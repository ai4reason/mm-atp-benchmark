...
thf(aflimss1_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwss @ XJ @ XK)) => (cwss @ (cco @ XK @ XF @ ccflim) @ (cco @ XJ @ XF @ ccflim)))))))).
