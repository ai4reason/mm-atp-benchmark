...
thf(asetcepi_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XU)) => ((Xph => (cwcel @ XY @ XU)) => ((XE = (ccfv @ XC @ ccepi)) => ((Xph => (cwcel @ cc2o @ XU)) => (Xph => ((cwcel @ XF @ (cco @ XX @ XY @ XE)) <=> (cwfo @ XX @ XY @ XF)))))))))))))))))).
