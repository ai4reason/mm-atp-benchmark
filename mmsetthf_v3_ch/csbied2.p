...
thf(acsbied2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (XA2 = (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = (XB2 @ Xx3))) => ((XC @ Xx3) = XD))) => (Xph => ((ccsb @ XA2 @ (^ [Xx3:$i] : (XC @ Xx3))) = XD)))))))))))).
