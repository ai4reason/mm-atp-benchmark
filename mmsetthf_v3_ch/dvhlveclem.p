...
thf(advhlveclem_thm,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccsca)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XI = (ccfv @ XD @ ccminusg)) => ((Xc_xp = (ccfv @ XD @ ccmulr)) => ((Xc_x = (ccfv @ XU @ ccvsca)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwcel @ XU @ cclvec))))))))))))))))))))))))))))).
