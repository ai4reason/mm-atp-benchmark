...
thf(afzoaddel2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ XB2 @ XC @ ccmin) @ ccfzo)) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) => (cwcel @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XC @ XB2 @ ccfzo))))))).
