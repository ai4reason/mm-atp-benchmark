...
thf(aablonnncan1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XD = (ccfv @ XG @ ccgs)) => (((cwcel @ XG @ ccablo) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ XD) @ (cco @ XA2 @ XC @ XD) @ XD) = (cco @ XC @ XB2 @ XD)))))))))))).
