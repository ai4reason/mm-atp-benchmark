...
thf(afbun_thm,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XG @ (ccfv @ XX @ ccfbas))) => ((cwcel @ (ccun @ XF @ XG) @ (ccfv @ XX @ ccfbas)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccv @ Xz) @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccun @ XF @ XG)))) @ (^ [Xy1:$i] : XG))) @ (^ [Xx3:$i] : XF)))))))).
