...
thf(adf_on_ax,axiom,(ccon0 = (^ [Xx3:$i] : (cword @ (ccv @ Xx3))))).
...
thf(aelon_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ ccon0) <=> (cword @ XA2))))).
thf(aeloni_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cword @ XA2)))).
thf(aelon2_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) <=> ((cword @ XA2) & (cwcel @ XA2 @ ccvv))))).
