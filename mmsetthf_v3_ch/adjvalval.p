...
thf(aadjvalval_thm,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ (ccdm @ ccado)) & (cwcel @ XA2 @ cchil)) => ((ccfv @ XA2 @ (ccfv @ XT @ ccado)) = (ccrio @ (^ [Xw:$i] : (cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ XA2 @ ccsp) = (cco @ (ccv @ Xx3) @ (ccv @ Xw) @ ccsp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xw:$i] : cchil))))))).
