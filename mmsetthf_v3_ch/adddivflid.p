...
thf(aadddivflid_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccn0) & (cwcel @ XC @ ccn)) => ((cwbr @ XB2 @ XC @ cclt) <=> ((ccfv @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccdiv) @ ccaddc) @ ccfl) = XA2))))))).
