...
thf(aregsep2_thm,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccreg) & ((cwcel @ XC @ (ccfv @ XJ @ cccld)) & (cwcel @ XA2 @ XX) & (~ (cwcel @ XA2 @ XC)))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwss @ XC @ (ccv @ Xx3)) & (cwcel @ XA2 @ (ccv @ Xy1)) & ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))))).
