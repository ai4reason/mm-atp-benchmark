...
thf(aralrab2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xy1))))) <=> (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => (Xch @ Xy1))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))))))))).
...
thf(arexrab2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xy1))))) <=> (cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & (Xch @ Xy1))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))))))))).
thf(aabidnf_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((^ [Xz:$i] : (! [Xx3:$i] : (cwcel @ (ccv @ Xz) @ (XA2 @ Xx3)))) = (XA2 @ Xx3)))))).
