...
thf(asibfof_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XS = (ccfv @ XJ @ ccsigagen)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XH = (ccfv @ (ccfv @ XW @ ccsca) @ ccrrh)) => ((Xph => (cwcel @ XW @ XV)) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((Xph => (cwcel @ XF @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => ((XC = (ccfv @ XK @ ccbs)) => ((Xph => (cwcel @ XW @ cctps)) => ((Xph => (cwf @ (ccxp @ XB2 @ XB2) @ XC @ Xc_pl)) => ((Xph => (cwcel @ XG @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => ((Xph => (cwcel @ XK @ cctps)) => ((Xph => (cwcel @ XJ @ cct1)) => ((Xph => ((cco @ Xc_0 @ Xc_0 @ Xc_pl) = (ccfv @ XK @ cc0g))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ (ccdm @ (cco @ XK @ XM @ ccsitg)))))))))))))))))))))))))))))))))))).
thf(asitgfval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ XW @ ccbs))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XW @ cctopn))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ (XJ @ Xx3) @ ccsigagen))) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xx3:$i] : ((Xc_x @ Xx3) = (ccfv @ XW @ ccvsca))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ (ccfv @ XW @ ccsca) @ ccrrh))) => ((! [Xx3:$i] : (Xph => (cwcel @ XW @ (XV @ Xx3)))) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((Xph => (cwcel @ XF @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => (Xph => ((ccfv @ XF @ (cco @ XW @ XM @ ccsitg)) = (cco @ XW @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ (ccrn @ XF) @ (ccsn @ Xc_0))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ XM) @ (XH @ Xx3)) @ (ccv @ Xx3) @ (Xc_x @ Xx3)))) @ ccgsu)))))))))))))))))))))))).
...
thf(asitmf_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XW @ ccmnd)) => ((Xph => (cwcel @ XW @ ccxme)) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => (Xph => (cwf @ (ccxp @ (ccdm @ (cco @ XW @ XM @ ccsitg)) @ (ccdm @ (cco @ XW @ XM @ ccsitg))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (cco @ XW @ XM @ ccsitm)))))))))).
thf(adf_itgm_ax,axiom,(ccitgm = (ccmpt2 @ (^ [Xw:$i] : (^ [Xm:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xm:$i] : (ccuni @ (ccrn @ ccmeas)))) @ (^ [Xw:$i] : (^ [Xm:$i] : (ccfv @ (cco @ (ccv @ Xw) @ (ccv @ Xm) @ ccsitg) @ (cco @ (ccfv @ (cco @ (ccv @ Xw) @ (ccv @ Xm) @ ccsitm) @ ccmetu) @ (ccfv @ (ccv @ Xw) @ ccuss) @ cccnext))))))).
thf(aoddpwdc_thm,axiom,(! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > $o))] : ((! [Xz:$i] : ((XJ @ Xz) = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XJ @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ (ccv @ Xx3) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwf1o @ (ccxp @ (XJ @ Xz) @ ccn0) @ ccn @ (XF @ Xx3 @ Xy1 @ Xz)))))))))).
thf(aoddpwdcv_thm,axiom,(! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : ((XJ @ Xz) = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XJ @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ (ccv @ Xx3) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XW @ Xz) @ (ccxp @ (XJ @ Xz) @ ccn0)) => ((ccfv @ (XW @ Xz) @ (XF @ Xx3 @ Xy1 @ Xz)) = (cco @ (cco @ cc2 @ (ccfv @ (XW @ Xz) @ cc2nd) @ ccexp) @ (ccfv @ (XW @ Xz) @ cc1st) @ ccmul)))))))))))).
thf(aeulerpartlemsv1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xf1:$i] : (! [Xk:$i] : ((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) => ((ccfv @ XA2 @ (XS @ Xf1 @ Xk)) = (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul))))))))))))).
thf(aeulerpartlemelr_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => ((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) => ((cwf @ ccn @ ccn0 @ XA2) & (cwcel @ (ccima @ (cccnv @ XA2) @ ccn) @ ccfn))))))))).
thf(aeulerpartlemsv2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xf1:$i] : (! [Xk:$i] : ((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) => ((ccfv @ XA2 @ (XS @ Xf1 @ Xk)) = (ccsu @ (ccima @ (cccnv @ XA2) @ ccn) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul))))))))))))).
thf(aeulerpartlemsf_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xf1:$i] : (! [Xk:$i] : (cwf @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR) @ ccn0 @ (XS @ Xf1 @ Xk))))))))).
thf(aeulerpartlems_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xk:$i] : (((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) & (cwcel @ (ccv @ Xt) @ (ccfv @ (cco @ (ccfv @ XA2 @ (XS @ Xf1 @ Xk)) @ cc1 @ ccaddc) @ ccuz))) => ((ccfv @ (ccv @ Xt) @ XA2) = ccc0))))))))))).
thf(aeulerpartlemsv3_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))))))) => (! [Xf1:$i] : ((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) => ((ccfv @ XA2 @ (XS @ Xf1)) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ (XS @ Xf1)) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul)))))))))))).
thf(aeulerpartlemgc_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xn:$i] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))))))) => (! [Xt:$i] : (! [Xf1:$i] : (((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) & ((cwcel @ (ccv @ Xt) @ ccn) & (cwcel @ (ccv @ Xn) @ (ccfv @ (ccfv @ (ccv @ Xt) @ XA2) @ ccbits)))) => (cwbr @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ (ccv @ Xt) @ ccmul) @ (ccfv @ XA2 @ (XS @ Xf1)) @ ccle))))))))))).
...
thf(aeulerpartlemv_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((XP @ Xf1) = (ccrab @ (^ [Xf1:$i] : ((cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn) & ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))) = XN))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap))))) => (! [Xf1:$i] : ((cwcel @ XA2 @ (XP @ Xf1)) <=> ((cwf @ ccn @ ccn0 @ XA2) & (cwcel @ (ccima @ (cccnv @ XA2) @ ccn) @ ccfn) & ((ccsu @ (ccima @ (cccnv @ XA2) @ ccn) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul))) = XN))))))))).
thf(aeulerpartlemo_thm,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XP @ Xf1 @ Xk @ Xn) = (ccrab @ (^ [Xf1:$i] : ((cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn) & ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))) = (XN @ Xf1 @ Xg1 @ Xk @ Xn)))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XO @ Xf1 @ Xg1 @ Xk @ Xn) = (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (~ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (ccima @ (cccnv @ (ccv @ Xg1)) @ ccn)))) @ (^ [Xg1:$i] : (XP @ Xf1 @ Xk @ Xn)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XD @ Xf1 @ Xg1 @ Xk @ Xn) = (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ cc1 @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xg1:$i] : (XP @ Xf1 @ Xk @ Xn)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((cwcel @ (XA2 @ Xf1 @ Xk) @ (XO @ Xf1 @ Xg1 @ Xk @ Xn)) <=> ((cwcel @ (XA2 @ Xf1 @ Xk) @ (XP @ Xf1 @ Xk @ Xn)) & (cwral @ (^ [Xn:$i] : (~ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (ccima @ (cccnv @ (XA2 @ Xf1 @ Xk)) @ ccn)))))))))))))))))).
