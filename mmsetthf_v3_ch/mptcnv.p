...
thf(apoleloe_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ (ccun @ XR @ ccid)) <=> ((cwbr @ XA2 @ XB2 @ XR) | (XA2 = XB2))))))))).
thf(apoltletr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwpo @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => (((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XB2 @ XC @ (ccun @ XR @ ccid))) => (cwbr @ XA2 @ XC @ XR))))))))).
thf(asomin1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ XR) @ XA2 @ XB2) @ XA2 @ (ccun @ XR @ ccid)))))))).
thf(asomincom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((ccif @ (cwbr @ XA2 @ XB2 @ XR) @ XA2 @ XB2) = (ccif @ (cwbr @ XB2 @ XA2 @ XR) @ XB2 @ XA2)))))))).
thf(asomin2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ XR) @ XA2 @ XB2) @ XB2 @ (ccun @ XR @ ccid)))))))).
thf(asoltmin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ XR) @ XB2 @ XC) @ XR) <=> ((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XA2 @ XC @ XR)))))))))).
thf(acnvopab_thm,axiom,(! [Xph:($i > ($i > $o))] : ((cccnv @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) = (ccopab @ (^ [Xy1:$i] : (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))))))).
thf(amptcnv_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & ((ccv @ Xy1) = (XB2 @ Xx3))) <=> ((cwcel @ (ccv @ Xy1) @ (XC @ Xy1)) & ((ccv @ Xx3) = (XD @ Xy1))))))) => (Xph => ((cccnv @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = (ccmpt @ (^ [Xy1:$i] : (XC @ Xy1)) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))).
