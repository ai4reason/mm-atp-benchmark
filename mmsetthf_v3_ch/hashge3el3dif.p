...
thf(ahashge3el3dif_thm,conjecture,(! [XD:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XD @ (XV @ Xx3 @ Xy1 @ Xz)) & (cwbr @ cc3 @ (ccfv @ XD @ cchash) @ ccle)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & ((ccv @ Xx3) != (ccv @ Xz)) & ((ccv @ Xy1) != (ccv @ Xz)))) @ (^ [Xz:$i] : XD))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD))))))))).
