...
thf(aeigrei_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ ccc) => ((((ccfv @ XA2 @ XT) = (cco @ XB2 @ XA2 @ ccsm)) & (XA2 != cc0v)) => (((cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) = (cco @ (ccfv @ XA2 @ XT) @ XA2 @ ccsp)) <=> (cwcel @ XB2 @ ccr))))))))).
