...
thf(azrhpsgnmhm_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwcel @ XR @ ccrg) & (cwcel @ XA2 @ ccfn)) => (cwcel @ (cccom @ (ccfv @ XR @ cczrh) @ (ccfv @ XA2 @ ccpsgn)) @ (cco @ (ccfv @ XA2 @ ccsymg) @ (ccfv @ XR @ ccmgp) @ ccmhm)))))).
