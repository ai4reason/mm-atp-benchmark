...
thf(areusv3_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((XC @ Xy1) = (XD @ Xz))))) => ((cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & (cwcel @ (XC @ Xy1) @ XA2))) @ (^ [Xy1:$i] : XB2)) => ((cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((Xph @ Xy1) & (Xps @ Xz)) => ((XC @ Xy1) = (XD @ Xz)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))))))).
