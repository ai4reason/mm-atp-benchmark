...
thf(advcmul_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => (cwcel @ XC @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => (Xph => ((ccfv @ XC @ (cco @ XS @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdv)) = (cco @ XA2 @ (ccfv @ XC @ (cco @ XS @ XF @ ccdv)) @ ccmul))))))))))))))).
