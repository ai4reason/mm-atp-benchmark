...
thf(axrpxdivcld_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ ccxdiv) @ (cco @ ccc0 @ ccpnf @ ccicc))))))))).
