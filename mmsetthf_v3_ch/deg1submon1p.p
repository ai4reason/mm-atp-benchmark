...
thf(adeg1submon1p_thm,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XO = (ccfv @ XR @ ccmn1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XO)) => ((Xph => ((ccfv @ XF @ XD) = XX)) => ((Xph => (cwcel @ XG @ XO)) => ((Xph => ((ccfv @ XG @ XD) = XX)) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ XX @ cclt))))))))))))))))))))).
