...
thf(aaxhis1_zf_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ cchlo) => ((ccsp = (ccfv @ XU @ ccdip)) => (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ XA2 @ XB2 @ ccsp) = (ccfv @ (cco @ XB2 @ XA2 @ ccsp) @ cccj)))))))))).
