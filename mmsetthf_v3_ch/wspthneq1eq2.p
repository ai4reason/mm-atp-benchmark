...
thf(awspthneq1eq2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwspthsnon))) & (cwcel @ XP @ (cco @ XC @ XD @ (cco @ XN @ XG @ ccwwspthsnon)))) => ((XA2 = XC) & (XB2 = XD))))))))))).
