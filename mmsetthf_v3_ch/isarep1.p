...
thf(aisarep1_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xb:$i] : ((cwcel @ (ccv @ Xb) @ (ccima @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xb)))) @ (XA2 @ Xy1 @ Xb))) <=> (cwrex @ (^ [Xx3:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xb)) @ Xb)) @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xb))))))))).
