...
thf(aredwlk_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ ccle)) => (cwbr @ (ccres @ XF @ (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (ccres @ XP @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (ccfv @ XG @ ccwlks))))))).
