...
thf(asltres_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur) & (cwcel @ XX @ ccon0)) => ((cwbr @ (ccres @ XA2 @ XX) @ (ccres @ XB2 @ XX) @ ccslt) => (cwbr @ XA2 @ XB2 @ ccslt))))))).
