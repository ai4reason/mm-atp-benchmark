...
thf(aodval_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XG @ ccbs))) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((! [Xy1:$i] : ((XO @ Xy1) = (ccfv @ XG @ ccod))) => ((! [Xy1:$i] : ((XI @ Xy1) = (ccrab @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ XA2 @ Xc_x) = Xc_0)) @ (^ [Xy1:$i] : ccn)))) => (! [Xy1:$i] : ((cwcel @ XA2 @ (XX @ Xy1)) => ((ccfv @ XA2 @ (XO @ Xy1)) = (ccif @ ((XI @ Xy1) = cc0) @ ccc0 @ (ccinf @ (XI @ Xy1) @ ccr @ cclt)))))))))))))))))).
