...
thf(ar1pval_thm,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XE = (ccfv @ XR @ ccr1p)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XQ = (ccfv @ XR @ ccq1p)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => (((cwcel @ XF @ XB2) & (cwcel @ XG @ XB2)) => ((cco @ XF @ XG @ XE) = (cco @ XF @ (cco @ (cco @ XF @ XG @ XQ) @ XG @ Xc_x) @ Xc_mi))))))))))))))))))).
