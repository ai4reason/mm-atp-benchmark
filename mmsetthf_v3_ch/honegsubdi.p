...
thf(ahonegsubdi_thm,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU)) => ((cco @ (ccneg @ cc1) @ (cco @ XT @ XU @ cchod) @ cchot) = (cco @ (cco @ (ccneg @ cc1) @ XT @ cchot) @ XU @ cchos)))))).
