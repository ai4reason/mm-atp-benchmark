...
thf(apropssopi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => ((cwcel @ XE @ ccvv) => ((cwcel @ XF @ ccvv) => ((cwss @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (ccop @ XE @ XF)) => (XA2 = XC))))))))))))))).
