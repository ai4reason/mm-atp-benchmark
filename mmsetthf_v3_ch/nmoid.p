...
thf(anmoid_thm,conjecture,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (cco @ XS @ XS @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => (((cwcel @ XS @ ccngp) & (cwpss @ (ccsn @ Xc_0) @ XV)) => ((ccfv @ (ccres @ ccid @ XV) @ XN) = cc1)))))))))).
