...
thf(aomopth2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (XA2 != cc0)) & ((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ XA2)) & ((cwcel @ XD @ ccon0) & (cwcel @ XE @ XA2))) => (((cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccoa) = (cco @ (cco @ XA2 @ XD @ ccomu) @ XE @ ccoa)) <=> ((XB2 = XD) & (XC = XE)))))))))).
