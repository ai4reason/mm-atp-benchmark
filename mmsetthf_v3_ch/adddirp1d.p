...
thf(aadddirp1d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XB2 @ ccmul) = (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XB2 @ ccaddc))))))))).
