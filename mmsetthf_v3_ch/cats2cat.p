...
thf(acats2cat_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XB2 @ (ccword @ ccvv)) => ((cwcel @ XD @ (ccword @ ccvv)) => ((XA2 = (cco @ XB2 @ (ccs1 @ XX) @ ccconcat)) => ((XC = (cco @ (ccs1 @ XY) @ XD @ ccconcat)) => ((cco @ XA2 @ XC @ ccconcat) = (cco @ (cco @ XB2 @ (ccs2 @ XX @ XY) @ ccconcat) @ XD @ ccconcat))))))))))))).
