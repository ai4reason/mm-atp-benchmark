...
thf(aig1pcl_thm,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XR @ ccig1p)) => ((XU = (ccfv @ XP @ cclidl)) => (((cwcel @ XR @ ccdr) & (cwcel @ XI @ XU)) => (cwcel @ (ccfv @ XI @ XG) @ XI))))))))))).
