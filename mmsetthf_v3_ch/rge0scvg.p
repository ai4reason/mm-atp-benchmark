...
thf(arge0scvg_thm,conjecture,(! [XF:($i > $o)] : (((cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccico) @ XF) & (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli))) => (cwcel @ (ccsup @ (ccrn @ (ccseq @ ccaddc @ XF @ cc1)) @ ccr @ cclt) @ ccr)))).
