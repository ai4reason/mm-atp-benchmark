...
thf(ahtpycn_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (Xph => (cwss @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)) @ (cco @ (cco @ XJ @ ccii @ cctx) @ XK @ cccn))))))))))))).
