...
thf(aaxhis4_zf_thm,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ cchlo) => ((ccsp = (ccfv @ XU @ ccdip)) => (((cwcel @ XA2 @ cchil) & (XA2 != cc0v)) => (cwbr @ ccc0 @ (cco @ XA2 @ XA2 @ ccsp) @ cclt)))))))).
