...
thf(asqrlem5_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xu:$i] : ((XS @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (XA2 @ Xu) @ ccle)) @ (^ [Xx3:$i] : ccrp))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XB2 @ Xx3 @ Xu @ Xa @ Xb) = (ccsup @ (XS @ Xx3) @ ccr @ cclt)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XT @ Xx3 @ Xy1 @ Xa @ Xb) = (^ [Xy1:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((ccv @ Xy1) = (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccmul))) @ (^ [Xb:$i] : (XS @ Xx3)))) @ (^ [Xa:$i] : (XS @ Xx3))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ (XA2 @ Xu) @ ccrp) & (cwbr @ (XA2 @ Xu) @ cc1 @ ccle)) => (((cwss @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ ccr) & ((XT @ Xx3 @ Xy1 @ Xa @ Xb) != cc0) & (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xu:$i] : (cwbr @ (ccv @ Xu) @ (ccv @ Xv) @ ccle)) @ (^ [Xu:$i] : (XT @ Xx3 @ Xy1 @ Xa @ Xb)))) @ (^ [Xv:$i] : ccr))) & ((cco @ (XB2 @ Xx3 @ Xu @ Xa @ Xb) @ cc2 @ ccexp) = (ccsup @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ ccr @ cclt))))))))))))))))).
