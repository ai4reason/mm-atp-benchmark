...
thf(aostthlem2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xp:$i] : ((XQ @ Xp) = (cco @ cccnfld @ ccq @ ccress))) => ((! [Xp:$i] : (XA2 = (ccfv @ (XQ @ Xp) @ ccabv))) => ((Xph => (cwcel @ XF @ XA2)) => ((Xph => (cwcel @ XG @ XA2)) => ((! [Xp:$i] : ((Xph & (cwcel @ (ccv @ Xp) @ ccprime)) => ((ccfv @ (ccv @ Xp) @ XF) = (ccfv @ (ccv @ Xp) @ XG)))) => (Xph => (XF = XG))))))))))))).
