...
thf(ascmatscm_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xc:$i] : ((XA2 @ Xc) = (cco @ XN @ XR @ ccmat))) => ((! [Xm:$i] : (! [Xc:$i] : ((XB2 @ Xm @ Xc) = (ccfv @ (XA2 @ Xc) @ ccbs)))) => ((! [Xc:$i] : ((Xc_as @ Xc) = (ccfv @ (XA2 @ Xc) @ ccvsca))) => ((! [Xm:$i] : (! [Xc:$i] : ((Xc_xp @ Xm @ Xc) = (ccfv @ (XA2 @ Xc) @ ccmulr)))) => ((XS = (cco @ XN @ XR @ ccscmat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & (cwcel @ XC @ XS)) => (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xm:$i] : ((cco @ XC @ (ccv @ Xm) @ (Xc_xp @ Xm @ Xc)) = (cco @ (ccv @ Xc) @ (ccv @ Xm) @ (Xc_as @ Xc)))) @ (^ [Xm:$i] : (XB2 @ Xm @ Xc)))) @ (^ [Xc:$i] : XK))))))))))))))))))).
