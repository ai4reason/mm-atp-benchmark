...
thf(achj4_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) & ((cwcel @ XC @ ccch) & (cwcel @ XD @ ccch))) => ((cco @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XC @ XD @ cchj) @ cchj) = (cco @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XD @ cchj) @ cchj)))))))).
