...
thf(aclmzlmvsca_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XW = (ccfv @ XG @ cczlm)) => ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccclm) & ((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ XX))) => ((cco @ XA2 @ XB2 @ (ccfv @ XG @ ccvsca)) = (cco @ XA2 @ XB2 @ (ccfv @ XW @ ccvsca)))))))))))).
