...
thf(ametustrel_thm,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XA2 @ XF)) => (cwrel @ XA2)))))))).
