...
thf(ataylth_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccdm @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdvn))) = XA2)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XB2 @ XA2)) => ((XT = (cco @ XN @ XB2 @ (cco @ ccr @ XF @ cctayl))) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccmin) @ (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ XN @ ccexp) @ ccdiv))))) => (! [Xx3:$i] : (Xph => (cwcel @ ccc0 @ (cco @ (XR @ Xx3) @ XB2 @ cclimc))))))))))))))))))).
