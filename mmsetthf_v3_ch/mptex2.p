...
thf(amptex2_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xt:$i] : ((Xph @ Xt) => (cwf @ XA2 @ XC @ (ccmpt @ (^ [Xt:$i] : XA2) @ (^ [Xt:$i] : (XB2 @ Xt)))))) => (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xt) @ XA2)) => (cwcel @ (XB2 @ Xt) @ XC))))))))).
