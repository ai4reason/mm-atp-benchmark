...
thf(aidinside_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => (((cwbr @ XC @ (ccop @ XA2 @ XB2) @ ccbtwn) & (cwbr @ (ccop @ XA2 @ XC) @ (ccop @ XA2 @ XD) @ cccgr) & (cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XB2 @ XD) @ cccgr)) => (XC = XD))))))))).
