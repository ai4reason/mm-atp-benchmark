...
thf(aswrd0swrdid_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => ((cco @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ (ccop @ ccc0 @ XN) @ ccsubstr) = (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr))))))).
thf(awrdcctswrd_thm,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => ((cco @ (cco @ XW @ (ccop @ ccc0 @ XM) @ ccsubstr) @ (cco @ XW @ (ccop @ XM @ (ccfv @ XW @ cchash)) @ ccsubstr) @ ccconcat) = XW)))))).
thf(alencctswrd_thm,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ (cco @ XW @ (ccop @ ccc0 @ XM) @ ccsubstr) @ (cco @ XW @ (ccop @ XM @ (ccfv @ XW @ cchash)) @ ccsubstr) @ ccconcat) @ cchash) = (ccfv @ XW @ cchash))))))).
thf(alenrevcctswrd_thm,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ (cco @ XW @ (ccop @ XM @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (cco @ XW @ (ccop @ ccc0 @ XM) @ ccsubstr) @ ccconcat) @ cchash) = (ccfv @ XW @ cchash))))))).
...
thf(accats1swrdeq_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV)) & ((ccfv @ XU @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) => ((XW = (cco @ XU @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) => (XU = (cco @ XW @ (ccs1 @ (ccfv @ XU @ cclsw)) @ ccconcat)))))))).
thf(accatopth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ (ccword @ XX))) & ((cwcel @ XC @ (ccword @ XX)) & (cwcel @ XD @ (ccword @ XX))) & ((ccfv @ XA2 @ cchash) = (ccfv @ XC @ cchash))) => (((cco @ XA2 @ XB2 @ ccconcat) = (cco @ XC @ XD @ ccconcat)) <=> ((XA2 = XC) & (XB2 = XD)))))))))).
thf(accatopth2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ (ccword @ XX))) & ((cwcel @ XC @ (ccword @ XX)) & (cwcel @ XD @ (ccword @ XX))) & ((ccfv @ XB2 @ cchash) = (ccfv @ XD @ cchash))) => (((cco @ XA2 @ XB2 @ ccconcat) = (cco @ XC @ XD @ ccconcat)) <=> ((XA2 = XC) & (XB2 = XD)))))))))).
thf(accatlcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ (ccword @ XX)) & (cwcel @ XC @ (ccword @ XX))) => (((cco @ XC @ XA2 @ ccconcat) = (cco @ XC @ XB2 @ ccconcat)) <=> (XA2 = XB2)))))))).
thf(accatrcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ (ccword @ XX)) & (cwcel @ XC @ (ccword @ XX))) => (((cco @ XA2 @ XC @ ccconcat) = (cco @ XB2 @ XC @ ccconcat)) <=> (XA2 = XB2)))))))).
thf(awrdeqs1cat_thm,axiom,(! [XA2:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (XW != cc0)) => (XW = (cco @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ (cco @ XW @ (ccop @ cc1 @ (ccfv @ XW @ cchash)) @ ccsubstr) @ ccconcat)))))).
thf(acats1un_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ XX)) => ((cco @ XA2 @ (ccs1 @ XB2) @ ccconcat) = (ccun @ XA2 @ (ccsn @ (ccop @ (ccfv @ XA2 @ cchash) @ XB2))))))))).
