...
thf(aprsshashgt1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (XA2 != XB2)) & (cwcel @ XC @ XU)) => ((cwss @ (ccpr @ XA2 @ XB2) @ XC) => (cwbr @ cc2 @ (ccfv @ XC @ cchash) @ ccle)))))))))).
