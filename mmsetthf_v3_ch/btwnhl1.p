...
thf(abtwnhl1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ XI))) => ((Xph => (XA2 != XB2)) => ((Xph => (XC != XA2)) => (Xph => (cwbr @ XC @ XB2 @ (ccfv @ XA2 @ XK)))))))))))))))))))))))).
