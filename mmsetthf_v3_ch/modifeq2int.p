...
thf(amodifeq2int_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn) & (cwbr @ XA2 @ (cco @ cc2 @ XB2 @ ccmul) @ cclt)) => ((cco @ XA2 @ XB2 @ ccmo) = (ccif @ (cwbr @ XA2 @ XB2 @ cclt) @ XA2 @ (cco @ XA2 @ XB2 @ ccmin))))))).
