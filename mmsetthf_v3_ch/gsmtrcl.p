...
thf(agsmtrcl_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XN @ ccsymg)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XT = (ccrn @ (ccfv @ XN @ ccpmtr))) => (((cwcel @ XN @ ccfn) & (cwcel @ XW @ (ccword @ XT))) => (cwcel @ (cco @ XS @ XW @ ccgsu) @ XB2))))))))))).
