...
thf(altrec1d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ cclt)) => (Xph => (cwbr @ (cco @ cc1 @ XB2 @ ccdiv) @ XA2 @ cclt))))))))).
