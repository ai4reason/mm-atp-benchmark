...
thf(altexp2rd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => (Xph => ((cwbr @ XM @ XN @ cclt) <=> (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ cclt)))))))))))).
