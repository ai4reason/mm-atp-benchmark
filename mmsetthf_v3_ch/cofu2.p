...
thf(afuncsect_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XD @ ccbs)) => ((XS = (ccfv @ XD @ ccsect)) => ((XT = (ccfv @ XE @ ccsect)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XD @ XE @ ccfunc))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwbr @ XM @ XN @ (cco @ XX @ XY @ XS))) => (Xph => (cwbr @ (ccfv @ XM @ (cco @ XX @ XY @ XG)) @ (ccfv @ XN @ (cco @ XY @ XX @ XG)) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XT))))))))))))))))))))))).
...
thf(afunciso_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XD @ ccbs)) => ((XI = (ccfv @ XD @ cciso)) => ((XJ = (ccfv @ XE @ cciso)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XD @ XE @ ccfunc))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XM @ (cco @ XX @ XY @ XI))) => (Xph => (cwcel @ (ccfv @ XM @ (cco @ XX @ XY @ XG)) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XJ)))))))))))))))))))))).
thf(afuncoppc_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XP = (ccfv @ XD @ ccoppc)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfunc))) => (Xph => (cwbr @ XF @ (cctpos @ XG) @ (cco @ XO @ XP @ ccfunc)))))))))))))).
...
thf(aidfu2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XC @ ccidfu)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => (Xph => ((ccfv @ XF @ (cco @ XX @ XY @ (ccfv @ XI @ cc2nd))) = XF)))))))))))))))))).
...
thf(acofu2_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XD @ XE @ ccfunc))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XR @ (cco @ XX @ XY @ XH))) => (Xph => ((ccfv @ XR @ (cco @ XX @ XY @ (ccfv @ (cco @ XG @ XF @ cccofu) @ cc2nd))) = (ccfv @ (ccfv @ XR @ (cco @ XX @ XY @ (ccfv @ XF @ cc2nd))) @ (cco @ (ccfv @ XX @ (ccfv @ XF @ cc1st)) @ (ccfv @ XY @ (ccfv @ XF @ cc1st)) @ (ccfv @ XG @ cc2nd)))))))))))))))))))))))).
