...
thf(adfac1_thm,conjecture,(cwac <=> (! [Xx3:$i] : (? [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwcel @ (ccv @ Xz) @ (ccv @ Xw)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))) => (? [Xx3:$i] : (! [Xz:$i] : ((? [Xx3:$i] : (((cwcel @ (ccv @ Xz) @ (ccv @ Xw)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))) & ((cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))))) <=> ((ccv @ Xz) = (ccv @ Xx3)))))))))))).
