...
thf(afoconst_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ (ccsn @ XB2) @ XF) & (XF != cc0)) => (cwfo @ XA2 @ (ccsn @ XB2) @ XF)))))).
...
thf(af1oeq123d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cwf1o @ XA2 @ XC @ XF) <=> (cwf1o @ XB2 @ XD @ XG)))))))))))))).
