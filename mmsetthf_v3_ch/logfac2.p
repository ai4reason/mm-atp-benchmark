...
thf(alogfac2_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => ((ccfv @ (ccfv @ (ccfv @ XA2 @ ccfl) @ ccfa) @ cclog) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ ccvma) @ (ccfv @ (cco @ XA2 @ (ccv @ Xk) @ ccdiv) @ ccfl) @ ccmul))))))).
