...
thf(aleexp2rd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ cc1 @ ccle)) => (Xph => (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ ccle)))))))))))).
