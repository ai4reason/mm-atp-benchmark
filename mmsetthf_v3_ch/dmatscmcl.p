...
thf(admatscmcl_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((Xc_as = (ccfv @ XA2 @ ccvsca)) => ((XD = (cco @ XN @ XR @ ccdmat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ XC @ XK) & (cwcel @ XM @ XD))) => (cwcel @ (cco @ XC @ XM @ Xc_as) @ XD))))))))))))))))).
