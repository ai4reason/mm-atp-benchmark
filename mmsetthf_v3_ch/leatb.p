...
thf(aleatb_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ ccops) & (cwcel @ XX @ XB2) & (cwcel @ XP @ XA2)) => ((cwbr @ XX @ XP @ Xc_le) <=> ((XX = XP) | (XX = Xc_0)))))))))))))))).
