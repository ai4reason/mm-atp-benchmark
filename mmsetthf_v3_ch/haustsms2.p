...
thf(ahaustsms2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((XJ = (ccfv @ XG @ cctopn)) => ((Xph => (cwcel @ XJ @ ccha)) => (Xph => ((cwcel @ XX @ (cco @ XG @ XF @ cctsu)) => ((cco @ XG @ XF @ cctsu) = (ccsn @ XX)))))))))))))))))))).
