...
thf(abnj941_thm,conjecture,(! [XC:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xp:$i] : ((! [Xf1:$i] : (! [Xn:$i] : ((XG @ Xf1 @ Xn) = (ccun @ (ccv @ Xf1) @ (ccsn @ (ccop @ (ccv @ Xn) @ (XC @ Xf1 @ Xn))))))) => (! [Xf1:$i] : (! [Xn:$i] : ((cwcel @ (XC @ Xf1 @ Xn) @ ccvv) => ((((ccv @ Xp) = (ccsuc @ (ccv @ Xn))) & (cwfn @ (ccv @ Xf1) @ (ccv @ Xn))) => (cwfn @ (XG @ Xf1 @ Xn) @ (ccv @ Xp))))))))))).
