...
thf(agruiin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XU:($i > $o)] : (((cwcel @ XU @ ccgru) & (cwrex @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XU)) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XU)))))).
thf(agruf_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XU @ ccgru) & (cwcel @ XA2 @ XU) & (cwf @ XA2 @ XU @ XF)) => (cwcel @ XF @ XU)))))).
thf(agruen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XU @ ccgru) & (cwss @ XA2 @ XU) & ((cwcel @ XB2 @ XU) & (cwbr @ XB2 @ XA2 @ ccen))) => (cwcel @ XA2 @ XU)))))).
thf(agruwun_thm,axiom,(! [XU:($i > $o)] : (((cwcel @ XU @ ccgru) & (XU != cc0)) => (cwcel @ XU @ ccwun)))).
thf(aintgru_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccgru) & (XA2 != cc0)) => (cwcel @ (ccint @ XA2) @ ccgru)))).
...
thf(awfgru_thm,axiom,(! [XU:($i > $o)] : ((cwcel @ XU @ ccgru) => (cwcel @ (ccin @ XU @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ ccgru)))).
thf(agrudomon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XU @ ccgru) & (cwcel @ XA2 @ ccon0) & ((cwcel @ XB2 @ XU) & (cwbr @ XA2 @ XB2 @ ccdom))) => (cwcel @ XA2 @ XU)))))).
thf(agruina_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((XA2 = (ccin @ XU @ ccon0)) => (((cwcel @ XU @ ccgru) & (XU != cc0)) => (cwcel @ XA2 @ ccina)))))).
thf(agrur1a_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((XA2 = (ccin @ XU @ ccon0)) => ((cwcel @ XU @ ccgru) => (cwss @ (ccfv @ XA2 @ ccr1) @ XU)))))).
thf(agrur1_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((XA2 = (ccin @ XU @ ccon0)) => (((cwcel @ XU @ ccgru) & (cwcel @ XU @ (ccuni @ (ccima @ ccr1 @ ccon0)))) => (XU = (ccfv @ XA2 @ ccr1))))))).
thf(agrutsk1_thm,axiom,(! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwtr @ XT)) => (cwcel @ XT @ ccgru)))).
thf(agrutsk_thm,axiom,(ccgru = (ccrab @ (^ [Xx3:$i] : (cwtr @ (ccv @ Xx3))) @ (^ [Xx3:$i] : cctsk)))).
...
thf(aaxgroth2_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) & (cwrex @ (^ [Xw:$i] : (! [Xv:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xv) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
thf(agrothpw_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : (! [Xz:$i] : ((! [Xw:$i] : ((cwcel @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)))) => (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))).
thf(agrothpwex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccpw @ (ccv @ Xx3)) @ ccvv))).
thf(aaxgroth6_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)) & (cwcel @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccsdm) => (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xy1)))))))).
thf(agrothomex_thm,axiom,(cwcel @ ccom @ ccvv)).
thf(agrothac_thm,axiom,((ccdm @ cccrd) = ccvv)).
thf(aaxgroth3_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) & (cwrex @ (^ [Xw:$i] : (! [Xv:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xv) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccdif @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
thf(aaxgroth4_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xv)))))) @ (^ [Xv:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccdif @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
thf(agrothprimlem_thm,axiom,(! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : ((cwcel @ (ccpr @ (ccv @ Xu) @ (ccv @ Xv)) @ (ccv @ Xw)) <=> (? [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) & (! [Xh:$i] : ((cwcel @ (ccv @ Xh) @ (ccv @ Xg1)) <=> (((ccv @ Xh) = (ccv @ Xu)) | ((ccv @ Xh) = (ccv @ Xv)))))))))))).
thf(agrothprim_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (! [Xz:$i] : (((cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) => (? [Xv:$i] : ((cwcel @ (ccv @ Xv) @ (ccv @ Xy1)) & (! [Xw:$i] : ((! [Xu:$i] : ((cwcel @ (ccv @ Xu) @ (ccv @ Xw)) => (cwcel @ (ccv @ Xu) @ (ccv @ Xz)))) => ((cwcel @ (ccv @ Xw) @ (ccv @ Xy1)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xv)))))))) & (? [Xw:$i] : (((cwcel @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1))) => ((! [Xv:$i] : (((cwcel @ (ccv @ Xv) @ (ccv @ Xz)) => (? [Xt:$i] : (! [Xu:$i] : ((? [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) & (! [Xh:$i] : ((cwcel @ (ccv @ Xh) @ (ccv @ Xg1)) <=> (((ccv @ Xh) = (ccv @ Xv)) | ((ccv @ Xh) = (ccv @ Xu))))))) => ((ccv @ Xu) = (ccv @ Xt)))))) & ((cwcel @ (ccv @ Xv) @ (ccv @ Xy1)) => ((cwcel @ (ccv @ Xv) @ (ccv @ Xz)) | (? [Xu:$i] : ((cwcel @ (ccv @ Xu) @ (ccv @ Xz)) & (? [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) & (! [Xh:$i] : ((cwcel @ (ccv @ Xh) @ (ccv @ Xg1)) <=> (((ccv @ Xh) = (ccv @ Xu)) | ((ccv @ Xh) = (ccv @ Xv))))))))))))) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))))).
thf(agrothtsk_thm,axiom,((ccuni @ cctsk) = ccvv)).
thf(ainaprc_thm,axiom,(~ (wnel @ ccina @ ccvv))).
thf(cctskm_tp,type,(cctskm : ($i > $o))).
thf(adf_tskm_ax,axiom,(cctskm = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : cctsk))))))).
thf(atskmval_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((ccfv @ XA2 @ cctskm) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : cctsk))))))))).
thf(atskmid_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ XA2 @ (ccfv @ XA2 @ cctskm)))))).
thf(atskmcl_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccfv @ XA2 @ cctskm) @ cctsk))).
thf(asstskm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwss @ XB2 @ (ccfv @ XA2 @ cctskm)) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) => (cwss @ XB2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : cctsk))))))))).
thf(aeltskm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwcel @ XB2 @ (ccfv @ XA2 @ cctskm)) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) => (cwcel @ XB2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : cctsk))))))))).
...
thf(adf_mi_ax,axiom,(ccmi = (ccres @ ccomu @ (ccxp @ ccnpi @ ccnpi)))).
thf(adf_lti_ax,axiom,(cclti = (ccin @ ccep @ (ccxp @ ccnpi @ ccnpi)))).
thf(aelni_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnpi) <=> ((cwcel @ XA2 @ ccom) & (XA2 != cc0))))).
thf(aelni2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnpi) <=> ((cwcel @ XA2 @ ccom) & (cwcel @ cc0 @ XA2))))).
thf(apinn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnpi) => (cwcel @ XA2 @ ccom)))).
thf(apion_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnpi) => (cwcel @ XA2 @ ccon0)))).
thf(apiord_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnpi) => (cword @ XA2)))).
thf(aniex_thm,axiom,(cwcel @ ccnpi @ ccvv)).
...
thf(amulpiord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) => ((cco @ XA2 @ XB2 @ ccmi) = (cco @ XA2 @ XB2 @ ccomu)))))).
...
thf(aaddasspi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cco @ (cco @ XA2 @ XB2 @ ccpli) @ XC @ ccpli) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccpli) @ ccpli)))))).
...
thf(aaddcanpi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) => (((cco @ XA2 @ XB2 @ ccpli) = (cco @ XA2 @ XC @ ccpli)) <=> (XB2 = XC))))))).
