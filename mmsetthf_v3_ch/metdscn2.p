...
thf(acnmpt1ds_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccfv @ XG @ ccds)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XR = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwcel @ XG @ ccmt)) => ((Xph => (cwcel @ XK @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XK @ XJ @ cccn))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XK @ XJ @ cccn))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XD))) @ (cco @ XK @ XR @ cccn)))))))))))))))))))).
thf(acnmpt2ds_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XD = (ccfv @ XG @ ccds)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XR = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwcel @ XG @ ccmt)) => ((! [Xy1:$i] : (Xph => (cwcel @ (XK @ Xy1) @ (ccfv @ XX @ cctopon)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XL @ Xx3 @ Xy1) @ (ccfv @ XY @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XK @ Xy1) @ (XL @ Xx3 @ Xy1) @ cctx) @ XJ @ cccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XK @ Xy1) @ (XL @ Xx3 @ Xy1) @ cctx) @ XJ @ cccn))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1) @ XD)))) @ (cco @ (cco @ (XK @ Xy1) @ (XL @ Xx3 @ Xy1) @ cctx) @ XR @ cccn))))))))))))))))))))))))).
...
thf(angnmcncn_thm,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XG @ ccngp) => (cwcel @ XN @ (cco @ XJ @ XK @ cccn))))))))))).
thf(aabscn_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwcel @ ccabs @ (cco @ XJ @ XK @ cccn))))))).
thf(ametdsval_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XA2 @ XX) => ((ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) = (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))))))))).
thf(ametdsf_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xx3 @ Xy1))))))))))).
thf(ametdsge_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX) & (cwcel @ XA2 @ XX)) & (cwcel @ (XR @ Xx3 @ Xy1) @ ccxr)) => ((cwbr @ (XR @ Xx3 @ Xy1) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ ccle) <=> ((ccin @ XS @ (cco @ XA2 @ (XR @ Xx3 @ Xy1) @ (ccfv @ XD @ ccbl))) = cc0))))))))))))).
thf(ametds0_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX) & (cwcel @ XA2 @ XS)) => ((ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) = ccc0))))))))))).
thf(ametdstri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => (cwbr @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ (cco @ (cco @ XA2 @ XB2 @ XD) @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1)) @ ccxad) @ ccle)))))))))))).
thf(ametdsle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) & ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XX))) => (cwbr @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1)) @ (cco @ XA2 @ XB2 @ XD) @ ccle)))))))))))).
thf(ametdsre_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XD @ (ccfv @ XX @ ccme)) & (cwss @ XS @ XX) & (XS != cc0)) => (cwf @ XX @ ccr @ (XF @ Xx3 @ Xy1))))))))))).
thf(ametdseq0_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX) & (cwcel @ XA2 @ XX)) => (((ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) = ccc0) <=> (cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ (XJ @ Xx3) @ cccl)))))))))))))))).
thf(ametdscnlem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xx3 @ Xy1) = (ccfv @ ccxrs @ ccds)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ (XC @ Xx3 @ Xy1) @ ccmopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XD @ (ccfv @ XX @ ccxmt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XS @ XX)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XA2 @ XX)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XB2 @ XX)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XR @ Xx3 @ Xy1) @ ccrp)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwbr @ (cco @ XA2 @ XB2 @ XD) @ (XR @ Xx3 @ Xy1) @ cclt)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwbr @ (cco @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ (ccxne @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1))) @ ccxad) @ (XR @ Xx3 @ Xy1) @ cclt)))))))))))))))))))))))))).
thf(ametdscn_thm,axiom,(! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xx3 @ Xy1) = (ccfv @ ccxrs @ ccds)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ (XC @ Xx3 @ Xy1) @ ccmopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3 @ Xy1) @ cccn))))))))))))))))).
thf(ametdscn2_thm,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ cccnfld @ cctopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XD @ (ccfv @ XX @ ccme)) & (cwss @ XS @ XX) & (XS != cc0)) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3 @ Xy1) @ cccn))))))))))))))).
