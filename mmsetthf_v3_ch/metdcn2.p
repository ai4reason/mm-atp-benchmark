...
thf(ametdcn2_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwcel @ XD @ (ccfv @ XX @ ccme)) => (cwcel @ XD @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn)))))))))).
