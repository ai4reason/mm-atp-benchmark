...
thf(aperfect1_thm,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccz) & (cwcel @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccprime)) => ((cco @ cc1 @ (cco @ (cco @ cc2 @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccmul) @ ccsgm) = (cco @ (cco @ cc2 @ XP @ ccexp) @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccmul))))).
