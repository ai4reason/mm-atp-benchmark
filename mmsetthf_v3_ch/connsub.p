...
thf(aconnsub_thm,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwss @ XS @ XX)) => ((cwcel @ (cco @ XJ @ XS @ ccrest) @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((((ccin @ (ccv @ Xx3) @ XS) != cc0) & ((ccin @ (ccv @ Xy1) @ XS) != cc0) & (cwss @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccdif @ XX @ XS))) => (~ (cwss @ XS @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))))))).
