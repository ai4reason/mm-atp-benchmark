...
thf(ashftcan1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ XB2 @ (cco @ (cco @ XF @ XA2 @ ccshi) @ (ccneg @ XA2) @ ccshi)) = (ccfv @ XB2 @ XF)))))))).
