...
thf(arexanre_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : ((cwss @ XA2 @ ccr) => ((cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) => ((Xph @ Xk) & (Xps @ Xk)))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : ccr)) <=> ((cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) => (Xph @ Xk))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : ccr)) & (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) => (Xps @ Xk))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : ccr))))))))).
