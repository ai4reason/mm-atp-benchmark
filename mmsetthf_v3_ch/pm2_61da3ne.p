...
thf(apm2_61da3ne_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((Xph & (XA2 = XB2)) => Xps) => (((Xph & (XC = XD)) => Xps) => (((Xph & (XE = XF)) => Xps) => (((Xph & ((XA2 != XB2) & (XC != XD) & (XE != XF))) => Xps) => (Xph => Xps)))))))))))))).
