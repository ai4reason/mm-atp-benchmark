...
thf(aopelopabsbALT_thm,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ (ccop @ (ccv @ Xz) @ (ccv @ Xw)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) <=> ((^ [Xy1:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xz)) @ Xw)))))).
