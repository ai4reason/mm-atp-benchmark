...
thf(atsmslem1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XS = (ccin @ (ccpw @ XA2) @ ccfn)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XA2 @ XW)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph & (cwcel @ XX @ XS)) => (cwcel @ (cco @ XG @ (ccres @ XF @ XX) @ ccgsu) @ XB2)))))))))))))))).
