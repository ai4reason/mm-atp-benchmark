...
thf(afipreima_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XB2) & (cwss @ XA2 @ (ccrn @ XF)) & (cwcel @ XA2 @ ccfn)) => (cwrex @ (^ [Xc:$i] : ((ccima @ XF @ (ccv @ Xc)) = XA2)) @ (^ [Xc:$i] : (ccin @ (ccpw @ XB2) @ ccfn)))))))).
