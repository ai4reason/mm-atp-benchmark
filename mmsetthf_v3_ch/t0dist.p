...
thf(at0dist_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cct0) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (XA2 != XB2))) => (cwrex @ (^ [Xo:$i] : (~ ((cwcel @ XA2 @ (ccv @ Xo)) <=> (cwcel @ XB2 @ (ccv @ Xo))))) @ (^ [Xo:$i] : XJ))))))))).
