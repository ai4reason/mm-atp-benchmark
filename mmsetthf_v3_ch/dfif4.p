...
thf(adfif4_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (^ [Xx3:$i] : Xph))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccin @ (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (ccin @ (ccun @ (XA2 @ Xx3) @ (ccdif @ ccvv @ (XC @ Xx3))) @ (ccun @ (XB2 @ Xx3) @ (XC @ Xx3)))))))))))).
