...
thf(acsbprg_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ (XC @ Xx3) @ (XV @ Xx3)) => ((ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (ccpr @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) = (ccpr @ (ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))).
