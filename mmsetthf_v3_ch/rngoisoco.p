...
thf(arngoisoco_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XT @ ccrngo)) & ((cwcel @ XF @ (cco @ XR @ XS @ ccrngiso)) & (cwcel @ XG @ (cco @ XS @ XT @ ccrngiso)))) => (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccrngiso))))))))).
