...
thf(azrhcopsgndif_thm,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : ((XS @ Xq) = (ccfv @ (XN @ Xq) @ ccpsgn))) => ((! [Xq:$i] : ((XZ @ Xq) = (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpsgn))) => ((! [Xq:$i] : ((XY @ Xq) = (ccfv @ (XR @ Xq) @ cczrh))) => (! [Xq:$i] : (((cwcel @ (XN @ Xq) @ ccfn) & (cwcel @ XK @ (XN @ Xq))) => ((cwcel @ XQ @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : XP))) => ((ccfv @ (ccres @ XQ @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) @ (cccom @ (XY @ Xq) @ (XZ @ Xq))) = (ccfv @ XQ @ (cccom @ (XY @ Xq) @ (XS @ Xq)))))))))))))))))))).
