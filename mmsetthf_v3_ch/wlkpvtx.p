...
thf(awlkpvtx_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) => ((cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz)) => (cwcel @ (ccfv @ XN @ XP) @ XV)))))))))).
