...
thf(awlk1walk_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : ((! [Xk:$i] : ((XI @ Xk) = (ccfv @ XG @ cciedg))) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) => (cwral @ (^ [Xk:$i] : (cwbr @ cc1 @ (ccfv @ (ccin @ (ccfv @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ XF) @ (XI @ Xk)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (XI @ Xk))) @ cchash) @ ccle)) @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
