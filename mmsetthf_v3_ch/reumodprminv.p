...
thf(areumodprminv_thm,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ (cco @ cc1 @ XP @ ccfzo))) => (cwreu @ (^ [Xi:$i] : ((cco @ (cco @ XN @ (ccv @ Xi) @ ccmul) @ XP @ ccmo) = cc1)) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))))))).
