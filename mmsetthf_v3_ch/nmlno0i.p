...
thf(anmlno0i_thm,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XN = (cco @ XU @ XW @ ccnmoo)) => ((XZ = (cco @ XU @ XW @ cc0o)) => ((XL = (cco @ XU @ XW @ cclno)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => ((cwcel @ XT @ XL) => (((ccfv @ XT @ XN) = ccc0) <=> (XT = XZ))))))))))))))).
