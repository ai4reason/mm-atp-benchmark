...
thf(arankbnd2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccon0) => ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ XB2)) @ (^ [Xx3:$i] : XA2)) <=> (cwss @ (ccfv @ XA2 @ ccrnk) @ (ccsuc @ XB2)))))))).
