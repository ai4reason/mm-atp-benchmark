...
thf(aisfil_thm,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) <=> ((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwral @ (^ [Xx3:$i] : (((ccin @ XF @ (ccpw @ (ccv @ Xx3))) != cc0) => (cwcel @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
