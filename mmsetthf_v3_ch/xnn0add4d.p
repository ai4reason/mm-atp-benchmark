...
thf(axnn0add4d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxnn0)) => ((Xph => (cwcel @ XB2 @ ccxnn0)) => ((Xph => (cwcel @ XC @ ccxnn0)) => ((Xph => (cwcel @ XD @ ccxnn0)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ (cco @ XC @ XD @ ccxad) @ ccxad) = (cco @ (cco @ XA2 @ XC @ ccxad) @ (cco @ XB2 @ XD @ ccxad) @ ccxad))))))))))))).
