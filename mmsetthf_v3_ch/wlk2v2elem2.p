...
thf(awlk2v2elem2_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (XI = (ccs1 @ (ccpr @ (XX @ Xk) @ (XY @ Xk))))) => ((XF = (ccs2 @ ccc0 @ ccc0)) => ((! [Xk:$i] : (cwcel @ (XX @ Xk) @ ccvv)) => ((! [Xk:$i] : (cwcel @ (XY @ Xk) @ ccvv)) => ((! [Xk:$i] : (XP = (ccs3 @ (XX @ Xk) @ (XY @ Xk) @ (XX @ Xk)))) => (cwral @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) = (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))))).
