...
thf(apcprecl_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : ((XS @ Xn) = (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => ((cwcel @ (XS @ Xn) @ ccn0) & (cwbr @ (cco @ XP @ (XS @ Xn) @ ccexp) @ XN @ ccdvds))))))))))).
