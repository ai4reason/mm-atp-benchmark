...
thf(aefopnlem2_thm,conjecture,(! [XR:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (((cwcel @ XR @ ccrp) & (cwbr @ XR @ ccpi @ cclt)) => (cwcel @ (ccima @ cce @ (cco @ ccc0 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) @ XJ)))))).
