...
thf(asin01bnd_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) => ((cwbr @ (cco @ XA2 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ (ccfv @ XA2 @ ccsin) @ cclt) & (cwbr @ (ccfv @ XA2 @ ccsin) @ XA2 @ cclt))))).
