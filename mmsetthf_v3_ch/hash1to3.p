...
thf(ahash1to3_thm,conjecture,(! [XV:($i > $o)] : (((cwcel @ XV @ ccfn) & (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ ccle) & (cwbr @ (ccfv @ XV @ cchash) @ cc3 @ ccle)) => (? [Xa:$i] : (? [Xb:$i] : (? [Xc:$i] : ((XV = (ccsn @ (ccv @ Xa))) | (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) | (XV = (cctp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc)))))))))).
