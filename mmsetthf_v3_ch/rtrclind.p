...
thf(artrclind_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((Xet => (cwrel @ XR)) => ((Xet => (cwcel @ XR @ ccvv)) => ((Xet => (cwcel @ XS @ ccvv)) => ((! [Xi:$i] : (! [Xj:$i] : (Xet => (cwcel @ (XX @ Xi @ Xj) @ ccvv)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (((ccv @ Xi) = XS) => ((Xph @ Xi) <=> (Xch @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (((ccv @ Xi) = (ccv @ Xx3)) => ((Xph @ Xi) <=> (Xps @ Xx3))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) => ((Xph @ Xi) <=> (Xth @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (((ccv @ Xx3) = (XX @ Xi @ Xj)) => ((Xps @ Xx3) <=> (Xta @ Xi @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (Xet => (Xch @ Xx3 @ Xj)))) => ((! [Xx3:$i] : (! [Xj:$i] : (Xet => ((cwbr @ (ccv @ Xj) @ (ccv @ Xx3) @ XR) => ((Xth @ Xx3 @ Xj) => (Xps @ Xx3)))))) => (! [Xi:$i] : (! [Xj:$i] : (Xet => ((cwbr @ XS @ (XX @ Xi @ Xj) @ (ccfv @ XR @ ccrtcl)) => (Xta @ Xi @ Xj))))))))))))))))))))))))).
