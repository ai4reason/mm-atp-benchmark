...
thf(aacsficld_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccacs))) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((Xph => (cwss @ XS @ XX)) => (Xph => ((ccfv @ XS @ XN) = (ccuni @ (ccima @ XN @ (ccin @ (ccpw @ XS) @ ccfn)))))))))))))).
