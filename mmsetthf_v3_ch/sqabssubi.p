...
thf(asqabssubi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ cc2 @ ccexp) = (cco @ (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ XB2 @ ccabs) @ cc2 @ ccexp) @ ccaddc) @ (cco @ cc2 @ (ccfv @ (cco @ XA2 @ (ccfv @ XB2 @ cccj) @ ccmul) @ ccre) @ ccmul) @ ccmin))))))).
