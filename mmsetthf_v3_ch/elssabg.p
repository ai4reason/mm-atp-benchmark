...
thf(aelssabg_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : ((cwcel @ XB2 @ (XV @ Xx3)) => ((cwcel @ XA2 @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XB2) & (Xph @ Xx3)))) <=> ((cwss @ XA2 @ XB2) & Xps))))))))))).
