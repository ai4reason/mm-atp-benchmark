...
thf(axmulcand_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (XC != ccc0)) => (Xph => (((cco @ XC @ XA2 @ ccxmu) = (cco @ XC @ XB2 @ ccxmu)) <=> (XA2 = XB2)))))))))))).
