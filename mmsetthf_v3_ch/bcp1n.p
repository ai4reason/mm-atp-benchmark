...
thf(abcp1n_thm,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccbc) = (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccmin) @ ccdiv) @ ccmul)))))).
