...
thf(a_2lgsoddprm_thm,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) => ((cco @ cc2 @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XP @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccexp))))).
