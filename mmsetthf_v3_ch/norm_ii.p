...
thf(anorm_ii_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ (cco @ (ccfv @ XA2 @ ccno) @ (ccfv @ XB2 @ ccno) @ ccaddc) @ ccle))))).
