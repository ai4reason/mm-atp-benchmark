...
thf(adifelfzle_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwbr @ XK @ XM @ ccle)) => (cwcel @ (cco @ XM @ XK @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))))).
