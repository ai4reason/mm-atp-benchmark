...
thf(ascshwfzeqfzo_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ (ccword @ XV)) & (XX != cc0) & (XN = (ccfv @ XX @ cchash))) => ((ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (ccword @ XV))) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfzo)))) @ (^ [Xy1:$i] : (ccword @ XV))))))))).
