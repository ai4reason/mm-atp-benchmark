...
thf(amumul_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & ((cco @ XA2 @ XB2 @ ccgcd) = cc1)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccmu) = (cco @ (ccfv @ XA2 @ ccmu) @ (ccfv @ XB2 @ ccmu) @ ccmul)))))).
