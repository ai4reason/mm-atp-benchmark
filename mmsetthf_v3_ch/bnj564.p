...
thf(abnj564_thm,conjecture,(! [Xta:($i > ($i > $o))] : (! [Xbnjwphm:($i > ($i > $o))] : (! [Xbnjwpsm:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xm:$i] : ((Xta @ Xf1 @ Xm) <=> ((cwfn @ (ccv @ Xf1) @ (ccv @ Xm)) & (Xbnjwphm @ Xf1 @ Xm) & (Xbnjwpsm @ Xf1 @ Xm))))) => (! [Xf1:$i] : (! [Xm:$i] : ((Xta @ Xf1 @ Xm) => ((ccdm @ (ccv @ Xf1)) = (ccv @ Xm)))))))))).
