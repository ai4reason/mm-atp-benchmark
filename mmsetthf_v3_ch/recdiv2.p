...
thf(arecdiv2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) & ((cwcel @ XB2 @ ccc) & (XB2 != ccc0))) => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ ccdiv) = (cco @ cc1 @ (cco @ XA2 @ XB2 @ ccmul) @ ccdiv)))))).
