...
thf(areusv2_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (((cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XC @ Xy1) @ XA2))) @ (^ [Xy1:$i] : (XB2 @ Xy1))) & (cwrex @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) => ((cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : XA2)) <=> (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : XA2))))))))).
