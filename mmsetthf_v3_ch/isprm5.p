...
thf(aisprm5_thm,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) <=> ((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwral @ (^ [Xz:$i] : ((cwbr @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ XP @ ccle) => (~ (cwbr @ (ccv @ Xz) @ XP @ ccdvds)))) @ (^ [Xz:$i] : ccprime)))))).
