...
thf(amnd1id_thm,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccsn @ XI)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccsn @ (ccop @ (ccop @ XI @ XI) @ XI))))) => ((cwcel @ XI @ XV) => ((ccfv @ XM @ cc0g) = XI))))))).
...
thf(adf_submnd_ax,axiom,(ccsubmnd = (ccmpt @ (^ [Xs1:$i] : ccmnd) @ (^ [Xs1:$i] : (ccrab @ (^ [Xt:$i] : ((cwcel @ (ccfv @ (ccv @ Xs1) @ cc0g) @ (ccv @ Xt)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xs1) @ ccplusg)) @ (ccv @ Xt))) @ (^ [Xy1:$i] : (ccv @ Xt)))) @ (^ [Xx3:$i] : (ccv @ Xt))))) @ (^ [Xt:$i] : (ccpw @ (ccfv @ (ccv @ Xs1) @ ccbs)))))))).
...
thf(amhmf1o_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (ccfv @ XS @ ccbs)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccmhm)) => ((cwf1o @ XB2 @ XC @ XF) <=> (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ ccmhm)))))))))))).
...
thf(aissubm2_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => ((XH = (cco @ XM @ XS @ ccress)) => ((cwcel @ XM @ ccmnd) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) <=> ((cwss @ XS @ XB2) & (cwcel @ Xc_0 @ XS) & (cwcel @ XH @ ccmnd))))))))))))).
thf(aissubmd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (XB2 = (ccfv @ (XM @ Xz) @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_pl @ Xx3 @ Xy1) = (ccfv @ (XM @ Xz) @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ (XM @ Xz) @ cc0g))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XM @ Xz) @ ccmnd))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => (Xch @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xz) & (((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2)) & ((Xth @ Xx3 @ Xy1) & (Xta @ Xx3 @ Xy1)))) => (Xet @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (Xc_0 @ Xx3 @ Xy1)) => ((Xps @ Xz) <=> (Xch @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccv @ Xx3)) => ((Xps @ Xz) <=> (Xth @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccv @ Xy1)) => ((Xps @ Xz) <=> (Xta @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1))) => ((Xps @ Xz) <=> (Xet @ Xx3 @ Xy1)))))) => (! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (ccrab @ (^ [Xz:$i] : (Xps @ Xz)) @ (^ [Xz:$i] : XB2)) @ (ccfv @ (XM @ Xz) @ ccsubmnd))))))))))))))))))))))))).
thf(asubmss_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) => (cwss @ XS @ XB2))))))).
thf(asubmid_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((cwcel @ XM @ ccmnd) => (cwcel @ XB2 @ (ccfv @ XM @ ccsubmnd))))))).
thf(asubm0cl_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XM @ cc0g)) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) => (cwcel @ Xc_0 @ XS))))))).
thf(asubmcl_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_pl = (ccfv @ XM @ ccplusg)) => (((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) & (cwcel @ XX @ XS) & (cwcel @ XY @ XS)) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XS))))))))).
thf(asubmmnd_thm,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((XH = (cco @ XM @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) => (cwcel @ XH @ ccmnd))))))).
thf(asubmbas_thm,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((XH = (cco @ XM @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) => (XS = (ccfv @ XH @ ccbs)))))))).
thf(asubm0_thm,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (cco @ XM @ XS @ ccress)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) => (Xc_0 = (ccfv @ XH @ cc0g)))))))))).
thf(asubsubm_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) => ((cwcel @ XA2 @ (ccfv @ XH @ ccsubmnd)) <=> ((cwcel @ XA2 @ (ccfv @ XG @ ccsubmnd)) & (cwss @ XA2 @ XS)))))))))).
...
thf(aresmhm_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) & (cwcel @ XX @ (ccfv @ XS @ ccsubmnd))) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccmhm)))))))))).
thf(aresmhm2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XU @ ccmhm)) & (cwcel @ XX @ (ccfv @ XT @ ccsubmnd))) => (cwcel @ XF @ (cco @ XS @ XT @ ccmhm)))))))))).
thf(aresmhm2b_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XX @ (ccfv @ XT @ ccsubmnd)) & (cwss @ (ccrn @ XF) @ XX)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) <=> (cwcel @ XF @ (cco @ XS @ XU @ ccmhm))))))))))).
...
thf(amhmima_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (cco @ XM @ XN @ ccmhm)) & (cwcel @ XX @ (ccfv @ XM @ ccsubmnd))) => (cwcel @ (ccima @ XF @ XX) @ (ccfv @ XN @ ccsubmnd)))))))).
thf(amhmeql_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccmhm))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XS @ ccsubmnd)))))))).
thf(asubmacs_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XG @ ccmnd) => (cwcel @ (ccfv @ XG @ ccsubmnd) @ (ccfv @ XB2 @ ccacs))))))).
thf(amrcmndind_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl)) => ((Xps @ Xx3) <=> (Xth @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (Xc_0 @ Xy1 @ Xz)) => ((Xps @ Xx3) <=> (Xta @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (XA2 @ Xy1 @ Xz)) => ((Xps @ Xx3) <=> (Xet @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_0 @ Xy1 @ Xz) = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ cc0g))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xc_pl = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XB2 @ Xx3) = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xy1 @ Xz) @ ccmnd))))) => ((! [Xx3:$i] : (Xph => (cwss @ (XG @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((XB2 @ Xx3) = (ccfv @ (XG @ Xx3) @ (ccfv @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccsubmnd) @ ccmrc))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xph => (Xta @ Xy1 @ Xz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3)) & (cwcel @ (ccv @ Xz) @ (XG @ Xx3))) & (Xch @ Xy1)) => (Xth @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xx3)))))) => (! [Xy1:$i] : (! [Xz:$i] : (Xph => (Xet @ Xy1 @ Xz)))))))))))))))))))))))))))))).
