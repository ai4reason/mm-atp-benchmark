...
thf(acygzn_thm,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XN = (ccif @ (cwcel @ XB2 @ ccfn) @ (ccfv @ XB2 @ cchash) @ ccc0)) => ((XY = (ccfv @ XN @ cczn)) => ((cwcel @ XG @ cccyg) => (cwbr @ XG @ XY @ ccgic)))))))))).
