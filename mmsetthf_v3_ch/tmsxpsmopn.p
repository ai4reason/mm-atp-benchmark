...
thf(atmsxpsmopn_thm,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ (cco @ (ccfv @ XM @ cctmt) @ (ccfv @ XN @ cctmt) @ ccxps) @ ccds)) => ((Xph => (cwcel @ XM @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((XJ = (ccfv @ XM @ ccmopn)) => ((XK = (ccfv @ XN @ ccmopn)) => ((XL = (ccfv @ XP @ ccmopn)) => (Xph => (XL = (cco @ XJ @ XK @ cctx))))))))))))))))))).
