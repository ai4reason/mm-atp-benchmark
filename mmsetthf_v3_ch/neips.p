...
thf(aneips_thm,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & (XS != cc0)) => ((cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) <=> (cwral @ (^ [Xp:$i] : (cwcel @ XN @ (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei)))) @ (^ [Xp:$i] : XS)))))))))).
