...
thf(apr2pwpr_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xp:$i] : (((cwcel @ XA2 @ (XV @ Xp)) & (cwcel @ XB2 @ (XW @ Xp)) & (XA2 != XB2)) => ((ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ cc2o @ ccen)) @ (^ [Xp:$i] : (ccpw @ (ccpr @ XA2 @ XB2)))) = (ccsn @ (ccpr @ XA2 @ XB2)))))))))).
