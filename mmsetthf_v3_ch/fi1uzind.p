...
thf(aelss2prb_thm,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XP @ (ccrab @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ cchash) = cc2)) @ (^ [Xz:$i] : (ccpw @ XV)))) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & (XP = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV)))))).
thf(ahash2sspr_thm,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XP @ (ccpw @ XV)) & ((ccfv @ XP @ cchash) = cc2)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (XP = (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))).
thf(aexprelprel_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xe:$i] : ((cwrex @ (^ [Xp:$i] : (cwcel @ (ccv @ Xp) @ (XX @ Xe))) @ (^ [Xp:$i] : (ccrab @ (^ [Xe:$i] : ((ccfv @ (ccv @ Xe) @ cchash) = cc2)) @ (^ [Xe:$i] : (ccpw @ XV))))) => (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ (XX @ Xe))) @ (^ [Xw:$i] : XV))) @ (^ [Xv:$i] : XV))))))).
thf(ahash3tr_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((cwcel @ XV @ (XW @ Xa @ Xb @ Xc)) & ((ccfv @ XV @ cchash) = cc3)) => (? [Xa:$i] : (? [Xb:$i] : (? [Xc:$i] : (XV = (cctp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc))))))))))))).
thf(ahash1to3_thm,axiom,(! [XV:($i > $o)] : (((cwcel @ XV @ ccfn) & (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ ccle) & (cwbr @ (ccfv @ XV @ cchash) @ cc3 @ ccle)) => (? [Xa:$i] : (? [Xb:$i] : (? [Xc:$i] : ((XV = (ccsn @ (ccv @ Xa))) | (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) | (XV = (cctp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc)))))))))).
thf(afundmge2nop0_thm,axiom,(! [XG:($i > $o)] : (((cwfun @ (ccdif @ XG @ (ccsn @ cc0))) & (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) => (~ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)))))).
thf(afundmge2nop_thm,axiom,(! [XG:($i > $o)] : (((cwfun @ XG) & (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) => (~ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)))))).
...
thf(afun2dmnop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((cwfun @ XG) & (XA2 != XB2) & (cwss @ (ccpr @ XA2 @ XB2) @ (ccdm @ XG))) => (~ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)))))))))).
thf(abrfi1indlem_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XV @ XW) & (cwcel @ XN @ XV) & (cwcel @ XY @ ccn0)) => (((ccfv @ XV @ cchash) = (cco @ XY @ cc1 @ ccaddc)) => ((ccfv @ (ccdif @ XV @ (ccsn @ XN)) @ cchash) = XY)))))))).
thf(afi1uzind_thm,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xrh:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwcel @ (XF @ Xy1 @ Xv @ Xe @ Xn @ Xb) @ ccvv)))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwcel @ (XL @ Xw @ Xf1 @ Xa @ Xb) @ ccn0))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((ccv @ Xv) = (XV @ Xy1 @ Xw @ Xf1)) & ((ccv @ Xe) = (XE @ Xy1 @ Xw @ Xf1 @ Xb))) => ((Xps @ Xv @ Xe @ Xa @ Xb) <=> (Xph @ Xy1 @ Xw @ Xf1 @ Xa @ Xb)))))))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((ccv @ Xv) = (ccv @ Xw)) & ((ccv @ Xe) = (ccv @ Xf1))) => ((Xps @ Xv @ Xe @ Xa @ Xb) <=> (Xth @ Xy1 @ Xw @ Xf1 @ Xa @ Xb)))))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xn:$i] : (! [Xb:$i] : (((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xrh @ Xa @ Xb)) @ (ccv @ Xe))) @ (ccv @ Xv)) & (cwcel @ (ccv @ Xn) @ (ccv @ Xv))) => (cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xrh @ Xa @ Xb)) @ (XF @ Xy1 @ Xv @ Xe @ Xn @ Xb))) @ (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xn)))))))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((ccv @ Xw) = (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xn)))) & ((ccv @ Xf1) = (XF @ Xy1 @ Xv @ Xe @ Xn @ Xb))) => ((Xth @ Xy1 @ Xw @ Xf1 @ Xa @ Xb) <=> (Xch @ Xy1 @ Xv @ Xe @ Xn @ Xa @ Xb))))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xrh @ Xa @ Xb)) @ (ccv @ Xe))) @ (ccv @ Xv)) & ((ccfv @ (ccv @ Xv) @ cchash) = (XL @ Xw @ Xf1 @ Xa @ Xb))) => (Xps @ Xv @ Xe @ Xa @ Xb)))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((cwcel @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccn0) & ((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xrh @ Xa @ Xb)) @ (ccv @ Xe))) @ (ccv @ Xv)) & ((ccfv @ (ccv @ Xv) @ cchash) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) & (cwcel @ (ccv @ Xn) @ (ccv @ Xv)))) & (Xch @ Xy1 @ Xv @ Xe @ Xn @ Xa @ Xb)) => (Xps @ Xv @ Xe @ Xa @ Xb)))))))) => (! [Xy1:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xrh @ Xa @ Xb)) @ (XE @ Xy1 @ Xw @ Xf1 @ Xb))) @ (XV @ Xy1 @ Xw @ Xf1)) & (cwcel @ (XV @ Xy1 @ Xw @ Xf1) @ ccfn) & (cwbr @ (XL @ Xw @ Xf1 @ Xa @ Xb) @ (ccfv @ (XV @ Xy1 @ Xw @ Xf1) @ cchash) @ ccle)) => (Xph @ Xy1 @ Xw @ Xf1 @ Xa @ Xb))))))))))))))))))))))))).
