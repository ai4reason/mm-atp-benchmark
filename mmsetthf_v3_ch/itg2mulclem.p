...
thf(aitg2mulclem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => ((Xph => (cwcel @ XA2 @ ccrp)) => (Xph => (cwbr @ (ccfv @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccitg2) @ (cco @ XA2 @ (ccfv @ XF @ ccitg2) @ ccmul) @ ccle))))))))).
