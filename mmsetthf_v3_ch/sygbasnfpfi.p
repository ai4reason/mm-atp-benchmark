...
thf(asygbasnfpfi_thm,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccfv @ XD @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XD @ ccfn) & (cwcel @ XP @ XB2)) => (cwcel @ (ccdm @ (ccdif @ XP @ ccid)) @ ccfn))))))))).
