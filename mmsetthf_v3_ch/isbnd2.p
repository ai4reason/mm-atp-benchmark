...
thf(aisbnd2_thm,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccbnd)) & (XX != cc0)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
