...
thf(anffo_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((? [X:$i] : ((^ [Xx3:$i] : (cwfo @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XF @ Xx3))) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (cwfo @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XF @ Xx3))) @ X)))))))))).
