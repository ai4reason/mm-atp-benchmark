...
thf(assnei2_thm,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))) & ((cwss @ XN @ XM) & (cwss @ XM @ XX))) => (cwcel @ XM @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))))).
