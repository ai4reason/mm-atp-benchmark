...
thf(accatws1lenp1b_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccn0)) => (((ccfv @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ cchash) = (cco @ XN @ cc1 @ ccaddc)) <=> ((ccfv @ XW @ cchash) = XN)))))))).
