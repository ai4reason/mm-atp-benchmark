...
thf(apsgnfix1_thm,conjecture,(! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xw:$i] : (! [Xq:$i] : ((XP @ Xw) = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs)))) => ((! [Xq:$i] : ((XT @ Xq) = (ccrn @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpmtr)))) => ((! [Xq:$i] : ((XS @ Xq) = (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccsymg))) => (! [Xw:$i] : (! [Xq:$i] : (((cwcel @ (XN @ Xq) @ ccfn) & (cwcel @ XK @ (XN @ Xq))) => ((cwcel @ (XQ @ Xq) @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : (XP @ Xw)))) => (cwrex @ (^ [Xw:$i] : ((ccres @ (XQ @ Xq) @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) = (cco @ (XS @ Xq) @ (ccv @ Xw) @ ccgsu))) @ (^ [Xw:$i] : (ccword @ (XT @ Xq)))))))))))))))))).
