...
thf(anmhmcn_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cctopn)) => ((XK = (ccfv @ XT @ cctopn)) => ((XG = (ccfv @ XS @ ccsca)) => ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XS @ (ccin @ ccnlm @ ccclm)) & (cwcel @ XT @ (ccin @ ccnlm @ ccclm)) & (cwss @ ccq @ XB2)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnmhm)) <=> ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))))))))).
