...
thf(aswrd0f_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (cwf @ (cco @ ccc0 @ XN @ ccfzo) @ XV @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr))))))).
