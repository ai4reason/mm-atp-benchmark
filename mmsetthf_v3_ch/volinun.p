...
thf(avolinun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ (ccdm @ ccvol))) & ((cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) & (cwcel @ (ccfv @ XB2 @ ccvol) @ ccr))) => ((cco @ (ccfv @ XA2 @ ccvol) @ (ccfv @ XB2 @ ccvol) @ ccaddc) = (cco @ (ccfv @ (ccin @ XA2 @ XB2) @ ccvol) @ (ccfv @ (ccun @ XA2 @ XB2) @ ccvol) @ ccaddc)))))).
