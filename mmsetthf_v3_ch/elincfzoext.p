...
thf(aelincfzoext_thm,conjecture,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XZ @ (cco @ XM @ XN @ ccfzo)) & (cwcel @ XI @ ccn0)) => (cwcel @ (cco @ XZ @ XI @ ccaddc) @ (cco @ XM @ (cco @ XN @ XI @ ccaddc) @ ccfzo)))))))).
