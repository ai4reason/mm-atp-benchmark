...
thf(amodadd12d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwcel @ XE @ ccrp)) => ((Xph => ((cco @ XA2 @ XE @ ccmo) = (cco @ XB2 @ XE @ ccmo))) => ((Xph => ((cco @ XC @ XE @ ccmo) = (cco @ XD @ XE @ ccmo))) => (Xph => ((cco @ (cco @ XA2 @ XC @ ccaddc) @ XE @ ccmo) = (cco @ (cco @ XB2 @ XD @ ccaddc) @ XE @ ccmo))))))))))))))))).
