...
thf(apjeq_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => (((ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) = XB2) <=> ((cwcel @ XB2 @ XH) & (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ XB2 @ (ccv @ Xx3) @ ccva))) @ (^ [Xx3:$i] : (ccfv @ XH @ ccort)))))))))).
