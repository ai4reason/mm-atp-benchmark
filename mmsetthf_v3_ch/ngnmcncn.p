...
thf(angnmcncn_thm,conjecture,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XG @ ccngp) => (cwcel @ XN @ (cco @ XJ @ XK @ cccn))))))))))).
