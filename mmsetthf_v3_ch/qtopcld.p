...
thf(aqtopcld_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwfo @ XX @ XY @ XF)) => ((cwcel @ XA2 @ (ccfv @ (cco @ XJ @ XF @ ccqtop) @ cccld)) <=> ((cwss @ XA2 @ XY) & (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ (ccfv @ XJ @ cccld))))))))))).
