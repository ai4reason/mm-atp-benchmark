...
thf(astrle2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XI @ ccn) => ((XA2 = XI) => ((cwbr @ XI @ XJ @ cclt) => ((cwcel @ XJ @ ccn) => ((XB2 = XJ) => (cwbr @ (ccpr @ (ccop @ XA2 @ XX) @ (ccop @ XB2 @ XY)) @ (ccop @ XI @ XJ) @ ccstr))))))))))))).
