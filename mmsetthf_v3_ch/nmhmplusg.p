...
thf(anmhmplusg_thm,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xc_pl = (ccfv @ XT @ ccplusg)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccnmhm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccnmhm))) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ (cco @ XS @ XT @ ccnmhm)))))))))).
