...
thf(alcmdvdsb_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (((cwbr @ XM @ XK @ ccdvds) & (cwbr @ XN @ XK @ ccdvds)) <=> (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccdvds))))))).
