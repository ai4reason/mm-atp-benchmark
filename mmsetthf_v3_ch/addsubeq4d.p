...
thf(aaddsubeq4d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => (Xph => (((cco @ XA2 @ XB2 @ ccaddc) = (cco @ XC @ XD @ ccaddc)) <=> ((cco @ XC @ XA2 @ ccmin) = (cco @ XB2 @ XD @ ccmin)))))))))))))).
