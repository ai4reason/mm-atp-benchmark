...
thf(azrhpsgnodpm_thm,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XI = (ccfv @ XR @ ccminusg)) => (((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn) & (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XN @ ccevpm)))) => ((ccfv @ XF @ (cccom @ XY @ XS)) = (ccfv @ Xc_1 @ XI))))))))))))))))).
