...
thf(anorm3lem_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => ((cwcel @ XD @ ccr) => (((cwbr @ (ccfv @ (cco @ XA2 @ XC @ ccmv) @ ccno) @ (cco @ XD @ cc2 @ ccdiv) @ cclt) & (cwbr @ (ccfv @ (cco @ XC @ XB2 @ ccmv) @ ccno) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ XD @ cclt))))))))))).
