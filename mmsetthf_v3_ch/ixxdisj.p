...
thf(axrsupexmnf_thm,axiom,(! [XA2:($i > $o)] : ((cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr)) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt))) @ (^ [Xy1:$i] : (ccun @ XA2 @ (ccsn @ ccmnf)))) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ ccmnf)))))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr))))).
thf(axrinfmexpnf_thm,axiom,(! [XA2:($i > $o)] : ((cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr)) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt))) @ (^ [Xy1:$i] : (ccun @ XA2 @ (ccsn @ ccpnf)))) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ cclt)) @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ ccpnf)))))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr))))).
thf(axrsupsslem_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccxr) & ((cwss @ XA2 @ ccr) | (cwcel @ ccpnf @ XA2))) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr))))).
thf(axrinfmsslem_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccxr) & ((cwss @ XA2 @ ccr) | (cwcel @ ccmnf @ XA2))) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr))))).
...
thf(axrinfmss_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr))))).
...
thf(axrub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccxr))))))).
thf(asupxr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwral @ (^ [Xx3:$i] : (~ (cwbr @ XB2 @ (ccv @ Xx3) @ cclt))) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)))) => ((ccsup @ XA2 @ ccxr @ cclt) = XB2))))).
thf(asupxr2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ ccle)) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)))) => ((ccsup @ XA2 @ ccxr @ cclt) = XB2))))).
thf(asupxrcl_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => (cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccxr)))).
thf(asupxrun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwss @ XB2 @ ccxr) & (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle)) => ((ccsup @ (ccun @ XA2 @ XB2) @ ccxr @ cclt) = (ccsup @ XB2 @ ccxr @ cclt)))))).
thf(asupxrmnf_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccsup @ (ccun @ XA2 @ (ccsn @ ccmnf)) @ ccxr @ cclt) = (ccsup @ XA2 @ ccxr @ cclt))))).
thf(asupxrpnf_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ ccpnf @ XA2)) => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)))).
thf(asupxrunb1_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) <=> ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf))))).
thf(asupxrunb2_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) <=> ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf))))).
thf(asupxrbnd1_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) <=> (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt))))).
thf(asupxrbnd2_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) <=> (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt))))).
...
thf(asupxrlub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ cclt) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(asupxrbnd_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (XA2 != cc0) & (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt)) => (cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccr)))).
thf(asupxrgtmnf_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (XA2 != cc0)) => (cwbr @ ccmnf @ (ccsup @ XA2 @ ccxr @ cclt) @ cclt)))).
thf(asupxrre1_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (XA2 != cc0)) => ((cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccr) <=> (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt))))).
thf(asupxrre2_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (XA2 != cc0)) => ((cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccr) <=> ((ccsup @ XA2 @ ccxr @ cclt) != ccpnf))))).
thf(asupxrss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwss @ XB2 @ ccxr)) => (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle))))).
...
thf(ainfxrgelb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XB2 @ (ccinf @ XA2 @ ccxr @ cclt) @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(ainfxrmnf_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ ccmnf @ XA2)) => ((ccinf @ XA2 @ ccxr @ cclt) = ccmnf)))).
thf(axrinf0_thm,axiom,((ccinf @ cc0 @ ccxr @ cclt) = ccpnf)).
thf(ainfxrss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwss @ XB2 @ ccxr)) => (cwbr @ (ccinf @ XB2 @ ccxr @ cclt) @ (ccinf @ XA2 @ ccxr @ cclt) @ ccle))))).
thf(areltre_thm,axiom,(cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt)) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccr))).
thf(arpltrp_thm,axiom,(cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt)) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : ccrp))).
thf(areltxrnmnf_thm,axiom,(cwral @ (^ [Xx3:$i] : ((cwbr @ ccmnf @ (ccv @ Xx3) @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt)) @ (^ [Xy1:$i] : ccr)))) @ (^ [Xx3:$i] : ccxr))).
thf(ainfmremnf_thm,axiom,((ccinf @ ccr @ ccxr @ cclt) = ccmnf)).
thf(ainfmrp1_thm,axiom,((ccinf @ ccrp @ ccr @ cclt) = ccc0)).
...
thf(adf_ioc_ax,axiom,(ccioc = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ cclt) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccle))) @ (^ [Xz:$i] : ccxr))))))).
...
thf(aixxssxr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XO @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XS))) @ (^ [Xz:$i] : ccxr))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwss @ (cco @ XA2 @ XB2 @ (XO @ Xx3 @ Xy1 @ Xz)) @ ccxr))))))))))).
thf(aelixx3g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XO @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XS))) @ (^ [Xz:$i] : ccxr))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XC @ (cco @ XA2 @ XB2 @ (XO @ Xx3 @ Xy1 @ Xz))) <=> (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & ((cwbr @ XA2 @ XC @ XR) & (cwbr @ XC @ XB2 @ XS))))))))))))))).
thf(aixxssixx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XO @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (XR @ Xw)) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (XS @ Xw)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XP @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (XT @ Xw)) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (XU @ Xw)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xw:$i] : (((cwcel @ XA2 @ ccxr) & (cwcel @ (ccv @ Xw) @ ccxr)) => ((cwbr @ XA2 @ (ccv @ Xw) @ (XR @ Xw)) => (cwbr @ XA2 @ (ccv @ Xw) @ (XT @ Xw))))) => ((! [Xw:$i] : (((cwcel @ (ccv @ Xw) @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ (ccv @ Xw) @ XB2 @ (XS @ Xw)) => (cwbr @ (ccv @ Xw) @ XB2 @ (XU @ Xw))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwss @ (cco @ XA2 @ XB2 @ (XO @ Xx3 @ Xy1 @ Xz)) @ (cco @ XA2 @ XB2 @ (XP @ Xx3 @ Xy1 @ Xz))))))))))))))))))).
thf(aixxdisj_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XO @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (XR @ Xw)) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (XS @ Xw)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XP @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (XT @ Xw)) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (XU @ Xw)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xw:$i] : (((cwcel @ XB2 @ ccxr) & (cwcel @ (ccv @ Xw) @ ccxr)) => ((cwbr @ XB2 @ (ccv @ Xw) @ (XT @ Xw)) <=> (~ (cwbr @ (ccv @ Xw) @ XB2 @ (XS @ Xw)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) => ((ccin @ (cco @ XA2 @ XB2 @ (XO @ Xx3 @ Xy1 @ Xz)) @ (cco @ XB2 @ XC @ (XP @ Xx3 @ Xy1 @ Xz))) = cc0)))))))))))))))))).
