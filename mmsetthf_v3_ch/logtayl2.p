...
thf(alogtayl2_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xk:$i] : ((XS @ Xk) = (cco @ cc1 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => (! [Xk:$i] : ((cwcel @ XA2 @ (XS @ Xk)) => (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ (ccv @ Xk) @ ccdiv) @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (ccv @ Xk) @ ccexp) @ ccmul))) @ cc1) @ (ccfv @ XA2 @ cclog) @ ccli))))))).
