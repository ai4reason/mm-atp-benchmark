...
thf(anmoolb_thm,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XL = (ccfv @ XU @ ccnmcv)) => ((XM = (ccfv @ XW @ ccnmcv)) => ((XN = (cco @ XU @ XW @ ccnmoo)) => ((((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv) & (cwf @ XX @ XY @ XT)) & ((cwcel @ XA2 @ XX) & (cwbr @ (ccfv @ XA2 @ XL) @ cc1 @ ccle))) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ XM) @ (ccfv @ XT @ XN) @ ccle))))))))))))))))).
