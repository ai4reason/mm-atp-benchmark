...
thf(adfco2a_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ (ccin @ (ccdm @ XA2) @ (ccrn @ XB2)) @ XC) => ((cccom @ XA2 @ XB2) = (cciun @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccxp @ (ccima @ (cccnv @ XB2) @ (ccsn @ (ccv @ Xx3))) @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3)))))))))))).
