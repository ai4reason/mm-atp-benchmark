...
thf(aoprabrexex2_thm,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xw:$i] : (cwcel @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) @ ccvv)) => (cwcel @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ (^ [Xw:$i] : XA2)))))) @ ccvv)))))).
