...
thf(achtppilimlem2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => (Xph => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ ccle) => (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccppi) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccht) @ cclt))) @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)))) @ (^ [Xz:$i] : ccr)))))))).
