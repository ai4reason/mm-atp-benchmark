...
thf(ahonegdi_thm,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU)) => ((cco @ (ccneg @ cc1) @ (cco @ XT @ XU @ cchos) @ cchot) = (cco @ (cco @ (ccneg @ cc1) @ XT @ cchot) @ (cco @ (ccneg @ cc1) @ XU @ cchot) @ cchos)))))).
