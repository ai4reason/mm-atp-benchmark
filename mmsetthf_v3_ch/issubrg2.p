...
thf(aissubrg2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ XR @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_1 @ Xx3 @ Xy1) = (ccfv @ XR @ ccur)))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XR @ ccrg) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) <=> ((cwcel @ XA2 @ (ccfv @ XR @ ccsubg)) & (cwcel @ (Xc_1 @ Xx3 @ Xy1) @ XA2) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))))))))))))).
