...
thf(aisacs_thm,conjecture,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (? [Xf1:$i] : ((cwf @ (ccpw @ XX) @ (ccpw @ XX) @ (ccv @ Xf1)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccv @ Xs1) @ XC) <=> (cwss @ (ccuni @ (ccima @ (ccv @ Xf1) @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ XX)))))))))).
