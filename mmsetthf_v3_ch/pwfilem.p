...
thf(apwfilem_thm,conjecture,(! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XF @ Xx3 @ Xb @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xb))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xb:$i] : ((cwcel @ (ccpw @ (ccv @ Xb)) @ ccfn) => (cwcel @ (ccpw @ (ccun @ (ccv @ Xb) @ (ccsn @ (ccv @ Xx3)))) @ ccfn))))))).
