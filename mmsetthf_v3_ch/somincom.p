...
thf(asomincom_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((ccif @ (cwbr @ XA2 @ XB2 @ XR) @ XA2 @ XB2) = (ccif @ (cwbr @ XB2 @ XA2 @ XR) @ XB2 @ XA2)))))))).
