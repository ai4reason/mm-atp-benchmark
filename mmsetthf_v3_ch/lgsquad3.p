...
thf(algsquad3_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccn) & (~ (cwbr @ cc2 @ XM @ ccdvds))) & ((cwcel @ XN @ ccn) & (~ (cwbr @ cc2 @ XN @ ccdvds)))) => ((cco @ XM @ XN @ cclgs) = (cco @ (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp) @ (cco @ XN @ XM @ cclgs) @ ccmul)))))).
