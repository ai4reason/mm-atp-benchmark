...
thf(adivalglem7_thm,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ ccz) => ((XD != ccc0) => (((cwcel @ XX @ (cco @ ccc0 @ (cco @ (ccfv @ XD @ ccabs) @ cc1 @ ccmin) @ ccfz)) & (cwcel @ XK @ ccz)) => ((XK != ccc0) => (~ (cwcel @ (cco @ XX @ (cco @ XK @ (ccfv @ XD @ ccabs) @ ccmul) @ ccaddc) @ (cco @ ccc0 @ (cco @ (ccfv @ XD @ ccabs) @ cc1 @ ccmin) @ ccfz))))))))))).
