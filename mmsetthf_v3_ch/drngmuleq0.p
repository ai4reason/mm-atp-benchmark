...
thf(adrngmuleq0_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (XY != Xc_0)) => (Xph => (((cco @ XX @ XY @ Xc_x) = Xc_0) <=> (XX = Xc_0)))))))))))))))))).
