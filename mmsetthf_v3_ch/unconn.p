...
thf(aunconn_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & ((cwss @ XA2 @ XX) & (cwss @ XB2 @ XX)) & ((ccin @ XA2 @ XB2) != cc0)) => (((cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn) & (cwcel @ (cco @ XJ @ XB2 @ ccrest) @ ccconn)) => (cwcel @ (cco @ XJ @ (ccun @ XA2 @ XB2) @ ccrest) @ ccconn)))))))).
