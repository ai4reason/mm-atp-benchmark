...
thf(aissconn_thm,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccsconn) <=> ((cwcel @ XJ @ ccpconn) & (cwral @ (^ [Xf1:$i] : (((ccfv @ ccc0 @ (ccv @ Xf1)) = (ccfv @ cc1 @ (ccv @ Xf1))) => (cwbr @ (ccv @ Xf1) @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ (ccv @ Xf1)))) @ (ccfv @ XJ @ ccphtpc)))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))).
