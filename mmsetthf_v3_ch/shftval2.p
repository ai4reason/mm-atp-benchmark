...
thf(ashftval2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ ccc)) => ((ccfv @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XF @ (cco @ XA2 @ XB2 @ ccmin) @ ccshi)) = (ccfv @ (cco @ XB2 @ XC @ ccaddc) @ XF))))))))).
