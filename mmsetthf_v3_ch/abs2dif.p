...
thf(aabs2dif_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (cwbr @ (cco @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs) @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ ccle))))).
