...
thf(aaxhvdistr1_zf_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ cchlo) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccva) @ ccsm) = (cco @ (cco @ XA2 @ XB2 @ ccsm) @ (cco @ XA2 @ XC @ ccsm) @ ccva)))))))))).
