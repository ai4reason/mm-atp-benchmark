...
thf(aaddcnsrec_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccnr) & (cwcel @ XB2 @ ccnr)) & ((cwcel @ XC @ ccnr) & (cwcel @ XD @ ccnr))) => ((cco @ (ccec @ (ccop @ XA2 @ XB2) @ (cccnv @ ccep)) @ (ccec @ (ccop @ XC @ XD) @ (cccnv @ ccep)) @ ccaddc) = (ccec @ (ccop @ (cco @ XA2 @ XC @ ccplr) @ (cco @ XB2 @ XD @ ccplr)) @ (cccnv @ ccep))))))))).
