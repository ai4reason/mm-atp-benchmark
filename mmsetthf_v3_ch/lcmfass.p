...
thf(alcmfass_thm,conjecture,(! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwss @ XY @ ccz) & (cwcel @ XY @ ccfn)) & ((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn))) => ((ccfv @ (ccun @ (ccsn @ (ccfv @ XY @ cclcmf)) @ XZ) @ cclcmf) = (ccfv @ (ccun @ XY @ (ccsn @ (ccfv @ XZ @ cclcmf))) @ cclcmf)))))).
