...
thf(aconnsuba_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwss @ XA2 @ XX)) => ((cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((((ccin @ (ccv @ Xx3) @ XA2) != cc0) & ((ccin @ (ccv @ Xy1) @ XA2) != cc0) & ((ccin @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) = cc0)) => ((ccin @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) != XA2))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))))))).
