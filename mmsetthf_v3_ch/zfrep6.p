...
thf(azfrep6_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xz:$i] : ((cwral @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xx3:$i] : (ccv @ Xz))) => (? [Xw:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (^ [Xy1:$i] : (ccv @ Xw)))) @ (^ [Xx3:$i] : (ccv @ Xz)))))))).
