...
thf(amaxprmfct_thm,conjecture,(! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xz:$i] : ((XS @ Xz) = (ccrab @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ XN @ ccdvds)) @ (^ [Xz:$i] : ccprime)))) => (! [Xz:$i] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (((cwss @ (XS @ Xz) @ ccz) & ((XS @ Xz) != cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XS @ Xz)))) @ (^ [Xx3:$i] : ccz))) & (cwcel @ (ccsup @ (XS @ Xz) @ ccr @ cclt) @ (XS @ Xz))))))))).
