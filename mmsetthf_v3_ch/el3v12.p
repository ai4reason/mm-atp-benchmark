...
thf(ael3v12_thm,conjecture,(! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccvv) & (cwcel @ (ccv @ Xy1) @ ccvv) & (Xch @ Xx3 @ Xy1)) => (Xth @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xch @ Xx3 @ Xy1) => (Xth @ Xx3 @ Xy1)))))))).
