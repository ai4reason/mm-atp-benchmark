...
thf(auffcfflf_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XL @ (ccfv @ XY @ ccufil)) & (cwf @ XY @ XX @ XF)) => ((ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)) = (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)))))))))).
