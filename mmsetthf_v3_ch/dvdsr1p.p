...
thf(advdsr1p_thm,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_pa = (ccfv @ XP @ ccdsr)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XC = (ccfv @ XR @ ccuc1p)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XE = (ccfv @ XR @ ccr1p)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XB2) & (cwcel @ XG @ XC)) => ((cwbr @ XG @ XF @ Xc_pa) <=> ((cco @ XF @ XG @ XE) = Xc_0))))))))))))))))))).
