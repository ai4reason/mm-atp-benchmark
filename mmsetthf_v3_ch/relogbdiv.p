...
thf(arelogbdiv_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & ((cwcel @ XA2 @ ccrp) & (cwcel @ XC @ ccrp))) => ((cco @ XB2 @ (cco @ XA2 @ XC @ ccdiv) @ cclogb) = (cco @ (cco @ XB2 @ XA2 @ cclogb) @ (cco @ XB2 @ XC @ cclogb) @ ccmin))))))).
