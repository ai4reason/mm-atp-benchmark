...
thf(ahonpncani_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => ((cco @ (cco @ XR @ XS @ cchod) @ (cco @ XS @ XT @ cchod) @ cchos) = (cco @ XR @ XT @ cchod))))))))).
