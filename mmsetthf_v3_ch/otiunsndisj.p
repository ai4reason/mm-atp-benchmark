...
thf(aotiunsndisj_thm,conjecture,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XB2 @ XX) => (cwdisj @ (^ [Xa:$i] : XV) @ (^ [Xa:$i] : (cciun @ (^ [Xc:$i] : (ccdif @ XW @ (ccsn @ (ccv @ Xa)))) @ (^ [Xc:$i] : (ccsn @ (ccotp @ (ccv @ Xa) @ XB2 @ (ccv @ Xc))))))))))))).
