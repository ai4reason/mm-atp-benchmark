...
thf(abcth2_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((((cwcel @ XD @ (ccfv @ XX @ ccms)) & (XX != cc0)) & ((cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM) & ((ccuni @ (ccrn @ XM)) = XX))) => (cwrex @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ ccnt)) != cc0)) @ (^ [Xk:$i] : ccn))))))))).
