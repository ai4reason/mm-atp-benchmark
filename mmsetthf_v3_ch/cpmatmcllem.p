...
thf(acpmatmcllem_thm,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xc:$i] : ((XS @ Xi @ Xj @ Xk @ Xc) = (cco @ XN @ XR @ cccpmat)))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XP @ Xi @ Xj) = (ccfv @ XR @ ccpl1)))) => ((! [Xi:$i] : (! [Xj:$i] : (XC = (cco @ XN @ (XP @ Xi @ Xj) @ ccmat)))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xc:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ (ccv @ Xx3) @ (XS @ Xi @ Xj @ Xk @ Xc)) & (cwcel @ (ccv @ Xy1) @ (XS @ Xi @ Xj @ Xk @ Xc)))) => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwral @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ (ccfv @ (cco @ (XP @ Xi @ Xj) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xk) @ (ccv @ Xx3)) @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ (ccv @ Xy1)) @ (ccfv @ (XP @ Xi @ Xj) @ ccmulr)))) @ ccgsu) @ ccco1)) = (ccfv @ XR @ cc0g))) @ (^ [Xc:$i] : ccn))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))))))))))))))))).
