...
thf(aig1pdvds_thm,conjecture,(! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XR @ ccig1p)) => ((XU = (ccfv @ XP @ cclidl)) => ((Xc_pa = (ccfv @ XP @ ccdsr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XI @ XU) & (cwcel @ XX @ XI)) => (cwbr @ (ccfv @ XI @ XG) @ XX @ Xc_pa)))))))))))))).
