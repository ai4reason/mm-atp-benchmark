...
thf(alcmfcllem_thm,conjecture,(! [XZ:($i > $o)] : (((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn) & (~ (wnel @ ccc0 @ XZ))) => (cwcel @ (ccfv @ XZ @ cclcmf) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XZ))) @ (^ [Xn:$i] : ccn)))))).
