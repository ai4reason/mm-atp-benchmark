...
thf(aoduleg_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XD = (ccfv @ XO @ ccodu)) => ((Xc_le = (ccfv @ XO @ ccple)) => ((XG = (ccfv @ XD @ ccple)) => (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ XA2 @ XB2 @ XG) <=> (cwbr @ XB2 @ XA2 @ Xc_le))))))))))))))).
