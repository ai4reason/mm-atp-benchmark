...
thf(avc0rid_thm,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XW @ cc1st)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => (((cwcel @ XW @ ccvc) & (cwcel @ XA2 @ XX)) => ((cco @ XA2 @ XZ @ XG) = XA2))))))))))).
