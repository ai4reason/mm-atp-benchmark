...
thf(aclwwlkccat_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XG @ ccclwwlk)) & (cwcel @ XB2 @ (ccfv @ XG @ ccclwwlk)) & ((ccfv @ ccc0 @ XA2) = (ccfv @ ccc0 @ XB2))) => (cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccfv @ XG @ ccclwwlk))))))).
