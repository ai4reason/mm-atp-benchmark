...
thf(acxplt3d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => ((cwbr @ XB2 @ XC @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XA2 @ XB2 @ cccxp) @ cclt)))))))))))).
