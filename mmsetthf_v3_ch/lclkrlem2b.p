...
thf(alcfl5a_thm,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XF = (ccfv @ XU @ cclfn)) => ((XL = (ccfv @ XU @ cclk)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XG @ XF)) => (Xph => (((ccfv @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ Xc_pe) = (ccfv @ XG @ XL)) <=> (cwcel @ (ccfv @ XG @ XL) @ (ccrn @ XI))))))))))))))))))))))).
thf(alcfl6lem_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [Xc_pe:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((XH @ Xw @ Xv @ Xk) = (ccfv @ (XK @ Xw @ Xv @ Xk) @ cclh))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (Xc_pe = (ccfv @ (XW @ Xw @ Xv @ Xk) @ (ccfv @ (XK @ Xw @ Xv @ Xk) @ ccoch)))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((XU @ Xw @ Xv @ Xk) = (ccfv @ (XW @ Xw @ Xv @ Xk) @ (ccfv @ (XK @ Xw @ Xv @ Xk) @ ccdvh)))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((XV @ Xw @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xk) @ ccbs))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (Xc_pl = (ccfv @ (XU @ Xw @ Xv @ Xk) @ ccplusg))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (Xc_x = (ccfv @ (XU @ Xw @ Xv @ Xk) @ ccvsca))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((XS @ Xw @ Xv) = (ccfv @ (XU @ Xw @ Xv @ Xk) @ ccsca))))) => ((! [Xw:$i] : (! [Xv:$i] : ((Xc_1 @ Xv) = (ccfv @ (XS @ Xw @ Xv) @ ccur)))) => ((! [Xw:$i] : (! [Xv:$i] : ((XR @ Xw) = (ccfv @ (XS @ Xw @ Xv) @ ccbs)))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((Xc_0 @ Xv @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xk) @ cc0g))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((XF @ Xw @ Xv @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xk) @ cclfn))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((XL @ Xw @ Xv @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xk) @ cclk))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xk) => ((cwcel @ (XK @ Xw @ Xv @ Xk) @ cchlt) & (cwcel @ (XW @ Xw @ Xv @ Xk) @ (XH @ Xw @ Xv @ Xk))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xk) => (cwcel @ (XG @ Xw @ Xv @ Xk) @ (XF @ Xw @ Xv @ Xk)))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xk) => (cwcel @ XX @ (ccdif @ (ccfv @ (ccfv @ (XG @ Xw @ Xv @ Xk) @ (XL @ Xw @ Xv @ Xk)) @ Xc_pe) @ (ccsn @ (Xc_0 @ Xv @ Xk)))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xk) => ((ccfv @ XX @ (XG @ Xw @ Xv @ Xk)) = (Xc_1 @ Xv)))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xk) => ((XG @ Xw @ Xv @ Xk) = (ccmpt @ (^ [Xv:$i] : (XV @ Xw @ Xk)) @ (^ [Xv:$i] : (ccrio @ (^ [Xk:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xv) = (cco @ (ccv @ Xw) @ (cco @ (ccv @ Xk) @ XX @ Xc_x) @ Xc_pl))) @ (^ [Xw:$i] : (ccfv @ (ccsn @ XX) @ Xc_pe)))) @ (^ [Xk:$i] : (XR @ Xw)))))))))))))))))))))))))))))))))))))))))))).
...
thf(alcfl7N_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [Xc_pe:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XH @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) = (ccfv @ (XK @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) @ cclh))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : (Xc_pe = (ccfv @ (XW @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) @ (ccfv @ (XK @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) @ ccoch)))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XU @ Xw @ Xv @ Xf1 @ Xk) = (ccfv @ (XW @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) @ (ccfv @ (XK @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) @ ccdvh)))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XV @ Xw @ Xf1 @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xf1 @ Xk) @ ccbs)))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xc_pl @ Xf1) = (ccfv @ (XU @ Xw @ Xv @ Xf1 @ Xk) @ ccplusg)))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xc_x @ Xf1) = (ccfv @ (XU @ Xw @ Xv @ Xf1 @ Xk) @ ccvsca)))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xv @ Xf1) = (ccfv @ (XU @ Xw @ Xv @ Xf1 @ Xk) @ ccsca)))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : ((XR @ Xw @ Xf1) = (ccfv @ (XS @ Xv @ Xf1) @ ccbs))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xc_0 @ Xv @ Xf1 @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xf1 @ Xk) @ cc0g)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XF @ Xx3 @ Xw @ Xv @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xf1 @ Xk) @ cclfn))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XL @ Xw @ Xv @ Xk) = (ccfv @ (XU @ Xw @ Xv @ Xf1 @ Xk) @ cclk)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XC @ Xw @ Xv @ Xf1 @ Xk) = (ccrab @ (^ [Xf1:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ (XL @ Xw @ Xv @ Xk)) @ Xc_pe) @ Xc_pe) = (ccfv @ (ccv @ Xf1) @ (XL @ Xw @ Xv @ Xk)))) @ (^ [Xf1:$i] : (XF @ Xx3 @ Xw @ Xv @ Xk))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xf1 @ Xk) => ((cwcel @ (XK @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) @ cchlt) & (cwcel @ (XW @ Xx3 @ Xw @ Xv @ Xf1 @ Xk) @ (XH @ Xx3 @ Xw @ Xv @ Xf1 @ Xk))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xf1 @ Xk) => (cwcel @ (XG @ Xw @ Xv @ Xk) @ (XF @ Xx3 @ Xw @ Xv @ Xk)))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xw @ Xv @ Xf1 @ Xk) => ((cwcel @ (XG @ Xw @ Xv @ Xk) @ (XC @ Xw @ Xv @ Xf1 @ Xk)) <=> (((ccfv @ (XG @ Xw @ Xv @ Xk) @ (XL @ Xw @ Xv @ Xk)) = (XV @ Xw @ Xf1 @ Xk)) | (cwreu @ (^ [Xx3:$i] : ((XG @ Xw @ Xv @ Xk) = (ccmpt @ (^ [Xv:$i] : (XV @ Xw @ Xf1 @ Xk)) @ (^ [Xv:$i] : (ccrio @ (^ [Xk:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xv) = (cco @ (ccv @ Xw) @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ (Xc_x @ Xf1)) @ (Xc_pl @ Xf1)))) @ (^ [Xw:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ Xc_pe)))) @ (^ [Xk:$i] : (XR @ Xw @ Xf1))))))) @ (^ [Xx3:$i] : (ccdif @ (XV @ Xw @ Xf1 @ Xk) @ (ccsn @ (Xc_0 @ Xv @ Xf1 @ Xk))))))))))))))))))))))))))))))))))))))))))).
...
thf(alclkrlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ (XK @ Xf1) @ cclh))) => ((! [Xf1:$i] : (Xc_pe = (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ ccoch)))) => ((! [Xf1:$i] : ((XU @ Xf1) = (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ ccdvh)))) => ((! [Xf1:$i] : (XF = (ccfv @ (XU @ Xf1) @ cclfn))) => ((! [Xf1:$i] : (XL = (ccfv @ (XU @ Xf1) @ cclk))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccfv @ (XU @ Xf1) @ ccld))) => ((! [Xf1:$i] : ((XR @ Xf1) = (ccfv @ (XU @ Xf1) @ ccsca))) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ (XR @ Xf1) @ ccbs))) => ((! [Xf1:$i] : (Xc_x = (ccfv @ (XD @ Xf1) @ ccvsca))) => ((! [Xf1:$i] : ((XC @ Xf1) = (ccrab @ (^ [Xf1:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe) @ Xc_pe) = (ccfv @ (ccv @ Xf1) @ XL))) @ (^ [Xf1:$i] : XF)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((cwcel @ (XK @ Xf1) @ cchlt) & (cwcel @ (XW @ Xf1) @ (XH @ Xf1))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XX @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XG @ (XC @ Xf1)))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (cco @ XX @ XG @ Xc_x) @ (XC @ Xf1))))))))))))))))))))))))))))))))).
thf(alclkrlem2a_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XN = (ccfv @ XU @ cclspn)) => ((XA2 = (ccfv @ XU @ cclsa)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XB2 @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XX @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XY @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => ((ccfv @ (ccsn @ XX) @ Xc_pe) != (ccfv @ (ccsn @ XY) @ Xc_pe))) => ((Xph => (~ (cwcel @ XX @ (ccfv @ (ccsn @ XB2) @ Xc_pe)))) => (Xph => (cwcel @ (ccin @ (cco @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN) @ Xc_po) @ (ccfv @ (ccsn @ XB2) @ Xc_pe)) @ XA2))))))))))))))))))))))))))))))).
thf(alclkrlem2b_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XN = (ccfv @ XU @ cclspn)) => ((XA2 = (ccfv @ XU @ cclsa)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XB2 @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XX @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XY @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => ((ccfv @ (ccsn @ XX) @ Xc_pe) != (ccfv @ (ccsn @ XY) @ Xc_pe))) => ((Xph => ((~ (cwcel @ XX @ (ccfv @ (ccsn @ XB2) @ Xc_pe))) | (~ (cwcel @ XY @ (ccfv @ (ccsn @ XB2) @ Xc_pe))))) => (Xph => (cwcel @ (ccin @ (cco @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN) @ Xc_po) @ (ccfv @ (ccsn @ XB2) @ Xc_pe)) @ XA2))))))))))))))))))))))))))))))).
