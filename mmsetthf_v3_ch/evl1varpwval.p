...
thf(aevl1varpwval_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XW = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XW @ ccmgp)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XC @ XB2)) => ((XH = (ccfv @ XR @ ccmgp)) => ((XE = (ccfv @ XH @ ccmg)) => (Xph => ((ccfv @ XC @ (ccfv @ (cco @ XN @ XX @ Xc_ex) @ XQ)) = (cco @ XN @ XC @ XE))))))))))))))))))))))))))).
