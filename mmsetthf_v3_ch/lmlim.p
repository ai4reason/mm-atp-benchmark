...
thf(almlim_thm,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XY @ cctopon)) => ((Xph => (cwf @ ccn @ XX @ XF)) => ((Xph => (cwcel @ XP @ XX)) => (((cco @ XJ @ XX @ ccrest) = (cco @ (ccfv @ cccnfld @ cctopn) @ XX @ ccrest)) => ((cwss @ XX @ ccc) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ XF @ XP @ ccli))))))))))))))).
