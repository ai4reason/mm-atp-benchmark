...
thf(aonasuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ (ccsuc @ XB2) @ ccoa) = (ccsuc @ (cco @ XA2 @ XB2 @ ccoa))))))).
thf(aonmsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ (ccsuc @ XB2) @ ccomu) = (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XA2 @ ccoa)))))).
thf(aonesuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ (ccsuc @ XB2) @ ccoe) = (cco @ (cco @ XA2 @ XB2 @ ccoe) @ XA2 @ ccomu)))))).
...
thf(aom0r_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ cc0 @ XA2 @ ccomu) = cc0)))).
thf(ao1p1e2_thm,axiom,((cco @ cc1o @ cc1o @ ccoa) = cc2o)).
thf(ao2p2e4_thm,axiom,((cco @ cc2o @ cc2o @ ccoa) = cc4o)).
thf(aom1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ XA2 @ cc1o @ ccomu) = XA2)))).
thf(aom1r_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ cc1o @ XA2 @ ccomu) = XA2)))).
thf(aoe1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ XA2 @ cc1o @ ccoe) = XA2)))).
thf(aoe1m_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ cc1o @ XA2 @ ccoe) = cc1o)))).
thf(aoaordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => ((cwcel @ XA2 @ XB2) => (cwcel @ (cco @ XC @ XA2 @ ccoa) @ (cco @ XC @ XB2 @ ccoa)))))))).
...
thf(aoacan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => (((cco @ XA2 @ XB2 @ ccoa) = (cco @ XA2 @ XC @ ccoa)) <=> (XB2 = XC))))))).
...
thf(aoawordeulem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ XB2 @ ccon0) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwss @ XB2 @ (cco @ XA2 @ (ccv @ Xy1) @ ccoa))) @ (^ [Xy1:$i] : ccon0)))) => ((cwss @ XA2 @ XB2) => (cwreu @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2)) @ (^ [Xx3:$i] : ccon0)))))))))).
...
thf(aoawordex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2)) @ (^ [Xx3:$i] : ccon0))))))).
thf(aoaordex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwcel @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cwcel @ cc0 @ (ccv @ Xx3)) & ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2))) @ (^ [Xx3:$i] : ccon0))))))).
thf(aoa00_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (((cco @ XA2 @ XB2 @ ccoa) = cc0) <=> ((XA2 = cc0) & (XB2 = cc0))))))).
...
thf(aoarec_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cco @ XA2 @ XB2 @ ccoa) = (ccun @ XA2 @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa)))))))))).
thf(aoaf1o_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwf1o @ ccon0 @ (ccdif @ ccon0 @ XA2) @ (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))))).
thf(aoacomf1olem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XB2 @ (ccv @ Xx3) @ ccoa))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwf1o @ XA2 @ (ccrn @ (XF @ Xx3)) @ (XF @ Xx3)) & ((ccin @ (ccrn @ (XF @ Xx3)) @ XB2) = cc0))))))))).
thf(aoacomf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccun @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XB2 @ (ccv @ Xx3) @ ccoa))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (cwf1o @ (cco @ XA2 @ XB2 @ ccoa) @ (cco @ XB2 @ XA2 @ ccoa) @ (XF @ Xx3))))))))).
...
thf(aomord2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) & (cwcel @ cc0 @ XC)) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(aomord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => (((cwcel @ XA2 @ XB2) & (cwcel @ cc0 @ XC)) <=> (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(aomcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) & (cwcel @ cc0 @ XA2)) => (((cco @ XA2 @ XB2 @ ccomu) = (cco @ XA2 @ XC @ ccomu)) <=> (XB2 = XC))))))).
thf(aomword_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) & (cwcel @ cc0 @ XC)) => ((cwss @ XA2 @ XB2) <=> (cwss @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
...
thf(aomwordri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => ((cwss @ XA2 @ XB2) => (cwss @ (cco @ XA2 @ XC @ ccomu) @ (cco @ XB2 @ XC @ ccomu)))))))).
thf(aomword1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwcel @ cc0 @ XB2)) => (cwss @ XA2 @ (cco @ XA2 @ XB2 @ ccomu)))))).
thf(aomword2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwcel @ cc0 @ XB2)) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccomu)))))).
thf(aom00_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (((cco @ XA2 @ XB2 @ ccomu) = cc0) <=> ((XA2 = cc0) | (XB2 = cc0))))))).
thf(aom00el_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwcel @ cc0 @ (cco @ XA2 @ XB2 @ ccomu)) <=> ((cwcel @ cc0 @ XA2) & (cwcel @ cc0 @ XB2))))))).
...
thf(aomlimcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & ((cwcel @ XB2 @ XC) & (cwlim @ XB2))) & (cwcel @ cc0 @ XA2)) => (cwlim @ (cco @ XA2 @ XB2 @ ccomu))))))).
...
thf(aoneo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (XC = (cco @ cc2o @ XA2 @ ccomu))) => (~ ((ccsuc @ XC) = (cco @ cc2o @ XB2 @ ccomu)))))))).
thf(aomeulem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (XA2 != cc0)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccomu) @ (ccv @ Xy1) @ ccoa) = XB2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccon0)))))).
thf(aomeulem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (XA2 != cc0)) & ((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ XA2)) & ((cwcel @ XD @ ccon0) & (cwcel @ XE @ XA2))) => (((cwcel @ XB2 @ XD) | ((XB2 = XD) & (cwcel @ XC @ XE))) => (cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccoa) @ (cco @ (cco @ XA2 @ XD @ ccomu) @ XE @ ccoa)))))))))).
thf(aomopth2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (XA2 != cc0)) & ((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ XA2)) & ((cwcel @ XD @ ccon0) & (cwcel @ XE @ XA2))) => (((cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccoa) = (cco @ (cco @ XA2 @ XD @ ccomu) @ XE @ ccoa)) <=> ((XB2 = XD) & (XC = XE)))))))))).
thf(aomeu_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (XA2 != cc0)) => (cweu @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((ccv @ Xz) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & ((cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccomu) @ (ccv @ Xy1) @ ccoa) = XB2))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccon0)))))))).
thf(aoen0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwcel @ cc0 @ XA2)) => (cwcel @ cc0 @ (cco @ XA2 @ XB2 @ ccoe)))))).
thf(aoeordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ (ccdif @ ccon0 @ cc2o))) => ((cwcel @ XA2 @ XB2) => (cwcel @ (cco @ XC @ XA2 @ ccoe) @ (cco @ XC @ XB2 @ ccoe)))))))).
...
thf(aoecan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => (((cco @ XA2 @ XB2 @ ccoe) = (cco @ XA2 @ XC @ ccoe)) <=> (XB2 = XC))))))).
thf(aoeword_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ (ccdif @ ccon0 @ cc2o))) => ((cwss @ XA2 @ XB2) <=> (cwss @ (cco @ XC @ XA2 @ ccoe) @ (cco @ XC @ XB2 @ ccoe)))))))).
...
thf(aoewordri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => ((cwcel @ XA2 @ XB2) => (cwss @ (cco @ XA2 @ XC @ ccoe) @ (cco @ XB2 @ XC @ ccoe)))))))).
thf(aoeworde_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) & (cwcel @ XB2 @ ccon0)) => (cwss @ XB2 @ (cco @ XA2 @ XB2 @ ccoe)))))).
thf(aoeordsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => ((cwcel @ XA2 @ XB2) => (cwcel @ (cco @ XA2 @ (ccsuc @ XC) @ ccoe) @ (cco @ XB2 @ (ccsuc @ XC) @ ccoe)))))))).
...
thf(aoeoalem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ cc0 @ XA2) => ((cwcel @ XB2 @ ccon0) => ((cwcel @ XC @ ccon0) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccoe) = (cco @ (cco @ XA2 @ XB2 @ ccoe) @ (cco @ XA2 @ XC @ ccoe) @ ccomu)))))))))).
...
thf(aoeoelem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ cc0 @ XA2) => (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => ((cco @ (cco @ XA2 @ XB2 @ ccoe) @ XC @ ccoe) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccoe))))))))).
...
thf(aoeeu_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) & (cwcel @ XB2 @ (ccdif @ ccon0 @ cc1o))) => (cweu @ (^ [Xw:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (((ccv @ Xw) = (ccotp @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xz))) & ((cco @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccoe) @ (ccv @ Xy1) @ ccomu) @ (ccv @ Xz) @ ccoa) = XB2))) @ (^ [Xz:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoe)))) @ (^ [Xy1:$i] : (ccdif @ XA2 @ cc1o)))) @ (^ [Xx3:$i] : ccon0)))))))).
thf(anna0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cco @ XA2 @ cc0 @ ccoa) = XA2)))).
thf(annm0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cco @ XA2 @ cc0 @ ccomu) = cc0)))).
thf(annasuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ (ccsuc @ XB2) @ ccoa) = (ccsuc @ (cco @ XA2 @ XB2 @ ccoa))))))).
thf(annmsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ (ccsuc @ XB2) @ ccomu) = (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XA2 @ ccoa)))))).
thf(annesuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ (ccsuc @ XB2) @ ccoe) = (cco @ (cco @ XA2 @ XB2 @ ccoe) @ XA2 @ ccomu)))))).
thf(anna0r_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cco @ cc0 @ XA2 @ ccoa) = XA2)))).
thf(annm0r_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cco @ cc0 @ XA2 @ ccomu) = cc0)))).
thf(annacl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwcel @ (cco @ XA2 @ XB2 @ ccoa) @ ccom))))).
thf(annmcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwcel @ (cco @ XA2 @ XB2 @ ccomu) @ ccom))))).
thf(annecl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwcel @ (cco @ XA2 @ XB2 @ ccoe) @ ccom))))).
...
thf(annaordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cwcel @ XA2 @ XB2) => (cwcel @ (cco @ XC @ XA2 @ ccoa) @ (cco @ XC @ XB2 @ ccoa)))))))).
...
thf(annaordr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (cco @ XA2 @ XC @ ccoa) @ (cco @ XB2 @ XC @ ccoa)))))))).
...
thf(anndi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccomu) = (cco @ (cco @ XA2 @ XB2 @ ccomu) @ (cco @ XA2 @ XC @ ccomu) @ ccoa))))))).
thf(annmass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccomu) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccomu))))))).
thf(annmsucr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ (ccsuc @ XA2) @ XB2 @ ccomu) = (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XB2 @ ccoa)))))).
thf(annmcom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ XB2 @ ccomu) = (cco @ XB2 @ XA2 @ ccomu)))))).
thf(annaword_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cwss @ XA2 @ XB2) <=> (cwss @ (cco @ XC @ XA2 @ ccoa) @ (cco @ XC @ XB2 @ ccoa)))))))).
thf(annacan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => (((cco @ XA2 @ XB2 @ ccoa) = (cco @ XA2 @ XC @ ccoa)) <=> (XB2 = XC))))))).
thf(annaword1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwss @ XA2 @ (cco @ XA2 @ XB2 @ ccoa)))))).
thf(annaword2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccoa)))))).
thf(annmordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) & (cwcel @ cc0 @ XC)) => ((cwcel @ XA2 @ XB2) => (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(annmord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => (((cwcel @ XA2 @ XB2) & (cwcel @ cc0 @ XC)) <=> (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(annmword_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) & (cwcel @ cc0 @ XC)) => ((cwss @ XA2 @ XB2) <=> (cwss @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(annmcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) & (cwcel @ cc0 @ XA2)) => (((cco @ XA2 @ XB2 @ ccomu) = (cco @ XA2 @ XC @ ccomu)) <=> (XB2 = XC))))))).
thf(annmwordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cwss @ XA2 @ XB2) => (cwss @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(annmwordri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cwss @ XA2 @ XB2) => (cwss @ (cco @ XA2 @ XC @ ccomu) @ (cco @ XB2 @ XC @ ccomu)))))))).
thf(annawordex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cwss @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2)) @ (^ [Xx3:$i] : ccom))))))).
thf(annaordex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cwcel @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cwcel @ cc0 @ (ccv @ Xx3)) & ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2))) @ (^ [Xx3:$i] : ccom))))))).
thf(a_1onn_thm,axiom,(cwcel @ cc1o @ ccom)).
thf(a_2onn_thm,axiom,(cwcel @ cc2o @ ccom)).
thf(a_3onn_thm,axiom,(cwcel @ cc3o @ ccom)).
thf(a_4onn_thm,axiom,(cwcel @ cc4o @ ccom)).
thf(aoaabslem_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ ccom @ ccon0) & (cwcel @ XA2 @ ccom)) => ((cco @ XA2 @ ccom @ ccoa) = ccom)))).
