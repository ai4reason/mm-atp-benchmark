...
thf(amodmulmodr_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccr) & (cwcel @ XM @ ccrp)) => ((cco @ (cco @ XA2 @ (cco @ XB2 @ XM @ ccmo) @ ccmul) @ XM @ ccmo) = (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XM @ ccmo))))))).
