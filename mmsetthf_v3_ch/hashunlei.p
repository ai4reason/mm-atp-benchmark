...
thf(ahashunlei_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XC = (ccun @ XA2 @ XB2)) => (((cwcel @ XA2 @ ccfn) & (cwbr @ (ccfv @ XA2 @ cchash) @ XK @ ccle)) => (((cwcel @ XB2 @ ccfn) & (cwbr @ (ccfv @ XB2 @ cchash) @ XM @ ccle)) => ((cwcel @ XK @ ccn0) => ((cwcel @ XM @ ccn0) => (((cco @ XK @ XM @ ccaddc) = XN) => ((cwcel @ XC @ ccfn) & (cwbr @ (ccfv @ XC @ cchash) @ XN @ ccle))))))))))))))).
