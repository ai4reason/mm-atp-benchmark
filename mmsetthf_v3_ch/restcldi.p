...
thf(arestcldi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwss @ XA2 @ XX) & (cwcel @ XB2 @ (ccfv @ XJ @ cccld)) & (cwss @ XB2 @ XA2)) => (cwcel @ XB2 @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ cccld))))))))).
