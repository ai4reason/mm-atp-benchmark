...
thf(afun11iun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XB2 @ Xx3) = (XC @ Xy1))))) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : ((cwf1 @ (XD @ Xx3 @ Xy1) @ (XS @ Xy1) @ (XB2 @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((cwss @ (XB2 @ Xx3) @ (XC @ Xy1)) | (cwss @ (XC @ Xy1) @ (XB2 @ Xx3)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)) => (cwf1 @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1))) @ (XS @ Xy1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
