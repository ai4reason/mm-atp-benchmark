...
thf(aasclval_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_1 = (ccfv @ XW @ ccur)) => ((cwcel @ XX @ XK) => ((ccfv @ XX @ XA2) = (cco @ XX @ Xc_1 @ Xc_x)))))))))))))))).
