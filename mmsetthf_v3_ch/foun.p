...
thf(afoun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwfo @ XA2 @ XB2 @ XF) & (cwfo @ XC @ XD @ XG)) & ((ccin @ XA2 @ XC) = cc0)) => (cwfo @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ (ccun @ XF @ XG)))))))))).
