...
thf(amodprmn0modprm0_thm,conjecture,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccz) & ((cco @ XN @ XP @ ccmo) != ccc0)) => ((cwcel @ XI @ (cco @ ccc0 @ XP @ ccfzo)) => (cwrex @ (^ [Xj:$i] : ((cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XN @ ccmul) @ ccaddc) @ XP @ ccmo) = ccc0)) @ (^ [Xj:$i] : (cco @ ccc0 @ XP @ ccfzo))))))))).
