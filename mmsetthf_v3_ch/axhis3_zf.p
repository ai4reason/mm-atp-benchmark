...
thf(aaxhis3_zf_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ cchlo) => ((ccsp = (ccfv @ XU @ ccdip)) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => ((cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ ccsp) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccsp) @ ccmul))))))))))).
