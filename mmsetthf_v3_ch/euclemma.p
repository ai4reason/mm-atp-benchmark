...
thf(aeuclemma_thm,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XP @ (cco @ XM @ XN @ ccmul) @ ccdvds) <=> ((cwbr @ XP @ XM @ ccdvds) | (cwbr @ XP @ XN @ ccdvds)))))))).
