...
thf(ajm3_1_thm,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XK @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn)) & (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => ((cco @ XK @ XN @ ccexp) = (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmin) @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ ccmo))))))).
