...
thf(afresaun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf @ XA2 @ XC @ XF) & (cwf @ XB2 @ XC @ XG) & ((ccres @ XF @ (ccin @ XA2 @ XB2)) = (ccres @ XG @ (ccin @ XA2 @ XB2)))) => (cwf @ (ccun @ XA2 @ XB2) @ XC @ (ccun @ XF @ XG))))))))).
