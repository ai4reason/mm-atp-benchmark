...
thf(apwfilem_b_thm,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xc:$i] : ((XF @ Xx3 @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3)))))))) => (! [Xx3:$i] : ((cwcel @ (ccpw @ (ccv @ Xx3)) @ ccfn) => (cwcel @ (ccpw @ (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xx3)))) @ ccfn)))))).
