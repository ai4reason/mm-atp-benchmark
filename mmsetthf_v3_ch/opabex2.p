...
thf(a_1stnpr_thm,axiom,(! [XA2:($i > $o)] : ((~ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv))) => ((ccfv @ XA2 @ cc1st) = cc0)))).
thf(a_2ndnpr_thm,axiom,(! [XA2:($i > $o)] : ((~ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv))) => ((ccfv @ XA2 @ cc2nd) = cc0)))).
thf(a_1st0_thm,axiom,((ccfv @ cc0 @ cc1st) = cc0)).
thf(a_2nd0_thm,axiom,((ccfv @ cc0 @ cc2nd) = cc0)).
...
thf(a_1stval2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) => ((ccfv @ XA2 @ cc1st) = (ccint @ (ccint @ XA2)))))).
thf(a_2ndval2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) => ((ccfv @ XA2 @ cc2nd) = (ccint @ (ccint @ (ccint @ (cccnv @ (ccsn @ XA2))))))))).
thf(aoteqimp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccotp @ XA2 @ XB2 @ XC)) => (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XZ)) => (((ccfv @ (ccfv @ XT @ cc1st) @ cc1st) = XA2) & ((ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) = XB2) & ((ccfv @ XT @ cc2nd) = XC)))))))))))).
thf(afo1st_thm,axiom,(cwfo @ ccvv @ ccvv @ cc1st)).
thf(afo2nd_thm,axiom,(cwfo @ ccvv @ ccvv @ cc2nd)).
thf(abr1steqg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cc1st) <=> (XC = XA2))))))))).
thf(abr2ndeqg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cc2nd) <=> (XC = XB2))))))))).
thf(af1stres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwf @ (ccxp @ XA2 @ XB2) @ XA2 @ (ccres @ cc1st @ (ccxp @ XA2 @ XB2)))))).
thf(af2ndres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwf @ (ccxp @ XA2 @ XB2) @ XB2 @ (ccres @ cc2nd @ (ccxp @ XA2 @ XB2)))))).
thf(afo1stres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XB2 != cc0) => (cwfo @ (ccxp @ XA2 @ XB2) @ XA2 @ (ccres @ cc1st @ (ccxp @ XA2 @ XB2))))))).
thf(afo2ndres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 != cc0) => (cwfo @ (ccxp @ XA2 @ XB2) @ XB2 @ (ccres @ cc2nd @ (ccxp @ XA2 @ XB2))))))).
thf(a_1st2val_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((ccv @ Xz) = (ccv @ Xx3))))))) = (ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ cc1st))))))).
thf(a_2nd2val_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((ccv @ Xz) = (ccv @ Xy1))))))) = (ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ cc2nd))))))).
thf(a_1stcof_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccxp @ XB2 @ XC) @ XF) => (cwf @ XA2 @ XB2 @ (cccom @ cc1st @ XF)))))))).
thf(a_2ndcof_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccxp @ XB2 @ XC) @ XF) => (cwf @ XA2 @ XC @ (cccom @ cc2nd @ XF)))))))).
...
thf(aelxp6_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) <=> ((XA2 = (ccop @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd))) & ((cwcel @ (ccfv @ XA2 @ cc1st) @ XB2) & (cwcel @ (ccfv @ XA2 @ cc2nd) @ XC)))))))).
...
thf(axp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccxp @ XA2 @ XB2) = (ccrab @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ XA2) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ XB2))) @ (^ [Xx3:$i] : (ccxp @ ccvv @ ccvv))))))).
thf(aunielxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) => (cwcel @ (ccuni @ XA2) @ (ccuni @ (ccxp @ XB2 @ XC)))))))).
thf(a_1st2nd2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) => (XA2 = (ccop @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd)))))))).
thf(a_1st2ndb_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) <=> (XA2 = (ccop @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd)))))).
thf(axpopth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccxp @ XC @ XD)) & (cwcel @ XB2 @ (ccxp @ XR @ XS))) => ((((ccfv @ XA2 @ cc1st) = (ccfv @ XB2 @ cc1st)) & ((ccfv @ XA2 @ cc2nd) = (ccfv @ XB2 @ cc2nd))) <=> (XA2 = XB2)))))))))).
...
thf(aeqop2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((XA2 = (ccop @ XB2 @ XC)) <=> ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) & (((ccfv @ XA2 @ cc1st) = XB2) & ((ccfv @ XA2 @ cc2nd) = XC)))))))))).
thf(aop1steq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (ccxp @ (XV @ Xx3) @ (XW @ Xx3))) => (((ccfv @ XA2 @ cc1st) = XB2) <=> (? [Xx3:$i] : (XA2 = (ccop @ XB2 @ (ccv @ Xx3)))))))))))).
thf(ael2xptp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ (ccxp @ XB2 @ XC) @ XD)) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (XA2 = (ccotp @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XD))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : XB2)))))))).
thf(ael2xptp0_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XX @ XU) & (cwcel @ XY @ XV) & (cwcel @ XZ @ XW)) => (((cwcel @ XA2 @ (ccxp @ (ccxp @ XU @ XV) @ XW)) & (((ccfv @ (ccfv @ XA2 @ cc1st) @ cc1st) = XX) & ((ccfv @ (ccfv @ XA2 @ cc1st) @ cc2nd) = XY) & ((ccfv @ XA2 @ cc2nd) = XZ))) <=> (XA2 = (ccotp @ XX @ XY @ XZ)))))))))))).
thf(a_2nd1st_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) => ((ccuni @ (cccnv @ (ccsn @ XA2))) = (ccop @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XA2 @ cc1st)))))))).
thf(a_1st2nd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrel @ XB2) & (cwcel @ XA2 @ XB2)) => (XA2 = (ccop @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd))))))).
thf(a_1stdm_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwrel @ XR) & (cwcel @ XA2 @ XR)) => (cwcel @ (ccfv @ XA2 @ cc1st) @ (ccdm @ XR)))))).
thf(a_2ndrn_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwrel @ XR) & (cwcel @ XA2 @ XR)) => (cwcel @ (ccfv @ XA2 @ cc2nd) @ (ccrn @ XR)))))).
thf(a_1st2ndbr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrel @ XB2) & (cwcel @ XA2 @ XB2)) => (cwbr @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd) @ XB2))))).
thf(areleldm2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwrel @ XA2) => ((cwcel @ XB2 @ (ccdm @ XA2)) <=> (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cc1st) = XB2)) @ (^ [Xx3:$i] : XA2))))))).
thf(areldm_thm,axiom,(! [XA2:($i > $o)] : ((cwrel @ XA2) => ((ccdm @ XA2) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cc1st)))))))).
...
thf(acsbopeq1a_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((XA2 @ Xx3 @ Xy1) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((ccsb @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ cc1st) @ (^ [Xx3:$i] : (ccsb @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ cc2nd) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))))) = (XB2 @ Xx3 @ Xy1)))))))).
thf(adfopab2_thm,axiom,(! [Xph:($i > ($i > $o))] : ((ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) = (ccrab @ (^ [Xz:$i] : (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (ccfv @ (ccv @ Xz) @ cc2nd))) @ (ccfv @ (ccv @ Xz) @ cc1st))) @ (^ [Xz:$i] : (ccxp @ ccvv @ ccvv)))))).
thf(adfoprab3s_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : ((ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) = (ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : ((cwcel @ (ccv @ Xw) @ (ccxp @ ccvv @ ccvv)) & (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (ccfv @ (ccv @ Xw) @ cc2nd))) @ (ccfv @ (ccv @ Xw) @ cc1st))))))))).
...
thf(adfoprab4_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xw) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((Xph @ Xz @ Xw) <=> (Xps @ Xx3 @ Xy1 @ Xz))))))) => ((ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : ((cwcel @ (ccv @ Xw) @ (ccxp @ (XA2 @ Xz) @ (XB2 @ Xz))) & (Xph @ Xz @ Xw))))) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xz))) & (Xps @ Xx3 @ Xy1 @ Xz))))))))))))).
thf(adfoprab4f_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ X)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : ((? [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ X)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xw) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) <=> (Xps @ Xx3 @ Xy1 @ Xz))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : ((cwcel @ (ccv @ Xw) @ (ccxp @ (XA2 @ Xz) @ (XB2 @ Xz))) & (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xz))) & (Xps @ Xx3 @ Xy1 @ Xz))))))))))))))))).
thf(aopabex2_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xx3) @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xy1) @ XB2)))) => (Xph => (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))) @ ccvv))))))))))))).
