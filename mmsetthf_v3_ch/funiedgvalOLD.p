...
thf(afuniedgvalOLD_thm,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XG @ XV) & (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) & (cwss @ (ccpr @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ ccedgf)) @ (ccdm @ XG))) => ((ccfv @ XG @ cciedg) = (ccfv @ XG @ ccedgf)))))).
