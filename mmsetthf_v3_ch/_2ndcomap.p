...
thf(a_2ndcomap_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XY @ Xx3) = (ccuni @ XK))) => ((Xph => (cwcel @ XJ @ cc2ndc)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((! [Xx3:$i] : (Xph => ((ccrn @ XF) = (XY @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XJ)) => (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ XK))) => (Xph => (cwcel @ XK @ cc2ndc))))))))))))).
