...
thf(aopeqpr_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (((ccop @ XA2 @ XB2) = (ccpr @ XC @ XD)) <=> (((XC = (ccsn @ XA2)) & (XD = (ccpr @ XA2 @ XB2))) | ((XC = (ccpr @ XA2 @ XB2)) & (XD = (ccsn @ XA2)))))))))))))).
