...
thf(ahmeocls_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) & (cwss @ XA2 @ XX)) => ((ccfv @ (ccima @ XF @ XA2) @ (ccfv @ XK @ cccl)) = (ccima @ XF @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)))))))))))).
