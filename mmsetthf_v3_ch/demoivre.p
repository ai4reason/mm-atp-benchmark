...
thf(ademoivre_thm,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ (ccfv @ XA2 @ cccos) @ (cco @ cci @ (ccfv @ XA2 @ ccsin) @ ccmul) @ ccaddc) @ XN @ ccexp) = (cco @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ cccos) @ (cco @ cci @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ ccsin) @ ccmul) @ ccaddc)))))).
