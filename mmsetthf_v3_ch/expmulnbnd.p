...
thf(aexpmulnbnd_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ cc1 @ XB2 @ cclt)) => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ XA2 @ (ccv @ Xk) @ ccmul) @ (cco @ XB2 @ (ccv @ Xk) @ ccexp) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccn0)))))).
