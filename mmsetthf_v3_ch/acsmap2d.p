...
thf(aacsmap2d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : (Xph => (cwcel @ (XA2 @ Xf1) @ (ccfv @ (XX @ Xf1) @ ccacs)))) => ((! [Xf1:$i] : (XN = (ccfv @ (XA2 @ Xf1) @ ccmrc))) => ((! [Xf1:$i] : ((XI @ Xf1) = (ccfv @ (XA2 @ Xf1) @ ccmri))) => ((! [Xf1:$i] : (Xph => (cwcel @ XS @ (XI @ Xf1)))) => ((! [Xf1:$i] : (Xph => (cwss @ XT @ (XX @ Xf1)))) => ((Xph => ((ccfv @ XS @ XN) = (ccfv @ XT @ XN))) => (Xph => (? [Xf1:$i] : ((cwf @ XT @ (ccin @ (ccpw @ XS) @ ccfn) @ (ccv @ Xf1)) & (XS = (ccuni @ (ccrn @ (ccv @ Xf1))))))))))))))))))))).
