...
thf(apredpredss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ XB2 @ XR @ XX)))))))).
thf(apredss_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwss @ (ccpred @ XA2 @ XR @ XX) @ XA2))))).
thf(asspred_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XB2 @ XA2) & (cwss @ (ccpred @ XA2 @ XR @ XX) @ XB2)) => ((ccpred @ XA2 @ XR @ XX) = (ccpred @ XB2 @ XR @ XX)))))))).
...
thf(adfpred3_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ ccvv) => ((ccpred @ XA2 @ XR @ XX) = (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ XR)) @ (^ [Xy1:$i] : XA2)))))))).
thf(adfpred3g_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : ((cwcel @ XX @ (XV @ Xy1)) => ((ccpred @ XA2 @ XR @ XX) = (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ XR)) @ (^ [Xy1:$i] : XA2)))))))))).
thf(aelpredim_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) => (cwbr @ XY @ XX @ XR)))))))).
thf(aelpred_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ ccvv) => ((cwcel @ XX @ XD) => ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) <=> ((cwcel @ XY @ XA2) & (cwbr @ XY @ XX @ XR))))))))))).
thf(aelpredg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XB2) & (cwcel @ XY @ XA2)) => ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) <=> (cwbr @ XY @ XX @ XR))))))))).
thf(apredasetex_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccpred @ XA2 @ XR @ XX) @ ccvv)))))).
thf(adffr4_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwfr @ XA2 @ XR) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & ((ccv @ Xx3) != cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccpred @ (ccv @ Xx3) @ XR @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
thf(apredel_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) => (cwcel @ XY @ XA2))))))).
thf(apredpo_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwpo @ XA2 @ XR) & (cwcel @ XX @ XA2)) => ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) => (cwss @ (ccpred @ XA2 @ XR @ XY) @ (ccpred @ XA2 @ XR @ XX))))))))).
thf(apredso_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XX @ XA2)) => ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) => (cwss @ (ccpred @ XA2 @ XR @ XY) @ (ccpred @ XA2 @ XR @ XX))))))))).
thf(apredbrg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XY @ (ccpred @ XA2 @ XR @ XX))) => (cwbr @ XY @ XX @ XR)))))))).
thf(asetlikespec_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XA2) & (cwse @ XA2 @ XR)) => (cwcel @ (ccpred @ XA2 @ XR @ XX) @ ccvv)))))).
thf(apredidm_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((ccpred @ (ccpred @ XA2 @ XR @ XX) @ XR @ XX) = (ccpred @ XA2 @ XR @ XX)))))).
thf(apredin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((ccpred @ (ccin @ XA2 @ XB2) @ XR @ XX) = (ccin @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ XB2 @ XR @ XX)))))))).
thf(apredun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((ccpred @ (ccun @ XA2 @ XB2) @ XR @ XX) = (ccun @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ XB2 @ XR @ XX)))))))).
thf(apreddif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((ccpred @ (ccdif @ XA2 @ XB2) @ XR @ XX) = (ccdif @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ XB2 @ XR @ XX)))))))).
thf(apredep_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XB2) => ((ccpred @ XA2 @ ccep @ XX) = (ccin @ XA2 @ XX))))))).
...
thf(apredpoirr_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwpo @ XA2 @ XR) => (~ (cwcel @ XX @ (ccpred @ XA2 @ XR @ XX)))))))).
thf(apredfrirr_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwfr @ XA2 @ XR) => (~ (cwcel @ XX @ (ccpred @ XA2 @ XR @ XX)))))))).
thf(apred0_thm,axiom,(! [XR:($i > $o)] : (! [XX:($i > $o)] : ((ccpred @ cc0 @ XR @ XX) = cc0)))).
thf(atz6_26_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwss @ XB2 @ XA2) & (XB2 != cc0))) => (cwrex @ (^ [Xy1:$i] : ((ccpred @ XB2 @ XR @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : XB2))))))).
thf(atz6_26i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => (((cwss @ XB2 @ XA2) & (XB2 != cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccpred @ XB2 @ XR @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : XB2))))))))).
thf(awfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwss @ XB2 @ XA2) & (cwral @ (^ [Xy1:$i] : ((cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ XB2) => (cwcel @ (ccv @ Xy1) @ XB2))) @ (^ [Xy1:$i] : XA2)))) => (XA2 = XB2)))))).
thf(awfii_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => (((cwss @ XB2 @ XA2) & (cwral @ (^ [Xy1:$i] : ((cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ XB2) => (cwcel @ (ccv @ Xy1) @ XB2))) @ (^ [Xy1:$i] : XA2))) => (XA2 = XB2)))))))).
...
thf(awfis_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => ((cwral @ (^ [Xz:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))) => (Xph @ Xy1)))) => (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => (Xph @ Xy1)))))))))).
...
thf(awfis2f_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : ((? [X:$i] : ((^ [Xy1:$i] : (Xps @ Xy1 @ Xz)) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (Xps @ Xy1 @ Xz)) @ X)))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xy1 @ Xz))))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => ((cwral @ (^ [Xz:$i] : (Xps @ Xy1 @ Xz)) @ (^ [Xz:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))) => (Xph @ Xy1)))) => (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => (Xph @ Xy1))))))))))))).
thf(awfis2g_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => ((cwral @ (^ [Xz:$i] : (Xps @ Xz)) @ (^ [Xz:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))) => (Xph @ Xy1)))) => (((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) => (cwral @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : XA2)))))))))).
thf(awfis2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => ((cwral @ (^ [Xz:$i] : (Xps @ Xz)) @ (^ [Xz:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))) => (Xph @ Xy1)))) => (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => (Xph @ Xy1)))))))))))).
thf(awfis3_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (XB2 @ Xz)) => ((Xph @ Xy1) <=> (Xch @ Xz))))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => ((cwral @ (^ [Xz:$i] : (Xps @ Xz)) @ (^ [Xz:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))) => (Xph @ Xy1)))) => (! [Xz:$i] : ((cwcel @ (XB2 @ Xz) @ XA2) => (Xch @ Xz))))))))))))))).
