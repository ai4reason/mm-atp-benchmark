...
thf(afaclbnd6_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => (cwbr @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XM @ ccexp) @ ccmul) @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ ccfa) @ ccle))))).
