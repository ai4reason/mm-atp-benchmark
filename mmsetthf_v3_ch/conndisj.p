...
thf(aconndisj_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XJ @ ccconn)) => ((Xph => (cwcel @ XA2 @ XJ)) => ((Xph => (XA2 != cc0)) => ((Xph => (cwcel @ XB2 @ XJ)) => ((Xph => (XB2 != cc0)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (Xph => ((ccun @ XA2 @ XB2) != XX))))))))))))))).
