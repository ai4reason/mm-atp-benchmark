...
thf(adrnfc1_thm,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) => ((XA2 @ Xx3 @ Xy1) = (XB2 @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) <=> (cwnfc @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))))))))))).
