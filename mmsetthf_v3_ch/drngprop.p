...
thf(adrngprop_thm,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (((ccfv @ XK @ ccbs) = (ccfv @ XL @ ccbs)) => (((ccfv @ XK @ ccplusg) = (ccfv @ XL @ ccplusg)) => (((ccfv @ XK @ ccmulr) = (ccfv @ XL @ ccmulr)) => ((cwcel @ XK @ ccdr) <=> (cwcel @ XL @ ccdr)))))))).
