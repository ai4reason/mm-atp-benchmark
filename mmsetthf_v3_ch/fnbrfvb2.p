...
thf(afnbrfvb2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwfn @ XF @ (ccxp @ XV @ XW)) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW))) => (((ccfv @ (ccop @ XA2 @ XB2) @ XF) = XC) <=> (cwbr @ (ccop @ XA2 @ XB2) @ XC @ XF)))))))))).
