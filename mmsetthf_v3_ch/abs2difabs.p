...
thf(aabs2difabs_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (cwbr @ (ccfv @ (cco @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ ccle))))).
