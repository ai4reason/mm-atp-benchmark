...
thf(anorm3dif_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmv) @ ccno) @ (ccfv @ (cco @ XC @ XB2 @ ccmv) @ ccno) @ ccaddc) @ ccle)))))).
