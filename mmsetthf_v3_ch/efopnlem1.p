...
thf(aefopnlem1_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((((cwcel @ XR @ ccrp) & (cwbr @ XR @ ccpi @ cclt)) & (cwcel @ XA2 @ (cco @ ccc0 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => (cwbr @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs) @ ccpi @ cclt))))).
