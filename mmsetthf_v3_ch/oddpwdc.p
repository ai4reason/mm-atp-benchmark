...
thf(aoddpwdc_thm,conjecture,(! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > $o))] : ((! [Xz:$i] : ((XJ @ Xz) = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XJ @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ (ccv @ Xx3) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwf1o @ (ccxp @ (XJ @ Xz) @ ccn0) @ ccn @ (XF @ Xx3 @ Xy1 @ Xz)))))))))).
