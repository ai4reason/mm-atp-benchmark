...
thf(aquoremnn0_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((XQ = (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl)) => ((XR = (cco @ XA2 @ (cco @ XB2 @ XQ @ ccmul) @ ccmin)) => (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn)) => (((cwcel @ XQ @ ccn0) & (cwcel @ XR @ ccn0)) & ((cwbr @ XR @ XB2 @ cclt) & (XA2 = (cco @ (cco @ XB2 @ XQ @ ccmul) @ XR @ ccaddc)))))))))))).
