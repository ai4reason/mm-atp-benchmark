...
thf(acmpsub_thm,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp) <=> (cwral @ (^ [Xc:$i] : ((cwss @ XS @ (ccuni @ (ccv @ Xc))) => (cwrex @ (^ [Xd:$i] : (cwss @ XS @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ XJ)))))))))).
