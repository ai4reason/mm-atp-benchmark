...
thf(anegfcncf_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccv @ Xx3) @ XF)))))) => (! [Xx3:$i] : ((cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf)) => (cwcel @ (XG @ Xx3) @ (cco @ XA2 @ ccc @ cccncf))))))))).
