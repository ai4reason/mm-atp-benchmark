...
thf(axadddir_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccr)) => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxmu) = (cco @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccxad))))))).
