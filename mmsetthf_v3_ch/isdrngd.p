...
thf(aisdrngd_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (Xc_x = (ccfv @ XR @ ccmulr))) => ((Xph => (Xc_0 = (ccfv @ XR @ cc0g))) => ((Xph => (Xc_1 = (ccfv @ XR @ ccur))) => ((Xph => (cwcel @ XR @ ccrg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0)) & ((cwcel @ (ccv @ Xy1) @ XB2) & ((ccv @ Xy1) != Xc_0))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) != Xc_0)))) => ((Xph => (Xc_1 != Xc_0)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0))) => (cwcel @ (XI @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0))) => ((XI @ Xx3) != Xc_0))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0))) => ((cco @ (XI @ Xx3) @ (ccv @ Xx3) @ Xc_x) = Xc_1))) => (Xph => (cwcel @ XR @ ccdr)))))))))))))))))))).
