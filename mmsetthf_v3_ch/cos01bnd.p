...
thf(acos01bnd_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) => ((cwbr @ (cco @ cc1 @ (cco @ cc2 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmul) @ ccmin) @ (ccfv @ XA2 @ cccos) @ cclt) & (cwbr @ (ccfv @ XA2 @ cccos) @ (cco @ cc1 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ cclt))))).
