...
thf(axkohmeo_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((XF = (ccmpt @ (^ [Xf1:$i] : (cco @ (cco @ XJ @ XK @ cctx) @ XL @ cccn)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xf1))))))))) => ((Xph => (cwcel @ XJ @ (ccnlly @ cccmp))) => ((Xph => (cwcel @ XK @ (ccnlly @ cccmp))) => ((Xph => (cwcel @ XL @ cctop)) => (Xph => (cwcel @ XF @ (cco @ (cco @ XL @ (cco @ XJ @ XK @ cctx) @ ccxko) @ (cco @ (cco @ XL @ XK @ ccxko) @ XJ @ ccxko) @ cchmeo))))))))))))))))).
