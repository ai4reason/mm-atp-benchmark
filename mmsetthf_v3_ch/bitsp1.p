...
thf(abitsp1_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((cwcel @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ XN @ ccbits)) <=> (cwcel @ XM @ (ccfv @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ ccbits))))))).
