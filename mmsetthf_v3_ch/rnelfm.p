...
thf(arnelfm_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XY @ XA2) & (cwcel @ XL @ (ccfv @ XX @ ccfil)) & (cwf @ XY @ XX @ XF)) => ((cwcel @ XL @ (ccrn @ (cco @ XX @ XF @ ccfm))) <=> (cwcel @ (ccrn @ XF) @ XL))))))))).
