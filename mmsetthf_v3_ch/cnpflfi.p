...
thf(acnpflfi_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XA2 @ (cco @ XJ @ XL @ ccflim)) & (cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp)))) => (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ XF @ (cco @ XK @ XL @ ccflf)))))))))).
