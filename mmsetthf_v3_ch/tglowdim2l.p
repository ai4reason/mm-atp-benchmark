...
thf(atglowdim2l_thm,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XL @ Xa @ Xb @ Xc) = (ccfv @ XG @ cclng))))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => (Xph => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (~ ((cwcel @ (ccv @ Xc) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (XL @ Xa @ Xb @ Xc))) | ((ccv @ Xa) = (ccv @ Xb))))) @ (^ [Xc:$i] : XP))) @ (^ [Xb:$i] : XP))) @ (^ [Xa:$i] : XP)))))))))))))).
