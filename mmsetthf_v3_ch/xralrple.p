...
thf(axralrple_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (cco @ XB2 @ (ccv @ Xx3) @ ccaddc) @ ccle)) @ (^ [Xx3:$i] : ccrp))))))).
