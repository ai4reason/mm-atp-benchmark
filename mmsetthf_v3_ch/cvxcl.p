...
thf(acvxcl_thm,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwss @ XD @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XD) & (cwcel @ (ccv @ Xy1) @ XD))) => (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XD)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ XX @ XD) & (cwcel @ XY @ XD) & (cwcel @ (XT @ Xx3 @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc)))) => (cwcel @ (cco @ (cco @ (XT @ Xx3 @ Xy1) @ XX @ ccmul) @ (cco @ (cco @ cc1 @ (XT @ Xx3 @ Xy1) @ ccmin) @ XY @ ccmul) @ ccaddc) @ XD)))))))))))).
