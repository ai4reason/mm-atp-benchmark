...
thf(armxdiophlem_thm,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0) & (cwcel @ XX @ ccn0)) => ((XX = (cco @ XA2 @ XN @ ccrmx)) <=> (cwrex @ (^ [Xy1:$i] : (((ccv @ Xy1) = (cco @ XA2 @ XN @ ccrmy)) & ((cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1))) @ (^ [Xy1:$i] : ccn0)))))))).
