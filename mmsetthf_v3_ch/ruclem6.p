...
thf(arpnnen2lem12_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ ccn)) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ (ccv @ Xx3)) @ (cco @ (cco @ cc1 @ cc3 @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccc0)))))))) => (cwbr @ (ccpw @ ccn) @ (cco @ ccc0 @ cc1 @ ccicc) @ ccdom)))).
thf(arpnnen2_thm,axiom,(cwbr @ (ccpw @ ccn) @ (cco @ ccc0 @ cc1 @ ccicc) @ ccdom)).
thf(arpnnen_thm,axiom,(cwbr @ ccr @ (ccpw @ ccn) @ ccen)).
thf(arexpen_thm,axiom,(cwbr @ (ccxp @ ccr @ ccr) @ ccr @ ccen)).
thf(acpnnen_thm,axiom,(cwbr @ ccc @ (ccpw @ ccn) @ ccen)).
thf(arucALT_thm,axiom,(cwbr @ ccn @ ccr @ ccsdm)).
...
thf(aruclem2_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwf @ ccn @ ccr @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => ((XD @ Xx3 @ Xy1 @ Xm) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ ccr @ ccr))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccsb @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (^ [Xm:$i] : (ccif @ (cwbr @ (ccv @ Xm) @ (ccv @ Xy1) @ cclt) @ (ccop @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccv @ Xm)) @ (ccop @ (cco @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ cc2nd))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwcel @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwcel @ XB2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwcel @ XM @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((XX @ Xx3 @ Xy1 @ Xm) = (ccfv @ (cco @ (ccop @ XA2 @ XB2) @ XM @ (XD @ Xx3 @ Xy1 @ Xm)) @ cc1st))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((XY @ Xx3 @ Xy1 @ Xm) = (ccfv @ (cco @ (ccop @ XA2 @ XB2) @ XM @ (XD @ Xx3 @ Xy1 @ Xm)) @ cc2nd))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwbr @ XA2 @ XB2 @ cclt))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => ((cwbr @ XA2 @ (XX @ Xx3 @ Xy1 @ Xm) @ ccle) & (cwbr @ (XX @ Xx3 @ Xy1 @ Xm) @ (XY @ Xx3 @ Xy1 @ Xm) @ cclt) & (cwbr @ (XY @ Xx3 @ Xy1 @ Xm) @ XB2 @ ccle))))))))))))))))))))))).
thf(aruclem3_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwf @ ccn @ ccr @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => ((XD @ Xx3 @ Xy1 @ Xm) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ ccr @ ccr))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccsb @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (^ [Xm:$i] : (ccif @ (cwbr @ (ccv @ Xm) @ (ccv @ Xy1) @ cclt) @ (ccop @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccv @ Xm)) @ (ccop @ (cco @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ cc2nd))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwcel @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwcel @ XB2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwcel @ XM @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((XX @ Xx3 @ Xy1 @ Xm) = (ccfv @ (cco @ (ccop @ XA2 @ XB2) @ XM @ (XD @ Xx3 @ Xy1 @ Xm)) @ cc1st))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((XY @ Xx3 @ Xy1 @ Xm) = (ccfv @ (cco @ (ccop @ XA2 @ XB2) @ XM @ (XD @ Xx3 @ Xy1 @ Xm)) @ cc2nd))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwbr @ XA2 @ XB2 @ cclt))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => ((cwbr @ XM @ (XX @ Xx3 @ Xy1 @ Xm) @ cclt) | (cwbr @ (XY @ Xx3 @ Xy1 @ Xm) @ XM @ cclt))))))))))))))))))))))).
thf(aruclem4_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwf @ ccn @ ccr @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => ((XD @ Xx3 @ Xy1 @ Xm) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ ccr @ ccr))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccsb @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (^ [Xm:$i] : (ccif @ (cwbr @ (ccv @ Xm) @ (ccv @ Xy1) @ cclt) @ (ccop @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccv @ Xm)) @ (ccop @ (cco @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ cc2nd))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((XC @ Xx3 @ Xy1 @ Xm) = (ccun @ (ccsn @ (ccop @ ccc0 @ (ccop @ ccc0 @ cc1))) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (XG = (ccseq @ (XD @ Xx3 @ Xy1 @ Xm) @ (XC @ Xx3 @ Xy1 @ Xm) @ ccc0))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => ((ccfv @ ccc0 @ XG) = (ccop @ ccc0 @ cc1)))))))))))))))).
thf(aruclem6_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwf @ ccn @ ccr @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => ((XD @ Xx3 @ Xy1 @ Xm) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ ccr @ ccr))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccsb @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (^ [Xm:$i] : (ccif @ (cwbr @ (ccv @ Xm) @ (ccv @ Xy1) @ cclt) @ (ccop @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccv @ Xm)) @ (ccop @ (cco @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ cc2nd))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((XC @ Xx3 @ Xy1 @ Xm) = (ccun @ (ccsn @ (ccop @ ccc0 @ (ccop @ ccc0 @ cc1))) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (XG = (ccseq @ (XD @ Xx3 @ Xy1 @ Xm) @ (XC @ Xx3 @ Xy1 @ Xm) @ ccc0))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xm) => (cwf @ ccn0 @ (ccxp @ ccr @ ccr) @ XG))))))))))))))).
