...
thf(arepsco_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ XA2) & (cwcel @ XN @ ccn0) & (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XS @ XN @ ccreps)) = (cco @ (ccfv @ XS @ XF) @ XN @ ccreps))))))))).
