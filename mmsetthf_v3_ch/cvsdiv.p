...
thf(acvsdiv_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccvs) & ((cwcel @ XA2 @ XK) & (cwcel @ XB2 @ XK) & (XB2 != ccc0))) => ((cco @ XA2 @ XB2 @ ccdiv) = (cco @ XA2 @ XB2 @ (ccfv @ XF @ ccdvr)))))))))))).
