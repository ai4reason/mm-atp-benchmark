...
thf(apoltletr_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwpo @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => (((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XB2 @ XC @ (ccun @ XR @ ccid))) => (cwbr @ XA2 @ XC @ XR))))))))).
