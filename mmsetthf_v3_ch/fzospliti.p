...
thf(afzospliti_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) & (cwcel @ XD @ ccz)) => ((cwcel @ XA2 @ (cco @ XB2 @ XD @ ccfzo)) | (cwcel @ XA2 @ (cco @ XD @ XC @ ccfzo))))))))).
