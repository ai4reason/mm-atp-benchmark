...
thf(asubsubmgm_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XG @ ccsubmgm)) => ((cwcel @ XA2 @ (ccfv @ XH @ ccsubmgm)) <=> ((cwcel @ XA2 @ (ccfv @ XG @ ccsubmgm)) & (cwss @ XA2 @ XS)))))))))).
