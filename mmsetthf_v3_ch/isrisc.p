...
thf(aisrisc_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XR @ ccvv) => ((cwcel @ XS @ ccvv) => ((cwbr @ XR @ XS @ ccrisc) <=> (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo)) & (? [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XR @ XS @ ccrngiso)))))))))).
