...
thf(afun2dmnop0_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((cwfun @ (ccdif @ XG @ (ccsn @ cc0))) & (XA2 != XB2) & (cwss @ (ccpr @ XA2 @ XB2) @ (ccdm @ XG))) => (~ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)))))))))).
