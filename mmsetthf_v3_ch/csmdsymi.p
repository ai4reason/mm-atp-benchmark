...
thf(acsmdsymi_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xc:$i] : (cwcel @ (XA2 @ Xc) @ ccch)) => ((cwcel @ XB2 @ ccch) => (! [Xc:$i] : (((cwral @ (^ [Xc:$i] : ((cwbr @ (ccv @ Xc) @ XB2 @ ccmd) => (cwbr @ XB2 @ (ccv @ Xc) @ ccdmd))) @ (^ [Xc:$i] : ccch)) & (cwbr @ (XA2 @ Xc) @ XB2 @ ccmd)) => (cwbr @ XB2 @ (XA2 @ Xc) @ ccmd)))))))).
