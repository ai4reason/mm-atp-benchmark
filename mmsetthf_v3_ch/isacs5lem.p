...
thf(aisacs5lem_thm,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xt:$i] : ((cwcel @ (ccfv @ (ccv @ Xt) @ ccipo) @ ccdrs) => ((ccfv @ (ccuni @ (ccv @ Xt)) @ XF) = (ccuni @ (ccima @ XF @ (ccv @ Xt)))))) @ (^ [Xt:$i] : (ccpw @ (ccpw @ XX))))) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xs1:$i] : ((ccfv @ (ccv @ Xs1) @ XF) = (ccuni @ (ccima @ XF @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))))) @ (^ [Xs1:$i] : (ccpw @ XX)))))))))).
