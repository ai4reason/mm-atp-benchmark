...
thf(asnssgOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ XB2) <=> (cwss @ (ccsn @ XA2) @ XB2))))))).
thf(aeldifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC))) <=> ((cwcel @ XA2 @ XB2) & (XA2 != XC))))))).
thf(assdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC))) <=> ((cwss @ XA2 @ XB2) & (~ (cwcel @ XC @ XA2)))))))).
thf(assdifsnOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC))) <=> ((cwss @ XA2 @ XB2) & (~ (cwcel @ XC @ XA2)))))))).
thf(aelpwdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XS @ XW) & (cwss @ XS @ XV) & (~ (wnel @ XA2 @ XS))) => (cwcel @ XS @ (ccpw @ (ccdif @ XV @ (ccsn @ XA2)))))))))).
...
thf(araldifsnb_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XY:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (((ccv @ Xx3) != XY) => (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccsn @ XY))))))))).
thf(aeldifvsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ (ccdif @ ccvv @ (ccsn @ XB2))) <=> (XA2 != XB2))))))).
...
thf(adiftpsn3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((XA2 != XC) & (XB2 != XC)) => ((ccdif @ (cctp @ XA2 @ XB2 @ XC) @ (ccsn @ XC)) = (ccpr @ XA2 @ XB2))))))).
thf(adiftpsn3OLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((XA2 != XC) & (XB2 != XC)) => ((ccdif @ (cctp @ XA2 @ XB2 @ XC) @ (ccsn @ XC)) = (ccpr @ XA2 @ XB2))))))).
thf(adifpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ XA2 @ (ccpr @ XB2 @ XC)) = (ccdif @ (ccdif @ XA2 @ (ccsn @ XB2)) @ (ccsn @ XC))))))).
thf(atpprceq3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((~ ((cwcel @ XC @ ccvv) & (XC != XB2))) => ((cctp @ XA2 @ XB2 @ XC) = (ccpr @ XA2 @ XB2))))))).
thf(atppreqb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((~ ((cwcel @ XC @ ccvv) & (XC != XA2) & (XC != XB2))) <=> ((cctp @ XA2 @ XB2 @ XC) = (ccpr @ XA2 @ XB2))))))).
thf(adifsnb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (cwcel @ XA2 @ XB2)) <=> ((ccdif @ XB2 @ (ccsn @ XA2)) = XB2))))).
thf(adifsnpss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ XB2) <=> (cwpss @ (ccdif @ XB2 @ (ccsn @ XA2)) @ XB2))))).
...
thf(aeldifeldifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XA2) & (cwcel @ XY @ (ccdif @ XB2 @ XA2))) => (cwcel @ XY @ (ccdif @ XB2 @ (ccsn @ XX))))))))).
thf(apw0_thm,axiom,((ccpw @ cc0) = (ccsn @ cc0))).
thf(apwpw0_thm,axiom,((ccpw @ (ccsn @ cc0)) = (ccpr @ cc0 @ (ccsn @ cc0)))).
...
thf(asnsstp1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwss @ (ccsn @ XA2) @ (cctp @ XA2 @ XB2 @ XC)))))).
