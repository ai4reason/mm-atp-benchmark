...
thf(adivle1le_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1 @ ccle) <=> (cwbr @ XA2 @ XB2 @ ccle)))))).
thf(aledivge1le_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp) & ((cwcel @ XC @ ccrp) & (cwbr @ cc1 @ XC @ ccle))) => ((cwbr @ XA2 @ XB2 @ ccle) => (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle))))))).
...
thf(altmulgt11d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((cwbr @ cc1 @ XA2 @ cclt) <=> (cwbr @ XB2 @ (cco @ XB2 @ XA2 @ ccmul) @ cclt))))))))).
thf(altmulgt12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((cwbr @ cc1 @ XA2 @ cclt) <=> (cwbr @ XB2 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))))))))).
thf(agt0divd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ cclt))))))))).
thf(age0divd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((cwbr @ ccc0 @ XA2 @ ccle) <=> (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccle))))))))).
...
thf(alemul1d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccle))))))))))).
