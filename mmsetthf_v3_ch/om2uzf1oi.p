...
thf(aom2uzf1oi_thm,conjecture,(! [XC:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwcel @ XC @ ccz) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XC) @ ccom))) => (! [Xx3:$i] : (cwf1o @ ccom @ (ccfv @ XC @ ccuz) @ (XG @ Xx3)))))))).
