...
thf(aperfect_thm,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwbr @ cc2 @ XN @ ccdvds)) => (((cco @ cc1 @ XN @ ccsgm) = (cco @ cc2 @ XN @ ccmul)) <=> (cwrex @ (^ [Xp:$i] : ((cwcel @ (cco @ (cco @ cc2 @ (ccv @ Xp) @ ccexp) @ cc1 @ ccmin) @ ccprime) & (XN = (cco @ (cco @ cc2 @ (cco @ (ccv @ Xp) @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xp) @ ccexp) @ cc1 @ ccmin) @ ccmul)))) @ (^ [Xp:$i] : ccz)))))).
