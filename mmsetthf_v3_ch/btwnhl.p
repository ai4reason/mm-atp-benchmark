...
thf(abtwnhl_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwbr @ XA2 @ XB2 @ (ccfv @ XD @ XK))) => ((Xph => (cwcel @ XD @ (cco @ XA2 @ XC @ XI))) => (Xph => (cwcel @ XD @ (cco @ XB2 @ XC @ XI))))))))))))))))))))))).
