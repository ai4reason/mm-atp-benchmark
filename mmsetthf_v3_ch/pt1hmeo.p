...
thf(apt1hmeo_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XK = (ccfv @ (ccsn @ (ccop @ XA2 @ XJ)) @ ccpt)) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XA2 @ (ccv @ Xx3))))) @ (cco @ XJ @ XK @ cchmeo))))))))))))).
