...
thf(afacndiv_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn)) & ((cwbr @ cc1 @ XN @ cclt) & (cwbr @ XN @ XM @ ccle))) => (~ (cwcel @ (cco @ (cco @ (ccfv @ XM @ ccfa) @ cc1 @ ccaddc) @ XN @ ccdiv) @ ccz)))))).
