...
thf(aeulerpartlemgc_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xn:$i] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))))))) => (! [Xt:$i] : (! [Xf1:$i] : (((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) & ((cwcel @ (ccv @ Xt) @ ccn) & (cwcel @ (ccv @ Xn) @ (ccfv @ (ccfv @ (ccv @ Xt) @ XA2) @ ccbits)))) => (cwbr @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ (ccv @ Xt) @ ccmul) @ (ccfv @ XA2 @ (XS @ Xf1)) @ ccle))))))))))).
