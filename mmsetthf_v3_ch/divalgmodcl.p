...
thf(adivalgmodcl_thm,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XD @ ccn) & (cwcel @ XR @ ccn0)) => ((XR = (cco @ XN @ XD @ ccmo)) <=> ((cwbr @ XR @ XD @ cclt) & (cwbr @ XD @ (cco @ XN @ XR @ ccmin) @ ccdvds)))))))).
