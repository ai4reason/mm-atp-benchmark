...
thf(asucel_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ (ccsuc @ XA2) @ (XB2 @ Xy1)) <=> (cwrex @ (^ [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) <=> ((cwcel @ (ccv @ Xy1) @ XA2) | ((ccv @ Xy1) = XA2))))) @ (^ [Xx3:$i] : (XB2 @ Xy1)))))))).
