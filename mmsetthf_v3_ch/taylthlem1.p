...
thf(ataylthlem1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ XS)) => ((Xph => ((ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))) = XA2)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XB2 @ XA2)) => ((XT = (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XR @ Xx3 @ Xy1 @ Xn) = (ccmpt @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccmin) @ (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ XN @ ccexp) @ ccdiv))))))) => ((! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfzo)) & (cwcel @ ccc0 @ (cco @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xy1:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (cco @ XN @ (ccv @ Xn) @ ccmin) @ (cco @ XS @ XF @ ccdvn))) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (cco @ XN @ (ccv @ Xn) @ ccmin) @ (cco @ ccc @ XT @ ccdvn))) @ ccmin) @ (cco @ (cco @ (ccv @ Xy1) @ XB2 @ ccmin) @ (ccv @ Xn) @ ccexp) @ ccdiv))) @ XB2 @ cclimc)))) => (cwcel @ ccc0 @ (cco @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmin) @ (cco @ XS @ XF @ ccdvn))) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmin) @ (cco @ ccc @ XT @ ccdvn))) @ ccmin) @ (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccexp) @ ccdiv))) @ XB2 @ cclimc)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (Xph => (cwcel @ ccc0 @ (cco @ (XR @ Xx3 @ Xy1 @ Xn) @ XB2 @ cclimc)))))))))))))))))))))))).
