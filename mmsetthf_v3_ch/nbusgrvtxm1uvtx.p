...
thf(anbusgrvtxm1uvtx_thm,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfusgr) & (cwcel @ XU @ XV)) => (((ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)) => (cwcel @ XU @ (ccfv @ XG @ ccuvtx))))))))).
