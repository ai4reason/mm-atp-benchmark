...
thf(adfoprab3s_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : ((ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) = (ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : ((cwcel @ (ccv @ Xw) @ (ccxp @ ccvv @ ccvv)) & (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (ccfv @ (ccv @ Xw) @ cc2nd))) @ (ccfv @ (ccv @ Xw) @ cc1st))))))))).
