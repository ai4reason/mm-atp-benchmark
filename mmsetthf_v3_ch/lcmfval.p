...
thf(alcmfval_thm,conjecture,(! [XZ:($i > $o)] : (((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn)) => ((ccfv @ XZ @ cclcmf) = (ccif @ (cwcel @ ccc0 @ XZ) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XZ))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
