...
thf(atsmspropd_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwcel @ XG @ XW)) => ((Xph => (cwcel @ XH @ XX)) => ((Xph => ((ccfv @ XG @ ccbs) = (ccfv @ XH @ ccbs))) => ((Xph => ((ccfv @ XG @ ccplusg) = (ccfv @ XH @ ccplusg))) => ((Xph => ((ccfv @ XG @ cctopn) = (ccfv @ XH @ cctopn))) => (Xph => ((cco @ XG @ XF @ cctsu) = (cco @ XH @ XF @ cctsu))))))))))))))))).
