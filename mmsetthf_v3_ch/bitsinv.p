...
thf(abitsinv_thm,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xk:$i] : ((XK @ Xk) = (cccnv @ (ccres @ ccbits @ ccn0)))) => (! [Xk:$i] : ((cwcel @ XA2 @ (ccin @ (ccpw @ ccn0) @ ccfn)) => ((ccfv @ XA2 @ (XK @ Xk)) = (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ cc2 @ (ccv @ Xk) @ ccexp)))))))))).
