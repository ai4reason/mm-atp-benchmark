...
thf(asubmnd0_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XH = (cco @ XG @ XS @ ccress)) => ((((cwcel @ XG @ ccmnd) & (cwcel @ XH @ ccmnd)) & ((cwss @ XS @ XB2) & (cwcel @ Xc_0 @ XS))) => (Xc_0 = (ccfv @ XH @ cc0g)))))))))))).
