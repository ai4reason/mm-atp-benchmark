...
thf(aofmres_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((ccres @ (ccof @ XR) @ (ccxp @ XA2 @ XB2)) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : XA2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccof @ XR)))))))))).
