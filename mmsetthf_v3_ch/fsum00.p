...
thf(afsum00_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwbr @ ccc0 @ (XB2 @ Xk) @ ccle))) => (Xph => (((ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) = ccc0) <=> (cwral @ (^ [Xk:$i] : ((XB2 @ Xk) = ccc0)) @ (^ [Xk:$i] : XA2))))))))))).
