...
thf(aax12wdemo_thm,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (! [Xx3:$i] : (cwcel @ (ccv @ Xz) @ (ccv @ Xx3))) & (! [Xy1:$i] : (! [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (! [Xx3:$i] : (cwcel @ (ccv @ Xz) @ (ccv @ Xx3))) & (! [Xy1:$i] : (! [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))))))).
