...
thf(aoalim_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ ccon0) & ((cwcel @ XB2 @ (XC @ Xx3)) & (cwlim @ XB2))) => ((cco @ XA2 @ XB2 @ ccoa) = (cciun @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa)))))))))).
