...
thf(arimf1o_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (ccfv @ XS @ ccbs)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccrs)) => (cwf1o @ XB2 @ XC @ XF)))))))))).
thf(arimrhm_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (ccfv @ XS @ ccbs)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccrs)) => (cwcel @ XF @ (cco @ XR @ XS @ ccrh))))))))))).
thf(arimgim_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XR @ XS @ ccrs)) => (cwcel @ XF @ (cco @ XR @ XS @ ccgim))))))).
...
thf(apwsco1rhm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XR @ XA2 @ ccpws)) => ((XZ = (cco @ XR @ XB2 @ ccpws)) => ((XC = (ccfv @ XZ @ ccbs)) => ((Xph => (cwcel @ XR @ ccrg)) => ((! [Xg1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xg1)))) => ((! [Xg1:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xg1)))) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => (Xph => (cwcel @ (ccmpt @ (^ [Xg1:$i] : XC) @ (^ [Xg1:$i] : (cccom @ (ccv @ Xg1) @ XF))) @ (cco @ XZ @ XY @ ccrh))))))))))))))))))))).
thf(apwsco2rhm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XR @ XA2 @ ccpws)) => ((XZ = (cco @ XS @ XA2 @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((! [Xg1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xg1)))) => ((Xph => (cwcel @ XF @ (cco @ XR @ XS @ ccrh))) => (Xph => (cwcel @ (ccmpt @ (^ [Xg1:$i] : XB2) @ (^ [Xg1:$i] : (cccom @ XF @ (ccv @ Xg1)))) @ (cco @ XY @ XZ @ ccrh)))))))))))))))))).
thf(af1rhm0to0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XS @ cc0g)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) & (cwf1 @ XA2 @ XB2 @ XF) & (cwcel @ XX @ XA2)) => (((ccfv @ XX @ XF) = XN) <=> (XX = Xc_0)))))))))))))))).
thf(af1rhm0to0ALT_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XS @ cc0g)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) & (cwf1 @ XA2 @ XB2 @ XF) & (cwcel @ XX @ XA2)) => (((ccfv @ XX @ XF) = XN) <=> (XX = Xc_0)))))))))))))))).
thf(arim0to0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XS @ cc0g)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XF @ (cco @ XR @ XS @ ccrs)) & (cwcel @ XX @ XA2)) => (((ccfv @ XX @ XF) = XN) <=> (XX = Xc_0)))))))))))))))).
...
thf(abrric2_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ ccric) <=> (((cwcel @ XR @ ccrg) & (cwcel @ XS @ ccrg)) & (? [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XR @ XS @ ccrs)))))))).
thf(aricgic_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ ccric) => (cwbr @ XR @ XS @ ccgic))))).
thf(ccdr_tp,type,(ccdr : ($i > $o))).
thf(ccfield_tp,type,(ccfield : ($i > $o))).
thf(adf_drng_ax,axiom,(ccdr = (ccrab @ (^ [Xr:$i] : ((ccfv @ (ccv @ Xr) @ ccui) = (ccdif @ (ccfv @ (ccv @ Xr) @ ccbs) @ (ccsn @ (ccfv @ (ccv @ Xr) @ cc0g))))) @ (^ [Xr:$i] : ccrg)))).
...
thf(adrnggrp_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccdr) => (cwcel @ XR @ ccgrp)))).
thf(aisfld_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccfield) <=> ((cwcel @ XR @ ccdr) & (cwcel @ XR @ cccrg))))).
thf(aisdrng2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((cwcel @ XR @ ccdr) <=> ((cwcel @ XR @ ccrg) & (cwcel @ XG @ ccgrp))))))))))).
thf(adrngprop_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (((ccfv @ XK @ ccbs) = (ccfv @ XL @ ccbs)) => (((ccfv @ XK @ ccplusg) = (ccfv @ XL @ ccplusg)) => (((ccfv @ XK @ ccmulr) = (ccfv @ XL @ ccmulr)) => ((cwcel @ XK @ ccdr) <=> (cwcel @ XL @ ccdr)))))))).
thf(adrngmgp_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((cwcel @ XR @ ccdr) => (cwcel @ XG @ ccgrp)))))))))).
...
thf(adrngid_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((cwcel @ XR @ ccdr) => (Xc_1 = (ccfv @ XG @ cc0g))))))))))))).
...
thf(adrnginvrcl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XX @ XB2) & (XX != Xc_0)) => (cwcel @ (ccfv @ XX @ XI) @ XB2))))))))))).
thf(adrnginvrn0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XX @ XB2) & (XX != Xc_0)) => ((ccfv @ XX @ XI) != Xc_0))))))))))).
thf(adrnginvrl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XX @ XB2) & (XX != Xc_0)) => ((cco @ (ccfv @ XX @ XI) @ XX @ Xc_x) = Xc_1))))))))))))))).
thf(adrnginvrr_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XX @ XB2) & (XX != Xc_0)) => ((cco @ XX @ (ccfv @ XX @ XI) @ Xc_x) = Xc_1))))))))))))))).
thf(adrngmul0or_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => (((cco @ XX @ XY @ Xc_x) = Xc_0) <=> ((XX = Xc_0) | (XY = Xc_0)))))))))))))))))).
thf(adrngmulne0_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => (((cco @ XX @ XY @ Xc_x) != Xc_0) <=> ((XX != Xc_0) & (XY != Xc_0)))))))))))))))))).
thf(adrngmuleq0_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (XY != Xc_0)) => (Xph => (((cco @ XX @ XY @ Xc_x) = Xc_0) <=> (XX = Xc_0)))))))))))))))))).
...
thf(aisdrngrd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (Xc_x = (ccfv @ XR @ ccmulr))) => ((Xph => (Xc_0 = (ccfv @ XR @ cc0g))) => ((Xph => (Xc_1 = (ccfv @ XR @ ccur))) => ((Xph => (cwcel @ XR @ ccrg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0)) & ((cwcel @ (ccv @ Xy1) @ XB2) & ((ccv @ Xy1) != Xc_0))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) != Xc_0)))) => ((Xph => (Xc_1 != Xc_0)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0))) => (cwcel @ (XI @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0))) => ((XI @ Xx3) != Xc_0))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccv @ Xx3) != Xc_0))) => ((cco @ (ccv @ Xx3) @ (XI @ Xx3) @ Xc_x) = Xc_1))) => (Xph => (cwcel @ XR @ ccdr)))))))))))))))))))).
thf(adrngpropd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (XB2 = (ccfv @ XK @ ccbs))) => ((Xph => (XB2 = (ccfv @ XL @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XK @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XL @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XK @ ccmulr)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XL @ ccmulr)))))) => (Xph => ((cwcel @ XK @ ccdr) <=> (cwcel @ XL @ ccdr)))))))))))).
thf(afldpropd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (XB2 = (ccfv @ XK @ ccbs))) => ((Xph => (XB2 = (ccfv @ XL @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XK @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XL @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XK @ ccmulr)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XL @ ccmulr)))))) => (Xph => ((cwcel @ XK @ ccfield) <=> (cwcel @ XL @ ccfield)))))))))))).
thf(ccsubrg_tp,type,(ccsubrg : ($i > $o))).
thf(ccrgspn_tp,type,(ccrgspn : ($i > $o))).
thf(adf_subrg_ax,axiom,(ccsubrg = (ccmpt @ (^ [Xw:$i] : ccrg) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : ((cwcel @ (cco @ (ccv @ Xw) @ (ccv @ Xs1) @ ccress) @ ccrg) & (cwcel @ (ccfv @ (ccv @ Xw) @ ccur) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))))))).
thf(adf_rgspn_ax,axiom,(ccrgspn = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xs1:$i] : (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ (ccv @ Xs1) @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xw) @ ccsubrg)))))))))).
...
thf(asubrgdvds_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => ((XE = (ccfv @ XS @ ccdsr)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => (cwss @ XE @ Xc_pa))))))))))).
thf(asubrguss_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XU = (ccfv @ XR @ ccui)) => ((XV = (ccfv @ XS @ ccui)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => (cwss @ XV @ XU))))))))))).
thf(asubrginv_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XI = (ccfv @ XR @ ccinvr)) => ((XU = (ccfv @ XS @ ccui)) => ((XJ = (ccfv @ XS @ ccinvr)) => (((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) & (cwcel @ XX @ XU)) => ((ccfv @ XX @ XI) = (ccfv @ XX @ XJ))))))))))))))).
thf(asubrgdv_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XU = (ccfv @ XS @ ccui)) => ((XE = (ccfv @ XS @ ccdvr)) => (((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) & (cwcel @ XX @ XA2) & (cwcel @ XY @ XU)) => ((cco @ XX @ XY @ Xc_dv) = (cco @ XX @ XY @ XE)))))))))))))))).
thf(asubrgunit_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XU = (ccfv @ XR @ ccui)) => ((XV = (ccfv @ XS @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => ((cwcel @ XX @ XV) <=> ((cwcel @ XX @ XU) & (cwcel @ XX @ XA2) & (cwcel @ (ccfv @ XX @ XI) @ XA2)))))))))))))))).
thf(asubrgugrp_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XU = (ccfv @ XR @ ccui)) => ((XV = (ccfv @ XS @ ccui)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ XU @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => (cwcel @ XV @ (ccfv @ XG @ ccsubg)))))))))))))).
...
thf(aopprsubrg_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppr)) => ((ccfv @ XR @ ccsubrg) = (ccfv @ XO @ ccsubrg)))))).
thf(asubrgint_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwss @ XS @ (ccfv @ XR @ ccsubrg)) & (XS != cc0)) => (cwcel @ (ccint @ XS) @ (ccfv @ XR @ ccsubrg)))))).
thf(asubrgin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) & (cwcel @ XB2 @ (ccfv @ XR @ ccsubrg))) => (cwcel @ (ccin @ XA2 @ XB2) @ (ccfv @ XR @ ccsubrg))))))).
thf(asubrgmre_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwcel @ (ccfv @ XR @ ccsubrg) @ (ccfv @ XB2 @ ccmre))))))).
thf(aissubdrg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XR @ ccinvr))) => (((cwcel @ XR @ ccdr) & (cwcel @ XA2 @ (ccfv @ XR @ ccsubrg))) => ((cwcel @ XS @ ccdr) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XI @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ Xc_0))))))))))))))).
thf(asubsubrg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => ((cwcel @ XB2 @ (ccfv @ XS @ ccsubrg)) <=> ((cwcel @ XB2 @ (ccfv @ XR @ ccsubrg)) & (cwss @ XB2 @ XA2)))))))))).
thf(asubsubrg2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => ((ccfv @ XS @ ccsubrg) = (ccin @ (ccfv @ XR @ ccsubrg) @ (ccpw @ XA2))))))))).
thf(aissubrg3_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((cwcel @ XR @ ccrg) => ((cwcel @ XS @ (ccfv @ XR @ ccsubrg)) <=> ((cwcel @ XS @ (ccfv @ XR @ ccsubg)) & (cwcel @ XS @ (ccfv @ XM @ ccsubmnd)))))))))).
thf(aresrhm_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccrh)) & (cwcel @ XX @ (ccfv @ XS @ ccsubrg))) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccrh)))))))))).
thf(arhmeql_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XS @ XT @ ccrh)) & (cwcel @ XG @ (cco @ XS @ XT @ ccrh))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XS @ ccsubrg)))))))).
thf(arhmima_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (cco @ XM @ XN @ ccrh)) & (cwcel @ XX @ (ccfv @ XM @ ccsubrg))) => (cwcel @ (ccima @ XF @ XX) @ (ccfv @ XN @ ccsubrg)))))))).
thf(acntzsubr_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XM = (ccfv @ XR @ ccmgp)) => ((XZ = (ccfv @ XM @ cccntz)) => (((cwcel @ XR @ ccrg) & (cwss @ XS @ XB2)) => (cwcel @ (ccfv @ XS @ XZ) @ (ccfv @ XR @ ccsubrg)))))))))))).
thf(apwsdiagrhm_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccxp @ XI @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XW)) => (cwcel @ (XF @ Xx3) @ (cco @ XR @ XY @ ccrh)))))))))))))).
...
thf(arhmpropd_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (XB2 = (ccfv @ XJ @ ccbs))) => ((Xph => (XC = (ccfv @ XK @ ccbs))) => ((Xph => (XB2 = (ccfv @ XL @ ccbs))) => ((Xph => (XC = (ccfv @ XM @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XJ @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XL @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XC) & (cwcel @ (ccv @ Xy1) @ XC))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XK @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XM @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XJ @ ccmulr)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XL @ ccmulr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XC) & (cwcel @ (ccv @ Xy1) @ XC))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XK @ ccmulr)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XM @ ccmulr)))))) => (Xph => ((cco @ XJ @ XK @ ccrh) = (cco @ XL @ XM @ ccrh))))))))))))))))))).
