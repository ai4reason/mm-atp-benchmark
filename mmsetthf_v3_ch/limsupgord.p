...
thf(alimsupgord_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccsup @ (ccin @ (ccima @ XF @ (cco @ XB2 @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ (ccsup @ (ccin @ (ccima @ XF @ (cco @ XA2 @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ ccle)))))).
