...
thf(aiunmbl2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwbr @ XA2 @ ccn @ ccdom) & (cwral @ (^ [Xn:$i] : (cwcel @ (XB2 @ Xn) @ (ccdm @ ccvol))) @ (^ [Xn:$i] : XA2))) => (cwcel @ (cciun @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ (ccdm @ ccvol)))))).
