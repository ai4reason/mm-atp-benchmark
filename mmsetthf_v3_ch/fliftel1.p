...
thf(a_2fvidf1od_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf @ (XA2 @ Xb) @ (XB2 @ Xa) @ XF)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf @ (XB2 @ Xa) @ (XA2 @ Xb) @ XG)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwral @ (^ [Xa:$i] : ((ccfv @ (ccfv @ (ccv @ Xa) @ XF) @ XG) = (ccv @ Xa))) @ (^ [Xa:$i] : (XA2 @ Xb)))))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwral @ (^ [Xb:$i] : ((ccfv @ (ccfv @ (ccv @ Xb) @ XG) @ XF) = (ccv @ Xb))) @ (^ [Xb:$i] : (XB2 @ Xa)))))) => (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf1o @ (XA2 @ Xb) @ (XB2 @ Xa) @ XF)))))))))))))).
thf(a_2fvidinvd_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf @ (XA2 @ Xb) @ (XB2 @ Xa) @ XF)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf @ (XB2 @ Xa) @ (XA2 @ Xb) @ XG)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwral @ (^ [Xa:$i] : ((ccfv @ (ccfv @ (ccv @ Xa) @ XF) @ XG) = (ccv @ Xa))) @ (^ [Xa:$i] : (XA2 @ Xb)))))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwral @ (^ [Xb:$i] : ((ccfv @ (ccfv @ (ccv @ Xb) @ XG) @ XF) = (ccv @ Xb))) @ (^ [Xb:$i] : (XB2 @ Xa)))))) => (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => ((cccnv @ XF) = XG)))))))))))))).
thf(afoeqcnvco_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfo @ XA2 @ XB2 @ XF) & (cwfo @ XA2 @ XB2 @ XG)) => ((XF = XG) <=> ((cccom @ XF @ (cccnv @ XG)) = (ccres @ ccid @ XB2))))))))).
thf(af1eqcocnv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & (cwf1 @ XA2 @ XB2 @ XG)) => ((XF = XG) <=> ((cccom @ (cccnv @ XF) @ XG) = (ccres @ ccid @ XA2))))))))).
thf(afveqf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (ccun @ (ccres @ ccid @ (ccdif @ XA2 @ (ccpr @ XC @ (ccfv @ XD @ (cccnv @ XF))))) @ (ccpr @ (ccop @ XC @ (ccfv @ XD @ (cccnv @ XF))) @ (ccop @ (ccfv @ XD @ (cccnv @ XF)) @ XC))))) => (((cwf1o @ XA2 @ XB2 @ XF) & (cwcel @ XC @ XA2) & (cwcel @ XD @ XB2)) => ((cwf1o @ XA2 @ XB2 @ XG) & ((ccfv @ XC @ XG) = XD))))))))))).
thf(afliftrel_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ XR))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3) @ XS))) => (! [Xx3:$i] : (Xph => (cwss @ (XF @ Xx3) @ (ccxp @ XR @ XS))))))))))))))).
...
thf(afliftel1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ XR))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3) @ XS))) => (! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwbr @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XF @ Xx3))))))))))))))).
