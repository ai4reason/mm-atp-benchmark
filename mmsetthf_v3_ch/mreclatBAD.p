...
thf(amreclatBAD_thm,conjecture,(! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XC @ ccipo)) => (((cwcel @ XI @ cccla) <=> ((cwcel @ XI @ ccpo) & (! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (ccfv @ XI @ ccbs)) => ((cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XI @ cclub)) @ (ccfv @ XI @ ccbs)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XI @ ccglb)) @ (ccfv @ XI @ ccbs))))))) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) => (cwcel @ XI @ cccla)))))))).
