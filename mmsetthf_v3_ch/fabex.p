...
thf(afabex_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : ((XF @ Xx3) = (^ [Xx3:$i] : ((cwf @ XA2 @ XB2 @ (ccv @ Xx3)) & (Xph @ Xx3))))) => (! [Xx3:$i] : (cwcel @ (XF @ Xx3) @ ccvv)))))))))).
