...
thf(aconjmul_thm,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((((cwcel @ XP @ ccc) & (XP != ccc0)) & ((cwcel @ XQ @ ccc) & (XQ != ccc0))) => (((cco @ (cco @ cc1 @ XP @ ccdiv) @ (cco @ cc1 @ XQ @ ccdiv) @ ccaddc) = cc1) <=> ((cco @ (cco @ XP @ cc1 @ ccmin) @ (cco @ XQ @ cc1 @ ccmin) @ ccmul) = cc1)))))).
