...
thf(aef01bndlem_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) => (cwbr @ (ccfv @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccabs) @ (cco @ (cco @ XA2 @ cc4 @ ccexp) @ cc6 @ ccdiv) @ cclt))))))).
