...
thf(a_3elpr2eq_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XX @ (ccpr @ XA2 @ XB2)) & (cwcel @ XY @ (ccpr @ XA2 @ XB2)) & (cwcel @ XZ @ (ccpr @ XA2 @ XB2))) & ((XY != XX) & (XZ != XX))) => (XY = XZ)))))))).
