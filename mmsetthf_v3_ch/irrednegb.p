...
thf(airrednegb_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XR @ ccir)) => ((XN = (ccfv @ XR @ ccminusg)) => ((XB2 = (ccfv @ XR @ ccbs)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2)) => ((cwcel @ XX @ XI) <=> (cwcel @ (ccfv @ XX @ XN) @ XI)))))))))))).
