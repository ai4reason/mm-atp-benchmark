...
thf(asbcfng_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((cwsbc @ (^ [Xx3:$i] : (cwfn @ (XF @ Xx3) @ (XA2 @ Xx3))) @ XX) <=> (cwfn @ (ccsb @ XX @ (^ [Xx3:$i] : (XF @ Xx3))) @ (ccsb @ XX @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
