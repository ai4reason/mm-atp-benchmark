...
thf(aifsb_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((((ccif @ Xph @ XA2 @ XB2) = XA2) => (XC = XD)) => ((((ccif @ Xph @ XA2 @ XB2) = XB2) => (XC = XE)) => (XC = (ccif @ Xph @ XD @ XE))))))))))).
thf(adfif3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (^ [Xx3:$i] : Xph))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccun @ (ccin @ (XA2 @ Xx3) @ (XC @ Xx3)) @ (ccin @ (XB2 @ Xx3) @ (ccdif @ ccvv @ (XC @ Xx3)))))))))))).
thf(adfif4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (^ [Xx3:$i] : Xph))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccin @ (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (ccin @ (ccun @ (XA2 @ Xx3) @ (ccdif @ ccvv @ (XC @ Xx3))) @ (ccun @ (XB2 @ Xx3) @ (XC @ Xx3)))))))))))).
thf(adfif5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (^ [Xx3:$i] : Xph))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccun @ (ccin @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (ccun @ (ccin @ (ccdif @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (XC @ Xx3)) @ (ccin @ (ccdif @ (XB2 @ Xx3) @ (XA2 @ Xx3)) @ (ccdif @ ccvv @ (XC @ Xx3))))))))))))).
thf(aifeq12_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = XB2) & (XC = XD)) => ((ccif @ Xph @ XA2 @ XC) = (ccif @ Xph @ XB2 @ XD))))))))).
...
thf(aifbieq2i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph <=> Xps) => ((XA2 = XB2) => ((ccif @ Xph @ XC @ XA2) = (ccif @ Xps @ XC @ XB2)))))))))).
...
thf(anfifd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => ((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwnfc @ (^ [Xx3:$i] : (ccif @ (Xps @ Xx3) @ (XA2 @ Xx3) @ (XB2 @ Xx3)))))))))))))).
...
thf(aifeq12da_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((Xph & Xps) => (XA2 = XC)) => (((Xph & (~ Xps)) => (XB2 = XD)) => (Xph => ((ccif @ Xps @ XA2 @ XB2) = (ccif @ Xps @ XC @ XD)))))))))))).
...
thf(aifval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = (ccif @ Xph @ XB2 @ XC)) <=> ((Xph => (XA2 = XB2)) & ((~ Xph) => (XA2 = XC))))))))).
thf(aelif_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccif @ Xph @ XB2 @ XC)) <=> ((Xph & (cwcel @ XA2 @ XB2)) | ((~ Xph) & (cwcel @ XA2 @ XC))))))))).
...
thf(aifeqor_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((ccif @ Xph @ XA2 @ XB2) = XA2) | ((ccif @ Xph @ XA2 @ XB2) = XB2)))))).
...
thf(a_2if2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((Xph & Xps) => (XD = XA2)) => (((Xph & (~ Xps) & Xth) => (XD = XB2)) => (((Xph & (~ Xps) & (~ Xth)) => (XD = XC)) => (Xph => (XD = (ccif @ Xps @ XA2 @ (ccif @ Xth @ XB2 @ XC))))))))))))))).
thf(aifcomnan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((~ (Xph & Xps)) => ((ccif @ Xph @ XA2 @ (ccif @ Xps @ XB2 @ XC)) = (ccif @ Xps @ XB2 @ (ccif @ Xph @ XA2 @ XC)))))))))).
thf(acsbif_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccif @ (Xph @ Xx3) @ (XB2 @ Xx3) @ (XC @ Xx3)))) = (ccif @ (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3)) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
thf(adedth_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((XA2 = (ccif @ Xph @ XA2 @ XB2)) => (Xps <=> Xch)) => (Xch => (Xph => Xps))))))))).
thf(adedth2h_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = (ccif @ Xph @ XA2 @ XC)) => (Xch <=> Xth)) => (((XB2 = (ccif @ Xps @ XB2 @ XD)) => (Xth <=> Xta)) => (Xta => ((Xph & Xps) => Xch)))))))))))))).
