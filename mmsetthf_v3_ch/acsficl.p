...
thf(aacsficl_thm,conjecture,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccacs)) & (cwss @ XS @ XX)) => ((ccfv @ XS @ XF) = (ccuni @ (ccima @ XF @ (ccin @ (ccpw @ XS) @ ccfn))))))))))).
