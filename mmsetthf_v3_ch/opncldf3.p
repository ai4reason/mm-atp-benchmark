...
thf(aopncldf3_thm,conjecture,(! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((! [Xu:$i] : ((XF @ Xu) = (ccmpt @ (^ [Xu:$i] : XJ) @ (^ [Xu:$i] : (ccdif @ XX @ (ccv @ Xu)))))) => (! [Xu:$i] : ((cwcel @ (XB2 @ Xu) @ (ccfv @ XJ @ cccld)) => ((ccfv @ (XB2 @ Xu) @ (cccnv @ (XF @ Xu))) = (ccdif @ XX @ (XB2 @ Xu)))))))))))).
