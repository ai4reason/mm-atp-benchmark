...
thf(asubrgacl_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_pl = (ccfv @ XR @ ccplusg)) => (((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) & (cwcel @ XX @ XA2) & (cwcel @ XY @ XA2)) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XA2))))))))).
