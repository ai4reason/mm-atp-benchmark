...
thf(aad10antlrOLD_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (! [Xmu:$o] : (! [Xla:$o] : (! [Xka:$o] : ((Xph => Xps) => (((((((((((Xch & Xph) & Xth) & Xta) & Xet) & Xze) & Xsi) & Xrh) & Xmu) & Xla) & Xka) => Xps))))))))))))))).
