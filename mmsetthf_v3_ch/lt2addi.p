...
thf(alt2addi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => ((cwcel @ XD @ ccr) => (((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XB2 @ XD @ cclt)) => (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ cclt))))))))))).
