...
thf(auzwo3_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ ccr) & ((cwss @ XA2 @ (ccrab @ (^ [Xz:$i] : (cwbr @ XB2 @ (ccv @ Xz) @ ccle)) @ (^ [Xz:$i] : ccz))) & (XA2 != cc0))) => (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
