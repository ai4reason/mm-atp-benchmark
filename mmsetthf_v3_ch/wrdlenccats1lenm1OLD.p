...
thf(awrdlenccats1lenm1OLD_thm,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XS @ XV)) => ((ccfv @ XW @ cchash) = (cco @ (ccfv @ (cco @ XW @ (ccs1 @ XS) @ ccconcat) @ cchash) @ cc1 @ ccmin))))))).
