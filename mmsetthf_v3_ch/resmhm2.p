...
thf(aresmhm2_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XU @ ccmhm)) & (cwcel @ XX @ (ccfv @ XT @ ccsubmnd))) => (cwcel @ XF @ (cco @ XS @ XT @ ccmhm)))))))))).
