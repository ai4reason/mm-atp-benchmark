...
thf(apmtrodpm_thm,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ XT)) => (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm))))))))))))).
