...
thf(aelspani_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwss @ XA2 @ cchil) => ((cwcel @ XB2 @ (ccfv @ XA2 @ ccspn)) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ XA2 @ (ccv @ Xx3)) => (cwcel @ XB2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccsh)))))))).
