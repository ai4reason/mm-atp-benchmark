...
thf(awwlksonvtx_thm,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ XN @ XG @ ccwwlksnon))) => ((cwcel @ XA2 @ XV) & (cwcel @ XC @ XV))))))))))).
