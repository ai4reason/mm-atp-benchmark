...
thf(aordtrest2lem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((Xph => (cwcel @ XR @ cctsr)) => ((Xph => (cwss @ XA2 @ XX)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2))) => (cwss @ (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR))) @ (^ [Xz:$i] : XX)) @ XA2)))) => (Xph => (cwral @ (^ [Xv:$i] : (cwcel @ (ccin @ (ccv @ Xv) @ XA2) @ (ccfv @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccordt))) @ (^ [Xv:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : XX) @ (^ [Xz:$i] : (ccrab @ (^ [Xw:$i] : (~ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR))) @ (^ [Xw:$i] : XX))))))))))))))))).
