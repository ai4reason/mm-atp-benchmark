...
thf(amerco1lem3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph => Xps) => (Xch => $false)) => (Xch => Xph)))))).
thf(amerco1lem4_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph => Xps) => Xch) => (Xps => Xch)))))).
thf(amerco1lem5_thm,axiom,(! [Xph:$o] : (! [Xch:$o] : (! [Xta:$o] : ((((Xph => $false) => Xch) => Xta) => (Xph => Xta)))))).
thf(amerco1lem6_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xph => Xps)) => (Xch => (Xph => Xps))))))).
thf(amerco1lem7_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (((Xps => Xch) => Xps) => Xps)))))).
thf(aretbwax3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (((Xph => Xps) => Xph) => Xph)))).
thf(amerco1lem8_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((Xps => (Xps => Xch)) => (Xps => Xch))))))).
thf(amerco1lem9_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph => (Xph => Xps)) => (Xph => Xps))))).
thf(amerco1lem10_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((((Xph => Xps) => Xch) => (Xta => Xch)) => Xph) => (Xth => Xph)))))))).
thf(amerco1lem11_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xta:$o] : ((Xph => Xps) => (((Xch => (Xph => Xta)) => $false) => Xps))))))).
thf(amerco1lem12_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xta:$o] : ((Xph => Xps) => (((Xch => (Xph => Xta)) => Xph) => Xps))))))).
thf(amerco1lem13_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xta:$o] : ((((Xph => Xps) => (Xch => Xps)) => Xta) => (Xph => Xta))))))).
thf(amerco1lem14_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((((Xph => Xps) => Xps) => Xch) => (Xph => Xch)))))).
thf(amerco1lem15_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => (Xph => (Xch => Xps))))))).
thf(amerco1lem16_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xta:$o] : (((Xph => (Xps => Xch)) => Xta) => ((Xph => Xch) => Xta))))))).
thf(amerco1lem17_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xta:$o] : (((((Xph => Xps) => Xph) => Xch) => Xta) => ((Xph => Xch) => Xta))))))).
thf(amerco1lem18_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xps => Xph) => (Xps => Xch))))))).
thf(aretbwax1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(amerco2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((Xph => Xps) => (($false => Xch) => Xth)) => ((Xth => Xph) => (Xta => (Xet => Xph))))))))))).
thf(amercolem1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph => Xps) => Xch) => (Xps => (Xth => Xch)))))))).
thf(amercolem2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph => Xps) => Xph) => (Xch => (Xth => Xph)))))))).
thf(amercolem3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xps => Xch) => (Xps => (Xph => Xch))))))).
thf(amercolem4_thm,axiom,(! [Xph:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xth => (Xet => Xph)) => (((Xth => Xch) => Xph) => (Xta => (Xet => Xph)))))))))).
thf(amercolem5_thm,axiom,(! [Xph:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (Xth => ((Xth => Xph) => (Xta => (Xch => Xph))))))))).
thf(amercolem6_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => (Xph => Xch))) => (Xps => (Xph => Xch))))))).
thf(amercolem7_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xph => Xch) => (Xth => Xps)) => (Xth => Xps)))))))).
thf(amercolem8_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xps => (Xph => Xch)) => (Xta => (Xth => (Xph => Xch))))))))))).
thf(are1tbw1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(are1tbw2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(are1tbw3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (((Xph => Xps) => Xph) => Xph)))).
thf(are1tbw4_thm,axiom,(! [Xph:$o] : ($false => Xph))).
...
thf(arblem4_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((~ Xph) | Xth) => (((~ Xps) | Xta) => (((~ Xch) | Xet) => ((~ ((Xph | Xps) | Xch)) | ((Xet | Xta) | Xth)))))))))))).
...
thf(are1axmp_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(are2luk1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(are2luk2_thm,axiom,(! [Xph:$o] : (((~ Xph) => Xph) => Xph))).
thf(are2luk3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((~ Xph) => Xps))))).
thf(amptnan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((~ (Xph & Xps)) => (~ Xps)))))).
thf(amptxor_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((~ (Xph <=> Xps)) => (~ Xps)))))).
thf(amtpor_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ Xph) => ((Xph | Xps) => Xps))))).
thf(amtpxor_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ Xph) => ((~ (Xph <=> Xps)) => Xps))))).
thf(astoic1a_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (((Xph & Xps) => Xth) => ((Xph & (~ Xth)) => (~ Xps))))))).
thf(astoic1b_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (((Xph & Xps) => Xth) => ((Xps & (~ Xth)) => (~ Xph))))))).
thf(astoic2a_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xch) => Xth) => ((Xph & Xps) => Xth)))))))).
thf(astoic2b_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xps & Xch) => Xth) => ((Xph & Xps) => Xth)))))))).
thf(astoic3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xch) => (((Xch & Xth) => Xta) => ((Xph & Xps & Xth) => Xta))))))))).
thf(astoic4a_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xch) => (((Xch & Xph & Xth) => Xta) => ((Xph & Xps & Xth) => Xta))))))))).
thf(astoic4b_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xch) => ((((Xch & Xph & Xps) & Xth) => Xta) => ((Xph & Xps & Xth) => Xta))))))))).
