...
thf(alecldbas_thm,conjecture,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccicc)) @ (^ [Xx3:$i] : (ccdif @ ccxr @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((ccfv @ ccle @ ccordt) = (ccfv @ (ccfv @ (ccrn @ (XF @ Xx3)) @ ccfi) @ cctg)))))).
