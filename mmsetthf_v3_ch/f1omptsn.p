...
thf(af1omptsn_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : ((XF @ Xx3 @ Xu) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3))))))) => ((! [Xx3:$i] : (! [Xu:$i] : ((XR @ Xx3 @ Xu) = (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))) => (! [Xx3:$i] : (! [Xu:$i] : (cwf1o @ XA2 @ (XR @ Xx3 @ Xu) @ (XF @ Xx3 @ Xu)))))))))).
