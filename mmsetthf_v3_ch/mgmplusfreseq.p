...
thf(amgmplusfreseq_thm,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((Xc_pd = (ccfv @ XM @ ccplusf)) => (((cwcel @ XM @ ccmgm) & (~ (wnel @ cc0 @ XB2))) => ((ccres @ Xc_pl @ (ccxp @ XB2 @ XB2)) = Xc_pd)))))))))).
