...
thf(asupxrlub_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ cclt) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2))))))).
