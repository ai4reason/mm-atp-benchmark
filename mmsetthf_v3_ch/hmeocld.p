...
thf(ahmeocld_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ (ccfv @ XJ @ cccld)) <=> (cwcel @ (ccima @ XF @ XA2) @ (ccfv @ XK @ cccld))))))))))).
