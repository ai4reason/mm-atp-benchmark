...
thf(aisfil2_thm,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) <=> (((cwss @ XF @ (ccpw @ XX)) & (~ (cwcel @ cc0 @ XF)) & (cwcel @ XX @ XF)) & (cwral @ (^ [Xx3:$i] : ((cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XF)) => (cwcel @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : (ccpw @ XX))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF))))))).
