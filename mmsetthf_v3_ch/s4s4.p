...
thf(as3cl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX)) => (cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccword @ XX)))))))).
...
thf(as8cli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwcel @ (ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) @ (ccword @ ccvv))))))))))).
...
thf(as2dm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccdm @ (ccs2 @ XA2 @ XB2)) = (ccpr @ ccc0 @ cc1))))).
thf(as3fv0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ ccc0 @ (ccs3 @ XA2 @ XB2 @ XC)) = XA2))))))).
thf(as3fv1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((ccfv @ cc1 @ (ccs3 @ XA2 @ XB2 @ XC)) = XB2))))))).
...
thf(as4fv1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((ccfv @ cc1 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XB2)))))))).
thf(as4fv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((ccfv @ cc2 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XC)))))))).
...
thf(as5len_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((ccfv @ (ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) @ cchash) = cc5))))))).
thf(as6len_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ (ccs6 @ XA2 @ XB2 @ XC @ XD @ XE @ XF) @ cchash) = cc6)))))))).
thf(as7len_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccfv @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ cchash) = cc7))))))))).
thf(as8len_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((ccfv @ (ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) @ cchash) = cc8)))))))))).
thf(alsws2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((ccfv @ (ccs2 @ XA2 @ XB2) @ cclsw) = XB2)))))).
thf(alsws3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((ccfv @ (ccs3 @ XA2 @ XB2 @ XC) @ cclsw) = XC))))))).
thf(alsws4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XD @ XV) => ((ccfv @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ cclsw) = XD)))))))).
thf(as2prop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) => ((ccs2 @ XA2 @ XB2) = (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2)))))))).
thf(as2dmALT_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) => ((ccdm @ (ccs2 @ XA2 @ XB2)) = (ccpr @ ccc0 @ cc1))))))).
thf(as3tpop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS) & (cwcel @ XC @ XS)) => ((ccs3 @ XA2 @ XB2 @ XC) = (cctp @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2) @ (ccop @ cc2 @ XC))))))))).
thf(as4prop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((ccs4 @ XA2 @ XB2 @ XC @ XD) = (ccun @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2)) @ (ccpr @ (ccop @ cc2 @ XC) @ (ccop @ cc3 @ XD))))))))))).
thf(as3fn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV)) => (cwfn @ (ccs3 @ XA2 @ XB2 @ XC) @ (cctp @ ccc0 @ cc1 @ cc2)))))))).
thf(afuncnvs1_thm,axiom,(! [XA2:($i > $o)] : (cwfun @ (cccnv @ (ccs1 @ XA2))))).
thf(afuncnvs2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (XA2 != XB2)) => (cwfun @ (cccnv @ (ccs2 @ XA2 @ XB2)))))))).
thf(afuncnvs3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV)) & ((XA2 != XB2) & (XA2 != XC) & (XB2 != XC))) => (cwfun @ (cccnv @ (ccs3 @ XA2 @ XB2 @ XC))))))))).
thf(afuncnvs4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & ((cwcel @ XC @ XV) & (cwcel @ XD @ XV))) & (((XA2 != XB2) & (XA2 != XC) & (XA2 != XD)) & ((XB2 != XC) & (XB2 != XD)) & (XC != XD))) => (cwfun @ (cccnv @ (ccs4 @ XA2 @ XB2 @ XC @ XD)))))))))).
thf(as2f1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS) & (XA2 != XB2)) => ((XE = (ccs2 @ XA2 @ XB2)) => (cwf1o @ (ccpr @ ccc0 @ cc1) @ (ccpr @ XA2 @ XB2) @ XE)))))))).
thf(af1oun2prg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) & ((cwcel @ XC @ XX) & (cwcel @ XD @ XY))) => ((((XA2 != XB2) & (XA2 != XC) & (XA2 != XD)) & ((XB2 != XC) & (XB2 != XD) & (XC != XD))) => (cwf1o @ (ccun @ (ccpr @ ccc0 @ cc1) @ (ccpr @ cc2 @ cc3)) @ (ccun @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ (ccun @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2)) @ (ccpr @ (ccop @ cc2 @ XC) @ (ccop @ cc3 @ XD))))))))))))))).
thf(as4f1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((((XA2 != XB2) & (XA2 != XC) & (XA2 != XD)) & ((XB2 != XC) & (XB2 != XD) & (XC != XD))) => ((XE = (ccs4 @ XA2 @ XB2 @ XC @ XD)) => (cwf1o @ (ccdm @ XE) @ (ccun @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ XE))))))))))).
thf(as4dom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((XE = (ccs4 @ XA2 @ XB2 @ XC @ XD)) => ((ccdm @ XE) = (ccun @ (ccpr @ ccc0 @ cc1) @ (ccpr @ cc2 @ cc3)))))))))))).
thf(as2co_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwf @ XX @ XY @ XF)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => (Xph => ((cccom @ XF @ (ccs2 @ XA2 @ XB2)) = (ccs2 @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)))))))))))))).
thf(as3co_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwf @ XX @ XY @ XF)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XX)) => (Xph => ((cccom @ XF @ (ccs3 @ XA2 @ XB2 @ XC)) = (ccs3 @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ (ccfv @ XC @ XF)))))))))))))))).
thf(as0s1_thm,axiom,(! [XA2:($i > $o)] : ((ccs1 @ XA2) = (cco @ cc0 @ (ccs1 @ XA2) @ ccconcat)))).
thf(as1s2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccs3 @ XA2 @ XB2 @ XC) = (cco @ (ccs1 @ XA2) @ (ccs2 @ XB2 @ XC) @ ccconcat)))))).
thf(as1s3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((ccs4 @ XA2 @ XB2 @ XC @ XD) = (cco @ (ccs1 @ XA2) @ (ccs3 @ XB2 @ XC @ XD) @ ccconcat))))))).
thf(as1s4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) = (cco @ (ccs1 @ XA2) @ (ccs4 @ XB2 @ XC @ XD @ XE) @ ccconcat)))))))).
thf(as1s5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((ccs6 @ XA2 @ XB2 @ XC @ XD @ XE @ XF) = (cco @ (ccs1 @ XA2) @ (ccs5 @ XB2 @ XC @ XD @ XE @ XF) @ ccconcat))))))))).
thf(as1s6_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) = (cco @ (ccs1 @ XA2) @ (ccs6 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
thf(as1s7_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) = (cco @ (ccs1 @ XA2) @ (ccs7 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) @ ccconcat))))))))))).
thf(as2s2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((ccs4 @ XA2 @ XB2 @ XC @ XD) = (cco @ (ccs2 @ XA2 @ XB2) @ (ccs2 @ XC @ XD) @ ccconcat))))))).
thf(as4s2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((ccs6 @ XA2 @ XB2 @ XC @ XD @ XE @ XF) = (cco @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs2 @ XE @ XF) @ ccconcat))))))))).
thf(as4s3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) = (cco @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs3 @ XE @ XF @ XG) @ ccconcat)))))))))).
thf(as4s4_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) = (cco @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs4 @ XE @ XF @ XG @ XH) @ ccconcat))))))))))).
