...
thf(acats1co_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XT = (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((Xph => (cwcel @ XS @ (ccword @ XA2))) => ((Xph => (cwcel @ XX @ XA2)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => ((cccom @ XF @ XS) = XU)) => ((XV = (cco @ XU @ (ccs1 @ (ccfv @ XX @ XF)) @ ccconcat)) => (Xph => ((cccom @ XF @ XT) = XV)))))))))))))))))).
