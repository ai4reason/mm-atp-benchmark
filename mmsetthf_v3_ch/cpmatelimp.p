...
thf(acpmatelimp_thm,conjecture,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XS @ Xi @ Xj @ Xk) = (cco @ XN @ XR @ cccpmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XP @ Xi @ Xj @ Xk) = (ccfv @ XR @ ccpl1))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XC @ Xi @ Xj @ Xk) = (cco @ XN @ (XP @ Xi @ Xj @ Xk) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xi @ Xj @ Xk) = (ccfv @ (XC @ Xi @ Xj @ Xk) @ ccbs))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => ((cwcel @ XM @ (XS @ Xi @ Xj @ Xk)) => ((cwcel @ XM @ (XB2 @ Xi @ Xj @ Xk)) & (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)) = (ccfv @ XR @ cc0g))) @ (^ [Xk:$i] : ccn))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))))))))))))))))))).
