...
thf(aevl1gsumadd_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((XQ = (ccfv @ XR @ cce1)) => ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XW @ Xx3) = (ccfv @ XR @ ccpl1))) => ((! [Xx3:$i] : ((XP @ Xx3) = (cco @ XR @ XK @ ccpws))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XW @ Xx3) @ ccbs))) => ((Xph => (cwcel @ XR @ cccrg)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XN)) => (cwcel @ (XY @ Xx3) @ XB2))) => ((Xph => (cwss @ XN @ ccn0)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ (XW @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (XY @ Xx3))) @ (Xc_0 @ Xx3) @ ccfsupp))) => (! [Xx3:$i] : (Xph => ((ccfv @ (cco @ (XW @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (XY @ Xx3))) @ ccgsu) @ XQ) = (cco @ (XP @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (ccfv @ (XY @ Xx3) @ XQ))) @ ccgsu))))))))))))))))))))))))).
