...
thf(aexpcand_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwbr @ cc1 @ XA2 @ cclt)) => ((Xph => ((cco @ XA2 @ XM @ ccexp) = (cco @ XA2 @ XN @ ccexp))) => (Xph => (XM = XN)))))))))))).
