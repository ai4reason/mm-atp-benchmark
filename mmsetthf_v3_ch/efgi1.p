...
thf(aefgi1_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((Xc_sm = (ccfv @ XI @ ccefg)) => (((cwcel @ XA2 @ XW) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XA2 @ cchash) @ ccfz)) & (cwcel @ XJ @ XI)) => (cwbr @ XA2 @ (cco @ XA2 @ (ccotp @ XN @ XN @ (ccs2 @ (ccop @ XJ @ cc1o) @ (ccop @ XJ @ cc0))) @ ccsplice) @ Xc_sm))))))))))).
