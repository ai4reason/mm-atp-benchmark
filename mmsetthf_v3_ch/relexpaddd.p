...
thf(arelexpaddd_thm,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => ((cccom @ (cco @ XR @ XN @ ccrelexp) @ (cco @ XR @ XM @ ccrelexp)) = (cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp))))))))))).
