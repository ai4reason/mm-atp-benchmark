...
thf(a_1stcclb_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cc1stc) & (cwcel @ XA2 @ XX)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & (cwral @ (^ [Xy1:$i] : ((cwcel @ XA2 @ (ccv @ Xy1)) => (cwrex @ (^ [Xz:$i] : ((cwcel @ XA2 @ (ccv @ Xz)) & (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : XJ)))) @ (^ [Xx3:$i] : (ccpw @ XJ))))))))).
