...
thf(atxflf_thm,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (Xph => (cwcel @ (XJ @ Xn) @ (ccfv @ XX @ cctopon)))) => ((! [Xn:$i] : (Xph => (cwcel @ (XK @ Xn) @ (ccfv @ XY @ cctopon)))) => ((! [Xn:$i] : (Xph => (cwcel @ (XL @ Xn) @ (ccfv @ XZ @ ccfil)))) => ((Xph => (cwf @ XZ @ XX @ XF)) => ((Xph => (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG)))))) => (! [Xn:$i] : (Xph => ((cwcel @ (ccop @ (XR @ Xn) @ (XS @ Xn)) @ (ccfv @ (XH @ Xn) @ (cco @ (cco @ (XJ @ Xn) @ (XK @ Xn) @ cctx) @ (XL @ Xn) @ ccflf))) <=> ((cwcel @ (XR @ Xn) @ (ccfv @ XF @ (cco @ (XJ @ Xn) @ (XL @ Xn) @ ccflf))) & (cwcel @ (XS @ Xn) @ (ccfv @ XG @ (cco @ (XK @ Xn) @ (XL @ Xn) @ ccflf)))))))))))))))))))))))))).
