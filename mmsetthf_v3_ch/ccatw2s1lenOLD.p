...
thf(accatw2s1lenOLD_thm,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV)) => ((ccfv @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat) @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccaddc)))))))).
