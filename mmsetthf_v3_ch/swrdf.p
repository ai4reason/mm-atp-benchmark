...
thf(aswrdf_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (cwf @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo) @ XV @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr)))))))).
