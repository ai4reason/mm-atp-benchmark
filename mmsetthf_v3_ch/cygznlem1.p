...
thf(acygznlem1_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xn:$i] : ((XN @ Xn) = (ccif @ (cwcel @ XB2 @ ccfn) @ (ccfv @ XB2 @ cchash) @ ccc0))) => ((! [Xn:$i] : (XY = (ccfv @ (XN @ Xn) @ cczn))) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XL = (ccfv @ XY @ cczrh)) => ((! [Xx3:$i] : (! [Xn:$i] : ((XE @ Xx3 @ Xn) = (ccrab @ (^ [Xx3:$i] : ((ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_x)))) = XB2)) @ (^ [Xx3:$i] : XB2))))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwcel @ XG @ cccyg)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwcel @ XX @ (XE @ Xx3 @ Xn))))) => (! [Xx3:$i] : (! [Xn:$i] : (((Xph @ Xx3 @ Xn) & ((cwcel @ (XK @ Xx3 @ Xn) @ ccz) & (cwcel @ (XM @ Xx3 @ Xn) @ ccz))) => (((ccfv @ (XK @ Xx3 @ Xn) @ XL) = (ccfv @ (XM @ Xx3 @ Xn) @ XL)) <=> ((cco @ (XK @ Xx3 @ Xn) @ XX @ Xc_x) = (cco @ (XM @ Xx3 @ Xn) @ XX @ Xc_x)))))))))))))))))))))))))).
