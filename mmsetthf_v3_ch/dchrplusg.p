...
thf(adchrplusg_thm,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => (Xc_x = (ccres @ (ccof @ ccmul) @ (ccxp @ XD @ XD)))))))))))))))).
