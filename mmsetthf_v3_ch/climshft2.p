...
thf(aclimshft2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XK @ ccz)) => ((! [Xk:$i] : (Xph => (cwcel @ XF @ (XW @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XX @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (cco @ (ccv @ Xk) @ XK @ ccaddc) @ XG) = (ccfv @ (ccv @ Xk) @ XF)))) => (Xph => ((cwbr @ XF @ XA2 @ ccli) <=> (cwbr @ XG @ XA2 @ ccli))))))))))))))))))).
