...
thf(aanim12d1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => Xch)) => ((Xth => Xta) => (Xph => ((Xps & Xth) => (Xch & Xta))))))))))).
...
thf(apm2_3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph | (Xps | Xch)) => (Xph | (Xch | Xps))))))).
thf(apm2_41_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xps | (Xph | Xps)) => (Xph | Xps))))).
thf(apm2_42_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (((~ Xph) | (Xph => Xps)) => (Xph => Xps))))).
thf(apm2_4_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph | (Xph | Xps)) => (Xph | Xps))))).
thf(apm2_65da_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => (((Xph & Xps) => (~ Xch)) => (Xph => (~ Xps)))))))).
thf(apm4_44_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph <=> (Xph | (Xph & Xps)))))).
thf(apm4_14_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) <=> ((Xph & (~ Xch)) => (~ Xps))))))).
thf(apm3_37_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => ((Xph & (~ Xch)) => (~ Xps))))))).
thf(anan_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (~ (Xps & Xch))) <=> ((Xph & Xps) => (~ Xch))))))).
