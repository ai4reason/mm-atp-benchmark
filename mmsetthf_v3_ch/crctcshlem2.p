...
thf(acrctcshlem2_thm,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((Xph => (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts))) => ((XN = (ccfv @ XF @ cchash)) => ((Xph => (cwcel @ XS @ (cco @ ccc0 @ XN @ ccfzo))) => ((XH = (cco @ XF @ XS @ cccsh)) => (Xph => ((ccfv @ XH @ cchash) = XN)))))))))))))))))).
