...
thf(asymg1bas_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XA2 = (ccsn @ XI)) => ((cwcel @ XI @ XV) => (XB2 = (ccsn @ (ccsn @ (ccop @ XI @ XI)))))))))))))).
