...
thf(acshweqdifid_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz) & (cwcel @ XM @ ccz)) => (((cco @ XW @ XN @ cccsh) = (cco @ XW @ XM @ cccsh)) => ((cco @ XW @ (cco @ XM @ XN @ ccmin) @ cccsh) = XW)))))))).
