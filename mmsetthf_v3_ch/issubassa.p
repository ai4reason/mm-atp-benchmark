...
thf(aissubassa_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XW @ XA2 @ ccress)) => ((XL = (ccfv @ XW @ cclss)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_1 = (ccfv @ XW @ ccur)) => (((cwcel @ XW @ ccasa) & (cwcel @ Xc_1 @ XA2) & (cwss @ XA2 @ XV)) => ((cwcel @ XS @ ccasa) <=> ((cwcel @ XA2 @ (ccfv @ XW @ ccsubrg)) & (cwcel @ XA2 @ XL))))))))))))))).
