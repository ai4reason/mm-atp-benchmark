...
thf(arecrecnq_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => ((ccfv @ (ccfv @ XA2 @ ccrq) @ ccrq) = XA2)))).
thf(admrecnq_thm,axiom,((ccdm @ ccrq) = ccnq)).
...
thf(altanq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnq) => ((cwbr @ XA2 @ XB2 @ ccltq) <=> (cwbr @ (cco @ XC @ XA2 @ ccplq) @ (cco @ XC @ XB2 @ ccplq) @ ccltq))))))).
thf(altmnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnq) => ((cwbr @ XA2 @ XB2 @ ccltq) <=> (cwbr @ (cco @ XC @ XA2 @ ccmq) @ (cco @ XC @ XB2 @ ccmq) @ ccltq))))))).
thf(a_1lt2nq_thm,axiom,(cwbr @ cc1q @ (cco @ cc1q @ cc1q @ ccplq) @ ccltq)).
thf(altaddnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnq) & (cwcel @ XB2 @ ccnq)) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccplq) @ ccltq))))).
thf(altexnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccnq) => ((cwbr @ XA2 @ XB2 @ ccltq) <=> (? [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccplq) = XB2))))))).
thf(ahalfnq_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => (? [Xx3:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ ccplq) = XA2))))).
thf(ansmallnq_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => (? [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccltq))))).
thf(altbtwnnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccltq) <=> (? [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccltq) & (cwbr @ (ccv @ Xx3) @ XB2 @ ccltq))))))).
thf(altrnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccltq) <=> (cwbr @ (ccfv @ XB2 @ ccrq) @ (ccfv @ XA2 @ ccrq) @ ccltq))))).
thf(aarchnq_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccop @ (ccv @ Xx3) @ cc1o) @ ccltq)) @ (^ [Xx3:$i] : ccnpi))))).
thf(adf_np_ax,axiom,(ccnp = (^ [Xx3:$i] : (((cwpss @ cc0 @ (ccv @ Xx3)) & (cwpss @ (ccv @ Xx3) @ ccnq)) & (cwral @ (^ [Xy1:$i] : ((! [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccltq) => (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))) & (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltq)) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))).
...
thf(adf_ltp_ax,axiom,(ccltp = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccnp) & (cwcel @ (ccv @ Xy1) @ ccnp)) & (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)))))))).
thf(anpex_thm,axiom,(cwcel @ ccnp @ ccvv)).
thf(aelnp_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnp) <=> (((cwpss @ cc0 @ XA2) & (cwpss @ XA2 @ ccnq)) & (cwral @ (^ [Xx3:$i] : ((! [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltq) => (cwcel @ (ccv @ Xy1) @ XA2))) & (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(aprub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ XA2)) & (cwcel @ XC @ ccnq)) => ((~ (cwcel @ XC @ XA2)) => (cwbr @ XB2 @ XC @ ccltq))))))).
thf(aprnmax_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccltq)) @ (^ [Xx3:$i] : XA2)))))).
thf(anpomex_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnp) => (cwcel @ ccom @ ccvv)))).
...
thf(agenpv_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xh:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xh) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw)))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xh:$i] : (((cwcel @ (XA2 @ Xw @ Xv) @ ccnp) & (cwcel @ (XB2 @ Xw @ Xv) @ ccnp)) => ((cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xh)) = (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwrex @ (^ [Xh:$i] : ((ccv @ Xf1) = (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ XG))) @ (^ [Xh:$i] : (XB2 @ Xw @ Xv)))) @ (^ [Xg1:$i] : (XA2 @ Xw @ Xv))))))))))))))))))).
...
thf(agenpprecl_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (((cwcel @ (XA2 @ Xw @ Xv) @ ccnp) & (cwcel @ (XB2 @ Xw @ Xv) @ ccnp)) => (((cwcel @ (XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ (XA2 @ Xw @ Xv)) & (cwcel @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ (XB2 @ Xw @ Xv))) => (cwcel @ (cco @ (XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ XG) @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv))))))))))))))))))).
thf(agenpdm_thm,axiom,(! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((ccdm @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv)) = (ccxp @ ccnp @ ccnp)))))))))))).
thf(agenpn0_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (((cwcel @ (XA2 @ Xw @ Xv) @ ccnp) & (cwcel @ (XB2 @ Xw @ Xv) @ ccnp)) => (cwpss @ cc0 @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv)))))))))))))))).
thf(agenpss_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (((cwcel @ (XA2 @ Xw @ Xv) @ ccnp) & (cwcel @ (XB2 @ Xw @ Xv) @ ccnp)) => (cwss @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv)) @ ccnq)))))))))))))).
thf(agenpnnp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ ccnq) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq) <=> (cwbr @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XG) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XG) @ ccltq)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => (~ ((cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) = ccnq))))))))))))))).
thf(agenpcd_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xf1:$i] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((((cwcel @ (XA2 @ Xw @ Xv) @ ccnp) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xw @ Xv))) & ((cwcel @ (XB2 @ Xw @ Xv) @ ccnp) & (cwcel @ (ccv @ Xh) @ (XB2 @ Xw @ Xv)))) & (cwcel @ (ccv @ Xx3) @ ccnq)) => ((cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ XG) @ ccltq) => (cwcel @ (ccv @ Xx3) @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (((cwcel @ (XA2 @ Xw @ Xv) @ ccnp) & (cwcel @ (XB2 @ Xw @ Xv) @ ccnp)) => ((cwcel @ (ccv @ Xf1) @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv))) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xf1) @ ccltq) => (cwcel @ (ccv @ Xx3) @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv)))))))))))))))))))).
thf(agenpnmax_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xf1:$i] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : ((! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((XF @ Xz @ Xw @ Xv) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((cwcel @ (ccv @ Xv) @ ccnq) => ((cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ ccltq) <=> (cwbr @ (cco @ (ccv @ Xv) @ (ccv @ Xz) @ XG) @ (cco @ (ccv @ Xv) @ (ccv @ Xw) @ XG) @ ccltq)))))) => ((! [Xz:$i] : (! [Xw:$i] : ((cco @ (ccv @ Xz) @ (ccv @ Xw) @ XG) = (cco @ (ccv @ Xw) @ (ccv @ Xz) @ XG)))) => (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (((cwcel @ (XA2 @ Xw @ Xv) @ ccnp) & (cwcel @ (XB2 @ Xw @ Xv) @ ccnp)) => ((cwcel @ (ccv @ Xf1) @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xz @ Xw @ Xv))) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ ccltq)) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xz @ Xw @ Xv))))))))))))))))))).
thf(agenpcl_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xz:$i] : ((XF @ Xz) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccnq) & (cwcel @ (ccv @ Xz) @ ccnq)) => (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((cwcel @ (ccv @ Xh) @ ccnq) => ((cwbr @ (ccv @ Xf1) @ (ccv @ Xg1) @ ccltq) <=> (cwbr @ (cco @ (ccv @ Xh) @ (ccv @ Xf1) @ XG) @ (cco @ (ccv @ Xh) @ (ccv @ Xg1) @ XG) @ ccltq)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((((cwcel @ XA2 @ ccnp) & (cwcel @ (ccv @ Xg1) @ XA2)) & ((cwcel @ XB2 @ ccnp) & (cwcel @ (ccv @ Xh) @ XB2))) & (cwcel @ (ccv @ Xx3) @ ccnq)) => ((cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ XG) @ ccltq) => (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ (XF @ Xz))))))))) => (! [Xz:$i] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => (cwcel @ (cco @ XA2 @ XB2 @ (XF @ Xz)) @ ccnp))))))))))))).
