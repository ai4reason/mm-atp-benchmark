...
thf(ahashreshashfun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwfun @ XA2) & (cwcel @ XA2 @ ccfn) & (cwss @ XB2 @ (ccdm @ XA2))) => ((ccfv @ XA2 @ cchash) = (cco @ (ccfv @ (ccres @ XA2 @ XB2) @ cchash) @ (ccfv @ (ccdif @ (ccdm @ XA2) @ XB2) @ cchash) @ ccaddc)))))).
