...
thf(aishtpy_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xs1:$i] : (Xph => (cwcel @ XF @ (cco @ XJ @ (XK @ Xs1) @ cccn)))) => ((! [Xs1:$i] : (Xph => (cwcel @ XG @ (cco @ XJ @ (XK @ Xs1) @ cccn)))) => (! [Xs1:$i] : (Xph => ((cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ (XK @ Xs1) @ cchtpy))) <=> ((cwcel @ XH @ (cco @ (cco @ XJ @ ccii @ cctx) @ (XK @ Xs1) @ cccn)) & (cwral @ (^ [Xs1:$i] : (((cco @ (ccv @ Xs1) @ ccc0 @ XH) = (ccfv @ (ccv @ Xs1) @ XF)) & ((cco @ (ccv @ Xs1) @ cc1 @ XH) = (ccfv @ (ccv @ Xs1) @ XG)))) @ (^ [Xs1:$i] : XX))))))))))))))))).
