...
thf(advnfre_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr) & (cwcel @ XN @ ccn0)) => (cwf @ (ccdm @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdvn))) @ ccr @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdvn)))))))).
