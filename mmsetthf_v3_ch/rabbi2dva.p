...
thf(arabbi2dva_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => ((cwcel @ (ccv @ Xx3) @ XB2) <=> (Xps @ Xx3)))) => (Xph => ((ccin @ XA2 @ XB2) = (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))))).
