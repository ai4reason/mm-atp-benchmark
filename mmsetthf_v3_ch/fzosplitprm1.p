...
thf(afzosplitprm1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwbr @ XA2 @ XB2 @ cclt)) => ((cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccfzo) = (ccun @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ ccfzo) @ (ccpr @ (cco @ XB2 @ cc1 @ ccmin) @ XB2))))))).
