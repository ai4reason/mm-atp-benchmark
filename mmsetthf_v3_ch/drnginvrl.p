...
thf(adrnginvrl_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XX @ XB2) & (XX != Xc_0)) => ((cco @ (ccfv @ XX @ XI) @ XX @ Xc_x) = Xc_1))))))))))))))).
