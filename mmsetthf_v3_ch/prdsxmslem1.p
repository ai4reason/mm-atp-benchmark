...
thf(aprdsxmslem1_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XS @ XW)) => ((Xph => (cwcel @ XI @ ccfn)) => ((XD = (ccfv @ XY @ ccds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xph => (cwf @ XI @ ccxme @ XR)) => (Xph => (cwcel @ XD @ (ccfv @ XB2 @ ccxmt)))))))))))))))))).
