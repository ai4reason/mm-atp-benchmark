...
thf(adp2ltsuc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => ((cwbr @ XB2 @ (ccdc @ cc1 @ ccc0) @ cclt) => (((cco @ XA2 @ cc1 @ ccaddc) = XC) => (cwbr @ (ccdp2 @ XA2 @ XB2) @ XC @ cclt))))))))).
