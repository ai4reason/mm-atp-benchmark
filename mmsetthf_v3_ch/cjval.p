...
thf(acjval_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cccj) = (ccrio @ (^ [Xx3:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccaddc) @ ccr) & (cwcel @ (cco @ cci @ (cco @ XA2 @ (ccv @ Xx3) @ ccmin) @ ccmul) @ ccr))) @ (^ [Xx3:$i] : ccc)))))).
