...
thf(astructvtxvallem_thm,conjecture,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XS @ ccn) => ((cwbr @ (ccfv @ ccnx @ ccbs) @ XS @ cclt) => ((XG = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ XS @ XE))) => (((cwcel @ XV @ XX) & (cwcel @ XE @ XY)) => (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)))))))))))).
