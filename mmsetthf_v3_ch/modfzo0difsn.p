...
thf(amodfzo0difsn_thm,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XK @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ)))) => (cwrex @ (^ [Xi:$i] : (XK = (cco @ (cco @ (ccv @ Xi) @ XJ @ ccaddc) @ XN @ ccmo))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfzo)))))))).
