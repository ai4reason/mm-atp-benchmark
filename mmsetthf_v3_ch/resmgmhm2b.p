...
thf(aresmgmhm2b_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XX @ (ccfv @ XT @ ccsubmgm)) & (cwss @ (ccrn @ XF) @ XX)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccmgmhm)) <=> (cwcel @ XF @ (cco @ XS @ XU @ ccmgmhm))))))))))).
