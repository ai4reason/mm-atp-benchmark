...
thf(asymgmov1_thm,conjecture,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => (! [Xk:$i] : ((cwcel @ XQ @ (XP @ Xk)) => (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xn) @ XQ) = (ccv @ Xk))) @ (^ [Xk:$i] : XN))) @ (^ [Xn:$i] : XN))))))))).
