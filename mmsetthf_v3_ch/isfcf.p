...
thf(aisfcf_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwf @ XY @ XX @ XF)) => ((cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf))) <=> ((cwcel @ (XA2 @ Xs1) @ XX) & (cwral @ (^ [Xo:$i] : ((cwcel @ (XA2 @ Xs1) @ (ccv @ Xo)) => (cwral @ (^ [Xs1:$i] : ((ccin @ (ccv @ Xo) @ (ccima @ XF @ (ccv @ Xs1))) != cc0)) @ (^ [Xs1:$i] : XL)))) @ (^ [Xo:$i] : XJ))))))))))))).
