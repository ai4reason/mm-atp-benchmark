...
thf(a_3decltc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwcel @ XE @ ccn0) => ((cwcel @ XF @ ccn0) => ((cwbr @ XA2 @ XB2 @ cclt) => ((cwbr @ XC @ (ccdc @ cc1 @ ccc0) @ cclt) => ((cwbr @ XE @ (ccdc @ cc1 @ ccc0) @ cclt) => (cwbr @ (ccdc @ (ccdc @ XA2 @ XC) @ XE) @ (ccdc @ (ccdc @ XB2 @ XD) @ XF) @ cclt))))))))))))))))).
