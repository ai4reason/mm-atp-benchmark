...
thf(aoffval3_thm,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XG @ XW)) => ((cco @ XF @ XG @ (ccof @ XR)) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccdm @ XF) @ (ccdm @ XG))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ XR))))))))))).
