...
thf(alogbfval_thm,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XB2 @ ccc) & (XB2 != ccc0) & (XB2 != cc1)) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((ccfv @ XX @ (ccfv @ XB2 @ (cccur @ cclogb))) = (cco @ XB2 @ XX @ cclogb)))))).
