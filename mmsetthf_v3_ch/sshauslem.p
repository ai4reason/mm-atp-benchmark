...
thf(asshauslem_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ XA2) => (cwcel @ XJ @ cctop)) => ((((cwcel @ XJ @ XA2) & (cwf1 @ XX @ XX @ (ccres @ ccid @ XX)) & (cwcel @ (ccres @ ccid @ XX) @ (cco @ XK @ XJ @ cccn))) => (cwcel @ XK @ XA2)) => (((cwcel @ XJ @ XA2) & (cwcel @ XK @ (ccfv @ XX @ cctopon)) & (cwss @ XJ @ XK)) => (cwcel @ XK @ XA2)))))))))).
