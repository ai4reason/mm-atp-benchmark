...
thf(afuncnvuni_thm,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xf1:$i] : ((cwfun @ (cccnv @ (ccv @ Xf1))) & (cwral @ (^ [Xg1:$i] : ((cwss @ (ccv @ Xf1) @ (ccv @ Xg1)) | (cwss @ (ccv @ Xg1) @ (ccv @ Xf1)))) @ (^ [Xg1:$i] : XA2)))) @ (^ [Xf1:$i] : XA2)) => (cwfun @ (cccnv @ (ccuni @ XA2)))))).
thf(afun11uni_thm,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xf1:$i] : (((cwfun @ (ccv @ Xf1)) & (cwfun @ (cccnv @ (ccv @ Xf1)))) & (cwral @ (^ [Xg1:$i] : ((cwss @ (ccv @ Xf1) @ (ccv @ Xg1)) | (cwss @ (ccv @ Xg1) @ (ccv @ Xf1)))) @ (^ [Xg1:$i] : XA2)))) @ (^ [Xf1:$i] : XA2)) => ((cwfun @ (ccuni @ XA2)) & (cwfun @ (cccnv @ (ccuni @ XA2))))))).
thf(afex2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwf @ XA2 @ XB2 @ XF) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwcel @ XF @ ccvv)))))))).
thf(afabexg_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (^ [Xx3:$i] : ((cwf @ XA2 @ XB2 @ (ccv @ Xx3)) & (Xph @ Xx3))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XC @ Xx3)) & (cwcel @ XB2 @ (XD @ Xx3))) => (cwcel @ (XF @ Xx3) @ ccvv))))))))))).
thf(afabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : ((XF @ Xx3) = (^ [Xx3:$i] : ((cwf @ XA2 @ XB2 @ (ccv @ Xx3)) & (Xph @ Xx3))))) => (! [Xx3:$i] : (cwcel @ (XF @ Xx3) @ ccvv)))))))))).
thf(admfex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ XC) & (cwf @ XA2 @ XB2 @ XF)) => (cwcel @ XA2 @ ccvv))))))).
thf(af1oabexg_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xf1:$i] : ((XF @ Xf1) = (^ [Xf1:$i] : ((cwf1o @ XA2 @ XB2 @ (ccv @ Xf1)) & (Xph @ Xf1))))) => (! [Xf1:$i] : (((cwcel @ XA2 @ (XC @ Xf1)) & (cwcel @ XB2 @ (XD @ Xf1))) => (cwcel @ (XF @ Xf1) @ ccvv))))))))))).
thf(afun11iun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XB2 @ Xx3) = (XC @ Xy1))))) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : ((cwf1 @ (XD @ Xx3 @ Xy1) @ (XS @ Xy1) @ (XB2 @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((cwss @ (XB2 @ Xx3) @ (XC @ Xy1)) | (cwss @ (XC @ Xy1) @ (XB2 @ Xx3)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)) => (cwf1 @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1))) @ (XS @ Xy1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
thf(affoss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwf @ XA2 @ XB2 @ XF) <=> (? [Xx3:$i] : ((cwfo @ XA2 @ (ccv @ Xx3) @ XF) & (cwss @ (ccv @ Xx3) @ XB2))))))))).
thf(af11o_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwf1 @ XA2 @ XB2 @ XF) <=> (? [Xx3:$i] : ((cwf1o @ XA2 @ (ccv @ Xx3) @ XF) & (cwss @ (ccv @ Xx3) @ XB2))))))))).
