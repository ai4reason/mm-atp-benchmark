...
thf(atrkgbas_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XU) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ (ccop @ (ccfv @ ccnx @ ccitv) @ XI))) => ((cwcel @ XU @ XV) => (XU = (ccfv @ XW @ ccbs)))))))))).
thf(atrkgdist_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XU) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ (ccop @ (ccfv @ ccnx @ ccitv) @ XI))) => ((cwcel @ XD @ XV) => (XD = (ccfv @ XW @ ccds)))))))))).
thf(atrkgitv_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XU) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ (ccop @ (ccfv @ ccnx @ ccitv) @ XI))) => ((cwcel @ XI @ XV) => (XI = (ccfv @ XW @ ccitv)))))))))).
thf(adf_trkgc_ax,axiom,(ccstrkgc = (^ [Xf1:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xd:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xd)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)) = (cco @ (ccv @ Xz) @ (ccv @ Xz) @ (ccv @ Xd))) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xp)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))))) @ (ccfv @ (ccv @ Xf1) @ ccds))) @ (ccfv @ (ccv @ Xf1) @ ccbs))))).
thf(adf_trkgb_ax,axiom,(ccstrkgb = (^ [Xf1:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xi:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xi))) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (((cwcel @ (ccv @ Xu) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xi))) & (cwcel @ (ccv @ Xv) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xi)))) => (cwrex @ (^ [Xa:$i] : ((cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xu) @ (ccv @ Xy1) @ (ccv @ Xi))) & (cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xv) @ (ccv @ Xx3) @ (ccv @ Xi))))) @ (^ [Xa:$i] : (ccv @ Xp))))) @ (^ [Xv:$i] : (ccv @ Xp)))) @ (^ [Xu:$i] : (ccv @ Xp)))) @ (^ [Xz:$i] : (ccv @ Xp)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))) & (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : ((cwrex @ (^ [Xa:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xa) @ (ccv @ Xy1) @ (ccv @ Xi)))) @ (^ [Xy1:$i] : (ccv @ Xt)))) @ (^ [Xx3:$i] : (ccv @ Xs1)))) @ (^ [Xa:$i] : (ccv @ Xp))) => (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xb) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xi)))) @ (^ [Xy1:$i] : (ccv @ Xt)))) @ (^ [Xx3:$i] : (ccv @ Xs1)))) @ (^ [Xb:$i] : (ccv @ Xp))))) @ (^ [Xt:$i] : (ccpw @ (ccv @ Xp))))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xp)))))) @ (ccfv @ (ccv @ Xf1) @ ccitv))) @ (ccfv @ (ccv @ Xf1) @ ccbs))))).
thf(adf_trkgcb_ax,axiom,(ccstrkgcb = (^ [Xf1:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xd:$i] : (cwsbc @ (^ [Xi:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xv:$i] : (((((ccv @ Xx3) != (ccv @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xi))) & (cwcel @ (ccv @ Xb) @ (cco @ (ccv @ Xa) @ (ccv @ Xc) @ (ccv @ Xi)))) & ((((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)) = (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xd))) & ((cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xd)) = (cco @ (ccv @ Xb) @ (ccv @ Xc) @ (ccv @ Xd)))) & (((cco @ (ccv @ Xx3) @ (ccv @ Xu) @ (ccv @ Xd)) = (cco @ (ccv @ Xa) @ (ccv @ Xv) @ (ccv @ Xd))) & ((cco @ (ccv @ Xy1) @ (ccv @ Xu) @ (ccv @ Xd)) = (cco @ (ccv @ Xb) @ (ccv @ Xv) @ (ccv @ Xd)))))) => ((cco @ (ccv @ Xz) @ (ccv @ Xu) @ (ccv @ Xd)) = (cco @ (ccv @ Xc) @ (ccv @ Xv) @ (ccv @ Xd))))) @ (^ [Xv:$i] : (ccv @ Xp)))) @ (^ [Xc:$i] : (ccv @ Xp)))) @ (^ [Xb:$i] : (ccv @ Xp)))) @ (^ [Xa:$i] : (ccv @ Xp)))) @ (^ [Xu:$i] : (ccv @ Xp)))) @ (^ [Xz:$i] : (ccv @ Xp)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xi))) & ((cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xd)) = (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xd))))) @ (^ [Xz:$i] : (ccv @ Xp)))) @ (^ [Xb:$i] : (ccv @ Xp)))) @ (^ [Xa:$i] : (ccv @ Xp)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))))) @ (ccfv @ (ccv @ Xf1) @ ccitv))) @ (ccfv @ (ccv @ Xf1) @ ccds))) @ (ccfv @ (ccv @ Xf1) @ ccbs))))).
thf(adf_trkge_ax,axiom,(ccstrkge = (^ [Xf1:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xi:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (((cwcel @ (ccv @ Xu) @ (cco @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccv @ Xi))) & (cwcel @ (ccv @ Xu) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xi))) & ((ccv @ Xx3) != (ccv @ Xu))) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xa) @ (ccv @ Xi))) & (cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xb) @ (ccv @ Xi))) & (cwcel @ (ccv @ Xv) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xi))))) @ (^ [Xb:$i] : (ccv @ Xp)))) @ (^ [Xa:$i] : (ccv @ Xp))))) @ (^ [Xv:$i] : (ccv @ Xp)))) @ (^ [Xu:$i] : (ccv @ Xp)))) @ (^ [Xz:$i] : (ccv @ Xp)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp)))) @ (ccfv @ (ccv @ Xf1) @ ccitv))) @ (ccfv @ (ccv @ Xf1) @ ccbs))))).
...
thf(aistrkgcb_thm,conjecture,(! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (XP = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb @ Xc) @ ccbs)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (Xc_mi = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb @ Xc) @ ccds)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (XI = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb @ Xc) @ ccitv)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((cwcel @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb @ Xc) @ ccstrkgcb) <=> ((cwcel @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb @ Xc) @ ccvv) & ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xv:$i] : (((((ccv @ Xx3) != (ccv @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XI)) & (cwcel @ (ccv @ Xb) @ (cco @ (ccv @ Xa) @ (ccv @ Xc) @ XI))) & ((((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) = (cco @ (ccv @ Xa) @ (ccv @ Xb) @ Xc_mi)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_mi) = (cco @ (ccv @ Xb) @ (ccv @ Xc) @ Xc_mi))) & (((cco @ (ccv @ Xx3) @ (ccv @ Xu) @ Xc_mi) = (cco @ (ccv @ Xa) @ (ccv @ Xv) @ Xc_mi)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xu) @ Xc_mi) = (cco @ (ccv @ Xb) @ (ccv @ Xv) @ Xc_mi))))) => ((cco @ (ccv @ Xz) @ (ccv @ Xu) @ Xc_mi) = (cco @ (ccv @ Xc) @ (ccv @ Xv) @ Xc_mi)))) @ (^ [Xv:$i] : XP))) @ (^ [Xc:$i] : XP))) @ (^ [Xb:$i] : XP))) @ (^ [Xa:$i] : XP))) @ (^ [Xu:$i] : XP))) @ (^ [Xz:$i] : XP))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XI)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_mi) = (cco @ (ccv @ Xa) @ (ccv @ Xb) @ Xc_mi)))) @ (^ [Xz:$i] : XP))) @ (^ [Xb:$i] : XP))) @ (^ [Xa:$i] : XP))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP))))))))))))))))))))).
