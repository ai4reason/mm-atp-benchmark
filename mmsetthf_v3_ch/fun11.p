...
thf(afun11_thm,conjecture,(! [XA2:($i > $o)] : (((cwfun @ (cccnv @ (cccnv @ XA2))) & (cwfun @ (cccnv @ XA2))) <=> (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) & (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ XA2)) => (((ccv @ Xx3) = (ccv @ Xz)) <=> ((ccv @ Xy1) = (ccv @ Xw))))))))))).
