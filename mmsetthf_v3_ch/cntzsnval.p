...
thf(acntzsnval_thm,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XM @ cccntz))) => (! [Xx3:$i] : ((cwcel @ XY @ XB2) => ((ccfv @ (ccsn @ XY) @ (XZ @ Xx3)) = (ccrab @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XY @ Xc_pl) = (cco @ XY @ (ccv @ Xx3) @ Xc_pl))) @ (^ [Xx3:$i] : XB2)))))))))))))).
