...
thf(a_3cshw_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz) & (cwcel @ XM @ ccz)) => ((cco @ XW @ XN @ cccsh) = (cco @ (cco @ (cco @ XW @ XM @ cccsh) @ XN @ cccsh) @ (cco @ (ccfv @ XW @ cchash) @ XM @ ccmin) @ cccsh)))))))).
