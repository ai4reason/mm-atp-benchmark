...
thf(abcval2_thm,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ XN @ XK @ ccbc) = (cco @ (ccfv @ XN @ ccfa) @ (cco @ (ccfv @ (cco @ XN @ XK @ ccmin) @ ccfa) @ (ccfv @ XK @ ccfa) @ ccmul) @ ccdiv)))))).
