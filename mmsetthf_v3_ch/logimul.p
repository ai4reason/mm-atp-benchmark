...
thf(alogimul_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) => ((ccfv @ (cco @ cci @ XA2 @ ccmul) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccaddc))))).
