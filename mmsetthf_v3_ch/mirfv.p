...
thf(amirfv_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((! [Xz:$i] : ((XL @ Xz) = (ccfv @ XG @ cclng))) => ((! [Xz:$i] : ((XS @ Xz) = (ccfv @ XG @ ccmir))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((! [Xz:$i] : (XM = (ccfv @ XA2 @ (XS @ Xz)))) => ((Xph => (cwcel @ XB2 @ XP)) => (Xph => ((ccfv @ XB2 @ XM) = (ccrio @ (^ [Xz:$i] : (((cco @ XA2 @ (ccv @ Xz) @ Xc_mi) = (cco @ XA2 @ XB2 @ Xc_mi)) & (cwcel @ XA2 @ (cco @ (ccv @ Xz) @ XB2 @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))))))))).
