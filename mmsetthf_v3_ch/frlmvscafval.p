...
thf(afrlmvscafval_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XA2 @ XK)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xc_xb = (ccfv @ XY @ ccvsca)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (Xph => ((cco @ XA2 @ XX @ Xc_xb) = (cco @ (ccxp @ XI @ (ccsn @ XA2)) @ XX @ (ccof @ Xc_x)))))))))))))))))))))))).
