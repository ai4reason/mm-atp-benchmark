...
thf(alpolsatN_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ cclsa)) => ((XH = (ccfv @ XW @ cclsh)) => ((XP = (ccfv @ XW @ cclpoN)) => ((Xph => (cwcel @ XW @ XX)) => ((Xph => (cwcel @ Xc_pe @ XP)) => ((Xph => (cwcel @ XQ @ XA2)) => (Xph => (cwcel @ (ccfv @ XQ @ Xc_pe) @ XH))))))))))))))))).
