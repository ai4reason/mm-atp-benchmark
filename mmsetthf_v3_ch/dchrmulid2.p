...
thf(adchrelbas2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : ((XD @ Xx3) = (ccfv @ (XG @ Xx3) @ ccbs))) => (! [Xx3:$i] : (Xph => ((cwcel @ XX @ (XD @ Xx3)) <=> ((cwcel @ XX @ (cco @ (ccfv @ XZ @ ccmgp) @ (ccfv @ cccnfld @ ccmgp) @ ccmhm)) & (cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ XX) != ccc0) => (cwcel @ (ccv @ Xx3) @ XU))) @ (^ [Xx3:$i] : XB2))))))))))))))))))))).
thf(adchrelbas3_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ (XN @ Xy1) @ ccdchr)))) => ((! [Xy1:$i] : (XZ = (ccfv @ (XN @ Xy1) @ cczn))) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xy1:$i] : (Xph => (cwcel @ (XN @ Xy1) @ ccn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cwcel @ XX @ (XD @ Xx3 @ Xy1)) <=> ((cwf @ XB2 @ ccc @ XX) & ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XZ @ ccmulr)) @ XX) = (cco @ (ccfv @ (ccv @ Xx3) @ XX) @ (ccfv @ (ccv @ Xy1) @ XX) @ ccmul))) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : XU)) & ((ccfv @ (ccfv @ XZ @ ccur) @ XX) = cc1) & (cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ XX) != ccc0) => (cwcel @ (ccv @ Xx3) @ XU))) @ (^ [Xx3:$i] : XB2))))))))))))))))))))))).
...
thf(adchrelbas4_thm,axiom,(! [XD:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((! [Xx3:$i] : (XD = (ccfv @ (XG @ Xx3) @ ccbs))) => ((XL = (ccfv @ XZ @ cczrh)) => ((cwcel @ XX @ XD) <=> ((cwcel @ XN @ ccn) & (cwcel @ XX @ (cco @ (ccfv @ XZ @ ccmgp) @ (ccfv @ cccnfld @ ccmgp) @ ccmhm)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ cc1 @ (cco @ (ccv @ Xx3) @ XN @ ccgcd) @ cclt) => ((ccfv @ (ccfv @ (ccv @ Xx3) @ XL) @ XX) = ccc0))) @ (^ [Xx3:$i] : ccz))))))))))))))).
thf(adchrzrh1_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XX @ XD)) => (Xph => ((ccfv @ (ccfv @ cc1 @ XL) @ XX) = cc1))))))))))))))).
...
thf(adchrplusg_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => (Xc_x = (ccres @ (ccof @ ccmul) @ (ccxp @ XD @ XD)))))))))))))))).
thf(adchrmul_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XY @ XD)) => (Xph => ((cco @ XX @ XY @ Xc_x) = (cco @ XX @ XY @ (ccof @ ccmul))))))))))))))))))).
thf(adchrmulcl_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XY @ XD)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XD))))))))))))))))).
...
thf(adchr1cl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((! [Xk:$i] : ((XD @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : ((Xc_1 @ Xk) = (ccmpt @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XU) @ cc1 @ ccc0))))) => ((Xph => (cwcel @ XN @ ccn)) => (! [Xk:$i] : (Xph => (cwcel @ (Xc_1 @ Xk) @ (XD @ Xk)))))))))))))))))))).
thf(adchrmulid2_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((! [Xk:$i] : ((XD @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : ((Xc_1 @ Xk) = (ccmpt @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XU) @ cc1 @ ccc0))))) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwcel @ XX @ (XD @ Xk)))) => (! [Xk:$i] : (Xph => ((cco @ (Xc_1 @ Xk) @ XX @ (Xc_x @ Xk)) = XX)))))))))))))))))))))).
