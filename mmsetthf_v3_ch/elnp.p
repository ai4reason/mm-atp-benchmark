...
thf(aelnp_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnp) <=> (((cwpss @ cc0 @ XA2) & (cwpss @ XA2 @ ccnq)) & (cwral @ (^ [Xx3:$i] : ((! [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltq) => (cwcel @ (ccv @ Xy1) @ XA2))) & (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)))))).
