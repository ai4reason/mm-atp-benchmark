...
thf(amul2lt0rgt0_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) => ((Xph & (cwbr @ ccc0 @ XB2 @ cclt)) => (cwbr @ XA2 @ ccc0 @ cclt))))))))).
