...
thf(acnvimamptfin_thm,conjecture,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XN @ ccfn))) => (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (ccima @ (cccnv @ (ccmpt @ (^ [Xp:$i] : XN) @ (^ [Xp:$i] : (XX @ Xp)))) @ (XY @ Xp)) @ ccfn))))))))).
