...
thf(aisga_thm,conjecture,(! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccfv @ XG @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_pl @ Xx3 @ Xy1 @ Xz) = (ccfv @ XG @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_0 @ Xx3 @ Xy1 @ Xz) = (ccfv @ XG @ cc0g))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) <=> (((cwcel @ XG @ ccgrp) & (cwcel @ XY @ ccvv)) & ((cwf @ (ccxp @ (XX @ Xx3) @ XY) @ XY @ Xc_po) & (cwral @ (^ [Xx3:$i] : (((cco @ (Xc_0 @ Xx3 @ Xy1 @ Xz) @ (ccv @ Xx3) @ Xc_po) = (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_pl @ Xx3 @ Xy1 @ Xz)) @ (ccv @ Xx3) @ Xc_po) = (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ Xc_po) @ Xc_po))) @ (^ [Xz:$i] : (XX @ Xx3)))) @ (^ [Xy1:$i] : (XX @ Xx3))))) @ (^ [Xx3:$i] : XY)))))))))))))))))).
