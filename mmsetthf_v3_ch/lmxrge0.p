...
thf(almxrge0_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xj:$i] : ((XJ @ Xj) = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF))) => ((! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xj) & (cwcel @ (ccv @ Xk) @ ccn)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk))))) => (! [Xj:$i] : ((Xph @ Xj) => ((cwbr @ XF @ ccpnf @ (ccfv @ (XJ @ Xj) @ cclm)) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccv @ Xx3) @ (XA2 @ Xk) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccn))) @ (^ [Xx3:$i] : ccr))))))))))))).
