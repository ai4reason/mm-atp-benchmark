...
thf(asetcsect_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XU)) => ((Xph => (cwcel @ XY @ XU)) => ((XS = (ccfv @ XC @ ccsect)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XX @ XY @ XS)) <=> ((cwf @ XX @ XY @ XF) & (cwf @ XY @ XX @ XG) & ((cccom @ XG @ XF) = (ccres @ ccid @ XX)))))))))))))))))))).
