...
thf(amndodconglem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ ccmnd)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ XM @ (ccfv @ XA2 @ XO) @ cclt)) => ((Xph => (cwbr @ XN @ (ccfv @ XA2 @ XO) @ cclt)) => ((Xph => ((cco @ XM @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))) => ((Xph & (cwbr @ XM @ XN @ ccle)) => (XM = XN)))))))))))))))))))))))).
