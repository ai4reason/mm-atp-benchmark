...
thf(adomunfican_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ ccfn) & (cwbr @ XB2 @ XA2 @ ccen)) & (((ccin @ XA2 @ XX) = cc0) & ((ccin @ XB2 @ XY) = cc0))) => ((cwbr @ (ccun @ XA2 @ XX) @ (ccun @ XB2 @ XY) @ ccdom) <=> (cwbr @ XX @ XY @ ccdom)))))))).
