...
thf(aomabs_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccom) & (cwcel @ cc0 @ XA2)) & ((cwcel @ XB2 @ ccon0) & (cwcel @ cc0 @ XB2))) => ((cco @ XA2 @ (cco @ ccom @ XB2 @ ccoe) @ ccomu) = (cco @ ccom @ XB2 @ ccoe)))))).
