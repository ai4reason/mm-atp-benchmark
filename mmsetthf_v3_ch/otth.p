...
thf(aotth_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XR @ ccvv) => (((ccotp @ XA2 @ XB2 @ XR) = (ccotp @ XC @ XD @ XS)) <=> ((XA2 = XC) & (XB2 = XD) & (XR = XS))))))))))))).
