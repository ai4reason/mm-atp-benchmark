...
thf(aelequ2_b_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)) <=> (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))))))).
thf(aelequ2_b1_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) <=> (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1))))))).
thf(aax6dgen_thm,axiom,(~ (! [Xx3:$i] : (~ ((ccv @ Xx3) = (ccv @ Xx3)))))).
thf(aax10w_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((~ (! [Xx3:$i] : (Xph @ Xx3))) => (! [Xx3:$i] : (~ (! [Xx3:$i] : (Xph @ Xx3))))))))).
thf(aax11w_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph @ Xx3 @ Xy1))) => (! [Xy1:$i] : (! [Xx3:$i] : (Xph @ Xx3 @ Xy1)))))))).
thf(aax11dgen_thm,axiom,(! [Xph:($i > $o)] : ((! [Xx3:$i] : (! [Xx3:$i] : (Xph @ Xx3))) => (! [Xx3:$i] : (! [Xx3:$i] : (Xph @ Xx3)))))).
thf(aax12wlem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3 @ Xy1) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (Xph @ Xx3 @ Xy1))))))))))).
thf(aax12w_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xx3 @ Xz)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((! [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (Xph @ Xx3 @ Xy1))))))))))))).
thf(aax12dgen_thm,axiom,(! [Xph:($i > $o)] : (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xx3)) => ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xx3)) => (Xph @ Xx3)))))))).
thf(aax12wdemo_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (! [Xx3:$i] : (cwcel @ (ccv @ Xz) @ (ccv @ Xx3))) & (! [Xy1:$i] : (! [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (! [Xx3:$i] : (cwcel @ (ccv @ Xz) @ (ccv @ Xx3))) & (! [Xy1:$i] : (! [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))))))).
thf(aax13w_thm,axiom,(! [Xy1:$i] : (! [Xz:$i] : (! [Xx3:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xz)) => (! [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xz))))))))).
thf(aax13dgen1_thm,axiom,(! [Xz:$i] : (! [Xx3:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xx3) = (ccv @ Xz)) => (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz)))))))).
thf(aax13dgen1_b_thm,axiom,(! [Xx3:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xx3) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))))))).
thf(aax13dgen2_thm,axiom,(! [Xy1:$i] : (! [Xx3:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xx3)))))))).
thf(aax13dgen3_thm,axiom,(! [Xy1:$i] : (! [Xx3:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xy1)) => (! [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xy1)))))))).
thf(aax13dgen4_thm,axiom,(! [Xx3:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xx3) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))))))).
thf(aax13dgen4OLD_thm,axiom,(! [Xx3:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xx3) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))))))).
thf(aax_10_ax,axiom,(! [Xph:($i > $o)] : ((~ (! [Xx3:$i] : (Xph @ Xx3))) => (! [Xx3:$i] : (~ (! [Xx3:$i] : (Xph @ Xx3))))))).
...
thf(anf5dv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (Xph => ((Xps @ Xx3) => (! [Xx3:$i] : (Xps @ Xx3))))) => (Xph => ((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)))))))).
thf(anf5dh_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (! [Xx3:$i] : (Xph @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((Xps @ Xx3) => (! [Xx3:$i] : (Xps @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)))))))))).
...
thf(anfia1_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((? [X:$i] : ((^ [Xx3:$i] : ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (Xps @ Xx3)))) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (Xps @ Xx3)))) @ X)))))).
