...
thf(afiniunmbl_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ (ccdm @ ccvol))) @ (^ [Xk:$i] : XA2))) => (cwcel @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccdm @ ccvol)))))).
