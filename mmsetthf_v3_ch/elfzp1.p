...
thf(aelfzp1_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cwcel @ XK @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)) <=> ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) | (XK = (cco @ XN @ cc1 @ ccaddc))))))))).
