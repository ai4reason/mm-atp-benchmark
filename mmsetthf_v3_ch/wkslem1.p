...
thf(awkslem1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((XA2 = XB2) => (((((ccfv @ XA2 @ XP) = (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) & ((ccfv @ (ccfv @ XA2 @ XF) @ XI) = (ccsn @ (ccfv @ XA2 @ XP)))) | ((~ ((ccfv @ XA2 @ XP) = (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP))) & (cwss @ (ccpr @ (ccfv @ XA2 @ XP) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ XA2 @ XF) @ XI)))) <=> ((((ccfv @ XB2 @ XP) = (ccfv @ (cco @ XB2 @ cc1 @ ccaddc) @ XP)) & ((ccfv @ (ccfv @ XB2 @ XF) @ XI) = (ccsn @ (ccfv @ XB2 @ XP)))) | ((~ ((ccfv @ XB2 @ XP) = (ccfv @ (cco @ XB2 @ cc1 @ ccaddc) @ XP))) & (cwss @ (ccpr @ (ccfv @ XB2 @ XP) @ (ccfv @ (cco @ XB2 @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ XB2 @ XF) @ XI)))))))))))).
