...
thf(auzind4s_thm,conjecture,(! [Xph:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (((cwcel @ XM @ ccz) => (cwsbc @ (^ [Xk:$i] : (Xph @ Xk)) @ XM)) => ((! [Xk:$i] : ((cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz)) => ((Xph @ Xk) => (cwsbc @ (^ [Xk:$i] : (Xph @ Xk)) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc))))) => (! [Xk:$i] : ((cwcel @ (XN @ Xk) @ (ccfv @ XM @ ccuz)) => (cwsbc @ (^ [Xk:$i] : (Xph @ Xk)) @ (XN @ Xk)))))))))).
