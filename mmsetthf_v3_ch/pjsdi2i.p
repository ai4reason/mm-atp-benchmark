...
thf(apjsdi2i_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (((cccom @ XR @ (cco @ XS @ XT @ cchos)) = (cco @ (cccom @ XR @ XS) @ (cccom @ XR @ XT) @ cchos)) => ((cccom @ (cccom @ (ccfv @ XH @ ccpjh) @ XR) @ (cco @ XS @ XT @ cchos)) = (cco @ (cccom @ (cccom @ (ccfv @ XH @ ccpjh) @ XR) @ XS) @ (cccom @ (cccom @ (ccfv @ XH @ ccpjh) @ XR) @ XT) @ cchos)))))))))))).
