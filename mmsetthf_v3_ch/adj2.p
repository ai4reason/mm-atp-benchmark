...
thf(aadj2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ (ccdm @ ccado)) & (cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ (ccfv @ XA2 @ XT) @ XB2 @ ccsp) = (cco @ XA2 @ (ccfv @ XB2 @ (ccfv @ XT @ ccado)) @ ccsp))))))).
