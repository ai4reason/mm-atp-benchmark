...
thf(aflimcf_thm,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XX @ cctopon))) => ((cwss @ XJ @ XK) <=> (cwral @ (^ [Xf1:$i] : (cwss @ (cco @ XK @ (ccv @ Xf1) @ ccflim) @ (cco @ XJ @ (ccv @ Xf1) @ ccflim))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))).
