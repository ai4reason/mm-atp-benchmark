...
thf(apadicabv_thm,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccc0 @ (cco @ XN @ (cco @ XP @ (ccv @ Xx3) @ ccpc) @ ccexp)))))) => (! [Xx3:$i] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ (cco @ ccc0 @ cc1 @ ccioo))) => (cwcel @ (XF @ Xx3) @ XA2)))))))))))).
