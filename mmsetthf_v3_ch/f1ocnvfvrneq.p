...
thf(af1ocnvfvrneq_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & ((cwcel @ XC @ (ccrn @ XF)) & (cwcel @ XD @ (ccrn @ XF)))) => (((ccfv @ XC @ (cccnv @ XF)) = (ccfv @ XD @ (cccnv @ XF))) => (XC = XD))))))))).
