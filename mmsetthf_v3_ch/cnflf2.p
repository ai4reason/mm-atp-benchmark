...
thf(acnflf2_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xf1:$i] : (cwss @ (ccima @ XF @ (cco @ XJ @ (ccv @ Xf1) @ ccflim)) @ (ccfv @ XF @ (cco @ XK @ (ccv @ Xf1) @ ccflf)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))))))).
