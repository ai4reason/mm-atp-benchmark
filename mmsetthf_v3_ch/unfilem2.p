...
thf(aunfilem2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XB2 @ ccom) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))) => (! [Xx3:$i] : (cwf1o @ XB2 @ (ccdif @ (cco @ XA2 @ XB2 @ ccoa) @ XA2) @ (XF @ Xx3)))))))))).
