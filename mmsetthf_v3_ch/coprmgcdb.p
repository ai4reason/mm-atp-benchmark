...
thf(acoprmgcdb_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((cwral @ (^ [Xi:$i] : (((cwbr @ (ccv @ Xi) @ XA2 @ ccdvds) & (cwbr @ (ccv @ Xi) @ XB2 @ ccdvds)) => ((ccv @ Xi) = cc1))) @ (^ [Xi:$i] : ccn)) <=> ((cco @ XA2 @ XB2 @ ccgcd) = cc1)))))).
