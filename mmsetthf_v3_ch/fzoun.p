...
thf(afzoun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) & (cwcel @ XC @ ccn0)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo) = (ccun @ (cco @ XA2 @ XB2 @ ccfzo) @ (cco @ XB2 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo)))))))).
