...
thf(adchr1cl_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((! [Xk:$i] : ((XD @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : ((Xc_1 @ Xk) = (ccmpt @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XU) @ cc1 @ ccc0))))) => ((Xph => (cwcel @ XN @ ccn)) => (! [Xk:$i] : (Xph => (cwcel @ (Xc_1 @ Xk) @ (XD @ Xk)))))))))))))))))))).
