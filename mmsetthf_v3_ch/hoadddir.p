...
thf(ahoadddir_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwf @ cchil @ cchil @ XT)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XT @ cchot) = (cco @ (cco @ XA2 @ XT @ cchot) @ (cco @ XB2 @ XT @ cchot) @ cchos))))))).
