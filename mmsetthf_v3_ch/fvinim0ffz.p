...
thf(afvinim0ffz_thm,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (((cwf @ (cco @ ccc0 @ XK @ ccfz) @ XV @ XF) & (cwcel @ XK @ ccn0)) => (((ccin @ (ccima @ XF @ (ccpr @ ccc0 @ XK)) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) = cc0) <=> ((~ (wnel @ (ccfv @ ccc0 @ XF) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo)))) & (~ (wnel @ (ccfv @ XK @ XF) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))))))))))).
