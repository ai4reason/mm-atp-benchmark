...
thf(aicccmp_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XT = (cco @ XJ @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest)) => (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ XT @ cccmp))))))))).
