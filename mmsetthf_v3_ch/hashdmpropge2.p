...
thf(ahashdmpropge2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => (cwcel @ XD @ XY)) => ((Xph => (cwcel @ XF @ XZ)) => ((Xph => (XA2 != XB2)) => ((Xph => (cwss @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD)) @ XF)) => (Xph => (cwbr @ cc2 @ (ccfv @ (ccdm @ XF) @ cchash) @ ccle))))))))))))))))))))).
