...
thf(ampt2xeldm_thm,conjecture,(! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XD @ Xx3))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XR @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XN @ Xx3 @ Xy1) @ (cco @ (XX @ Xy1) @ (XY @ Xy1) @ (XF @ Xx3 @ Xy1))) => ((cwcel @ (XX @ Xy1) @ XC) & (cwcel @ (XY @ Xy1) @ (ccsb @ (XX @ Xy1) @ (^ [Xx3:$i] : (XD @ Xx3))))))))))))))))).
