...
thf(acmetss_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccms)) => ((cwcel @ (ccres @ XD @ (ccxp @ XY @ XY)) @ (ccfv @ XY @ ccms)) <=> (cwcel @ XY @ (ccfv @ XJ @ cccld)))))))))).
