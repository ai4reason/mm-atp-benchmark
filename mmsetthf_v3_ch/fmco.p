...
thf(afmco_thm,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XX @ XV) & (cwcel @ XY @ XW) & (cwcel @ XB2 @ (ccfv @ XZ @ ccfbas))) & ((cwf @ XY @ XX @ XF) & (cwf @ XZ @ XY @ XG))) => ((ccfv @ XB2 @ (cco @ XX @ (cccom @ XF @ XG) @ ccfm)) = (ccfv @ (ccfv @ XB2 @ (cco @ XY @ XG @ ccfm)) @ (cco @ XX @ XF @ ccfm))))))))))))).
