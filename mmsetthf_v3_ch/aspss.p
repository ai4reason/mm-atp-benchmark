...
thf(aaspss_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccasp)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ ccasa) & (cwss @ XS @ XV) & (cwss @ XT @ XS)) => (cwss @ (ccfv @ XT @ XA2) @ (ccfv @ XS @ XA2))))))))))).
