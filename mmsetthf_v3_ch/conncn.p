...
thf(aconncn_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XJ @ ccconn)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XU @ XK)) => ((Xph => (cwcel @ XU @ (ccfv @ XK @ cccld))) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XF) @ XU)) => (Xph => (cwf @ XX @ XU @ XF))))))))))))))))).
