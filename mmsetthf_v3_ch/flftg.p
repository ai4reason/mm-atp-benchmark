...
thf(aflftg_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xo:$i] : (! [Xs1:$i] : ((XJ @ Xo) = (ccfv @ (XB2 @ Xs1) @ cctg)))) => (! [Xo:$i] : (! [Xs1:$i] : (((cwcel @ (XJ @ Xo) @ (ccfv @ (XX @ Xo) @ cctopon)) & (cwcel @ XL @ (ccfv @ (XY @ Xo) @ ccfil)) & (cwf @ (XY @ Xo) @ (XX @ Xo) @ XF)) => ((cwcel @ XA2 @ (ccfv @ XF @ (cco @ (XJ @ Xo) @ XL @ ccflf))) <=> ((cwcel @ XA2 @ (XX @ Xo)) & (cwral @ (^ [Xo:$i] : ((cwcel @ XA2 @ (ccv @ Xo)) => (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xo))) @ (^ [Xs1:$i] : XL)))) @ (^ [Xo:$i] : (XB2 @ Xs1))))))))))))))))).
