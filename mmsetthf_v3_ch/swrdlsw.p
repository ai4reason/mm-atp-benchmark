...
thf(aswrdlsw_thm,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (XW != cc0)) => ((cco @ XW @ (ccop @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccfv @ XW @ cchash)) @ ccsubstr) = (ccs1 @ (ccfv @ XW @ cclsw))))))).
