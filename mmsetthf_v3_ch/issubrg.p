...
thf(aissubrg_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) <=> (((cwcel @ XR @ ccrg) & (cwcel @ (cco @ XR @ XA2 @ ccress) @ ccrg)) & ((cwss @ XA2 @ XB2) & (cwcel @ Xc_1 @ XA2))))))))))).
