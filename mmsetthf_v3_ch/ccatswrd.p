...
thf(accatswrd_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & ((cwcel @ XX @ (cco @ ccc0 @ XY @ ccfz)) & (cwcel @ XY @ (cco @ ccc0 @ XZ @ ccfz)) & (cwcel @ XZ @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz)))) => ((cco @ (cco @ XS @ (ccop @ XX @ XY) @ ccsubstr) @ (cco @ XS @ (ccop @ XY @ XZ) @ ccsubstr) @ ccconcat) = (cco @ XS @ (ccop @ XX @ XZ) @ ccsubstr))))))))).
