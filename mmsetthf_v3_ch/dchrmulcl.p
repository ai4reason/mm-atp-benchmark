...
thf(adchrmulcl_thm,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XY @ XD)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XD))))))))))))))))).
