...
thf(acmsss_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XK = (cco @ XM @ XA2 @ ccress)) => ((XX = (ccfv @ XM @ ccbs)) => ((XJ = (ccfv @ XM @ cctopn)) => (((cwcel @ XM @ cccms) & (cwss @ XA2 @ XX)) => ((cwcel @ XK @ cccms) <=> (cwcel @ XA2 @ (ccfv @ XJ @ cccld))))))))))))).
