...
thf(acctop_thm,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom) | ((ccv @ Xx3) = cc0))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ cctopon))))))).
