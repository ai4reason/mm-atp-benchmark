...
thf(amodsumfzodifsn_thm,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XK @ (cco @ cc1 @ XN @ ccfzo))) => (cwcel @ (cco @ (cco @ XK @ XJ @ ccaddc) @ XN @ ccmo) @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ)))))))).
