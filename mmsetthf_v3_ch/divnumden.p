...
thf(adivnumden_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccn)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) = (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)) & ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) = (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))))))).
