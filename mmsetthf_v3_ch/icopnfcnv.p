...
thf(aicopnfcnv_thm,conjecture,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ ccdiv))))) => (! [Xx3:$i] : ((cwf1o @ (cco @ ccc0 @ cc1 @ ccico) @ (cco @ ccc0 @ ccpnf @ ccico) @ (XF @ Xx3)) & ((cccnv @ (XF @ Xx3)) = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ ccpnf @ ccico)) @ (^ [Xy1:$i] : (cco @ (ccv @ Xy1) @ (cco @ cc1 @ (ccv @ Xy1) @ ccaddc) @ ccdiv))))))))).
