...
thf(a_3ccased_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : ((Xph => ((Xch & Xet) => Xps)) => ((Xph => ((Xch & Xze) => Xps)) => ((Xph => ((Xch & Xsi) => Xps)) => ((Xph => ((Xth & Xet) => Xps)) => ((Xph => ((Xth & Xze) => Xps)) => ((Xph => ((Xth & Xsi) => Xps)) => ((Xph => ((Xta & Xet) => Xps)) => ((Xph => ((Xta & Xze) => Xps)) => ((Xph => ((Xta & Xsi) => Xps)) => (Xph => (((Xch | Xth | Xta) & (Xet | Xze | Xsi)) => Xps)))))))))))))))))))).
