...
thf(aqsinxp_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwss @ (ccima @ XR @ XA2) @ XA2) => ((ccqs @ XA2 @ XR) = (ccqs @ XA2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2)))))))).
thf(aqsdisj_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwer @ XX @ XR)) => ((Xph => (cwcel @ XB2 @ (ccqs @ XA2 @ XR))) => ((Xph => (cwcel @ XC @ (ccqs @ XA2 @ XR))) => (Xph => ((XB2 = XC) | ((ccin @ XB2 @ XC) = cc0))))))))))))).
thf(aqsdisj2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwer @ XX @ XR) => (cwdisj @ (^ [Xx3:$i] : (ccqs @ XA2 @ XR)) @ (^ [Xx3:$i] : (ccv @ Xx3)))))))).
thf(aqsel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwer @ XX @ XR) & (cwcel @ XB2 @ (ccqs @ XA2 @ XR)) & (cwcel @ XC @ XB2)) => (XB2 = (ccec @ XC @ XR))))))))).
thf(auniinqs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwer @ XX @ XR) => (((cwss @ XB2 @ (ccqs @ XA2 @ XR)) & (cwss @ XC @ (ccqs @ XA2 @ XR))) => ((ccuni @ (ccin @ XB2 @ XC)) = (ccin @ (ccuni @ XB2) @ (ccuni @ XC))))))))))).
thf(aqliftlem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (ccec @ (ccv @ Xx3) @ XR) @ (XA2 @ Xx3))))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ XY))) => ((Xph => (cwer @ XX @ XR)) => ((Xph => (cwcel @ XX @ ccvv)) => (! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (ccec @ (ccv @ Xx3) @ XR) @ (ccqs @ XX @ XR))))))))))))))).
