...
thf(achj12_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch) & (cwcel @ XC @ ccch)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cchj) = (cco @ XB2 @ (cco @ XA2 @ XC @ cchj) @ cchj))))))).
