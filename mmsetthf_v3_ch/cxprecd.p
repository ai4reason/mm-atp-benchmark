...
thf(acxprecd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ cccxp) = (cco @ cc1 @ (cco @ XA2 @ XB2 @ cccxp) @ ccdiv))))))))).
