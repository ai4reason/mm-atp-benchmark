...
thf(abnj1098_thm,conjecture,(! [XD:($i > $o)] : (! [Xi:$i] : (! [Xn:$i] : ((XD = (ccdif @ ccom @ (ccsn @ cc0))) => (? [Xj:$i] : ((((ccv @ Xi) != cc0) & (cwcel @ (ccv @ Xi) @ (ccv @ Xn)) & (cwcel @ (ccv @ Xn) @ XD)) => ((cwcel @ (ccv @ Xj) @ (ccv @ Xn)) & ((ccv @ Xi) = (ccsuc @ (ccv @ Xj))))))))))).
