...
thf(aqtopcmplem_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ XA2) => (cwcel @ XJ @ cctop)) => ((((cwcel @ XJ @ XA2) & (cwfo @ XX @ (ccuni @ (cco @ XJ @ XF @ ccqtop)) @ XF) & (cwcel @ XF @ (cco @ XJ @ (cco @ XJ @ XF @ ccqtop) @ cccn))) => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ XA2)) => (((cwcel @ XJ @ XA2) & (cwfn @ XF @ XX)) => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ XA2)))))))))).
