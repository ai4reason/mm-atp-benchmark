...
thf(aleisorel_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwiso @ XA2 @ XB2 @ cclt @ cclt @ XF) & ((cwss @ XA2 @ ccxr) & (cwss @ XB2 @ ccxr)) & ((cwcel @ XC @ XA2) & (cwcel @ XD @ XA2))) => ((cwbr @ XC @ XD @ ccle) <=> (cwbr @ (ccfv @ XC @ XF) @ (ccfv @ XD @ XF) @ ccle))))))))).
