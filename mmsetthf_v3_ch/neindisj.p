...
thf(aneindisj_thm,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) & ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) & (cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))) => ((ccin @ XN @ XS) != cc0))))))))).
