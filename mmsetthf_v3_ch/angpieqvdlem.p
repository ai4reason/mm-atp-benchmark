...
thf(aangpieqvdlem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (XA2 != XB2)) => ((Xph => (XA2 != XC)) => (Xph => ((cwcel @ (ccneg @ (cco @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccmin) @ ccdiv)) @ ccrp) <=> (cwcel @ (cco @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccdiv) @ (cco @ ccc0 @ cc1 @ ccioo)))))))))))))).
