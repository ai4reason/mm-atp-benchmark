...
thf(axrge0tsms2_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwbr @ (cco @ XG @ XF @ cctsu) @ cc1o @ ccen)))))))).
