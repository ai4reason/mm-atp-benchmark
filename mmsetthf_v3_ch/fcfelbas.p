...
thf(afcfelbas_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwf @ XY @ XX @ XF)) & (cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)))) => (cwcel @ XA2 @ XX))))))))).
