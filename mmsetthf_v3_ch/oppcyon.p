...
thf(aoppcyon_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XY = (ccfv @ XO @ ccyon)) => ((XM = (ccfv @ XC @ cchof)) => ((Xph => (cwcel @ XC @ cccat)) => (Xph => (XY = (cco @ (ccop @ XO @ XC) @ XM @ cccurf))))))))))))).
