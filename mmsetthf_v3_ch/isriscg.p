...
thf(aisriscg_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xf1:$i] : (((cwcel @ XR @ (XA2 @ Xf1)) & (cwcel @ XS @ (XB2 @ Xf1))) => ((cwbr @ XR @ XS @ ccrisc) <=> (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo)) & (? [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XR @ XS @ ccrngiso)))))))))))).
