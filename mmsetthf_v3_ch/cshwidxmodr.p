...
thf(acshwidxmodr_thm,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz) & (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((ccfv @ (cco @ (cco @ XI @ XN @ ccmin) @ (ccfv @ XW @ cchash) @ ccmo) @ (cco @ XW @ XN @ cccsh)) = (ccfv @ XI @ XW)))))))).
