...
thf(acshimadifsn0_thm,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XF @ (ccword @ XS)) & (XN = (ccfv @ XF @ cchash)) & (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo))) => ((ccima @ XF @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ))) = (ccima @ (cco @ XF @ (cco @ XJ @ cc1 @ ccaddc) @ cccsh) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))))))))).
