...
thf(acoprmprod_thm,conjecture,(! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xn:$i] : ((((cwcel @ XM @ ccfn) & (cwss @ XM @ ccn) & (cwcel @ XN @ ccn)) & (cwf @ ccn @ ccn @ (XF @ Xn)) & (cwral @ (^ [Xm:$i] : ((cco @ (ccfv @ (ccv @ Xm) @ (XF @ Xn)) @ XN @ ccgcd) = cc1)) @ (^ [Xm:$i] : XM))) => ((cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : ((cco @ (ccfv @ (ccv @ Xm) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)) @ ccgcd) = cc1)) @ (^ [Xn:$i] : (ccdif @ XM @ (ccsn @ (ccv @ Xm)))))) @ (^ [Xm:$i] : XM)) => ((cco @ (ccprod @ (^ [Xm:$i] : XM) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xm) @ (XF @ Xn)))) @ XN @ ccgcd) = cc1)))))))).
