...
thf(aswrds1_thm,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((cco @ XW @ (ccop @ XI @ (cco @ XI @ cc1 @ ccaddc)) @ ccsubstr) = (ccs1 @ (ccfv @ XI @ XW)))))))).
