...
thf(aidaf_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XC @ ccida)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((XA2 = (ccfv @ XC @ ccarw)) => (Xph => (cwf @ XB2 @ XA2 @ XI)))))))))))).
