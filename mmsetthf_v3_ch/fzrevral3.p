...
thf(afzrevral3_thm,conjecture,(! [Xph:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwral @ (^ [Xj:$i] : (Xph @ Xj)) @ (^ [Xj:$i] : (cco @ XM @ XN @ ccfz))) <=> (cwral @ (^ [Xk:$i] : (cwsbc @ (^ [Xj:$i] : (Xph @ Xj)) @ (cco @ (cco @ XM @ XN @ ccaddc) @ (ccv @ Xk) @ ccmin))) @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz))))))))).
