...
thf(aelsx_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XS @ XV) & (cwcel @ XT @ XW)) & ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XT))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (cco @ XS @ XT @ ccsx)))))))))).
