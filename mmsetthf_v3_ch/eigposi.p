...
thf(aeigposi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ ccc) => ((((cwcel @ (cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) @ ccr) & (cwbr @ ccc0 @ (cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) @ ccle)) & (((ccfv @ XA2 @ XT) = (cco @ XB2 @ XA2 @ ccsm)) & (XA2 != cc0v))) => ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ ccle))))))))).
