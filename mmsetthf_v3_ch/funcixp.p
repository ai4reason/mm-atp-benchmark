...
thf(afuncixp_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((XB2 = (ccfv @ XD @ ccbs)) => ((XH = (ccfv @ XD @ cchom)) => ((XJ = (ccfv @ XE @ cchom)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XD @ XE @ ccfunc))) => (Xph => (cwcel @ XG @ (ccixp @ (^ [Xz:$i] : (ccxp @ XB2 @ XB2)) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xz) @ cc1st) @ XF) @ (ccfv @ (ccfv @ (ccv @ Xz) @ cc2nd) @ XF) @ XJ) @ (ccfv @ (ccv @ Xz) @ XH) @ ccmap)))))))))))))))))).
