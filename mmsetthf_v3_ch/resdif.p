...
thf(aresdif_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ (cccnv @ XF)) & (cwfo @ XA2 @ XC @ (ccres @ XF @ XA2)) & (cwfo @ XB2 @ XD @ (ccres @ XF @ XB2))) => (cwf1o @ (ccdif @ XA2 @ XB2) @ (ccdif @ XC @ XD) @ (ccres @ XF @ (ccdif @ XA2 @ XB2)))))))))).
