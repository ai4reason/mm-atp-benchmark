...
thf(acntzmhm2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XG @ cccntz)) => ((XY = (ccfv @ XH @ cccntz)) => (((cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) & (cwss @ XS @ (ccfv @ XT @ XZ))) => (cwss @ (ccima @ XF @ XS) @ (ccfv @ (ccima @ XF @ XT) @ XY))))))))))))).
thf(acntrsubgnsg_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ cccntr)) => (((cwcel @ XX @ (ccfv @ XM @ ccsubg)) & (cwss @ XX @ XZ)) => (cwcel @ XX @ (ccfv @ XM @ ccnsg)))))))).
thf(acntrnsg_thm,axiom,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ cccntr)) => ((cwcel @ XM @ ccgrp) => (cwcel @ XZ @ (ccfv @ XM @ ccnsg))))))).
thf(ccoppg_tp,type,(ccoppg : ($i > $o))).
thf(adf_oppg_ax,axiom,(ccoppg = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (cctpos @ (ccfv @ (ccv @ Xw) @ ccplusg))) @ ccsts))))).
thf(aoppgval_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((XO = (ccfv @ XR @ ccoppg)) => (XO = (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (cctpos @ Xc_pl)) @ ccsts)))))))).
thf(aoppgplusfval_thm,axiom,(! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((XO = (ccfv @ XR @ ccoppg)) => ((Xc_pb = (ccfv @ XO @ ccplusg)) => (Xc_pb = (cctpos @ Xc_pl)))))))))).
...
thf(aoppgtopn_thm,axiom,(! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((XJ = (ccfv @ XR @ cctopn)) => (XJ = (ccfv @ XO @ cctopn)))))))).
thf(aoppgmnd_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((cwcel @ XR @ ccmnd) => (cwcel @ XO @ ccmnd)))))).
thf(aoppgmndb_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((cwcel @ XR @ ccmnd) <=> (cwcel @ XO @ ccmnd)))))).
thf(aoppgid_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [Xc_0:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (Xc_0 = (ccfv @ XO @ cc0g)))))))).
thf(aoppggrp_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((cwcel @ XR @ ccgrp) => (cwcel @ XO @ ccgrp)))))).
thf(aoppggrpb_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((cwcel @ XR @ ccgrp) <=> (cwcel @ XO @ ccgrp)))))).
thf(aoppginv_thm,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((XI = (ccfv @ XR @ ccminusg)) => ((cwcel @ XR @ ccgrp) => (XI = (ccfv @ XO @ ccminusg))))))))).
thf(ainvoppggim_thm,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ ccgrp) => (cwcel @ XI @ (cco @ XG @ XO @ ccgim))))))))).
thf(aoppggic_thm,axiom,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((cwcel @ XG @ ccgrp) => (cwbr @ XG @ XO @ ccgic)))))).
thf(aoppgsubm_thm,axiom,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((ccfv @ XG @ ccsubmnd) = (ccfv @ XO @ ccsubmnd)))))).
thf(aoppgsubg_thm,axiom,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((ccfv @ XG @ ccsubg) = (ccfv @ XO @ ccsubg)))))).
thf(aoppgcntz_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((XZ = (ccfv @ XG @ cccntz)) => ((ccfv @ XA2 @ XZ) = (ccfv @ XA2 @ (ccfv @ XO @ cccntz)))))))))).
thf(aoppgcntr_thm,axiom,(! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((XZ = (ccfv @ XG @ cccntr)) => (XZ = (ccfv @ XO @ cccntr)))))))).
thf(agsumwrev_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XO = (ccfv @ XM @ ccoppg)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XW @ (ccword @ XB2))) => ((cco @ XO @ XW @ ccgsu) = (cco @ XM @ (ccfv @ XW @ ccreverse) @ ccgsu)))))))))).
thf(ccsymg_tp,type,(ccsymg : ($i > $o))).
thf(adf_symg_ax,axiom,(ccsymg = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccsb @ (^ [Xh:$i] : (cwf1o @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xh))) @ (^ [Xb:$i] : (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccv @ Xb)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccv @ Xb))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccv @ Xb))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))))) @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ (ccxp @ (ccv @ Xx3) @ (ccsn @ (ccpw @ (ccv @ Xx3)))) @ ccpt))))))))).
thf(asymgval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XG @ Xx3 @ Xf1 @ Xg1) = (ccfv @ XA2 @ ccsymg))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XB2 @ Xx3 @ Xf1 @ Xg1) = (^ [Xx3:$i] : (cwf1o @ XA2 @ XA2 @ (ccv @ Xx3))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xc_pl @ Xx3 @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XB2 @ Xx3 @ Xf1 @ Xg1))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XB2 @ Xx3 @ Xf1 @ Xg1))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XJ @ Xx3 @ Xf1 @ Xg1) = (ccfv @ (ccxp @ XA2 @ (ccsn @ (ccpw @ XA2))) @ ccpt))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xf1 @ Xg1)) => ((XG @ Xx3 @ Xf1 @ Xg1) = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (XB2 @ Xx3 @ Xf1 @ Xg1)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (Xc_pl @ Xx3 @ Xf1 @ Xg1)) @ (ccop @ (ccfv @ ccnx @ ccts) @ (XJ @ Xx3 @ Xf1 @ Xg1))))))))))))))))))).
...
thf(aelsymgbas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ XV) => ((cwcel @ XF @ XB2) <=> (cwf1o @ XA2 @ XA2 @ XF))))))))))).
...
thf(asymghash_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ ccfn) => ((ccfv @ XB2 @ cchash) = (ccfv @ (ccfv @ XA2 @ cchash) @ ccfa))))))))).
thf(asymgbasfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ ccfn) => (cwcel @ XB2 @ ccfn)))))))).
...
thf(asymgfvne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XF @ XB2) & (cwcel @ XX @ XA2) & (cwcel @ XY @ XA2)) => (((ccfv @ XX @ XF) = XZ) => ((XY != XX) => ((ccfv @ XY @ XF) != XZ)))))))))))))).
...
thf(asymgmov1_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => (! [Xk:$i] : ((cwcel @ XQ @ (XP @ Xk)) => (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xn) @ XQ) = (ccv @ Xk))) @ (^ [Xk:$i] : XN))) @ (^ [Xn:$i] : XN))))))))).
thf(asymgmov2_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => (! [Xk:$i] : ((cwcel @ XQ @ (XP @ Xk)) => (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ XQ) = (ccv @ Xn))) @ (^ [Xk:$i] : XN))) @ (^ [Xn:$i] : XN))))))))).
thf(asymgbas0_thm,axiom,((ccfv @ (ccfv @ cc0 @ ccsymg) @ ccbs) = (ccsn @ cc0))).
thf(asymg1hash_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XA2 = (ccsn @ XI)) => ((cwcel @ XI @ XV) => ((ccfv @ XB2 @ cchash) = cc1))))))))))).
thf(asymg1bas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XA2 = (ccsn @ XI)) => ((cwcel @ XI @ XV) => (XB2 = (ccsn @ (ccsn @ (ccop @ XI @ XI)))))))))))))).
thf(asymg2hash_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XA2 = (ccpr @ XI @ XJ)) => (((cwcel @ XI @ XV) & (cwcel @ XJ @ XW) & (XI != XJ)) => ((ccfv @ XB2 @ cchash) = cc2))))))))))))).
thf(asymg2bas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XA2 = (ccpr @ XI @ XJ)) => (((cwcel @ XI @ XV) & (cwcel @ XJ @ XW)) => (XB2 = (ccpr @ (ccpr @ (ccop @ XI @ XI) @ (ccop @ XJ @ XJ)) @ (ccpr @ (ccop @ XI @ XJ) @ (ccop @ XJ @ XI)))))))))))))))).
thf(asymgtset_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((cwcel @ XA2 @ XV) => ((ccfv @ (ccxp @ XA2 @ (ccsn @ (ccpw @ XA2))) @ ccpt) = (ccfv @ XG @ ccts)))))))).
...
thf(agalactghm_thm,conjecture,(! [Xc_po:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xy1:$i] : ((XH @ Xy1) = (ccfv @ XY @ ccsymg))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_po)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ XG @ (XH @ Xy1) @ ccghm))))))))))))))).
