...
thf(amulcxplem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ ccc0 @ XC @ cccxp) = (cco @ (cco @ XA2 @ XC @ cccxp) @ (cco @ ccc0 @ XC @ cccxp) @ ccmul))))))))).
