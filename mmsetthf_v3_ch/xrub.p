...
thf(axrub_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccxr))))))).
