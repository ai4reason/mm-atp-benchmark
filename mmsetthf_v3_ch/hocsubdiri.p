...
thf(ahocsubdiri_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => ((cccom @ (cco @ XR @ XS @ cchod) @ XT) = (cco @ (cccom @ XR @ XT) @ (cccom @ XS @ XT) @ cchod))))))))).
