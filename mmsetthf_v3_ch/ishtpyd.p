...
thf(acnllycmp_thm,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (cwcel @ XJ @ (ccnlly @ cccmp))))).
thf(arellycmp_thm,axiom,(cwcel @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (ccnlly @ cccmp))).
thf(abndth_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((Xph => (cwcel @ XJ @ cccmp)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ XJ @ (XK @ Xx3) @ cccn)))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))))))))).
thf(aevth_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((Xph => (cwcel @ XJ @ cccmp)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ XJ @ (XK @ Xx3) @ cccn)))) => ((Xph => (XX != cc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))))).
thf(aevth2_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((Xph => (cwcel @ XJ @ cccmp)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ XJ @ (XK @ Xx3) @ cccn)))) => ((Xph => (XX != cc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccle)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))))).
thf(alebnumlem1_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XJ @ cccmp)) => ((Xph => (cwss @ XU @ XJ)) => ((Xph => (XX = (ccuni @ XU))) => ((Xph => (cwcel @ XU @ ccfn)) => ((Xph => (~ (cwcel @ XX @ XU))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : ((XF @ Xy1 @ Xz @ Xk) = (ccmpt @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccsu @ XU @ (^ [Xk:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccv @ Xk))) @ (^ [Xz:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD)))) @ ccxr @ cclt))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (Xph => (cwf @ XX @ ccrp @ (XF @ Xy1 @ Xz @ Xk))))))))))))))))))))).
thf(alebnumlem2_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XJ @ cccmp)) => ((Xph => (cwss @ XU @ XJ)) => ((Xph => (XX = (ccuni @ XU))) => ((Xph => (cwcel @ XU @ ccfn)) => ((Xph => (~ (cwcel @ XX @ XU))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : ((XF @ Xy1 @ Xz @ Xk) = (ccmpt @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccsu @ XU @ (^ [Xk:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccv @ Xk))) @ (^ [Xz:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD)))) @ ccxr @ cclt))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : ((XK @ Xy1 @ Xz @ Xk) = (ccfv @ (ccrn @ ccioo) @ cctg))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XF @ Xy1 @ Xz @ Xk) @ (cco @ XJ @ (XK @ Xy1 @ Xz @ Xk) @ cccn))))))))))))))))))))))).
thf(alebnumlem3_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > $o)] : ((! [Xu:$i] : ((XJ @ Xu) = (ccfv @ XD @ ccmopn))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XD @ (ccfv @ XX @ ccme)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ (XJ @ Xu) @ cccmp))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwss @ XU @ (XJ @ Xu)))) => ((! [Xu:$i] : ((Xph @ Xu) => (XX = (ccuni @ XU)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XU @ ccfn))) => ((! [Xu:$i] : ((Xph @ Xu) => (~ (cwcel @ XX @ XU)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xd:$i] : ((XF @ Xy1 @ Xz @ Xu @ Xk @ Xd) = (ccmpt @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccsu @ XU @ (^ [Xk:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccv @ Xk))) @ (^ [Xz:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD)))) @ ccxr @ cclt))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xd:$i] : ((XK @ Xy1 @ Xz @ Xu @ Xk @ Xd) = (ccfv @ (ccrn @ ccioo) @ cctg))))))) => (! [Xu:$i] : ((Xph @ Xu) => (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XD @ ccbl)) @ (ccv @ Xu))) @ (^ [Xu:$i] : XU))) @ (^ [Xx3:$i] : XX))) @ (^ [Xd:$i] : ccrp))))))))))))))))))))).
thf(alebnum_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xu:$i] : ((XJ @ Xu) = (ccfv @ XD @ ccmopn))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XD @ (ccfv @ XX @ ccme)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ (XJ @ Xu) @ cccmp))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwss @ XU @ (XJ @ Xu)))) => ((! [Xu:$i] : ((Xph @ Xu) => (XX = (ccuni @ XU)))) => (! [Xu:$i] : ((Xph @ Xu) => (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XD @ ccbl)) @ (ccv @ Xu))) @ (^ [Xu:$i] : XU))) @ (^ [Xx3:$i] : XX))) @ (^ [Xd:$i] : ccrp))))))))))))))).
thf(axlebnum_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xd:$i] : ((XJ @ Xx3 @ Xu @ Xd) = (ccfv @ XD @ ccmopn))))) => ((! [Xd:$i] : ((Xph @ Xd) => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xd:$i] : ((Xph @ Xd) => (cwcel @ (XJ @ Xx3 @ Xu @ Xd) @ cccmp))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xd:$i] : ((Xph @ Xd) => (cwss @ XU @ (XJ @ Xx3 @ Xu @ Xd)))))) => ((! [Xd:$i] : ((Xph @ Xd) => (XX = (ccuni @ XU)))) => (! [Xd:$i] : ((Xph @ Xd) => (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XD @ ccbl)) @ (ccv @ Xu))) @ (^ [Xu:$i] : XU))) @ (^ [Xx3:$i] : XX))) @ (^ [Xd:$i] : ccrp))))))))))))))).
...
thf(adf_htpy_ax,axiom,(cchtpy = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : cctop)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : cctop)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccrab @ (^ [Xh:$i] : (cwral @ (^ [Xs1:$i] : (((cco @ (ccv @ Xs1) @ ccc0 @ (ccv @ Xh)) = (ccfv @ (ccv @ Xs1) @ (ccv @ Xf1))) & ((cco @ (ccv @ Xs1) @ cc1 @ (ccv @ Xh)) = (ccfv @ (ccv @ Xs1) @ (ccv @ Xg1))))) @ (^ [Xs1:$i] : (ccuni @ (ccv @ Xx3))))) @ (^ [Xh:$i] : (cco @ (cco @ (ccv @ Xx3) @ ccii @ cctx) @ (ccv @ Xy1) @ cccn))))))))))).
thf(adf_phtpy_ax,axiom,(ccphtpy = (ccmpt @ (^ [Xx3:$i] : cctop) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccii @ (ccv @ Xx3) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccii @ (ccv @ Xx3) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccrab @ (^ [Xh:$i] : (cwral @ (^ [Xs1:$i] : (((cco @ ccc0 @ (ccv @ Xs1) @ (ccv @ Xh)) = (ccfv @ ccc0 @ (ccv @ Xf1))) & ((cco @ cc1 @ (ccv @ Xs1) @ (ccv @ Xh)) = (ccfv @ cc1 @ (ccv @ Xf1))))) @ (^ [Xs1:$i] : (cco @ ccc0 @ cc1 @ ccicc)))) @ (^ [Xh:$i] : (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (cco @ ccii @ (ccv @ Xx3) @ cchtpy))))))))))).
...
thf(ahtpycn_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (Xph => (cwss @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)) @ (cco @ (cco @ XJ @ ccii @ cctx) @ XK @ cccn))))))))))))).
thf(ahtpyi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)))) => ((Xph & (cwcel @ XA2 @ XX)) => (((cco @ XA2 @ ccc0 @ XH) = (ccfv @ XA2 @ XF)) & ((cco @ XA2 @ cc1 @ XH) = (ccfv @ XA2 @ XG))))))))))))))))).
thf(aishtpyd_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xs1:$i] : (Xph => (cwcel @ XF @ (cco @ XJ @ (XK @ Xs1) @ cccn)))) => ((! [Xs1:$i] : (Xph => (cwcel @ XG @ (cco @ XJ @ (XK @ Xs1) @ cccn)))) => ((! [Xs1:$i] : (Xph => (cwcel @ XH @ (cco @ (cco @ XJ @ ccii @ cctx) @ (XK @ Xs1) @ cccn)))) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ XX)) => ((cco @ (ccv @ Xs1) @ ccc0 @ XH) = (ccfv @ (ccv @ Xs1) @ XF)))) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ XX)) => ((cco @ (ccv @ Xs1) @ cc1 @ XH) = (ccfv @ (ccv @ Xs1) @ XG)))) => (! [Xs1:$i] : (Xph => (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ (XK @ Xs1) @ cchtpy))))))))))))))))))).
