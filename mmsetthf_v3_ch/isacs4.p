...
thf(aisacs4_thm,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) => ((ccfv @ (ccuni @ (ccv @ Xs1)) @ XF) = (ccuni @ (ccima @ XF @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ XX))))))))))).
