...
thf(amodcyc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XA2 @ (cco @ XN @ XB2 @ ccmul) @ ccaddc) @ XB2 @ ccmo) = (cco @ XA2 @ XB2 @ ccmo))))))).
