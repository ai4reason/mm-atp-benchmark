...
thf(asetciso_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XU)) => ((Xph => (cwcel @ XY @ XU)) => ((XI = (ccfv @ XC @ cciso)) => (Xph => ((cwcel @ XF @ (cco @ XX @ XY @ XI)) <=> (cwf1o @ XX @ XY @ XF))))))))))))))))).
