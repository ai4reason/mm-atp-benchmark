...
thf(aply1rem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XG = (cco @ XX @ (ccfv @ XN @ XA2) @ Xc_mi)) => ((XO = (ccfv @ XR @ cce1)) => ((Xph => (cwcel @ XR @ ccnzr)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ XK)) => ((Xph => (cwcel @ XF @ XB2)) => ((XE = (ccfv @ XR @ ccr1p)) => (Xph => ((cco @ XF @ XG @ XE) = (ccfv @ (ccfv @ XN @ (ccfv @ XF @ XO)) @ XA2)))))))))))))))))))))))))))))).
