...
thf(assfzo12bi_thm,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XK @ ccz) & (cwcel @ XL @ ccz)) & ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (cwbr @ XK @ XL @ cclt)) => ((cwss @ (cco @ XK @ XL @ ccfzo) @ (cco @ XM @ XN @ ccfzo)) <=> ((cwbr @ XM @ XK @ ccle) & (cwbr @ XL @ XN @ ccle))))))))).
