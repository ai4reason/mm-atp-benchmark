...
thf(azmin_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwreu @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccle) & (cwral @ (^ [Xy1:$i] : ((cwbr @ XA2 @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) @ (^ [Xy1:$i] : ccz)))) @ (^ [Xx3:$i] : ccz))))).
