...
thf(adffv2_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ XF) = (ccuni @ (ccdif @ (ccima @ XF @ (ccsn @ XA2)) @ (ccuni @ (ccuni @ (ccdif @ (cccom @ (ccres @ XF @ (ccsn @ XA2)) @ (cccnv @ (ccres @ XF @ (ccsn @ XA2)))) @ ccid))))))))).
