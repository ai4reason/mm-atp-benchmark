...
thf(aoffres_thm,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XG @ XW)) => ((ccres @ (cco @ XF @ XG @ (ccof @ XR)) @ XD) = (cco @ (ccres @ XF @ XD) @ (ccres @ XG @ XD) @ (ccof @ XR))))))))))).
