...
thf(aclsndisj_thm,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))) & ((cwcel @ XU @ XJ) & (cwcel @ XP @ XU))) => ((ccin @ XU @ XS) != cc0))))))))).
