...
thf(advcof_thm,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XT @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XY @ XX @ XG)) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => ((Xph => ((ccdm @ (cco @ XT @ XG @ ccdv)) = XY)) => (Xph => ((cco @ XT @ (cccom @ XF @ XG) @ ccdv) = (cco @ (cccom @ (cco @ XS @ XF @ ccdv) @ XG) @ (cco @ XT @ XG @ ccdv) @ (ccof @ ccmul)))))))))))))))))).
