...
thf(aiunxdif2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XC @ Xx3) = (XD @ Xy1))))) => ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (XC @ Xx3) @ (XD @ Xy1))) @ (^ [Xy1:$i] : (ccdif @ XA2 @ XB2)))) @ (^ [Xx3:$i] : XA2)) => ((cciun @ (^ [Xy1:$i] : (ccdif @ XA2 @ XB2)) @ (^ [Xy1:$i] : (XD @ Xy1))) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
