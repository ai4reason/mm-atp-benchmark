...
thf(acxpsqrtlem_thm,conjecture,(! [XA2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) & ((cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ cccxp) = (ccneg @ (ccfv @ XA2 @ ccsqrt)))) => (cwcel @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccr)))).
