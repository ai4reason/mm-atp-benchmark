...
thf(aasymref2_thm,conjecture,(! [XR:($i > $o)] : (((ccin @ XR @ (cccnv @ XR)) = (ccres @ ccid @ (ccuni @ (ccuni @ XR)))) <=> ((cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XR)) @ (^ [Xx3:$i] : (ccuni @ (ccuni @ XR)))) & (! [Xx3:$i] : (! [Xy1:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)) => ((ccv @ Xx3) = (ccv @ Xy1))))))))).
