...
thf(anmorepnf_thm,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XN = (cco @ XU @ XW @ ccnmoo)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv) & (cwf @ XX @ XY @ XT)) => ((cwcel @ (ccfv @ XT @ XN) @ ccr) <=> ((ccfv @ XT @ XN) != ccpnf))))))))))))).
