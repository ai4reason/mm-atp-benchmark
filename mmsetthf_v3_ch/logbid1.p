...
thf(aresqrtcn_thm,axiom,(cwcel @ (ccres @ ccsqrt @ (cco @ ccc0 @ ccpnf @ ccico)) @ (cco @ (cco @ ccc0 @ ccpnf @ ccico) @ ccr @ cccncf))).
thf(asqrtcn_thm,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccres @ ccsqrt @ XD) @ (cco @ XD @ ccc @ cccncf))))).
thf(acxpaddlelem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ cc1 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ XB2 @ cc1 @ ccle)) => (Xph => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cccxp) @ ccle))))))))))).
thf(acxpaddle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XB2 @ ccle)) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => (cwbr @ XC @ cc1 @ ccle)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cccxp) @ (cco @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XB2 @ XC @ cccxp) @ ccaddc) @ ccle))))))))))))).
thf(aabscxpbnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle)) => ((Xph => (cwcel @ XM @ ccr)) => ((Xph => (cwbr @ (ccfv @ XA2 @ ccabs) @ XM @ ccle)) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ ccabs) @ (cco @ (cco @ XM @ (ccfv @ XB2 @ ccre) @ cccxp) @ (ccfv @ (cco @ (ccfv @ XB2 @ ccabs) @ ccpi @ ccmul) @ cce) @ ccmul) @ ccle)))))))))))).
thf(aroot1id_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ XN @ ccexp) = cc1)))).
...
thf(aloglesqrt_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwbr @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ ccsqrt) @ ccle)))).
thf(alogreclem_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccrn @ cclog)) & (~ ((ccfv @ XA2 @ ccim) = ccpi))) => (cwcel @ (ccneg @ XA2) @ (ccrn @ cclog))))).
thf(alogrec_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & ((ccfv @ (ccfv @ XA2 @ cclog) @ ccim) != ccpi)) => ((ccfv @ XA2 @ cclog) = (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccdiv) @ cclog)))))).
...
thf(alogbcl_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => (cwcel @ (cco @ XB2 @ XX @ cclogb) @ ccc))))).
thf(alogbid1_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & (XA2 != cc1)) => ((cco @ XA2 @ XA2 @ cclogb) = cc1)))).
