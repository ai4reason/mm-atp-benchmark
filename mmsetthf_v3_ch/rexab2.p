...
thf(arexab2_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xy1)))) <=> (? [Xy1:$i] : ((Xph @ Xy1) & (Xch @ Xy1))))))))).
