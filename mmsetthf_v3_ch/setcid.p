...
thf(asetcid_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XU)) => (Xph => ((ccfv @ XX @ Xc_1) = (ccres @ ccid @ XX)))))))))))))).
