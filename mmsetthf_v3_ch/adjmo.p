...
thf(aadjmo_thm,conjecture,(! [XT:($i > $o)] : (cwmo @ (^ [Xu:$i] : ((cwf @ cchil @ cchil @ (ccv @ Xu)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccsp) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))))))).
