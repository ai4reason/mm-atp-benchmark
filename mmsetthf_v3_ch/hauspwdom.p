...
thf(allynlly_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ (cclly @ XA2)) => (cwcel @ XJ @ (ccnlly @ XA2)))))).
thf(allyssnlly_thm,axiom,(! [XA2:($i > $o)] : (cwss @ (cclly @ XA2) @ (ccnlly @ XA2)))).
thf(allyss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (cclly @ XA2) @ (cclly @ XB2)))))).
thf(anllyss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (ccnlly @ XA2) @ (ccnlly @ XB2)))))).
thf(asubislly_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ XB2 @ XV)) => ((cwcel @ (cco @ XJ @ XB2 @ ccrest) @ (cclly @ XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwss @ (ccin @ (ccv @ Xu) @ XB2) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)) & (cwcel @ (cco @ XJ @ (ccin @ (ccv @ Xu) @ XB2) @ ccrest) @ XA2))) @ (^ [Xu:$i] : XJ))) @ (^ [Xy1:$i] : (ccin @ (ccv @ Xx3) @ XB2)))) @ (^ [Xx3:$i] : XJ))))))))).
...
thf(arestlly_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xj)))) => (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ ccrest) @ XA2)))) => ((Xph => (cwss @ XA2 @ cctop)) => (Xph => (cwss @ XA2 @ (cclly @ XA2)))))))).
thf(aislly2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xj)))) => (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ ccrest) @ XA2)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XX @ Xx3 @ Xj) = (ccuni @ XJ)))) => (! [Xx3:$i] : (! [Xj:$i] : (Xph => ((cwcel @ XJ @ (cclly @ XA2)) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xu)) & (cwcel @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ XA2))) @ (^ [Xu:$i] : XJ))) @ (^ [Xy1:$i] : (XX @ Xx3 @ Xj))))))))))))))).
thf(allyrest_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ (cclly @ XA2)) & (cwcel @ XB2 @ XJ)) => (cwcel @ (cco @ XJ @ XB2 @ ccrest) @ (cclly @ XA2))))))).
thf(anllyrest_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ (ccnlly @ XA2)) & (cwcel @ XB2 @ XJ)) => (cwcel @ (cco @ XJ @ XB2 @ ccrest) @ (ccnlly @ XA2))))))).
thf(aloclly_thm,axiom,(! [XA2:($i > $o)] : (((cclly @ XA2) = XA2) <=> ((ccnlly @ XA2) = XA2)))).
thf(allyidm_thm,axiom,(! [XA2:($i > $o)] : ((cclly @ (cclly @ XA2)) = (cclly @ XA2)))).
thf(anllyidm_thm,axiom,(! [XA2:($i > $o)] : ((cclly @ (ccnlly @ XA2)) = (ccnlly @ XA2)))).
thf(atoplly_thm,axiom,((cclly @ cctop) = cctop)).
thf(atopnlly_thm,axiom,((ccnlly @ cctop) = cctop)).
thf(ahauslly_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccha) => (cwcel @ XJ @ (cclly @ ccha))))).
thf(ahausnlly_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccnlly @ ccha)) <=> (cwcel @ XJ @ (cclly @ ccha))))).
thf(ahausllycmp_thm,axiom,(! [XJ:($i > $o)] : (((cwcel @ XJ @ ccha) & (cwcel @ XJ @ cccmp)) => (cwcel @ XJ @ (ccnlly @ cccmp))))).
thf(acldllycmp_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ (ccnlly @ cccmp)) & (cwcel @ XA2 @ (ccfv @ XJ @ cccld))) => (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ (ccnlly @ cccmp)))))).
thf(ally1stc_thm,axiom,((cclly @ cc1stc) = cc1stc)).
thf(adislly_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((cwcel @ (ccpw @ XX) @ (cclly @ XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccpw @ (ccsn @ (ccv @ Xx3))) @ XA2)) @ (^ [Xx3:$i] : XX)))))))).
thf(adisllycmp_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwcel @ (ccpw @ XX) @ (cclly @ cccmp)))))).
thf(adis1stc_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwcel @ (ccpw @ XX) @ cc1stc))))).
thf(ahausmapdom_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccha) & (cwcel @ XJ @ cc1stc) & (cwss @ XA2 @ XX)) => (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (cco @ XA2 @ ccn @ ccmap) @ ccdom))))))).
thf(ahauspwdom_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ ccha) & (cwcel @ XJ @ cc1stc) & (cwss @ XA2 @ XX)) & ((cwbr @ XA2 @ (ccpw @ XB2) @ ccdom) & (cwbr @ ccn @ XB2 @ ccdom))) => (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccpw @ XB2) @ ccdom)))))))).
