...
thf(aresubmet_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : ((XR = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XJ = (ccfv @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XA2 @ XA2)) @ ccmopn)) => ((cwss @ XA2 @ ccr) => (XJ = (cco @ XR @ XA2 @ ccrest))))))))).
