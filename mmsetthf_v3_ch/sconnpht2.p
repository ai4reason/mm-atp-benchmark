...
thf(asconnpht2_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XJ @ ccsconn)) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((Xph => ((ccfv @ ccc0 @ XF) = (ccfv @ ccc0 @ XG))) => ((Xph => ((ccfv @ cc1 @ XF) = (ccfv @ cc1 @ XG))) => (Xph => (cwbr @ XF @ XG @ (ccfv @ XJ @ ccphtpc))))))))))))).
