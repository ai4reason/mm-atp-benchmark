...
thf(aefgmval_thm,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : ((XM @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (XA2 @ Xy1 @ Xz) @ XI) & (cwcel @ (XB2 @ Xy1 @ Xz) @ cc2o)) => ((cco @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xy1 @ Xz) @ (XM @ Xy1 @ Xz)) = (ccop @ (XA2 @ Xy1 @ Xz) @ (ccdif @ cc1o @ (XB2 @ Xy1 @ Xz))))))))))))).
