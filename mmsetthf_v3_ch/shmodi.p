...
thf(ashmodi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => ((((cco @ XA2 @ XB2 @ ccph) = (cco @ XA2 @ XB2 @ cchj)) & (cwss @ XA2 @ XC)) => (cwss @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ XC) @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ cchj)))))))))).
