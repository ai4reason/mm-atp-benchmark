...
thf(a_2cshw_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XW @ XM @ cccsh) @ XN @ cccsh) = (cco @ XW @ (cco @ XM @ XN @ ccaddc) @ cccsh)))))))).
