...
thf(ancvsm1_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => (((cwcel @ XW @ (ccin @ ccnvc @ cccvs)) & (cwcel @ XA2 @ XV)) => ((ccfv @ (cco @ (ccneg @ cc1) @ XA2 @ Xc_x) @ XN) = (ccfv @ XA2 @ XN)))))))))))).
