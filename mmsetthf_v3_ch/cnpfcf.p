...
thf(acnpfcf_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon)) & (cwcel @ XA2 @ XX)) => ((cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xf1:$i] : ((cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xf1) @ ccfcls)) => (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ XF @ (cco @ XK @ (ccv @ Xf1) @ ccfcf))))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))))))).
