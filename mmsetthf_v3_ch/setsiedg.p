...
thf(asetsiedg_thm,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ ccnx @ ccedgf)) => ((Xph => (cwbr @ XG @ XX @ ccstr)) => ((Xph => (cwcel @ (ccfv @ ccnx @ ccbs) @ (ccdm @ XG))) => ((Xph => (cwcel @ XE @ XW)) => (Xph => ((ccfv @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ cciedg) = XE))))))))))))).
