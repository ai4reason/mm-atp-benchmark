...
thf(a_2ebits_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ (cco @ cc2 @ XN @ ccexp) @ ccbits) = (ccsn @ XN))))).
thf(abitsinv_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xk:$i] : ((XK @ Xk) = (cccnv @ (ccres @ ccbits @ ccn0)))) => (! [Xk:$i] : ((cwcel @ XA2 @ (ccin @ (ccpw @ ccn0) @ ccfn)) => ((ccfv @ XA2 @ (XK @ Xk)) = (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ cc2 @ (ccv @ Xk) @ ccexp)))))))))).
...
thf(adf_sad_ax,axiom,(ccsad = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ ccn0))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ ccn0))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xk:$i] : (~ ((~ ((cwcel @ (ccv @ Xk) @ (ccv @ Xx3)) <=> (cwcel @ (ccv @ Xk) @ (ccv @ Xy1)))) <=> (cwcel @ cc0 @ (ccfv @ (ccv @ Xk) @ (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (((cwcel @ (ccv @ Xm) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xm) @ (ccv @ Xy1))) | ((cwcel @ cc0 @ (ccv @ Xc)) & (~ ((cwcel @ (ccv @ Xm) @ (ccv @ Xx3)) <=> (cwcel @ (ccv @ Xm) @ (ccv @ Xy1)))))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0)))))) @ (^ [Xk:$i] : ccn0))))))).
...
thf(asadcf_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (((cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) & (cwcel @ (ccv @ Xm) @ (XB2 @ Xn))) | ((cwcel @ cc0 @ (ccv @ Xc)) & (~ ((cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) <=> (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)))))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwf @ ccn0 @ cc2o @ (XC @ Xm @ Xn @ Xc)))))))))))))).
...
thf(asadcp1_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (((cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) & (cwcel @ (ccv @ Xm) @ (XB2 @ Xn))) | ((cwcel @ cc0 @ (ccv @ Xc)) & (~ ((cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) <=> (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)))))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XN @ Xm @ Xc) @ ccn0))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((cwcel @ cc0 @ (ccfv @ (cco @ (XN @ Xm @ Xc) @ cc1 @ ccaddc) @ (XC @ Xm @ Xn @ Xc))) <=> (((cwcel @ (XN @ Xm @ Xc) @ (XA2 @ Xn)) & (cwcel @ (XN @ Xm @ Xc) @ (XB2 @ Xn))) | ((cwcel @ cc0 @ (ccfv @ (XN @ Xm @ Xc) @ (XC @ Xm @ Xn @ Xc))) & (~ ((cwcel @ (XN @ Xm @ Xc) @ (XA2 @ Xn)) <=> (cwcel @ (XN @ Xm @ Xc) @ (XB2 @ Xn))))))))))))))))))))).
