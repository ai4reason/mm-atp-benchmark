...
thf(aacsfiindd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccacs))) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((XI = (ccfv @ XA2 @ ccmri)) => ((Xph => (cwss @ XS @ XX)) => (Xph => ((cwcel @ XS @ XI) <=> (cwss @ (ccin @ (ccpw @ XS) @ ccfn) @ XI)))))))))))))).
