...
thf(adfopab2_thm,conjecture,(! [Xph:($i > ($i > $o))] : ((ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) = (ccrab @ (^ [Xz:$i] : (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (ccfv @ (ccv @ Xz) @ cc2nd))) @ (ccfv @ (ccv @ Xz) @ cc1st))) @ (^ [Xz:$i] : (ccxp @ ccvv @ ccvv)))))).
