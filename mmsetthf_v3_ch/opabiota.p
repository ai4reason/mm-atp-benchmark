...
thf(aopabiota_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) = (ccsn @ (ccv @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XB2) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1))))) => ((cwcel @ XB2 @ (ccdm @ XF)) => ((ccfv @ XB2 @ XF) = (ccio @ (^ [Xy1:$i] : (Xps @ Xy1)))))))))))).
