...
thf(axaddid1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => (Xph => ((cco @ XA2 @ ccc0 @ ccxad) = XA2)))))).
thf(axnn0lenn0nn0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccxnn0) & (cwcel @ XN @ ccn0) & (cwbr @ XM @ XN @ ccle)) => (cwcel @ XM @ ccn0))))).
thf(axnn0le2is012_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccxnn0) & (cwbr @ XN @ cc2 @ ccle)) => ((XN = ccc0) | (XN = cc1) | (XN = cc2))))).
thf(axnn0xadd0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxnn0) & (cwcel @ XB2 @ ccxnn0)) => (((cco @ XA2 @ XB2 @ ccxad) = ccc0) <=> ((XA2 = ccc0) & (XB2 = ccc0))))))).
thf(axnegdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((ccxne @ (cco @ XA2 @ XB2 @ ccxad)) = (cco @ (ccxne @ XA2) @ (ccxne @ XB2) @ ccxad)))))).
...
thf(axaddass2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (XA2 != ccpnf)) & ((cwcel @ XB2 @ ccxr) & (XB2 != ccpnf)) & ((cwcel @ XC @ ccxr) & (XC != ccpnf))) => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxad) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxad))))))).
thf(axpncan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccr)) => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ (ccxne @ XB2) @ ccxad) = XA2))))).
thf(axnpcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccr)) => ((cco @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ XB2 @ ccxad) = XA2))))).
thf(axleadd1a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (cco @ XA2 @ XC @ ccxad) @ (cco @ XB2 @ XC @ ccxad) @ ccle)))))).
...
thf(axleadd1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XC @ ccxad) @ (cco @ XB2 @ XC @ ccxad) @ ccle))))))).
thf(axltadd1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ ccxad) @ (cco @ XB2 @ XC @ ccxad) @ cclt))))))).
thf(axltadd2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XC @ XA2 @ ccxad) @ (cco @ XC @ XB2 @ ccxad) @ cclt))))))).
...
thf(axsubge0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ ccc0 @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ ccle) <=> (cwbr @ XB2 @ XA2 @ ccle)))))).
thf(axposdif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ ccc0 @ (cco @ XB2 @ (ccxne @ XA2) @ ccxad) @ cclt)))))).
...
thf(axmullem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & (~ ((XA2 = ccc0) | (XB2 = ccc0)))) & (~ ((((cwbr @ ccc0 @ XB2 @ cclt) & (XA2 = ccpnf)) | ((cwbr @ XB2 @ ccc0 @ cclt) & (XA2 = ccmnf))) | (((cwbr @ ccc0 @ XA2 @ cclt) & (XB2 = ccpnf)) | ((cwbr @ XA2 @ ccc0 @ cclt) & (XB2 = ccmnf)))))) & (~ ((((cwbr @ ccc0 @ XB2 @ cclt) & (XA2 = ccmnf)) | ((cwbr @ XB2 @ ccc0 @ cclt) & (XA2 = ccpnf))) | (((cwbr @ ccc0 @ XA2 @ cclt) & (XB2 = ccmnf)) | ((cwbr @ XA2 @ ccc0 @ cclt) & (XB2 = ccpnf)))))) => (cwcel @ XA2 @ ccr))))).
thf(axmullem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => (((((cwbr @ ccc0 @ XB2 @ cclt) & (XA2 = ccpnf)) | ((cwbr @ XB2 @ ccc0 @ cclt) & (XA2 = ccmnf))) | (((cwbr @ ccc0 @ XA2 @ cclt) & (XB2 = ccpnf)) | ((cwbr @ XA2 @ ccc0 @ cclt) & (XB2 = ccmnf)))) => (~ ((((cwbr @ ccc0 @ XB2 @ cclt) & (XA2 = ccmnf)) | ((cwbr @ XB2 @ ccc0 @ cclt) & (XA2 = ccpnf))) | (((cwbr @ ccc0 @ XA2 @ cclt) & (XB2 = ccmnf)) | ((cwbr @ XA2 @ ccc0 @ cclt) & (XB2 = ccpnf)))))))))).
thf(axmulcom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccxmu) = (cco @ XB2 @ XA2 @ ccxmu)))))).
thf(axmul01_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ XA2 @ ccc0 @ ccxmu) = ccc0)))).
thf(axmul02_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ ccc0 @ XA2 @ ccxmu) = ccc0)))).
thf(axmulneg1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ (ccxne @ XA2) @ XB2 @ ccxmu) = (ccxne @ (cco @ XA2 @ XB2 @ ccxmu))))))).
...
thf(axmulcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => (cwcel @ (cco @ XA2 @ XB2 @ ccxmu) @ ccxr))))).
thf(axmulpnf1_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cco @ XA2 @ ccpnf @ ccxmu) = ccpnf)))).
thf(axmulpnf2_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cco @ ccpnf @ XA2 @ ccxmu) = ccpnf)))).
thf(axmulmnf1_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cco @ XA2 @ ccmnf @ ccxmu) = ccmnf)))).
thf(axmulmnf2_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cco @ ccmnf @ XA2 @ ccxmu) = ccmnf)))).
thf(axmulpnf1n_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwbr @ XA2 @ ccc0 @ cclt)) => ((cco @ XA2 @ ccpnf @ ccxmu) = ccmnf)))).
thf(axmulid1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ XA2 @ cc1 @ ccxmu) = XA2)))).
thf(axmulid2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ cc1 @ XA2 @ ccxmu) = XA2)))).
thf(axmulm1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ (ccneg @ cc1) @ XA2 @ ccxmu) = (ccxne @ XA2))))).
thf(axmulasslem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (((cwbr @ ccc0 @ XA2 @ cclt) & (XA2 = ccmnf)) => Xph)))).
thf(axmulgt0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccxr) & (cwbr @ ccc0 @ XB2 @ cclt))) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccxmu) @ cclt))))).
thf(axmulge0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ ccle)) & ((cwcel @ XB2 @ ccxr) & (cwbr @ ccc0 @ XB2 @ ccle))) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccxmu) @ ccle))))).
thf(axmulasslem_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XD) => ((Xps @ Xx3) <=> (XX = XY)))) => ((! [Xx3:$i] : (((ccv @ Xx3) = (ccxne @ XD)) => ((Xps @ Xx3) <=> (XE = XF)))) => ((Xph => (cwcel @ XX @ ccxr)) => ((Xph => (cwcel @ XY @ ccxr)) => ((Xph => (cwcel @ XD @ ccxr)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ ccxr) & (cwbr @ ccc0 @ (ccv @ Xx3) @ cclt))) => (Xps @ Xx3))) => ((! [Xx3:$i] : (Xph => (((ccv @ Xx3) = ccc0) => (Xps @ Xx3)))) => ((Xph => (XE = (ccxne @ XX))) => ((Xph => (XF = (ccxne @ XY))) => (Xph => (XX = XY))))))))))))))))))).
thf(axmulasslem3_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccxr) & (cwbr @ ccc0 @ XB2 @ cclt)) & ((cwcel @ XC @ ccxr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cco @ (cco @ XA2 @ XB2 @ ccxmu) @ XC @ ccxmu) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccxmu) @ ccxmu))))))).
