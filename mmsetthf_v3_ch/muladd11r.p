...
thf(amuladd11r_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ cc1 @ ccaddc) @ (cco @ XB2 @ cc1 @ ccaddc) @ ccmul) = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccaddc) @ cc1 @ ccaddc)))))).
