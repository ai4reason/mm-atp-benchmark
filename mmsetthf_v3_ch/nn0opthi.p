...
thf(ann0opthi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => (((cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccmul) @ XB2 @ ccaddc) = (cco @ (cco @ (cco @ XC @ XD @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccmul) @ XD @ ccaddc)) <=> ((XA2 = XC) & (XB2 = XD)))))))))))).
