...
thf(aomlsilem_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccsh) => ((cwcel @ XH @ ccsh) => ((cwss @ XG @ XH) => (((ccin @ XH @ (ccfv @ XG @ ccort)) = cc0h) => ((cwcel @ XA2 @ XH) => ((cwcel @ XB2 @ XG) => ((cwcel @ XC @ (ccfv @ XG @ ccort)) => ((XA2 = (cco @ XB2 @ XC @ ccva)) => (cwcel @ XA2 @ XG))))))))))))))).
