...
thf(advrec_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccdiv))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (ccneg @ (cco @ XA2 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccdiv)))))))).
