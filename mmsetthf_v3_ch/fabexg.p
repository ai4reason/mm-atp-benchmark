...
thf(afabexg_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (^ [Xx3:$i] : ((cwf @ XA2 @ XB2 @ (ccv @ Xx3)) & (Xph @ Xx3))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XC @ Xx3)) & (cwcel @ XB2 @ (XD @ Xx3))) => (cwcel @ (XF @ Xx3) @ ccvv))))))))))).
