...
thf(aresssetc_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((XD = (ccfv @ XV @ ccsetc)) => ((Xph => (cwcel @ XU @ XW)) => ((Xph => (cwss @ XV @ XU)) => (Xph => (((ccfv @ (cco @ XC @ XV @ ccress) @ cchomf) = (ccfv @ XD @ cchomf)) & ((ccfv @ (cco @ XC @ XV @ ccress) @ cccomf) = (ccfv @ XD @ cccomf))))))))))))))).
