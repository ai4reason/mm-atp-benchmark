...
thf(alogimcld_thm,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (XX != ccc0)) => (Xph => ((cwbr @ (ccneg @ ccpi) @ (ccfv @ (ccfv @ XX @ cclog) @ ccim) @ cclt) & (cwbr @ (ccfv @ (ccfv @ XX @ cclog) @ ccim) @ ccpi @ ccle)))))))).
