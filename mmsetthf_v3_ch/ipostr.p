...
thf(aipostr_thm,conjecture,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_pe:($i > $o)] : (cwbr @ (ccun @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ (ccop @ (ccfv @ ccnx @ ccoc) @ Xc_pe))) @ (ccop @ cc1 @ (ccdc @ cc1 @ cc1)) @ ccstr)))))).
