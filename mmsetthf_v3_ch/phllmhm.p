...
thf(aphllmhm_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccfv @ XW @ ccsca))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_xi))))) => (! [Xx3:$i] : (((cwcel @ XW @ ccphl) & (cwcel @ XA2 @ XV)) => (cwcel @ (XG @ Xx3) @ (cco @ XW @ (ccfv @ (XF @ Xx3) @ ccrglmod) @ cclmhm))))))))))))))).
