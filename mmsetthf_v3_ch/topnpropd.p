...
thf(adsndx_thm,axiom,((ccfv @ ccnx @ ccds) = (ccdc @ cc1 @ cc2))).
thf(adsid_thm,axiom,(ccds = (ccslot @ (ccfv @ ccnx @ ccds)))).
thf(aunifndx_thm,axiom,((ccfv @ ccnx @ ccunif) = (ccdc @ cc1 @ cc3))).
thf(aunifid_thm,axiom,(ccunif = (ccslot @ (ccfv @ ccnx @ ccunif)))).
...
thf(aodrngbas_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (cctp @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD)))) => ((cwcel @ XB2 @ XV) => (XB2 = (ccfv @ XW @ ccbs))))))))))))).
thf(aodrngplusg_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (cctp @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD)))) => ((cwcel @ Xc_pl @ XV) => (Xc_pl = (ccfv @ XW @ ccplusg))))))))))))).
thf(aodrngmulr_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (cctp @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD)))) => ((cwcel @ Xc_x @ XV) => (Xc_x = (ccfv @ XW @ ccmulr))))))))))))).
thf(aodrngtset_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (cctp @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD)))) => ((cwcel @ XJ @ XV) => (XJ = (ccfv @ XW @ ccts))))))))))))).
thf(aodrngle_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (cctp @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD)))) => ((cwcel @ Xc_le @ XV) => (Xc_le = (ccfv @ XW @ ccple))))))))))))).
thf(aodrngds_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (cctp @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD)))) => ((cwcel @ XD @ XV) => (XD = (ccfv @ XW @ ccds))))))))))))).
thf(aressds_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((XD = (ccfv @ XG @ ccds)) => ((cwcel @ XA2 @ XV) => (XD = (ccfv @ XH @ ccds))))))))))).
...
thf(aresshom_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XD = (cco @ XC @ XA2 @ ccress)) => ((XH = (ccfv @ XC @ cchom)) => ((cwcel @ XA2 @ XV) => (XH = (ccfv @ XD @ cchom))))))))))).
...
thf(adf_rest_ax,axiom,(ccrest = (ccmpt2 @ (^ [Xj:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xj:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xj:$i] : (^ [Xx3:$i] : (ccrn @ (ccmpt @ (^ [Xy1:$i] : (ccv @ Xj)) @ (^ [Xy1:$i] : (ccin @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))).
...
thf(atopnfn_thm,axiom,(cwfn @ cctopn @ ccvv)).
...
thf(a_0rest_thm,axiom,(! [XA2:($i > $o)] : ((cco @ cc0 @ XA2 @ ccrest) = cc0))).
thf(arestid2_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwss @ XJ @ (ccpw @ XA2))) => ((cco @ XJ @ XA2 @ ccrest) = XJ)))))).
...
thf(atopnid_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ ccts)) => ((cwss @ XJ @ (ccpw @ XB2)) => (XJ = (ccfv @ XW @ cctopn))))))))).
thf(atopnpropd_thm,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => ((ccfv @ XK @ ccbs) = (ccfv @ XL @ ccbs))) => ((Xph => ((ccfv @ XK @ ccts) = (ccfv @ XL @ ccts))) => (Xph => ((ccfv @ XK @ cctopn) = (ccfv @ XL @ cctopn))))))))).
