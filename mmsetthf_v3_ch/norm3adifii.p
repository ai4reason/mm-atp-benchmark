...
thf(anorm3adifii_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => (cwbr @ (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmv) @ ccno) @ (ccfv @ (cco @ XB2 @ XC @ ccmv) @ ccno) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ ccle)))))))).
