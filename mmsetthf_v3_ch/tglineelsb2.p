...
thf(atglineelsb2_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XP @ XB2)) => ((Xph => (cwcel @ XQ @ XB2)) => ((Xph => (XP != XQ)) => ((Xph => (cwcel @ XS @ XB2)) => ((Xph => (XS != XP)) => ((Xph => (cwcel @ XS @ (cco @ XP @ XQ @ XL))) => (Xph => ((cco @ XP @ XQ @ XL) = (cco @ XP @ XS @ XL)))))))))))))))))))))).
