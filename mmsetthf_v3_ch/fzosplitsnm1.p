...
thf(afzosplitsnm1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccuz))) => ((cco @ XA2 @ XB2 @ ccfzo) = (ccun @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ ccfzo) @ (ccsn @ (cco @ XB2 @ cc1 @ ccmin)))))))).
