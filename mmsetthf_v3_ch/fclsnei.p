...
thf(afclsnei_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xn:$i] : (((cwcel @ XJ @ (ccfv @ (XX @ Xn) @ cctopon)) & (cwcel @ XF @ (ccfv @ (XX @ Xn) @ ccfil))) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) <=> ((cwcel @ XA2 @ (XX @ Xn)) & (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xs1:$i] : ((ccin @ (ccv @ Xn) @ (ccv @ Xs1)) != cc0)) @ (^ [Xs1:$i] : XF))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei))))))))))))).
