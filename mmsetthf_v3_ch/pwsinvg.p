...
thf(apwsinvg_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XM = (ccfv @ XR @ ccminusg)) => ((XN = (ccfv @ XY @ ccminusg)) => (((cwcel @ XR @ ccgrp) & (cwcel @ XI @ XV) & (cwcel @ XX @ XB2)) => ((ccfv @ XX @ XN) = (cccom @ XM @ XX)))))))))))))))).
