...
thf(ar0weon_thm,conjecture,(! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XR @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (((cwcel @ (ccv @ Xz) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xw) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) | (((ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) = (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) & (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XL @ Xx3 @ Xy1))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwwe @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)) & (cwse @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
