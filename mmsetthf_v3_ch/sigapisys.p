...
thf(asigapisys_thm,conjecture,(! [XP:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xs1:$i] : ((XP @ Xs1) = (ccrab @ (^ [Xs1:$i] : (cwss @ (ccfv @ (ccv @ Xs1) @ ccfi) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ XO)))))) => (! [Xs1:$i] : (cwss @ (ccfv @ XO @ ccsiga) @ (XP @ Xs1))))))).
