...
thf(axaddval_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccxad) = (ccif @ (XA2 = ccpnf) @ (ccif @ (XB2 = ccmnf) @ ccc0 @ ccpnf) @ (ccif @ (XA2 = ccmnf) @ (ccif @ (XB2 = ccpnf) @ ccc0 @ ccmnf) @ (ccif @ (XB2 = ccpnf) @ ccpnf @ (ccif @ (XB2 = ccmnf) @ ccmnf @ (cco @ XA2 @ XB2 @ ccaddc)))))))))).
