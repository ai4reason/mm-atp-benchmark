...
thf(a_4fvwrd4_thm,axiom,(! [XP:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (((cwcel @ (XL @ Xa @ Xb @ Xc @ Xd) @ (ccfv @ cc3 @ ccuz)) & (cwf @ (cco @ ccc0 @ (XL @ Xa @ Xb @ Xc @ Xd) @ ccfz) @ XV @ XP)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : ((((ccfv @ ccc0 @ XP) = (ccv @ Xa)) & ((ccfv @ cc1 @ XP) = (ccv @ Xb))) & (((ccfv @ cc2 @ XP) = (ccv @ Xc)) & ((ccfv @ cc3 @ XP) = (ccv @ Xd))))) @ (^ [Xd:$i] : XV))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))))).
thf(a_2ffzeq_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xi:$i] : (((cwcel @ XM @ ccn0) & (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (XX @ Xi) @ XF) & (cwf @ (cco @ ccc0 @ (XN @ Xi) @ ccfz) @ (XY @ Xi) @ XP)) => ((XF = XP) <=> ((XM = (XN @ Xi)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XF) = (ccfv @ (ccv @ Xi) @ XP))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))))))).
thf(apreduz_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((ccpred @ (ccfv @ XM @ ccuz) @ cclt @ XN) = (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))))).
thf(aprednn_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccpred @ ccn @ cclt @ XN) = (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))).
thf(aprednn0_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccpred @ ccn0 @ cclt @ XN) = (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))).
thf(apredfz_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) => ((ccpred @ (cco @ XM @ XN @ ccfz) @ cclt @ XK) = (cco @ XM @ (cco @ XK @ cc1 @ ccmin) @ ccfz))))))).
thf(ccfzo_tp,type,(ccfzo : ($i > $o))).
thf(adf_fzo_ax,axiom,(ccfzo = (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xm:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xm:$i] : (^ [Xn:$i] : (cco @ (ccv @ Xm) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccfz)))))).
thf(afzof_thm,axiom,(cwf @ (ccxp @ ccz @ ccz) @ (ccpw @ ccz) @ ccfzo)).
...
thf(aelfzo_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) <=> ((cwbr @ XM @ XK @ ccle) & (cwbr @ XK @ XN @ cclt)))))))).
...
thf(anelfzo_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((~ (wnel @ XK @ (cco @ XM @ XN @ ccfzo))) <=> ((cwbr @ XK @ XM @ cclt) | (cwbr @ XN @ XK @ ccle)))))))).
thf(afzolb_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ (cco @ XM @ XN @ ccfzo)) <=> ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (cwbr @ XM @ XN @ cclt)))))).
thf(afzolb2_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwcel @ XM @ (cco @ XM @ XN @ ccfzo)) <=> (cwbr @ XM @ XN @ cclt)))))).
...
thf(aelfzolt3_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwbr @ XM @ XN @ cclt)))))).
thf(aelfzolt2b_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwcel @ XK @ (cco @ XK @ XN @ ccfzo))))))).
thf(aelfzolt3b_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwcel @ XM @ (cco @ XM @ XN @ ccfzo))))))).
...
thf(aelfzo3_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) <=> ((cwcel @ XK @ (ccfv @ XM @ ccuz)) & (cwcel @ XK @ (cco @ XK @ XN @ ccfzo)))))))).
...
thf(afzon_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XN @ XM @ ccle) <=> ((cco @ XM @ XN @ ccfzo) = cc0)))))).
thf(afzo0n_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XN @ XM @ ccle) <=> ((cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo) = cc0)))))).
thf(afzonlt0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((~ (cwbr @ XM @ XN @ cclt)) <=> ((cco @ XM @ XN @ ccfzo) = cc0)))))).
thf(afzo0_thm,axiom,(! [XA2:($i > $o)] : ((cco @ XA2 @ XA2 @ ccfzo) = cc0))).
thf(afzonnsub_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwcel @ (cco @ XN @ XK @ ccmin) @ ccn)))))).
thf(afzonnsub2_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwcel @ (cco @ XN @ XM @ ccmin) @ ccn)))))).
...
thf(afzossnn0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccn0) => (cwss @ (cco @ XM @ XN @ ccfzo) @ ccn0))))).
...
thf(afzosplit_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XD @ (cco @ XB2 @ XC @ ccfz)) => ((cco @ XB2 @ XC @ ccfzo) = (ccun @ (cco @ XB2 @ XD @ ccfzo) @ (cco @ XD @ XC @ ccfzo)))))))).
thf(afzodisj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccin @ (cco @ XA2 @ XB2 @ ccfzo) @ (cco @ XB2 @ XC @ ccfzo)) = cc0))))).
...
thf(afzoun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) & (cwcel @ XC @ ccn0)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo) = (ccun @ (cco @ XA2 @ XB2 @ ccfzo) @ (cco @ XB2 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo)))))))).
thf(afzodisjsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccin @ (cco @ XA2 @ XB2 @ ccfzo) @ (ccsn @ XB2)) = cc0)))).
thf(aprinfzo0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => ((ccin @ (ccpr @ XM @ XN) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfzo)) = cc0))))).
...
thf(aelfzo0z_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)) <=> ((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccz) & (cwbr @ XA2 @ XB2 @ cclt)))))).
...
thf(aelfzo0le_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)) => (cwbr @ XA2 @ XB2 @ ccle))))).
thf(aelfzonn0_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfzo)) => (cwcel @ XK @ ccn0))))).
thf(afzonmapblen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XB2 @ (cco @ ccc0 @ XN @ ccfzo)) & (cwbr @ XB2 @ XA2 @ cclt)) => (cwbr @ (cco @ XB2 @ (cco @ XN @ XA2 @ ccmin) @ ccaddc) @ XN @ cclt)))))).
thf(afzofzim_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (((XK != XM) & (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfz))) => (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfzo)))))).
