...
thf(asqrlem7_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2 @ ccle)) @ (^ [Xx3:$i] : ccrp)))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XB2 @ Xx3 @ Xa @ Xb) = (ccsup @ (XS @ Xx3) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XT @ Xx3 @ Xy1 @ Xa @ Xb) = (^ [Xy1:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((ccv @ Xy1) = (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccmul))) @ (^ [Xb:$i] : (XS @ Xx3)))) @ (^ [Xa:$i] : (XS @ Xx3))))))))) => (! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XA2 @ ccrp) & (cwbr @ XA2 @ cc1 @ ccle)) => ((cco @ (XB2 @ Xx3 @ Xa @ Xb) @ cc2 @ ccexp) = XA2))))))))))))).
