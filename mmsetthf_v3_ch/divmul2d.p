...
thf(adivmul2d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (XC != ccc0)) => (Xph => (((cco @ XA2 @ XC @ ccdiv) = XB2) <=> (XA2 = (cco @ XC @ XB2 @ ccmul))))))))))))).
