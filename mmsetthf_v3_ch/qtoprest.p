...
thf(aqtoprest_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwfo @ XX @ XY @ XF)) => ((Xph => (cwss @ XU @ XY)) => ((Xph => (XA2 = (ccima @ (cccnv @ XF) @ XU))) => ((Xph => ((cwcel @ XA2 @ XJ) | (cwcel @ XA2 @ (ccfv @ XJ @ cccld)))) => (Xph => ((cco @ (cco @ XJ @ XF @ ccqtop) @ XU @ ccrest) = (cco @ (cco @ XJ @ XA2 @ ccrest) @ (ccres @ XF @ XA2) @ ccqtop)))))))))))))))).
