...
thf(aiota2d_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (XV @ Xx3)))) => ((Xph => (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XB2)) => ((Xps @ Xx3) <=> Xch))) => (Xph => (Xch <=> ((ccio @ (^ [Xx3:$i] : (Xps @ Xx3))) = XB2)))))))))))).
thf(aiota2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3)) & (cweu @ (^ [Xx3:$i] : (Xph @ Xx3)))) => (Xps <=> ((ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) = XA2)))))))))).
thf(asniota_thm,axiom,(! [Xph:($i > $o)] : ((cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((^ [Xx3:$i] : (Xph @ Xx3)) = (ccsn @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3)))))))).
thf(adfiota4_thm,axiom,(! [Xph:($i > $o)] : ((ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) = (ccif @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccuni @ (^ [Xx3:$i] : (Xph @ Xx3))) @ cc0)))).
thf(adfiota4OLD_thm,axiom,(! [Xph:($i > $o)] : ((ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) = (ccif @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccuni @ (^ [Xx3:$i] : (Xph @ Xx3))) @ cc0)))).
thf(acsbiota_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccio @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) = (ccio @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (XA2 @ Xx3))))))))).
...
thf(adffun2_thm,axiom,(! [XA2:($i > $o)] : ((cwfun @ XA2) <=> ((cwrel @ XA2) & (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XA2)) => ((ccv @ Xy1) = (ccv @ Xz)))))))))).
thf(adffun3_thm,axiom,(! [XA2:($i > $o)] : ((cwfun @ XA2) <=> ((cwrel @ XA2) & (! [Xx3:$i] : (? [Xz:$i] : (! [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) => ((ccv @ Xy1) = (ccv @ Xz)))))))))).
...
thf(adffun6f_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwfun @ (XA2 @ Xx3 @ Xy1)) <=> ((cwrel @ (XA2 @ Xx3 @ Xy1)) & (! [Xx3:$i] : (cwmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XA2 @ Xx3 @ Xy1))))))))))))).
...
thf(a_0nelfun_thm,axiom,(! [XR:($i > $o)] : ((cwfun @ XR) => (~ (wnel @ cc0 @ XR))))).
...
thf(anffun_thm,axiom,(! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((? [X:$i] : ((^ [Xx3:$i] : (cwfun @ (XF @ Xx3))) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (cwfun @ (XF @ Xx3))) @ X)))))).
thf(asbcfung_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) => ((cwsbc @ (^ [Xx3:$i] : (cwfun @ (XF @ Xx3))) @ (XA2 @ Xx3)) <=> (cwfun @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XF @ Xx3))))))))))).
thf(afuneu_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xy1:$i] : (((cwfun @ XF) & (cwbr @ XA2 @ (XB2 @ Xy1) @ XF)) => (cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF))))))))).
thf(afuneu2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xy1:$i] : (((cwfun @ XF) & (cwcel @ (ccop @ XA2 @ (XB2 @ Xy1)) @ XF)) => (cweu @ (^ [Xy1:$i] : (cwcel @ (ccop @ XA2 @ (ccv @ Xy1)) @ XF))))))))).
thf(adffun7_thm,axiom,(! [XA2:($i > $o)] : ((cwfun @ XA2) <=> ((cwrel @ XA2) & (cwral @ (^ [Xx3:$i] : (cwmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2)))) @ (^ [Xx3:$i] : (ccdm @ XA2))))))).
thf(adffun8_thm,axiom,(! [XA2:($i > $o)] : ((cwfun @ XA2) <=> ((cwrel @ XA2) & (cwral @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2)))) @ (^ [Xx3:$i] : (ccdm @ XA2))))))).
thf(adffun9_thm,axiom,(! [XA2:($i > $o)] : ((cwfun @ XA2) <=> ((cwrel @ XA2) & (cwral @ (^ [Xx3:$i] : (cwrmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2)) @ (^ [Xy1:$i] : (ccrn @ XA2)))) @ (^ [Xx3:$i] : (ccdm @ XA2))))))).
...
thf(anfunv_thm,axiom,(~ (cwfun @ ccvv))).
thf(afunopg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwfun @ (ccop @ XA2 @ XB2))) => (XA2 = XB2))))))).
...
thf(afununmo_thm,axiom,(! [Xx3:$i] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwfun @ (ccun @ XF @ XG)) => (cwmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF)))))))).
thf(afununfun_thm,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwfun @ (ccun @ XF @ XG)) => ((cwfun @ XF) & (cwfun @ XG)))))).
