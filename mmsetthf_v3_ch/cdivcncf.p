...
thf(acdivcncf_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccdiv))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ ccc) => (cwcel @ (XF @ Xx3) @ (cco @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccc @ cccncf)))))))).
