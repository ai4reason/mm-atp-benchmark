...
thf(asxsigon_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => (cwcel @ (cco @ XS @ XT @ ccsx) @ (ccfv @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT)) @ ccsiga)))))).
