...
thf(aisprm6_thm,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) <=> ((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ XP @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ ccdvds) => ((cwbr @ XP @ (ccv @ Xx3) @ ccdvds) | (cwbr @ XP @ (ccv @ Xy1) @ ccdvds)))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))).
