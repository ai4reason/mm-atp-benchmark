...
thf(atgpconncompeqg_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XJ = (ccfv @ XG @ cctopn)) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccuni @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ Xc_0 @ (ccv @ Xx3)) & (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccconn))) @ (^ [Xx3:$i] : (ccpw @ XX)))))) => ((! [Xx3:$i] : ((Xc_sm @ Xx3) = (cco @ XG @ (XS @ Xx3) @ ccqg))) => (! [Xx3:$i] : (((cwcel @ XG @ cctgp) & (cwcel @ XA2 @ XX)) => ((ccec @ XA2 @ (Xc_sm @ Xx3)) = (ccuni @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) & (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccconn))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))))))))))))))).
