...
thf(aclsval2_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ XS @ (ccfv @ XJ @ cccl)) = (ccdif @ XX @ (ccfv @ (ccdif @ XX @ XS) @ (ccfv @ XJ @ ccnt)))))))))).
thf(antrval2_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ XS @ (ccfv @ XJ @ ccnt)) = (ccdif @ XX @ (ccfv @ (ccdif @ XX @ XS) @ (ccfv @ XJ @ cccl)))))))))).
thf(antrdif_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ ccnt)) = (ccdif @ XX @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)))))))))).
thf(aclsdif_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ cccl)) = (ccdif @ XX @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)))))))))).
...
thf(antrss_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & (cwss @ XT @ XS)) => (cwss @ (ccfv @ XT @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)))))))))).
...
thf(antrss3_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => (cwss @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ XX))))))).
thf(antrin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX) & (cwss @ XB2 @ XX)) => ((ccfv @ (ccin @ XA2 @ XB2) @ (ccfv @ XJ @ ccnt)) = (ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XB2 @ (ccfv @ XJ @ ccnt))))))))))).
thf(acmclsopn_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => (cwcel @ (ccdif @ XX @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) @ XJ))))))).
thf(acmntrcld_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => (cwcel @ (ccdif @ XX @ (ccfv @ XS @ (ccfv @ XJ @ ccnt))) @ (ccfv @ XJ @ cccld)))))))).
...
thf(aclsidm_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XJ @ cccl)) = (ccfv @ XS @ (ccfv @ XJ @ cccl))))))))).
thf(antridm_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XJ @ ccnt)) = (ccfv @ XS @ (ccfv @ XJ @ ccnt))))))))).
thf(aclstop_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XX @ (ccfv @ XJ @ cccl)) = XX)))))).
thf(antrtop_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XX @ (ccfv @ XJ @ ccnt)) = XX)))))).
thf(a_0ntr_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ cctop) & (XX != cc0)) & ((cwss @ XS @ XX) & ((ccfv @ XS @ (ccfv @ XJ @ ccnt)) = cc0))) => ((ccdif @ XX @ XS) != cc0))))))).
...
thf(aelcls_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & (cwcel @ XP @ XX)) => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) => ((ccin @ (ccv @ Xx3) @ XS) != cc0))) @ (^ [Xx3:$i] : XJ)))))))))).
thf(aelcls2_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) <=> ((cwcel @ XP @ XX) & (cwral @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) => ((ccin @ (ccv @ Xx3) @ XS) != cc0))) @ (^ [Xx3:$i] : XJ))))))))))).
...
thf(antrcls0_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & ((ccfv @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XJ @ ccnt)) = cc0)) => ((ccfv @ XS @ (ccfv @ XJ @ ccnt)) = cc0))))))).
thf(antreq0_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => (((ccfv @ XS @ (ccfv @ XJ @ ccnt)) = cc0) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XS) => ((ccv @ Xx3) = cc0))) @ (^ [Xx3:$i] : XJ))))))))).
thf(acldmre_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => (cwcel @ (ccfv @ XJ @ cccld) @ (ccfv @ XX @ ccmre))))))).
thf(amrccls_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((XF = (ccfv @ (ccfv @ XJ @ cccld) @ ccmrc)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ cccl) = XF)))))).
thf(acls0_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((ccfv @ cc0 @ (ccfv @ XJ @ cccl)) = cc0)))).
thf(antr0_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((ccfv @ cc0 @ (ccfv @ XJ @ ccnt)) = cc0)))).
...
thf(aopncldf2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((! [Xu:$i] : ((XF @ Xu) = (ccmpt @ (^ [Xu:$i] : XJ) @ (^ [Xu:$i] : (ccdif @ XX @ (ccv @ Xu)))))) => (! [Xu:$i] : (((cwcel @ XJ @ cctop) & (cwcel @ XA2 @ XJ)) => ((ccfv @ XA2 @ (XF @ Xu)) = (ccdif @ XX @ XA2))))))))))).
thf(aopncldf3_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((! [Xu:$i] : ((XF @ Xu) = (ccmpt @ (^ [Xu:$i] : XJ) @ (^ [Xu:$i] : (ccdif @ XX @ (ccv @ Xu)))))) => (! [Xu:$i] : ((cwcel @ (XB2 @ Xu) @ (ccfv @ XJ @ cccld)) => ((ccfv @ (XB2 @ Xu) @ (cccnv @ (XF @ Xu))) = (ccdif @ XX @ (XB2 @ Xu)))))))))))).
thf(aisclo_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ (ccin @ XJ @ (ccfv @ XJ @ cccld))) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) <=> (cwcel @ (ccv @ Xz) @ XA2))) @ (^ [Xz:$i] : (ccv @ Xy1))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XX))))))))).
thf(aisclo2_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ (ccin @ XJ @ (ccfv @ XJ @ cccld))) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XA2) => (cwss @ (ccv @ Xy1) @ XA2))) @ (^ [Xz:$i] : (ccv @ Xy1))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XX))))))))).
thf(adiscld_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ (ccpw @ XA2) @ cccld) = (ccpw @ XA2)))))).
thf(asn0cld_thm,axiom,((ccfv @ (ccsn @ cc0) @ cccld) = (ccsn @ cc0))).
thf(aindiscld_thm,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccpr @ cc0 @ XA2) @ cccld) = (ccpr @ cc0 @ XA2)))).
thf(amretopd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XB2 @ ccmre))) => ((Xph => (cwcel @ cc0 @ XM)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XM) & (cwcel @ (ccv @ Xy1) @ XM)) => (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XM)))) => ((! [Xz:$i] : ((XJ @ Xz) = (ccrab @ (^ [Xz:$i] : (cwcel @ (ccdif @ XB2 @ (ccv @ Xz)) @ XM)) @ (^ [Xz:$i] : (ccpw @ XB2))))) => (! [Xz:$i] : (Xph => ((cwcel @ (XJ @ Xz) @ (ccfv @ XB2 @ cctopon)) & (XM = (ccfv @ (XJ @ Xz) @ cccld)))))))))))))).
thf(atoponmre_thm,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => (cwcel @ (ccfv @ XB2 @ cctopon) @ (ccfv @ (ccpw @ XB2) @ ccmre)))))).
thf(acldmreon_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XB2 @ cctopon)) => (cwcel @ (ccfv @ XJ @ cccld) @ (ccfv @ XB2 @ ccmre)))))).
thf(aiscldtop_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : ((cwcel @ XK @ (ccima @ cccld @ (ccfv @ XB2 @ cctopon))) <=> ((cwcel @ XK @ (ccfv @ XB2 @ ccmre)) & (cwcel @ cc0 @ XK) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XK)) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XK))))))).
thf(amreclatdemoBAD_thm,axiom,(! [XW:($i > $o)] : (((cwcel @ (ccin @ (ccfv @ XW @ cclss) @ (ccfv @ (ccfv @ XW @ cctopn) @ cccld)) @ (ccfv @ (ccuni @ (ccfv @ XW @ cctopn)) @ ccmre)) => (cwcel @ (ccfv @ (ccin @ (ccfv @ XW @ cclss) @ (ccfv @ (ccfv @ XW @ cctopn) @ cccld)) @ ccipo) @ cccla)) => ((cwcel @ XW @ (ccin @ cctps @ cclmod)) => (cwcel @ (ccfv @ (ccin @ (ccfv @ XW @ cclss) @ (ccfv @ (ccfv @ XW @ cctopn) @ cccld)) @ ccipo) @ cccla))))).
thf(ccnei_tp,type,(ccnei : ($i > $o))).
thf(adf_nei_ax,axiom,(ccnei = (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xj)))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xg1:$i] : ((cwss @ (ccv @ Xx3) @ (ccv @ Xg1)) & (cwss @ (ccv @ Xg1) @ (ccv @ Xy1)))) @ (^ [Xg1:$i] : (ccv @ Xj)))) @ (^ [Xy1:$i] : (ccpw @ (ccuni @ (ccv @ Xj))))))))))).
thf(aneifval_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ ccnei) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : ((cwss @ (ccv @ Xx3) @ (ccv @ Xg1)) & (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX))))))))))).
thf(aneif_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => (cwfn @ (ccfv @ XJ @ ccnei) @ (ccpw @ XX))))))).
thf(aneiss2_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))) => (cwss @ XS @ XX)))))))).
thf(aneival_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ XS @ (ccfv @ XJ @ ccnei)) = (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : ((cwss @ XS @ (ccv @ Xg1)) & (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX)))))))))).
thf(aisnei_thm,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) <=> ((cwss @ XN @ XX) & (cwrex @ (^ [Xg1:$i] : ((cwss @ XS @ (ccv @ Xg1)) & (cwss @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : XJ))))))))))).
