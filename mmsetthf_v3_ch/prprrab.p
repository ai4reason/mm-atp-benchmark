...
thf(aprprrab_thm,conjecture,(! [XA2:($i > ($i > $o))] : ((ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ (XA2 @ Xx3)) @ (ccsn @ cc0)))) = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xx3))))))).
