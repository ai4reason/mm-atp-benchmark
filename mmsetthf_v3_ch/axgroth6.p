...
thf(aaxgroth6_thm,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)) & (cwcel @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccsdm) => (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xy1)))))))).
