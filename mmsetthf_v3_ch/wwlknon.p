...
thf(awwlknon_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon))) <=> ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) & ((ccfv @ ccc0 @ XW) = XA2) & ((ccfv @ XN @ XW) = XB2))))))))).
