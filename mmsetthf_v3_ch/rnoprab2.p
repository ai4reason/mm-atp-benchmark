...
thf(arnoprab2_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : ((ccrn @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xz))) & (Xph @ Xx3 @ Xy1 @ Xz))))))) = (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz))))))))).
