...
thf(aflffbas_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XY @ XB2 @ ccfg)) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) & (cwf @ XY @ XX @ XF)) => ((cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) <=> ((cwcel @ XA2 @ XX) & (cwral @ (^ [Xo:$i] : ((cwcel @ XA2 @ (ccv @ Xo)) => (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xo))) @ (^ [Xs1:$i] : XB2)))) @ (^ [Xo:$i] : XJ)))))))))))))).
