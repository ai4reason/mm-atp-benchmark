...
thf(aissubrg3_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((cwcel @ XR @ ccrg) => ((cwcel @ XS @ (ccfv @ XR @ ccsubrg)) <=> ((cwcel @ XS @ (ccfv @ XR @ ccsubg)) & (cwcel @ XS @ (ccfv @ XM @ ccsubmnd)))))))))).
