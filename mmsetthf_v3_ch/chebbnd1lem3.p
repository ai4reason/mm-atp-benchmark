...
thf(achebbnd1lem3_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl)) => (((cwcel @ XN @ ccr) & (cwbr @ cc8 @ XN @ ccle)) => (cwbr @ (cco @ (cco @ (ccfv @ cc2 @ cclog) @ (cco @ cc1 @ (cco @ cc2 @ cceu @ ccmul) @ ccdiv) @ ccmin) @ cc2 @ ccdiv) @ (cco @ (ccfv @ XN @ ccppi) @ (cco @ (ccfv @ XN @ cclog) @ XN @ ccdiv) @ ccmul) @ cclt)))))).
