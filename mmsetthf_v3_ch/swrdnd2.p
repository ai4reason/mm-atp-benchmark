...
thf(aswrdnd2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (((cwbr @ XB2 @ XA2 @ ccle) | (cwbr @ (ccfv @ XW @ cchash) @ XA2 @ ccle) | (cwbr @ XB2 @ ccc0 @ ccle)) => ((cco @ XW @ (ccop @ XA2 @ XB2) @ ccsubstr) = cc0)))))))).
