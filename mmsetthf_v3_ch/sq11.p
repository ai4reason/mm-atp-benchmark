...
thf(asq11_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ ccle))) => (((cco @ XA2 @ cc2 @ ccexp) = (cco @ XB2 @ cc2 @ ccexp)) <=> (XA2 = XB2)))))).
