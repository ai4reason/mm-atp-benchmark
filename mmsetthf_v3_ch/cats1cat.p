...
thf(acats1cat_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : ((XT = (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwcel @ XA2 @ (ccword @ ccvv)) => ((cwcel @ XS @ (ccword @ ccvv)) => ((XC = (cco @ XB2 @ (ccs1 @ XX) @ ccconcat)) => ((XB2 = (cco @ XA2 @ XS @ ccconcat)) => (XC = (cco @ XA2 @ XT @ ccconcat)))))))))))))).
