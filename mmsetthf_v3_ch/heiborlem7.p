...
thf(aisbndx_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
thf(aisbnd2_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccbnd)) & (XX != cc0)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
...
thf(aisbnd3b_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))).
thf(abndss_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccbnd)) & (cwss @ XS @ XX)) => (cwcel @ (ccres @ XM @ (ccxp @ XS @ XS)) @ (ccfv @ XS @ ccbnd))))))).
thf(ablbnd_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XY @ XX) & (cwcel @ XR @ ccr)) => (cwcel @ (ccres @ XM @ (ccxp @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)))) @ (ccfv @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ ccbnd)))))))).
thf(assbnd_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccres @ XM @ (ccxp @ XY @ XY))) => (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwcel @ XP @ XX)) => ((cwcel @ XN @ (ccfv @ XY @ ccbnd)) <=> (cwrex @ (^ [Xd:$i] : (cwss @ XY @ (cco @ XP @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xd:$i] : ccr))))))))))).
...
thf(aprdsbnd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccres @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : ((XD @ Xx3) = (ccfv @ XY @ ccds))) => ((! [Xx3:$i] : (Xph => (cwcel @ XS @ (XW @ Xx3)))) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwfn @ XR @ XI)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ ccbnd)))) => (! [Xx3:$i] : (Xph => (cwcel @ (XD @ Xx3) @ (ccfv @ XB2 @ ccbnd)))))))))))))))))))))))).
thf(aprdstotbnd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccres @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : ((XD @ Xx3) = (ccfv @ XY @ ccds))) => ((! [Xx3:$i] : (Xph => (cwcel @ XS @ (XW @ Xx3)))) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwfn @ XR @ XI)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ cctotbnd)))) => (! [Xx3:$i] : (Xph => (cwcel @ (XD @ Xx3) @ (ccfv @ XB2 @ cctotbnd)))))))))))))))))))))))).
thf(aprdsbnd2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > $o))] : ((! [Xy1:$i] : ((XY @ Xy1) = (cco @ (XS @ Xy1) @ XR @ ccprds))) => ((! [Xy1:$i] : (XB2 = (ccfv @ (XY @ Xy1) @ ccbs))) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccres @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3) = (ccfv @ (XY @ Xy1) @ ccds)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XS @ Xy1) @ (XW @ Xx3 @ Xy1))))) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwfn @ XR @ XI)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xx3 @ Xy1) = (ccres @ (XD @ Xx3) @ (ccxp @ (XA2 @ Xx3 @ Xy1) @ (XA2 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ ccme)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => ((cwcel @ (ccres @ (XE @ Xx3) @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (ccfv @ (ccv @ Xy1) @ cctotbnd)) <=> (cwcel @ (ccres @ (XE @ Xx3) @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (ccfv @ (ccv @ Xy1) @ ccbnd)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cwcel @ (XC @ Xx3 @ Xy1) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ cctotbnd)) <=> (cwcel @ (XC @ Xx3 @ Xy1) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccbnd)))))))))))))))))))))))))))))).
thf(acntotbnd_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XX @ XX))) => ((cwcel @ XD @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XD @ (ccfv @ XX @ ccbnd))))))).
...
thf(adf_ismty_ax,axiom,(ccismty = (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : (ccuni @ (ccrn @ ccxmt)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccuni @ (ccrn @ ccxmt)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (^ [Xf1:$i] : ((cwf1o @ (ccdm @ (ccdm @ (ccv @ Xm))) @ (ccdm @ (ccdm @ (ccv @ Xn))) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xm)) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xn)))) @ (^ [Xy1:$i] : (ccdm @ (ccdm @ (ccv @ Xm)))))) @ (^ [Xx3:$i] : (ccdm @ (ccdm @ (ccv @ Xm)))))))))))).
thf(aismtyval_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((cco @ XM @ XN @ ccismty) = (^ [Xf1:$i] : ((cwf1o @ XX @ XY @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))).
thf(aisismty_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((cwcel @ XF @ (cco @ XM @ XN @ ccismty)) <=> ((cwf1o @ XX @ XY @ XF) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) = (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))).
...
thf(aismtyima_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt)) & (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) & ((cwcel @ XP @ XX) & (cwcel @ XR @ ccxr))) => ((ccima @ XF @ (cco @ XP @ XR @ (ccfv @ XM @ ccbl))) = (cco @ (ccfv @ XP @ XF) @ XR @ (ccfv @ XN @ ccbl)))))))))))).
thf(aismtyhmeolem_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XM @ ccmopn)) => ((XK = (ccfv @ XN @ ccmopn)) => ((Xph => (cwcel @ XM @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((Xph => (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) => (Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))))))))).
thf(aismtyhmeo_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XM @ ccmopn)) => ((XK = (ccfv @ XN @ ccmopn)) => (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => (cwss @ (cco @ XM @ XN @ ccismty) @ (cco @ XJ @ XK @ cchmeo)))))))))))).
...
thf(aismtybnd_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt)) & (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) => ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> (cwcel @ XN @ (ccfv @ XY @ ccbnd)))))))))).
thf(aismtyres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccima @ XF @ XA2)) => ((XS = (ccres @ XM @ (ccxp @ XA2 @ XA2))) => ((XT = (ccres @ XN @ (ccxp @ XB2 @ XB2))) => ((((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) & ((cwcel @ XF @ (cco @ XM @ XN @ ccismty)) & (cwss @ XA2 @ XX))) => (cwcel @ (ccres @ XF @ XA2) @ (cco @ XS @ XT @ ccismty)))))))))))))))).
thf(aheibor1lem_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XJ @ cccmp)) => ((Xph => (cwcel @ XF @ (ccfv @ XD @ ccca))) => ((Xph => (cwf @ ccn @ XX @ XF)) => (Xph => (cwcel @ XF @ (ccdm @ (ccfv @ XJ @ cclm))))))))))))))).
thf(aheibor1_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccme)) & (cwcel @ XJ @ cccmp)) => ((cwcel @ XD @ (ccfv @ XX @ ccms)) & (cwcel @ XD @ (ccfv @ XX @ cctotbnd))))))))).
