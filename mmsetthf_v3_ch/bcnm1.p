...
thf(adigit2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccn) & (cwcel @ XK @ ccn)) => ((cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ XB2 @ ccmo) = (cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ (cco @ XB2 @ (ccfv @ (cco @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccmin) @ ccexp) @ XA2 @ ccmul) @ ccfl) @ ccmul) @ ccmin))))))).
thf(adigit1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccn) & (cwcel @ XK @ ccn)) => ((cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ XB2 @ ccmo) = (cco @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ (cco @ XB2 @ XK @ ccexp) @ ccmo) @ (cco @ (cco @ XB2 @ (ccfv @ (cco @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccmin) @ ccexp) @ XA2 @ ccmul) @ ccfl) @ ccmul) @ (cco @ XB2 @ XK @ ccexp) @ ccmo) @ ccmin))))))).
...
thf(adiscr1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwbr @ ccc0 @ (cco @ (cco @ (cco @ XA2 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ XC @ ccaddc) @ ccle))) => ((XX = (ccif @ (cwbr @ cc1 @ (cco @ (cco @ (cco @ XB2 @ (ccif @ (cwbr @ ccc0 @ XC @ ccle) @ XC @ ccc0) @ ccaddc) @ cc1 @ ccaddc) @ (ccneg @ XA2) @ ccdiv) @ ccle) @ (cco @ (cco @ (cco @ XB2 @ (ccif @ (cwbr @ ccc0 @ XC @ ccle) @ XC @ ccc0) @ ccaddc) @ cc1 @ ccaddc) @ (ccneg @ XA2) @ ccdiv) @ cc1)) => (Xph => (cwbr @ ccc0 @ XA2 @ ccle))))))))))))).
thf(adiscr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwbr @ ccc0 @ (cco @ (cco @ (cco @ XA2 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ XC @ ccaddc) @ ccle))) => (Xph => (cwbr @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ (cco @ XA2 @ XC @ ccmul) @ ccmul) @ ccmin) @ ccc0 @ ccle))))))))))).
...
thf(aexpeq0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => ((cco @ XA2 @ XN @ ccexp) = ccc0)) => (Xph => (XA2 = ccc0))))))))).
...
thf(asqeq0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = ccc0)) => (Xph => (XA2 = ccc0))))))).
...
thf(aexpaddd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XM @ ccn0)) => (Xph => ((cco @ XA2 @ (cco @ XM @ XN @ ccaddc) @ ccexp) = (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmul))))))))))).
...
thf(asqrecd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (XA2 != ccc0)) => (Xph => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ cc2 @ ccexp) = (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccdiv)))))))).
...
thf(aexpp1zd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (XA2 != ccc0)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) = (cco @ (cco @ XA2 @ XN @ ccexp) @ XA2 @ ccmul)))))))))).
...
thf(asqdivd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (XB2 != ccc0)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ cc2 @ ccexp) = (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccdiv)))))))))).
...
thf(amulexpd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ ccexp) = (cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccmul))))))))))).
...
thf(aexpge0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => (Xph => (cwbr @ ccc0 @ (cco @ XA2 @ XN @ ccexp) @ ccle))))))))).
thf(aexpge1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ cc1 @ XA2 @ ccle)) => (Xph => (cwbr @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccle))))))))).
thf(asqoddm1div8_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (XM = (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc))) => ((cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) = (cco @ (cco @ XN @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ cc2 @ ccdiv)))))).
...
thf(altexp2rd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => (Xph => ((cwbr @ XM @ XN @ cclt) <=> (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ cclt)))))))))))).
thf(areexpclzd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (XA2 != ccc0)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccr))))))))).
...
thf(asqgt0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (XA2 != ccc0)) => (Xph => (cwbr @ ccc0 @ (cco @ XA2 @ cc2 @ ccexp) @ cclt))))))).
thf(altexp2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwbr @ cc1 @ XA2 @ cclt)) => (Xph => ((cwbr @ XM @ XN @ cclt) <=> (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ cclt)))))))))))).
thf(aleexp2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwbr @ cc1 @ XA2 @ cclt)) => (Xph => ((cwbr @ XM @ XN @ ccle) <=> (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle)))))))))))).
thf(aexpcand_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwbr @ cc1 @ XA2 @ cclt)) => ((Xph => ((cco @ XA2 @ XM @ ccexp) = (cco @ XA2 @ XN @ ccexp))) => (Xph => (XM = XN)))))))))))).
thf(aleexp2ad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ cc1 @ XA2 @ ccle)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (Xph => (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle)))))))))).
thf(aleexp2rd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ cc1 @ ccle)) => (Xph => (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ ccle)))))))))))).
...
thf(asq11d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ ccc0 @ XB2 @ ccle)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = (cco @ XB2 @ cc2 @ ccexp))) => (Xph => (XA2 = XB2))))))))))).
thf(amulsubdivbinom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XD @ ccc)) & ((cwcel @ XC @ ccc) & (XC != ccc0))) => ((cco @ (cco @ (cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ XB2 @ ccaddc) @ cc2 @ ccexp) @ XD @ ccmin) @ XC @ ccdiv) = (cco @ (cco @ (cco @ XC @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ XD @ ccmin) @ XC @ ccdiv) @ ccaddc)))))))).
thf(amuldivbinom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & ((cwcel @ XC @ ccc) & (XC != ccc0))) => ((cco @ (cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ XB2 @ ccaddc) @ cc2 @ ccexp) @ XC @ ccdiv) = (cco @ (cco @ (cco @ XC @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ XC @ ccdiv) @ ccaddc))))))).
thf(asq10_thm,axiom,((cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) = (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0))).
thf(asq10e99m1_thm,axiom,((cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) = (cco @ (ccdc @ cc9 @ cc9) @ cc1 @ ccaddc))).
thf(a_3dec_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((ccdc @ (ccdc @ XA2 @ XB2) @ XC) = (cco @ (cco @ (cco @ (cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ (ccdc @ cc1 @ ccc0) @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
thf(asq10OLD_thm,axiom,((cco @ cc10 @ cc2 @ ccexp) = (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0))).
thf(asq10e99m1OLD_thm,axiom,((cco @ cc10 @ cc2 @ ccexp) = (cco @ (ccdc @ cc9 @ cc9) @ cc1 @ ccaddc))).
thf(a_3decOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((ccdc @ (ccdc @ XA2 @ XB2) @ XC) = (cco @ (cco @ (cco @ (cco @ cc10 @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ cc10 @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
thf(ann0le2msqi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ XB2 @ XB2 @ ccmul) @ ccle))))))).
thf(ann0opthlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwbr @ XA2 @ XC @ cclt) <=> (cwbr @ (cco @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ cc2 @ XA2 @ ccmul) @ ccaddc) @ (cco @ XC @ XC @ ccmul) @ cclt))))))).
thf(ann0opthlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt) => ((cco @ (cco @ XC @ XC @ ccmul) @ XD @ ccaddc) != (cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccmul) @ XB2 @ ccaddc)))))))))))).
thf(ann0opthi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => (((cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccmul) @ XB2 @ ccaddc) = (cco @ (cco @ (cco @ XC @ XD @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccmul) @ XD @ ccaddc)) <=> ((XA2 = XC) & (XB2 = XD)))))))))))).
thf(ann0opth2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => (((cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccexp) @ XB2 @ ccaddc) = (cco @ (cco @ (cco @ XC @ XD @ ccaddc) @ cc2 @ ccexp) @ XD @ ccaddc)) <=> ((XA2 = XC) & (XB2 = XD)))))))))))).
thf(ann0opth2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) & ((cwcel @ XC @ ccn0) & (cwcel @ XD @ ccn0))) => (((cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccexp) @ XB2 @ ccaddc) = (cco @ (cco @ (cco @ XC @ XD @ ccaddc) @ cc2 @ ccexp) @ XD @ ccaddc)) <=> ((XA2 = XC) & (XB2 = XD))))))))).
thf(ccfa_tp,type,(ccfa : ($i > $o))).
thf(adf_fac_ax,axiom,(ccfa = (ccun @ (ccsn @ (ccop @ ccc0 @ cc1)) @ (ccseq @ ccmul @ ccid @ cc1)))).
thf(afacnn_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccfa) = (ccfv @ XN @ (ccseq @ ccmul @ ccid @ cc1)))))).
thf(afac0_thm,axiom,((ccfv @ ccc0 @ ccfa) = cc1)).
thf(afac1_thm,axiom,((ccfv @ cc1 @ ccfa) = cc1)).
thf(afacp1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfa) = (cco @ (ccfv @ XN @ ccfa) @ (cco @ XN @ cc1 @ ccaddc) @ ccmul))))).
thf(afac2_thm,axiom,((ccfv @ cc2 @ ccfa) = cc2)).
thf(afac3_thm,axiom,((ccfv @ cc3 @ ccfa) = cc6)).
thf(afac4_thm,axiom,((ccfv @ cc4 @ ccfa) = (ccdc @ cc2 @ cc4))).
...
thf(afacne0_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ XN @ ccfa) != ccc0)))).
thf(afacdiv_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn) & (cwbr @ XN @ XM @ ccle)) => (cwcel @ (cco @ (ccfv @ XM @ ccfa) @ XN @ ccdiv) @ ccn))))).
thf(afacndiv_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn)) & ((cwbr @ cc1 @ XN @ cclt) & (cwbr @ XN @ XM @ ccle))) => (~ (cwcel @ (cco @ (cco @ (ccfv @ XM @ ccfa) @ cc1 @ ccaddc) @ XN @ ccdiv) @ ccz)))))).
thf(afacwordi_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0) & (cwbr @ XM @ XN @ ccle)) => (cwbr @ (ccfv @ XM @ ccfa) @ (ccfv @ XN @ ccfa) @ ccle))))).
thf(afaclbnd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ (cco @ (cco @ XM @ XM @ ccexp) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
thf(afaclbnd2_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc2 @ ccdiv) @ (ccfv @ XN @ ccfa) @ ccle)))).
thf(afaclbnd3_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ XM @ XN @ ccexp) @ (cco @ (cco @ XM @ XM @ ccexp) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
thf(afaclbnd4lem1_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ XK @ ccn0) => ((cwcel @ XM @ ccn0) => ((cwbr @ (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccexp) @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa) @ ccmul) @ ccle) => (cwbr @ (cco @ (cco @ XN @ (cco @ XK @ cc1 @ ccaddc) @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ (cco @ XK @ cc1 @ ccaddc) @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))))))).
thf(afaclbnd4lem2_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XK @ ccn0) & (cwcel @ XN @ ccn)) => ((cwbr @ (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccexp) @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa) @ ccmul) @ ccle) => (cwbr @ (cco @ (cco @ XN @ (cco @ XK @ cc1 @ ccaddc) @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ (cco @ XK @ cc1 @ ccaddc) @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))))).
...
thf(afaclbnd4_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccn0) & (cwcel @ XM @ ccn0)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle)))))).
thf(afaclbnd5_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccn0) & (cwcel @ XM @ ccn)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ cclt)))))).
thf(afaclbnd6_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => (cwbr @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XM @ ccexp) @ ccmul) @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ ccfa) @ ccle))))).
thf(afacubnd_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ (ccfv @ XN @ ccfa) @ (cco @ XN @ XN @ ccexp) @ ccle)))).
thf(afacavg_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (cwbr @ (ccfv @ (ccfv @ (cco @ (cco @ XM @ XN @ ccaddc) @ cc2 @ ccdiv) @ ccfl) @ ccfa) @ (cco @ (ccfv @ XM @ ccfa) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
thf(ccbc_tp,type,(ccbc : ($i > $o))).
thf(adf_bc_ax,axiom,(ccbc = (ccmpt2 @ (^ [Xn:$i] : (^ [Xk:$i] : ccn0)) @ (^ [Xn:$i] : (^ [Xk:$i] : ccz)) @ (^ [Xn:$i] : (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ ccfa) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccmul) @ ccdiv) @ ccc0)))))).
thf(abcval_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccz)) => ((cco @ XN @ XK @ ccbc) = (ccif @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ (ccfv @ (cco @ XN @ XK @ ccmin) @ ccfa) @ (ccfv @ XK @ ccfa) @ ccmul) @ ccdiv) @ ccc0)))))).
thf(abcval2_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ XN @ XK @ ccbc) = (cco @ (ccfv @ XN @ ccfa) @ (cco @ (ccfv @ (cco @ XN @ XK @ ccmin) @ ccfa) @ (ccfv @ XK @ ccfa) @ ccmul) @ ccdiv)))))).
thf(abcval3_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccz) & (~ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)))) => ((cco @ XN @ XK @ ccbc) = ccc0))))).
...
thf(abc0k_thm,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn) => ((cco @ ccc0 @ XK @ ccbc) = ccc0)))).
thf(abcnn_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ XN @ XN @ ccbc) = cc1)))).
thf(abcn1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ XN @ cc1 @ ccbc) = XN)))).
thf(abcnp1n_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ XN @ ccbc) = (cco @ XN @ cc1 @ ccaddc))))).
...
thf(abcval5_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccn)) => ((cco @ XN @ XK @ ccbc) = (cco @ (ccfv @ XN @ (ccseq @ ccmul @ ccid @ (cco @ (cco @ XN @ XK @ ccmin) @ cc1 @ ccaddc))) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
thf(abcn2_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ XN @ cc2 @ ccbc) = (cco @ (cco @ XN @ (cco @ XN @ cc1 @ ccmin) @ ccmul) @ cc2 @ ccdiv))))).
thf(abcp1m1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XN @ cc1 @ ccmin) @ ccbc) = (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XN @ ccmul) @ cc2 @ ccdiv))))).
...
thf(abcn2m1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ (cco @ XN @ cc1 @ ccmin) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccbc) @ ccaddc) = (cco @ XN @ cc2 @ ccbc))))).
thf(abcn2p1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ XN @ (cco @ XN @ cc2 @ ccbc) @ ccaddc) = (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccbc))))).
thf(apermnn_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XR @ (cco @ ccc0 @ XN @ ccfz)) => (cwcel @ (cco @ (ccfv @ XN @ ccfa) @ (ccfv @ XR @ ccfa) @ ccdiv) @ ccn))))).
thf(abcnm1_thm,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ XN @ (cco @ XN @ cc1 @ ccmin) @ ccbc) = XN)))).
