...
thf(acfilucfil4_thm,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (((XX != cc0) & (cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XC @ (ccfv @ XX @ ccfil))) => ((cwcel @ XC @ (ccfv @ (ccfv @ XD @ ccmetu) @ cccfilu)) <=> (cwcel @ XC @ (ccfv @ XD @ cccfil)))))))).
