...
thf(acmspropd_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (XB2 = (ccfv @ XK @ ccbs))) => ((Xph => (XB2 = (ccfv @ XL @ ccbs))) => ((Xph => ((ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XB2 @ XB2)) = (ccres @ (ccfv @ XL @ ccds) @ (ccxp @ XB2 @ XB2)))) => ((Xph => ((ccfv @ XK @ cctopn) = (ccfv @ XL @ cctopn))) => (Xph => ((cwcel @ XK @ cccms) <=> (cwcel @ XL @ cccms)))))))))))).
