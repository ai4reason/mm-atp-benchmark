...
thf(amndlrid_thm,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccmnd) & (cwcel @ XX @ XB2)) => (((cco @ Xc_0 @ XX @ Xc_pl) = XX) & ((cco @ XX @ Xc_0 @ Xc_pl) = XX)))))))))))).
