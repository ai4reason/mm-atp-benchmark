...
thf(aacsdomd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccacs))) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((XI = (ccfv @ XA2 @ ccmri)) => ((Xph => (cwcel @ XS @ XI)) => ((Xph => (cwss @ XT @ XX)) => ((Xph => ((ccfv @ XS @ XN) = (ccfv @ XT @ XN))) => ((Xph => (~ (cwcel @ XS @ ccfn))) => (Xph => (cwbr @ XS @ XT @ ccdom))))))))))))))))).
