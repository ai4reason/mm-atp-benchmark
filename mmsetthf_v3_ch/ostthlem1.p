...
thf(aostthlem1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => ((Xph => (cwcel @ XF @ XA2)) => ((Xph => (cwcel @ XG @ XA2)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccfv @ cc2 @ ccuz))) => ((ccfv @ (ccv @ Xn) @ XF) = (ccfv @ (ccv @ Xn) @ XG)))) => (Xph => (XF = XG))))))))))))).
