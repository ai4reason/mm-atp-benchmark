...
thf(anumsucc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ ccn0) => ((XT = (cco @ XY @ cc1 @ ccaddc)) => ((cwcel @ XA2 @ ccn0) => (((cco @ XA2 @ cc1 @ ccaddc) = XB2) => ((XN = (cco @ (cco @ XT @ XA2 @ ccmul) @ XY @ ccaddc)) => ((cco @ XN @ cc1 @ ccaddc) = (cco @ (cco @ XT @ XB2 @ ccmul) @ ccc0 @ ccaddc))))))))))))).
