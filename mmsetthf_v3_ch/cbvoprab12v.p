...
thf(acbvoprab12v_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : ((((ccv @ Xx3) = (ccv @ Xw)) & ((ccv @ Xy1) = (ccv @ Xv))) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> (Xps @ Xz @ Xw @ Xv)))))))) => ((ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) = (ccoprab @ (^ [Xw:$i] : (^ [Xv:$i] : (^ [Xz:$i] : (Xps @ Xz @ Xw @ Xv)))))))))).
