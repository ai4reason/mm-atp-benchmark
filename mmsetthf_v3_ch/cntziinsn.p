...
thf(acntziinsn_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XZ = (ccfv @ XM @ cccntz)) => ((cwss @ XS @ XB2) => ((ccfv @ XS @ XZ) = (ccin @ XB2 @ (cciin @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ XZ))))))))))))).
