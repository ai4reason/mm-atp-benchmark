...
thf(asgmmul_thm,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn) & ((cco @ XM @ XN @ ccgcd) = cc1))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ ccsgm) = (cco @ (cco @ XA2 @ XM @ ccsgm) @ (cco @ XA2 @ XN @ ccsgm) @ ccmul))))))).
