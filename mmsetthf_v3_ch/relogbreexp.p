...
thf(arelogbreexp_thm,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & (cwcel @ XC @ ccrp) & (cwcel @ XE @ ccr)) => ((cco @ XB2 @ (cco @ XC @ XE @ cccxp) @ cclogb) = (cco @ XE @ (cco @ XB2 @ XC @ cclogb) @ ccmul))))))).
