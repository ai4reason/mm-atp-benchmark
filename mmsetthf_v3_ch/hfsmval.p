...
thf(ahfsmval_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ ccc @ XS) & (cwf @ cchil @ ccc @ XT)) => ((cco @ XS @ XT @ cchfs) = (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccaddc)))))))).
