...
thf(aflfssfcf_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwf @ XY @ XX @ XF)) => (cwss @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)))))))))).
