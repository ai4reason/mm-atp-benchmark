...
thf(alemaxle_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) & (cwcel @ XA2 @ ccr) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ XA2 @ (ccif @ (cwbr @ XC @ XB2 @ ccle) @ XB2 @ XC) @ ccle)))))).
