...
thf(aq1pval_thm,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : ((! [Xq:$i] : ((XQ @ Xq) = (ccfv @ XR @ ccq1p))) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((! [Xq:$i] : ((XD @ Xq) = (ccfv @ XR @ ccdg1))) => ((! [Xq:$i] : ((Xc_mi @ Xq) = (ccfv @ XP @ ccsg))) => ((! [Xq:$i] : ((Xc_x @ Xq) = (ccfv @ XP @ ccmulr))) => (! [Xq:$i] : (((cwcel @ XF @ XB2) & (cwcel @ XG @ XB2)) => ((cco @ XF @ XG @ (XQ @ Xq)) = (ccrio @ (^ [Xq:$i] : (cwbr @ (ccfv @ (cco @ XF @ (cco @ (ccv @ Xq) @ XG @ (Xc_x @ Xq)) @ (Xc_mi @ Xq)) @ (XD @ Xq)) @ (ccfv @ XG @ (XD @ Xq)) @ cclt)) @ (^ [Xq:$i] : XB2))))))))))))))))))))).
