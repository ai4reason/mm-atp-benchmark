...
thf(aprmind2_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = cc1) => ((Xph @ Xx3) <=> (Xps @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xz)) => ((Xph @ Xx3) <=> (Xth @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmul)) => ((Xph @ Xx3) <=> (Xta @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (XA2 @ Xy1 @ Xz)) => ((Xph @ Xx3) <=> (Xet @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)))) => ((! [Xx3:$i] : (((cwcel @ (ccv @ Xx3) @ ccprime) & (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc1 @ ccmin) @ ccfz)))) => (Xph @ Xx3))) => ((! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (ccv @ Xz) @ (ccfv @ cc2 @ ccuz))) => (((Xch @ Xy1) & (Xth @ Xy1 @ Xz)) => (Xta @ Xy1 @ Xz))))) => (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XA2 @ Xy1 @ Xz) @ ccn) => (Xet @ Xy1 @ Xz)))))))))))))))))))).
