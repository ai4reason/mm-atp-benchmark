...
thf(aisfildlem_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => (! [Xx3:$i] : (Xph => ((cwcel @ (XB2 @ Xx3) @ XF) <=> ((cwss @ (XB2 @ Xx3) @ XA2) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XB2 @ Xx3)))))))))))))).
