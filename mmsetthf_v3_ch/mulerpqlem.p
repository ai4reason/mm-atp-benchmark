...
thf(amulerpqlem_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) & (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi)) & (cwcel @ XC @ (ccxp @ ccnpi @ ccnpi))) => ((cwbr @ XA2 @ XB2 @ cceq) <=> (cwbr @ (cco @ XA2 @ XC @ ccmpq) @ (cco @ XB2 @ XC @ ccmpq) @ cceq))))))).
