...
thf(awlkreslem0_thm,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XF @ (ccword @ XS)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz))) => ((ccfv @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ cchash) = XN)))))).
