...
thf(arelogbmulexp_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & ((cwcel @ XA2 @ ccrp) & (cwcel @ XC @ ccrp) & (cwcel @ XE @ ccr))) => ((cco @ XB2 @ (cco @ XA2 @ (cco @ XC @ XE @ cccxp) @ ccmul) @ cclogb) = (cco @ (cco @ XB2 @ XA2 @ cclogb) @ (cco @ XE @ (cco @ XB2 @ XC @ cclogb) @ ccmul) @ ccaddc)))))))).
