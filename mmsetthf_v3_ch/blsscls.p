...
thf(ablsscls_thm,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX)) & ((cwcel @ XR @ ccxr) & (cwcel @ XS @ ccxr) & (cwbr @ XR @ XS @ cclt))) => (cwss @ (ccfv @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccfv @ XJ @ cccl)) @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl)))))))))))).
