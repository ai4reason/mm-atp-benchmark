...
thf(apsgnfieu_thm,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XN @ ccsymg)) => ((! [Xw:$i] : (! [Xs1:$i] : ((XB2 @ Xw @ Xs1) = (ccfv @ XG @ ccbs)))) => ((XT = (ccrn @ (ccfv @ XN @ ccpmtr))) => (! [Xw:$i] : (! [Xs1:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XQ @ (XB2 @ Xw @ Xs1))) => (cweu @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : ((XQ = (cco @ XG @ (ccv @ Xw) @ ccgsu)) & ((ccv @ Xs1) = (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ XT))))))))))))))))).
