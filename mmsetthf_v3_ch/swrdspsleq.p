...
thf(aswrdspsleq_thm,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV))) & ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) & ((cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle) & (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) => (((cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) = (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr)) <=> (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) = (ccfv @ (ccv @ Xi) @ XU))) @ (^ [Xi:$i] : (cco @ XM @ XN @ ccfzo))))))))))).
