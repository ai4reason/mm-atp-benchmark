...
thf(afnwe2lem1_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccfv @ (ccv @ Xx3) @ XF)) => ((XS @ Xz) = (XU @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XT @ Xx3 @ Xy1 @ Xz) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (XR @ Xz)) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XU @ Xx3))))))))))) => ((! [Xx3:$i] : (! [Xa:$i] : (((Xph @ Xa) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwwe @ (ccrab @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) = (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : XA2)) @ (XU @ Xx3))))) => (! [Xa:$i] : (((Xph @ Xa) & (cwcel @ (ccv @ Xa) @ XA2)) => (cwwe @ (ccrab @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) = (ccfv @ (ccv @ Xa) @ XF))) @ (^ [Xy1:$i] : XA2)) @ (ccsb @ (ccfv @ (ccv @ Xa) @ XF) @ (^ [Xz:$i] : (XS @ Xz))))))))))))))))).
