...
thf(afindes_thm,conjecture,(! [Xph:($i > $o)] : ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ cc0) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccom) => ((Xph @ Xx3) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccom) => (Xph @ Xx3))))))).
