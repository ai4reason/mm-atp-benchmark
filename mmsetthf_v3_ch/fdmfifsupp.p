...
thf(afrfi_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwpo @ XA2 @ XR) & (cwcel @ XA2 @ ccfn)) => (cwfr @ XA2 @ XR))))).
...
thf(afimaxg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XA2 @ ccfn) & (XA2 != cc0)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) => (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
thf(afisupg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XA2 @ ccfn) & (XA2 != cc0)) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)))))).
thf(awofi_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XA2 @ ccfn)) => (cwwe @ XA2 @ XR))))).
...
thf(aunblem3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccdif @ XA2 @ (ccsuc @ (ccv @ Xx3)))))) @ (ccint @ XA2)) @ ccom))) => (! [Xx3:$i] : (! [Xz:$i] : (((cwss @ XA2 @ ccom) & (cwral @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwcel @ (ccv @ Xw) @ (ccv @ Xv))) @ (^ [Xv:$i] : XA2))) @ (^ [Xw:$i] : ccom))) => ((cwcel @ (ccv @ Xz) @ ccom) => (cwcel @ (ccfv @ (ccv @ Xz) @ (XF @ Xx3)) @ (ccfv @ (ccsuc @ (ccv @ Xz)) @ (XF @ Xx3))))))))))).
thf(aunblem4_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccdif @ XA2 @ (ccsuc @ (ccv @ Xx3)))))) @ (ccint @ XA2)) @ ccom))) => (! [Xx3:$i] : (((cwss @ XA2 @ ccom) & (cwral @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwcel @ (ccv @ Xw) @ (ccv @ Xv))) @ (^ [Xv:$i] : XA2))) @ (^ [Xw:$i] : ccom))) => (cwf1 @ ccom @ XA2 @ (XF @ Xx3)))))))).
thf(aunbnn_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ ccom @ ccvv) & (cwss @ XA2 @ ccom) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccom))) => (cwbr @ XA2 @ ccom @ ccen)))).
thf(aunbnn2_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ ccom @ ccvv) & (cwss @ XA2 @ ccom) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccom))) => (cwbr @ XA2 @ ccom @ ccen)))).
thf(aisfinite2_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ ccom @ ccsdm) => (cwcel @ XA2 @ ccfn)))).
thf(annsdomg_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ ccom @ ccvv) & (cwcel @ XA2 @ ccom)) => (cwbr @ XA2 @ ccom @ ccsdm)))).
thf(aisfiniteg_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ ccom @ ccvv) => ((cwcel @ XA2 @ ccfn) <=> (cwbr @ XA2 @ ccom @ ccsdm))))).
thf(ainfsdomnn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ ccom @ XA2 @ ccdom) & (cwcel @ XB2 @ ccom)) => (cwbr @ XB2 @ XA2 @ ccsdm))))).
thf(ainfn0_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (XA2 != cc0)))).
thf(afin2inf_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ ccom @ ccsdm) => (cwcel @ ccom @ ccvv)))).
thf(aunfilem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XB2 @ ccom) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))) => (! [Xx3:$i] : ((ccrn @ (XF @ Xx3)) = (ccdif @ (cco @ XA2 @ XB2 @ ccoa) @ XA2)))))))))).
thf(aunfilem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XB2 @ ccom) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))) => (! [Xx3:$i] : (cwf1o @ XB2 @ (ccdif @ (cco @ XA2 @ XB2 @ ccoa) @ XA2) @ (XF @ Xx3)))))))))).
thf(aunfilem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwbr @ XB2 @ (ccdif @ (cco @ XA2 @ XB2 @ ccoa) @ XA2) @ ccen))))).
thf(aunfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => (cwcel @ (ccun @ XA2 @ XB2) @ ccfn))))).
thf(aunfir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ (ccun @ XA2 @ XB2) @ ccfn) => ((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)))))).
...
thf(a_3xpfi_thm,axiom,(! [XV:($i > $o)] : ((cwcel @ XV @ ccfn) => (cwcel @ (ccxp @ (ccxp @ XV @ XV) @ XV) @ ccfn)))).
thf(adomunfican_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ ccfn) & (cwbr @ XB2 @ XA2 @ ccen)) & (((ccin @ XA2 @ XX) = cc0) & ((ccin @ XB2 @ XY) = cc0))) => ((cwbr @ (ccun @ XA2 @ XX) @ (ccun @ XB2 @ XY) @ ccdom) <=> (cwbr @ XX @ XY @ ccdom)))))))).
thf(ainfcntss_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwbr @ ccom @ XA2 @ ccdom) => (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ ccom @ ccen))))))).
...
thf(afiint_thm,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & ((ccv @ Xx3) != cc0) & (cwcel @ (ccv @ Xx3) @ ccfn)) => (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2)))))).
thf(afnfi_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XA2 @ ccfn)) => (cwcel @ XF @ ccfn))))).
thf(afodomfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwfo @ XA2 @ XB2 @ XF)) => (cwbr @ XB2 @ XA2 @ ccdom)))))).
thf(afodomfib_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (((XA2 != cc0) & (? [Xf1:$i] : (cwfo @ XA2 @ XB2 @ (ccv @ Xf1)))) <=> ((cwbr @ cc0 @ XB2 @ ccsdm) & (cwbr @ XB2 @ XA2 @ ccdom))))))).
thf(afofinf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfo @ XA2 @ XB2 @ XF) & (cwbr @ XA2 @ XB2 @ ccen) & (cwcel @ XB2 @ ccfn)) => (cwf1o @ XA2 @ XB2 @ XF)))))).
thf(arneqdmfinf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwfn @ XF @ XA2) & ((ccrn @ XF) = XA2)) => (cwf1o @ XA2 @ XA2 @ XF))))).
thf(afidomdm_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccfn) => (cwbr @ (ccdm @ XF) @ XF @ ccdom)))).
thf(admfi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ (ccdm @ XA2) @ ccfn)))).
thf(afundmfibi_thm,axiom,(! [XF:($i > $o)] : ((cwfun @ XF) => ((cwcel @ XF @ ccfn) <=> (cwcel @ (ccdm @ XF) @ ccfn))))).
thf(aresfnfinfin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XB2 @ ccfn)) => (cwcel @ (ccres @ XF @ XB2) @ ccfn)))))).
thf(aresidfi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ (ccres @ ccid @ XA2) @ ccfn) <=> (cwcel @ XA2 @ ccfn)))).
thf(acnvfi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ (cccnv @ XA2) @ ccfn)))).
thf(arnfi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ (ccrn @ XA2) @ ccfn)))).
thf(af1dmvrnfibi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf1 @ XA2 @ XB2 @ XF)) => ((cwcel @ XF @ ccfn) <=> (cwcel @ (ccrn @ XF) @ ccfn)))))))).
thf(af1vrnfibi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XF @ XV) & (cwf1 @ XA2 @ XB2 @ XF)) => ((cwcel @ XF @ ccfn) <=> (cwcel @ (ccrn @ XF) @ ccfn)))))))).
...
thf(aunifi_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwss @ XA2 @ ccfn)) => (cwcel @ (ccuni @ XA2) @ ccfn)))).
thf(aunifi2_thm,axiom,(! [XA2:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccsdm) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ ccom @ ccsdm)) @ (^ [Xx3:$i] : XA2))) => (cwbr @ (ccuni @ XA2) @ ccom @ ccsdm)))).
thf(ainfssuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((~ (cwcel @ XA2 @ ccfn)) & (cwcel @ XB2 @ ccfn) & (cwss @ XA2 @ (ccuni @ XB2))) => (cwrex @ (^ [Xx3:$i] : (~ (cwcel @ (ccin @ XA2 @ (ccv @ Xx3)) @ ccfn))) @ (^ [Xx3:$i] : XB2)))))).
thf(aunirnffid_thm,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XT @ ccfn @ XF)) => ((Xph => (cwcel @ XT @ ccfn)) => (Xph => (cwcel @ (ccuni @ (ccrn @ XF)) @ ccfn)))))))).
thf(aimafi_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfun @ XF) & (cwcel @ XX @ ccfn)) => (cwcel @ (ccima @ XF @ XX) @ ccfn))))).
thf(apwfilem_thm,axiom,(! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XF @ Xx3 @ Xb @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xb))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xb:$i] : ((cwcel @ (ccpw @ (ccv @ Xb)) @ ccfn) => (cwcel @ (ccpw @ (ccun @ (ccv @ Xb) @ (ccsn @ (ccv @ Xx3)))) @ ccfn))))))).
thf(apwfilem_b_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xc:$i] : ((XF @ Xx3 @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3)))))))) => (! [Xx3:$i] : ((cwcel @ (ccpw @ (ccv @ Xx3)) @ ccfn) => (cwcel @ (ccpw @ (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xx3)))) @ ccfn)))))).
thf(apwfi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) <=> (cwcel @ (ccpw @ XA2) @ ccfn)))).
thf(amapfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmap) @ ccfn))))).
thf(aixpfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccfn)) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccfn))))).
thf(aixpfi2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((Xph => (cwcel @ XC @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ XA2 @ XC))) => (cwss @ (XB2 @ Xx3) @ (ccsn @ (XD @ Xx3))))) => (Xph => (cwcel @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccfn))))))))))).
thf(amptfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccfn) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccfn))))).
thf(aabrexfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccfn) => (cwcel @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))) @ ccfn))))).
thf(acnvimamptfin_thm,axiom,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XN @ ccfn))) => (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (ccima @ (cccnv @ (ccmpt @ (^ [Xp:$i] : XN) @ (^ [Xp:$i] : (XX @ Xp)))) @ (XY @ Xp)) @ ccfn))))))))).
...
thf(af1opwfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ XA2 @ XB2 @ XF) => (cwf1o @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccin @ (ccpw @ XB2) @ ccfn) @ (ccmpt @ (^ [Xb:$i] : (ccin @ (ccpw @ XA2) @ ccfn)) @ (^ [Xb:$i] : (ccima @ XF @ (ccv @ Xb)))))))))).
...
thf(afipreima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XB2) & (cwss @ XA2 @ (ccrn @ XF)) & (cwcel @ XA2 @ ccfn)) => (cwrex @ (^ [Xc:$i] : ((ccima @ XF @ (ccv @ Xc)) = XA2)) @ (^ [Xc:$i] : (ccin @ (ccpw @ XB2) @ ccfn)))))))).
thf(afinsschain_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((XA2 != cc0) & (cwor @ XA2 @ ccrpss)) & ((cwcel @ XB2 @ ccfn) & (cwss @ XB2 @ (ccuni @ XA2)))) => (cwrex @ (^ [Xz:$i] : (cwss @ XB2 @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2)))))).
thf(aindexfi_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xc:$i] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ (XM @ Xx3 @ Xy1 @ Xc)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))) => (cwrex @ (^ [Xc:$i] : ((cwss @ (ccv @ Xc) @ XB2) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xc)))) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : (ccv @ Xc))))) @ (^ [Xc:$i] : ccfn))))))))))).
thf(ccfsupp_tp,type,(ccfsupp : ($i > $o))).
thf(adf_fsupp_ax,axiom,(ccfsupp = (ccopab @ (^ [Xr:$i] : (^ [Xz:$i] : ((cwfun @ (ccv @ Xr)) & (cwcel @ (cco @ (ccv @ Xr) @ (ccv @ Xz) @ ccsupp) @ ccfn))))))).
thf(arelfsupp_thm,axiom,(cwrel @ ccfsupp)).
thf(arelprcnfsupp_thm,axiom,(! [XA2:($i > $o)] : (! [XZ:($i > $o)] : ((~ (cwcel @ XA2 @ ccvv)) => (~ (cwbr @ XA2 @ XZ @ ccfsupp)))))).
...
thf(afsuppimp_thm,axiom,(! [XR:($i > $o)] : (! [XZ:($i > $o)] : ((cwbr @ XR @ XZ @ ccfsupp) => ((cwfun @ XR) & (cwcel @ (cco @ XR @ XZ @ ccsupp) @ ccfn)))))).
thf(afsuppimpd_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => (Xph => (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn))))))).
thf(afisuppfi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => (Xph => (cwcel @ (ccima @ (cccnv @ XF) @ XC) @ ccfn)))))))))).
thf(afdmfisuppfi_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XD @ XR @ XF)) => ((Xph => (cwcel @ XD @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn)))))))))))).
thf(afdmfifsupp_thm,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XD @ XR @ XF)) => ((Xph => (cwcel @ XD @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwbr @ XF @ XZ @ ccfsupp)))))))))))).
