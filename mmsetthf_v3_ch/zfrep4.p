...
thf(azfrep4_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : ((cwcel @ (^ [Xx3:$i] : (Xph @ Xx3)) @ ccvv) => ((! [Xx3:$i] : ((Xph @ Xx3) => (? [Xz:$i] : (! [Xy1:$i] : ((Xps @ Xx3 @ Xy1) => ((ccv @ Xy1) = (ccv @ Xz))))))) => (cwcel @ (^ [Xy1:$i] : (? [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3 @ Xy1)))) @ ccvv)))))).
