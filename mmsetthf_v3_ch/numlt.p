...
thf(anumlt_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccn) => ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn) => ((cwbr @ XB2 @ XC @ cclt) => (cwbr @ (cco @ (cco @ XT @ XA2 @ ccmul) @ XB2 @ ccaddc) @ (cco @ (cco @ XT @ XA2 @ ccmul) @ XC @ ccaddc) @ cclt))))))))))).
