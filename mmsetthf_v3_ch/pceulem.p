...
thf(apythagtriplem19_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwcel @ XC @ ccn)) & ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) & (~ (cwbr @ cc2 @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds))) => (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xk:$i] : ((XA2 = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin) @ ccmul)) & (XB2 = (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul) @ ccmul)) & (XC = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc) @ ccmul)))) @ (^ [Xk:$i] : ccn))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn))))))).
thf(apythagtrip_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwcel @ XC @ ccn)) => (((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) <=> (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xk:$i] : (((ccpr @ XA2 @ XB2) = (ccpr @ (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul) @ ccmul))) & (XC = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc) @ ccmul)))) @ (^ [Xk:$i] : ccn))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn)))))))).
...
thf(adf_pc_ax,axiom,(ccpc = (ccmpt2 @ (^ [Xp:$i] : (^ [Xr:$i] : ccprime)) @ (^ [Xp:$i] : (^ [Xr:$i] : ccq)) @ (^ [Xp:$i] : (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = ccc0) @ ccpnf @ (ccio @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((ccv @ Xr) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv)) & ((ccv @ Xz) = (cco @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt) @ ccmin)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccz)))))))))).
thf(apclem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => (! [Xn:$i] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => ((cwss @ (XA2 @ Xn) @ ccz) & ((XA2 @ Xn) != cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XA2 @ Xn)))) @ (^ [Xx3:$i] : ccz)))))))))).
thf(apcprecl_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : ((XS @ Xn) = (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => ((cwcel @ (XS @ Xn) @ ccn0) & (cwbr @ (cco @ XP @ (XS @ Xn) @ ccexp) @ XN @ ccdvds))))))))))).
thf(apcprendvds_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : ((XS @ Xn) = (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => (~ (cwbr @ (cco @ XP @ (cco @ (XS @ Xn) @ cc1 @ ccaddc) @ ccexp) @ XN @ ccdvds))))))))))).
thf(apcprendvds2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : ((XS @ Xn) = (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => (~ (cwbr @ XP @ (cco @ XN @ (cco @ XP @ (XS @ Xn) @ ccexp) @ ccdiv) @ ccdvds))))))))))).
thf(apcpre1_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : ((XS @ Xn) = (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (XN = cc1)) => ((XS @ Xn) = ccc0)))))))))).
thf(apcpremul_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XS @ Xn) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XM @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))) => ((! [Xn:$i] : ((XT @ Xn) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))) => ((! [Xn:$i] : ((XU @ Xn) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (cco @ XM @ XN @ ccmul) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))) => (! [Xn:$i] : (((cwcel @ XP @ ccprime) & ((cwcel @ XM @ ccz) & (XM != ccc0)) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => ((cco @ (XS @ Xn) @ (XT @ Xn) @ ccaddc) = (XU @ Xn)))))))))))))).
thf(apcval_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XS @ Xx3 @ Xy1 @ Xn) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XT @ Xx3 @ Xy1 @ Xn) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => (! [Xn:$i] : (((cwcel @ XP @ ccprime) & ((cwcel @ XN @ ccq) & (XN != ccc0))) => ((cco @ XP @ XN @ ccpc) = (ccio @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((XN = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv)) & ((ccv @ Xz) = (cco @ (XS @ Xx3 @ Xy1 @ Xn) @ (XT @ Xx3 @ Xy1 @ Xn) @ ccmin)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccz)))))))))))))).
thf(apceulem_thm,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XS @ Xx3 @ Xy1 @ Xn) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XT @ Xx3 @ Xy1 @ Xn) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XU @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xs1) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XV @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) = (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xt) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) => (cwcel @ XP @ ccprime))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) => (XN != ccc0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) => ((cwcel @ (ccv @ Xx3) @ ccz) & (cwcel @ (ccv @ Xy1) @ ccn)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) => (XN = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) => ((cwcel @ (ccv @ Xs1) @ ccz) & (cwcel @ (ccv @ Xt) @ ccn)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) => (XN = (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ ccdiv)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) => ((cco @ (XS @ Xx3 @ Xy1 @ Xn) @ (XT @ Xx3 @ Xy1 @ Xn) @ ccmin) = (cco @ (XU @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (XV @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ ccmin)))))))))))))))))))))))))).
