...
thf(adiv12d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (XC != ccc0)) => (Xph => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccdiv) @ ccmul) = (cco @ XB2 @ (cco @ XA2 @ XC @ ccdiv) @ ccmul)))))))))))).
