...
thf(aaspsubrg_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccasp)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ ccasa) & (cwss @ XS @ XV)) => (cwcel @ (ccfv @ XS @ XA2) @ (ccfv @ XW @ ccsubrg)))))))))).
