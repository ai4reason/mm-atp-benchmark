...
thf(amrelatlub_thm,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XC @ ccipo)) => ((XF = (ccfv @ XC @ ccmrc)) => ((XL = (ccfv @ XI @ cclub)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XC)) => ((ccfv @ XU @ XL) = (ccfv @ (ccuni @ XU) @ XF))))))))))))).
