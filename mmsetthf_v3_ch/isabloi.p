...
thf(aisabloi_thm,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XG @ ccgr) => (((ccdm @ XG) = (ccxp @ XX @ XX)) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX)) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG))))) => (cwcel @ XG @ ccablo))))))).
