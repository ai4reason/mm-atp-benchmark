...
thf(aswrdsbslen_thm,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV))) & ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) & ((cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle) & (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) => ((ccfv @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) @ cchash) = (ccfv @ (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr) @ cchash))))))))).
