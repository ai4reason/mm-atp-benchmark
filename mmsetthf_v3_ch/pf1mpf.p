...
thf(apf1mpf_thm,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ cce1))) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccrn @ (cco @ cc1o @ XR @ ccevl)))) => (! [Xx3:$i] : ((cwcel @ XF @ XQ) => (cwcel @ (cccom @ XF @ (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ cc1o @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ cc0 @ (ccv @ Xx3))))) @ (XE @ Xx3))))))))))))).
