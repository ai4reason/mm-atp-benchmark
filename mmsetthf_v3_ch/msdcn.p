...
thf(amsdcn_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccfv @ XM @ ccds)) => ((XJ = (ccfv @ XM @ cctopn)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwcel @ XM @ ccmt) => (cwcel @ (ccres @ XD @ (ccxp @ XX @ XX)) @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn))))))))))))).
