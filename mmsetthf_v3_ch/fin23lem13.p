...
thf(afin23lem13_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : ((! [Xt:$i] : ((XU @ Xt) = (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ ((ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) = cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))) => (! [Xt:$i] : ((cwcel @ (XA2 @ Xt) @ ccom) => (cwss @ (ccfv @ (ccsuc @ (XA2 @ Xt)) @ (XU @ Xt)) @ (ccfv @ (XA2 @ Xt) @ (XU @ Xt))))))))).
