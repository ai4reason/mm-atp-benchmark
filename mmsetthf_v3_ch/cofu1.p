...
thf(acofu1_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XD @ XE @ ccfunc))) => ((Xph => (cwcel @ XX @ XB2)) => (Xph => ((ccfv @ XX @ (ccfv @ (cco @ XG @ XF @ cccofu) @ cc1st)) = (ccfv @ (ccfv @ XX @ (ccfv @ XF @ cc1st)) @ (ccfv @ XG @ cc1st))))))))))))))))).
