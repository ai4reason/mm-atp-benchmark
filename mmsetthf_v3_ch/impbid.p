...
thf(aimpbidd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => (Xch => Xth))) => ((Xph => (Xps => (Xth => Xch))) => (Xph => (Xps => (Xch <=> Xth)))))))))).
thf(aimpbid21d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xps => (Xch => Xth)) => ((Xph => (Xth => Xch)) => (Xph => (Xps => (Xch <=> Xth)))))))))).
thf(aimpbid_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xph => (Xch => Xps)) => (Xph => (Xps <=> Xch)))))))).
