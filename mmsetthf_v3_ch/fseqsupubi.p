...
thf(afseqsupubi_thm,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) & (cwf @ (cco @ XM @ XN @ ccfz) @ ccr @ XF)) => (cwbr @ (ccfv @ XK @ XF) @ (ccsup @ (ccrn @ XF) @ ccr @ cclt) @ ccle))))))).
