...
thf(aiunsuc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = XC))) => ((cciun @ (^ [Xx3:$i] : (ccsuc @ XA2)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccun @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC)))))))).
