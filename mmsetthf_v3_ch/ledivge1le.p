...
thf(aledivge1le_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp) & ((cwcel @ XC @ ccrp) & (cwbr @ cc1 @ XC @ ccle))) => ((cwbr @ XA2 @ XB2 @ ccle) => (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle))))))).
