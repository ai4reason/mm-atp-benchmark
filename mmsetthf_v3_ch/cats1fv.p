...
thf(acats1fv_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XT = (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwcel @ XS @ (ccword @ ccvv)) => (((ccfv @ XS @ cchash) = XM) => (((cwcel @ XY @ XV) => ((ccfv @ XN @ XS) = XY)) => ((cwcel @ XN @ ccn0) => ((cwbr @ XN @ XM @ cclt) => ((cwcel @ XY @ XV) => ((ccfv @ XN @ XT) = XY)))))))))))))))).
