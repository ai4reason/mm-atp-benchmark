...
thf(adchrelbas4_thm,conjecture,(! [XD:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((! [Xx3:$i] : (XD = (ccfv @ (XG @ Xx3) @ ccbs))) => ((XL = (ccfv @ XZ @ cczrh)) => ((cwcel @ XX @ XD) <=> ((cwcel @ XN @ ccn) & (cwcel @ XX @ (cco @ (ccfv @ XZ @ ccmgp) @ (ccfv @ cccnfld @ ccmgp) @ ccmhm)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ cc1 @ (cco @ (ccv @ Xx3) @ XN @ ccgcd) @ cclt) => ((ccfv @ (ccfv @ (ccv @ Xx3) @ XL) @ XX) = ccc0))) @ (^ [Xx3:$i] : ccz))))))))))))))).
