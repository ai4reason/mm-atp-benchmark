...
thf(ancvsdif_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ (ccin @ ccnvc @ cccvs)) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((ccfv @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ Xc_x) @ Xc_pl) @ XN) = (ccfv @ (cco @ XB2 @ (cco @ (ccneg @ cc1) @ XA2 @ Xc_x) @ Xc_pl) @ XN))))))))))))))).
