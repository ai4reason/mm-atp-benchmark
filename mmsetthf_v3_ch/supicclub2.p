...
thf(asupicclub2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : ((! [Xz:$i] : (Xph => (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xz:$i] : (Xph => (cwcel @ (XC @ Xz) @ ccr))) => ((! [Xz:$i] : (Xph => (cwss @ XA2 @ (cco @ (XB2 @ Xz) @ (XC @ Xz) @ ccicc)))) => ((Xph => (XA2 != cc0)) => ((Xph => (cwcel @ XD @ XA2)) => ((! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XA2)) => (cwbr @ (ccv @ Xz) @ XD @ ccle))) => (Xph => (cwbr @ (ccsup @ XA2 @ ccr @ cclt) @ XD @ ccle)))))))))))))).
