...
thf(afiint_thm,conjecture,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & ((ccv @ Xx3) != cc0) & (cwcel @ (ccv @ Xx3) @ ccfn)) => (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2)))))).
