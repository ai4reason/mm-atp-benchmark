...
thf(antrl2v2e_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccs1 @ (ccpr @ XX @ XY))) => ((XF = (ccs2 @ ccc0 @ ccc0)) => ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((XP = (ccs3 @ XX @ XY @ XX)) => ((XG = (ccop @ (ccpr @ XX @ XY) @ XI)) => (~ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)))))))))))))))).
