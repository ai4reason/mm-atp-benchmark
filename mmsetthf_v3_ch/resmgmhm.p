...
thf(aresmgmhm_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccmgmhm)) & (cwcel @ XX @ (ccfv @ XS @ ccsubmgm))) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccmgmhm)))))))))).
