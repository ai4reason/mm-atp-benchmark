...
thf(asubsubc_thm,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((XD = (cco @ XC @ XH @ ccresc)) => ((cwcel @ XH @ (ccfv @ XC @ ccsubc)) => ((cwcel @ XJ @ (ccfv @ XD @ ccsubc)) <=> ((cwcel @ XJ @ (ccfv @ XC @ ccsubc)) & (cwbr @ XJ @ XH @ ccssc)))))))))).
