...
thf(accatfval_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XS @ (XV @ Xx3)) & (cwcel @ XT @ (XW @ Xx3))) => ((cco @ XS @ XT @ ccconcat) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XS @ cchash) @ (ccfv @ XT @ cchash) @ ccaddc) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfzo)) @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccfv @ XS @ cchash) @ ccmin) @ XT)))))))))))).
