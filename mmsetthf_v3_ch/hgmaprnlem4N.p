...
thf(adf_hgmap_ax,axiom,(cchg = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (^ [Xa:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xm:$i] : (cwcel @ (ccv @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xb)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccfv @ (ccv @ Xu) @ ccvsca)) @ (ccv @ Xm)) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xm)) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cclcd)) @ ccvsca)))) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xu) @ ccbs)))) @ (^ [Xy1:$i] : (ccv @ Xb))))))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cchdma)))) @ (ccfv @ (ccfv @ (ccv @ Xu) @ ccsca) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)))))))))).
thf(ahgmapffval_thm,axiom,(! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XH @ Xx3 @ Xy1 @ Xv @ Xu @ Xm @ Xa @ Xb) = (ccfv @ XK @ cclh))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XK @ (XX @ Xx3 @ Xy1 @ Xw @ Xv @ Xu @ Xm @ Xa @ Xb)) => ((ccfv @ XK @ cchg) = (ccmpt @ (^ [Xw:$i] : (XH @ Xx3 @ Xy1 @ Xv @ Xu @ Xm @ Xa @ Xb)) @ (^ [Xw:$i] : (^ [Xa:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xm:$i] : (cwcel @ (ccv @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xb)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccfv @ (ccv @ Xu) @ ccvsca)) @ (ccv @ Xm)) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xm)) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cclcd)) @ ccvsca)))) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xu) @ ccbs)))) @ (^ [Xy1:$i] : (ccv @ Xb))))))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cchdma)))) @ (ccfv @ (ccfv @ (ccv @ Xu) @ ccsca) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh))))))))))))))))))))).
...
thf(ahgmapfnN_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XR = (ccfv @ XU @ ccsca)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cchg))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => (Xph => (cwfn @ XG @ XB2))))))))))))))))).
...
thf(ahgmapdcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XR = (ccfv @ XU @ ccsca)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((XQ = (ccfv @ XC @ ccsca)) => ((XA2 = (ccfv @ XQ @ ccbs)) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cchg))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XF @ XB2)) => (Xph => (cwcel @ (ccfv @ XF @ XG) @ XA2))))))))))))))))))))))))).
...
thf(ahgmaprnlem1N_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_xb:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_x:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_0:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XH @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XK @ Xz @ Xt @ Xk @ Xs1) @ cclh)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XU @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xk @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xk @ Xs1) @ ccdvh))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XV @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xk @ Xs1) @ ccbs)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XR @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xk @ Xs1) @ ccsca)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XB2 @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XR @ Xz @ Xt @ Xk @ Xs1) @ ccbs)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xc_x @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xk @ Xs1) @ ccvsca)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xc_0 @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xk @ Xs1) @ cc0g)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XC @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xk @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xk @ Xs1) @ cclcd))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XD @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xk @ Xs1) @ ccbs)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XP @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xk @ Xs1) @ ccsca)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XA2 @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XP @ Xz @ Xt @ Xk @ Xs1) @ ccbs)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xc_xb @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xk @ Xs1) @ ccvsca)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XQ @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xk @ Xs1) @ cc0g)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XS @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xk @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xk @ Xs1) @ cchdma))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XG @ Xz @ Xt @ Xk @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xk @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xk @ Xs1) @ cchg))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => ((cwcel @ (XK @ Xz @ Xt @ Xk @ Xs1) @ cchlt) & (cwcel @ (XW @ Xz @ Xt @ Xk @ Xs1) @ (XH @ Xz @ Xt @ Xk @ Xs1)))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => (cwcel @ (ccv @ Xz) @ (XA2 @ Xz @ Xt @ Xk @ Xs1))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => (cwcel @ (ccv @ Xt) @ (ccdif @ (XV @ Xz @ Xt @ Xk @ Xs1) @ (ccsn @ (Xc_0 @ Xz @ Xt @ Xk @ Xs1))))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => (cwcel @ (ccv @ Xs1) @ (XV @ Xz @ Xt @ Xk @ Xs1))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => ((ccfv @ (ccv @ Xs1) @ (XS @ Xz @ Xt @ Xk @ Xs1)) = (cco @ (ccv @ Xz) @ (ccfv @ (ccv @ Xt) @ (XS @ Xz @ Xt @ Xk @ Xs1)) @ (Xc_xb @ Xz @ Xt @ Xk @ Xs1)))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => (cwcel @ (ccv @ Xk) @ (XB2 @ Xz @ Xt @ Xk @ Xs1))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => ((ccv @ Xs1) = (cco @ (ccv @ Xk) @ (ccv @ Xt) @ (Xc_x @ Xz @ Xt @ Xk @ Xs1)))))))) => (! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xk @ Xs1) => (cwcel @ (ccv @ Xz) @ (ccrn @ (XG @ Xz @ Xt @ Xk @ Xs1))))))))))))))))))))))))))))))))))))))))))))))))).
thf(ahgmaprnlem2N_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xb:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XH @ Xz @ Xt @ Xs1) = (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cclh))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XU @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ ccdvh)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XV @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XR @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ ccsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XB2 @ Xz @ Xt @ Xs1) = (ccfv @ (XR @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xc_x @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ ccvsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xc_0 @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ cc0g))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XC @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cclcd)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XD @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XP @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ ccsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XA2 @ Xz @ Xt @ Xs1) = (ccfv @ (XP @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xc_xb @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ ccvsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XQ @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ cc0g))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XS @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cchdma)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XG @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cchg)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => ((cwcel @ (XK @ Xz @ Xt @ Xs1) @ cchlt) & (cwcel @ (XW @ Xz @ Xt @ Xs1) @ (XH @ Xz @ Xt @ Xs1))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwcel @ (ccv @ Xz) @ (XA2 @ Xz @ Xt @ Xs1)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwcel @ (ccv @ Xt) @ (ccdif @ (XV @ Xz @ Xt @ Xs1) @ (ccsn @ (Xc_0 @ Xz @ Xt @ Xs1)))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwcel @ (ccv @ Xs1) @ (XV @ Xz @ Xt @ Xs1)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => ((ccfv @ (ccv @ Xs1) @ (XS @ Xz @ Xt @ Xs1)) = (cco @ (ccv @ Xz) @ (ccfv @ (ccv @ Xt) @ (XS @ Xz @ Xt @ Xs1)) @ (Xc_xb @ Xz @ Xt @ Xs1))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XM @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ ccmpd)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XN @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ cclspn))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XL @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ cclspn))))) => (! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwss @ (ccfv @ (ccsn @ (ccv @ Xs1)) @ (XN @ Xz @ Xt @ Xs1)) @ (ccfv @ (ccsn @ (ccv @ Xt)) @ (XN @ Xz @ Xt @ Xs1)))))))))))))))))))))))))))))))))))))))))))))))))))).
thf(ahgmaprnlem3N_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xb:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XH @ Xz @ Xt @ Xs1) = (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cclh))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XU @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ ccdvh)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XV @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XR @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ ccsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XB2 @ Xz @ Xt @ Xs1) = (ccfv @ (XR @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xc_x @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ ccvsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xc_0 @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ cc0g))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XC @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cclcd)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XD @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XP @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ ccsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XA2 @ Xz @ Xt @ Xs1) = (ccfv @ (XP @ Xz @ Xt @ Xs1) @ ccbs))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xc_xb @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ ccvsca))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XQ @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ cc0g))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XS @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cchdma)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XG @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ cchg)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => ((cwcel @ (XK @ Xz @ Xt @ Xs1) @ cchlt) & (cwcel @ (XW @ Xz @ Xt @ Xs1) @ (XH @ Xz @ Xt @ Xs1))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwcel @ (ccv @ Xz) @ (XA2 @ Xz @ Xt @ Xs1)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwcel @ (ccv @ Xt) @ (ccdif @ (XV @ Xz @ Xt @ Xs1) @ (ccsn @ (Xc_0 @ Xz @ Xt @ Xs1)))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwcel @ (ccv @ Xs1) @ (XV @ Xz @ Xt @ Xs1)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => ((ccfv @ (ccv @ Xs1) @ (XS @ Xz @ Xt @ Xs1)) = (cco @ (ccv @ Xz) @ (ccfv @ (ccv @ Xt) @ (XS @ Xz @ Xt @ Xs1)) @ (Xc_xb @ Xz @ Xt @ Xs1))))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XM @ Xz @ Xt @ Xs1) = (ccfv @ (XW @ Xz @ Xt @ Xs1) @ (ccfv @ (XK @ Xz @ Xt @ Xs1) @ ccmpd)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XN @ Xz @ Xt @ Xs1) = (ccfv @ (XU @ Xz @ Xt @ Xs1) @ cclspn))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XL @ Xz @ Xt @ Xs1) = (ccfv @ (XC @ Xz @ Xt @ Xs1) @ cclspn))))) => (! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xz @ Xt @ Xs1) => (cwcel @ (ccv @ Xz) @ (ccrn @ (XG @ Xz @ Xt @ Xs1)))))))))))))))))))))))))))))))))))))))))))))))))))).
thf(ahgmaprnlem4N_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_xb:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xt:$i] : ((XH @ Xz @ Xt) = (ccfv @ (XK @ Xz @ Xt) @ cclh)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XU @ Xz @ Xt) = (ccfv @ (XW @ Xz @ Xt) @ (ccfv @ (XK @ Xz @ Xt) @ ccdvh))))) => ((! [Xz:$i] : (! [Xt:$i] : ((XV @ Xz @ Xt) = (ccfv @ (XU @ Xz @ Xt) @ ccbs)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XR @ Xz @ Xt) = (ccfv @ (XU @ Xz @ Xt) @ ccsca)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XB2 @ Xz @ Xt) = (ccfv @ (XR @ Xz @ Xt) @ ccbs)))) => ((! [Xz:$i] : (! [Xt:$i] : ((Xc_x @ Xz @ Xt) = (ccfv @ (XU @ Xz @ Xt) @ ccvsca)))) => ((! [Xz:$i] : (! [Xt:$i] : ((Xc_0 @ Xz @ Xt) = (ccfv @ (XU @ Xz @ Xt) @ cc0g)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XC @ Xz @ Xt) = (ccfv @ (XW @ Xz @ Xt) @ (ccfv @ (XK @ Xz @ Xt) @ cclcd))))) => ((! [Xz:$i] : (! [Xt:$i] : ((XD @ Xz @ Xt) = (ccfv @ (XC @ Xz @ Xt) @ ccbs)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XP @ Xz @ Xt) = (ccfv @ (XC @ Xz @ Xt) @ ccsca)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XA2 @ Xz @ Xt) = (ccfv @ (XP @ Xz @ Xt) @ ccbs)))) => ((! [Xz:$i] : (! [Xt:$i] : ((Xc_xb @ Xz @ Xt) = (ccfv @ (XC @ Xz @ Xt) @ ccvsca)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XQ @ Xz @ Xt) = (ccfv @ (XC @ Xz @ Xt) @ cc0g)))) => ((! [Xz:$i] : (! [Xt:$i] : ((XS @ Xz @ Xt) = (ccfv @ (XW @ Xz @ Xt) @ (ccfv @ (XK @ Xz @ Xt) @ cchdma))))) => ((! [Xz:$i] : (! [Xt:$i] : ((XG @ Xz @ Xt) = (ccfv @ (XW @ Xz @ Xt) @ (ccfv @ (XK @ Xz @ Xt) @ cchg))))) => ((! [Xz:$i] : (! [Xt:$i] : ((Xph @ Xz @ Xt) => ((cwcel @ (XK @ Xz @ Xt) @ cchlt) & (cwcel @ (XW @ Xz @ Xt) @ (XH @ Xz @ Xt)))))) => ((! [Xz:$i] : (! [Xt:$i] : ((Xph @ Xz @ Xt) => (cwcel @ (ccv @ Xz) @ (XA2 @ Xz @ Xt))))) => ((! [Xz:$i] : (! [Xt:$i] : ((Xph @ Xz @ Xt) => (cwcel @ (ccv @ Xt) @ (ccdif @ (XV @ Xz @ Xt) @ (ccsn @ (Xc_0 @ Xz @ Xt))))))) => (! [Xz:$i] : (! [Xt:$i] : ((Xph @ Xz @ Xt) => (cwcel @ (ccv @ Xz) @ (ccrn @ (XG @ Xz @ Xt))))))))))))))))))))))))))))))))))))))))))).
