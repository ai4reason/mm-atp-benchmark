...
thf(ametss_thm,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ XD @ ccmopn)) => (((cwcel @ XC @ (ccfv @ XX @ ccxmt)) & (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((cwss @ XJ @ XK) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xs1) @ (ccfv @ XD @ ccbl)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XC @ ccbl)))) @ (^ [Xs1:$i] : ccrp))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX)))))))))))).
