...
thf(avcass_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XW @ cc1st)) => ((XS = (ccfv @ XW @ cc2nd)) => ((XX = (ccrn @ XG)) => (((cwcel @ XW @ ccvc) & ((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XC @ XS) = (cco @ XA2 @ (cco @ XB2 @ XC @ XS) @ XS)))))))))))))).
