...
thf(aeqerlem_thm,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XA2 @ Xx3 @ Xz @ Xw) = (XB2 @ Xy1 @ Xz @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XR @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((XA2 @ Xx3 @ Xz @ Xw) = (XB2 @ Xy1 @ Xz @ Xw)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)) <=> ((ccsb @ (ccv @ Xz) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz @ Xw))) = (ccsb @ (ccv @ Xw) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz @ Xw))))))))))))))).
