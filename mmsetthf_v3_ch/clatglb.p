...
thf(aclatglb_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XG = (ccfv @ XK @ ccglb)) => (((cwcel @ XK @ cccla) & (cwss @ XS @ XB2)) => ((cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ XS @ XG) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xy1:$i] : XS)) & (cwral @ (^ [Xz:$i] : ((cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xy1:$i] : XS)) => (cwbr @ (ccv @ Xz) @ (ccfv @ XS @ XG) @ Xc_le))) @ (^ [Xz:$i] : XB2))))))))))))).
