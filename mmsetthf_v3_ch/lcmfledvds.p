...
thf(alcmfledvds_thm,conjecture,(! [XK:($i > $o)] : (! [XZ:($i > $o)] : (((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn) & (~ (wnel @ ccc0 @ XZ))) => (((cwcel @ XK @ ccn) & (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ XK @ ccdvds)) @ (^ [Xm:$i] : XZ))) => (cwbr @ (ccfv @ XZ @ cclcmf) @ XK @ ccle)))))).
