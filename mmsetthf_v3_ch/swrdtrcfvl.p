...
thf(aswrdtrcfvl_thm,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) => ((ccfv @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ cclsw) = (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW)))))).
