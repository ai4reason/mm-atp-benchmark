...
thf(areadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ ccre) = (cco @ (ccfv @ XA2 @ ccre) @ (ccfv @ XB2 @ ccre) @ ccaddc)))))).
thf(aresub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccre) = (cco @ (ccfv @ XA2 @ ccre) @ (ccfv @ XB2 @ ccre) @ ccmin)))))).
thf(aremullem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccre) = (cco @ (cco @ (ccfv @ XA2 @ ccre) @ (ccfv @ XB2 @ ccre) @ ccmul) @ (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XB2 @ ccim) @ ccmul) @ ccmin)) & ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccim) = (cco @ (cco @ (ccfv @ XA2 @ ccre) @ (ccfv @ XB2 @ ccim) @ ccmul) @ (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XB2 @ ccre) @ ccmul) @ ccaddc)) & ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccmul))))))).
...
thf(aremul2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccre) = (cco @ XA2 @ (ccfv @ XB2 @ ccre) @ ccmul)))))).
thf(arediv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccr) & (XB2 != ccc0)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccre) = (cco @ (ccfv @ XA2 @ ccre) @ XB2 @ ccdiv)))))).
thf(aimcj_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccfv @ XA2 @ cccj) @ ccim) = (ccneg @ (ccfv @ XA2 @ ccim)))))).
thf(aimneg_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccneg @ XA2) @ ccim) = (ccneg @ (ccfv @ XA2 @ ccim)))))).
thf(aimadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ ccim) = (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XB2 @ ccim) @ ccaddc)))))).
thf(aimsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccim) = (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XB2 @ ccim) @ ccmin)))))).
...
thf(aimmul2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccim) = (cco @ XA2 @ (ccfv @ XB2 @ ccim) @ ccmul)))))).
thf(aimdiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccr) & (XB2 != ccc0)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccim) = (cco @ (ccfv @ XA2 @ ccim) @ XB2 @ ccdiv)))))).
...
thf(acjadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccaddc)))))).
thf(acjmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccmul)))))).
thf(aipcnval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ (ccfv @ XB2 @ cccj) @ ccmul) @ ccre) = (cco @ (cco @ (ccfv @ XA2 @ ccre) @ (ccfv @ XB2 @ ccre) @ ccmul) @ (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XB2 @ ccim) @ ccmul) @ ccaddc)))))).
thf(acjmulrcl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmul) @ ccr)))).
thf(acjmulval_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmul) = (cco @ (cco @ (ccfv @ XA2 @ ccre) @ cc2 @ ccexp) @ (cco @ (ccfv @ XA2 @ ccim) @ cc2 @ ccexp) @ ccaddc))))).
thf(acjmulge0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwbr @ ccc0 @ (cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmul) @ ccle)))).
thf(acjneg_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccneg @ XA2) @ cccj) = (ccneg @ (ccfv @ XA2 @ cccj)))))).
thf(aaddcj_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccaddc) = (cco @ cc2 @ (ccfv @ XA2 @ ccre) @ ccmul))))).
thf(acjsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccmin)))))).
thf(acjexp_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XA2 @ XN @ ccexp) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ XN @ ccexp)))))).
thf(aimval2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccim) = (cco @ (cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmin) @ (cco @ cc2 @ cci @ ccmul) @ ccdiv))))).
thf(are0_thm,axiom,((ccfv @ ccc0 @ ccre) = ccc0)).
thf(aim0_thm,axiom,((ccfv @ ccc0 @ ccim) = ccc0)).
thf(are1_thm,axiom,((ccfv @ cc1 @ ccre) = cc1)).
thf(aim1_thm,axiom,((ccfv @ cc1 @ ccim) = ccc0)).
thf(arei_thm,axiom,((ccfv @ cci @ ccre) = ccc0)).
thf(aimi_thm,axiom,((ccfv @ cci @ ccim) = cc1)).
thf(acj0_thm,axiom,((ccfv @ ccc0 @ cccj) = ccc0)).
thf(acji_thm,axiom,((ccfv @ cci @ cccj) = (ccneg @ cci))).
thf(acjreim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ cccj) = (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccmin)))))).
thf(acjreim2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccmin) @ cccj) = (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc)))))).
thf(acj11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((ccfv @ XA2 @ cccj) = (ccfv @ XB2 @ cccj)) <=> (XA2 = XB2)))))).
thf(acjne0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((XA2 != ccc0) <=> ((ccfv @ XA2 @ cccj) != ccc0))))).
thf(acjdiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (XB2 != ccc0)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccdiv)))))).
thf(acnrecnv_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cccnv @ (XF @ Xx3 @ Xy1)) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccop @ (ccfv @ (ccv @ Xz) @ ccre) @ (ccfv @ (ccv @ Xz) @ ccim)))))))))).
thf(asqeqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = (cco @ XB2 @ cc2 @ ccexp))) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle)) => (((Xph & ((ccfv @ XA2 @ ccre) = ccc0) & ((ccfv @ XB2 @ ccre) = ccc0)) => (XA2 = XB2)) => (Xph => (XA2 = XB2)))))))))))).
thf(arecli_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccfv @ XA2 @ ccre) @ ccr)))).
thf(aimcli_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccfv @ XA2 @ ccim) @ ccr)))).
thf(acjcli_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccfv @ XA2 @ cccj) @ ccc)))).
thf(areplimi_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (XA2 = (cco @ (ccfv @ XA2 @ ccre) @ (cco @ cci @ (ccfv @ XA2 @ ccim) @ ccmul) @ ccaddc))))).
