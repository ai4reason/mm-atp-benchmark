...
thf(ahausflf2_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ ccha) & (cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwf @ XY @ XX @ XF)) & ((ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) != cc0)) => (cwbr @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ cc1o @ ccen))))))))).
