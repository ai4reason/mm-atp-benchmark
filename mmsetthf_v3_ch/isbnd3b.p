...
thf(aisbnd3b_thm,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))).
