...
thf(asqrtmsq2i_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle)) => (((ccfv @ XA2 @ ccsqrt) = XB2) <=> (XA2 = (cco @ XB2 @ XB2 @ ccmul))))))))).
