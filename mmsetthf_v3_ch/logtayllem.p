...
thf(alogtayllem_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwcel @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccif @ ((ccv @ Xn) = ccc0) @ ccc0 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv)) @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ ccmul))) @ ccc0) @ (ccdm @ ccli))))).
