...
thf(aarwrid_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((Xc_x = (ccfv @ XC @ cccoa)) => ((Xc_1 = (ccfv @ XC @ ccida)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => (Xph => ((cco @ XF @ (ccfv @ XX @ Xc_1) @ Xc_x) = XF))))))))))))))).
