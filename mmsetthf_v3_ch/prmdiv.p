...
thf(aprmdiv_thm,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XR = (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) => (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz) & (~ (cwbr @ XP @ XA2 @ ccdvds))) => ((cwcel @ XR @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz)) & (cwbr @ XP @ (cco @ (cco @ XA2 @ XR @ ccmul) @ cc1 @ ccmin) @ ccdvds)))))))).
