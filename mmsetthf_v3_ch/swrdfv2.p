...
thf(aswrdfv2_thm,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XS @ (ccword @ XV)) & ((cwcel @ XF @ ccn0) & (cwcel @ XL @ (ccfv @ XF @ ccuz))) & (cwbr @ XL @ (ccfv @ XS @ cchash) @ ccle)) & (cwcel @ XX @ (cco @ XF @ XL @ ccfzo))) => ((ccfv @ (cco @ XX @ XF @ ccmin) @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr)) = (ccfv @ XX @ XS))))))))).
