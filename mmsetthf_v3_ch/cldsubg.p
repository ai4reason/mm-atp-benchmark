...
thf(acldsubg_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XR = (cco @ XG @ XS @ ccqg)) => ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ cctgp) & (cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ (ccqs @ XX @ XR) @ ccfn)) => ((cwcel @ XS @ (ccfv @ XJ @ cccld)) <=> (cwcel @ XS @ XJ)))))))))))).
