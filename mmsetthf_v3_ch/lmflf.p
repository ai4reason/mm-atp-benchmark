...
thf(almflf_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((XL = (cco @ XZ @ (ccima @ ccuz @ XZ) @ ccfg)) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XM @ ccz) & (cwf @ XZ @ XX @ XF)) => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwcel @ XP @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))))))))))))))).
