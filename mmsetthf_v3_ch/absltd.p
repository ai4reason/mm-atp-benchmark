...
thf(aabsltd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ (ccfv @ XA2 @ ccabs) @ XB2 @ cclt) <=> ((cwbr @ (ccneg @ XB2) @ XA2 @ cclt) & (cwbr @ XA2 @ XB2 @ cclt)))))))))).
