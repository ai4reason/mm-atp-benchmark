...
thf(axlt2add_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) => (((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XB2 @ XD @ cclt)) => (cwbr @ (cco @ XA2 @ XB2 @ ccxad) @ (cco @ XC @ XD @ ccxad) @ cclt)))))))).
