...
thf(afnunsn_thm,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccvv)) => ((Xph => (cwcel @ XY @ ccvv)) => ((Xph => (cwfn @ XF @ XD)) => ((XG = (ccun @ XF @ (ccsn @ (ccop @ XX @ XY)))) => ((XE = (ccun @ XD @ (ccsn @ XX))) => ((Xph => (~ (cwcel @ XX @ XD))) => (Xph => (cwfn @ XG @ XE)))))))))))))))).
