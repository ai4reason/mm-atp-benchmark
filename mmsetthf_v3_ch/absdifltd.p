...
thf(aabsdifltd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => ((cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ cclt) <=> ((cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ cclt) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))))))).
