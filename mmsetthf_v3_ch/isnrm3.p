...
thf(aisnrm3_thm,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccnrm) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xd:$i] : (((ccin @ (ccv @ Xc) @ (ccv @ Xd)) = cc0) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xc) @ (ccv @ Xx3)) & (cwss @ (ccv @ Xd) @ (ccv @ Xy1)) & ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))) @ (^ [Xd:$i] : (ccfv @ XJ @ cccld)))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld))))))).
