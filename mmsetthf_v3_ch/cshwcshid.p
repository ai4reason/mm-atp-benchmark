...
thf(acshwcshid_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xm:$i] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xn) => (cwcel @ (ccv @ Xy1) @ (ccword @ (XV @ Xx3 @ Xy1 @ Xn))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xn) => ((ccfv @ (ccv @ Xx3) @ cchash) = (ccfv @ (ccv @ Xy1) @ cchash)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xn) => (((cwcel @ (ccv @ Xm) @ (cco @ ccc0 @ (ccfv @ (ccv @ Xy1) @ cchash) @ ccfz)) & ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xm) @ cccsh))) => (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccfz)))))))))))))).
