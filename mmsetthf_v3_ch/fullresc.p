...
thf(afullresc_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchomf)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwss @ XS @ XB2)) => ((XD = (cco @ XC @ XS @ ccress)) => ((XE = (cco @ XC @ (ccres @ XH @ (ccxp @ XS @ XS)) @ ccresc)) => (Xph => (((ccfv @ XD @ cchomf) = (ccfv @ XE @ cchomf)) & ((ccfv @ XD @ cccomf) = (ccfv @ XE @ cccomf)))))))))))))))))).
