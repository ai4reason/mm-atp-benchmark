...
thf(aelfzm11_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwcel @ XK @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) <=> ((cwcel @ XK @ ccz) & (cwbr @ XM @ XK @ ccle) & (cwbr @ XK @ XN @ cclt)))))))).
