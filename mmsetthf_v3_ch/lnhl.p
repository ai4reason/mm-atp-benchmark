...
thf(alnhl_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XD @ XP)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ XL))) => (Xph => ((cwbr @ XC @ XA2 @ (ccfv @ XB2 @ XK)) | (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))))))))))))))))))))))))).
