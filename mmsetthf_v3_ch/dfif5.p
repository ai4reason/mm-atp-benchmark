...
thf(adfif5_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (^ [Xx3:$i] : Xph))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccun @ (ccin @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (ccun @ (ccin @ (ccdif @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (XC @ Xx3)) @ (ccin @ (ccdif @ (XB2 @ Xx3) @ (XA2 @ Xx3)) @ (ccdif @ ccvv @ (XC @ Xx3))))))))))))).
