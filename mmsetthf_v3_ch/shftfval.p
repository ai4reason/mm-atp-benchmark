...
thf(ashftfval_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwcel @ XA2 @ ccc) => ((cco @ XF @ XA2 @ ccshi) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ ccc) & (cwbr @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccv @ Xy1) @ XF))))))))))).
