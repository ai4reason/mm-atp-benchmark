...
thf(a_3decltcOLD_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwcel @ XE @ ccn0) => ((cwcel @ XF @ ccn0) => ((cwbr @ XC @ cc10 @ cclt) => ((cwbr @ XE @ cc10 @ cclt) => ((cwbr @ XA2 @ XB2 @ cclt) => (cwbr @ (ccdc @ (ccdc @ XA2 @ XC) @ XE) @ (ccdc @ (ccdc @ XB2 @ XD) @ XF) @ cclt))))))))))))))))).
