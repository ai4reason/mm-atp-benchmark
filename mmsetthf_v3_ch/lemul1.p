...
thf(alep1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ XA2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccle)))).
thf(altm1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ (cco @ XA2 @ cc1 @ ccmin) @ XA2 @ cclt)))).
thf(alem1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ (cco @ XA2 @ cc1 @ ccmin) @ XA2 @ ccle)))).
thf(aletrp1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccle))))).
thf(ap1le_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ (cco @ XA2 @ cc1 @ ccaddc) @ XB2 @ ccle)) => (cwbr @ XA2 @ XB2 @ ccle))))).
thf(arecgt0_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) => (cwbr @ ccc0 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt)))).
thf(aprodgt0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))) => (cwbr @ ccc0 @ XB2 @ cclt))))).
thf(aprodgt02_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XB2 @ ccle) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))) => (cwbr @ ccc0 @ XA2 @ cclt))))).
thf(aprodge0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ cclt) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle))) => (cwbr @ ccc0 @ XB2 @ ccle))))).
thf(aprodge02_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XB2 @ cclt) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle))) => (cwbr @ ccc0 @ XA2 @ ccle))))).
...
thf(alemul1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccle))))))).
