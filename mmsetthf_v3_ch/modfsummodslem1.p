...
thf(amodfsummodslem1_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xz:$i] : ((cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xz @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))))) => (cwcel @ (ccsb @ (ccv @ Xz) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) @ ccz)))))).
