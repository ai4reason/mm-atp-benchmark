...
thf(acshco_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwcel @ XN @ ccz) & (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XW @ XN @ cccsh)) = (cco @ (cccom @ XF @ XW) @ XN @ cccsh))))))))).
