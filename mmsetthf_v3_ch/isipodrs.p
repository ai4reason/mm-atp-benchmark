...
thf(aisipodrs_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) <=> ((cwcel @ XA2 @ ccvv) & (XA2 != cc0) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
