...
thf(aiswwlksnon_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon)) = (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = XA2) & ((ccfv @ XN @ (ccv @ Xw)) = XB2))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))))))))).
