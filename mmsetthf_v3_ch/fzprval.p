...
thf(afzprval_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccif @ ((ccv @ Xx3) = cc1) @ XA2 @ XB2))) @ (^ [Xx3:$i] : (cco @ cc1 @ cc2 @ ccfz))) <=> (((ccfv @ cc1 @ XF) = XA2) & ((ccfv @ cc2 @ XF) = XB2))))))).
