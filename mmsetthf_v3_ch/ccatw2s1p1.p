...
thf(accatw2s1p1_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = XN)) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ XN @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat)) = XX)))))))).
