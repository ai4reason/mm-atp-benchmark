...
thf(alesubd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccle)) => (Xph => (cwbr @ XC @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))))))).
