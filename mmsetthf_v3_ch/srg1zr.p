...
thf(asrg1zr_thm,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xc_as = (ccfv @ XR @ ccmulr)) => ((((cwcel @ XR @ ccsrg) & (cwfn @ Xc_pl @ (ccxp @ XB2 @ XB2)) & (cwfn @ Xc_as @ (ccxp @ XB2 @ XB2))) & (cwcel @ XZ @ XB2)) => ((XB2 = (ccsn @ XZ)) <=> ((Xc_pl = (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))) & (Xc_as = (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))))))))))))))).
