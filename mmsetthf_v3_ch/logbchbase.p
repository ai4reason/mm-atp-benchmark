...
thf(alogbchbase_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & (XA2 != cc1)) & ((cwcel @ XB2 @ ccc) & (XB2 != ccc0) & (XB2 != cc1)) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((cco @ XA2 @ XX @ cclogb) = (cco @ (cco @ XB2 @ XX @ cclogb) @ (cco @ XB2 @ XA2 @ cclogb) @ ccdiv))))))).
