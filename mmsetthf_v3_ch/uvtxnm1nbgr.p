...
thf(auvtxnm1nbgr_thm,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ (ccfv @ XG @ ccuvtx))) => ((ccfv @ (cco @ XG @ XN @ ccnbgr) @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)))))))).
