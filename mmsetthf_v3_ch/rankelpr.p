...
thf(arankelpr_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (((cwcel @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XC @ ccrnk)) & (cwcel @ (ccfv @ XB2 @ ccrnk) @ (ccfv @ XD @ ccrnk))) => (cwcel @ (ccfv @ (ccpr @ XA2 @ XB2) @ ccrnk) @ (ccfv @ (ccpr @ XC @ XD) @ ccrnk)))))))))))).
