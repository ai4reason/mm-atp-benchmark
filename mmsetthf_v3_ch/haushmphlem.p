...
thf(ahaushmphlem_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XJ @ XA2) => (cwcel @ XJ @ cctop)) => ((! [Xf1:$i] : (((cwcel @ XJ @ XA2) & (cwf1 @ (ccuni @ XK) @ (ccuni @ XJ) @ (ccv @ Xf1)) & (cwcel @ (ccv @ Xf1) @ (cco @ XK @ XJ @ cccn))) => (cwcel @ XK @ XA2))) => ((cwbr @ XJ @ XK @ cchmph) => ((cwcel @ XJ @ XA2) => (cwcel @ XK @ XA2))))))))).
