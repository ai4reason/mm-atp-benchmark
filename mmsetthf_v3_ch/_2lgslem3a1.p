...
thf(a_2lgslem3a1_thm,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XP @ ccn) & ((cco @ XP @ cc8 @ ccmo) = cc1)) => ((cco @ XN @ cc2 @ ccmo) = ccc0)))))).
