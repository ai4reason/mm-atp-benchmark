...
thf(arestlly_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xj)))) => (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ ccrest) @ XA2)))) => ((Xph => (cwss @ XA2 @ cctop)) => (Xph => (cwss @ XA2 @ (cclly @ XA2)))))))).
