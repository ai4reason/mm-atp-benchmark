...
thf(abitsinvp1_thm,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (cccnv @ (ccres @ ccbits @ ccn0))) => (((cwss @ XA2 @ ccn0) & (cwcel @ XN @ ccn0)) => ((ccfv @ (ccin @ XA2 @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)) @ XK) = (cco @ (ccfv @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ XK) @ (ccif @ (cwcel @ XN @ XA2) @ (cco @ cc2 @ XN @ ccexp) @ ccc0) @ ccaddc)))))))).
