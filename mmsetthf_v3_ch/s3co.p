...
thf(as3co_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwf @ XX @ XY @ XF)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XX)) => (Xph => ((cccom @ XF @ (ccs3 @ XA2 @ XB2 @ XC)) = (ccs3 @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ (ccfv @ XC @ XF)))))))))))))))).
