...
thf(atmsxps_thm,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ (cco @ (ccfv @ XM @ cctmt) @ (ccfv @ XN @ cctmt) @ ccxps) @ ccds)) => ((Xph => (cwcel @ XM @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => (Xph => (cwcel @ XP @ (ccfv @ (ccxp @ XX @ XY) @ ccxmt))))))))))))).
