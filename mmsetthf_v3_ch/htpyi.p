...
thf(ahtpyi_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)))) => ((Xph & (cwcel @ XA2 @ XX)) => (((cco @ XA2 @ ccc0 @ XH) = (ccfv @ XA2 @ XF)) & ((cco @ XA2 @ cc1 @ XH) = (ccfv @ XA2 @ XG))))))))))))))))).
