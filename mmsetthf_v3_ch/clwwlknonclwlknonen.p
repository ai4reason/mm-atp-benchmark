...
thf(aclwwlknonclwlknonen_thm,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XX @ (ccfv @ XG @ ccvtx)) & (cwcel @ XN @ ccn)) => (cwbr @ (ccrab @ (^ [Xw:$i] : (((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN) & ((ccfv @ ccc0 @ (ccfv @ (ccv @ Xw) @ cc2nd)) = XX))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ ccen)))))).
