...
thf(arplogsumlem1_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwbr @ (ccsu @ (cco @ cc2 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccmul) @ ccdiv))) @ cc2 @ ccle)))).
