...
thf(aintab_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((cwcel @ (^ [Xx3:$i] : (? [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XA2 @ Xy1))))) @ ccvv) => ((ccint @ (^ [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XA2 @ Xy1) @ (ccv @ Xx3)))))) = (^ [Xx3:$i] : (? [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XA2 @ Xy1))))))))))).
