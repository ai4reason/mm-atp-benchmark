...
thf(afldivndvdslt_thm,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XK @ ccz) & ((cwcel @ XL @ ccz) & (XL != ccc0)) & (~ (cwbr @ XL @ XK @ ccdvds))) => (cwbr @ (ccfv @ (cco @ XK @ XL @ ccdiv) @ ccfl) @ (cco @ XK @ XL @ ccdiv) @ cclt))))).
