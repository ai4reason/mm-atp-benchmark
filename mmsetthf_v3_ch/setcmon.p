...
thf(asetcmon_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XU)) => ((Xph => (cwcel @ XY @ XU)) => ((XM = (ccfv @ XC @ ccmon)) => (Xph => ((cwcel @ XF @ (cco @ XX @ XY @ XM)) <=> (cwf1 @ XX @ XY @ XF))))))))))))))))).
