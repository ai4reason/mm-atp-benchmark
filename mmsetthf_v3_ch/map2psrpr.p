...
thf(amap2psrpr_thm,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnr) => ((cwbr @ (cco @ XC @ ccm1r @ ccplr) @ XA2 @ ccltr) <=> (cwrex @ (^ [Xx3:$i] : ((cco @ XC @ (ccec @ (ccop @ (ccv @ Xx3) @ cc1p) @ ccer) @ ccplr) = XA2)) @ (^ [Xx3:$i] : ccnp))))))).
