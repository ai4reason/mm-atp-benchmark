...
thf(anfsb4t_b_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xz:$i] : (Xph @ Xx3 @ Xz)) @ X)) => (! [X:$i] : ((^ [Xz:$i] : (Xph @ Xx3 @ Xz)) @ X)))) => ((~ (! [Xz:$i] : ((ccv @ Xz) = (ccv @ Xx3)))) => ((? [X:$i] : ((^ [Xz:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xz)) @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xz:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xz)) @ Xx3)) @ X)))))))).
