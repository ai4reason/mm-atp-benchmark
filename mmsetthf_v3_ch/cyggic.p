...
thf(acyggic_thm,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XC = (ccfv @ XH @ ccbs)) => (((cwcel @ XG @ cccyg) & (cwcel @ XH @ cccyg)) => ((cwbr @ XG @ XH @ ccgic) <=> (cwbr @ XB2 @ XC @ ccen)))))))))).
