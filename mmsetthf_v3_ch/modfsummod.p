...
thf(amodfsummod_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XN @ ccn))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : XA2)))) => (! [Xk:$i] : ((Xph @ Xk) => ((cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ XN @ ccmo) = (cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XN @ ccmo))) @ XN @ ccmo)))))))))))).
