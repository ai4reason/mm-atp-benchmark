...
thf(acmetcusp1_thm,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XF @ ccbs)) => ((XD = (ccres @ (ccfv @ XF @ ccds) @ (ccxp @ XX @ XX))) => ((XU = (ccfv @ XF @ ccuss)) => (((XX != cc0) & (cwcel @ XF @ cccms) & (XU = (ccfv @ XD @ ccmetu))) => (cwcel @ XF @ cccusp)))))))))).
