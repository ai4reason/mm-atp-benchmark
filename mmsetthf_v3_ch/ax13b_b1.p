...
thf(aax13b_b1_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xx3)) => (Xph @ Xx3 @ Xy1))) <=> ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xy1) = (ccv @ Xx3)) => (Xph @ Xx3 @ Xy1))))))))).
