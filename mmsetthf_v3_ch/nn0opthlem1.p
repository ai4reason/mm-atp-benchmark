...
thf(ann0opthlem1_thm,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwbr @ XA2 @ XC @ cclt) <=> (cwbr @ (cco @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ cc2 @ XA2 @ ccmul) @ ccaddc) @ (cco @ XC @ XC @ ccmul) @ cclt))))))).
