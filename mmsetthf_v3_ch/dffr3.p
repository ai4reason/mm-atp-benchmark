...
thf(adffr3_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwfr @ XA2 @ XR) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & ((ccv @ Xx3) != cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xx3) @ (ccima @ (cccnv @ XR) @ (ccsn @ (ccv @ Xy1)))) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
