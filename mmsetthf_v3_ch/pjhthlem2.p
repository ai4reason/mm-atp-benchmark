...
thf(apjhthlem2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((Xph => (cwcel @ XA2 @ cchil)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XA2 = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : (ccfv @ XH @ ccort)))) @ (^ [Xx3:$i] : XH))))))))).
