...
thf(acoa2_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_x = (ccfv @ XC @ cccoa)) => ((XH = (ccfv @ XC @ cchoma)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ XH))) => ((Xc_xb = (ccfv @ XC @ ccco)) => (Xph => ((ccfv @ (cco @ XG @ XF @ Xc_x) @ cc2nd) = (cco @ (ccfv @ XG @ cc2nd) @ (ccfv @ XF @ cc2nd) @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_xb)))))))))))))))))))).
