...
thf(adfac5lem2_thm,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [Xg1:$i] : ((! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : ((XA2 @ Xu @ Xt @ Xh) = (^ [Xu:$i] : (((ccv @ Xu) != cc0) & (cwrex @ (^ [Xt:$i] : ((ccv @ Xu) = (ccxp @ (ccsn @ (ccv @ Xt)) @ (ccv @ Xt)))) @ (^ [Xt:$i] : (ccv @ Xh))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : ((cwcel @ (ccop @ (ccv @ Xw) @ (ccv @ Xg1)) @ (ccuni @ (XA2 @ Xu @ Xt @ Xh))) <=> ((cwcel @ (ccv @ Xw) @ (ccv @ Xh)) & (cwcel @ (ccv @ Xg1) @ (ccv @ Xw)))))))))))).
