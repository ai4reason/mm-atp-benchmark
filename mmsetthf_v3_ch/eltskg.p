...
thf(aeltskg_thm,conjecture,(! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ XT @ (XV @ Xz @ Xw)) => ((cwcel @ XT @ cctsk) <=> ((cwral @ (^ [Xz:$i] : ((cwss @ (ccpw @ (ccv @ Xz)) @ XT) & (cwrex @ (^ [Xw:$i] : (cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xw))) @ (^ [Xw:$i] : XT)))) @ (^ [Xz:$i] : XT)) & (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ XT @ ccen) | (cwcel @ (ccv @ Xz) @ XT))) @ (^ [Xz:$i] : (ccpw @ XT))))))))))).
