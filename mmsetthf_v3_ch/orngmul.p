...
thf(aorngmul_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_le = (ccfv @ XR @ ccple)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccorng) & ((cwcel @ XX @ XB2) & (cwbr @ Xc_0 @ XX @ Xc_le)) & ((cwcel @ XY @ XB2) & (cwbr @ Xc_0 @ XY @ Xc_le))) => (cwbr @ Xc_0 @ (cco @ XX @ XY @ Xc_x) @ Xc_le)))))))))))))).
