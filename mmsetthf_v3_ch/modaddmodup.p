...
thf(amodaddmodup_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XM @ ccn)) => ((cwcel @ XB2 @ (cco @ (cco @ XM @ (cco @ XA2 @ XM @ ccmo) @ ccmin) @ XM @ ccfzo)) => ((cco @ (cco @ XB2 @ (cco @ XA2 @ XM @ ccmo) @ ccaddc) @ XM @ ccmin) = (cco @ (cco @ XB2 @ XA2 @ ccaddc) @ XM @ ccmo)))))))).
