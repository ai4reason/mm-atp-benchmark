...
thf(acnrecnv_thm,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cccnv @ (XF @ Xx3 @ Xy1)) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccop @ (ccfv @ (ccv @ Xz) @ ccre) @ (ccfv @ (ccv @ Xz) @ ccim)))))))))).
