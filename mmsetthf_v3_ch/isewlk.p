...
thf(aisewlk_thm,conjecture,(! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xk:$i] : ((XI @ Xk) = (ccfv @ XG @ cciedg))) => (! [Xk:$i] : (((cwcel @ XG @ XW) & (cwcel @ XS @ ccxnn0) & (cwcel @ XF @ (XU @ Xk))) => ((cwcel @ XF @ (cco @ XG @ XS @ ccewlks)) <=> ((cwcel @ XF @ (ccword @ (ccdm @ (XI @ Xk)))) & (cwral @ (^ [Xk:$i] : (cwbr @ XS @ (ccfv @ (ccin @ (ccfv @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ XF) @ (XI @ Xk)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (XI @ Xk))) @ cchash) @ ccle)) @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo))))))))))))))).
