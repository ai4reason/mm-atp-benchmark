...
thf(assprsseq_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (XA2 != XB2)) => ((cwss @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) <=> ((ccpr @ XA2 @ XB2) = (ccpr @ XC @ XD))))))))))).
