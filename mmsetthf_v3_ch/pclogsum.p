...
thf(apclogsum_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((ccsu @ (ccin @ (cco @ cc1 @ XA2 @ ccfz) @ ccprime) @ (^ [Xp:$i] : (cco @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ (ccfv @ (ccv @ Xp) @ cclog) @ ccmul))) = (ccfv @ XA2 @ cclog))))).
