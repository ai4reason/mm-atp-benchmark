...
thf(atz6_12f_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xy1:$i] : (XF @ Xy1))) => (! [Xy1:$i] : (((cwcel @ (ccop @ XA2 @ (ccv @ Xy1)) @ (XF @ Xy1)) & (cweu @ (^ [Xy1:$i] : (cwcel @ (ccop @ XA2 @ (ccv @ Xy1)) @ (XF @ Xy1))))) => ((ccfv @ XA2 @ (XF @ Xy1)) = (ccv @ Xy1)))))))).
