...
thf(aqsdisj_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwer @ XX @ XR)) => ((Xph => (cwcel @ XB2 @ (ccqs @ XA2 @ XR))) => ((Xph => (cwcel @ XC @ (ccqs @ XA2 @ XR))) => (Xph => ((XB2 = XC) | ((ccin @ XB2 @ XC) = cc0))))))))))))).
