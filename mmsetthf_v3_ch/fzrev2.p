...
thf(afzrev2_thm,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cwcel @ XJ @ ccz) & (cwcel @ XK @ ccz))) => ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) <=> (cwcel @ (cco @ XJ @ XK @ ccmin) @ (cco @ (cco @ XJ @ XN @ ccmin) @ (cco @ XJ @ XM @ ccmin) @ ccfz))))))))).
