...
thf(alogdiflbnd_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (cco @ cc1 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ cclog) @ ccmin) @ ccle)))).
