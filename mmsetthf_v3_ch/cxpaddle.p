...
thf(acxpaddle_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XB2 @ ccle)) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => (cwbr @ XC @ cc1 @ ccle)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cccxp) @ (cco @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XB2 @ XC @ cccxp) @ ccaddc) @ ccle))))))))))))).
