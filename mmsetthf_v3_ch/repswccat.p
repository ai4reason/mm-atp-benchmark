...
thf(arepswccat_thm,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => ((cco @ (cco @ XS @ XN @ ccreps) @ (cco @ XS @ XM @ ccreps) @ ccconcat) = (cco @ XS @ (cco @ XN @ XM @ ccaddc) @ ccreps)))))))).
