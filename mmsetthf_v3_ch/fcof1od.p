...
thf(afcof1od_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XB2 @ XA2 @ XG)) => ((Xph => ((cccom @ XG @ XF) = (ccres @ ccid @ XA2))) => ((Xph => ((cccom @ XF @ XG) = (ccres @ ccid @ XB2))) => (Xph => (cwf1o @ XA2 @ XB2 @ XF)))))))))))).
