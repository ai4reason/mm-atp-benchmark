...
thf(aswrd0len_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((ccfv @ (cco @ XS @ (ccop @ ccc0 @ XL) @ ccsubstr) @ cchash) = XL)))))).
