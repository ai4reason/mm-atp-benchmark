...
thf(amuladd11_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ cc1 @ XB2 @ ccaddc) @ ccmul) = (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccaddc) @ ccaddc)))))).
