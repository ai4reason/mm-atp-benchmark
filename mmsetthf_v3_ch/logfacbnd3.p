...
thf(alogfacbnd3_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccfv @ XA2 @ ccfl) @ ccfa) @ cclog) @ (cco @ XA2 @ (cco @ (ccfv @ XA2 @ cclog) @ cc1 @ ccmin) @ ccmul) @ ccmin) @ ccabs) @ (cco @ (ccfv @ XA2 @ cclog) @ cc1 @ ccaddc) @ ccle)))).
