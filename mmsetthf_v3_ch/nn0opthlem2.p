...
thf(ann0opthlem2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt) => ((cco @ (cco @ XC @ XC @ ccmul) @ XD @ ccaddc) != (cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccmul) @ XB2 @ ccaddc)))))))))))).
