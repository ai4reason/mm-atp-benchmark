...
thf(aioorval_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (ccrn @ ccioo)) => ((ccfv @ XA2 @ (XF @ Xx3)) = (ccif @ (XA2 = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ XA2 @ ccxr @ cclt) @ (ccsup @ XA2 @ ccxr @ cclt)))))))))).
