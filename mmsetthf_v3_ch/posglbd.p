...
thf(aposglbd_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xph => (XB2 = (ccfv @ XK @ ccbs))) => ((Xph => (XG = (ccfv @ XK @ ccglb))) => ((Xph => (cwcel @ XK @ ccpo)) => ((Xph => (cwss @ XS @ XB2)) => ((Xph => (cwcel @ XT @ XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwbr @ XT @ (ccv @ Xx3) @ Xc_le))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_le)) @ (^ [Xx3:$i] : XS))) => (cwbr @ (ccv @ Xy1) @ XT @ Xc_le))) => (Xph => ((ccfv @ XS @ XG) = XT)))))))))))))))))).
