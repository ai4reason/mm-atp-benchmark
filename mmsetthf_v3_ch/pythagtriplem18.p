...
thf(apythagtriplem18_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwcel @ XC @ ccn)) & ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) & (((cco @ XA2 @ XB2 @ ccgcd) = cc1) & (~ (cwbr @ cc2 @ XA2 @ ccdvds)))) => (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : ((XA2 = (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin)) & (XB2 = (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul)) & (XC = (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc)))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn))))))).
