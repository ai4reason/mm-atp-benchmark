...
thf(alejdiri_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwss @ (cco @ (ccin @ XA2 @ XB2) @ XC @ cchj) @ (ccin @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XC @ cchj)))))))))).
