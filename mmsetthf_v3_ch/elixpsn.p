...
thf(aelixpsn_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : XB2))) <=> (cwrex @ (^ [Xy1:$i] : (XF = (ccsn @ (ccop @ XA2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XB2))))))))).
