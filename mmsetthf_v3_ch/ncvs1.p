...
thf(ancvs1_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_x = (ccfv @ XG @ ccvsca)) => ((XF = (ccfv @ XG @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XG @ (ccin @ ccnvc @ cccvs)) & ((cwcel @ XA2 @ XX) & (XA2 != Xc_0)) & (cwcel @ (cco @ cc1 @ (ccfv @ XA2 @ XN) @ ccdiv) @ XK)) => ((ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ XN) @ ccdiv) @ XA2 @ Xc_x) @ XN) = cc1))))))))))))))))).
