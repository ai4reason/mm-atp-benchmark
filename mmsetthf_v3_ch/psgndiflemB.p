...
thf(apsgndiflemB_thm,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XP @ Xi @ Xn) = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XT @ Xi @ Xn @ Xq) = (ccrn @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpmtr)))))) => ((! [Xq:$i] : ((XS @ Xq) = (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccsymg))) => ((! [Xq:$i] : ((XZ @ Xq) = (ccfv @ (XN @ Xq) @ ccsymg))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XR @ Xi @ Xn @ Xq) = (ccrn @ (ccfv @ (XN @ Xq) @ ccpmtr)))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((((cwcel @ (XN @ Xq) @ ccfn) & (cwcel @ XK @ (XN @ Xq))) & (cwcel @ (XQ @ Xi @ Xn) @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : (XP @ Xi @ Xn))))) => (((cwcel @ (XW @ Xq) @ (ccword @ (XT @ Xi @ Xn @ Xq))) & ((ccres @ (XQ @ Xi @ Xn) @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) = (cco @ (XS @ Xq) @ (XW @ Xq) @ ccgsu))) => (((cwcel @ (XU @ Xq) @ (ccword @ (XR @ Xi @ Xn @ Xq))) & ((ccfv @ (XW @ Xq) @ cchash) = (ccfv @ (XU @ Xq) @ cchash)) & (cwral @ (^ [Xi:$i] : (((ccfv @ XK @ (ccfv @ (ccv @ Xi) @ (XU @ Xq))) = XK) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xi) @ (XW @ Xq))) = (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xi) @ (XU @ Xq))))) @ (^ [Xn:$i] : (ccdif @ (XN @ Xq) @ (ccsn @ XK)))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ (XW @ Xq) @ cchash) @ ccfzo)))) => ((XQ @ Xi @ Xn) = (cco @ (XZ @ Xq) @ (XU @ Xq) @ ccgsu)))))))))))))))))))))))).
