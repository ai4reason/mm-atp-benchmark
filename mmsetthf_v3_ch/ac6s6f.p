...
thf(aac6s6f_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XA2 @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((? [X:$i] : ((^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xf1)) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xf1)) @ X))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xy1 @ Xf1)))))) => ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) => (! [Xy1:$i] : (? [Xf1:$i] : (cwral @ (^ [Xx3:$i] : ((? [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (Xps @ Xx3 @ Xy1 @ Xf1))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))))))))))))).
