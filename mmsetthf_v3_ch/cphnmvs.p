...
thf(acphnmvs_thm,conjecture,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XX @ XK) & (cwcel @ XY @ XV)) => ((ccfv @ (cco @ XX @ XY @ Xc_x) @ XN) = (cco @ (ccfv @ XX @ ccabs) @ (ccfv @ XY @ XN) @ ccmul))))))))))))))))).
