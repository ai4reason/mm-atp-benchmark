...
thf(aaffineequiv_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => (Xph => ((XB2 = (cco @ (cco @ XD @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XD @ ccmin) @ XC @ ccmul) @ ccaddc)) <=> ((cco @ XC @ XB2 @ ccmin) = (cco @ XD @ (cco @ XC @ XA2 @ ccmin) @ ccmul)))))))))))))).
