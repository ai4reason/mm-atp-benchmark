...
thf(agrpsubpropd2_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (XB2 = (ccfv @ XG @ ccbs))) => ((Xph => (XB2 = (ccfv @ XH @ ccbs))) => ((Xph => (cwcel @ XG @ ccgrp)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XG @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XH @ ccplusg)))))) => (Xph => ((ccfv @ XG @ ccsg) = (ccfv @ XH @ ccsg)))))))))))).
