...
thf(ataylpfval_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xk) @ ccc @ XF)))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwss @ (XA2 @ Xx3 @ Xk) @ XS)))) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XB2 @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))))) => ((! [Xk:$i] : ((XT @ Xk) = (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl)))) => (! [Xk:$i] : (Xph => ((XT @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ XB2 @ (ccfv @ (ccv @ Xk) @ (cco @ XS @ XF @ ccdvn))) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))))))))))))))).
