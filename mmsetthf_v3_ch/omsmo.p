...
thf(aomsmo_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : ((((cwss @ (XA2 @ Xx3) @ ccon0) & (cwf @ ccom @ (XA2 @ Xx3) @ XF)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF))) @ (^ [Xx3:$i] : ccom))) => (cwf1 @ ccom @ (XA2 @ Xx3) @ XF)))))).
