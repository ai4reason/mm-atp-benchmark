...
thf(arankc2_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ ccrnk) = (ccfv @ (ccuni @ XA2) @ ccrnk))) @ (^ [Xx3:$i] : XA2)) => ((ccfv @ XA2 @ ccrnk) = (ccsuc @ (ccfv @ (ccuni @ XA2) @ ccrnk))))))).
