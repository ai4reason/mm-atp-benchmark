...
thf(antreq0_thm,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => (((ccfv @ XS @ (ccfv @ XJ @ ccnt)) = cc0) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XS) => ((ccv @ Xx3) = cc0))) @ (^ [Xx3:$i] : XJ))))))))).
