...
thf(asuperpos_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccat) & (cwcel @ XB2 @ ccat) & (XA2 != XB2)) => (cwrex @ (^ [Xx3:$i] : (((ccv @ Xx3) != XA2) & ((ccv @ Xx3) != XB2) & (cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccat)))))).
