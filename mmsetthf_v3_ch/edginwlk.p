...
thf(aedginwlk_thm,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwfun @ XI) & (cwcel @ XF @ (ccword @ (ccdm @ XI))) & (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) => (cwcel @ (ccfv @ (ccfv @ XK @ XF) @ XI) @ XE)))))))))).
