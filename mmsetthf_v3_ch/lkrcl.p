...
thf(alkrcl_thm,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => (((cwcel @ XW @ XY) & (cwcel @ XG @ XF) & (cwcel @ XX @ (ccfv @ XG @ XK))) => (cwcel @ XX @ XV))))))))))))).
