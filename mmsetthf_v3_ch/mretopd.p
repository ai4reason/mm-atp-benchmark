...
thf(amretopd_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XB2 @ ccmre))) => ((Xph => (cwcel @ cc0 @ XM)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XM) & (cwcel @ (ccv @ Xy1) @ XM)) => (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XM)))) => ((! [Xz:$i] : ((XJ @ Xz) = (ccrab @ (^ [Xz:$i] : (cwcel @ (ccdif @ XB2 @ (ccv @ Xz)) @ XM)) @ (^ [Xz:$i] : (ccpw @ XB2))))) => (! [Xz:$i] : (Xph => ((cwcel @ (XJ @ Xz) @ (ccfv @ XB2 @ cctopon)) & (XM = (ccfv @ (XJ @ Xz) @ cccld)))))))))))))).
