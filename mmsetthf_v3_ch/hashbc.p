...
thf(ahashbc_thm,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XK @ ccz)) => ((cco @ (ccfv @ XA2 @ cchash) @ XK @ ccbc) = (ccfv @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = XK)) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ cchash)))))).
