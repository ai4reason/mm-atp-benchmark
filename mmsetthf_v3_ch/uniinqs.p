...
thf(auniinqs_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwer @ XX @ XR) => (((cwss @ XB2 @ (ccqs @ XA2 @ XR)) & (cwss @ XC @ (ccqs @ XA2 @ XR))) => ((ccuni @ (ccin @ XB2 @ XC)) = (ccin @ (ccuni @ XB2) @ (ccuni @ XC))))))))))).
