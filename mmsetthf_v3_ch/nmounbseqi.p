...
thf(anmounbseqi_thm,conjecture,(! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xk:$i] : (XX = (ccfv @ (XU @ Xf1 @ Xk) @ ccba)))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XY @ Xf1) = (ccfv @ (XW @ Xf1 @ Xk) @ ccba)))) => ((! [Xf1:$i] : (! [Xk:$i] : (XL = (ccfv @ (XU @ Xf1 @ Xk) @ ccnmcv)))) => ((! [Xf1:$i] : (! [Xk:$i] : (XM = (ccfv @ (XW @ Xf1 @ Xk) @ ccnmcv)))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XN @ Xf1) = (cco @ (XU @ Xf1 @ Xk) @ (XW @ Xf1 @ Xk) @ ccnmoo)))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwcel @ (XU @ Xf1 @ Xk) @ ccnv))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwcel @ (XW @ Xf1 @ Xk) @ ccnv))) => (! [Xf1:$i] : (((cwf @ XX @ (XY @ Xf1) @ XT) & ((ccfv @ XT @ (XN @ Xf1)) = ccpnf)) => (? [Xf1:$i] : ((cwf @ ccn @ XX @ (ccv @ Xf1)) & (cwral @ (^ [Xk:$i] : ((cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ XL) @ cc1 @ ccle) & (cwbr @ (ccv @ Xk) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ XT) @ XM) @ cclt))) @ (^ [Xk:$i] : ccn)))))))))))))))))))))).
