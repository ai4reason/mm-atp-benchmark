...
thf(amet2ndc_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XJ @ cc2ndc) <=> (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) = XX))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))))).
