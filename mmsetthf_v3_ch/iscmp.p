...
thf(aiscmp_thm,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : ((XX @ Xy1 @ Xz) = (ccuni @ XJ)))) => (! [Xz:$i] : ((cwcel @ XJ @ cccmp) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xy1:$i] : (((XX @ Xy1 @ Xz) = (ccuni @ (ccv @ Xy1))) => (cwrex @ (^ [Xz:$i] : ((XX @ Xy1 @ Xz) = (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (ccv @ Xy1)) @ ccfn))))) @ (^ [Xy1:$i] : (ccpw @ XJ)))))))))).
