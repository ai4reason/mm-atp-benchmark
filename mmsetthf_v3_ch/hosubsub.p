...
thf(ahosubsub_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwf @ cchil @ cchil @ XS) & (cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU)) => ((cco @ XS @ (cco @ XT @ XU @ cchod) @ cchod) = (cco @ (cco @ XS @ XT @ cchod) @ XU @ cchos))))))).
