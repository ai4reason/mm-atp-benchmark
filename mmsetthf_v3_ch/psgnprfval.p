...
thf(apsgnprfval_thm,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccpr @ cc1 @ cc2)) => ((XG = (ccfv @ XD @ ccsymg)) => ((! [Xw:$i] : (! [Xs1:$i] : ((XB2 @ Xw @ Xs1) = (ccfv @ XG @ ccbs)))) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XN = (ccfv @ XD @ ccpsgn)) => (! [Xw:$i] : (! [Xs1:$i] : ((cwcel @ XX @ (XB2 @ Xw @ Xs1)) => ((ccfv @ XX @ XN) = (ccio @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : ((XX = (cco @ XG @ (ccv @ Xw) @ ccgsu)) & ((ccv @ Xs1) = (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ XT))))))))))))))))))))).
