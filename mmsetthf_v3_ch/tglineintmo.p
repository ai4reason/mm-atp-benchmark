...
thf(atglineintmo_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : ((! [Xx3:$i] : ((XP @ Xx3) = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ (XG @ Xx3) @ ccitv))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccfv @ (XG @ Xx3) @ cclng))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ ccstrkg))) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (ccrn @ (XL @ Xx3))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (ccrn @ (XL @ Xx3))))) => ((Xph => (XA2 != XB2)) => (Xph => (cwmo @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xx3) @ XB2)))))))))))))))))))).
