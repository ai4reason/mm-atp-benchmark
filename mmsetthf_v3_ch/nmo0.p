...
thf(anmo0_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XT @ cc0g)) => (((cwcel @ XS @ ccngp) & (cwcel @ XT @ ccngp)) => ((ccfv @ (ccxp @ XV @ (ccsn @ Xc_0)) @ XN) = ccc0))))))))))).
