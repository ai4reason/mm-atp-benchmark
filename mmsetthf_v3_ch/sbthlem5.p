...
thf(af1dom2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwf1 @ XA2 @ XB2 @ XF)) => (cwbr @ XA2 @ XB2 @ ccdom)))))))).
thf(af1oeng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwf1o @ XA2 @ XB2 @ XF)) => (cwbr @ XA2 @ XB2 @ ccen))))))).
...
thf(af1dom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwf1 @ XA2 @ XB2 @ XF) => (cwbr @ XA2 @ XB2 @ ccdom))))))).
thf(abrsdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) <=> ((cwbr @ XA2 @ XB2 @ ccdom) & (~ (cwbr @ XA2 @ XB2 @ ccen))))))).
thf(aisfi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccen)) @ (^ [Xx3:$i] : ccom))))).
thf(aenssdom_thm,axiom,(cwss @ ccen @ ccdom)).
thf(adfdom2_thm,axiom,(ccdom = (ccun @ ccsdm @ ccen))).
...
thf(abren2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) <=> ((cwbr @ XA2 @ XB2 @ ccdom) & (~ (cwbr @ XA2 @ XB2 @ ccsdm))))))).
...
thf(aeqeng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((XA2 = XB2) => (cwbr @ XA2 @ XB2 @ ccen))))))).
thf(adomrefg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ XA2 @ ccdom))))).
thf(aen2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ ccvv)))) => ((! [Xy1:$i] : (Xph => ((cwcel @ (ccv @ Xy1) @ XB2) => (cwcel @ (XD @ Xy1) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (((cwcel @ (ccv @ Xx3) @ XA2) & ((ccv @ Xy1) = (XC @ Xx3))) <=> ((cwcel @ (ccv @ Xy1) @ XB2) & ((ccv @ Xx3) = (XD @ Xy1))))))) => (Xph => (cwbr @ XA2 @ XB2 @ ccen))))))))))))).
...
thf(adom2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => (((XC @ Xx3) = (XD @ Xy1)) <=> ((ccv @ Xx3) = (ccv @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cwcel @ XB2 @ (XR @ Xx3 @ Xy1)) => (cwbr @ XA2 @ XB2 @ ccdom)))))))))))))).
thf(adom3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => (((XC @ Xx3) = (XD @ Xy1)) <=> ((ccv @ Xx3) = (ccv @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))))) => (Xph => (cwbr @ XA2 @ XB2 @ ccdom)))))))))))))).
thf(adom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => (((XC @ Xx3) = (XD @ Xy1)) <=> ((ccv @ Xx3) = (ccv @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ (XV @ Xx3 @ Xy1)) => (cwbr @ XA2 @ XB2 @ ccdom)))))))))))).
...
thf(aentr2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XB2 @ XC @ ccen) => (cwbr @ XC @ XA2 @ ccen))))))).
thf(aentr3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XA2 @ XC @ ccen) => (cwbr @ XB2 @ XC @ ccen))))))).
thf(aentr4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XC @ XB2 @ ccen) => (cwbr @ XA2 @ XC @ ccen))))))).
...
thf(af1imaeng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & (cwss @ XC @ XA2) & (cwcel @ XC @ XV)) => (cwbr @ (ccima @ XF @ XC) @ XC @ ccen)))))))).
thf(af1imaen2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((((cwf1 @ XA2 @ XB2 @ XF) & (cwcel @ XB2 @ XV)) & ((cwss @ XC @ XA2) & (cwcel @ XC @ XV))) => (cwbr @ (ccima @ XF @ XC) @ XC @ ccen)))))))).
thf(af1imaen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XC @ ccvv) => (((cwf1 @ XA2 @ XB2 @ XF) & (cwss @ XC @ XA2)) => (cwbr @ (ccima @ XF @ XC) @ XC @ ccen)))))))).
thf(aen0_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc0 @ ccen) <=> (XA2 = cc0)))).
thf(aensn1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwbr @ (ccsn @ XA2) @ cc1o @ ccen)))).
thf(aensn1g_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (ccsn @ XA2) @ cc1o @ ccen))))).
thf(aenpr1g_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (ccpr @ XA2 @ XA2) @ cc1o @ ccen))))).
thf(aen1_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc1o @ ccen) <=> (? [Xx3:$i] : (XA2 = (ccsn @ (ccv @ Xx3))))))).
thf(aen1b_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc1o @ ccen) <=> (XA2 = (ccsn @ (ccuni @ XA2)))))).
thf(areuen1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ cc1o @ ccen))))).
...
thf(aen1uniel_thm,axiom,(! [XS:($i > $o)] : ((cwbr @ XS @ cc1o @ ccen) => (cwcel @ (ccuni @ XS) @ XS)))).
thf(a_2dom_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ cc2o @ XA2 @ ccdom) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (~ ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
thf(afundmen_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwfun @ XF) => (cwbr @ (ccdm @ XF) @ XF @ ccen))))).
thf(afundmeng_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XF @ XV) & (cwfun @ XF)) => (cwbr @ (ccdm @ XF) @ XF @ ccen))))).
thf(acnven_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwrel @ XA2) & (cwcel @ XA2 @ XV)) => (cwbr @ XA2 @ (cccnv @ XA2) @ ccen))))).
thf(acnvct_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ ccom @ ccdom) => (cwbr @ (cccnv @ XA2) @ ccom @ ccdom)))).
thf(afndmeng_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XA2 @ XC)) => (cwbr @ XA2 @ XF @ ccen)))))).
thf(amapsnen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwbr @ (cco @ XA2 @ (ccsn @ XB2) @ ccmap) @ XA2 @ ccen)))))).
thf(amap1_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (cco @ cc1o @ XA2 @ ccmap) @ cc1o @ ccen))))).
thf(aen2sn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD)) => (cwbr @ (ccsn @ XA2) @ (ccsn @ XB2) @ ccen))))))).
thf(asnfi_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccsn @ XA2) @ ccfn))).
thf(afiprc_thm,axiom,(~ (wnel @ ccfn @ ccvv))).
thf(aunen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XC @ XD @ ccen)) & (((ccin @ XA2 @ XC) = cc0) & ((ccin @ XB2 @ XD) = cc0))) => (cwbr @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ ccen))))))).
thf(assct_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwbr @ XB2 @ ccom @ ccdom)) => (cwbr @ XA2 @ ccom @ ccdom))))).
thf(adifsnen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwbr @ (ccdif @ XX @ (ccsn @ XA2)) @ (ccdif @ XX @ (ccsn @ XB2)) @ ccen))))))).
thf(adomdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) => (cwbr @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC)) @ ccdom)))))).
...
thf(axp1en_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (ccxp @ XA2 @ cc1o) @ XA2 @ ccen))))).
thf(aendisj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (? [Xx3:$i] : (? [Xy1:$i] : (((cwbr @ (ccv @ Xx3) @ XA2 @ ccen) & (cwbr @ (ccv @ Xy1) @ XB2 @ ccen)) & ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0))))))))).
thf(aundom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwbr @ XA2 @ XB2 @ ccdom) & (cwbr @ XC @ XD @ ccdom)) & ((ccin @ XB2 @ XD) = cc0)) => (cwbr @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ ccdom))))))).
thf(axpcomf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccxp @ XA2 @ XB2)) @ (^ [Xx3:$i] : (ccuni @ (cccnv @ (ccsn @ (ccv @ Xx3)))))))) => (! [Xx3:$i] : (cwf1o @ (ccxp @ XA2 @ XB2) @ (ccxp @ XB2 @ XA2) @ (XF @ Xx3)))))))).
thf(axpcomco_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccxp @ XA2 @ XB2)) @ (^ [Xx3:$i] : (ccuni @ (cccnv @ (ccsn @ (ccv @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XG @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XB2)) @ (^ [Xy1:$i] : (^ [Xz:$i] : XA2)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cccom @ (XG @ Xx3 @ Xy1 @ Xz) @ (XF @ Xx3)) = (ccmpt2 @ (^ [Xz:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xz:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xz:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1 @ Xz)))))))))))))))).
thf(axpcomen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwbr @ (ccxp @ XA2 @ XB2) @ (ccxp @ XB2 @ XA2) @ ccen)))))).
thf(axpcomeng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwbr @ (ccxp @ XA2 @ XB2) @ (ccxp @ XB2 @ XA2) @ ccen))))))).
thf(axpsnen2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwbr @ (ccxp @ (ccsn @ XA2) @ XB2) @ XB2 @ ccen))))))).
thf(axpassen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwbr @ (ccxp @ (ccxp @ XA2 @ XB2) @ XC) @ (ccxp @ XA2 @ (ccxp @ XB2 @ XC)) @ ccen)))))))).
thf(axpdom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (ccxp @ XC @ XA2) @ (ccxp @ XC @ XB2) @ ccdom))))))).
thf(axpdom2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XC @ XV) & (cwbr @ XA2 @ XB2 @ ccdom)) => (cwbr @ (ccxp @ XC @ XA2) @ (ccxp @ XC @ XB2) @ ccdom))))))).
thf(axpdom1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XC @ XV) & (cwbr @ XA2 @ XB2 @ ccdom)) => (cwbr @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC) @ ccdom))))))).
thf(axpdom3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (XB2 != cc0)) => (cwbr @ XA2 @ (ccxp @ XA2 @ XB2) @ ccdom))))))).
thf(axpdom1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC) @ ccdom))))))).
thf(adomunsncan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((~ (cwcel @ XA2 @ XX)) & (~ (cwcel @ XB2 @ XY))) => ((cwbr @ (ccun @ (ccsn @ XA2) @ XX) @ (ccun @ (ccsn @ XB2) @ XY) @ ccdom) <=> (cwbr @ XX @ XY @ ccdom)))))))))).
...
thf(aomxpen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (cwbr @ (cco @ XA2 @ XB2 @ ccomu) @ (ccxp @ XA2 @ XB2) @ ccen))))).
...
thf(apw2f1olem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XA2 @ (XV @ Xz)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XB2 @ (XW @ Xz)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XC @ (XW @ Xz)))) => ((! [Xz:$i] : ((Xph @ Xz) => (XB2 != XC))) => (! [Xz:$i] : ((Xph @ Xz) => (((cwcel @ XS @ (ccpw @ XA2)) & ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccif @ (cwcel @ (ccv @ Xz) @ XS) @ XC @ XB2))))) <=> ((cwcel @ (XG @ Xz) @ (cco @ (ccpr @ XB2 @ XC) @ XA2 @ ccmap)) & (XS = (ccima @ (cccnv @ (XG @ Xz)) @ (ccsn @ XC)))))))))))))))))))).
...
thf(apw2eng_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (ccpw @ XA2) @ (cco @ cc2o @ XA2 @ ccmap) @ ccen))))).
thf(apw2en_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwbr @ (ccpw @ XA2) @ (cco @ cc2o @ XA2 @ ccmap) @ ccen)))).
thf(afopwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XF @ XV) & (cwfo @ XA2 @ XB2 @ XF)) => (cwbr @ (ccpw @ XB2) @ (ccpw @ XA2) @ ccdom))))))).
thf(aenfixsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwbr @ XX @ XY @ ccen)) => (? [Xf1:$i] : ((cwf1o @ XX @ XY @ (ccv @ Xf1)) & ((ccfv @ XA2 @ (ccv @ Xf1)) = XB2))))))))).
thf(asbthlem1_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwcel @ (XA2 @ Xf1 @ Xg1) @ ccvv))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xf1 @ Xg1) = (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (XA2 @ Xf1 @ Xg1)) & (cwss @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccv @ Xx3)))) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccv @ Xx3)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (cwss @ (ccuni @ (XD @ Xf1 @ Xg1)) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccuni @ (XD @ Xf1 @ Xg1))))))))))))))).
thf(asbthlem2_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwcel @ (XA2 @ Xf1 @ Xg1) @ ccvv))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xf1 @ Xg1) = (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (XA2 @ Xf1 @ Xg1)) & (cwss @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccv @ Xx3)))) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccv @ Xx3)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((cwss @ (ccrn @ (ccv @ Xg1)) @ (XA2 @ Xf1 @ Xg1)) => (cwss @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccuni @ (XD @ Xf1 @ Xg1)))))) @ (ccuni @ (XD @ Xf1 @ Xg1)))))))))))).
...
thf(asbthlem5_thm,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwcel @ (XA2 @ Xf1 @ Xg1) @ ccvv))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xf1 @ Xg1) = (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (XA2 @ Xf1 @ Xg1)) & (cwss @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccv @ Xx3)))) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccv @ Xx3)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XH @ Xf1 @ Xg1) = (ccun @ (ccres @ (ccv @ Xf1) @ (ccuni @ (XD @ Xf1 @ Xg1))) @ (ccres @ (cccnv @ (ccv @ Xg1)) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccuni @ (XD @ Xf1 @ Xg1)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((((ccdm @ (ccv @ Xf1)) = (XA2 @ Xf1 @ Xg1)) & (cwss @ (ccrn @ (ccv @ Xg1)) @ (XA2 @ Xf1 @ Xg1))) => ((ccdm @ (XH @ Xf1 @ Xg1)) = (XA2 @ Xf1 @ Xg1))))))))))))).
