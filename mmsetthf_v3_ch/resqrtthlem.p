...
thf(aresqrtthlem_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (((cco @ (ccfv @ XA2 @ ccsqrt) @ cc2 @ ccexp) = XA2) & (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ ccsqrt) @ ccre) @ ccle) & (~ (wnel @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccrp)))))).
