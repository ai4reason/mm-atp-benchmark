...
thf(amodltm1p1mod_thm,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XM @ ccrp) & (cwbr @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XM @ cc1 @ ccmin) @ cclt)) => ((cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XM @ ccmo) = (cco @ (cco @ XA2 @ XM @ ccmo) @ cc1 @ ccaddc)))))).
