...
thf(afsequb_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr)) @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)))) @ (^ [Xx3:$i] : ccr))))))).
thf(afsequb2_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwf @ (cco @ XM @ XN @ ccfz) @ ccr @ XF) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccrn @ XF)))) @ (^ [Xx3:$i] : ccr))))))).
thf(afseqsupcl_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ XM @ ccuz)) & (cwf @ (cco @ XM @ XN @ ccfz) @ ccr @ XF)) => (cwcel @ (ccsup @ (ccrn @ XF) @ ccr @ cclt) @ ccr)))))).
thf(afseqsupubi_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) & (cwf @ (cco @ XM @ XN @ ccfz) @ ccr @ XF)) => (cwbr @ (ccfv @ XK @ XF) @ (ccsup @ (ccrn @ XF) @ ccr @ cclt) @ ccle))))))).
thf(ann0ennn_thm,axiom,(cwbr @ ccn0 @ ccn @ ccen)).
thf(annenom_thm,axiom,(cwbr @ ccn @ ccom @ ccen)).
thf(annct_thm,axiom,(cwbr @ ccn @ ccom @ ccdom)).
thf(auzindi_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwcel @ XT @ (ccfv @ XL @ ccuz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (XR @ Xx3) @ (cco @ XL @ XT @ ccfz)) & (! [Xy1:$i] : ((cwcel @ (XS @ Xy1) @ (cco @ XL @ (XR @ Xx3) @ ccfzo)) => (Xch @ Xy1)))) => (Xps @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xps @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XR @ Xx3) = (XS @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((XR @ Xx3) = XT)))) => (! [Xy1:$i] : (Xph => (Xth @ Xy1))))))))))))))))))))).
...
thf(assnn0fi_thm,axiom,(! [XS:($i > $o)] : ((cwss @ XS @ ccn0) => ((cwcel @ XS @ ccfn) <=> (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) => (~ (wnel @ (ccv @ Xx3) @ XS)))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0)))))).
thf(arabssnn0fi_thm,conjecture,(! [Xph:($i > $o)] : ((cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccn0)) @ ccfn) <=> (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) => (~ (Xph @ Xx3)))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))).
