...
thf(aaspval2_thm,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccasp)) => ((XC = (ccfv @ XW @ ccascl)) => ((XR = (ccfv @ (ccfv @ XW @ ccsubrg) @ ccmrc)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ ccasa) & (cwss @ XS @ XV)) => ((ccfv @ XS @ XA2) = (ccfv @ (ccun @ (ccrn @ XC) @ XS) @ XR)))))))))))))).
