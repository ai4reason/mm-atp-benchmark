...
thf(ablcld_thm,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((XJ @ Xz) = (ccfv @ XD @ ccmopn))) => ((! [Xz:$i] : ((XS @ Xz) = (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ XP @ (ccv @ Xz) @ XD) @ XR @ ccle)) @ (^ [Xz:$i] : XX)))) => (! [Xz:$i] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccxr)) => (cwcel @ (XS @ Xz) @ (ccfv @ (XJ @ Xz) @ cccld))))))))))))).
