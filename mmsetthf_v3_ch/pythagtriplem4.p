...
thf(apythagtriplem4_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwcel @ XC @ ccn)) & ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) & (((cco @ XA2 @ XB2 @ ccgcd) = cc1) & (~ (cwbr @ cc2 @ XA2 @ ccdvds)))) => ((cco @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XC @ XB2 @ ccaddc) @ ccgcd) = cc1)))))).
