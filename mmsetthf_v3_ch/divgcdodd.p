...
thf(adivgcdodd_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((~ (cwbr @ cc2 @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds)) | (~ (cwbr @ cc2 @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds))))))).
