...
thf(abwth_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cccmp) & (cwss @ XA2 @ XX) & (~ (cwcel @ XA2 @ ccfn))) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp)))) @ (^ [Xx3:$i] : XX)))))))).
