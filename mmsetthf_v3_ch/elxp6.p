...
thf(aelxp6_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) <=> ((XA2 = (ccop @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd))) & ((cwcel @ (ccfv @ XA2 @ cc1st) @ XB2) & (cwcel @ (ccfv @ XA2 @ cc2nd) @ XC)))))))).
