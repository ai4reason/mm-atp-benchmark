...
thf(ahmeores_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) & (cwss @ XY @ XX)) => (cwcel @ (ccres @ XF @ XY) @ (cco @ (cco @ XJ @ XY @ ccrest) @ (cco @ XK @ (ccima @ XF @ XY) @ ccrest) @ cchmeo)))))))))).
