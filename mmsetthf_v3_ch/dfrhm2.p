...
thf(adfrhm2_thm,conjecture,(ccrh = (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrg)) @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrg)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccin @ (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccghm) @ (cco @ (ccfv @ (ccv @ Xr) @ ccmgp) @ (ccfv @ (ccv @ Xs1) @ ccmgp) @ ccmhm))))))).
