...
thf(aeqop2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((XA2 = (ccop @ XB2 @ XC)) <=> ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) & (((ccfv @ XA2 @ cc1st) = XB2) & ((ccfv @ XA2 @ cc2nd) = XC)))))))))).
