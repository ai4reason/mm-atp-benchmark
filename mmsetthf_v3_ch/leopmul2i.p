...
thf(aleopmul2i_thm,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XT @ XU @ ccleo))) => (cwbr @ (cco @ XA2 @ XT @ cchot) @ (cco @ XA2 @ XU @ cchot) @ ccleo)))))).
