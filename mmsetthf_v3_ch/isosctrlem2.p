...
thf(aisosctrlem2_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ ccabs) = cc1) & (~ (cc1 = XA2))) => ((ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) = (ccfv @ (ccfv @ (cco @ (ccneg @ XA2) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ cclog) @ ccim))))).
