...
thf(aboxcutc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XX:($i > $o)] : (((cwcel @ XX @ XA2) & (cwral @ (^ [Xk:$i] : (cwss @ (XC @ Xk) @ (XB2 @ Xk))) @ (^ [Xk:$i] : XA2))) => ((ccdif @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ ((ccv @ Xk) = XX) @ (XC @ Xk) @ (XB2 @ Xk))))) = (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ ((ccv @ Xk) = XX) @ (ccdif @ (XB2 @ Xk) @ (XC @ Xk)) @ (XB2 @ Xk))))))))))).
