...
thf(alpolpolsatN_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ cclsa)) => ((XP = (ccfv @ XW @ cclpoN)) => ((Xph => (cwcel @ XW @ XX)) => ((Xph => (cwcel @ Xc_pe @ XP)) => ((Xph => (cwcel @ XQ @ XA2)) => (Xph => ((ccfv @ (ccfv @ XQ @ Xc_pe) @ Xc_pe) = XQ))))))))))))))).
