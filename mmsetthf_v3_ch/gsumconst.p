...
thf(agsumconst_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ XG @ ccmg))) => (! [Xk:$i] : (((cwcel @ XG @ ccmnd) & (cwcel @ XA2 @ ccfn) & (cwcel @ XX @ XB2)) => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : XX)) @ ccgsu) = (cco @ (ccfv @ XA2 @ cchash) @ XX @ (Xc_x @ Xk))))))))))))).
