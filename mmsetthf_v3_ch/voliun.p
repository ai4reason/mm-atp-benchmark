...
thf(avoliun_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccseq @ ccaddc @ (XG @ Xn) @ cc1))) => ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccvol))))) => (! [Xn:$i] : (((cwral @ (^ [Xn:$i] : ((cwcel @ (XA2 @ Xn) @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ (XA2 @ Xn) @ ccvol) @ ccr))) @ (^ [Xn:$i] : ccn)) & (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn)))) => ((ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccvol) = (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt)))))))))).
