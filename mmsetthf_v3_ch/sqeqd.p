...
thf(asqeqd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = (cco @ XB2 @ cc2 @ ccexp))) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle)) => (((Xph & ((ccfv @ XA2 @ ccre) = ccc0) & ((ccfv @ XB2 @ ccre) = ccc0)) => (XA2 = XB2)) => (Xph => (XA2 = XB2)))))))))))).
