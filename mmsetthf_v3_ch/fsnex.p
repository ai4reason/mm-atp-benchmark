...
thf(afsnex_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xf1:$i] : (((ccv @ Xx3) = (ccfv @ XA2 @ (ccv @ Xf1))) => ((Xps @ Xx3) <=> (Xph @ Xf1))))) => ((cwcel @ XA2 @ XV) => ((? [Xf1:$i] : ((cwf @ (ccsn @ XA2) @ XD @ (ccv @ Xf1)) & (Xph @ Xf1))) <=> (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XD))))))))))).
