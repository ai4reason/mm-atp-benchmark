...
thf(aqtopf1_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwf1 @ XX @ XY @ XF)) => (Xph => (cwcel @ XF @ (cco @ XJ @ (cco @ XJ @ XF @ ccqtop) @ cchmeo))))))))))).
