...
thf(astructgrssvtxlemOLD_thm,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XG @ XX)) => ((Xph => (cwfun @ XG)) => ((Xph => (cwcel @ XV @ XY)) => ((Xph => (cwcel @ XE @ XZ)) => ((Xph => (cwss @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE)) @ XG)) => (Xph => (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle))))))))))))))).
