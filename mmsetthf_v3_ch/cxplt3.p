...
thf(acxplt3_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccrp) & (cwbr @ XA2 @ cc1 @ cclt)) & ((cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr))) => ((cwbr @ XB2 @ XC @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XA2 @ XB2 @ cccxp) @ cclt))))))).
