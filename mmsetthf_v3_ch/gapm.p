...
thf(agapm_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ Xc_po))))) => (! [Xx3:$i] : (((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) & (cwcel @ XA2 @ XX)) => (cwf1o @ XY @ XY @ (XF @ Xx3))))))))))))).
