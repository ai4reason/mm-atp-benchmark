...
thf(apwssub_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XM = (ccfv @ XR @ ccsg)) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((((cwcel @ XR @ ccgrp) & (cwcel @ XI @ XV)) & ((cwcel @ XF @ XB2) & (cwcel @ XG @ XB2))) => ((cco @ XF @ XG @ Xc_mi) = (cco @ XF @ XG @ (ccof @ XM)))))))))))))))))).
