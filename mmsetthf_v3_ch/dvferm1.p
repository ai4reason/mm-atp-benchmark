...
thf(advferm1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ XX @ ccr @ XF)) => ((Xph => (cwss @ XX @ ccr)) => ((Xph => (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX)) => ((Xph => (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => ((Xph => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XU @ XB2 @ ccioo)))) => (Xph => (cwbr @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccc0 @ ccle))))))))))))))).
