...
thf(aelfzomelpfzo_thm,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cwcel @ XK @ ccz) & (cwcel @ XL @ ccz))) => ((cwcel @ XK @ (cco @ (cco @ XM @ XL @ ccmin) @ (cco @ XN @ XL @ ccmin) @ ccfzo)) <=> (cwcel @ (cco @ XK @ XL @ ccaddc) @ (cco @ XM @ XN @ ccfzo))))))))).
