...
thf(aqnumdenbi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccq) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccn)) => ((((cco @ XB2 @ XC @ ccgcd) = cc1) & (XA2 = (cco @ XB2 @ XC @ ccdiv))) <=> (((ccfv @ XA2 @ ccnumer) = XB2) & ((ccfv @ XA2 @ ccdenom) = XC)))))))).
