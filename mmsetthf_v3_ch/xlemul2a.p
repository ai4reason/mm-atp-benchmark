...
thf(axlemul2a_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & ((cwcel @ XC @ ccxr) & (cwbr @ ccc0 @ XC @ ccle))) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (cco @ XC @ XA2 @ ccxmu) @ (cco @ XC @ XB2 @ ccxmu) @ ccle)))))).
