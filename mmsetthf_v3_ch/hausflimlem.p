...
thf(ahausflimlem_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) & (cwcel @ XB2 @ (cco @ XJ @ XF @ ccflim))) & ((cwcel @ XU @ XJ) & (cwcel @ XV @ XJ)) & ((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV))) => ((ccin @ XU @ XV) != cc0))))))))).
