...
thf(azorng_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (! [Xz:$i] : (((cwss @ (ccv @ Xz) @ XA2) & (cwor @ (ccv @ Xz) @ ccrpss)) => (cwcel @ (ccuni @ (ccv @ Xz)) @ XA2)))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
