...
thf(afun11uni_thm,conjecture,(! [XA2:($i > $o)] : ((cwral @ (^ [Xf1:$i] : (((cwfun @ (ccv @ Xf1)) & (cwfun @ (cccnv @ (ccv @ Xf1)))) & (cwral @ (^ [Xg1:$i] : ((cwss @ (ccv @ Xf1) @ (ccv @ Xg1)) | (cwss @ (ccv @ Xg1) @ (ccv @ Xf1)))) @ (^ [Xg1:$i] : XA2)))) @ (^ [Xf1:$i] : XA2)) => ((cwfun @ (ccuni @ XA2)) & (cwfun @ (cccnv @ (ccuni @ XA2))))))).
