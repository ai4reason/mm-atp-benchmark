...
thf(aax_pre_mulgt0_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (((cwbr @ ccc0 @ XA2 @ ccltrr) & (cwbr @ ccc0 @ XB2 @ ccltrr)) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccltrr)))))).
