...
thf(abcpasc_thm,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccz)) => ((cco @ (cco @ XN @ XK @ ccbc) @ (cco @ XN @ (cco @ XK @ cc1 @ ccmin) @ ccbc) @ ccaddc) = (cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccbc)))))).
