...
thf(abitsf1ocnv_thm,conjecture,((cwf1o @ ccn0 @ (ccin @ (ccpw @ ccn0) @ ccfn) @ (ccres @ ccbits @ ccn0)) & ((cccnv @ (ccres @ ccbits @ ccn0)) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccn0) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp)))))))).
