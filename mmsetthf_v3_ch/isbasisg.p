...
thf(aisbasisg_thm,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ (XC @ Xx3 @ Xy1)) => ((cwcel @ XB2 @ cctb) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccuni @ (ccin @ XB2 @ (ccpw @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1))))))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))).
