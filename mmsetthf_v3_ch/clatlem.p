...
thf(aclatlem_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XU = (ccfv @ XK @ cclub)) => ((XG = (ccfv @ XK @ ccglb)) => (((cwcel @ XK @ cccla) & (cwss @ XS @ XB2)) => ((cwcel @ (ccfv @ XS @ XU) @ XB2) & (cwcel @ (ccfv @ XS @ XG) @ XB2)))))))))))).
