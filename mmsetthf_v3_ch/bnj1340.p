...
thf(abnj1340_thm,conjecture,(! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : ((! [Xx3:$i] : ((Xps @ Xx3) => (? [Xx3:$i] : (Xth @ Xx3)))) => ((! [Xx3:$i] : ((Xch @ Xx3) <=> ((Xps @ Xx3) & (Xth @ Xx3)))) => ((! [Xx3:$i] : ((Xps @ Xx3) => (! [Xx3:$i] : (Xps @ Xx3)))) => (! [Xx3:$i] : ((Xps @ Xx3) => (? [Xx3:$i] : (Xch @ Xx3))))))))))).
