...
thf(aevpmodpmf1o_thm,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) => (cwf1o @ (ccfv @ XD @ ccevpm) @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)) @ (ccmpt @ (^ [Xf1:$i] : (ccfv @ XD @ ccevpm)) @ (^ [Xf1:$i] : (cco @ XF @ (ccv @ Xf1) @ (ccfv @ XS @ ccplusg))))))))))))).
