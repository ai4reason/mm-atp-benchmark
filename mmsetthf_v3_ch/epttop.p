...
thf(aepttop_thm,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XP @ XA2)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) => ((ccv @ Xx3) = XA2))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ cctopon)))))))).
