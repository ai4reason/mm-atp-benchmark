...
thf(achpub_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ ccchp) @ (cco @ (ccfv @ XA2 @ cccht) @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccaddc) @ ccle)))).
