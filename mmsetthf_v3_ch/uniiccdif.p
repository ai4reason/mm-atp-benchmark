...
thf(auniiccdif_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => (Xph => ((cwss @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))) @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF)))) & ((ccfv @ (ccdif @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF))) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) @ ccovol) = ccc0))))))).
