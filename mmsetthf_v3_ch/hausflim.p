...
thf(ahausflim_thm,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccha) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xf1:$i] : (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XJ @ (ccv @ Xf1) @ ccflim))))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))).
