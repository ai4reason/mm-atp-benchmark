...
thf(a_1stcelcls_thm,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cc1stc) & (cwss @ XS @ XX)) => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) <=> (? [Xf1:$i] : ((cwf @ ccn @ XS @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XJ @ cclm)))))))))))).
