...
thf(acofu1st_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XD @ XE @ ccfunc))) => (Xph => ((ccfv @ (cco @ XG @ XF @ cccofu) @ cc1st) = (cccom @ (ccfv @ XG @ cc1st) @ (ccfv @ XF @ cc1st))))))))))))))).
