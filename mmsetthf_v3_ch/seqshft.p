...
thf(aseqshft_thm,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((ccseq @ Xc_pl @ (cco @ XF @ XN @ ccshi) @ XM) = (cco @ (ccseq @ Xc_pl @ XF @ (cco @ XM @ XN @ ccmin)) @ XN @ ccshi))))))))).
