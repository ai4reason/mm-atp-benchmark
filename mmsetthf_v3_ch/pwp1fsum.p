...
thf(apwp1fsum_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => ((cco @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc) = (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul))) @ ccmul))))))))).
