...
thf(aaxhvdistr2_zf_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ cchlo) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ cchil)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccsm) = (cco @ (cco @ XA2 @ XC @ ccsm) @ (cco @ XB2 @ XC @ ccsm) @ ccva)))))))))).
