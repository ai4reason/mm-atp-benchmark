...
thf(atrclsslem_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwss @ XR @ XS) => (cwss @ (ccint @ (^ [Xr:$i] : ((cwss @ XR @ (ccv @ Xr)) & (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr))))) @ (ccint @ (^ [Xr:$i] : ((cwss @ XS @ (ccv @ Xr)) & (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr)))))))))).
