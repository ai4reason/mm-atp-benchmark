...
thf(asupxrbnd1_thm,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) <=> (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt))))).
