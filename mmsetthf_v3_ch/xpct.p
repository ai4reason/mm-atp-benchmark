...
thf(acardnn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((ccfv @ XA2 @ cccrd) = XA2)))).
thf(acardnueq0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => (((ccfv @ XA2 @ cccrd) = cc0) <=> (XA2 = cc0))))).
thf(acardne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ cccrd)) => (~ (cwbr @ XA2 @ XB2 @ ccen)))))).
thf(acarden2a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((ccfv @ XA2 @ cccrd) = (ccfv @ XB2 @ cccrd)) & ((ccfv @ XA2 @ cccrd) != cc0)) => (cwbr @ XA2 @ XB2 @ ccen))))).
thf(acarden2b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((ccfv @ XA2 @ cccrd) = (ccfv @ XB2 @ cccrd)))))).
thf(acard1_thm,axiom,(! [XA2:($i > $o)] : (((ccfv @ XA2 @ cccrd) = cc1o) <=> (? [Xx3:$i] : (XA2 = (ccsn @ (ccv @ Xx3))))))).
thf(acardsn_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ (ccsn @ XA2) @ cccrd) = cc1o))))).
thf(acarddomi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ XV)) => ((cwss @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) => (cwbr @ XA2 @ XB2 @ ccdom))))))).
thf(asdomsdomcardi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ (ccfv @ XB2 @ cccrd) @ ccsdm) => (cwbr @ XA2 @ XB2 @ ccsdm))))).
thf(acardlim_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ ccom @ (ccfv @ XA2 @ cccrd)) <=> (cwlim @ (ccfv @ XA2 @ cccrd))))).
thf(acardsdomelir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ cccrd)) => (cwbr @ XA2 @ XB2 @ ccsdm))))).
thf(acardsdomel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ (ccdm @ cccrd))) => ((cwbr @ XA2 @ XB2 @ ccsdm) <=> (cwcel @ XA2 @ (ccfv @ XB2 @ cccrd))))))).
thf(aiscard_thm,axiom,(! [XA2:($i > $o)] : (((ccfv @ XA2 @ cccrd) = XA2) <=> ((cwcel @ XA2 @ ccon0) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : XA2)))))).
thf(aiscard2_thm,axiom,(! [XA2:($i > $o)] : (((ccfv @ XA2 @ cccrd) = XA2) <=> ((cwcel @ XA2 @ ccon0) & (cwral @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccen) => (cwss @ XA2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))).
...
thf(aharcard_thm,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ XA2 @ cchar) @ cccrd) = (ccfv @ XA2 @ cchar)))).
thf(acardprclem_thm,axiom,(! [XA2:($i > $o)] : ((XA2 = (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)))) => (~ (cwcel @ XA2 @ ccvv))))).
thf(acardprc_thm,axiom,(~ (wnel @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3))) @ ccvv))).
thf(acarduni_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) => ((ccfv @ (ccuni @ XA2) @ cccrd) = (ccuni @ XA2)))))))).
thf(acardiun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwral @ (^ [Xx3:$i] : ((ccfv @ (XB2 @ Xx3) @ cccrd) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)) => ((ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cccrd) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
thf(acardennn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwcel @ XB2 @ ccom)) => ((ccfv @ XA2 @ cccrd) = XB2))))).
thf(acardsucinf_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwss @ ccom @ XA2)) => ((ccfv @ (ccsuc @ XA2) @ cccrd) = (ccfv @ XA2 @ cccrd))))).
thf(acardsucnn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((ccfv @ (ccsuc @ XA2) @ cccrd) = (ccsuc @ (ccfv @ XA2 @ cccrd)))))).
thf(acardom_thm,axiom,((ccfv @ ccom @ cccrd) = ccom)).
thf(acarden2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd))) => (((ccfv @ XA2 @ cccrd) = (ccfv @ XB2 @ cccrd)) <=> (cwbr @ XA2 @ XB2 @ ccen)))))).
thf(acardsdom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd))) => ((cwcel @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) <=> (cwbr @ XA2 @ XB2 @ ccsdm)))))).
thf(adomtri2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd))) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (~ (cwbr @ XB2 @ XA2 @ ccsdm))))))).
thf(annsdomel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cwcel @ XA2 @ XB2) <=> (cwbr @ XA2 @ XB2 @ ccsdm)))))).
thf(acardval2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => ((ccfv @ XA2 @ cccrd) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : ccon0)))))).
thf(aisinffi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((~ (cwcel @ XA2 @ ccfn)) & (cwcel @ XB2 @ ccfn)) => (? [Xf1:$i] : (cwf1 @ XB2 @ XA2 @ (ccv @ Xf1))))))).
thf(afidomtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ XV)) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (~ (cwbr @ XB2 @ XA2 @ ccsdm)))))))).
thf(afidomtri2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ ccfn)) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (~ (cwbr @ XB2 @ XA2 @ ccsdm)))))))).
thf(aharsdom_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => (cwbr @ XA2 @ (ccfv @ XA2 @ cchar) @ ccsdm)))).
thf(aonsdom_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))))).
thf(aharval2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => ((ccfv @ XA2 @ cchar) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))))))).
thf(acardmin2_thm,axiom,(! [XA2:($i > $o)] : ((cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0)) <=> ((ccfv @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))) @ cccrd) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))))))).
thf(apm54_43lem_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc1o @ ccen) <=> (cwcel @ XA2 @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = cc1o)))))).
thf(apm54_43_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ cc1o @ ccen) & (cwbr @ XB2 @ cc1o @ ccen)) => (((ccin @ XA2 @ XB2) = cc0) <=> (cwbr @ (ccun @ XA2 @ XB2) @ cc2o @ ccen)))))).
thf(apr2nelem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD) & (XA2 != XB2)) => (cwbr @ (ccpr @ XA2 @ XB2) @ cc2o @ ccen))))))).
thf(apr2ne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD)) => ((cwbr @ (ccpr @ XA2 @ XB2) @ cc2o @ ccen) <=> (XA2 != XB2)))))))).
thf(aprdom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD)) => (cwbr @ (ccpr @ XA2 @ XB2) @ cc2o @ ccdom))))))).
thf(aen2eqpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XC @ cc2o @ ccen) & (cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XC)) => ((XA2 != XB2) => (XC = (ccpr @ XA2 @ XB2)))))))).
thf(aen2eleq_thm,axiom,(! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XP) & (cwbr @ XP @ cc2o @ ccen)) => (XP = (ccpr @ XX @ (ccuni @ (ccdif @ XP @ (ccsn @ XX))))))))).
thf(aen2other2_thm,axiom,(! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XP) & (cwbr @ XP @ cc2o @ ccen)) => ((ccuni @ (ccdif @ XP @ (ccsn @ (ccuni @ (ccdif @ XP @ (ccsn @ XX)))))) = XX))))).
thf(adif1card_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XX @ XA2)) => ((ccfv @ XA2 @ cccrd) = (ccsuc @ (ccfv @ (ccdif @ XA2 @ (ccsn @ XX)) @ cccrd))))))).
thf(aleweon_thm,axiom,(! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwwe @ (ccxp @ ccon0 @ ccon0) @ (XL @ Xx3 @ Xy1))))))).
thf(ar0weon_thm,axiom,(! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XR @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (((cwcel @ (ccv @ Xz) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xw) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) | (((ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) = (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) & (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XL @ Xx3 @ Xy1))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwwe @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)) & (cwse @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
thf(ainfxpenlem_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XL @ Xx3 @ Xy1 @ Xm @ Xa) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XR @ Xx3 @ Xy1 @ Xz @ Xw @ Xm @ Xa) = (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (((cwcel @ (ccv @ Xz) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xw) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) | (((ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) = (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) & (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XL @ Xx3 @ Xy1 @ Xm @ Xa))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XQ @ Xx3 @ Xy1 @ Xw @ Xm @ Xa) = (ccin @ (XR @ Xx3 @ Xy1 @ Xz @ Xw @ Xm @ Xa) @ (ccxp @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xy1 @ Xm @ Xa) <=> (((cwcel @ (ccv @ Xa) @ ccon0) & (cwral @ (^ [Xm:$i] : ((cwss @ ccom @ (ccv @ Xm)) => (cwbr @ (ccxp @ (ccv @ Xm) @ (ccv @ Xm)) @ (ccv @ Xm) @ ccen))) @ (^ [Xm:$i] : (ccv @ Xa)))) & ((cwss @ ccom @ (ccv @ Xa)) & (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xa) @ ccsdm)) @ (^ [Xm:$i] : (ccv @ Xa)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xa:$i] : ((XM @ Xx3 @ Xy1 @ Xw @ Xa) = (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XJ @ Xx3 @ Xy1 @ Xz @ Xm @ Xa) = (ccoi @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ (XQ @ Xx3 @ Xy1 @ Xw @ Xm @ Xa))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (((cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm) @ ccon0) & (cwss @ ccom @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm))) => (cwbr @ (ccxp @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm) @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm)) @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm) @ ccen))))))))))))))))))))).
thf(ainfxpen_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwss @ ccom @ XA2)) => (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
thf(axpomen_thm,axiom,(cwbr @ (ccxp @ ccom @ ccom) @ ccom @ ccen)).
thf(axpct_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccdom) & (cwbr @ XB2 @ ccom @ ccdom)) => (cwbr @ (ccxp @ XA2 @ XB2) @ ccom @ ccdom))))).
