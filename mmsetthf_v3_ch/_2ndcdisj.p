...
thf(a_2ndcdisj_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [Xy1:$i] : (((cwcel @ (XJ @ Xy1) @ cc2ndc) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccdif @ (XJ @ Xy1) @ (ccsn @ cc0)))) @ (^ [Xx3:$i] : XA2)) & (! [Xy1:$i] : (cwrmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))) => (cwbr @ XA2 @ ccom @ ccdom))))))).
