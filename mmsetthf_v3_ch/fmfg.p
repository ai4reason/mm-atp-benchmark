...
thf(afmfg_thm,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XY @ XB2 @ ccfg)) => (((cwcel @ XX @ XC) & (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) & (cwf @ XY @ XX @ XF)) => ((ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) = (ccfv @ XL @ (cco @ XX @ XF @ ccfm)))))))))))).
