...
thf(aress0g_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_0:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccmnd) & (cwcel @ Xc_0 @ XA2) & (cwss @ XA2 @ XB2)) => (Xc_0 = (ccfv @ XS @ cc0g)))))))))))).
