...
thf(aissubmgm2_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XH = (cco @ XM @ XS @ ccress)) => ((cwcel @ XM @ ccmgm) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmgm)) <=> ((cwss @ XS @ XB2) & (cwcel @ XH @ ccmgm))))))))))).
