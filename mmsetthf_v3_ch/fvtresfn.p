...
thf(afvtresfn_thm,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : ((cwcel @ XX @ XB2) => ((ccfv @ XX @ (XF @ Xx3)) = (ccres @ XX @ XV)))))))))).
