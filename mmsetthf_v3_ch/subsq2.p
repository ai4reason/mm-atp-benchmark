...
thf(asubsq2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin) = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc2 @ ccexp) @ (cco @ (cco @ cc2 @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccmin) @ ccmul) @ ccaddc)))))).
