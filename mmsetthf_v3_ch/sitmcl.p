...
thf(asitmcl_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XW @ ccmnd)) => ((Xph => (cwcel @ XW @ ccxme)) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((Xph => (cwcel @ XF @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => ((Xph => (cwcel @ XG @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => (Xph => (cwcel @ (cco @ XF @ XG @ (cco @ XW @ XM @ ccsitm)) @ (cco @ ccc0 @ ccpnf @ ccicc)))))))))))))).
