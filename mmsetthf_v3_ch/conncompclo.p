...
thf(aconncompclo_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccuni @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) & (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccconn))) @ (^ [Xx3:$i] : (ccpw @ XX)))))) => (! [Xx3:$i] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ (XT @ Xx3) @ (ccin @ XJ @ (ccfv @ XJ @ cccld))) & (cwcel @ XA2 @ (XT @ Xx3))) => (cwss @ (XS @ Xx3) @ (XT @ Xx3))))))))))).
