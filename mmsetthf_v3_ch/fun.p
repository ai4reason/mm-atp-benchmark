...
thf(afun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwf @ XA2 @ XC @ XF) & (cwf @ XB2 @ XD @ XG)) & ((ccin @ XA2 @ XB2) = cc0)) => (cwf @ (ccun @ XA2 @ XB2) @ (ccun @ XC @ XD) @ (ccun @ XF @ XG)))))))))).
