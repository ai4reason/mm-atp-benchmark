...
thf(axlesubadd_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (XB2 != ccmnf) & (cwbr @ ccc0 @ XC @ ccle))) => ((cwbr @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ XC @ ccle) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccxad) @ ccle))))))).
