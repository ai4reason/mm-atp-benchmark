...
thf(aisnmhm2_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => (((cwcel @ XS @ ccnlm) & (cwcel @ XT @ ccnlm) & (cwcel @ XF @ (cco @ XS @ XT @ cclmhm))) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnmhm)) <=> (cwcel @ (ccfv @ XF @ XN) @ ccr))))))))).
