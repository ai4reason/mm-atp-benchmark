...
thf(auntangtr_thm,conjecture,(! [XA2:($i > $o)] : ((cwtr @ XA2) => ((cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))).
