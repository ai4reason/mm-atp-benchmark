...
thf(acmodscmulexp_thm,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((XX = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => (((cwcel @ XW @ ccclm) & ((cwcel @ cci @ XK) & (cwcel @ XB2 @ XX) & (cwcel @ XN @ ccn))) => (cwcel @ (cco @ (cco @ cci @ XN @ ccexp) @ XB2 @ Xc_x) @ XX)))))))))))))).
