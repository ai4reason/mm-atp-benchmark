...
thf(as1s7_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) = (cco @ (ccs1 @ XA2) @ (ccs7 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) @ ccconcat))))))))))).
