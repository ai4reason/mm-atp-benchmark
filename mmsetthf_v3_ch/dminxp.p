...
thf(adminxp_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xy1:$i] : (((ccdm @ (ccin @ XC @ (ccxp @ (XA2 @ Xy1) @ XB2))) = (XA2 @ Xy1)) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))))))).
