...
thf(aimdivd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (XA2 != ccc0)) => (Xph => ((ccfv @ (cco @ XB2 @ XA2 @ ccdiv) @ ccim) = (cco @ (ccfv @ XB2 @ ccim) @ XA2 @ ccdiv)))))))))).
