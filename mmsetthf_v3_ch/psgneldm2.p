...
thf(apsgneldm2_thm,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XG = (ccfv @ XD @ ccsymg)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XN = (ccfv @ XD @ ccpsgn)) => (! [Xw:$i] : ((cwcel @ XD @ (XV @ Xw)) => ((cwcel @ XP @ (ccdm @ XN)) <=> (cwrex @ (^ [Xw:$i] : (XP = (cco @ XG @ (ccv @ Xw) @ ccgsu))) @ (^ [Xw:$i] : (ccword @ XT)))))))))))))))).
