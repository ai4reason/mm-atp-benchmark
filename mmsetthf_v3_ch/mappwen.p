...
thf(amappwen_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XB2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XB2 @ ccdom)) & ((cwbr @ cc2o @ XA2 @ ccdom) & (cwbr @ XA2 @ (ccpw @ XB2) @ ccdom))) => (cwbr @ (cco @ XA2 @ XB2 @ ccmap) @ (ccpw @ XB2) @ ccen))))).
