...
thf(adivalgmod_thm,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XD @ ccn)) => ((XR = (cco @ XN @ XD @ ccmo)) <=> ((cwcel @ XR @ ccn0) & ((cwbr @ XR @ XD @ cclt) & (cwbr @ XD @ (cco @ XN @ XR @ ccmin) @ ccdvds))))))))).
