...
thf(asubrgunit_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XU = (ccfv @ XR @ ccui)) => ((XV = (ccfv @ XS @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => ((cwcel @ XX @ XV) <=> ((cwcel @ XX @ XU) & (cwcel @ XX @ XA2) & (cwcel @ (ccfv @ XX @ XI) @ XA2)))))))))))))))).
