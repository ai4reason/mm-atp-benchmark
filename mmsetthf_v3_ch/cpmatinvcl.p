...
thf(acpmatinvcl_thm,conjecture,(! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XS @ Xx3) = (cco @ XN @ XR @ cccpmat))) => ((! [Xx3:$i] : ((XP @ Xx3) = (ccfv @ XR @ ccpl1))) => ((! [Xx3:$i] : ((XC @ Xx3) = (cco @ XN @ (XP @ Xx3) @ ccmat))) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (XC @ Xx3) @ ccminusg)) @ (XS @ Xx3))) @ (^ [Xx3:$i] : (XS @ Xx3))))))))))))).
