...
thf(aneifval_thm,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ ccnei) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : ((cwss @ (ccv @ Xx3) @ (ccv @ Xg1)) & (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX))))))))))).
