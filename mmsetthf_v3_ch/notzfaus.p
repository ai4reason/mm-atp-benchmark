...
thf(anotzfaus_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccsn @ cc0))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) <=> (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))))) => (~ (? [Xy1:$i] : (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) <=> ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) & (Xph @ Xx3 @ Xy1))))))))))).
