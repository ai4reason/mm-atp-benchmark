...
thf(alswccats1fst_thm,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XP @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((ccfv @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ cclsw) = (ccfv @ ccc0 @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat))))))).
