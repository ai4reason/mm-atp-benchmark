...
thf(a_2ffzeq_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xi:$i] : (((cwcel @ XM @ ccn0) & (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (XX @ Xi) @ XF) & (cwf @ (cco @ ccc0 @ (XN @ Xi) @ ccfz) @ (XY @ Xi) @ XP)) => ((XF = XP) <=> ((XM = (XN @ Xi)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XF) = (ccfv @ (ccv @ Xi) @ XP))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))))))).
