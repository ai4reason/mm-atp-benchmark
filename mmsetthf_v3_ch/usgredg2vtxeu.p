...
thf(ausgredg2vtxeu_thm,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XG @ ccusgr) & (cwcel @ XE @ (ccfv @ XG @ ccedg)) & (cwcel @ XY @ XE)) => (cwreu @ (^ [Xy1:$i] : (XE = (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XG @ ccvtx)))))))).
