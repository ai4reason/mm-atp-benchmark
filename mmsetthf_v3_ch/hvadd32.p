...
thf(ahvadd32_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => ((cco @ (cco @ XA2 @ XB2 @ ccva) @ XC @ ccva) = (cco @ (cco @ XA2 @ XC @ ccva) @ XB2 @ ccva))))))).
