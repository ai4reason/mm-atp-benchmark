...
thf(aulm0_thm,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => ((Xph => (cwf @ XS @ ccc @ XG)) => ((Xph & (XS = cc0)) => (cwbr @ XF @ XG @ (ccfv @ XS @ cculm)))))))))))))).
