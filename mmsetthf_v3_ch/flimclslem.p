...
thf(aflimclslem_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XX @ (ccfv @ (ccun @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ (ccsn @ XS)) @ ccfi) @ ccfg)) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwss @ XS @ XX) & (cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))) => ((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwcel @ XS @ XF) & (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim))))))))))).
