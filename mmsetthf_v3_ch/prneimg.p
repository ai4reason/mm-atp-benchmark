...
thf(aprneimg_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV)) & ((cwcel @ XC @ XX) & (cwcel @ XD @ XY))) => ((((XA2 != XC) & (XA2 != XD)) | ((XB2 != XC) & (XB2 != XD))) => ((ccpr @ XA2 @ XB2) != (ccpr @ XC @ XD))))))))))))).
