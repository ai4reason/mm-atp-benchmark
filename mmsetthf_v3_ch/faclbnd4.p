...
thf(afaclbnd4_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccn0) & (cwcel @ XM @ ccn0)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle)))))).
