...
thf(aiscmet3i_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccme)) => ((! [Xf1:$i] : (((cwcel @ (ccv @ Xf1) @ (ccfv @ XD @ ccca)) & (cwf @ ccn @ XX @ (ccv @ Xf1))) => (cwcel @ (ccv @ Xf1) @ (ccdm @ (ccfv @ XJ @ cclm))))) => (cwcel @ XD @ (ccfv @ XX @ ccms))))))))).
