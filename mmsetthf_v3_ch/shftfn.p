...
thf(ashftfn_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwfn @ XF @ XB2) & (cwcel @ XA2 @ ccc)) => (cwfn @ (cco @ XF @ XA2 @ ccshi) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ XB2)) @ (^ [Xx3:$i] : ccc))))))))).
