...
thf(aundm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccdif @ ccvv @ (ccun @ XA2 @ XB2)) = (ccin @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2)))))).
thf(aindm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccdif @ ccvv @ (ccin @ XA2 @ XB2)) = (ccun @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2)))))).
...
thf(aundif3OLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccun @ XA2 @ (ccdif @ XB2 @ XC)) = (ccdif @ (ccun @ XA2 @ XB2) @ (ccdif @ XC @ XA2))))))).
thf(adifin2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XC) => ((ccdif @ XA2 @ XB2) = (ccin @ (ccdif @ XC @ XB2) @ XA2))))))).
thf(adif32_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ (ccdif @ XA2 @ XB2) @ XC) = (ccdif @ (ccdif @ XA2 @ XC) @ XB2)))))).
thf(adifabs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccdif @ (ccdif @ XA2 @ XB2) @ XB2) = (ccdif @ XA2 @ XB2))))).
thf(adfsymdif3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccsymdif @ XA2 @ XB2) = (ccdif @ (ccun @ XA2 @ XB2) @ (ccin @ XA2 @ XB2)))))).
...
thf(anotab_thm,axiom,(! [Xph:($i > $o)] : ((^ [Xx3:$i] : (~ (Xph @ Xx3))) = (ccdif @ ccvv @ (^ [Xx3:$i] : (Xph @ Xx3)))))).
...
thf(ainrab2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((ccin @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ XB2) = (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccin @ (XA2 @ Xx3) @ XB2)))))))).
thf(adifrab_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((ccdif @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) = (ccrab @ (^ [Xx3:$i] : ((Xph @ Xx3) & (~ (Xps @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(adfrab3ss_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) => ((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) = (ccin @ XA2 @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
...
thf(areuss2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XA2 @ XB2) & (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3))) @ (^ [Xx3:$i] : XA2))) & ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) & (cwreu @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)))) => (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(areuun1_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) & (cwreu @ (^ [Xx3:$i] : ((Xph @ Xx3) | (Xps @ Xx3))) @ (^ [Xx3:$i] : (ccun @ XA2 @ XB2)))) => (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))).
thf(areuun2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))) => ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccun @ XA2 @ XB2))) <=> (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))).
thf(areupick_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xx3:$i] : ((((cwss @ XA2 @ XB2) & ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) & (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2)))) & (Xph @ Xx3)) => ((cwcel @ (ccv @ Xx3) @ XA2) <=> (cwcel @ (ccv @ Xx3) @ XB2)))))))).
thf(areupick3_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [Xx3:$i] : (((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) & (cwrex @ (^ [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3))) @ (^ [Xx3:$i] : XA2)) & (cwcel @ (ccv @ Xx3) @ XA2)) => ((Xph @ Xx3) => (Xps @ Xx3)))))))).
thf(areupick2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [Xx3:$i] : ((((cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => (Xph @ Xx3))) @ (^ [Xx3:$i] : XA2)) & (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) & (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2))) & (cwcel @ (ccv @ Xx3) @ XA2)) => ((Xph @ Xx3) <=> (Xps @ Xx3)))))))).
thf(aeuelss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (? [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)) & (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XB2)))) => (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(adf_nul_ax,axiom,(cc0 = (ccdif @ ccvv @ ccvv))).
...
thf(avn0_thm,axiom,(ccvv != cc0)).
thf(aeq0f_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : (((XA2 @ Xx3) = cc0) <=> (! [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))))))))).
thf(aneq0f_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : ((~ ((XA2 @ Xx3) = cc0)) <=> (? [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)))))))).
thf(an0f_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : (((XA2 @ Xx3) != cc0) <=> (? [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)))))))).
thf(an0fOLD_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : (((XA2 @ Xx3) != cc0) <=> (? [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)))))))).
...
thf(anel0_thm,axiom,(! [XA2:($i > $o)] : ((! [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ XA2))) => (XA2 = cc0)))).
...
thf(arspn0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((XA2 != cc0) => ((cwral @ (^ [Xx3:$i] : Xph) @ (^ [Xx3:$i] : XA2)) => Xph))))).
thf(an0rex_thm,axiom,(! [XA2:($i > $o)] : ((XA2 != cc0) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XA2))))).
thf(assn0rex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (XA2 != cc0)) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XB2)))))).
...
thf(a_0el_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ cc0 @ (XA2 @ Xy1)) <=> (cwrex @ (^ [Xx3:$i] : (! [Xy1:$i] : (~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))))).
thf(an0el_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [Xu:$i] : ((~ (cwcel @ cc0 @ (XA2 @ Xu))) <=> (cwral @ (^ [Xx3:$i] : (? [Xu:$i] : (cwcel @ (ccv @ Xu) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xu))))))).
thf(aeqeuel_thm,axiom,(! [XA2:($i > $o)] : (((XA2 != cc0) & (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => ((ccv @ Xx3) = (ccv @ Xy1)))))) => (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)))))).
thf(assdif0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) <=> ((ccdif @ XA2 @ XB2) = cc0))))).
thf(adifn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((ccdif @ XA2 @ XB2) != cc0) => (XA2 != XB2))))).
thf(apssdifn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (XA2 != XB2)) => ((ccdif @ XB2 @ XA2) != cc0))))).
thf(apssdif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwpss @ XA2 @ XB2) => ((ccdif @ XB2 @ XA2) != cc0))))).
thf(adifin0ss_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((ccin @ (ccdif @ XA2 @ XB2) @ XC) = cc0) => ((cwss @ XC @ XA2) => (cwss @ XC @ XB2))))))).
