...
thf(aelxp5_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) <=> ((XA2 = (ccop @ (ccint @ (ccint @ XA2)) @ (ccuni @ (ccrn @ (ccsn @ XA2))))) & ((cwcel @ (ccint @ (ccint @ XA2)) @ XB2) & (cwcel @ (ccuni @ (ccrn @ (ccsn @ XA2))) @ XC)))))))).
