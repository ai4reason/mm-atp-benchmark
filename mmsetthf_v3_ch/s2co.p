...
thf(as2co_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwf @ XX @ XY @ XF)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => (Xph => ((cccom @ XF @ (ccs2 @ XA2 @ XB2)) = (ccs2 @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)))))))))))))).
