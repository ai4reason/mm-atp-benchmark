...
thf(asupicc_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwss @ XA2 @ (cco @ XB2 @ XC @ ccicc))) => ((Xph => (XA2 != cc0)) => (Xph => (cwcel @ (ccsup @ XA2 @ ccr @ cclt) @ (cco @ XB2 @ XC @ ccicc)))))))))))).
