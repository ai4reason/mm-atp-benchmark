...
thf(aaxgroth4_thm,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xv)))))) @ (^ [Xv:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccdif @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
