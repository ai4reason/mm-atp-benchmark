...
thf(afcof1o_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwf @ XA2 @ XB2 @ XF) & (cwf @ XB2 @ XA2 @ XG)) & (((cccom @ XF @ XG) = (ccres @ ccid @ XB2)) & ((cccom @ XG @ XF) = (ccres @ ccid @ XA2)))) => ((cwf1o @ XA2 @ XB2 @ XF) & ((cccnv @ XF) = XG)))))))).
