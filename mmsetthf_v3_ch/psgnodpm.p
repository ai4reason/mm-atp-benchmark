...
thf(apsgnodpm_thm,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XD @ ccpsgn)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) => ((ccfv @ XF @ XN) = (ccneg @ cc1)))))))))))).
