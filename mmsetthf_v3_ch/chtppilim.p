...
thf(achtppilim_thm,conjecture,(cwbr @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cccht) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccppi) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccdiv))) @ cc1 @ ccrli)).
