...
thf(aisdrng2_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((cwcel @ XR @ ccdr) <=> ((cwcel @ XR @ ccrg) & (cwcel @ XG @ ccgrp))))))))))).
