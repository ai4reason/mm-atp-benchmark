...
thf(a_0nmhm_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XT @ cc0g)) => ((XF = (ccfv @ XS @ ccsca)) => ((XG = (ccfv @ XT @ ccsca)) => (((cwcel @ XS @ ccnlm) & (cwcel @ XT @ ccnlm) & (XF = XG)) => (cwcel @ (ccxp @ XV @ (ccsn @ Xc_0)) @ (cco @ XS @ XT @ ccnmhm)))))))))))))).
