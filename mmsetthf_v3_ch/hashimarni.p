...
thf(ahashimarni_thm,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwf1 @ (ccdm @ XE) @ (ccrn @ XE) @ XE) & (cwcel @ XE @ XV)) => (((cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ XF) & (XP = (ccima @ XE @ (ccrn @ XF))) & ((ccfv @ XP @ cchash) = XN)) => ((ccfv @ XF @ cchash) = XN))))))))).
