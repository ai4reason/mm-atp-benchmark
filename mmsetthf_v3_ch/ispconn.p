...
thf(aispconn_thm,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : ((XX @ Xf1) = (ccuni @ XJ))) => (! [Xf1:$i] : ((cwcel @ XJ @ ccpconn) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (((ccfv @ ccc0 @ (ccv @ Xf1)) = (ccv @ Xx3)) & ((ccfv @ cc1 @ (ccv @ Xf1)) = (ccv @ Xy1)))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn)))) @ (^ [Xy1:$i] : (XX @ Xf1)))) @ (^ [Xx3:$i] : (XX @ Xf1)))))))))).
