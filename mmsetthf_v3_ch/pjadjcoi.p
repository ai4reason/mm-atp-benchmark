...
thf(apjadjcoi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ (ccfv @ XA2 @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh))) @ XB2 @ ccsp) = (cco @ XA2 @ (ccfv @ XB2 @ (cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XG @ ccpjh))) @ ccsp)))))))))).
