...
thf(asrgisid_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwcel @ XR @ ccsrg)) => ((Xph => (cwcel @ XZ @ XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((cco @ XZ @ (ccv @ Xx3) @ Xc_x) = XZ))) => (Xph => (XZ = Xc_0))))))))))))))).
