...
thf(a_2submod_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) & ((cwbr @ XB2 @ XA2 @ ccle) & (cwbr @ XA2 @ (cco @ cc2 @ XB2 @ ccmul) @ cclt))) => ((cco @ XA2 @ XB2 @ ccmo) = (cco @ XA2 @ XB2 @ ccmin)))))).
