...
thf(apjhfval_thm,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((ccfv @ XH @ ccpjh) = (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (ccrio @ (^ [Xz:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : (ccfv @ XH @ ccort)))) @ (^ [Xz:$i] : XH)))))))).
