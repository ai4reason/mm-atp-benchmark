...
thf(a_2lgslem3_thm,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XP @ ccn) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => ((cco @ XN @ cc2 @ ccmo) = (ccif @ (cwcel @ (cco @ XP @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ ccc0 @ cc1))))))).
