...
thf(assfzoulel_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (((cwbr @ XN @ XA2 @ ccle) | (cwbr @ XB2 @ ccc0 @ ccle)) => ((cwss @ (cco @ XA2 @ XB2 @ ccfzo) @ (cco @ ccc0 @ XN @ ccfzo)) => (cwbr @ XB2 @ XA2 @ ccle)))))))).
