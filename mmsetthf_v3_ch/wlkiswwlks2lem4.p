...
thf(awwlksn0s_thm,axiom,(! [XG:($i > $o)] : ((cco @ ccc0 @ XG @ ccwwlksn) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cchash) = cc1)) @ (^ [Xw:$i] : (ccword @ (ccfv @ XG @ ccvtx))))))).
thf(awwlkssswrd_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (cwss @ (ccfv @ XG @ ccwwlks) @ (ccword @ XV)))))).
thf(awwlksn0_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ ccc0 @ XG @ ccwwlksn)) => (cwrex @ (^ [Xv:$i] : (XW = (ccs1 @ (ccv @ Xv)))) @ (^ [Xv:$i] : XV)))))))).
thf(a_0enwwlksnge1_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((((ccfv @ XG @ ccedg) = cc0) & (cwcel @ XN @ ccn)) => ((cco @ XN @ XG @ ccwwlksn) = cc0))))).
thf(awwlkswwlksn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => (cwcel @ XW @ (ccfv @ XG @ ccwwlks))))))).
thf(awwlkssswwlksn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwss @ (cco @ XN @ XG @ ccwwlksn) @ (ccfv @ XG @ ccwwlks))))).
thf(awlkiswwlks1_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XG @ ccupgr) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) => (cwcel @ XP @ (ccfv @ XG @ ccwwlks)))))))).
thf(awlklnwwlkln1_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XG @ ccupgr) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ XF @ cchash) = XN)) => (cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn))))))))).
thf(awlkiswwlks2lem1_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ (XE @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XP @ (ccword @ (XV @ Xx3))) & (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((ccfv @ (XF @ Xx3) @ cchash) = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)))))))))).
thf(awlkiswwlks2lem2_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)))))) => (! [Xx3:$i] : (((cwcel @ (ccfv @ XP @ cchash) @ ccn0) & (cwcel @ XI @ (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo))) => ((ccfv @ XI @ (XF @ Xx3)) = (ccfv @ (ccpr @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE))))))))))).
thf(awlkiswwlks2lem3_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)))))) => (! [Xx3:$i] : (((cwcel @ XP @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => (cwf @ (cco @ ccc0 @ (ccfv @ (XF @ Xx3) @ cchash) @ ccfz) @ XV @ XP))))))))).
thf(awlkiswwlks2lem4_thm,conjecture,(! [XP:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ (XE @ Xi)))))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XE @ Xi) = (ccfv @ (XG @ Xx3) @ cciedg)))) => (! [Xx3:$i] : (((cwcel @ (XG @ Xx3) @ ccuspgr) & (cwcel @ XP @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccrn @ (XE @ Xi)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo))) => (cwral @ (^ [Xi:$i] : ((ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3)) @ (XE @ Xi)) = (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ (XF @ Xx3) @ cchash) @ ccfzo)))))))))))))).
