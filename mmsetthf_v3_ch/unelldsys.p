...
thf(aunelldsys_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((XL @ Xx3 @ Xy1 @ Xs1) = (ccrab @ (^ [Xs1:$i] : ((cwcel @ cc0 @ (ccv @ Xs1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ (XO @ Xy1) @ (ccv @ Xx3)) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccv @ Xs1))) & (cwral @ (^ [Xx3:$i] : (((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & (cwdisj @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccv @ Xy1)))) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ (XO @ Xy1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => (cwcel @ (XS @ Xy1) @ (XL @ Xx3 @ Xy1 @ Xs1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => (cwcel @ (XA2 @ Xx3 @ Xs1) @ (XS @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => (cwcel @ (XB2 @ Xx3 @ Xs1) @ (XS @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => ((ccin @ (XA2 @ Xx3 @ Xs1) @ (XB2 @ Xx3 @ Xs1)) = cc0))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => (cwcel @ (ccun @ (XA2 @ Xx3 @ Xs1) @ (XB2 @ Xx3 @ Xs1)) @ (XS @ Xy1)))))))))))))))))).
