...
thf(aisnghm2_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => (((cwcel @ XS @ ccngp) & (cwcel @ XT @ ccngp) & (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) <=> (cwcel @ (ccfv @ XF @ XN) @ ccr))))))))).
