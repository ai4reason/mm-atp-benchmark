...
thf(aacsfn_thm,conjecture,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XX @ XV) & (cwcel @ XK @ XX)) & ((cwss @ XT @ XX) & (cwcel @ XT @ ccfn))) => (cwcel @ (ccrab @ (^ [Xa:$i] : ((cwss @ XT @ (ccv @ Xa)) => (cwcel @ XK @ (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
