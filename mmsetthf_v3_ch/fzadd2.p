...
thf(afzadd2_thm,conjecture,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cwcel @ XO @ ccz) & (cwcel @ XP @ ccz))) => (((cwcel @ XJ @ (cco @ XM @ XN @ ccfz)) & (cwcel @ XK @ (cco @ XO @ XP @ ccfz))) => (cwcel @ (cco @ XJ @ XK @ ccaddc) @ (cco @ (cco @ XM @ XO @ ccaddc) @ (cco @ XN @ XP @ ccaddc) @ ccfz))))))))))).
