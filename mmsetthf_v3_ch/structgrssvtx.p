...
thf(astructgrssvtx_thm,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XG @ XX @ ccstr)) => ((Xph => (cwcel @ XV @ XY)) => ((Xph => (cwcel @ XE @ XZ)) => ((Xph => (cwss @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE)) @ XG)) => (Xph => ((ccfv @ XG @ ccvtx) = XV)))))))))))))).
