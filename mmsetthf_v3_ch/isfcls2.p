...
thf(aisfcls2_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XF @ (ccfv @ XX @ ccfil))) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) <=> (cwral @ (^ [Xs1:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xs1) @ (ccfv @ XJ @ cccl)))) @ (^ [Xs1:$i] : XF))))))))).
