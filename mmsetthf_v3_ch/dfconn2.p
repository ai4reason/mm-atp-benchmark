...
thf(adfconn2_thm,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((((ccv @ Xx3) != cc0) & ((ccv @ Xy1) != cc0) & ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0)) => ((ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) != XX))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))).
