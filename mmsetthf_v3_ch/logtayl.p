...
thf(alogtayl_thm,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (ccv @ Xk) @ ccdiv))) @ cc1) @ (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog)) @ ccli)))).
