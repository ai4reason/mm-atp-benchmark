...
thf(asubsubrg_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => ((cwcel @ XB2 @ (ccfv @ XS @ ccsubrg)) <=> ((cwcel @ XB2 @ (ccfv @ XR @ ccsubrg)) & (cwss @ XB2 @ XA2)))))))))).
