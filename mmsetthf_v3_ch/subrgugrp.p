...
thf(asubrgugrp_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XU = (ccfv @ XR @ ccui)) => ((XV = (ccfv @ XS @ ccui)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ XU @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => (cwcel @ XV @ (ccfv @ XG @ ccsubg)))))))))))))).
