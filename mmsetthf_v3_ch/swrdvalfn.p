...
thf(aswrdvalfn_thm,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XS @ (ccword @ XV)) & (cwcel @ XF @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => (cwfn @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) @ (cco @ ccc0 @ (cco @ XL @ XF @ ccmin) @ ccfzo)))))))).
