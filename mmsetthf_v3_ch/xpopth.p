...
thf(axpopth_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccxp @ XC @ XD)) & (cwcel @ XB2 @ (ccxp @ XR @ XS))) => ((((ccfv @ XA2 @ cc1st) = (ccfv @ XB2 @ cc1st)) & ((ccfv @ XA2 @ cc2nd) = (ccfv @ XB2 @ cc2nd))) <=> (XA2 = XB2)))))))))).
