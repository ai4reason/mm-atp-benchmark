...
thf(arelexpsucrd_thm,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cwcel @ XN @ ccn0) => ((cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) = (cccom @ (cco @ XR @ XN @ ccrelexp) @ XR)))))))))).
