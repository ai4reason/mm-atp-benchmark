...
thf(arepswswrd_thm,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XS @ XV) & (cwcel @ XL @ ccn0)) & ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) & (cwbr @ XN @ XL @ ccle)) => ((cco @ (cco @ XS @ XL @ ccreps) @ (ccop @ XM @ XN) @ ccsubstr) = (cco @ XS @ (cco @ XN @ XM @ ccmin) @ ccreps))))))))).
