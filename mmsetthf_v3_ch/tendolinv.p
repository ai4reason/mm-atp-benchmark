...
thf(atendolinv_thm,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : ((XE @ Xh) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xh:$i] : ((XO @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((! [Xh:$i] : ((XU @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : ((XF @ Xh) = (ccfv @ (XU @ Xh) @ ccsca))) => ((! [Xh:$i] : ((XN @ Xh) = (ccfv @ (XF @ Xh) @ ccinvr))) => (! [Xh:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ (XS @ Xh) @ (XE @ Xh)) & ((XS @ Xh) != (XO @ Xh))) => ((cccom @ (ccfv @ (XS @ Xh) @ (XN @ Xh)) @ (XS @ Xh)) = (ccres @ ccid @ XT)))))))))))))))))))))))).
