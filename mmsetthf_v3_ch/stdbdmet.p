...
thf(astdbdmet_thm,conjecture,(! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR @ ccle) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XC @ (ccfv @ XX @ ccxmt)) & (cwcel @ XR @ ccrp)) => (cwcel @ (XD @ Xx3 @ Xy1) @ (ccfv @ XX @ ccme))))))))))).
