...
thf(aexpdiophlem1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccn0) => ((((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XB2 @ ccn)) & (XC = (cco @ XA2 @ XB2 @ ccexp))) <=> (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : (cwrex @ (^ [Xf1:$i] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XB2 @ ccn)) & (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & ((ccv @ Xd) = (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccrmy))) & (((cwcel @ (ccv @ Xd) @ (ccfv @ cc2 @ ccuz)) & ((ccv @ Xe) = (cco @ (ccv @ Xd) @ XB2 @ ccrmy))) & (((cwcel @ (ccv @ Xd) @ (ccfv @ cc2 @ ccuz)) & ((ccv @ Xf1) = (cco @ (ccv @ Xd) @ XB2 @ ccrmx))) & ((cwbr @ XC @ (cco @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xd) @ ccmul) @ XA2 @ ccmul) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ cclt) & (cwbr @ (cco @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xd) @ ccmul) @ XA2 @ ccmul) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ (cco @ (cco @ (ccv @ Xf1) @ (cco @ (cco @ (ccv @ Xd) @ XA2 @ ccmin) @ (ccv @ Xe) @ ccmul) @ ccmin) @ XC @ ccmin) @ ccdvds))))))) @ (^ [Xf1:$i] : ccn0))) @ (^ [Xe:$i] : ccn0))) @ (^ [Xd:$i] : ccn0)))))))).
