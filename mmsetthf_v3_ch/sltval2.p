...
thf(asltval2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur)) => ((cwbr @ XA2 @ XB2 @ ccslt) <=> (cwbr @ (ccfv @ (ccint @ (ccrab @ (^ [Xa:$i] : ((ccfv @ (ccv @ Xa) @ XA2) != (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0))) @ XA2) @ (ccfv @ (ccint @ (ccrab @ (^ [Xa:$i] : ((ccfv @ (ccv @ Xa) @ XA2) != (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0))) @ XB2) @ (cctp @ (ccop @ cc1o @ cc0) @ (ccop @ cc1o @ cc2o) @ (ccop @ cc0 @ cc2o)))))))).
