...
thf(arankc1_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccuni @ XA2) @ ccrnk))) @ (^ [Xx3:$i] : XA2)) <=> ((ccfv @ XA2 @ ccrnk) = (ccfv @ (ccuni @ XA2) @ ccrnk)))))).
