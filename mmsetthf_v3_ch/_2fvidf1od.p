...
thf(a_2fvidf1od_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf @ (XA2 @ Xb) @ (XB2 @ Xa) @ XF)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf @ (XB2 @ Xa) @ (XA2 @ Xb) @ XG)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwral @ (^ [Xa:$i] : ((ccfv @ (ccfv @ (ccv @ Xa) @ XF) @ XG) = (ccv @ Xa))) @ (^ [Xa:$i] : (XA2 @ Xb)))))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwral @ (^ [Xb:$i] : ((ccfv @ (ccfv @ (ccv @ Xb) @ XG) @ XF) = (ccv @ Xb))) @ (^ [Xb:$i] : (XB2 @ Xa)))))) => (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf1o @ (XA2 @ Xb) @ (XB2 @ Xa) @ XF)))))))))))))).
