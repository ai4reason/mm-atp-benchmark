...
thf(alogbmpt_thm,conjecture,(! [XB2:($i > $o)] : (((cwcel @ XB2 @ ccc) & (XB2 != ccc0) & (XB2 != cc1)) => ((ccfv @ XB2 @ (cccur @ cclogb)) = (ccmpt @ (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ (ccfv @ XB2 @ cclog) @ ccdiv))))))).
