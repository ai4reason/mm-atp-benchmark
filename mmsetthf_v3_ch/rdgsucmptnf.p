...
thf(ardgsucmptnf_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XD @ Xx3))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XA2 @ Xx3)))) => ((! [Xx3:$i] : (((ccv @ Xx3) = (ccfv @ (XB2 @ Xx3) @ (XF @ Xx3))) => ((XC @ Xx3) = (XD @ Xx3)))) => (! [Xx3:$i] : ((~ (cwcel @ (XD @ Xx3) @ ccvv)) => ((ccfv @ (ccsuc @ (XB2 @ Xx3)) @ (XF @ Xx3)) = cc0)))))))))))))).
