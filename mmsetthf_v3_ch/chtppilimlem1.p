...
thf(achtppilimlem1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => ((Xph => (cwcel @ XN @ (cco @ cc2 @ ccpnf @ ccico))) => ((Xph => (cwbr @ (cco @ (cco @ XN @ XA2 @ cccxp) @ (ccfv @ XN @ ccppi) @ ccdiv) @ (cco @ cc1 @ XA2 @ ccmin) @ cclt)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XN @ cclog) @ ccmul) @ ccmul) @ (ccfv @ XN @ cccht) @ cclt)))))))))).
