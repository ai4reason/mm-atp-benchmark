...
thf(aimaelfm_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XY @ XB2 @ ccfg)) => ((((cwcel @ XX @ XA2) & (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) & (cwf @ XY @ XX @ XF)) & (cwcel @ XS @ XL)) => (cwcel @ (ccima @ XF @ XS) @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))))))))))))).
