...
thf(aposlubdg_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xph => (XB2 = (ccfv @ XK @ ccbs))) => ((Xph => (XU = (ccfv @ XK @ cclub))) => ((Xph => (cwcel @ XK @ ccpo)) => ((Xph => (cwss @ XS @ XB2)) => ((Xph => (cwcel @ XT @ XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwbr @ (ccv @ Xx3) @ XT @ Xc_le))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xx3:$i] : XS))) => (cwbr @ XT @ (ccv @ Xy1) @ Xc_le))) => (Xph => ((ccfv @ XS @ XU) = XT)))))))))))))))))).
