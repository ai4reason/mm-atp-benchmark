...
thf(aflimrest_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwcel @ XY @ XF)) => ((cco @ (cco @ XJ @ XY @ ccrest) @ (cco @ XF @ XY @ ccrest) @ ccflim) = (ccin @ (cco @ XJ @ XF @ ccflim) @ XY)))))))).
