...
thf(adpmul100_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccr) => ((cco @ (cco @ XA2 @ (ccdp2 @ XB2 @ XC) @ ccdp) @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ ccmul) = (ccdc @ (ccdc @ XA2 @ XB2) @ XC))))))))).
