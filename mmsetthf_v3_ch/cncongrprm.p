...
thf(acncongrprm_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) & ((cwcel @ XP @ ccprime) & (~ (cwbr @ XP @ XC @ ccdvds)))) => (((cco @ (cco @ XA2 @ XC @ ccmul) @ XP @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XP @ ccmo)) <=> ((cco @ XA2 @ XP @ ccmo) = (cco @ XB2 @ XP @ ccmo))))))))).
