...
thf(aacsfiel2_thm,conjecture,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccacs)) & (cwss @ XS @ XX)) => ((cwcel @ XS @ XC) <=> (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ XF) @ XS)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
