...
thf(arec11d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (XA2 != ccc0)) => ((Xph => (XB2 != ccc0)) => ((Xph => ((cco @ cc1 @ XA2 @ ccdiv) = (cco @ cc1 @ XB2 @ ccdiv))) => (Xph => (XA2 = XB2))))))))))).
