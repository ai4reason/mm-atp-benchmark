...
thf(alogfacrlim_thm,conjecture,(cwbr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ (cco @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfa) @ cclog) @ (ccv @ Xx3) @ ccdiv) @ ccmin))) @ cc1 @ ccrli)).
