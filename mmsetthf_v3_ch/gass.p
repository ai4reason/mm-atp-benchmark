...
thf(agass_thm,conjecture,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) & (cwss @ XZ @ XY)) => ((cwcel @ (ccres @ Xc_po @ (ccxp @ XX @ XZ)) @ (cco @ XG @ XZ @ ccga)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_po) @ XZ)) @ (^ [Xy1:$i] : XZ))) @ (^ [Xx3:$i] : XX))))))))))).
