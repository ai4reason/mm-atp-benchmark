...
thf(asitmf_thm,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XW @ ccmnd)) => ((Xph => (cwcel @ XW @ ccxme)) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => (Xph => (cwf @ (ccxp @ (ccdm @ (cco @ XW @ XM @ ccsitg)) @ (ccdm @ (cco @ XW @ XM @ ccsitg))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (cco @ XW @ XM @ ccsitm)))))))))).
