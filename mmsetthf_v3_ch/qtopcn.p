...
thf(aqtopcn_thm,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XZ @ cctopon))) & ((cwfo @ XX @ XY @ XF) & (cwf @ XY @ XZ @ XG))) => ((cwcel @ XG @ (cco @ (cco @ XJ @ XF @ ccqtop) @ XK @ cccn)) <=> (cwcel @ (cccom @ XG @ XF) @ (cco @ XJ @ XK @ cccn)))))))))))).
