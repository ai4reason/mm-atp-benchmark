...
thf(auncmp_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ cctop) & (XX = (ccun @ XS @ XT))) & ((cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp) & (cwcel @ (cco @ XJ @ XT @ ccrest) @ cccmp))) => (cwcel @ XJ @ cccmp)))))))).
