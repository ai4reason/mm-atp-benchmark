...
thf(amodaddmulmod_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccz)) & (cwcel @ XM @ ccrp)) => ((cco @ (cco @ XA2 @ (cco @ (cco @ XB2 @ XM @ ccmo) @ XC @ ccmul) @ ccaddc) @ XM @ ccmo) = (cco @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccaddc) @ XM @ ccmo)))))))).
