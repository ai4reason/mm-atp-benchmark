...
thf(aswrd0fvlsw_thm,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ XW @ (ccop @ ccc0 @ XL) @ ccsubstr) @ cclsw) = (ccfv @ (cco @ XL @ cc1 @ ccmin) @ XW))))))).
