...
thf(adpmul1000_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccr) => ((cco @ (cco @ XA2 @ (ccdp2 @ XB2 @ (ccdp2 @ XC @ XD)) @ ccdp) @ (ccdc @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ ccc0) @ ccmul) = (ccdc @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ XD))))))))))).
