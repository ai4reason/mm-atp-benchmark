...
thf(aaxgroth2_thm,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) & (cwrex @ (^ [Xw:$i] : (! [Xv:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xv) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
