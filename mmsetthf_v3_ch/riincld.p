...
thf(ariincld_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccfv @ XJ @ cccld))) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (ccin @ XX @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (ccfv @ XJ @ cccld))))))))).
