...
thf(aisglbd_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_le @ Xx3 @ Xy1) = (ccfv @ XK @ ccple)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XK @ ccglb)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XS)) => (cwbr @ XH @ (ccv @ Xy1) @ (Xc_le @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XB2 @ Xy1)) & (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_le @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : XS))) => (cwbr @ (ccv @ Xx3) @ XH @ (Xc_le @ Xx3 @ Xy1))))) => ((Xph => (cwcel @ XK @ cccla)) => ((! [Xy1:$i] : (Xph => (cwss @ XS @ (XB2 @ Xy1)))) => ((! [Xy1:$i] : (Xph => (cwcel @ XH @ (XB2 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((ccfv @ XS @ (XG @ Xx3 @ Xy1)) = XH)))))))))))))))))))).
