...
thf(avcm_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XW @ cc1st)) => ((XS = (ccfv @ XW @ cc2nd)) => ((XX = (ccrn @ XG)) => ((XM = (ccfv @ XG @ ccgn)) => (((cwcel @ XW @ ccvc) & (cwcel @ XA2 @ XX)) => ((cco @ (ccneg @ cc1) @ XA2 @ XS) = (ccfv @ XA2 @ XM)))))))))))))).
