...
thf(almod4_thm,conjecture,(! [Xc_pl:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ cclmod) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV)) & ((cwcel @ XZ @ XV) & (cwcel @ XU @ XV))) => ((cco @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XU @ Xc_pl) @ Xc_pl) = (cco @ (cco @ XX @ XZ @ Xc_pl) @ (cco @ XY @ XU @ Xc_pl) @ Xc_pl))))))))))))).
