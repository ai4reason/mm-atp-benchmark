...
thf(adrngid_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((cwcel @ XR @ ccdr) => (Xc_1 = (ccfv @ XG @ cc0g))))))))))))).
