...
thf(appiublem1_thm,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwbr @ XN @ cc6 @ ccle) & (((cwcel @ XP @ ccprime) & (cwbr @ cc4 @ XP @ ccle)) => ((cwcel @ (cco @ XP @ cc6 @ ccmo) @ (cco @ XN @ cc5 @ ccfz)) => (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))) => ((cwcel @ XM @ ccn0) => ((XN = (cco @ XM @ cc1 @ ccaddc)) => (((cwbr @ cc2 @ XM @ ccdvds) | (cwbr @ cc3 @ XM @ ccdvds) | (cwcel @ XM @ (ccpr @ cc1 @ cc5))) => ((cwbr @ XM @ cc6 @ ccle) & (((cwcel @ XP @ ccprime) & (cwbr @ cc4 @ XP @ ccle)) => ((cwcel @ (cco @ XP @ cc6 @ ccmo) @ (cco @ XM @ cc5 @ ccfz)) => (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))))))))))).
