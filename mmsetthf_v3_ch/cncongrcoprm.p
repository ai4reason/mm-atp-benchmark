...
thf(acncongrcoprm_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) & ((cwcel @ XN @ ccn) & ((cco @ XC @ XN @ ccgcd) = cc1))) => (((cco @ (cco @ XA2 @ XC @ ccmul) @ XN @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XN @ ccmo)) <=> ((cco @ XA2 @ XN @ ccmo) = (cco @ XB2 @ XN @ ccmo))))))))).
