...
thf(acnmptre_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((! [Xx3:$i] : ((XR @ Xx3) = (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest))) => ((! [Xx3:$i] : ((XK @ Xx3) = (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XB2 @ ccrest))) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwss @ XB2 @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XF @ Xx3) @ XB2))) => ((! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (XF @ Xx3))) @ (cco @ (XR @ Xx3) @ (XR @ Xx3) @ cccn)))) => (! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XF @ Xx3))) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccn))))))))))))))))))).
