...
thf(acxpval_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ XA2 @ XB2 @ cccxp) = (ccif @ (XA2 = ccc0) @ (ccif @ (XB2 = ccc0) @ cc1 @ ccc0) @ (ccfv @ (cco @ XB2 @ (ccfv @ XA2 @ cclog) @ ccmul) @ cce))))))).
