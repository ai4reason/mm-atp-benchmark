...
thf(adomunsncan_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((~ (cwcel @ XA2 @ XX)) & (~ (cwcel @ XB2 @ XY))) => ((cwbr @ (ccun @ (ccsn @ XA2) @ XX) @ (ccun @ (ccsn @ XB2) @ XY) @ ccdom) <=> (cwbr @ XX @ XY @ ccdom)))))))))).
