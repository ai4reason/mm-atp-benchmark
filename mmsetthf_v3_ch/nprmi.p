...
thf(anprmi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwcel @ XB2 @ ccn) => ((cwbr @ cc1 @ XA2 @ cclt) => ((cwbr @ cc1 @ XB2 @ cclt) => (((cco @ XA2 @ XB2 @ ccmul) = XN) => (~ (cwcel @ XN @ ccprime))))))))))).
