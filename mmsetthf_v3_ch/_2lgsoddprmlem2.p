...
thf(a_2lgsoddprmlem2_thm,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds)) & (XR = (cco @ XN @ cc8 @ ccmo))) => ((cwbr @ cc2 @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccdvds) <=> (cwbr @ cc2 @ (cco @ (cco @ (cco @ XR @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccdvds)))))).
