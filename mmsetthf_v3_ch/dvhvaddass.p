...
thf(advhvaddass_thm,conjecture,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccsca)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XF @ (ccxp @ XT @ XE)) & (cwcel @ XG @ (ccxp @ XT @ XE)) & (cwcel @ XI @ (ccxp @ XT @ XE)))) => ((cco @ (cco @ XF @ XG @ Xc_pl) @ XI @ Xc_pl) = (cco @ XF @ (cco @ XG @ XI @ Xc_pl) @ Xc_pl))))))))))))))))))))))).
