...
thf(ashftval4_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ XB2 @ (cco @ XF @ (ccneg @ XA2) @ ccshi)) = (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ XF)))))))).
