...
thf(abcth3_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccms)) & (cwf @ ccn @ XJ @ XM) & (cwral @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ cccl)) = XX)) @ (^ [Xk:$i] : ccn))) => ((ccfv @ (ccint @ (ccrn @ XM)) @ (ccfv @ XJ @ cccl)) = XX)))))))).
