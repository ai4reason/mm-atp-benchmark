...
thf(asubsubm_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) => ((cwcel @ XA2 @ (ccfv @ XH @ ccsubmnd)) <=> ((cwcel @ XA2 @ (ccfv @ XG @ ccsubmnd)) & (cwss @ XA2 @ XS)))))))))).
