...
thf(accatw2s1p2_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = XN)) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat)) = XY)))))))).
