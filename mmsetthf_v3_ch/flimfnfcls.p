...
thf(aflimfnfcls_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) <=> (cwral @ (^ [Xg1:$i] : ((cwss @ XF @ (ccv @ Xg1)) => (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccfcls)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil))))))))))).
