...
thf(aiswlkon_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & ((cwcel @ XF @ XU) & (cwcel @ XP @ XZ))) => ((cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccwlkson))) <=> ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ ccc0 @ XP) = XA2) & ((ccfv @ (ccfv @ XF @ cchash) @ XP) = XB2)))))))))))))).
