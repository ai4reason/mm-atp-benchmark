...
thf(asymg2hash_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XA2 = (ccpr @ XI @ XJ)) => (((cwcel @ XI @ XV) & (cwcel @ XJ @ XW) & (XI != XJ)) => ((ccfv @ XB2 @ cchash) = cc2))))))))))))).
