...
thf(altaddsubi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => ((cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ cclt))))))))).
