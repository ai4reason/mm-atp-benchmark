...
thf(aphimul_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn) & ((cco @ XM @ XN @ ccgcd) = cc1)) => ((ccfv @ (cco @ XM @ XN @ ccmul) @ ccphi) = (cco @ (ccfv @ XM @ ccphi) @ (ccfv @ XN @ ccphi) @ ccmul)))))).
