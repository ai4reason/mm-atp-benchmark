...
thf(accatrcan_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ (ccword @ XX)) & (cwcel @ XC @ (ccword @ XX))) => (((cco @ XA2 @ XC @ ccconcat) = (cco @ XB2 @ XC @ ccconcat)) <=> (XA2 = XB2)))))))).
