...
thf(as4cld_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => (cwcel @ XD @ XX)) => (Xph => (cwcel @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccword @ XX)))))))))))))).
