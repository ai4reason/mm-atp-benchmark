...
thf(aicodiamlt_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) & (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccico)))) => (cwbr @ (ccfv @ (cco @ XC @ XD @ ccmin) @ ccabs) @ (cco @ XB2 @ XA2 @ ccmin) @ cclt))))))).
