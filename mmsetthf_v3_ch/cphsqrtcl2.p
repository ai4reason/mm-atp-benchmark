...
thf(acphsqrtcl2_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XK) & (~ (cwcel @ (ccneg @ XA2) @ ccrp))) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
