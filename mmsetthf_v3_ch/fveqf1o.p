...
thf(afveqf1o_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (ccun @ (ccres @ ccid @ (ccdif @ XA2 @ (ccpr @ XC @ (ccfv @ XD @ (cccnv @ XF))))) @ (ccpr @ (ccop @ XC @ (ccfv @ XD @ (cccnv @ XF))) @ (ccop @ (ccfv @ XD @ (cccnv @ XF)) @ XC))))) => (((cwf1o @ XA2 @ XB2 @ XF) & (cwcel @ XC @ XA2) & (cwcel @ XD @ XB2)) => ((cwf1o @ XA2 @ XB2 @ XG) & ((ccfv @ XC @ XG) = XD))))))))))).
