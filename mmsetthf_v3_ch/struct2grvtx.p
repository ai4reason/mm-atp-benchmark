...
thf(astruct2grvtx_thm,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE))) => (((cwcel @ XV @ XX) & (cwcel @ XE @ XY)) => ((ccfv @ XG @ ccvtx) = XV))))))))).
