...
thf(adifgtsumgt_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccn0) & (cwcel @ XC @ ccr)) => ((cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ cclt) => (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))))).
