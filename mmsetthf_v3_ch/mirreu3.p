...
thf(amirreu3_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xb:$i] : (XP = (ccfv @ (XG @ Xb) @ ccbs))) => ((! [Xb:$i] : (Xc_mi = (ccfv @ (XG @ Xb) @ ccds))) => ((! [Xb:$i] : (XI = (ccfv @ (XG @ Xb) @ ccitv))) => ((! [Xb:$i] : (Xph => (cwcel @ (XG @ Xb) @ ccstrkg))) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XM @ XP)) => (Xph => (cwreu @ (^ [Xb:$i] : (((cco @ XM @ (ccv @ Xb) @ Xc_mi) = (cco @ XM @ XA2 @ Xc_mi)) & (cwcel @ XM @ (cco @ (ccv @ Xb) @ XA2 @ XI)))) @ (^ [Xb:$i] : XP))))))))))))))))).
