...
thf(abrpprod3a_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwbr @ (ccop @ XX @ XY) @ XZ @ (ccpprod @ XR @ XS)) <=> (? [Xz:$i] : (? [Xw:$i] : ((XZ = (ccop @ (ccv @ Xz) @ (ccv @ Xw))) & (cwbr @ XX @ (ccv @ Xz) @ XR) & (cwbr @ XY @ (ccv @ Xw) @ XS)))))))))))))).
