...
thf(ahlcgreulem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XD @ XP)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((Xph => (XD != XA2)) => ((Xph => (XB2 != XC)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwbr @ XX @ XD @ (ccfv @ XA2 @ XK))) => ((Xph => (cwbr @ XY @ XD @ (ccfv @ XA2 @ XK))) => ((Xph => ((cco @ XA2 @ XX @ Xc_mi) = (cco @ XB2 @ XC @ Xc_mi))) => ((Xph => ((cco @ XA2 @ XY @ Xc_mi) = (cco @ XB2 @ XC @ Xc_mi))) => (Xph => (XX = XY)))))))))))))))))))))))))))))))).
