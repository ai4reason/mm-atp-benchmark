...
thf(afacavg_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (cwbr @ (ccfv @ (ccfv @ (cco @ (cco @ XM @ XN @ ccaddc) @ cc2 @ ccdiv) @ ccfl) @ ccfa) @ (cco @ (ccfv @ XM @ ccfa) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
