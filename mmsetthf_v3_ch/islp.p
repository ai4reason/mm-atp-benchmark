...
thf(aislp_thm,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cclp))) <=> (cwcel @ XP @ (ccfv @ (ccdif @ XS @ (ccsn @ XP)) @ (ccfv @ XJ @ cccl))))))))))).
