...
thf(amodmuladdim_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XM @ ccrp)) => (((cco @ XA2 @ XM @ ccmo) = XB2) => (cwrex @ (^ [Xk:$i] : (XA2 = (cco @ (cco @ (ccv @ Xk) @ XM @ ccmul) @ XB2 @ ccaddc))) @ (^ [Xk:$i] : ccz)))))))).
