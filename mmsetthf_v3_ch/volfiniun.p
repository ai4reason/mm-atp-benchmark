...
thf(avolfiniun_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xk:$i] : ((cwcel @ (XB2 @ Xk) @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ (XB2 @ Xk) @ ccvol) @ ccr))) @ (^ [Xk:$i] : XA2)) & (cwdisj @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))) => ((ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccvol) = (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccvol)))))))).
