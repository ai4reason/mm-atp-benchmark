...
thf(arplogsumlem2_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => (cwbr @ (ccsu @ (cco @ cc1 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccc0) @ ccmin) @ (ccv @ Xn) @ ccdiv))) @ cc2 @ ccle)))).
