...
thf(amirval_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((! [Xy1:$i] : (! [Xz:$i] : ((XL @ Xy1 @ Xz) = (ccfv @ XG @ cclng)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XS @ Xy1 @ Xz) = (ccfv @ XG @ ccmir)))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((ccfv @ XA2 @ (XS @ Xy1 @ Xz)) = (ccmpt @ (^ [Xy1:$i] : XP) @ (^ [Xy1:$i] : (ccrio @ (^ [Xz:$i] : (((cco @ XA2 @ (ccv @ Xz) @ Xc_mi) = (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi)) & (cwcel @ XA2 @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))))))))).
