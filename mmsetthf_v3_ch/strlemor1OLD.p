...
thf(astrlemor1OLD_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwfun @ (cccnv @ (cccnv @ XF))) & (cwss @ (ccdm @ XF) @ (cco @ cc1 @ XI @ ccfz))) => ((cwcel @ XI @ ccn0) => ((cwbr @ XI @ XJ @ cclt) => ((cwcel @ XJ @ ccn) => ((XA2 = XJ) => ((XG = (ccun @ XF @ (ccsn @ (ccop @ XA2 @ XX)))) => ((cwfun @ (cccnv @ (cccnv @ XG))) & (cwss @ (ccdm @ XG) @ (cco @ cc1 @ XJ @ ccfz)))))))))))))))).
