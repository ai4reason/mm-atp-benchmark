...
thf(atfindes_thm,conjecture,(! [Xph:($i > $o)] : ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ cc0) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccon0) => ((Xph @ Xx3) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccsuc @ (ccv @ Xx3)))))) => ((! [Xy1:$i] : ((cwlim @ (ccv @ Xy1)) => ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccv @ Xy1))) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1))))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccon0) => (Xph @ Xx3)))))))).
