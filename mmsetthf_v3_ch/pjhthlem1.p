...
thf(apjhthlem1_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ cchil))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ XH))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ XH))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmv) @ ccno) @ ccle)) @ (^ [Xx3:$i] : XH)))) => ((XT = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccsp) @ (cco @ (cco @ XC @ XC @ ccsp) @ cc1 @ ccaddc) @ ccdiv)) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccsp) = ccc0)))))))))))))))).
