...
thf(ahlcgrex_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xx3:$i] : (XP = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ ccitv))) => ((! [Xx3:$i] : (XK = (ccfv @ (XG @ Xx3) @ cchlg))) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ ccstrkg))) => ((Xph => (cwcel @ XD @ XP)) => ((! [Xx3:$i] : (Xc_mi = (ccfv @ (XG @ Xx3) @ ccds))) => ((Xph => (XD != XA2)) => ((Xph => (XB2 != XC)) => (Xph => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XD @ (ccfv @ XA2 @ XK)) & ((cco @ XA2 @ (ccv @ Xx3) @ Xc_mi) = (cco @ XB2 @ XC @ Xc_mi)))) @ (^ [Xx3:$i] : XP))))))))))))))))))))))))).
