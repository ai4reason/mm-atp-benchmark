...
thf(aaddsubeq4_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ ccc) & (cwcel @ XD @ ccc))) => (((cco @ XA2 @ XB2 @ ccaddc) = (cco @ XC @ XD @ ccaddc)) <=> ((cco @ XC @ XA2 @ ccmin) = (cco @ XB2 @ XD @ ccmin))))))))).
