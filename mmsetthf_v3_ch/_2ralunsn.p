...
thf(a_2ralunsn_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XB2) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = XB2) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XB2) => ((Xps @ Xx3) <=> (Xth @ Xy1))))) => (! [Xy1:$i] : ((cwcel @ XB2 @ (XC @ Xy1)) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccun @ (XA2 @ Xy1) @ (ccsn @ XB2))))) @ (^ [Xx3:$i] : (ccun @ (XA2 @ Xy1) @ (ccsn @ XB2)))) <=> (((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) & (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) & ((cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xy1))) & (Xth @ Xy1))))))))))))))))).
