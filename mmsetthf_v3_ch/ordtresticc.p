...
thf(aordtresticc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cco @ (ccfv @ ccle @ ccordt) @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest) = (ccfv @ (ccin @ ccle @ (ccxp @ (cco @ XA2 @ XB2 @ ccicc) @ (cco @ XA2 @ XB2 @ ccicc))) @ ccordt))))).
