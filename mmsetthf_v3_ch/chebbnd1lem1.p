...
thf(achebbnd1lem1_thm,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccif @ (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccle) @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc))) => ((cwcel @ XN @ (ccfv @ cc4 @ ccuz)) => (cwbr @ (ccfv @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ cclog) @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccppi) @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ cclog) @ ccmul) @ cclt)))))).
