...
thf(ascmatscmiddistr_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => ((Xc_as = (ccfv @ XA2 @ ccvsca)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_xp = (ccfv @ XA2 @ ccmulr)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ XS @ XB2) & (cwcel @ XT @ XB2))) => ((cco @ (cco @ XS @ Xc_1 @ Xc_as) @ (cco @ XT @ Xc_1 @ Xc_as) @ Xc_xp) = (cco @ (cco @ XS @ XT @ Xc_x) @ Xc_1 @ Xc_as)))))))))))))))))))))).
