...
thf(ah2hlm_thm,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ ccnv) => ((cchil = (ccfv @ XU @ ccba)) => ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => (cchli = (ccres @ (ccfv @ XJ @ cclm) @ (cco @ cchil @ ccn @ ccmap)))))))))))).
