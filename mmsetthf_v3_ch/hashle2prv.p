...
thf(ahashle2prv_thm,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XP @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0))) => ((cwbr @ (ccfv @ XP @ cchash) @ cc2 @ ccle) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (XP = (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
