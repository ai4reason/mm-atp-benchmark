...
thf(adfoprab4_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xw) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((Xph @ Xz @ Xw) <=> (Xps @ Xx3 @ Xy1 @ Xz))))))) => ((ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : ((cwcel @ (ccv @ Xw) @ (ccxp @ (XA2 @ Xz) @ (XB2 @ Xz))) & (Xph @ Xz @ Xw))))) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xz))) & (Xps @ Xx3 @ Xy1 @ Xz))))))))))))).
