...
thf(ashftf_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (! [Xx3:$i] : (((cwf @ XB2 @ (XC @ Xx3) @ XF) & (cwcel @ XA2 @ ccc)) => (cwf @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ XB2)) @ (^ [Xx3:$i] : ccc)) @ (XC @ Xx3) @ (cco @ XF @ XA2 @ ccshi)))))))))).
