...
thf(a_1stccn_thm,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ cc1stc)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwf @ XX @ XY @ XF)) => (Xph => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> (! [Xf1:$i] : ((cwf @ ccn @ XX @ (ccv @ Xf1)) => (! [Xx3:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ (ccfv @ XJ @ cclm)) => (cwbr @ (cccom @ XF @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ XK @ cclm))))))))))))))))))).
