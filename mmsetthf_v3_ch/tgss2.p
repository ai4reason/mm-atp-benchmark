...
thf(atgss2_thm,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : (((cwcel @ XB2 @ (XV @ Xz)) & ((ccuni @ XB2) = (ccuni @ XC))) => ((cwss @ (ccfv @ XB2 @ cctg) @ (ccfv @ XC @ cctg)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) & (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : XC)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (ccuni @ XB2)))))))))).
