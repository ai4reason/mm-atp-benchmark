...
thf(afzsplit2_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ (cco @ XK @ cc1 @ ccaddc) @ (ccfv @ XM @ ccuz)) & (cwcel @ XN @ (ccfv @ XK @ ccuz))) => ((cco @ XM @ XN @ ccfz) = (ccun @ (cco @ XM @ XK @ ccfz) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz)))))))).
