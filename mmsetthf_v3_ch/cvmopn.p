...
thf(akur14lem10_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ cctop) => ((XX = (ccuni @ XJ)) => ((XK = (ccfv @ XJ @ cccl)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccint @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpr @ (ccdif @ XX @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xy1) @ XK)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ (ccpw @ XX)))))))) => ((cwss @ XA2 @ XX) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XS @ Xx3 @ Xy1) @ ccfn) & (cwbr @ (ccfv @ (XS @ Xx3 @ Xy1) @ cchash) @ (ccdc @ cc1 @ cc4) @ ccle))))))))))))))).
thf(akur14_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccuni @ XJ))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ XJ @ cccl)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccint @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpr @ (ccdif @ (XX @ Xy1) @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xy1) @ (XK @ Xx3 @ Xy1))) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ (ccpw @ (XX @ Xy1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ (XX @ Xy1))) => ((cwcel @ (XS @ Xx3 @ Xy1) @ ccfn) & (cwbr @ (ccfv @ (XS @ Xx3 @ Xy1) @ cchash) @ (ccdc @ cc1 @ cc4) @ ccle)))))))))))))).
thf(ccretr_tp,type,(ccretr : ($i > $o))).
thf(adf_retr_ax,axiom,(ccretr = (ccmpt2 @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : (ccrab @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : ((cco @ (cccom @ (ccv @ Xr) @ (ccv @ Xs1)) @ (ccres @ ccid @ (ccuni @ (ccv @ Xj))) @ (cco @ (ccv @ Xj) @ (ccv @ Xj) @ cchtpy)) != cc0)) @ (^ [Xs1:$i] : (cco @ (ccv @ Xk) @ (ccv @ Xj) @ cccn)))) @ (^ [Xr:$i] : (cco @ (ccv @ Xj) @ (ccv @ Xk) @ cccn)))))))).
...
thf(adf_sconn_ax,axiom,(ccsconn = (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xf1:$i] : (((ccfv @ ccc0 @ (ccv @ Xf1)) = (ccfv @ cc1 @ (ccv @ Xf1))) => (cwbr @ (ccv @ Xf1) @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ (ccv @ Xf1)))) @ (ccfv @ (ccv @ Xj) @ ccphtpc)))) @ (^ [Xf1:$i] : (cco @ ccii @ (ccv @ Xj) @ cccn)))) @ (^ [Xj:$i] : ccpconn)))).
thf(aispconn_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : ((XX @ Xf1) = (ccuni @ XJ))) => (! [Xf1:$i] : ((cwcel @ XJ @ ccpconn) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (((ccfv @ ccc0 @ (ccv @ Xf1)) = (ccv @ Xx3)) & ((ccfv @ cc1 @ (ccv @ Xf1)) = (ccv @ Xy1)))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn)))) @ (^ [Xy1:$i] : (XX @ Xf1)))) @ (^ [Xx3:$i] : (XX @ Xf1)))))))))).
...
thf(asconntop_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccsconn) => (cwcel @ XJ @ cctop)))).
...
thf(acnpconn_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccuni @ XK)) => (((cwcel @ XJ @ ccpconn) & (cwfo @ XX @ XY @ XF) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => (cwcel @ XK @ ccpconn))))))))).
thf(apconnconn_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccpconn) => (cwcel @ XJ @ ccconn)))).
thf(atxpconn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ ccpconn) & (cwcel @ XS @ ccpconn)) => (cwcel @ (cco @ XR @ XS @ cctx) @ ccpconn))))).
thf(aptpconn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccpconn @ XF)) => (cwcel @ (ccfv @ XF @ ccpt) @ ccpconn)))))).
thf(aindispconn_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccpr @ cc0 @ XA2) @ ccpconn))).
thf(aconnpconn_thm,axiom,(! [XJ:($i > $o)] : (((cwcel @ XJ @ ccconn) & (cwcel @ XJ @ (ccnlly @ ccpconn))) => (cwcel @ XJ @ ccpconn)))).
thf(aqtoppconn_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccpconn) & (cwfn @ XF @ XX)) => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ ccpconn))))))).
thf(apconnpi1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XP = (cco @ XJ @ XA2 @ ccpi1)) => ((XQ = (cco @ XJ @ XB2 @ ccpi1)) => ((XS = (ccfv @ XP @ ccbs)) => ((XT = (ccfv @ XQ @ ccbs)) => (((cwcel @ XJ @ ccpconn) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwbr @ XP @ XQ @ ccgic)))))))))))))))).
thf(asconnpht2_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XJ @ ccsconn)) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((Xph => ((ccfv @ ccc0 @ XF) = (ccfv @ ccc0 @ XG))) => ((Xph => ((ccfv @ cc1 @ XF) = (ccfv @ cc1 @ XG))) => (Xph => (cwbr @ XF @ XG @ (ccfv @ XJ @ ccphtpc))))))))))))).
thf(asconnpi1_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccpconn) & (cwcel @ XY @ XX)) => ((cwcel @ XJ @ ccsconn) <=> (cwbr @ (ccfv @ (cco @ XJ @ XY @ ccpi1) @ ccbs) @ cc1o @ ccen)))))))).
thf(atxsconnlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XR @ cctop)) => ((Xph => (cwcel @ XS @ cctop)) => ((Xph => (cwcel @ XF @ (cco @ ccii @ (cco @ XR @ XS @ cctx) @ cccn))) => ((XA2 = (cccom @ (ccres @ cc1st @ (ccxp @ (ccuni @ XR) @ (ccuni @ XS))) @ XF)) => ((XB2 = (cccom @ (ccres @ cc2nd @ (ccxp @ (ccuni @ XR) @ (ccuni @ XS))) @ XF)) => ((Xph => (cwcel @ XG @ (cco @ XA2 @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ XA2))) @ (ccfv @ XR @ ccphtpy)))) => ((Xph => (cwcel @ XH @ (cco @ XB2 @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ XB2))) @ (ccfv @ XS @ ccphtpy)))) => (Xph => (cwbr @ XF @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ XF))) @ (ccfv @ (cco @ XR @ XS @ cctx) @ ccphtpc))))))))))))))))))).
thf(atxsconn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ ccsconn) & (cwcel @ XS @ ccsconn)) => (cwcel @ (cco @ XR @ XS @ cctx) @ ccsconn))))).
thf(acvxpconn_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS) & (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ cc1 @ ccicc)))) => (cwcel @ (cco @ (cco @ (ccv @ Xt) @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccv @ Xy1) @ ccmul) @ ccaddc) @ XS))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ cccnfld @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XK = (cco @ (XJ @ Xx3 @ Xy1) @ XS @ ccrest)))) => (Xph => (cwcel @ XK @ ccpconn))))))))))).
thf(acvxsconn_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS) & (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ cc1 @ ccicc)))) => (cwcel @ (cco @ (cco @ (ccv @ Xt) @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccv @ Xy1) @ ccmul) @ ccaddc) @ XS))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ cccnfld @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XK = (cco @ (XJ @ Xx3 @ Xy1) @ XS @ ccrest)))) => (Xph => (cwcel @ XK @ ccsconn))))))))))).
thf(ablsconn_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XS = (cco @ XP @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((XK = (cco @ XJ @ XS @ ccrest)) => (((cwcel @ XP @ ccc) & (cwcel @ XR @ ccxr)) => (cwcel @ XK @ ccsconn))))))))))).
thf(acnllysconn_thm,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (cwcel @ XJ @ (cclly @ ccsconn))))).
thf(aresconn_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest)) => ((cwss @ XA2 @ ccr) => ((cwcel @ XJ @ ccsconn) <=> (cwcel @ XJ @ ccconn))))))).
thf(aioosconn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ XA2 @ XB2 @ ccioo) @ ccrest) @ ccsconn)))).
thf(aiccsconn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest) @ ccsconn))))).
thf(aretopsconn_thm,axiom,(cwcel @ (ccfv @ (ccrn @ ccioo) @ cctg) @ ccsconn)).
thf(aiccllysconn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest) @ (cclly @ ccsconn)))))).
thf(arellysconn_thm,axiom,(cwcel @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cclly @ ccsconn))).
thf(aiisconn_thm,axiom,(cwcel @ ccii @ ccsconn)).
...
thf(adf_cvm_ax,axiom,(cccvm = (ccmpt2 @ (^ [Xc:$i] : (^ [Xj:$i] : cctop)) @ (^ [Xc:$i] : (^ [Xj:$i] : cctop)) @ (^ [Xc:$i] : (^ [Xj:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xk)) & (cwrex @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccv @ Xk))) & (cwral @ (^ [Xu:$i] : ((cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xu) @ (ccv @ Xv)) = cc0)) @ (^ [Xv:$i] : (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xu))))) & (cwcel @ (ccres @ (ccv @ Xf1) @ (ccv @ Xu)) @ (cco @ (cco @ (ccv @ Xc) @ (ccv @ Xu) @ ccrest) @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ ccrest) @ cchmeo)))) @ (^ [Xu:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ (ccv @ Xc)) @ (ccsn @ cc0)))))) @ (^ [Xk:$i] : (ccv @ Xj)))) @ (^ [Xx3:$i] : (ccuni @ (ccv @ Xj))))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xc) @ (ccv @ Xj) @ cccn)))))))).
thf(afncvm_thm,axiom,(cwfn @ cccvm @ (ccxp @ cctop @ cctop))).
...
thf(acvmcn_thm,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XF @ (cco @ XC @ XJ @ cccvm)) => (cwcel @ XF @ (cco @ XC @ XJ @ cccn))))))).
...
thf(acvmsval_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XS @ Xv @ Xu @ Xk @ Xs1) = (ccmpt @ (^ [Xk:$i] : XJ) @ (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccima @ (cccnv @ XF) @ (ccv @ Xk))) & (cwral @ (^ [Xu:$i] : ((cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xu) @ (ccv @ Xv)) = cc0)) @ (^ [Xv:$i] : (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xu))))) & (cwcel @ (ccres @ XF @ (ccv @ Xu)) @ (cco @ (cco @ XC @ (ccv @ Xu) @ ccrest) @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cchmeo)))) @ (^ [Xu:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ XC) @ (ccsn @ cc0))))))))))) => (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((cwcel @ XC @ XV) => ((cwcel @ (XT @ Xk) @ (ccfv @ XU @ (XS @ Xv @ Xu @ Xk @ Xs1))) <=> ((cwcel @ XU @ XJ) & ((cwss @ (XT @ Xk) @ XC) & ((XT @ Xk) != cc0)) & (((ccuni @ (XT @ Xk)) = (ccima @ (cccnv @ XF) @ XU)) & (cwral @ (^ [Xu:$i] : ((cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xu) @ (ccv @ Xv)) = cc0)) @ (^ [Xv:$i] : (ccdif @ (XT @ Xk) @ (ccsn @ (ccv @ Xu))))) & (cwcel @ (ccres @ XF @ (ccv @ Xu)) @ (cco @ (cco @ XC @ (ccv @ Xu) @ ccrest) @ (cco @ XJ @ XU @ ccrest) @ cchmeo)))) @ (^ [Xu:$i] : (XT @ Xk)))))))))))))))))))).
...
thf(acvmsn0_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XS @ Xv @ Xu @ Xk @ Xs1) = (ccmpt @ (^ [Xk:$i] : XJ) @ (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccima @ (cccnv @ XF) @ (ccv @ Xk))) & (cwral @ (^ [Xu:$i] : ((cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xu) @ (ccv @ Xv)) = cc0)) @ (^ [Xv:$i] : (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xu))))) & (cwcel @ (ccres @ XF @ (ccv @ Xu)) @ (cco @ (cco @ XC @ (ccv @ Xu) @ ccrest) @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cchmeo)))) @ (^ [Xu:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ XC) @ (ccsn @ cc0))))))))))) => (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((cwcel @ (XT @ Xk) @ (ccfv @ XU @ (XS @ Xv @ Xu @ Xk @ Xs1))) => ((XT @ Xk) != cc0)))))))))))))).
...
thf(acvmcov2_thm,axiom,(! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XS @ Xv @ Xu @ Xk @ Xs1) = (ccmpt @ (^ [Xk:$i] : XJ) @ (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccima @ (cccnv @ XF) @ (ccv @ Xk))) & (cwral @ (^ [Xu:$i] : ((cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xu) @ (ccv @ Xv)) = cc0)) @ (^ [Xv:$i] : (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xu))))) & (cwcel @ (ccres @ XF @ (ccv @ Xu)) @ (cco @ (cco @ XC @ (ccv @ Xu) @ ccrest) @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cchmeo)))) @ (^ [Xu:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ XC) @ (ccsn @ cc0))))))))))) => (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : (((cwcel @ XF @ (cco @ XC @ XJ @ cccvm)) & (cwcel @ XU @ XJ) & (cwcel @ (XP @ Xv @ Xu @ Xs1) @ XU)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ (XP @ Xv @ Xu @ Xs1) @ (ccv @ Xx3)) & ((ccfv @ (ccv @ Xx3) @ (XS @ Xv @ Xu @ Xk @ Xs1)) != cc0))) @ (^ [Xx3:$i] : (ccpw @ XU)))))))))))))))).
thf(acvmseu_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XS @ Xv @ Xu @ Xk @ Xs1) = (ccmpt @ (^ [Xk:$i] : XJ) @ (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccima @ (cccnv @ XF) @ (ccv @ Xk))) & (cwral @ (^ [Xu:$i] : ((cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xu) @ (ccv @ Xv)) = cc0)) @ (^ [Xv:$i] : (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xu))))) & (cwcel @ (ccres @ XF @ (ccv @ Xu)) @ (cco @ (cco @ XC @ (ccv @ Xu) @ ccrest) @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cchmeo)))) @ (^ [Xu:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ XC) @ (ccsn @ cc0))))))))))) => ((! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XB2 @ Xu @ Xk @ Xs1) = (ccuni @ XC))))) => (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : (((cwcel @ XF @ (cco @ XC @ XJ @ cccvm)) & ((cwcel @ (XT @ Xk) @ (ccfv @ XU @ (XS @ Xv @ Xu @ Xk @ Xs1))) & (cwcel @ (XA2 @ Xk @ Xs1) @ (XB2 @ Xu @ Xk @ Xs1)) & (cwcel @ (ccfv @ (XA2 @ Xk @ Xs1) @ XF) @ XU))) => (cwreu @ (^ [Xx3:$i] : (cwcel @ (XA2 @ Xk @ Xs1) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (XT @ Xk))))))))))))))))))).
thf(acvmsiota_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XS @ Xv @ Xu @ Xk @ Xs1) = (ccmpt @ (^ [Xk:$i] : XJ) @ (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccima @ (cccnv @ XF) @ (ccv @ Xk))) & (cwral @ (^ [Xu:$i] : ((cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xu) @ (ccv @ Xv)) = cc0)) @ (^ [Xv:$i] : (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xu))))) & (cwcel @ (ccres @ XF @ (ccv @ Xu)) @ (cco @ (cco @ XC @ (ccv @ Xu) @ ccrest) @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cchmeo)))) @ (^ [Xu:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ XC) @ (ccsn @ cc0))))))))))) => ((! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XB2 @ Xu @ Xk @ Xs1) = (ccuni @ XC))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XW @ Xx3 @ Xu @ Xk @ Xs1) = (ccrio @ (^ [Xx3:$i] : (cwcel @ (XA2 @ Xk @ Xs1) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (XT @ Xk)))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xs1:$i] : (((cwcel @ XF @ (cco @ XC @ XJ @ cccvm)) & ((cwcel @ (XT @ Xk) @ (ccfv @ XU @ (XS @ Xv @ Xu @ Xk @ Xs1))) & (cwcel @ (XA2 @ Xk @ Xs1) @ (XB2 @ Xu @ Xk @ Xs1)) & (cwcel @ (ccfv @ (XA2 @ Xk @ Xs1) @ XF) @ XU))) => ((cwcel @ (XW @ Xx3 @ Xu @ Xk @ Xs1) @ (XT @ Xk)) & (cwcel @ (XA2 @ Xk @ Xs1) @ (XW @ Xx3 @ Xu @ Xk @ Xs1)))))))))))))))))))))).
