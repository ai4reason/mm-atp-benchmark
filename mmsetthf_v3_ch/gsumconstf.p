...
thf(agsumconstf_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XX @ Xk))) => ((! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ (XG @ Xk) @ ccmg))) => (! [Xk:$i] : (((cwcel @ (XG @ Xk) @ ccmnd) & (cwcel @ XA2 @ ccfn) & (cwcel @ (XX @ Xk) @ (XB2 @ Xk))) => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) = (cco @ (ccfv @ XA2 @ cchash) @ (XX @ Xk) @ (Xc_x @ Xk)))))))))))))).
