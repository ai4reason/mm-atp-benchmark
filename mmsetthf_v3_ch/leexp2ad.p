...
thf(aleexp2ad_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ cc1 @ XA2 @ ccle)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (Xph => (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle)))))))))).
