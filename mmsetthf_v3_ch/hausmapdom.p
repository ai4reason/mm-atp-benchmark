...
thf(ahausmapdom_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccha) & (cwcel @ XJ @ cc1stc) & (cwss @ XA2 @ XX)) => (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (cco @ XA2 @ ccn @ ccmap) @ ccdom))))))).
