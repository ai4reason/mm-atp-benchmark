...
thf(aexpnlbnd2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccr) & (cwbr @ cc1 @ XB2 @ cclt)) => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ (cco @ XB2 @ (ccv @ Xk) @ ccexp) @ ccdiv) @ XA2 @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccn)))))).
