...
thf(aist1_5lem_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ XA2) => (cwcel @ XJ @ cct0)) => (((cwbr @ XJ @ (ccfv @ XJ @ cckq) @ cchmph) => ((cwcel @ XJ @ XA2) => (cwcel @ (ccfv @ XJ @ cckq) @ XA2))) => (((cwbr @ (ccfv @ XJ @ cckq) @ XJ @ cchmph) => ((cwcel @ (ccfv @ XJ @ cckq) @ XA2) => (cwcel @ XJ @ XA2))) => ((cwcel @ XJ @ XA2) <=> ((cwcel @ XJ @ cct0) & (cwcel @ (ccfv @ XJ @ cckq) @ XA2))))))))).
