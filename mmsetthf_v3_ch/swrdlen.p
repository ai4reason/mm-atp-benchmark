...
thf(aswrdlen_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & (cwcel @ XF @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((ccfv @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) @ cchash) = (cco @ XL @ XF @ ccmin)))))))).
