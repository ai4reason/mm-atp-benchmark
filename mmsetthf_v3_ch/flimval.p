...
thf(aflimval_thm,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwcel @ XF @ (ccuni @ (ccrn @ ccfil)))) => ((cco @ XJ @ XF @ ccflim) = (ccrab @ (^ [Xx3:$i] : ((cwss @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XF) & (cwss @ XF @ (ccpw @ XX)))) @ (^ [Xx3:$i] : XX))))))))).
