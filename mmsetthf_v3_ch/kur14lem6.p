...
thf(akur14lem6_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ cctop) => ((XX = (ccuni @ XJ)) => ((XK = (ccfv @ XJ @ cccl)) => ((XI = (ccfv @ XJ @ ccnt)) => ((cwss @ XA2 @ XX) => ((XB2 = (ccdif @ XX @ (ccfv @ XA2 @ XK))) => ((ccfv @ (ccfv @ (ccfv @ XB2 @ XK) @ XI) @ XK) = (ccfv @ XB2 @ XK))))))))))))))).
