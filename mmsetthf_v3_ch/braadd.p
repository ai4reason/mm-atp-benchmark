...
thf(abraadd_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => ((ccfv @ (cco @ XB2 @ XC @ ccva) @ (ccfv @ XA2 @ ccbr)) = (cco @ (ccfv @ XB2 @ (ccfv @ XA2 @ ccbr)) @ (ccfv @ XC @ (ccfv @ XA2 @ ccbr)) @ ccaddc))))))).
