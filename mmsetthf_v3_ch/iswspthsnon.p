...
thf(aiswspthsnon_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwspthsnon)) = (ccrab @ (^ [Xw:$i] : (? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xw) @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson))))) @ (^ [Xw:$i] : (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon)))))))))))).
