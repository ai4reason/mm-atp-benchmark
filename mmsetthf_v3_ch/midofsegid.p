...
thf(amidofsegid_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XD @ (ccfv @ XN @ ccee)) & (cwcel @ XE @ (ccfv @ XN @ ccee)))) => (((cwbr @ XD @ (ccop @ XA2 @ XB2) @ ccbtwn) & (cwbr @ XE @ (ccop @ XA2 @ XB2) @ ccbtwn) & (cwbr @ (ccop @ XA2 @ XD) @ (ccop @ XA2 @ XE) @ cccgr)) => (XD = XE))))))))).
