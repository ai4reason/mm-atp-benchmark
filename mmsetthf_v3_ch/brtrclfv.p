...
thf(abrtrclfv_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xr:$i] : ((cwcel @ XR @ (XV @ Xr)) => ((cwbr @ XA2 @ XB2 @ (ccfv @ XR @ cctcl)) <=> (! [Xr:$i] : (((cwss @ XR @ (ccv @ Xr)) & (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr))) => (cwbr @ XA2 @ XB2 @ (ccv @ Xr)))))))))))).
