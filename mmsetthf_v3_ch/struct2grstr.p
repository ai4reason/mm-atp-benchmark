...
thf(astruct2grstr_thm,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE))) => (cwbr @ XG @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ ccedgf)) @ ccstr)))))).
