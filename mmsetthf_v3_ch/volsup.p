...
thf(avolsup_thm,conjecture,(! [XF:($i > $o)] : (((cwf @ ccn @ (ccdm @ ccvol) @ XF) & (cwral @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF))) @ (^ [Xn:$i] : ccn))) => ((ccfv @ (ccuni @ (ccrn @ XF)) @ ccvol) = (ccsup @ (ccima @ ccvol @ (ccrn @ XF)) @ ccxr @ cclt))))).
