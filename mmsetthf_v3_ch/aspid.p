...
thf(aaspid_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccasp)) => ((XV = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ ccasa) & (cwcel @ XS @ (ccfv @ XW @ ccsubrg)) & (cwcel @ XS @ XL)) => ((ccfv @ XS @ XA2) = XS))))))))))).
