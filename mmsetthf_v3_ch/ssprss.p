...
thf(assprss_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwss @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) <=> (((XA2 = XC) | (XA2 = XD)) & ((XB2 = XC) | (XB2 = XD)))))))))))).
