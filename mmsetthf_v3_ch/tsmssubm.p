...
thf(atsmssubm_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XS @ (ccfv @ XG @ ccsubmnd))) => ((Xph => (cwf @ XA2 @ XS @ XF)) => ((XH = (cco @ XG @ XS @ ccress)) => (Xph => ((cco @ XH @ XF @ cctsu) = (ccin @ (cco @ XG @ XF @ cctsu) @ XS))))))))))))))))).
