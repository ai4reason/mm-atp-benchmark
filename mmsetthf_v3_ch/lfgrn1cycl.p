...
thf(alfgrn1cycl_thm,conjecture,(! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (XV = (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ cciedg))) => (! [Xx3:$i] : ((cwf @ (ccdm @ XI) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ XI) => ((cwbr @ XF @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ cccycls)) => ((ccfv @ XF @ cchash) != cc1)))))))))))).
