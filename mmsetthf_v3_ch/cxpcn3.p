...
thf(acxpcn3_thm,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : ((XD = (ccima @ (cccnv @ ccre) @ ccrp)) => ((XJ = (ccfv @ cccnfld @ cctopn)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (cco @ XJ @ (cco @ ccc0 @ ccpnf @ ccico) @ ccrest)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (cco @ XJ @ XD @ ccrest)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XD)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cccxp)))) @ (cco @ (cco @ (XK @ Xx3 @ Xy1) @ (XL @ Xx3 @ Xy1) @ cctx) @ XJ @ cccn))))))))))))).
