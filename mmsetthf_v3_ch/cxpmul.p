...
thf(acxpmul_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccc)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ cccxp) = (cco @ (cco @ XA2 @ XB2 @ cccxp) @ XC @ cccxp))))))).
