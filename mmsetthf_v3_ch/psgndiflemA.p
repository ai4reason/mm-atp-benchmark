...
thf(apsgndiflemA_thm,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : ((XT @ Xq) = (ccrn @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpmtr)))) => ((! [Xq:$i] : ((XS @ Xq) = (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccsymg))) => ((! [Xq:$i] : ((XZ @ Xq) = (ccfv @ (XN @ Xq) @ ccsymg))) => ((! [Xq:$i] : ((XR @ Xq) = (ccrn @ (ccfv @ (XN @ Xq) @ ccpmtr)))) => (! [Xq:$i] : ((((cwcel @ (XN @ Xq) @ ccfn) & (cwcel @ XK @ (XN @ Xq))) & (cwcel @ XQ @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : XP)))) => (((cwcel @ (XW @ Xq) @ (ccword @ (XT @ Xq))) & ((ccres @ XQ @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) = (cco @ (XS @ Xq) @ (XW @ Xq) @ ccgsu)) & (cwcel @ (XU @ Xq) @ (ccword @ (XR @ Xq)))) => ((XQ = (cco @ (ccfv @ (XN @ Xq) @ ccsymg) @ (XU @ Xq) @ ccgsu)) => ((cco @ (ccneg @ cc1) @ (ccfv @ (XW @ Xq) @ cchash) @ ccexp) = (cco @ (ccneg @ cc1) @ (ccfv @ (XU @ Xq) @ cchash) @ ccexp)))))))))))))))))))))).
