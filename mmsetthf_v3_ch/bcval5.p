...
thf(abcval5_thm,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccn)) => ((cco @ XN @ XK @ ccbc) = (cco @ (ccfv @ XN @ (ccseq @ ccmul @ ccid @ (cco @ (cco @ XN @ XK @ ccmin) @ cc1 @ ccaddc))) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
