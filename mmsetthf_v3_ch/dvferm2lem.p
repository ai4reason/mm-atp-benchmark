...
thf(advcmul_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => (cwcel @ XC @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => (Xph => ((ccfv @ XC @ (cco @ XS @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdv)) = (cco @ XA2 @ (ccfv @ XC @ (cco @ XS @ XF @ ccdv)) @ ccmul))))))))))))))).
...
thf(advcjbr_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwss @ XX @ ccr)) => ((Xph => (cwcel @ XC @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => (Xph => (cwbr @ XC @ (ccfv @ (ccfv @ XC @ (cco @ ccr @ XF @ ccdv)) @ cccj) @ (cco @ ccr @ (cccom @ cccj @ XF) @ ccdv))))))))))).
thf(advcj_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwf @ XX @ ccc @ XF) & (cwss @ XX @ ccr)) => ((cco @ ccr @ (cccom @ cccj @ XF) @ ccdv) = (cccom @ cccj @ (cco @ ccr @ XF @ ccdv))))))).
thf(advfre_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr)) => (cwf @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ ccr @ (cco @ ccr @ XF @ ccdv)))))).
thf(advnfre_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr) & (cwcel @ XN @ ccn0)) => (cwf @ (ccdm @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdvn))) @ ccr @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdvn)))))))).
...
thf(advmptcj_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (XA2 @ Xx3) @ cccj))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ cccj)))))))))))))).
thf(advmptre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (XA2 @ Xx3) @ ccre))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccre)))))))))))))).
thf(advmptim_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (XA2 @ Xx3) @ ccim))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccim)))))))))))))).
...
thf(advrecg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XC @ Xx3) @ XV))) => ((Xph => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XC @ Xx3))))) => (Xph => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ XA2 @ (XB2 @ Xx3) @ ccdiv))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccneg @ (cco @ (cco @ XA2 @ (XC @ Xx3) @ ccmul) @ (cco @ (XB2 @ Xx3) @ cc2 @ ccexp) @ ccdiv))))))))))))))))))).
...
thf(advcnvlem_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XK = (cco @ XJ @ XS @ ccrest)) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XY @ XK)) => ((Xph => (cwf1o @ XX @ XY @ XF)) => ((Xph => (cwcel @ (cccnv @ XF) @ (cco @ XY @ XX @ cccncf))) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ XS @ XF @ ccdv))))) => ((Xph => (cwcel @ XC @ XX)) => (Xph => (cwbr @ (ccfv @ XC @ XF) @ (cco @ cc1 @ (ccfv @ XC @ (cco @ XS @ XF @ ccdv)) @ ccdiv) @ (cco @ XS @ (cccnv @ XF) @ ccdv))))))))))))))))))))).
...
thf(advexp3_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccexp))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ XN @ (cco @ (ccv @ Xx3) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul))))))).
thf(adveflem_thm,axiom,(cwbr @ ccc0 @ cc1 @ (cco @ ccc @ cce @ ccdv))).
thf(advef_thm,axiom,((cco @ ccc @ cce @ ccdv) = cce)).
thf(advsincos_thm,axiom,(((cco @ ccc @ ccsin @ ccdv) = cccos) & ((cco @ ccc @ cccos @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccv @ Xx3) @ ccsin))))))).
thf(advsin_thm,axiom,((cco @ ccc @ ccsin @ ccdv) = cccos)).
thf(advcos_thm,axiom,((cco @ ccc @ cccos @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccv @ Xx3) @ ccsin)))))).
thf(advferm1lem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwf @ XX @ ccr @ XF))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwss @ XX @ ccr))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XU @ XB2 @ ccioo))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ ccc0 @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ cclt))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XT @ Xy1) @ ccrp)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => (cwral @ (^ [Xz:$i] : ((((ccv @ Xz) != XU) & (cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XU @ ccmin) @ ccabs) @ (XT @ Xy1) @ cclt)) => (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XU @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XU @ ccmin) @ ccdiv) @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccmin) @ ccabs) @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ cclt))) @ (^ [Xz:$i] : (ccdif @ XX @ (ccsn @ XU))))))) => ((! [Xy1:$i] : (XS = (cco @ (cco @ XU @ (ccif @ (cwbr @ XB2 @ (cco @ XU @ (XT @ Xy1) @ ccaddc) @ ccle) @ XB2 @ (cco @ XU @ (XT @ Xy1) @ ccaddc)) @ ccaddc) @ cc2 @ ccdiv))) => (! [Xz:$i] : (~ (Xph @ Xz)))))))))))))))))))))).
...
thf(advferm2lem_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwf @ XX @ ccr @ XF))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwss @ XX @ ccr))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XU @ ccioo))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccc0 @ cclt))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XT @ Xy1) @ ccrp)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => (cwral @ (^ [Xz:$i] : ((((ccv @ Xz) != XU) & (cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XU @ ccmin) @ ccabs) @ (XT @ Xy1) @ cclt)) => (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XU @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XU @ ccmin) @ ccdiv) @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccmin) @ ccabs) @ (ccneg @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv))) @ cclt))) @ (^ [Xz:$i] : (ccdif @ XX @ (ccsn @ XU))))))) => ((! [Xy1:$i] : (XS = (cco @ (cco @ (ccif @ (cwbr @ XA2 @ (cco @ XU @ (XT @ Xy1) @ ccmin) @ ccle) @ (cco @ XU @ (XT @ Xy1) @ ccmin) @ XA2) @ XU @ ccaddc) @ cc2 @ ccdiv))) => (! [Xz:$i] : (~ (Xph @ Xz)))))))))))))))))))))).
