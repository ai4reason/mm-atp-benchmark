...
thf(aen2i_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ ccvv))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XB2) => (cwcel @ (XD @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & ((ccv @ Xy1) = (XC @ Xx3))) <=> ((cwcel @ (ccv @ Xy1) @ XB2) & ((ccv @ Xx3) = (XD @ Xy1)))))) => (cwbr @ XA2 @ XB2 @ ccen))))))))))).
