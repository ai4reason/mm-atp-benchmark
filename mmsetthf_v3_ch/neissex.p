...
thf(aneissex_thm,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))) => (cwrex @ (^ [Xx3:$i] : (! [Xy1:$i] : ((cwss @ (ccv @ Xy1) @ (ccv @ Xx3)) => (cwcel @ XN @ (ccfv @ (ccv @ Xy1) @ (ccfv @ XJ @ ccnei)))))) @ (^ [Xx3:$i] : (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))).
