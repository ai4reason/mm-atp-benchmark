...
thf(arnascl_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((Xc_1 = (ccfv @ XW @ ccur)) => ((XN = (ccfv @ XW @ cclspn)) => ((cwcel @ XW @ ccasa) => ((ccrn @ XA2) = (ccfv @ (ccsn @ Xc_1) @ XN))))))))))).
...
thf(adf_mvr_ax,axiom,(ccmvr = (ccmpt2 @ (^ [Xi:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xr:$i] : (ccmpt @ (^ [Xx3:$i] : (ccv @ Xi)) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xf1:$i] : (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ (ccv @ Xi) @ ccmap)))) @ (^ [Xf1:$i] : (ccif @ ((ccv @ Xf1) = (ccmpt @ (^ [Xy1:$i] : (ccv @ Xi)) @ (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = (ccv @ Xx3)) @ cc1 @ ccc0)))) @ (ccfv @ (ccv @ Xr) @ ccur) @ (ccfv @ (ccv @ Xr) @ cc0g))))))))))).
thf(adf_mpl_ax,axiom,(ccmpl = (ccmpt2 @ (^ [Xi:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xr:$i] : (ccsb @ (cco @ (ccv @ Xi) @ (ccv @ Xr) @ ccmps) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccrab @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xr) @ cc0g) @ ccfsupp)) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xw) @ ccbs))) @ ccress)))))))).
thf(adf_ltbag_ax,axiom,(ccltb = (ccmpt2 @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ (ccv @ Xi) @ ccmap)))) & (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ cclt) & (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xr)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : (ccv @ Xi))))) @ (^ [Xz:$i] : (ccv @ Xi)))))))))))).
...
thf(areldmpsr_thm,conjecture,(cwrel @ (ccdm @ ccmps))).
