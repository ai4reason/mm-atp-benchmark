...
thf(areconnlem1_thm,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwss @ XA2 @ ccr) & (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn)) & ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2))) => (cwss @ (cco @ XX @ XY @ ccicc) @ XA2)))))).
