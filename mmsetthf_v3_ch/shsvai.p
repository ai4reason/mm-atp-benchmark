...
thf(ashsvai_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (((cwcel @ XC @ XA2) & (cwcel @ XD @ XB2)) => (cwcel @ (cco @ XC @ XD @ ccva) @ (cco @ XA2 @ XB2 @ ccph)))))))))).
