...
thf(aifle_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XB2 @ XA2 @ ccle)) & (Xph => Xps)) => (cwbr @ (ccif @ Xph @ XA2 @ XB2) @ (ccif @ Xps @ XA2 @ XB2) @ ccle))))))).
