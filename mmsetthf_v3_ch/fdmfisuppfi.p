...
thf(afdmfisuppfi_thm,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XD @ XR @ XF)) => ((Xph => (cwcel @ XD @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn)))))))))))).
