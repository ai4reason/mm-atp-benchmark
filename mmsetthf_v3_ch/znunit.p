...
thf(aznunit_thm,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XU = (ccfv @ XY @ ccui)) => ((XL = (ccfv @ XY @ cczrh)) => (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccz)) => ((cwcel @ (ccfv @ XA2 @ XL) @ XU) <=> ((cco @ XA2 @ XN @ ccgcd) = cc1)))))))))))).
