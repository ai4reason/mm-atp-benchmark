...
thf(avcidOLD_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XW @ cc1st)) => ((XS = (ccfv @ XW @ cc2nd)) => ((XX = (ccrn @ XG)) => (((cwcel @ XW @ ccvc) & (cwcel @ XA2 @ XX)) => ((cco @ cc1 @ XA2 @ XS) = XA2))))))))))).
