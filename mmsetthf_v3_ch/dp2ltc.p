...
thf(adp2ltc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccrp) => ((cwbr @ XB2 @ (ccdc @ cc1 @ ccc0) @ cclt) => ((cwbr @ XA2 @ XC @ cclt) => (cwbr @ (ccdp2 @ XA2 @ XB2) @ (ccdp2 @ XC @ XD) @ cclt)))))))))))).
