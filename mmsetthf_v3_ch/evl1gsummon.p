...
thf(aevl1gsummon_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [Xc_ex:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((XQ = (ccfv @ XR @ cce1)) => ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XW @ Xx3) = (ccfv @ XR @ ccpl1))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XW @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XX @ Xx3) = (ccfv @ XR @ ccv1))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ XR @ ccmgp))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ (XH @ Xx3) @ ccmg))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ (XW @ Xx3) @ ccmgp))) => ((! [Xx3:$i] : ((Xc_ex @ Xx3) = (ccfv @ (XG @ Xx3) @ ccmg))) => ((! [Xx3:$i] : ((Xc_xp @ Xx3) = (ccfv @ (XW @ Xx3) @ ccvsca))) => ((! [Xx3:$i] : ((Xc_x @ Xx3) = (ccfv @ XR @ ccmulr))) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ XK)) @ (^ [Xx3:$i] : XM))) => ((Xph => (cwss @ XM @ ccn0)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwcel @ (XN @ Xx3) @ ccn0)) @ (^ [Xx3:$i] : XM))) => ((Xph => (cwcel @ XC @ XK)) => (! [Xx3:$i] : (Xph => ((ccfv @ XC @ (ccfv @ (cco @ (XW @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XM) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (cco @ (XN @ Xx3) @ (XX @ Xx3) @ (Xc_ex @ Xx3)) @ (Xc_xp @ Xx3)))) @ ccgsu) @ XQ)) = (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : XM) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (cco @ (XN @ Xx3) @ XC @ (XE @ Xx3)) @ (Xc_x @ Xx3)))) @ ccgsu))))))))))))))))))))))))))))))))))))))).
