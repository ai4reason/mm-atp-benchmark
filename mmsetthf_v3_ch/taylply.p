...
thf(ataylply_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ XS)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XB2 @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))))) => ((XT = (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl))) => (Xph => ((cwcel @ XT @ (ccfv @ ccc @ ccply)) & (cwbr @ (ccfv @ XT @ ccdgr) @ XN @ ccle))))))))))))))))).
