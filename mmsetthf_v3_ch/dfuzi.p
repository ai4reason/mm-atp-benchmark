...
thf(adfuzi_thm,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccrab @ (^ [Xz:$i] : (cwbr @ XN @ (ccv @ Xz) @ ccle)) @ (^ [Xz:$i] : ccz)) = (ccint @ (^ [Xx3:$i] : ((cwcel @ XN @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))).
