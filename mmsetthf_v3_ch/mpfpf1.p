...
thf(ampfpf1_thm,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xy1:$i] : ((XQ @ Xy1) = (ccrn @ (ccfv @ XR @ cce1)))) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XE = (ccrn @ (cco @ cc1o @ XR @ ccevl))) => (! [Xy1:$i] : ((cwcel @ XF @ XE) => (cwcel @ (cccom @ XF @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1)))))) @ (XQ @ Xy1))))))))))))).
