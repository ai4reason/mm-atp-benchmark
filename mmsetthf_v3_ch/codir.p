...
thf(acodir_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwss @ (ccxp @ XA2 @ XB2) @ (cccom @ (cccnv @ XR) @ XR)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (? [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))).
