...
thf(aphibndlem_thm,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwss @ (ccrab @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XN @ ccgcd) = cc1)) @ (^ [Xx3:$i] : (cco @ cc1 @ XN @ ccfz))) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))).
