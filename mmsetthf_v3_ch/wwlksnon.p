...
thf(awwlksnon_thm,conjecture,(! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XN @ ccn0) & (cwcel @ XG @ (XU @ Xw @ Xa @ Xb))) => ((cco @ XN @ XG @ ccwwlksnon) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (XV @ Xw))) @ (^ [Xa:$i] : (^ [Xb:$i] : (XV @ Xw))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xa)) & ((ccfv @ XN @ (ccv @ Xw)) = (ccv @ Xb)))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))))))))))))))).
