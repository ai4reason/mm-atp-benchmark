...
thf(adpltc_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccrp) => ((cwbr @ XA2 @ XC @ cclt) => ((cwbr @ XB2 @ (ccdc @ cc1 @ ccc0) @ cclt) => (cwbr @ (cco @ XA2 @ XB2 @ ccdp) @ (cco @ XC @ XD @ ccdp) @ cclt)))))))))))).
