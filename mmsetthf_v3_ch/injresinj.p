...
thf(ainjresinj_thm,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XK @ ccn0) => (((cwf @ (cco @ ccc0 @ XK @ ccfz) @ XV @ XF) & (cwfun @ (cccnv @ (ccres @ XF @ (cco @ cc1 @ XK @ ccfzo)))) & ((ccfv @ ccc0 @ XF) != (ccfv @ XK @ XF))) => (((ccin @ (ccima @ XF @ (ccpr @ ccc0 @ XK)) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) = cc0) => (cwfun @ (cccnv @ XF))))))))).
