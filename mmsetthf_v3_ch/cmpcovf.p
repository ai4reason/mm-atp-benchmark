...
thf(acmpcovf_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((XX @ Xy1 @ Xz @ Xf1) = (ccuni @ (XJ @ Xf1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (((ccv @ Xz) = (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1))) => ((Xph @ Xy1 @ Xz) <=> (Xps @ Xx3 @ Xy1 @ Xf1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (((cwcel @ (XJ @ Xf1) @ cccmp) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwrex @ (^ [Xz:$i] : (Xph @ Xy1 @ Xz)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : (XJ @ Xf1)))) @ (^ [Xx3:$i] : (XX @ Xy1 @ Xz @ Xf1)))) => (cwrex @ (^ [Xs1:$i] : (((XX @ Xy1 @ Xz @ Xf1) = (ccuni @ (ccv @ Xs1))) & (? [Xf1:$i] : ((cwf @ (ccv @ Xs1) @ XA2 @ (ccv @ Xf1)) & (cwral @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xf1)) @ (^ [Xy1:$i] : (ccv @ Xs1))))))) @ (^ [Xs1:$i] : (ccin @ (ccpw @ (XJ @ Xf1)) @ ccfn)))))))))))))))).
