...
thf(asubrgdvds_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => ((XE = (ccfv @ XS @ ccdsr)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => (cwss @ XE @ Xc_pa))))))))))).
