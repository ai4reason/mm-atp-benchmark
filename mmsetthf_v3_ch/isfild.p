...
thf(atxhmeo_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XL @ cchmeo))) => ((Xph => (cwcel @ XG @ (cco @ XK @ XM @ cchmeo))) => (Xph => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XG))))) @ (cco @ (cco @ XJ @ XK @ cctx) @ (cco @ XL @ XM @ cctx) @ cchmeo))))))))))))))))).
thf(atxswaphmeolem_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cccom @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xx3:$i] : XY)) @ (^ [Xy1:$i] : (^ [Xx3:$i] : XX)) @ (^ [Xy1:$i] : (^ [Xx3:$i] : (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccv @ Xy1) @ (ccv @ Xx3)))))) = (ccres @ ccid @ (ccxp @ XX @ XY)))))).
thf(atxswaphmeo_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (cco @ (cco @ XJ @ XK @ cctx) @ (cco @ XK @ XJ @ cctx) @ cchmeo)))))))).
thf(apt1hmeo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XK = (ccfv @ (ccsn @ (ccop @ XA2 @ XJ)) @ ccpt)) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XA2 @ (ccv @ Xx3))))) @ (cco @ XJ @ XK @ cchmeo))))))))))))).
thf(aptuncnv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XK)) => ((XY = (ccuni @ XL)) => ((XJ = (ccfv @ XF @ ccpt)) => ((XK = (ccfv @ (ccres @ XF @ XA2) @ ccpt)) => ((XL = (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XC @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwf @ XC @ cctop @ XF)) => ((Xph => (XC = (ccun @ XA2 @ XB2))) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cccnv @ (XG @ Xx3 @ Xy1)) = (ccmpt @ (^ [Xz:$i] : (ccuni @ XJ)) @ (^ [Xz:$i] : (ccop @ (ccres @ (ccv @ Xz) @ XA2) @ (ccres @ (ccv @ Xz) @ XB2))))))))))))))))))))))))))))))).
thf(aptunhmeo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XK)) => ((XY = (ccuni @ XL)) => ((XJ = (ccfv @ XF @ ccpt)) => ((XK = (ccfv @ (ccres @ XF @ XA2) @ ccpt)) => ((XL = (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XC @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwf @ XC @ cctop @ XF)) => ((Xph => (XC = (ccun @ XA2 @ XB2))) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ (cco @ (cco @ XK @ XL @ cctx) @ XJ @ cchmeo)))))))))))))))))))))))))))).
thf(axpstopnlem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccnv @ (cco @ (ccsn @ (ccv @ Xx3)) @ (ccsn @ (ccv @ Xy1)) @ cccda)))))))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ (cco @ XJ @ XK @ cctx) @ (ccfv @ (cccnv @ (cco @ (ccsn @ XJ) @ (ccsn @ XK) @ cccda)) @ ccpt) @ cchmeo))))))))))))))).
thf(axpstps_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XT = (cco @ XR @ XS @ ccxps)) => (((cwcel @ XR @ cctps) & (cwcel @ XS @ cctps)) => (cwcel @ XT @ cctps))))))).
thf(axpstopnlem2_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3 @ Xy1) = (cco @ XR @ XS @ ccxps)))) => ((XJ = (ccfv @ XR @ cctopn)) => ((XK = (ccfv @ XS @ cctopn)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XO @ Xx3 @ Xy1) = (ccfv @ (XT @ Xx3 @ Xy1) @ cctopn)))) => ((XX = (ccfv @ XR @ ccbs)) => ((XY = (ccfv @ XS @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccnv @ (cco @ (ccsn @ (ccv @ Xx3)) @ (ccsn @ (ccv @ Xy1)) @ cccda)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XR @ cctps) & (cwcel @ XS @ cctps)) => ((XO @ Xx3 @ Xy1) = (cco @ XJ @ XK @ cctx)))))))))))))))))))))).
thf(axpstopn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : ((XT = (cco @ XR @ XS @ ccxps)) => ((XJ = (ccfv @ XR @ cctopn)) => ((XK = (ccfv @ XS @ cctopn)) => ((XO = (ccfv @ XT @ cctopn)) => (((cwcel @ XR @ cctps) & (cwcel @ XS @ cctps)) => (XO = (cco @ XJ @ XK @ cctx)))))))))))))).
thf(aptcmpfi_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwf @ XA2 @ cccmp @ XF)) => (cwcel @ (ccfv @ XF @ ccpt) @ cccmp))))).
thf(axkocnv_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((XF = (ccmpt @ (^ [Xf1:$i] : (cco @ (cco @ XJ @ XK @ cctx) @ XL @ cccn)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xf1))))))))) => ((Xph => (cwcel @ XJ @ (ccnlly @ cccmp))) => ((Xph => (cwcel @ XK @ (ccnlly @ cccmp))) => ((Xph => (cwcel @ XL @ cctop)) => (Xph => ((cccnv @ XF) = (ccmpt @ (^ [Xg1:$i] : (cco @ XJ @ (cco @ XL @ XK @ ccxko) @ cccn)) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)))))))))))))))))))))))).
thf(axkohmeo_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((XF = (ccmpt @ (^ [Xf1:$i] : (cco @ (cco @ XJ @ XK @ cctx) @ XL @ cccn)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xf1))))))))) => ((Xph => (cwcel @ XJ @ (ccnlly @ cccmp))) => ((Xph => (cwcel @ XK @ (ccnlly @ cccmp))) => ((Xph => (cwcel @ XL @ cctop)) => (Xph => (cwcel @ XF @ (cco @ (cco @ XL @ (cco @ XJ @ XK @ cctx) @ ccxko) @ (cco @ (cco @ XL @ XK @ ccxko) @ XJ @ ccxko) @ cchmeo))))))))))))))))).
thf(aqtopf1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwf1 @ XX @ XY @ XF)) => (Xph => (cwcel @ XF @ (cco @ XJ @ (cco @ XJ @ XF @ ccqtop) @ cchmeo))))))))))).
thf(aqtophmeo_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xf1:$i] : (Xph => (cwcel @ XJ @ (ccfv @ (XX @ Xf1) @ cctopon)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (Xph => (cwfo @ (XX @ Xf1) @ (XY @ Xy1) @ XF)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (Xph => (cwfo @ (XX @ Xf1) @ (XY @ Xy1) @ XG)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XX @ Xf1)) & (cwcel @ (ccv @ Xy1) @ (XX @ Xf1)))) => (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) <=> ((ccfv @ (ccv @ Xx3) @ XG) = (ccfv @ (ccv @ Xy1) @ XG))))))) => (Xph => (cwreu @ (^ [Xf1:$i] : (XG = (cccom @ (ccv @ Xf1) @ XF))) @ (^ [Xf1:$i] : (cco @ (cco @ XJ @ XF @ ccqtop) @ (cco @ XJ @ XG @ ccqtop) @ cchmeo))))))))))))))).
...
thf(aist1_5lem_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ XA2) => (cwcel @ XJ @ cct0)) => (((cwbr @ XJ @ (ccfv @ XJ @ cckq) @ cchmph) => ((cwcel @ XJ @ XA2) => (cwcel @ (ccfv @ XJ @ cckq) @ XA2))) => (((cwbr @ (ccfv @ XJ @ cckq) @ XJ @ cchmph) => ((cwcel @ (ccfv @ XJ @ cckq) @ XA2) => (cwcel @ XJ @ XA2))) => ((cwcel @ XJ @ XA2) <=> ((cwcel @ XJ @ cct0) & (cwcel @ (ccfv @ XJ @ cckq) @ XA2))))))))).
thf(at1r0_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cct1) => (cwcel @ (ccfv @ XJ @ cckq) @ cct1)))).
thf(aist1_5_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cct1) <=> ((cwcel @ XJ @ cct0) & (cwcel @ (ccfv @ XJ @ cckq) @ cct1))))).
...
thf(anrmhaus_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccnrm) => ((cwcel @ XJ @ ccha) <=> (cwcel @ XJ @ cct1))))).
thf(aelmptrab_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (XD @ Xy1)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XX) & ((ccv @ Xy1) = XY)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XB2 @ Xx3) = XC))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xy1)) => (cwcel @ (XB2 @ Xx3) @ XV)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XY @ (ccfv @ XX @ (XF @ Xx3 @ Xy1))) <=> ((cwcel @ XX @ (XD @ Xy1)) & (cwcel @ XY @ XC) & Xps)))))))))))))))))).
thf(aelmptrab2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XX) & ((ccv @ Xy1) = XY)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XB2 @ Xx3) = XC))) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (((cwcel @ XY @ XC) => (cwcel @ XX @ XW)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XY @ (ccfv @ XX @ (XF @ Xx3 @ Xy1))) <=> ((cwcel @ XY @ XC) & Xps)))))))))))))))))).
thf(aisfbas_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1)) => ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) <=> ((cwss @ XF @ (ccpw @ XB2)) & ((XF != cc0) & (~ (wnel @ cc0 @ XF)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccin @ XF @ (ccpw @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) != cc0)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF)))))))))))).
thf(afbasne0_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) => (XF != cc0))))).
...
thf(afbelss_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) & (cwcel @ XX @ XF)) => (cwss @ XX @ XB2)))))).
thf(afbdmn0_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) => (XB2 != cc0))))).
thf(aisfbas2_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1 @ Xz)) => ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) <=> ((cwss @ XF @ (ccpw @ XB2)) & ((XF != cc0) & (~ (wnel @ cc0 @ XF)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccv @ Xz) @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : XF))) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF))))))))))))).
thf(afbasssin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XA2 @ XF) & (cwcel @ XB2 @ XF)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2))) @ (^ [Xx3:$i] : XF)))))))).
thf(afbssfi_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XA2 @ (ccfv @ XF @ ccfi))) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XF))))))).
thf(afbssint_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) & (cwss @ XA2 @ XF) & (cwcel @ XA2 @ ccfn)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccint @ XA2))) @ (^ [Xx3:$i] : XF))))))).
thf(afbncp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XA2 @ XF)) => (~ (cwcel @ (ccdif @ XB2 @ XA2) @ XF)))))))).
thf(afbun_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XG @ (ccfv @ XX @ ccfbas))) => ((cwcel @ (ccun @ XF @ XG) @ (ccfv @ XX @ ccfbas)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccv @ Xz) @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccun @ XF @ XG)))) @ (^ [Xy1:$i] : XG))) @ (^ [Xx3:$i] : XF)))))))).
thf(afbfinnfr_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) & (cwcel @ XS @ XF) & (cwcel @ XS @ ccfn)) => ((ccint @ XF) != cc0)))))).
thf(aopnfbas_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & (XS != cc0)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ XS @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XJ)) @ (ccfv @ XX @ ccfbas)))))))).
...
thf(atrfbas_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xv:$i] : (((cwcel @ XF @ (ccfv @ (XY @ Xv) @ ccfbas)) & (cwss @ XA2 @ (XY @ Xv))) => ((cwcel @ (cco @ XF @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfbas)) <=> (cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xv) @ XA2) != cc0)) @ (^ [Xv:$i] : XF))))))))).
thf(ccfil_tp,type,(ccfil : ($i > $o))).
thf(adf_fil_ax,axiom,(ccfil = (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (((ccin @ (ccv @ Xf1) @ (ccpw @ (ccv @ Xx3))) != cc0) => (cwcel @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xz))))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xz) @ ccfbas))))))).
...
thf(aisfildlem_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => (! [Xx3:$i] : (Xph => ((cwcel @ (XB2 @ Xx3) @ XF) <=> ((cwss @ (XB2 @ Xx3) @ XA2) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XB2 @ Xx3)))))))))))))).
thf(aisfild_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3 @ Xz)))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => ((! [Xz:$i] : (Xph => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ XA2))) => ((! [Xz:$i] : (Xph => (~ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ cc0)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xz) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz)) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xz) @ XA2)) => (((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz))) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))) => (Xph => (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
