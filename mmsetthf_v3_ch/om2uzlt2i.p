...
thf(aom2uzlt2i_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwcel @ XC @ ccz) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XC) @ ccom))) => (! [Xx3:$i] : (((cwcel @ (XA2 @ Xx3) @ ccom) & (cwcel @ (XB2 @ Xx3) @ ccom)) => ((cwcel @ (XA2 @ Xx3) @ (XB2 @ Xx3)) <=> (cwbr @ (ccfv @ (XA2 @ Xx3) @ (XG @ Xx3)) @ (ccfv @ (XB2 @ Xx3) @ (XG @ Xx3)) @ cclt))))))))))).
