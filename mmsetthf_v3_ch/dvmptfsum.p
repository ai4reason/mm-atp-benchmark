...
thf(advmptfsum_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : ((XJ @ Xx3 @ Xi) = (cco @ (XK @ Xx3 @ Xi) @ XS @ ccrest)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XK @ Xx3 @ Xi) = (ccfv @ cccnfld @ cctopn)))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xx3:$i] : (! [Xi:$i] : (Xph => (cwcel @ XX @ (XJ @ Xx3 @ Xi))))) => ((Xph => (cwcel @ XI @ ccfn)) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI) & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3 @ Xi) @ ccc)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI) & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3 @ Xi) @ ccc)))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI)) => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xi))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xi)))))) => (Xph => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XI @ (^ [Xi:$i] : (XA2 @ Xx3 @ Xi))))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XI @ (^ [Xi:$i] : (XB2 @ Xx3 @ Xi)))))))))))))))))))))))).
