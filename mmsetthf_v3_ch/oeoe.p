...
thf(aoeoe_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => ((cco @ (cco @ XA2 @ XB2 @ ccoe) @ XC @ ccoe) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccoe))))))).
