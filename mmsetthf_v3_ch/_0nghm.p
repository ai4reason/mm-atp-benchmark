...
thf(a_0nghm_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XT @ cc0g)) => (((cwcel @ XS @ ccngp) & (cwcel @ XT @ ccngp)) => (cwcel @ (ccxp @ XV @ (ccsn @ Xc_0)) @ (cco @ XS @ XT @ ccnghm)))))))))).
