...
thf(a_2if2_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((Xph & Xps) => (XD = XA2)) => (((Xph & (~ Xps) & Xth) => (XD = XB2)) => (((Xph & (~ Xps) & (~ Xth)) => (XD = XC)) => (Xph => (XD = (ccif @ Xps @ XA2 @ (ccif @ Xth @ XB2 @ XC))))))))))))))).
