...
thf(avccl_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XW @ cc1st)) => ((XS = (ccfv @ XW @ cc2nd)) => ((XX = (ccrn @ XG)) => (((cwcel @ XW @ ccvc) & (cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ XX)) => (cwcel @ (cco @ XA2 @ XB2 @ XS) @ XX)))))))))))).
