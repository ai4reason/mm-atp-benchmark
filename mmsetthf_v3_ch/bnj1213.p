...
thf(abnj1213_thm,conjecture,(! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3))) => ((! [Xx3:$i] : ((Xth @ Xx3) => (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)))) => (! [Xx3:$i] : ((Xth @ Xx3) => (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)))))))))).
