...
thf(asubfzo0_thm,conjecture,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo))) => ((cwbr @ (ccneg @ XN) @ (cco @ XI @ XJ @ ccmin) @ cclt) & (cwbr @ (cco @ XI @ XJ @ ccmin) @ XN @ cclt))))))).
