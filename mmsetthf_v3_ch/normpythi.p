...
thf(anormpythi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (((cco @ XA2 @ XB2 @ ccsp) = ccc0) => ((cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ cc2 @ ccexp) = (cco @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ XB2 @ ccno) @ cc2 @ ccexp) @ ccaddc)))))))).
