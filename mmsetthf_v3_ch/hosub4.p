...
thf(ahosub4_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((((cwf @ cchil @ cchil @ XR) & (cwf @ cchil @ cchil @ XS)) & ((cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU))) => ((cco @ (cco @ XR @ XS @ cchos) @ (cco @ XT @ XU @ cchos) @ cchod) = (cco @ (cco @ XR @ XT @ cchod) @ (cco @ XS @ XU @ cchod) @ cchos)))))))).
