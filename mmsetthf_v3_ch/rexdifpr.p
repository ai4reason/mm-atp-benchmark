...
thf(arexdifpr_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccpr @ (XB2 @ Xx3) @ (XC @ Xx3))))) <=> (cwrex @ (^ [Xx3:$i] : (((ccv @ Xx3) != (XB2 @ Xx3)) & ((ccv @ Xx3) != (XC @ Xx3)) & (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
