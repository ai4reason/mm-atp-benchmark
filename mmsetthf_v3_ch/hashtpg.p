...
thf(ahashtpg_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XW)) => (((XA2 != XB2) & (XB2 != XC) & (XC != XA2)) <=> ((ccfv @ (cctp @ XA2 @ XB2 @ XC) @ cchash) = cc3)))))))))).
