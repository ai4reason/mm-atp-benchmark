...
thf(a_2lgsoddprmlem1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (XN = (cco @ (cco @ cc8 @ XA2 @ ccmul) @ XB2 @ ccaddc))) => ((cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) = (cco @ (cco @ (cco @ cc8 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccaddc))))))).
