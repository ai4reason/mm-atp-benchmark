...
thf(atglnpt2_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XP @ Xy1) = (ccfv @ (XG @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((XI @ Xy1) = (ccfv @ (XG @ Xy1) @ ccitv))) => ((! [Xy1:$i] : ((XL @ Xy1) = (ccfv @ (XG @ Xy1) @ cclng))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XG @ Xy1) @ ccstrkg))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ (ccrn @ (XL @ Xy1))))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XX @ XA2))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwrex @ (^ [Xy1:$i] : (XX != (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2)))))))))))))))))).
