...
thf(acnpval_thm,conjecture,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon)) & (cwcel @ XP @ XX)) => ((ccfv @ XP @ (cco @ XJ @ XK @ cccnp)) = (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccfv @ XP @ (ccv @ Xf1)) @ (ccv @ Xy1)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xx3)) @ (ccv @ Xy1)))) @ (^ [Xx3:$i] : XJ)))) @ (^ [Xy1:$i] : XK))) @ (^ [Xf1:$i] : (cco @ XY @ XX @ ccmap))))))))))).
