...
thf(abitsinv1lem_thm,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((cco @ XN @ (cco @ cc2 @ (cco @ XM @ cc1 @ ccaddc) @ ccexp) @ ccmo) = (cco @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccmo) @ (ccif @ (cwcel @ XM @ (ccfv @ XN @ ccbits)) @ (cco @ cc2 @ XM @ ccexp) @ ccc0) @ ccaddc)))))).
