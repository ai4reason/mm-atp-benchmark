...
thf(aisnrm_thm,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccnrm) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwss @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwss @ (ccfv @ (ccv @ Xz) @ (ccfv @ XJ @ cccl)) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XJ))) @ (^ [Xy1:$i] : (ccin @ (ccfv @ XJ @ cccld) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XJ)))))).
