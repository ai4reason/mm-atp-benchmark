...
thf(as8cld_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => (cwcel @ XD @ XX)) => ((Xph => (cwcel @ XE @ XX)) => ((Xph => (cwcel @ XF @ XX)) => ((Xph => (cwcel @ XG @ XX)) => ((Xph => (cwcel @ XH @ XX)) => (Xph => (cwcel @ (ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) @ (ccword @ XX)))))))))))))))))))))).
