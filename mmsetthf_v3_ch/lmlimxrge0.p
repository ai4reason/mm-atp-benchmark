...
thf(almlimxrge0_thm,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn)) => ((Xph => (cwf @ ccn @ XX @ XF)) => ((Xph => (cwcel @ XP @ XX)) => ((cwss @ XX @ (cco @ ccc0 @ ccpnf @ ccico)) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ XF @ XP @ ccli))))))))))))).
