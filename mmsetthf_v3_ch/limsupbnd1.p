...
thf(alimsupbnd1_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XB2 @ ccr)) => ((Xph => (cwf @ XB2 @ ccxr @ XF)) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xj) @ XF) @ XA2 @ ccle))) @ (^ [Xj:$i] : XB2))) @ (^ [Xk:$i] : ccr))) => (Xph => (cwbr @ (ccfv @ XF @ cclsp) @ XA2 @ ccle))))))))))).
