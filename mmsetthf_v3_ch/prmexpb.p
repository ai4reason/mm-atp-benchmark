...
thf(aprmexpb_thm,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime)) & ((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn))) => (((cco @ XP @ XM @ ccexp) = (cco @ XQ @ XN @ ccexp)) <=> ((XP = XQ) & (XM = XN))))))))).
