...
thf(aisdir_thm,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccuni @ (ccuni @ XR))) => ((cwcel @ XR @ XV) => ((cwcel @ XR @ ccdir) <=> (((cwrel @ XR) & (cwss @ (ccres @ ccid @ XA2) @ XR)) & ((cwss @ (cccom @ XR @ XR) @ XR) & (cwss @ (ccxp @ XA2 @ XA2) @ (cccom @ (cccnv @ XR) @ XR))))))))))).
