...
thf(akur14lem5_thm,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ cctop) => ((XX = (ccuni @ XJ)) => ((XK = (ccfv @ XJ @ cccl)) => ((XI = (ccfv @ XJ @ ccnt)) => ((cwss @ XA2 @ XX) => ((ccfv @ (ccfv @ XA2 @ XK) @ XK) = (ccfv @ XA2 @ XK))))))))))))).
