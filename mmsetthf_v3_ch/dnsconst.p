...
thf(adnsconst_thm,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XK @ cct1) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) & ((cwcel @ XP @ XY) & (cwss @ XA2 @ (ccima @ (cccnv @ XF) @ (ccsn @ XP))) & ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XX))) => (cwf @ XX @ (ccsn @ XP) @ XF)))))))))))).
