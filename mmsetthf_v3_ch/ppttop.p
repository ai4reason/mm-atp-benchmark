...
thf(appttop_thm,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XP @ XA2)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) | ((ccv @ Xx3) = cc0))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ cctopon))))))).
