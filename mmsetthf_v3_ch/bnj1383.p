...
thf(abnj1383_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : ((Xph @ Xf1) <=> (cwral @ (^ [Xf1:$i] : (cwfun @ (ccv @ Xf1))) @ (^ [Xf1:$i] : XA2)))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xf1 @ Xg1) = (ccin @ (ccdm @ (ccv @ Xf1)) @ (ccdm @ (ccv @ Xg1)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xps @ Xf1 @ Xg1) <=> ((Xph @ Xf1) & (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : ((ccres @ (ccv @ Xf1) @ (XD @ Xf1 @ Xg1)) = (ccres @ (ccv @ Xg1) @ (XD @ Xf1 @ Xg1)))) @ (^ [Xg1:$i] : XA2))) @ (^ [Xf1:$i] : XA2)))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((Xps @ Xf1 @ Xg1) => (cwfun @ (ccuni @ XA2))))))))))))).
