...
thf(amodadd2mod_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XM @ ccrp)) => ((cco @ (cco @ XB2 @ (cco @ XA2 @ XM @ ccmo) @ ccaddc) @ XM @ ccmo) = (cco @ (cco @ XB2 @ XA2 @ ccaddc) @ XM @ ccmo))))))).
