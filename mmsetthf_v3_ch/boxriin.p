...
thf(aboxriin_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XI)) => ((ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccin @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciin @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))))))).
