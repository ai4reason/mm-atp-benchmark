...
thf(acshwidxn_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (cco @ XW @ XN @ cccsh)) = (ccfv @ (cco @ XN @ cc1 @ ccmin) @ XW))))))).
