...
thf(afzosubel_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) & (cwcel @ XD @ ccz)) => (cwcel @ (cco @ XA2 @ XD @ ccmin) @ (cco @ (cco @ XB2 @ XD @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccfzo)))))))).
