...
thf(af1oabexg_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xf1:$i] : ((XF @ Xf1) = (^ [Xf1:$i] : ((cwf1o @ XA2 @ XB2 @ (ccv @ Xf1)) & (Xph @ Xf1))))) => (! [Xf1:$i] : (((cwcel @ XA2 @ (XC @ Xf1)) & (cwcel @ XB2 @ (XD @ Xf1))) => (cwcel @ (XF @ Xf1) @ ccvv))))))))))).
