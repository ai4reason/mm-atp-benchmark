...
thf(apsgnran_thm,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XS = (ccfv @ XN @ ccpsgn)) => (((cwcel @ XN @ ccfn) & (cwcel @ XQ @ XP)) => (cwcel @ (ccfv @ XQ @ XS) @ (ccpr @ cc1 @ (ccneg @ cc1))))))))))).
