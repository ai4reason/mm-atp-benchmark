...
thf(amon1pldg_thm,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XM = (ccfv @ XR @ ccmn1)) => ((cwcel @ XF @ XM) => ((ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) = Xc_1))))))))))).
