...
thf(aabs3lem_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ ccc) & (cwcel @ XD @ ccr))) => (((cwbr @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt) & (cwbr @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XD @ cclt)))))))).
