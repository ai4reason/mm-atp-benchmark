...
thf(acntzi_thm,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((XZ = (ccfv @ XM @ cccntz)) => (((cwcel @ XX @ (ccfv @ XS @ XZ)) & (cwcel @ XY @ XS)) => ((cco @ XX @ XY @ Xc_pl) = (cco @ XY @ XX @ Xc_pl)))))))))))).
