...
thf(alcmfunsnlem_thm,conjecture,(! [XY:($i > $o)] : (((cwss @ XY @ ccz) & (cwcel @ XY @ ccfn)) => ((cwral @ (^ [Xk:$i] : ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccdvds)) @ (^ [Xm:$i] : XY)) => (cwbr @ (ccfv @ XY @ cclcmf) @ (ccv @ Xk) @ ccdvds))) @ (^ [Xk:$i] : ccz)) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccun @ XY @ (ccsn @ (ccv @ Xn))) @ cclcmf) = (cco @ (ccfv @ XY @ cclcmf) @ (ccv @ Xn) @ cclcm))) @ (^ [Xn:$i] : ccz)))))).
