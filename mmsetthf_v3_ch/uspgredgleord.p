...
thf(auspgredgleord_thm,conjecture,(! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : ((XV @ Xe) = (ccfv @ (XG @ Xe) @ ccvtx))) => ((! [Xe:$i] : (XE = (ccfv @ (XG @ Xe) @ ccedg))) => (! [Xe:$i] : (((cwcel @ (XG @ Xe) @ ccuspgr) & (cwcel @ XN @ (XV @ Xe))) => (cwbr @ (ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash) @ (ccfv @ (XV @ Xe) @ cchash) @ ccle)))))))))).
