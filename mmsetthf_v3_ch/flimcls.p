...
thf(aflimcls_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwss @ XS @ XX)) => ((cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) <=> (cwrex @ (^ [Xf1:$i] : ((cwcel @ XS @ (ccv @ Xf1)) & (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xf1) @ ccflim)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))))).
