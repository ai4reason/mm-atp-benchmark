...
thf(awlksoneq1eq2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (((cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccwlkson))) & (cwbr @ XH @ XP @ (cco @ XC @ XD @ (ccfv @ XG @ ccwlkson)))) => ((XA2 = XC) & (XB2 = XD)))))))))))).
