...
thf(aabs3difd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccabs) @ ccaddc) @ ccle)))))))))).
