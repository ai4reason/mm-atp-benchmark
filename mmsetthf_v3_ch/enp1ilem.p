...
thf(aenp1ilem_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : ((XT @ Xx3) = (ccun @ (ccsn @ (ccv @ Xx3)) @ (XS @ Xx3)))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) => (((ccdif @ (XA2 @ Xx3) @ (ccsn @ (ccv @ Xx3))) = (XS @ Xx3)) => ((XA2 @ Xx3) = (XT @ Xx3)))))))))).
