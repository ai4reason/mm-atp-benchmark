...
thf(ann0indd_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [Xet:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = ccc0) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xps @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xps @ Xx3) <=> (Xet @ Xy1))))) => ((! [Xy1:$i] : (Xph => (Xch @ Xy1))) => ((! [Xy1:$i] : (((Xph & (cwcel @ (ccv @ Xy1) @ ccn0)) & (Xth @ Xy1)) => (Xta @ Xy1))) => (! [Xy1:$i] : ((Xph & (cwcel @ (XA2 @ Xy1) @ ccn0)) => (Xet @ Xy1))))))))))))))))).
