...
thf(apwsco2rhm_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XR @ XA2 @ ccpws)) => ((XZ = (cco @ XS @ XA2 @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((! [Xg1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xg1)))) => ((Xph => (cwcel @ XF @ (cco @ XR @ XS @ ccrh))) => (Xph => (cwcel @ (ccmpt @ (^ [Xg1:$i] : XB2) @ (^ [Xg1:$i] : (cccom @ XF @ (ccv @ Xg1)))) @ (cco @ XY @ XZ @ ccrh)))))))))))))))))).
