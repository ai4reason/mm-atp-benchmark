...
thf(ahoadd4_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((((cwf @ cchil @ cchil @ XR) & (cwf @ cchil @ cchil @ XS)) & ((cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU))) => ((cco @ (cco @ XR @ XS @ cchos) @ (cco @ XT @ XU @ cchos) @ cchos) = (cco @ (cco @ XR @ XT @ cchos) @ (cco @ XS @ XU @ cchos) @ cchos)))))))).
