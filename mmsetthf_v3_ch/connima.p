...
thf(aconnima_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn)) => (Xph => (cwcel @ (cco @ XK @ (ccima @ XF @ XA2) @ ccrest) @ ccconn))))))))))))).
