...
thf(ajoinlmuladdmuld_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccaddc) = XD)) => (Xph => ((cco @ (cco @ XA2 @ XC @ ccaddc) @ XB2 @ ccmul) = XD)))))))))))).
