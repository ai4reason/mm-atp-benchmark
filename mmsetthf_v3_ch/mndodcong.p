...
thf(amndodcong_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((((cwcel @ XG @ ccmnd) & (cwcel @ XA2 @ XX)) & ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XM @ XN @ ccmin) @ ccdvds) <=> ((cco @ XM @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))))).
