...
thf(a_1strwun_thm,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccsn @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2))) => ((Xph => (cwcel @ XU @ ccwun)) => ((Xph => (cwcel @ ccom @ XU)) => ((Xph & (cwcel @ XB2 @ XU)) => (cwcel @ XG @ XU)))))))))).
