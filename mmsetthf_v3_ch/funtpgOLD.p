...
thf(afuntpgOLD_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XX @ XU) & (cwcel @ XY @ XV) & (cwcel @ XZ @ XW)) & ((cwcel @ XA2 @ XF) & (cwcel @ XB2 @ XG) & (cwcel @ XC @ XH)) & ((XX != XY) & (XX != XZ) & (XY != XZ))) => (cwfun @ (cctp @ (ccop @ XX @ XA2) @ (ccop @ XY @ XB2) @ (ccop @ XZ @ XC))))))))))))))))).
