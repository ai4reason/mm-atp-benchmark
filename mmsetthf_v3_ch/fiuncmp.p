...
thf(afiuncmp_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccuni @ XJ))) => (((cwcel @ XJ @ cctop) & (cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ XJ @ (XB2 @ Xx3) @ ccrest) @ cccmp)) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (cco @ XJ @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccrest) @ cccmp)))))))).
