...
thf(aisfin2_2_thm,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xy1)) => ((cwcel @ XA2 @ ccfin2) <=> (cwral @ (^ [Xy1:$i] : ((((ccv @ Xy1) != cc0) & (cwor @ (ccv @ Xy1) @ ccrpss)) => (cwcel @ (ccint @ (ccv @ Xy1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (ccpw @ XA2)))))))))).
