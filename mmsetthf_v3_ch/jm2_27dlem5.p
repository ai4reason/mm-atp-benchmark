...
thf(ajm2_27dlem5_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XB2 = (cco @ XA2 @ cc1 @ ccaddc)) => ((cwss @ (cco @ cc1 @ XB2 @ ccfz) @ (cco @ cc1 @ XC @ ccfz)) => (cwss @ (cco @ cc1 @ XA2 @ ccfz) @ (cco @ cc1 @ XC @ ccfz)))))))).
