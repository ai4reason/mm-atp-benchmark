...
thf(amodvalp1_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ XB2 @ ccmul) @ ccmin) = (cco @ XA2 @ XB2 @ ccmo)))))).
