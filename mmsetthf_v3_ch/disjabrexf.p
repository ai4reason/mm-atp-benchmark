...
thf(adisjabrexf_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (cwdisj @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) @ (^ [Xy1:$i] : (ccv @ Xy1)))))))).
