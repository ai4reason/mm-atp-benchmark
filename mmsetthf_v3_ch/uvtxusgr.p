...
thf(auvtxusgr_thm,conjecture,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : (! [Xn:$i] : ((XE @ Xk @ Xn) = (ccfv @ XG @ ccedg)))) => ((cwcel @ XG @ ccusgr) => ((ccfv @ XG @ ccuvtx) = (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xk:$i] : (cwcel @ (ccpr @ (ccv @ Xk) @ (ccv @ Xn)) @ (XE @ Xk @ Xn))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xn)))))) @ (^ [Xn:$i] : XV)))))))))).
