...
thf(agsummptfidmadd2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((! [Xx3:$i] : (XB2 = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (Xc_pl = (ccfv @ (XG @ Xx3) @ ccplusg))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ cccmn))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XD @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3))))) => (! [Xx3:$i] : (Xph => ((cco @ (XG @ Xx3) @ (cco @ (XF @ Xx3) @ (XH @ Xx3) @ (ccof @ Xc_pl)) @ ccgsu) = (cco @ (cco @ (XG @ Xx3) @ (XF @ Xx3) @ ccgsu) @ (cco @ (XG @ Xx3) @ (XH @ Xx3) @ ccgsu) @ Xc_pl)))))))))))))))))))))).
thf(agsumzsplit_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xph => (cwcel @ XG @ ccmnd)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ XZ))) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XA2 = (ccun @ XC @ XD))) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ (cco @ XG @ (ccres @ XF @ XC) @ ccgsu) @ (cco @ XG @ (ccres @ XF @ XD) @ ccgsu) @ Xc_pl)))))))))))))))))))))))))).
thf(agsumsplit_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XA2 = (ccun @ XC @ XD))) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ (cco @ XG @ (ccres @ XF @ XC) @ ccgsu) @ (cco @ XG @ (ccres @ XF @ XD) @ ccgsu) @ Xc_pl))))))))))))))))))))))).
thf(agsumsplit2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xc_0 @ Xk) = (ccfv @ (XG @ Xk) @ cc0g))) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwcel @ (XG @ Xk) @ cccmn))) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XX @ Xk) @ XB2))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ (Xc_0 @ Xk) @ ccfsupp))) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XA2 = (ccun @ XC @ XD))) => (! [Xk:$i] : (Xph => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) = (cco @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : XD) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ (Xc_pl @ Xk))))))))))))))))))))))))).
...
thf(agsummptfidmsplitres_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwcel @ (XG @ Xk) @ cccmn))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XY @ Xk) @ XB2))) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XA2 = (ccun @ XC @ XD))) => ((! [Xk:$i] : ((XF @ Xk) = (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XY @ Xk))))) => (! [Xk:$i] : (Xph => ((cco @ (XG @ Xk) @ (XF @ Xk) @ ccgsu) = (cco @ (cco @ (XG @ Xk) @ (ccres @ (XF @ Xk) @ XC) @ ccgsu) @ (cco @ (XG @ Xk) @ (ccres @ (XF @ Xk) @ XD) @ ccgsu) @ (Xc_pl @ Xk))))))))))))))))))))))).
thf(agsummptfzsplit_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwcel @ (XG @ Xk) @ cccmn))) => ((Xph => (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))) => (cwcel @ (XY @ Xk) @ XB2))) => (! [Xk:$i] : (Xph => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)) @ (^ [Xk:$i] : (XY @ Xk))) @ ccgsu) = (cco @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (XY @ Xk))) @ ccgsu) @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (ccsn @ (cco @ XN @ cc1 @ ccaddc))) @ (^ [Xk:$i] : (XY @ Xk))) @ ccgsu) @ (Xc_pl @ Xk))))))))))))))))).
thf(agsummptfzsplitl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwcel @ (XG @ Xk) @ cccmn))) => ((Xph => (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ XN @ ccfz))) => (cwcel @ (XY @ Xk) @ XB2))) => (! [Xk:$i] : (Xph => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (XY @ Xk))) @ ccgsu) = (cco @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (XY @ Xk))) @ ccgsu) @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (ccsn @ ccc0)) @ (^ [Xk:$i] : (XY @ Xk))) @ ccgsu) @ (Xc_pl @ Xk))))))))))))))))).
...
thf(agsumconstf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XX @ Xk))) => ((! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ (XG @ Xk) @ ccmg))) => (! [Xk:$i] : (((cwcel @ (XG @ Xk) @ ccmnd) & (cwcel @ XA2 @ ccfn) & (cwcel @ (XX @ Xk) @ (XB2 @ Xk))) => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) = (cco @ (ccfv @ XA2 @ cchash) @ (XX @ Xk) @ (Xc_x @ Xk)))))))))))))).
thf(agsummptshft_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ (XG @ Xj @ Xk) @ ccbs)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xc_0 @ Xj @ Xk) = (ccfv @ (XG @ Xj @ Xk) @ cc0g)))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XG @ Xj @ Xk) @ cccmn)))) => ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xj) @ (XB2 @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (cco @ (ccv @ Xk) @ XK @ ccmin)) => ((XA2 @ Xj) = (XC @ Xk))))) => (! [Xj:$i] : (! [Xk:$i] : (Xph => ((cco @ (XG @ Xj @ Xk) @ (ccmpt @ (^ [Xj:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xj:$i] : (XA2 @ Xj))) @ ccgsu) = (cco @ (XG @ Xj @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ (cco @ XM @ XK @ ccaddc) @ (cco @ XN @ XK @ ccaddc) @ ccfz)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccgsu))))))))))))))))))))))).
thf(agsumzmhm_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xph => (cwcel @ XG @ ccmnd)) => ((Xph => (cwcel @ XH @ ccmnd)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XK @ (cco @ XG @ XH @ ccmhm))) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ XZ))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XH @ (cccom @ XK @ XF) @ ccgsu) = (ccfv @ (cco @ XG @ XF @ ccgsu) @ XK)))))))))))))))))))))))).
