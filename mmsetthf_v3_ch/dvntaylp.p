...
thf(advntaylp_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ XS)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XB2 @ (ccdm @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))) => (Xph => ((ccfv @ XM @ (cco @ ccc @ (cco @ (cco @ XN @ XM @ ccaddc) @ XB2 @ (cco @ XS @ XF @ cctayl)) @ ccdvn)) = (cco @ XN @ XB2 @ (cco @ XS @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)) @ cctayl)))))))))))))))))).
