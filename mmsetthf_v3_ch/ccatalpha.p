...
thf(accatalpha_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccword @ ccvv)) & (cwcel @ XB2 @ (ccword @ ccvv))) => ((cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccword @ XS)) <=> ((cwcel @ XA2 @ (ccword @ XS)) & (cwcel @ XB2 @ (ccword @ XS))))))))).
