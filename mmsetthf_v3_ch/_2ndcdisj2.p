...
thf(a_2ndcdisj2_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [Xy1:$i] : (((cwcel @ (XJ @ Xy1) @ cc2ndc) & (cwss @ XA2 @ (XJ @ Xy1)) & (! [Xy1:$i] : (cwrmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)))) => (cwbr @ XA2 @ ccom @ ccdom)))))).
