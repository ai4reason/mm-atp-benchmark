...
thf(asrgbinomlem_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XS = (ccfv @ XR @ ccbs)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XR @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XG @ Xk) @ ccmg))) => ((Xph => (cwcel @ XR @ ccsrg)) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => ((Xph => ((cco @ XA2 @ XB2 @ Xc_xp) = (cco @ XB2 @ XA2 @ Xc_xp))) => ((Xph => (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : ((Xps @ Xk) => ((cco @ XN @ (cco @ XA2 @ XB2 @ Xc_pl) @ Xc_ex) = (cco @ XR @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xk) @ XB2 @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu)))) => (! [Xk:$i] : ((Xph & (Xps @ Xk)) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XA2 @ XB2 @ Xc_pl) @ Xc_ex) = (cco @ XR @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccmin) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xk) @ XB2 @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu))))))))))))))))))))))))))))).
