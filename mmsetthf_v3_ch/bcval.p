...
thf(abcval_thm,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccz)) => ((cco @ XN @ XK @ ccbc) = (ccif @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ (ccfv @ (cco @ XN @ XK @ ccmin) @ ccfa) @ (ccfv @ XK @ ccfa) @ ccmul) @ ccdiv) @ ccc0)))))).
