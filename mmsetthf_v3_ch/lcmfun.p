...
thf(alcmfun_thm,conjecture,(! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwss @ XY @ ccz) & (cwcel @ XY @ ccfn)) & ((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn))) => ((ccfv @ (ccun @ XY @ XZ) @ cclcmf) = (cco @ (ccfv @ XY @ cclcmf) @ (ccfv @ XZ @ cclcmf) @ cclcm)))))).
