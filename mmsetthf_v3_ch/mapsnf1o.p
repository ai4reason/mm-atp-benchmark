...
thf(amapsnf1o_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ XI) @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & (cwcel @ XI @ XW)) => (cwf1o @ XA2 @ (cco @ XA2 @ (ccsn @ XI) @ ccmap) @ (XF @ Xx3))))))))))).
