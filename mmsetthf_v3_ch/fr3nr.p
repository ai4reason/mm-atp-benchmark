...
thf(afr3nr_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (((cwfr @ XA2 @ XR) & ((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XA2) & (cwcel @ XD @ XA2))) => (~ ((cwbr @ XB2 @ XC @ XR) & (cwbr @ XC @ XD @ XR) & (cwbr @ XD @ XB2 @ XR)))))))))).
