...
thf(atsrlemax_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => (((cwcel @ XR @ cctsr) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ XR) @ XC @ XB2) @ XR) <=> ((cwbr @ XA2 @ XB2 @ XR) | (cwbr @ XA2 @ XC @ XR))))))))))).
thf(atsrps_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ cctsr) => (cwcel @ XR @ ccps)))).
thf(acnvtsr_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ cctsr) => (cwcel @ (cccnv @ XR) @ cctsr)))).
thf(atsrss_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XR @ cctsr) => (cwcel @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ cctsr))))).
thf(aledm_thm,axiom,(ccxr = (ccdm @ ccle))).
thf(alern_thm,axiom,(ccxr = (ccrn @ ccle))).
thf(alefld_thm,axiom,(ccxr = (ccuni @ (ccuni @ ccle)))).
thf(aletsr_thm,axiom,(cwcel @ ccle @ cctsr)).
thf(ccdir_tp,type,(ccdir : ($i > $o))).
thf(cctail_tp,type,(cctail : ($i > $o))).
thf(adf_dir_ax,axiom,(ccdir = (^ [Xr:$i] : (((cwrel @ (ccv @ Xr)) & (cwss @ (ccres @ ccid @ (ccuni @ (ccuni @ (ccv @ Xr)))) @ (ccv @ Xr))) & ((cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr)) & (cwss @ (ccxp @ (ccuni @ (ccuni @ (ccv @ Xr))) @ (ccuni @ (ccuni @ (ccv @ Xr)))) @ (cccom @ (cccnv @ (ccv @ Xr)) @ (ccv @ Xr)))))))).
thf(adf_tail_ax,axiom,(cctail = (ccmpt @ (^ [Xr:$i] : ccdir) @ (^ [Xr:$i] : (ccmpt @ (^ [Xx3:$i] : (ccuni @ (ccuni @ (ccv @ Xr)))) @ (^ [Xx3:$i] : (ccima @ (ccv @ Xr) @ (ccsn @ (ccv @ Xx3))))))))).
thf(aisdir_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccuni @ (ccuni @ XR))) => ((cwcel @ XR @ XV) => ((cwcel @ XR @ ccdir) <=> (((cwrel @ XR) & (cwss @ (ccres @ ccid @ XA2) @ XR)) & ((cwss @ (cccom @ XR @ XR) @ XR) & (cwss @ (ccxp @ XA2 @ XA2) @ (cccom @ (cccnv @ XR) @ XR))))))))))).
thf(areldir_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccdir) => (cwrel @ XR)))).
thf(adirdm_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccdir) => ((ccdm @ XR) = (ccuni @ (ccuni @ XR)))))).
thf(adirref_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => (((cwcel @ XR @ ccdir) & (cwcel @ XA2 @ XX)) => (cwbr @ XA2 @ XA2 @ XR))))))).
thf(adirtr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XR @ ccdir) & (cwcel @ XC @ XV)) & ((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XB2 @ XC @ XR))) => (cwbr @ XA2 @ XC @ XR)))))))).
thf(adirge_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => (((cwcel @ XR @ ccdir) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ XR) & (cwbr @ XB2 @ (ccv @ Xx3) @ XR))) @ (^ [Xx3:$i] : XX))))))))).
thf(atsrdir_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cctsr) => (cwcel @ XA2 @ ccdir)))).
thf(ccplusf_tp,type,(ccplusf : ($i > $o))).
thf(ccmgm_tp,type,(ccmgm : ($i > $o))).
thf(adf_plusf_ax,axiom,(ccplusf = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xg1) @ ccplusg))))))))).
...
thf(aismgm_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xc_op:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_op = (ccfv @ XM @ ccplusg)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XM @ (XV @ Xx3 @ Xy1)) => ((cwcel @ XM @ ccmgm) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_op) @ XB2)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))).
...
thf(aisnmgm_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_op = (ccfv @ XM @ ccplusg)) => (((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (~ (wnel @ (cco @ XX @ XY @ Xc_op) @ XB2))) => (~ (wnel @ XM @ ccmgm))))))))))).
thf(aplusffval_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_pd @ Xx3 @ Xy1) = (ccfv @ XG @ ccplusf)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xc_pd @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl))))))))))))))).
thf(aplusfval_thm,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_pd = (ccfv @ XG @ ccplusf)) => (((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_pd) = (cco @ XX @ XY @ Xc_pl))))))))))))).
