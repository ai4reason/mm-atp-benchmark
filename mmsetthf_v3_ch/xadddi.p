...
thf(axadddi_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxmu) = (cco @ (cco @ XA2 @ XB2 @ ccxmu) @ (cco @ XA2 @ XC @ ccxmu) @ ccxad))))))).
