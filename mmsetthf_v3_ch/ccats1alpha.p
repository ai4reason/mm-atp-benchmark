...
thf(accats1alpha_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XX @ XU)) => ((cwcel @ (cco @ XA2 @ (ccs1 @ XX) @ ccconcat) @ (ccword @ XS)) <=> ((cwcel @ XA2 @ (ccword @ XS)) & (cwcel @ XX @ XS)))))))))).
