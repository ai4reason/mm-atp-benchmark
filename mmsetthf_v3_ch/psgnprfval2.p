...
thf(apsgnprfval2_thm,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XD = (ccpr @ cc1 @ cc2)) => ((XG = (ccfv @ XD @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XN = (ccfv @ XD @ ccpsgn)) => ((ccfv @ (ccpr @ (ccop @ cc1 @ cc2) @ (ccop @ cc2 @ cc1)) @ XN) = (ccneg @ cc1))))))))))))).
