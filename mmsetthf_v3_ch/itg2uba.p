...
thf(aitg2uba_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ ccovol) = ccc0)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle))) => (Xph => (cwbr @ (ccfv @ XG @ ccitg1) @ (ccfv @ XF @ ccitg2) @ ccle)))))))))))).
