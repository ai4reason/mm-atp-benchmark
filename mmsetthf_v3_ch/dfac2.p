...
thf(adfac2_thm,conjecture,(cwac <=> (! [Xx3:$i] : (? [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((ccv @ Xz) != cc0) => (cwreu @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xv)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccv @ Xy1)))) @ (^ [Xw:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))).
