...
thf(aisfbas_thm,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1)) => ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) <=> ((cwss @ XF @ (ccpw @ XB2)) & ((XF != cc0) & (~ (wnel @ cc0 @ XF)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccin @ XF @ (ccpw @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) != cc0)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF)))))))))))).
