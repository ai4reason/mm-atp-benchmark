...
thf(ahosubsub4_thm,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwf @ cchil @ cchil @ XS) & (cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU)) => ((cco @ (cco @ XS @ XT @ cchod) @ XU @ cchod) = (cco @ XS @ (cco @ XT @ XU @ cchos) @ cchod))))))).
