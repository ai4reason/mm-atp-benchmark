...
thf(as8eqd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (XA2 = XN)) => ((Xph => (XB2 = XO)) => ((Xph => (XC = XP)) => ((Xph => (XD = XQ)) => ((Xph => (XE = XR)) => ((Xph => (XF = XS)) => ((Xph => (XG = XT)) => ((Xph => (XH = XU)) => (Xph => ((ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) = (ccs8 @ XN @ XO @ XP @ XQ @ XR @ XS @ XT @ XU))))))))))))))))))))))))))))).
