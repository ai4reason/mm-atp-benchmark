...
thf(almodsubid_thm,conjecture,(! [XA2:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => (((cwcel @ XW @ cclmod) & (cwcel @ XA2 @ XV)) => ((cco @ XA2 @ XA2 @ Xc_mi) = Xc_0))))))))))).
