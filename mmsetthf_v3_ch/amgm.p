...
thf(aamgm_thm,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ cccnfld @ ccmgp)) => (((cwcel @ XA2 @ ccfn) & (XA2 != cc0) & (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => (cwbr @ (cco @ (cco @ XM @ XF @ ccgsu) @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccdiv) @ cccxp) @ (cco @ (cco @ cccnfld @ XF @ ccgsu) @ (ccfv @ XA2 @ cchash) @ ccdiv) @ ccle))))))).
