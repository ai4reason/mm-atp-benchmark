...
thf(aopncldf1_thm,conjecture,(! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((! [Xu:$i] : ((XF @ Xu) = (ccmpt @ (^ [Xu:$i] : XJ) @ (^ [Xu:$i] : (ccdif @ XX @ (ccv @ Xu)))))) => (! [Xu:$i] : ((cwcel @ XJ @ cctop) => ((cwf1o @ XJ @ (ccfv @ XJ @ cccld) @ (XF @ Xu)) & ((cccnv @ (XF @ Xu)) = (ccmpt @ (^ [Xx3:$i] : (ccfv @ XJ @ cccld)) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccv @ Xx3)))))))))))))).
