...
thf(afnwe2lem3_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccfv @ (ccv @ Xx3) @ XF)) => ((XS @ Xz) = (XU @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XT @ Xx3 @ Xy1 @ Xz) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (XR @ Xz)) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XU @ Xx3))))))))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xa @ Xb) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwwe @ (ccrab @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) = (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : XA2)) @ (XU @ Xx3)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwf @ XA2 @ (XB2 @ Xx3 @ Xy1 @ Xz) @ (ccres @ XF @ XA2)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwwe @ (XB2 @ Xx3 @ Xy1 @ Xz) @ (XR @ Xz)))))))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwcel @ (ccv @ Xa) @ XA2)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwcel @ (ccv @ Xb) @ XA2)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => ((cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ (XT @ Xx3 @ Xy1 @ Xz)) | ((ccv @ Xa) = (ccv @ Xb)) | (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ (XT @ Xx3 @ Xy1 @ Xz))))))))))))))))))))))))).
