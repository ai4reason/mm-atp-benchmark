...
thf(aabscxpbnd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle)) => ((Xph => (cwcel @ XM @ ccr)) => ((Xph => (cwbr @ (ccfv @ XA2 @ ccabs) @ XM @ ccle)) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ ccabs) @ (cco @ (cco @ XM @ (ccfv @ XB2 @ ccre) @ cccxp) @ (ccfv @ (cco @ (ccfv @ XB2 @ ccabs) @ ccpi @ ccmul) @ cce) @ ccmul) @ ccle)))))))))))).
