...
thf(adivalglem0_thm,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => (((cwcel @ XR @ ccz) & (cwcel @ XK @ ccz)) => ((cwbr @ XD @ (cco @ XN @ XR @ ccmin) @ ccdvds) => (cwbr @ XD @ (cco @ XN @ (cco @ XR @ (cco @ XK @ (ccfv @ XD @ ccabs) @ ccmul) @ ccmin) @ ccmin) @ ccdvds)))))))))).
