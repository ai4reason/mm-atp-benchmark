...
thf(aadvlogexp_thm,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XN @ ccn0)) => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ cclog) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv))) @ ccmul))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ cclog) @ XN @ ccexp) @ (ccfv @ XN @ ccfa) @ ccdiv)))))))).
