...
thf(asqrtval_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccsqrt) = (ccrio @ (^ [Xx3:$i] : (((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2) & (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) & (~ (wnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp)))) @ (^ [Xx3:$i] : ccc)))))).
