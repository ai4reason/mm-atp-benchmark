...
thf(astrlemor2OLD_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwfun @ (cccnv @ (cccnv @ XF))) & (cwss @ (ccdm @ XF) @ (cco @ cc1 @ XI @ ccfz))) => ((cwcel @ XI @ ccn0) => ((cwbr @ XI @ XJ @ cclt) => ((cwcel @ XJ @ ccn) => ((XA2 = XJ) => ((cwbr @ XJ @ XK @ cclt) => ((cwcel @ XK @ ccn) => ((XB2 = XK) => ((XG = (ccun @ XF @ (ccpr @ (ccop @ XA2 @ XX) @ (ccop @ XB2 @ XY)))) => ((cwfun @ (cccnv @ (cccnv @ XG))) & (cwss @ (ccdm @ XG) @ (cco @ cc1 @ XK @ ccfz)))))))))))))))))))))).
