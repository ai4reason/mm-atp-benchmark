...
thf(antrin_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX) & (cwss @ XB2 @ XX)) => ((ccfv @ (ccin @ XA2 @ XB2) @ (ccfv @ XJ @ ccnt)) = (ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XB2 @ (ccfv @ XJ @ ccnt))))))))))).
