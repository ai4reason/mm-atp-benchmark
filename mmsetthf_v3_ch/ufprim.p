...
thf(aufprim_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccufil)) & (cwss @ XA2 @ XX) & (cwss @ XB2 @ XX)) => (((cwcel @ XA2 @ XF) | (cwcel @ XB2 @ XF)) <=> (cwcel @ (ccun @ XA2 @ XB2) @ XF)))))))).
