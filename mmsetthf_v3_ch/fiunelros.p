...
thf(afiunelros_thm,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XQ @ Xx3 @ Xy1 @ Xk @ Xs1) = (ccrab @ (^ [Xs1:$i] : ((cwcel @ cc0 @ (ccv @ Xs1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xs1)) & (cwcel @ (ccdif @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ (XO @ Xx3 @ Xy1 @ Xk)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => (cwcel @ XS @ (XQ @ Xx3 @ Xy1 @ Xk @ Xs1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => (cwcel @ (XN @ Xx3 @ Xy1 @ Xs1) @ ccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (((Xph @ Xx3 @ Xy1 @ Xs1) & (cwcel @ (ccv @ Xk) @ (cco @ cc1 @ (XN @ Xx3 @ Xy1 @ Xs1) @ ccfzo))) => (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xk @ Xs1) @ XS)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xx3 @ Xy1 @ Xs1) => (cwcel @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ (XN @ Xx3 @ Xy1 @ Xs1) @ ccfzo)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xy1 @ Xk @ Xs1))) @ XS)))))))))))))))).
