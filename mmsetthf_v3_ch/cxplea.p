...
thf(acxplea_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ ccle)) & ((cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) & (cwbr @ XB2 @ XC @ ccle)) => (cwbr @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccle)))))).
