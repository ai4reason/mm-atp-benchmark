...
thf(aphiprmpw_thm,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XK @ ccn)) => ((ccfv @ (cco @ XP @ XK @ ccexp) @ ccphi) = (cco @ (cco @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccexp) @ (cco @ XP @ cc1 @ ccmin) @ ccmul)))))).
