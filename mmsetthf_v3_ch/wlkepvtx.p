...
thf(awlkepvtx_thm,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) => ((cwcel @ (ccfv @ ccc0 @ XP) @ XV) & (cwcel @ (ccfv @ (ccfv @ XF @ cchash) @ XP) @ XV))))))))).
