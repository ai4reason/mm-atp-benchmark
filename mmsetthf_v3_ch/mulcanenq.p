...
thf(amulcanenq_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi) & (cwcel @ XC @ ccnpi)) => (cwbr @ (ccop @ (cco @ XA2 @ XB2 @ ccmi) @ (cco @ XA2 @ XC @ ccmi)) @ (ccop @ XB2 @ XC) @ cceq)))))).
