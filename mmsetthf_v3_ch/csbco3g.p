...
thf(acsbco3g_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((XB2 @ Xx3 @ Xy1) = (XC @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1)) => ((ccsb @ (XA2 @ Xy1) @ (^ [Xx3:$i] : (ccsb @ (XB2 @ Xx3 @ Xy1) @ (^ [Xy1:$i] : (XD @ Xy1))))) = (ccsb @ (XC @ Xy1) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))))).
