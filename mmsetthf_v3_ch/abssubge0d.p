...
thf(aabssubge0d_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => (Xph => ((ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) = (cco @ XB2 @ XA2 @ ccmin)))))))))).
