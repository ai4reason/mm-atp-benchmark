...
thf(advhopvadd_thm,axiom,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccsca)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XF @ XT) & (cwcel @ XQ @ XE)) & ((cwcel @ XG @ XT) & (cwcel @ XR @ XE))) => ((cco @ (ccop @ XF @ XQ) @ (ccop @ XG @ XR) @ Xc_pl) = (ccop @ (cccom @ XF @ XG) @ (cco @ XQ @ XR @ Xc_pd))))))))))))))))))))))))).
thf(advhopvadd2_thm,axiom,(! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [Xc_pb:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xt:$i] : (! [Xs1:$i] : ((XH @ Xt @ Xs1) = (ccfv @ XK @ cclh)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : ((XT @ Xt @ Xf1 @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccltrn)))))) => ((! [Xf1:$i] : ((XE @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : ((Xc_pl @ Xt @ Xf1 @ Xs1) = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : (XE @ Xf1))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (XE @ Xf1))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccmpt @ (^ [Xf1:$i] : (XT @ Xt @ Xf1 @ Xs1)) @ (^ [Xf1:$i] : (cccom @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xs1)) @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xt)))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : ((XU @ Xt @ Xf1 @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : ((Xc_pb @ Xt @ Xf1 @ Xs1) = (ccfv @ (XU @ Xt @ Xf1 @ Xs1) @ ccplusg))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xt @ Xs1))) & ((cwcel @ (XF @ Xt @ Xf1 @ Xs1) @ (XT @ Xt @ Xf1 @ Xs1)) & (cwcel @ (XQ @ Xt @ Xf1 @ Xs1) @ (XE @ Xf1))) & ((cwcel @ (XG @ Xt @ Xf1 @ Xs1) @ (XT @ Xt @ Xf1 @ Xs1)) & (cwcel @ (XR @ Xt @ Xf1 @ Xs1) @ (XE @ Xf1)))) => ((cco @ (ccop @ (XF @ Xt @ Xf1 @ Xs1) @ (XQ @ Xt @ Xf1 @ Xs1)) @ (ccop @ (XG @ Xt @ Xf1 @ Xs1) @ (XR @ Xt @ Xf1 @ Xs1)) @ (Xc_pb @ Xt @ Xf1 @ Xs1)) = (ccop @ (cccom @ (XF @ Xt @ Xf1 @ Xs1) @ (XG @ Xt @ Xf1 @ Xs1)) @ (cco @ (XQ @ Xt @ Xf1 @ Xs1) @ (XR @ Xt @ Xf1 @ Xs1) @ (Xc_pl @ Xt @ Xf1 @ Xs1))))))))))))))))))))))))))).
...
thf(advhvaddcomN_thm,axiom,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccsca)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XF @ (ccxp @ XT @ XE)) & (cwcel @ XG @ (ccxp @ XT @ XE)))) => ((cco @ XF @ XG @ Xc_pl) = (cco @ XG @ XF @ Xc_pl)))))))))))))))))))))).
thf(advhvaddass_thm,axiom,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccsca)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XF @ (ccxp @ XT @ XE)) & (cwcel @ XG @ (ccxp @ XT @ XE)) & (cwcel @ XI @ (ccxp @ XT @ XE)))) => ((cco @ (cco @ XF @ XG @ Xc_pl) @ XI @ Xc_pl) = (cco @ XF @ (cco @ XG @ XI @ Xc_pl) @ Xc_pl))))))))))))))))))))))).
thf(advhvscacbv_thm,axiom,(! [XT:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XE:($i > $o)] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : ((Xc_x @ Xt @ Xf1 @ Xg1 @ Xs1) = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xf1:$i] : XE)) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccxp @ XT @ XE))) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (ccv @ Xs1)) @ (cccom @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xf1) @ cc2nd))))))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : ((Xc_x @ Xt @ Xf1 @ Xg1 @ Xs1) = (ccmpt2 @ (^ [Xt:$i] : (^ [Xg1:$i] : XE)) @ (^ [Xt:$i] : (^ [Xg1:$i] : (ccxp @ XT @ XE))) @ (^ [Xt:$i] : (^ [Xg1:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xg1) @ cc1st) @ (ccv @ Xt)) @ (cccom @ (ccv @ Xt) @ (ccfv @ (ccv @ Xg1) @ cc2nd)))))))))))))))).
...
thf(atendoinvcl_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : ((XE @ Xh) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xh:$i] : ((XO @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((! [Xh:$i] : ((XU @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : ((XF @ Xh) = (ccfv @ (XU @ Xh) @ ccsca))) => ((! [Xh:$i] : ((XN @ Xh) = (ccfv @ (XF @ Xh) @ ccinvr))) => (! [Xh:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ (XS @ Xh) @ (XE @ Xh)) & ((XS @ Xh) != (XO @ Xh))) => ((cwcel @ (ccfv @ (XS @ Xh) @ (XN @ Xh)) @ (XE @ Xh)) & ((ccfv @ (XS @ Xh) @ (XN @ Xh)) != (XO @ Xh))))))))))))))))))))))))).
thf(atendolinv_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : ((XE @ Xh) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xh:$i] : ((XO @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((! [Xh:$i] : ((XU @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : ((XF @ Xh) = (ccfv @ (XU @ Xh) @ ccsca))) => ((! [Xh:$i] : ((XN @ Xh) = (ccfv @ (XF @ Xh) @ ccinvr))) => (! [Xh:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ (XS @ Xh) @ (XE @ Xh)) & ((XS @ Xh) != (XO @ Xh))) => ((cccom @ (ccfv @ (XS @ Xh) @ (XN @ Xh)) @ (XS @ Xh)) = (ccres @ ccid @ XT)))))))))))))))))))))))).
thf(atendorinv_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : ((XE @ Xh) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xh:$i] : ((XO @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((! [Xh:$i] : ((XU @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : ((XF @ Xh) = (ccfv @ (XU @ Xh) @ ccsca))) => ((! [Xh:$i] : ((XN @ Xh) = (ccfv @ (XF @ Xh) @ ccinvr))) => (! [Xh:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ (XS @ Xh) @ (XE @ Xh)) & ((XS @ Xh) != (XO @ Xh))) => ((cccom @ (XS @ Xh) @ (ccfv @ (XS @ Xh) @ (XN @ Xh))) = (ccres @ ccid @ XT)))))))))))))))))))))))).
...
thf(advhlveclem_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccsca)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XI = (ccfv @ XD @ ccminusg)) => ((Xc_xp = (ccfv @ XD @ ccmulr)) => ((Xc_x = (ccfv @ XU @ ccvsca)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwcel @ XU @ cclvec))))))))))))))))))))))))))))).
...
thf(advhopclN_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ XT) & (cwcel @ XU @ XE)) => (cwcel @ (ccop @ XF @ XU) @ (ccxp @ XT @ XE)))))))).
thf(advhopaddN_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : ((XA2 @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccxp @ XT @ XE))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccxp @ XT @ XE))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccop @ (cccom @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (ccfv @ (ccv @ Xg1) @ cc1st)) @ (cco @ (ccfv @ (ccv @ Xf1) @ cc2nd) @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ XP)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((((cwcel @ (XF @ Xf1 @ Xg1) @ XT) & (cwcel @ (XU @ Xf1 @ Xg1) @ XE)) & ((cwcel @ (XG @ Xf1 @ Xg1) @ XT) & (cwcel @ (XV @ Xf1 @ Xg1) @ XE))) => ((cco @ (ccop @ (XF @ Xf1 @ Xg1) @ (XU @ Xf1 @ Xg1)) @ (ccop @ (XG @ Xf1 @ Xg1) @ (XV @ Xf1 @ Xg1)) @ (XA2 @ Xf1 @ Xg1)) = (ccop @ (cccom @ (XF @ Xf1 @ Xg1) @ (XG @ Xf1 @ Xg1)) @ (cco @ (XU @ Xf1 @ Xg1) @ (XV @ Xf1 @ Xg1) @ XP)))))))))))))))).
thf(advhopspN_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xs1:$i] : ((XS @ Xf1 @ Xs1) = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xf1:$i] : XE)) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccxp @ XT @ XE))) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (ccv @ Xs1)) @ (cccom @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xf1) @ cc2nd))))))))) => (! [Xf1:$i] : (! [Xs1:$i] : (((cwcel @ (XR @ Xf1 @ Xs1) @ XE) & ((cwcel @ (XF @ Xf1 @ Xs1) @ XT) & (cwcel @ (XU @ Xf1 @ Xs1) @ XE))) => ((cco @ (XR @ Xf1 @ Xs1) @ (ccop @ (XF @ Xf1 @ Xs1) @ (XU @ Xf1 @ Xs1)) @ (XS @ Xf1 @ Xs1)) = (ccop @ (ccfv @ (XF @ Xf1 @ Xs1) @ (XR @ Xf1 @ Xs1)) @ (cccom @ (XR @ Xf1 @ Xs1) @ (XU @ Xf1 @ Xs1))))))))))))))).
thf(advhopN_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XB2 @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb) = (ccfv @ (XK @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb) @ ccbs))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XH @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb) = (ccfv @ (XK @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb) @ cclh))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (XT = (ccfv @ (XW @ Xf1 @ Xg1 @ Xs1) @ (ccfv @ (XK @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb) @ ccltrn)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XE @ Xc) = (ccfv @ (XW @ Xf1 @ Xg1 @ Xs1) @ (ccfv @ (XK @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb) @ cctendo))))))))) => ((! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XP @ Xs1 @ Xa @ Xb @ Xc) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (XE @ Xc))) @ (^ [Xa:$i] : (^ [Xb:$i] : (XE @ Xc))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccmpt @ (^ [Xc:$i] : XT) @ (^ [Xc:$i] : (cccom @ (ccfv @ (ccv @ Xc) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xc) @ (ccv @ Xb))))))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XA2 @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccxp @ XT @ (XE @ Xc)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccxp @ XT @ (XE @ Xc)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccop @ (cccom @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (ccfv @ (ccv @ Xg1) @ cc1st)) @ (cco @ (ccfv @ (ccv @ Xf1) @ cc2nd) @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ (XP @ Xs1 @ Xa @ Xb @ Xc))))))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XS @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xf1:$i] : (XE @ Xc))) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccxp @ XT @ (XE @ Xc)))) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (ccv @ Xs1)) @ (cccom @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xf1) @ cc2nd))))))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XO @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) = (ccmpt @ (^ [Xc:$i] : XT) @ (^ [Xc:$i] : (ccres @ ccid @ (XB2 @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb))))))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((((cwcel @ (XK @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb) @ cchlt) & (cwcel @ (XW @ Xf1 @ Xg1 @ Xs1) @ (XH @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb))) & ((cwcel @ (XF @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) @ XT) & (cwcel @ (XU @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) @ (XE @ Xc)))) => ((ccop @ (XF @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) @ (XU @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc)) = (cco @ (ccop @ (XF @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) @ (XO @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc)) @ (cco @ (XU @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc) @ (ccop @ (ccres @ ccid @ (XB2 @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb)) @ (ccres @ ccid @ XT)) @ (XS @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc)) @ (XA2 @ Xf1 @ Xg1 @ Xs1 @ Xa @ Xb @ Xc))))))))))))))))))))))))))))))).
thf(advhopellsm_thm,axiom,(! [Xc_pl:($i > $o)] : (! [Xc_po:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xz:$i] : (! [Xw:$i] : ((XH @ Xz @ Xw) = (ccfv @ (XK @ Xz @ Xw) @ cclh)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XU @ Xx3 @ Xy1 @ Xz @ Xw) = (ccfv @ (XW @ Xz @ Xw) @ (ccfv @ (XK @ Xz @ Xw) @ ccdvh))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (Xc_pl = (ccfv @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xz @ Xw) = (ccfv @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ cclss)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xc_po @ Xx3 @ Xy1 @ Xz @ Xw) = (ccfv @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ cclsm)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((cwcel @ (XK @ Xz @ Xw) @ cchlt) & (cwcel @ (XW @ Xz @ Xw) @ (XH @ Xz @ Xw))) & (cwcel @ XX @ (XS @ Xz @ Xw)) & (cwcel @ XY @ (XS @ Xz @ Xw))) => ((cwcel @ (ccop @ XF @ XT) @ (cco @ XX @ XY @ (Xc_po @ Xx3 @ Xy1 @ Xz @ Xw))) <=> (? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (? [Xw:$i] : (((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XX) & (cwcel @ (ccop @ (ccv @ Xz) @ (ccv @ Xw)) @ XY)) & ((ccop @ XF @ XT) = (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xz) @ (ccv @ Xw)) @ Xc_pl)))))))))))))))))))))))))))))).
thf(acdlemm10N_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xr:$i] : (! [Xq:$i] : ((Xc_le @ Xq) = (ccfv @ (XK @ Xr @ Xq) @ ccple)))) => ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : ((Xc_or @ Xf1 @ Xs1 @ Xq) = (ccfv @ (XK @ Xr @ Xq) @ ccjn)))))) => ((! [Xr:$i] : (! [Xq:$i] : ((XA2 @ Xq) = (ccfv @ (XK @ Xr @ Xq) @ ccatm)))) => ((! [Xr:$i] : (! [Xq:$i] : ((XH @ Xr @ Xq) = (ccfv @ (XK @ Xr @ Xq) @ cclh)))) => ((! [Xr:$i] : (! [Xq:$i] : ((XT @ Xr) = (ccfv @ (XW @ Xq) @ (ccfv @ (XK @ Xr @ Xq) @ ccltrn))))) => ((! [Xr:$i] : (! [Xq:$i] : ((XR @ Xr @ Xq) = (ccfv @ (XW @ Xq) @ (ccfv @ (XK @ Xr @ Xq) @ cctrl))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XI @ Xf1 @ Xs1 @ Xr @ Xq) = (ccfv @ (XW @ Xq) @ (ccfv @ (XK @ Xr @ Xq) @ ccdia))))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XC @ Xf1 @ Xr) = (ccrab @ (^ [Xr:$i] : ((cwbr @ (ccv @ Xr) @ (cco @ XP @ (XV @ Xq) @ (Xc_or @ Xf1 @ Xs1 @ Xq)) @ (Xc_le @ Xq)) & (~ (cwbr @ (ccv @ Xr) @ (XW @ Xq) @ (Xc_le @ Xq))))) @ (^ [Xr:$i] : (XA2 @ Xq)))))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XF @ Xf1 @ Xs1 @ Xr @ Xq) = (ccrio @ (^ [Xf1:$i] : ((ccfv @ XP @ (ccv @ Xf1)) = (ccv @ Xs1))) @ (^ [Xf1:$i] : (XT @ Xr)))))))) => ((! [Xf1:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XG @ Xf1 @ Xr @ Xq) = (ccmpt @ (^ [Xq:$i] : (XC @ Xf1 @ Xr)) @ (^ [Xq:$i] : (ccrio @ (^ [Xf1:$i] : ((ccfv @ XP @ (ccv @ Xf1)) = (ccv @ Xq))) @ (^ [Xf1:$i] : (XT @ Xr))))))))) => (! [Xf1:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : ((((cwcel @ (XK @ Xr @ Xq) @ cchlt) & (cwcel @ (XW @ Xq) @ (XH @ Xr @ Xq))) & ((cwcel @ XP @ (XA2 @ Xq)) & (~ (cwbr @ XP @ (XW @ Xq) @ (Xc_le @ Xq)))) & ((cwcel @ (XV @ Xq) @ (XA2 @ Xq)) & (cwbr @ (XV @ Xq) @ (XW @ Xq) @ (Xc_le @ Xq)))) => ((ccrn @ (XG @ Xf1 @ Xr @ Xq)) = (ccfv @ (XV @ Xq) @ (XI @ Xf1 @ Xs1 @ Xr @ Xq))))))))))))))))))))))))))))))))).
