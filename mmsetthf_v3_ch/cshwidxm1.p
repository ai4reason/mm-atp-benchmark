...
thf(acshwidxm1_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((ccfv @ (cco @ (cco @ (ccfv @ XW @ cchash) @ XN @ ccmin) @ cc1 @ ccmin) @ (cco @ XW @ XN @ cccsh)) = (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ XW))))))).
