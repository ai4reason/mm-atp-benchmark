...
thf(aaxrep5_thm,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((? [X:$i] : ((^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ X)) => (! [X:$i] : ((^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ X)))))) => (! [Xw:$i] : ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xw)) => (? [Xz:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => ((ccv @ Xy1) = (ccv @ Xz))))))) => (? [Xz:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) <=> (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xw)) & (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))))))))).
