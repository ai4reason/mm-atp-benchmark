...
thf(apsgnghm_thm,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XN = (ccfv @ XD @ ccpsgn)) => ((XF = (cco @ XS @ (ccdm @ XN) @ ccress)) => ((XU = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccpr @ cc1 @ (ccneg @ cc1)) @ ccress)) => ((cwcel @ XD @ XV) => (cwcel @ XN @ (cco @ XF @ XU @ ccghm)))))))))))))).
