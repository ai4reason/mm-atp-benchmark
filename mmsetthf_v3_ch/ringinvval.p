...
thf(aringinvval_thm,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [Xc_as:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XR @ ccbs))) => ((! [Xy1:$i] : ((Xc_as @ Xy1) = (ccfv @ XR @ ccmulr))) => ((! [Xy1:$i] : ((Xc_1 @ Xy1) = (ccfv @ XR @ ccur))) => ((! [Xy1:$i] : ((XN @ Xy1) = (ccfv @ XR @ ccinvr))) => ((XU = (ccfv @ XR @ ccui)) => (! [Xy1:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XU)) => ((ccfv @ XX @ (XN @ Xy1)) = (ccrio @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ XX @ (Xc_as @ Xy1)) = (Xc_1 @ Xy1))) @ (^ [Xy1:$i] : XU)))))))))))))))))).
