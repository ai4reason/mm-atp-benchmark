...
thf(aelcntz_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XM @ ccbs))) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((! [Xy1:$i] : ((XZ @ Xy1) = (ccfv @ XM @ cccntz))) => (! [Xy1:$i] : ((cwss @ XS @ (XB2 @ Xy1)) => ((cwcel @ XA2 @ (ccfv @ XS @ (XZ @ Xy1))) <=> ((cwcel @ XA2 @ (XB2 @ Xy1)) & (cwral @ (^ [Xy1:$i] : ((cco @ XA2 @ (ccv @ Xy1) @ Xc_pl) = (cco @ (ccv @ Xy1) @ XA2 @ Xc_pl))) @ (^ [Xy1:$i] : XS)))))))))))))))).
