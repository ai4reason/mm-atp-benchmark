...
thf(agrothprimlem_thm,conjecture,(! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : ((cwcel @ (ccpr @ (ccv @ Xu) @ (ccv @ Xv)) @ (ccv @ Xw)) <=> (? [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) & (! [Xh:$i] : ((cwcel @ (ccv @ Xh) @ (ccv @ Xg1)) <=> (((ccv @ Xh) = (ccv @ Xu)) | ((ccv @ Xh) = (ccv @ Xv)))))))))))).
