...
thf(azrhcofipsgn_thm,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => (((cwcel @ XN @ ccfn) & (cwcel @ XQ @ XP)) => ((ccfv @ XQ @ (cccom @ XY @ XS)) = (ccfv @ (ccfv @ XQ @ XS) @ XY))))))))))))).
