...
thf(adjudisj_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((ccin @ (XA2 @ Xy1) @ (XB2 @ Xx3)) = cc0) => ((ccin @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XC @ Xx3 @ Xy1)))) @ (cciun @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (XD @ Xx3 @ Xy1))))) = cc0))))))))).
