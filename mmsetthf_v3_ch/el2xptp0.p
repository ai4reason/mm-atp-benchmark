...
thf(ael2xptp0_thm,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XX @ XU) & (cwcel @ XY @ XV) & (cwcel @ XZ @ XW)) => (((cwcel @ XA2 @ (ccxp @ (ccxp @ XU @ XV) @ XW)) & (((ccfv @ (ccfv @ XA2 @ cc1st) @ cc1st) = XX) & ((ccfv @ (ccfv @ XA2 @ cc1st) @ cc2nd) = XY) & ((ccfv @ XA2 @ cc2nd) = XZ))) <=> (XA2 = (ccotp @ XX @ XY @ XZ)))))))))))).
