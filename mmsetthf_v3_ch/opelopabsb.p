...
thf(aelopab_b_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccopab_b @ (^ [Xx3:$i] : (Xph @ Xx3)))) <=> (? [Xx3:$i] : (? [Xx3:$i] : ((XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xx3))) & (Xph @ Xx3)))))))).
...
thf(aopelopabsb_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccop @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xy1)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) <=> (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (XB2 @ Xy1))) @ (XA2 @ Xx3 @ Xy1))))))))).
