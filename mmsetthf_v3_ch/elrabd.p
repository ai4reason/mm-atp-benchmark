...
thf(aelrabd_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xps @ Xx3) <=> Xch))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ XB2))) => ((! [Xx3:$i] : ((Xph @ Xx3) => Xch)) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))))))))).
