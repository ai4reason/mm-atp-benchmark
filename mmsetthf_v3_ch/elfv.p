...
thf(aelfv_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ (ccfv @ XB2 @ XF)) <=> (? [Xx3:$i] : ((cwcel @ (XA2 @ Xy1) @ (ccv @ Xx3)) & (! [Xy1:$i] : ((cwbr @ XB2 @ (ccv @ Xy1) @ XF) <=> ((ccv @ Xy1) = (ccv @ Xx3)))))))))))).
