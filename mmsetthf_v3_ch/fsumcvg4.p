...
thf(afsumcvg4_thm,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((XS = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XS @ ccc @ XF)) => ((Xph => (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ ccfn)) => (Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli)))))))))))).
