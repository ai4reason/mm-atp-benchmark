...
thf(apsgneldm2i_thm,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XD @ ccsymg)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XN = (ccfv @ XD @ ccpsgn)) => (((cwcel @ XD @ XV) & (cwcel @ XW @ (ccword @ XT))) => (cwcel @ (cco @ XG @ XW @ ccgsu) @ (ccdm @ XN))))))))))))).
