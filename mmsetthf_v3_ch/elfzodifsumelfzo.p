...
thf(aelfzodifsumelfzo_thm,conjecture,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XN @ (cco @ ccc0 @ XP @ ccfz))) => ((cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) => (cwcel @ (cco @ XI @ XM @ ccaddc) @ (cco @ ccc0 @ XP @ ccfzo))))))))).
