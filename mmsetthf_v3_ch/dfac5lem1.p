...
thf(adfac5lem1_thm,conjecture,(! [Xy1:$i] : (! [Xw:$i] : ((cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccxp @ (ccsn @ (ccv @ Xw)) @ (ccv @ Xw)) @ (ccv @ Xy1))))) <=> (cweu @ (^ [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) & (cwcel @ (ccop @ (ccv @ Xw) @ (ccv @ Xg1)) @ (ccv @ Xy1))))))))).
