...
thf(afuncnvqp_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((((cwcel @ XA2 @ XU) & (cwcel @ XC @ XV)) & ((cwcel @ XE @ XW) & (cwcel @ XG @ XT))) & (((XB2 != XD) & (XB2 != XF) & (XB2 != XH)) & ((XD != XF) & (XD != XH)) & (XF != XH))) => (cwfun @ (cccnv @ (ccun @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (ccpr @ (ccop @ XE @ XF) @ (ccop @ XG @ XH))))))))))))))))))).
