...
thf(ahfsval_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ ccc @ XS) & (cwf @ cchil @ ccc @ XT) & (cwcel @ XA2 @ cchil)) => ((ccfv @ XA2 @ (cco @ XS @ XT @ cchfs)) = (cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XA2 @ XT) @ ccaddc))))))).
