...
thf(axpstopn_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : ((XT = (cco @ XR @ XS @ ccxps)) => ((XJ = (ccfv @ XR @ cctopn)) => ((XK = (ccfv @ XS @ cctopn)) => ((XO = (ccfv @ XT @ cctopn)) => (((cwcel @ XR @ cctps) & (cwcel @ XS @ cctps)) => (XO = (cco @ XJ @ XK @ cctx)))))))))))))).
