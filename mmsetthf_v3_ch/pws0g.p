...
thf(apws0g_thm,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccmnd) & (cwcel @ XI @ XV)) => ((ccxp @ XI @ (ccsn @ Xc_0)) = (ccfv @ XY @ cc0g))))))))))).
