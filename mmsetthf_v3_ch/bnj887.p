...
thf(abnj887_thm,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xbnjwphm:$o] : (! [Xbnjwpsm:$o] : (! [Xbnjwchm:$o] : (! [Xbnjwthm:$o] : ((Xph <=> Xbnjwphm) => ((Xps <=> Xbnjwpsm) => ((Xch <=> Xbnjwchm) => ((Xth <=> Xbnjwthm) => ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) <=> (cw_bnj17 @ Xbnjwphm @ Xbnjwpsm @ Xbnjwchm @ Xbnjwthm))))))))))))))).
