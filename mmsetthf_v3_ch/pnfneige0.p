...
thf(apnfneige0_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XJ @ Xx3)) & (cwcel @ ccpnf @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioc) @ XA2)) @ (^ [Xx3:$i] : ccr)))))))).
