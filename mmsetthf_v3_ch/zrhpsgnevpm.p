...
thf(azrhpsgnevpm_thm,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn) & (cwcel @ XF @ (ccfv @ XN @ ccevpm))) => ((ccfv @ XF @ (cccom @ XY @ XS)) = Xc_1)))))))))))).
