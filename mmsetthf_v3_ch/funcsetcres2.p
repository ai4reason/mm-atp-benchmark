...
thf(afuncsetcres2_thm,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((XD = (ccfv @ XV @ ccsetc)) => ((Xph => (cwcel @ XU @ XW)) => ((Xph => (cwss @ XV @ XU)) => (Xph => (cwss @ (cco @ XE @ XD @ ccfunc) @ (cco @ XE @ XC @ ccfunc))))))))))))))).
