...
thf(ais1stc_thm,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : ((XX @ Xy1 @ Xz) = (ccuni @ XJ)))) => (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XJ @ cc1stc) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ ccom @ ccdom) & (cwral @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xx3) @ (ccuni @ (ccin @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xz))))))) @ (^ [Xz:$i] : XJ)))) @ (^ [Xy1:$i] : (ccpw @ XJ)))) @ (^ [Xx3:$i] : (XX @ Xy1 @ Xz))))))))))).
