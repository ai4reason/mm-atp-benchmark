...
thf(aiporthcom_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((XZ = (ccfv @ XF @ cc0g)) => (((cwcel @ XW @ ccphl) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => (((cco @ XA2 @ XB2 @ Xc_xi) = XZ) <=> ((cco @ XB2 @ XA2 @ Xc_xi) = XZ))))))))))))))).
