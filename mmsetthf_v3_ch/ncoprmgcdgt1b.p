...
thf(ancoprmgcdgt1b_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((cwrex @ (^ [Xi:$i] : ((cwbr @ (ccv @ Xi) @ XA2 @ ccdvds) & (cwbr @ (ccv @ Xi) @ XB2 @ ccdvds))) @ (^ [Xi:$i] : (ccfv @ cc2 @ ccuz))) <=> (cwbr @ cc1 @ (cco @ XA2 @ XB2 @ ccgcd) @ cclt)))))).
