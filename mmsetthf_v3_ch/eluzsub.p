...
thf(a_6t5e30OLD_thm,axiom,((cco @ cc6 @ cc5 @ ccmul) = (ccdc @ cc3 @ ccc0))).
thf(a_6t6e36_thm,axiom,((cco @ cc6 @ cc6 @ ccmul) = (ccdc @ cc3 @ cc6))).
thf(a_6t6e36OLD_thm,axiom,((cco @ cc6 @ cc6 @ ccmul) = (ccdc @ cc3 @ cc6))).
...
thf(a_8t4e32_thm,axiom,((cco @ cc8 @ cc4 @ ccmul) = (ccdc @ cc3 @ cc2))).
thf(a_8t5e40_thm,axiom,((cco @ cc8 @ cc5 @ ccmul) = (ccdc @ cc4 @ ccc0))).
thf(a_8t5e40OLD_thm,axiom,((cco @ cc8 @ cc5 @ ccmul) = (ccdc @ cc4 @ ccc0))).
thf(a_8t6e48_thm,axiom,((cco @ cc8 @ cc6 @ ccmul) = (ccdc @ cc4 @ cc8))).
thf(a_8t6e48OLD_thm,axiom,((cco @ cc8 @ cc6 @ ccmul) = (ccdc @ cc4 @ cc8))).
thf(a_8t7e56_thm,axiom,((cco @ cc8 @ cc7 @ ccmul) = (ccdc @ cc5 @ cc6))).
...
thf(a_9t5e45_thm,axiom,((cco @ cc9 @ cc5 @ ccmul) = (ccdc @ cc4 @ cc5))).
thf(a_9t6e54_thm,axiom,((cco @ cc9 @ cc6 @ ccmul) = (ccdc @ cc5 @ cc4))).
thf(a_9t7e63_thm,axiom,((cco @ cc9 @ cc7 @ ccmul) = (ccdc @ cc6 @ cc3))).
thf(a_9t8e72_thm,axiom,((cco @ cc9 @ cc8 @ ccmul) = (ccdc @ cc7 @ cc2))).
thf(a_9t9e81_thm,axiom,((cco @ cc9 @ cc9 @ ccmul) = (ccdc @ cc8 @ cc1))).
thf(a_9t11e99_thm,axiom,((cco @ cc9 @ (ccdc @ cc1 @ cc1) @ ccmul) = (ccdc @ cc9 @ cc9))).
thf(a_9t11e99OLD_thm,axiom,((cco @ cc9 @ (ccdc @ cc1 @ cc1) @ ccmul) = (ccdc @ cc9 @ cc9))).
...
thf(adecbin0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cco @ cc4 @ XA2 @ ccmul) = (cco @ cc2 @ (cco @ cc2 @ XA2 @ ccmul) @ ccmul))))).
thf(adecbin2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cco @ (cco @ cc4 @ XA2 @ ccmul) @ cc2 @ ccaddc) = (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ cc1 @ ccaddc) @ ccmul))))).
thf(adecbin3_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cco @ (cco @ cc4 @ XA2 @ ccmul) @ cc3 @ ccaddc) = (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ cc1 @ ccaddc))))).
thf(ahalfthird_thm,axiom,((cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) = (cco @ cc1 @ cc6 @ ccdiv))).
thf(a_5recm6rec_thm,axiom,((cco @ (cco @ cc1 @ cc5 @ ccdiv) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccmin) = (cco @ cc1 @ (ccdc @ cc3 @ ccc0) @ ccdiv))).
thf(ccuz_tp,type,(ccuz : ($i > $o))).
thf(adf_uz_ax,axiom,(ccuz = (ccmpt @ (^ [Xj:$i] : ccz) @ (^ [Xj:$i] : (ccrab @ (^ [Xk:$i] : (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle)) @ (^ [Xk:$i] : ccz)))))).
...
thf(aeluzmn_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn0)) => (cwcel @ XM @ (ccfv @ (cco @ XM @ XN @ ccmin) @ ccuz)))))).
...
thf(auzn0_thm,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ (ccrn @ ccuz)) => (XM != cc0)))).
...
thf(auzneg_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => (cwcel @ (ccneg @ XM) @ (ccfv @ (ccneg @ XN) @ ccuz)))))).
...
thf(auz11_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => (((ccfv @ XM @ ccuz) = (ccfv @ XN @ ccuz)) <=> (XM = XN)))))).
...
thf(aeluzp1l_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) => (cwbr @ XM @ XN @ cclt))))).
thf(aeluzp1p1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz)))))).
thf(aeluzaddi_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => ((cwcel @ XK @ ccz) => ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => (cwcel @ (cco @ XN @ XK @ ccaddc) @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz))))))))).
thf(aeluzsubi_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => ((cwcel @ XK @ ccz) => ((cwcel @ XN @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz)) => (cwcel @ (cco @ XN @ XK @ ccmin) @ (ccfv @ XM @ ccuz))))))))).
thf(aeluzadd_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ XM @ ccuz)) & (cwcel @ XK @ ccz)) => (cwcel @ (cco @ XN @ XK @ ccaddc) @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz))))))).
thf(aeluzsub_thm,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XK @ ccz) & (cwcel @ XN @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz))) => (cwcel @ (cco @ XN @ XK @ ccmin) @ (ccfv @ XM @ ccuz))))))).
