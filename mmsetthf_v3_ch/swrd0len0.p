...
thf(aswrd0len0_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccn0) & ((ccfv @ XW @ cchash) = (cco @ XN @ cc1 @ ccaddc))) => ((ccfv @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ cchash) = XN)))))).
