...
thf(alogcnlem2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((XS = (ccif @ (cwcel @ XA2 @ ccrp) @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs))) => ((XT = (cco @ (ccfv @ XA2 @ ccabs) @ (cco @ XR @ (cco @ cc1 @ XR @ ccaddc) @ ccdiv) @ ccmul)) => ((Xph => (cwcel @ XA2 @ XD)) => ((Xph => (cwcel @ XR @ ccrp)) => (Xph => (cwcel @ (ccif @ (cwbr @ XS @ XT @ ccle) @ XS @ XT) @ ccrp)))))))))))))).
