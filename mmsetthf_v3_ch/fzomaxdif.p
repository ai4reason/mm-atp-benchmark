...
thf(afzomaxdif_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XC @ XD @ ccfzo)) & (cwcel @ XB2 @ (cco @ XC @ XD @ ccfzo))) => (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (cco @ ccc0 @ (cco @ XD @ XC @ ccmin) @ ccfzo)))))))).
