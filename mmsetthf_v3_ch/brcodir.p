...
thf(abrcodir_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ XA2 @ XB2 @ (cccom @ (cccnv @ XR) @ XR)) <=> (? [Xz:$i] : ((cwbr @ XA2 @ (ccv @ Xz) @ XR) & (cwbr @ XB2 @ (ccv @ Xz) @ XR))))))))))).
