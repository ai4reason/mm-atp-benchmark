...
thf(adirge_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => (((cwcel @ XR @ ccdir) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ XR) & (cwbr @ XB2 @ (ccv @ Xx3) @ XR))) @ (^ [Xx3:$i] : XX))))))))).
