...
thf(aplypf1_thm,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((XR = (cco @ cccnfld @ XS @ ccress)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (ccfv @ XP @ ccbs)) => ((XE = (ccfv @ cccnfld @ cce1)) => ((cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg)) => ((ccfv @ XS @ ccply) = (ccima @ XE @ XA2))))))))))))).
