...
thf(acshf1_thm,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ XA2 @ XF) & (cwcel @ XS @ ccz) & (XG = (cco @ XF @ XS @ cccsh))) => (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ XA2 @ XG))))))).
