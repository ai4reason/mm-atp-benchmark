...
thf(ascmatmat_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XS = (cco @ XN @ XR @ ccscmat)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ XV)) => ((cwcel @ XM @ XS) => (cwcel @ XM @ XB2)))))))))))))).
