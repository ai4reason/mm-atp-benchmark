...
thf(ainelpisys_thm,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((! [Xs1:$i] : ((XP @ Xs1) = (ccrab @ (^ [Xs1:$i] : (cwss @ (ccfv @ (ccv @ Xs1) @ ccfi) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ XO)))))) => (! [Xs1:$i] : (((cwcel @ XS @ (XP @ Xs1)) & (cwcel @ (XA2 @ Xs1) @ XS) & (cwcel @ (XB2 @ Xs1) @ XS)) => (cwcel @ (ccin @ (XA2 @ Xs1) @ (XB2 @ Xs1)) @ XS)))))))))).
