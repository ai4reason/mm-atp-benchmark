...
thf(aclass2set_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ ccvv)) @ (^ [Xx3:$i] : XA2)) @ ccvv))).
thf(aclass2seteq_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ ccvv)) @ (^ [Xx3:$i] : XA2)) = XA2)))))).
...
thf(a_0inp0_thm,axiom,(! [XA2:($i > $o)] : ((XA2 = cc0) => (~ (XA2 = (ccsn @ cc0)))))).
thf(aunidif0_thm,axiom,(! [XA2:($i > $o)] : ((ccuni @ (ccdif @ XA2 @ (ccsn @ cc0))) = (ccuni @ XA2)))).
thf(aiin0_thm,axiom,(! [XA2:($i > $o)] : ((XA2 != cc0) <=> ((cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : cc0)) = cc0)))).
thf(anotzfaus_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccsn @ cc0))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) <=> (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))))) => (~ (? [Xy1:$i] : (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) <=> ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) & (Xph @ Xx3 @ Xy1))))))))))).
thf(aintv_thm,axiom,((ccint @ ccvv) = cc0)).
thf(aaxpweq_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ (ccpw @ XA2) @ ccvv) <=> (? [Xx3:$i] : (! [Xy1:$i] : ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) => (cwcel @ (ccv @ Xz) @ XA2))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))).
thf(aax_pow_ax,axiom,(! [Xx3:$i] : (? [Xy1:$i] : (! [Xz:$i] : ((! [Xw:$i] : ((cwcel @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)))) => (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))).
thf(azfpow_thm,axiom,(! [Xz:$i] : (? [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
thf(aaxpow2_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xx3)) => (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))).
thf(aaxpow3_thm,axiom,(! [Xx3:$i] : (? [Xy1:$i] : (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xx3)) <=> (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))).
...
thf(asnexALT_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccsn @ XA2) @ ccvv))).
thf(ap0ex_thm,axiom,(cwcel @ (ccsn @ cc0) @ ccvv)).
thf(ap0exALT_thm,axiom,(cwcel @ (ccsn @ cc0) @ ccvv)).
thf(app0ex_thm,axiom,(cwcel @ (ccpr @ cc0 @ (ccsn @ cc0)) @ ccvv)).
thf(aord3ex_thm,axiom,(cwcel @ (cctp @ cc0 @ (ccsn @ cc0) @ (ccpr @ cc0 @ (ccsn @ cc0))) @ ccvv)).
thf(adtru_thm,axiom,(! [Xy1:$i] : (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))))).
thf(aaxc16b_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) => ((Xph @ Xx3 @ Xy1) => (! [Xx3:$i] : (Xph @ Xx3 @ Xy1)))))))).
thf(aeunex_thm,axiom,(! [Xph:($i > $o)] : ((cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) => (? [Xx3:$i] : (~ (Xph @ Xx3)))))).
thf(aeusv1_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cweu @ (^ [Xy1:$i] : (! [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))))) <=> (? [Xy1:$i] : (! [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))))))).
...
thf(aeusv2_thm,axiom,(! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ ccvv)) => ((cweu @ (^ [Xy1:$i] : (? [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))))) <=> (cweu @ (^ [Xy1:$i] : (! [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))))))))).
...
thf(areusv1OLD_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xy1:$i] : ((cwrex @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1))) => ((cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))))))))).
thf(areusv2lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((XA2 != cc0) => ((cweu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) <=> (? [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))))))).
thf(areusv2lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cweu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) => (cweu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))))))).
thf(areusv2lem2OLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cweu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) => (cweu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))))))).
thf(areusv2lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xy1:$i] : (cwcel @ (XB2 @ Xy1) @ ccvv)) @ (^ [Xy1:$i] : XA2)) => ((cweu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) <=> (cweu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2))))))))).
thf(areusv2lem4_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : XA2)) <=> (cweu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cwcel @ (XC @ Xy1) @ XA2) & (Xph @ Xy1)) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1))))))))))).
thf(areusv2lem5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (((cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xy1) @ XA2)) @ (^ [Xy1:$i] : XB2)) & (XB2 != cc0)) => ((cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XC @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)) <=> (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XC @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))).
thf(areusv2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (((cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XC @ Xy1) @ XA2))) @ (^ [Xy1:$i] : (XB2 @ Xy1))) & (cwrex @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) => ((cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : XA2)) <=> (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : XA2))))))))).
thf(areusv3i_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((XC @ Xy1) = (XD @ Xz))))) => (! [Xy1:$i] : (! [Xz:$i] : ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))) => (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((Xph @ Xy1) & (Xps @ Xz)) => ((XC @ Xy1) = (XD @ Xz)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)))))))))))))).
thf(areusv3_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((XC @ Xy1) = (XD @ Xz))))) => ((cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & (cwcel @ (XC @ Xy1) @ XA2))) @ (^ [Xy1:$i] : XB2)) => ((cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((Xph @ Xy1) & (Xps @ Xz)) => ((XC @ Xy1) = (XD @ Xz)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))))))).
thf(aeusv4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwcel @ (XB2 @ Xy1) @ ccvv)) => ((cweu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) <=> (cweu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2))))))))).
thf(aalxfr_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => (! [Xx3:$i] : (((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ (XB2 @ Xx3 @ Xy1))) & (! [Xx3:$i] : (? [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))))) => ((! [Xx3:$i] : (Xph @ Xx3)) <=> (! [Xy1:$i] : (Xps @ Xy1))))))))))).
thf(aralxfrd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) => (cwcel @ (XA2 @ Xy1) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1))))))))))))))).
thf(aralxfrdOLD_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) => (cwcel @ (XA2 @ Xy1) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1))))))))))))))).
thf(arexxfrd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) => (cwcel @ (XA2 @ Xy1) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> (cwrex @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1))))))))))))))).
thf(aralxfr2d_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) => (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XB2) <=> (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))))))).
thf(arexxfr2d_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) => (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XB2) <=> (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> (cwrex @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))))))).
thf(aralxfrd2_thm,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) => (cwcel @ (XA2 @ Xy1) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (XC @ Xy1)) & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1))))))))))))))).
