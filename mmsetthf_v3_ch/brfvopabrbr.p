...
thf(abrfvopabrbr_thm,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ XZ @ (XA2 @ Xx3 @ Xy1)) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XZ @ XB2)) & (Xph @ Xx3 @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XX) & ((ccv @ Xy1) = XY)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((cwrel @ (ccfv @ XZ @ XB2)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwbr @ XX @ XY @ (ccfv @ XZ @ (XA2 @ Xx3 @ Xy1))) <=> ((cwbr @ XX @ XY @ (ccfv @ XZ @ XB2)) & Xps))))))))))))))).
