...
thf(acphreccl_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XK) & (XA2 != ccc0)) => (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ XK))))))))).
...
thf(acphcjcl_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XK)) => (cwcel @ (ccfv @ XA2 @ cccj) @ XK))))))))).
...
thf(acphsqrtcl2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XK) & (~ (cwcel @ (ccneg @ XA2) @ ccrp))) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
thf(acphsqrtcl3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ cci @ XK) & (cwcel @ XA2 @ XK)) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
thf(acphqss_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ cccph) => (cwss @ ccq @ XK)))))))).
thf(acphclm_thm,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cccph) => (cwcel @ XW @ ccclm)))).
thf(acphnmvs_thm,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XX @ XK) & (cwcel @ XY @ XV)) => ((ccfv @ (cco @ XX @ XY @ Xc_x) @ XN) = (cco @ (ccfv @ XX @ ccabs) @ (ccfv @ XY @ XN) @ ccmul))))))))))))))))).
thf(acphipcl_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => (cwcel @ (cco @ XA2 @ XB2 @ Xc_xi) @ ccc)))))))))).
