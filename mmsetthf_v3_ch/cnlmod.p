...
thf(acnlmod_thm,conjecture,(! [XW:($i > $o)] : ((XW = (ccun @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ ccc) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ ccaddc)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccsca) @ cccnfld) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ ccmul)))) => (cwcel @ XW @ cclmod)))).
