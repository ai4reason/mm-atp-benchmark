...
thf(advcnv_thm,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((! [Xx3:$i] : ((XK @ Xx3) = (cco @ XJ @ XS @ ccrest))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xx3:$i] : (Xph => (cwcel @ XY @ (XK @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwf1o @ (XX @ Xx3) @ XY @ XF))) => ((! [Xx3:$i] : (Xph => (cwcel @ (cccnv @ XF) @ (cco @ XY @ (XX @ Xx3) @ cccncf)))) => ((! [Xx3:$i] : (Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = (XX @ Xx3)))) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ XS @ XF @ ccdv))))) => (Xph => ((cco @ XS @ (cccnv @ XF) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cccnv @ XF)) @ (cco @ XS @ XF @ ccdv)) @ ccdiv))))))))))))))))))))).
