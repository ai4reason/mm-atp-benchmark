...
thf(aalxfr_thm,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => (! [Xx3:$i] : (((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ (XB2 @ Xx3 @ Xy1))) & (! [Xx3:$i] : (? [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))))) => ((! [Xx3:$i] : (Xph @ Xx3)) <=> (! [Xy1:$i] : (Xps @ Xy1))))))))))).
