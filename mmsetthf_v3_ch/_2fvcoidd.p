...
thf(a_2fvcoidd_thm,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xa:$i] : ((Xph @ Xa) => (cwf @ XA2 @ (XB2 @ Xa) @ XF))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwf @ (XB2 @ Xa) @ XA2 @ XG))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwral @ (^ [Xa:$i] : ((ccfv @ (ccfv @ (ccv @ Xa) @ XF) @ XG) = (ccv @ Xa))) @ (^ [Xa:$i] : XA2)))) => (! [Xa:$i] : ((Xph @ Xa) => ((cccom @ XG @ XF) = (ccres @ ccid @ XA2))))))))))))).
