...
thf(afin23lem27_thm,conjecture,(! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : ((XC @ Xi @ Xj) = (ccmpt @ (^ [Xi:$i] : ccom) @ (^ [Xi:$i] : (ccrio @ (^ [Xj:$i] : (cwbr @ (ccin @ (ccv @ Xj) @ XS) @ (ccv @ Xi) @ ccen)) @ (^ [Xj:$i] : XS))))))) => (! [Xi:$i] : (! [Xj:$i] : (((cwss @ XS @ ccom) & (~ (cwcel @ XS @ ccfn))) => (cwiso @ ccom @ XS @ ccep @ ccep @ (XC @ Xi @ Xj))))))))).
