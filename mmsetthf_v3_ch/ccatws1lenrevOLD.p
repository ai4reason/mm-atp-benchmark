...
thf(accatws1lenrevOLD_thm,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XX @ XV)) => (((ccfv @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ cchash) = XN) => ((ccfv @ XW @ cchash) = (cco @ XN @ cc1 @ ccmin))))))))).
