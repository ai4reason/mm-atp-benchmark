...
thf(atelfsum_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (ccv @ Xj)) => ((XA2 @ Xk) = (XB2 @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (cco @ (ccv @ Xj) @ cc1 @ ccaddc)) => ((XA2 @ Xk) = (XC @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = (XD @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (cco @ XN @ cc1 @ ccaddc)) => ((XA2 @ Xk) = (XE @ Xj))))) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => (! [Xj:$i] : (Xph => ((ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xj:$i] : (cco @ (XB2 @ Xj) @ (XC @ Xj) @ ccmin))) = (cco @ (XD @ Xj) @ (XE @ Xj) @ ccmin)))))))))))))))))))).
...
thf(afsumrelem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((cwf @ ccc @ ccc @ XF) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccc) & (cwcel @ (ccv @ Xy1) @ ccc)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XF) = (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccaddc))))) => (Xph => ((ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ XF) = (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ XF)))))))))))))).
thf(afsumre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (Xph => ((ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccre) = (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccre))))))))))).
...
thf(afsumrlim_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xk) @ XB2))) => (cwcel @ (XC @ Xx3 @ Xk) @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XB2)) => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xk))) @ (XD @ Xx3 @ Xk) @ ccrli)))) => (! [Xx3:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xx3 @ Xk))))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (XD @ Xx3 @ Xk))) @ ccrli)))))))))))))).
