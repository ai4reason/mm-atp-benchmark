...
thf(aisnlly_thm,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccnlly @ XA2)) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ XA2)) @ (^ [Xu:$i] : (ccin @ (ccfv @ (ccsn @ (ccv @ Xy1)) @ (ccfv @ XJ @ ccnei)) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ))))))).
