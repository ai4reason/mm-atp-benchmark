...
thf(as4dom_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((XE = (ccs4 @ XA2 @ XB2 @ XC @ XD)) => ((ccdm @ XE) = (ccun @ (ccpr @ ccc0 @ cc1) @ (ccpr @ cc2 @ cc3)))))))))))).
