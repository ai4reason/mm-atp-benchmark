...
thf(aabsrdbnd_thm,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ (ccfv @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ ccabs) @ (cco @ (ccfv @ (ccfv @ XA2 @ ccabs) @ ccfl) @ cc1 @ ccaddc) @ ccle)))).
