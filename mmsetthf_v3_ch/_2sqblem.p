...
thf(a_2sqblem_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => ((cwcel @ XP @ ccprime) & (XP != cc2))) => ((Xph => ((cwcel @ XX @ ccz) & (cwcel @ XY @ ccz))) => ((Xph => (XP = (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc))) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((Xph => ((cco @ XP @ XY @ ccgcd) = (cco @ (cco @ XP @ XA2 @ ccmul) @ (cco @ XY @ XB2 @ ccmul) @ ccaddc))) => (Xph => ((cco @ XP @ cc4 @ ccmo) = cc1))))))))))))))).
