...
thf(asrgfcl_thm,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccsrg) & (cwfn @ Xc_x @ (ccxp @ XB2 @ XB2))) => (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ Xc_x)))))))).
