...
thf(acncongr2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) & ((cwcel @ XN @ ccn) & (XM = (cco @ XN @ (cco @ XC @ XN @ ccgcd) @ ccdiv)))) => (((cco @ XA2 @ XM @ ccmo) = (cco @ XB2 @ XM @ ccmo)) => ((cco @ (cco @ XA2 @ XC @ ccmul) @ XN @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XN @ ccmo)))))))))).
