...
thf(auspgr2wlkeq2_thm,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) & ((cwcel @ XA2 @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccfv @ XA2 @ cc1st) @ cchash) = XN)) & ((cwcel @ XB2 @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccfv @ XB2 @ cc1st) @ cchash) = XN))) => (((ccfv @ XA2 @ cc2nd) = (ccfv @ XB2 @ cc2nd)) => (XA2 = XB2)))))))).
