...
thf(alimsupbnd2_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XB2 @ ccr)) => ((Xph => (cwf @ XB2 @ ccxr @ XF)) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => ((ccsup @ XB2 @ ccxr @ cclt) = ccpnf)) => ((Xph => (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ XA2 @ (ccfv @ (ccv @ Xj) @ XF) @ ccle))) @ (^ [Xj:$i] : XB2))) @ (^ [Xk:$i] : ccr))) => (Xph => (cwbr @ XA2 @ (ccfv @ XF @ cclsp) @ ccle)))))))))))).
