...
thf(apreqsnd_thm,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => (cwcel @ XC @ ccvv)) => (Xph => (((ccpr @ XA2 @ XB2) = (ccsn @ XC)) <=> ((XA2 = XC) & (XB2 = XC)))))))))))).
