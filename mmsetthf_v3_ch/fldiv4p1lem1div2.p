...
thf(afldiv4p1lem1div2_thm,conjecture,(! [XN:($i > $o)] : (((XN = cc3) | (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => (cwbr @ (cco @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
