...
thf(cgaid_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XS @ XV)) @ (cwcel @ (ccres @ cc2nd @ (ccxp @ XX @ XS)) @ (cco @ XG @ XS @ ccga))))))))).
