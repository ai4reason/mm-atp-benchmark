...
thf(aunbdqndv2lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => ((cwi @ Xph @ (cwne @ XD @ ccc0)) => ((cwi @ Xph @ (cwbr @ (cco @ cc2 @ XE @ ccmul) @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XD @ ccdiv) @ ccabs) @ ccle)) => (cwi @ Xph @ (cwo @ (cwbr @ (cco @ XE @ (ccfv @ XD @ ccabs) @ ccmul) @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ ccle) @ (cwbr @ (cco @ XE @ (ccfv @ XD @ ccabs) @ ccmul) @ (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs) @ ccle))))))))))))))))).
...
thf(cunbdqndv2lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XG @ Xz) @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccsn @ XA2))) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XA2 @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ ccdiv))))) => ((! [Xz:$i] : (cwceq @ (XW @ Xz) @ (ccif @ (cwbr @ (cco @ XB2 @ (cco @ XV @ XU @ ccmin) @ ccmul) @ (ccfv @ (cco @ (ccfv @ XU @ XF) @ (ccfv @ XA2 @ XF) @ ccmin) @ ccabs) @ ccle) @ XU @ XV))) => ((cwi @ Xph @ (cwss @ XX @ ccr)) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XD @ Xz) @ ccrp))) => ((cwi @ Xph @ (cwcel @ XU @ XX)) => ((cwi @ Xph @ (cwcel @ XV @ XX)) => ((cwi @ Xph @ (cwne @ XU @ XV)) => ((cwi @ Xph @ (cwbr @ XU @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XA2 @ XV @ ccle)) => ((! [Xz:$i] : (cwi @ Xph @ (cwbr @ (cco @ XV @ XU @ ccmin) @ (XD @ Xz) @ cclt))) => ((cwi @ Xph @ (cwbr @ (cco @ cc2 @ XB2 @ ccmul) @ (cco @ (ccfv @ (cco @ (ccfv @ XV @ XF) @ (ccfv @ XU @ XF) @ ccmin) @ ccabs) @ (cco @ XV @ XU @ ccmin) @ ccdiv) @ ccle)) => (! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XW @ Xz) @ (ccdif @ XX @ (ccsn @ XA2))) @ (cwa @ (cwbr @ (ccfv @ (cco @ (XW @ Xz) @ XA2 @ ccmin) @ ccabs) @ (XD @ Xz) @ cclt) @ (cwbr @ XB2 @ (ccfv @ (ccfv @ (XW @ Xz) @ (XG @ Xz)) @ ccabs) @ ccle)))))))))))))))))))))))))))))).
