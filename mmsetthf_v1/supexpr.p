...
thf(asuplem1pr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnp))) @ (cwcel @ (ccuni @ XA2) @ ccnp)))).
...
thf(asuplem2pr_thm,axiom,(! [Xy1:$i] : (! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccnp) @ (cwa @ (cwi @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwn @ (cwbr @ (ccuni @ XA2) @ (ccv @ Xy1) @ ccltp))) @ (cwi @ (cwbr @ (ccv @ Xy1) @ (ccuni @ XA2) @ ccltp) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltp)) @ (^ [Xz:$i] : XA2)))))))).
