...
thf(csge0seq_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((cwceq @ XG @ (ccseq @ ccaddc @ XF @ XM)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccsup @ (ccrn @ XG) @ ccxr @ cclt))))))))))))).
