...
thf(cisprm6_conj,conjecture,(! [XP:($i > $o)] : (cwb @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ XP @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ ccdvds) @ (cwo @ (cwbr @ XP @ (ccv @ Xx3) @ ccdvds) @ (cwbr @ XP @ (ccv @ Xy1) @ ccdvds)))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))).
