...
thf(assltss2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwss @ XB2 @ ccsur))))).
thf(assltex2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwcel @ XB2 @ ccvv))))).
thf(assltsep_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(abrsslt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwa @ (cwa @ (cwcel @ XA2 @ ccvv) @ (cwcel @ XB2 @ ccvv)) @ (cw3a @ (cwss @ XA2 @ ccsur) @ (cwss @ XB2 @ ccsur) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(aexp44_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ Xph @ (cwa @ (cwa @ Xps @ Xch) @ Xth)) @ Xta) => (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ Xta))))))))))).
...
thf(aslttrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccsur)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccsur)) => ((cwi @ Xph @ (cwcel @ XC @ ccsur)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccslt)) => ((cwi @ Xph @ (cwbr @ XB2 @ XC @ ccslt)) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ ccslt)))))))))))).
...
thf(anocvxmin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwne @ XA2 @ cc0) @ (cwss @ XA2 @ ccsur) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccslt) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccslt)) @ (cwcel @ (ccv @ Xz) @ XA2))) @ (^ [Xz:$i] : ccsur))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ (cwreu @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ ccbday) @ (ccint @ (ccima @ ccbday @ XA2)))) @ (^ [Xw:$i] : XA2))))).
thf(cconway_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwreu @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ ccbday) @ (ccint @ (ccima @ ccbday @ (ccrab @ (^ [Xy1:$i] : (cwa @ (cwbr @ XA2 @ (ccsn @ (ccv @ Xy1)) @ ccsslt) @ (cwbr @ (ccsn @ (ccv @ Xy1)) @ XB2 @ ccsslt))) @ (^ [Xy1:$i] : ccsur)))))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwa @ (cwbr @ XA2 @ (ccsn @ (ccv @ Xy1)) @ ccsslt) @ (cwbr @ (ccsn @ (ccv @ Xy1)) @ XB2 @ ccsslt))) @ (^ [Xy1:$i] : ccsur)))))))).
