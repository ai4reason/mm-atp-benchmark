...
thf(cexanres2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XW)) @ (cwb @ (cwex @ (^ [Xu:$i] : (cwa @ (cwbr @ (ccv @ Xu) @ XB2 @ (ccres @ (XR @ Xu) @ (XA2 @ Xu))) @ (cwbr @ (ccv @ Xu) @ XC @ (ccres @ (XS @ Xu) @ (XA2 @ Xu)))))) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ XB2 @ (ccec @ (ccv @ Xu) @ (XR @ Xu))) @ (cwcel @ XC @ (ccec @ (ccv @ Xu) @ (XS @ Xu))))) @ (^ [Xu:$i] : (XA2 @ Xu))))))))))))).
