...
thf(cevls1sca_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XQ @ (cco @ XS @ XR @ cces1)) => ((cwceq @ XW @ (ccfv @ XU @ ccpl1)) => ((cwceq @ XU @ (cco @ XS @ XR @ ccress)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XA2 @ (ccfv @ XW @ ccascl)) => ((cwi @ Xph @ (cwcel @ XS @ cccrg)) => ((cwi @ Xph @ (cwcel @ XR @ (ccfv @ XS @ ccsubrg))) => ((cwi @ Xph @ (cwcel @ XX @ XR)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XX @ XA2) @ XQ) @ (ccxp @ XB2 @ (ccsn @ XX)))))))))))))))))))))).
