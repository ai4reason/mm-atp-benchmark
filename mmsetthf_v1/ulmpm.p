...
thf(aulmf_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm)) @ (cwrex @ (^ [Xn:$i] : (cwf @ (ccfv @ (ccv @ Xn) @ ccuz) @ (cco @ ccc @ XS @ ccmap) @ XF)) @ (^ [Xn:$i] : ccz))))))).
...
thf(culmpm_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm)) @ (cwcel @ XF @ (cco @ (cco @ ccc @ XS @ ccmap) @ ccz @ ccpm))))))).
