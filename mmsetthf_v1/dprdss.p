...
thf(cdprdss_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XT @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XT) @ XI)) => ((cwi @ Xph @ (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XI)) @ (cwss @ (ccfv @ (ccv @ Xk) @ XS) @ (ccfv @ (ccv @ Xk) @ XT)))) => (cwi @ Xph @ (cwa @ (cwbr @ XG @ XS @ (ccdm @ ccdprd)) @ (cwss @ (cco @ XG @ XS @ ccdprd) @ (cco @ XG @ XT @ ccdprd)))))))))))))).
