...
thf(aindval_thm,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XO @ (XV @ Xx3)) @ (cwss @ XA2 @ XO)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XO @ ccind)) @ (ccmpt @ (^ [Xx3:$i] : XO) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0)))))))))).
...
thf(cindval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XO @ ccind)) @ (ccun @ (ccxp @ XA2 @ (ccsn @ cc1)) @ (ccxp @ (ccdif @ XO @ XA2) @ (ccsn @ ccc0))))))))).
