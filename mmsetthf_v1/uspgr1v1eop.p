...
thf(auspgr1eop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwcel @ (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XC)))) @ ccuspgr))))))))).
thf(cuspgr1v1eop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XV @ XW) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XV)) @ (cwcel @ (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccsn @ XB2)))) @ ccuspgr)))))))).
