...
thf(arngoid_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XA2 @ XX)) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xu) @ XA2 @ XH) @ XA2) @ (cwceq @ (cco @ XA2 @ (ccv @ Xu) @ XH) @ XA2))) @ (^ [Xu:$i] : XX)))))))))))).
...
thf(crngo2_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XA2 @ XX)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ XA2 @ XG) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XG) @ XA2 @ XH))) @ (^ [Xx3:$i] : XX)))))))))))).
