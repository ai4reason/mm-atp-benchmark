...
thf(cply1vr1smo_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((cwceq @ XG @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ (cco @ Xc_1 @ (cco @ cc1 @ XX @ Xc_ex) @ Xc_x) @ XX)))))))))))))))).
