...
thf(ctrrelind_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwi @ Xph @ (cwss @ (cccom @ XR @ XR) @ XR)) => ((cwi @ Xph @ (cwss @ (cccom @ XS @ XS) @ XS)) => ((cwi @ Xph @ (cwceq @ XT @ (ccin @ XR @ XS))) => (cwi @ Xph @ (cwss @ (cccom @ XT @ XT) @ XT)))))))))).
