...
thf(alhpexle3_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le) @ (cw3a @ (cwne @ (ccv @ Xp) @ XX) @ (cwne @ (ccv @ Xp) @ XY) @ (cwne @ (ccv @ Xp) @ XZ)))) @ (^ [Xp:$i] : XA2))))))))))))))).
...
thf(ccdlemftr3_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccfv @ XK @ ccbs))) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccv @ Xf1) @ (ccres @ ccid @ (XB2 @ Xf1))) @ (cw3a @ (cwne @ (ccfv @ (ccv @ Xf1) @ XR) @ XX) @ (cwne @ (ccfv @ (ccv @ Xf1) @ XR) @ XY) @ (cwne @ (ccfv @ (ccv @ Xf1) @ XR) @ XZ)))) @ (^ [Xf1:$i] : XT))))))))))))))))).
