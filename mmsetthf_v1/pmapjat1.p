...
thf(acvrat42_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((! [Xr:$i] : (cwceq @ (Xc_0 @ Xr) @ (ccfv @ XK @ ccp0))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2))) @ (cwi @ (cwa @ (cwne @ XX @ (Xc_0 @ Xr)) @ (cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le)) @ (cwrex @ (^ [Xr:$i] : (cwa @ (cwbr @ (ccv @ Xr) @ XX @ Xc_le) @ (cwbr @ XP @ (cco @ (ccv @ Xr) @ XQ @ Xc_or) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))))))).
...
thf(aelpmap_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ XC) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwcel @ XP @ (ccfv @ XX @ XM)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwbr @ XP @ XX @ Xc_le))))))))))))))))).
...
thf(aelpmapat_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2)) @ (cwb @ (cwcel @ XX @ (ccfv @ XP @ XM)) @ (cwceq @ XX @ XP))))))))))).
thf(aceqsexgv_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwb @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3)))) @ Xps))))))))).
...
thf(apmapeq0_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwceq @ (ccfv @ XX @ XM) @ cc0) @ (cwceq @ XX @ Xc_0)))))))))))).
