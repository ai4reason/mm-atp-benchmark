...
thf(aimim3i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => (cwi @ (cwi @ Xth @ Xph) @ (cwi @ (cwi @ Xth @ Xps) @ (cwi @ Xth @ Xch))))))))).
...
thf(cbj_ceqsalt0_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xth:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xth @ Xx3) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3))))) @ (cwex @ (^ [Xx3:$i] : (Xth @ Xx3)))) @ (cwb @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xth @ Xx3) @ (Xph @ Xx3)))) @ (Xps @ Xx3)))))))).
