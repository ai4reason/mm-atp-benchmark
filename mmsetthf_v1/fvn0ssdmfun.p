...
thf(aelsnres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => (cwb @ (cwcel @ XA2 @ (ccres @ XB2 @ (ccsn @ XC))) @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ XA2 @ (ccop @ XC @ (ccv @ Xy1))) @ (cwcel @ (ccop @ XC @ (ccv @ Xy1)) @ XB2)))))))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(aspimvw_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xy1))))) => (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))) @ (Xps @ Xy1))))))).
...
thf(cfvn0ssdmfun_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwral @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XF) @ cc0)) @ (^ [Xa:$i] : XD)) @ (cwa @ (cwss @ XD @ (ccdm @ XF)) @ (cwfun @ (ccres @ XF @ XD))))))).
