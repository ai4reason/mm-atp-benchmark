...
thf(csubmmulg_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_xb @ (ccfv @ XG @ ccmg)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => ((cwceq @ Xc_x @ (ccfv @ XH @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XS)) @ (cwceq @ (cco @ XN @ XX @ Xc_xb) @ (cco @ XN @ XX @ Xc_x)))))))))))))).
