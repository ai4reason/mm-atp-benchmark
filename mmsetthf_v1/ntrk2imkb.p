...
thf(araaanv_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwa @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : XA2)))))))).
...
thf(cntrk2imkb_conj,conjecture,(! [XB2:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwral @ (^ [Xs1:$i] : (cwss @ (ccfv @ (ccv @ Xs1) @ XI) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccpw @ XB2))) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwi @ (cwceq @ (ccin @ (ccv @ Xs1) @ (ccv @ Xt)) @ cc0) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xs1) @ XI) @ (ccfv @ (ccv @ Xt) @ XI)) @ cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2))))))).
