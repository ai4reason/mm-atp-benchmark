...
thf(cnulmbl2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwss @ XA2 @ (ccv @ Xy1)) @ (cwbr @ (ccfv @ (ccv @ Xy1) @ ccovol) @ (ccv @ Xx3) @ ccle))) @ (^ [Xy1:$i] : (ccdm @ ccvol)))) @ (^ [Xx3:$i] : ccrp)) @ (cwcel @ XA2 @ (ccdm @ ccvol))))).
