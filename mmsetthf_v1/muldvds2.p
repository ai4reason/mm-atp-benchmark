...
thf(cmuldvds2_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwbr @ (cco @ XK @ XM @ ccmul) @ XN @ ccdvds) @ (cwbr @ XM @ XN @ ccdvds))))))).
