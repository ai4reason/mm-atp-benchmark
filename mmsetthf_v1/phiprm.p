...
thf(aphiprmpw_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XK @ ccn)) @ (cwceq @ (ccfv @ (cco @ XP @ XK @ ccexp) @ ccphi) @ (cco @ (cco @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccexp) @ (cco @ XP @ cc1 @ ccmin) @ ccmul)))))).
...
thf(cphiprm_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwceq @ (ccfv @ XP @ ccphi) @ (cco @ XP @ cc1 @ ccmin))))).
