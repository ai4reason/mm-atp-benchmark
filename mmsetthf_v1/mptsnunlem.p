...
thf(aequsb3_b_thm,axiom,(! [Xx3:$i] : (cwb @ (cwsb @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3))) @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3))))).
thf(asbf_thm,axiom,(! [Xph:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1) @ (Xph @ Xx3 @ Xy1))))))).
thf(cmptsnunlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : ((! [Xu:$i] : (cwceq @ (XF @ Xu) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3)))))) => ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XR @ Xx3 @ Xu) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))) => (! [Xu:$i] : (cwi @ (cwss @ XB2 @ XA2) @ (cwceq @ XB2 @ (ccuni @ (ccima @ (XF @ Xu) @ XB2)))))))))))).
