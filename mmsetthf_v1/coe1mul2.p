...
thf(apsr1ring_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccps1)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwcel @ XS @ ccrg)))))).
...
thf(acoe1mul2lem2_thm,axiom,(! [XH:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xd:$i] : (cwceq @ (XH @ Xk @ Xd) @ (ccrab @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (ccxp @ cc1o @ (ccsn @ (ccv @ Xk))) @ (ccofr @ ccle))) @ (^ [Xd:$i] : (cco @ ccn0 @ cc1o @ ccmap)))))) => (! [Xk:$i] : (! [Xd:$i] : (cwi @ (cwcel @ (ccv @ Xk) @ ccn0) @ (cwf1o @ (XH @ Xk @ Xd) @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (ccmpt @ (^ [Xc:$i] : (XH @ Xk @ Xd)) @ (^ [Xc:$i] : (ccfv @ cc0 @ (ccv @ Xc))))))))))).
...
thf(acoe1mul2lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XX @ (cco @ ccn0 @ cc1o @ ccmap))) @ (cwb @ (cwbr @ XX @ (ccxp @ cc1o @ (ccsn @ XA2)) @ (ccofr @ ccle)) @ (cwcel @ (ccfv @ cc0 @ XX) @ (cco @ ccc0 @ XA2 @ ccfz))))))).
...
thf(amapsnconst_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccsn @ XX)) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XX @ ccvv) => (cwi @ (cwcel @ XF @ (cco @ XB2 @ XS @ ccmap)) @ (cwceq @ XF @ (ccxp @ XS @ (ccsn @ (ccfv @ XX @ XF))))))))))))).
...
thf(acoe1fv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ ccco1)) => (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ XN @ XA2) @ (ccfv @ (ccxp @ cc1o @ (ccsn @ XN)) @ XF))))))))).
thf(ccoe1mul2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XS @ Xx3 @ Xk) @ (ccfv @ XR @ ccps1)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (Xc_xb @ Xx3) @ (ccfv @ (XS @ Xx3 @ Xk) @ ccmulr)))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XB2 @ (ccfv @ (XS @ Xx3 @ Xk) @ ccbs)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (Xc_xb @ Xx3)) @ ccco1) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ ccco1)) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ ccmin) @ (ccfv @ XG @ ccco1)) @ Xc_x))) @ ccgsu)))))))))))))))))).
