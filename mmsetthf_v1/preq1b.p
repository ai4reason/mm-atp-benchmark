...
thf(aoplem1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwo @ Xps @ Xch)) => ((cwi @ Xph @ (cwo @ Xth @ Xta)) => ((cwb @ Xps @ Xth) => ((cwi @ Xch @ (cwb @ Xth @ Xta)) => (cwi @ Xph @ Xps))))))))))).
...
thf(cpreq1b_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => (cwi @ Xph @ (cwb @ (cwceq @ (ccpr @ XA2 @ XC) @ (ccpr @ XB2 @ XC)) @ (cwceq @ XA2 @ XB2)))))))))))).
