...
thf(asincos2sgn_thm,axiom,(cwa @ (cwbr @ ccc0 @ (ccfv @ cc2 @ ccsin) @ cclt) @ (cwbr @ (ccfv @ cc2 @ cccos) @ ccc0 @ cclt))).
...
thf(apilem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ cc2 @ cc4 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccsin) @ ccc0)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ ccsin) @ ccc0)) => ((cwi @ Xph @ (cwbr @ ccpi @ XA2 @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ ccpi @ XA2 @ ccaddc) @ cc2 @ ccdiv) @ XB2 @ ccle))))))))))).
...
thf(aavgle2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ XB2 @ ccle)))))).
...
thf(cpilem3_conj,conjecture,(cwa @ (cwcel @ ccpi @ (cco @ cc2 @ cc4 @ ccioo)) @ (cwceq @ (ccfv @ ccpi @ ccsin) @ ccc0))).
