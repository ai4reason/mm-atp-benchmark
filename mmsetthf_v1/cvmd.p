...
thf(acvmdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) @ (cwbr @ XA2 @ XB2 @ ccmd))))))).
thf(aifchhv_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XA2 @ ccch) @ XA2 @ cchil) @ ccch))).
thf(ccvmd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv)) @ (cwbr @ XA2 @ XB2 @ ccmd))))).
