...
thf(aspansnsh_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwcel @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccsh)))).
...
thf(aelspansncl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ (ccfv @ (ccsn @ XA2) @ ccspn))) @ (cwcel @ XB2 @ cchil))))).
...
thf(aelspansn5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccsh) @ (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ cchil) @ (cwn @ (cwcel @ XB2 @ XA2))) @ (cwa @ (cwcel @ XC @ (ccfv @ (ccsn @ XB2) @ ccspn)) @ (cwcel @ XC @ XA2))) @ (cwceq @ XC @ cc0v))))))).
...
thf(ashsub1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh)) @ (cwss @ XA2 @ (cco @ XA2 @ XB2 @ ccph)))))).
thf(assrin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XC))))))).
thf(csumdmdlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwa @ (cwcel @ XC @ cchil) @ (cwn @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccph)))) @ (cwceq @ (ccin @ (cco @ XB2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ ccph) @ XA2) @ (ccin @ XB2 @ XA2))))))))).
