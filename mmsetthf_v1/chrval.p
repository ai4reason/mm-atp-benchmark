...
thf(adf_chr_ax,axiom,(cwceq @ ccchr @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccfv @ (ccfv @ (ccv @ Xg1) @ ccur) @ (ccfv @ (ccv @ Xg1) @ ccod)))))).
...
thf(cchrval_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccod)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ XC @ (ccfv @ XR @ ccchr)) => (cwceq @ (ccfv @ Xc_1 @ XO) @ XC))))))))).
