...
thf(a_3imp21_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ Xth))) => (cwi @ (cw3a @ Xps @ Xph @ Xch) @ Xth))))))).
...
thf(cnumclwwlk2lem1lem_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ (ccfv @ XG @ ccvtx)) @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwne @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW))) @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) @ (ccfv @ ccc0 @ XW)) @ (cwne @ (ccfv @ XN @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) @ (ccfv @ ccc0 @ XW))))))))).
