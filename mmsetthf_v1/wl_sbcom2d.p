...
thf(awl_sbcom2d_lem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwn @ (cwal @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (cwb @ (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ Xv)) @ Xu) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xu)) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xv))) @ (Xph @ Xx3 @ Xy1))))))))))))).
...
thf(awl_sbcom2d_lem1_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xu) @ (ccv @ Xy1)) @ (cwceq @ (ccv @ Xv) @ (ccv @ Xw))) @ (cwi @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xw))))) @ (cwb @ (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xv)) @ Xu) @ (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xw)) @ Xy1)))))))))).
thf(aancoms_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ Xps @ Xph) @ Xch)))))).
thf(cwl_sbcom2d_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xw)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwn @ (cwal @ (^ [Xz:$i] : (cwceq @ (ccv @ Xz) @ (ccv @ Xy1)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwb @ (cwsb @ (^ [Xz:$i] : (cwsb @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xy1)) @ Xw) @ (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xw)) @ Xy1))))))))))))).
