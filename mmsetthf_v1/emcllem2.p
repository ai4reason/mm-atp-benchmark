...
thf(cemcllem2_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xm @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmin)))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xm @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ cclog) @ ccmin)))))) => (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwa @ (cwbr @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XF @ Xm @ Xn)) @ (ccfv @ XN @ (XF @ Xm @ Xn)) @ ccle) @ (cwbr @ (ccfv @ XN @ (XG @ Xm @ Xn)) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XG @ Xm @ Xn)) @ ccle))))))))))).
