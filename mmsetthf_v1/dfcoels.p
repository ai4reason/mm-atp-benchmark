...
thf(a_1cossres_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwceq @ (cccoss @ (ccres @ XR @ XA2)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwbr @ (ccv @ Xu) @ (ccv @ Xx3) @ XR) @ (cwbr @ (ccv @ Xu) @ (ccv @ Xy1) @ XR))) @ (^ [Xu:$i] : XA2))))))))).
...
thf(cdfcoels_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (cccoels @ XA2) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2)))))))).
