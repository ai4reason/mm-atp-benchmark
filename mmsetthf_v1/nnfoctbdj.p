...
thf(annfoctb_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwne @ XA2 @ cc0)) @ (cwex @ (^ [Xf1:$i] : (cwfo @ ccn @ XA2 @ (ccv @ Xf1))))))).
...
thf(awessf1orn_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwfn @ XF @ XA2))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwwe @ XA2 @ XR))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ (ccrn @ XF) @ (ccres @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccpw @ XA2)))))))))))))).
...
thf(annfoctbdjlem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwss @ (XA2 @ Xf1) @ ccn))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (XA2 @ Xf1) @ XX @ (XG @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwdisj @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccv @ Xy1))))) => ((! [Xf1:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwo @ (cwceq @ (ccv @ Xn) @ cc1) @ (cwn @ (cwcel @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XA2 @ Xf1)))) @ cc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XG @ Xf1))))))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwfo @ ccn @ (ccun @ XX @ (ccsn @ cc0)) @ (ccv @ Xf1)) @ (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))))))))))))))))))).
...
thf(cnnfoctbdj_conj,conjecture,(! [Xph:($i > $o)] : (! [XX:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwbr @ XX @ ccom @ ccdom))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwne @ XX @ cc0))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwdisj @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccv @ Xy1))))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwfo @ ccn @ (ccun @ XX @ (ccsn @ cc0)) @ (ccv @ Xf1)) @ (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))))))))))))))).
