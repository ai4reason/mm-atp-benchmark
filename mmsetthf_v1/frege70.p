...
thf(afrege68c_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ (XB2 @ Xx3))) => (! [Xx3:$i] : (cwi @ (cwb @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (Xps @ Xx3)) @ (cwi @ (Xps @ Xx3) @ (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3))))))))))).
...
thf(asbcbr1g_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) @ (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ XC @ XR)) @ (XA2 @ Xx3)) @ (cwbr @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC @ XR)))))))))).
...
thf(cfrege70_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwcel @ XX @ (XV @ Xy1))) => (cwi @ (cwhe @ XA2 @ XR) @ (cwi @ (cwcel @ XX @ XA2) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ XX @ (ccv @ Xy1) @ XR) @ (cwcel @ (ccv @ Xy1) @ XA2)))))))))))).
