...
thf(antrf2_thm,axiom,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XI @ (ccfv @ XJ @ ccnt)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwf @ (ccpw @ XX) @ (ccpw @ XX) @ XI)))))))).
...
thf(cntrelmap_conj,conjecture,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XI @ (ccfv @ XJ @ ccnt)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwcel @ XI @ (cco @ (ccpw @ XX) @ (ccpw @ XX) @ ccmap))))))))).
