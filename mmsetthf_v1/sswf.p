...
thf(ar1sscl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) @ (cwss @ XC @ XA2)) @ (cwcel @ XC @ (ccfv @ XB2 @ ccr1))))))).
...
thf(csswf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwss @ XB2 @ XA2)) @ (cwcel @ XB2 @ (ccuni @ (ccima @ ccr1 @ ccon0))))))).
