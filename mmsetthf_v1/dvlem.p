...
thf(cdvlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XD @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XD @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ XD)) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ (ccdif @ XD @ (ccsn @ XB2)))) @ (cwcel @ (cco @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccmin) @ (cco @ XA2 @ XB2 @ ccmin) @ ccdiv) @ ccc))))))))))).
