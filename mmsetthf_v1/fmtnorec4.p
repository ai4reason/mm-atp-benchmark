...
thf(cfmtnorec4_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (ccfv @ XN @ ccfmtno) @ (cco @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfmtno) @ cc2 @ ccexp) @ (cco @ cc2 @ (cco @ (cco @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ ccfmtno) @ cc1 @ ccmin) @ cc2 @ ccexp) @ ccmul) @ ccmin))))).
