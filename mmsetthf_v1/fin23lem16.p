...
thf(afin23lem15_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XU @ Xt) @ (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) @ cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (XA2 @ Xt) @ ccom) @ (cwcel @ (XB2 @ Xu @ Xt @ Xi) @ ccom)) @ (cwss @ (XB2 @ Xu @ Xt @ Xi) @ (XA2 @ Xt))) @ (cwss @ (ccfv @ (XA2 @ Xt) @ (XU @ Xt)) @ (ccfv @ (XB2 @ Xu @ Xt @ Xi) @ (XU @ Xt)))))))))))).
...
thf(cfin23lem16_conj,conjecture,(! [XU:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XU @ Xt) @ (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) @ cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))) => (! [Xt:$i] : (cwceq @ (ccuni @ (ccrn @ (XU @ Xt))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))))).
