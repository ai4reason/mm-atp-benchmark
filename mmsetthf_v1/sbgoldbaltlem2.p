...
thf(asbgoldbaltlem1_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime)) @ (cwi @ (cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (cwceq @ XN @ (cco @ XP @ XQ @ ccaddc))) @ (cwcel @ XQ @ ccodd))))))).
thf(csbgoldbaltlem2_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime)) @ (cwi @ (cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (cwceq @ XN @ (cco @ XP @ XQ @ ccaddc))) @ (cwa @ (cwcel @ XP @ ccodd) @ (cwcel @ XQ @ ccodd)))))))).
