...
thf(cabrexco_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xw:$i] : (cwcel @ (XB2 @ Xx3 @ Xw) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xw)) @ (cwceq @ (XC @ Xx3 @ Xy1 @ Xz) @ (XD @ Xx3 @ Xz @ Xw))))))) => (! [Xz:$i] : (cwceq @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (XC @ Xx3 @ Xy1 @ Xz))) @ (^ [Xy1:$i] : (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xz) @ (XB2 @ Xx3 @ Xw))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xw))))))))) @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xx3) @ (XD @ Xx3 @ Xz @ Xw))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xw)))))))))))))).
