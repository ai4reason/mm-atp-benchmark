...
thf(adfodd6_thm,axiom,(cwceq @ ccodd @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : (cwceq @ (ccv @ Xz) @ (cco @ (cco @ cc2 @ (ccv @ Xi) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xi:$i] : ccz))) @ (^ [Xz:$i] : ccz)))).
thf(asyl5bi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwb @ Xph @ Xps) => ((cwi @ Xch @ (cwi @ Xps @ Xth)) => (cwi @ Xch @ (cwi @ Xph @ Xth))))))))).
thf(adfeven4_thm,axiom,(cwceq @ cceven @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xi) @ ccmul))) @ (^ [Xi:$i] : ccz))) @ (^ [Xz:$i] : ccz)))).
...
thf(copeoALTV_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccodd) @ (cwcel @ XB2 @ cceven)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccodd))))).
