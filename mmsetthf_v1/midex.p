...
thf(amideulem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XP @ (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ Xc_mi @ (ccfv @ (XG @ Xx3) @ ccds))) => ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ ccitv))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccfv @ (XG @ Xx3) @ cclng))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ ccstrkg))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccmir))) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XQ @ XP)) => ((cwi @ Xph @ (cwcel @ XO @ XP)) => ((cwi @ Xph @ (cwcel @ XT @ XP)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ (XL @ Xx3)) @ (cco @ XQ @ XB2 @ (XL @ Xx3)) @ (ccfv @ (XG @ Xx3) @ ccperpg)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ (XL @ Xx3)) @ (cco @ XA2 @ XO @ (XL @ Xx3)) @ (ccfv @ (XG @ Xx3) @ ccperpg)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XT @ (cco @ XA2 @ XB2 @ (XL @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XT @ (cco @ XQ @ XO @ XI))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XO @ Xc_mi) @ (cco @ XB2 @ XQ @ Xc_mi) @ (ccfv @ (XG @ Xx3) @ ccleg)))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ XA2 @ (ccfv @ (ccv @ Xx3) @ (XS @ Xx3))))) @ (^ [Xx3:$i] : XP))))))))))))))))))))))))))))))))).
...
thf(aperpcom_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccrn @ XL))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccrn @ XL))) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (cwi @ Xph @ (cwbr @ XB2 @ XA2 @ (ccfv @ XG @ ccperpg)))))))))))))))))))).
...
thf(aperpln1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (cwi @ Xph @ (cwcel @ XA2 @ (ccrn @ XL)))))))))))).
...
thf(atglnne_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ (cco @ XX @ XY @ XL) @ (ccrn @ XL))) => (cwi @ Xph @ (cwne @ XX @ XY))))))))))))))))).
...
thf(amircom_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwceq @ XS @ (ccfv @ XG @ ccmir)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwceq @ XM @ (ccfv @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ XM) @ XC)) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ XM) @ XB2)))))))))))))))))))))))).
...
thf(acolperpex_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => (cwi @ Xph @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ (cco @ XA2 @ (ccv @ Xp) @ XL) @ (cco @ XA2 @ XB2 @ XL) @ (ccfv @ XG @ ccperpg)) @ (cwrex @ (^ [Xt:$i] : (cwa @ (cwo @ (cwcel @ (ccv @ Xt) @ (cco @ XA2 @ XB2 @ XL)) @ (cwceq @ XA2 @ XB2)) @ (cwcel @ (ccv @ Xt) @ (cco @ XC @ (ccv @ Xp) @ XI)))) @ (^ [Xt:$i] : XP)))) @ (^ [Xp:$i] : XP))))))))))))))))))))))).
...
thf(cmidex_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwceq @ XS @ (ccfv @ XG @ ccmir)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ XA2 @ (ccfv @ (ccv @ Xx3) @ XS)))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))).
