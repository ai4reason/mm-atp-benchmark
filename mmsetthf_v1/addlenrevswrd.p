...
thf(aswrdrlen_thm,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ (cco @ XW @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr) @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ XI @ ccmin))))))).
...
thf(caddlenrevswrd_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XM @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (cco @ (ccfv @ (cco @ XW @ (ccop @ XM @ (ccfv @ XW @ cchash)) @ ccsubstr) @ cchash) @ (ccfv @ (cco @ XW @ (ccop @ ccc0 @ XM) @ ccsubstr) @ cchash) @ ccaddc) @ (ccfv @ XW @ cchash))))))).
