...
thf(alsmssspx_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwi @ Xph @ (cwss @ XT @ XV)) => ((cwi @ Xph @ (cwss @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => (cwi @ Xph @ (cwss @ (cco @ XT @ XU @ Xc_po) @ (ccfv @ (ccun @ XT @ XU) @ XN))))))))))))))))).
