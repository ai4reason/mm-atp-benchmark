...
thf(cs4s3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ (cco @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs3 @ XE @ XF @ XG) @ ccconcat)))))))))).
