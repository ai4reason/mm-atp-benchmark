...
thf(algsqrlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XP @ cczn)) => ((cwceq @ XS @ (ccfv @ XY @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XD @ (ccfv @ XY @ ccdg1)) => ((cwceq @ XO @ (ccfv @ XY @ cce1)) => ((cwceq @ Xc_ex @ (ccfv @ (ccfv @ XS @ ccmgp) @ ccmg)) => ((cwceq @ XX @ (ccfv @ XY @ ccv1)) => ((cwceq @ Xc_mi @ (ccfv @ XS @ ccsg)) => ((cwceq @ Xc_1 @ (ccfv @ XS @ ccur)) => ((cwceq @ XT @ (cco @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ XX @ Xc_ex) @ Xc_1 @ Xc_mi)) => ((cwceq @ XL @ (ccfv @ XY @ cczrh)) => ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) @ (cco @ cc1 @ XP @ ccmo))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XA2 @ XL) @ (ccfv @ XT @ XO)) @ (ccfv @ XY @ cc0g)))))))))))))))))))))))))))))))).
