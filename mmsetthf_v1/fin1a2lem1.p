...
thf(cfin1a2lem1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ ccon0) @ (cwceq @ (ccfv @ (XA2 @ Xx3) @ (XS @ Xx3)) @ (ccsuc @ (XA2 @ Xx3))))))))).
