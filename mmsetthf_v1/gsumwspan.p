...
thf(cgsumwspan_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XK @ (ccfv @ (ccfv @ XM @ ccsubmnd) @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XM @ ccmnd) @ (cwss @ XG @ XB2)) @ (cwceq @ (ccfv @ XG @ XK) @ (ccrn @ (ccmpt @ (^ [Xw:$i] : (ccword @ XG)) @ (^ [Xw:$i] : (cco @ XM @ (ccv @ Xw) @ ccgsu))))))))))))).
