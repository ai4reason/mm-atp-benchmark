...
thf(ceulerpartlemd_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XP @ Xf1 @ Xk) @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn) @ (cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))) @ (XN @ Xg1 @ Xk @ Xn)))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XO @ Xf1 @ Xg1 @ Xk @ Xn) @ (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (cwn @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (ccima @ (cccnv @ (ccv @ Xg1)) @ ccn)))) @ (^ [Xg1:$i] : (XP @ Xf1 @ Xk)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xf1 @ Xg1 @ Xk @ Xn) @ (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ cc1 @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xg1:$i] : (XP @ Xf1 @ Xk)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwb @ (cwcel @ XA2 @ (XD @ Xf1 @ Xg1 @ Xk @ Xn)) @ (cwa @ (cwcel @ XA2 @ (XP @ Xf1 @ Xk)) @ (cwss @ (ccima @ XA2 @ ccn) @ (ccpr @ ccc0 @ cc1))))))))))))))))).
