...
thf(cnnsum4primesodd_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc5 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc6 @ ccuz)) @ (cwcel @ XN @ ccodd)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XN @ (ccsu @ (cco @ cc1 @ cc3 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))))))).
