...
thf(csmatvscl_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XS @ (cco @ XN @ XR @ ccscmat)) => ((cwceq @ Xc_as @ (ccfv @ XA2 @ ccvsca)) => (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwa @ (cwcel @ XC @ XK) @ (cwcel @ XX @ XS))) @ (cwcel @ (cco @ XC @ XX @ Xc_as) @ XS))))))))))))))).
