...
thf(cmodabsdifz_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccr) @ (cwcel @ XM @ ccr) @ (cwne @ XM @ ccc0)) @ (cwcel @ (cco @ (cco @ XN @ (cco @ XN @ (ccfv @ XM @ ccabs) @ ccmo) @ ccmin) @ XM @ ccdiv) @ ccz))))).
