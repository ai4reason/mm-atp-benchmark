...
thf(acbvfo_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => (! [Xx3:$i] : (cwi @ (cwfo @ XA2 @ (XB2 @ Xx3) @ XF) @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3))))))))))))).
...
thf(afvcoe1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ ccco1)) => (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XX @ (cco @ ccn0 @ cc1o @ ccmap))) @ (cwceq @ (ccfv @ XX @ XF) @ (ccfv @ (ccfv @ cc0 @ XX) @ XA2))))))))).
thf(cdeg1leb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccdg1))) => ((! [Xx3:$i] : (cwceq @ (XP @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccpl1))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XP @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (cwceq @ XA2 @ (ccfv @ (XF @ Xx3) @ ccco1))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XF @ Xx3) @ (XB2 @ Xx3)) @ (cwcel @ XG @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ (XF @ Xx3) @ (XD @ Xx3)) @ XG @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ XG @ (ccv @ Xx3) @ cclt) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XA2) @ Xc_0))) @ (^ [Xx3:$i] : ccn0))))))))))))))))))).
