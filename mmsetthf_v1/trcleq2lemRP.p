...
thf(ctrcleq2lemRP_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwa @ (cwss @ XR @ XA2) @ (cwss @ (cccom @ XA2 @ XA2) @ XA2)) @ (cwa @ (cwss @ XR @ XB2) @ (cwss @ (cccom @ XB2 @ XB2) @ XB2)))))))).
