...
thf(adecbin0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => (cwceq @ (cco @ cc4 @ XA2 @ ccmul) @ (cco @ cc2 @ (cco @ cc2 @ XA2 @ ccmul) @ ccmul))))).
...
thf(cdecexp2_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccn0) => ((cwceq @ (cco @ XM @ cc2 @ ccaddc) @ XN) => (cwceq @ (cco @ (cco @ cc4 @ (cco @ cc2 @ XM @ ccexp) @ ccmul) @ ccc0 @ ccaddc) @ (cco @ cc2 @ XN @ ccexp))))))).
