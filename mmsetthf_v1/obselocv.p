...
thf(cobselocv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwss @ XC @ XB2) @ (cwcel @ XA2 @ XB2)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XC @ Xc_pe)) @ (cwn @ (cwcel @ XA2 @ XC))))))))))).
