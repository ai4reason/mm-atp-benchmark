...
thf(csmfmbfcex_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccdm @ ccvol))) => ((cwi @ Xph @ (cwss @ XX @ ccr)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwn @ (cwcel @ XX @ (XS @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : ccc0)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XF @ Xx3) @ (ccfv @ (XS @ Xx3) @ ccsmblfn)) @ (cwn @ (cwcel @ (XF @ Xx3) @ ccmbf)))))))))))))).
