...
thf(aeuen1_thm,axiom,(! [Xph:($i > $o)] : (cwb @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwbr @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ cc1o @ ccen)))).
...
thf(ceuen1b_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwbr @ XA2 @ cc1o @ ccen) @ (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)))))).
