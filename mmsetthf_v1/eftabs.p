...
thf(ceftabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (ccfv @ (cco @ (cco @ XA2 @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv) @ ccabs) @ (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
