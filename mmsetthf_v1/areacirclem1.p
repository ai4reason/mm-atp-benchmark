...
thf(advreasin_thm,axiom,(cwceq @ (cco @ ccr @ (ccres @ ccasin @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))).
...
thf(advsqrt_thm,axiom,(cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccsqrt))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccmul) @ ccdiv))))).
