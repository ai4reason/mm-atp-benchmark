...
thf(clmodsubid_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XA2 @ XV)) @ (cwceq @ (cco @ XA2 @ XA2 @ Xc_mi) @ Xc_0))))))))))).
