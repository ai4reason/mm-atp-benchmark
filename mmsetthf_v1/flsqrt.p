...
thf(cflsqrt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwcel @ XB2 @ ccn0)) @ (cwb @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccsqrt) @ ccfl) @ XB2) @ (cwa @ (cwbr @ (cco @ XB2 @ cc2 @ ccexp) @ XA2 @ ccle) @ (cwbr @ XA2 @ (cco @ (cco @ XB2 @ cc1 @ ccaddc) @ cc2 @ ccexp) @ cclt))))))).
