...
thf(a_2ndcsep_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cc2ndc) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XX))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
...
thf(amet2ndci_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cw3a @ (cwss @ XA2 @ XX) @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ XX))) @ (cwcel @ XJ @ cc2ndc)))))))).
thf(cmet2ndc_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwb @ (cwcel @ XJ @ cc2ndc) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XX))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))))).
