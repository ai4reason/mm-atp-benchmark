...
thf(abitsfzolem_thm,axiom,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XN @ ccn0))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XM @ Xn) @ ccn0))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwss @ (ccfv @ XN @ ccbits) @ (cco @ ccc0 @ (XM @ Xn) @ ccfzo)))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwbr @ XN @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ cclt)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XN @ (cco @ ccc0 @ (cco @ cc2 @ (XM @ Xn) @ ccexp) @ ccfzo))))))))))))).
...
thf(abernneq3_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwbr @ XN @ (cco @ XP @ XN @ ccexp) @ cclt))))).
...
thf(cbitsfzo_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0)) @ (cwb @ (cwcel @ XN @ (cco @ ccc0 @ (cco @ cc2 @ XM @ ccexp) @ ccfzo)) @ (cwss @ (ccfv @ XN @ ccbits) @ (cco @ ccc0 @ XM @ ccfzo))))))).
