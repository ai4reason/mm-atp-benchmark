...
thf(afallfac0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XA2 @ ccc0 @ ccfallfac) @ cc1)))).
...
thf(abcnn_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ XN @ ccbc) @ cc1)))).
...
thf(abinomfallfaclem2_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : (cwi @ (Xps @ Xk) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccfallfac) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul)))))) => (! [Xk:$i] : (cwi @ (cwa @ Xph @ (Xps @ Xk)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul)))))))))))))))).
thf(asimprl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xps))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xch))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(aid_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ Xph))).
thf(cbinomfallfac_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccfallfac) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul))))))))).
