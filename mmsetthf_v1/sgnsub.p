...
thf(amul2lt0lgt0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) => (cwi @ (cwa @ Xph @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwbr @ XB2 @ ccc0 @ cclt))))))))).
...
thf(amul2lt0llt0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) => (cwi @ (cwa @ Xph @ (cwbr @ XA2 @ ccc0 @ cclt)) @ (cwbr @ ccc0 @ XB2 @ cclt))))))))).
thf(asgnn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ XA2 @ ccc0 @ cclt)) @ (cwceq @ (ccfv @ XA2 @ ccsgn) @ (ccneg @ cc1))))).
thf(csgnsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccsgn) @ (ccfv @ XA2 @ ccsgn)))))).
