...
thf(csrhmsubclem1_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwral @ (^ [Xr:$i] : (cwcel @ (ccv @ Xr) @ ccrg)) @ (^ [Xr:$i] : XS)) => ((! [Xr:$i] : (cwceq @ (XC @ Xr) @ (ccin @ (XU @ Xr) @ XS))) => (! [Xr:$i] : (cwi @ (cwcel @ XX @ (XC @ Xr)) @ (cwcel @ XX @ (ccin @ (XU @ Xr) @ ccrg))))))))))).
