...
thf(asmadiadetg0_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XR @ cccrg) => (cwi @ (cw3a @ (cwcel @ XM @ (ccfv @ (cco @ XN @ XR @ ccmat) @ ccbs)) @ (cwcel @ XK @ XN) @ (cwcel @ XS @ (ccfv @ XR @ ccbs))) @ (cwceq @ (ccfv @ (cco @ XK @ XK @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ (cco @ XN @ XR @ ccmdat)) @ (cco @ XS @ (ccfv @ (cco @ XK @ XK @ (ccfv @ XM @ (cco @ XN @ XR @ ccsubma))) @ (cco @ (ccdif @ XN @ (ccsn @ XK)) @ XR @ ccmdat)) @ (ccfv @ XR @ ccmulr))))))))))).
...
thf(csmadiadetr_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ (ccfv @ (cco @ XN @ XR @ ccmat) @ ccbs))) @ (cwa @ (cwcel @ XK @ XN) @ (cwcel @ XS @ (ccfv @ XR @ ccbs)))) @ (cwceq @ (ccfv @ (cco @ XK @ XK @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ (cco @ XN @ XR @ ccmdat)) @ (cco @ XS @ (ccfv @ (cco @ XK @ XK @ (ccfv @ XM @ (cco @ XN @ XR @ ccsubma))) @ (cco @ (ccdif @ XN @ (ccsn @ XK)) @ XR @ ccmdat)) @ (ccfv @ XR @ ccmulr)))))))))).
