...
thf(ccphreccllem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwi @ Xph @ (cwceq @ XF @ (cco @ cccnfld @ XA2 @ ccress))) => ((cwi @ Xph @ (cwcel @ XF @ ccdr)) => (cwi @ (cw3a @ Xph @ (cwcel @ XX @ XK) @ (cwne @ XX @ ccc0)) @ (cwcel @ (cco @ cc1 @ XX @ ccdiv) @ XK))))))))))).
