...
thf(cisf34lem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwa @ (cwss @ (XX @ Xx3) @ (ccpw @ XA2)) @ (cwne @ (XX @ Xx3) @ cc0))) @ (cwceq @ (ccfv @ (ccint @ (XX @ Xx3)) @ (XF @ Xx3)) @ (ccuni @ (ccima @ (XF @ Xx3) @ (XX @ Xx3)))))))))))).
