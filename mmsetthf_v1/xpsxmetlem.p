...
thf(cxpsxmetlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ (XR @ Xy1) @ (XS @ Xy1) @ ccxps)))) => ((! [Xy1:$i] : (cwceq @ XX @ (ccfv @ (XR @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (cwceq @ XY @ (ccfv @ (XS @ Xy1) @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XR @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XS @ Xy1) @ (XW @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XP @ Xx3 @ Xy1) @ (ccfv @ (XT @ Xx3 @ Xy1) @ ccds)))) => ((! [Xy1:$i] : (cwceq @ (XM @ Xy1) @ (ccres @ (ccfv @ (XR @ Xy1) @ ccds) @ (ccxp @ XX @ XX)))) => ((! [Xy1:$i] : (cwceq @ (XN @ Xy1) @ (ccres @ (ccfv @ (XS @ Xy1) @ ccds) @ (ccxp @ XY @ XY)))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XM @ Xy1) @ (ccfv @ XX @ ccxmt)))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XN @ Xy1) @ (ccfv @ XY @ ccxmt)))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (ccfv @ (cco @ (ccfv @ (XR @ Xy1) @ ccsca) @ (cccnv @ (cco @ (ccsn @ (XR @ Xy1)) @ (ccsn @ (XS @ Xy1)) @ cccda)) @ ccprds) @ ccds) @ (ccfv @ (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccnv @ (cco @ (ccsn @ (ccv @ Xx3)) @ (ccsn @ (ccv @ Xy1)) @ cccda)))))) @ ccxmt)))))))))))))))))))))))))).
