...
thf(afsumharmonic_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwa @ (cwcel @ XT @ ccr) @ (cwbr @ cc1 @ XT @ ccle))) => ((cwi @ Xph @ (cwa @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz))) @ (cwcel @ (XB2 @ Xn) @ ccc))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz))) @ (cwcel @ (XC @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz))) @ (cwbr @ ccc0 @ (XC @ Xn) @ ccle))) => ((! [Xn:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz))) @ (cwbr @ XT @ (cco @ XA2 @ (ccv @ Xn) @ ccdiv) @ ccle)) @ (cwbr @ (ccfv @ (XB2 @ Xn) @ ccabs) @ (cco @ (XC @ Xn) @ (ccv @ Xn) @ ccmul) @ ccle))) => ((! [Xn:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz))) @ (cwbr @ (cco @ XA2 @ (ccv @ Xn) @ ccdiv) @ XT @ cclt)) @ (cwbr @ (ccfv @ (XB2 @ Xn) @ ccabs) @ XR @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (XB2 @ Xn) @ (ccv @ Xn) @ ccdiv))) @ ccabs) @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (XC @ Xn))) @ (cco @ XR @ (cco @ (ccfv @ XT @ cclog) @ cc1 @ ccaddc) @ ccmul) @ ccaddc) @ ccle))))))))))))))))).
...
thf(amulog2sumlem1_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (cwceq @ (XF @ Xy1 @ Xi @ Xm) @ (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccv @ Xi) @ ccdiv))) @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwbr @ (XF @ Xy1 @ Xi @ Xm) @ (XL @ Xy1 @ Xi @ Xm) @ ccrli))))) => ((! [Xy1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwcel @ XA2 @ ccrp)))) => ((! [Xy1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwbr @ cceu @ XA2 @ ccle)))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xm) @ ccdiv) @ cclog) @ (ccv @ Xm) @ ccdiv))) @ (cco @ (cco @ (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ (cco @ (cco @ ccem @ (ccfv @ XA2 @ cclog) @ ccmul) @ (XL @ Xy1 @ Xi @ Xm) @ ccmin) @ ccaddc) @ ccmin) @ ccabs) @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ cclog) @ XA2 @ ccdiv) @ ccmul) @ ccle)))))))))))))).
...
thf(cmulog2sumlem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xy1 @ Xi @ Xm @ Xn) @ (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccv @ Xi) @ ccdiv))) @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin)))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwbr @ (XF @ Xy1 @ Xi @ Xm @ Xn) @ (XL @ Xy1 @ Xi @ Xm) @ ccrli)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xi @ Xm @ Xn) @ (cco @ (cco @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ (cco @ (cco @ ccem @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ cclog) @ ccmul) @ (XL @ Xy1 @ Xi @ Xm) @ ccmin) @ ccaddc))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (cwceq @ (XR @ Xy1 @ Xi @ Xm) @ (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ ccem @ (ccfv @ (XL @ Xy1 @ Xi @ Xm) @ ccabs) @ ccaddc) @ ccaddc) @ (ccsu @ (cco @ cc1 @ cc2 @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (cco @ cceu @ (ccv @ Xm) @ ccdiv) @ cclog) @ (ccv @ Xm) @ ccdiv))) @ ccaddc))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccmu) @ (ccv @ Xn) @ ccdiv) @ (XT @ Xx3 @ Xy1 @ Xi @ Xm @ Xn) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1))))))))))))))).
