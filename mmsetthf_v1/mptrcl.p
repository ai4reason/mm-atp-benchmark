...
thf(cmptrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (XI @ Xx3) @ (ccfv @ (XX @ Xx3) @ (XF @ Xx3))) @ (cwcel @ (XX @ Xx3) @ XA2)))))))))).
