...
thf(a_1loopgrvd0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XN @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ (ccsn @ XN))))) => ((cwi @ Xph @ (cwcel @ XK @ (ccdif @ XV @ (ccsn @ XN)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XK @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))))))))))).
...
thf(ausgr1e_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XC))))) => ((cwi @ Xph @ (cwne @ XB2 @ XC)) => (cwi @ Xph @ (cwcel @ XG @ ccusgr)))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(aeleqtrrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XB2)) => (cwi @ Xph @ (cwcel @ XA2 @ XC))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(ccuhgr_tp,type,(ccuhgr : ($i > $o))).
thf(avtxdusgr0edgnel_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XD @ Xe) @ (ccfv @ XG @ ccvtxdg))) => (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XU @ XV)) @ (cwb @ (cwceq @ (ccfv @ XU @ (XD @ Xe)) @ ccc0) @ (cwn @ (cwrex @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
thf(c_1egrvtxdg0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwne @ XB2 @ XC)) => ((cwi @ Xph @ (cwcel @ XD @ XV)) => ((cwi @ Xph @ (cwne @ XC @ XD)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XD))))) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))))))))))))))).
