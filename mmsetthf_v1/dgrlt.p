...
thf(cdgrlt_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ ccn0)) @ (cwb @ (cwo @ (cwceq @ XF @ cc0p) @ (cwbr @ XN @ XM @ cclt)) @ (cwa @ (cwbr @ XN @ XM @ ccle) @ (cwceq @ (ccfv @ XM @ XA2) @ ccc0)))))))))))).
