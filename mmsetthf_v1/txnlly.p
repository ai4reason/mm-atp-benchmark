...
thf(ctxnlly_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ cctx) @ XA2)))) => (! [Xj:$i] : (cwi @ (cwa @ (cwcel @ XR @ (ccnlly @ XA2)) @ (cwcel @ (XS @ Xj) @ (ccnlly @ XA2))) @ (cwcel @ (cco @ XR @ (XS @ Xj) @ cctx) @ (ccnlly @ XA2))))))))).
