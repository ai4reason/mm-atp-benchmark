...
thf(abraadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (ccfv @ (cco @ XB2 @ XC @ ccva) @ (ccfv @ XA2 @ ccbr)) @ (cco @ (ccfv @ XB2 @ (ccfv @ XA2 @ ccbr)) @ (ccfv @ XC @ (ccfv @ XA2 @ ccbr)) @ ccaddc))))))).
...
thf(abramul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ cchil)) @ (cwceq @ (ccfv @ (cco @ XB2 @ XC @ ccsm) @ (ccfv @ XA2 @ ccbr)) @ (cco @ XB2 @ (ccfv @ XC @ (ccfv @ XA2 @ ccbr)) @ ccmul))))))).
...
thf(cbralnfn_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwcel @ (ccfv @ XA2 @ ccbr) @ cclf)))).
