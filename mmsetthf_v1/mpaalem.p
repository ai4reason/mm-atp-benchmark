...
thf(ampaaval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwceq @ (ccfv @ XA2 @ ccmpaa) @ (ccrio @ (^ [Xp:$i] : (cw3a @ (cwceq @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccfv @ XA2 @ ccdgraa)) @ (cwceq @ (ccfv @ XA2 @ (ccv @ Xp)) @ ccc0) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccv @ Xp) @ cccoe)) @ cc1))) @ (^ [Xp:$i] : (ccfv @ ccq @ ccply))))))).
...
thf(ampaaeu_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwreu @ (^ [Xp:$i] : (cw3a @ (cwceq @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccfv @ XA2 @ ccdgraa)) @ (cwceq @ (ccfv @ XA2 @ (ccv @ Xp)) @ ccc0) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccv @ Xp) @ cccoe)) @ cc1))) @ (^ [Xp:$i] : (ccfv @ ccq @ ccply)))))).
...
thf(cmpaalem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwa @ (cwcel @ (ccfv @ XA2 @ ccmpaa) @ (ccfv @ ccq @ ccply)) @ (cw3a @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccmpaa) @ ccdgr) @ (ccfv @ XA2 @ ccdgraa)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XA2 @ ccmpaa)) @ ccc0) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccfv @ XA2 @ ccmpaa) @ cccoe)) @ cc1)))))).
