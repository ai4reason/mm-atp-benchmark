...
thf(autopreg_thm,axiom,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XU @ ccutop)) => (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XJ @ ccha)) @ (cwcel @ XJ @ ccreg))))))).
thf(cuspreg_conj,conjecture,(! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XW @ cctopn)) => (cwi @ (cwa @ (cwcel @ XW @ ccusp) @ (cwcel @ XJ @ ccha)) @ (cwcel @ XJ @ ccreg)))))).
