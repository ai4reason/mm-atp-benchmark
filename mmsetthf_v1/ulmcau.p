...
thf(ar19_29uz_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => (cwi @ (cwa @ (cwral @ (^ [Xk:$i] : (Xph @ Xk)) @ (^ [Xk:$i] : XZ)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xps @ Xj @ Xk)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (Xph @ Xk) @ (Xps @ Xj @ Xk))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))))))))).
...
thf(culmcau_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3) @ ccz))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XS @ (XV @ Xx3 @ Xz @ Xj @ Xk))))))) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ (ccdm @ (ccfv @ XS @ cculm))) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)) @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xj) @ XF)) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xz:$i] : XS))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccrp))))))))))))))).
