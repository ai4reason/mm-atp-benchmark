...
thf(aintrnfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cw3a @ (cwf @ XA2 @ XB2 @ XF) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn))) @ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccfv @ XB2 @ ccfi)))))))).
...
thf(afi0_thm,axiom,(cwceq @ (ccfv @ cc0 @ ccfi) @ cc0)).
...
thf(a_0rest_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (cco @ cc0 @ XA2 @ ccrest) @ cc0))).
thf(aovprc2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ (ccdm @ XF)) => (cwi @ (cwn @ (cwcel @ XB2 @ ccvv)) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ cc0))))))).
thf(cfirest_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwceq @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ ccfi) @ (cco @ (ccfv @ XJ @ ccfi) @ XA2 @ ccrest))))).
