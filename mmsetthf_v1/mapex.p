...
thf(cmapex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XC @ Xf1)) @ (cwcel @ XB2 @ (XD @ Xf1))) @ (cwcel @ (ccab @ (^ [Xf1:$i] : (cwf @ XA2 @ XB2 @ (ccv @ Xf1)))) @ ccvv)))))))).
