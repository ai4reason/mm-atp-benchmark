...
thf(climcmptdm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xx3) @ (cco @ (XF @ Xx3) @ (XD @ Xx3) @ cclimc)))) => (cwi @ Xph @ (cwss @ XA2 @ ccc)))))))))))).
