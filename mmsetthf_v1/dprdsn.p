...
thf(cdprdsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XS @ (ccfv @ XG @ ccsubg))) @ (cwa @ (cwbr @ XG @ (ccsn @ (ccop @ XA2 @ XS)) @ (ccdm @ ccdprd)) @ (cwceq @ (cco @ XG @ (ccsn @ (ccop @ XA2 @ XS)) @ ccdprd) @ XS)))))))).
