...
thf(abrwdom2_thm,axiom,(! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XY @ (XV @ Xy1 @ Xz)) @ (cwb @ (cwbr @ XX @ XY @ ccwdom) @ (cwrex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwfo @ (ccv @ Xy1) @ XX @ (ccv @ Xz))))) @ (^ [Xy1:$i] : (ccpw @ XY))))))))))).
...
thf(cbrwdom3_conj,conjecture,(! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xx3 @ Xy1 @ Xf1)) @ (cwcel @ XY @ (XW @ Xx3 @ Xy1 @ Xf1))) @ (cwb @ (cwbr @ XX @ XY @ ccwdom) @ (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX)))))))))))))).
