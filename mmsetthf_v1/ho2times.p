...
thf(ahoadddir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwf @ cchil @ cchil @ XT)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XT @ cchot) @ (cco @ (cco @ XA2 @ XT @ cchot) @ (cco @ XB2 @ XT @ cchot) @ cchos))))))).
...
thf(cho2times_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ cchil @ XT) @ (cwceq @ (cco @ cc2 @ XT @ cchot) @ (cco @ XT @ XT @ cchos))))).
