...
thf(ahhxmet_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwcel @ XD @ (ccfv @ cchil @ ccxmt))))))).
...
thf(almcau_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ (ccdm @ (ccfv @ XJ @ cclm)) @ (ccfv @ XD @ ccca)))))))).
...
thf(ahhcau_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwceq @ cccau @ (ccin @ (ccfv @ XD @ ccca) @ (cco @ cchil @ ccn @ ccmap)))))))).
...
thf(chlimcaui_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwbr @ XF @ XA2 @ cchli) @ (cwcel @ XF @ cccau))))).
