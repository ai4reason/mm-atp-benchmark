...
thf(cmdslj1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (cwi @ (cwa @ (cwa @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwbr @ XB2 @ XA2 @ ccdmd)) @ (cwa @ (cwss @ XA2 @ (ccin @ XC @ XD)) @ (cwss @ (cco @ XC @ XD @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) @ (cwceq @ (ccin @ (cco @ XC @ XD @ cchj) @ XB2) @ (cco @ (ccin @ XC @ XB2) @ (ccin @ XD @ XB2) @ cchj)))))))))))).
