...
thf(cbcm1k_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ (cco @ XK @ cc1 @ ccmin) @ ccbc) @ (cco @ (cco @ XN @ (cco @ XK @ cc1 @ ccmin) @ ccmin) @ XK @ ccdiv) @ ccmul)))))).
