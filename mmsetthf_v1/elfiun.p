...
thf(apm2_61iine_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ (cwa @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XD)) @ Xph) => ((cwi @ (cwceq @ XA2 @ XC) @ Xph) => ((cwi @ (cwceq @ XB2 @ XD) @ Xph) => Xph))))))))).
...
thf(celfiun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XK)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ (ccun @ XB2 @ XC) @ ccfi)) @ (cw3o @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) @ (cwcel @ XA2 @ (ccfv @ XC @ ccfi)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XC @ ccfi)))) @ (^ [Xx3:$i] : (ccfv @ XB2 @ ccfi)))))))))))).
