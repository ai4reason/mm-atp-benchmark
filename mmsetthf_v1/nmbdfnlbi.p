...
thf(cnmbdfnlbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwa @ (cwcel @ XT @ cclf) @ (cwcel @ (ccfv @ XT @ ccnmf) @ ccr)) => (cwi @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle)))))).
