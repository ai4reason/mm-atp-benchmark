...
thf(cmap0g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmap) @ cc0) @ (cwa @ (cwceq @ XA2 @ cc0) @ (cwne @ XB2 @ cc0))))))))).
