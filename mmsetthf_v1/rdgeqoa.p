...
thf(afindes_thm,axiom,(! [Xph:($i > $o)] : ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ cc0) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccom) @ (cwi @ (Xph @ Xx3) @ (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccom) @ (Xph @ Xx3))))))).
...
thf(aonasuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccom)) @ (cwceq @ (cco @ XA2 @ (ccsuc @ XB2) @ ccoa) @ (ccsuc @ (cco @ XA2 @ XB2 @ ccoa))))))).
...
thf(acsbov123_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [Xx3:$i] : (cwceq @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ (XF @ Xx3)))) @ (cco @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XF @ Xx3))))))))))).
...
thf(crdgeqoa_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccon0) @ (cwcel @ XM @ ccon0) @ (cwcel @ XX @ ccom)) @ (cwi @ (cwceq @ (ccfv @ XN @ (ccrdg @ XF @ XA2)) @ (ccfv @ XM @ (ccrdg @ XF @ XB2))) @ (cwceq @ (ccfv @ (cco @ XN @ XX @ ccoa) @ (ccrdg @ XF @ XA2)) @ (ccfv @ (cco @ XM @ XX @ ccoa) @ (ccrdg @ XF @ XB2)))))))))))).
