...
thf(celsymgbas2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ XA2 @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwcel @ XF @ XV) @ (cwb @ (cwcel @ XF @ XB2) @ (cwf1o @ XA2 @ XA2 @ XF))))))))))).
