...
thf(anumexp0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => (cwceq @ (cco @ XA2 @ ccc0 @ ccexp) @ cc1)))).
...
thf(advds2subd_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((cwi @ Xph @ (cwbr @ XK @ XM @ ccdvds)) => ((cwi @ Xph @ (cwbr @ XK @ XN @ ccdvds)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => (cwi @ Xph @ (cwbr @ XK @ (cco @ XM @ XN @ ccmin) @ ccdvds)))))))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(advdsmultr1d_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwbr @ XK @ XM @ ccdvds)) => (cwi @ Xph @ (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds))))))))))).
...
thf(cex_ind_dvds_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwbr @ cc3 @ (cco @ (cco @ cc4 @ XN @ ccexp) @ cc2 @ ccaddc) @ ccdvds)))).
