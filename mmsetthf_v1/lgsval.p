...
thf(adf_lgs_ax,axiom,(cwceq @ cclgs @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xa:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xa:$i] : (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ (ccif @ (cwceq @ (cco @ (ccv @ Xa) @ cc2 @ ccexp) @ cc1) @ cc1 @ ccc0) @ (cco @ (ccif @ (cwa @ (cwbr @ (ccv @ Xn) @ ccc0 @ cclt) @ (cwbr @ (ccv @ Xa) @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccfv @ (ccfv @ (ccv @ Xn) @ ccabs) @ (ccseq @ ccmul @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccif @ (cwcel @ (ccv @ Xm) @ ccprime) @ (cco @ (ccif @ (cwceq @ (ccv @ Xm) @ cc2) @ (ccif @ (cwbr @ cc2 @ (ccv @ Xa) @ ccdvds) @ ccc0 @ (ccif @ (cwcel @ (cco @ (ccv @ Xa) @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ cc1 @ (ccneg @ cc1))) @ (cco @ (cco @ (cco @ (cco @ (ccv @ Xa) @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccmo) @ cc1 @ ccmin)) @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccpc) @ ccexp) @ cc1))) @ cc1)) @ ccmul))))))).
...
thf(clgsval_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccif @ (cwceq @ (ccv @ Xn) @ cc2) @ (ccif @ (cwbr @ cc2 @ XA2 @ ccdvds) @ ccc0 @ (ccif @ (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ cc1 @ (ccneg @ cc1))) @ (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccmo) @ cc1 @ ccmin)) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ XN @ cclgs) @ (ccif @ (cwceq @ XN @ ccc0) @ (ccif @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ cc1) @ cc1 @ ccc0) @ (cco @ (ccif @ (cwa @ (cwbr @ XN @ ccc0 @ cclt) @ (cwbr @ XA2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccfv @ (ccfv @ XN @ ccabs) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ ccmul)))))))))).
