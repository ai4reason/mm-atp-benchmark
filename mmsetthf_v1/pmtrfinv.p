...
thf(adif1en_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccom) @ (cwbr @ XA2 @ (ccsuc @ XM) @ ccen) @ (cwcel @ XX @ XA2)) @ (cwbr @ (ccdif @ XA2 @ (ccsn @ XX)) @ XM @ ccen)))))).
...
thf(aen2other2_thm,axiom,(! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XP) @ (cwbr @ XP @ cc2o @ ccen)) @ (cwceq @ (ccuni @ (ccdif @ XP @ (ccsn @ (ccuni @ (ccdif @ XP @ (ccsn @ XX)))))) @ XX))))).
...
thf(cpmtrfinv_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => ((cwceq @ XR @ (ccrn @ XT)) => (cwi @ (cwcel @ XF @ XR) @ (cwceq @ (cccom @ XF @ XF) @ (ccres @ ccid @ XD)))))))))).
