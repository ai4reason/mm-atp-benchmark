...
thf(cpreqsnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccvv)) => ((cwi @ Xph @ (cwcel @ XC @ ccvv)) => (cwi @ Xph @ (cwb @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccsn @ XC)) @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XC)))))))))))).
