...
thf(aisfbas_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1)) @ (cwb @ (cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) @ (cwa @ (cwss @ XF @ (ccpw @ XB2)) @ (cw3a @ (cwne @ XF @ cc0) @ (cwnel @ cc0 @ XF) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwne @ (ccin @ XF @ (ccpw @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ cc0)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF)))))))))))).
thf(ctsmsfbas_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwceq @ XS @ (ccin @ (ccpw @ (XA2 @ Xy1)) @ ccfn))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xy1 @ Xz) @ (ccmpt @ (^ [Xz:$i] : XS) @ (^ [Xz:$i] : (ccrab @ (^ [Xy1:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XS))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XL @ Xy1 @ Xz) @ (ccrn @ (XF @ Xy1 @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xy1 @ Xz) @ (cwcel @ (XA2 @ Xy1) @ (XW @ Xy1 @ Xz))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xy1 @ Xz) @ (cwcel @ (XL @ Xy1 @ Xz) @ (ccfv @ XS @ ccfbas)))))))))))))))).
