...
thf(agsmsymgrfixlem1_thm,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccfv @ XN @ ccsymg))) => ((! [Xi:$i] : (cwceq @ XB2 @ (ccfv @ (XS @ Xi) @ ccbs))) => (! [Xi:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XB2)) @ (cwcel @ XP @ XB2)) @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XK @ XN)) @ (cwi @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ XK @ (ccfv @ (ccv @ Xi) @ XW)) @ XK)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ XK @ (cco @ (XS @ Xi) @ XW @ ccgsu)) @ XK))) @ (cwi @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ XK @ (ccfv @ (ccv @ Xi) @ (cco @ XW @ (ccs1 @ XP) @ ccconcat))) @ XK)) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc) @ ccfzo))) @ (cwceq @ (ccfv @ XK @ (cco @ (XS @ Xi) @ (cco @ XW @ (ccs1 @ XP) @ ccconcat) @ ccgsu)) @ XK))))))))))))).
thf(cgsmsymgrfix_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccfv @ XN @ ccsymg))) => ((! [Xi:$i] : (cwceq @ XB2 @ (ccfv @ (XS @ Xi) @ ccbs))) => (! [Xi:$i] : (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XK @ XN) @ (cwcel @ XW @ (ccword @ XB2))) @ (cwi @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ XK @ (ccfv @ (ccv @ Xi) @ XW)) @ XK)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ XK @ (cco @ (XS @ Xi) @ XW @ ccgsu)) @ XK)))))))))))).
