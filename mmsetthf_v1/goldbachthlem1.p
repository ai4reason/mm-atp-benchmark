...
thf(afmtnodvds_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn)) @ (cwbr @ (ccfv @ XN @ ccfmtno) @ (cco @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ ccfmtno) @ cc2 @ ccmin) @ ccdvds))))).
...
thf(cgoldbachthlem1_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn0) @ (cwbr @ XM @ XN @ cclt)) @ (cwbr @ (ccfv @ XM @ ccfmtno) @ (cco @ (ccfv @ XN @ ccfmtno) @ cc2 @ ccmin) @ ccdvds))))).
