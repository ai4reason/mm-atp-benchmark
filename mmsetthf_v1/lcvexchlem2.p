...
thf(clcvexchlem2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XR @ XS)) => ((cwi @ Xph @ (cwss @ (ccin @ XT @ XU) @ XR)) => ((cwi @ Xph @ (cwss @ XR @ XU)) => (cwi @ Xph @ (cwceq @ (ccin @ (cco @ XR @ XT @ Xc_po) @ XU) @ XR)))))))))))))))))))).
