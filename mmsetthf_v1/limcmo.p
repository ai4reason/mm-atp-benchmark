...
thf(alimcflflem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp)))) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XC @ (ccdif @ XA2 @ (ccsn @ XB2))) => ((cwceq @ XL @ (cco @ (ccfv @ (ccsn @ XB2) @ (ccfv @ XK @ ccnei)) @ XC @ ccrest)) => (cwi @ Xph @ (cwcel @ XL @ (ccfv @ XC @ ccfil))))))))))))))))).
...
thf(alimcflf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp)))) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XC @ (ccdif @ XA2 @ (ccsn @ XB2))) => ((cwceq @ XL @ (cco @ (ccfv @ (ccsn @ XB2) @ (ccfv @ XK @ ccnei)) @ XC @ ccrest)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XB2 @ cclimc) @ (ccfv @ (ccres @ XF @ XC) @ (cco @ XK @ XL @ ccflf)))))))))))))))))).
thf(climcmo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp)))) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (cwi @ Xph @ (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XF @ XB2 @ cclimc))))))))))))))).
