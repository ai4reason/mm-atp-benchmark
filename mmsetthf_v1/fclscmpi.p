...
thf(afclsval_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XX @ Xt) @ (ccuni @ XJ))) => (! [Xt:$i] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XF @ (ccfv @ (XY @ Xt) @ ccfil))) @ (cwceq @ (cco @ XJ @ XF @ ccfcls) @ (ccif @ (cwceq @ (XX @ Xt) @ (XY @ Xt)) @ (cciin @ (^ [Xt:$i] : XF) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ XJ @ cccl)))) @ cc0)))))))))).
thf(aiftruei_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (Xph => (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XA2)))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(adfiin3_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (cwceq @ (cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccint @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(cfclscmpi_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cccmp) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))) @ (cwne @ (cco @ XJ @ XF @ ccfcls) @ cc0))))))).
