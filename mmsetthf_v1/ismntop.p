...
thf(aismntoplly_thm,axiom,(! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XJ @ XV)) @ (cwb @ (cwbr @ XN @ XJ @ ccmntop) @ (cw3a @ (cwcel @ XJ @ cc2ndc) @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ (cclly @ (ccec @ (ccfv @ (ccfv @ XN @ ccehl) @ cctopn) @ cchmph)))))))))).
...
thf(ahmphsymb_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwb @ (cwbr @ XJ @ XK @ cchmph) @ (cwbr @ XK @ XJ @ cchmph))))).
...
thf(cismntop_conj,conjecture,(! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XJ @ (XV @ Xx3 @ Xy1 @ Xu))) @ (cwb @ (cwbr @ XN @ XJ @ ccmntop) @ (cw3a @ (cwcel @ XJ @ cc2ndc) @ (cwcel @ XJ @ ccha) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)) @ (cwbr @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ (ccfv @ (ccfv @ XN @ ccehl) @ cctopn) @ cchmph))) @ (^ [Xu:$i] : (ccin @ XJ @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ)))))))))))).
