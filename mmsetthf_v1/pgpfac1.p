...
thf(apgpfac1lem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((cwceq @ XK @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cwceq @ XS @ (ccfv @ (ccsn @ XA2) @ XK)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xt:$i] : (! [Xs1:$i] : (cwceq @ (XO @ Xt @ Xs1) @ (ccfv @ XG @ ccod)))) => ((! [Xt:$i] : (! [Xs1:$i] : (cwceq @ (XE @ Xt @ Xs1) @ (ccfv @ XG @ ccgex)))) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwbr @ XP @ XG @ ccpgp)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xt:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (XO @ Xt @ Xs1)) @ (XE @ Xt @ Xs1))))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xs1) @ XU) @ (cwcel @ XA2 @ (ccv @ Xs1))) @ (cwrex @ (^ [Xt:$i] : (cwa @ (cwceq @ (ccin @ XS @ (ccv @ Xt)) @ (ccsn @ Xc_0)) @ (cwceq @ (cco @ XS @ (ccv @ Xt) @ Xc_po) @ (ccv @ Xs1)))) @ (^ [Xt:$i] : (ccfv @ XG @ ccsubg))))) @ (^ [Xs1:$i] : (ccfv @ XG @ ccsubg)))) => (cwi @ Xph @ (cwrex @ (^ [Xt:$i] : (cwa @ (cwceq @ (ccin @ XS @ (ccv @ Xt)) @ (ccsn @ Xc_0)) @ (cwceq @ (cco @ XS @ (ccv @ Xt) @ Xc_po) @ XU))) @ (^ [Xt:$i] : (ccfv @ XG @ ccsubg))))))))))))))))))))))))))))))).
...
thf(cpgpfac1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((cwceq @ XK @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cwceq @ XS @ (ccfv @ (ccsn @ XA2) @ XK)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xt:$i] : (cwceq @ (XO @ Xt) @ (ccfv @ XG @ ccod))) => ((! [Xt:$i] : (cwceq @ (XE @ Xt) @ (ccfv @ XG @ ccgex))) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwbr @ XP @ XG @ ccpgp)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xt:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (XO @ Xt)) @ (XE @ Xt)))) => ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => (cwi @ Xph @ (cwrex @ (^ [Xt:$i] : (cwa @ (cwceq @ (ccin @ XS @ (ccv @ Xt)) @ (ccsn @ Xc_0)) @ (cwceq @ (cco @ XS @ (ccv @ Xt) @ Xc_po) @ XB2))) @ (^ [Xt:$i] : (ccfv @ XG @ ccsubg)))))))))))))))))))))))))))).
