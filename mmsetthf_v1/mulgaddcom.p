...
thf(amulgaddcomlem_thm,axiom,(! [Xy1:$i] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ (ccv @ Xy1) @ ccz) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ XX @ Xc_x) @ XX @ Xc_pl) @ (cco @ XX @ (cco @ (ccv @ Xy1) @ XX @ Xc_x) @ Xc_pl))) @ (cwceq @ (cco @ (cco @ (ccneg @ (ccv @ Xy1)) @ XX @ Xc_x) @ XX @ Xc_pl) @ (cco @ XX @ (cco @ (ccneg @ (ccv @ Xy1)) @ XX @ Xc_x) @ Xc_pl))))))))))))).
thf(cmulgaddcom_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ (cco @ XN @ XX @ Xc_x) @ XX @ Xc_pl) @ (cco @ XX @ (cco @ XN @ XX @ Xc_x) @ Xc_pl))))))))))))).
