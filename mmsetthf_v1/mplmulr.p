...
thf(cmplmulr_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XI @ XR @ ccmpl)) => ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccmulr)) => (cwceq @ Xc_x @ (ccfv @ XS @ ccmulr))))))))))).
