...
thf(arescom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccres @ (ccres @ XA2 @ XB2) @ XC) @ (ccres @ (ccres @ XA2 @ XC) @ XB2)))))).
...
thf(auzinico_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ Xph @ (cwceq @ XZ @ (ccin @ ccz @ (cco @ XM @ ccpnf @ ccico)))))))))).
...
thf(alimsupresico_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((cwceq @ XZ @ (cco @ XM @ ccpnf @ ccico)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ XZ) @ cclsp) @ (ccfv @ XF @ cclsp)))))))))))).
...
thf(alimsupresre_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ ccr) @ cclsp) @ (ccfv @ XF @ cclsp)))))))).
thf(climsupresuz_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwss @ (ccdm @ (ccres @ XF @ ccr)) @ ccz)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ XZ) @ cclsp) @ (ccfv @ XF @ cclsp))))))))))))).
