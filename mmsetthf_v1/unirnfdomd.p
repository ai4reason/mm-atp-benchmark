...
thf(aunidom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ ccdom)) @ (^ [Xx3:$i] : XA2))) @ (cwbr @ (ccuni @ XA2) @ (ccxp @ XA2 @ XB2) @ ccdom))))))).
...
thf(ainfinf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwb @ (cwn @ (cwcel @ XA2 @ ccfn)) @ (cwbr @ ccom @ XA2 @ ccdom)))))).
...
thf(cunirnfdomd_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwf @ XT @ ccfn @ XF)) => ((cwi @ Xph @ (cwn @ (cwcel @ XT @ ccfn))) => ((cwi @ Xph @ (cwcel @ XT @ XV)) => (cwi @ Xph @ (cwbr @ (ccuni @ (ccrn @ XF)) @ XT @ ccdom)))))))))).
