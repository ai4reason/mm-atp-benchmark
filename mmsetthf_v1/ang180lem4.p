...
thf(aang180lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ cclog) @ (ccfv @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XA2 @ ccdiv) @ cclog) @ ccaddc) @ (ccfv @ XA2 @ cclog) @ ccaddc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (cco @ (cco @ (cco @ (XT @ Xx3 @ Xy1) @ cci @ ccdiv) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) @ (cwcel @ (XT @ Xx3 @ Xy1) @ (ccpr @ (ccneg @ (cco @ cci @ ccpi @ ccmul)) @ (cco @ cci @ ccpi @ ccmul)))))))))))))).
...
thf(aimnegi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwceq @ (ccfv @ (ccneg @ XA2) @ ccim) @ (ccneg @ (ccfv @ XA2 @ ccim)))))).
...
thf(acrimi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ ccim) @ XB2)))))).
...
thf(cang180lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) @ (cwcel @ (cco @ (cco @ (cco @ (cco @ cc1 @ XA2 @ ccmin) @ cc1 @ (XF @ Xx3 @ Xy1)) @ (cco @ XA2 @ (cco @ XA2 @ cc1 @ ccmin) @ (XF @ Xx3 @ Xy1)) @ ccaddc) @ (cco @ cc1 @ XA2 @ (XF @ Xx3 @ Xy1)) @ ccaddc) @ (ccpr @ (ccneg @ ccpi) @ ccpi))))))))).
