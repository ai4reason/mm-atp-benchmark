...
thf(cismred2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XC @ (ccpw @ XX))) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwss @ (ccv @ Xs1) @ XC)) @ (cwcel @ (ccin @ XX @ (ccint @ (ccv @ Xs1))) @ XC))) => (cwi @ Xph @ (cwcel @ XC @ (ccfv @ XX @ ccmre))))))))).
