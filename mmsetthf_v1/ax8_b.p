...
thf(aax8v2_b_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
thf(aax8v1_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)))))))).
thf(cax8_b_conj,conjecture,(! [Xy1:$i] : (! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
