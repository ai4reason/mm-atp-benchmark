...
thf(cpclbtwnN_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XX @ XS)) @ (cwa @ (cwss @ XY @ XX) @ (cwss @ XX @ (ccfv @ XY @ XU)))) @ (cwceq @ XX @ (ccfv @ XY @ XU)))))))))))).
