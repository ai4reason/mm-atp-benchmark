...
thf(celtsk2g_conj,conjecture,(! [XT:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : (cwi @ (cwcel @ XT @ (XV @ Xz)) @ (cwb @ (cwcel @ XT @ cctsk) @ (cwa @ (cwral @ (^ [Xz:$i] : (cwa @ (cwss @ (ccpw @ (ccv @ Xz)) @ XT) @ (cwcel @ (ccpw @ (ccv @ Xz)) @ XT))) @ (^ [Xz:$i] : XT)) @ (cwral @ (^ [Xz:$i] : (cwo @ (cwbr @ (ccv @ Xz) @ XT @ ccen) @ (cwcel @ (ccv @ Xz) @ XT))) @ (^ [Xz:$i] : (ccpw @ XT)))))))))).
