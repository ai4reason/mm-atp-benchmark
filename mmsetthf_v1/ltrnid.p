...
thf(alauteq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XF @ XI) @ (cwcel @ XX @ XB2)) @ (cwral @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccv @ Xp) @ XF) @ (ccv @ Xp))) @ (^ [Xp:$i] : XA2))) @ (cwceq @ (ccfv @ XX @ XF) @ XX)))))))))))).
...
thf(cltrnid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xp:$i] : (cwceq @ (Xc_le @ Xp) @ (ccfv @ XK @ ccple))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT)) @ (cwb @ (cwral @ (^ [Xp:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xp) @ XW @ (Xc_le @ Xp))) @ (cwceq @ (ccfv @ (ccv @ Xp) @ XF) @ (ccv @ Xp)))) @ (^ [Xp:$i] : XA2)) @ (cwceq @ XF @ (ccres @ ccid @ XB2)))))))))))))))))).
