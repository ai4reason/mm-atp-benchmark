...
thf(amatmulcell_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xj:$i] : (cwceq @ (XA2 @ Xj) @ (cco @ XN @ XR @ ccmat))) => ((! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xj) @ ccbs))) => ((! [Xj:$i] : (cwceq @ (Xc_x @ Xj) @ (ccfv @ XR @ ccmulr))) => ((! [Xj:$i] : (cwceq @ (Xc_xp @ Xj) @ (ccfv @ (XA2 @ Xj) @ ccmulr))) => (! [Xj:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwa @ (cwcel @ XI @ XN) @ (cwcel @ XJ @ XN))) @ (cwceq @ (cco @ XI @ XJ @ (cco @ XX @ XY @ (Xc_xp @ Xj))) @ (cco @ XR @ (ccmpt @ (^ [Xj:$i] : XN) @ (^ [Xj:$i] : (cco @ (cco @ XI @ (ccv @ Xj) @ XX) @ (cco @ (ccv @ Xj) @ XJ @ XY) @ (ccfv @ XR @ ccmulr)))) @ ccgsu))))))))))))))))))).
...
thf(cscmatscm_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((! [Xc:$i] : (cwceq @ (XA2 @ Xc) @ (cco @ XN @ XR @ ccmat))) => ((! [Xm:$i] : (! [Xc:$i] : (cwceq @ (XB2 @ Xm @ Xc) @ (ccfv @ (XA2 @ Xc) @ ccbs)))) => ((! [Xc:$i] : (cwceq @ (Xc_as @ Xc) @ (ccfv @ (XA2 @ Xc) @ ccvsca))) => ((! [Xm:$i] : (! [Xc:$i] : (cwceq @ (Xc_xp @ Xm @ Xc) @ (ccfv @ (XA2 @ Xc) @ ccmulr)))) => ((cwceq @ XS @ (cco @ XN @ XR @ ccscmat)) => (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwcel @ XC @ XS)) @ (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xm:$i] : (cwceq @ (cco @ XC @ (ccv @ Xm) @ (Xc_xp @ Xm @ Xc)) @ (cco @ (ccv @ Xc) @ (ccv @ Xm) @ (Xc_as @ Xc)))) @ (^ [Xm:$i] : (XB2 @ Xm @ Xc)))) @ (^ [Xc:$i] : XK))))))))))))))))))).
