...
thf(apoleloe_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ (ccun @ XR @ ccid)) @ (cwo @ (cwbr @ XA2 @ XB2 @ XR) @ (cwceq @ XA2 @ XB2))))))))).
thf(csomin1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwor @ XX @ XR) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) @ (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ XR) @ XA2 @ XB2) @ XA2 @ (ccun @ XR @ ccid)))))))).
