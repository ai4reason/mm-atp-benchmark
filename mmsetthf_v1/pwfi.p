...
thf(apwfilem_b_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xc:$i] : (cwceq @ (XF @ Xx3 @ Xc) @ (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3)))))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccpw @ (ccv @ Xx3)) @ ccfn) @ (cwcel @ (ccpw @ (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xx3)))) @ ccfn)))))).
...
thf(cpwfi_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfn) @ (cwcel @ (ccpw @ XA2) @ ccfn)))).
