...
thf(acnmgpabl_thm,axiom,(! [XM:($i > $o)] : ((cwceq @ XM @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => (cwcel @ XM @ ccabl)))).
