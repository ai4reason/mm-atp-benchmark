...
thf(apjhmop_thm,axiom,(! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ ccch) @ (cwcel @ (ccfv @ XH @ ccpjh) @ ccho)))).
thf(apjidmco_thm,axiom,(! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ ccch) @ (cwceq @ (cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XH @ ccpjh))))).
...
thf(cdfpjop_conj,conjecture,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ (ccrn @ ccpjh)) @ (cwa @ (cwcel @ XT @ ccho) @ (cwceq @ (cccom @ XT @ XT) @ XT))))).
