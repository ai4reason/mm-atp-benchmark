...
thf(clmireu_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((! [Xb:$i] : (cwceq @ (Xc_mi @ Xb) @ (ccfv @ XG @ ccds))) => ((! [Xb:$i] : (cwceq @ (XI @ Xb) @ (ccfv @ XG @ ccitv))) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => ((cwceq @ XM @ (ccfv @ XD @ (ccfv @ XG @ cclmi))) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XD @ (ccrn @ XL))) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => (cwi @ Xph @ (cwreu @ (^ [Xb:$i] : (cwceq @ (ccfv @ (ccv @ Xb) @ XM) @ XA2)) @ (^ [Xb:$i] : XP)))))))))))))))))))))).
