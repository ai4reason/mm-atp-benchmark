...
thf(clsmhash_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwceq @ (ccin @ XT @ XU) @ (ccsn @ Xc_0))) => ((cwi @ Xph @ (cwss @ XT @ (ccfv @ XU @ XZ))) => ((cwi @ Xph @ (cwcel @ XT @ ccfn)) => ((cwi @ Xph @ (cwcel @ XU @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XT @ XU @ Xc_po) @ cchash) @ (cco @ (ccfv @ XT @ cchash) @ (ccfv @ XU @ cchash) @ ccmul)))))))))))))))))))).
