...
thf(aupwlkbprop_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccupwlks)) @ (cw3a @ (cwcel @ XG @ ccvv) @ (cwcel @ XF @ ccvv) @ (cwcel @ XP @ ccvv))))))))))).
...
thf(aifpprsnss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwceq @ XP @ (ccpr @ XA2 @ XB2)) @ (cwif @ (cwceq @ XA2 @ XB2) @ (cwceq @ XP @ (ccsn @ XA2)) @ (cwss @ (ccpr @ XA2 @ XB2) @ XP))))))).
...
thf(cupwlkwlk_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccupwlks)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))).
