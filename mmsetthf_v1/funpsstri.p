...
thf(cfunpsstri_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cw3a @ (cwfun @ XH) @ (cwa @ (cwss @ XF @ XH) @ (cwss @ XG @ XH)) @ (cwo @ (cwss @ (ccdm @ XF) @ (ccdm @ XG)) @ (cwss @ (ccdm @ XG) @ (ccdm @ XF)))) @ (cw3o @ (cwpss @ XF @ XG) @ (cwceq @ XF @ XG) @ (cwpss @ XG @ XF))))))).
