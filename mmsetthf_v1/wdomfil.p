...
thf(afodomfi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ ccfn) @ (cwfo @ XA2 @ XB2 @ XF)) @ (cwbr @ XB2 @ XA2 @ ccdom))))))).
thf(ccsdm_tp,type,(ccsdm : ($i > $o))).
thf(adomwdom_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwbr @ XX @ XY @ ccdom) @ (cwbr @ XX @ XY @ ccwdom))))).
thf(cwdomfil_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwcel @ XX @ ccfn) @ (cwb @ (cwbr @ XX @ XY @ ccwdom) @ (cwbr @ XX @ XY @ ccdom)))))).
