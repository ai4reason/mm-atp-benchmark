...
thf(amulog2sumlem3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xy1 @ Xi @ Xn) @ (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccv @ Xi) @ ccdiv))) @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwbr @ (XF @ Xy1 @ Xi @ Xn) @ (XL @ Xy1 @ Xi) @ ccrli))))) => (! [Xy1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xy1 @ Xi) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccmu) @ (ccv @ Xn) @ ccdiv) @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ cclog) @ cc2 @ ccexp) @ ccmul))) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmin))) @ cco1)))))))))).
