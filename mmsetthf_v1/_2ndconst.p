...
thf(afo2ndres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwne @ XA2 @ cc0) @ (cwfo @ (ccxp @ XA2 @ XB2) @ XB2 @ (ccres @ cc2nd @ (ccxp @ XA2 @ XB2))))))).
...
thf(c_2ndconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwf1o @ (ccxp @ (ccsn @ XA2) @ XB2) @ XB2 @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XA2) @ XB2)))))))).
