...
thf(cgraop_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccop @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ cciedg))) => (cwa @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccfv @ XH @ ccvtx)) @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccfv @ XH @ cciedg))))))).
