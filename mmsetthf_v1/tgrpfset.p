...
thf(adf_tgrp_ax,axiom,(cwceq @ cctgrp @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccltrn))) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccltrn)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccltrn)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1))))))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(ctgrpfset_conj,conjecture,(! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XH @ Xf1 @ Xg1) @ (ccfv @ XK @ cclh)))) => (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (cwcel @ XK @ (XV @ Xw @ Xf1 @ Xg1)) @ (cwceq @ (ccfv @ XK @ cctgrp) @ (ccmpt @ (^ [Xw:$i] : (XH @ Xf1 @ Xg1)) @ (^ [Xw:$i] : (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccltrn))) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccltrn)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccltrn)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1))))))))))))))))))).
