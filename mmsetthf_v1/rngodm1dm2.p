...
thf(agrpofo_thm,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwcel @ XG @ ccgr) @ (cwfo @ (ccxp @ XX @ XX) @ XX @ XG)))))).
...
thf(crngodm1dm2_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwceq @ (ccdm @ (ccdm @ XG)) @ (ccdm @ (ccdm @ XH)))))))))).
