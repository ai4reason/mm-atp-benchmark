...
thf(cuvcvv0_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XU @ (cco @ XR @ XI @ ccuvc)) => ((cwi @ Xph @ (cwcel @ XR @ XV)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XJ @ XI)) => ((cwi @ Xph @ (cwcel @ XK @ XI)) => ((cwi @ Xph @ (cwne @ XJ @ XK)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ Xph @ (cwceq @ (ccfv @ XK @ (ccfv @ XJ @ XU)) @ Xc_0))))))))))))))))))).
