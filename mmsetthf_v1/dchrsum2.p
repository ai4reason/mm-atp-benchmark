...
thf(aznunithash_thm,axiom,(! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XN @ cczn)) => ((cwceq @ XU @ (ccfv @ XY @ ccui)) => (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XU @ cchash) @ (ccfv @ XN @ ccphi))))))))).
...
thf(cdchrsum2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : (cwceq @ (XG @ Xa) @ (ccfv @ (XN @ Xa) @ ccdchr))) => ((! [Xa:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : (cwceq @ (XD @ Xa) @ (ccfv @ (XG @ Xa) @ ccbs))) => ((! [Xa:$i] : (cwceq @ Xc_1 @ (ccfv @ (XG @ Xa) @ cc0g))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xa)))) => ((cwceq @ XU @ (ccfv @ XZ @ ccui)) => (! [Xa:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XU @ (^ [Xa:$i] : (ccfv @ (ccv @ Xa) @ XX))) @ (ccif @ (cwceq @ XX @ Xc_1) @ (ccfv @ (XN @ Xa) @ ccphi) @ ccc0))))))))))))))))))).
