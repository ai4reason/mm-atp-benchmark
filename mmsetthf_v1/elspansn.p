...
thf(celspansn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwb @ (cwcel @ XB2 @ (ccfv @ (ccsn @ XA2) @ ccspn)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XB2 @ (cco @ (ccv @ Xx3) @ XA2 @ ccsm))) @ (^ [Xx3:$i] : ccc))))))).
