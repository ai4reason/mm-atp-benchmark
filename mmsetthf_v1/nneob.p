...
thf(annneo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwceq @ XC @ (cco @ cc2o @ XA2 @ ccomu))) @ (cwn @ (cwceq @ (ccsuc @ XC) @ (cco @ cc2o @ XB2 @ ccomu)))))))).
...
thf(acon1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwi @ (cwn @ Xph) @ Xps) @ (cwi @ (cwn @ Xps) @ Xph))))).
thf(cnneob_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccom) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (cco @ cc2o @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : ccom)) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccsuc @ XA2) @ (cco @ cc2o @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : ccom))))))).
