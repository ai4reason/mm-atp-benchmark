...
thf(apellfundgt1_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwbr @ cc1 @ (ccfv @ XD @ ccpellfund) @ cclt)))).
thf(cpellfundrp_conj,conjecture,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ (ccfv @ XD @ ccpellfund) @ ccrp)))).
