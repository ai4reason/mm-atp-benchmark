...
thf(cfveqf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (ccun @ (ccres @ ccid @ (ccdif @ XA2 @ (ccpr @ XC @ (ccfv @ XD @ (cccnv @ XF))))) @ (ccpr @ (ccop @ XC @ (ccfv @ XD @ (cccnv @ XF))) @ (ccop @ (ccfv @ XD @ (cccnv @ XF)) @ XC))))) => (cwi @ (cw3a @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) @ (cwa @ (cwf1o @ XA2 @ XB2 @ XG) @ (cwceq @ (ccfv @ XC @ XG) @ XD))))))))))).
