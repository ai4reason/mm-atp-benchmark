...
thf(ckeephyp2v_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ (cwceq @ XA2 @ (ccif @ Xph @ XA2 @ XC)) @ (cwb @ Xps @ Xch)) => ((cwi @ (cwceq @ XB2 @ (ccif @ Xph @ XB2 @ XD)) @ (cwb @ Xch @ Xth)) => ((cwi @ (cwceq @ XC @ (ccif @ Xph @ XA2 @ XC)) @ (cwb @ Xta @ Xet)) => ((cwi @ (cwceq @ XD @ (ccif @ Xph @ XB2 @ XD)) @ (cwb @ Xet @ Xth)) => (Xps => (Xta => Xth))))))))))))))))).
