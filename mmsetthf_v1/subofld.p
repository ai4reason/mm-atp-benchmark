...
thf(asuborng_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccorng) @ (cwcel @ (cco @ XR @ XA2 @ ccress) @ ccrg)) @ (cwcel @ (cco @ XR @ XA2 @ ccress) @ ccorng))))).
thf(csubofld_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ ccofld) @ (cwcel @ (cco @ XF @ XA2 @ ccress) @ ccfield)) @ (cwcel @ (cco @ XF @ XA2 @ ccress) @ ccofld))))).
