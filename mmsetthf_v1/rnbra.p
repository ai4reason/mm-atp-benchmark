...
thf(abralnfn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwcel @ (ccfv @ XA2 @ ccbr) @ cclf)))).
thf(abrabn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ ccbr) @ ccnmf) @ ccr)))).
...
thf(ariesz1_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ cclf) @ (cwb @ (cwcel @ (ccfv @ XT @ ccnmf) @ ccr) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XT) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xy1:$i] : cchil)))))).
...
thf(crnbra_conj,conjecture,(cwceq @ (ccrn @ ccbr) @ (ccin @ cclf @ cccnfn))).
