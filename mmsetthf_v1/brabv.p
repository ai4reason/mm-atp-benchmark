...
thf(a_0neqopab_thm,axiom,(! [Xph:($i > ($i > $o))] : (cwn @ (cwcel @ cc0 @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))).
thf(aeleq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC))))))).
thf(cbrabv_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwbr @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwa @ (cwcel @ (XX @ Xx3 @ Xy1) @ ccvv) @ (cwcel @ (XY @ Xx3 @ Xy1) @ ccvv))))))))).
