...
thf(aitg1climres_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwf @ ccn @ (ccdm @ ccvol) @ XA2)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (ccfv @ (ccv @ Xn) @ XA2) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XA2)))) => ((cwi @ Xph @ (cwceq @ (ccuni @ (ccrn @ XA2)) @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XA2)) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0)))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XG @ Xx3 @ Xn) @ ccitg1))) @ (ccfv @ XF @ ccitg1) @ ccli))))))))))))).
...
thf(aiunrab_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwceq @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1))))) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))))))).
...
thf(ai1fres_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XA2 @ (ccdm @ ccvol))) @ (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1))))))))).
...
thf(citg2monolem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccmbf))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ (ccfv @ (ccv @ Xn) @ XF)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwbr @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (ccofr @ ccle)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xy1:$i] : ccr)))) => ((cwceq @ XS @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ ccitg2)))) @ ccxr @ cclt)) => ((cwi @ Xph @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XH @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwbr @ XH @ XG @ (ccofr @ ccle))) => ((cwi @ Xph @ (cwcel @ XS @ ccr)) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ XT @ (ccfv @ (ccv @ Xx3) @ XH) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccle)) @ (^ [Xx3:$i] : ccr))))))) => (cwi @ Xph @ (cwbr @ (cco @ XT @ (ccfv @ XH @ ccitg1) @ ccmul) @ XS @ ccle))))))))))))))))))))).
