...
thf(adf_wl_clelv2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (cwb @ (cwcel2_wl @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwal @ (^ [Xu:$i] : (cwi @ (cwceq @ (ccv @ Xu) @ (ccv @ Xx3)) @ (cwcel_wl @ (^ [Xu:$i] : (XA2 @ Xx3)))))))))).
...
thf(cwl_ax8clv2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (cwcel2_wl @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) @ (cwcel2_wl @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))))))))).
