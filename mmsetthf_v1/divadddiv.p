...
thf(cdivadddiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwa @ (cwcel @ XC @ ccc) @ (cwne @ XC @ ccc0)) @ (cwa @ (cwcel @ XD @ ccc) @ (cwne @ XD @ ccc0)))) @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XD @ ccdiv) @ ccaddc) @ (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccaddc) @ (cco @ XC @ XD @ ccmul) @ ccdiv)))))))).
