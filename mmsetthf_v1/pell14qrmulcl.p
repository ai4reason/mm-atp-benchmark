...
thf(apell1234qrmulcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr)) @ (cwcel @ XB2 @ (ccfv @ XD @ ccpell1234qr))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ (ccfv @ XD @ ccpell1234qr))))))).
...
thf(aelpell14qr2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr)) @ (cwbr @ ccc0 @ XA2 @ cclt))))))).
thf(cpell14qrmulcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwcel @ XB2 @ (ccfv @ XD @ ccpell14qr))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ (ccfv @ XD @ ccpell14qr))))))).
