...
thf(agausslemma2dlem1_thm,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XP @ Xk) @ (ccdif @ ccprime @ (ccsn @ cc2))))) => ((! [Xk:$i] : (cwceq @ XH @ (cco @ (cco @ (XP @ Xk) @ cc1 @ ccmin) @ cc2 @ ccdiv))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XR @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin))))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XH @ ccfa) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XR @ Xx3))))))))))))))).
...
thf(aprm23ge5_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cw3o @ (cwceq @ XP @ cc2) @ (cwceq @ XP @ cc3) @ (cwcel @ XP @ (ccfv @ cc5 @ ccuz)))))).
...
thf(adivfl0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ ccc0)))))).
...
thf(afldiv4lem1div2uz2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwbr @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
