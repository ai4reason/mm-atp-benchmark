...
thf(c_0oval_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XZ @ (ccfv @ XW @ ccn0v)) => ((cwceq @ XO @ (cco @ XU @ XW @ cc0o)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ XA2 @ XO) @ XZ)))))))))))).
