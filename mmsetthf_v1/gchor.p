...
thf(cgchor_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom))) @ (cwo @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccen)))))).
