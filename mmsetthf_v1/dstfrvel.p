...
thf(aorrvcval4_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XP @ Xy1) @ ccprb))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XX @ (ccfv @ (XP @ Xy1) @ ccrrv)))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XA2 @ (XV @ Xy1)))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ (cco @ XX @ XA2 @ (ccorvc @ XR)) @ (ccima @ (cccnv @ XX) @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XA2 @ XR)) @ (^ [Xy1:$i] : ccr)))))))))))))))).
thf(cdstfrvel_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprb)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccuni @ (ccdm @ XP)))) => ((cwi @ Xph @ (cwbr @ (ccfv @ XB2 @ XX) @ XA2 @ ccle)) => (cwi @ Xph @ (cwcel @ XB2 @ (cco @ XX @ XA2 @ (ccorvc @ ccle))))))))))))))).
