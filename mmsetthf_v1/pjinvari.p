...
thf(cpjinvari_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((cwf @ cchil @ cchil @ XS) => ((cwcel @ XH @ ccch) => ((cwceq @ XT @ (ccfv @ XH @ ccpjh)) => (cwb @ (cwf @ cchil @ XH @ (cccom @ XS @ XT)) @ (cwceq @ (cccom @ XS @ XT) @ (cccom @ XT @ (cccom @ XS @ XT))))))))))).
