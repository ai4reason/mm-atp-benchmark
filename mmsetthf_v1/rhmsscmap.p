...
thf(crhmsscmap_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XU @ (XV @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwceq @ XR @ (ccin @ ccrg @ XU))) => (cwi @ Xph @ (cwbr @ (ccres @ ccrh @ (ccxp @ XR @ XR)) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XU)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XU)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ ccbs) @ (ccfv @ (ccv @ Xx3) @ ccbs) @ ccmap)))) @ ccssc))))))))).
