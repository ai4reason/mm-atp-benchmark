...
thf(cpfxtrcfv_conj,conjecture,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XW @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx)) @ (ccfv @ XI @ XW))))))).
