...
thf(angprcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => (cwi @ (cwa @ (cwcel @ XG @ ccngp) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ (cco @ XA2 @ XC @ Xc_pl) @ (cco @ XB2 @ XC @ Xc_pl) @ XD) @ (cco @ XA2 @ XB2 @ XD)))))))))))))).
...
thf(aisngp3_thm,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwb @ (cwcel @ XG @ ccngp) @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XG @ ccmt) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))))).
thf(cisngp4_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1) @ (ccfv @ XG @ ccplusg)))) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => (cwb @ (cwcel @ XG @ ccngp) @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XG @ ccmt) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_pl @ Xx3 @ Xy1)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_pl @ Xx3 @ Xy1)) @ XD) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))).
