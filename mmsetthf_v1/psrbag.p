...
thf(cpsrbag_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => (! [Xf1:$i] : (cwi @ (cwcel @ XI @ (XV @ Xf1)) @ (cwb @ (cwcel @ XF @ (XD @ Xf1)) @ (cwa @ (cwf @ XI @ ccn0 @ XF) @ (cwcel @ (ccima @ (cccnv @ XF) @ ccn) @ ccfn))))))))))).
