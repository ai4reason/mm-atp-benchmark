...
thf(apwwf_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ (ccpw @ XA2) @ (ccuni @ (ccima @ ccr1 @ ccon0)))))).
...
thf(cuniwf_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ (ccuni @ XA2) @ (ccuni @ (ccima @ ccr1 @ ccon0)))))).
