...
thf(aisgrpd2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XG @ ccbs))) => ((cwi @ Xph @ (cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XG @ cc0g)))) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwcel @ (XN @ Xx3) @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (cco @ (XN @ Xx3) @ (ccv @ Xx3) @ Xc_pl) @ (Xc_0 @ Xx3)))) => (cwi @ Xph @ (cwcel @ XG @ ccgrp))))))))))))))).
...
thf(cprdsgrpd_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccgrp @ XR)) => (cwi @ Xph @ (cwcel @ XY @ ccgrp)))))))))))))).
