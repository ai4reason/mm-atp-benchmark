...
thf(ai1fd_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ (ccrn @ XF) @ ccfn)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)))) @ (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)))) @ (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccr))) => (cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1)))))))))).
...
thf(adivne0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0))) @ (cwne @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0))))).
...
thf(aceicl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccneg @ (ccfv @ (ccneg @ XA2) @ ccfl)) @ ccz)))).
...
thf(arabiun_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (cwceq @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XA2 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))))) @ (cciun @ (^ [Xy1:$i] : (XA2 @ Xy1)) @ (^ [Xy1:$i] : (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))))))))).
thf(aeqtr3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XA2 @ XC) => (cwceq @ XB2 @ XC))))))).
thf(acnvimarndm_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccima @ (cccnv @ XA2) @ (ccrn @ XA2)) @ (ccdm @ XA2)))).
...
thf(ainrab2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (cwceq @ (ccin @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ XB2) @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccin @ (XA2 @ Xx3) @ XB2)))))))).
...
thf(aflflp1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccfl) @ XB2 @ ccle) @ (cwbr @ XA2 @ (cco @ (ccfv @ XB2 @ ccfl) @ cc1 @ ccaddc) @ cclt)))))).
...
thf(aelioomnf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwcel @ XB2 @ (cco @ ccmnf @ XA2 @ ccioo)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ XB2 @ XA2 @ cclt))))))).
...
thf(ai1fmbf_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XF @ ccmbf)))).
thf(a_3expa_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth))))))).
thf(ccicc_tp,type,(ccicc : ($i > $o))).
thf(ambfimasn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ ccmbf) @ (cwf @ XA2 @ ccr @ XF) @ (cwcel @ XB2 @ ccr)) @ (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ XB2)) @ (ccdm @ ccvol))))))).
...
thf(ai1fima_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ (ccdm @ ccvol)))))).
...
thf(asubadd2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmin) @ XC) @ (cwceq @ (cco @ XC @ XB2 @ ccaddc) @ XA2))))))))))).
...
thf(altmul2dd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ cclt))))))))))).
...
thf(a_3biant1d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xth) => (cwi @ Xph @ (cwb @ (cwa @ Xch @ Xps) @ (cw3a @ Xth @ Xch @ Xps))))))))).
...
thf(altadd1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ cclt))))))))))).
...
thf(altdivmul2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ cclt))))))))))).
...
thf(adifpreima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwceq @ (ccima @ (cccnv @ XF) @ (ccdif @ XA2 @ XB2)) @ (ccdif @ (ccima @ (cccnv @ XF) @ XA2) @ (ccima @ (cccnv @ XF) @ XB2)))))))).
...
thf(ai1fima2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwn @ (cwcel @ ccc0 @ XA2))) @ (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ XA2) @ ccvol) @ ccr))))).
...
thf(citg2addnclem2_conj,conjecture,(! [Xph:$o] : (! [Xv:$i] : (! [Xh:$i] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xh) @ (ccdm @ ccitg1))) @ (cwcel @ (ccv @ Xv) @ ccrp)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwa @ (cwbr @ (cco @ (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ (ccv @ Xv) @ cc3 @ ccdiv) @ ccdiv) @ ccfl) @ cc1 @ ccmin) @ (cco @ (ccv @ Xv) @ cc3 @ ccdiv) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xh)) @ ccle) @ (cwne @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xh)) @ ccc0)) @ (cco @ (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ (ccv @ Xv) @ cc3 @ ccdiv) @ ccdiv) @ ccfl) @ cc1 @ ccmin) @ (cco @ (ccv @ Xv) @ cc3 @ ccdiv) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xh))))) @ (ccdm @ ccitg1)))))))))).
