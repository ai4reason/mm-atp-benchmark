...
thf(abj_rest10_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwi @ (cwne @ XX @ cc0) @ (cwceq @ (cco @ XX @ cc0 @ ccrest) @ (ccsn @ cc0))))))).
thf(cbj_rest10b_conj,conjecture,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ (ccdif @ XV @ (ccsn @ cc0))) @ (cwceq @ (cco @ XX @ cc0 @ ccrest) @ (ccsn @ cc0)))))).
