...
thf(adf_pli_ax,axiom,(cwceq @ ccpli @ (ccres @ ccoa @ (ccxp @ ccnpi @ ccnpi)))).
thf(caddpiord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccpli) @ (cco @ XA2 @ XB2 @ ccoa)))))).
