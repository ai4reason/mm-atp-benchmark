...
thf(cgsumcom_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XC @ (XW @ Xj @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XC))) @ (cwcel @ (XX @ Xj @ Xk) @ XB2)))) => ((cwi @ Xph @ (cwcel @ XU @ ccfn)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XC)) @ (cwn @ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ XU)))) @ (cwceq @ (XX @ Xj @ Xk) @ Xc_0)))) => (cwi @ Xph @ (cwceq @ (cco @ XG @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xk:$i] : XA2)) @ (^ [Xj:$i] : (^ [Xk:$i] : XC)) @ (^ [Xj:$i] : (^ [Xk:$i] : (XX @ Xj @ Xk)))) @ ccgsu) @ (cco @ XG @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xj:$i] : XC)) @ (^ [Xk:$i] : (^ [Xj:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xj:$i] : (XX @ Xj @ Xk)))) @ ccgsu)))))))))))))))))))))).
