...
thf(csgrp2nmndlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xc_op:($i > ($i > ($i > $o)))] : ((cwceq @ XS @ (ccpr @ XA2 @ XB2)) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccbs) @ XS)) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ XA2 @ XB2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_op @ Xx3 @ Xy1) @ (ccfv @ (XM @ Xy1) @ ccplusg)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XC @ XS)) @ (cwceq @ (cco @ XA2 @ XC @ (Xc_op @ Xx3 @ Xy1)) @ XA2))))))))))))))).
