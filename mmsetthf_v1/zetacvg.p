...
thf(acxpaddd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cccxp) @ (cco @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccmul)))))))))))).
...
thf(czetacvg_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccc)) => ((cwi @ Xph @ (cwbr @ cc1 @ (ccfv @ XS @ ccre) @ cclt)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ (ccv @ Xk) @ (ccneg @ XS) @ cccxp)))) => (cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli)))))))))).
