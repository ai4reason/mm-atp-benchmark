...
thf(achpvalz_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccfv @ XN @ ccchp) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccvma))))))).
...
thf(aax_ros335_ax,axiom,(cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (cco @ (cco @ cc1 @ (ccdp2 @ ccc0 @ (ccdp2 @ cc3 @ (ccdp2 @ cc8 @ (ccdp2 @ cc8 @ cc3)))) @ ccdp) @ (ccv @ Xx3) @ ccmul) @ cclt)) @ (^ [Xx3:$i] : ccrp))).
thf(annrpd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => (cwi @ Xph @ (cwcel @ XA2 @ ccrp)))))).
thf(chgt750lemc_conj,conjecture,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ XN @ ccn))) => (! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwbr @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ ccvma))) @ (cco @ (cco @ cc1 @ (ccdp2 @ ccc0 @ (ccdp2 @ cc3 @ (ccdp2 @ cc8 @ (ccdp2 @ cc8 @ cc3)))) @ ccdp) @ XN @ ccmul) @ cclt))))))).
