...
thf(af1oiso2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XS @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ (cccnv @ XH)) @ (ccfv @ (ccv @ Xy1) @ (cccnv @ XH)) @ XR)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwf1o @ XA2 @ XB2 @ XH) @ (cwiso @ XA2 @ XB2 @ XR @ (XS @ Xx3 @ Xy1) @ XH))))))))))).
...
thf(aisoeq3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwceq @ XS @ XT) @ (cwb @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwiso @ XA2 @ XB2 @ XR @ XT @ XH)))))))))).
