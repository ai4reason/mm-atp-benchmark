...
thf(clspsnss_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XS) @ (cwcel @ XX @ XU)) @ (cwss @ (ccfv @ (ccsn @ XX) @ XN) @ XU)))))))))).
