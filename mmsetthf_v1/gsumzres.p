...
thf(agsumcllem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XZ @ Xk) @ (XU @ Xk)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwss @ (cco @ XF @ (XZ @ Xk) @ ccsupp) @ XW))) => (cwi @ (cwa @ Xph @ (cwceq @ XW @ cc0)) @ (cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XZ @ Xk)))))))))))))))))).
