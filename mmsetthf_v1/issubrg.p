...
thf(adf_subrg_ax,axiom,(cwceq @ ccsubrg @ (ccmpt @ (^ [Xw:$i] : ccrg) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : (cwa @ (cwcel @ (cco @ (ccv @ Xw) @ (ccv @ Xs1) @ ccress) @ ccrg) @ (cwcel @ (ccfv @ (ccv @ Xw) @ ccur) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))))))).
...
thf(cissubrg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwb @ (cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) @ (cwa @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ (cco @ XR @ XA2 @ ccress) @ ccrg)) @ (cwa @ (cwss @ XA2 @ XB2) @ (cwcel @ Xc_1 @ XA2))))))))))).
