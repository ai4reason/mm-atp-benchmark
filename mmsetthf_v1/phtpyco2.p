...
thf(ahtpyco2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XP @ (cco @ XK @ XL @ cccn))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)))) => (cwi @ Xph @ (cwcel @ (cccom @ XP @ XH) @ (cco @ (cccom @ XP @ XF) @ (cccom @ XP @ XG) @ (cco @ XJ @ XL @ cchtpy))))))))))))))))).
...
thf(cphtpyco2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XP @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)))) => (cwi @ Xph @ (cwcel @ (cccom @ XP @ XH) @ (cco @ (cccom @ XP @ XF) @ (cccom @ XP @ XG) @ (ccfv @ XK @ ccphtpy)))))))))))))))).
