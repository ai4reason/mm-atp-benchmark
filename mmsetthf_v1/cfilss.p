...
thf(aiscfil_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwb @ (cwcel @ XF @ (ccfv @ XD @ cccfil)) @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccima @ XD @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccico))) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : ccrp))))))))).
...
thf(ccfilss_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XF @ (ccfv @ XD @ cccfil))) @ (cwa @ (cwcel @ XG @ (ccfv @ XX @ ccfil)) @ (cwss @ XF @ XG))) @ (cwcel @ XG @ (ccfv @ XD @ cccfil)))))))).
