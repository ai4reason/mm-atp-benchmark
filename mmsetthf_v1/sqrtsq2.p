...
thf(csqrtsq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ ccle))) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccsqrt) @ XB2) @ (cwceq @ XA2 @ (cco @ XB2 @ cc2 @ ccexp))))))).
