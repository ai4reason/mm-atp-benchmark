...
thf(cptuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XF @ ccpt))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF)) @ (cwceq @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccuni @ (ccfv @ (ccv @ Xx3) @ XF)))) @ (ccuni @ (XJ @ Xx3))))))))))).
