...
thf(aocvi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XS @ Xc_pe)) @ (cwcel @ XB2 @ XS)) @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_xi) @ Xc_0))))))))))))))))).
...
thf(aiscss2_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XC @ (ccfv @ XW @ cccss)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwss @ XS @ XV)) @ (cwb @ (cwcel @ XS @ XC) @ (cwss @ (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe) @ XS)))))))))))).
thf(clsmcss_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XC @ (ccfv @ XW @ cccss)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwi @ Xph @ (cwcel @ XW @ ccphl)) => ((cwi @ Xph @ (cwss @ XS @ XV)) => ((cwi @ Xph @ (cwss @ (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe) @ (cco @ XS @ (ccfv @ XS @ Xc_pe) @ Xc_po))) => (cwi @ Xph @ (cwcel @ XS @ XC))))))))))))))))).
