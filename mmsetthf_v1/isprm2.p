...
thf(aisprm2lem_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccn) @ (cwne @ XP @ cc1)) @ (cwb @ (cwbr @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XP @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ cc2o @ ccen) @ (cwceq @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XP @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ (ccpr @ cc1 @ XP)))))).
...
thf(a_1idssfct_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwss @ (ccpr @ cc1 @ XN) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn)))))).
...
thf(cisprm2_conj,conjecture,(! [XP:($i > $o)] : (cwb @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xz) @ XP @ ccdvds) @ (cwo @ (cwceq @ (ccv @ Xz) @ cc1) @ (cwceq @ (ccv @ Xz) @ XP)))) @ (^ [Xz:$i] : ccn)))))).
