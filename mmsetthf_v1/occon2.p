...
thf(coccon2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ cchil) @ (cwss @ XB2 @ cchil)) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccort) @ (ccfv @ (ccfv @ XB2 @ ccort) @ ccort))))))).
