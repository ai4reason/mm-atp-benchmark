...
thf(cdibelval2nd_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccfv @ XK @ ccbs))) => ((! [Xf1:$i] : (cwceq @ (Xc_le @ Xf1) @ (ccfv @ XK @ ccple))) => ((! [Xf1:$i] : (cwceq @ (XH @ Xf1) @ (ccfv @ XK @ cclh))) => ((! [Xf1:$i] : (cwceq @ (XT @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccltrn)))) => ((! [Xf1:$i] : (cwceq @ (Xc_0 @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : (XT @ Xf1)) @ (^ [Xf1:$i] : (ccres @ ccid @ (XB2 @ Xf1)))))) => ((! [Xf1:$i] : (cwceq @ (XI @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => (! [Xf1:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ (XV @ Xf1)) @ (cwcel @ XW @ (XH @ Xf1))) @ (cwa @ (cwcel @ (XX @ Xf1) @ (XB2 @ Xf1)) @ (cwbr @ (XX @ Xf1) @ XW @ (Xc_le @ Xf1))) @ (cwcel @ (XY @ Xf1) @ (ccfv @ (XX @ Xf1) @ (XI @ Xf1)))) @ (cwceq @ (ccfv @ (XY @ Xf1) @ cc2nd) @ (Xc_0 @ Xf1)))))))))))))))))))))).
