...
thf(atan4thpi_thm,axiom,(cwceq @ (ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ cctan) @ cc1)).
...
thf(aatantan_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccatan) @ XA2)))).
thf(catan1_conj,conjecture,(cwceq @ (ccfv @ cc1 @ ccatan) @ (cco @ ccpi @ cc4 @ ccdiv))).
