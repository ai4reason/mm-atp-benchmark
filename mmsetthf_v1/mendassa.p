...
thf(amendsca_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => ((cwceq @ XS @ (ccfv @ XM @ ccsca)) => (cwceq @ XS @ (ccfv @ XA2 @ ccsca)))))))).
thf(aeqidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (cwi @ Xph @ (cwceq @ XA2 @ XA2))))).
thf(ccgrp_tp,type,(ccgrp : ($i > $o))).
thf(ccur_tp,type,(ccur : ($i > $o))).
thf(amendlmod_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => ((cwceq @ XS @ (ccfv @ XM @ ccsca)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ cccrg)) @ (cwcel @ XA2 @ cclmod)))))))).
...
thf(amendring_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => (cwi @ (cwcel @ XM @ cclmod) @ (cwcel @ XA2 @ ccrg)))))).
...
thf(amendvsca_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XS @ (ccfv @ XM @ ccsca)) => ((cwceq @ XK @ (ccfv @ XS @ ccbs)) => ((cwceq @ XE @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_xb @ (ccfv @ XA2 @ ccvsca)) => (cwi @ (cwa @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XB2)) @ (cwceq @ (cco @ XX @ XY @ Xc_xb) @ (cco @ (ccxp @ XE @ (ccsn @ XX)) @ XY @ (ccof @ Xc_x)))))))))))))))))))))).
...
thf(amendmulr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XA2 @ ccmulr)) => (cwi @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwceq @ (cco @ XX @ XY @ Xc_x) @ (cccom @ XX @ XY))))))))))))).
...
thf(cmendassa_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => ((cwceq @ XS @ (ccfv @ XM @ ccsca)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ cccrg)) @ (cwcel @ XA2 @ ccasa)))))))).
