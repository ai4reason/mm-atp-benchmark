...
thf(csymgfisg_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XG @ (ccfv @ (XD @ Xx3) @ ccsymg))) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (! [Xx3:$i] : (cwi @ (cwcel @ (XD @ Xx3) @ (XV @ Xx3)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xx3) @ ccid)) @ ccfn)) @ (^ [Xx3:$i] : XB2)) @ (ccfv @ XG @ ccsubg))))))))))).
