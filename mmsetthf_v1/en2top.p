...
thf(asdom2en01_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwbr @ XA2 @ cc2o @ ccsdm) @ (cwo @ (cwceq @ XA2 @ cc0) @ (cwbr @ XA2 @ cc1o @ ccen))))).
...
thf(aen2eqpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwbr @ XC @ cc2o @ ccen) @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC)) @ (cwi @ (cwne @ XA2 @ XB2) @ (cwceq @ XC @ (ccpr @ XA2 @ XB2)))))))).
...
thf(cen2top_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwbr @ XJ @ cc2o @ ccen) @ (cwa @ (cwceq @ XJ @ (ccpr @ cc0 @ XX)) @ (cwne @ XX @ cc0))))))).
