...
thf(arelexpxpnnidm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwi @ (cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwne @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwceq @ (cco @ (ccxp @ XA2 @ XB2) @ XN @ ccrelexp) @ (ccxp @ XA2 @ XB2)))))))))).
...
thf(arelexpiidm_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ (ccres @ ccid @ XA2) @ XN @ ccrelexp) @ (ccres @ ccid @ XA2))))))).
...
thf(arelexp0idm_thm,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwceq @ (cco @ (cco @ XR @ ccc0 @ ccrelexp) @ ccc0 @ ccrelexp) @ (cco @ XR @ ccc0 @ ccrelexp)))))).
thf(crelexpxpmin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwne @ (ccin @ XA2 @ XB2) @ cc0)) @ (cw3a @ (cwceq @ XI @ (ccif @ (cwbr @ XJ @ XK @ cclt) @ XJ @ XK)) @ (cwcel @ XJ @ ccn0) @ (cwcel @ XK @ ccn0))) @ (cwceq @ (cco @ (cco @ (ccxp @ XA2 @ XB2) @ XJ @ ccrelexp) @ XK @ ccrelexp) @ (cco @ (ccxp @ XA2 @ XB2) @ XI @ ccrelexp))))))))))).
