...
thf(cpclidN_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XX @ XS)) @ (cwceq @ (ccfv @ XX @ XU) @ XX)))))))))).
