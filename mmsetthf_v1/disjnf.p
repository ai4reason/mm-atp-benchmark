...
thf(amoel_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
thf(cdisjnf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ (cwo @ (cwceq @ XB2 @ cc0) @ (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)))))))).
