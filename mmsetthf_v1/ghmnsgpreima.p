...
thf(cghmnsgpreima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XV @ (ccfv @ XT @ ccnsg))) @ (cwcel @ (ccima @ (cccnv @ XF) @ XV) @ (ccfv @ XS @ ccnsg)))))))).
