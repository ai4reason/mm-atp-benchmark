...
thf(cswrdccat3a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwi @ (cwcel @ XN @ (cco @ ccc0 @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ ccc0 @ XN) @ ccsubstr) @ (ccif @ (cwbr @ XN @ XL @ ccle) @ (cco @ XA2 @ (ccop @ ccc0 @ XN) @ ccsubstr) @ (cco @ XA2 @ (cco @ XB2 @ (ccop @ ccc0 @ (cco @ XN @ XL @ ccmin)) @ ccsubstr) @ ccconcat)))))))))))).
