...
thf(adf_clintop_ax,axiom,(cwceq @ ccclintop @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (cco @ (ccv @ Xm) @ (ccv @ Xm) @ ccintop))))).
...
thf(cclintopval_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XM @ XV) @ (cwceq @ (ccfv @ XM @ ccclintop) @ (cco @ XM @ (ccxp @ XM @ XM) @ ccmap)))))).
