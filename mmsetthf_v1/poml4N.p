...
thf(cpoml4N_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccpolN)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) @ (cwi @ (cwa @ (cwss @ XX @ XY) @ (cwceq @ (ccfv @ (ccfv @ XY @ Xc_pe) @ Xc_pe) @ XY)) @ (cwceq @ (ccin @ (ccfv @ (ccin @ (ccfv @ XX @ Xc_pe) @ XY) @ Xc_pe) @ XY) @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe)))))))))))).
