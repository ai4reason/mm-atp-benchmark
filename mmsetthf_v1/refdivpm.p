...
thf(arefdivmptf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwf @ XA2 @ ccr @ XF) @ (cwf @ XA2 @ ccr @ XG) @ (cwcel @ XA2 @ XV)) @ (cwf @ (cco @ XG @ ccc0 @ ccsupp) @ ccr @ (cco @ XF @ XG @ ccfdiv)))))))).
...
thf(crefdivpm_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwf @ XA2 @ ccr @ XF) @ (cwf @ XA2 @ ccr @ XG) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XF @ XG @ ccfdiv) @ (cco @ ccr @ XA2 @ ccpm)))))))).
