...
thf(a_1loopgruspgr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XN @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ (ccsn @ XN))))) => (cwi @ Xph @ (cwcel @ XG @ ccuspgr))))))))))))).
...
thf(a_1loopgredg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XN @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ (ccsn @ XN))))) => (cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccedg) @ (ccsn @ (ccsn @ XN))))))))))))))).
thf(cwsbc_tp,type,(cwsbc : (($i > $o) > (($i > $o) > $o)))).
thf(arabsnif_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwceq @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ XA2))) @ (ccif @ Xps @ (ccsn @ XA2) @ cc0))))))).
...
thf(c_1loopgrvd2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XN @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ (ccsn @ XN))))) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (ccfv @ XG @ ccvtxdg)) @ cc2))))))))))))).
