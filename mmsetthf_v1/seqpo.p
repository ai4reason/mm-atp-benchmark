...
thf(cseqpo_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwpo @ XA2 @ XR) @ (cwf @ ccn @ XA2 @ XF)) @ (cwb @ (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccv @ Xs1) @ XF) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ XF) @ XR)) @ (^ [Xs1:$i] : ccn)) @ (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (ccv @ Xn) @ XF) @ XR)) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ ccuz)))) @ (^ [Xm:$i] : ccn)))))))).
