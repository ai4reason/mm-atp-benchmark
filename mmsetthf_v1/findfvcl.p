...
thf(afveleq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XF) @ XP)) @ (cwi @ Xph @ (cwcel @ (ccfv @ XB2 @ XF) @ XP)))))))))).
thf(aa2d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ Xth))) => (cwi @ Xph @ (cwi @ (cwi @ Xps @ Xch) @ (cwi @ Xps @ Xth))))))))).
thf(cfindfvcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ (ccfv @ cc0 @ XF) @ XP)) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccom) @ (cwi @ Xph @ (cwi @ (cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ XP) @ (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ XF) @ XP))))) => (! [Xy1:$i] : (cwi @ (cwcel @ (XA2 @ Xy1) @ ccom) @ (cwi @ Xph @ (cwcel @ (ccfv @ (XA2 @ Xy1) @ XF) @ XP))))))))))).
