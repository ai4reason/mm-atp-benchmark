...
thf(abj_ismooredr2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ (ccuni @ XA2) @ XA2)) => ((! [Xx3:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwss @ (ccv @ Xx3) @ XA2)) @ (cwne @ (ccv @ Xx3) @ cc0)) @ (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2))) => (cwi @ Xph @ (cwcel @ XA2 @ ccmoore))))))))).
...
thf(abj_0nmoore_thm,axiom,(cwn @ (cwcel @ cc0 @ ccmoore))).
thf(cbj_snmoore_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccvv) @ (cwcel @ (ccsn @ XA2) @ ccmoore)))).
