...
thf(corvcval2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwfun @ XX))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XX @ (XV @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XA2 @ (XW @ Xz)))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwceq @ (cco @ XX @ XA2 @ (ccorvc @ XR)) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccv @ Xz) @ XX) @ XA2 @ XR)) @ (^ [Xz:$i] : (ccdm @ XX)))))))))))))))).
