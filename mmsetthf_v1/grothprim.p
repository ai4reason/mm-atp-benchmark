...
thf(aaxgroth4_thm,axiom,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwss @ (ccv @ Xw) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xv))))))) @ (^ [Xv:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwo @ (cwbr @ (ccdif @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xz) @ ccdom) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))))).
...
thf(abrdom6disj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwceq @ (ccin @ XA2 @ XB2) @ cc0) => (cwb @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwral @ (^ [Xx3:$i] : (cwmo @ (^ [Xy1:$i] : (cwcel @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xf1))))) @ (^ [Xx3:$i] : XB2)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccpr @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))))))).
...
thf(a_19_44v_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwo @ (Xph @ Xx3) @ Xps))) @ (cwo @ (cwex @ (^ [Xx3:$i] : (Xph @ Xx3))) @ Xps))))).
...
thf(agrothprimlem_thm,axiom,(! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwb @ (cwcel @ (ccpr @ (ccv @ Xu) @ (ccv @ Xv)) @ (ccv @ Xw)) @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) @ (cwal @ (^ [Xh:$i] : (cwb @ (cwcel @ (ccv @ Xh) @ (ccv @ Xg1)) @ (cwo @ (cwceq @ (ccv @ Xh) @ (ccv @ Xu)) @ (cwceq @ (ccv @ Xh) @ (ccv @ Xv)))))))))))))).
...
thf(cgrothprim_conj,conjecture,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwal @ (^ [Xz:$i] : (cwa @ (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwex @ (^ [Xv:$i] : (cwa @ (cwcel @ (ccv @ Xv) @ (ccv @ Xy1)) @ (cwal @ (^ [Xw:$i] : (cwi @ (cwal @ (^ [Xu:$i] : (cwi @ (cwcel @ (ccv @ Xu) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xu) @ (ccv @ Xz))))) @ (cwa @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xv)))))))))) @ (cwex @ (^ [Xw:$i] : (cwi @ (cwi @ (cwcel @ (ccv @ Xw) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1))) @ (cwo @ (cwal @ (^ [Xv:$i] : (cwa @ (cwi @ (cwcel @ (ccv @ Xv) @ (ccv @ Xz)) @ (cwex @ (^ [Xt:$i] : (cwal @ (^ [Xu:$i] : (cwi @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) @ (cwal @ (^ [Xh:$i] : (cwb @ (cwcel @ (ccv @ Xh) @ (ccv @ Xg1)) @ (cwo @ (cwceq @ (ccv @ Xh) @ (ccv @ Xv)) @ (cwceq @ (ccv @ Xh) @ (ccv @ Xu))))))))) @ (cwceq @ (ccv @ Xu) @ (ccv @ Xt)))))))) @ (cwi @ (cwcel @ (ccv @ Xv) @ (ccv @ Xy1)) @ (cwo @ (cwcel @ (ccv @ Xv) @ (ccv @ Xz)) @ (cwex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xz)) @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) @ (cwal @ (^ [Xh:$i] : (cwb @ (cwcel @ (ccv @ Xh) @ (ccv @ Xg1)) @ (cwo @ (cwceq @ (ccv @ Xh) @ (ccv @ Xu)) @ (cwceq @ (ccv @ Xh) @ (ccv @ Xv))))))))))))))))) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)))))))))))))).
