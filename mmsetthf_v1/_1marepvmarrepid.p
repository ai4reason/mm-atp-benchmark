...
thf(amat1bas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ (cco @ XN @ XR @ ccmat) @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn)) @ (cwcel @ Xc_1 @ XB2))))))))))).
thf(a_3simpc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xps @ Xch)))))).
thf(ama1repveval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XV @ (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((cwceq @ Xc_1 @ (ccfv @ XA2 @ ccur)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XE @ (ccfv @ XK @ (cco @ Xc_1 @ XC @ (cco @ XN @ XR @ ccmatrepV)))) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cw3a @ (cwcel @ XM @ XB2) @ (cwcel @ XC @ XV) @ (cwcel @ XK @ XN)) @ (cwa @ (cwcel @ XI @ XN) @ (cwcel @ XJ @ XN))) @ (cwceq @ (cco @ XI @ XJ @ XE) @ (ccif @ (cwceq @ XJ @ XK) @ (ccfv @ XI @ XC) @ (ccif @ (cwceq @ XJ @ XI) @ (ccfv @ XR @ ccur) @ Xc_0)))))))))))))))))))))))).
