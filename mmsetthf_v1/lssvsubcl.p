...
thf(clssvsubcl_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => (cwi @ (cwa @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XS)) @ (cwa @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XU))) @ (cwcel @ (cco @ XX @ XY @ Xc_mi) @ XU))))))))))).
