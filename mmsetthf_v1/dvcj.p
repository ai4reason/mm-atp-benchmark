...
thf(advcjbr_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => (cwi @ Xph @ (cwbr @ XC @ (ccfv @ (ccfv @ XC @ (cco @ ccr @ XF @ ccdv)) @ cccj) @ (cco @ ccr @ (cccom @ cccj @ XF) @ ccdv))))))))))).
...
thf(cdvcj_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwf @ XX @ ccc @ XF) @ (cwss @ XX @ ccr)) @ (cwceq @ (cco @ ccr @ (cccom @ cccj @ XF) @ ccdv) @ (cccom @ cccj @ (cco @ ccr @ XF @ ccdv))))))).
