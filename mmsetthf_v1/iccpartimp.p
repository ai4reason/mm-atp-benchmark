...
thf(ciccpartimp_conj,conjecture,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XP @ (ccfv @ XM @ cciccp)) @ (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwa @ (cwcel @ XP @ (cco @ ccxr @ (cco @ ccc0 @ XM @ ccfz) @ ccmap)) @ (cwbr @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP) @ cclt))))))).
