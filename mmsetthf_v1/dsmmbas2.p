...
thf(cdsmmbas2_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xf1) @ (cccom @ cc0g @ XR))) @ ccfn)) @ (^ [Xf1:$i] : (ccfv @ XP @ ccbs))))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwfn @ XR @ XI) @ (cwcel @ XI @ XV)) @ (cwceq @ (XB2 @ Xf1) @ (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs))))))))))))).
