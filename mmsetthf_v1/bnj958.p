...
thf(cbnj958_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xi:$i] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XC @ Xy1 @ Xf1 @ Xm @ Xn) @ (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xm) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xy1 @ Xf1 @ Xm @ Xn) @ (XR @ Xy1 @ Xf1 @ Xm @ Xn) @ (ccv @ Xy1))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xy1 @ Xf1 @ Xm @ Xn) @ (ccun @ (ccv @ Xf1) @ (ccsn @ (ccop @ (ccv @ Xn) @ (XC @ Xy1 @ Xf1 @ Xm @ Xn))))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xi) @ (XG @ Xy1 @ Xf1 @ Xm @ Xn)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (cwal @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ (XG @ Xy1 @ Xf1 @ Xm @ Xn)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)))))))))))))))))).
