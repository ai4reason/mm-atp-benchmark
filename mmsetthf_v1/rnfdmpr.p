...
thf(crnfdmpr_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XW)) @ (cwi @ (cwfn @ XF @ (ccpr @ XX @ XY)) @ (cwceq @ (ccrn @ XF) @ (ccpr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF))))))))))).
