...
thf(abitsuz_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwbr @ (cco @ cc2 @ XN @ ccexp) @ XA2 @ ccdvds) @ (cwss @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XN @ ccuz))))))).
...
thf(cbitsshft_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccrab @ (^ [Xn:$i] : (cwcel @ (cco @ (ccv @ Xn) @ XN @ ccmin) @ (ccfv @ XA2 @ ccbits))) @ (^ [Xn:$i] : ccn0)) @ (ccfv @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ ccbits)))))).
