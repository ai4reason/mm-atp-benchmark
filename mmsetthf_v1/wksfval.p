...
thf(aifpbi123d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xta)) => ((cwi @ Xph @ (cwb @ Xch @ Xet)) => ((cwi @ Xph @ (cwb @ Xth @ Xze)) => (cwi @ Xph @ (cwb @ (cwif @ Xps @ Xch @ Xth) @ (cwif @ Xta @ Xet @ Xze)))))))))))))).
