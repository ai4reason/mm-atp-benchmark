...
thf(adifpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccdif @ XA2 @ (ccpr @ XB2 @ XC)) @ (ccdif @ (ccdif @ XA2 @ (ccsn @ XB2)) @ (ccsn @ XC))))))).
thf(cnbgrssvwo2_conj,conjecture,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwnel @ XM @ (cco @ XG @ XX @ ccnbgr)) @ (cwss @ (cco @ XG @ XX @ ccnbgr) @ (ccdif @ XV @ (ccpr @ XM @ XX)))))))))).
