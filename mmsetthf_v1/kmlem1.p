...
thf(ckmlem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xw:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwral @ (^ [Xz:$i] : (cwne @ (ccv @ Xz) @ cc0)) @ (^ [Xz:$i] : (ccv @ Xx3))) @ (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (Xph @ Xz @ Xw)) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (Xps @ Xy1 @ Xz @ Xw)) @ (^ [Xz:$i] : (ccv @ Xx3)))))))) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (Xph @ Xz @ Xw)) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3))) @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (Xps @ Xy1 @ Xz @ Xw))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))))))).
