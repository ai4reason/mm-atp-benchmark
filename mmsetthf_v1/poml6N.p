...
thf(cpoml6N_conj,conjecture,(! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccpolN)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XC) @ (cwcel @ XY @ XC)) @ (cwss @ XX @ XY)) @ (cwceq @ (ccin @ (ccfv @ (ccin @ (ccfv @ XX @ Xc_pe) @ XY) @ Xc_pe) @ XY) @ XX)))))))))).
