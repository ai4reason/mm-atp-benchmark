...
thf(ciota5f_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xx3) @ XV)) @ (cwb @ (Xps @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xx3) @ XV)) @ (cwceq @ (ccio @ (^ [Xx3:$i] : (Xps @ Xx3))) @ (XA2 @ Xx3)))))))))))).
