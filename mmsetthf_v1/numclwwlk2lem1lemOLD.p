...
thf(cnumclwwlk2lem1lemOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ (ccfv @ XG @ ccvtx))) @ (cwa @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwne @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW)))) @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) @ (ccfv @ ccc0 @ XW)) @ (cwne @ (ccfv @ XN @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) @ (ccfv @ ccc0 @ XW))))))))).
