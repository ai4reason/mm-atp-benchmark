...
thf(cumgrbi_conj,conjecture,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ XV) => ((cwcel @ XY @ XV) => ((cwne @ XX @ XY) => (cwcel @ (ccpr @ XX @ XY) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))))))))))).
