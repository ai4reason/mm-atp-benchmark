...
thf(apythagtriplem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ XC @ cc2 @ ccexp)) @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds)))) @ (cwceq @ (cco @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XC @ XB2 @ ccaddc) @ ccgcd) @ cc1)))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(a_1gcd_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccz) @ (cwceq @ (cco @ cc1 @ XM @ ccgcd) @ cc1)))).
...
thf(acoprimeprodsq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccgcd) @ cc1)) @ (cwi @ (cwceq @ (cco @ XC @ cc2 @ ccexp) @ (cco @ XA2 @ XB2 @ ccmul)) @ (cwceq @ XA2 @ (cco @ (cco @ XA2 @ XC @ ccgcd) @ cc2 @ ccexp)))))))).
...
thf(cpythagtriplem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ XC @ cc2 @ ccexp)) @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds)))) @ (cwceq @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccsqrt) @ (cco @ (cco @ XC @ XB2 @ ccmin) @ XA2 @ ccgcd))))))).
