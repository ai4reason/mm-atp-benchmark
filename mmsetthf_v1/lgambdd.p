...
thf(algamgulmlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XR @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XU @ Xx3 @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XR @ ccle) @ (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ XR @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ (XU @ Xx3 @ Xk) @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))))))))))).
...
thf(aabslogle_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccabs) @ (cco @ (ccfv @ (ccfv @ (ccfv @ XA2 @ ccabs) @ cclog) @ ccabs) @ ccpi @ ccaddc) @ ccle)))).
...
thf(aabsled_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccle) @ (cwa @ (cwbr @ (ccneg @ XB2) @ XA2 @ ccle) @ (cwbr @ XA2 @ XB2 @ ccle)))))))))).
...
thf(clgambdd_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XR @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XU @ Xx3 @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XR @ ccle) @ (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ XR @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XG @ Xx3 @ Xz @ Xk @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xz:$i] : (XU @ Xx3 @ Xk)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xz) @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccdiv) @ cclog) @ ccmul) @ (ccfv @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xm) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin)))))))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ cclgam) @ ccabs) @ (ccv @ Xr) @ ccle)) @ (^ [Xz:$i] : (XU @ Xx3 @ Xk)))) @ (^ [Xr:$i] : ccr))))))))))))).
