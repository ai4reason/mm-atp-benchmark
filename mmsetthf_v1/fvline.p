...
thf(cfvline_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xx3) @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwcel @ XB2 @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwne @ XA2 @ XB2))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccline2) @ (ccab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XA2 @ XB2) @ cccolin)))))))))).
