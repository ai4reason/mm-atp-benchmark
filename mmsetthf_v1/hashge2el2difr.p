...
thf(chashge2el2difr_conj,conjecture,(! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ XV) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwne @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD))) @ (cwbr @ cc2 @ (ccfv @ XD @ cchash) @ ccle))))).
