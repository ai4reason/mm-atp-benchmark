...
thf(ahasheuni_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3)))) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cchash) @ (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash)))))))).
...
thf(ccntmeas_conj,conjecture,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ (ccres @ cchash @ XS) @ (ccfv @ XS @ ccmeas))))).
