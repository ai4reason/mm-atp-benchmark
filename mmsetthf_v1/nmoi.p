...
thf(cnmoi_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) @ (cwcel @ XX @ XV)) @ (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XM) @ (cco @ (ccfv @ XF @ XN) @ (ccfv @ XX @ XL) @ ccmul) @ ccle))))))))))))))).
