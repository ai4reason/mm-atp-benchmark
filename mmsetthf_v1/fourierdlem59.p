...
thf(advdivcncf_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwf @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((cwi @ Xph @ (cwcel @ (cco @ XS @ XF @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ (cco @ XS @ XG @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ ccdv) @ (cco @ XX @ ccc @ cccncf)))))))))))))).
...
thf(advsubcncf_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XG)) => ((cwi @ Xph @ (cwcel @ (cco @ XS @ XF @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ (cco @ XS @ XG @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdv) @ (cco @ XX @ ccc @ cccncf)))))))))))))).
...
thf(advmptidg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => (cwi @ Xph @ (cwceq @ (cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : cc1)))))))))).
...
thf(cfourierdlem59_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (cco @ XA2 @ XB2 @ ccioo)))) => ((cwi @ Xph @ (cwcel @ (cco @ ccr @ (ccres @ XF @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo)) @ ccdv) @ (cco @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((! [Xs1:$i] : (cwceq @ (XH @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF) @ XC @ ccmin) @ (ccv @ Xs1) @ ccdiv))))) => (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (cco @ ccr @ (XH @ Xs1) @ ccdv) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf)))))))))))))))))))).
