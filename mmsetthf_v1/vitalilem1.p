...
thf(cvitalilem1_conj,conjecture,(! [Xc_sm:($i > $o)] : ((cwceq @ Xc_sm @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccq)))))) => (cwer @ (cco @ ccc0 @ cc1 @ ccicc) @ Xc_sm)))).
