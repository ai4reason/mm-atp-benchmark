...
thf(aneitx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XC @ (ccfv @ XJ @ ccnei))) @ (cwcel @ XB2 @ (ccfv @ XD @ (ccfv @ XK @ ccnei))))) @ (cwcel @ (ccxp @ XA2 @ XB2) @ (ccfv @ (ccxp @ XC @ XD) @ (ccfv @ (cco @ XJ @ XK @ cctx) @ ccnei))))))))))))))).
...
thf(cutop3cls_conj,conjecture,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XU @ ccutop)) => (cwi @ (cwa @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwss @ XM @ (ccxp @ XX @ XX))) @ (cwa @ (cwcel @ XV @ XU) @ (cwceq @ (cccnv @ XV) @ XV))) @ (cwss @ (ccfv @ XM @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccl)) @ (cccom @ XV @ (cccom @ XM @ XV))))))))))).
