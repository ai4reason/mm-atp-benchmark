...
thf(cmetcnpi3_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XK @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XD @ (ccfv @ XY @ ccxmt))) @ (cwa @ (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) @ (cwcel @ XA2 @ ccrp))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (cco @ (ccv @ Xy1) @ XP @ XC) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XP @ XF) @ XD) @ XA2 @ ccle))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccrp))))))))))))))).
