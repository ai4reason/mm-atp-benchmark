...
thf(aevengpop3_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc5 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc9 @ ccuz)) @ (cwcel @ XN @ cceven)) @ (cwrex @ (^ [Xo:$i] : (cwceq @ XN @ (cco @ (ccv @ Xo) @ cc3 @ ccaddc))) @ (^ [Xo:$i] : ccgbow)))))).
...
thf(cnnsum4primeseven_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc5 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc9 @ ccuz)) @ (cwcel @ XN @ cceven)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XN @ (ccsu @ (cco @ cc1 @ cc4 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc4 @ ccfz) @ ccmap))))))).
