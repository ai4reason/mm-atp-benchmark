...
thf(adf_mgm2_ax,axiom,(cwceq @ ccmgm2 @ (ccab @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ ccplusg) @ (ccfv @ (ccv @ Xm) @ ccbs) @ cccllaw))))).
thf(cismgmALT_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_op @ (ccfv @ XM @ ccplusg)) => (cwi @ (cwcel @ XM @ XV) @ (cwb @ (cwcel @ XM @ ccmgm2) @ (cwbr @ Xc_op @ XB2 @ cccllaw)))))))))).
