...
thf(advdsaddr_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ XM @ (cco @ XN @ XM @ ccaddc) @ ccdvds)))))).
...
thf(csignslema_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwcel @ XE @ ccn0)) => ((cwi @ Xph @ (cwcel @ XF @ ccn0)) => ((cwi @ Xph @ (cwcel @ XG @ ccn0)) => ((cwi @ Xph @ (cwcel @ XH @ ccn0)) => ((cwi @ Xph @ (cwa @ (cwbr @ XE @ XG @ cclt) @ (cwn @ (cwbr @ cc2 @ (cco @ XG @ XE @ ccmin) @ ccdvds)))) => ((cwi @ Xph @ (cwcel @ (cco @ (cco @ XH @ XG @ ccmin) @ (cco @ XF @ XE @ ccmin) @ ccmin) @ (ccpr @ ccc0 @ cc2))) => (cwi @ Xph @ (cwa @ (cwbr @ XF @ XH @ cclt) @ (cwn @ (cwbr @ cc2 @ (cco @ XH @ XF @ ccmin) @ ccdvds)))))))))))))))).
