...
thf(ahashge2el2difr_thm,axiom,(! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ XV) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwne @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD))) @ (cwbr @ cc2 @ (ccfv @ XD @ cchash) @ ccle))))).
thf(cstructgrssvtxlemOLD_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XG @ XX)) => ((cwi @ Xph @ (cwfun @ XG)) => ((cwi @ Xph @ (cwcel @ XV @ XY)) => ((cwi @ Xph @ (cwcel @ XE @ XZ)) => ((cwi @ Xph @ (cwss @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE)) @ XG)) => (cwi @ Xph @ (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle))))))))))))))).
