...
thf(cismgmid2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XU @ XB2)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (cco @ XU @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (cco @ (ccv @ Xx3) @ XU @ Xc_pl) @ (ccv @ Xx3)))) => (cwi @ Xph @ (cwceq @ XU @ Xc_0))))))))))))))).
