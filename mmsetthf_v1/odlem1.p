...
thf(aodval_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XX @ Xy1) @ (ccfv @ XG @ ccbs))) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((! [Xy1:$i] : (cwceq @ (XO @ Xy1) @ (ccfv @ XG @ ccod))) => ((! [Xy1:$i] : (cwceq @ (XI @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ XA2 @ Xc_x) @ Xc_0)) @ (^ [Xy1:$i] : ccn)))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XX @ Xy1)) @ (cwceq @ (ccfv @ XA2 @ (XO @ Xy1)) @ (ccif @ (cwceq @ (XI @ Xy1) @ cc0) @ ccc0 @ (ccinf @ (XI @ Xy1) @ ccr @ cclt)))))))))))))))))).
...
thf(codlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XX @ Xy1) @ (ccfv @ XG @ ccbs))) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((! [Xy1:$i] : (cwceq @ (XO @ Xy1) @ (ccfv @ XG @ ccod))) => ((! [Xy1:$i] : (cwceq @ (XI @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ XA2 @ Xc_x) @ Xc_0)) @ (^ [Xy1:$i] : ccn)))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XX @ Xy1)) @ (cwo @ (cwa @ (cwceq @ (ccfv @ XA2 @ (XO @ Xy1)) @ ccc0) @ (cwceq @ (XI @ Xy1) @ cc0)) @ (cwcel @ (ccfv @ XA2 @ (XO @ Xy1)) @ (XI @ Xy1)))))))))))))))))).
