...
thf(csubmateqlem1_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XM @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((cwi @ Xph @ (cwbr @ XK @ XM @ ccle)) => (cwi @ Xph @ (cwa @ (cwcel @ XM @ (cco @ XK @ XN @ ccfz)) @ (cwcel @ (cco @ XM @ cc1 @ ccaddc) @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ XK)))))))))))))).
