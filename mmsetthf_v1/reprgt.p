...
thf(creprgt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ cc1 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwbr @ (cco @ XS @ XN @ ccmul) @ XM @ cclt)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ cc0))))))))))))).
