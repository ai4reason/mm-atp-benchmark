...
thf(adfon3_thm,axiom,(cwceq @ ccon0 @ (ccdif @ ccvv @ (ccrn @ (ccdif @ (ccin @ ccsset @ (ccxp @ cctrans @ ccvv)) @ (ccun @ ccid @ ccep)))))).
...
thf(cdfon4_conj,conjecture,(cwceq @ ccon0 @ (ccdif @ ccvv @ (ccima @ (ccdif @ ccsset @ (ccun @ ccid @ ccep)) @ cctrans)))).
