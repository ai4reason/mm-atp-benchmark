...
thf(aerngfset_rN_thm,axiom,(! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XH @ Xt @ Xf1 @ Xs1) @ (ccfv @ XK @ cclh))))) => (! [Xw:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwi @ (cwcel @ XK @ (XV @ Xw @ Xt @ Xf1 @ Xs1)) @ (cwceq @ (ccfv @ XK @ ccedring_rN) @ (ccmpt @ (^ [Xw:$i] : (XH @ Xt @ Xf1 @ Xs1)) @ (^ [Xw:$i] : (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cctendo))) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cctendo)))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cctendo)))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccmpt @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccltrn))) @ (^ [Xf1:$i] : (cccom @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xs1)) @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xt))))))))) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cctendo)))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cctendo)))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (cccom @ (ccv @ Xt) @ (ccv @ Xs1)))))))))))))))))))).
...
thf(cerngset_rN_conj,conjecture,(! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > $o)] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XH @ Xt @ Xf1 @ Xs1) @ (ccfv @ XK @ cclh))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XT @ Xt @ Xf1 @ Xs1) @ (ccfv @ XW @ (ccfv @ XK @ ccltrn)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XE @ Xt @ Xf1 @ Xs1) @ (ccfv @ XW @ (ccfv @ XK @ cctendo)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XD @ Xt @ Xf1 @ Xs1) @ (ccfv @ XW @ (ccfv @ XK @ ccedring_rN)))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ XK @ (XV @ Xt @ Xf1 @ Xs1)) @ (cwcel @ XW @ (XH @ Xt @ Xf1 @ Xs1))) @ (cwceq @ (XD @ Xt @ Xf1 @ Xs1) @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (XE @ Xt @ Xf1 @ Xs1)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : (XE @ Xt @ Xf1 @ Xs1))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (XE @ Xt @ Xf1 @ Xs1))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccmpt @ (^ [Xf1:$i] : (XT @ Xt @ Xf1 @ Xs1)) @ (^ [Xf1:$i] : (cccom @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xs1)) @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xt))))))))) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : (XE @ Xt @ Xf1 @ Xs1))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (XE @ Xt @ Xf1 @ Xs1))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (cccom @ (ccv @ Xt) @ (ccv @ Xs1)))))))))))))))))))))))).
