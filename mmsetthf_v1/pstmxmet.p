...
thf(aab2rexex_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (! [Xy1:$i] : (cwcel @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) @ ccvv)))))))).
...
thf(apstmval_thm,axiom,(! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XD @ ccmetid)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwceq @ (ccfv @ XD @ ccpstm) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccuni @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa)))))))))))))))).
...
thf(apstmfval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XD @ ccmetid)) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ (ccec @ XA2 @ Xc_sm) @ (ccec @ XB2 @ Xc_sm) @ (ccfv @ XD @ ccpstm)) @ (cco @ XA2 @ XB2 @ XD)))))))))).
...
thf(ametidv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) @ (cwb @ (cwbr @ XA2 @ XB2 @ (ccfv @ XD @ ccmetid)) @ (cwceq @ (cco @ XA2 @ XB2 @ XD) @ ccc0)))))))).
...
thf(ametider_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwer @ XX @ (ccfv @ XD @ ccmetid)))))).
...
thf(aadantl6r_thm,axiom,(! [Xph:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (! [Xmu:$o] : (! [Xla:$o] : (! [Xka:$o] : ((cwi @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ Xph @ Xet) @ Xze) @ Xsi) @ Xrh) @ Xmu) @ Xla) @ Xka) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ Xph @ Xta) @ Xet) @ Xze) @ Xsi) @ Xrh) @ Xmu) @ Xla) @ Xka)))))))))))).
...
thf(aqsexg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccqs @ XA2 @ XR) @ ccvv)))))).
...
thf(cpstmxmet_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XD @ ccmetid)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ (ccfv @ XD @ ccpstm) @ (ccfv @ (ccqs @ XX @ Xc_sm) @ ccxmt)))))))).
