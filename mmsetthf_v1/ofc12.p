...
thf(cofc12_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XC @ XX)) => (cwi @ Xph @ (cwceq @ (cco @ (ccxp @ XA2 @ (ccsn @ XB2)) @ (ccxp @ XA2 @ (ccsn @ XC)) @ (ccof @ XR)) @ (ccxp @ XA2 @ (ccsn @ (cco @ XB2 @ XC @ XR))))))))))))))))).
