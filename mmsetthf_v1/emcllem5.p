...
thf(cemcllem5_conj,conjecture,(! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xm @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmin)))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xm @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ cclog) @ ccmin)))))) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ cclog))))) => ((cwceq @ XT @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ (ccfv @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ cclog) @ ccmin)))) => (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xm @ Xn) @ (ccseq @ ccaddc @ XT @ cc1))))))))))))).
