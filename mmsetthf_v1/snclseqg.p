...
thf(csnclseqg_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_sm @ (cco @ XG @ XS @ ccqg)) => ((cwceq @ XS @ (ccfv @ (ccsn @ Xc_0) @ (ccfv @ XJ @ cccl))) => (cwi @ (cwa @ (cwcel @ XG @ cctgp) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccec @ XA2 @ Xc_sm) @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ cccl))))))))))))))))).
