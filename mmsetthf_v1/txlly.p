...
thf(acaovcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XS)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ (XB2 @ Xx3) @ XS)) @ (cwcel @ (cco @ XA2 @ (XB2 @ Xx3) @ XF) @ XS))))))))).
...
thf(ctxlly_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ cctx) @ XA2)))) => (! [Xj:$i] : (cwi @ (cwa @ (cwcel @ XR @ (cclly @ XA2)) @ (cwcel @ (XS @ Xj) @ (cclly @ XA2))) @ (cwcel @ (cco @ XR @ (XS @ Xj) @ cctx) @ (cclly @ XA2))))))))).
