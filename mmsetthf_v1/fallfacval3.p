...
thf(aelfz3nn0_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XN @ ccn0))))).
...
thf(afprodrev_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (XA2 @ Xj) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ XK @ (ccv @ Xk) @ ccmin)) @ (cwceq @ (XA2 @ Xj) @ (XB2 @ Xk))))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xj:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xj:$i] : (XA2 @ Xj))) @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XK @ XN @ ccmin) @ (cco @ XK @ XM @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (XB2 @ Xk))))))))))))))))).
...
thf(cfallfacval3_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (cco @ ccc0 @ XA2 @ ccfz)) @ (cwceq @ (cco @ XA2 @ XN @ ccfallfac) @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccmin) @ XA2 @ ccfz)) @ (^ [Xk:$i] : (ccv @ Xk)))))))).
