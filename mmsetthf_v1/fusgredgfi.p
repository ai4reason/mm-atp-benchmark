...
thf(ausgredgleord_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : (cwceq @ (XV @ Xe) @ (ccfv @ (XG @ Xe) @ ccvtx))) => ((! [Xe:$i] : (cwceq @ XE @ (ccfv @ (XG @ Xe) @ ccedg))) => (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ (XG @ Xe) @ ccusgr) @ (cwcel @ XN @ (XV @ Xe))) @ (cwbr @ (ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash) @ (ccfv @ (XV @ Xe) @ cchash) @ ccle)))))))))).
...
thf(cfusgredgfi_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ XV)) @ (cwcel @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ ccfn))))))))).
