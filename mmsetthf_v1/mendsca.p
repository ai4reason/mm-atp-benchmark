...
thf(aalgsca_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_xp)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccsca) @ XS) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ Xc_x)))) => (cwi @ (cwcel @ XS @ XV) @ (cwceq @ XS @ (ccfv @ XA2 @ ccsca)))))))))))).
...
thf(cmendsca_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => ((cwceq @ XS @ (ccfv @ XM @ ccsca)) => (cwceq @ XS @ (ccfv @ XA2 @ ccsca)))))))).
