...
thf(aisghm3_thm,axiom,(! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XS @ ccbs)) => ((cwceq @ XY @ (ccfv @ XT @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XS @ ccplusg)) => ((cwceq @ Xc_pd @ (ccfv @ XT @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XS @ ccgrp) @ (cwcel @ XT @ ccgrp)) @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ Xc_pl) @ XF) @ (cco @ (ccfv @ (ccv @ Xu) @ XF) @ (ccfv @ (ccv @ Xv) @ XF) @ Xc_pd))) @ (^ [Xv:$i] : XX))) @ (^ [Xu:$i] : XX))))))))))))))))).
...
thf(cdfrhm2_conj,conjecture,(cwceq @ ccrh @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrg)) @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrg)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccin @ (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccghm) @ (cco @ (ccfv @ (ccv @ Xr) @ ccmgp) @ (ccfv @ (ccv @ Xs1) @ ccmgp) @ ccmhm))))))).
