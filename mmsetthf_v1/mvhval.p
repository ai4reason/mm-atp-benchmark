...
thf(cmvhval_conj,conjecture,(! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XY @ (ccfv @ XT @ ccmty)) => ((cwceq @ XH @ (ccfv @ XT @ ccmvh)) => (cwi @ (cwcel @ XX @ XV) @ (cwceq @ (ccfv @ XX @ XH) @ (ccop @ (ccfv @ XX @ XY) @ (ccs1 @ XX))))))))))))).
