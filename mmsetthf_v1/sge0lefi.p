...
thf(csge0lefi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ XF @ ccsumge0) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ XA2 @ ccle)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
