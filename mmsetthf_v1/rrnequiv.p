...
thf(aprdsdsval3_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XR @ Xx3))) @ ccprds))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XY @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XS @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XI @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XR @ Xx3) @ (XX @ Xx3))) @ (^ [Xx3:$i] : XI)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XF @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XG @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccres @ (ccfv @ (XR @ Xx3) @ ccds) @ (ccxp @ (XK @ Xx3) @ (XK @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ (XY @ Xx3) @ ccds))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (cco @ XF @ XG @ (XD @ Xx3)) @ (ccsup @ (ccun @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ (XE @ Xx3))))) @ (ccsn @ ccc0)) @ ccxr @ cclt))))))))))))))))))))))))))))).
...
thf(arrndstprj1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ ccr @ XI @ ccmap)) => ((cwceq @ XM @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (cwi @ (cwa @ (cwa @ (cwcel @ XI @ ccfn) @ (cwcel @ XA2 @ XI)) @ (cwa @ (cwcel @ XF @ XX) @ (cwcel @ XG @ XX))) @ (cwbr @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG) @ XM) @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ ccle))))))))))).
...
thf(ametge0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ XD) @ ccle))))))).
...
thf(aprdsbascl_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XR @ Xx3))) @ ccprds))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XY @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XS @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XI @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XR @ Xx3) @ (XX @ Xx3))) @ (^ [Xx3:$i] : XI)))) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XF @ (XB2 @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (XK @ Xx3))) @ (^ [Xx3:$i] : XI))))))))))))))))))))))).
thf(amp3an1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ Xps @ Xch) @ Xth)))))))).
thf(aremet_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (cwcel @ XD @ (ccfv @ ccr @ ccme))))).
...
thf(amet0_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ XA2 @ XA2 @ XD) @ ccc0)))))).
...
thf(arepwsmet_thm,axiom,(! [XD:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ (cco @ cccnfld @ ccr @ ccress) @ XI @ ccpws)) => ((cwceq @ XD @ (ccfv @ XY @ ccds)) => ((cwceq @ XX @ (cco @ ccr @ XI @ ccmap)) => (cwi @ (cwcel @ XI @ ccfn) @ (cwcel @ XD @ (ccfv @ XX @ ccme))))))))))).
thf(asqrtge0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsqrt) @ ccle))))))).
...
thf(arrndstprj2_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XX @ Xn) @ (cco @ ccr @ XI @ ccmap))) => ((cwceq @ XM @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (! [Xn:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XI @ (ccdif @ ccfn @ (ccsn @ cc0))) @ (cwcel @ XF @ (XX @ Xn)) @ (cwcel @ XG @ (XX @ Xn))) @ (cwa @ (cwcel @ XR @ ccrp) @ (cwral @ (^ [Xn:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG) @ XM) @ XR @ cclt)) @ (^ [Xn:$i] : XI)))) @ (cwbr @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ (cco @ XR @ (ccfv @ (ccfv @ XI @ cchash) @ ccsqrt) @ ccmul) @ cclt)))))))))))).
...
thf(aalrple_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (cco @ XB2 @ (ccv @ Xx3) @ ccaddc) @ ccle)) @ (^ [Xx3:$i] : ccrp))))))).
thf(crrnequiv_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ (cco @ cccnfld @ ccr @ ccress) @ XI @ ccpws)) => ((cwceq @ XD @ (ccfv @ XY @ ccds)) => ((cwceq @ XX @ (cco @ ccr @ XI @ ccmap)) => ((cwi @ Xph @ (cwcel @ XI @ ccfn)) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XF @ XX) @ (cwcel @ XG @ XX))) @ (cwa @ (cwbr @ (cco @ XF @ XG @ XD) @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ ccle) @ (cwbr @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ (cco @ (ccfv @ (ccfv @ XI @ cchash) @ ccsqrt) @ (cco @ XF @ XG @ XD) @ ccmul) @ ccle))))))))))))))).
