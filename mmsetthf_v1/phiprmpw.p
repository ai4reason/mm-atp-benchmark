...
thf(aphival_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccphi) @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XN @ ccgcd) @ cc1)) @ (^ [Xx3:$i] : (cco @ cc1 @ XN @ ccfz))) @ cchash))))).
...
thf(cphiprmpw_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XK @ ccn)) @ (cwceq @ (ccfv @ (cco @ XP @ XK @ ccexp) @ ccphi) @ (cco @ (cco @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccexp) @ (cco @ XP @ cc1 @ ccmin) @ ccmul)))))).
