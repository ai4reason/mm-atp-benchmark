...
thf(cee4anv_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xz @ Xw)))))))))) @ (cwa @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwex @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (Xps @ Xz @ Xw)))))))))).
