...
thf(ctgldimor_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XP @ (ccfv @ XF @ XE)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => (cwi @ Xph @ (cwo @ (cwceq @ (ccfv @ XP @ cchash) @ cc1) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle))))))))))).
