...
thf(ceqfnfv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ (XB2 @ Xx3))) @ (cwb @ (cwceq @ XF @ XG) @ (cwa @ (cwceq @ XA2 @ (XB2 @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2))))))))))).
