...
thf(aodzval_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ cc1 @ ccmin) @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
...
thf(codzcllem_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwa @ (cwcel @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccn) @ (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccexp) @ cc1 @ ccmin) @ ccdvds)))))).
