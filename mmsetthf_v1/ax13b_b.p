...
thf(cax13b_b_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xz:$i] : (cwb @ (cwi @ (cwn @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)) @ (Xph @ Xx3 @ Xz))) @ (cwi @ (cwn @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwi @ (cwn @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz))) @ (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)) @ (Xph @ Xx3 @ Xz))))))))).
