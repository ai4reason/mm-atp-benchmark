...
thf(amodid0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccrp) @ (cwceq @ (cco @ XN @ XN @ ccmo) @ ccc0)))).
...
thf(acrctcshwlkn0lem2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (cco @ cc1 @ XN @ ccfzo))) => ((! [Xx3:$i] : (cwceq @ (XQ @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP)))))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XJ @ (cco @ ccc0 @ (cco @ XN @ XS @ ccmin) @ ccfz))) @ (cwceq @ (ccfv @ XJ @ (XQ @ Xx3)) @ (ccfv @ (cco @ XJ @ XS @ ccaddc) @ XP))))))))))))).
...
thf(acrctcshwlkn0lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn)) @ (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc1 @ ccaddc) @ XA2 @ ccle))))).
...
thf(aubmelfzo_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (cco @ XN @ XK @ ccmin) @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(ccrctcshwlkn0lem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (cco @ cc1 @ XN @ ccfzo))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XQ @ Xx3 @ Xi) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XH @ Xx3 @ Xi) @ (cco @ (XF @ Xx3) @ XS @ cccsh)))) => ((! [Xx3:$i] : (cwceq @ XN @ (ccfv @ (XF @ Xx3) @ cchash))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3) @ (ccword @ (XA2 @ Xx3 @ Xi)))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwral @ (^ [Xi:$i] : (cwif @ (cwceq @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3)) @ (XI @ Xx3)) @ (ccsn @ (ccfv @ (ccv @ Xi) @ XP))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3)) @ (XI @ Xx3))))) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfzo))))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XN @ XP) @ (ccfv @ ccc0 @ XP))) => (! [Xx3:$i] : (! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (XJ @ Xi) @ (cco @ XN @ XS @ ccmin))) @ (cwif @ (cwceq @ (ccfv @ (XJ @ Xi) @ (XQ @ Xx3 @ Xi)) @ (ccfv @ (cco @ (XJ @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi))) @ (cwceq @ (ccfv @ (ccfv @ (XJ @ Xi) @ (XH @ Xx3 @ Xi)) @ (XI @ Xx3)) @ (ccsn @ (ccfv @ (XJ @ Xi) @ (XQ @ Xx3 @ Xi)))) @ (cwss @ (ccpr @ (ccfv @ (XJ @ Xi) @ (XQ @ Xx3 @ Xi)) @ (ccfv @ (cco @ (XJ @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi))) @ (ccfv @ (ccfv @ (XJ @ Xi) @ (XH @ Xx3 @ Xi)) @ (XI @ Xx3))))))))))))))))))))))))).
