...
thf(cisdrngo1_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwb @ (cwcel @ XR @ ccdrng) @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ (ccres @ XH @ (ccxp @ (ccdif @ XX @ (ccsn @ XZ)) @ (ccdif @ XX @ (ccsn @ XZ)))) @ ccgr))))))))))))).
