...
thf(cgcdcllem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xy1 @ Xz @ Xn) @ (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xn:$i] : XA2))) @ (^ [Xz:$i] : ccz)))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwss @ XA2 @ ccz) @ (cwrex @ (^ [Xn:$i] : (cwne @ (ccv @ Xn) @ ccc0)) @ (^ [Xn:$i] : XA2))) @ (cwa @ (cwne @ (XS @ Xy1 @ Xz @ Xn) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XS @ Xy1 @ Xz @ Xn)))) @ (^ [Xx3:$i] : ccz))))))))))).
