...
thf(cbcth2_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwne @ XX @ cc0)) @ (cwa @ (cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM) @ (cwceq @ (ccuni @ (ccrn @ XM)) @ XX))) @ (cwrex @ (^ [Xk:$i] : (cwne @ (ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ ccnt)) @ cc0)) @ (^ [Xk:$i] : ccn))))))))).
