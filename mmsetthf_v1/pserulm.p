...
thf(aulm0_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => ((cwi @ Xph @ (cwf @ XS @ ccc @ XG)) => (cwi @ (cwa @ Xph @ (cwceq @ XS @ cc0)) @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm)))))))))))))).
