...
thf(amarepvfval_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XA2 @ Xv @ Xi @ Xj @ Xk @ Xm) @ (cco @ XN @ XR @ ccmat))))))) => ((! [Xv:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk) @ (ccfv @ (XA2 @ Xv @ Xi @ Xj @ Xk @ Xm) @ ccbs))))))) => ((! [Xv:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XQ @ Xv @ Xi @ Xj @ Xk @ Xm) @ (cco @ XN @ XR @ ccmatrepV))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XV @ Xi @ Xj @ Xk) @ (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap))))) => (! [Xv:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XQ @ Xv @ Xi @ Xj @ Xk @ Xm) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xv:$i] : (XB2 @ Xi @ Xj @ Xk))) @ (^ [Xm:$i] : (^ [Xv:$i] : (XV @ Xi @ Xj @ Xk))) @ (^ [Xm:$i] : (^ [Xv:$i] : (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xv)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)))))))))))))))))))))))))))).
