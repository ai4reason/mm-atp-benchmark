...
thf(acoshalfpi_thm,axiom,(cwceq @ (ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ cccos) @ ccc0)).
...
thf(ccoshalfpip_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccaddc) @ cccos) @ (ccneg @ (ccfv @ XA2 @ ccsin)))))).
