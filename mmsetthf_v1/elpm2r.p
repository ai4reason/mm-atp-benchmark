...
thf(celpm2r_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwa @ (cwf @ XC @ XA2 @ XF) @ (cwss @ XC @ XB2))) @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ ccpm)))))))))).
