...
thf(aesumpcvgval_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xl:$i] : (cwi @ (cwa @ (Xph @ Xl) @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xk:$i] : (! [Xl:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccv @ Xl)) @ (cwceq @ (XA2 @ Xk) @ (XB2 @ Xl))))) => ((! [Xl:$i] : (cwi @ (Xph @ Xl) @ (cwcel @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))))) @ (ccdm @ ccli)))) => (! [Xl:$i] : (cwi @ (Xph @ Xl) @ (cwceq @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsu @ ccn @ (^ [Xk:$i] : (XA2 @ Xk))))))))))))).
...
thf(aicossioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XD @ XB2 @ ccle))) @ (cwss @ (cco @ XC @ XD @ ccico) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(cesumcvgsum_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccv @ Xi)) @ (cwceq @ (XA2 @ Xk) @ (XB2 @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xi) @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xi) @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XF @ Xi)) @ (XA2 @ Xk))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xi) @ (cwbr @ (ccseq @ ccaddc @ (XF @ Xi) @ cc1) @ (XL @ Xi @ Xk) @ ccli)))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XL @ Xi @ Xk) @ ccr)))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwceq @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsu @ ccn @ (^ [Xk:$i] : (XA2 @ Xk))))))))))))))))).
