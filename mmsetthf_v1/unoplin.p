...
thf(aunopf1o_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccuo) @ (cwf1o @ cchil @ cchil @ XT)))).
...
thf(aunopadj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ ccuo) @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ (ccfv @ XA2 @ XT) @ XB2 @ ccsp) @ (cco @ XA2 @ (ccfv @ XB2 @ (cccnv @ XT)) @ ccsp))))))).
...
thf(acnvunop_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccuo) @ (cwcel @ (cccnv @ XT) @ ccuo)))).
thf(ahiassdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil)) @ (cwa @ (cwcel @ XC @ cchil) @ (cwcel @ XD @ cchil))) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ ccva) @ XD @ ccsp) @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XD @ ccsp) @ ccmul) @ (cco @ XC @ XD @ ccsp) @ ccaddc)))))))).
...
thf(cunoplin_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccuo) @ (cwcel @ XT @ cclo)))).
