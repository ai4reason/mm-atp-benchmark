...
thf(chmeores_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) @ (cwss @ XY @ XX)) @ (cwcel @ (ccres @ XF @ XY) @ (cco @ (cco @ XJ @ XY @ ccrest) @ (cco @ XK @ (ccima @ XF @ XY) @ ccrest) @ cchmeo)))))))))).
