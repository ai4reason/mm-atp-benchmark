...
thf(axpcomeng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwbr @ (ccxp @ XA2 @ XB2) @ (ccxp @ XB2 @ XA2) @ ccen))))))).
...
thf(comxpen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccomu) @ (ccxp @ XA2 @ XB2) @ ccen))))).
