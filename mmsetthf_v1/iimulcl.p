...
thf(ciimulcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwcel @ XB2 @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ ccc0 @ cc1 @ ccicc)))))).
