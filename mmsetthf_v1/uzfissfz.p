...
thf(cuzfissfz_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XM @ ccz))) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ XA2 @ XZ))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ ccfn))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xk:$i] : (cwss @ XA2 @ (cco @ XM @ (ccv @ Xk) @ ccfz))) @ (^ [Xk:$i] : XZ))))))))))))).
