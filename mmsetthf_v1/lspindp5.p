...
thf(clspindp5_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ (ccfv @ (ccpr @ XX @ XU) @ XN))) => ((cwi @ Xph @ (cwn @ (cwcel @ XZ @ (ccfv @ (ccpr @ XX @ XY) @ XN)))) => (cwi @ Xph @ (cwn @ (cwcel @ XU @ (ccfv @ (ccpr @ XX @ XY) @ XN))))))))))))))))))))).
