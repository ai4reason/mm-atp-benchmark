...
thf(atcwf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ (ccfv @ XA2 @ cctc) @ (ccuni @ (ccima @ ccr1 @ ccon0)))))).
...
thf(ctcrank_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwceq @ (ccfv @ XA2 @ ccrnk) @ (ccima @ ccrnk @ (ccfv @ XA2 @ cctc)))))).
