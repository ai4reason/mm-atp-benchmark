...
thf(atrufil_thm,axiom,(! [XA2:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XL @ (ccfv @ XY @ ccufil)) @ (cwss @ XA2 @ XY)) @ (cwb @ (cwcel @ (cco @ XL @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccufil)) @ (cwcel @ XA2 @ XL))))))).
...
thf(cssufl_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ ccufl) @ (cwss @ XY @ XX)) @ (cwcel @ XY @ ccufl))))).
