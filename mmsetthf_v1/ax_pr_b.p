...
thf(azfpair_b_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xx3)) @ ccvv))).
...
thf(cax_pr_b_conj,conjecture,(! [Xx3:$i] : (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwo @ (cwceq @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwceq @ (ccv @ Xw) @ (ccv @ Xx3))) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xz))))))))).
