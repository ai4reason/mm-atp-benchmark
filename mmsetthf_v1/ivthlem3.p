...
thf(aivthlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xz) @ ccr))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ ccr)) => ((! [Xz:$i] : (cwi @ Xph @ (cwbr @ (XA2 @ Xz) @ XB2 @ cclt))) => ((! [Xz:$i] : (cwi @ Xph @ (cwss @ (cco @ (XA2 @ Xz) @ XB2 @ ccicc) @ XD))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ (XA2 @ Xz) @ XB2 @ ccicc))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr)))) => ((! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwbr @ (ccfv @ (XA2 @ Xz) @ XF) @ XU @ cclt) @ (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt)))) => ((! [Xz:$i] : (cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XU @ ccle)) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xz) @ XB2 @ ccicc))))) => (! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XA2 @ Xz) @ XS) @ (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ XB2 @ ccle)) @ (^ [Xz:$i] : XS)))))))))))))))))))))).
...
thf(aivthlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((cwi @ Xph @ (cwa @ (cwbr @ (ccfv @ XA2 @ XF) @ XU @ cclt) @ (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt))) => ((cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XU @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) => ((cwceq @ XC @ (ccsup @ XS @ ccr @ cclt)) => (cwi @ Xph @ (cwn @ (cwbr @ (ccfv @ XC @ XF) @ XU @ cclt)))))))))))))))))))))).
...
thf(acncfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf)) @ (cwcel @ XC @ XA2) @ (cwcel @ XR @ ccrp)) @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccfv @ (cco @ (ccv @ Xw) @ XC @ ccmin) @ ccabs) @ (ccv @ Xz) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ XF) @ (ccfv @ XC @ XF) @ ccmin) @ ccabs) @ XR @ cclt))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : ccrp))))))))).
...
thf(altsubrp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XA2 @ cclt))))).
...
thf(altsub23d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XC @ ccmin) @ XB2 @ cclt))))))))))).
...
thf(apm3_45_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwi @ Xph @ Xps) @ (cwi @ (cwa @ Xph @ Xch) @ (cwa @ Xps @ Xch))))))).
...
thf(alttri3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwa @ (cwn @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwn @ (cwbr @ XB2 @ XA2 @ cclt))))))))))).
...
thf(altnrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwn @ (cwbr @ XA2 @ XA2 @ cclt))))))).
thf(anotbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ Xph @ (cwb @ (cwn @ Xps) @ (cwn @ Xch)))))))).
thf(altlend_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwne @ XB2 @ XA2)))))))))).
...
thf(civthlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((cwi @ Xph @ (cwa @ (cwbr @ (ccfv @ XA2 @ XF) @ XU @ cclt) @ (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt))) => ((cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XU @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) => ((cwceq @ XC @ (ccsup @ XS @ ccr @ cclt)) => (cwi @ Xph @ (cwa @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) @ (cwceq @ (ccfv @ XC @ XF) @ XU)))))))))))))))))))))).
