...
thf(arami_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XC @ Xi @ Xa @ Xb) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xi:$i] : ccn0)) @ (^ [Xa:$i] : (^ [Xi:$i] : (ccrab @ (^ [Xb:$i] : (cwceq @ (ccfv @ (ccv @ Xb) @ cchash) @ (ccv @ Xi))) @ (^ [Xb:$i] : (ccpw @ (ccv @ Xa))))))))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwcel @ XM @ ccn0))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwcel @ (XR @ Xi @ Xa @ Xb) @ (XV @ Xi @ Xa @ Xb)))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwf @ (XR @ Xi @ Xa @ Xb) @ ccn0 @ (XF @ Xi @ Xa @ Xb)))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwcel @ (cco @ XM @ (XF @ Xi @ Xa @ Xb) @ ccram) @ ccn0))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwcel @ (XS @ Xi @ Xa @ Xb) @ (XW @ Xx3 @ Xi @ Xa @ Xb @ Xc)))))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwbr @ (cco @ XM @ (XF @ Xi @ Xa @ Xb) @ ccram) @ (ccfv @ (XS @ Xi @ Xa @ Xb) @ cchash) @ ccle))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwf @ (cco @ (XS @ Xi @ Xa @ Xb) @ XM @ (XC @ Xi @ Xa @ Xb)) @ (XR @ Xi @ Xa @ Xb) @ (XG @ Xi @ Xa @ Xb)))))) => (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xi @ Xa @ Xb) @ (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xc) @ (XF @ Xi @ Xa @ Xb)) @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle) @ (cwss @ (cco @ (ccv @ Xx3) @ XM @ (XC @ Xi @ Xa @ Xb)) @ (ccima @ (cccnv @ (XG @ Xi @ Xa @ Xb)) @ (ccsn @ (ccv @ Xc)))))) @ (^ [Xx3:$i] : (ccpw @ (XS @ Xi @ Xa @ Xb))))) @ (^ [Xc:$i] : (XR @ Xi @ Xa @ Xb))))))))))))))))))))))))).
...
thf(aramxrcl_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ XV) @ (cwf @ XR @ ccn0 @ XF)) @ (cwcel @ (cco @ XM @ XF @ ccram) @ ccxr))))))).
