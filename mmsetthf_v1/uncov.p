...
thf(adf_unc_ax,axiom,(! [XF:($i > $o)] : (cwceq @ (ccunc @ XF) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccfv @ (ccv @ Xx3) @ XF))))))))).
...
thf(cuncov_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (cco @ XA2 @ XB2 @ (ccunc @ XF)) @ (ccfv @ XB2 @ (ccfv @ XA2 @ XF)))))))))).
