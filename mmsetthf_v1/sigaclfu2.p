...
thf(asigaclcu2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xk) @ XS)) @ (^ [Xk:$i] : ccn))) @ (cwcel @ (cciun @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XS))))).
thf(csigaclfu2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xk) @ XS)) @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfzo)))) @ (cwcel @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfzo)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XS)))))).
