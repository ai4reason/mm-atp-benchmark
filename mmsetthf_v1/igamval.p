...
thf(adf_igam_ax,axiom,(cwceq @ ccigam @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccdif @ ccz @ ccn)) @ ccc0 @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccgam) @ ccdiv)))))).
...
thf(cigamval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccigam) @ (ccif @ (cwcel @ XA2 @ (ccdif @ ccz @ ccn)) @ ccc0 @ (cco @ cc1 @ (ccfv @ XA2 @ ccgam) @ ccdiv)))))).
