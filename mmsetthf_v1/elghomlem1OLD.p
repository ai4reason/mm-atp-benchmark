...
thf(adf_ghomOLD_ax,axiom,(cwceq @ ccghomOLD @ (ccmpt2 @ (^ [Xg1:$i] : (^ [Xh:$i] : ccgr)) @ (^ [Xg1:$i] : (^ [Xh:$i] : ccgr)) @ (^ [Xg1:$i] : (^ [Xh:$i] : (ccab @ (^ [Xf1:$i] : (cwa @ (cwf @ (ccrn @ (ccv @ Xg1)) @ (ccrn @ (ccv @ Xh)) @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xh)) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xg1))))) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1)))))))))))).
thf(celghomlem1OLD_conj,conjecture,(! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwa @ (cwf @ (ccrn @ XG) @ (ccrn @ XH) @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ XH) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccrn @ XG)))) @ (^ [Xx3:$i] : (ccrn @ XG)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccgr) @ (cwcel @ XH @ ccgr)) @ (cwceq @ (cco @ XG @ XH @ ccghomOLD) @ (XS @ Xx3 @ Xy1 @ Xf1))))))))))).
