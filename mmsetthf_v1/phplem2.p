...
thf(aphplem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ XA2)) @ (cwceq @ (ccun @ (ccsn @ XA2) @ (ccdif @ XA2 @ (ccsn @ XB2))) @ (ccdif @ (ccsuc @ XA2) @ (ccsn @ XB2))))))).
thf(cphplem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ XA2)) @ (cwbr @ XA2 @ (ccdif @ (ccsuc @ XA2) @ (ccsn @ XB2)) @ ccen))))))).
