...
thf(acnlimci_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XA2 @ XD @ cccncf))) => ((cwi @ Xph @ (cwcel @ XB2 @ XA2)) => (cwi @ Xph @ (cwcel @ (ccfv @ XB2 @ XF) @ (cco @ XF @ XB2 @ cclimc))))))))))).
...
thf(alimccnp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XD @ XF)) => ((cwi @ Xph @ (cwss @ XD @ ccc)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XJ @ (cco @ XK @ XD @ ccrest)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XF @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ XC @ (cco @ XJ @ XK @ cccnp)))) => (cwi @ Xph @ (cwcel @ (ccfv @ XC @ XG) @ (cco @ (cccom @ XG @ XF) @ XB2 @ cclimc))))))))))))))))))).
...
thf(adivcn_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XK @ (cco @ XJ @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccrest)) => (cwcel @ ccdiv @ (cco @ (cco @ XJ @ XK @ cctx) @ XJ @ cccn))))))).
...
thf(af1ocnvfvb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) @ (cwb @ (cwceq @ (ccfv @ XC @ XF) @ XD) @ (cwceq @ (ccfv @ XD @ (cccnv @ XF)) @ XC))))))))).
...
thf(cdvcnvlem_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XK @ (cco @ XJ @ XS @ ccrest)) => ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwcel @ XY @ XK)) => ((cwi @ Xph @ (cwf1o @ XX @ XY @ XF)) => ((cwi @ Xph @ (cwcel @ (cccnv @ XF) @ (cco @ XY @ XX @ cccncf))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ XX)) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccrn @ (cco @ XS @ XF @ ccdv))))) => ((cwi @ Xph @ (cwcel @ XC @ XX)) => (cwi @ Xph @ (cwbr @ (ccfv @ XC @ XF) @ (cco @ cc1 @ (ccfv @ XC @ (cco @ XS @ XF @ ccdv)) @ ccdiv) @ (cco @ XS @ (cccnv @ XF) @ ccdv))))))))))))))))))))).
