...
thf(aabsre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ (ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccsqrt))))).
thf(aabsval2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ (ccfv @ (cco @ (cco @ (ccfv @ XA2 @ ccre) @ cc2 @ ccexp) @ (cco @ (ccfv @ XA2 @ ccim) @ cc2 @ ccexp) @ ccaddc) @ ccsqrt))))).
thf(cabsrele_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ ccre) @ ccabs) @ (ccfv @ XA2 @ ccabs) @ ccle)))).
