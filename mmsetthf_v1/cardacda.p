...
thf(ccardacda_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd))) @ (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (cco @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd) @ ccoa) @ ccen))))).
