...
thf(alplnnle2at_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XP) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2))) @ (cwn @ (cwbr @ XX @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))))))))))))))).
...
thf(alplni2_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2)) @ (cwa @ (cwne @ XQ @ XR) @ (cwn @ (cwbr @ XS @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))) @ (cwcel @ (cco @ (cco @ XQ @ XR @ Xc_or) @ XS @ Xc_or) @ XP))))))))))))))).
thf(alplnnlt_thm,axiom,(! [XP:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XP) @ (cwcel @ XY @ XP)) @ (cwn @ (cwbr @ XX @ XY @ Xc_lt))))))))))).
