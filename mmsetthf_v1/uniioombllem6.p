...
thf(ar19_2uz_thm,axiom,(! [Xph:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => (cwi @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xph @ Xk)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)) @ (cwrex @ (^ [Xk:$i] : (Xph @ Xk)) @ (^ [Xk:$i] : XZ)))))))).
...
thf(auniioombllem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XS @ Xx3 @ Xz) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1)))) => ((cwceq @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XE @ Xx3 @ Xz) @ ccovol) @ ccr)))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwss @ (XE @ Xx3 @ Xz) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG))))))) => ((cwceq @ XT @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3 @ Xz) @ ccovol) @ XC @ ccaddc) @ ccle)))) => ((cwceq @ XH @ (ccmpt @ (^ [Xz:$i] : ccn) @ (^ [Xz:$i] : (ccin @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccioo) @ (ccfv @ (ccfv @ XJ @ XG) @ ccioo))))) => ((cwceq @ XK @ (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt)))))) => (cwi @ (cwa @ Xph @ (cwcel @ XJ @ ccn)) @ (cwbr @ (ccseq @ ccaddc @ (cccom @ ccovol @ XH) @ cc1) @ (ccfv @ (ccin @ (ccfv @ (ccfv @ XJ @ XG) @ ccioo) @ XA2) @ ccovol) @ ccli)))))))))))))))))))))))))).
...
thf(arexfiuz_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwb @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (Xph @ Xk @ Xn)) @ (^ [Xn:$i] : XA2))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz)) @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xph @ Xk @ Xn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz))) @ (^ [Xn:$i] : XA2))))))).
thf(aanassrs_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xth) => (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth))))))).
thf(cc2_tp,type,(cc2 : ($i > $o))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(auniioombllem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XS @ Xx3 @ Xi @ Xj) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))))) => ((! [Xi:$i] : (cwceq @ (XA2 @ Xi) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XE @ Xx3 @ Xi @ Xj) @ ccovol) @ ccr))))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwss @ (XE @ Xx3 @ Xi @ Xj) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG)))))))) => ((cwceq @ XT @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3 @ Xi @ Xj) @ ccovol) @ XC @ ccaddc) @ ccle))))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (ccfv @ XM @ XT) @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccmin) @ ccabs) @ XC @ cclt)) => ((! [Xi:$i] : (cwceq @ (XK @ Xi) @ (ccuni @ (ccima @ (cccom @ ccioo @ XG) @ (cco @ cc1 @ XM @ ccfz))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3) @ ccn))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ Xph @ (cwral @ (^ [Xj:$i] : (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccin @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ ccioo) @ (ccfv @ (ccfv @ (ccv @ Xj) @ XG) @ ccioo)) @ ccovol))) @ (ccfv @ (ccin @ (ccfv @ (ccfv @ (ccv @ Xj) @ XG) @ ccioo) @ (XA2 @ Xi)) @ ccovol) @ ccmin) @ ccabs) @ (cco @ XC @ XM @ ccdiv) @ cclt)) @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XL @ Xx3 @ Xi @ Xj) @ (ccuni @ (ccima @ (cccom @ ccioo @ XF) @ (cco @ cc1 @ (XN @ Xx3) @ ccfz))))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ (ccin @ (XE @ Xx3 @ Xi @ Xj) @ (XA2 @ Xi)) @ ccovol) @ (ccfv @ (ccdif @ (XE @ Xx3 @ Xi @ Xj) @ (XA2 @ Xi)) @ ccovol) @ ccaddc) @ (cco @ (ccfv @ (XE @ Xx3 @ Xi @ Xj) @ ccovol) @ (cco @ cc4 @ XC @ ccmul) @ ccaddc) @ ccle)))))))))))))))))))))))))))))))))).
...
thf(cuniioombllem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((cwceq @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XE @ Xx3) @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XE @ Xx3) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG)))))) => ((cwceq @ XT @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3) @ ccovol) @ XC @ ccaddc) @ ccle))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ (ccin @ (XE @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (XE @ Xx3) @ XA2) @ ccovol) @ ccaddc) @ (cco @ (ccfv @ (XE @ Xx3) @ ccovol) @ (cco @ cc4 @ XC @ ccmul) @ ccaddc) @ ccle)))))))))))))))))))))).
