...
thf(adf_fmtno_ax,axiom,(cwceq @ ccfmtno @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ cc2 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccexp) @ cc1 @ ccaddc))))).
...
thf(aexpcan_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwb @ (cwceq @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp)) @ (cwceq @ XM @ XN))))))).
