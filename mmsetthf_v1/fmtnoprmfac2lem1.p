...
thf(afmtnoprmfac1_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) @ (cwrex @ (^ [Xk:$i] : (cwceq @ XP @ (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn)))))).
...
thf(algsvalmod_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) @ (cwceq @ (cco @ (cco @ XA2 @ XP @ cclgs) @ XP @ ccmo) @ (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo)))))).
...
thf(azdiv_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwrex @ (^ [Xk:$i] : (cwceq @ (cco @ XM @ (ccv @ Xk) @ ccmul) @ XN)) @ (^ [Xk:$i] : ccz)) @ (cwcel @ (cco @ XN @ XM @ ccdiv) @ ccz)))))).
...
thf(amulp1mod1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) @ (cwceq @ (cco @ (cco @ (cco @ XN @ XA2 @ ccmul) @ cc1 @ ccaddc) @ XN @ ccmo) @ cc1))))).
...
thf(cfmtnoprmfac2lem1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) @ (cwceq @ (cco @ (cco @ cc2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) @ cc1))))).
