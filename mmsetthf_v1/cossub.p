...
thf(acosneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (ccneg @ XA2) @ cccos) @ (ccfv @ XA2 @ cccos))))).
thf(asinneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (ccneg @ XA2) @ ccsin) @ (ccneg @ (ccfv @ XA2 @ ccsin)))))).
...
thf(ccossub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cccos) @ (cco @ (cco @ (ccfv @ XA2 @ cccos) @ (ccfv @ XB2 @ cccos) @ ccmul) @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) @ ccaddc)))))).
