...
thf(cdsmm0cl_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XH @ (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccmnd @ XR)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => (cwi @ Xph @ (cwcel @ Xc_0 @ XH)))))))))))))))))).
