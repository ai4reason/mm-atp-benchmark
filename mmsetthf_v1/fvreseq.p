...
thf(cfvreseq_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwa @ (cwa @ (cwfn @ XF @ (XA2 @ Xx3)) @ (cwfn @ XG @ (XA2 @ Xx3))) @ (cwss @ XB2 @ (XA2 @ Xx3))) @ (cwb @ (cwceq @ (ccres @ XF @ XB2) @ (ccres @ XG @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XB2)))))))))).
