...
thf(adf_metid_ax,axiom,(cwceq @ ccmetid @ (ccmpt @ (^ [Xd:$i] : (ccuni @ (ccrn @ ccpsmet))) @ (^ [Xd:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccdm @ (ccdm @ (ccv @ Xd)))) @ (cwcel @ (ccv @ Xy1) @ (ccdm @ (ccdm @ (ccv @ Xd))))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)) @ ccc0))))))))).
...
thf(cmetidval_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwceq @ (ccfv @ XD @ ccmetid) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX)) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccc0)))))))))).
