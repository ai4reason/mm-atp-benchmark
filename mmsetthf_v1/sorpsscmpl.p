...
thf(asorpss_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwor @ XA2 @ ccrpss) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwo @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwss @ (ccv @ Xy1) @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
thf(csorpsscmpl_conj,conjecture,(! [XA2:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwor @ XY @ ccrpss) @ (cwor @ (ccrab @ (^ [Xu:$i] : (cwcel @ (ccdif @ XA2 @ (ccv @ Xu)) @ XY)) @ (^ [Xu:$i] : (ccpw @ XA2))) @ ccrpss))))).
