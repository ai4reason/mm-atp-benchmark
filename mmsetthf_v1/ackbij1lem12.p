...
thf(cackbij1lem12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwi @ (cwa @ (cwcel @ XB2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ (cwss @ XA2 @ XB2)) @ (cwss @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)))))))).
