...
thf(agzrngunit_thm,axiom,(! [XA2:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (cco @ cccnfld @ ccgz @ ccress)) => (cwb @ (cwcel @ XA2 @ (ccfv @ XZ @ ccui)) @ (cwa @ (cwcel @ XA2 @ ccgz) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ cc1))))))).
...
thf(czringunit_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccfv @ czring @ ccui)) @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ cc1))))).
