...
thf(aovoliunlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : ((cwceq @ XT @ (ccseq @ ccaddc @ XG @ cc1)) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccfv @ (ccv @ Xn) @ XF)) @ cc1))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XU @ Xk @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XH @ Xk)) @ cc1)))) => ((! [Xk:$i] : (cwceq @ (XH @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc2nd) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc1st) @ XF)))))) => ((cwi @ Xph @ (cwf1o @ ccn @ (ccxp @ ccn @ ccn) @ XJ)) => ((cwi @ Xph @ (cwf @ ccn @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap) @ XF)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccfv @ (ccv @ Xn) @ XF))))))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwbr @ (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ (XA2 @ Xn) @ ccovol) @ (cco @ XB2 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccaddc) @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (cco @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ XB2 @ ccaddc) @ ccle)))))))))))))))))))))))))).
...
thf(covoliunlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XT @ (ccseq @ ccaddc @ XG @ cc1)) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (cco @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ XB2 @ ccaddc) @ ccle)))))))))))))).
