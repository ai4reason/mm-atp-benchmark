...
thf(cdisjpr2OLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)) @ (cwa @ (cwne @ XA2 @ XD) @ (cwne @ XB2 @ XD))) @ (cwceq @ (ccin @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ cc0))))))).
