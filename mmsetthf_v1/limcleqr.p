...
thf(climcleqr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ (ccres @ XF @ (cco @ ccmnf @ XB2 @ ccioo)) @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ (ccres @ XF @ (cco @ XB2 @ ccpnf @ ccioo)) @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwceq @ XL @ XR)) => (cwi @ Xph @ (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc)))))))))))))))))))).
