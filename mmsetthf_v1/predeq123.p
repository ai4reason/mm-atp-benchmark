...
thf(cpredeq123_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwceq @ XR @ XS) @ (cwceq @ XA2 @ XB2) @ (cwceq @ XX @ XY)) @ (cwceq @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ XB2 @ XS @ XY)))))))))).
