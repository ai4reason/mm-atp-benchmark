...
thf(aelwwlks2on_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XV @ Xf1) @ (ccfv @ XG @ ccvtx))) => (! [Xf1:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XA2 @ (XV @ Xf1)) @ (cwcel @ XC @ (XV @ Xf1))) @ (cwb @ (cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwceq @ XW @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ XW @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc2)))))) @ (^ [Xb:$i] : (XV @ Xf1))))))))))))).
...
thf(celwwlks2_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ ccupgr) @ (cwb @ (cwcel @ XW @ (cco @ cc2 @ XG @ ccwwlksn)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwa @ (cwceq @ XW @ (ccs3 @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc))) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc2) @ (cw3a @ (cwceq @ (ccv @ Xa) @ (ccfv @ ccc0 @ (ccv @ Xp))) @ (cwceq @ (ccv @ Xb) @ (ccfv @ cc1 @ (ccv @ Xp))) @ (cwceq @ (ccv @ Xc) @ (ccfv @ cc2 @ (ccv @ Xp))))))))))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
