...
thf(aimass2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => (cwi @ Xph @ (cwss @ (ccima @ XC @ XA2) @ (ccima @ XC @ XB2))))))))).
thf(aicossico2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwbr @ XB2 @ XA2 @ ccle)) => (cwi @ Xph @ (cwss @ (cco @ XA2 @ XC @ ccico) @ (cco @ XB2 @ XC @ ccico))))))))))).
...
thf(ainfxrlesupxr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => (cwi @ Xph @ (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))).
...
thf(aralrnmpt3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3)) @ (cwb @ (Xps @ Xy1) @ (Xch @ Xx3))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwb @ (cwral @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) @ (cwral @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))))))))))).
...
thf(asupxrleubrnmptf_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ ccxr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwbr @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccxr @ cclt) @ (XC @ Xx3) @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
...
thf(aliminfvald_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ XF @ cclsi) @ (ccsup @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))))).
thf(alimsupvald_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ XF @ cclsp) @ (ccinf @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))))).
thf(climinflelimsuplem_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (XV @ Xj @ Xk))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwne @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xj) @ ccpnf @ ccico)) @ ccxr) @ cc0)) @ (^ [Xj:$i] : (cco @ (ccv @ Xk) @ ccpnf @ ccico)))) @ (^ [Xk:$i] : ccr)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccfv @ XF @ cclsi) @ (ccfv @ XF @ cclsp) @ ccle))))))))).
