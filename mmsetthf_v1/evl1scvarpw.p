...
thf(aevl1varpw_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XQ @ (ccfv @ XR @ cce1)) => ((cwceq @ XW @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XG @ (ccfv @ XW @ ccmgp)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XN @ XX @ Xc_ex) @ XQ) @ (cco @ XN @ (ccfv @ XX @ XQ) @ (ccfv @ (ccfv @ (cco @ XR @ XB2 @ ccpws) @ ccmgp) @ ccmg)))))))))))))))))))))).
thf(aoveqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XC @ XD @ XA2) @ (cco @ XC @ XD @ XB2)))))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(aeqtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XB2 @ XC) => (cwceq @ XA2 @ XC))))))).
thf(afveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(cevl1scvarpw_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XQ @ (ccfv @ XR @ cce1)) => ((cwceq @ XW @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XG @ (ccfv @ XW @ ccmgp)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwceq @ Xc_xp @ (ccfv @ XW @ ccvsca)) => ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((cwceq @ XS @ (cco @ XR @ XB2 @ ccpws)) => ((cwceq @ Xc_xb @ (ccfv @ XS @ ccmulr)) => ((cwceq @ XM @ (ccfv @ XS @ ccmgp)) => ((cwceq @ XF @ (ccfv @ XM @ ccmg)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ XN @ XX @ Xc_ex) @ Xc_xp) @ XQ) @ (cco @ (ccxp @ XB2 @ (ccsn @ XA2)) @ (cco @ XN @ (ccfv @ XX @ XQ) @ XF) @ Xc_xb))))))))))))))))))))))))))))))))).
