...
thf(a_3orel3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwn @ Xch) @ (cwi @ (cw3o @ Xph @ Xps @ Xch) @ (cwo @ Xph @ Xps))))))).
...
thf(cnolesgn2o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XX @ ccon0)) @ (cwa @ (cwceq @ (ccres @ XA2 @ XX) @ (ccres @ XB2 @ XX)) @ (cwceq @ (ccfv @ XX @ XA2) @ cc2o)) @ (cwn @ (cwbr @ XB2 @ XA2 @ ccslt))) @ (cwceq @ (ccfv @ XX @ XB2) @ cc2o)))))).
