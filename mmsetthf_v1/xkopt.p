...
thf(arestdis_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwss @ XB2 @ XA2)) @ (cwceq @ (cco @ (ccpw @ XA2) @ XB2 @ ccrest) @ (ccpw @ XB2))))))).
...
thf(aptuniconst_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt)) => ((cwceq @ XX @ (ccuni @ XR)) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XR @ cctop)) @ (cwceq @ (cco @ XX @ XA2 @ ccmap) @ (ccuni @ XJ))))))))))).
thf(arestid_thm,axiom,(! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ XV) @ (cwceq @ (cco @ XJ @ XX @ ccrest) @ XJ))))))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(axkoptsub_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XR)) => ((cwceq @ XJ @ (ccfv @ (ccxp @ XX @ (ccsn @ XS)) @ ccpt)) => (cwi @ (cwa @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ cctop)) @ (cwss @ (cco @ XJ @ (cco @ XR @ XS @ cccn) @ ccrest) @ (cco @ XS @ XR @ ccxko)))))))))).
thf(cxkopt_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ cctop) @ (cwcel @ XA2 @ XV)) @ (cwceq @ (cco @ XR @ (ccpw @ XA2) @ ccxko) @ (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt))))))).
