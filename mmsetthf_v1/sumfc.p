...
thf(asum2id_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccid))))))).
thf(csumfc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwceq @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))))) @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))))))).
