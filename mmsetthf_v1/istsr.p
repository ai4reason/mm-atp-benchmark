...
thf(adf_tsr_ax,axiom,(cwceq @ cctsr @ (ccrab @ (^ [Xr:$i] : (cwss @ (ccxp @ (ccdm @ (ccv @ Xr)) @ (ccdm @ (ccv @ Xr))) @ (ccun @ (ccv @ Xr) @ (cccnv @ (ccv @ Xr))))) @ (^ [Xr:$i] : ccps)))).
thf(cistsr_conj,conjecture,(! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwb @ (cwcel @ XR @ cctsr) @ (cwa @ (cwcel @ XR @ ccps) @ (cwss @ (ccxp @ XX @ XX) @ (ccun @ XR @ (cccnv @ XR))))))))).
