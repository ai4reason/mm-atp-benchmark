...
thf(ambfi1fseqlem6_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XF @ ccmbf))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xx3 @ Xy1 @ Xg1 @ Xn) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))))) => ((! [Xy1:$i] : (! [Xg1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xy1 @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1 @ Xg1 @ Xn)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1 @ Xg1 @ Xn)) @ (ccv @ Xm)) @ ccc0)))))))))) => (! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwex @ (^ [Xg1:$i] : (cw3a @ (cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) @ (cwral @ (^ [Xn:$i] : (cwa @ (cwbr @ cc0p @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccofr @ ccle)) @ (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (ccofr @ ccle)))) @ (^ [Xn:$i] : ccn)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : ccr)))))))))))))))).
...
thf(cmbfi1fseq_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XF @ ccmbf))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => (! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwex @ (^ [Xg1:$i] : (cw3a @ (cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) @ (cwral @ (^ [Xn:$i] : (cwa @ (cwbr @ cc0p @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccofr @ ccle)) @ (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (ccofr @ ccle)))) @ (^ [Xn:$i] : ccn)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : ccr)))))))))))).
