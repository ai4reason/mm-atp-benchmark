...
thf(aisofval_thm,axiom,(! [XC:($i > $o)] : (cwi @ (cwcel @ XC @ cccat) @ (cwceq @ (ccfv @ XC @ cciso) @ (cccom @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xx3)))) @ (ccfv @ XC @ ccinv)))))).
...
thf(ainvffval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (ccfv @ XC @ ccinv)))) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwceq @ XS @ (ccfv @ XC @ ccsect)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (XN @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccin @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XS) @ (cccnv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XS)))))))))))))))))))))))).
...
thf(cisoval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XN @ (ccfv @ XC @ ccinv)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwceq @ XI @ (ccfv @ XC @ cciso)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ XI) @ (ccdm @ (cco @ XX @ XY @ XN)))))))))))))))))).
