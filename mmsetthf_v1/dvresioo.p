...
thf(cdvresioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccr) @ (cwf @ XA2 @ ccc @ XF)) @ (cwceq @ (cco @ ccr @ (ccres @ XF @ (cco @ XB2 @ XC @ ccioo)) @ ccdv) @ (ccres @ (cco @ ccr @ XF @ ccdv) @ (cco @ XB2 @ XC @ ccioo))))))))).
