...
thf(af1oiso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwf1o @ XA2 @ (XB2 @ Xz @ Xw) @ XH) @ (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwa @ (cwceq @ (ccv @ Xz) @ (ccfv @ (ccv @ Xx3) @ XH)) @ (cwceq @ (ccv @ Xw) @ (ccfv @ (ccv @ Xy1) @ XH))) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))))) @ (cwiso @ XA2 @ (XB2 @ Xz @ Xw) @ XR @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ XH)))))))))))).
thf(asyl6bb_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwb @ Xch @ Xth) => (cwi @ Xph @ (cwb @ Xps @ Xth))))))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(aisoso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwb @ (cwor @ XA2 @ XR) @ (cwor @ XB2 @ XS))))))))).
...
thf(ccnso_conj,conjecture,(cwex @ (^ [Xx3:$i] : (cwor @ ccc @ (ccv @ Xx3))))).
