...
thf(af1oexrnex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwcel @ XB2 @ XV)) @ (cwcel @ XF @ ccvv))))))).
...
thf(acsbnestg_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ (XA2 @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1)) @ (cwceq @ (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xx3:$i] : (ccsb @ (XB2 @ Xx3 @ Xy1) @ (^ [Xy1:$i] : (XC @ Xy1))))) @ (ccsb @ (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))).
...
thf(aelfzmlbm_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ XM @ XN @ ccfz)) @ (cwcel @ (cco @ XK @ XM @ ccmin) @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfz))))))).
...
thf(apoimirlem23_thm,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfzo) @ XT)) => ((cwi @ Xph @ (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ XU)) => ((cwi @ Xph @ (cwcel @ XV @ (cco @ ccc0 @ XN @ ccfz))) => (cwi @ Xph @ (cwb @ (cwrex @ (^ [Xp:$i] : (cwne @ (ccfv @ XN @ (ccv @ Xp)) @ ccc0)) @ (^ [Xp:$i] : (ccrn @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ XV @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ XT @ (ccun @ (ccxp @ (ccima @ XU @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ XU @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))))))))) @ (cwn @ (cwa @ (cwceq @ XV @ XN) @ (cwa @ (cwceq @ (ccfv @ XN @ XT) @ ccc0) @ (cwceq @ (ccfv @ XN @ XU) @ XN))))))))))))))))).
thf(cpoimirlem24_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xj:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (cwceq @ (ccv @ Xp) @ (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))) @ (cwceq @ (XB2 @ Xp) @ (XC @ Xj @ Xs1)))))) => ((! [Xp:$i] : (cwi @ (cwa @ Xph @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp))) @ (cwcel @ (XB2 @ Xp) @ (cco @ ccc0 @ XN @ ccfz)))) => ((cwi @ Xph @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfzo) @ XT)) => ((cwi @ Xph @ (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ XU)) => ((cwi @ Xph @ (cwcel @ XV @ (cco @ ccc0 @ XN @ ccfz))) => (cwi @ Xph @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ XV @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ XT @ (ccun @ (ccxp @ (ccima @ XU @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ XU @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))))))) @ (cwa @ (cwss @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (ccrn @ (ccmpt @ (^ [Xp:$i] : (ccrn @ (ccv @ Xx3))) @ (^ [Xp:$i] : (XB2 @ Xp))))) @ (cwrex @ (^ [Xp:$i] : (cwne @ (ccfv @ XN @ (ccv @ Xp)) @ ccc0)) @ (^ [Xp:$i] : (ccrn @ (ccv @ Xx3))))))) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ ccc0 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ ccmap))) @ (cwa @ (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : (cwceq @ (ccv @ Xi) @ (ccsb @ (ccop @ XT @ XU) @ (^ [Xs1:$i] : (XC @ Xj @ Xs1))))) @ (^ [Xj:$i] : (ccdif @ (cco @ ccc0 @ XN @ ccfz) @ (ccsn @ XV))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ (cwn @ (cwa @ (cwceq @ XV @ XN) @ (cwa @ (cwceq @ (ccfv @ XN @ XT) @ ccc0) @ (cwceq @ (ccfv @ XN @ XU) @ XN)))))))))))))))))))))).
