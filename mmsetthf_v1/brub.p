...
thf(adf_ub_ax,axiom,(! [XR:($i > $o)] : (cwceq @ (ccub @ XR) @ (ccdif @ (ccxp @ ccvv @ ccvv) @ (cccom @ (ccdif @ ccvv @ XR) @ (cccnv @ ccep)))))).
...
thf(cbrub_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XS @ ccvv) => ((cwcel @ XA2 @ ccvv) => (cwb @ (cwbr @ XS @ XA2 @ (ccub @ XR)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ XR)) @ (^ [Xx3:$i] : XS))))))))).
