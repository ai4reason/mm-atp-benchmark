...
thf(adf_cht_ax,axiom,(cwceq @ cccht @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsu @ (ccin @ (cco @ ccc0 @ (ccv @ Xx3) @ ccicc) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog))))))).
...
thf(cchtval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ cccht) @ (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog))))))).
