...
thf(ampt2difsnif_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (cwceq @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ (XA2 @ Xi @ Xj) @ (ccsn @ (XX @ Xi @ Xj))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XB2 @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ (XX @ Xi @ Xj)) @ (XC @ Xi @ Xj) @ (XD @ Xi @ Xj))))) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ (XA2 @ Xi @ Xj) @ (ccsn @ (XX @ Xi @ Xj))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XB2 @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XD @ Xi @ Xj))))))))))).
...
thf(csmadiadetglem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwcel @ XR @ cccrg) => ((cwceq @ XD @ (cco @ XN @ XR @ ccmdat)) => ((cwceq @ XE @ (cco @ (ccdif @ XN @ (ccsn @ XK)) @ XR @ ccmdat)) => (cwi @ (cw3a @ (cwcel @ XM @ XB2) @ (cwcel @ XK @ XN) @ (cwcel @ XS @ (ccfv @ XR @ ccbs))) @ (cwceq @ (ccres @ (cco @ XK @ XK @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ (ccxp @ (ccdif @ XN @ (ccsn @ XK)) @ XN)) @ (ccres @ (cco @ XK @ XK @ (ccfv @ XM @ (cco @ XN @ XR @ ccminmar1))) @ (ccxp @ (ccdif @ XN @ (ccsn @ XK)) @ XN))))))))))))))))))).
