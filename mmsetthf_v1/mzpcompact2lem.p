...
thf(cmzpcompact2lem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (! [Xc:$i] : (cwi @ (cwcel @ (XA2 @ Xc) @ (ccfv @ XB2 @ ccmzp)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwss @ (ccv @ Xa) @ XB2) @ (cwceq @ (XA2 @ Xc) @ (ccmpt @ (^ [Xc:$i] : (cco @ ccz @ XB2 @ ccmap)) @ (^ [Xc:$i] : (ccfv @ (ccres @ (ccv @ Xc) @ (ccv @ Xa)) @ (ccv @ Xb))))))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xa) @ ccmzp)))) @ (^ [Xa:$i] : ccfn)))))))).
