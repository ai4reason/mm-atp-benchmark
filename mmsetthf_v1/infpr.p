...
thf(aifpr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD)) @ (cwcel @ (ccif @ Xph @ XA2 @ XB2) @ (ccpr @ XA2 @ XB2))))))))).
...
thf(cinfpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) @ (cwceq @ (ccinf @ (ccpr @ XB2 @ XC) @ XA2 @ XR) @ (ccif @ (cwbr @ XB2 @ XC @ XR) @ XB2 @ XC)))))))).
