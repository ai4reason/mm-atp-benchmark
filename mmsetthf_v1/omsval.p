...
thf(adf_oms_ax,axiom,(cwceq @ ccoms @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ (ccv @ Xr))))) @ (^ [Xa:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xa) @ (ccuni @ (ccv @ Xz))) @ (cwbr @ (ccv @ Xz) @ ccom @ ccdom))) @ (^ [Xz:$i] : (ccpw @ (ccdm @ (ccv @ Xr)))))) @ (^ [Xx3:$i] : (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccv @ Xr))))))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt))))))).
...
thf(comsval_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccvv) @ (cwceq @ (ccfv @ XR @ ccoms) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ XR)))) @ (^ [Xa:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xa) @ (ccuni @ (ccv @ Xz))) @ (cwbr @ (ccv @ Xz) @ ccom @ ccdom))) @ (^ [Xz:$i] : (ccpw @ (ccdm @ XR))))) @ (^ [Xx3:$i] : (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XR)))))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt))))))).
