...
thf(ctglnunirn_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => (cwi @ (cwcel @ XG @ ccstrkg) @ (cwss @ (ccuni @ (ccrn @ XL)) @ XP)))))))))).
