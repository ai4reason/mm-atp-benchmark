...
thf(alogblt_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp) @ (cwcel @ XY @ ccrp)) @ (cwb @ (cwbr @ XX @ XY @ cclt) @ (cwbr @ (cco @ XB2 @ XX @ cclogb) @ (cco @ XB2 @ XY @ cclogb) @ cclt))))))).
thf(abreq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XC @ XR) @ (cwbr @ XB2 @ XC @ XR)))))))))).
thf(asyl2anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(ccpi_tp,type,(ccpi : ($i > $o))).
thf(ccim_tp,type,(ccim : ($i > $o))).
thf(alogbrec_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XA2 @ ccrp)) @ (cwceq @ (cco @ XB2 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclogb) @ (ccneg @ (cco @ XB2 @ XA2 @ cclogb))))))).
...
thf(annlogbexp_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccz)) @ (cwceq @ (cco @ XB2 @ (cco @ XB2 @ XM @ ccexp) @ cclogb) @ XM))))).
thf(cdya2ub_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccrp) @ (cwbr @ (cco @ cc1 @ (cco @ cc2 @ (ccfv @ (cco @ cc1 @ (cco @ cc2 @ XR @ cclogb) @ ccmin) @ ccfl) @ ccexp) @ ccdiv) @ XR @ cclt)))).
