...
thf(aigenidl_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwss @ XS @ XX)) @ (cwcel @ (cco @ XR @ XS @ ccigen) @ (ccfv @ XR @ ccidl)))))))))).
...
thf(aprnc_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwcel @ XR @ cccring) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ XR @ (ccsn @ XA2) @ ccigen) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ XA2 @ XH))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))))).
...
thf(acrngm4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cw3a @ (cwcel @ XR @ cccring) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwa @ (cwcel @ XC @ XX) @ (cwcel @ XD @ XX))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XH) @ (cco @ XC @ XD @ XH) @ XH) @ (cco @ (cco @ XA2 @ XC @ XH) @ (cco @ XB2 @ XD @ XH) @ XH))))))))))))))).
...
thf(aigenss_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwss @ XS @ XX)) @ (cwss @ XS @ (cco @ XR @ XS @ ccigen)))))))))).
...
thf(aispridl2_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XG @ Xa @ Xb) @ (ccfv @ XR @ cc1st)))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XH @ Xa @ Xb) @ (ccfv @ XR @ cc2nd)))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xa @ Xb))))) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cw3a @ (cwcel @ XP @ (ccfv @ XR @ ccidl)) @ (cwne @ XP @ XX) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (XH @ Xa @ Xb)) @ XP) @ (cwo @ (cwcel @ (ccv @ Xa) @ XP) @ (cwcel @ (ccv @ Xb) @ XP)))) @ (^ [Xb:$i] : XX))) @ (^ [Xa:$i] : XX)))) @ (cwcel @ XP @ (ccfv @ XR @ ccpridl)))))))))))).
thf(cispridlc_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XG @ Xa @ Xb) @ (ccfv @ XR @ cc1st)))) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xa @ Xb))))) => (cwi @ (cwcel @ XR @ cccring) @ (cwb @ (cwcel @ XP @ (ccfv @ XR @ ccpridl)) @ (cw3a @ (cwcel @ XP @ (ccfv @ XR @ ccidl)) @ (cwne @ XP @ XX) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) @ XP) @ (cwo @ (cwcel @ (ccv @ Xa) @ XP) @ (cwcel @ (ccv @ Xb) @ XP)))) @ (^ [Xb:$i] : XX))) @ (^ [Xa:$i] : XX)))))))))))))).
