...
thf(cresghm2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XU @ ccghm)) @ (cwcel @ XX @ (ccfv @ XT @ ccsubg))) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)))))))))).
