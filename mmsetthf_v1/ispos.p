...
thf(adf_poset_ax,axiom,(cwceq @ ccpo @ (ccab @ (^ [Xf1:$i] : (cwex @ (^ [Xb:$i] : (cwex @ (^ [Xr:$i] : (cw3a @ (cwceq @ (ccv @ Xb) @ (ccfv @ (ccv @ Xf1) @ ccbs)) @ (cwceq @ (ccv @ Xr) @ (ccfv @ (ccv @ Xf1) @ ccple)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cw3a @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xr))) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xr))) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xr))))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))))))))))).
