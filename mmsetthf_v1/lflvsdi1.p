...
thf(acaofdir_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((cwi @ Xph @ (cwf @ XA2 @ XK @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XS @ XG)) => ((cwi @ Xph @ (cwf @ XA2 @ XS @ XH)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwcel @ (ccv @ Xz) @ XK))) @ (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (ccv @ Xz) @ XT) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XT) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XT) @ XO)))))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XG @ XH @ (ccof @ XR)) @ XF @ (ccof @ XT)) @ (cco @ (cco @ XG @ XF @ (ccof @ XT)) @ (cco @ XH @ XF @ (ccof @ XT)) @ (ccof @ XO))))))))))))))))))))).
