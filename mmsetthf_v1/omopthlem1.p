...
thf(annmwordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(annmwordri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (cco @ XA2 @ XC @ ccomu) @ (cco @ XB2 @ XC @ ccomu)))))))).
...
thf(annm2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccom) @ (cwceq @ (cco @ XA2 @ cc2o @ ccomu) @ (cco @ XA2 @ XA2 @ ccoa))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asuceq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccsuc @ XA2) @ (ccsuc @ XB2)))))).
thf(comopthlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XC @ ccom) => (cwi @ (cwcel @ XA2 @ XC) @ (cwcel @ (cco @ (cco @ XA2 @ XA2 @ ccomu) @ (cco @ XA2 @ cc2o @ ccomu) @ ccoa) @ (cco @ XC @ XC @ ccomu)))))))).
