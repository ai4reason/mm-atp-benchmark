...
thf(cply1divmo_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xb:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xq:$i] : (cwceq @ (XP @ Xq) @ (ccfv @ (XR @ Xq) @ ccpl1))) => ((! [Xq:$i] : (cwceq @ XD @ (ccfv @ (XR @ Xq) @ ccdg1))) => ((! [Xq:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xq) @ ccbs))) => ((! [Xq:$i] : (cwceq @ Xc_mi @ (ccfv @ (XP @ Xq) @ ccsg))) => ((! [Xq:$i] : (cwceq @ (Xc_0 @ Xq) @ (ccfv @ (XP @ Xq) @ cc0g))) => ((! [Xq:$i] : (cwceq @ Xc_xb @ (ccfv @ (XP @ Xq) @ ccmulr))) => ((! [Xq:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xq) @ ccrg))) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((! [Xq:$i] : (cwi @ Xph @ (cwne @ XG @ (Xc_0 @ Xq)))) => ((! [Xq:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (ccfv @ XG @ XD) @ (ccfv @ XG @ ccco1)) @ (XE @ Xq)))) => ((! [Xq:$i] : (cwceq @ (XE @ Xq) @ (ccfv @ (XR @ Xq) @ ccrlreg))) => (cwi @ Xph @ (cwrmo @ (^ [Xq:$i] : (cwbr @ (ccfv @ (cco @ XF @ (cco @ XG @ (ccv @ Xq) @ Xc_xb) @ Xc_mi) @ XD) @ (ccfv @ XG @ XD) @ cclt)) @ (^ [Xq:$i] : XB2))))))))))))))))))))))))))).
