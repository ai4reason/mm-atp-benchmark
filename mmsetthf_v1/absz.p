...
thf(aznegclb_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwcel @ XA2 @ ccz) @ (cwcel @ (ccneg @ XA2) @ ccz))))).
...
thf(cabsz_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwcel @ XA2 @ ccz) @ (cwcel @ (ccfv @ XA2 @ ccabs) @ ccz))))).
