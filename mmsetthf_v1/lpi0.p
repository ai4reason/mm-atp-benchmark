...
thf(arsp0_thm,axiom,(! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccrsp)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ (ccfv @ (ccsn @ Xc_0) @ XK) @ (ccsn @ Xc_0))))))))).
...
thf(clpi0_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ cclpidl)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwcel @ (ccsn @ Xc_0) @ XP)))))))).
