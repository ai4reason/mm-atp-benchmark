...
thf(cnominpos_conj,conjecture,(cwn @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) @ (cwn @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ ccc0 @ (ccv @ Xy1) @ cclt) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt))) @ (^ [Xy1:$i] : ccr))))) @ (^ [Xx3:$i] : ccr)))).
