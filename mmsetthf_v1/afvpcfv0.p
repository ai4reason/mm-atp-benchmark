...
thf(afveqvfvv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ (ccfv @ XA2 @ XF) @ ccvv) @ (cwceq @ (ccfv @ XA2 @ XF) @ XB2)))))).
...
thf(cafvpcfv0_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ (ccafv @ XA2 @ XF) @ ccvv) @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0))))).
