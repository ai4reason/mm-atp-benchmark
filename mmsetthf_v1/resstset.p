...
thf(cresstset_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwceq @ XJ @ (ccfv @ XG @ ccts)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ XJ @ (ccfv @ XH @ ccts))))))))))).
