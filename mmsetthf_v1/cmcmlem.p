...
thf(achdmj4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwceq @ (ccfv @ (cco @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort) @ cchj) @ ccort) @ (ccin @ XA2 @ XB2))))))).
thf(achdmj2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwceq @ (ccfv @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj) @ ccort) @ (ccin @ XA2 @ (ccfv @ XB2 @ ccort)))))))).
...
thf(ccmcmlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ XB2 @ XA2 @ cccm))))))).
