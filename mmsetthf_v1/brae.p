...
thf(cbrae_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas))) @ (cwcel @ XA2 @ (ccdm @ XM))) @ (cwb @ (cwbr @ XA2 @ XM @ ccae) @ (cwceq @ (ccfv @ (ccdif @ (ccuni @ (ccdm @ XM)) @ XA2) @ XM) @ ccc0)))))).
