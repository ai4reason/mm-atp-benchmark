...
thf(adf_perf_ax,axiom,(cwceq @ ccperf @ (ccrab @ (^ [Xj:$i] : (cwceq @ (ccfv @ (ccuni @ (ccv @ Xj)) @ (ccfv @ (ccv @ Xj) @ cclp)) @ (ccuni @ (ccv @ Xj)))) @ (^ [Xj:$i] : cctop)))).
thf(cisperf_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccperf) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XX @ (ccfv @ XJ @ cclp)) @ XX))))))).
