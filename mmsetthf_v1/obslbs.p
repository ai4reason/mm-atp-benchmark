...
thf(aocvlsp_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwss @ XS @ XV)) @ (cwceq @ (ccfv @ (ccfv @ XS @ XN) @ Xc_pe) @ (ccfv @ XS @ Xc_pe)))))))))))).
thf(aobs2ocv_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => (cwi @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwceq @ (ccfv @ (ccfv @ XB2 @ Xc_pe) @ Xc_pe) @ XV))))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(aiscss_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XC @ (ccfv @ XW @ cccss)) => (cwi @ (cwcel @ XW @ XX) @ (cwb @ (cwcel @ XS @ XC) @ (cwceq @ XS @ (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe)))))))))))).
...
thf(aobselocv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwss @ XC @ XB2) @ (cwcel @ XA2 @ XB2)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XC @ Xc_pe)) @ (cwn @ (cwcel @ XA2 @ XC))))))))))).
thf(ccdr_tp,type,(ccdr : ($i > $o))).
thf(aobsne0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwcel @ XA2 @ XB2)) @ (cwne @ XA2 @ Xc_0)))))))).
...
thf(aislbs3_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwcel @ XW @ cclvec) @ (cwb @ (cwcel @ XB2 @ XJ) @ (cw3a @ (cwss @ XB2 @ XV) @ (cwceq @ (ccfv @ XB2 @ XN) @ XV) @ (cwal @ (^ [Xs1:$i] : (cwi @ (cwpss @ (ccv @ Xs1) @ XB2) @ (cwpss @ (ccfv @ (ccv @ Xs1) @ XN) @ XV)))))))))))))))).
thf(a_3anan32_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xch) @ Xps)))))).
thf(cobslbs_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwceq @ XC @ (ccfv @ XW @ cccss)) => (cwi @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwb @ (cwcel @ XB2 @ XJ) @ (cwcel @ (ccfv @ XB2 @ XN) @ XC)))))))))))).
