...
thf(abcth_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM) @ (cwne @ (ccfv @ (ccuni @ (ccrn @ XM)) @ (ccfv @ XJ @ ccnt)) @ cc0)) @ (cwrex @ (^ [Xk:$i] : (cwne @ (ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ ccnt)) @ cc0)) @ (^ [Xk:$i] : ccn))))))))).
...
thf(cbcth3_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwf @ ccn @ XJ @ XM) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ cccl)) @ XX)) @ (^ [Xk:$i] : ccn))) @ (cwceq @ (ccfv @ (ccint @ (ccrn @ XM)) @ (ccfv @ XJ @ cccl)) @ XX)))))))).
