...
thf(clcvnbtwn3_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ XX)) => ((cwi @ Xph @ (cwcel @ XR @ XS)) => ((cwi @ Xph @ (cwcel @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwbr @ XR @ XT @ XC)) => ((cwi @ Xph @ (cwss @ XR @ XU)) => ((cwi @ Xph @ (cwpss @ XU @ XT)) => (cwi @ Xph @ (cwceq @ XU @ XR)))))))))))))))))))).
