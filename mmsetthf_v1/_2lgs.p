...
thf(aprm2orodd_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwo @ (cwceq @ XP @ cc2) @ (cwn @ (cwbr @ cc2 @ XP @ ccdvds)))))).
...
thf(a_2lgslem4_thm,axiom,(cwb @ (cwceq @ (cco @ cc2 @ cc2 @ cclgs) @ cc1) @ (cwcel @ (cco @ cc2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))).
...
thf(a_2lgslem2_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwn @ (cwbr @ cc2 @ XP @ ccdvds))) @ (cwcel @ XN @ ccz)))))).
...
thf(a_2lgslem3_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XP @ ccn) @ (cwn @ (cwbr @ cc2 @ XP @ ccdvds))) @ (cwceq @ (cco @ XN @ cc2 @ ccmo) @ (ccif @ (cwcel @ (cco @ XP @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ ccc0 @ cc1))))))).
...
thf(c_2lgs_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwb @ (cwceq @ (cco @ cc2 @ XP @ cclgs) @ cc1) @ (cwcel @ (cco @ XP @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))))).
