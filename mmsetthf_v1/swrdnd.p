...
thf(assfzo12bi_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ ccz) @ (cwcel @ XL @ ccz)) @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwbr @ XK @ XL @ cclt)) @ (cwb @ (cwss @ (cco @ XK @ XL @ ccfzo) @ (cco @ XM @ XN @ ccfzo)) @ (cwa @ (cwbr @ XM @ XK @ ccle) @ (cwbr @ XL @ XN @ ccle))))))))).
...
thf(cswrdnd_conj,conjecture,(! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XF @ ccz) @ (cwcel @ XL @ ccz)) @ (cwi @ (cw3o @ (cwbr @ XF @ ccc0 @ cclt) @ (cwbr @ XL @ XF @ ccle) @ (cwbr @ (ccfv @ XW @ cchash) @ XL @ cclt)) @ (cwceq @ (cco @ XW @ (ccop @ XF @ XL) @ ccsubstr) @ cc0)))))))).
