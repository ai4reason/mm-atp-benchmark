...
thf(acnfcom3c_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwss @ ccom @ (ccv @ Xb)) @ (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2))))))).
...
thf(aomxpen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccomu) @ (ccxp @ XA2 @ XB2) @ ccen))))).
...
thf(ainfxpenc2lem3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xg1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xg1 @ Xn) @ (cwcel @ XA2 @ ccon0)))) => ((! [Xg1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xg1 @ Xn) @ (cwral @ (^ [Xb:$i] : (cwi @ (cwss @ ccom @ (ccv @ Xb)) @ (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2))))) => ((! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XW @ Xn @ Xb) @ (ccfv @ (ccrn @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccon0 @ cc1o)) @ (^ [Xx3:$i] : (cco @ ccom @ (ccv @ Xx3) @ ccoe)))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xg1 @ Xn) @ (cwf1o @ (cco @ ccom @ cc2o @ ccoe) @ ccom @ (XF @ Xw @ Xn @ Xb))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xg1 @ Xn) @ (cwceq @ (ccfv @ cc0 @ (XF @ Xw @ Xn @ Xb)) @ cc0)))))) => (! [Xg1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xg1 @ Xn) @ (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwss @ ccom @ (ccv @ Xb)) @ (cwf1o @ (ccxp @ (ccv @ Xb) @ (ccv @ Xb)) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1))))) @ (^ [Xb:$i] : XA2))))))))))))))))).
...
thf(afveqf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (ccun @ (ccres @ ccid @ (ccdif @ XA2 @ (ccpr @ XC @ (ccfv @ XD @ (cccnv @ XF))))) @ (ccpr @ (ccop @ XC @ (ccfv @ XD @ (cccnv @ XF))) @ (ccop @ (ccfv @ XD @ (cccnv @ XF)) @ XC))))) => (cwi @ (cw3a @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) @ (cwa @ (cwf1o @ XA2 @ XB2 @ XG) @ (cwceq @ (ccfv @ XC @ XG) @ XD))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(asimprd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwa @ Xps @ Xch)) => (cwi @ Xph @ Xch)))))).
thf(cinfxpenc2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwss @ ccom @ (ccv @ Xb)) @ (cwf1o @ (ccxp @ (ccv @ Xb) @ (ccv @ Xb)) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1))))) @ (^ [Xb:$i] : XA2))))))).
