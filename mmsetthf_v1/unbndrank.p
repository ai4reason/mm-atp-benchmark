...
thf(abndrank_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ ccrnk) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccon0)) @ (cwcel @ XA2 @ ccvv)))).
thf(cunbndrank_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccrnk))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccon0))))).
