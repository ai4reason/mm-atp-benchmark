...
thf(cocvin_conj,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwcel @ XS @ XL)) @ (cwceq @ (ccin @ XS @ (ccfv @ XS @ Xc_pe)) @ (ccsn @ Xc_0)))))))))))).
