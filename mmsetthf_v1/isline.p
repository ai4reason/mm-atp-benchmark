...
thf(alineset_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_le @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccple))))) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccjn))))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xs1 @ Xr @ Xq @ Xp) @ (ccfv @ XK @ cclines)))))) => (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XK @ (XB2 @ Xs1 @ Xr @ Xq @ Xp)) @ (cwceq @ (XN @ Xs1 @ Xr @ Xq @ Xp) @ (ccab @ (^ [Xs1:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwa @ (cwne @ (ccv @ Xq) @ (ccv @ Xr)) @ (cwceq @ (ccv @ Xs1) @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xr @ Xq @ Xp)) @ (Xc_le @ Xr @ Xq @ Xp))) @ (^ [Xp:$i] : XA2))))) @ (^ [Xr:$i] : XA2))) @ (^ [Xq:$i] : XA2))))))))))))))))))))).
...
thf(cisline_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_le @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccple))))) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccjn))))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xr @ Xq @ Xp) @ (ccfv @ XK @ cclines))))) => (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XK @ (XD @ Xr @ Xq @ Xp)) @ (cwb @ (cwcel @ (XX @ Xp) @ (XN @ Xr @ Xq @ Xp)) @ (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwa @ (cwne @ (ccv @ Xq) @ (ccv @ Xr)) @ (cwceq @ (XX @ Xp) @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xr @ Xq @ Xp)) @ (Xc_le @ Xr @ Xq @ Xp))) @ (^ [Xp:$i] : XA2))))) @ (^ [Xr:$i] : XA2))) @ (^ [Xq:$i] : XA2))))))))))))))))))).
