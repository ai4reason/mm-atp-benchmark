...
thf(celriin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XB2 @ (ccin @ XA2 @ (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XS @ Xx3))))) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ XB2 @ (XS @ Xx3))) @ (^ [Xx3:$i] : XX))))))))).
