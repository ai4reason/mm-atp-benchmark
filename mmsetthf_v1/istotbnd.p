...
thf(adf_totbnd_ax,axiom,(cwceq @ cctotbnd @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (cwa @ (cwceq @ (ccuni @ (ccv @ Xv)) @ (ccv @ Xx3)) @ (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xb) @ (cco @ (ccv @ Xy1) @ (ccv @ Xd) @ (ccfv @ (ccv @ Xm) @ ccbl)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xb:$i] : (ccv @ Xv))))) @ (^ [Xv:$i] : ccfn))) @ (^ [Xd:$i] : ccrp))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ ccme))))))).
...
thf(cistotbnd_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XM @ (ccfv @ XX @ cctotbnd)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (cwa @ (cwceq @ (ccuni @ (ccv @ Xv)) @ XX) @ (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xb) @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xb:$i] : (ccv @ Xv))))) @ (^ [Xv:$i] : ccfn))) @ (^ [Xd:$i] : ccrp))))))).
