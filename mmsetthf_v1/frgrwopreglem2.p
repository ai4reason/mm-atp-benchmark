...
thf(a_3imp31_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ Xth))) => (cwi @ (cw3a @ Xch @ Xps @ Xph) @ Xth))))))).
...
thf(avdgfrgrgt2_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XN @ XV)) @ (cwi @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt) @ (cwbr @ cc2 @ (ccfv @ XN @ (ccfv @ XG @ ccvtxdg)) @ ccle)))))))).
...
thf(cfrgrwopreglem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ XG @ ccvtxdg))) => ((cwceq @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (XD @ Xx3)) @ XK)) @ (^ [Xx3:$i] : XV))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccdif @ XV @ XA2))) => (cwi @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt) @ (cwne @ XA2 @ cc0)) @ (cwbr @ cc2 @ XK @ ccle))))))))))))).
