...
thf(covncl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ ccr @ XX @ ccmap))) => (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ (ccfv @ XX @ ccovoln)) @ (cco @ ccc0 @ ccpnf @ ccicc))))))))).
