...
thf(clsmsubm_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => (cwi @ (cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubmnd)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubmnd)) @ (cwss @ XT @ (ccfv @ XU @ XZ))) @ (cwcel @ (cco @ XT @ XU @ Xc_po) @ (ccfv @ XG @ ccsubmnd))))))))))).
