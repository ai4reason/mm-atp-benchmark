...
thf(csconnpht_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ ccsconn) @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) @ (cwceq @ (ccfv @ ccc0 @ XF) @ (ccfv @ cc1 @ XF))) @ (cwbr @ XF @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ XF))) @ (ccfv @ XJ @ ccphtpc)))))).
