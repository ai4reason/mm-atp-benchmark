...
thf(ar19_36v_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > ($i > $o))] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ Xps)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwi @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ Xps)))))).
...
thf(aimadomg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwi @ (cwfun @ XF) @ (cwbr @ (ccima @ XF @ XA2) @ XA2 @ ccdom))))))).
...
thf(cuniimadom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwfun @ XF) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2 @ ccdom)) @ (^ [Xx3:$i] : XA2))) @ (cwbr @ (ccuni @ (ccima @ XF @ XA2)) @ (ccxp @ XA2 @ XB2) @ ccdom)))))))).
