...
thf(ap1modz1_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwbr @ XM @ XA2 @ ccdvds) @ (cwbr @ cc1 @ XM @ cclt)) @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XM @ ccmo) @ cc1))))).
...
thf(algslem1_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwn @ (cwbr @ XP @ XA2 @ ccdvds))) @ (cwcel @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ XP @ ccmo) @ (ccpr @ ccc0 @ cc2)))))).
...
thf(clgslem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XZ @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cc1 @ ccle)) @ (^ [Xx3:$i] : ccz)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ (XP @ Xx3) @ (ccdif @ ccprime @ (ccsn @ cc2)))) @ (cwcel @ (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ (XP @ Xx3) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (XP @ Xx3) @ ccmo) @ cc1 @ ccmin) @ (XZ @ Xx3))))))))).
