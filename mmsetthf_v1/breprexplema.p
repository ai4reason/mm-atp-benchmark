...
thf(areprsuc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XF @ Xb @ Xc) @ (ccmpt @ (^ [Xc:$i] : (cco @ XA2 @ (cco @ XM @ (ccv @ Xb) @ ccmin) @ (ccfv @ XS @ ccrepr))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccop @ XS @ (ccv @ Xb))))))))) => (! [Xc:$i] : (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XM @ (ccfv @ (cco @ XS @ cc1 @ ccaddc) @ ccrepr)) @ (cciun @ (^ [Xb:$i] : XA2) @ (^ [Xb:$i] : (ccrn @ (XF @ Xb @ Xc))))))))))))))))).
...
thf(afsumiun_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3)))) @ (cwcel @ (XC @ Xk) @ ccc)))) => (cwi @ Xph @ (cwceq @ (ccsu @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ XA2 @ (^ [Xx3:$i] : (ccsu @ (XB2 @ Xx3) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))).
...
thf(afzodisjsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccin @ (cco @ XA2 @ XB2 @ ccfzo) @ (ccsn @ XB2)) @ cc0)))).
...
thf(afzossfzop1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwss @ (cco @ ccc0 @ XN @ ccfzo) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo))))).
