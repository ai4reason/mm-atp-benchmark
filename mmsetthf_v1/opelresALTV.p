...
thf(copelresALTV_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XC @ XV) @ (cwb @ (cwcel @ (ccop @ XB2 @ XC) @ (ccres @ XR @ XA2)) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwcel @ (ccop @ XB2 @ XC) @ XR)))))))))).
