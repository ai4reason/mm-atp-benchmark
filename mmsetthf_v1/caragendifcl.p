...
thf(ccaragendifcl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => ((cwi @ Xph @ (cwcel @ XE @ XS)) => (cwi @ Xph @ (cwcel @ (ccdif @ (ccuni @ XS) @ XE) @ XS)))))))))).
