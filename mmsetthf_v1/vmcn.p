...
thf(anvmfval_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XS @ Xx3 @ Xy1) @ (ccfv @ XU @ ccns)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XM @ Xx3 @ Xy1) @ (ccfv @ XU @ ccnsb)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XU @ ccnv) @ (cwceq @ (XM @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccneg @ cc1) @ (ccv @ Xy1) @ (XS @ Xx3 @ Xy1)) @ XG)))))))))))))))))).
...
thf(avacn_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwcel @ XG @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))))).
thf(cvmcn_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwcel @ XM @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))))).
