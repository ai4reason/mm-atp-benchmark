...
thf(cf1opr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [Xu:$i] : (! [Xt:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwb @ (cwf1 @ (ccxp @ XA2 @ XB2) @ (XC @ Xu @ Xt @ Xs1 @ Xr) @ XF) @ (cwa @ (cwf @ (ccxp @ XA2 @ XB2) @ (XC @ Xu @ Xt @ Xs1 @ Xr) @ XF) @ (cwral @ (^ [Xr:$i] : (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwral @ (^ [Xu:$i] : (cwi @ (cwceq @ (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ XF) @ (cco @ (ccv @ Xt) @ (ccv @ Xu) @ XF)) @ (cwa @ (cwceq @ (ccv @ Xr) @ (ccv @ Xt)) @ (cwceq @ (ccv @ Xs1) @ (ccv @ Xu))))) @ (^ [Xu:$i] : XB2))) @ (^ [Xt:$i] : XA2))) @ (^ [Xs1:$i] : XB2))) @ (^ [Xr:$i] : XA2))))))))))))).
