...
thf(alkrfval_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccfv @ XW @ ccsca))) => ((! [Xf1:$i] : (cwceq @ (Xc_0 @ Xf1) @ (ccfv @ (XD @ Xf1) @ cc0g))) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((! [Xf1:$i] : (cwceq @ (XK @ Xf1) @ (ccfv @ XW @ cclk))) => (! [Xf1:$i] : (cwi @ (cwcel @ XW @ (XX @ Xf1)) @ (cwceq @ (XK @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : XF) @ (^ [Xf1:$i] : (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (Xc_0 @ Xf1))))))))))))))))))).
...
thf(clkrval_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_0 @ (ccfv @ XD @ cc0g)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XK @ (ccfv @ XW @ cclk)) => (cwi @ (cwa @ (cwcel @ XW @ XX) @ (cwcel @ XG @ XF)) @ (cwceq @ (ccfv @ XG @ XK) @ (ccima @ (cccnv @ XG) @ (ccsn @ Xc_0)))))))))))))))).
