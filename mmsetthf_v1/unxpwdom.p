...
thf(aunxpwdom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwbr @ (ccxp @ XA2 @ XA2) @ (ccun @ XB2 @ XC) @ ccen) @ (cwo @ (cwbr @ XA2 @ XB2 @ ccwdom) @ (cwbr @ XA2 @ XC @ ccdom))))))).
...
thf(cunxpwdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwbr @ (ccxp @ XA2 @ XA2) @ (ccun @ XB2 @ XC) @ ccdom) @ (cwo @ (cwbr @ XA2 @ XB2 @ ccwdom) @ (cwbr @ XA2 @ XC @ ccdom))))))).
