...
thf(ctglngval_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((! [Xz:$i] : (cwceq @ (XL @ Xz) @ (ccfv @ XG @ cclng))) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XY @ XP)) => ((cwi @ Xph @ (cwne @ XX @ XY)) => (! [Xz:$i] : (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ (XL @ Xz)) @ (ccrab @ (^ [Xz:$i] : (cw3o @ (cwcel @ (ccv @ Xz) @ (cco @ XX @ XY @ XI)) @ (cwcel @ XX @ (cco @ (ccv @ Xz) @ XY @ XI)) @ (cwcel @ XY @ (cco @ XX @ (ccv @ Xz) @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))))).
