...
thf(aitgeq1d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ XA2 @ XB2))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccitg @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(aitgspltprt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) => ((cwi @ Xph @ (cwf @ (cco @ XM @ XN @ ccfz) @ ccr @ XP)) => ((! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ (cco @ XM @ XN @ ccfzo))) @ (cwbr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP) @ cclt))) => ((! [Xt:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xt) @ (cco @ (ccfv @ XM @ XP) @ (ccfv @ XN @ XP) @ ccicc))) @ (cwcel @ (XA2 @ Xt) @ ccc))) => ((! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ (cco @ XM @ XN @ ccfzo))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP) @ ccicc)) @ (^ [Xt:$i] : (XA2 @ Xt))) @ ccibl))) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xt:$i] : (cco @ (ccfv @ XM @ XP) @ (ccfv @ XN @ XP) @ ccicc)) @ (^ [Xt:$i] : (XA2 @ Xt))) @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xi:$i] : (ccitg @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP) @ ccicc)) @ (^ [Xt:$i] : (XA2 @ Xt))))))))))))))))))).
...
thf(afourierdlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ XA2 @ XB2 @ ccicc) @ XQ)) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccicc))) => (cwi @ Xph @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)))))))))))))))).
...
thf(afourierdlem82_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ (XR @ Xt) @ (ccif @ (cwceq @ (ccv @ Xx3) @ XB2) @ (XL @ Xt) @ (ccfv @ (ccv @ Xx3) @ (ccres @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ ccioo)))))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xt:$i] : (cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ (XF @ Xt)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (ccres @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XL @ Xt) @ (cco @ (XF @ Xt) @ XB2 @ cclimc)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xt) @ (cco @ (XF @ Xt) @ XA2 @ cclimc)))) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (XF @ Xt)))) @ (ccitg @ (^ [Xt:$i] : (cco @ (cco @ XA2 @ XX @ ccmin) @ (cco @ XB2 @ XX @ ccmin) @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (cco @ XX @ (ccv @ Xt) @ ccaddc) @ (XF @ Xt)))))))))))))))))))))))).
...
thf(alimcicciooub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XB2 @ cclimc) @ (cco @ XF @ XB2 @ cclimc)))))))))))).
thf(ccmnf_tp,type,(ccmnf : ($i > $o))).
thf(alimciccioolb_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XA2 @ cclimc) @ (cco @ XF @ XA2 @ cclimc)))))))))))).
...
thf(alimccog_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwss @ (ccrn @ XF) @ (ccdif @ (ccdm @ XG) @ (ccsn @ XB2)))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XF @ XA2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XG @ XB2 @ cclimc))) => (cwi @ Xph @ (cwcel @ XC @ (cco @ (cccom @ XG @ XF) @ XA2 @ cclimc))))))))))))).
