...
thf(adf_oposet_ax,axiom,(cwceq @ ccops @ (ccrab @ (^ [Xp:$i] : (cwa @ (cwa @ (cwcel @ (ccfv @ (ccv @ Xp) @ ccbs) @ (ccdm @ (ccfv @ (ccv @ Xp) @ cclub))) @ (cwcel @ (ccfv @ (ccv @ Xp) @ ccbs) @ (ccdm @ (ccfv @ (ccv @ Xp) @ ccglb)))) @ (cwex @ (^ [Xo:$i] : (cwa @ (cwceq @ (ccv @ Xo) @ (ccfv @ (ccv @ Xp) @ ccoc)) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cw3a @ (cw3a @ (cwcel @ (ccfv @ (ccv @ Xa) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xp) @ ccbs)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xo)) @ (ccv @ Xo)) @ (ccv @ Xa)) @ (cwi @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xp) @ ccple)) @ (cwbr @ (ccfv @ (ccv @ Xb) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xa) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xp) @ ccple)))) @ (cwceq @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xa) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xp) @ ccjn)) @ (ccfv @ (ccv @ Xp) @ ccp1)) @ (cwceq @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xa) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xp) @ ccmee)) @ (ccfv @ (ccv @ Xp) @ ccp0)))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xp) @ ccbs)))) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xp) @ ccbs)))))))) @ (^ [Xp:$i] : ccpo)))).
...
thf(cisopos_conj,conjecture,(! [XB2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [Xc_pe:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XU @ Xx3 @ Xy1) @ (ccfv @ XK @ cclub)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccfv @ XK @ ccglb)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_le @ Xx3 @ Xy1) @ (ccfv @ XK @ ccple)))) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccoc)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_or @ Xx3 @ Xy1) @ (ccfv @ XK @ ccjn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_an @ Xx3 @ Xy1) @ (ccfv @ XK @ ccmee)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1) @ (ccfv @ XK @ ccp0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_1 @ Xx3 @ Xy1) @ (ccfv @ XK @ ccp1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwcel @ XK @ ccops) @ (cwa @ (cw3a @ (cwcel @ XK @ ccpo) @ (cwcel @ XB2 @ (ccdm @ (XU @ Xx3 @ Xy1))) @ (cwcel @ XB2 @ (ccdm @ (XG @ Xx3 @ Xy1)))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cw3a @ (cw3a @ (cwcel @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XB2) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ Xc_pe) @ (ccv @ Xx3)) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_le @ Xx3 @ Xy1)) @ (cwbr @ (ccfv @ (ccv @ Xy1) @ Xc_pe) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ (Xc_le @ Xx3 @ Xy1)))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ (Xc_or @ Xx3 @ Xy1)) @ (Xc_1 @ Xx3 @ Xy1)) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ (Xc_an @ Xx3 @ Xy1)) @ (Xc_0 @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))))))))))))))))).
