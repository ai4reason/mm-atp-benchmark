...
thf(ccats1cat_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XT @ (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwcel @ XA2 @ (ccword @ ccvv)) => ((cwcel @ XS @ (ccword @ ccvv)) => ((cwceq @ XC @ (cco @ XB2 @ (ccs1 @ XX) @ ccconcat)) => ((cwceq @ XB2 @ (cco @ XA2 @ XS @ ccconcat)) => (cwceq @ XC @ (cco @ XA2 @ XT @ ccconcat)))))))))))))).
