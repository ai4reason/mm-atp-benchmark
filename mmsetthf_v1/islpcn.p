...
thf(ablnei_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccrp)) @ (cwcel @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))))))))).
...
thf(cislpcn_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwi @ Xph @ (cwcel @ XP @ ccc)) => (cwi @ Xph @ (cwb @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ (ccfv @ cccnfld @ cctopn) @ cclp))) @ (cwral @ (^ [Xe:$i] : (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XP @ ccmin) @ ccabs) @ (ccv @ Xe) @ cclt)) @ (^ [Xx3:$i] : (ccdif @ XS @ (ccsn @ XP))))) @ (^ [Xe:$i] : ccrp)))))))))).
