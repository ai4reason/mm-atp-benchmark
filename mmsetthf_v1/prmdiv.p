...
thf(cprmdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XR @ (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) => (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz) @ (cwn @ (cwbr @ XP @ XA2 @ ccdvds))) @ (cwa @ (cwcel @ XR @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz)) @ (cwbr @ XP @ (cco @ (cco @ XA2 @ XR @ ccmul) @ cc1 @ ccmin) @ ccdvds)))))))).
