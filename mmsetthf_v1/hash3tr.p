...
thf(chash3tr_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (cwa @ (cwcel @ XV @ (XW @ Xa @ Xb @ Xc)) @ (cwceq @ (ccfv @ XV @ cchash) @ cc3)) @ (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwex @ (^ [Xc:$i] : (cwceq @ XV @ (cctp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc)))))))))))))))).
