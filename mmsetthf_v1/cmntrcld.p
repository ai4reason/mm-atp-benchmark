...
thf(ccmntrcld_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwcel @ (ccdif @ XX @ (ccfv @ XS @ (ccfv @ XJ @ ccnt))) @ (ccfv @ XJ @ cccld)))))))).
