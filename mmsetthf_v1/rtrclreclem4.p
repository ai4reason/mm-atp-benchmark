...
thf(arelexp0d_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwrel @ XR)) => ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => (cwi @ Xph @ (cwceq @ (cco @ XR @ ccc0 @ ccrelexp) @ (ccres @ ccid @ (ccuni @ (ccuni @ XR)))))))))).
...
thf(adf_rtrclrec_ax,axiom,(cwceq @ ccrtrcl @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwceq @ XF @ XG) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG))))))).
thf(crtrclreclem4_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : ((! [Xs1:$i] : (cwi @ Xph @ (cwrel @ (XR @ Xs1)))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xs1) @ ccvv))) => (cwi @ Xph @ (cwal @ (^ [Xs1:$i] : (cwi @ (cw3a @ (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (XR @ Xs1)) @ (ccrn @ (XR @ Xs1)))) @ (ccv @ Xs1)) @ (cwss @ (XR @ Xs1) @ (ccv @ Xs1)) @ (cwss @ (cccom @ (ccv @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1))) @ (cwss @ (ccfv @ (XR @ Xs1) @ ccrtrcl) @ (ccv @ Xs1))))))))))).
