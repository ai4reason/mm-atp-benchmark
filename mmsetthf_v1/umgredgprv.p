...
thf(aumgredg2_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwceq @ (ccfv @ (ccfv @ XX @ XE) @ cchash) @ cc2))))))))).
...
thf(cumgredgprv_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwi @ (cwceq @ (ccfv @ XX @ XE) @ (ccpr @ XM @ XN)) @ (cwa @ (cwcel @ XM @ XV) @ (cwcel @ XN @ XV))))))))))))).
