...
thf(aopnmbllem_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (cwi @ (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) @ (cwcel @ XA2 @ (ccdm @ ccvol))))))).
...
thf(copnmbl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) @ (cwcel @ XA2 @ (ccdm @ ccvol))))).
