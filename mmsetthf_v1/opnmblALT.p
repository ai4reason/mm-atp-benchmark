...
thf(atgqioo_thm,axiom,(! [XQ:($i > $o)] : ((cwceq @ XQ @ (ccfv @ (ccima @ ccioo @ (ccxp @ ccq @ ccq)) @ cctg)) => (cwceq @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XQ)))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(copnmblALT_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) @ (cwcel @ XA2 @ (ccdm @ ccvol))))).
