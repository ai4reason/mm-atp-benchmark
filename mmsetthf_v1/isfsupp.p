...
thf(cisfsupp_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XZ @ XW)) @ (cwb @ (cwbr @ XR @ XZ @ ccfsupp) @ (cwa @ (cwfun @ XR) @ (cwcel @ (cco @ XR @ XZ @ ccsupp) @ ccfn))))))))).
