...
thf(amodeqmodmin_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ (cco @ (cco @ XA2 @ XM @ ccmin) @ XM @ ccmo)))))).
...
thf(annpw2blen_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwa @ (cwbr @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ XN @ ccle) @ (cwbr @ XN @ (cco @ cc2 @ (ccfv @ XN @ ccblen) @ ccexp) @ cclt))))).
...
thf(cnnpw2pmod_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ (cco @ XN @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ ccmo) @ ccaddc))))).
