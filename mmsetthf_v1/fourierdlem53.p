...
thf(cfourierdlem53_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((! [Xs1:$i] : (cwceq @ (XG @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : XA2) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))))) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xs1) @ XA2)) @ (cwcel @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XB2))) => ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xs1) @ XA2)) @ (cwne @ (ccv @ Xs1) @ XD))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xs1) @ (cco @ (ccres @ XF @ XB2) @ (cco @ XX @ XD @ ccaddc) @ cclimc)))) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xs1) @ (cco @ (XG @ Xs1) @ XD @ cclimc)))))))))))))))))))))).
