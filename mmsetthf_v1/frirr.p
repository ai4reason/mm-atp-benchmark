...
thf(afrc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwi @ (cw3a @ (cwfr @ XA2 @ XR) @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)) @ (^ [Xy1:$i] : XB2)) @ cc0)) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(cfrirr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwfr @ XA2 @ XR) @ (cwcel @ XB2 @ XA2)) @ (cwn @ (cwbr @ XB2 @ XB2 @ XR))))))).
