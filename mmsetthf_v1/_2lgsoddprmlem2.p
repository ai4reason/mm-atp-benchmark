...
thf(amodmuladdim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccrp)) @ (cwi @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ XB2) @ (cwrex @ (^ [Xk:$i] : (cwceq @ XA2 @ (cco @ (cco @ (ccv @ Xk) @ XM @ ccmul) @ XB2 @ ccaddc))) @ (^ [Xk:$i] : ccz)))))))).
...
thf(a_2lgsoddprmlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwceq @ XN @ (cco @ (cco @ cc8 @ XA2 @ ccmul) @ XB2 @ ccaddc))) @ (cwceq @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ (cco @ (cco @ (cco @ cc8 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccaddc))))))).
...
thf(advdsaddre2b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccr) @ (cwa @ (cwcel @ XC @ ccz) @ (cwbr @ XA2 @ XC @ ccdvds))) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccdvds) @ (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccaddc) @ ccdvds))))))).
thf(c_2lgsoddprmlem2_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwceq @ XR @ (cco @ XN @ cc8 @ ccmo))) @ (cwb @ (cwbr @ cc2 @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccdvds) @ (cwbr @ cc2 @ (cco @ (cco @ (cco @ XR @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccdvds)))))).
