...
thf(caxcc4_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwbr @ (XN @ Xx3) @ ccom @ ccen)) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xx3 @ Xn) @ (Xps @ Xf1 @ Xn)))))) => (! [Xx3:$i] : (cwi @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xn)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xn:$i] : (XN @ Xx3))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (XN @ Xx3) @ XA2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xn:$i] : (Xps @ Xf1 @ Xn)) @ (^ [Xn:$i] : (XN @ Xx3)))))))))))))))).
