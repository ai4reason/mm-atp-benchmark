...
thf(csubmateqlem2_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XM @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((cwi @ Xph @ (cwbr @ XM @ XK @ cclt)) => (cwi @ Xph @ (cwa @ (cwcel @ XM @ (cco @ cc1 @ XK @ ccfzo)) @ (cwcel @ XM @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ XK)))))))))))))).
