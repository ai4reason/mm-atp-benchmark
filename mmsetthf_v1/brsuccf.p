...
thf(adf_succf_ax,axiom,(cwceq @ ccsuccf @ (cccom @ cccup @ (cctxp @ ccid @ ccsingle)))).
...
thf(abrcup_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwbr @ (ccop @ XA2 @ XB2) @ XC @ cccup) @ (cwceq @ XC @ (ccun @ XA2 @ XB2)))))))))).
...
thf(cbrsuccf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ ccsuccf) @ (cwceq @ XB2 @ (ccsuc @ XA2)))))))).
