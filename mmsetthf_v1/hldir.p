...
thf(chldir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => (cwi @ (cwa @ (cwcel @ XU @ cchlo) @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ XS) @ (cco @ (cco @ XA2 @ XC @ XS) @ (cco @ XB2 @ XC @ XS) @ XG)))))))))))))).
