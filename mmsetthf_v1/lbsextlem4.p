...
thf(albsextlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ XV @ (ccfv @ (XW @ Xz) @ ccbs))) => ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (ccfv @ (XW @ Xz) @ cclbs))) => ((! [Xz:$i] : (cwceq @ XN @ (ccfv @ (XW @ Xz) @ cclspn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XW @ Xz) @ cclvec))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XC @ XV))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XC @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : XC)))) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwss @ XC @ (ccv @ Xz)) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (ccv @ Xz) @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccpw @ XV))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwne @ (XS @ Xz) @ cc0)))))))))))))))))).
thf(aalrimiv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (Xps @ Xx3))) => (cwi @ Xph @ (cwal @ (^ [Xx3:$i] : (Xps @ Xx3)))))))).
thf(aex_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ Xph @ (cwi @ Xps @ Xch))))))).
thf(ccint_tp,type,(ccint : (($i > $o) > ($i > $o)))).
thf(albsextlem3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ XV @ (ccfv @ (XW @ Xz) @ ccbs))) => ((! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XJ @ Xz @ Xu) @ (ccfv @ (XW @ Xz) @ cclbs)))) => ((! [Xz:$i] : (cwceq @ XN @ (ccfv @ (XW @ Xz) @ cclspn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XW @ Xz) @ cclvec))) => ((! [Xz:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xz) @ (cwss @ (XC @ Xu) @ XV)))) => ((! [Xz:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (XC @ Xu) @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : (XC @ Xu)))))) => ((! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XS @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwss @ (XC @ Xu) @ (ccv @ Xz)) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (ccv @ Xz) @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccpw @ XV)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XP @ Xx3 @ Xz @ Xu) @ (ccfv @ (XW @ Xz) @ cclss))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XA2 @ (XS @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwne @ XA2 @ cc0))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwor @ XA2 @ ccrpss))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XT @ Xx3 @ Xz @ Xu) @ (cciun @ (^ [Xu:$i] : XA2) @ (^ [Xu:$i] : (ccfv @ (ccdif @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3))) @ XN))))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (ccuni @ XA2) @ (XS @ Xz))))))))))))))))))))))))))).
...
thf(azornn0g_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwne @ XA2 @ cc0) @ (cwal @ (^ [Xz:$i] : (cwi @ (cw3a @ (cwss @ (ccv @ Xz) @ XA2) @ (cwne @ (ccv @ Xz) @ cc0) @ (cwor @ (ccv @ Xz) @ ccrpss)) @ (cwcel @ (ccuni @ (ccv @ Xz)) @ XA2))))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
...
thf(aislbs2_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwcel @ XW @ cclvec) @ (cwb @ (cwcel @ XB2 @ XJ) @ (cw3a @ (cwss @ XB2 @ XV) @ (cwceq @ (ccfv @ XB2 @ XN) @ XV) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XB2 @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : XB2)))))))))))))).
