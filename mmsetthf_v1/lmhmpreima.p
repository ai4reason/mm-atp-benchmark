...
thf(clmhmpreima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XS @ cclss)) => ((cwceq @ XY @ (ccfv @ XT @ cclss)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XU @ XY)) @ (cwcel @ (ccima @ (cccnv @ XF) @ XU) @ XX))))))))))).
