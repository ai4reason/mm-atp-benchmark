...
thf(crfcnpre4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((cwnfc @ (^ [Xt:$i] : (XF @ Xt))) => ((! [Xt:$i] : (cwceq @ (XK @ Xt) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xt:$i] : (cwceq @ XT @ (ccuni @ (XJ @ Xt)))) => ((! [Xt:$i] : (cwceq @ (XA2 @ Xt) @ (ccrab @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (XF @ Xt)) @ XB2 @ ccle)) @ (^ [Xt:$i] : XT)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XB2 @ ccr))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XF @ Xt) @ (cco @ (XJ @ Xt) @ (XK @ Xt) @ cccn)))) => (! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XA2 @ Xt) @ (ccfv @ (XJ @ Xt) @ cccld)))))))))))))))))).
