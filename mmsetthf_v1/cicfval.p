...
thf(adf_cic_ax,axiom,(cwceq @ cccic @ (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (cco @ (ccfv @ (ccv @ Xc) @ cciso) @ cc0 @ ccsupp))))).
...
thf(ccicfval_conj,conjecture,(! [XC:($i > $o)] : (cwi @ (cwcel @ XC @ cccat) @ (cwceq @ (ccfv @ XC @ cccic) @ (cco @ (ccfv @ XC @ cciso) @ cc0 @ ccsupp))))).
