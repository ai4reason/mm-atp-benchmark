...
thf(cax6e2eqVD_conj,conjecture,(! [Xv:$i] : (! [Xy1:$i] : (! [Xu:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwi @ (cwceq @ (ccv @ Xu) @ (ccv @ Xv)) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xu)) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xv))))))))))))).
