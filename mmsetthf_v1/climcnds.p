...
thf(aclimcndslem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XG) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ XF) @ ccmul)))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (XN @ Xk @ Xn) @ ccn0)) @ (cwbr @ (ccfv @ (cco @ (cco @ cc2 @ (cco @ (XN @ Xk @ Xn) @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ (ccseq @ ccaddc @ XF @ cc1)) @ (ccfv @ (XN @ Xk @ Xn) @ (ccseq @ ccaddc @ XG @ ccc0)) @ ccle))))))))))))).
thf(aelfznn0_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XK @ ccn0))))).
thf(cclimcnds_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XG) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ XF) @ ccmul)))) => (cwi @ Xph @ (cwb @ (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli)) @ (cwcel @ (ccseq @ ccaddc @ XG @ ccc0) @ (ccdm @ ccli)))))))))))).
