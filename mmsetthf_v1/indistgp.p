...
thf(cindistgp_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwceq @ XJ @ (ccpr @ cc0 @ XB2))) @ (cwcel @ XG @ cctgp)))))))).
