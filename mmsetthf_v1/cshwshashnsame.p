...
thf(acshwsdisj_thm,axiom,(! [Xph:$o] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xn:$i] : (cwi @ Xph @ (cwa @ (cwcel @ XW @ (ccword @ (XV @ Xn))) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime)))) => (cwi @ (cwa @ Xph @ (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (cwdisj @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xn:$i] : (ccsn @ (cco @ XW @ (ccv @ Xn) @ cccsh)))))))))).
...
thf(ccshwshashnsame_conj,conjecture,(! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XM @ Xw @ Xi @ Xn) @ (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ XW @ (ccv @ Xn) @ cccsh) @ (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ XV))))))) => (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime)) @ (cwi @ (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ (XM @ Xw @ Xi @ Xn) @ cchash) @ (ccfv @ XW @ cchash)))))))))))).
