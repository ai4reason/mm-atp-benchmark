...
thf(cordthauslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cw3a @ (cwcel @ XR @ cctsr) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwi @ (cwbr @ XA2 @ XB2 @ XR) @ (cwi @ (cwne @ XA2 @ XB2) @ (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwcel @ XA2 @ (ccv @ Xm)) @ (cwcel @ XB2 @ (ccv @ Xn)) @ (cwceq @ (ccin @ (ccv @ Xm) @ (ccv @ Xn)) @ cc0))) @ (^ [Xn:$i] : (ccfv @ XR @ ccordt)))) @ (^ [Xm:$i] : (ccfv @ XR @ ccordt)))))))))))).
