...
thf(aseqval_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XR @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccres @ (ccrdg @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccmpt2 @ (^ [Xz:$i] : (^ [Xw:$i] : ccvv)) @ (^ [Xz:$i] : (^ [Xw:$i] : ccvv)) @ (^ [Xz:$i] : (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccfv @ (cco @ (ccv @ Xz) @ cc1 @ ccaddc) @ XF) @ Xc_pl))))))))) @ (ccop @ (XM @ Xz @ Xw) @ (ccfv @ (XM @ Xz @ Xw) @ XF))) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (ccseq @ Xc_pl @ XF @ (XM @ Xz @ Xw)) @ (ccrn @ (XR @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))).
...
thf(cseqp1_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (ccseq @ Xc_pl @ XF @ XM)) @ (cco @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XF) @ Xc_pl)))))))).
