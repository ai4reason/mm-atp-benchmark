...
thf(adf_diag_ax,axiom,(cwceq @ ccdiag @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : (cco @ (ccop @ (ccv @ Xc) @ (ccv @ Xd)) @ (cco @ (ccv @ Xc) @ (ccv @ Xd) @ cc1stf) @ cccurf)))))).
...
thf(cdiagval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (cco @ XC @ XD @ ccdiag)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => (cwi @ Xph @ (cwceq @ XL @ (cco @ (ccop @ XC @ XD) @ (cco @ XC @ XD @ cc1stf) @ cccurf))))))))))).
