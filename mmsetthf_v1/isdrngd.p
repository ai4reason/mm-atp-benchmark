...
thf(cisdrngd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwceq @ Xc_x @ (ccfv @ XR @ ccmulr))) => ((cwi @ Xph @ (cwceq @ Xc_0 @ (ccfv @ XR @ cc0g))) => ((cwi @ Xph @ (cwceq @ Xc_1 @ (ccfv @ XR @ ccur))) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwne @ (ccv @ Xx3) @ Xc_0)) @ (cwa @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwne @ (ccv @ Xy1) @ Xc_0))) @ (cwne @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) @ Xc_0)))) => ((cwi @ Xph @ (cwne @ Xc_1 @ Xc_0)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwne @ (ccv @ Xx3) @ Xc_0))) @ (cwcel @ (XI @ Xx3) @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwne @ (ccv @ Xx3) @ Xc_0))) @ (cwne @ (XI @ Xx3) @ Xc_0))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwne @ (ccv @ Xx3) @ Xc_0))) @ (cwceq @ (cco @ (XI @ Xx3) @ (ccv @ Xx3) @ Xc_x) @ Xc_1))) => (cwi @ Xph @ (cwcel @ XR @ ccdr)))))))))))))))))))).
