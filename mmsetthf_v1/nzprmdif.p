...
thf(anzin_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => (cwi @ Xph @ (cwceq @ (ccin @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) @ (ccima @ ccdvds @ (ccsn @ (cco @ XM @ XN @ cclcm))))))))))).
...
thf(cnzprmdif_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccprime)) => ((cwi @ Xph @ (cwcel @ XN @ ccprime)) => ((cwi @ Xph @ (cwne @ XM @ XN)) => (cwi @ Xph @ (cwceq @ (ccdif @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) @ (ccdif @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ (cco @ XM @ XN @ ccmul))))))))))))).
