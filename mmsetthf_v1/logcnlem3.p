...
thf(aargimlt0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ XA2 @ ccim) @ ccc0 @ cclt)) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ (ccneg @ ccpi) @ ccc0 @ ccioo))))).
...
thf(aargimgt0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccim) @ cclt)) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ ccc0 @ ccpi @ ccioo))))).
...
thf(altnegcon2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ (ccneg @ XB2) @ cclt)) => (cwi @ Xph @ (cwbr @ XB2 @ (ccneg @ XA2) @ cclt))))))))).
