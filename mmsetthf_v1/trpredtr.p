...
thf(ctrpredtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwse @ XA2 @ XR)) @ (cwi @ (cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) @ (cwss @ (ccpred @ XA2 @ XR @ XY) @ (cctrpred @ XA2 @ XR @ XX))))))))).
