...
thf(avrgpfval_thm,axiom,(! [Xc_sm:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XI @ ccefg)) => ((! [Xj:$i] : (cwceq @ (XU @ Xj) @ (ccfv @ XI @ ccvrgp))) => (! [Xj:$i] : (cwi @ (cwcel @ XI @ XV) @ (cwceq @ (XU @ Xj) @ (ccmpt @ (^ [Xj:$i] : XI) @ (^ [Xj:$i] : (ccec @ (ccs1 @ (ccop @ (ccv @ Xj) @ cc0)) @ Xc_sm))))))))))))).
...
thf(cvrgpval_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XI @ ccefg)) => ((cwceq @ XU @ (ccfv @ XI @ ccvrgp)) => (cwi @ (cwa @ (cwcel @ XI @ XV) @ (cwcel @ XA2 @ XI)) @ (cwceq @ (ccfv @ XA2 @ XU) @ (ccec @ (ccs1 @ (ccop @ XA2 @ cc0)) @ Xc_sm))))))))))).
