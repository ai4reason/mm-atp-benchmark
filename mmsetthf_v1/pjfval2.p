...
thf(cpjfval2_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XP @ (ccfv @ XW @ ccpj1)) => ((cwceq @ XK @ (ccfv @ XW @ ccpj)) => (cwceq @ XK @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ XK)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XP)))))))))))).
