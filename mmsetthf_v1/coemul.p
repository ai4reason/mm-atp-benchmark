...
thf(ccoemul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XB2 @ (ccfv @ XG @ cccoe)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ XN @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XB2) @ ccmul)))))))))))))).
