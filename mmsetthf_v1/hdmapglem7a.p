...
thf(chdmapglem7a_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xu:$i] : (! [Xk:$i] : (cwceq @ (XH @ Xu @ Xk) @ (ccfv @ (XK @ Xu @ Xk) @ cclh)))) => ((! [Xu:$i] : (! [Xk:$i] : (cwceq @ XE @ (ccop @ (ccres @ ccid @ (ccfv @ (XK @ Xu @ Xk) @ ccbs)) @ (ccres @ ccid @ (ccfv @ (XW @ Xu @ Xk) @ (ccfv @ (XK @ Xu @ Xk) @ ccltrn))))))) => ((! [Xu:$i] : (! [Xk:$i] : (cwceq @ XO @ (ccfv @ (XW @ Xu @ Xk) @ (ccfv @ (XK @ Xu @ Xk) @ ccoch))))) => ((! [Xu:$i] : (! [Xk:$i] : (cwceq @ XU @ (ccfv @ (XW @ Xu @ Xk) @ (ccfv @ (XK @ Xu @ Xk) @ ccdvh))))) => ((! [Xu:$i] : (cwceq @ (XV @ Xu) @ (ccfv @ XU @ ccbs))) => ((cwceq @ Xc_pl @ (ccfv @ XU @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XU @ ccvsca)) => ((! [Xu:$i] : (cwceq @ (XR @ Xu) @ (ccfv @ XU @ ccsca))) => ((! [Xu:$i] : (cwceq @ XB2 @ (ccfv @ (XR @ Xu) @ ccbs))) => ((! [Xu:$i] : (! [Xk:$i] : (cwceq @ (Xc_po @ Xu @ Xk) @ (ccfv @ XU @ cclsm)))) => ((cwceq @ XN @ (ccfv @ XU @ cclspn)) => ((! [Xu:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XK @ Xu @ Xk) @ cchlt) @ (cwcel @ (XW @ Xu @ Xk) @ (XH @ Xu @ Xk)))))) => ((! [Xu:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xu)))) => (cwi @ Xph @ (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xk:$i] : (cwceq @ XX @ (cco @ (cco @ (ccv @ Xk) @ XE @ Xc_x) @ (ccv @ Xu) @ Xc_pl))) @ (^ [Xk:$i] : XB2))) @ (^ [Xu:$i] : (ccfv @ (ccsn @ XE) @ XO))))))))))))))))))))))))))))))))).
