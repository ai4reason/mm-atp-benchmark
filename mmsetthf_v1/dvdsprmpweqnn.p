...
thf(cdvdsprmpweqnn_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwi @ (cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn)))))))).
