...
thf(cptpjopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XY @ (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XF @ ccpt))) => (! [Xx3:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF) @ (cwcel @ XI @ XA2)) @ (cwcel @ XU @ (XJ @ Xx3))) @ (cwcel @ (ccima @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (ccfv @ XI @ (ccv @ Xx3)))) @ XU) @ (ccfv @ XI @ XF)))))))))))))).
