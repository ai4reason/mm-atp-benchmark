...
thf(ahmeoimaf1o_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XJ) @ (^ [Xx3:$i] : (ccima @ XF @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) @ (cwf1o @ XJ @ XK @ (XG @ Xx3)))))))))).
...
thf(chmphen_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwbr @ XJ @ XK @ cchmph) @ (cwbr @ XJ @ XK @ ccen))))).
