...
thf(cnumexp2x_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XM @ ccn0) => ((cwceq @ (cco @ cc2 @ XM @ ccmul) @ XN) => ((cwceq @ (cco @ XA2 @ XM @ ccexp) @ XD) => ((cwceq @ (cco @ XD @ XD @ ccmul) @ XC) => (cwceq @ (cco @ XA2 @ XN @ ccexp) @ XC)))))))))))).
