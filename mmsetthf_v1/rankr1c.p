...
thf(arankr1clem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ XB2 @ (ccdm @ ccr1))) @ (cwb @ (cwn @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1))) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccrnk))))))).
...
thf(crankr1c_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwb @ (cwceq @ XB2 @ (ccfv @ XA2 @ ccrnk)) @ (cwa @ (cwn @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1))) @ (cwcel @ XA2 @ (ccfv @ (ccsuc @ XB2) @ ccr1)))))))).
