...
thf(ademoivre_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ (ccfv @ XA2 @ cccos) @ (cco @ cci @ (ccfv @ XA2 @ ccsin) @ ccmul) @ ccaddc) @ XN @ ccexp) @ (cco @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ cccos) @ (cco @ cci @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ ccsin) @ ccmul) @ ccaddc)))))).
...
thf(abccmpl_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccz)) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ (cco @ XN @ (cco @ XN @ XK @ ccmin) @ ccbc)))))).
...
thf(afsumim_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccim) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccim))))))))))).
