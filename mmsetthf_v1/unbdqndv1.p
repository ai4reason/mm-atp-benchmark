...
thf(aunblimceq0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwi @ Xph @ (cwf @ XS @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccv @ Xb) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle))) @ (^ [Xx3:$i] : XS))) @ (^ [Xd:$i] : ccrp))) @ (^ [Xb:$i] : ccrp))) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XA2 @ cclimc) @ cc0))))))))))).
...
thf(cunbdqndv1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XG @ Xz) @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccsn @ XA2))) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XA2 @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ ccdiv))))) => ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwi @ Xph @ (cwss @ XX @ XS)) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((! [Xz:$i] : (cwi @ Xph @ (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccv @ Xb) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XG @ Xz)) @ ccabs) @ ccle))) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccsn @ XA2))))) @ (^ [Xd:$i] : ccrp))) @ (^ [Xb:$i] : ccrp)))) => (cwi @ Xph @ (cwn @ (cwcel @ XA2 @ (ccdm @ (cco @ XS @ XF @ ccdv))))))))))))))))).
