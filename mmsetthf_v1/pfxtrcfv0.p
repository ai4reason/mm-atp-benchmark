...
thf(apfxtrcfv_thm,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XW @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx)) @ (ccfv @ XI @ XW))))))).
thf(cpfxtrcfv0_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) @ (cwceq @ (ccfv @ ccc0 @ (cco @ XW @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx)) @ (ccfv @ ccc0 @ XW)))))).
