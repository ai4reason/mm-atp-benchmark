...
thf(ashel_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwcel @ XH @ ccsh) @ (cwcel @ XA2 @ XH)) @ (cwcel @ XA2 @ cchil))))).
...
thf(cspansnss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ XA2)) @ (cwss @ (ccfv @ (ccsn @ XB2) @ ccspn) @ XA2))))).
