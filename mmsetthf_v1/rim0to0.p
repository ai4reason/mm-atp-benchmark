...
thf(af1rhm0to0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XS @ cc0g)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh)) @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwcel @ XX @ XA2)) @ (cwb @ (cwceq @ (ccfv @ XX @ XF) @ XN) @ (cwceq @ XX @ Xc_0)))))))))))))))).
thf(crim0to0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XS @ cc0g)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ ccrs)) @ (cwcel @ XX @ XA2)) @ (cwb @ (cwceq @ (ccfv @ XX @ XF) @ XN) @ (cwceq @ XX @ Xc_0)))))))))))))))).
