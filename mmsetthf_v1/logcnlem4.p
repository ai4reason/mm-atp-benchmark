...
thf(alogcnlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((cwceq @ XS @ (ccif @ (cwcel @ XA2 @ ccrp) @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs))) => ((cwceq @ XT @ (cco @ (ccfv @ XA2 @ ccabs) @ (cco @ XR @ (cco @ cc1 @ XR @ ccaddc) @ ccdiv) @ ccmul)) => ((cwi @ Xph @ (cwcel @ XA2 @ XD)) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ XD)) => ((cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (ccif @ (cwbr @ XS @ XT @ ccle) @ XS @ XT) @ cclt)) => (cwi @ Xph @ (cwa @ (cwbr @ (ccneg @ ccpi) @ (cco @ (ccfv @ (ccfv @ XB2 @ cclog) @ ccim) @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccmin) @ cclt) @ (cwbr @ (cco @ (ccfv @ (ccfv @ XB2 @ cclog) @ ccim) @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccmin) @ ccpi @ ccle)))))))))))))))))).
...
thf(alogeftb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XB2 @ (ccrn @ cclog))) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cclog) @ XB2) @ (cwceq @ (ccfv @ XB2 @ cce) @ XA2)))))).
...
thf(aretancld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ cctan) @ ccr))))))).
...
thf(altmin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ ccle) @ XB2 @ XC) @ cclt) @ (cwa @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XA2 @ XC @ cclt)))))))).
...
thf(are1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccre) @ cc1)).
...
thf(aargregt0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))))).
...
thf(atanabsge_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccabs) @ ccle)))).
thf(a_3eqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => ((cwi @ Xph @ (cwceq @ XC @ XD)) => (cwi @ Xph @ (cwceq @ XA2 @ XD))))))))))).
thf(ccz_tp,type,(ccz : ($i > $o))).
thf(ccexp_tp,type,(ccexp : ($i > $o))).
thf(atanarg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) @ (cwceq @ (ccfv @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ cctan) @ (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XA2 @ ccre) @ ccdiv))))).
...
thf(aim1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccim) @ ccc0)).
...
thf(clogcnlem4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((cwceq @ XS @ (ccif @ (cwcel @ XA2 @ ccrp) @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs))) => ((cwceq @ XT @ (cco @ (ccfv @ XA2 @ ccabs) @ (cco @ XR @ (cco @ cc1 @ XR @ ccaddc) @ ccdiv) @ ccmul)) => ((cwi @ Xph @ (cwcel @ XA2 @ XD)) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ XD)) => ((cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (ccif @ (cwbr @ XS @ XT @ ccle) @ XS @ XT) @ cclt)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (ccfv @ (ccfv @ XB2 @ cclog) @ ccim) @ ccmin) @ ccabs) @ XR @ cclt))))))))))))))))).
