...
thf(aabsmod0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ ccc0) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccmo) @ ccc0)))))).
...
thf(aabsz_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwcel @ XA2 @ ccz) @ (cwcel @ (ccfv @ XA2 @ ccabs) @ ccz))))).
...
thf(cpellexlem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XC @ ccz)) => ((cwi @ Xph @ (cwcel @ XD @ ccn)) => ((cwi @ Xph @ (cwn @ (cwcel @ (ccfv @ XD @ ccsqrt) @ ccq))) => ((cwi @ Xph @ (cwcel @ XE @ ccn)) => ((cwi @ Xph @ (cwcel @ XF @ ccn)) => ((cwi @ Xph @ (cwn @ (cwa @ (cwceq @ XA2 @ XE) @ (cwceq @ XB2 @ XF)))) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmin) @ XC)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XE @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XF @ cc2 @ ccexp) @ ccmul) @ ccmin) @ XC)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ (ccfv @ XC @ ccabs) @ ccmo) @ (cco @ XE @ (ccfv @ XC @ ccabs) @ ccmo))) => ((cwi @ Xph @ (cwceq @ (cco @ XB2 @ (ccfv @ XC @ ccabs) @ ccmo) @ (cco @ XF @ (ccfv @ XC @ ccabs) @ ccmo))) => (cwi @ Xph @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xa) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xb) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1)) @ (^ [Xb:$i] : ccn))) @ (^ [Xa:$i] : ccn)))))))))))))))))))))))).
