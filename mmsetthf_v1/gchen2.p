...
thf(abren2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwn @ (cwbr @ XA2 @ XB2 @ ccsdm))))))).
thf(cgchen2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom))) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccen))))).
