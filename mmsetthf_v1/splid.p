...
thf(csplid_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XA2)) @ (cwa @ (cwcel @ XX @ (cco @ ccc0 @ XY @ ccfz)) @ (cwcel @ XY @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz)))) @ (cwceq @ (cco @ XS @ (ccotp @ XX @ XY @ (cco @ XS @ (ccop @ XX @ XY) @ ccsubstr)) @ ccsplice) @ XS))))))).
