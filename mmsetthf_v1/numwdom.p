...
thf(abrwdomi_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwbr @ XX @ XY @ ccwdom) @ (cwo @ (cwceq @ XX @ cc0) @ (cwex @ (^ [Xz:$i] : (cwfo @ XY @ XX @ (ccv @ Xz))))))))).
...
thf(cnumwdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ XB2 @ XA2 @ ccwdom)) @ (cwcel @ XB2 @ (ccdm @ cccrd)))))).
