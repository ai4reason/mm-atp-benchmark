...
thf(altrnco4_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XE @ XT) @ (cwcel @ XF @ XT)) @ (cwceq @ (cccom @ (cccom @ XD @ XE) @ (cccom @ XF @ XG)) @ (cccom @ (cccom @ XD @ XF) @ (cccom @ XE @ XG))))))))))))))).
