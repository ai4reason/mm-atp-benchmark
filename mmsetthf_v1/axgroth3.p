...
thf(aaxgroth2_thm,axiom,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : (cwa @ (cwal @ (^ [Xw:$i] : (cwi @ (cwss @ (ccv @ Xw) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (cwrex @ (^ [Xw:$i] : (cwal @ (^ [Xv:$i] : (cwi @ (cwss @ (ccv @ Xv) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xv) @ (ccv @ Xw)))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwo @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccdom) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))))).
...
thf(adominf_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwa @ (cwne @ XA2 @ cc0) @ (cwss @ XA2 @ (ccuni @ XA2))) @ (cwbr @ ccom @ XA2 @ ccdom))))).
