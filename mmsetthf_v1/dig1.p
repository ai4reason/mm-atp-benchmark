...
thf(adigexp_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XK @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XK @ (cco @ XB2 @ XN @ ccexp) @ (ccfv @ XB2 @ ccdig)) @ (ccif @ (cwceq @ XK @ XN) @ cc1 @ ccc0))))))).
...
thf(adignn0fr_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ (ccdif @ ccz @ ccn0)) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XK @ XN @ (ccfv @ XB2 @ ccdig)) @ ccc0)))))).
...
thf(cdig1_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XK @ ccz)) @ (cwceq @ (cco @ XK @ cc1 @ (ccfv @ XB2 @ ccdig)) @ (ccif @ (cwceq @ XK @ ccc0) @ cc1 @ ccc0)))))).
