...
thf(citg1addlem2_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwa @ (cwceq @ (ccv @ Xi) @ ccc0) @ (cwceq @ (ccv @ Xj) @ ccc0)) @ ccc0 @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xi))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xj)))) @ ccvol)))))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ (ccxp @ ccr @ ccr) @ ccr @ (XI @ Xi @ Xj))))))))))))).
