...
thf(cfsumsplitsnun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwa @ (cwcel @ XZ @ (XV @ Xk)) @ (cwnel @ XZ @ XA2)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ XA2 @ (ccsn @ XZ))))) @ (cwceq @ (ccsu @ (ccun @ XA2 @ (ccsn @ XZ)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsb @ XZ @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccaddc))))))))).
