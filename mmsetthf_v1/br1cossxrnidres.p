...
thf(aideq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccid) @ (cwceq @ XA2 @ XB2))))))).
thf(cbr1cossxrnidres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XW)) @ (cwa @ (cwcel @ XD @ XX) @ (cwcel @ XE @ XY))) @ (cwb @ (cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XD @ XE) @ (cccoss @ (ccxrn @ XR @ (ccres @ ccid @ XA2)))) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwa @ (cwceq @ (ccv @ Xu) @ XC) @ (cwbr @ (ccv @ Xu) @ XB2 @ XR)) @ (cwa @ (cwceq @ (ccv @ Xu) @ XE) @ (cwbr @ (ccv @ Xu) @ XD @ XR)))) @ (^ [Xu:$i] : XA2))))))))))))))).
