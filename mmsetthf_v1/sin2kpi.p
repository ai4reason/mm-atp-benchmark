...
thf(asin0_thm,axiom,(cwceq @ (ccfv @ ccc0 @ ccsin) @ ccc0)).
thf(csin2kpi_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccsin) @ ccc0)))).
