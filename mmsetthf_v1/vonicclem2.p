...
thf(avonicclem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XA2)) => ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XB2 @ Xk)))) => ((cwi @ Xph @ (cwne @ XX @ cc0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwbr @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccle))) => ((! [Xn:$i] : (cwceq @ (XC @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc))))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xn) @ (XC @ Xn))) @ ccico)))))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XD @ Xk @ Xn)) @ (ccfv @ XX @ ccvoln))))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XS @ Xk @ Xn) @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ XA2) @ ccmin))) @ ccli)))))))))))))))))))).
