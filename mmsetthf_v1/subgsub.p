...
thf(csubgsub_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => ((cwceq @ XN @ (ccfv @ XH @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XS)) @ (cwceq @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XX @ XY @ XN)))))))))))))).
