...
thf(aatandmtan_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) @ (cwcel @ (ccfv @ XA2 @ cctan) @ (ccdm @ ccatan))))).
...
thf(atancl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) @ (cwcel @ (ccfv @ XA2 @ cctan) @ ccc)))).
...
thf(arenegd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccneg @ XA2) @ ccre) @ (ccneg @ (ccfv @ XA2 @ ccre)))))))).
...
thf(atanregt0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccre) @ cclt)))).
...
thf(aatanlogsub_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) @ (cwcel @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ (ccrn @ cclog))))).
...
thf(areim0bd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccim) @ ccc0)) => (cwi @ Xph @ (cwcel @ XA2 @ ccr))))))).
...
thf(atanhbnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cctan) @ cci @ ccdiv) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))))).
...
thf(catantan_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccatan) @ XA2)))).
