...
thf(algsmod_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) @ (cwceq @ (cco @ (cco @ XA2 @ XN @ ccmo) @ XN @ cclgs) @ (cco @ XA2 @ XN @ cclgs)))))).
...
thf(clgsmodeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwa @ (cwcel @ XN @ ccn) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)))) @ (cwi @ (cwceq @ (cco @ XA2 @ XN @ ccmo) @ (cco @ XB2 @ XN @ ccmo)) @ (cwceq @ (cco @ XA2 @ XN @ cclgs) @ (cco @ XB2 @ XN @ cclgs)))))))).
