...
thf(adifgtsumgt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn0) @ (cwcel @ XC @ ccr)) @ (cwi @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ cclt) @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))))).
...
thf(cdifsqpwdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0) @ (cwbr @ (cco @ XB2 @ cc1 @ ccaddc) @ XA2 @ cclt)) @ (cwa @ (cwcel @ XC @ ccprime) @ (cwcel @ XD @ ccn0))) @ (cwi @ (cwceq @ (cco @ XC @ XD @ ccexp) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin)) @ (cwbr @ XC @ (cco @ cc2 @ XB2 @ ccmul) @ ccdvds)))))))).
