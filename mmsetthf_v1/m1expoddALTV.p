...
thf(aoddm1eveni_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ ccodd) @ (cwcel @ (cco @ XZ @ cc1 @ ccmin) @ cceven)))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwa_tp,type,(cwa : ($o > ($o > $o)))).
thf(am1expevenALTV_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ cceven) @ (cwceq @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ cc1)))).
thf(amulid2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ cc1 @ XA2 @ ccmul) @ XA2)))))).
thf(cm1expoddALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccodd) @ (cwceq @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (ccneg @ cc1))))).
