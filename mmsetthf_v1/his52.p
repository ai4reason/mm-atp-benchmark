...
thf(chis52_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (cco @ XB2 @ (cco @ (ccfv @ XA2 @ cccj) @ XC @ ccsm) @ ccsp) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccsp) @ ccmul))))))).
