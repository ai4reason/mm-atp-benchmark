...
thf(cstirlinglem2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ (XN @ Xn) @ ccn) @ (cwcel @ (ccfv @ (XN @ Xn) @ (XA2 @ Xn)) @ ccrp))))))).
