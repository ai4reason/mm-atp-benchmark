...
thf(cwfr2a_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((cwceq @ XF @ (ccwrecs @ XA2 @ XR @ XG)) => (cwi @ (cwcel @ XX @ (ccdm @ XF)) @ (cwceq @ (ccfv @ XX @ XF) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ XX)) @ XG)))))))))))).
