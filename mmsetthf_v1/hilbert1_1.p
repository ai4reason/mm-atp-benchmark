...
thf(alinerflx2_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XQ @ (ccfv @ XN @ ccee)) @ (cwne @ XP @ XQ))) @ (cwcel @ XQ @ (cco @ XP @ XQ @ ccline2))))))).
thf(aeleq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwcel @ XC @ XA2) @ (cwcel @ XC @ XB2))))))).
thf(chilbert1_1_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xx3) @ ccn) @ (cw3a @ (cwcel @ XP @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwcel @ XQ @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwne @ XP @ XQ))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwcel @ XQ @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : cclines2)))))))).
