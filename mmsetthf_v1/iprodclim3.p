...
thf(ciprodclim3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xn) @ ccz))) => ((cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xy1) @ ccc0) @ (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli))))) @ (^ [Xn:$i] : XZ))) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xy1 @ Xk @ Xn) @ (ccdm @ ccli)))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xy1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xj) @ (XF @ Xy1 @ Xk @ Xn)) @ (ccprod @ (^ [Xk:$i] : (cco @ (XM @ Xn) @ (ccv @ Xj) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))))))))) => (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XF @ Xy1 @ Xk @ Xn) @ (ccprod @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccli))))))))))))))))).
