...
thf(clnr2i_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ XN @ (ccfv @ XR @ ccrsp)) => (cwi @ (cwa @ (cwcel @ XR @ cclnr) @ (cwcel @ XI @ XU)) @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XI @ (ccfv @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XI) @ ccfn))))))))))).
