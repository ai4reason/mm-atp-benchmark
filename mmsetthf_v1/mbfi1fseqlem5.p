...
thf(ambfi1fseqlem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xy1:$i] : (cwceq @ (XJ @ Xy1) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv)))))) => (! [Xy1:$i] : (cwi @ Xph @ (cwf @ (ccxp @ ccn @ ccr) @ (cco @ ccc0 @ ccpnf @ ccico) @ (XJ @ Xy1))))))))))).
...
thf(cmbfi1fseqlem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (cwceq @ (XG @ Xy1 @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ ccn)) @ (cwa @ (cwbr @ cc0p @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)) @ (ccofr @ ccle)) @ (cwbr @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ (XG @ Xy1 @ Xm)) @ (ccofr @ ccle)))))))))))))))).
