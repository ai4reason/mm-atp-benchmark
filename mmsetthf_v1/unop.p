...
thf(cunop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ ccuo) @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ (ccfv @ XA2 @ XT) @ (ccfv @ XB2 @ XT) @ ccsp) @ (cco @ XA2 @ XB2 @ ccsp))))))).
