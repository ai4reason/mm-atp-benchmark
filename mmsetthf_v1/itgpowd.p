...
thf(citgpowd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccexp))) @ (cco @ (cco @ (cco @ XB2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccmin) @ (cco @ XN @ cc1 @ ccaddc) @ ccdiv)))))))))))).
