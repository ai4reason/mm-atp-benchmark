...
thf(cpr1eqbg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XX)) @ (cwne @ XA2 @ XB2)) @ (cwb @ (cwceq @ XA2 @ XC) @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccpr @ XB2 @ XC))))))))))).
