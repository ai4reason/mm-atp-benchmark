...
thf(amonotuz_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XH)) @ (cwbr @ (XF @ Xy1) @ (XG @ Xy1) @ cclt))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XH)) @ (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XH @ (ccfv @ (XI @ Xx3 @ Xy1) @ ccuz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwceq @ (XC @ Xx3) @ (XG @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XC @ Xx3) @ (XF @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (XC @ Xx3) @ XD))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwceq @ (XC @ Xx3) @ XE))) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XA2 @ XH) @ (cwcel @ XB2 @ XH))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XD @ XE @ cclt))))))))))))))))))))).
...
thf(armxypos_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwa @ (cwbr @ ccc0 @ (cco @ XA2 @ XN @ ccrmx) @ cclt) @ (cwbr @ ccc0 @ (cco @ XA2 @ XN @ ccrmy) @ ccle)))))).
...
thf(armyp1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmx) @ ccaddc)))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ann0uz_thm,axiom,(cwceq @ ccn0 @ (ccfv @ ccc0 @ ccuz))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aoveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF)))))))).
thf(cltrmynn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwbr @ XM @ XN @ cclt) @ (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ cclt))))))).
