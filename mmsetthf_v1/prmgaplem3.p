...
thf(cprmgaplem3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xp) @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (XN @ Xx3 @ Xy1) @ cclt)) @ (^ [Xp:$i] : ccprime)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (cwcel @ (XN @ Xx3 @ Xy1) @ (ccfv @ cc3 @ ccuz)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XA2 @ Xp)))) @ (^ [Xx3:$i] : (XA2 @ Xp))))))))))).
