...
thf(adf_spths_ax,axiom,(cwceq @ ccspths @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ (ccv @ Xg1) @ cctrls)) @ (cwfun @ (cccnv @ (ccv @ Xp))))))))))).
thf(cspthsfval_conj,conjecture,(! [XG:($i > $o)] : (cwceq @ (ccfv @ XG @ ccspths) @ (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cctrls)) @ (cwfun @ (cccnv @ (ccv @ Xp)))))))))).
