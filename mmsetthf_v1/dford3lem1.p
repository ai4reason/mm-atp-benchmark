...
thf(cdford3lem1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwtr @ XN) @ (cwral @ (^ [Xy1:$i] : (cwtr @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XN))) @ (cwral @ (^ [Xb:$i] : (cwa @ (cwtr @ (ccv @ Xb)) @ (cwral @ (^ [Xy1:$i] : (cwtr @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xb))))) @ (^ [Xb:$i] : XN))))).
