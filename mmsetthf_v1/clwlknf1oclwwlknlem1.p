...
thf(aige2m1fz_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwbr @ cc2 @ XN @ ccle)) @ (cwcel @ (cco @ XN @ cc1 @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))).
...
thf(cclwlknf1oclwwlknlem1_conj,conjecture,(! [XC:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XG @ ccclwlks)) @ (cwbr @ cc1 @ (ccfv @ (ccfv @ XC @ cc1st) @ cchash) @ ccle)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XC @ cc2nd) @ (ccop @ ccc0 @ (cco @ (ccfv @ (ccfv @ XC @ cc2nd) @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ cchash) @ (ccfv @ (ccfv @ XC @ cc1st) @ cchash)))))).
