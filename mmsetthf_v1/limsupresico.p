...
thf(climsupresico_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((cwceq @ XZ @ (cco @ XM @ ccpnf @ ccico)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ XZ) @ cclsp) @ (ccfv @ XF @ cclsp)))))))))))).
