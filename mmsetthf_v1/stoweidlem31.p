...
thf(cstoweidlem31_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XY:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (cwnf @ (^ [Xh:$i] : (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh)))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xh:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh)))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (cwnf @ (^ [Xw:$i] : (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh)))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwceq @ (XY @ Xv @ Xt @ Xe @ Xh @ Xi) @ (ccrab @ (^ [Xh:$i] : (cwral @ (^ [Xt:$i] : (cwa @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cc1 @ ccle))) @ (^ [Xt:$i] : (XT @ Xx3 @ Xv @ Xt @ Xi)))) @ (^ [Xh:$i] : (XA2 @ Xx3 @ Xv @ Xi)))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwceq @ (XV @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh @ Xi) @ (ccrab @ (^ [Xw:$i] : (cwral @ (^ [Xe:$i] : (cwrex @ (^ [Xh:$i] : (cw3a @ (cwral @ (^ [Xt:$i] : (cwa @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cc1 @ ccle))) @ (^ [Xt:$i] : (XT @ Xx3 @ Xv @ Xt @ Xi))) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ (ccv @ Xe) @ cclt)) @ (^ [Xt:$i] : (ccv @ Xw))) @ (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xe) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cclt)) @ (^ [Xt:$i] : (ccdif @ (XT @ Xx3 @ Xv @ Xt @ Xi) @ (XU @ Xx3 @ Xv @ Xt @ Xi)))))) @ (^ [Xh:$i] : (XA2 @ Xx3 @ Xv @ Xi)))) @ (^ [Xe:$i] : ccrp))) @ (^ [Xw:$i] : (XJ @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh @ Xi))))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwceq @ (XG @ Xw @ Xv @ Xt @ Xe @ Xh) @ (ccmpt @ (^ [Xw:$i] : (XR @ Xx3 @ Xv @ Xe @ Xi)) @ (^ [Xw:$i] : (ccrab @ (^ [Xh:$i] : (cw3a @ (cwral @ (^ [Xt:$i] : (cwa @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cc1 @ ccle))) @ (^ [Xt:$i] : (XT @ Xx3 @ Xv @ Xt @ Xi))) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ (cco @ (XE @ Xv @ Xi) @ (XM @ Xv) @ ccdiv) @ cclt)) @ (^ [Xt:$i] : (ccv @ Xw))) @ (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (cco @ (XE @ Xv @ Xi) @ (XM @ Xv) @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cclt)) @ (^ [Xt:$i] : (ccdif @ (XT @ Xx3 @ Xv @ Xt @ Xi) @ (XU @ Xx3 @ Xv @ Xt @ Xi)))))) @ (^ [Xh:$i] : (XA2 @ Xx3 @ Xv @ Xi))))))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwss @ (XR @ Xx3 @ Xv @ Xe @ Xi) @ (XV @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh @ Xi)))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwcel @ (XM @ Xv) @ ccn)))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwf1o @ (cco @ cc1 @ (XM @ Xv) @ ccfz) @ (XR @ Xx3 @ Xv @ Xe @ Xi) @ (ccv @ Xv)))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwcel @ (XE @ Xv @ Xi) @ ccrp))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwss @ (XB2 @ Xw @ Xv @ Xt @ Xe @ Xh @ Xi) @ (ccdif @ (XT @ Xx3 @ Xv @ Xt @ Xi) @ (XU @ Xx3 @ Xv @ Xt @ Xi))))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwcel @ (XV @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh @ Xi) @ ccvv))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwcel @ (XA2 @ Xx3 @ Xv @ Xi) @ ccvv))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwcel @ (ccrn @ (XG @ Xw @ Xv @ Xt @ Xe @ Xh)) @ ccfn)))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xv @ Xt @ Xe @ Xh) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwf @ (cco @ cc1 @ (XM @ Xv) @ ccfz) @ (XY @ Xv @ Xt @ Xe @ Xh @ Xi) @ (ccv @ Xx3)) @ (cwral @ (^ [Xi:$i] : (cwa @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xx3))) @ (cco @ (XE @ Xv @ Xi) @ (XM @ Xv) @ ccdiv) @ cclt)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xv)))) @ (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (cco @ (XE @ Xv @ Xi) @ (XM @ Xv) @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xx3))) @ cclt)) @ (^ [Xt:$i] : (XB2 @ Xw @ Xv @ Xt @ Xe @ Xh @ Xi))))) @ (^ [Xi:$i] : (cco @ cc1 @ (XM @ Xv) @ ccfz))))))))))))))))))))))))))))))))))))))))).
