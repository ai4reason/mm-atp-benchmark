...
thf(csgmmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1))) @ (cwceq @ (cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ ccsgm) @ (cco @ (cco @ XA2 @ XM @ ccsgm) @ (cco @ XA2 @ XN @ ccsgm) @ ccmul))))))).
