...
thf(aelicores_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccrn @ (ccres @ ccico @ (ccxp @ ccr @ ccr)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccico))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))).
...
thf(cicoresmbl_conj,conjecture,(cwss @ (ccrn @ (ccres @ ccico @ (ccxp @ ccr @ ccr))) @ (ccdm @ ccvol))).
