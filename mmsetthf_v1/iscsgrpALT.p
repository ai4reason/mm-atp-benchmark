...
thf(adf_csgrp2_ax,axiom,(cwceq @ cccsgrp2 @ (ccrab @ (^ [Xg1:$i] : (cwbr @ (ccfv @ (ccv @ Xg1) @ ccplusg) @ (ccfv @ (ccv @ Xg1) @ ccbs) @ cccomlaw)) @ (^ [Xg1:$i] : ccsgrp2)))).
thf(ciscsgrpALT_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_op @ (ccfv @ XM @ ccplusg)) => (cwb @ (cwcel @ XM @ cccsgrp2) @ (cwa @ (cwcel @ XM @ ccsgrp2) @ (cwbr @ Xc_op @ XB2 @ cccomlaw))))))))).
