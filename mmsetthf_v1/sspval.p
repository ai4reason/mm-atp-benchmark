...
thf(adf_ssp_ax,axiom,(cwceq @ ccss @ (ccmpt @ (^ [Xu:$i] : ccnv) @ (^ [Xu:$i] : (ccrab @ (^ [Xw:$i] : (cw3a @ (cwss @ (ccfv @ (ccv @ Xw) @ ccpv) @ (ccfv @ (ccv @ Xu) @ ccpv)) @ (cwss @ (ccfv @ (ccv @ Xw) @ ccns) @ (ccfv @ (ccv @ Xu) @ ccns)) @ (cwss @ (ccfv @ (ccv @ Xw) @ ccnmcv) @ (ccfv @ (ccv @ Xu) @ ccnmcv)))) @ (^ [Xw:$i] : ccnv)))))).
...
thf(csspval_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((! [Xw:$i] : (cwceq @ (XH @ Xw) @ (ccfv @ XU @ ccss))) => (! [Xw:$i] : (cwi @ (cwcel @ XU @ ccnv) @ (cwceq @ (XH @ Xw) @ (ccrab @ (^ [Xw:$i] : (cw3a @ (cwss @ (ccfv @ (ccv @ Xw) @ ccpv) @ XG) @ (cwss @ (ccfv @ (ccv @ Xw) @ ccns) @ XS) @ (cwss @ (ccfv @ (ccv @ Xw) @ ccnmcv) @ XN))) @ (^ [Xw:$i] : ccnv))))))))))))))).
