...
thf(amulsubd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XD @ XB2 @ ccmul) @ ccaddc) @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccaddc) @ ccmin))))))))))))).
thf(arecnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwcel @ XA2 @ ccc)))))).
thf(aelioored_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccioo))) => (cwi @ Xph @ (cwcel @ XA2 @ ccr)))))))).
...
thf(altleaddd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XC @ cclt)) => ((cwi @ Xph @ (cwbr @ XB2 @ XD @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ cclt)))))))))))))).
...
thf(aioogtlbd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ cclt)))))))))).
thf(aiooltubd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => (cwi @ Xph @ (cwbr @ XC @ XB2 @ cclt)))))))))).
...
thf(asqrlearg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ XA2 @ ccle) @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)))))))).
...
thf(altsub1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin) @ cclt))))))))))).
thf(csmfmullem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ ccr)) => ((cwi @ Xph @ (cwcel @ XV @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XU @ XV @ ccmul) @ XA2 @ cclt)) => ((cwceq @ XX @ (cco @ (cco @ XA2 @ (cco @ XU @ XV @ ccmul) @ ccmin) @ (cco @ cc1 @ (cco @ (ccfv @ XU @ ccabs) @ (ccfv @ XV @ ccabs) @ ccaddc) @ ccaddc) @ ccdiv)) => ((cwceq @ XY @ (ccif @ (cwbr @ cc1 @ XX @ ccle) @ cc1 @ XX)) => ((cwi @ Xph @ (cwcel @ XP @ (cco @ (cco @ XU @ XY @ ccmin) @ XU @ ccioo))) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ XU @ (cco @ XU @ XY @ ccaddc) @ ccioo))) => ((cwi @ Xph @ (cwcel @ XS @ (cco @ (cco @ XV @ XY @ ccmin) @ XV @ ccioo))) => ((cwi @ Xph @ (cwcel @ XZ @ (cco @ XV @ (cco @ XV @ XY @ ccaddc) @ ccioo))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XP @ XR @ ccioo))) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ XS @ XZ @ ccioo))) => (cwi @ Xph @ (cwbr @ (cco @ XH @ XI @ ccmul) @ XA2 @ cclt))))))))))))))))))))))))))).
