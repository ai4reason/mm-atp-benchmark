...
thf(aeldmrexrn_thm,axiom,(! [XF:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwi @ (cwcel @ XY @ (ccdm @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccfv @ XY @ XF))) @ (^ [Xx3:$i] : (ccrn @ XF)))))))).
...
thf(celdmrexrnb_conj,conjecture,(! [XF:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwnel @ cc0 @ (ccrn @ XF))) @ (cwb @ (cwcel @ XY @ (ccdm @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccfv @ XY @ XF))) @ (^ [Xx3:$i] : (ccrn @ XF)))))))).
