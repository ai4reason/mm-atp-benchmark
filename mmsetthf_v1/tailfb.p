...
thf(atailini_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwa @ (cwcel @ XD @ ccdir) @ (cwcel @ XA2 @ XX)) @ (cwcel @ XA2 @ (ccfv @ XA2 @ (ccfv @ XD @ cctail))))))))).
...
thf(adirge_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdir) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ XR) @ (cwbr @ XB2 @ (ccv @ Xx3) @ XR))) @ (^ [Xx3:$i] : XX))))))))).
...
thf(adirtr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccdir) @ (cwcel @ XC @ XV)) @ (cwa @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XB2 @ XC @ XR))) @ (cwbr @ XA2 @ XC @ XR)))))))).
...
thf(ctailfb_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwa @ (cwcel @ XD @ ccdir) @ (cwne @ XX @ cc0)) @ (cwcel @ (ccrn @ (ccfv @ XD @ cctail)) @ (ccfv @ XX @ ccfbas))))))).
