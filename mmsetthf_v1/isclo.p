...
thf(cisclo_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ XA2 @ (ccin @ XJ @ (ccfv @ XJ @ cccld))) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : (cwb @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xz) @ XA2))) @ (^ [Xz:$i] : (ccv @ Xy1))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XX))))))))).
