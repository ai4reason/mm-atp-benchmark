...
thf(cquseccl_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((cwceq @ XV @ (ccfv @ XG @ ccbs)) => ((cwceq @ XB2 @ (ccfv @ XH @ ccbs)) => (cwi @ (cwa @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwcel @ XX @ XV)) @ (cwcel @ (ccec @ XX @ (cco @ XG @ XS @ ccqg)) @ XB2)))))))))))).
