...
thf(aclimcnds_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XG) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ XF) @ ccmul)))) => (cwi @ Xph @ (cwb @ (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli)) @ (cwcel @ (ccseq @ ccaddc @ XG @ ccc0) @ (ccdm @ ccli)))))))))))).
...
thf(charmonic_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccseq @ ccaddc @ (XF @ Xn) @ cc1))) => (! [Xn:$i] : (cwn @ (cwcel @ (XH @ Xn) @ (ccdm @ ccli))))))))).
