...
thf(apm2_621_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwi @ Xph @ Xps) @ (cwi @ (cwo @ Xph @ Xps) @ Xps))))).
...
thf(aordi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwo @ Xph @ (cwa @ Xps @ Xch)) @ (cwa @ (cwo @ Xph @ Xps) @ (cwo @ Xph @ Xch))))))).
...
thf(cundif4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ (ccin @ XA2 @ XC) @ cc0) @ (cwceq @ (ccun @ XA2 @ (ccdif @ XB2 @ XC)) @ (ccdif @ (ccun @ XA2 @ XB2) @ XC))))))).
