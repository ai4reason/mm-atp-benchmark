...
thf(cquotdgr_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XR @ (cco @ XF @ (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)) @ (ccof @ ccmin))) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwne @ XG @ cc0p)) @ (cwo @ (cwceq @ XR @ cc0p) @ (cwbr @ (ccfv @ XR @ ccdgr) @ (ccfv @ XG @ ccdgr) @ cclt))))))))).
