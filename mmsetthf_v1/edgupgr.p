...
thf(cedgupgr_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg))) @ (cw3a @ (cwcel @ XE @ (ccpw @ (ccfv @ XG @ ccvtx))) @ (cwne @ XE @ cc0) @ (cwbr @ (ccfv @ XE @ cchash) @ cc2 @ ccle)))))).
