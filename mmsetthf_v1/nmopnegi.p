...
thf(anormneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwceq @ (ccfv @ (cco @ (ccneg @ cc1) @ XA2 @ ccsm) @ ccno) @ (ccfv @ XA2 @ ccno))))).
...
thf(cnmopnegi_conj,conjecture,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => (cwceq @ (ccfv @ (cco @ (ccneg @ cc1) @ XT @ cchot) @ ccnop) @ (ccfv @ XT @ ccnop))))).
