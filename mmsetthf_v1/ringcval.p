...
thf(adf_ringc_ax,axiom,(cwceq @ ccringc @ (ccmpt @ (^ [Xu:$i] : ccvv) @ (^ [Xu:$i] : (cco @ (ccfv @ (ccv @ Xu) @ ccestrc) @ (ccres @ ccrh @ (ccxp @ (ccin @ (ccv @ Xu) @ ccrg) @ (ccin @ (ccv @ Xu) @ ccrg))) @ ccresc))))).
...
thf(cringcval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccringc)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccin @ XU @ ccrg))) => ((cwi @ Xph @ (cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XB2 @ XB2)))) => (cwi @ Xph @ (cwceq @ XC @ (cco @ (ccfv @ XU @ ccestrc) @ XH @ ccresc)))))))))))))).
