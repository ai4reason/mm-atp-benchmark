...
thf(cunwf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwa @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ XB2 @ (ccuni @ (ccima @ ccr1 @ ccon0)))) @ (cwcel @ (ccun @ XA2 @ XB2) @ (ccuni @ (ccima @ ccr1 @ ccon0))))))).
