...
thf(apmapjoin_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cw3a @ (cwcel @ XK @ cclat) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwss @ (cco @ (ccfv @ XX @ XM) @ (ccfv @ XY @ XM) @ Xc_pl) @ (ccfv @ (cco @ XX @ XY @ Xc_or) @ XM))))))))))))))).
...
thf(apaddss12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cw3a @ (cwcel @ XK @ XB2) @ (cwss @ XY @ XA2) @ (cwss @ XW @ XA2)) @ (cwi @ (cwa @ (cwss @ XX @ XY) @ (cwss @ XZ @ XW)) @ (cwss @ (cco @ XX @ XZ @ Xc_pl) @ (cco @ XY @ XW @ Xc_pl))))))))))))))).
