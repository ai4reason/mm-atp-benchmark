...
thf(clcdvsub_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XS @ (ccfv @ XU @ ccsca)) => ((cwceq @ XN @ (ccfv @ XS @ ccminusg)) => ((cwceq @ Xc_1 @ (ccfv @ XS @ ccur)) => ((cwceq @ XC @ (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((cwceq @ XV @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XC @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccvsca)) => ((cwceq @ Xc_mi @ (ccfv @ XC @ ccsg)) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XG @ Xc_mi) @ (cco @ XF @ (cco @ (ccfv @ Xc_1 @ XN) @ XG @ Xc_x) @ Xc_pl)))))))))))))))))))))))))))))))).
