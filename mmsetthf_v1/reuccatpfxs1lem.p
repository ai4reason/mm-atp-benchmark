...
thf(accats1pfxeqrex_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwceq @ (ccfv @ XU @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) @ (cwi @ (cwceq @ XW @ (cco @ XU @ (ccfv @ XW @ cchash) @ ccpfx)) @ (cwrex @ (^ [Xs1:$i] : (cwceq @ XU @ (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat))) @ (^ [Xs1:$i] : XV)))))))).
