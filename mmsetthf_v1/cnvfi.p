...
thf(acnven_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwrel @ XA2) @ (cwcel @ XA2 @ XV)) @ (cwbr @ XA2 @ (cccnv @ XA2) @ ccen))))).
thf(aenfii_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ ccfn) @ (cwbr @ XA2 @ XB2 @ ccen)) @ (cwcel @ XA2 @ ccfn))))).
thf(ccnvfi_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwcel @ (cccnv @ XA2) @ ccfn)))).
