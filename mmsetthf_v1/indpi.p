...
thf(aelni2_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccnpi) @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ cc0 @ XA2))))).
...
thf(altpiord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclti) @ (cwcel @ XA2 @ XB2)))))).
...
thf(apion_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XA2 @ ccon0)))).
...
thf(anlt1pi_thm,axiom,(! [XA2:($i > $o)] : (cwn @ (cwbr @ XA2 @ cc1o @ cclti)))).
...
thf(cindpi_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ cc1o) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ cc1o @ ccpli)) @ (cwb @ (Xph @ Xx3) @ (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xta @ Xy1))))) => ((! [Xy1:$i] : (Xps @ Xy1)) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccnpi) @ (cwi @ (Xch @ Xy1) @ (Xth @ Xy1)))) => (! [Xy1:$i] : (cwi @ (cwcel @ (XA2 @ Xy1) @ ccnpi) @ (Xta @ Xy1)))))))))))))))).
