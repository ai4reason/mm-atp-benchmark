...
thf(cfrege77d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccvv)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XR @ cctcl))) => ((cwi @ Xph @ (cwss @ (ccima @ XR @ XU) @ XU)) => ((cwi @ Xph @ (cwss @ (ccima @ XR @ (ccsn @ XA2)) @ XU)) => (cwi @ Xph @ (cwcel @ XB2 @ XU)))))))))))))).
