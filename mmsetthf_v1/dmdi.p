...
thf(cdmdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwss @ XB2 @ XC))) @ (cwceq @ (cco @ (ccin @ XC @ XA2) @ XB2 @ cchj) @ (ccin @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
