...
thf(ccaovcomg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XF))))) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS))) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ (cco @ XB2 @ XA2 @ XF)))))))))).
