...
thf(acnre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))).
...
thf(acru_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccr))) @ (cwb @ (cwceq @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ (cco @ XC @ (cco @ cci @ XD @ ccmul) @ ccaddc)) @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD))))))))).
...
thf(ccreur_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))).
