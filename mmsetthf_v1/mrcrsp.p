...
thf(cmrcrsp_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ XK @ (ccfv @ XR @ ccrsp)) => ((cwceq @ XF @ (ccfv @ XU @ ccmrc)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ XK @ XF)))))))))).
