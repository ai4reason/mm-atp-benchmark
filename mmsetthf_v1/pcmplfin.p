...
thf(cpcmplfin_conj,conjecture,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xv:$i] : (cwceq @ (XX @ Xv) @ (ccuni @ XJ))) => (! [Xv:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ ccpcmp) @ (cwss @ XU @ XJ) @ (cwceq @ (XX @ Xv) @ (ccuni @ XU))) @ (cwrex @ (^ [Xv:$i] : (cwa @ (cwcel @ (ccv @ Xv) @ (ccfv @ XJ @ cclocfin)) @ (cwbr @ (ccv @ Xv) @ XU @ ccref))) @ (^ [Xv:$i] : (ccpw @ XJ)))))))))).
