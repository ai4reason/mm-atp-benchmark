...
thf(aocval_thm,axiom,(! [XH:($i > $o)] : (cwi @ (cwss @ XH @ cchil) @ (cwceq @ (ccfv @ XH @ ccort) @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp) @ ccc0)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : cchil)))))).
...
thf(cocsh_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ cchil) @ (cwcel @ (ccfv @ XA2 @ ccort) @ ccsh)))).
