...
thf(aoa00_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccoa) @ cc0) @ (cwa @ (cwceq @ XA2 @ cc0) @ (cwceq @ XB2 @ cc0))))))).
...
thf(adflim3_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwlim @ XA2) @ (cwa @ (cword @ XA2) @ (cwn @ (cwo @ (cwceq @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))))).
thf(coalimcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwa @ (cwcel @ XB2 @ XC) @ (cwlim @ XB2))) @ (cwlim @ (cco @ XA2 @ XB2 @ ccoa))))))).
