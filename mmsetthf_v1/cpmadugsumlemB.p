...
thf(ccpmadugsumlemB_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : (! [Xb:$i] : ((! [Xi:$i] : (cwceq @ (XA2 @ Xi) @ (cco @ XN @ XR @ ccmat))) => ((! [Xi:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xi) @ ccbs))) => ((! [Xi:$i] : (cwceq @ (XP @ Xi) @ (ccfv @ XR @ ccpl1))) => ((! [Xi:$i] : (cwceq @ XY @ (cco @ XN @ (XP @ Xi) @ ccmat))) => ((! [Xi:$i] : (cwceq @ (XT @ Xi) @ (cco @ XN @ XR @ ccmat2pmat))) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((! [Xi:$i] : (cwceq @ (Xc_ex @ Xi) @ (ccfv @ (ccfv @ (XP @ Xi) @ ccmgp) @ ccmg))) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccvsca)) => ((cwceq @ Xc_xp @ (ccfv @ XY @ ccmulr)) => ((cwceq @ Xc_1 @ (ccfv @ XY @ ccur)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) @ (cwa @ (cwcel @ (ccv @ Xs1) @ ccn0) @ (cwcel @ (ccv @ Xb) @ (cco @ XB2 @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) @ (cwceq @ (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ (Xc_ex @ Xi)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (XT @ Xi)) @ Xc_x))) @ ccgsu) @ Xc_xp) @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XX @ (Xc_ex @ Xi)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (XT @ Xi)) @ Xc_x))) @ ccgsu))))))))))))))))))))))))))))).
