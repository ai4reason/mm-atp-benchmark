...
thf(amodprm0_thm,axiom,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ (cco @ cc1 @ XP @ ccfzo)) @ (cwcel @ XI @ (cco @ cc1 @ XP @ ccfzo))) @ (cwrex @ (^ [Xj:$i] : (cwceq @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XN @ ccmul) @ ccaddc) @ XP @ ccmo) @ ccc0)) @ (^ [Xj:$i] : (cco @ ccc0 @ XP @ ccfzo)))))))).
thf(cnnnn0modprm0_conj,conjecture,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ (cco @ cc1 @ XP @ ccfzo)) @ (cwcel @ XI @ (cco @ ccc0 @ XP @ ccfzo))) @ (cwrex @ (^ [Xj:$i] : (cwceq @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XN @ ccmul) @ ccaddc) @ XP @ ccmo) @ ccc0)) @ (^ [Xj:$i] : (cco @ ccc0 @ XP @ ccfzo)))))))).
