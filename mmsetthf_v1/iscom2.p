...
thf(adf_com2_ax,axiom,(cwceq @ cccm2 @ (ccopab @ (^ [Xg1:$i] : (^ [Xh:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwceq @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xh)) @ (cco @ (ccv @ Xb) @ (ccv @ Xa) @ (ccv @ Xh)))) @ (^ [Xb:$i] : (ccrn @ (ccv @ Xg1))))) @ (^ [Xa:$i] : (ccrn @ (ccv @ Xg1))))))))).
...
thf(ciscom2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XG @ (XA2 @ Xa @ Xb)) @ (cwcel @ XH @ (XB2 @ Xa @ Xb))) @ (cwb @ (cwcel @ (ccop @ XG @ XH) @ cccm2) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwceq @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) @ (cco @ (ccv @ Xb) @ (ccv @ Xa) @ XH))) @ (^ [Xb:$i] : (ccrn @ XG)))) @ (^ [Xa:$i] : (ccrn @ XG)))))))))))).
