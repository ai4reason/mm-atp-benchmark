...
thf(cicoopn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwceq @ XJ @ (cco @ XK @ (cco @ XA2 @ XB2 @ ccico) @ ccrest)) => ((cwi @ Xph @ (cwbr @ XC @ XB2 @ ccle)) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XC @ ccico) @ XJ))))))))))))))).
