...
thf(crankxpl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwne @ (ccxp @ XA2 @ XB2) @ cc0) @ (cwss @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk) @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk)))))))).
