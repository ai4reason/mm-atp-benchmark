...
thf(ctgldim0eq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XP @ (ccfv @ XF @ XE)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XP @ cchash) @ cc1)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => (cwi @ Xph @ (cwceq @ XA2 @ XB2))))))))))))).
