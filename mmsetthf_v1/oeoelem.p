...
thf(coeoelem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ cc0 @ XA2) => (cwi @ (cwa @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccoe) @ XC @ ccoe) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccoe))))))))).
