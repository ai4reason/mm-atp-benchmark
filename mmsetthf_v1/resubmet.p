...
thf(cresubmet_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XR @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwceq @ XJ @ (ccfv @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XA2 @ XA2)) @ ccmopn)) => (cwi @ (cwss @ XA2 @ ccr) @ (cwceq @ XJ @ (cco @ XR @ XA2 @ ccrest))))))))).
