...
thf(cplymulx0_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccdif @ (ccfv @ ccr @ ccply) @ (ccsn @ cc0p))) @ (cwceq @ (ccfv @ (cco @ XF @ ccidp @ (ccof @ ccmul)) @ cccoe) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ ccc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccfv @ XF @ cccoe))))))))).
