...
thf(aupgredginwlk_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XF @ (ccword @ (ccdm @ XI)))) @ (cwi @ (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (cwcel @ (ccfv @ (ccfv @ XK @ XF) @ XI) @ XE))))))))))).
...
thf(cupgrwlkupwlk_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccupwlks))))))).
