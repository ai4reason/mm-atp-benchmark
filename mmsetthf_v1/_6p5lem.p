...
thf(c_6p5lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwcel @ XE @ ccn0) => ((cwceq @ XB2 @ (cco @ XD @ cc1 @ ccaddc)) => ((cwceq @ XC @ (cco @ XE @ cc1 @ ccaddc)) => ((cwceq @ (cco @ XA2 @ XD @ ccaddc) @ (ccdc @ cc1 @ XE)) => (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ (ccdc @ cc1 @ XC)))))))))))))).
