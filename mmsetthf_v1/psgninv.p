...
thf(cpsgninv_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ XP)) @ (cwceq @ (ccfv @ (cccnv @ XF) @ XN) @ (ccfv @ XF @ XN)))))))))))).
