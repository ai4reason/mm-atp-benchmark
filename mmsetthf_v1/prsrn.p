...
thf(aprsref_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => (cwi @ (cwa @ (cwcel @ XK @ ccpreset) @ (cwcel @ XX @ XB2)) @ (cwbr @ XX @ XX @ Xc_le))))))))).
...
thf(aopelxp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwcel @ (ccop @ XA2 @ XB2) @ (ccxp @ XC @ XD)) @ (cwcel @ XB2 @ XD))))))).
thf(aelrn2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ (ccrn @ XB2)) @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ XA2) @ XB2)))))))).
thf(cprsrn_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cwcel @ XK @ ccpreset) @ (cwceq @ (ccrn @ Xc_le) @ XB2)))))))).
