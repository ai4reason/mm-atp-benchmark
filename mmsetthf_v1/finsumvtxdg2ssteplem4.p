...
thf(afinsumvtxdg2ssteplem3_thm,axiom,(! [XP:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XK @ Xv @ Xi) @ (ccdif @ XV @ (ccsn @ XN))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XI @ Xv @ Xi) @ (ccrab @ (^ [Xi:$i] : (cwnel @ XN @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE)))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XP @ Xv @ Xi) @ (ccres @ XE @ (XI @ Xv @ Xi))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XS @ Xv @ Xi) @ (ccop @ (XK @ Xv @ Xi) @ (XP @ Xv @ Xi))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XJ @ Xv @ Xi) @ (ccrab @ (^ [Xi:$i] : (cwcel @ XN @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE)))))) => (! [Xv:$i] : (! [Xi:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XN @ XV)) @ (cwa @ (cwcel @ XV @ ccfn) @ (cwcel @ XE @ ccfn))) @ (cwceq @ (cco @ (ccsu @ (ccdif @ XV @ (ccsn @ XN)) @ (^ [Xv:$i] : (ccfv @ (ccrab @ (^ [Xi:$i] : (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (XJ @ Xv @ Xi))) @ cchash))) @ (ccfv @ (ccrab @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XE) @ (ccsn @ XN))) @ (^ [Xi:$i] : (ccdm @ XE))) @ cchash) @ ccaddc) @ (ccfv @ (XJ @ Xv @ Xi) @ cchash)))))))))))))))))))))).
