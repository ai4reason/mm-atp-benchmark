...
thf(adf_uni_ax,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccuni @ XA2) @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ XA2))))))))).
thf(celuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccuni @ XB2)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ XB2)))))))).
