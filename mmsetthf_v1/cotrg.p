...
thf(ccotrg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwss @ (cccom @ XA2 @ XB2) @ XC) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XB2) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XA2)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XC))))))))))))).
