...
thf(czfcndac_conj,conjecture,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))) @ (cwex @ (^ [Xv:$i] : (cwal @ (^ [Xu:$i] : (cwb @ (cwex @ (^ [Xt:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xt))) @ (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xt)) @ (cwcel @ (ccv @ Xt) @ (ccv @ Xy1)))))) @ (cwceq @ (ccv @ Xu) @ (ccv @ Xv)))))))))))))))).
