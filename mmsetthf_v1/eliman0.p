...
thf(afvbr0_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwo @ (cwbr @ XX @ (ccfv @ XX @ XF) @ XF) @ (cwceq @ (ccfv @ XX @ XF) @ cc0))))).
...
thf(celiman0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwn @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0))) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccima @ XF @ XB2))))))).
