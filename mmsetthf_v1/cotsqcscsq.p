...
thf(ccotsqcscsq_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) @ (cwceq @ (cco @ cc1 @ (cco @ (ccfv @ XA2 @ cccot) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (ccfv @ XA2 @ cccsc) @ cc2 @ ccexp))))).
