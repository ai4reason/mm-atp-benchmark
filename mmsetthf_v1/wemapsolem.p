...
thf(awemappo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ XS) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwor @ XA2 @ XR) @ (cwpo @ (XB2 @ Xy1 @ Xz @ Xw) @ XS)) @ (cwpo @ (cco @ (XB2 @ Xy1 @ Xz @ Xw) @ XA2 @ ccmap) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))).
...
thf(afndmdif_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XA2)) @ (cwceq @ (ccdm @ (ccdif @ XF @ XG)) @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(awemaplem1_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ XS) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XP @ (XV @ Xx3 @ Xy1 @ Xz @ Xw @ Xa @ Xb)) @ (cwcel @ XQ @ (XW @ Xx3 @ Xy1 @ Xz @ Xw @ Xa @ Xb))) @ (cwb @ (cwbr @ XP @ XQ @ (XT @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwrex @ (^ [Xa:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xa) @ XP) @ (ccfv @ (ccv @ Xa) @ XQ) @ XS) @ (cwral @ (^ [Xb:$i] : (cwi @ (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ XR) @ (cwceq @ (ccfv @ (ccv @ Xb) @ XP) @ (ccfv @ (ccv @ Xb) @ XQ)))) @ (^ [Xb:$i] : XA2)))) @ (^ [Xa:$i] : XA2)))))))))))))))))))).
...
thf(cwemapsolem_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ XS) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwss @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (cco @ (XB2 @ Xy1 @ Xz @ Xw) @ XA2 @ ccmap)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwcel @ XA2 @ ccvv)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwor @ XA2 @ XR)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwor @ (XB2 @ Xy1 @ Xz @ Xw) @ XS)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwcel @ (ccv @ Xb) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw))) @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)))) @ (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xd:$i] : (cwn @ (cwbr @ (ccv @ Xd) @ (ccv @ Xc) @ XR))) @ (^ [Xd:$i] : (ccdm @ (ccdif @ (ccv @ Xa) @ (ccv @ Xb)))))) @ (^ [Xc:$i] : (ccdm @ (ccdif @ (ccv @ Xa) @ (ccv @ Xb)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwor @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))))))))).
