...
thf(a_2ndfval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ XC @ XD @ ccxpc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XT @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XH @ (ccfv @ (XT @ Xx3 @ Xy1) @ cchom)))) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XQ @ Xx3 @ Xy1) @ (cco @ XC @ XD @ cc2ndf)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (XQ @ Xx3 @ Xy1) @ (ccop @ (ccres @ cc2nd @ XB2) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ cc2nd @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)))))))))))))))))))))))).
...
thf(afofun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfo @ XA2 @ XB2 @ XF) @ (cwfun @ XF)))))).
...
thf(axpccat_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (cco @ XC @ XD @ ccxpc)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => (cwi @ Xph @ (cwcel @ XT @ cccat)))))))))).
...
thf(axpchom_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XT @ (cco @ XC @ XD @ ccxpc)) => ((cwceq @ XB2 @ (ccfv @ XT @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ XJ @ (ccfv @ XD @ cchom)) => ((cwceq @ XK @ (ccfv @ XT @ cchom)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ XK) @ (ccxp @ (cco @ (ccfv @ XX @ cc1st) @ (ccfv @ XY @ cc1st) @ XH) @ (cco @ (ccfv @ XX @ cc2nd) @ (ccfv @ XY @ cc2nd) @ XJ)))))))))))))))))))))).
...
thf(axpcco2nd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XT @ (cco @ XC @ XD @ ccxpc)) => ((cwceq @ XB2 @ (ccfv @ XT @ ccbs)) => ((cwceq @ XK @ (ccfv @ XT @ cchom)) => ((cwceq @ XO @ (ccfv @ XT @ ccco)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ XY @ XK))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XY @ XZ @ XK))) => ((cwceq @ Xc_x @ (ccfv @ XD @ ccco)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ XO)) @ cc2nd) @ (cco @ (ccfv @ XG @ cc2nd) @ (ccfv @ XF @ cc2nd) @ (cco @ (ccop @ (ccfv @ XX @ cc2nd) @ (ccfv @ XY @ cc2nd)) @ (ccfv @ XZ @ cc2nd) @ Xc_x)))))))))))))))))))))))))))).
...
thf(c_2ndfcl_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (cco @ XC @ XD @ ccxpc)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((cwceq @ XQ @ (cco @ XC @ XD @ cc2ndf)) => (cwi @ Xph @ (cwcel @ XQ @ (cco @ XT @ XD @ ccfunc))))))))))))).
