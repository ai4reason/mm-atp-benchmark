...
thf(aintopsn_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_op:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ Xc_op) @ (cwcel @ XZ @ XB2)) @ (cwb @ (cwceq @ XB2 @ (ccsn @ XZ)) @ (cwceq @ Xc_op @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))))))))).
thf(cmgmb1mgm1_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XM @ ccmgm) @ (cwcel @ XZ @ XB2) @ (cwfn @ Xc_pl @ (ccxp @ XB2 @ XB2))) @ (cwb @ (cwceq @ XB2 @ (ccsn @ XZ)) @ (cwceq @ Xc_pl @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ)))))))))))).
