...
thf(ccfval2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ cccf) @ (cciin @ (^ [Xx3:$i] : (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : XA2))) @ (^ [Xx3:$i] : (ccpw @ XA2)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cccrd))))))).
