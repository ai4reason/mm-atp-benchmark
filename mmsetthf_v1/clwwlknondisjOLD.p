...
thf(cclwwlknondisjOLD_conj,conjecture,(! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xw:$i] : (cwdisj @ (^ [Xx3:$i] : (XV @ Xw)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xx3))) @ (^ [Xw:$i] : (cco @ (XN @ Xw) @ (XG @ Xw) @ ccclwwlkn)))))))))).
