...
thf(cuvtx01vtx_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwceq @ XE @ cc0) @ (cwb @ (cwne @ (ccfv @ XG @ ccuvtx) @ cc0) @ (cwceq @ (ccfv @ XV @ cchash) @ cc1))))))))).
