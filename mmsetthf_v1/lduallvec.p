...
thf(aopprdrng_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => (cwb @ (cwcel @ XR @ ccdr) @ (cwcel @ XO @ ccdr)))))).
thf(aislvec_thm,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => (cwb @ (cwcel @ XW @ cclvec) @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XF @ ccdr))))))).
thf(clduallvec_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XD @ (ccfv @ XW @ ccld)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => (cwi @ Xph @ (cwcel @ XD @ cclvec)))))))).
