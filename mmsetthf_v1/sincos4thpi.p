...
thf(asinhalfpi_thm,axiom,(cwceq @ (ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ ccsin) @ cc1)).
...
thf(apigt2lt4_thm,axiom,(cwa @ (cwbr @ cc2 @ ccpi @ cclt) @ (cwbr @ ccpi @ cc4 @ cclt))).
...
thf(asqrtmsqi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwi @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwceq @ (ccfv @ (cco @ XA2 @ XA2 @ ccmul) @ ccsqrt) @ XA2))))).
thf(csincos4thpi_conj,conjecture,(cwa @ (cwceq @ (ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ ccsin) @ (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)) @ (cwceq @ (ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ cccos) @ (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)))).
