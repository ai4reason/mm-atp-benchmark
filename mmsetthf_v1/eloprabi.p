...
thf(celoprabi_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > $o)))] : (! [Xth:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ XA2 @ cc1st) @ cc1st)) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz) @ (Xps @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccfv @ XA2 @ cc1st) @ cc2nd)) @ (cwb @ (Xps @ Xx3 @ Xy1 @ Xz) @ (Xch @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccfv @ XA2 @ cc2nd)) @ (cwb @ (Xch @ Xx3 @ Xy1 @ Xz) @ Xth))))) => (cwi @ (cwcel @ XA2 @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) @ Xth)))))))))).
