...
thf(cfzocatel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo)) @ (cwn @ (cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)))) @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ ccc0 @ XC @ ccfzo))))))).
