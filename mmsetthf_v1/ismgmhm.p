...
thf(adf_mgmhm_ax,axiom,(cwceq @ ccmgmhm @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : ccmgm)) @ (^ [Xs1:$i] : (^ [Xt:$i] : ccmgm)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xs1) @ ccplusg)) @ (ccv @ Xf1)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ ccplusg)))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xs1) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xs1) @ ccbs)))) @ (^ [Xf1:$i] : (cco @ (ccfv @ (ccv @ Xt) @ ccbs) @ (ccfv @ (ccv @ Xs1) @ ccbs) @ ccmap)))))))).
