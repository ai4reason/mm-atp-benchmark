...
thf(af1omptsnlem_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xu:$i] : (cwceq @ (XF @ Xu) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3)))))) => ((cwceq @ XR @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))) => (! [Xu:$i] : (cwf1o @ XA2 @ XR @ (XF @ Xu))))))))).
...
thf(cf1omptsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XF @ Xx3 @ Xu) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XR @ Xx3 @ Xu) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))) => (! [Xx3:$i] : (! [Xu:$i] : (cwf1o @ XA2 @ (XR @ Xx3 @ Xu) @ (XF @ Xx3 @ Xu)))))))))).
