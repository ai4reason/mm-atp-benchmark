...
thf(adf_odd_ax,axiom,(cwceq @ ccodd @ (ccrab @ (^ [Xz:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xz) @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz)) @ (^ [Xz:$i] : ccz)))).
thf(cisodd_conj,conjecture,(! [XZ:($i > $o)] : (cwb @ (cwcel @ XZ @ ccodd) @ (cwa @ (cwcel @ XZ @ ccz) @ (cwcel @ (cco @ (cco @ XZ @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz))))).
