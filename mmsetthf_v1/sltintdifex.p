...
thf(csltintdifex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur)) @ (cwi @ (cwbr @ XA2 @ XB2 @ ccslt) @ (cwcel @ (ccint @ (ccrab @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XA2) @ (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0))) @ ccvv)))))).
