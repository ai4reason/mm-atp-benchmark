...
thf(cargs_conj,conjecture,(! [XF:($i > ($i > $o))] : (cwceq @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwceq @ (ccima @ (XF @ Xx3) @ (ccsn @ (ccv @ Xx3))) @ (ccsn @ (ccv @ Xy1))))))) @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XF @ Xx3))))))))).
