...
thf(clnopsubmuli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (ccfv @ (cco @ XB2 @ (cco @ XA2 @ XC @ ccsm) @ ccmv) @ XT) @ (cco @ (ccfv @ XB2 @ XT) @ (cco @ XA2 @ (ccfv @ XC @ XT) @ ccsm) @ ccmv))))))))).
