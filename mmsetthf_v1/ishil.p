...
thf(adf_hil_ax,axiom,(cwceq @ cchs @ (ccrab @ (^ [Xh:$i] : (cwceq @ (ccdm @ (ccfv @ (ccv @ Xh) @ ccpj)) @ (ccfv @ (ccv @ Xh) @ cccss))) @ (^ [Xh:$i] : ccphl)))).
thf(cishil_conj,conjecture,(! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ XH @ ccpj)) => ((cwceq @ XC @ (ccfv @ XH @ cccss)) => (cwb @ (cwcel @ XH @ cchs) @ (cwa @ (cwcel @ XH @ ccphl) @ (cwceq @ (ccdm @ XK) @ XC))))))))).
