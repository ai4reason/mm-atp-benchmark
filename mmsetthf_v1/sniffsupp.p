...
thf(csniffsupp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XI @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ Xc_0 @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XX) @ (XA2 @ Xx3) @ Xc_0))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (XF @ Xx3) @ Xc_0 @ ccfsupp))))))))))))))).
