...
thf(cdec2dvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwceq @ (cco @ XB2 @ cc2 @ ccmul) @ XC) => ((cwceq @ XD @ (cco @ XC @ cc1 @ ccaddc)) => (cwn @ (cwbr @ cc2 @ (ccdc @ XA2 @ XD) @ ccdvds))))))))))).
