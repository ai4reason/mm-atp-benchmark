...
thf(ccvrnle_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ ccpo) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwbr @ XX @ XY @ XC)) @ (cwn @ (cwbr @ XY @ XX @ Xc_le))))))))))))).
