...
thf(aelrnrexdm_thm,axiom,(! [XF:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwi @ (cwcel @ XY @ (ccrn @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XY @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : (ccdm @ XF)))))))).
...
thf(aac6_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xf1)))))) => (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (XA2 @ Xy1) @ XB2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xf1)) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))))))))))))).
...
thf(afnfzo0hash_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwf @ (cco @ ccc0 @ XN @ ccfzo) @ XB2 @ XF)) @ (cwceq @ (ccfv @ XF @ cchash) @ XN)))))).
...
thf(aupgriswlk_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ ccupgr) @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cw3a @ (cwcel @ XF @ (ccword @ (ccdm @ XI))) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))))).
thf(cwlkiswwlksupgr2_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccupgr) @ (cwi @ (cwcel @ XP @ (ccfv @ XG @ ccwwlks)) @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks))))))))).
