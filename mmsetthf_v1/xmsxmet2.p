...
thf(cxmsxmet2_conj,conjecture,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XM @ ccbs)) => ((cwceq @ XD @ (ccfv @ XM @ ccds)) => (cwi @ (cwcel @ XM @ ccxme) @ (cwcel @ (ccres @ XD @ (ccxp @ XX @ XX)) @ (ccfv @ XX @ ccxmt))))))))).
