...
thf(cidsrngd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_as @ (ccfv @ XR @ ccstv)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ Xc_as) @ (ccv @ Xx3)))) => (cwi @ Xph @ (cwcel @ XR @ ccsr))))))))))).
