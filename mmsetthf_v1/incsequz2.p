...
thf(aincsequz_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwf @ ccn @ ccn @ XF) @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF) @ cclt)) @ (^ [Xm:$i] : ccn)) @ (cwcel @ XA2 @ ccn)) @ (cwrex @ (^ [Xn:$i] : (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ XA2 @ ccuz))) @ (^ [Xn:$i] : ccn)))))).
...
thf(aseqpo_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwpo @ XA2 @ XR) @ (cwf @ ccn @ XA2 @ XF)) @ (cwb @ (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccv @ Xs1) @ XF) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ XF) @ XR)) @ (^ [Xs1:$i] : ccn)) @ (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (ccv @ Xn) @ XF) @ XR)) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ ccuz)))) @ (^ [Xm:$i] : ccn)))))))).
...
thf(cincsequz2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwf @ ccn @ ccn @ XF) @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF) @ cclt)) @ (^ [Xm:$i] : ccn)) @ (cwcel @ XA2 @ ccn)) @ (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ XA2 @ ccuz))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xn) @ ccuz)))) @ (^ [Xn:$i] : ccn)))))).
