...
thf(aforesf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwfo @ XA2 @ XB2 @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ XB2 @ (ccres @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccpw @ XA2)))))))))).
thf(crabfodom_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (cwb @ (Xch @ Xy1) @ (Xps @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwfo @ XA2 @ XB2 @ XF)) => (cwi @ Xph @ (cwbr @ (ccrab @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XB2)) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccdom))))))))))))).
