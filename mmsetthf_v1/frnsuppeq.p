...
thf(cfrnsuppeq_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XI @ XV) @ (cwcel @ XZ @ XW)) @ (cwi @ (cwf @ XI @ XS @ XF) @ (cwceq @ (cco @ XF @ XZ @ ccsupp) @ (ccima @ (cccnv @ XF) @ (ccdif @ XS @ (ccsn @ XZ))))))))))))).
