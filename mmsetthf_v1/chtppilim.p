...
thf(achtppilimlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ cclt)) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccppi) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccht) @ cclt))) @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)))) @ (^ [Xz:$i] : ccr)))))))).
...
thf(achtleppi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwbr @ (ccfv @ XA2 @ cccht) @ (cco @ (ccfv @ XA2 @ ccppi) @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccle)))).
