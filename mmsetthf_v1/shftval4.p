...
thf(cshftval4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ XB2 @ (cco @ XF @ (ccneg @ XA2) @ ccshi)) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ XF)))))))).
