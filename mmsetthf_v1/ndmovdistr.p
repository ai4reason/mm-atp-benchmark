...
thf(aanandi3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ (cwa @ Xph @ Xch))))))).
thf(cndmovdistr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ (ccdm @ XF) @ (ccxp @ XS @ XS)) => ((cwn @ (cwcel @ cc0 @ XS)) => ((cwceq @ (ccdm @ XG) @ (ccxp @ XS @ XS)) => (cwi @ (cwn @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS))) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ XF) @ XG) @ (cco @ (cco @ XA2 @ XB2 @ XG) @ (cco @ XA2 @ XC @ XG) @ XF))))))))))))).
