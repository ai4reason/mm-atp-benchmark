...
thf(adf_fcf_ax,axiom,(cwceq @ ccfcf @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xf1:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xf1:$i] : (ccuni @ (ccrn @ ccfil)))) @ (^ [Xj:$i] : (^ [Xf1:$i] : (ccmpt @ (^ [Xg1:$i] : (cco @ (ccuni @ (ccv @ Xj)) @ (ccuni @ (ccv @ Xf1)) @ ccmap)) @ (^ [Xg1:$i] : (cco @ (ccv @ Xj) @ (ccfv @ (ccv @ Xf1) @ (cco @ (ccuni @ (ccv @ Xj)) @ (ccv @ Xg1) @ ccfm)) @ ccfcls)))))))).
...
thf(cfcfval_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwceq @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)) @ (cco @ XJ @ (ccfv @ XL @ (cco @ XX @ XF @ ccfm)) @ ccfcls))))))))).
