...
thf(apcz_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwb @ (cwcel @ XA2 @ ccz) @ (cwral @ (^ [Xp:$i] : (cwbr @ ccc0 @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ ccle)) @ (^ [Xp:$i] : ccprime)))))).
...
thf(cpcmptdvds_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (XA2 @ Xn) @ ccexp) @ cc1))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwral @ (^ [Xn:$i] : (cwcel @ (XA2 @ Xn) @ ccn0)) @ (^ [Xn:$i] : ccprime)))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XM @ Xn) @ (ccfv @ (XN @ Xn) @ ccuz)))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccfv @ (XN @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ (ccfv @ (XM @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ ccdvds))))))))))))).
