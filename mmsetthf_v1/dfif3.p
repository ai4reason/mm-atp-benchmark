...
thf(anotab_thm,axiom,(! [Xph:($i > $o)] : (cwceq @ (ccab @ (^ [Xx3:$i] : (cwn @ (Xph @ Xx3)))) @ (ccdif @ ccvv @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
thf(adifeq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccdif @ XC @ XA2) @ (ccdif @ XC @ XB2))))))).
thf(cdfif3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccab @ (^ [Xx3:$i] : Xph)))) => (! [Xx3:$i] : (cwceq @ (ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (ccun @ (ccin @ (XA2 @ Xx3) @ (XC @ Xx3)) @ (ccin @ (XB2 @ Xx3) @ (ccdif @ ccvv @ (XC @ Xx3)))))))))))).
