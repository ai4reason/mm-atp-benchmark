...
thf(ashjval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh)) @ (cwceq @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ (ccfv @ (ccun @ XA2 @ XB2) @ ccort) @ ccort)))))).
...
thf(aoccon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ cchil) @ (cwss @ XB2 @ cchil)) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccfv @ XB2 @ ccort) @ (ccfv @ XA2 @ ccort))))))).
thf(achsscon1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwss @ (ccfv @ XA2 @ ccort) @ XB2) @ (cwss @ (ccfv @ XB2 @ ccort) @ XA2))))))).
...
thf(cshjshsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwceq @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ (ccfv @ (cco @ XA2 @ XB2 @ ccph) @ ccort) @ ccort))))))).
