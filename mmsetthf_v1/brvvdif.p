...
thf(cbrvvdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwbr @ XA2 @ XB2 @ (ccdif @ (ccxp @ ccvv @ ccvv) @ XR)) @ (cwn @ (cwbr @ XA2 @ XB2 @ XR)))))))))).
