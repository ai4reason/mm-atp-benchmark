...
thf(atospos_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ cctos) @ (cwcel @ XF @ ccpo)))).
thf(aposprs_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccpo) @ (cwcel @ XK @ ccpreset)))).
thf(aordtrestNEW_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cwa @ (cwcel @ XK @ ccpreset) @ (cwss @ XA2 @ XB2)) @ (cwss @ (ccfv @ (ccin @ Xc_le @ (ccxp @ XA2 @ XA2)) @ ccordt) @ (cco @ (ccfv @ Xc_le @ ccordt) @ XA2 @ ccrest)))))))))).
...
thf(atgrest_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XA2 @ XW)) @ (cwceq @ (ccfv @ (cco @ XB2 @ XA2 @ ccrest) @ cctg) @ (cco @ (ccfv @ XB2 @ cctg) @ XA2 @ ccrest)))))))).
...
thf(afirest_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwceq @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ ccfi) @ (cco @ (ccfv @ XJ @ ccfi) @ XA2 @ ccrest))))).
thf(amp1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((cwi @ Xph @ Xps) => (cwi @ Xch @ Xps))))))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(ainex1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccin @ XA2 @ XB2) @ ccvv))))).
thf(aordttop_thm,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwcel @ (ccfv @ XR @ ccordt) @ cctop))))).
thf(asylibr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwb @ Xch @ Xps) => (cwi @ Xph @ Xch))))))).
thf(aeqeltrrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XA2 @ XC)) => (cwi @ Xph @ (cwcel @ XB2 @ XC))))))))).
thf(aordtprsuni_thm,axiom,(! [XB2:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XE @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_le))) @ (^ [Xy1:$i] : XB2)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le))) @ (^ [Xy1:$i] : XB2)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XK @ ccpreset) @ (cwceq @ XB2 @ (ccuni @ (ccun @ (ccsn @ XB2) @ (ccun @ (XE @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)))))))))))))))))).
...
thf(aprsssdm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cwa @ (cwcel @ XK @ ccpreset) @ (cwss @ XA2 @ XB2)) @ (cwceq @ (ccdm @ (ccin @ Xc_le @ (ccxp @ XA2 @ XA2))) @ XA2))))))))).
...
thf(aordtrest2NEWlem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [Xc_le:($i > $o)] : ((! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (cwceq @ XB2 @ (ccfv @ (XK @ Xz @ Xw @ Xv) @ ccbs))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (cwceq @ Xc_le @ (ccin @ (ccfv @ (XK @ Xz @ Xw @ Xv) @ ccple) @ (ccxp @ XB2 @ XB2)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (cwi @ (Xph @ Xw @ Xv) @ (cwcel @ (XK @ Xz @ Xw @ Xv) @ cctos))))) => ((! [Xw:$i] : (! [Xv:$i] : (cwi @ (Xph @ Xw @ Xv) @ (cwss @ XA2 @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (cwi @ (cwa @ (Xph @ Xw @ Xv) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2))) @ (cwss @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le))) @ (^ [Xz:$i] : XB2)) @ XA2)))))) => (! [Xw:$i] : (! [Xv:$i] : (cwi @ (Xph @ Xw @ Xv) @ (cwral @ (^ [Xv:$i] : (cwcel @ (ccin @ (ccv @ Xv) @ XA2) @ (ccfv @ (ccin @ Xc_le @ (ccxp @ XA2 @ XA2)) @ ccordt))) @ (^ [Xv:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : XB2) @ (^ [Xz:$i] : (ccrab @ (^ [Xw:$i] : (cwn @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ Xc_le))) @ (^ [Xw:$i] : XB2))))))))))))))))))))).
...
thf(aodutos_thm,axiom,(! [XD:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XD @ (ccfv @ XK @ ccodu)) => (cwi @ (cwcel @ XK @ cctos) @ (cwcel @ XD @ cctos)))))).
...
thf(aordtcnvNEW_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cwcel @ XK @ ccpreset) @ (cwceq @ (ccfv @ (cccnv @ Xc_le) @ ccordt) @ (ccfv @ Xc_le @ ccordt))))))))).
...
thf(atgfiss_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XJ)) @ (cwss @ (ccfv @ (ccfv @ XA2 @ ccfi) @ cctg) @ XJ))))).
thf(cordtrest2NEW_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => ((cwi @ Xph @ (cwcel @ XK @ cctos)) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2))) @ (cwss @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le))) @ (^ [Xz:$i] : XB2)) @ XA2)))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccin @ Xc_le @ (ccxp @ XA2 @ XA2)) @ ccordt) @ (cco @ (ccfv @ Xc_le @ ccordt) @ XA2 @ ccrest)))))))))))))).
