...
thf(clocfincf_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XK @ (ccfv @ XX @ cctopon)) @ (cwss @ XJ @ XK)) @ (cwss @ (ccfv @ XJ @ cclocfin) @ (ccfv @ XK @ cclocfin)))))))).
