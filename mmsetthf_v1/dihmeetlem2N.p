...
thf(cdihmeetlem2N_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XB2 @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccbs)))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (Xc_an @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccmee)))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XH @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ cclh)))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XI @ Xh @ Xq) @ (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccdih))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (Xc_le @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccple)))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (Xc_or @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccjn)))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XA2 @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccatm)))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XP @ Xh @ Xq) @ (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccoc))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XT @ Xh @ Xq) @ (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccltrn))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XR @ Xh @ Xq) @ (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ cctrl))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XE @ Xh @ Xq) @ (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ cctendo))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XG @ Xh @ Xq) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ (XP @ Xh @ Xq) @ (ccv @ Xh)) @ (ccv @ Xq))) @ (^ [Xh:$i] : (XT @ Xh @ Xq)))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (Xc_0 @ Xh @ Xq) @ (ccmpt @ (^ [Xh:$i] : (XT @ Xh @ Xq)) @ (^ [Xh:$i] : (ccres @ ccid @ (XB2 @ Xh @ Xq))))))) => (! [Xh:$i] : (! [Xq:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ (XK @ Xh @ Xq) @ cchlt) @ (cwcel @ (XW @ Xh @ Xq) @ (XH @ Xh @ Xq))) @ (cwa @ (cwcel @ (XX @ Xh @ Xq) @ (XB2 @ Xh @ Xq)) @ (cwbr @ (XX @ Xh @ Xq) @ (XW @ Xh @ Xq) @ (Xc_le @ Xh @ Xq))) @ (cwa @ (cwcel @ (XY @ Xh @ Xq) @ (XB2 @ Xh @ Xq)) @ (cwbr @ (XY @ Xh @ Xq) @ (XW @ Xh @ Xq) @ (Xc_le @ Xh @ Xq)))) @ (cwceq @ (ccfv @ (cco @ (XX @ Xh @ Xq) @ (XY @ Xh @ Xq) @ (Xc_an @ Xh @ Xq)) @ (XI @ Xh @ Xq)) @ (ccin @ (ccfv @ (XX @ Xh @ Xq) @ (XI @ Xh @ Xq)) @ (ccfv @ (XY @ Xh @ Xq) @ (XI @ Xh @ Xq)))))))))))))))))))))))))))))))))))))).
