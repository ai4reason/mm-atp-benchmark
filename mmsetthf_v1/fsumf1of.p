...
thf(cfsumf1of_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xk @ Xn)))) => ((! [Xk:$i] : (cwnf @ (^ [Xn:$i] : (Xph @ Xk @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (XG @ Xn)) @ (cwceq @ (XB2 @ Xk) @ (XD @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwcel @ (XC @ Xk) @ ccfn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwf1o @ (XC @ Xk) @ (XA2 @ Xn) @ (XF @ Xk))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xk @ Xn) @ (cwcel @ (ccv @ Xn) @ (XC @ Xk))) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (XF @ Xk)) @ (XG @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xk @ Xn) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xn))) @ (cwcel @ (XB2 @ Xk) @ ccc)))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwceq @ (ccsu @ (XA2 @ Xn) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsu @ (XC @ Xk) @ (^ [Xn:$i] : (XD @ Xn)))))))))))))))))))))).
