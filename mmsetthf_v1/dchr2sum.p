...
thf(adchrinv_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XX @ XD)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ XI) @ (cccom @ cccj @ XX)))))))))))))).
...
thf(cdchr2sum_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : (cwceq @ XG @ (ccfv @ (XN @ Xa) @ ccdchr))) => ((! [Xa:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : (cwceq @ (XD @ Xa) @ (ccfv @ XG @ ccbs))) => ((cwceq @ XB2 @ (ccfv @ XZ @ ccbs)) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xa)))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XY @ (XD @ Xa)))) => (! [Xa:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XB2 @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ XX) @ (ccfv @ (ccfv @ (ccv @ Xa) @ XY) @ cccj) @ ccmul))) @ (ccif @ (cwceq @ XX @ XY) @ (ccfv @ (XN @ Xa) @ ccphi) @ ccc0))))))))))))))))))).
