...
thf(cacunirnmpt2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3 @ Xf1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwne @ (XB2 @ Xx3 @ Xj) @ cc0)))) => ((! [Xx3:$i] : (cwceq @ XC @ (ccuni @ (ccrn @ (ccmpt @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xx3 @ Xj))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) @ (cwceq @ (XB2 @ Xx3 @ Xj) @ (XD @ Xx3 @ Xf1)))))) => (cwi @ Xph @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XC @ XA2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XD @ Xx3 @ Xf1))) @ (^ [Xx3:$i] : XC))))))))))))))))).
