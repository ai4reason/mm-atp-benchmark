...
thf(csuplem2pr_conj,conjecture,(! [Xy1:$i] : (! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccnp) @ (cwa @ (cwi @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwn @ (cwbr @ (ccuni @ XA2) @ (ccv @ Xy1) @ ccltp))) @ (cwi @ (cwbr @ (ccv @ Xy1) @ (ccuni @ XA2) @ ccltp) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltp)) @ (^ [Xz:$i] : XA2)))))))).
