...
thf(cwl_aleq_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)))) @ (cwa @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwb @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)))))))))).
