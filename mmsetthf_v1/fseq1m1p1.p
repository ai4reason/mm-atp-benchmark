...
thf(afseq1p1m1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XH @ (ccsn @ (ccop @ (cco @ XN @ cc1 @ ccaddc) @ XB2))) => (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cw3a @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ XA2 @ XF) @ (cwcel @ XB2 @ XA2) @ (cwceq @ XG @ (ccun @ XF @ XH))) @ (cw3a @ (cwf @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ XA2 @ XG) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XG) @ XB2) @ (cwceq @ XF @ (ccres @ XG @ (cco @ cc1 @ XN @ ccfz)))))))))))))).
...
thf(cfseq1m1p1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XH @ (ccsn @ (ccop @ XN @ XB2))) => (cwi @ (cwcel @ XN @ ccn) @ (cwb @ (cw3a @ (cwf @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ XA2 @ XF) @ (cwcel @ XB2 @ XA2) @ (cwceq @ XG @ (ccun @ XF @ XH))) @ (cw3a @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ XA2 @ XG) @ (cwceq @ (ccfv @ XN @ XG) @ XB2) @ (cwceq @ XF @ (ccres @ XG @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))))))))))))).
