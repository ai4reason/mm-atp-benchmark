...
thf(alerec2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ XA2 @ (cco @ cc1 @ XB2 @ ccdiv) @ ccle)) => (cwi @ Xph @ (cwbr @ XB2 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccle))))))))).
...
thf(abernneq2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwbr @ (cco @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmul) @ cc1 @ ccaddc) @ (cco @ XA2 @ XN @ ccexp) @ ccle))))).
...
thf(cexpcnv_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccc))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccexp))) @ ccc0 @ ccli)))))))).
