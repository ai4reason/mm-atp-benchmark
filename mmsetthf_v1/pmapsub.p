...
thf(cpmapsub_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ cclat) @ (cwcel @ XX @ XB2)) @ (cwcel @ (ccfv @ XX @ XM) @ XS))))))))))).
