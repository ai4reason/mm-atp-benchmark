...
thf(aply1mulgsumlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XP @ Xn @ Xs1) @ (ccfv @ XR @ ccpl1)))) => ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xn @ Xs1) @ ccbs)))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccco1)) => ((cwceq @ XC @ (ccfv @ XL @ ccco1)) => ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XX @ Xn @ Xs1) @ (ccfv @ XR @ ccv1)))) => ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (Xc_xp @ Xn @ Xs1) @ (ccfv @ (XP @ Xn @ Xs1) @ ccmulr)))) => ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (Xc_x @ Xn @ Xs1) @ (ccfv @ (XP @ Xn @ Xs1) @ ccvsca)))) => ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (Xc_as @ Xn @ Xs1) @ (ccfv @ XR @ ccmulr)))) => ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XM @ Xn @ Xs1) @ (ccfv @ (XP @ Xn @ Xs1) @ ccmgp)))) => ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (Xc_ex @ Xn @ Xs1) @ (ccfv @ (XM @ Xn @ Xs1) @ ccmg)))) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ XB2) @ (cwcel @ XL @ XB2)) @ (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xn:$i] : (cwi @ (cwbr @ (ccv @ Xs1) @ (ccv @ Xn) @ cclt) @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xn) @ XA2) @ (ccfv @ XR @ cc0g)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XC) @ (ccfv @ XR @ cc0g))))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))))))))))))))).
