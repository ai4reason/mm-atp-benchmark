...
thf(apcfac_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (cco @ XP @ (ccfv @ XN @ ccfa) @ ccpc) @ (ccsu @ (cco @ cc1 @ XM @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ XN @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl))))))))).
