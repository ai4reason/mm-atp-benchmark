...
thf(cpsgnodpm_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) @ (cwceq @ (ccfv @ XF @ XN) @ (ccneg @ cc1)))))))))))).
