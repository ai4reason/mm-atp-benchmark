...
thf(apjopyth_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XH @ ccch) @ (cwcel @ XG @ ccch) @ (cwcel @ XA2 @ cchil)) @ (cwi @ (cwss @ XH @ (ccfv @ XG @ ccort)) @ (cwceq @ (cco @ (ccfv @ (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ ccva) @ ccno) @ cc2 @ ccexp) @ (cco @ (cco @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ ccno) @ cc2 @ ccexp) @ ccaddc)))))))).
...
thf(aisst_thm,axiom,(! [XS:($i > $o)] : (cwb @ (cwcel @ XS @ ccst) @ (cw3a @ (cwf @ ccch @ (cco @ ccc0 @ cc1 @ ccicc) @ XS) @ (cwceq @ (ccfv @ cchil @ XS) @ cc1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cchj) @ XS) @ (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccaddc)))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))))).
thf(cstrlem3a_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XS @ Xx3 @ Xu) @ (ccmpt @ (^ [Xx3:$i] : ccch) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xu) @ (ccfv @ (ccv @ Xx3) @ ccpjh)) @ ccno) @ cc2 @ ccexp)))))) => (! [Xx3:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xu) @ cchil) @ (cwceq @ (ccfv @ (ccv @ Xu) @ ccno) @ cc1)) @ (cwcel @ (XS @ Xx3 @ Xu) @ ccst))))))).
