...
thf(cknoppndvlem5_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XT @ Xx3 @ Xi) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xi @ Xn) @ (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3 @ Xi) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xi) @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xi)) @ ccmul)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xi) @ ccr)))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3 @ Xi) @ ccr)))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XN @ Xi) @ ccn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccsu @ (cco @ ccc0 @ (XJ @ Xx3) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ (XA2 @ Xi) @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ ccr)))))))))))))))))).
