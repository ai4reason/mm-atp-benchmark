...
thf(asincosq1lem_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ XA2 @ (cco @ ccpi @ cc2 @ ccdiv) @ cclt)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt)))).
...
thf(csinq12gt0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccioo)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt)))).
