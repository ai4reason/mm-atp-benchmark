...
thf(adf_mul_ax,axiom,(cwceq @ ccmul @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc)) @ (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xv:$i] : (cwex @ (^ [Xu:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwa @ (cwceq @ (ccv @ Xx3) @ (ccop @ (ccv @ Xw) @ (ccv @ Xv))) @ (cwceq @ (ccv @ Xy1) @ (ccop @ (ccv @ Xu) @ (ccv @ Xf1)))) @ (cwceq @ (ccv @ Xz) @ (ccop @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccmr) @ (cco @ ccm1r @ (cco @ (ccv @ Xv) @ (ccv @ Xf1) @ ccmr) @ ccmr) @ ccplr) @ (cco @ (cco @ (ccv @ Xv) @ (ccv @ Xu) @ ccmr) @ (cco @ (ccv @ Xw) @ (ccv @ Xf1) @ ccmr) @ ccplr))))))))))))))))))).
...
thf(caxmulf_conj,conjecture,(cwf @ (ccxp @ ccc @ ccc) @ ccc @ ccmul)).
