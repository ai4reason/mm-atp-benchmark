...
thf(afseqdom_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xn:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xn)) @ (cwbr @ (ccxp @ ccom @ XA2) @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccmap))) @ ccdom)))))).
...
thf(cfseqen_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen) @ (cwne @ XA2 @ cc0)) @ (cwbr @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccmap))) @ (ccxp @ ccom @ XA2) @ ccen)))).
