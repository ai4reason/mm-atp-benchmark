...
thf(csadasslem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn0)) => ((cwi @ Xph @ (cwss @ XB2 @ ccn0)) => ((cwi @ Xph @ (cwss @ XC @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccin @ (cco @ (cco @ XA2 @ XB2 @ ccsad) @ XC @ ccsad) @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccin @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccsad) @ ccsad) @ (cco @ ccc0 @ XN @ ccfzo)))))))))))))).
