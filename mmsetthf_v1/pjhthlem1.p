...
thf(anormsq_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ (cco @ XA2 @ XA2 @ ccsp))))).
...
thf(ahis2sub2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmv) @ ccsp) @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XA2 @ XC @ ccsp) @ ccmin))))))).
...
thf(ahire_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwcel @ (cco @ XA2 @ XB2 @ ccsp) @ ccr) @ (cwceq @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XA2 @ ccsp))))))).
...
thf(cpjhthlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ cchil))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ XH))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XC @ XH))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmv) @ ccno) @ ccle)) @ (^ [Xx3:$i] : XH)))) => ((cwceq @ XT @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccsp) @ (cco @ (cco @ XC @ XC @ ccsp) @ cc1 @ ccaddc) @ ccdiv)) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccsp) @ ccc0)))))))))))))))).
