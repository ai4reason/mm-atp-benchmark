...
thf(advres3_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwf @ XA2 @ ccc @ XF)) @ (cwa @ (cwss @ XA2 @ ccc) @ (cwss @ XS @ (ccdm @ (cco @ ccc @ XF @ ccdv))))) @ (cwceq @ (cco @ XS @ (ccres @ XF @ XS) @ ccdv) @ (ccres @ (cco @ ccc @ XF @ ccdv) @ XS))))))).
