...
thf(ctelgsumfz0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ XK @ (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xk) @ ccabl))) => ((! [Xk:$i] : (cwceq @ (Xc_mi @ Xk) @ (ccfv @ (XG @ Xk) @ ccsg))) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xk) @ XK)) @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ XS @ cc1 @ ccaddc) @ ccfz)))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccv @ Xi)) @ (cwceq @ (XA2 @ Xk) @ (XB2 @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc)) @ (cwceq @ (XA2 @ Xk) @ (XC @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ ccc0) @ (cwceq @ (XA2 @ Xk) @ (XD @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (cco @ XS @ cc1 @ ccaddc)) @ (cwceq @ (XA2 @ Xk) @ (XE @ Xi))))) => (! [Xi:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ XS @ ccfz)) @ (^ [Xi:$i] : (cco @ (XB2 @ Xi) @ (XC @ Xi) @ (Xc_mi @ Xk)))) @ ccgsu) @ (cco @ (XD @ Xi) @ (XE @ Xi) @ (Xc_mi @ Xk)))))))))))))))))))))))))).
