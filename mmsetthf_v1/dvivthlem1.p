...
thf(advferm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ ccr @ XF)) => ((cwi @ Xph @ (cwss @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX)) => ((cwi @ Xph @ (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => ((cwi @ Xph @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccioo)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccc0))))))))))))))).
...
thf(advferm1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ ccr @ XF)) => ((cwi @ Xph @ (cwss @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX)) => ((cwi @ Xph @ (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => ((cwi @ Xph @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XU @ XB2 @ ccioo)))) => (cwi @ Xph @ (cwbr @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccc0 @ ccle))))))))))))))).
...
thf(advferm2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ ccr @ XF)) => ((cwi @ Xph @ (cwss @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX)) => ((cwi @ Xph @ (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => ((cwi @ Xph @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XU @ ccioo)))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccle))))))))))))))).
...
thf(cdvivthlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwbr @ XM @ XN @ cclt)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ XM @ (cco @ ccr @ XF @ ccdv)) @ ccicc))) => ((! [Xy1:$i] : (cwceq @ (XG @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ XC @ (ccv @ Xy1) @ ccmul) @ ccmin))))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ XC)) @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccicc)))))))))))))))))))).
