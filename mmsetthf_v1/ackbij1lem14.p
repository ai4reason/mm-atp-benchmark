...
thf(acardsn_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (ccfv @ (ccsn @ XA2) @ cccrd) @ cc1o))))).
thf(aackbij1lem13_thm,axiom,(! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwceq @ (ccfv @ cc0 @ XF) @ cc0)))).
...
thf(aackbij1lem5_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccom) @ (cwceq @ (ccfv @ (ccpw @ (ccsuc @ XA2)) @ cccrd) @ (cco @ (ccfv @ (ccpw @ XA2) @ cccrd) @ (ccfv @ (ccpw @ XA2) @ cccrd) @ ccoa))))).
...
thf(aackbij1lem4_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccom) @ (cwcel @ (ccsn @ XA2) @ (ccin @ (ccpw @ ccom) @ ccfn))))).
...
thf(aackbij1lem9_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwi @ (cw3a @ (cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ (cwcel @ XB2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ XF) @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccoa)))))))).
...
thf(cackbij1lem14_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwi @ (cwcel @ XA2 @ ccom) @ (cwceq @ (ccfv @ (ccsn @ XA2) @ XF) @ (ccsuc @ (ccfv @ XA2 @ XF)))))))).
