...
thf(acncfperiod_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccr)) => ((cwceq @ XB2 @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ XT @ ccaddc))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccc))) => ((cwi @ Xph @ (cwf @ (ccdm @ XF) @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XB2 @ (ccdm @ XF))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XA2) @ (cco @ XA2 @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (ccres @ XF @ XB2) @ (cco @ XB2 @ ccc @ cccncf)))))))))))))))).
...
thf(affdm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwa @ (cwf @ (ccdm @ XF) @ XB2 @ XF) @ (cwss @ (ccdm @ XF) @ XA2))))))).
...
thf(aiccshift_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ ccr))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XB2 @ ccr))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XT @ ccr))) => (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwceq @ (cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccicc) @ (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ (ccv @ Xw) @ (cco @ (ccv @ Xz) @ XT @ ccaddc))) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xw:$i] : ccc))))))))))))).
...
thf(citgperiod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XT @ ccrp)) => ((cwi @ Xph @ (cwf @ ccr @ ccc @ XF)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccicc)) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF)))))))))))))))))).
