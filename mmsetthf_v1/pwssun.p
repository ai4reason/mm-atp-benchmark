...
thf(assun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwo @ (cwss @ XA2 @ XB2) @ (cwss @ XA2 @ XC)) @ (cwss @ XA2 @ (ccun @ XB2 @ XC))))))).
...
thf(cpwssun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwo @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ XA2)) @ (cwss @ (ccpw @ (ccun @ XA2 @ XB2)) @ (ccun @ (ccpw @ XA2) @ (ccpw @ XB2))))))).
