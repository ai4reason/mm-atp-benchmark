...
thf(apwfseq_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwn @ (cwbr @ (ccpw @ XA2) @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccmap))) @ ccdom))))).
...
thf(amap2xp_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ (cco @ XA2 @ cc2o @ ccmap) @ (ccxp @ XA2 @ XA2) @ ccen))))).
...
thf(cpwxpndom2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwn @ (cwbr @ (ccpw @ XA2) @ (cco @ XA2 @ (ccxp @ XA2 @ XA2) @ cccda) @ ccdom))))).
