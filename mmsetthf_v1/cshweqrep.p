...
thf(ccshweqrep_conj,conjecture,(! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ ccz)) @ (cwi @ (cwa @ (cwceq @ (cco @ XW @ XL @ cccsh) @ XW) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwral @ (^ [Xj:$i] : (cwceq @ (ccfv @ XI @ XW) @ (ccfv @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XL @ ccmul) @ ccaddc) @ (ccfv @ XW @ cchash) @ ccmo) @ XW))) @ (^ [Xj:$i] : ccn0))))))))).
