...
thf(aexpp1zd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ (cco @ (cco @ XA2 @ XN @ ccexp) @ XA2 @ ccmul)))))))))).
...
thf(aiseraltlem2_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((cwi @ Xph @ (cwbr @ XG @ ccc0 @ ccli)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmul)))) => (cwi @ (cw3a @ Xph @ (cwcel @ XN @ XZ) @ (cwcel @ XK @ ccn0)) @ (cwbr @ (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XK @ ccmul) @ ccaddc) @ (ccseq @ ccaddc @ XF @ XM)) @ ccmul) @ (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmul) @ ccle)))))))))))))))).
...
thf(aiseraltlem1_thm,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((cwi @ Xph @ (cwbr @ XG @ ccc0 @ ccli)) => (cwi @ (cwa @ Xph @ (cwcel @ XN @ XZ)) @ (cwbr @ ccc0 @ (ccfv @ XN @ XG) @ ccle))))))))))))).
...
thf(ciseraltlem3_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((cwi @ Xph @ (cwbr @ XG @ ccc0 @ ccli)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmul)))) => (cwi @ (cw3a @ Xph @ (cwcel @ XN @ XZ) @ (cwcel @ XK @ ccn0)) @ (cwa @ (cwbr @ (ccfv @ (cco @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XK @ ccmul) @ ccaddc) @ (ccseq @ ccaddc @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XG) @ ccle) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc2 @ XK @ ccmul) @ ccaddc) @ cc1 @ ccaddc) @ (ccseq @ ccaddc @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XG) @ ccle))))))))))))))))).
