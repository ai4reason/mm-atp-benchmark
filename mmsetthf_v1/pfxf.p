...
thf(cpfxf_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwf @ (cco @ ccc0 @ XL @ ccfzo) @ XV @ (cco @ XW @ XL @ ccpfx))))))).
