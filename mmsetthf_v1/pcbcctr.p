...
thf(cpcbcctr_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ (ccsu @ (cco @ cc1 @ (cco @ cc2 @ XN @ ccmul) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ (cco @ cc2 @ (ccfv @ (cco @ XN @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ ccmul) @ ccmin)))))))).
