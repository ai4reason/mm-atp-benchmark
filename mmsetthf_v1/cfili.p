...
thf(adf_cfil_ax,axiom,(cwceq @ cccfil @ (ccmpt @ (^ [Xd:$i] : (ccuni @ (ccrn @ ccxmt))) @ (^ [Xd:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccima @ (ccv @ Xd) @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccico))) @ (^ [Xy1:$i] : (ccv @ Xf1)))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xf1:$i] : (ccfv @ (ccdm @ (ccdm @ (ccv @ Xd))) @ ccfil))))))).
...
thf(ccfili_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XD @ cccfil)) @ (cwcel @ XR @ ccrp)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD) @ XR @ cclt)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XF))))))).
