...
thf(aistop2g_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ XA2) @ (cwb @ (cwcel @ XJ @ cctop) @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XJ) @ (cwcel @ (ccuni @ (ccv @ Xx3)) @ XJ)))) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cw3a @ (cwss @ (ccv @ Xx3) @ XJ) @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwcel @ (ccv @ Xx3) @ ccfn)) @ (cwcel @ (ccint @ (ccv @ Xx3)) @ XJ)))))))))).
thf(cfiinopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwi @ (cw3a @ (cwss @ XA2 @ XJ) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ (ccint @ XA2) @ XJ)))))).
