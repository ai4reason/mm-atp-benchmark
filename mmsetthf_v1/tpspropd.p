...
thf(ctpspropd_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ ccbs) @ (ccfv @ XL @ ccbs))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ cctopn) @ (ccfv @ XL @ cctopn))) => (cwi @ Xph @ (cwb @ (cwcel @ XK @ cctps) @ (cwcel @ XL @ cctps))))))))).
