...
thf(arlmvneg_thm,axiom,(! [XR:($i > $o)] : (cwceq @ (ccfv @ XR @ ccminusg) @ (ccfv @ (ccfv @ XR @ ccrglmod) @ ccminusg)))).
...
thf(clidlnegcl_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ XN @ (ccfv @ XR @ ccminusg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwcel @ XX @ XI)) @ (cwcel @ (ccfv @ XX @ XN) @ XI)))))))))).
