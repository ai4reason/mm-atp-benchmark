...
thf(abitsinv2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccin @ (ccpw @ ccn0) @ ccfn)) @ (cwceq @ (ccfv @ (ccsu @ XA2 @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ ccbits) @ XA2)))).
...
thf(cbitsf1ocnv_conj,conjecture,(cwa @ (cwf1o @ ccn0 @ (ccin @ (ccpw @ ccn0) @ ccfn) @ (ccres @ ccbits @ ccn0)) @ (cwceq @ (cccnv @ (ccres @ ccbits @ ccn0)) @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccn0) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp)))))))).
