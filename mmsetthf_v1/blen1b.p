...
thf(annlog2ge0lt1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwb @ (cwceq @ XN @ cc1) @ (cwa @ (cwbr @ ccc0 @ (cco @ cc2 @ XN @ cclogb) @ ccle) @ (cwbr @ (cco @ cc2 @ XN @ cclogb) @ cc1 @ cclt)))))).
...
thf(ablen1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccblen) @ cc1)).
thf(cblen1b_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwceq @ (ccfv @ XN @ ccblen) @ cc1) @ (cwo @ (cwceq @ XN @ ccc0) @ (cwceq @ XN @ cc1)))))).
