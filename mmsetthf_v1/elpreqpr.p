...
thf(aelpreqprlem_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XB2 @ (XV @ Xx3)) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (ccpr @ XB2 @ XC) @ (ccpr @ XB2 @ (ccv @ Xx3))))))))))).
...
thf(celpreqpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccpr @ XB2 @ XC)) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (ccpr @ XB2 @ XC) @ (ccpr @ XA2 @ (ccv @ Xx3)))))))))).
