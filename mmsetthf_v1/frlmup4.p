...
thf(afuncoeqres_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwfun @ XG) @ (cwceq @ (cccom @ XF @ XG) @ XH)) @ (cwceq @ (ccres @ XF @ (ccrn @ XG)) @ (cccom @ XH @ (cccnv @ XG)))))))).
...
thf(alspextmo_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XK @ (ccfv @ XS @ cclspn)) => (cwi @ (cwa @ (cwss @ XX @ XB2) @ (cwceq @ (ccfv @ XX @ XK) @ XB2)) @ (cwrmo @ (^ [Xg1:$i] : (cwceq @ (ccres @ (ccv @ Xg1) @ XX) @ XF)) @ (^ [Xg1:$i] : (cco @ XS @ XT @ cclmhm))))))))))))).
...
thf(cfrlmup4_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xm:$i] : (cwceq @ (XR @ Xm) @ (ccfv @ XT @ ccsca))) => ((! [Xm:$i] : (cwceq @ XF @ (cco @ (XR @ Xm) @ (XI @ Xm) @ ccfrlm))) => ((! [Xm:$i] : (cwceq @ XU @ (cco @ (XR @ Xm) @ (XI @ Xm) @ ccuvc))) => ((! [Xm:$i] : (cwceq @ (XC @ Xm) @ (ccfv @ XT @ ccbs))) => (! [Xm:$i] : (cwi @ (cw3a @ (cwcel @ XT @ cclmod) @ (cwcel @ (XI @ Xm) @ (XX @ Xm)) @ (cwf @ (XI @ Xm) @ (XC @ Xm) @ XA2)) @ (cwreu @ (^ [Xm:$i] : (cwceq @ (cccom @ (ccv @ Xm) @ XU) @ XA2)) @ (^ [Xm:$i] : (cco @ XF @ XT @ cclmhm)))))))))))))))))).
