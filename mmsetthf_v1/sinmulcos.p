...
thf(csinmulcos_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ cccos) @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ ccsin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccsin) @ ccaddc) @ cc2 @ ccdiv)))))).
