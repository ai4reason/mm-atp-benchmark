...
thf(aresvid2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (cco @ XW @ XA2 @ ccresv)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwss @ XB2 @ XA2) @ (cwcel @ XW @ XX) @ (cwcel @ XA2 @ XY)) @ (cwceq @ XR @ XW))))))))))))).
...
thf(aresvval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (cco @ XW @ XA2 @ ccresv)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwn @ (cwss @ XB2 @ XA2)) @ (cwcel @ XW @ XX) @ (cwcel @ XA2 @ XY)) @ (cwceq @ XR @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ XF @ XA2 @ ccress)) @ ccsts)))))))))))))).
...
thf(cresvsca_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XR @ (cco @ XW @ XA2 @ ccresv)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (cco @ XF @ XA2 @ ccress) @ (ccfv @ XR @ ccsca))))))))))))).
