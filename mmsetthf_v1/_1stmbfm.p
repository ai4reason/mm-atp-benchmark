...
thf(c_1stmbfm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => (cwi @ Xph @ (cwcel @ (ccres @ cc1st @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT))) @ (cco @ (cco @ XS @ XT @ ccsx) @ XS @ ccmbfm))))))))).
