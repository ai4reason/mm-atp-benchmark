...
thf(aclsidm_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwceq @ (ccfv @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XJ @ cccl)) @ (ccfv @ XS @ (ccfv @ XJ @ cccl))))))))).
...
thf(copnregcld_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwceq @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XJ @ cccl)) @ XA2) @ (cwrex @ (^ [Xo:$i] : (cwceq @ XA2 @ (ccfv @ (ccv @ Xo) @ (ccfv @ XJ @ cccl)))) @ (^ [Xo:$i] : XJ))))))))).
