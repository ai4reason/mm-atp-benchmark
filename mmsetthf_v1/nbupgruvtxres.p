...
thf(adif32_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccdif @ (ccdif @ XA2 @ XB2) @ XC) @ (ccdif @ (ccdif @ XA2 @ XC) @ XB2)))))).
