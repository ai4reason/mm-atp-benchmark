...
thf(acnvsn0_thm,axiom,(cwceq @ (cccnv @ (ccsn @ cc0)) @ cc0)).
thf(auni0_thm,axiom,(cwceq @ (ccuni @ cc0) @ cc0)).
thf(abrtpos0_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwbr @ cc0 @ XA2 @ (cctpos @ XF)) @ (cwbr @ cc0 @ XA2 @ XF))))))).
...
thf(abrtpos2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ (cctpos @ XF)) @ (cwa @ (cwcel @ XA2 @ (ccun @ (cccnv @ (ccdm @ XF)) @ (ccsn @ cc0))) @ (cwbr @ (ccuni @ (cccnv @ (ccsn @ XA2))) @ XB2 @ XF))))))))).
thf(abrin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwb @ (cwbr @ XA2 @ XB2 @ (ccin @ XR @ XS)) @ (cwa @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XA2 @ XB2 @ XS)))))))).
thf(ctpostpos_conj,conjecture,(! [XF:($i > $o)] : (cwceq @ (cctpos @ (cctpos @ XF)) @ (ccin @ XF @ (ccxp @ (ccun @ (ccxp @ ccvv @ ccvv) @ (ccsn @ cc0)) @ ccvv))))).
