...
thf(aswrds2m_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ cc2 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) @ (ccs2 @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ XW)))))))).
...
thf(aclwwlknonmpt2_thm,axiom,(! [XG:($i > $o)] : (cwceq @ (ccfv @ XG @ ccclwwlknon) @ (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ XG @ ccvtx))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn))))))))).
...
thf(as2elclwwlknon2_thm,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccfv @ XG @ ccclwwlknon)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ (ccpr @ XX @ XY) @ XE)) @ (cwcel @ (ccs2 @ XX @ XY) @ (cco @ XX @ cc2 @ XC))))))))))))).
thf(c_2clwwlk2clwwlklem_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ (ccfv @ cc3 @ ccuz)) @ (cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) @ (cwceq @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) @ (ccfv @ ccc0 @ XW))) @ (cwcel @ (cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) @ (cco @ XX @ cc2 @ (ccfv @ XG @ ccclwwlknon))))))))).
