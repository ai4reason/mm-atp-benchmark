...
thf(adf_epi_ax,axiom,(cwceq @ ccepi @ (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (cctpos @ (ccfv @ (ccfv @ (ccv @ Xc) @ ccoppc) @ ccmon)))))).
...
thf(coppcmon_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XM @ (ccfv @ XO @ ccmon)) => ((cwceq @ XE @ (ccfv @ XC @ ccepi)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ XM) @ (cco @ XY @ XX @ XE))))))))))))))).
