...
thf(atendoex_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xu:$i] : (cwceq @ (Xc_le @ Xu) @ (ccfv @ XK @ ccple))) => ((! [Xu:$i] : (cwceq @ (XH @ Xu) @ (ccfv @ XK @ cclh))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ cctendo))) => (! [Xu:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ (XH @ Xu))) @ (cwa @ (cwcel @ XF @ XT) @ (cwcel @ XN @ XT)) @ (cwbr @ (ccfv @ XN @ XR) @ (ccfv @ XF @ XR) @ (Xc_le @ Xu))) @ (cwrex @ (^ [Xu:$i] : (cwceq @ (ccfv @ XF @ (ccv @ Xu)) @ XN)) @ (^ [Xu:$i] : XE))))))))))))))))))).
