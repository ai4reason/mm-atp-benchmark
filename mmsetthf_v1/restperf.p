...
thf(aisperf_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccperf) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XX @ (ccfv @ XJ @ cclp)) @ XX))))))).
...
thf(crestperf_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XK @ (cco @ XJ @ XY @ ccrest)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XY @ XX)) @ (cwb @ (cwcel @ XK @ ccperf) @ (cwss @ XY @ (ccfv @ XY @ (ccfv @ XJ @ cclp)))))))))))).
