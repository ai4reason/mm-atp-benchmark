...
thf(aswrdccatfn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XN @ (cco @ ccc0 @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz)))) @ (cwfn @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ XM @ XN) @ ccsubstr) @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo))))))))).
...
thf(accatsymb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwcel @ XI @ ccz)) @ (cwceq @ (ccfv @ XI @ (cco @ XA2 @ XB2 @ ccconcat)) @ (ccif @ (cwbr @ XI @ (ccfv @ XA2 @ cchash) @ cclt) @ (ccfv @ XI @ XA2) @ (ccfv @ (cco @ XI @ (ccfv @ XA2 @ cchash) @ ccmin) @ XB2))))))))).
...
thf(afzmmmeqm_thm,axiom,(! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XM @ (cco @ XL @ XN @ ccfz)) @ (cwceq @ (cco @ (cco @ XN @ XL @ ccmin) @ (cco @ XM @ XL @ ccmin) @ ccmin) @ (cco @ XN @ XM @ ccmin))))))).
