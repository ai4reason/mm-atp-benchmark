...
thf(celxp6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ XB2 @ XC)) @ (cwa @ (cwceq @ XA2 @ (ccop @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd))) @ (cwa @ (cwcel @ (ccfv @ XA2 @ cc1st) @ XB2) @ (cwcel @ (ccfv @ XA2 @ cc2nd) @ XC)))))))).
