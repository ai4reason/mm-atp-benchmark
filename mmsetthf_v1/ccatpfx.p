...
thf(apfxfn_thm,axiom,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XV)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) @ (cwfn @ (cco @ XS @ XL @ ccpfx) @ (cco @ ccc0 @ XL @ ccfzo))))))).
...
thf(afzosubel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) @ (cwcel @ XD @ ccz)) @ (cwcel @ (cco @ XA2 @ XD @ ccmin) @ (cco @ (cco @ XB2 @ XD @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccfzo)))))))).
...
thf(cccatpfx_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XY @ (cco @ ccc0 @ XZ @ ccfz)) @ (cwcel @ XZ @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) @ (cwceq @ (cco @ (cco @ XS @ XY @ ccpfx) @ (cco @ XS @ (ccop @ XY @ XZ) @ ccsubstr) @ ccconcat) @ (cco @ XS @ XZ @ ccpfx)))))))).
