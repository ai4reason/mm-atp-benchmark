...
thf(adochfln0_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ XR @ (ccfv @ XU @ ccsca)) => ((cwceq @ XN @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_0 @ (ccfv @ XU @ cc0g)) => ((cwceq @ XF @ (ccfv @ XU @ cclfn)) => ((cwceq @ XL @ (ccfv @ XU @ cclk)) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XG @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ (ccdif @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ (ccsn @ Xc_0)))) => (cwi @ Xph @ (cwne @ (ccfv @ XX @ XG) @ XN))))))))))))))))))))))))))))).
...
thf(adrnginvrn0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0)) @ (cwne @ (ccfv @ XX @ XI) @ Xc_0))))))))))).
...
thf(alflmul_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XD @ ccbs)) => ((cwceq @ Xc_xp @ (ccfv @ XD @ ccmulr)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XG @ XF) @ (cwa @ (cwcel @ XR @ XK) @ (cwcel @ XX @ XV))) @ (cwceq @ (ccfv @ (cco @ XR @ XX @ Xc_x) @ XG) @ (cco @ XR @ (ccfv @ XX @ XG) @ Xc_xp)))))))))))))))))))).
thf(adrnginvrl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0)) @ (cwceq @ (cco @ (ccfv @ XX @ XI) @ XX @ Xc_x) @ Xc_1))))))))))))))).
thf(arspcev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ Xps) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(cdochkr1_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccfv @ (XK @ Xx3) @ cclh))) => ((! [Xx3:$i] : (cwceq @ Xc_pe @ (ccfv @ (XW @ Xx3) @ (ccfv @ (XK @ Xx3) @ ccoch)))) => ((! [Xx3:$i] : (cwceq @ XU @ (ccfv @ (XW @ Xx3) @ (ccfv @ (XK @ Xx3) @ ccdvh)))) => ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ XU @ ccbs))) => ((cwceq @ XR @ (ccfv @ XU @ ccsca)) => ((cwceq @ Xc_0 @ (ccfv @ XU @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccfv @ XU @ cclfn))) => ((cwceq @ XL @ (ccfv @ XU @ cclk)) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwa @ (cwcel @ (XK @ Xx3) @ cchlt) @ (cwcel @ (XW @ Xx3) @ (XH @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XG @ (XF @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwne @ (ccfv @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ Xc_pe) @ (XV @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XG) @ Xc_1)) @ (^ [Xx3:$i] : (ccdif @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ (ccsn @ Xc_0)))))))))))))))))))))))))))))))).
