...
thf(adf_trg_ax,axiom,(cwceq @ cctrg @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccfv @ (ccv @ Xr) @ ccmgp) @ cctmd)) @ (^ [Xr:$i] : (ccin @ cctgp @ ccrg))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cistrg_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => (cwb @ (cwcel @ XR @ cctrg) @ (cw3a @ (cwcel @ XR @ cctgp) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ cctmd))))))).
