...
thf(ahoiqssbl_thm,axiom,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ ccr @ XX @ ccmap))) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : (cwa @ (cwcel @ XY @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico)))) @ (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico))) @ (cco @ XY @ XE @ (ccfv @ (ccfv @ (ccfv @ XX @ ccrrx) @ ccds) @ ccbl))))) @ (^ [Xd:$i] : (cco @ ccq @ XX @ ccmap)))) @ (^ [Xc:$i] : (cco @ ccq @ XX @ ccmap)))))))))))).
thf(aad2antrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ (cwa @ Xph @ Xch) @ Xth) @ Xps))))))).
thf(asseldd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XC @ XA2)) => (cwi @ Xph @ (cwcel @ XC @ XB2))))))))).
thf(asyl2anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(arrxtoponfi_thm,axiom,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccfv @ XI @ ccrrx) @ cctopn)) => (cwi @ (cwcel @ XI @ ccfn) @ (cwcel @ XJ @ (ccfv @ (cco @ ccr @ XI @ ccmap) @ cctopon))))))).
...
thf(aopnvonmbllem1_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xh:$i] : (cwnf @ (^ [Xi:$i] : (Xph @ Xh @ Xi)))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ XX @ (XV @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwf @ XX @ ccq @ (XC @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwf @ XX @ ccq @ (XD @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)) @ ccico))) @ (XB2 @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwss @ (XB2 @ Xh @ Xi) @ (XG @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ (XY @ Xi) @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)) @ ccico))))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwceq @ (XK @ Xh @ Xi) @ (ccrab @ (^ [Xh:$i] : (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))) @ (XG @ Xi))) @ (^ [Xh:$i] : (cco @ (ccxp @ ccq @ ccq) @ XX @ ccmap)))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwceq @ (XH @ Xi) @ (ccmpt @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccop @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)))))))) => (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwrex @ (^ [Xh:$i] : (cwcel @ (XY @ Xi) @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))))) @ (^ [Xh:$i] : (XK @ Xh @ Xi)))))))))))))))))))))))))).
...
thf(ampct_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwbr @ XA2 @ ccom @ ccdom)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmap) @ ccom @ ccdom)))))))).
...
thf(ahoicoto2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XX @ (ccxp @ ccr @ ccr) @ (XI @ Xk)))) => ((! [Xk:$i] : (cwceq @ (XA2 @ Xk) @ (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (XI @ Xk)) @ cc1st))))) => ((! [Xk:$i] : (cwceq @ (XB2 @ Xk) @ (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (XI @ Xk)) @ cc2nd))))) => (cwi @ Xph @ (cwceq @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))))) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccico)))))))))))))).
...
thf(copnvonmbllem2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwceq @ XS @ (ccdm @ (ccfv @ XX @ ccvoln))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ (ccfv @ XX @ ccrrx) @ cctopn))) => ((cwceq @ XK @ (ccrab @ (^ [Xh:$i] : (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))) @ XG)) @ (^ [Xh:$i] : (cco @ (ccxp @ ccq @ ccq) @ XX @ ccmap)))) => (cwi @ Xph @ (cwcel @ XG @ XS)))))))))))).
