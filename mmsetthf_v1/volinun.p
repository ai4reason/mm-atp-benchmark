...
thf(adifin0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccdif @ (ccin @ XA2 @ XB2) @ XB2) @ cc0)))).
...
thf(cvolinun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ (ccdm @ ccvol))) @ (cwa @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccvol) @ ccr))) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccvol) @ (ccfv @ XB2 @ ccvol) @ ccaddc) @ (cco @ (ccfv @ (ccin @ XA2 @ XB2) @ ccvol) @ (ccfv @ (ccun @ XA2 @ XB2) @ ccvol) @ ccaddc)))))).
