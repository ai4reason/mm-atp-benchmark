...
thf(adf_z_ax,axiom,(cwceq @ ccz @ (ccrab @ (^ [Xn:$i] : (cw3o @ (cwceq @ (ccv @ Xn) @ ccc0) @ (cwcel @ (ccv @ Xn) @ ccn) @ (cwcel @ (ccneg @ (ccv @ Xn)) @ ccn))) @ (^ [Xn:$i] : ccr)))).
thf(celz_conj,conjecture,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccz) @ (cwa @ (cwcel @ XN @ ccr) @ (cw3o @ (cwceq @ XN @ ccc0) @ (cwcel @ XN @ ccn) @ (cwcel @ (ccneg @ XN) @ ccn)))))).
