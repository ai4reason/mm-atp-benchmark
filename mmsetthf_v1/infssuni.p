...
thf(cinfssuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwn @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ XB2 @ ccfn) @ (cwss @ XA2 @ (ccuni @ XB2))) @ (cwrex @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccin @ XA2 @ (ccv @ Xx3)) @ ccfn))) @ (^ [Xx3:$i] : XB2)))))).
