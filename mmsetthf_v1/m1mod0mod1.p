...
thf(amodsubmod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XM @ ccmo) @ XB2 @ ccmin) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XM @ ccmo))))))).
thf(a_0mod_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccrp) @ (cwceq @ (cco @ ccc0 @ XN @ ccmo) @ ccc0)))).
thf(cm1mod0mod1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccr) @ (cwbr @ cc1 @ XN @ cclt)) @ (cwb @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmo) @ ccc0) @ (cwceq @ (cco @ XA2 @ XN @ ccmo) @ cc1)))))).
