...
thf(amapdm0_thm,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwceq @ (cco @ XB2 @ cc0 @ ccmap) @ (ccsn @ cc0)))))).
...
thf(covnlecvr2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XC @ Xx3 @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XD @ Xx3 @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xx3 @ Xj @ Xk @ Xa @ Xb) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xj))) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xj))) @ ccico)))))))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XA2 @ Xx3 @ Xj @ Xk @ Xa @ Xb) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xj)) @ (ccfv @ XX @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb))))) @ ccsumge0) @ ccle))))))))))))))))))).
