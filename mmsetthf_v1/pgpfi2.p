...
thf(cpgpfi2_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn)) @ (cwb @ (cwbr @ XP @ XG @ ccpgp) @ (cwa @ (cwcel @ XP @ ccprime) @ (cwceq @ (ccfv @ XX @ cchash) @ (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp)))))))))).
