...
thf(agsumconstf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XX @ Xk))) => ((! [Xk:$i] : (cwceq @ (XB2 @ Xk) @ (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (cwceq @ (Xc_x @ Xk) @ (ccfv @ (XG @ Xk) @ ccmg))) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ (XG @ Xk) @ ccmnd) @ (cwcel @ XA2 @ ccfn) @ (cwcel @ (XX @ Xk) @ (XB2 @ Xk))) @ (cwceq @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ (cco @ (ccfv @ XA2 @ cchash) @ (XX @ Xk) @ (Xc_x @ Xk)))))))))))))).
...
thf(axrge0mulgnn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwceq @ (cco @ XA2 @ XB2 @ (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ ccmg)) @ (cco @ XA2 @ XB2 @ ccxmu)))))).
...
thf(axlemul1a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwa @ (cwcel @ XC @ ccxr) @ (cwbr @ ccc0 @ XC @ ccle))) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwbr @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccle)))))).
...
thf(anfielex_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccfn)) @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)))))).
...
thf(aelxrge02_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cw3o @ (cwceq @ XA2 @ ccc0) @ (cwcel @ XA2 @ ccrp) @ (cwceq @ XA2 @ ccpnf))))).
...
thf(cesumcst_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xk) @ XV) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwceq @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (cco @ (ccfv @ (XA2 @ Xk) @ cchash) @ (XB2 @ Xk) @ ccxmu)))))))))).
