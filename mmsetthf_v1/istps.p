...
thf(adf_topsp_ax,axiom,(cwceq @ cctps @ (ccab @ (^ [Xf1:$i] : (cwcel @ (ccfv @ (ccv @ Xf1) @ cctopn) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ ccbs) @ cctopon)))))).
...
thf(cistps_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XK @ cctopn)) => (cwb @ (cwcel @ XK @ cctps) @ (cwcel @ XJ @ (ccfv @ XA2 @ cctopon))))))))).
