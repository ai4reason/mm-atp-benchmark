...
thf(adf_cmgm2_ax,axiom,(cwceq @ cccmgm2 @ (ccrab @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ ccplusg) @ (ccfv @ (ccv @ Xm) @ ccbs) @ cccomlaw)) @ (^ [Xm:$i] : ccmgm2)))).
thf(ciscmgmALT_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_op @ (ccfv @ XM @ ccplusg)) => (cwb @ (cwcel @ XM @ cccmgm2) @ (cwa @ (cwcel @ XM @ ccmgm2) @ (cwbr @ Xc_op @ XB2 @ cccomlaw))))))))).
