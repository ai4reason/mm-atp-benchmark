...
thf(cflimval_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XF @ (ccuni @ (ccrn @ ccfil)))) @ (cwceq @ (cco @ XJ @ XF @ ccflim) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XF) @ (cwss @ XF @ (ccpw @ XX)))) @ (^ [Xx3:$i] : XX))))))))).
