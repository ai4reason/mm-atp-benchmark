...
thf(adf_flf_ax,axiom,(cwceq @ ccflf @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : cctop)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccuni @ (ccrn @ ccfil)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt @ (^ [Xf1:$i] : (cco @ (ccuni @ (ccv @ Xx3)) @ (ccuni @ (ccv @ Xy1)) @ ccmap)) @ (^ [Xf1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (cco @ (ccuni @ (ccv @ Xx3)) @ (ccv @ Xf1) @ ccfm)) @ ccflim)))))))).
...
thf(cflffval_conj,conjecture,(! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil))) @ (cwceq @ (cco @ XJ @ XL @ ccflf) @ (ccmpt @ (^ [Xf1:$i] : (cco @ XX @ XY @ ccmap)) @ (^ [Xf1:$i] : (cco @ XJ @ (ccfv @ XL @ (cco @ XX @ (ccv @ Xf1) @ ccfm)) @ ccflim)))))))))).
