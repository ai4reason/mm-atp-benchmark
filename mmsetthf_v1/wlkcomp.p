...
thf(cwlkcomp_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XV @ Xk) @ (ccfv @ XG @ ccvtx))) => ((! [Xk:$i] : (cwceq @ (XI @ Xk) @ (ccfv @ XG @ cciedg))) => ((! [Xk:$i] : (cwceq @ XF @ (ccfv @ (XW @ Xk) @ cc1st))) => ((! [Xk:$i] : (cwceq @ XP @ (ccfv @ (XW @ Xk) @ cc2nd))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XG @ (XU @ Xk)) @ (cwcel @ (XW @ Xk) @ (ccxp @ (XS @ Xk) @ (XT @ Xk)))) @ (cwb @ (cwcel @ (XW @ Xk) @ (ccfv @ XG @ ccwlks)) @ (cw3a @ (cwcel @ XF @ (ccword @ (ccdm @ (XI @ Xk)))) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ (XV @ Xk) @ XP) @ (cwral @ (^ [Xk:$i] : (cwif @ (cwceq @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (XI @ Xk)) @ (ccsn @ (ccfv @ (ccv @ Xk) @ XP))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (XI @ Xk))))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))))))))))))))).
