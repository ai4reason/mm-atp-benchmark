...
thf(ampnanrd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ (cwn @ (cwa @ Xps @ Xch))) => (cwi @ Xph @ (cwn @ Xch)))))))).
...
thf(consucuni3_conj,conjecture,(! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccon0) @ (cwne @ XB2 @ cc0) @ (cwn @ (cwlim @ XB2))) @ (cwceq @ XB2 @ (ccsuc @ (ccuni @ XB2)))))).
