...
thf(atposmpt2_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (cctpos @ (XF @ Xx3 @ Xy1)) @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (^ [Xx3:$i] : (XC @ Xx3 @ Xy1))))))))))))).
...
thf(cmattpos1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ Xc_1 @ (ccfv @ XA2 @ ccur)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwceq @ (cctpos @ Xc_1) @ Xc_1))))))))).
