...
thf(cvonn0ioo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwne @ XX @ cc0)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XA2)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XB2)) => ((! [Xk:$i] : (cwceq @ (XI @ Xk) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccioo))))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XI @ Xk) @ (ccfv @ XX @ ccvoln)) @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccico) @ ccvol))))))))))))))))).
