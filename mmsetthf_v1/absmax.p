...
thf(cabsmax_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XB2 @ XA2) @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ ccaddc) @ cc2 @ ccdiv)))))).
