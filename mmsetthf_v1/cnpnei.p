...
thf(ccnpnei_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop) @ (cwf @ XX @ XY @ XF)) @ (cwcel @ XA2 @ XX)) @ (cwb @ (cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xy1)) @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)))) @ (^ [Xy1:$i] : (ccfv @ (ccsn @ (ccfv @ XA2 @ XF)) @ (ccfv @ XK @ ccnei))))))))))))))).
