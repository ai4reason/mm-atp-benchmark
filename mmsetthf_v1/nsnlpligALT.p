...
thf(apm2_61danel_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ (cwa @ Xph @ (cwcel @ XA2 @ XB2)) @ Xps) => ((cwi @ (cwa @ Xph @ (cwnel @ XA2 @ XB2)) @ Xps) => (cwi @ Xph @ Xps)))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(cwreu_tp,type,(cwreu : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(al2p_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XP @ (ccuni @ XG)) => (cwi @ (cwa @ (cwcel @ XG @ ccplig) @ (cwcel @ XL @ XG)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cw3a @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwcel @ (ccv @ Xa) @ XL) @ (cwcel @ (ccv @ Xb) @ XL))) @ (^ [Xb:$i] : XP))) @ (^ [Xa:$i] : XP)))))))).
...
thf(cnsnlpligALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccplig) @ (cwnel @ (ccsn @ XA2) @ XG))))).
