...
thf(afnejoin1_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XX @ (XV @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS)) @ (cwcel @ XA2 @ XS)) @ (cwbr @ XA2 @ (ccif @ (cwceq @ XS @ cc0) @ (ccsn @ XX) @ (ccuni @ XS)) @ ccfne)))))))).
...
thf(afnetg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwss @ XA2 @ (ccfv @ XB2 @ cctg)))))).
...
thf(cfnejoin2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS))) @ (cwb @ (cwbr @ (ccif @ (cwceq @ XS @ cc0) @ (ccsn @ XX) @ (ccuni @ XS)) @ (XT @ Xy1) @ ccfne) @ (cwa @ (cwceq @ XX @ (ccuni @ (XT @ Xy1))) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XT @ Xy1) @ ccfne)) @ (^ [Xx3:$i] : XS))))))))))).
