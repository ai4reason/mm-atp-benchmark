...
thf(adom3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2)) @ (cwb @ (cwceq @ (XC @ Xx3) @ (XD @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))))) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwbr @ XA2 @ XB2 @ ccdom))))))))))).
...
thf(climenpsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwlim @ XA2) => (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ XA2 @ (ccdif @ XA2 @ (ccsn @ cc0)) @ ccen)))))).
