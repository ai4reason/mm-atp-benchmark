...
thf(anrmsep2_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccnrm) @ (cw3a @ (cwcel @ XC @ (ccfv @ XJ @ cccld)) @ (cwcel @ XD @ (ccfv @ XJ @ cccld)) @ (cwceq @ (ccin @ XC @ XD) @ cc0))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwss @ XC @ (ccv @ Xx3)) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XD) @ cc0))) @ (^ [Xx3:$i] : XJ))))))).
...
thf(cisnrm2_conj,conjecture,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccnrm) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xd:$i] : (cwi @ (cwceq @ (ccin @ (ccv @ Xc) @ (ccv @ Xd)) @ cc0) @ (cwrex @ (^ [Xo:$i] : (cwa @ (cwss @ (ccv @ Xc) @ (ccv @ Xo)) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xo) @ (ccfv @ XJ @ cccl)) @ (ccv @ Xd)) @ cc0))) @ (^ [Xo:$i] : XJ)))) @ (^ [Xd:$i] : (ccfv @ XJ @ cccld)))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld))))))).
