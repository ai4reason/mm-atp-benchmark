...
thf(adf_voln_ax,axiom,(cwceq @ ccvoln @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccres @ (ccfv @ (ccv @ Xx3) @ ccovoln) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccovoln) @ cccaragen)))))).
...
thf(cvonval_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ ccvoln) @ (ccres @ (ccfv @ XX @ ccovoln) @ (ccfv @ (ccfv @ XX @ ccovoln) @ cccaragen)))))))).
