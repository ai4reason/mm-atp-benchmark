...
thf(agcdnncl_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwcel @ (cco @ XM @ XN @ ccgcd) @ ccn))))).
...
thf(agcddiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn)) @ (cwa @ (cwbr @ XC @ XA2 @ ccdvds) @ (cwbr @ XC @ XB2 @ ccdvds))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccdiv) @ (cco @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccgcd))))))).
...
thf(cdivgcdodd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwo @ (cwn @ (cwbr @ cc2 @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds)) @ (cwn @ (cwbr @ cc2 @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds))))))).
