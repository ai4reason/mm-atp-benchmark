...
thf(aistermoi_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XO:($i > $o)] : ((! [Xh:$i] : (cwceq @ (XB2 @ Xh) @ (ccfv @ XC @ ccbs))) => ((! [Xh:$i] : (! [Xb:$i] : (cwceq @ (XH @ Xh @ Xb) @ (ccfv @ XC @ cchom)))) => ((! [Xh:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xh @ Xb) @ (cwcel @ XC @ cccat)))) => (! [Xh:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xh @ Xb) @ (cwcel @ XO @ (ccfv @ XC @ cctermo))) @ (cwa @ (cwcel @ XO @ (XB2 @ Xh)) @ (cwral @ (^ [Xb:$i] : (cweu @ (^ [Xh:$i] : (cwcel @ (ccv @ Xh) @ (cco @ (ccv @ Xb) @ XO @ (XH @ Xh @ Xb)))))) @ (^ [Xb:$i] : (XB2 @ Xh)))))))))))))))).
...
thf(aisohom_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ XI @ (ccfv @ XC @ cciso)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwss @ (cco @ XX @ XY @ XI) @ (cco @ XX @ XY @ XH))))))))))))))))).
...
thf(a_2termoinv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ cctermo))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XC @ cctermo))) => (cwi @ (cw3a @ Xph @ (cwcel @ XG @ (cco @ XB2 @ XA2 @ (ccfv @ XC @ cchom))) @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cchom)))) @ (cwbr @ XF @ XG @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ ccinv)))))))))))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwreu_tp,type,(cwreu : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwtru_tp,type,(cwtru : $o)).
thf(aeuelss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ XB2) @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))) @ (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XB2)))) @ (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))))))).
thf(ctermoeu1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ cctermo))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XC @ cctermo))) => (cwi @ Xph @ (cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cciso)))))))))))))).
