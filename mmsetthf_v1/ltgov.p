...
thf(cltgov_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ Xc_le @ (ccfv @ XG @ ccleg)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwceq @ XE @ (ccima @ Xc_mi @ (ccxp @ XP @ XP))) => ((cwi @ Xph @ (cwfun @ Xc_mi)) => ((cwceq @ Xc_lt @ (ccdif @ (ccres @ Xc_le @ XE) @ ccid)) => ((cwi @ Xph @ (cwss @ (ccxp @ XP @ XP) @ (ccdm @ Xc_mi))) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ Xc_mi) @ (cco @ XC @ XD @ Xc_mi) @ Xc_lt) @ (cwa @ (cwbr @ (cco @ XA2 @ XB2 @ Xc_mi) @ (cco @ XC @ XD @ Xc_mi) @ Xc_le) @ (cwne @ (cco @ XA2 @ XB2 @ Xc_mi) @ (cco @ XC @ XD @ Xc_mi))))))))))))))))))))))))))))).
