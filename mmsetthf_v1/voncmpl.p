...
thf(acaragencmpl_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwi @ Xph @ (cwss @ XE @ XX)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XE @ XO) @ ccc0)) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => (cwi @ Xph @ (cwcel @ XE @ XS))))))))))))).
...
thf(cvoncmpl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwceq @ XS @ (ccdm @ (ccfv @ XX @ ccvoln))) => ((cwi @ Xph @ (cwcel @ XE @ (ccdm @ (ccfv @ XX @ ccvoln)))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XE @ (ccfv @ XX @ ccvoln)) @ ccc0)) => ((cwi @ Xph @ (cwss @ XF @ XE)) => (cwi @ Xph @ (cwcel @ XF @ XS))))))))))))).
