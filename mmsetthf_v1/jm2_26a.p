...
thf(aacongneg2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwo @ (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ (ccneg @ XC)) @ ccmin) @ ccdvds))) @ (cwo @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds))))))).
thf(cjm2_26a_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz))) @ (cwi @ (cwo @ (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ XM @ ccmin) @ ccdvds) @ (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ (ccneg @ XM) @ ccmin) @ ccdvds)) @ (cwo @ (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (cco @ XA2 @ XM @ ccrmy) @ ccmin) @ ccdvds) @ (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (ccneg @ (cco @ XA2 @ XM @ ccrmy)) @ ccmin) @ ccdvds))))))))).
