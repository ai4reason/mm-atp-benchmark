...
thf(assimaexg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XC @ Xx3)) @ (cwfun @ XF) @ (cwss @ XB2 @ (ccima @ XF @ XA2))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwceq @ XB2 @ (ccima @ XF @ (ccv @ Xx3))))))))))))).
...
thf(ctgrest_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XA2 @ XW)) @ (cwceq @ (ccfv @ (cco @ XB2 @ XA2 @ ccrest) @ cctg) @ (cco @ (ccfv @ XB2 @ cctg) @ XA2 @ ccrest)))))))).
