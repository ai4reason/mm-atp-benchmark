...
thf(cchpval2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccchp) @ (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ cclog) @ (ccfv @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ (ccv @ Xp) @ cclog) @ ccdiv) @ ccfl) @ ccmul))))))).
