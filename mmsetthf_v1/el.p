...
thf(azfpow_thm,axiom,(! [Xz:$i] : (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))).
...
thf(cel_conj,conjecture,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))))).
