...
thf(comeunle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwi @ Xph @ (cwss @ XA2 @ XX)) => ((cwi @ Xph @ (cwss @ XB2 @ XX)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ XO) @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccxad) @ ccle)))))))))))).
