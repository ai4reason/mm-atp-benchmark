...
thf(cclimlimsup_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XF)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ (ccdm @ ccli)) @ (cwbr @ XF @ (ccfv @ XF @ cclsp) @ ccli))))))))))).
