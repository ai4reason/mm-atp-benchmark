...
thf(acliminf_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ XZ @ ccr @ XF))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xk) @ XF) @ ccle)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ XF) @ ccle)) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XF @ (ccinf @ (ccrn @ XF) @ ccr @ cclt) @ ccli))))))))))))).
...
thf(aeluzd_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwbr @ XM @ XN @ ccle)) => (cwi @ Xph @ (cwcel @ XN @ XZ))))))))))).
...
thf(alimsupvaluz2_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XZ @ ccr @ XF))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccfv @ XF @ cclsp) @ ccr))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ XF @ cclsp) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccsup @ (ccrn @ (ccres @ XF @ (ccfv @ (ccv @ Xk) @ ccuz))) @ ccxr @ cclt)))) @ ccr @ cclt))))))))))))).
thf(csupcnvlimsup_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XZ @ ccr @ XF))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccfv @ XF @ cclsp) @ ccr))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccsup @ (ccrn @ (ccres @ XF @ (ccfv @ (ccv @ Xk) @ ccuz))) @ ccxr @ cclt))) @ (ccfv @ XF @ cclsp) @ ccli)))))))))))).
