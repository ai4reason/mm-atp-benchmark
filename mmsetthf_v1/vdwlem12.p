...
thf(avdwap1_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XD @ ccn)) @ (cwceq @ (cco @ XA2 @ XD @ (ccfv @ cc1 @ ccvdwa)) @ (ccsn @ XA2)))))).
...
thf(cvdwlem12_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccfn)) => ((cwi @ Xph @ (cwf @ (cco @ cc1 @ (cco @ (ccfv @ XR @ cchash) @ cc1 @ ccaddc) @ ccfz) @ XR @ XF)) => ((cwi @ Xph @ (cwn @ (cwbr @ cc2 @ XF @ ccvdwm))) => (cwn @ Xph)))))))).
