...
thf(a_3anidm13_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xph) @ Xch) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
...
thf(clsmss2_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg)) @ (cwss @ XU @ XT)) @ (cwceq @ (cco @ XT @ XU @ Xc_po) @ XT)))))))).
