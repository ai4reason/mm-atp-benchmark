...
thf(adfco2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cccom @ XA2 @ XB2) @ (cciun @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccxp @ (ccima @ (cccnv @ XB2) @ (ccsn @ (ccv @ Xx3))) @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3)))))))))).
...
thf(cdfco2a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ (ccin @ (ccdm @ XA2) @ (ccrn @ XB2)) @ XC) @ (cwceq @ (cccom @ XA2 @ XB2) @ (cciun @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccxp @ (ccima @ (cccnv @ XB2) @ (ccsn @ (ccv @ Xx3))) @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3)))))))))))).
