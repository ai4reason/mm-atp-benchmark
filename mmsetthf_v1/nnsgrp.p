...
thf(annsgrpmgm_thm,axiom,(! [XM:($i > $o)] : ((cwceq @ XM @ (cco @ cccnfld @ ccn @ ccress)) => (cwcel @ XM @ ccmgm)))).
...
thf(cnnsgrp_conj,conjecture,(! [XM:($i > $o)] : ((cwceq @ XM @ (cco @ cccnfld @ ccn @ ccress)) => (cwcel @ XM @ ccsgrp)))).
