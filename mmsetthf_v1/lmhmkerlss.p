...
thf(clmhmkerlss_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XK @ (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((cwceq @ Xc_0 @ (ccfv @ XT @ cc0g)) => ((cwceq @ XU @ (ccfv @ XS @ cclss)) => (cwi @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XK @ XU)))))))))))).
