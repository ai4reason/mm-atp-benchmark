...
thf(auzublem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xx3 @ Xj)))) => ((cwnfc @ (^ [Xj:$i] : (XX @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xx3 @ Xj) @ (cwcel @ (XM @ Xx3) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XZ @ Xj) @ (ccfv @ (XM @ Xx3) @ ccuz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xx3 @ Xj) @ (cwcel @ (XY @ Xx3 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XW @ Xx3 @ Xj) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xj:$i] : (cco @ (XM @ Xx3) @ (XK @ Xx3) @ ccfz)) @ (^ [Xj:$i] : (XB2 @ Xj)))) @ ccr @ cclt)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XX @ Xj) @ (ccif @ (cwbr @ (XW @ Xx3 @ Xj) @ (XY @ Xx3 @ Xj) @ ccle) @ (XY @ Xx3 @ Xj) @ (XW @ Xx3 @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xx3 @ Xj) @ (cwcel @ (XK @ Xx3) @ (XZ @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xj) @ (cwcel @ (ccv @ Xj) @ (XZ @ Xj))) @ (cwcel @ (XB2 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xx3 @ Xj) @ (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (XY @ Xx3 @ Xj) @ ccle)) @ (^ [Xj:$i] : (ccfv @ (XK @ Xx3) @ ccuz)))))) => (! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xx3 @ Xj) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (XZ @ Xj)))) @ (^ [Xx3:$i] : ccr)))))))))))))))))))))))).
...
thf(cuzub_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xx3 @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwcel @ (XM @ Xx3 @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xj @ Xk) @ (cwcel @ (ccv @ Xj) @ XZ)) @ (cwcel @ (XB2 @ Xj) @ ccr))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))))))).
