...
thf(agasubg_thm,axiom,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => (cwi @ (cwa @ (cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) @ (cwcel @ XS @ (ccfv @ XG @ ccsubg))) @ (cwcel @ (ccres @ Xc_po @ (ccxp @ XS @ XY)) @ (cco @ XH @ XY @ ccga)))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(csylow3lem5_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XG @ ccgrp)) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ XP @ XG @ ccslw))) => ((cwceq @ Xc_po @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XK)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ XP @ XG @ ccslw))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl) @ (ccv @ Xx3) @ Xc_mi)))))))) => (cwi @ Xph @ (cwcel @ Xc_po @ (cco @ (cco @ XG @ XK @ ccress) @ (cco @ XP @ XG @ ccslw) @ ccga)))))))))))))))))))).
