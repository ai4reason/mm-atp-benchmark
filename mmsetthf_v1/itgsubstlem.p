...
thf(citgsubstlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XY @ ccr)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ ccle)) => ((cwi @ Xph @ (cwcel @ XZ @ ccxr)) => ((cwi @ Xph @ (cwcel @ XW @ ccxr)) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ XY @ ccicc)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ (cco @ XX @ XY @ ccicc) @ (cco @ XZ @ XW @ ccioo) @ cccncf))) => ((! [Xu:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ XY @ ccioo)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xu))) @ (ccin @ (cco @ (cco @ XX @ XY @ ccioo) @ ccc @ cccncf) @ ccibl)))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xu:$i] : (cco @ XZ @ XW @ ccioo)) @ (^ [Xu:$i] : (XC @ Xu))) @ (cco @ (cco @ XZ @ XW @ ccioo) @ ccc @ cccncf))) => ((! [Xu:$i] : (cwi @ Xph @ (cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ XY @ ccicc)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ XY @ ccioo)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xu)))))) => ((! [Xx3:$i] : (! [Xu:$i] : (cwi @ (cwceq @ (ccv @ Xu) @ (XA2 @ Xx3)) @ (cwceq @ (XC @ Xu) @ (XE @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XX) @ (cwceq @ (XA2 @ Xx3) @ XK))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XY) @ (cwceq @ (XA2 @ Xx3) @ XL))) => ((cwi @ Xph @ (cwcel @ XM @ (cco @ XZ @ XW @ ccioo))) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ XZ @ XW @ ccioo))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XX @ XY @ ccicc))) @ (cwcel @ (XA2 @ Xx3) @ (cco @ XM @ XN @ ccioo)))) => (! [Xu:$i] : (cwi @ Xph @ (cwceq @ (ccdit @ (^ [Xu:$i] : XK) @ (^ [Xu:$i] : XL) @ (^ [Xu:$i] : (XC @ Xu))) @ (ccdit @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (cco @ (XE @ Xx3) @ (XB2 @ Xx3 @ Xu) @ ccmul))))))))))))))))))))))))))))))))))).
