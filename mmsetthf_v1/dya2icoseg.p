...
thf(adya2ub_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccrp) @ (cwbr @ (cco @ cc1 @ (cco @ cc2 @ (ccfv @ (cco @ cc1 @ (cco @ cc2 @ XR @ cclogb) @ ccmin) @ ccfl) @ ccexp) @ ccdiv) @ XR @ cclt)))).
...
thf(cdya2icoseg_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XJ @ Xx3 @ Xn @ Xb) @ (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xn:$i] : (cwceq @ (XI @ Xn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico)))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XN @ Xn) @ (ccfv @ (cco @ cc1 @ (cco @ cc2 @ (XD @ Xx3 @ Xn) @ cclogb) @ ccmin) @ ccfl)))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ (XX @ Xn) @ ccr) @ (cwcel @ (XD @ Xx3 @ Xn) @ ccrp)) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwcel @ (XX @ Xn) @ (ccv @ Xb)) @ (cwss @ (ccv @ Xb) @ (cco @ (cco @ (XX @ Xn) @ (XD @ Xx3 @ Xn) @ ccmin) @ (cco @ (XX @ Xn) @ (XD @ Xx3 @ Xn) @ ccaddc) @ ccioo)))) @ (^ [Xb:$i] : (ccrn @ (XI @ Xn)))))))))))))))).
