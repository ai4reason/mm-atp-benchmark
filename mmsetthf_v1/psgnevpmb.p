...
thf(adf_evpm_ax,axiom,(cwceq @ ccevpm @ (ccmpt @ (^ [Xd:$i] : ccvv) @ (^ [Xd:$i] : (ccima @ (cccnv @ (ccfv @ (ccv @ Xd) @ ccpsgn)) @ (ccsn @ cc1)))))).
...
thf(cpsgnevpmb_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwcel @ XD @ ccfn) @ (cwb @ (cwcel @ XF @ (ccfv @ XD @ ccevpm)) @ (cwa @ (cwcel @ XF @ XP) @ (cwceq @ (ccfv @ XF @ XN) @ cc1))))))))))))).
