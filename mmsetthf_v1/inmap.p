...
thf(cinmap_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XC @ XZ)) => (cwi @ Xph @ (cwceq @ (ccin @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap)) @ (cco @ (ccin @ XA2 @ XB2) @ XC @ ccmap)))))))))))))).
