...
thf(cfislw_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XP @ ccprime)) @ (cwb @ (cwcel @ XH @ (cco @ XP @ XG @ ccslw)) @ (cwa @ (cwcel @ XH @ (ccfv @ XG @ ccsubg)) @ (cwceq @ (ccfv @ XH @ cchash) @ (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp))))))))))).
