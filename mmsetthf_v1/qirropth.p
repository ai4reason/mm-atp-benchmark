...
thf(cqirropth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdif @ ccc @ ccq)) @ (cwa @ (cwcel @ XB2 @ ccq) @ (cwcel @ XC @ ccq)) @ (cwa @ (cwcel @ XD @ ccq) @ (cwcel @ XE @ ccq))) @ (cwb @ (cwceq @ (cco @ XB2 @ (cco @ XA2 @ XC @ ccmul) @ ccaddc) @ (cco @ XD @ (cco @ XA2 @ XE @ ccmul) @ ccaddc)) @ (cwa @ (cwceq @ XB2 @ XD) @ (cwceq @ XC @ XE)))))))))).
