...
thf(adf_mvrs_ax,axiom,(cwceq @ ccmvrs @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccmpt @ (^ [Xe:$i] : (ccfv @ (ccv @ Xt) @ ccmex)) @ (^ [Xe:$i] : (ccin @ (ccrn @ (ccfv @ (ccv @ Xe) @ cc2nd)) @ (ccfv @ (ccv @ Xt) @ ccmvar)))))))).
...
thf(cmvrsval_conj,conjecture,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XW @ (ccfv @ XT @ ccmvrs)) => (cwi @ (cwcel @ XX @ XE) @ (cwceq @ (ccfv @ XX @ XW) @ (ccin @ (ccrn @ (ccfv @ XX @ cc2nd)) @ XV)))))))))))).
