...
thf(cvtoclr_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR))))) => (! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwbr @ (XA2 @ Xz) @ (XB2 @ Xx3 @ Xz) @ XR) @ (cwbr @ (XB2 @ Xx3 @ Xz) @ XC @ XR)) @ (cwbr @ (XA2 @ Xz) @ XC @ XR))))))))))).
