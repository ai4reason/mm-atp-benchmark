...
thf(amertens_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xj) @ (XF @ Xk)) @ (XA2 @ Xj))))) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xj) @ XK) @ (ccfv @ (XA2 @ Xj) @ ccabs)))) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ ccn0)) @ (cwcel @ (XA2 @ Xj) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XG) @ (XB2 @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XH @ Xj)) @ (ccsu @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (^ [Xj:$i] : (cco @ (XA2 @ Xj) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ ccmin) @ XG) @ ccmul))))))) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XK @ ccc0) @ (ccdm @ ccli))) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XG @ ccc0) @ (ccdm @ ccli))) => (! [Xj:$i] : (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ (XH @ Xj) @ ccc0) @ (cco @ (ccsu @ ccn0 @ (^ [Xj:$i] : (XA2 @ Xj))) @ (ccsu @ ccn0 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccmul) @ ccli))))))))))))))))))).
