...
thf(aimadmres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccima @ XA2 @ (ccdm @ (ccres @ XA2 @ XB2))) @ (ccima @ XA2 @ XB2))))).
...
thf(aordunpr_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwcel @ (ccun @ XB2 @ XC) @ (ccpr @ XB2 @ XC)))))).
...
thf(afnse_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xw)) @ (cwcel @ (ccv @ Xy1) @ (XA2 @ Xw))) @ (cwo @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XR) @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XS @ Xw)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwf @ (XA2 @ Xw) @ (XB2 @ Xx3 @ Xy1) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwse @ (XB2 @ Xx3 @ Xy1) @ XR)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xw)) @ ccvv))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwse @ (XA2 @ Xw) @ (XT @ Xx3 @ Xy1)))))))))))))))))).
...
thf(cr0weon_conj,conjecture,(! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XL @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) @ (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) @ (cwo @ (cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XR @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xz) @ (ccxp @ ccon0 @ ccon0)) @ (cwcel @ (ccv @ Xw) @ (ccxp @ ccon0 @ ccon0))) @ (cwo @ (cwcel @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) @ (cwa @ (cwceq @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XL @ Xx3 @ Xy1))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwa @ (cwwe @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwse @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
