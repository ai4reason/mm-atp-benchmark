...
thf(adiveq1bd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1))))))))).
...
thf(aefeq1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cce) @ cc1) @ (cwcel @ (cco @ XA2 @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccdiv) @ ccz))))).
thf(ann0abscl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwcel @ (ccfv @ XA2 @ ccabs) @ ccn0)))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(ann0lt10b_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwbr @ XN @ cc1 @ cclt) @ (cwceq @ XN @ ccc0))))).
...
thf(aefif1olem3_thm,axiom,(! [Xph:$o] : (! [Xx3:$i] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XF @ Xw) @ (ccmpt @ (^ [Xw:$i] : XD) @ (^ [Xw:$i] : (ccfv @ (cco @ cci @ (ccv @ Xw) @ ccmul) @ cce))))) => ((cwceq @ XC @ (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XC)) @ (cwcel @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccim) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc))))))))))).
...
thf(acosq14ge0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ cccos) @ ccle)))).
thf(asqrtrege0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ ccsqrt) @ ccre) @ ccle)))))).
