...
thf(cbposlem2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwbr @ cc2 @ XP @ cclt)) => ((cwi @ Xph @ (cwbr @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ XP @ cclt)) => ((cwi @ Xph @ (cwbr @ XP @ XN @ ccle)) => (cwi @ Xph @ (cwceq @ (cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccc0))))))))))).
