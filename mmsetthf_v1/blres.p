...
thf(cblres_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccres @ XD @ (ccxp @ XY @ XY))) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ (ccin @ XX @ XY)) @ (cwcel @ XR @ ccxr)) @ (cwceq @ (cco @ XP @ XR @ (ccfv @ XC @ ccbl)) @ (ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ XY))))))))))).
