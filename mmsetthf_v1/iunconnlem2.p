...
thf(aiunconnlem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwss @ (XB2 @ Xk) @ XX))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ XP @ (XB2 @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (cco @ XJ @ (XB2 @ Xk) @ ccrest) @ ccconn))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XU @ XJ))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XV @ XJ))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwne @ (ccin @ XV @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))) @ cc0))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ (ccin @ XU @ XV) @ (ccdif @ XX @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccun @ XU @ XV)))) => ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwn @ (cwcel @ XP @ XU))))))))))))))))))))))).
