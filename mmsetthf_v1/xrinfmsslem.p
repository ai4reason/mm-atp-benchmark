...
thf(anltmnf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwn @ (cwbr @ XA2 @ ccmnf @ cclt))))).
...
thf(axrltnr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwn @ (cwbr @ XA2 @ XA2 @ cclt))))).
...
thf(cxrinfmsslem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwo @ (cwss @ XA2 @ ccr) @ (cwcel @ ccmnf @ XA2))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt))) @ (^ [Xy1:$i] : XA2)) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr))))).
