...
thf(adf_perpg_ax,axiom,(cwceq @ ccperpg @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ (ccrn @ (ccfv @ (ccv @ Xg1) @ cclng))) @ (cwcel @ (ccv @ Xb) @ (ccrn @ (ccfv @ (ccv @ Xg1) @ cclng)))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwcel @ (ccs3 @ (ccv @ Xu) @ (ccv @ Xx3) @ (ccv @ Xv)) @ (ccfv @ (ccv @ Xg1) @ ccrag))) @ (^ [Xv:$i] : (ccv @ Xb)))) @ (^ [Xu:$i] : (ccv @ Xa)))) @ (^ [Xx3:$i] : (ccin @ (ccv @ Xa) @ (ccv @ Xb)))))))))))).
...
thf(aopelopab2a_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XB2)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ Xps)))) => (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD)) @ (cwb @ (cwcel @ (ccop @ XA2 @ XB2) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XC) @ (cwcel @ (ccv @ Xy1) @ XD)) @ (Xph @ Xx3 @ Xy1)))))) @ Xps)))))))))).
...
thf(aineq12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwceq @ XA2 @ XB2) @ (cwceq @ XC @ XD)) @ (cwceq @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XD)))))))).
...
thf(cisperp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [Xc_mi:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XP @ Xx3 @ Xv @ Xu) @ (ccfv @ XG @ ccbs))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (Xc_mi @ Xx3 @ Xv @ Xu) @ (ccfv @ XG @ ccds))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XI @ Xx3 @ Xv @ Xu) @ (ccfv @ XG @ ccitv))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XL @ Xx3 @ Xv @ Xu) @ (ccfv @ XG @ cclng))))) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (ccrn @ (XL @ Xx3 @ Xv @ Xu))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (ccrn @ (XL @ Xx3 @ Xv @ Xu))))))) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwcel @ (ccs3 @ (ccv @ Xu) @ (ccv @ Xx3) @ (ccv @ Xv)) @ (ccfv @ XG @ ccrag))) @ (^ [Xv:$i] : XB2))) @ (^ [Xu:$i] : XA2))) @ (^ [Xx3:$i] : (ccin @ XA2 @ XB2))))))))))))))))))))).
