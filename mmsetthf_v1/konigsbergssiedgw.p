...
thf(aprprrab_thm,axiom,(! [XA2:($i > ($i > $o))] : (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ (XA2 @ Xx3)) @ (ccsn @ cc0)))) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xx3))))))).
...
thf(aeqlei2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwi @ (cwceq @ XB2 @ XA2) @ (cwbr @ XB2 @ XA2 @ ccle)))))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(a_2re_thm,axiom,(cwcel @ cc2 @ ccr)).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(afss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwss @ XB2 @ XC)) @ (cwf @ XA2 @ XC @ XF))))))).
thf(aiswrdb_thm,axiom,(! [XS:($i > $o)] : (! [XW:($i > $o)] : (cwb @ (cwcel @ XW @ (ccword @ XS)) @ (cwf @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo) @ XS @ XW))))).
