...
thf(cbgoldbachlt_conj,conjecture,(cwrex @ (^ [Xm:$i] : (cwa @ (cwbr @ (cco @ cc4 @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ (ccv @ Xm) @ ccle) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwa @ (cwbr @ cc4 @ (ccv @ Xn) @ cclt) @ (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ cclt)) @ (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)))) @ (^ [Xm:$i] : ccn))).
