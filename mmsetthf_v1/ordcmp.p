...
thf(alimsucncmp_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwlim @ XA2) @ (cwn @ (cwcel @ (ccsuc @ XA2) @ cccmp))))).
...
thf(aunon_thm,axiom,(cwceq @ (ccuni @ ccon0) @ ccon0)).
...
thf(aonsucsuccmp_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccsuc @ (ccsuc @ XA2)) @ cccmp)))).
...
thf(cordcmp_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwb @ (cwcel @ XA2 @ cccmp) @ (cwi @ (cwceq @ (ccuni @ XA2) @ (ccuni @ (ccuni @ XA2))) @ (cwceq @ XA2 @ cc1o)))))).
