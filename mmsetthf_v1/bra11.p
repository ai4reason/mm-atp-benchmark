...
thf(adf_bra_ax,axiom,(cwceq @ ccbr @ (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : cchil) @ (^ [Xy1:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccsp))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(ccnmf_tp,type,(ccnmf : ($i > $o))).
thf(arnbra_thm,axiom,(cwceq @ (ccrn @ ccbr) @ (ccin @ cclf @ cccnfn))).
