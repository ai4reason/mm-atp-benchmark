...
thf(cfgss2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwcel @ XG @ (ccfv @ XX @ ccfbas))) @ (cwb @ (cwss @ (cco @ XX @ XF @ ccfg) @ (cco @ XX @ XG @ ccfg)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XG))) @ (^ [Xx3:$i] : XF)))))))).
