...
thf(codmodnn0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) @ (cwceq @ (cco @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccmo) @ XA2 @ Xc_x) @ (cco @ XN @ XA2 @ Xc_x))))))))))))))).
