...
thf(cabv1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccabv)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwcel @ XF @ XA2)) @ (cwceq @ (ccfv @ Xc_1 @ XF) @ cc1))))))))).
