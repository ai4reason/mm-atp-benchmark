...
thf(afmuldfeqlem1_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwnf @ (^ [Xf1:$i] : (Xph @ Xt @ Xf1 @ Xg1 @ Xi)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (cwnf @ (^ [Xg1:$i] : (Xph @ Xt @ Xf1 @ Xg1 @ Xi)))))) => ((! [Xi:$i] : (cwnfc @ (^ [Xt:$i] : (XY @ Xt @ Xi)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xt:$i] : (XT @ Xi)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XF @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccmpt @ (^ [Xt:$i] : (XT @ Xi)) @ (^ [Xt:$i] : (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XU @ Xg1)))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwcel @ (XT @ Xi) @ ccvv)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwf @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz) @ (XY @ Xt @ Xi) @ (XU @ Xg1))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cw3a @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XY @ Xt @ Xi))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xi)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XY @ Xt @ Xi))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwcel @ (XN @ Xg1 @ Xi) @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwcel @ (cco @ (XN @ Xg1 @ Xi) @ cc1 @ ccaddc) @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwceq @ (ccfv @ (ccv @ Xt) @ (ccfv @ (XN @ Xg1 @ Xi) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ (XU @ Xg1) @ cc1))) @ (ccfv @ (XN @ Xg1 @ Xi) @ (ccseq @ ccmul @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xf1 @ Xg1 @ Xi)) @ cc1)))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi))) @ (cwf @ (XT @ Xi) @ ccr @ (ccv @ Xf1))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwcel @ (ccv @ Xt) @ (XT @ Xi))) @ (cwceq @ (ccfv @ (ccv @ Xt) @ (ccfv @ (cco @ (XN @ Xg1 @ Xi) @ cc1 @ ccaddc) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ (XU @ Xg1) @ cc1))) @ (ccfv @ (cco @ (XN @ Xg1 @ Xi) @ cc1 @ ccaddc) @ (ccseq @ ccmul @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xf1 @ Xg1 @ Xi)) @ cc1))))))))))))))))))))))))))))).
