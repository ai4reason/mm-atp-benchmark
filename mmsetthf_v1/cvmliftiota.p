...
thf(acvmlift_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XB2 @ (ccuni @ XC)) => (cwi @ (cwa @ (cwa @ (cwcel @ XF @ (cco @ XC @ XJ @ cccvm)) @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) @ (cwa @ (cwcel @ XP @ XB2) @ (cwceq @ (ccfv @ XP @ XF) @ (ccfv @ ccc0 @ XG)))) @ (cwreu @ (^ [Xf1:$i] : (cwa @ (cwceq @ (cccom @ XF @ (ccv @ Xf1)) @ XG) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn)))))))))))).
