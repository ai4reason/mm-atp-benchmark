...
thf(amplbas2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (cco @ XI @ XR @ ccmpl)) => ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XV @ (cco @ XI @ XR @ ccmvr)) => ((cwceq @ XA2 @ (ccfv @ XS @ ccasp)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccrn @ XV) @ XA2) @ (ccfv @ XP @ ccbs)))))))))))))))))).
...
thf(aislss4_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => (cwi @ (cwcel @ XW @ cclmod) @ (cwb @ (cwcel @ XU @ XS) @ (cwa @ (cwcel @ XU @ (ccfv @ XW @ ccsubg)) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ Xc_x) @ XU)) @ (^ [Xb:$i] : XU))) @ (^ [Xa:$i] : XB2)))))))))))))))))).
...
thf(cmplind_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XK @ Xy1) @ (ccfv @ (XR @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XV @ Xy1) @ (cco @ (XI @ Xy1) @ (XR @ Xx3 @ Xy1) @ ccmvr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XY @ (cco @ (XI @ Xy1) @ (XR @ Xx3 @ Xy1) @ ccmpl)))) => ((cwceq @ Xc_pl @ (ccfv @ XY @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccmulr)) => ((cwceq @ XC @ (ccfv @ XY @ ccascl)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XH) @ (cwcel @ (ccv @ Xy1) @ XH))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XH)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XH) @ (cwcel @ (ccv @ Xy1) @ XH))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) @ XH)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XK @ Xy1))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XC) @ XH)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XI @ Xy1))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (XV @ Xy1)) @ XH)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xx3 @ Xy1) @ XB2)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XI @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3 @ Xy1) @ cccrg)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xx3 @ Xy1) @ XH))))))))))))))))))))))))))))))).
