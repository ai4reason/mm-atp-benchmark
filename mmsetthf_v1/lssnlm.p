...
thf(asubgngp_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => (cwi @ (cwa @ (cwcel @ XG @ ccngp) @ (cwcel @ XA2 @ (ccfv @ XG @ ccsubg))) @ (cwcel @ XH @ ccngp))))))).
...
thf(asubgnm2_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ XM @ (ccfv @ XH @ ccnm)) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XX @ XA2)) @ (cwceq @ (ccfv @ XX @ XM) @ (ccfv @ XX @ XN))))))))))))).
...
thf(clssnlm_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ XW @ XU @ ccress)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => (cwi @ (cwa @ (cwcel @ XW @ ccnlm) @ (cwcel @ XU @ XS)) @ (cwcel @ XX @ ccnlm))))))))).
