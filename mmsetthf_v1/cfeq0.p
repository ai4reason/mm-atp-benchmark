...
thf(aonint0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccon0) @ (cwb @ (cwceq @ (ccint @ XA2) @ cc0) @ (cwcel @ cc0 @ XA2))))).
...
thf(ccfeq0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccf) @ cc0) @ (cwceq @ XA2 @ cc0))))).
