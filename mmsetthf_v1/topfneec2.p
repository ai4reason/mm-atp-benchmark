...
thf(ctopfneec2_conj,conjecture,(! [Xc_sm:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ Xc_sm @ (ccin @ ccfne @ (cccnv @ ccfne))) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwb @ (cwceq @ (ccec @ XJ @ Xc_sm) @ (ccec @ XK @ Xc_sm)) @ (cwceq @ XJ @ XK)))))))).
