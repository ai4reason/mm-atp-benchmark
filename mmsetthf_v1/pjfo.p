...
thf(apjf2_thm,axiom,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XK @ (ccfv @ XW @ ccpj)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwcel @ XT @ (ccdm @ XK))) @ (cwf @ XV @ XT @ (ccfv @ XT @ XK)))))))))).
...
thf(cpjfo_conj,conjecture,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XK @ (ccfv @ XW @ ccpj)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwcel @ XT @ (ccdm @ XK))) @ (cwfo @ XV @ XT @ (ccfv @ XT @ XK)))))))))).
