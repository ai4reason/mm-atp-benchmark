...
thf(asupxrleubrnmpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XC @ ccxr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwbr @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccxr @ cclt) @ XC @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ XC @ ccle)) @ (^ [Xx3:$i] : XA2))))))))))))).
...
thf(csupxrleubrnmptf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ ccxr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwbr @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccxr @ cclt) @ (XC @ Xx3) @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
