...
thf(crhmresfn_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccin @ XU @ ccrg))) => ((cwi @ Xph @ (cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XB2 @ XB2)))) => (cwi @ Xph @ (cwfn @ XH @ (ccxp @ XB2 @ XB2)))))))))).
