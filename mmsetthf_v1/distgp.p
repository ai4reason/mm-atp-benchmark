...
thf(atxdis_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (cco @ (ccpw @ XA2) @ (ccpw @ XB2) @ cctx) @ (ccpw @ (ccxp @ XA2 @ XB2))))))))).
...
thf(cdistgp_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwceq @ XJ @ (ccpw @ XB2))) @ (cwcel @ XG @ cctgp)))))))).
