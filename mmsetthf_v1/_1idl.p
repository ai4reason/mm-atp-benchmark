...
thf(aidlrmulcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XI @ (ccfv @ XR @ ccidl))) @ (cwa @ (cwcel @ XA2 @ XI) @ (cwcel @ XB2 @ XX))) @ (cwcel @ (cco @ XA2 @ XB2 @ XH) @ XI))))))))))))).
...
thf(c_1idl_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XI @ (ccfv @ XR @ ccidl))) @ (cwb @ (cwcel @ XU @ XI) @ (cwceq @ XI @ XX)))))))))))))).
