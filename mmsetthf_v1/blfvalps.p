...
thf(adf_bl_ax,axiom,(cwceq @ ccbl @ (ccmpt @ (^ [Xd:$i] : ccvv) @ (^ [Xd:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xz:$i] : (ccdm @ (ccdm @ (ccv @ Xd))))) @ (^ [Xx3:$i] : (^ [Xz:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xz:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)) @ (ccv @ Xz) @ cclt)) @ (^ [Xy1:$i] : (ccdm @ (ccdm @ (ccv @ Xd)))))))))))).
...
thf(cblfvalps_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwceq @ (ccfv @ XD @ ccbl) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xr:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xr:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xr:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (ccv @ Xr) @ cclt)) @ (^ [Xy1:$i] : XX)))))))))).
