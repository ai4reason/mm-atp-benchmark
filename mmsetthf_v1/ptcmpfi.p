...
thf(afincmp_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccin @ cctop @ ccfn)) @ (cwcel @ XJ @ cccmp)))).
...
thf(aptunhmeo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XK)) => ((cwceq @ XY @ (ccuni @ XL)) => ((cwceq @ XJ @ (ccfv @ XF @ ccpt)) => ((cwceq @ XK @ (ccfv @ (ccres @ XF @ XA2) @ ccpt)) => ((cwceq @ XL @ (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XC @ (XV @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwf @ XC @ cctop @ XF)) => ((cwi @ Xph @ (cwceq @ XC @ (ccun @ XA2 @ XB2))) => ((cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3 @ Xy1) @ (cco @ (cco @ XK @ XL @ cctx) @ XJ @ cchmeo)))))))))))))))))))))))))))).
...
thf(ahmphi_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) @ (cwbr @ XJ @ XK @ cchmph)))))).
...
thf(apt1hmeo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ (ccsn @ (ccop @ XA2 @ XJ)) @ ccpt)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XA2 @ (ccv @ Xx3))))) @ (cco @ XJ @ XK @ cchmeo))))))))))))).
...
thf(acmphmph_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwbr @ XJ @ XK @ cchmph) @ (cwi @ (cwcel @ XJ @ cccmp) @ (cwcel @ XK @ cccmp)))))).
thf(atxcmp_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ cccmp) @ (cwcel @ XS @ cccmp)) @ (cwcel @ (cco @ XR @ XS @ cctx) @ cccmp))))).
thf(cptcmpfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwf @ XA2 @ cccmp @ XF)) @ (cwcel @ (ccfv @ XF @ ccpt) @ cccmp))))).
