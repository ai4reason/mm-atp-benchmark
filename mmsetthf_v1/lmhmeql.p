...
thf(clmhmeql_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XU @ (ccfv @ XS @ cclss)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XG @ (cco @ XS @ XT @ cclmhm))) @ (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ XU))))))))).
