...
thf(acmpfi_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwb @ (cwcel @ XJ @ cccmp) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwn @ (cwcel @ cc0 @ (ccfv @ (ccv @ Xx3) @ ccfi))) @ (cwne @ (ccint @ (ccv @ Xx3)) @ cc0))) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ XJ @ cccld)))))))).
...
thf(ccmpfii_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cccmp) @ (cwss @ XX @ (ccfv @ XJ @ cccld)) @ (cwn @ (cwcel @ cc0 @ (ccfv @ XX @ ccfi)))) @ (cwne @ (ccint @ XX) @ cc0))))).
