...
thf(afproddvdsd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xx3) @ ccz))) => (cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xx3)) @ (^ [Xk:$i] : (ccv @ Xk))) @ ccdvds)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
...
thf(cabsproddvds_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xm:$i] : (cwi @ Xph @ (cwss @ (XZ @ Xm) @ ccz))) => ((! [Xm:$i] : (cwi @ Xph @ (cwcel @ (XZ @ Xm) @ ccfn))) => ((! [Xz:$i] : (! [Xm:$i] : (cwceq @ (XP @ Xz @ Xm) @ (ccfv @ (ccprod @ (^ [Xz:$i] : (XZ @ Xm)) @ (^ [Xz:$i] : (ccv @ Xz))) @ ccabs)))) => (! [Xz:$i] : (cwi @ Xph @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (XP @ Xz @ Xm) @ ccdvds)) @ (^ [Xm:$i] : (XZ @ Xm)))))))))))).
