...
thf(aontgval_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccon0) @ (cwceq @ (ccfv @ XB2 @ cctg) @ (ccsuc @ (ccuni @ XB2)))))).
...
thf(contgsucval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ (ccsuc @ XA2) @ cctg) @ (ccsuc @ XA2))))).
