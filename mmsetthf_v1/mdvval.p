...
thf(adf_mdv_ax,axiom,(cwceq @ ccmdv @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccdif @ (ccxp @ (ccfv @ (ccv @ Xt) @ ccmvar) @ (ccfv @ (ccv @ Xt) @ ccmvar)) @ ccid))))).
...
thf(cmdvval_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XD @ (ccfv @ XT @ ccmdv)) => (cwceq @ XD @ (ccdif @ (ccxp @ XV @ XV) @ ccid)))))))).
