...
thf(aresasplit_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XB2) @ (cwceq @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccres @ XG @ (ccin @ XA2 @ XB2)))) @ (cwceq @ (ccun @ XF @ XG) @ (ccun @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccun @ (ccres @ XF @ (ccdif @ XA2 @ XB2)) @ (ccres @ XG @ (ccdif @ XB2 @ XA2))))))))))).
...
thf(cfresaun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwf @ XA2 @ XC @ XF) @ (cwf @ XB2 @ XC @ XG) @ (cwceq @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccres @ XG @ (ccin @ XA2 @ XB2)))) @ (cwf @ (ccun @ XA2 @ XB2) @ XC @ (ccun @ XF @ XG))))))))).
