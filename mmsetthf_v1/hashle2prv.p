...
thf(ahashle2pr_thm,axiom,(! [XP:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XP @ (XV @ Xa @ Xb)) @ (cwne @ XP @ cc0)) @ (cwb @ (cwbr @ (ccfv @ XP @ cchash) @ cc2 @ ccle) @ (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwceq @ XP @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))))))))))))).
...
thf(aprelpw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC)) @ (cwcel @ (ccpr @ XA2 @ XB2) @ (ccpw @ XC)))))))))).
...
thf(chashle2prv_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XP @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0))) @ (cwb @ (cwbr @ (ccfv @ XP @ cchash) @ cc2 @ ccle) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ XP @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
