...
thf(ccosmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (ccfv @ XA2 @ cccos) @ (ccfv @ XB2 @ cccos) @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cccos) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccaddc) @ cc2 @ ccdiv)))))).
