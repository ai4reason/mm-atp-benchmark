...
thf(aovolicopnf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ (cco @ XA2 @ ccpnf @ ccico) @ ccovol) @ ccpnf)))).
...
thf(covolre_conj,conjecture,(cwceq @ (ccfv @ ccr @ ccovol) @ ccpnf)).
