...
thf(acompsscnvlem_thm,axiom,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccpw @ XA2)) @ (cwceq @ (ccv @ Xy1) @ (ccdif @ XA2 @ (ccv @ Xx3)))) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccpw @ XA2)) @ (cwceq @ (ccv @ Xx3) @ (ccdif @ XA2 @ (ccv @ Xy1))))))))).
thf(ccompsscnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwceq @ (cccnv @ (XF @ Xx3)) @ (XF @ Xx3))))))).
