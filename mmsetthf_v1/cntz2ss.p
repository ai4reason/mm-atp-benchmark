...
thf(ccntz2ss_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwa @ (cwss @ XS @ XB2) @ (cwss @ XT @ XS)) @ (cwss @ (ccfv @ XS @ XZ) @ (ccfv @ XT @ XZ))))))))))).
