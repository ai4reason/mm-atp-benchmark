...
thf(adf_rusgr_ax,axiom,(cwceq @ ccrusgr @ (ccopab @ (^ [Xg1:$i] : (^ [Xk:$i] : (cwa @ (cwcel @ (ccv @ Xg1) @ ccusgr) @ (cwbr @ (ccv @ Xg1) @ (ccv @ Xk) @ ccrgr))))))).
...
thf(crusgrprop_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwbr @ XG @ XK @ ccrusgr) @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwbr @ XG @ XK @ ccrgr)))))).
