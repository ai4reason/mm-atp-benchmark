...
thf(cee022_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => ((cwi @ Xps @ (cwi @ Xch @ Xth)) => ((cwi @ Xps @ (cwi @ Xch @ Xta)) => ((cwi @ Xph @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwi @ Xps @ (cwi @ Xch @ Xet))))))))))))).
