...
thf(a_1stconst_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwf1o @ (ccxp @ XA2 @ (ccsn @ XB2)) @ XA2 @ (ccres @ cc1st @ (ccxp @ XA2 @ (ccsn @ XB2))))))))).
...
thf(ccurry2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ (ccsn @ XC)))))) => (cwi @ (cwa @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwcel @ XC @ XB2)) @ (cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ XF)))))))))))).
