...
thf(azmax_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwreu @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccle) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ XA2 @ ccle) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle))) @ (^ [Xy1:$i] : ccz)))) @ (^ [Xx3:$i] : ccz))))).
...
thf(cflval2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccfl) @ (ccrio @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccle) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ XA2 @ ccle) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle))) @ (^ [Xy1:$i] : ccz)))) @ (^ [Xx3:$i] : ccz)))))).
