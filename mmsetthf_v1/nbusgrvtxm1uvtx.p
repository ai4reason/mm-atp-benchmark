...
thf(anbusgrvtxm1_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XU @ XV)) @ (cwi @ (cwceq @ (ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)) @ (cwi @ (cwa @ (cwcel @ XM @ XV) @ (cwne @ XM @ XU)) @ (cwcel @ XM @ (cco @ XG @ XU @ ccnbgr))))))))))).
...
thf(cnbusgrvtxm1uvtx_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XU @ XV)) @ (cwi @ (cwceq @ (ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)) @ (cwcel @ XU @ (ccfv @ XG @ ccuvtx))))))))).
