...
thf(ahsupcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccpw @ cchil)) @ (cwcel @ (ccfv @ XA2 @ cchsup) @ ccch)))).
thf(cchsupcl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccch) @ (cwcel @ (ccfv @ XA2 @ cchsup) @ ccch)))).
