...
thf(csgrim_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ XT @ XU @ ccress)) => ((cwceq @ XD @ (ccfv @ XT @ ccds)) => ((cwceq @ XE @ (ccfv @ XX @ ccds)) => (cwi @ (cwcel @ XU @ XS) @ (cwceq @ XE @ XD)))))))))))).
