...
thf(aclwwnisshclwwsn_thm,axiom,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) @ (cwcel @ (cco @ XW @ XM @ cccsh) @ (cco @ XN @ XG @ ccclwwlkn)))))))).
...
thf(cclwwlknscsh_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn))) @ (cwceq @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ XW @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (cco @ XN @ XG @ ccclwwlkn))) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ XW @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (ccword @ (ccfv @ XG @ ccvtx)))))))))).
