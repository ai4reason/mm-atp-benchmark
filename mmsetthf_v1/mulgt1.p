...
thf(cmulgt1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ cc1 @ XA2 @ cclt) @ (cwbr @ cc1 @ XB2 @ cclt))) @ (cwbr @ cc1 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))))).
