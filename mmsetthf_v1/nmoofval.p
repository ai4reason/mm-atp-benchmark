...
thf(adf_nmoo_ax,axiom,(cwceq @ ccnmoo @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xw:$i] : ccnv)) @ (^ [Xu:$i] : (^ [Xw:$i] : ccnv)) @ (^ [Xu:$i] : (^ [Xw:$i] : (ccmpt @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccba) @ (ccfv @ (ccv @ Xu) @ ccba) @ ccmap)) @ (^ [Xt:$i] : (ccsup @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xu) @ ccnmcv)) @ cc1 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xw) @ ccnmcv))))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xu) @ ccba))))) @ ccxr @ cclt)))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cnmoofval_conj,conjecture,(! [XU:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (ccfv @ XU @ ccba))) => ((! [Xz:$i] : (cwceq @ (XY @ Xz) @ (ccfv @ XW @ ccba))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XL @ Xx3 @ Xz) @ (ccfv @ XU @ ccnmcv)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XM @ Xx3 @ Xz) @ (ccfv @ XW @ ccnmcv)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwceq @ (XN @ Xx3 @ Xz @ Xt) @ (cco @ XU @ XW @ ccnmoo))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv)) @ (cwceq @ (XN @ Xx3 @ Xz @ Xt) @ (ccmpt @ (^ [Xt:$i] : (cco @ (XY @ Xz) @ (XX @ Xx3) @ ccmap)) @ (^ [Xt:$i] : (ccsup @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (XL @ Xx3 @ Xz)) @ cc1 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ (XM @ Xx3 @ Xz))))) @ (^ [Xz:$i] : (XX @ Xx3))))) @ ccxr @ cclt))))))))))))))))))))).
