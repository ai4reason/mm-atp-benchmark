...
thf(cclimmpt2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk @ Xn) @ ccuz)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk @ Xn) @ ccz)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ XF @ (XV @ Xk @ Xn))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XF @ (XA2 @ Xk) @ ccli) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) @ (XA2 @ Xk) @ ccrli))))))))))))))).
