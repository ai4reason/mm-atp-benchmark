...
thf(ciserex_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XN @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => (cwi @ Xph @ (cwb @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli)) @ (cwcel @ (ccseq @ ccaddc @ XF @ XN) @ (ccdm @ ccli))))))))))))).
