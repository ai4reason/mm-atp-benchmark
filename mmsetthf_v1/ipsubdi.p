...
thf(cipsubdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwceq @ XS @ (ccfv @ XF @ ccsg)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ Xc_mi) @ Xc_xi) @ (cco @ (cco @ XA2 @ XB2 @ Xc_xi) @ (cco @ XA2 @ XC @ Xc_xi) @ XS)))))))))))))))))).
