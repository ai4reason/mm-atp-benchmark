...
thf(cdipfval_conj,conjecture,(! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwceq @ (XP @ Xx3 @ Xy1 @ Xk) @ (ccfv @ XU @ ccdip))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ (cwcel @ XU @ ccnv) @ (cwceq @ (XP @ Xx3 @ Xy1 @ Xk) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ cc4 @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ (ccv @ Xy1) @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ ccmul))) @ cc4 @ ccdiv))))))))))))))))))))).
