...
thf(aoffval3_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XG @ XW)) @ (cwceq @ (cco @ XF @ XG @ (ccof @ XR)) @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccdm @ XF) @ (ccdm @ XG))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ XR))))))))))).
...
thf(advcmulf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ XX)) => (cwi @ Xph @ (cwceq @ (cco @ XS @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdv) @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ (cco @ XS @ XF @ ccdv) @ (ccof @ ccmul)))))))))))))).
...
thf(cdvsinax_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ ccsin))) @ ccdv) @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ cccos) @ ccmul))))))).
