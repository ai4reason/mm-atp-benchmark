...
thf(ablss_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XB2 @ (ccrn @ (ccfv @ XD @ ccbl))) @ (cwcel @ XP @ XB2)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ XB2)) @ (^ [Xx3:$i] : ccrp)))))))).
...
thf(ablelrn_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccxr)) @ (cwcel @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccrn @ (ccfv @ XD @ ccbl))))))))).
...
thf(cblssex_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XA2))) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ XD @ ccbl)))) @ (cwrex @ (^ [Xr:$i] : (cwss @ (cco @ XP @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XA2)) @ (^ [Xr:$i] : ccrp))))))))).
