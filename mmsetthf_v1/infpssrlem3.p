...
thf(cinfpssrlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => ((cwi @ Xph @ (cwf1o @ XB2 @ XA2 @ XF)) => ((cwi @ Xph @ (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((cwceq @ XG @ (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => (cwi @ Xph @ (cwf @ ccom @ XA2 @ XG))))))))))))).
