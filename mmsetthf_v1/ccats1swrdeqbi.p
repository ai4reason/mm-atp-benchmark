...
thf(cccats1swrdeqbi_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwceq @ (ccfv @ XU @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) @ (cwb @ (cwceq @ XW @ (cco @ XU @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) @ (cwceq @ XU @ (cco @ XW @ (ccs1 @ (ccfv @ XU @ cclsw)) @ ccconcat)))))))).
