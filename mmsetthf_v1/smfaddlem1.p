...
thf(altsub13d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ cclt)) => (cwi @ Xph @ (cwbr @ XC @ (cco @ XB2 @ XA2 @ ccmin) @ cclt))))))))))).
...
thf(aad5ant135_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ Xph @ Xta) @ Xps) @ Xet) @ Xch) @ Xth))))))))).
...
thf(adfcleqf_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (! [Xx3:$i] : (cwb @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (cwal @ (^ [Xx3:$i] : (cwb @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)))))))))))).
...
thf(csmfaddlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XC @ Xx3))) @ (cwcel @ (XD @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XR @ Xx3) @ ccr))) => ((! [Xx3:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XK @ Xq @ Xp) @ (ccmpt @ (^ [Xp:$i] : ccq) @ (^ [Xp:$i] : (ccrab @ (^ [Xq:$i] : (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc) @ (XR @ Xx3) @ cclt)) @ (^ [Xq:$i] : ccq)))))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ (XB2 @ Xx3) @ (XD @ Xx3) @ ccaddc) @ (XR @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (ccin @ (XA2 @ Xx3) @ (XC @ Xx3)))) @ (cciun @ (^ [Xp:$i] : ccq) @ (^ [Xp:$i] : (cciun @ (^ [Xq:$i] : (ccfv @ (ccv @ Xp) @ (XK @ Xq @ Xp))) @ (^ [Xq:$i] : (ccrab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (XB2 @ Xx3) @ (ccv @ Xp) @ cclt) @ (cwbr @ (XD @ Xx3) @ (ccv @ Xq) @ cclt))) @ (^ [Xx3:$i] : (ccin @ (XA2 @ Xx3) @ (XC @ Xx3)))))))))))))))))))))))).
