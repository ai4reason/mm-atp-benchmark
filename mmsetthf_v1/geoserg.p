...
thf(cgeoserg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ cc1)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) @ (cco @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmin) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv)))))))))))).
