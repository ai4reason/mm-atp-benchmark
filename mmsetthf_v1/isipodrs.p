...
thf(aipopos_thm,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XI @ (ccfv @ XF @ ccipo)) => (cwcel @ XI @ ccpo))))).
...
thf(aipole_thm,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccfv @ XF @ ccipo)) => ((cwceq @ Xc_le @ (ccfv @ XI @ ccple)) => (cwi @ (cw3a @ (cwcel @ XF @ XV) @ (cwcel @ XX @ XF) @ (cwcel @ XY @ XF)) @ (cwb @ (cwbr @ XX @ XY @ Xc_le) @ (cwss @ XX @ XY)))))))))))).
...
thf(cisipodrs_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) @ (cw3a @ (cwcel @ XA2 @ ccvv) @ (cwne @ XA2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
