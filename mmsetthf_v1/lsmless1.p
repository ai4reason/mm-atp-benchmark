...
thf(clsmless1_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg)) @ (cwss @ XS @ XT)) @ (cwss @ (cco @ XS @ XU @ Xc_po) @ (cco @ XT @ XU @ Xc_po)))))))))).
