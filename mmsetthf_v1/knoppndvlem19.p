...
thf(cknoppndvlem19_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xm:$i] : (cwceq @ (XA2 @ Xm) @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ (ccv @ Xm) @ ccmul))) => ((! [Xm:$i] : (cwceq @ (XB2 @ Xm) @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ ccmul))) => ((cwi @ Xph @ (cwcel @ XJ @ ccn0)) => ((cwi @ Xph @ (cwcel @ XH @ ccr)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwrex @ (^ [Xm:$i] : (cwa @ (cwbr @ (XA2 @ Xm) @ XH @ ccle) @ (cwbr @ XH @ (XB2 @ Xm) @ ccle))) @ (^ [Xm:$i] : ccz))))))))))))))).
