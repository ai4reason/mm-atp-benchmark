...
thf(adecpmatval0_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwcel @ XM @ (XV @ Xi @ Xj)) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (cco @ XM @ XK @ ccdecpmat) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdm @ (ccdm @ XM)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdm @ (ccdm @ XM)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ XK @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1))))))))))))).
...
thf(cdecpmatval_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ (XN @ Xi @ Xj) @ (XR @ Xi @ Xj) @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => (cwi @ (cwa @ (cwcel @ XM @ XB2) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (cco @ XM @ XK @ ccdecpmat) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ XK @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)))))))))))))))).
