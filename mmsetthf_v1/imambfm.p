...
thf(cimambfm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ ccvv)) => ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwceq @ XT @ (ccfv @ XK @ ccsigagen))) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccmbfm)) @ (cwa @ (cwf @ (ccuni @ XS) @ (ccuni @ XT) @ XF) @ (cwral @ (^ [Xa:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xa)) @ XS)) @ (^ [Xa:$i] : XK)))))))))))))).
