...
thf(aevendiv2z_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ cceven) @ (cwcel @ (cco @ XZ @ cc2 @ ccdiv) @ ccz)))).
thf(aelnn0z_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn0) @ (cwa @ (cwcel @ XN @ ccz) @ (cwbr @ ccc0 @ XN @ ccle))))).
thf(cnn0e_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XN @ cceven)) @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)))).
