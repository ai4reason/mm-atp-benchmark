...
thf(axpima2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwne @ (ccin @ XA2 @ XC) @ cc0) @ (cwceq @ (ccima @ (ccxp @ XA2 @ XB2) @ XC) @ XB2)))))).
...
thf(atrclimalb2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwss @ (ccima @ XR @ (ccun @ XA2 @ XB2)) @ XB2)) @ (cwss @ (ccima @ (ccfv @ XR @ cctcl) @ XA2) @ XB2))))))).
...
thf(acsbcog_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) @ (cwceq @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (cccom @ (XB2 @ Xx3) @ (XC @ Xx3)))) @ (cccom @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(arexab2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => (cwb @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xph @ Xy1))))) @ (cwex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xy1) @ (Xch @ Xy1)))))))))).
...
thf(cbrtrclfv2_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XR @ XW)) @ (cwb @ (cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) @ (cwcel @ XY @ (ccint @ (ccab @ (^ [Xf1:$i] : (cwss @ (ccima @ XR @ (ccun @ (ccsn @ XX) @ (ccv @ Xf1))) @ (ccv @ Xf1))))))))))))))).
