...
thf(adf_zn_ax,axiom,(cwceq @ cczn @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccsb @ czring @ (^ [Xz:$i] : (ccsb @ (cco @ (ccv @ Xz) @ (cco @ (ccv @ Xz) @ (ccfv @ (ccsn @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xz) @ ccrsp)) @ ccqg) @ ccqus) @ (^ [Xs1:$i] : (cco @ (ccv @ Xs1) @ (ccop @ (ccfv @ ccnx @ ccple) @ (ccsb @ (ccres @ (ccfv @ (ccv @ Xs1) @ cczrh) @ (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ ccz @ (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))) @ (^ [Xf1:$i] : (cccom @ (cccom @ (ccv @ Xf1) @ ccle) @ (cccnv @ (ccv @ Xf1)))))) @ ccsts))))))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cznval_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ czring @ ccrsp)) => ((cwceq @ XU @ (cco @ czring @ (cco @ czring @ (ccfv @ (ccsn @ XN) @ XS) @ ccqg) @ ccqus)) => ((cwceq @ XY @ (ccfv @ XN @ cczn)) => ((cwceq @ XF @ (ccres @ (ccfv @ XU @ cczrh) @ XW)) => ((cwceq @ XW @ (ccif @ (cwceq @ XN @ ccc0) @ ccz @ (cco @ ccc0 @ XN @ ccfzo))) => ((cwceq @ Xc_le @ (cccom @ (cccom @ XF @ ccle) @ (cccnv @ XF))) => (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ XY @ (cco @ XU @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ ccsts))))))))))))))))).
