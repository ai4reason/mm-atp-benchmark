...
thf(alnopunii_thm,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwfo @ cchil @ cchil @ XT) => ((cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) @ (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)) => (cwcel @ XT @ ccuo)))))).
...
thf(celunop2_conj,conjecture,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ ccuo) @ (cw3a @ (cwcel @ XT @ cclo) @ (cwfo @ cchil @ cchil @ XT) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) @ (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)))))).
