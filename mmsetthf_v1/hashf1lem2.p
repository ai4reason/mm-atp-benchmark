...
thf(ahashf1lem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XA2 @ Xz) @ ccfn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XB2 @ Xz) @ ccfn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwn @ (cwcel @ (ccv @ Xz) @ (XA2 @ Xz))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (cco @ (ccfv @ (XA2 @ Xz) @ cchash) @ cc1 @ ccaddc) @ (ccfv @ (XB2 @ Xz) @ cchash) @ ccle))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf1 @ (XA2 @ Xz) @ (XB2 @ Xz) @ (XF @ Xz)))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccab @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccres @ (ccv @ Xf1) @ (XA2 @ Xz)) @ (XF @ Xz)) @ (cwf1 @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (XB2 @ Xz) @ (ccv @ Xf1))))) @ (ccdif @ (XB2 @ Xz) @ (ccrn @ (XF @ Xz))) @ ccen))))))))))))).
