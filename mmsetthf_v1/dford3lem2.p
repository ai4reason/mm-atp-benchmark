...
thf(asetindtrs_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (Xps @ Xy1 @ Xz)) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XB2 @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1 @ Xz)))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwex @ (^ [Xz:$i] : (cwa @ (cwtr @ (ccv @ Xz)) @ (cwcel @ (XB2 @ Xy1) @ (ccv @ Xz))))) @ (Xch @ Xy1 @ Xz)))))))))))).
...
thf(adford3lem1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwtr @ XN) @ (cwral @ (^ [Xy1:$i] : (cwtr @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XN))) @ (cwral @ (^ [Xb:$i] : (cwa @ (cwtr @ (ccv @ Xb)) @ (cwral @ (^ [Xy1:$i] : (cwtr @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xb))))) @ (^ [Xb:$i] : XN))))).
...
thf(cdford3lem2_conj,conjecture,(! [Xx3:$i] : (cwi @ (cwa @ (cwtr @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwtr @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (cwcel @ (ccv @ Xx3) @ ccon0)))).
