...
thf(admmpt2ssx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwss @ (ccdm @ (XF @ Xx3 @ Xy1)) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3))))))))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(cccat_tp,type,(cccat : ($i > $o))).
thf(acoafval_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xb:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwceq @ (Xc_x @ Xf1 @ Xg1 @ Xh) @ (ccfv @ XC @ cccoa))))) => ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwceq @ (Xc_xb @ Xf1 @ Xg1 @ Xh) @ (ccfv @ XC @ ccco))))) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwceq @ (Xc_x @ Xf1 @ Xg1 @ Xh) @ (ccmpt2 @ (^ [Xg1:$i] : (^ [Xf1:$i] : XA2)) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccrab @ (^ [Xh:$i] : (cwceq @ (ccfv @ (ccv @ Xh) @ cccoda) @ (ccfv @ (ccv @ Xg1) @ ccdoma))) @ (^ [Xh:$i] : XA2)))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccotp @ (ccfv @ (ccv @ Xf1) @ ccdoma) @ (ccfv @ (ccv @ Xg1) @ cccoda) @ (cco @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ (ccfv @ (ccv @ Xf1) @ cc2nd) @ (cco @ (ccop @ (ccfv @ (ccv @ Xf1) @ ccdoma) @ (ccfv @ (ccv @ Xg1) @ ccdoma)) @ (ccfv @ (ccv @ Xg1) @ cccoda) @ (Xc_xb @ Xf1 @ Xg1 @ Xh))))))))))))))))))).
...
thf(cdmcoass_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XC @ cccoa)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => (cwss @ (ccdm @ Xc_x) @ (ccxp @ XA2 @ XA2)))))))).
