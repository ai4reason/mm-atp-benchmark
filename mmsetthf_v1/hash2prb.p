...
thf(ahash2exprb_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XV @ XW) @ (cwb @ (cwceq @ (ccfv @ XV @ cchash) @ cc2) @ (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwa @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))))).
...
thf(chash2prb_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XV @ XW) @ (cwb @ (cwceq @ (ccfv @ XV @ cchash) @ cc2) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
