...
thf(cmhm0_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => ((cwceq @ XY @ (ccfv @ XT @ cc0g)) => (cwi @ (cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) @ (cwceq @ (ccfv @ Xc_0 @ XF) @ XY)))))))))).
