...
thf(cmblfinlem4_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) @ (cwcel @ XA2 @ (ccdm @ ccvol))) @ (cwceq @ (ccfv @ XA2 @ ccovol) @ (ccsup @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwss @ (ccv @ Xb) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))) @ ccr @ cclt))))).
