...
thf(chashp1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwceq @ XB2 @ (ccsuc @ XA2)) => ((cwceq @ (ccfv @ XA2 @ cchash) @ XM) => ((cwceq @ (cco @ XM @ cc1 @ ccaddc) @ XN) => (cwceq @ (ccfv @ XB2 @ cchash) @ XN)))))))))).
