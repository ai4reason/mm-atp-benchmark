...
thf(adf_mex_ax,axiom,(cwceq @ ccmex @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccxp @ (ccfv @ (ccv @ Xt) @ ccmtc) @ (ccfv @ (ccv @ Xt) @ ccmrex)))))).
...
thf(cmexval_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ XT @ ccmtc)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => (cwceq @ XE @ (ccxp @ XK @ XR)))))))))).
