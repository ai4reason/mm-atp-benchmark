...
thf(crusgrnumwwlkslem_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwcel @ XY @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XP)) @ (^ [Xw:$i] : XZ))) @ (cwceq @ (ccrab @ (^ [Xw:$i] : (cwa @ (Xph @ Xw) @ (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw))) @ (ccrab @ (^ [Xw:$i] : (cw3a @ (Xph @ Xw) @ (cwceq @ (ccfv @ ccc0 @ XY) @ XP) @ (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw)))))))))))).
