...
thf(csubspopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ XV)) @ (cwa @ (cwcel @ XB2 @ XJ) @ (cwss @ XB2 @ XA2))) @ (cwcel @ XB2 @ (cco @ XJ @ XA2 @ ccrest)))))))).
