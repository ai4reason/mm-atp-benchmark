...
thf(atgss3_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XW)) @ (cwb @ (cwss @ (ccfv @ XB2 @ cctg) @ (ccfv @ XC @ cctg)) @ (cwss @ XB2 @ (ccfv @ XC @ cctg))))))))).
...
thf(ctgss2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ (XV @ Xz)) @ (cwceq @ (ccuni @ XB2) @ (ccuni @ XC))) @ (cwb @ (cwss @ (ccfv @ XB2 @ cctg) @ (ccfv @ XC @ cctg)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : XC)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (ccuni @ XB2)))))))))).
