...
thf(cpwsco1rhm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XA2 @ ccpws)) => ((cwceq @ XZ @ (cco @ XR @ XB2 @ ccpws)) => ((cwceq @ XC @ (ccfv @ XZ @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xg1)))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XW @ Xg1)))) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xg1:$i] : XC) @ (^ [Xg1:$i] : (cccom @ (ccv @ Xg1) @ XF))) @ (cco @ XZ @ XY @ ccrh))))))))))))))))))))).
