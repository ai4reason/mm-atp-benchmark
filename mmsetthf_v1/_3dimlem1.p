...
thf(c_3dimlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cwa @ (cw3a @ (cwne @ XQ @ XR) @ (cwn @ (cwbr @ XS @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ XT @ (cco @ (cco @ XQ @ XR @ Xc_or) @ XS @ Xc_or) @ Xc_le))) @ (cwceq @ XP @ XQ)) @ (cw3a @ (cwne @ XP @ XR) @ (cwn @ (cwbr @ XS @ (cco @ XP @ XR @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ XT @ (cco @ (cco @ XP @ XR @ Xc_or) @ XS @ Xc_or) @ Xc_le))))))))))))))))).
