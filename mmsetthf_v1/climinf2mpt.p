...
thf(acliminf2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xx3 @ Xk)))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xk) @ (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xk) @ (cwf @ XZ @ ccr @ (XF @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XF @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xk) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccle)) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xk) @ (cwbr @ (XF @ Xk) @ (ccinf @ (ccrn @ (XF @ Xk)) @ ccxr @ cclt) @ ccli)))))))))))))))).
...
thf(acbvcsb_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1))) @ (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xy1:$i] : (XD @ Xx3 @ Xy1))))))))))))).
...
thf(apeano2uzs_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XN @ XZ) @ (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ XZ))))))).
...
thf(aclimbddf_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ (XF @ Xk) @ (ccdm @ ccli)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccc)) @ (^ [Xk:$i] : XZ))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))).
thf(arexabsle2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccr)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwb @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (^ [Xy1:$i] : ccr)) @ (cwa @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (^ [Xy1:$i] : ccr)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xy1) @ (XB2 @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (^ [Xy1:$i] : ccr))))))))))))).
thf(ccliminf2mpt_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xj:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xj @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XB2 @ Xk) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccv @ Xj)) @ (cwceq @ (XB2 @ Xk) @ (XC @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cw3a @ (Xph @ Xj @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ) @ (cwceq @ (ccv @ Xj) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc))) @ (cwbr @ (XC @ Xj) @ (XB2 @ Xk) @ ccle)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccdm @ ccli))))) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk)))) @ ccxr @ cclt) @ ccli)))))))))))))))))).
