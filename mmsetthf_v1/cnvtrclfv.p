...
thf(acnviun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwceq @ (cccnv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cccnv @ (XB2 @ Xx3)))))))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acnvexg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (cccnv @ XA2) @ ccvv))))).
thf(ccnvtrclfv_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwceq @ (cccnv @ (ccfv @ XR @ cctcl)) @ (ccfv @ (cccnv @ XR) @ cctcl)))))).
