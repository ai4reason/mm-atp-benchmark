...
thf(anmopreltpnf_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ cchil @ XT) @ (cwb @ (cwcel @ (ccfv @ XT @ ccnop) @ ccr) @ (cwbr @ (ccfv @ XT @ ccnop) @ ccpnf @ cclt))))).
thf(celbdop2_conj,conjecture,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ ccbo) @ (cwa @ (cwcel @ XT @ cclo) @ (cwcel @ (ccfv @ XT @ ccnop) @ ccr))))).
