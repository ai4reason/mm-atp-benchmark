...
thf(agchpwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwcel @ XA2 @ ccgch) @ (cwcel @ XB2 @ ccgch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ (ccpw @ XA2) @ XB2 @ ccdom)))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwwe_tp,type,(cwwe : (($i > $o) > (($i > $o) > $o)))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(aondomen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwbr @ XB2 @ XA2 @ ccdom)) @ (cwcel @ XB2 @ (ccdm @ cccrd)))))).
thf(agchaleph_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccfv @ XA2 @ ccale) @ ccgch) @ (cwcel @ (ccpw @ (ccfv @ XA2 @ ccale)) @ (ccdm @ cccrd))) @ (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccen)))).
thf(cgchaleph2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccfv @ XA2 @ ccale) @ ccgch) @ (cwcel @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccgch)) @ (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccen)))).
