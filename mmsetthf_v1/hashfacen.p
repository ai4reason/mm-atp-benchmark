...
thf(chashfacen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwbr @ XC @ XD @ ccen)) @ (cwbr @ (ccab @ (^ [Xf1:$i] : (cwf1o @ XA2 @ XC @ (ccv @ Xf1)))) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ XB2 @ XD @ (ccv @ Xf1)))) @ ccen))))))).
