...
thf(adf_fzo_ax,axiom,(cwceq @ ccfzo @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xm:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xm:$i] : (^ [Xn:$i] : (cco @ (ccv @ Xm) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccfz)))))).
thf(cfzof_conj,conjecture,(cwf @ (ccxp @ ccz @ ccz) @ (ccpw @ ccz) @ ccfzo)).
