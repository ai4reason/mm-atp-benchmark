...
thf(aplyco_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS)))) => (cwi @ Xph @ (cwcel @ (cccom @ XF @ XG) @ (ccfv @ XS @ ccply)))))))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(asyl3anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ Xth) => ((cwi @ (cw3a @ Xps @ Xch @ Xth) @ Xta) => (cwi @ Xph @ Xta))))))))))).
thf(assid_thm,axiom,(! [XA2:($i > $o)] : (cwss @ XA2 @ XA2))).
thf(aplypow_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwss @ XS @ ccc) @ (cwcel @ cc1 @ XS) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ (ccv @ Xz) @ XN @ ccexp))) @ (ccfv @ XS @ ccply)))))).
...
thf(cdgrcolem1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (ccfv @ XG @ ccdgr))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3) @ ccn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XG @ (ccfv @ (XS @ Xx3) @ ccply)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XG) @ XM @ ccexp))) @ ccdgr) @ (cco @ XM @ (XN @ Xx3) @ ccmul)))))))))))))).
