...
thf(afrlmbasfsupp_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => (cwi @ (cwa @ (cwcel @ XI @ XW) @ (cwcel @ XX @ XB2)) @ (cwbr @ XX @ Xc_0 @ ccfsupp))))))))))))).
...
thf(cuvcresum_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XU @ (cco @ XR @ XI @ ccuvc)) => ((cwceq @ XY @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccvsca)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XW) @ (cwcel @ XX @ XB2)) @ (cwceq @ XX @ (cco @ XY @ (cco @ XX @ XU @ (ccof @ Xc_x)) @ ccgsu)))))))))))))))).
