...
thf(aatandmneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwcel @ (ccneg @ XA2) @ (ccdm @ ccatan))))).
...
thf(aatanlogsublem_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) @ (cwcel @ (ccfv @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))))).
...
thf(catanlogsub_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) @ (cwcel @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ (ccrn @ cclog))))).
