...
thf(areldir_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccdir) @ (cwrel @ XR)))).
thf(arelelrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwrel @ XR) @ (cwbr @ XA2 @ XB2 @ XR)) @ (cwcel @ XB2 @ (ccrn @ XR))))))).
...
thf(cdirge_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdir) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ XR) @ (cwbr @ XB2 @ (ccv @ Xx3) @ XR))) @ (^ [Xx3:$i] : XX))))))))).
