...
thf(atz7_49c_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwne @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3))) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : ccon0))) @ (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ XA2 @ (ccres @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))))).
...
thf(cdfac8alem_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XF @ Xg1) @ (ccrecs @ (XG @ Xy1 @ Xf1 @ Xg1)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XG @ Xy1 @ Xf1 @ Xg1) @ (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (ccfv @ (ccdif @ XA2 @ (ccrn @ (ccv @ Xf1))) @ (ccv @ Xg1)))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwcel @ XA2 @ (XC @ Xy1 @ Xf1)) @ (cwi @ (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwne @ (ccv @ Xy1) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ XA2))))) @ (cwcel @ XA2 @ (ccdm @ cccrd))))))))))))).
