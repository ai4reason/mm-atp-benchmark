...
thf(asummolem3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc)))) => ((! [Xf1:$i] : (cwceq @ (XG @ Xf1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xf1 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (XK @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwa @ (cwcel @ (XM @ Xf1) @ ccn) @ (cwcel @ (XN @ Xf1) @ ccn)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (cco @ cc1 @ (XM @ Xf1) @ ccfz) @ XA2 @ (ccv @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (cco @ cc1 @ (XN @ Xf1) @ ccfz) @ XA2 @ (XK @ Xf1)))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccfv @ (XM @ Xf1) @ (ccseq @ ccaddc @ (XG @ Xf1) @ cc1)) @ (ccfv @ (XN @ Xf1) @ (ccseq @ ccaddc @ (XH @ Xf1 @ Xk @ Xn) @ cc1)))))))))))))))))))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => (cwi @ Xph @ (cwa @ Xps @ Xch)))))))).
thf(csummolem2a_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc)))) => ((! [Xf1:$i] : (cwceq @ (XG @ Xf1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xf1 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (XK @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XN @ Xf1) @ ccn))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XM @ Xf1) @ ccz))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwss @ XA2 @ (ccfv @ (XM @ Xf1) @ ccuz)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (cco @ cc1 @ (XN @ Xf1) @ ccfz) @ XA2 @ (ccv @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwiso @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ XA2 @ cclt @ cclt @ (XK @ Xf1)))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwbr @ (ccseq @ ccaddc @ XF @ (XM @ Xf1)) @ (ccfv @ (XN @ Xf1) @ (ccseq @ ccaddc @ (XG @ Xf1) @ cc1)) @ ccli)))))))))))))))))))))).
