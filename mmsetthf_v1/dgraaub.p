...
thf(adgraaval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwceq @ (ccfv @ XA2 @ ccdgraa) @ (ccinf @ (ccrab @ (^ [Xd:$i] : (cwrex @ (^ [Xp:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccv @ Xd)) @ (cwceq @ (ccfv @ XA2 @ (ccv @ Xp)) @ ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p))))) @ (^ [Xd:$i] : ccn)) @ ccr @ cclt))))).
...
thf(cdgraaub_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XP @ (ccfv @ ccq @ ccply)) @ (cwne @ XP @ cc0p)) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ XP) @ ccc0))) @ (cwbr @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ XP @ ccdgr) @ ccle))))).
