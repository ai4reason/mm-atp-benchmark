...
thf(cbernneq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwbr @ (cco @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmul) @ cc1 @ ccaddc) @ (cco @ XA2 @ XN @ ccexp) @ ccle))))).
