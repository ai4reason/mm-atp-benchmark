...
thf(axpima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccima @ (ccxp @ XA2 @ XB2) @ XC) @ (ccif @ (cwceq @ (ccin @ XA2 @ XC) @ cc0) @ cc0 @ XB2)))))).
...
thf(cimadifxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwss @ XC @ XA2) @ (cwceq @ (ccima @ (ccdif @ XR @ (ccxp @ XA2 @ XB2)) @ XC) @ (ccdif @ (ccima @ XR @ XC) @ XB2)))))))).
