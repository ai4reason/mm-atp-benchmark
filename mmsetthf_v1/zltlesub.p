...
thf(czltlesub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XN @ XA2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XB2 @ cc1 @ cclt)) => ((cwi @ Xph @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccz)) => (cwi @ Xph @ (cwbr @ XN @ (cco @ XA2 @ XB2 @ ccmin) @ ccle))))))))))))).
