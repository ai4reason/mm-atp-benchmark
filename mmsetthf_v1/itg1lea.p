...
thf(aitg1ge0a_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XF @ ccitg1) @ ccle)))))))))).
...
thf(citg1lea_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ ccc0)) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccle)))))))))))).
