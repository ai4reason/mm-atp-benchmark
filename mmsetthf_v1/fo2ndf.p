...
thf(af2ndf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ XF @ XB2 @ (ccres @ cc2nd @ XF))))))).
...
thf(aelrn2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwb @ (cwcel @ XA2 @ (ccrn @ XB2)) @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ XA2) @ XB2)))))))))).
...
thf(cfo2ndf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwfo @ XF @ (ccrn @ XF) @ (ccres @ cc2nd @ XF))))))).
