...
thf(achprpcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc2 @ XA2 @ ccle)) @ (cwcel @ (ccfv @ XA2 @ ccchp) @ ccrp)))).
...
thf(achpfl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccfl) @ ccchp) @ (ccfv @ XA2 @ ccchp))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(achp1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccchp) @ ccc0)).
...
thf(cchpeq0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccchp) @ ccc0) @ (cwbr @ XA2 @ cc2 @ cclt))))).
