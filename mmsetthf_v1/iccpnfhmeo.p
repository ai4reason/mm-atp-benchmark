...
thf(aicopnfhmeo_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ ccdiv))))) => ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (! [Xx3:$i] : (cwa @ (cwiso @ (cco @ ccc0 @ cc1 @ ccico) @ (cco @ ccc0 @ ccpnf @ ccico) @ cclt @ cclt @ (XF @ Xx3)) @ (cwcel @ (XF @ Xx3) @ (cco @ (cco @ XJ @ (cco @ ccc0 @ cc1 @ ccico) @ ccrest) @ (cco @ XJ @ (cco @ ccc0 @ ccpnf @ ccico) @ ccrest) @ cchmeo))))))))).
...
thf(aisores2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwb @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwiso @ XA2 @ XB2 @ XR @ (ccin @ XS @ (ccxp @ XB2 @ XB2)) @ XH)))))))).
...
thf(adfii5_thm,axiom,(cwceq @ ccii @ (ccfv @ (ccin @ ccle @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ cc1 @ ccicc))) @ ccordt))).
