...
thf(ainfpn_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwrex @ (^ [Xj:$i] : (cwa @ (cwbr @ XN @ (ccv @ Xj) @ cclt) @ (cwral @ (^ [Xk:$i] : (cwi @ (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ ccdiv) @ ccn) @ (cwo @ (cwceq @ (ccv @ Xk) @ cc1) @ (cwceq @ (ccv @ Xk) @ (ccv @ Xj))))) @ (^ [Xk:$i] : ccn)))) @ (^ [Xj:$i] : ccn))))).
...
thf(aunben_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccn) @ (cwral @ (^ [Xm:$i] : (cwrex @ (^ [Xn:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ cclt)) @ (^ [Xn:$i] : XA2))) @ (^ [Xm:$i] : ccn))) @ (cwbr @ XA2 @ ccn @ ccen)))).
thf(cinfpn2_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xm @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwbr @ cc1 @ (ccv @ Xn) @ cclt) @ (cwral @ (^ [Xm:$i] : (cwi @ (cwcel @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccdiv) @ ccn) @ (cwo @ (cwceq @ (ccv @ Xm) @ cc1) @ (cwceq @ (ccv @ Xm) @ (ccv @ Xn))))) @ (^ [Xm:$i] : ccn)))) @ (^ [Xn:$i] : ccn))))) => (! [Xm:$i] : (! [Xn:$i] : (cwbr @ (XS @ Xm @ Xn) @ ccn @ ccen)))))).
