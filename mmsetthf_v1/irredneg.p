...
thf(cirredneg_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ ccir)) => ((cwceq @ XN @ (ccfv @ XR @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XI)) @ (cwcel @ (ccfv @ XX @ XN) @ XI))))))))).
