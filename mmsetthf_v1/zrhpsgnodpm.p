...
thf(azringinvg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwceq @ (ccneg @ XA2) @ (ccfv @ XA2 @ (ccfv @ czring @ ccminusg)))))).
...
thf(czrhpsgnodpm_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ cczrh)) => ((cwceq @ XS @ (ccfv @ XN @ ccpsgn)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((cwceq @ XI @ (ccfv @ XR @ ccminusg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XN @ ccevpm)))) @ (cwceq @ (ccfv @ XF @ (cccom @ XY @ XS)) @ (ccfv @ Xc_1 @ XI))))))))))))))))).
