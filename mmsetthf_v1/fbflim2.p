...
thf(afbflim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (cco @ XX @ XB2 @ ccfg)) => (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XB2 @ (ccfv @ XX @ ccfbas))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xx3)) @ (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XB2)))) @ (^ [Xx3:$i] : XJ)))))))))))).
...
thf(cfbflim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (cco @ XX @ XB2 @ ccfg))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XB2 @ (ccfv @ XX @ ccfbas))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ (XF @ Xn) @ ccflim)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xn))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei))))))))))))))).
