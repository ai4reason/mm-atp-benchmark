...
thf(aisldepslvec2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XE @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XM @ cclvec) @ (cwcel @ XS @ (ccpw @ XB2))) @ (cwb @ (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) @ (cwceq @ (cco @ (ccv @ Xf1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ (ccfv @ XM @ cclinc)) @ (ccv @ Xs1)))) @ (^ [Xf1:$i] : (cco @ XE @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ ccmap)))) @ (^ [Xs1:$i] : XS)) @ (cwbr @ XS @ XM @ cclindeps)))))))))))))))).
...
thf(cldepslinc_conj,conjecture,(cwa @ (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xs1:$i] : (cwb @ (cwbr @ (ccv @ Xs1) @ (ccv @ Xm) @ cclindeps) @ (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ cc0g) @ ccfsupp) @ (cwceq @ (cco @ (ccv @ Xf1) @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xv))) @ (ccfv @ (ccv @ Xm) @ cclinc)) @ (ccv @ Xv)))) @ (^ [Xf1:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ ccbs) @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xv))) @ ccmap)))) @ (^ [Xv:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xm) @ ccbs))))) @ (^ [Xm:$i] : cclvec)) @ (cwn @ (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xs1:$i] : (cwb @ (cwbr @ (ccv @ Xs1) @ (ccv @ Xm) @ cclindeps) @ (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ cc0g) @ ccfsupp) @ (cwceq @ (cco @ (ccv @ Xf1) @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xv))) @ (ccfv @ (ccv @ Xm) @ cclinc)) @ (ccv @ Xv)))) @ (^ [Xf1:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ ccbs) @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xv))) @ ccmap)))) @ (^ [Xv:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xm) @ ccbs))))) @ (^ [Xm:$i] : cclmod))))).
