...
thf(aaxrep5_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwnf @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))) => (! [Xw:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xw)) @ (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)))))))))) @ (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xy1:$i] : (cwb @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xw)) @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))).
...
thf(caxsep_conj,conjecture,(! [Xph:($i > $o)] : (! [Xz:$i] : (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xx3:$i] : (cwb @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) @ (Xph @ Xx3)))))))))).
