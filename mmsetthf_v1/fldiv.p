...
thf(aintfrac2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XA2 @ ccfl)) => ((cwceq @ XF @ (cco @ XA2 @ XZ @ ccmin)) => (cwi @ (cwcel @ XA2 @ ccr) @ (cw3a @ (cwbr @ ccc0 @ XF @ ccle) @ (cwbr @ XF @ cc1 @ cclt) @ (cwceq @ XA2 @ (cco @ XZ @ XF @ ccaddc)))))))))).
...
thf(aintfracq_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccfl)) => ((cwceq @ XF @ (cco @ (cco @ XM @ XN @ ccdiv) @ XZ @ ccmin)) => (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccn)) @ (cw3a @ (cwbr @ ccc0 @ XF @ ccle) @ (cwbr @ XF @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XN @ ccdiv) @ ccle) @ (cwceq @ (cco @ XM @ XN @ ccdiv) @ (cco @ XZ @ XF @ ccaddc))))))))))).
...
thf(cfldiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XA2 @ ccfl) @ XN @ ccdiv) @ ccfl) @ (ccfv @ (cco @ XA2 @ XN @ ccdiv) @ ccfl)))))).
