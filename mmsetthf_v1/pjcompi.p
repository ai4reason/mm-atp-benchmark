...
thf(achocunii_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XH) @ (cwcel @ XB2 @ (ccfv @ XH @ ccort))) @ (cwa @ (cwcel @ XC @ XH) @ (cwcel @ XD @ (ccfv @ XH @ ccort)))) @ (cwi @ (cwa @ (cwceq @ XR @ (cco @ XA2 @ XB2 @ ccva)) @ (cwceq @ XR @ (cco @ XC @ XD @ ccva))) @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)))))))))))).
thf(cpjcompi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwi @ (cwa @ (cwcel @ XA2 @ XH) @ (cwcel @ XB2 @ (ccfv @ XH @ ccort))) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ (ccfv @ XH @ ccpjh)) @ XA2))))))).
