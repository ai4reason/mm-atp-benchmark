...
thf(cdprdf1o_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwi @ Xph @ (cwf1o @ XJ @ XI @ XF)) => (cwi @ Xph @ (cwa @ (cwbr @ XG @ (cccom @ XS @ XF) @ (ccdm @ ccdprd)) @ (cwceq @ (cco @ XG @ (cccom @ XS @ XF) @ ccdprd) @ (cco @ XG @ XS @ ccdprd)))))))))))))).
