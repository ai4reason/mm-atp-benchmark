...
thf(aopnneiss_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XN @ XJ) @ (cwss @ XS @ XN)) @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))))))).
...
thf(ctopssnei_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop) @ (cwceq @ XX @ XY)) @ (cwss @ XJ @ XK)) @ (cwss @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccfv @ XS @ (ccfv @ XK @ ccnei)))))))))))).
