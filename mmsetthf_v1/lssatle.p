...
thf(clssatle_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XW @ cclmod))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XT @ XS))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XU @ XS))) => (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwb @ (cwss @ XT @ XU) @ (cwral @ (^ [Xp:$i] : (cwi @ (cwss @ (ccv @ Xp) @ XT) @ (cwss @ (ccv @ Xp) @ XU))) @ (^ [Xp:$i] : XA2))))))))))))))))).
