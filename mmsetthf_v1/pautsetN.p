...
thf(adf_pautN_ax,axiom,(cwceq @ ccpautN @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccab @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (ccfv @ (ccv @ Xk) @ ccpsubsp) @ (ccfv @ (ccv @ Xk) @ ccpsubsp) @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwb @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwss @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1))))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xk) @ ccpsubsp)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccpsubsp)))))))))).
...
thf(amapval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwceq @ (cco @ XA2 @ XB2 @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf @ XB2 @ XA2 @ (ccv @ Xf1)))))))))).
...
thf(cpautsetN_conj,conjecture,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (cwceq @ XS @ (ccfv @ (XK @ Xy1) @ ccpsubsp))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XM @ Xx3 @ Xy1 @ Xf1) @ (ccfv @ (XK @ Xy1) @ ccpautN))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwcel @ (XK @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xf1)) @ (cwceq @ (XM @ Xx3 @ Xy1 @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwa @ (cwf1o @ XS @ XS @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwb @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwss @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1))))) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS))))))))))))))))).
