...
thf(almfval_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xu:$i] : (cwi @ (cwcel @ XJ @ (ccfv @ (XX @ Xu) @ cctopon)) @ (cwceq @ (ccfv @ XJ @ cclm) @ (ccopab @ (^ [Xf1:$i] : (^ [Xx3:$i] : (cw3a @ (cwcel @ (ccv @ Xf1) @ (cco @ (XX @ Xu) @ ccc @ ccpm)) @ (cwcel @ (ccv @ Xx3) @ (XX @ Xu)) @ (cwral @ (^ [Xu:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xu) @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz))))) @ (^ [Xu:$i] : XJ)))))))))))).
...
thf(clmbr_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwb @ (cwbr @ XF @ (XP @ Xy1) @ (ccfv @ XJ @ cclm)) @ (cw3a @ (cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) @ (cwcel @ (XP @ Xy1) @ XX) @ (cwral @ (^ [Xu:$i] : (cwi @ (cwcel @ (XP @ Xy1) @ (ccv @ Xu)) @ (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xu) @ (ccres @ XF @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz))))) @ (^ [Xu:$i] : XJ))))))))))))).
