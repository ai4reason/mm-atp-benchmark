...
thf(achjassi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ cchj) @ XC @ cchj) @ (cco @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cchj))))))))).
...
thf(afh3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) => ((cwbr @ XA2 @ XC @ cccm) => (cwceq @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ cchj) @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XA2 @ XC @ cchj)))))))))))).
...
thf(acmcm2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ XA2 @ (ccfv @ XB2 @ ccort) @ cccm))))))).
...
thf(achjjdiri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ cchj) @ XC @ cchj) @ (cco @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XC @ cchj) @ cchj))))))))).
...
thf(cmayetes3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => ((cwcel @ XF @ ccch) => ((cwcel @ XG @ ccch) => ((cwcel @ XR @ ccch) => ((cwss @ XA2 @ (ccfv @ XC @ ccort)) => ((cwss @ XA2 @ (ccfv @ XF @ ccort)) => ((cwss @ XC @ (ccfv @ XF @ ccort)) => ((cwss @ XA2 @ (ccfv @ XB2 @ ccort)) => ((cwss @ XC @ (ccfv @ XD @ ccort)) => ((cwss @ XF @ (ccfv @ XG @ ccort)) => ((cwss @ XR @ (ccfv @ XX @ ccort)) => ((cwceq @ XX @ (cco @ (cco @ XA2 @ XC @ cchj) @ XF @ cchj)) => ((cwceq @ XY @ (ccin @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XC @ XD @ cchj)) @ (cco @ XF @ XG @ cchj))) => ((cwceq @ XZ @ (cco @ (cco @ XB2 @ XD @ cchj) @ XG @ cchj)) => (cwss @ (ccin @ (cco @ XX @ XR @ cchj) @ XY) @ (cco @ XZ @ XR @ cchj)))))))))))))))))))))))))))))).
