...
thf(afunbrafv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwi @ (cwbr @ XA2 @ XB2 @ XF) @ (cwceq @ (ccafv @ XA2 @ XF) @ XB2))))))).
thf(cafvelima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwcel @ XA2 @ (ccima @ XF @ XB2))) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccafv @ (ccv @ Xx3) @ XF) @ XA2)) @ (^ [Xx3:$i] : XB2))))))).
