...
thf(aac7_thm,axiom,(! [Xx3:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwss @ (ccv @ Xf1) @ (ccv @ Xx3)) @ (cwfn @ (ccv @ Xf1) @ (ccdm @ (ccv @ Xx3)))))))).
thf(cac7g_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xf1:$i] : (cwi @ (cwcel @ XR @ (XA2 @ Xf1)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwss @ (ccv @ Xf1) @ XR) @ (cwfn @ (ccv @ Xf1) @ (ccdm @ XR)))))))))).
