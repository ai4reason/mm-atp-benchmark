...
thf(ccyggeninv_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XE @ Xx3 @ Xn) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_x)))) @ XB2)) @ (^ [Xx3:$i] : XB2))))) => ((cwceq @ XN @ (ccfv @ XG @ ccminusg)) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ (XE @ Xx3 @ Xn))) @ (cwcel @ (ccfv @ XX @ XN) @ (XE @ Xx3 @ Xn)))))))))))))))).
