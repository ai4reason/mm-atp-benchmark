...
thf(ctxrest_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY))) @ (cwceq @ (cco @ (cco @ XR @ XS @ cctx) @ (ccxp @ XA2 @ XB2) @ ccrest) @ (cco @ (cco @ XR @ XA2 @ ccrest) @ (cco @ XS @ XB2 @ ccrest) @ cctx)))))))))))).
