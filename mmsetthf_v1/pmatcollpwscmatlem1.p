...
thf(cpmatcollpwscmatlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_as @ (ccfv @ XC @ ccvsca)) => ((cwceq @ Xc_ex @ (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XD @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XU @ (ccfv @ XP @ ccascl)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XE @ (ccfv @ XP @ ccbs)) => ((cwceq @ XS @ (ccfv @ XP @ ccascl)) => ((cwceq @ Xc_1 @ (ccfv @ XC @ ccur)) => ((cwceq @ XM @ (cco @ XQ @ Xc_1 @ Xc_as)) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwa @ (cwcel @ XL @ ccn0) @ (cwcel @ XQ @ XE))) @ (cwa @ (cwcel @ (ccv @ Xa) @ XN) @ (cwcel @ (ccv @ Xb) @ XN))) @ (cwceq @ (cco @ (ccfv @ XL @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XM) @ ccco1)) @ (cco @ ccc0 @ (ccfv @ XR @ ccv1) @ (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) @ (ccfv @ XP @ ccvsca)) @ (ccif @ (cwceq @ (ccv @ Xa) @ (ccv @ Xb)) @ (ccfv @ (ccfv @ XL @ (ccfv @ XQ @ ccco1)) @ XU) @ (ccfv @ XP @ cc0g))))))))))))))))))))))))))))))))))))))))).
