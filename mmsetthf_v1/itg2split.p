...
thf(aitg2splitlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ ccvol))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ ccvol))) => ((cwi @ Xph @ (cwceq @ (ccfv @ (ccin @ XA2 @ XB2) @ ccovol) @ ccc0)) => ((cwi @ Xph @ (cwceq @ XU @ (ccun @ XA2 @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XU)) @ (cwcel @ (XC @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (XC @ Xx3) @ ccc0))))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XB2) @ (XC @ Xx3) @ ccc0))))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XU) @ (XC @ Xx3) @ ccc0))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XF @ Xx3) @ ccitg2) @ ccr))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XG @ Xx3) @ ccitg2) @ ccr))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XH @ Xx3) @ ccitg2) @ (cco @ (ccfv @ (XF @ Xx3) @ ccitg2) @ (ccfv @ (XG @ Xx3) @ ccitg2) @ ccaddc) @ ccle)))))))))))))))))))))).
