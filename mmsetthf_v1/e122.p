...
thf(ce122_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwvd1 @ Xph @ Xps) => ((cwvd2 @ Xph @ Xch @ Xth) => ((cwvd2 @ Xph @ Xch @ Xta) => ((cwi @ Xps @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwvd2 @ Xph @ Xch @ Xet)))))))))))).
