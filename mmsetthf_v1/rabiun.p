...
thf(crabiun_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (cwceq @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XA2 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))))) @ (cciun @ (^ [Xy1:$i] : (XA2 @ Xy1)) @ (^ [Xy1:$i] : (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))))))))).
