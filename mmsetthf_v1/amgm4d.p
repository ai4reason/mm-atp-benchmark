...
thf(agsumws4_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ ccmnd) @ (cwa @ (cwcel @ XS @ XB2) @ (cwa @ (cwcel @ XT @ XB2) @ (cwa @ (cwcel @ XU @ XB2) @ (cwcel @ XV @ XB2))))) @ (cwceq @ (cco @ XG @ (ccs4 @ XS @ XT @ XU @ XV) @ ccgsu) @ (cco @ XS @ (cco @ XT @ (cco @ XU @ XV @ Xc_pl) @ Xc_pl) @ Xc_pl))))))))))))).
...
thf(camgm4d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwcel @ XD @ ccrp)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ XA2 @ (cco @ XB2 @ (cco @ XC @ XD @ ccmul) @ ccmul) @ ccmul) @ (cco @ cc1 @ cc4 @ ccdiv) @ cccxp) @ (cco @ (cco @ XA2 @ (cco @ XB2 @ (cco @ XC @ XD @ ccaddc) @ ccaddc) @ ccaddc) @ cc4 @ ccdiv) @ ccle)))))))))))).
