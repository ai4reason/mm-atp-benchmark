...
thf(aprodfzo03_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ ccc0) @ (cwceq @ (XD @ Xk) @ XA2))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ cc1) @ (cwceq @ (XD @ Xk) @ XB2))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ cc2) @ (cwceq @ (XD @ Xk) @ XC))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ cc3 @ ccfzo))) @ (cwcel @ (XD @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ cc3 @ ccfzo)) @ (^ [Xk:$i] : (XD @ Xk))) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccmul))))))))))))).
...
thf(ccirclevma_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ ccn @ XN @ (ccfv @ cc3 @ ccrepr)) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xn)) @ ccvma) @ (cco @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xn)) @ ccvma) @ (ccfv @ (ccfv @ cc2 @ (ccv @ Xn)) @ ccvma) @ ccmul) @ ccmul))) @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (cco @ ccvma @ XN @ ccvts)) @ cc3 @ ccexp) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccneg @ XN) @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce) @ ccmul))))))))).
