...
thf(amrissmrcd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((cwceq @ XN @ (ccfv @ XA2 @ ccmrc)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccmri)) => ((cwi @ Xph @ (cwss @ XS @ (ccfv @ XT @ XN))) => ((cwi @ Xph @ (cwss @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XS @ XI)) => (cwi @ Xph @ (cwceq @ XS @ XT)))))))))))))))).
...
thf(cmreexexlem3d_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwcel @ (XA2 @ Xy1 @ Xz @ Xi @ Xs1) @ (ccfv @ (XX @ Xy1 @ Xz @ Xi @ Xs1) @ ccmre))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwceq @ (XN @ Xy1 @ Xz @ Xi @ Xs1) @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xi @ Xs1) @ ccmrc)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwceq @ (XI @ Xy1 @ Xz @ Xs1) @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xi @ Xs1) @ ccmri)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xz))) @ (XN @ Xy1 @ Xz @ Xi @ Xs1)))) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xy1))) @ (XN @ Xy1 @ Xz @ Xi @ Xs1)) @ (ccfv @ (ccv @ Xs1) @ (XN @ Xy1 @ Xz @ Xi @ Xs1)))))) @ (^ [Xy1:$i] : (XX @ Xy1 @ Xz @ Xi @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ (XX @ Xy1 @ Xz @ Xi @ Xs1))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwss @ (XF @ Xy1 @ Xz @ Xs1) @ (ccdif @ (XX @ Xy1 @ Xz @ Xi @ Xs1) @ (XH @ Xy1 @ Xz @ Xs1)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwss @ (XG @ Xy1 @ Xz @ Xs1) @ (ccdif @ (XX @ Xy1 @ Xz @ Xi @ Xs1) @ (XH @ Xy1 @ Xz @ Xs1)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwss @ (XF @ Xy1 @ Xz @ Xs1) @ (ccfv @ (ccun @ (XG @ Xy1 @ Xz @ Xs1) @ (XH @ Xy1 @ Xz @ Xs1)) @ (XN @ Xy1 @ Xz @ Xi @ Xs1)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwcel @ (ccun @ (XF @ Xy1 @ Xz @ Xs1) @ (XH @ Xy1 @ Xz @ Xs1)) @ (XI @ Xy1 @ Xz @ Xs1))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwo @ (cwceq @ (XF @ Xy1 @ Xz @ Xs1) @ cc0) @ (cwceq @ (XG @ Xy1 @ Xz @ Xs1) @ cc0))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xi @ Xs1) @ (cwrex @ (^ [Xi:$i] : (cwa @ (cwbr @ (XF @ Xy1 @ Xz @ Xs1) @ (ccv @ Xi) @ ccen) @ (cwcel @ (ccun @ (ccv @ Xi) @ (XH @ Xy1 @ Xz @ Xs1)) @ (XI @ Xy1 @ Xz @ Xs1)))) @ (^ [Xi:$i] : (ccpw @ (XG @ Xy1 @ Xz @ Xs1))))))))))))))))))))))))))).
