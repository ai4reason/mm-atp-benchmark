...
thf(cfmtnorec1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfmtno) @ (cco @ (cco @ (cco @ (ccfv @ XN @ ccfmtno) @ cc1 @ ccmin) @ cc2 @ ccexp) @ cc1 @ ccaddc))))).
