...
thf(amdslmd3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (cwi @ (cwa @ (cwa @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwbr @ (ccin @ XA2 @ XB2) @ XC @ ccmd)) @ (cwa @ (cwss @ (ccin @ XA2 @ XC) @ XD) @ (cwss @ XD @ XA2))) @ (cwbr @ XD @ (ccin @ XB2 @ XC) @ ccmd))))))))))).
thf(aadantl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xch @ Xph) @ Xps)))))).
thf(abiimpi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwb @ Xph @ Xps) => (cwi @ Xph @ Xps))))).
thf(asseqin2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccin @ XB2 @ XA2) @ XA2))))).
thf(cmdslmd4i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (cwi @ (cw3a @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwa @ (cwss @ (ccin @ XA2 @ XB2) @ XC) @ (cwss @ XC @ XA2)) @ (cwa @ (cwss @ (ccin @ XA2 @ XB2) @ XD) @ (cwss @ XD @ XB2))) @ (cwbr @ XC @ XD @ ccmd))))))))))).
