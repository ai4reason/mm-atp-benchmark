...
thf(ausgrnloop_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ cciedg))) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwi @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (XE @ Xx3)) @ (ccpr @ XM @ XN))) @ (^ [Xx3:$i] : (ccdm @ (XE @ Xx3)))) @ (cwne @ XM @ XN))))))))).
...
thf(cusgrnloop0ALT_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ cciedg))) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (XE @ Xx3)) @ (ccsn @ XU))) @ (^ [Xx3:$i] : (ccdm @ (XE @ Xx3)))) @ cc0))))))).
