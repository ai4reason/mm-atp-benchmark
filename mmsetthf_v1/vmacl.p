...
thf(aisppw2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwb @ (cwne @ (ccfv @ XA2 @ ccvma) @ ccc0) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xk:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp))) @ (^ [Xk:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))))).
...
thf(cvmacl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwcel @ (ccfv @ XA2 @ ccvma) @ ccr)))).
