...
thf(alimensuc_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwlim @ XA2)) @ (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen))))).
thf(cinfensuc_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwss @ ccom @ XA2)) @ (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen)))).
