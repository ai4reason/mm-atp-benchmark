...
thf(c_3dim1lem5_conj,conjecture,(! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [Xc_le:($i > $o)] : ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (cwceq @ Xc_or @ (ccfv @ (XK @ Xs1 @ Xr @ Xq) @ ccjn))))) => ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (cwceq @ Xc_le @ (ccfv @ (XK @ Xs1 @ Xr @ Xq) @ ccple))))) => ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xs1 @ Xr @ Xq) @ ccatm))))) => (cwi @ (cwa @ (cw3a @ (cwcel @ (ccv @ Xu) @ XA2) @ (cwcel @ (ccv @ Xv) @ XA2) @ (cwcel @ (ccv @ Xw) @ XA2)) @ (cw3a @ (cwne @ XP @ (ccv @ Xu)) @ (cwn @ (cwbr @ (ccv @ Xv) @ (cco @ XP @ (ccv @ Xu) @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ (ccv @ Xw) @ (cco @ (cco @ XP @ (ccv @ Xu) @ Xc_or) @ (ccv @ Xv) @ Xc_or) @ Xc_le)))) @ (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cw3a @ (cwne @ XP @ (ccv @ Xq)) @ (cwn @ (cwbr @ (ccv @ Xr) @ (cco @ XP @ (ccv @ Xq) @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ (ccv @ Xs1) @ (cco @ (cco @ XP @ (ccv @ Xq) @ Xc_or) @ (ccv @ Xr) @ Xc_or) @ Xc_le)))) @ (^ [Xs1:$i] : XA2))) @ (^ [Xr:$i] : XA2))) @ (^ [Xq:$i] : XA2))))))))))))))).
