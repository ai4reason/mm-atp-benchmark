...
thf(acmcmi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ XB2 @ XA2 @ cccm))))))).
thf(acmbr2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ XA2 @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XA2 @ (ccfv @ XB2 @ ccort) @ cchj))))))))).
...
thf(achabs2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwceq @ (ccin @ XA2 @ (cco @ XA2 @ XB2 @ cchj)) @ XA2)))))).
...
thf(apjoml2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwss @ XA2 @ XB2) @ (cwceq @ (cco @ XA2 @ (ccin @ (ccfv @ XA2 @ ccort) @ XB2) @ cchj) @ XB2))))))).
...
thf(achdmm3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwceq @ (ccfv @ (ccin @ XA2 @ (ccfv @ XB2 @ ccort)) @ ccort) @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj))))))).
thf(aincom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccin @ XA2 @ XB2) @ (ccin @ XB2 @ XA2))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aoveq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF)))))))).
thf(acmbri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ XA2 @ (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ (ccfv @ XB2 @ ccort)) @ cchj)))))))).
thf(ccmbr3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ (ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) @ (ccin @ XA2 @ XB2)))))))).
