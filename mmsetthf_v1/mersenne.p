...
thf(anprm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz))) @ (cwn @ (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ ccprime)))))).
...
thf(cmersenne_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccz) @ (cwcel @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccprime)) @ (cwcel @ XP @ ccprime)))).
