...
thf(cndmovass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ (ccdm @ XF) @ (ccxp @ XS @ XS)) => ((cwn @ (cwcel @ cc0 @ XS)) => (cwi @ (cwn @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XF) @ XC @ XF) @ (cco @ XA2 @ (cco @ XB2 @ XC @ XF) @ XF))))))))))).
