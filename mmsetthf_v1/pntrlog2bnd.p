...
thf(apntrmax_thm,axiom,(! [XR:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ ccabs) @ (ccv @ Xc) @ ccle)) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xc:$i] : ccrp)))))).
...
thf(apntrlog2bndlem6_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XR @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccif @ (cwcel @ (ccv @ Xa) @ ccrp) @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xa) @ cclog) @ ccmul) @ ccc0)))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwcel @ (XB2 @ Xi @ Xa) @ ccrp))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ (XR @ Xi @ Xa)) @ (ccv @ Xy1) @ ccdiv) @ ccabs) @ (XB2 @ Xi @ Xa) @ ccle)) @ (^ [Xy1:$i] : ccrp)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwcel @ XA2 @ ccr))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwbr @ cc1 @ XA2 @ ccle))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul))) @ ccmul) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cclo1))))))))))))))))))).
...
thf(cpntrlog2bnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ ccle)) @ (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (cco @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul))) @ ccmul) @ ccmin) @ (ccv @ Xx3) @ ccdiv) @ (ccv @ Xc) @ ccle)) @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)))) @ (^ [Xc:$i] : ccrp)))))))).
