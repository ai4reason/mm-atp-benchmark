...
thf(af1omvdcnv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf1o @ XA2 @ XA2 @ XF) @ (cwceq @ (ccdm @ (ccdif @ (cccnv @ XF) @ ccid)) @ (ccdm @ (ccdif @ XF @ ccid))))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xch))))).
thf(csymgsssg_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XG @ (ccfv @ (XD @ Xx3) @ ccsymg))) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (! [Xx3:$i] : (cwi @ (cwcel @ (XD @ Xx3) @ (XV @ Xx3)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccdm @ (ccdif @ (ccv @ Xx3) @ ccid)) @ XX)) @ (^ [Xx3:$i] : XB2)) @ (ccfv @ XG @ ccsubg)))))))))))).
