...
thf(corvcelval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprb)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccbrsiga)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XA2 @ (ccorvc @ ccep)) @ (ccima @ (cccnv @ XX) @ XA2))))))))))).
