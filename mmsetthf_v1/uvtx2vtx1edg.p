...
thf(anbgr2vtx1edg_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (cwceq @ (XE @ Xv) @ (ccfv @ XG @ ccedg))) => (! [Xv:$i] : (cwi @ (cwa @ (cwceq @ (ccfv @ XV @ cchash) @ cc2) @ (cwcel @ XV @ (XE @ Xv))) @ (cwral @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV)))))))))).
...
thf(cuvtx2vtx1edg_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwceq @ (ccfv @ XV @ cchash) @ cc2) @ (cwcel @ XV @ XE)) @ (cwral @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccfv @ XG @ ccuvtx))) @ (^ [Xv:$i] : XV))))))))).
