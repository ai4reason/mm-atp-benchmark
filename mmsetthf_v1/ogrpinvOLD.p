...
thf(cogrpinvOLD_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XG @ ccple)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XG @ ccogrp) @ (cwcel @ XX @ XB2) @ (cwbr @ Xc_0 @ XX @ Xc_le)) @ (cwbr @ (ccfv @ XX @ XI) @ Xc_0 @ Xc_le))))))))))))).
