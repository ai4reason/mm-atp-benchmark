...
thf(atz6_12i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwne @ XB2 @ cc0) @ (cwi @ (cwceq @ (ccfv @ XA2 @ XF) @ XB2) @ (cwbr @ XA2 @ XB2 @ XF))))))).
...
thf(aax_dc_ax,axiom,(! [Xx3:$i] : (cwi @ (cwa @ (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xx3)))))) @ (cwss @ (ccrn @ (ccv @ Xx3)) @ (ccdm @ (ccv @ Xx3)))) @ (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (ccfv @ (ccsuc @ (ccv @ Xn)) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xn:$i] : ccom))))))).
