...
thf(apfxccatin12lem1_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) @ (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) @ (cwn @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) @ (cwcel @ (cco @ XK @ (cco @ XL @ XM @ ccmin) @ ccmin) @ (cco @ ccc0 @ (cco @ XN @ XL @ ccmin) @ ccfzo)))))))))).
