...
thf(adffun3f_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwnfc @ (^ [Xz:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwfun @ (XA2 @ Xx3 @ Xy1 @ Xz)) @ (cwa @ (cwrel @ (XA2 @ Xx3 @ Xy1 @ Xz)) @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XA2 @ Xx3 @ Xy1 @ Xz)) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz))))))))))))))))))).
...
thf(csetrec2lem2_conj,conjecture,(! [XF:($i > $o)] : (cwfun @ (ccres @ XF @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))))))))).
