...
thf(cdvdsmod_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XP @ ccn) @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccz)) @ (cwbr @ XP @ XN @ ccdvds)) @ (cwb @ (cwbr @ XP @ (cco @ XK @ XN @ ccmo) @ ccdvds) @ (cwbr @ XP @ XK @ ccdvds))))))).
