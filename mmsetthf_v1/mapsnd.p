...
thf(afneu_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwfn @ XF @ (XA2 @ Xy1)) @ (cwcel @ XB2 @ (XA2 @ Xy1))) @ (cweu @ (^ [Xy1:$i] : (cwbr @ XB2 @ (ccv @ Xy1) @ XF))))))))).
...
thf(cmapsnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xy1 @ Xf1))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XW @ Xy1 @ Xf1))))) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (ccsn @ XB2) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xf1) @ (ccsn @ (ccop @ XB2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XA2)))))))))))))).
