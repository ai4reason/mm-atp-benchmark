...
thf(ctrkgdist_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XU) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ (ccop @ (ccfv @ ccnx @ ccitv) @ XI))) => (cwi @ (cwcel @ XD @ XV) @ (cwceq @ XD @ (ccfv @ XW @ ccds)))))))))).
