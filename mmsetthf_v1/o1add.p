...
thf(ao1of2_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xm) @ ccr) @ (cwcel @ (ccv @ Xn) @ ccr)) @ (cwcel @ (XM @ Xm @ Xn) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ ccc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xm) @ ccr) @ (cwcel @ (ccv @ Xn) @ ccr)) @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc))) @ (cwi @ (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ (ccv @ Xm) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xy1) @ ccabs) @ (ccv @ Xn) @ ccle)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ ccabs) @ (XM @ Xm @ Xn) @ ccle))))))) => (cwi @ (cwa @ (cwcel @ XF @ cco1) @ (cwcel @ XG @ cco1)) @ (cwcel @ (cco @ XF @ XG @ (ccof @ XR)) @ cco1)))))))))).
...
thf(co1add_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ cco1) @ (cwcel @ XG @ cco1)) @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ cco1))))).
