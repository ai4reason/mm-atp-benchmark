...
thf(acphipval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ cccph) @ (cwcel @ cci @ XK)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_xi) @ (cco @ (cco @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_mi) @ XN) @ cc2 @ ccexp) @ ccmin) @ (cco @ cci @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ Xc_x) @ Xc_pl) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ Xc_x) @ Xc_mi) @ XN) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ ccaddc) @ cc4 @ ccdiv))))))))))))))))))))))).
...
thf(aaddneg1mul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccmin)))))).
...
thf(aclmvsubval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => (cwi @ (cw3a @ (cwcel @ XW @ ccclm) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_mi) @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ Xc_x) @ Xc_pl))))))))))))))))).
thf(aeqtr4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XB2)) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(aclmvsneg_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XW @ ccminusg)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwi @ Xph @ (cwcel @ XW @ ccclm)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XR @ XK)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XR @ XX @ Xc_x) @ XN) @ (cco @ (ccneg @ XR) @ XX @ Xc_x))))))))))))))))))))).
...
thf(ai4_thm,axiom,(cwceq @ (cco @ cci @ cc4 @ ccexp) @ cc1)).
...
thf(acmodscexp_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cwa @ (cwa @ (cwcel @ XW @ ccclm) @ (cwcel @ cci @ XK)) @ (cwcel @ XN @ ccn)) @ (cwcel @ (cco @ cci @ XN @ ccexp) @ XK))))))))).
...
thf(asubdir2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ ccmul) @ (cco @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccmin))))))))))).
...
thf(ccphipval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_xi:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((! [Xk:$i] : (cwceq @ (Xc_xi @ Xk) @ (ccfv @ XW @ ccip))) => ((! [Xk:$i] : (cwceq @ (XF @ Xk) @ (ccfv @ XW @ ccsca))) => ((! [Xk:$i] : (cwceq @ XK @ (ccfv @ (XF @ Xk) @ ccbs))) => (! [Xk:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ cccph) @ (cwcel @ cci @ XK)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ XA2 @ XB2 @ (Xc_xi @ Xk)) @ (cco @ (ccsu @ (cco @ cc1 @ cc4 @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ XB2 @ Xc_x) @ Xc_pl) @ XN) @ cc2 @ ccexp) @ ccmul))) @ cc4 @ ccdiv)))))))))))))))))))))).
