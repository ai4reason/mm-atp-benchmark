...
thf(cocvlsp_conj,conjecture,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwss @ XS @ XV)) @ (cwceq @ (ccfv @ (ccfv @ XS @ XN) @ Xc_pe) @ (ccfv @ XS @ Xc_pe)))))))))))).
