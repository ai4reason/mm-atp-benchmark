...
thf(aavgle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwo @ (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ XA2 @ ccle) @ (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ XB2 @ ccle)))))).
thf(cfacavg_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwbr @ (ccfv @ (ccfv @ (cco @ (cco @ XM @ XN @ ccaddc) @ cc2 @ ccdiv) @ ccfl) @ ccfa) @ (cco @ (ccfv @ XM @ ccfa) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
