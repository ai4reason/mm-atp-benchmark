...
thf(amadeval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ ccmade) @ (ccima @ ccscut @ (ccxp @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))) @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))))))))).
...
thf(ascutcut_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cw3a @ (cwcel @ (cco @ XA2 @ XB2 @ ccscut) @ ccsur) @ (cwbr @ XA2 @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ ccsslt) @ (cwbr @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ XB2 @ ccsslt)))))).
...
thf(aimaindm_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwceq @ (ccima @ XR @ XA2) @ (ccima @ XR @ (ccin @ XA2 @ (ccdm @ XR))))))).
...
thf(admscut_thm,axiom,(cwceq @ (ccdm @ ccscut) @ ccsslt)).
...
thf(ascutf_thm,axiom,(cwf @ ccsslt @ ccsur @ ccscut)).
thf(affn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwfn @ XF @ XA2)))))).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(afnbrfvb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ XA2)) @ (cwb @ (cwceq @ (ccfv @ XB2 @ XF) @ XC) @ (cwbr @ XB2 @ XC @ XF)))))))).
...
thf(cmadeval2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ ccmade) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ ccsslt) @ (cwceq @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccscut) @ (ccv @ Xx3)))) @ (^ [Xb:$i] : (ccpw @ (ccuni @ (ccima @ ccmade @ XA2)))))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccima @ ccmade @ XA2)))))) @ (^ [Xx3:$i] : ccsur)))))).
