...
thf(axmetrtri2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ ccxrs @ ccds)) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwbr @ (cco @ (cco @ XA2 @ XC @ XD) @ (cco @ XB2 @ XC @ XD) @ XK) @ (cco @ XA2 @ XB2 @ XD) @ ccle)))))))))).
...
thf(axmettri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwbr @ (cco @ XA2 @ XB2 @ XD) @ (cco @ (cco @ XA2 @ XC @ XD) @ (cco @ XC @ XB2 @ XD) @ ccxad) @ ccle)))))))).
...
thf(cmetdcnlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XC @ (ccfv @ ccxrs @ ccds)) => ((cwceq @ XK @ (ccfv @ XC @ ccmopn)) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XB2 @ XX)) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((cwi @ Xph @ (cwcel @ XZ @ XX)) => ((cwi @ Xph @ (cwbr @ (cco @ XA2 @ XY @ XD) @ (cco @ XR @ cc2 @ ccdiv) @ cclt)) => ((cwi @ Xph @ (cwbr @ (cco @ XB2 @ XZ @ XD) @ (cco @ XR @ cc2 @ ccdiv) @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ XA2 @ XB2 @ XD) @ (cco @ XY @ XZ @ XD) @ XC) @ XR @ cclt))))))))))))))))))))))))).
