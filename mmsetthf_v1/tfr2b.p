...
thf(atfrlem15_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1 @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0)))))))) => (cwi @ (cwcel @ XB2 @ ccon0) @ (cwb @ (cwcel @ XB2 @ (ccdm @ (ccrecs @ XF))) @ (cwcel @ (ccres @ (ccrecs @ XF) @ XB2) @ ccvv)))))))).
...
thf(ctfr2b_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (ccrecs @ XG)) => (cwi @ (cword @ XA2) @ (cwb @ (cwcel @ XA2 @ (ccdm @ XF)) @ (cwcel @ (ccres @ XF @ XA2) @ ccvv)))))))).
