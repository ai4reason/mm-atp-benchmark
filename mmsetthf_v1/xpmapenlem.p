...
thf(aen3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwcel @ (XD @ Xy1) @ XA2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwb @ (cwceq @ (ccv @ Xx3) @ (XD @ Xy1)) @ (cwceq @ (ccv @ Xy1) @ (XC @ Xx3)))))) => (cwbr @ XA2 @ XB2 @ ccen))))))))))).
...
thf(cxpmapenlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ cc1st))))) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ cc2nd))))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (ccop @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))) => (cwbr @ (cco @ (ccxp @ XA2 @ XB2) @ XC @ ccmap) @ (ccxp @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap)) @ ccen)))))))))))))).
