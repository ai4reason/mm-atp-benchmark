...
thf(abrwdom3i_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwbr @ XX @ XY @ ccwdom) @ (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX)))))))).
...
thf(cxpwdomg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccwdom) @ (cwbr @ XC @ XD @ ccwdom)) @ (cwbr @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XD) @ ccwdom))))))).
