...
thf(acoseq00topi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccos) @ ccc0) @ (cwceq @ XA2 @ (cco @ ccpi @ cc2 @ ccdiv)))))).
...
thf(ccoseq0negpitopi_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccos) @ ccc0) @ (cwcel @ XA2 @ (ccpr @ (cco @ ccpi @ cc2 @ ccdiv) @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)))))))).
