...
thf(af1oresrab_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf1o @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (XC @ Xx3))) @ (cwb @ (Xch @ Xy1) @ (Xps @ Xx3))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf1o @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XB2)) @ (ccres @ (XF @ Xx3 @ Xy1) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(cwfo_tp,type,(cwfo : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aclwwlkf1o_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XD @ Xw) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cclsw) @ (ccfv @ ccc0 @ (ccv @ Xw)))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => ((! [Xw:$i] : (! [Xt:$i] : (cwceq @ (XF @ Xw @ Xt) @ (ccmpt @ (^ [Xt:$i] : (XD @ Xw)) @ (^ [Xt:$i] : (cco @ (ccv @ Xt) @ (ccop @ ccc0 @ XN) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xt:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwf1o @ (XD @ Xw) @ (cco @ XN @ XG @ ccclwwlkn) @ (XF @ Xw @ Xt)))))))))))).
...
thf(cclwwlkvbijOLD_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwex @ (^ [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xw) @ cclsw) @ (ccfv @ ccc0 @ (ccv @ Xw))) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XS))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XS)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn))) @ (ccv @ Xf1))))))))).
