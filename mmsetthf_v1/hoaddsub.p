...
thf(choaddsub_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cw3a @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) @ (cwceq @ (cco @ (cco @ XS @ XT @ cchos) @ XU @ cchod) @ (cco @ (cco @ XS @ XU @ cchod) @ XT @ cchos))))))).
