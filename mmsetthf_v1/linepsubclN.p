...
thf(clinepsubclN_conj,conjecture,(! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XK @ cclines)) => ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN)) @ (cwcel @ XX @ XC))))))))).
