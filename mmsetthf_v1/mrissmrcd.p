...
thf(apssne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwpss @ XA2 @ XB2) @ (cwne @ XA2 @ XB2))))).
...
thf(amrieqv2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xs1) @ (ccfv @ (XX @ Xs1) @ ccmre)))) => ((! [Xs1:$i] : (cwceq @ XN @ (ccfv @ (XA2 @ Xs1) @ ccmrc))) => ((! [Xs1:$i] : (cwceq @ XI @ (ccfv @ (XA2 @ Xs1) @ ccmri))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwss @ XS @ (XX @ Xs1)))) => (cwi @ Xph @ (cwb @ (cwcel @ XS @ XI) @ (cwal @ (^ [Xs1:$i] : (cwi @ (cwpss @ (ccv @ Xs1) @ XS) @ (cwpss @ (ccfv @ (ccv @ Xs1) @ XN) @ (ccfv @ XS @ XN)))))))))))))))))).
...
thf(aspcdv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwb @ (Xps @ Xx3) @ Xch))) => (cwi @ Xph @ (cwi @ (cwal @ (^ [Xx3:$i] : (Xps @ Xx3))) @ Xch)))))))))).
...
thf(cmrissmrcd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((cwceq @ XN @ (ccfv @ XA2 @ ccmrc)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccmri)) => ((cwi @ Xph @ (cwss @ XS @ (ccfv @ XT @ XN))) => ((cwi @ Xph @ (cwss @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XS @ XI)) => (cwi @ Xph @ (cwceq @ XS @ XT)))))))))))))))).
