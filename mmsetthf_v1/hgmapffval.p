...
thf(adf_hgmap_ax,axiom,(cwceq @ cchg @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccab @ (^ [Xa:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xm:$i] : (cwcel @ (ccv @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xb)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccfv @ (ccv @ Xu) @ ccvsca)) @ (ccv @ Xm)) @ (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xm)) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cclcd)) @ ccvsca)))) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xu) @ ccbs)))) @ (^ [Xy1:$i] : (ccv @ Xb))))))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cchdma)))) @ (ccfv @ (ccfv @ (ccv @ Xu) @ ccsca) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh))))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(chgmapffval_conj,conjecture,(! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XH @ Xx3 @ Xy1 @ Xv @ Xu @ Xm @ Xa @ Xb) @ (ccfv @ XK @ cclh))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwcel @ XK @ (XX @ Xx3 @ Xy1 @ Xw @ Xv @ Xu @ Xm @ Xa @ Xb)) @ (cwceq @ (ccfv @ XK @ cchg) @ (ccmpt @ (^ [Xw:$i] : (XH @ Xx3 @ Xy1 @ Xv @ Xu @ Xm @ Xa @ Xb)) @ (^ [Xw:$i] : (ccab @ (^ [Xa:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xm:$i] : (cwcel @ (ccv @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xb)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccfv @ (ccv @ Xu) @ ccvsca)) @ (ccv @ Xm)) @ (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xm)) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cclcd)) @ ccvsca)))) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xu) @ ccbs)))) @ (^ [Xy1:$i] : (ccv @ Xb))))))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cchdma)))) @ (ccfv @ (ccfv @ (ccv @ Xu) @ ccsca) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)))))))))))))))))))))).
