...
thf(army1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (cco @ XA2 @ cc1 @ ccrmy) @ cc1)))).
...
thf(alermy_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ ccle) @ (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccle))))))).
...
thf(armyluc2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmy) @ ccmin)))))).
thf(cjm2_17a_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwbr @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ cc1 @ ccmin) @ XN @ ccexp) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ ccle))))).
