...
thf(aodd2np1lem_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwo @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ XN)) @ (^ [Xn:$i] : ccz)) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (cco @ (ccv @ Xk) @ cc2 @ ccmul) @ XN)) @ (^ [Xk:$i] : ccz)))))).
...
thf(codd2np1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ XN)) @ (^ [Xn:$i] : ccz)))))).
