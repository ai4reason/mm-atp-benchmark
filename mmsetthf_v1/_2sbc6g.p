...
thf(asbc6_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XA2) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3))))))))).
...
thf(c_2sbc6g_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XC @ Xz @ Xw)) @ (cwcel @ XB2 @ (XD @ Xz @ Xw))) @ (cwb @ (cwal @ (^ [Xz:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xz) @ XA2) @ (cwceq @ (ccv @ Xw) @ XB2)) @ (Xph @ Xz @ Xw)))))) @ (cwsbc @ (^ [Xz:$i] : (cwsbc @ (^ [Xw:$i] : (Xph @ Xz @ Xw)) @ XB2)) @ XA2))))))))))).
