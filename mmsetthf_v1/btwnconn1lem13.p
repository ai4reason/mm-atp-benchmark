...
thf(abtwnconn1lem12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (cwa @ (cw3a @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cwa @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ (ccv @ Xc) @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ (ccv @ Xd) @ (ccfv @ XN @ ccee)) @ (cwcel @ (ccv @ Xb) @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee)))) @ (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XQ @ (ccfv @ XN @ ccee)) @ (cwcel @ XR @ (ccfv @ XN @ ccee)))) @ (cwa @ (cw3a @ (cwa @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XB2 @ XC) @ (cwne @ XC @ (ccv @ Xc))) @ (cwa @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn))) @ (cwa @ (cwa @ (cwbr @ XD @ (ccop @ XA2 @ (ccv @ Xc)) @ ccbtwn) @ (cwbr @ (ccop @ XD @ (ccv @ Xc)) @ (ccop @ XC @ XD) @ cccgr)) @ (cwa @ (cwbr @ XC @ (ccop @ XA2 @ (ccv @ Xd)) @ ccbtwn) @ (cwbr @ (ccop @ XC @ (ccv @ Xd)) @ (ccop @ XC @ XD) @ cccgr))) @ (cwa @ (cwa @ (cwbr @ (ccv @ Xc) @ (ccop @ XA2 @ (ccv @ Xb)) @ ccbtwn) @ (cwbr @ (ccop @ (ccv @ Xc) @ (ccv @ Xb)) @ (ccop @ XC @ XB2) @ cccgr)) @ (cwa @ (cwbr @ (ccv @ Xd) @ (ccop @ XA2 @ (ccv @ Xb)) @ ccbtwn) @ (cwbr @ (ccop @ (ccv @ Xd) @ (ccv @ Xb)) @ (ccop @ XD @ XB2) @ cccgr)))) @ (cwa @ (cwa @ (cwbr @ XE @ (ccop @ XC @ (ccv @ Xc)) @ ccbtwn) @ (cwbr @ XE @ (ccop @ XD @ (ccv @ Xd)) @ ccbtwn)) @ (cw3a @ (cwa @ (cwbr @ XC @ (ccop @ (ccv @ Xc) @ XP) @ ccbtwn) @ (cwbr @ (ccop @ XC @ XP) @ (ccop @ XC @ (ccv @ Xd)) @ cccgr)) @ (cwa @ (cwbr @ XC @ (ccop @ (ccv @ Xd) @ XR) @ ccbtwn) @ (cwbr @ (ccop @ XC @ XR) @ (ccop @ XC @ XE) @ cccgr)) @ (cwa @ (cwbr @ XR @ (ccop @ XP @ XQ) @ ccbtwn) @ (cwbr @ (ccop @ XR @ XQ) @ (ccop @ XR @ XP) @ cccgr)))))) @ (cwceq @ XD @ (ccv @ Xd)))))))))))))))).
thf(cbtwnconn1lem13_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (cwa @ (cwa @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cwa @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ (ccv @ Xc) @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ (ccv @ Xd) @ (ccfv @ XN @ ccee)) @ (cwcel @ (ccv @ Xb) @ (ccfv @ XN @ ccee))))) @ (cw3a @ (cwa @ (cwa @ (cwne @ XA2 @ XB2) @ (cwne @ XB2 @ XC)) @ (cwa @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn))) @ (cwa @ (cwa @ (cwbr @ XD @ (ccop @ XA2 @ (ccv @ Xc)) @ ccbtwn) @ (cwbr @ (ccop @ XD @ (ccv @ Xc)) @ (ccop @ XC @ XD) @ cccgr)) @ (cwa @ (cwbr @ XC @ (ccop @ XA2 @ (ccv @ Xd)) @ ccbtwn) @ (cwbr @ (ccop @ XC @ (ccv @ Xd)) @ (ccop @ XC @ XD) @ cccgr))) @ (cwa @ (cwa @ (cwbr @ (ccv @ Xc) @ (ccop @ XA2 @ (ccv @ Xb)) @ ccbtwn) @ (cwbr @ (ccop @ (ccv @ Xc) @ (ccv @ Xb)) @ (ccop @ XC @ XB2) @ cccgr)) @ (cwa @ (cwbr @ (ccv @ Xd) @ (ccop @ XA2 @ (ccv @ Xb)) @ ccbtwn) @ (cwbr @ (ccop @ (ccv @ Xd) @ (ccv @ Xb)) @ (ccop @ XD @ XB2) @ cccgr))))) @ (cwo @ (cwceq @ XC @ (ccv @ Xc)) @ (cwceq @ XD @ (ccv @ Xd))))))))))))).
