...
thf(aftc1lem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XG @ Xx3 @ Xt) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ ccibl)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ XC @ (cco @ (XK @ Xx3 @ Xy1 @ Xz @ Xt) @ (XL @ Xt) @ cccnp)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwceq @ (XJ @ Xx3 @ Xy1 @ Xz @ Xt) @ (cco @ (XL @ Xt) @ ccr @ ccrest)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwceq @ (XK @ Xx3 @ Xy1 @ Xz @ Xt) @ (cco @ (XL @ Xt) @ XD @ ccrest)))))) => ((! [Xt:$i] : (cwceq @ (XL @ Xt) @ (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwceq @ (XH @ Xx3 @ Xz @ Xt) @ (ccmpt @ (^ [Xz:$i] : (ccdif @ (cco @ XA2 @ XB2 @ ccicc) @ (ccsn @ XC))) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xz) @ (XG @ Xx3 @ Xt)) @ (ccfv @ XC @ (XG @ Xx3 @ Xt)) @ ccmin) @ (cco @ (ccv @ Xz) @ XC @ ccmin) @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XE @ Xx3 @ Xz) @ ccrp)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3 @ Xz @ Xt) @ ccrp))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XD)) @ (cwi @ (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XC @ ccmin) @ ccabs) @ (XR @ Xx3 @ Xz @ Xt) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XC @ XF) @ ccmin) @ ccabs) @ (XE @ Xx3 @ Xz) @ cclt))))))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xy1) @ (cco @ XA2 @ XB2 @ ccicc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (XX @ Xy1) @ XC @ ccmin) @ ccabs) @ (XR @ Xx3 @ Xz @ Xt) @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ (cwa @ Xph @ (cwne @ (XX @ Xy1) @ XC)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (XX @ Xy1) @ (XH @ Xx3 @ Xz @ Xt)) @ (ccfv @ XC @ XF) @ ccmin) @ ccabs) @ (XE @ Xx3 @ Xz) @ cclt))))))))))))))))))))))))))))))))))))))).
...
thf(cftc1lem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XG @ Xx3 @ Xt) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ ccibl)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ XC @ (cco @ (XK @ Xx3 @ Xz @ Xt) @ (XL @ Xt) @ cccnp))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwceq @ (XJ @ Xx3 @ Xz @ Xt) @ (cco @ (XL @ Xt) @ ccr @ ccrest))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwceq @ (XK @ Xx3 @ Xz @ Xt) @ (cco @ (XL @ Xt) @ XD @ ccrest))))) => ((! [Xt:$i] : (cwceq @ (XL @ Xt) @ (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwceq @ (XH @ Xx3 @ Xz @ Xt) @ (ccmpt @ (^ [Xz:$i] : (ccdif @ (cco @ XA2 @ XB2 @ ccicc) @ (ccsn @ XC))) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xz) @ (XG @ Xx3 @ Xt)) @ (ccfv @ XC @ (XG @ Xx3 @ Xt)) @ ccmin) @ (cco @ (ccv @ Xz) @ XC @ ccmin) @ ccdiv))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ XC @ XF) @ (cco @ (XH @ Xx3 @ Xz @ Xt) @ XC @ cclimc))))))))))))))))))))))))))))))).
