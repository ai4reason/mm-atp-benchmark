...
thf(amuval2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwne @ (ccfv @ XA2 @ ccmu) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ ccmu) @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ cchash) @ ccexp))))).
...
thf(adifrab_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwceq @ (ccdif @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (cwn @ (Xps @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(asqff1o_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwne @ (ccfv @ (ccv @ Xx3) @ ccmu) @ ccc0) @ (cwbr @ (ccv @ Xx3) @ XN @ ccdvds))) @ (^ [Xx3:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xx3 @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : (XS @ Xx3)) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xp:$i] : ccprime)))))))) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccpc)))))) => (! [Xx3:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwf1o @ (XS @ Xx3) @ (ccpw @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XN @ ccdvds)) @ (^ [Xp:$i] : ccprime))) @ (XF @ Xx3 @ Xn @ Xp)))))))))))))).
...
thf(abinom1p_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ XN @ ccexp) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))))).
...
thf(aexprmfct_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XN @ ccdvds)) @ (^ [Xp:$i] : ccprime))))).
...
thf(cmusum_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccsu @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ ccmu))) @ (ccif @ (cwceq @ XN @ cc1) @ cc1 @ ccc0))))).
