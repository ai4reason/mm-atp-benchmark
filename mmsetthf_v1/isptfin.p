...
thf(adf_ptfin_ax,axiom,(cwceq @ ccptfin @ (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccrab @ (^ [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xz))) @ (^ [Xz:$i] : (ccv @ Xx3))) @ ccfn)) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xx3)))))))).
thf(cisptfin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XX @ Xy1) @ (ccuni @ XA2))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XB2 @ Xx3 @ Xy1)) @ (cwb @ (cwcel @ XA2 @ ccptfin) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2)) @ ccfn)) @ (^ [Xx3:$i] : (XX @ Xy1)))))))))))).
