...
thf(aupgrspthswlk_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccupgr) @ (cwceq @ (ccfv @ XG @ ccspths) @ (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ (cwfun @ (cccnv @ (ccv @ Xp))))))))))).
...
thf(cupgrwlkdvspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwfun @ (cccnv @ XP))) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))).
