...
thf(cdfimafnf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwfun @ (XF @ Xx3)) @ (cwss @ (XA2 @ Xx3) @ (ccdm @ (XF @ Xx3)))) @ (cwceq @ (ccima @ (XF @ Xx3) @ (XA2 @ Xx3)) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))))).
