...
thf(afundmen_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwfun @ XF) @ (cwbr @ (ccdm @ XF) @ XF @ ccen))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(cfundmeng_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwfun @ XF)) @ (cwbr @ (ccdm @ XF) @ XF @ ccen))))).
