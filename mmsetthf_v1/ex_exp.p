...
thf(asq4e2t8_thm,axiom,(cwceq @ (cco @ cc4 @ cc2 @ ccexp) @ (cco @ cc2 @ cc8 @ ccmul))).
...
thf(cex_exp_conj,conjecture,(cwa @ (cwceq @ (cco @ cc5 @ cc2 @ ccexp) @ (ccdc @ cc2 @ cc5)) @ (cwceq @ (cco @ (ccneg @ cc3) @ (ccneg @ cc2) @ ccexp) @ (cco @ cc1 @ cc9 @ ccdiv)))).
