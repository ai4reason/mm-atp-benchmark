...
thf(adf_gbe_ax,axiom,(cwceq @ ccgbe @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwcel @ (ccv @ Xp) @ ccodd) @ (cwcel @ (ccv @ Xq) @ ccodd) @ (cwceq @ (ccv @ Xz) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc)))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))) @ (^ [Xz:$i] : cceven)))).
thf(cisgbe_conj,conjecture,(! [XZ:($i > $o)] : (cwb @ (cwcel @ XZ @ ccgbe) @ (cwa @ (cwcel @ XZ @ cceven) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwcel @ (ccv @ Xp) @ ccodd) @ (cwcel @ (ccv @ Xq) @ ccodd) @ (cwceq @ XZ @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc)))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))))).
