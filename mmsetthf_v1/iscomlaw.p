...
thf(adf_comlaw_ax,axiom,(cwceq @ cccomlaw @ (ccopab @ (^ [Xo:$i] : (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xo)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xo)))) @ (^ [Xy1:$i] : (ccv @ Xm)))) @ (^ [Xx3:$i] : (ccv @ Xm)))))))).
thf(ciscomlaw_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_op:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ Xc_op @ (XV @ Xx3 @ Xy1)) @ (cwcel @ XM @ (XW @ Xx3 @ Xy1))) @ (cwb @ (cwbr @ Xc_op @ XM @ cccomlaw) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_op) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_op))) @ (^ [Xy1:$i] : XM))) @ (^ [Xx3:$i] : XM))))))))))).
