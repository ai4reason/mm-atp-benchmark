...
thf(acos2tsin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ cc2 @ XA2 @ ccmul) @ cccos) @ (cco @ cc1 @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccsin) @ cc2 @ ccexp) @ ccmul) @ ccmin))))).
...
thf(ccoseq1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccos) @ cc1) @ (cwcel @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ ccz))))).
