...
thf(cbnj156_conj,conjecture,(! [Xbnjwphm:($i > ($i > $o))] : (! [Xbnjwpsm:($i > ($i > $o))] : (! [Xze0:($i > ($i > $o))] : (! [Xph1:($i > ($i > $o))] : (! [Xps1:($i > ($i > $o))] : (! [Xze1:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwb @ (Xze0 @ Xf1 @ Xg1) @ (cw3a @ (cwfn @ (ccv @ Xf1) @ cc1o) @ (Xbnjwphm @ Xf1 @ Xg1) @ (Xbnjwpsm @ Xf1 @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwb @ (Xze1 @ Xf1 @ Xg1) @ (cwsbc @ (^ [Xf1:$i] : (Xze0 @ Xf1 @ Xg1)) @ (ccv @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwb @ (Xph1 @ Xf1 @ Xg1) @ (cwsbc @ (^ [Xf1:$i] : (Xbnjwphm @ Xf1 @ Xg1)) @ (ccv @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwb @ (Xps1 @ Xf1 @ Xg1) @ (cwsbc @ (^ [Xf1:$i] : (Xbnjwpsm @ Xf1 @ Xg1)) @ (ccv @ Xg1))))) => (! [Xf1:$i] : (! [Xg1:$i] : (cwb @ (Xze1 @ Xf1 @ Xg1) @ (cw3a @ (cwfn @ (ccv @ Xg1) @ cc1o) @ (Xph1 @ Xf1 @ Xg1) @ (Xps1 @ Xf1 @ Xg1)))))))))))))))).
