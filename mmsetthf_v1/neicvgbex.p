...
thf(acoemptyd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccin @ (ccdm @ XA2) @ (ccrn @ XB2)) @ cc0)) => (cwi @ Xph @ (cwceq @ (cccom @ XA2 @ XB2) @ cc0))))))).
...
thf(cneicvgbex_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XD @ (ccfv @ XB2 @ XP)) => ((cwceq @ XH @ (cccom @ XF @ (cccom @ XD @ XG))) => ((cwi @ Xph @ (cwbr @ XN @ XM @ XH)) => (cwi @ Xph @ (cwcel @ XB2 @ ccvv))))))))))))))).
