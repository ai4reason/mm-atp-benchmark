...
thf(adf_cda_ax,axiom,(cwceq @ cccda @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccun @ (ccxp @ (ccv @ Xx3) @ (ccsn @ cc0)) @ (ccxp @ (ccv @ Xy1) @ (ccsn @ cc1o)))))))).
...
thf(ccdafn_conj,conjecture,(cwfn @ cccda @ (ccxp @ ccvv @ ccvv))).
