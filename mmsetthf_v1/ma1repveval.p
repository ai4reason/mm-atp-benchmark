...
thf(amarepveval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XQ @ (cco @ XN @ XR @ ccmatrepV)) => ((cwceq @ XV @ (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XM @ XB2) @ (cwcel @ XC @ XV) @ (cwcel @ XK @ XN)) @ (cwa @ (cwcel @ XI @ XN) @ (cwcel @ XJ @ XN))) @ (cwceq @ (cco @ XI @ XJ @ (ccfv @ XK @ (cco @ XM @ XC @ XQ))) @ (ccif @ (cwceq @ XJ @ XK) @ (ccfv @ XI @ XC) @ (cco @ XI @ XJ @ XM)))))))))))))))))))).
