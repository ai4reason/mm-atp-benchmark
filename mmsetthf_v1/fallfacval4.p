...
thf(afallfacval3_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (cco @ ccc0 @ XA2 @ ccfz)) @ (cwceq @ (cco @ XA2 @ XN @ ccfallfac) @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccmin) @ XA2 @ ccfz)) @ (^ [Xk:$i] : (ccv @ Xk)))))))).
...
thf(cfallfacval4_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (cco @ ccc0 @ XA2 @ ccfz)) @ (cwceq @ (cco @ XA2 @ XN @ ccfallfac) @ (cco @ (ccfv @ XA2 @ ccfa) @ (ccfv @ (cco @ XA2 @ XN @ ccmin) @ ccfa) @ ccdiv)))))).
