...
thf(a_1259lem3_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => (cwceq @ (cco @ (cco @ cc2 @ (ccdc @ cc7 @ cc6) @ ccexp) @ XN @ ccmo) @ (cco @ cc5 @ XN @ ccmo))))).
...
thf(a_1259lem1_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => (cwceq @ (cco @ (cco @ cc2 @ (ccdc @ cc1 @ cc7) @ ccexp) @ XN @ ccmo) @ (cco @ (ccdc @ (ccdc @ cc1 @ cc3) @ cc6) @ XN @ ccmo))))).
...
thf(c_1259lem4_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => (cwceq @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo))))).
