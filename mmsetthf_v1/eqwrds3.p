...
thf(ceqwrds3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwb @ (cwceq @ XW @ (ccs3 @ XA2 @ XB2 @ XC)) @ (cwa @ (cwceq @ (ccfv @ XW @ cchash) @ cc3) @ (cw3a @ (cwceq @ (ccfv @ ccc0 @ XW) @ XA2) @ (cwceq @ (ccfv @ cc1 @ XW) @ XB2) @ (cwceq @ (ccfv @ cc2 @ XW) @ XC))))))))))).
