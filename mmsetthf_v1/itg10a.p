...
thf(citg10a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccitg1) @ ccc0)))))))))).
