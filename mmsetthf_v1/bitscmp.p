...
thf(aoddm1even_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwbr @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccdvds))))).
...
thf(cbitscmp_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccdif @ ccn0 @ (ccfv @ XN @ ccbits)) @ (ccfv @ (cco @ (ccneg @ XN) @ cc1 @ ccmin) @ ccbits))))).
