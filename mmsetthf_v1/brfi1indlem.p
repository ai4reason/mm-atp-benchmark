...
thf(cbrfi1indlem_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XV @ XW) @ (cwcel @ XN @ XV) @ (cwcel @ XY @ ccn0)) @ (cwi @ (cwceq @ (ccfv @ XV @ cchash) @ (cco @ XY @ cc1 @ ccaddc)) @ (cwceq @ (ccfv @ (ccdif @ XV @ (ccsn @ XN)) @ cchash) @ XY)))))))).
