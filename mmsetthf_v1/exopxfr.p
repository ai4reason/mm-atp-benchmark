...
thf(cexopxfr_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1 @ Xz)))))) => (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccxp @ ccvv @ ccvv))) @ (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (Xps @ Xy1 @ Xz)))))))))).
