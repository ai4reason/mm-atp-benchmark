...
thf(aomoeALTV_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccodd) @ (cwcel @ XB2 @ ccodd)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ cceven))))).
...
thf(aexp5o_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ (cwi @ (cwa @ Xth @ Xta) @ Xet)) => (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))))))))))))).
...
thf(aiccpartipre_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ cc1 @ XM @ ccfzo))) => (cwi @ Xph @ (cwcel @ (ccfv @ XI @ XP) @ ccr)))))))))).
...
thf(altsubposd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ XB2 @ cclt))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(asimpll_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xph))))).
thf(cbgoldbtbndlem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwcel @ (XM @ Xi @ Xn) @ (ccfv @ (ccdc @ cc1 @ cc1) @ ccuz))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwcel @ (XN @ Xn) @ (ccfv @ (ccdc @ cc1 @ cc1) @ ccuz))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwa @ (cwbr @ cc4 @ (ccv @ Xn) @ cclt) @ (cwbr @ (ccv @ Xn) @ (XN @ Xn) @ cclt)) @ (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwcel @ (XD @ Xn) @ (ccfv @ cc3 @ ccuz))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwcel @ (XF @ Xn) @ (ccfv @ (XD @ Xn) @ cciccp))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwral @ (^ [Xi:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ ccmin) @ (cco @ (XN @ Xn) @ cc4 @ ccmin) @ cclt) @ (cwbr @ cc4 @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ ccmin) @ cclt))) @ (^ [Xi:$i] : (cco @ ccc0 @ (XD @ Xn) @ ccfzo)))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwceq @ (ccfv @ ccc0 @ (XF @ Xn)) @ cc7)))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwceq @ (ccfv @ cc1 @ (XF @ Xn)) @ (ccdc @ cc1 @ cc3))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwbr @ (XM @ Xi @ Xn) @ (ccfv @ (XD @ Xn) @ (XF @ Xn)) @ cclt)))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi @ Xn) @ (cwcel @ (ccfv @ (XD @ Xn) @ (XF @ Xn)) @ ccr)))) => ((! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xi @ Xn) @ (cco @ (XX @ Xi @ Xn) @ (ccfv @ (XI @ Xn) @ (XF @ Xn)) @ ccmin)))) => (! [Xi:$i] : (! [Xn:$i] : (cwi @ (cw3a @ (Xph @ Xi @ Xn) @ (cwcel @ (XX @ Xi @ Xn) @ ccodd) @ (cwcel @ (XI @ Xn) @ (cco @ cc1 @ (XD @ Xn) @ ccfzo))) @ (cwi @ (cwa @ (cwcel @ (XX @ Xi @ Xn) @ (cco @ (ccfv @ (XI @ Xn) @ (XF @ Xn)) @ (ccfv @ (cco @ (XI @ Xn) @ cc1 @ ccaddc) @ (XF @ Xn)) @ ccico)) @ (cwbr @ cc4 @ (XS @ Xi @ Xn) @ cclt)) @ (cw3a @ (cwcel @ (XS @ Xi @ Xn) @ cceven) @ (cwbr @ (XS @ Xi @ Xn) @ (XN @ Xn) @ cclt) @ (cwbr @ cc4 @ (XS @ Xi @ Xn) @ cclt)))))))))))))))))))))))))).
