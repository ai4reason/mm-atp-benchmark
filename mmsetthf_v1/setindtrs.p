...
thf(asetindtr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xx3) @ XA2)))) @ (cwi @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwtr @ (ccv @ Xy1)) @ (cwcel @ XB2 @ (ccv @ Xy1))))) @ (cwcel @ XB2 @ XA2)))))).
...
thf(csetindtrs_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (Xps @ Xy1 @ Xz)) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XB2 @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1 @ Xz)))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwex @ (^ [Xz:$i] : (cwa @ (cwtr @ (ccv @ Xz)) @ (cwcel @ (XB2 @ Xy1) @ (ccv @ Xz))))) @ (Xch @ Xy1 @ Xz)))))))))))).
