...
thf(ahlhgt2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (Xc_lt @ Xx3) @ (ccfv @ XK @ ccplt))) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XK @ ccp0))) => ((! [Xx3:$i] : (cwceq @ (Xc_1 @ Xx3) @ (ccfv @ XK @ ccp1))) => (cwi @ (cwcel @ XK @ cchlt) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (Xc_0 @ Xx3) @ (ccv @ Xx3) @ (Xc_lt @ Xx3)) @ (cwbr @ (ccv @ Xx3) @ (Xc_1 @ Xx3) @ (Xc_lt @ Xx3)))) @ (^ [Xx3:$i] : XB2))))))))))))).
...
thf(chl0lt1N_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ Xc_1 @ (ccfv @ XK @ ccp1)) => (cwi @ (cwcel @ XK @ cchlt) @ (cwbr @ Xc_0 @ Xc_1 @ Xc_lt)))))))))).
