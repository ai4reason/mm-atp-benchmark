...
thf(cdfoprab4f_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwceq @ (ccv @ Xw) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (Xps @ Xx3 @ Xy1 @ Xz))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xw) @ (ccxp @ (XA2 @ Xz) @ (XB2 @ Xz))) @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xz)) @ (cwcel @ (ccv @ Xy1) @ (XB2 @ Xz))) @ (Xps @ Xx3 @ Xy1 @ Xz))))))))))))))))).
