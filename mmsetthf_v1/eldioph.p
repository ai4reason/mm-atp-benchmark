...
thf(celdioph_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ (ccfv @ (cco @ cc1 @ XK @ ccfz) @ ccmzp))) @ (cwcel @ (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwceq @ (ccv @ Xt) @ (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xu) @ XP) @ ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ XK @ ccfz) @ ccmap))))) @ (ccfv @ XN @ ccdioph))))))).
