...
thf(alogbmpt_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) @ (cwceq @ (ccfv @ XB2 @ (cccur @ cclogb)) @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ (ccfv @ XB2 @ cclog) @ ccdiv))))))).
...
thf(alogbfval_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) @ (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) @ (cwceq @ (ccfv @ XX @ (ccfv @ XB2 @ (cccur @ cclogb))) @ (cco @ XB2 @ XX @ cclogb)))))).
...
thf(alogbf_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) @ (cwf @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccc @ (ccfv @ XB2 @ (cccur @ cclogb)))))).
...
thf(crelogbf_conj,conjecture,(! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ ccrp) @ (cwbr @ cc1 @ XB2 @ cclt)) @ (cwf @ ccrp @ ccr @ (ccres @ (ccfv @ XB2 @ (cccur @ cclogb)) @ ccrp))))).
