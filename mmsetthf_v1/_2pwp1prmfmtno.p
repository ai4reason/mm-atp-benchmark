...
thf(a_2pwp1prm_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccn) @ (cwcel @ (cco @ (cco @ cc2 @ XK @ ccexp) @ cc1 @ ccaddc) @ ccprime)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XK @ (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0))))).
...
thf(c_2pwp1prmfmtno_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccn) @ (cwceq @ XP @ (cco @ (cco @ cc2 @ XK @ ccexp) @ cc1 @ ccaddc)) @ (cwcel @ XP @ ccprime)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XP @ (ccfv @ (ccv @ Xn) @ ccfmtno))) @ (^ [Xn:$i] : ccn0)))))).
