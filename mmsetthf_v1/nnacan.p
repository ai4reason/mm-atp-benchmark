...
thf(cnnacan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccoa) @ (cco @ XA2 @ XC @ ccoa)) @ (cwceq @ XB2 @ XC))))))).
