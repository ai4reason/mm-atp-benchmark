...
thf(cmamudm_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XE @ (cco @ XR @ (ccxp @ XM @ XN) @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XE @ ccbs)) => ((cwceq @ XF @ (cco @ XR @ (ccxp @ XN @ XP) @ ccfrlm)) => ((cwceq @ XC @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_xp @ (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cw3a @ (cwcel @ XM @ ccfn) @ (cwcel @ XN @ ccfn) @ (cwcel @ XP @ ccfn))) @ (cwceq @ (ccdm @ Xc_xp) @ (ccxp @ XB2 @ XC))))))))))))))))))).
