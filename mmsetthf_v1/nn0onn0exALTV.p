...
thf(ann0oALTV_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XN @ ccodd)) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0)))).
...
thf(cnn0onn0exALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XN @ ccodd)) @ (cwrex @ (^ [Xm:$i] : (cwceq @ XN @ (cco @ (cco @ cc2 @ (ccv @ Xm) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xm:$i] : ccn0))))).
