...
thf(avieta1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccfv @ (XF @ Xx3) @ cccoe))) => ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (ccfv @ (XF @ Xx3) @ ccdgr))) => ((! [Xx3:$i] : (cwceq @ XR @ (ccima @ (cccnv @ (XF @ Xx3)) @ (ccsn @ ccc0)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3) @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XR @ cchash) @ (XN @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3) @ ccn))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XR @ (^ [Xx3:$i] : (ccv @ Xx3))) @ (ccneg @ (cco @ (ccfv @ (cco @ (XN @ Xx3) @ cc1 @ ccmin) @ (XA2 @ Xx3)) @ (ccfv @ (XN @ Xx3) @ (XA2 @ Xx3)) @ ccdiv)))))))))))))))))).
...
thf(abcm1k_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ (cco @ XK @ cc1 @ ccmin) @ ccbc) @ (cco @ (cco @ XN @ (cco @ XK @ cc1 @ ccmin) @ ccmin) @ XK @ ccdiv) @ ccmul)))))).
