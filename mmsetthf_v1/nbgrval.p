...
thf(cnbgrval_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xn:$i] : (cwceq @ (XE @ Xn) @ (ccfv @ XG @ ccedg))) => (cwi @ (cwcel @ XN @ XV) @ (cwceq @ (cco @ XG @ XN @ ccnbgr) @ (ccrab @ (^ [Xn:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XN @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xn)))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))))).
