...
thf(ciccpartgtprec_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ cc1 @ XM @ ccfz))) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XI @ cc1 @ ccmin) @ XP) @ (ccfv @ XI @ XP) @ cclt)))))))))).
