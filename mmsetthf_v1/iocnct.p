...
thf(ciocnct_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwceq @ XC @ (cco @ XA2 @ XB2 @ ccioc)) => (cwi @ Xph @ (cwn @ (cwbr @ XC @ ccom @ ccdom)))))))))))).
