...
thf(cissubrg3_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwb @ (cwcel @ XS @ (ccfv @ XR @ ccsubrg)) @ (cwa @ (cwcel @ XS @ (ccfv @ XR @ ccsubg)) @ (cwcel @ XS @ (ccfv @ XM @ ccsubmnd)))))))))).
