...
thf(aqexpclz_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccq) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XN @ ccz)) @ (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccq))))).
...
thf(cpcaddlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwceq @ XA2 @ (cco @ (cco @ XP @ XM @ ccexp) @ (cco @ XR @ XS @ ccdiv) @ ccmul))) => ((cwi @ Xph @ (cwceq @ XB2 @ (cco @ (cco @ XP @ XN @ ccexp) @ (cco @ XT @ XU @ ccdiv) @ ccmul))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwa @ (cwcel @ XR @ ccz) @ (cwn @ (cwbr @ XP @ XR @ ccdvds)))) => ((cwi @ Xph @ (cwa @ (cwcel @ XS @ ccn) @ (cwn @ (cwbr @ XP @ XS @ ccdvds)))) => ((cwi @ Xph @ (cwa @ (cwcel @ XT @ ccz) @ (cwn @ (cwbr @ XP @ XT @ ccdvds)))) => ((cwi @ Xph @ (cwa @ (cwcel @ XU @ ccn) @ (cwn @ (cwbr @ XP @ XU @ ccdvds)))) => (cwi @ Xph @ (cwbr @ XM @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc) @ ccle))))))))))))))))))))).
