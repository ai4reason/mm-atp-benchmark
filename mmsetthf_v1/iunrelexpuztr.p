...
thf(ciunrelexpuztr_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwceq @ XC @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp)))))) => (! [Xr:$i] : (cwi @ (cw3a @ (cwcel @ XR @ (XV @ Xr)) @ (cwceq @ XN @ (ccfv @ (XM @ Xr) @ ccuz)) @ (cwcel @ (XM @ Xr) @ ccn0)) @ (cwss @ (cccom @ (ccfv @ XR @ XC) @ (ccfv @ XR @ XC)) @ (ccfv @ XR @ XC))))))))))).
