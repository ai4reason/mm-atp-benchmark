...
thf(clvolnlelpln_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => ((cwceq @ XV @ (ccfv @ XK @ cclvol)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XP)) @ (cwn @ (cwbr @ XX @ XY @ Xc_le))))))))))))).
