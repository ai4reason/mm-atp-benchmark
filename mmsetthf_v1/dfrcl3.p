...
thf(adfrcl2_thm,axiom,(cwceq @ ccrcl @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccun @ (ccres @ ccid @ (ccun @ (ccdm @ (ccv @ Xx3)) @ (ccrn @ (ccv @ Xx3)))) @ (ccv @ Xx3)))))).
...
thf(cdfrcl3_conj,conjecture,(cwceq @ ccrcl @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccun @ (cco @ (ccv @ Xx3) @ ccc0 @ ccrelexp) @ (cco @ (ccv @ Xx3) @ cc1 @ ccrelexp)))))).
