...
thf(cknoppndvlem18_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XD @ ccrp)) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => ((cwi @ Xph @ (cwcel @ XG @ ccrp)) => ((cwi @ Xph @ (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwa @ (cwbr @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ (ccv @ Xj)) @ ccexp) @ cc2 @ ccdiv) @ XD @ cclt) @ (cwbr @ XE @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) @ (ccv @ Xj) @ ccexp) @ XG @ ccmul) @ ccle))) @ (^ [Xj:$i] : ccn0)))))))))))))))).
