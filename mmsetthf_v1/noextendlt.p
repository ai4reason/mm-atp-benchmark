...
thf(anoextenddif_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccpr @ cc1o @ cc2o)) => (cwi @ (cwcel @ XA2 @ ccsur) @ (cwceq @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ (ccun @ XA2 @ (ccsn @ (ccop @ (ccdm @ XA2) @ XX)))))) @ (^ [Xx3:$i] : ccon0))) @ (ccdm @ XA2))))))).
...
thf(anoextend_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccpr @ cc1o @ cc2o)) => (cwi @ (cwcel @ XA2 @ ccsur) @ (cwcel @ (ccun @ XA2 @ (ccsn @ (ccop @ (ccdm @ XA2) @ XX))) @ ccsur)))))).
...
thf(cnoextendlt_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccsur) @ (cwbr @ (ccun @ XA2 @ (ccsn @ (ccop @ (ccdm @ XA2) @ cc1o))) @ XA2 @ ccslt)))).
