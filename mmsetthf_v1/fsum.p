...
thf(asummo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xf1:$i] : (cwceq @ (XG @ Xf1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => (cwi @ Xph @ (cwmo @ (^ [Xx3:$i] : (cwo @ (cwrex @ (^ [Xm:$i] : (cwa @ (cwss @ XA2 @ (ccfv @ (ccv @ Xm) @ ccuz)) @ (cwbr @ (ccseq @ ccaddc @ XF @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz)) @ (cwrex @ (^ [Xm:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ XA2 @ (ccv @ Xf1)) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (ccseq @ ccaddc @ (XG @ Xf1) @ cc1))))))) @ (^ [Xm:$i] : ccn))))))))))))))).
