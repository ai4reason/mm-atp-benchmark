...
thf(cmzpexpmpt_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XV @ ccmap)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccfv @ XV @ ccmzp)) @ (cwcel @ XD @ ccn0)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XV @ ccmap)) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ XD @ ccexp))) @ (ccfv @ XV @ ccmzp))))))).
