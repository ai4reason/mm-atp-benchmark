...
thf(c_2sqlem1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => (! [Xw:$i] : (cwb @ (cwcel @ (XA2 @ Xw) @ (XS @ Xw)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (XA2 @ Xw) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cc2 @ ccexp))) @ (^ [Xx3:$i] : ccgz)))))))).
