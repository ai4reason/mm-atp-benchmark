...
thf(abitsfval_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccfv @ XN @ ccbits) @ (ccrab @ (^ [Xm:$i] : (cwn @ (cwbr @ cc2 @ (ccfv @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv) @ ccfl) @ ccdvds))) @ (^ [Xm:$i] : ccn0)))))).
...
thf(cbitsval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwcel @ XM @ (ccfv @ XN @ ccbits)) @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0) @ (cwn @ (cwbr @ cc2 @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccdiv) @ ccfl) @ ccdvds))))))).
