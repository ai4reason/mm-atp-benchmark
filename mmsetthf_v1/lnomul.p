...
thf(clnomul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XR @ (ccfv @ XU @ ccns)) => ((cwceq @ XS @ (ccfv @ XW @ ccns)) => ((cwceq @ XL @ (cco @ XU @ XW @ cclno)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwcel @ XT @ XL)) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ XX))) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ XR) @ XT) @ (cco @ XA2 @ (ccfv @ XB2 @ XT) @ XS))))))))))))))))).
