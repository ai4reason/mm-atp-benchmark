...
thf(agrpoidinvlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccgr) @ (cwa @ (cwcel @ XY @ XX) @ (cwcel @ XA2 @ XX))) @ (cwa @ (cwceq @ (cco @ XU @ XY @ XG) @ XY) @ (cwceq @ (cco @ XY @ XA2 @ XG) @ XU))) @ (cwceq @ (cco @ (cco @ XA2 @ XY @ XG) @ (cco @ XA2 @ XY @ XG) @ XG) @ (cco @ XA2 @ XY @ XG)))))))))).
...
thf(agrpoidinvlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccgr) @ (cwa @ (cwcel @ XY @ XX) @ (cwcel @ XA2 @ XX))) @ (cwa @ (cwceq @ (cco @ XY @ XA2 @ XG) @ XU) @ (cwceq @ (cco @ XA2 @ XA2 @ XG) @ XA2))) @ (cwceq @ (cco @ XU @ XA2 @ XG) @ XU))))))))).
thf(cgrpoidinvlem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwb @ (Xph @ Xx3 @ Xz) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ XU @ (ccv @ Xx3) @ XG) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XX))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwb @ (Xps @ Xx3 @ Xz) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XG) @ XU)) @ (^ [Xz:$i] : XX))) @ (^ [Xx3:$i] : XX))))) => (! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XG @ ccgr) @ (cwcel @ XU @ XX)) @ (cwa @ (Xph @ Xx3 @ Xz) @ (Xps @ Xx3 @ Xz))) @ (cwcel @ XA2 @ XX)) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xy1) @ XA2 @ XG) @ XU) @ (cwceq @ (cco @ XA2 @ (ccv @ Xy1) @ XG) @ XU))) @ (^ [Xy1:$i] : XX))))))))))))))).
