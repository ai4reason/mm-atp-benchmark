...
thf(cswrdccatwrd_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)) @ (cwceq @ (cco @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ (ccs1 @ (ccfv @ XW @ cclsw)) @ ccconcat) @ XW))))).
