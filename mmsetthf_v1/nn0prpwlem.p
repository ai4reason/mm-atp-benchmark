...
thf(aindstr2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ cc1) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xch @ Xx3 @ Xy1))) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccfv @ cc2 @ ccuz)) @ (cwi @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt) @ (Xps @ Xy1))) @ (^ [Xy1:$i] : ccn)) @ (Xph @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccn) @ (Xph @ Xx3))))))))))).
...
thf(cnn0prpwlem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ XA2 @ cclt) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xn:$i] : (cwn @ (cwb @ (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xk) @ ccdvds) @ (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ XA2 @ ccdvds)))) @ (^ [Xn:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))) @ (^ [Xk:$i] : ccn))))).
