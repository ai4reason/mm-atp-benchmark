...
thf(aofaddmndmap_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XM @ ccmnd) @ (cwcel @ XV @ XY) @ (cwa @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) @ (cwcel @ XB2 @ (cco @ XR @ XV @ ccmap)))) @ (cwcel @ (cco @ XA2 @ XB2 @ (ccof @ Xc_pl)) @ (cco @ XR @ XV @ ccmap))))))))))))).
thf(aanim1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xph @ Xch) @ (cwa @ Xps @ Xch))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(ccsupp_tp,type,(ccsupp : ($i > $o))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(amndpfsupp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XR @ (ccfv @ XM @ ccbs)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XM @ ccmnd) @ (cwcel @ XV @ XX)) @ (cwa @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) @ (cwcel @ XB2 @ (cco @ XR @ XV @ ccmap))) @ (cwa @ (cwbr @ XA2 @ (ccfv @ XM @ cc0g) @ ccfsupp) @ (cwbr @ XB2 @ (ccfv @ XM @ cc0g) @ ccfsupp))) @ (cwbr @ (cco @ XA2 @ XB2 @ (ccof @ (ccfv @ XM @ ccplusg))) @ (ccfv @ XM @ cc0g) @ ccfsupp)))))))))).
...
thf(clincsumcl_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) @ (cwa @ (cwcel @ XC @ (cco @ XM @ XV @ cclinco)) @ (cwcel @ XD @ (cco @ XM @ XV @ cclinco)))) @ (cwcel @ (cco @ XC @ XD @ Xc_pl) @ (cco @ XM @ XV @ cclinco)))))))))).
