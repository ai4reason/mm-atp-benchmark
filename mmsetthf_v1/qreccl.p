...
thf(adivne0b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwb @ (cwne @ XA2 @ ccc0) @ (cwne @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0)))))).
...
thf(amsqznn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ (cco @ XA2 @ XA2 @ ccmul) @ ccn)))).
...
thf(cqreccl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccq) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccq)))).
