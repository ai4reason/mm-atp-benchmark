...
thf(axpco_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwne @ XB2 @ cc0) @ (cwceq @ (cccom @ (ccxp @ XB2 @ XC) @ (ccxp @ XA2 @ XB2)) @ (ccxp @ XA2 @ XC))))))).
...
thf(custund_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwss @ (ccxp @ XA2 @ XA2) @ XV)) => ((cwi @ Xph @ (cwss @ (ccxp @ XB2 @ XB2) @ XV)) => ((cwi @ Xph @ (cwne @ (ccin @ XA2 @ XB2) @ cc0)) => (cwi @ Xph @ (cwss @ (ccxp @ (ccun @ XA2 @ XB2) @ (ccun @ XA2 @ XB2)) @ (cccom @ XV @ XV))))))))))).
