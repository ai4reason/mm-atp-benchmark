...
thf(am1modge3gt1_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ (ccfv @ cc3 @ ccuz)) @ (cwbr @ cc1 @ (cco @ (ccneg @ cc1) @ XM @ ccmo) @ cclt)))).
...
thf(anegmod0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ ccc0) @ (cwceq @ (cco @ (ccneg @ XA2) @ XB2 @ ccmo) @ ccc0)))))).
