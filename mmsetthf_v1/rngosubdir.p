...
thf(arngoneglmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XN @ (ccfv @ XG @ ccgn)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ XH) @ XN) @ (cco @ (ccfv @ XA2 @ XN) @ XB2 @ XH))))))))))))))).
thf(crngosubdir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XD @ (ccfv @ XG @ ccgs)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XD) @ XC @ XH) @ (cco @ (cco @ XA2 @ XC @ XH) @ (cco @ XB2 @ XC @ XH) @ XD)))))))))))))))).
