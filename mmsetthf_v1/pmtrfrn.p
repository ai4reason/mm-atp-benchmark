...
thf(cpmtrfrn_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => ((cwceq @ XR @ (ccrn @ XT)) => ((cwceq @ XP @ (ccdm @ (ccdif @ XF @ ccid))) => (cwi @ (cwcel @ XF @ XR) @ (cwa @ (cw3a @ (cwcel @ XD @ ccvv) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) @ (cwceq @ XF @ (ccfv @ XP @ XT))))))))))))).
