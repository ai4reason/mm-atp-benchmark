...
thf(ar19_40_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwa @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
...
thf(ar19_27zv_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (cwi @ (cwne @ XA2 @ cc0) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ Xps)) @ (^ [Xx3:$i] : XA2)) @ (cwa @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ Xps))))))).
...
thf(aflftg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xo:$i] : (! [Xs1:$i] : (cwceq @ (XJ @ Xo) @ (ccfv @ (XB2 @ Xs1) @ cctg)))) => (! [Xo:$i] : (! [Xs1:$i] : (cwi @ (cw3a @ (cwcel @ (XJ @ Xo) @ (ccfv @ (XX @ Xo) @ cctopon)) @ (cwcel @ XL @ (ccfv @ (XY @ Xo) @ ccfil)) @ (cwf @ (XY @ Xo) @ (XX @ Xo) @ XF)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XF @ (cco @ (XJ @ Xo) @ XL @ ccflf))) @ (cwa @ (cwcel @ XA2 @ (XX @ Xo)) @ (cwral @ (^ [Xo:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xo)) @ (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xo))) @ (^ [Xs1:$i] : XL)))) @ (^ [Xo:$i] : (XB2 @ Xs1))))))))))))))))).
...
thf(ctxflf_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xn) @ (ccfv @ XX @ cctopon)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xn) @ (ccfv @ XY @ cctopon)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XL @ Xn) @ (ccfv @ XZ @ ccfil)))) => ((cwi @ Xph @ (cwf @ XZ @ XX @ XF)) => ((cwi @ Xph @ (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG)))))) => (! [Xn:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccop @ (XR @ Xn) @ (XS @ Xn)) @ (ccfv @ (XH @ Xn) @ (cco @ (cco @ (XJ @ Xn) @ (XK @ Xn) @ cctx) @ (XL @ Xn) @ ccflf))) @ (cwa @ (cwcel @ (XR @ Xn) @ (ccfv @ XF @ (cco @ (XJ @ Xn) @ (XL @ Xn) @ ccflf))) @ (cwcel @ (XS @ Xn) @ (ccfv @ XG @ (cco @ (XK @ Xn) @ (XL @ Xn) @ ccflf)))))))))))))))))))))))))).
