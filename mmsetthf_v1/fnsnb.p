...
thf(afnsnr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ (ccsn @ XA2)) @ (cwi @ (cwcel @ XB2 @ XF) @ (cwceq @ XB2 @ (ccop @ XA2 @ (ccfv @ XA2 @ XF))))))))).
...
thf(cfnsnb_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwfn @ XF @ (ccsn @ XA2)) @ (cwceq @ XF @ (ccsn @ (ccop @ XA2 @ (ccfv @ XA2 @ XF))))))))).
