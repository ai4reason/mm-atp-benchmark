...
thf(aimasf1oxms_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwf1o @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ ccxme)) => (cwi @ Xph @ (cwcel @ XU @ ccxme))))))))))))).
...
thf(aprdsxms_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => (cwi @ (cw3a @ (cwcel @ XS @ XW) @ (cwcel @ XI @ ccfn) @ (cwf @ XI @ ccxme @ XR)) @ (cwcel @ XY @ ccxme))))))))).
thf(cxpsxms_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (cco @ XR @ XS @ ccxps)) => (cwi @ (cwa @ (cwcel @ XR @ ccxme) @ (cwcel @ XS @ ccxme)) @ (cwcel @ XT @ ccxme))))))).
