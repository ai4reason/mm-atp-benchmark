...
thf(abrcolinear2_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XQ @ (XV @ Xn)) @ (cwcel @ XR @ (XW @ Xn))) @ (cwb @ (cwbr @ XP @ (ccop @ XQ @ XR) @ cccolin) @ (cwrex @ (^ [Xn:$i] : (cwa @ (cw3a @ (cwcel @ XP @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ XQ @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ XR @ (ccfv @ (ccv @ Xn) @ ccee))) @ (cw3o @ (cwbr @ XP @ (ccop @ XQ @ XR) @ ccbtwn) @ (cwbr @ XQ @ (ccop @ XR @ XP) @ ccbtwn) @ (cwbr @ XR @ (ccop @ XP @ XQ) @ ccbtwn)))) @ (^ [Xn:$i] : ccn))))))))))).
...
thf(cbrcolinear_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) @ (cwb @ (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin) @ (cw3o @ (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) @ (cwbr @ XB2 @ (ccop @ XC @ XA2) @ ccbtwn) @ (cwbr @ XC @ (ccop @ XA2 @ XB2) @ ccbtwn))))))))).
