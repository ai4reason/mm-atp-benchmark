...
thf(acjmuld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ cccj) @ (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccmul))))))))).
...
thf(ale0neg1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwbr @ XA2 @ ccc0 @ ccle) @ (cwbr @ ccc0 @ (ccneg @ XA2) @ ccle))))).
...
thf(csqreulem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwceq @ XB2 @ (cco @ (ccfv @ (ccfv @ XA2 @ ccabs) @ ccsqrt) @ (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XA2 @ ccaddc) @ (ccfv @ (cco @ (ccfv @ XA2 @ ccabs) @ XA2 @ ccaddc) @ ccabs) @ ccdiv) @ ccmul)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (cco @ (ccfv @ XA2 @ ccabs) @ XA2 @ ccaddc) @ ccc0)) @ (cw3a @ (cwceq @ (cco @ XB2 @ cc2 @ ccexp) @ XA2) @ (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ XB2 @ ccmul) @ ccrp))))))).
