...
thf(cetransclem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwss @ XX @ ccc))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ (XP @ Xx3) @ ccn)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XH @ Xx3 @ Xj) @ (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ (XM @ Xx3) @ ccfz)) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (ccif @ (cwceq @ (ccv @ Xj) @ ccc0) @ (cco @ (XP @ Xx3) @ cc1 @ ccmin) @ (XP @ Xx3)) @ ccexp)))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ (XJ @ Xj) @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz))))) => (! [Xx3:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwf @ XX @ ccc @ (ccfv @ (XJ @ Xj) @ (XH @ Xx3 @ Xj))))))))))))))))).
