...
thf(adf_tus_ax,axiom,(cwceq @ cctus @ (ccmpt @ (^ [Xu:$i] : (ccuni @ (ccrn @ ccust))) @ (^ [Xu:$i] : (cco @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccdm @ (ccuni @ (ccv @ Xu)))) @ (ccop @ (ccfv @ ccnx @ ccunif) @ (ccv @ Xu))) @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ (ccv @ Xu) @ ccutop)) @ ccsts))))).
...
thf(ctusval_conj,conjecture,(! [XU:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwceq @ (ccfv @ XU @ cctus) @ (cco @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccdm @ (ccuni @ XU))) @ (ccop @ (ccfv @ ccnx @ ccunif) @ XU)) @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XU @ ccutop)) @ ccsts)))))).
