...
thf(confrALTlem4VD_conj,conjecture,(! [Xa:$i] : (! [Xy1:$i] : (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) @ (cwceq @ (ccin @ (ccv @ Xa) @ (ccv @ Xx3)) @ cc0))) @ (ccv @ Xy1)) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xa)) @ (cwceq @ (ccin @ (ccv @ Xa) @ (ccv @ Xy1)) @ cc0)))))).
