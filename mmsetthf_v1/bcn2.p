...
thf(abcval5_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccn)) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ (cco @ (ccfv @ XN @ (ccseq @ ccmul @ ccid @ (cco @ (cco @ XN @ XK @ ccmin) @ cc1 @ ccaddc))) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
...
thf(cbcn2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ cc2 @ ccbc) @ (cco @ (cco @ XN @ (cco @ XN @ cc1 @ ccmin) @ ccmul) @ cc2 @ ccdiv))))).
