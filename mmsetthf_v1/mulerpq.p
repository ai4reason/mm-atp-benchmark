...
thf(anqercl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ (ccfv @ XA2 @ ccerq) @ ccnq)))).
...
thf(amulpqnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnq) @ (cwcel @ XB2 @ ccnq)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmq) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmpq) @ ccerq)))))).
...
thf(anqerrel_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwbr @ XA2 @ (ccfv @ XA2 @ ccerq) @ cceq)))).
...
thf(amulerpqlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XC @ (ccxp @ ccnpi @ ccnpi))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cceq) @ (cwbr @ (cco @ XA2 @ XC @ ccmpq) @ (cco @ XB2 @ XC @ ccmpq) @ cceq))))))).
...
thf(amulcompq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ ccmpq) @ (cco @ XB2 @ XA2 @ ccmpq))))).
...
thf(anqereq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cceq) @ (cwceq @ (ccfv @ XA2 @ ccerq) @ (ccfv @ XB2 @ ccerq))))))).
...
thf(cmulerpq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ (ccfv @ XA2 @ ccerq) @ (ccfv @ XB2 @ ccerq) @ ccmq) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmpq) @ ccerq))))).
