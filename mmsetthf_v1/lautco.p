...
thf(clautco_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cw3a @ (cwcel @ XK @ XV) @ (cwcel @ XF @ XI) @ (cwcel @ XG @ XI)) @ (cwcel @ (cccom @ XF @ XG) @ XI))))))))).
