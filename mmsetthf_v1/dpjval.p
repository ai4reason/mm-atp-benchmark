...
thf(adpjfval_thm,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((! [Xi:$i] : (cwceq @ (XP @ Xi) @ (cco @ XG @ XS @ ccdpj))) => ((! [Xi:$i] : (cwceq @ (XQ @ Xi) @ (ccfv @ XG @ ccpj1))) => (! [Xi:$i] : (cwi @ Xph @ (cwceq @ (XP @ Xi) @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ (ccv @ Xi)))) @ ccdprd) @ (XQ @ Xi)))))))))))))))))).
...
thf(cdpjval_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwceq @ XP @ (cco @ XG @ XS @ ccdpj)) => ((cwceq @ XQ @ (ccfv @ XG @ ccpj1)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ XP) @ (cco @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ XQ)))))))))))))))).
