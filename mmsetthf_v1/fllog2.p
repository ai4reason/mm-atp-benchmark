...
thf(azgeltp1eq_thm,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwa @ (cwcel @ XI @ ccz) @ (cwcel @ XA2 @ ccz)) @ (cwi @ (cwa @ (cwbr @ XA2 @ XI @ ccle) @ (cwbr @ XI @ (cco @ XA2 @ cc1 @ ccaddc) @ cclt)) @ (cwceq @ XI @ XA2)))))).
thf(cfllog2_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XI @ ccn0) @ (cwcel @ XN @ (cco @ (cco @ cc2 @ XI @ ccexp) @ (cco @ cc2 @ (cco @ XI @ cc1 @ ccaddc) @ ccexp) @ ccfzo))) @ (cwceq @ (ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) @ XI))))).
