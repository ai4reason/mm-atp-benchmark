...
thf(cfvline2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwne @ XA2 @ XB2))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccline2) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XA2 @ XB2) @ cccolin)) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee))))))))).
