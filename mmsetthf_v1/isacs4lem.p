...
thf(amrcuni_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XU @ (ccpw @ XX))) @ (cwceq @ (ccfv @ (ccuni @ XU) @ XF) @ (ccfv @ (ccuni @ (ccima @ XF @ XU)) @ XF))))))))).
...
thf(cisacs4lem_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) @ (cwcel @ (ccuni @ (ccv @ Xs1)) @ XC))) @ (^ [Xs1:$i] : (ccpw @ XC)))) @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwral @ (^ [Xt:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xt) @ ccipo) @ ccdrs) @ (cwceq @ (ccfv @ (ccuni @ (ccv @ Xt)) @ XF) @ (ccuni @ (ccima @ XF @ (ccv @ Xt)))))) @ (^ [Xt:$i] : (ccpw @ (ccpw @ XX))))))))))).
