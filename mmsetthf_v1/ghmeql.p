...
thf(cghmeql_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XG @ (cco @ XS @ XT @ ccghm))) @ (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XS @ ccsubg)))))))).
