...
thf(czringsubgval_conj,conjecture,(! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_mi @ (ccfv @ czring @ ccsg)) => (cwi @ (cwa @ (cwcel @ XX @ ccz) @ (cwcel @ XY @ ccz)) @ (cwceq @ (cco @ XX @ XY @ ccmin) @ (cco @ XX @ XY @ Xc_mi)))))))).
