...
thf(aov2ssiunov2_thm,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwceq @ XC @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ Xc_ex)))))) => (! [Xr:$i] : (cwi @ (cw3a @ (cwcel @ XR @ (XU @ Xr)) @ (cwcel @ XN @ (XV @ Xr)) @ (cwcel @ (XM @ Xr) @ XN)) @ (cwss @ (cco @ XR @ (XM @ Xr) @ Xc_ex) @ (ccfv @ XR @ XC))))))))))))).
...
thf(aiunrelexpuztr_thm,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwceq @ XC @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp)))))) => (! [Xr:$i] : (cwi @ (cw3a @ (cwcel @ XR @ (XV @ Xr)) @ (cwceq @ XN @ (ccfv @ (XM @ Xr) @ ccuz)) @ (cwcel @ (XM @ Xr) @ ccn0)) @ (cwss @ (cccom @ (ccfv @ XR @ XC) @ (ccfv @ XR @ XC)) @ (ccfv @ XR @ XC))))))))))).
...
thf(aelabgt_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))))) @ (cwb @ (cwcel @ XA2 @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))) @ Xps)))))))).
...
thf(aiunrelexpmin2_thm,axiom,(! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xs1:$i] : (cwceq @ (XC @ Xs1) @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp))))))) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwceq @ XN @ ccn0)) @ (cwal @ (^ [Xs1:$i] : (cwi @ (cw3a @ (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ XR) @ (ccrn @ XR))) @ (ccv @ Xs1)) @ (cwss @ XR @ (ccv @ Xs1)) @ (cwss @ (cccom @ (ccv @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1))) @ (cwss @ (ccfv @ XR @ (XC @ Xs1)) @ (ccv @ Xs1)))))))))))).
...
thf(cdfrtrcl3_conj,conjecture,(cwceq @ ccrtcl @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp))))))).
