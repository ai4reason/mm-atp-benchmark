...
thf(afunopab4_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (cwfun @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3)))))))))).
...
thf(aintirr_thm,axiom,(! [XR:($i > $o)] : (cwb @ (cwceq @ (ccin @ XR @ ccid) @ cc0) @ (cwal @ (^ [Xx3:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XR))))))).
...
thf(aoieq1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwceq @ (ccoi @ XA2 @ XR) @ (ccoi @ XA2 @ XS))))))).
