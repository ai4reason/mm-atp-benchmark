...
thf(alfl0sc_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XK @ (ccfv @ XD @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XD @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XD @ cc0g)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XG @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ (ccxp @ XV @ (ccsn @ Xc_0)) @ (ccof @ Xc_x)) @ (ccxp @ XV @ (ccsn @ Xc_0)))))))))))))))))))))).
...
thf(aeqlkr2_thm,axiom,(! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XD @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XD @ ccmulr)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XL @ (ccfv @ XW @ cclk)) => (cwi @ (cw3a @ (cwcel @ XW @ cclvec) @ (cwa @ (cwcel @ XG @ XF) @ (cwcel @ XH @ XF)) @ (cwceq @ (ccfv @ XG @ XL) @ (ccfv @ XH @ XL))) @ (cwrex @ (^ [Xr:$i] : (cwceq @ XH @ (cco @ XG @ (ccxp @ XV @ (ccsn @ (ccv @ Xr))) @ (ccof @ Xc_x)))) @ (^ [Xr:$i] : XK))))))))))))))))))).
