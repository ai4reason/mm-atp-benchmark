...
thf(advply1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xz @ Xk) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (XG @ Xz @ Xk) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => ((cwi @ Xph @ (cwf @ ccn0 @ ccc @ XA2)) => ((! [Xk:$i] : (cwceq @ (XB2 @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XA2) @ ccmul))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ ccc @ (XF @ Xz @ Xk) @ ccdv) @ (XG @ Xz @ Xk))))))))))))))))).
...
thf(azsssubrg_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ (ccfv @ cccnfld @ ccsubrg)) @ (cwss @ ccz @ XR)))).
...
thf(cdvply2g_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg)) @ (cwcel @ XF @ (ccfv @ XS @ ccply))) @ (cwcel @ (cco @ ccc @ XF @ ccdv) @ (ccfv @ XS @ ccply)))))).
