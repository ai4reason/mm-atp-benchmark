...
thf(crinvf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((cwceq @ (cccnv @ XF) @ XF) => ((cwss @ (ccima @ XF @ XA2) @ XB2) => ((cwss @ (ccima @ XF @ XB2) @ XA2) => ((cwss @ XA2 @ (ccdm @ XF)) => ((cwss @ XB2 @ (ccdm @ XF)) => (cwf1o @ XA2 @ XB2 @ (ccres @ XF @ XA2)))))))))))).
