...
thf(abastop1_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XB2 @ XJ)) @ (cwb @ (cwceq @ (ccfv @ XB2 @ cctg) @ XJ) @ (cwral @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwss @ (ccv @ Xy1) @ XB2) @ (cwceq @ (ccv @ Xx3) @ (ccuni @ (ccv @ Xy1))))))) @ (^ [Xx3:$i] : XJ))))))).
thf(cbastop2_conj,conjecture,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwb @ (cwceq @ (ccfv @ XB2 @ cctg) @ XJ) @ (cwa @ (cwss @ XB2 @ XJ) @ (cwral @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwss @ (ccv @ Xy1) @ XB2) @ (cwceq @ (ccv @ Xx3) @ (ccuni @ (ccv @ Xy1))))))) @ (^ [Xx3:$i] : XJ)))))))).
