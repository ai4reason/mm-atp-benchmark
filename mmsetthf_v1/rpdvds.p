...
thf(crpdvds_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwceq @ (cco @ XK @ XN @ ccgcd) @ cc1) @ (cwbr @ XM @ XN @ ccdvds))) @ (cwceq @ (cco @ XK @ XM @ ccgcd) @ cc1)))))).
