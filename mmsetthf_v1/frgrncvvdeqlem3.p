...
thf(aelnelne2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwnel @ XB2 @ XC)) @ (cwne @ XA2 @ XB2)))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(afrcond3_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XG @ ccfrgr) @ (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV) @ (cwne @ XA2 @ XC)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ (cco @ XG @ XA2 @ ccnbgr) @ (cco @ XG @ XC @ ccnbgr)) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XV)))))))))))).
