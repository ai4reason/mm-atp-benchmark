...
thf(cspansncol_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ (ccfv @ (ccsn @ (cco @ XB2 @ XA2 @ ccsm)) @ ccspn) @ (ccfv @ (ccsn @ XA2) @ ccspn)))))).
