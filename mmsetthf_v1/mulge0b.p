...
thf(cmulge0b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle) @ (cwo @ (cwa @ (cwbr @ XA2 @ ccc0 @ ccle) @ (cwbr @ XB2 @ ccc0 @ ccle)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ XB2 @ ccle)))))))).
