...
thf(ceqcoe1ply1eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XP @ Xk) @ (ccfv @ (XR @ Xk) @ ccpl1))) => ((! [Xk:$i] : (cwceq @ (XB2 @ Xk) @ (ccfv @ (XP @ Xk) @ ccbs))) => ((! [Xk:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xk) @ ccco1))) => ((! [Xk:$i] : (cwceq @ XC @ (ccfv @ (XL @ Xk) @ ccco1))) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ (XR @ Xk) @ ccrg) @ (cwcel @ (XK @ Xk) @ (XB2 @ Xk)) @ (cwcel @ (XL @ Xk) @ (XB2 @ Xk))) @ (cwi @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XC))) @ (^ [Xk:$i] : ccn0)) @ (cwceq @ (XK @ Xk) @ (XL @ Xk))))))))))))))))).
