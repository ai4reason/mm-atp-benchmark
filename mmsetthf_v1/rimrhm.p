...
thf(arimrcl_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (cco @ XR @ XS @ ccrs)) @ (cwa @ (cwcel @ XR @ ccvv) @ (cwcel @ XS @ ccvv))))))).
...
thf(crimrhm_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (ccfv @ XS @ ccbs)) => (cwi @ (cwcel @ XF @ (cco @ XR @ XS @ ccrs)) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh))))))))))).
