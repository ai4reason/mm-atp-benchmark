...
thf(aelfiun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XK)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ (ccun @ XB2 @ XC) @ ccfi)) @ (cw3o @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) @ (cwcel @ XA2 @ (ccfv @ XC @ ccfi)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XC @ ccfi)))) @ (^ [Xx3:$i] : (ccfv @ XB2 @ ccfi)))))))))))).
thf(abitr2i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ Xps) => ((cwb @ Xps @ Xch) => (cwb @ Xch @ Xph))))))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(a_3ioran_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwn @ (cw3o @ Xph @ Xps @ Xch)) @ (cw3a @ (cwn @ Xph) @ (cwn @ Xps) @ (cwn @ Xch))))))).
...
thf(anesym_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwne @ XA2 @ XB2) @ (cwn @ (cwceq @ XB2 @ XA2)))))).
...
thf(afbasfip_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwn @ (cwcel @ cc0 @ (ccfv @ XF @ ccfi))))))).
...
thf(aralrimdvva_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1)))) @ (cwi @ Xps @ (Xch @ Xx3 @ Xy1))))) => (cwi @ Xph @ (cwi @ Xps @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))).
...
thf(cfbunfip_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwcel @ XG @ (ccfv @ XY @ ccfbas))) @ (cwb @ (cwn @ (cwcel @ cc0 @ (ccfv @ (ccun @ XF @ XG) @ ccfi))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwne @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0)) @ (^ [Xy1:$i] : XG))) @ (^ [Xx3:$i] : XF))))))))).
