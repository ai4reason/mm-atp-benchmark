...
thf(cbr1cossinres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XW)) @ (cwb @ (cwbr @ XB2 @ XC @ (cccoss @ (ccin @ XR @ (ccres @ XS @ XA2)))) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwa @ (cwbr @ (ccv @ Xu) @ XB2 @ XS) @ (cwbr @ (ccv @ Xu) @ XB2 @ XR)) @ (cwa @ (cwbr @ (ccv @ Xu) @ XC @ XS) @ (cwbr @ (ccv @ Xu) @ XC @ XR)))) @ (^ [Xu:$i] : XA2)))))))))))).
