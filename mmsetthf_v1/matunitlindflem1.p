...
thf(afrlmfibas_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XN @ (ccfv @ XR @ ccbs)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XI @ ccfn)) @ (cwceq @ (cco @ XN @ XI @ ccmap) @ (ccfv @ XF @ ccbs))))))))))).
...
thf(acurf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwf @ (ccxp @ XA2 @ XB2) @ XC @ XF) @ (cwcel @ XB2 @ (ccdif @ XV @ (ccsn @ cc0))) @ (cwcel @ XC @ XW)) @ (cwf @ XA2 @ (cco @ XC @ XB2 @ ccmap) @ (cccur @ XF)))))))))).
...
thf(aislindf4_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XR @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XY @ (ccfv @ XR @ cc0g)) => ((cwceq @ XL @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XI @ XX) @ (cwf @ XI @ XB2 @ XF)) @ (cwb @ (cwbr @ XF @ XW @ cclindf) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwceq @ (cco @ XW @ (cco @ (ccv @ Xx3) @ XF @ (ccof @ Xc_x)) @ ccgsu) @ Xc_0) @ (cwceq @ (ccv @ Xx3) @ (ccxp @ XI @ (ccsn @ XY))))) @ (^ [Xx3:$i] : XL))))))))))))))))))))).
...
thf(acurfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwfn @ XF @ (ccxp @ XV @ XW)) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwcel @ XW @ XX)) @ (cwceq @ (ccfv @ XB2 @ (ccfv @ XA2 @ (cccur @ XF))) @ (cco @ XA2 @ XB2 @ XF)))))))))).
thf(ccsubg_tp,type,(ccsubg : ($i > $o))).
thf(cclss_tp,type,(cclss : ($i > $o))).
thf(afrlmgsum_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XY @ cc0g)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XI @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XJ @ (XW @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XJ)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XU @ Xx3 @ Xy1))) @ XB2))) => ((cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XU @ Xx3 @ Xy1))))) @ Xc_0 @ ccfsupp)) => (cwi @ Xph @ (cwceq @ (cco @ XY @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XU @ Xx3 @ Xy1))))) @ ccgsu) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ XR @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (XU @ Xx3 @ Xy1))) @ ccgsu)))))))))))))))))))))))).
...
thf(aad5ant245_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ Xta @ Xph) @ Xet) @ Xps) @ Xch) @ Xth))))))))).
...
thf(afconstfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwf @ XA2 @ (ccsn @ XB2) @ XF) @ (cwa @ (cwfn @ XF @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))))))).
thf(afconst2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwb @ (cwf @ XA2 @ (ccsn @ XB2) @ XF) @ (cwceq @ XF @ (ccxp @ XA2 @ (ccsn @ XB2))))))))).
...
thf(aad5ant25_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ Xth @ Xph) @ Xta) @ Xet) @ Xps) @ Xch))))))))).
...
thf(aad5ant24_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ Xth @ Xph) @ Xta) @ Xps) @ Xet) @ Xch))))))))).
...
thf(aabl32_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl) @ (cco @ (cco @ XX @ XZ @ Xc_pl) @ XY @ Xc_pl))))))))))))))))).
...
thf(amdetero_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XD @ Xi @ Xj) @ (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XK @ (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ Xc_pl @ (ccfv @ (XR @ Xi @ Xj) @ ccplusg)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ Xc_x @ (ccfv @ (XR @ Xi @ Xj) @ ccmulr)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xi @ Xj) @ cccrg)))) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XN)) @ (cwcel @ (XX @ Xj) @ XK))) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XN)) @ (cwcel @ (XY @ Xj) @ XK))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) @ (cwcel @ (XZ @ Xi @ Xj) @ XK)))) => ((cwi @ Xph @ (cwcel @ XW @ XK)) => ((cwi @ Xph @ (cwcel @ XI @ XN)) => ((cwi @ Xph @ (cwcel @ XJ @ XN)) => ((cwi @ Xph @ (cwne @ XI @ XJ)) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ XI) @ (cco @ (XX @ Xj) @ (cco @ XW @ (XY @ Xj) @ Xc_x) @ Xc_pl) @ (ccif @ (cwceq @ (ccv @ Xi) @ XJ) @ (XY @ Xj) @ (XZ @ Xi @ Xj)))))) @ (XD @ Xi @ Xj)) @ (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ XI) @ (XX @ Xj) @ (ccif @ (cwceq @ (ccv @ Xi) @ XJ) @ (XY @ Xj) @ (XZ @ Xi @ Xj)))))) @ (XD @ Xi @ Xj))))))))))))))))))))))))))))))))).
...
thf(agsumdifsnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : (cwceq @ (Xc_pl @ Xk) @ (ccfv @ XG @ ccplusg))) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XW @ Xk)))) => ((cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ (ccfv @ XG @ cc0g) @ ccfsupp)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XX @ Xk) @ XB2))) => ((cwi @ Xph @ (cwcel @ XM @ XA2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xk) @ XM)) @ (cwceq @ (XX @ Xk) @ XY))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ (cco @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccdif @ XA2 @ (ccsn @ XM))) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ XY @ (Xc_pl @ Xk)))))))))))))))))))))))).
...
thf(aad5ant145_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ Xph @ Xta) @ Xet) @ Xps) @ Xch) @ Xth))))))))).
...
thf(cmatunitlindflem1_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccfield) @ (cwf @ (ccxp @ XI @ XI) @ (ccfv @ XR @ ccbs) @ XM)) @ (cwcel @ XI @ (ccdif @ ccfn @ (ccsn @ cc0)))) @ (cwi @ (cwn @ (cwbr @ (cccur @ XM) @ (cco @ XR @ XI @ ccfrlm) @ cclindf)) @ (cwceq @ (ccfv @ XM @ (cco @ XI @ XR @ ccmdat)) @ (ccfv @ XR @ cc0g)))))))).
