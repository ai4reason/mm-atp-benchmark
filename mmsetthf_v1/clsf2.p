...
thf(aclsf_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwf @ (ccpw @ XX) @ (ccfv @ XJ @ cccld) @ (ccfv @ XJ @ cccl))))))).
...
thf(cclsf2_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XK @ (ccfv @ XJ @ cccl)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwf @ (ccpw @ XX) @ (ccpw @ XX) @ XK)))))))).
