...
thf(atposf2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ (cccnv @ XA2) @ XB2 @ (cctpos @ XF)))))))).
...
thf(ctposf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ (ccxp @ XA2 @ XB2) @ XC @ XF) @ (cwf @ (ccxp @ XB2 @ XA2) @ XC @ (cctpos @ XF)))))))).
