...
thf(ccosselcnvrefrels3_conj,conjecture,(! [XR:($i > $o)] : (cwb @ (cwcel @ (cccoss @ XR) @ cccnvrefrels) @ (cwa @ (cwal @ (^ [Xu:$i] : (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xu) @ (ccv @ Xx3) @ XR) @ (cwbr @ (ccv @ Xu) @ (ccv @ Xy1) @ XR)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))))))) @ (cwcel @ (cccoss @ XR) @ ccrels))))).
