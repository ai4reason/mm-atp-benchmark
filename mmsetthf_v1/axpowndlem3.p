...
thf(aaxpowndlem2_thm,axiom,(! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwi @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xz))))) @ (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwex @ (^ [Xz:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))))).
thf(caxpowndlem3_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwn @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwex @ (^ [Xz:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))))).
