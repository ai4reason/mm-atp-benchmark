...
thf(cusgrexi_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))) => (cwi @ (cwcel @ XV @ XW) @ (cwcel @ (ccop @ XV @ (ccres @ ccid @ XP)) @ ccusgr))))))).
