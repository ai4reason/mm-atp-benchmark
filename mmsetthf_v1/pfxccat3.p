...
thf(a_2if2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ (cwa @ Xph @ Xps) @ (cwceq @ XD @ XA2)) => ((cwi @ (cw3a @ Xph @ (cwn @ Xps) @ Xth) @ (cwceq @ XD @ XB2)) => ((cwi @ (cw3a @ Xph @ (cwn @ Xps) @ (cwn @ Xth)) @ (cwceq @ XD @ XC)) => (cwi @ Xph @ (cwceq @ XD @ (ccif @ Xps @ XA2 @ (ccif @ Xth @ XB2 @ XC))))))))))))))).
...
thf(aswrdccatin1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwi @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XA2 @ cchash) @ ccfz))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ XM @ XN) @ ccsubstr) @ (cco @ XA2 @ (ccop @ XM @ XN) @ ccsubstr)))))))))).
...
thf(aswrdccatin2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwi @ (cwa @ (cwcel @ XM @ (cco @ XL @ XN @ ccfz)) @ (cwcel @ XN @ (cco @ XL @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ XM @ XN) @ ccsubstr) @ (cco @ XB2 @ (ccop @ (cco @ XM @ XL @ ccmin) @ (cco @ XN @ XL @ ccmin)) @ ccsubstr)))))))))))).
