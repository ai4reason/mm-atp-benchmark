...
thf(afsumrev2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (XA2 @ Xj) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ (cco @ XM @ XN @ ccaddc) @ (ccv @ Xk) @ ccmin)) @ (cwceq @ (XA2 @ Xj) @ (XB2 @ Xk))))) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xj:$i] : (XA2 @ Xj))) @ (ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk))))))))))))).
...
thf(cfsum0diag2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xk)) @ (cwceq @ (XB2 @ Xx3 @ Xj) @ (XA2 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ ccmin)) @ (cwceq @ (XB2 @ Xx3 @ Xj) @ (XC @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwa @ (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ (cco @ XN @ (ccv @ Xj) @ ccmin) @ ccfz)))) @ (cwcel @ (XA2 @ Xj @ Xk) @ ccc))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xj:$i] : (ccsu @ (cco @ ccc0 @ (cco @ XN @ (ccv @ Xj) @ ccmin) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xj @ Xk))))) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (ccsu @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (^ [Xj:$i] : (XC @ Xj @ Xk))))))))))))))))).
