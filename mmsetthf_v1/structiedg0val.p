...
thf(cstructiedg0val_conj,conjecture,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XS @ ccn) => ((cwbr @ (ccfv @ ccnx @ ccbs) @ XS @ cclt) => ((cwceq @ XG @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ XS @ XE))) => (cwi @ (cw3a @ (cwcel @ XV @ XX) @ (cwcel @ XE @ XY) @ (cwne @ XS @ (ccfv @ ccnx @ ccedgf))) @ (cwceq @ (ccfv @ XG @ cciedg) @ cc0)))))))))))).
