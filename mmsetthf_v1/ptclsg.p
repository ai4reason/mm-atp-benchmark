...
thf(aacni3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1))) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xg1)))))) => (cwi @ (cwa @ (cwcel @ XX @ (cwacn @ XA2)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XA2))) @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwf @ XA2 @ XX @ (ccv @ Xg1)) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xg1)) @ (^ [Xx3:$i] : XA2)))))))))))).
...
thf(aixpin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (cwceq @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccin @ (XB2 @ Xx3) @ (XC @ Xx3)))) @ (ccin @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(aelcls3_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (XJ @ Xx3) @ (ccfv @ XB2 @ cctg)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (XX @ Xx3) @ (ccuni @ (XJ @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ cctb))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XS @ (XX @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XP @ (XX @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ (XJ @ Xx3) @ cccl))) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwne @ (ccin @ (ccv @ Xx3) @ XS) @ cc0))) @ (^ [Xx3:$i] : XB2))))))))))))))))).
