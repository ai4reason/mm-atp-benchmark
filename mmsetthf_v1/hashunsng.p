...
thf(chashunsng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwn @ (cwcel @ XB2 @ XA2))) @ (cwceq @ (ccfv @ (ccun @ XA2 @ (ccsn @ XB2)) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccaddc)))))))).
