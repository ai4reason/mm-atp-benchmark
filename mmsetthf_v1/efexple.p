...
thf(cefexple_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwcel @ XN @ ccz) @ (cwcel @ XB2 @ ccrp)) @ (cwb @ (cwbr @ (cco @ XA2 @ XN @ ccexp) @ XB2 @ ccle) @ (cwbr @ XN @ (ccfv @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XA2 @ cclog) @ ccdiv) @ ccfl) @ ccle))))))).
