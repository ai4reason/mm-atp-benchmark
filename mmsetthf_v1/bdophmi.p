...
thf(alnopmi_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (cco @ XA2 @ XT @ cchot) @ cclo)))))).
...
thf(anmophmi_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ XA2 @ XT @ cchot) @ ccnop) @ (cco @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XT @ ccnop) @ ccmul))))))).
...
thf(cbdophmi_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (cco @ XA2 @ XT @ cchot) @ ccbo)))))).
