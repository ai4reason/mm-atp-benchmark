...
thf(cseq1hcau_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwf @ ccn @ cchil @ XF) @ (cwb @ (cwcel @ XF @ cccau) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xz) @ XF) @ ccmv) @ ccno) @ (ccv @ Xx3) @ cclt)) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccrp)))))).
