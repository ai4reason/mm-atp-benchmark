...
thf(cintmin4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))) @ (cwceq @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XA2 @ (ccv @ Xx3)) @ (Xph @ Xx3))))) @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))))))).
