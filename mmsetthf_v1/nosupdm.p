...
thf(cnosupdm_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xg1 @ Xq @ Xp) @ (ccif @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : (XA2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccun @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : (XA2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsn @ (ccop @ (ccdm @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : (XA2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ cc2o))) @ (ccmpt @ (^ [Xg1:$i] : (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xy1)))))) @ (^ [Xv:$i] : (XA2 @ Xx3))))) @ (^ [Xu:$i] : (XA2 @ Xx3)))))) @ (^ [Xg1:$i] : (ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xg1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xg1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xg1)))))) @ (^ [Xv:$i] : (XA2 @ Xx3))) @ (cwceq @ (ccfv @ (ccv @ Xg1) @ (ccv @ Xu)) @ (ccv @ Xx3)))) @ (^ [Xu:$i] : (XA2 @ Xx3))))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : (XA2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (cwceq @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xg1 @ Xq @ Xp)) @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xp:$i] : (cwa @ (cwcel @ (ccv @ Xz) @ (ccdm @ (ccv @ Xp))) @ (cwral @ (^ [Xq:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xq) @ (ccv @ Xp) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xp) @ (ccsuc @ (ccv @ Xz))) @ (ccres @ (ccv @ Xq) @ (ccsuc @ (ccv @ Xz)))))) @ (^ [Xq:$i] : (XA2 @ Xx3))))) @ (^ [Xp:$i] : (XA2 @ Xx3))))))))))))))))))).
