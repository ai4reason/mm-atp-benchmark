...
thf(appisval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (ccin @ (cco @ cc2 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ ccprime))))).
...
thf(cchtprm_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cccht) @ (cco @ (ccfv @ XA2 @ cccht) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ ccaddc))))).
