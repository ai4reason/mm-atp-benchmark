...
thf(ametres_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ (ccres @ XD @ (ccxp @ XR @ XR)) @ (ccfv @ (ccin @ XX @ XR) @ ccme))))))).
...
thf(cressms_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccmt) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XK @ XA2 @ ccress) @ ccmt)))))).
