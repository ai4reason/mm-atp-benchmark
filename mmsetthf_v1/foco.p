...
thf(arncoeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwceq @ (ccdm @ XA2) @ (ccrn @ XB2)) @ (cwceq @ (ccrn @ (cccom @ XA2 @ XB2)) @ (ccrn @ XA2)))))).
thf(cfoco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfo @ XB2 @ XC @ XF) @ (cwfo @ XA2 @ XB2 @ XG)) @ (cwfo @ XA2 @ XC @ (cccom @ XF @ XG))))))))).
