...
thf(adnicld2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccfv @ XA2 @ (XT @ Xx3)) @ ccr))))))))).
...
thf(adnibnd_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (ccfv @ (cco @ (ccfv @ XB2 @ (XT @ Xx3)) @ (ccfv @ XA2 @ (XT @ Xx3)) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ ccle))))))))))).
...
thf(cknoppndvlem11_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XT @ Xx3 @ Xi) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xi @ Xn) @ (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3 @ Xi) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xi) @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xi)) @ ccmul)))))))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccr))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3 @ Xi) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XJ @ Xx3) @ ccn0))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XN @ Xi) @ ccn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ ccmin) @ ccabs) @ (cco @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (cco @ (cco @ (cco @ cc2 @ (XN @ Xi) @ ccmul) @ (ccfv @ (XC @ Xx3 @ Xi) @ ccabs) @ ccmul) @ (ccv @ Xi) @ ccexp))) @ ccmul) @ ccle))))))))))))))))))))).
