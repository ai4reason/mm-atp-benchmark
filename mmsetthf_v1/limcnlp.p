...
thf(climcnlp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwi @ Xph @ (cwn @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp))))) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XB2 @ cclimc) @ ccc))))))))))))).
