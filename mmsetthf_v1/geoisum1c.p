...
thf(ageoisum1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) @ (cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) @ (cco @ XA2 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccz_tp,type,(ccz : ($i > $o))).
thf(aisummulc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XA2 @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XB2 @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccmul) @ (ccsu @ XZ @ (^ [Xk:$i] : (cco @ XB2 @ (XA2 @ Xk) @ ccmul)))))))))))))))))).
...
thf(cgeoisum1c_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XR @ ccc) @ (cwbr @ (ccfv @ XR @ ccabs) @ cc1 @ cclt)) @ (cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ XR @ (ccv @ Xk) @ ccexp) @ ccmul))) @ (cco @ (cco @ XA2 @ XR @ ccmul) @ (cco @ cc1 @ XR @ ccmin) @ ccdiv)))))).
