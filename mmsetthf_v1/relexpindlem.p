...
thf(ajccil_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ (cwa @ Xch @ Xps)))))))).
...
thf(arelexpsucl_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ XV) @ (cwrel @ XR) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) @ (cccom @ XR @ (cco @ XR @ XN @ ccrelexp)))))))).
...
thf(crelexpindlem_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [Xet:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xn:$i] : ((cwi @ Xet @ (cwrel @ XR)) => ((cwi @ Xet @ (cwcel @ XR @ ccvv)) => ((cwi @ Xet @ (cwcel @ XS @ ccvv)) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwceq @ (ccv @ Xi) @ XS) @ (cwb @ (Xph @ Xi) @ (Xch @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ (cwceq @ (ccv @ Xi) @ (ccv @ Xx3)) @ (cwb @ (Xph @ Xi) @ (Xps @ Xx3))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwceq @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwb @ (Xph @ Xi) @ (Xth @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xet @ (Xch @ Xx3 @ Xj)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xet @ (cwi @ (cwbr @ (ccv @ Xj) @ (ccv @ Xx3) @ XR) @ (cwi @ (Xth @ Xx3 @ Xj) @ (Xps @ Xx3)))))) => (! [Xx3:$i] : (cwi @ Xet @ (cwi @ (cwcel @ (ccv @ Xn) @ ccn0) @ (cwi @ (cwbr @ XS @ (ccv @ Xx3) @ (cco @ XR @ (ccv @ Xn) @ ccrelexp)) @ (Xps @ Xx3)))))))))))))))))))))).
