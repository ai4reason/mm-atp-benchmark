...
thf(cltrec1d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ cc1 @ XB2 @ ccdiv) @ XA2 @ cclt))))))))).
