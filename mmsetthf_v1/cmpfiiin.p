...
thf(ariinint_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwral @ (^ [Xk:$i] : (cwss @ (XS @ Xk) @ XX)) @ (^ [Xk:$i] : (XI @ Xk)))) @ (cwceq @ (ccin @ XX @ (cciin @ (^ [Xk:$i] : (XI @ Xk)) @ (^ [Xk:$i] : (XS @ Xk)))) @ (ccint @ (ccun @ (ccsn @ XX) @ (ccrn @ (ccmpt @ (^ [Xk:$i] : (XI @ Xk)) @ (^ [Xk:$i] : (XS @ Xk))))))))))))).
...
thf(aelrfirn2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwral @ (^ [Xy1:$i] : (cwss @ (XC @ Xy1) @ XB2)) @ (^ [Xy1:$i] : XI))) @ (cwb @ (cwcel @ (XA2 @ Xy1) @ (ccfv @ (ccun @ (ccsn @ XB2) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (XC @ Xy1))))) @ ccfi)) @ (cwrex @ (^ [Xv:$i] : (cwceq @ (XA2 @ Xy1) @ (ccin @ XB2 @ (cciin @ (^ [Xy1:$i] : (ccv @ Xv)) @ (^ [Xy1:$i] : (XC @ Xy1)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XI) @ ccfn)))))))))))).
thf(acmpfii_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cccmp) @ (cwss @ XX @ (ccfv @ XJ @ cccld)) @ (cwn @ (cwcel @ cc0 @ (ccfv @ XX @ ccfi)))) @ (cwne @ (ccint @ XX) @ cc0))))).
thf(ccmpfiiin_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ Xph @ (cwcel @ XJ @ cccmp)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XI)) @ (cwcel @ (XS @ Xk) @ (ccfv @ XJ @ cccld)))) => ((! [Xl:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwss @ (ccv @ Xl) @ XI) @ (cwcel @ (ccv @ Xl) @ ccfn))) @ (cwne @ (ccin @ XX @ (cciin @ (^ [Xk:$i] : (ccv @ Xl)) @ (^ [Xk:$i] : (XS @ Xk)))) @ cc0))) => (cwi @ Xph @ (cwne @ (ccin @ XX @ (cciin @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (XS @ Xk)))) @ cc0)))))))))))).
