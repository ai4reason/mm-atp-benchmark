...
thf(cmarrepval_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XB2 @ Xi @ Xj) @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XQ @ Xi @ Xj) @ (cco @ XN @ XR @ ccmarrep)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_0 @ Xi @ Xj) @ (ccfv @ XR @ cc0g)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ (XB2 @ Xi @ Xj)) @ (cwcel @ XS @ (ccfv @ XR @ ccbs))) @ (cwa @ (cwcel @ XK @ XN) @ (cwcel @ XL @ XN))) @ (cwceq @ (cco @ XK @ XL @ (cco @ XM @ XS @ (XQ @ Xi @ Xj))) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ XK) @ (ccif @ (cwceq @ (ccv @ Xj) @ XL) @ XS @ (Xc_0 @ Xi @ Xj)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM)))))))))))))))))))))))).
