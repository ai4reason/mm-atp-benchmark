...
thf(arelexpnndm_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XR @ XV)) @ (cwss @ (ccdm @ (cco @ XR @ XN @ ccrelexp)) @ (ccdm @ XR))))))).
...
thf(crelexpdmg_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XR @ XV)) @ (cwss @ (ccdm @ (cco @ XR @ XN @ ccrelexp)) @ (ccun @ (ccdm @ XR) @ (ccrn @ XR)))))))).
