...
thf(adf_nrm_ax,axiom,(cwceq @ ccnrm @ (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xj) @ cccl)) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xj)))) @ (^ [Xy1:$i] : (ccin @ (ccfv @ (ccv @ Xj) @ cccld) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : (ccv @ Xj)))) @ (^ [Xj:$i] : cctop)))).
thf(cisnrm_conj,conjecture,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccnrm) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccfv @ (ccv @ Xz) @ (ccfv @ XJ @ cccl)) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XJ))) @ (^ [Xy1:$i] : (ccin @ (ccfv @ XJ @ cccld) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XJ)))))).
