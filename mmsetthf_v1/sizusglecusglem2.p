...
thf(acusgrfi_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ cccusgr) @ (cwcel @ XE @ ccfn)) @ (cwcel @ XV @ ccfn)))))))).
...
thf(csizusglecusglem2_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XV @ (ccfv @ XH @ ccvtx)) => ((cwceq @ XF @ (ccfv @ XH @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XH @ cccusgr) @ (cwcel @ XF @ ccfn)) @ (cwcel @ XE @ ccfn)))))))))))).
