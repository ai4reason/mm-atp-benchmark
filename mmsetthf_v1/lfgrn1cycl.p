...
thf(acycliswlk_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccycls)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))).
...
thf(alfgrwlknloop_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xx3) @ ccvtx))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwf @ (ccdm @ XI) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ XI) @ (cwbr @ XF @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccwlks))) @ (cwral @ (^ [Xk:$i] : (cwne @ (ccfv @ (ccv @ Xk) @ (XP @ Xx3)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XP @ Xx3)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))))))).
...
thf(clfgrn1cycl_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => (! [Xx3:$i] : (cwi @ (cwf @ (ccdm @ XI) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ XI) @ (cwi @ (cwbr @ XF @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ cccycls)) @ (cwne @ (ccfv @ XF @ cchash) @ cc1)))))))))))).
