...
thf(alnopeqi_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwcel @ XU @ cclo) => (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) @ (cco @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XT @ XU))))))).
...
thf(clnopeq_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cclo) @ (cwcel @ XU @ cclo)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) @ (cco @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XT @ XU)))))).
