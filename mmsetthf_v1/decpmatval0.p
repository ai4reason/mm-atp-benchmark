...
thf(cdecpmatval0_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwcel @ XM @ (XV @ Xi @ Xj)) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (cco @ XM @ XK @ ccdecpmat) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdm @ (ccdm @ XM)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdm @ (ccdm @ XM)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ XK @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1))))))))))))).
