...
thf(crelexpsucl_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ XV) @ (cwrel @ XR) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) @ (cccom @ XR @ (cco @ XR @ XN @ ccrelexp)))))))).
