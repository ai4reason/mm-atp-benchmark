...
thf(cind0_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO) @ (cwcel @ XX @ (ccdif @ XO @ XA2))) @ (cwceq @ (ccfv @ XX @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) @ ccc0))))))).
