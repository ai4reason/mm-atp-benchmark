...
thf(cmodmulconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn)) @ (cwcel @ XM @ ccn)) @ (cwb @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XB2 @ XM @ ccmo)) @ (cwceq @ (cco @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XM @ ccmul) @ ccmo) @ (cco @ (cco @ XC @ XB2 @ ccmul) @ (cco @ XC @ XM @ ccmul) @ ccmo))))))))).
