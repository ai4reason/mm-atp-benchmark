...
thf(avolres_thm,axiom,(cwceq @ ccvol @ (ccres @ ccovol @ (ccdm @ ccvol)))).
...
thf(afunssxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwa @ (cwfun @ XF) @ (cwss @ XF @ (ccxp @ XA2 @ XB2))) @ (cwa @ (cwf @ (ccdm @ XF) @ XB2 @ XF) @ (cwss @ (ccdm @ XF) @ XA2))))))).
