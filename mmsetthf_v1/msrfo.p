...
thf(amstaval_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XR @ (ccfv @ XT @ ccmsr)) => ((cwceq @ XS @ (ccfv @ XT @ ccmsta)) => (cwceq @ XS @ (ccrn @ XR)))))))).
thf(afoeq3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwfo @ XC @ XA2 @ XF) @ (cwfo @ XC @ XB2 @ XF)))))))).
thf(cmsrfo_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XR @ (ccfv @ XT @ ccmsr)) => ((cwceq @ XS @ (ccfv @ XT @ ccmsta)) => ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => (cwfo @ XP @ XS @ XR))))))))).
