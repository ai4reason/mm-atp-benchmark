...
thf(adf_bj_proj_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cbj_cproj @ XA2 @ XB2) @ (ccab @ (^ [Xx3:$i] : (cwcel @ (ccsn @ (ccv @ Xx3)) @ (ccima @ XB2 @ (ccsn @ XA2))))))))).
...
thf(cbj_projun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (cbj_cproj @ XA2 @ (ccun @ XB2 @ XC)) @ (ccun @ (cbj_cproj @ XA2 @ XB2) @ (cbj_cproj @ XA2 @ XC))))))).
