...
thf(amapcdaen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) @ (cwbr @ (cco @ XA2 @ (cco @ XB2 @ XC @ cccda) @ ccmap) @ (ccxp @ (cco @ XA2 @ XB2 @ ccmap) @ (cco @ XA2 @ XC @ ccmap)) @ ccen))))))))).
...
thf(cpwcdaen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwbr @ (ccpw @ (cco @ XA2 @ XB2 @ cccda)) @ (ccxp @ (ccpw @ XA2) @ (ccpw @ XB2)) @ ccen))))))).
