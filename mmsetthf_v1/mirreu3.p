...
thf(cmirreu3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xb:$i] : (cwceq @ XP @ (ccfv @ (XG @ Xb) @ ccbs))) => ((! [Xb:$i] : (cwceq @ Xc_mi @ (ccfv @ (XG @ Xb) @ ccds))) => ((! [Xb:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xb) @ ccitv))) => ((! [Xb:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xb) @ ccstrkg))) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XM @ XP)) => (cwi @ Xph @ (cwreu @ (^ [Xb:$i] : (cwa @ (cwceq @ (cco @ XM @ (ccv @ Xb) @ Xc_mi) @ (cco @ XM @ XA2 @ Xc_mi)) @ (cwcel @ XM @ (cco @ (ccv @ Xb) @ XA2 @ XI)))) @ (^ [Xb:$i] : XP))))))))))))))))).
