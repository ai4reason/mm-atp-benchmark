...
thf(cmthmi_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (ccfv @ XT @ ccmsr)) => ((cwceq @ XJ @ (ccfv @ XT @ ccmpps)) => ((cwceq @ XU @ (ccfv @ XT @ ccmthm)) => (cwi @ (cwa @ (cwcel @ XX @ XJ) @ (cwceq @ (ccfv @ XX @ XR) @ (ccfv @ XY @ XR))) @ (cwcel @ XY @ XU)))))))))))).
