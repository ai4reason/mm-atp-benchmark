...
thf(ablres_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccres @ XD @ (ccxp @ XY @ XY))) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ (ccin @ XX @ XY)) @ (cwcel @ XR @ ccxr)) @ (cwceq @ (cco @ XP @ XR @ (ccfv @ XC @ ccbl)) @ (ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ XY))))))))))).
...
thf(csstotbnd2_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccres @ XM @ (ccxp @ XY @ XY))) => (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwss @ XY @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ XY @ cctotbnd)) @ (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ XY @ (cciun @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XX) @ ccfn)))) @ (^ [Xd:$i] : ccrp)))))))))).
