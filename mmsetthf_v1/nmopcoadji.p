...
thf(aadjbdlnb_thm,axiom,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ ccbo) @ (cwcel @ (ccfv @ XT @ ccado) @ ccbo)))).
...
thf(anmbdoplbi_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => (cwi @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccno) @ (cco @ (ccfv @ XT @ ccnop) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle)))))).
...
thf(anmopadji_thm,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => (cwceq @ (ccfv @ (ccfv @ XT @ ccado) @ ccnop) @ (ccfv @ XT @ ccnop))))).
...
thf(aadj2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ (ccdm @ ccado)) @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ (ccfv @ XA2 @ XT) @ XB2 @ ccsp) @ (cco @ XA2 @ (ccfv @ XB2 @ (ccfv @ XT @ ccado)) @ ccsp))))))).
...
thf(cnmopcoadji_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => (cwceq @ (ccfv @ (cccom @ (ccfv @ XT @ ccado) @ XT) @ ccnop) @ (cco @ (ccfv @ XT @ ccnop) @ cc2 @ ccexp))))).
