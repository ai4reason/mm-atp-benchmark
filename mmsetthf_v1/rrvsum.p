...
thf(arrvadd_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprb)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((cwi @ Xph @ (cwcel @ XY @ (ccfv @ XP @ ccrrv))) => (cwi @ Xph @ (cwcel @ (cco @ XX @ XY @ (ccof @ ccaddc)) @ (ccfv @ XP @ ccrrv))))))))))).
...
thf(crrvsum_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprb)) => ((cwi @ Xph @ (cwf @ ccn @ (ccfv @ XP @ ccrrv) @ XX)) => ((cwi @ (cwa @ Xph @ (cwcel @ XN @ ccn)) @ (cwceq @ XS @ (ccfv @ XN @ (ccseq @ (ccof @ ccaddc) @ XX @ cc1)))) => (cwi @ (cwa @ Xph @ (cwcel @ XN @ ccn)) @ (cwcel @ XS @ (ccfv @ XP @ ccrrv)))))))))))).
