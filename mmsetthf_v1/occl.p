...
thf(aoccllem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ cchil)) => ((cwi @ Xph @ (cwcel @ XF @ cccau)) => ((cwi @ Xph @ (cwf @ ccn @ (ccfv @ XA2 @ ccort) @ XF)) => ((cwi @ Xph @ (cwcel @ XB2 @ XA2)) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ XF @ cchli) @ XB2 @ ccsp) @ ccc0))))))))))).
...
thf(aisch3_thm,axiom,(! [XH:($i > $o)] : (cwb @ (cwcel @ XH @ ccch) @ (cwa @ (cwcel @ XH @ ccsh) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwf @ ccn @ XH @ (ccv @ Xf1)) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ cchli)) @ (^ [Xx3:$i] : XH)))) @ (^ [Xf1:$i] : cccau)))))).
thf(coccl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ cchil) @ (cwcel @ (ccfv @ XA2 @ ccort) @ ccch)))).
