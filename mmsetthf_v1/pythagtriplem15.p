...
thf(apythagtriplem12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (cco @ (cco @ (ccfv @ (cco @ XC @ XB2 @ ccaddc) @ ccsqrt) @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccsqrt) @ ccaddc) @ cc2 @ ccdiv)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ XC @ cc2 @ ccexp)) @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds)))) @ (cwceq @ (cco @ XM @ cc2 @ ccexp) @ (cco @ (cco @ XC @ XA2 @ ccaddc) @ cc2 @ ccdiv))))))))).
thf(apythagtriplem14_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (ccfv @ (cco @ XC @ XB2 @ ccaddc) @ ccsqrt) @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccsqrt) @ ccmin) @ cc2 @ ccdiv)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ XC @ cc2 @ ccexp)) @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds)))) @ (cwceq @ (cco @ XN @ cc2 @ ccexp) @ (cco @ (cco @ XC @ XA2 @ ccmin) @ cc2 @ ccdiv))))))))).
