...
thf(aax_hgprmladderOLD_ax,axiom,(cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cw3a @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ cc7) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xf1)) @ (ccdc @ cc1 @ cc3)) @ (cwceq @ (ccfv @ (ccv @ Xd) @ (ccv @ Xf1)) @ (cco @ (ccdc @ cc8 @ cc9) @ (cco @ cc10 @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul))) @ (cwral @ (^ [Xi:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccmin) @ (cco @ (cco @ cc4 @ (cco @ cc10 @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ cc4 @ ccmin) @ cclt) @ (cwbr @ cc4 @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccmin) @ cclt))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xd) @ ccfzo))))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xd) @ cciccp)))) @ (^ [Xd:$i] : (ccfv @ cc3 @ ccuz)))).
...
thf(a_1t10e1p1e11OLD_thm,axiom,(cwceq @ (ccdc @ cc1 @ cc1) @ (cco @ (cco @ cc1 @ (cco @ cc10 @ cc1 @ ccexp) @ ccmul) @ cc1 @ ccaddc))).
...
thf(ctgblthelfgottOLD_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccodd) @ (cwbr @ cc7 @ XN @ cclt) @ (cwbr @ XN @ (cco @ (ccdc @ cc8 @ cc8) @ (cco @ cc10 @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul) @ cclt)) @ (cwcel @ XN @ ccgbo)))).
