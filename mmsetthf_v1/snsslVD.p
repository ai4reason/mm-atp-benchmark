...
thf(ae10an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwvd1 @ Xph @ Xps) => (Xch => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwvd1 @ Xph @ Xth))))))))).
...
thf(csnsslVD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwss @ (ccsn @ XA2) @ XB2) @ (cwcel @ XA2 @ XB2)))))).
