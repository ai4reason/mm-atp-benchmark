...
thf(aamgmw2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XP @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XQ @ ccrp)) => ((cwi @ Xph @ (cwceq @ (cco @ XP @ XQ @ ccaddc) @ cc1)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ XA2 @ XP @ cccxp) @ (cco @ XB2 @ XQ @ cccxp) @ ccmul) @ (cco @ (cco @ XA2 @ XP @ ccmul) @ (cco @ XB2 @ XQ @ ccmul) @ ccaddc) @ ccle))))))))))))).
...
thf(cyoung2d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XP @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XQ @ ccrp)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ cc1 @ XP @ ccdiv) @ (cco @ cc1 @ XQ @ ccdiv) @ ccaddc) @ cc1)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ XP @ cccxp) @ XP @ ccdiv) @ (cco @ (cco @ XB2 @ XQ @ cccxp) @ XQ @ ccdiv) @ ccaddc) @ ccle))))))))))))).
