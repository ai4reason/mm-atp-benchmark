...
thf(cfourierdlem17_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioc)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XB2) @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioc) @ (cco @ XA2 @ XB2 @ ccicc) @ (XL @ Xx3))))))))))))).
