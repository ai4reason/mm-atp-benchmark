...
thf(adf_plq_ax,axiom,(cwceq @ ccplq @ (ccres @ (cccom @ ccerq @ ccplpq) @ (ccxp @ ccnq @ ccnq)))).
...
thf(caddpqnq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnq) @ (cwcel @ XB2 @ ccnq)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccplq) @ (ccfv @ (cco @ XA2 @ XB2 @ ccplpq) @ ccerq)))))).
