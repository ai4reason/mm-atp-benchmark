...
thf(aindsumin_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XO @ (XV @ Xk)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ XO)) => ((cwi @ Xph @ (cwss @ XB2 @ XO)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XC @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ XB2 @ (ccfv @ XO @ ccind))) @ (XC @ Xk) @ ccmul))) @ (ccsu @ (ccin @ XA2 @ XB2) @ (^ [Xk:$i] : (XC @ Xk))))))))))))))))).
...
thf(ahashreprin_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XB2 @ ccn)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ (ccin @ XA2 @ XB2) @ XM @ (ccfv @ XS @ ccrepr)) @ cchash) @ (ccsu @ (cco @ XB2 @ XM @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ XA2 @ (ccfv @ ccn @ ccind)))))))))))))))))))).
...
thf(cbreprexpnat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XZ @ ccc)) => ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((! [Xm:$i] : (! [Xb:$i] : (cwceq @ (XP @ Xm @ Xb) @ (ccsu @ (ccin @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ (^ [Xb:$i] : (cco @ XZ @ (ccv @ Xb) @ ccexp)))))) => ((! [Xm:$i] : (! [Xb:$i] : (cwceq @ (XR @ Xm @ Xb) @ (ccfv @ (cco @ (ccin @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ cchash)))) => (! [Xm:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XP @ Xm @ Xb) @ XS @ ccexp) @ (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (cco @ (XR @ Xm @ Xb) @ (cco @ XZ @ (ccv @ Xm) @ ccexp) @ ccmul))))))))))))))))))))).
