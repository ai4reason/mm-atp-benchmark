...
thf(aisfin3_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfin3) @ (cwcel @ (ccpw @ XA2) @ ccfin4)))).
...
thf(cisfin32i_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfin3) @ (cwn @ (cwbr @ ccom @ XA2 @ ccwdom))))).
