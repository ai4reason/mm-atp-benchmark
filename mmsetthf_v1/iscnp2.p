...
thf(adf_cnp_ax,axiom,(cwceq @ cccnp @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : (ccmpt @ (^ [Xx3:$i] : (ccuni @ (ccv @ Xj))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xy1)) @ (cwrex @ (^ [Xg1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xg1)) @ (ccv @ Xy1)))) @ (^ [Xg1:$i] : (ccv @ Xj))))) @ (^ [Xy1:$i] : (ccv @ Xk)))) @ (^ [Xf1:$i] : (cco @ (ccuni @ (ccv @ Xk)) @ (ccuni @ (ccv @ Xj)) @ ccmap)))))))))).
...
thf(acnpfval_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xv:$i] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ (XX @ Xv) @ cctopon)) @ (cwcel @ (XK @ Xv) @ (ccfv @ (XY @ Xv) @ cctopon))) @ (cwceq @ (cco @ XJ @ (XK @ Xv) @ cccnp) @ (ccmpt @ (^ [Xx3:$i] : (XX @ Xv)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xw)) @ (cwrex @ (^ [Xv:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xv)) @ (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xv)) @ (ccv @ Xw)))) @ (^ [Xv:$i] : XJ)))) @ (^ [Xw:$i] : (XK @ Xv)))) @ (^ [Xf1:$i] : (cco @ (XY @ Xv) @ (XX @ Xv) @ ccmap))))))))))))).
