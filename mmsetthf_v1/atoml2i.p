...
thf(apjoml5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwceq @ (cco @ XA2 @ (ccin @ (ccfv @ XA2 @ ccort) @ (cco @ XA2 @ XB2 @ cchj)) @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))))).
...
thf(aatomli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwcel @ XB2 @ ccat) @ (cwcel @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ XA2 @ ccort)) @ (ccun @ ccat @ (ccsn @ cc0h)))))))).
...
thf(catoml2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwa @ (cwcel @ XB2 @ ccat) @ (cwn @ (cwss @ XB2 @ XA2))) @ (cwcel @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ XA2 @ ccort)) @ ccat)))))).
