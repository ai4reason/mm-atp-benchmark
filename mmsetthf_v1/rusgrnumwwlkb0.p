...
thf(awrdl1s1_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwb @ (cwceq @ XW @ (ccs1 @ XS)) @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwceq @ (ccfv @ XW @ cchash) @ cc1) @ (cwceq @ (ccfv @ ccc0 @ XW) @ XS)))))))).
...
thf(crusgrnumwwlkb0_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XL @ Xw @ Xv @ Xn) @ (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn))) @ cchash)))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ XV)) @ (cwceq @ (cco @ XP @ ccc0 @ (XL @ Xw @ Xv @ Xn)) @ cc1)))))))))))).
