...
thf(ann0sumshdig_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwceq @ XA2 @ (ccsu @ (cco @ ccc0 @ (ccfv @ XA2 @ ccblen) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ XA2 @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul))))))).
...
thf(cnn0mullong_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmul) @ (ccsu @ (cco @ ccc0 @ (ccfv @ XA2 @ ccblen) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ (ccv @ Xk) @ XA2 @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul) @ XB2 @ ccmul)))))))).
