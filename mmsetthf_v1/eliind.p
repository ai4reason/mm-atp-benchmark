...
thf(celiind_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XK @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XK) @ (cwb @ (cwcel @ XA2 @ (XC @ Xx3)) @ (cwcel @ XA2 @ XD)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ XD))))))))))))).
