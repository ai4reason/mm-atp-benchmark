...
thf(austex2sym_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU)) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (cccnv @ (ccv @ Xw)) @ (ccv @ Xw)) @ (cwss @ (cccom @ (ccv @ Xw) @ (ccv @ Xw)) @ XV))) @ (^ [Xw:$i] : XU))))))).
...
thf(custex3sym_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU)) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (cccnv @ (ccv @ Xw)) @ (ccv @ Xw)) @ (cwss @ (cccom @ (ccv @ Xw) @ (cccom @ (ccv @ Xw) @ (ccv @ Xw))) @ XV))) @ (^ [Xw:$i] : XU))))))).
