...
thf(arrnmbl_thm,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => (cwi @ Xph @ (cwcel @ (cco @ ccr @ XX @ ccmap) @ (ccdm @ (ccfv @ XX @ ccvoln)))))))).
...
thf(choimbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwceq @ XS @ (ccdm @ (ccfv @ XX @ ccvoln))) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XA2)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XB2)) => (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccico))) @ XS)))))))))))).
