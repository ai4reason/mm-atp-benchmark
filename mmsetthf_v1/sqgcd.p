...
thf(csqgcd_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ (cco @ XM @ XN @ ccgcd) @ cc2 @ ccexp) @ (cco @ (cco @ XM @ cc2 @ ccexp) @ (cco @ XN @ cc2 @ ccexp) @ ccgcd)))))).
