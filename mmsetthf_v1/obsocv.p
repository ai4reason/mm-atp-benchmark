...
thf(cobsocv_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwceq @ (ccfv @ XB2 @ Xc_pe) @ (ccsn @ Xc_0)))))))))).
