...
thf(aopidon2OLD_thm,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwcel @ XG @ (ccin @ ccmagm @ ccexid)) @ (cwfo @ (ccxp @ XX @ XX) @ XX @ XG)))))).
