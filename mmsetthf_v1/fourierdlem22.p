...
thf(acnmbf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf))) @ (cwcel @ XF @ ccmbf))))).
...
thf(aabscosbd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ cccos) @ ccabs) @ cc1 @ ccle)))).
thf(arspcev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ Xps) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(aralbidv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwb @ (Xps @ Xx3) @ (Xch @ Xx3)))) => (cwi @ Xph @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
thf(abreq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwbr @ XC @ XA2 @ XR) @ (cwbr @ XC @ XB2 @ XR)))))))).
thf(ccofr_tp,type,(ccofr : (($i > $o) > ($i > $o)))).
thf(abddmulibl_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ ccmbf) @ (cwcel @ XG @ ccibl) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccdm @ XF)))) @ (^ [Xx3:$i] : ccr))) @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccibl))))).
...
thf(aabssinbd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ ccsin) @ ccabs) @ cc1 @ ccle)))).
thf(cfourierdlem22_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwi @ Xph @ (cwf @ ccr @ ccr @ (XF @ Xn)))) => ((! [Xn:$i] : (cwceq @ (XC @ Xn) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (ccres @ (XF @ Xn) @ (XC @ Xn)) @ ccibl))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (XC @ Xn)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xn)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv)))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (XC @ Xn)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xn)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv)))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwa @ (cwi @ (cwcel @ (ccv @ Xn) @ ccn0) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xn)) @ ccr)) @ (cwi @ (cwcel @ (ccv @ Xn) @ ccn) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xn)) @ ccr))))))))))))))))).
