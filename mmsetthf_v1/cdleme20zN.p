...
thf(ccdleme20zN_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2) @ (cwcel @ XT @ XA2)) @ (cwa @ (cwne @ XS @ XT) @ (cwn @ (cwbr @ XR @ (cco @ XS @ XT @ Xc_or) @ Xc_le)))) @ (cwceq @ (cco @ (cco @ XS @ XR @ Xc_or) @ XT @ Xc_an) @ (ccfv @ XK @ ccp0)))))))))))))))).
