...
thf(cplyexmo_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XD @ ccc) @ (cwn @ (cwcel @ XD @ ccfn))) @ (cwmo @ (^ [Xp:$i] : (cwa @ (cwcel @ (ccv @ Xp) @ (ccfv @ XS @ ccply)) @ (cwceq @ (ccres @ (ccv @ Xp) @ XD) @ XF))))))))).
