...
thf(ahashbclem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xz:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xj) @ (cwcel @ XA2 @ ccfn)))) => ((! [Xz:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xj) @ (cwn @ (cwcel @ (ccv @ Xz) @ XA2))))) => ((! [Xz:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xj) @ (cwral @ (^ [Xj:$i] : (cwceq @ (cco @ (ccfv @ XA2 @ cchash) @ (ccv @ Xj) @ ccbc) @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ (ccv @ Xj))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ cchash))) @ (^ [Xj:$i] : ccz))))) => ((! [Xz:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xj) @ (cwcel @ (XK @ Xz) @ ccz)))) => (! [Xz:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xj) @ (cwceq @ (cco @ (ccfv @ (ccun @ XA2 @ (ccsn @ (ccv @ Xz))) @ cchash) @ (XK @ Xz) @ ccbc) @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ (XK @ Xz))) @ (^ [Xx3:$i] : (ccpw @ (ccun @ XA2 @ (ccsn @ (ccv @ Xz)))))) @ cchash))))))))))))).
...
thf(chashbc_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XK @ ccz)) @ (cwceq @ (cco @ (ccfv @ XA2 @ cchash) @ XK @ ccbc) @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ XK)) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ cchash)))))).
