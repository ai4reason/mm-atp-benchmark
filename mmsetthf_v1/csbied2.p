...
thf(ccsbied2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ XA2 @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ (XB2 @ Xx3))) @ (cwceq @ (XC @ Xx3) @ XD))) => (cwi @ Xph @ (cwceq @ (ccsb @ XA2 @ (^ [Xx3:$i] : (XC @ Xx3))) @ XD)))))))))))).
