...
thf(cblelrnps_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccxr)) @ (cwcel @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccrn @ (ccfv @ XD @ ccbl))))))))).
