...
thf(apm5_501_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ Xph @ (cwb @ Xps @ (cwb @ Xph @ Xps)))))).
...
thf(anbn2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwn @ Xph) @ (cwb @ (cwn @ Xps) @ (cwb @ Xph @ Xps)))))).
...
thf(ahad1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ Xph @ (cwb @ (cwhad @ Xph @ Xps @ Xch) @ (cwb @ Xps @ Xch))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(acad1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ Xch @ (cwb @ (cwcad @ Xph @ Xps @ Xch) @ (cwo @ Xph @ Xps))))))).
...
thf(csadadd2lem2_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ (ccif @ (cwhad @ Xph @ Xps @ Xch) @ XA2 @ ccc0) @ (ccif @ (cwcad @ Xph @ Xps @ Xch) @ (cco @ cc2 @ XA2 @ ccmul) @ ccc0) @ ccaddc) @ (cco @ (cco @ (ccif @ Xph @ XA2 @ ccc0) @ (ccif @ Xps @ XA2 @ ccc0) @ ccaddc) @ (ccif @ Xch @ XA2 @ ccc0) @ ccaddc)))))))).
