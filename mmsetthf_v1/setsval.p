...
thf(csetsval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts) @ (ccun @ (ccres @ XS @ (ccdif @ ccvv @ (ccsn @ XA2))) @ (ccsn @ (ccop @ XA2 @ XB2))))))))))).
