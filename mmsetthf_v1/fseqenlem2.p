...
thf(afseqenlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xf1 @ Xn)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XB2 @ Xx3 @ Xf1 @ Xn) @ XA2))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (ccxp @ XA2 @ XA2) @ XA2 @ XF))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xf1 @ Xn) @ (ccseqom @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ (ccsuc @ (ccv @ Xn)) @ ccmap)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccres @ (ccv @ Xx3) @ (ccv @ Xn)) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xx3)) @ XF)))))) @ (ccsn @ (ccop @ cc0 @ (XB2 @ Xx3 @ Xf1 @ Xn)))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (XC @ Xx3 @ Xf1 @ Xn) @ ccom)) @ (cwf1 @ (cco @ XA2 @ (XC @ Xx3 @ Xf1 @ Xn) @ ccmap) @ XA2 @ (ccfv @ (XC @ Xx3 @ Xf1 @ Xn) @ (XG @ Xx3 @ Xf1 @ Xn))))))))))))))))))).
...
thf(amo2icl_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccv @ Xx3) @ XA2)))) @ (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
thf(adff12_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwf1 @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1) @ XF) @ (cwa @ (cwf @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1) @ XF) @ (cwal @ (^ [Xy1:$i] : (cwmo @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))))))))))))).
thf(cfseqenlem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xf1 @ Xk @ Xn)))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XB2 @ Xx3 @ Xf1 @ Xk @ Xn) @ XA2)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (ccxp @ XA2 @ XA2) @ XA2 @ (XF @ Xy1 @ Xk)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xf1 @ Xn) @ (ccseqom @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ (ccsuc @ (ccv @ Xn)) @ ccmap)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccres @ (ccv @ Xx3) @ (ccv @ Xn)) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xx3)) @ (XF @ Xy1 @ Xk))))))) @ (ccsn @ (ccop @ cc0 @ (XB2 @ Xx3 @ Xf1 @ Xk @ Xn)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XK @ Xx3 @ Xy1 @ Xf1 @ Xk @ Xn) @ (ccmpt @ (^ [Xy1:$i] : (cciun @ (^ [Xk:$i] : ccom) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccmap)))) @ (^ [Xy1:$i] : (ccop @ (ccdm @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccdm @ (ccv @ Xy1)) @ (XG @ Xx3 @ Xf1 @ Xn)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1) @ (cwf1 @ (cciun @ (^ [Xk:$i] : ccom) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccmap))) @ (ccxp @ ccom @ XA2) @ (XK @ Xx3 @ Xy1 @ Xf1 @ Xk @ Xn))))))))))))))))))))).
