...
thf(cclmvs1_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => (cwi @ (cwa @ (cwcel @ XW @ ccclm) @ (cwcel @ XX @ XV)) @ (cwceq @ (cco @ cc1 @ XX @ Xc_x) @ XX))))))))).
