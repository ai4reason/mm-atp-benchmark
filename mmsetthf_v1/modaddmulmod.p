...
thf(amodaddmod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XM @ ccmo) @ XB2 @ ccaddc) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XM @ ccmo))))))).
...
thf(cmodaddmulmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccz)) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ (cco @ XB2 @ XM @ ccmo) @ XC @ ccmul) @ ccaddc) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccaddc) @ XM @ ccmo)))))))).
