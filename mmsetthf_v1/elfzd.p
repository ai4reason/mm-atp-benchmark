...
thf(celfzd_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((cwi @ Xph @ (cwbr @ XM @ XK @ ccle)) => ((cwi @ Xph @ (cwbr @ XK @ XN @ ccle)) => (cwi @ Xph @ (cwcel @ XK @ (cco @ XM @ XN @ ccfz))))))))))))).
