...
thf(cmuleqadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccaddc)) @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ XB2 @ cc1 @ ccmin) @ ccmul) @ cc1)))))).
