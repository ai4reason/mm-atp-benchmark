...
thf(aitg2uba_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ XG @ ccitg1) @ (ccfv @ XF @ ccitg2) @ ccle)))))))))))).
...
thf(aitg2leub_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) @ (cwcel @ XA2 @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ XF @ ccitg2) @ XA2 @ ccle) @ (cwral @ (^ [Xg1:$i] : (cwi @ (cwbr @ (ccv @ Xg1) @ XF @ (ccofr @ ccle)) @ (cwbr @ (ccfv @ (ccv @ Xg1) @ ccitg1) @ XA2 @ ccle))) @ (^ [Xg1:$i] : (ccdm @ ccitg1)))))))).
thf(citg2lea_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XG)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ XF @ ccitg2) @ (ccfv @ XG @ ccitg2) @ ccle)))))))))))).
