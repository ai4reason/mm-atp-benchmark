...
thf(adf_qqh_ax,axiom,(cwceq @ ccqqh @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccima @ (cccnv @ (ccfv @ (ccv @ Xr) @ cczrh)) @ (ccfv @ (ccv @ Xr) @ ccui)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xr) @ cczrh)) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xr) @ cczrh)) @ (ccfv @ (ccv @ Xr) @ ccdvr))))))))))).
...
thf(cqqhval_conj,conjecture,(! [Xc_dv:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_dv @ Xx3 @ Xy1) @ (ccfv @ XR @ ccdvr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_1 @ Xx3 @ Xy1) @ (ccfv @ XR @ ccur)))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccfv @ XR @ cczrh))) => (cwi @ (cwcel @ XR @ ccvv) @ (cwceq @ (ccfv @ XR @ ccqqh) @ (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccima @ (cccnv @ (XL @ Xx3)) @ (ccfv @ XR @ ccui)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv) @ (cco @ (ccfv @ (ccv @ Xx3) @ (XL @ Xx3)) @ (ccfv @ (ccv @ Xy1) @ (XL @ Xx3)) @ (Xc_dv @ Xx3 @ Xy1))))))))))))))))).
