...
thf(cesumsn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xk) @ XM)) @ (cwceq @ (XA2 @ Xk) @ XB2))) => ((cwi @ Xph @ (cwcel @ XM @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (cwi @ Xph @ (cwceq @ (ccesum @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XB2))))))))))).
