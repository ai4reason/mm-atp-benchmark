...
thf(axpcco1st_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XT @ (cco @ XC @ XD @ ccxpc)) => ((cwceq @ XB2 @ (ccfv @ XT @ ccbs)) => ((cwceq @ XK @ (ccfv @ XT @ cchom)) => ((cwceq @ XO @ (ccfv @ XT @ ccco)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ XY @ XK))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XY @ XZ @ XK))) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ XO)) @ cc1st) @ (cco @ (ccfv @ XG @ cc1st) @ (ccfv @ XF @ cc1st) @ (cco @ (ccop @ (ccfv @ XX @ cc1st) @ (ccfv @ XY @ cc1st)) @ (ccfv @ XZ @ cc1st) @ Xc_x)))))))))))))))))))))))))))).
...
thf(c_1stfcl_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (cco @ XC @ XD @ ccxpc)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((cwceq @ XP @ (cco @ XC @ XD @ cc1stf)) => (cwi @ Xph @ (cwcel @ XP @ (cco @ XT @ XC @ ccfunc))))))))))))).
