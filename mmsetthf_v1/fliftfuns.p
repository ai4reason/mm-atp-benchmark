...
thf(cfliftfuns_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XX)) @ (cwcel @ (XA2 @ Xx3) @ XR))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XX)) @ (cwcel @ (XB2 @ Xx3) @ XS))) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwfun @ (XF @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwceq @ (ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsb @ (ccv @ Xz) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (cwceq @ (ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (ccv @ Xz) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX)))))))))))))))).
