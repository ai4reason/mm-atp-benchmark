...
thf(apsrass23_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (cco @ XI @ XR @ ccmps))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XI @ (XV @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XR @ ccrg))) => ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xf1:$i] : (cwceq @ (Xc_xp @ Xf1) @ (ccfv @ (XS @ Xf1) @ ccmulr))) => ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccfv @ (XS @ Xf1) @ ccbs))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XX @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XY @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XR @ cccrg))) => ((! [Xf1:$i] : (cwceq @ (XK @ Xf1) @ (ccfv @ XR @ ccbs))) => ((! [Xf1:$i] : (cwceq @ (Xc_x @ Xf1) @ (ccfv @ (XS @ Xf1) @ ccvsca))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XA2 @ Xf1) @ (XK @ Xf1)))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwa @ (cwceq @ (cco @ (cco @ (XA2 @ Xf1) @ XX @ (Xc_x @ Xf1)) @ XY @ (Xc_xp @ Xf1)) @ (cco @ (XA2 @ Xf1) @ (cco @ XX @ XY @ (Xc_xp @ Xf1)) @ (Xc_x @ Xf1))) @ (cwceq @ (cco @ XX @ (cco @ (XA2 @ Xf1) @ XY @ (Xc_x @ Xf1)) @ (Xc_xp @ Xf1)) @ (cco @ (XA2 @ Xf1) @ (cco @ XX @ XY @ (Xc_xp @ Xf1)) @ (Xc_x @ Xf1)))))))))))))))))))))))))))))))).
...
thf(cpsrassa_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwi @ Xph @ (cwcel @ XI @ XV)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => (cwi @ Xph @ (cwcel @ XS @ ccasa))))))))))).
