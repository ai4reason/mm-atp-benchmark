...
thf(aboxriin_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XI)) @ (cwceq @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccin @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciin @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))))))).
...
thf(a_0ntop_thm,axiom,(cwn @ (cwcel @ cc0 @ cctop))).
...
thf(aptunimpt_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XK @ Xx3))) @ ccpt))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XK @ Xx3) @ cctop)) @ (^ [Xx3:$i] : XA2))) @ (cwceq @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccuni @ (XK @ Xx3)))) @ (ccuni @ (XJ @ Xx3))))))))))).
thf(ccfi_tp,type,(ccfi : ($i > $o))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccint_tp,type,(ccint : (($i > $o) > ($i > $o)))).
thf(acmpfiiin_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ Xph @ (cwcel @ XJ @ cccmp)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XI)) @ (cwcel @ (XS @ Xk) @ (ccfv @ XJ @ cccld)))) => ((! [Xl:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwss @ (ccv @ Xl) @ XI) @ (cwcel @ (ccv @ Xl) @ ccfn))) @ (cwne @ (ccin @ XX @ (cciin @ (^ [Xk:$i] : (ccv @ Xl)) @ (^ [Xk:$i] : (XS @ Xk)))) @ cc0))) => (cwi @ Xph @ (cwne @ (ccin @ XX @ (cciin @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (XS @ Xk)))) @ cc0)))))))))))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xph @ Xch) @ Xps)))))).
thf(ccsb_tp,type,(ccsb : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aptcldmpt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XJ @ Xk) @ cctop))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XC @ Xk) @ (ccfv @ (XJ @ Xk) @ cccld)))) => (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccfv @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XJ @ Xk))) @ ccpt) @ cccld)))))))))))).
...
thf(ckelac1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwne @ (XS @ Xx3) @ cc0))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XJ @ Xx3) @ cctop))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XC @ Xx3) @ (ccfv @ (XJ @ Xx3) @ cccld)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwf1o @ (XS @ Xx3) @ (XC @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XU @ Xx3) @ (ccuni @ (XJ @ Xx3))))) => ((cwi @ Xph @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XJ @ Xx3))) @ ccpt) @ cccmp)) => (cwi @ Xph @ (cwne @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XS @ Xx3))) @ cc0)))))))))))))))).
