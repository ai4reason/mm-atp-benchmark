...
thf(aevpmss_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => (cwss @ (ccfv @ XD @ ccevpm) @ XP))))))).
...
thf(apsgnghm2_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => ((cwceq @ XU @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccpr @ cc1 @ (ccneg @ cc1)) @ ccress)) => (cwi @ (cwcel @ XD @ ccfn) @ (cwcel @ XN @ (cco @ XS @ XU @ ccghm))))))))))).
...
thf(apsgnodpm_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) @ (cwceq @ (ccfv @ XF @ XN) @ (ccneg @ cc1)))))))))))).
thf(aadantlr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ (cwa @ Xph @ Xth) @ Xps) @ Xch))))))).
thf(apsgnevpm_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ (ccfv @ XD @ ccevpm))) @ (cwceq @ (ccfv @ XF @ XN) @ cc1))))))))))).
...
thf(apsgnodpmr_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cw3a @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ XP) @ (cwceq @ (ccfv @ XF @ XN) @ (ccneg @ cc1))) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm))))))))))))).
...
thf(apsgninv_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ XP)) @ (cwceq @ (ccfv @ (cccnv @ XF) @ XN) @ (ccfv @ XF @ XN)))))))))))).
...
thf(cevpmodpmf1o_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) @ (cwf1o @ (ccfv @ XD @ ccevpm) @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)) @ (ccmpt @ (^ [Xf1:$i] : (ccfv @ XD @ ccevpm)) @ (^ [Xf1:$i] : (cco @ XF @ (ccv @ Xf1) @ (ccfv @ XS @ ccplusg))))))))))))).
