...
thf(chisubcomi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => ((cwcel @ XD @ cchil) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmv) @ (cco @ XC @ XD @ ccmv) @ ccsp) @ (cco @ (cco @ XB2 @ XA2 @ ccmv) @ (cco @ XD @ XC @ ccmv) @ ccsp))))))))))).
