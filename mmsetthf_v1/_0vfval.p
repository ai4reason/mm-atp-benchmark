...
thf(adf_0v_ax,axiom,(cwceq @ ccn0v @ (cccom @ ccgi @ ccpv))).
thf(afveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(c_0vfval_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XZ @ (ccfv @ XU @ ccn0v)) => (cwi @ (cwcel @ XU @ XV) @ (cwceq @ XZ @ (ccfv @ XG @ ccgi)))))))))).
