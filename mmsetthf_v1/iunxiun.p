...
thf(ciunxiun_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (cwceq @ (cciun @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XA2 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cciun @ (^ [Xy1:$i] : (XA2 @ Xy1)) @ (^ [Xy1:$i] : (cciun @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))).
