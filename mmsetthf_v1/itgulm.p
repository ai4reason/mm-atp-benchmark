...
thf(aulmi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xz @ Xk) @ (ccfv @ XM @ ccuz)))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwf @ (XZ @ Xz @ Xk) @ (cco @ ccc @ XS @ ccmap) @ XF)))) => ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xk) @ (XZ @ Xz @ Xk)) @ (cwcel @ (ccv @ Xz) @ XS))) @ (cwceq @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)) @ (XB2 @ Xz @ Xj @ Xk)))))) => ((! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XS)) @ (cwceq @ (ccfv @ (ccv @ Xz) @ XG) @ (XA2 @ Xz)))) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (XB2 @ Xz @ Xj @ Xk) @ (XA2 @ Xz) @ ccmin) @ ccabs) @ XC @ cclt)) @ (^ [Xz:$i] : XS))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xz @ Xk))))))))))))))))))))))).
...
thf(aiblulm_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccibl @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XS @ ccvol) @ ccr)) => (cwi @ Xph @ (cwcel @ XG @ ccibl)))))))))))))).
...
thf(citgulm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccibl @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XS @ ccvol) @ ccr)) => (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccitg @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ XF)))))) @ (ccitg @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XG))) @ ccli)))))))))))))).
