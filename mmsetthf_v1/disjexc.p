...
thf(cdisjexc_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwi @ (cwex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xz) @ (XA2 @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xz) @ (XB2 @ Xx3 @ Xy1))))) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwo @ (cwceq @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1)) @ (cwceq @ (ccin @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1)) @ cc0))))))))).
