...
thf(aafvvfveq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ (ccafv @ XA2 @ XF) @ XB2) @ (cwceq @ (ccafv @ XA2 @ XF) @ (ccfv @ XA2 @ XF))))))).
...
thf(cafv0nbfvbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwnel @ cc0 @ XB2) @ (cwb @ (cwcel @ (ccafv @ XA2 @ XF) @ XB2) @ (cwcel @ (ccfv @ XA2 @ XF) @ XB2))))))).
