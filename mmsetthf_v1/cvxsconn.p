...
thf(acvxpconn_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwcel @ (cco @ (cco @ (ccv @ Xt) @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccv @ Xy1) @ ccmul) @ ccaddc) @ XS))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccfv @ cccnfld @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XK @ (cco @ (XJ @ Xx3 @ Xy1) @ XS @ ccrest)))) => (cwi @ Xph @ (cwcel @ XK @ ccpconn))))))))))).
