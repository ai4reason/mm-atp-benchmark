...
thf(ausgredgreu_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE)) @ (cwcel @ XY @ (ccfv @ XX @ XE))) @ (cwreu @ (^ [Xy1:$i] : (cwceq @ (ccfv @ XX @ XE) @ (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XV))))))))))).
