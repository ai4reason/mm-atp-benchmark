...
thf(awrdval_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwceq @ (ccword @ XS) @ (cciun @ (^ [Xl:$i] : ccn0) @ (^ [Xl:$i] : (cco @ XS @ (cco @ ccc0 @ (ccv @ Xl) @ ccfzo) @ ccmap)))))))).
...
thf(cwrdexg_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwcel @ (ccword @ XS) @ ccvv))))).
