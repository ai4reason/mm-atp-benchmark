...
thf(admdi4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwi @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwss @ (ccin @ (cco @ XC @ XB2 @ cchj) @ (cco @ XA2 @ XB2 @ cchj)) @ (cco @ (ccin @ (cco @ XC @ XB2 @ cchj) @ XA2) @ XB2 @ cchj)))))))).
...
thf(aatabs2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwcel @ XC @ ccat) @ (cwi @ (cwn @ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj))) @ (cwceq @ (ccin @ (cco @ XA2 @ XC @ cchj) @ (cco @ XA2 @ XB2 @ cchj)) @ XA2))))))))).
...
thf(apm4_83_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwa @ (cwi @ Xph @ Xps) @ (cwi @ (cwn @ Xph) @ Xps)) @ Xps)))).
...
thf(cdmdbr5ati_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)) @ (cwss @ (ccv @ Xx3) @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccat)))))))).
