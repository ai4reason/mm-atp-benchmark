...
thf(arescval_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XD @ (cco @ XC @ XH @ ccresc)) => (cwi @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XH @ XW)) @ (cwceq @ XD @ (cco @ (cco @ XC @ (ccdm @ (ccdm @ XH)) @ ccress) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ ccsts)))))))))).
...
thf(crescval2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XD @ (cco @ XC @ XH @ ccresc)) => ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwcel @ XS @ XW)) => ((cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS))) => (cwi @ Xph @ (cwceq @ XD @ (cco @ (cco @ XC @ XS @ ccress) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ ccsts))))))))))))))).
