...
thf(asumeq2d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwral @ (^ [Xk:$i] : (cwceq @ (XB2 @ Xk) @ (XC @ Xk))) @ (^ [Xk:$i] : XA2)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsu @ XA2 @ (^ [Xk:$i] : (XC @ Xk)))))))))))).
...
thf(adivadddivd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwne @ XD @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccaddc) @ (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccaddc) @ (cco @ XB2 @ XD @ ccmul) @ ccdiv))))))))))))))).
...
thf(amoddi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccrp)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmo) @ ccmul) @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XA2 @ XC @ ccmul) @ ccmo))))))).
...
thf(amodcld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XB2 @ ccmo) @ ccr)))))))).
thf(aid_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ Xph))).
thf(adivne0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwne @ XA2 @ ccc0) => ((cwne @ XB2 @ ccc0) => (cwne @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0)))))))).
thf(aax_1cn_thm,axiom,(cwcel @ cc1 @ ccc)).
thf(aneqne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwn @ (cwceq @ XA2 @ XB2)) @ (cwne @ XA2 @ XB2))))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(aoddfl_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccz) @ (cwne @ (cco @ XK @ cc2 @ ccmo) @ ccc0)) @ (cwceq @ XK @ (cco @ (cco @ cc2 @ (ccfv @ (cco @ XK @ cc2 @ ccdiv) @ ccfl) @ ccmul) @ cc1 @ ccaddc))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(adirkertrigeqlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xn) @ ccz))) => ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (cco @ (cco @ (cco @ cc2 @ (XK @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccpi @ ccmul))) => (! [Xn:$i] : (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (XA2 @ Xn) @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (XA2 @ Xn) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (XA2 @ Xn) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))))).
...
thf(adirkertrigeqlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ XA2 @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ XA2 @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))).
...
thf(asineq0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccsin) @ ccc0) @ (cwcel @ (cco @ XA2 @ ccpi @ ccdiv) @ ccz))))).
thf(cdirkertrigeq_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XD @ Xk @ Xn @ Xs1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XF @ Xk @ Xn @ Xs1) @ (ccfv @ (XN @ Xn) @ (XD @ Xk @ Xn @ Xs1)))))) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XH @ Xk @ Xn @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ (XN @ Xn) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xs1) @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv))))))) => (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (XF @ Xk @ Xn @ Xs1) @ (XH @ Xk @ Xn @ Xs1)))))))))))))))).
