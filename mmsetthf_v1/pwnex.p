...
thf(aabnex_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwa @ (cwcel @ (XF @ Xx3) @ (XV @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xx3) @ (XF @ Xx3))))) @ (cwn @ (cwcel @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XF @ Xx3)))))) @ ccvv))))))).
...
thf(cpwnex_conj,conjecture,(cwnel @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccpw @ (ccv @ Xy1))))))) @ ccvv)).
