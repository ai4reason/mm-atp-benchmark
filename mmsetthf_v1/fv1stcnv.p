...
thf(abrresg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ (ccres @ XC @ XD)) @ (cwa @ (cwbr @ XA2 @ XB2 @ XC) @ (cwcel @ XA2 @ XD)))))))))).
...
thf(cfv1stcnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XV)) @ (cwceq @ (ccfv @ XX @ (cccnv @ (ccres @ cc1st @ (ccxp @ XA2 @ (ccsn @ XY))))) @ (ccop @ XX @ XY)))))))).
