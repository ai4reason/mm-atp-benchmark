...
thf(aovoliun_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XT @ Xn) @ (ccseq @ ccaddc @ (XG @ Xn) @ cc1))) => ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol))))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (ccsup @ (ccrn @ (XT @ Xn)) @ ccxr @ cclt) @ ccle)))))))))))).
...
thf(aisumless_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XB2 @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ ccc0 @ (XB2 @ Xk) @ ccle))) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => (cwi @ Xph @ (cwbr @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsu @ XZ @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccle))))))))))))))))).
...
thf(asupxrre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XA2 @ ccr @ cclt))))).
thf(aisumsup_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccseq @ ccaddc @ XF @ XM))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XM @ ccz))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XA2 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ ccc0 @ (XA2 @ Xk) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccv @ Xj) @ (XG @ Xk)) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsup @ (ccrn @ (XG @ Xk)) @ ccr @ cclt))))))))))))))))))).
...
thf(covoliun2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XT @ Xn) @ (ccseq @ ccaddc @ (XG @ Xn) @ cc1))) => ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol))))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XT @ Xn) @ (ccdm @ ccli)))) => (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (ccsu @ ccn @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol))) @ ccle)))))))))))).
