...
thf(cpj3lem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XF @ ccch) => ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (cwi @ (cwcel @ XA2 @ (ccin @ (ccin @ XF @ XG) @ XH)) @ (cwceq @ (ccfv @ XA2 @ (cccom @ (cccom @ (ccfv @ XF @ ccpjh) @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XH @ ccpjh))) @ XA2)))))))))).
