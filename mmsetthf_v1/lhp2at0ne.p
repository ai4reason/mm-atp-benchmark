...
thf(alhp2at0nle_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwne @ XU @ XV)) @ (cwa @ (cwo @ (cwcel @ XU @ XA2) @ (cwceq @ XU @ Xc_0)) @ (cwbr @ XU @ XW @ Xc_le)) @ (cwa @ (cwcel @ XV @ XA2) @ (cwbr @ XV @ XW @ Xc_le))) @ (cwn @ (cwbr @ XV @ (cco @ XP @ XU @ Xc_or) @ Xc_le))))))))))))))))))).
...
thf(clhp2at0ne_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwcel @ XQ @ XA2)) @ (cwa @ (cwa @ (cwo @ (cwcel @ XU @ XA2) @ (cwceq @ XU @ Xc_0)) @ (cwbr @ XU @ XW @ Xc_le)) @ (cwa @ (cwcel @ XV @ XA2) @ (cwbr @ XV @ XW @ Xc_le))) @ (cwne @ XU @ XV)) @ (cwne @ (cco @ XP @ XU @ Xc_or) @ (cco @ XQ @ XV @ Xc_or)))))))))))))))))))).
