...
thf(aserge0_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccle)))))))))).
