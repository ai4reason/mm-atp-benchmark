...
thf(aupgredgssspr_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccupgr) @ (cwss @ (ccfv @ XG @ ccedg) @ (ccfv @ (ccfv @ XG @ ccvtx) @ ccspr))))).
