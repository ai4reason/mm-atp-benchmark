...
thf(ccrngunit_conj,conjecture,(! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => (cwi @ (cwcel @ XR @ cccrg) @ (cwb @ (cwcel @ XX @ XU) @ (cwbr @ XX @ Xc_1 @ Xc_pa)))))))))))).
