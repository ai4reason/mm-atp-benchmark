...
thf(aplyrecld_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ ccr @ ccply))) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ XF) @ ccr)))))))).
...
thf(aivth2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((cwi @ Xph @ (cwa @ (cwbr @ (ccfv @ XB2 @ XF) @ XU @ cclt) @ (cwbr @ XU @ (ccfv @ XA2 @ XF) @ cclt))) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ XF) @ XU)) @ (^ [Xc:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))))))).
...
thf(anegelrp_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwcel @ (ccneg @ XA2) @ ccrp) @ (cwbr @ XA2 @ ccc0 @ cclt))))).
thf(asyl6breq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ XR)) => ((cwceq @ XB2 @ XC) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ XR)))))))))).
thf(amul2lt0rlt0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) => (cwi @ (cwa @ Xph @ (cwbr @ XB2 @ ccc0 @ cclt)) @ (cwbr @ ccc0 @ XA2 @ cclt))))))))).
...
thf(asignsplypnf_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XD @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XC @ (ccfv @ XF @ cccoe)) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ XD @ XC))) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XD @ ccexp)))) => (! [Xx3:$i] : (cwi @ (cwcel @ XF @ (ccfv @ ccr @ ccply)) @ (cwbr @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (XB2 @ Xx3) @ ccrli))))))))))))).
...
thf(agt0divd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ cclt))))))))).
...
thf(amul2lt0rgt0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) => (cwi @ (cwa @ Xph @ (cwbr @ ccc0 @ XB2 @ cclt)) @ (cwbr @ XA2 @ ccc0 @ cclt))))))))).
...
thf(arpneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwne @ XA2 @ ccc0)) @ (cwb @ (cwcel @ XA2 @ ccrp) @ (cwn @ (cwcel @ (ccneg @ XA2) @ ccrp)))))).
thf(csignsply0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XD @ Xz) @ (ccfv @ XF @ ccdgr))) => ((! [Xz:$i] : (cwceq @ (XC @ Xz) @ (ccfv @ XF @ cccoe))) => ((! [Xz:$i] : (cwceq @ XB2 @ (ccfv @ (XD @ Xz) @ (XC @ Xz)))) => ((! [Xz:$i] : (cwceq @ (XA2 @ Xz) @ (ccfv @ ccc0 @ (XC @ Xz)))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ ccr @ ccply))) => ((cwi @ Xph @ (cwne @ XF @ cc0p)) => ((! [Xz:$i] : (cwi @ Xph @ (cwbr @ (cco @ (XA2 @ Xz) @ XB2 @ ccmul) @ ccc0 @ cclt))) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ XF) @ ccc0)) @ (^ [Xz:$i] : ccrp))))))))))))))))).
