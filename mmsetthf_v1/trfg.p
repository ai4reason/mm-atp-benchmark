...
thf(ctrfg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XA2 @ ccfil)) @ (cwss @ XA2 @ XX) @ (cwcel @ XX @ XV)) @ (cwceq @ (cco @ (cco @ XX @ XF @ ccfg) @ XA2 @ ccrest) @ XF))))))).
