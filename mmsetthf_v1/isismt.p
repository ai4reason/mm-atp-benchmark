...
thf(adf_ismt_ax,axiom,(cwceq @ ccismt @ (ccmpt2 @ (^ [Xg1:$i] : (^ [Xh:$i] : ccvv)) @ (^ [Xg1:$i] : (^ [Xh:$i] : ccvv)) @ (^ [Xg1:$i] : (^ [Xh:$i] : (ccab @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (ccfv @ (ccv @ Xg1) @ ccbs) @ (ccfv @ (ccv @ Xh) @ ccbs) @ (ccv @ Xf1)) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xa) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xh) @ ccds)) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ ccds)))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)))) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))))))))))).
