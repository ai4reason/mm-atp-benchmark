...
thf(axpdifid_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccdif @ XB2 @ (ccsn @ (ccv @ Xx3)))))) @ (ccdif @ (ccxp @ XA2 @ XB2) @ ccid))))).
...
thf(ctglnfn_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => (cwi @ (cwcel @ XG @ ccstrkg) @ (cwfn @ XL @ (ccdif @ (ccxp @ XP @ XP) @ ccid))))))))))).
