...
thf(cswrdsbslen_conj,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwa @ (cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle) @ (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) @ (cwceq @ (ccfv @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) @ cchash) @ (ccfv @ (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr) @ cchash))))))))).
