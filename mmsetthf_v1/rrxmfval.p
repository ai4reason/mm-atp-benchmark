...
thf(arrxmval_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : (! [Xk:$i] : (cwceq @ (XD @ Xh @ Xk) @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds)))) => (! [Xh:$i] : (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XI @ XV) @ (cwcel @ XF @ (XX @ Xh)) @ (cwcel @ XG @ (XX @ Xh))) @ (cwceq @ (cco @ XF @ XG @ (XD @ Xh @ Xk)) @ (ccfv @ (ccsu @ (ccun @ (cco @ XF @ ccc0 @ ccsupp) @ (cco @ XG @ ccc0 @ ccsupp)) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt)))))))))))))).
thf(crrxmfval_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : (! [Xk:$i] : (cwceq @ (XD @ Xh @ Xk) @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds)))) => (! [Xh:$i] : (! [Xk:$i] : (cwi @ (cwcel @ XI @ XV) @ (cwceq @ (XD @ Xh @ Xk) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XX @ Xh))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XX @ Xh))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (ccsu @ (ccun @ (cco @ (ccv @ Xf1) @ ccc0 @ ccsupp) @ (cco @ (ccv @ Xg1) @ ccc0 @ ccsupp)) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt))))))))))))))).
