...
thf(agaset_thm,axiom,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) @ (cwcel @ XY @ ccvv)))))).
...
thf(cgass_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) @ (cwss @ XZ @ XY)) @ (cwb @ (cwcel @ (ccres @ Xc_po @ (ccxp @ XX @ XZ)) @ (cco @ XG @ XZ @ ccga)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_po) @ XZ)) @ (^ [Xy1:$i] : XZ))) @ (^ [Xx3:$i] : XX))))))))))).
