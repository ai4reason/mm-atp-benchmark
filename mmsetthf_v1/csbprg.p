...
thf(acsbun_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : (cwceq @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccun @ (XB2 @ Xx3) @ (XC @ Xx3)))) @ (ccun @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))).
...
thf(ccsbprg_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ (XC @ Xx3) @ (XV @ Xx3)) @ (cwceq @ (ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (ccpr @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) @ (ccpr @ (ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))).
