...
thf(aatordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwa @ (cwcel @ XB2 @ ccat) @ (cwbr @ XA2 @ XB2 @ cccm)) @ (cwo @ (cwss @ XB2 @ XA2) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))))))).
...
thf(cchirredlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccat) @ (cwss @ (ccv @ Xp) @ XA2)) @ (cwa @ (cwcel @ (ccv @ Xq) @ ccat) @ (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) @ (cwa @ (cwcel @ (ccv @ Xr) @ ccat) @ (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) @ (cwo @ (cwceq @ (ccv @ Xr) @ (ccv @ Xp)) @ (cwceq @ (ccv @ Xr) @ (ccv @ Xq))))))))))).
