...
thf(ataylply2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xk:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xk) @ ccc @ XF))) => ((! [Xk:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xk) @ XS))) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))))) => ((! [Xk:$i] : (cwceq @ (XT @ Xk) @ (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl)))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ cccnfld @ ccsubrg))) => ((cwi @ Xph @ (cwcel @ XB2 @ XD)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ XN @ ccfz))) @ (cwcel @ (cco @ (ccfv @ XB2 @ (ccfv @ (ccv @ Xk) @ (cco @ XS @ XF @ ccdvn))) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv) @ XD))) => (! [Xk:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XT @ Xk) @ (ccfv @ XD @ ccply)) @ (cwbr @ (ccfv @ (XT @ Xk) @ ccdgr) @ XN @ ccle)))))))))))))))))))))).
...
thf(ctaylply_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))))) => ((cwceq @ XT @ (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl))) => (cwi @ Xph @ (cwa @ (cwcel @ XT @ (ccfv @ ccc @ ccply)) @ (cwbr @ (ccfv @ XT @ ccdgr) @ XN @ ccle))))))))))))))))).
