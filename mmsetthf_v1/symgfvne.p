...
thf(csymgfvne_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XA2 @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XF @ XB2) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2)) @ (cwi @ (cwceq @ (ccfv @ XX @ XF) @ XZ) @ (cwi @ (cwne @ XY @ XX) @ (cwne @ (ccfv @ XY @ XF) @ XZ)))))))))))))).
