...
thf(ambfi1fseqlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (cwceq @ (XG @ Xy1 @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ ccn)) @ (cwf @ ccr @ (ccrn @ (ccmpt @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XA2 @ (cco @ cc2 @ XA2 @ ccexp) @ ccmul) @ ccfz)) @ (^ [Xm:$i] : (cco @ (ccv @ Xm) @ (cco @ cc2 @ XA2 @ ccexp) @ ccdiv)))) @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)))))))))))))))).
...
thf(ambfi1fseqlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (cwceq @ (XG @ Xy1 @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwceq @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ XA2) @ XA2 @ ccicc)) @ (ccif @ (cwbr @ (cco @ XA2 @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ XA2 @ ccle) @ (cco @ XA2 @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ XA2) @ ccc0))))))))))))))))).
...
thf(cmbfi1fseqlem4_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (cwceq @ (XG @ Xy1 @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : (cwi @ Xph @ (cwf @ ccn @ (ccdm @ ccitg1) @ (XG @ Xy1 @ Xm)))))))))))))).
