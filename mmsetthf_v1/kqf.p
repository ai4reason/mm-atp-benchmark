...
thf(adf_kq_ax,axiom,(cwceq @ cckq @ (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (cco @ (ccv @ Xj) @ (ccmpt @ (^ [Xx3:$i] : (ccuni @ (ccv @ Xj))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xj))))) @ ccqtop))))).
...
thf(akqt0_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ cctop) @ (cwcel @ (ccfv @ XJ @ cckq) @ cct0)))).
...
thf(ckqf_conj,conjecture,(cwf @ cctop @ cct0 @ cckq)).
