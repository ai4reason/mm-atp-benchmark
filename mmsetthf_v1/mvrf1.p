...
thf(amvrid_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xh:$i] : (cwceq @ (XV @ Xy1 @ Xh) @ (cco @ XI @ (XR @ Xy1 @ Xh) @ ccmvr)))) => ((! [Xh:$i] : (cwceq @ (XD @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xy1:$i] : (! [Xh:$i] : (cwceq @ (Xc_0 @ Xy1 @ Xh) @ (ccfv @ (XR @ Xy1 @ Xh) @ cc0g)))) => ((! [Xy1:$i] : (! [Xh:$i] : (cwceq @ (Xc_1 @ Xy1 @ Xh) @ (ccfv @ (XR @ Xy1 @ Xh) @ ccur)))) => ((! [Xy1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xy1 @ Xh) @ (cwcel @ XI @ (XW @ Xh))))) => ((! [Xy1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xy1 @ Xh) @ (cwcel @ (XR @ Xy1 @ Xh) @ (XY @ Xy1 @ Xh))))) => ((! [Xy1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xy1 @ Xh) @ (cwcel @ XX @ XI)))) => (! [Xy1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xy1 @ Xh) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ XX) @ cc1 @ ccc0))) @ (ccfv @ XX @ (XV @ Xy1 @ Xh))) @ (Xc_1 @ Xy1 @ Xh))))))))))))))))))))))).
...
thf(cmvrf1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XV @ (cco @ XI @ XR @ ccmvr)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwi @ Xph @ (cwne @ Xc_1 @ Xc_0)) => (cwi @ Xph @ (cwf1 @ XI @ XB2 @ XV)))))))))))))))))))).
