...
thf(acntzrcl_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwcel @ XX @ (ccfv @ XS @ XZ)) @ (cwa @ (cwcel @ XM @ ccvv) @ (cwss @ XS @ XB2))))))))))).
...
thf(ccntzmhm_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwceq @ XY @ (ccfv @ XH @ cccntz)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) @ (cwcel @ XA2 @ (ccfv @ XS @ XZ))) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ (ccima @ XF @ XS) @ XY))))))))))))).
