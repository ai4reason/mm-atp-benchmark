...
thf(arnascl_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccascl)) => ((cwceq @ Xc_1 @ (ccfv @ XW @ ccur)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwcel @ XW @ ccasa) @ (cwceq @ (ccrn @ XA2) @ (ccfv @ (ccsn @ Xc_1) @ XN))))))))))).
...
thf(aasclfn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccascl)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwfn @ XA2 @ XK))))))))).
...
thf(cissubassa2_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccascl)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => (cwi @ (cwa @ (cwcel @ XW @ ccasa) @ (cwcel @ XS @ (ccfv @ XW @ ccsubrg))) @ (cwb @ (cwcel @ XS @ XL) @ (cwss @ (ccrn @ XA2) @ XS)))))))))).
