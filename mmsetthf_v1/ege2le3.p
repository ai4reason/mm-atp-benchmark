...
thf(afaclbnd2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwbr @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc2 @ ccdiv) @ (ccfv @ XN @ ccfa) @ ccle)))).
...
thf(cege2le3_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (cwa @ (cwbr @ cc2 @ cceu @ ccle) @ (cwbr @ cceu @ cc3 @ ccle))))))).
