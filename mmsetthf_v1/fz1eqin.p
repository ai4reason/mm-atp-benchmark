...
thf(aellz1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccz) @ (cwb @ (cwcel @ XA2 @ (ccdif @ ccz @ (ccfv @ (cco @ XB2 @ cc1 @ ccaddc) @ ccuz))) @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwbr @ XA2 @ XB2 @ ccle))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(ccc0_tp,type,(ccc0 : ($i > $o))).
thf(aelnnz1_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XN @ ccz) @ (cwbr @ cc1 @ XN @ ccle))))).
thf(cfz1eqin_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ cc1 @ XN @ ccfz) @ (ccin @ (ccdif @ ccz @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ ccn))))).
