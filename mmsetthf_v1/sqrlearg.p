...
thf(aiccgelbd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ ccle)))))))))).
...
thf(aiccleubd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => (cwi @ Xph @ (cwbr @ XC @ XB2 @ ccle)))))))))).
thf(csqrlearg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ XA2 @ ccle) @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)))))))).
