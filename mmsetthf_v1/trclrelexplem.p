...
thf(ctrclrelexplem_conj,conjecture,(! [XD:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xj:$i] : (cwi @ (cwcel @ (XN @ Xj) @ ccn) @ (cwss @ (cciun @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ XD @ (ccv @ Xk) @ ccrelexp) @ (XN @ Xj) @ ccrelexp))) @ (cco @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ XD @ (ccv @ Xj) @ ccrelexp))) @ (XN @ Xj) @ ccrelexp))))))).
