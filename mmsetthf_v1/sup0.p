...
thf(asup0riota_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwor @ XA2 @ XR) @ (cwceq @ (ccsup @ cc0 @ XA2 @ XR) @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(csup0_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwor @ XA2 @ XR) @ (cwa @ (cwcel @ XX @ XA2) @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ XX @ XR))) @ (^ [Xy1:$i] : XA2))) @ (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ (cwceq @ (ccsup @ cc0 @ XA2 @ XR) @ XX)))))).
