...
thf(asqsscirc1_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XX @ ccr) @ (cwbr @ ccc0 @ XX @ ccle)) @ (cwa @ (cwcel @ XY @ ccr) @ (cwbr @ ccc0 @ XY @ ccle))) @ (cwcel @ XD @ ccrp)) @ (cwi @ (cwa @ (cwbr @ XX @ (cco @ XD @ cc2 @ ccdiv) @ cclt) @ (cwbr @ XY @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) @ (cwbr @ (ccfv @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ XD @ cclt))))))).
...
thf(aabsval2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccabs) @ (ccfv @ (cco @ (cco @ (ccfv @ XA2 @ ccre) @ cc2 @ ccexp) @ (cco @ (ccfv @ XA2 @ ccim) @ cc2 @ ccexp) @ ccaddc) @ ccsqrt))))))).
...
thf(csqsscirc2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwcel @ XD @ ccrp)) @ (cwi @ (cwa @ (cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccre) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt) @ (cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccim) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) @ (cwbr @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ XD @ cclt))))))).
