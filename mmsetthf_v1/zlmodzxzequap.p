...
thf(azlmodzxzadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((cwceq @ Xc_pl @ (ccfv @ XZ @ ccplusg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ XC @ ccz) @ (cwcel @ XD @ ccz))) @ (cwceq @ (cco @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XC)) @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XD)) @ Xc_pl) @ (ccpr @ (ccop @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc)) @ (ccop @ cc1 @ (cco @ XC @ XD @ ccaddc)))))))))))))).
thf(czlmodzxzequap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((cwceq @ XA2 @ (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((cwceq @ XB2 @ (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((cwceq @ Xc_0 @ (ccpr @ (ccop @ ccc0 @ ccc0) @ (ccop @ cc1 @ ccc0))) => ((cwceq @ Xc_pl @ (ccfv @ XZ @ ccplusg)) => ((cwceq @ Xc_xb @ (ccfv @ XZ @ ccvsca)) => (cwceq @ (cco @ (cco @ cc2 @ XA2 @ Xc_xb) @ (cco @ (ccneg @ cc3) @ XB2 @ Xc_xb) @ Xc_pl) @ Xc_0)))))))))))))).
