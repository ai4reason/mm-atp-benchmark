...
thf(cgrplactcnv_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((! [Xg1:$i] : (! [Xa:$i] : (cwceq @ (XF @ Xg1 @ Xa) @ (ccmpt @ (^ [Xg1:$i] : XX) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xa:$i] : XX) @ (^ [Xa:$i] : (cco @ (ccv @ Xg1) @ (ccv @ Xa) @ Xc_pl)))))))) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => (! [Xg1:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwf1o @ XX @ XX @ (ccfv @ XA2 @ (XF @ Xg1 @ Xa))) @ (cwceq @ (cccnv @ (ccfv @ XA2 @ (XF @ Xg1 @ Xa))) @ (ccfv @ (ccfv @ XA2 @ XI) @ (XF @ Xg1 @ Xa)))))))))))))))))).
