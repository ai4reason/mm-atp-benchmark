...
thf(celunirnmbfm_conj,conjecture,(! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ (ccuni @ (ccrn @ ccmbfm))) @ (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xt:$i] : (cwa @ (cwcel @ XF @ (cco @ (ccuni @ (ccv @ Xt)) @ (ccuni @ (ccv @ Xs1)) @ ccmap)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccv @ Xt))))) @ (^ [Xt:$i] : (ccuni @ (ccrn @ ccsiga))))) @ (^ [Xs1:$i] : (ccuni @ (ccrn @ ccsiga))))))).
