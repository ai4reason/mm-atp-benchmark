...
thf(aifov_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ (ccif @ Xph @ XF @ XG)) @ (ccif @ Xph @ (cco @ XA2 @ XB2 @ XF) @ (cco @ XA2 @ XB2 @ XG))))))))).
...
thf(cmonmatcollpw_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XK @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XA2 @ cc0g)) => ((cwceq @ Xc_ex @ (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccvsca)) => ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg)) @ (cw3a @ (cwcel @ XM @ XK) @ (cwcel @ XL @ ccn0) @ (cwcel @ XI @ ccn0))) @ (cwceq @ (cco @ (cco @ (cco @ XL @ XX @ Xc_ex) @ (ccfv @ XM @ XT) @ Xc_x) @ XI @ ccdecpmat) @ (ccif @ (cwceq @ XI @ XL) @ XM @ Xc_0))))))))))))))))))))))))))).
