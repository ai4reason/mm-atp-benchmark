...
thf(clidlnz_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ (XR @ Xx3) @ cclidl))) => ((! [Xx3:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xx3) @ cc0g))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ (XR @ Xx3) @ ccrg) @ (cwcel @ XI @ (XU @ Xx3)) @ (cwne @ XI @ (ccsn @ Xc_0))) @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ Xc_0)) @ (^ [Xx3:$i] : XI))))))))))).
