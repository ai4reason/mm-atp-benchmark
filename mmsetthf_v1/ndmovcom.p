...
thf(cndmovcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ (ccdm @ XF) @ (ccxp @ XS @ XS)) => (cwi @ (cwn @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS))) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ (cco @ XB2 @ XA2 @ XF))))))))).
