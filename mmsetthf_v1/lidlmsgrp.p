...
thf(alidlmmgm_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XR @ cclidl)) => ((cwceq @ XI @ (cco @ XR @ XU @ ccress)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XU @ XL)) @ (cwcel @ (ccfv @ XI @ ccmgp) @ ccmgm))))))))).
...
thf(alidlssbas_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XR @ cclidl)) => ((cwceq @ XI @ (cco @ XR @ XU @ ccress)) => (cwi @ (cwcel @ XU @ XL) @ (cwss @ (ccfv @ XI @ ccbs) @ (ccfv @ XR @ ccbs)))))))))).
...
thf(clidlmsgrp_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XR @ cclidl)) => ((cwceq @ XI @ (cco @ XR @ XU @ ccress)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XU @ XL)) @ (cwcel @ (ccfv @ XI @ ccmgp) @ ccsgrp))))))))).
