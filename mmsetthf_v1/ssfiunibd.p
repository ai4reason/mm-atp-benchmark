...
thf(aupbdrech2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XC @ Xx3 @ Xy1 @ Xz) @ (ccif @ (cwceq @ XA2 @ cc0) @ ccc0 @ (ccsup @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))) @ ccr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwa @ (cwcel @ (XC @ Xx3 @ Xy1 @ Xz) @ ccr) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3 @ Xy1 @ Xz) @ ccle)) @ (^ [Xx3:$i] : XA2))))))))))))))).
...
thf(anfsab_b_thm,axiom,(! [Xph:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => (! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xy1) @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xch))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(ccsb_tp,type,(ccsb : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aelabrexg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xy1))) @ (cwcel @ (XB2 @ Xx3) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))))))))))).
...
thf(anfsab_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) => (! [Xz:$i] : (cwnf @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xz) @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))))))).
...
thf(cssfiunibd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ (ccuni @ XA2))) @ (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xy1) @ ccle)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : ccr)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ Xph @ (cwss @ (XC @ Xy1 @ Xz @ Xw) @ (ccuni @ XA2)))))) => (! [Xy1:$i] : (cwi @ Xph @ (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xw) @ ccle)) @ (^ [Xz:$i] : (XC @ Xy1 @ Xz @ Xw)))) @ (^ [Xw:$i] : ccr))))))))))))).
