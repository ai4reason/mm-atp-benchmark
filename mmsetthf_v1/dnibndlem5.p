...
thf(cdnibndlem5_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ XA2 @ ccmin) @ cclt)))).
