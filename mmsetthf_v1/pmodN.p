...
thf(cpmodN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XS) @ (cwss @ XY @ XA2) @ (cwss @ XZ @ XA2))) @ (cwceq @ (ccin @ XX @ (cco @ XY @ (ccin @ XX @ XZ) @ Xc_pl)) @ (cco @ (ccin @ XX @ XY) @ (ccin @ XX @ XZ) @ Xc_pl)))))))))))))).
