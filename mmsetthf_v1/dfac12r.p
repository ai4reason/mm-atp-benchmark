...
thf(aonwf_thm,axiom,(cwss @ ccon0 @ (ccuni @ (ccima @ ccr1 @ ccon0)))).
...
thf(cdfac12r_conj,conjecture,(cwb @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccpw @ (ccv @ Xx3)) @ (ccdm @ cccrd))) @ (^ [Xx3:$i] : ccon0)) @ (cwss @ (ccuni @ (ccima @ ccr1 @ ccon0)) @ (ccdm @ cccrd)))).
