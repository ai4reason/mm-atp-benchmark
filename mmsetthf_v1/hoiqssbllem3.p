...
thf(achoicefi_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3 @ Xf1))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwne @ (XB2 @ Xx3) @ cc0)))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))))))))).
...
thf(aqinioo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => (cwi @ Xph @ (cwb @ (cwceq @ (ccin @ ccq @ (cco @ XA2 @ XB2 @ ccioo)) @ cc0) @ (cwbr @ XB2 @ XA2 @ ccle))))))))).
...
thf(ahoiqssbllem1_thm,axiom,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwnf @ (^ [Xi:$i] : (Xph @ Xi))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XX @ ccfn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwne @ XX @ cc0))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XY @ (cco @ ccr @ XX @ ccmap)))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwf @ XX @ ccr @ (XC @ Xi)))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwf @ XX @ ccr @ (XD @ Xi)))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XE @ Xi) @ ccrp))) => ((! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xi) @ (cwcel @ (ccv @ Xi) @ XX)) @ (cwcel @ (ccfv @ (ccv @ Xi) @ (XC @ Xi)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ (XE @ Xi) @ (cco @ cc2 @ (ccfv @ (ccfv @ XX @ cchash) @ ccsqrt) @ ccmul) @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XY) @ ccioo)))) => ((! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xi) @ (cwcel @ (ccv @ Xi) @ XX)) @ (cwcel @ (ccfv @ (ccv @ Xi) @ (XD @ Xi)) @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ (XE @ Xi) @ (cco @ cc2 @ (ccfv @ (ccfv @ XX @ cchash) @ ccsqrt) @ ccmul) @ ccdiv) @ ccaddc) @ ccioo)))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XY @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xi)) @ ccico)))))))))))))))))))))).
