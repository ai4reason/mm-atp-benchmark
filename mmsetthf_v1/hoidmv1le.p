...
thf(ahoidmv1lelem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ ccn @ ccr @ XC)) => ((cwi @ Xph @ (cwf @ ccn @ ccr @ XD)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccico) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ ccico))))) => ((cwi @ Xph @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ ccico) @ ccvol))) @ ccsumge0) @ ccr)) => ((cwceq @ XU @ (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ XD) @ (ccv @ Xz) @ ccle) @ (ccfv @ (ccv @ Xj) @ XD) @ (ccv @ Xz)) @ ccico) @ ccvol))) @ ccsumge0) @ ccle)) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccicc)))) => ((cwceq @ XS @ (ccsup @ XU @ ccr @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ ccico) @ ccvol))) @ ccsumge0) @ ccle))))))))))))))))))).
...
thf(aelixpsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : XB2))) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ XF @ (ccsn @ (ccop @ XA2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XB2))))))))).
...
thf(choidmv1le_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XZ @ Xa @ Xb) @ (XV @ Xx3 @ Xj @ Xa @ Xb)))))))) => ((! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XX @ Xj) @ (ccsn @ (XZ @ Xa @ Xb)))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ (XX @ Xj) @ ccr @ XA2)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ (XX @ Xj) @ ccr @ XB2)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ ccn @ (cco @ ccr @ (XX @ Xj) @ ccmap) @ XC)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ ccn @ (cco @ ccr @ (XX @ Xj) @ ccmap) @ XD)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ (ccixp @ (^ [Xk:$i] : (XX @ Xj)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccico))) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : (XX @ Xj)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ XC)) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ XD)) @ ccico))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (cco @ XA2 @ XB2 @ (ccfv @ (XX @ Xj) @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb))) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ (ccfv @ (XX @ Xj) @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb))))) @ ccsumge0) @ ccle))))))))))))))))))))))))).
