...
thf(ciunrelexpmin1_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xs1:$i] : (cwceq @ (XC @ Xs1) @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp))))))) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwceq @ XN @ ccn)) @ (cwal @ (^ [Xs1:$i] : (cwi @ (cwa @ (cwss @ XR @ (ccv @ Xs1)) @ (cwss @ (cccom @ (ccv @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1))) @ (cwss @ (ccfv @ XR @ (XC @ Xs1)) @ (ccv @ Xs1)))))))))))).
