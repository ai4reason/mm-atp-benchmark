...
thf(axadddilem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxmu) @ (cco @ (cco @ XA2 @ XB2 @ ccxmu) @ (cco @ XA2 @ XC @ ccxmu) @ ccxad))))))).
...
thf(axnegdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwceq @ (ccxne @ (cco @ XA2 @ XB2 @ ccxad)) @ (cco @ (ccxne @ XA2) @ (ccxne @ XB2) @ ccxad)))))).
...
thf(cxadddi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxmu) @ (cco @ (cco @ XA2 @ XB2 @ ccxmu) @ (cco @ XA2 @ XC @ ccxmu) @ ccxad))))))).
