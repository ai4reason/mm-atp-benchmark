...
thf(ar1ord3g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccr1)) @ (cwcel @ XB2 @ (ccdm @ ccr1))) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
...
thf(cr1val1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccr1)) @ (cwceq @ (ccfv @ XA2 @ ccr1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ ccr1)))))))).
