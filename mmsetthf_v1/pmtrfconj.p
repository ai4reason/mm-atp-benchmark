...
thf(cpmtrfconj_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => ((cwceq @ XR @ (ccrn @ XT)) => (cwi @ (cwa @ (cwcel @ XF @ XR) @ (cwf1o @ XD @ XD @ XG)) @ (cwcel @ (cccom @ (cccom @ XG @ XF) @ (cccnv @ XG)) @ XR)))))))))).
