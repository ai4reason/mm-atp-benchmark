...
thf(cgenpass_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((! [Xw:$i] : (! [Xv:$i] : (cwceq @ (XF @ Xw @ Xv) @ (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xy1) @ ccnq) @ (cwcel @ (ccv @ Xz) @ ccnq)) @ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => ((! [Xw:$i] : (! [Xv:$i] : (cwceq @ (ccdm @ (XF @ Xw @ Xv)) @ (ccxp @ ccnp @ ccnp)))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xf1) @ ccnp) @ (cwcel @ (ccv @ Xg1) @ ccnp)) @ (cwcel @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (XF @ Xw @ Xv)) @ ccnp)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ XG) @ (ccv @ Xh) @ XG) @ (cco @ (ccv @ Xf1) @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ XG) @ XG))))) => (! [Xw:$i] : (! [Xv:$i] : (cwceq @ (cco @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xw @ Xv)) @ (XC @ Xw @ Xv) @ (XF @ Xw @ Xv)) @ (cco @ (XA2 @ Xw @ Xv) @ (cco @ (XB2 @ Xw @ Xv) @ (XC @ Xw @ Xv) @ (XF @ Xw @ Xv)) @ (XF @ Xw @ Xv)))))))))))))))).
