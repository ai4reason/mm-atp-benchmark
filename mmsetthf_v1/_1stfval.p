...
thf(adf_1stf_ax,axiom,(cwceq @ cc1stf @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : cccat)) @ (^ [Xr:$i] : (^ [Xs1:$i] : cccat)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccsb @ (ccxp @ (ccfv @ (ccv @ Xr) @ ccbs) @ (ccfv @ (ccv @ Xs1) @ ccbs)) @ (^ [Xb:$i] : (ccop @ (ccres @ cc1st @ (ccv @ Xb)) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ cc1st @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccxpc) @ cchom)))))))))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aopex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (ccop @ XA2 @ XB2) @ ccvv)))).
thf(c_1stfval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ XC @ XD @ ccxpc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XT @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XH @ (ccfv @ (XT @ Xx3 @ Xy1) @ cchom)))) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XP @ Xx3 @ Xy1) @ (cco @ XC @ XD @ cc1stf)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (XP @ Xx3 @ Xy1) @ (ccop @ (ccres @ cc1st @ XB2) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ cc1st @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)))))))))))))))))))))))).
