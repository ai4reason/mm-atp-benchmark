...
thf(chofpropd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XC @ cchomf) @ (ccfv @ XD @ cchomf))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XC @ cccomf) @ (ccfv @ XD @ cccomf))) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ cchof) @ (ccfv @ XD @ cchof))))))))))).
