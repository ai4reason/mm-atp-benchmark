...
thf(causgrusgrb_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xv:$i] : (! [Xe:$i] : (cwceq @ (XG @ Xx3 @ Xv @ Xe) @ (ccopab @ (^ [Xv:$i] : (^ [Xe:$i] : (cwss @ (ccv @ Xe) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xv)))))))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ XV @ (XX @ Xv @ Xe)) @ (cwcel @ XE @ (XY @ Xv @ Xe))) @ (cwb @ (cwbr @ XV @ XE @ (XG @ Xx3 @ Xv @ Xe)) @ (cwcel @ (ccop @ XV @ (ccres @ ccid @ XE)) @ ccusgr))))))))))))).
