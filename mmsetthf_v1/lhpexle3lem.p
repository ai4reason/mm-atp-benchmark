...
thf(alhpexle2_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwrex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le) @ (cwne @ (ccv @ Xp) @ XX) @ (cwne @ (ccv @ Xp) @ XY))) @ (^ [Xp:$i] : XA2)))))))))))))).
...
thf(clhpexle3lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2) @ (cwcel @ XZ @ XA2)) @ (cw3a @ (cwbr @ XX @ XW @ Xc_le) @ (cwbr @ XY @ XW @ Xc_le) @ (cwbr @ XZ @ XW @ Xc_le))) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le) @ (cw3a @ (cwne @ (ccv @ Xp) @ XX) @ (cwne @ (ccv @ Xp) @ XY) @ (cwne @ (ccv @ Xp) @ XZ)))) @ (^ [Xp:$i] : XA2))))))))))))))).
