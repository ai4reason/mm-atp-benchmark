...
thf(adf_odu_ax,axiom,(cwceq @ ccodu @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccop @ (ccfv @ ccnx @ ccple) @ (cccnv @ (ccfv @ (ccv @ Xw) @ ccple))) @ ccsts))))).
...
thf(coduval_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XD @ (ccfv @ XO @ ccodu)) => ((cwceq @ Xc_le @ (ccfv @ XO @ ccple)) => (cwceq @ XD @ (cco @ XO @ (ccop @ (ccfv @ ccnx @ ccple) @ (cccnv @ Xc_le)) @ ccsts)))))))).
