...
thf(afzonn0p1p1_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)))))).
...
thf(accatval1lsw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwne @ XA2 @ cc0)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin) @ (cco @ XA2 @ XB2 @ ccconcat)) @ (ccfv @ XA2 @ cclsw))))))).
...
thf(accatws1ls_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ (ccfv @ XW @ cchash) @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) @ XX)))))).
...
thf(accatfv0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ cchash) @ cclt)) @ (cwceq @ (ccfv @ ccc0 @ (cco @ XA2 @ XB2 @ ccconcat)) @ (ccfv @ ccc0 @ XA2))))))).
thf(awwlknbp2OLD_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwa @ (cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) @ (cwceq @ (ccfv @ XW @ cchash) @ (cco @ XN @ cc1 @ ccaddc)))))))).
...
thf(cwwlksext2clwwlkOLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwcel @ XZ @ XV) @ (cwcel @ XN @ ccn0)) @ (cwi @ (cwa @ (cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) @ (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)) @ (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ (cco @ XN @ cc2 @ ccaddc) @ XG @ ccclwwlkn))))))))))))).
