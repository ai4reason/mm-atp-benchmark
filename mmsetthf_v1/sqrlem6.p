...
thf(asqrlem5_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XS @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (XA2 @ Xu) @ ccle)) @ (^ [Xx3:$i] : ccrp))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XB2 @ Xx3 @ Xu @ Xa @ Xb) @ (ccsup @ (XS @ Xx3) @ ccr @ cclt)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccmul))) @ (^ [Xb:$i] : (XS @ Xx3)))) @ (^ [Xa:$i] : (XS @ Xx3)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xu) @ ccrp) @ (cwbr @ (XA2 @ Xu) @ cc1 @ ccle)) @ (cwa @ (cw3a @ (cwss @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ ccr) @ (cwne @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ cc0) @ (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xu:$i] : (cwbr @ (ccv @ Xu) @ (ccv @ Xv) @ ccle)) @ (^ [Xu:$i] : (XT @ Xx3 @ Xy1 @ Xa @ Xb)))) @ (^ [Xv:$i] : ccr))) @ (cwceq @ (cco @ (XB2 @ Xx3 @ Xu @ Xa @ Xb) @ cc2 @ ccexp) @ (ccsup @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ ccr @ cclt))))))))))))))))).
...
thf(asuprleub_b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cwcel @ (XB2 @ Xy1) @ ccr)) @ (cwb @ (cwbr @ (ccsup @ XA2 @ ccr @ cclt) @ (XB2 @ Xy1) @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XB2 @ Xy1) @ ccle)) @ (^ [Xx3:$i] : XA2)))))))).
thf(csqrlem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2 @ ccle)) @ (^ [Xx3:$i] : ccrp)))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XB2 @ Xx3 @ Xa @ Xb) @ (ccsup @ (XS @ Xx3) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccmul))) @ (^ [Xb:$i] : (XS @ Xx3)))) @ (^ [Xa:$i] : (XS @ Xx3)))))))))) => (! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwbr @ XA2 @ cc1 @ ccle)) @ (cwbr @ (cco @ (XB2 @ Xx3 @ Xa @ Xb) @ cc2 @ ccexp) @ XA2 @ ccle))))))))))))).
