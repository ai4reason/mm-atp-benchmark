...
thf(aplymul02_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwceq @ (cco @ cc0p @ XF @ (ccof @ ccmul)) @ cc0p))))).
...
thf(aplymulx0_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccdif @ (ccfv @ ccr @ ccply) @ (ccsn @ cc0p))) @ (cwceq @ (ccfv @ (cco @ XF @ ccidp @ (ccof @ ccmul)) @ cccoe) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ ccc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccfv @ XF @ cccoe))))))))).
thf(cplymulx_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ ccr @ ccply)) @ (cwceq @ (ccfv @ (cco @ XF @ ccidp @ (ccof @ ccmul)) @ cccoe) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ ccc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccfv @ XF @ cccoe))))))))).
