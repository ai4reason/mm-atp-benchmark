...
thf(c_3dvdsOLD_conj,conjecture,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwf @ (cco @ ccc0 @ XN @ ccfz) @ ccz @ XF)) @ (cwb @ (cwbr @ cc3 @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ cc10 @ (ccv @ Xk) @ ccexp) @ ccmul))) @ ccdvds) @ (cwbr @ cc3 @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ ccdvds)))))).
