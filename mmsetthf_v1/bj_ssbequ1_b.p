...
thf(aequtr2_b1_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))))).
...
thf(adf_ssb_b_ax,axiom,(! [Xph:($i > $o)] : (! [Xx3:$i] : (cwb @ (cwssb @ (^ [Xx3:$i] : (^ [Xx3:$i] : (Xph @ Xx3)))) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3))))))))))).
thf(cbj_ssbequ1_b_conj,conjecture,(! [Xph:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (cwi @ (Xph @ Xx3) @ (cwssb @ (^ [Xx3:$i] : (^ [Xx3:$i] : (Xph @ Xx3))))))))).
