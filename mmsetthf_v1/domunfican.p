...
thf(adomunsncan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwn @ (cwcel @ XA2 @ XX)) @ (cwn @ (cwcel @ XB2 @ XY))) @ (cwb @ (cwbr @ (ccun @ (ccsn @ XA2) @ XX) @ (ccun @ (ccsn @ XB2) @ XY) @ ccdom) @ (cwbr @ XX @ XY @ ccdom)))))))))).
...
thf(cdomunfican_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwbr @ XB2 @ XA2 @ ccen)) @ (cwa @ (cwceq @ (ccin @ XA2 @ XX) @ cc0) @ (cwceq @ (ccin @ XB2 @ XY) @ cc0))) @ (cwb @ (cwbr @ (ccun @ XA2 @ XX) @ (ccun @ XB2 @ XY) @ ccdom) @ (cwbr @ XX @ XY @ ccdom)))))))).
