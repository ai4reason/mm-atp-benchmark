...
thf(airredrmul_thm,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ ccir)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XI) @ (cwcel @ XY @ XU)) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI)))))))))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(aopprirred_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccoppr)) => ((cwceq @ XI @ (ccfv @ XR @ ccir)) => (cwceq @ XI @ (ccfv @ XS @ ccir)))))))).
...
thf(cirredlmul_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ ccir)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XI)) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI)))))))))))).
