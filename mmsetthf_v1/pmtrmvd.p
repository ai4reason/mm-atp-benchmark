...
thf(apmtrfv_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ XV) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) @ (cwcel @ XZ @ XD)) @ (cwceq @ (ccfv @ XZ @ (ccfv @ XP @ XT)) @ (ccif @ (cwcel @ XZ @ XP) @ (ccuni @ (ccdif @ XP @ (ccsn @ XZ))) @ XZ)))))))))).
...
thf(cpmtrmvd_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => (cwi @ (cw3a @ (cwcel @ XD @ XV) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) @ (cwceq @ (ccdm @ (ccdif @ (ccfv @ XP @ XT) @ ccid)) @ XP)))))))).
