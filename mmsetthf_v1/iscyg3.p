...
thf(ciscyg3_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwb @ (cwcel @ XG @ cccyg) @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_x))) @ (^ [Xn:$i] : ccz))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
