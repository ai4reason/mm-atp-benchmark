...
thf(cetransclem25_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XP @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xj) @ ccn0))) => ((! [Xj:$i] : (cwi @ Xph @ (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz) @ XC))) => ((! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ XC))) @ (XN @ Xj)))) => ((! [Xj:$i] : (cwceq @ (XT @ Xj) @ (cco @ (cco @ (ccfv @ (XN @ Xj) @ ccfa) @ (ccprod @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ XC) @ ccfa))) @ ccdiv) @ (cco @ (ccif @ (cwbr @ (cco @ XP @ cc1 @ ccmin) @ (ccfv @ ccc0 @ XC) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ XP @ cc1 @ ccmin) @ ccfa) @ (ccfv @ (cco @ (cco @ XP @ cc1 @ ccmin) @ (ccfv @ ccc0 @ XC) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ XJ @ (cco @ (cco @ XP @ cc1 @ ccmin) @ (ccfv @ ccc0 @ XC) @ ccmin) @ ccexp) @ ccmul)) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccif @ (cwbr @ XP @ (ccfv @ (ccv @ Xj) @ XC) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ XP @ ccfa) @ (ccfv @ (cco @ XP @ (ccfv @ (ccv @ Xj) @ XC) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ XJ @ (ccv @ Xj) @ ccmin) @ (cco @ XP @ (ccfv @ (ccv @ Xj) @ XC) @ ccmin) @ ccexp) @ ccmul)))) @ ccmul) @ ccmul))) => ((cwi @ Xph @ (cwcel @ XJ @ (cco @ cc1 @ XM @ ccfz))) => (! [Xj:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ XP @ ccfa) @ (XT @ Xj) @ ccdvds)))))))))))))))))).
