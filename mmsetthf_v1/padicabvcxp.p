...
thf(acxp0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ ccc0 @ cccxp) @ cc1)))))).
...
thf(apadicabv_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (cco @ cccnfld @ ccq @ ccress)) => ((cwceq @ XA2 @ (ccfv @ XQ @ ccabv)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ XN @ (cco @ XP @ (ccv @ Xx3) @ ccpc) @ ccexp)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ (cco @ ccc0 @ cc1 @ ccioo))) @ (cwcel @ (XF @ Xx3) @ XA2)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(cpadicabvcxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : (cwceq @ (XQ @ Xq) @ (cco @ cccnfld @ ccq @ ccress))) => ((! [Xq:$i] : (cwceq @ XA2 @ (ccfv @ (XQ @ Xq) @ ccabv))) => ((! [Xx3:$i] : (! [Xq:$i] : (cwceq @ (XJ @ Xx3 @ Xq) @ (ccmpt @ (^ [Xq:$i] : ccprime) @ (^ [Xq:$i] : (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ (ccv @ Xq) @ (ccneg @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ ccpc)) @ ccexp))))))))) => (! [Xx3:$i] : (! [Xq:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ (XR @ Xx3) @ ccrp)) @ (cwcel @ (ccmpt @ (^ [Xy1:$i] : ccq) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ (ccfv @ XP @ (XJ @ Xx3 @ Xq))) @ (XR @ Xx3) @ cccxp))) @ XA2))))))))))))).
