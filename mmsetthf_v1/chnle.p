...
thf(achnlei_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwn @ (cwss @ XB2 @ XA2)) @ (cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj)))))))).
...
thf(cchnle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwn @ (cwss @ XB2 @ XA2)) @ (cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj))))))).
