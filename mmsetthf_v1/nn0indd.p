...
thf(cnn0indd_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [Xet:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ ccc0) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwb @ (Xps @ Xx3) @ (Xta @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xet @ Xy1))))) => ((! [Xy1:$i] : (cwi @ Xph @ (Xch @ Xy1))) => ((! [Xy1:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ ccn0)) @ (Xth @ Xy1)) @ (Xta @ Xy1))) => (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (XA2 @ Xy1) @ ccn0)) @ (Xet @ Xy1))))))))))))))))).
