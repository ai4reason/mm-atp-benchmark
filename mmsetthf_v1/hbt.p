...
thf(alnrring_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cclnr) @ (cwcel @ XA2 @ ccrg)))).
...
thf(aislnr3_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => (cwb @ (cwcel @ XR @ cclnr) @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XU @ (ccfv @ XB2 @ ccnacs)))))))))).
...
thf(ahbtlem7_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((cwceq @ XT @ (ccfv @ XR @ cclidl)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU)) @ (cwf @ ccn0 @ XT @ (ccfv @ XI @ XS)))))))))))))).
...
thf(ahbtlem4_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XI @ XU)) => ((cwi @ Xph @ (cwcel @ XX @ ccn0)) => ((cwi @ Xph @ (cwcel @ XY @ ccn0)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ ccle)) => (cwi @ Xph @ (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XY @ (ccfv @ XI @ XS))))))))))))))))))))).
...
thf(anacsfix_thm,axiom,(! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ (XC @ Xx3) @ (ccfv @ (XX @ Xx3) @ ccnacs)) @ (cwf @ ccn0 @ (XC @ Xx3) @ XF) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))) @ (^ [Xx3:$i] : ccn0))) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn0)))))))).
...
thf(ahbtlem6_thm,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XP @ Xk) @ (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : (cwceq @ (XU @ Xk) @ (ccfv @ (XP @ Xk) @ cclidl))) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((! [Xk:$i] : (cwceq @ (XN @ Xk) @ (ccfv @ (XP @ Xk) @ ccrsp))) => ((cwi @ Xph @ (cwcel @ XR @ cclnr)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XI @ (XU @ Xk)))) => ((cwi @ Xph @ (cwcel @ XX @ ccn0)) => (cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XX @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XN @ Xk)) @ XS)))) @ (^ [Xk:$i] : (ccin @ (ccpw @ XI) @ ccfn)))))))))))))))))))).
...
thf(ahbtlem5_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XP @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccpl1))) => ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ (XP @ Xx3) @ cclidl))) => ((! [Xx3:$i] : (cwceq @ XS @ (ccfv @ (XR @ Xx3) @ ccldgis))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XR @ Xx3) @ ccrg))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XI @ (XU @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XJ @ (XU @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XI @ XJ))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ XS)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XI @ XS)))) @ (^ [Xx3:$i] : ccn0)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ XI @ XJ))))))))))))))))))).
...
thf(arspssp_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccrsp)) => ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwss @ XG @ XI)) @ (cwss @ (ccfv @ XG @ XK) @ XI)))))))))).
...
thf(ahbtlem3_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XI @ XU)) => ((cwi @ Xph @ (cwcel @ XJ @ XU)) => ((cwi @ Xph @ (cwss @ XI @ XJ)) => ((cwi @ Xph @ (cwcel @ XX @ ccn0)) => (cwi @ Xph @ (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XX @ (ccfv @ XJ @ XS))))))))))))))))))))).
...
thf(chbt_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => (cwi @ (cwcel @ XR @ cclnr) @ (cwcel @ XP @ cclnr)))))).
