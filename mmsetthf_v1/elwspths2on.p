...
thf(celwspths2on_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV)) @ (cwb @ (cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwceq @ XW @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) @ (cwcel @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))))) @ (^ [Xb:$i] : XV))))))))))).
