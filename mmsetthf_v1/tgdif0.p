...
thf(atgval_thm,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwceq @ (ccfv @ XB2 @ cctg) @ (ccab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccuni @ (ccin @ XB2 @ (ccpw @ (ccv @ Xx3)))))))))))).
...
thf(ctgdif0_conj,conjecture,(! [XB2:($i > $o)] : (cwceq @ (ccfv @ (ccdif @ XB2 @ (ccsn @ cc0)) @ cctg) @ (ccfv @ XB2 @ cctg)))).
