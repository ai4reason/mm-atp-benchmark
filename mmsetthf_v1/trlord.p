...
thf(ahlatle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwbr @ XX @ XY @ Xc_le) @ (cwral @ (^ [Xp:$i] : (cwi @ (cwbr @ (ccv @ Xp) @ XX @ Xc_le) @ (cwbr @ (ccv @ Xp) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2)))))))))))))).
thf(ctrlord_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xf1:$i] : (cwceq @ (XA2 @ Xf1) @ (ccfv @ XK @ ccatm))) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwbr @ XX @ XW @ Xc_le)) @ (cwa @ (cwcel @ XY @ XB2) @ (cwbr @ XY @ XW @ Xc_le))) @ (cwb @ (cwbr @ XX @ XY @ Xc_le) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xf1) @ XR) @ XX @ Xc_le) @ (cwbr @ (ccfv @ (ccv @ Xf1) @ XR) @ XY @ Xc_le))) @ (^ [Xf1:$i] : XT))))))))))))))))))))).
