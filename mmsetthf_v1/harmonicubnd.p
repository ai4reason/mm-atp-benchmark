...
thf(charmonicubnd_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ ccle)) @ (cwbr @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (cco @ (ccfv @ XA2 @ cclog) @ cc1 @ ccaddc) @ ccle)))).
