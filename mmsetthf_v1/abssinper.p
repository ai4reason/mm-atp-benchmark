...
thf(asinper_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XK @ ccz)) @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccaddc) @ ccsin) @ (ccfv @ XA2 @ ccsin)))))).
...
thf(asinmpi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ XA2 @ ccpi @ ccmin) @ ccsin) @ (ccneg @ (ccfv @ XA2 @ ccsin)))))).
...
thf(cabssinper_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XK @ ccz)) @ (cwceq @ (ccfv @ (ccfv @ (cco @ XA2 @ (cco @ XK @ ccpi @ ccmul) @ ccaddc) @ ccsin) @ ccabs) @ (ccfv @ (ccfv @ XA2 @ ccsin) @ ccabs)))))).
