...
thf(cwrdumgr_conj,conjecture,(! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XG @ (XU @ Xx3)) @ (cwcel @ (XE @ Xx3) @ (ccword @ (XX @ Xx3)))) @ (cwb @ (cwcel @ XG @ ccumgr) @ (cwcel @ (XE @ Xx3) @ (ccword @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))))))))))))))).
