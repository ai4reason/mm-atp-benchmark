...
thf(adf_tail_ax,axiom,(cwceq @ cctail @ (ccmpt @ (^ [Xr:$i] : ccdir) @ (^ [Xr:$i] : (ccmpt @ (^ [Xx3:$i] : (ccuni @ (ccuni @ (ccv @ Xr)))) @ (^ [Xx3:$i] : (ccima @ (ccv @ Xr) @ (ccsn @ (ccv @ Xx3))))))))).
...
thf(ctailfval_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwcel @ XD @ ccdir) @ (cwceq @ (ccfv @ XD @ cctail) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccima @ XD @ (ccsn @ (ccv @ Xx3))))))))))).
