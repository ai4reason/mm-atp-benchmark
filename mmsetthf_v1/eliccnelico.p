...
thf(celiccnelico_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwn @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)))) => (cwi @ Xph @ (cwceq @ XC @ XB2))))))))))).
