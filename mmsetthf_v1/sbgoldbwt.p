...
thf(aevennodd_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ cceven) @ (cwn @ (cwcel @ XZ @ ccodd))))).
thf(csbgoldbwt_conj,conjecture,(cwi @ (cwral @ (^ [Xn:$i] : (cwi @ (cwbr @ cc4 @ (ccv @ Xn) @ cclt) @ (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc5 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)))).
