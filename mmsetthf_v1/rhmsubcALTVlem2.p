...
thf(crhmsubcALTVlem2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccrngcALTV)) => ((cwi @ Xph @ (cwceq @ XR @ (ccin @ ccrg @ XU))) => ((cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XR @ XR))) => (cwi @ (cw3a @ Xph @ (cwcel @ XX @ XR) @ (cwcel @ XY @ XR)) @ (cwceq @ (cco @ XX @ XY @ XH) @ (cco @ XX @ XY @ ccrh)))))))))))))))).
