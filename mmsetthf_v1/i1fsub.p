...
thf(aofnegsub_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG)) @ (cwceq @ (cco @ XF @ (cco @ (ccxp @ XA2 @ (ccsn @ (ccneg @ cc1))) @ XG @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ (cco @ XF @ XG @ (ccof @ ccmin))))))))).
...
thf(ai1fmulc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwcel @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ (ccdm @ ccitg1))))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(aneg1rr_thm,axiom,(cwcel @ (ccneg @ cc1) @ ccr)).
thf(ci1fsub_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ (ccdm @ ccitg1))) @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccdm @ ccitg1)))))).
