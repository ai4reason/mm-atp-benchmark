...
thf(cptunimpt_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XK @ Xx3))) @ ccpt))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XK @ Xx3) @ cctop)) @ (^ [Xx3:$i] : XA2))) @ (cwceq @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccuni @ (XK @ Xx3)))) @ (ccuni @ (XJ @ Xx3))))))))))).
