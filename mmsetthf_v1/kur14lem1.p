...
thf(ckur14lem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwss @ XA2 @ XX) => ((cwcel @ (ccdif @ XX @ XA2) @ XT) => ((cwcel @ (ccfv @ XA2 @ XK) @ XT) => (cwi @ (cwceq @ XN @ XA2) @ (cwa @ (cwss @ XN @ XX) @ (cwss @ (ccpr @ (ccdif @ XX @ XN) @ (ccfv @ XN @ XK)) @ XT)))))))))))).
