...
thf(cblhalf_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XY @ XX)) @ (cwa @ (cwcel @ XR @ ccr) @ (cwcel @ XZ @ (cco @ XY @ (cco @ XR @ cc2 @ ccdiv) @ (ccfv @ XM @ ccbl))))) @ (cwss @ (cco @ XY @ (cco @ XR @ cc2 @ ccdiv) @ (ccfv @ XM @ ccbl)) @ (cco @ XZ @ XR @ (ccfv @ XM @ ccbl)))))))))).
