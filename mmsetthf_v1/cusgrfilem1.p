...
thf(acusgredg_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ ccedg))) => (! [Xx3:$i] : (cwi @ (cwcel @ XG @ cccusgr) @ (cwceq @ (XE @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))))))))))).
...
thf(ccusgrfilem1_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xa:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xa) @ ccvtx))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XP @ Xx3 @ Xa) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xa:$i] : (cwa @ (cwne @ (ccv @ Xa) @ XN) @ (cwceq @ (ccv @ Xx3) @ (ccpr @ (ccv @ Xa) @ XN)))) @ (^ [Xa:$i] : XV))) @ (^ [Xx3:$i] : (ccpw @ XV)))))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwcel @ (XG @ Xa) @ cccusgr) @ (cwcel @ XN @ XV)) @ (cwss @ (XP @ Xx3 @ Xa) @ (ccfv @ (XG @ Xa) @ ccedg)))))))))))).
