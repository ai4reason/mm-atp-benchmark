...
thf(cgsumws4_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ ccmnd) @ (cwa @ (cwcel @ XS @ XB2) @ (cwa @ (cwcel @ XT @ XB2) @ (cwa @ (cwcel @ XU @ XB2) @ (cwcel @ XV @ XB2))))) @ (cwceq @ (cco @ XG @ (ccs4 @ XS @ XT @ XU @ XV) @ ccgsu) @ (cco @ XS @ (cco @ XT @ (cco @ XU @ XV @ Xc_pl) @ Xc_pl) @ Xc_pl))))))))))))).
