...
thf(cvfermltlALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz) @ (cwn @ (cwbr @ XP @ XA2 @ ccdvds))) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ XP @ ccmo) @ cc1))))).
