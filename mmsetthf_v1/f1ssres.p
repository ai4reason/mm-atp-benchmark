...
thf(afunres11_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ (cccnv @ XF)) @ (cwfun @ (cccnv @ (ccres @ XF @ XA2))))))).
thf(cf1ssres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwss @ XC @ XA2)) @ (cwf1 @ XC @ XB2 @ (ccres @ XF @ XC)))))))).
