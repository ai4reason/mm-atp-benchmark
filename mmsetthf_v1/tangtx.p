...
thf(acos01bnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) @ (cwa @ (cwbr @ (cco @ cc1 @ (cco @ cc2 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmul) @ ccmin) @ (ccfv @ XA2 @ cccos) @ cclt) @ (cwbr @ (ccfv @ XA2 @ cccos) @ (cco @ cc1 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ cclt))))).
...
thf(asubadd4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccmin) @ (cco @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ ccmin))))))))))))).
...
thf(ctangtx_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) @ (cwbr @ XA2 @ (ccfv @ XA2 @ cctan) @ cclt)))).
