...
thf(cs2eq2s1eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XD @ XV))) @ (cwb @ (cwceq @ (ccs2 @ XA2 @ XB2) @ (ccs2 @ XC @ XD)) @ (cwa @ (cwceq @ (ccs1 @ XA2) @ (ccs1 @ XC)) @ (cwceq @ (ccs1 @ XB2) @ (ccs1 @ XD))))))))))).
