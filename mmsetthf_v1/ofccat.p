...
thf(aifbieq12d2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ (cwa @ Xph @ Xps) @ (cwceq @ XA2 @ XC)) => ((cwi @ (cwa @ Xph @ (cwn @ Xps)) @ (cwceq @ XB2 @ XD)) => (cwi @ Xph @ (cwceq @ (ccif @ Xps @ XA2 @ XB2) @ (ccif @ Xch @ XC @ XD)))))))))))))).
...
thf(afzocatel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo)) @ (cwn @ (cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)))) @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ ccc0 @ XC @ ccfzo))))))).
...
thf(cofccat_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwcel @ XE @ (ccword @ XS))) => ((cwi @ Xph @ (cwcel @ XF @ (ccword @ XS))) => ((cwi @ Xph @ (cwcel @ XG @ (ccword @ XT))) => ((cwi @ Xph @ (cwcel @ XH @ (ccword @ XT))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XE @ cchash) @ (ccfv @ XG @ cchash))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ cchash) @ (ccfv @ XH @ cchash))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XE @ XF @ ccconcat) @ (cco @ XG @ XH @ ccconcat) @ (ccof @ XR)) @ (cco @ (cco @ XE @ XG @ (ccof @ XR)) @ (cco @ XF @ XH @ (ccof @ XR)) @ ccconcat)))))))))))))))))).
