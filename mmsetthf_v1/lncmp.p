...
thf(aisline3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xq @ Xp) @ (ccfv @ XK @ ccjn)))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xq @ Xp) @ (ccfv @ XK @ cclines)))) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwcel @ (ccfv @ XX @ XM) @ (XN @ Xq @ Xp)) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ (ccv @ Xp) @ (ccv @ Xq)) @ (cwceq @ XX @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp))))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))))))))))))))).
...
thf(alneq2at_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XN @ (ccfv @ XK @ cclines)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ (ccfv @ XX @ XM) @ XN)) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwne @ XP @ XQ)) @ (cwa @ (cwbr @ XP @ XX @ Xc_le) @ (cwbr @ XQ @ XX @ Xc_le))) @ (cwceq @ XX @ (cco @ XP @ XQ @ Xc_or)))))))))))))))))))).
...
thf(clncmp_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XN @ (ccfv @ XK @ cclines)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwa @ (cwcel @ (ccfv @ XX @ XM) @ XN) @ (cwcel @ (ccfv @ XY @ XM) @ XN))) @ (cwb @ (cwbr @ XX @ XY @ Xc_le) @ (cwceq @ XX @ XY))))))))))))))).
