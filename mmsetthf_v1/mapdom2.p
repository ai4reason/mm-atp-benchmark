...
thf(amap0g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmap) @ cc0) @ (cwa @ (cwceq @ XA2 @ cc0) @ (cwne @ XB2 @ cc0))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(axpdom3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwne @ XB2 @ cc0)) @ (cwbr @ XA2 @ (ccxp @ XA2 @ XB2) @ ccdom))))))).
...
thf(amapunen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwbr @ (cco @ XC @ (ccun @ XA2 @ XB2) @ ccmap) @ (ccxp @ (cco @ XC @ XA2 @ ccmap) @ (cco @ XC @ XB2 @ ccmap)) @ ccen))))))))).
...
thf(cmapdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwn @ (cwa @ (cwceq @ XA2 @ cc0) @ (cwceq @ XC @ cc0)))) @ (cwbr @ (cco @ XC @ XA2 @ ccmap) @ (cco @ XC @ XB2 @ ccmap) @ ccdom)))))).
