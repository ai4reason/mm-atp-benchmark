...
thf(cneiss_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) @ (cwss @ XR @ XS)) @ (cwcel @ XN @ (ccfv @ XR @ (ccfv @ XJ @ ccnei))))))))).
