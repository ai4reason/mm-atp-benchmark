...
thf(adf_psr1_ax,axiom,(cwceq @ ccps1 @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccfv @ cc0 @ (cco @ cc1o @ (ccv @ Xr) @ ccopws)))))).
...
thf(cpsr1val_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccps1)) => (cwceq @ XS @ (ccfv @ cc0 @ (cco @ cc1o @ XR @ ccopws))))))).
