...
thf(almbr2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xu:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xu @ Xk) @ ccuz)))) => ((! [Xu:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xu @ Xk) @ ccz)))) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) @ (cw3a @ (cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) @ (cwcel @ XP @ XX) @ (cwral @ (^ [Xu:$i] : (cwi @ (cwcel @ XP @ (ccv @ Xu)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (cwcel @ (ccv @ Xk) @ (ccdm @ XF)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xu)))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))) @ (^ [Xu:$i] : XJ)))))))))))))))).
thf(asylib_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwb @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(acnptop1_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) @ (cwcel @ XJ @ cctop))))))).
...
thf(aelpm2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ ccpm)) @ (cwa @ (cwf @ (ccdm @ XF) @ XA2 @ XF) @ (cwss @ (ccdm @ XF) @ XB2)))))))))).
...
thf(clmcnp_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp)))) => (cwi @ Xph @ (cwbr @ (cccom @ XG @ XF) @ (ccfv @ XP @ XG) @ (ccfv @ XK @ cclm)))))))))))).
