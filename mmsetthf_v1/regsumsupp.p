...
thf(agsumress_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XG @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ (XX @ Xx3)))) => ((cwi @ Xph @ (cwss @ XS @ XB2)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3) @ XS @ (XF @ Xx3)))) => ((cwi @ Xph @ (cwcel @ Xc_0 @ XS)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwa @ (cwceq @ (cco @ Xc_0 @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xx3)) @ (cwceq @ (cco @ (ccv @ Xx3) @ Xc_0 @ Xc_pl) @ (ccv @ Xx3))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ XG @ (XF @ Xx3) @ ccgsu) @ (cco @ XH @ (XF @ Xx3) @ ccgsu))))))))))))))))))))))))).
...
thf(cregsumsupp_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwf @ XI @ ccr @ XF) @ (cwbr @ XF @ ccc0 @ ccfsupp) @ (cwcel @ XI @ XV)) @ (cwceq @ (cco @ ccrefld @ XF @ ccgsu) @ (ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))).
