...
thf(aanabss4_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ (cwa @ Xps @ Xph) @ Xps) @ Xch) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(asspsstri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwo @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ XA2)) @ (cw3o @ (cwpss @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2) @ (cwpss @ XB2 @ XA2)))))).
...
thf(aordelpss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cword @ XB2)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwpss @ XA2 @ XB2)))))).
thf(abiidd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ Xph @ (cwb @ Xps @ Xps))))).
thf(aancoms_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ Xps @ Xph) @ Xch)))))).
thf(cordtri3or_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cword @ XB2)) @ (cw3o @ (cwcel @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2) @ (cwcel @ XB2 @ XA2)))))).
