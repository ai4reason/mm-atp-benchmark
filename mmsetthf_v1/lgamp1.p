...
thf(clgamp1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclgam) @ (cco @ (ccfv @ XA2 @ cclgam) @ (ccfv @ XA2 @ cclog) @ ccaddc))))).
