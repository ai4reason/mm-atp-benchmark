...
thf(amulgcddvds_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwbr @ (cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) @ (cco @ (cco @ XK @ XM @ ccgcd) @ (cco @ XK @ XN @ ccgcd) @ ccmul) @ ccdvds)))))).
...
thf(crpmul_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwa @ (cwceq @ (cco @ XK @ XM @ ccgcd) @ cc1) @ (cwceq @ (cco @ XK @ XN @ ccgcd) @ cc1)) @ (cwceq @ (cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) @ cc1))))))).
