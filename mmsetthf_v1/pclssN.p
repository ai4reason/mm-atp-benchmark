...
thf(cpclssN_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cw3a @ (cwcel @ XK @ XV) @ (cwss @ XX @ XY) @ (cwss @ XY @ XA2)) @ (cwss @ (ccfv @ XX @ XU) @ (ccfv @ XY @ XU)))))))))))).
