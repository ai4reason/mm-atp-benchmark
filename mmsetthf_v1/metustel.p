...
thf(cmetustel_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xa:$i] : (cwceq @ (XF @ Xa) @ (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico))))))) => (! [Xa:$i] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwb @ (cwcel @ XB2 @ (XF @ Xa)) @ (cwrex @ (^ [Xa:$i] : (cwceq @ XB2 @ (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))) @ (^ [Xa:$i] : ccrp))))))))))).
