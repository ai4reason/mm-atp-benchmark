...
thf(aneiuni_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwceq @ XX @ (ccuni @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))))))))).
...
thf(a_0nnei_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwne @ XS @ cc0)) @ (cwn @ (cwcel @ cc0 @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))))))).
...
thf(ainnei_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) @ (cwcel @ XM @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))) @ (cwcel @ (ccin @ XN @ XM) @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))).
...
thf(cneifil_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) @ (cwcel @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccfv @ XX @ ccfil))))))).
