...
thf(aimaiun1_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (cwceq @ (ccima @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC) @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccima @ (XB2 @ Xx3) @ XC)))))))).
...
thf(arelexpsucnnl_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) @ (cccom @ XR @ (cco @ XR @ XN @ ccrelexp)))))))).
...
thf(ctrclimalb2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwss @ (ccima @ XR @ (ccun @ XA2 @ XB2)) @ XB2)) @ (cwss @ (ccima @ (ccfv @ XR @ cctcl) @ XA2) @ XB2))))))).
