...
thf(cclwwlkbp_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) @ (cw3a @ (cwcel @ XG @ ccvv) @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)))))))).
