...
thf(areef11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cce) @ (ccfv @ XB2 @ cce)) @ (cwceq @ XA2 @ XB2)))))).
thf(cefieq1re_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ cc1)) @ (cwcel @ XA2 @ ccr)))).
