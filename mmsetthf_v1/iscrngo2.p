...
thf(aiscom2_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XG @ (XA2 @ Xa @ Xb)) @ (cwcel @ XH @ (XB2 @ Xa @ Xb))) @ (cwb @ (cwcel @ (ccop @ XG @ XH) @ cccm2) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwceq @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) @ (cco @ (ccv @ Xb) @ (ccv @ Xa) @ XH))) @ (^ [Xb:$i] : (ccrn @ XG)))) @ (^ [Xa:$i] : (ccrn @ XG)))))))))))).
thf(ciscrngo2_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccfv @ XR @ cc1st)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XH @ Xx3 @ Xy1) @ (ccfv @ XR @ cc2nd)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xx3 @ Xy1))))) => (cwb @ (cwcel @ XR @ cccring) @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XH @ Xx3 @ Xy1)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (XH @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))).
