...
thf(afprodm1s_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (XA2 @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (cco @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsb @ XN @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccmul)))))))))).
...
thf(cfprodeq0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XN @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xk) @ XN)) @ (cwceq @ (XA2 @ Xk) @ ccc0))) => (cwi @ (cwa @ Xph @ (cwcel @ XK @ (ccfv @ XN @ ccuz))) @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XK @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccc0))))))))))))).
