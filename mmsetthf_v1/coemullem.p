...
thf(ccoemullem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XB2 @ (ccfv @ XG @ cccoe)) => ((! [Xn:$i] : (cwceq @ (XM @ Xn) @ (ccfv @ XF @ ccdgr))) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply))) @ (cwa @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccsu @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ XB2) @ ccmul)))))) @ (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdgr) @ (cco @ (XM @ Xn) @ XN @ ccaddc) @ ccle)))))))))))))))).
