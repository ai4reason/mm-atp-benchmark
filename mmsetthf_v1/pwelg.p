...
thf(cpwelg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccuni @ (ccv @ Xx3)) @ XB2) @ (cwcel @ (ccpw @ (ccv @ Xx3)) @ XB2))) @ (^ [Xx3:$i] : XB2)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwcel @ (ccpw @ XA2) @ XB2)))))).
