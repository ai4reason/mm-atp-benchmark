...
thf(alcmgcd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ XM @ XN @ cclcm) @ (cco @ XM @ XN @ ccgcd) @ ccmul) @ (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs)))))).
...
thf(clcmid_conj,conjecture,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccz) @ (cwceq @ (cco @ XM @ XM @ cclcm) @ (ccfv @ XM @ ccabs))))).
