...
thf(cislsat_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccfv @ XW @ cclsa))) => (! [Xx3:$i] : (cwi @ (cwcel @ XW @ XX) @ (cwb @ (cwcel @ XU @ (XA2 @ Xx3)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XU @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ XN))) @ (^ [Xx3:$i] : (ccdif @ XV @ (ccsn @ Xc_0))))))))))))))))))).
