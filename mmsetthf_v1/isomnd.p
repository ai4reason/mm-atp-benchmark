...
thf(adf_omnd_ax,axiom,(cwceq @ ccomnd @ (ccrab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xl:$i] : (cwa @ (cwcel @ (ccv @ Xg1) @ cctos) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwi @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xl)) @ (cwbr @ (cco @ (ccv @ Xa) @ (ccv @ Xc) @ (ccv @ Xp)) @ (cco @ (ccv @ Xb) @ (ccv @ Xc) @ (ccv @ Xp)) @ (ccv @ Xl)))) @ (^ [Xc:$i] : (ccv @ Xv)))) @ (^ [Xb:$i] : (ccv @ Xv)))) @ (^ [Xa:$i] : (ccv @ Xv))))) @ (ccfv @ (ccv @ Xg1) @ ccple))) @ (ccfv @ (ccv @ Xg1) @ ccplusg))) @ (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xg1:$i] : ccmnd)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(cisomnd_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (Xc_pl @ Xa @ Xb @ Xc) @ (ccfv @ XM @ ccplusg))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (Xc_le @ Xa @ Xb @ Xc) @ (ccfv @ XM @ ccple))))) => (cwb @ (cwcel @ XM @ ccomnd) @ (cw3a @ (cwcel @ XM @ ccmnd) @ (cwcel @ XM @ cctos) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwi @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ (Xc_le @ Xa @ Xb @ Xc)) @ (cwbr @ (cco @ (ccv @ Xa) @ (ccv @ Xc) @ (Xc_pl @ Xa @ Xb @ Xc)) @ (cco @ (ccv @ Xb) @ (ccv @ Xc) @ (Xc_pl @ Xa @ Xb @ Xc)) @ (Xc_le @ Xa @ Xb @ Xc)))) @ (^ [Xc:$i] : XB2))) @ (^ [Xb:$i] : XB2))) @ (^ [Xa:$i] : XB2)))))))))))).
