...
thf(aleoppos_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccho) @ (cwb @ (cwbr @ cch0o @ XT @ ccleo) @ (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) @ ccle)) @ (^ [Xx3:$i] : cchil)))))).
thf(cleopsq_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccho) @ (cwbr @ cch0o @ (cccom @ XT @ XT) @ ccleo)))).
