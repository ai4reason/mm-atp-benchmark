...
thf(advdszrcl_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwbr @ XX @ XY @ ccdvds) @ (cwa @ (cwcel @ XX @ ccz) @ (cwcel @ XY @ ccz)))))).
...
thf(alcmdvds_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwa @ (cwbr @ XM @ XK @ ccdvds) @ (cwbr @ XN @ XK @ ccdvds)) @ (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccdvds))))))).
...
thf(anzss_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ XV)) => (cwi @ Xph @ (cwb @ (cwss @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) @ (cwbr @ XN @ XM @ ccdvds)))))))))).
...
thf(cnzin_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => (cwi @ Xph @ (cwceq @ (ccin @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) @ (ccima @ ccdvds @ (ccsn @ (cco @ XM @ XN @ cclcm))))))))))).
