...
thf(amdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwss @ XC @ XB2))) @ (cwceq @ (ccin @ (cco @ XC @ XA2 @ cchj) @ XB2) @ (cco @ XC @ (ccin @ XA2 @ XB2) @ cchj))))))).
...
thf(amdbr2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwss @ (ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) @ (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
...
thf(cmdexchi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwi @ (cw3a @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ cchj) @ ccmd) @ (cwss @ (ccin @ XC @ (cco @ XA2 @ XB2 @ cchj)) @ XA2)) @ (cwa @ (cwbr @ (cco @ XC @ XA2 @ cchj) @ XB2 @ ccmd) @ (cwceq @ (ccin @ (cco @ XC @ XA2 @ cchj) @ XB2) @ (ccin @ XA2 @ XB2))))))))))).
