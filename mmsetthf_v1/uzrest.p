...
thf(auzin_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (ccin @ (ccfv @ XM @ ccuz) @ (ccfv @ XN @ ccuz)) @ (ccfv @ (ccif @ (cwbr @ XM @ XN @ ccle) @ XN @ XM) @ ccuz)))))).
...
thf(cuzrest_conj,conjecture,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XM @ ccz) @ (cwceq @ (cco @ (ccrn @ ccuz) @ XZ @ ccrest) @ (ccima @ ccuz @ XZ))))))).
