...
thf(adf_pconn_ax,axiom,(cwceq @ ccpconn @ (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ (ccv @ Xx3)) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xf1)) @ (ccv @ Xy1)))) @ (^ [Xf1:$i] : (cco @ ccii @ (ccv @ Xj) @ cccn)))) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xj))))) @ (^ [Xx3:$i] : (ccuni @ (ccv @ Xj))))) @ (^ [Xj:$i] : cctop)))).
thf(cispconn_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XX @ Xf1) @ (ccuni @ XJ))) => (! [Xf1:$i] : (cwb @ (cwcel @ XJ @ ccpconn) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ (ccv @ Xx3)) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xf1)) @ (ccv @ Xy1)))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn)))) @ (^ [Xy1:$i] : (XX @ Xf1)))) @ (^ [Xx3:$i] : (XX @ Xf1)))))))))).
