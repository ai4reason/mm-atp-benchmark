...
thf(apmapssbaN_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ XC) @ (cwcel @ XX @ XB2)) @ (cwss @ (ccfv @ XX @ XM) @ XB2)))))))))).
...
thf(a_2pmaplubN_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XU @ (ccfv @ XK @ cclub)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwss @ XS @ XA2)) @ (cwceq @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ XS @ XU) @ XM) @ XU) @ XM) @ (ccfv @ (ccfv @ XS @ XU) @ XM)))))))))))).
thf(a_2polcon4bN_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccpolN)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) @ (cwb @ (cwss @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) @ (ccfv @ (ccfv @ XY @ Xc_pe) @ Xc_pe)) @ (cwss @ (ccfv @ XY @ Xc_pe) @ (ccfv @ XX @ Xc_pe)))))))))))).
thf(cpaddunN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccpolN)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XS @ XA2) @ (cwss @ XT @ XA2)) @ (cwceq @ (ccfv @ (cco @ XS @ XT @ Xc_pl) @ Xc_pe) @ (ccfv @ (ccun @ XS @ XT) @ Xc_pe))))))))))))).
