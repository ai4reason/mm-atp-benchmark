...
thf(aacufl_thm,axiom,(cwi @ cwac @ (cwceq @ ccufl @ ccvv))).
thf(acardeqv_thm,axiom,(cwceq @ (ccdm @ cccrd) @ ccvv)).
...
thf(aptcmpg_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XF @ ccpt)) => ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cccmp @ XF) @ (cwcel @ XX @ (ccin @ ccufl @ (ccdm @ cccrd)))) @ (cwcel @ XJ @ cccmp)))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(cptcmp_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cccmp @ XF)) @ (cwcel @ (ccfv @ XF @ ccpt) @ cccmp)))))).
