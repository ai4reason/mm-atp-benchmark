...
thf(aprodf1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XN @ XZ) @ (cwceq @ (ccfv @ XN @ (ccseq @ ccmul @ (ccxp @ XZ @ (ccsn @ cc1)) @ XM)) @ cc1))))))).
