...
thf(cupgrwlkvtxedg_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XE @ Xk) @ (ccfv @ XG @ ccedg))) => (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (XE @ Xk))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
