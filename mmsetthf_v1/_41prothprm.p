...
thf(a_41prothprmlem2_thm,axiom,(! [XP:($i > $o)] : ((cwceq @ XP @ (ccdc @ cc4 @ cc1)) => (cwceq @ (cco @ (cco @ cc3 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) @ (cco @ (ccneg @ cc1) @ XP @ ccmo))))).
...
thf(aproththd_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xx3) @ ccn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ XP @ (cco @ (cco @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ cclt))) => ((cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) @ (cco @ (ccneg @ cc1) @ XP @ ccmo))) @ (^ [Xx3:$i] : ccz))) => (cwi @ Xph @ (cwcel @ XP @ ccprime)))))))))))).
...
thf(c_41prothprm_conj,conjecture,(! [XP:($i > $o)] : ((cwceq @ XP @ (ccdc @ cc4 @ cc1)) => (cwa @ (cwceq @ XP @ (cco @ (cco @ cc5 @ (cco @ cc2 @ cc3 @ ccexp) @ ccmul) @ cc1 @ ccaddc)) @ (cwcel @ XP @ ccprime))))).
