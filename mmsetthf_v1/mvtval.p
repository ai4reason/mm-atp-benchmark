...
thf(adf_mvt_ax,axiom,(cwceq @ ccmvt @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccrn @ (ccfv @ (ccv @ Xt) @ ccmty)))))).
...
thf(cmvtval_conj,conjecture,(! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvt)) => ((cwceq @ XY @ (ccfv @ XT @ ccmty)) => (cwceq @ XV @ (ccrn @ XY)))))))).
