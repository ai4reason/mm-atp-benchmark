...
thf(apjhf_thm,axiom,(! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ ccch) @ (cwf @ cchil @ cchil @ (ccfv @ XH @ ccpjh))))).
...
thf(apj11_thm,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccch) @ (cwcel @ XH @ ccch)) @ (cwb @ (cwceq @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) @ (cwceq @ XG @ XH)))))).
...
thf(cpjmf1_conj,conjecture,(cwf1 @ ccch @ (cco @ cchil @ cchil @ ccmap) @ ccpjh)).
