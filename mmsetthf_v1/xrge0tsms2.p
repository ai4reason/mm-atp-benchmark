...
thf(axrge0tsms_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwceq @ XG @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xs1)))) => ((cwi @ Xph @ (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((! [Xs1:$i] : (cwceq @ (XS @ Xs1) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xs1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)) @ (^ [Xs1:$i] : (cco @ XG @ (ccres @ XF @ (ccv @ Xs1)) @ ccgsu)))) @ ccxr @ cclt))) => (! [Xs1:$i] : (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ cctsu) @ (ccsn @ (XS @ Xs1)))))))))))))))).
...
thf(cxrge0tsms2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) @ (cwbr @ (cco @ XG @ XF @ cctsu) @ cc1o @ ccen)))))))).
