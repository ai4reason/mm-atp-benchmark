...
thf(clmodscaf_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_xb @ (ccfv @ XW @ ccscaf)) => (cwi @ (cwcel @ XW @ cclmod) @ (cwf @ (ccxp @ XK @ XB2) @ XB2 @ Xc_xb)))))))))))).
