...
thf(cdvdsgcd_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwa @ (cwbr @ XK @ XM @ ccdvds) @ (cwbr @ XK @ XN @ ccdvds)) @ (cwbr @ XK @ (cco @ XM @ XN @ ccgcd) @ ccdvds))))))).
