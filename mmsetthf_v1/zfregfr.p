...
thf(azfreg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ (ccv @ Xx3) @ XA2) @ cc0)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(czfregfr_conj,conjecture,(! [XA2:($i > $o)] : (cwfr @ XA2 @ ccep))).
