...
thf(aimasleval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwceq @ (XU @ Xa @ Xb @ Xc @ Xd) @ (cco @ XF @ (XR @ Xa @ Xb @ Xc @ Xd) @ ccimas))))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwceq @ XV @ (ccfv @ (XR @ Xa @ Xb @ Xc @ Xd) @ ccbs))))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwfo @ XV @ (XB2 @ Xa @ Xb @ Xc @ Xd) @ XF)))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xa @ Xb @ Xc @ Xd) @ (XZ @ Xa @ Xb @ Xc @ Xd))))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (Xc_le @ Xa @ Xb) @ (ccfv @ (XU @ Xa @ Xb @ Xc @ Xd) @ ccple)))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ XN @ (ccfv @ (XR @ Xa @ Xb @ Xc @ Xd) @ ccple)))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xa) @ XV) @ (cwcel @ (ccv @ Xb) @ XV)) @ (cwa @ (cwcel @ (ccv @ Xc) @ XV) @ (cwcel @ (ccv @ Xd) @ XV))) @ (cwi @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xc) @ XF)) @ (cwceq @ (ccfv @ (ccv @ Xb) @ XF) @ (ccfv @ (ccv @ Xd) @ XF))) @ (cwb @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ XN) @ (cwbr @ (ccv @ Xc) @ (ccv @ Xd) @ XN)))))))) => (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (XX @ Xa @ Xb) @ XV) @ (cwcel @ (XY @ Xa @ Xb @ Xc) @ XV)) @ (cwb @ (cwbr @ (ccfv @ (XX @ Xa @ Xb) @ XF) @ (ccfv @ (XY @ Xa @ Xb @ Xc) @ XF) @ (Xc_le @ Xa @ Xb)) @ (cwbr @ (XX @ Xa @ Xb) @ (XY @ Xa @ Xb @ Xc) @ XN))))))))))))))))))))))))).
...
thf(af1olecpbl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf1o @ XV @ XX @ XF)) => (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XD @ XV))) @ (cwi @ (cwa @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XC @ XF)) @ (cwceq @ (ccfv @ XB2 @ XF) @ (ccfv @ XD @ XF))) @ (cwb @ (cwbr @ XA2 @ XB2 @ XN) @ (cwbr @ XC @ XD @ XN))))))))))))))).
...
thf(aprdsleval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwfn @ XR @ XI)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((! [Xx3:$i] : (cwceq @ (Xc_le @ Xx3) @ (ccfv @ XY @ ccple))) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XF @ XG @ (Xc_le @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccple))) @ (^ [Xx3:$i] : XI))))))))))))))))))))))))).
