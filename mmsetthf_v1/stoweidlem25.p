...
thf(cstoweidlem25_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XQ @ Xt) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (cco @ cc1 @ (cco @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ (XN @ Xt) @ ccexp) @ ccmin) @ (cco @ (XK @ Xt) @ (XN @ Xt) @ ccexp) @ ccexp))))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XN @ Xt) @ ccn))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XK @ Xt) @ ccn))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XD @ Xt) @ ccrp))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwf @ XT @ ccr @ (XP @ Xt)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwral @ (^ [Xt:$i] : (cwa @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ cc1 @ ccle))) @ (^ [Xt:$i] : XT)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwral @ (^ [Xt:$i] : (cwbr @ (XD @ Xt) @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ ccle)) @ (^ [Xt:$i] : (ccdif @ XT @ (XU @ Xt)))))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XE @ Xt) @ ccrp))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwbr @ (cco @ cc1 @ (cco @ (cco @ (XK @ Xt) @ (XD @ Xt) @ ccmul) @ (XN @ Xt) @ ccexp) @ ccdiv) @ (XE @ Xt) @ cclt))) => (! [Xt:$i] : (cwi @ (cwa @ (Xph @ Xt) @ (cwcel @ (ccv @ Xt) @ (ccdif @ XT @ (XU @ Xt)))) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (XQ @ Xt)) @ (XE @ Xt) @ cclt)))))))))))))))))))))).
