...
thf(cwlkwwlkbij2_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (XV @ Xw @ Xf1 @ Xp)) @ (cwcel @ XN @ ccn0)) @ (cwex @ (^ [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xp:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) @ XN) @ (cwceq @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xp) @ cc2nd)) @ XP))) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XP)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))) @ (ccv @ Xf1))))))))))))).
