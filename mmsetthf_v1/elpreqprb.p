...
thf(aelpreqpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccpr @ XB2 @ XC)) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (ccpr @ XB2 @ XC) @ (ccpr @ XA2 @ (ccv @ Xx3)))))))))).
...
thf(celpreqprb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ (ccpr @ XB2 @ XC)) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (ccpr @ XB2 @ XC) @ (ccpr @ XA2 @ (ccv @ Xx3)))))))))))).
