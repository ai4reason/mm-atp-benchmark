...
thf(adochord_thm,axiom,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwceq @ Xc_pe @ (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ (ccrn @ XI))) => ((cwi @ Xph @ (cwcel @ XY @ (ccrn @ XI))) => (cwi @ Xph @ (cwb @ (cwss @ XX @ XY) @ (cwss @ (ccfv @ XY @ Xc_pe) @ (ccfv @ XX @ Xc_pe))))))))))))))))))).
...
thf(cdochord3_conj,conjecture,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwceq @ Xc_pe @ (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ (ccrn @ XI))) => ((cwi @ Xph @ (cwcel @ XY @ (ccrn @ XI))) => (cwi @ Xph @ (cwb @ (cwss @ XX @ (ccfv @ XY @ Xc_pe)) @ (cwss @ XY @ (ccfv @ XX @ Xc_pe))))))))))))))))))).
