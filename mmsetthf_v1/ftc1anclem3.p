...
thf(ai1fmul_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (ccdm @ ccitg1))))))))).
...
thf(cftc1anclem3_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ (ccdm @ ccitg1))) @ (cwcel @ (cccom @ ccabs @ (cco @ XF @ (cco @ (ccxp @ ccr @ (ccsn @ cci)) @ XG @ (ccof @ ccmul)) @ (ccof @ ccaddc))) @ (ccdm @ ccitg1)))))).
