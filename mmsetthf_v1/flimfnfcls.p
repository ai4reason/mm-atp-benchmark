...
thf(aflimss2_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XG @ XF)) @ (cwss @ (cco @ XJ @ XG @ ccflim) @ (cco @ XJ @ XF @ ccflim)))))))).
...
thf(ainssdif0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwss @ (ccin @ XA2 @ XB2) @ XC) @ (cwceq @ (ccin @ XA2 @ (ccdif @ XB2 @ XC)) @ cc0)))))).
...
thf(asupfil_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ XB2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ ccfil)))))))).
...
thf(afclsopni_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cw3a @ (cwcel @ XU @ XJ) @ (cwcel @ XA2 @ XU) @ (cwcel @ XS @ XF))) @ (cwne @ (ccin @ XU @ XS) @ cc0)))))))).
...
thf(cflimfnfcls_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) @ (cwral @ (^ [Xg1:$i] : (cwi @ (cwss @ XF @ (ccv @ Xg1)) @ (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccfcls)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil))))))))))).
