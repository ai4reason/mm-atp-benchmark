...
thf(adf2nd2_thm,axiom,(cwceq @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwceq @ (ccv @ Xz) @ (ccv @ Xy1)))))) @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv)))).
...
thf(cdf2ndres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccres @ cc2nd @ (ccxp @ XA2 @ XB2)) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xy1)))))))).
