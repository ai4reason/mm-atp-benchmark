...
thf(ainfpwfidom_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccvv) @ (cwbr @ XA2 @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccdom)))).
...
thf(afpwwecbv_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xa:$i] : (cwceq @ (XW @ Xx3 @ Xy1 @ Xz @ Xs1 @ Xr @ Xa) @ (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xz)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (cwa @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))) @ XF) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xa:$i] : (cwceq @ (XW @ Xx3 @ Xy1 @ Xz @ Xs1 @ Xr @ Xa) @ (ccopab @ (^ [Xa:$i] : (^ [Xs1:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xa) @ (XA2 @ Xy1 @ Xz)) @ (cwss @ (ccv @ Xs1) @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)))) @ (cwa @ (cwwe @ (ccv @ Xa) @ (ccv @ Xs1)) @ (cwral @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xs1)) @ (ccsn @ (ccv @ Xz))) @ XF) @ (ccv @ Xz))) @ (^ [Xz:$i] : (ccv @ Xa)))))))))))))))))))).
...
thf(ccanthnum_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ XA2 @ (ccin @ (ccpw @ XA2) @ (ccdm @ cccrd)) @ ccsdm))))).
