...
thf(advdsprmpweqle_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccn0)) @ (cwi @ (cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwa @ (cwbr @ (ccv @ Xn) @ XN @ ccle) @ (cwceq @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp)))) @ (^ [Xn:$i] : ccn0)))))))).
...
thf(codz2prm2pw_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) @ (cwa @ (cwne @ (cco @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp) @ XP @ ccmo) @ cc1) @ (cwceq @ (cco @ (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccexp) @ XP @ ccmo) @ cc1))) @ (cwceq @ (ccfv @ cc2 @ (ccfv @ XP @ ccodz)) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp)))))).
