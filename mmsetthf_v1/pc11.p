...
thf(cpc11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwral @ (^ [Xp:$i] : (cwceq @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ (cco @ (ccv @ Xp) @ XB2 @ ccpc))) @ (^ [Xp:$i] : ccprime))))))).
