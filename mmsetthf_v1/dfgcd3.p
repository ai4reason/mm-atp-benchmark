...
thf(adfgcd2_thm,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwceq @ XD @ (cco @ XM @ XN @ ccgcd)) @ (cw3a @ (cwbr @ ccc0 @ XD @ ccle) @ (cwa @ (cwbr @ XD @ XM @ ccdvds) @ (cwbr @ XD @ XN @ ccdvds)) @ (cwral @ (^ [Xe:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xe) @ XM @ ccdvds) @ (cwbr @ (ccv @ Xe) @ XN @ ccdvds)) @ (cwbr @ (ccv @ Xe) @ XD @ ccdvds))) @ (^ [Xe:$i] : ccz))))))))).
...
thf(cdfgcd3_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ (ccrio @ (^ [Xd:$i] : (cwral @ (^ [Xz:$i] : (cwb @ (cwbr @ (ccv @ Xz) @ (ccv @ Xd) @ ccdvds) @ (cwa @ (cwbr @ (ccv @ Xz) @ XM @ ccdvds) @ (cwbr @ (ccv @ Xz) @ XN @ ccdvds)))) @ (^ [Xz:$i] : ccz))) @ (^ [Xd:$i] : ccn0))))))).
