...
thf(cifbothda_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xet:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ (cwceq @ XA2 @ (ccif @ Xph @ XA2 @ XB2)) @ (cwb @ Xps @ Xth)) => ((cwi @ (cwceq @ XB2 @ (ccif @ Xph @ XA2 @ XB2)) @ (cwb @ Xch @ Xth)) => ((cwi @ (cwa @ Xet @ Xph) @ Xps) => ((cwi @ (cwa @ Xet @ (cwn @ Xph)) @ Xch) => (cwi @ Xet @ Xth))))))))))))).
