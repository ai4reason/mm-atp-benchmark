...
thf(akgentop_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccrn @ cckgen)) @ (cwcel @ XJ @ cctop)))).
...
thf(akgenidm_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccrn @ cckgen)) @ (cwceq @ (ccfv @ XJ @ cckgen) @ XJ)))).
...
thf(atoponcom_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ (ccfv @ (ccuni @ XJ) @ cctopon))) @ (cwcel @ XJ @ (ccfv @ (ccuni @ XK) @ cctopon)))))).
...
thf(ckgencn3_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccrn @ cckgen)) @ (cwcel @ XK @ cctop)) @ (cwceq @ (cco @ XJ @ XK @ cccn) @ (cco @ XJ @ (ccfv @ XK @ cckgen) @ cccn)))))).
