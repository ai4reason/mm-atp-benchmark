...
thf(avtxduhgr0edgnel_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XD @ Xe) @ (ccfv @ XG @ ccvtxdg))) => (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccuhgr) @ (cwcel @ XU @ XV)) @ (cwb @ (cwceq @ (ccfv @ XU @ (XD @ Xe)) @ ccc0) @ (cwn @ (cwrex @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
...
thf(assn0rex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XB2) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XB2)))))).
...
thf(cuhgrvd00_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XG @ ccuhgr) @ (cwi @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ ccc0)) @ (^ [Xv:$i] : XV)) @ (cwceq @ XE @ cc0))))))))).
