...
thf(aunisngl_thm,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => (cwceq @ XX @ (ccuni @ XC)))))).
...
thf(cdissnref_conj,conjecture,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwceq @ (ccuni @ XY) @ XX)) @ (cwbr @ XC @ XY @ ccref)))))))).
