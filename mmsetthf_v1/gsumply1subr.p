...
thf(asubrgply1_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (ccfv @ XH @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => (cwi @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg)) @ (cwcel @ XB2 @ (ccfv @ XS @ ccsubrg)))))))))))))).
...
thf(aressply1bas_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (ccfv @ XH @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((cwceq @ XP @ (cco @ XS @ XB2 @ ccress)) => (cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XP @ ccbs)))))))))))))))))).
...
thf(aringmgm_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccrg) @ (cwcel @ XR @ ccmgm)))).
...
thf(cgsumply1subr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (ccfv @ XH @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ XS @ XF @ ccgsu) @ (cco @ XU @ XF @ ccgsu))))))))))))))))))))).
