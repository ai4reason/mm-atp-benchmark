...
thf(cpjjsi_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccsh) => (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccfv @ XG @ ccort) @ ccpjh)) @ XH)) @ (^ [Xx3:$i] : (cco @ XG @ XH @ cchj))) @ (cwceq @ (cco @ XG @ XH @ cchj) @ (cco @ XG @ XH @ ccph)))))))).
