...
thf(aharmonicbnd3_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (cco @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ cclog) @ ccmin) @ (cco @ ccc0 @ ccem @ ccicc))))).
...
thf(aabsdifled_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ ccle) @ (cwa @ (cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ ccle) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccle)))))))))))).
thf(charmonicbnd4_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (cco @ (ccfv @ XA2 @ cclog) @ ccem @ ccaddc) @ ccmin) @ ccabs) @ (cco @ cc1 @ XA2 @ ccdiv) @ ccle)))).
