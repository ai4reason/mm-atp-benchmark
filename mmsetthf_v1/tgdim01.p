...
thf(ctgdim01_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => ((cwi @ Xph @ (cwn @ (cwbr @ XG @ cc2 @ ccstrkgld))) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XY @ XP)) => ((cwi @ Xph @ (cwcel @ XZ @ XP)) => (cwi @ Xph @ (cw3o @ (cwcel @ XZ @ (cco @ XX @ XY @ XI)) @ (cwcel @ XX @ (cco @ XZ @ XY @ XI)) @ (cwcel @ XY @ (cco @ XX @ XZ @ XI)))))))))))))))))))).
