...
thf(acnvresrn_thm,axiom,(! [XR:($i > $o)] : (cwceq @ (ccres @ (cccnv @ XR) @ (ccrn @ XR)) @ (cccnv @ XR)))).
...
thf(calrmomorn_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (cwb @ (cwal @ (^ [Xx3:$i] : (cwrmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XR @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (ccrn @ (XR @ Xx3 @ Xy1)))))) @ (cwal @ (^ [Xx3:$i] : (cwmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XR @ Xx3 @ Xy1))))))))).
