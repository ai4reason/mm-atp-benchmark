...
thf(alfladd_thm,axiom,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_pd @ (ccfv @ XD @ ccplusg)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XG @ XF) @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV))) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ XG) @ (cco @ (ccfv @ XX @ XG) @ (ccfv @ XY @ XG) @ Xc_pd)))))))))))))))))).
thf(chdmaplna1_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XU @ ccplusg)) => ((cwceq @ XR @ (ccfv @ XU @ ccsca)) => ((cwceq @ Xc_pd @ (ccfv @ XR @ ccplusg)) => ((cwceq @ XS @ (ccfv @ XW @ (ccfv @ XK @ cchdma))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ (ccfv @ XZ @ XS)) @ (cco @ (ccfv @ XX @ (ccfv @ XZ @ XS)) @ (ccfv @ XY @ (ccfv @ XZ @ XS)) @ Xc_pd)))))))))))))))))))))))))))).
