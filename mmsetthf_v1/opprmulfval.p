...
thf(aopprval_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => (cwceq @ XO @ (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (cctpos @ Xc_x)) @ ccsts)))))))))).
...
thf(copprmulfval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => ((cwceq @ Xc_xb @ (ccfv @ XO @ ccmulr)) => (cwceq @ Xc_xb @ (cctpos @ Xc_x)))))))))))).
