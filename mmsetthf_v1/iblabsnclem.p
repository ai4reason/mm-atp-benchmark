...
thf(amax0add_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (cco @ (ccif @ (cwbr @ ccc0 @ XA2 @ ccle) @ XA2 @ ccc0) @ (ccif @ (cwbr @ ccc0 @ (ccneg @ XA2) @ ccle) @ (ccneg @ XA2) @ ccc0) @ ccaddc) @ (ccfv @ XA2 @ ccabs))))).
