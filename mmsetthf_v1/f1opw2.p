...
thf(cf1opw2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf1o @ XA2 @ XB2 @ XF)) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xa)) @ ccvv))) => ((! [Xb:$i] : (cwi @ Xph @ (cwcel @ (ccima @ XF @ (ccv @ Xb)) @ ccvv))) => (cwi @ Xph @ (cwf1o @ (ccpw @ XA2) @ (ccpw @ XB2) @ (ccmpt @ (^ [Xb:$i] : (ccpw @ XA2)) @ (^ [Xb:$i] : (ccima @ XF @ (ccv @ Xb)))))))))))))).
