...
thf(adf_tlm_ax,axiom,(cwceq @ cctlm @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xw) @ ccsca) @ cctrg) @ (cwcel @ (ccfv @ (ccv @ Xw) @ ccscaf) @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xw) @ ccsca) @ cctopn) @ (ccfv @ (ccv @ Xw) @ cctopn) @ cctx) @ (ccfv @ (ccv @ Xw) @ cctopn) @ cccn)))) @ (^ [Xw:$i] : (ccin @ cctmd @ cclmod))))).
thf(cistlm_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XW @ ccscaf)) => ((cwceq @ XJ @ (ccfv @ XW @ cctopn)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ cctopn)) => (cwb @ (cwcel @ XW @ cctlm) @ (cwa @ (cw3a @ (cwcel @ XW @ cctmd) @ (cwcel @ XW @ cclmod) @ (cwcel @ XF @ cctrg)) @ (cwcel @ Xc_x @ (cco @ (cco @ XK @ XJ @ cctx) @ XJ @ cccn)))))))))))))).
