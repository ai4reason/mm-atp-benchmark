...
thf(atskop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ cctsk) @ (cwcel @ XA2 @ XT) @ (cwcel @ XB2 @ XT)) @ (cwcel @ (ccop @ XA2 @ XB2) @ XT)))))).
...
thf(ctskxpss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ cctsk) @ (cwss @ XA2 @ XT) @ (cwss @ XB2 @ XT)) @ (cwss @ (ccxp @ XA2 @ XB2) @ XT)))))).
