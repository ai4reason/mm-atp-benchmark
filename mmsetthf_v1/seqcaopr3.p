...
thf(cseqcaopr3_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XS @ Xn)) @ (cwcel @ (ccv @ Xy1) @ (XS @ Xn)))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xk)) @ (XS @ Xn))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XS @ Xn)) @ (cwcel @ (ccv @ Xy1) @ (XS @ Xn)))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XQ) @ (XS @ Xn)))))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ (XS @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ (XS @ Xn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XH @ Xx3 @ Xy1)) @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ XQ)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ XM @ XN @ ccfzo))) @ (cwceq @ (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (ccseq @ (Xc_pl @ Xk) @ XF @ XM)) @ (ccfv @ (ccv @ Xn) @ (ccseq @ (Xc_pl @ Xk) @ XG @ XM)) @ XQ) @ (cco @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XG) @ XQ) @ (Xc_pl @ Xk)) @ (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (ccseq @ (Xc_pl @ Xk) @ XF @ XM)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (Xc_pl @ Xk)) @ (cco @ (ccfv @ (ccv @ Xn) @ (ccseq @ (Xc_pl @ Xk) @ XG @ XM)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XG) @ (Xc_pl @ Xk)) @ XQ))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (ccseq @ (Xc_pl @ Xk) @ (XH @ Xx3 @ Xy1) @ XM)) @ (cco @ (ccfv @ XN @ (ccseq @ (Xc_pl @ Xk) @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ (Xc_pl @ Xk) @ XG @ XM)) @ XQ))))))))))))))))))))))).
