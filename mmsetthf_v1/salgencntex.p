...
thf(aeqneltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwn @ (cwcel @ XB2 @ XC)) => (cwn @ (cwcel @ XA2 @ XC)))))))).
...
thf(apwsal_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwcel @ (ccpw @ XX) @ ccsalg))))).
...
thf(csalgencntex_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xs1:$i] : (cwceq @ (XA2 @ Xs1) @ (cco @ ccc0 @ cc2 @ ccicc))) => ((! [Xs1:$i] : (cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwbr @ (ccdif @ (XA2 @ Xs1) @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xs1)))))) => ((! [Xs1:$i] : (cwceq @ (XB2 @ Xs1) @ (cco @ ccc0 @ cc1 @ ccicc))) => ((! [Xx3:$i] : (! [Xs1:$i] : (cwceq @ (XT @ Xx3) @ (ccpw @ (XB2 @ Xs1))))) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccin @ XS @ (XT @ Xx3)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (cwceq @ (XZ @ Xx3 @ Xs1) @ (ccint @ (ccrab @ (^ [Xs1:$i] : (cwss @ (XC @ Xx3) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : ccsalg)))))) => (! [Xx3:$i] : (! [Xs1:$i] : (cwn @ (cwcel @ (XZ @ Xx3 @ Xs1) @ ccsalg))))))))))))))))).
