...
thf(aboxcutc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwral @ (^ [Xk:$i] : (cwss @ (XC @ Xk) @ (XB2 @ Xk))) @ (^ [Xk:$i] : XA2))) @ (cwceq @ (ccdif @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ XX) @ (XC @ Xk) @ (XB2 @ Xk))))) @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ XX) @ (ccdif @ (XB2 @ Xk) @ (XC @ Xk)) @ (XB2 @ Xk))))))))))).
...
thf(aptopn2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ cctop @ XF)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XO @ Xk) @ (ccfv @ XY @ XF)))) => (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ XY) @ (XO @ Xk) @ (ccuni @ (ccfv @ (ccv @ Xk) @ XF))))) @ (ccfv @ XF @ ccpt))))))))))))).
...
thf(cptcld_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ cctop @ XF)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XC @ Xk) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ cccld)))) => (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccfv @ (ccfv @ XF @ ccpt) @ cccld)))))))))))).
