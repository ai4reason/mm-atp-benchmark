...
thf(cfun2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwf @ XA2 @ XC @ XF) @ (cwf @ XB2 @ XC @ XG)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwf @ (ccun @ XA2 @ XB2) @ XC @ (ccun @ XF @ XG))))))))).
