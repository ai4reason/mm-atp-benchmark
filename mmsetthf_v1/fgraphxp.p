...
thf(afgraphopab_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwceq @ XF @ (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ XA2) @ (cwcel @ (ccv @ Xb) @ XB2)) @ (cwceq @ (ccfv @ (ccv @ Xa) @ XF) @ (ccv @ Xb)))))))))))).
...
thf(cfgraphxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwceq @ XF @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ XF) @ (ccfv @ (ccv @ Xx3) @ cc2nd))) @ (^ [Xx3:$i] : (ccxp @ XA2 @ XB2))))))))).
