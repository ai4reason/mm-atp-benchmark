...
thf(custuqtop0_conj,conjecture,(! [XU:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xv:$i] : (cwceq @ (XN @ Xv) @ (ccmpt @ (^ [Xp:$i] : XX) @ (^ [Xp:$i] : (ccrn @ (ccmpt @ (^ [Xv:$i] : XU) @ (^ [Xv:$i] : (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xp)))))))))) => (! [Xv:$i] : (cwi @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwf @ XX @ (ccpw @ (ccpw @ XX)) @ (XN @ Xv))))))))).
