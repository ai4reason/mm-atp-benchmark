...
thf(cipfeq_conj,conjecture,(! [Xc_x:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccipf)) => (cwi @ (cwfn @ Xc_xi @ (ccxp @ XV @ XV)) @ (cwceq @ Xc_x @ Xc_xi)))))))))).
