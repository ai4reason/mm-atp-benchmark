...
thf(aefiarg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwceq @ (ccfv @ (cco @ cci @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccmul) @ cce) @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv))))).
...
thf(clawcos_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XX @ Xx3 @ Xy1) @ (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XY @ Xx3 @ Xy1) @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XZ @ Xx3 @ Xy1) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XO @ Xx3 @ Xy1) @ (cco @ (cco @ XB2 @ XC @ ccmin) @ (cco @ XA2 @ XC @ ccmin) @ (XF @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwa @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC))) @ (cwceq @ (cco @ (XZ @ Xx3 @ Xy1) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ (XX @ Xx3 @ Xy1) @ cc2 @ ccexp) @ (cco @ (XY @ Xx3 @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ cc2 @ (cco @ (cco @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ ccmul) @ (ccfv @ (XO @ Xx3 @ Xy1) @ cccos) @ ccmul) @ ccmul) @ ccmin))))))))))))))))))).
