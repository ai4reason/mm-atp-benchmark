...
thf(cfpwwe2lem9_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (cwceq @ XW @ (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (cwa @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) @ (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xr:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ XF) @ (XA2 @ Xy1 @ Xu))))))) => ((cwi @ Xph @ (cwbr @ XX @ XR @ XW)) => ((cwi @ Xph @ (cwbr @ XY @ XS @ XW)) => ((cwceq @ XM @ (ccoi @ XX @ XR)) => ((cwceq @ XN @ (ccoi @ XY @ XS)) => ((cwi @ Xph @ (cwss @ (ccdm @ XM) @ (ccdm @ XN))) => (cwi @ Xph @ (cwa @ (cwss @ XX @ XY) @ (cwceq @ XR @ (ccin @ XS @ (ccxp @ XY @ XX)))))))))))))))))))))))).
