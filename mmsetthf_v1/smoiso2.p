...
thf(asmo11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwsmo @ XF)) @ (cwf1 @ XA2 @ XB2 @ XF)))))).
...
thf(asmoord_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwfn @ XF @ XA2) @ (cwsmo @ XF)) @ (cwa @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XA2))) @ (cwb @ (cwcel @ XC @ XD) @ (cwcel @ (ccfv @ XC @ XF) @ (ccfv @ XD @ XF))))))))).
...
thf(asmoiso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwiso @ XA2 @ XB2 @ ccep @ ccep @ XF) @ (cword @ XA2) @ (cwss @ XB2 @ ccon0)) @ (cwsmo @ XF)))))).
thf(csmoiso2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cwss @ XB2 @ ccon0)) @ (cwb @ (cwa @ (cwfo @ XA2 @ XB2 @ XF) @ (cwsmo @ XF)) @ (cwiso @ XA2 @ XB2 @ ccep @ ccep @ XF))))))).
