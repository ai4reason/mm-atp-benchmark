...
thf(awfrlem13_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : (cwceq @ XF @ (ccwrecs @ XA2 @ XR @ (XG @ Xz)))) => ((! [Xz:$i] : (cwceq @ (XC @ Xz) @ (ccun @ XF @ (ccsn @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ (XG @ Xz))))))) => (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ XF))) @ (cwfn @ (XC @ Xz) @ (ccun @ (ccdm @ XF) @ (ccsn @ (ccv @ Xz)))))))))))))))).
...
thf(awfrlem12_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xy1:$i] : (cwceq @ (XF @ Xy1) @ (ccwrecs @ XA2 @ XR @ XG))) => (! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ (ccdm @ (XF @ Xy1))) @ (cwceq @ (ccfv @ (ccv @ Xy1) @ (XF @ Xy1)) @ (ccfv @ (ccres @ (XF @ Xy1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG)))))))))))).
...
thf(awfrdmcl_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccwrecs @ XA2 @ XR @ XG)) => (cwi @ (cwcel @ XX @ (ccdm @ XF)) @ (cwss @ (ccpred @ XA2 @ XR @ XX) @ (ccdm @ XF)))))))))).
thf(afun2ssres_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwfun @ XF) @ (cwss @ XG @ XF) @ (cwss @ XA2 @ (ccdm @ XG))) @ (cwceq @ (ccres @ XF @ XA2) @ (ccres @ XG @ XA2))))))).
...
thf(apredfrirr_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwfr @ XA2 @ XR) @ (cwn @ (cwcel @ XX @ (ccpred @ XA2 @ XR @ XX)))))))).
thf(aressnop0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ XC)) @ (cwceq @ (ccres @ (ccsn @ (ccop @ XA2 @ XB2)) @ XC) @ cc0)))))).
...
thf(afnopfvb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ XA2)) @ (cwb @ (cwceq @ (ccfv @ XB2 @ XF) @ XC) @ (cwcel @ (ccop @ XB2 @ XC) @ XF)))))))).
...
thf(cwfrlem14_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : (cwceq @ XF @ (ccwrecs @ XA2 @ XR @ (XG @ Xz)))) => ((! [Xz:$i] : (cwceq @ (XC @ Xz) @ (ccun @ XF @ (ccsn @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ (XG @ Xz))))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ XF))) @ (cwi @ (cwcel @ (ccv @ Xy1) @ (ccun @ (ccdm @ XF) @ (ccsn @ (ccv @ Xz)))) @ (cwceq @ (ccfv @ (ccv @ Xy1) @ (XC @ Xz)) @ (ccfv @ (ccres @ (XC @ Xz) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ (XG @ Xz))))))))))))))))).
