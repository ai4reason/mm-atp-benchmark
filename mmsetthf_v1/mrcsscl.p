...
thf(cmrcsscl_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XU @ XV) @ (cwcel @ XV @ XC)) @ (cwss @ (ccfv @ XU @ XF) @ XV))))))))).
