...
thf(clefldiveq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XA2 @ ccicc))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ (ccfv @ (cco @ XC @ XB2 @ ccdiv) @ ccfl))))))))))).
