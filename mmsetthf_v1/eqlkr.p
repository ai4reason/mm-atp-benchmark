...
thf(ceqlkr_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xr:$i] : (cwceq @ XD @ (ccfv @ (XW @ Xr) @ ccsca))) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ XD @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (Xc_x @ Xx3) @ (ccfv @ XD @ ccmulr))) => ((! [Xr:$i] : (cwceq @ XV @ (ccfv @ (XW @ Xr) @ ccbs))) => ((! [Xr:$i] : (cwceq @ (XF @ Xr) @ (ccfv @ (XW @ Xr) @ cclfn))) => ((! [Xr:$i] : (cwceq @ (XL @ Xr) @ (ccfv @ (XW @ Xr) @ cclk))) => (! [Xx3:$i] : (! [Xr:$i] : (cwi @ (cw3a @ (cwcel @ (XW @ Xr) @ cclvec) @ (cwa @ (cwcel @ XG @ (XF @ Xr)) @ (cwcel @ XH @ (XF @ Xr))) @ (cwceq @ (ccfv @ XG @ (XL @ Xr)) @ (ccfv @ XH @ (XL @ Xr)))) @ (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XH) @ (cco @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccv @ Xr) @ (Xc_x @ Xx3)))) @ (^ [Xx3:$i] : XV))) @ (^ [Xr:$i] : (XK @ Xx3)))))))))))))))))))))).
