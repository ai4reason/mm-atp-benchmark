...
thf(ccoemulhi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XB2 @ (ccfv @ XG @ cccoe)) => ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply))) @ (cwceq @ (ccfv @ (cco @ XM @ XN @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) @ (cco @ (ccfv @ XM @ XA2) @ (ccfv @ XN @ XB2) @ ccmul))))))))))))))).
