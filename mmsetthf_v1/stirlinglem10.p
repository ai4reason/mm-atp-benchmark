...
thf(astirlinglem9_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xk @ Xn)) @ cclog)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc1 @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccaddc) @ cc2 @ ccdiv) @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccdiv) @ cclog) @ ccmul) @ cc1 @ ccmin)))))) => ((! [Xk:$i] : (cwceq @ (XK @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ ccexp) @ ccmul))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ (ccseq @ ccaddc @ (XK @ Xk) @ cc1) @ (cco @ (ccfv @ XN @ (XB2 @ Xk @ Xn)) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XB2 @ Xk @ Xn)) @ ccmin) @ ccli)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(abreqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ XR)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ XR)))))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(ccsu_tp,type,(ccsu : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ageolim2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp)))) => (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccli))))))))))).
...
thf(cstirlinglem10_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xk @ Xn)) @ cclog)))))) => ((! [Xk:$i] : (cwceq @ (XK @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ ccexp) @ ccmul))))) => ((! [Xk:$i] : (cwceq @ (XL @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ cc1 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ cc2 @ ccexp) @ ccdiv) @ (ccv @ Xk) @ ccexp))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ (cco @ (ccfv @ XN @ (XB2 @ Xk @ Xn)) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XB2 @ Xk @ Xn)) @ ccmin) @ (cco @ (cco @ cc1 @ cc4 @ ccdiv) @ (cco @ cc1 @ (cco @ XN @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ ccdiv) @ ccmul) @ ccle)))))))))))))).
