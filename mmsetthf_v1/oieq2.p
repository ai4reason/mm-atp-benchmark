...
thf(aseeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwse @ XA2 @ XR) @ (cwse @ XB2 @ XR))))))).
...
thf(coieq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccoi @ XA2 @ XR) @ (ccoi @ XB2 @ XR))))))).
