...
thf(as4s2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccs6 @ XA2 @ XB2 @ XC @ XD @ XE @ XF) @ (cco @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs2 @ XE @ XF) @ ccconcat))))))))).
...
thf(cs5s2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ (cco @ (ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) @ (ccs2 @ XF @ XG) @ ccconcat)))))))))).
