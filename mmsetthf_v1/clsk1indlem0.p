...
thf(cclsk1indlem0_conj,conjecture,(! [XK:($i > ($i > $o))] : ((! [Xr:$i] : (cwceq @ (XK @ Xr) @ (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ (cwceq @ (ccv @ Xr) @ (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr)))))) => (! [Xr:$i] : (cwceq @ (ccfv @ cc0 @ (XK @ Xr)) @ cc0))))).
