...
thf(alediv1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccle))))))))))).
...
thf(aeluzp1l_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) @ (cwbr @ XM @ XN @ cclt))))).
...
thf(arelogbval_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp)) @ (cwceq @ (cco @ XB2 @ XX @ cclogb) @ (cco @ (ccfv @ XX @ cclog) @ (ccfv @ XB2 @ cclog) @ ccdiv)))))).
thf(a_3adant2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cw3a @ Xph @ Xth @ Xps) @ Xch))))))).
thf(clogbleb_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp) @ (cwcel @ XY @ ccrp)) @ (cwb @ (cwbr @ XX @ XY @ ccle) @ (cwbr @ (cco @ XB2 @ XX @ cclogb) @ (cco @ XB2 @ XY @ cclogb) @ ccle))))))).
