...
thf(aovnsubadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwf @ ccn @ (ccpw @ (cco @ ccr @ XX @ ccmap)) @ XA2)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XA2))) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XA2) @ (ccfv @ XX @ ccovoln)))) @ ccsumge0) @ ccle)))))))).
...
thf(anelpr1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwn @ (cwcel @ XA2 @ (ccpr @ XB2 @ XC)))) => (cwi @ Xph @ (cwne @ XA2 @ XB2)))))))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(aid_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ Xph))).
thf(anelpr2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwn @ (cwcel @ XA2 @ (ccpr @ XB2 @ XC)))) => (cwi @ Xph @ (cwne @ XA2 @ XC)))))))))).
...
thf(aiunxdif3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XE @ Xx3))) => (cwi @ (cwral @ (^ [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ cc0)) @ (^ [Xx3:$i] : (XE @ Xx3))) @ (cwceq @ (cciun @ (^ [Xx3:$i] : (ccdif @ XA2 @ (XE @ Xx3))) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(aiunxprg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (XC @ Xx3) @ XD))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwceq @ (XC @ Xx3) @ XE))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ XB2 @ (XW @ Xx3))) @ (cwceq @ (cciun @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccun @ XD @ XE)))))))))))))).
...
thf(aovn0_thm,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ (ccfv @ XX @ ccovoln)) @ ccc0)))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(ccsu_tp,type,(ccsu : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ccmnf_tp,type,(ccmnf : ($i > $o))).
thf(asge0pr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((cwi @ Xph @ (cwcel @ XE @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XA2) @ (cwceq @ (XC @ Xk) @ XD))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XB2) @ (cwceq @ (XC @ Xk) @ XE))) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ (cco @ XD @ XE @ ccxad))))))))))))))))))).
