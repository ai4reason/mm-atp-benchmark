...
thf(awlkvtxiedg_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccrn @ XI)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
...
thf(cwlkonl1iedg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (! [Xe:$i] : (cwi @ (cwa @ (cwbr @ XF @ XP @ (cco @ XA2 @ (XB2 @ Xe) @ (ccfv @ XG @ ccwlkson))) @ (cwne @ (ccfv @ XF @ cchash) @ ccc0)) @ (cwrex @ (^ [Xe:$i] : (cwcel @ XA2 @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccrn @ XI))))))))))))).
