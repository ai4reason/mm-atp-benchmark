...
thf(afimacnvinrn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwceq @ (ccima @ (cccnv @ XF) @ XA2) @ (ccima @ (cccnv @ XF) @ (ccin @ XA2 @ (ccrn @ XF)))))))).
thf(cfimacnvinrn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ (ccrn @ XF) @ XB2)) @ (cwceq @ (ccima @ (cccnv @ XF) @ XA2) @ (ccima @ (cccnv @ XF) @ (ccin @ XA2 @ XB2)))))))).
