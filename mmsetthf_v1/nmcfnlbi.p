...
thf(asyl5breq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwbr @ XA2 @ XB2 @ XR) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ XR)))))))))).
...
thf(anorm_i_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccno) @ ccc0) @ (cwceq @ XA2 @ cc0v))))).
...
thf(anormgt0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwb @ (cwne @ XA2 @ cc0v) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccno) @ cclt))))).
...
thf(anorm1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwne @ XA2 @ cc0v)) @ (cwceq @ (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ ccno) @ ccdiv) @ XA2 @ ccsm) @ ccno) @ cc1)))).
...
thf(anmfnlb_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwf @ cchil @ ccc @ XT) @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ XA2 @ ccno) @ cc1 @ ccle)) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (ccfv @ XT @ ccnmf) @ ccle))))).
...
thf(cnmcfnlbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwi @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))))).
