...
thf(cupgrss_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XF @ (ccdm @ XE))) @ (cwss @ (ccfv @ XF @ XE) @ XV))))))))).
