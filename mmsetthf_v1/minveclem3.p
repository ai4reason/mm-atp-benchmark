...
thf(cminveclem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xr:$i] : (cwceq @ XX @ (ccfv @ (XU @ Xr) @ ccbs))) => ((! [Xr:$i] : (cwceq @ (Xc_mi @ Xr) @ (ccfv @ (XU @ Xr) @ ccsg))) => ((! [Xr:$i] : (cwceq @ (XN @ Xr) @ (ccfv @ (XU @ Xr) @ ccnm))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XU @ Xr) @ cccph))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ XY @ (ccfv @ (XU @ Xr) @ cclss)))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (cco @ (XU @ Xr) @ XY @ ccress) @ cccms))) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((! [Xr:$i] : (cwceq @ XJ @ (ccfv @ (XU @ Xr) @ cctopn))) => ((! [Xr:$i] : (cwceq @ (XR @ Xr) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ (Xc_mi @ Xr)) @ (XN @ Xr))))))) => ((! [Xr:$i] : (cwceq @ XS @ (ccinf @ (XR @ Xr) @ ccr @ cclt))) => ((! [Xr:$i] : (cwceq @ XD @ (ccres @ (ccfv @ (XU @ Xr) @ ccds) @ (ccxp @ XX @ XX)))) => ((! [Xr:$i] : (cwceq @ (XF @ Xr) @ (ccrn @ (ccmpt @ (^ [Xr:$i] : ccrp) @ (^ [Xr:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (cco @ (cco @ XA2 @ (ccv @ Xy1) @ XD) @ cc2 @ ccexp) @ (cco @ (cco @ XS @ cc2 @ ccexp) @ (ccv @ Xr) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : XY))))))) => (! [Xr:$i] : (cwi @ Xph @ (cwcel @ (cco @ XY @ (XF @ Xr) @ ccfg) @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ cccfil))))))))))))))))))))))))))))).
