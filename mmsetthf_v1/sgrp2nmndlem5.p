...
thf(asgrp2nmndlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xc_op:($i > ($i > ($i > $o)))] : ((cwceq @ XS @ (ccpr @ XA2 @ XB2)) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccbs) @ XS)) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ XA2 @ XB2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_op @ Xx3 @ Xy1) @ (ccfv @ (XM @ Xy1) @ ccplusg)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XC @ XS)) @ (cwceq @ (cco @ XA2 @ XC @ (Xc_op @ Xx3 @ Xy1)) @ XA2))))))))))))))).
...
thf(asgrp2nmndlem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xc_op:($i > ($i > ($i > $o)))] : ((cwceq @ XS @ (ccpr @ XA2 @ XB2)) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccbs) @ XS)) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ XA2 @ XB2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_op @ Xx3 @ Xy1) @ (ccfv @ (XM @ Xy1) @ ccplusg)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XC @ XS) @ (cwcel @ XB2 @ XS) @ (cwne @ XA2 @ XB2)) @ (cwceq @ (cco @ XB2 @ XC @ (Xc_op @ Xx3 @ Xy1)) @ XB2))))))))))))))).
...
thf(aisnmnd_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_op @ (ccfv @ XM @ ccplusg)) => (cwi @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwne @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ Xc_op) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xz:$i] : XB2)) @ (cwnel @ XM @ ccmnd)))))))).
thf(aeqtr2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XB2 @ XC) => (cwceq @ XC @ XA2))))))).
thf(csgrp2nmndlem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XS @ (ccpr @ XA2 @ XB2)) => ((cwceq @ (ccfv @ XM @ ccbs) @ XS) => ((cwceq @ (ccfv @ XM @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ XA2 @ XB2))))) => (cwi @ (cwceq @ (ccfv @ XS @ cchash) @ cc2) @ (cwnel @ XM @ ccmnd)))))))))).
