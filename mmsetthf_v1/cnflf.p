...
thf(acnpflf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon)) @ (cwcel @ XA2 @ XX)) @ (cwb @ (cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xf1) @ ccflim)) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ XF @ (cco @ XK @ (ccv @ Xf1) @ ccflf))))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))))))).
...
thf(ccnflf_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) @ (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ XF @ (cco @ XK @ (ccv @ Xf1) @ ccflf)))) @ (^ [Xx3:$i] : (cco @ XJ @ (ccv @ Xf1) @ ccflim)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))))))).
