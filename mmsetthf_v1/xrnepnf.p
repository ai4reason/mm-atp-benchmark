...
thf(aor32_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwo @ (cwo @ Xph @ Xps) @ Xch) @ (cwo @ (cwo @ Xph @ Xch) @ Xps)))))).
...
thf(cxrnepnf_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwne @ XA2 @ ccpnf)) @ (cwo @ (cwcel @ XA2 @ ccr) @ (cwceq @ XA2 @ ccmnf))))).
