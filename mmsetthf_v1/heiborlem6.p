...
thf(cheiborlem6_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XK @ Xv @ Xu @ Xk @ Xm) @ (ccab @ (^ [Xu:$i] : (cwn @ (cwrex @ (^ [Xv:$i] : (cwss @ (ccv @ Xu) @ (ccuni @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccin @ (ccpw @ (XU @ Xk @ Xm)) @ ccfn))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn) @ (ccopab @ (^ [Xy1:$i] : (^ [Xn:$i] : (cw3a @ (cwcel @ (ccv @ Xn) @ ccn0) @ (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xv @ Xm))) @ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xn) @ (XB2 @ Xz @ Xk @ Xm)) @ (XK @ Xv @ Xu @ Xk @ Xm)))))))))))))) => ((! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XB2 @ Xz @ Xk @ Xm) @ (ccmpt2 @ (^ [Xz:$i] : (^ [Xm:$i] : XX)) @ (^ [Xz:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xz:$i] : (^ [Xm:$i] : (cco @ (ccv @ Xz) @ (cco @ cc1 @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv) @ (ccfv @ XD @ ccbl))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn) @ (cwcel @ XD @ (ccfv @ XX @ ccms))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn) @ (cwf @ ccn0 @ (ccin @ (ccpw @ XX) @ ccfn) @ (XF @ Xz @ Xv @ Xm))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn) @ (cwral @ (^ [Xn:$i] : (cwceq @ XX @ (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xv @ Xm))) @ (^ [Xy1:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xn) @ (XB2 @ Xz @ Xk @ Xm)))))) @ (^ [Xn:$i] : ccn0)))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ (XT @ Xv @ Xu @ Xk)) @ (cco @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc1 @ ccaddc) @ (XG @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn)) @ (cwcel @ (ccin @ (ccfv @ (ccv @ Xx3) @ (XB2 @ Xz @ Xk @ Xm)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (XT @ Xv @ Xu @ Xk)) @ (cco @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc1 @ ccaddc) @ (XB2 @ Xz @ Xk @ Xm))) @ (XK @ Xv @ Xu @ Xk @ Xm)))) @ (^ [Xx3:$i] : (XG @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn) @ (cwbr @ (XC @ Xx3 @ Xz @ Xk) @ ccc0 @ (XG @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (cwceq @ XS @ (ccseq @ (XT @ Xv @ Xu @ Xk) @ (ccmpt @ (^ [Xm:$i] : ccn0) @ (^ [Xm:$i] : (ccif @ (cwceq @ (ccv @ Xm) @ ccc0) @ (XC @ Xx3 @ Xz @ Xk) @ (cco @ (ccv @ Xm) @ cc1 @ ccmin)))) @ ccc0))))))) => ((! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XM @ Xv @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XS) @ (cco @ cc3 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xv @ Xu @ Xm @ Xn) @ (cwral @ (^ [Xk:$i] : (cwss @ (ccfv @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XM @ Xv @ Xn)) @ (ccfv @ XD @ ccbl)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XM @ Xv @ Xn)) @ (ccfv @ XD @ ccbl)))) @ (^ [Xk:$i] : ccn)))))))))))))))))))))))))))))))))).
