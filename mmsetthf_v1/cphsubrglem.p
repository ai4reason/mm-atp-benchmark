...
thf(asq01_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ XA2) @ (cwo @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XA2 @ cc1)))))).
...
thf(ccphsubrglem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwi @ Xph @ (cwceq @ XF @ (cco @ cccnfld @ XA2 @ ccress))) => ((cwi @ Xph @ (cwcel @ XF @ ccdr)) => (cwi @ Xph @ (cw3a @ (cwceq @ XF @ (cco @ cccnfld @ XK @ ccress)) @ (cwceq @ XK @ (ccin @ XA2 @ ccc)) @ (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)))))))))))).
