...
thf(adf_sgrp2_ax,axiom,(cwceq @ ccsgrp2 @ (ccrab @ (^ [Xg1:$i] : (cwbr @ (ccfv @ (ccv @ Xg1) @ ccplusg) @ (ccfv @ (ccv @ Xg1) @ ccbs) @ ccasslaw)) @ (^ [Xg1:$i] : ccmgm2)))).
thf(cissgrpALT_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_op @ (ccfv @ XM @ ccplusg)) => (cwb @ (cwcel @ XM @ ccsgrp2) @ (cwa @ (cwcel @ XM @ ccmgm2) @ (cwbr @ Xc_op @ XB2 @ ccasslaw))))))))).
