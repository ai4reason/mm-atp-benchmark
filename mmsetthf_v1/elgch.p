...
thf(adf_gch_ax,axiom,(cwceq @ ccgch @ (ccun @ ccfn @ (ccab @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwn @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm) @ (cwbr @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xx3)) @ ccsdm)))))))))).
...
thf(celgch_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwb @ (cwcel @ XA2 @ ccgch) @ (cwo @ (cwcel @ XA2 @ ccfn) @ (cwal @ (^ [Xx3:$i] : (cwn @ (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm) @ (cwbr @ (ccv @ Xx3) @ (ccpw @ XA2) @ ccsdm)))))))))))).
