...
thf(astge1i_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwcel @ XS @ ccst) @ (cwb @ (cwbr @ cc1 @ (ccfv @ XA2 @ XS) @ ccle) @ (cwceq @ (ccfv @ XA2 @ XS) @ cc1))))))).
thf(cstm1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwcel @ XS @ ccst) @ (cwi @ (cwceq @ (ccfv @ (ccin @ XA2 @ XB2) @ XS) @ cc1) @ (cwceq @ (ccfv @ XA2 @ XS) @ cc1))))))))).
