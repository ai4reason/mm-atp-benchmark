...
thf(afin2solem_thm,axiom,(! [Xy1:$i] : (! [Xz:$i] : (! [XR:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwa @ (cwor @ (ccv @ Xx3) @ XR) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR) @ (cwbr @ (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xy1) @ XR)) @ (^ [Xw:$i] : (ccv @ Xx3))) @ (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR)) @ (^ [Xw:$i] : (ccv @ Xx3))) @ ccrpss)))))))).
...
thf(afin45_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfin4) @ (cwcel @ XA2 @ ccfin5)))).
thf(ccon0_tp,type,(ccon0 : ($i > $o))).
thf(cc2o_tp,type,(cc2o : ($i > $o))).
thf(afin56_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfin5) @ (cwcel @ XA2 @ ccfin6)))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(afin67_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfin6) @ (cwcel @ XA2 @ ccfin7)))).
thf(abiimpac_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ (cwa @ Xps @ Xph) @ Xch)))))).
thf(afin71num_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwb @ (cwcel @ XA2 @ ccfin7) @ (cwcel @ XA2 @ ccfn))))).
thf(cfin2so_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfin2) @ (cwor @ XA2 @ XR)) @ (cwcel @ XA2 @ ccfn))))).
