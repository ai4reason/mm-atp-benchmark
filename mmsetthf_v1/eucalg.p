...
thf(aeucalgcvga_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XE @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XR @ Xy1) @ (ccseq @ (cccom @ (XE @ Xx3 @ Xy1) @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ XA2)) @ ccc0)))) => ((cwceq @ XN @ (ccfv @ XA2 @ cc2nd)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (ccxp @ ccn0 @ ccn0)) @ (cwi @ (cwcel @ (XK @ Xx3 @ Xy1) @ (ccfv @ XN @ ccuz)) @ (cwceq @ (ccfv @ (ccfv @ (XK @ Xx3 @ Xy1) @ (XR @ Xy1)) @ cc2nd) @ ccc0)))))))))))))).
...
thf(ann0gcdid0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ ccc0 @ ccgcd) @ XN)))).
thf(a_3eqtr3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XA2 @ XC)) => ((cwi @ Xph @ (cwceq @ XB2 @ XD)) => (cwi @ Xph @ (cwceq @ XC @ XD))))))))))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(aalginv_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XR @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xx3))) @ ccc0))) => ((cwf @ XS @ XS @ XF) => ((cwfn @ XI @ XS) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XI) @ (ccfv @ (ccv @ Xx3) @ XI)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xx3) @ XS) @ (cwcel @ (XK @ Xx3) @ ccn0)) @ (cwceq @ (ccfv @ (ccfv @ (XK @ Xx3) @ XR) @ XI) @ (ccfv @ (ccfv @ ccc0 @ XR) @ XI))))))))))))))).
...
thf(aeucalginv_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XE @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XX @ (ccxp @ ccn0 @ ccn0)) @ (cwceq @ (ccfv @ (ccfv @ XX @ (XE @ Xx3 @ Xy1)) @ ccgcd) @ (ccfv @ XX @ ccgcd))))))))).
...
thf(aalgr0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwceq @ XR @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ XZ @ (ccsn @ XA2)) @ XM)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => (cwi @ Xph @ (cwceq @ (ccfv @ XM @ XR) @ XA2)))))))))))))).
thf(ceucalg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XE @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XR @ Xy1) @ (ccseq @ (cccom @ (XE @ Xx3 @ Xy1) @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ XA2)) @ ccc0)))) => ((cwceq @ XA2 @ (ccop @ XM @ XN)) => (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ (ccfv @ XN @ (XR @ Xy1)) @ cc1st) @ (cco @ XM @ XN @ ccgcd))))))))))))).
