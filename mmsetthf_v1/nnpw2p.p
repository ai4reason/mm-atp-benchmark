...
thf(annpw2pmod_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ (cco @ XN @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ ccmo) @ ccaddc))))).
thf(cnnpw2p_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwrex @ (^ [Xi:$i] : (cwrex @ (^ [Xr:$i] : (cwceq @ XN @ (cco @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ (ccv @ Xr) @ ccaddc))) @ (^ [Xr:$i] : (cco @ ccc0 @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ ccfzo)))) @ (^ [Xi:$i] : ccn0))))).
