...
thf(aminel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwceq @ (ccin @ XC @ XB2) @ cc0)) @ (cwn @ (cwcel @ XA2 @ XC))))))).
...
thf(amreexmrid_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xz @ Xs1) @ (ccfv @ (XX @ Xz) @ ccmre)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (cwceq @ XN @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xs1) @ ccmrc))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (cwceq @ (XI @ Xy1 @ Xz @ Xs1) @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xs1) @ ccmri))))) => ((! [Xz:$i] : (cwi @ Xph @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xz))) @ XN))) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xy1))) @ XN) @ (ccfv @ (ccv @ Xs1) @ XN))))) @ (^ [Xy1:$i] : (XX @ Xz)))) @ (^ [Xs1:$i] : (ccpw @ (XX @ Xz)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ XS @ (XI @ Xy1 @ Xz @ Xs1)))))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ XY @ (XX @ Xz)))) => ((cwi @ Xph @ (cwn @ (cwcel @ XY @ (ccfv @ XS @ XN)))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (ccun @ XS @ (ccsn @ XY)) @ (XI @ Xy1 @ Xz @ Xs1))))))))))))))))))))).
thf(amrissmrid_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((cwceq @ XN @ (ccfv @ XA2 @ ccmrc)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccmri)) => ((cwi @ Xph @ (cwcel @ XS @ XI)) => ((cwi @ Xph @ (cwss @ XT @ XS)) => (cwi @ Xph @ (cwcel @ XT @ XI))))))))))))))).
...
thf(cmreexexlem2d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xz @ Xg1 @ Xs1) @ (ccfv @ (XX @ Xz @ Xg1) @ ccmre))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwceq @ XN @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xg1 @ Xs1) @ ccmrc)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwceq @ (XI @ Xy1 @ Xz @ Xg1 @ Xs1) @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xg1 @ Xs1) @ ccmri)))))) => ((! [Xz:$i] : (! [Xg1:$i] : (cwi @ Xph @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xz))) @ XN))) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xy1))) @ XN) @ (ccfv @ (ccv @ Xs1) @ XN))))) @ (^ [Xy1:$i] : (XX @ Xz @ Xg1)))) @ (^ [Xs1:$i] : (ccpw @ (XX @ Xz @ Xg1))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (cwi @ Xph @ (cwss @ XF @ (ccdif @ (XX @ Xz @ Xg1) @ XH))))) => ((! [Xz:$i] : (! [Xg1:$i] : (cwi @ Xph @ (cwss @ XG @ (ccdif @ (XX @ Xz @ Xg1) @ XH))))) => ((cwi @ Xph @ (cwss @ XF @ (ccfv @ (ccun @ XG @ XH) @ XN))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (ccun @ XF @ XH) @ (XI @ Xy1 @ Xz @ Xg1 @ Xs1))))))) => ((cwi @ Xph @ (cwcel @ XY @ XF)) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwrex @ (^ [Xg1:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xg1) @ (ccdif @ XF @ (ccsn @ XY)))) @ (cwcel @ (ccun @ (ccdif @ XF @ (ccsn @ XY)) @ (ccun @ XH @ (ccsn @ (ccv @ Xg1)))) @ (XI @ Xy1 @ Xz @ Xg1 @ Xs1)))) @ (^ [Xg1:$i] : XG))))))))))))))))))))))))).
