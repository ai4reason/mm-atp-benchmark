...
thf(cipolt_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccfv @ XF @ ccipo)) => ((cwceq @ Xc_lt @ (ccfv @ XI @ ccplt)) => (cwi @ (cw3a @ (cwcel @ XF @ XV) @ (cwcel @ XX @ XF) @ (cwcel @ XY @ XF)) @ (cwb @ (cwbr @ XX @ XY @ Xc_lt) @ (cwpss @ XX @ XY)))))))))))).
