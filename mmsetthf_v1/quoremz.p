...
thf(cquoremz_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XQ @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl)) => ((cwceq @ XR @ (cco @ XA2 @ (cco @ XB2 @ XQ @ ccmul) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccn)) @ (cwa @ (cwa @ (cwcel @ XQ @ ccz) @ (cwcel @ XR @ ccn0)) @ (cwa @ (cwbr @ XR @ XB2 @ cclt) @ (cwceq @ XA2 @ (cco @ (cco @ XB2 @ XQ @ ccmul) @ XR @ ccaddc)))))))))))).
