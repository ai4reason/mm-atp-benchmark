...
thf(cposi_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => (cwi @ (cwa @ (cwcel @ XK @ ccpo) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) @ (cw3a @ (cwbr @ XX @ XX @ Xc_le) @ (cwi @ (cwa @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XY @ XX @ Xc_le)) @ (cwceq @ XX @ XY)) @ (cwi @ (cwa @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XY @ XZ @ Xc_le)) @ (cwbr @ XX @ XZ @ Xc_le))))))))))))).
