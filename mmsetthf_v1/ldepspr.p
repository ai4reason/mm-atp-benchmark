...
thf(alincvalpr_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XS @ (ccfv @ XM @ ccsca)) => ((cwceq @ XR @ (ccfv @ XS @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwceq @ XF @ (ccpr @ (ccop @ XV @ XX) @ (ccop @ XW @ XY))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XM @ cclmod) @ (cwne @ XV @ XW)) @ (cwa @ (cwcel @ XV @ XB2) @ (cwcel @ XX @ XR)) @ (cwa @ (cwcel @ XW @ XB2) @ (cwcel @ XY @ XR))) @ (cwceq @ (cco @ XF @ (ccpr @ XV @ XW) @ (ccfv @ XM @ cclinc)) @ (cco @ (cco @ XX @ XV @ Xc_x) @ (cco @ XY @ XW @ Xc_x) @ Xc_pl))))))))))))))))))))).
...
thf(aldepsprlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XS @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ XN @ (ccfv @ XR @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XA2 @ XS))) @ (cwi @ (cwceq @ XX @ (cco @ XA2 @ XY @ Xc_x)) @ (cwceq @ (cco @ (cco @ Xc_1 @ XX @ Xc_x) @ (cco @ (ccfv @ XA2 @ XN) @ XY @ Xc_x) @ (ccfv @ XM @ ccplusg)) @ XZ)))))))))))))))))))))))).
...
thf(a_01eq0ring_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwceq @ Xc_0 @ Xc_1)) @ (cwceq @ XB2 @ (ccsn @ Xc_0))))))))))).
...
thf(arexprg_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xch))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ XB2 @ (XW @ Xx3))) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2))) @ (cwo @ Xps @ Xch)))))))))))))).
...
thf(amapprop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccpr @ (ccop @ XX @ XA2) @ (ccop @ XY @ XB2))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XA2 @ XR)) @ (cwa @ (cwcel @ XY @ XV) @ (cwcel @ XB2 @ XR)) @ (cwa @ (cwne @ XX @ XY) @ (cwcel @ XR @ XW))) @ (cwcel @ XF @ (cco @ XR @ (ccpr @ XX @ XY) @ ccmap))))))))))))).
...
thf(cldepspr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XS @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwne @ XX @ XY))) @ (cwi @ (cwa @ (cwcel @ XA2 @ XS) @ (cwceq @ XX @ (cco @ XA2 @ XY @ Xc_x))) @ (cwbr @ (ccpr @ XX @ XY) @ XM @ cclindeps)))))))))))))))))))).
