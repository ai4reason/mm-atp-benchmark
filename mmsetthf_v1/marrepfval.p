...
thf(adf_marrep_ax,axiom,(cwceq @ ccmarrep @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccmpt2 @ (^ [Xm:$i] : (^ [Xs1:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ ccbs))) @ (^ [Xm:$i] : (^ [Xs1:$i] : (ccfv @ (ccv @ Xr) @ ccbs))) @ (^ [Xm:$i] : (^ [Xs1:$i] : (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : (ccv @ Xn))) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccv @ Xn))) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccv @ Xn))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccv @ Xn))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ (ccv @ Xk)) @ (ccif @ (cwceq @ (ccv @ Xj) @ (ccv @ Xl)) @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xr) @ cc0g)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm))))))))))))))))).
...
thf(cmarrepfval_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (cco @ XN @ XR @ ccmat)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk @ Xl) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ ccbs)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (cco @ XN @ XR @ ccmarrep)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (ccfv @ XR @ cc0g)))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xs1:$i] : (XB2 @ Xi @ Xj @ Xk @ Xl))) @ (^ [Xm:$i] : (^ [Xs1:$i] : (ccfv @ XR @ ccbs))) @ (^ [Xm:$i] : (^ [Xs1:$i] : (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ (ccv @ Xk)) @ (ccif @ (cwceq @ (ccv @ Xj) @ (ccv @ Xl)) @ (ccv @ Xs1) @ (Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)))))))))))))))))))))))))))))).
