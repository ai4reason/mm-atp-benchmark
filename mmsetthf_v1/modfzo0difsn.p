...
thf(altaddnegr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ XA2 @ ccc0 @ cclt) @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XB2 @ cclt)))))).
...
thf(aaddmodidr_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XM @ ccn) @ (cwbr @ XA2 @ XM @ cclt)) @ (cwceq @ (cco @ (cco @ XA2 @ XM @ ccaddc) @ XM @ ccmo) @ XA2))))).
...
thf(cmodfzo0difsn_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ XK @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ)))) @ (cwrex @ (^ [Xi:$i] : (cwceq @ XK @ (cco @ (cco @ (ccv @ Xi) @ XJ @ ccaddc) @ XN @ ccmo))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfzo)))))))).
