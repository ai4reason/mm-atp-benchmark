...
thf(asge00_thm,axiom,(cwceq @ (ccfv @ cc0 @ ccsumge0) @ ccc0)).
...
thf(assuzfz_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwss @ XA2 @ XZ)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => (cwi @ Xph @ (cwss @ XA2 @ (cco @ XM @ (ccsup @ XA2 @ ccr @ cclt) @ ccfz))))))))))).
...
thf(asuprfinzcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccz) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ (ccsup @ XA2 @ ccr @ cclt) @ XA2)))).
thf(asge0lefimpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ ccxr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ (XC @ Xx3) @ ccle) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ (XC @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))))))))))))).
...
thf(csge0isum_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((cwceq @ XG @ (ccseq @ ccaddc @ XF @ XM)) => ((cwi @ Xph @ (cwbr @ XG @ XB2 @ ccli)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ XB2)))))))))))))).
