...
thf(afnimapr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) @ (cwceq @ (ccima @ XF @ (ccpr @ XB2 @ XC)) @ (ccpr @ (ccfv @ XB2 @ XF) @ (ccfv @ XC @ XF))))))))).
...
thf(cpoimirlem1_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwceq @ XF @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ XM @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ XT @ (ccun @ (ccxp @ (ccima @ XU @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ XU @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) => ((cwi @ Xph @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ ccz @ XT)) => ((cwi @ Xph @ (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ XU)) => ((cwi @ Xph @ (cwcel @ XM @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => (cwi @ Xph @ (cwn @ (cwrmo @ (^ [Xn:$i] : (cwne @ (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ XM @ cc1 @ ccmin) @ XF)) @ (ccfv @ (ccv @ Xn) @ (ccfv @ XM @ XF)))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz))))))))))))))))).
