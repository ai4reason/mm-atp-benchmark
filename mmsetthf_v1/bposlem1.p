...
thf(aefexple_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwcel @ XN @ ccz) @ (cwcel @ XB2 @ ccrp)) @ (cwb @ (cwbr @ (cco @ XA2 @ XN @ ccexp) @ XB2 @ ccle) @ (cwbr @ XN @ (ccfv @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XA2 @ cclog) @ ccdiv) @ ccfl) @ ccle))))))).
...
thf(apcbcctr_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ (ccsu @ (cco @ cc1 @ (cco @ cc2 @ XN @ ccmul) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ (cco @ cc2 @ (ccfv @ (cco @ XN @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ ccmul) @ ccmin)))))))).
...
thf(cbposlem1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ ccprime)) @ (cwbr @ (cco @ XP @ (cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))))).
