...
thf(afzouzsplit_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) @ (cwceq @ (ccfv @ XA2 @ ccuz) @ (ccun @ (cco @ XA2 @ XB2 @ ccfzo) @ (ccfv @ XB2 @ ccuz))))))).
...
thf(annleltp1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ cclt)))))).
thf(ccmin_tp,type,(ccmin : ($i > $o))).
thf(annsum3primesle9_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwbr @ XN @ cc8 @ ccle)) @ (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xd) @ cc3 @ ccle) @ (cwceq @ XN @ (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))))).
...
thf(asyl5d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xph @ (cwi @ Xth @ (cwi @ Xch @ Xta))) => (cwi @ Xph @ (cwi @ Xth @ (cwi @ Xps @ Xta))))))))))).
...
thf(aeluzuzle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwbr @ XB2 @ XA2 @ ccle)) @ (cwi @ (cwcel @ XC @ (ccfv @ XA2 @ ccuz)) @ (cwcel @ XC @ (ccfv @ XB2 @ ccuz)))))))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(annsum4primesodd_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc5 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc6 @ ccuz)) @ (cwcel @ XN @ ccodd)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XN @ (ccsu @ (cco @ cc1 @ cc3 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))))))).
...
thf(asbgoldbwt_thm,axiom,(cwi @ (cwral @ (^ [Xn:$i] : (cwi @ (cwbr @ cc4 @ (ccv @ Xn) @ cclt) @ (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc5 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)))).
thf(aeluzelz_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwcel @ XN @ ccz))))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(azeoALTV_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ ccz) @ (cwo @ (cwcel @ XZ @ cceven) @ (cwcel @ XZ @ ccodd))))).
thf(cbgoldbnnsum3prm_conj,conjecture,(cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc4 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbe))) @ (^ [Xm:$i] : cceven)) @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xd) @ cc3 @ ccle) @ (cwceq @ (ccv @ Xn) @ (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xn:$i] : (ccfv @ cc2 @ ccuz))))).
