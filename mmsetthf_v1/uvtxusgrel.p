...
thf(auvtxusgr_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XE @ Xk @ Xn) @ (ccfv @ XG @ ccedg)))) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccfv @ XG @ ccuvtx) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xk:$i] : (cwcel @ (ccpr @ (ccv @ Xk) @ (ccv @ Xn)) @ (XE @ Xk @ Xn))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xn)))))) @ (^ [Xn:$i] : XV)))))))))).
...
thf(cuvtxusgrel_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : (cwceq @ (XE @ Xk) @ (ccfv @ XG @ ccedg))) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwb @ (cwcel @ XN @ (ccfv @ XG @ ccuvtx)) @ (cwa @ (cwcel @ XN @ XV) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccpr @ (ccv @ Xk) @ XN) @ (XE @ Xk))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))))))).
