...
thf(ar19_28v_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwi @ (cwa @ Xph @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (cwral @ (^ [Xx3:$i] : (cwa @ Xph @ (Xps @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(cfununi_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xf1:$i] : (cwa @ (cwfun @ (ccv @ Xf1)) @ (cwral @ (^ [Xg1:$i] : (cwo @ (cwss @ (ccv @ Xf1) @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xf1)))) @ (^ [Xg1:$i] : XA2)))) @ (^ [Xf1:$i] : XA2)) @ (cwfun @ (ccuni @ XA2))))).
