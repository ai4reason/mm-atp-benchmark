...
thf(afin1a2lem9_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwor @ XX @ ccrpss) @ (cwss @ XX @ ccfn) @ (cwcel @ XA2 @ ccom)) @ (cwcel @ (ccrab @ (^ [Xb:$i] : (cwbr @ (ccv @ Xb) @ XA2 @ ccdom)) @ (^ [Xb:$i] : XX)) @ ccfn))))).
...
thf(afin1a2lem10_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn) @ (cwor @ XA2 @ ccrpss)) @ (cwcel @ (ccuni @ XA2) @ XA2)))).
...
thf(afincssdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn) @ (cwo @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ XA2))) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwss @ XA2 @ XB2)))))).
...
thf(cfin1a2lem11_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwor @ XA2 @ ccrpss) @ (cwss @ XA2 @ ccfn)) @ (cwceq @ (ccrn @ (ccmpt @ (^ [Xb:$i] : ccom) @ (^ [Xb:$i] : (ccuni @ (ccrab @ (^ [Xc:$i] : (cwbr @ (ccv @ Xc) @ (ccv @ Xb) @ ccdom)) @ (^ [Xc:$i] : XA2)))))) @ (ccun @ XA2 @ (ccsn @ cc0)))))).
