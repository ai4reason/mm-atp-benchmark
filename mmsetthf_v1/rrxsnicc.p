...
thf(crrxsnicc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ ccr @ XX @ ccmap))) => (cwi @ Xph @ (cwceq @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XA2) @ ccicc))) @ (ccsn @ XA2)))))))).
