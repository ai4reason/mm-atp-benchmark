...
thf(ci1fmulclem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ (cwa @ (cwa @ Xph @ (cwne @ XA2 @ ccc0)) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccima @ (cccnv @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul))) @ (ccsn @ XB2)) @ (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XB2 @ XA2 @ ccdiv)))))))))))).
