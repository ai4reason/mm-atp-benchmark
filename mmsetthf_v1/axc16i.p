...
thf(caxc16i_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xy1:$i] : ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3 @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xps @ Xx3 @ Xz) @ (cwal @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)))))) => (! [Xx3:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwi @ (Xph @ Xx3) @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3)))))))))))).
