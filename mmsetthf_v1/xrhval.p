...
thf(adf_xrh_ax,axiom,(cwceq @ ccxrh @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ ccr) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xr) @ ccrrh)) @ (ccif @ (cwceq @ (ccv @ Xx3) @ ccpnf) @ (ccfv @ (ccima @ (ccfv @ (ccv @ Xr) @ ccrrh) @ ccr) @ (ccfv @ (ccv @ Xr) @ cclub)) @ (ccfv @ (ccima @ (ccfv @ (ccv @ Xr) @ ccrrh) @ ccr) @ (ccfv @ (ccv @ Xr) @ ccglb)))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(ccmnf_tp,type,(ccmnf : ($i > $o))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(axrex_thm,axiom,(cwcel @ ccxr @ ccvv)).
thf(cxrhval_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccima @ (ccfv @ XR @ ccrrh) @ ccr))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccfv @ XR @ ccglb))) => ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ XR @ cclub))) => (! [Xx3:$i] : (cwi @ (cwcel @ XR @ (XV @ Xx3)) @ (cwceq @ (ccfv @ XR @ ccxrh) @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ ccr) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XR @ ccrrh)) @ (ccif @ (cwceq @ (ccv @ Xx3) @ ccpnf) @ (ccfv @ (XB2 @ Xx3) @ (XU @ Xx3)) @ (ccfv @ (XB2 @ Xx3) @ (XL @ Xx3)))))))))))))))))).
