...
thf(admdsl3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cw3a @ (cwbr @ XB2 @ XA2 @ ccdmd) @ (cwss @ XA2 @ XC) @ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)))) @ (cwceq @ (cco @ (ccin @ XC @ XB2) @ XA2 @ cchj) @ XC)))))).
...
thf(amdslj1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (cwi @ (cwa @ (cwa @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwbr @ XB2 @ XA2 @ ccdmd)) @ (cwa @ (cwss @ XA2 @ (ccin @ XC @ XD)) @ (cwss @ (cco @ XC @ XD @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) @ (cwceq @ (ccin @ (cco @ XC @ XD @ cchj) @ XB2) @ (cco @ (ccin @ XC @ XB2) @ (ccin @ XD @ XB2) @ cchj)))))))))))).
...
thf(ainindir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccin @ (ccin @ XA2 @ XB2) @ XC) @ (ccin @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XC))))))).
thf(asimprl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xps))))).
thf(aad2antll_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xch @ (cwa @ Xth @ Xph)) @ Xps))))))).
thf(ainss2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccin @ XA2 @ XB2) @ XB2)))).
thf(amdsl3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cw3a @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwss @ (ccin @ XA2 @ XB2) @ XC) @ (cwss @ XC @ XB2))) @ (cwceq @ (ccin @ (cco @ XC @ XA2 @ cchj) @ XB2) @ XC)))))).
