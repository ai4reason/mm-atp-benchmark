...
thf(climcresioolb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwbr @ XB2 @ XC @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XB2 @ XC @ ccioo) @ XA2)) => ((cwi @ Xph @ (cwcel @ XD @ ccxr)) => ((cwi @ Xph @ (cwbr @ XC @ XD @ ccle)) => (cwi @ Xph @ (cwceq @ (cco @ (ccres @ XF @ (cco @ XB2 @ XC @ ccioo)) @ XB2 @ cclimc) @ (cco @ (ccres @ XF @ (cco @ XB2 @ XD @ ccioo)) @ XB2 @ cclimc))))))))))))))))).
