...
thf(amrsubco_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwi @ (cwa @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XG @ (ccrn @ XS))) @ (cwcel @ (cccom @ XF @ XG) @ (ccrn @ XS))))))))).
...
thf(cmsubco_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmsub)) => (cwi @ (cwa @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XG @ (ccrn @ XS))) @ (cwcel @ (cccom @ XF @ XG) @ (ccrn @ XS))))))))).
