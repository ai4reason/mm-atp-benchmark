...
thf(aax_bgbltosilvaOLD_ax,axiom,(! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (cwbr @ XN @ (cco @ cc4 @ (cco @ cc10 @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ ccle)) @ (cwcel @ XN @ ccgbe)))).
thf(cbgoldbachltOLD_conj,conjecture,(cwrex @ (^ [Xm:$i] : (cwa @ (cwbr @ (cco @ cc4 @ (cco @ cc10 @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ (ccv @ Xm) @ ccle) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwa @ (cwbr @ cc4 @ (ccv @ Xn) @ cclt) @ (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ cclt)) @ (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)))) @ (^ [Xm:$i] : ccn))).
