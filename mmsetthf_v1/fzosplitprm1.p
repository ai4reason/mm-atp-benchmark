...
thf(afzosplitpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ cc2 @ ccaddc) @ ccfzo) @ (ccun @ (cco @ XA2 @ XB2 @ ccfzo) @ (ccpr @ XB2 @ (cco @ XB2 @ cc1 @ ccaddc)))))))).
...
thf(cfzosplitprm1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccfzo) @ (ccun @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ ccfzo) @ (ccpr @ (cco @ XB2 @ cc1 @ ccmin) @ XB2))))))).
