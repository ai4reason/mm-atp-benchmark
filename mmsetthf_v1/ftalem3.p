...
thf(cftalem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XA2 @ Xy1 @ Xz) @ (ccfv @ XF @ cccoe)))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XN @ Xy1 @ Xz) @ (ccfv @ XF @ ccdgr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ (XS @ Xx3 @ Xy1 @ Xz) @ ccply)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xy1 @ Xz) @ ccn)))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XD @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ ccabs) @ (XR @ Xz) @ ccle)) @ (^ [Xy1:$i] : ccc))))) => ((! [Xy1:$i] : (cwceq @ (XJ @ Xy1) @ (ccfv @ cccnfld @ cctopn))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xz) @ ccrp))) => ((! [Xz:$i] : (cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (XR @ Xz) @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cclt) @ (cwbr @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ cclt))) @ (^ [Xx3:$i] : ccc)))) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle)) @ (^ [Xx3:$i] : ccc))) @ (^ [Xz:$i] : ccc)))))))))))))))))))).
