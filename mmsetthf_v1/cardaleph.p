...
thf(aonminsb_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccon0)))) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccon0)) @ (Xps @ Xx3)))))))).
...
thf(ccardaleph_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ ccom @ XA2) @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2)) @ (cwceq @ XA2 @ (ccfv @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccale))) @ (^ [Xx3:$i] : ccon0))) @ ccale))))).
