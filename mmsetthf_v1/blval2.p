...
thf(cblval2_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccrp)) @ (cwceq @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccima @ (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ XR @ ccico)) @ (ccsn @ XP))))))))).
