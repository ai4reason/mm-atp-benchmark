...
thf(avolfiniune_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xn:$i] : (cwcel @ (XB2 @ Xn) @ (ccdm @ ccvol))) @ (^ [Xn:$i] : XA2)) @ (cwdisj @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn)))) @ (cwceq @ (ccfv @ (cciun @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccvol) @ (ccesum @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccfv @ (XB2 @ Xn) @ ccvol)))))))).
...
thf(adisjrdx_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf1o @ XA2 @ XC @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (cwceq @ (XD @ Xy1) @ (XB2 @ Xx3))))) => (cwi @ Xph @ (cwb @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwdisj @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))))).
...
thf(avoliune_thm,axiom,(! [XA2:($i > ($i > $o))] : (cwi @ (cwa @ (cwral @ (^ [Xn:$i] : (cwcel @ (XA2 @ Xn) @ (ccdm @ ccvol))) @ (^ [Xn:$i] : ccn)) @ (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn)))) @ (cwceq @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccvol) @ (ccesum @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccvol))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))))).
thf(asyl6eqr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwceq @ XC @ XB2) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(aiunrdx_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwfo @ XA2 @ XC @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (cwceq @ (XD @ Xy1) @ (XB2 @ Xx3))))) => (cwi @ Xph @ (cwceq @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciun @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))))).
...
thf(aisfinite2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwbr @ XA2 @ ccom @ ccsdm) @ (cwcel @ XA2 @ ccfn)))).
