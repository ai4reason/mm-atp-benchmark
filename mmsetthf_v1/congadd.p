...
thf(ccongadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwa @ (cwcel @ XD @ ccz) @ (cwcel @ XE @ ccz)) @ (cwa @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XD @ XE @ ccmin) @ ccdvds))) @ (cwbr @ XA2 @ (cco @ (cco @ XB2 @ XD @ ccaddc) @ (cco @ XC @ XE @ ccaddc) @ ccmin) @ ccdvds)))))))).
