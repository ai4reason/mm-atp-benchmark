...
thf(aitg10a_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccitg1) @ ccc0)))))))))).
...
thf(ai1fsub_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ (ccdm @ ccitg1))) @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccdm @ ccitg1)))))).
thf(ccico_tp,type,(ccico : ($i > $o))).
thf(ai1fpos_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1)))))))).
...
thf(aitg1mulc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccitg1) @ (cco @ XA2 @ (ccfv @ XF @ ccitg1) @ ccmul))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))))).
thf(a_3eqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => ((cwi @ Xph @ (cwceq @ XC @ XD)) => (cwi @ Xph @ (cwceq @ XA2 @ XD))))))))))).
thf(aitg11_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr)) @ (cwceq @ (ccfv @ (XF @ Xx3) @ ccitg1) @ (ccfv @ XA2 @ ccvol)))))))).
...
thf(adivcan5rd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccdiv) @ (cco @ XA2 @ XB2 @ ccdiv))))))))))))).
thf(aitg1sub_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ (ccdm @ ccitg1))) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccitg1) @ (cco @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccmin)))))).
...
thf(apm4_53_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwn @ (cwa @ Xph @ (cwn @ Xps))) @ (cwo @ (cwn @ Xph) @ Xps))))).
...
thf(aitg1le_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ (ccdm @ ccitg1)) @ (cwbr @ XF @ XG @ (ccofr @ ccle))) @ (cwbr @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccle))))).
...
thf(citg2addnclem_conj,conjecture,(! [XF:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (cwceq @ (XL @ Xx3 @ Xy1 @ Xz @ Xg1) @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xg1:$i] : (cwa @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccif @ (cwceq @ (ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) @ ccc0) @ ccc0 @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xy1) @ ccaddc)))) @ XF @ (ccofr @ ccle))) @ (^ [Xy1:$i] : ccrp)) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xg1) @ ccitg1)))) @ (^ [Xg1:$i] : (ccdm @ ccitg1)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (cwi @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) @ (cwceq @ (ccfv @ XF @ ccitg2) @ (ccsup @ (XL @ Xx3 @ Xy1 @ Xz @ Xg1) @ ccxr @ cclt))))))))))).
