...
thf(aabslem2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwceq @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv) @ cccj) @ XA2 @ ccmul) @ (cco @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv) @ (ccfv @ XA2 @ cccj) @ ccmul) @ ccaddc) @ (cco @ cc2 @ (ccfv @ XA2 @ ccabs) @ ccmul))))).
...
thf(aabs00i_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwb @ (cwceq @ (ccfv @ XA2 @ ccabs) @ ccc0) @ (cwceq @ XA2 @ ccc0))))).
...
thf(aabsgt0i_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwb @ (cwne @ XA2 @ ccc0) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccabs) @ cclt))))).
thf(arecgt0i_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwi @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ ccc0 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt))))).
...
thf(anormlem7tALT_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwi @ (cwa @ (cwcel @ XS @ ccc) @ (cwceq @ (ccfv @ XS @ ccabs) @ cc1)) @ (cwbr @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XA2 @ XB2 @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XB2 @ XA2 @ ccsp) @ ccmul) @ ccaddc) @ (cco @ cc2 @ (cco @ (ccfv @ (cco @ XB2 @ XB2 @ ccsp) @ ccsqrt) @ (ccfv @ (cco @ XA2 @ XA2 @ ccsp) @ ccsqrt) @ ccmul) @ ccmul) @ ccle)))))))).
