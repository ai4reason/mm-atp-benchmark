...
thf(clt2halvesd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt)) => ((cwi @ Xph @ (cwbr @ XB2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt)))))))))))).
