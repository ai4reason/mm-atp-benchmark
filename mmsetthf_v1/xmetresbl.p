...
thf(axmeter_thm,axiom,(! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccima @ (cccnv @ XD) @ ccr)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwer @ XX @ Xc_sm))))))).
...
thf(ablssec_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccima @ (cccnv @ XD) @ ccr)) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XS @ ccxr)) @ (cwss @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl)) @ (ccec @ XP @ Xc_sm)))))))))).
...
thf(axmeterval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccima @ (cccnv @ XD) @ ccr)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwb @ (cwbr @ XA2 @ XB2 @ Xc_sm) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ (cco @ XA2 @ XB2 @ XD) @ ccr))))))))))).
...
thf(aismet2_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwf @ (ccxp @ XX @ XX) @ ccr @ XD)))))).
thf(cxmetresbl_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccxr)) @ (cwcel @ (ccres @ XD @ (ccxp @ XB2 @ XB2)) @ (ccfv @ XB2 @ ccme)))))))))).
