...
thf(achintcli_thm,axiom,(! [XA2:($i > $o)] : ((cwa @ (cwss @ XA2 @ ccch) @ (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ ccch)))).
...
thf(cchincli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwcel @ (ccin @ XA2 @ XB2) @ ccch)))))).
