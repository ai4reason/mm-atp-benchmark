...
thf(csumz_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwo @ (cwss @ XA2 @ (ccfv @ XM @ ccuz)) @ (cwcel @ XA2 @ ccfn)) @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : ccc0)) @ ccc0))))).
