...
thf(am1dvdsndvds_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz)) @ (cwi @ (cwbr @ XP @ (cco @ XA2 @ cc1 @ ccmin) @ ccdvds) @ (cwn @ (cwbr @ XP @ XA2 @ ccdvds))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(amodprminv_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XR @ (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) => (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz) @ (cwn @ (cwbr @ XP @ XA2 @ ccdvds))) @ (cwa @ (cwcel @ XR @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz)) @ (cwceq @ (cco @ (cco @ XA2 @ XR @ ccmul) @ XP @ ccmo) @ cc1)))))))).
...
thf(aprmm2nn0_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwcel @ (cco @ XP @ cc2 @ ccmin) @ ccn0)))).
...
thf(cpowm2modprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz)) @ (cwi @ (cwbr @ XP @ (cco @ XA2 @ cc1 @ ccmin) @ ccdvds) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo) @ cc1)))))).
