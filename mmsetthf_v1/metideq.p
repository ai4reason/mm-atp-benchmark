...
thf(cmetideq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwa @ (cwbr @ XA2 @ XB2 @ (ccfv @ XD @ ccmetid)) @ (cwbr @ XE @ XF @ (ccfv @ XD @ ccmetid)))) @ (cwceq @ (cco @ XA2 @ XE @ XD) @ (cco @ XB2 @ XF @ XD)))))))))).
