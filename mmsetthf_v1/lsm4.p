...
thf(clsm4_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cw3a @ (cwcel @ XG @ ccabl) @ (cwa @ (cwcel @ XQ @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XR @ (ccfv @ XG @ ccsubg))) @ (cwa @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg)))) @ (cwceq @ (cco @ (cco @ XQ @ XR @ Xc_po) @ (cco @ XT @ XU @ Xc_po) @ Xc_po) @ (cco @ (cco @ XQ @ XT @ Xc_po) @ (cco @ XR @ XU @ Xc_po) @ Xc_po))))))))))).
