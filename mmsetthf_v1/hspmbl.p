...
thf(ahspval_thm,axiom,(! [Xph:$o] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (cwceq @ (XH @ Xx3 @ Xy1 @ Xi @ Xk) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xy1:$i] : (ccv @ Xx3))) @ (^ [Xi:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xy1:$i] : (ccixp @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (ccv @ Xi)) @ (cco @ ccmnf @ (ccv @ Xy1) @ ccioo) @ ccr))))))))))))) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XI @ Xx3) @ XX))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XY @ Xx3) @ ccr))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XI @ Xx3) @ (XY @ Xx3) @ (ccfv @ XX @ (XH @ Xx3 @ Xy1 @ Xi @ Xk))) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (XI @ Xx3)) @ (cco @ ccmnf @ (XY @ Xx3) @ ccioo) @ ccr))))))))))))))))))).
...
thf(ahspmbllem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : (cwceq @ (XH @ Xx3 @ Xy1 @ Xh @ Xr @ Xa @ Xl) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccv @ Xx3))) @ (^ [Xl:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccixp @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (ccv @ Xl)) @ (cco @ ccmnf @ (ccv @ Xy1) @ ccioo) @ ccr))))))))))))))) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xr) @ XX))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XY @ Xr) @ ccr))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ (ccfv @ XX @ ccovoln)) @ ccr)) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ ccr @ XX @ ccmap))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XC @ Xx3 @ Xy1 @ Xj @ Xk @ Xl) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccrab @ (^ [Xl:$i] : (cwss @ (ccv @ Xa) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xl)))))))))) @ (^ [Xl:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XL @ Xx3 @ Xy1 @ Xj @ Xk @ Xl) @ (ccmpt @ (^ [Xh:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xh:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xh))) @ ccvol))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XD @ Xi) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccmpt @ (^ [Xr:$i] : ccrp) @ (^ [Xr:$i] : (ccrab @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)) @ (XL @ Xx3 @ Xy1 @ Xj @ Xk @ Xl)))) @ ccsumge0) @ (cco @ (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)) @ (ccv @ Xr) @ ccxad) @ ccle)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xa) @ (XC @ Xx3 @ Xy1 @ Xj @ Xk @ Xl))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xr:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xi @ Xj @ Xr) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))) @ cc1st))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xr:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xi @ Xr) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))) @ cc2nd)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ (ccin @ XA2 @ (cco @ (XK @ Xr) @ (XY @ Xr) @ (ccfv @ XX @ (XH @ Xx3 @ Xy1 @ Xh @ Xr @ Xa @ Xl)))) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccdif @ XA2 @ (cco @ (XK @ Xr) @ (XY @ Xr) @ (ccfv @ XX @ (XH @ Xx3 @ Xy1 @ Xh @ Xr @ Xa @ Xl)))) @ (ccfv @ XX @ ccovoln)) @ ccxad) @ (ccfv @ XA2 @ (ccfv @ XX @ ccovoln)) @ ccle))))))))))))))))))))))))))))))).
...
thf(chspmbl_conj,conjecture,(! [Xph:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XH @ Xx3 @ Xy1 @ Xk @ Xl) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccv @ Xx3))) @ (^ [Xl:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccixp @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (ccv @ Xl)) @ (cco @ ccmnf @ (ccv @ Xy1) @ ccioo) @ ccr))))))))))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XX @ Xk) @ ccfn))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XK @ Xk) @ (XX @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XY @ Xk) @ ccr))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (cco @ (XK @ Xk) @ (XY @ Xk) @ (ccfv @ (XX @ Xk) @ (XH @ Xx3 @ Xy1 @ Xk @ Xl))) @ (ccdm @ (ccfv @ (XX @ Xk) @ ccvoln)))))))))))))))))).
