...
thf(afourierdlem21_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwceq @ XC @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XC) @ ccibl)) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv)))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwa @ (cwa @ (cwcel @ (ccfv @ XN @ (XB2 @ Xx3 @ Xn)) @ ccr) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccibl)) @ (cwcel @ (ccitg @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccr)))))))))))))))).
...
thf(amul13d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccmul) @ (cco @ XC @ (cco @ XB2 @ XA2 @ ccmul) @ ccmul))))))))))).
...
thf(aitgfsum_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ ccvol))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ XB2))) @ (cwcel @ (XC @ Xx3 @ Xk) @ (XV @ Xx3 @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XB2)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xk))) @ ccibl))) => (cwi @ Xph @ (cwa @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xx3 @ Xk))))) @ ccibl) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xx3 @ Xk))))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xk)))))))))))))))))).
...
thf(adirkertrigeq_b_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XD @ Xk @ Xs1) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xk) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XF @ Xk @ Xs1) @ (ccfv @ XN @ (XD @ Xk @ Xs1))))) => ((! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XH @ Xk @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xs1) @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv)))))) => (! [Xk:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xk @ Xs1) @ (XH @ Xk @ Xs1))))))))))))))).
...
thf(aevthiccabs_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => (cwi @ Xph @ (cwa @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc))) @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xw) @ XF) @ ccabs) @ ccle)) @ (^ [Xw:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccicc)))))))))))))).
...
thf(cfourierdlem83_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xm:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwf @ ccr @ ccr @ (XF @ Xm @ Xs1))))) => ((! [Xm:$i] : (cwceq @ (XC @ Xm) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))) => ((! [Xm:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (ccres @ (XF @ Xm @ Xs1) @ (XC @ Xm)) @ ccibl)))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xs1:$i] : (cwceq @ (XA2 @ Xx3 @ Xs1) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (XC @ Xm)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xm @ Xs1)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XB2 @ Xx3 @ Xn @ Xs1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (XC @ Xm)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xm @ Xs1)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv)))))))) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XS @ Xx3 @ Xm @ Xn @ Xs1) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (cco @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xs1)) @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xs1)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xn @ Xs1)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ ccsin) @ ccmul) @ ccaddc))) @ ccaddc)))))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xm @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (XS @ Xx3 @ Xm @ Xn @ Xs1)) @ (ccitg @ (^ [Xx3:$i] : (XC @ Xm)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xm @ Xs1)) @ (ccfv @ (cco @ (ccv @ Xx3) @ XX @ ccmin) @ (ccfv @ XN @ (XD @ Xm @ Xn))) @ ccmul)))))))))))))))))))))))))))).
