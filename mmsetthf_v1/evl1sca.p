...
thf(cevl1sca_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => (cwi @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ (ccfv @ XX @ XA2) @ XO) @ (ccxp @ XB2 @ (ccsn @ XX))))))))))))))).
