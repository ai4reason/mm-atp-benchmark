...
thf(adf_fwddif_ax,axiom,(cwceq @ ccfwddif @ (ccmpt @ (^ [Xf1:$i] : (cco @ ccc @ ccc @ ccpm)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ (ccdm @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccdm @ (ccv @ Xf1))))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ ccmin))))))).
...
thf(cfwddifval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwi @ Xph @ (cwcel @ (cco @ XX @ cc1 @ ccaddc) @ XA2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ (ccfv @ XF @ ccfwddif)) @ (cco @ (ccfv @ (cco @ XX @ cc1 @ ccaddc) @ XF) @ (ccfv @ XX @ XF) @ ccmin)))))))))))).
