...
thf(aram0_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccn0) @ (cwceq @ (cco @ XM @ cc0 @ ccram) @ XM)))).
...
thf(a_0ram2_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ ccfn) @ (cwne @ XR @ cc0) @ (cwf @ XR @ ccn0 @ XF)) @ (cwceq @ (cco @ ccc0 @ XF @ ccram) @ (ccsup @ (ccrn @ XF) @ ccr @ cclt)))))).
...
thf(c_0ramcl_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccfn) @ (cwf @ XR @ ccn0 @ XF)) @ (cwcel @ (cco @ ccc0 @ XF @ ccram) @ ccn0))))).
