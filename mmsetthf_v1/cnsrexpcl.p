...
thf(ccnsrexpcl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => ((cwi @ Xph @ (cwcel @ XY @ ccn0)) => (cwi @ Xph @ (cwcel @ (cco @ XX @ XY @ ccexp) @ XS)))))))))).
