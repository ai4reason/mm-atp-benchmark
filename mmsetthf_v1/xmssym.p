...
thf(cxmssym_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XM @ ccbs)) => ((cwceq @ XD @ (ccfv @ XM @ ccds)) => (cwi @ (cw3a @ (cwcel @ XM @ ccxme) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ XA2 @ XB2 @ XD) @ (cco @ XB2 @ XA2 @ XD))))))))))).
