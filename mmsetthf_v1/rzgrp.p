...
thf(areplusg_thm,axiom,(cwceq @ ccaddc @ (ccfv @ ccrefld @ ccplusg))).
...
thf(crzgrp_conj,conjecture,(! [XR:($i > $o)] : ((cwceq @ XR @ (cco @ ccrefld @ (cco @ ccrefld @ ccz @ ccqg) @ ccqus)) => (cwcel @ XR @ ccgrp)))).
