...
thf(ccaurcvgr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf)) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xj) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : XA2))) @ (^ [Xx3:$i] : ccrp))) => (cwi @ Xph @ (cwbr @ XF @ (ccfv @ XF @ cclsp) @ ccrli)))))))))).
