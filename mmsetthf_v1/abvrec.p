...
thf(aabv1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccabv)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwcel @ XF @ XA2)) @ (cwceq @ (ccfv @ Xc_1 @ XF) @ cc1))))))))).
thf(cabvrec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccabv)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccdr) @ (cwcel @ XF @ XA2)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0))) @ (cwceq @ (ccfv @ (ccfv @ XX @ XI) @ XF) @ (cco @ cc1 @ (ccfv @ XX @ XF) @ ccdiv))))))))))))))).
