...
thf(axppreima2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XC @ XG)) => ((cwceq @ XH @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccima @ (cccnv @ XH) @ (ccxp @ (XY @ Xx3) @ (XZ @ Xx3))) @ (ccin @ (ccima @ (cccnv @ XF) @ (XY @ Xx3)) @ (ccima @ (cccnv @ XG) @ (XZ @ Xx3))))))))))))))))))).
...
thf(aimambfm_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ ccvv)) => ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwceq @ XT @ (ccfv @ XK @ ccsigagen))) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccmbfm)) @ (cwa @ (cwf @ (ccuni @ XS) @ (ccuni @ XT) @ XF) @ (cwral @ (^ [Xa:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xa)) @ XS)) @ (^ [Xa:$i] : XK)))))))))))))).
