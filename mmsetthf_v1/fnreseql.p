...
thf(cfnreseql_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XA2) @ (cwss @ XX @ XA2)) @ (cwb @ (cwceq @ (ccres @ XF @ XX) @ (ccres @ XG @ XX)) @ (cwss @ XX @ (ccdm @ (ccin @ XF @ XG)))))))))).
