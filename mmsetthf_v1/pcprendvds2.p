...
thf(cpcprendvds2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwa @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0))) @ (cwn @ (cwbr @ XP @ (cco @ XN @ (cco @ XP @ (XS @ Xn) @ ccexp) @ ccdiv) @ ccdvds))))))))))).
