...
thf(apm13_183_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xz)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwal @ (^ [Xz:$i] : (cwb @ (cwceq @ (ccv @ Xz) @ XA2) @ (cwceq @ (ccv @ Xz) @ XB2))))))))))).
