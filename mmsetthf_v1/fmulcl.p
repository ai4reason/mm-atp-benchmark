...
thf(cfmulcl_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XP @ Xt @ Xf1 @ Xg1) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul)))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XX @ Xt @ Xf1 @ Xg1) @ (ccfv @ (XN @ Xt @ Xf1 @ Xg1) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1) @ (XU @ Xt @ Xf1 @ Xg1) @ cc1)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XN @ Xt @ Xf1 @ Xg1) @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xt) @ (cwf @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz) @ (XY @ Xt) @ (XU @ Xt @ Xf1 @ Xg1)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt)) @ (cwcel @ (ccv @ Xg1) @ (XY @ Xt))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XY @ Xt)))))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XT @ ccvv))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XX @ Xt @ Xf1 @ Xg1) @ (XY @ Xt))))))))))))))))))))).
