...
thf(a_0clwlk_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XX) @ (cwb @ (cwbr @ cc0 @ XP @ (ccfv @ XG @ ccclwlks)) @ (cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP))))))))).
...
thf(a_0clwlkv_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XX @ XV) @ (cwceq @ XF @ cc0) @ (cwf @ (ccsn @ ccc0) @ (ccsn @ XX) @ XP)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccclwlks)))))))))).
...
thf(cwlkl0_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XX @ XV) @ (cwceq @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccc0) @ (cwceq @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xw) @ cc2nd)) @ XX))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ (ccsn @ (ccop @ cc0 @ (ccsn @ (ccop @ ccc0 @ XX))))))))))).
