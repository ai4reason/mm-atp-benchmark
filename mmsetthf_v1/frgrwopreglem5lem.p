...
thf(cfrgrwopreglem5lem_conj,conjecture,(! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XD @ (ccfv @ XG @ ccvtxdg)) => ((cwceq @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XD) @ XK)) @ (^ [Xx3:$i] : XV))) => ((cwceq @ XB2 @ (ccdif @ XV @ XA2)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ ccedg))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ XA2) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwa @ (cwcel @ (ccv @ Xb) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2))) @ (cw3a @ (cwceq @ (ccfv @ (ccv @ Xa) @ XD) @ (ccfv @ (ccv @ Xx3) @ XD)) @ (cwne @ (ccfv @ (ccv @ Xa) @ XD) @ (ccfv @ (ccv @ Xb) @ XD)) @ (cwne @ (ccfv @ (ccv @ Xx3) @ XD) @ (ccfv @ (ccv @ Xy1) @ XD))))))))))))))))))))).
