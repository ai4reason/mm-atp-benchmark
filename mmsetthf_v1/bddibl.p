...
thf(cbddibl_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ ccmbf) @ (cwcel @ (ccfv @ (ccdm @ XF) @ ccvol) @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccdm @ XF)))) @ (^ [Xx3:$i] : ccr))) @ (cwcel @ XF @ ccibl)))).
