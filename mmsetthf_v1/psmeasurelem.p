...
thf(asge0iun_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ XW))) => ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XX @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF))) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccres @ XF @ (XB2 @ Xx3)) @ ccsumge0))) @ ccsumge0)))))))))))))))).
...
thf(apwpwuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ (ccpw @ (ccpw @ XB2))) @ (cwcel @ (ccuni @ XA2) @ (ccpw @ XB2)))))))).
...
thf(cpsmeasurelem_conj,conjecture,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwf @ (XX @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XH))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XM @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ (XX @ Xy1))) @ (^ [Xx3:$i] : (ccfv @ (ccres @ XH @ (ccv @ Xx3)) @ ccsumge0)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf @ (ccpw @ (XX @ Xy1)) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XM @ Xx3))))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwss @ XY @ (ccpw @ (XX @ Xy1))))) => ((cwi @ Xph @ (cwdisj @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccv @ Xy1)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccuni @ XY) @ (XM @ Xx3)) @ (ccfv @ (ccres @ (XM @ Xx3) @ XY) @ ccsumge0))))))))))))))))).
