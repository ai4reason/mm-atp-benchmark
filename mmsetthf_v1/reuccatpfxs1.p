...
thf(areuccatpfxs1lem_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (XU @ Xs1) @ XX)) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat) @ XX) @ (cwceq @ (XS @ Xx3) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : XV)) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccword @ XV)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : XX))) @ (cwi @ (cwceq @ XW @ (cco @ (XU @ Xs1) @ (ccfv @ XW @ cchash) @ ccpfx)) @ (cwceq @ (XU @ Xs1) @ (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat)))))))))))).
...
thf(accats1pfxeqbi_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwceq @ (ccfv @ XU @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) @ (cwb @ (cwceq @ XW @ (cco @ XU @ (ccfv @ XW @ cchash) @ ccpfx)) @ (cwceq @ XU @ (cco @ XW @ (ccs1 @ (ccfv @ XU @ cclsw)) @ ccconcat)))))))).
...
thf(creuccatpfxs1_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccword @ XV)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : XX))) @ (cwi @ (cwreu @ (^ [Xv:$i] : (cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xv)) @ ccconcat) @ XX)) @ (^ [Xv:$i] : XV)) @ (cwreu @ (^ [Xw:$i] : (cwceq @ XW @ (cco @ (ccv @ Xw) @ (ccfv @ XW @ cchash) @ ccpfx))) @ (^ [Xw:$i] : XX)))))))).
