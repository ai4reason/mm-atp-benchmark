...
thf(chocadddiri_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (cwceq @ (cccom @ (cco @ XR @ XS @ cchos) @ XT) @ (cco @ (cccom @ XR @ XT) @ (cccom @ XS @ XT) @ cchos))))))))).
