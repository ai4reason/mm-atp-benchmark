...
thf(aclintop_thm,axiom,(! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ Xc_op @ (ccfv @ XM @ ccclintop)) @ (cwf @ (ccxp @ XM @ XM) @ XM @ Xc_op))))).
...
thf(cclintopcllaw_conj,conjecture,(! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ Xc_op @ (ccfv @ XM @ ccclintop)) @ (cwbr @ Xc_op @ XM @ cccllaw))))).
