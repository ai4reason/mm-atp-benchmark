...
thf(cee121_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ (cwi @ Xch @ Xth)) => ((cwi @ Xph @ Xta) => ((cwi @ Xps @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwi @ Xph @ (cwi @ Xch @ Xet))))))))))))).
