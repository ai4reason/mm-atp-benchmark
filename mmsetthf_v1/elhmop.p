...
thf(adf_hmop_ax,axiom,(cwceq @ ccho @ (ccrab @ (^ [Xt:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xt)) @ ccsp) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xt)) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xt:$i] : (cco @ cchil @ cchil @ ccmap))))).
...
thf(celhmop_conj,conjecture,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ ccho) @ (cwa @ (cwf @ cchil @ cchil @ XT) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccsp) @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)))))).
