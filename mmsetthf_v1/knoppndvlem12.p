...
thf(cknoppndvlem12_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (cwi @ Xph @ (cwa @ (cwne @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) @ cc1) @ (cwbr @ cc1 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) @ cc1 @ ccmin) @ cclt)))))))))).
