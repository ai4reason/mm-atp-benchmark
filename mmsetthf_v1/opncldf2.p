...
thf(copncldf2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((! [Xu:$i] : (cwceq @ (XF @ Xu) @ (ccmpt @ (^ [Xu:$i] : XJ) @ (^ [Xu:$i] : (ccdif @ XX @ (ccv @ Xu)))))) => (! [Xu:$i] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ XJ)) @ (cwceq @ (ccfv @ XA2 @ (XF @ Xu)) @ (ccdif @ XX @ XA2))))))))))).
