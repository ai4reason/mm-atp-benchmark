...
thf(cdifelcarsg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ XV)) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XM @ cccarsg))) => (cwi @ Xph @ (cwcel @ (ccdif @ XO @ XA2) @ (ccfv @ XM @ cccarsg)))))))))))).
