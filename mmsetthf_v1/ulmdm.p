...
thf(aulmuni_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm)) @ (cwbr @ XF @ XH @ (ccfv @ XS @ cculm))) @ (cwceq @ XG @ XH))))))).
...
thf(culmdm_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ (ccdm @ (ccfv @ XS @ cculm))) @ (cwbr @ XF @ (ccfv @ XF @ (ccfv @ XS @ cculm)) @ (ccfv @ XS @ cculm)))))).
