...
thf(adf_clm_ax,axiom,(cwceq @ ccclm @ (ccrab @ (^ [Xw:$i] : (cwsbc @ (^ [Xf1:$i] : (cwsbc @ (^ [Xk:$i] : (cwa @ (cwceq @ (ccv @ Xf1) @ (cco @ cccnfld @ (ccv @ Xk) @ ccress)) @ (cwcel @ (ccv @ Xk) @ (ccfv @ cccnfld @ ccsubrg)))) @ (ccfv @ (ccv @ Xf1) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ ccsca))) @ (^ [Xw:$i] : cclmod)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(cisclm_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwb @ (cwcel @ XW @ ccclm) @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwceq @ XF @ (cco @ cccnfld @ XK @ ccress)) @ (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)))))))))).
