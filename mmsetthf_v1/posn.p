...
thf(apoeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwpo @ XA2 @ XR) @ (cwpo @ XB2 @ XR))))))).
...
thf(cposn_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwrel @ XR) @ (cwb @ (cwpo @ (ccsn @ XA2) @ XR) @ (cwn @ (cwbr @ XA2 @ XA2 @ XR))))))).
