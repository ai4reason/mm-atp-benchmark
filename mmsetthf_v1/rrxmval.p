...
thf(arrxmvallem_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => (! [Xh:$i] : (cwi @ (cw3a @ (cwcel @ XI @ XV) @ (cwcel @ XF @ (XX @ Xh)) @ (cwcel @ XG @ (XX @ Xh))) @ (cwss @ (cco @ (ccmpt @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin) @ cc2 @ ccexp))) @ ccc0 @ ccsupp) @ (ccun @ (cco @ XF @ ccc0 @ ccsupp) @ (cco @ XG @ ccc0 @ ccsupp)))))))))))).
...
thf(aregsumsupp_thm,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwf @ XI @ ccr @ XF) @ (cwbr @ XF @ ccc0 @ ccfsupp) @ (cwcel @ XI @ XV)) @ (cwceq @ (cco @ ccrefld @ XF @ ccgsu) @ (ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))).
