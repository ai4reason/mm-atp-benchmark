...
thf(ahmopidmpji_thm,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccho) => ((cwceq @ (cccom @ XT @ XT) @ XT) => (cwceq @ XT @ (ccfv @ (ccrn @ XT) @ ccpjh)))))).
...
thf(chmopidmpj_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ ccho) @ (cwceq @ (cccom @ XT @ XT) @ XT)) @ (cwceq @ XT @ (ccfv @ (ccrn @ XT) @ ccpjh))))).
