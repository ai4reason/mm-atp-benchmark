...
thf(cac6n_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xf1)))))) => (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xf1:$i] : (cwi @ (cwf @ (XA2 @ Xy1) @ XB2 @ (ccv @ Xf1)) @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xf1)) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))))))))).
