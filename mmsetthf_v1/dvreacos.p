...
thf(aacosf_thm,axiom,(cwf @ ccc @ ccc @ ccacos)).
...
thf(advmptres3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xx3) @ (ccpr @ ccr @ ccc)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (XJ @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccin @ (XS @ Xx3) @ XX) @ XY))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XX)) @ (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XX)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))))))))))).
...
thf(auncld_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XJ @ cccld)) @ (cwcel @ XB2 @ (ccfv @ XJ @ cccld))) @ (cwcel @ (ccun @ XA2 @ XB2) @ (ccfv @ XJ @ cccld))))))).
...
thf(aasindmre_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => (cwceq @ (ccin @ XD @ ccr) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))))).
thf(aadantl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xch @ Xph) @ Xps)))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(aeldifi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdif @ XB2 @ XC)) @ (cwcel @ XA2 @ XB2)))))).
thf(aacoscl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccacos) @ ccc)))).
...
thf(advacos_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => (cwceq @ (cco @ ccc @ (ccres @ ccacos @ XD) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))))).
thf(adifssd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ Xph @ (cwss @ (ccdif @ XA2 @ XB2) @ XA2)))))).
thf(cdvreacos_conj,conjecture,(cwceq @ (cco @ ccr @ (ccres @ ccacos @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))).
