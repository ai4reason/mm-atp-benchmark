...
thf(aidfuval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XI @ Xz) @ (ccfv @ XC @ ccidfu))) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => (! [Xz:$i] : (cwi @ Xph @ (cwceq @ (XI @ Xz) @ (ccop @ (ccres @ ccid @ XB2) @ (ccmpt @ (^ [Xz:$i] : (ccxp @ XB2 @ XB2)) @ (^ [Xz:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xz) @ XH)))))))))))))))))).
thf(cc1stf_tp,type,(cc1stf : ($i > $o))).
thf(adiag11_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XL @ (cco @ XC @ XD @ ccdiag)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwceq @ XK @ (ccfv @ XX @ (ccfv @ XL @ cc1st))) => ((cwceq @ XB2 @ (ccfv @ XD @ ccbs)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XY @ (ccfv @ XK @ cc1st)) @ XX)))))))))))))))))))).
...
thf(adiag1cl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XL @ (cco @ XC @ XD @ ccdiag)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwceq @ XK @ (ccfv @ XX @ (ccfv @ XL @ cc1st))) => (cwi @ Xph @ (cwcel @ XK @ (cco @ XD @ XC @ ccfunc))))))))))))))))).
...
thf(adiag12_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XL @ (cco @ XC @ XD @ ccdiag)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwceq @ XK @ (ccfv @ XX @ (ccfv @ XL @ cc1st))) => ((cwceq @ XB2 @ (ccfv @ XD @ ccbs)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwceq @ XJ @ (ccfv @ XD @ cchom)) => ((cwceq @ Xc_1 @ (ccfv @ XC @ cccid)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XY @ XZ @ XJ))) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ (cco @ XY @ XZ @ (ccfv @ XK @ cc2nd))) @ (ccfv @ XX @ Xc_1))))))))))))))))))))))))))))).
...
thf(ccurf2ndf_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : ((cwceq @ XQ @ (cco @ XD @ XD @ ccfuc)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => (cwi @ Xph @ (cwceq @ (cco @ (ccop @ XC @ XD) @ (cco @ XC @ XD @ cc2ndf) @ cccurf) @ (ccfv @ (ccfv @ XD @ ccidfu) @ (ccfv @ (cco @ XQ @ XC @ ccdiag) @ cc1st)))))))))))).
