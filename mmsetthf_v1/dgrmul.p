...
thf(adgrmul2_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply))) @ (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdgr) @ (cco @ XM @ XN @ ccaddc) @ ccle)))))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(asyl3anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ Xth) => ((cwi @ (cw3a @ Xps @ Xch @ Xth) @ Xta) => (cwi @ Xph @ Xta))))))))))).
thf(aplymulcl_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply))) @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (ccfv @ ccc @ ccply))))))).
...
thf(adgrub_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ ccn0) @ (cwne @ (ccfv @ XM @ XA2) @ ccc0)) @ (cwbr @ XM @ XN @ ccle)))))))))).
...
thf(cdgrmul_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => (cwi @ (cwa @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwne @ XF @ cc0p)) @ (cwa @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwne @ XG @ cc0p))) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdgr) @ (cco @ XM @ XN @ ccaddc))))))))))).
