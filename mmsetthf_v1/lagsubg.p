...
thf(clagsubg_conj,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XY @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XX @ ccfn)) @ (cwbr @ (ccfv @ XY @ cchash) @ (ccfv @ XX @ cchash) @ ccdvds))))))).
