...
thf(apjtoi_thm,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwceq @ (cco @ (ccfv @ XH @ ccpjh) @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh) @ cchos) @ (ccfv @ cchil @ ccpjh))))).
...
thf(cpjoci_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwceq @ (cco @ (ccfv @ cchil @ ccpjh) @ (ccfv @ XH @ ccpjh) @ cchod) @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh))))).
