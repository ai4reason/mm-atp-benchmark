...
thf(cdeg1submon1p_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XO @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XF @ XO)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ XD) @ XX)) => ((cwi @ Xph @ (cwcel @ XG @ XO)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ XD) @ XX)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ XX @ cclt))))))))))))))))))))).
