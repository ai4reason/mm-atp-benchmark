...
thf(ccoeidlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xz:$i] : (cwceq @ XA2 @ (ccfv @ (XF @ Xz) @ cccoe))) => ((! [Xz:$i] : (cwceq @ XN @ (ccfv @ (XF @ Xz) @ ccdgr))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xz) @ (ccfv @ XS @ ccply)))) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ (ccun @ XS @ (ccsn @ ccc0)) @ ccn0 @ ccmap))) => ((cwi @ Xph @ (cwceq @ (ccima @ XB2 @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0))) => ((! [Xz:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xz) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XB2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))) => (! [Xz:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xz) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))))))))))))))))).
