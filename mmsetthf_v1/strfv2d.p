...
thf(cstrfv2d_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XE @ (ccslot @ (ccfv @ ccnx @ XE))) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwfun @ (cccnv @ (cccnv @ XS)))) => ((cwi @ Xph @ (cwcel @ (ccop @ (ccfv @ ccnx @ XE) @ XC) @ XS)) => ((cwi @ Xph @ (cwcel @ XC @ XW)) => (cwi @ Xph @ (cwceq @ XC @ (ccfv @ XS @ XE))))))))))))))).
