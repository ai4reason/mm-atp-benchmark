...
thf(afzonlt0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwn @ (cwbr @ XM @ XN @ cclt)) @ (cwceq @ (cco @ XM @ XN @ ccfzo) @ cc0)))))).
...
thf(cswrd0_conj,conjecture,(! [XF:($i > $o)] : (! [XL:($i > $o)] : (cwceq @ (cco @ cc0 @ (ccop @ XF @ XL) @ ccsubstr) @ cc0)))).
