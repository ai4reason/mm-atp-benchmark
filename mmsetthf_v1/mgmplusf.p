...
thf(cmgmplusf_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pd @ (ccfv @ XM @ ccplusf)) => (cwi @ (cwcel @ XM @ ccmgm) @ (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ Xc_pd)))))))).
