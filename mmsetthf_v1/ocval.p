...
thf(adf_oc_ax,axiom,(cwceq @ ccort @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ cchil)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccsp) @ ccc0)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : cchil)))))).
thf(arabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(cocval_conj,conjecture,(! [XH:($i > $o)] : (cwi @ (cwss @ XH @ cchil) @ (cwceq @ (ccfv @ XH @ ccort) @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp) @ ccc0)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : cchil)))))).
