...
thf(akgenval_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwceq @ (ccfv @ XJ @ cckgen) @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp) @ (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xk)) @ (cco @ XJ @ (ccv @ Xk) @ ccrest)))) @ (^ [Xk:$i] : (ccpw @ XX)))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
...
thf(ckgentopon_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ (ccfv @ XJ @ cckgen) @ (ccfv @ XX @ cctopon)))))).
