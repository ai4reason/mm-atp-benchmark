...
thf(cntrkbimka_conj,conjecture,(! [XB2:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwi @ (cwceq @ (ccin @ (ccv @ Xs1) @ (ccv @ Xt)) @ cc0) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xs1) @ XI) @ (ccfv @ (ccv @ Xt) @ XI)) @ cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2))) @ (cwceq @ (ccfv @ cc0 @ XI) @ cc0))))).
