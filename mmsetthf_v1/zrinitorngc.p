...
thf(azrrnghm_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XT @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XS @ ccrng) @ (cwcel @ XT @ (ccdif @ ccrg @ ccnzr))) @ (cwcel @ (XH @ Xx3) @ (cco @ XT @ XS @ ccrngh))))))))))))).
...
thf(czrinitorngc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccrngc)) => ((cwi @ Xph @ (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr))) => ((cwi @ Xph @ (cwcel @ XZ @ XU)) => (cwi @ Xph @ (cwcel @ XZ @ (ccfv @ XC @ ccinito))))))))))))).
