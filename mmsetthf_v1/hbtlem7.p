...
thf(adf_ldgis_ax,axiom,(cwceq @ ccldgis @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cclidl)) @ (^ [Xi:$i] : (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccab @ (^ [Xj:$i] : (cwrex @ (^ [Xk:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xr) @ ccdg1)) @ (ccv @ Xx3) @ ccle) @ (cwceq @ (ccv @ Xj) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ ccco1))))) @ (^ [Xk:$i] : (ccv @ Xi))))))))))))).
...
thf(chbtlem7_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((cwceq @ XT @ (ccfv @ XR @ cclidl)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU)) @ (cwf @ ccn0 @ XT @ (ccfv @ XI @ XS)))))))))))))).
