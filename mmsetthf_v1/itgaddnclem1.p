...
thf(aitgposval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccr))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle))) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (XB2 @ Xx3) @ ccc0))) @ ccitg2)))))))))).
...
thf(aitg2addnc_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XG)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XG @ ccitg2) @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccitg2) @ (cco @ (ccfv @ XF @ ccitg2) @ (ccfv @ XG @ ccitg2) @ ccaddc)))))))))))).
