...
thf(adf_mi_ax,axiom,(cwceq @ ccmi @ (ccres @ ccomu @ (ccxp @ ccnpi @ ccnpi)))).
thf(cmulpiord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmi) @ (cco @ XA2 @ XB2 @ ccomu)))))).
