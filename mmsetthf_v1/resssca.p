...
thf(cresssca_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwceq @ XF @ (ccfv @ XG @ ccsca)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ XF @ (ccfv @ XH @ ccsca))))))))))).
