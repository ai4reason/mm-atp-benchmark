...
thf(cioorcl2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwne @ (cco @ XA2 @ XB2 @ ccioo) @ cc0) @ (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccovol) @ ccr)) @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)))))).
