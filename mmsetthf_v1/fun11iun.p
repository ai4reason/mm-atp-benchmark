...
thf(afun11uni_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xf1:$i] : (cwa @ (cwa @ (cwfun @ (ccv @ Xf1)) @ (cwfun @ (cccnv @ (ccv @ Xf1)))) @ (cwral @ (^ [Xg1:$i] : (cwo @ (cwss @ (ccv @ Xf1) @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xf1)))) @ (^ [Xg1:$i] : XA2)))) @ (^ [Xf1:$i] : XA2)) @ (cwa @ (cwfun @ (ccuni @ XA2)) @ (cwfun @ (cccnv @ (ccuni @ XA2))))))).
...
thf(cfun11iun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xy1))))) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwf1 @ (XD @ Xx3 @ Xy1) @ (XS @ Xy1) @ (XB2 @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwo @ (cwss @ (XB2 @ Xx3) @ (XC @ Xy1)) @ (cwss @ (XC @ Xy1) @ (XB2 @ Xx3)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)) @ (cwf1 @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1))) @ (XS @ Xy1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
