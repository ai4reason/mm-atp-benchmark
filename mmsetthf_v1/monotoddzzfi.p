...
thf(aelznn_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccz) @ (cwa @ (cwcel @ XN @ ccr) @ (cwo @ (cwcel @ XN @ ccn) @ (cwcel @ (ccneg @ XN) @ ccn0)))))).
...
thf(cmonotoddzzfi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccz)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccz)) @ (cwceq @ (ccfv @ (ccneg @ (ccv @ Xx3)) @ XF) @ (ccneg @ (ccfv @ (ccv @ Xx3) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ ccn0) @ (cwcel @ (ccv @ Xy1) @ ccn0)) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ cclt))))) => (cwi @ (cw3a @ Xph @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ cclt))))))))))).
