...
thf(a_3dec_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => (cwceq @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ (cco @ (cco @ (cco @ (cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ (ccdc @ cc1 @ ccc0) @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
...
thf(asq10e99m1_thm,axiom,(cwceq @ (cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) @ (cco @ (ccdc @ cc9 @ cc9) @ cc1 @ ccaddc))).
...
thf(aadd4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwcel @ XD @ ccc))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccaddc) @ (cco @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XD @ ccaddc) @ ccaddc)))))))).
...
thf(c_3dvds2dec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => (cwb @ (cwbr @ cc3 @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ ccdvds) @ (cwbr @ cc3 @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccaddc) @ ccdvds))))))))).
