...
thf(cssfiunibd_b1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ (ccuni @ XA2))) @ (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xy1) @ ccle)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : ccr)))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwss @ (XC @ Xy1 @ Xz) @ (ccuni @ XA2))))) => (cwi @ Xph @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xy1) @ ccle)) @ (^ [Xz:$i] : (XC @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : ccr)))))))))))).
