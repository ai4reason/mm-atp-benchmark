...
thf(conzsl_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccon0) @ (cw3o @ (cwceq @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)) @ (cwa @ (cwcel @ XA2 @ ccvv) @ (cwlim @ XA2)))))).
