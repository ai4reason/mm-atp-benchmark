...
thf(clesub3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XX @ XC @ ccaddc) @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XB2 @ XX @ ccle)) => (cwi @ Xph @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ ccle)))))))))))))).
