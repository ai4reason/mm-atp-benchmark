...
thf(aeqleltd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwn @ (cwbr @ XA2 @ XB2 @ cclt))))))))))).
...
thf(a_3adantl2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) => (cwi @ (cwa @ (cw3a @ Xph @ Xta @ Xps) @ Xch) @ Xth)))))))).
...
thf(aiocgtlb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))) @ (cwbr @ XA2 @ XC @ cclt)))))).
...
thf(aeliocd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XC @ cclt)) => ((cwi @ Xph @ (cwbr @ XC @ XB2 @ ccle)) => (cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))))))))))))).
...
thf(altsub1dd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin) @ cclt))))))))))).
...
thf(altadd1dd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ cclt))))))))))).
...
thf(aiocleub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))) @ (cwbr @ XC @ XB2 @ ccle)))))).
...
thf(afzolb_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwcel @ XM @ (cco @ XM @ XN @ ccfzo)) @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwbr @ XM @ XN @ cclt)))))).
...
thf(anegsubdid_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccneg @ (cco @ XA2 @ XB2 @ ccmin)) @ (cco @ (ccneg @ XA2) @ XB2 @ ccaddc))))))))).
...
thf(asubsub23d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmin) @ XC) @ (cwceq @ (cco @ XA2 @ XC @ ccmin) @ XB2))))))))))).
...
thf(aelfzfzo_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwcel @ XA2 @ (cco @ XM @ XN @ ccfzo)) @ (cwa @ (cwcel @ XA2 @ (cco @ XM @ XN @ ccfz)) @ (cwbr @ XA2 @ XN @ cclt))))))).
...
thf(aicoltub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) @ (cwbr @ XC @ XB2 @ cclt)))))).
...
thf(aicogelb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) @ (cwbr @ XA2 @ XC @ ccle)))))).
thf(cfourierdlem41_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ (XA2 @ Xy1 @ Xi @ Xk) @ ccr))))))) => ((! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ XB2 @ ccr)))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwbr @ (XA2 @ Xy1 @ Xi @ Xk) @ XB2 @ cclt))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XT @ Xi @ Xm @ Xp) @ (cco @ XB2 @ (XA2 @ Xy1 @ Xi @ Xk) @ ccmin))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (Xph @ Xm @ Xp) @ (cwcel @ (ccv @ Xx3) @ (XD @ Xm @ Xp)) @ (cwcel @ (ccv @ Xk) @ ccz)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (XT @ Xi @ Xm @ Xp) @ ccmul) @ ccaddc) @ (XD @ Xm @ Xp)))))))) => ((! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ (XX @ Xm @ Xp) @ ccr)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XZ @ Xi @ Xm @ Xp) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ (XT @ Xi @ Xm @ Xp) @ ccdiv) @ ccfl) @ (XT @ Xi @ Xm @ Xp) @ ccmul))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xx3 @ Xm @ Xp) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (XZ @ Xi @ Xm @ Xp)) @ ccaddc)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XP @ Xx3 @ Xy1 @ Xi @ Xk @ Xm @ Xp) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : (cwa @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (XA2 @ Xy1 @ Xi @ Xk)) @ (cwceq @ (ccfv @ (ccv @ Xm) @ (ccv @ Xp)) @ XB2)) @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ (XM @ Xx3) @ ccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ (XQ @ Xx3 @ Xm) @ (ccfv @ (XM @ Xx3) @ (XP @ Xx3 @ Xy1 @ Xi @ Xk @ Xm @ Xp)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xm @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo))) @ (cwss @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xx3 @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xm)) @ ccioo) @ (XD @ Xm @ Xp))))))) => (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwa @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xy1) @ (XX @ Xm @ Xp) @ cclt) @ (cwss @ (cco @ (ccv @ Xy1) @ (XX @ Xm @ Xp) @ ccioo) @ (XD @ Xm @ Xp)))) @ (^ [Xy1:$i] : ccr)) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (XX @ Xm @ Xp) @ (ccv @ Xy1) @ cclt) @ (cwss @ (cco @ (XX @ Xm @ Xp) @ (ccv @ Xy1) @ ccioo) @ (XD @ Xm @ Xp)))) @ (^ [Xy1:$i] : ccr)))))))))))))))))))))))))))))).
