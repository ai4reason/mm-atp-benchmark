...
thf(cphtpyi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwa @ (cwceq @ (cco @ ccc0 @ XA2 @ XH) @ (ccfv @ ccc0 @ XF)) @ (cwceq @ (cco @ cc1 @ XA2 @ XH) @ (ccfv @ cc1 @ XF)))))))))))))).
