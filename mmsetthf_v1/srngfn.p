...
thf(csrngfn_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_as:($i > $o)] : ((cwceq @ XR @ (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (ccsn @ (ccop @ (ccfv @ ccnx @ ccstv) @ Xc_as)))) => (cwbr @ XR @ (ccop @ cc1 @ cc4) @ ccstr)))))))).
