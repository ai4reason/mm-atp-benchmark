...
thf(cseqcl_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xy1) @ (ccfv @ XM @ ccuz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XM @ (XN @ Xy1) @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XN @ Xy1) @ (ccseq @ Xc_pl @ XF @ XM)) @ XS))))))))))))).
