...
thf(ccnvimamptfin_conj,conjecture,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XN @ ccfn))) => (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (ccima @ (cccnv @ (ccmpt @ (^ [Xp:$i] : XN) @ (^ [Xp:$i] : (XX @ Xp)))) @ (XY @ Xp)) @ ccfn))))))))).
