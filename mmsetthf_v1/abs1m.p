...
thf(cabs1m_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cc1) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ (cco @ (ccv @ Xx3) @ XA2 @ ccmul)))) @ (^ [Xx3:$i] : ccc))))).
