...
thf(ardglimg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccdm @ (ccrdg @ XF @ XA2))) @ (cwlim @ XB2)) @ (cwceq @ (ccfv @ XB2 @ (ccrdg @ XF @ XA2)) @ (ccuni @ (ccima @ (ccrdg @ XF @ XA2) @ XB2)))))))).
...
thf(cr1limg_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccr1)) @ (cwlim @ XA2)) @ (cwceq @ (ccfv @ XA2 @ ccr1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccr1))))))).
