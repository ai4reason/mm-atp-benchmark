...
thf(adf_1stc_ax,axiom,(cwceq @ cc1stc @ (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xy1) @ ccom @ ccdom) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xx3) @ (ccuni @ (ccin @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xz))))))) @ (^ [Xz:$i] : (ccv @ Xj))))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xj))))) @ (^ [Xx3:$i] : (ccuni @ (ccv @ Xj))))) @ (^ [Xj:$i] : cctop)))).
thf(cis1stc_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XX @ Xy1 @ Xz) @ (ccuni @ XJ)))) => (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwcel @ XJ @ cc1stc) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xy1) @ ccom @ ccdom) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xx3) @ (ccuni @ (ccin @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xz))))))) @ (^ [Xz:$i] : XJ)))) @ (^ [Xy1:$i] : (ccpw @ XJ)))) @ (^ [Xx3:$i] : (XX @ Xy1 @ Xz))))))))))).
