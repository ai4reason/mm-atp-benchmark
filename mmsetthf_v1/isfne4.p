...
thf(aisfne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (ccuni @ XA2))) => ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (ccuni @ XB2))) => (! [Xx3:$i] : (cwi @ (cwcel @ XB2 @ XC) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwa @ (cwceq @ (XX @ Xx3) @ (XY @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccuni @ (ccin @ XB2 @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XA2)))))))))))))).
...
thf(cisfne4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwb @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwa @ (cwceq @ XX @ XY) @ (cwss @ XA2 @ (ccfv @ XB2 @ cctg))))))))))).
