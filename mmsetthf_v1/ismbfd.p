...
thf(aismbf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ ccr @ XF) @ (cwb @ (cwcel @ XF @ ccmbf) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ (ccdm @ ccvol))) @ (^ [Xx3:$i] : (ccrn @ ccioo)))))))).
thf(cismbfd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3) @ ccr @ XF))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccxr)) @ (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccxr)) @ (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccdm @ ccvol)))) => (cwi @ Xph @ (cwcel @ XF @ ccmbf))))))))).
