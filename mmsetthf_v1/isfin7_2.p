...
thf(aonfin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwb @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XA2 @ ccom))))).
...
thf(cisfin7_2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ ccfin7) @ (cwi @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XA2 @ ccfn))))))).
