...
thf(cumgrnloopv_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwcel @ XM @ XW)) @ (cwi @ (cwceq @ (ccfv @ XX @ XE) @ (ccpr @ XM @ XN)) @ (cwne @ XM @ XN))))))))))).
