...
thf(cwwlksn_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ XG @ ccwwlksn) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ (cco @ XN @ cc1 @ ccaddc))) @ (^ [Xw:$i] : (ccfv @ XG @ ccwwlks)))))))).
