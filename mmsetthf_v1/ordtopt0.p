...
thf(aonsuct0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccsuc @ XA2) @ cct0)))).
thf(at0top_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cct0) @ (cwcel @ XJ @ cctop)))).
thf(cordtopt0_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cword @ XJ) @ (cwb @ (cwcel @ XJ @ cctop) @ (cwcel @ XJ @ cct0))))).
