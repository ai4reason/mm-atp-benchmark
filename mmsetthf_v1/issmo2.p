...
thf(cissmo2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwf @ (XA2 @ Xy1) @ (XB2 @ Xx3 @ Xy1) @ XF) @ (cwi @ (cw3a @ (cwss @ (XB2 @ Xx3 @ Xy1) @ ccon0) @ (cword @ (XA2 @ Xy1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) @ (cwsmo @ XF))))))))).
