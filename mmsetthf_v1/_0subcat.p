...
thf(a_0ssc_thm,axiom,(! [XC:($i > $o)] : (cwi @ (cwcel @ XC @ cccat) @ (cwbr @ cc0 @ (ccfv @ XC @ cchomf) @ ccssc)))).
...
thf(c_0subcat_conj,conjecture,(! [XC:($i > $o)] : (cwi @ (cwcel @ XC @ cccat) @ (cwcel @ cc0 @ (ccfv @ XC @ ccsubc))))).
