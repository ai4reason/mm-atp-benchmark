...
thf(apc0_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwceq @ (cco @ XP @ ccc0 @ ccpc) @ ccpnf)))).
...
thf(apcqcl_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XN @ ccq) @ (cwne @ XN @ ccc0))) @ (cwcel @ (cco @ XP @ XN @ ccpc) @ ccz))))).
thf(cpcxcl_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccq)) @ (cwcel @ (cco @ XP @ XN @ ccpc) @ ccxr))))).
