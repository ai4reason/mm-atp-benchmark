...
thf(aofldfld_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccofld) @ (cwcel @ XF @ ccfield)))).
...
thf(aofldtos_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccofld) @ (cwcel @ XF @ cctos)))).
...
thf(cofldchr_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccofld) @ (cwceq @ (ccfv @ XF @ ccchr) @ ccc0)))).
