...
thf(apmatcollpw3fi1lem1_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xl:$i] : (cwceq @ (XP @ Xl) @ (ccfv @ XR @ ccpl1))) => ((! [Xl:$i] : (cwceq @ (XC @ Xl) @ (cco @ XN @ (XP @ Xl) @ ccmat))) => ((! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XC @ Xl) @ ccbs))) => ((! [Xn:$i] : (! [Xl:$i] : (cwceq @ (Xc_as @ Xn @ Xl) @ (ccfv @ (XC @ Xl) @ ccvsca)))) => ((! [Xl:$i] : (cwceq @ (Xc_ex @ Xl) @ (ccfv @ (ccfv @ (XP @ Xl) @ ccmgp) @ ccmg))) => ((! [Xl:$i] : (cwceq @ (XX @ Xl) @ (ccfv @ XR @ ccv1))) => ((! [Xn:$i] : (! [Xl:$i] : (cwceq @ (XT @ Xn @ Xl) @ (cco @ XN @ XR @ ccmat2pmat)))) => ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (cco @ XN @ XR @ ccmat))) => ((! [Xn:$i] : (cwceq @ XD @ (ccfv @ (XA2 @ Xn) @ ccbs))) => ((! [Xn:$i] : (! [Xl:$i] : (cwceq @ (Xc_0 @ Xn @ Xl) @ (ccfv @ (XA2 @ Xn) @ cc0g)))) => ((! [Xn:$i] : (! [Xl:$i] : (cwceq @ (XH @ Xn @ Xl) @ (ccmpt @ (^ [Xl:$i] : (cco @ ccc0 @ cc1 @ ccfz)) @ (^ [Xl:$i] : (ccif @ (cwceq @ (ccv @ Xl) @ ccc0) @ (ccfv @ ccc0 @ XG) @ (Xc_0 @ Xn @ Xl))))))) => (! [Xl:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwcel @ XG @ (cco @ XD @ (ccsn @ ccc0) @ ccmap)) @ (cwceq @ XM @ (cco @ (XC @ Xl) @ (ccmpt @ (^ [Xn:$i] : (ccsn @ ccc0)) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ (XX @ Xl) @ (Xc_ex @ Xl)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XG) @ (XT @ Xn @ Xl)) @ (Xc_as @ Xn @ Xl)))) @ ccgsu))) @ (cwceq @ XM @ (cco @ (XC @ Xl) @ (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ cc1 @ ccfz)) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ (XX @ Xl) @ (Xc_ex @ Xl)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XH @ Xn @ Xl)) @ (XT @ Xn @ Xl)) @ (Xc_as @ Xn @ Xl)))) @ ccgsu))))))))))))))))))))))))))))))).
