...
thf(a_2exp6_thm,axiom,(cwceq @ (cco @ cc2 @ cc6 @ ccexp) @ (ccdc @ cc6 @ cc4))).
...
thf(a_10p10e20_thm,axiom,(cwceq @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc1 @ ccc0) @ ccaddc) @ (ccdc @ cc2 @ ccc0))).
...
thf(c_4001lem1_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => (cwceq @ (cco @ (cco @ cc2 @ (ccdc @ (ccdc @ cc2 @ ccc0) @ ccc0) @ ccexp) @ XN @ ccmo) @ (cco @ (ccdc @ (ccdc @ cc9 @ ccc0) @ cc2) @ XN @ ccmo))))).
