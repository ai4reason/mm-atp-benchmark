...
thf(as2cl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwcel @ (ccs2 @ XA2 @ XB2) @ (ccword @ XX))))))).
...
thf(cs3tpop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS)) @ (cwceq @ (ccs3 @ XA2 @ XB2 @ XC) @ (cctp @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2) @ (ccop @ cc2 @ XC))))))))).
