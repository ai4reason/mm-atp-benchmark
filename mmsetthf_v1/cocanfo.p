...
thf(ccocanfo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwfo @ XA2 @ XB2 @ XF) @ (cwfn @ XG @ XB2) @ (cwfn @ XH @ XB2)) @ (cwceq @ (cccom @ XG @ XF) @ (cccom @ XH @ XF))) @ (cwceq @ XG @ XH)))))))).
