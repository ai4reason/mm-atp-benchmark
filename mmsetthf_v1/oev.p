...
thf(adf_oexp_ax,axiom,(cwceq @ ccoe @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccon0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccon0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ (ccdif @ cc1o @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xy1) @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ ccomu))) @ cc1o)))))))).
...
thf(coev_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (XB2 @ Xx3) @ ccon0)) @ (cwceq @ (cco @ XA2 @ (XB2 @ Xx3) @ ccoe) @ (ccif @ (cwceq @ XA2 @ cc0) @ (ccdif @ cc1o @ (XB2 @ Xx3)) @ (ccfv @ (XB2 @ Xx3) @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccomu))) @ cc1o))))))))).
