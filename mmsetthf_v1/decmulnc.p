...
thf(cdecmulnc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => (cwceq @ (cco @ XN @ (ccdc @ XA2 @ XB2) @ ccmul) @ (ccdc @ (cco @ XN @ XA2 @ ccmul) @ (cco @ XN @ XB2 @ ccmul)))))))))).
