...
thf(aswrd2lsw_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ cclt)) @ (cwceq @ (cco @ XW @ (ccop @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (ccs2 @ (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW) @ (ccfv @ XW @ cclsw))))))).
...
thf(as2eq2s1eq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XD @ XV))) @ (cwb @ (cwceq @ (ccs2 @ XA2 @ XB2) @ (ccs2 @ XC @ XD)) @ (cwa @ (cwceq @ (ccs1 @ XA2) @ (ccs1 @ XC)) @ (cwceq @ (ccs1 @ XB2) @ (ccs1 @ XD))))))))))).
...
thf(c_2swrd2eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ cclt)) @ (cwb @ (cwceq @ XW @ XU) @ (cwa @ (cwceq @ (ccfv @ XW @ cchash) @ (ccfv @ XU @ cchash)) @ (cw3a @ (cwceq @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin)) @ ccsubstr) @ (cco @ XU @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin)) @ ccsubstr)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW) @ (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XU)) @ (cwceq @ (ccfv @ XW @ cclsw) @ (ccfv @ XU @ cclsw)))))))))).
