...
thf(cmrcuni_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XU @ (ccpw @ XX))) @ (cwceq @ (ccfv @ (ccuni @ XU) @ XF) @ (ccfv @ (ccuni @ (ccima @ XF @ XU)) @ XF))))))))).
