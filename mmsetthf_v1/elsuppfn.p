...
thf(celsuppfn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XX) @ (cwcel @ XX @ XV) @ (cwcel @ XZ @ XW)) @ (cwb @ (cwcel @ XS @ (cco @ XF @ XZ @ ccsupp)) @ (cwa @ (cwcel @ XS @ XX) @ (cwne @ (ccfv @ XS @ XF) @ XZ))))))))))).
