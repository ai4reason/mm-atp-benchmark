...
thf(cprsss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cwa @ (cwcel @ XK @ ccpreset) @ (cwss @ XA2 @ XB2)) @ (cwceq @ (ccin @ Xc_le @ (ccxp @ XA2 @ XA2)) @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XA2 @ XA2))))))))))).
