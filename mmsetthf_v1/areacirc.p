...
thf(aareacirclem5_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XS @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwcel @ (ccv @ Xy1) @ ccr)) @ (cwbr @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ XR @ cc2 @ ccexp) @ ccle)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle) @ (cwcel @ (ccv @ Xt) @ ccr)) @ (cwceq @ (ccima @ (XS @ Xx3 @ Xy1) @ (ccsn @ (ccv @ Xt))) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xt) @ ccabs) @ XR @ ccle) @ (cco @ (ccneg @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt)) @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccicc) @ cc0)))))))))).
...
thf(aareacirclem3_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle)) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ cc2 @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul))) @ ccibl)))).
...
thf(aareacirclem2_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle)) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
...
thf(aareacirclem4_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccrp) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ ccasin) @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ (ccfv @ (cco @ cc1 @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul) @ ccaddc) @ ccmul))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
...
thf(aasin1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccasin) @ (cco @ ccpi @ cc2 @ ccdiv))).
...
thf(aasinneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (ccneg @ XA2) @ ccasin) @ (ccneg @ (ccfv @ XA2 @ ccasin)))))).
...
thf(apidiv2halves_thm,axiom,(cwceq @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccaddc) @ ccpi)).
...
thf(careacirc_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XS @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwcel @ (ccv @ Xy1) @ ccr)) @ (cwbr @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ XR @ cc2 @ ccexp) @ ccle)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle)) @ (cwceq @ (ccfv @ (XS @ Xx3 @ Xy1) @ ccarea) @ (cco @ ccpi @ (cco @ XR @ cc2 @ ccexp) @ ccmul))))))))).
