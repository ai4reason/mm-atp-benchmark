...
thf(adchr1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ Xc_1 @ (ccfv @ XG @ cc0g)) => ((cwceq @ XU @ (ccfv @ XZ @ ccui)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ Xc_1) @ cc1)))))))))))))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(adchreq_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccfv @ (XN @ Xk) @ ccdchr))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xk) @ cczn))) => ((! [Xk:$i] : (cwceq @ (XD @ Xk) @ (ccfv @ (XG @ Xk) @ ccbs))) => ((cwceq @ XU @ (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xk)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XY @ (XD @ Xk)))) => (cwi @ Xph @ (cwb @ (cwceq @ XX @ XY) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ XX) @ (ccfv @ (ccv @ Xk) @ XY))) @ (^ [Xk:$i] : XU))))))))))))))))))).
...
thf(cdchrinv_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XX @ XD)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ XI) @ (cccom @ cccj @ XX)))))))))))))).
