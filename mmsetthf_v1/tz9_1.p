...
thf(ctz9_1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwex @ (^ [Xx3:$i] : (cw3a @ (cwss @ XA2 @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xx3)) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwss @ XA2 @ (ccv @ Xy1)) @ (cwtr @ (ccv @ Xy1))) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))))))))))).
