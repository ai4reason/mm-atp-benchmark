...
thf(caxunprim_conj,conjecture,(! [Xz:$i] : (cwn @ (cwal @ (^ [Xx3:$i] : (cwn @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))))).
