...
thf(crrndstprj1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ ccr @ XI @ ccmap)) => ((cwceq @ XM @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (cwi @ (cwa @ (cwa @ (cwcel @ XI @ ccfn) @ (cwcel @ XA2 @ XI)) @ (cwa @ (cwcel @ XF @ XX) @ (cwcel @ XG @ XX))) @ (cwbr @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG) @ XM) @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ ccle))))))))))).
