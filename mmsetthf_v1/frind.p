...
thf(afrmin_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwa @ (cwfr @ (XA2 @ Xy1) @ XR) @ (cwse @ (XA2 @ Xy1) @ XR)) @ (cwa @ (cwss @ XB2 @ (XA2 @ Xy1)) @ (cwne @ XB2 @ cc0))) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccpred @ XB2 @ XR @ (ccv @ Xy1)) @ cc0)) @ (^ [Xy1:$i] : XB2)))))))).
...
thf(cfrind_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwfr @ XA2 @ XR) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwss @ XB2 @ XA2) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2))) @ (^ [Xy1:$i] : XA2)))) @ (cwceq @ XA2 @ XB2)))))).
