...
thf(adivmulass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwa @ (cwcel @ XD @ ccc) @ (cwne @ XD @ ccc0))) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XD @ ccdiv) @ ccmul) @ XC @ ccmul) @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XC @ XD @ ccdiv) @ ccmul)))))))).
...
thf(cdivmulasscom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwa @ (cwcel @ XD @ ccc) @ (cwne @ XD @ ccc0))) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XD @ ccdiv) @ ccmul) @ XC @ ccmul) @ (cco @ XB2 @ (cco @ (cco @ XA2 @ XC @ ccmul) @ XD @ ccdiv) @ ccmul)))))))).
