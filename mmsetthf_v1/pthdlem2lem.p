...
thf(cpthdlem2lem_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ (ccword @ ccvv))) => ((cwceq @ XR @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((cwi @ Xph @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwne @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwne @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => (cwi @ (cw3a @ Xph @ (cwcel @ (ccfv @ XP @ cchash) @ ccn) @ (cwo @ (cwceq @ XI @ ccc0) @ (cwceq @ XI @ XR))) @ (cwnel @ (ccfv @ XI @ XP) @ (ccima @ XP @ (cco @ cc1 @ XR @ ccfzo)))))))))))).
