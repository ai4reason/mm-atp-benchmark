...
thf(angtmnft_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwceq @ XA2 @ ccmnf) @ (cwn @ (cwbr @ ccmnf @ XA2 @ cclt)))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(axrrebnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwcel @ XA2 @ ccr) @ (cwa @ (cwbr @ ccmnf @ XA2 @ cclt) @ (cwbr @ XA2 @ ccpnf @ cclt)))))).
thf(cxblpnf_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XA2 @ (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl))) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ (cco @ XP @ XA2 @ XD) @ ccr))))))))).
