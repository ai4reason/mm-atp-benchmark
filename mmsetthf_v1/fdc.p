...
thf(cfdc_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [Xta:($i > ($i > ($i > $o)))] : (! [Xet:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((cwcel @ XM @ ccz) => ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xf1 @ Xk) @ (ccfv @ XM @ ccuz)))) => ((cwceq @ XN @ (cco @ XM @ cc1 @ ccaddc)) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwceq @ (ccv @ Xa) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xn @ Xa @ Xb) @ (Xps @ Xf1 @ Xk @ Xn @ Xb)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwi @ (cwceq @ (ccv @ Xb) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))) @ (cwb @ (Xps @ Xf1 @ Xk @ Xn @ Xb) @ (Xch @ Xf1 @ Xk))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwceq @ (ccv @ Xa) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))) @ (cwb @ (Xth @ Xk @ Xa @ Xb) @ (Xta @ Xf1 @ Xk @ Xn)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xet @ Xf1 @ Xk @ Xn) @ (cwcel @ (XC @ Xk @ Xa @ Xb) @ (XA2 @ Xk)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xet @ Xf1 @ Xk @ Xn) @ (cwfr @ (XA2 @ Xk) @ (XR @ Xf1 @ Xk @ Xn)))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xet @ Xf1 @ Xk @ Xn) @ (cwcel @ (ccv @ Xa) @ (XA2 @ Xk))) @ (cwo @ (Xth @ Xk @ Xa @ Xb) @ (cwrex @ (^ [Xb:$i] : (Xph @ Xn @ Xa @ Xb)) @ (^ [Xb:$i] : (XA2 @ Xk)))))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwa @ (Xet @ Xf1 @ Xk @ Xn) @ (Xph @ Xn @ Xa @ Xb)) @ (cwa @ (cwcel @ (ccv @ Xa) @ (XA2 @ Xk)) @ (cwcel @ (ccv @ Xb) @ (XA2 @ Xk)))) @ (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ (XR @ Xf1 @ Xk @ Xn)))))))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xet @ Xf1 @ Xk @ Xn) @ (cwrex @ (^ [Xn:$i] : (cwex @ (^ [Xf1:$i] : (cw3a @ (cwf @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (XA2 @ Xk) @ (ccv @ Xf1)) @ (cwa @ (cwceq @ (ccfv @ XM @ (ccv @ Xf1)) @ (XC @ Xk @ Xa @ Xb)) @ (Xta @ Xf1 @ Xk @ Xn)) @ (cwral @ (^ [Xk:$i] : (Xch @ Xf1 @ Xk)) @ (^ [Xk:$i] : (cco @ XN @ (ccv @ Xn) @ ccfz))))))) @ (^ [Xn:$i] : (XZ @ Xf1 @ Xk))))))))))))))))))))))))))))))))).
