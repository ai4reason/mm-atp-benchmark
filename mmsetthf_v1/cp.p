...
thf(acplem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwne @ (XB2 @ Xx3) @ cc0) @ (cwne @ (ccin @ (XB2 @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(ccp_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xz:$i] : (cwex @ (^ [Xw:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xw))))) @ (^ [Xx3:$i] : (ccv @ Xz)))))))).
