...
thf(afprodeq0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XN @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xk) @ XN)) @ (cwceq @ (XA2 @ Xk) @ ccc0))) => (cwi @ (cwa @ Xph @ (cwcel @ XK @ (ccfv @ XN @ ccuz))) @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XK @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccc0))))))))))))).
...
thf(cbcc0_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XK @ ccn0)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XC @ XK @ ccbcc) @ ccc0) @ (cwcel @ XC @ (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))))))))).
