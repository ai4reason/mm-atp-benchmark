...
thf(ccosargd_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwne @ XX @ ccc0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ (ccfv @ XX @ cclog) @ ccim) @ cccos) @ (cco @ (ccfv @ XX @ ccre) @ (ccfv @ XX @ ccabs) @ ccdiv)))))))).
