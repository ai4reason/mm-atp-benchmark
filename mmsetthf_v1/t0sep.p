...
thf(ct0sep_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cct0) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwb @ (cwcel @ XA2 @ (ccv @ Xx3)) @ (cwcel @ XB2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ)) @ (cwceq @ XA2 @ XB2))))))))).
