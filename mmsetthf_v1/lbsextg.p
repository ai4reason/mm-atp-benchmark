...
thf(albsextlem4_thm,axiom,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xs1:$i] : (cwceq @ (XV @ Xs1) @ (ccfv @ (XW @ Xz @ Xs1) @ ccbs)))) => ((! [Xz:$i] : (! [Xs1:$i] : (cwceq @ (XJ @ Xz @ Xs1) @ (ccfv @ (XW @ Xz @ Xs1) @ cclbs)))) => ((! [Xz:$i] : (! [Xs1:$i] : (cwceq @ (XN @ Xs1) @ (ccfv @ (XW @ Xz @ Xs1) @ cclspn)))) => ((! [Xz:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XW @ Xz @ Xs1) @ cclvec)))) => ((! [Xz:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xz) @ (cwss @ (XC @ Xs1) @ (XV @ Xs1))))) => ((! [Xz:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (XC @ Xs1) @ (ccsn @ (ccv @ Xx3))) @ (XN @ Xs1))))) @ (^ [Xx3:$i] : (XC @ Xs1)))))) => ((! [Xz:$i] : (! [Xs1:$i] : (cwceq @ (XS @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwss @ (XC @ Xs1) @ (ccv @ Xz)) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (ccv @ Xz) @ (ccsn @ (ccv @ Xx3))) @ (XN @ Xs1))))) @ (^ [Xx3:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccpw @ (XV @ Xs1))))))) => ((! [Xz:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (ccpw @ (XV @ Xs1)) @ (ccdm @ cccrd))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwrex @ (^ [Xs1:$i] : (cwss @ (XC @ Xs1) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (XJ @ Xz @ Xs1))))))))))))))))))))).
