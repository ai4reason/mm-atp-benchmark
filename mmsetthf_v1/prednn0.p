...
thf(apreduz_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (ccpred @ (ccfv @ XM @ ccuz) @ cclt @ XN) @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))))).
thf(cprednn0_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccpred @ ccn0 @ cclt @ XN) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))).
