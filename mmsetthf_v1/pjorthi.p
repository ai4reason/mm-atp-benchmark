...
thf(cpjorthi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwi @ (cwcel @ XH @ ccch) @ (cwceq @ (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) @ ccsp) @ ccc0)))))))).
