...
thf(apsr1crng_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccps1)) => (cwi @ (cwcel @ XR @ cccrg) @ (cwcel @ XS @ cccrg)))))).
...
thf(cply1crng_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => (cwi @ (cwcel @ XR @ cccrg) @ (cwcel @ XP @ cccrg)))))).
