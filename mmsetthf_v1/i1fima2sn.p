...
thf(ci1fima2sn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XA2 @ (ccdif @ XB2 @ (ccsn @ ccc0)))) @ (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ XA2)) @ ccvol) @ ccr)))))).
