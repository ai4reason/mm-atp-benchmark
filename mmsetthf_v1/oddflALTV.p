...
thf(azofldiv2ALTV_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccodd) @ (cwceq @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv))))).
...
thf(coddflALTV_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccodd) @ (cwceq @ XK @ (cco @ (cco @ cc2 @ (ccfv @ (cco @ XK @ cc2 @ ccdiv) @ ccfl) @ ccmul) @ cc1 @ ccaddc))))).
