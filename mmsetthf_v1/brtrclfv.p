...
thf(abrintclab_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwbr @ XA2 @ XB2 @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))) @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccop @ XA2 @ XB2) @ (ccv @ Xx3)))))))))).
...
thf(cbrtrclfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xr:$i] : (cwi @ (cwcel @ XR @ (XV @ Xr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ (ccfv @ XR @ cctcl)) @ (cwal @ (^ [Xr:$i] : (cwi @ (cwa @ (cwss @ XR @ (ccv @ Xr)) @ (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr))) @ (cwbr @ XA2 @ XB2 @ (ccv @ Xr))))))))))))).
