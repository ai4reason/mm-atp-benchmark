...
thf(aleaddsub2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccle) @ (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccmin) @ ccle))))))))))).
...
thf(aiblconst_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ ccc)) @ (cwcel @ (ccxp @ XA2 @ (ccsn @ XB2)) @ ccibl))))).
...
thf(citgsbtaddcnst_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => (cwi @ Xph @ (cwceq @ (ccdit @ (^ [Xs1:$i] : (cco @ XA2 @ XX @ ccmin)) @ (^ [Xs1:$i] : (cco @ XB2 @ XX @ ccmin)) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))) @ (ccdit @ (^ [Xt:$i] : XA2) @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))))))))))).
