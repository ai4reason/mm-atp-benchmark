...
thf(amoi_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xch))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ (XC @ Xx3)) @ (cwcel @ XB2 @ (XD @ Xx3))) @ (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwa @ Xps @ Xch)) @ (cwceq @ XA2 @ XB2))))))))))))).
...
thf(ahausnei2_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XJ @ ccha) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cwceq @ (ccin @ (ccv @ Xu) @ (ccv @ Xv)) @ cc0)) @ (^ [Xv:$i] : (ccfv @ (ccsn @ (ccv @ Xy1)) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xu:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)))))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))).
thf(chausflim_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccha) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xf1:$i] : (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XJ @ (ccv @ Xf1) @ ccflim))))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))).
