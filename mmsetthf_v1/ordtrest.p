...
thf(apsssdm2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cwcel @ XR @ ccps) @ (cwceq @ (ccdm @ (ccin @ XR @ (ccxp @ XA2 @ XA2))) @ (ccin @ XX @ XA2)))))))).
...
thf(cordtrest_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccps) @ (cwcel @ XA2 @ XV)) @ (cwss @ (ccfv @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccordt) @ (cco @ (ccfv @ XR @ ccordt) @ XA2 @ ccrest))))))).
