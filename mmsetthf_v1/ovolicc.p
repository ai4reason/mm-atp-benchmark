...
thf(aovolicc1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ cc1) @ (ccop @ XA2 @ XB2) @ (ccop @ ccc0 @ ccc0))))) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccovol) @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))))))).
...
thf(covolicc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccovol) @ (cco @ XB2 @ XA2 @ ccmin)))))).
