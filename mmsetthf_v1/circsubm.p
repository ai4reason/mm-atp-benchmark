...
thf(aefsubm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cce)))) => ((cwceq @ XG @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccrn @ XF) @ ccress)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ cccnfld @ ccsubg))) => (cwi @ Xph @ (cwcel @ (ccrn @ XF) @ (ccfv @ (ccfv @ cccnfld @ ccmgp) @ ccsubmnd))))))))))))).
...
thf(ccircsubm_conj,conjecture,(! [XC:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XC @ (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => ((cwceq @ XT @ (cco @ (ccfv @ cccnfld @ ccmgp) @ XC @ ccress)) => (cwcel @ XC @ (ccfv @ (ccfv @ cccnfld @ ccmgp) @ ccsubmnd))))))).
