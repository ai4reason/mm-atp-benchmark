...
thf(ahmeocls_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) @ (cwss @ XA2 @ XX)) @ (cwceq @ (ccfv @ (ccima @ XF @ XA2) @ (ccfv @ XK @ cccl)) @ (ccima @ XF @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)))))))))))).
...
thf(creghmph_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwbr @ XJ @ XK @ cchmph) @ (cwi @ (cwcel @ XJ @ ccreg) @ (cwcel @ XK @ ccreg)))))).
