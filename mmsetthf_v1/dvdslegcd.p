...
thf(cdvdslegcd_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwn @ (cwa @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)))) @ (cwi @ (cwa @ (cwbr @ XK @ XM @ ccdvds) @ (cwbr @ XK @ XN @ ccdvds)) @ (cwbr @ XK @ (cco @ XM @ XN @ ccgcd) @ ccle))))))).
