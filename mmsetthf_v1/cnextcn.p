...
thf(aclsss_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwss @ XT @ XS)) @ (cwss @ (ccfv @ XT @ (ccfv @ XJ @ cccl)) @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))))))))).
...
thf(acnextfvval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccuni @ XJ)) => ((cwceq @ XB2 @ (ccuni @ XK)) => ((cwi @ Xph @ (cwcel @ XJ @ cctop)) => ((cwi @ Xph @ (cwcel @ XK @ ccha)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XC)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ XC)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XC)) @ (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ XC)) @ (cwceq @ (ccfv @ XX @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext))) @ (ccuni @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)))))))))))))))))))))).
...
thf(ahausflf2_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwne @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ cc0)) @ (cwbr @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ cc1o @ ccen))))))))).
thf(aen1b_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwbr @ XA2 @ cc1o @ ccen) @ (cwceq @ XA2 @ (ccsn @ (ccuni @ XA2)))))).
thf(aflfnei_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwb @ (cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) @ (cwa @ (cwcel @ (XA2 @ Xs1) @ XX) @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xn))) @ (^ [Xs1:$i] : XL))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ (XA2 @ Xs1)) @ (ccfv @ XJ @ ccnei))))))))))))))).
...
thf(a_3an1rs_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ (cw3a @ Xph @ Xps @ Xch) @ Xth) @ Xta) => (cwi @ (cwa @ (cw3a @ Xph @ Xps @ Xth) @ Xch) @ Xta)))))))).
...
thf(aflimclsi_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XS @ XF) @ (cwss @ (cco @ XJ @ XF @ ccflim) @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))))))).
...
thf(acnextf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XC @ (ccuni @ XJ)) => ((cwceq @ XB2 @ (ccuni @ XK)) => ((cwi @ Xph @ (cwcel @ XJ @ cctop)) => ((cwi @ Xph @ (cwcel @ XK @ ccha)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XC)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ XC)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XC)) @ (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => (cwi @ Xph @ (cwf @ XC @ XB2 @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)))))))))))))))))))).
...
thf(acnnei_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop) @ (cwf @ XX @ XY @ XF)) @ (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ XF @ (ccv @ Xv)) @ (ccv @ Xw))) @ (^ [Xv:$i] : (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xw:$i] : (ccfv @ (ccsn @ (ccfv @ (ccv @ Xp) @ XF)) @ (ccfv @ XK @ ccnei))))) @ (^ [Xp:$i] : XX)))))))))))).
thf(ccnextcn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XC @ (ccuni @ XJ)) => ((cwceq @ XB2 @ (ccuni @ XK)) => ((cwi @ Xph @ (cwcel @ XJ @ cctop)) => ((cwi @ Xph @ (cwcel @ XK @ ccha)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XC)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ XC)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XC)) @ (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => ((cwi @ Xph @ (cwcel @ XK @ ccreg)) => (cwi @ Xph @ (cwcel @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)) @ (cco @ XJ @ XK @ cccn)))))))))))))))))))).
