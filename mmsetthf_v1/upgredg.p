...
thf(cupgredg_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XE @ Xa @ Xb) @ (ccfv @ XG @ ccedg)))) => (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XC @ (XE @ Xa @ Xb))) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ XC @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))))))))).
