...
thf(cmat1dimid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XO @ (ccop @ XE @ XE)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV)) @ (cwceq @ (ccfv @ XA2 @ ccur) @ (ccsn @ (ccop @ XO @ (ccfv @ XR @ ccur))))))))))))))).
