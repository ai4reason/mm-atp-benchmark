...
thf(ainn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwne @ (ccin @ XA2 @ XB2) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XB2)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(cqinioo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => (cwi @ Xph @ (cwb @ (cwceq @ (ccin @ ccq @ (cco @ XA2 @ XB2 @ ccioo)) @ cc0) @ (cwbr @ XB2 @ XA2 @ ccle))))))))).
