...
thf(cacsmapd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xf1) @ (ccfv @ (XX @ Xf1) @ ccacs)))) => ((! [Xf1:$i] : (cwceq @ XN @ (ccfv @ (XA2 @ Xf1) @ ccmrc))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwss @ XS @ (XX @ Xf1)))) => ((cwi @ Xph @ (cwss @ XT @ (ccfv @ XS @ XN))) => (cwi @ Xph @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XT @ (ccin @ (ccpw @ XS) @ ccfn) @ (ccv @ Xf1)) @ (cwss @ XT @ (ccfv @ (ccuni @ (ccrn @ (ccv @ Xf1))) @ XN))))))))))))))))).
