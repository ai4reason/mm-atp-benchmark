...
thf(asubneintr2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwne @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin)))))))))))).
...
thf(cnnfoctbdjlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwss @ (XA2 @ Xf1) @ ccn))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (XA2 @ Xf1) @ XX @ (XG @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwdisj @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccv @ Xy1))))) => ((! [Xf1:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwo @ (cwceq @ (ccv @ Xn) @ cc1) @ (cwn @ (cwcel @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XA2 @ Xf1)))) @ cc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XG @ Xf1))))))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwfo @ ccn @ (ccun @ XX @ (ccsn @ cc0)) @ (ccv @ Xf1)) @ (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))))))))))))))))))).
