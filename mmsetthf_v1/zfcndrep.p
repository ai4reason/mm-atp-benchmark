...
thf(czfcndrep_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (cwi @ (cwal @ (^ [Xw:$i] : (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))) @ (cwceq @ (ccv @ Xz) @ (ccv @ Xy1))))))))) @ (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwb @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwex @ (^ [Xw:$i] : (cwa @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))).
