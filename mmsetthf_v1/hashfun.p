...
thf(afidomdm_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccfn) @ (cwbr @ (ccdm @ XF) @ XF @ ccdom)))).
...
thf(chashfun_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccfn) @ (cwb @ (cwfun @ XF) @ (cwceq @ (ccfv @ XF @ cchash) @ (ccfv @ (ccdm @ XF) @ cchash)))))).
