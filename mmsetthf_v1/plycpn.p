...
thf(advnply_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn)) @ (ccfv @ ccc @ ccply))))))).
...
thf(aplycn_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XF @ (cco @ ccc @ ccc @ cccncf)))))).
...
thf(afncpn_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwss @ XS @ ccc) @ (cwfn @ (ccfv @ XS @ cccpn) @ ccn0)))).
...
thf(cplycpn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XF @ (ccint @ (ccrn @ (ccfv @ ccc @ cccpn)))))))).
