...
thf(aomndaddr_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XM @ ccple)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ (ccfv @ XM @ ccoppg) @ ccomnd) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) @ (cwbr @ XX @ XY @ Xc_le)) @ (cwbr @ (cco @ XZ @ XX @ Xc_pl) @ (cco @ XZ @ XY @ Xc_pl) @ Xc_le))))))))))))).
...
thf(comndadd2rd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XM @ ccple)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XM @ ccomnd)) => ((cwi @ Xph @ (cwcel @ XW @ XB2)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwbr @ XX @ XZ @ Xc_le)) => ((cwi @ Xph @ (cwbr @ XY @ XW @ Xc_le)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XM @ ccoppg) @ ccomnd)) => (cwi @ Xph @ (cwbr @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XW @ Xc_pl) @ Xc_le))))))))))))))))))))))).
