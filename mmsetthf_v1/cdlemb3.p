...
thf(acdlemg5_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xq:$i] : (cwceq @ (Xc_or @ Xq) @ (ccfv @ XK @ ccjn))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le)))) @ (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ XP @ (ccv @ Xq)) @ (cwn @ (cwbr @ (ccv @ Xq) @ XW @ Xc_le)))) @ (^ [Xq:$i] : XA2))))))))))))))).
