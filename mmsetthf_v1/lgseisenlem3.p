...
thf(advrid_thm,axiom,(! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XU)) @ (cwceq @ (cco @ XX @ XX @ Xc_dv) @ Xc_1))))))))))).
...
thf(clgseisenlem3_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwi @ Xph @ (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwi @ Xph @ (cwne @ XP @ XQ)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XR @ Xx3 @ Xy1) @ (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ XP @ ccmo)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XM @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XR @ Xx3 @ Xy1) @ ccexp) @ (XR @ Xx3 @ Xy1) @ ccmul) @ XP @ ccmo) @ cc2 @ ccdiv)))))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xy1) @ ccmul) @ ccmul) @ XP @ ccmo))) => ((! [Xy1:$i] : (cwceq @ (XY @ Xy1) @ (ccfv @ XP @ cczn))) => ((! [Xy1:$i] : (cwceq @ (XG @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccmgp))) => ((! [Xy1:$i] : (cwceq @ (XL @ Xy1) @ (ccfv @ (XY @ Xy1) @ cczrh))) => (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ (ccneg @ cc1) @ (XR @ Xx3 @ Xy1) @ ccexp) @ XQ @ ccmul) @ (XL @ Xy1)))) @ ccgsu) @ (ccfv @ (XY @ Xy1) @ ccur))))))))))))))))))))))).
