...
thf(ctz7_48_2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ (XA2 @ Xx3) @ (ccima @ XF @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0)) @ (cwfun @ (cccnv @ XF))))))).
