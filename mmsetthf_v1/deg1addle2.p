...
thf(cdeg1addle2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XY @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((cwi @ Xph @ (cwcel @ XL @ ccxr)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XF @ XD) @ XL @ ccle)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XG @ XD) @ XL @ ccle)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_pl) @ XD) @ XL @ ccle)))))))))))))))))))))).
