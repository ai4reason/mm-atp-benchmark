...
thf(csuppssof1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xv:$i] : (cwi @ Xph @ (cwss @ (cco @ (XA2 @ Xv) @ XY @ ccsupp) @ (XL @ Xv)))) => ((! [Xv:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xv) @ XR)) @ (cwceq @ (cco @ XY @ (ccv @ Xv) @ XO) @ XZ))) => ((! [Xv:$i] : (cwi @ Xph @ (cwf @ (XD @ Xv) @ (XV @ Xv) @ (XA2 @ Xv)))) => ((! [Xv:$i] : (cwi @ Xph @ (cwf @ (XD @ Xv) @ XR @ XB2))) => ((! [Xv:$i] : (cwi @ Xph @ (cwcel @ (XD @ Xv) @ (XW @ Xv)))) => ((! [Xv:$i] : (cwi @ Xph @ (cwcel @ XY @ (XU @ Xv)))) => (! [Xv:$i] : (cwi @ Xph @ (cwss @ (cco @ (cco @ (XA2 @ Xv) @ XB2 @ (ccof @ XO)) @ XZ @ ccsupp) @ (XL @ Xv))))))))))))))))))))))).
