...
thf(clinc0scn0_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccfv @ XM @ ccsca))) => ((! [Xx3:$i] : (cwceq @ Xc_0 @ (ccfv @ (XS @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (cwceq @ Xc_1 @ (ccfv @ (XS @ Xx3) @ ccur))) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XZ) @ Xc_1 @ Xc_0))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ XB2))) @ (cwceq @ (cco @ (XF @ Xx3) @ XV @ (ccfv @ XM @ cclinc)) @ XZ)))))))))))))))))).
