...
thf(advtaylp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))) => (cwi @ Xph @ (cwceq @ (cco @ ccc @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XB2 @ (cco @ XS @ XF @ cctayl)) @ ccdv) @ (cco @ XN @ XB2 @ (cco @ XS @ (cco @ XS @ XF @ ccdv) @ cctayl)))))))))))))))).
...
thf(cdvntaylp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))) => (cwi @ Xph @ (cwceq @ (ccfv @ XM @ (cco @ ccc @ (cco @ (cco @ XN @ XM @ ccaddc) @ XB2 @ (cco @ XS @ XF @ cctayl)) @ ccdvn)) @ (cco @ XN @ XB2 @ (cco @ XS @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)) @ cctayl)))))))))))))))))).
