...
thf(afopwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwfo @ XA2 @ XB2 @ XF)) @ (cwbr @ (ccpw @ XB2) @ (ccpw @ XA2) @ ccdom))))))).
...
thf(cpwdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ (ccpw @ XA2) @ (ccpw @ XB2) @ ccdom))))).
