...
thf(amapsnend_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ (ccsn @ XB2) @ ccmap) @ XA2 @ ccen)))))))))).
...
thf(cmpct_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwbr @ XA2 @ ccom @ ccdom)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmap) @ ccom @ ccdom)))))))).
