...
thf(a_2sqlem5_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XN @ Xw) @ ccn))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XP @ Xw) @ ccprime))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (cco @ (XN @ Xw) @ (XP @ Xw) @ ccmul) @ (XS @ Xw)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XP @ Xw) @ (XS @ Xw)))) => (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XN @ Xw) @ (XS @ Xw)))))))))))))).
