...
thf(axpimasn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XA2) @ (cwceq @ (ccima @ (ccxp @ XA2 @ XB2) @ (ccsn @ XX)) @ XB2)))))).
...
thf(cimasncld_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwa @ (cwcel @ XR @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cccld)) @ (cwcel @ XA2 @ XX))) @ (cwcel @ (ccima @ XR @ (ccsn @ XA2)) @ (ccfv @ XK @ cccld)))))))))).
