...
thf(adf_kb_ax,axiom,(cwceq @ cck @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : cchil)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : cchil)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt @ (^ [Xz:$i] : cchil) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ ccsp) @ (ccv @ Xx3) @ ccsm)))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aax_hilex_ax,axiom,(cwcel @ cchil @ ccvv)).
thf(ckbfval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ XA2 @ XB2 @ cck) @ (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccsp) @ XA2 @ ccsm)))))))).
