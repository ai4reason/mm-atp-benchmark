...
thf(csge0uzfsumgt_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XK @ ccz))) => ((cwceq @ XZ @ (ccfv @ XK @ ccuz)) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XC @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XC @ Xk) @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ cclt))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xm:$i] : (cwbr @ (XC @ Xk) @ (ccsu @ (cco @ XK @ (ccv @ Xm) @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk))) @ cclt)) @ (^ [Xm:$i] : XZ)))))))))))))))).
