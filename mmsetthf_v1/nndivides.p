...
thf(anndiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ XB2)) @ (^ [Xx3:$i] : ccn)) @ (cwcel @ (cco @ XB2 @ XA2 @ ccdiv) @ ccn)))))).
...
thf(cnndivides_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (ccv @ Xn) @ XM @ ccmul) @ XN)) @ (^ [Xn:$i] : ccn))))))).
