...
thf(aelincfzoext_thm,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XZ @ (cco @ XM @ XN @ ccfzo)) @ (cwcel @ XI @ ccn0)) @ (cwcel @ (cco @ XZ @ XI @ ccaddc) @ (cco @ XM @ (cco @ XN @ XI @ ccaddc) @ ccfzo)))))))).
...
thf(cccatalpha_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccword @ ccvv)) @ (cwcel @ XB2 @ (ccword @ ccvv))) @ (cwb @ (cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccword @ XS)) @ (cwa @ (cwcel @ XA2 @ (ccword @ XS)) @ (cwcel @ XB2 @ (ccword @ XS))))))))).
