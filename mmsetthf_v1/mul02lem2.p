...
thf(amul02lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwne @ (cco @ ccc0 @ XA2 @ ccmul) @ ccc0)) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ XB2 @ (cco @ XB2 @ XB2 @ ccaddc)))))).
...
thf(cmul02lem2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (cco @ ccc0 @ XA2 @ ccmul) @ ccc0)))).
