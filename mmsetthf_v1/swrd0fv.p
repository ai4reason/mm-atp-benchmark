...
thf(cswrd0fv_conj,conjecture,(! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) @ (cwcel @ XI @ (cco @ ccc0 @ XL @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XW @ (ccop @ ccc0 @ XL) @ ccsubstr)) @ (ccfv @ XI @ XW)))))))).
