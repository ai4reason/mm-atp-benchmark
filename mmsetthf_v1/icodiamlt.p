...
thf(cicodiamlt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) @ (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccico)))) @ (cwbr @ (ccfv @ (cco @ XC @ XD @ ccmin) @ ccabs) @ (cco @ XB2 @ XA2 @ ccmin) @ cclt))))))).
