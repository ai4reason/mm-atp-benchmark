...
thf(abj_xpima2sn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XA2) @ (cwceq @ (ccima @ (ccxp @ XA2 @ XB2) @ (ccsn @ XX)) @ XB2)))))).
...
thf(abj_taginv_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ (ccab @ (^ [Xx3:$i] : (cwcel @ (ccsn @ (ccv @ Xx3)) @ (cbj_ctag @ XA2))))))).
...
thf(abj_xpima1sn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwnel @ XX @ XA2) @ (cwceq @ (ccima @ (ccxp @ XA2 @ XB2) @ (ccsn @ XX)) @ cc0)))))).
...
thf(cbj_projval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (cbj_cproj @ XA2 @ (ccxp @ (ccsn @ XB2) @ (cbj_ctag @ XC))) @ (ccif @ (cwceq @ XB2 @ XA2) @ XC @ cc0)))))))).
