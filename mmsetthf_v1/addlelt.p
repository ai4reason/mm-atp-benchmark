...
thf(caddlelt_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccr) @ (cwcel @ XN @ ccr) @ (cwcel @ XA2 @ ccrp)) @ (cwi @ (cwbr @ (cco @ XM @ XA2 @ ccaddc) @ XN @ ccle) @ (cwbr @ XM @ XN @ cclt))))))).
