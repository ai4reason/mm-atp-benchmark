...
thf(cinxpex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwo @ (cwcel @ XR @ XW) @ (cwa @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV))) @ (cwcel @ (ccin @ XR @ (ccxp @ XA2 @ XB2)) @ ccvv))))))))).
