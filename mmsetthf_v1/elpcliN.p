...
thf(celpcliN_conj,conjecture,(! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ XV) @ (cwss @ XX @ XY) @ (cwcel @ XY @ XS)) @ (cwcel @ XQ @ (ccfv @ XX @ XU))) @ (cwcel @ XQ @ XY)))))))))))).
