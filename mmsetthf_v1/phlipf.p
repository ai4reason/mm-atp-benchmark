...
thf(cphlipf_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccipf)) => ((cwceq @ XS @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XS @ ccbs)) => (cwi @ (cwcel @ XW @ ccphl) @ (cwf @ (ccxp @ XV @ XV) @ XK @ Xc_xi)))))))))))).
