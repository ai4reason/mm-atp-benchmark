...
thf(adeg1pwle_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ ccn0)) @ (cwbr @ (ccfv @ (cco @ XF @ XX @ Xc_ex) @ XD) @ XF @ ccle))))))))))))))).
...
thf(acoe1pwmulfv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XD @ ccn0)) => ((cwi @ Xph @ (cwcel @ XY @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XD @ XY @ ccaddc) @ (ccfv @ (cco @ (cco @ XD @ XX @ Xc_ex) @ XA2 @ Xc_x) @ ccco1)) @ (ccfv @ XY @ (ccfv @ XA2 @ ccco1)))))))))))))))))))))))))))).
...
thf(chbtlem4_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XI @ XU)) => ((cwi @ Xph @ (cwcel @ XX @ ccn0)) => ((cwi @ Xph @ (cwcel @ XY @ ccn0)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ ccle)) => (cwi @ Xph @ (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XY @ (ccfv @ XI @ XS))))))))))))))))))))).
