...
thf(adivconjdvds_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwbr @ XM @ XN @ ccdvds) @ (cwne @ XM @ ccc0)) @ (cwbr @ (cco @ XN @ XM @ ccdiv) @ XN @ ccdvds))))).
thf(cdvdsdivcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)))) @ (cwcel @ (cco @ XN @ XA2 @ ccdiv) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn))))))).
