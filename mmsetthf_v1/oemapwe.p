...
thf(acantnf_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ ccon0))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XB2 @ ccon0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xz:$i] : XB2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwiso @ (XS @ Xw) @ (cco @ XA2 @ XB2 @ ccoe) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ ccep @ (cco @ XA2 @ XB2 @ cccnf))))))))))))))))).
...
thf(coemapwe_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ ccon0))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XB2 @ ccon0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xz:$i] : XB2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwa @ (cwwe @ (XS @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwceq @ (ccdm @ (ccoi @ (XS @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))) @ (cco @ XA2 @ XB2 @ ccoe)))))))))))))))))).
