...
thf(cccatmulgnn0dir_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccxp @ (cco @ ccc0 @ XM @ ccfzo) @ (ccsn @ XK))) => ((cwceq @ XB2 @ (ccxp @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XK))) => ((cwceq @ XC @ (ccxp @ (cco @ ccc0 @ (cco @ XM @ XN @ ccaddc) @ ccfzo) @ (ccsn @ XK))) => ((cwi @ Xph @ (cwcel @ XK @ XS)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccconcat) @ XC))))))))))))))))).
