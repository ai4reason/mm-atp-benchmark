...
thf(aedgvalOLD_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XG @ XV) @ (cwceq @ (ccfv @ XG @ ccedg) @ (ccrn @ (ccfv @ XG @ cciedg))))))).
...
thf(cedg0iedg0OLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwfun @ XI)) @ (cwb @ (cwceq @ XE @ cc0) @ (cwceq @ XI @ cc0)))))))))).
