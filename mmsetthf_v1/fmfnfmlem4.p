...
thf(afmfnfmlem1_thm,axiom,(! [Xph:$o] : (! [Xt:$i] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas))) => ((cwi @ Xph @ (cwcel @ XL @ (ccfv @ XX @ ccfil))) => ((cwi @ Xph @ (cwf @ XY @ XX @ XF)) => ((cwi @ Xph @ (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ XL)) => (cwi @ Xph @ (cwi @ (cwcel @ (ccv @ Xs1) @ (ccfv @ XB2 @ ccfi)) @ (cwi @ (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xt)) @ (cwi @ (cwss @ (ccv @ Xt) @ XX) @ (cwcel @ (ccv @ Xt) @ XL)))))))))))))))))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(aeleq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwcel @ XC @ XA2) @ (cwcel @ XC @ XB2))))))))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(afmfnfmlem3_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas))) => ((cwi @ Xph @ (cwcel @ XL @ (ccfv @ XX @ ccfil))) => ((cwi @ Xph @ (cwf @ XY @ XX @ XF)) => ((cwi @ Xph @ (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ XL)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3))))) @ ccfi) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3)))))))))))))))))).
thf(asyl5bi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwb @ Xph @ Xps) => ((cwi @ Xch @ (cwi @ Xps @ Xth)) => (cwi @ Xch @ (cwi @ Xph @ Xth))))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((cwi @ Xph @ Xps) => Xps))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(cwfo_tp,type,(cwfo : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(afmfnfmlem2_thm,axiom,(! [Xph:$o] : (! [Xt:$i] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas))) => ((cwi @ Xph @ (cwcel @ XL @ (ccfv @ XX @ ccfil))) => ((cwi @ Xph @ (cwf @ XY @ XX @ XF)) => ((cwi @ Xph @ (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ XL)) => (cwi @ Xph @ (cwi @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xs1) @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XL)) @ (cwi @ (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xt)) @ (cwi @ (cwss @ (ccv @ Xt) @ XX) @ (cwcel @ (ccv @ Xt) @ XL)))))))))))))))))).
