...
thf(ausgrfilem_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XF @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ XV)) @ (cwb @ (cwcel @ XE @ ccfn) @ (cwcel @ (XF @ Xe) @ ccfn))))))))))))).
...
thf(acusgrsizeindslem_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ XV)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)))))))))).
thf(ccusgrsizeinds_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XF @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : (cwi @ (cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ XV)) @ (cwceq @ (ccfv @ XE @ cchash) @ (cco @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ (ccfv @ (XF @ Xe) @ cchash) @ ccaddc))))))))))))).
