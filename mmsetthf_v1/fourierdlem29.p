...
thf(cfourierdlem29_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xs1:$i] : (cwceq @ (XK @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ cc1 @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => (! [Xs1:$i] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (cwceq @ (ccfv @ XA2 @ (XK @ Xs1)) @ (ccif @ (cwceq @ XA2 @ ccc0) @ cc1 @ (cco @ XA2 @ (cco @ cc2 @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))).
