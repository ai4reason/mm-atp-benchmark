...
thf(aitggt0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccvol) @ cclt)) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccrp))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclt))))))))).
...
thf(afct2relem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwceq @ XE @ (cco @ XC @ XD @ ccioo)) => ((cwi @ Xph @ (cwcel @ XA2 @ XE)) => ((cwi @ Xph @ (cwcel @ XB2 @ XE)) => (cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XE)))))))))))).
...
thf(cfdvposlt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XE @ (cco @ (XC @ Xx3) @ (XD @ Xx3) @ ccioo))) => ((cwi @ Xph @ (cwcel @ XA2 @ XE)) => ((cwi @ Xph @ (cwcel @ XB2 @ XE)) => ((cwi @ Xph @ (cwf @ XE @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ XE @ ccr @ cccncf))) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccioo))) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ cclt))) => (cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ cclt))))))))))))))))).
