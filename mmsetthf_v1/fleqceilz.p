...
thf(aceilid_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwceq @ (ccfv @ XA2 @ ccceil) @ XA2)))).
...
thf(aceilidz_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwcel @ XA2 @ ccz) @ (cwceq @ (ccfv @ XA2 @ ccceil) @ XA2))))).
...
thf(cfleqceilz_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwcel @ XA2 @ ccz) @ (cwceq @ (ccfv @ XA2 @ ccfl) @ (ccfv @ XA2 @ ccceil)))))).
