...
thf(aeltsk2g_thm,axiom,(! [XT:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : (cwi @ (cwcel @ XT @ (XV @ Xz)) @ (cwb @ (cwcel @ XT @ cctsk) @ (cwa @ (cwral @ (^ [Xz:$i] : (cwa @ (cwss @ (ccpw @ (ccv @ Xz)) @ XT) @ (cwcel @ (ccpw @ (ccv @ Xz)) @ XT))) @ (^ [Xz:$i] : XT)) @ (cwral @ (^ [Xz:$i] : (cwo @ (cwbr @ (ccv @ Xz) @ XT @ ccen) @ (cwcel @ (ccv @ Xz) @ XT))) @ (^ [Xz:$i] : (ccpw @ XT)))))))))).
thf(cinttsk_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ cctsk) @ (cwne @ XA2 @ cc0)) @ (cwcel @ (ccint @ XA2) @ cctsk)))).
