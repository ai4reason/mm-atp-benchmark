...
thf(aovidi_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XR @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (XS @ Xx3 @ Xy1))) @ (cwmo @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XR @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (XS @ Xx3 @ Xy1))) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XR @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (XS @ Xx3 @ Xy1))) @ (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XF @ Xx3 @ Xy1 @ Xz)) @ (ccv @ Xz)))))))))))))).
