...
thf(aostthlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xp:$i] : (cwceq @ (XQ @ Xp) @ (cco @ cccnfld @ ccq @ ccress))) => ((! [Xp:$i] : (cwceq @ XA2 @ (ccfv @ (XQ @ Xp) @ ccabv))) => ((cwi @ Xph @ (cwcel @ XF @ XA2)) => ((cwi @ Xph @ (cwcel @ XG @ XA2)) => ((! [Xp:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xp) @ ccprime)) @ (cwceq @ (ccfv @ (ccv @ Xp) @ XF) @ (ccfv @ (ccv @ Xp) @ XG)))) => (cwi @ Xph @ (cwceq @ XF @ XG))))))))))))).
thf(ccxr_tp,type,(ccxr : ($i > $o))).
thf(ccioo_tp,type,(ccioo : ($i > $o))).
thf(apadicabvcxp_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : (cwceq @ (XQ @ Xq) @ (cco @ cccnfld @ ccq @ ccress))) => ((! [Xq:$i] : (cwceq @ XA2 @ (ccfv @ (XQ @ Xq) @ ccabv))) => ((! [Xx3:$i] : (! [Xq:$i] : (cwceq @ (XJ @ Xx3 @ Xq) @ (ccmpt @ (^ [Xq:$i] : ccprime) @ (^ [Xq:$i] : (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ (ccv @ Xq) @ (ccneg @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ ccpc)) @ ccexp))))))))) => (! [Xx3:$i] : (! [Xq:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ (XR @ Xx3) @ ccrp)) @ (cwcel @ (ccmpt @ (^ [Xy1:$i] : ccq) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ (ccfv @ XP @ (XJ @ Xx3 @ Xq))) @ (XR @ Xx3) @ cccxp))) @ XA2))))))))))))).
...
thf(apadicval_thm,axiom,(! [XP:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xq:$i] : (cwceq @ (XJ @ Xx3 @ Xq) @ (ccmpt @ (^ [Xq:$i] : ccprime) @ (^ [Xq:$i] : (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ (ccv @ Xq) @ (ccneg @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ ccpc)) @ ccexp))))))))) => (! [Xx3:$i] : (! [Xq:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ (XX @ Xq) @ ccq)) @ (cwceq @ (ccfv @ (XX @ Xq) @ (ccfv @ XP @ (XJ @ Xx3 @ Xq))) @ (ccif @ (cwceq @ (XX @ Xq) @ ccc0) @ ccc0 @ (cco @ XP @ (ccneg @ (cco @ XP @ (XX @ Xq) @ ccpc)) @ ccexp))))))))))).
...
thf(arppwr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XN @ ccn)) @ (cwi @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwceq @ (cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccgcd) @ cc1))))))).
...
thf(aqabvexp_thm,axiom,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (cco @ cccnfld @ ccq @ ccress)) => ((cwceq @ XA2 @ (ccfv @ XQ @ ccabv)) => (cwi @ (cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XM @ ccq) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ (cco @ XM @ XN @ ccexp) @ XF) @ (cco @ (ccfv @ XM @ XF) @ XN @ ccexp))))))))))).
...
thf(aqrngneg_thm,axiom,(! [XQ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XQ @ (cco @ cccnfld @ ccq @ ccress)) => (cwi @ (cwcel @ XX @ ccq) @ (cwceq @ (ccfv @ XX @ (ccfv @ XQ @ ccminusg)) @ (ccneg @ XX))))))).
...
thf(costth3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (cwceq @ (XQ @ Xq @ Xp @ Xa) @ (cco @ cccnfld @ ccq @ ccress))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (cwceq @ XA2 @ (ccfv @ (XQ @ Xq @ Xp @ Xa) @ ccabv))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xq:$i] : (cwceq @ (XJ @ Xx3 @ Xn @ Xq) @ (ccmpt @ (^ [Xq:$i] : ccprime) @ (^ [Xq:$i] : (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ (ccv @ Xq) @ (ccneg @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ ccpc)) @ ccexp)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (cwceq @ (XK @ Xx3 @ Xy1 @ Xq @ Xp @ Xa) @ (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ cc1))))))))) => ((cwi @ Xph @ (cwcel @ XF @ XA2)) => ((cwi @ Xph @ (cwral @ (^ [Xn:$i] : (cwn @ (cwbr @ cc1 @ (ccfv @ (ccv @ Xn) @ XF) @ cclt))) @ (^ [Xn:$i] : ccn))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XP @ Xn) @ ccprime))) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XP @ Xn) @ XF) @ cc1 @ cclt))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xx3 @ Xn) @ (ccneg @ (cco @ (ccfv @ (ccfv @ (XP @ Xn) @ XF) @ cclog) @ (ccfv @ (XP @ Xn) @ cclog) @ ccdiv))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xn @ Xq @ Xp) @ (ccif @ (cwbr @ (ccfv @ (XP @ Xn) @ XF) @ (ccfv @ (ccv @ Xp) @ XF) @ ccle) @ (ccfv @ (ccv @ Xp) @ XF) @ (ccfv @ (XP @ Xn) @ XF)))))))) => (! [Xx3:$i] : (! [Xn:$i] : (! [Xq:$i] : (cwi @ Xph @ (cwrex @ (^ [Xa:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xy1:$i] : ccq) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (XP @ Xn) @ (XJ @ Xx3 @ Xn @ Xq))) @ (ccv @ Xa) @ cccxp))))) @ (^ [Xa:$i] : ccrp)))))))))))))))))))))))))).
