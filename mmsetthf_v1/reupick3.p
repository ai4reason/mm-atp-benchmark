...
thf(creupick3_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwi @ (Xph @ Xx3) @ (Xps @ Xx3)))))))).
