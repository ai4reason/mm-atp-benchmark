...
thf(aclimrec_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwbr @ XG @ XA2 @ ccli)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XH) @ (cco @ cc1 @ (ccfv @ (ccv @ Xk) @ XG) @ ccdiv)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XH @ (XW @ Xk)))) => (cwi @ Xph @ (cwbr @ XH @ (cco @ cc1 @ XA2 @ ccdiv) @ ccli))))))))))))))))).
...
thf(cclimrecf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XG @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XH @ Xk))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XG @ Xk) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwne @ (XA2 @ Xk) @ ccc0))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XH @ Xk)) @ (cco @ cc1 @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ ccdiv)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XH @ Xk) @ (XW @ Xk)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XH @ Xk) @ (cco @ cc1 @ (XA2 @ Xk) @ ccdiv) @ ccli))))))))))))))))))))).
