...
thf(a_19_41vvvv_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:$o] : (cwb @ (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwa @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ Xps))))))))) @ (cwa @ (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))))))) @ Xps))))).
...
thf(aexrot4_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))))))) @ (cwex @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
...
thf(aceqsex2v_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ XB2) @ (cwb @ (Xps @ Xy1) @ (Xch @ Xx3))))) => (! [Xx3:$i] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cw3a @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XB2) @ (Xph @ Xx3 @ Xy1)))))) @ (Xch @ Xx3))))))))))))).
...
thf(aequsexvw_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xy1))))) => (! [Xy1:$i] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3 @ Xy1)))) @ (Xps @ Xy1))))))).
...
thf(adf_funs_ax,axiom,(cwceq @ ccfuns @ (ccdif @ (ccpw @ (ccxp @ ccvv @ ccvv)) @ (ccfix @ (cccom @ ccep @ (cccom @ (cctxp @ cc1st @ (cccom @ (ccdif @ ccvv @ ccid) @ cc2nd)) @ (cccnv @ ccep))))))).
...
thf(acoepr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ (cccom @ XR @ (cccnv @ ccep))) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ XR)) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(celfuns_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwb @ (cwcel @ XF @ ccfuns) @ (cwfun @ XF))))).
