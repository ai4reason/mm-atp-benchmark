...
thf(ccplgr3v_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ (ccfv @ XG @ ccvtx) @ (cctp @ XA2 @ XB2 @ XC)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XZ)) @ (cwcel @ XG @ ccupgr) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC))) @ (cwb @ (cwcel @ XG @ cccplgr) @ (cw3a @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE) @ (cwcel @ (ccpr @ XC @ XA2) @ XE))))))))))))))).
