...
thf(adf_mon1_ax,axiom,(cwceq @ ccmn1 @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccrab @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cc0g)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xr) @ ccdg1)) @ (ccfv @ (ccv @ Xf1) @ ccco1)) @ (ccfv @ (ccv @ Xr) @ ccur)))) @ (^ [Xf1:$i] : (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccbs))))))).
...
thf(cmon1pval_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XP @ Xf1) @ (ccfv @ XR @ ccpl1))) => ((! [Xf1:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xf1) @ ccbs))) => ((! [Xf1:$i] : (cwceq @ Xc_0 @ (ccfv @ (XP @ Xf1) @ cc0g))) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((! [Xf1:$i] : (cwceq @ (XM @ Xf1) @ (ccfv @ XR @ ccmn1))) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (! [Xf1:$i] : (cwceq @ (XM @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccv @ Xf1) @ Xc_0) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XD) @ (ccfv @ (ccv @ Xf1) @ ccco1)) @ Xc_1))) @ (^ [Xf1:$i] : XB2)))))))))))))))))).
