...
thf(apcadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccq)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccq)) => ((cwi @ Xph @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc) @ ccle))))))))))).
...
thf(altexp2rd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ cclt)) => (cwi @ Xph @ (cwb @ (cwbr @ XM @ XN @ cclt) @ (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ cclt)))))))))))).
...
thf(cpadicabv_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (cco @ cccnfld @ ccq @ ccress)) => ((cwceq @ XA2 @ (ccfv @ XQ @ ccabv)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ XN @ (cco @ XP @ (ccv @ Xx3) @ ccpc) @ ccexp)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ (cco @ ccc0 @ cc1 @ ccioo))) @ (cwcel @ (XF @ Xx3) @ XA2)))))))))))).
