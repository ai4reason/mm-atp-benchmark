...
thf(amulgnegnn_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ (ccneg @ XN) @ XX @ Xc_x) @ (ccfv @ (cco @ XN @ XX @ Xc_x) @ XI))))))))))))).
...
thf(aarchiabllem1a_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((! [Xn:$i] : (cwceq @ (Xc_le @ Xn) @ (ccfv @ XW @ ccple))) => ((cwceq @ Xc_lt @ (ccfv @ XW @ ccplt)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccmg)) => ((cwi @ Xph @ (cwcel @ XW @ ccogrp)) => ((cwi @ Xph @ (cwcel @ XW @ ccarchi)) => ((cwi @ Xph @ (cwcel @ XU @ XB2)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XU @ Xc_lt)) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwbr @ Xc_0 @ (ccv @ Xx3) @ Xc_lt)) @ (cwbr @ XU @ (ccv @ Xx3) @ (Xc_le @ Xn))))) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XX @ Xc_lt)) => (cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (cwceq @ XX @ (cco @ (ccv @ Xn) @ XU @ Xc_x))) @ (^ [Xn:$i] : ccn))))))))))))))))))))))))).
...
thf(carchiabllem1b_conj,conjecture,(! [Xph:$o] : (! [Xy1:$i] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((! [Xn:$i] : (cwceq @ (Xc_le @ Xn) @ (ccfv @ XW @ ccple))) => ((cwceq @ Xc_lt @ (ccfv @ XW @ ccplt)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccmg)) => ((cwi @ Xph @ (cwcel @ XW @ ccogrp)) => ((cwi @ Xph @ (cwcel @ XW @ ccarchi)) => ((cwi @ Xph @ (cwcel @ XU @ XB2)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XU @ Xc_lt)) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwbr @ Xc_0 @ (ccv @ Xx3) @ Xc_lt)) @ (cwbr @ XU @ (ccv @ Xx3) @ (Xc_le @ Xn))))) => (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xn) @ XU @ Xc_x))) @ (^ [Xn:$i] : ccz))))))))))))))))))))))).
