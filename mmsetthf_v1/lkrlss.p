...
thf(alkrval2_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ XW @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ XW @ ccsca))) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ (XD @ Xx3) @ cc0g))) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XK @ (ccfv @ XW @ cclk)) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XW @ (XX @ Xx3)) @ (cwcel @ XG @ XF)) @ (cwceq @ (ccfv @ XG @ XK) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XG) @ (Xc_0 @ Xx3))) @ (^ [Xx3:$i] : (XV @ Xx3)))))))))))))))))))).
...
thf(alkrcl_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XK @ (ccfv @ XW @ cclk)) => (cwi @ (cw3a @ (cwcel @ XW @ XY) @ (cwcel @ XG @ XF) @ (cwcel @ XX @ (ccfv @ XG @ XK))) @ (cwcel @ XX @ XV))))))))))))).
...
thf(clkrlss_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XK @ (ccfv @ XW @ cclk)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XG @ XF)) @ (cwcel @ (ccfv @ XG @ XK) @ XS))))))))))).
