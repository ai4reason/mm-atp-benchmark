...
thf(ccomfffn_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XC @ cccomf)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => (cwfn @ XO @ (ccxp @ (ccxp @ XB2 @ XB2) @ XB2)))))))).
