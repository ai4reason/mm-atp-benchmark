...
thf(asumrb_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwss @ XA2 @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwss @ XA2 @ (ccfv @ XN @ ccuz))) => (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (XC @ Xk) @ ccli) @ (cwbr @ (ccseq @ ccaddc @ XF @ XN) @ (XC @ Xk) @ ccli)))))))))))))))))).
...
thf(asummolem2a_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc)))) => ((! [Xf1:$i] : (cwceq @ (XG @ Xf1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xf1 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (XK @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XN @ Xf1) @ ccn))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XM @ Xf1) @ ccz))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwss @ XA2 @ (ccfv @ (XM @ Xf1) @ ccuz)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (cco @ cc1 @ (XN @ Xf1) @ ccfz) @ XA2 @ (ccv @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwiso @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ XA2 @ cclt @ cclt @ (XK @ Xf1)))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwbr @ (ccseq @ ccaddc @ XF @ (XM @ Xf1)) @ (ccfv @ (XN @ Xf1) @ (ccseq @ ccaddc @ (XG @ Xf1) @ cc1)) @ ccli)))))))))))))))))))))).
...
thf(adf_sum_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xk:$i] : (cwceq @ (ccsu @ (XA2 @ Xk) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccio @ (^ [Xx3:$i] : (cwo @ (cwrex @ (^ [Xm:$i] : (cwa @ (cwss @ (XA2 @ Xk) @ (ccfv @ (ccv @ Xm) @ ccuz)) @ (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ (XA2 @ Xk)) @ (ccsb @ (ccv @ Xn) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccc0))) @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz)) @ (cwrex @ (^ [Xm:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (XA2 @ Xk) @ (ccv @ Xf1)) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))) @ cc1))))))) @ (^ [Xm:$i] : ccn)))))))))).
thf(adf_fv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ XF) @ (ccio @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))))))).
thf(czsum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwss @ XA2 @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccfv @ (ccseq @ ccaddc @ XF @ XM) @ ccli))))))))))))))).
