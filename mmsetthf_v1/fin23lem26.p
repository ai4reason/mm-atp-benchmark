...
thf(cfin23lem26_conj,conjecture,(! [XS:($i > $o)] : (! [Xi:$i] : (cwi @ (cwa @ (cwa @ (cwss @ XS @ ccom) @ (cwn @ (cwcel @ XS @ ccfn))) @ (cwcel @ (ccv @ Xi) @ ccom)) @ (cwrex @ (^ [Xj:$i] : (cwbr @ (ccin @ (ccv @ Xj) @ XS) @ (ccv @ Xi) @ ccen)) @ (^ [Xj:$i] : XS)))))).
