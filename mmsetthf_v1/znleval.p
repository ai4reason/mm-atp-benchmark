...
thf(aznle2_thm,axiom,(! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XN @ cczn)) => ((cwceq @ XF @ (ccres @ (ccfv @ XY @ cczrh) @ XW)) => ((cwceq @ XW @ (ccif @ (cwceq @ XN @ ccc0) @ ccz @ (cco @ ccc0 @ XN @ ccfzo))) => ((cwceq @ Xc_le @ (ccfv @ XY @ ccple)) => (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ Xc_le @ (cccom @ (cccom @ XF @ ccle) @ (cccnv @ XF)))))))))))))).
...
thf(cznleval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XN @ cczn)) => ((cwceq @ XF @ (ccres @ (ccfv @ XY @ cczrh) @ XW)) => ((cwceq @ XW @ (ccif @ (cwceq @ XN @ ccc0) @ ccz @ (cco @ ccc0 @ XN @ ccfzo))) => ((cwceq @ Xc_le @ (ccfv @ XY @ ccple)) => ((cwceq @ XX @ (ccfv @ XY @ ccbs)) => (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwbr @ XA2 @ XB2 @ Xc_le) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwbr @ (ccfv @ XA2 @ (cccnv @ XF)) @ (ccfv @ XB2 @ (cccnv @ XF)) @ ccle)))))))))))))))))).
