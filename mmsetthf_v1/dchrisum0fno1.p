...
thf(alogno1_thm,axiom,(cwn @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cclog))) @ cco1))).
...
thf(alogsqrt_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccsqrt) @ cclog) @ (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccdiv))))).
...
thf(adchrisum0flb_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [Xc_1:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XZ @ Xv @ Xq @ Xb) @ (ccfv @ (XN @ Xv @ Xb) @ cczn))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xq) @ (ccfv @ (XZ @ Xv @ Xq @ Xb) @ cczrh))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwcel @ (XN @ Xv @ Xb) @ ccn))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XG @ Xv @ Xq @ Xb) @ (ccfv @ (XN @ Xv @ Xb) @ ccdchr))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XD @ Xv @ Xq @ Xb) @ (ccfv @ (XG @ Xv @ Xq @ Xb) @ ccbs))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (Xc_1 @ Xv @ Xq @ Xb) @ (ccfv @ (XG @ Xv @ Xq @ Xb) @ cc0g))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XF @ Xv @ Xq @ Xb) @ (ccmpt @ (^ [Xb:$i] : ccn) @ (^ [Xb:$i] : (ccsu @ (ccrab @ (^ [Xq:$i] : (cwbr @ (ccv @ Xq) @ (ccv @ Xb) @ ccdvds)) @ (^ [Xq:$i] : ccn)) @ (^ [Xv:$i] : (ccfv @ (ccfv @ (ccv @ Xv) @ (XL @ Xq)) @ (XX @ Xq)))))))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwcel @ (XX @ Xq) @ (XD @ Xv @ Xq @ Xb)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwf @ (ccfv @ (XZ @ Xv @ Xq @ Xb) @ ccbs) @ ccr @ (XX @ Xq)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwcel @ XA2 @ ccn))))) => (! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwbr @ (ccif @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccn) @ cc1 @ ccc0) @ (ccfv @ XA2 @ (XF @ Xv @ Xq @ Xb)) @ ccle)))))))))))))))))))))))))).
thf(aad2antrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ (cwa @ Xph @ Xch) @ Xth) @ Xps))))))).
thf(aleabsd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwbr @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccle)))))).
thf(cdchrisum0fno1_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [Xc_1:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XZ @ Xv @ Xq @ Xb) @ (ccfv @ (XN @ Xv @ Xb) @ cczn))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xq) @ (ccfv @ (XZ @ Xv @ Xq @ Xb) @ cczrh))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwcel @ (XN @ Xv @ Xb) @ ccn))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XG @ Xx3 @ Xv @ Xk @ Xq @ Xb) @ (ccfv @ (XN @ Xv @ Xb) @ ccdchr))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XD @ Xv @ Xq @ Xb) @ (ccfv @ (XG @ Xx3 @ Xv @ Xk @ Xq @ Xb) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (Xc_1 @ Xv @ Xq @ Xb) @ (ccfv @ (XG @ Xx3 @ Xv @ Xk @ Xq @ Xb) @ cc0g))))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XF @ Xv @ Xq @ Xb) @ (ccmpt @ (^ [Xb:$i] : ccn) @ (^ [Xb:$i] : (ccsu @ (ccrab @ (^ [Xq:$i] : (cwbr @ (ccv @ Xq) @ (ccv @ Xb) @ ccdvds)) @ (^ [Xq:$i] : ccn)) @ (^ [Xv:$i] : (ccfv @ (ccfv @ (ccv @ Xv) @ (XL @ Xq)) @ (XX @ Xq)))))))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwcel @ (XX @ Xq) @ (XD @ Xv @ Xq @ Xb)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwf @ (ccfv @ (XZ @ Xv @ Xq @ Xb) @ ccbs) @ ccr @ (XX @ Xq)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xv @ Xq @ Xb) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xv @ Xq @ Xb)) @ (ccfv @ (ccv @ Xk) @ ccsqrt) @ ccdiv))))) @ cco1))))) => (! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (cwn @ (Xph @ Xv @ Xq @ Xb))))))))))))))))))))))))).
