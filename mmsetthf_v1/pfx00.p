...
thf(adf_pfx_ax,axiom,(cwceq @ ccpfx @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xl:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xl:$i] : ccn0)) @ (^ [Xs1:$i] : (^ [Xl:$i] : (cco @ (ccv @ Xs1) @ (ccop @ ccc0 @ (ccv @ Xl)) @ ccsubstr)))))).
...
thf(cpfx00_conj,conjecture,(! [XS:($i > $o)] : (cwceq @ (cco @ XS @ ccc0 @ ccpfx) @ cc0))).
