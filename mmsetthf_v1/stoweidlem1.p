...
thf(aexpne0_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwne @ (cco @ XA2 @ XN @ ccexp) @ ccc0) @ (cwne @ XA2 @ ccc0)))))).
...
thf(alediv12a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ XA2 @ XB2 @ ccle))) @ (cwa @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XC @ cclt) @ (cwbr @ XC @ XD @ ccle)))) @ (cwbr @ (cco @ XA2 @ XD @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccle))))))).
thf(cstoweidlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XK @ ccn)) => ((cwi @ Xph @ (cwcel @ XD @ ccrp)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ ccle)) => ((cwi @ Xph @ (cwbr @ XD @ XA2 @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccmin) @ (cco @ XK @ XN @ ccexp) @ ccexp) @ (cco @ cc1 @ (cco @ (cco @ XK @ XD @ ccmul) @ XN @ ccexp) @ ccdiv) @ ccle))))))))))))))).
