...
thf(celintima_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xb:$i] : (cwb @ (cwcel @ (ccv @ Xy1) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xa:$i] : (cwceq @ (ccv @ Xx3) @ (ccima @ (ccv @ Xa) @ (XB2 @ Xy1 @ Xa)))) @ (^ [Xa:$i] : (XA2 @ Xy1 @ Xa @ Xb))))))) @ (cwral @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ (ccop @ (ccv @ Xb) @ (ccv @ Xy1)) @ (ccv @ Xa))) @ (^ [Xb:$i] : (XB2 @ Xy1 @ Xa)))) @ (^ [Xa:$i] : (XA2 @ Xy1 @ Xa @ Xb))))))))).
