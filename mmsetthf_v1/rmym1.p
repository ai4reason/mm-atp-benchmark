...
thf(armxneg_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (ccneg @ XN) @ ccrmx) @ (cco @ XA2 @ XN @ ccrmx)))))).
thf(armx1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (cco @ XA2 @ cc1 @ ccrmx) @ XA2)))).
...
thf(crmym1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmy) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmx) @ ccmin)))))).
