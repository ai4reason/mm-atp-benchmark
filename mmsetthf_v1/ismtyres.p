...
thf(cismtyres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccima @ XF @ XA2)) => ((cwceq @ XS @ (ccres @ XM @ (ccxp @ XA2 @ XA2))) => ((cwceq @ XT @ (ccres @ XN @ (ccxp @ XB2 @ XB2))) => (cwi @ (cwa @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XN @ (ccfv @ XY @ ccxmt))) @ (cwa @ (cwcel @ XF @ (cco @ XM @ XN @ ccismty)) @ (cwss @ XA2 @ XX))) @ (cwcel @ (ccres @ XF @ XA2) @ (cco @ XS @ XT @ ccismty)))))))))))))))).
