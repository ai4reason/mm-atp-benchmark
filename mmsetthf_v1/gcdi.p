...
thf(cgcdi_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ ccn0) => ((cwcel @ XR @ ccn0) => ((cwcel @ XN @ ccn0) => ((cwceq @ (cco @ XN @ XR @ ccgcd) @ XG) => ((cwceq @ (cco @ (cco @ XK @ XN @ ccmul) @ XR @ ccaddc) @ XM) => (cwceq @ (cco @ XM @ XN @ ccgcd) @ XG)))))))))))).
