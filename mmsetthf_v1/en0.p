...
thf(af1o00_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwf1o @ cc0 @ XA2 @ XF) @ (cwa @ (cwceq @ XF @ cc0) @ (cwceq @ XA2 @ cc0)))))).
...
thf(cen0_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwbr @ XA2 @ cc0 @ ccen) @ (cwceq @ XA2 @ cc0)))).
