...
thf(ae03_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => ((cwvd3 @ Xps @ Xch @ Xth @ Xta) => ((cwi @ Xph @ (cwi @ Xta @ Xet)) => (cwvd3 @ Xps @ Xch @ Xth @ Xet))))))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asssucid_thm,axiom,(! [XA2:($i > $o)] : (cwss @ XA2 @ (ccsuc @ XA2)))).
thf(ae123_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwvd1 @ Xph @ Xps) => ((cwvd2 @ Xph @ Xch @ Xth) => ((cwvd3 @ Xph @ Xch @ Xta @ Xet) => ((cwi @ Xps @ (cwi @ Xth @ (cwi @ Xet @ Xze))) => (cwvd3 @ Xph @ Xch @ Xta @ Xze))))))))))))).
...
thf(csuctrALT2VD_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwtr @ XA2) @ (cwtr @ (ccsuc @ XA2))))).
