...
thf(aisbnd3b_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))).
...
thf(cequivbnd_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (ccfv @ XX @ ccbnd))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XN) @ (cco @ XR @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) @ ccmul) @ ccle)))) => (cwi @ Xph @ (cwcel @ XN @ (ccfv @ XX @ ccbnd))))))))))))).
