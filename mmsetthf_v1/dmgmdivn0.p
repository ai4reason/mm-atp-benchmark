...
thf(cdmgmdivn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => (cwi @ Xph @ (cwne @ (cco @ (cco @ XA2 @ XM @ ccdiv) @ cc1 @ ccaddc) @ ccc0)))))))).
