...
thf(alcvfbr_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xs1:$i] : (cwceq @ (XC @ Xu @ Xt @ Xs1) @ (ccfv @ XW @ cclcv))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xu @ Xt @ Xs1) @ (cwcel @ XW @ (XX @ Xu @ Xt @ Xs1)))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xu @ Xt @ Xs1) @ (cwceq @ (XC @ Xu @ Xt @ Xs1) @ (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xt) @ XS) @ (cwcel @ (ccv @ Xu) @ XS)) @ (cwa @ (cwpss @ (ccv @ Xt) @ (ccv @ Xu)) @ (cwn @ (cwrex @ (^ [Xs1:$i] : (cwa @ (cwpss @ (ccv @ Xt) @ (ccv @ Xs1)) @ (cwpss @ (ccv @ Xs1) @ (ccv @ Xu)))) @ (^ [Xs1:$i] : XS)))))))))))))))))))))).
thf(abiantrurd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ Xph @ (cwb @ Xch @ (cwa @ Xps @ Xch)))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => (cwi @ Xph @ (cwa @ Xps @ Xch)))))))).
thf(clcvbr_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((! [Xs1:$i] : (cwceq @ (XC @ Xs1) @ (ccfv @ XW @ cclcv))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XW @ (XX @ Xs1)))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XT @ XS))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XU @ XS))) => (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwb @ (cwbr @ XT @ XU @ (XC @ Xs1)) @ (cwa @ (cwpss @ XT @ XU) @ (cwn @ (cwrex @ (^ [Xs1:$i] : (cwa @ (cwpss @ XT @ (ccv @ Xs1)) @ (cwpss @ (ccv @ Xs1) @ XU))) @ (^ [Xs1:$i] : XS)))))))))))))))))))).
