...
thf(affrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ XA2 @ (ccrn @ XF) @ XF)))))).
...
thf(cvolicoff_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ (ccxp @ ccr @ ccxr) @ XF)) => (cwi @ Xph @ (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ (cccom @ (cccom @ ccvol @ ccico) @ XF)))))))).
