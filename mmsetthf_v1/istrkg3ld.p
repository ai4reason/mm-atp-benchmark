...
thf(aistrkgld_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (cwceq @ XP @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xj) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (cwceq @ Xc_mi @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xj) @ ccds)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xj) @ ccitv)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xz @ Xj) @ (XV @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xj)) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) @ (cwb @ (cwbr @ (XG @ Xx3 @ Xy1 @ Xz @ Xj) @ XN @ ccstrkgld) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1 @ (cco @ cc1 @ XN @ ccfzo) @ XP @ (ccv @ Xf1)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwral @ (^ [Xj:$i] : (cw3a @ (cwceq @ (cco @ (ccfv @ cc1 @ (ccv @ Xf1)) @ (ccv @ Xx3) @ Xc_mi) @ (cco @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (ccv @ Xx3) @ Xc_mi)) @ (cwceq @ (cco @ (ccfv @ cc1 @ (ccv @ Xf1)) @ (ccv @ Xy1) @ Xc_mi) @ (cco @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (ccv @ Xy1) @ Xc_mi)) @ (cwceq @ (cco @ (ccfv @ cc1 @ (ccv @ Xf1)) @ (ccv @ Xz) @ Xc_mi) @ (cco @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (ccv @ Xz) @ Xc_mi)))) @ (^ [Xj:$i] : (cco @ cc2 @ XN @ ccfzo))) @ (cwn @ (cw3o @ (cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XI)) @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XI)) @ (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XI)))))) @ (^ [Xz:$i] : XP))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))).
...
thf(af1prex_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccfv @ XA2 @ (ccv @ Xf1))) @ (cwb @ (Xps @ Xx3 @ Xy1) @ (Xch @ Xy1 @ Xf1)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ XB2 @ (ccv @ Xf1))) @ (cwb @ (Xch @ Xy1 @ Xf1) @ (Xph @ Xf1))))) => (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwne @ XA2 @ XB2)) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1 @ (ccpr @ XA2 @ XB2) @ XD @ (ccv @ Xf1)) @ (Xph @ Xf1)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xps @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD))))))))))))))).
...
thf(cistrkg3ld_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ XP @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ Xc_mi @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) @ ccds))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) @ ccitv))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) @ (XV @ Xx3 @ Xy1 @ Xz @ Xv @ Xu)) @ (cwb @ (cwbr @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) @ cc3 @ ccstrkgld) @ (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cwa @ (cwne @ (ccv @ Xu) @ (ccv @ Xv)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cw3a @ (cwceq @ (cco @ (ccv @ Xu) @ (ccv @ Xx3) @ Xc_mi) @ (cco @ (ccv @ Xv) @ (ccv @ Xx3) @ Xc_mi)) @ (cwceq @ (cco @ (ccv @ Xu) @ (ccv @ Xy1) @ Xc_mi) @ (cco @ (ccv @ Xv) @ (ccv @ Xy1) @ Xc_mi)) @ (cwceq @ (cco @ (ccv @ Xu) @ (ccv @ Xz) @ Xc_mi) @ (cco @ (ccv @ Xv) @ (ccv @ Xz) @ Xc_mi))) @ (cwn @ (cw3o @ (cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XI)) @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XI)) @ (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XI)))))) @ (^ [Xz:$i] : XP))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP)))) @ (^ [Xv:$i] : XP))) @ (^ [Xu:$i] : XP)))))))))))))))))).
