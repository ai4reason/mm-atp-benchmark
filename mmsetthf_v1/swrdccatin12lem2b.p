...
thf(aelfzonelfzo_thm,axiom,(! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwi @ (cwa @ (cwcel @ XK @ (cco @ XM @ XR @ ccfzo)) @ (cwn @ (cwcel @ XK @ (cco @ XM @ XN @ ccfzo)))) @ (cwcel @ XK @ (cco @ XN @ XR @ ccfzo))))))))).
...
thf(anpncan3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccaddc) @ (cco @ XC @ XB2 @ ccmin))))))))))).
...
thf(afzosubel2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ (cco @ XB2 @ XC @ ccaddc) @ (cco @ XB2 @ XD @ ccaddc) @ ccfzo)) @ (cw3a @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz) @ (cwcel @ XD @ ccz))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccfzo)))))))).
thf(cswrdccatin12lem2b_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) @ (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) @ (cwn @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) @ (cwcel @ (cco @ XK @ (cco @ XL @ XM @ ccmin) @ ccmin) @ (cco @ ccc0 @ (cco @ (cco @ XN @ XL @ ccmin) @ ccc0 @ ccmin) @ ccfzo)))))))))).
