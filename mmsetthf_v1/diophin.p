...
thf(aeldiophelnn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccdioph)) @ (cwcel @ XB2 @ ccn0))))).
...
thf(alzenom_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwbr @ (ccdif @ ccz @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ ccom @ ccen)))).
...
thf(afz1eqin_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ cc1 @ XN @ ccfz) @ (ccin @ (ccdif @ ccz @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ ccn))))).
thf(ainss1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccin @ XA2 @ XB2) @ XA2)))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(cccom_tp,type,(cccom : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(cwf1_tp,type,(cwf1 : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aeldioph2b_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [Xu:$i] : (! [Xt:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XS @ ccvv)) @ (cwa @ (cwn @ (cwcel @ XS @ ccfn)) @ (cwss @ (cco @ cc1 @ XN @ ccfz) @ XS))) @ (cwb @ (cwcel @ (XA2 @ Xu @ Xt) @ (ccfv @ XN @ ccdioph)) @ (cwrex @ (^ [Xp:$i] : (cwceq @ (XA2 @ Xu @ Xt) @ (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwceq @ (ccv @ Xt) @ (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xu) @ (ccv @ Xp)) @ ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ XS @ ccmap))))))) @ (^ [Xp:$i] : (ccfv @ XS @ ccmzp))))))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(annex_thm,axiom,(cwcel @ ccn @ ccvv)).
thf(a_1z_thm,axiom,(cwcel @ cc1 @ ccz)).
thf(auzinf_thm,axiom,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XM @ ccz) @ (cwn @ (cwcel @ XZ @ ccfn))))))).
...
thf(aelmapresaun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XC @ XA2 @ ccmap)) @ (cwcel @ XG @ (cco @ XC @ XB2 @ ccmap)) @ (cwceq @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccres @ XG @ (ccin @ XA2 @ XB2)))) @ (cwcel @ (ccun @ XF @ XG) @ (cco @ XC @ (ccun @ XA2 @ XB2) @ ccmap))))))))).
...
thf(alzunuz_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwbr @ XB2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccle)) @ (cwceq @ (ccun @ (ccdif @ ccz @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccuz)) @ (ccfv @ XB2 @ ccuz)) @ ccz))))).
...
thf(aelmapresaunres2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XC @ XA2 @ ccmap)) @ (cwcel @ XG @ (cco @ XC @ XB2 @ ccmap)) @ (cwceq @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccres @ XG @ (ccin @ XA2 @ XB2)))) @ (cwceq @ (ccres @ (ccun @ XF @ XG) @ XB2) @ XG)))))))).
...
thf(aelmapssres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) @ (cwss @ XD @ XC)) @ (cwcel @ (ccres @ XA2 @ XD) @ (cco @ XB2 @ XD @ ccmap)))))))).
...
thf(asumsqeq0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwa @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ ccc0)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ ccc0)))))).
...
thf(amzpresrename_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ ccvv) @ (cwss @ XV @ XW) @ (cwcel @ XF @ (ccfv @ XV @ ccmzp))) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (ccres @ (ccv @ Xx3) @ XV) @ XF))) @ (ccfv @ XW @ ccmzp))))))).
...
thf(aeldioph2_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwa @ (cwcel @ XS @ ccvv) @ (cwss @ (cco @ cc1 @ XN @ ccfz) @ XS)) @ (cwcel @ XP @ (ccfv @ XS @ ccmzp))) @ (cwcel @ (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwceq @ (ccv @ Xt) @ (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xu) @ XP) @ ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ XS @ ccmap))))) @ (ccfv @ XN @ ccdioph))))))).
...
thf(cdiophin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccdioph)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccdioph))) @ (cwcel @ (ccin @ XA2 @ XB2) @ (ccfv @ XN @ ccdioph))))))).
