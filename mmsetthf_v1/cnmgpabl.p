...
thf(aunitabl_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ XG @ (cco @ (ccfv @ XR @ ccmgp) @ XU @ ccress)) => (cwi @ (cwcel @ XR @ cccrg) @ (cwcel @ XG @ ccabl)))))))).
...
thf(ccnmgpabl_conj,conjecture,(! [XM:($i > $o)] : ((cwceq @ XM @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => (cwcel @ XM @ ccabl)))).
