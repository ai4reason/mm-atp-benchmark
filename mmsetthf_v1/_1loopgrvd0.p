...
thf(c_1loopgrvd0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XN @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ (ccsn @ XN))))) => ((cwi @ Xph @ (cwcel @ XK @ (ccdif @ XV @ (ccsn @ XN)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XK @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))))))))))).
