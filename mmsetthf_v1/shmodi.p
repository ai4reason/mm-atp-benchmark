...
thf(ashmodsi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => (cwi @ (cwss @ XA2 @ XC) @ (cwss @ (ccin @ (cco @ XA2 @ XB2 @ ccph) @ XC) @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ ccph)))))))))).
...
thf(cshmodi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => (cwi @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccph) @ (cco @ XA2 @ XB2 @ cchj)) @ (cwss @ XA2 @ XC)) @ (cwss @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ XC) @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ cchj)))))))))).
