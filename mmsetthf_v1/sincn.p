...
thf(adivccncf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccdiv))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf)))))))).
thf(csincn_conj,conjecture,(cwcel @ ccsin @ (cco @ ccc @ ccc @ cccncf))).
