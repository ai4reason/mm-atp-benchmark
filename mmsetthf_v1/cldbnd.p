...
thf(aopnbnd_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ XA2 @ XJ) @ (cwceq @ (ccin @ XA2 @ (ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ cccl)))) @ cc0)))))))).
...
thf(ccldbnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XJ @ cccld)) @ (cwss @ (ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ cccl))) @ XA2)))))))).
