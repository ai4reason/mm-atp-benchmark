...
thf(adf_scmat_ax,axiom,(cwceq @ ccscmat @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccfn)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccsb @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ (^ [Xa:$i] : (ccrab @ (^ [Xm:$i] : (cwrex @ (^ [Xc:$i] : (cwceq @ (ccv @ Xm) @ (cco @ (ccv @ Xc) @ (ccfv @ (ccv @ Xa) @ ccur) @ (ccfv @ (ccv @ Xa) @ ccvsca)))) @ (^ [Xc:$i] : (ccfv @ (ccv @ Xr) @ ccbs)))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xa) @ ccbs)))))))))).
