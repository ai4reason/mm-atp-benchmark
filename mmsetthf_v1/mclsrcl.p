...
thf(adf_mcls_ax,axiom,(cwceq @ ccmcls @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccmpt2 @ (^ [Xd:$i] : (^ [Xh:$i] : (ccpw @ (ccfv @ (ccv @ Xt) @ ccmdv)))) @ (^ [Xd:$i] : (^ [Xh:$i] : (ccpw @ (ccfv @ (ccv @ Xt) @ ccmex)))) @ (^ [Xd:$i] : (^ [Xh:$i] : (ccint @ (ccab @ (^ [Xc:$i] : (cwa @ (cwss @ (ccun @ (ccv @ Xh) @ (ccrn @ (ccfv @ (ccv @ Xt) @ ccmvh))) @ (ccv @ Xc)) @ (cwal @ (^ [Xm:$i] : (cwal @ (^ [Xo:$i] : (cwal @ (^ [Xp:$i] : (cwi @ (cwcel @ (ccotp @ (ccv @ Xm) @ (ccv @ Xo) @ (ccv @ Xp)) @ (ccfv @ (ccv @ Xt) @ ccmax)) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwa @ (cwss @ (ccima @ (ccv @ Xs1) @ (ccun @ (ccv @ Xo) @ (ccrn @ (ccfv @ (ccv @ Xt) @ ccmvh)))) @ (ccv @ Xc)) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xm)) @ (cwss @ (ccxp @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xt) @ ccmvh)) @ (ccv @ Xs1)) @ (ccfv @ (ccv @ Xt) @ ccmvrs)) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xt) @ ccmvh)) @ (ccv @ Xs1)) @ (ccfv @ (ccv @ Xt) @ ccmvrs))) @ (ccv @ Xd)))))))) @ (cwcel @ (ccfv @ (ccv @ Xp) @ (ccv @ Xs1)) @ (ccv @ Xc)))) @ (^ [Xs1:$i] : (ccrn @ (ccfv @ (ccv @ Xt) @ ccmsub)))))))))))))))))))))).
thf(asimprd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwa @ Xps @ Xch)) => (cwi @ Xph @ Xch)))))).
thf(cmclsrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XD @ (ccfv @ XT @ ccmdv)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XC @ (ccfv @ XT @ ccmcls)) => (cwi @ (cwcel @ XA2 @ (cco @ XK @ XB2 @ XC)) @ (cw3a @ (cwcel @ XT @ ccvv) @ (cwss @ XK @ XD) @ (cwss @ XB2 @ XE)))))))))))))).
