...
thf(agzaddcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccgz) @ (cwcel @ XB2 @ ccgz)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccgz))))).
thf(agznegcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccgz) @ (cwcel @ (ccneg @ XA2) @ ccgz)))).
