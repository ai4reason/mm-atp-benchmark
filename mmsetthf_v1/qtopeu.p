...
thf(aeqsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwne @ XA2 @ cc0) @ (cwb @ (cwceq @ XA2 @ (ccsn @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ XB2)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(aqtopcn_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XZ @ cctopon))) @ (cwa @ (cwfo @ XX @ XY @ XF) @ (cwf @ XY @ XZ @ XG))) @ (cwb @ (cwcel @ XG @ (cco @ (cco @ XJ @ XF @ ccqtop) @ XK @ cccn)) @ (cwcel @ (cccom @ XG @ XF) @ (cco @ XJ @ XK @ cccn)))))))))))).
...
thf(cqtopeu_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xy1) @ (ccfv @ (XX @ Xf1) @ cctopon))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwfo @ (XX @ Xf1) @ (XY @ Xy1) @ XF)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XG @ (cco @ (XJ @ Xy1) @ (XK @ Xy1) @ cccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XX @ Xf1)) @ (cwcel @ (ccv @ Xy1) @ (XX @ Xf1)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccv @ Xy1) @ XG)))))) => (! [Xy1:$i] : (cwi @ Xph @ (cwreu @ (^ [Xf1:$i] : (cwceq @ XG @ (cccom @ (ccv @ Xf1) @ XF))) @ (^ [Xf1:$i] : (cco @ (cco @ (XJ @ Xy1) @ XF @ ccqtop) @ (XK @ Xy1) @ cccn))))))))))))))))).
