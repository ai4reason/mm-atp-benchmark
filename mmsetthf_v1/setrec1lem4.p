...
thf(aspcdvw_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xps @ Xx3) @ Xch))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwi @ (cwal @ (^ [Xx3:$i] : (Xps @ Xx3))) @ Xch))))))))))).
