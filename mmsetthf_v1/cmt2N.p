...
thf(ccmt2N_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccoc)) => ((cwceq @ XC @ (ccfv @ XK @ cccmtN)) => (cwi @ (cw3a @ (cwcel @ XK @ ccoml) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwbr @ XX @ XY @ XC) @ (cwbr @ XX @ (ccfv @ XY @ Xc_pe) @ XC))))))))))))).
