...
thf(aclwlkiswlk_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccclwlks)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))).
