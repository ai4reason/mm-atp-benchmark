...
thf(anmfnxr_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ ccc @ XT) @ (cwcel @ (ccfv @ XT @ ccnmf) @ ccxr)))).
...
thf(cnmfnge0_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ ccc @ XT) @ (cwbr @ ccc0 @ (ccfv @ XT @ ccnmf) @ ccle)))).
