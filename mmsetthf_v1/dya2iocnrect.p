...
thf(ar19_41vv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (cwb @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ Xps)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) @ (cwa @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) @ Xps)))))))).
...
thf(adya2icoseg2_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XJ @ Xx3 @ Xn @ Xb) @ (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xn:$i] : (cwceq @ (XI @ Xn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico)))))) => (! [Xn:$i] : (cwi @ (cw3a @ (cwcel @ (XX @ Xn) @ ccr) @ (cwcel @ (XE @ Xn) @ (ccrn @ ccioo)) @ (cwcel @ (XX @ Xn) @ (XE @ Xn))) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwcel @ (XX @ Xn) @ (ccv @ Xb)) @ (cwss @ (ccv @ Xb) @ (XE @ Xn)))) @ (^ [Xb:$i] : (ccrn @ (XI @ Xn))))))))))))).
...
thf(aelxp7_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ XB2 @ XC)) @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ (cwa @ (cwcel @ (ccfv @ XA2 @ cc1st) @ XB2) @ (cwcel @ (ccfv @ XA2 @ cc2nd) @ XC)))))))).
...
thf(cdya2iocnrect_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XJ @ Xx3 @ Xv @ Xu @ Xe @ Xf1 @ Xn @ Xb) @ (ccfv @ (ccrn @ ccioo) @ cctg))))))))) => ((! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XI @ Xe @ Xf1 @ Xn @ Xb) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico))))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XR @ Xx3 @ Xv @ Xu @ Xn) @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xe @ Xf1 @ Xn @ Xb)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xe @ Xf1 @ Xn @ Xb)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (ccv @ Xu) @ (ccv @ Xv))))))))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XB2 @ Xx3 @ Xv @ Xu @ Xe @ Xf1 @ Xn @ Xb) @ (ccrn @ (ccmpt2 @ (^ [Xe:$i] : (^ [Xf1:$i] : (ccrn @ ccioo))) @ (^ [Xe:$i] : (^ [Xf1:$i] : (ccrn @ ccioo))) @ (^ [Xe:$i] : (^ [Xf1:$i] : (ccxp @ (ccv @ Xe) @ (ccv @ Xf1)))))))))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xb:$i] : (cwi @ (cw3a @ (cwcel @ (XX @ Xv @ Xu @ Xn) @ (ccxp @ ccr @ ccr)) @ (cwcel @ (XA2 @ Xx3 @ Xv @ Xu @ Xn) @ (XB2 @ Xx3 @ Xv @ Xu @ Xe @ Xf1 @ Xn @ Xb)) @ (cwcel @ (XX @ Xv @ Xu @ Xn) @ (XA2 @ Xx3 @ Xv @ Xu @ Xn))) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwcel @ (XX @ Xv @ Xu @ Xn) @ (ccv @ Xb)) @ (cwss @ (ccv @ Xb) @ (XA2 @ Xx3 @ Xv @ Xu @ Xn)))) @ (^ [Xb:$i] : (ccrn @ (XR @ Xx3 @ Xv @ Xu @ Xn))))))))))))))))))))))).
