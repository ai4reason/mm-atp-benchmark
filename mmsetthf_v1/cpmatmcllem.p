...
thf(acpmatelimp_thm,axiom,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XS @ Xi @ Xj @ Xk) @ (cco @ XN @ XR @ cccpmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XP @ Xi @ Xj @ Xk) @ (ccfv @ XR @ ccpl1))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XC @ Xi @ Xj @ Xk) @ (cco @ XN @ (XP @ Xi @ Xj @ Xk) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk) @ (ccfv @ (XC @ Xi @ Xj @ Xk) @ ccbs))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwi @ (cwcel @ XM @ (XS @ Xi @ Xj @ Xk)) @ (cwa @ (cwcel @ XM @ (XB2 @ Xi @ Xj @ Xk)) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)) @ (ccfv @ XR @ cc0g))) @ (^ [Xk:$i] : ccn))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))))))))))))))))))).
...
thf(acply1mul_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xc:$i] : (cwceq @ (XP @ Xc) @ (ccfv @ (XR @ Xc) @ ccpl1))) => ((! [Xc:$i] : (cwceq @ (XB2 @ Xc) @ (ccfv @ (XP @ Xc) @ ccbs))) => ((! [Xc:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xc) @ cc0g))) => ((! [Xc:$i] : (cwceq @ Xc_xp @ (ccfv @ (XP @ Xc) @ ccmulr))) => (! [Xc:$i] : (cwi @ (cwa @ (cwcel @ (XR @ Xc) @ ccrg) @ (cwa @ (cwcel @ XF @ (XB2 @ Xc)) @ (cwcel @ XG @ (XB2 @ Xc)))) @ (cwi @ (cwral @ (^ [Xc:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xc) @ (ccfv @ XF @ ccco1)) @ Xc_0) @ (cwceq @ (ccfv @ (ccv @ Xc) @ (ccfv @ XG @ ccco1)) @ Xc_0))) @ (^ [Xc:$i] : ccn)) @ (cwral @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ (ccfv @ (cco @ XF @ XG @ Xc_xp) @ ccco1)) @ Xc_0)) @ (^ [Xc:$i] : ccn))))))))))))))))).
...
thf(ccpmatmcllem_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwceq @ (XS @ Xi @ Xj @ Xk @ Xc) @ (cco @ XN @ XR @ cccpmat)))))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xi @ Xj) @ (ccfv @ XR @ ccpl1)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XC @ (cco @ XN @ (XP @ Xi @ Xj) @ ccmat)))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XS @ Xi @ Xj @ Xk @ Xc)) @ (cwcel @ (ccv @ Xy1) @ (XS @ Xi @ Xj @ Xk @ Xc)))) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwral @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ (ccfv @ (cco @ (XP @ Xi @ Xj) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xk) @ (ccv @ Xx3)) @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ (ccv @ Xy1)) @ (ccfv @ (XP @ Xi @ Xj) @ ccmulr)))) @ ccgsu) @ ccco1)) @ (ccfv @ XR @ cc0g))) @ (^ [Xc:$i] : ccn))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))))))))))))))))).
