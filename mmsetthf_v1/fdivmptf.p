...
thf(cfdivmptf_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG) @ (cwcel @ XA2 @ XV)) @ (cwf @ (cco @ XG @ ccc0 @ ccsupp) @ ccc @ (cco @ XF @ XG @ ccfdiv)))))))).
