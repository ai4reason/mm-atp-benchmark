...
thf(agsumval3lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xf1:$i] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ XZ))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwf1 @ (cco @ cc1 @ XM @ ccfz) @ XA2 @ XH)) => ((cwi @ Xph @ (cwss @ (cco @ XF @ Xc_0 @ ccsupp) @ (ccrn @ XH))) => ((cwceq @ XW @ (cco @ (cccom @ XF @ XH) @ Xc_0 @ ccsupp)) => (cwi @ (cwa @ (cwa @ Xph @ (cwne @ XW @ cc0)) @ (cwa @ (cwn @ (cwcel @ XA2 @ (ccrn @ ccfz))) @ (cwiso @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz) @ XW @ cclt @ cclt @ (ccv @ Xf1)))) @ (cwf1o @ (cco @ cc1 @ (ccfv @ (cco @ XF @ Xc_0 @ ccsupp) @ cchash) @ ccfz) @ (cco @ XF @ Xc_0 @ ccsupp) @ (cccom @ XH @ (ccv @ Xf1)))))))))))))))))))))))))))))).
...
thf(aimacosupp_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XG @ XW)) @ (cwi @ (cwa @ (cwfun @ XG) @ (cwss @ (cco @ XF @ XZ @ ccsupp) @ (ccrn @ XG))) @ (cwceq @ (ccima @ XG @ (cco @ (cccom @ XF @ XG) @ XZ @ ccsupp)) @ (cco @ XF @ XZ @ ccsupp)))))))))).
...
thf(asupp0cosupp0_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XG @ XW)) @ (cwi @ (cwceq @ (cco @ XF @ XZ @ ccsupp) @ cc0) @ (cwceq @ (cco @ (cccom @ XF @ XG) @ XZ @ ccsupp) @ cc0))))))))).
...
thf(cgsumval3lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xf1:$i] : (cwceq @ (Xc_0 @ Xf1) @ (ccfv @ XG @ cc0g))) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((! [Xf1:$i] : (cwceq @ (XZ @ Xf1) @ (ccfv @ XG @ cccntz))) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xf1)))) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ (XZ @ Xf1))))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwf1 @ (cco @ cc1 @ XM @ ccfz) @ XA2 @ XH)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwss @ (cco @ XF @ (Xc_0 @ Xf1) @ ccsupp) @ (ccrn @ XH)))) => ((! [Xf1:$i] : (cwceq @ XW @ (cco @ (cccom @ XF @ XH) @ (Xc_0 @ Xf1) @ ccsupp))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwne @ XW @ cc0)) @ (cwa @ (cwn @ (cwcel @ XA2 @ (ccrn @ ccfz))) @ (cwiso @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz) @ XW @ cclt @ cclt @ (ccv @ Xf1)))) @ (cwceq @ (cco @ XG @ XF @ ccgsu) @ (ccfv @ (ccfv @ XW @ cchash) @ (ccseq @ Xc_pl @ (cccom @ XF @ (cccom @ XH @ (ccv @ Xf1))) @ cc1)))))))))))))))))))))))))))))).
