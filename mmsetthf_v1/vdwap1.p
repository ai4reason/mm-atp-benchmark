...
thf(avdwap0_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XD @ ccn)) @ (cwceq @ (cco @ XA2 @ XD @ (ccfv @ ccc0 @ ccvdwa)) @ cc0))))).
thf(aun0_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccun @ XA2 @ cc0) @ XA2))).
thf(cvdwap1_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XD @ ccn)) @ (cwceq @ (cco @ XA2 @ XD @ (ccfv @ cc1 @ ccvdwa)) @ (ccsn @ XA2)))))).
