...
thf(cbrtpos2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ (cctpos @ XF)) @ (cwa @ (cwcel @ XA2 @ (ccun @ (cccnv @ (ccdm @ XF)) @ (ccsn @ cc0))) @ (cwbr @ (ccuni @ (cccnv @ (ccsn @ XA2))) @ XB2 @ XF))))))))).
