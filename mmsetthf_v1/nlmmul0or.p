...
thf(cnlmmul0or_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ XO @ (ccfv @ XF @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XW @ ccnlm) @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XV)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_x) @ Xc_0) @ (cwo @ (cwceq @ XA2 @ XO) @ (cwceq @ XB2 @ Xc_0)))))))))))))))))))).
