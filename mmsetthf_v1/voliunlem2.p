...
thf(aismbl_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwa @ (cwss @ XA2 @ ccr) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccr) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ ccovol) @ (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccaddc)))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
thf(cvoliunlem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwf @ ccn @ (ccdm @ ccvol) @ XF))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwdisj @ (^ [Xi:$i] : ccn) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XF))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xx3 @ Xi @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccin @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccovol))))))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (ccuni @ (ccrn @ XF)) @ (ccdm @ ccvol))))))))))).
