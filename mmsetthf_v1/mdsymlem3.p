...
thf(aatcvat4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwa @ (cwcel @ XB2 @ ccat) @ (cwcel @ XC @ ccat)) @ (cwi @ (cwa @ (cwne @ XA2 @ cc0h) @ (cwss @ XB2 @ (cco @ XA2 @ XC @ cchj))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwss @ XB2 @ (cco @ XC @ (ccv @ Xx3) @ cchj)))) @ (^ [Xx3:$i] : ccat))))))))).
...
thf(anssne2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XC) @ (cwn @ (cwss @ XB2 @ XC))) @ (cwne @ XA2 @ XB2)))))).
thf(aancoms_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ Xps @ Xph) @ Xch)))))).
thf(aatnemeq0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwne @ XA2 @ XB2) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)))))).
...
thf(aatexch_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat) @ (cwcel @ XC @ ccat)) @ (cwi @ (cwa @ (cwss @ XB2 @ (cco @ XA2 @ XC @ cchj)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)) @ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
...
thf(achrelat2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwn @ (cwss @ XA2 @ XB2)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwn @ (cwss @ (ccv @ Xx3) @ XB2)))) @ (^ [Xx3:$i] : ccat))))))).
thf(cmdsymlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : (cwceq @ (XC @ Xp) @ (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (! [Xp:$i] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccat) @ (cwn @ (cwss @ (ccin @ XB2 @ (XC @ Xp)) @ XA2))) @ (cwss @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ cchj))) @ (cwne @ XA2 @ cc0h)) @ (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwss @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ cchj)) @ (cwa @ (cwss @ (ccv @ Xq) @ XA2) @ (cwss @ (ccv @ Xr) @ XB2)))) @ (^ [Xq:$i] : ccat))) @ (^ [Xr:$i] : ccat))))))))))).
