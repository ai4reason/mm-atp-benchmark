...
thf(cprmdvdsfz_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xp) @ XN @ ccle) @ (cwbr @ (ccv @ Xp) @ XI @ ccdvds))) @ (^ [Xp:$i] : ccprime)))))).
