...
thf(avtsprod_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ XX @ (cco @ (ccfv @ (ccv @ Xa) @ XL) @ XN @ ccvts)))) @ (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccv @ Xm) @ XX @ ccmul) @ ccmul) @ cce) @ ccmul))))))))))))))))).
...
thf(aefmul2picn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XA2 @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (XB2 @ Xx3) @ ccmul) @ cce))) @ (cco @ XA2 @ ccc @ cccncf)))))))).
...
thf(aifeq3da_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ (cwceq @ (ccif @ Xps @ XE @ XF) @ XE) @ (cwceq @ XC @ XG)) => ((cwi @ (cwceq @ (ccif @ Xps @ XE @ XF) @ XF) @ (cwceq @ XC @ XH)) => ((cwi @ Xph @ (cwceq @ XG @ XA2)) => ((cwi @ Xph @ (cwceq @ XH @ XB2)) => (cwi @ Xph @ (cwceq @ (ccif @ Xps @ XA2 @ XB2) @ XC)))))))))))))))).
...
thf(aitgexpif_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce))) @ (ccif @ (cwceq @ XN @ ccc0) @ cc1 @ ccc0))))).
...
thf(annmulge_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn0)) @ (cwbr @ XN @ (cco @ XM @ XN @ ccmul) @ ccle))))).
...
thf(areprfz1_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ ccn @ XN @ (ccfv @ XS @ ccrepr)) @ (cco @ (cco @ cc1 @ XN @ ccfz) @ XN @ (ccfv @ XS @ ccrepr)))))))))).
thf(ccirclemeth_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ ccn @ XN @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))))) @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xx3) @ (cco @ (ccfv @ (ccv @ Xa) @ XL) @ XN @ ccvts)))) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccneg @ XN) @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce) @ ccmul))))))))))))).
