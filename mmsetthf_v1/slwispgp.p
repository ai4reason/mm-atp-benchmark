...
thf(cslwispgp_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XS @ (cco @ XG @ XK @ ccress)) => (cwi @ (cwa @ (cwcel @ XH @ (cco @ XP @ XG @ ccslw)) @ (cwcel @ XK @ (ccfv @ XG @ ccsubg))) @ (cwb @ (cwa @ (cwss @ XH @ XK) @ (cwbr @ XP @ XS @ ccpgp)) @ (cwceq @ XH @ XK)))))))))).
