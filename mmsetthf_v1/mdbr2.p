...
thf(cmdbr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwss @ (ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) @ (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
