...
thf(crhmdvdsr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => ((cwceq @ Xc_dv @ (ccfv @ XS @ ccdsr)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ XA2 @ XB2 @ Xc_pa)) @ (cwbr @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ Xc_dv)))))))))))))).
