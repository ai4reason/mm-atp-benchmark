...
thf(cismbl_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwa @ (cwss @ XA2 @ ccr) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccr) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ ccovol) @ (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccaddc)))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
