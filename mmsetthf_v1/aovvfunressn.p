...
thf(aafvvfunressn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ (ccafv @ XA2 @ XF) @ XB2) @ (cwfun @ (ccres @ XF @ (ccsn @ XA2)))))))).
thf(caovvfunressn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ (ccaov @ XA2 @ XB2 @ XF) @ XC) @ (cwfun @ (ccres @ XF @ (ccsn @ (ccop @ XA2 @ XB2)))))))))).
