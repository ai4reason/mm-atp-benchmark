...
thf(asubmnd0_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccmnd) @ (cwcel @ XH @ ccmnd)) @ (cwa @ (cwss @ XS @ XB2) @ (cwcel @ Xc_0 @ XS))) @ (cwceq @ Xc_0 @ (ccfv @ XH @ cc0g)))))))))))).
thf(csubm0_conj,conjecture,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XH @ (cco @ XM @ XS @ ccress)) => ((cwceq @ Xc_0 @ (ccfv @ XM @ cc0g)) => (cwi @ (cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) @ (cwceq @ Xc_0 @ (ccfv @ XH @ cc0g)))))))))).
