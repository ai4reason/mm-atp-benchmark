...
thf(aalephsucpw2_thm,axiom,(! [XA2:($i > $o)] : (cwn @ (cwbr @ (ccpw @ (ccfv @ XA2 @ ccale)) @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccsdm)))).
...
thf(aalephordilem1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccsdm)))).
thf(a_3expia_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ Xph @ Xps) @ (cwi @ Xch @ Xth)))))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(agchi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccgch) @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccsdm)) @ (cwcel @ XA2 @ ccfn))))).
...
thf(cgchaleph_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccfv @ XA2 @ ccale) @ ccgch) @ (cwcel @ (ccpw @ (ccfv @ XA2 @ ccale)) @ (ccdm @ cccrd))) @ (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccen)))).
