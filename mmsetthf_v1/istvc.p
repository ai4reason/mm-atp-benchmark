...
thf(adf_tvc_ax,axiom,(cwceq @ cctvc @ (ccrab @ (^ [Xw:$i] : (cwcel @ (ccfv @ (ccv @ Xw) @ ccsca) @ cctdrg)) @ (^ [Xw:$i] : cctlm)))).
thf(cistvc_conj,conjecture,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => (cwb @ (cwcel @ XW @ cctvc) @ (cwa @ (cwcel @ XW @ cctlm) @ (cwcel @ XF @ cctdrg))))))).
