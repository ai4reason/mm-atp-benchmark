...
thf(ctopontopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XK @ ccts)) => (cwi @ (cwcel @ XJ @ (ccfv @ XA2 @ cctopon)) @ (cwceq @ XJ @ (ccfv @ XK @ cctopn))))))))).
