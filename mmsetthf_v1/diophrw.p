...
thf(af1cocnv1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwceq @ (cccom @ (cccnv @ XF) @ XF) @ (ccres @ ccid @ XA2))))))).
...
thf(cdiophrw_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ ccvv) @ (cwf1 @ XT @ XS @ XM) @ (cwceq @ (ccres @ XM @ XO) @ (ccres @ ccid @ XO))) @ (cwceq @ (ccab @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwceq @ (ccv @ Xa) @ (ccres @ (ccv @ Xb) @ XO)) @ (cwceq @ (ccfv @ (ccv @ Xb) @ (ccmpt @ (^ [Xd:$i] : (cco @ ccz @ XS @ ccmap)) @ (^ [Xd:$i] : (ccfv @ (cccom @ (ccv @ Xd) @ XM) @ (XP @ Xa))))) @ ccc0))) @ (^ [Xb:$i] : (cco @ ccn0 @ XS @ ccmap))))) @ (ccab @ (^ [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwa @ (cwceq @ (ccv @ Xa) @ (ccres @ (ccv @ Xc) @ XO)) @ (cwceq @ (ccfv @ (ccv @ Xc) @ (XP @ Xa)) @ ccc0))) @ (^ [Xc:$i] : (cco @ ccn0 @ XT @ ccmap))))))))))))).
