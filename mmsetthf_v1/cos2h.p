...
thf(ccos2h_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ cccos) @ (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccaddc) @ cc2 @ ccdiv) @ ccsqrt))))).
