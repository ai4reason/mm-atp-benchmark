...
thf(afmptsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ XB2 @ (XW @ Xx3))) @ (cwceq @ (ccsn @ (ccop @ XA2 @ XB2)) @ (ccmpt @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : XB2)))))))))).
