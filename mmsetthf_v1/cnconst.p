...
thf(afconst2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XB2 @ XC) @ (cwb @ (cwf @ XA2 @ (ccsn @ XB2) @ XF) @ (cwceq @ XF @ (ccxp @ XA2 @ (ccsn @ XB2)))))))))).
...
thf(ccnconst_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) @ (cwa @ (cwcel @ XB2 @ XY) @ (cwf @ XX @ (ccsn @ XB2) @ XF))) @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)))))))))).
