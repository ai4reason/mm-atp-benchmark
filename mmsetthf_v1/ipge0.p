...
thf(cipge0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cwcel @ XA2 @ XV)) @ (cwbr @ ccc0 @ (cco @ XA2 @ XA2 @ Xc_xi) @ ccle))))))))).
