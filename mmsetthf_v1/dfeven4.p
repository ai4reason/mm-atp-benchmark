...
thf(adf_even_ax,axiom,(cwceq @ cceven @ (ccrab @ (^ [Xz:$i] : (cwcel @ (cco @ (ccv @ Xz) @ cc2 @ ccdiv) @ ccz)) @ (^ [Xz:$i] : ccz)))).
...
thf(cdfeven4_conj,conjecture,(cwceq @ cceven @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xi) @ ccmul))) @ (^ [Xi:$i] : ccz))) @ (^ [Xz:$i] : ccz)))).
