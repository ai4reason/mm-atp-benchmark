...
thf(csqrtval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccsqrt) @ (ccrio @ (^ [Xx3:$i] : (cw3a @ (cwceq @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp))) @ (^ [Xx3:$i] : ccc)))))).
