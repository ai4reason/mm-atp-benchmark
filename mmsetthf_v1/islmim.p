...
thf(cislmim_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (ccfv @ XS @ ccbs)) => (cwb @ (cwcel @ XF @ (cco @ XR @ XS @ cclmim)) @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ cclmhm)) @ (cwf1o @ XB2 @ XC @ XF))))))))))).
