...
thf(cseqfeq2_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XK @ (ccfv @ (XM @ Xk) @ ccuz)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XK @ (ccseq @ (Xc_pl @ Xk) @ XF @ (XM @ Xk))) @ (ccfv @ XK @ XG)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccfv @ (cco @ XK @ cc1 @ ccaddc) @ ccuz))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG)))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccres @ (ccseq @ (Xc_pl @ Xk) @ XF @ (XM @ Xk)) @ (ccfv @ XK @ ccuz)) @ (ccseq @ (Xc_pl @ Xk) @ XG @ XK)))))))))))))).
