...
thf(amrsubvr_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwi @ (cw3a @ (cwf @ XA2 @ XR @ XF) @ (cwss @ XA2 @ XV) @ (cwcel @ XX @ XA2)) @ (cwceq @ (ccfv @ (ccs1 @ XX) @ (ccfv @ XF @ XS)) @ (ccfv @ XX @ XF)))))))))))))).
...
thf(cmrsubff1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwi @ (cwcel @ XT @ XW) @ (cwf1 @ (cco @ XR @ XV @ ccmap) @ (cco @ XR @ XR @ ccmap) @ (ccres @ XS @ (cco @ XR @ XV @ ccmap))))))))))))).
