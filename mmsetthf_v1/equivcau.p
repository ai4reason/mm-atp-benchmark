...
thf(ametss2lem_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XK @ (ccfv @ XD @ ccmopn)) => ((cwi @ Xph @ (cwcel @ XC @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3) @ ccrp))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ (cco @ (XR @ Xx3) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccmul) @ ccle)))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (XS @ Xx3) @ ccrp))) @ (cwss @ (cco @ (ccv @ Xx3) @ (cco @ (XS @ Xx3) @ (XR @ Xx3) @ ccdiv) @ (ccfv @ XD @ ccbl)) @ (cco @ (ccv @ Xx3) @ (XS @ Xx3) @ (ccfv @ XC @ ccbl)))))))))))))))))))).
...
thf(acaufval_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwceq @ (ccfv @ XD @ ccca) @ (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwf @ (ccfv @ (ccv @ Xk) @ ccuz) @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (ccres @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xf1:$i] : (cco @ XX @ ccc @ ccpm)))))))).
thf(cequivcau_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ (cco @ XR @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccmul) @ ccle)))) => (cwi @ Xph @ (cwss @ (ccfv @ XD @ ccca) @ (ccfv @ XC @ ccca))))))))))))).
