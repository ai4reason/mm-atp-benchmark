...
thf(clighneallem4a_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ (ccfv @ cc3 @ ccuz)) @ (cwceq @ XS @ (cco @ (cco @ (cco @ XA2 @ XM @ ccexp) @ cc1 @ ccaddc) @ (cco @ XA2 @ cc1 @ ccaddc) @ ccdiv))) @ (cwbr @ cc2 @ XS @ ccle)))))).
