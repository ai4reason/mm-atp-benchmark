...
thf(cbnj1171_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (Xph @ Xz @ Xw) @ (Xps @ Xz @ Xw)) @ (cwss @ (XB2 @ Xz @ Xw) @ (XA2 @ Xz @ Xw))))) => ((cwex @ (^ [Xz:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwa @ (Xph @ Xz @ Xw) @ (Xps @ Xz @ Xw)) @ (cwa @ (cwcel @ (ccv @ Xz) @ (XB2 @ Xz @ Xw)) @ (cwi @ (cwcel @ (ccv @ Xw) @ (XA2 @ Xz @ Xw)) @ (cwi @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)) @ (cwn @ (cwcel @ (ccv @ Xw) @ (XB2 @ Xz @ Xw))))))))))) => (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwa @ (Xph @ Xz @ Xw) @ (Xps @ Xz @ Xw)) @ (cwa @ (cwcel @ (ccv @ Xz) @ (XB2 @ Xz @ Xw)) @ (cwi @ (cwcel @ (ccv @ Xw) @ (XB2 @ Xz @ Xw)) @ (cwn @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)))))))))))))))))).
