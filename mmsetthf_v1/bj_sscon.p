...
thf(abj_disj2r_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwb @ (cwss @ (ccin @ XA2 @ XV) @ (ccdif @ XV @ XB2)) @ (cwceq @ (ccin @ (ccin @ XA2 @ XB2) @ XV) @ cc0)))))).
thf(cbj_sscon_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwb @ (cwss @ (ccin @ XA2 @ XV) @ (ccdif @ XV @ XB2)) @ (cwss @ (ccin @ XB2 @ XV) @ (ccdif @ XV @ XA2))))))).
