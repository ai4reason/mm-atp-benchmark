...
thf(cnbusgreledg_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwb @ (cwcel @ XN @ (cco @ XG @ XK @ ccnbgr)) @ (cwcel @ (ccpr @ XN @ XK) @ XE))))))))).
