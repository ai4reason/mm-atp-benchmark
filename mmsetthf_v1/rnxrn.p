...
thf(adfrn6_thm,axiom,(! [XR:($i > $o)] : (cwceq @ (ccrn @ XR) @ (ccab @ (^ [Xx3:$i] : (cwne @ (ccec @ (ccv @ Xx3) @ (cccnv @ XR)) @ cc0)))))).
...
thf(aelec1cnvxrn2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwcel @ XB2 @ (ccec @ XA2 @ (cccnv @ (ccxrn @ XR @ XS)))) @ (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cw3a @ (cwceq @ XA2 @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwbr @ XB2 @ (ccv @ Xy1) @ XR) @ (cwbr @ XB2 @ (ccv @ Xz) @ XS)))))))))))))).
...
thf(crnxrn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwceq @ (ccrn @ (ccxrn @ XR @ XS)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwex @ (^ [Xu:$i] : (cwa @ (cwbr @ (ccv @ Xu) @ (ccv @ Xx3) @ XR) @ (cwbr @ (ccv @ Xu) @ (ccv @ Xy1) @ XS))))))))))).
