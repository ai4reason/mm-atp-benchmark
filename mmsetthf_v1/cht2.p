...
thf(achtprm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cccht) @ (cco @ (ccfv @ XA2 @ cccht) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ ccaddc))))).
...
thf(acht1_thm,axiom,(cwceq @ (ccfv @ cc1 @ cccht) @ ccc0)).
...
thf(ccht2_conj,conjecture,(cwceq @ (ccfv @ cc2 @ cccht) @ (ccfv @ cc2 @ cclog))).
