...
thf(akgenuni_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ XX @ (ccuni @ (ccfv @ XJ @ cckgen)))))))).
...
thf(aneiint_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwss @ XN @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) @ (cwss @ XS @ (ccfv @ XN @ (ccfv @ XJ @ ccnt))))))))))).
...
thf(aiskgen2_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ (ccrn @ cckgen)) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ (ccfv @ XJ @ cckgen) @ XJ))))).
thf(cllycmpkgen2_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (ccuni @ XJ))) => ((cwi @ Xph @ (cwcel @ XJ @ cctop)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XX @ Xx3))) @ (cwrex @ (^ [Xk:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp)) @ (^ [Xk:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)))))) => (cwi @ Xph @ (cwcel @ XJ @ (ccrn @ cckgen)))))))))).
