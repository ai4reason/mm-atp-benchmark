...
thf(adifioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwceq @ (ccdif @ (cco @ XA2 @ XC @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ XB2 @ XC @ ccico))))))).
...
thf(aelsigagen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XA2)) @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccsigagen))))))).
...
thf(cdya2iocbrsiga_conj,conjecture,(! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xx3 @ Xn) @ (ccfv @ (ccrn @ ccioo) @ cctg)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XI @ Xx3 @ Xn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico))))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xx3 @ Xn) @ ccz) @ (cwcel @ (XX @ Xx3 @ Xn) @ ccz)) @ (cwcel @ (cco @ (XX @ Xx3 @ Xn) @ (XN @ Xx3 @ Xn) @ (XI @ Xx3 @ Xn)) @ ccbrsiga))))))))))).
