...
thf(cccat0_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2))) @ (cwb @ (cwceq @ (cco @ XS @ XT @ ccconcat) @ cc0) @ (cwa @ (cwceq @ XS @ cc0) @ (cwceq @ XT @ cc0)))))))).
