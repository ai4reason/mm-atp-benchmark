...
thf(atngsca_thm,axiom,(! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ XF @ (ccfv @ XG @ ccsca)) => (cwi @ (cwcel @ XN @ XV) @ (cwceq @ XF @ (ccfv @ XT @ ccsca))))))))))).
...
thf(ctchsca_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => (cwceq @ XF @ (ccfv @ XG @ ccsca)))))))).
