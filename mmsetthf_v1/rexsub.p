...
thf(arexneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccxne @ XA2) @ (ccneg @ XA2))))).
...
thf(crexsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ (cco @ XA2 @ XB2 @ ccmin)))))).
