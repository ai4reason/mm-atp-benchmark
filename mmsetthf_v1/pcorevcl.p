...
thf(cpcorevcl_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ XF))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) @ (cw3a @ (cwcel @ (XG @ Xx3) @ (cco @ ccii @ XJ @ cccn)) @ (cwceq @ (ccfv @ ccc0 @ (XG @ Xx3)) @ (ccfv @ cc1 @ XF)) @ (cwceq @ (ccfv @ cc1 @ (XG @ Xx3)) @ (ccfv @ ccc0 @ XF)))))))))).
