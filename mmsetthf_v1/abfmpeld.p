...
thf(aan13s_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xth) => (cwi @ (cwa @ Xch @ (cwa @ Xps @ Xph)) @ Xth))))))).
...
thf(acsbexg_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3)))) @ (cwcel @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))))).
...
thf(cabfmpeld_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccab @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwi @ (cwa @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XB2)) @ (cwb @ (Xps @ Xx3 @ Xy1) @ Xch))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ (XW @ Xx3))) @ (cwb @ (cwcel @ XB2 @ (ccfv @ XA2 @ XF)) @ Xch)))))))))))))))).
