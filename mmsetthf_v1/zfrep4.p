...
thf(czfrep4_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : ((cwcel @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ ccvv) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (Xps @ Xx3 @ Xy1) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz))))))))) => (cwcel @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3 @ Xy1)))))) @ ccvv)))))).
