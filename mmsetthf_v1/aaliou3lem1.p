...
thf(caaliou3lem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xc:$i] : (cwceq @ (XG @ Xc) @ (ccmpt @ (^ [Xc:$i] : (ccfv @ XA2 @ ccuz)) @ (^ [Xc:$i] : (cco @ (cco @ cc2 @ (ccneg @ (ccfv @ XA2 @ ccfa)) @ ccexp) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ (ccv @ Xc) @ XA2 @ ccmin) @ ccexp) @ ccmul))))) => (! [Xc:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz))) @ (cwcel @ (ccfv @ XB2 @ (XG @ Xc)) @ ccr)))))))).
