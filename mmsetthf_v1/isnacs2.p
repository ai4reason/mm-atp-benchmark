...
thf(cisnacs2_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwb @ (cwcel @ XC @ (ccfv @ XX @ ccnacs)) @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccacs)) @ (cwceq @ (ccima @ XF @ (ccin @ (ccpw @ XX) @ ccfn)) @ XC)))))))).
