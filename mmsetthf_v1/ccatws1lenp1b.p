...
thf(cccatws1lenp1b_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwceq @ (ccfv @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ cchash) @ (cco @ XN @ cc1 @ ccaddc)) @ (cwceq @ (ccfv @ XW @ cchash) @ XN)))))))).
