...
thf(aissalgend_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xy1)))) => ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwceq @ (ccuni @ XS) @ (ccuni @ XX))) => ((cwi @ Xph @ (cwss @ XX @ XS)) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xy1) @ ccsalg) @ (cwceq @ (ccuni @ (ccv @ Xy1)) @ (ccuni @ XX)) @ (cwss @ XX @ (ccv @ Xy1)))) @ (cwss @ XS @ (ccv @ Xy1)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ ccsalgen) @ XS)))))))))))).
...
thf(cdfsalgen2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xy1)))) => (cwi @ Xph @ (cwb @ (cwceq @ (ccfv @ XX @ ccsalgen) @ XS) @ (cwa @ (cw3a @ (cwcel @ XS @ ccsalg) @ (cwceq @ (ccuni @ XS) @ (ccuni @ XX)) @ (cwss @ XX @ XS)) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwceq @ (ccuni @ (ccv @ Xy1)) @ (ccuni @ XX)) @ (cwss @ XX @ (ccv @ Xy1))) @ (cwss @ XS @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : ccsalg))))))))))).
