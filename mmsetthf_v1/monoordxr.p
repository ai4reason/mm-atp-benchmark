...
thf(cmonoordxr_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XN @ (ccfv @ XM @ ccuz)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccxr))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ (cwbr @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XF @ Xk)) @ ccle))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccfv @ XM @ (XF @ Xk)) @ (ccfv @ XN @ (XF @ Xk)) @ ccle))))))))))))).
