...
thf(aiswspthn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xf1:$i] : (cwb @ (cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwspthsn)) @ (cwa @ (cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwlksn)) @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XW @ (ccfv @ XG @ ccspths))))))))))).
thf(abitr4i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ Xps) => ((cwb @ Xch @ Xps) => (cwb @ Xph @ Xch))))))).
thf(aanbi1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ Xps) => (cwb @ (cwa @ Xph @ Xch) @ (cwa @ Xps @ Xch))))))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(ccfzo_tp,type,(ccfzo : ($i > $o))).
thf(awwlksnwwlksnon_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwb @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwlksnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
...
thf(aisspthonpth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwa @ (cwcel @ XF @ XW) @ (cwcel @ XP @ XZ))) @ (cwb @ (cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson))) @ (cw3a @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) @ (cwceq @ (ccfv @ ccc0 @ XP) @ XA2) @ (cwceq @ (ccfv @ (ccfv @ XF @ cchash) @ XP) @ XB2)))))))))))))).
...
thf(aspthiswlk_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))).
...
thf(awwlknon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwb @ (cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon))) @ (cw3a @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwceq @ (ccfv @ ccc0 @ XW) @ XA2) @ (cwceq @ (ccfv @ XN @ XW) @ XB2))))))))).
...
thf(cwspthsnwspthsnon_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwb @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwspthsn)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwspthsnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
