...
thf(atopmtcl_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwss @ XS @ (ccfv @ XX @ cctopon))) @ (cwcel @ (ccin @ (ccpw @ XX) @ (ccint @ XS)) @ (ccfv @ XX @ cctopon))))))).
...
thf(ctopmeet_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwss @ XS @ (ccfv @ XX @ cctopon))) @ (cwceq @ (ccin @ (ccpw @ XX) @ (ccint @ XS)) @ (ccuni @ (ccrab @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwss @ (ccv @ Xk) @ (ccv @ Xj))) @ (^ [Xj:$i] : XS))) @ (^ [Xk:$i] : (ccfv @ XX @ cctopon)))))))))).
