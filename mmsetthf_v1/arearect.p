...
thf(carearect_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => ((cwcel @ XD @ ccr) => ((cwbr @ XA2 @ XB2 @ ccle) => ((cwbr @ XC @ XD @ ccle) => ((cwceq @ XS @ (ccxp @ (cco @ XA2 @ XB2 @ ccicc) @ (cco @ XC @ XD @ ccicc))) => (cwceq @ (ccfv @ XS @ ccarea) @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ XD @ XC @ ccmin) @ ccmul))))))))))))))).
