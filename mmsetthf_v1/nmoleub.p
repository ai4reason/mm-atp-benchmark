...
thf(anmoi2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) @ (cwa @ (cwcel @ XX @ XV) @ (cwne @ XX @ Xc_0))) @ (cwbr @ (cco @ (ccfv @ (ccfv @ XX @ XF) @ XM) @ (ccfv @ XX @ XL) @ ccdiv) @ (ccfv @ XF @ XN) @ ccle))))))))))))))))).
...
thf(anm0_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwcel @ XG @ ccngp) @ (cwceq @ (ccfv @ Xc_0 @ XN) @ ccc0)))))))).
...
thf(anmolb_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XL) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : XV)) @ (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle)))))))))))))))).
...
thf(cnmoleub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XS @ cc0g))) => ((cwi @ Xph @ (cwcel @ XS @ ccngp)) => ((cwi @ Xph @ (cwcel @ XT @ ccngp)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwne @ (ccv @ Xx3) @ (Xc_0 @ Xx3)) @ (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ (ccfv @ (ccv @ Xx3) @ XL) @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV))))))))))))))))))))))))).
