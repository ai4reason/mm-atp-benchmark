...
thf(aorng0le1_thm,axiom,(! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XF @ ccur)) => ((cwceq @ Xc_le @ (ccfv @ XF @ ccple)) => (cwi @ (cwcel @ XF @ ccorng) @ (cwbr @ Xc_0 @ Xc_1 @ Xc_le)))))))))).
...
thf(cofldlt1_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XF @ ccur)) => ((cwceq @ Xc_lt @ (ccfv @ XF @ ccplt)) => (cwi @ (cwcel @ XF @ ccofld) @ (cwbr @ Xc_0 @ Xc_1 @ Xc_lt)))))))))).
