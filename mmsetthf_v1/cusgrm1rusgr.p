...
thf(acusgrrusgr_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) @ (cwbr @ XG @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ ccrusgr)))))).
...
thf(avdiscusgr_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ ccfusgr) @ (cwi @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin))) @ (^ [Xv:$i] : XV)) @ (cwcel @ XG @ cccusgr))))))).
thf(ccusgrm1rusgr_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwne @ XV @ cc0)) @ (cwb @ (cwcel @ XG @ cccusgr) @ (cwbr @ XG @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ ccrusgr))))))).
