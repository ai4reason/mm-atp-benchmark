...
thf(apgpfac1lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XK @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cwceq @ XS @ (ccfv @ (ccsn @ XA2) @ XK)) => ((! [Xw:$i] : (cwceq @ (XB2 @ Xw) @ (ccfv @ XG @ ccbs))) => ((! [Xw:$i] : (cwceq @ (XO @ Xw) @ (ccfv @ XG @ ccod))) => ((! [Xw:$i] : (cwceq @ (XE @ Xw) @ (ccfv @ XG @ ccgex))) => ((! [Xw:$i] : (cwceq @ (Xc_0 @ Xw) @ (ccfv @ XG @ cc0g))) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwbr @ XP @ XG @ ccpgp)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((! [Xw:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xw) @ ccfn))) => ((! [Xw:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (XO @ Xw)) @ (XE @ Xw)))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XW @ (ccfv @ XG @ ccsubg))) => ((! [Xw:$i] : (cwi @ Xph @ (cwceq @ (ccin @ XS @ XW) @ (ccsn @ (Xc_0 @ Xw))))) => ((cwi @ Xph @ (cwss @ (cco @ XS @ XW @ Xc_po) @ XU)) => ((cwi @ Xph @ (cwral @ (^ [Xw:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xw) @ XU) @ (cwcel @ XA2 @ (ccv @ Xw))) @ (cwn @ (cwpss @ (cco @ XS @ XW @ Xc_po) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccfv @ XG @ ccsubg)))) => (cwi @ (cwa @ Xph @ (cwcel @ XC @ (ccdif @ XU @ (cco @ XS @ XW @ Xc_po)))) @ (cwceq @ (cco @ (cco @ XS @ XW @ Xc_po) @ (ccfv @ (ccsn @ XC) @ XK) @ Xc_po) @ XU)))))))))))))))))))))))))))))))))).
...
thf(alsmelvalm_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (Xc_po @ Xy1 @ Xz) @ (ccfv @ XG @ cclsm)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwb @ (cwcel @ XX @ (cco @ XT @ XU @ (Xc_po @ Xy1 @ Xz))) @ (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ XX @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_mi))) @ (^ [Xz:$i] : XU))) @ (^ [Xy1:$i] : XT)))))))))))))))))).
...
thf(apgphash_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwbr @ XP @ XG @ ccpgp) @ (cwcel @ XX @ ccfn)) @ (cwceq @ (ccfv @ XX @ cchash) @ (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp)))))))).
thf(aeqtr3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XA2 @ XC)) => (cwi @ Xph @ (cwceq @ XB2 @ XC))))))))).
thf(agcdaddm_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ (cco @ XM @ (cco @ XN @ (cco @ XK @ XM @ ccmul) @ ccaddc) @ ccgcd))))))).
...
thf(arpdvds_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwceq @ (cco @ XK @ XN @ ccgcd) @ cc1) @ (cwbr @ XM @ XN @ ccdvds))) @ (cwceq @ (cco @ XK @ XM @ ccgcd) @ cc1)))))).
thf(aodbezout_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) @ cc1)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (cco @ XN @ XA2 @ Xc_x) @ Xc_x) @ XA2)) @ (^ [Xx3:$i] : ccz))))))))))))).
...
thf(cpgpfac1lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XK @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cwceq @ XS @ (ccfv @ (ccsn @ XA2) @ XK)) => ((! [Xw:$i] : (cwceq @ (XB2 @ Xw) @ (ccfv @ XG @ ccbs))) => ((! [Xw:$i] : (cwceq @ (XO @ Xw) @ (ccfv @ XG @ ccod))) => ((! [Xw:$i] : (cwceq @ (XE @ Xw) @ (ccfv @ XG @ ccgex))) => ((! [Xw:$i] : (cwceq @ (Xc_0 @ Xw) @ (ccfv @ XG @ cc0g))) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwbr @ XP @ XG @ ccpgp)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((! [Xw:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xw) @ ccfn))) => ((! [Xw:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (XO @ Xw)) @ (XE @ Xw)))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XW @ (ccfv @ XG @ ccsubg))) => ((! [Xw:$i] : (cwi @ Xph @ (cwceq @ (ccin @ XS @ XW) @ (ccsn @ (Xc_0 @ Xw))))) => ((cwi @ Xph @ (cwss @ (cco @ XS @ XW @ Xc_po) @ XU)) => ((cwi @ Xph @ (cwral @ (^ [Xw:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xw) @ XU) @ (cwcel @ XA2 @ (ccv @ Xw))) @ (cwn @ (cwpss @ (cco @ XS @ XW @ Xc_po) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccfv @ XG @ ccsubg)))) => ((cwi @ Xph @ (cwcel @ XC @ (ccdif @ XU @ (cco @ XS @ XW @ Xc_po)))) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ Xph @ (cwcel @ (cco @ XP @ XC @ Xc_x) @ (cco @ XS @ XW @ Xc_po)))))))))))))))))))))))))))))))))))))).
