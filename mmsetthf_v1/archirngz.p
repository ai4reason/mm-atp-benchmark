...
thf(aogrpinv0lt_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_lt @ (ccfv @ XG @ ccplt)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwa @ (cwcel @ XG @ ccogrp) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwbr @ Xc_0 @ XX @ Xc_lt) @ (cwbr @ (ccfv @ XX @ XI) @ Xc_0 @ Xc_lt)))))))))))))).
...
thf(atlt2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => (cwi @ (cw3a @ (cwcel @ XK @ cctos) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwo @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XY @ XX @ Xc_lt))))))))))))).
thf(aarchirng_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XB2 @ Xn) @ (ccfv @ (XW @ Xn) @ ccbs))) => ((! [Xn:$i] : (cwceq @ Xc_0 @ (ccfv @ (XW @ Xn) @ cc0g))) => ((! [Xn:$i] : (cwceq @ Xc_lt @ (ccfv @ (XW @ Xn) @ ccplt))) => ((! [Xn:$i] : (cwceq @ Xc_le @ (ccfv @ (XW @ Xn) @ ccple))) => ((! [Xn:$i] : (cwceq @ Xc_x @ (ccfv @ (XW @ Xn) @ ccmg))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XW @ Xn) @ ccogrp))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XW @ Xn) @ ccarchi))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XX @ (XB2 @ Xn)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XY @ (XB2 @ Xn)))) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XX @ Xc_lt)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XY @ Xc_lt)) => (cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (cwa @ (cwbr @ (cco @ (ccv @ Xn) @ XX @ Xc_x) @ XY @ Xc_lt) @ (cwbr @ XY @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XX @ Xc_x) @ Xc_le))) @ (^ [Xn:$i] : ccn0)))))))))))))))))))))))).
...
thf(atlt3_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => (cwi @ (cw3a @ (cwcel @ XK @ cctos) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cw3o @ (cwceq @ XX @ XY) @ (cwbr @ XX @ XY @ Xc_lt) @ (cwbr @ XY @ XX @ Xc_lt))))))))))).
thf(carchirngz_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XB2 @ Xn) @ (ccfv @ (XW @ Xn) @ ccbs))) => ((! [Xn:$i] : (cwceq @ Xc_0 @ (ccfv @ (XW @ Xn) @ cc0g))) => ((! [Xn:$i] : (cwceq @ Xc_lt @ (ccfv @ (XW @ Xn) @ ccplt))) => ((! [Xn:$i] : (cwceq @ Xc_le @ (ccfv @ (XW @ Xn) @ ccple))) => ((! [Xn:$i] : (cwceq @ Xc_x @ (ccfv @ (XW @ Xn) @ ccmg))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XW @ Xn) @ ccogrp))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XW @ Xn) @ ccarchi))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XX @ (XB2 @ Xn)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XY @ (XB2 @ Xn)))) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XX @ Xc_lt)) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XW @ Xn) @ ccoppg) @ ccogrp))) => (cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (cwa @ (cwbr @ (cco @ (ccv @ Xn) @ XX @ Xc_x) @ XY @ Xc_lt) @ (cwbr @ XY @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XX @ Xc_x) @ Xc_le))) @ (^ [Xn:$i] : ccz)))))))))))))))))))))))).
