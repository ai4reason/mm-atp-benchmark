...
thf(cdrnguc1p_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XF @ XB2) @ (cwne @ XF @ Xc_0)) @ (cwcel @ XF @ XC))))))))))))).
