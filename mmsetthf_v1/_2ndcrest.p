...
thf(arestbas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ cctb) @ (cwcel @ (cco @ XB2 @ XA2 @ ccrest) @ cctb))))).
...
thf(c_2ndcrest_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cc2ndc) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ cc2ndc)))))).
