...
thf(ansgconj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XS)) @ (cwcel @ (cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ XA2 @ Xc_mi) @ XS))))))))))))).
...
thf(cghmnsgima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XT @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XU @ (ccfv @ XS @ ccnsg)) @ (cwceq @ (ccrn @ XF) @ XY)) @ (cwcel @ (ccima @ XF @ XU) @ (ccfv @ XT @ ccnsg)))))))))).
