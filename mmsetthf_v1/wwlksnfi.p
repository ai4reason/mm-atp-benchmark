...
thf(awwlksn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ XG @ ccwwlksn) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ (cco @ XN @ cc1 @ ccaddc))) @ (^ [Xw:$i] : (ccfv @ XG @ ccwwlks)))))))).
...
thf(awrdnfi_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ XN)) @ (^ [Xw:$i] : (ccword @ XV))) @ ccfn))))).
...
thf(awwlksnndef_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwo @ (cwnel @ XG @ ccvv) @ (cwnel @ XN @ ccn0)) @ (cwceq @ (cco @ XN @ XG @ ccwwlksn) @ cc0))))).
...
thf(cwwlksnfi_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ (ccfv @ XG @ ccvtx) @ ccfn) @ (cwcel @ (cco @ XN @ XG @ ccwwlksn) @ ccfn))))).
