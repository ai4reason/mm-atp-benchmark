...
thf(clatjlej12_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => (cwi @ (cw3a @ (cwcel @ XK @ cclat) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwa @ (cwcel @ XZ @ XB2) @ (cwcel @ XW @ XB2))) @ (cwi @ (cwa @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XZ @ XW @ Xc_le)) @ (cwbr @ (cco @ XX @ XZ @ Xc_or) @ (cco @ XY @ XW @ Xc_or) @ Xc_le))))))))))))))).
