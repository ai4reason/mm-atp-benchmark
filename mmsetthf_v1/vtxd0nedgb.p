...
thf(axnn0xadd0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxnn0) @ (cwcel @ XB2 @ ccxnn0)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccxad) @ ccc0) @ (cwa @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ ccc0))))))).
...
thf(cvtxd0nedgb_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((! [Xi:$i] : (cwceq @ (XD @ Xi) @ (ccfv @ XG @ ccvtxdg))) => (! [Xi:$i] : (cwi @ (cwcel @ XU @ XV) @ (cwb @ (cwceq @ (ccfv @ XU @ (XD @ Xi)) @ ccc0) @ (cwn @ (cwrex @ (^ [Xi:$i] : (cwcel @ XU @ (ccfv @ (ccv @ Xi) @ XI))) @ (^ [Xi:$i] : (ccdm @ XI)))))))))))))))).
