...
thf(cbrcoffn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwfn @ XC @ XY)) => ((cwi @ Xph @ (cwf @ XX @ XY @ XD)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (cccom @ XC @ XD))) => (cwi @ Xph @ (cwa @ (cwbr @ XA2 @ (ccfv @ XA2 @ XD) @ XD) @ (cwbr @ (ccfv @ XA2 @ XD) @ XB2 @ XC)))))))))))))).
