...
thf(ashftfn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwfn @ XF @ XB2) @ (cwcel @ XA2 @ ccc)) @ (cwfn @ (cco @ XF @ XA2 @ ccshi) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ XB2)) @ (^ [Xx3:$i] : ccc))))))))).
...
thf(ashftuz_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccfv @ XB2 @ ccuz))) @ (^ [Xx3:$i] : ccc)) @ (ccfv @ (cco @ XB2 @ XA2 @ ccaddc) @ ccuz)))))).
...
thf(cuzmptshftfval_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ XN @ ccmin)) @ (cwceq @ (XB2 @ Xx3 @ Xy1) @ (XC @ Xy1))))) => ((! [Xx3:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : (cwceq @ (XW @ Xx3) @ (ccfv @ (cco @ (XM @ Xx3) @ XN @ ccaddc) @ ccuz))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XM @ Xx3) @ ccz))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XN @ ccz))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (cco @ (XF @ Xx3) @ XN @ ccshi) @ (ccmpt @ (^ [Xy1:$i] : (XW @ Xx3)) @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))))))))))))).
