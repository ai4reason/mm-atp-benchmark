...
thf(acdleme0ex1N_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xu:$i] : (cwceq @ Xc_le @ (ccfv @ (XK @ Xu) @ ccple))) => ((! [Xu:$i] : (cwceq @ Xc_or @ (ccfv @ (XK @ Xu) @ ccjn))) => ((! [Xu:$i] : (cwceq @ (Xc_an @ Xu) @ (ccfv @ (XK @ Xu) @ ccmee))) => ((! [Xu:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xu) @ ccatm))) => ((! [Xu:$i] : (cwceq @ (XH @ Xu) @ (ccfv @ (XK @ Xu) @ cclh))) => ((! [Xu:$i] : (cwceq @ XU @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ (Xc_an @ Xu)))) => (! [Xu:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ (XK @ Xu) @ cchlt) @ (cwcel @ XW @ (XH @ Xu))) @ (cwa @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwcel @ XQ @ XA2)) @ (cwne @ XP @ XQ)) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwbr @ (ccv @ Xu) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) @ (cwbr @ (ccv @ Xu) @ XW @ Xc_le))) @ (^ [Xu:$i] : XA2))))))))))))))))))))).
...
thf(ccdleme0ex2N_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((! [Xu:$i] : (cwceq @ (Xc_an @ Xu) @ (ccfv @ XK @ ccmee))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((! [Xu:$i] : (cwceq @ XU @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ (Xc_an @ Xu)))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le)))) @ (cwne @ XP @ XQ)) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwceq @ (cco @ XP @ (ccv @ Xu) @ Xc_or) @ (cco @ XQ @ (ccv @ Xu) @ Xc_or)) @ (cwbr @ (ccv @ Xu) @ XW @ Xc_le))) @ (^ [Xu:$i] : XA2)))))))))))))))))))).
