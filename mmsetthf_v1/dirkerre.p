...
thf(cdirkerre_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XD @ Xn @ Xs1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xn) @ ccn) @ (cwcel @ (XS @ Xn @ Xs1) @ ccr)) @ (cwcel @ (ccfv @ (XS @ Xn @ Xs1) @ (ccfv @ (XN @ Xn) @ (XD @ Xn @ Xs1))) @ ccr))))))))).
