...
thf(aspc2egv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XB2)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ Xps)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) @ (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))) @ (cwi @ Xps @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))))))))))))))).
...
thf(aovig_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XB2) @ (cwceq @ (ccv @ Xz) @ XC)) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz) @ Xps))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XR) @ (cwcel @ (ccv @ Xy1) @ XS)) @ (cwmo @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XR) @ (cwcel @ (ccv @ Xy1) @ XS)) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ XR) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ (XD @ Xx3 @ Xy1 @ Xz))) @ (cwi @ Xps @ (cwceq @ (cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) @ XC))))))))))))))))))).
...
thf(amulsrmo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer)) @ (cwcel @ XB2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer))) @ (cwmo @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xv:$i] : (cwex @ (^ [Xu:$i] : (cwex @ (^ [Xt:$i] : (cwa @ (cwa @ (cwceq @ XA2 @ (ccec @ (ccop @ (ccv @ Xw) @ (ccv @ Xv)) @ ccer)) @ (cwceq @ XB2 @ (ccec @ (ccop @ (ccv @ Xu) @ (ccv @ Xt)) @ ccer))) @ (cwceq @ (ccv @ Xz) @ (ccec @ (ccop @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccmp) @ (cco @ (ccv @ Xv) @ (ccv @ Xt) @ ccmp) @ ccpp) @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xt) @ ccmp) @ (cco @ (ccv @ Xv) @ (ccv @ Xu) @ ccmp) @ ccpp)) @ ccer))))))))))))))))).
thf(aeqtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XB2 @ XC) => (cwceq @ XA2 @ XC))))))).
thf(adf_mr_ax,axiom,(cwceq @ ccmr @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccnr) @ (cwcel @ (ccv @ Xy1) @ ccnr)) @ (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xv:$i] : (cwex @ (^ [Xu:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwa @ (cwceq @ (ccv @ Xx3) @ (ccec @ (ccop @ (ccv @ Xw) @ (ccv @ Xv)) @ ccer)) @ (cwceq @ (ccv @ Xy1) @ (ccec @ (ccop @ (ccv @ Xu) @ (ccv @ Xf1)) @ ccer))) @ (cwceq @ (ccv @ Xz) @ (ccec @ (ccop @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccmp) @ (cco @ (ccv @ Xv) @ (ccv @ Xf1) @ ccmp) @ ccpp) @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xf1) @ ccmp) @ (cco @ (ccv @ Xv) @ (ccv @ Xu) @ ccmp) @ ccpp)) @ ccer)))))))))))))))))).
...
thf(cmulsrpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp)) @ (cwa @ (cwcel @ XC @ ccnp) @ (cwcel @ XD @ ccnp))) @ (cwceq @ (cco @ (ccec @ (ccop @ XA2 @ XB2) @ ccer) @ (ccec @ (ccop @ XC @ XD) @ ccer) @ ccmr) @ (ccec @ (ccop @ (cco @ (cco @ XA2 @ XC @ ccmp) @ (cco @ XB2 @ XD @ ccmp) @ ccpp) @ (cco @ (cco @ XA2 @ XD @ ccmp) @ (cco @ XB2 @ XC @ ccmp) @ ccpp)) @ ccer)))))))).
