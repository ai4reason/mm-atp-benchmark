...
thf(acardonle_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwss @ (ccfv @ XA2 @ cccrd) @ XA2)))).
...
thf(aoncardid_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwbr @ (ccfv @ XA2 @ cccrd) @ XA2 @ ccen)))).
...
thf(calephinit_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwss @ ccom @ XA2)) @ (cwb @ (cwcel @ XA2 @ (ccrn @ ccale)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccdom) @ (cwss @ XA2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))).
