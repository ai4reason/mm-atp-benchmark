...
thf(arlimuni_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf)) => ((cwi @ Xph @ (cwbr @ XF @ XB2 @ ccrli)) => ((cwi @ Xph @ (cwbr @ XF @ XC @ ccrli)) => (cwi @ Xph @ (cwceq @ XB2 @ XC)))))))))))).
...
thf(crlimdm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ (ccdm @ ccrli)) @ (cwbr @ XF @ (ccfv @ XF @ ccrli) @ ccrli))))))))).
