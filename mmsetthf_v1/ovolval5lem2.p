...
thf(afcomptss_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ XA2 @ (XB2 @ Xx3) @ XF))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ (XB2 @ Xx3) @ XC))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ XC @ XD @ XG))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (cccom @ XG @ XF) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XG))))))))))))))))).
...
thf(aovolval5lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XW:($i > $o)] : ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (XB2 @ Xn) @ ccr))) => ((cwi @ Xph @ (cwcel @ XW @ ccrp)) => ((cwceq @ XC @ (ccrab @ (^ [Xn:$i] : (cwbr @ (XA2 @ Xn) @ (XB2 @ Xn) @ cclt)) @ (^ [Xn:$i] : ccn))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (cco @ (XA2 @ Xn) @ (cco @ XW @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (XB2 @ Xn) @ ccioo) @ ccvol))) @ ccsumge0) @ (cco @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccico) @ ccvol))) @ ccsumge0) @ XW @ ccxad) @ ccle)))))))))))).
...
thf(avolioofmpt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XA2 @ (ccxp @ ccxr @ ccxr) @ (XF @ Xx3)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cccom @ (cccom @ ccvol @ ccioo) @ (XF @ Xx3)) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc2nd) @ ccioo) @ ccvol)))))))))))).
...
thf(avolicofmpt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XA2 @ (ccxp @ ccr @ ccxr) @ (XF @ Xx3)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cccom @ (cccom @ ccvol @ ccico) @ (XF @ Xx3)) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc2nd) @ ccico) @ ccvol)))))))))))).
...
thf(covolval5lem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XQ @ Xf1 @ Xn) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) @ (cwceq @ (ccv @ Xz) @ (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xf1) @ (cwceq @ (XY @ Xf1 @ Xn) @ (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (XF @ Xz @ Xf1)) @ ccsumge0)))))) => ((! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XZ @ Xn) @ (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (XG @ Xz)) @ ccsumge0)))) => ((! [Xz:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xz @ Xf1) @ (cwf @ ccn @ (ccxp @ ccr @ ccr) @ (XF @ Xz @ Xf1))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xf1) @ (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccico @ (XF @ Xz @ Xf1))))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xz @ Xf1) @ (cwcel @ (XW @ Xf1) @ ccrp)))) => ((! [Xz:$i] : (! [Xf1:$i] : (cwceq @ (XG @ Xz) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc1st) @ (cco @ (XW @ Xf1) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc2nd))))))) => (! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xf1) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (XY @ Xf1 @ Xn) @ (XW @ Xf1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : (XQ @ Xf1 @ Xn))))))))))))))))))))))).
