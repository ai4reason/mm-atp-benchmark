...
thf(caxc5c711_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwi @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwn @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))))) @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) @ (Xph @ Xx3 @ Xy1)))))).
