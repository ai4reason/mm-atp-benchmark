...
thf(cisline4N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xp:$i] : (cwceq @ (XC @ Xp) @ (ccfv @ XK @ cccvr))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : (cwceq @ (XN @ Xp) @ (ccfv @ XK @ cclines))) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwcel @ (ccfv @ XX @ XM) @ (XN @ Xp)) @ (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XX @ (XC @ Xp))) @ (^ [Xp:$i] : XA2)))))))))))))))))).
