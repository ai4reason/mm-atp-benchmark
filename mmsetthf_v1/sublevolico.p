...
thf(csublevolico_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) @ ccle)))))))).
