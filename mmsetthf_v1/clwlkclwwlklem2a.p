...
thf(aclwlkclwwlklem2a1_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ XP @ (ccword @ (XV @ Xi))) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwi @ (cwa @ (cwceq @ (ccfv @ XP @ cclsw) @ (ccfv @ ccc0 @ XP)) @ (cwa @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (cco @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccc0 @ ccmin) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ XP) @ (ccfv @ ccc0 @ XP)) @ (ccrn @ XE)))) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)))))))))).
...
thf(aclwlkclwwlklem2a4_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ cclt) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ ccc0 @ XP)) @ (cccnv @ XE))))))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwf1 @ (ccdm @ XE) @ (XR @ Xx3) @ XE) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwi @ (cwa @ (cwceq @ (ccfv @ XP @ cclsw) @ (ccfv @ ccc0 @ XP)) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwi @ (cwcel @ (ccpr @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE)) @ (cwceq @ (ccfv @ (ccfv @ XI @ (XF @ Xx3)) @ XE) @ (ccpr @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP))))))))))))))).
