...
thf(adf_smblfn_ax,axiom,(cwceq @ ccsmblfn @ (ccmpt @ (^ [Xs1:$i] : ccsalg) @ (^ [Xs1:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xa:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (cco @ ccmnf @ (ccv @ Xa) @ ccioo)) @ (cco @ (ccv @ Xs1) @ (ccdm @ (ccv @ Xf1)) @ ccrest))) @ (^ [Xa:$i] : ccr))) @ (^ [Xf1:$i] : (cco @ ccr @ (ccuni @ (ccv @ Xs1)) @ ccpm))))))).
...
thf(cissmflem_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwceq @ XD @ (ccdm @ XF)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn)) @ (cw3a @ (cwss @ XD @ (ccuni @ XS)) @ (cwf @ XD @ ccr @ XF) @ (cwral @ (^ [Xa:$i] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xa) @ cclt)) @ (^ [Xx3:$i] : XD)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xa:$i] : ccr)))))))))))).
