...
thf(chvsub4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwa @ (cwcel @ XC @ cchil) @ (cwcel @ XD @ cchil))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccva) @ (cco @ XC @ XD @ ccva) @ ccmv) @ (cco @ (cco @ XA2 @ XC @ ccmv) @ (cco @ XB2 @ XD @ ccmv) @ ccva)))))))).
