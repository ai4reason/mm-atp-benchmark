...
thf(ameadif_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ XM))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ XM))) => ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccdif @ XA2 @ XB2) @ XM) @ (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccmin))))))))))))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(assdec_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ (cco @ XM @ XN @ ccfzo))) @ (cwss @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xm) @ XF)))) => (cwi @ Xph @ (cwss @ (ccfv @ XN @ XF) @ (ccfv @ XM @ XF)))))))))).
...
thf(ameassre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ XM))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ XM))) => (cwi @ Xph @ (cwcel @ (ccfv @ XB2 @ XM) @ ccr)))))))))))).
thf(cwnf_tp,type,(cwnf : (($i > $o) > $o))).
thf(aclimsubc1mpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (XC @ Xk) @ ccli))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XA2 @ (XB2 @ Xk) @ ccmin))) @ (cco @ XA2 @ (XC @ Xk) @ ccmin) @ ccli)))))))))))))))).
thf(anfv_thm,axiom,(! [Xph:$o] : (cwnf @ (^ [Xx3:$i] : Xph)))).
thf(aeluzelzd_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwi @ Xph @ (cwcel @ XN @ ccz))))))).
...
thf(ameaiuninc2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwceq @ XZ @ (ccfv @ XN @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (ccv @ Xn) @ XE) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE)))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM) @ XB2 @ ccle))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XS @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ ccli))))))))))))))))))).
...
thf(aclimresmpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XN @ XZ))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccfv @ XN @ ccuz)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwbr @ (XG @ Xx3) @ (XB2 @ Xx3) @ ccli) @ (cwbr @ (XF @ Xx3) @ (XB2 @ Xx3) @ ccli))))))))))))))))).
...
thf(ameadjunre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwceq @ XS @ (ccdm @ XM)) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XB2 @ XS)) => ((cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XB2 @ XM) @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ XM) @ (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccaddc)))))))))))))))).
...
thf(aiunssd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwss @ (XB2 @ Xx3) @ XC))) => (cwi @ Xph @ (cwss @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC)))))))).
...
thf(cmeaiininclem_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwceq @ XZ @ (ccfv @ XN @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE) @ (ccfv @ (ccv @ Xn) @ XE)))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XN @ ccuz))) => ((cwi @ Xph @ (cwcel @ (ccfv @ (ccfv @ XK @ XE) @ XM) @ ccr)) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdif @ (ccfv @ XK @ XE) @ (ccfv @ (ccv @ Xn) @ XE))))) => ((cwceq @ XF @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XG)))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XS @ Xn) @ (ccfv @ (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ ccli))))))))))))))))))))))).
