...
thf(cssmclslem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XD @ (ccfv @ XT @ ccmdv)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XC @ (ccfv @ XT @ ccmcls)) => ((cwi @ Xph @ (cwcel @ XT @ ccmfs)) => ((cwi @ Xph @ (cwss @ XK @ XD)) => ((cwi @ Xph @ (cwss @ XB2 @ XE)) => ((cwceq @ XH @ (ccfv @ XT @ ccmvh)) => (cwi @ Xph @ (cwss @ (ccun @ XB2 @ (ccrn @ XH)) @ (cco @ XK @ XB2 @ XC))))))))))))))))))).
