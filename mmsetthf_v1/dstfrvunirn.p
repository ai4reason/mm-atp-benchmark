...
thf(adstfrvel_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprb)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccuni @ (ccdm @ XP)))) => ((cwi @ Xph @ (cwbr @ (ccfv @ XB2 @ XX) @ XA2 @ ccle)) => (cwi @ Xph @ (cwcel @ XB2 @ (cco @ XX @ XA2 @ (ccorvc @ ccle))))))))))))))).
...
thf(cdstfrvunirn_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprb)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => (cwi @ Xph @ (cwceq @ (ccuni @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XX @ (ccv @ Xn) @ (ccorvc @ ccle)))))) @ (ccuni @ (ccdm @ XP)))))))))).
