...
thf(a_1stcelcls_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cc1stc) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ ccn @ XS @ (ccv @ Xf1)) @ (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XJ @ cclm))))))))))))).
...
thf(chausmapdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ cc1stc) @ (cwss @ XA2 @ XX)) @ (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (cco @ XA2 @ ccn @ ccmap) @ ccdom))))))).
