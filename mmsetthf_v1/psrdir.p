...
thf(cpsrdir_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (cco @ XI @ XR @ ccmps))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XI @ (XV @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XR @ ccrg))) => ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xf1:$i] : (cwceq @ (Xc_xp @ Xf1) @ (ccfv @ (XS @ Xf1) @ ccmulr))) => ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccfv @ (XS @ Xf1) @ ccbs))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XX @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XY @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XZ @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : (cwceq @ (Xc_pl @ Xf1) @ (ccfv @ (XS @ Xf1) @ ccplusg))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (cco @ (cco @ XX @ XY @ (Xc_pl @ Xf1)) @ XZ @ (Xc_xp @ Xf1)) @ (cco @ (cco @ XX @ XZ @ (Xc_xp @ Xf1)) @ (cco @ XY @ XZ @ (Xc_xp @ Xf1)) @ (Xc_pl @ Xf1)))))))))))))))))))))))))))).
