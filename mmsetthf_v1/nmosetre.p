...
thf(cnmosetre_conj,conjecture,(! [XT:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XN @ Xx3 @ Xz) @ (ccfv @ XW @ ccnmcv)))) => (cwi @ (cwa @ (cwcel @ XW @ ccnv) @ (cwf @ XX @ XY @ XT)) @ (cwss @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (XM @ Xx3 @ Xz)) @ cc1 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xz) @ XT) @ (XN @ Xx3 @ Xz))))) @ (^ [Xz:$i] : XX)))) @ ccr))))))))))).
