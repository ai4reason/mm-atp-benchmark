...
thf(csinhval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccsin) @ cci @ ccdiv) @ (cco @ (cco @ (ccfv @ XA2 @ cce) @ (ccfv @ (ccneg @ XA2) @ cce) @ ccmin) @ cc2 @ ccdiv))))).
