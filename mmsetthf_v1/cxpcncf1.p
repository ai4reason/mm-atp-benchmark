...
thf(ccxpcncf1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwss @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc)))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ cccxp))) @ (cco @ XD @ ccc @ cccncf))))))))).
