...
thf(abrssc_thm,axiom,(! [XH:($i > $o)] : (! [XJ:($i > $o)] : (cwb @ (cwbr @ XH @ XJ @ ccssc) @ (cwex @ (^ [Xt:$i] : (cwa @ (cwfn @ XJ @ (ccxp @ (ccv @ Xt) @ (ccv @ Xt))) @ (cwrex @ (^ [Xs1:$i] : (cwcel @ XH @ (ccixp @ (^ [Xx3:$i] : (ccxp @ (ccv @ Xs1) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ XJ)))))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xt))))))))))).
...
thf(csscfn1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XH @ XJ @ ccssc)) => ((cwi @ Xph @ (cwceq @ XS @ (ccdm @ (ccdm @ XH)))) => (cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS)))))))))).
