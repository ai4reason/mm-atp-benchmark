...
thf(cctbnfien_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwbr @ XX @ ccom @ ccen) @ (cwbr @ XY @ ccom @ ccen)) @ (cwa @ (cwss @ XA2 @ XX) @ (cwn @ (cwcel @ XA2 @ ccfn)))) @ (cwbr @ XA2 @ XY @ ccen)))))).
