...
thf(amhmima_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XM @ XN @ ccmhm)) @ (cwcel @ XX @ (ccfv @ XM @ ccsubmnd))) @ (cwcel @ (ccima @ XF @ XX) @ (ccfv @ XN @ ccsubmnd)))))))).
...
thf(crhmima_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XM @ XN @ ccrh)) @ (cwcel @ XX @ (ccfv @ XM @ ccsubrg))) @ (cwcel @ (ccima @ XF @ XX) @ (ccfv @ XN @ ccsubrg)))))))).
