...
thf(afnmptfvd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwfn @ XM @ XA2)) => ((! [Xi:$i] : (! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xi) @ (ccv @ Xa)) @ (cwceq @ (XD @ Xi) @ (XC @ Xa))))) => ((! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ XA2)) @ (cwcel @ (XD @ Xi) @ XU))) => ((! [Xa:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xa) @ XA2)) @ (cwcel @ (XC @ Xa) @ XV))) => (cwi @ Xph @ (cwb @ (cwceq @ XM @ (ccmpt @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (XC @ Xa)))) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XM) @ (XD @ Xi))) @ (^ [Xi:$i] : XA2)))))))))))))))).
