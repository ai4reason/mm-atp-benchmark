...
thf(csgnsval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_lt @ (ccfv @ XR @ ccplt)) => ((cwceq @ XS @ (ccfv @ XR @ ccsgns)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ XX @ XS) @ (ccif @ (cwceq @ XX @ Xc_0) @ ccc0 @ (ccif @ (cwbr @ Xc_0 @ XX @ Xc_lt) @ cc1 @ (ccneg @ cc1))))))))))))))))).
