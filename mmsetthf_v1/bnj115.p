...
thf(cbnj115_conj,conjecture,(! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [Xet:($i > $o)] : (! [XD:($i > ($i > $o))] : ((! [Xn:$i] : (cwb @ (Xet @ Xn) @ (cwral @ (^ [Xn:$i] : (cwi @ (Xta @ Xn) @ (Xth @ Xn))) @ (^ [Xn:$i] : (XD @ Xn))))) => (! [Xn:$i] : (cwb @ (Xet @ Xn) @ (cwal @ (^ [Xn:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xn) @ (XD @ Xn)) @ (Xta @ Xn)) @ (Xth @ Xn)))))))))))).
