...
thf(advres2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XS @ ccc) @ (cwf @ XA2 @ ccc @ XF)) @ (cwa @ (cwss @ XA2 @ XS) @ (cwss @ XB2 @ XS))) @ (cwss @ (ccres @ (cco @ XS @ XF @ ccdv) @ XB2) @ (cco @ XB2 @ (ccres @ XF @ XB2) @ ccdv)))))))).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(afunssres_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ XG @ XF)) @ (cwceq @ (ccres @ XF @ (ccdm @ XG)) @ XG))))).
thf(cdvres3a_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwf @ XA2 @ ccc @ XF)) @ (cwa @ (cwcel @ XA2 @ XJ) @ (cwceq @ (ccdm @ (cco @ ccc @ XF @ ccdv)) @ XA2))) @ (cwceq @ (cco @ XS @ (ccres @ XF @ XS) @ ccdv) @ (ccres @ (cco @ ccc @ XF @ ccdv) @ XS))))))))).
