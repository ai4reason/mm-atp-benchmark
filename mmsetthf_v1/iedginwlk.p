...
thf(ciedginwlk_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwfun @ XI) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwcel @ XX @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) @ (cwcel @ (ccfv @ (ccfv @ XX @ XF) @ XI) @ (ccrn @ XI)))))))))).
