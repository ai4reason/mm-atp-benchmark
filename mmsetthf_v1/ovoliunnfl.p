...
thf(covoliunnfl_conj,conjecture,(! [XA2:($i > $o)] : ((! [Xf1:$i] : (cwi @ (cwa @ (cwfn @ (ccv @ Xf1) @ ccn) @ (cwral @ (^ [Xn:$i] : (cwa @ (cwss @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ ccr) @ (cwcel @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ ccovol) @ ccr))) @ (^ [Xn:$i] : ccn))) @ (cwbr @ (ccfv @ (cciun @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xm) @ (ccv @ Xf1)))) @ ccovol) @ (ccsup @ (ccrn @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccfv @ (ccfv @ (ccv @ Xm) @ (ccv @ Xf1)) @ ccovol))) @ cc1)) @ ccxr @ cclt) @ ccle))) => (cwi @ (cwa @ (cwbr @ XA2 @ ccn @ ccdom) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ ccn @ ccdom)) @ (^ [Xx3:$i] : XA2))) @ (cwne @ (ccuni @ XA2) @ ccr))))).
