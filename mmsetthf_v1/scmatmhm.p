...
thf(ascmatscmiddistr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XA2 @ ccur)) => ((cwceq @ Xc_as @ (ccfv @ XA2 @ ccvsca)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_xp @ (ccfv @ XA2 @ ccmulr)) => (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwa @ (cwcel @ XS @ XB2) @ (cwcel @ XT @ XB2))) @ (cwceq @ (cco @ (cco @ XS @ Xc_1 @ Xc_as) @ (cco @ XT @ Xc_1 @ Xc_as) @ Xc_xp) @ (cco @ (cco @ XS @ XT @ Xc_x) @ Xc_1 @ Xc_as)))))))))))))))))))))).
...
thf(cscmatmhm_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (cco @ XN @ XR @ ccmat))) => ((! [Xx3:$i] : (cwceq @ Xc_1 @ (ccfv @ (XA2 @ Xx3) @ ccur))) => ((! [Xx3:$i] : (cwceq @ Xc_as @ (ccfv @ (XA2 @ Xx3) @ ccvsca))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_1 @ Xc_as))))) => ((cwceq @ XC @ (cco @ XN @ XR @ ccscmat)) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (cco @ (XA2 @ Xx3) @ XC @ ccress))) => ((! [Xx3:$i] : (cwceq @ (XM @ Xx3) @ (ccfv @ XR @ ccmgp))) => ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccfv @ (XS @ Xx3) @ ccmgp))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwcel @ (XF @ Xx3) @ (cco @ (XM @ Xx3) @ (XT @ Xx3) @ ccmhm))))))))))))))))))))))))).
