...
thf(cvtxdg0e_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XU @ XV) @ (cwceq @ XI @ cc0)) @ (cwceq @ (ccfv @ XU @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))))).
