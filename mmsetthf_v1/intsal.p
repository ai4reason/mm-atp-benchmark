...
thf(aintsaluni_thm,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XG @ ccsalg)) => ((cwi @ Xph @ (cwne @ XG @ cc0)) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xs1) @ XG)) @ (cwceq @ (ccuni @ (ccv @ Xs1)) @ XX))) => (cwi @ Xph @ (cwceq @ (ccuni @ (ccint @ XG)) @ XX))))))))).
thf(aadantll_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ (cwa @ Xth @ Xph) @ Xps) @ Xch))))))).
thf(aimp_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(aelinti_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccint @ XB2)) @ (cwi @ (cwcel @ XC @ XB2) @ (cwcel @ XA2 @ XC))))))).
...
thf(asalunicl_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XT @ (ccpw @ XS))) => ((cwi @ Xph @ (cwbr @ XT @ ccom @ ccdom)) => (cwi @ Xph @ (cwcel @ (ccuni @ XT) @ XS))))))))).
...
thf(cintsal_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XG @ ccsalg)) => ((cwi @ Xph @ (cwne @ XG @ cc0)) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xs1) @ XG)) @ (cwceq @ (ccuni @ (ccv @ Xs1)) @ XX))) => (cwi @ Xph @ (cwcel @ (ccint @ XG) @ ccsalg))))))))).
