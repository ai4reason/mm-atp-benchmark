...
thf(aqdensere_thm,axiom,(cwceq @ (ccfv @ ccq @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccl)) @ ccr)).
thf(cqdensere2_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XD @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwceq @ (ccfv @ ccq @ (ccfv @ XJ @ cccl)) @ ccr)))))).
