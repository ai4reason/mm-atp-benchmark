...
thf(annmsucr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwceq @ (cco @ (ccsuc @ XA2) @ XB2 @ ccomu) @ (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XB2 @ ccoa)))))).
...
thf(cnnmcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccomu) @ (cco @ XB2 @ XA2 @ ccomu)))))).
