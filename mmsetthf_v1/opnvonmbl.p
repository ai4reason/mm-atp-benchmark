...
thf(aopnvonmbllem2_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwceq @ XS @ (ccdm @ (ccfv @ XX @ ccvoln))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ (ccfv @ XX @ ccrrx) @ cctopn))) => ((cwceq @ XK @ (ccrab @ (^ [Xh:$i] : (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))) @ XG)) @ (^ [Xh:$i] : (cco @ (ccxp @ ccq @ ccq) @ XX @ ccmap)))) => (cwi @ Xph @ (cwcel @ XG @ XS)))))))))))).
...
thf(copnvonmbl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwceq @ XS @ (ccdm @ (ccfv @ XX @ ccvoln))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ (ccfv @ XX @ ccrrx) @ cctopn))) => (cwi @ Xph @ (cwcel @ XG @ XS)))))))))).
