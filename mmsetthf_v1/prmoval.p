...
thf(adf_prmo_ax,axiom,(cwceq @ ccprmo @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (ccv @ Xk) @ cc1))))))).
...
thf(cprmoval_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ XN @ ccprmo) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (ccv @ Xk) @ cc1))))))).
