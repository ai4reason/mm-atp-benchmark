...
thf(asmfid_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XJ @ Xx3) @ ccsalgen))) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))) @ (ccfv @ (XB2 @ Xx3) @ ccsmblfn)))))))))))).
thf(csmf2id_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XJ @ Xx3) @ ccsalgen))) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (ccfv @ (XB2 @ Xx3) @ ccsmblfn)))))))))))).
