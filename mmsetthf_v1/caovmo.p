...
thf(ccaovmo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ XS) => ((cwceq @ (ccdm @ XF) @ (ccxp @ XS @ XS)) => ((cwn @ (cwcel @ cc0 @ XS)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ (ccv @ Xz) @ XF) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XF) @ XF))))) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwceq @ (cco @ (ccv @ Xx3) @ XB2 @ XF) @ (ccv @ Xx3)))) => (cwmo @ (^ [Xw:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xw) @ XF) @ XB2)))))))))))))).
