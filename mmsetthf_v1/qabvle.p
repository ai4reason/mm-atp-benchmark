...
thf(aqrng1_thm,axiom,(! [XQ:($i > $o)] : ((cwceq @ XQ @ (cco @ cccnfld @ ccq @ ccress)) => (cwceq @ cc1 @ (ccfv @ XQ @ ccur))))).
...
thf(cqabvle_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (cco @ cccnfld @ ccq @ ccress)) => ((cwceq @ XA2 @ (ccfv @ XQ @ ccabv)) => (cwi @ (cwa @ (cwcel @ XF @ XA2) @ (cwcel @ XN @ ccn0)) @ (cwbr @ (ccfv @ XN @ XF) @ XN @ ccle))))))))).
