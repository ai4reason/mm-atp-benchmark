...
thf(cisercolllem1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (cwi @ Xph @ (cwf @ ccn @ (XZ @ Xk) @ XG))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt))) => (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwss @ (XS @ Xk) @ ccn)) @ (cwiso @ (XS @ Xk) @ (ccima @ XG @ (XS @ Xk)) @ cclt @ cclt @ (ccres @ XG @ (XS @ Xk))))))))))))))).
