...
thf(adf_oppr_ax,axiom,(cwceq @ ccoppr @ (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (cco @ (ccv @ Xf1) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (cctpos @ (ccfv @ (ccv @ Xf1) @ ccmulr))) @ ccsts))))).
...
thf(copprval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => (cwceq @ XO @ (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (cctpos @ Xc_x)) @ ccsts)))))))))).
