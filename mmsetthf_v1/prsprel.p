...
thf(cprsprel_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ (ccpr @ XX @ XY) @ (ccfv @ XV @ ccspr)) @ (cwa @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XW))) @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV))))))))).
