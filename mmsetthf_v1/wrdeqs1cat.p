...
thf(a_1elfz0hash_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) @ (cwcel @ cc1 @ (cco @ ccc0 @ (ccfv @ XA2 @ cchash) @ ccfz))))).
...
thf(aswrds1_thm,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XA2)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwceq @ (cco @ XW @ (ccop @ XI @ (cco @ XI @ cc1 @ ccaddc)) @ ccsubstr) @ (ccs1 @ (ccfv @ XI @ XW)))))))).
...
thf(cwrdeqs1cat_conj,conjecture,(! [XA2:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XA2)) @ (cwne @ XW @ cc0)) @ (cwceq @ XW @ (cco @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ (cco @ XW @ (ccop @ cc1 @ (ccfv @ XW @ cchash)) @ ccsubstr) @ ccconcat)))))).
