...
thf(afprodcnv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccop @ (ccv @ Xj) @ (ccv @ Xk))) @ (cwceq @ (XB2 @ Xx3) @ (XD @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccop @ (ccv @ Xk) @ (ccv @ Xj))) @ (cwceq @ (XC @ Xx3 @ Xy1) @ (XD @ Xj @ Xk))))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ (XA2 @ Xj @ Xk) @ ccfn)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwrel @ (XA2 @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xj @ Xk) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xj @ Xk))) @ (cwcel @ (XB2 @ Xx3) @ ccc))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwceq @ (ccprod @ (^ [Xx3:$i] : (XA2 @ Xj @ Xk)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccprod @ (^ [Xy1:$i] : (cccnv @ (XA2 @ Xj @ Xk))) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))))))))))))))).
...
thf(arspce_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ (Xps @ Xx3)) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))))).
...
thf(afprod2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccop @ (ccv @ Xj) @ (ccv @ Xk))) @ (cwceq @ (XD @ Xz) @ (XC @ Xj @ Xk)))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (XB2 @ Xj) @ ccfn))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xj)))) @ (cwcel @ (XC @ Xj @ Xk) @ ccc)))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (XB2 @ Xj)) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))) @ (ccprod @ (^ [Xz:$i] : (cciun @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccxp @ (ccsn @ (ccv @ Xj)) @ (XB2 @ Xj))))) @ (^ [Xz:$i] : (XD @ Xz))))))))))))))).
thf(acbvprodi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XB2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XC @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (cwceq @ (XB2 @ Xj @ Xk) @ (XC @ Xj @ Xk))))) => (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xj @ Xk))) @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))))))))))).
...
thf(aprodeq12dv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwceq @ (XC @ Xk) @ (XD @ Xk)))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XD @ Xk))))))))))))).
thf(cfprodcom2OLD_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XC @ ccfn)) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (XB2 @ Xj) @ ccfn))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xj))) @ (cwa @ (cwcel @ (ccv @ Xk) @ XC) @ (cwcel @ (ccv @ Xj) @ (XD @ Xk))))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xj)))) @ (cwcel @ (XE @ Xj @ Xk) @ ccc)))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (XB2 @ Xj)) @ (^ [Xk:$i] : (XE @ Xj @ Xk))))) @ (ccprod @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (ccprod @ (^ [Xj:$i] : (XD @ Xk)) @ (^ [Xj:$i] : (XE @ Xj @ Xk))))))))))))))))))).
