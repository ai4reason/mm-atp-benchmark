...
thf(asdomen1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwb @ (cwbr @ XA2 @ XC @ ccsdm) @ (cwbr @ XB2 @ XC @ ccsdm))))))).
thf(ccsuc_tp,type,(ccsuc : (($i > $o) > ($i > $o)))).
thf(a_1on_thm,axiom,(cwcel @ cc1o @ ccon0)).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(aunfi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccsdm) @ (cwbr @ XB2 @ ccom @ ccsdm)) @ (cwbr @ (ccun @ XA2 @ XB2) @ ccom @ ccsdm))))).
thf(ccdafi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccsdm) @ (cwbr @ XB2 @ ccom @ ccsdm)) @ (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ ccom @ ccsdm))))).
