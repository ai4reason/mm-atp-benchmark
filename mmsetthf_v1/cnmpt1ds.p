...
thf(amsdcn_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XM @ ccbs)) => ((cwceq @ XD @ (ccfv @ XM @ ccds)) => ((cwceq @ XJ @ (ccfv @ XM @ cctopn)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwi @ (cwcel @ XM @ ccmt) @ (cwcel @ (ccres @ XD @ (ccxp @ XX @ XX)) @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn))))))))))))).
thf(ccnmpt1ds_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccfv @ XG @ ccds)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ XR @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwi @ Xph @ (cwcel @ XG @ ccmt)) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XK @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XK @ XJ @ cccn))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XD))) @ (cco @ XK @ XR @ cccn)))))))))))))))))))).
