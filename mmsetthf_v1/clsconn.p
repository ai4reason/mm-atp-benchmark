...
thf(cclsconn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XA2 @ XX) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn)) @ (cwcel @ (cco @ XJ @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ ccrest) @ ccconn)))))).
