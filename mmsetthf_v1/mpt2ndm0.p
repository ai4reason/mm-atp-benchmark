...
thf(anssdmovg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ (ccdm @ XF) @ (ccxp @ XR @ XS)) @ (cwn @ (cwa @ (cwcel @ XA2 @ XR) @ (cwcel @ XB2 @ XS)))) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ cc0)))))))).
thf(cmpt2ndm0_conj,conjecture,(! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwn @ (cwa @ (cwcel @ (XV @ Xx3 @ Xy1) @ XX) @ (cwcel @ (XW @ Xx3 @ Xy1) @ XY))) @ (cwceq @ (cco @ (XV @ Xx3 @ Xy1) @ (XW @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) @ cc0)))))))))))).
