...
thf(aleordtval_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioc)))))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ ccmnf @ (ccv @ Xx3) @ ccico)))))) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccrn @ ccioo))) => (! [Xx3:$i] : (cwceq @ (ccfv @ ccle @ ccordt) @ (ccfv @ (ccun @ (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (XC @ Xx3)) @ cctg)))))))))).
...
thf(axrmax1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwbr @ XA2 @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XB2 @ XA2) @ ccle))))).
thf(age0gtmnf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwbr @ ccmnf @ XA2 @ cclt)))).
...
thf(axrmax2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwbr @ XB2 @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XB2 @ XA2) @ ccle))))).
...
thf(apnfnlt_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwn @ (cwbr @ ccpnf @ XA2 @ cclt))))).
...
thf(cpnfnei_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ ccle @ ccordt)) @ (cwcel @ ccpnf @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioc) @ XA2)) @ (^ [Xx3:$i] : ccr))))).
