...
thf(ashftval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ XB2 @ (cco @ XF @ XA2 @ ccshi)) @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ XF)))))))).
...
thf(aisershft_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ (ccseq @ Xc_pl @ XF @ XM) @ XA2 @ ccli) @ (cwbr @ (ccseq @ Xc_pl @ (cco @ XF @ XN @ ccshi) @ (cco @ XM @ XN @ ccaddc)) @ XA2 @ ccli)))))))))).
...
thf(asersub_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XH) @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (ccseq @ ccaddc @ XH @ XM)) @ (cco @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ ccaddc @ XG @ XM)) @ ccmin)))))))))))))).
...
thf(cabelthlem6_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ ccn0 @ ccc @ XA2))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XM @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ ccc0 @ XM @ ccle))) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ cc1 @ (ccv @ Xz) @ ccmin) @ ccabs) @ (cco @ XM @ (cco @ cc1 @ (ccfv @ (ccv @ Xz) @ ccabs) @ ccmin) @ ccmul) @ ccle)) @ (^ [Xz:$i] : ccc)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xz @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (XS @ Xz)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul))))))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccseq @ ccaddc @ XA2 @ ccc0) @ ccc0 @ ccli))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XX @ (ccdif @ (XS @ Xz) @ (ccsn @ cc1))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz) @ (cwceq @ (ccfv @ XX @ (XF @ Xx3 @ Xz @ Xn)) @ (cco @ (cco @ cc1 @ XX @ ccmin) @ (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (ccseq @ ccaddc @ XA2 @ ccc0)) @ (cco @ XX @ (ccv @ Xn) @ ccexp) @ ccmul))) @ ccmul))))))))))))))))))))).
