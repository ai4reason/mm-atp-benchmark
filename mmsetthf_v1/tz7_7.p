...
thf(atz7_5_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cword @ (XA2 @ Xx3)) @ (cwss @ XB2 @ (XA2 @ Xx3)) @ (cwne @ XB2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ XB2 @ (ccv @ Xx3)) @ cc0)) @ (^ [Xx3:$i] : XB2))))))).
...
thf(awecmpep_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwwe @ (XA2 @ Xx3 @ Xy1) @ ccep) @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (XA2 @ Xx3 @ Xy1)))) @ (cw3o @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))).
thf(aad2antrl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xch @ (cwa @ Xph @ Xth)) @ Xps))))))).
thf(ctz7_7_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cwtr @ XB2)) @ (cwb @ (cwcel @ XB2 @ XA2) @ (cwa @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ XA2))))))).
