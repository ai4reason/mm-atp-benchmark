...
thf(cfta1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XR @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0))) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwne @ XF @ cc0p)) @ (cwa @ (cwcel @ XR @ ccfn) @ (cwbr @ (ccfv @ XR @ cchash) @ (ccfv @ XF @ ccdgr) @ ccle)))))))).
