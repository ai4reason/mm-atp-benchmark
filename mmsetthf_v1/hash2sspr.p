...
thf(chash2sspr_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ (ccpw @ XV)) @ (cwceq @ (ccfv @ XP @ cchash) @ cc2)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ XP @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))).
