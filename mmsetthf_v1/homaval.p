...
thf(ahomafval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccfv @ XC @ cchoma))) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XC @ cchom))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccxp @ XB2 @ XB2)) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xx3) @ (XJ @ Xx3)))))))))))))))))).
...
thf(chomaval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XC @ cchoma)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XJ @ (ccfv @ XC @ cchom)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ XH) @ (ccxp @ (ccsn @ (ccop @ XX @ XY)) @ (cco @ XX @ XY @ XJ)))))))))))))))))).
