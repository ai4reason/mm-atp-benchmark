...
thf(acnvuni_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (cccnv @ (ccuni @ XA2)) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cccnv @ (ccv @ Xx3))))))).
...
thf(cfuncnvuni_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xf1:$i] : (cwa @ (cwfun @ (cccnv @ (ccv @ Xf1))) @ (cwral @ (^ [Xg1:$i] : (cwo @ (cwss @ (ccv @ Xf1) @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xf1)))) @ (^ [Xg1:$i] : XA2)))) @ (^ [Xf1:$i] : XA2)) @ (cwfun @ (cccnv @ (ccuni @ XA2)))))).
