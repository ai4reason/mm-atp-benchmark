...
thf(ccplem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwne @ (XB2 @ Xx3) @ cc0) @ (cwne @ (ccin @ (XB2 @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xx3:$i] : XA2)))))))).
