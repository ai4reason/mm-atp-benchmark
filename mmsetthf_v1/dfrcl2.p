...
thf(adf_rcl_ax,axiom,(cwceq @ ccrcl @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccab @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (ccv @ Xz)) @ (ccrn @ (ccv @ Xz)))) @ (ccv @ Xz)))))))))).
...
thf(cdfrcl2_conj,conjecture,(cwceq @ ccrcl @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccun @ (ccres @ ccid @ (ccun @ (ccdm @ (ccv @ Xx3)) @ (ccrn @ (ccv @ Xx3)))) @ (ccv @ Xx3)))))).
