...
thf(cpmtrdifellem1_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XT @ (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccpmtr))) => ((cwceq @ XR @ (ccrn @ (ccfv @ XN @ ccpmtr))) => ((cwceq @ XS @ (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ XN @ ccpmtr))) => (cwi @ (cwcel @ XQ @ XT) @ (cwcel @ XS @ XR)))))))))))).
