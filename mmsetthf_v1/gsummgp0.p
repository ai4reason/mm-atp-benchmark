...
thf(cgsummgp0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (cwceq @ XG @ (ccfv @ (XR @ Xi) @ ccmgp))) => ((! [Xi:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xi) @ cc0g))) => ((! [Xi:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xi) @ cccrg))) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XN)) @ (cwcel @ (XA2 @ Xn) @ (ccfv @ (XR @ Xi) @ ccbs))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xn) @ (ccv @ Xi))) @ (cwceq @ (XA2 @ Xn) @ (XB2 @ Xi))))) => ((cwi @ Xph @ (cwrex @ (^ [Xi:$i] : (cwceq @ (XB2 @ Xi) @ Xc_0)) @ (^ [Xi:$i] : XN))) => (cwi @ Xph @ (cwceq @ (cco @ XG @ (ccmpt @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccgsu) @ Xc_0))))))))))))))))).
