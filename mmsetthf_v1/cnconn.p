...
thf(ccnconn_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cw3a @ (cwcel @ XJ @ ccconn) @ (cwfo @ XX @ XY @ XF) @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) @ (cwcel @ XK @ ccconn))))))))).
