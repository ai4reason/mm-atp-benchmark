...
thf(aanc2r_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwi @ Xph @ (cwi @ Xps @ Xch)) @ (cwi @ Xph @ (cwi @ Xps @ (cwa @ Xch @ Xph)))))))).
...
thf(cssorduni_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccon0) @ (cword @ (ccuni @ XA2))))).
