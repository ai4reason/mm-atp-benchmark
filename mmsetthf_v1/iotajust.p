...
thf(ciotajust_conj,conjecture,(! [Xph:($i > $o)] : (cwceq @ (ccuni @ (ccab @ (^ [Xy1:$i] : (cwceq @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccsn @ (ccv @ Xy1)))))) @ (ccuni @ (ccab @ (^ [Xz:$i] : (cwceq @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccsn @ (ccv @ Xz))))))))).
