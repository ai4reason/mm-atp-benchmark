...
thf(atailfval_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwcel @ XD @ ccdir) @ (cwceq @ (ccfv @ XD @ cctail) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccima @ XD @ (ccsn @ (ccv @ Xx3))))))))))).
thf(ctailf_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwcel @ XD @ ccdir) @ (cwf @ XX @ (ccpw @ XX) @ (ccfv @ XD @ cctail))))))).
