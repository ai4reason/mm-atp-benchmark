...
thf(aodcong_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz))) @ (cwb @ (cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XM @ XN @ ccmin) @ ccdvds) @ (cwceq @ (cco @ XM @ XA2 @ Xc_x) @ (cco @ XN @ XA2 @ Xc_x))))))))))))))))).
...
thf(aodcl2_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XA2 @ XX)) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn))))))))).
...
thf(acxpne0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwne @ (cco @ XA2 @ XB2 @ cccxp) @ ccc0))))))))).
...
thf(aroot1eq1_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccz)) @ (cwb @ (cwceq @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ XK @ ccexp) @ cc1) @ (cwbr @ XN @ XK @ ccdvds)))))).
...
thf(cdchrptlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XZ:($i > $o)] : ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xu @ Xh @ Xk @ Xm @ Xn) @ (ccfv @ (XN @ Xu @ Xh @ Xk @ Xm @ Xn) @ ccdchr))))))) => ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xu @ Xh @ Xk @ Xm @ Xn) @ cczn))))))) => ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xu @ Xh @ Xk @ Xm @ Xn) @ (ccfv @ (XG @ Xu @ Xh @ Xk @ Xm @ Xn) @ ccbs))))))) => ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xu @ Xh @ Xk @ Xm @ Xn) @ (ccfv @ XZ @ ccbs))))))) => ((! [Xu:$i] : (cwceq @ (Xc_1 @ Xu) @ (ccfv @ XZ @ ccur))) => ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XN @ Xu @ Xh @ Xk @ Xm @ Xn) @ ccn))))))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwne @ XA2 @ (Xc_1 @ Xu)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XU @ Xk @ Xn) @ (ccfv @ XZ @ ccui)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ XH @ (cco @ (ccfv @ XZ @ ccmgp) @ (XU @ Xk @ Xn) @ ccress)))) => ((cwceq @ Xc_x @ (ccfv @ XH @ ccmg)) => ((cwceq @ XS @ (ccmpt @ (^ [Xk:$i] : (ccdm @ XW)) @ (^ [Xk:$i] : (ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xk) @ XW) @ Xc_x))))))) => ((! [Xu:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ (XU @ Xk @ Xn)))))) => ((! [Xu:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XW @ (ccword @ (XU @ Xk @ Xn))))))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ XH @ XS @ (ccdm @ ccdprd)))) => ((! [Xu:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwceq @ (cco @ XH @ XS @ ccdprd) @ (XU @ Xk @ Xn)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XP @ Xk @ Xn) @ (cco @ XH @ XS @ ccdpj)))) => ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XO @ Xu @ Xh @ Xk @ Xm @ Xn) @ (ccfv @ XH @ ccod))))))) => ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xk @ Xn) @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ (ccfv @ (ccfv @ (XI @ Xn) @ XW) @ (XO @ Xu @ Xh @ Xk @ Xm @ Xn)) @ ccdiv) @ cccxp))))))) => ((! [Xu:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XI @ Xn) @ (ccdm @ XW))))) => ((! [Xu:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwne @ (ccfv @ XA2 @ (ccfv @ (XI @ Xn) @ (XP @ Xk @ Xn))) @ (Xc_1 @ Xu)))))) => ((! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XX @ Xu @ Xh @ Xk @ Xm @ Xn) @ (ccmpt @ (^ [Xu:$i] : (XU @ Xk @ Xn)) @ (^ [Xu:$i] : (ccio @ (^ [Xh:$i] : (cwrex @ (^ [Xm:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xu) @ (ccfv @ (XI @ Xn) @ (XP @ Xk @ Xn))) @ (cco @ (ccv @ Xm) @ (ccfv @ (XI @ Xn) @ XW) @ Xc_x)) @ (cwceq @ (ccv @ Xh) @ (cco @ (XT @ Xk @ Xn) @ (ccv @ Xm) @ ccexp)))) @ (^ [Xm:$i] : ccz)))))))))))) => (! [Xu:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xu) @ (cwcel @ (XC @ Xk @ Xn) @ (XU @ Xk @ Xn))) @ (cwa @ (cwcel @ (XM @ Xu @ Xk @ Xn) @ ccz) @ (cwceq @ (ccfv @ (XC @ Xk @ Xn) @ (ccfv @ (XI @ Xn) @ (XP @ Xk @ Xn))) @ (cco @ (XM @ Xu @ Xk @ Xn) @ (ccfv @ (XI @ Xn) @ XW) @ Xc_x)))) @ (cwceq @ (ccfv @ (XC @ Xk @ Xn) @ (XX @ Xu @ Xh @ Xk @ Xm @ Xn)) @ (cco @ (XT @ Xk @ Xn) @ (XM @ Xu @ Xk @ Xn) @ ccexp)))))))))))))))))))))))))))))))))))))))))))))))))).
