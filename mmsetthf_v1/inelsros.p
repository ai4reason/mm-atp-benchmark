...
thf(cinelsros_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : (cwceq @ (XN @ Xx3 @ Xy1 @ Xz @ Xt @ Xs1) @ (ccrab @ (^ [Xs1:$i] : (cwa @ (cwcel @ cc0 @ (ccv @ Xs1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xs1)) @ (cwrex @ (^ [Xz:$i] : (cw3a @ (cwcel @ (ccv @ Xz) @ ccfn) @ (cwdisj @ (^ [Xt:$i] : (ccv @ Xz)) @ (^ [Xt:$i] : (ccv @ Xt))) @ (cwceq @ (ccdif @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccuni @ (ccv @ Xz))))) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xs1)))))) @ (^ [Xy1:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ (XO @ Xx3 @ Xy1 @ Xz @ Xt))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xs1:$i] : (cwi @ (cw3a @ (cwcel @ (XS @ Xt) @ (XN @ Xx3 @ Xy1 @ Xz @ Xt @ Xs1)) @ (cwcel @ (XA2 @ Xt @ Xs1) @ (XS @ Xt)) @ (cwcel @ (XB2 @ Xx3 @ Xt @ Xs1) @ (XS @ Xt))) @ (cwcel @ (ccin @ (XA2 @ Xt @ Xs1) @ (XB2 @ Xx3 @ Xt @ Xs1)) @ (XS @ Xt))))))))))))))).
