...
thf(cclwwlknonOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xw)) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XX)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn)))))))))))).
