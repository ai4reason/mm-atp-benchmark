...
thf(cfh1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwa @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ XA2 @ XC @ cccm))) @ (cwceq @ (ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) @ (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj))))))).
