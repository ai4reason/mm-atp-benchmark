...
thf(ccyggex2_conj,conjecture,(! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => (cwi @ (cwcel @ XG @ cccyg) @ (cwceq @ XE @ (ccif @ (cwcel @ XB2 @ ccfn) @ (ccfv @ XB2 @ cchash) @ ccc0))))))))).
