...
thf(apcl0N_thm,axiom,(! [XU:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwcel @ XK @ cchlt) @ (cwceq @ (ccfv @ cc0 @ XU) @ cc0)))))).
thf(a_0psubclN_thm,axiom,(! [XC:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => (cwi @ (cwcel @ XK @ cchlt) @ (cwcel @ cc0 @ XC)))))).
...
thf(aatpsubclN_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XQ @ XA2)) @ (cwcel @ (ccsn @ XQ) @ XC))))))))).
...
thf(apclssidN_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwcel @ XK @ XV) @ (cwss @ XX @ XA2)) @ (cwss @ XX @ (ccfv @ XX @ XU))))))))))).
...
thf(apaddunssN_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cw3a @ (cwcel @ XK @ XB2) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) @ (cwss @ (ccun @ XX @ XY) @ (cco @ XX @ XY @ Xc_pl)))))))))))).
...
thf(apsubclsubN_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XC)) @ (cwcel @ XX @ XS))))))))).
...
thf(apcl0bN_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwss @ XP @ XA2)) @ (cwb @ (cwceq @ (ccfv @ XP @ XU) @ cc0) @ (cwceq @ XP @ cc0)))))))))).
...
thf(aexp520_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cwa @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xth @ Xta)) @ Xet) => (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))))))))))))).
...
thf(aelpcliN_thm,axiom,(! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ XV) @ (cwss @ XX @ XY) @ (cwcel @ XY @ XS)) @ (cwcel @ XQ @ (ccfv @ XX @ XU))) @ (cwcel @ XQ @ XY)))))))))))).
...
thf(apsubspi2N_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ XD) @ (cwcel @ XX @ XS) @ (cwcel @ XP @ XA2)) @ (cw3a @ (cwcel @ XQ @ XX) @ (cwcel @ XR @ XX) @ (cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le))) @ (cwcel @ XP @ XX))))))))))))))))).
thf(asylib_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwb @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => (cwi @ Xph @ (cwa @ Xps @ Xch)))))))).
thf(asimplrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwa @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xth) @ Xch)))))).
thf(aelpclN_thm,axiom,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((! [Xy1:$i] : (cwceq @ (XU @ Xy1) @ (ccfv @ XK @ ccpclN))) => ((cwcel @ XQ @ ccvv) => (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XK @ XV) @ (cwss @ XX @ XA2)) @ (cwb @ (cwcel @ XQ @ (ccfv @ XX @ (XU @ Xy1))) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwss @ XX @ (ccv @ Xy1)) @ (cwcel @ XQ @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS))))))))))))))))).
thf(cpclfinclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => ((cwceq @ XS @ (ccfv @ XK @ ccpscN)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XX @ XA2) @ (cwcel @ XX @ ccfn)) @ (cwcel @ (ccfv @ XX @ XU) @ XS))))))))))).
