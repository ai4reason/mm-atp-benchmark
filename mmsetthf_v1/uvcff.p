...
thf(auvcfval_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XU @ Xj @ Xk) @ (cco @ XR @ XI @ ccuvc)))) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XR @ (XV @ Xj @ Xk)) @ (cwcel @ XI @ (XW @ Xj @ Xk))) @ (cwceq @ (XU @ Xj @ Xk) @ (ccmpt @ (^ [Xj:$i] : XI) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (ccv @ Xj)) @ Xc_1 @ Xc_0)))))))))))))))))))).
thf(cuvcff_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XU @ (cco @ XR @ XI @ ccuvc)) => ((cwceq @ XY @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XW)) @ (cwf @ XI @ XB2 @ XU)))))))))))).
