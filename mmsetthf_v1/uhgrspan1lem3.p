...
thf(auhgrspan1lem1_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XV @ Xi) @ (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (cwceq @ (XI @ Xi) @ (ccfv @ (XG @ Xi) @ cciedg))) => ((! [Xi:$i] : (cwceq @ (XF @ Xi) @ (ccrab @ (^ [Xi:$i] : (cwnel @ (XN @ Xi) @ (ccfv @ (ccv @ Xi) @ (XI @ Xi)))) @ (^ [Xi:$i] : (ccdm @ (XI @ Xi)))))) => (! [Xi:$i] : (cwa @ (cwcel @ (ccdif @ (XV @ Xi) @ (ccsn @ (XN @ Xi))) @ ccvv) @ (cwcel @ (ccres @ (XI @ Xi) @ (XF @ Xi)) @ ccvv)))))))))))).
