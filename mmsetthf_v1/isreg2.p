...
thf(aregsep2_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ ccreg) @ (cw3a @ (cwcel @ XC @ (ccfv @ XJ @ cccld)) @ (cwcel @ XA2 @ XX) @ (cwn @ (cwcel @ XA2 @ XC)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwss @ XC @ (ccv @ Xx3)) @ (cwcel @ XA2 @ (ccv @ Xy1)) @ (cwceq @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))))).
...
thf(aralcom3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
...
thf(cisreg2_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XJ @ ccreg) @ (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xc))) @ (cwrex @ (^ [Xo:$i] : (cwrex @ (^ [Xp:$i] : (cw3a @ (cwss @ (ccv @ Xc) @ (ccv @ Xo)) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xp)) @ (cwceq @ (ccin @ (ccv @ Xo) @ (ccv @ Xp)) @ cc0))) @ (^ [Xp:$i] : XJ))) @ (^ [Xo:$i] : XJ)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld)))))))).
