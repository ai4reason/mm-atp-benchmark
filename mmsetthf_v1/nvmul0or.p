...
thf(cnvmul0or_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XZ @ (ccfv @ XU @ ccn0v)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ XX)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ XS) @ XZ) @ (cwo @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ XZ)))))))))))))).
