...
thf(cmulgrhm_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ Xc_1 @ Xc_x))))) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (! [Xn:$i] : (cwi @ (cwcel @ XR @ ccrg) @ (cwcel @ (XF @ Xn) @ (cco @ czring @ XR @ ccrh)))))))))))).
