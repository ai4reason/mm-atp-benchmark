...
thf(csotrine_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwor @ XA2 @ XR) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2))) @ (cwb @ (cwne @ XB2 @ XC) @ (cwo @ (cwbr @ XB2 @ XC @ XR) @ (cwbr @ XC @ XB2 @ XR))))))))).
