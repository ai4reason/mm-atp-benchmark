...
thf(aply1term_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XF @ Xz) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ XA2 @ (cco @ (ccv @ Xz) @ XN @ ccexp) @ ccmul))))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwss @ XS @ ccc) @ (cwcel @ XA2 @ XS) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (XF @ Xz) @ (ccfv @ XS @ ccply)))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(aplysubcl_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply))) @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccfv @ ccc @ ccply))))))).
...
thf(adgrsub_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply))) @ (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdgr) @ (ccif @ (cwbr @ XM @ XN @ ccle) @ XN @ XM) @ ccle)))))))))).
...
thf(acoesub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XB2 @ (ccfv @ XG @ cccoe)) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply))) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ cccoe) @ (cco @ XA2 @ XB2 @ (ccof @ ccmin)))))))))))).
...
thf(adgrlt_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ ccn0)) @ (cwb @ (cwo @ (cwceq @ XF @ cc0p) @ (cwbr @ XN @ XM @ cclt)) @ (cwa @ (cwbr @ XN @ XM @ ccle) @ (cwceq @ (ccfv @ XM @ XA2) @ ccc0)))))))))))).
...
thf(ann0leltp1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwbr @ XM @ XN @ ccle) @ (cwbr @ XM @ (cco @ XN @ cc1 @ ccaddc) @ cclt)))))).
...
thf(adgrmulc_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XF @ (ccfv @ XS @ ccply))) @ (cwceq @ (ccfv @ (cco @ (ccxp @ ccc @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdgr) @ (ccfv @ XF @ ccdgr))))))).
thf(adgrcolem1_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (ccfv @ XG @ ccdgr))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3) @ ccn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XG @ (ccfv @ (XS @ Xx3) @ ccply)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XG) @ XM @ ccexp))) @ ccdgr) @ (cco @ XM @ (XN @ Xx3) @ ccmul)))))))))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(adgradd2_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwbr @ XM @ XN @ cclt)) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdgr) @ XN)))))))))).
...
thf(a_0dgr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (ccxp @ ccc @ (ccsn @ XA2)) @ ccdgr) @ ccc0)))).
...
thf(a_0dgrb_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwb @ (cwceq @ (ccfv @ XF @ ccdgr) @ ccc0) @ (cwceq @ XF @ (ccxp @ ccc @ (ccsn @ (ccfv @ ccc0 @ XF))))))))).
thf(asylib_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwb @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(aelnn0_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccn0) @ (cwo @ (cwcel @ XA2 @ ccn) @ (cwceq @ XA2 @ ccc0))))).
thf(cdgrcolem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XG @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwi @ Xph @ (cwcel @ XD @ ccn0)) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ XD @ cc1 @ ccaddc))) => ((cwi @ Xph @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XD @ ccle) @ (cwceq @ (ccfv @ (cccom @ (ccv @ Xf1) @ XG) @ ccdgr) @ (cco @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XN @ ccmul)))) @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply)))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cccom @ XF @ XG) @ ccdgr) @ (cco @ XM @ XN @ ccmul)))))))))))))))))))).
