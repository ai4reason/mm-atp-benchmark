...
thf(cadjadd_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccdm @ ccado)) @ (cwcel @ XT @ (ccdm @ ccado))) @ (cwceq @ (ccfv @ (cco @ XS @ XT @ cchos) @ ccado) @ (cco @ (ccfv @ XS @ ccado) @ (ccfv @ XT @ ccado) @ cchos)))))).
