...
thf(aralrab2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => (cwb @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xy1))))) @ (cwral @ (^ [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (Xch @ Xy1))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))))))))).
...
thf(ainfregelb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccr)) @ (cwb @ (cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccinf @ XA2 @ ccr @ cclt) @ ccle) @ (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccv @ Xz) @ ccle)) @ (^ [Xz:$i] : XA2))))))))).
...
thf(arlim2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xz:$i] : (cwcel @ (XB2 @ Xz) @ ccc)) @ (^ [Xz:$i] : XA2)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XA2 @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XC @ ccc))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwb @ (cwbr @ (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (XB2 @ Xz))) @ XC @ ccrli) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccle) @ (cwbr @ (ccfv @ (cco @ (XB2 @ Xz) @ XC @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccrp))))))))))))).
...
thf(cpntlem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ (XA2 @ Xu @ Xa) @ ccrp)))) => ((! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ ccabs) @ (XA2 @ Xu @ Xa) @ ccle)) @ (^ [Xx3:$i] : ccrp))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xa:$i] : (cwceq @ (XT @ Xy1 @ Xz @ Xt @ Xa) @ (ccrab @ (^ [Xt:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ (XR @ Xa)) @ (ccv @ Xz) @ ccdiv) @ ccabs) @ (ccv @ Xt) @ ccle)) @ (^ [Xz:$i] : (cco @ (ccv @ Xy1) @ ccpnf @ ccico)))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xt:$i] : (cco @ ccc0 @ (XA2 @ Xu @ Xa) @ ccicc))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ (XC @ Xx3 @ Xy1 @ Xz @ Xt @ Xa) @ ccrp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xa) @ (cwcel @ (ccv @ Xu) @ (XT @ Xy1 @ Xz @ Xt @ Xa))) @ (cwcel @ (cco @ (ccv @ Xu) @ (cco @ (XC @ Xx3 @ Xy1 @ Xz @ Xt @ Xa) @ (cco @ (ccv @ Xu) @ cc3 @ ccexp) @ ccmul) @ ccmin) @ (XT @ Xy1 @ Xz @ Xt @ Xa))))))))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccv @ Xx3) @ ccdiv))) @ cc1 @ ccrli))))))))))))))).
