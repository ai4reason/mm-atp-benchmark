...
thf(cfsuppmptif_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XZ @ (XW @ Xk)))) => ((cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp)) => (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XD @ Xk)) @ (ccfv @ (ccv @ Xk) @ XF) @ XZ))) @ XZ @ ccfsupp))))))))))))))).
