...
thf(azabscl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwcel @ (ccfv @ XA2 @ ccabs) @ ccz)))).
...
thf(aclimmulf_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XG @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XH @ Xk))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XF @ Xk) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XH @ Xk) @ (XX @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XG @ Xk) @ (XB2 @ Xk) @ ccli))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XH @ Xk)) @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ ccmul)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XH @ Xk) @ (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccmul) @ ccli))))))))))))))))))))))))).
...
thf(aexpfac_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwbr @ (XF @ Xn) @ ccc0 @ ccli))))))).
...
thf(aclim0cf_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xx3) @ (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xk) @ (XV @ Xx3 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (XZ @ Xx3))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ (XB2 @ Xx3 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (XZ @ Xx3))) @ (cwcel @ (XB2 @ Xx3 @ Xj @ Xk) @ ccc))))) => (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwbr @ (XF @ Xk) @ ccc0 @ ccli) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (XB2 @ Xx3 @ Xj @ Xk) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xx3)))) @ (^ [Xx3:$i] : ccrp)))))))))))))))))).
...
thf(atpnzd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => (cwi @ Xph @ (cwne @ (cctp @ XA2 @ XB2 @ XC) @ cc0))))))))).
...
thf(aprmunb_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwrex @ (^ [Xp:$i] : (cwbr @ XN @ (ccv @ Xp) @ cclt)) @ (^ [Xp:$i] : ccprime))))).
...
thf(aetransclem6_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (cwceq @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul))) @ (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (cco @ (cco @ (ccv @ Xy1) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xk) @ ccmin) @ XP @ ccexp))) @ ccmul))))))).
thf(cetransclem48_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XQ @ Xi @ Xk @ Xn) @ (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ cceu @ (XQ @ Xi @ Xk @ Xn)) @ ccc0))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xi) @ (ccfv @ (XQ @ Xi @ Xk @ Xn) @ cccoe))))) => ((! [Xi:$i] : (cwi @ Xph @ (cwne @ (ccfv @ ccc0 @ (XA2 @ Xi)) @ ccc0))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XM @ Xi) @ (ccfv @ (XQ @ Xi @ Xk @ Xn) @ ccdgr))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XC @ Xj @ Xk) @ (ccsu @ (cco @ ccc0 @ (XM @ Xi) @ ccfz) @ (^ [Xj:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xi)) @ (cco @ cceu @ (ccv @ Xj) @ cccxp) @ ccmul) @ ccabs) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xj @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (XC @ Xj @ Xk) @ (cco @ (cco @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv) @ ccmul)))))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XI @ Xj @ Xk) @ (ccinf @ (ccrab @ (^ [Xi:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XS @ Xj @ Xk @ Xn)) @ ccabs) @ cc1 @ cclt)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xi) @ ccuz)))) @ (^ [Xi:$i] : ccn0)) @ ccr @ cclt)))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xi @ Xn) @ (ccsup @ (cctp @ (ccfv @ (ccfv @ ccc0 @ (XA2 @ Xi)) @ ccabs) @ (ccfv @ (XM @ Xi) @ ccfa) @ (XI @ Xj @ Xk)) @ ccxr @ cclt)))))) => (cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwa @ (cwne @ (ccv @ Xk) @ ccc0) @ (cwbr @ (ccfv @ (ccv @ Xk) @ ccabs) @ cc1 @ cclt))) @ (^ [Xk:$i] : ccz))))))))))))))))))))).
