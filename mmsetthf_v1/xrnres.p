...
thf(ainres2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwceq @ (ccin @ (ccres @ XR @ XA2) @ XS) @ (ccres @ (ccin @ XR @ XS) @ XA2)))))).
thf(cxrnres_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwceq @ (ccres @ (ccxrn @ XR @ XS) @ XA2) @ (ccxrn @ (ccres @ XR @ XA2) @ XS)))))).
