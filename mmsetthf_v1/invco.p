...
thf(asectco_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((cwceq @ XS @ (ccfv @ XC @ ccsect)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (cco @ XX @ XY @ XS))) => ((cwi @ Xph @ (cwbr @ XH @ XK @ (cco @ XY @ XZ @ XS))) => (cwi @ Xph @ (cwbr @ (cco @ XH @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_x)) @ (cco @ XG @ XK @ (cco @ (ccop @ XZ @ XY) @ XX @ Xc_x)) @ (cco @ XX @ XZ @ XS))))))))))))))))))))))))).
...
thf(cinvco_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XN @ (ccfv @ XC @ ccinv)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwceq @ XI @ (ccfv @ XC @ cciso)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ XY @ XI))) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XY @ XZ @ XI))) => (cwi @ Xph @ (cwbr @ (cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_x)) @ (cco @ (ccfv @ XF @ (cco @ XX @ XY @ XN)) @ (ccfv @ XG @ (cco @ XY @ XZ @ XN)) @ (cco @ (ccop @ XZ @ XY) @ XX @ Xc_x)) @ (cco @ XX @ XZ @ XN))))))))))))))))))))))))).
