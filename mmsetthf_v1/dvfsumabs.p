...
thf(cdvfsumabs_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccicc)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ (cco @ XM @ XN @ ccicc) @ ccc @ cccncf))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccioo))) @ (cwcel @ (XB2 @ Xx3 @ Xk) @ (XV @ Xk))))) => ((! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XM) @ (cwceq @ (XA2 @ Xx3) @ (XC @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XN) @ (cwceq @ (XA2 @ Xx3) @ (XD @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfzo))) @ (cwcel @ (XX @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfzo))) @ (cwcel @ (XY @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfzo)) @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccioo)))) @ (cwbr @ (ccfv @ (cco @ (XX @ Xk) @ (XB2 @ Xx3 @ Xk) @ ccmin) @ ccabs) @ (XY @ Xk) @ ccle)))) => (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (XX @ Xk))) @ (cco @ (XD @ Xk) @ (XC @ Xk) @ ccmin) @ ccmin) @ ccabs) @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (XY @ Xk))) @ ccle))))))))))))))))))))))).
