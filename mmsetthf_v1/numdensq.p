...
thf(azgcdsq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccgcd) @ cc2 @ ccexp) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccgcd)))))).
...
thf(cnumdensq_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwa @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccnumer) @ (cco @ (ccfv @ XA2 @ ccnumer) @ cc2 @ ccexp)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccdenom) @ (cco @ (ccfv @ XA2 @ ccdenom) @ cc2 @ ccexp)))))).
