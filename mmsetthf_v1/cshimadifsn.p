...
thf(amodsumfzodifsn_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfzo))) @ (cwcel @ (cco @ (cco @ XK @ XJ @ ccaddc) @ XN @ ccmo) @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ)))))))).
...
thf(amodfzo0difsn_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ XK @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ)))) @ (cwrex @ (^ [Xi:$i] : (cwceq @ XK @ (cco @ (cco @ (ccv @ Xi) @ XJ @ ccaddc) @ XN @ ccmo))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfzo)))))))).
...
thf(ccshimadifsn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccword @ XS)) @ (cwceq @ XN @ (ccfv @ XF @ cchash)) @ (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo))) @ (cwceq @ (ccima @ XF @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ))) @ (ccima @ (cco @ XF @ XJ @ cccsh) @ (cco @ cc1 @ XN @ ccfzo))))))))).
