...
thf(cs2co_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ XY @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XB2 @ XX)) => (cwi @ Xph @ (cwceq @ (cccom @ XF @ (ccs2 @ XA2 @ XB2)) @ (ccs2 @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)))))))))))))).
