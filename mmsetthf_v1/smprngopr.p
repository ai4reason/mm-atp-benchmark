...
thf(a_0rngo_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwb @ (cwceq @ XZ @ XU) @ (cwceq @ XX @ (ccsn @ XZ)))))))))))))))).
...
thf(csmprngopr_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrngo) @ (cwne @ XU @ XZ) @ (cwceq @ (ccfv @ XR @ ccidl) @ (ccpr @ (ccsn @ XZ) @ XX))) @ (cwcel @ XR @ ccprrng)))))))))))))).
