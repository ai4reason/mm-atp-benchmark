...
thf(arisc_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo)) @ (cwb @ (cwbr @ XR @ XS @ ccrisc) @ (cwex @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XR @ XS @ ccrngiso))))))))).
thf(crisci_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) @ (cwbr @ XR @ XS @ ccrisc)))))).
