...
thf(aitgeq2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (XC @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccitg @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(aioovolcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccvol) @ ccr))))).
thf(aax_1cn_thm,axiom,(cwcel @ cc1 @ ccc)).
thf(ccibl_tp,type,(ccibl : ($i > $o))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(ccim_tp,type,(ccim : ($i > $o))).
thf(aitgconst_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ (cco @ XB2 @ (ccfv @ XA2 @ ccvol) @ ccmul)))))).
thf(aoveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF)))))))).
thf(aeqtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XB2 @ XC) => (cwceq @ XA2 @ XC))))))).
thf(a_0le1_thm,axiom,(cwbr @ ccc0 @ cc1 @ ccle)).
thf(avolioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccvol) @ (cco @ XB2 @ XA2 @ ccmin)))))).
...
thf(aftc2re_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xt:$i] : (cwceq @ (XE @ Xt) @ (cco @ (XC @ Xt) @ (XD @ Xt) @ ccioo))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XE @ Xt)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XE @ Xt)))) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xt:$i] : (cwi @ Xph @ (cwf @ (XE @ Xt) @ ccc @ XF))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ (XE @ Xt) @ ccc @ cccncf)))) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)))) @ (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin))))))))))))))))).
...
thf(advef_thm,axiom,(cwceq @ (cco @ ccc @ cce @ ccdv) @ cce)).
...
thf(aef2kpi_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ XK @ ccmul) @ cce) @ cc1)))).
...
thf(citgexpif_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce))) @ (ccif @ (cwceq @ XN @ ccc0) @ cc1 @ ccc0))))).
