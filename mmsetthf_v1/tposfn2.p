...
thf(atposfun_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwfun @ (cctpos @ XF))))).
...
thf(ctposfn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwi @ (cwfn @ XF @ XA2) @ (cwfn @ (cctpos @ XF) @ (cccnv @ XA2))))))).
