...
thf(alogcxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ cclog) @ (cco @ XB2 @ (ccfv @ XA2 @ cclog) @ ccmul)))))).
...
thf(crelogbreexp_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) @ (cwcel @ XC @ ccrp) @ (cwcel @ XE @ ccr)) @ (cwceq @ (cco @ XB2 @ (cco @ XC @ XE @ cccxp) @ cclogb) @ (cco @ XE @ (cco @ XB2 @ XC @ cclogb) @ ccmul))))))).
