...
thf(asigagensiga_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccfv @ XA2 @ ccsigagen) @ (ccfv @ (ccuni @ XA2) @ ccsiga)))))).
...
thf(arnmpt2ss_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ XD)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwss @ (ccrn @ (XF @ Xx3 @ Xy1)) @ XD))))))))))).
...
thf(asxbrsigalem6_thm,axiom,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwss @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ ccsigagen) @ (cco @ ccbrsiga @ ccbrsiga @ ccsx))))).
thf(csxbrsiga_conj,conjecture,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwceq @ (cco @ ccbrsiga @ ccbrsiga @ ccsx) @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ ccsigagen))))).
