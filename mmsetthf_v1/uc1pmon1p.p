...
thf(cuc1pmon1p_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => ((cwceq @ XM @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XC)) @ (cwcel @ (cco @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ XX @ XD) @ (ccfv @ XX @ ccco1)) @ XI) @ XA2) @ XX @ Xc_x) @ XM))))))))))))))))))).
