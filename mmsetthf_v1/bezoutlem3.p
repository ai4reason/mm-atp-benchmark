...
thf(cbezoutlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XM @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xz) @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccn)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((! [Xz:$i] : (cwceq @ XG @ (ccinf @ (XM @ Xz) @ ccr @ cclt))) => ((cwi @ Xph @ (cwn @ (cwa @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ ccc0)))) => (! [Xz:$i] : (cwi @ Xph @ (cwi @ (cwcel @ XC @ (XM @ Xz)) @ (cwbr @ XG @ XC @ ccdvds)))))))))))))))).
