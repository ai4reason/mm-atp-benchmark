...
thf(ablfvalps_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwceq @ (ccfv @ XD @ ccbl) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xr:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xr:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xr:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (ccv @ Xr) @ cclt)) @ (^ [Xy1:$i] : XX)))))))))).
...
thf(cblvalps_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccxr)) @ (cwceq @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ XP @ (ccv @ Xx3) @ XD) @ XR @ cclt)) @ (^ [Xx3:$i] : XX))))))))).
