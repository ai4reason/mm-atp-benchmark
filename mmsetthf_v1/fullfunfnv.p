...
thf(adf_fullfun_ax,axiom,(! [XF:($i > $o)] : (cwceq @ (ccfullfn @ XF) @ (ccun @ (ccfunpart @ XF) @ (ccxp @ (ccdif @ ccvv @ (ccdm @ (ccfunpart @ XF))) @ (ccsn @ cc0)))))).
...
thf(cfullfunfnv_conj,conjecture,(! [XF:($i > $o)] : (cwfn @ (ccfullfn @ XF) @ ccvv))).
