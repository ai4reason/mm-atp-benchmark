...
thf(asupxrun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccxr) @ (cwss @ XB2 @ ccxr) @ (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle)) @ (cwceq @ (ccsup @ (ccun @ XA2 @ XB2) @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt)))))).
thf(csupxrmnf_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccxr) @ (cwceq @ (ccsup @ (ccun @ XA2 @ (ccsn @ ccmnf)) @ ccxr @ cclt) @ (ccsup @ XA2 @ ccxr @ cclt))))).
