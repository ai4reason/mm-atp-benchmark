...
thf(aasinsin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccsin) @ ccasin) @ XA2)))).
...
thf(cacoscos_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ ccc0 @ ccpi @ ccioo))) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cccos) @ ccacos) @ XA2)))).
