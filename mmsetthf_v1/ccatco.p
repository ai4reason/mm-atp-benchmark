...
thf(alenco_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XA2)) @ (cwf @ XA2 @ XB2 @ XF)) @ (cwceq @ (ccfv @ (cccom @ XF @ XW) @ cchash) @ (ccfv @ XW @ cchash)))))))).
...
thf(cccatco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XT @ (ccword @ XA2)) @ (cwf @ XA2 @ XB2 @ XF)) @ (cwceq @ (cccom @ XF @ (cco @ XS @ XT @ ccconcat)) @ (cco @ (cccom @ XF @ XS) @ (cccom @ XF @ XT) @ ccconcat))))))))).
