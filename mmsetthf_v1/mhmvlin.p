...
thf(cmhmvlin_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwceq @ Xc_pd @ (ccfv @ XN @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XM @ XN @ ccmhm)) @ (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap)) @ (cwcel @ XY @ (cco @ XB2 @ XI @ ccmap))) @ (cwceq @ (cccom @ XF @ (cco @ XX @ XY @ (ccof @ Xc_pl))) @ (cco @ (cccom @ XF @ XX) @ (cccom @ XF @ XY) @ (ccof @ Xc_pd))))))))))))))))).
