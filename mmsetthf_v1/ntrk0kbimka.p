...
thf(cntrk0kbimka_conj,conjecture,(! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xt:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ (XV @ Xt @ Xs1)) @ (cwcel @ XI @ (cco @ (ccpw @ XB2) @ (ccpw @ XB2) @ ccmap))) @ (cwi @ (cwa @ (cwceq @ (ccfv @ XB2 @ XI) @ XB2) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwi @ (cwceq @ (ccin @ (ccv @ Xs1) @ (ccv @ Xt)) @ cc0) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xs1) @ XI) @ (ccfv @ (ccv @ Xt) @ XI)) @ cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2)))) @ (cwceq @ (ccfv @ cc0 @ XI) @ cc0))))))))).
