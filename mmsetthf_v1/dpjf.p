...
thf(cdpjf_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwceq @ XP @ (cco @ XG @ XS @ ccdpj)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => (cwi @ Xph @ (cwf @ (cco @ XG @ XS @ ccdprd) @ (ccfv @ XX @ XS) @ (ccfv @ XX @ XP)))))))))))))).
