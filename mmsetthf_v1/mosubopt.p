...
thf(cmosubopt_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (cwi @ (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))) @ (cwmo @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwa @ (cwceq @ XA2 @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))))).
