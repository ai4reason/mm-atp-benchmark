...
thf(amopnm_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XX @ XJ))))))).
...
thf(cmetrest_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XD @ (ccres @ XC @ (ccxp @ XY @ XY))) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XK @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccxmt)) @ (cwss @ XY @ XX)) @ (cwceq @ (cco @ XJ @ XY @ ccrest) @ XK)))))))))))).
