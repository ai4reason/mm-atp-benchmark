...
thf(cisf32lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ ccom @ (ccpw @ (XG @ Xx3)) @ XF))) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => ((cwi @ Xph @ (cwn @ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ ccom)) @ (cwrex @ (^ [Xa:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xa)) @ (cwpss @ (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF) @ (ccfv @ (ccv @ Xa) @ XF)))) @ (^ [Xa:$i] : ccom))))))))))).
