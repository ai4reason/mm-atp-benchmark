...
thf(afun2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwf @ XA2 @ XC @ XF) @ (cwf @ XB2 @ XC @ XG)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwf @ (ccun @ XA2 @ XB2) @ XC @ (ccun @ XF @ XG))))))))).
...
thf(afresaunres1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwf @ XA2 @ XC @ XF) @ (cwf @ XB2 @ XC @ XG) @ (cwceq @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccres @ XG @ (ccin @ XA2 @ XB2)))) @ (cwceq @ (ccres @ (ccun @ XF @ XG) @ XA2) @ XF)))))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(afresaunres2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwf @ XA2 @ XC @ XF) @ (cwf @ XB2 @ XC @ XG) @ (cwceq @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccres @ XG @ (ccin @ XA2 @ XB2)))) @ (cwceq @ (ccres @ (ccun @ XF @ XG) @ XB2) @ XG)))))))).
...
thf(cmapunen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwbr @ (cco @ XC @ (ccun @ XA2 @ XB2) @ ccmap) @ (ccxp @ (cco @ XC @ XA2 @ ccmap) @ (cco @ XC @ XB2 @ ccmap)) @ ccen))))))))).
