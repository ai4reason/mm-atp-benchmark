...
thf(ametcnp2_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XK @ (ccfv @ XD @ ccmopn)) => (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XD @ (ccfv @ XY @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (cco @ (ccv @ Xw) @ XP @ XC) @ (ccv @ Xz) @ cclt) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xw) @ XF) @ (ccfv @ XP @ XF) @ XD) @ (ccv @ Xy1) @ cclt))) @ (^ [Xw:$i] : XX))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : ccrp)))))))))))))))).
