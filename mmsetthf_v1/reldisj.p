...
thf(apm5_44_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwi @ Xph @ Xps) @ (cwb @ (cwi @ Xph @ Xch) @ (cwi @ Xph @ (cwa @ Xps @ Xch)))))))).
...
thf(creldisj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ XA2 @ XC) @ (cwb @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwss @ XA2 @ (ccdif @ XC @ XB2)))))))).
