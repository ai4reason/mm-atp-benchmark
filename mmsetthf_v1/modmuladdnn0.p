...
thf(cmodmuladdnn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XM @ ccrp)) @ (cwi @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ XB2) @ (cwrex @ (^ [Xk:$i] : (cwceq @ XA2 @ (cco @ (cco @ (ccv @ Xk) @ XM @ ccmul) @ XB2 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))))))).
