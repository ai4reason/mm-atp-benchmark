...
thf(afuncres2_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ (ccfv @ XD @ ccsubc)) @ (cwss @ (cco @ XC @ (cco @ XD @ XR @ ccresc) @ ccfunc) @ (cco @ XC @ XD @ ccfunc))))))).
...
thf(cfthres2_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ (ccfv @ XD @ ccsubc)) @ (cwss @ (cco @ XC @ (cco @ XD @ XR @ ccresc) @ ccfth) @ (cco @ XC @ XD @ ccfth))))))).
