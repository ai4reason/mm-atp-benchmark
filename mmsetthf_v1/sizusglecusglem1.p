...
thf(csizusglecusglem1_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XV @ (ccfv @ XH @ ccvtx)) => ((cwceq @ XF @ (ccfv @ XH @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XH @ cccusgr)) @ (cwf1 @ XE @ XF @ (ccres @ ccid @ XE))))))))))))).
