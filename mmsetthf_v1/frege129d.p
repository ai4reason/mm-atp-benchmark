...
thf(afrege126d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccvv)) => ((cwi @ Xph @ (cwcel @ XX @ (ccdm @ XF))) => ((cwi @ Xph @ (cwceq @ XA2 @ (ccfv @ XX @ XF))) => ((cwi @ Xph @ (cwbr @ XX @ XB2 @ (ccfv @ XF @ cctcl))) => ((cwi @ Xph @ (cwfun @ XF)) => (cwi @ Xph @ (cw3o @ (cwbr @ XA2 @ XB2 @ (ccfv @ XF @ cctcl)) @ (cwceq @ XA2 @ XB2) @ (cwbr @ XB2 @ XA2 @ (ccfv @ XF @ cctcl))))))))))))))).
...
thf(cfrege129d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccvv)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ XF))) => ((cwi @ Xph @ (cwceq @ XC @ (ccfv @ XA2 @ XF))) => ((cwi @ Xph @ (cw3o @ (cwbr @ XA2 @ XB2 @ (ccfv @ XF @ cctcl)) @ (cwceq @ XA2 @ XB2) @ (cwbr @ XB2 @ XA2 @ (ccfv @ XF @ cctcl)))) => ((cwi @ Xph @ (cwfun @ XF)) => (cwi @ Xph @ (cw3o @ (cwbr @ XB2 @ XC @ (ccfv @ XF @ cctcl)) @ (cwceq @ XB2 @ XC) @ (cwbr @ XC @ XB2 @ (ccfv @ XF @ cctcl))))))))))))))).
