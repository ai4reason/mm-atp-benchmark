...
thf(afeq12i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ XG) => ((cwceq @ XA2 @ XB2) => (cwb @ (cwf @ XA2 @ XC @ XF) @ (cwf @ XB2 @ XC @ XG)))))))))).
...
thf(a_0cnv_thm,axiom,(cwi @ (cwcel @ cc0 @ ccc) @ (cwbr @ cc0 @ cc0 @ ccli))).
...
thf(cclimlimsupcex_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwn @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwceq @ XF @ cc0) => (cwi @ (cwa @ (cwcel @ cc0 @ ccc) @ (cwn @ (cwcel @ ccmnf @ ccc))) @ (cw3a @ (cwf @ XZ @ ccr @ XF) @ (cwcel @ XF @ (ccdm @ ccli)) @ (cwn @ (cwbr @ XF @ (ccfv @ XF @ cclsp) @ ccli))))))))))).
