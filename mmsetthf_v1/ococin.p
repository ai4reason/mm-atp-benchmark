...
thf(achintcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccch) @ (cwne @ XA2 @ cc0)) @ (cwcel @ (ccint @ XA2) @ ccch)))).
...
thf(cococin_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ cchil) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccort) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : ccch))))))).
