...
thf(asubmat1n_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ XB2)) @ (cwceq @ (cco @ XN @ XN @ (ccfv @ XM @ ccsmat)) @ (cco @ XN @ XN @ (ccfv @ XM @ (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccsubma))))))))))))).
...
thf(csubmatres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ XB2)) @ (cwceq @ (cco @ XN @ XN @ (ccfv @ XM @ ccsmat)) @ (ccres @ XM @ (ccxp @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))))))))))).
