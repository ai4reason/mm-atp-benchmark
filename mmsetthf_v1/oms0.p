...
thf(asnct_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ (ccsn @ XA2) @ ccom @ ccdom))))).
...
thf(coms0_conj,conjecture,(! [Xph:$o] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccoms)) => ((cwi @ Xph @ (cwcel @ XQ @ XV)) => ((cwi @ Xph @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((cwi @ Xph @ (cwcel @ cc0 @ (ccdm @ XR))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XR) @ ccc0)) => (cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0))))))))))))).
