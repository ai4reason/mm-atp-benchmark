...
thf(ariotaeqdv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) => (cwi @ Xph @ (cwceq @ (ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(adf_transport_ax,axiom,(cwceq @ cctransport @ (ccoprab @ (^ [Xp:$i] : (^ [Xq:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xn:$i] : (cwa @ (cw3a @ (cwcel @ (ccv @ Xp) @ (ccxp @ (ccfv @ (ccv @ Xn) @ ccee) @ (ccfv @ (ccv @ Xn) @ ccee))) @ (cwcel @ (ccv @ Xq) @ (ccxp @ (ccfv @ (ccv @ Xn) @ ccee) @ (ccfv @ (ccv @ Xn) @ ccee))) @ (cwne @ (ccfv @ (ccv @ Xq) @ cc1st) @ (ccfv @ (ccv @ Xq) @ cc2nd))) @ (cwceq @ (ccv @ Xx3) @ (ccrio @ (^ [Xr:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xq) @ cc2nd) @ (ccop @ (ccfv @ (ccv @ Xq) @ cc1st) @ (ccv @ Xr)) @ ccbtwn) @ (cwbr @ (ccop @ (ccfv @ (ccv @ Xq) @ cc2nd) @ (ccv @ Xr)) @ (ccv @ Xp) @ cccgr))) @ (^ [Xr:$i] : (ccfv @ (ccv @ Xn) @ ccee)))))) @ (^ [Xn:$i] : ccn)))))))).
...
thf(cfvtransport_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee))) @ (cwne @ XC @ XD))) @ (cwceq @ (cco @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cctransport) @ (ccrio @ (^ [Xr:$i] : (cwa @ (cwbr @ XD @ (ccop @ XC @ (ccv @ Xr)) @ ccbtwn) @ (cwbr @ (ccop @ XD @ (ccv @ Xr)) @ (ccop @ XA2 @ XB2) @ cccgr))) @ (^ [Xr:$i] : (ccfv @ XN @ ccee))))))))))).
