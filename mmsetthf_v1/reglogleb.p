...
thf(creglogleb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp)) @ (cwa @ (cwcel @ XC @ ccrp) @ (cwbr @ cc1 @ XC @ cclt))) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ ccle))))))).
