...
thf(cdv11cn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ XA2 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XR @ ccxr)) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XG)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccc @ XF @ ccdv)) @ XX)) => ((cwi @ Xph @ (cwceq @ (cco @ ccc @ XF @ ccdv) @ (cco @ ccc @ XG @ ccdv))) => ((cwi @ Xph @ (cwcel @ XC @ XX)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XC @ XF) @ (ccfv @ XC @ XG))) => (cwi @ Xph @ (cwceq @ XF @ XG))))))))))))))))))).
