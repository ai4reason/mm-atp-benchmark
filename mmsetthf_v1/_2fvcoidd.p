...
thf(c_2fvcoidd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwf @ XA2 @ (XB2 @ Xa) @ XF))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwf @ (XB2 @ Xa) @ XA2 @ XG))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwral @ (^ [Xa:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xa) @ XF) @ XG) @ (ccv @ Xa))) @ (^ [Xa:$i] : XA2)))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwceq @ (cccom @ XG @ XF) @ (ccres @ ccid @ XA2))))))))))))).
