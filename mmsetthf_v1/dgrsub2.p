...
thf(cdgrsub2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => (cwi @ (cwa @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XT @ ccply))) @ (cw3a @ (cwceq @ (ccfv @ XG @ ccdgr) @ XN) @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ (ccfv @ XF @ cccoe)) @ (ccfv @ XN @ (ccfv @ XG @ cccoe))))) @ (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdgr) @ XN @ cclt))))))))).
