...
thf(adchrzrh1_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((cwceq @ XL @ (ccfv @ XZ @ cczrh)) => ((cwi @ Xph @ (cwcel @ XX @ XD)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ cc1 @ XL) @ XX) @ cc1))))))))))))))).
...
thf(cdchrvmasum2lem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xd:$i] : (cwceq @ (XZ @ Xd) @ (ccfv @ (XN @ Xd) @ cczn))) => ((! [Xd:$i] : (cwceq @ XL @ (ccfv @ (XZ @ Xd) @ cczrh))) => ((! [Xd:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xd) @ ccn))) => ((! [Xm:$i] : (! [Xd:$i] : (cwceq @ (XG @ Xm @ Xd) @ (ccfv @ (XN @ Xd) @ ccdchr)))) => ((! [Xm:$i] : (! [Xd:$i] : (cwceq @ (XD @ Xd) @ (ccfv @ (XG @ Xm @ Xd) @ ccbs)))) => ((! [Xm:$i] : (! [Xd:$i] : (cwceq @ (Xc_1 @ Xd) @ (ccfv @ (XG @ Xm @ Xd) @ cc0g)))) => ((! [Xd:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xd)))) => ((! [Xd:$i] : (cwi @ Xph @ (cwne @ XX @ (Xc_1 @ Xd)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ cc1 @ XA2 @ ccle)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ cclog) @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xd) @ XL) @ XX) @ (cco @ (ccfv @ (ccv @ Xd) @ ccmu) @ (ccv @ Xd) @ ccdiv) @ ccmul) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ XA2 @ (ccv @ Xd) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ XX) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ (ccv @ Xd) @ ccdiv) @ (ccv @ Xm) @ ccdiv) @ cclog) @ (ccv @ Xm) @ ccdiv) @ ccmul))) @ ccmul))))))))))))))))))))))))).
