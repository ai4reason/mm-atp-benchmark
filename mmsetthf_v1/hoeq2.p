...
thf(ahial2eq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XA2 @ ccsp) @ (cco @ (ccv @ Xx3) @ XB2 @ ccsp))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XA2 @ XB2)))))).
thf(ccmv_tp,type,(ccmv : ($i > $o))).
thf(ahial2eq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccsp) @ (cco @ XB2 @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XA2 @ XB2)))))).
thf(ahoeq1_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccv @ Xy1) @ ccsp) @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XS @ XT)))))).
thf(choeq2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccsp) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XS @ XT)))))).
