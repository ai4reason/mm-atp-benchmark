...
thf(ctopfne_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cwa @ (cwcel @ XK @ cctop) @ (cwceq @ XX @ XY)) @ (cwb @ (cwss @ XJ @ XK) @ (cwbr @ XJ @ XK @ ccfne)))))))))).
