...
thf(cgcdcllem2_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xz @ Xn) @ (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xn:$i] : (ccpr @ XM @ XN)))) @ (^ [Xz:$i] : ccz))))) => ((! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xz @ Xn) @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xz) @ XM @ ccdvds) @ (cwbr @ (ccv @ Xz) @ XN @ ccdvds))) @ (^ [Xz:$i] : ccz))))) => (! [Xz:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (XR @ Xz @ Xn) @ (XS @ Xz @ Xn)))))))))))).
