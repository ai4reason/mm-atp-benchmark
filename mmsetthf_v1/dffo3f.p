...
thf(cdffo3f_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (! [Xx3:$i] : (cwb @ (cwfo @ XA2 @ XB2 @ (XF @ Xx3)) @ (cwa @ (cwf @ XA2 @ XB2 @ (XF @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XB2)))))))))).
