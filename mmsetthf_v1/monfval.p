...
thf(adf_mon_ax,axiom,(cwceq @ ccmon @ (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (ccsb @ (ccfv @ (ccv @ Xc) @ ccbs) @ (^ [Xb:$i] : (ccsb @ (ccfv @ (ccv @ Xc) @ cchom) @ (^ [Xh:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xz:$i] : (cwfun @ (cccnv @ (ccmpt @ (^ [Xg1:$i] : (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccv @ Xh))) @ (^ [Xg1:$i] : (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (cco @ (ccop @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xc) @ ccco)))))))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xh))))))))))))))).
