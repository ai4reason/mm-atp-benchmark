...
thf(cmrsubccat_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XX @ XR) @ (cwcel @ XY @ XR)) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ ccconcat) @ XF) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccconcat)))))))))))).
