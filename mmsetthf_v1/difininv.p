...
thf(cdifininv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwceq @ (ccin @ (ccdif @ XA2 @ XC) @ XB2) @ cc0) @ (cwceq @ (ccin @ (ccdif @ XC @ XA2) @ XB2) @ cc0)) @ (cwceq @ (ccin @ XA2 @ XB2) @ (ccin @ XC @ XB2))))))).
