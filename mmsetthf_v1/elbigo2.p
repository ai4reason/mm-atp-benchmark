...
thf(celbigo2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwf @ XA2 @ ccr @ XG) @ (cwss @ XA2 @ ccr)) @ (cwa @ (cwf @ XB2 @ ccr @ XF) @ (cwss @ XB2 @ XA2))) @ (cwb @ (cwcel @ XF @ (ccfv @ XG @ ccbigo)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccmul) @ ccle))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))))).
