...
thf(aupgredgss_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccupgr) @ (cwss @ (ccfv @ XG @ ccedg) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ (ccfv @ XG @ ccvtx)) @ (ccsn @ cc0)))))))).
...
thf(cuspgrupgrushgr_conj,conjecture,(! [XG:($i > $o)] : (cwb @ (cwcel @ XG @ ccuspgr) @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XG @ ccushgr))))).
