...
thf(adfvd3ir_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ Xth))) => (cwvd3 @ Xph @ Xps @ Xch @ Xth))))))).
...
thf(cvd23_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwvd2 @ Xph @ Xps @ Xch) => (cwvd3 @ Xph @ Xps @ Xth @ Xch))))))).
