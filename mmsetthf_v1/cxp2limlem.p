...
thf(ccxp2limlem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (cco @ XA2 @ (ccv @ Xn) @ cccxp) @ ccdiv))) @ ccc0 @ ccrli)))).
