...
thf(adf_linc_ax,axiom,(cwceq @ cclinc @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccmpt2 @ (^ [Xs1:$i] : (^ [Xv:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ ccbs) @ (ccv @ Xv) @ ccmap))) @ (^ [Xs1:$i] : (^ [Xv:$i] : (ccpw @ (ccfv @ (ccv @ Xm) @ ccbs)))) @ (^ [Xs1:$i] : (^ [Xv:$i] : (cco @ (ccv @ Xm) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ ccvsca)))) @ ccgsu)))))))).
...
thf(ampt2exxg2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ (XR @ Xx3 @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ (XS @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (cwcel @ (XF @ Xx3 @ Xy1) @ ccvv)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(clincop_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (cwcel @ XM @ (XX @ Xx3 @ Xs1)) @ (cwceq @ (ccfv @ XM @ cclinc) @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xv:$i] : (cco @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs) @ (ccv @ Xv) @ ccmap))) @ (^ [Xs1:$i] : (^ [Xv:$i] : (ccpw @ (ccfv @ XM @ ccbs)))) @ (^ [Xs1:$i] : (^ [Xv:$i] : (cco @ XM @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (ccv @ Xx3) @ (ccfv @ XM @ ccvsca)))) @ ccgsu))))))))))).
