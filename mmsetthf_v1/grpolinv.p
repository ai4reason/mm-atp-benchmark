...
thf(cgrpolinv_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XU @ (ccfv @ XG @ ccgi)) => ((cwceq @ XN @ (ccfv @ XG @ ccgn)) => (cwi @ (cwa @ (cwcel @ XG @ ccgr) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ (ccfv @ XA2 @ XN) @ XA2 @ XG) @ XU))))))))))).
