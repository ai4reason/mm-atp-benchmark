...
thf(ausgrss_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwss @ (ccfv @ XX @ XE) @ XV))))))))).
...
thf(cusgredgprvALT_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwi @ (cwceq @ (ccfv @ XX @ XE) @ (ccpr @ XM @ XN)) @ (cwa @ (cwcel @ XM @ XV) @ (cwcel @ XN @ XV))))))))))))).
