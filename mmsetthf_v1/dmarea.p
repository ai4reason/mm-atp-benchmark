...
thf(adf_area_ax,axiom,(cwceq @ ccarea @ (ccmpt @ (^ [Xs1:$i] : (ccrab @ (^ [Xt:$i] : (cwa @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (ccv @ Xt) @ (ccsn @ (ccv @ Xx3))) @ (ccima @ (cccnv @ ccvol) @ ccr))) @ (^ [Xx3:$i] : ccr)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccima @ (ccv @ Xt) @ (ccsn @ (ccv @ Xx3))) @ ccvol))) @ ccibl))) @ (^ [Xt:$i] : (ccpw @ (ccxp @ ccr @ ccr))))) @ (^ [Xs1:$i] : (ccitg @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccima @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xx3))) @ ccvol))))))).
...
thf(cdmarea_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ ccarea)) @ (cw3a @ (cwss @ XA2 @ (ccxp @ ccr @ ccr)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3))) @ (ccima @ (cccnv @ ccvol) @ ccr))) @ (^ [Xx3:$i] : ccr)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3))) @ ccvol))) @ ccibl))))).
