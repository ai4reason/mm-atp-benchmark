...
thf(aresixpfo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : (cwceq @ (XF @ Xx3 @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (^ [Xf1:$i] : (ccres @ (ccv @ Xf1) @ XB2)))))) => (! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cwss @ XB2 @ XA2) @ (cwne @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ cc0)) @ (cwfo @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XF @ Xx3 @ Xf1))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(ccdom_tp,type,(ccdom : ($i > $o))).
thf(afonum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwfo @ XA2 @ XB2 @ XF)) @ (cwcel @ XB2 @ (ccdm @ cccrd))))))).
...
thf(aixpiunwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (XW @ Xx3)) @ (cwne @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cc0)) @ (cwbr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccxp @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XA2) @ ccwdom)))))))).
thf(anumwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ XB2 @ XA2 @ ccwdom)) @ (cwcel @ XB2 @ (ccdm @ cccrd)))))).
thf(cptcmplem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xu:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccima @ (cccnv @ (ccmpt @ (^ [Xw:$i] : XX) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xw))))) @ (ccv @ Xu))))))) => ((cwceq @ XX @ (ccixp @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccuni @ (ccfv @ (ccv @ Xn) @ XF))))) => ((! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwcel @ XA2 @ XV)))) => ((! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwf @ XA2 @ cccmp @ XF)))) => ((! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwcel @ XX @ (ccin @ ccufl @ (ccdm @ cccrd)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwss @ (XU @ Xw @ Xn) @ (ccrn @ (XS @ Xw))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwceq @ XX @ (ccuni @ (XU @ Xw @ Xn))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwn @ (cwrex @ (^ [Xz:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (XU @ Xw @ Xn)) @ ccfn)))))))) => (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwcel @ (cciun @ (^ [Xk:$i] : (ccrab @ (^ [Xn:$i] : (cwn @ (cwbr @ (ccuni @ (ccfv @ (ccv @ Xn) @ XF)) @ cc1o @ ccen))) @ (^ [Xn:$i] : XA2))) @ (^ [Xk:$i] : (ccuni @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccdm @ cccrd))))))))))))))))))))).
