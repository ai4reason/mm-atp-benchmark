...
thf(ainfdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ (ccdif @ XA2 @ (ccsn @ XB2)) @ XA2 @ ccen))))).
...
thf(cinfpss_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwpss @ (ccv @ Xx3) @ XA2) @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccen))))))).
