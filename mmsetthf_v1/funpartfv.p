...
thf(afunpartlem_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ (ccin @ (cccom @ (ccimage @ XF) @ ccsingle) @ (ccxp @ ccvv @ ccsingles)))) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (ccima @ XF @ (ccsn @ XA2)) @ (ccsn @ (ccv @ Xx3))))))))).
...
thf(cfunpartfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ (ccfunpart @ XF)) @ (ccfv @ XA2 @ XF))))).
