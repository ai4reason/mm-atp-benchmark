...
thf(atgblthelfgottOLD_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccodd) @ (cwbr @ cc7 @ XN @ cclt) @ (cwbr @ XN @ (cco @ (ccdc @ cc8 @ cc8) @ (cco @ cc10 @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul) @ cclt)) @ (cwcel @ XN @ ccgbo)))).
...
thf(ctgoldbachltOLD_conj,conjecture,(cwrex @ (^ [Xm:$i] : (cwa @ (cwbr @ (cco @ cc8 @ (cco @ cc10 @ (ccdc @ cc3 @ ccc0) @ ccexp) @ ccmul) @ (ccv @ Xm) @ cclt) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwa @ (cwbr @ cc7 @ (ccv @ Xn) @ cclt) @ (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ cclt)) @ (cwcel @ (ccv @ Xn) @ ccgbo))) @ (^ [Xn:$i] : ccodd)))) @ (^ [Xm:$i] : ccn))).
