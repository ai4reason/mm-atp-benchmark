...
thf(aelhf_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ cchf) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccr1))) @ (^ [Xx3:$i] : ccom))))).
...
thf(arankr1a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwcel @ XB2 @ ccon0) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) @ (cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2))))))).
...
thf(celhf2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ cchf) @ (cwcel @ (ccfv @ XA2 @ ccrnk) @ ccom))))).
