...
thf(achlej1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwss @ XA2 @ XB2)) @ (cwss @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XC @ cchj))))))).
...
thf(cdmdbr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ XB2 @ (ccv @ Xx3)) @ (cwss @ (ccin @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)) @ (cco @ (ccin @ (ccv @ Xx3) @ XA2) @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
