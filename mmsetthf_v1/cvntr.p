...
thf(acvnbtwn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwn @ (cwa @ (cwpss @ XA2 @ XC) @ (cwpss @ XC @ XB2))))))))).
thf(ccvntr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwbr @ XB2 @ XC @ cccv)) @ (cwn @ (cwbr @ XA2 @ XC @ cccv)))))))).
