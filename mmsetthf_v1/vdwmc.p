...
thf(adf_vdwmc_ax,axiom,(cwceq @ ccvdwm @ (ccopab @ (^ [Xk:$i] : (^ [Xf1:$i] : (cwex @ (^ [Xc:$i] : (cwne @ (ccin @ (ccrn @ (ccfv @ (ccv @ Xk) @ ccvdwa)) @ (ccpw @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xc))))) @ cc0)))))))).
...
thf(avdwapf_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccn0) @ (cwf @ (ccxp @ ccn @ ccn) @ (ccpw @ ccn) @ (ccfv @ XK @ ccvdwa))))).
...
thf(cvdwmc_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwcel @ (XX @ Xa @ Xc @ Xd) @ ccvv)))) => ((! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xa @ Xd) @ (cwcel @ XK @ ccn0)))) => ((! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xa @ Xd) @ (cwf @ (XX @ Xa @ Xc @ Xd) @ (XR @ Xa @ Xc @ Xd) @ XF))))) => (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xa @ Xd) @ (cwb @ (cwbr @ XK @ XF @ ccvdwm) @ (cwex @ (^ [Xc:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwss @ (cco @ (ccv @ Xa) @ (ccv @ Xd) @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn))))))))))))))))).
