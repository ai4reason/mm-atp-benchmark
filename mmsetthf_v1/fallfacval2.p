...
thf(cfallfacval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ XN @ ccfallfac) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccmin)))))))).
