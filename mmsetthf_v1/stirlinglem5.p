...
thf(alogtayl2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XS @ Xk) @ (cco @ cc1 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => (! [Xk:$i] : (cwi @ (cwcel @ XA2 @ (XS @ Xk)) @ (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ (ccv @ Xk) @ ccdiv) @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (ccv @ Xk) @ ccexp) @ ccmul))) @ cc1) @ (ccfv @ XA2 @ cclog) @ ccli))))))).
...
thf(alogtayl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) @ (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (ccv @ Xk) @ ccdiv))) @ cc1) @ (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog)) @ ccli)))).
...
thf(aisercoll2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XZ @ Xn) @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwceq @ (XW @ Xk) @ (ccfv @ (XN @ Xk) @ ccuz))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xk) @ ccz))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwf @ (XZ @ Xn) @ (XW @ Xk) @ XG)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (XZ @ Xn))) @ (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (ccdif @ (XW @ Xk) @ (ccrn @ XG)))) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XF) @ ccc0)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (XW @ Xk))) @ (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccc)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (XZ @ Xn))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XH) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ XF))))) => (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwbr @ (ccseq @ ccaddc @ XH @ XM) @ XA2 @ ccli) @ (cwbr @ (ccseq @ ccaddc @ XF @ (XN @ Xk)) @ XA2 @ ccli))))))))))))))))))))))).
...
thf(amulltgt0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ XA2 @ ccc0 @ cclt)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ cclt))) @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt))))).
...
thf(aoexpneg_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) @ (cwceq @ (cco @ (ccneg @ XA2) @ XN @ ccexp) @ (ccneg @ (cco @ XA2 @ XN @ ccexp))))))).
...
thf(cstirlinglem5_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((! [Xj:$i] : (cwceq @ (XD @ Xj) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv) @ ccmul))))) => ((! [Xj:$i] : (cwceq @ (XE @ Xj) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv))))) => ((! [Xj:$i] : (cwceq @ (XF @ Xj) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv) @ ccmul) @ (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv) @ ccaddc))))) => ((! [Xj:$i] : (cwceq @ (XH @ Xj) @ (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ XT @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))) => ((! [Xj:$i] : (cwceq @ (XG @ Xj) @ (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc))))) => ((cwi @ Xph @ (cwcel @ XT @ ccrp)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XT @ ccabs) @ cc1 @ cclt)) => (! [Xj:$i] : (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ (XH @ Xj) @ ccc0) @ (ccfv @ (cco @ (cco @ cc1 @ XT @ ccaddc) @ (cco @ cc1 @ XT @ ccmin) @ ccdiv) @ cclog) @ ccli)))))))))))))))))).
