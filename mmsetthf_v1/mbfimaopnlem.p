...
thf(acnrehmeo_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccfv @ (ccrn @ ccioo) @ cctg)))) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ (cco @ (XJ @ Xx3 @ Xy1) @ (XJ @ Xx3 @ Xy1) @ cctx) @ XK @ cchmeo))))))))))).
...
thf(acnrecnv_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (cccnv @ (XF @ Xx3 @ Xy1)) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccop @ (ccfv @ (ccv @ Xz) @ ccre) @ (ccfv @ (ccv @ Xz) @ ccim)))))))))).
