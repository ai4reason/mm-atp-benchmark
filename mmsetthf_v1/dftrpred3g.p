...
thf(atrpredeq3_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwceq @ XX @ XY) @ (cwceq @ (cctrpred @ XA2 @ XR @ XX) @ (cctrpred @ XA2 @ XR @ XY)))))))).
thf(assiun_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwss @ XC @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwss @ XC @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))).
...
thf(atrpredelss_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwse @ XA2 @ XR)) @ (cwi @ (cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) @ (cwss @ (cctrpred @ XA2 @ XR @ XY) @ (cctrpred @ XA2 @ XR @ XX))))))))).
...
thf(atrpredmintr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XX @ XA2) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ XB2)) @ (^ [Xy1:$i] : XB2)) @ (cwss @ (ccpred @ XA2 @ XR @ XX) @ XB2))) @ (cwss @ (cctrpred @ XA2 @ XR @ XX) @ XB2))))))).
...
thf(cdftrpred3g_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwse @ XA2 @ XR)) @ (cwceq @ (cctrpred @ XA2 @ XR @ XX) @ (ccun @ (ccpred @ XA2 @ XR @ XX) @ (cciun @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ XX)) @ (^ [Xy1:$i] : (cctrpred @ XA2 @ XR @ (ccv @ Xy1))))))))))).
