...
thf(adf_relexp_ax,axiom,(cwceq @ ccrelexp @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xn:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xr:$i] : (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ (ccres @ ccid @ (ccun @ (ccdm @ (ccv @ Xr)) @ (ccrn @ (ccv @ Xr)))) @ (ccfv @ (ccv @ Xn) @ (ccseq @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccom @ (ccv @ Xx3) @ (ccv @ Xr))))) @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccv @ Xr))) @ cc1)))))))).
...
thf(crelexp0g_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwceq @ (cco @ XR @ ccc0 @ ccrelexp) @ (ccres @ ccid @ (ccun @ (ccdm @ XR) @ (ccrn @ XR)))))))).
