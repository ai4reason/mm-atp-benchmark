...
thf(ambfres2cn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XB2) @ ccmbf)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XC) @ ccmbf)) => ((cwi @ Xph @ (cwceq @ (ccun @ XB2 @ XC) @ XA2)) => (cwi @ Xph @ (cwcel @ XF @ ccmbf)))))))))))).
...
thf(ciblsplit_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ (ccin @ XA2 @ XB2) @ ccovol) @ ccc0)) => ((cwi @ Xph @ (cwceq @ XU @ (ccun @ XA2 @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XU)) @ (cwcel @ (XC @ Xx3) @ ccc))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl)) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl)) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XU) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl))))))))))))).
