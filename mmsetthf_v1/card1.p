...
thf(acarden2a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwceq @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) @ (cwne @ (ccfv @ XA2 @ cccrd) @ cc0)) @ (cwbr @ XA2 @ XB2 @ ccen))))).
...
thf(ccard1_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ cc1o) @ (cwex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsn @ (ccv @ Xx3)))))))).
