...
thf(cvtxdusgr0edgnelALT_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XD @ Xe) @ (ccfv @ XG @ ccvtxdg))) => (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XU @ XV)) @ (cwb @ (cwceq @ (ccfv @ XU @ (XD @ Xe)) @ ccc0) @ (cwn @ (cwrex @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
