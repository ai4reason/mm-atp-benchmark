...
thf(acnrlmod_thm,axiom,(! [XC:($i > $o)] : ((cwceq @ XC @ (ccfv @ cccnfld @ ccrglmod)) => (cwcel @ XC @ cclmod)))).
...
thf(acnrlvec_thm,axiom,(! [XC:($i > $o)] : ((cwceq @ XC @ (ccfv @ cccnfld @ ccrglmod)) => (cwcel @ XC @ cclvec)))).
...
thf(ccncvs_conj,conjecture,(! [XC:($i > $o)] : ((cwceq @ XC @ (ccfv @ cccnfld @ ccrglmod)) => (cwcel @ XC @ cccvs)))).
