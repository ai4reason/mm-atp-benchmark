...
thf(celmpst_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmdv)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => (cwb @ (cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) @ (cw3a @ (cwa @ (cwss @ XD @ XV) @ (cwceq @ (cccnv @ XD) @ XD)) @ (cwa @ (cwss @ XH @ XE) @ (cwcel @ XH @ ccfn)) @ (cwcel @ XA2 @ XE)))))))))))))).
