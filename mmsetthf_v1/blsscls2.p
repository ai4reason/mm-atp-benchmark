...
thf(cblsscls2_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (ccfv @ XD @ ccmopn))) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ XP @ (ccv @ Xz) @ XD) @ XR @ ccle)) @ (^ [Xz:$i] : XX)))) => (! [Xz:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cw3a @ (cwcel @ XR @ ccxr) @ (cwcel @ XT @ ccxr) @ (cwbr @ XR @ XT @ cclt))) @ (cwss @ (XS @ Xz) @ (cco @ XP @ XT @ (ccfv @ XD @ ccbl))))))))))))))).
