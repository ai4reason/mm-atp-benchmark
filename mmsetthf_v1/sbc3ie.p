...
thf(csbc3ie_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3)) @ (cwceq @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1))) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz) @ Xps))))) => (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (XC @ Xx3 @ Xy1))) @ (XB2 @ Xx3))) @ XA2) @ Xps))))))))))).
