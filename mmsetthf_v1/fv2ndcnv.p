...
thf(cfv2ndcnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XA2)) @ (cwceq @ (ccfv @ XY @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XX) @ XA2)))) @ (ccop @ XX @ XY)))))))).
