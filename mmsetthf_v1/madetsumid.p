...
thf(amatgsumcl_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xr:$i] : (cwceq @ (XA2 @ Xr) @ (cco @ XN @ XR @ ccmat))) => ((! [Xr:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xr) @ ccbs))) => ((! [Xr:$i] : (cwceq @ (XU @ Xr) @ (ccfv @ XR @ ccmgp))) => (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) @ (cwcel @ (cco @ (XU @ Xr) @ (ccmpt @ (^ [Xr:$i] : XN) @ (^ [Xr:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xr) @ XM))) @ ccgsu) @ (ccfv @ XR @ ccbs)))))))))))))).
...
thf(cmadetsumid_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xr:$i] : (cwceq @ (XA2 @ Xr) @ (cco @ XN @ XR @ ccmat))) => ((! [Xr:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xr) @ ccbs))) => ((! [Xr:$i] : (cwceq @ (XU @ Xr) @ (ccfv @ XR @ ccmgp))) => ((! [Xr:$i] : (cwceq @ (XY @ Xr) @ (ccfv @ XR @ cczrh))) => ((! [Xr:$i] : (cwceq @ (XS @ Xr) @ (ccfv @ XN @ ccpsgn))) => ((! [Xr:$i] : (cwceq @ (Xc_x @ Xr) @ (ccfv @ XR @ ccmulr))) => (! [Xr:$i] : (cwi @ (cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2) @ (cwceq @ XP @ (ccres @ ccid @ XN))) @ (cwceq @ (cco @ (ccfv @ XP @ (cccom @ (XY @ Xr) @ (XS @ Xr))) @ (cco @ (XU @ Xr) @ (ccmpt @ (^ [Xr:$i] : XN) @ (^ [Xr:$i] : (cco @ (ccfv @ (ccv @ Xr) @ XP) @ (ccv @ Xr) @ XM))) @ ccgsu) @ (Xc_x @ Xr)) @ (cco @ (XU @ Xr) @ (ccmpt @ (^ [Xr:$i] : XN) @ (^ [Xr:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xr) @ XM))) @ ccgsu))))))))))))))))))))).
