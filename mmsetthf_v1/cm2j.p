...
thf(acmbr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ XA2 @ (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ (ccfv @ XB2 @ ccort)) @ cchj))))))).
...
thf(achj4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwa @ (cwcel @ XC @ ccch) @ (cwcel @ XD @ ccch))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XC @ XD @ cchj) @ cchj) @ (cco @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XD @ cchj) @ cchj)))))))).
...
thf(ccm2j_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwa @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ XA2 @ XC @ cccm))) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cccm)))))).
