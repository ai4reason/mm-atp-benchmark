...
thf(aprobnul_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprb) @ (cwceq @ (ccfv @ cc0 @ XP) @ ccc0)))).
...
thf(adisjprg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (XC @ Xx3) @ XD))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwceq @ (XC @ Xx3) @ XE))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ XB2 @ (XV @ Xx3)) @ (cwne @ XA2 @ XB2)) @ (cwb @ (cwdisj @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cwceq @ (ccin @ XD @ XE) @ cc0))))))))))))).
thf(aid_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ Xph))).
thf(aprobcun_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccpw @ (ccdm @ XP))) @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ XP) @ (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XP)))))))).
...
thf(aunitssxrge0_thm,axiom,(cwss @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ ccpnf @ ccicc))).
...
thf(cprobun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) @ (cwi @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ XP) @ (cco @ (ccfv @ XA2 @ XP) @ (ccfv @ XB2 @ XP) @ ccaddc)))))))).
