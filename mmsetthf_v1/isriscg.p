...
thf(cisriscg_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XR @ (XA2 @ Xf1)) @ (cwcel @ XS @ (XB2 @ Xf1))) @ (cwb @ (cwbr @ XR @ XS @ ccrisc) @ (cwa @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo)) @ (cwex @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XR @ XS @ ccrngiso))))))))))))).
