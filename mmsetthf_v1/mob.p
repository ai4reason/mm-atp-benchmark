...
thf(cmob_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xch))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ (XC @ Xx3)) @ (cwcel @ XB2 @ (XD @ Xx3))) @ (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) @ Xps) @ (cwb @ (cwceq @ XA2 @ XB2) @ Xch))))))))))))).
