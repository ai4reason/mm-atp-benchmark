...
thf(adf_mvh_ax,axiom,(cwceq @ ccmvh @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccmpt @ (^ [Xv:$i] : (ccfv @ (ccv @ Xt) @ ccmvar)) @ (^ [Xv:$i] : (ccop @ (ccfv @ (ccv @ Xv) @ (ccfv @ (ccv @ Xt) @ ccmty)) @ (ccs1 @ (ccv @ Xv))))))))).
...
thf(cmvhfval_conj,conjecture,(! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XY @ (ccfv @ XT @ ccmty)) => ((! [Xv:$i] : (cwceq @ (XH @ Xv) @ (ccfv @ XT @ ccmvh))) => (! [Xv:$i] : (cwceq @ (XH @ Xv) @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (ccop @ (ccfv @ (ccv @ Xv) @ XY) @ (ccs1 @ (ccv @ Xv))))))))))))))).
