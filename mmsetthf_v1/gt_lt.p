...
thf(adf_gt_ax,axiom,(cwceq @ ccgt @ (cccnv @ cclt))).
...
thf(cgt_lt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccvv) @ (cwcel @ XB2 @ ccvv)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccgt) @ (cwbr @ XB2 @ XA2 @ cclt)))))).
