...
thf(anneneq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwceq @ XA2 @ XB2)))))).
...
thf(cdif1en_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccom) @ (cwbr @ XA2 @ (ccsuc @ XM) @ ccen) @ (cwcel @ XX @ XA2)) @ (cwbr @ (ccdif @ XA2 @ (ccsn @ XX)) @ XM @ ccen)))))).
