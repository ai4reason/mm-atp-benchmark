...
thf(amzpcln0_thm,axiom,(! [XV:($i > $o)] : (cwi @ (cwcel @ XV @ ccvv) @ (cwne @ (ccfv @ XV @ ccmzpcl) @ cc0)))).
...
thf(adf_mzp_ax,axiom,(cwceq @ ccmzp @ (ccmpt @ (^ [Xv:$i] : ccvv) @ (^ [Xv:$i] : (ccint @ (ccfv @ (ccv @ Xv) @ ccmzpcl)))))).
thf(cmzpval_conj,conjecture,(! [XV:($i > $o)] : (cwi @ (cwcel @ XV @ ccvv) @ (cwceq @ (ccfv @ XV @ ccmzp) @ (ccint @ (ccfv @ XV @ ccmzpcl)))))).
