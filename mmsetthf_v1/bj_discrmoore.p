...
thf(abj_ismooredr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwss @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccin @ (ccuni @ XA2) @ (ccint @ (ccv @ Xx3))) @ XA2))) => (cwi @ Xph @ (cwcel @ XA2 @ ccmoore)))))))).
...
thf(cbj_discrmoore_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccvv) @ (cwcel @ (ccpw @ XA2) @ ccmoore)))).
