...
thf(atopgele_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwa @ (cwss @ (ccpr @ cc0 @ XX) @ XJ) @ (cwss @ XJ @ (ccpw @ XX))))))).
...
thf(arnmptsn_thm,axiom,(! [XA2:($i > ($i > $o))] : (cwceq @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3))))) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(amptsnun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XF @ Xx3 @ Xu) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XR @ Xx3 @ Xu) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))) => (! [Xx3:$i] : (! [Xu:$i] : (cwi @ (cwss @ XB2 @ XA2) @ (cwceq @ XB2 @ (ccuni @ (ccima @ (XF @ Xx3 @ Xu) @ XB2))))))))))))).
...
thf(cdissneqlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xu:$i] : (cwceq @ (XC @ Xu) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))) => (! [Xu:$i] : (cwi @ (cwa @ (cwss @ (XC @ Xu) @ (XB2 @ Xu)) @ (cwcel @ (XB2 @ Xu) @ (ccfv @ XA2 @ cctopon))) @ (cwceq @ (XB2 @ Xu) @ (ccpw @ XA2))))))))).
