...
thf(crepswpfx_conj,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0) @ (cwcel @ XL @ (cco @ ccc0 @ XN @ ccfz))) @ (cwceq @ (cco @ (cco @ XS @ XN @ ccreps) @ XL @ ccpfx) @ (cco @ XS @ XL @ ccreps)))))))).
