...
thf(cmzpcl2_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) @ (cwcel @ XF @ XV)) @ (cwcel @ (ccmpt @ (^ [Xg1:$i] : (cco @ ccz @ XV @ ccmap)) @ (^ [Xg1:$i] : (ccfv @ XF @ (ccv @ Xg1)))) @ XP)))))).
