...
thf(clcmgcdlem_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwa @ (cwceq @ (cco @ (cco @ XM @ XN @ cclcm) @ (cco @ XM @ XN @ ccgcd) @ ccmul) @ (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs)) @ (cwi @ (cwa @ (cwcel @ XK @ ccn) @ (cwa @ (cwbr @ XM @ XK @ ccdvds) @ (cwbr @ XN @ XK @ ccdvds))) @ (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccdvds)))))))).
