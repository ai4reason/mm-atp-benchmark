...
thf(csqsscirc1_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XX @ ccr) @ (cwbr @ ccc0 @ XX @ ccle)) @ (cwa @ (cwcel @ XY @ ccr) @ (cwbr @ ccc0 @ XY @ ccle))) @ (cwcel @ XD @ ccrp)) @ (cwi @ (cwa @ (cwbr @ XX @ (cco @ XD @ cc2 @ ccdiv) @ cclt) @ (cwbr @ XY @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) @ (cwbr @ (ccfv @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ XD @ cclt))))))).
