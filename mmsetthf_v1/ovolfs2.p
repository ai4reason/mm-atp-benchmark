...
thf(covolfs2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => (cwi @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) @ (cwceq @ XG @ (cccom @ (cccom @ ccovol @ ccioo) @ XF))))))).
