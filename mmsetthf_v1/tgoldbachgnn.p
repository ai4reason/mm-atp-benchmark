...
thf(ctgoldbachgnn_conj,conjecture,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccrab @ (^ [Xz:$i] : (cwn @ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccz))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XN @ XO))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ XN @ ccle))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XN @ ccn)))))))))).
