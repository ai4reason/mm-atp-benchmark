...
thf(cmpt2xopxprcov0_conj,conjecture,(! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XF @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xx3) @ cc1st))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))) => (! [Xy1:$i] : (cwi @ (cwn @ (cwa @ (cwcel @ (XV @ Xy1) @ ccvv) @ (cwcel @ (XW @ Xy1) @ ccvv))) @ (cwceq @ (cco @ (ccop @ (XV @ Xy1) @ (XW @ Xy1)) @ (XK @ Xy1) @ (XF @ Xy1)) @ cc0)))))))))).
