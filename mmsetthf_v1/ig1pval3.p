...
thf(aig1peu_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ XM @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ XU) @ (cwne @ XI @ (ccsn @ Xc_0))) @ (cwreu @ (^ [Xg1:$i] : (cwceq @ (ccfv @ (ccv @ Xg1) @ XD) @ (ccinf @ (ccima @ XD @ (ccdif @ XI @ (ccsn @ Xc_0))) @ ccr @ cclt))) @ (^ [Xg1:$i] : (ccin @ XI @ XM))))))))))))))))).
