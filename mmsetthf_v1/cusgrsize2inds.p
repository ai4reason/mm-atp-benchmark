...
thf(ahashnn0n0nn_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XY @ ccn0)) @ (cwa @ (cwceq @ (ccfv @ XV @ cchash) @ XY) @ (cwcel @ XN @ XV))) @ (cwcel @ XY @ ccn))))))).
...
thf(acusgrsizeinds_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XF @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : (cwi @ (cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ XV)) @ (cwceq @ (ccfv @ XE @ cchash) @ (cco @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ (ccfv @ (XF @ Xe) @ cchash) @ ccaddc))))))))))))).
...
thf(abcn2m1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ (cco @ XN @ cc1 @ ccmin) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccbc) @ ccaddc) @ (cco @ XN @ cc2 @ ccbc))))).
