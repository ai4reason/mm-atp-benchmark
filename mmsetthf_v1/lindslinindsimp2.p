...
thf(alspeqlco_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ XB2))) @ (cwceq @ (cco @ XM @ XV @ cclinco) @ (ccfv @ XV @ (ccfv @ XM @ cclspn))))))))).
...
thf(alindslinindsimp2lem5_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XR @ (ccfv @ (XM @ Xx3) @ ccsca))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ XR @ ccbs))) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XZ @ Xx3) @ (ccfv @ (XM @ Xx3) @ cc0g))) => (! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (XV @ Xx3 @ Xf1)) @ (cwcel @ (XM @ Xx3) @ cclmod)) @ (cwa @ (cwss @ XS @ (ccfv @ (XM @ Xx3) @ ccbs)) @ (cwcel @ (ccv @ Xx3) @ XS))) @ (cwi @ (cwa @ (cwcel @ (ccv @ Xf1) @ (cco @ (XB2 @ Xx3) @ XS @ ccmap)) @ (cwa @ (cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) @ (cwceq @ (cco @ (ccv @ Xf1) @ XS @ (ccfv @ (XM @ Xx3) @ cclinc)) @ (XZ @ Xx3)))) @ (cwi @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xg1:$i] : (cwo @ (cwn @ (cwbr @ (ccv @ Xg1) @ Xc_0 @ ccfsupp)) @ (cwn @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (XM @ Xx3) @ ccvsca)) @ (cco @ (ccv @ Xg1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ (ccfv @ (XM @ Xx3) @ cclinc)))))) @ (^ [Xg1:$i] : (cco @ (XB2 @ Xx3) @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ ccmap)))) @ (^ [Xy1:$i] : (ccdif @ (XB2 @ Xx3) @ (ccsn @ Xc_0)))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ Xc_0)))))))))))))))))).
thf(clindslinindsimp2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XM @ cclmod)) @ (cwi @ (cwa @ (cwss @ XS @ (ccfv @ XM @ ccbs)) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xs1) @ (ccfv @ XM @ ccvsca)) @ (ccfv @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ (ccfv @ XM @ cclspn))))) @ (^ [Xy1:$i] : (ccdif @ XB2 @ (ccsn @ Xc_0))))) @ (^ [Xs1:$i] : XS))) @ (cwa @ (cwcel @ XS @ (ccpw @ (ccfv @ XM @ ccbs))) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) @ (cwceq @ (cco @ (ccv @ Xf1) @ XS @ (ccfv @ XM @ cclinc)) @ XZ)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ Xc_0)) @ (^ [Xx3:$i] : XS)))) @ (^ [Xf1:$i] : (cco @ XB2 @ XS @ ccmap)))))))))))))))))).
