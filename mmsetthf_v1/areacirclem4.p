...
thf(ainelr_thm,axiom,(cwn @ (cwcel @ cci @ ccr))).
...
thf(careacirclem4_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccrp) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ ccasin) @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ (ccfv @ (cco @ cc1 @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul) @ ccaddc) @ ccmul))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
