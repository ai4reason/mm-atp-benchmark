...
thf(aefrn2lp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwfr @ XA2 @ ccep) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2))) @ (cwn @ (cwa @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XB2)))))))).
...
thf(cen2lp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwn @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ XA2)))))).
