...
thf(aax_1rid_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (cco @ XA2 @ cc1 @ ccmul) @ XA2)))).
...
thf(anmfnleub_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ ccc @ XT) @ (cwcel @ XA2 @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ XT @ ccnmf) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccno) @ cc1 @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccabs) @ XA2 @ ccle))) @ (^ [Xx3:$i] : cchil))))))).
thf(cnmfnleub2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwf @ cchil @ ccc @ XT) @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccabs) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccno) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : cchil))) @ (cwbr @ (ccfv @ XT @ ccnmf) @ XA2 @ ccle))))).
