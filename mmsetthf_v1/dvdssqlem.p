...
thf(advdssqim_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ (cco @ XM @ cc2 @ ccexp) @ (cco @ XN @ cc2 @ ccexp) @ ccdvds)))))).
...
thf(asqgcd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ (cco @ XM @ XN @ ccgcd) @ cc2 @ ccexp) @ (cco @ (cco @ XM @ cc2 @ ccexp) @ (cco @ XN @ cc2 @ ccexp) @ ccgcd)))))).
...
thf(agcdeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ XA2) @ (cwbr @ XA2 @ XB2 @ ccdvds)))))).
...
thf(cdvdssqlem_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ (cco @ XM @ cc2 @ ccexp) @ (cco @ XN @ cc2 @ ccexp) @ ccdvds)))))).
