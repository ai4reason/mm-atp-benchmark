...
thf(cncoprmlnprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwi @ (cwbr @ cc1 @ (cco @ XA2 @ XB2 @ ccgcd) @ cclt) @ (cwnel @ XB2 @ ccprime)))))).
