...
thf(aunopbd_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccuo) @ (cwcel @ XT @ ccbo)))).
...
thf(anmop0h_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwceq @ cchil @ cc0h) @ (cwf @ cchil @ cchil @ XT)) @ (cwceq @ (ccfv @ XT @ ccnop) @ ccc0)))).
...
thf(ahonpncani_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (cwceq @ (cco @ (cco @ XR @ XS @ cchod) @ (cco @ XS @ XT @ cchod) @ cchos) @ (cco @ XR @ XT @ cchod))))))))).
...
thf(anmopun_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwne @ cchil @ cc0h) @ (cwcel @ XT @ ccuo)) @ (cwceq @ (ccfv @ XT @ ccnop) @ cc1)))).
