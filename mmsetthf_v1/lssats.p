...
thf(clssats_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XS @ (ccfv @ (XW @ Xx3) @ cclss))) => ((! [Xx3:$i] : (cwceq @ XN @ (ccfv @ (XW @ Xx3) @ cclspn))) => ((! [Xx3:$i] : (cwceq @ XA2 @ (ccfv @ (XW @ Xx3) @ cclsa))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XW @ Xx3) @ cclmod) @ (cwcel @ XU @ XS)) @ (cwceq @ XU @ (ccfv @ (ccuni @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XU)) @ (^ [Xx3:$i] : XA2))) @ XN))))))))))))).
