...
thf(aeqbrrdv2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwa @ (cwrel @ XA2) @ (cwrel @ XB2)) @ Xph) @ (cwb @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XB2))))) => (cwi @ (cwa @ (cwa @ (cwrel @ XA2) @ (cwrel @ XB2)) @ Xph) @ (cwceq @ XA2 @ XB2))))))).
...
thf(aqsel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwer @ XX @ XR) @ (cwcel @ XB2 @ (ccqs @ XA2 @ XR)) @ (cwcel @ XC @ XB2)) @ (cwceq @ XB2 @ (ccec @ XC @ XR))))))))).
...
thf(cprter3_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (cwceq @ (Xc_sm @ Xx3 @ Xy1 @ Xu) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwer @ (ccuni @ XA2) @ (XS @ Xx3 @ Xy1 @ Xu)) @ (cwceq @ (ccqs @ (ccuni @ XA2) @ (XS @ Xx3 @ Xy1 @ Xu)) @ (ccdif @ XA2 @ (ccsn @ cc0)))) @ (cwceq @ (Xc_sm @ Xx3 @ Xy1 @ Xu) @ (XS @ Xx3 @ Xy1 @ Xu))))))))))).
