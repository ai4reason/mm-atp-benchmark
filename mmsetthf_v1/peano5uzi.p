...
thf(cpeano5uzi_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwi @ (cwa @ (cwcel @ XN @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XA2)) @ (^ [Xx3:$i] : XA2))) @ (cwss @ (ccrab @ (^ [Xk:$i] : (cwbr @ XN @ (ccv @ Xk) @ ccle)) @ (^ [Xk:$i] : ccz)) @ XA2)))))).
