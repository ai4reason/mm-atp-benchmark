...
thf(asub2cncfd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccmin))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf)))))))))).
...
thf(cfprodsub2cncf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XF @ Xx3 @ Xk) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ (ccv @ Xx3) @ ccmin)))))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XF @ Xx3 @ Xk) @ (cco @ ccc @ ccc @ cccncf)))))))))))))).
