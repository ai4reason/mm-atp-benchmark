...
thf(aaannenlem2_thm,axiom,(! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (XH @ Xe @ Xa @ Xb @ Xc @ Xd) @ (ccmpt @ (^ [Xa:$i] : ccn0) @ (^ [Xa:$i] : (ccrab @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xb) @ (ccv @ Xc)) @ ccc0)) @ (^ [Xc:$i] : (ccrab @ (^ [Xd:$i] : (cw3a @ (cwne @ (ccv @ Xd) @ cc0p) @ (cwbr @ (ccfv @ (ccv @ Xd) @ ccdgr) @ (ccv @ Xa) @ ccle) @ (cwral @ (^ [Xe:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xd) @ cccoe)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xe:$i] : ccn0)))) @ (^ [Xd:$i] : (ccfv @ ccz @ ccply)))))) @ (^ [Xb:$i] : ccc)))))))))) => (! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ ccaa @ (ccuni @ (ccrn @ (XH @ Xe @ Xa @ Xb @ Xc @ Xd)))))))))))).
...
thf(aisnumi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwbr @ XA2 @ XB2 @ ccen)) @ (cwcel @ XB2 @ (ccdm @ cccrd)))))).
...
thf(aaannenlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (XH @ Xe @ Xa @ Xb @ Xc @ Xd) @ (ccmpt @ (^ [Xa:$i] : ccn0) @ (^ [Xa:$i] : (ccrab @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xb) @ (ccv @ Xc)) @ ccc0)) @ (^ [Xc:$i] : (ccrab @ (^ [Xd:$i] : (cw3a @ (cwne @ (ccv @ Xd) @ cc0p) @ (cwbr @ (ccfv @ (ccv @ Xd) @ ccdgr) @ (ccv @ Xa) @ ccle) @ (cwral @ (^ [Xe:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xd) @ cccoe)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xe:$i] : ccn0)))) @ (^ [Xd:$i] : (ccfv @ ccz @ ccply)))))) @ (^ [Xb:$i] : ccc)))))))))) => (! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwcel @ (ccfv @ XA2 @ (XH @ Xe @ Xa @ Xb @ Xc @ Xd)) @ ccfn))))))))))).
...
thf(aiunfictbso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwss @ XA2 @ ccfn) @ (cwor @ (ccuni @ XA2) @ XB2)) @ (cwbr @ (ccuni @ XA2) @ ccom @ ccdom))))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acnso_thm,axiom,(cwex @ (^ [Xx3:$i] : (cwor @ ccc @ (ccv @ Xx3))))).
