...
thf(agsumwrev_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XO @ (ccfv @ XM @ ccoppg)) => (cwi @ (cwa @ (cwcel @ XM @ ccmnd) @ (cwcel @ XW @ (ccword @ XB2))) @ (cwceq @ (cco @ XO @ XW @ ccgsu) @ (cco @ XM @ (ccfv @ XW @ ccreverse) @ ccgsu)))))))))).
thf(csymgtrinv_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XD @ XV) @ (cwcel @ XW @ (ccword @ XT))) @ (cwceq @ (ccfv @ (cco @ XG @ XW @ ccgsu) @ XI) @ (cco @ XG @ (ccfv @ XW @ ccreverse) @ ccgsu))))))))))))).
