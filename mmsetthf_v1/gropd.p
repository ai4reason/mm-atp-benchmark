...
thf(cgropd_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwi @ Xph @ (cwal @ (^ [Xg1:$i] : (cwi @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xg1) @ ccvtx) @ XV) @ (cwceq @ (ccfv @ (ccv @ Xg1) @ cciedg) @ XE)) @ (Xps @ Xg1))))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XV @ (XU @ Xg1)))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XE @ (XW @ Xg1)))) => (cwi @ Xph @ (cwsbc @ (^ [Xg1:$i] : (Xps @ Xg1)) @ (ccop @ XV @ XE))))))))))))).
