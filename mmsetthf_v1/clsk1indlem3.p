...
thf(aelif_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccif @ Xph @ XB2 @ XC)) @ (cwo @ (cwa @ Xph @ (cwcel @ XA2 @ XB2)) @ (cwa @ (cwn @ Xph) @ (cwcel @ XA2 @ XC))))))))).
...
thf(aan3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwa @ (cwa @ Xph @ Xps) @ (cwa @ Xch @ Xth)) @ (cwa @ Xph @ Xth))))))).
...
thf(auneqsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwceq @ (ccun @ XA2 @ XB2) @ (ccsn @ XC)) @ (cw3o @ (cwa @ (cwceq @ XA2 @ (ccsn @ XC)) @ (cwceq @ XB2 @ (ccsn @ XC))) @ (cwa @ (cwceq @ XA2 @ (ccsn @ XC)) @ (cwceq @ XB2 @ cc0)) @ (cwa @ (cwceq @ XA2 @ cc0) @ (cwceq @ XB2 @ (ccsn @ XC))))))))).
...
thf(aor42_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwb @ (cwo @ (cwo @ Xph @ Xps) @ (cwo @ Xch @ Xth)) @ (cwo @ (cwo @ Xph @ Xch) @ (cwo @ Xth @ Xps)))))))).
thf(a_4exmid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwo @ (cwo @ (cwa @ Xph @ Xps) @ (cwa @ (cwn @ Xph) @ (cwn @ Xps))) @ (cwo @ (cwa @ Xph @ (cwn @ Xps)) @ (cwa @ Xps @ (cwn @ Xph))))))).
