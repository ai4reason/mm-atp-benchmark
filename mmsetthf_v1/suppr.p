...
thf(csuppr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) @ (cwceq @ (ccsup @ (ccpr @ XB2 @ XC) @ XA2 @ XR) @ (ccif @ (cwbr @ XC @ XB2 @ XR) @ XB2 @ XC)))))))).
