...
thf(aaxcc2lem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XK @ Xf1 @ Xg1) @ (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)) @ cc0) @ (ccsn @ cc0) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XA2 @ Xg1) @ (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccxp @ (ccsn @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xn) @ (XK @ Xf1 @ Xg1)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XG @ Xf1) @ (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xg1)) @ (ccv @ Xf1)) @ cc2nd)))))) => (cwex @ (^ [Xg1:$i] : (cwa @ (cwfn @ (ccv @ Xg1) @ ccom) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwne @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))))) @ (^ [Xn:$i] : ccom))))))))))))).
...
thf(caxcc2_conj,conjecture,(! [XF:($i > $o)] : (cwex @ (^ [Xg1:$i] : (cwa @ (cwfn @ (ccv @ Xg1) @ ccom) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwne @ (ccfv @ (ccv @ Xn) @ XF) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xn) @ XF)))) @ (^ [Xn:$i] : ccom))))))).
