...
thf(cdfrefrels3_conj,conjecture,(cwceq @ ccrefrels @ (ccrab @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)))) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xr))))) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xr))))) @ (^ [Xr:$i] : ccrels)))).
