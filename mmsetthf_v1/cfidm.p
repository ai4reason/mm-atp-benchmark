...
thf(acfcoflem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwi @ (cwex @ (^ [Xf1:$i] : (cw3a @ (cwf @ XB2 @ XA2 @ (ccv @ Xf1)) @ (cwsmo @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))) @ (cwss @ (ccfv @ XA2 @ cccf) @ (ccfv @ XB2 @ cccf))))))).
...
thf(ccfidm_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ XA2 @ cccf) @ cccf) @ (ccfv @ XA2 @ cccf)))).
