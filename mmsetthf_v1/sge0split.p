...
thf(axreqle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwceq @ XA2 @ XB2)) @ (cwbr @ XA2 @ XB2 @ ccle))))).
...
thf(age0nemnf2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwne @ XA2 @ ccmnf)))).
...
thf(arnresun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccrn @ (ccres @ XF @ (ccun @ XA2 @ XB2))) @ (ccun @ (ccrn @ (ccres @ XF @ XA2)) @ (ccrn @ (ccres @ XF @ XB2)))))))).
...
thf(afsumlesge0_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XX @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ (XX @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XY @ (XX @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XY @ ccfn))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (ccsu @ XY @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) @ (ccfv @ XF @ ccsumge0) @ ccle))))))))))))).
...
thf(csge0split_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwceq @ XU @ (ccun @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) => ((cwi @ Xph @ (cwf @ XU @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (cco @ (ccfv @ (ccres @ XF @ XA2) @ ccsumge0) @ (ccfv @ (ccres @ XF @ XB2) @ ccsumge0) @ ccxad)))))))))))))))).
