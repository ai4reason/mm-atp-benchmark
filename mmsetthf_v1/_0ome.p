...
thf(c_0ome_conj,conjecture,(! [Xph:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XX @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XO @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : ccc0)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XO @ Xx3) @ ccome)))))))))).
