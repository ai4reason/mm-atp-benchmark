...
thf(asinmulcos_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ cccos) @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ ccsin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccsin) @ ccaddc) @ cc2 @ ccdiv)))))).
...
thf(cdirkertrigeqlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ XA2 @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ XA2 @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))).
