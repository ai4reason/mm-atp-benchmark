...
thf(celrint_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [Xy1:$i] : (cwb @ (cwcel @ XX @ (ccin @ (XA2 @ Xy1) @ (ccint @ XB2))) @ (cwa @ (cwcel @ XX @ (XA2 @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ XX @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))))))))).
