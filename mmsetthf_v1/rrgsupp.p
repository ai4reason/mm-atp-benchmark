...
thf(arrgeq0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XE @ (ccfv @ XR @ ccrlreg)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XE) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwceq @ (cco @ XX @ XY @ Xc_x) @ Xc_0) @ (cwceq @ XY @ Xc_0))))))))))))))).
