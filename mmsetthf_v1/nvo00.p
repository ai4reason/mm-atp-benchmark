...
thf(cnvo00_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwf @ XX @ XY @ XT)) @ (cwb @ (cwceq @ XT @ (ccxp @ XX @ (ccsn @ XZ))) @ (cwceq @ (ccrn @ XT) @ (ccsn @ XZ))))))))))).
