...
thf(adissnlocfin_thm,axiom,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => (cwi @ (cwcel @ XX @ XV) @ (cwcel @ XC @ (ccfv @ (ccpw @ XX) @ cclocfin)))))))).
...
thf(adissnref_thm,axiom,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwceq @ (ccuni @ XY) @ XX)) @ (cwbr @ XC @ XY @ ccref)))))))).
thf(arspcev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ Xps) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(abreq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwbr @ XA2 @ XC @ XR) @ (cwbr @ XB2 @ XC @ XR)))))))).
thf(aiscref_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XX @ Xy1 @ Xz) @ (ccuni @ XJ)))) => (! [Xz:$i] : (cwb @ (cwcel @ XJ @ (cccref @ XA2)) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwceq @ (XX @ Xy1 @ Xz) @ (ccuni @ (ccv @ Xy1))) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccref)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XJ) @ XA2))))) @ (^ [Xy1:$i] : (ccpw @ XJ))))))))))).
thf(aeqcomi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ XB2 @ XA2))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(aunipw_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccuni @ (ccpw @ XA2)) @ XA2))).
thf(aispcmp_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccpcmp) @ (cwcel @ XJ @ (cccref @ (ccfv @ XJ @ cclocfin)))))).
thf(cdispcmp_conj,conjecture,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwcel @ (ccpw @ XX) @ ccpcmp))))).
