...
thf(cismri2dad_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccfv @ XA2 @ ccmrc)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccmri)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((cwi @ Xph @ (cwcel @ XS @ XI)) => ((cwi @ Xph @ (cwcel @ XY @ XS)) => (cwi @ Xph @ (cwn @ (cwcel @ XY @ (ccfv @ (ccdif @ XS @ (ccsn @ XY)) @ XN))))))))))))))))).
