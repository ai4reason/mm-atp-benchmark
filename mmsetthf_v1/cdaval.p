...
thf(ccdaval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (cco @ XA2 @ XB2 @ cccda) @ (ccun @ (ccxp @ XA2 @ (ccsn @ cc0)) @ (ccxp @ XB2 @ (ccsn @ cc1o)))))))))).
