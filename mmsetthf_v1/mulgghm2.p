...
thf(cmulgghm2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ Xc_1 @ Xc_x))))) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XR @ ccgrp) @ (cwcel @ Xc_1 @ XB2)) @ (cwcel @ (XF @ Xn) @ (cco @ czring @ XR @ ccghm))))))))))))).
