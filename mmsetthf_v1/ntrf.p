...
thf(antrrn_thm,axiom,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XI @ (ccfv @ XJ @ ccnt)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwss @ (ccrn @ XI) @ XJ)))))))).
thf(adf_f_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwf @ XA2 @ XB2 @ XF) @ (cwa @ (cwfn @ XF @ XA2) @ (cwss @ (ccrn @ XF) @ XB2))))))).
thf(cntrf_conj,conjecture,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XI @ (ccfv @ XJ @ ccnt)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwf @ (ccpw @ XX) @ XJ @ XI)))))))).
