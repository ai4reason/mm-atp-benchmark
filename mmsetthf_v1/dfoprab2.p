...
thf(cdfoprab2_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (cwceq @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) @ (ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xw) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))))).
