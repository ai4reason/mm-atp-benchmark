...
thf(csuppssr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ (cco @ XF @ XZ @ ccsupp) @ XW)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ XU)) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ (ccdif @ XA2 @ XW))) @ (cwceq @ (ccfv @ XX @ XF) @ XZ)))))))))))))))).
