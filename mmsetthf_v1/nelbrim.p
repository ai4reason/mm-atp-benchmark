...
thf(anelbr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccnelbr) @ (cwn @ (cwcel @ XA2 @ XB2))))))))).
thf(cnelbrim_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccnelbr) @ (cwn @ (cwcel @ XA2 @ XB2)))))).
