...
thf(acxp2limlem_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (cco @ XA2 @ (ccv @ Xn) @ cccxp) @ ccdiv))) @ ccc0 @ ccrli)))).
...
thf(ccxp2lim_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ cc1 @ XB2 @ cclt)) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ XA2 @ cccxp) @ (cco @ XB2 @ (ccv @ Xn) @ cccxp) @ ccdiv))) @ ccc0 @ ccrli))))).
