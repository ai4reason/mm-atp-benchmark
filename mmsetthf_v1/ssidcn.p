...
thf(cssidcn_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XX @ cctopon))) @ (cwb @ (cwcel @ (ccres @ ccid @ XX) @ (cco @ XJ @ XK @ cccn)) @ (cwss @ XK @ XJ))))))).
