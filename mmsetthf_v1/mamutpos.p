...
thf(atposmap_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ XI @ XJ) @ ccmap)) @ (cwcel @ (cctpos @ XA2) @ (cco @ XB2 @ (ccxp @ XJ @ XI) @ ccmap)))))))).
thf(cmamutpos_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => ((cwceq @ XG @ (cco @ XR @ (ccotp @ XP @ XN @ XM) @ ccmmul)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XM @ ccfn)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((cwi @ Xph @ (cwcel @ XP @ ccfn)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XN @ XP) @ ccmap))) => (cwi @ Xph @ (cwceq @ (cctpos @ (cco @ XX @ XY @ XF)) @ (cco @ (cctpos @ XY) @ (cctpos @ XX) @ XG))))))))))))))))))))))).
