...
thf(afaclbnd4lem3_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XK @ ccn0)) @ (cwceq @ XN @ ccc0)) @ (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle)))))).
...
thf(afaclbnd3_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwbr @ (cco @ XM @ XN @ ccexp) @ (cco @ (cco @ XM @ XM @ ccexp) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
...
thf(cfaclbnd4lem4_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccn0) @ (cwcel @ XM @ ccn0)) @ (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle)))))).
