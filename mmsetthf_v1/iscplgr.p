...
thf(ciscplgr_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (! [Xv:$i] : (cwi @ (cwcel @ XG @ (XW @ Xv)) @ (cwb @ (cwcel @ XG @ cccplgr) @ (cwral @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccfv @ XG @ ccuvtx))) @ (^ [Xv:$i] : XV)))))))))).
