...
thf(asnunioo2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwceq @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XB2)) @ (cco @ XA2 @ XB2 @ ccioc)))))).
thf(climcicciooub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XB2 @ cclimc) @ (cco @ XF @ XB2 @ cclimc)))))))))))).
