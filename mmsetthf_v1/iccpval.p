...
thf(adf_iccp_ax,axiom,(cwceq @ cciccp @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo)))) @ (^ [Xp:$i] : (cco @ ccxr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap))))))).
...
thf(ciccpval_conj,conjecture,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccn) @ (cwceq @ (ccfv @ XM @ cciccp) @ (ccrab @ (^ [Xp:$i] : (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)))) @ (^ [Xp:$i] : (cco @ ccxr @ (cco @ ccc0 @ XM @ ccfz) @ ccmap))))))).
