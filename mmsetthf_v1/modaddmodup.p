...
thf(cmodaddmodup_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccn)) @ (cwi @ (cwcel @ XB2 @ (cco @ (cco @ XM @ (cco @ XA2 @ XM @ ccmo) @ ccmin) @ XM @ ccfzo)) @ (cwceq @ (cco @ (cco @ XB2 @ (cco @ XA2 @ XM @ ccmo) @ ccaddc) @ XM @ ccmin) @ (cco @ (cco @ XB2 @ XA2 @ ccaddc) @ XM @ ccmo)))))))).
