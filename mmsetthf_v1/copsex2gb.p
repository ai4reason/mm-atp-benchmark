...
thf(ccopsex2gb_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ XA2 @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwb @ Xph @ (Xps @ Xx3 @ Xy1))))) => (cwb @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ XA2 @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (Xps @ Xx3 @ Xy1)))))) @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ Xph))))))).
