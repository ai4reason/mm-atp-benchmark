...
thf(adfac10c_thm,axiom,(cwb @ cwac @ (cwal @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccen)) @ (^ [Xy1:$i] : ccon0)))))).
thf(aeqv_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ XA2 @ ccvv) @ (cwal @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)))))).
thf(cdfac10b_conj,conjecture,(cwb @ cwac @ (cwceq @ (ccima @ ccen @ ccon0) @ ccvv))).
