...
thf(advdsadd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ XM @ (cco @ XM @ XN @ ccaddc) @ ccdvds)))))).
...
thf(advdsmod_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XP @ ccn) @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccz)) @ (cwbr @ XP @ XN @ ccdvds)) @ (cwb @ (cwbr @ XP @ (cco @ XK @ XN @ ccmo) @ ccdvds) @ (cwbr @ XP @ XK @ ccdvds))))))).
