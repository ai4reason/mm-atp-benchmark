...
thf(cisosctrlem1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ cc1) @ (cwn @ (cwceq @ cc1 @ XA2))) @ (cwne @ (ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) @ ccpi)))).
