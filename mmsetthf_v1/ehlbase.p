...
thf(aehlval_thm,axiom,(! [XE:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XE @ (ccfv @ XN @ ccehl)) => (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ XE @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccrrx))))))).
...
thf(cehlbase_conj,conjecture,(! [XE:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XE @ (ccfv @ XN @ ccehl)) => (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ ccr @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccfv @ XE @ ccbs))))))).
