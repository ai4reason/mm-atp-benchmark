...
thf(cqredeq_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1)) @ (cw3a @ (cwcel @ XP @ ccz) @ (cwcel @ XQ @ ccn) @ (cwceq @ (cco @ XP @ XQ @ ccgcd) @ cc1)) @ (cwceq @ (cco @ XM @ XN @ ccdiv) @ (cco @ XP @ XQ @ ccdiv))) @ (cwa @ (cwceq @ XM @ XP) @ (cwceq @ XN @ XQ)))))))).
