...
thf(aex_ss_thm,axiom,(cwss @ (ccpr @ cc1 @ cc2) @ (cctp @ cc1 @ cc2 @ cc3))).
...
thf(anelpri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwne @ XA2 @ XB2) => ((cwne @ XA2 @ XC) => (cwn @ (cwcel @ XA2 @ (ccpr @ XB2 @ XC))))))))).
...
thf(cex_pss_conj,conjecture,(cwpss @ (ccpr @ cc1 @ cc2) @ (cctp @ cc1 @ cc2 @ cc3))).
