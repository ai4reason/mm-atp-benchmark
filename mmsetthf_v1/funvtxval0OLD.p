...
thf(cfunvtxval0OLD_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ ccvv) => (cwi @ (cw3a @ (cwa @ (cwcel @ XG @ XV) @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0)))) @ (cwne @ XS @ (ccfv @ ccnx @ ccbs)) @ (cwss @ (ccpr @ (ccfv @ ccnx @ ccbs) @ XS) @ (ccdm @ XG))) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ ccbs)))))))).
