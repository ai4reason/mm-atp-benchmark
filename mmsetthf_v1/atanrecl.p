...
thf(acjrebd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ cccj) @ XA2)) => (cwi @ Xph @ (cwcel @ XA2 @ ccr))))))).
...
thf(aatancj_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccatan) @ cccj) @ (ccfv @ (ccfv @ XA2 @ cccj) @ ccatan)))))).
thf(acjre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ cccj) @ XA2)))).
thf(catanrecl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccatan) @ ccr)))).
