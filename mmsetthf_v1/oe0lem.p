...
thf(coe0lem_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : ((cwi @ (cwa @ Xph @ (cwceq @ XA2 @ cc0)) @ Xps) => ((cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccon0) @ Xph) @ (cwcel @ cc0 @ XA2)) @ Xps) => (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ Xph) @ Xps))))))).
