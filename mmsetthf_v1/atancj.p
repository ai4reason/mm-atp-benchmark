...
thf(arenegi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwceq @ (ccfv @ (ccneg @ XA2) @ ccre) @ (ccneg @ (ccfv @ XA2 @ ccre)))))).
...
thf(aatandmcj_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwcel @ (ccfv @ XA2 @ cccj) @ (ccdm @ ccatan))))).
...
thf(catancj_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccatan) @ cccj) @ (ccfv @ (ccfv @ XA2 @ cccj) @ ccatan)))))).
