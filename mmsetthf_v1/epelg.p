...
thf(aopeqex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwceq @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (cwb @ (cwa @ (cwcel @ XA2 @ ccvv) @ (cwcel @ XB2 @ ccvv)) @ (cwa @ (cwcel @ XC @ ccvv) @ (cwcel @ XD @ ccvv))))))))).
...
thf(cepelg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccep) @ (cwcel @ XA2 @ XB2))))))).
