...
thf(asnifpsrbag_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XI @ (XV @ Xf1)) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccmpt @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ XX) @ XN @ ccc0))) @ (XD @ Xf1))))))))))).
thf(amplcoe3_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [Xc_ex:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XP @ Xy1 @ Xf1) @ (cco @ XI @ (XR @ Xk) @ ccmpl))))) => ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xk:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xk) @ cc0g))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (Xc_1 @ Xf1) @ (ccfv @ (XR @ Xk) @ ccur)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XI @ (XW @ Xf1)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XG @ Xy1 @ Xf1) @ (ccfv @ (XP @ Xy1 @ Xf1) @ ccmgp)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (Xc_ex @ Xy1 @ Xf1) @ (ccfv @ (XG @ Xy1 @ Xf1) @ ccmg)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XV @ Xy1 @ Xf1) @ (cco @ XI @ (XR @ Xk) @ ccmvr))))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XR @ Xk) @ ccrg)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XX @ XI))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XN @ Xf1) @ ccn0))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccmpt @ (^ [Xy1:$i] : (XD @ Xf1)) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ (ccmpt @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ XX) @ (XN @ Xf1) @ ccc0)))) @ (Xc_1 @ Xf1) @ Xc_0))) @ (cco @ (XN @ Xf1) @ (ccfv @ XX @ (XV @ Xy1 @ Xf1)) @ (Xc_ex @ Xy1 @ Xf1))))))))))))))))))))))))))))))).
...
thf(agsumzunsnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : (cwceq @ (Xc_pl @ Xk) @ (ccfv @ XG @ ccplusg))) => ((! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ XG @ cccntz))) => ((! [Xk:$i] : (cwceq @ (XF @ Xk) @ (ccmpt @ (^ [Xk:$i] : (ccun @ XA2 @ (ccsn @ XM))) @ (^ [Xk:$i] : (XX @ Xk))))) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ Xph @ (cwss @ (ccrn @ (XF @ Xk)) @ (ccfv @ (ccrn @ (XF @ Xk)) @ (XZ @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XX @ Xk) @ XB2))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XM @ (XV @ Xk)))) => ((cwi @ Xph @ (cwn @ (cwcel @ XM @ XA2))) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xk) @ XM)) @ (cwceq @ (XX @ Xk) @ XY))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ XG @ (XF @ Xk) @ ccgsu) @ (cco @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ XY @ (Xc_pl @ Xk))))))))))))))))))))))))))))).
