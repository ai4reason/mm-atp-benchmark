...
thf(aaxrepndlem2_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwa @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)))))) @ (cwn @ (cwal @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)))))) @ (cwex @ (^ [Xx3:$i] : (cwi @ (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (cwceq @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (cwal @ (^ [Xz:$i] : (cwb @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))))))))))))).
...
thf(anexd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwn @ (Xps @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwn @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3))))))))))).
...
thf(and4_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwn @ (cwal @ (^ [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))).
thf(and1_thm,axiom,(! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xz))))))))).
thf(caxrepnd_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwi @ (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (cwceq @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (cwal @ (^ [Xz:$i] : (cwb @ (cwal @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwal @ (^ [Xz:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))))))))))).
