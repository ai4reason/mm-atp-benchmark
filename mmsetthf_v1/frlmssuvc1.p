...
thf(afrlmsslss2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XU @ (ccfv @ XY @ cclss)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ Xc_0 @ ccsupp) @ XJ)) @ (^ [Xx3:$i] : XB2)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XV) @ (cwss @ XJ @ XI)) @ (cwcel @ (XC @ Xx3) @ XU)))))))))))))))))).
...
thf(cfrlmssuvc1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XU @ (cco @ XR @ XI @ ccuvc)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XF @ ccvsca)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ Xc_0 @ ccsupp) @ XJ)) @ (^ [Xx3:$i] : XB2)))) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XI @ XV)) => ((cwi @ Xph @ (cwss @ XJ @ XI)) => ((cwi @ Xph @ (cwcel @ XL @ XJ)) => ((cwi @ Xph @ (cwcel @ XX @ XK)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (cco @ XX @ (ccfv @ XL @ XU) @ Xc_x) @ (XC @ Xx3))))))))))))))))))))))))))))))).
