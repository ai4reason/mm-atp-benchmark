...
thf(auni0b_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ (ccuni @ XA2) @ cc0) @ (cwss @ XA2 @ (ccsn @ cc0))))).
...
thf(adisjssun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwb @ (cwss @ XA2 @ (ccun @ XB2 @ XC)) @ (cwss @ XA2 @ XC))))))).
...
thf(afinsschain_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwne @ XA2 @ cc0) @ (cwor @ XA2 @ ccrpss)) @ (cwa @ (cwcel @ XB2 @ ccfn) @ (cwss @ XB2 @ (ccuni @ XA2)))) @ (cwrex @ (^ [Xz:$i] : (cwss @ XB2 @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2)))))).
...
thf(azorn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwal @ (^ [Xz:$i] : (cwi @ (cwa @ (cwss @ (ccv @ Xz) @ XA2) @ (cwor @ (ccv @ Xz) @ ccrpss)) @ (cwcel @ (ccuni @ (ccv @ Xz)) @ XA2)))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
