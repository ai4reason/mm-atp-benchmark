...
thf(aflsqrt5_thm,axiom,(! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ ccr) @ (cwbr @ ccc0 @ XX @ ccle)) @ (cwb @ (cwa @ (cwbr @ (ccdc @ cc2 @ cc5) @ XX @ ccle) @ (cwbr @ XX @ (ccdc @ cc3 @ cc6) @ cclt)) @ (cwceq @ (ccfv @ (ccfv @ XX @ ccsqrt) @ ccfl) @ cc5))))).
