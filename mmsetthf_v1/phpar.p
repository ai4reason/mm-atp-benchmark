...
thf(aphop_thm,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => (cwi @ (cwcel @ XU @ cccphlo) @ (cwceq @ XU @ (ccop @ (ccop @ XG @ XS) @ XN))))))))))).
