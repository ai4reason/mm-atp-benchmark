...
thf(ccfilucfil2_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwne @ XX @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) @ (cwb @ (cwcel @ XC @ (ccfv @ (ccfv @ XD @ ccmetu) @ cccfilu)) @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccfbas)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccima @ XD @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccico))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : ccrp))))))))).
