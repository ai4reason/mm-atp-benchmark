...
thf(aacneq_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XC) @ (cwceq @ (cwacn @ XA2) @ (cwacn @ XC)))))).
...
thf(aacni2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ (cwacn @ XA2)) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwss @ (XB2 @ Xx3) @ XX) @ (cwne @ (XB2 @ Xx3) @ cc0))) @ (^ [Xx3:$i] : XA2))) @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwf @ XA2 @ XX @ (ccv @ Xg1)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(adfac4_thm,axiom,(cwb @ cwac @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3)))))))))).
thf(cdfacacn_conj,conjecture,(cwb @ cwac @ (cwal @ (^ [Xx3:$i] : (cwceq @ (cwacn @ (ccv @ Xx3)) @ ccvv))))).
