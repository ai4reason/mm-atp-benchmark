...
thf(anbgrssovtxOLD_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XW) @ (cwss @ (cco @ XG @ XN @ ccnbgr) @ (ccdif @ XV @ (ccsn @ XN)))))))))).
...
thf(cnbgrssvwo2OLD_conj,conjecture,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwnel @ XM @ (cco @ XG @ XN @ ccnbgr))) @ (cwss @ (cco @ XG @ XN @ ccnbgr) @ (ccdif @ XV @ (ccpr @ XM @ XN))))))))))).
