...
thf(adrnguc1p_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XF @ XB2) @ (cwne @ XF @ Xc_0)) @ (cwcel @ XF @ XC))))))))))))).
...
thf(auc1pmon1p_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => ((cwceq @ XM @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XC)) @ (cwcel @ (cco @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ XX @ XD) @ (ccfv @ XX @ ccco1)) @ XI) @ XA2) @ XX @ Xc_x) @ XM))))))))))))))))))).
...
thf(adeg1mul3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XE @ (ccfv @ XR @ ccrlreg)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XE) @ (cwcel @ XG @ XB2)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XF @ XA2) @ XG @ Xc_x) @ XD) @ (ccfv @ XG @ XD))))))))))))))))))).
...
thf(adeg1submon1p_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XO @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XF @ XO)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ XD) @ XX)) => ((cwi @ Xph @ (cwcel @ XG @ XO)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ XD) @ XX)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ XX @ cclt))))))))))))))))))))).
...
thf(cig1peu_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ XM @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ XU) @ (cwne @ XI @ (ccsn @ Xc_0))) @ (cwreu @ (^ [Xg1:$i] : (cwceq @ (ccfv @ (ccv @ Xg1) @ XD) @ (ccinf @ (ccima @ XD @ (ccdif @ XI @ (ccsn @ Xc_0))) @ ccr @ cclt))) @ (^ [Xg1:$i] : (ccin @ XI @ XM))))))))))))))))).
