...
thf(cvtoclgftOLD_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwa @ (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3)))) @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3))))) @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3)))) @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3))) @ (Xps @ Xx3)))))))).
