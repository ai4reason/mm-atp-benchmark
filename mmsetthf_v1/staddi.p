...
thf(cstaddi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwcel @ XS @ ccst) @ (cwi @ (cwceq @ (cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XB2 @ XS) @ ccaddc) @ cc2) @ (cwceq @ (ccfv @ XA2 @ XS) @ cc1))))))))).
