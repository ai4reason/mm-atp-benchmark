...
thf(afvun_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwfun @ XF) @ (cwfun @ XG)) @ (cwceq @ (ccin @ (ccdm @ XF) @ (ccdm @ XG)) @ cc0)) @ (cwceq @ (ccfv @ XA2 @ (ccun @ XF @ XG)) @ (ccun @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG)))))))).
...
thf(cfvun1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XB2) @ (cwa @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwcel @ XX @ XA2))) @ (cwceq @ (ccfv @ XX @ (ccun @ XF @ XG)) @ (ccfv @ XX @ XF))))))))).
