...
thf(adf_dilN_ax,axiom,(cwceq @ ccdilN @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xd:$i] : (ccfv @ (ccv @ Xk) @ ccatm)) @ (^ [Xd:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xd) @ (ccfv @ (ccv @ Xk) @ ccwpointsN))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccpsubsp)))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xk) @ ccpautN))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cdilfsetN_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (cwceq @ (XA2 @ Xx3 @ Xf1) @ (ccfv @ XK @ ccatm)))) => ((! [Xf1:$i] : (! [Xd:$i] : (cwceq @ (XS @ Xf1 @ Xd) @ (ccfv @ XK @ ccpsubsp)))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwceq @ (XW @ Xx3 @ Xf1 @ Xd) @ (ccfv @ XK @ ccwpointsN))))) => ((! [Xx3:$i] : (! [Xd:$i] : (cwceq @ (XM @ Xx3 @ Xd) @ (ccfv @ XK @ ccpautN)))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwceq @ (XL @ Xx3 @ Xf1 @ Xd) @ (ccfv @ XK @ ccdilN))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwi @ (cwcel @ XK @ (XB2 @ Xx3 @ Xf1 @ Xd)) @ (cwceq @ (XL @ Xx3 @ Xf1 @ Xd) @ (ccmpt @ (^ [Xd:$i] : (XA2 @ Xx3 @ Xf1)) @ (^ [Xd:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xd) @ (XW @ Xx3 @ Xf1 @ Xd))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XS @ Xf1 @ Xd)))) @ (^ [Xf1:$i] : (XM @ Xx3 @ Xd))))))))))))))))))))))).
