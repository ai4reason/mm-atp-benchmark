...
thf(afmucndlem_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XX) @ (cwss @ XA2 @ XX)) @ (cwceq @ (ccima @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))))) @ (ccxp @ XA2 @ XA2)) @ (ccxp @ (ccima @ XF @ XA2) @ (ccima @ XF @ XA2)))))))).
...
thf(aucnprima_thm,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XX @ ccust))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XV @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccust)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ XU @ (XV @ Xy1) @ ccucn)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XW @ (XV @ Xy1)))) => ((cwceq @ XG @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))))) => (cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ XG) @ XW) @ XU)))))))))))))))).
...
thf(cfmucnd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ (XU @ Xa) @ (ccfv @ XX @ ccust)))) => ((cwi @ Xph @ (cwcel @ XV @ (ccfv @ XY @ ccust))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ (XU @ Xa) @ XV @ ccucn)))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XC @ (ccfv @ (XU @ Xa) @ cccfilu)))) => ((cwceq @ XD @ (ccrn @ (ccmpt @ (^ [Xa:$i] : XC) @ (^ [Xa:$i] : (ccima @ XF @ (ccv @ Xa)))))) => (cwi @ Xph @ (cwcel @ XD @ (ccfv @ XV @ cccfilu))))))))))))))))).
