...
thf(celfzp1b_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (cwcel @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ cc1 @ XN @ ccfz))))))).
