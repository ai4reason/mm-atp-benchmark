...
thf(cclsocv_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XO @ (ccfv @ XW @ ccocv)) => ((cwceq @ XJ @ (ccfv @ XW @ cctopn)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cwss @ XS @ XV)) @ (cwceq @ (ccfv @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ XO) @ (ccfv @ XS @ XO)))))))))))).
