...
thf(agchacg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwcel @ XA2 @ ccgch) @ (cwcel @ (ccpw @ XA2) @ ccgch)) @ (cwcel @ (ccpw @ XA2) @ (ccdm @ cccrd))))).
...
thf(cgchac_conj,conjecture,(cwi @ (cwceq @ ccgch @ ccvv) @ cwac)).
