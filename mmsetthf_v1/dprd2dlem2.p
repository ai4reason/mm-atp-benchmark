...
thf(cdprd2dlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwrel @ XA2)) => ((cwi @ Xph @ (cwf @ XA2 @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xj:$i] : (cwi @ Xph @ (cwss @ (ccdm @ XA2) @ (XI @ Xj)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ (XI @ Xj))) @ (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ (ccdm @ ccdprd))))) => ((! [Xj:$i] : (cwi @ Xph @ (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ (ccdm @ ccdprd)))) => ((! [Xj:$i] : (cwceq @ (XK @ Xj) @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc))) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ XA2)) @ (cwss @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccfv @ XX @ cc1st)))) @ (^ [Xj:$i] : (cco @ (ccfv @ XX @ cc1st) @ (ccv @ Xj) @ XS))) @ ccdprd))))))))))))))))).
