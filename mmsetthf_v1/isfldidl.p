...
thf(afldcrng_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccfld) @ (cwcel @ XK @ cccring)))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aflddivrng_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccfld) @ (cwcel @ XK @ ccdrng)))).
...
thf(aisdrngo3_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccfv @ XR @ cc1st)))) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XZ @ (ccfv @ (XG @ Xx3 @ Xy1) @ ccgi)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xx3 @ Xy1))))) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwb @ (cwcel @ XR @ ccdrng) @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwa @ (cwne @ XU @ XZ) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XH) @ XU)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccsn @ XZ))))))))))))))))))).
thf(asimp1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xph))))).
thf(aisfld2_thm,axiom,(! [XK:($i > $o)] : (cwb @ (cwcel @ XK @ ccfld) @ (cwa @ (cwcel @ XK @ ccdrng) @ (cwcel @ XK @ cccring))))).
thf(cisfldidl_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XK @ cc1st)) => ((cwceq @ XH @ (ccfv @ XK @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwb @ (cwcel @ XK @ ccfld) @ (cw3a @ (cwcel @ XK @ cccring) @ (cwne @ XU @ XZ) @ (cwceq @ (ccfv @ XK @ ccidl) @ (ccpr @ (ccsn @ XZ) @ XX)))))))))))))))).
