...
thf(aelfilss_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ XA2 @ XF) @ (cwrex @ (^ [Xt:$i] : (cwss @ (ccv @ Xt) @ XA2)) @ (^ [Xt:$i] : XF)))))))).
thf(ctrfil3_conj,conjecture,(! [XA2:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwss @ XA2 @ XY)) @ (cwb @ (cwcel @ (cco @ XL @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfil)) @ (cwn @ (cwcel @ (ccdif @ XY @ XA2) @ XL)))))))).
