...
thf(cpjpjpre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwcel @ XH @ ccch)) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XH @ (ccfv @ XH @ ccort) @ ccph))) => (cwi @ Xph @ (cwceq @ XA2 @ (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) @ ccva))))))))).
