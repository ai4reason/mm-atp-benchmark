...
thf(c_1stpreimas_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwrel @ XA2) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccima @ (cccnv @ (ccres @ cc1st @ XA2)) @ (ccsn @ XX)) @ (ccxp @ (ccsn @ XX) @ (ccima @ XA2 @ (ccsn @ XX))))))))).
