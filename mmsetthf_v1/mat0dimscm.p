...
thf(cmat0dimscm_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (cco @ cc0 @ XR @ ccmat)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ (ccfv @ XR @ ccbs))) @ (cwceq @ (cco @ XX @ cc0 @ (ccfv @ XA2 @ ccvsca)) @ cc0))))))).
