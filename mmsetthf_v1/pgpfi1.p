...
thf(cpgpfi1_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccn0)) @ (cwi @ (cwceq @ (ccfv @ XX @ cchash) @ (cco @ XP @ XN @ ccexp)) @ (cwbr @ XP @ XG @ ccpgp))))))))).
