...
thf(adf_lnm_ax,axiom,(cwceq @ cclnm @ (ccrab @ (^ [Xw:$i] : (cwral @ (^ [Xi:$i] : (cwcel @ (cco @ (ccv @ Xw) @ (ccv @ Xi) @ ccress) @ cclfig)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xw) @ cclss)))) @ (^ [Xw:$i] : cclmod)))).
thf(cislnm_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XS @ (ccfv @ XM @ cclss)) => (cwb @ (cwcel @ XM @ cclnm) @ (cwa @ (cwcel @ XM @ cclmod) @ (cwral @ (^ [Xi:$i] : (cwcel @ (cco @ XM @ (ccv @ Xi) @ ccress) @ cclfig)) @ (^ [Xi:$i] : XS)))))))).
