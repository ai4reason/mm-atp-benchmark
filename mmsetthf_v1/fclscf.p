...
thf(afclstopon_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwb @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))))))))).
thf(asimprl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xps))))).
thf(afclsss1_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XJ @ XK)) @ (cwss @ (cco @ XK @ XF @ ccfcls) @ (cco @ XJ @ XF @ ccfcls)))))))).
...
thf(asupnfcls_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XU @ XJ) @ (cwcel @ (XA2 @ Xx3) @ XU)) @ (cwn @ (cwcel @ (XA2 @ Xx3) @ (cco @ XJ @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccdif @ XX @ XU) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XX))) @ ccfcls)))))))))).
...
thf(afclsopn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwral @ (^ [Xo:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xo)) @ (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xo) @ (ccv @ Xs1)) @ cc0)) @ (^ [Xs1:$i] : XF)))) @ (^ [Xo:$i] : XJ)))))))))).
...
thf(cfclscf_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XX @ cctopon))) @ (cwb @ (cwss @ XJ @ XK) @ (cwral @ (^ [Xf1:$i] : (cwss @ (cco @ XK @ (ccv @ Xf1) @ ccfcls) @ (cco @ XJ @ (ccv @ Xf1) @ ccfcls))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))).
