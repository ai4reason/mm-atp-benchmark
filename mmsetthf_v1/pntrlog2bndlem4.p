...
thf(apntrval_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwceq @ (ccfv @ XA2 @ (XR @ Xa)) @ (cco @ (ccfv @ XA2 @ ccchp) @ XA2 @ ccmin)))))))).
...
thf(aflltp1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ XA2 @ (cco @ (ccfv @ XA2 @ ccfl) @ cc1 @ ccaddc) @ cclt)))).
...
thf(altdivmuld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt) @ (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmul) @ cclt))))))))))).
thf(a_1lt2_thm,axiom,(cwbr @ cc1 @ cc2 @ cclt)).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(achpeq0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccchp) @ ccc0) @ (cwbr @ XA2 @ cc2 @ cclt))))).
...
thf(apntsval2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ (XS @ Xi @ Xa)) @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul) @ (ccsu @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccdiv) @ ccvma) @ ccmul))) @ ccaddc))))))))))).
...
thf(aflidm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccfl) @ ccfl) @ (ccfv @ XA2 @ ccfl))))).
...
thf(apntsf_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwf @ ccr @ ccr @ (XS @ Xi @ Xa))))))).
...
thf(asumeq12rdv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XB2)) @ (cwceq @ (XC @ Xk) @ (XD @ Xk)))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (XD @ Xk))))))))))))).
...
thf(afsumparts_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccv @ Xj)) @ (cwa @ (cwceq @ (XA2 @ Xk) @ (XB2 @ Xj)) @ (cwceq @ (XV @ Xk) @ (XW @ Xj)))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc)) @ (cwa @ (cwceq @ (XA2 @ Xk) @ (XC @ Xj)) @ (cwceq @ (XV @ Xk) @ (XX @ Xj)))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XM) @ (cwa @ (cwceq @ (XA2 @ Xk) @ (XD @ Xj)) @ (cwceq @ (XV @ Xk) @ (XY @ Xj)))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XN) @ (cwa @ (cwceq @ (XA2 @ Xk) @ (XE @ Xj)) @ (cwceq @ (XV @ Xk) @ (XZ @ Xj)))))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (XV @ Xk) @ ccc))) => (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xj:$i] : (cco @ (XB2 @ Xj) @ (cco @ (XX @ Xj) @ (XW @ Xj) @ ccmin) @ ccmul))) @ (cco @ (cco @ (cco @ (XE @ Xj) @ (XZ @ Xj) @ ccmul) @ (cco @ (XD @ Xj) @ (XY @ Xj) @ ccmul) @ ccmin) @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xj:$i] : (cco @ (cco @ (XC @ Xj) @ (XB2 @ Xj) @ ccmin) @ (XX @ Xj) @ ccmul))) @ ccmin))))))))))))))))))))))))).
...
thf(asub4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccmin) @ (cco @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XD @ ccmin) @ ccmin))))))))))))).
...
thf(apntrlog2bndlem1_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XR @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => (! [Xi:$i] : (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xn) @ (XS @ Xi @ Xa)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XS @ Xi @ Xa)) @ ccmin) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cclo1)))))))).
...
thf(alo1mul_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3) @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1)) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ cclo1)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccmul))) @ cclo1))))))))))))).
...
thf(ao1sub2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3) @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1)) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ cco1)) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccmin))) @ cco1)))))))))))).
...
thf(aselbergs_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XS @ Xi @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmin))) @ cco1)))))).
...
thf(aselbergsb_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XS @ Xi @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ (ccv @ Xc) @ ccle)) @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccico)))) @ (^ [Xc:$i] : ccrp))))))).
...
thf(apntrlog2bndlem3_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XR @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwcel @ XA2 @ ccrp))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ (XS @ Xi @ Xa)) @ (ccv @ Xy1) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xy1) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ XA2 @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico))))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xi @ Xa) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xn) @ (XS @ Xi @ Xa)) @ (cco @ cc2 @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul) @ ccmul) @ ccmin) @ ccmul))) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccdiv))) @ cco1)))))))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(cpntrlog2bndlem4_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XS @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XR @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XT @ Xx3 @ Xi @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccif @ (cwcel @ (ccv @ Xa) @ ccrp) @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xa) @ cclog) @ ccmul) @ ccc0))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xn) @ (XT @ Xx3 @ Xi @ Xa)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XT @ Xx3 @ Xi @ Xa)) @ ccmin) @ ccmul))) @ ccmul) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cclo1)))))))))).
