...
thf(adf_lcm_ax,axiom,(cwceq @ cclcm @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwo @ (cwceq @ (ccv @ Xx3) @ ccc0) @ (cwceq @ (ccv @ Xy1) @ ccc0)) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdvds) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt))))))).
...
thf(clcmval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XM @ XN @ cclcm) @ (ccif @ (cwo @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwbr @ XM @ (ccv @ Xn) @ ccdvds) @ (cwbr @ XN @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt))))))).
