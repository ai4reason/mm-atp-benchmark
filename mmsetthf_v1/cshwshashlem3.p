...
thf(acshwshashlem2_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => (cwi @ (cwa @ Xph @ (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (cwi @ (cw3a @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (cwbr @ XK @ XL @ cclt)) @ (cwne @ (cco @ XW @ XL @ cccsh) @ (cco @ XW @ XK @ cccsh))))))))))).
...
thf(ccshwshashlem3_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => (cwi @ (cwa @ Xph @ (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (cwi @ (cw3a @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (cwne @ XK @ XL)) @ (cwne @ (cco @ XW @ XL @ cccsh) @ (cco @ XW @ XK @ cccsh))))))))))).
