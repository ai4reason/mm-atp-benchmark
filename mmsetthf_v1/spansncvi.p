...
thf(aspansnji_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => (cwceq @ (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ ccph) @ (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ cchj))))))).
...
thf(cspansncvi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ cchil) => (cwi @ (cwa @ (cwpss @ XA2 @ XB2) @ (cwss @ XB2 @ (cco @ XA2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ cchj))) @ (cwceq @ XB2 @ (cco @ XA2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ cchj)))))))))).
