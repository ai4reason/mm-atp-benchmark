...
thf(cmplvsca2_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XP @ (cco @ XI @ XR @ ccmpl)) => ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => (cwceq @ Xc_x @ (ccfv @ XS @ ccvsca))))))))))).
