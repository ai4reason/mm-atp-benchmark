...
thf(aestrccatid_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccestrc)) => (cwi @ (cwcel @ XU @ XV) @ (cwa @ (cwcel @ XC @ cccat) @ (cwceq @ (ccfv @ XC @ cccid) @ (ccmpt @ (^ [Xx3:$i] : XU) @ (^ [Xx3:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xx3) @ ccbs)))))))))))).
...
thf(cestrcid_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccestrc)) => ((cwceq @ Xc_1 @ (ccfv @ XC @ cccid)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XU)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ Xc_1) @ (ccres @ ccid @ (ccfv @ XX @ ccbs))))))))))))))).
