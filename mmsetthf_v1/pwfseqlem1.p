...
thf(cpwfseqlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xw) @ (cwf1 @ (ccpw @ (XA2 @ Xw)) @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ (XA2 @ Xw) @ (ccv @ Xn) @ ccmap))) @ (XG @ Xx3 @ Xn @ Xr))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xw) @ (cwss @ (XX @ Xx3 @ Xw @ Xn @ Xr) @ (XA2 @ Xw))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xw) @ (cwf1o @ ccom @ (XX @ Xx3 @ Xw @ Xn @ Xr) @ (XH @ Xw @ Xn))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xr:$i] : (cwb @ (Xps @ Xx3 @ Xw @ Xr) @ (cwa @ (cw3a @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xw)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr))) @ (cwbr @ ccom @ (ccv @ Xx3) @ ccdom)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xw) @ (Xps @ Xx3 @ Xw @ Xr)) @ (cwf1 @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccmap))) @ (ccv @ Xx3) @ (XK @ Xx3 @ Xn @ Xr))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwceq @ (XD @ Xx3 @ Xw @ Xr) @ (ccfv @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xw) @ (cccnv @ (XK @ Xx3 @ Xn @ Xr))) @ (ccrn @ (XG @ Xx3 @ Xn @ Xr))) @ (cwn @ (cwcel @ (ccv @ Xw) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (cccnv @ (XK @ Xx3 @ Xn @ Xr))) @ (cccnv @ (XG @ Xx3 @ Xn @ Xr))))))) @ (^ [Xw:$i] : (ccv @ Xx3))) @ (XG @ Xx3 @ Xn @ Xr))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xw) @ (Xps @ Xx3 @ Xw @ Xr)) @ (cwcel @ (XD @ Xx3 @ Xw @ Xr) @ (ccdif @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ (XA2 @ Xw) @ (ccv @ Xn) @ ccmap))) @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccmap)))))))))))))))))))))))).
