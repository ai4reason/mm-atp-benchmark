...
thf(cfrlmlss_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ XU @ (ccfv @ (cco @ (ccfv @ XR @ ccrglmod) @ XI @ ccpws) @ cclss)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XW)) @ (cwcel @ XB2 @ XU)))))))))))).
