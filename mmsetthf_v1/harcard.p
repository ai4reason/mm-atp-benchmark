...
thf(aiscard2_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2) @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccen) @ (cwss @ XA2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))).
thf(charcard_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ XA2 @ cchar) @ cccrd) @ (ccfv @ XA2 @ cchar)))).
