...
thf(afofinf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfo @ XA2 @ XB2 @ XF) @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwcel @ XB2 @ ccfn)) @ (cwf1o @ XA2 @ XB2 @ XF)))))).
thf(crneqdmfinf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwfn @ XF @ XA2) @ (cwceq @ (ccrn @ XF) @ XA2)) @ (cwf1o @ XA2 @ XA2 @ XF))))).
