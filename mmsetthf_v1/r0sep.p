...
thf(aisr0_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ (ccfv @ XJ @ cckq) @ cct1) @ (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwral @ (^ [Xo:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xo)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ)) @ (cwral @ (^ [Xo:$i] : (cwb @ (cwcel @ (ccv @ Xz) @ (ccv @ Xo)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ)))) @ (^ [Xw:$i] : XX))) @ (^ [Xz:$i] : XX))))))))).
...
thf(cr0sep_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ (ccfv @ XJ @ cckq) @ cct1)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) @ (cwi @ (cwral @ (^ [Xo:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xo)) @ (cwcel @ XB2 @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ)) @ (cwral @ (^ [Xo:$i] : (cwb @ (cwcel @ XA2 @ (ccv @ Xo)) @ (cwcel @ XB2 @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ))))))))).
