...
thf(azltaddlt1le_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioo))) @ (cwb @ (cwbr @ (cco @ XM @ XA2 @ ccaddc) @ XN @ cclt) @ (cwbr @ (cco @ XM @ XA2 @ ccaddc) @ XN @ ccle))))))).
...
thf(amuldivdir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwa @ (cwcel @ XC @ ccc) @ (cwne @ XC @ ccc0))) @ (cwceq @ (cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ XB2 @ ccaddc) @ XC @ ccdiv) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccdiv) @ ccaddc))))))).
...
thf(chalfleoddlt_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ XM @ ccz)) @ (cwb @ (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ ccle) @ (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ cclt)))))).
