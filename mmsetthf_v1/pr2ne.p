...
thf(aenpr1g_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ (ccpr @ XA2 @ XA2) @ cc1o @ ccen))))).
...
thf(cpr2ne_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD)) @ (cwb @ (cwbr @ (ccpr @ XA2 @ XB2) @ cc2o @ ccen) @ (cwne @ XA2 @ XB2)))))))).
