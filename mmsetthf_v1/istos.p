...
thf(adf_toset_ax,axiom,(cwceq @ cctos @ (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xr)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xf1) @ ccple))) @ (ccfv @ (ccv @ Xf1) @ ccbs))) @ (^ [Xf1:$i] : ccpo)))).
thf(cistos_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XK @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ Xc_le @ (ccfv @ (XK @ Xx3 @ Xy1) @ ccple)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwcel @ (XK @ Xx3 @ Xy1) @ cctos) @ (cwa @ (cwcel @ (XK @ Xx3 @ Xy1) @ ccpo) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_le))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))).
