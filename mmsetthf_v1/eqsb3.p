...
thf(aeqsb3lem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (cwb @ (cwsb @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3))) @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xx3)))))).
...
thf(ceqsb3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (cwb @ (cwsb @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3))) @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xx3)))))).
