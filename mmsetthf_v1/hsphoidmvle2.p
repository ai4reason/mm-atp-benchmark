...
thf(chsphoidmvle2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb @ Xc) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol)))))))))))))))) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwcel @ (XZ @ Xa @ Xb) @ (ccdif @ XX @ (XY @ Xk @ Xa @ Xb))))))) => ((! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ XX @ (ccun @ (XY @ Xk @ Xa @ Xb) @ (ccsn @ (XZ @ Xa @ Xb))))))) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwbr @ XC @ XD @ ccle)) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XH @ Xx3 @ Xj @ Xc) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xc:$i] : (cco @ ccr @ XX @ ccmap)) @ (^ [Xc:$i] : (ccmpt @ (^ [Xj:$i] : XX) @ (^ [Xj:$i] : (ccif @ (cwcel @ (ccv @ Xj) @ (XY @ Xk @ Xa @ Xb)) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xc)) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ (ccv @ Xc)) @ (ccv @ Xx3) @ ccle) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xc)) @ (ccv @ Xx3)))))))))))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xc:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XA2 @ Xx3 @ Xj @ Xc)))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XB2 @ Xx3)))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ Xph @ (cwbr @ (cco @ (XA2 @ Xx3 @ Xj @ Xc) @ (ccfv @ (XB2 @ Xx3) @ (ccfv @ XC @ (XH @ Xx3 @ Xj @ Xc))) @ (ccfv @ XX @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb @ Xc))) @ (cco @ (XA2 @ Xx3 @ Xj @ Xc) @ (ccfv @ (XB2 @ Xx3) @ (ccfv @ XD @ (XH @ Xx3 @ Xj @ Xc))) @ (ccfv @ XX @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb @ Xc))) @ ccle))))))))))))))))))))))))))))).
