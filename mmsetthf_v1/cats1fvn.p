...
thf(ccats1fvn_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XT @ (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwcel @ XS @ (ccword @ ccvv)) => ((cwceq @ (ccfv @ XS @ cchash) @ XM) => (cwi @ (cwcel @ XX @ XV) @ (cwceq @ (ccfv @ XM @ XT) @ XX))))))))))).
