...
thf(adisjif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XY) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ XY @ XA2)) @ (cwa @ (cwcel @ (XZ @ Xx3) @ (XB2 @ Xx3)) @ (cwcel @ (XZ @ Xx3) @ (XC @ Xx3)))) @ (cwceq @ (ccv @ Xx3) @ XY))))))))))).
...
thf(cdisjabrex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwdisj @ (^ [Xy1:$i] : (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))))) @ (^ [Xy1:$i] : (ccv @ Xy1))))))).
