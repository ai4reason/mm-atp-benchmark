...
thf(cimacosupp_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XG @ XW)) @ (cwi @ (cwa @ (cwfun @ XG) @ (cwss @ (cco @ XF @ XZ @ ccsupp) @ (ccrn @ XG))) @ (cwceq @ (ccima @ XG @ (cco @ (cccom @ XF @ XG) @ XZ @ ccsupp)) @ (cco @ XF @ XZ @ ccsupp)))))))))).
