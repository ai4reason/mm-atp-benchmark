...
thf(adipdir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cwa @ (cwcel @ XU @ cccphlo) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XG) @ XC @ XP) @ (cco @ (cco @ XA2 @ XC @ XP) @ (cco @ XB2 @ XC @ XP) @ ccaddc)))))))))))))).
thf(aoveq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF)))))))))).
thf(asimplr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xps))))).
thf(asimprl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xps))))).
thf(ccn0v_tp,type,(ccn0v : ($i > $o))).
thf(aipassi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XS) @ XC @ XP) @ (cco @ XA2 @ (cco @ XB2 @ XC @ XP) @ ccmul))))))))))))))))).
...
thf(acnnvg_thm,axiom,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwceq @ ccaddc @ (ccfv @ XU @ ccpv))))).
thf(cc2nd_tp,type,(cc2nd : ($i > $o))).
thf(acnnvs_thm,axiom,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwceq @ ccmul @ (ccfv @ XU @ ccns))))).
...
thf(ablo3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XM @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XN @ (ccfv @ XW @ ccnmcv)) => ((! [Xy1:$i] : (cwceq @ (XL @ Xy1) @ (cco @ XU @ XW @ cclno))) => ((cwceq @ XB2 @ (cco @ XU @ XW @ ccblo)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XT @ (XL @ Xy1)) @ (cwcel @ XA2 @ ccr) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ XN) @ (cco @ XA2 @ (ccfv @ (ccv @ Xy1) @ XM) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : XX))) @ (cwcel @ XT @ XB2)))))))))))))))))))).
thf(acnnvnm_thm,axiom,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwceq @ ccabs @ (ccfv @ XU @ ccnmcv))))).
thf(cipblnfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (cco @ XU @ (XC @ Xx3) @ ccblo))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ XP))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ XX) @ (cwcel @ (XF @ Xx3) @ (XB2 @ Xx3)))))))))))))))))).
