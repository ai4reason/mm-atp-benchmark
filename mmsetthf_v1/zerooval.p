...
thf(czerooval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ cczeroo) @ (ccin @ (ccfv @ XC @ ccinito) @ (ccfv @ XC @ cctermo)))))))))))).
