...
thf(amrsub0_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwi @ (cwcel @ XF @ (ccrn @ XS)) @ (cwceq @ (ccfv @ cc0 @ XF) @ cc0))))))).
...
thf(accatrn_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2))) @ (cwceq @ (ccrn @ (cco @ XS @ XT @ ccconcat)) @ (ccun @ (ccrn @ XS) @ (ccrn @ XT)))))))).
...
thf(as1rn_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (ccrn @ (ccs1 @ XA2)) @ (ccsn @ XA2)))))).
...
thf(cmrsubvrs_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccfv @ XT @ ccmrex))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XX @ (XR @ Xx3))) @ (cwceq @ (ccin @ (ccrn @ (ccfv @ XX @ XF)) @ XV) @ (cciun @ (^ [Xx3:$i] : (ccin @ (ccrn @ XX) @ XV)) @ (^ [Xx3:$i] : (ccin @ (ccrn @ (ccfv @ (ccs1 @ (ccv @ Xx3)) @ XF)) @ XV)))))))))))))))).
