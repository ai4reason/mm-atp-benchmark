...
thf(amexval2_thm,axiom,(! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XK @ (ccfv @ XT @ ccmtc)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XC @ (ccfv @ XT @ ccmcn)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => (cwceq @ XE @ (ccxp @ XK @ (ccword @ (ccun @ XC @ XV)))))))))))))).
...
thf(cmvrsfpw_conj,conjecture,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XW @ (ccfv @ XT @ ccmvrs)) => (cwi @ (cwcel @ XX @ XE) @ (cwcel @ (ccfv @ XX @ XW) @ (ccin @ (ccpw @ XV) @ ccfn)))))))))))).
