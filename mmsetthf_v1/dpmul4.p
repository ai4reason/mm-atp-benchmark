...
thf(akaratsuba_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwcel @ XS @ ccn0) => ((cwcel @ XM @ ccn0) => ((cwceq @ (cco @ XA2 @ XC @ ccmul) @ XR) => ((cwceq @ (cco @ XB2 @ XD @ ccmul) @ XT) => ((cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccmul) @ (cco @ (cco @ XR @ XS @ ccaddc) @ XT @ ccaddc)) => ((cwceq @ (cco @ (cco @ XA2 @ (cco @ (ccdc @ cc1 @ ccc0) @ XM @ ccexp) @ ccmul) @ XB2 @ ccaddc) @ XX) => ((cwceq @ (cco @ (cco @ XC @ (cco @ (ccdc @ cc1 @ ccc0) @ XM @ ccexp) @ ccmul) @ XD @ ccaddc) @ XY) => ((cwceq @ (cco @ (cco @ XR @ (cco @ (ccdc @ cc1 @ ccc0) @ XM @ ccexp) @ ccmul) @ XS @ ccaddc) @ XW) => ((cwceq @ (cco @ (cco @ XW @ (cco @ (ccdc @ cc1 @ ccc0) @ XM @ ccexp) @ ccmul) @ XT @ ccaddc) @ XZ) => (cwceq @ (cco @ XX @ XY @ ccmul) @ XZ))))))))))))))))))))))))))).
...
thf(adp3mul10_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccr) => (cwceq @ (cco @ (cco @ XA2 @ (ccdp2 @ XB2 @ XC) @ ccdp) @ (ccdc @ cc1 @ ccc0) @ ccmul) @ (cco @ (ccdc @ XA2 @ XB2) @ XC @ ccdp))))))))).
...
thf(adpmul100_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccr) => (cwceq @ (cco @ (cco @ XA2 @ (ccdp2 @ XB2 @ XC) @ ccdp) @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ ccmul) @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC))))))))).
thf(asq10_thm,axiom,(cwceq @ (cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0))).
...
thf(amvlladdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ XC) => (cwceq @ XB2 @ (cco @ XC @ XA2 @ ccmin))))))))).
...
thf(asubdiri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccmul) @ (cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccmin))))))))).
...
thf(altadd2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ XC @ XA2 @ ccaddc) @ (cco @ XC @ XB2 @ ccaddc) @ cclt))))))))).
...
thf(adiv23i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwne @ XC @ ccc0) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XC @ ccdiv) @ (cco @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccmul)))))))))).
thf(agt0ne0ii_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ cclt) => (cwne @ XA2 @ ccc0))))).
thf(adpmul1000_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccr) => (cwceq @ (cco @ (cco @ XA2 @ (ccdp2 @ XB2 @ (ccdp2 @ XC @ XD)) @ ccdp) @ (ccdc @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ ccc0) @ ccmul) @ (ccdc @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ XD))))))))))).
