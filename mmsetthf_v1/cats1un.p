...
thf(ccats1un_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccword @ XX)) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ XA2 @ (ccs1 @ XB2) @ ccconcat) @ (ccun @ XA2 @ (ccsn @ (ccop @ (ccfv @ XA2 @ cchash) @ XB2))))))))).
