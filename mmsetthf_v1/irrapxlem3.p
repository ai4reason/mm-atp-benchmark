...
thf(airrapxlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccn)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) @ (cwbr @ (ccfv @ (cco @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmo) @ (cco @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ cc1 @ ccmo) @ ccmin) @ ccabs) @ (cco @ cc1 @ XB2 @ ccdiv) @ cclt))) @ (^ [Xy1:$i] : (cco @ ccc0 @ XB2 @ ccfz)))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XB2 @ ccfz))))))).
...
thf(cirrapxlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccn)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ (cco @ cc1 @ XB2 @ ccdiv) @ cclt)) @ (^ [Xy1:$i] : ccn0))) @ (^ [Xx3:$i] : (cco @ cc1 @ XB2 @ ccfz))))))).
