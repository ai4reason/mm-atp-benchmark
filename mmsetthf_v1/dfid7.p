...
thf(aintmin2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwceq @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccv @ Xx3))))) @ XA2)))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(cdfid7_conj,conjecture,(cwceq @ ccid @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccab @ (^ [Xy1:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cwtru)))))))).
