...
thf(cfuniedgdmge2valOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ XV) @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) @ (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccfv @ XG @ ccedgf)))))).
