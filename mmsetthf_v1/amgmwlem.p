...
thf(alogcxpd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ cclog) @ (cco @ XB2 @ (ccfv @ XA2 @ cclog) @ ccmul))))))))).
...
thf(areloggim_thm,axiom,(! [XP:($i > $o)] : ((cwceq @ XP @ (cco @ (ccfv @ cccnfld @ ccmgp) @ ccrp @ ccress)) => (cwcel @ (ccres @ cclog @ ccrp) @ (cco @ XP @ ccrefld @ ccgim))))).
...
thf(ajensen_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((cwi @ Xph @ (cwf @ XD @ ccr @ XF)) => ((! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xa) @ XD) @ (cwcel @ (ccv @ Xb) @ XD))) @ (cwss @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccicc) @ XD)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico) @ XT)) => ((cwi @ Xph @ (cwf @ XA2 @ XD @ XX)) => ((cwi @ Xph @ (cwbr @ ccc0 @ (cco @ cccnfld @ XT @ ccgsu) @ cclt)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XD) @ (cwcel @ (ccv @ Xy1) @ XD) @ (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xt) @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccv @ Xy1) @ ccmul) @ ccaddc) @ XF) @ (cco @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccmul) @ ccaddc) @ ccle))))) => (cwi @ Xph @ (cwa @ (cwcel @ (cco @ (cco @ cccnfld @ (cco @ XT @ XX @ (ccof @ ccmul)) @ ccgsu) @ (cco @ cccnfld @ XT @ ccgsu) @ ccdiv) @ XD) @ (cwbr @ (ccfv @ (cco @ (cco @ cccnfld @ (cco @ XT @ XX @ (ccof @ ccmul)) @ ccgsu) @ (cco @ cccnfld @ XT @ ccgsu) @ ccdiv) @ XF) @ (cco @ (cco @ cccnfld @ (cco @ XT @ (cccom @ XF @ XX) @ (ccof @ ccmul)) @ ccgsu) @ (cco @ cccnfld @ XT @ ccgsu) @ ccdiv) @ ccle)))))))))))))))))).
...
thf(aiccssioo2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) @ (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccioo))) @ (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(ascvxcvx_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwf @ XD @ ccr @ (XF @ Xa @ Xb))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xa) @ XD) @ (cwcel @ (ccv @ Xb) @ XD))) @ (cwss @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccicc) @ XD)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cw3a @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XD) @ (cwcel @ (ccv @ Xy1) @ XD) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ cc1 @ ccioo))) @ (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xt) @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccv @ Xy1) @ ccmul) @ ccaddc) @ (XF @ Xa @ Xb)) @ (cco @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xa @ Xb)) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xy1) @ (XF @ Xa @ Xb)) @ ccmul) @ ccaddc) @ cclt))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwcel @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwbr @ (ccfv @ (cco @ (cco @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ XX @ ccmul) @ (cco @ (cco @ cc1 @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ ccmin) @ XY @ ccmul) @ ccaddc) @ (XF @ Xa @ Xb)) @ (cco @ (cco @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ (ccfv @ XX @ (XF @ Xa @ Xb)) @ ccmul) @ (cco @ (cco @ cc1 @ (XT @ Xx3 @ Xy1 @ Xa @ Xb) @ ccmin) @ (ccfv @ XY @ (XF @ Xa @ Xb)) @ ccmul) @ ccaddc) @ ccle))))))))))))))))).
...
thf(alogccv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) @ (cwbr @ (cco @ (cco @ XT @ (ccfv @ XA2 @ cclog) @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ XB2 @ cclog) @ ccmul) @ ccaddc) @ (ccfv @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc) @ cclog) @ cclt)))))).
...
thf(camgmwlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XM @ (ccfv @ cccnfld @ ccmgp)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => ((cwi @ Xph @ (cwf @ XA2 @ ccrp @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ ccrp @ XW)) => ((cwi @ Xph @ (cwceq @ (cco @ cccnfld @ XW @ ccgsu) @ cc1)) => (cwi @ Xph @ (cwbr @ (cco @ XM @ (cco @ XF @ XW @ (ccof @ cccxp)) @ ccgsu) @ (cco @ cccnfld @ (cco @ XF @ XW @ (ccof @ ccmul)) @ ccgsu) @ ccle)))))))))))))).
