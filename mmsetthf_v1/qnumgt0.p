...
thf(aqmuldeneqnum_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwceq @ (cco @ XA2 @ (ccfv @ XA2 @ ccdenom) @ ccmul) @ (ccfv @ XA2 @ ccnumer))))).
thf(cqnumgt0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwb @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccnumer) @ cclt))))).
