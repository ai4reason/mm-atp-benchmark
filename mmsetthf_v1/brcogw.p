...
thf(cbrcogw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XX @ XZ)) @ (cwa @ (cwbr @ XA2 @ XX @ XD) @ (cwbr @ XX @ XB2 @ XC))) @ (cwbr @ XA2 @ XB2 @ (cccom @ XC @ XD)))))))))))).
