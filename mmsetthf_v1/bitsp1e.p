...
thf(cbitsp1e_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0)) @ (cwb @ (cwcel @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccbits)) @ (cwcel @ XM @ (ccfv @ XN @ ccbits))))))).
