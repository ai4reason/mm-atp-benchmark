...
thf(acoeid3_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XX @ ccc)) @ (cwceq @ (ccfv @ XX @ XF) @ (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ XX @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))))))).
