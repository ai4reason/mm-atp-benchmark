...
thf(ciscld4_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XS @ (ccfv @ XJ @ cccld)) @ (cwss @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ XS)))))))).
