...
thf(a_2swrdeqwrdeq_thm,axiom,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XS @ (ccword @ XV)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwb @ (cwceq @ XW @ XS) @ (cwa @ (cwceq @ (ccfv @ XW @ cchash) @ (ccfv @ XS @ cchash)) @ (cwa @ (cwceq @ (cco @ XW @ (ccop @ ccc0 @ XI) @ ccsubstr) @ (cco @ XS @ (ccop @ ccc0 @ XI) @ ccsubstr)) @ (cwceq @ (cco @ XW @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (cco @ XS @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr))))))))))).
...
thf(aswrdlsw_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)) @ (cwceq @ (cco @ XW @ (ccop @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (ccs1 @ (ccfv @ XW @ cclsw))))))).
...
thf(ahashgt0n0_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ cchash) @ cclt)) @ (cwne @ XA2 @ cc0))))).
thf(alswcl_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)) @ (cwcel @ (ccfv @ XW @ cclsw) @ XV))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(as111_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XA2) @ (cwcel @ XT @ XA2)) @ (cwb @ (cwceq @ (ccs1 @ XS) @ (ccs1 @ XT)) @ (cwceq @ XS @ XT))))))).
thf(c_2swrd1eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwbr @ ccc0 @ (ccfv @ XW @ cchash) @ cclt)) @ (cwb @ (cwceq @ XW @ XU) @ (cwa @ (cwceq @ (ccfv @ XW @ cchash) @ (ccfv @ XU @ cchash)) @ (cwa @ (cwceq @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ (cco @ XU @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr)) @ (cwceq @ (ccfv @ XW @ cclsw) @ (ccfv @ XU @ cclsw)))))))))).
