...
thf(c_2strstr1_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ XN @ Xc_pl))) => ((cwbr @ (ccfv @ ccnx @ ccbs) @ XN @ cclt) => ((cwcel @ XN @ ccn) => (cwbr @ XG @ (ccop @ (ccfv @ ccnx @ ccbs) @ XN) @ ccstr))))))))).
