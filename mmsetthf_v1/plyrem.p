...
thf(aquotdgr_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XR @ (cco @ XF @ (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)) @ (ccof @ ccmin))) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwne @ XG @ cc0p)) @ (cwo @ (cwceq @ XR @ cc0p) @ (cwbr @ (ccfv @ XR @ ccdgr) @ (ccfv @ XG @ ccdgr) @ cclt))))))))).
...
thf(apm2_62_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwo @ Xph @ Xps) @ (cwi @ (cwi @ Xph @ Xps) @ Xps))))).
...
thf(aanabss3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xps) @ Xch) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
...
thf(cplyrem_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => ((cwceq @ XR @ (cco @ XF @ (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)) @ (ccof @ ccmin))) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XA2 @ ccc)) @ (cwceq @ XR @ (ccxp @ ccc @ (ccsn @ (ccfv @ XA2 @ XF))))))))))))).
