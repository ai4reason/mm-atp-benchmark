...
thf(adf_psmet_ax,axiom,(cwceq @ ccpsmet @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xd:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xy1) @ (ccv @ Xd)) @ ccc0) @ (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xd)) @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xy1) @ (ccv @ Xd)) @ (cco @ (ccv @ Xw) @ (ccv @ Xz) @ (ccv @ Xd)) @ ccxad) @ ccle)) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xd:$i] : (cco @ ccxr @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)) @ ccmap))))))).
...
thf(cispsmet_conj,conjecture,(! [XD:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XX @ (XV @ Xx3 @ Xy1 @ Xz)) @ (cwb @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwa @ (cwf @ (ccxp @ XX @ XX) @ ccxr @ XD) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XD) @ ccc0) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XD) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XD) @ ccxad) @ ccle)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX)))) @ (^ [Xx3:$i] : XX)))))))))))).
