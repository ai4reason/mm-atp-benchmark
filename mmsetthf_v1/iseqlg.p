...
thf(adf_eqlg_ax,axiom,(cwceq @ cceqlg @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccs3 @ (ccfv @ cc1 @ (ccv @ Xx3)) @ (ccfv @ cc2 @ (ccv @ Xx3)) @ (ccfv @ ccc0 @ (ccv @ Xx3))) @ (ccfv @ (ccv @ Xg1) @ cccgrg))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccmap))))))).
...
thf(ciseqlg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => (cwi @ Xph @ (cwb @ (cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ cceqlg)) @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XB2 @ XC @ XA2) @ (ccfv @ XG @ cccgrg)))))))))))))))))))))).
