...
thf(aprsssprel_thm,axiom,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwss @ XP @ (ccfv @ XV @ ccspr)) @ (cwcel @ (ccpr @ XX @ XY) @ XP) @ (cwa @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XW))) @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)))))))))).
...
thf(csprsymrelfvlem_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwss @ XP @ (ccfv @ XV @ ccspr)) @ (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xc:$i] : (cwceq @ (ccv @ Xc) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xc:$i] : XP))))) @ (ccpw @ (ccxp @ XV @ XV))))))).
