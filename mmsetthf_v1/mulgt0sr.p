...
thf(altaddpr2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XC @ ccnp) @ (cwi @ (cwceq @ (cco @ XA2 @ XB2 @ ccpp) @ XC) @ (cwbr @ XA2 @ XC @ ccltp))))))).
...
thf(cmulgt0sr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwbr @ cc0r @ XA2 @ ccltr) @ (cwbr @ cc0r @ XB2 @ ccltr)) @ (cwbr @ cc0r @ (cco @ XA2 @ XB2 @ ccmr) @ ccltr))))).
