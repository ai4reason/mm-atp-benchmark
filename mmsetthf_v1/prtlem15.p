...
thf(aanabs7_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwa @ Xps @ (cwa @ Xph @ Xps)) @ (cwa @ Xph @ Xps))))).
thf(aanbi2i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ Xps) => (cwb @ (cwa @ Xch @ Xph) @ (cwa @ Xch @ Xps))))))).
thf(aan43_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwb @ (cwa @ (cwa @ Xph @ Xps) @ (cwa @ Xch @ Xth)) @ (cwa @ (cwa @ Xph @ Xth) @ (cwa @ Xps @ Xch)))))))).
...
thf(aprtlem14_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwi @ (cwprt @ (XA2 @ Xw)) @ (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xw)) @ (cwcel @ (ccv @ Xy1) @ (XA2 @ Xw))) @ (cwi @ (cwa @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1))) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))))))))).
...
thf(cprtlem15_conj,conjecture,(! [Xv:$i] : (! [Xu:$i] : (! [XA2:($i > ($i > $o))] : (! [Xw:$i] : (cwi @ (cwprt @ (XA2 @ Xw)) @ (cwi @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))) @ (cwa @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xv) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (XA2 @ Xw)))) @ (^ [Xx3:$i] : (XA2 @ Xw))) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xv) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (XA2 @ Xw)))))))))).
