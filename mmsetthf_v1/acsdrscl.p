...
thf(cacsdrscl_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccacs)) @ (cwss @ XY @ (ccpw @ XX)) @ (cwcel @ (ccfv @ XY @ ccipo) @ ccdrs)) @ (cwceq @ (ccfv @ (ccuni @ XY) @ XF) @ (ccuni @ (ccima @ XF @ XY)))))))))).
