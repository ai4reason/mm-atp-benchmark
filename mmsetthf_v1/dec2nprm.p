...
thf(annnn0addcl_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (cco @ XM @ XN @ ccaddc) @ ccn))))).
...
thf(cdec2nprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwcel @ XB2 @ ccn0) => ((cwceq @ (cco @ XB2 @ cc2 @ ccmul) @ XC) => (cwn @ (cwcel @ (ccdc @ XA2 @ XC) @ ccprime))))))))).
