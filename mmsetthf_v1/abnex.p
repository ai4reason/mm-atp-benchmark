...
thf(aabnexg_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwcel @ (XF @ Xx3) @ (XV @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (^ [Xx3:$i] : XA2)) @ (cwi @ (cwcel @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XF @ Xx3))) @ (^ [Xx3:$i] : XA2)))) @ (XW @ Xx3 @ Xy1)) @ (cwcel @ XA2 @ ccvv)))))))))).
thf(cabnex_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwa @ (cwcel @ (XF @ Xx3) @ (XV @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xx3) @ (XF @ Xx3))))) @ (cwn @ (cwcel @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XF @ Xx3)))))) @ ccvv))))))).
