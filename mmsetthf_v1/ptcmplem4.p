...
thf(aptcmplem3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xw @ Xf1) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xu:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccima @ (cccnv @ (ccmpt @ (^ [Xw:$i] : XX) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xw))))) @ (ccv @ Xu)))))))) => ((cwceq @ XX @ (ccixp @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccuni @ (ccfv @ (ccv @ Xn) @ XF))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwcel @ XA2 @ (XV @ Xf1)))))) => ((! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwf @ XA2 @ cccmp @ XF)))) => ((! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwcel @ XX @ (ccin @ ccufl @ (ccdm @ cccrd)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwss @ (XU @ Xw @ Xf1 @ Xn) @ (ccrn @ (XS @ Xw @ Xf1)))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwceq @ XX @ (ccuni @ (XU @ Xw @ Xf1 @ Xn)))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwn @ (cwrex @ (^ [Xz:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (XU @ Xw @ Xf1 @ Xn)) @ ccfn))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XK @ Xz @ Xw @ Xk @ Xn) @ (ccrab @ (^ [Xu:$i] : (cwcel @ (ccima @ (cccnv @ (ccmpt @ (^ [Xw:$i] : XX) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xw))))) @ (ccv @ Xu)) @ (XU @ Xw @ Xf1 @ Xn))) @ (^ [Xu:$i] : (ccfv @ (ccv @ Xk) @ XF))))))))) => (! [Xz:$i] : (! [Xw:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ XA2) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccdif @ (ccuni @ (ccfv @ (ccv @ Xk) @ XF)) @ (ccuni @ (XK @ Xz @ Xw @ Xk @ Xn))))) @ (^ [Xk:$i] : XA2))))))))))))))))))))))))))).
