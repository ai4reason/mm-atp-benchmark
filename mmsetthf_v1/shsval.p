...
thf(adf_shs_ax,axiom,(cwceq @ ccph @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccsh)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccsh)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccima @ ccva @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1)))))))).
...
thf(cshsval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccph) @ (ccima @ ccva @ (ccxp @ XA2 @ XB2))))))).
