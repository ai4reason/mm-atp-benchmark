...
thf(adf_nq_ax,axiom,(cwceq @ ccnq @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cceq) @ (cwn @ (cwbr @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cclti)))) @ (^ [Xy1:$i] : (ccxp @ ccnpi @ ccnpi)))) @ (^ [Xx3:$i] : (ccxp @ ccnpi @ ccnpi))))).
