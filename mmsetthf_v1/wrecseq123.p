...
thf(cwrecseq123_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwceq @ XR @ XS) @ (cwceq @ XA2 @ XB2) @ (cwceq @ XF @ XG)) @ (cwceq @ (ccwrecs @ XA2 @ XR @ XF) @ (ccwrecs @ XB2 @ XS @ XG)))))))))).
