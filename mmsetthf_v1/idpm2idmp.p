...
thf(adecpmatid_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XI @ (ccfv @ XC @ ccur)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ Xc_0 @ (ccfv @ XA2 @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XA2 @ ccur)) => (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (cco @ XI @ XK @ ccdecpmat) @ (ccif @ (cwceq @ XK @ ccc0) @ Xc_1 @ Xc_0))))))))))))))))))).
...
thf(cidpm2idmp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_as @ (ccfv @ XQ @ ccvsca)) => ((cwceq @ Xc_ex @ (ccfv @ (ccfv @ XQ @ ccmgp) @ ccmg)) => ((cwceq @ XX @ (ccfv @ XA2 @ ccv1)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XQ @ (ccfv @ XA2 @ ccpl1)) => ((cwceq @ XT @ (cco @ XN @ XR @ ccpm2mp)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwceq @ (ccfv @ (ccfv @ XC @ ccur) @ XT) @ (ccfv @ XQ @ ccur)))))))))))))))))))))))).
