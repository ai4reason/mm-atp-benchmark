...
thf(ccpm2mvalel_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (cco @ XN @ XR @ cccpmat2mat)) => ((cwceq @ XS @ (cco @ XN @ XR @ cccpmat)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ XV) @ (cwcel @ XM @ XS)) @ (cwa @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XN))) @ (cwceq @ (cco @ XX @ XY @ (ccfv @ XM @ XI)) @ (ccfv @ ccc0 @ (ccfv @ (cco @ XX @ XY @ XM) @ ccco1))))))))))))))).
