...
thf(adf_rest_ax,axiom,(cwceq @ ccrest @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xj:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xj:$i] : (^ [Xx3:$i] : (ccrn @ (ccmpt @ (^ [Xy1:$i] : (ccv @ Xj)) @ (^ [Xy1:$i] : (ccin @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(abiimpi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwb @ Xph @ Xps) => (cwi @ Xph @ Xps))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(asnprc_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwceq @ (ccsn @ XA2) @ cc0)))).
thf(cbj_restsnid_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (cco @ (ccsn @ XA2) @ XA2 @ ccrest) @ (ccsn @ XA2)))).
