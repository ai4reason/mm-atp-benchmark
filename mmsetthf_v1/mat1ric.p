...
thf(amat1rngiso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XA2 @ (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XO @ (ccop @ XE @ XE)) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XO @ (ccv @ Xx3)))))) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV)) @ (cwcel @ XF @ (cco @ XR @ XA2 @ ccrs))))))))))))))))).
...
thf(cmat1ric_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (cco @ (ccsn @ XE) @ XR @ ccmat)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV)) @ (cwbr @ XR @ XA2 @ ccric)))))))).
