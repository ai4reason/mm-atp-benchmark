...
thf(chhssmetdval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwceq @ XD @ (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccsh) => (cwi @ (cwa @ (cwcel @ XA2 @ XH) @ (cwcel @ XB2 @ XH)) @ (cwceq @ (cco @ XA2 @ XB2 @ XD) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno)))))))))))).
