...
thf(apjeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwcel @ XH @ ccch) @ (cwcel @ XA2 @ cchil)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ XB2) @ (cwa @ (cwcel @ XB2 @ XH) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (cco @ XB2 @ (ccv @ Xx3) @ ccva))) @ (^ [Xx3:$i] : (ccfv @ XH @ ccort)))))))))).
...
thf(ashsel3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh)) @ (cwb @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccph)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XC @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmv))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(cpjimai_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccch) => (cwceq @ (ccima @ (ccfv @ XB2 @ ccpjh) @ XA2) @ (ccin @ (cco @ XA2 @ (ccfv @ XB2 @ ccort) @ ccph) @ XB2))))))).
