...
thf(cforesf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwfo @ XA2 @ XB2 @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ XB2 @ (ccres @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccpw @ XA2)))))))))).
