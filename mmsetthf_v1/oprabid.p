...
thf(aeqvinop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwceq @ XA2 @ (ccop @ XB2 @ XC)) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ XA2 @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwceq @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ XB2 @ XC)))))))))))))).
...
thf(aotth2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XR @ ccvv) => (cwb @ (cwceq @ (ccop @ (ccop @ XA2 @ XB2) @ XR) @ (ccop @ (ccop @ XC @ XD) @ XS)) @ (cw3a @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD) @ (cwceq @ XR @ XS))))))))))))).
...
thf(aeuequ1_thm,axiom,(! [Xy1:$i] : (cweu @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))))).
...
thf(aexdistrf_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))) => (! [Xy1:$i] : (cwi @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1)))))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ (cwex @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))))))))))).
...
thf(coprabid_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwcel @ (ccop @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz)) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) @ (Xph @ Xx3 @ Xy1 @ Xz))))))).
