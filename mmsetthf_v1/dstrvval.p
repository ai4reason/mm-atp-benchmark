...
thf(cdstrvval_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XP @ ccprb))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XX @ (ccfv @ XP @ ccrrv)))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwceq @ (XD @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccbrsiga) @ (^ [Xa:$i] : (ccfv @ (cco @ XX @ (ccv @ Xa) @ (ccorvc @ ccep)) @ XP)))))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XA2 @ ccbrsiga))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwceq @ (ccfv @ XA2 @ (XD @ Xa)) @ (ccfv @ (ccima @ (cccnv @ XX) @ XA2) @ XP)))))))))))))).
