...
thf(adf_llines_ax,axiom,(cwceq @ cclln @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ cccvr))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xk) @ ccatm)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccbs))))))).
thf(arabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cllnset_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xp:$i] : (cwceq @ (XB2 @ Xp) @ (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XC @ Xx3 @ Xp) @ (ccfv @ XK @ cccvr)))) => ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccfv @ XK @ ccatm))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xx3 @ Xp) @ (ccfv @ XK @ cclln)))) => (! [Xx3:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XK @ (XD @ Xx3 @ Xp)) @ (cwceq @ (XN @ Xx3 @ Xp) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ (XC @ Xx3 @ Xp))) @ (^ [Xp:$i] : (XA2 @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xp)))))))))))))))))).
