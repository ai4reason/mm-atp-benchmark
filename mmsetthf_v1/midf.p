...
thf(amideu_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwceq @ XS @ (ccfv @ XG @ ccmir)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => (cwi @ Xph @ (cwreu @ (^ [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ XA2 @ (ccfv @ (ccv @ Xx3) @ XS)))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))).
...
thf(adf_mid_ax,axiom,(cwceq @ ccmid @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccrio @ (^ [Xm:$i] : (cwceq @ (ccv @ Xb) @ (ccfv @ (ccv @ Xa) @ (ccfv @ (ccv @ Xm) @ (ccfv @ (ccv @ Xg1) @ ccmir))))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)))))))))).
...
thf(cmidf_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => (cwi @ Xph @ (cwf @ (ccxp @ XP @ XP) @ XP @ (ccfv @ XG @ ccmid)))))))))))))).
