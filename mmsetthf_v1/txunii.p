...
thf(ctxunii_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XR @ cctop) => ((cwcel @ XS @ cctop) => ((cwceq @ XX @ (ccuni @ XR)) => ((cwceq @ XY @ (ccuni @ XS)) => (cwceq @ (ccxp @ XX @ XY) @ (ccuni @ (cco @ XR @ XS @ cctx)))))))))))).
