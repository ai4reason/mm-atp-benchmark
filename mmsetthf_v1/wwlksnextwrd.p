...
thf(awwlksnextbi_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XS @ XV)) @ (cw3a @ (cwcel @ XT @ (ccword @ XV)) @ (cwceq @ XW @ (cco @ XT @ (ccs1 @ XS) @ ccconcat)) @ (cwcel @ (ccpr @ (ccfv @ XT @ cclsw) @ XS) @ XE))) @ (cwb @ (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) @ (cwcel @ XT @ (cco @ XN @ XG @ ccwwlksn)))))))))))))).
