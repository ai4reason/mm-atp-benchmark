...
thf(cnnsum4primesprm_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xd) @ cc4 @ ccle) @ (cwceq @ XP @ (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))))).
