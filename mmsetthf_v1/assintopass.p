...
thf(aassintopasslaw_thm,axiom,(! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ Xc_op @ (ccfv @ XM @ ccassintop)) @ (cwbr @ Xc_op @ XM @ ccasslaw))))).
...
thf(cassintopass_conj,conjecture,(! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ Xc_op @ (ccfv @ XM @ ccassintop)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_op) @ (ccv @ Xz) @ Xc_op) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_op) @ Xc_op))) @ (^ [Xz:$i] : XM))) @ (^ [Xy1:$i] : XM))) @ (^ [Xx3:$i] : XM)))))).
