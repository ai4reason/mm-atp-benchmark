...
thf(amblfinlem4_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) @ (cwcel @ XA2 @ (ccdm @ ccvol))) @ (cwceq @ (ccfv @ XA2 @ ccovol) @ (ccsup @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwss @ (ccv @ Xb) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))) @ ccr @ cclt))))).
...
thf(aunirnioo_thm,axiom,(cwceq @ ccr @ (ccuni @ (ccrn @ ccioo)))).
...
thf(aovolge0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccr) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccovol) @ ccle)))).
thf(ampanl12_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => (Xps => ((cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) => (cwi @ Xch @ Xth))))))))).
thf(a_0re_thm,axiom,(cwcel @ ccc0 @ ccr)).
thf(axrre3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ XB2 @ XA2 @ ccle) @ (cwbr @ XA2 @ ccpnf @ cclt))) @ (cwcel @ XA2 @ ccr))))).
...
thf(aralab_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3))))) => (! [Xy1:$i] : (cwb @ (cwral @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xps @ Xx3) @ (Xch @ Xx3 @ Xy1))))))))))).
...
thf(aovolss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ ccr)) @ (cwbr @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccle))))).
...
thf(a_0cld_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwcel @ cc0 @ (ccfv @ XJ @ cccld))))).
...
thf(adifss2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccdif @ XB2 @ XC)) @ (cwss @ XA2 @ XB2)))))).
...
thf(aeqsupd_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwor @ XA2 @ XR))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XC @ Xz) @ XA2))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwn @ (cwbr @ (XC @ Xz) @ (ccv @ Xy1) @ XR))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwa @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwbr @ (ccv @ Xy1) @ (XC @ Xz) @ XR))) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR)) @ (^ [Xz:$i] : XB2))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwceq @ (ccsup @ XB2 @ XA2 @ XR) @ (XC @ Xz)))))))))))))).
...
thf(auniopn_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XJ)) @ (cwcel @ (ccuni @ XA2) @ XJ))))).
...
thf(amblfinlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) @ (cwcel @ XM @ ccr) @ (cwbr @ XM @ (ccfv @ XA2 @ ccovol) @ cclt)) @ (cwrex @ (^ [Xs1:$i] : (cwa @ (cwss @ (ccv @ Xs1) @ XA2) @ (cwbr @ XM @ (ccfv @ (ccv @ Xs1) @ ccovol) @ cclt))) @ (^ [Xs1:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))))).
...
thf(arexab_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3))))) => (! [Xy1:$i] : (cwb @ (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xps @ Xx3) @ (Xch @ Xx3 @ Xy1))))))))))).
...
thf(amblfinlem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) @ (cwa @ (cwss @ XB2 @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr)) @ (cwa @ (cwceq @ (ccfv @ XA2 @ ccovol) @ (ccsup @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwss @ (ccv @ Xb) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))) @ ccr @ cclt)) @ (cwceq @ (ccfv @ XB2 @ ccovol) @ (ccsup @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwss @ (ccv @ Xb) @ XB2) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))) @ ccr @ cclt)))) @ (cwceq @ (ccsup @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwss @ (ccv @ Xb) @ (ccdif @ XA2 @ XB2)) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))) @ ccr @ cclt) @ (ccfv @ (ccdif @ XA2 @ XB2) @ ccovol)))))).
thf(asupadd_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwss @ XA2 @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwne @ XA2 @ cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwss @ XB2 @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwne @ XB2 @ cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xb:$i] : (cwceq @ (XC @ Xy1 @ Xz @ Xv @ Xb) @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xz) @ (cco @ (ccv @ Xv) @ (ccv @ Xb) @ ccaddc))) @ (^ [Xb:$i] : XB2))) @ (^ [Xv:$i] : XA2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (cco @ (ccsup @ XA2 @ ccr @ cclt) @ (ccsup @ XB2 @ ccr @ cclt) @ ccaddc) @ (ccsup @ (XC @ Xy1 @ Xz @ Xv @ Xb) @ ccr @ cclt)))))))))))))))))))).
...
thf(avolun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ (ccdm @ ccvol)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwa @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccvol) @ ccr))) @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ ccvol) @ (cco @ (ccfv @ XA2 @ ccvol) @ (ccfv @ XB2 @ ccvol) @ ccaddc)))))).
thf(asyl2an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xta @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ Xph @ Xta) @ Xth)))))))))).
thf(aunmbl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ (ccdm @ ccvol))) @ (cwcel @ (ccun @ XA2 @ XB2) @ (ccdm @ ccvol)))))).
...
thf(ainfxrgelb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwb @ (cwbr @ XB2 @ (ccinf @ XA2 @ ccxr @ cclt) @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cismblfin_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) @ (cwb @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwceq @ (ccfv @ XA2 @ ccovol) @ (ccsup @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwss @ (ccv @ Xb) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))) @ ccr @ cclt)))))).
