...
thf(ccntzi_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwa @ (cwcel @ XX @ (ccfv @ XS @ XZ)) @ (cwcel @ XY @ XS)) @ (cwceq @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XY @ XX @ Xc_pl)))))))))))).
