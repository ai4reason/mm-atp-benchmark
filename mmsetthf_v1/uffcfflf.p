...
thf(auffclsflim_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwceq @ (cco @ XJ @ XF @ ccfcls) @ (cco @ XJ @ XF @ ccflim))))))).
...
thf(cuffcfflf_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccufil)) @ (cwf @ XY @ XX @ XF)) @ (cwceq @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)))))))))).
