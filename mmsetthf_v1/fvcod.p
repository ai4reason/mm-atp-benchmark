...
thf(cfvcod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwfun @ XG)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ XG))) => ((cwceq @ XH @ (cccom @ XF @ XG)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XH) @ (ccfv @ (ccfv @ XA2 @ XG) @ XF)))))))))))).
