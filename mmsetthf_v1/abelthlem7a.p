...
thf(cabelthlem7a_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ ccn0 @ ccc @ XA2))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XM @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ ccc0 @ XM @ ccle))) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ cc1 @ (ccv @ Xz) @ ccmin) @ ccabs) @ (cco @ XM @ (cco @ cc1 @ (ccfv @ (ccv @ Xz) @ ccabs) @ ccmin) @ ccmul) @ ccle)) @ (^ [Xz:$i] : ccc)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xz @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (XS @ Xz)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul))))))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccseq @ ccaddc @ XA2 @ ccc0) @ ccc0 @ ccli))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XX @ (ccdif @ (XS @ Xz) @ (ccsn @ cc1))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwa @ (cwcel @ XX @ ccc) @ (cwbr @ (ccfv @ (cco @ cc1 @ XX @ ccmin) @ ccabs) @ (cco @ XM @ (cco @ cc1 @ (ccfv @ XX @ ccabs) @ ccmin) @ ccmul) @ ccle))))))))))))))))))).
