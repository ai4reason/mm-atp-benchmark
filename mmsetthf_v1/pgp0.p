...
thf(cpgp0_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XP @ ccprime)) @ (cwbr @ XP @ (cco @ XG @ (ccsn @ Xc_0) @ ccress) @ ccpgp))))))).
