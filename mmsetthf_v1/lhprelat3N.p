...
thf(alhpoc2N_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccoc)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XB2)) @ (cwb @ (cwcel @ XW @ XA2) @ (cwcel @ (ccfv @ XW @ Xc_pe) @ XH)))))))))))))).
...
thf(clhprelat3N_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [Xc_lt:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XB2 @ Xw) @ (ccfv @ XK @ ccbs))) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xw:$i] : (cwceq @ (Xc_lt @ Xw) @ (ccfv @ XK @ ccplt))) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (! [Xw:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ (XB2 @ Xw)) @ (cwcel @ XY @ (XB2 @ Xw))) @ (cwbr @ XX @ XY @ (Xc_lt @ Xw))) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwbr @ XX @ (cco @ XY @ (ccv @ Xw) @ Xc_an) @ Xc_le) @ (cwbr @ (cco @ XY @ (ccv @ Xw) @ Xc_an) @ XY @ XC))) @ (^ [Xw:$i] : XH)))))))))))))))))))).
