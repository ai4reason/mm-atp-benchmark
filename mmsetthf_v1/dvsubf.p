...
thf(cdvsubf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XG)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ XX)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ XS @ XG @ ccdv)) @ XX)) => (cwi @ Xph @ (cwceq @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdv) @ (cco @ (cco @ XS @ XF @ ccdv) @ (cco @ XS @ XG @ ccdv) @ (ccof @ ccmin))))))))))))))).
