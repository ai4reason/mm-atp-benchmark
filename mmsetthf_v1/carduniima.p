...
thf(ccarduniima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwi @ (cwf @ XA2 @ (ccun @ ccom @ (ccrn @ ccale)) @ XF) @ (cwcel @ (ccuni @ (ccima @ XF @ XA2)) @ (ccun @ ccom @ (ccrn @ ccale))))))))).
