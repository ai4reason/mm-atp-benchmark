...
thf(aenqbreq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cceq) @ (cwceq @ (cco @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc2nd) @ ccmi) @ (cco @ (ccfv @ XB2 @ cc1st) @ (ccfv @ XA2 @ cc2nd) @ ccmi))))))).
...
thf(aaddcompi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ ccpli) @ (cco @ XB2 @ XA2 @ ccpli))))).
...
thf(aaddcanpi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccpli) @ (cco @ XA2 @ XC @ ccpli)) @ (cwceq @ XB2 @ XC))))))).
thf(cadderpqlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XC @ (ccxp @ ccnpi @ ccnpi))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cceq) @ (cwbr @ (cco @ XA2 @ XC @ ccplpq) @ (cco @ XB2 @ XC @ ccplpq) @ cceq))))))).
