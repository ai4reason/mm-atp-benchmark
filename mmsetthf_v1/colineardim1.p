...
thf(ccolineardim1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ XW))) @ (cwi @ (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee))))))))))).
