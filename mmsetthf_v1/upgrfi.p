...
thf(cupgrfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) @ (cwcel @ (ccfv @ XF @ XE) @ ccfn)))))))))).
