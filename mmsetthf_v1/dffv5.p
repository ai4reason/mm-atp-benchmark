...
thf(adfiota3_thm,axiom,(! [Xph:($i > $o)] : (cwceq @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccuni @ (ccuni @ (ccin @ (ccsn @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))) @ ccsingles)))))).
...
thf(cdffv5_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ XF) @ (ccuni @ (ccuni @ (ccin @ (ccsn @ (ccima @ XF @ (ccsn @ XA2))) @ ccsingles))))))).
