...
thf(a_4atlem10b_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cwa @ (cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2) @ (cwcel @ XV @ XA2)) @ (cw3a @ (cwcel @ XW @ XA2) @ (cwn @ (cwbr @ XR @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ XS @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XR @ Xc_or) @ Xc_le)))) @ (cwa @ (cwbr @ XR @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or) @ Xc_le) @ (cwbr @ XS @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or) @ Xc_le))) @ (cwceq @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XR @ XS @ Xc_or) @ Xc_or) @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or))))))))))))))))).
...
thf(a_4atlem0a_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwa @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cwa @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2))) @ (cwa @ (cwn @ (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ XS @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XR @ Xc_or) @ Xc_le)))) @ (cwn @ (cwbr @ XR @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XS @ Xc_or) @ Xc_le))))))))))))))).
...
thf(a_4atlem3b_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2) @ (cwcel @ XV @ XA2)) @ (cw3a @ (cwne @ XP @ XQ) @ (cwn @ (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ XS @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XR @ Xc_or) @ Xc_le)))) @ (cwo @ (cwn @ (cwbr @ XR @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XV @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ XS @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XV @ Xc_or) @ Xc_le))))))))))))))))).
thf(c_4atlem10_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwa @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2)) @ (cwcel @ XV @ XA2) @ (cwcel @ XW @ XA2)) @ (cw3a @ (cwne @ XP @ XQ) @ (cwn @ (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) @ (cwn @ (cwbr @ XS @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XR @ Xc_or) @ Xc_le)))) @ (cwi @ (cwbr @ (cco @ XR @ XS @ Xc_or) @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or) @ Xc_le) @ (cwceq @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XR @ XS @ Xc_or) @ Xc_or) @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or)))))))))))))))))).
