...
thf(cfuncnvpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XC @ XV) @ (cwne @ XB2 @ XD)) @ (cwfun @ (cccnv @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)))))))))))).
