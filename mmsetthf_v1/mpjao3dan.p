...
thf(cmpjao3dan_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => ((cwi @ (cwa @ Xph @ Xth) @ Xch) => ((cwi @ (cwa @ Xph @ Xta) @ Xch) => ((cwi @ Xph @ (cw3o @ Xps @ Xth @ Xta)) => (cwi @ Xph @ Xch))))))))))).
