...
thf(cgrpoidinvlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccgr) @ (cwa @ (cwcel @ XY @ XX) @ (cwcel @ XA2 @ XX))) @ (cwa @ (cwceq @ (cco @ XU @ XY @ XG) @ XY) @ (cwceq @ (cco @ XY @ XA2 @ XG) @ XU))) @ (cwceq @ (cco @ (cco @ XA2 @ XY @ XG) @ (cco @ XA2 @ XY @ XG) @ XG) @ (cco @ XA2 @ XY @ XG)))))))))).
