...
thf(chashgt12el2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xb:$i] : (cwi @ (cw3a @ (cwcel @ XV @ (XW @ Xb)) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt) @ (cwcel @ XA2 @ XV)) @ (cwrex @ (^ [Xb:$i] : (cwne @ XA2 @ (ccv @ Xb))) @ (^ [Xb:$i] : XV)))))))).
