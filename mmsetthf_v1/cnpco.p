...
thf(ccnpco_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) @ (cwcel @ XG @ (ccfv @ (ccfv @ XP @ XF) @ (cco @ XK @ XL @ cccnp)))) @ (cwcel @ (cccom @ XG @ XF) @ (ccfv @ XP @ (cco @ XJ @ XL @ cccnp))))))))))).
