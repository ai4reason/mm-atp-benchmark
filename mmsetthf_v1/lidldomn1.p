...
thf(alidlnz_thm,axiom,(! [XR:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ (XR @ Xx3) @ cclidl))) => ((! [Xx3:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xx3) @ cc0g))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ (XR @ Xx3) @ ccrg) @ (cwcel @ XI @ (XU @ Xx3)) @ (cwne @ XI @ (ccsn @ Xc_0))) @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ Xc_0)) @ (^ [Xx3:$i] : XI))))))))))).
...
thf(clidldomn1_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccfv @ (XR @ Xx3) @ cclidl))) => ((! [Xx3:$i] : (cwceq @ Xc_x @ (ccfv @ (XR @ Xx3) @ ccmulr))) => ((! [Xx3:$i] : (cwceq @ (Xc_1 @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccur))) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ (XR @ Xx3) @ cc0g))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ (XR @ Xx3) @ ccdomn) @ (cwa @ (cwcel @ XU @ (XL @ Xx3)) @ (cwne @ XU @ (ccsn @ (Xc_0 @ Xx3)))) @ (cwcel @ XI @ XU)) @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ XI @ (ccv @ Xx3) @ Xc_x) @ (ccv @ Xx3)) @ (cwceq @ (cco @ (ccv @ Xx3) @ XI @ Xc_x) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XU)) @ (cwceq @ XI @ (Xc_1 @ Xx3))))))))))))))))).
