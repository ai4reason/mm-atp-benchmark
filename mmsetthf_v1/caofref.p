...
thf(ccaofref_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3) @ XS @ XF))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XR))) => (cwi @ Xph @ (cwbr @ XF @ XF @ (ccofr @ XR))))))))))))).
