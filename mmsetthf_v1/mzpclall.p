...
thf(aconstmap_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwi @ (cwcel @ XB2 @ XC) @ (cwcel @ (ccxp @ XA2 @ (ccsn @ XB2)) @ (cco @ XC @ XA2 @ ccmap))))))))).
...
thf(cmzpclall_conj,conjecture,(! [XV:($i > $o)] : (cwi @ (cwcel @ XV @ ccvv) @ (cwcel @ (cco @ ccz @ (cco @ ccz @ XV @ ccmap) @ ccmap) @ (ccfv @ XV @ ccmzpcl))))).
