...
thf(adf_lti_ax,axiom,(cwceq @ cclti @ (ccin @ ccep @ (ccxp @ ccnpi @ ccnpi)))).
...
thf(cltpiord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclti) @ (cwcel @ XA2 @ XB2)))))).
