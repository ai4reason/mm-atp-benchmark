...
thf(aaddcompq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ ccplpq) @ (cco @ XB2 @ XA2 @ ccplpq))))).
...
thf(caddcomnq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ ccplq) @ (cco @ XB2 @ XA2 @ ccplq))))).
