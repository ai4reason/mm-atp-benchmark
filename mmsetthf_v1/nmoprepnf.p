...
thf(anmopsetretHIL_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ cchil @ XT) @ (cwss @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xy1) @ ccno) @ cc1 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccno)))) @ (^ [Xy1:$i] : cchil)))) @ ccr)))).
thf(ane0ii_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ XB2) => (cwne @ XB2 @ cc0))))).
thf(ccc0_tp,type,(ccc0 : ($i > $o))).
thf(anmopsetn0_thm,axiom,(! [XT:($i > $o)] : (cwcel @ (ccfv @ (ccfv @ cc0v @ XT) @ ccno) @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xy1) @ ccno) @ cc1 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccno)))) @ (^ [Xy1:$i] : cchil))))))).
...
thf(cnmoprepnf_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ cchil @ XT) @ (cwb @ (cwcel @ (ccfv @ XT @ ccnop) @ ccr) @ (cwne @ (ccfv @ XT @ ccnop) @ ccpnf))))).
