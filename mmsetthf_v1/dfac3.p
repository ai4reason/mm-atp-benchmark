...
thf(afunfvima3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ XF @ XG)) @ (cwi @ (cwcel @ XA2 @ (ccdm @ XF)) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccima @ XG @ (ccsn @ XA2))))))))).
...
thf(aaceq3lem_thm,axiom,(! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xf1:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xf1) @ (ccmpt @ (^ [Xw:$i] : (ccdm @ (ccv @ Xy1))) @ (^ [Xw:$i] : (ccfv @ (ccab @ (^ [Xu:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xu) @ (ccv @ Xy1)))) @ (ccv @ Xf1))))))))))) => (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3))))))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwss @ (ccv @ Xf1) @ (ccv @ Xy1)) @ (cwfn @ (ccv @ Xf1) @ (ccdm @ (ccv @ Xy1))))))))))).
thf(cdfac3_conj,conjecture,(cwb @ cwac @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))).
