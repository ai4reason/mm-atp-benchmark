...
thf(cdvcxp2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ cccxp))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ XA2 @ cclog) @ (cco @ XA2 @ (ccv @ Xx3) @ cccxp) @ ccmul))))))).
