...
thf(acau3_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xm:$i] : (cwceq @ (XZ @ Xm) @ (ccfv @ (XM @ Xm) @ ccuz))) => (! [Xm:$i] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xj) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xm)))) @ (^ [Xx3:$i] : ccrp)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc) @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xm) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xk) @ ccuz))))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xm)))) @ (^ [Xx3:$i] : ccrp))))))))).
...
thf(cserf0_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => (cwi @ Xph @ (cwbr @ XF @ ccc0 @ ccli))))))))))))).
