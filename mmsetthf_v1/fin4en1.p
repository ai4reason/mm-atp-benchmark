...
thf(af1imapss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwa @ (cwss @ XC @ XA2) @ (cwss @ XD @ XA2))) @ (cwb @ (cwpss @ (ccima @ XF @ XC) @ (ccima @ XF @ XD)) @ (cwpss @ XC @ XD))))))))).
...
thf(aisfin4_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xy1)) @ (cwb @ (cwcel @ XA2 @ ccfin4) @ (cwn @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwpss @ (ccv @ Xy1) @ XA2) @ (cwbr @ (ccv @ Xy1) @ XA2 @ ccen))))))))))).
thf(cfin4en1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwi @ (cwcel @ XA2 @ ccfin4) @ (cwcel @ XB2 @ ccfin4)))))).
