...
thf(aelpadd2at2_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cwa @ (cwcel @ XK @ cclat) @ (cw3a @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2))) @ (cwb @ (cwcel @ XS @ (cco @ (ccsn @ XQ) @ (ccsn @ XR) @ Xc_pl)) @ (cwbr @ XS @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))))))))))))))).
