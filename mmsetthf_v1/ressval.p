...
thf(adf_ress_ax,axiom,(cwceq @ ccress @ (ccmpt2 @ (^ [Xw:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xx3:$i] : (ccif @ (cwss @ (ccfv @ (ccv @ Xw) @ ccbs) @ (ccv @ Xx3)) @ (ccv @ Xw) @ (cco @ (ccv @ Xw) @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccin @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccbs))) @ ccsts))))))).
thf(cressval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (cco @ XW @ XA2 @ ccress)) => ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ XX) @ (cwcel @ XA2 @ XY)) @ (cwceq @ XR @ (ccif @ (cwss @ XB2 @ XA2) @ XW @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccin @ XA2 @ XB2)) @ ccsts))))))))))))).
