...
thf(aledi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwss @ (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj) @ (ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)))))))).
...
thf(achdmj1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ cchj) @ ccort) @ (ccin @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort))))))).
...
thf(ain4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwceq @ (ccin @ (ccin @ XA2 @ XB2) @ (ccin @ XC @ XD)) @ (ccin @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XD)))))))).
...
thf(acmcm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ XB2 @ XA2 @ cccm)))))).
thf(achoccl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwcel @ (ccfv @ XA2 @ ccort) @ ccch)))).
thf(acmbr3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ (ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) @ (ccin @ XA2 @ XB2))))))).
...
thf(acmcm3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ (ccfv @ XA2 @ ccort) @ XB2 @ cccm)))))).
...
thf(achocin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwceq @ (ccin @ XA2 @ (ccfv @ XA2 @ ccort)) @ cc0h)))).
thf(achm0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwceq @ (ccin @ XA2 @ cc0h) @ cc0h)))).
thf(apjoml_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccsh)) @ (cwa @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccin @ XB2 @ (ccfv @ XA2 @ ccort)) @ cc0h))) @ (cwceq @ XA2 @ XB2))))).
thf(cfh2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwa @ (cwbr @ XB2 @ XA2 @ cccm) @ (cwbr @ XB2 @ XC @ cccm))) @ (cwceq @ (ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) @ (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj))))))).
