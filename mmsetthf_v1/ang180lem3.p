...
thf(aang180lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ cclog) @ (ccfv @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XA2 @ ccdiv) @ cclog) @ ccaddc) @ (ccfv @ XA2 @ cclog) @ ccaddc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (cco @ (cco @ (cco @ (XT @ Xx3 @ Xy1) @ cci @ ccdiv) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) @ (cwa @ (cwbr @ (ccneg @ cc2) @ (XN @ Xx3 @ Xy1) @ cclt) @ (cwbr @ (XN @ Xx3 @ Xy1) @ cc1 @ cclt))))))))))))).
...
thf(cang180lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ cclog) @ (ccfv @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XA2 @ ccdiv) @ cclog) @ ccaddc) @ (ccfv @ XA2 @ cclog) @ ccaddc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (cco @ (cco @ (cco @ (XT @ Xx3 @ Xy1) @ cci @ ccdiv) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) @ (cwcel @ (XT @ Xx3 @ Xy1) @ (ccpr @ (ccneg @ (cco @ cci @ ccpi @ ccmul)) @ (cco @ cci @ ccpi @ ccmul)))))))))))))).
