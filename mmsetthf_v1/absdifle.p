...
thf(cabsdifle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ ccle) @ (cwa @ (cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ ccle) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccle)))))))).
