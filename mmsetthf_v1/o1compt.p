...
thf(ao1co_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XF @ cco1)) => ((cwi @ Xph @ (cwf @ XB2 @ XA2 @ XG)) => ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ ccr)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) @ (cwbr @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccle))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr)))) => (cwi @ Xph @ (cwcel @ (cccom @ XF @ XG) @ cco1))))))))))))).
...
thf(co1compt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xy1:$i] : (cwi @ Xph @ (cwf @ XA2 @ ccc @ (XF @ Xy1)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xy1) @ cco1))) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwcel @ (XC @ Xy1) @ XA2))) => ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ ccr)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) @ (cwbr @ (ccv @ Xm) @ (XC @ Xy1) @ ccle))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr)))) => (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (cccom @ (XF @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (XC @ Xy1)))) @ cco1)))))))))))))).
