...
thf(anmlno0i_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => ((cwceq @ XZ @ (cco @ XU @ XW @ cc0o)) => ((cwceq @ XL @ (cco @ XU @ XW @ cclno)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (cwi @ (cwcel @ XT @ XL) @ (cwb @ (cwceq @ (ccfv @ XT @ XN) @ ccc0) @ (cwceq @ XT @ XZ))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(aelimnvu_thm,axiom,(! [XU:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XU @ ccnv) @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) @ ccnv))).
thf(cnmlno0_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => ((cwceq @ XZ @ (cco @ XU @ XW @ cc0o)) => ((cwceq @ XL @ (cco @ XU @ XW @ cclno)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwcel @ XT @ XL)) @ (cwb @ (cwceq @ (ccfv @ XT @ XN) @ ccc0) @ (cwceq @ XT @ XZ))))))))))))).
