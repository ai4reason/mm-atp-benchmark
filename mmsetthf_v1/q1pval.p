...
thf(cq1pval_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : ((! [Xq:$i] : (cwceq @ (XQ @ Xq) @ (ccfv @ XR @ ccq1p))) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((! [Xq:$i] : (cwceq @ (XD @ Xq) @ (ccfv @ XR @ ccdg1))) => ((! [Xq:$i] : (cwceq @ (Xc_mi @ Xq) @ (ccfv @ XP @ ccsg))) => ((! [Xq:$i] : (cwceq @ (Xc_x @ Xq) @ (ccfv @ XP @ ccmulr))) => (! [Xq:$i] : (cwi @ (cwa @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) @ (cwceq @ (cco @ XF @ XG @ (XQ @ Xq)) @ (ccrio @ (^ [Xq:$i] : (cwbr @ (ccfv @ (cco @ XF @ (cco @ (ccv @ Xq) @ XG @ (Xc_x @ Xq)) @ (Xc_mi @ Xq)) @ (XD @ Xq)) @ (ccfv @ XG @ (XD @ Xq)) @ cclt)) @ (^ [Xq:$i] : XB2))))))))))))))))))))).
