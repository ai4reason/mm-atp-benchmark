...
thf(adf_cmp_ax,axiom,(cwceq @ cccmp @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwceq @ (ccuni @ (ccv @ Xx3)) @ (ccuni @ (ccv @ Xy1))) @ (cwrex @ (^ [Xz:$i] : (cwceq @ (ccuni @ (ccv @ Xx3)) @ (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (ccv @ Xy1)) @ ccfn))))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : cctop)))).
thf(ciscmp_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XX @ Xy1 @ Xz) @ (ccuni @ XJ)))) => (! [Xz:$i] : (cwb @ (cwcel @ XJ @ cccmp) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwceq @ (XX @ Xy1 @ Xz) @ (ccuni @ (ccv @ Xy1))) @ (cwrex @ (^ [Xz:$i] : (cwceq @ (XX @ Xy1 @ Xz) @ (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (ccv @ Xy1)) @ ccfn))))) @ (^ [Xy1:$i] : (ccpw @ XJ)))))))))).
