...
thf(c_1stcclb_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cc1stc) @ (cwcel @ XA2 @ XX)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xy1)) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : XJ)))) @ (^ [Xx3:$i] : (ccpw @ XJ))))))))).
