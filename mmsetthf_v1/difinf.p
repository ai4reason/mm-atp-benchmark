...
thf(aunfir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ (ccun @ XA2 @ XB2) @ ccfn) @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)))))).
thf(cdifinf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwn @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ XB2 @ ccfn)) @ (cwn @ (cwcel @ (ccdif @ XA2 @ XB2) @ ccfn)))))).
