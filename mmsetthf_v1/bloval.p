...
thf(adf_blo_ax,axiom,(cwceq @ ccblo @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xw:$i] : ccnv)) @ (^ [Xu:$i] : (^ [Xw:$i] : ccnv)) @ (^ [Xu:$i] : (^ [Xw:$i] : (ccrab @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (cco @ (ccv @ Xu) @ (ccv @ Xw) @ ccnmoo)) @ ccpnf @ cclt)) @ (^ [Xt:$i] : (cco @ (ccv @ Xu) @ (ccv @ Xw) @ cclno)))))))).
...
thf(cbloval_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => ((cwceq @ XL @ (cco @ XU @ XW @ cclno)) => ((! [Xt:$i] : (cwceq @ (XB2 @ Xt) @ (cco @ XU @ XW @ ccblo))) => (! [Xt:$i] : (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv)) @ (cwceq @ (XB2 @ Xt) @ (ccrab @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ XN) @ ccpnf @ cclt)) @ (^ [Xt:$i] : XL)))))))))))))).
