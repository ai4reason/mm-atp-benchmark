...
thf(caddsrmo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer)) @ (cwcel @ XB2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer))) @ (cwmo @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xv:$i] : (cwex @ (^ [Xu:$i] : (cwex @ (^ [Xt:$i] : (cwa @ (cwa @ (cwceq @ XA2 @ (ccec @ (ccop @ (ccv @ Xw) @ (ccv @ Xv)) @ ccer)) @ (cwceq @ XB2 @ (ccec @ (ccop @ (ccv @ Xu) @ (ccv @ Xt)) @ ccer))) @ (cwceq @ (ccv @ Xz) @ (ccec @ (ccop @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccpp) @ (cco @ (ccv @ Xv) @ (ccv @ Xt) @ ccpp)) @ ccer))))))))))))))))).
