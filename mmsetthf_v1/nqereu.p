...
thf(aertr4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwer @ XX @ XR)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ XR)) => ((cwi @ Xph @ (cwbr @ XC @ XB2 @ XR)) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ XR)))))))))))).
...
thf(cnqereu_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwreu @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ cceq)) @ (^ [Xx3:$i] : ccnq))))).
