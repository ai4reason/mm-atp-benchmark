...
thf(cadjeq_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XS) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))) @ (cwceq @ (ccfv @ XT @ ccado) @ XS))))).
