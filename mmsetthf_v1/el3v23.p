...
thf(cel3v23_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (Xph @ Xy1 @ Xz) @ (cwcel @ (ccv @ Xy1) @ ccvv) @ (cwcel @ (ccv @ Xz) @ ccvv)) @ (Xth @ Xy1 @ Xz)))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xy1 @ Xz) @ (Xth @ Xy1 @ Xz)))))))).
