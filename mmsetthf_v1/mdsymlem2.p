...
thf(amdsymlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : (cwceq @ (XC @ Xp) @ (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (! [Xp:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccch) @ (cwss @ (ccin @ XB2 @ (XC @ Xp)) @ XA2)) @ (cwa @ (cwbr @ XB2 @ XA2 @ ccdmd) @ (cwss @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ cchj)))) @ (cwss @ (ccv @ Xp) @ XA2)))))))))).
...
thf(cmdsymlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : (cwceq @ (XC @ Xp) @ (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (! [Xp:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccat) @ (cwss @ (ccin @ XB2 @ (XC @ Xp)) @ XA2)) @ (cwa @ (cwbr @ XB2 @ XA2 @ ccdmd) @ (cwss @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ cchj)))) @ (cwi @ (cwne @ XB2 @ cc0h) @ (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwss @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ cchj)) @ (cwa @ (cwss @ (ccv @ Xq) @ XA2) @ (cwss @ (ccv @ Xr) @ XB2)))) @ (^ [Xq:$i] : ccat))) @ (^ [Xr:$i] : ccat)))))))))))).
