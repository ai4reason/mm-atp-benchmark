...
thf(cgrppropstr_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ (ccfv @ XK @ ccbs) @ XB2) => ((cwceq @ (ccfv @ XK @ ccplusg) @ Xc_pl) => ((cwceq @ XL @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl))) => (cwb @ (cwcel @ XK @ ccgrp) @ (cwcel @ XL @ ccgrp)))))))))).
