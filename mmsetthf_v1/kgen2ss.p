...
thf(asscmp_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XK)) => (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ cccmp) @ (cwss @ XJ @ XK)) @ (cwcel @ XJ @ cccmp))))))).
...
thf(aelkgen_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XJ @ cckgen)) @ (cwa @ (cwss @ XA2 @ XX) @ (cwral @ (^ [Xk:$i] : (cwi @ (cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp) @ (cwcel @ (ccin @ XA2 @ (ccv @ Xk)) @ (cco @ XJ @ (ccv @ Xk) @ ccrest)))) @ (^ [Xk:$i] : (ccpw @ XX)))))))))).
thf(a_3ad2ant2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xch) => (cwi @ (cw3a @ Xps @ Xph @ Xth) @ Xch))))))).
thf(ckgen2ss_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XX @ cctopon)) @ (cwss @ XJ @ XK)) @ (cwss @ (ccfv @ XJ @ cckgen) @ (ccfv @ XK @ cckgen))))))).
