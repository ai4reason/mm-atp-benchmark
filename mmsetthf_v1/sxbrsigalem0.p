...
thf(csxbrsigalem0_conj,conjecture,(cwceq @ (ccuni @ (ccun @ (ccrn @ (ccmpt @ (^ [Xe:$i] : ccr) @ (^ [Xe:$i] : (ccxp @ (cco @ (ccv @ Xe) @ ccpnf @ ccico) @ ccr)))) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : ccr) @ (^ [Xf1:$i] : (ccxp @ ccr @ (cco @ (ccv @ Xf1) @ ccpnf @ ccico))))))) @ (ccxp @ ccr @ ccr))).
