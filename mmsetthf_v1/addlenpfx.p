...
thf(caddlenpfx_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XM @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (cco @ (ccfv @ (cco @ XW @ XM @ ccpfx) @ cchash) @ (ccfv @ (cco @ XW @ (ccop @ XM @ (ccfv @ XW @ cchash)) @ ccsubstr) @ cchash) @ ccaddc) @ (ccfv @ XW @ cchash))))))).
