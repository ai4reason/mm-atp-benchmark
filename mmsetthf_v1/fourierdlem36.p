...
thf(afzisoeu_thm,axiom,(! [Xph:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XH @ ccfn))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwor @ XH @ cclt))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XM @ ccz))) => ((cwceq @ XN @ (cco @ (ccfv @ XH @ cchash) @ (cco @ XM @ cc1 @ ccmin) @ ccaddc)) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cweu @ (^ [Xf1:$i] : (cwiso @ (cco @ XM @ XN @ ccfz) @ XH @ cclt @ cclt @ (ccv @ Xf1))))))))))))))).
...
thf(cfourierdlem36_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwceq @ XF @ (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ (ccv @ Xf1))))) => ((cwceq @ XN @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin)) => (cwi @ Xph @ (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ XF))))))))))).
