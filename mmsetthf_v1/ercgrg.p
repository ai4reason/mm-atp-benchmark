...
thf(adf_cgrg_ax,axiom,(cwceq @ cccgrg @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ ccr @ ccpm)) @ (cwcel @ (ccv @ Xb) @ (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ ccr @ ccpm))) @ (cwa @ (cwceq @ (ccdm @ (ccv @ Xa)) @ (ccdm @ (ccv @ Xb))) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xg1) @ ccds)) @ (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xb)) @ (ccfv @ (ccv @ Xg1) @ ccds)))) @ (^ [Xj:$i] : (ccdm @ (ccv @ Xa))))) @ (^ [Xi:$i] : (ccdm @ (ccv @ Xa))))))))))))).
...
thf(aiscgrg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_sm:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xi @ Xj) @ (ccfv @ XG @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_mi @ Xi @ Xj) @ (ccfv @ XG @ ccds)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_sm @ Xi @ Xj) @ (ccfv @ XG @ cccgrg)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwcel @ XG @ (XV @ Xi @ Xj)) @ (cwb @ (cwbr @ XA2 @ XB2 @ (Xc_sm @ Xi @ Xj)) @ (cwa @ (cwa @ (cwcel @ XA2 @ (cco @ (XP @ Xi @ Xj) @ ccr @ ccpm)) @ (cwcel @ XB2 @ (cco @ (XP @ Xi @ Xj) @ ccr @ ccpm))) @ (cwa @ (cwceq @ (ccdm @ XA2) @ (ccdm @ XB2)) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xj) @ XA2) @ (Xc_mi @ Xi @ Xj)) @ (cco @ (ccfv @ (ccv @ Xi) @ XB2) @ (ccfv @ (ccv @ Xj) @ XB2) @ (Xc_mi @ Xi @ Xj)))) @ (^ [Xj:$i] : (ccdm @ XA2)))) @ (^ [Xi:$i] : (ccdm @ XA2)))))))))))))))))))).
...
thf(cercgrg_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => (cwi @ (cwcel @ XG @ ccstrkg) @ (cwer @ (cco @ XP @ ccr @ ccpm) @ (ccfv @ XG @ cccgrg))))))).
