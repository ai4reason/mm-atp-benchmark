...
thf(acnvintabd_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3)))))) => (! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwceq @ (cccnv @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3))))) @ (ccint @ (ccrab @ (^ [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccv @ Xw) @ (cccnv @ (ccv @ Xx3))) @ (Xps @ Xx3))))) @ (^ [Xw:$i] : (ccpw @ (ccxp @ ccvv @ ccvv))))))))))))).
...
thf(aintabssd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1))) @ (cwi @ (Xch @ Xy1) @ (Xps @ Xx3))))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xy1) @ (ccv @ Xy1)))) => (cwi @ Xph @ (cwss @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3)))) @ (ccint @ (ccab @ (^ [Xy1:$i] : (Xch @ Xy1))))))))))))))).
