...
thf(cringelnzr_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ (ccdif @ XB2 @ (ccsn @ Xc_0)))) @ (cwcel @ XR @ ccnzr))))))))).
