...
thf(aringccatALTV_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccringcALTV)) => (cwi @ (cwcel @ XU @ XV) @ (cwcel @ XC @ cccat))))))).
...
thf(cringcsectALTV_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccringcALTV)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwceq @ XE @ (ccfv @ XX @ ccbs)) => ((cwceq @ XS @ (ccfv @ XC @ ccsect)) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XG @ (cco @ XX @ XY @ XS)) @ (cw3a @ (cwcel @ XF @ (cco @ XX @ XY @ ccrh)) @ (cwcel @ XG @ (cco @ XY @ XX @ ccrh)) @ (cwceq @ (cccom @ XG @ XF) @ (ccres @ ccid @ XE)))))))))))))))))))))))).
