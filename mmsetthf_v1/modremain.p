...
thf(cmodremain_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn) @ (cwa @ (cwcel @ XR @ ccn0) @ (cwbr @ XR @ XD @ cclt))) @ (cwb @ (cwceq @ (cco @ XN @ XD @ ccmo) @ XR) @ (cwrex @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xz) @ XD @ ccmul) @ XR @ ccaddc) @ XN)) @ (^ [Xz:$i] : ccz)))))))).
