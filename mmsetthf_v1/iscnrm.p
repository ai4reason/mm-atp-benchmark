...
thf(adf_cnrm_ax,axiom,(cwceq @ cccnrm @ (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ ccrest) @ ccnrm)) @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xj)))))) @ (^ [Xj:$i] : cctop)))).
thf(ciscnrm_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ cccnrm) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccnrm)) @ (^ [Xx3:$i] : (ccpw @ XX))))))))).
