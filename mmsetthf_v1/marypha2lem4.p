...
thf(aresopab2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccres @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (Xph @ Xx3 @ Xy1))))) @ XA2) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3 @ Xy1))))))))))).
...
thf(cmarypha2lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xx3) @ XF)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwss @ XX @ XA2)) @ (cwceq @ (ccima @ (XT @ Xx3) @ XX) @ (ccuni @ (ccima @ XF @ XX))))))))))).
