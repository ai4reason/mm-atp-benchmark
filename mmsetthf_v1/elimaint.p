...
thf(celimaint_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xa:$i] : (cwb @ (cwcel @ (ccv @ Xy1) @ (ccima @ (ccint @ (XA2 @ Xy1)) @ (XB2 @ Xy1 @ Xa))) @ (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xa:$i] : (cwcel @ (ccop @ (ccv @ Xb) @ (ccv @ Xy1)) @ (ccv @ Xa))) @ (^ [Xa:$i] : (XA2 @ Xy1)))) @ (^ [Xb:$i] : (XB2 @ Xy1 @ Xa))))))))).
