...
thf(afisn_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccsn @ XA2) @ ccfi) @ (ccsn @ XA2)))).
...
thf(aordtbas2_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XC @ Xx3 @ Xy1 @ Xa @ Xb) @ (ccrn @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XX)) @ (^ [Xa:$i] : (^ [Xb:$i] : XX)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccrab @ (^ [Xy1:$i] : (cwa @ (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xa) @ XR)) @ (cwn @ (cwbr @ (ccv @ Xb) @ (ccv @ Xy1) @ XR)))) @ (^ [Xy1:$i] : XX))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwcel @ XR @ cctsr) @ (cwceq @ (ccfv @ (ccun @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1)) @ ccfi) @ (ccun @ (ccun @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1)) @ (XC @ Xx3 @ Xy1 @ Xa @ Xb)))))))))))))))))).
...
thf(cordtbas_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XC @ Xx3 @ Xy1 @ Xa @ Xb) @ (ccrn @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XX)) @ (^ [Xa:$i] : (^ [Xb:$i] : XX)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccrab @ (^ [Xy1:$i] : (cwa @ (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xa) @ XR)) @ (cwn @ (cwbr @ (ccv @ Xb) @ (ccv @ Xy1) @ XR)))) @ (^ [Xy1:$i] : XX))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwcel @ XR @ cctsr) @ (cwceq @ (ccfv @ (ccun @ (ccsn @ XX) @ (ccun @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1))) @ ccfi) @ (ccun @ (ccun @ (ccsn @ XX) @ (ccun @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1))) @ (XC @ Xx3 @ Xy1 @ Xa @ Xb)))))))))))))))))).
