...
thf(aaxdc3lem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XS @ Xk @ Xn @ Xs1) @ (ccab @ (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwf @ (ccsuc @ (ccv @ Xn)) @ (XA2 @ Xk) @ (ccv @ Xs1)) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xs1)) @ (XC @ Xk @ Xn @ Xs1)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)) @ (XF @ Xk @ Xn @ Xs1)))) @ (^ [Xk:$i] : (ccv @ Xn))))) @ (^ [Xn:$i] : ccom)))))))) => (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwcel @ (XS @ Xk @ Xn @ Xs1) @ ccvv))))))))))).
...
thf(a_0elsuc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwcel @ cc0 @ (ccsuc @ XA2))))).
...
thf(aaxdc2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwa @ (cwne @ XA2 @ cc0) @ (cwf @ XA2 @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ XF)) @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwf @ ccom @ XA2 @ (ccv @ Xg1)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ XF))) @ (^ [Xk:$i] : ccom)))))))))).
thf(cwtr_tp,type,(cwtr : (($i > $o) > $o))).
thf(cciun_tp,type,(cciun : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(aaxdc3lem2_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xk) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xg1 @ Xh @ Xn) @ (ccab @ (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwf @ (ccsuc @ (ccv @ Xn)) @ (XA2 @ Xx3 @ Xy1 @ Xk) @ (ccv @ Xs1)) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xs1)) @ (XC @ Xx3 @ Xy1 @ Xk)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)) @ (XF @ Xx3 @ Xy1 @ Xk)))) @ (^ [Xk:$i] : (ccv @ Xn))))) @ (^ [Xn:$i] : ccom))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xg1 @ Xh @ Xn @ Xs1) @ (ccmpt @ (^ [Xx3:$i] : (XS @ Xg1 @ Xh @ Xn)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccdm @ (ccv @ Xy1)) @ (ccsuc @ (ccdm @ (ccv @ Xx3)))) @ (cwceq @ (ccres @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xx3))) @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (XS @ Xg1 @ Xh @ Xn)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (cwex @ (^ [Xh:$i] : (cwa @ (cwf @ ccom @ (XS @ Xg1 @ Xh @ Xn) @ (ccv @ Xh)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xh)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xh)) @ (XG @ Xx3 @ Xy1 @ Xg1 @ Xh @ Xn @ Xs1)))) @ (^ [Xk:$i] : ccom))))) @ (cwex @ (^ [Xg1:$i] : (cw3a @ (cwf @ ccom @ (XA2 @ Xx3 @ Xy1 @ Xk) @ (ccv @ Xg1)) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xg1)) @ (XC @ Xx3 @ Xy1 @ Xk)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (XF @ Xx3 @ Xy1 @ Xk)))) @ (^ [Xk:$i] : ccom))))))))))))))))))))).
thf(caxdc3lem4_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xg1 @ Xn) @ (ccab @ (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwf @ (ccsuc @ (ccv @ Xn)) @ (XA2 @ Xy1) @ (ccv @ Xs1)) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xs1)) @ (XC @ Xx3 @ Xy1)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)) @ (XF @ Xy1)))) @ (^ [Xk:$i] : (ccv @ Xn))))) @ (^ [Xn:$i] : ccom))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xg1 @ Xn @ Xs1) @ (ccmpt @ (^ [Xx3:$i] : (XS @ Xg1 @ Xn)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccdm @ (ccv @ Xy1)) @ (ccsuc @ (ccdm @ (ccv @ Xx3)))) @ (cwceq @ (ccres @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xx3))) @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (XS @ Xg1 @ Xn))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (XC @ Xx3 @ Xy1) @ (XA2 @ Xy1)) @ (cwf @ (XA2 @ Xy1) @ (ccdif @ (ccpw @ (XA2 @ Xy1)) @ (ccsn @ cc0)) @ (XF @ Xy1))) @ (cwex @ (^ [Xg1:$i] : (cw3a @ (cwf @ ccom @ (XA2 @ Xy1) @ (ccv @ Xg1)) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xg1)) @ (XC @ Xx3 @ Xy1)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (XF @ Xy1)))) @ (^ [Xk:$i] : ccom))))))))))))))))).
