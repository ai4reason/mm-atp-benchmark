...
thf(arelogbzcl_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp)) @ (cwcel @ (cco @ XB2 @ XX @ cclogb) @ ccr))))).
...
thf(arege1logbzge0_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ (cco @ cc1 @ ccpnf @ ccico))) @ (cwbr @ ccc0 @ (cco @ XB2 @ XX @ cclogb) @ ccle))))).
...
thf(aeluz2n0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwne @ XN @ ccc0)))).
...
thf(adignn0ldlem_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc) @ ccuz))) @ (cwbr @ XN @ (cco @ XB2 @ XK @ ccexp) @ cclt)))))).
...
thf(cdignnld_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc) @ ccuz))) @ (cwceq @ (cco @ XK @ XN @ (ccfv @ XB2 @ ccdig)) @ ccc0)))))).
