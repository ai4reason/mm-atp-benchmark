...
thf(cpmapidclN_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XK @ cclub)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XC)) @ (cwceq @ (ccfv @ (ccfv @ XX @ XU) @ XM) @ XX))))))))))).
