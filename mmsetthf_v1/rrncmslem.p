...
thf(crrncmslem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xm:$i] : (cwceq @ (XX @ Xt @ Xm) @ (cco @ ccr @ (XI @ Xt) @ ccmap)))) => ((! [Xt:$i] : (! [Xm:$i] : (cwceq @ (XM @ Xt @ Xm) @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))))) => ((! [Xt:$i] : (! [Xm:$i] : (cwceq @ (XJ @ Xt @ Xm) @ (ccfv @ (ccfv @ (XI @ Xt) @ ccrrn) @ ccmopn)))) => ((! [Xt:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xt @ Xm) @ (cwcel @ (XI @ Xt) @ ccfn)))) => ((! [Xt:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xt @ Xm) @ (cwcel @ XF @ (ccfv @ (ccfv @ (XI @ Xt) @ ccrrn) @ ccca))))) => ((! [Xt:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xt @ Xm) @ (cwf @ ccn @ (XX @ Xt @ Xm) @ XF)))) => ((! [Xt:$i] : (! [Xm:$i] : (cwceq @ (XP @ Xt @ Xm) @ (ccmpt @ (^ [Xm:$i] : (XI @ Xt)) @ (^ [Xm:$i] : (ccfv @ (ccmpt @ (^ [Xt:$i] : ccn) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xm) @ (ccfv @ (ccv @ Xt) @ XF)))) @ ccli)))))) => (! [Xt:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xt @ Xm) @ (cwcel @ XF @ (ccdm @ (ccfv @ (XJ @ Xt @ Xm) @ cclm))))))))))))))))))))).
