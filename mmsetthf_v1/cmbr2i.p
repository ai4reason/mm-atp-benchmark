...
thf(ccmbr2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ XA2 @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XA2 @ (ccfv @ XB2 @ ccort) @ cchj))))))))).
