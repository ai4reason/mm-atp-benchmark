...
thf(alimuni2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwlim @ XA2) @ (cwlim @ (ccuni @ XA2))))).
...
thf(a_3ori_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3o @ Xph @ Xps @ Xch) => (cwi @ (cwa @ (cwn @ Xph) @ (cwn @ Xps)) @ Xch)))))).
...
thf(arankxplim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwlim @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)) @ (cwne @ (ccxp @ XA2 @ XB2) @ cc0)) @ (cwceq @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk) @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)))))))).
...
thf(crankxplim3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwlim @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk)) @ (cwlim @ (ccuni @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk))))))))).
