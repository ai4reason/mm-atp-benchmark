...
thf(acnvoprab_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xa) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwb @ (Xps @ Xz @ Xa) @ (Xph @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xps @ Xz @ Xa) @ (cwcel @ (ccv @ Xa) @ (ccxp @ ccvv @ ccvv))))) => (cwceq @ (cccnv @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) @ (ccopab @ (^ [Xz:$i] : (^ [Xa:$i] : (Xps @ Xz @ Xa)))))))))).
...
thf(ael3v_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ (ccv @ Xx3) @ ccvv) @ (cwcel @ (ccv @ Xy1) @ ccvv) @ (cwcel @ (ccv @ Xz) @ ccvv)) @ (Xph @ Xx3 @ Xy1 @ Xz))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))).
...
thf(cdfxrn2_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwceq @ (ccxrn @ XR @ XS) @ (cccnv @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xu:$i] : (cwa @ (cwbr @ (ccv @ Xu) @ (ccv @ Xx3) @ XR) @ (cwbr @ (ccv @ Xu) @ (ccv @ Xy1) @ XS))))))))))).
