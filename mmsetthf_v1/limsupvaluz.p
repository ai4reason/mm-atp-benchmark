...
thf(afreld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => (cwi @ Xph @ (cwrel @ XF)))))))).
...
thf(auzinico2_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ ccuz) @ (ccin @ (ccfv @ XM @ ccuz) @ (cco @ XN @ ccpnf @ ccico))))))))).
...
thf(climsupvaluz_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XZ @ ccxr @ XF))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ XF @ cclsp) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccsup @ (ccrn @ (ccres @ XF @ (ccfv @ (ccv @ Xk) @ ccuz))) @ ccxr @ cclt)))) @ ccxr @ cclt)))))))))))).
