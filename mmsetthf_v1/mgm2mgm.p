...
thf(aismgmALT_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_op @ (ccfv @ XM @ ccplusg)) => (cwi @ (cwcel @ XM @ XV) @ (cwb @ (cwcel @ XM @ ccmgm2) @ (cwbr @ Xc_op @ XB2 @ cccllaw)))))))))).
...
thf(amgmplusgiopALT_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccmgm) @ (cwbr @ (ccfv @ XM @ ccplusg) @ (ccfv @ XM @ ccbs) @ cccllaw)))).
thf(cmgm2mgm_conj,conjecture,(! [XM:($i > $o)] : (cwb @ (cwcel @ XM @ ccmgm2) @ (cwcel @ XM @ ccmgm)))).
