...
thf(clnatexN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xq:$i] : (cwceq @ (XB2 @ Xq) @ (ccfv @ (XK @ Xq) @ ccbs))) => ((! [Xq:$i] : (cwceq @ Xc_le @ (ccfv @ (XK @ Xq) @ ccple))) => ((! [Xq:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xq) @ ccatm))) => ((! [Xq:$i] : (cwceq @ (XN @ Xq) @ (ccfv @ (XK @ Xq) @ cclines))) => ((! [Xq:$i] : (cwceq @ (XM @ Xq) @ (ccfv @ (XK @ Xq) @ ccpmap))) => (! [Xq:$i] : (cwi @ (cw3a @ (cwcel @ (XK @ Xq) @ cchlt) @ (cwcel @ XX @ (XB2 @ Xq)) @ (cwcel @ (ccfv @ XX @ (XM @ Xq)) @ (XN @ Xq))) @ (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ (ccv @ Xq) @ XP) @ (cwbr @ (ccv @ Xq) @ XX @ Xc_le))) @ (^ [Xq:$i] : XA2)))))))))))))))))).
