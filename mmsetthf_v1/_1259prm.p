...
thf(a_1259lem4_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => (cwceq @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo))))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(a_1259lem5_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => (cwceq @ (cco @ (cco @ (cco @ cc2 @ (ccdc @ cc3 @ cc4) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) @ cc1)))).
thf(c_1259prm_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => (cwcel @ XN @ ccprime)))).
