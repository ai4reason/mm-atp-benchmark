...
thf(axeqlelt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwn @ (cwbr @ XA2 @ XB2 @ cclt)))))))).
...
thf(acarsgclctunlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XO @ (XV @ Xx3 @ Xy1 @ Xk)))))) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cw3a @ Xph @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwss @ (ccv @ Xx3) @ (ccpw @ XO))) @ (cwbr @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XM) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XM))) @ ccle))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccpw @ XO))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccle)))) => ((cwi @ Xph @ (cwdisj @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (XA2 @ Xk) @ (ccfv @ XM @ cccarsg)))) => ((cwi @ Xph @ (cwcel @ XE @ (ccpw @ XO))) => ((cwi @ Xph @ (cwne @ (ccfv @ XE @ XM) @ ccpnf)) => (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ (ccin @ XE @ (cciun @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk)))) @ XM) @ (ccfv @ (ccdif @ XE @ (cciun @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk)))) @ XM) @ ccxad) @ (ccfv @ XE @ XM) @ ccle)))))))))))))))))).
