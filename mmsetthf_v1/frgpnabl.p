...
thf(afrgpnabllem2_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (ccfv @ XI @ ccfrgp))))))) => ((cwceq @ XW @ (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xw @ Xv @ Xn) @ (ccfv @ XI @ ccefg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (ccfv @ (XG @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ ccplusg)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XM @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (ccmpt @ (^ [Xv:$i] : XW) @ (^ [Xv:$i] : (ccmpt2 @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xv) @ cchash) @ ccfz))) @ (^ [Xn:$i] : (^ [Xw:$i] : (ccxp @ XI @ cc2o))) @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ (XM @ Xy1 @ Xz)))) @ ccsplice)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (ccdif @ XW @ (cciun @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ (ccv @ Xx3) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (ccfv @ XI @ ccvrgp)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (cwcel @ XI @ ccvv))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (cwcel @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ XI))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (cwcel @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ XI))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (cwceq @ (cco @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (ccfv @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (cco @ (ccfv @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (cwceq @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn))))))))))))))))))))))))))))))))).
...
thf(cfrgpnabl_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XG @ (ccfv @ XI @ ccfrgp)) => (cwi @ (cwbr @ cc1o @ XI @ ccsdm) @ (cwn @ (cwcel @ XG @ ccabl))))))).
