...
thf(aspaev_thm,axiom,(! [Xy1:$i] : (! [Xx3:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))))).
...
thf(caevlem0_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xz:$i] : (cwceq @ (ccv @ Xz) @ (ccv @ Xx3)))))))).
