...
thf(afacth1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ XG @ (cco @ XX @ (ccfv @ XN @ XA2) @ Xc_mi)) => ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwi @ Xph @ (cwcel @ XR @ ccnzr)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XN @ XK)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_pa @ (ccfv @ XP @ ccdsr)) => (cwi @ Xph @ (cwb @ (cwbr @ XG @ XF @ Xc_pa) @ (cwceq @ (ccfv @ XN @ (ccfv @ XF @ XO)) @ Xc_0)))))))))))))))))))))))))))))))).
...
thf(aply1remlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ XG @ (cco @ XX @ (ccfv @ XN @ XA2) @ Xc_mi)) => ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwi @ Xph @ (cwcel @ XR @ ccnzr)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XN @ XK)) => ((cwceq @ XU @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ Xph @ (cw3a @ (cwcel @ XG @ XU) @ (cwceq @ (ccfv @ XG @ XD) @ cc1) @ (cwceq @ (ccima @ (cccnv @ (ccfv @ XG @ XO)) @ (ccsn @ Xc_0)) @ (ccsn @ XN))))))))))))))))))))))))))))))))).
thf(ccui_tp,type,(ccui : ($i > $o))).
thf(amon1puc1p_thm,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => ((cwceq @ XM @ (ccfv @ XR @ ccmn1)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XM)) @ (cwcel @ XX @ XC))))))))).
thf(ccmnf_tp,type,(ccmnf : ($i > $o))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(advdsq1p_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_pa @ (ccfv @ XP @ ccdsr)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwceq @ XQ @ (ccfv @ XR @ ccq1p)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) @ (cwb @ (cwbr @ XG @ XF @ Xc_pa) @ (cwceq @ XF @ (cco @ (cco @ XF @ XG @ XQ) @ XG @ Xc_x)))))))))))))))))))).
thf(aq1pcl_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XQ @ (ccfv @ XR @ ccq1p)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) @ (cwcel @ (cco @ XF @ XG @ XQ) @ XB2)))))))))))))).
...
thf(adomneq0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdomn) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwceq @ (cco @ XX @ XY @ Xc_x) @ Xc_0) @ (cwo @ (cwceq @ XX @ Xc_0) @ (cwceq @ XY @ Xc_0)))))))))))))).
...
thf(afta1glem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XW @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwi @ Xph @ (cwcel @ XR @ ccidom)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ XG @ (cco @ XX @ (ccfv @ XT @ XA2) @ Xc_mi)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ XD) @ (cco @ XN @ cc1 @ ccaddc))) => ((cwi @ Xph @ (cwcel @ XT @ (ccima @ (cccnv @ (ccfv @ XF @ XO)) @ (ccsn @ XW)))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccfv @ XR @ ccq1p)) @ XD) @ XN))))))))))))))))))))))))))))))))))).
...
thf(ahashun2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccle))))).
...
thf(cfta1glem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XW @ (ccfv @ XR @ cc0g)) => ((! [Xg1:$i] : (cwceq @ (Xc_0 @ Xg1) @ (ccfv @ XP @ cc0g))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XR @ ccidom))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XF @ XB2))) => ((! [Xg1:$i] : (cwceq @ (XK @ Xg1) @ (ccfv @ XR @ ccbs))) => ((! [Xg1:$i] : (cwceq @ (XX @ Xg1) @ (ccfv @ XR @ ccv1))) => ((! [Xg1:$i] : (cwceq @ (Xc_mi @ Xg1) @ (ccfv @ XP @ ccsg))) => ((! [Xg1:$i] : (cwceq @ (XA2 @ Xg1) @ (ccfv @ XP @ ccascl))) => ((! [Xg1:$i] : (cwceq @ XG @ (cco @ (XX @ Xg1) @ (ccfv @ (XT @ Xg1) @ (XA2 @ Xg1)) @ (Xc_mi @ Xg1)))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XN @ ccn0))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwceq @ (ccfv @ XF @ XD) @ (cco @ XN @ cc1 @ ccaddc)))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ (XT @ Xg1) @ (ccima @ (cccnv @ (ccfv @ XF @ XO)) @ (ccsn @ XW))))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwral @ (^ [Xg1:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xg1) @ XD) @ XN) @ (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xg1) @ XO)) @ (ccsn @ XW)) @ cchash) @ (ccfv @ (ccv @ Xg1) @ XD) @ ccle))) @ (^ [Xg1:$i] : XB2)))) => (! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccfv @ XF @ XO)) @ (ccsn @ XW)) @ cchash) @ (ccfv @ XF @ XD) @ ccle))))))))))))))))))))))))))))))))))))).
