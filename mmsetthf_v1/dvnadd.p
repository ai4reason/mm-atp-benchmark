...
thf(apmss12g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XD)) @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XD @ XW))) @ (cwss @ (cco @ XA2 @ XB2 @ ccpm) @ (cco @ XC @ XD @ ccpm)))))))))).
...
thf(cdvnadd_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0))) @ (cwceq @ (ccfv @ XN @ (cco @ XS @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)) @ ccdvn)) @ (ccfv @ (cco @ XM @ XN @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))))))).
