...
thf(adf_drng_ax,axiom,(cwceq @ ccdr @ (ccrab @ (^ [Xr:$i] : (cwceq @ (ccfv @ (ccv @ Xr) @ ccui) @ (ccdif @ (ccfv @ (ccv @ Xr) @ ccbs) @ (ccsn @ (ccfv @ (ccv @ Xr) @ cc0g))))) @ (^ [Xr:$i] : ccrg)))).
thf(cisdrng_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwb @ (cwcel @ XR @ ccdr) @ (cwa @ (cwcel @ XR @ ccrg) @ (cwceq @ XU @ (ccdif @ XB2 @ (ccsn @ Xc_0))))))))))))).
