...
thf(abpos1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwbr @ XN @ (ccdc @ cc6 @ cc4) @ ccle)) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ XN @ (ccv @ Xp) @ cclt) @ (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime))))).
thf(apm2_18da_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwi @ (cwa @ Xph @ (cwn @ Xps)) @ Xps) => (cwi @ Xph @ Xps))))).
...
thf(abposlem9_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xx3 @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (ccfv @ cc2 @ ccsqrt) @ (ccfv @ (ccfv @ (ccv @ Xn) @ ccsqrt) @ (XG @ Xx3 @ Xp)) @ ccmul) @ (cco @ (cco @ cc9 @ cc4 @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ (XG @ Xx3 @ Xp)) @ ccmul) @ ccaddc) @ (cco @ (ccfv @ cc2 @ cclog) @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ ccdiv) @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XG @ Xx3 @ Xp) @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ (ccv @ Xx3) @ ccdiv)))))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xp) @ (cwcel @ XN @ ccn)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xp) @ (cwbr @ (ccdc @ cc6 @ cc4) @ XN @ cclt)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xp) @ (cwn @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ XN @ (ccv @ Xp) @ cclt) @ (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))))) => (! [Xx3:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xp) @ (Xps @ Xx3 @ Xn @ Xp)))))))))))))))).
...
thf(cbpos_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ XN @ (ccv @ Xp) @ cclt) @ (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime))))).
