...
thf(cinfunsdom1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XX @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XX @ ccdom)) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ XB2 @ XX @ ccsdm))) @ (cwbr @ (ccun @ XA2 @ XB2) @ XX @ ccsdm)))))).
