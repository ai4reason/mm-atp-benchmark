...
thf(cply1scltm_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XK)) @ (cwceq @ (ccfv @ XF @ XA2) @ (cco @ XF @ (cco @ ccc0 @ XX @ Xc_ex) @ Xc_x)))))))))))))))))))).
