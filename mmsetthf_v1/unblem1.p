...
thf(cunblem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XB2 @ ccom) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccom))) @ (cwcel @ XA2 @ XB2)) @ (cwcel @ (ccint @ (ccdif @ XB2 @ (ccsuc @ XA2))) @ XB2))))).
