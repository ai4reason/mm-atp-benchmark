...
thf(ametustsym_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XA2 @ XF)) @ (cwceq @ (cccnv @ XA2) @ XA2)))))))).
...
thf(ametustexhalf_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (cwi @ (cwa @ (cwa @ (cwne @ XX @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) @ (cwcel @ XA2 @ XF)) @ (cwrex @ (^ [Xv:$i] : (cwss @ (cccom @ (ccv @ Xv) @ (ccv @ Xv)) @ XA2)) @ (^ [Xv:$i] : XF))))))))).
...
thf(cmetust_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (cwi @ (cwa @ (cwne @ XX @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) @ (cwcel @ (cco @ (ccxp @ XX @ XX) @ XF @ ccfg) @ (ccfv @ XX @ ccust)))))))).
