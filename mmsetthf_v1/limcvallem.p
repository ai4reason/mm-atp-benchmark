...
thf(climcvallem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((! [Xz:$i] : (cwceq @ (XG @ Xz) @ (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ (cwceq @ (ccv @ Xz) @ XB2) @ XC @ (ccfv @ (ccv @ Xz) @ XF)))))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwi @ (cwcel @ (XG @ Xz) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ XK @ cccnp))) @ (cwcel @ XC @ ccc))))))))))))))).
