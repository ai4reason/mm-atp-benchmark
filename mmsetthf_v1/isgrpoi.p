...
thf(cisgrpoi_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwf @ (ccxp @ XX @ XX) @ XX @ XG) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX)) @ (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG)))))) => ((cwcel @ XU @ XX) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwceq @ (cco @ XU @ (ccv @ Xx3) @ XG) @ (ccv @ Xx3)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (XN @ Xx3 @ Xz) @ XX)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwceq @ (cco @ (XN @ Xx3 @ Xz) @ (ccv @ Xx3) @ XG) @ XU)))) => (cwcel @ XG @ ccgr))))))))))))).
