...
thf(cfressnfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ XA2)) @ (cwb @ (cwf @ (ccsn @ XB2) @ XC @ (ccres @ XF @ (ccsn @ XB2))) @ (cwcel @ (ccfv @ XB2 @ XF) @ XC)))))))).
