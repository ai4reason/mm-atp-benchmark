...
thf(ccoe1f2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ ccco1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccps1)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => (cwi @ (cwcel @ XF @ XB2) @ (cwf @ ccn0 @ XK @ XA2))))))))))))).
