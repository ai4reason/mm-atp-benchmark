...
thf(aelnnnn0_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XN @ ccc) @ (cwcel @ (cco @ XN @ cc1 @ ccmin) @ ccn0))))).
...
thf(cfacnn2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccfa) @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa) @ XN @ ccmul))))).
