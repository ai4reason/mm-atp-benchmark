...
thf(arngorn1_thm,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwceq @ (ccrn @ XG) @ (ccdm @ (ccdm @ XH)))))))))).
...
thf(axpid11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwceq @ (ccxp @ XA2 @ XA2) @ (ccxp @ XB2 @ XB2)) @ (cwceq @ XA2 @ XB2))))).
...
thf(aismndo1_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ (ccdm @ XG))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XG @ (XA2 @ Xx3 @ Xy1 @ Xz)) @ (cwb @ (cwcel @ XG @ ccmndo) @ (cw3a @ (cwf @ (ccxp @ XX @ XX) @ XX @ XG) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xy1)) @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))))).
thf(crngomndo_conj,conjecture,(! [XR:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwcel @ XH @ ccmndo)))))).
