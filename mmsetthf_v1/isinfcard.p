...
thf(acardalephex_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ ccom @ XA2) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccale))) @ (^ [Xx3:$i] : ccon0)))))).
thf(cisinfcard_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwa @ (cwss @ ccom @ XA2) @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2)) @ (cwcel @ XA2 @ (ccrn @ ccale))))).
