...
thf(asincosq3sgn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccpi @ (cco @ cc3 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccioo)) @ (cwa @ (cwbr @ (ccfv @ XA2 @ ccsin) @ ccc0 @ cclt) @ (cwbr @ (ccfv @ XA2 @ cccos) @ ccc0 @ cclt))))).
...
thf(csincosq4sgn_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (cco @ cc3 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ (cco @ cc2 @ ccpi @ ccmul) @ ccioo)) @ (cwa @ (cwbr @ (ccfv @ XA2 @ ccsin) @ ccc0 @ cclt) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ cccos) @ cclt))))).
