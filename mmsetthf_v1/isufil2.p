...
thf(aisufil_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwral @ (^ [Xx3:$i] : (cwo @ (cwcel @ (ccv @ Xx3) @ XF) @ (cwcel @ (ccdif @ XX @ (ccv @ Xx3)) @ XF))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
thf(cisufil2_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwss @ XF @ (ccv @ Xf1)) @ (cwceq @ XF @ (ccv @ Xf1)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))).
