...
thf(cclsslem_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwss @ XR @ XS) @ (cwss @ (ccint @ (ccab @ (^ [Xr:$i] : (cwa @ (cwss @ XR @ (ccv @ Xr)) @ (Xph @ Xr))))) @ (ccint @ (ccab @ (^ [Xr:$i] : (cwa @ (cwss @ XS @ (ccv @ Xr)) @ (Xph @ Xr))))))))))).
