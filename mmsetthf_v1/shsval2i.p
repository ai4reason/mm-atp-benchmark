...
thf(ashslubi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => (cwb @ (cwa @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XC)) @ (cwss @ (cco @ XA2 @ XB2 @ ccph) @ XC))))))))).
...
thf(ashintcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccsh) @ (cwne @ XA2 @ cc0)) @ (cwcel @ (ccint @ XA2) @ ccsh)))).
...
thf(cshsval2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwceq @ (cco @ XA2 @ XB2 @ ccph) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccun @ XA2 @ XB2) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : ccsh))))))))).
