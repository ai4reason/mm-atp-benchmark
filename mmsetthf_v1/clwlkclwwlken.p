...
thf(cclwlkclwwlken_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccuspgr) @ (cwbr @ (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ (ccfv @ XG @ ccclwwlk) @ ccen)))).
