...
thf(acvp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
...
thf(acvpss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwpss @ XA2 @ XB2)))))).
...
thf(achcv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj)) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
thf(acvnbtwn2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwi @ (cwa @ (cwpss @ XA2 @ XC) @ (cwss @ XC @ XB2)) @ (cwceq @ XC @ XB2)))))))).
thf(catexch_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat) @ (cwcel @ XC @ ccat)) @ (cwi @ (cwa @ (cwss @ XB2 @ (cco @ XA2 @ XC @ cchj)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)) @ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
