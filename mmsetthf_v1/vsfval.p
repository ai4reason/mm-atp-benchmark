...
thf(adf_vs_ax,axiom,(cwceq @ ccnsb @ (cccom @ ccgs @ ccpv))).
...
thf(cvsfval_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => (cwceq @ XM @ (ccfv @ XG @ ccgs)))))))).
