...
thf(agrusn_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ ccgru) @ (cwcel @ XA2 @ XU)) @ (cwcel @ (ccsn @ XA2) @ XU))))).
...
thf(cgruop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ ccgru) @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XU)) @ (cwcel @ (ccop @ XA2 @ XB2) @ XU)))))).
