...
thf(cscott0s_conj,conjecture,(! [Xph:($i > $o)] : (cwb @ (cwex @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwne @ (ccab @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1)) @ (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk)))))))) @ cc0)))).
