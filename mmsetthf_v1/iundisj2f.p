...
thf(aleltne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwne @ XB2 @ XA2)))))).
...
thf(adisjors_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwb @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwo @ (cwceq @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwceq @ (ccin @ (ccsb @ (ccv @ Xi) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (ccv @ Xj) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ cc0))) @ (^ [Xj:$i] : XA2))) @ (^ [Xi:$i] : XA2)))))).
thf(ciundisj2f_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (cwnfc @ (^ [Xk:$i] : (XA2 @ Xk @ Xn)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xn:$i] : (XB2 @ Xk @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xk)) @ (cwceq @ (XA2 @ Xk @ Xn) @ (XB2 @ Xk @ Xn))))) => (! [Xk:$i] : (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccdif @ (XA2 @ Xk @ Xn) @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfzo)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xn))))))))))))).
