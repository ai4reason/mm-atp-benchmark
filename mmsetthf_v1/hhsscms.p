...
thf(ahhssmet_thm,axiom,(! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwceq @ XD @ (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccsh) => (cwcel @ XD @ (ccfv @ XH @ ccme))))))))).
...
thf(ahhssims2_thm,axiom,(! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwceq @ XD @ (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccsh) => (cwceq @ XD @ (ccres @ (cccom @ ccno @ ccmv) @ (ccxp @ XH @ XH)))))))))).
...
thf(acauss_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwf @ ccn @ XY @ XF)) @ (cwb @ (cwcel @ XF @ (ccfv @ XD @ ccca)) @ (cwcel @ XF @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ ccca))))))))).
...
thf(chhsscms_conj,conjecture,(! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwceq @ XD @ (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccch) => (cwcel @ XD @ (ccfv @ XH @ ccms))))))))).
