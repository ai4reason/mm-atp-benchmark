...
thf(ccantnfs_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XS @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccon0)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ XS) @ (cwa @ (cwf @ XB2 @ XA2 @ XF) @ (cwbr @ XF @ cc0 @ ccfsupp))))))))))))).
