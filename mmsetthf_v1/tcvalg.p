...
thf(atz9_1c_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XA2 @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xx3)))))) @ ccvv)))).
...
thf(adf_tc_ax,axiom,(cwceq @ cctc @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccab @ (^ [Xy1:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwtr @ (ccv @ Xy1)))))))))).
thf(ctcvalg_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwceq @ (ccfv @ XA2 @ cctc) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XA2 @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xx3)))))))))))).
