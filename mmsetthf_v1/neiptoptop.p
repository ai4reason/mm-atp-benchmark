...
thf(aistopg_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwcel @ XJ @ (XA2 @ Xy1)) @ (cwb @ (cwcel @ XJ @ cctop) @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XJ) @ (cwcel @ (ccuni @ (ccv @ Xx3)) @ XJ)))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))))).
thf(cneiptoptop_conj,conjecture,(! [Xph:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xq:$i] : (! [Xb:$i] : (cwceq @ (XJ @ Xq @ Xb) @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xp:$i] : (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))) @ (^ [Xp:$i] : (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ (XX @ Xq))))))) => ((! [Xq:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xq) @ (cwf @ (XX @ Xq) @ (ccpw @ (ccpw @ (XX @ Xq))) @ (XN @ Xq @ Xp))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cw3a @ (cwa @ (Xph @ Xq) @ (cwcel @ (ccv @ Xp) @ (XX @ Xq))) @ (cwss @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwss @ (ccv @ Xb) @ (XX @ Xq))) @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))) @ (cwcel @ (ccv @ Xb) @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))))))) => ((! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xq) @ (cwcel @ (ccv @ Xp) @ (XX @ Xq))) @ (cwss @ (ccfv @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)) @ ccfi) @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xq) @ (cwcel @ (ccv @ Xp) @ (XX @ Xq))) @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))) @ (cwcel @ (ccv @ Xp) @ (ccv @ Xa)))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xq) @ (cwcel @ (ccv @ Xp) @ (XX @ Xq))) @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))) @ (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xq:$i] : (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xq) @ (XN @ Xq @ Xp)))) @ (^ [Xq:$i] : (ccv @ Xb)))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))))))) => ((! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xq) @ (cwcel @ (ccv @ Xp) @ (XX @ Xq))) @ (cwcel @ (XX @ Xq) @ (ccfv @ (ccv @ Xp) @ (XN @ Xq @ Xp)))))) => (! [Xq:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xq) @ (cwcel @ (XJ @ Xq @ Xb) @ cctop)))))))))))))))).
