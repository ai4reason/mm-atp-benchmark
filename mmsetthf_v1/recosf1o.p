...
thf(acosbnd2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ cccos) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc))))).
...
thf(acos11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpi @ ccicc))) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ cccos) @ (ccfv @ XB2 @ cccos))))))).
