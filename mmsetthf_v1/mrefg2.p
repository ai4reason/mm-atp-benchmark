...
thf(amrcssv_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ (ccfv @ XU @ XF) @ XX)))))))).
...
thf(cmrefg2_conj,conjecture,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwb @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XS @ (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn))) @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XS @ (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
