...
thf(afclsfnflim_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ XF @ (ccv @ Xg1)) @ (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccflim)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil)))))))))).
...
thf(cuffclsflim_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwceq @ (cco @ XJ @ XF @ ccfcls) @ (cco @ XJ @ XF @ ccflim))))))).
