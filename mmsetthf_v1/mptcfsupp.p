...
thf(asuppmptcfin_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccfv @ XM @ ccsca))) => ((! [Xx3:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (cwceq @ Xc_1 @ (ccfv @ (XR @ Xx3) @ ccur))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XX) @ Xc_1 @ Xc_0)))) => (cwi @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ XB2)) @ (cwcel @ XX @ XV)) @ (cwcel @ (cco @ XF @ Xc_0 @ ccsupp) @ ccfn)))))))))))))))).
