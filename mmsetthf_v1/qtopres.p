...
thf(adf_qtop_ax,axiom,(cwceq @ ccqtop @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xj:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xj:$i] : (^ [Xf1:$i] : (ccrab @ (^ [Xs1:$i] : (cwcel @ (ccin @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccv @ Xs1)) @ (ccuni @ (ccv @ Xj))) @ (ccv @ Xj))) @ (^ [Xs1:$i] : (ccpw @ (ccima @ (ccv @ Xf1) @ (ccuni @ (ccv @ Xj))))))))))).
thf(cqtopres_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XF @ XV) @ (cwceq @ (cco @ XJ @ XF @ ccqtop) @ (cco @ XJ @ (ccres @ XF @ XX) @ ccqtop))))))))).
