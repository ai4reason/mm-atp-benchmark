...
thf(cmplplusg_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XI @ XR @ ccmpl)) => ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ Xc_pl @ (ccfv @ XY @ ccplusg)) => (cwceq @ Xc_pl @ (ccfv @ XS @ ccplusg))))))))))).
