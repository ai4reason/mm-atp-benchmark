...
thf(apfxlswccat_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)) @ (cwceq @ (cco @ (cco @ XW @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx) @ (ccs1 @ (ccfv @ XW @ cclsw)) @ ccconcat) @ XW))))).
thf(cccats1pfxeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwceq @ (ccfv @ XU @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) @ (cwi @ (cwceq @ XW @ (cco @ XU @ (ccfv @ XW @ cchash) @ ccpfx)) @ (cwceq @ XU @ (cco @ XW @ (ccs1 @ (ccfv @ XU @ cclsw)) @ ccconcat)))))))).
