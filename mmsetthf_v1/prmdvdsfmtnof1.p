...
thf(aprmdvdsfmtnof_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xf1 @ Xp) @ (ccmpt @ (^ [Xf1:$i] : (ccrn @ ccfmtno)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xf1) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt)))))) => (! [Xf1:$i] : (! [Xp:$i] : (cwf @ (ccrn @ ccfmtno) @ ccprime @ (XF @ Xf1 @ Xp))))))).
...
thf(afmtnorn_thm,axiom,(! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ (ccrn @ ccfmtno)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccfv @ (ccv @ Xn) @ ccfmtno) @ XF)) @ (^ [Xn:$i] : ccn0))))).
...
thf(afmtnoge3_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccfv @ XN @ ccfmtno) @ (ccfv @ cc3 @ ccuz))))).
thf(auzuzle23_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ cc3 @ ccuz)) @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz))))).
thf(aeleq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC))))))).
thf(aprmdvdsfmtnof1lem1_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (XI @ Xp) @ (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XF @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt))) => ((! [Xp:$i] : (cwceq @ (XJ @ Xp) @ (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XG @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt))) => (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XG @ (ccfv @ cc2 @ ccuz))) @ (cwi @ (cwceq @ (XI @ Xp) @ (XJ @ Xp)) @ (cw3a @ (cwcel @ (XI @ Xp) @ ccprime) @ (cwbr @ (XI @ Xp) @ XF @ ccdvds) @ (cwbr @ (XI @ Xp) @ XG @ ccdvds)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(ccgcd_tp,type,(ccgcd : ($i > $o))).
thf(aprmdvdsfmtnof1lem2_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccrn @ ccfmtno)) @ (cwcel @ XG @ (ccrn @ ccfmtno))) @ (cwi @ (cw3a @ (cwcel @ XI @ ccprime) @ (cwbr @ XI @ XF @ ccdvds) @ (cwbr @ XI @ XG @ ccdvds)) @ (cwceq @ XF @ XG))))))).
...
thf(cprmdvdsfmtnof1_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xf1 @ Xp) @ (ccmpt @ (^ [Xf1:$i] : (ccrn @ ccfmtno)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xf1) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt)))))) => (! [Xf1:$i] : (! [Xp:$i] : (cwf1 @ (ccrn @ ccfmtno) @ ccprime @ (XF @ Xf1 @ Xp))))))).
