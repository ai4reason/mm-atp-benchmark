...
thf(cmpst123_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => (cwi @ (cwcel @ XX @ XP) @ (cwceq @ XX @ (ccotp @ (ccfv @ (ccfv @ XX @ cc1st) @ cc1st) @ (ccfv @ (ccfv @ XX @ cc1st) @ cc2nd) @ (ccfv @ XX @ cc2nd))))))))).
