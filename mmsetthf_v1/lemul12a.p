...
thf(clemul12a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwa @ (cwcel @ XC @ ccr) @ (cwbr @ ccc0 @ XC @ ccle)) @ (cwcel @ XD @ ccr))) @ (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ XC @ XD @ ccle)) @ (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ ccle)))))))).
