...
thf(cisghm_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XS @ ccbs)) => ((cwceq @ XY @ (ccfv @ XT @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XS @ ccplusg)) => ((cwceq @ Xc_pd @ (ccfv @ XT @ ccplusg)) => (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwa @ (cwa @ (cwcel @ XS @ ccgrp) @ (cwcel @ XT @ ccgrp)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ Xc_pl) @ XF) @ (cco @ (ccfv @ (ccv @ Xu) @ XF) @ (ccfv @ (ccv @ Xv) @ XF) @ Xc_pd))) @ (^ [Xv:$i] : XX))) @ (^ [Xu:$i] : XX))))))))))))))))).
