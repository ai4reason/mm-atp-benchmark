...
thf(adf_bj_inftyexpi_ax,axiom,(cwceq @ ccinftyexpi @ (ccmpt @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) @ (^ [Xx3:$i] : (ccop @ (ccv @ Xx3) @ ccc))))).
...
thf(adf_bj_minfty_ax,axiom,(cwceq @ ccminfty @ (ccfv @ ccpi @ ccinftyexpi))).
thf(adf_bj_ccinfty_ax,axiom,(cwceq @ ccccinfty @ (ccrn @ ccinftyexpi))).
