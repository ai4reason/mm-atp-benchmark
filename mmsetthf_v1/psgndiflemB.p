...
thf(agsmtrcl_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XN @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XN @ ccpmtr))) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XW @ (ccword @ XT))) @ (cwcel @ (cco @ XS @ XW @ ccgsu) @ XB2))))))))))).
...
thf(asswrd_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwss @ XS @ XT) @ (cwss @ (ccword @ XS) @ (ccword @ XT)))))).
...
thf(agsmsymgrfix_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccfv @ XN @ ccsymg))) => ((! [Xi:$i] : (cwceq @ XB2 @ (ccfv @ (XS @ Xi) @ ccbs))) => (! [Xi:$i] : (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XK @ XN) @ (cwcel @ XW @ (ccword @ XB2))) @ (cwi @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ XK @ (ccfv @ (ccv @ Xi) @ XW)) @ XK)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ XK @ (cco @ (XS @ Xi) @ XW @ ccgsu)) @ XK)))))))))))).
...
thf(cpsgndiflemB_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : (cwceq @ (XP @ Xi @ Xn) @ (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : (cwceq @ (XT @ Xi @ Xn @ Xq) @ (ccrn @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpmtr)))))) => ((! [Xq:$i] : (cwceq @ (XS @ Xq) @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccsymg))) => ((! [Xq:$i] : (cwceq @ (XZ @ Xq) @ (ccfv @ (XN @ Xq) @ ccsymg))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : (cwceq @ (XR @ Xi @ Xn @ Xq) @ (ccrn @ (ccfv @ (XN @ Xq) @ ccpmtr)))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (XN @ Xq) @ ccfn) @ (cwcel @ XK @ (XN @ Xq))) @ (cwcel @ (XQ @ Xi @ Xn) @ (ccrab @ (^ [Xq:$i] : (cwceq @ (ccfv @ XK @ (ccv @ Xq)) @ XK)) @ (^ [Xq:$i] : (XP @ Xi @ Xn))))) @ (cwi @ (cwa @ (cwcel @ (XW @ Xq) @ (ccword @ (XT @ Xi @ Xn @ Xq))) @ (cwceq @ (ccres @ (XQ @ Xi @ Xn) @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) @ (cco @ (XS @ Xq) @ (XW @ Xq) @ ccgsu))) @ (cwi @ (cw3a @ (cwcel @ (XU @ Xq) @ (ccword @ (XR @ Xi @ Xn @ Xq))) @ (cwceq @ (ccfv @ (XW @ Xq) @ cchash) @ (ccfv @ (XU @ Xq) @ cchash)) @ (cwral @ (^ [Xi:$i] : (cwa @ (cwceq @ (ccfv @ XK @ (ccfv @ (ccv @ Xi) @ (XU @ Xq))) @ XK) @ (cwral @ (^ [Xn:$i] : (cwceq @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xi) @ (XW @ Xq))) @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xi) @ (XU @ Xq))))) @ (^ [Xn:$i] : (ccdif @ (XN @ Xq) @ (ccsn @ XK)))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ (XW @ Xq) @ cchash) @ ccfzo)))) @ (cwceq @ (XQ @ Xi @ Xn) @ (cco @ (XZ @ Xq) @ (XU @ Xq) @ ccgsu)))))))))))))))))))))))).
