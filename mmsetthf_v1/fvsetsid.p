...
thf(cfvsetsid_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ XV) @ (cwcel @ XX @ XW) @ (cwcel @ XY @ XU)) @ (cwceq @ (ccfv @ XX @ (cco @ XF @ (ccop @ XX @ XY) @ ccsts)) @ XY))))))))).
