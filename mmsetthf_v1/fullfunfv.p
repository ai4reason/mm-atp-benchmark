...
thf(afunpartfv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ (ccfunpart @ XF)) @ (ccfv @ XA2 @ XF))))).
thf(afvprc_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0))))).
thf(cfullfunfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ (ccfullfn @ XF)) @ (ccfv @ XA2 @ XF))))).
