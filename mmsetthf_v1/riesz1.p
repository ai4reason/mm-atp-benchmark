...
thf(ariesz3i_thm,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ XT) @ (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil)))))).
...
thf(criesz1_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ cclf) @ (cwb @ (cwcel @ (ccfv @ XT @ ccnmf) @ ccr) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XT) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xy1:$i] : cchil)))))).
