...
thf(anbusgredgeu_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XM @ (cco @ XG @ XN @ ccnbgr))) @ (cwreu @ (^ [Xe:$i] : (cwceq @ (ccv @ Xe) @ (ccpr @ XM @ XN))) @ (^ [Xe:$i] : XE))))))))).
...
thf(cnbusgredgeu0_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : (cwceq @ (XV @ Xe) @ (ccfv @ (XG @ Xe) @ ccvtx))) => ((! [Xe:$i] : (cwceq @ XE @ (ccfv @ (XG @ Xe) @ ccedg))) => ((! [Xe:$i] : (cwceq @ (XN @ Xe) @ (cco @ (XG @ Xe) @ XU @ ccnbgr))) => ((! [Xe:$i] : (! [Xi:$i] : (cwceq @ (XI @ Xe @ Xi) @ (ccrab @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))) => (! [Xe:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (XG @ Xe) @ ccusgr) @ (cwcel @ XU @ (XV @ Xe))) @ (cwcel @ (XM @ Xe) @ (XN @ Xe))) @ (cwreu @ (^ [Xi:$i] : (cwceq @ (ccv @ Xi) @ (ccpr @ XU @ (XM @ Xe)))) @ (^ [Xi:$i] : (XI @ Xe @ Xi))))))))))))))))).
