...
thf(csumspansn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwcel @ (cco @ XA2 @ XB2 @ ccva) @ (ccfv @ (ccsn @ XA2) @ ccspn)) @ (cwcel @ XB2 @ (ccfv @ (ccsn @ XA2) @ ccspn))))))).
