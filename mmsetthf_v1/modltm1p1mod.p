...
thf(cmodltm1p1mod_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccrp) @ (cwbr @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XM @ cc1 @ ccmin) @ cclt)) @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ XM @ ccmo) @ cc1 @ ccaddc)))))).
