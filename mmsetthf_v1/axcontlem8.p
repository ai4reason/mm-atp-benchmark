...
thf(ar19_26_3_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwb @ (cwral @ (^ [Xx3:$i] : (cw3a @ (Xph @ Xx3) @ (Xps @ Xx3) @ (Xch @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cw3a @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))).
...
thf(caxcontlem8_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xi:$i] : (cwceq @ (XD @ Xi) @ (ccrab @ (^ [Xp:$i] : (cwo @ (cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) @ (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XF @ Xx3) @ (ccopab @ (^ [Xx3:$i] : (^ [Xt:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (XD @ Xi)) @ (cwa @ (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ ccpnf @ ccico)) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) @ (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))))))))) => (! [Xx3:$i] : (! [Xi:$i] : (cwi @ (cwa @ (cwa @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XZ @ (ccfv @ XN @ ccee)) @ (cwcel @ XU @ (ccfv @ XN @ ccee))) @ (cwne @ XZ @ XU)) @ (cw3a @ (cwcel @ XP @ (XD @ Xi)) @ (cwcel @ XQ @ (XD @ Xi)) @ (cwcel @ XR @ (XD @ Xi)))) @ (cwi @ (cwa @ (cwbr @ (ccfv @ XP @ (XF @ Xx3)) @ (ccfv @ XQ @ (XF @ Xx3)) @ ccle) @ (cwbr @ (ccfv @ XQ @ (XF @ Xx3)) @ (ccfv @ XR @ (XF @ Xx3)) @ ccle)) @ (cwbr @ XQ @ (ccop @ XP @ XR) @ ccbtwn)))))))))))))))).
