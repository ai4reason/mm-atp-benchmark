...
thf(cssenen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwbr @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwbr @ (ccv @ Xx3) @ XC @ ccen)))) @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwbr @ (ccv @ Xx3) @ XC @ ccen)))) @ ccen)))))).
