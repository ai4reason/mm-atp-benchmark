...
thf(cclwwlknlbonbgr1_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn))) @ (cwcel @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ XW) @ (cco @ XG @ (ccfv @ ccc0 @ XW) @ ccnbgr))))))).
