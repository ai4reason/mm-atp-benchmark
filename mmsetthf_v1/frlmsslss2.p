...
thf(afrlmsslss_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XU @ (ccfv @ XY @ cclss)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccres @ (ccv @ Xx3) @ XJ) @ (ccxp @ XJ @ (ccsn @ Xc_0)))) @ (^ [Xx3:$i] : XB2)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XV) @ (cwss @ XJ @ XI)) @ (cwcel @ (XC @ Xx3) @ XU)))))))))))))))))).
