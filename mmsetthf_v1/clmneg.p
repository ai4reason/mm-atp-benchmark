...
thf(cclmneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ ccclm) @ (cwcel @ XA2 @ XK)) @ (cwceq @ (ccneg @ XA2) @ (ccfv @ XA2 @ (ccfv @ XF @ ccminusg))))))))))).
