...
thf(adfrn4_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccrn @ XA2) @ (ccima @ XA2 @ ccvv)))).
...
thf(afnrndomg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwi @ (cwfn @ XF @ XA2) @ (cwbr @ (ccrn @ XF) @ XA2 @ ccdom))))))).
...
thf(afunimacnv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwceq @ (ccima @ XF @ (ccima @ (cccnv @ XF) @ XA2)) @ (ccin @ XA2 @ (ccrn @ XF))))))).
...
thf(cffsrn_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XZ @ XW)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwfun @ XF)) => ((cwi @ Xph @ (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn)) => (cwi @ Xph @ (cwcel @ (ccrn @ XF) @ ccfn)))))))))))).
