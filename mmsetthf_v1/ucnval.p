...
thf(adf_ucn_ax,axiom,(cwceq @ ccucn @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccuni @ (ccrn @ ccust)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccuni @ (ccrn @ ccust)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (ccdm @ (ccuni @ (ccv @ Xu)))))) @ (^ [Xx3:$i] : (ccdm @ (ccuni @ (ccv @ Xu)))))) @ (^ [Xr:$i] : (ccv @ Xu)))) @ (^ [Xs1:$i] : (ccv @ Xv)))) @ (^ [Xf1:$i] : (cco @ (ccdm @ (ccuni @ (ccv @ Xv))) @ (ccdm @ (ccuni @ (ccv @ Xu))) @ ccmap)))))))).
...
thf(cucnval_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ (XV @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccust))) @ (cwceq @ (cco @ XU @ (XV @ Xy1) @ ccucn) @ (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) @ (^ [Xr:$i] : XU))) @ (^ [Xs1:$i] : (XV @ Xy1)))) @ (^ [Xf1:$i] : (cco @ (XY @ Xy1) @ XX @ ccmap))))))))))).
