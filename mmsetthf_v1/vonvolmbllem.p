...
thf(assmapsn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xf1:$i] : (XD @ Xf1))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xf1)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwss @ XC @ (cco @ (XB2 @ Xf1) @ (ccsn @ XA2) @ ccmap)))) => ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (cciun @ (^ [Xf1:$i] : XC) @ (^ [Xf1:$i] : (ccrn @ (ccv @ Xf1)))))) => (! [Xf1:$i] : (cwi @ Xph @ (cwceq @ XC @ (cco @ (XD @ Xf1) @ (ccsn @ XA2) @ ccmap))))))))))))))).
