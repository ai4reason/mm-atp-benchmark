...
thf(apcneg_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccq)) @ (cwceq @ (cco @ XP @ (ccneg @ XA2) @ ccpc) @ (cco @ XP @ XA2 @ ccpc)))))).
...
thf(cpcadd2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccq)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccq)) => ((cwi @ Xph @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ cclt)) => (cwi @ Xph @ (cwceq @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc)))))))))))).
