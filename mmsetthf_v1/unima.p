...
thf(cunima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwss @ XB2 @ XA2) @ (cwss @ XC @ XA2)) @ (cwceq @ (ccima @ XF @ (ccun @ XB2 @ XC)) @ (ccun @ (ccima @ XF @ XB2) @ (ccima @ XF @ XC))))))))).
