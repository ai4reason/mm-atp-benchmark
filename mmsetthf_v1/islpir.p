...
thf(adf_lpir_ax,axiom,(cwceq @ cclpir @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cclidl) @ (ccfv @ (ccv @ Xw) @ cclpidl))) @ (^ [Xw:$i] : ccrg)))).
thf(cislpir_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ cclpidl)) => ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => (cwb @ (cwcel @ XR @ cclpir) @ (cwa @ (cwcel @ XR @ ccrg) @ (cwceq @ XU @ XP))))))))).
