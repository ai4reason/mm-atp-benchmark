...
thf(cevl1val_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XO @ Xy1) @ (ccfv @ (XR @ Xy1) @ cce1))) => ((! [Xy1:$i] : (cwceq @ (XQ @ Xy1) @ (cco @ cc1o @ (XR @ Xy1) @ ccevl))) => ((! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XR @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (cwceq @ (XM @ Xy1) @ (cco @ cc1o @ (XR @ Xy1) @ ccmpl))) => ((! [Xy1:$i] : (cwceq @ (XK @ Xy1) @ (ccfv @ (XM @ Xy1) @ ccbs))) => (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (XR @ Xy1) @ cccrg) @ (cwcel @ (XA2 @ Xy1) @ (XK @ Xy1))) @ (cwceq @ (ccfv @ (XA2 @ Xy1) @ (XO @ Xy1)) @ (cccom @ (ccfv @ (XA2 @ Xy1) @ (XQ @ Xy1)) @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1)))))))))))))))))))))).
