...
thf(a_2sqlem6_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => ((! [Xw:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XA2 @ Xw @ Xp) @ ccn)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XB2 @ Xw) @ ccn))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwral @ (^ [Xp:$i] : (cwi @ (cwbr @ (ccv @ Xp) @ (XB2 @ Xw) @ ccdvds) @ (cwcel @ (ccv @ Xp) @ (XS @ Xw)))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xw:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (cco @ (XA2 @ Xw @ Xp) @ (XB2 @ Xw) @ ccmul) @ (XS @ Xw))))) => (! [Xw:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XA2 @ Xw @ Xp) @ (XS @ Xw))))))))))))))).
...
thf(a_4sqlem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (cwi @ Xph @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XM @ ccdiv) @ ccz))))))))))).
thf(azsqcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccz)))).
thf(a_4sqlem8_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (cwi @ Xph @ (cwbr @ XM @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin) @ ccdvds)))))))))).
...
thf(a_2sqlem8a_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => ((! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XY @ Xz @ Xw) @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccgcd) @ cc1) @ (cwceq @ (ccv @ Xz) @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc)))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xa:$i] : (cwi @ (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ ccdvds) @ (cwcel @ (ccv @ Xb) @ (XS @ Xw)))) @ (^ [Xa:$i] : (XY @ Xz @ Xw)))) @ (^ [Xb:$i] : (cco @ cc1 @ (cco @ (XM @ Xw) @ cc1 @ ccmin) @ ccfz)))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwbr @ (XM @ Xw) @ (XN @ Xw @ Xa @ Xb) @ ccdvds)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwcel @ (XN @ Xw @ Xa @ Xb) @ ccn)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwcel @ (XM @ Xw) @ (ccfv @ cc2 @ ccuz))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwcel @ (XA2 @ Xw @ Xb) @ ccz)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwcel @ (XB2 @ Xz @ Xw) @ ccz)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwceq @ (cco @ (XA2 @ Xw @ Xb) @ (XB2 @ Xz @ Xw) @ ccgcd) @ cc1)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwceq @ (XN @ Xw @ Xa @ Xb) @ (cco @ (cco @ (XA2 @ Xw @ Xb) @ cc2 @ ccexp) @ (cco @ (XB2 @ Xz @ Xw) @ cc2 @ ccexp) @ ccaddc))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XC @ Xy1 @ Xz @ Xw @ Xa @ Xb) @ (cco @ (cco @ (cco @ (XA2 @ Xw @ Xb) @ (cco @ (XM @ Xw) @ cc2 @ ccdiv) @ ccaddc) @ (XM @ Xw) @ ccmo) @ (cco @ (XM @ Xw) @ cc2 @ ccdiv) @ ccmin))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XD @ Xy1 @ Xz @ Xw @ Xa @ Xb) @ (cco @ (cco @ (cco @ (XB2 @ Xz @ Xw) @ (cco @ (XM @ Xw) @ cc2 @ ccdiv) @ ccaddc) @ (XM @ Xw) @ ccmo) @ (cco @ (XM @ Xw) @ cc2 @ ccdiv) @ ccmin))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz @ Xw @ Xa @ Xb) @ (cwcel @ (cco @ (XC @ Xy1 @ Xz @ Xw @ Xa @ Xb) @ (XD @ Xy1 @ Xz @ Xw @ Xa @ Xb) @ ccgcd) @ ccn))))))))))))))))))))))))))))).
thf(azsqcl2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccn0)))).
...
thf(annle1eq1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwb @ (cwbr @ XA2 @ cc1 @ ccle) @ (cwceq @ XA2 @ cc1))))).
thf(a_2nn_thm,axiom,(cwcel @ cc2 @ ccn)).
thf(arplpwr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XN @ ccn)) @ (cwi @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwceq @ (cco @ (cco @ XA2 @ XN @ ccexp) @ XB2 @ ccgcd) @ cc1))))))).
...
thf(a_4sqlem7_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (cwi @ Xph @ (cwbr @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ ccle)))))))))).
