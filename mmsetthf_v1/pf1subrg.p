...
thf(arhmima_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XM @ XN @ ccrh)) @ (cwcel @ XX @ (ccfv @ XM @ ccsubrg))) @ (cwcel @ (ccima @ XF @ XX) @ (ccfv @ XN @ ccsubrg)))))))).
thf(cpf1subrg_conj,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XQ @ (ccrn @ (ccfv @ XR @ cce1))) => (cwi @ (cwcel @ XR @ cccrg) @ (cwcel @ XQ @ (ccfv @ (cco @ XR @ XB2 @ ccpws) @ ccsubrg))))))))).
