...
thf(abnj941_thm,axiom,(! [XC:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xp:$i] : ((! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xf1 @ Xn) @ (ccun @ (ccv @ Xf1) @ (ccsn @ (ccop @ (ccv @ Xn) @ (XC @ Xf1 @ Xn))))))) => (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (cwcel @ (XC @ Xf1 @ Xn) @ ccvv) @ (cwi @ (cwa @ (cwceq @ (ccv @ Xp) @ (ccsuc @ (ccv @ Xn))) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn))) @ (cwfn @ (XG @ Xf1 @ Xn) @ (ccv @ Xp))))))))))).
...
thf(cbnj945_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xp:$i] : ((! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xf1 @ Xn) @ (ccun @ (ccv @ Xf1) @ (ccsn @ (ccop @ (ccv @ Xn) @ (XC @ Xf1 @ Xn))))))) => (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (cw_bnj17 @ (cwcel @ (XC @ Xf1 @ Xn) @ ccvv) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (cwceq @ (ccv @ Xp) @ (ccsuc @ (ccv @ Xn))) @ (cwcel @ (XA2 @ Xf1 @ Xn) @ (ccv @ Xn))) @ (cwceq @ (ccfv @ (XA2 @ Xf1 @ Xn) @ (XG @ Xf1 @ Xn)) @ (ccfv @ (XA2 @ Xf1 @ Xn) @ (ccv @ Xf1)))))))))))).
