...
thf(csumsnf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XM) @ (cwceq @ (XA2 @ Xk) @ (XB2 @ Xk)))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XM @ XV) @ (cwcel @ (XB2 @ Xk) @ ccc)) @ (cwceq @ (ccsu @ (ccsn @ XM) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (XB2 @ Xk))))))))))).
