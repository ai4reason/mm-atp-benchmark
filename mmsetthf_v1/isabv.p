...
thf(aabvfval_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1 @ Xf1) @ (ccfv @ XR @ ccabv))))) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1) @ (ccfv @ XR @ ccplusg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_x @ Xx3 @ Xy1) @ (ccfv @ XR @ ccmulr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1) @ (ccfv @ XR @ cc0g)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ (XA2 @ Xx3 @ Xy1 @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwa @ (cwb @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ ccc0) @ (cwceq @ (ccv @ Xx3) @ (Xc_0 @ Xx3 @ Xy1))) @ (cwral @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) @ (ccv @ Xf1)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ ccmul)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1)) @ (ccv @ Xf1)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ ccaddc) @ ccle))) @ (^ [Xy1:$i] : XB2)))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xf1:$i] : (cco @ (cco @ ccc0 @ ccpnf @ ccico) @ XB2 @ ccmap)))))))))))))))))))).
...
thf(cisabv_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1) @ (ccfv @ XR @ ccabv)))) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1) @ (ccfv @ XR @ ccplusg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_x @ Xx3 @ Xy1) @ (ccfv @ XR @ ccmulr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1) @ (ccfv @ XR @ cc0g)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XR @ ccrg) @ (cwb @ (cwcel @ XF @ (XA2 @ Xx3 @ Xy1)) @ (cwa @ (cwf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico) @ XF) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwb @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0) @ (cwceq @ (ccv @ Xx3) @ (Xc_0 @ Xx3 @ Xy1))) @ (cwral @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) @ XF) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccmul)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1)) @ XF) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccaddc) @ ccle))) @ (^ [Xy1:$i] : XB2)))) @ (^ [Xx3:$i] : XB2)))))))))))))))))))).
