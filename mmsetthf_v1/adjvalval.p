...
thf(cadjvalval_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ (ccdm @ ccado)) @ (cwcel @ XA2 @ cchil)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XT @ ccado)) @ (ccrio @ (^ [Xw:$i] : (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ XA2 @ ccsp) @ (cco @ (ccv @ Xx3) @ (ccv @ Xw) @ ccsp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xw:$i] : cchil))))))).
