...
thf(aexpcnfg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3) @ (cco @ XA2 @ ccc @ cccncf)))) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ XN @ ccexp))) @ (cco @ XA2 @ ccc @ cccncf))))))))))).
...
thf(aitgsinexplem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ XN @ ccexp))))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccv @ Xx3) @ cccos)))))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ XN @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccos) @ ccmul))))) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ XN @ ccexp) @ (ccfv @ (ccv @ Xx3) @ ccsin) @ ccmul))))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ XN @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccos) @ ccmul) @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cccos)) @ ccmul))))) => ((! [Xx3:$i] : (cwceq @ (XM @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ cccos) @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ XN @ ccexp) @ (ccfv @ (ccv @ Xx3) @ ccsin) @ ccmul))) @ (cco @ XN @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ cccos) @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul))) @ ccmul))))))))))))))))))).
