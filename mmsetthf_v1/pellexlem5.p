...
thf(cpellexlem5_conj,conjecture,(! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ ccn) @ (cwn @ (cwcel @ (ccfv @ XD @ ccsqrt) @ ccq))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ ccc0) @ (cwbr @ (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xy1) @ ccn) @ (cwcel @ (ccv @ Xz) @ ccn)) @ (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ (ccv @ Xx3)))))) @ ccn @ ccen))) @ (^ [Xx3:$i] : ccz))))).
