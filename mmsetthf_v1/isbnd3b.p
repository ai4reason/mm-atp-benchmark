...
thf(cisbnd3b_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))).
