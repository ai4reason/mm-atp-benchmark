...
thf(cltdiv23i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => (cwi @ (cwa @ (cwbr @ ccc0 @ XB2 @ cclt) @ (cwbr @ ccc0 @ XC @ cclt)) @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ cclt) @ (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt)))))))))).
