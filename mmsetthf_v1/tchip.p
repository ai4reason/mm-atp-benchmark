...
thf(atngip_thm,axiom,(! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ Xc_xi @ (ccfv @ XG @ ccip)) => (cwi @ (cwcel @ XN @ XV) @ (cwceq @ Xc_xi @ (ccfv @ XT @ ccip))))))))))).
...
thf(ctchip_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccip)) => (cwceq @ Xc_x @ (ccfv @ XG @ ccip)))))))).
