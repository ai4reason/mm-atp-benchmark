...
thf(auniioombllem2a_thm,axiom,(! [Xph:$o] : (! [Xz:$i] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((cwceq @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XE @ Xx3) @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XE @ Xx3) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG)))))) => ((cwceq @ XT @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3) @ ccovol) @ XC @ ccaddc) @ ccle))) => (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ XJ @ ccn)) @ (cwcel @ (ccv @ Xz) @ ccn)) @ (cwcel @ (ccin @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccioo) @ (ccfv @ (ccfv @ XJ @ XG) @ ccioo)) @ (ccrn @ ccioo)))))))))))))))))))))))).
...
thf(aioorcl_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccrn @ ccioo)) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) @ (cwcel @ (ccfv @ XA2 @ (XF @ Xx3)) @ (ccin @ ccle @ (ccxp @ ccr @ ccr))))))))).
...
thf(aioorf_thm,axiom,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : (cwf @ (ccrn @ ccioo) @ (ccin @ ccle @ (ccxp @ ccxr @ ccxr)) @ (XF @ Xx3)))))).
...
thf(aioorinv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (ccrn @ ccioo)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ (XF @ Xx3)) @ ccioo) @ XA2))))))).
...
thf(aovolfs2_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => (cwi @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) @ (cwceq @ XG @ (cccom @ (cccom @ ccovol @ ccioo) @ XF))))))).
