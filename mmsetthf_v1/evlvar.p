...
thf(cevlvar_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xg1:$i] : (cwceq @ (XQ @ Xg1) @ (cco @ XI @ XS @ ccevl))) => ((! [Xg1:$i] : (cwceq @ (XV @ Xg1) @ (cco @ XI @ XS @ ccmvr))) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XI @ XW))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XS @ cccrg))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XX @ XI))) => (! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwceq @ (ccfv @ (ccfv @ XX @ (XV @ Xg1)) @ (XQ @ Xg1)) @ (ccmpt @ (^ [Xg1:$i] : (cco @ XB2 @ XI @ ccmap)) @ (^ [Xg1:$i] : (ccfv @ XX @ (ccv @ Xg1)))))))))))))))))))))).
