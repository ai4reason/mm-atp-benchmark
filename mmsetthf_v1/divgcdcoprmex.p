...
thf(azeqzmulgcd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xn) @ (cco @ XA2 @ XB2 @ ccgcd) @ ccmul))) @ (^ [Xn:$i] : ccz)))))).
...
thf(adivgcdcoprm0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccgcd) @ cc1))))).
...
thf(cdivgcdcoprmex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ XM @ (cco @ XA2 @ XB2 @ ccgcd))) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cw3a @ (cwceq @ XA2 @ (cco @ XM @ (ccv @ Xa) @ ccmul)) @ (cwceq @ XB2 @ (cco @ XM @ (ccv @ Xb) @ ccmul)) @ (cwceq @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccgcd) @ cc1))) @ (^ [Xb:$i] : ccz))) @ (^ [Xa:$i] : ccz))))))).
