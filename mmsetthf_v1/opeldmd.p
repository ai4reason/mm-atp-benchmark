...
thf(copeldmd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => (cwi @ Xph @ (cwi @ (cwcel @ (ccop @ XA2 @ XB2) @ XC) @ (cwcel @ XA2 @ (ccdm @ XC))))))))))))).
