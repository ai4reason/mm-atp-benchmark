...
thf(aspansncv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ cchil)) @ (cwi @ (cwa @ (cwpss @ XA2 @ XB2) @ (cwss @ XB2 @ (cco @ XA2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ cchj))) @ (cwceq @ XB2 @ (cco @ XA2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ cchj)))))))).
...
thf(cspansncv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ cchil)) @ (cwi @ (cwn @ (cwss @ (ccfv @ (ccsn @ XB2) @ ccspn) @ XA2)) @ (cwbr @ XA2 @ (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ cchj) @ cccv)))))).
