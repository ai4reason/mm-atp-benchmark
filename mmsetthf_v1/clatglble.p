...
thf(cclatglble_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XG @ (ccfv @ XK @ ccglb)) => (cwi @ (cw3a @ (cwcel @ XK @ cccla) @ (cwss @ XS @ XB2) @ (cwcel @ XX @ XS)) @ (cwbr @ (ccfv @ XS @ XG) @ XX @ Xc_le)))))))))))).
