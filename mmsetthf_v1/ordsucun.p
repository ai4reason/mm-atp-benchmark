...
thf(aordssun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cword @ XB2) @ (cword @ XC)) @ (cwb @ (cwss @ XA2 @ (ccun @ XB2 @ XC)) @ (cwo @ (cwss @ XA2 @ XB2) @ (cwss @ XA2 @ XC)))))))).
...
thf(cordsucun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cword @ XB2)) @ (cwceq @ (ccsuc @ (ccun @ XA2 @ XB2)) @ (ccun @ (ccsuc @ XA2) @ (ccsuc @ XB2))))))).
