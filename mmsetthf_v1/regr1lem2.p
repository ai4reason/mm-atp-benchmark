...
thf(aregr1lem_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm @ Xn) @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm @ Xn) @ (cwcel @ XJ @ ccreg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm @ Xn) @ (cwcel @ XA2 @ XX)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm @ Xn) @ (cwcel @ XB2 @ XX)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm @ Xn) @ (cwcel @ (XU @ Xx3 @ Xy1 @ Xm @ Xn) @ XJ)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm @ Xn) @ (cwn @ (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwcel @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ (cwcel @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1)) @ (ccv @ Xn)) @ (cwceq @ (ccin @ (ccv @ Xm) @ (ccv @ Xn)) @ cc0))) @ (^ [Xn:$i] : (ccfv @ XJ @ cckq)))) @ (^ [Xm:$i] : (ccfv @ XJ @ cckq))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm @ Xn) @ (cwi @ (cwcel @ XA2 @ (XU @ Xx3 @ Xy1 @ Xm @ Xn)) @ (cwcel @ XB2 @ (XU @ Xx3 @ Xy1 @ Xm @ Xn))))))))))))))))))))))).
...
thf(cregr1lem2_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XJ @ ccreg)) @ (cwcel @ (ccfv @ XJ @ cckq) @ ccha))))))).
