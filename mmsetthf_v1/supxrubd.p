...
thf(csupxrubd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ XA2)) => ((cwceq @ XS @ (ccsup @ XA2 @ ccxr @ cclt)) => (cwi @ Xph @ (cwbr @ XB2 @ XS @ ccle)))))))))).
