...
thf(achlubi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwb @ (cwa @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XC)) @ (cwss @ (cco @ XA2 @ XB2 @ cchj) @ XC))))))))).
...
thf(clejdii_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwss @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ cchj) @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XA2 @ XC @ cchj)))))))))).
