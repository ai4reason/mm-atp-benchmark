...
thf(ausgrspan_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwcel @ XS @ XW)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XS @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XS @ cciedg) @ (ccres @ XE @ XA2))) => ((cwi @ Xph @ (cwcel @ XG @ ccusgr)) => (cwi @ Xph @ (cwcel @ XS @ ccusgr)))))))))))))))).
...
thf(cusgrspanop_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwcel @ (ccop @ XV @ (ccres @ XE @ XA2)) @ ccusgr))))))))).
