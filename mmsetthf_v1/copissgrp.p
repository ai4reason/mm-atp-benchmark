...
thf(aopmpt2ismgm_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XM @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))) => ((cwi @ Xph @ (cwne @ XB2 @ cc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2))) @ (cwcel @ (XC @ Xx3 @ Xy1) @ XB2)))) => (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xy1) @ ccmgm)))))))))))).
...
thf(ccopissgrp_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XM @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (cwceq @ (ccfv @ (XM @ Xy1) @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC))))) => ((cwi @ Xph @ (cwne @ XB2 @ cc0)) => ((cwi @ Xph @ (cwcel @ XC @ XB2)) => (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xy1) @ ccsgrp)))))))))))).
