...
thf(atsk0_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cctsk) @ (cwne @ XT @ cc0)) @ (cwcel @ cc0 @ XT)))).
...
thf(ctskr1om_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cctsk) @ (cwne @ XT @ cc0)) @ (cwss @ (ccima @ ccr1 @ ccom) @ XT)))).
