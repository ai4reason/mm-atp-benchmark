...
thf(aloglesqrt_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwbr @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ ccsqrt) @ ccle)))).
...
thf(adivsubdiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwa @ (cwcel @ XC @ ccc) @ (cwne @ XC @ ccc0)) @ (cwa @ (cwcel @ XD @ ccc) @ (cwne @ XD @ ccc0)))) @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XD @ ccdiv) @ ccmin) @ (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccmin) @ (cco @ XC @ XD @ ccmul) @ ccdiv)))))))).
...
thf(crplogsumlem1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwbr @ (ccsu @ (cco @ cc2 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccmul) @ ccdiv))) @ cc2 @ ccle)))).
