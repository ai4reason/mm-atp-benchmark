...
thf(aclintopcllaw_thm,axiom,(! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ Xc_op @ (ccfv @ XM @ ccclintop)) @ (cwbr @ Xc_op @ XM @ cccllaw))))).
thf(cassintopcllaw_conj,conjecture,(! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ Xc_op @ (ccfv @ XM @ ccassintop)) @ (cwbr @ Xc_op @ XM @ cccllaw))))).
