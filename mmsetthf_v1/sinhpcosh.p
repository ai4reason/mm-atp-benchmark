...
thf(asinhval_named_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccsinh) @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccsin) @ cci @ ccdiv))))).
...
thf(acoshval_named_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ cccosh) @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cccos))))).
...
thf(csinhpcosh_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccsinh) @ (ccfv @ XA2 @ cccosh) @ ccaddc) @ (ccfv @ XA2 @ cce))))).
