...
thf(ccarduni_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cccrd) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cccrd) @ (ccuni @ XA2)))))))).
