...
thf(aply1mulgsumlem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > $o))] : (! [Xc_as:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XP @ Xk @ Xl) @ (ccfv @ XR @ ccpl1)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xk @ Xl) @ ccbs)))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccco1)) => ((cwceq @ XC @ (ccfv @ XL @ ccco1)) => ((! [Xl:$i] : (cwceq @ (XX @ Xl) @ (ccfv @ XR @ ccv1))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_xp @ Xk @ Xl) @ (ccfv @ (XP @ Xk @ Xl) @ ccmulr)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_x @ Xl) @ (ccfv @ (XP @ Xk @ Xl) @ ccvsca)))) => ((! [Xl:$i] : (cwceq @ (Xc_as @ Xl) @ (ccfv @ XR @ ccmulr))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XM @ Xk @ Xl) @ (ccfv @ (XP @ Xk @ Xl) @ ccmgp)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_ex @ Xl) @ (ccfv @ (XM @ Xk @ Xl) @ ccmg)))) => (! [Xk:$i] : (! [Xl:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ XB2) @ (cwcel @ XL @ XB2)) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ XR @ (ccmpt @ (^ [Xl:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xl:$i] : (cco @ (ccfv @ (ccv @ Xl) @ XA2) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ ccmin) @ XC) @ (Xc_as @ Xl)))) @ ccgsu) @ (cco @ (ccv @ Xk) @ (XX @ Xl) @ (Xc_ex @ Xl)) @ (Xc_x @ Xl)))) @ (ccfv @ (XP @ Xk @ Xl) @ cc0g) @ ccfsupp)))))))))))))))))))))))))))).
...
thf(cply1mulgsum_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xl:$i] : (cwceq @ (XP @ Xl) @ (ccfv @ XR @ ccpl1))) => ((! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xl) @ ccbs))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccco1)) => ((cwceq @ XC @ (ccfv @ XL @ ccco1)) => ((! [Xl:$i] : (cwceq @ (XX @ Xl) @ (ccfv @ XR @ ccv1))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_xp @ Xk @ Xl) @ (ccfv @ (XP @ Xl) @ ccmulr)))) => ((! [Xl:$i] : (cwceq @ (Xc_x @ Xl) @ (ccfv @ (XP @ Xl) @ ccvsca))) => ((cwceq @ Xc_as @ (ccfv @ XR @ ccmulr)) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XM @ Xk @ Xl) @ (ccfv @ (XP @ Xl) @ ccmgp)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_ex @ Xl) @ (ccfv @ (XM @ Xk @ Xl) @ ccmg)))) => (! [Xk:$i] : (! [Xl:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ XB2) @ (cwcel @ XL @ XB2)) @ (cwceq @ (cco @ XK @ XL @ (Xc_xp @ Xk @ Xl)) @ (cco @ (XP @ Xl) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ XR @ (ccmpt @ (^ [Xl:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xl:$i] : (cco @ (ccfv @ (ccv @ Xl) @ XA2) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ ccmin) @ XC) @ Xc_as))) @ ccgsu) @ (cco @ (ccv @ Xk) @ (XX @ Xl) @ (Xc_ex @ Xl)) @ (Xc_x @ Xl)))) @ ccgsu))))))))))))))))))))))))))))).
