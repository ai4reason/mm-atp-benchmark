...
thf(ciccsuble_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccicc))) => (cwi @ Xph @ (cwbr @ (cco @ XC @ XD @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccle)))))))))))).
