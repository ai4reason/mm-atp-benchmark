...
thf(agsumadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XH)) => ((cwi @ Xph @ (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((cwi @ Xph @ (cwbr @ XH @ Xc_0 @ ccfsupp)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ (cco @ XF @ XH @ (ccof @ Xc_pl)) @ ccgsu) @ (cco @ (cco @ XG @ XF @ ccgsu) @ (cco @ XG @ XH @ ccgsu) @ Xc_pl)))))))))))))))))))))).
