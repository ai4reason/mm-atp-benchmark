...
thf(ainfxrge0glb_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwbr @ (ccinf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ XB2 @ cclt) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ cclt)) @ (^ [Xx3:$i] : XA2))))))))))).
...
thf(cinfxrge0gelb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (cwi @ Xph @ (cwb @ (cwbr @ XB2 @ (ccinf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2)))))))))).
