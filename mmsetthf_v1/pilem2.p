...
thf(adf_pi_ax,axiom,(cwceq @ ccpi @ (ccinf @ (ccin @ ccrp @ (ccima @ (cccnv @ ccsin) @ (ccsn @ ccc0))) @ ccr @ cclt))).
...
thf(apilem1_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccin @ ccrp @ (ccima @ (cccnv @ ccsin) @ (ccsn @ ccc0)))) @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwceq @ (ccfv @ XA2 @ ccsin) @ ccc0))))).
...
thf(anecon4bd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwi @ (cwn @ Xps) @ (cwne @ XA2 @ XB2))) => (cwi @ Xph @ (cwi @ (cwceq @ XA2 @ XB2) @ Xps)))))))).
...
thf(asin02gt0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ cc2 @ ccioc)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt)))).
...
thf(asinsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccsin) @ (cco @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ cccos) @ ccmul) @ (cco @ (ccfv @ XA2 @ cccos) @ (ccfv @ XB2 @ ccsin) @ ccmul) @ ccmin)))))).
...
thf(cpilem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ cc2 @ cc4 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccsin) @ ccc0)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ ccsin) @ ccc0)) => ((cwi @ Xph @ (cwbr @ ccpi @ XA2 @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ ccpi @ XA2 @ ccaddc) @ cc2 @ ccdiv) @ XB2 @ ccle))))))))))).
