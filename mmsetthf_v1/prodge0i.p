...
thf(cprodge0i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (cwi @ (cwa @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle)) @ (cwbr @ ccc0 @ XB2 @ ccle))))))).
