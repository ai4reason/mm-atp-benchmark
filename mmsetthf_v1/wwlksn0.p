...
thf(awrdl1exs1_thm,axiom,(! [XS:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XS)) @ (cwceq @ (ccfv @ XW @ cchash) @ cc1)) @ (cwrex @ (^ [Xs1:$i] : (cwceq @ XW @ (ccs1 @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : XS)))))).
...
thf(awwlksn0s_thm,axiom,(! [XG:($i > $o)] : (cwceq @ (cco @ ccc0 @ XG @ ccwwlksn) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1)) @ (^ [Xw:$i] : (ccword @ (ccfv @ XG @ ccvtx))))))).
...
thf(cwwlksn0_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XW @ (cco @ ccc0 @ XG @ ccwwlksn)) @ (cwrex @ (^ [Xv:$i] : (cwceq @ XW @ (ccs1 @ (ccv @ Xv)))) @ (^ [Xv:$i] : XV)))))))).
