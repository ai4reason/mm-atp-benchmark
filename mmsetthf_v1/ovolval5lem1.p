...
thf(avolioore_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccvol) @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ (cco @ XB2 @ XA2 @ ccmin) @ ccc0)))))).
...
thf(asublevolico_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) @ ccle)))))))).
...
thf(asge0ad2en_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XA2 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv))) @ ccsumge0) @ XA2)))))).
...
thf(covolval5lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XW:($i > $o)] : ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (XB2 @ Xn) @ ccr))) => ((cwi @ Xph @ (cwcel @ XW @ ccrp)) => ((cwceq @ XC @ (ccrab @ (^ [Xn:$i] : (cwbr @ (XA2 @ Xn) @ (XB2 @ Xn) @ cclt)) @ (^ [Xn:$i] : ccn))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (cco @ (XA2 @ Xn) @ (cco @ XW @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (XB2 @ Xn) @ ccioo) @ ccvol))) @ ccsumge0) @ (cco @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccico) @ ccvol))) @ ccsumge0) @ XW @ ccxad) @ ccle)))))))))))).
