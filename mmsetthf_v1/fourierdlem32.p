...
thf(afourierdlem10_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwbr @ XC @ XD @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XC @ XD @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwi @ Xph @ (cwa @ (cwbr @ XA2 @ XC @ ccle) @ (cwbr @ XD @ XB2 @ ccle))))))))))))))).
...
thf(cfourierdlem32_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ XF @ XA2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwbr @ XC @ XD @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XC @ XD @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwceq @ XY @ (ccif @ (cwceq @ XC @ XA2) @ XR @ (ccfv @ XC @ XF))) => ((cwceq @ XJ @ (cco @ (ccfv @ cccnfld @ cctopn) @ (cco @ XA2 @ XB2 @ ccico) @ ccrest)) => (cwi @ Xph @ (cwcel @ XY @ (cco @ (ccres @ XF @ (cco @ XC @ XD @ ccioo)) @ XC @ cclimc)))))))))))))))))))))))).
