...
thf(adf_fib_ax,axiom,(cwceq @ ccfib @ (cco @ (ccs2 @ ccc0 @ cc1) @ (ccmpt @ (^ [Xw:$i] : (ccin @ (ccword @ ccn0) @ (ccima @ (cccnv @ cchash) @ (ccfv @ cc2 @ ccuz)))) @ (^ [Xw:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1 @ ccmin) @ (ccv @ Xw)) @ ccaddc))) @ ccsseq))).
...
thf(asseqp1_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwcel @ XM @ (ccword @ XS))) => ((cwceq @ XW @ (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XW @ XS @ XF)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (cco @ XM @ XF @ ccsseq)) @ (ccfv @ (ccres @ (cco @ XM @ XF @ ccsseq) @ (cco @ ccc0 @ XN @ ccfzo)) @ XF))))))))))))))).
...
thf(afiblem_thm,axiom,(cwf @ (ccin @ (ccword @ ccn0) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ (ccs2 @ ccc0 @ cc1) @ cchash) @ ccuz))) @ ccn0 @ (ccmpt @ (^ [Xw:$i] : (ccin @ (ccword @ ccn0) @ (ccima @ (cccnv @ cchash) @ (ccfv @ cc2 @ ccuz)))) @ (^ [Xw:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1 @ ccmin) @ (ccv @ Xw)) @ ccaddc))))).
...
thf(asubiwrdlen_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwf @ ccn0 @ XS @ XF)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ cchash) @ XN)))))))))).
...
thf(asseqf_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwcel @ XM @ (ccword @ XS))) => ((cwceq @ XW @ (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XW @ XS @ XF)) => (cwi @ Xph @ (cwf @ ccn0 @ XS @ (cco @ XM @ XF @ ccsseq))))))))))))).
...
thf(asubiwrd_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwf @ ccn0 @ XS @ XF)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwcel @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccword @ XS))))))))))).
...
thf(cfibp1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfib) @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfib) @ (ccfv @ XN @ ccfib) @ ccaddc))))).
