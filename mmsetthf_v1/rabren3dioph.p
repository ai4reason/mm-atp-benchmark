...
thf(afntp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => ((cwcel @ XE @ ccvv) => ((cwcel @ XF @ ccvv) => (cwi @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)) @ (cwfn @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF)) @ (cctp @ XA2 @ XB2 @ XC)))))))))))))))).
...
thf(arabrenfdioph_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccn0) @ (cwf @ (cco @ cc1 @ XA2 @ ccfz) @ (cco @ cc1 @ XB2 @ ccfz) @ XF) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (Xph @ Xa)) @ (^ [Xa:$i] : (cco @ ccn0 @ (cco @ cc1 @ XA2 @ ccfz) @ ccmap))) @ (ccfv @ XA2 @ ccdioph))) @ (cwcel @ (ccrab @ (^ [Xb:$i] : (cwsbc @ (^ [Xa:$i] : (Xph @ Xa)) @ (cccom @ (ccv @ Xb) @ XF))) @ (^ [Xb:$i] : (cco @ ccn0 @ (cco @ cc1 @ XB2 @ ccfz) @ ccmap))) @ (ccfv @ XB2 @ ccdioph)))))))).
thf(crabren3dioph_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (cwi @ (cw3a @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ XX @ (ccv @ Xb))) @ (cwceq @ (ccfv @ cc2 @ (ccv @ Xa)) @ (ccfv @ XY @ (ccv @ Xb))) @ (cwceq @ (ccfv @ cc3 @ (ccv @ Xa)) @ (ccfv @ XZ @ (ccv @ Xb)))) @ (cwb @ (Xph @ Xa) @ (Xps @ Xb))))) => ((cwcel @ XX @ (cco @ cc1 @ XN @ ccfz)) => ((cwcel @ XY @ (cco @ cc1 @ XN @ ccfz)) => ((cwcel @ XZ @ (cco @ cc1 @ XN @ ccfz)) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (Xph @ Xa)) @ (^ [Xa:$i] : (cco @ ccn0 @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))) @ (ccfv @ cc3 @ ccdioph))) @ (cwcel @ (ccrab @ (^ [Xb:$i] : (Xps @ Xb)) @ (^ [Xb:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))))))))))).
