...
thf(afbasssin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2))) @ (^ [Xx3:$i] : XF)))))))).
...
thf(ctrfbas2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XY @ ccfbas)) @ (cwss @ XA2 @ XY)) @ (cwb @ (cwcel @ (cco @ XF @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfbas)) @ (cwn @ (cwcel @ cc0 @ (cco @ XF @ XA2 @ ccrest))))))))).
