...
thf(cltexprlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XC @ Xy1) @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xy1) @ XA2)) @ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccplq) @ XB2)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XB2 @ ccnp) @ (cwi @ (cwcel @ (ccv @ Xx3) @ (XC @ Xy1)) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ ccltq) @ (cwcel @ (ccv @ Xz) @ (XC @ Xy1)))))))))))))).
