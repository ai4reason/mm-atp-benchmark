...
thf(acdj3lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwi @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xy1) @ ccno) @ (ccfv @ (ccv @ Xz) @ ccno) @ ccaddc) @ (cco @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccva) @ ccno) @ ccmul) @ ccle)) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h))))))).
