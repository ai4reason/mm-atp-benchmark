...
thf(cumgr2v2evd2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccop @ XV @ (ccpr @ (ccop @ ccc0 @ (ccpr @ XA2 @ XB2)) @ (ccop @ cc1 @ (ccpr @ XA2 @ XB2))))) => (cwi @ (cwa @ (cw3a @ (cwcel @ XV @ XW) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwne @ XA2 @ XB2)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XG @ ccvtxdg)) @ cc2))))))))).
