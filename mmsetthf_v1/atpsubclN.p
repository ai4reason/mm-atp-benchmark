...
thf(a_2polatN_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XP @ (ccfv @ XK @ ccpolN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XQ @ XA2)) @ (cwceq @ (ccfv @ (ccfv @ (ccsn @ XQ) @ XP) @ XP) @ (ccsn @ XQ)))))))))).
...
thf(catpsubclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XQ @ XA2)) @ (cwcel @ (ccsn @ XQ) @ XC))))))))).
