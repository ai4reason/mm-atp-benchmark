...
thf(aasclghm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccascl)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwi @ Xph @ (cwcel @ XW @ ccrg)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => (cwi @ Xph @ (cwcel @ XA2 @ (cco @ XF @ XW @ ccghm)))))))))))).
...
thf(ampt2matmul_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xp:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XE:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (cco @ XN @ XR @ ccmat))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (ccfv @ XR @ ccbs))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (Xc_xp @ Xi @ Xj @ Xk @ Xm @ Xl) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ ccmulr))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (cwceq @ (Xc_x @ Xi @ Xj @ Xm) @ (ccfv @ XR @ ccmulr))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ Xph @ (cwcel @ XR @ (XV @ Xi @ Xj @ Xk @ Xm @ Xl)))))))) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XX @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XC @ Xi @ Xj @ Xk @ Xm @ Xl)))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XY @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XE @ Xi @ Xj @ Xk @ Xm @ Xl)))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) @ (cwcel @ (XC @ Xi @ Xj @ Xk @ Xm @ Xl) @ (XB2 @ Xi @ Xj @ Xk @ Xm @ Xl)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) @ (cwcel @ (XE @ Xi @ Xj @ Xk @ Xm @ Xl) @ (XB2 @ Xi @ Xj @ Xk @ Xm @ Xl)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwceq @ (ccv @ Xk) @ (ccv @ Xi)) @ (cwceq @ (ccv @ Xm) @ (ccv @ Xj)))) @ (cwceq @ (XD @ Xk @ Xm @ Xl) @ (XC @ Xi @ Xj @ Xk @ Xm @ Xl)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwceq @ (ccv @ Xm) @ (ccv @ Xi)) @ (cwceq @ (ccv @ Xl) @ (ccv @ Xj)))) @ (cwceq @ (XF @ Xk @ Xm @ Xl) @ (XE @ Xi @ Xj @ Xk @ Xm @ Xl)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xk) @ XN) @ (cwcel @ (ccv @ Xm) @ XN)) @ (cwcel @ (XD @ Xk @ Xm @ Xl) @ (XU @ Xi @ Xj @ Xk @ Xm @ Xl)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xm) @ XN) @ (cwcel @ (ccv @ Xl) @ XN)) @ (cwcel @ (XF @ Xk @ Xm @ Xl) @ (XW @ Xi @ Xj @ Xk @ Xm @ Xl)))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XX @ Xi @ Xj) @ (XY @ Xi @ Xj) @ (Xc_xp @ Xi @ Xj @ Xk @ Xm @ Xl)) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (cco @ XR @ (ccmpt @ (^ [Xm:$i] : XN) @ (^ [Xm:$i] : (cco @ (XD @ Xk @ Xm @ Xl) @ (XF @ Xk @ Xm @ Xl) @ (Xc_x @ Xi @ Xj @ Xm)))) @ ccgsu)))))))))))))))))))))))))))))))))))))))))).
...
thf(amat2pmatval_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ XN @ XR @ ccmat2pmat)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XP @ Xx3 @ Xy1) @ (ccfv @ XR @ ccpl1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XS @ Xx3 @ Xy1) @ (ccfv @ (XP @ Xx3 @ Xy1) @ ccascl)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ (XV @ Xx3 @ Xy1)) @ (cwcel @ XM @ (XB2 @ Xx3 @ Xy1))) @ (cwceq @ (ccfv @ XM @ (XT @ Xx3 @ Xy1)) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XN)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XN)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) @ (XS @ Xx3 @ Xy1)))))))))))))))))))))))).
...
thf(cmat2pmatmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XH @ (ccfv @ XC @ ccbs)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XA2 @ ccmulr)) @ XT) @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccfv @ (ccv @ Xy1) @ XT) @ (ccfv @ XC @ ccmulr)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))))))))).
