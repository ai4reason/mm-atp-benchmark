...
thf(ashintcli_thm,axiom,(! [XA2:($i > $o)] : ((cwa @ (cwss @ XA2 @ ccsh) @ (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ ccsh)))).
...
thf(achlimi_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cw3a @ (cwcel @ XH @ ccch) @ (cwf @ ccn @ XH @ XF) @ (cwbr @ XF @ XA2 @ cchli)) @ (cwcel @ XA2 @ XH))))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(afint_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwne @ XB2 @ cc0) => (cwb @ (cwf @ XA2 @ (ccint @ XB2) @ XF) @ (cwral @ (^ [Xx3:$i] : (cwf @ XA2 @ (ccv @ Xx3) @ XF)) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(cchintcli_conj,conjecture,(! [XA2:($i > $o)] : ((cwa @ (cwss @ XA2 @ ccch) @ (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ ccch)))).
