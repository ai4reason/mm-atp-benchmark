...
thf(ajm3_1_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XK @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn)) @ (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) @ (cwceq @ (cco @ XK @ XN @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmin) @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ ccmo))))))).
...
thf(ajm3_1lem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => (cwi @ Xph @ (cwcel @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ ccn))))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(adivalgmodcl_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn) @ (cwcel @ XR @ ccn0)) @ (cwb @ (cwceq @ XR @ (cco @ XN @ XD @ ccmo)) @ (cwa @ (cwbr @ XR @ XD @ cclt) @ (cwbr @ XD @ (cco @ XN @ XR @ ccmin) @ ccdvds)))))))).
...
thf(armynn0_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (cco @ XA2 @ XN @ ccrmy) @ ccn0))))).
