...
thf(cppisval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ cc2 @ (ccfv @ XM @ ccuz))) @ (cwceq @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (ccin @ (cco @ XM @ (ccfv @ XA2 @ ccfl) @ ccfz) @ ccprime)))))).
