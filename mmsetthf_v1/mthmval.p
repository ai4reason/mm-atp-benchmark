...
thf(adf_mthm_ax,axiom,(cwceq @ ccmthm @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccima @ (cccnv @ (ccfv @ (ccv @ Xt) @ ccmsr)) @ (ccima @ (ccfv @ (ccv @ Xt) @ ccmsr) @ (ccfv @ (ccv @ Xt) @ ccmpps))))))).
...
thf(cmthmval_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XR @ (ccfv @ XT @ ccmsr)) => ((cwceq @ XJ @ (ccfv @ XT @ ccmpps)) => ((cwceq @ XU @ (ccfv @ XT @ ccmthm)) => (cwceq @ XU @ (ccima @ (cccnv @ XR) @ (ccima @ XR @ XJ))))))))))).
