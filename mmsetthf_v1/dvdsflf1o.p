...
thf(cdvdsflf1o_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XN @ ccn))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (cco @ XA2 @ XN @ ccdiv) @ ccfl) @ ccfz)) @ (^ [Xn:$i] : (cco @ XN @ (ccv @ Xn) @ ccmul)))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwf1o @ (cco @ cc1 @ (ccfv @ (cco @ XA2 @ XN @ ccdiv) @ ccfl) @ ccfz) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XN @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz))) @ (XF @ Xx3 @ Xn))))))))))))).
