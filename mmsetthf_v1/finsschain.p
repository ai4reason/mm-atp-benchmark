...
thf(cfinsschain_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwne @ XA2 @ cc0) @ (cwor @ XA2 @ ccrpss)) @ (cwa @ (cwcel @ XB2 @ ccfn) @ (cwss @ XB2 @ (ccuni @ XA2)))) @ (cwrex @ (^ [Xz:$i] : (cwss @ XB2 @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2)))))).
