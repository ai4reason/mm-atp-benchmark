...
thf(afinlocfin_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XA2)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (cwceq @ XX @ XY)) @ (cwcel @ XA2 @ (ccfv @ XJ @ cclocfin)))))))))).
thf(aispcmp_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccpcmp) @ (cwcel @ XJ @ (cccref @ (ccfv @ XJ @ cclocfin)))))).
thf(ccmppcmp_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cccmp) @ (cwcel @ XJ @ ccpcmp)))).
