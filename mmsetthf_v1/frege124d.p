...
thf(aeupicka_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwi @ (cwa @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3))))) @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (Xps @ Xx3)))))))).
...
thf(areltrclfv_thm,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwrel @ XR)) @ (cwrel @ (ccfv @ XR @ cctcl)))))).
...
thf(cfrege124d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccvv)) => ((cwi @ Xph @ (cwcel @ XX @ (ccdm @ XF))) => ((cwi @ Xph @ (cwceq @ XA2 @ (ccfv @ XX @ XF))) => ((cwi @ Xph @ (cwbr @ XX @ XB2 @ (ccfv @ XF @ cctcl))) => ((cwi @ Xph @ (cwfun @ XF)) => (cwi @ Xph @ (cwo @ (cwbr @ XA2 @ XB2 @ (ccfv @ XF @ cctcl)) @ (cwceq @ XA2 @ XB2)))))))))))))).
