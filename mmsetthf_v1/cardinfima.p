...
thf(acarduniima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwi @ (cwf @ XA2 @ (ccun @ ccom @ (ccrn @ ccale)) @ XF) @ (cwcel @ (ccuni @ (ccima @ XF @ XA2)) @ (ccun @ ccom @ (ccrn @ ccale))))))))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(aiscard3_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2) @ (cwcel @ XA2 @ (ccun @ ccom @ (ccrn @ ccale)))))).
thf(ccardinfima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ (cwi @ (cwa @ (cwf @ XA2 @ (ccun @ ccom @ (ccrn @ ccale)) @ XF) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccrn @ ccale))) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ (ccuni @ (ccima @ XF @ XA2)) @ (ccrn @ ccale))))))))).
