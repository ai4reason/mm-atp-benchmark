...
thf(arpvmasum2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ XL @ (ccfv @ XZ @ cczrh)) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XN @ ccn))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xm @ Xn) @ (ccfv @ XN @ ccdchr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ XD @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xn) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ Xc_1 @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xn) @ cc0g)))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XW @ Xy1 @ Xm @ Xn) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) @ ccc0)) @ (^ [Xy1:$i] : (ccdif @ XD @ (ccsn @ Xc_1)))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XU @ Xy1 @ Xf1) @ (ccfv @ XZ @ ccui)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XA2 @ (XU @ Xy1 @ Xf1))))) => ((! [Xf1:$i] : (cwceq @ (XT @ Xf1) @ (ccima @ (cccnv @ XL) @ (ccsn @ XA2)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (cwcel @ (ccv @ Xf1) @ (XW @ Xy1 @ Xm @ Xn))) @ (cwceq @ XA2 @ (ccfv @ XZ @ ccur))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ XN @ ccphi) @ (ccsu @ (ccin @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (XT @ Xf1)) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv))) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ (cco @ cc1 @ (ccfv @ (XW @ Xy1 @ Xm @ Xn) @ cchash) @ ccmin) @ ccmul) @ ccmin))) @ cco1))))))))))))))))))))))))))))).
thf(apm2_21i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwn @ Xph) => (cwi @ Xph @ Xps))))).
thf(crpvmasum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ XL @ (ccfv @ XZ @ cczrh)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwceq @ XU @ (ccfv @ XZ @ ccui)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwceq @ XT @ (ccima @ (cccnv @ XL) @ (ccsn @ XA2))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ XN @ ccphi) @ (ccsu @ (ccin @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ XT) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv))) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1)))))))))))))))).
