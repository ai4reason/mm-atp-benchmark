...
thf(acantnflem1d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ ccon0))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XB2 @ ccon0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xz:$i] : XB2)))))))))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XF @ (XS @ Xw)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XG @ (XS @ Xw)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwbr @ XF @ XG @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((! [Xc:$i] : (cwceq @ (XX @ Xc) @ (ccuni @ (ccrab @ (^ [Xc:$i] : (cwcel @ (ccfv @ (ccv @ Xc) @ XF) @ (ccfv @ (ccv @ Xc) @ XG))) @ (^ [Xc:$i] : XB2))))) => ((! [Xc:$i] : (cwceq @ (XO @ Xc) @ (ccoi @ (cco @ XG @ cc0 @ ccsupp) @ ccep))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwceq @ (XH @ Xz @ Xw @ Xk @ Xc) @ (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xk) @ (XO @ Xc)) @ ccoe) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XO @ Xc)) @ XG) @ ccomu) @ (ccv @ Xz) @ ccoa)))) @ cc0)))))) => (! [Xz:$i] : (! [Xw:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccif @ (cwss @ (ccv @ Xx3) @ (XX @ Xc)) @ (ccfv @ (ccv @ Xx3) @ XF) @ cc0))) @ (cco @ XA2 @ XB2 @ cccnf)) @ (ccfv @ (ccsuc @ (ccfv @ (XX @ Xc) @ (cccnv @ (XO @ Xc)))) @ (XH @ Xz @ Xw @ Xk @ Xc))))))))))))))))))))))))))))).
...
thf(aonsseleq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwo @ (cwcel @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2))))))).
...
thf(afsuppsssupp_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XG @ XV) @ (cwfun @ XG)) @ (cwa @ (cwbr @ XF @ XZ @ ccfsupp) @ (cwss @ (cco @ XG @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp)))) @ (cwbr @ XG @ XZ @ ccfsupp))))))).
...
thf(aoaord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwcel @ (cco @ XC @ XA2 @ ccoa) @ (cco @ XC @ XB2 @ ccoa)))))))).
...
thf(aonsssuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwcel @ XA2 @ (ccsuc @ XB2))))))).
...
thf(aordelsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cword @ XB2)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwss @ (ccsuc @ XA2) @ XB2))))))).
...
thf(aifor_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccif @ (cwo @ Xph @ Xps) @ XA2 @ XB2) @ (ccif @ Xph @ XA2 @ (ccif @ Xps @ XA2 @ XB2)))))))).
...
thf(aorduni_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cword @ (ccuni @ XA2))))).
...
thf(ccantnflem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ ccon0))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XB2 @ ccon0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xz:$i] : XB2)))))))))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XF @ (XS @ Xw)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XG @ (XS @ Xw)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwbr @ XF @ XG @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((! [Xc:$i] : (cwceq @ (XX @ Xc) @ (ccuni @ (ccrab @ (^ [Xc:$i] : (cwcel @ (ccfv @ (ccv @ Xc) @ XF) @ (ccfv @ (ccv @ Xc) @ XG))) @ (^ [Xc:$i] : XB2))))) => ((! [Xc:$i] : (cwceq @ (XO @ Xc) @ (ccoi @ (cco @ XG @ cc0 @ ccsupp) @ ccep))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwceq @ (XH @ Xz @ Xw @ Xk @ Xc) @ (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xk) @ (XO @ Xc)) @ ccoe) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XO @ Xc)) @ XG) @ ccomu) @ (ccv @ Xz) @ ccoa)))) @ cc0)))))) => (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (ccfv @ XF @ (cco @ XA2 @ XB2 @ cccnf)) @ (ccfv @ XG @ (cco @ XA2 @ XB2 @ cccnf)))))))))))))))))))))))))).
