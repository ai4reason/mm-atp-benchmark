...
thf(cgeolim2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp)))) => (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccli))))))))))).
