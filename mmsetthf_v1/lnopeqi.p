...
thf(alnopeq0i_thm,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) @ ccc0)) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XT @ cch0o))))).
...
thf(ahosubeq0i_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwf @ cchil @ cchil @ XU) => (cwb @ (cwceq @ (cco @ XT @ XU @ cchod) @ cch0o) @ (cwceq @ XT @ XU))))))).
thf(clnopeqi_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwcel @ XU @ cclo) => (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) @ (cco @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XT @ XU))))))).
