...
thf(covg_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > $o)] : (! [Xth:$o] : (! [Xta:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz) @ (Xps @ Xy1 @ Xz)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ XB2) @ (cwb @ (Xps @ Xy1 @ Xz) @ (Xch @ Xz))))) => ((! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ XC) @ (cwb @ (Xch @ Xz) @ Xth))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xta @ Xz) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XR) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cweu @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XR) @ (cwcel @ (ccv @ Xy1) @ XS)) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xta @ Xz) @ (cw3a @ (cwcel @ XA2 @ XR) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ (XD @ Xx3 @ Xy1 @ Xz)))) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) @ XC) @ Xth))))))))))))))))))))))).
