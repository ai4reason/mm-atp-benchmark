...
thf(adf_pmap_ax,axiom,(cwceq @ ccpmap @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xa:$i] : (ccfv @ (ccv @ Xk) @ ccbs)) @ (^ [Xa:$i] : (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xk) @ ccple))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xk) @ ccatm))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cpmapfval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (Xc_le @ Xx3 @ Xa) @ (ccfv @ XK @ ccple)))) => ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccfv @ XK @ ccatm))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XM @ Xx3 @ Xa) @ (ccfv @ XK @ ccpmap)))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwcel @ XK @ (XC @ Xx3 @ Xa)) @ (cwceq @ (XM @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (XB2 @ Xa)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ (ccv @ Xx3) @ (Xc_le @ Xx3 @ Xa))) @ (^ [Xa:$i] : (XA2 @ Xx3)))))))))))))))))))).
