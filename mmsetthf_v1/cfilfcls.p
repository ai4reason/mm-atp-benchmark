...
thf(ccfilfcls_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XX @ (ccdm @ (ccdm @ XD))) => (cwi @ (cwcel @ XF @ (ccfv @ XD @ cccfil)) @ (cwceq @ (cco @ XJ @ XF @ ccfcls) @ (cco @ XJ @ XF @ ccflim)))))))))).
