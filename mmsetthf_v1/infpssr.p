...
thf(ainfpssrlem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => ((cwi @ Xph @ (cwf1o @ XB2 @ XA2 @ XF)) => ((cwi @ Xph @ (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((cwceq @ XG @ (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => (cwi @ Xph @ (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ ccom @ XA2 @ ccdom))))))))))))))).
thf(asimplr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xps))))).
thf(asimpll_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xph))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(cinfpssr_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwpss @ XX @ XA2) @ (cwbr @ XX @ XA2 @ ccen)) @ (cwbr @ ccom @ XA2 @ ccdom))))).
