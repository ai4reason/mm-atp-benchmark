...
thf(asszcld_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwss @ XA2 @ ccz) @ (cwcel @ XA2 @ (ccfv @ XJ @ cccld))))))).
...
thf(aabs2difd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs) @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ ccle)))))))).
...
thf(aeldmgm_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwn @ (cwcel @ (ccneg @ XA2) @ ccn0)))))).
...
thf(ablhalf_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XY @ XX)) @ (cwa @ (cwcel @ XR @ ccr) @ (cwcel @ XZ @ (cco @ XY @ (cco @ XR @ cc2 @ ccdiv) @ (ccfv @ XM @ ccbl))))) @ (cwss @ (cco @ XY @ (cco @ XR @ cc2 @ ccdiv) @ (ccfv @ XM @ ccbl)) @ (cco @ XZ @ XR @ (ccfv @ XM @ ccbl)))))))))).
...
thf(clgamucov_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : (cwceq @ (XU @ Xx3 @ Xk @ Xr) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ (ccv @ Xr) @ ccle) @ (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xr) @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc)))))) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : (cwceq @ (XJ @ Xx3 @ Xk @ Xr) @ (ccfv @ cccnfld @ cctopn))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwrex @ (^ [Xr:$i] : (cwcel @ XA2 @ (ccfv @ (XU @ Xx3 @ Xk @ Xr) @ (ccfv @ (XJ @ Xx3 @ Xk @ Xr) @ ccnt)))) @ (^ [Xr:$i] : ccn))))))))))))).
