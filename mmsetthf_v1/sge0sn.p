...
thf(arnsnf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ (ccsn @ XA2) @ XB2 @ XF)) => (cwi @ Xph @ (cwceq @ (ccrn @ XF) @ (ccsn @ (ccfv @ XA2 @ XF)))))))))))).
...
thf(asuppr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) @ (cwceq @ (ccsup @ (ccpr @ XB2 @ XC) @ XA2 @ XR) @ (ccif @ (cwbr @ XC @ XB2 @ XR) @ XB2 @ XC)))))))).
...
thf(csge0sn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ (ccsn @ XA2) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccfv @ XA2 @ XF)))))))))).
