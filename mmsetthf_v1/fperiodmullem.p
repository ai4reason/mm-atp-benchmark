...
thf(cfperiodmullem_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XT @ ccr)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3) @ ccn0))) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XX @ (cco @ (XN @ Xx3) @ XT @ ccmul) @ ccaddc) @ XF) @ (ccfv @ XX @ XF))))))))))))))).
