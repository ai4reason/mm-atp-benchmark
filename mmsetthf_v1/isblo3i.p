...
thf(cisblo3i_conj,conjecture,(! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XM @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XN @ (ccfv @ XW @ ccnmcv)) => ((! [Xy1:$i] : (cwceq @ (XL @ Xy1) @ (cco @ XU @ XW @ cclno))) => ((cwceq @ XB2 @ (cco @ XU @ XW @ ccblo)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (! [Xy1:$i] : (cwb @ (cwcel @ XT @ XB2) @ (cwa @ (cwcel @ XT @ (XL @ Xy1)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ XN) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))))))))))))))))).
