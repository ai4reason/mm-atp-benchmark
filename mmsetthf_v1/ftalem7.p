...
thf(aftalem6_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwne @ (ccfv @ ccc0 @ XF) @ ccc0)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ cclt)) @ (^ [Xx3:$i] : ccc)))))))))))))).
...
thf(adgrco_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ XS @ ccply))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cccom @ XF @ XG) @ ccdgr) @ (cco @ XM @ XN @ ccmul)))))))))))))).
...
thf(cftalem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwne @ (ccfv @ XX @ XF) @ ccc0)) => (cwi @ Xph @ (cwn @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle)) @ (^ [Xx3:$i] : ccc))))))))))))))))).
