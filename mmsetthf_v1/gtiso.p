...
thf(aisocnv3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XC @ (ccdif @ (ccxp @ XA2 @ XA2) @ XR)) => ((cwceq @ XD @ (ccdif @ (ccxp @ XB2 @ XB2) @ XS)) => (cwb @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwiso @ XA2 @ XB2 @ XC @ XD @ XH)))))))))))).
...
thf(aindif1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccin @ (ccdif @ XA2 @ XC) @ XB2) @ (ccdif @ (ccin @ XA2 @ XB2) @ XC)))))).
...
thf(aisoeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwceq @ XR @ XT) @ (cwb @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwiso @ XA2 @ XB2 @ XT @ XS @ XH)))))))))).
...
thf(aisocnv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwb @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwiso @ XA2 @ XB2 @ (cccnv @ XR) @ (cccnv @ XS) @ XH)))))))).
...
thf(cgtiso_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwss @ XB2 @ ccxr)) @ (cwb @ (cwiso @ XA2 @ XB2 @ cclt @ (cccnv @ cclt) @ XF) @ (cwiso @ XA2 @ XB2 @ ccle @ (cccnv @ ccle) @ XF))))))).
