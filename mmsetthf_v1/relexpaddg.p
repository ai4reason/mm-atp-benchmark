...
thf(arelexpuzrel_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XR @ XV)) @ (cwrel @ (cco @ XR @ XN @ ccrelexp))))))).
...
thf(arelexpcnv_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XR @ XV)) @ (cwceq @ (cccnv @ (cco @ XR @ XN @ ccrelexp)) @ (cco @ (cccnv @ XR) @ XN @ ccrelexp))))))).
...
thf(acnveqb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwrel @ XA2) @ (cwrel @ XB2)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cccnv @ XA2) @ (cccnv @ XB2))))))).
...
thf(arelexp0rel_thm,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwrel @ (cco @ XR @ ccc0 @ ccrelexp)))))).
...
thf(crelexpaddg_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ XV) @ (cwi @ (cwceq @ (cco @ XN @ XM @ ccaddc) @ cc1) @ (cwrel @ XR)))) @ (cwceq @ (cccom @ (cco @ XR @ XN @ ccrelexp) @ (cco @ XR @ XM @ ccrelexp)) @ (cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp)))))))).
