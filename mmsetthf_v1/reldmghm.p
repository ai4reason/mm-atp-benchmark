...
thf(adf_ghm_ax,axiom,(cwceq @ ccghm @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : ccgrp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : ccgrp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xw:$i] : (cwa @ (cwf @ (ccv @ Xw) @ (ccfv @ (ccv @ Xt) @ ccbs) @ (ccv @ Xg1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xs1) @ ccplusg)) @ (ccv @ Xg1)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xt) @ ccplusg)))) @ (^ [Xy1:$i] : (ccv @ Xw)))) @ (^ [Xx3:$i] : (ccv @ Xw))))) @ (ccfv @ (ccv @ Xs1) @ ccbs))))))))).
thf(creldmghm_conj,conjecture,(cwrel @ (ccdm @ ccghm))).
