...
thf(cfeq123_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwceq @ XF @ XG) @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)) @ (cwb @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ XC @ XD @ XG)))))))))).
