...
thf(ccompssiso_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ XV) @ (cwiso @ (ccpw @ XA2) @ (ccpw @ XA2) @ ccrpss @ (cccnv @ ccrpss) @ (XF @ Xx3))))))))).
