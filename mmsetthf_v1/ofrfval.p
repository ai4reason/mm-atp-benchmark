...
thf(adf_ofr_ax,axiom,(! [XR:($i > $o)] : (cwceq @ (ccofr @ XR) @ (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ XR)) @ (^ [Xx3:$i] : (ccin @ (ccdm @ (ccv @ Xf1)) @ (ccdm @ (ccv @ Xg1))))))))))).
