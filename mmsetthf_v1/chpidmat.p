...
thf(cchpidmat_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (cco @ XN @ XR @ ccchpmat)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XG @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccur)) => ((cwceq @ XS @ (ccfv @ XP @ ccascl)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg)) @ (cwceq @ (ccfv @ XI @ XC) @ (cco @ (ccfv @ XN @ cchash) @ (cco @ XX @ (ccfv @ Xc_1 @ XS) @ Xc_mi) @ Xc_ex)))))))))))))))))))))))))).
