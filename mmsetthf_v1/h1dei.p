...
thf(ah1deoi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ cchil) => (cwb @ (cwcel @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccort)) @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwceq @ (cco @ XA2 @ XB2 @ ccsp) @ ccc0))))))).
...
thf(ch1dei_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ cchil) => (cwb @ (cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwceq @ (cco @ XB2 @ (ccv @ Xx3) @ ccsp) @ ccc0) @ (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccsp) @ ccc0))) @ (^ [Xx3:$i] : cchil)))))))).
