...
thf(ccdlemg27a_conj,conjecture,(! [Xz:$i] : (! [Xv:$i] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (cwi @ (cw3a @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwa @ (cwcel @ (ccv @ Xv) @ XA2) @ (cwbr @ (ccv @ Xv) @ XW @ Xc_le))) @ (cwa @ (cwcel @ (ccv @ Xz) @ XA2) @ (cwcel @ XF @ XT)) @ (cw3a @ (cwne @ (ccv @ Xv) @ (ccfv @ XF @ XR)) @ (cwbr @ (ccv @ Xz) @ (cco @ XP @ (ccv @ Xv) @ Xc_or) @ Xc_le) @ (cwne @ (ccfv @ XP @ XF) @ XP))) @ (cwn @ (cwbr @ (ccfv @ XF @ XR) @ (cco @ XP @ (ccv @ Xz) @ Xc_or) @ Xc_le)))))))))))))))))))))))).
