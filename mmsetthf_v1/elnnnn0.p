...
thf(aelnn0nn_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn0) @ (cwa @ (cwcel @ XN @ ccc) @ (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ ccn))))).
thf(celnnnn0_conj,conjecture,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XN @ ccc) @ (cwcel @ (cco @ XN @ cc1 @ ccmin) @ ccn0))))).
