...
thf(cnbuhgr2vtx1edgblem_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccuhgr) @ (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) @ (cwcel @ (ccv @ Xa) @ (cco @ XG @ (ccv @ Xb) @ ccnbgr))) @ (cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ XE)))))))))).
