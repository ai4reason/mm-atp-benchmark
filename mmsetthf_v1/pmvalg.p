...
thf(adf_pm_ax,axiom,(cwceq @ ccpm @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xf1:$i] : (cwfun @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccpw @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))).
thf(cpmvalg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XC @ Xf1)) @ (cwcel @ XB2 @ (XD @ Xf1))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccpm) @ (ccrab @ (^ [Xf1:$i] : (cwfun @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccpw @ (ccxp @ XB2 @ XA2)))))))))))).
