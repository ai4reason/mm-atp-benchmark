...
thf(adfun3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccun @ XA2 @ XB2) @ (ccdif @ ccvv @ (ccin @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2))))))).
...
thf(cdifundi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccdif @ XA2 @ (ccun @ XB2 @ XC)) @ (ccin @ (ccdif @ XA2 @ XB2) @ (ccdif @ XA2 @ XC))))))).
