...
thf(achebbnd1lem1_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XK @ (ccif @ (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccle) @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc))) => (cwi @ (cwcel @ XN @ (ccfv @ cc4 @ ccuz)) @ (cwbr @ (ccfv @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ cclog) @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccppi) @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ cclog) @ ccmul) @ cclt)))))).
...
thf(achebbnd1lem2_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl)) => (cwi @ (cwa @ (cwcel @ XN @ ccr) @ (cwbr @ cc8 @ XN @ ccle)) @ (cwbr @ (cco @ (ccfv @ (cco @ cc2 @ XM @ ccmul) @ cclog) @ (cco @ cc2 @ XM @ ccmul) @ ccdiv) @ (cco @ cc2 @ (cco @ (ccfv @ XN @ cclog) @ XN @ ccdiv) @ ccmul) @ cclt)))))).
...
thf(cchebbnd1lem3_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl)) => (cwi @ (cwa @ (cwcel @ XN @ ccr) @ (cwbr @ cc8 @ XN @ ccle)) @ (cwbr @ (cco @ (cco @ (ccfv @ cc2 @ cclog) @ (cco @ cc1 @ (cco @ cc2 @ cceu @ ccmul) @ ccdiv) @ ccmin) @ cc2 @ ccdiv) @ (cco @ (ccfv @ XN @ ccppi) @ (cco @ (ccfv @ XN @ cclog) @ XN @ ccdiv) @ ccmul) @ cclt)))))).
