...
thf(adf_plt_ax,axiom,(cwceq @ ccplt @ (ccmpt @ (^ [Xp:$i] : ccvv) @ (^ [Xp:$i] : (ccdif @ (ccfv @ (ccv @ Xp) @ ccple) @ ccid))))).
...
thf(cpltfval_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => (cwi @ (cwcel @ XK @ XA2) @ (cwceq @ Xc_lt @ (ccdif @ Xc_le @ ccid)))))))))).
