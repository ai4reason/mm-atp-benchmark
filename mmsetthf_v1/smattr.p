...
thf(afzssnn_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XM @ ccn) @ (cwss @ (cco @ XM @ XN @ ccfz) @ ccn))))).
...
thf(csmattr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (cco @ XK @ XL @ (ccfv @ XA2 @ ccsmat))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XN @ ccfz)) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ XK @ XM @ ccfz))) => ((cwi @ Xph @ (cwcel @ XJ @ (cco @ cc1 @ XL @ ccfzo))) => (cwi @ Xph @ (cwceq @ (cco @ XI @ XJ @ XS) @ (cco @ (cco @ XI @ cc1 @ ccaddc) @ XJ @ XA2)))))))))))))))))))))).
