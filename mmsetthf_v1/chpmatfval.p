...
thf(adf_chpmat_ax,axiom,(cwceq @ ccchpmat @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccfn)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccmpt @ (^ [Xm:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ ccbs)) @ (^ [Xm:$i] : (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xr) @ ccv1) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccmat) @ ccur) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccmat) @ ccvsca)) @ (ccfv @ (ccv @ Xm) @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat2pmat)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccmat) @ ccsg)) @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccmdat))))))))).
...
thf(cchpmatfval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xm:$i] : (cwceq @ (XC @ Xm) @ (cco @ XN @ XR @ ccchpmat))) => ((! [Xm:$i] : (cwceq @ (XA2 @ Xm) @ (cco @ XN @ XR @ ccmat))) => ((! [Xm:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xm) @ ccbs))) => ((! [Xm:$i] : (cwceq @ (XP @ Xm) @ (ccfv @ XR @ ccpl1))) => ((! [Xm:$i] : (cwceq @ (XY @ Xm) @ (cco @ XN @ (XP @ Xm) @ ccmat))) => ((! [Xm:$i] : (cwceq @ XD @ (cco @ XN @ (XP @ Xm) @ ccmdat))) => ((! [Xm:$i] : (cwceq @ Xc_mi @ (ccfv @ (XY @ Xm) @ ccsg))) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((! [Xm:$i] : (cwceq @ Xc_x @ (ccfv @ (XY @ Xm) @ ccvsca))) => ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => ((! [Xm:$i] : (cwceq @ Xc_1 @ (ccfv @ (XY @ Xm) @ ccur))) => (! [Xm:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ (XV @ Xm))) @ (cwceq @ (XC @ Xm) @ (ccmpt @ (^ [Xm:$i] : XB2) @ (^ [Xm:$i] : (ccfv @ (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (ccfv @ (ccv @ Xm) @ XT) @ Xc_mi) @ XD)))))))))))))))))))))))))))))))).
