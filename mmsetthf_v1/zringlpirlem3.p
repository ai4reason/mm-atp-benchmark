...
thf(azringlpirlem1_thm,axiom,(! [Xph:$o] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwcel @ XI @ (ccfv @ czring @ cclidl))) => ((cwi @ Xph @ (cwne @ XI @ (ccsn @ ccc0))) => (cwi @ Xph @ (cwne @ (ccin @ XI @ ccn) @ cc0))))))).
...
thf(azringlpirlem2_thm,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwcel @ XI @ (ccfv @ czring @ cclidl))) => ((cwi @ Xph @ (cwne @ XI @ (ccsn @ ccc0))) => ((cwceq @ XG @ (ccinf @ (ccin @ XI @ ccn) @ ccr @ cclt)) => (cwi @ Xph @ (cwcel @ XG @ XI))))))))).
...
thf(czringlpirlem3_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XI @ (ccfv @ czring @ cclidl))) => ((cwi @ Xph @ (cwne @ XI @ (ccsn @ ccc0))) => ((cwceq @ XG @ (ccinf @ (ccin @ XI @ ccn) @ ccr @ cclt)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => (cwi @ Xph @ (cwbr @ XG @ XX @ ccdvds))))))))))).
