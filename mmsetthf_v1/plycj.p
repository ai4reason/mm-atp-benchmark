...
thf(cplycj_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (cccom @ (cccom @ cccj @ XF) @ cccj))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ cccj) @ XS))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccply))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ (ccfv @ XS @ ccply)))))))))))))).
