...
thf(csupp0cosupp0_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XG @ XW)) @ (cwi @ (cwceq @ (cco @ XF @ XZ @ ccsupp) @ cc0) @ (cwceq @ (cco @ (cccom @ XF @ XG) @ XZ @ ccsupp) @ cc0))))))))).
