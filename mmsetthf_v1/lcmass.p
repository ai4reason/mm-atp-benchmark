...
thf(alcmeq0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwceq @ (cco @ XM @ XN @ cclcm) @ ccc0) @ (cwo @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0))))))).
...
thf(alcmdvdsb_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwa @ (cwbr @ XM @ XK @ ccdvds) @ (cwbr @ XN @ XK @ ccdvds)) @ (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccdvds))))))).
...
thf(clcmass_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XP @ ccz)) @ (cwceq @ (cco @ (cco @ XN @ XM @ cclcm) @ XP @ cclcm) @ (cco @ XN @ (cco @ XM @ XP @ cclcm) @ cclcm))))))).
