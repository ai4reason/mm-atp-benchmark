...
thf(amodprmn0modprm0_thm,axiom,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccz) @ (cwne @ (cco @ XN @ XP @ ccmo) @ ccc0)) @ (cwi @ (cwcel @ XI @ (cco @ ccc0 @ XP @ ccfzo)) @ (cwrex @ (^ [Xj:$i] : (cwceq @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XN @ ccmul) @ ccaddc) @ XP @ ccmo) @ ccc0)) @ (^ [Xj:$i] : (cco @ ccc0 @ XP @ ccfzo))))))))).
...
thf(acshweqrep_thm,axiom,(! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ ccz)) @ (cwi @ (cwa @ (cwceq @ (cco @ XW @ XL @ cccsh) @ XW) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwral @ (^ [Xj:$i] : (cwceq @ (ccfv @ XI @ XW) @ (ccfv @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XL @ ccmul) @ ccaddc) @ (ccfv @ XW @ cchash) @ ccmo) @ XW))) @ (^ [Xj:$i] : ccn0))))))))).
...
thf(ccshwsidrepsw_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime)) @ (cwi @ (cw3a @ (cwcel @ XL @ ccz) @ (cwne @ (cco @ XL @ (ccfv @ XW @ cchash) @ ccmo) @ ccc0) @ (cwceq @ (cco @ XW @ XL @ cccsh) @ XW)) @ (cwceq @ XW @ (cco @ (ccfv @ ccc0 @ XW) @ (ccfv @ XW @ cchash) @ ccreps)))))))).
