...
thf(aiundomg_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XC @ (XB2 @ Xx3) @ ccmap))) @ (cwacn @ XA2)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ XC @ ccdom)) @ (^ [Xx3:$i] : XA2)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccxp @ XA2 @ XC) @ (cwacn @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccxp @ XA2 @ XC) @ ccdom))))))))))))).
...
thf(aacncc_thm,axiom,(cwceq @ (cwacn @ ccom) @ ccvv)).
...
thf(aacndom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwi @ (cwcel @ XX @ (cwacn @ XB2)) @ (cwcel @ XX @ (cwacn @ XA2)))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(asylancr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(ccsuc_tp,type,(ccsuc : (($i > $o) > ($i > $o)))).
thf(aomex_thm,axiom,(cwcel @ ccom @ ccvv)).
thf(axpdom1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ XV) @ (cwbr @ XA2 @ XB2 @ ccdom)) @ (cwbr @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC) @ ccdom))))))).
...
thf(anumacn_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwi @ (cwcel @ XX @ (ccdm @ cccrd)) @ (cwcel @ XX @ (cwacn @ XA2)))))))).
...
thf(ciunctb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ ccom @ ccdom)) @ (^ [Xx3:$i] : XA2))) @ (cwbr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccom @ ccdom))))).
