...
thf(astirlinglem2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ (XN @ Xn) @ ccn) @ (cwcel @ (ccfv @ (XN @ Xn) @ (XA2 @ Xn)) @ ccrp))))))).
...
thf(astirlinglem12_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XB2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cclog))))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ (cco @ (ccfv @ cc1 @ (XB2 @ Xn)) @ (cco @ cc1 @ cc4 @ ccdiv) @ ccmin) @ (ccfv @ XN @ (XB2 @ Xn)) @ ccle))))))))))).
...
thf(astirlinglem11_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xk @ Xn)) @ cclog)))))) => ((! [Xk:$i] : (cwceq @ (XK @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ ccexp) @ ccmul))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XB2 @ Xk @ Xn)) @ (ccfv @ XN @ (XB2 @ Xk @ Xn)) @ cclt)))))))))))).
thf(abreq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwbr @ XC @ XA2 @ XR) @ (cwbr @ XC @ XB2 @ XR)))))))).
thf(cstirlinglem13_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : ((! [Xn:$i] : (! [Xd:$i] : (cwceq @ (XA2 @ Xn @ Xd) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv)))))) => ((! [Xn:$i] : (! [Xd:$i] : (cwceq @ (XB2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn @ Xd)) @ cclog)))))) => (! [Xn:$i] : (cwrex @ (^ [Xd:$i] : (cwbr @ (XB2 @ Xn) @ (ccv @ Xd) @ ccli)) @ (^ [Xd:$i] : ccr)))))))).
