...
thf(cpmtrprfv_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => (cwi @ (cwa @ (cwcel @ XD @ XV) @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwne @ XX @ XY))) @ (cwceq @ (ccfv @ XX @ (ccfv @ (ccpr @ XX @ XY) @ XT)) @ XY))))))))).
