...
thf(azrhpsgninv_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((cwceq @ XY @ (ccfv @ XR @ cczrh)) => ((cwceq @ XS @ (ccfv @ XN @ ccpsgn)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XF @ XP)) @ (cwceq @ (ccfv @ (cccnv @ XF) @ (cccom @ XY @ XS)) @ (ccfv @ XF @ (cccom @ XY @ XS)))))))))))))).
...
thf(cmdetleib2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XD @ Xx3 @ Xp) @ (cco @ XN @ XR @ ccmdat)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xx3 @ Xp) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xx3 @ Xp) @ ccbs)))) => ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (ccfv @ XR @ cczrh))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccfv @ XN @ ccpsgn))) => ((! [Xx3:$i] : (cwceq @ (Xc_x @ Xx3) @ (ccfv @ XR @ ccmulr))) => ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ XR @ ccmgp))) => (! [Xx3:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) @ (cwceq @ (ccfv @ XM @ (XD @ Xx3 @ Xp)) @ (cco @ XR @ (ccmpt @ (^ [Xp:$i] : XP) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ (cccom @ (XY @ Xx3) @ (XS @ Xx3))) @ (cco @ (XU @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ XM))) @ ccgsu) @ (Xc_x @ Xx3)))) @ ccgsu))))))))))))))))))))))))).
