...
thf(abj_inftyexpiinv_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccinftyexpi) @ cc1st) @ XA2)))).
thf(aeqeq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XC @ XA2) @ (cwceq @ XC @ XB2))))))))).
thf(aadantl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xch @ Xph) @ Xps)))))).
thf(cbj_inftyexpiinj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) @ (cwcel @ XB2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc))) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ ccinftyexpi) @ (ccfv @ XB2 @ ccinftyexpi))))))).
