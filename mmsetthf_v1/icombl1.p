...
thf(aioombl1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwcel @ (cco @ XA2 @ ccpnf @ ccioo) @ (ccdm @ ccvol))))).
thf(aunmbl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ (ccdm @ ccvol))) @ (cwcel @ (ccun @ XA2 @ XB2) @ (ccdm @ ccvol)))))).
thf(cicombl1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (cco @ XA2 @ ccpnf @ ccico) @ (ccdm @ ccvol))))).
