...
thf(ciblcnlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwbr @ ccc0 @ (ccfv @ (XB2 @ Xx3) @ ccre) @ ccle)) @ (ccfv @ (XB2 @ Xx3) @ ccre) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwbr @ ccc0 @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccre)) @ ccle)) @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccre)) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwbr @ ccc0 @ (ccfv @ (XB2 @ Xx3) @ ccim) @ ccle)) @ (ccfv @ (XB2 @ Xx3) @ ccim) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwbr @ ccc0 @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccim)) @ ccle)) @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccim)) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl) @ (cw3a @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmbf) @ (cwa @ (cwcel @ (XR @ Xx3) @ ccr) @ (cwcel @ (XS @ Xx3) @ ccr)) @ (cwa @ (cwcel @ (XT @ Xx3) @ ccr) @ (cwcel @ (XU @ Xx3) @ ccr))))))))))))))))))).
