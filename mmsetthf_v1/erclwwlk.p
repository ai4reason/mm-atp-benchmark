...
thf(aerclwwlkrel_thm,axiom,(! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xw @ Xu @ Xn) @ (ccopab @ (^ [Xu:$i] : (^ [Xw:$i] : (cw3a @ (cwcel @ (ccv @ Xu) @ (ccfv @ (XG @ Xw @ Xu @ Xn) @ ccclwwlk)) @ (cwcel @ (ccv @ Xw) @ (ccfv @ (XG @ Xw @ Xu @ Xn) @ ccclwwlk)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xu) @ (cco @ (ccv @ Xw) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xw) @ cchash) @ ccfz))))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwrel @ (Xc_sm @ Xw @ Xu @ Xn))))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(ccword_tp,type,(ccword : (($i > $o) > ($i > $o)))).
thf(ccvtx_tp,type,(ccvtx : ($i > $o))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(aerclwwlksym_thm,axiom,(! [Xc_sm:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xx3 @ Xy1 @ Xw @ Xu @ Xn) @ (ccopab @ (^ [Xu:$i] : (^ [Xw:$i] : (cw3a @ (cwcel @ (ccv @ Xu) @ (ccfv @ (XG @ Xx3 @ Xy1) @ ccclwwlk)) @ (cwcel @ (ccv @ Xw) @ (ccfv @ (XG @ Xx3 @ Xy1) @ ccclwwlk)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xu) @ (cco @ (ccv @ Xw) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xw) @ cchash) @ ccfz))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_sm @ Xx3 @ Xy1 @ Xw @ Xu @ Xn)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_sm @ Xx3 @ Xy1 @ Xw @ Xu @ Xn)))))))))))).
thf(aerclwwlktr_thm,axiom,(! [Xc_sm:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xn) @ (ccopab @ (^ [Xu:$i] : (^ [Xw:$i] : (cw3a @ (cwcel @ (ccv @ Xu) @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz) @ ccclwwlk)) @ (cwcel @ (ccv @ Xw) @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xz) @ ccclwwlk)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xu) @ (cco @ (ccv @ Xw) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xw) @ cchash) @ ccfz)))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_sm @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xn)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_sm @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xn))) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_sm @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xn))))))))))))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(ccn0_tp,type,(ccn0 : ($i > $o))).
thf(aerclwwlkref_thm,axiom,(! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xx3 @ Xw @ Xu @ Xn) @ (ccopab @ (^ [Xu:$i] : (^ [Xw:$i] : (cw3a @ (cwcel @ (ccv @ Xu) @ (ccfv @ (XG @ Xx3) @ ccclwwlk)) @ (cwcel @ (ccv @ Xw) @ (ccfv @ (XG @ Xx3) @ ccclwwlk)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xu) @ (cco @ (ccv @ Xw) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xw) @ cchash) @ ccfz)))))))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwb @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccclwwlk)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ (Xc_sm @ Xx3 @ Xw @ Xu @ Xn))))))))))).
thf(cerclwwlk_conj,conjecture,(! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : ((! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xw @ Xu @ Xn) @ (ccopab @ (^ [Xu:$i] : (^ [Xw:$i] : (cw3a @ (cwcel @ (ccv @ Xu) @ (ccfv @ XG @ ccclwwlk)) @ (cwcel @ (ccv @ Xw) @ (ccfv @ XG @ ccclwwlk)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xu) @ (cco @ (ccv @ Xw) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xw) @ cchash) @ ccfz))))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwer @ (ccfv @ XG @ ccclwwlk) @ (Xc_sm @ Xw @ Xu @ Xn))))))))).
