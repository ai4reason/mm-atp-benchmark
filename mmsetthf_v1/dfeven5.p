...
thf(aiseven5_thm,axiom,(! [XZ:($i > $o)] : (cwb @ (cwcel @ XZ @ cceven) @ (cwa @ (cwcel @ XZ @ ccz) @ (cwceq @ (cco @ cc2 @ XZ @ ccgcd) @ cc2))))).
...
thf(cdfeven5_conj,conjecture,(cwceq @ cceven @ (ccrab @ (^ [Xz:$i] : (cwceq @ (cco @ cc2 @ (ccv @ Xz) @ ccgcd) @ cc2)) @ (^ [Xz:$i] : ccz)))).
