...
thf(aubthlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwceq @ XX @ (ccfv @ (XU @ Xk) @ ccba))) => ((! [Xz:$i] : (! [Xk:$i] : (cwceq @ XN @ (ccfv @ (XW @ Xz @ Xk) @ ccnmcv)))) => ((! [Xy1:$i] : (! [Xk:$i] : (cwceq @ (XD @ Xy1) @ (ccfv @ (XU @ Xk) @ ccims)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xr:$i] : (! [Xc:$i] : (cwceq @ (XJ @ Xz @ Xr @ Xc) @ (ccfv @ (XD @ Xy1) @ ccmopn)))))) => ((! [Xk:$i] : (cwcel @ (XU @ Xk) @ cccbn)) => ((! [Xz:$i] : (! [Xk:$i] : (cwcel @ (XW @ Xz @ Xk) @ ccnv))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XT @ (cco @ (XU @ Xk) @ (XW @ Xz @ Xk) @ ccblo))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xt)) @ XN) @ (ccv @ Xc) @ ccle)) @ (^ [Xt:$i] : XT))) @ (^ [Xc:$i] : ccr))) @ (^ [Xx3:$i] : XX)))) => ((! [Xt:$i] : (cwceq @ (XA2 @ Xt) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ XN) @ (ccv @ Xk) @ ccle)) @ (^ [Xt:$i] : XT))) @ (^ [Xz:$i] : XX)))))) => (! [Xz:$i] : (! [Xt:$i] : (cwi @ (Xph @ Xz) @ (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xr:$i] : (cwss @ (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (XD @ Xy1)) @ (ccv @ Xr) @ ccle)) @ (^ [Xz:$i] : XX)) @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xt)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xy1:$i] : XX))) @ (^ [Xn:$i] : ccn)))))))))))))))))))))))).
...
thf(anmoxr_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwf @ XX @ XY @ XT)) @ (cwcel @ (ccfv @ XT @ XN) @ ccxr)))))))))))).
thf(asimpllr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xps)))))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(ccpnf_tp,type,(ccpnf : ($i > $o))).
thf(anmogtmnf_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwf @ XX @ XY @ XT)) @ (cwbr @ ccmnf @ (ccfv @ XT @ XN) @ cclt)))))))))))).
