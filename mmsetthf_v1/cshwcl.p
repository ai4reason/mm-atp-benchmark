...
thf(acshnz_thm,axiom,(! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwn @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XW @ XN @ cccsh) @ cc0))))).
thf(awrd0_thm,axiom,(! [XS:($i > $o)] : (cwcel @ cc0 @ (ccword @ XS)))).
thf(ccshwcl_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (cco @ XW @ XN @ cccsh) @ (ccword @ XV))))))).
