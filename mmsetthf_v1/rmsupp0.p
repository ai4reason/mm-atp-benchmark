...
thf(crmsupp0_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XR @ (ccfv @ XM @ ccbs)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XM @ ccrg) @ (cwcel @ XV @ XX) @ (cwceq @ XC @ (ccfv @ XM @ cc0g))) @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap))) @ (cwceq @ (cco @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (cco @ XC @ (ccfv @ (ccv @ Xv) @ XA2) @ (ccfv @ XM @ ccmulr)))) @ (ccfv @ XM @ cc0g) @ ccsupp) @ cc0)))))))))).
