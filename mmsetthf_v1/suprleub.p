...
thf(asuprnub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccr)) @ (cwb @ (cwn @ (cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccsup @ XA2 @ ccr @ cclt) @ cclt)) @ (cwral @ (^ [Xz:$i] : (cwn @ (cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccv @ Xz) @ cclt))) @ (^ [Xz:$i] : XA2))))))))).
...
thf(csuprleub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccr)) @ (cwb @ (cwbr @ (ccsup @ XA2 @ ccr @ cclt) @ (XB2 @ Xx3 @ Xy1) @ ccle) @ (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (XB2 @ Xx3 @ Xy1) @ ccle)) @ (^ [Xz:$i] : XA2))))))))).
