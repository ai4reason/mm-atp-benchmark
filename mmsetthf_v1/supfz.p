...
thf(asupmax_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwor @ XA2 @ XR)) => ((cwi @ Xph @ (cwcel @ XC @ XA2)) => ((cwi @ Xph @ (cwcel @ XC @ XB2)) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwn @ (cwbr @ XC @ (ccv @ Xy1) @ XR)))) => (cwi @ Xph @ (cwceq @ (ccsup @ XB2 @ XA2 @ XR) @ XC)))))))))))).
...
thf(csupfz_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (ccsup @ (cco @ XM @ XN @ ccfz) @ ccz @ cclt) @ XN))))).
