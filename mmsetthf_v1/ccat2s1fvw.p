...
thf(accat2s1cl_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) @ (cwcel @ (cco @ (ccs1 @ XX) @ (ccs1 @ XY) @ ccconcat) @ (ccword @ XV))))))).
...
thf(cccat2s1fvw_conj,conjecture,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XI @ ccn0) @ (cwbr @ XI @ (ccfv @ XW @ cchash) @ cclt)) @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV))) @ (cwceq @ (ccfv @ XI @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat)) @ (ccfv @ XI @ XW))))))))).
