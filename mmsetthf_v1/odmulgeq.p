...
thf(aodmulg2_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) @ (cwbr @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ (ccfv @ XA2 @ XO) @ ccdvds)))))))))))).
...
thf(codmulgeq_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) @ (cwb @ (cwceq @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ (ccfv @ XA2 @ XO)) @ (cwceq @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) @ cc1))))))))))))).
