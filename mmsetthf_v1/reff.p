...
thf(creff_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccref) @ (cwa @ (cwss @ (ccuni @ XB2) @ (ccuni @ XA2)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XA2 @ XB2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xv:$i] : (cwss @ (ccv @ Xv) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xf1)))) @ (^ [Xv:$i] : XA2)))))))))))).
