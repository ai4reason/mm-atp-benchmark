...
thf(cssdf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccv @ Xx3) @ XB2))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ XB2))))))))).
