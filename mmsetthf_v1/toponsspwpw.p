...
thf(apwpwssunieq_thm,axiom,(! [XA2:($i > $o)] : (cwss @ (ccab @ (^ [Xx3:$i] : (cwceq @ (ccuni @ (ccv @ Xx3)) @ XA2))) @ (ccpw @ (ccpw @ XA2))))).
...
thf(adf_topon_ax,axiom,(cwceq @ cctopon @ (ccmpt @ (^ [Xb:$i] : ccvv) @ (^ [Xb:$i] : (ccrab @ (^ [Xj:$i] : (cwceq @ (ccv @ Xb) @ (ccuni @ (ccv @ Xj)))) @ (^ [Xj:$i] : cctop)))))).
