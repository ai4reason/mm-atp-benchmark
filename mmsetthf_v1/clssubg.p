...
thf(atxcls_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ (ccfv @ XX @ cctopon)) @ (cwcel @ XS @ (ccfv @ XY @ cctopon))) @ (cwa @ (cwss @ XA2 @ XX) @ (cwss @ XB2 @ XY))) @ (cwceq @ (ccfv @ (ccxp @ XA2 @ XB2) @ (ccfv @ (cco @ XR @ XS @ cctx) @ cccl)) @ (ccxp @ (ccfv @ XA2 @ (ccfv @ XR @ cccl)) @ (ccfv @ XB2 @ (ccfv @ XS @ cccl)))))))))))).
...
thf(afunimass5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ XA2 @ (ccdm @ XF))) @ (cwb @ (cwss @ XA2 @ (ccima @ (cccnv @ XF) @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(cclssubg_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwi @ (cwa @ (cwcel @ XG @ cctgp) @ (cwcel @ XS @ (ccfv @ XG @ ccsubg))) @ (cwcel @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XG @ ccsubg)))))))).
