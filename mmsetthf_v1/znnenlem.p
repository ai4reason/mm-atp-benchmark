...
thf(azneo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwne @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (cco @ cc2 @ XB2 @ ccmul) @ cc1 @ ccaddc)))))).
...
thf(cznnenlem_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwa @ (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle) @ (cwn @ (cwbr @ ccc0 @ (ccv @ Xy1) @ ccle))) @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccz) @ (cwcel @ (ccv @ Xy1) @ ccz))) @ (cwb @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ (ccneg @ cc2) @ (ccv @ Xy1) @ ccmul) @ cc1 @ ccaddc))))))).
