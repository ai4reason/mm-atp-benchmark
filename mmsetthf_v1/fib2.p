...
thf(afibp1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfib) @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfib) @ (ccfv @ XN @ ccfib) @ ccaddc))))).
...
thf(afib0_thm,axiom,(cwceq @ (ccfv @ ccc0 @ ccfib) @ ccc0)).
thf(afib1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccfib) @ cc1)).
thf(a_0p1e1_thm,axiom,(cwceq @ (cco @ ccc0 @ cc1 @ ccaddc) @ cc1)).
thf(cfib2_conj,conjecture,(cwceq @ (ccfv @ cc2 @ ccfib) @ cc1)).
