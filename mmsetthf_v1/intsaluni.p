...
thf(cintsaluni_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XG @ ccsalg)) => ((cwi @ Xph @ (cwne @ XG @ cc0)) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xs1) @ XG)) @ (cwceq @ (ccuni @ (ccv @ Xs1)) @ XX))) => (cwi @ Xph @ (cwceq @ (ccuni @ (ccint @ XG)) @ XX))))))))).
