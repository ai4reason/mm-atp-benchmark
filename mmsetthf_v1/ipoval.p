...
thf(adf_ipo_ax,axiom,(cwceq @ ccipo @ (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (ccsb @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xf1)) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xo:$i] : (ccun @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccv @ Xf1)) @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ (ccv @ Xo) @ ccordt))) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccple) @ (ccv @ Xo)) @ (ccop @ (ccfv @ ccnx @ ccoc) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xf1)) @ (^ [Xx3:$i] : (ccuni @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (ccin @ (ccv @ Xy1) @ (ccv @ Xx3)) @ cc0)) @ (^ [Xy1:$i] : (ccv @ Xf1))))))))))))))).
