...
thf(crppwr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XN @ ccn)) @ (cwi @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwceq @ (cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccgcd) @ cc1))))))).
