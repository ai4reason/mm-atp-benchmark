...
thf(ahsphoival_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xa:$i] : (cwceq @ (XH @ Xx3 @ Xj @ Xa) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xa:$i] : (cco @ ccr @ XX @ ccmap)) @ (^ [Xa:$i] : (ccmpt @ (^ [Xj:$i] : XX) @ (^ [Xj:$i] : (ccif @ (cwcel @ (ccv @ Xj) @ XY) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xa)) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ (ccv @ Xa)) @ (ccv @ Xx3) @ ccle) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xa)) @ (ccv @ Xx3))))))))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xa:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3 @ Xj @ Xa)))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xx3 @ Xa) @ XX)))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xa:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XK @ Xx3 @ Xa) @ (ccfv @ (XB2 @ Xx3) @ (ccfv @ XA2 @ (XH @ Xx3 @ Xj @ Xa)))) @ (ccif @ (cwcel @ (XK @ Xx3 @ Xa) @ XY) @ (ccfv @ (XK @ Xx3 @ Xa) @ (XB2 @ Xx3)) @ (ccif @ (cwbr @ (ccfv @ (XK @ Xx3 @ Xa) @ (XB2 @ Xx3)) @ XA2 @ ccle) @ (ccfv @ (XK @ Xx3 @ Xa) @ (XB2 @ Xx3)) @ XA2))))))))))))))))))))).
