...
thf(aac6sf2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xy1:$i] : (XB2 @ Xy1))) => ((! [Xx3:$i] : (! [Xf1:$i] : (cwnf @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xf1))))) => ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1 @ Xf1)))))) => (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (XA2 @ Xy1) @ (XB2 @ Xy1) @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1 @ Xf1)) @ (^ [Xx3:$i] : (XA2 @ Xy1))))))))))))))))).
thf(cacunirnmpt2f_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xj) @ (XV @ Xx3 @ Xf1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ (XA2 @ Xj))) @ (cwne @ (XB2 @ Xx3 @ Xj) @ cc0)))) => ((cwnfc @ (^ [Xj:$i] : (XA2 @ Xj))) => ((cwnfc @ (^ [Xj:$i] : (XC @ Xj))) => ((! [Xx3:$i] : (! [Xf1:$i] : (cwnfc @ (^ [Xj:$i] : (XD @ Xx3 @ Xf1 @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XC @ Xj) @ (cciun @ (^ [Xj:$i] : (XA2 @ Xj)) @ (^ [Xj:$i] : (XB2 @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) @ (cwceq @ (XB2 @ Xx3 @ Xj) @ (XD @ Xx3 @ Xf1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ (XA2 @ Xj))) @ (cwcel @ (XB2 @ Xx3 @ Xj) @ (XW @ Xx3 @ Xf1 @ Xj)))))) => (! [Xj:$i] : (cwi @ Xph @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (XC @ Xj) @ (XA2 @ Xj) @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XD @ Xx3 @ Xf1 @ Xj))) @ (^ [Xx3:$i] : (XC @ Xj)))))))))))))))))))))))).
