...
thf(cackbij1lem18_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwi @ (cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ (cwrex @ (^ [Xb:$i] : (cwceq @ (ccfv @ (ccv @ Xb) @ XF) @ (ccsuc @ (ccfv @ XA2 @ XF)))) @ (^ [Xb:$i] : (ccin @ (ccpw @ ccom) @ ccfn)))))))).
