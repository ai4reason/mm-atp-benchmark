...
thf(crusgrnumwrdl2_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (! [Xw:$i] : (cwi @ (cwa @ (cwbr @ XG @ (XK @ Xw) @ ccrusgr) @ (cwcel @ XP @ XV)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xw:$i] : (cw3a @ (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ cc2) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XP) @ (cwcel @ (ccpr @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ cc1 @ (ccv @ Xw))) @ (ccfv @ XG @ ccedg)))) @ (^ [Xw:$i] : (ccword @ XV))) @ cchash) @ (XK @ Xw)))))))))).
