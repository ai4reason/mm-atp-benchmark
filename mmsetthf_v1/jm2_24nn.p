...
thf(armym1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmy) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmx) @ ccmin)))))).
...
thf(cjm2_24nn_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn)) @ (cwbr @ (cco @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccaddc) @ (cco @ XA2 @ XN @ ccrmx) @ cclt))))).
