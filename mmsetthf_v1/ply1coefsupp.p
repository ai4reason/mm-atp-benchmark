...
thf(cply1coefsupp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((! [Xk:$i] : (cwceq @ (XX @ Xk) @ (ccfv @ XR @ ccv1))) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((! [Xk:$i] : (cwceq @ (XM @ Xk) @ (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (cwceq @ (Xc_ex @ Xk) @ (ccfv @ (XM @ Xk) @ ccmg))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccco1)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ XB2)) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xk) @ (XX @ Xk) @ (Xc_ex @ Xk)) @ Xc_x))) @ (ccfv @ XP @ cc0g) @ ccfsupp))))))))))))))))))).
