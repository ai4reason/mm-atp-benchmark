...
thf(acnvcnv3_thm,axiom,(! [XR:($i > $o)] : (cwceq @ (cccnv @ (cccnv @ XR)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))))))).
thf(cdfrel4v_conj,conjecture,(! [XR:($i > $o)] : (cwb @ (cwrel @ XR) @ (cwceq @ XR @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR)))))))).
