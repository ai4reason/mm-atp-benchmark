...
thf(ccaragenunidm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => (cwi @ Xph @ (cwcel @ XX @ XS)))))))))).
