...
thf(cestrreslem1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwceq @ XC @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ (ccop @ (ccfv @ ccnx @ ccco) @ Xc_x)))) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => (cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XC @ ccbs)))))))))))).
