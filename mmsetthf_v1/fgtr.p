...
thf(atrfilss_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ XA2 @ XF)) @ (cwss @ (cco @ XF @ XA2 @ ccrest) @ XF)))))).
...
thf(cfgtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ XA2 @ XF)) @ (cwceq @ (cco @ XX @ (cco @ XF @ XA2 @ ccrest) @ ccfg) @ XF)))))).
