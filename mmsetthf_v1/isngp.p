...
thf(adf_ngp_ax,axiom,(cwceq @ ccngp @ (ccrab @ (^ [Xg1:$i] : (cwss @ (cccom @ (ccfv @ (ccv @ Xg1) @ ccnm) @ (ccfv @ (ccv @ Xg1) @ ccsg)) @ (ccfv @ (ccv @ Xg1) @ ccds))) @ (^ [Xg1:$i] : (ccin @ ccgrp @ ccmt))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cisngp_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => (cwb @ (cwcel @ XG @ ccngp) @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XG @ ccmt) @ (cwss @ (cccom @ XN @ Xc_mi) @ XD))))))))))).
