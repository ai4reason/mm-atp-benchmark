...
thf(as1dm_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccdm @ (ccs1 @ XA2)) @ (ccsn @ ccc0)))).
thf(cwlk2v2elem1_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccs1 @ (ccpr @ XX @ XY))) => ((cwceq @ XF @ (ccs2 @ ccc0 @ ccc0)) => (cwcel @ XF @ (ccword @ (ccdm @ XI)))))))))).
