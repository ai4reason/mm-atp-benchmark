...
thf(cndmovrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ (ccdm @ XF) @ (ccxp @ XS @ XS)) => ((cwn @ (cwcel @ cc0 @ XS)) => (cwi @ (cwcel @ (cco @ XA2 @ XB2 @ XF) @ XS) @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS)))))))))).
