...
thf(cmapdhval_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xh:$i] : (cwceq @ (XQ @ Xh) @ (ccfv @ (XC @ Xx3 @ Xh) @ cc0g)))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwceq @ (XI @ Xx3 @ Xh) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (Xc_0 @ Xh)) @ (XQ @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccsn @ (ccfv @ (ccv @ Xx3) @ cc2nd)) @ (XN @ Xh)) @ (XM @ Xh)) @ (ccfv @ (ccsn @ (ccv @ Xh)) @ (XJ @ Xh))) @ (cwceq @ (ccfv @ (ccfv @ (ccsn @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (Xc_mi @ Xh))) @ (XN @ Xh)) @ (XM @ Xh)) @ (ccfv @ (ccsn @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc2nd) @ (ccv @ Xh) @ (XR @ Xh))) @ (XJ @ Xh))))) @ (^ [Xh:$i] : (XD @ Xh))))))))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XX @ (XA2 @ Xx3 @ Xh))))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XF @ (XB2 @ Xx3 @ Xh))))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XY @ (XE @ Xx3 @ Xh))))) => (! [Xx3:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ (ccotp @ XX @ XF @ XY) @ (XI @ Xx3 @ Xh)) @ (ccif @ (cwceq @ XY @ (Xc_0 @ Xh)) @ (XQ @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccsn @ XY) @ (XN @ Xh)) @ (XM @ Xh)) @ (ccfv @ (ccsn @ (ccv @ Xh)) @ (XJ @ Xh))) @ (cwceq @ (ccfv @ (ccfv @ (ccsn @ (cco @ XX @ XY @ (Xc_mi @ Xh))) @ (XN @ Xh)) @ (XM @ Xh)) @ (ccfv @ (ccsn @ (cco @ XF @ (ccv @ Xh) @ (XR @ Xh))) @ (XJ @ Xh))))) @ (^ [Xh:$i] : (XD @ Xh))))))))))))))))))))))))))))))).
