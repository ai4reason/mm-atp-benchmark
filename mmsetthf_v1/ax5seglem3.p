...
thf(aax5seglem3a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xj:$i] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee)) @ (cwcel @ XF @ (ccfv @ XN @ ccee)))) @ (cwcel @ (ccv @ Xj) @ (cco @ cc1 @ XN @ ccfz))) @ (cwa @ (cwcel @ (cco @ (ccfv @ (ccv @ Xj) @ XA2) @ (ccfv @ (ccv @ Xj) @ XC) @ ccmin) @ ccr) @ (cwcel @ (cco @ (ccfv @ (ccv @ Xj) @ XD) @ (ccfv @ (ccv @ Xj) @ XF) @ ccmin) @ ccr)))))))))))).
...
thf(aax5seglem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XB2) @ (cco @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ XT @ (ccfv @ (ccv @ Xi) @ XC) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))) @ (cwceq @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xj) @ XA2) @ (ccfv @ (ccv @ Xj) @ XB2) @ ccmin) @ cc2 @ ccexp))) @ (cco @ (cco @ XT @ cc2 @ ccexp) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xj) @ XA2) @ (ccfv @ (ccv @ Xj) @ XC) @ ccmin) @ cc2 @ ccexp))) @ ccmul))))))))).
