...
thf(csymgmov2_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XP @ Xk) @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => (! [Xk:$i] : (cwi @ (cwcel @ XQ @ (XP @ Xk)) @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ XQ) @ (ccv @ Xn))) @ (^ [Xk:$i] : XN))) @ (^ [Xn:$i] : XN))))))))).
