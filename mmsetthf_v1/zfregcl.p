...
thf(aaxreg2_thm,axiom,(! [Xy1:$i] : (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))))))).
...
thf(czfregcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) @ (cwi @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xy1) @ XA2))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))))).
