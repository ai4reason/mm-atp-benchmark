...
thf(cpfxfvlsw_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ (cco @ XW @ XL @ ccpfx) @ cclsw) @ (ccfv @ (cco @ XL @ cc1 @ ccmin) @ XW))))))).
