...
thf(aackbij2lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : (ccpw @ (ccdm @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccfv @ (ccima @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)))))) => (cwi @ (cwcel @ XA2 @ ccom) @ (cwss @ (ccfv @ XA2 @ (ccrdg @ XG @ cc0)) @ (ccfv @ (ccsuc @ XA2) @ (ccrdg @ XG @ cc0)))))))))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(asstr2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwi @ (cwss @ XB2 @ XC) @ (cwss @ XA2 @ XC))))))).
thf(cackbij2lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : (ccpw @ (ccdm @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccfv @ (ccima @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)))))) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwss @ XB2 @ XA2)) @ (cwss @ (ccfv @ XB2 @ (ccrdg @ XG @ cc0)) @ (ccfv @ XA2 @ (ccrdg @ XG @ cc0))))))))))).
