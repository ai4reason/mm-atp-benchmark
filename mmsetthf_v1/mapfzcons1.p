...
thf(cmapfzcons1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (cwceq @ (ccres @ (ccun @ XA2 @ (ccsn @ (ccop @ XM @ XC))) @ (cco @ cc1 @ XN @ ccfz)) @ XA2))))))))).
