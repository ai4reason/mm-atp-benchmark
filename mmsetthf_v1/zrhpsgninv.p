...
thf(czrhpsgninv_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((cwceq @ XY @ (ccfv @ XR @ cczrh)) => ((cwceq @ XS @ (ccfv @ XN @ ccpsgn)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XF @ XP)) @ (cwceq @ (ccfv @ (cccnv @ XF) @ (cccom @ XY @ XS)) @ (ccfv @ XF @ (cccom @ XY @ XS)))))))))))))).
