...
thf(aswrdsb0eq_thm,axiom,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwbr @ XN @ XM @ ccle)) @ (cwceq @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) @ (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr))))))))).
...
thf(aswrdsbslen_thm,axiom,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwa @ (cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle) @ (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) @ (cwceq @ (ccfv @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) @ cchash) @ (ccfv @ (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr) @ cchash))))))))).
...
thf(aswrdlen2_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccword @ XV)) @ (cwa @ (cwcel @ XF @ ccn0) @ (cwcel @ XL @ (ccfv @ XF @ ccuz))) @ (cwbr @ XL @ (ccfv @ XS @ cchash) @ ccle)) @ (cwceq @ (ccfv @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) @ cchash) @ (cco @ XL @ XF @ ccmin)))))))).
...
thf(afzoshftral_thm,axiom,(! [Xph:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XK @ ccz)) @ (cwb @ (cwral @ (^ [Xj:$i] : (Xph @ Xj)) @ (^ [Xj:$i] : (cco @ XM @ XN @ ccfzo))) @ (cwral @ (^ [Xk:$i] : (cwsbc @ (^ [Xj:$i] : (Xph @ Xj)) @ (cco @ (ccv @ Xk) @ XK @ ccmin))) @ (^ [Xk:$i] : (cco @ (cco @ XM @ XK @ ccaddc) @ (cco @ XN @ XK @ ccaddc) @ ccfzo)))))))))).
...
thf(aswrdfv2_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XS @ (ccword @ XV)) @ (cwa @ (cwcel @ XF @ ccn0) @ (cwcel @ XL @ (ccfv @ XF @ ccuz))) @ (cwbr @ XL @ (ccfv @ XS @ cchash) @ ccle)) @ (cwcel @ XX @ (cco @ XF @ XL @ ccfzo))) @ (cwceq @ (ccfv @ (cco @ XX @ XF @ ccmin) @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr)) @ (ccfv @ XX @ XS))))))))).
