...
thf(alhpmcvr5N_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xp:$i] : (cwceq @ (Xc_or @ Xp) @ (ccfv @ XK @ ccjn))) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwn @ (cwbr @ XX @ XW @ Xc_le))) @ (cwa @ (cwcel @ XY @ XB2) @ (cwbr @ (cco @ XX @ XY @ Xc_an) @ XW @ Xc_le))) @ (cwrex @ (^ [Xp:$i] : (cw3a @ (cwn @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)) @ (cwn @ (cwbr @ (ccv @ Xp) @ XY @ Xc_le)) @ (cwceq @ (cco @ (ccv @ Xp) @ (cco @ XX @ XW @ Xc_an) @ (Xc_or @ Xp)) @ XX))) @ (^ [Xp:$i] : XA2)))))))))))))))))))).
...
thf(clhpmcvr6N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xp:$i] : (cwceq @ (Xc_or @ Xp) @ (ccfv @ XK @ ccjn))) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwn @ (cwbr @ XX @ XW @ Xc_le))) @ (cwa @ (cwcel @ XY @ XB2) @ (cwbr @ (cco @ XX @ XY @ Xc_an) @ XW @ Xc_le))) @ (cwrex @ (^ [Xp:$i] : (cw3a @ (cwn @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)) @ (cwn @ (cwbr @ (ccv @ Xp) @ XY @ Xc_le)) @ (cwbr @ (ccv @ Xp) @ XX @ Xc_le))) @ (^ [Xp:$i] : XA2)))))))))))))))))))).
