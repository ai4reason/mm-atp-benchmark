...
thf(crepswsymb_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0) @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XS @ XN @ ccreps)) @ XS))))))).
