...
thf(anacsacs_thm,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XC @ (ccfv @ XX @ ccnacs)) @ (cwcel @ XC @ (ccfv @ XX @ ccacs)))))).
...
thf(aacsdrsel_thm,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccacs)) @ (cwss @ XY @ XC) @ (cwcel @ (ccfv @ XY @ ccipo) @ ccdrs)) @ (cwcel @ (ccuni @ XY) @ XC)))))).
thf(anacsfg_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccnacs)) @ (cwcel @ XS @ XC)) @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XS @ (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(amrefg2_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwb @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XS @ (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn))) @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XS @ (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
...
thf(afissuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ (ccuni @ XB2)) @ (cwcel @ XA2 @ ccfn)) @ (cwrex @ (^ [Xc:$i] : (cwss @ XA2 @ (ccuni @ (ccv @ Xc)))) @ (^ [Xc:$i] : (ccin @ (ccpw @ XB2) @ ccfn))))))).
...
thf(aipodrsfi_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) @ (cwss @ XX @ XA2) @ (cwcel @ XX @ ccfn)) @ (cwrex @ (^ [Xz:$i] : (cwss @ (ccuni @ XX) @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2)))))).
...
thf(aisacs3_thm,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XC @ (ccfv @ XX @ ccacs)) @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) @ (cwcel @ (ccuni @ (ccv @ Xs1)) @ XC))) @ (^ [Xs1:$i] : (ccpw @ XC)))))))).
...
thf(amrcid_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwcel @ XU @ XC)) @ (cwceq @ (ccfv @ XU @ XF) @ XU)))))))).
thf(aacsficld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XX @ ccacs))) => ((cwceq @ XN @ (ccfv @ XA2 @ ccmrc)) => ((cwi @ Xph @ (cwss @ XS @ XX)) => (cwi @ Xph @ (cwceq @ (ccfv @ XS @ XN) @ (ccuni @ (ccima @ XN @ (ccin @ (ccpw @ XS) @ ccfn)))))))))))))).
thf(amress_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwcel @ XS @ XC)) @ (cwss @ XS @ XX)))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(aipodrsima_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwfn @ XF @ (ccpw @ XA2))) => ((! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwss @ (ccv @ Xu) @ (ccv @ Xv)) @ (cwss @ (ccv @ Xv) @ XA2))) @ (cwss @ (ccfv @ (ccv @ Xu) @ XF) @ (ccfv @ (ccv @ Xv) @ XF))))) => ((! [Xv:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XB2 @ Xv @ Xu) @ ccipo) @ ccdrs)))) => ((! [Xv:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwss @ (XB2 @ Xv @ Xu) @ (ccpw @ XA2))))) => ((! [Xv:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (ccima @ XF @ (XB2 @ Xv @ Xu)) @ (XV @ Xv @ Xu))))) => (! [Xv:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (ccima @ XF @ (XB2 @ Xv @ Xu)) @ ccipo) @ ccdrs))))))))))))))).
...
thf(afpwipodrs_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccfv @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccipo) @ ccdrs))))).
...
thf(cisnacs3_conj,conjecture,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XC @ (ccfv @ XX @ ccnacs)) @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) @ (cwcel @ (ccuni @ (ccv @ Xs1)) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ XC)))))))).
