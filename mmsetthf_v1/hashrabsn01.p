...
thf(chashrabsn01_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwceq @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ XA2))) @ cchash) @ (XN @ Xx3)) @ (cwo @ (cwceq @ (XN @ Xx3) @ ccc0) @ (cwceq @ (XN @ Xx3) @ cc1)))))))).
