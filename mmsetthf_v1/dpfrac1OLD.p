...
thf(adfdp2OLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccdp2 @ XA2 @ XB2) @ (cco @ XA2 @ (cco @ XB2 @ cc10 @ ccdiv) @ ccaddc))))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(adpval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccdp) @ (ccdp2 @ XA2 @ XB2)))))).
...
thf(cdpfrac1OLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccdp) @ (cco @ (ccdc @ XA2 @ XB2) @ cc10 @ ccdiv)))))).
