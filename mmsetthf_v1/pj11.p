...
thf(apj11i_thm,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (cwb @ (cwceq @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) @ (cwceq @ XG @ XH))))))).
...
thf(cpj11_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccch) @ (cwcel @ XH @ ccch)) @ (cwb @ (cwceq @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) @ (cwceq @ XG @ XH)))))).
