...
thf(cisexid2_conj,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwcel @ XG @ (ccin @ ccmagm @ ccexid)) @ (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) @ (ccv @ Xx3)) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xu) @ XG) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX))))))).
