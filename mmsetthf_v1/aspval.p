...
thf(adf_asp_ax,axiom,(cwceq @ ccasp @ (ccmpt @ (^ [Xw:$i] : ccasa) @ (^ [Xw:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xs1:$i] : (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ (ccv @ Xs1) @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccin @ (ccfv @ (ccv @ Xw) @ ccsubrg) @ (ccfv @ (ccv @ Xw) @ cclss))))))))))).
...
thf(caspval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xt:$i] : (cwceq @ (XA2 @ Xt) @ (ccfv @ XW @ ccasp))) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => (! [Xt:$i] : (cwi @ (cwa @ (cwcel @ XW @ ccasa) @ (cwss @ XS @ XV)) @ (cwceq @ (ccfv @ XS @ (XA2 @ Xt)) @ (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ XS @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccin @ (ccfv @ XW @ ccsubrg) @ XL)))))))))))))))).
