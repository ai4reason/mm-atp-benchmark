...
thf(aectocl_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccqs @ XB2 @ XR))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccec @ (ccv @ Xx3) @ XR) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XB2) @ (Xph @ Xx3))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XS @ Xx3)) @ Xps)))))))))))).
