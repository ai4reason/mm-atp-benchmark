...
thf(aoecan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccoe) @ (cco @ XA2 @ XC @ ccoe)) @ (cwceq @ XB2 @ XC))))))).
...
thf(cinfxpenc2lem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccon0))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwral @ (^ [Xb:$i] : (cwi @ (cwss @ ccom @ (ccv @ Xb)) @ (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2)))) => ((! [Xn:$i] : (! [Xb:$i] : (cwceq @ (XW @ Xn @ Xb) @ (ccfv @ (ccrn @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccon0 @ cc1o)) @ (^ [Xx3:$i] : (cco @ ccom @ (ccv @ Xx3) @ ccoe)))))))) => (! [Xn:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwa @ (cwcel @ (ccv @ Xb) @ XA2) @ (cwss @ ccom @ (ccv @ Xb)))) @ (cwa @ (cwcel @ (XW @ Xn @ Xb) @ (ccdif @ ccon0 @ cc1o)) @ (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (XW @ Xn @ Xb) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)))))))))))))).
