...
thf(adf_lmim_ax,axiom,(cwceq @ cclmim @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : cclmod)) @ (^ [Xs1:$i] : (^ [Xt:$i] : cclmod)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccrab @ (^ [Xg1:$i] : (cwf1o @ (ccfv @ (ccv @ Xs1) @ ccbs) @ (ccfv @ (ccv @ Xt) @ ccbs) @ (ccv @ Xg1))) @ (^ [Xg1:$i] : (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ cclmhm)))))))).
thf(arabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(clmimfn_conj,conjecture,(cwfn @ cclmim @ (ccxp @ cclmod @ cclmod))).
