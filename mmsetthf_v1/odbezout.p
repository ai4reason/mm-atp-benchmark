...
thf(codbezout_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) @ cc1)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (cco @ XN @ XA2 @ Xc_x) @ Xc_x) @ XA2)) @ (^ [Xx3:$i] : ccz))))))))))))).
