...
thf(chstri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwceq @ (ccfv @ (ccfv @ XA2 @ (ccv @ Xf1)) @ ccno) @ cc1) @ (cwceq @ (ccfv @ (ccfv @ XB2 @ (ccv @ Xf1)) @ ccno) @ cc1))) @ (^ [Xf1:$i] : cchst)) @ (cwss @ XA2 @ XB2))))))).
