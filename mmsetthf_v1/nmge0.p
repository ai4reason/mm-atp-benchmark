...
thf(axmsge0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XM @ ccbs)) => ((cwceq @ XD @ (ccfv @ XM @ ccds)) => (cwi @ (cw3a @ (cwcel @ XM @ ccxme) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ XD) @ ccle)))))))))).
...
thf(cnmge0_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => (cwi @ (cwa @ (cwcel @ XG @ ccngp) @ (cwcel @ XA2 @ XX)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ XN) @ ccle))))))))).
