...
thf(alspidm_thm,axiom,(! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwss @ XU @ XV)) @ (cwceq @ (ccfv @ (ccfv @ XU @ XN) @ XN) @ (ccfv @ XU @ XN)))))))))).
thf(clspun0_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwss @ XX @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccun @ XX @ (ccsn @ Xc_0)) @ XN) @ (ccfv @ XX @ XN))))))))))))))).
