...
thf(amapfzcons_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (cwcel @ XC @ XB2)) @ (cwcel @ (ccun @ XA2 @ (ccsn @ (ccop @ XM @ XC))) @ (cco @ XB2 @ (cco @ cc1 @ XM @ ccfz) @ ccmap)))))))))).
...
thf(amapfzcons2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (cwcel @ XC @ XB2)) @ (cwceq @ (ccfv @ XM @ (ccun @ XA2 @ (ccsn @ (ccop @ XM @ XC)))) @ XC))))))))).
...
thf(amapfzcons1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (cwceq @ (ccres @ (ccun @ XA2 @ (ccsn @ (ccop @ XM @ XC))) @ (cco @ cc1 @ XN @ ccfz)) @ XA2))))))))).
...
thf(amapfzcons1cl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ XM @ ccfz) @ ccmap)) @ (cwcel @ (ccres @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))))))))).
