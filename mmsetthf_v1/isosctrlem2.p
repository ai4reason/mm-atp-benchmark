...
thf(anegrebd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ (ccneg @ XA2) @ ccr)) => (cwi @ Xph @ (cwcel @ XA2 @ ccr))))))).
...
thf(acjnegd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccneg @ XA2) @ cccj) @ (ccneg @ (ccfv @ XA2 @ cccj)))))))).
...
thf(asyl3an3br_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwb @ Xth @ Xph) => ((cwi @ (cw3a @ Xps @ Xch @ Xth) @ Xta) => (cwi @ (cw3a @ Xps @ Xch @ Xph) @ Xta))))))))).
...
thf(acjne0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => (cwi @ Xph @ (cwne @ (ccfv @ XA2 @ cccj) @ ccc0))))))).
...
thf(alogcj_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccim) @ ccc0)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cccj) @ cclog) @ (ccfv @ (ccfv @ XA2 @ cclog) @ cccj))))).
...
thf(aisosctrlem1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ cc1) @ (cwn @ (cwceq @ cc1 @ XA2))) @ (cwne @ (ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) @ ccpi)))).
thf(alogrec_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccpi)) @ (cwceq @ (ccfv @ XA2 @ cclog) @ (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccdiv) @ cclog)))))).
...
thf(cisosctrlem2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ cc1) @ (cwn @ (cwceq @ cc1 @ XA2))) @ (cwceq @ (ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) @ (ccfv @ (ccfv @ (cco @ (ccneg @ XA2) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ cclog) @ ccim))))).
