...
thf(cofresid_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XG)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XG @ (ccof @ XR)) @ (cco @ XF @ XG @ (ccof @ (ccres @ XR @ (ccxp @ XB2 @ XB2))))))))))))))))).
