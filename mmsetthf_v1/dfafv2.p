...
thf(adf_afv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccafv @ XA2 @ XF) @ (ccif @ (cwdfat @ XA2 @ XF) @ (ccio @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))) @ ccvv))))).
...
thf(cdfafv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccafv @ XA2 @ XF) @ (ccif @ (cwdfat @ XA2 @ XF) @ (ccfv @ XA2 @ XF) @ ccvv))))).
