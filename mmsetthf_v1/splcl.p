...
thf(csplcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XR @ (ccword @ XA2))) @ (cwcel @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) @ (ccword @ XA2))))))))).
