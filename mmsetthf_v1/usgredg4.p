...
thf(ausgredg3_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (ccfv @ XX @ XE) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV)))))))))).
...
thf(cusgredg4_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE)) @ (cwcel @ XY @ (ccfv @ XX @ XE))) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccfv @ XX @ XE) @ (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XV))))))))))).
