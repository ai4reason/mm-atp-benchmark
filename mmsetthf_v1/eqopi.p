...
thf(ceqopi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccxp @ XV @ XW)) @ (cwa @ (cwceq @ (ccfv @ XA2 @ cc1st) @ XB2) @ (cwceq @ (ccfv @ XA2 @ cc2nd) @ XC))) @ (cwceq @ XA2 @ (ccop @ XB2 @ XC))))))))).
