...
thf(caddcnlem_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwf @ (ccxp @ ccc @ ccc) @ ccc @ Xc_pl) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (cw3a @ (cwcel @ (ccv @ Xa) @ ccrp) @ (cwcel @ (ccv @ Xb) @ ccc) @ (cwcel @ (ccv @ Xc) @ ccc)) @ (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwi @ (cwa @ (cwbr @ (ccfv @ (cco @ (ccv @ Xu) @ (ccv @ Xb) @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xv) @ (ccv @ Xc) @ ccmin) @ ccabs) @ (ccv @ Xz) @ cclt)) @ (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ Xc_pl) @ (cco @ (ccv @ Xb) @ (ccv @ Xc) @ Xc_pl) @ ccmin) @ ccabs) @ (ccv @ Xa) @ cclt))) @ (^ [Xv:$i] : ccc))) @ (^ [Xu:$i] : ccc))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : ccrp)))))) => (cwcel @ Xc_pl @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn)))))))).
