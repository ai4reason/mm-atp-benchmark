...
thf(anlly2i_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccnlly @ XA2)) @ (cwcel @ XU @ XJ) @ (cwcel @ XP @ XU)) @ (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwcel @ XP @ (ccv @ Xu)) @ (cwss @ (ccv @ Xu) @ (ccv @ Xs1)) @ (cwcel @ (cco @ XJ @ (ccv @ Xs1) @ ccrest) @ XA2))) @ (^ [Xu:$i] : XJ))) @ (^ [Xs1:$i] : (ccpw @ XU))))))))).
...
thf(acmpcovf_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwceq @ (XX @ Xy1 @ Xz @ Xf1) @ (ccuni @ (XJ @ Xf1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xy1 @ Xz) @ (Xps @ Xx3 @ Xy1 @ Xf1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ (XJ @ Xf1) @ cccmp) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwrex @ (^ [Xz:$i] : (Xph @ Xy1 @ Xz)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : (XJ @ Xf1)))) @ (^ [Xx3:$i] : (XX @ Xy1 @ Xz @ Xf1)))) @ (cwrex @ (^ [Xs1:$i] : (cwa @ (cwceq @ (XX @ Xy1 @ Xz @ Xf1) @ (ccuni @ (ccv @ Xs1))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (ccv @ Xs1) @ XA2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xf1)) @ (^ [Xy1:$i] : (ccv @ Xs1)))))))) @ (^ [Xs1:$i] : (ccin @ (ccpw @ (XJ @ Xf1)) @ ccfn)))))))))))))))).
...
thf(afiuncmp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (ccuni @ XJ))) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ XJ @ (XB2 @ Xx3) @ ccrest) @ cccmp)) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ (cco @ XJ @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccrest) @ cccmp)))))))).
...
thf(cxkococnlem_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwceq @ (XF @ Xf1 @ Xg1 @ Xh) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (XS @ Xh) @ XT @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XR @ (XS @ Xh) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1))))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwcel @ (XS @ Xh) @ (ccnlly @ cccmp))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwss @ (XK @ Xf1 @ Xg1) @ (ccuni @ XR))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwcel @ (cco @ XR @ (XK @ Xf1 @ Xg1) @ ccrest) @ cccmp)))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwcel @ (XV @ Xf1 @ Xg1) @ XT)))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwcel @ (XA2 @ Xf1 @ Xg1 @ Xh) @ (cco @ (XS @ Xh) @ XT @ cccn))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwcel @ (XB2 @ Xf1 @ Xg1 @ Xh) @ (cco @ XR @ (XS @ Xh) @ cccn))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwss @ (ccima @ (cccom @ (XA2 @ Xf1 @ Xg1 @ Xh) @ (XB2 @ Xf1 @ Xg1 @ Xh)) @ (XK @ Xf1 @ Xg1)) @ (XV @ Xf1 @ Xg1))))))) => (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xf1 @ Xg1 @ Xh) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccop @ (XA2 @ Xf1 @ Xg1 @ Xh) @ (XB2 @ Xf1 @ Xg1 @ Xh)) @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccima @ (cccnv @ (XF @ Xf1 @ Xg1 @ Xh)) @ (ccrab @ (^ [Xh:$i] : (cwss @ (ccima @ (ccv @ Xh) @ (XK @ Xf1 @ Xg1)) @ (XV @ Xf1 @ Xg1))) @ (^ [Xh:$i] : (cco @ XR @ XT @ cccn))))))) @ (^ [Xz:$i] : (cco @ (cco @ XT @ (XS @ Xh) @ ccxko) @ (cco @ (XS @ Xh) @ XR @ ccxko) @ cctx)))))))))))))))))))))))))).
