...
thf(aeulerth_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwceq @ (cco @ (cco @ XA2 @ (ccfv @ XN @ ccphi) @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo)))))).
...
thf(clgslem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwn @ (cwbr @ XP @ XA2 @ ccdvds))) @ (cwcel @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ XP @ ccmo) @ (ccpr @ ccc0 @ cc2)))))).
