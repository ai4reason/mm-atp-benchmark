...
thf(cdvsinexp_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ XN @ ccexp))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ XN @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccos) @ ccmul))))))))).
