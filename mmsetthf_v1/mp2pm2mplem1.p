...
thf(cmp2pm2mplem1_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk @ Xp) @ (cco @ (XN @ Xk) @ (XR @ Xi @ Xj @ Xk) @ ccmat)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk @ Xp) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xp) @ ccpl1)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XL @ Xi @ Xj @ Xk) @ (ccfv @ (XQ @ Xi @ Xj @ Xk @ Xp) @ ccbs)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (Xc_x @ Xi @ Xj @ Xk) @ (ccfv @ (XP @ Xi @ Xj @ Xk) @ ccvsca))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XE @ Xi @ Xj @ Xk) @ (ccfv @ (ccfv @ (XP @ Xi @ Xj @ Xk) @ ccmgp) @ ccmg))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XY @ Xi @ Xj @ Xk) @ (ccfv @ (XR @ Xi @ Xj @ Xk) @ ccv1))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XI @ Xi @ Xj @ Xk @ Xp) @ (ccmpt @ (^ [Xp:$i] : (XL @ Xi @ Xj @ Xk)) @ (^ [Xp:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xk))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xk))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (XP @ Xi @ Xj @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xp) @ ccco1))) @ (cco @ (ccv @ Xk) @ (XY @ Xi @ Xj @ Xk) @ (XE @ Xi @ Xj @ Xk)) @ (Xc_x @ Xi @ Xj @ Xk)))) @ ccgsu))))))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (cwcel @ (XN @ Xk) @ ccfn) @ (cwcel @ (XR @ Xi @ Xj @ Xk) @ ccrg) @ (cwcel @ XO @ (XL @ Xi @ Xj @ Xk))) @ (cwceq @ (ccfv @ XO @ (XI @ Xi @ Xj @ Xk @ Xp)) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xk))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xk))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (XP @ Xi @ Xj @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccfv @ (ccv @ Xk) @ (ccfv @ XO @ ccco1))) @ (cco @ (ccv @ Xk) @ (XY @ Xi @ Xj @ Xk) @ (XE @ Xi @ Xj @ Xk)) @ (Xc_x @ Xi @ Xj @ Xk)))) @ ccgsu))))))))))))))))))))))))))))).
