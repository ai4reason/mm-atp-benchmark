...
thf(cnonsq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwa @ (cwbr @ (cco @ XB2 @ cc2 @ ccexp) @ XA2 @ cclt) @ (cwbr @ XA2 @ (cco @ (cco @ XB2 @ cc1 @ ccaddc) @ cc2 @ ccexp) @ cclt))) @ (cwn @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccq)))))).
