...
thf(adf_mir_ax,axiom,(cwceq @ ccmir @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xm:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)) @ (^ [Xm:$i] : (ccmpt @ (^ [Xa:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)) @ (^ [Xa:$i] : (ccrio @ (^ [Xb:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xm) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ ccds)) @ (cco @ (ccv @ Xm) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xg1) @ ccds))) @ (cwcel @ (ccv @ Xm) @ (cco @ (ccv @ Xb) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xg1) @ ccitv))))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))))))))))).
...
thf(cmirval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XL @ Xy1 @ Xz) @ (ccfv @ XG @ cclng)))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XS @ Xy1 @ Xz) @ (ccfv @ XG @ ccmir)))) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (XS @ Xy1 @ Xz)) @ (ccmpt @ (^ [Xy1:$i] : XP) @ (^ [Xy1:$i] : (ccrio @ (^ [Xz:$i] : (cwa @ (cwceq @ (cco @ XA2 @ (ccv @ Xz) @ Xc_mi) @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi)) @ (cwcel @ XA2 @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))))))))).
