...
thf(cballotlemelo_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XM @ ccn) => ((cwcel @ XN @ ccn) => ((cwceq @ XO @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ cchash) @ XM)) @ (^ [Xc:$i] : (ccpw @ (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz))))) => (! [Xc:$i] : (cwb @ (cwcel @ (XC @ Xc) @ XO) @ (cwa @ (cwss @ (XC @ Xc) @ (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz)) @ (cwceq @ (ccfv @ (XC @ Xc) @ cchash) @ XM)))))))))))).
