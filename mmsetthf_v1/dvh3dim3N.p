...
thf(alspprss_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XX @ XU)) => ((cwi @ Xph @ (cwcel @ XY @ XU)) => (cwi @ Xph @ (cwss @ (ccfv @ (ccpr @ XX @ XY) @ XN) @ XU)))))))))))))))).
...
thf(alspprat_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (ccfv @ XW @ cclss))) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ XU @ (XS @ Xz)))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xz) @ XV))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XY @ Xz) @ XV))) => ((! [Xz:$i] : (cwi @ Xph @ (cwpss @ XU @ (ccfv @ (ccpr @ (XX @ Xz) @ (XY @ Xz)) @ XN)))) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwceq @ XU @ (ccfv @ (ccsn @ (ccv @ Xz)) @ XN))) @ (^ [Xz:$i] : XV)))))))))))))))))))).
...
thf(advh3dim2_thm,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XH @ Xz) @ (ccfv @ (XK @ Xz) @ cclh))) => ((! [Xz:$i] : (cwceq @ XU @ (ccfv @ (XW @ Xz) @ (ccfv @ (XK @ Xz) @ ccdvh)))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ XN @ (ccfv @ XU @ cclspn)) => ((! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XK @ Xz) @ cchlt) @ (cwcel @ (XW @ Xz) @ (XH @ Xz))))) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XX @ XY) @ XN))) @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XX @ XZ) @ XN))))) @ (^ [Xz:$i] : XV)))))))))))))))))))))).
...
thf(alssvancl2_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XX @ XU)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwn @ (cwcel @ XY @ XU))) => (cwi @ Xph @ (cwn @ (cwcel @ (cco @ XY @ XX @ Xc_pl) @ XU)))))))))))))))))))).
...
thf(alssvancl1_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XX @ XU)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwn @ (cwcel @ XY @ XU))) => (cwi @ Xph @ (cwn @ (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XU)))))))))))))))))))).
...
thf(cdvh3dim3N_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XH @ Xz) @ (ccfv @ (XK @ Xz) @ cclh))) => ((! [Xz:$i] : (cwceq @ XU @ (ccfv @ (XW @ Xz) @ (ccfv @ (XK @ Xz) @ ccdvh)))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ XN @ (ccfv @ XU @ cclspn)) => ((! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XK @ Xz) @ cchlt) @ (cwcel @ (XW @ Xz) @ (XH @ Xz))))) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => ((cwi @ Xph @ (cwcel @ XT @ XV)) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XX @ XY) @ XN))) @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XZ @ XT) @ XN))))) @ (^ [Xz:$i] : XV)))))))))))))))))))))))).
