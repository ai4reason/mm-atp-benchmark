...
thf(adf_on_ax,axiom,(cwceq @ ccon0 @ (ccab @ (^ [Xx3:$i] : (cword @ (ccv @ Xx3)))))).
...
thf(atz7_7_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cwtr @ XB2)) @ (cwb @ (cwcel @ XB2 @ XA2) @ (cwa @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ XA2))))))).
...
thf(adfon2lem7_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xx3) @ XA2) @ (cwtr @ (ccv @ Xx3))) @ (cwcel @ (ccv @ Xx3) @ XA2)))) @ (cwi @ (cwcel @ XB2 @ XA2) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ XB2) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ XB2)))))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => (cwi @ Xph @ (cwa @ Xps @ Xch)))))))).
thf(ccint_tp,type,(ccint : (($i > $o) > ($i > $o)))).
thf(adfon2lem9_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XA2)) @ (cwfr @ XA2 @ ccep)))).
...
thf(adfon2lem5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xx3) @ XA2) @ (cwtr @ (ccv @ Xx3))) @ (cwcel @ (ccv @ Xx3) @ XA2)))) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ XB2) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ XB2))))) @ (cw3o @ (cwcel @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2) @ (cwcel @ XB2 @ XA2)))))))).
...
thf(cdfon2_conj,conjecture,(cwceq @ ccon0 @ (ccab @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))).
