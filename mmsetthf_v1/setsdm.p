...
thf(csetsdm_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ XV) @ (cwcel @ XE @ XW)) @ (cwceq @ (ccdm @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts)) @ (ccun @ (ccdm @ XG) @ (ccsn @ XI)))))))))).
