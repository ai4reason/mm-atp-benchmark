...
thf(aax_hvmul0_ax,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwceq @ (cco @ ccc0 @ XA2 @ ccsm) @ cc0v)))).
...
thf(ch1datomi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => (cwi @ (cwss @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) @ (cwo @ (cwceq @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) @ (cwceq @ XA2 @ cc0h)))))))).
