...
thf(aclwwlknun_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwceq @ (cco @ XN @ XG @ ccclwwlkn) @ (cciun @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ (ccfv @ XG @ ccclwwlknon))))))))))).
...
thf(cnumclwwlk4_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ ccn)) @ (cwceq @ (ccfv @ (cco @ XN @ XG @ ccclwwlkn) @ cchash) @ (ccsu @ XV @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XN @ (ccfv @ XG @ ccclwwlknon)) @ cchash)))))))))).
