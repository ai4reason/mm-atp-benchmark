...
thf(cmpteq12f_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (cwi @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (XC @ Xx3)))) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (XD @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (cwceq @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccmpt @ (^ [Xx3:$i] : (XC @ Xx3)) @ (^ [Xx3:$i] : (XD @ Xx3)))))))))).
