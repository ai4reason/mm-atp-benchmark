...
thf(aperfectlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccn)) => ((cwi @ Xph @ (cwn @ (cwbr @ cc2 @ XB2 @ ccdvds))) => ((cwi @ Xph @ (cwceq @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccsgm) @ (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccmul))) => (cwi @ Xph @ (cwa @ (cwcel @ XB2 @ ccprime) @ (cwceq @ XB2 @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin)))))))))))).
...
thf(cperfect_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwb @ (cwceq @ (cco @ cc1 @ XN @ ccsgm) @ (cco @ cc2 @ XN @ ccmul)) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwcel @ (cco @ (cco @ cc2 @ (ccv @ Xp) @ ccexp) @ cc1 @ ccmin) @ ccprime) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ (cco @ (ccv @ Xp) @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xp) @ ccexp) @ cc1 @ ccmin) @ ccmul)))) @ (^ [Xp:$i] : ccz)))))).
