...
thf(apjmulii_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XC @ ccc) => (cwceq @ (ccfv @ (cco @ XC @ XA2 @ ccsm) @ (ccfv @ XH @ ccpjh)) @ (cco @ XC @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccsm))))))))).
...
thf(cpjsubii_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ (ccfv @ XH @ ccpjh)) @ (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XB2 @ (ccfv @ XH @ ccpjh)) @ ccmv))))))))).
