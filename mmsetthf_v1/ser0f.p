...
thf(aser0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XN @ XZ) @ (cwceq @ (ccfv @ XN @ (ccseq @ ccaddc @ (ccxp @ XZ @ (ccsn @ ccc0)) @ XM)) @ ccc0))))))).
...
thf(cser0f_conj,conjecture,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XM @ ccz) @ (cwceq @ (ccseq @ ccaddc @ (ccxp @ XZ @ (ccsn @ ccc0)) @ XM) @ (ccxp @ XZ @ (ccsn @ ccc0)))))))).
