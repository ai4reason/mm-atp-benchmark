...
thf(cpsubcli2N_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XK @ ccpolN)) => ((cwceq @ XC @ (ccfv @ XK @ ccpscN)) => (cwi @ (cwa @ (cwcel @ XK @ XD) @ (cwcel @ XX @ XC)) @ (cwceq @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) @ XX)))))))))).
