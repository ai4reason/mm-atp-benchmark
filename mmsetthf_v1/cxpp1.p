...
thf(ccxpp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ cccxp) @ (cco @ (cco @ XA2 @ XB2 @ cccxp) @ XA2 @ ccmul)))))).
