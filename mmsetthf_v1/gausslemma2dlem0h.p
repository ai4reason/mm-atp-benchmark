...
thf(cgausslemma2dlem0h_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XM @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((cwceq @ XH @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((cwceq @ XN @ (cco @ XH @ XM @ ccmin)) => (cwi @ Xph @ (cwcel @ XN @ ccn0)))))))))))).
