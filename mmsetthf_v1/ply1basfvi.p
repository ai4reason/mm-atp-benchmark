...
thf(a_00ply1bas_thm,axiom,(cwceq @ cc0 @ (ccfv @ (ccfv @ cc0 @ ccpl1) @ ccbs))).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(afvprc_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0))))).
thf(cply1basfvi_conj,conjecture,(! [XR:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ XR @ ccpl1) @ ccbs) @ (ccfv @ (ccfv @ (ccfv @ XR @ ccid) @ ccpl1) @ ccbs)))).
