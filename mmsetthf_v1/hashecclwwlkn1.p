...
thf(aeclclwwlkn1_thm,axiom,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwceq @ XW @ (cco @ XN @ (XG @ Xy1 @ Xu @ Xt @ Xn) @ ccclwwlkn)))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xu @ Xt @ Xn) @ (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xt) @ XW) @ (cwcel @ (ccv @ Xu) @ XW) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xt) @ (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwi @ (cwcel @ (XB2 @ Xu @ Xt @ Xn) @ (XX @ Xu @ Xt @ Xn)) @ (cwb @ (cwcel @ (XB2 @ Xu @ Xt @ Xn) @ (ccqs @ XW @ (Xc_sm @ Xu @ Xt @ Xn))) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (XB2 @ Xu @ Xt @ Xn) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : XW)))) @ (^ [Xx3:$i] : XW)))))))))))))))).
...
thf(aclwwlknscsh_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn))) @ (cwceq @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ XW @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (cco @ XN @ XG @ ccclwwlkn))) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ XW @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (ccword @ (ccfv @ XG @ ccvtx)))))))))).
...
thf(acshwshash_thm,axiom,(! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xw:$i] : (! [Xn:$i] : (cwceq @ (XM @ Xw @ Xn) @ (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ XW @ (ccv @ Xn) @ cccsh) @ (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ XV)))))) => (! [Xw:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime)) @ (cwo @ (cwceq @ (ccfv @ (XM @ Xw @ Xn) @ cchash) @ (ccfv @ XW @ cchash)) @ (cwceq @ (ccfv @ (XM @ Xw @ Xn) @ cchash) @ cc1)))))))))).
...
thf(chashecclwwlkn1_conj,conjecture,(! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xt:$i] : (cwceq @ XW @ (cco @ XN @ (XG @ Xt) @ ccclwwlkn))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xu @ Xt @ Xn) @ (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xt) @ XW) @ (cwcel @ (ccv @ Xu) @ XW) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (ccv @ Xt) @ (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccprime) @ (cwcel @ (XU @ Xt) @ (ccqs @ XW @ (Xc_sm @ Xu @ Xt @ Xn)))) @ (cwo @ (cwceq @ (ccfv @ (XU @ Xt) @ cchash) @ cc1) @ (cwceq @ (ccfv @ (XU @ Xt) @ cchash) @ XN)))))))))))))).
