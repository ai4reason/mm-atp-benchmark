...
thf(adf_pell14qr_ax,axiom,(cwceq @ ccpell14qr @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccn @ ccsquarenn)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ (ccv @ Xw) @ ccmul) @ ccaddc)) @ (cwceq @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccn0))) @ (^ [Xy1:$i] : ccr)))))).
...
thf(cpell14qrval_conj,conjecture,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwceq @ (ccfv @ XD @ ccpell14qr) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (cco @ (ccfv @ XD @ ccsqrt) @ (ccv @ Xw) @ ccmul) @ ccaddc)) @ (cwceq @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccn0))) @ (^ [Xy1:$i] : ccr)))))).
