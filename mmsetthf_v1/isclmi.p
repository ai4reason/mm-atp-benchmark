...
thf(cisclmi_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwceq @ XF @ (cco @ cccnfld @ XK @ ccress)) @ (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg))) @ (cwcel @ XW @ ccclm))))))).
