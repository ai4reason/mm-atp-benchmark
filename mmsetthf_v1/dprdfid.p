...
thf(asniffsupp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XI @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ Xc_0 @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XX) @ (XA2 @ Xx3) @ Xc_0))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (XF @ Xx3) @ Xc_0 @ ccfsupp))))))))))))))).
...
thf(cdprdfid_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (Xc_0 @ Xi) @ (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XW @ Xh @ Xi @ Xn) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS))))))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwceq @ (ccdm @ XS) @ XI)))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ (XX @ Xi) @ XI)))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ (XA2 @ Xi) @ (ccfv @ (XX @ Xi) @ XS))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xi @ Xn) @ (ccmpt @ (^ [Xn:$i] : XI) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ (XX @ Xi)) @ (XA2 @ Xi) @ (Xc_0 @ Xi))))))) => (! [Xh:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwa @ (cwcel @ (XF @ Xi @ Xn) @ (XW @ Xh @ Xi @ Xn)) @ (cwceq @ (cco @ XG @ (XF @ Xi @ Xn) @ ccgsu) @ (XA2 @ Xi)))))))))))))))))))))))).
