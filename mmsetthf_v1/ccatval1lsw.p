...
thf(cccatval1lsw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwne @ XA2 @ cc0)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin) @ (cco @ XA2 @ XB2 @ ccconcat)) @ (ccfv @ XA2 @ cclsw))))))).
