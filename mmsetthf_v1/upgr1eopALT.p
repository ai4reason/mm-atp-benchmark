...
thf(cupgr1eopALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwcel @ (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XC)))) @ ccupgr))))))))).
