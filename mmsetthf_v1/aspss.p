...
thf(caspss_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccasp)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ ccasa) @ (cwss @ XS @ XV) @ (cwss @ XT @ XS)) @ (cwss @ (ccfv @ XT @ XA2) @ (ccfv @ XS @ XA2))))))))))).
