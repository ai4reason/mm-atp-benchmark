...
thf(asubsub23i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmin) @ XC) @ (cwceq @ (cco @ XA2 @ XC @ ccmin) @ XB2))))))))).
...
thf(aballotlem8_thm,axiom,(! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : ((cwcel @ XM @ ccn) => ((cwcel @ XN @ ccn) => ((! [Xx3:$i] : (cwceq @ (XO @ Xx3) @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ cchash) @ XM)) @ (^ [Xc:$i] : (ccpw @ (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwceq @ (XP @ Xx3 @ Xi @ Xk @ Xc) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ (XO @ Xx3))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cchash) @ (ccfv @ (XO @ Xx3) @ cchash) @ ccdiv)))))))) => ((! [Xx3:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xc:$i] : (XO @ Xx3)) @ (^ [Xc:$i] : (ccmpt @ (^ [Xi:$i] : ccz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccin @ (cco @ cc1 @ (ccv @ Xi) @ ccfz) @ (ccv @ Xc)) @ cchash) @ (ccfv @ (ccdif @ (cco @ cc1 @ (ccv @ Xi) @ ccfz) @ (ccv @ Xc)) @ cchash) @ ccmin))))))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccrab @ (^ [Xc:$i] : (cwral @ (^ [Xi:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xi) @ (ccfv @ (ccv @ Xc) @ XF)) @ cclt)) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz)))) @ (^ [Xc:$i] : (XO @ Xx3))))) => ((cwbr @ XN @ XM @ cclt) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccmpt @ (^ [Xc:$i] : (ccdif @ (XO @ Xx3) @ (XE @ Xx3))) @ (^ [Xc:$i] : (ccinf @ (ccrab @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xc) @ XF)) @ ccc0)) @ (^ [Xk:$i] : (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz))) @ ccr @ cclt))))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccmpt @ (^ [Xc:$i] : (ccdif @ (XO @ Xx3) @ (XE @ Xx3))) @ (^ [Xc:$i] : (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz)) @ (^ [Xi:$i] : (ccif @ (cwbr @ (ccv @ Xi) @ (ccfv @ (ccv @ Xc) @ (XI @ Xx3)) @ ccle) @ (cco @ (cco @ (ccfv @ (ccv @ Xc) @ (XI @ Xx3)) @ cc1 @ ccaddc) @ (ccv @ Xi) @ ccmin) @ (ccv @ Xi)))))))) => ((! [Xx3:$i] : (! [Xc:$i] : (cwceq @ (XR @ Xx3 @ Xc) @ (ccmpt @ (^ [Xc:$i] : (ccdif @ (XO @ Xx3) @ (XE @ Xx3))) @ (^ [Xc:$i] : (ccima @ (ccfv @ (ccv @ Xc) @ (XS @ Xx3)) @ (ccv @ Xc))))))) => (! [Xx3:$i] : (cwceq @ (ccfv @ (ccrab @ (^ [Xc:$i] : (cwcel @ cc1 @ (ccv @ Xc))) @ (^ [Xc:$i] : (ccdif @ (XO @ Xx3) @ (XE @ Xx3)))) @ cchash) @ (ccfv @ (ccrab @ (^ [Xc:$i] : (cwn @ (cwcel @ cc1 @ (ccv @ Xc)))) @ (^ [Xc:$i] : (ccdif @ (XO @ Xx3) @ (XE @ Xx3)))) @ cchash))))))))))))))))))))))).
...
thf(cballotth_conj,conjecture,(! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XM @ ccn) => ((cwcel @ XN @ ccn) => ((cwceq @ XO @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ cchash) @ XM)) @ (^ [Xc:$i] : (ccpw @ (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwceq @ (XP @ Xx3 @ Xi @ Xk @ Xc) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XO)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cchash) @ (ccfv @ XO @ cchash) @ ccdiv)))))))) => ((cwceq @ XF @ (ccmpt @ (^ [Xc:$i] : XO) @ (^ [Xc:$i] : (ccmpt @ (^ [Xi:$i] : ccz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccin @ (cco @ cc1 @ (ccv @ Xi) @ ccfz) @ (ccv @ Xc)) @ cchash) @ (ccfv @ (ccdif @ (cco @ cc1 @ (ccv @ Xi) @ ccfz) @ (ccv @ Xc)) @ cchash) @ ccmin)))))) => ((cwceq @ XE @ (ccrab @ (^ [Xc:$i] : (cwral @ (^ [Xi:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xi) @ (ccfv @ (ccv @ Xc) @ XF)) @ cclt)) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz)))) @ (^ [Xc:$i] : XO))) => ((cwbr @ XN @ XM @ cclt) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccmpt @ (^ [Xc:$i] : (ccdif @ XO @ XE)) @ (^ [Xc:$i] : (ccinf @ (ccrab @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xc) @ XF)) @ ccc0)) @ (^ [Xk:$i] : (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz))) @ ccr @ cclt))))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccmpt @ (^ [Xc:$i] : (ccdif @ XO @ XE)) @ (^ [Xc:$i] : (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz)) @ (^ [Xi:$i] : (ccif @ (cwbr @ (ccv @ Xi) @ (ccfv @ (ccv @ Xc) @ (XI @ Xx3)) @ ccle) @ (cco @ (cco @ (ccfv @ (ccv @ Xc) @ (XI @ Xx3)) @ cc1 @ ccaddc) @ (ccv @ Xi) @ ccmin) @ (ccv @ Xi)))))))) => ((! [Xx3:$i] : (! [Xc:$i] : (cwceq @ (XR @ Xx3 @ Xc) @ (ccmpt @ (^ [Xc:$i] : (ccdif @ XO @ XE)) @ (^ [Xc:$i] : (ccima @ (ccfv @ (ccv @ Xc) @ (XS @ Xx3)) @ (ccv @ Xc))))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwceq @ (ccfv @ XE @ (XP @ Xx3 @ Xi @ Xk @ Xc)) @ (cco @ (cco @ XM @ XN @ ccmin) @ (cco @ XM @ XN @ ccaddc) @ ccdiv)))))))))))))))))))))))))).
