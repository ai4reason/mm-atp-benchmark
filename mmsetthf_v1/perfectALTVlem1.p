...
thf(annpw2evenALTV_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ cc2 @ XN @ ccexp) @ cceven)))).
thf(aevenm1odd_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ cceven) @ (cwcel @ (cco @ XZ @ cc1 @ ccmin) @ ccodd)))).
...
thf(cperfectALTVlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccodd)) => ((cwi @ Xph @ (cwceq @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccsgm) @ (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccmul))) => (cwi @ Xph @ (cw3a @ (cwcel @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ ccn) @ (cwcel @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccn) @ (cwcel @ (cco @ XB2 @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccdiv) @ ccn))))))))))).
