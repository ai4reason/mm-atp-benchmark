...
thf(aisconn_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccconn) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccin @ XJ @ (ccfv @ XJ @ cccld)) @ (ccpr @ cc0 @ XX)))))))).
...
thf(cconndisj_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ Xph @ (cwcel @ XJ @ ccconn)) => ((cwi @ Xph @ (cwcel @ XA2 @ XJ)) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => ((cwi @ Xph @ (cwcel @ XB2 @ XJ)) => ((cwi @ Xph @ (cwne @ XB2 @ cc0)) => ((cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) => (cwi @ Xph @ (cwne @ (ccun @ XA2 @ XB2) @ XX))))))))))))))).
