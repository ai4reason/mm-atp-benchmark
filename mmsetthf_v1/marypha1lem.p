...
thf(adomdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC)) @ ccdom)))))).
...
thf(aimainrect_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (cwceq @ (ccima @ (ccin @ XG @ (ccxp @ XA2 @ XB2)) @ XY) @ (ccin @ (ccima @ XG @ (ccin @ XY @ XA2)) @ XB2))))))).
...
thf(adomunfican_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwbr @ XB2 @ XA2 @ ccen)) @ (cwa @ (cwceq @ (ccin @ XA2 @ XX) @ cc0) @ (cwceq @ (ccin @ XB2 @ XY) @ cc0))) @ (cwb @ (cwbr @ (ccun @ XA2 @ XX) @ (ccun @ XB2 @ XY) @ ccdom) @ (cwbr @ XX @ XY @ ccdom)))))))).
...
thf(adisj4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwn @ (cwpss @ (ccdif @ XA2 @ XB2) @ XA2)))))).
...
thf(cmarypha1lem_conj,conjecture,(! [XA2:($i > $o)] : (! [Xb:$i] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwi @ (cwcel @ (ccv @ Xb) @ ccfn) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwral @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (ccima @ (ccv @ Xc) @ (ccv @ Xd)) @ ccdom)) @ (^ [Xd:$i] : (ccpw @ XA2))) @ (cwrex @ (^ [Xe:$i] : (cwf1 @ XA2 @ ccvv @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccpw @ (ccv @ Xc)))))) @ (^ [Xc:$i] : (ccpw @ (ccxp @ XA2 @ (ccv @ Xb)))))))))).
