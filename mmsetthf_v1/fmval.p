...
thf(adf_fm_ax,axiom,(cwceq @ ccfm @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xf1:$i] : (ccmpt @ (^ [Xy1:$i] : (ccfv @ (ccdm @ (ccv @ Xf1)) @ ccfbas)) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccrn @ (ccmpt @ (^ [Xt:$i] : (ccv @ Xy1)) @ (^ [Xt:$i] : (ccima @ (ccv @ Xf1) @ (ccv @ Xt))))) @ ccfg)))))))).
...
thf(cfmval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwf @ XY @ XX @ XF)) @ (cwceq @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ (cco @ XX @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccima @ XF @ (ccv @ Xy1))))) @ ccfg))))))))).
