...
thf(cbnj1326_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xd:$i] : (cwceq @ (XB2 @ Xx3 @ Xg1 @ Xh @ Xd) @ (ccab @ (^ [Xd:$i] : (cwa @ (cwss @ (ccv @ Xd) @ (XA2 @ Xg1 @ Xh)) @ (cwral @ (^ [Xx3:$i] : (cwss @ (cc_bnj14 @ (XA2 @ Xg1 @ Xh) @ (XR @ Xg1 @ Xh) @ (ccv @ Xx3)) @ (ccv @ Xd))) @ (^ [Xx3:$i] : (ccv @ Xd))))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xd:$i] : (cwceq @ (XY @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd) @ (ccop @ (ccv @ Xx3) @ (ccres @ (ccv @ Xf1) @ (cc_bnj14 @ (XA2 @ Xg1 @ Xh) @ (XR @ Xg1 @ Xh) @ (ccv @ Xx3)))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xd:$i] : (cwceq @ (XC @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xd:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xd)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (XY @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd) @ (XG @ Xx3 @ Xg1 @ Xh)))) @ (^ [Xx3:$i] : (ccv @ Xd))))) @ (^ [Xd:$i] : (XB2 @ Xx3 @ Xg1 @ Xh @ Xd))))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xd:$i] : (cwceq @ (XD @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh))))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xd:$i] : (cwi @ (cw3a @ (cw_bnj15 @ (XA2 @ Xg1 @ Xh) @ (XR @ Xg1 @ Xh)) @ (cwcel @ (ccv @ Xg1) @ (XC @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd)) @ (cwcel @ (ccv @ Xh) @ (XC @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd))) @ (cwceq @ (ccres @ (ccv @ Xg1) @ (XD @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd)) @ (ccres @ (ccv @ Xh) @ (XD @ Xx3 @ Xf1 @ Xg1 @ Xh @ Xd))))))))))))))))))))).
