...
thf(aimasgim_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwf1o @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ ccgrp)) => (cwi @ Xph @ (cwcel @ XF @ (cco @ XR @ XU @ ccgim)))))))))))))).
...
thf(agicabl_thm,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwbr @ XG @ XH @ ccgic) @ (cwb @ (cwcel @ XG @ ccabl) @ (cwcel @ XH @ ccabl)))))).
...
thf(cisnumbasgrplem1_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (cwi @ (cwa @ (cwcel @ XR @ ccabl) @ (cwbr @ XC @ XB2 @ ccen)) @ (cwcel @ XC @ (ccima @ ccbs @ ccabl)))))))).
