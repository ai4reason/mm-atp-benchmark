...
thf(cfourierdlem31_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwnf @ (^ [Xi:$i] : (Xph @ Xi @ Xm @ Xn @ Xr)))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwnf @ (^ [Xr:$i] : (Xph @ Xi @ Xm @ Xn @ Xr)))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwnfc @ (^ [Xi:$i] : (XV @ Xi @ Xm @ Xn @ Xr)))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xi @ Xm @ Xn @ Xr) @ (cwcel @ XA2 @ ccfn)))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xi @ Xm @ Xn @ Xr) @ (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xr:$i] : (Xch @ Xi @ Xr)) @ (^ [Xr:$i] : (cco @ (ccv @ Xm) @ ccpnf @ ccioo)))) @ (^ [Xm:$i] : ccn))) @ (^ [Xi:$i] : XA2))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwceq @ (XM @ Xi @ Xm @ Xn @ Xr) @ (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xr:$i] : (Xch @ Xi @ Xr)) @ (^ [Xr:$i] : (cco @ (ccv @ Xm) @ ccpnf @ ccioo)))) @ (^ [Xm:$i] : ccn))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwceq @ (XV @ Xi @ Xm @ Xn @ Xr) @ (ccmpt @ (^ [Xi:$i] : XA2) @ (^ [Xi:$i] : (ccinf @ (XM @ Xi @ Xm @ Xn @ Xr) @ ccr @ cclt)))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwceq @ (XN @ Xi @ Xm @ Xr) @ (ccsup @ (ccrn @ (XV @ Xi @ Xm @ Xn @ Xr)) @ ccr @ cclt)))))) => (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xi @ Xm @ Xn @ Xr) @ (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xr:$i] : (cwral @ (^ [Xi:$i] : (Xch @ Xi @ Xr)) @ (^ [Xi:$i] : XA2))) @ (^ [Xr:$i] : (cco @ (ccv @ Xn) @ ccpnf @ ccioo)))) @ (^ [Xn:$i] : ccn)))))))))))))))))))))).
