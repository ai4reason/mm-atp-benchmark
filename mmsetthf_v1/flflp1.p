...
thf(cflflp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccfl) @ XB2 @ ccle) @ (cwbr @ XA2 @ (cco @ (ccfv @ XB2 @ ccfl) @ cc1 @ ccaddc) @ cclt)))))).
