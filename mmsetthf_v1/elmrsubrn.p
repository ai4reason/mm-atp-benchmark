...
thf(amrsubf_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => (cwi @ (cwcel @ XF @ (ccrn @ XS)) @ (cwf @ XR @ XR @ XF))))))))).
thf(aralrimiva_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (Xps @ Xx3))) => (cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(amrsubcn_thm,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XC @ (ccfv @ XT @ ccmcn)) => (cwi @ (cwa @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XX @ (ccdif @ XC @ XV))) @ (cwceq @ (ccfv @ (ccs1 @ XX) @ XF) @ (ccs1 @ XX))))))))))))))).
...
thf(amrsubccat_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XX @ XR) @ (cwcel @ XY @ XR)) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ ccconcat) @ XF) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccconcat)))))))))))).
...
thf(amrsubfval_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XT @ ccmcn)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((! [Xv:$i] : (! [Xe:$i] : (cwceq @ (XS @ Xv @ Xe) @ (ccfv @ XT @ ccmrsub)))) => ((! [Xv:$i] : (cwceq @ (XG @ Xv) @ (ccfv @ (ccun @ XC @ XV) @ ccfrmd))) => (! [Xv:$i] : (! [Xe:$i] : (cwi @ (cwa @ (cwf @ XA2 @ XR @ XF) @ (cwss @ XA2 @ XV)) @ (cwceq @ (ccfv @ XF @ (XS @ Xv @ Xe)) @ (ccmpt @ (^ [Xe:$i] : XR) @ (^ [Xe:$i] : (cco @ (XG @ Xv) @ (cccom @ (ccmpt @ (^ [Xv:$i] : (ccun @ XC @ XV)) @ (^ [Xv:$i] : (ccif @ (cwcel @ (ccv @ Xv) @ XA2) @ (ccfv @ (ccv @ Xv) @ XF) @ (ccs1 @ (ccv @ Xv))))) @ (ccv @ Xe)) @ ccgsu))))))))))))))))))))).
...
thf(afrmdmnd_thm,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XM @ (ccfv @ XI @ ccfrmd)) => (cwi @ (cwcel @ XI @ XV) @ (cwcel @ XM @ ccmnd))))))).
...
thf(celmrsubrn_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xc:$i] : (cwceq @ XS @ (ccfv @ (XT @ Xc) @ ccmrsub))) => ((! [Xc:$i] : (cwceq @ (XR @ Xc) @ (ccfv @ (XT @ Xc) @ ccmrex))) => ((! [Xc:$i] : (cwceq @ XV @ (ccfv @ (XT @ Xc) @ ccmvar))) => ((! [Xc:$i] : (cwceq @ XC @ (ccfv @ (XT @ Xc) @ ccmcn))) => (! [Xc:$i] : (cwi @ (cwcel @ (XT @ Xc) @ (XW @ Xc)) @ (cwb @ (cwcel @ XF @ (ccrn @ XS)) @ (cw3a @ (cwf @ (XR @ Xc) @ (XR @ Xc) @ XF) @ (cwral @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccs1 @ (ccv @ Xc)) @ XF) @ (ccs1 @ (ccv @ Xc)))) @ (^ [Xc:$i] : (ccdif @ XC @ XV))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccconcat) @ XF) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccconcat))) @ (^ [Xy1:$i] : (XR @ Xc)))) @ (^ [Xx3:$i] : (XR @ Xc))))))))))))))))))).
