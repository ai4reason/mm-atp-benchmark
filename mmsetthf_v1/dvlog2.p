...
thf(cdvlog2_conj,conjecture,(! [XS:($i > $o)] : ((cwceq @ XS @ (cco @ cc1 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => (cwceq @ (cco @ ccc @ (ccres @ cclog @ XS) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccv @ Xx3) @ ccdiv))))))).
