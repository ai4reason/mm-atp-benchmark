...
thf(cblss2_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XQ @ XX)) @ (cw3a @ (cwcel @ XR @ ccr) @ (cwcel @ XS @ ccr) @ (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ XR @ ccmin) @ ccle))) @ (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))).
