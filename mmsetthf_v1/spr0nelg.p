...
thf(aimori_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwi @ Xph @ Xps) => (cwo @ (cwn @ Xph) @ Xps))))).
...
thf(cspr0nelg_conj,conjecture,(cwnel @ cc0 @ (ccab @ (^ [Xp:$i] : (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xp) @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))).
