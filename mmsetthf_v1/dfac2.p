...
thf(aprel12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (cwi @ (cwn @ (cwceq @ XA2 @ XB2)) @ (cwb @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ (cwa @ (cwcel @ XA2 @ (ccpr @ XC @ XD)) @ (cwcel @ XB2 @ (ccpr @ XC @ XD)))))))))))))).
...
thf(apreleq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwcel @ XC @ XD)) @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD))) @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)))))))))))).
...
thf(cdfac2_conj,conjecture,(cwb @ cwac @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwreu @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwa @ (cwcel @ (ccv @ Xz) @ (ccv @ Xv)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccv @ Xy1)))) @ (^ [Xw:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))).
