...
thf(cetransclem9_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((cwi @ Xph @ (cwne @ XK @ ccc0)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwn @ (cwbr @ XK @ XM @ ccdvds))) => ((cwi @ Xph @ (cwbr @ XK @ XN @ ccdvds)) => (cwi @ Xph @ (cwne @ (cco @ XM @ XN @ ccaddc) @ ccc0))))))))))))).
