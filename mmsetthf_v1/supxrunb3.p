...
thf(csupxrunb3_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccxr) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf))))).
