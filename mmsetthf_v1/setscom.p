...
thf(csetscom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwa @ (cwcel @ XS @ XV) @ (cwne @ XA2 @ XB2)) @ (cwa @ (cwcel @ XC @ XW) @ (cwcel @ XD @ XX))) @ (cwceq @ (cco @ (cco @ XS @ (ccop @ XA2 @ XC) @ ccsts) @ (ccop @ XB2 @ XD) @ ccsts) @ (cco @ (cco @ XS @ (ccop @ XB2 @ XD) @ ccsts) @ (ccop @ XA2 @ XC) @ ccsts)))))))))))))).
