...
thf(auun0_1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ cwtru @ Xph) => ((cwi @ Xps @ Xch) => ((cwi @ (cwa @ cwtru @ Xps) @ Xth) => (cwi @ Xps @ Xth))))))))).
...
thf(aelpwgded_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => ((cwi @ Xps @ (cwss @ XA2 @ XB2)) => (cwi @ (cwa @ Xph @ Xps) @ (cwcel @ XA2 @ (ccpw @ XB2)))))))))).
...
thf(csspwimp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccpw @ XA2) @ (ccpw @ XB2)))))).
