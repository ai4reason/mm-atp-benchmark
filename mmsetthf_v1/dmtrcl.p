...
thf(cdmtrcl_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwcel @ XX @ (XV @ Xx3)) @ (cwceq @ (ccdm @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XX @ (ccv @ Xx3)) @ (cwss @ (cccom @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (ccv @ Xx3))))))) @ (ccdm @ XX))))))).
