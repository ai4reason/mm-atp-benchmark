...
thf(asymgtopn_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XX @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwcel @ XX @ XV) @ (cwceq @ (cco @ (ccfv @ (ccxp @ XX @ (ccsn @ (ccpw @ XX))) @ ccpt) @ XB2 @ ccrest) @ (ccfv @ XG @ cctopn)))))))))).
...
thf(acndis_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) @ (cwceq @ (cco @ (ccpw @ XA2) @ XJ @ cccn) @ (cco @ XX @ XA2 @ ccmap)))))))).
thf(asyl3anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ Xth) => ((cwi @ (cw3a @ Xps @ Xch @ Xth) @ Xta) => (cwi @ Xph @ Xta))))))))))).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(adisllycmp_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwcel @ (ccpw @ XX) @ (cclly @ cccmp)))))).
thf(ccnei_tp,type,(ccnei : ($i > $o))).
thf(allynlly_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ (cclly @ XA2)) @ (cwcel @ XJ @ (ccnlly @ XA2)))))).
...
thf(axkopt_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ cctop) @ (cwcel @ XA2 @ XV)) @ (cwceq @ (cco @ XR @ (ccpw @ XA2) @ ccxko) @ (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt))))))).
thf(a_3syl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => ((cwi @ Xch @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(agrpplusf_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XF @ (ccfv @ XG @ ccplusf)) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ XF)))))))).
...
thf(csymgtgp_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ XA2 @ ccsymg)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ XG @ cctgp))))))).
