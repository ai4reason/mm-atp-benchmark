...
thf(cesumiun_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xj @ Xk))))) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (XB2 @ Xj) @ XW))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xj))) @ (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => (cwi @ Xph @ (cwbr @ (ccesum @ (^ [Xk:$i] : (cciun @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xj)))) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccesum @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccesum @ (^ [Xk:$i] : (XB2 @ Xj)) @ (^ [Xk:$i] : (XC @ Xk))))) @ ccle)))))))))))).
