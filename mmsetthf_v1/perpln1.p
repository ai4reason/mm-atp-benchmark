...
thf(admopabss_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (cwss @ (ccdm @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3 @ Xy1)))))) @ XA2)))).
...
thf(cperpln1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (cwi @ Xph @ (cwcel @ XA2 @ (ccrn @ XL)))))))))))).
