...
thf(afmtnonn_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccfv @ XN @ ccfmtno) @ ccn)))).
...
thf(amuladd11r_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ (cco @ XB2 @ cc1 @ ccaddc) @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccaddc) @ cc1 @ ccaddc)))))).
...
thf(cfmtnofac2lem_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ (ccv @ Xz) @ (ccfv @ cc2 @ ccuz))) @ (cwi @ (cwa @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwbr @ (ccv @ Xy1) @ (ccfv @ XN @ ccfmtno) @ ccdvds)) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc2 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn0))) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwbr @ (ccv @ Xz) @ (ccfv @ XN @ ccfmtno) @ ccdvds)) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (ccv @ Xz) @ (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc2 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmul) @ (ccfv @ XN @ ccfmtno) @ ccdvds)) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmul) @ (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc2 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn0))))))))).
