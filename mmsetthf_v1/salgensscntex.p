...
thf(aunisalgen_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwceq @ XS @ (ccfv @ XX @ ccsalgen)) => ((cwceq @ XU @ (ccuni @ XX)) => (cwi @ Xph @ (cwcel @ XU @ XS))))))))))).
...
thf(csalgensscntex_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwceq @ (XA2 @ Xy1) @ (cco @ ccc0 @ cc2 @ ccicc))) => ((! [Xy1:$i] : (cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwbr @ (ccdif @ (XA2 @ Xy1) @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XX @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xy1:$i] : (ccsn @ (ccv @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccfv @ (XX @ Xx3 @ Xy1) @ ccsalgen)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cw3a @ (cwss @ (XX @ Xx3 @ Xy1) @ XS) @ (cwcel @ XS @ ccsalg) @ (cwn @ (cwss @ (XG @ Xx3 @ Xy1) @ XS)))))))))))))).
