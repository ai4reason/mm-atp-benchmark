...
thf(adigit2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ ccn)) @ (cwceq @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ XB2 @ ccmo) @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ (cco @ XB2 @ (ccfv @ (cco @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccmin) @ ccexp) @ XA2 @ ccmul) @ ccfl) @ ccmul) @ ccmin))))))).
...
thf(amodmulnn_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccn)) @ (cwbr @ (cco @ (cco @ XN @ (ccfv @ XA2 @ ccfl) @ ccmul) @ (cco @ XN @ XM @ ccmul) @ ccmo) @ (cco @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ ccfl) @ (cco @ XN @ XM @ ccmul) @ ccmo) @ ccle)))))).
