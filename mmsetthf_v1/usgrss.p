...
thf(cusgrss_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwss @ (ccfv @ XX @ XE) @ XV))))))))).
