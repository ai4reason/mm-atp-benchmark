...
thf(agcdn0cl_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwn @ (cwa @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)))) @ (cwcel @ (cco @ XM @ XN @ ccgcd) @ ccn))))).
...
thf(amulgcd_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccn0) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccgcd) @ (cco @ XK @ (cco @ XM @ XN @ ccgcd) @ ccmul))))))).
...
thf(adivcan7d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccdiv) @ (cco @ XA2 @ XB2 @ ccdiv))))))))))))).
...
thf(aqredeq_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1)) @ (cw3a @ (cwcel @ XP @ ccz) @ (cwcel @ XQ @ ccn) @ (cwceq @ (cco @ XP @ XQ @ ccgcd) @ cc1)) @ (cwceq @ (cco @ XM @ XN @ ccdiv) @ (cco @ XP @ XQ @ ccdiv))) @ (cwa @ (cwceq @ XM @ XP) @ (cwceq @ XN @ XQ)))))))).
...
thf(aelq_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccq) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccz))))).
...
thf(cqredeu_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwreu @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccgcd) @ cc1) @ (cwceq @ XA2 @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccdiv)))) @ (^ [Xx3:$i] : (ccxp @ ccz @ ccn)))))).
