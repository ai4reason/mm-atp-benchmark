...
thf(adf_padd_ax,axiom,(cwceq @ ccpadd @ (ccmpt @ (^ [Xl:$i] : ccvv) @ (^ [Xl:$i] : (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : (ccpw @ (ccfv @ (ccv @ Xl) @ ccatm)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccpw @ (ccfv @ (ccv @ Xl) @ ccatm)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccun @ (ccun @ (ccv @ Xm) @ (ccv @ Xn)) @ (ccrab @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (ccfv @ (ccv @ Xl) @ ccjn)) @ (ccfv @ (ccv @ Xl) @ ccple))) @ (^ [Xr:$i] : (ccv @ Xn)))) @ (^ [Xq:$i] : (ccv @ Xm)))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xl) @ ccatm))))))))))).
...
thf(cpaddfval_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_or:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_le @ Xm @ Xn @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccple))))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xm @ Xn @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccjn))))))) => ((! [Xr:$i] : (! [Xq:$i] : (cwceq @ (XA2 @ Xr @ Xq) @ (ccfv @ XK @ ccatm)))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_pl @ Xm @ Xn @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccpadd))))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XK @ (XB2 @ Xm @ Xn @ Xr @ Xq @ Xp)) @ (cwceq @ (Xc_pl @ Xm @ Xn @ Xr @ Xq @ Xp) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : (ccpw @ (XA2 @ Xr @ Xq)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccpw @ (XA2 @ Xr @ Xq)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccun @ (ccun @ (ccv @ Xm) @ (ccv @ Xn)) @ (ccrab @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xm @ Xn @ Xr @ Xq @ Xp)) @ (Xc_le @ Xm @ Xn @ Xr @ Xq @ Xp))) @ (^ [Xr:$i] : (ccv @ Xn)))) @ (^ [Xq:$i] : (ccv @ Xm)))) @ (^ [Xp:$i] : (XA2 @ Xr @ Xq))))))))))))))))))))))))).
