...
thf(adeg1sublt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwi @ Xph @ (cwcel @ XL @ ccn0)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XF @ XD) @ XL @ ccle)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XG @ XD) @ XL @ ccle)) => ((cwceq @ XA2 @ (ccfv @ XF @ ccco1)) => ((cwceq @ XC @ (ccfv @ XG @ ccco1)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XL @ (ccfv @ XF @ ccco1)) @ (ccfv @ XL @ (ccfv @ XG @ ccco1)))) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ XL @ cclt))))))))))))))))))))))))))).
...
thf(adeg1cl_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => (cwi @ (cwcel @ XF @ XB2) @ (cwcel @ (ccfv @ XF @ XD) @ (ccun @ ccn0 @ (ccsn @ ccmnf))))))))))))).
...
thf(adegltlem1_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ (ccun @ ccn0 @ (ccsn @ ccmnf))) @ (cwcel @ XY @ ccz)) @ (cwb @ (cwbr @ XX @ XY @ cclt) @ (cwbr @ XX @ (cco @ XY @ cc1 @ ccmin) @ ccle)))))).
...
thf(adeg1mulle2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccmulr)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((cwi @ Xph @ (cwcel @ XJ @ ccn0)) => ((cwi @ Xph @ (cwcel @ XK @ ccn0)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XF @ XD) @ XJ @ ccle)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XG @ XD) @ XK @ ccle)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_x) @ XD) @ (cco @ XJ @ XK @ ccaddc) @ ccle)))))))))))))))))))))))).
...
thf(agrpsubsub4_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) @ (cwceq @ (cco @ (cco @ XX @ XY @ Xc_mi) @ XZ @ Xc_mi) @ (cco @ XX @ (cco @ XZ @ XY @ Xc_pl) @ Xc_mi)))))))))))))).
...
thf(cply1divex_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ Xc_xb @ (ccfv @ XP @ ccmulr)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((cwi @ Xph @ (cwne @ XG @ Xc_0)) => ((! [Xq:$i] : (cwceq @ (Xc_1 @ Xq) @ (ccfv @ XR @ ccur))) => ((! [Xq:$i] : (cwceq @ (XK @ Xq) @ (ccfv @ XR @ ccbs))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((! [Xq:$i] : (cwi @ Xph @ (cwcel @ XI @ (XK @ Xq)))) => ((! [Xq:$i] : (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (ccfv @ XG @ XD) @ (ccfv @ XG @ ccco1)) @ XI @ Xc_x) @ (Xc_1 @ Xq)))) => (cwi @ Xph @ (cwrex @ (^ [Xq:$i] : (cwbr @ (ccfv @ (cco @ XF @ (cco @ XG @ (ccv @ Xq) @ Xc_xb) @ Xc_mi) @ XD) @ (ccfv @ XG @ XD) @ cclt)) @ (^ [Xq:$i] : XB2))))))))))))))))))))))))))))))))).
