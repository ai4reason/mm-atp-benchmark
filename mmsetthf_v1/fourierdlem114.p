...
thf(afourierdlem113_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwf @ ccr @ ccr @ (XF @ Xp)))) => ((cwceq @ XT @ (cco @ cc2 @ ccpi @ ccmul)) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ (XF @ Xp)) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xp)))))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XX @ ccr))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XL @ Xx3 @ Xp) @ (cco @ (ccres @ (XF @ Xp) @ (cco @ ccmnf @ XX @ ccioo)) @ XX @ cclimc))))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XR @ Xx3 @ Xp) @ (cco @ (ccres @ (XF @ Xp) @ (cco @ XX @ ccpnf @ ccioo)) @ XX @ cclimc))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XP @ Xx3 @ Xi @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : (cwa @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccneg @ ccpi)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (ccv @ Xp)) @ ccpi)) @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ ccmap)))))))))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XM @ ccn))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XQ @ (ccfv @ XM @ (XP @ Xx3 @ Xi @ Xn @ Xp)))))))) => ((! [Xi:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwcel @ (ccres @ (cco @ ccr @ (XF @ Xp) @ ccdv) @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo) @ ccc @ cccncf))))) => ((! [Xi:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwne @ (cco @ (ccres @ (cco @ ccr @ (XF @ Xp) @ ccdv) @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (ccv @ Xi) @ XQ) @ cclimc) @ cc0)))) => ((! [Xi:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwne @ (cco @ (ccres @ (cco @ ccr @ (XF @ Xp) @ ccdv) @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ cclimc) @ cc0)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xx3 @ Xi @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xp:$i] : (cwceq @ (XB2 @ Xx3 @ Xi @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xx3 @ Xi @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ ccsin) @ ccmul) @ ccaddc)))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xi @ Xn @ Xp) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ ccpi @ (ccv @ Xx3) @ ccmin) @ XT @ ccdiv) @ ccfl) @ XT @ ccmul) @ ccaddc))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (ccfv @ XX @ (XE @ Xi @ Xn @ Xp)) @ (ccrn @ XQ)))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwa @ (cwbr @ (ccseq @ ccaddc @ (XS @ Xx3 @ Xi @ Xn @ Xp) @ cc1) @ (cco @ (cco @ (cco @ (XL @ Xx3 @ Xp) @ (XR @ Xx3 @ Xp) @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xi @ Xp)) @ cc2 @ ccdiv) @ ccmin) @ ccli) @ (cwceq @ (cco @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xi @ Xp)) @ cc2 @ ccdiv) @ (ccsu @ ccn @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ ccsin) @ ccmul) @ ccaddc))) @ ccaddc) @ (cco @ (cco @ (XL @ Xx3 @ Xp) @ (XR @ Xx3 @ Xp) @ ccaddc) @ cc2 @ ccdiv))))))))))))))))))))))))))))))))))))))).
...
thf(atpfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwcel @ (cctp @ XA2 @ XB2 @ XC) @ ccfn))))).
...
thf(aprunioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwceq @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccpr @ XA2 @ XB2)) @ (cco @ XA2 @ XB2 @ ccicc)))))).
...
thf(afourierdlem36_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwceq @ XF @ (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ (ccv @ Xf1))))) => ((cwceq @ XN @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin)) => (cwi @ Xph @ (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ XF))))))))))).
...
thf(afourierdlem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwceq @ XT @ (cco @ XB2 @ XA2 @ ccmin)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ XT @ ccdiv) @ ccfl) @ XT @ ccmul) @ ccaddc))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwf @ ccr @ (cco @ XA2 @ XB2 @ ccioc) @ (XE @ Xx3))))))))))))))).
...
thf(atpss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XD)) @ (cwss @ (cctp @ XA2 @ XB2 @ XC) @ XD)))))))))).
...
thf(atpssi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XD)) @ (cwss @ (cctp @ XA2 @ XB2 @ XC) @ XD))))))).
...
thf(afourierdlem27_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ XA2 @ XB2 @ ccicc) @ XQ)) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo))) => (cwi @ Xph @ (cwss @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo)))))))))))))).
thf(afourierdlem38_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : ((! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xn @ Xp) @ (cwcel @ (XF @ Xn @ Xp) @ (cco @ (ccdm @ (XF @ Xn @ Xp)) @ ccc @ cccncf))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XP @ Xi @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : (cwa @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccneg @ ccpi)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (ccv @ Xp)) @ ccpi)) @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ ccmap))))))))) => ((! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xn @ Xp) @ (cwcel @ XM @ ccn)))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xn @ Xp) @ (cwcel @ (XQ @ Xn) @ (ccfv @ XM @ (XP @ Xi @ Xn @ Xp))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XH @ Xi @ Xn @ Xp) @ (ccun @ (XA2 @ Xi @ Xn @ Xp) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ (XF @ Xn @ Xp)))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xn @ Xp) @ (cwceq @ (ccrn @ (XQ @ Xn)) @ (XH @ Xi @ Xn @ Xp)))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xn @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwcel @ (ccres @ (XF @ Xn @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xn)) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xn)) @ ccioo) @ ccc @ cccncf)))))))))))))))))))).
...
thf(afourierdlem46_thm,axiom,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ (ccdm @ XF) @ ccc @ cccncf))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccico) @ (ccdm @ XF)))) @ (cwne @ (cco @ (ccres @ XF @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ (ccdm @ XF)))) @ (cwne @ (cco @ (ccres @ XF @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwiso @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz) @ (XH @ Xx3) @ cclt @ cclt @ XQ))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz) @ (XH @ Xx3) @ XQ))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XI @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo)))) => ((cwi @ Xph @ (cwbr @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccun @ (cctp @ (ccneg @ ccpi) @ ccpi @ (XC @ Xx3)) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ XF))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccrn @ XQ) @ (XH @ Xx3)))) => (cwi @ Xph @ (cwa @ (cwne @ (cco @ (ccres @ XF @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ XI @ XQ) @ cclimc) @ cc0) @ (cwne @ (cco @ (ccres @ XF @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ cclimc) @ cc0)))))))))))))))))))))).
...
thf(cfourierdlem114_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xg1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwf @ ccr @ ccr @ (XF @ Xg1 @ Xp))))) => ((! [Xg1:$i] : (cwceq @ (XT @ Xg1) @ (cco @ cc2 @ ccpi @ ccmul))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (XT @ Xg1) @ ccaddc) @ (XF @ Xg1 @ Xp)) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xg1 @ Xp))))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XG @ Xg1 @ Xn @ Xp) @ (ccres @ (cco @ ccr @ (XF @ Xg1 @ Xp) @ ccdv) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))) @ ccfn))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ (ccdm @ (XG @ Xg1 @ Xn @ Xp)) @ ccc @ cccncf)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccico) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))))) @ (cwne @ (cco @ (ccres @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))))) @ (cwne @ (cco @ (ccres @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0)))))) => ((! [Xg1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XX @ Xg1) @ ccr)))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XL @ Xx3 @ Xg1 @ Xp) @ (cco @ (ccres @ (XF @ Xg1 @ Xp) @ (cco @ ccmnf @ (XX @ Xg1) @ ccioo)) @ (XX @ Xg1) @ cclimc)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XR @ Xx3 @ Xg1 @ Xp) @ (cco @ (ccres @ (XF @ Xg1 @ Xp) @ (cco @ (XX @ Xg1) @ ccpnf @ ccioo)) @ (XX @ Xg1) @ cclimc)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xg1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv)))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xp:$i] : (cwceq @ (XB2 @ Xx3 @ Xg1 @ Xi @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xg1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv)))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xx3 @ Xg1 @ Xi @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ ccsin) @ ccmul) @ ccaddc))))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XP @ Xx3 @ Xg1 @ Xi @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : (cwa @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccneg @ ccpi)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (ccv @ Xp)) @ ccpi)) @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ ccmap))))))))))) => ((! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xg1 @ Xi @ Xn @ Xp) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ ccpi @ (ccv @ Xx3) @ ccmin) @ (XT @ Xg1) @ ccdiv) @ ccfl) @ (XT @ Xg1) @ ccmul) @ ccaddc)))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XH @ Xx3 @ Xi @ Xn @ Xp) @ (ccun @ (cctp @ (ccneg @ ccpi) @ ccpi @ (ccfv @ (XX @ Xg1) @ (XE @ Xg1 @ Xi @ Xn @ Xp))) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ XM @ (cco @ (ccfv @ (XH @ Xx3 @ Xi @ Xn @ Xp) @ cchash) @ cc1 @ ccmin)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwceq @ XQ @ (ccio @ (^ [Xg1:$i] : (cwiso @ (cco @ ccc0 @ XM @ ccfz) @ (XH @ Xx3 @ Xi @ Xn @ Xp) @ cclt @ cclt @ (ccv @ Xg1))))))))) => (! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwa @ (cwbr @ (ccseq @ ccaddc @ (XS @ Xx3 @ Xg1 @ Xi @ Xn @ Xp) @ cc1) @ (cco @ (cco @ (cco @ (XL @ Xx3 @ Xg1 @ Xp) @ (XR @ Xx3 @ Xg1 @ Xp) @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ cc2 @ ccdiv) @ ccmin) @ ccli) @ (cwceq @ (cco @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ cc2 @ ccdiv) @ (ccsu @ ccn @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ ccsin) @ ccmul) @ ccaddc))) @ ccaddc) @ (cco @ (cco @ (XL @ Xx3 @ Xg1 @ Xp) @ (XR @ Xx3 @ Xg1 @ Xp) @ ccaddc) @ cc2 @ ccdiv)))))))))))))))))))))))))))))))))))))))))))).
