...
thf(agexdvds2_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => ((! [Xx3:$i] : (cwceq @ (XO @ Xx3) @ (ccfv @ XG @ ccod))) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XE @ XN @ ccdvds) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xx3)) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XX))))))))))))).
thf(cgexdvds3_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn)) @ (cwbr @ XE @ (ccfv @ XX @ cchash) @ ccdvds)))))))).
