...
thf(aeliooxr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccioo)) @ (cwa @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr))))))).
...
thf(celiooord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccioo)) @ (cwa @ (cwbr @ XB2 @ XA2 @ cclt) @ (cwbr @ XA2 @ XC @ cclt))))))).
