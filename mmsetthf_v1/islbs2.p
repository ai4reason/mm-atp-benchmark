...
thf(albsind2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_1 @ (ccfv @ XF @ ccur)) => ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ cclmod) @ (cwne @ Xc_1 @ Xc_0)) @ (cwcel @ XB2 @ XJ) @ (cwcel @ XE @ XB2)) @ (cwn @ (cwcel @ XE @ (ccfv @ (ccdif @ XB2 @ (ccsn @ XE)) @ XN)))))))))))))))))).
...
thf(cislbs2_conj,conjecture,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwcel @ XW @ cclvec) @ (cwb @ (cwcel @ XB2 @ XJ) @ (cw3a @ (cwss @ XB2 @ XV) @ (cwceq @ (ccfv @ XB2 @ XN) @ XV) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XB2 @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : XB2)))))))))))))).
