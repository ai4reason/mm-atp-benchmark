...
thf(arhmsubclem2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccrngc)) => ((cwi @ Xph @ (cwceq @ XR @ (ccin @ ccrg @ XU))) => ((cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XR @ XR))) => (cwi @ (cw3a @ Xph @ (cwcel @ XX @ XR) @ (cwcel @ XY @ XR)) @ (cwceq @ (cco @ XX @ XY @ XH) @ (cco @ XX @ XY @ ccrh)))))))))))))))).
thf(crhmsubclem3_conj,conjecture,(! [Xph:$o] : (! [Xx3:$i] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccrngc)) => ((cwi @ Xph @ (cwceq @ XR @ (ccin @ ccrg @ XU))) => ((cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XR @ XR))) => (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XR)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccfv @ XU @ ccrngc) @ cccid)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XH))))))))))))))).
