...
thf(aatcveq0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwceq @ XA2 @ cc0h)))))).
thf(acvexch_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
thf(ccvp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
