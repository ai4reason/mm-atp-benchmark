...
thf(cinfleinflem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwss @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XR @ ccr)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwbr @ XX @ (cco @ XR @ cc2 @ ccmin) @ cclt)) => ((cwi @ Xph @ (cwcel @ XZ @ XA2)) => ((cwi @ Xph @ (cwbr @ XZ @ (cco @ XX @ cc1 @ ccxad) @ ccle)) => (cwi @ Xph @ (cwbr @ XZ @ XR @ cclt)))))))))))))))).
