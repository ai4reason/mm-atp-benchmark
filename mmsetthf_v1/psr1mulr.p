...
thf(cpsr1mulr_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ ccps1)) => ((cwceq @ XS @ (cco @ cc1o @ XR @ ccmps)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccmulr)) => (cwceq @ Xc_x @ (ccfv @ XS @ ccmulr)))))))))).
