...
thf(adfrdg3_thm,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (cwceq @ (ccrdg @ XF @ XI) @ (ccuni @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccif @ (cwceq @ (ccv @ Xy1) @ cc0) @ (ccif @ (cwcel @ XI @ ccvv) @ XI @ cc0) @ (ccif @ (cwlim @ (ccv @ Xy1)) @ (ccuni @ (ccima @ (ccv @ Xf1) @ (ccv @ Xy1))) @ (ccfv @ (ccfv @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xf1)) @ XF))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0))))))))).
...
thf(abrimg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwbr @ (ccop @ XA2 @ XB2) @ XC @ ccimg) @ (cwceq @ XC @ (ccima @ XA2 @ XB2)))))))))).
thf(abrbigcup_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ ccbigcup) @ (cwceq @ (ccuni @ XA2) @ XB2)))))).
...
thf(aellimits_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ cclimits) @ (cwlim @ XA2))))).
thf(abrpprod3a_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => (cwb @ (cwbr @ (ccop @ XX @ XY) @ XZ @ (ccpprod @ XR @ XS)) @ (cwex @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (cw3a @ (cwceq @ XZ @ (ccop @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwbr @ XX @ (ccv @ Xz) @ XR) @ (cwbr @ XY @ (ccv @ Xw) @ XS)))))))))))))))).
...
thf(abrsuccf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ ccsuccf) @ (cwceq @ XB2 @ (ccsuc @ XA2)))))))).
thf(asylbi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(aonzsl_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccon0) @ (cw3o @ (cwceq @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)) @ (cwa @ (cwcel @ XA2 @ ccvv) @ (cwlim @ XA2)))))).
...
thf(aunisnif_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccuni @ (ccsn @ XA2)) @ (ccif @ (cwcel @ XA2 @ ccvv) @ XA2 @ cc0)))).
...
thf(cdfrdg4_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccrdg @ XF @ XA2) @ (ccuni @ (ccdif @ (ccin @ ccfuns @ (ccima @ (cccnv @ ccdomain) @ ccon0)) @ (ccdm @ (ccdif @ (cccom @ (cccnv @ ccep) @ ccdomain) @ (ccfix @ (cccom @ (cccnv @ ccapply) @ (ccun @ (ccxp @ (ccxp @ ccvv @ (ccsn @ cc0)) @ (ccsn @ (ccuni @ (ccsn @ XA2)))) @ (ccun @ (ccres @ (cccom @ ccbigcup @ ccimg) @ (ccxp @ ccvv @ cclimits)) @ (ccres @ (cccom @ (ccfullfn @ XF) @ (cccom @ ccapply @ (ccpprod @ ccid @ ccbigcup))) @ (ccxp @ ccvv @ (ccrn @ ccsuccf))))))))))))))).
