...
thf(cpfxeq_conj,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwa @ (cwbr @ XM @ (ccfv @ XW @ cchash) @ ccle) @ (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) @ (cwb @ (cwceq @ (cco @ XW @ XM @ ccpfx) @ (cco @ XU @ XN @ ccpfx)) @ (cwa @ (cwceq @ XM @ XN) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (ccv @ Xi) @ XU))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)))))))))))).
