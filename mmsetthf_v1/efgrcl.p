...
thf(awrdexb_thm,axiom,(! [XS:($i > $o)] : (cwb @ (cwcel @ XS @ ccvv) @ (cwcel @ (ccword @ XS) @ ccvv)))).
...
thf(cefgrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => (cwi @ (cwcel @ XA2 @ XW) @ (cwa @ (cwcel @ XI @ ccvv) @ (cwceq @ XW @ (ccword @ (ccxp @ XI @ cc2o)))))))))).
