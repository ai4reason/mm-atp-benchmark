...
thf(amulbinom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwceq @ (cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ XB2 @ ccaddc) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ cc2 @ ccexp) @ (cco @ (cco @ cc2 @ XC @ ccmul) @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc))))))).
...
thf(asqdivid_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XA2 @ ccdiv) @ XA2)))).
...
thf(cmulsubdivbinom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XD @ ccc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwne @ XC @ ccc0))) @ (cwceq @ (cco @ (cco @ (cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ XB2 @ ccaddc) @ cc2 @ ccexp) @ XD @ ccmin) @ XC @ ccdiv) @ (cco @ (cco @ (cco @ XC @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ XD @ ccmin) @ XC @ ccdiv) @ ccaddc)))))))).
