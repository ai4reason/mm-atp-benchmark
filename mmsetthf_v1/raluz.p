...
thf(aeluz1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XM @ ccz) @ (cwb @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwa @ (cwcel @ XN @ ccz) @ (cwbr @ XM @ XN @ ccle))))))).
thf(aimpexp_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwi @ (cwa @ Xph @ Xps) @ Xch) @ (cwi @ Xph @ (cwi @ Xps @ Xch))))))).
thf(craluz_conj,conjecture,(! [Xph:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccz) @ (cwb @ (cwral @ (^ [Xn:$i] : (Xph @ Xn)) @ (^ [Xn:$i] : (ccfv @ XM @ ccuz))) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwbr @ XM @ (ccv @ Xn) @ ccle) @ (Xph @ Xn))) @ (^ [Xn:$i] : ccz))))))).
