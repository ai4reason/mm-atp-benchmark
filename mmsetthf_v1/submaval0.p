...
thf(asubmafval_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (cco @ XN @ XR @ ccmat))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk @ Xm @ Xl) @ (cco @ XN @ XR @ ccsubma))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk @ Xl) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ ccbs))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk @ Xm @ Xl) @ (ccmpt @ (^ [Xm:$i] : (XB2 @ Xi @ Xj @ Xk @ Xl)) @ (^ [Xm:$i] : (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ XN @ (ccsn @ (ccv @ Xk))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ XN @ (ccsn @ (ccv @ Xl))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm))))))))))))))))))))))))).
thf(csubmaval0_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk @ Xl) @ (cco @ XN @ XR @ ccmat)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk @ Xl) @ (cco @ XN @ XR @ ccsubma)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk @ Xl) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xl) @ ccbs)))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwi @ (cwcel @ XM @ (XB2 @ Xi @ Xj @ Xk @ Xl)) @ (cwceq @ (ccfv @ XM @ (XQ @ Xi @ Xj @ Xk @ Xl)) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ XN @ (ccsn @ (ccv @ Xk))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ XN @ (ccsn @ (ccv @ Xl))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM))))))))))))))))))))))).
