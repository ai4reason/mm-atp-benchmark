...
thf(cocvsscon_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cw3a @ (cwcel @ XW @ ccphl) @ (cwss @ XS @ XV) @ (cwss @ XT @ XV)) @ (cwb @ (cwss @ XS @ (ccfv @ XT @ Xc_pe)) @ (cwss @ XT @ (ccfv @ XS @ Xc_pe)))))))))))).
