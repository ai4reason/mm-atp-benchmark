...
thf(cmbfmco_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XR @ XS @ ccmbfm))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XS @ XT @ ccmbfm))) => (cwi @ Xph @ (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccmbfm))))))))))))))).
