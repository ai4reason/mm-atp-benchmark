...
thf(cgsumspl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwi @ Xph @ (cwcel @ XM @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XS @ (ccword @ XB2))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((cwi @ Xph @ (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((cwi @ Xph @ (cwcel @ XX @ (ccword @ XB2))) => ((cwi @ Xph @ (cwcel @ XY @ (ccword @ XB2))) => ((cwi @ Xph @ (cwceq @ (cco @ XM @ XX @ ccgsu) @ (cco @ XM @ XY @ ccgsu))) => (cwi @ Xph @ (cwceq @ (cco @ XM @ (cco @ XS @ (ccotp @ XF @ XT @ XX) @ ccsplice) @ ccgsu) @ (cco @ XM @ (cco @ XS @ (ccotp @ XF @ XT @ XY) @ ccsplice) @ ccgsu)))))))))))))))))))).
