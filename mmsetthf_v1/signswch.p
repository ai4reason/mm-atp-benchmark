...
thf(csignswch_conj,conjecture,(! [Xc_pd:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (Xc_pd @ Xa @ Xb) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xb) @ ccc0) @ (ccv @ Xa) @ (ccv @ Xb)))))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XW @ Xa @ Xb) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (Xc_pd @ Xa @ Xb)))))) => (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XX @ (ccpr @ (ccneg @ cc1) @ cc1)) @ (cwcel @ XY @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (cwb @ (cwne @ (cco @ XX @ XY @ (Xc_pd @ Xa @ Xb)) @ XX) @ (cwbr @ (cco @ XX @ XY @ ccmul) @ ccc0 @ cclt)))))))))))).
