...
thf(amamutpos_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => ((cwceq @ XG @ (cco @ XR @ (ccotp @ XP @ XN @ XM) @ ccmmul)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XM @ ccfn)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((cwi @ Xph @ (cwcel @ XP @ ccfn)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XN @ XP) @ ccmap))) => (cwi @ Xph @ (cwceq @ (cctpos @ (cco @ XX @ XY @ XF)) @ (cco @ (cctpos @ XY) @ (cctpos @ XX) @ XG))))))))))))))))))))))).
...
thf(cmattposm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XA2 @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwceq @ (cctpos @ (cco @ XX @ XY @ Xc_x)) @ (cco @ (cctpos @ XY) @ (cctpos @ XX) @ Xc_x)))))))))))))).
