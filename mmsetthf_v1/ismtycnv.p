...
thf(cismtycnv_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XN @ (ccfv @ XY @ ccxmt))) @ (cwi @ (cwcel @ XF @ (cco @ XM @ XN @ ccismty)) @ (cwcel @ (cccnv @ XF) @ (cco @ XN @ XM @ ccismty)))))))))).
