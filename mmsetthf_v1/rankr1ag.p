...
thf(crankr1ag_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ XB2 @ (ccdm @ ccr1))) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) @ (cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2)))))).
