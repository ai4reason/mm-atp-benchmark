...
thf(cuhgreq12g_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwceq @ XW @ (ccfv @ XH @ ccvtx)) => ((cwceq @ XF @ (ccfv @ XH @ cciedg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ XX) @ (cwcel @ XH @ XY)) @ (cwa @ (cwceq @ XV @ XW) @ (cwceq @ XE @ XF))) @ (cwb @ (cwcel @ XG @ ccuhgr) @ (cwcel @ XH @ ccuhgr)))))))))))))))).
