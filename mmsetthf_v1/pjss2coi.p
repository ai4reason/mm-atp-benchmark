...
thf(apjss2i_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XG @ ccch) => (cwi @ (cwss @ XH @ XG) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh))))))))))).
...
thf(cpjss2coi_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (cwb @ (cwss @ XG @ XH) @ (cwceq @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XG @ ccpjh)))))))).
