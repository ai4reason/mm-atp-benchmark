...
thf(ctruae_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (ccuni @ (ccdm @ (XM @ Xx3))) @ XO)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3) @ (ccuni @ (ccrn @ ccmeas))))) => ((! [Xx3:$i] : (cwi @ Xph @ (Xps @ Xx3))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae))))))))))).
