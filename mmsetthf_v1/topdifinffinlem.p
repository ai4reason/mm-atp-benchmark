...
thf(adissneq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : (cwceq @ (XC @ Xx3 @ Xu) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))) => (! [Xx3:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwss @ (XC @ Xx3 @ Xu) @ (XB2 @ Xx3 @ Xu)) @ (cwcel @ (XB2 @ Xx3 @ Xu) @ (ccfv @ XA2 @ cctopon))) @ (cwceq @ (XB2 @ Xx3 @ Xu) @ (ccpw @ XA2)))))))))).
thf(aexellimddv_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > ($i > $o))] : ((cwi @ Xph @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwi @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ Xps))) => (cwi @ Xph @ Xps))))))).
...
thf(anelneq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwn @ (cwcel @ XA2 @ XC))) @ (cwn @ (cwceq @ XB2 @ XC))))))).
thf(aeqcom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ XB2 @ XA2))))).
thf(ctopdifinffinlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwn @ (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) @ (cwo @ (cwceq @ (ccv @ Xx3) @ cc0) @ (cwceq @ (ccv @ Xx3) @ XA2)))) @ (^ [Xx3:$i] : (ccpw @ XA2)))) => (cwi @ (cwcel @ XT @ (ccfv @ XA2 @ cctopon)) @ (cwcel @ XA2 @ ccfn)))))).
