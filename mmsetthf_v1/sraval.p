...
thf(adf_sra_ax,axiom,(cwceq @ ccsra @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xs1:$i] : (cco @ (cco @ (cco @ (ccv @ Xw) @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ (ccv @ Xw) @ (ccv @ Xs1) @ ccress)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ (ccfv @ (ccv @ Xw) @ ccmulr)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccip) @ (ccfv @ (ccv @ Xw) @ ccmulr)) @ ccsts))))))).
...
thf(csraval_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ XV) @ (cwss @ XS @ (ccfv @ XW @ ccbs))) @ (cwceq @ (ccfv @ XS @ (ccfv @ XW @ ccsra)) @ (cco @ (cco @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ XW @ XS @ ccress)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ (ccfv @ XW @ ccmulr)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccip) @ (ccfv @ XW @ ccmulr)) @ ccsts))))))).
