...
thf(comwordri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (cco @ XA2 @ XC @ ccomu) @ (cco @ XB2 @ XC @ ccomu)))))))).
