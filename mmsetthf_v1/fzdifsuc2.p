...
thf(cfzdifsuc2_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccmin) @ ccuz)) @ (cwceq @ (cco @ XM @ XN @ ccfz) @ (ccdif @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccsn @ (cco @ XN @ cc1 @ ccaddc)))))))).
