...
thf(awspthsn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xf1:$i] : (cwceq @ (cco @ (XN @ Xf1) @ XG @ ccwwspthsn) @ (ccrab @ (^ [Xw:$i] : (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xw) @ (ccfv @ XG @ ccspths))))) @ (^ [Xw:$i] : (cco @ (XN @ Xf1) @ XG @ ccwwlksn)))))))).
thf(ciswspthn_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xf1:$i] : (cwb @ (cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwspthsn)) @ (cwa @ (cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwlksn)) @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XW @ (ccfv @ XG @ ccspths))))))))))).
