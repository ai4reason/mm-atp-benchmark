...
thf(cfrege110_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (cwcel @ XX @ (XA2 @ Xa))) => ((! [Xa:$i] : (cwcel @ XY @ (XB2 @ Xa))) => ((! [Xa:$i] : (cwcel @ (XM @ Xa) @ (XC @ Xa))) => ((! [Xa:$i] : (cwcel @ XR @ (XD @ Xa))) => (! [Xa:$i] : (cwi @ (cwal @ (^ [Xa:$i] : (cwi @ (cwbr @ XY @ (ccv @ Xa) @ XR) @ (cwbr @ XX @ (ccv @ Xa) @ (ccun @ (ccfv @ XR @ cctcl) @ ccid))))) @ (cwi @ (cwbr @ XY @ (XM @ Xa) @ (ccfv @ XR @ cctcl)) @ (cwbr @ XX @ (XM @ Xa) @ (ccun @ (ccfv @ XR @ cctcl) @ ccid)))))))))))))))))).
