...
thf(ahis52_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (cco @ XB2 @ (cco @ (ccfv @ XA2 @ cccj) @ XC @ ccsm) @ ccsp) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccsp) @ ccmul))))))).
thf(criesz3i_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ XT) @ (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil)))))).
