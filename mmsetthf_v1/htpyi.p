...
thf(chtpyi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwceq @ (cco @ XA2 @ ccc0 @ XH) @ (ccfv @ XA2 @ XF)) @ (cwceq @ (cco @ XA2 @ cc1 @ XH) @ (ccfv @ XA2 @ XG))))))))))))))))).
