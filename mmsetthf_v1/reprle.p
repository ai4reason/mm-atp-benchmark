...
thf(afsumub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XK) @ (cwceq @ (XB2 @ Xk) @ XD))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (XC @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccrp))) => ((cwi @ Xph @ (cwcel @ XK @ XA2)) => (! [Xk:$i] : (cwi @ Xph @ (cwbr @ XD @ (XC @ Xk) @ ccle))))))))))))))).
...
thf(creprle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => (cwi @ Xph @ (cwbr @ (ccfv @ XX @ XC) @ XM @ ccle)))))))))))))).
