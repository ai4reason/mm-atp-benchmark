...
thf(csubsubrg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwceq @ XS @ (cco @ XR @ XA2 @ ccress)) => (cwi @ (cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) @ (cwb @ (cwcel @ XB2 @ (ccfv @ XS @ ccsubrg)) @ (cwa @ (cwcel @ XB2 @ (ccfv @ XR @ ccsubrg)) @ (cwss @ XB2 @ XA2)))))))))).
