...
thf(arrndistlt_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XI @ ccfn)) => ((cwi @ Xph @ (cwne @ XI @ cc0)) => ((! [Xi:$i] : (cwceq @ (XN @ Xi) @ (ccfv @ XI @ cchash))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ ccr @ XI @ ccmap))) => ((! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ XI)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xi) @ XX) @ (ccfv @ (ccv @ Xi) @ XY) @ ccmin) @ ccabs) @ XE @ cclt))) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => ((! [Xi:$i] : (cwceq @ (XD @ Xi) @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => (! [Xi:$i] : (cwi @ Xph @ (cwbr @ (cco @ XX @ XY @ (XD @ Xi)) @ (cco @ (ccfv @ (XN @ Xi) @ ccsqrt) @ XE @ ccmul) @ cclt))))))))))))))))))).
...
thf(cqndenserrnbllem_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XI @ ccfn)) => ((cwi @ Xph @ (cwne @ XI @ cc0)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((! [Xy1:$i] : (cwceq @ (XD @ Xy1) @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => (cwi @ Xph @ (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (cco @ XX @ XE @ (ccfv @ (XD @ Xy1) @ ccbl)))) @ (^ [Xy1:$i] : (cco @ ccq @ XI @ ccmap))))))))))))))).
