...
thf(clcmfunsn_conj,conjecture,(! [XN:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwss @ XY @ ccz) @ (cwcel @ XY @ ccfn) @ (cwcel @ XN @ ccz)) @ (cwceq @ (ccfv @ (ccun @ XY @ (ccsn @ XN)) @ cclcmf) @ (cco @ (ccfv @ XY @ cclcmf) @ XN @ cclcm)))))).
