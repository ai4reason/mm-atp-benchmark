...
thf(crpnnen3lem_conj,conjecture,(! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ ccr) @ (cwcel @ (ccv @ Xb) @ ccr)) @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ cclt)) @ (cwne @ (ccrab @ (^ [Xc:$i] : (cwbr @ (ccv @ Xc) @ (ccv @ Xa) @ cclt)) @ (^ [Xc:$i] : ccq)) @ (ccrab @ (^ [Xc:$i] : (cwbr @ (ccv @ Xc) @ (ccv @ Xb) @ cclt)) @ (^ [Xc:$i] : ccq))))))).
