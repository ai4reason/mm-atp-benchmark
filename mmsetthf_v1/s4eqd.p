...
thf(cs4eqd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XN)) => ((cwi @ Xph @ (cwceq @ XB2 @ XO)) => ((cwi @ Xph @ (cwceq @ XC @ XP)) => ((cwi @ Xph @ (cwceq @ XD @ XQ)) => (cwi @ Xph @ (cwceq @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs4 @ XN @ XO @ XP @ XQ))))))))))))))))).
