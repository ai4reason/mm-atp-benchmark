...
thf(acoss12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwss @ XC @ XD)) => (cwi @ Xph @ (cwss @ (cccom @ XA2 @ XC) @ (cccom @ XB2 @ XD))))))))))).
...
thf(crelexpss1d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccvv)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwss @ (cco @ XA2 @ XN @ ccrelexp) @ (cco @ XB2 @ XN @ ccrelexp))))))))))).
