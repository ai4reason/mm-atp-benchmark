...
thf(araleqd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
...
thf(callbutfiinf_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xm @ Xn) @ ccuz)))) => ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xm @ Xn) @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (XB2 @ Xm)))))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xm @ Xn) @ (cwcel @ XX @ (XA2 @ Xm @ Xn))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XN @ Xm @ Xn) @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ XX @ (XB2 @ Xm))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)))) @ (^ [Xn:$i] : XZ)) @ ccr @ cclt)))) => (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xm @ Xn) @ (cwa @ (cwcel @ (XN @ Xm @ Xn) @ XZ) @ (cwral @ (^ [Xm:$i] : (cwcel @ XX @ (XB2 @ Xm))) @ (^ [Xm:$i] : (ccfv @ (XN @ Xm @ Xn) @ ccuz))))))))))))))))))).
