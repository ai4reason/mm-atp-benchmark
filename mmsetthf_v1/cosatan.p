...
thf(aefiatan2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwceq @ (ccfv @ (cco @ cci @ (ccfv @ XA2 @ ccatan) @ ccmul) @ cce) @ (cco @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ ccdiv))))).
...
thf(ccosatan_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccatan) @ cccos) @ (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ ccdiv))))).
