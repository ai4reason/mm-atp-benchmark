...
thf(ctrpredmintr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XX @ XA2) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ XB2)) @ (^ [Xy1:$i] : XB2)) @ (cwss @ (ccpred @ XA2 @ XR @ XX) @ XB2))) @ (cwss @ (cctrpred @ XA2 @ XR @ XX) @ XB2))))))).
