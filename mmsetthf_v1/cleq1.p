...
thf(ccleq1_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwceq @ (ccint @ (ccab @ (^ [Xr:$i] : (cwa @ (cwss @ XR @ (ccv @ Xr)) @ (Xph @ Xr))))) @ (ccint @ (ccab @ (^ [Xr:$i] : (cwa @ (cwss @ XS @ (ccv @ Xr)) @ (Xph @ Xr))))))))))).
