...
thf(aelsuc2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XB2 @ (ccsuc @ XA2)) @ (cwo @ (cwcel @ XB2 @ XA2) @ (cwceq @ XB2 @ XA2))))))).
...
thf(calephordi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccon0) @ (cwi @ (cwcel @ XA2 @ XB2) @ (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ ccsdm)))))).
