...
thf(cdprdcntz_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => ((cwi @ Xph @ (cwcel @ XY @ XI)) => ((cwi @ Xph @ (cwne @ XX @ XY)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => (cwi @ Xph @ (cwss @ (ccfv @ XX @ XS) @ (ccfv @ (ccfv @ XY @ XS) @ XZ))))))))))))))))).
