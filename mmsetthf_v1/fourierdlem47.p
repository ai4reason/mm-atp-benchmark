...
thf(afladdz_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccz)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XN @ ccaddc) @ ccfl) @ (cco @ (ccfv @ XA2 @ ccfl) @ XN @ ccaddc)))))).
...
thf(afourierdlem30_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3) @ (ccneg @ (XG @ Xx3)) @ ccmul))) @ ccibl)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XF @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XG @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (ccfv @ (XA2 @ Xx3) @ ccabs))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (ccfv @ (XC @ Xx3) @ ccabs))) => ((! [Xx3:$i] : (cwceq @ (XZ @ Xx3) @ (ccfv @ (ccitg @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3) @ (ccneg @ (XG @ Xx3)) @ ccmul))) @ ccabs))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XE @ Xx3) @ ccrp))) => ((cwi @ Xph @ (cwcel @ XR @ ccr)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (cco @ (cco @ (cco @ (cco @ (XX @ Xx3) @ (XY @ Xx3) @ ccaddc) @ (XZ @ Xx3) @ ccaddc) @ (XE @ Xx3) @ ccdiv) @ cc1 @ ccaddc) @ XR @ ccle))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ cc1 @ ccle))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XD @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XD @ Xx3) @ ccabs) @ cc1 @ ccle))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (XA2 @ Xx3) @ (ccneg @ (cco @ (XB2 @ Xx3) @ XR @ ccdiv)) @ ccmul) @ (cco @ (XC @ Xx3) @ (ccneg @ (cco @ (XD @ Xx3) @ XR @ ccdiv)) @ ccmul) @ ccmin) @ (ccitg @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3) @ (ccneg @ (cco @ (XG @ Xx3) @ XR @ ccdiv)) @ ccmul))) @ ccmin) @ ccabs) @ (XE @ Xx3) @ cclt)))))))))))))))))))))))))))))))).
...
thf(cfourierdlem47_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xm:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xm) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XI @ Xr)) @ (^ [Xx3:$i] : (XF @ Xx3 @ Xr))) @ ccibl)))) => ((! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xr) @ ccr)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XI @ Xr)) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3 @ Xr) @ (ccneg @ (XG @ Xx3 @ Xr)) @ ccmul))) @ ccibl)))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xx3) @ (XI @ Xr))) @ (cwcel @ (XF @ Xx3 @ Xr) @ ccc))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xx3) @ (XI @ Xr))) @ (cwcel @ (ccv @ Xr) @ ccc)) @ (cwcel @ (XG @ Xx3 @ Xr) @ ccc))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xx3) @ (XI @ Xr))) @ (cwcel @ (ccv @ Xr) @ ccr)) @ (cwbr @ (ccfv @ (XG @ Xx3 @ Xr) @ ccabs) @ cc1 @ ccle))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xm) @ (cwcel @ (XA2 @ Xx3 @ Xr) @ ccc))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwceq @ (XX @ Xx3 @ Xm @ Xr) @ (ccfv @ (XA2 @ Xx3 @ Xr) @ ccabs))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xm) @ (cwcel @ (XC @ Xx3 @ Xr) @ ccc))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwceq @ (XY @ Xx3 @ Xm @ Xr) @ (ccfv @ (XC @ Xx3 @ Xr) @ ccabs))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwceq @ (XZ @ Xx3 @ Xm @ Xr) @ (ccitg @ (^ [Xx3:$i] : (XI @ Xr)) @ (^ [Xx3:$i] : (ccfv @ (XF @ Xx3 @ Xr) @ ccabs))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xm) @ (cwcel @ (XE @ Xx3 @ Xr) @ ccrp))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xr) @ ccc)) @ (cwcel @ (XB2 @ Xx3 @ Xr) @ ccc))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xr) @ ccr)) @ (cwbr @ (ccfv @ (XB2 @ Xx3 @ Xr) @ ccabs) @ cc1 @ ccle))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xr) @ ccc)) @ (cwcel @ (XD @ Xx3 @ Xr) @ ccc))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xr) @ ccr)) @ (cwbr @ (ccfv @ (XD @ Xx3 @ Xr) @ ccabs) @ cc1 @ ccle))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xr:$i] : (cwceq @ XM @ (cco @ (ccfv @ (cco @ (cco @ (cco @ (cco @ (XX @ Xx3 @ Xm @ Xr) @ (XY @ Xx3 @ Xm @ Xr) @ ccaddc) @ (XZ @ Xx3 @ Xm @ Xr) @ ccaddc) @ (XE @ Xx3 @ Xr) @ ccdiv) @ cc1 @ ccaddc) @ ccfl) @ cc1 @ ccaddc))))) => (! [Xx3:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xm) @ (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xr:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (XA2 @ Xx3 @ Xr) @ (ccneg @ (cco @ (XB2 @ Xx3 @ Xr) @ (ccv @ Xr) @ ccdiv)) @ ccmul) @ (cco @ (XC @ Xx3 @ Xr) @ (ccneg @ (cco @ (XD @ Xx3 @ Xr) @ (ccv @ Xr) @ ccdiv)) @ ccmul) @ ccmin) @ (ccitg @ (^ [Xx3:$i] : (XI @ Xr)) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3 @ Xr) @ (ccneg @ (cco @ (XG @ Xx3 @ Xr) @ (ccv @ Xr) @ ccdiv)) @ ccmul))) @ ccmin) @ ccabs) @ (XE @ Xx3 @ Xr) @ cclt)) @ (^ [Xr:$i] : (cco @ (ccv @ Xm) @ ccpnf @ ccioo)))) @ (^ [Xm:$i] : ccn))))))))))))))))))))))))))))))))))).
