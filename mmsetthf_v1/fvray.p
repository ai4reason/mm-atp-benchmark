...
thf(adf_ray_ax,axiom,(cwceq @ ccray @ (ccoprab @ (^ [Xp:$i] : (^ [Xa:$i] : (^ [Xr:$i] : (cwrex @ (^ [Xn:$i] : (cwa @ (cw3a @ (cwcel @ (ccv @ Xp) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwne @ (ccv @ Xp) @ (ccv @ Xa))) @ (cwceq @ (ccv @ Xr) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xp) @ (ccop @ (ccv @ Xa) @ (ccv @ Xx3)) @ ccoutsideof)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xn) @ ccee)))))) @ (^ [Xn:$i] : ccn)))))))).
...
thf(cfvray_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwne @ XP @ XA2))) @ (cwceq @ (cco @ XP @ XA2 @ ccray) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XP @ (ccop @ XA2 @ (ccv @ Xx3)) @ ccoutsideof)) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee))))))))).
