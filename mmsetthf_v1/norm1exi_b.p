...
thf(anormne0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwb @ (cwne @ (ccfv @ XA2 @ ccno) @ ccc0) @ (cwne @ XA2 @ cc0v))))).
...
thf(cnorm1exi_b_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) => (cwb @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0v)) @ (^ [Xx3:$i] : XH)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ ccno) @ cc1)) @ (^ [Xx3:$i] : XH)))))).
