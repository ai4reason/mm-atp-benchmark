...
thf(aislp3_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cclp))) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwne @ (ccin @ (ccv @ Xx3) @ (ccdif @ XS @ (ccsn @ XP))) @ cc0))) @ (^ [Xx3:$i] : XJ)))))))))).
...
thf(ainfssuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwn @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ XB2 @ ccfn) @ (cwss @ XA2 @ (ccuni @ XB2))) @ (cwrex @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccin @ XA2 @ (ccv @ Xx3)) @ ccfn))) @ (^ [Xx3:$i] : XB2)))))).
...
thf(cbwth_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cccmp) @ (cwss @ XA2 @ XX) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp)))) @ (^ [Xx3:$i] : XX)))))))).
