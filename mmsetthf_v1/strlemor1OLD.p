...
thf(acnvcnvsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cccnv @ (cccnv @ (ccsn @ (ccop @ XA2 @ XB2)))) @ (cccnv @ (ccsn @ (ccop @ XB2 @ XA2))))))).
...
thf(cstrlemor1OLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwa @ (cwfun @ (cccnv @ (cccnv @ XF))) @ (cwss @ (ccdm @ XF) @ (cco @ cc1 @ XI @ ccfz))) => ((cwcel @ XI @ ccn0) => ((cwbr @ XI @ XJ @ cclt) => ((cwcel @ XJ @ ccn) => ((cwceq @ XA2 @ XJ) => ((cwceq @ XG @ (ccun @ XF @ (ccsn @ (ccop @ XA2 @ XX)))) => (cwa @ (cwfun @ (cccnv @ (cccnv @ XG))) @ (cwss @ (ccdm @ XG) @ (cco @ cc1 @ XJ @ ccfz)))))))))))))))).
