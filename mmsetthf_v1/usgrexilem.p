...
thf(cusgrexilem_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XP @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XV @ (XW @ Xx3)) @ (cwf1 @ (ccdm @ (ccres @ ccid @ (XP @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (ccres @ ccid @ (XP @ Xx3)))))))))).
