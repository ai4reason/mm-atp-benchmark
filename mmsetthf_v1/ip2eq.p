...
thf(cip2eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ ccphl) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XA2 @ Xc_xi) @ (cco @ (ccv @ Xx3) @ XB2 @ Xc_xi))) @ (^ [Xx3:$i] : XV)))))))))))).
