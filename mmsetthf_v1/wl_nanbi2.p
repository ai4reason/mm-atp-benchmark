...
thf(awl_dfnan2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwnan @ Xph @ Xps) @ (cwi @ Xph @ (cwn @ Xps)))))).
thf(cwl_nanbi2_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwb @ Xph @ Xps) @ (cwb @ (cwnan @ Xph @ Xch) @ (cwnan @ Xps @ Xch))))))).
