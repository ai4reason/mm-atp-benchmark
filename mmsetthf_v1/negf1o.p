...
thf(cnegf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccneg @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwss @ XA2 @ ccr) @ (cwf1o @ XA2 @ (ccrab @ (^ [Xn:$i] : (cwcel @ (ccneg @ (ccv @ Xn)) @ XA2)) @ (^ [Xn:$i] : ccr)) @ (XF @ Xx3 @ Xn))))))))).
