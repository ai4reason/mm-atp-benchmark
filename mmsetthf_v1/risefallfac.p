...
thf(arisefacval2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ XN @ ccrisefac) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccaddc)))))))).
...
thf(afallfacval2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ XN @ ccfallfac) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccmin)))))))).
...
thf(crisefallfac_conj,conjecture,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XX @ XN @ ccrisefac) @ (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (cco @ (ccneg @ XX) @ XN @ ccfallfac) @ ccmul)))))).
