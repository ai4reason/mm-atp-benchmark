...
thf(cisfusgrf1_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : (cwi @ (cwcel @ XG @ XW) @ (cwb @ (cwcel @ XG @ ccfusgr) @ (cwa @ (cwf1 @ (ccdm @ (XI @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (XI @ Xx3)) @ (cwcel @ XV @ ccfn)))))))))))).
