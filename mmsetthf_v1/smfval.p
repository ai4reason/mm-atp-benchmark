...
thf(adf_sm_ax,axiom,(cwceq @ ccns @ (cccom @ cc2nd @ cc1st))).
...
thf(a_2nd0_thm,axiom,(cwceq @ (ccfv @ cc0 @ cc2nd) @ cc0)).
thf(csmfval_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XS @ (ccfv @ XU @ ccns)) => (cwceq @ XS @ (ccfv @ (ccfv @ XU @ cc1st) @ cc2nd)))))).
