...
thf(cofcfval3_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XF @ (XV @ Xx3)) @ (cwcel @ XC @ (XW @ Xx3))) @ (cwceq @ (cco @ XF @ XC @ (ccofc @ XR)) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ XF)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ XC @ XR)))))))))))).
