...
thf(aumgrspan_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwcel @ XS @ XW)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XS @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XS @ cciedg) @ (ccres @ XE @ XA2))) => ((cwi @ Xph @ (cwcel @ XG @ ccumgr)) => (cwi @ Xph @ (cwcel @ XS @ ccumgr)))))))))))))))).
...
thf(cumgrspanop_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ ccumgr) @ (cwcel @ (ccop @ XV @ (ccres @ XE @ XA2)) @ ccumgr))))))))).
