...
thf(csmatbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (cco @ XK @ XL @ (ccfv @ XA2 @ ccsmat))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XN @ ccfz)) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ cc1 @ XK @ ccfzo))) => ((cwi @ Xph @ (cwcel @ XJ @ (cco @ XL @ XN @ ccfz))) => (cwi @ Xph @ (cwceq @ (cco @ XI @ XJ @ XS) @ (cco @ XI @ (cco @ XJ @ cc1 @ ccaddc) @ XA2)))))))))))))))))))))).
