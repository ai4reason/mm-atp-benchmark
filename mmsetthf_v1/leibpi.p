...
thf(aleibpilem1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwa @ (cwn @ (cwceq @ XN @ ccc0)) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)))) @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0))))).
...
thf(aiseralt_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((cwi @ Xph @ (cwbr @ XG @ ccc0 @ ccli)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmul)))) => (cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))))))))))))))).
...
thf(aleibpilem2_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xn) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv)))))) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccif @ (cwo @ (cwceq @ (ccv @ Xk) @ ccc0) @ (cwbr @ cc2 @ (ccv @ Xk) @ ccdvds)) @ ccc0 @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ (ccv @ Xk) @ ccdiv)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwcel @ (XA2 @ Xk @ Xn) @ ccvv))) => (! [Xk:$i] : (! [Xn:$i] : (cwb @ (cwbr @ (ccseq @ ccaddc @ (XF @ Xk @ Xn) @ ccc0) @ (XA2 @ Xk @ Xn) @ ccli) @ (cwbr @ (ccseq @ ccaddc @ (XG @ Xk) @ ccc0) @ (XA2 @ Xk @ Xn) @ ccli))))))))))).
...
thf(aabelth2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwf @ ccn0 @ ccc @ XA2)) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3 @ Xn) @ (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ ccc @ cccncf)))))))))))).
...
thf(aatantayl2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds) @ ccc0 @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccv @ Xn) @ ccdiv) @ ccmul)))))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) @ (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ cc1) @ (ccfv @ XA2 @ ccatan) @ ccli))))))).
...
thf(aatancn_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwcel @ (ccres @ ccatan @ (XS @ Xy1)) @ (cco @ (XS @ Xy1) @ ccc @ cccncf)))))))).
thf(asstri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwss @ XB2 @ XC) => (cwss @ XA2 @ XC))))))).
thf(aunitssre_thm,axiom,(cwss @ (cco @ ccc0 @ cc1 @ ccicc) @ ccr)).
thf(ccxr_tp,type,(ccxr : ($i > $o))).
thf(aressatans_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwss @ ccr @ (XS @ Xy1)))))))).
...
thf(aatan1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccatan) @ (cco @ ccpi @ cc4 @ ccdiv))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(aclimuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwbr @ XF @ XA2 @ ccli) @ (cwbr @ XF @ XB2 @ ccli)) @ (cwceq @ XA2 @ XB2)))))).
thf(cleibpi_conj,conjecture,(! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xn) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ ccc0) @ (cco @ ccpi @ cc4 @ ccdiv) @ ccli))))).
