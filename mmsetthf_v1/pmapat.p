...
thf(cpmapat_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2)) @ (cwceq @ (ccfv @ XP @ XM) @ (ccsn @ XP)))))))))).
