...
thf(auzwo_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwss @ XS @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)) @ (cwne @ XS @ cc0)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle)) @ (^ [Xk:$i] : XS))) @ (^ [Xj:$i] : XS)))))))).
...
thf(albinfle_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwss @ XS @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS)) @ (cwcel @ (XA2 @ Xx3) @ XS)) @ (cwbr @ (ccinf @ XS @ ccr @ cclt) @ (XA2 @ Xx3) @ ccle)))))).
thf(cinfssuzle_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ (ccfv @ XM @ ccuz)) @ (cwcel @ XA2 @ XS)) @ (cwbr @ (ccinf @ XS @ ccr @ cclt) @ XA2 @ ccle)))))).
