...
thf(c_2sqn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ XP)) => (cwi @ Xph @ (cwne @ XA2 @ ccc0))))))))))).
