...
thf(apfxres_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) @ (cwceq @ (cco @ XS @ XL @ ccpfx) @ (ccres @ XS @ (cco @ ccc0 @ XL @ ccfzo)))))))).
...
thf(cpfxccat1_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2))) @ (cwceq @ (cco @ (cco @ XS @ XT @ ccconcat) @ (ccfv @ XS @ cchash) @ ccpfx) @ XS)))))).
