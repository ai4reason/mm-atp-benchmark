...
thf(aovoliunlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XT @ (ccseq @ ccaddc @ XG @ cc1)) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (cco @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ XB2 @ ccaddc) @ ccle)))))))))))))).
