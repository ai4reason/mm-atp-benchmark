...
thf(acht2_thm,axiom,(cwceq @ (ccfv @ cc2 @ cccht) @ (ccfv @ cc2 @ cclog))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xph @ Xch) @ Xps)))))).
thf(ccicc_tp,type,(ccicc : ($i > $o))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccsu_tp,type,(ccsu : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(achtfl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccfl) @ cccht) @ (ccfv @ XA2 @ cccht))))).
...
thf(auzind4i_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwcel @ XM @ ccz) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ XM) @ (cwb @ (Xph @ Xj) @ (Xps @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xch @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xj) @ (Xth @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (XN @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xta @ Xk))))) => ((! [Xk:$i] : (Xps @ Xk)) => ((! [Xk:$i] : (cwi @ (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz)) @ (cwi @ (Xch @ Xk) @ (Xth @ Xk)))) => (! [Xk:$i] : (cwi @ (cwcel @ (XN @ Xk) @ (ccfv @ XM @ ccuz)) @ (Xta @ Xk)))))))))))))))))).
...
thf(achtublem_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccmin) @ cccht) @ (cco @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc4 @ cclog) @ (cco @ XN @ cc1 @ ccmin) @ ccmul) @ ccaddc) @ ccle)))).
...
thf(achtnprm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwn @ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime))) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cccht) @ (ccfv @ XA2 @ cccht))))).
...
thf(cchtub_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccr) @ (cwbr @ cc2 @ XN @ cclt)) @ (cwbr @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc2 @ cclog) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccmin) @ ccmul) @ cclt)))).
