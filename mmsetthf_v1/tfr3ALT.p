...
thf(awfr3_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((cwceq @ XF @ (ccwrecs @ XA2 @ XR @ XG)) => (cwi @ (cwa @ (cwfn @ XH @ XA2) @ (cwral @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ XH) @ (ccfv @ (ccres @ XH @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ XG))) @ (^ [Xz:$i] : XA2))) @ (cwceq @ XF @ XH))))))))))).
...
thf(ctfr3ALT_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (ccrecs @ XG)) => (cwi @ (cwa @ (cwfn @ XB2 @ ccon0) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XB2) @ (ccfv @ (ccres @ XB2 @ (ccv @ Xx3)) @ XG))) @ (^ [Xx3:$i] : ccon0))) @ (cwceq @ XB2 @ XF))))))).
