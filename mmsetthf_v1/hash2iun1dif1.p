...
thf(ahashdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ XA2)) @ (cwceq @ (ccfv @ (ccdif @ XA2 @ (ccsn @ XB2)) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin)))))).
