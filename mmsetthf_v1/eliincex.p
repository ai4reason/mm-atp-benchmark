...
thf(celiincex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwceq @ XA2 @ ccvv) => ((cwceq @ XB2 @ cc0) => (cwn @ (cwb @ (cwcel @ XA2 @ (cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (cwral @ (^ [Xx3:$i] : (cwcel @ XA2 @ (XC @ Xx3))) @ (^ [Xx3:$i] : XB2)))))))))).
