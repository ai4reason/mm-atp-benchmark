...
thf(cdvafvsca_conj,conjecture,(! [XT:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XH @ Xf1 @ Xs1) @ (ccfv @ XK @ cclh)))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XU @ Xf1 @ Xs1) @ (ccfv @ XW @ (ccfv @ XK @ ccdveca))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (Xc_x @ Xf1 @ Xs1) @ (ccfv @ (XU @ Xf1 @ Xs1) @ ccvsca)))) => (! [Xf1:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ XK @ (XV @ Xf1 @ Xs1)) @ (cwcel @ XW @ (XH @ Xf1 @ Xs1))) @ (cwceq @ (Xc_x @ Xf1 @ Xs1) @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xf1:$i] : XE)) @ (^ [Xs1:$i] : (^ [Xf1:$i] : XT)) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccfv @ (ccv @ Xf1) @ (ccv @ Xs1))))))))))))))))))))))).
