...
thf(copelco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwcel @ (ccop @ XA2 @ XB2) @ (cccom @ XC @ XD)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ XD) @ (cwbr @ (ccv @ Xx3) @ XB2 @ XC)))))))))))).
