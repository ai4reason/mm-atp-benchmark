...
thf(aontgsucval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ (ccsuc @ XA2) @ cctg) @ (ccsuc @ XA2))))).
...
thf(consuctop_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccsuc @ XA2) @ cctop)))).
