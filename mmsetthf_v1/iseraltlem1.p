...
thf(ciseraltlem1_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((cwi @ Xph @ (cwbr @ XG @ ccc0 @ ccli)) => (cwi @ (cwa @ Xph @ (cwcel @ XN @ XZ)) @ (cwbr @ ccc0 @ (ccfv @ XN @ XG) @ ccle))))))))))))).
