...
thf(adivmul13d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwne @ XD @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccmul) @ (cco @ (cco @ XC @ XB2 @ ccdiv) @ (cco @ XA2 @ XD @ ccdiv) @ ccmul))))))))))))))).
...
thf(cmccllem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwcel @ (XA2 @ Xb) @ ccfn))) => ((! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwss @ XC @ (XA2 @ Xb)))) => ((! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwcel @ (XD @ Xb) @ (ccdif @ (XA2 @ Xb) @ XC)))) => ((! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwcel @ XB2 @ (cco @ ccn0 @ (ccun @ XC @ (ccsn @ (XD @ Xb))) @ ccmap)))) => ((! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (ccfv @ (ccsu @ XC @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xb)))) @ ccfa) @ (ccprod @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccfa))) @ ccdiv) @ ccn)) @ (^ [Xb:$i] : (cco @ ccn0 @ XC @ ccmap))))) => (! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwcel @ (cco @ (ccfv @ (ccsu @ (ccun @ XC @ (ccsn @ (XD @ Xb))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XB2))) @ ccfa) @ (ccprod @ (^ [Xk:$i] : (ccun @ XC @ (ccsn @ (XD @ Xb)))) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ XB2) @ ccfa))) @ ccdiv) @ ccn)))))))))))))).
