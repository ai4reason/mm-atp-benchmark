...
thf(afclstop_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwcel @ XJ @ cctop)))))).
thf(aneisspw_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwss @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccpw @ XX)))))))).
...
thf(afilunibas_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwceq @ (ccuni @ XF) @ XX))))).
thf(afclsfil_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))))))))).
...
thf(afclsneii_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwcel @ XN @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei))) @ (cwcel @ XS @ XF)) @ (cwne @ (ccin @ XN @ XS) @ cc0)))))))).
...
thf(afclselbas_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwcel @ XA2 @ XX)))))))).
thf(asnnzg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwne @ (ccsn @ XA2) @ cc0))))).
thf(aneifil_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) @ (cwcel @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccfv @ XX @ ccfil))))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(afbunfip_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwcel @ XG @ (ccfv @ XY @ ccfbas))) @ (cwb @ (cwn @ (cwcel @ cc0 @ (ccfv @ (ccun @ XF @ XG) @ ccfi))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwne @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0)) @ (^ [Xy1:$i] : XG))) @ (^ [Xx3:$i] : XF))))))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(afiltop_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ XX @ XF))))).
thf(cwnel_tp,type,(cwnel : (($i > $o) > (($i > $o) > $o)))).
thf(afsubbas_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwb @ (cwcel @ (ccfv @ XA2 @ ccfi) @ (ccfv @ XX @ ccfbas)) @ (cw3a @ (cwss @ XA2 @ (ccpw @ XX)) @ (cwne @ XA2 @ cc0) @ (cwn @ (cwcel @ cc0 @ (ccfv @ XA2 @ ccfi)))))))))).
...
thf(assfg_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwss @ XF @ (cco @ XX @ XF @ ccfg)))))).
...
thf(aelflim_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwss @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ XF))))))))).
...
thf(aflimtopon_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) @ (cwb @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(asimprrl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ (cwa @ Xch @ Xth))) @ Xch)))))).
thf(afclsss2_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XF @ XG)) @ (cwss @ (cco @ XJ @ XG @ ccfcls) @ (cco @ XJ @ XF @ ccfcls)))))))).
thf(asseldi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwi @ Xph @ (cwcel @ XC @ XA2)) => (cwi @ Xph @ (cwcel @ XC @ XB2))))))))).
thf(aflimfcls_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwss @ (cco @ XJ @ XF @ ccflim) @ (cco @ XJ @ XF @ ccfcls))))).
thf(cfclsfnflim_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ XF @ (ccv @ Xg1)) @ (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccflim)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil)))))))))).
