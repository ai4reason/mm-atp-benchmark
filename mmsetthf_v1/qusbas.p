...
thf(cqusbas_conj,conjecture,(! [Xph:$o] : (! [Xc_sm:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XR @ Xc_sm @ ccqus))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwcel @ Xc_sm @ XW)) => ((cwi @ Xph @ (cwcel @ XR @ XZ)) => (cwi @ Xph @ (cwceq @ (ccqs @ XV @ Xc_sm) @ (ccfv @ XU @ ccbs))))))))))))))).
