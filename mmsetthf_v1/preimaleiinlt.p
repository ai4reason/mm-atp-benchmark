...
thf(aiinrab_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwne @ XA2 @ cc0) @ (cwceq @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1))))) @ (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : (XB2 @ Xy1))))))))).
...
thf(axrralrecnnle_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccxr))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XB2 @ ccr))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwral @ (^ [Xn:$i] : (cwbr @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccle)) @ (^ [Xn:$i] : ccn)))))))))))).
...
thf(cpreimaleiinlt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ ccr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cciin @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (cco @ (XC @ Xx3) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
