...
thf(assrnres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwss @ XB2 @ (ccrn @ (ccres @ XC @ XA2))) @ (cwceq @ (ccrn @ (ccin @ XC @ (ccxp @ XA2 @ XB2))) @ XB2)))))).
...
thf(crninxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [Xx3:$i] : (cwb @ (cwceq @ (ccrn @ (ccin @ XC @ (ccxp @ XA2 @ (XB2 @ Xx3)))) @ (XB2 @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : (XB2 @ Xx3))))))))).
