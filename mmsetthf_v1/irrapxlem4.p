...
thf(airrapxlem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccn)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ (cco @ cc1 @ XB2 @ ccdiv) @ cclt)) @ (^ [Xy1:$i] : ccn0))) @ (^ [Xx3:$i] : (cco @ cc1 @ XB2 @ ccfz))))))).
thf(cirrapxlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccn)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ (cco @ cc1 @ (ccif @ (cwbr @ (ccv @ Xx3) @ XB2 @ ccle) @ XB2 @ (ccv @ Xx3)) @ ccdiv) @ cclt)) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccn)))))).
