...
thf(achirredi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => (cwo @ (cwceq @ XA2 @ cc0h) @ (cwceq @ XA2 @ cchil)))))).
...
thf(acm0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwbr @ cc0h @ XA2 @ cccm)))).
...
thf(cchirred_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ cccm)) @ (^ [Xx3:$i] : ccch))) @ (cwo @ (cwceq @ XA2 @ cc0h) @ (cwceq @ XA2 @ cchil))))).
