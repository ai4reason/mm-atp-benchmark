...
thf(adf_nlfn_ax,axiom,(cwceq @ ccnl @ (ccmpt @ (^ [Xt:$i] : (cco @ ccc @ cchil @ ccmap)) @ (^ [Xt:$i] : (ccima @ (cccnv @ (ccv @ Xt)) @ (ccsn @ ccc0)))))).
thf(cnlfnval_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ ccc @ XT) @ (cwceq @ (ccfv @ XT @ ccnl) @ (ccima @ (cccnv @ XT) @ (ccsn @ ccc0)))))).
