...
thf(cmatinvg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XG @ (cco @ XR @ (ccxp @ XN @ XN) @ ccfrlm)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ XV)) @ (cwceq @ (ccfv @ XG @ ccminusg) @ (ccfv @ XA2 @ ccminusg))))))))))).
