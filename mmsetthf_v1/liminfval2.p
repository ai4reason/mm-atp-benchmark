...
thf(aliminfval_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (cwcel @ XF @ (XV @ Xk)) @ (cwceq @ (ccfv @ XF @ cclsi) @ (ccsup @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))).
...
thf(assrexr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => (cwi @ Xph @ (cwss @ XA2 @ ccxr)))))).
thf(cwor_tp,type,(cwor : (($i > $o) > (($i > $o) > $o)))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(asupxrunb1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccxr) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf))))).
...
thf(aliminfgf_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ (XF @ Xk) @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwf @ ccr @ ccxr @ (XG @ Xk))))))).
...
thf(aliminfgord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwbr @ (ccinf @ (ccin @ (ccima @ XF @ (cco @ XA2 @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ (ccinf @ (ccin @ (ccima @ XF @ (cco @ XB2 @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ ccle)))))).
...
thf(aliminfgval_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (cwcel @ XM @ ccr) @ (cwceq @ (ccfv @ XM @ (XG @ Xk)) @ (ccinf @ (ccin @ (ccima @ XF @ (cco @ XM @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))))))).
thf(aadantlr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ (cwa @ Xph @ Xth) @ Xps) @ Xch))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(afnfvimad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwfn @ XF @ XA2)) => ((cwi @ Xph @ (cwcel @ XB2 @ XA2)) => ((cwi @ Xph @ (cwcel @ XB2 @ XC)) => (cwi @ Xph @ (cwcel @ (ccfv @ XB2 @ XF) @ (ccima @ XF @ XC)))))))))))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xph @ Xch) @ Xps)))))).
thf(cwnf_tp,type,(cwnf : (($i > $o) > $o))).
thf(afnmptd_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwfn @ (XF @ Xx3) @ XA2)))))))))))).
...
thf(asupxrss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ ccxr)) @ (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle))))).
...
thf(climinfval2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ (XA2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccsup @ (XA2 @ Xk) @ ccxr @ cclt) @ ccpnf))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ XF @ cclsi) @ (ccsup @ (ccima @ (XG @ Xk) @ (XA2 @ Xk)) @ ccxr @ cclt)))))))))))))).
