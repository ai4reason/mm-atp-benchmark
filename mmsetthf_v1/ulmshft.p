...
thf(aulmshftlem_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XZ @ Xn) @ (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwceq @ XW @ (ccfv @ (cco @ (XM @ Xn) @ XK @ ccaddc) @ ccuz))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xn) @ ccz))) => ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((! [Xn:$i] : (cwi @ Xph @ (cwf @ (XZ @ Xn) @ (cco @ ccc @ XS @ ccmap) @ XF))) => ((! [Xn:$i] : (cwi @ Xph @ (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : XW) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ XK @ ccmin) @ XF)))))) => (! [Xn:$i] : (cwi @ Xph @ (cwi @ (cwbr @ XF @ (XG @ Xn) @ (ccfv @ XS @ cculm)) @ (cwbr @ (XH @ Xn) @ (XG @ Xn) @ (ccfv @ XS @ cculm))))))))))))))))))))).
...
thf(culmshft_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XZ @ Xn) @ (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwceq @ XW @ (ccfv @ (cco @ (XM @ Xn) @ XK @ ccaddc) @ ccuz))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xn) @ ccz))) => ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((! [Xn:$i] : (cwi @ Xph @ (cwf @ (XZ @ Xn) @ (cco @ ccc @ XS @ ccmap) @ XF))) => ((! [Xn:$i] : (cwi @ Xph @ (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : XW) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ XK @ ccmin) @ XF)))))) => (! [Xn:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XF @ (XG @ Xn) @ (ccfv @ XS @ cculm)) @ (cwbr @ (XH @ Xn) @ (XG @ Xn) @ (ccfv @ XS @ cculm))))))))))))))))))))).
