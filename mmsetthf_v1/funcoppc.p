...
thf(atposfn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwfn @ (cctpos @ XF) @ (ccxp @ XB2 @ XA2))))))).
...
thf(cfuncoppc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => ((cwceq @ XP @ (ccfv @ XD @ ccoppc)) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfunc))) => (cwi @ Xph @ (cwbr @ XF @ (cctpos @ XG) @ (cco @ XO @ XP @ ccfunc)))))))))))))).
