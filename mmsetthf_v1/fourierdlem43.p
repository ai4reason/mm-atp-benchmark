...
thf(asinaover2ne0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ cc2 @ ccpi @ ccmul) @ ccioo)) @ (cwne @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) @ ccc0)))).
...
thf(cfourierdlem43_conj,conjecture,(! [XK:($i > ($i > $o))] : ((! [Xs1:$i] : (cwceq @ (XK @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ cc1 @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => (! [Xs1:$i] : (cwf @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccr @ (XK @ Xs1)))))).
