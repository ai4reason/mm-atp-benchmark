...
thf(cqqh1_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0)) @ (cwceq @ (ccfv @ cc1 @ (ccfv @ XR @ ccqqh)) @ (ccfv @ XR @ ccur))))))))))).
