...
thf(aclim2prod_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XN @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((cwi @ Xph @ (cwbr @ (ccseq @ ccmul @ XF @ (cco @ XN @ cc1 @ ccaddc)) @ XA2 @ ccli)) => (cwi @ Xph @ (cwbr @ (ccseq @ ccmul @ XF @ XM) @ (cco @ (ccfv @ XN @ (ccseq @ ccmul @ XF @ XM)) @ XA2 @ ccmul) @ ccli))))))))))))).
...
thf(cntrivcvg_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XZ @ Xn) @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xy1) @ ccc0) @ (cwbr @ (ccseq @ ccmul @ XF @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli))))) @ (^ [Xn:$i] : (XZ @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (XZ @ Xn))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc)))) => (cwi @ Xph @ (cwcel @ (ccseq @ ccmul @ XF @ XM) @ (ccdm @ ccli))))))))))).
