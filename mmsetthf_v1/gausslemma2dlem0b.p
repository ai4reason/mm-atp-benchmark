...
thf(annoddm1d2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwb @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn))))).
...
thf(cgausslemma2dlem0b_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XH @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => (cwi @ Xph @ (cwcel @ XH @ ccn)))))))).
