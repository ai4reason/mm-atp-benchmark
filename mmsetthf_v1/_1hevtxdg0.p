...
thf(c_1hevtxdg0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ XE)))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XD @ XV)) => ((cwi @ Xph @ (cwcel @ XE @ XY)) => ((cwi @ Xph @ (cwnel @ XD @ XE)) => (cwi @ Xph @ (cwceq @ (ccfv @ XD @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))))))))))))).
