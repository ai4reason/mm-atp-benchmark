...
thf(celcpn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwcel @ XF @ (ccfv @ XN @ (ccfv @ XS @ cccpn))) @ (cwa @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) @ (cwcel @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn)) @ (cco @ (ccdm @ XF) @ ccc @ cccncf))))))))).
