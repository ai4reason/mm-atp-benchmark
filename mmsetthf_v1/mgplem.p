...
thf(cmgplem_conj,conjecture,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => ((cwceq @ XE @ (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwne @ XN @ cc2) => (cwceq @ (ccfv @ XR @ XE) @ (ccfv @ XM @ XE))))))))))).
