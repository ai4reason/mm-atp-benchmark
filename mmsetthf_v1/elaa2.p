...
thf(celaa2_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdif @ ccaa @ (ccsn @ ccc0))) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ ccc0) @ (cwceq @ (ccfv @ XA2 @ (ccv @ Xf1)) @ ccc0))) @ (^ [Xf1:$i] : (ccfv @ ccz @ ccply))))))).
