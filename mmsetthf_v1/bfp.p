...
thf(abfplem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XD @ (ccfv @ XX @ ccms)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwne @ XX @ cc0))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XK @ Xz) @ ccrp))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (XK @ Xz) @ cc1 @ cclt))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ XX @ XX @ XF))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XD) @ (cco @ (XK @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccmul) @ ccle))))) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XX))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ XG @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn @ (ccsn @ (XA2 @ Xx3 @ Xy1 @ Xz))) @ cc1))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwrex @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz))) @ (^ [Xz:$i] : XX)))))))))))))))))))))).
...
thf(cbfp_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XD @ (ccfv @ XX @ ccms)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwne @ XX @ cc0))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XK @ Xz) @ ccrp))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (XK @ Xz) @ cc1 @ cclt))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ XX @ XX @ XF))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XD) @ (cco @ (XK @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccmul) @ ccle))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwreu @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz))) @ (^ [Xz:$i] : XX)))))))))))))))).
