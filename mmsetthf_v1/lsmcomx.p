...
thf(clsmcomx_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cw3a @ (cwcel @ XG @ ccabl) @ (cwss @ XT @ XB2) @ (cwss @ XU @ XB2)) @ (cwceq @ (cco @ XT @ XU @ Xc_po) @ (cco @ XU @ XT @ Xc_po))))))))))).
