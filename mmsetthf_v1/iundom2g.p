...
thf(aacnrcl_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ (cwacn @ XA2)) @ (cwcel @ XA2 @ ccvv))))).
...
thf(ciundom2g_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XC @ (XB2 @ Xx3) @ ccmap))) @ (cwacn @ XA2)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ XC @ ccdom)) @ (^ [Xx3:$i] : XA2)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (XT @ Xx3) @ (ccxp @ XA2 @ XC) @ ccdom)))))))))))).
