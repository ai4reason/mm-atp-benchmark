...
thf(cpcmpt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (XA2 @ Xn) @ ccexp) @ cc1))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwral @ (^ [Xn:$i] : (cwcel @ (XA2 @ Xn) @ ccn0)) @ (^ [Xn:$i] : ccprime)))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XP @ ccprime))) => ((! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ XP) @ (cwceq @ (XA2 @ Xn) @ XB2))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (cco @ XP @ (ccfv @ (XN @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ ccpc) @ (ccif @ (cwbr @ XP @ (XN @ Xn) @ ccle) @ XB2 @ ccc0)))))))))))))))).
