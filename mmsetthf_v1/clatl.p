...
thf(ajoindmss_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwi @ Xph @ (cwcel @ XK @ XV)) => (cwi @ Xph @ (cwss @ (ccdm @ Xc_or) @ (ccxp @ XB2 @ XB2)))))))))))).
...
thf(ameetdmss_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwi @ Xph @ (cwcel @ XK @ XV)) => (cwi @ Xph @ (cwss @ (ccdm @ Xc_an) @ (ccxp @ XB2 @ XB2)))))))))))).
...
thf(cclatl_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ cccla) @ (cwcel @ XK @ cclat)))).
