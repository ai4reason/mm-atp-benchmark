...
thf(adf_linds_ax,axiom,(cwceq @ cclinds @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : (cwbr @ (ccres @ ccid @ (ccv @ Xs1)) @ (ccv @ Xw) @ cclindf)) @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))))))).
...
thf(cislinds_conj,conjecture,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => (cwi @ (cwcel @ XW @ XV) @ (cwb @ (cwcel @ XX @ (ccfv @ XW @ cclinds)) @ (cwa @ (cwss @ XX @ XB2) @ (cwbr @ (ccres @ ccid @ XX) @ XW @ cclindf)))))))))).
