...
thf(aiscmet3i_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccme)) => ((! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xf1) @ (ccfv @ XD @ ccca)) @ (cwf @ ccn @ XX @ (ccv @ Xf1))) @ (cwcel @ (ccv @ Xf1) @ (ccdm @ (ccfv @ XJ @ cclm))))) => (cwcel @ XD @ (ccfv @ XX @ ccms))))))))).
...
thf(chhcms_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwcel @ XD @ (ccfv @ cchil @ ccms))))))).
