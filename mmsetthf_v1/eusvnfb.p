...
thf(aeusv1_thm,axiom,(! [XA2:($i > ($i > $o))] : (cwb @ (cweu @ (^ [Xy1:$i] : (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3)))))) @ (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3))))))))).
thf(ceusvnfb_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (cwb @ (cweu @ (^ [Xy1:$i] : (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3)))))) @ (cwa @ (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwcel @ (XA2 @ Xx3) @ ccvv)))))).
