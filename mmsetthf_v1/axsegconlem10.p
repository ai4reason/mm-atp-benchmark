...
thf(afveere_thm,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XI @ (cco @ cc1 @ XN @ ccfz))) @ (cwcel @ (ccfv @ XI @ XA2) @ ccr)))))).
thf(aad2antrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ (cwa @ Xph @ Xch) @ Xth) @ Xps))))))).
thf(a_3adant3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cw3a @ Xph @ Xps @ Xth) @ Xch))))))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(aaxsegconlem8_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xp:$i] : (cwceq @ (XS @ Xp) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xp:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xp) @ XA2) @ (ccfv @ (ccv @ Xp) @ XB2) @ ccmin) @ cc2 @ ccexp))))) => ((! [Xp:$i] : (cwceq @ (XT @ Xp) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xp:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xp) @ XC) @ (ccfv @ (ccv @ Xp) @ XD) @ ccmin) @ cc2 @ ccexp))))) => ((! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xk @ Xp) @ (ccmpt @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ (cco @ (ccfv @ (XS @ Xp) @ ccsqrt) @ (ccfv @ (XT @ Xp) @ ccsqrt) @ ccaddc) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccmul) @ (cco @ (ccfv @ (XT @ Xp) @ ccsqrt) @ (ccfv @ (ccv @ Xk) @ XA2) @ ccmul) @ ccmin) @ (ccfv @ (XS @ Xp) @ ccsqrt) @ ccdiv)))))) => (! [Xk:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwne @ XA2 @ XB2)) @ (cwa @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)))) @ (cwcel @ (XF @ Xk @ Xp) @ (ccfv @ XN @ ccee))))))))))))))))).
...
thf(adivmul2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XC @ ccdiv) @ XB2) @ (cwceq @ XA2 @ (cco @ XC @ XB2 @ ccmul))))))))))))).
...
thf(caxsegconlem10_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : ((! [Xp:$i] : (cwceq @ (XS @ Xp) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xp:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xp) @ XA2) @ (ccfv @ (ccv @ Xp) @ XB2) @ ccmin) @ cc2 @ ccexp))))) => ((! [Xp:$i] : (cwceq @ (XT @ Xp) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xp:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xp) @ XC) @ (ccfv @ (ccv @ Xp) @ XD) @ ccmin) @ cc2 @ ccexp))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xi @ Xk @ Xp) @ (ccmpt @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ (cco @ (ccfv @ (XS @ Xp) @ ccsqrt) @ (ccfv @ (XT @ Xp) @ ccsqrt) @ ccaddc) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccmul) @ (cco @ (ccfv @ (XT @ Xp) @ ccsqrt) @ (ccfv @ (ccv @ Xk) @ XA2) @ ccmul) @ ccmin) @ (ccfv @ (XS @ Xp) @ ccsqrt) @ ccdiv))))))) => (! [Xk:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwne @ XA2 @ XB2)) @ (cwa @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)))) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XB2) @ (cco @ (cco @ (cco @ cc1 @ (cco @ (ccfv @ (XS @ Xp) @ ccsqrt) @ (cco @ (ccfv @ (XS @ Xp) @ ccsqrt) @ (ccfv @ (XT @ Xp) @ ccsqrt) @ ccaddc) @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ (cco @ (ccfv @ (XS @ Xp) @ ccsqrt) @ (cco @ (ccfv @ (XS @ Xp) @ ccsqrt) @ (ccfv @ (XT @ Xp) @ ccsqrt) @ ccaddc) @ ccdiv) @ (ccfv @ (ccv @ Xi) @ (XF @ Xi @ Xk @ Xp)) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))))))))))))))))).
