...
thf(cflodddiv4_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc))) @ (cwceq @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ (ccif @ (cwbr @ cc2 @ XM @ ccdvds) @ (cco @ XM @ cc2 @ ccdiv) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv))))))).
