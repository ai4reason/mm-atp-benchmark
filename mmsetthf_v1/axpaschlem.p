...
thf(caxpaschlem_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwcel @ XS @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xp:$i] : (cw3a @ (cwceq @ (ccv @ Xp) @ (cco @ (cco @ cc1 @ (ccv @ Xr) @ ccmin) @ (cco @ cc1 @ XT @ ccmin) @ ccmul)) @ (cwceq @ (ccv @ Xr) @ (cco @ (cco @ cc1 @ (ccv @ Xp) @ ccmin) @ (cco @ cc1 @ XS @ ccmin) @ ccmul)) @ (cwceq @ (cco @ (cco @ cc1 @ (ccv @ Xr) @ ccmin) @ XT @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xp) @ ccmin) @ XS @ ccmul)))) @ (^ [Xp:$i] : (cco @ ccc0 @ cc1 @ ccicc)))) @ (^ [Xr:$i] : (cco @ ccc0 @ cc1 @ ccicc))))))).
