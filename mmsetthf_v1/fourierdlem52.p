...
thf(cfourierdlem52_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XT @ ccfn)) => ((cwceq @ XN @ (cco @ (ccfv @ XT @ cchash) @ cc1 @ ccmin)) => ((cwceq @ XS @ (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XT @ cclt @ cclt @ (ccv @ Xf1))))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xf1) @ ccr))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xf1) @ ccr))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwss @ XT @ (cco @ (XA2 @ Xf1) @ (XB2 @ Xf1) @ ccicc)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xf1) @ XT))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xf1) @ XT))) => (! [Xf1:$i] : (cwi @ Xph @ (cwa @ (cwa @ (cwf @ (cco @ ccc0 @ XN @ ccfz) @ (cco @ (XA2 @ Xf1) @ (XB2 @ Xf1) @ ccicc) @ XS) @ (cwceq @ (ccfv @ ccc0 @ XS) @ (XA2 @ Xf1))) @ (cwceq @ (ccfv @ XN @ XS) @ (XB2 @ Xf1)))))))))))))))))))).
