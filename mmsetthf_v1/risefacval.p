...
thf(aprodeq2sdv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwceq @ (XB2 @ Xk) @ (XC @ Xk)))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))))))))))).
...
thf(adf_risefac_ax,axiom,(cwceq @ ccrisefac @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc)))))))).
...
thf(crisefacval_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ XN @ ccrisefac) @ (ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccaddc)))))))).
