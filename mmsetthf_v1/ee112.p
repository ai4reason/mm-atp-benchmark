...
thf(cee112_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ (cwi @ Xth @ Xta)) => ((cwi @ Xps @ (cwi @ Xch @ (cwi @ Xta @ Xet))) => (cwi @ Xph @ (cwi @ Xth @ Xet))))))))))))).
