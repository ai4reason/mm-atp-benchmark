...
thf(cee122_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ (cwi @ Xch @ Xth)) => ((cwi @ Xph @ (cwi @ Xch @ Xta)) => ((cwi @ Xps @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwi @ Xph @ (cwi @ Xch @ Xet))))))))))))).
