...
thf(cccatval21sw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwne @ XB2 @ cc0)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cchash) @ (cco @ XA2 @ XB2 @ ccconcat)) @ (ccfv @ ccc0 @ XB2))))))).
