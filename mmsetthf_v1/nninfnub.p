...
thf(cnninfnub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccn) @ (cwn @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ XB2 @ ccn)) @ (cwne @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2)) @ cc0))))).
