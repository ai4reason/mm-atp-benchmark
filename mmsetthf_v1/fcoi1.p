...
thf(acores2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ (ccdm @ XA2) @ XC) @ (cwceq @ (cccom @ XA2 @ (cccnv @ (ccres @ (cccnv @ XB2) @ XC))) @ (cccom @ XA2 @ XB2))))))).
thf(afunrel_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwfun @ XA2) @ (cwrel @ XA2)))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwcel_tp,type,(cwcel : (($i > $o) > (($i > $o) > $o)))).
thf(acoi1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwceq @ (cccom @ XA2 @ ccid) @ XA2)))).
thf(cfcoi1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwceq @ (cccom @ XF @ (ccres @ ccid @ XA2)) @ XF)))))).
