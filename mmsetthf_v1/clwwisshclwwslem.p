...
thf(aelfzom1p1elfzo_thm,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XX @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (cco @ XX @ cc1 @ ccaddc) @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(ann0n0n1ge2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwne @ XN @ ccc0) @ (cwne @ XN @ cc1)) @ (cwbr @ cc2 @ XN @ ccle)))).
