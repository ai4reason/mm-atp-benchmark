...
thf(a_2pthon3v_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XV @ Xf1 @ Xp) @ (ccfv @ XG @ ccvtx)))) => ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xf1 @ Xp) @ (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XG @ ccuhgr) @ (cw3a @ (cwcel @ XA2 @ (XV @ Xf1 @ Xp)) @ (cwcel @ XB2 @ (XV @ Xf1 @ Xp)) @ (cwcel @ XC @ (XV @ Xf1 @ Xp)))) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)) @ (cwa @ (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp)))) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ XA2 @ XC @ (ccfv @ XG @ ccspthson))) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc2)))))))))))))))))).
thf(c_2pthfrgr_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XV @ Xf1 @ Xp) @ (ccfv @ XG @ ccvtx)))) => (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XG @ ccfrgr) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ XG @ ccspthson))) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc2))))))) @ (^ [Xb:$i] : (ccdif @ (XV @ Xf1 @ Xp) @ (ccsn @ (ccv @ Xa)))))) @ (^ [Xa:$i] : (XV @ Xf1 @ Xp)))))))))).
