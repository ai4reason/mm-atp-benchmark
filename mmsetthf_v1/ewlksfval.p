...
thf(cewlksfval_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XI @ Xf1 @ Xk) @ (ccfv @ XG @ cciedg)))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwcel @ XS @ ccxnn0)) @ (cwceq @ (cco @ XG @ XS @ ccewlks) @ (ccab @ (^ [Xf1:$i] : (cwa @ (cwcel @ (ccv @ Xf1) @ (ccword @ (ccdm @ (XI @ Xf1 @ Xk)))) @ (cwral @ (^ [Xk:$i] : (cwbr @ XS @ (ccfv @ (ccin @ (ccfv @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xf1)) @ (XI @ Xf1 @ Xk)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (XI @ Xf1 @ Xk))) @ cchash) @ ccle)) @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo))))))))))))))).
