...
thf(a_0noddALTV_thm,axiom,(cwnel @ ccc0 @ ccodd)).
...
thf(cnn0oALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XN @ ccodd)) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0)))).
