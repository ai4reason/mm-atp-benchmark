...
thf(apwslnmlem0_thm,axiom,(! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XW @ cc0 @ ccpws)) => (cwi @ (cwcel @ XW @ cclmod) @ (cwcel @ XY @ cclnm)))))).
...
thf(apwslnmlem1_thm,axiom,(! [XW:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XY @ Xi) @ (cco @ XW @ (ccsn @ (ccv @ Xi)) @ ccpws))) => (! [Xi:$i] : (cwi @ (cwcel @ XW @ cclnm) @ (cwcel @ (XY @ Xi) @ cclnm))))))).
thf(cpwslnm_conj,conjecture,(! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XW @ XI @ ccpws)) => (cwi @ (cwa @ (cwcel @ XW @ cclnm) @ (cwcel @ XI @ ccfn)) @ (cwcel @ XY @ cclnm))))))).
