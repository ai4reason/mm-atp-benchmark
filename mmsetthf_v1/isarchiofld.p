...
thf(aisarchi3_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1) @ (ccfv @ XW @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_lt @ Xx3 @ Xy1) @ (ccfv @ XW @ ccplt)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_x @ Xx3 @ Xy1) @ (ccfv @ XW @ ccmg)))) => (cwi @ (cwcel @ XW @ ccogrp) @ (cwb @ (cwcel @ XW @ ccarchi) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (Xc_0 @ Xx3 @ Xy1) @ (ccv @ Xx3) @ (Xc_lt @ Xx3 @ Xy1)) @ (cwrex @ (^ [Xn:$i] : (cwbr @ (ccv @ Xy1) @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ (Xc_x @ Xx3 @ Xy1)) @ (Xc_lt @ Xx3 @ Xy1))) @ (^ [Xn:$i] : ccn)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))))).
...
thf(aofldlt1_thm,axiom,(! [Xc_lt:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XF @ ccur)) => ((cwceq @ Xc_lt @ (ccfv @ XF @ ccplt)) => (cwi @ (cwcel @ XF @ ccofld) @ (cwbr @ Xc_0 @ Xc_1 @ Xc_lt)))))))))).
...
thf(aorngrmullt_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwi @ Xph @ (cwcel @ XR @ ccorng)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwceq @ Xc_lt @ (ccfv @ XR @ ccplt)) => ((cwi @ Xph @ (cwcel @ XR @ ccdr)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ Xc_lt)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XZ @ Xc_lt)) => (cwi @ Xph @ (cwbr @ (cco @ XX @ XZ @ Xc_x) @ (cco @ XY @ XZ @ Xc_x) @ Xc_lt))))))))))))))))))))))).
...
thf(amulgass2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => ((cwceq @ Xc_xp @ (ccfv @ XR @ ccmulr)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (cco @ (cco @ XN @ XX @ Xc_x) @ XY @ Xc_xp) @ (cco @ XN @ (cco @ XX @ XY @ Xc_xp) @ Xc_x)))))))))))))).
...
thf(cisarchiofld_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccfv @ XW @ cczrh))) => ((cwceq @ Xc_lt @ (ccfv @ XW @ ccplt)) => (cwi @ (cwcel @ XW @ ccofld) @ (cwb @ (cwcel @ XW @ ccarchi) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xn:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XH @ Xn)) @ Xc_lt)) @ (^ [Xn:$i] : ccn))) @ (^ [Xx3:$i] : XB2)))))))))))).
