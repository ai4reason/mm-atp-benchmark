...
thf(cdisjxun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XC @ Xx3) @ (XD @ Xy1))))) => (cwi @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwb @ (cwdisj @ (^ [Xx3:$i] : (ccun @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cw3a @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccin @ (XC @ Xx3) @ (XD @ Xy1)) @ cc0)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))))).
