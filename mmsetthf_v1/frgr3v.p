...
thf(afrgr3vlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XZ)) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC))) @ (cwi @ (cwa @ (cwceq @ XV @ (cctp @ XA2 @ XB2 @ XC)) @ (cwcel @ XG @ ccusgr)) @ (cwb @ (cwreu @ (^ [Xx3:$i] : (cwss @ (ccpr @ (ccpr @ (ccv @ Xx3) @ XA2) @ (ccpr @ (ccv @ Xx3) @ XB2)) @ XE)) @ (^ [Xx3:$i] : (cctp @ XA2 @ XB2 @ XC))) @ (cwa @ (cwcel @ (ccpr @ XC @ XA2) @ XE) @ (cwcel @ (ccpr @ XC @ XB2) @ XE))))))))))))))))).
