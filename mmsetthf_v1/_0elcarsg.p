...
thf(c_0elcarsg_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ XV)) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0)) => (cwi @ Xph @ (cwcel @ cc0 @ (ccfv @ XM @ cccarsg))))))))))).
