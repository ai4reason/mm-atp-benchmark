...
thf(aelfz0add_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwi @ (cwcel @ XN @ (cco @ ccc0 @ XA2 @ ccfz)) @ (cwcel @ XN @ (cco @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ ccfz)))))))).
...
thf(ciwrdsplit_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwf @ ccn0 @ XS @ XF)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccres @ XF @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)) @ (cco @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccs1 @ (ccfv @ XN @ XF)) @ ccconcat))))))))))).
