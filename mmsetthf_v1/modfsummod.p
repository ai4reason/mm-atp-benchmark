...
thf(amodfsummods_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ (XA2 @ Xz) @ ccfn) @ (cwcel @ (XN @ Xz) @ ccn) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xz @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz)))))) @ (cwi @ (cwceq @ (cco @ (ccsu @ (XA2 @ Xz) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) @ (XN @ Xz) @ ccmo) @ (cco @ (ccsu @ (XA2 @ Xz) @ (^ [Xk:$i] : (cco @ (XB2 @ Xz @ Xk) @ (XN @ Xz) @ ccmo))) @ (XN @ Xz) @ ccmo)) @ (cwceq @ (cco @ (ccsu @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) @ (XN @ Xz) @ ccmo) @ (cco @ (ccsu @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (^ [Xk:$i] : (cco @ (XB2 @ Xz @ Xk) @ (XN @ Xz) @ ccmo))) @ (XN @ Xz) @ ccmo))))))))).
...
thf(cmodfsummod_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XN @ ccn))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : XA2)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ XN @ ccmo) @ (cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XN @ ccmo))) @ XN @ ccmo)))))))))))).
