...
thf(ao1f_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ cco1) @ (cwf @ (ccdm @ XF) @ ccc @ XF)))).
thf(alo1o1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ ccc @ XF) @ (cwb @ (cwcel @ XF @ cco1) @ (cwcel @ (cccom @ ccabs @ XF) @ cclo1)))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(alo1res_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ cclo1) @ (cwcel @ (ccres @ XF @ XA2) @ cclo1))))).
thf(a_3syl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => ((cwi @ Xch @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(afresin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ (ccin @ XA2 @ XX) @ XB2 @ (ccres @ XF @ XX)))))))).
thf(co1res_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ cco1) @ (cwcel @ (ccres @ XF @ XA2) @ cco1))))).
