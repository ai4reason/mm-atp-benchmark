...
thf(afourierdlem77_thm,axiom,(! [Xph:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwf @ ccr @ ccr @ (XF @ Xs1 @ Xa @ Xb)))))) => ((! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwcel @ (XX @ Xs1 @ Xa @ Xb) @ ccr))))) => ((! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwcel @ (XY @ Xs1 @ Xa @ Xb) @ ccr))))) => ((! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwcel @ (XW @ Xs1 @ Xa @ Xb) @ ccr))))) => ((! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XH @ Xs1 @ Xa @ Xb) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ (XX @ Xs1 @ Xa @ Xb) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xs1 @ Xa @ Xb)) @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xs1) @ cclt) @ (XY @ Xs1 @ Xa @ Xb) @ (XW @ Xs1 @ Xa @ Xb)) @ ccmin) @ (ccv @ Xs1) @ ccdiv)))))))) => ((! [Xa:$i] : (cwceq @ (XK @ Xa) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ cc1 @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => ((! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XU @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XH @ Xs1 @ Xa @ Xb)) @ (ccfv @ (ccv @ Xs1) @ (XK @ Xa)) @ ccmul))))))) => ((! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwrex @ (^ [Xa:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (XH @ Xs1 @ Xa @ Xb)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)))) @ (^ [Xa:$i] : ccr)))) => (! [Xb:$i] : (cwi @ (Xph @ Xb) @ (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (XU @ Xs1)) @ ccabs) @ (ccv @ Xb) @ ccle)) @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)))) @ (^ [Xb:$i] : ccrp))))))))))))))))))))).
...
thf(aitgabs_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ XV))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccabs) @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccabs))) @ ccle))))))))).
...
thf(aiblconstmpt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ ccc)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ ccibl))))).
...
thf(cfourierdlem87_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XY:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xe @ Xk) @ (cwf @ ccr @ ccr @ (XF @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xe @ Xk) @ (cwcel @ (XX @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ ccr)))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xe @ Xk) @ (cwcel @ (XY @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ ccr)))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xe @ Xk) @ (cwcel @ (XW @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ ccr)))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwceq @ (XH @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ (XX @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xs1) @ cclt) @ (XY @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ (XW @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ ccmin) @ (ccv @ Xs1) @ ccdiv))))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : (cwceq @ (XK @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xd) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ cc1 @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwceq @ (XU @ Xu @ Xe @ Xs1 @ Xd) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XH @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ (ccfv @ (ccv @ Xs1) @ (XK @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xd)) @ ccmul)))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwceq @ (XS @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin)))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwceq @ (XG @ Xx3 @ Xe @ Xk @ Xn) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XU @ Xu @ Xe @ Xs1 @ Xd)) @ (ccfv @ (ccv @ Xs1) @ (XS @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ ccmul))))))))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xe @ Xk) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (XH @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)))) @ (^ [Xx3:$i] : ccr))))))))) => ((! [Xx3:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xe @ Xk) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (XG @ Xx3 @ Xe @ Xk @ Xn) @ ccibl)))))) => ((! [Xx3:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xa:$i] : (cwceq @ (XD @ Xx3 @ Xe @ Xk @ Xs1 @ Xa) @ (cco @ (cco @ (ccv @ Xe) @ cc3 @ ccdiv) @ (ccv @ Xa) @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwb @ (Xch @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xa @ Xd) @ (cwa @ (cwa @ (cwa @ (cw3a @ (cwa @ (Xph @ Xe @ Xk) @ (cwcel @ (ccv @ Xe) @ ccrp)) @ (cwcel @ (ccv @ Xa) @ ccrp) @ (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (XG @ Xx3 @ Xe @ Xk @ Xn)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)))) @ (^ [Xn:$i] : ccn))) @ (cwcel @ (ccv @ Xu) @ (ccdm @ ccvol))) @ (cwa @ (cwss @ (ccv @ Xu) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (XD @ Xx3 @ Xe @ Xk @ Xs1 @ Xa) @ ccle))) @ (cwcel @ (ccv @ Xn) @ ccn))))))))))) => (! [Xe:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xe @ Xk) @ (cwcel @ (ccv @ Xe) @ ccrp)) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xu:$i] : (cwi @ (cwa @ (cwss @ (ccv @ Xu) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (ccv @ Xd) @ ccle)) @ (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccitg @ (^ [Xs1:$i] : (ccv @ Xu)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XU @ Xu @ Xe @ Xs1 @ Xd)) @ (ccfv @ (cco @ (cco @ (ccv @ Xk) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ ccmul))) @ ccabs) @ (cco @ (ccv @ Xe) @ cc2 @ ccdiv) @ cclt)) @ (^ [Xk:$i] : ccn)))) @ (^ [Xu:$i] : (ccdm @ ccvol)))) @ (^ [Xd:$i] : ccrp))))))))))))))))))))))))))))))).
