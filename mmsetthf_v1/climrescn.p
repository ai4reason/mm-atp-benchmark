...
thf(cclimrescn_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ (XM @ Xj) @ ccz))) => ((! [Xj:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xj) @ ccuz))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwfn @ XF @ XZ))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ XF @ (ccdm @ ccli)))) => (! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwrex @ (^ [Xj:$i] : (cwf @ (ccfv @ (ccv @ Xj) @ ccuz) @ ccc @ (ccres @ XF @ (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))))))))))))).
