...
thf(aspthonisspth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson))) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))))).
...
thf(aspthonepeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson))) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XF @ cchash) @ ccc0))))))))).
thf(cwspthsnonn0vne_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwne @ (cco @ XX @ XY @ (cco @ XN @ XG @ ccwwspthsnon)) @ cc0)) @ (cwne @ XX @ XY))))))).
