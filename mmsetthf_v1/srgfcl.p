...
thf(csrgfcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cwa @ (cwcel @ XR @ ccsrg) @ (cwfn @ Xc_x @ (ccxp @ XB2 @ XB2))) @ (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ Xc_x)))))))).
