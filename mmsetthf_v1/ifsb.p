...
thf(cifsb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwi @ (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XA2) @ (cwceq @ XC @ XD)) => ((cwi @ (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XB2) @ (cwceq @ XC @ XE)) => (cwceq @ XC @ (ccif @ Xph @ XD @ XE))))))))))).
