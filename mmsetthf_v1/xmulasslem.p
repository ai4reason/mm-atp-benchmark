...
thf(cxmulasslem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XD) @ (cwb @ (Xps @ Xx3) @ (cwceq @ XX @ XY)))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccxne @ XD)) @ (cwb @ (Xps @ Xx3) @ (cwceq @ XE @ XF)))) => ((cwi @ Xph @ (cwcel @ XX @ ccxr)) => ((cwi @ Xph @ (cwcel @ XY @ ccxr)) => ((cwi @ Xph @ (cwcel @ XD @ ccxr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccxr) @ (cwbr @ ccc0 @ (ccv @ Xx3) @ cclt))) @ (Xps @ Xx3))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwi @ (cwceq @ (ccv @ Xx3) @ ccc0) @ (Xps @ Xx3)))) => ((cwi @ Xph @ (cwceq @ XE @ (ccxne @ XX))) => ((cwi @ Xph @ (cwceq @ XF @ (ccxne @ XY))) => (cwi @ Xph @ (cwceq @ XX @ XY))))))))))))))))))).
