...
thf(csqrtmsq2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (cwi @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ XB2 @ ccle)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccsqrt) @ XB2) @ (cwceq @ XA2 @ (cco @ XB2 @ XB2 @ ccmul))))))))).
