...
thf(crmxm1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmx) @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmin)))))).
