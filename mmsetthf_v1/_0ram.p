...
thf(ahashbc0_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XC @ Xi @ Xa @ Xb) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xi:$i] : ccn0)) @ (^ [Xa:$i] : (^ [Xi:$i] : (ccrab @ (^ [Xb:$i] : (cwceq @ (ccfv @ (ccv @ Xb) @ cchash) @ (ccv @ Xi))) @ (^ [Xb:$i] : (ccpw @ (ccv @ Xa))))))))))) => (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwcel @ (XA2 @ Xb) @ (XV @ Xi @ Xa @ Xb)) @ (cwceq @ (cco @ (XA2 @ Xb) @ ccc0 @ (XC @ Xi @ Xa @ Xb)) @ (ccsn @ cc0))))))))))).
...
thf(c_0ram_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XR @ (XV @ Xy1)) @ (cwne @ XR @ cc0) @ (cwf @ XR @ ccn0 @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccrn @ XF)))) @ (^ [Xx3:$i] : ccz))) @ (cwceq @ (cco @ ccc0 @ XF @ ccram) @ (ccsup @ (ccrn @ XF) @ ccr @ cclt)))))))).
