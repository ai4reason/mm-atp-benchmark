...
thf(caxpweq_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ (ccpw @ XA2) @ ccvv) @ (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwal @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xz) @ XA2)))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))))).
