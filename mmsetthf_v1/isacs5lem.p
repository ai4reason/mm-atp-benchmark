...
thf(cisacs5lem_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwral @ (^ [Xt:$i] : (cwi @ (cwcel @ (ccfv @ (ccv @ Xt) @ ccipo) @ ccdrs) @ (cwceq @ (ccfv @ (ccuni @ (ccv @ Xt)) @ XF) @ (ccuni @ (ccima @ XF @ (ccv @ Xt)))))) @ (^ [Xt:$i] : (ccpw @ (ccpw @ XX))))) @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwral @ (^ [Xs1:$i] : (cwceq @ (ccfv @ (ccv @ Xs1) @ XF) @ (ccuni @ (ccima @ XF @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))))) @ (^ [Xs1:$i] : (ccpw @ XX)))))))))).
