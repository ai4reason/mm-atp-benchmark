...
thf(cplusfeq_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_pd @ (ccfv @ XG @ ccplusf)) => (cwi @ (cwfn @ Xc_pl @ (ccxp @ XB2 @ XB2)) @ (cwceq @ Xc_pd @ Xc_pl)))))))))).
