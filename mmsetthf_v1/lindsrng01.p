...
thf(almodsn0_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => (cwi @ (cwcel @ XW @ cclmod) @ (cwne @ XB2 @ cc0)))))))).
...
thf(a_0ring_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwceq @ (ccfv @ XB2 @ cchash) @ cc1)) @ (cwceq @ XB2 @ (ccsn @ Xc_0))))))))).
...
thf(clindsrng01_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XE @ (ccfv @ XR @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwo @ (cwceq @ (ccfv @ XE @ cchash) @ ccc0) @ (cwceq @ (ccfv @ XE @ cchash) @ cc1)) @ (cwcel @ XS @ (ccpw @ XB2))) @ (cwbr @ XS @ XM @ cclininds))))))))))).
