...
thf(agrpinveu_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ XB2)) @ (cwreu @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ XX @ Xc_pl) @ Xc_0)) @ (^ [Xy1:$i] : XB2)))))))))))).
...
thf(cgrpinvf_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XG @ ccminusg)) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwf @ XB2 @ XB2 @ XN)))))))).
