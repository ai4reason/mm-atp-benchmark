...
thf(asupicclub_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XC @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XA2 @ (cco @ (XB2 @ Xz) @ (XC @ Xz) @ ccicc)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwne @ XA2 @ cc0))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XD @ XA2))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwb @ (cwbr @ XD @ (ccsup @ XA2 @ ccr @ cclt) @ cclt) @ (cwrex @ (^ [Xz:$i] : (cwbr @ XD @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : XA2)))))))))))))))).
...
thf(csupicclub2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ Xph @ (cwss @ XA2 @ (cco @ (XB2 @ Xz) @ (XC @ Xz) @ ccicc)))) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => ((cwi @ Xph @ (cwcel @ XD @ XA2)) => ((! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XA2)) @ (cwbr @ (ccv @ Xz) @ XD @ ccle))) => (cwi @ Xph @ (cwbr @ (ccsup @ XA2 @ ccr @ cclt) @ XD @ ccle)))))))))))))).
