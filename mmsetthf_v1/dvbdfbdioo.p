...
thf(advbdfbdioolem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XK @ ccr)) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccabs) @ XK @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)))) => ((! [Xx3:$i] : (cwceq @ (XM @ Xx3) @ (cco @ (ccfv @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ XF) @ ccabs) @ (cco @ XK @ (cco @ XB2 @ XA2 @ ccmin) @ ccmul) @ ccaddc))) => (cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ (XM @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))))))).
