...
thf(clemulge11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ cc1 @ XB2 @ ccle))) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle))))).
