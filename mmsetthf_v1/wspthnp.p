...
thf(adf_wspthsn_ax,axiom,(cwceq @ ccwwspthsn @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xg1:$i] : ccn0)) @ (^ [Xn:$i] : (^ [Xg1:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xg1:$i] : (ccrab @ (^ [Xw:$i] : (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xw) @ (ccfv @ (ccv @ Xg1) @ ccspths))))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xg1) @ ccwwlksn)))))))).
...
thf(cwspthnp_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xf1:$i] : (cwi @ (cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwspthsn)) @ (cw3a @ (cwa @ (cwcel @ (XN @ Xf1) @ ccn0) @ (cwcel @ XG @ ccvv)) @ (cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwlksn)) @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XW @ (ccfv @ XG @ ccspths))))))))))).
