...
thf(asubgdmdprd_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => (cwi @ (cwcel @ XA2 @ (ccfv @ XG @ ccsubg)) @ (cwb @ (cwbr @ XH @ XS @ (ccdm @ ccdprd)) @ (cwa @ (cwbr @ XG @ XS @ (ccdm @ ccdprd)) @ (cwss @ (ccrn @ XS) @ (ccpw @ XA2))))))))))).
...
thf(csubgdprd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwss @ (ccrn @ XS) @ (ccpw @ XA2))) => (cwi @ Xph @ (cwceq @ (cco @ XH @ XS @ ccdprd) @ (cco @ XG @ XS @ ccdprd))))))))))))).
