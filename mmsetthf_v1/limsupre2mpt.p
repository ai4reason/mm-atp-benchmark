...
thf(alimsupre2_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwf @ XA2 @ ccxr @ (XF @ Xj)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwb @ (cwcel @ (ccfv @ (XF @ Xj) @ cclsp) @ ccr) @ (cwa @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwa @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ cclt))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccv @ Xx3) @ cclt))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))))))))))).
...
thf(climsupre2mpt_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xk:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xk))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xk) @ (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xy1 @ Xk) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccxr))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xk) @ (cwb @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclsp) @ ccr) @ (cwa @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xk) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccv @ Xy1) @ (XB2 @ Xx3) @ cclt))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xy1:$i] : ccr)) @ (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ cclt))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xy1:$i] : ccr))))))))))))))).
