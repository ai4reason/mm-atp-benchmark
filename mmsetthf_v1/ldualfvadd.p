...
thf(aofmresex_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => (cwi @ Xph @ (cwcel @ (ccres @ (ccof @ XR) @ (ccxp @ XA2 @ XB2)) @ ccvv))))))))))).
...
thf(cldualfvadd_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XR @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwceq @ XD @ (ccfv @ XW @ ccld)) => ((cwceq @ Xc_pb @ (ccfv @ XD @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XW @ XX)) => ((cwceq @ Xc_pd @ (ccres @ (ccof @ Xc_pl) @ (ccxp @ XF @ XF))) => (cwi @ Xph @ (cwceq @ Xc_pb @ Xc_pd))))))))))))))))))).
