...
thf(chlprlem_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cwcel @ XW @ cchl) @ (cw3a @ (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)) @ (cwcel @ (cco @ cccnfld @ XK @ ccress) @ ccdr) @ (cwcel @ (cco @ cccnfld @ XK @ ccress) @ cccms))))))))).
