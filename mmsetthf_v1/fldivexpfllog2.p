...
thf(afllogbd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XX @ ccrp)) => ((cwceq @ XE @ (ccfv @ (cco @ XB2 @ XX @ cclogb) @ ccfl)) => (cwi @ Xph @ (cwa @ (cwbr @ (cco @ XB2 @ XE @ ccexp) @ XX @ ccle) @ (cwbr @ XX @ (cco @ XB2 @ (cco @ XE @ cc1 @ ccaddc) @ ccexp) @ cclt))))))))))).
...
thf(adivge1b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ cc1 @ (cco @ XB2 @ XA2 @ ccdiv) @ ccle)))))).
...
thf(cfldivexpfllog2_conj,conjecture,(! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ ccrp) @ (cwceq @ (ccfv @ (cco @ XX @ (cco @ cc2 @ (ccfv @ (cco @ cc2 @ XX @ cclogb) @ ccfl) @ ccexp) @ ccdiv) @ ccfl) @ cc1)))).
