...
thf(ccoe1mul2lem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XX @ (cco @ ccn0 @ cc1o @ ccmap))) @ (cwb @ (cwbr @ XX @ (ccxp @ cc1o @ (ccsn @ XA2)) @ (ccofr @ ccle)) @ (cwcel @ (ccfv @ cc0 @ XX) @ (cco @ ccc0 @ XA2 @ ccfz))))))).
