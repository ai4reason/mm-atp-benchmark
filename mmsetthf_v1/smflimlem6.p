...
thf(aaxccd2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwbr @ XA2 @ ccom @ ccdom)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwne @ (ccv @ Xx3) @ cc0))) => (cwi @ Xph @ (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(axpct_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwbr @ XB2 @ ccom @ ccdom)) @ (cwbr @ (ccxp @ XA2 @ XB2) @ ccom @ ccdom))))).
...
thf(asmflimlem5_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XM @ Xx3 @ Xk @ Xn @ Xs1 @ Xr) @ ccz))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XZ @ Xs1 @ Xr) @ (ccfv @ (XM @ Xx3 @ Xk @ Xn @ Xs1 @ Xr) @ ccuz))))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XS @ Xx3 @ Xr) @ ccsalg))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwf @ (XZ @ Xs1 @ Xr) @ (ccfv @ (XS @ Xx3 @ Xr) @ ccsmblfn) @ (XF @ Xr)))))) => ((! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XD @ Xs1) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccmpt @ (^ [Xm:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xr))))) @ (ccdm @ ccli))) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xr)))))))))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XG @ Xx3 @ Xs1 @ Xr) @ (ccmpt @ (^ [Xx3:$i] : (XD @ Xs1)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xm:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xr))))) @ ccli))))))) => ((! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XA2 @ Xr) @ ccr)))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XP @ Xx3 @ Xn) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xk:$i] : (XZ @ Xs1 @ Xr))) @ (^ [Xm:$i] : (^ [Xk:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xr))) @ (cco @ (XA2 @ Xr) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ cclt)) @ (^ [Xx3:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xr))))) @ (ccin @ (ccv @ Xs1) @ (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xr)))))) @ (^ [Xs1:$i] : (XS @ Xx3 @ Xr))))))))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XH @ Xx3 @ Xr) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xk:$i] : (XZ @ Xs1 @ Xr))) @ (^ [Xm:$i] : (^ [Xk:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xk:$i] : (ccfv @ (cco @ (ccv @ Xm) @ (ccv @ Xk) @ (XP @ Xx3 @ Xn)) @ (XC @ Xx3 @ Xn)))))))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XI @ Xn @ Xs1) @ (cciin @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cciun @ (^ [Xn:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (cco @ (ccv @ Xm) @ (ccv @ Xk) @ (XH @ Xx3 @ Xr))))))))))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xs1) @ (cwcel @ (ccv @ Xr) @ (ccrn @ (XP @ Xx3 @ Xn)))) @ (cwcel @ (ccfv @ (ccv @ Xr) @ (XC @ Xx3 @ Xn)) @ (ccv @ Xr))))))) => (! [Xx3:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XG @ Xx3 @ Xs1 @ Xr)) @ (XA2 @ Xr) @ ccle)) @ (^ [Xx3:$i] : (XD @ Xs1))) @ (cco @ (XS @ Xx3 @ Xr) @ (XD @ Xs1) @ ccrest)))))))))))))))))))))))))))))).
...
thf(csmflimlem6_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XM @ Xx3 @ Xk @ Xn @ Xs1) @ ccz)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xk @ Xn @ Xs1) @ ccuz)))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XS @ Xx3) @ ccsalg)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwf @ XZ @ (ccfv @ (XS @ Xx3) @ ccsmblfn) @ XF)))) => ((! [Xs1:$i] : (cwceq @ (XD @ Xs1) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ XF)))) @ (ccdm @ ccli))) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ XF)))))))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (cwceq @ (XG @ Xx3 @ Xs1) @ (ccmpt @ (^ [Xx3:$i] : (XD @ Xs1)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ XF)))) @ ccli)))))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XA2 @ ccr))) => ((! [Xx3:$i] : (cwceq @ XP @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xk:$i] : XZ)) @ (^ [Xm:$i] : (^ [Xk:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ XF)) @ (cco @ XA2 @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ cclt)) @ (^ [Xx3:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ XF)))) @ (ccin @ (ccv @ Xs1) @ (ccdm @ (ccfv @ (ccv @ Xm) @ XF))))) @ (^ [Xs1:$i] : (XS @ Xx3)))))))) => (! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XG @ Xx3 @ Xs1)) @ XA2 @ ccle)) @ (^ [Xx3:$i] : (XD @ Xs1))) @ (cco @ (XS @ Xx3) @ (XD @ Xs1) @ ccrest))))))))))))))))))))))).
