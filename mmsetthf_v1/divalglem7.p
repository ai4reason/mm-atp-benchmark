...
thf(adivalglem6_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwcel @ XX @ (cco @ ccc0 @ (cco @ XA2 @ cc1 @ ccmin) @ ccfz)) => ((cwcel @ XK @ ccz) => (cwi @ (cwne @ XK @ ccc0) @ (cwn @ (cwcel @ (cco @ XX @ (cco @ XK @ XA2 @ ccmul) @ ccaddc) @ (cco @ ccc0 @ (cco @ XA2 @ cc1 @ ccmin) @ ccfz))))))))))).
...
thf(cdivalglem7_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => (cwi @ (cwa @ (cwcel @ XX @ (cco @ ccc0 @ (cco @ (ccfv @ XD @ ccabs) @ cc1 @ ccmin) @ ccfz)) @ (cwcel @ XK @ ccz)) @ (cwi @ (cwne @ XK @ ccc0) @ (cwn @ (cwcel @ (cco @ XX @ (cco @ XK @ (ccfv @ XD @ ccabs) @ ccmul) @ ccaddc) @ (cco @ ccc0 @ (cco @ (ccfv @ XD @ ccabs) @ cc1 @ ccmin) @ ccfz))))))))))).
