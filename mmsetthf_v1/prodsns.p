...
thf(cprodsns_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XM @ (XV @ Xk)) @ (cwcel @ (ccsb @ XM @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccc)) @ (cwceq @ (ccprod @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsb @ XM @ (^ [Xk:$i] : (XA2 @ Xk)))))))))).
