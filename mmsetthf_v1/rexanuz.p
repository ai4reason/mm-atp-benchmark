...
thf(auzin2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccrn @ ccuz)) @ (cwcel @ XB2 @ (ccrn @ ccuz))) @ (cwcel @ (ccin @ XA2 @ XB2) @ (ccrn @ ccuz)))))).
...
thf(crexanuz_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwb @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (Xph @ Xk) @ (Xps @ Xk))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz)) @ (cwa @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xph @ Xk)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xps @ Xk)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz))))))).
