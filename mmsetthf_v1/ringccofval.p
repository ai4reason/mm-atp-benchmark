...
thf(cringccofval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccringc)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => (cwi @ Xph @ (cwceq @ Xc_x @ (ccfv @ (ccfv @ XU @ ccestrc) @ ccco)))))))))))).
