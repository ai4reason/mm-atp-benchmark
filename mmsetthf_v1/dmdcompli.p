...
thf(amdsldmd1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (cwi @ (cwa @ (cwa @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwbr @ XB2 @ XA2 @ ccdmd)) @ (cwa @ (cwss @ XA2 @ (ccin @ XC @ XD)) @ (cwss @ (cco @ XC @ XD @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) @ (cwb @ (cwbr @ XC @ XD @ ccdmd) @ (cwbr @ (ccin @ XC @ XB2) @ (ccin @ XD @ XB2) @ ccdmd)))))))))))).
thf(achoccli_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwcel @ (ccfv @ XA2 @ ccort) @ ccch)))).
thf(cdmdcompli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwbr @ (ccin @ XA2 @ (ccfv @ (ccin @ XA2 @ XB2) @ ccort)) @ (ccin @ XB2 @ (ccfv @ (ccin @ XA2 @ XB2) @ ccort)) @ ccdmd))))))).
