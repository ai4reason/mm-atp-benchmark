...
thf(cdifreicc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccdif @ ccr @ (cco @ XA2 @ XB2 @ ccicc)) @ (ccun @ (cco @ ccmnf @ XA2 @ ccioo) @ (cco @ XB2 @ ccpnf @ ccioo))))))).
