...
thf(aneival_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwceq @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ XS @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX)))))))))).
...
thf(cisnei_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) @ (cwa @ (cwss @ XN @ XX) @ (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ XS @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : XJ))))))))))).
