...
thf(cimasnopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwa @ (cwcel @ XR @ (cco @ XJ @ XK @ cctx)) @ (cwcel @ XA2 @ XX))) @ (cwcel @ (ccima @ XR @ (ccsn @ XA2)) @ XK))))))))).
