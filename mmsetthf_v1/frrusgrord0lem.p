...
thf(cfrrusgrord0lem_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ XK)) @ (^ [Xv:$i] : XV))) @ (cw3a @ (cwcel @ XK @ ccc) @ (cwcel @ (ccfv @ XV @ cchash) @ ccc) @ (cwne @ (ccfv @ XV @ cchash) @ ccc0)))))))).
