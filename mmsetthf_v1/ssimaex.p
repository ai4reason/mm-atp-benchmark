...
thf(cssimaex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ XB2 @ (ccima @ XF @ XA2))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwceq @ XB2 @ (ccima @ XF @ (ccv @ Xx3)))))))))))).
