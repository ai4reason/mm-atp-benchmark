...
thf(ccxpaddlelem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ XB2 @ cc1 @ ccle)) => (cwi @ Xph @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cccxp) @ ccle))))))))))).
