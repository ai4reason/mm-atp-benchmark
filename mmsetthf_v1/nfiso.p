...
thf(cnfiso_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XH @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XR @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XS @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (cwnf @ (^ [Xx3:$i] : (cwiso @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XR @ Xx3) @ (XS @ Xx3) @ (XH @ Xx3))))))))))))))).
