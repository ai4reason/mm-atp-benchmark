...
thf(asqcn_thm,axiom,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc2 @ ccexp))) @ (cco @ XJ @ XJ @ cccn))))).
...
thf(asin01bnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) @ (cwa @ (cwbr @ (cco @ XA2 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ (ccfv @ XA2 @ ccsin) @ cclt) @ (cwbr @ (ccfv @ XA2 @ ccsin) @ XA2 @ cclt))))).
...
thf(csinccvglem_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ ccn @ (ccdif @ ccr @ (ccsn @ ccc0)) @ XF))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XF @ ccc0 @ ccli))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccr @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xx3) @ ccdiv))))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmin))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XM @ Xx3) @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xk) @ (ccfv @ (XM @ Xx3) @ ccuz))) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccabs) @ cc1 @ cclt)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (cccom @ (XG @ Xx3) @ XF) @ cc1 @ ccli))))))))))))))).
