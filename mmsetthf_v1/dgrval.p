...
thf(adf_dgr_ax,axiom,(cwceq @ ccdgr @ (ccmpt @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply)) @ (^ [Xf1:$i] : (ccsup @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ ccn0 @ cclt))))).
...
thf(cdgrval_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwceq @ (ccfv @ XF @ ccdgr) @ (ccsup @ (ccima @ (cccnv @ XA2) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ ccn0 @ cclt)))))))).
