...
thf(arrnval_thm,axiom,(! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ ccr @ XI @ ccmap)) => (cwi @ (cwcel @ XI @ ccfn) @ (cwceq @ (ccfv @ XI @ ccrrn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccsu @ XI @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xy1)) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt)))))))))).
...
thf(crrnmet_conj,conjecture,(! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ ccr @ XI @ ccmap)) => (cwi @ (cwcel @ XI @ ccfn) @ (cwcel @ (ccfv @ XI @ ccrrn) @ (ccfv @ XX @ ccme))))))).
