...
thf(afge0icoicc_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => (cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF))))))).
...
thf(afge0iccre_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwn @ (cwcel @ ccpnf @ (ccrn @ XF)))) => (cwi @ Xph @ (cwf @ XX @ ccr @ XF)))))))).
thf(afge0npnf_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => (cwi @ Xph @ (cwn @ (cwcel @ ccpnf @ (ccrn @ XF))))))))).
...
thf(csge0fsum_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccsu @ XX @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))))).
