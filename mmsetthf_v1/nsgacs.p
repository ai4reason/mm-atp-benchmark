...
thf(aisnsg3_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwb @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwa @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (ccv @ Xx3) @ Xc_mi) @ XS)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XX))))))))))))).
...
thf(aacsfn1c_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwcel @ (XE @ Xb @ Xc) @ XX)) @ (^ [Xc:$i] : XX))) @ (^ [Xb:$i] : XK))) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwcel @ (XE @ Xb @ Xc) @ (ccv @ Xa))) @ (^ [Xc:$i] : (ccv @ Xa)))) @ (^ [Xb:$i] : XK))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
...
thf(cnsgacs_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwcel @ (ccfv @ XG @ ccnsg) @ (ccfv @ XB2 @ ccacs))))))).
