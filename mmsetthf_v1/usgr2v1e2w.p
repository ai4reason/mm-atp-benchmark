...
thf(ausgr1eop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwi @ (cwne @ XB2 @ XC) @ (cwcel @ (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XC)))) @ ccusgr)))))))))).
thf(cusgr2v1e2w_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwne @ XA2 @ XB2)) @ (cwcel @ (ccop @ (ccpr @ XA2 @ XB2) @ (ccs1 @ (ccpr @ XA2 @ XB2))) @ ccusgr))))))).
