...
thf(celfzonlteqm1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)) @ (cwn @ (cwbr @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ cclt))) @ (cwceq @ XA2 @ (cco @ XB2 @ cc1 @ ccmin)))))).
