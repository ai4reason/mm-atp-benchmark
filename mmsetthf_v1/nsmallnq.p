...
thf(ahalfnq_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccnq) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ ccplq) @ XA2)))))).
...
thf(cnsmallnq_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccnq) @ (cwex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccltq)))))).
