...
thf(amusum_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccsu @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ ccmu))) @ (ccif @ (cwceq @ XN @ cc1) @ cc1 @ ccc0))))).
