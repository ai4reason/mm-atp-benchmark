...
thf(alcvnbtwn3_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ XX)) => ((cwi @ Xph @ (cwcel @ XR @ XS)) => ((cwi @ Xph @ (cwcel @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwbr @ XR @ XT @ XC)) => ((cwi @ Xph @ (cwss @ XR @ XU)) => ((cwi @ Xph @ (cwpss @ XU @ XT)) => (cwi @ Xph @ (cwceq @ XU @ XR)))))))))))))))))))).
...
thf(alsatexch1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XQ @ XA2)) => ((cwi @ Xph @ (cwcel @ XR @ XA2)) => ((cwi @ Xph @ (cwcel @ XS @ XA2)) => ((cwi @ Xph @ (cwss @ XQ @ (cco @ XS @ XR @ Xc_po))) => ((cwi @ Xph @ (cwne @ XQ @ XS)) => (cwi @ Xph @ (cwss @ XR @ (cco @ XS @ XQ @ Xc_po))))))))))))))))))).
...
thf(clsatcvatlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XQ @ XA2)) => ((cwi @ Xph @ (cwcel @ XR @ XA2)) => ((cwi @ Xph @ (cwne @ XU @ (ccsn @ Xc_0))) => ((cwi @ Xph @ (cwpss @ XU @ (cco @ XQ @ XR @ Xc_po))) => ((cwi @ Xph @ (cwn @ (cwss @ XQ @ XU))) => (cwi @ Xph @ (cwcel @ XU @ XA2))))))))))))))))))))))).
