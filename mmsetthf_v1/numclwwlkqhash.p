...
thf(awwlknlsw_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwceq @ (ccfv @ XN @ XW) @ (ccfv @ XW @ cclsw))))))).
...
thf(aclwwlkvbij_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xw)) @ (cwcel @ XN @ ccn)) @ (cwex @ (^ [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xw) @ cclsw) @ (ccfv @ ccc0 @ (ccv @ Xw))) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XX))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))) @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ (ccv @ Xf1)))))))))))).
