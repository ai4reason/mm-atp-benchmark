...
thf(aamgmlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (ccfv @ cccnfld @ ccmgp)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => ((cwi @ Xph @ (cwf @ XA2 @ ccrp @ XF)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ XM @ XF @ ccgsu) @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccdiv) @ cccxp) @ (cco @ (cco @ cccnfld @ XF @ ccgsu) @ (ccfv @ XA2 @ cchash) @ ccdiv) @ ccle))))))))))).
...
thf(as3cld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XB2 @ XX)) => ((cwi @ Xph @ (cwcel @ XC @ XX)) => (cwi @ Xph @ (cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccword @ XX)))))))))))).
...
thf(agsumws3_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ ccmnd) @ (cwa @ (cwcel @ XS @ XB2) @ (cwa @ (cwcel @ XT @ XB2) @ (cwcel @ XU @ XB2)))) @ (cwceq @ (cco @ XG @ (ccs3 @ XS @ XT @ XU) @ ccgsu) @ (cco @ XS @ (cco @ XT @ XU @ Xc_pl) @ Xc_pl)))))))))))).
...
thf(camgm3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccmul) @ (cco @ cc1 @ cc3 @ ccdiv) @ cccxp) @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccaddc) @ cc3 @ ccdiv) @ ccle)))))))))).
