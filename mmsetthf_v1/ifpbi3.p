...
thf(adfifp2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwif @ Xph @ Xps @ Xch) @ (cwa @ (cwi @ Xph @ Xps) @ (cwi @ (cwn @ Xph) @ Xch))))))).
thf(cifpbi3_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwb @ Xph @ Xps) @ (cwb @ (cwif @ Xch @ Xth @ Xph) @ (cwif @ Xch @ Xth @ Xps)))))))).
