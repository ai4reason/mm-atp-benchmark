...
thf(abits0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwcel @ ccc0 @ (ccfv @ XN @ ccbits)) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)))))).
thf(cbits0o_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwcel @ ccc0 @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccbits))))).
