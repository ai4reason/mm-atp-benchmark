...
thf(awunex_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xu:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xu)) @ (cwrex @ (^ [Xu:$i] : (cwss @ XA2 @ (ccv @ Xu))) @ (^ [Xu:$i] : ccwun))))))).
...
thf(cuniwun_conj,conjecture,(cwceq @ (ccuni @ ccwun) @ ccvv)).
