...
thf(a_0ram_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XR @ (XV @ Xy1)) @ (cwne @ XR @ cc0) @ (cwf @ XR @ ccn0 @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccrn @ XF)))) @ (^ [Xx3:$i] : ccz))) @ (cwceq @ (cco @ ccc0 @ XF @ ccram) @ (ccsup @ (ccrn @ XF) @ ccr @ cclt)))))))).
thf(c_0ram2_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ ccfn) @ (cwne @ XR @ cc0) @ (cwf @ XR @ ccn0 @ XF)) @ (cwceq @ (cco @ ccc0 @ XF @ ccram) @ (ccsup @ (ccrn @ XF) @ ccr @ cclt)))))).
