...
thf(clediv12a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ XA2 @ XB2 @ ccle))) @ (cwa @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XC @ cclt) @ (cwbr @ XC @ XD @ ccle)))) @ (cwbr @ (cco @ XA2 @ XD @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccle))))))).
