...
thf(cf12dfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccpr @ XX @ XY)) => (cwi @ (cwa @ (cwa @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV)) @ (cwne @ XX @ XY)) @ (cwb @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwne @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF)))))))))))))).
