...
thf(awunin_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwcel @ (ccin @ XA2 @ XB2) @ XU))))))))).
...
thf(cwunress_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ ccom @ XU)) => ((cwi @ Xph @ (cwcel @ XW @ XU)) => (cwi @ Xph @ (cwcel @ (cco @ XW @ XA2 @ ccress) @ XU)))))))))).
