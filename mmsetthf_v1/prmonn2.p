...
thf(aprmop1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccprmo) @ (ccif @ (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ ccprime) @ (cco @ (ccfv @ XN @ ccprmo) @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (ccfv @ XN @ ccprmo)))))).
...
thf(cprmonn2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccprmo) @ (ccif @ (cwcel @ XN @ ccprime) @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccprmo) @ XN @ ccmul) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccprmo)))))).
