...
thf(cltmuldivi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => (cwi @ (cwbr @ ccc0 @ XC @ cclt) @ (cwb @ (cwbr @ (cco @ XA2 @ XC @ ccmul) @ XB2 @ cclt) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccdiv) @ cclt)))))))))).
