...
thf(auvtxavalOLD_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (! [Xv:$i] : (! [Xn:$i] : (cwi @ (cwcel @ XG @ (XW @ Xv @ Xn)) @ (cwceq @ (ccfv @ XG @ ccuvtx) @ (ccrab @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
...
thf(afalseral0_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwi @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwn @ (Xph @ Xx3)))) @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2))) @ (cwceq @ XA2 @ cc0))))).
...
thf(asssn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwss @ XA2 @ (ccsn @ XB2)) @ (cwo @ (cwceq @ XA2 @ cc0) @ (cwceq @ XA2 @ (ccsn @ XB2))))))).
...
thf(anbgr0edg_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwceq @ (ccfv @ XG @ ccedg) @ cc0) @ (cwceq @ (cco @ XG @ XK @ ccnbgr) @ cc0))))).
...
thf(cuvtxa01vtx0OLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwceq @ XE @ cc0)) @ (cwb @ (cwne @ (ccfv @ XG @ ccuvtx) @ cc0) @ (cwceq @ (ccfv @ XV @ cchash) @ cc1)))))))))).
