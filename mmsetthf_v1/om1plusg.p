...
thf(com1plusg_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (cco @ XJ @ XY @ ccomi)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => (cwi @ Xph @ (cwceq @ (ccfv @ XJ @ ccpco) @ (ccfv @ XO @ ccplusg)))))))))))).
