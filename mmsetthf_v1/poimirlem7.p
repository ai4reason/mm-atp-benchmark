...
thf(asub1m1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccc) @ (cwceq @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc1 @ ccmin) @ (cco @ XN @ cc2 @ ccmin))))).
...
thf(cpoimirlem7_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccrab @ (^ [Xt:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xt) @ cc2nd) @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ (cco @ ccc0 @ XN @ ccfz))))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XT @ (XS @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (ccfv @ XT @ cc2nd) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XM @ (cco @ (cco @ (cco @ (ccfv @ XT @ cc2nd) @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ XN @ ccfz)))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccrio @ (^ [Xn:$i] : (cwne @ (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ XM @ cc2 @ ccmin) @ XF)) @ (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ XM @ cc1 @ ccmin) @ XF)))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz))) @ (ccfv @ XM @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd)))))))))))))))))).
