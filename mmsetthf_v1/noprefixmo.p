...
thf(cnoprefixmo_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwss @ XA2 @ ccsur) @ (cwmo @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwcel @ XG @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ XG)) @ (ccres @ (ccv @ Xv) @ (ccsuc @ XG))))) @ (^ [Xv:$i] : XA2)) @ (cwceq @ (ccfv @ XG @ (ccv @ Xu)) @ (ccv @ Xx3)))) @ (^ [Xu:$i] : XA2)))))))).
