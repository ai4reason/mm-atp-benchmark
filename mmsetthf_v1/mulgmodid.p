...
thf(amulgassr_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2))) @ (cwceq @ (cco @ (cco @ XN @ XM @ ccmul) @ XX @ Xc_x) @ (cco @ XM @ (cco @ XN @ XX @ Xc_x) @ Xc_x)))))))))))).
...
thf(cmulgmodid_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwceq @ (cco @ XM @ XX @ Xc_x) @ Xc_0))) @ (cwceq @ (cco @ (cco @ XN @ XM @ ccmo) @ XX @ Xc_x) @ (cco @ XN @ XX @ Xc_x)))))))))))))).
