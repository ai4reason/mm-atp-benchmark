...
thf(almbrf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xu:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xu @ Xk) @ ccuz)))) => ((! [Xu:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xu @ Xk) @ ccz)))) => ((cwi @ Xph @ (cwf @ XZ @ XX @ XF)) => ((! [Xu:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XA2 @ Xu @ Xj @ Xk)))))) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) @ (cwa @ (cwcel @ XP @ XX) @ (cwral @ (^ [Xu:$i] : (cwi @ (cwcel @ XP @ (ccv @ Xu)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xu @ Xj @ Xk) @ (ccv @ Xu))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))) @ (^ [Xu:$i] : XJ))))))))))))))))))).
...
thf(clmconst_conj,conjecture,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XP @ XX) @ (cwcel @ XM @ ccz)) @ (cwbr @ (ccxp @ XZ @ (ccsn @ XP)) @ XP @ (ccfv @ XJ @ cclm)))))))))).
