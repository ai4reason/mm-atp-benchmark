...
thf(accatws1clv_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccword @ ccvv))))))).
...
thf(cccatw2s1len_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwcel @ XW @ (ccword @ XV)) @ (cwceq @ (ccfv @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat) @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccaddc)))))))).
