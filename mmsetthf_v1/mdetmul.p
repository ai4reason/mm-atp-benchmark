...
thf(amdetralt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XD @ Xa) @ (cco @ XN @ (XR @ Xa) @ ccmdat))) => ((! [Xa:$i] : (cwceq @ (XA2 @ Xa) @ (cco @ XN @ (XR @ Xa) @ ccmat))) => ((! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccfv @ (XA2 @ Xa) @ ccbs))) => ((! [Xa:$i] : (cwceq @ (Xc_0 @ Xa) @ (ccfv @ (XR @ Xa) @ cc0g))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ (XR @ Xa) @ cccrg))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XX @ (XB2 @ Xa)))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XI @ XN))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XJ @ XN))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwne @ XI @ XJ))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwral @ (^ [Xa:$i] : (cwceq @ (cco @ XI @ (ccv @ Xa) @ XX) @ (cco @ XJ @ (ccv @ Xa) @ XX))) @ (^ [Xa:$i] : XN)))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwceq @ (ccfv @ XX @ (XD @ Xa)) @ (Xc_0 @ Xa))))))))))))))))))))))))).
...
thf(amamudi_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwceq @ XF @ (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((cwi @ Xph @ (cwcel @ XM @ ccfn)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((cwi @ Xph @ (cwcel @ XO @ ccfn)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XX @ XY @ (ccof @ Xc_pl)) @ XZ @ XF) @ (cco @ (cco @ XX @ XZ @ XF) @ (cco @ XY @ XZ @ XF) @ (ccof @ Xc_pl)))))))))))))))))))))))))).
...
thf(cmdetmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XD @ (cco @ XN @ XR @ ccmdat)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_xb @ (ccfv @ XA2 @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ Xc_xb) @ XD) @ (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ Xc_x)))))))))))))))))).
