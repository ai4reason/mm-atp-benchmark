...
thf(aixpeq1d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ XA2 @ XB2))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(celixpsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : XB2))) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ XF @ (ccsn @ (ccop @ XA2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XB2))))))))).
