...
thf(aisofrlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccima @ XH @ (ccv @ Xx3)) @ ccvv))) => (cwi @ Xph @ (cwi @ (cwfr @ XB2 @ XS) @ (cwfr @ XA2 @ XR)))))))))))).
...
thf(cisofr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwcel @ XB2 @ XV)) @ (cwi @ (cwfr @ XB2 @ XS) @ (cwfr @ XA2 @ XR)))))))))).
