...
thf(acardne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ XB2 @ cccrd)) @ (cwn @ (cwbr @ XA2 @ XB2 @ ccen)))))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(abrsdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwn @ (cwbr @ XA2 @ XB2 @ ccen))))))).
thf(ccardsdomelir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ XB2 @ cccrd)) @ (cwbr @ XA2 @ XB2 @ ccsdm))))).
