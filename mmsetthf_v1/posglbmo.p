...
thf(cposglbmo_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => (cwi @ (cwa @ (cwcel @ XK @ ccpo) @ (cwss @ XS @ XB2)) @ (cwrmo @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xy1:$i] : XS)) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xy1:$i] : XS)) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ Xc_le))) @ (^ [Xz:$i] : XB2)))) @ (^ [Xx3:$i] : XB2)))))))))).
