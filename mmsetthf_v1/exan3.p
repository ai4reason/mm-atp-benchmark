...
thf(cexan3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwex @ (^ [Xu:$i] : (cwa @ (cwcel @ XA2 @ (ccec @ (ccv @ Xu) @ (XR @ Xu))) @ (cwcel @ XB2 @ (ccec @ (ccv @ Xu) @ (XR @ Xu)))))) @ (cwex @ (^ [Xu:$i] : (cwa @ (cwbr @ (ccv @ Xu) @ XA2 @ (XR @ Xu)) @ (cwbr @ (ccv @ Xu) @ XB2 @ (XR @ Xu))))))))))))).
