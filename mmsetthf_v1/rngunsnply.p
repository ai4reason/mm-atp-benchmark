...
thf(aissubrngd2_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwi @ Xph @ (cwceq @ XS @ (cco @ XI @ XD @ ccress))) => ((cwi @ Xph @ (cwceq @ Xc_0 @ (ccfv @ XI @ cc0g))) => ((cwi @ Xph @ (cwceq @ Xc_pl @ (ccfv @ XI @ ccplusg))) => ((cwi @ Xph @ (cwss @ XD @ (ccfv @ XI @ ccbs))) => ((cwi @ Xph @ (cwcel @ Xc_0 @ XD)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XD) @ (cwcel @ (ccv @ Xy1) @ XD)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XD)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XD)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XI @ ccminusg)) @ XD))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (Xc_1 @ Xx3 @ Xy1) @ (ccfv @ XI @ ccur))))) => ((cwi @ Xph @ (cwceq @ Xc_x @ (ccfv @ XI @ ccmulr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (Xc_1 @ Xx3 @ Xy1) @ XD)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XD) @ (cwcel @ (ccv @ Xy1) @ XD)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) @ XD)))) => ((cwi @ Xph @ (cwcel @ XI @ ccrg)) => (cwi @ Xph @ (cwcel @ XD @ (ccfv @ XI @ ccsubrg)))))))))))))))))))))))).
...
thf(aplyconst_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ ccc) @ (cwcel @ XA2 @ XS)) @ (cwcel @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccfv @ XS @ ccply)))))).
...
thf(asyl3anb_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwb @ Xph @ Xps) => ((cwb @ Xch @ Xth) => ((cwb @ Xta @ Xet) => ((cwi @ (cw3a @ Xps @ Xth @ Xet) @ Xze) => (cwi @ (cw3a @ Xph @ Xch @ Xta) @ Xze))))))))))))).
...
thf(aplymul_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS)))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (ccfv @ XS @ ccply)))))))))))).
...
thf(asubrg1cl_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) @ (cwcel @ Xc_1 @ XA2))))))).
thf(acnfld1_thm,axiom,(cwceq @ cc1 @ (ccfv @ cccnfld @ ccur))).
thf(asubginvcl_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XX @ XS)) @ (cwcel @ (ccfv @ XX @ XI) @ XS)))))))).
...
thf(aplyid_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ ccc) @ (cwcel @ cc1 @ XS)) @ (cwcel @ ccidp @ (ccfv @ XS @ ccply))))).
...
thf(adf_idp_ax,axiom,(cwceq @ ccidp @ (ccres @ ccid @ ccc))).
...
thf(acnsrplycl_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg))) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XC @ ccply))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => ((cwi @ Xph @ (cwss @ XC @ XS)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ XP) @ XS)))))))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(argspncl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XN @ (ccfv @ XR @ ccrgspn))) => ((cwi @ Xph @ (cwceq @ XU @ (ccfv @ XA2 @ XN))) => (cwi @ Xph @ (cwcel @ XU @ (ccfv @ XR @ ccsubrg))))))))))))))).
...
thf(crngunsnply_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ cccnfld @ ccsubrg))) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((! [Xp:$i] : (cwi @ Xph @ (cwceq @ (XS @ Xp) @ (ccfv @ (ccun @ XB2 @ (ccsn @ XX)) @ (ccfv @ cccnfld @ ccrgspn))))) => (! [Xp:$i] : (cwi @ Xph @ (cwb @ (cwcel @ XV @ (XS @ Xp)) @ (cwrex @ (^ [Xp:$i] : (cwceq @ XV @ (ccfv @ XX @ (ccv @ Xp)))) @ (^ [Xp:$i] : (ccfv @ XB2 @ ccply))))))))))))))).
