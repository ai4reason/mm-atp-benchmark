...
thf(cissh3_conj,conjecture,(! [XH:($i > $o)] : (cwi @ (cwss @ XH @ cchil) @ (cwb @ (cwcel @ XH @ ccsh) @ (cwa @ (cwcel @ cc0v @ XH) @ (cwa @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : XH)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsm) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : ccc)))))))).
