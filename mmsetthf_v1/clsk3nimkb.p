...
thf(cclsk3nimkb_conj,conjecture,(cwn @ (cwal @ (^ [Xb:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwss @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccv @ Xt)) @ (ccv @ Xk)) @ (ccun @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xk)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xk))))) @ (^ [Xt:$i] : (ccpw @ (ccv @ Xb))))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xb)))) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwi @ (cwceq @ (ccun @ (ccv @ Xs1) @ (ccv @ Xt)) @ (ccv @ Xb)) @ (cwceq @ (ccun @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xk)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xk))) @ (ccv @ Xb)))) @ (^ [Xt:$i] : (ccpw @ (ccv @ Xb))))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xb)))))) @ (^ [Xk:$i] : (cco @ (ccpw @ (ccv @ Xb)) @ (ccpw @ (ccv @ Xb)) @ ccmap))))))).
