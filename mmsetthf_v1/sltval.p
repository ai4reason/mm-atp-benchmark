...
thf(csltval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccslt) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ XA2) @ (ccfv @ (ccv @ Xy1) @ XB2))) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XB2) @ (cctp @ (ccop @ cc1o @ cc0) @ (ccop @ cc1o @ cc2o) @ (ccop @ cc0 @ cc2o))))) @ (^ [Xx3:$i] : ccon0))))))).
