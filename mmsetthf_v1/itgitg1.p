...
thf(ai1fibl_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XF @ ccibl)))).
thf(aeqtr4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XB2)) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(aoveq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XD)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XD @ XF)))))))))))).
thf(aeqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(aitgitg2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwcel @ (XA2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwbr @ ccc0 @ (XA2 @ Xx3) @ ccle))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccibl)) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccitg2))))))))).
...
thf(ai1fposd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccdm @ ccitg1))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (XA2 @ Xx3) @ ccle) @ (XA2 @ Xx3) @ ccc0))) @ (ccdm @ ccitg1))))))).
...
thf(citgitg1_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) @ (ccfv @ XF @ ccitg1))))).
