...
thf(aun4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwceq @ (ccun @ (ccun @ XA2 @ XB2) @ (ccun @ XC @ XD)) @ (ccun @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD)))))))).
thf(cunundir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccun @ (ccun @ XA2 @ XB2) @ XC) @ (ccun @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XC))))))).
