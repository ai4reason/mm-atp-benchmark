...
thf(axp2cda_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (ccxp @ XA2 @ cc2o) @ (cco @ XA2 @ XA2 @ cccda)))))).
...
thf(cunctb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwbr @ XB2 @ ccom @ ccdom)) @ (cwbr @ (ccun @ XA2 @ XB2) @ ccom @ ccdom))))).
