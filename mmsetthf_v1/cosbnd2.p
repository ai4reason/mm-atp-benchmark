...
thf(acosbnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwa @ (cwbr @ (ccneg @ cc1) @ (ccfv @ XA2 @ cccos) @ ccle) @ (cwbr @ (ccfv @ XA2 @ cccos) @ cc1 @ ccle))))).
...
thf(ccosbnd2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ cccos) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc))))).
