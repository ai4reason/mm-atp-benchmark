...
thf(ahstpyth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ cchst) @ (cwcel @ XA2 @ ccch)) @ (cwa @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ (ccfv @ XB2 @ ccort)))) @ (cwceq @ (cco @ (ccfv @ (ccfv @ (cco @ XA2 @ XB2 @ cchj) @ XS) @ ccno) @ cc2 @ ccexp) @ (cco @ (cco @ (ccfv @ (ccfv @ XA2 @ XS) @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccfv @ XB2 @ XS) @ ccno) @ cc2 @ ccexp) @ ccaddc))))))).
...
thf(ahstle1_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ cchst) @ (cwcel @ XA2 @ ccch)) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XS) @ ccno) @ cc1 @ ccle))))).
...
thf(chstle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ cchst) @ (cwcel @ XA2 @ ccch)) @ (cwa @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ XB2))) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XS) @ ccno) @ (ccfv @ (ccfv @ XB2 @ XS) @ ccno) @ ccle)))))).
