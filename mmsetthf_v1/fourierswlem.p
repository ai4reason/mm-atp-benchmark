...
thf(anegdii_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (cwceq @ (ccneg @ (cco @ XA2 @ XB2 @ ccaddc)) @ (cco @ (ccneg @ XA2) @ (ccneg @ XB2) @ ccaddc))))))).
...
thf(cfourierswlem_conj,conjecture,(! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((cwceq @ XT @ (cco @ cc2 @ ccpi @ ccmul)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ XT @ ccmo) @ ccpi @ cclt) @ cc1 @ (ccneg @ cc1)))))) => ((cwcel @ XX @ ccr) => ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (ccif @ (cwceq @ (cco @ XX @ ccpi @ ccmo) @ ccc0) @ ccc0 @ (ccfv @ XX @ (XF @ Xx3))))) => (! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (cco @ (cco @ (ccif @ (cwcel @ (cco @ XX @ XT @ ccmo) @ (cco @ ccc0 @ ccpi @ ccioc)) @ cc1 @ (ccneg @ cc1)) @ (ccfv @ XX @ (XF @ Xx3)) @ ccaddc) @ cc2 @ ccdiv)))))))))))).
