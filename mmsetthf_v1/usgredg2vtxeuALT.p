...
thf(cusgredg2vtxeuALT_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg)) @ (cwcel @ XY @ XE)) @ (cwreu @ (^ [Xy1:$i] : (cwceq @ XE @ (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XG @ ccvtx)))))))).
