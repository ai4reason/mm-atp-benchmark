...
thf(cgalcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XY))) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_po) @ (cco @ XA2 @ XC @ Xc_po)) @ (cwceq @ XB2 @ XC)))))))))))).
