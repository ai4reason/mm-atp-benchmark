...
thf(ccdleme31se_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xs1:$i] : (cwceq @ (XE @ Xs1) @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XD @ (cco @ (cco @ (ccv @ Xs1) @ XT @ Xc_or) @ XW @ Xc_an) @ Xc_or) @ Xc_an))) => ((! [Xs1:$i] : (cwceq @ (XY @ Xs1) @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XD @ (cco @ (cco @ XR @ XT @ Xc_or) @ XW @ Xc_an) @ Xc_or) @ Xc_an))) => (! [Xs1:$i] : (cwi @ (cwcel @ XR @ XA2) @ (cwceq @ (ccsb @ XR @ (^ [Xs1:$i] : (XE @ Xs1))) @ (XY @ Xs1)))))))))))))))))).
