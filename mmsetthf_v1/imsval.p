...
thf(adf_ims_ax,axiom,(cwceq @ ccims @ (ccmpt @ (^ [Xu:$i] : ccnv) @ (^ [Xu:$i] : (cccom @ (ccfv @ (ccv @ Xu) @ ccnmcv) @ (ccfv @ (ccv @ Xu) @ ccnsb)))))).
...
thf(cimsval_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwceq @ XD @ (cccom @ XN @ XM))))))))))).
