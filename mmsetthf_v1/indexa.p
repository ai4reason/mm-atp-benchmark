...
thf(cindexa_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xc:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ (XM @ Xx3 @ Xy1 @ Xc)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))) @ (cwex @ (^ [Xc:$i] : (cw3a @ (cwss @ (ccv @ Xc) @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xc)))) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : (ccv @ Xc))))))))))))))).
