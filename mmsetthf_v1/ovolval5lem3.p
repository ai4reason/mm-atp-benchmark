...
thf(ainfleinf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwss @ XB2 @ ccxr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ ccrp)) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : XA2))))) => (cwi @ Xph @ (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ (ccinf @ XB2 @ ccxr @ cclt) @ ccle))))))))).
...
thf(avoliooicof_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ (ccxp @ ccr @ ccr) @ XF)) => (cwi @ Xph @ (cwceq @ (cccom @ (cccom @ ccvol @ ccioo) @ XF) @ (cccom @ (cccom @ ccvol @ ccico) @ XF)))))))).
