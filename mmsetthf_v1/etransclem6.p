...
thf(cetransclem6_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (cwceq @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul))) @ (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (cco @ (cco @ (ccv @ Xy1) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xk) @ ccmin) @ XP @ ccexp))) @ ccmul))))))).
