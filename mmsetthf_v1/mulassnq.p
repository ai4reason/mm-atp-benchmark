...
thf(amulpipq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwa @ (cwcel @ XC @ ccnpi) @ (cwcel @ XD @ ccnpi))) @ (cwceq @ (cco @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccmpq) @ (ccop @ (cco @ XA2 @ XC @ ccmi) @ (cco @ XB2 @ XD @ ccmi))))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(cwer_tp,type,(cwer : (($i > $o) > (($i > $o) > $o)))).
thf(amulerpq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ (ccfv @ XA2 @ ccerq) @ (ccfv @ XB2 @ ccerq) @ ccmq) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmpq) @ ccerq))))).
...
thf(cmulassnq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmq) @ XC @ ccmq) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmq) @ ccmq)))))).
