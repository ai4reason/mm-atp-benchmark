...
thf(amzpcl34_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) @ (cwcel @ XF @ XP) @ (cwcel @ XG @ XP)) @ (cwa @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ XP) @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ XP)))))))).
thf(cmzpmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XV @ ccmzp)) @ (cwcel @ XB2 @ (ccfv @ XV @ ccmzp))) @ (cwcel @ (cco @ XA2 @ XB2 @ (ccof @ ccmul)) @ (ccfv @ XV @ ccmzp))))))).
