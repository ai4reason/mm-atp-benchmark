...
thf(ctxopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW)) @ (cwa @ (cwcel @ XA2 @ XR) @ (cwcel @ XB2 @ XS))) @ (cwcel @ (ccxp @ XA2 @ XB2) @ (cco @ XR @ XS @ cctx)))))))))).
