...
thf(csupicclub_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XC @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XA2 @ (cco @ (XB2 @ Xz) @ (XC @ Xz) @ ccicc)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwne @ XA2 @ cc0))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XD @ XA2))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwb @ (cwbr @ XD @ (ccsup @ XA2 @ ccr @ cclt) @ cclt) @ (cwrex @ (^ [Xz:$i] : (cwbr @ XD @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : XA2)))))))))))))))).
