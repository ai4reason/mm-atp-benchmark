...
thf(aim0_thm,axiom,(cwceq @ (ccfv @ ccc0 @ ccim) @ ccc0)).
...
thf(clogneg2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccim) @ cclt)) @ (cwceq @ (ccfv @ (ccneg @ XA2) @ cclog) @ (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ ccpi @ ccmul) @ ccmin))))).
