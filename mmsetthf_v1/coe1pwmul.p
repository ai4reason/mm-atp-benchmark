...
thf(ccoe1pwmul_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ XP @ ccbs))) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XB2 @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XD @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ (cco @ XD @ XX @ Xc_ex) @ XA2 @ Xc_x) @ ccco1) @ (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccif @ (cwbr @ XD @ (ccv @ Xx3) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XD @ ccmin) @ (ccfv @ XA2 @ ccco1)) @ Xc_0))))))))))))))))))))))))))).
