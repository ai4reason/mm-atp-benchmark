...
thf(assdif2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwss @ XC @ XD)) => (cwi @ Xph @ (cwss @ (ccdif @ XA2 @ XD) @ (ccdif @ XB2 @ XC))))))))))).
...
thf(adifdif2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccdif @ XA2 @ (ccdif @ XB2 @ XC)) @ (ccun @ (ccdif @ XA2 @ XB2) @ (ccin @ XA2 @ XC))))))).
