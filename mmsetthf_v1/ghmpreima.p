...
thf(cghmpreima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XV @ (ccfv @ XT @ ccsubg))) @ (cwcel @ (ccima @ (cccnv @ XF) @ XV) @ (ccfv @ XS @ ccsubg)))))))).
