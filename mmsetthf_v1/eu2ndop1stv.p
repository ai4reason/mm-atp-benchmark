...
thf(aalneu_thm,axiom,(! [Xph:($i > $o)] : (cwi @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwn @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
...
thf(ceu2ndop1stv_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cweu @ (^ [Xy1:$i] : (cwcel @ (ccop @ XA2 @ (ccv @ Xy1)) @ XV))) @ (cwcel @ XA2 @ ccvv))))).
