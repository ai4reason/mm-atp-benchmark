...
thf(cvacn_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwcel @ XG @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))))).
