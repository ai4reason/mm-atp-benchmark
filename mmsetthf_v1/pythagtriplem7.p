...
thf(acoprimeprodsq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccn0) @ (cwcel @ XC @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccgcd) @ cc1)) @ (cwi @ (cwceq @ (cco @ XC @ cc2 @ ccexp) @ (cco @ XA2 @ XB2 @ ccmul)) @ (cwceq @ XB2 @ (cco @ (cco @ XB2 @ XC @ ccgcd) @ cc2 @ ccexp)))))))).
...
thf(cpythagtriplem7_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ XC @ cc2 @ ccexp)) @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds)))) @ (cwceq @ (ccfv @ (cco @ XC @ XB2 @ ccaddc) @ ccsqrt) @ (cco @ (cco @ XC @ XB2 @ ccaddc) @ XA2 @ ccgcd))))))).
