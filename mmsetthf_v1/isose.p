...
thf(aisoselem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccima @ XH @ (ccv @ Xx3)) @ ccvv))) => (cwi @ Xph @ (cwi @ (cwse @ XA2 @ XR) @ (cwse @ XB2 @ XS)))))))))))).
...
thf(cisose_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwb @ (cwse @ XA2 @ XR) @ (cwse @ XB2 @ XS))))))))).
