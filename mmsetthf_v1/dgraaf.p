...
thf(adf_dgraa_ax,axiom,(cwceq @ ccdgraa @ (ccmpt @ (^ [Xx3:$i] : ccaa) @ (^ [Xx3:$i] : (ccinf @ (ccrab @ (^ [Xd:$i] : (cwrex @ (^ [Xp:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccv @ Xd)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p))))) @ (^ [Xd:$i] : ccn)) @ ccr @ cclt))))).
thf(cwi_tp,type,(cwi : ($o > ($o > $o)))).
thf(argen_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (Xph @ Xx3))) => (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))).
thf(adgraacl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwcel @ (ccfv @ XA2 @ ccdgraa) @ ccn)))).
...
thf(cdgraaf_conj,conjecture,(cwf @ ccaa @ ccn @ ccdgraa)).
