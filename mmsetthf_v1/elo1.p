...
thf(adf_o1_ax,axiom,(cwceq @ cco1 @ (ccrab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ ccabs) @ (ccv @ Xm) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ (ccv @ Xf1)) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))) @ (^ [Xf1:$i] : (cco @ ccc @ ccr @ ccpm))))).
thf(celo1_conj,conjecture,(! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ cco1) @ (cwa @ (cwcel @ XF @ (cco @ ccc @ ccr @ ccpm)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xm) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))).
