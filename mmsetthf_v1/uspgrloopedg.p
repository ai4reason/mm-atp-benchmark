...
thf(cuspgrloopedg_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccsn @ XN))))) => (cwi @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ XG @ ccedg) @ (ccsn @ (ccsn @ XN)))))))))))).
