...
thf(copeliunxp2f_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XE @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XC) @ (cwceq @ (XB2 @ Xx3) @ (XE @ Xx3)))) => (! [Xx3:$i] : (cwb @ (cwcel @ (ccop @ XC @ XD) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3))))) @ (cwa @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ (XE @ Xx3))))))))))))).
