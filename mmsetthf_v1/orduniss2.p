...
thf(aordpwsuc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwceq @ (ccin @ (ccpw @ XA2) @ ccon0) @ (ccsuc @ XA2))))).
thf(cwtr_tp,type,(cwtr : (($i > $o) > $o))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(aordunisuc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwceq @ (ccuni @ (ccsuc @ XA2)) @ XA2)))).
thf(corduniss2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwceq @ (ccuni @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccon0))) @ XA2)))).
