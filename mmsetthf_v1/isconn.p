...
thf(adf_conn_ax,axiom,(cwceq @ ccconn @ (ccrab @ (^ [Xj:$i] : (cwceq @ (ccin @ (ccv @ Xj) @ (ccfv @ (ccv @ Xj) @ cccld)) @ (ccpr @ cc0 @ (ccuni @ (ccv @ Xj))))) @ (^ [Xj:$i] : cctop)))).
thf(cisconn_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccconn) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccin @ XJ @ (ccfv @ XJ @ cccld)) @ (ccpr @ cc0 @ XX)))))))).
