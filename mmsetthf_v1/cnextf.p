...
thf(adfdm3_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccdm @ XA2) @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)))))))).
...
thf(arniun_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwceq @ (ccrn @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccrn @ (XB2 @ Xx3)))))))).
...
thf(aflfelbas_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)))) @ (cwcel @ XA2 @ XX))))))))).
