...
thf(aprobmeasb_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwcel @ XA2 @ XS) @ (cwcel @ (ccfv @ XA2 @ XM) @ ccrp)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ XM) @ (ccfv @ XA2 @ XM) @ ccdiv))) @ ccprb)))))).
...
thf(ccndprobprob_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XB2 @ (ccdm @ XP)) @ (cwne @ (ccfv @ XB2 @ XP) @ ccc0)) @ (cwcel @ (ccmpt @ (^ [Xa:$i] : (ccdm @ XP)) @ (^ [Xa:$i] : (ccfv @ (ccop @ (ccv @ Xa) @ XB2) @ (ccfv @ XP @ cccprob)))) @ ccprb))))).
