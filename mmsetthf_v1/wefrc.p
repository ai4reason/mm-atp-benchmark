...
thf(aepfrc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwi @ (cw3a @ (cwfr @ XA2 @ ccep) @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ XB2 @ (ccv @ Xx3)) @ cc0)) @ (^ [Xx3:$i] : XB2))))))).
...
thf(awetrep_thm,axiom,(! [Xx3:$i] : (! [XA2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwwe @ (XA2 @ Xy1 @ Xz) @ ccep) @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xz)) @ (cwcel @ (ccv @ Xy1) @ (XA2 @ Xy1 @ Xz)) @ (cwcel @ (ccv @ Xz) @ (XA2 @ Xy1 @ Xz)))) @ (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))))))).
...
thf(cwefrc_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwwe @ (XA2 @ Xx3) @ ccep) @ (cwss @ XB2 @ (XA2 @ Xx3)) @ (cwne @ XB2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ XB2 @ (ccv @ Xx3)) @ cc0)) @ (^ [Xx3:$i] : XB2))))))).
