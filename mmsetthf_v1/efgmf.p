...
thf(a_2oconcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cc2o) @ (cwcel @ (ccdif @ cc1o @ XA2) @ cc2o)))).
...
thf(cefgmf_conj,conjecture,(! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XM @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwf @ (ccxp @ XI @ cc2o) @ (ccxp @ XI @ cc2o) @ (XM @ Xy1 @ Xz)))))))).
