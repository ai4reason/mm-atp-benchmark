...
thf(avolicorecl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) @ ccr))))).
thf(cvolicorescl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccrn @ (ccres @ ccico @ (ccxp @ ccr @ ccr)))) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr)))).
