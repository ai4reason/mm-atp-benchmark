...
thf(apfxccatpfx1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ XL @ ccfz))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ XN @ ccpfx) @ (cco @ XA2 @ XN @ ccpfx)))))))))).
...
thf(apfxccatpfx2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => ((cwceq @ XM @ (ccfv @ XB2 @ cchash)) => (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ (cco @ XL @ cc1 @ ccaddc) @ (cco @ XL @ XM @ ccaddc) @ ccfz))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ XN @ ccpfx) @ (cco @ XA2 @ (cco @ XB2 @ (cco @ XN @ XL @ ccmin) @ ccpfx) @ ccconcat)))))))))))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(aiffalse_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwn @ Xph) @ (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XB2)))))).
thf(cpfxccat3a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => ((cwceq @ XM @ (ccfv @ XB2 @ cchash)) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwi @ (cwcel @ XN @ (cco @ ccc0 @ (cco @ XL @ XM @ ccaddc) @ ccfz)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ XN @ ccpfx) @ (ccif @ (cwbr @ XN @ XL @ ccle) @ (cco @ XA2 @ XN @ ccpfx) @ (cco @ XA2 @ (cco @ XB2 @ (cco @ XN @ XL @ ccmin) @ ccpfx) @ ccconcat)))))))))))))).
