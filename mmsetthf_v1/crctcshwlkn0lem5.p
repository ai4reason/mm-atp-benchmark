...
thf(a_2addsubd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccaddc) @ XD @ ccmin) @ (cco @ (cco @ (cco @ XA2 @ XC @ ccaddc) @ XD @ ccmin) @ XB2 @ ccaddc))))))))))))).
...
thf(aelfzo1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ (cco @ cc1 @ XM @ ccfzo)) @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ ccn) @ (cwbr @ XN @ XM @ cclt)))))).
...
thf(acrctcshwlkn0lem3_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (cco @ cc1 @ XN @ ccfzo))) => ((! [Xx3:$i] : (cwceq @ (XQ @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP)))))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XJ @ (cco @ (cco @ (cco @ XN @ XS @ ccmin) @ cc1 @ ccaddc) @ XN @ ccfz))) @ (cwceq @ (ccfv @ XJ @ (XQ @ Xx3)) @ (ccfv @ (cco @ (cco @ XJ @ XS @ ccaddc) @ XN @ ccmin) @ XP))))))))))))).
...
thf(afzoss1_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (ccfv @ XM @ ccuz)) @ (cwss @ (cco @ XK @ XN @ ccfzo) @ (cco @ XM @ XN @ ccfzo))))))).
...
thf(alt2addmuld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XC @ cclt)) => ((cwi @ Xph @ (cwbr @ XB2 @ XC @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ cc2 @ XC @ ccmul) @ cclt)))))))))))).
...
thf(a_2submod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwa @ (cwbr @ XB2 @ XA2 @ ccle) @ (cwbr @ XA2 @ (cco @ cc2 @ XB2 @ ccmul) @ cclt))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ (cco @ XA2 @ XB2 @ ccmin)))))).
thf(asimp1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xph))))).
thf(asimp2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xps))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xch))))).
thf(ccrctcshwlkn0lem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xj) @ (cco @ cc1 @ (XN @ Xj) @ ccfzo)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XQ @ Xx3 @ Xi @ Xj) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (XN @ Xj) @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ (XN @ Xj) @ (XS @ Xj) @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ (XS @ Xj) @ ccaddc) @ (XP @ Xj)) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (XS @ Xj) @ ccaddc) @ (XN @ Xj) @ ccmin) @ (XP @ Xj))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XH @ Xx3 @ Xi @ Xj) @ (cco @ (XF @ Xx3 @ Xj) @ (XS @ Xj) @ cccsh))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XN @ Xj) @ (ccfv @ (XF @ Xx3 @ Xj) @ cchash)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3 @ Xj) @ (ccword @ (XA2 @ Xx3 @ Xi @ Xj))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwral @ (^ [Xi:$i] : (cwif @ (cwceq @ (ccfv @ (ccv @ Xi) @ (XP @ Xj)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XP @ Xj))) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3 @ Xj)) @ (XI @ Xx3 @ Xj)) @ (ccsn @ (ccfv @ (ccv @ Xi) @ (XP @ Xj)))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xi) @ (XP @ Xj)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XP @ Xj))) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3 @ Xj)) @ (XI @ Xx3 @ Xj))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (XN @ Xj) @ ccfzo)))))) => (! [Xx3:$i] : (! [Xi:$i] : (cwi @ Xph @ (cwral @ (^ [Xj:$i] : (cwif @ (cwceq @ (ccfv @ (ccv @ Xj) @ (XQ @ Xx3 @ Xi @ Xj)) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi @ Xj))) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xj) @ (XH @ Xx3 @ Xi @ Xj)) @ (XI @ Xx3 @ Xj)) @ (ccsn @ (ccfv @ (ccv @ Xj) @ (XQ @ Xx3 @ Xi @ Xj)))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xj) @ (XQ @ Xx3 @ Xi @ Xj)) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi @ Xj))) @ (ccfv @ (ccfv @ (ccv @ Xj) @ (XH @ Xx3 @ Xi @ Xj)) @ (XI @ Xx3 @ Xj))))) @ (^ [Xj:$i] : (cco @ (cco @ (cco @ (XN @ Xj) @ (XS @ Xj) @ ccmin) @ cc1 @ ccaddc) @ (XN @ Xj) @ ccfzo)))))))))))))))))))))).
