...
thf(cbj_ismooredr2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ (ccuni @ XA2) @ XA2)) => ((! [Xx3:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwss @ (ccv @ Xx3) @ XA2)) @ (cwne @ (ccv @ Xx3) @ cc0)) @ (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2))) => (cwi @ Xph @ (cwcel @ XA2 @ ccmoore))))))))).
