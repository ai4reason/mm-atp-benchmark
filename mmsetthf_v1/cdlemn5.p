...
thf(acdlemn5pre_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xh:$i] : (cwceq @ (Xc_or @ Xh) @ (ccfv @ XK @ ccjn))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((! [Xh:$i] : (cwceq @ (XU @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : (cwceq @ (Xc_po @ Xh) @ (ccfv @ (XU @ Xh) @ cclsm))) => ((! [Xh:$i] : (cwceq @ (XI @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => ((! [Xh:$i] : (cwceq @ (XJ @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdic)))) => ((cwceq @ XP @ (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((! [Xh:$i] : (cwceq @ (XO @ Xh) @ (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : (cwceq @ (XE @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xh:$i] : (cwceq @ (XN @ Xh) @ (ccfv @ (XU @ Xh) @ cclspn))) => ((! [Xh:$i] : (cwceq @ (XF @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ XP @ (ccv @ Xh)) @ XQ)) @ (^ [Xh:$i] : XT)))) => ((! [Xh:$i] : (cwceq @ (XG @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ XP @ (ccv @ Xh)) @ XR)) @ (^ [Xh:$i] : XT)))) => ((! [Xh:$i] : (cwceq @ (XM @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ XQ @ (ccv @ Xh)) @ XR)) @ (^ [Xh:$i] : XT)))) => (! [Xh:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le))) @ (cwa @ (cwcel @ XR @ XA2) @ (cwn @ (cwbr @ XR @ XW @ Xc_le))) @ (cwa @ (cwcel @ (XX @ Xh) @ XB2) @ (cwbr @ (XX @ Xh) @ XW @ Xc_le))) @ (cwbr @ XR @ (cco @ XQ @ (XX @ Xh) @ (Xc_or @ Xh)) @ Xc_le)) @ (cwss @ (ccfv @ XR @ (XJ @ Xh)) @ (cco @ (ccfv @ XQ @ (XJ @ Xh)) @ (ccfv @ (XX @ Xh) @ (XI @ Xh)) @ (Xc_po @ Xh))))))))))))))))))))))))))))))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(ccdlemn5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((cwceq @ XJ @ (ccfv @ XW @ (ccfv @ XK @ ccdic))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le))) @ (cwa @ (cwcel @ XR @ XA2) @ (cwn @ (cwbr @ XR @ XW @ Xc_le))) @ (cwa @ (cwcel @ XX @ XB2) @ (cwbr @ XX @ XW @ Xc_le))) @ (cwbr @ XR @ (cco @ XQ @ XX @ Xc_or) @ Xc_le)) @ (cwss @ (ccfv @ XR @ XJ) @ (cco @ (ccfv @ XQ @ XJ) @ (ccfv @ XX @ XI) @ Xc_po))))))))))))))))))))))))))).
