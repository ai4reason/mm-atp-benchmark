...
thf(afldiv4p1lem1div2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwo @ (cwceq @ XN @ cc3) @ (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) @ (cwbr @ (cco @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
thf(aoveq1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF)))))))).
thf(cgausslemma2dlem0f_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XM @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((cwceq @ XH @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => (cwi @ Xph @ (cwbr @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccle)))))))))).
