...
thf(areclt1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwb @ (cwbr @ XA2 @ cc1 @ cclt) @ (cwbr @ cc1 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt))))).
...
thf(areeff1olem_thm,axiom,(! [XU:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ ccr) @ (cwbr @ cc1 @ XU @ cclt)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cce) @ XU)) @ (^ [Xx3:$i] : ccr))))).
...
thf(arec11r_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0))) @ (cwb @ (cwceq @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2) @ (cwceq @ (cco @ cc1 @ XB2 @ ccdiv) @ XA2)))))).
...
thf(arexxfr_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ (XC @ Xy1)) @ (cwcel @ (XA2 @ Xy1) @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2)) @ (cwrex @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1))))))))))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(arenegcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccneg @ XA2) @ ccr)))).
thf(ainfm3lem_thm,axiom,(! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccneg @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : ccr))))).
