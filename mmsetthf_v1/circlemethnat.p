...
thf(aindf_thm,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO)) @ (cwf @ XO @ (ccpr @ ccc0 @ cc1) @ (ccfv @ XA2 @ (ccfv @ XO @ ccind)))))))).
...
thf(ahashrepr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ cchash) @ (ccsu @ (cco @ ccn @ XM @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ XA2 @ (ccfv @ ccn @ ccind))))))))))))))))).
...
thf(acirclemeth_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ ccn @ XN @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))))) @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xx3) @ (cco @ (ccfv @ (ccv @ Xa) @ XL) @ XN @ ccvts)))) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccneg @ XN) @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce) @ ccmul))))))))))))).
...
thf(avtscl_thm,axiom,(! [Xph:$o] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwf @ ccn @ ccc @ XL)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ (cco @ XL @ XN @ ccvts)) @ ccc)))))))))).
...
thf(ccirclemethnat_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccfv @ (cco @ XA2 @ XN @ (ccfv @ XS @ ccrepr)) @ cchash))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (cco @ (ccfv @ XA2 @ (ccfv @ ccn @ ccind)) @ XN @ ccvts)))) => ((cwcel @ XN @ ccn0) => ((cwss @ XA2 @ ccn) => ((cwcel @ XS @ ccn) => (! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (XF @ Xx3) @ XS @ ccexp) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccneg @ XN) @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce) @ ccmul)))))))))))))))).
