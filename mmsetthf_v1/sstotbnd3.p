...
thf(arexrab2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => (cwb @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xy1))))) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xy1) @ (Xch @ Xy1))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))))))))).
...
thf(csstotbnd3_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccres @ XM @ (ccxp @ XY @ XY))) => (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwss @ XY @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ XY @ cctotbnd)) @ (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (cwa @ (cwss @ XY @ (cciun @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl))))) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)) @ XY) @ cc0)) @ (^ [Xx3:$i] : (ccv @ Xv))) @ ccfn))) @ (^ [Xv:$i] : (ccpw @ XX)))) @ (^ [Xd:$i] : ccrp)))))))))).
