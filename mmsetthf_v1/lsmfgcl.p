...
thf(clsmfgcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XU @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XD @ (cco @ XW @ XA2 @ ccress)) => ((cwceq @ XE @ (cco @ XW @ XB2 @ ccress)) => ((cwceq @ XF @ (cco @ XW @ (cco @ XA2 @ XB2 @ Xc_po) @ ccress)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XB2 @ XU)) => ((cwi @ Xph @ (cwcel @ XD @ cclfig)) => ((cwi @ Xph @ (cwcel @ XE @ cclfig)) => (cwi @ Xph @ (cwcel @ XF @ cclfig)))))))))))))))))))))).
