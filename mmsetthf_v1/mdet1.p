...
thf(amdetdiagid_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XD @ Xi @ Xj) @ (cco @ XN @ XR @ ccmdat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XG @ Xi @ Xj) @ (ccfv @ XR @ ccmgp)))) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XC @ (ccfv @ XR @ ccbs)) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_x @ Xi @ Xj) @ (ccfv @ (XG @ Xi @ Xj) @ ccmg)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XN @ ccfn)) @ (cwa @ (cwcel @ XM @ XB2) @ (cwcel @ XX @ XC))) @ (cwi @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwceq @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ (ccif @ (cwceq @ (ccv @ Xi) @ (ccv @ Xj)) @ XX @ Xc_0))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)) @ (cwceq @ (ccfv @ XM @ (XD @ Xi @ Xj)) @ (cco @ (ccfv @ XN @ cchash) @ XX @ (Xc_x @ Xi @ Xj)))))))))))))))))))))))))).
...
thf(asrg1expzeq1_thm,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ ccmgp)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccsrg) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XN @ Xc_1 @ Xc_x) @ Xc_1))))))))))).
thf(cmdet1_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XD @ (cco @ XN @ XR @ ccmdat)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccur)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XN @ ccfn)) @ (cwceq @ (ccfv @ XI @ XD) @ Xc_1))))))))))))).
