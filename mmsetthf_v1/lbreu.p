...
thf(clbreu_conj,conjecture,(! [XS:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS))) @ (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS))))).
