...
thf(aoawordri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (cco @ XA2 @ XC @ ccoa) @ (cco @ XB2 @ XC @ ccoa)))))))).
thf(a_3eqtr4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XA2)) => ((cwi @ Xph @ (cwceq @ XD @ XB2)) => (cwi @ Xph @ (cwceq @ XC @ XD))))))))))).
thf(aodi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccomu) @ (cco @ (cco @ XA2 @ XB2 @ ccomu) @ (cco @ XA2 @ XC @ ccomu) @ ccoa))))))).
thf(aoaabslem_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ ccom @ ccon0) @ (cwcel @ XA2 @ ccom)) @ (cwceq @ (cco @ XA2 @ ccom @ ccoa) @ ccom)))).
thf(aoaword2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccoa)))))).
thf(asyl12anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ Xth) => ((cwi @ (cwa @ Xps @ (cwa @ Xch @ Xth)) @ Xta) => (cwi @ Xph @ Xta))))))))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(aoelim2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwa @ (cwcel @ XB2 @ (XC @ Xx3)) @ (cwlim @ XB2))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccoe) @ (cciun @ (^ [Xx3:$i] : (ccdif @ XB2 @ cc1o)) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoe)))))))))).
...
thf(aoelimcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) @ (cwa @ (cwcel @ XB2 @ XC) @ (cwlim @ XB2))) @ (cwlim @ (cco @ XA2 @ XB2 @ ccoe))))))).
...
thf(aoaword_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwss @ (cco @ XC @ XA2 @ ccoa) @ (cco @ XC @ XB2 @ ccoa)))))))).
...
thf(coaabs2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (cco @ ccom @ XC @ ccoe)) @ (cwcel @ XB2 @ ccon0)) @ (cwss @ (cco @ ccom @ XC @ ccoe) @ XB2)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccoa) @ XB2)))))).
