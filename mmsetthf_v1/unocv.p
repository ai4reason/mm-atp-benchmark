...
thf(cunocv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ Xc_pe) @ (ccin @ (ccfv @ XA2 @ Xc_pe) @ (ccfv @ XB2 @ Xc_pe))))))))).
