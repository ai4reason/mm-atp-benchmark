...
thf(afaclim_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ XA2 @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwbr @ (ccseq @ ccmul @ (XF @ Xn) @ cc1) @ (ccfv @ XA2 @ ccfa) @ ccli))))))).
...
thf(ciprodfac_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwceq @ (ccfv @ XA2 @ ccfa) @ (ccprod @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ XA2 @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ ccdiv))))))).
