...
thf(alincdifsn_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XS @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ XB2)) @ (cwcel @ XX @ XV)) @ (cwa @ (cwcel @ XF @ (cco @ XS @ XV @ ccmap)) @ (cwbr @ XF @ Xc_0 @ ccfsupp)) @ (cwceq @ XG @ (ccres @ XF @ (ccdif @ XV @ (ccsn @ XX))))) @ (cwceq @ (cco @ XF @ XV @ (ccfv @ XM @ cclinc)) @ (cco @ (cco @ XG @ (ccdif @ XV @ (ccsn @ XX)) @ (ccfv @ XM @ cclinc)) @ (cco @ (ccfv @ XX @ XF) @ XX @ Xc_x) @ Xc_pl))))))))))))))))))))).
...
thf(almodvsneg_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XW @ ccminusg)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ XM @ (ccfv @ XF @ ccminusg)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XR @ XK)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XR @ XX @ Xc_x) @ XN) @ (cco @ (ccfv @ XR @ XM) @ XX @ Xc_x))))))))))))))))))))))).
...
thf(almodvnegid_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XN @ (ccfv @ XW @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XX @ XV)) @ (cwceq @ (cco @ XX @ (ccfv @ XX @ XN) @ Xc_pl) @ Xc_0))))))))))))).
thf(clincext3_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((! [Xz:$i] : (cwceq @ (XR @ Xz) @ (ccfv @ XM @ ccsca))) => ((! [Xz:$i] : (cwceq @ XE @ (ccfv @ (XR @ Xz) @ ccbs))) => ((! [Xz:$i] : (cwceq @ (Xc_0 @ Xz) @ (ccfv @ (XR @ Xz) @ cc0g))) => ((! [Xz:$i] : (cwceq @ (XZ @ Xz) @ (ccfv @ XM @ cc0g))) => ((! [Xz:$i] : (cwceq @ XN @ (ccfv @ (XR @ Xz) @ ccminusg))) => ((! [Xz:$i] : (cwceq @ (XF @ Xz) @ (ccmpt @ (^ [Xz:$i] : XS) @ (^ [Xz:$i] : (ccif @ (cwceq @ (ccv @ Xz) @ XX) @ (ccfv @ XY @ XN) @ (ccfv @ (ccv @ Xz) @ XG)))))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ (ccpw @ XB2))) @ (cw3a @ (cwcel @ XY @ XE) @ (cwcel @ XX @ XS) @ (cwcel @ XG @ (cco @ XE @ (ccdif @ XS @ (ccsn @ XX)) @ ccmap))) @ (cwa @ (cwbr @ XG @ (Xc_0 @ Xz) @ ccfsupp) @ (cwceq @ (cco @ XY @ XX @ (ccfv @ XM @ ccvsca)) @ (cco @ XG @ (ccdif @ XS @ (ccsn @ XX)) @ (ccfv @ XM @ cclinc))))) @ (cwceq @ (cco @ (XF @ Xz) @ XS @ (ccfv @ XM @ cclinc)) @ (XZ @ Xz)))))))))))))))))))))))).
