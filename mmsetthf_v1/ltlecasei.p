...
thf(cltlecasei_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ (cwa @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) @ Xps) => ((cwi @ (cwa @ Xph @ (cwbr @ XB2 @ XA2 @ ccle)) @ Xps) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ Xps)))))))))).
