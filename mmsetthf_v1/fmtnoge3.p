...
thf(aexpge1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwbr @ cc1 @ XA2 @ ccle)) => (cwi @ Xph @ (cwbr @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccle))))))))).
...
thf(cfmtnoge3_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccfv @ XN @ ccfmtno) @ (ccfv @ cc3 @ ccuz))))).
