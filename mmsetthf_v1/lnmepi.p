...
thf(almhmfgima_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XT @ (ccima @ XF @ XA2) @ ccress)) => ((cwceq @ XX @ (cco @ XS @ XA2 @ ccress)) => ((cwceq @ XU @ (ccfv @ XS @ cclss)) => ((cwi @ Xph @ (cwcel @ XX @ cclfig)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm))) => (cwi @ Xph @ (cwcel @ XY @ cclfig))))))))))))))))).
...
thf(clnmepi_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XT @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XS @ cclnm) @ (cwceq @ (ccrn @ XF) @ XB2)) @ (cwcel @ XT @ cclnm)))))))).
