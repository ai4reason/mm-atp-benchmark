...
thf(admmpt2ssx2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwss @ (ccdm @ (XF @ Xx3 @ Xy1)) @ (cciun @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ (XA2 @ Xy1) @ (ccsn @ (ccv @ Xy1)))))))))))))).
...
thf(cmpt2exxg2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ (XR @ Xx3 @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ (XS @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (cwcel @ (XF @ Xx3 @ Xy1) @ ccvv)))))))))))).
