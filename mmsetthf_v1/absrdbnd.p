...
thf(cabsrdbnd_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ ccabs) @ (cco @ (ccfv @ (ccfv @ XA2 @ ccabs) @ ccfl) @ cc1 @ ccaddc) @ ccle)))).
