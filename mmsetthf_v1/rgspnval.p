...
thf(adf_rgspn_ax,axiom,(cwceq @ ccrgspn @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xs1:$i] : (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ (ccv @ Xs1) @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xw) @ ccsubrg)))))))))).
...
thf(crgspnval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((! [Xt:$i] : (cwi @ Xph @ (cwceq @ (XN @ Xt) @ (ccfv @ XR @ ccrgspn)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwceq @ (XU @ Xt) @ (ccfv @ XA2 @ (XN @ Xt))))) => (! [Xt:$i] : (cwi @ Xph @ (cwceq @ (XU @ Xt) @ (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ XA2 @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccfv @ XR @ ccsubrg))))))))))))))))))).
