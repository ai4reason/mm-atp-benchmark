...
thf(aclwwlknon2_thm,axiom,(! [XC:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XC @ Xw) @ (ccfv @ XG @ ccclwwlknon))) => (! [Xw:$i] : (cwceq @ (cco @ XX @ cc2 @ (XC @ Xw)) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XX)) @ (^ [Xw:$i] : (cco @ cc2 @ XG @ ccclwwlkn)))))))))).
...
thf(cclwwlknon2x_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XC @ Xw) @ (ccfv @ XG @ ccclwwlknon))) => ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : (cwceq @ (XE @ Xw) @ (ccfv @ XG @ ccedg))) => (! [Xw:$i] : (cwceq @ (cco @ XX @ cc2 @ (XC @ Xw)) @ (ccrab @ (^ [Xw:$i] : (cw3a @ (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ cc2) @ (cwcel @ (ccpr @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ cc1 @ (ccv @ Xw))) @ (XE @ Xw)) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XX))) @ (^ [Xw:$i] : (ccword @ (XV @ Xw))))))))))))))).
