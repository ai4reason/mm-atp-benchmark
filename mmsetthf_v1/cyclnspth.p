...
thf(aspthdep_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) @ (cwne @ (ccfv @ XF @ cchash) @ ccc0)) @ (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP))))))).
thf(ccyclnspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwne @ XF @ cc0) @ (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccycls)) @ (cwn @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))))).
