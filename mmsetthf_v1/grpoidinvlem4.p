...
thf(cgrpoidinvlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccgr) @ (cwcel @ XA2 @ XX)) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xy1) @ XA2 @ XG) @ XU) @ (cwceq @ (cco @ XA2 @ (ccv @ Xy1) @ XG) @ XU))) @ (^ [Xy1:$i] : XX))) @ (cwceq @ (cco @ XA2 @ XU @ XG) @ (cco @ XU @ XA2 @ XG))))))))).
