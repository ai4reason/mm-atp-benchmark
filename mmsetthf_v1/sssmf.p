...
thf(csssmf_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => (cwi @ Xph @ (cwcel @ (ccres @ XF @ XB2) @ (ccfv @ XS @ ccsmblfn)))))))))).
