...
thf(csubsubm_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => (cwi @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XH @ ccsubmnd)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XG @ ccsubmnd)) @ (cwss @ XA2 @ XS)))))))))).
