...
thf(casclf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccascl)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwi @ Xph @ (cwcel @ XW @ ccrg)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => (cwi @ Xph @ (cwf @ XK @ XB2 @ XA2))))))))))))))).
