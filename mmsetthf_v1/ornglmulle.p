...
thf(cornglmulle_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwi @ Xph @ (cwcel @ XR @ ccorng)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwceq @ Xc_le @ (ccfv @ XR @ ccple)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ Xc_le)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XZ @ Xc_le)) => (cwi @ Xph @ (cwbr @ (cco @ XZ @ XX @ Xc_x) @ (cco @ XZ @ XY @ Xc_x) @ Xc_le)))))))))))))))))))))).
