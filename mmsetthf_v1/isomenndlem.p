...
thf(afouniiun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfo @ XA2 @ XB2 @ XF) @ (cwceq @ (ccuni @ XB2) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))).
...
thf(axaddid2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => (cwi @ Xph @ (cwceq @ (cco @ ccc0 @ XA2 @ ccxad) @ XA2)))))).
...
thf(asge0z_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xk)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : ccc0)) @ ccsumge0) @ ccc0))))))))).
...
thf(cisomenndlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xn:$i] : (cwi @ Xph @ (cwf @ (ccpw @ (XX @ Xn)) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XO))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XO) @ ccc0)) => ((! [Xn:$i] : (! [Xa:$i] : (cwi @ Xph @ (cwss @ (XY @ Xa) @ (ccpw @ (XX @ Xn)))))) => ((! [Xn:$i] : (! [Xa:$i] : (cwi @ (cwa @ Xph @ (cwf @ ccn @ (ccpw @ (XX @ Xn)) @ (ccv @ Xa))) @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xa)))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xa)) @ XO))) @ ccsumge0) @ ccle)))) => ((! [Xa:$i] : (cwi @ Xph @ (cwss @ (XB2 @ Xa) @ ccn))) => ((! [Xa:$i] : (cwi @ Xph @ (cwf1o @ (XB2 @ Xa) @ (XY @ Xa) @ (XF @ Xa)))) => ((! [Xa:$i] : (cwceq @ XA2 @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ (XB2 @ Xa)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xa)) @ cc0))))) => (! [Xa:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (ccuni @ (XY @ Xa)) @ XO) @ (ccfv @ (ccres @ XO @ (XY @ Xa)) @ ccsumge0) @ ccle)))))))))))))))))).
