...
thf(cdivrngcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdrng) @ (cwcel @ XA2 @ (ccdif @ XX @ (ccsn @ XZ))) @ (cwcel @ XB2 @ (ccdif @ XX @ (ccsn @ XZ)))) @ (cwcel @ (cco @ XA2 @ XB2 @ XH) @ (ccdif @ XX @ (ccsn @ XZ)))))))))))))))).
