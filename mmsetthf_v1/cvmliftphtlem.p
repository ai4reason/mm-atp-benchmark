...
thf(aphtpy01_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)))) => (cwi @ Xph @ (cwa @ (cwceq @ (ccfv @ ccc0 @ XF) @ (ccfv @ ccc0 @ XG)) @ (cwceq @ (ccfv @ cc1 @ XF) @ (ccfv @ cc1 @ XG))))))))))))).
...
thf(ahtpyi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwceq @ (cco @ XA2 @ ccc0 @ XH) @ (ccfv @ XA2 @ XF)) @ (cwceq @ (cco @ XA2 @ cc1 @ XH) @ (ccfv @ XA2 @ XG))))))))))))))))).
...
thf(acvmliftmoi_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccuni @ XC)) => ((cwceq @ XY @ (ccuni @ XK)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XC @ XJ @ cccvm))) => ((cwi @ Xph @ (cwcel @ XK @ ccconn)) => ((cwi @ Xph @ (cwcel @ XK @ (ccnlly @ ccconn))) => ((cwi @ Xph @ (cwcel @ XO @ XY)) => ((cwi @ Xph @ (cwcel @ XM @ (cco @ XK @ XC @ cccn))) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ XK @ XC @ cccn))) => ((cwi @ Xph @ (cwceq @ (cccom @ XF @ XM) @ (cccom @ XF @ XN))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XO @ XM) @ (ccfv @ XO @ XN))) => (cwi @ Xph @ (cwceq @ XM @ XN))))))))))))))))))))))).
...
thf(aphtpyi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwa @ (cwceq @ (cco @ ccc0 @ XA2 @ XH) @ (ccfv @ ccc0 @ XF)) @ (cwceq @ (cco @ cc1 @ XA2 @ XH) @ (ccfv @ cc1 @ XF)))))))))))))).
...
thf(ccvmliftphtlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccuni @ XC)) => ((! [Xf1:$i] : (cwceq @ (XM @ Xf1) @ (ccrio @ (^ [Xf1:$i] : (cwa @ (cwceq @ (cccom @ XF @ (ccv @ Xf1)) @ XG) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn))))) => ((! [Xf1:$i] : (cwceq @ (XN @ Xf1) @ (ccrio @ (^ [Xf1:$i] : (cwa @ (cwceq @ (cccom @ XF @ (ccv @ Xf1)) @ XH) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XF @ (cco @ XC @ XJ @ cccvm)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XP @ XB2))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccfv @ XP @ XF) @ (ccfv @ ccc0 @ XG)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XH @ (cco @ ccii @ XJ @ cccn)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XK @ Xf1) @ (cco @ XG @ XH @ (ccfv @ XJ @ ccphtpy))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XA2 @ (cco @ (cco @ ccii @ ccii @ cctx) @ XC @ cccn)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (cccom @ XF @ XA2) @ (XK @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (cco @ ccc0 @ ccc0 @ XA2) @ XP))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XA2 @ (cco @ (XM @ Xf1) @ (XN @ Xf1) @ (ccfv @ XC @ ccphtpy)))))))))))))))))))))))))))))).
