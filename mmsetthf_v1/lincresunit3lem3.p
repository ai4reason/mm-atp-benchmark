...
thf(clincresunit3lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XE @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ XN @ (ccfv @ XR @ ccminusg)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwcel @ XA2 @ XU)) @ (cwb @ (cwceq @ (cco @ (ccfv @ XA2 @ XN) @ XX @ Xc_x) @ (cco @ (ccfv @ XA2 @ XN) @ XY @ Xc_x)) @ (cwceq @ XX @ XY)))))))))))))))))))).
