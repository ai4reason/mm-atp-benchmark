...
thf(caltopthsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwb @ (cwceq @ (ccaltop @ XA2 @ XB2) @ (ccaltop @ XC @ XD)) @ (cwa @ (cwceq @ (ccsn @ XA2) @ (ccsn @ XC)) @ (cwceq @ (ccsn @ XB2) @ (ccsn @ XD))))))))).
