...
thf(cfunvtxval_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwa @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) @ (cwss @ (ccpr @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ ccedgf)) @ (ccdm @ XG))) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ ccbs))))).
