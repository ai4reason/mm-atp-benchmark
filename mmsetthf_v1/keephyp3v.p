...
thf(ckeephyp3v_conj,conjecture,(! [Xph:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ (cwceq @ XA2 @ (ccif @ Xph @ XA2 @ XD)) @ (cwb @ Xrh @ Xch)) => ((cwi @ (cwceq @ XB2 @ (ccif @ Xph @ XB2 @ XR)) @ (cwb @ Xch @ Xth)) => ((cwi @ (cwceq @ XC @ (ccif @ Xph @ XC @ XS)) @ (cwb @ Xth @ Xta)) => ((cwi @ (cwceq @ XD @ (ccif @ Xph @ XA2 @ XD)) @ (cwb @ Xet @ Xze)) => ((cwi @ (cwceq @ XR @ (ccif @ Xph @ XB2 @ XR)) @ (cwb @ Xze @ Xsi)) => ((cwi @ (cwceq @ XS @ (ccif @ Xph @ XC @ XS)) @ (cwb @ Xsi @ Xta)) => (Xrh => (Xet => Xta))))))))))))))))))))))).
