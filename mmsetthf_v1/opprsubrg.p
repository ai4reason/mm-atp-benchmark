...
thf(aopprsubg_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => (cwceq @ (ccfv @ XR @ ccsubg) @ (ccfv @ XO @ ccsubg)))))).
...
thf(copprsubrg_conj,conjecture,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => (cwceq @ (ccfv @ XR @ ccsubrg) @ (ccfv @ XO @ ccsubrg)))))).
