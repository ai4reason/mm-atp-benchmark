...
thf(czlmodzxzsubm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((cwceq @ Xc_mi @ (ccfv @ XZ @ ccsg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ XC @ ccz) @ (cwcel @ XD @ ccz))) @ (cwceq @ (cco @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XC)) @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XD)) @ Xc_mi) @ (cco @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XC)) @ (cco @ (ccneg @ cc1) @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XD)) @ (ccfv @ XZ @ ccvsca)) @ (ccfv @ XZ @ ccplusg))))))))))))).
