...
thf(aseqz_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XS))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwceq @ (cco @ XZ @ (ccv @ Xx3) @ Xc_pl) @ XZ))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwceq @ (cco @ (ccv @ Xx3) @ XZ @ Xc_pl) @ XZ))) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ XM @ XN @ ccfz))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XN @ (XV @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ XF) @ XZ)) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) @ XZ))))))))))))))))))).
...
thf(abcval3_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccz) @ (cwn @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)))) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ ccc0))))).
thf(cbcval5_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccn)) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ (cco @ (ccfv @ XN @ (ccseq @ ccmul @ ccid @ (cco @ (cco @ XN @ XK @ ccmin) @ cc1 @ ccaddc))) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
