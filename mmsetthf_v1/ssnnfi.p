...
thf(apssnn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwpss @ XB2 @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccen)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(cssnnfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwss @ XB2 @ XA2)) @ (cwcel @ XB2 @ ccfn))))).
