...
thf(cfucid_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XQ @ (cco @ XC @ XD @ ccfuc)) => ((cwceq @ XI @ (ccfv @ XQ @ cccid)) => ((cwceq @ Xc_1 @ (ccfv @ XD @ cccid)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ XI) @ (cccom @ Xc_1 @ (ccfv @ XF @ cc1st)))))))))))))))).
