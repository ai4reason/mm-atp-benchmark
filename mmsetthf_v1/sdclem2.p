...
thf(aelabf_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3)))) => (! [Xx3:$i] : (cwb @ (cwcel @ XA2 @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))) @ (Xps @ Xx3)))))))))).
...
thf(aabrexex2g_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ XW)) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2)))) @ ccvv))))))).
...
thf(csdclem2_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xth:($i > ($i > ($i > ($i > $o))))] : (! [Xta:($i > ($i > $o))] : (! [Xsi:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xg1) @ (ccres @ (ccv @ Xf1) @ (cco @ XM @ (ccv @ Xn) @ ccfz))) @ (cwb @ (Xps @ Xw @ Xg1 @ Xn) @ (Xch @ Xx3 @ Xw @ Xf1 @ Xh @ Xk @ Xn)))))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ XM) @ (cwb @ (Xps @ Xw @ Xg1 @ Xn) @ (Xta @ Xf1 @ Xg1))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xk)) @ (cwb @ (Xps @ Xw @ Xg1 @ Xn) @ (Xth @ Xf1 @ Xg1 @ Xh @ Xk))))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xg1) @ (ccv @ Xh)) @ (cwceq @ (ccv @ Xn) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc))) @ (cwb @ (Xps @ Xw @ Xg1 @ Xn) @ (Xsi @ Xw @ Xh @ Xk)))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xw @ Xf1 @ Xg1 @ Xk @ Xn)))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwcel @ XM @ ccz)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwf @ (ccsn @ XM) @ XA2 @ (ccv @ Xg1)) @ (Xta @ Xf1 @ Xg1))))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwi @ (cwa @ (cwf @ (cco @ XM @ (ccv @ Xk) @ ccfz) @ XA2 @ (ccv @ Xg1)) @ (Xth @ Xf1 @ Xg1 @ Xh @ Xk)) @ (cwex @ (^ [Xh:$i] : (cw3a @ (cwf @ (cco @ XM @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccfz) @ XA2 @ (ccv @ Xh)) @ (cwceq @ (ccv @ Xg1) @ (ccres @ (ccv @ Xh) @ (cco @ XM @ (ccv @ Xk) @ ccfz))) @ (Xsi @ Xw @ Xh @ Xk))))))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xf1 @ Xg1 @ Xn) @ (ccab @ (^ [Xg1:$i] : (cwrex @ (^ [Xn:$i] : (cwa @ (cwf @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ XA2 @ (ccv @ Xg1)) @ (Xps @ Xw @ Xg1 @ Xn))) @ (^ [Xn:$i] : XZ))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xf1 @ Xg1 @ Xh @ Xk) @ (ccmpt2 @ (^ [Xw:$i] : (^ [Xx3:$i] : XZ)) @ (^ [Xw:$i] : (^ [Xx3:$i] : (XJ @ Xf1 @ Xg1 @ Xn))) @ (^ [Xw:$i] : (^ [Xx3:$i] : (ccab @ (^ [Xh:$i] : (cwrex @ (^ [Xk:$i] : (cw3a @ (cwf @ (cco @ XM @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccfz) @ XA2 @ (ccv @ Xh)) @ (cwceq @ (ccv @ Xx3) @ (ccres @ (ccv @ Xh) @ (cco @ XM @ (ccv @ Xk) @ ccfz))) @ (Xsi @ Xw @ Xh @ Xk))) @ (^ [Xk:$i] : XZ))))))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xf1 @ Xg1 @ Xh @ Xk)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwf @ XZ @ (XJ @ Xf1 @ Xg1 @ Xn) @ XG))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwf @ (cco @ XM @ XM @ ccfz) @ XA2 @ (ccfv @ XM @ XG))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwcel @ (ccv @ Xw) @ XZ)) @ (cwcel @ (ccfv @ (cco @ (ccv @ Xw) @ cc1 @ ccaddc) @ XG) @ (cco @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ XG) @ (XF @ Xf1 @ Xg1 @ Xh @ Xk))))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xh @ Xk) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XZ @ XA2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xn:$i] : (Xch @ Xx3 @ Xw @ Xf1 @ Xh @ Xk @ Xn)) @ (^ [Xn:$i] : XZ))))))))))))))))))))))))))))))))))))))))).
