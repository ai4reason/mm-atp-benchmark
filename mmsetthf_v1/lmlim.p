...
thf(almclimf_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwf @ XZ @ ccc @ XF)) @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) @ (cwbr @ XF @ XP @ ccli))))))))))).
thf(clmlim_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XY @ cctopon)) => ((cwi @ Xph @ (cwf @ ccn @ XX @ XF)) => ((cwi @ Xph @ (cwcel @ XP @ XX)) => ((cwceq @ (cco @ XJ @ XX @ ccrest) @ (cco @ (ccfv @ cccnfld @ cctopn) @ XX @ ccrest)) => ((cwss @ XX @ ccc) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) @ (cwbr @ XF @ XP @ ccli))))))))))))))).
