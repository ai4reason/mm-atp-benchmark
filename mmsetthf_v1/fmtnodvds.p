...
thf(afprodfvdvdsd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwf @ (XB2 @ Xx3 @ Xk) @ ccz @ (XF @ Xx3))))) => (cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xx3)))) @ ccdvds)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))).
...
thf(cfmtnodvds_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn)) @ (cwbr @ (ccfv @ XN @ ccfmtno) @ (cco @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ ccfmtno) @ cc2 @ ccmin) @ ccdvds))))).
