...
thf(atopgrpbas_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XW @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ))) => (cwi @ (cwcel @ XB2 @ XX) @ (cwceq @ XB2 @ (ccfv @ XW @ ccbs)))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(com1bas_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XO @ Xf1) @ (cco @ XJ @ XY @ ccomi))) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwceq @ (XB2 @ Xf1) @ (ccfv @ (XO @ Xf1) @ ccbs)))) => (! [Xf1:$i] : (cwi @ Xph @ (cwceq @ (XB2 @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ XY) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xf1)) @ XY))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))))))))))))).
