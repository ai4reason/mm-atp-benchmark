...
thf(adeg1z_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ (ccfv @ Xc_0 @ XD) @ ccmnf)))))))))).
...
thf(aexp5c_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ (cwa @ Xps @ Xch) @ (cwi @ (cwa @ Xth @ Xta) @ Xet))) => (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))))))))))))).
thf(aexp45_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ Xph @ (cwa @ Xps @ (cwa @ Xch @ Xth))) @ Xta) => (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ Xta))))))))))).
...
thf(alidlacl_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU)) @ (cwa @ (cwcel @ XX @ XI) @ (cwcel @ XY @ XI))) @ (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XI))))))))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(adeg1addle2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XY @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((cwi @ Xph @ (cwcel @ XL @ ccxr)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XF @ XD) @ XL @ ccle)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XG @ XD) @ XL @ ccle)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_pl) @ XD) @ XL @ ccle)))))))))))))))))))))).
...
thf(adeg1mul3le_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XK) @ (cwcel @ XG @ XB2)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ XF @ XA2) @ XG @ Xc_x) @ XD) @ (ccfv @ XG @ XD) @ ccle)))))))))))))))))).
...
thf(acoe1sclmulfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ Xc_xb @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwa @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XB2)) @ (cwcel @ Xc_0 @ ccn0)) @ (cwceq @ (ccfv @ Xc_0 @ (ccfv @ (cco @ (ccfv @ XX @ XA2) @ XY @ Xc_xb) @ ccco1)) @ (cco @ XX @ (ccfv @ Xc_0 @ (ccfv @ XY @ ccco1)) @ Xc_x)))))))))))))))))))).
...
thf(aislidl_thm,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XU @ Xx3 @ Xa @ Xb) @ (ccfv @ XR @ cclidl))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XB2 @ Xa @ Xb) @ (ccfv @ XR @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xa @ Xb) @ (ccfv @ XR @ ccplusg))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (Xc_x @ Xx3 @ Xa @ Xb) @ (ccfv @ XR @ ccmulr))))) => (! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwb @ (cwcel @ XI @ (XU @ Xx3 @ Xa @ Xb)) @ (cw3a @ (cwss @ XI @ (XB2 @ Xa @ Xb)) @ (cwne @ XI @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xa) @ (Xc_x @ Xx3 @ Xa @ Xb)) @ (ccv @ Xb) @ (Xc_pl @ Xx3 @ Xa @ Xb)) @ XI)) @ (^ [Xb:$i] : XI))) @ (^ [Xa:$i] : XI))) @ (^ [Xx3:$i] : (XB2 @ Xa @ Xb))))))))))))))))))).
thf(chbtlem2_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((cwceq @ XT @ (ccfv @ XR @ cclidl)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwcel @ XX @ ccn0)) @ (cwcel @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ XT)))))))))))))).
