...
thf(acnrmtop_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cccnrm) @ (cwcel @ XJ @ cctop)))).
...
thf(aiscnrm2_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XJ @ cccnrm) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccnrm)) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
thf(crestcnrm_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cccnrm) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ cccnrm)))))).
