...
thf(afunresdfunsn_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwcel @ XX @ (ccdm @ XF))) @ (cwceq @ (ccun @ (ccres @ XF @ (ccdif @ ccvv @ (ccsn @ XX))) @ (ccsn @ (ccop @ XX @ (ccfv @ XX @ XF)))) @ XF))))).
thf(csetsidvald_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XE @ (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwfun @ XS)) => ((cwi @ Xph @ (cwcel @ (ccfv @ ccnx @ XE) @ (ccdm @ XS))) => (cwi @ Xph @ (cwceq @ XS @ (cco @ XS @ (ccop @ (ccfv @ ccnx @ XE) @ (ccfv @ XS @ XE)) @ ccsts)))))))))))))).
