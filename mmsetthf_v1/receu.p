...
thf(arecex_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cc1)) @ (^ [Xx3:$i] : ccc))))).
...
thf(creceu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwreu @ (^ [Xx3:$i] : (cwceq @ (cco @ XB2 @ (ccv @ Xx3) @ ccmul) @ XA2)) @ (^ [Xx3:$i] : ccc)))))).
