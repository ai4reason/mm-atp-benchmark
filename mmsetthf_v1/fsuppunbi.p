...
thf(asuppun_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XG @ XV)) => (cwi @ Xph @ (cwss @ (cco @ XF @ XZ @ ccsupp) @ (cco @ (ccun @ XF @ XG) @ XZ @ ccsupp)))))))))).
...
thf(afununfun_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwfun @ (ccun @ XF @ XG)) @ (cwa @ (cwfun @ XF) @ (cwfun @ XG)))))).
...
thf(afsuppun_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp)) => ((cwi @ Xph @ (cwbr @ XG @ XZ @ ccfsupp)) => (cwi @ Xph @ (cwcel @ (cco @ (ccun @ XF @ XG) @ XZ @ ccsupp) @ ccfn))))))))).
...
thf(cfsuppunbi_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwfun @ (ccun @ XF @ XG))) => (cwi @ Xph @ (cwb @ (cwbr @ (ccun @ XF @ XG) @ XZ @ ccfsupp) @ (cwa @ (cwbr @ XF @ XZ @ ccfsupp) @ (cwbr @ XG @ XZ @ ccfsupp)))))))))).
