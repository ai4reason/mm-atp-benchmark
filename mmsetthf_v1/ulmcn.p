...
thf(culmcn_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ XS @ ccc @ cccncf) @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (cwi @ Xph @ (cwcel @ XG @ (cco @ XS @ ccc @ cccncf)))))))))))))).
