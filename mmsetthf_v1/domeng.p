...
thf(cdomeng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XB2 @ (XC @ Xx3)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccen) @ (cwss @ (ccv @ Xx3) @ XB2))))))))))).
