...
thf(aleid_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ XA2 @ XA2 @ ccle)))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(a_0pledm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwfn @ XF @ XA2)) => (cwi @ Xph @ (cwb @ (cwbr @ cc0p @ XF @ (ccofr @ ccle)) @ (cwbr @ (ccxp @ XA2 @ (ccsn @ ccc0)) @ XF @ (ccofr @ ccle)))))))))).
...
thf(aitg2itg1_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwbr @ cc0p @ XF @ (ccofr @ ccle))) @ (cwceq @ (ccfv @ XF @ ccitg2) @ (ccfv @ XF @ ccitg1))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(ccsu_tp,type,(ccsu : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aitg10_thm,axiom,(cwceq @ (ccfv @ (ccxp @ ccr @ (ccsn @ ccc0)) @ ccitg1) @ ccc0)).
thf(citg20_conj,conjecture,(cwceq @ (ccfv @ (ccxp @ ccr @ (ccsn @ ccc0)) @ ccitg2) @ ccc0)).
