...
thf(cssref_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwi @ (cw3a @ (cwcel @ XA2 @ XC) @ (cwss @ XA2 @ XB2) @ (cwceq @ XX @ XY)) @ (cwbr @ XA2 @ XB2 @ ccref)))))))))).
