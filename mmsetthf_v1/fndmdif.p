...
thf(cfndmdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XA2)) @ (cwceq @ (ccdm @ (ccdif @ XF @ XG)) @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2)))))))).
