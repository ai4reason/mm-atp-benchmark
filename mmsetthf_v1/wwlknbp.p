...
thf(aiswwlksn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwa @ (cwcel @ XW @ (ccfv @ XG @ ccwwlks)) @ (cwceq @ (ccfv @ XW @ cchash) @ (cco @ XN @ cc1 @ ccaddc))))))))).
...
thf(cwwlknbp_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cw3a @ (cwcel @ XG @ ccvv) @ (cwcel @ XN @ ccn0) @ (cwcel @ XW @ (ccword @ XV)))))))))).
