...
thf(afrege117_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (! [Xb:$i] : (cwcel @ XX @ (XU @ Xa @ Xb)))) => (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwi @ (cwal @ (^ [Xb:$i] : (cwi @ (cwbr @ (ccv @ Xb) @ XX @ XR) @ (cwal @ (^ [Xa:$i] : (cwi @ (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ XR) @ (cwceq @ (ccv @ Xa) @ XX))))))) @ (cwi @ (cwbr @ (XY @ Xa @ Xb) @ XX @ XR) @ (cwal @ (^ [Xa:$i] : (cwi @ (cwbr @ (XY @ Xa @ Xb) @ (ccv @ Xa) @ XR) @ (cwceq @ (ccv @ Xa) @ XX)))))) @ (cwi @ (cwfun @ (cccnv @ (cccnv @ XR))) @ (cwi @ (cwbr @ (XY @ Xa @ Xb) @ XX @ XR) @ (cwal @ (^ [Xa:$i] : (cwi @ (cwbr @ (XY @ Xa @ Xb) @ (ccv @ Xa) @ XR) @ (cwceq @ (ccv @ Xa) @ XX))))))))))))))).
thf(cfrege118_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (cwcel @ XX @ (XU @ Xa))) => ((! [Xa:$i] : (cwcel @ XY @ (XV @ Xa))) => (cwi @ (cwfun @ (cccnv @ (cccnv @ XR))) @ (cwi @ (cwbr @ XY @ XX @ XR) @ (cwal @ (^ [Xa:$i] : (cwi @ (cwbr @ XY @ (ccv @ Xa) @ XR) @ (cwceq @ (ccv @ Xa) @ XX)))))))))))))).
