...
thf(admdbr3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj) @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
...
thf(admdbr5ati_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)) @ (cwss @ (ccv @ Xx3) @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccat)))))))).
thf(cdmdbr6ati_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccv @ Xx3)) @ (ccin @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccat)))))))).
