...
thf(caxpre_mulgt0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwi @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccltrr) @ (cwbr @ ccc0 @ XB2 @ ccltrr)) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccltrr)))))).
