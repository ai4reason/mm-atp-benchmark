...
thf(cstrlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwn @ (cwss @ XA2 @ XB2)) @ (cwrex @ (^ [Xu:$i] : (cwceq @ (ccfv @ (ccv @ Xu) @ ccno) @ cc1)) @ (^ [Xu:$i] : (ccdif @ XA2 @ XB2))))))))).
