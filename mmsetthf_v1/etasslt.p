...
thf(abianass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xet:$o] : ((cwb @ Xph @ (cwa @ Xps @ Xch)) => (cwb @ (cwa @ Xet @ Xph) @ (cwa @ (cwa @ Xet @ Xps) @ Xch)))))))).
...
thf(cetasslt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwbr @ XA2 @ (ccsn @ (ccv @ Xx3)) @ ccsslt) @ (cwbr @ (ccsn @ (ccv @ Xx3)) @ XB2 @ ccsslt) @ (cwss @ (ccfv @ (ccv @ Xx3) @ ccbday) @ (ccsuc @ (ccuni @ (ccima @ ccbday @ (ccun @ XA2 @ XB2))))))) @ (^ [Xx3:$i] : ccsur)))))).
