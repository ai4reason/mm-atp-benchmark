...
thf(csuppval_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xi)) @ (cwcel @ XZ @ (XW @ Xi))) @ (cwceq @ (cco @ XX @ XZ @ ccsupp) @ (ccrab @ (^ [Xi:$i] : (cwne @ (ccima @ XX @ (ccsn @ (ccv @ Xi))) @ (ccsn @ XZ))) @ (^ [Xi:$i] : (ccdm @ XX))))))))))).
