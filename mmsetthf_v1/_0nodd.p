...
thf(anegcon1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwb @ (cwceq @ (ccneg @ XA2) @ XB2) @ (cwceq @ (ccneg @ XB2) @ XA2))))))))).
...
thf(c_0nodd_conj,conjecture,(! [XO:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XO @ Xx3 @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => (! [Xx3:$i] : (! [Xz:$i] : (cwnel @ ccc0 @ (XO @ Xx3 @ Xz))))))).
