...
thf(csalgenss_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwceq @ XG @ (ccfv @ XX @ ccsalgen)) => ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwss @ XX @ XS)) => ((cwi @ Xph @ (cwceq @ (ccuni @ XS) @ (ccuni @ XX))) => (cwi @ Xph @ (cwss @ XG @ XS))))))))))))).
