...
thf(ciundifdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XO @ ccvv) => ((cwss @ XA2 @ (ccpw @ XO)) => (cwi @ (cwne @ XA2 @ cc0) @ (cwceq @ (ccint @ XA2) @ (ccdif @ XO @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccdif @ XO @ (ccv @ Xx3)))))))))))).
