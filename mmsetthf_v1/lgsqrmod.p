...
thf(clgsqrmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) @ (cwi @ (cwceq @ (cco @ XA2 @ XP @ cclgs) @ cc1) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XP @ ccmo) @ (cco @ XA2 @ XP @ ccmo))) @ (^ [Xx3:$i] : ccz))))))).
