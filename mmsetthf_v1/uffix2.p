...
thf(auffixfr_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwb @ (cwcel @ XA2 @ (ccint @ XF)) @ (cwceq @ XF @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))))).
...
thf(cuffix2_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwb @ (cwne @ (ccint @ XF) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XF @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccpw @ XX))))) @ (^ [Xx3:$i] : XX))))))).
