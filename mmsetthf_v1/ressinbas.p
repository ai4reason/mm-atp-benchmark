...
thf(cressinbas_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => (cwi @ (cwcel @ XA2 @ XX) @ (cwceq @ (cco @ XW @ XA2 @ ccress) @ (cco @ XW @ (ccin @ XA2 @ XB2) @ ccress))))))))).
