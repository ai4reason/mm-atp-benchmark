...
thf(aom2uzuzi_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwcel @ XC @ ccz) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XC) @ ccom))) => (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ ccom) @ (cwcel @ (ccfv @ (XA2 @ Xx3) @ (XG @ Xx3)) @ (ccfv @ XC @ ccuz)))))))))).
...
thf(adffun5_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwfun @ XA2) @ (cwa @ (cwrel @ XA2) @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz))))))))))))).
