...
thf(afin4en1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwi @ (cwcel @ XA2 @ ccfin4) @ (cwcel @ XB2 @ ccfin4)))))).
...
thf(ainfcda1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ XA2 @ ccen)))).
thf(arelsdom_thm,axiom,(cwrel @ ccsdm)).
thf(aisfin4_2_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ ccfin4) @ (cwn @ (cwbr @ ccom @ XA2 @ ccdom))))))).
thf(cisfin4_3_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfin4) @ (cwbr @ XA2 @ (cco @ XA2 @ cc1o @ cccda) @ ccsdm)))).
