...
thf(clnopunilem1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) @ (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)) => ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ cchil)) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ cchil)) => ((! [Xx3:$i] : (cwcel @ (XC @ Xx3) @ ccc)) => (! [Xx3:$i] : (cwceq @ (ccfv @ (cco @ (XC @ Xx3) @ (cco @ (ccfv @ (XA2 @ Xx3) @ XT) @ (ccfv @ (XB2 @ Xx3) @ XT) @ ccsp) @ ccmul) @ ccre) @ (ccfv @ (cco @ (XC @ Xx3) @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccsp) @ ccmul) @ ccre))))))))))))).
