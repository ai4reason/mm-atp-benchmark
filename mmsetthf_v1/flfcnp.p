...
thf(acnpflfi_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ XJ @ XL @ ccflim)) @ (cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp)))) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ XF @ (cco @ XK @ XL @ ccflf)))))))))).
...
thf(cflfcnp_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) @ (cwcel @ XG @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))))) @ (cwcel @ (ccfv @ XA2 @ XG) @ (ccfv @ (cccom @ XG @ XF) @ (cco @ XK @ XL @ ccflf))))))))))))).
