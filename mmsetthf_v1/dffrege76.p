...
thf(abrtrclfv2_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XR @ XW)) @ (cwb @ (cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) @ (cwcel @ XY @ (ccint @ (ccab @ (^ [Xf1:$i] : (cwss @ (ccima @ XR @ (ccun @ (ccsn @ XX) @ (ccv @ Xf1))) @ (ccv @ Xf1))))))))))))))).
...
thf(cdffrege76_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xa:$i] : (cwcel @ XB2 @ (XU @ Xa))) => ((! [Xa:$i] : (cwcel @ (XE @ Xa) @ (XV @ Xa))) => ((! [Xa:$i] : (cwcel @ XR @ (XW @ Xa))) => (! [Xa:$i] : (cwb @ (cwal @ (^ [Xf1:$i] : (cwi @ (cwhe @ (ccv @ Xf1) @ XR) @ (cwi @ (cwal @ (^ [Xa:$i] : (cwi @ (cwbr @ XB2 @ (ccv @ Xa) @ XR) @ (cwcel @ (ccv @ Xa) @ (ccv @ Xf1))))) @ (cwcel @ (XE @ Xa) @ (ccv @ Xf1)))))) @ (cwbr @ XB2 @ (XE @ Xa) @ (ccfv @ XR @ cctcl)))))))))))))).
