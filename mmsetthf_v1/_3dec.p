...
thf(c_3dec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => (cwceq @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ (cco @ (cco @ (cco @ (cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ (ccdc @ cc1 @ ccc0) @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
