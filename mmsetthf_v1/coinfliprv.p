...
thf(ccoinfliprv_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((cwne @ XH @ XT) => ((cwceq @ XP @ (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((cwceq @ XX @ (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => (cwcel @ XX @ (ccfv @ XP @ ccrrv)))))))))))).
