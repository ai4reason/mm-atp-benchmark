...
thf(celunif_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (! [Xx3:$i] : (cwb @ (cwcel @ (XA2 @ Xx3) @ (ccuni @ (XB2 @ Xx3))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (XA2 @ Xx3) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)))))))))))).
