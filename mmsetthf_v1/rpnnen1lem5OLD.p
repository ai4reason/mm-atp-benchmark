...
thf(arpnnen1lem3OLD_thm,axiom,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xk) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccle)) @ (^ [Xn:$i] : (ccrn @ (ccfv @ (ccv @ Xx3) @ XF))))))))))).
...
thf(arpnnen1lem1OLD_thm,axiom,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xk) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ ccq @ ccn @ ccmap))))))))).
...
thf(arpnnen1lem4OLD_thm,axiom,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xk) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwcel @ (ccsup @ (ccrn @ (ccfv @ (ccv @ Xx3) @ XF)) @ ccr @ cclt) @ ccr)))))))).
...
thf(arpnnen1lem2_thm,axiom,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xk) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ ccz))))))))).
...
thf(aeqlelt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwn @ (cwbr @ XA2 @ XB2 @ cclt)))))))).
thf(crpnnen1lem5OLD_conj,conjecture,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xk) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwceq @ (ccsup @ (ccrn @ (ccfv @ (ccv @ Xx3) @ XF)) @ ccr @ cclt) @ (ccv @ Xx3))))))))).
