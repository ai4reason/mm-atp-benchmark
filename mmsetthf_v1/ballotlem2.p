...
thf(ale2addi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => ((cwcel @ XD @ ccr) => (cwi @ (cwa @ (cwbr @ XA2 @ XC @ ccle) @ (cwbr @ XB2 @ XD @ ccle)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccle))))))))))).
thf(annrei_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwcel @ XA2 @ ccr)))).
thf(aletri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ XB2 @ XC @ ccle)) @ (cwbr @ XA2 @ XC @ ccle))))))))).
...
thf(ainab_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwceq @ (ccin @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3)))) @ (ccab @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3)))))))).
...
thf(aimnang_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwb @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwn @ (Xps @ Xx3))))) @ (cwal @ (^ [Xx3:$i] : (cwn @ (cwa @ (Xph @ Xx3) @ (Xps @ Xx3))))))))).
...
thf(ahashfz_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccfz) @ cchash) @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ cc1 @ ccaddc)))))).
...
thf(aballotlem1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XM @ ccn) => ((cwcel @ XN @ ccn) => ((cwceq @ XO @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ cchash) @ XM)) @ (^ [Xc:$i] : (ccpw @ (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz))))) => (cwceq @ (ccfv @ XO @ cchash) @ (cco @ (cco @ XM @ XN @ ccaddc) @ XM @ ccbc))))))))).
...
thf(abcm1n_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccbc) @ (cco @ XN @ XK @ ccbc) @ ccdiv) @ (cco @ (cco @ XN @ XK @ ccmin) @ XN @ ccdiv)))))).
thf(apncan2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XA2 @ ccmin) @ XB2))))).
thf(cballotlem2_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (cwcel @ (XM @ Xx3) @ ccn)) => ((! [Xx3:$i] : (cwcel @ (XN @ Xx3) @ ccn)) => ((! [Xx3:$i] : (cwceq @ XO @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ cchash) @ (XM @ Xx3))) @ (^ [Xc:$i] : (ccpw @ (cco @ cc1 @ (cco @ (XM @ Xx3) @ (XN @ Xx3) @ ccaddc) @ ccfz)))))) => ((! [Xx3:$i] : (! [Xc:$i] : (cwceq @ (XP @ Xx3 @ Xc) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XO)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cchash) @ (ccfv @ XO @ cchash) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xc:$i] : (cwceq @ (ccfv @ (ccrab @ (^ [Xc:$i] : (cwn @ (cwcel @ cc1 @ (ccv @ Xc)))) @ (^ [Xc:$i] : XO)) @ (XP @ Xx3 @ Xc)) @ (cco @ (XN @ Xx3) @ (cco @ (XM @ Xx3) @ (XN @ Xx3) @ ccaddc) @ ccdiv))))))))))))).
