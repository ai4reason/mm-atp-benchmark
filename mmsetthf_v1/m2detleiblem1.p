...
thf(apsgnprfval1_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XD @ (ccpr @ cc1 @ cc2)) => ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwceq @ (ccfv @ (ccpr @ (ccop @ cc1 @ cc1) @ (ccop @ cc2 @ cc2)) @ XN) @ cc1)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(a_1z_thm,axiom,(cwcel @ cc1 @ ccz)).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(apsgnprfval2_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XD @ (ccpr @ cc1 @ cc2)) => ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwceq @ (ccfv @ (ccpr @ (ccop @ cc1 @ cc2) @ (ccop @ cc2 @ cc1)) @ XN) @ (ccneg @ cc1))))))))))))).
...
thf(cm2detleiblem1_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccpr @ cc1 @ cc2)) => ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((cwceq @ XY @ (ccfv @ XR @ cczrh)) => ((cwceq @ XS @ (ccfv @ XN @ ccpsgn)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XQ @ XP)) @ (cwceq @ (ccfv @ (ccfv @ XQ @ XS) @ XY) @ (cco @ (ccfv @ XQ @ (ccfv @ XN @ ccpsgn)) @ Xc_1 @ (ccfv @ XR @ ccmg))))))))))))))))).
