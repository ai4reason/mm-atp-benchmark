...
thf(ampt2curryvald_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ XV)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))) => ((cwi @ Xph @ (cwne @ XY @ cc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XY @ (XW @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (cccur @ XF)) @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccsb @ XA2 @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1))))))))))))))))))))).
...
thf(acbvcsbv_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xy1:$i] : (XC @ Xy1))))))))))).
...
thf(afvmpt2curryd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ XV)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XY @ (XW @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XB2 @ XY)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ (ccfv @ XA2 @ (cccur @ (XF @ Xx3 @ Xy1)))) @ (cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1))))))))))))))))))))).
...
thf(adf_decpmat_ax,axiom,(cwceq @ ccdecpmat @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xk:$i] : ccvv)) @ (^ [Xm:$i] : (^ [Xk:$i] : ccn0)) @ (^ [Xm:$i] : (^ [Xk:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdm @ (ccdm @ (ccv @ Xm))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdm @ (ccdm @ (ccv @ Xm))))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)) @ ccco1)))))))))).
