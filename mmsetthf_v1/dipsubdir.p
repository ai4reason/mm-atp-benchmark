...
thf(cdipsubdir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cwa @ (cwcel @ XU @ cccphlo) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XM) @ XC @ XP) @ (cco @ (cco @ XA2 @ XC @ XP) @ (cco @ XB2 @ XC @ XP) @ ccmin)))))))))))))).
