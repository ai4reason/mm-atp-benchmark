...
thf(clvecindp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwn @ (cwcel @ XX @ XU))) => ((cwi @ Xph @ (cwcel @ XY @ XU)) => ((cwi @ Xph @ (cwcel @ XZ @ XU)) => ((cwi @ Xph @ (cwcel @ XA2 @ XK)) => ((cwi @ Xph @ (cwcel @ XB2 @ XK)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XX @ Xc_x) @ XY @ Xc_pl) @ (cco @ (cco @ XB2 @ XX @ Xc_x) @ XZ @ Xc_pl))) => (cwi @ Xph @ (cwa @ (cwceq @ XA2 @ XB2) @ (cwceq @ XY @ XZ))))))))))))))))))))))))))))))))).
