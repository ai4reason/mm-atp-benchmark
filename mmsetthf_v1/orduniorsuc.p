...
thf(aordelssne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cword @ XB2)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwa @ (cwss @ XA2 @ XB2) @ (cwne @ XA2 @ XB2))))))).
thf(aordsucss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cword @ XB2) @ (cwi @ (cwcel @ XA2 @ XB2) @ (cwss @ (ccsuc @ XA2) @ XB2)))))).
thf(aordsucuni_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwss @ XA2 @ (ccsuc @ (ccuni @ XA2)))))).
...
thf(corduniorsuc_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwo @ (cwceq @ XA2 @ (ccuni @ XA2)) @ (cwceq @ XA2 @ (ccsuc @ (ccuni @ XA2))))))).
