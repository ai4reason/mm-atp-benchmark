...
thf(cfvelimad_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwfn @ (XF @ Xx3) @ XA2))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XC @ (ccima @ (XF @ Xx3) @ XB2)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ XC)) @ (^ [Xx3:$i] : (ccin @ XA2 @ XB2)))))))))))))).
