...
thf(amp2pm2mplem3_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk @ Xp) @ (cco @ XN @ XR @ ccmat)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk @ Xp) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xp) @ ccpl1)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ XL @ (ccfv @ (XQ @ Xi @ Xj @ Xk @ Xp) @ ccbs)))))) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((! [Xk:$i] : (cwceq @ (XE @ Xk) @ (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg))) => ((! [Xk:$i] : (cwceq @ (XY @ Xk) @ (ccfv @ XR @ ccv1))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwceq @ (XI @ Xi @ Xj @ Xk @ Xp) @ (ccmpt @ (^ [Xp:$i] : XL) @ (^ [Xp:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xp) @ ccco1))) @ (cco @ (ccv @ Xk) @ (XY @ Xk) @ (XE @ Xk)) @ Xc_x))) @ ccgsu))))))))))) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XO @ XL)) @ (cwcel @ (XK @ Xk @ Xp) @ ccn0)) @ (cwceq @ (cco @ (ccfv @ XO @ (XI @ Xi @ Xj @ Xk @ Xp)) @ (XK @ Xk @ Xp) @ ccdecpmat) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (XK @ Xk @ Xp) @ (ccfv @ (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccfv @ (ccv @ Xk) @ (ccfv @ XO @ ccco1))) @ (cco @ (ccv @ Xk) @ (XY @ Xk) @ (XE @ Xk)) @ Xc_x))) @ ccgsu) @ ccco1)))))))))))))))))))))))))))))))).
...
thf(acoe1fzgsumd_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XP @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccpl1))) => ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XR @ Xx3) @ ccrg))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XK @ ccn0))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3) @ XB2)) @ (^ [Xx3:$i] : XN)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XN @ ccfn))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ XK @ (ccfv @ (cco @ (XP @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (XM @ Xx3))) @ ccgsu) @ ccco1)) @ (cco @ (XR @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (ccfv @ XK @ (ccfv @ (XM @ Xx3) @ ccco1)))) @ ccgsu)))))))))))))))))).
...
thf(acsbov_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xx3:$i] : (cwceq @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (cco @ XB2 @ XC @ (XF @ Xx3)))) @ (cco @ XB2 @ XC @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XF @ Xx3))))))))))).
