...
thf(altexpi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclti) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccpli) @ XB2)) @ (^ [Xx3:$i] : ccnpi))))))).
...
thf(aadderpq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ (ccfv @ XA2 @ ccerq) @ (ccfv @ XB2 @ ccerq) @ ccplq) @ (ccfv @ (cco @ XA2 @ XB2 @ ccplpq) @ ccerq))))).
...
thf(amulcanenq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi) @ (cwcel @ XC @ ccnpi)) @ (cwbr @ (ccop @ (cco @ XA2 @ XB2 @ ccmi) @ (cco @ XA2 @ XC @ ccmi)) @ (ccop @ XB2 @ XC) @ cceq)))))).
...
thf(altaddnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnq) @ (cwcel @ XB2 @ ccnq)) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccplq) @ ccltq))))).
thf(cltexnq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccnq) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccltq) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccplq) @ XB2)))))))).
