...
thf(ccgsexg_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (Xch @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xch @ Xx3) @ (cwb @ (Xph @ Xx3) @ Xps))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwb @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xch @ Xx3) @ (Xph @ Xx3)))) @ Xps))))))))))).
