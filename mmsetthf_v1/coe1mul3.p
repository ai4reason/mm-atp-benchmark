...
thf(adeg1lt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XA2 @ (ccfv @ XF @ ccco1)) => (cwi @ (cw3a @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ ccn0) @ (cwbr @ (ccfv @ XF @ XD) @ XG @ cclt)) @ (cwceq @ (ccfv @ XG @ XA2) @ Xc_0)))))))))))))))).
...
thf(ccoe1mul3_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_xb @ (ccfv @ XY @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XI @ ccn0)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XF @ XD) @ XI @ ccle)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((cwi @ Xph @ (cwcel @ XJ @ ccn0)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XG @ XD) @ XJ @ ccle)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XI @ XJ @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ Xc_xb) @ ccco1)) @ (cco @ (ccfv @ XI @ (ccfv @ XF @ ccco1)) @ (ccfv @ XJ @ (ccfv @ XG @ ccco1)) @ Xc_x))))))))))))))))))))))))))).
