...
thf(cpjf2_conj,conjecture,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XK @ (ccfv @ XW @ ccpj)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwcel @ XT @ (ccdm @ XK))) @ (cwf @ XV @ XT @ (ccfv @ XT @ XK)))))))))).
