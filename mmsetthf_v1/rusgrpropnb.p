...
thf(crusgrpropnb_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xv:$i] : (cwceq @ (XV @ Xv) @ (ccfv @ XG @ ccvtx))) => (cwi @ (cwbr @ XG @ XK @ ccrusgr) @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XK @ ccxnn0) @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (cco @ XG @ (ccv @ Xv) @ ccnbgr) @ cchash) @ XK)) @ (^ [Xv:$i] : (XV @ Xv)))))))))).
