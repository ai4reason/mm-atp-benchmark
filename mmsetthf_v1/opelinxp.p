...
thf(copelinxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (cwb @ (cwcel @ (ccop @ XC @ XD) @ (ccin @ XR @ (ccxp @ XA2 @ XB2))) @ (cwa @ (cwa @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) @ (cwcel @ (ccop @ XC @ XD) @ XR))))))))).
