...
thf(clmnn_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XJ @ Xk) @ (ccfv @ XD @ ccmopn))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((cwi @ Xph @ (cwcel @ XP @ XX)) => ((cwi @ Xph @ (cwf @ ccn @ XX @ XF)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ XP @ XD) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ cclt))) => (! [Xk:$i] : (cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ (XJ @ Xk) @ cclm)))))))))))))))).
