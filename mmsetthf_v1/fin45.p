...
thf(aisfin5_2_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ ccfin5) @ (cwn @ (cwa @ (cwne @ XA2 @ cc0) @ (cwbr @ XA2 @ (cco @ XA2 @ XA2 @ cccda) @ ccen)))))))).
thf(cfin45_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfin4) @ (cwcel @ XA2 @ ccfin5)))).
