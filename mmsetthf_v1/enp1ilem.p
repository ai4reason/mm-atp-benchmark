...
thf(cenp1ilem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccun @ (ccsn @ (ccv @ Xx3)) @ (XS @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (cwi @ (cwceq @ (ccdif @ (XA2 @ Xx3) @ (ccsn @ (ccv @ Xx3))) @ (XS @ Xx3)) @ (cwceq @ (XA2 @ Xx3) @ (XT @ Xx3)))))))))).
