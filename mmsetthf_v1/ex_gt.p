...
thf(agt_lth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ ccgt) @ (cwbr @ XB2 @ XA2 @ cclt))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(ac0ex_thm,axiom,(cwcel @ ccc0 @ ccvv)).
thf(cex_gt_conj,conjecture,(cwn @ (cwbr @ ccc0 @ ccc0 @ ccgt))).
