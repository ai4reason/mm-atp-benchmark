...
thf(cqtopcmap_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwceq @ (ccrn @ XF) @ XY)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccfv @ XJ @ cccld))) @ (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ (ccfv @ XK @ cccld)))) => (cwi @ Xph @ (cwceq @ XK @ (cco @ XJ @ XF @ ccqtop))))))))))))).
