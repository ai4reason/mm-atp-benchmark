...
thf(ciinopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XJ)) @ (^ [Xx3:$i] : XA2)))) @ (cwcel @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XJ)))))).
