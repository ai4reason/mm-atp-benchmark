...
thf(aflimcfil_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim))) @ (cwcel @ XF @ (ccfv @ XD @ cccfil)))))))))).
thf(cfmcncfil_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XK @ (ccfv @ XE @ ccmopn)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwcel @ XE @ (ccfv @ XY @ ccxmt)) @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) @ (cwcel @ XB2 @ (ccfv @ XD @ cccfil))) @ (cwcel @ (ccfv @ XB2 @ (cco @ XY @ XF @ ccfm)) @ (ccfv @ XE @ cccfil)))))))))))))).
