...
thf(cefcvg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ ccc0) @ (ccfv @ XA2 @ cce) @ ccli))))))).
