...
thf(asbeqalb_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwi @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3) @ (cwceq @ (ccv @ Xx3) @ XA2)))) @ (cwal @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3) @ (cwceq @ (ccv @ Xx3) @ XB2))))) @ (cwceq @ XA2 @ XB2))))))))).
...
thf(auniabio_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwceq @ (ccuni @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) @ (ccv @ Xy1)))))).
thf(ciotaval_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwceq @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))) @ (ccv @ Xy1)))))).
