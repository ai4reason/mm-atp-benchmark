...
thf(asqfpc_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwne @ (ccfv @ XA2 @ ccmu) @ ccc0) @ (cwcel @ XP @ ccprime)) @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ cc1 @ ccle))))).
...
thf(csqf11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwne @ (ccfv @ XA2 @ ccmu) @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccn) @ (cwne @ (ccfv @ XB2 @ ccmu) @ ccc0))) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwral @ (^ [Xp:$i] : (cwb @ (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds) @ (cwbr @ (ccv @ Xp) @ XB2 @ ccdvds))) @ (^ [Xp:$i] : ccprime))))))).
