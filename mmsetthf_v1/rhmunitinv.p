...
thf(crhmunitinv_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh)) @ (cwcel @ XA2 @ (ccfv @ XR @ ccui))) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XR @ ccinvr)) @ XF) @ (ccfv @ (ccfv @ XA2 @ XF) @ (ccfv @ XS @ ccinvr))))))))).
