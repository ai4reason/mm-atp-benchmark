...
thf(aelwspths2on_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV)) @ (cwb @ (cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwceq @ XW @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) @ (cwcel @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))))) @ (^ [Xb:$i] : XV))))))))))).
...
thf(awlklenvp1_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ XP @ cchash) @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccaddc))))))).
...
thf(celwspths2spth_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ ccupgr) @ (cwb @ (cwcel @ XW @ (cco @ cc2 @ XG @ ccwwspthsn)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwa @ (cwceq @ XW @ (ccs3 @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc))) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccspths)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc2) @ (cw3a @ (cwceq @ (ccv @ Xa) @ (ccfv @ ccc0 @ (ccv @ Xp))) @ (cwceq @ (ccv @ Xb) @ (ccfv @ cc1 @ (ccv @ Xp))) @ (cwceq @ (ccv @ Xc) @ (ccfv @ cc2 @ (ccv @ Xp))))))))))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
