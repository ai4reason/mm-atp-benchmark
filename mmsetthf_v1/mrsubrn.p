...
thf(cmrsubrn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwceq @ (ccrn @ XS) @ (ccima @ XS @ (cco @ XR @ XV @ ccmap))))))))))).
