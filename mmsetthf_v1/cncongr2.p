...
thf(adivgcdz_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwne @ XB2 @ ccc0)) @ (cwcel @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccz))))).
...
thf(adivmulasscom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwa @ (cwcel @ XD @ ccc) @ (cwne @ XD @ ccc0))) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XD @ ccdiv) @ ccmul) @ XC @ ccmul) @ (cco @ XB2 @ (cco @ (cco @ XA2 @ XC @ ccmul) @ XD @ ccdiv) @ ccmul)))))))).
...
thf(ccncongr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwa @ (cwcel @ XN @ ccn) @ (cwceq @ XM @ (cco @ XN @ (cco @ XC @ XN @ ccgcd) @ ccdiv)))) @ (cwi @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XB2 @ XM @ ccmo)) @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccmul) @ XN @ ccmo) @ (cco @ (cco @ XB2 @ XC @ ccmul) @ XN @ ccmo)))))))))).
