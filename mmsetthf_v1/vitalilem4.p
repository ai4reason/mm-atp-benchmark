...
thf(aovolshft_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XC @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (XB2 @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XC @ ccmin) @ XA2)) @ (^ [Xx3:$i] : ccr))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ XA2 @ ccovol) @ (ccfv @ (XB2 @ Xx3) @ ccovol)))))))))))).
...
thf(ashftmbl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ ccr)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ XA2)) @ (^ [Xx3:$i] : ccr)) @ (ccdm @ ccvol)))))).
...
thf(cvitalilem4_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xc_sm:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_sm @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccq)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xm @ Xn @ Xs1) @ (ccqs @ (cco @ ccc0 @ cc1 @ ccicc) @ Xc_sm))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xs1) @ (cwfn @ XF @ (XS @ Xx3 @ Xy1 @ Xm @ Xn @ Xs1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xs1) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (XS @ Xx3 @ Xy1 @ Xm @ Xn @ Xs1))))))))) => ((! [Xy1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xs1) @ (cwf1o @ ccn @ (ccin @ ccq @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc)) @ XG)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XT @ Xy1 @ Xz @ Xn @ Xs1) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xs1:$i] : (cwcel @ (cco @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xn) @ XG) @ ccmin) @ (ccrn @ XF))) @ (^ [Xs1:$i] : ccr))))))))) => ((! [Xy1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xy1 @ Xs1) @ (cwn @ (cwcel @ (ccrn @ XF) @ (ccdif @ (ccpw @ ccr) @ (ccdm @ ccvol))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (Xph @ Xy1 @ Xs1) @ (cwcel @ (ccv @ Xm) @ ccn)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xm) @ (XT @ Xy1 @ Xz @ Xn @ Xs1)) @ ccovol) @ ccc0))))))))))))))))))))).
