...
thf(c_4t3lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwceq @ XC @ (cco @ XB2 @ cc1 @ ccaddc)) => ((cwceq @ (cco @ XA2 @ XB2 @ ccmul) @ XD) => ((cwceq @ (cco @ XD @ XA2 @ ccaddc) @ XE) => (cwceq @ (cco @ XA2 @ XC @ ccmul) @ XE)))))))))))).
