...
thf(cgeoisum1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) @ (cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) @ (cco @ XA2 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv))))).
