...
thf(antrtop_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XX @ (ccfv @ XJ @ ccnt)) @ XX)))))).
...
thf(cicocncflimc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccico) @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XF) @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XA2 @ cclimc)))))))))))).
