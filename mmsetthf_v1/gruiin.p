...
thf(cgruiin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ ccgru) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XU)) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XU)))))).
