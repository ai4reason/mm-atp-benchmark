...
thf(aeuorv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (cwi @ (cwa @ (cwn @ Xph) @ (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))) @ (cweu @ (^ [Xx3:$i] : (cwo @ Xph @ (Xps @ Xx3)))))))).
...
thf(ceueq2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cweu @ (^ [Xx3:$i] : (cwo @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwa @ (cwn @ Xph) @ (cwceq @ (ccv @ Xx3) @ XB2))))))))))).
