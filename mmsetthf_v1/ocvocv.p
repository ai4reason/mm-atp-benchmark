...
thf(cocvocv_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwss @ XS @ XV)) @ (cwss @ XS @ (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe)))))))))).
