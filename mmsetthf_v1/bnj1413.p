...
thf(abnj1149_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccvv)) => (cwi @ Xph @ (cwcel @ (ccun @ XA2 @ XB2) @ ccvv)))))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(abnj1148_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw_bnj15 @ XA2 @ XR) @ (cwcel @ XX @ XA2)) @ (cwcel @ (cc_bnj14 @ XA2 @ XR @ XX) @ ccvv)))))).
...
thf(abnj893_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw_bnj15 @ XA2 @ XR) @ (cwcel @ XX @ XA2)) @ (cwcel @ (cc_bnj18 @ XA2 @ XR @ XX) @ ccvv)))))).
...
thf(abnj1127_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwcel @ XY @ (cc_bnj18 @ XA2 @ XR @ XX)) @ (cwcel @ XY @ XA2))))))).
...
thf(abnj906_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw_bnj15 @ XA2 @ XR) @ (cwcel @ XX @ XA2)) @ (cwss @ (cc_bnj14 @ XA2 @ XR @ XX) @ (cc_bnj18 @ XA2 @ XR @ XX))))))).
...
thf(cbnj1413_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (ccun @ (cc_bnj14 @ XA2 @ XR @ XX) @ (cciun @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ XX)) @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (cwi @ (cwa @ (cw_bnj15 @ XA2 @ XR) @ (cwcel @ XX @ XA2)) @ (cwcel @ (XB2 @ Xy1) @ ccvv))))))))).
