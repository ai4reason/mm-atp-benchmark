...
thf(axnegpnf_thm,axiom,(cwceq @ (ccxne @ ccpnf) @ ccmnf)).
...
thf(axmulneg2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwceq @ (cco @ XA2 @ (ccxne @ XB2) @ ccxmu) @ (ccxne @ (cco @ XA2 @ XB2 @ ccxmu))))))).
...
thf(cxmulmnf1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwceq @ (cco @ XA2 @ ccmnf @ ccxmu) @ ccmnf)))).
