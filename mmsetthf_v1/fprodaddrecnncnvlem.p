...
thf(adivcnv_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccdiv))) @ ccc0 @ ccli)))).
...
thf(cfprodaddrecnncnvlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XA2 @ Xn) @ ccfn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xn))) @ (cwcel @ (XB2 @ Xk @ Xn) @ ccc)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xx3 @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccprod @ (^ [Xk:$i] : (XA2 @ Xn)) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk @ Xn) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xk) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : (XA2 @ Xn)) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk @ Xn) @ (ccv @ Xx3) @ ccaddc))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XG @ Xx3 @ Xk) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XS @ Xx3 @ Xk @ Xn) @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xn)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xn))) @ ccli)))))))))))))))))).
