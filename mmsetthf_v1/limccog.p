...
thf(aellimc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (cwi @ Xph @ (cwb @ (cwcel @ XC @ (cco @ XF @ XB2 @ cclimc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwral @ (^ [Xu:$i] : (cwi @ (cwcel @ XC @ (ccv @ Xu)) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwcel @ XB2 @ (ccv @ Xw)) @ (cwss @ (ccima @ XF @ (ccin @ (ccv @ Xw) @ (ccdif @ XA2 @ (ccsn @ XB2)))) @ (ccv @ Xu)))) @ (^ [Xw:$i] : XK)))) @ (^ [Xu:$i] : XK)))))))))))))))).
thf(asimp1d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cw3a @ Xps @ Xch @ Xth)) => (cwi @ Xph @ Xps))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(cwsbc_tp,type,(cwsbc : (($i > $o) > (($i > $o) > $o)))).
thf(ccpm_tp,type,(ccpm : ($i > $o))).
thf(alimcrcl_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XC @ (cco @ XF @ XB2 @ cclimc)) @ (cw3a @ (cwf @ (ccdm @ XF) @ ccc @ XF) @ (cwss @ (ccdm @ XF) @ ccc) @ (cwcel @ XB2 @ ccc))))))).
...
thf(climccog_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwss @ (ccrn @ XF) @ (ccdif @ (ccdm @ XG) @ (ccsn @ XB2)))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XF @ XA2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XG @ XB2 @ cclimc))) => (cwi @ Xph @ (cwcel @ XC @ (cco @ (cccom @ XG @ XF) @ XA2 @ cclimc))))))))))))).
