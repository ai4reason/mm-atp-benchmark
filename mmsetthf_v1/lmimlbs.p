...
thf(alindsmm2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XC @ (ccfv @ XT @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XG @ (cco @ XS @ XT @ cclmhm)) @ (cwf1 @ XB2 @ XC @ XG) @ (cwcel @ XF @ (ccfv @ XS @ cclinds))) @ (cwcel @ (ccima @ XG @ XF) @ (ccfv @ XT @ cclinds)))))))))))).
...
thf(albsss_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => (cwi @ (cwcel @ XB2 @ XJ) @ (cwss @ XB2 @ XV))))))))).
...
thf(aislbs4_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => ((cwceq @ XK @ (ccfv @ XW @ cclspn)) => (cwb @ (cwcel @ XX @ XJ) @ (cwa @ (cwcel @ XX @ (ccfv @ XW @ cclinds)) @ (cwceq @ (ccfv @ XX @ XK) @ XB2)))))))))))).
thf(clmimlbs_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XS @ cclbs)) => ((cwceq @ XK @ (ccfv @ XT @ cclbs)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmim)) @ (cwcel @ XB2 @ XJ)) @ (cwcel @ (ccima @ XF @ XB2) @ XK))))))))))).
