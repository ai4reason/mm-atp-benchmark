...
thf(adf_nei_ax,axiom,(cwceq @ ccnei @ (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xj)))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xy1)))) @ (^ [Xg1:$i] : (ccv @ Xj)))) @ (^ [Xy1:$i] : (ccpw @ (ccuni @ (ccv @ Xj))))))))))).
thf(cneifval_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XJ @ ccnei) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX))))))))))).
