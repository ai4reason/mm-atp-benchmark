...
thf(a_4001lem3_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => (cwceq @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo))))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(a_4001lem4_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => (cwceq @ (cco @ (cco @ (cco @ cc2 @ (ccdc @ (ccdc @ cc8 @ ccc0) @ ccc0) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) @ cc1)))).
thf(c_4001prm_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => (cwcel @ XN @ ccprime)))).
