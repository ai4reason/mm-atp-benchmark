...
thf(afzoend_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XA2 @ XB2 @ ccfzo)) @ (cwcel @ (cco @ XB2 @ cc1 @ ccmin) @ (cco @ XA2 @ XB2 @ ccfzo)))))).
...
thf(clswccatn0lsw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwne @ XB2 @ cc0)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccconcat) @ cclsw) @ (ccfv @ XB2 @ cclsw))))))).
