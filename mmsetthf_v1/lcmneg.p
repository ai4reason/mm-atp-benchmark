...
thf(advdslcm_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwbr @ XM @ (cco @ XM @ XN @ cclcm) @ ccdvds) @ (cwbr @ XN @ (cco @ XM @ XN @ cclcm) @ ccdvds)))))).
...
thf(alcmn0cl_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwn @ (cwo @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)))) @ (cwcel @ (cco @ XM @ XN @ cclcm) @ ccn))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(ccuz_tp,type,(ccuz : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(alcmledvds_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ ccn) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwn @ (cwo @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)))) @ (cwi @ (cwa @ (cwbr @ XM @ XK @ ccdvds) @ (cwbr @ XN @ XK @ ccdvds)) @ (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccle))))))).
...
thf(clcmneg_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XM @ (ccneg @ XN) @ cclcm) @ (cco @ XM @ XN @ cclcm)))))).
