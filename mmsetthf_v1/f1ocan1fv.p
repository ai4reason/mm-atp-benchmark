...
thf(cf1ocan1fv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwfun @ XF) @ (cwf1o @ XA2 @ XB2 @ XG) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ (ccfv @ XX @ (cccnv @ XG)) @ (cccom @ XF @ XG)) @ (ccfv @ XX @ XF))))))))).
