...
thf(ccuspcvg_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XW @ cctopn)) => (cwi @ (cw3a @ (cwcel @ XW @ cccusp) @ (cwcel @ XC @ (ccfv @ (ccfv @ XW @ ccuss) @ cccfilu)) @ (cwcel @ XC @ (ccfv @ XB2 @ ccfil))) @ (cwne @ (cco @ XJ @ XC @ ccflim) @ cc0))))))))).
