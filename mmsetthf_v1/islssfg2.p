...
thf(cislssfg2_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ XW @ XU @ ccress)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((! [Xb:$i] : (cwceq @ (XB2 @ Xb) @ (ccfv @ XW @ ccbs))) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XS)) @ (cwb @ (cwcel @ XX @ cclfig) @ (cwrex @ (^ [Xb:$i] : (cwceq @ (ccfv @ (ccv @ Xb) @ XN) @ XU)) @ (^ [Xb:$i] : (ccin @ (ccpw @ (XB2 @ Xb)) @ ccfn)))))))))))))))).
