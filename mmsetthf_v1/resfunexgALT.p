...
thf(admresexg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwcel @ (ccdm @ (ccres @ XA2 @ XB2)) @ ccvv)))))).
...
thf(cresfunexgALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwfun @ XA2) @ (cwcel @ XB2 @ XC)) @ (cwcel @ (ccres @ XA2 @ XB2) @ ccvv)))))).
