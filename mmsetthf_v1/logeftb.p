...
thf(adflog2_thm,axiom,(cwceq @ cclog @ (cccnv @ (ccres @ cce @ (ccrn @ cclog))))).
thf(clogeftb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XB2 @ (ccrn @ cclog))) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cclog) @ XB2) @ (cwceq @ (ccfv @ XB2 @ cce) @ XA2)))))).
