...
thf(alogdifbnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwbr @ (cco @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ cclog) @ ccmin) @ (cco @ cc1 @ XA2 @ ccdiv) @ ccle)))).
...
thf(alogdiflbnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwbr @ (cco @ cc1 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ cclog) @ ccmin) @ ccle)))).
...
thf(algamgulmlem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XR @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XU @ Xx3 @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XR @ ccle) @ (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ XR @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XN @ Xk) @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XU @ Xx3 @ Xk))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (cco @ cc2 @ XR @ ccmul) @ (XN @ Xk) @ ccle))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (XN @ Xk) @ ccdiv) @ (ccfv @ (cco @ (cco @ XA2 @ (XN @ Xk) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin) @ ccabs) @ (cco @ XR @ (cco @ (cco @ cc1 @ (cco @ (XN @ Xk) @ XR @ ccmin) @ ccdiv) @ (cco @ cc1 @ (XN @ Xk) @ ccdiv) @ ccmin) @ ccmul) @ ccle)))))))))))))).
...
thf(asubrecd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ (cco @ cc1 @ XB2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccmul) @ ccdiv))))))))))).
...
thf(clgamgulmlem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XR @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XU @ Xx3 @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XR @ ccle) @ (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ XR @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XN @ Xk) @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XU @ Xx3 @ Xk))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (cco @ cc2 @ XR @ ccmul) @ (XN @ Xk) @ ccle))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (ccfv @ (cco @ (cco @ (XN @ Xk) @ cc1 @ ccaddc) @ (XN @ Xk) @ ccdiv) @ cclog) @ ccmul) @ (ccfv @ (cco @ (cco @ XA2 @ (XN @ Xk) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin) @ ccabs) @ (cco @ XR @ (cco @ (cco @ cc2 @ (cco @ XR @ cc1 @ ccaddc) @ ccmul) @ (cco @ (XN @ Xk) @ cc2 @ ccexp) @ ccdiv) @ ccmul) @ ccle)))))))))))))).
