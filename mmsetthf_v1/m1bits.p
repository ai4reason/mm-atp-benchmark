...
thf(abitscmp_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccdif @ ccn0 @ (ccfv @ XN @ ccbits)) @ (ccfv @ (cco @ (ccneg @ XN) @ cc1 @ ccmin) @ ccbits))))).
...
thf(cm1bits_conj,conjecture,(cwceq @ (ccfv @ (ccneg @ cc1) @ ccbits) @ ccn0)).
