...
thf(csigaex_conj,conjecture,(! [Xo:$i] : (cwcel @ (ccab @ (^ [Xs1:$i] : (cwa @ (cwss @ (ccv @ Xs1) @ (ccpw @ (ccv @ Xo))) @ (cw3a @ (cwcel @ (ccv @ Xo) @ (ccv @ Xs1)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ (ccv @ Xo) @ (ccv @ Xx3)) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccv @ Xs1))) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwcel @ (ccuni @ (ccv @ Xx3)) @ (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xs1)))))))) @ ccvv))).
