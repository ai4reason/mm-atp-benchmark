...
thf(anumdenneg_thm,axiom,(! [XQ:($i > $o)] : (cwi @ (cwcel @ XQ @ ccq) @ (cwa @ (cwceq @ (ccfv @ (ccneg @ XQ) @ ccnumer) @ (ccneg @ (ccfv @ XQ @ ccnumer))) @ (cwceq @ (ccfv @ (ccneg @ XQ) @ ccdenom) @ (ccfv @ XQ @ ccdenom)))))).
...
thf(cdivnumden2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ (ccneg @ XB2) @ ccn)) @ (cwa @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) @ (ccneg @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) @ (ccneg @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)))))))).
