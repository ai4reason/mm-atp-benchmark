...
thf(apsgneldm2i_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwa @ (cwcel @ XD @ XV) @ (cwcel @ XW @ (ccword @ XT))) @ (cwcel @ (cco @ XG @ XW @ ccgsu) @ (ccdm @ XN))))))))))))).
...
thf(aiota2d_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XV @ Xx3)))) => ((cwi @ Xph @ (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XB2)) @ (cwb @ (Xps @ Xx3) @ Xch))) => (cwi @ Xph @ (cwb @ Xch @ (cwceq @ (ccio @ (^ [Xx3:$i] : (Xps @ Xx3))) @ XB2)))))))))))).
...
thf(cpsgnvalii_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwa @ (cwcel @ XD @ XV) @ (cwcel @ XW @ (ccword @ XT))) @ (cwceq @ (ccfv @ (cco @ XG @ XW @ ccgsu) @ XN) @ (cco @ (ccneg @ cc1) @ (ccfv @ XW @ cchash) @ ccexp))))))))))))).
