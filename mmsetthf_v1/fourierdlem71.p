...
thf(assfiunibd_b1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ (ccuni @ XA2))) @ (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xy1) @ ccle)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : ccr)))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwss @ (XC @ Xy1 @ Xz) @ (ccuni @ XA2))))) => (cwi @ Xph @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xy1) @ ccle)) @ (^ [Xz:$i] : (XC @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : ccr)))))))))))).
...
thf(cfourierdlem71_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : ((cwi @ Xph @ (cwss @ (ccdm @ XF) @ ccr)) => ((cwi @ Xph @ (cwf @ (ccdm @ XF) @ ccr @ XF)) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xi @ Xk) @ ccr)))) => ((! [Xi:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xi) @ ccr))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (XA2 @ Xi @ Xk) @ (XB2 @ Xi) @ cclt)))) => ((! [Xi:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xi) @ (cco @ (XB2 @ Xi) @ (XA2 @ Xi @ Xk) @ ccmin)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xy1) @ ccn))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwf @ (cco @ ccc0 @ (XM @ Xy1) @ ccfz) @ ccr @ XQ))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ ccc0 @ XQ) @ (XA2 @ Xi @ Xk))))) => ((! [Xy1:$i] : (! [Xi:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XM @ Xy1) @ XQ) @ (XB2 @ Xi))))) => ((! [Xy1:$i] : (! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xy1) @ ccfzo))) @ (cwcel @ (ccres @ XF @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo) @ ccc @ cccncf))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xy1) @ ccfzo))) @ (cwcel @ (XR @ Xy1 @ Xi @ Xk) @ (cco @ (ccres @ XF @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (ccv @ Xi) @ XQ) @ cclimc)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xy1) @ ccfzo))) @ (cwcel @ (XL @ Xy1 @ Xi @ Xk) @ (cco @ (ccres @ XF @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ cclimc)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdm @ XF))) @ (cwcel @ (ccv @ Xk) @ ccz)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (XT @ Xi) @ ccmul) @ ccaddc) @ (ccdm @ XF)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdm @ XF))) @ (cwcel @ (ccv @ Xk) @ ccz)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (XT @ Xi) @ ccmul) @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)))))) => ((! [Xy1:$i] : (! [Xk:$i] : (cwceq @ (XI @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (XM @ Xy1) @ ccfzo)) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (cwceq @ (XE @ Xx3 @ Xy1 @ Xi @ Xk) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ (XB2 @ Xi) @ (ccv @ Xx3) @ ccmin) @ (XT @ Xi) @ ccdiv) @ ccfl) @ (XT @ Xi) @ ccmul) @ ccaddc)))))))) => (cwi @ Xph @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : (ccdm @ XF)))) @ (^ [Xy1:$i] : ccr)))))))))))))))))))))))))))))))).
