...
thf(ccnextrel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XC @ (ccuni @ XJ)) => ((cwceq @ XB2 @ (ccuni @ XK)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwss @ XA2 @ XC))) @ (cwrel @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext))))))))))))).
