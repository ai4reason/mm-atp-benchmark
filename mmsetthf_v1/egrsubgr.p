...
thf(cegrsubgr_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XG @ XW) @ (cwcel @ XS @ XU)) @ (cwss @ (ccfv @ XS @ ccvtx) @ (ccfv @ XG @ ccvtx)) @ (cwa @ (cwfun @ (ccfv @ XS @ cciedg)) @ (cwceq @ (ccfv @ XS @ ccedg) @ cc0))) @ (cwbr @ XS @ XG @ ccsubgr))))))).
