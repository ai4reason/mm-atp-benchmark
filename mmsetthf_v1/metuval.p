...
thf(adf_metu_ax,axiom,(cwceq @ ccmetu @ (ccmpt @ (^ [Xd:$i] : (ccuni @ (ccrn @ ccpsmet))) @ (^ [Xd:$i] : (cco @ (ccxp @ (ccdm @ (ccdm @ (ccv @ Xd))) @ (ccdm @ (ccdm @ (ccv @ Xd)))) @ (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ (ccv @ Xd)) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico))))) @ ccfg))))).
...
thf(cmetuval_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwceq @ (ccfv @ XD @ ccmetu) @ (cco @ (ccxp @ XX @ XX) @ (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico))))) @ ccfg)))))).
