...
thf(acncfcnvcn_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XK @ (cco @ XJ @ XX @ ccrest)) => (cwi @ (cwa @ (cwcel @ XK @ cccmp) @ (cwcel @ XF @ (cco @ XX @ XY @ cccncf))) @ (cwb @ (cwf1o @ XX @ XY @ XF) @ (cwcel @ (cccnv @ XF) @ (cco @ XY @ XX @ cccncf)))))))))))).
