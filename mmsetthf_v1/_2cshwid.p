...
thf(a_2cshw_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ XW @ XM @ cccsh) @ XN @ cccsh) @ (cco @ XW @ (cco @ XM @ XN @ ccaddc) @ cccsh)))))))).
...
thf(c_2cshwid_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ XW @ XN @ cccsh) @ (cco @ (ccfv @ XW @ cchash) @ XN @ ccmin) @ cccsh) @ XW)))))).
