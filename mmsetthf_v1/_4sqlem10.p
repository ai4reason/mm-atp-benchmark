...
thf(asubcan2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin))) => (cwi @ Xph @ (cwceq @ XA2 @ XB2))))))))))).
...
thf(a_4sqlem6_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (cwi @ Xph @ (cwa @ (cwbr @ (ccneg @ (cco @ XM @ cc2 @ ccdiv)) @ XB2 @ ccle) @ (cwbr @ XB2 @ (cco @ XM @ cc2 @ ccdiv) @ cclt))))))))))).
...
thf(advdssq_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ (cco @ XM @ cc2 @ ccexp) @ (cco @ XN @ cc2 @ ccexp) @ ccdvds)))))).
...
thf(advds2sub_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwa @ (cwbr @ XK @ XM @ ccdvds) @ (cwbr @ XK @ XN @ ccdvds)) @ (cwbr @ XK @ (cco @ XM @ XN @ ccmin) @ ccdvds))))))).
...
thf(c_4sqlem10_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => ((cwi @ (cwa @ Xph @ Xps) @ (cwceq @ (cco @ (cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin) @ ccc0)) => (cwi @ (cwa @ Xph @ Xps) @ (cwbr @ (cco @ XM @ cc2 @ ccexp) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ ccmin) @ ccdvds)))))))))))).
