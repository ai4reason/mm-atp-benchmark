...
thf(cfbssint_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) @ (cwss @ XA2 @ XF) @ (cwcel @ XA2 @ ccfn)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccint @ XA2))) @ (^ [Xx3:$i] : XF))))))).
