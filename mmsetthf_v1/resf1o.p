...
thf(affs2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XC @ (ccdif @ XB2 @ (ccsn @ XZ))) => (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XZ @ XW) @ (cwf @ XA2 @ XB2 @ XF)) @ (cwceq @ (cco @ XF @ XZ @ ccsupp) @ (ccima @ (cccnv @ XF) @ XC)))))))))))).
...
thf(afnsuppres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ (ccun @ XA2 @ XB2)) @ (cwa @ (cwcel @ XF @ XW) @ (cwcel @ XZ @ XV)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwb @ (cwss @ (cco @ XF @ XZ @ ccsupp) @ XA2) @ (cwceq @ (ccres @ XF @ XB2) @ (ccxp @ XB2 @ (ccsn @ XZ)))))))))))).
...
thf(cresf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccdif @ XB2 @ (ccsn @ XZ))) @ XC)) @ (^ [Xf1:$i] : (cco @ XB2 @ XA2 @ ccmap)))) => ((! [Xf1:$i] : (cwceq @ (XF @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : XX) @ (^ [Xf1:$i] : (ccres @ (ccv @ Xf1) @ XC))))) => (! [Xf1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwss @ XC @ XA2)) @ (cwcel @ XZ @ XB2)) @ (cwf1o @ XX @ (cco @ XB2 @ XC @ ccmap) @ (XF @ Xf1))))))))))))))).
