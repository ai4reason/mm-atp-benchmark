...
thf(cfucco_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XQ @ Xx3) @ (cco @ XC @ XD @ ccfuc))) => ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (cco @ XC @ XD @ ccnat))) => ((cwceq @ XA2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XD @ ccco)) => ((! [Xx3:$i] : (cwceq @ (Xc_xb @ Xx3) @ (ccfv @ (XQ @ Xx3) @ ccco))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XR @ (cco @ XF @ XG @ (XN @ Xx3))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XS @ (cco @ XG @ XH @ (XN @ Xx3))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ XS @ XR @ (cco @ (ccop @ XF @ XG) @ XH @ (Xc_xb @ Xx3))) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xx3) @ XR) @ (cco @ (ccop @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ cc1st)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ cc1st))) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XH @ cc1st)) @ Xc_x)))))))))))))))))))))))))))).
