...
thf(adf_st_ax,axiom,(cwceq @ ccst @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ cchil @ (ccv @ Xf1)) @ cc1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cchj) @ (ccv @ Xf1)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ ccaddc)))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))) @ (^ [Xf1:$i] : (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ ccch @ ccmap))))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(cisst_conj,conjecture,(! [XS:($i > $o)] : (cwb @ (cwcel @ XS @ ccst) @ (cw3a @ (cwf @ ccch @ (cco @ ccc0 @ cc1 @ ccicc) @ XS) @ (cwceq @ (ccfv @ cchil @ XS) @ cc1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cchj) @ XS) @ (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccaddc)))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))))).
