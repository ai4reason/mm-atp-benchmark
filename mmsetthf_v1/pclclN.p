...
thf(cpclclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwcel @ XK @ XV) @ (cwss @ XX @ XA2)) @ (cwcel @ (ccfv @ XX @ XU) @ XS)))))))))))).
