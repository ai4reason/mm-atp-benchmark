...
thf(asub2times_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XA2 @ (cco @ cc2 @ XA2 @ ccmul) @ ccmin) @ (ccneg @ XA2))))).
...
thf(ccosnegpi_conj,conjecture,(cwceq @ (ccfv @ (ccneg @ ccpi) @ cccos) @ (ccneg @ cc1))).
