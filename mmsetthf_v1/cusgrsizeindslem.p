...
thf(acusgrcplgr_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ cccusgr) @ (cwcel @ XG @ cccplgr)))).
thf(ccuvtx_tp,type,(ccuvtx : ($i > $o))).
thf(anbcplgr_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ cccplgr) @ (cwcel @ XN @ XV)) @ (cwceq @ (cco @ XG @ XN @ ccnbgr) @ (ccdif @ XV @ (ccsn @ XN))))))))).
...
thf(anbusgr_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwceq @ (cco @ XG @ XN @ ccnbgr) @ (ccrab @ (^ [Xn:$i] : (cwcel @ (ccpr @ XN @ (ccv @ Xn)) @ XE)) @ (^ [Xn:$i] : XV))))))))))).
...
thf(ahasheqf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash)) @ (cwex @ (^ [Xf1:$i] : (cwf1o @ XA2 @ XB2 @ (ccv @ Xf1))))))))).
...
thf(ccusgrsizeindslem_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ XV)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)))))))))).
