...
thf(cfprodsplitf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ XU @ (ccun @ XA2 @ XB2)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XU @ ccfn))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XU)) @ (cwcel @ (XC @ Xk) @ ccc))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccprod @ (^ [Xk:$i] : XU) @ (^ [Xk:$i] : (XC @ Xk))) @ (cco @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk))) @ ccmul))))))))))))))).
