...
thf(aunirnmap_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwss @ XX @ (cco @ XB2 @ XA2 @ ccmap))) => (cwi @ Xph @ (cwss @ XX @ (cco @ (ccrn @ (ccuni @ XX)) @ XA2 @ ccmap))))))))))).
...
thf(afsneq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwceq @ XB2 @ (ccsn @ XA2)) => ((cwi @ Xph @ (cwfn @ XF @ XB2)) => ((cwi @ Xph @ (cwfn @ XG @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XF @ XG) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG))))))))))))))).
...
thf(cunirnmapsn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwceq @ XC @ (ccsn @ XA2)) => ((cwi @ Xph @ (cwss @ XX @ (cco @ XB2 @ XC @ ccmap))) => (cwi @ Xph @ (cwceq @ XX @ (cco @ (ccrn @ (ccuni @ XX)) @ XC @ ccmap))))))))))))))).
