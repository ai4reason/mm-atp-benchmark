...
thf(aax_hvass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccva) @ XC @ ccva) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccva) @ ccva))))))).
...
thf(chvaddsubass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccva) @ XC @ ccmv) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmv) @ ccva))))))).
