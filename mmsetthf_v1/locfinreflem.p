...
thf(areff_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccref) @ (cwa @ (cwss @ (ccuni @ XB2) @ (ccuni @ XA2)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XA2 @ XB2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xv:$i] : (cwss @ (ccv @ Xv) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xf1)))) @ (^ [Xv:$i] : XA2)))))))))))).
...
thf(areximd2a_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (Xps @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (Xps @ Xx3)) @ (Xch @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))))))).
...
thf(arabfodom_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (cwb @ (Xch @ Xy1) @ (Xps @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwfo @ XA2 @ XB2 @ XF)) => (cwi @ Xph @ (cwbr @ (ccrab @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XB2)) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccdom))))))))))))).
...
thf(auniinn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwne @ (ccin @ (ccuni @ XA2) @ XB2) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccin @ (ccv @ Xx3) @ XB2) @ cc0)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(afimarab_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwa @ (cwf @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XF) @ (cwss @ XX @ (XA2 @ Xx3))) @ (cwceq @ (ccima @ XF @ XX) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xy1))) @ (^ [Xx3:$i] : XX))) @ (^ [Xy1:$i] : (XB2 @ Xx3))))))))))).
...
thf(clocfinreflem_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XX @ Xf1) @ (ccuni @ XJ))) => ((cwi @ Xph @ (cwss @ XU @ XJ)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwceq @ (XX @ Xf1) @ (ccuni @ XU)))) => ((cwi @ Xph @ (cwss @ XV @ XJ)) => ((cwi @ Xph @ (cwbr @ XV @ XU @ ccref)) => ((cwi @ Xph @ (cwcel @ XV @ (ccfv @ XJ @ cclocfin))) => (cwi @ Xph @ (cwex @ (^ [Xf1:$i] : (cwa @ (cw3a @ (cwfun @ (ccv @ Xf1)) @ (cwss @ (ccdm @ (ccv @ Xf1)) @ XU) @ (cwss @ (ccrn @ (ccv @ Xf1)) @ XJ)) @ (cwa @ (cwbr @ (ccrn @ (ccv @ Xf1)) @ XU @ ccref) @ (cwcel @ (ccrn @ (ccv @ Xf1)) @ (ccfv @ XJ @ cclocfin))))))))))))))))))).
