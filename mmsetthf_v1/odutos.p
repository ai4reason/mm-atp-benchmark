...
thf(aodupos_thm,axiom,(! [XD:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XD @ (ccfv @ XO @ ccodu)) => (cwi @ (cwcel @ XO @ ccpo) @ (cwcel @ XD @ ccpo)))))).
...
thf(atleile_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => (cwi @ (cw3a @ (cwcel @ XK @ cctos) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwo @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XY @ XX @ Xc_le))))))))))).
...
thf(codutos_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XD @ (ccfv @ XK @ ccodu)) => (cwi @ (cwcel @ XK @ cctos) @ (cwcel @ XD @ cctos)))))).
