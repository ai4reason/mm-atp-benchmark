...
thf(clpolvN_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XP @ (ccfv @ XW @ cclpoN)) => ((cwi @ Xph @ (cwcel @ XW @ XX)) => ((cwi @ Xph @ (cwcel @ Xc_pe @ XP)) => (cwi @ Xph @ (cwceq @ (ccfv @ XV @ Xc_pe) @ (ccsn @ Xc_0)))))))))))))))).
