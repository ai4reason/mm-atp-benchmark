...
thf(ci1fadd_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ (ccdm @ ccitg1))))))))).
