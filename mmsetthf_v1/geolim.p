...
thf(cgeolim_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp)))) => (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ XF @ ccc0) @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccli))))))))).
