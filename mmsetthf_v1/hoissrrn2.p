...
thf(choissrrn2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwcel @ (XA2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwcel @ (XB2 @ Xk) @ ccxr))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccico))) @ (cco @ ccr @ XX @ ccmap)))))))))))).
