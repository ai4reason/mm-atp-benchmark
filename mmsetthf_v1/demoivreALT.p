...
thf(cdemoivreALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ (cco @ (ccfv @ XA2 @ cccos) @ (cco @ cci @ (ccfv @ XA2 @ ccsin) @ ccmul) @ ccaddc) @ XN @ ccexp) @ (cco @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ cccos) @ (cco @ cci @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ ccsin) @ ccmul) @ ccaddc)))))).
