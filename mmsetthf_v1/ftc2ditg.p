...
thf(aftc2ditglem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XY @ ccr)) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XX @ XY @ ccicc))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XX @ XY @ ccicc))) => ((cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ (cco @ XX @ XY @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ ccibl)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XX @ XY @ ccicc) @ ccc @ cccncf))) => (cwi @ (cwa @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwceq @ (ccdit @ (^ [Xt:$i] : XA2) @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)))) @ (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin))))))))))))))))).
...
thf(cftc2ditg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XY @ ccr)) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XX @ XY @ ccicc))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XX @ XY @ ccicc))) => ((cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ (cco @ XX @ XY @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ ccibl)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XX @ XY @ ccicc) @ ccc @ cccncf))) => (cwi @ Xph @ (cwceq @ (ccdit @ (^ [Xt:$i] : XA2) @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)))) @ (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin))))))))))))))))).
