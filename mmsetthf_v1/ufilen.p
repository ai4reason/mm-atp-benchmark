...
thf(acsdfil_thm,axiom,(! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XX @ ccdom)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccdif @ XX @ (ccv @ Xx3)) @ XX @ ccsdm)) @ (^ [Xx3:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccfil))))).
...
thf(cufilen_conj,conjecture,(! [XX:($i > $o)] : (cwi @ (cwbr @ ccom @ XX @ ccdom) @ (cwrex @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XX @ ccen)) @ (^ [Xx3:$i] : (ccv @ Xf1)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil)))))).
