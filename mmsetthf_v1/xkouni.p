...
thf(arest0_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (cco @ XJ @ cc0 @ ccrest) @ (ccsn @ cc0))))).
...
thf(afiuni_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (ccuni @ XA2) @ (ccuni @ (ccfv @ XA2 @ ccfi))))))).
...
thf(cxkouni_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (cco @ XS @ XR @ ccxko)) => (cwi @ (cwa @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ cctop)) @ (cwceq @ (cco @ XR @ XS @ cccn) @ (ccuni @ XJ)))))))).
