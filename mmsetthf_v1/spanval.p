...
thf(adf_span_ax,axiom,(cwceq @ ccspn @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ cchil)) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : ccsh))))))).
thf(cspanval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ cchil) @ (cwceq @ (ccfv @ XA2 @ ccspn) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : ccsh))))))).
