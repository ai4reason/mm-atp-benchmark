...
thf(celsetrecslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XB2 @ (ccsetrecs @ XF)) => (cwi @ (cwcel @ XA2 @ XB2) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ XF))))))))))).
