...
thf(celrnmpt1s_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XD) @ (cwceq @ (XB2 @ Xx3) @ XC))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XD @ XA2) @ (cwcel @ XC @ (XV @ Xx3))) @ (cwcel @ XC @ (ccrn @ (XF @ Xx3)))))))))))))).
