...
thf(cpf1mulcl_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XQ @ (ccrn @ (ccfv @ XR @ cce1))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cwa @ (cwcel @ XF @ XQ) @ (cwcel @ XG @ XQ)) @ (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_x)) @ XQ)))))))))).
