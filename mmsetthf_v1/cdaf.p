...
thf(adf_coda_ax,axiom,(cwceq @ cccoda @ (cccom @ cc2nd @ cc1st))).
...
thf(aarwcd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => (cwi @ (cwcel @ XF @ XA2) @ (cwcel @ (ccfv @ XF @ cccoda) @ XB2))))))))).
...
thf(ccdaf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => (cwf @ XA2 @ XB2 @ (ccres @ cccoda @ XA2)))))))).
