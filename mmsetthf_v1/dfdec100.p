...
thf(cdfdec100_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccr) => (cwceq @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ (cco @ (cco @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ XA2 @ ccmul) @ (ccdc @ XB2 @ XC) @ ccaddc))))))))).
