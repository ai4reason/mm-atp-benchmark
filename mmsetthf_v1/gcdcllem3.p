...
thf(agcdcllem1_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xy1 @ Xz @ Xn) @ (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xn:$i] : XA2))) @ (^ [Xz:$i] : ccz)))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwss @ XA2 @ ccz) @ (cwrex @ (^ [Xn:$i] : (cwne @ (ccv @ Xn) @ ccc0)) @ (^ [Xn:$i] : XA2))) @ (cwa @ (cwne @ (XS @ Xy1 @ Xz @ Xn) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XS @ Xy1 @ Xz @ Xn)))) @ (^ [Xx3:$i] : ccz))))))))))).
thf(agcdcllem2_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xz @ Xn) @ (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xn:$i] : (ccpr @ XM @ XN)))) @ (^ [Xz:$i] : ccz))))) => ((! [Xz:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xz @ Xn) @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xz) @ XM @ ccdvds) @ (cwbr @ (ccv @ Xz) @ XN @ ccdvds))) @ (^ [Xz:$i] : ccz))))) => (! [Xz:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (XR @ Xz @ Xn) @ (XS @ Xz @ Xn)))))))))))).
...
thf(asuprzcl2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccz) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccz))) @ (cwcel @ (ccsup @ XA2 @ ccr @ cclt) @ XA2)))).
