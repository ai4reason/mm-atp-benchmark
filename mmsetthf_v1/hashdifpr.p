...
thf(chashdifpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cw3a @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2) @ (cwne @ XB2 @ XC))) @ (cwceq @ (ccfv @ (ccdif @ XA2 @ (ccpr @ XB2 @ XC)) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ cc2 @ ccmin))))))).
