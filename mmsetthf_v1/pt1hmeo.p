...
thf(afsnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => (cwi @ Xph @ (cwf @ (ccsn @ XA2) @ XW @ (ccsn @ (ccop @ XA2 @ XB2)))))))))))).
...
thf(afsn2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwf @ (ccsn @ XA2) @ XB2 @ XF) @ (cwa @ (cwcel @ (ccfv @ XA2 @ XF) @ XB2) @ (cwceq @ XF @ (ccsn @ (ccop @ XA2 @ (ccfv @ XA2 @ XF)))))))))))).
...
thf(cpt1hmeo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ (ccsn @ (ccop @ XA2 @ XJ)) @ ccpt)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XA2 @ (ccv @ Xx3))))) @ (cco @ XJ @ XK @ cchmeo))))))))))))).
