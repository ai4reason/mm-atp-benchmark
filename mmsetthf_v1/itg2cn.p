...
thf(aitg2cnlem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => (cwi @ Xph @ (cwceq @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xn) @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2)))) @ ccxr @ cclt) @ (ccfv @ XF @ ccitg2))))))))).
...
thf(aitg2cnlem2_thm,axiom,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XF @ ccmbf))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ (ccfv @ XF @ ccitg2) @ ccr))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XC @ ccrp))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XM @ ccn))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwn @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XM @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2) @ (cco @ (ccfv @ XF @ ccitg2) @ (cco @ XC @ cc2 @ ccdiv) @ ccmin) @ ccle)))) => (! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xu:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2) @ XC @ cclt))) @ (^ [Xu:$i] : (ccdm @ ccvol)))) @ (^ [Xd:$i] : ccrp))))))))))))))).
...
thf(citg2cn_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XF @ ccmbf))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ (ccfv @ XF @ ccitg2) @ ccr))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XC @ ccrp))) => (! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xu:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2) @ XC @ cclt))) @ (^ [Xu:$i] : (ccdm @ ccvol)))) @ (^ [Xd:$i] : ccrp)))))))))))).
