...
thf(c_0lno_conj,conjecture,(! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (cco @ XU @ XW @ cc0o)) => ((cwceq @ XL @ (cco @ XU @ XW @ cclno)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv)) @ (cwcel @ XZ @ XL))))))))).
