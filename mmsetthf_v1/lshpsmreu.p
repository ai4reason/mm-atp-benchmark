...
thf(alshpne0_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XH @ (ccfv @ XW @ cclsh)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XU @ XH)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwceq @ (cco @ XU @ (ccfv @ (ccsn @ XX) @ XN) @ Xc_po) @ XV)) => (cwi @ Xph @ (cwne @ XX @ Xc_0))))))))))))))))))))).
