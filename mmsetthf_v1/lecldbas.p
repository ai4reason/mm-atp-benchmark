...
thf(aleordtval2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioc)))))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ ccmnf @ (ccv @ Xx3) @ ccico)))))) => (! [Xx3:$i] : (cwceq @ (ccfv @ ccle @ ccordt) @ (ccfv @ (ccfv @ (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ ccfi) @ cctg)))))))).
...
thf(atgss_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ XV) @ (cwss @ XB2 @ XC)) @ (cwss @ (ccfv @ XB2 @ cctg) @ (ccfv @ XC @ cctg))))))).
...
thf(clecldbas_conj,conjecture,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccicc)) @ (^ [Xx3:$i] : (ccdif @ ccxr @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwceq @ (ccfv @ ccle @ ccordt) @ (ccfv @ (ccfv @ (ccrn @ (XF @ Xx3)) @ ccfi) @ cctg)))))).
