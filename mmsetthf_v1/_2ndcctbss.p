...
thf(aaxcc4dom_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xx3 @ Xn) @ (Xps @ Xf1 @ Xn)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwbr @ (XN @ Xx3) @ ccom @ ccdom) @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xn)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xn:$i] : (XN @ Xx3)))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (XN @ Xx3) @ XA2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xn:$i] : (Xps @ Xf1 @ Xn)) @ (^ [Xn:$i] : (XN @ Xx3))))))))))))))).
...
thf(a_2ndctop_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cc2ndc) @ (cwcel @ XJ @ cctop)))).
...
thf(abasgen2_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XB2 @ XJ) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ))) @ (cwceq @ (ccfv @ XB2 @ cctg) @ XJ))))).
...
thf(c_2ndcctbss_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XX @ Xw @ Xv @ Xu @ Xb @ Xc) @ (ccuni @ XB2))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XJ @ Xw @ Xv @ Xu) @ (ccfv @ XB2 @ cctg))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XS @ Xw @ Xv @ Xu @ Xb @ Xc) @ (ccopab @ (^ [Xu:$i] : (^ [Xv:$i] : (cw3a @ (cwcel @ (ccv @ Xu) @ (ccv @ Xc)) @ (cwcel @ (ccv @ Xv) @ (ccv @ Xc)) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwss @ (ccv @ Xu) @ (ccv @ Xw)) @ (cwss @ (ccv @ Xw) @ (ccv @ Xv)))) @ (^ [Xw:$i] : XB2)))))))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ cctb) @ (cwcel @ (XJ @ Xw @ Xv @ Xu) @ cc2ndc)) @ (cwrex @ (^ [Xb:$i] : (cw3a @ (cwbr @ (ccv @ Xb) @ ccom @ ccdom) @ (cwss @ (ccv @ Xb) @ XB2) @ (cwceq @ (XJ @ Xw @ Xv @ Xu) @ (ccfv @ (ccv @ Xb) @ cctg)))) @ (^ [Xb:$i] : cctb)))))))))))))).
