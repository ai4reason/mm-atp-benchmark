...
thf(crmxfval_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ XN @ ccrmx) @ (ccfv @ (ccfv @ (cco @ (cco @ XA2 @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ ccaddc) @ XN @ ccexp) @ (cccnv @ (ccmpt @ (^ [Xb:$i] : (ccxp @ ccn0 @ ccz)) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xb) @ cc1st) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ (ccfv @ (ccv @ Xb) @ cc2nd) @ ccmul) @ ccaddc))))) @ cc1st)))))).
