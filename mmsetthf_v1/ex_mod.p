...
thf(aaddmodid_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XM @ ccn) @ (cwbr @ XA2 @ XM @ cclt)) @ (cwceq @ (cco @ (cco @ XM @ XA2 @ ccaddc) @ XM @ ccmo) @ XA2))))).
...
thf(cex_mod_conj,conjecture,(cwa @ (cwceq @ (cco @ cc5 @ cc3 @ ccmo) @ cc2) @ (cwceq @ (cco @ (ccneg @ cc7) @ cc2 @ ccmo) @ cc1))).
