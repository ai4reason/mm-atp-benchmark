...
thf(cmeaiininc_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XM @ ccmea))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccz))) => ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwf @ XZ @ (ccdm @ XM) @ XE))) => ((! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE) @ (ccfv @ (ccv @ Xn) @ XE)))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XK @ (ccfv @ (XN @ Xn) @ ccuz)))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (ccfv @ (ccfv @ XK @ XE) @ XM) @ ccr))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (XS @ Xn) @ (ccfv @ (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ ccli)))))))))))))))))))).
