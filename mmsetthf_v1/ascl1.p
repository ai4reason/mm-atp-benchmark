...
thf(cascl1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccascl)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XW @ ccrg)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XF @ ccur) @ XA2) @ (ccfv @ XW @ ccur)))))))))))).
