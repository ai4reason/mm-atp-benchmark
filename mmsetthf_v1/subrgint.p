...
thf(asubgint_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ (ccfv @ XG @ ccsubg)) @ (cwne @ XS @ cc0)) @ (cwcel @ (ccint @ XS) @ (ccfv @ XG @ ccsubg)))))).
...
thf(csubrgint_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ (ccfv @ XR @ ccsubrg)) @ (cwne @ XS @ cc0)) @ (cwcel @ (ccint @ XS) @ (ccfv @ XR @ ccsubrg)))))).
