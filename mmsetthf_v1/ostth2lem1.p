...
thf(costth2lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwbr @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (cco @ (ccv @ Xn) @ XB2 @ ccmul) @ ccle))) => (cwi @ Xph @ (cwbr @ XA2 @ cc1 @ ccle))))))))).
