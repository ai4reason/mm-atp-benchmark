...
thf(aclwwlknonclwlknonen_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XX @ (ccfv @ XG @ ccvtx)) @ (cwcel @ XN @ ccn)) @ (cwbr @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ XN) @ (cwceq @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xw) @ cc2nd)) @ XX))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ ccen)))))).
...
thf(awlksnfi_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) @ XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ ccfn))))).
thf(arabssrabd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((! [Xx3:$i] : (cwi @ (cw3a @ Xph @ (Xps @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (Xch @ Xx3))) => (cwi @ Xph @ (cwss @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))))))).
...
thf(aclwwlknon2num_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XX @ (ccfv @ XG @ ccvtx))) @ (cwceq @ (ccfv @ (cco @ XX @ cc2 @ (ccfv @ XG @ ccclwwlknon)) @ cchash) @ XK)))))).
thf(cclwlknon2num_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XV @ ccfn) @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ cc2) @ (cwceq @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xw) @ cc2nd)) @ XX))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ cchash) @ XK)))))))).
