...
thf(cindsum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XO:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ XO)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XO)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccsu @ XO @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) @ (XB2 @ Xx3) @ ccmul))) @ (ccsu @ XA2 @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))))).
