...
thf(abc0k_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccn) @ (cwceq @ (cco @ ccc0 @ XK @ ccbc) @ ccc0)))).
...
thf(cbccolsum_conj,conjecture,(! [XC:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XC @ ccn0)) @ (cwceq @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ XC @ ccbc))) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XC @ cc1 @ ccaddc) @ ccbc)))))).
