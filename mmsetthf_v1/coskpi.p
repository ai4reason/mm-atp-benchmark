...
thf(asqabs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp)) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs))))))).
thf(aabs1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccabs) @ cc1)).
thf(ccoskpi_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (ccfv @ (cco @ XK @ ccpi @ ccmul) @ cccos) @ ccabs) @ cc1)))).
