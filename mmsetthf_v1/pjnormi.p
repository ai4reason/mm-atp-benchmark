...
thf(apjorthi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwi @ (cwcel @ XH @ ccch) @ (cwceq @ (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) @ ccsp) @ ccc0)))))))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(ccexp_tp,type,(ccexp : ($i > $o))).
thf(cc2_tp,type,(cc2 : ($i > $o))).
thf(anormpyc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwi @ (cwceq @ (cco @ XA2 @ XB2 @ ccsp) @ ccc0) @ (cwbr @ (ccfv @ XA2 @ ccno) @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ ccle)))))).
...
thf(cpjnormi_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => (cwbr @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccno) @ (ccfv @ XA2 @ ccno) @ ccle)))))).
