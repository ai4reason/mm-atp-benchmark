...
thf(cbj_ssbjust_conj,conjecture,(! [Xph:($i > $o)] : (! [Xt:$i] : (cwb @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xt)) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3))))))) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccv @ Xt)) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)) @ (Xph @ Xx3))))))))))).
