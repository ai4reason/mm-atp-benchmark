...
thf(agrpplusfo_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XF @ (ccfv @ XG @ ccplusf)) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwfo @ (ccxp @ XB2 @ XB2) @ XB2 @ XF)))))))).
...
thf(cresgrpplusfrn_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => ((cwceq @ XF @ (ccfv @ XH @ ccplusf)) => (cwi @ (cwa @ (cwcel @ XH @ ccgrp) @ (cwss @ XS @ XB2)) @ (cwceq @ XS @ (ccrn @ XF)))))))))))).
