...
thf(ccoe1mul2lem2_conj,conjecture,(! [XH:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xd:$i] : (cwceq @ (XH @ Xk @ Xd) @ (ccrab @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (ccxp @ cc1o @ (ccsn @ (ccv @ Xk))) @ (ccofr @ ccle))) @ (^ [Xd:$i] : (cco @ ccn0 @ cc1o @ ccmap)))))) => (! [Xk:$i] : (! [Xd:$i] : (cwi @ (cwcel @ (ccv @ Xk) @ ccn0) @ (cwf1o @ (XH @ Xk @ Xd) @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (ccmpt @ (^ [Xc:$i] : (XH @ Xk @ Xd)) @ (^ [Xc:$i] : (ccfv @ cc0 @ (ccv @ Xc))))))))))).
