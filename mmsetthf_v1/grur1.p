...
thf(arankcf_thm,axiom,(! [XA2:($i > $o)] : (cwn @ (cwbr @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccrnk) @ cccf) @ ccsdm)))).
...
thf(agrur1a_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XA2 @ (ccin @ XU @ ccon0)) => (cwi @ (cwcel @ XU @ ccgru) @ (cwss @ (ccfv @ XA2 @ ccr1) @ XU)))))).
thf(cgrur1_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XA2 @ (ccin @ XU @ ccon0)) => (cwi @ (cwa @ (cwcel @ XU @ ccgru) @ (cwcel @ XU @ (ccuni @ (ccima @ ccr1 @ ccon0)))) @ (cwceq @ XU @ (ccfv @ XA2 @ ccr1))))))).
