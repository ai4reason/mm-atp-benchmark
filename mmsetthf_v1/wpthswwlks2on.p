...
thf(awlklnwwlknupgr_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XG @ ccupgr) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ XN)))) @ (cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn)))))))).
...
thf(ausgr2wlkspth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccfv @ XF @ cchash) @ cc2) @ (cwne @ XA2 @ XB2)) @ (cwb @ (cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccwlkson))) @ (cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson))))))))))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(ccmpt2_tp,type,(ccmpt2 : (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > ($i > $o)))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(aiswspthsnon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwceq @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwspthsnon)) @ (ccrab @ (^ [Xw:$i] : (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xw) @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson)))))) @ (^ [Xw:$i] : (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon)))))))))))).
thf(ccwwlks_tp,type,(ccwwlks : ($i > $o))).
thf(aiswwlksnon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwceq @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon)) @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XA2) @ (cwceq @ (ccfv @ XN @ (ccv @ Xw)) @ XB2))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))))))))).
thf(cwpthswwlks2on_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwne @ XA2 @ XB2)) @ (cwceq @ (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwspthsnon)) @ (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)))))))).
