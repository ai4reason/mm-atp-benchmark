...
thf(arrxmet_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : (cwceq @ (XD @ Xh) @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => (! [Xh:$i] : (cwi @ (cwcel @ XI @ XV) @ (cwcel @ (XD @ Xh) @ (ccfv @ (XX @ Xh) @ ccme))))))))))).
...
thf(crrxmetfi_conj,conjecture,(! [XD:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XD @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds)) => (cwi @ (cwcel @ XI @ ccfn) @ (cwcel @ XD @ (ccfv @ (cco @ ccr @ XI @ ccmap) @ ccme))))))).
