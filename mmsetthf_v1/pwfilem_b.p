...
thf(apwundif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccpw @ (ccun @ XA2 @ XB2)) @ (ccun @ (ccdif @ (ccpw @ (ccun @ XA2 @ XB2)) @ (ccpw @ XA2)) @ (ccpw @ XA2)))))).
...
thf(afodomfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwfo @ XA2 @ XB2 @ XF)) @ (cwbr @ XB2 @ XA2 @ ccdom)))))).
...
thf(aelpwun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => (cwb @ (cwcel @ XA2 @ (ccpw @ (ccun @ XB2 @ XC))) @ (cwcel @ (ccdif @ XA2 @ XC) @ (ccpw @ XB2)))))))).
...
thf(cpwfilem_b_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xc:$i] : (cwceq @ (XF @ Xx3 @ Xc) @ (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3)))))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccpw @ (ccv @ Xx3)) @ ccfn) @ (cwcel @ (ccpw @ (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xx3)))) @ ccfn)))))).
