...
thf(cmpfconst_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XQ @ (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => ((cwi @ Xph @ (cwcel @ XI @ XV)) => ((cwi @ Xph @ (cwcel @ XS @ cccrg)) => ((cwi @ Xph @ (cwcel @ XR @ (ccfv @ XS @ ccsubrg))) => ((cwi @ Xph @ (cwcel @ XX @ XR)) => (cwi @ Xph @ (cwcel @ (ccxp @ (cco @ XB2 @ XI @ ccmap) @ (ccsn @ XX)) @ XQ))))))))))))))))).
