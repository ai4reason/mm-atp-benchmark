...
thf(acjne0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwne @ XA2 @ ccc0) @ (cwne @ (ccfv @ XA2 @ cccj) @ ccc0))))).
...
thf(clogcj_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccim) @ ccc0)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cccj) @ cclog) @ (ccfv @ (ccfv @ XA2 @ cclog) @ cccj))))).
