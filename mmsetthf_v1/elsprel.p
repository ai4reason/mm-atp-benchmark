...
thf(aprprc1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccsn @ XB2)))))).
...
thf(celsprel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwo @ (cwcel @ XA2 @ (XV @ Xp @ Xa @ Xb)) @ (cwcel @ XB2 @ (XW @ Xp @ Xa @ Xb))) @ (cwcel @ (ccpr @ XA2 @ XB2) @ (ccab @ (^ [Xp:$i] : (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xp) @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))))))))))).
