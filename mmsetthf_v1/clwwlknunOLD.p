...
thf(ausgrpredgv_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ (ccpr @ XM @ XN) @ XE)) @ (cwa @ (cwcel @ XM @ XV) @ (cwcel @ XN @ XV))))))))))).
...
thf(cclwwlknunOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XN @ XG @ ccclwwlkn) @ (cciun @ (^ [Xx3:$i] : (XV @ Xw)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xx3))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn))))))))))))).
