...
thf(adf_clwwlknOLD_ax,axiom,(cwceq @ ccclwwlknold @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xg1:$i] : ccn)) @ (^ [Xn:$i] : (^ [Xg1:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xg1:$i] : (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ (ccv @ Xn))) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xg1) @ ccclwwlk)))))))).
...
thf(cclwwlknOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ XN @ XG @ ccclwwlknold) @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwwlk)))))))).
