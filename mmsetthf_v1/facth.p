...
thf(aplyrem_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => ((cwceq @ XR @ (cco @ XF @ (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)) @ (ccof @ ccmin))) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XA2 @ ccc)) @ (cwceq @ XR @ (ccxp @ ccc @ (ccsn @ (ccfv @ XA2 @ XF))))))))))))).
...
thf(cfacth_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ XF) @ ccc0)) @ (cwceq @ XF @ (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)))))))))).
