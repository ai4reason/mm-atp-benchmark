...
thf(anlfnval_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ ccc @ XT) @ (cwceq @ (ccfv @ XT @ ccnl) @ (ccima @ (cccnv @ XT) @ (ccsn @ ccc0)))))).
...
thf(aissh3_thm,axiom,(! [XH:($i > $o)] : (cwi @ (cwss @ XH @ cchil) @ (cwb @ (cwcel @ XH @ ccsh) @ (cwa @ (cwcel @ cc0v @ XH) @ (cwa @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : XH)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsm) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : ccc)))))))).
