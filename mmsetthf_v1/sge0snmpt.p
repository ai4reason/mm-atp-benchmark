...
thf(csge0snmpt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XA2) @ (cwceq @ (XB2 @ Xk) @ XC))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ XC))))))))))).
