...
thf(asmfresal_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((cwceq @ XD @ (ccdm @ XF)) => ((! [Xe:$i] : (cwceq @ (XT @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xe)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xe:$i] : (ccpw @ ccr))))) => (! [Xe:$i] : (cwi @ Xph @ (cwcel @ (XT @ Xe) @ ccsalg))))))))))))).
...
thf(asmfpimbor1lem1_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((cwceq @ XD @ (ccdm @ XF)) => ((! [Xe:$i] : (cwceq @ (XJ @ Xe) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xe:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xe) @ (XJ @ Xe)))) => ((! [Xe:$i] : (cwceq @ (XT @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xe)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xe:$i] : (ccpw @ ccr))))) => (! [Xe:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xe) @ (XT @ Xe)))))))))))))))))).
