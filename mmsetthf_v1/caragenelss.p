...
thf(ccaragenelss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => (cwi @ Xph @ (cwss @ XA2 @ XX)))))))))))).
