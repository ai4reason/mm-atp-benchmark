...
thf(afun11iun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xy1))))) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwf1 @ (XD @ Xx3 @ Xy1) @ (XS @ Xy1) @ (XB2 @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwo @ (cwss @ (XB2 @ Xx3) @ (XC @ Xy1)) @ (cwss @ (XC @ Xy1) @ (XB2 @ Xx3)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)) @ (cwf1 @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1))) @ (XS @ Xy1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
...
thf(aackbij2lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : (ccpw @ (ccdm @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccfv @ (ccima @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)))))) => (cwi @ (cwcel @ XA2 @ ccom) @ (cwf1o @ (ccfv @ XA2 @ ccr1) @ (ccfv @ (ccfv @ XA2 @ ccr1) @ cccrd) @ (ccfv @ XA2 @ (ccrdg @ XG @ cc0)))))))))).
...
thf(ar1fin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccom) @ (cwcel @ (ccfv @ XA2 @ ccr1) @ ccfn)))).
...
thf(arnuni_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccrn @ (ccuni @ XA2)) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xx3))))))).
...
thf(acarddom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd))) @ (cwb @ (cwss @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) @ (cwbr @ XA2 @ XB2 @ ccdom)))))).
...
thf(cackbij2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : (ccpw @ (ccdm @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccfv @ (ccima @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)))))) => ((cwceq @ XH @ (ccuni @ (ccima @ (ccrdg @ XG @ cc0) @ ccom))) => (cwf1o @ (ccuni @ (ccima @ ccr1 @ ccom)) @ ccom @ XH)))))))).
