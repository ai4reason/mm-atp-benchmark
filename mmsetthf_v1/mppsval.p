...
thf(adf_mpps_ax,axiom,(cwceq @ ccmpps @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccoprab @ (^ [Xd:$i] : (^ [Xh:$i] : (^ [Xa:$i] : (cwa @ (cwcel @ (ccotp @ (ccv @ Xd) @ (ccv @ Xh) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xt) @ ccmpst)) @ (cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xd) @ (ccv @ Xh) @ (ccfv @ (ccv @ Xt) @ ccmcls)))))))))))).
...
thf(cmppsval_conj,conjecture,(! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => ((! [Xh:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwceq @ (XJ @ Xh @ Xa @ Xd) @ (ccfv @ XT @ ccmpps))))) => ((cwceq @ XC @ (ccfv @ XT @ ccmcls)) => (! [Xh:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwceq @ (XJ @ Xh @ Xa @ Xd) @ (ccoprab @ (^ [Xd:$i] : (^ [Xh:$i] : (^ [Xa:$i] : (cwa @ (cwcel @ (ccotp @ (ccv @ Xd) @ (ccv @ Xh) @ (ccv @ Xa)) @ XP) @ (cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xd) @ (ccv @ Xh) @ XC))))))))))))))))))).
