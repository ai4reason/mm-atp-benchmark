...
thf(adfur2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > ($i > $o)))] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (! [Xe:$i] : (cwceq @ (Xc_x @ Xx3 @ Xe) @ (ccfv @ XR @ ccmulr)))) => ((! [Xx3:$i] : (! [Xe:$i] : (cwceq @ (Xc_1 @ Xx3 @ Xe) @ (ccfv @ XR @ ccur)))) => (! [Xx3:$i] : (! [Xe:$i] : (cwceq @ (Xc_1 @ Xx3 @ Xe) @ (ccio @ (^ [Xe:$i] : (cwa @ (cwcel @ (ccv @ Xe) @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xe) @ (ccv @ Xx3) @ (Xc_x @ Xx3 @ Xe)) @ (ccv @ Xx3)) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xe) @ (Xc_x @ Xx3 @ Xe)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XB2)))))))))))))))).
...
thf(crngurd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwceq @ Xc_x @ (ccfv @ XR @ ccmulr))) => ((cwi @ Xph @ (cwcel @ Xc_1 @ XB2)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (cco @ Xc_1 @ (ccv @ Xx3) @ Xc_x) @ (ccv @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (cco @ (ccv @ Xx3) @ Xc_1 @ Xc_x) @ (ccv @ Xx3)))) => (cwi @ Xph @ (cwceq @ Xc_1 @ (ccfv @ XR @ ccur)))))))))))))).
