...
thf(aisnghm2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => (cwi @ (cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) @ (cwcel @ (ccfv @ XF @ XN) @ ccr))))))))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccico_tp,type,(ccico : ($i > $o))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(anmoi_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) @ (cwcel @ XX @ XV)) @ (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XM) @ (cco @ (ccfv @ XF @ XN) @ (ccfv @ XX @ XL) @ ccmul) @ ccle))))))))))))))).
