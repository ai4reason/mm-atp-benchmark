...
thf(afuncsetcestrclem3_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccfv @ (XU @ Xx3) @ ccsetc))) => ((! [Xx3:$i] : (cwceq @ XC @ (ccfv @ (XS @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccv @ Xx3)))))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XU @ Xx3) @ ccwun))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ ccom @ (XU @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ (XU @ Xx3) @ ccestrc))) => ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XE @ Xx3) @ ccbs))) => (! [Xx3:$i] : (cwi @ Xph @ (cwf @ XC @ XB2 @ (XF @ Xx3))))))))))))))))))).
...
thf(cembedsetcestrclem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccfv @ (XU @ Xx3) @ ccsetc))) => ((! [Xx3:$i] : (cwceq @ XC @ (ccfv @ (XS @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccv @ Xx3)))))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XU @ Xx3) @ ccwun))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ ccom @ (XU @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ (XU @ Xx3) @ ccestrc))) => ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XE @ Xx3) @ ccbs))) => (! [Xx3:$i] : (cwi @ Xph @ (cwf1 @ XC @ XB2 @ (XF @ Xx3))))))))))))))))))).
