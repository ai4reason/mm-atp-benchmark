...
thf(arncmp_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cccmp) @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) @ (cwcel @ (cco @ XK @ (ccrn @ XF) @ ccrest) @ cccmp)))))).
...
thf(cbndth_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((cwi @ Xph @ (cwcel @ XJ @ cccmp)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ (XK @ Xx3) @ cccn)))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))))))))).
