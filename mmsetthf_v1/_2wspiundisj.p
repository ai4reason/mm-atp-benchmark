...
thf(adisjiund_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (cwceq @ (ccv @ Xa) @ (ccv @ Xc)) @ (cwceq @ (XA2 @ Xa @ Xb) @ (XC @ Xb @ Xc)))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (cwceq @ (ccv @ Xb) @ (ccv @ Xd)) @ (cwceq @ (XC @ Xb @ Xc) @ (XD @ Xx3 @ Xa @ Xc @ Xd)))))))) => ((! [Xa:$i] : (! [Xc:$i] : (cwi @ (cwceq @ (ccv @ Xa) @ (ccv @ Xc)) @ (cwceq @ (XW @ Xa) @ (XX @ Xc))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xa @ Xb)) @ (cwcel @ (ccv @ Xx3) @ (XD @ Xx3 @ Xa @ Xc @ Xd))) @ (cwceq @ (ccv @ Xa) @ (ccv @ Xc)))))))) => (! [Xx3:$i] : (! [Xb:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwdisj @ (^ [Xa:$i] : (XV @ Xx3 @ Xb @ Xd)) @ (^ [Xa:$i] : (cciun @ (^ [Xb:$i] : (XW @ Xa)) @ (^ [Xb:$i] : (XA2 @ Xa @ Xb))))))))))))))))))))).
