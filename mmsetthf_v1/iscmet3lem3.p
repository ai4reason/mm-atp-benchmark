...
thf(ciscmet3lem3_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XR @ ccrp)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccv @ Xk) @ ccexp) @ XR @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))).
