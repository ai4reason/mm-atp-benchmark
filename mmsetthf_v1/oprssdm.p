...
thf(coprssdm_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwn @ (cwcel @ cc0 @ XS)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XS)))) => (cwss @ (ccxp @ XS @ XS) @ (ccdm @ XF))))))).
