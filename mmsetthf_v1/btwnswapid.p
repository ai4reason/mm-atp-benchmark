...
thf(cbtwnswapid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) @ (cwi @ (cwa @ (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn)) @ (cwceq @ XA2 @ XB2)))))))).
