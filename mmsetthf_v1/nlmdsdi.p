...
thf(anmvs_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ XA2 @ (ccfv @ XF @ ccnm)) => (cwi @ (cw3a @ (cwcel @ XW @ ccnlm) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XV)) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_x) @ XN) @ (cco @ (ccfv @ XX @ XA2) @ (ccfv @ XY @ XN) @ ccmul))))))))))))))))))).
...
thf(cnlmdsdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccds)) => ((cwceq @ XA2 @ (ccfv @ XF @ ccnm)) => (cwi @ (cwa @ (cwcel @ XW @ ccnlm) @ (cw3a @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XV) @ (cwcel @ XZ @ XV))) @ (cwceq @ (cco @ (ccfv @ XX @ XA2) @ (cco @ XY @ XZ @ XD) @ ccmul) @ (cco @ (cco @ XX @ XY @ Xc_x) @ (cco @ XX @ XZ @ Xc_x) @ XD)))))))))))))))))))).
