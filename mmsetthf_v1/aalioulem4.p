...
thf(aaalioulem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xr:$i] : (cwceq @ (XN @ Xx3 @ Xr) @ (ccfv @ XF @ ccdgr)))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xx3:$i] : (! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3 @ Xr) @ ccn)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ ccc0)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xr:$i] : (cwi @ (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xr) @ ccmin) @ ccabs) @ cc1 @ ccle) @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xr) @ XF) @ ccabs) @ ccmul) @ (ccfv @ (cco @ XA2 @ (ccv @ Xr) @ ccmin) @ ccabs) @ ccle))) @ (^ [Xr:$i] : ccr))) @ (^ [Xx3:$i] : ccrp))))))))))))).
...
thf(aaalioulem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((cwi @ Xph @ (cwcel @ XX @ ccz)) => ((cwi @ Xph @ (cwcel @ XY @ ccn)) => (cwi @ Xph @ (cwcel @ (cco @ (ccfv @ (cco @ XX @ XY @ ccdiv) @ XF) @ (cco @ XY @ (ccfv @ XF @ ccdgr) @ ccexp) @ ccmul) @ ccz)))))))))).
...
thf(caalioulem4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xx3 @ Xq @ Xp) @ (ccfv @ XF @ ccdgr))))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xx3:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3 @ Xq @ Xp) @ ccn))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ ccc0)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : (cwi @ (cwa @ (cwne @ (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ XF) @ ccc0) @ (cwbr @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ cc1 @ ccle)) @ (cwo @ (cwceq @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) @ (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (XN @ Xx3 @ Xq @ Xp) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ ccle)))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))))))).
