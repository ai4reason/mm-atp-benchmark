...
thf(aclssubg_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwi @ (cwa @ (cwcel @ XG @ cctgp) @ (cwcel @ XS @ (ccfv @ XG @ ccsubg))) @ (cwcel @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XG @ ccsubg)))))))).
...
thf(atsmssub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctgp)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XH)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XG @ XF @ cctsu))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XG @ XH @ cctsu))) => (cwi @ Xph @ (cwcel @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XG @ (cco @ XF @ XH @ (ccof @ Xc_mi)) @ cctsu))))))))))))))))))))))).
...
thf(atsmsgsum_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctps)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ cctsu) @ (ccfv @ (ccsn @ (cco @ XG @ XF @ ccgsu)) @ (ccfv @ XJ @ cccl))))))))))))))))))))).
...
thf(aeqgabl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ Xc_sm @ (cco @ XG @ XS @ ccqg)) => (cwi @ (cwa @ (cwcel @ XG @ ccabl) @ (cwss @ XS @ XX)) @ (cwb @ (cwbr @ XA2 @ XB2 @ Xc_sm) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ (cco @ XB2 @ XA2 @ Xc_mi) @ XS))))))))))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((cwi @ Xph @ Xps) => Xps))))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(areleqg_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XR @ (cco @ XG @ XS @ ccqg)) => (cwrel @ XR)))))).
thf(arelelec_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwrel @ XR) @ (cwb @ (cwcel @ XA2 @ (ccec @ XB2 @ XR)) @ (cwbr @ XB2 @ XA2 @ XR))))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cchmeo_tp,type,(cchmeo : ($i > $o))).
thf(asnclseqg_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_sm @ (cco @ XG @ XS @ ccqg)) => ((cwceq @ XS @ (ccfv @ (ccsn @ Xc_0) @ (ccfv @ XJ @ cccl))) => (cwi @ (cwa @ (cwcel @ XG @ cctgp) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccec @ XA2 @ Xc_sm) @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ cccl))))))))))))))))).
...
thf(atsmscls_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctps)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XG @ XF @ cctsu))) => (cwi @ Xph @ (cwss @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ cccl)) @ (cco @ XG @ XF @ cctsu))))))))))))))))))).
thf(ctgptsmscls_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctgp)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XG @ XF @ cctsu))) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ cctsu) @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ cccl)))))))))))))))))))).
