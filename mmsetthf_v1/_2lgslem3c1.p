...
thf(amodmuladdnn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XM @ ccrp)) @ (cwi @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ XB2) @ (cwrex @ (^ [Xk:$i] : (cwceq @ XA2 @ (cco @ (cco @ (ccv @ Xk) @ XM @ ccmul) @ XB2 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))))))).
...
thf(a_2lgslem3c_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XK @ ccn0) @ (cwceq @ XP @ (cco @ (cco @ cc8 @ XK @ ccmul) @ cc5 @ ccaddc))) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ XK @ ccmul) @ cc1 @ ccaddc)))))))).
...
thf(a_2tp1odd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwceq @ XB2 @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ cc1 @ ccaddc))) @ (cwn @ (cwbr @ cc2 @ XB2 @ ccdvds)))))).
...
thf(amod2eq1n2dvds_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwceq @ (cco @ XN @ cc2 @ ccmo) @ cc1) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)))))).
thf(c_2lgslem3c1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XP @ ccn) @ (cwceq @ (cco @ XP @ cc8 @ ccmo) @ cc5)) @ (cwceq @ (cco @ XN @ cc2 @ ccmo) @ cc1)))))).
