...
thf(acnlmod_thm,axiom,(! [XW:($i > $o)] : ((cwceq @ XW @ (ccun @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ ccc) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ ccaddc)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccsca) @ cccnfld) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ ccmul)))) => (cwcel @ XW @ cclmod)))).
...
thf(aqdass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwceq @ (ccun @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ (ccun @ (cctp @ XA2 @ XB2 @ XC) @ (ccsn @ XD)))))))).
...
thf(ccnstrcvs_conj,conjecture,(! [XW:($i > $o)] : ((cwceq @ XW @ (ccun @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ ccc) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ ccaddc)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccsca) @ cccnfld) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ ccmul)))) => (cwcel @ XW @ cccvs)))).
