...
thf(aoaass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccoa) @ XC @ ccoa) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccoa))))))).
thf(acom12_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => (cwi @ Xps @ (cwi @ Xph @ Xch))))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(aoe0lem_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : ((cwi @ (cwa @ Xph @ (cwceq @ XA2 @ cc0)) @ Xps) => ((cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccon0) @ Xph) @ (cwcel @ cc0 @ XA2)) @ Xps) => (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ Xph) @ Xps))))))).
...
thf(aoawordex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccoa) @ XB2)) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(asylan2i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ Xth) => ((cwi @ Xps @ (cwi @ (cwa @ Xch @ Xth) @ Xta)) => (cwi @ Xps @ (cwi @ (cwa @ Xch @ Xph) @ Xta)))))))))).
...
thf(aom00el_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwcel @ cc0 @ (cco @ XA2 @ XB2 @ ccomu)) @ (cwa @ (cwcel @ cc0 @ XA2) @ (cwcel @ cc0 @ XB2))))))).
...
thf(aomordlim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwa @ (cwcel @ XB2 @ (XD @ Xx3)) @ (cwlim @ XB2))) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccomu))) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ XC @ (cco @ XA2 @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : XB2))))))))).
...
thf(aomlimcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwa @ (cwcel @ XB2 @ XC) @ (cwlim @ XB2))) @ (cwcel @ cc0 @ XA2)) @ (cwlim @ (cco @ XA2 @ XB2 @ ccomu))))))).
...
thf(codi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccomu) @ (cco @ (cco @ XA2 @ XB2 @ ccomu) @ (cco @ XA2 @ XC @ ccomu) @ ccoa))))))).
