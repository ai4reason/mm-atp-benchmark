...
thf(asrhmsubcALTVlem1_thm,axiom,(! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwral @ (^ [Xr:$i] : (cwcel @ (ccv @ Xr) @ ccrg)) @ (^ [Xr:$i] : XS)) => ((! [Xr:$i] : (cwceq @ (XC @ Xr) @ (ccin @ (XU @ Xr) @ XS))) => (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ (XU @ Xr) @ (XV @ Xr)) @ (cwcel @ XX @ (XC @ Xr))) @ (cwcel @ XX @ (ccfv @ (ccfv @ (XU @ Xr) @ ccringcALTV) @ ccbs)))))))))))).
