...
thf(abccbc_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XK @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ XN @ XK @ ccbcc) @ (cco @ XN @ XK @ ccbc))))))))).
...
thf(cbinomcxplemnn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XB2 @ ccabs) @ (ccfv @ XA2 @ ccabs) @ cclt)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ (cwa @ Xph @ (cwcel @ XC @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cccxp) @ (ccsu @ ccn0 @ (^ [Xk:$i] : (cco @ (cco @ XC @ (ccv @ Xk) @ ccbcc) @ (cco @ (cco @ XA2 @ (cco @ XC @ (ccv @ Xk) @ ccmin) @ cccxp) @ (cco @ XB2 @ (ccv @ Xk) @ ccexp) @ ccmul) @ ccmul)))))))))))))).
