...
thf(cdrngmul0or_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwi @ Xph @ (cwcel @ XR @ ccdr)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XX @ XY @ Xc_x) @ Xc_0) @ (cwo @ (cwceq @ XX @ Xc_0) @ (cwceq @ XY @ Xc_0)))))))))))))))))).
