...
thf(adom2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (XC @ Xx3) @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2)) @ (cwb @ (cwceq @ (XC @ Xx3) @ (XD @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwi @ (cwcel @ XB2 @ (XR @ Xx3 @ Xy1)) @ (cwbr @ XA2 @ XB2 @ ccdom)))))))))))))).
...
thf(aprmreclem1_thm,axiom,(! [XQ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XQ @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsup @ (ccrab @ (^ [Xr:$i] : (cwbr @ (cco @ (ccv @ Xr) @ cc2 @ ccexp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xr:$i] : ccn)) @ ccr @ cclt))))) => (! [Xn:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ (ccfv @ XN @ (XQ @ Xn)) @ ccn) @ (cwbr @ (cco @ (ccfv @ XN @ (XQ @ Xn)) @ cc2 @ ccexp) @ XN @ ccdvds) @ (cwi @ (cwcel @ (XK @ Xn) @ (ccfv @ cc2 @ ccuz)) @ (cwn @ (cwbr @ (cco @ (XK @ Xn) @ cc2 @ ccexp) @ (cco @ XN @ (cco @ (ccfv @ XN @ (XQ @ Xn)) @ cc2 @ ccexp) @ ccdiv) @ ccdvds))))))))))).
...
thf(aelnn1uz2_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn) @ (cwo @ (cwceq @ XN @ cc1) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)))))).
...
thf(ahashxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwceq @ (ccfv @ (ccxp @ XA2 @ XB2) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccmul)))))).
...
thf(aprmreclem2_thm,axiom,(! [Xph:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ (XK @ Xr) @ ccn))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ (XN @ Xr) @ ccn))) => ((! [Xr:$i] : (cwceq @ (XM @ Xr) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xp:$i] : (cwn @ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xp:$i] : (ccdif @ ccprime @ (cco @ cc1 @ (XK @ Xr) @ ccfz))))) @ (^ [Xn:$i] : (cco @ cc1 @ (XN @ Xr) @ ccfz))))) => ((cwceq @ XQ @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsup @ (ccrab @ (^ [Xr:$i] : (cwbr @ (cco @ (ccv @ Xr) @ cc2 @ ccexp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xr:$i] : ccn)) @ ccr @ cclt)))) => (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwbr @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XQ) @ cc1)) @ (^ [Xx3:$i] : (XM @ Xr))) @ cchash) @ (cco @ cc2 @ (XK @ Xr) @ ccexp) @ ccle))))))))))))))).
...
thf(cprmreclem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ (XK @ Xr) @ ccn))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ (XN @ Xr) @ ccn))) => ((! [Xr:$i] : (cwceq @ (XM @ Xr) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xp:$i] : (cwn @ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xp:$i] : (ccdif @ ccprime @ (cco @ cc1 @ (XK @ Xr) @ ccfz))))) @ (^ [Xn:$i] : (cco @ cc1 @ (XN @ Xr) @ ccfz))))) => ((cwceq @ XQ @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsup @ (ccrab @ (^ [Xr:$i] : (cwbr @ (cco @ (ccv @ Xr) @ cc2 @ ccexp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xr:$i] : ccn)) @ ccr @ cclt)))) => (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwbr @ (ccfv @ (XM @ Xr) @ cchash) @ (cco @ (cco @ cc2 @ (XK @ Xr) @ ccexp) @ (ccfv @ (XN @ Xr) @ ccsqrt) @ ccmul) @ ccle))))))))))))))).
