...
thf(crabdiophlem1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XN:($i > $o)] : (cwi @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (XA2 @ Xt))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp)) @ (cwral @ (^ [Xt:$i] : (cwcel @ (XA2 @ Xt) @ ccz)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))))))).
