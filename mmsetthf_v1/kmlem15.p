...
thf(ckmlem15_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xch:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (cwb @ (Xph @ Xx3 @ Xy1 @ Xz @ Xv) @ (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xv) @ (ccv @ Xx3)) @ (cwne @ (ccv @ Xy1) @ (ccv @ Xv))) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xv))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwb @ (Xps @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) @ (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xv) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xv) @ (ccv @ Xy1))) @ (cwi @ (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xu) @ (ccv @ Xy1))) @ (cwceq @ (ccv @ Xu) @ (ccv @ Xv))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwb @ (Xch @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) @ (cwral @ (^ [Xz:$i] : (cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1)))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwb @ (cwa @ (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (Xch @ Xx3 @ Xy1 @ Xz @ Xv @ Xu)) @ (cwal @ (^ [Xz:$i] : (cwex @ (^ [Xv:$i] : (cwal @ (^ [Xu:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (Xps @ Xx3 @ Xy1 @ Xz @ Xv @ Xu))))))))))))))))))))).
