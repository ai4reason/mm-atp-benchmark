...
thf(asecval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ ccsec) @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccdiv))))).
...
thf(creseccl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) @ (cwcel @ (ccfv @ XA2 @ ccsec) @ ccr)))).
