...
thf(adf_cnop_ax,axiom,(cwceq @ cccop @ (ccrab @ (^ [Xt:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccfv @ (cco @ (ccv @ Xw) @ (ccv @ Xx3) @ ccmv) @ ccno) @ (ccv @ Xz) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xt)) @ ccmv) @ ccno) @ (ccv @ Xy1) @ cclt))) @ (^ [Xw:$i] : cchil))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xt:$i] : (cco @ cchil @ cchil @ ccmap))))).
...
thf(ahilmetdval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (cccom @ ccno @ ccmv)) => (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ XA2 @ XB2 @ XD) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno)))))))).
...
thf(ahilxmet_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (cccom @ ccno @ ccmv)) => (cwcel @ XD @ (ccfv @ cchil @ ccxmt))))).
...
thf(chhcno_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XD @ (cccom @ ccno @ ccmv)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwceq @ cccop @ (cco @ XJ @ XJ @ cccn))))))).
