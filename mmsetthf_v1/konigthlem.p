...
thf(aac6c5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (cwi @ (cwral @ (^ [Xx3:$i] : (cwne @ (XB2 @ Xx3) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(aac9_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (cwb @ (cwral @ (^ [Xx3:$i] : (cwne @ (XB2 @ Xx3) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ (cwne @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cc0))))))).
