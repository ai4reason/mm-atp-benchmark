...
thf(afvclss_thm,axiom,(! [XF:($i > $o)] : (cwss @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF)))))) @ (ccun @ (ccrn @ XF) @ (ccsn @ cc0))))).
thf(cfvclex_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwcel @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF)))))) @ ccvv)))).
