...
thf(aminveclem4c_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XU @ ccsg)) => ((cwceq @ XN @ (ccfv @ XU @ ccnm)) => ((cwi @ Xph @ (cwcel @ XU @ cccph)) => ((cwi @ Xph @ (cwcel @ XY @ (ccfv @ XU @ cclss))) => ((cwi @ Xph @ (cwcel @ (cco @ XU @ XY @ ccress) @ cccms)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwceq @ XJ @ (ccfv @ XU @ cctopn)) => ((cwceq @ XR @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi) @ XN))))) => ((cwceq @ XS @ (ccinf @ XR @ ccr @ cclt)) => (cwi @ Xph @ (cwcel @ XS @ ccr))))))))))))))))))))))).
...
thf(acphreccl_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ XA2 @ XK) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ XK))))))))).
...
thf(alssvscl_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => (cwi @ (cwa @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XS)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XU))) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ XU))))))))))))))).
...
thf(aminveclem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XU @ ccsg)) => ((cwceq @ XN @ (ccfv @ XU @ ccnm)) => ((cwi @ Xph @ (cwcel @ XU @ cccph)) => ((cwi @ Xph @ (cwcel @ XY @ (ccfv @ XU @ cclss))) => ((cwi @ Xph @ (cwcel @ (cco @ XU @ XY @ ccress) @ cccms)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwceq @ XJ @ (ccfv @ XU @ cctopn)) => ((cwceq @ XR @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi) @ XN))))) => (cwi @ Xph @ (cw3a @ (cwss @ XR @ ccr) @ (cwne @ XR @ cc0) @ (cwral @ (^ [Xw:$i] : (cwbr @ ccc0 @ (ccv @ Xw) @ ccle)) @ (^ [Xw:$i] : XR))))))))))))))))))))))).
...
thf(ainfregelb_b1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cwcel @ (XB2 @ Xx3) @ ccr)) @ (cwb @ (cwbr @ (XB2 @ Xx3) @ (ccinf @ XA2 @ ccr @ cclt) @ ccle) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2)))))))).
...
thf(ainfrelb_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwss @ XB2 @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr)) @ (cwcel @ (XA2 @ Xx3 @ Xy1) @ XB2)) @ (cwbr @ (ccinf @ XB2 @ ccr @ cclt) @ (XA2 @ Xx3 @ Xy1) @ ccle))))))).
...
thf(acphnmvs_thm,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XV)) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_x) @ XN) @ (cco @ (ccfv @ XX @ ccabs) @ (ccfv @ XY @ XN) @ ccmul))))))))))))))))).
...
thf(almodsubdi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XA2 @ XK)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (cco @ XX @ XY @ Xc_mi) @ Xc_x) @ (cco @ (cco @ XA2 @ XX @ Xc_x) @ (cco @ XA2 @ XY @ Xc_x) @ Xc_mi))))))))))))))))))))))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(amulg2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwcel @ XX @ XB2) @ (cwceq @ (cco @ cc2 @ XX @ Xc_x) @ (cco @ XX @ XX @ Xc_pl)))))))))))).
...
thf(aablsub4_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccabl) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwa @ (cwcel @ XZ @ XB2) @ (cwcel @ XW @ XB2))) @ (cwceq @ (cco @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XW @ Xc_pl) @ Xc_mi) @ (cco @ (cco @ XX @ XZ @ Xc_mi) @ (cco @ XY @ XW @ Xc_mi) @ Xc_pl))))))))))))))).
thf(ccxme_tp,type,(ccxme : ($i > $o))).
thf(angpdsr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => (cwi @ (cw3a @ (cwcel @ XG @ ccngp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ XA2 @ XB2 @ XD) @ (ccfv @ (cco @ XB2 @ XA2 @ Xc_mi) @ XN))))))))))))))).
...
thf(aablnnncan1_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XX @ XZ @ Xc_mi) @ Xc_mi) @ (cco @ XZ @ XY @ Xc_mi))))))))))))))))).
