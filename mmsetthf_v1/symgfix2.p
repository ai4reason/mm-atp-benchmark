...
thf(asymgmov2_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XP @ Xk) @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => (! [Xk:$i] : (cwi @ (cwcel @ XQ @ (XP @ Xk)) @ (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ XQ) @ (ccv @ Xn))) @ (^ [Xk:$i] : XN))) @ (^ [Xn:$i] : XN))))))))).
...
thf(csymgfix2_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xq:$i] : (cwceq @ (XP @ Xk) @ (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs)))) => (! [Xk:$i] : (! [Xq:$i] : (cwi @ (cwcel @ XL @ (XN @ Xq)) @ (cwi @ (cwcel @ XQ @ (ccdif @ (XP @ Xk) @ (ccrab @ (^ [Xq:$i] : (cwceq @ (ccfv @ XK @ (ccv @ Xq)) @ XL)) @ (^ [Xq:$i] : (XP @ Xk))))) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ XQ) @ XL)) @ (^ [Xk:$i] : (ccdif @ (XN @ Xq) @ (ccsn @ XK))))))))))))))).
