...
thf(cexpmhm_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (cco @ cccnfld @ ccn0 @ ccress))) => ((! [Xx3:$i] : (cwceq @ (XM @ Xx3) @ (ccfv @ cccnfld @ ccmgp))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccexp))) @ (cco @ (XN @ Xx3) @ (XM @ Xx3) @ ccmhm)))))))))).
