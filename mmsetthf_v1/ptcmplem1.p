...
thf(cptcmplem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xu:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccima @ (cccnv @ (ccmpt @ (^ [Xw:$i] : XX) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xw))))) @ (ccv @ Xu))))))) => ((cwceq @ XX @ (ccixp @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccuni @ (ccfv @ (ccv @ Xn) @ XF))))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ XV))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwf @ XA2 @ cccmp @ XF))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XX @ (ccin @ ccufl @ (ccdm @ cccrd))))) => (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwa @ (cwceq @ XX @ (ccuni @ (ccun @ (ccrn @ (XS @ Xw)) @ (ccsn @ XX)))) @ (cwceq @ (ccfv @ XF @ ccpt) @ (ccfv @ (ccfv @ (ccun @ (ccrn @ (XS @ Xw)) @ (ccsn @ XX)) @ ccfi) @ cctg))))))))))))))))).
