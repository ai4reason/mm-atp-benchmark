...
thf(arlimclim1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ ccrli)) => ((cwi @ Xph @ (cwss @ XZ @ (ccdm @ XF))) => (cwi @ Xph @ (cwbr @ XF @ XA2 @ ccli)))))))))))).
