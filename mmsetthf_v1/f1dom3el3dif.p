...
thf(af1dom3fv3dif_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XZ))) => ((cwi @ Xph @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC))) => ((cwi @ Xph @ (cwf1 @ (cctp @ XA2 @ XB2 @ XC) @ XR @ XF)) => (cwi @ Xph @ (cw3a @ (cwne @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)) @ (cwne @ (ccfv @ XA2 @ XF) @ (ccfv @ XC @ XF)) @ (cwne @ (ccfv @ XB2 @ XF) @ (ccfv @ XC @ XF))))))))))))))))).
...
thf(cf1dom3el3dif_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (cw3a @ (cwcel @ XA2 @ (XX @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XB2 @ (XY @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XC @ (XZ @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (cwf1 @ (cctp @ XA2 @ XB2 @ XC) @ XR @ XF))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwne @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwne @ (ccv @ Xy1) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XR))) @ (^ [Xy1:$i] : XR))) @ (^ [Xx3:$i] : XR))))))))))))))))))).
