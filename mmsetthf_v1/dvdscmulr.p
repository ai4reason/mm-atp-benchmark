...
thf(cdvdscmulr_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwa @ (cwcel @ XK @ ccz) @ (cwne @ XK @ ccc0))) @ (cwb @ (cwbr @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccdvds) @ (cwbr @ XM @ XN @ ccdvds))))))).
