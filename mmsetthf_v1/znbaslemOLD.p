...
thf(aplendxOLD_thm,axiom,(cwceq @ (ccfv @ ccnx @ ccple) @ cc10)).
thf(cznbaslemOLD_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ czring @ ccrsp)) => ((cwceq @ XU @ (cco @ czring @ (cco @ czring @ (ccfv @ (ccsn @ XN) @ XS) @ ccqg) @ ccqus)) => ((cwceq @ XY @ (ccfv @ XN @ cczn)) => ((cwceq @ XE @ (ccslot @ XK)) => ((cwcel @ XK @ ccn) => ((cwbr @ XK @ cc10 @ cclt) => (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ XU @ XE) @ (ccfv @ XY @ XE)))))))))))))))).
