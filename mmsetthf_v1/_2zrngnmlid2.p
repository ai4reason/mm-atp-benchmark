...
thf(a_2zrngnmrid_thm,axiom,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((cwceq @ XE @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))) => ((cwceq @ XR @ (cco @ cccnfld @ XE @ ccress)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XM @ Xx3 @ Xz) @ (ccfv @ XR @ ccmgp)))) => (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwne @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccmul) @ (ccv @ Xa))) @ (^ [Xb:$i] : XE))) @ (^ [Xa:$i] : (ccdif @ XE @ (ccsn @ ccc0))))))))))).
...
thf(c_2zrngnmlid2_conj,conjecture,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((cwceq @ XE @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))) => ((cwceq @ XR @ (cco @ cccnfld @ XE @ ccress)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XM @ Xx3 @ Xz) @ (ccfv @ XR @ ccmgp)))) => (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwne @ (cco @ (ccv @ Xb) @ (ccv @ Xa) @ ccmul) @ (ccv @ Xa))) @ (^ [Xb:$i] : XE))) @ (^ [Xa:$i] : (ccdif @ XE @ (ccsn @ ccc0))))))))))).
