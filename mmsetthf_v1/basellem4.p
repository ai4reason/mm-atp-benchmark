...
thf(abasellem1_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) @ (cwcel @ (cco @ (cco @ XK @ ccpi @ ccmul) @ XN @ ccdiv) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)))))))).
...
thf(abasellem3_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => ((! [Xt:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xt @ Xj) @ (ccmpt @ (^ [Xt:$i] : ccc) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ ccbc) @ (cco @ (ccneg @ cc1) @ (cco @ XM @ (ccv @ Xj) @ ccmin) @ ccexp) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccv @ Xj) @ ccexp) @ ccmul)))))))) => (! [Xt:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XA2 @ cctan) @ (ccneg @ cc2) @ ccexp) @ (XP @ Xt @ Xj)) @ (cco @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ ccsin) @ (cco @ (ccfv @ XA2 @ ccsin) @ XN @ ccexp) @ ccdiv)))))))))))).
...
thf(asinkpi_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ XK @ ccpi @ ccmul) @ ccsin) @ ccc0)))).
...
thf(aeqord2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XC) @ (cwceq @ (XA2 @ Xx3 @ Xy1) @ XM)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XD) @ (cwceq @ (XA2 @ Xx3 @ Xy1) @ XN)))) => ((cwss @ XS @ ccr) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (XA2 @ Xx3 @ Xy1) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) @ (cwbr @ (XB2 @ Xy1) @ (XA2 @ Xx3 @ Xy1) @ cclt))))) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XC @ XS) @ (cwcel @ XD @ XS))) @ (cwb @ (cwceq @ XC @ XD) @ (cwceq @ XM @ XN)))))))))))))))))).
...
thf(atanord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) @ (cwcel @ XB2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ cclt)))))).
...
thf(cbasellem4_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => ((! [Xt:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xt @ Xj) @ (ccmpt @ (^ [Xt:$i] : ccc) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ ccbc) @ (cco @ (ccneg @ cc1) @ (cco @ XM @ (ccv @ Xj) @ ccmin) @ ccexp) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccv @ Xj) @ ccexp) @ ccmul)))))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xt @ Xj @ Xn) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ ccpi @ ccmul) @ XN @ ccdiv) @ cctan) @ (ccneg @ cc2) @ ccexp))))))) => (! [Xt:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwi @ (cwcel @ XM @ ccn) @ (cwf1o @ (cco @ cc1 @ XM @ ccfz) @ (ccima @ (cccnv @ (XP @ Xt @ Xj)) @ (ccsn @ ccc0)) @ (XT @ Xt @ Xj @ Xn)))))))))))))).
