...
thf(cxadd0ge_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (cwi @ Xph @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccxad) @ ccle)))))))).
