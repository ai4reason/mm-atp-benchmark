...
thf(allnnlt_thm,axiom,(! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ XN @ (ccfv @ XK @ cclln)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XN)) @ (cwn @ (cwbr @ XX @ XY @ Xc_lt))))))))))).
...
thf(clplnnle2at_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XP) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2))) @ (cwn @ (cwbr @ XX @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))))))))))))))).
