...
thf(aelfi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccint @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdif @ (ccin @ (ccpw @ XB2) @ ccfn) @ (ccsn @ cc0)))))))))).
...
thf(atgtopon_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ cctb) @ (cwcel @ (ccfv @ XB2 @ cctg) @ (ccfv @ (ccuni @ XB2) @ cctopon))))).
...
thf(ariinn0_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwral @ (^ [Xx3:$i] : (cwss @ (XS @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XX)) @ (cwne @ XX @ cc0)) @ (cwceq @ (ccin @ XA2 @ (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XS @ Xx3)))) @ (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XS @ Xx3))))))))).
...
thf(aufilb_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwss @ XS @ XX)) @ (cwb @ (cwn @ (cwcel @ XS @ XF)) @ (cwcel @ (ccdif @ XX @ XS) @ XF))))))).
...
thf(afilintn0_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cw3a @ (cwss @ XA2 @ XF) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn))) @ (cwne @ (ccint @ XA2) @ cc0)))))).
...
thf(calexsublem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccufl)) => ((cwi @ Xph @ (cwceq @ XX @ (ccuni @ XB2))) => ((cwi @ Xph @ (cwceq @ XJ @ (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwceq @ XX @ (ccuni @ (ccv @ Xx3))))) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XX @ ccufil))) => ((cwi @ Xph @ (cwceq @ (cco @ XJ @ XF @ ccflim) @ cc0)) => (cwn @ Xph))))))))))))).
