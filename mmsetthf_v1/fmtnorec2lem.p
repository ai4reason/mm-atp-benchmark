...
thf(cfmtnorec2lem_conj,conjecture,(! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccn0) @ (cwi @ (cwceq @ (ccfv @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfmtno) @ (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (ccv @ Xy1) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc)) @ (cwceq @ (ccfv @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ ccfmtno) @ (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc)))))).
