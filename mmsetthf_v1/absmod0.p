...
thf(cabsmod0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ ccc0) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccmo) @ ccc0)))))).
