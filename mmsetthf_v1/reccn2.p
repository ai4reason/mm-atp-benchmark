...
thf(creccn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (cco @ (ccif @ (cwbr @ cc1 @ (cco @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccmul) @ ccle) @ cc1 @ (cco @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccmul)) @ (cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccdiv) @ ccmul)) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0))) @ (cwcel @ XB2 @ ccrp)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt) @ (cwbr @ (ccfv @ (cco @ (cco @ cc1 @ (ccv @ Xz) @ ccdiv) @ (cco @ cc1 @ XA2 @ ccdiv) @ ccmin) @ ccabs) @ XB2 @ cclt))) @ (^ [Xz:$i] : (ccdif @ ccc @ (ccsn @ ccc0))))) @ (^ [Xy1:$i] : ccrp)))))))).
