...
thf(apjspansn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwne @ XA2 @ cc0v)) @ (cwceq @ (ccfv @ XB2 @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccpjh)) @ (cco @ (cco @ (cco @ XB2 @ XA2 @ ccsp) @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ ccdiv) @ XA2 @ ccsm)))))).
...
thf(akbop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwf @ cchil @ cchil @ (cco @ XA2 @ XB2 @ cck)))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(affn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwfn @ XF @ XA2)))))).
thf(aspansnch_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwcel @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccch)))).
thf(apjfn_thm,axiom,(! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ ccch) @ (cwfn @ (ccfv @ XH @ ccpjh) @ cchil)))).
...
thf(ckbpj_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwceq @ (ccfv @ XA2 @ ccno) @ cc1)) @ (cwceq @ (cco @ XA2 @ XA2 @ cck) @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccpjh))))).
