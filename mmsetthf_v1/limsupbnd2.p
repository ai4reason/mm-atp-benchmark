...
thf(climsupbnd2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((cwi @ Xph @ (cwf @ XB2 @ ccxr @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwceq @ (ccsup @ XB2 @ ccxr @ cclt) @ ccpnf)) => ((cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ XA2 @ (ccfv @ (ccv @ Xj) @ XF) @ ccle))) @ (^ [Xj:$i] : XB2))) @ (^ [Xk:$i] : ccr))) => (cwi @ Xph @ (cwbr @ XA2 @ (ccfv @ XF @ cclsp) @ ccle)))))))))))).
