...
thf(adnibndlem7_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ XB2 @ ccmin) @ ccabs) @ ccmin) @ (cco @ XB2 @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin) @ ccmin) @ ccle)))))).
thf(adnibndlem8_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ XA2 @ ccmin) @ ccabs) @ ccmin) @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ XA2 @ ccmin) @ ccle)))))).
...
thf(adnibndlem4_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ (cco @ XB2 @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin) @ ccmin) @ ccle)))).
...
thf(adnibndlem5_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ XA2 @ ccmin) @ cclt)))).
thf(adnibndlem3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ (cco @ (XB2 @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ (ccfv @ (cco @ (XA2 @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ cc1 @ ccaddc)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ (cco @ (XB2 @ Xx3) @ (XA2 @ Xx3) @ ccmin) @ ccabs) @ (ccfv @ (cco @ (cco @ (XB2 @ Xx3) @ (cco @ (ccfv @ (cco @ (XB2 @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin) @ ccmin) @ (cco @ (cco @ (ccfv @ (cco @ (XA2 @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (XA2 @ Xx3) @ ccmin) @ ccaddc) @ ccabs))))))))))))).
...
thf(cdnibndlem9_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ cc1 @ ccaddc)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (ccfv @ (cco @ (ccfv @ XB2 @ (XT @ Xx3)) @ (ccfv @ XA2 @ (XT @ Xx3)) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ ccle)))))))))))).
