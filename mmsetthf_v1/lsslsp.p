...
thf(clsslsp_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (cco @ XW @ XU @ ccress)) => ((cwceq @ XM @ (ccfv @ XW @ cclspn)) => ((cwceq @ XN @ (ccfv @ XX @ cclspn)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XL) @ (cwss @ XG @ XU)) @ (cwceq @ (ccfv @ XG @ XM) @ (ccfv @ XG @ XN))))))))))))))).
