...
thf(aperftop_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ ccperf) @ (cwcel @ XJ @ cctop)))).
...
thf(aperfi_thm,axiom,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ ccperf) @ (cwcel @ XP @ XX)) @ (cwn @ (cwcel @ (ccsn @ XP) @ XJ)))))))).
...
thf(cperfopn_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XK @ (cco @ XJ @ XY @ ccrest)) => (cwi @ (cwa @ (cwcel @ XJ @ ccperf) @ (cwcel @ XY @ XJ)) @ (cwcel @ XK @ ccperf))))))))).
