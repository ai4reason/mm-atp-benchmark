...
thf(anndivsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwa @ (cwcel @ (cco @ XA2 @ XC @ ccdiv) @ ccn) @ (cwbr @ XA2 @ XB2 @ cclt))) @ (cwb @ (cwcel @ (cco @ XB2 @ XC @ ccdiv) @ ccn) @ (cwcel @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ XC @ ccdiv) @ ccn))))))).
thf(adf_gcdOLD_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccgcdOLD @ XA2 @ XB2) @ (ccsup @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ ccn) @ (cwcel @ (cco @ XB2 @ (ccv @ Xx3) @ ccdiv) @ ccn))) @ (^ [Xx3:$i] : ccn)) @ ccn @ cclt))))).
thf(cee7_2aOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwceq @ (ccgcdOLD @ XA2 @ XB2) @ (ccgcdOLD @ XA2 @ (cco @ XB2 @ XA2 @ ccmin)))))))).
