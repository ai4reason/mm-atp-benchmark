...
thf(c_4sqlem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (cwi @ Xph @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XM @ ccdiv) @ ccz))))))))))).
