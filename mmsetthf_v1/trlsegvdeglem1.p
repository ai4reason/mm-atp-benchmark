...
thf(awlkpvtx_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwi @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz)) @ (cwcel @ (ccfv @ XN @ XP) @ XV)))))))))).
