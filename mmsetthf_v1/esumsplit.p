...
thf(atsmssplit_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctmd)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XG @ (ccres @ XF @ XC) @ cctsu))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XG @ (ccres @ XF @ XD) @ cctsu))) => ((cwi @ Xph @ (cwceq @ (ccin @ XC @ XD) @ cc0)) => ((cwi @ Xph @ (cwceq @ XA2 @ (ccun @ XC @ XD))) => (cwi @ Xph @ (cwcel @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XG @ XF @ cctsu))))))))))))))))))))))))).
...
thf(cesumsplit_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XA2 @ Xk) @ ccvv))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XB2 @ Xk) @ ccvv))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccin @ (XA2 @ Xk) @ (XB2 @ Xk)) @ cc0))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xk))) @ (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xk))) @ (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccesum @ (^ [Xk:$i] : (ccun @ (XA2 @ Xk) @ (XB2 @ Xk))) @ (^ [Xk:$i] : (XC @ Xk))) @ (cco @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccesum @ (^ [Xk:$i] : (XB2 @ Xk)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccxad))))))))))))))))).
