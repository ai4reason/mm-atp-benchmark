...
thf(afineqvlem_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwbr @ ccom @ (ccpw @ (ccpw @ XA2)) @ ccdom))))).
...
thf(cfineqv_conj,conjecture,(cwb @ (cwn @ (cwcel @ ccom @ ccvv)) @ (cwceq @ ccfn @ ccvv))).
