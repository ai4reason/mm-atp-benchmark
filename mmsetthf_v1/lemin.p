...
thf(clemin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ ccle) @ XB2 @ XC) @ ccle) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ XA2 @ XC @ ccle)))))))).
