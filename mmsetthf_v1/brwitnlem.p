...
thf(cbrwitnlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XR @ (ccima @ (cccnv @ XO) @ (ccdif @ ccvv @ cc1o))) => ((cwfn @ XO @ XX) => (cwb @ (cwbr @ XA2 @ XB2 @ XR) @ (cwne @ (cco @ XA2 @ XB2 @ XO) @ cc0)))))))))).
