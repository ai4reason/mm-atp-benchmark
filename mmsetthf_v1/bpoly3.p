...
thf(abcn2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ cc2 @ ccbc) @ (cco @ (cco @ XN @ (cco @ XN @ cc1 @ ccmin) @ ccmul) @ cc2 @ ccdiv))))).
...
thf(abpoly2_thm,axiom,(! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ ccc) @ (cwceq @ (cco @ cc2 @ XX @ ccbp) @ (cco @ (cco @ (cco @ XX @ cc2 @ ccexp) @ XX @ ccmin) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccaddc))))).
...
thf(cbpoly3_conj,conjecture,(! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ ccc) @ (cwceq @ (cco @ cc3 @ XX @ ccbp) @ (cco @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ cc3 @ cc2 @ ccdiv) @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ ccmin) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ XX @ ccmul) @ ccaddc))))).
