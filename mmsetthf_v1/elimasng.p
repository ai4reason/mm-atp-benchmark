...
thf(celimasng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XW)) @ (cwb @ (cwcel @ XC @ (ccima @ XA2 @ (ccsn @ XB2))) @ (cwcel @ (ccop @ XB2 @ XC) @ XA2))))))))).
