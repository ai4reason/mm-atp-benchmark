...
thf(cjm2_27dlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (cco @ cc1 @ XB2 @ ccfz)) => ((cwceq @ XC @ (cco @ XB2 @ cc1 @ ccaddc)) => ((cwcel @ XB2 @ ccn) => (cwcel @ XA2 @ (cco @ cc1 @ XC @ ccfz))))))))).
