...
thf(csetsfun_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XG @ XV) @ (cwfun @ XG)) @ (cwa @ (cwcel @ XI @ XU) @ (cwcel @ XE @ XW))) @ (cwfun @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts)))))))))).
