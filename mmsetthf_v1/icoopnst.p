...
thf(cicoopnst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ (cco @ XA2 @ XB2 @ ccicc) @ (cco @ XA2 @ XB2 @ ccicc))) @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwi @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc)) @ (cwcel @ (cco @ XA2 @ XC @ ccico) @ XJ))))))))).
