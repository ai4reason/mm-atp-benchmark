...
thf(afdvnegge_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XE @ (cco @ (XC @ Xx3) @ (XD @ Xx3) @ ccioo))) => ((cwi @ Xph @ (cwcel @ XA2 @ XE)) => ((cwi @ Xph @ (cwcel @ XB2 @ XE)) => ((cwi @ Xph @ (cwf @ XE @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ XE @ ccr @ cccncf))) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccioo))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccc0 @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccle))))))))))))))))).
...
thf(a_0nrp_thm,axiom,(cwn @ (cwcel @ ccc0 @ ccrp))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(assdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwss @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC))) @ (cwa @ (cwss @ XA2 @ XB2) @ (cwn @ (cwcel @ XC @ XA2)))))))).
...
thf(advcxp1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ cccxp))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ XA2 @ (cco @ (ccv @ Xx3) @ (cco @ XA2 @ cc1 @ ccmin) @ cccxp) @ ccmul))))))).
...
thf(acxpcncf1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwss @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc)))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ cccxp))) @ (cco @ XD @ ccc @ cccncf))))))))).
...
thf(clogdivsqrle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ (ccfv @ cc2 @ cce) @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XB2 @ ccsqrt) @ ccdiv) @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XA2 @ ccsqrt) @ ccdiv) @ ccle)))))))))).
