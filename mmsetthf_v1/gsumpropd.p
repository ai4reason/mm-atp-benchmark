...
thf(cgsumpropd_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwcel @ XG @ XW)) => ((cwi @ Xph @ (cwcel @ XH @ XX)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccbs) @ (ccfv @ XH @ ccbs))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccplusg) @ (ccfv @ XH @ ccplusg))) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ ccgsu) @ (cco @ XH @ XF @ ccgsu)))))))))))))))).
