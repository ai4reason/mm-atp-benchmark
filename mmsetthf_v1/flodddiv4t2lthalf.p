...
thf(aflodddiv4lt_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) @ (cwbr @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ (cco @ XN @ cc4 @ ccdiv) @ cclt)))).
...
thf(cflodddiv4t2lthalf_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) @ (cwbr @ (cco @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ cc2 @ ccmul) @ (cco @ XN @ cc2 @ ccdiv) @ cclt)))).
