...
thf(apellfundre_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ (ccfv @ XD @ ccpellfund) @ ccr)))).
...
thf(asqrtled_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XB2 @ ccle)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ ccle))))))))))).
...
thf(apellfundge_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ (ccfv @ XD @ ccpellfund) @ ccle)))).
thf(cpellfundgt1_conj,conjecture,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwbr @ cc1 @ (ccfv @ XD @ ccpellfund) @ cclt)))).
