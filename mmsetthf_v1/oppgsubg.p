...
thf(aoppgsubm_thm,axiom,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccoppg)) => (cwceq @ (ccfv @ XG @ ccsubmnd) @ (ccfv @ XO @ ccsubmnd)))))).
...
thf(coppgsubg_conj,conjecture,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccoppg)) => (cwceq @ (ccfv @ XG @ ccsubg) @ (ccfv @ XO @ ccsubg)))))).
