...
thf(arlimpm_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwbr @ XF @ XA2 @ ccrli) @ (cwcel @ XF @ (cco @ ccc @ ccr @ ccpm)))))).
...
thf(crlimf_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwbr @ XF @ XA2 @ ccrli) @ (cwf @ (ccdm @ XF) @ ccc @ XF))))).
