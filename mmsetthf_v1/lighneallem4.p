...
thf(alighneallem4b_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ (ccfv @ cc2 @ ccuz)) @ (cwn @ (cwbr @ cc2 @ XM @ ccdvds))) @ (cwcel @ (ccsu @ (cco @ ccc0 @ (cco @ XM @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul))) @ (ccfv @ cc2 @ ccuz)))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(advdsprmpweqnn_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwi @ (cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn)))))))).
...
thf(aoddsumodd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwn @ (cwbr @ cc2 @ (XB2 @ Xk) @ ccdvds)))) => ((cwi @ Xph @ (cwn @ (cwbr @ cc2 @ (ccfv @ XA2 @ cchash) @ ccdvds))) => (cwi @ Xph @ (cwn @ (cwbr @ cc2 @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccdvds))))))))))).
...
thf(an2dvdsm1_thm,axiom,(cwn @ (cwbr @ cc2 @ (ccneg @ cc1) @ ccdvds))).
...
thf(amp3an2ani_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => ((cwi @ Xps @ Xch) => ((cwi @ (cwa @ Xps @ Xth) @ Xta) => ((cwi @ (cw3a @ Xph @ Xch @ Xta) @ Xet) => (cwi @ (cwa @ Xps @ Xth) @ Xet)))))))))))).
...
thf(clighneallem4_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwa @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwn @ (cwbr @ cc2 @ XM @ ccdvds))) @ (cwceq @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin) @ (cco @ XP @ XM @ ccexp))) @ (cwceq @ XM @ cc1)))))).
