...
thf(cmotcgr3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ Xc_sm @ (ccfv @ XG @ cccgrg)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwceq @ XD @ (ccfv @ XA2 @ XH))) => ((cwi @ Xph @ (cwceq @ XE @ (ccfv @ XB2 @ XH))) => ((cwi @ Xph @ (cwceq @ XF @ (ccfv @ XC @ XH))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XG @ XG @ ccismt))) => (cwi @ Xph @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XD @ XE @ XF) @ Xc_sm)))))))))))))))))))))))))).
