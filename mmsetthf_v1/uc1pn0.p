...
thf(cuc1pn0_conj,conjecture,(! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => (cwi @ (cwcel @ XF @ XC) @ (cwne @ XF @ Xc_0))))))))))).
