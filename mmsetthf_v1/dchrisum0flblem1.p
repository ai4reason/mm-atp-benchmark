...
thf(a_0expd_thm,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ ccc0 @ XN @ ccexp) @ ccc0)))))).
...
thf(apcexp_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XA2 @ ccq) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XP @ (cco @ XA2 @ XN @ ccexp) @ ccpc) @ (cco @ XN @ (cco @ XP @ XA2 @ ccpc) @ ccmul))))))).
...
thf(adchrabs_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XX @ XD)) => ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ XU @ (ccfv @ XZ @ ccui)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XA2 @ XX) @ ccabs) @ cc1))))))))))))))))).
...
thf(adchrabs2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ XB2 @ (ccfv @ XZ @ ccbs)) => ((cwi @ Xph @ (cwcel @ XX @ XD)) => ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XX) @ ccabs) @ cc1 @ ccle))))))))))))))))).
...
thf(advdsppwf1o_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ XA2 @ ccfz)) @ (^ [Xn:$i] : (cco @ XP @ (ccv @ Xn) @ ccexp)))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccn0)) @ (cwf1o @ (cco @ ccc0 @ XA2 @ ccfz) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XP @ XA2 @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (XF @ Xx3 @ Xn)))))))))).
...
thf(asubrgsubm_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => (cwi @ (cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) @ (cwcel @ XA2 @ (ccfv @ XM @ ccsubmnd)))))))).
...
thf(azringmpg_thm,axiom,(cwceq @ (cco @ (ccfv @ cccnfld @ ccmgp) @ ccz @ ccress) @ (ccfv @ czring @ ccmgp))).
...
thf(amhmmulg_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_xp @ (ccfv @ XH @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ (cco @ XN @ XX @ Xc_x) @ XF) @ (cco @ XN @ (ccfv @ XX @ XF) @ Xc_xp))))))))))))))).
