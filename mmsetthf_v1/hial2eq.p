...
thf(ahi2eq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwceq @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmv) @ ccsp) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccmv) @ ccsp)) @ (cwceq @ XA2 @ XB2)))))).
...
thf(chial2eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccsp) @ (cco @ XB2 @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XA2 @ XB2)))))).
