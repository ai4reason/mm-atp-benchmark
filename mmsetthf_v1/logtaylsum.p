...
thf(clogtaylsum_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) @ (cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (ccv @ Xk) @ ccdiv))) @ (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog)))))).
