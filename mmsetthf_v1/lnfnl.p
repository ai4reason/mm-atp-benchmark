...
thf(clnfnl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XT @ cclf) @ (cwcel @ XA2 @ ccc)) @ (cwa @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil))) @ (cwceq @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ ccva) @ XT) @ (cco @ (cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccmul) @ (ccfv @ XC @ XT) @ ccaddc)))))))).
