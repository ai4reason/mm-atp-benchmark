...
thf(alspsnat_thm,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XW @ cclvec) @ (cwcel @ XU @ XS) @ (cwcel @ XX @ XV)) @ (cwss @ XU @ (ccfv @ (ccsn @ XX) @ XN))) @ (cwo @ (cwceq @ XU @ (ccfv @ (ccsn @ XX) @ XN)) @ (cwceq @ XU @ (ccsn @ Xc_0)))))))))))))))).
...
thf(clsatcmp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XT @ XA2)) => ((cwi @ Xph @ (cwcel @ XU @ XA2)) => (cwi @ Xph @ (cwb @ (cwss @ XT @ XU) @ (cwceq @ XT @ XU))))))))))))).
