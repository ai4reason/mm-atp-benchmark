...
thf(aisfinite4_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfn) @ (cwbr @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ XA2 @ ccen)))).
...
thf(crp_isfinite5_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfn) @ (cwrex @ (^ [Xn:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ XA2 @ ccen)) @ (^ [Xn:$i] : ccn0))))).
