...
thf(ainitoeu2lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((cwceq @ XX @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ XI @ (ccfv @ XC @ cciso)) => ((cwceq @ Xc_op @ (ccfv @ XC @ ccco)) => (cwi @ (cw3a @ Xph @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XD @ XX)) @ (cwa @ (cwcel @ XK @ (cco @ XB2 @ XA2 @ XI)) @ (cwcel @ (cco @ XF @ XK @ (cco @ (ccop @ XB2 @ XA2) @ XD @ Xc_op)) @ (cco @ XB2 @ XD @ XH)))) @ (cwi @ (cw3a @ (cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XD @ XH)))) @ (cwcel @ XF @ (cco @ XA2 @ XD @ XH)) @ (cwcel @ XG @ (cco @ XB2 @ XD @ XH))) @ (cwceq @ XG @ (cco @ XF @ XK @ (cco @ (ccop @ XB2 @ XA2) @ XD @ Xc_op)))))))))))))))))))))))).
