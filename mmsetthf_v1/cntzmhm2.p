...
thf(acntzmhm_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwceq @ XY @ (ccfv @ XH @ cccntz)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) @ (cwcel @ XA2 @ (ccfv @ XS @ XZ))) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ (ccima @ XF @ XS) @ XY))))))))))))).
...
thf(ccntzmhm2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwceq @ XY @ (ccfv @ XH @ cccntz)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) @ (cwss @ XS @ (ccfv @ XT @ XZ))) @ (cwss @ (ccima @ XF @ XS) @ (ccfv @ (ccima @ XF @ XT) @ XY))))))))))))).
