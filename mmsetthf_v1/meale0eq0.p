...
thf(cmeale0eq0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ XM))) => ((cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ XM) @ ccc0 @ ccle)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XM) @ ccc0))))))))).
