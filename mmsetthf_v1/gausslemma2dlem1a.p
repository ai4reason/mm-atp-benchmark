...
thf(altoddhalfle_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ XM @ ccz)) @ (cwb @ (cwbr @ XM @ (cco @ XN @ cc2 @ ccdiv) @ cclt) @ (cwbr @ XM @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))))).
...
thf(ahalfleoddlt_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ XM @ ccz)) @ (cwb @ (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ ccle) @ (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ cclt)))))).
...
thf(asubhalfhalf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XA2 @ (cco @ XA2 @ cc2 @ ccdiv) @ ccmin) @ (cco @ XA2 @ cc2 @ ccdiv))))).
...
thf(annehalf_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn)))).
...
thf(aledivge1le_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp) @ (cwa @ (cwcel @ XC @ ccrp) @ (cwbr @ cc1 @ XC @ ccle))) @ (cwi @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle))))))).
...
thf(alesub2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccle))))))).
...
thf(aeqnbrtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwn @ (cwbr @ XB2 @ XC @ XR))) => (cwi @ Xph @ (cwn @ (cwbr @ XA2 @ XC @ XR))))))))))).
...
thf(alesub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccle) @ (cwbr @ XC @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))).
...
thf(amulsubfacd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XB2 @ ccmin) @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XB2 @ ccmul))))))))).
...
thf(cgausslemma2dlem1a_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XH @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccrn @ (XR @ Xx3)) @ (cco @ cc1 @ XH @ ccfz)))))))))))).
