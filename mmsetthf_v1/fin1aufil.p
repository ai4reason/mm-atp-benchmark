...
thf(cfin1aufil_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccdif @ (ccpw @ XX) @ ccfn)) => (cwi @ (cwcel @ XX @ (ccdif @ ccfin1a @ ccfn)) @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwceq @ (ccint @ XF) @ cc0))))))).
