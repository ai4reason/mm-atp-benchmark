...
thf(aacongrep_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccz)) @ (cwrex @ (^ [Xa:$i] : (cwo @ (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ XN @ ccmin) @ ccdvds) @ (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ (ccneg @ XN) @ ccmin) @ ccdvds))) @ (^ [Xa:$i] : (cco @ ccc0 @ XA2 @ ccfz))))))).
...
thf(ajm2_26a_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz))) @ (cwi @ (cwo @ (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ XM @ ccmin) @ ccdvds) @ (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ (ccneg @ XM) @ ccmin) @ ccdvds)) @ (cwo @ (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (cco @ XA2 @ XM @ ccrmy) @ ccmin) @ ccdvds) @ (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (ccneg @ (cco @ XA2 @ XM @ ccrmy)) @ ccmin) @ ccdvds))))))))).
...
thf(aacongsym_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwo @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds))) @ (cwo @ (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XC @ (ccneg @ XB2) @ ccmin) @ ccdvds))))))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(ccabs_tp,type,(ccabs : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(ajm2_26lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn)) @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) @ (cwo @ (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (cco @ XA2 @ XM @ ccrmy) @ ccmin) @ ccdvds) @ (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (ccneg @ (cco @ XA2 @ XM @ ccrmy)) @ ccmin) @ ccdvds))) @ (cwceq @ XK @ XM))))))).
thf(aacongeq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => ((cwi @ Xph @ (cwceq @ XD @ XE)) => (cwi @ Xph @ (cwb @ (cwo @ (cwbr @ XA2 @ (cco @ XB2 @ XD @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XD) @ ccmin) @ ccdvds)) @ (cwo @ (cwbr @ XA2 @ (cco @ XC @ XE @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XC @ (ccneg @ XE) @ ccmin) @ ccdvds))))))))))))).
