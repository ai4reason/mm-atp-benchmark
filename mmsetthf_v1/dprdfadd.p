...
thf(afsuppunfi_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp)) => ((cwi @ Xph @ (cwbr @ XG @ XZ @ ccfsupp)) => (cwi @ Xph @ (cwcel @ (ccun @ (cco @ XF @ XZ @ ccsupp) @ (cco @ XG @ XZ @ ccsupp)) @ ccfn))))))))).
...
thf(agsumzaddlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => ((cwi @ Xph @ (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((cwi @ Xph @ (cwbr @ XH @ Xc_0 @ ccfsupp)) => ((cwceq @ XW @ (cco @ (ccun @ XF @ XH) @ Xc_0 @ ccsupp)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XH)) => ((cwi @ Xph @ (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ XZ))) => ((cwi @ Xph @ (cwss @ (ccrn @ XH) @ (ccfv @ (ccrn @ XH) @ XZ))) => ((cwi @ Xph @ (cwss @ (ccrn @ (cco @ XF @ XH @ (ccof @ Xc_pl))) @ (ccfv @ (ccrn @ (cco @ XF @ XH @ (ccof @ Xc_pl))) @ XZ))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ (ccdif @ XA2 @ (ccv @ Xx3))))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccsn @ (cco @ XG @ (ccres @ XH @ (ccv @ Xx3)) @ ccgsu)) @ XZ))))) => (cwi @ Xph @ (cwceq @ (cco @ XG @ (cco @ XF @ XH @ (ccof @ Xc_pl)) @ ccgsu) @ (cco @ (cco @ XG @ XF @ ccgsu) @ (cco @ XG @ XH @ ccgsu) @ Xc_pl)))))))))))))))))))))))))))))).
...
thf(acntzidss_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => (cwi @ (cwa @ (cwss @ XS @ (ccfv @ XS @ XZ)) @ (cwss @ XT @ XS)) @ (cwss @ XT @ (ccfv @ XT @ XZ))))))))).
...
thf(cdprdfadd_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (Xc_0 @ Xi) @ (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : (cwceq @ (XW @ Xh @ Xi) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS)))))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwceq @ (ccdm @ XS) @ XI)))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ (XF @ Xi) @ (XW @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ (XH @ Xi) @ (XW @ Xh @ Xi))))) => ((! [Xi:$i] : (cwceq @ (Xc_pl @ Xi) @ (ccfv @ XG @ ccplusg))) => (! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwa @ (cwcel @ (cco @ (XF @ Xi) @ (XH @ Xi) @ (ccof @ (Xc_pl @ Xi))) @ (XW @ Xh @ Xi)) @ (cwceq @ (cco @ XG @ (cco @ (XF @ Xi) @ (XH @ Xi) @ (ccof @ (Xc_pl @ Xi))) @ ccgsu) @ (cco @ (cco @ XG @ (XF @ Xi) @ ccgsu) @ (cco @ XG @ (XH @ Xi) @ ccgsu) @ (Xc_pl @ Xi)))))))))))))))))))))))).
