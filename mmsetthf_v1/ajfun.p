...
thf(aajfuni_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (cco @ XU @ XW @ ccaj)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XW @ ccnv) => (cwfun @ XA2)))))))).
...
thf(cajfun_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (cco @ XU @ XW @ ccaj)) => (cwi @ (cwa @ (cwcel @ XU @ cccphlo) @ (cwcel @ XW @ ccnv)) @ (cwfun @ XA2))))))).
