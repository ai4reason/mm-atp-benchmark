...
thf(ameage0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ XM))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XA2 @ XM) @ ccle)))))))).
...
thf(asge0reuzb_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xx3 @ Xk)))) => ((! [Xk:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xk)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xk) @ (cwcel @ XM @ ccz)))) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xk) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccsu @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccv @ Xx3) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xx3:$i] : ccr))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xk) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccsu @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk)))))) @ ccr @ cclt)))))))))))))))).
...
thf(aiunincfi_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ XM @ XN @ ccfzo))) @ (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => (cwi @ Xph @ (cwceq @ (cciun @ (^ [Xn:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) @ (ccfv @ XN @ XF)))))))))).
...
thf(ameadjiun_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XM @ ccmea))) => ((cwceq @ XS @ (ccdm @ XM)) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ XS))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ XA2 @ ccom @ ccdom))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwdisj @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XM) @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ XM))) @ ccsumge0)))))))))))))))).
...
thf(cmeaiuninclem_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwceq @ XZ @ (ccfv @ XN @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (ccv @ Xn) @ XE) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE)))) => ((cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xx3:$i] : ccr))) => ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdif @ (ccfv @ (ccv @ Xn) @ XE) @ (cciun @ (^ [Xi:$i] : (cco @ XN @ (ccv @ Xn) @ ccfzo)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XE))))))) => (! [Xi:$i] : (cwi @ Xph @ (cwbr @ (XS @ Xi) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ ccli))))))))))))))))))).
