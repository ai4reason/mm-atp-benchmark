...
thf(cfndmfifsupp_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwfn @ XF @ XD)) => ((cwi @ Xph @ (cwcel @ XD @ ccfn)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => (cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp))))))))))).
