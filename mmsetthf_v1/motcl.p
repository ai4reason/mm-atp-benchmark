...
thf(cmotcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XG @ XG @ ccismt))) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XF) @ XP))))))))))))))).
