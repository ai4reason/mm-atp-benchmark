...
thf(abj_inftyexpiinj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) @ (cwcel @ XB2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc))) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ ccinftyexpi) @ (ccfv @ XB2 @ ccinftyexpi))))))).
