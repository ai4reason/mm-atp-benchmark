...
thf(cfzsubel_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwcel @ XJ @ ccz) @ (cwcel @ XK @ ccz))) @ (cwb @ (cwcel @ XJ @ (cco @ XM @ XN @ ccfz)) @ (cwcel @ (cco @ XJ @ XK @ ccmin) @ (cco @ (cco @ XM @ XK @ ccmin) @ (cco @ XN @ XK @ ccmin) @ ccfz))))))))).
