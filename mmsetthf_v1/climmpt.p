...
thf(cclimmpt_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ (XM @ Xk) @ ccz) @ (cwcel @ XF @ (XV @ Xk))) @ (cwb @ (cwbr @ XF @ XA2 @ ccli) @ (cwbr @ (XG @ Xk) @ XA2 @ ccli))))))))))))).
