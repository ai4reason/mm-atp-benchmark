...
thf(cocvlss_conj,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cwss @ XS @ XV)) @ (cwcel @ (ccfv @ XS @ Xc_pe) @ XL))))))))))).
