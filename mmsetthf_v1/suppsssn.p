...
thf(csuppsssn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xk) @ XA2) @ (cwne @ (ccv @ Xk) @ XW)) @ (cwceq @ (XB2 @ Xk) @ XZ))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => (cwi @ Xph @ (cwss @ (cco @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XZ @ ccsupp) @ (ccsn @ XW)))))))))))).
