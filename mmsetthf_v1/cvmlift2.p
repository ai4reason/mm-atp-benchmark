...
thf(acvmlift2lem13_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XB2 @ Xf1 @ Xg1) @ (ccuni @ XC)))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XC @ XJ @ cccvm))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ (cco @ ccii @ ccii @ cctx) @ XJ @ cccn))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XP @ (XB2 @ Xf1 @ Xg1))))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XP @ XF) @ (cco @ ccc0 @ ccc0 @ XG))) => ((! [Xg1:$i] : (cwceq @ (XH @ Xg1) @ (ccrio @ (^ [Xf1:$i] : (cwa @ (cwceq @ (cccom @ XF @ (ccv @ Xf1)) @ (ccmpt @ (^ [Xz:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xz:$i] : (cco @ (ccv @ Xz) @ ccc0 @ XG)))) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn))))) => ((! [Xg1:$i] : (cwceq @ XK @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccrio @ (^ [Xf1:$i] : (cwa @ (cwceq @ (cccom @ XF @ (ccv @ Xf1)) @ (ccmpt @ (^ [Xz:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XG)))) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (XH @ Xg1))))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn))))))))) => (cwi @ Xph @ (cwreu @ (^ [Xg1:$i] : (cwa @ (cwceq @ (cccom @ XF @ (ccv @ Xg1)) @ XG) @ (cwceq @ (cco @ ccc0 @ ccc0 @ (ccv @ Xg1)) @ XP))) @ (^ [Xg1:$i] : (cco @ (cco @ ccii @ ccii @ cctx) @ XC @ cccn))))))))))))))))))))).
...
thf(ccvmlift2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccuni @ XC))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XC @ XJ @ cccvm))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ (cco @ ccii @ ccii @ cctx) @ XJ @ cccn))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XP @ (XB2 @ Xf1)))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XP @ XF) @ (cco @ ccc0 @ ccc0 @ XG))) => (cwi @ Xph @ (cwreu @ (^ [Xf1:$i] : (cwa @ (cwceq @ (cccom @ XF @ (ccv @ Xf1)) @ XG) @ (cwceq @ (cco @ ccc0 @ ccc0 @ (ccv @ Xf1)) @ XP))) @ (^ [Xf1:$i] : (cco @ (cco @ ccii @ ccii @ cctx) @ XC @ cccn))))))))))))))))).
