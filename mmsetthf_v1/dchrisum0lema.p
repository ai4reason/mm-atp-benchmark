...
thf(arpsqrtcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccrp)))).
...
thf(asqrtle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ ccle))) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ ccle)))))).
...
thf(cdchrisum0lema_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : (cwceq @ (XZ @ Xt @ Xa @ Xc) @ (ccfv @ (XN @ Xa) @ cczn))))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : (cwceq @ XL @ (ccfv @ (XZ @ Xt @ Xa @ Xc) @ cczrh))))) => ((! [Xy1:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwcel @ (XN @ Xa) @ ccn)))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : (cwceq @ (XG @ Xy1 @ Xt @ Xm @ Xa @ Xc) @ (ccfv @ (XN @ Xa) @ ccdchr))))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : (cwceq @ (XD @ Xa) @ (ccfv @ (XG @ Xy1 @ Xt @ Xm @ Xa @ Xc) @ ccbs))))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : (cwceq @ (Xc_1 @ Xa) @ (ccfv @ (XG @ Xy1 @ Xt @ Xm @ Xa @ Xc) @ cc0g))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XW @ Xy1 @ Xm @ Xa) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) @ ccc0)) @ (^ [Xy1:$i] : (ccdif @ (XD @ Xa) @ (ccsn @ (Xc_1 @ Xa))))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwcel @ XX @ (XW @ Xy1 @ Xm @ Xa)))))) => ((! [Xa:$i] : (cwceq @ (XF @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccfv @ (ccv @ Xa) @ ccsqrt) @ ccdiv))))) => (! [Xy1:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwex @ (^ [Xt:$i] : (cwrex @ (^ [Xc:$i] : (cwa @ (cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (ccv @ Xt) @ ccli) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (ccv @ Xt) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xc) @ (ccfv @ (ccv @ Xy1) @ ccsqrt) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico))))) @ (^ [Xc:$i] : (cco @ ccc0 @ ccpnf @ ccico)))))))))))))))))))))))))))).
