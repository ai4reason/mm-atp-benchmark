...
thf(coppcyon_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => ((cwceq @ XY @ (ccfv @ XO @ ccyon)) => ((cwceq @ XM @ (ccfv @ XC @ cchof)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => (cwi @ Xph @ (cwceq @ XY @ (cco @ (ccop @ XO @ XC) @ XM @ cccurf))))))))))))).
