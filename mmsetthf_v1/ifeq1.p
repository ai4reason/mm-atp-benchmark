...
thf(adfif6_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ (ccun @ (ccrab @ (^ [Xx3:$i] : Xph) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xx3:$i] : (cwn @ Xph)) @ (^ [Xx3:$i] : XB2)))))))).
thf(cifeq1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccif @ Xph @ XA2 @ XC) @ (ccif @ Xph @ XB2 @ XC)))))))).
