...
thf(ciscplgredg_conj,conjecture,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XE @ Xv @ Xn) @ (ccfv @ XG @ ccedg)))) => (cwi @ (cwcel @ XG @ XW) @ (cwb @ (cwcel @ XG @ cccplgr) @ (cwral @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xv) @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xv @ Xn)))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
