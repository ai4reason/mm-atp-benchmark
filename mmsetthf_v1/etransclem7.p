...
thf(cetransclem7_conj,conjecture,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XP @ Xj) @ ccn))) => ((! [Xj:$i] : (cwi @ Xph @ (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz) @ (XC @ Xj)))) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xj) @ (cco @ ccc0 @ XM @ ccfz)))) => (cwi @ Xph @ (cwcel @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccif @ (cwbr @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (XP @ Xj) @ ccfa) @ (ccfv @ (cco @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ (XJ @ Xj) @ (ccv @ Xj) @ ccmin) @ (cco @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ ccmin) @ ccexp) @ ccmul)))) @ ccz)))))))))))).
