...
thf(c_2wlkdlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XP @ (ccs3 @ XA2 @ XB2 @ XC)) => ((cwceq @ XF @ (ccs2 @ XJ @ XK)) => (cwceq @ (ccfv @ XP @ cchash) @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccaddc)))))))))))).
