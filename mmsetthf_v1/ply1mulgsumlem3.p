...
thf(aply1mulgsumlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xp:($i > ($i > ($i > ($i > $o))))] : (! [Xc_ex:($i > ($i > ($i > ($i > $o))))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XP @ Xn @ Xs1 @ Xl) @ (ccfv @ XR @ ccpl1))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccbs))))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccco1)) => ((cwceq @ XC @ (ccfv @ XL @ ccco1)) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XX @ Xn @ Xs1 @ Xl) @ (ccfv @ XR @ ccv1))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (Xc_xp @ Xn @ Xs1 @ Xl) @ (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccmulr))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (Xc_x @ Xn @ Xs1 @ Xl) @ (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccvsca))))) => ((! [Xn:$i] : (! [Xl:$i] : (cwceq @ (Xc_as @ Xn @ Xl) @ (ccfv @ XR @ ccmulr)))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XM @ Xn @ Xs1 @ Xl) @ (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccmgp))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (Xc_ex @ Xn @ Xs1 @ Xl) @ (ccfv @ (XM @ Xn @ Xs1 @ Xl) @ ccmg))))) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ XB2) @ (cwcel @ XL @ XB2)) @ (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xn:$i] : (cwi @ (cwbr @ (ccv @ Xs1) @ (ccv @ Xn) @ cclt) @ (cwceq @ (cco @ XR @ (ccmpt @ (^ [Xl:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (^ [Xl:$i] : (cco @ (ccfv @ (ccv @ Xl) @ XA2) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xl) @ ccmin) @ XC) @ (Xc_as @ Xn @ Xl)))) @ ccgsu) @ (ccfv @ XR @ cc0g)))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))))))))))))))).
...
thf(cply1mulgsumlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XP @ Xk @ Xl) @ (ccfv @ XR @ ccpl1)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xk @ Xl) @ ccbs)))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccco1)) => ((cwceq @ XC @ (ccfv @ XL @ ccco1)) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XX @ Xk @ Xl) @ (ccfv @ XR @ ccv1)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_xp @ Xk @ Xl) @ (ccfv @ (XP @ Xk @ Xl) @ ccmulr)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_x @ Xk @ Xl) @ (ccfv @ (XP @ Xk @ Xl) @ ccvsca)))) => ((! [Xl:$i] : (cwceq @ (Xc_as @ Xl) @ (ccfv @ XR @ ccmulr))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XM @ Xk @ Xl) @ (ccfv @ (XP @ Xk @ Xl) @ ccmgp)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_ex @ Xk @ Xl) @ (ccfv @ (XM @ Xk @ Xl) @ ccmg)))) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ XB2) @ (cwcel @ XL @ XB2)) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XR @ (ccmpt @ (^ [Xl:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xl:$i] : (cco @ (ccfv @ (ccv @ Xl) @ XA2) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ ccmin) @ XC) @ (Xc_as @ Xl)))) @ ccgsu))) @ (ccfv @ XR @ cc0g) @ ccfsupp)))))))))))))))))))))))))).
