...
thf(axrs1mnd_thm,axiom,(! [XR:($i > $o)] : ((cwceq @ XR @ (cco @ ccxrs @ (ccdif @ ccxr @ (ccsn @ ccmnf)) @ ccress)) => (cwcel @ XR @ ccmnd)))).
...
thf(cxrge0subm_conj,conjecture,(! [XR:($i > $o)] : ((cwceq @ XR @ (cco @ ccxrs @ (ccdif @ ccxr @ (ccsn @ ccmnf)) @ ccress)) => (cwcel @ (cco @ ccc0 @ ccpnf @ ccicc) @ (ccfv @ XR @ ccsubmnd))))).
