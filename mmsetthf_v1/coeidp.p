...
thf(acoe1term_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XF @ Xz) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ XA2 @ (cco @ (ccv @ Xz) @ XN @ ccexp) @ ccmul))))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0) @ (cwcel @ (XM @ Xz) @ ccn0)) @ (cwceq @ (ccfv @ (XM @ Xz) @ (ccfv @ (XF @ Xz) @ cccoe)) @ (ccif @ (cwceq @ (XM @ Xz) @ XN) @ XA2 @ ccc0)))))))))).
...
thf(ccoeidp_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ ccidp @ cccoe)) @ (ccif @ (cwceq @ XA2 @ cc1) @ cc1 @ ccc0))))).
