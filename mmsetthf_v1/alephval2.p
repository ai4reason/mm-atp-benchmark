...
thf(aalephordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccon0) @ (cwi @ (cwcel @ XA2 @ XB2) @ (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ ccsdm)))))).
...
thf(aentri3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwo @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccdom)))))))).
...
thf(acarddom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwss @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) @ (cwbr @ XA2 @ XB2 @ ccdom)))))))).
thf(asseq1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwb @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XC))))))).
thf(acardom_thm,axiom,(cwceq @ (ccfv @ ccom @ cccrd) @ ccom)).
...
thf(aalephord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ ccsdm)))))).
...
thf(calephval2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ cc0 @ XA2)) @ (cwceq @ (ccfv @ XA2 @ ccale) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ ccale) @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccon0))))))).
