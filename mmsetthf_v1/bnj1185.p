...
thf(cbnj1185_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwn @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XB2))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))).
