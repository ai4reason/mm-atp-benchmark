...
thf(cdvbss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => (cwi @ Xph @ (cwss @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ XA2)))))))))).
