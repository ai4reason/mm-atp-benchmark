...
thf(ascmsuppfi_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xv:$i] : (cwceq @ (XS @ Xv) @ (ccfv @ XM @ ccsca))) => ((! [Xv:$i] : (cwceq @ XR @ (ccfv @ (XS @ Xv) @ ccbs))) => (! [Xv:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) @ (cwcel @ (cco @ XA2 @ (ccfv @ (XS @ Xv) @ cc0g) @ ccsupp) @ ccfn)) @ (cwcel @ (cco @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (cco @ (ccfv @ (ccv @ Xv) @ XA2) @ (ccv @ Xv) @ (ccfv @ XM @ ccvsca)))) @ (ccfv @ XM @ cc0g) @ ccsupp) @ ccfn))))))))))).
