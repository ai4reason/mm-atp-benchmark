...
thf(atanrpcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) @ (cwcel @ (ccfv @ XA2 @ cctan) @ ccrp)))).
...
thf(adivneg2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (ccneg @ (cco @ XA2 @ XB2 @ ccdiv)) @ (cco @ XA2 @ (ccneg @ XB2) @ ccdiv)))))))))).
...
thf(aimmul2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccim) @ (cco @ XA2 @ (ccfv @ XB2 @ ccim) @ ccmul))))))))).
...
thf(atanadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cw3a @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0) @ (cwne @ (ccfv @ XB2 @ cccos) @ ccc0) @ (cwne @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccc0))) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cctan) @ (cco @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccaddc) @ (cco @ cc1 @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) @ ccmin) @ ccdiv)))))).
thf(aoveq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF)))))))))).
thf(arecval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwceq @ (cco @ cc1 @ XA2 @ ccdiv) @ (cco @ (ccfv @ XA2 @ cccj) @ (cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccexp) @ ccdiv))))).
...
thf(ctanregt0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccre) @ cclt)))).
