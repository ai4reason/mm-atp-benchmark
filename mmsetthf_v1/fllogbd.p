...
thf(aeluz2cnn0n1_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1)))))).
...
thf(acxplogb_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) @ (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) @ (cwceq @ (cco @ XB2 @ (cco @ XB2 @ XX @ cclogb) @ cccxp) @ XX))))).
...
thf(cfllogbd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XX @ ccrp)) => ((cwceq @ XE @ (ccfv @ (cco @ XB2 @ XX @ cclogb) @ ccfl)) => (cwi @ Xph @ (cwa @ (cwbr @ (cco @ XB2 @ XE @ ccexp) @ XX @ ccle) @ (cwbr @ XX @ (cco @ XB2 @ (cco @ XE @ cc1 @ ccaddc) @ ccexp) @ cclt))))))))))).
