...
thf(acmbr4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwss @ (ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) @ XB2))))))).
...
thf(apjoml4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwceq @ (cco @ XA2 @ (ccin @ XB2 @ (cco @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort) @ cchj)) @ cchj) @ (cco @ XA2 @ XB2 @ cchj))))))).
...
thf(cosumcor2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ (cco @ XA2 @ XB2 @ ccph) @ (cco @ XA2 @ XB2 @ cchj)))))))).
