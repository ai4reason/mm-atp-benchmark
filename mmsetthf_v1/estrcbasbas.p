...
thf(cestrcbasbas_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccestrc)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => (cwi @ (cwa @ Xph @ (cwcel @ XE @ XB2)) @ (cwcel @ (ccfv @ XE @ ccbs) @ XU))))))))))).
