...
thf(csbth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccdom)) @ (cwbr @ XA2 @ XB2 @ ccen))))).
