...
thf(annunb_thm,axiom,(cwn @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwo @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccr)))).
...
thf(carch_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwrex @ (^ [Xn:$i] : (cwbr @ XA2 @ (ccv @ Xn) @ cclt)) @ (^ [Xn:$i] : ccn))))).
