...
thf(ctrclun_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW)) @ (cwceq @ (ccfv @ (ccun @ XR @ XS) @ cctcl) @ (ccfv @ (ccun @ (ccfv @ XR @ cctcl) @ (ccfv @ XS @ cctcl)) @ cctcl)))))))).
