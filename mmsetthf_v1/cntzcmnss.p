...
thf(ccntzcmnss_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => (cwi @ (cwa @ (cwcel @ XG @ cccmn) @ (cwss @ XS @ XB2)) @ (cwss @ XS @ (ccfv @ XS @ XZ)))))))))).
