...
thf(aclsndisj_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))) @ (cwa @ (cwcel @ XU @ XJ) @ (cwcel @ XP @ XU))) @ (cwne @ (ccin @ XU @ XS) @ cc0))))))))).
...
thf(cmetdseq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XD @ ccmopn))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX) @ (cwcel @ XA2 @ XX)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ ccc0) @ (cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ (XJ @ Xx3) @ cccl)))))))))))))))).
