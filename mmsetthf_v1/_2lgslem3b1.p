...
thf(a_2lgslem3b_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XK @ ccn0) @ (cwceq @ XP @ (cco @ (cco @ cc8 @ XK @ ccmul) @ cc3 @ ccaddc))) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ XK @ ccmul) @ cc1 @ ccaddc)))))))).
...
thf(c_2lgslem3b1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XP @ ccn) @ (cwceq @ (cco @ XP @ cc8 @ ccmo) @ cc3)) @ (cwceq @ (cco @ XN @ cc2 @ ccmo) @ cc1)))))).
