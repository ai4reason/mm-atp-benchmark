...
thf(a_3cshw_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz)) @ (cwceq @ (cco @ XW @ XN @ cccsh) @ (cco @ (cco @ (cco @ XW @ XM @ cccsh) @ XN @ cccsh) @ (cco @ (ccfv @ XW @ cchash) @ XM @ ccmin) @ cccsh)))))))).
...
thf(acshwleneq_thm,axiom,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV))) @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz)) @ (cwceq @ (cco @ XW @ XN @ cccsh) @ (cco @ XU @ XM @ cccsh))) @ (cwceq @ (ccfv @ XW @ cchash) @ (ccfv @ XU @ cchash))))))))).
...
thf(ccshweqdif2_conj,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV))) @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz))) @ (cwi @ (cwceq @ (cco @ XW @ XN @ cccsh) @ (cco @ XU @ XM @ cccsh)) @ (cwceq @ (cco @ XU @ (cco @ XM @ XN @ ccmin) @ cccsh) @ XW))))))))).
