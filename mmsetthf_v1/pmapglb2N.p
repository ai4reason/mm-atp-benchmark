...
thf(cpmapglb2N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccfv @ XK @ ccglb))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xx3:$i] : (cwceq @ (XM @ Xx3) @ (ccfv @ XK @ ccpmap))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwss @ XS @ XB2)) @ (cwceq @ (ccfv @ (ccfv @ XS @ (XG @ Xx3)) @ (XM @ Xx3)) @ (ccin @ XA2 @ (cciin @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XM @ Xx3))))))))))))))))))).
