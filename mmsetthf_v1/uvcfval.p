...
thf(adf_uvc_ax,axiom,(cwceq @ ccuvc @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : (ccmpt @ (^ [Xj:$i] : (ccv @ Xi)) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : (ccv @ Xi)) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (ccv @ Xj)) @ (ccfv @ (ccv @ Xr) @ ccur) @ (ccfv @ (ccv @ Xr) @ cc0g))))))))))).
