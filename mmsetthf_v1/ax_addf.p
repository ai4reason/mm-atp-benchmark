...
thf(amosubop_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) => (cwmo @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwa @ (cwceq @ XA2 @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))))).
...
thf(adf_add_ax,axiom,(cwceq @ ccaddc @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc)) @ (cwex @ (^ [Xw:$i] : (cwex @ (^ [Xv:$i] : (cwex @ (^ [Xu:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwa @ (cwceq @ (ccv @ Xx3) @ (ccop @ (ccv @ Xw) @ (ccv @ Xv))) @ (cwceq @ (ccv @ Xy1) @ (ccop @ (ccv @ Xu) @ (ccv @ Xf1)))) @ (cwceq @ (ccv @ Xz) @ (ccop @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccplr) @ (cco @ (ccv @ Xv) @ (ccv @ Xf1) @ ccplr))))))))))))))))))).
...
thf(aoprssdm_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwn @ (cwcel @ cc0 @ XS)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XS)))) => (cwss @ (ccxp @ XS @ XS) @ (ccdm @ XF))))))).
thf(a_0ncn_thm,axiom,(cwn @ (cwcel @ cc0 @ ccc))).
thf(asyl6eleqr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((cwceq @ XC @ XB2) => (cwi @ Xph @ (cwcel @ XA2 @ XC))))))))).
thf(a_2optocl_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XR @ Xx3 @ Xy1) @ (ccxp @ XC @ XD)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwceq @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (Xps @ Xz @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwceq @ (ccop @ (ccv @ Xz) @ (ccv @ Xw)) @ (XB2 @ Xx3 @ Xy1)) @ (cwb @ (Xps @ Xz @ Xw) @ (Xch @ Xx3 @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XC) @ (cwcel @ (ccv @ Xy1) @ XD)) @ (cwa @ (cwcel @ (ccv @ Xz) @ XC) @ (cwcel @ (ccv @ Xw) @ XD))) @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XR @ Xx3 @ Xy1)) @ (cwcel @ (XB2 @ Xx3 @ Xy1) @ (XR @ Xx3 @ Xy1))) @ (Xch @ Xx3 @ Xy1))))))))))))))))).
...
thf(aaddcnsr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccnr) @ (cwcel @ XB2 @ ccnr)) @ (cwa @ (cwcel @ XC @ ccnr) @ (cwcel @ XD @ ccnr))) @ (cwceq @ (cco @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccaddc) @ (ccop @ (cco @ XA2 @ XC @ ccplr) @ (cco @ XB2 @ XD @ ccplr))))))))).
...
thf(cax_addf_conj,conjecture,(cwf @ (ccxp @ ccc @ ccc) @ ccc @ ccaddc)).
