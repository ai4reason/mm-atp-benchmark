...
thf(apmatcoe1fsupp_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : (cwceq @ (XP @ Xx3 @ Xi @ Xj @ Xs1) @ (ccfv @ XR @ ccpl1)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : (cwceq @ (XC @ Xx3 @ Xi @ Xj @ Xs1) @ (cco @ XN @ (XP @ Xx3 @ Xi @ Xj @ Xs1) @ ccmat)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : (cwceq @ XB2 @ (ccfv @ (XC @ Xx3 @ Xi @ Xj @ Xs1) @ ccbs)))))) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) @ (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)) @ Xc_0)) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))).
...
thf(amat0op_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_0 @ Xi @ Xj) @ (ccfv @ XR @ cc0g)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwceq @ (ccfv @ (XA2 @ Xi @ Xj) @ cc0g) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (Xc_0 @ Xi @ Xj))))))))))))))).
...
thf(adecpmatmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((! [Xk:$i] : (cwceq @ (XC @ Xk) @ (cco @ XN @ XP @ ccmat))) => ((! [Xk:$i] : (cwceq @ XB2 @ (ccfv @ (XC @ Xk) @ ccbs))) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwa @ (cwcel @ XU @ XB2) @ (cwcel @ XW @ XB2)) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (cco @ (cco @ XU @ XW @ (ccfv @ (XC @ Xk) @ ccmulr)) @ XK @ ccdecpmat) @ (cco @ XA2 @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XK @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XU @ (ccv @ Xk) @ ccdecpmat) @ (cco @ XW @ (cco @ XK @ (ccv @ Xk) @ ccmin) @ ccdecpmat) @ (ccfv @ XA2 @ ccmulr)))) @ ccgsu)))))))))))))))))).
thf(asylan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ Xph @ Xch) @ Xth)))))))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(adecpmatval_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ (XN @ Xi @ Xj) @ (XR @ Xi @ Xj) @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => (cwi @ (cwa @ (cwcel @ XM @ XB2) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (cco @ XM @ XK @ ccdecpmat) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ XK @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)))))))))))))))).
thf(cdecpmatmulsumfsupp_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xl:$i] : (cwceq @ (XP @ Xl) @ (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XC @ Xk @ Xl) @ (cco @ XN @ (XP @ Xl) @ ccmat)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XC @ Xk @ Xl) @ ccbs)))) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((! [Xk:$i] : (cwceq @ (Xc_x @ Xk) @ (ccfv @ XA2 @ ccmulr))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_0 @ Xk @ Xl) @ (ccfv @ XA2 @ cc0g)))) => (! [Xk:$i] : (! [Xl:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2))) @ (cwbr @ (ccmpt @ (^ [Xl:$i] : ccn0) @ (^ [Xl:$i] : (cco @ XA2 @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ (ccv @ Xl) @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccdecpmat) @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xl) @ (ccv @ Xk) @ ccmin) @ ccdecpmat) @ (Xc_x @ Xk)))) @ ccgsu))) @ (Xc_0 @ Xk @ Xl) @ ccfsupp))))))))))))))))))))).
