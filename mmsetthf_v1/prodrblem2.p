...
thf(aclimres_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XF @ XV)) @ (cwb @ (cwbr @ (ccres @ XF @ (ccfv @ XM @ ccuz)) @ XA2 @ ccli) @ (cwbr @ XF @ XA2 @ ccli)))))))).
...
thf(aprodrblem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xk) @ (ccfv @ (XM @ Xk) @ ccuz)))) => (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwss @ XA2 @ (ccfv @ (XN @ Xk) @ ccuz))) @ (cwceq @ (ccres @ (ccseq @ ccmul @ XF @ (XM @ Xk)) @ (ccfv @ (XN @ Xk) @ ccuz)) @ (ccseq @ ccmul @ XF @ (XN @ Xk))))))))))))))).
thf(aadantlr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ (cwa @ Xph @ Xth) @ Xps) @ Xch))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(cprodrblem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwss @ XA2 @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwss @ XA2 @ (ccfv @ XN @ ccuz))) => (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) @ (cwb @ (cwbr @ (ccseq @ ccmul @ XF @ XM) @ (XC @ Xk) @ ccli) @ (cwbr @ (ccseq @ ccmul @ XF @ XN) @ (XC @ Xk) @ ccli)))))))))))))))))).
