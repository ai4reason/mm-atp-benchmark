...
thf(a_0fallfac_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ ccc0 @ XN @ ccfallfac) @ ccc0)))).
...
thf(c_0risefac_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ ccc0 @ XN @ ccrisefac) @ ccc0)))).
