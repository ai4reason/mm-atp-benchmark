...
thf(cfdmdifeqresdif_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XY) @ (XX @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XG)))))) => (! [Xx3:$i] : (cwi @ (cwf @ (ccdif @ XD @ (ccsn @ XY)) @ XR @ XG) @ (cwceq @ XG @ (ccres @ (XF @ Xx3) @ (ccdif @ XD @ (ccsn @ XY)))))))))))))).
