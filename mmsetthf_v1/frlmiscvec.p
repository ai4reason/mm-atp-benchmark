...
thf(afrlmisfrlm_thm,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ ccnzr) @ (cwcel @ XI @ XY) @ (cwbr @ XI @ XJ @ ccen)) @ (cwbr @ (cco @ XR @ XI @ ccfrlm) @ (cco @ XR @ XJ @ ccfrlm) @ cclmic))))))).
thf(cfrlmiscvec_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccnzr) @ (cwcel @ XI @ XY)) @ (cwbr @ (cco @ XR @ XI @ ccfrlm) @ (cco @ XR @ (ccxp @ XI @ (ccsn @ cc0)) @ ccfrlm) @ cclmic)))))).
