...
thf(csshjval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ cchil) @ (cwss @ XB2 @ cchil)) @ (cwceq @ (cco @ XA2 @ XB2 @ cchj) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccun @ XA2 @ XB2) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : ccch)))))))).
