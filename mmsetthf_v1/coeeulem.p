...
thf(aplyeq0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ (ccun @ XS @ (ccsn @ ccc0)) @ ccn0 @ ccmap))) => ((cwi @ Xph @ (cwceq @ (ccima @ XA2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0))) => ((cwi @ Xph @ (cwceq @ cc0p @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))) => (cwi @ Xph @ (cwceq @ XA2 @ (ccxp @ ccn0 @ (ccsn @ ccc0)))))))))))))).
