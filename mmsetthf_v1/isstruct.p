...
thf(cisstruct_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwbr @ XF @ (ccop @ XM @ XN) @ ccstr) @ (cw3a @ (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn) @ (cwbr @ XM @ XN @ ccle)) @ (cwfun @ (ccdif @ XF @ (ccsn @ cc0))) @ (cwss @ (ccdm @ XF) @ (cco @ XM @ XN @ ccfz)))))))).
