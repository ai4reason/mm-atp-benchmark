...
thf(crec11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0))) @ (cwb @ (cwceq @ (cco @ cc1 @ XA2 @ ccdiv) @ (cco @ cc1 @ XB2 @ ccdiv)) @ (cwceq @ XA2 @ XB2)))))).
