...
thf(arnghmresel_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwceq @ XH @ (ccres @ ccrngh @ (ccxp @ XB2 @ XB2)))) => (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwcel @ XF @ (cco @ XX @ XY @ XH))) @ (cwcel @ XF @ (cco @ XX @ XY @ ccrngh))))))))))).
...
thf(arnghmco_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XT @ XU @ ccrngh)) @ (cwcel @ XG @ (cco @ XS @ XT @ ccrngh))) @ (cwcel @ (cccom @ XF @ XG) @ (cco @ XS @ XU @ ccrngh))))))))).
