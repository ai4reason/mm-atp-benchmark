...
thf(aordunisssuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccon0) @ (cword @ XB2)) @ (cwb @ (cwss @ (ccuni @ XA2) @ XB2) @ (cwss @ XA2 @ (ccsuc @ XB2))))))).
thf(crankbnd2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwcel @ XB2 @ ccon0) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ XB2)) @ (^ [Xx3:$i] : XA2)) @ (cwss @ (ccfv @ XA2 @ ccrnk) @ (ccsuc @ XB2)))))))).
