...
thf(csumpr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XA2) @ (cwceq @ (XC @ Xk) @ XD))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XB2) @ (cwceq @ (XC @ Xk) @ XE))) => ((cwi @ Xph @ (cwa @ (cwcel @ XD @ ccc) @ (cwcel @ XE @ ccc))) => ((cwi @ Xph @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW))) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccsu @ (ccpr @ XA2 @ XB2) @ (^ [Xk:$i] : (XC @ Xk))) @ (cco @ XD @ XE @ ccaddc))))))))))))))))).
