...
thf(apjch_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwcel @ XH @ ccch) @ (cwcel @ XA2 @ cchil)) @ (cwb @ (cwcel @ XA2 @ XH) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ XA2)))))).
thf(cpjvec_conj,conjecture,(! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ ccch) @ (cwceq @ XH @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XH @ ccpjh)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : cchil)))))).
