...
thf(cprmorcht_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccv @ Xn) @ cc1))))) => (! [Xn:$i] : (cwi @ (cwcel @ (XA2 @ Xn) @ ccn) @ (cwceq @ (ccfv @ (ccfv @ (XA2 @ Xn) @ cccht) @ cce) @ (ccfv @ (XA2 @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))).
