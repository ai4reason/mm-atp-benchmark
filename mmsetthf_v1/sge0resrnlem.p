...
thf(csge0resrnlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XG)) => ((cwi @ Xph @ (cwcel @ XX @ (ccpw @ XA2))) => ((cwi @ Xph @ (cwf1o @ XX @ (ccrn @ XG) @ (ccres @ XG @ XX))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccres @ XF @ (ccrn @ XG)) @ ccsumge0) @ (ccfv @ (cccom @ XF @ XG) @ ccsumge0) @ ccle))))))))))))))).
