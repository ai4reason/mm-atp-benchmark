...
thf(adf_ldil_ax,axiom,(cwceq @ ccldil @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccple)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccbs)))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xk) @ cclaut))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cldilfset_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : ((! [Xw:$i] : (! [Xf1:$i] : (cwceq @ (XB2 @ Xw @ Xf1) @ (ccfv @ XK @ ccbs)))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (cwceq @ (Xc_le @ Xx3 @ Xw @ Xf1) @ (ccfv @ XK @ ccple))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (cwceq @ (XH @ Xx3 @ Xf1) @ (ccfv @ XK @ cclh)))) => ((! [Xx3:$i] : (! [Xw:$i] : (cwceq @ (XI @ Xx3 @ Xw) @ (ccfv @ XK @ cclaut)))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (cwi @ (cwcel @ XK @ (XC @ Xx3 @ Xw @ Xf1)) @ (cwceq @ (ccfv @ XK @ ccldil) @ (ccmpt @ (^ [Xw:$i] : (XH @ Xx3 @ Xf1)) @ (^ [Xw:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xw) @ (Xc_le @ Xx3 @ Xw @ Xf1)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xw @ Xf1)))) @ (^ [Xf1:$i] : (XI @ Xx3 @ Xw))))))))))))))))))))).
