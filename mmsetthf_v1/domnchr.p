...
thf(achrnzr_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccrg) @ (cwb @ (cwcel @ XR @ ccnzr) @ (cwne @ (ccfv @ XR @ ccchr) @ cc1))))).
...
thf(aisprm6_thm,axiom,(! [XP:($i > $o)] : (cwb @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ XP @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ ccdvds) @ (cwo @ (cwbr @ XP @ (ccv @ Xx3) @ ccdvds) @ (cwbr @ XP @ (ccv @ Xy1) @ ccdvds)))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))).
thf(cdomnchr_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccdomn) @ (cwo @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0) @ (cwcel @ (ccfv @ XR @ ccchr) @ ccprime))))).
