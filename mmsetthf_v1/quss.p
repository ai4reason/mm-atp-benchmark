...
thf(cquss_conj,conjecture,(! [Xph:$o] : (! [Xc_sm:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XR @ Xc_sm @ ccqus))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwcel @ Xc_sm @ XW)) => ((cwi @ Xph @ (cwcel @ XR @ XZ)) => ((cwceq @ XK @ (ccfv @ XR @ ccsca)) => (cwi @ Xph @ (cwceq @ XK @ (ccfv @ XU @ ccsca))))))))))))))))).
