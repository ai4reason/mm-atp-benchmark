...
thf(cctvonmbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ ccr @ XX @ ccmap))) => ((cwi @ Xph @ (cwbr @ XA2 @ ccom @ ccdom)) => (cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ (ccfv @ XX @ ccvoln))))))))))).
