...
thf(aodinv_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ XI) @ XO) @ (ccfv @ XA2 @ XO)))))))))))).
...
thf(ctorsubg_conj,conjecture,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwi @ (cwcel @ XG @ ccabl) @ (cwcel @ (ccima @ (cccnv @ XO) @ ccn) @ (ccfv @ XG @ ccsubg))))))).
