...
thf(aupgrn0_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) @ (cwne @ (ccfv @ XF @ XE) @ cc0)))))))))).
...
thf(aupgrss_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XF @ (ccdm @ XE))) @ (cwss @ (ccfv @ XF @ XE) @ XV))))))))).
...
thf(aupgrfi_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) @ (cwcel @ (ccfv @ XF @ XE) @ ccfn)))))))))).
...
thf(aupgrle_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) @ (cwbr @ (ccfv @ (ccfv @ XF @ XE) @ cchash) @ cc2 @ ccle)))))))))).
...
thf(cupgrex_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccfv @ XF @ XE) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV))))))))))).
