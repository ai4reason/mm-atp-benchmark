...
thf(adochexmidlem8_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ XS @ (ccfv @ XU @ cclss)) => ((cwceq @ XN @ (ccfv @ XU @ cclspn)) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XU @ cclsa)) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => ((cwceq @ Xc_0 @ (ccfv @ XU @ cc0g)) => ((cwi @ Xph @ (cwne @ XX @ (ccsn @ Xc_0))) => ((cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) @ XX)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ (ccfv @ XX @ Xc_pe) @ Xc_po) @ XV))))))))))))))))))))))))))))).
