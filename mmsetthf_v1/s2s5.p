...
thf(as1s4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (cwceq @ (ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) @ (cco @ (ccs1 @ XA2) @ (ccs4 @ XB2 @ XC @ XD @ XE) @ ccconcat)))))))).
...
thf(cs2s5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ (cco @ (ccs2 @ XA2 @ XB2) @ (ccs5 @ XC @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
