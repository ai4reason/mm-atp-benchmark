...
thf(ctgphaus_conj,conjecture,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwi @ (cwcel @ XG @ cctgp) @ (cwb @ (cwcel @ XJ @ ccha) @ (cwcel @ (ccsn @ Xc_0) @ (ccfv @ XJ @ cccld)))))))))).
