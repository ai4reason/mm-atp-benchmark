...
thf(chhcnf_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XD @ (cccom @ ccno @ ccmv)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (cwceq @ cccnfn @ (cco @ XJ @ XK @ cccn))))))))).
