...
thf(ametdcn2_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ XD @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn)))))))))).
...
thf(cmsdcn_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XM @ ccbs)) => ((cwceq @ XD @ (ccfv @ XM @ ccds)) => ((cwceq @ XJ @ (ccfv @ XM @ cctopn)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwi @ (cwcel @ XM @ ccmt) @ (cwcel @ (ccres @ XD @ (ccxp @ XX @ XX)) @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn))))))))))))).
