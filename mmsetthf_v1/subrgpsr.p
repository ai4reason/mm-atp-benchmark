...
thf(aresspsrbas_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (cco @ XI @ XH @ ccmps)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => ((cwceq @ XP @ (cco @ XS @ XB2 @ ccress)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => (cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XP @ ccbs))))))))))))))))))).
...
thf(aresspsrmul_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (cco @ XI @ XH @ ccmps)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => ((cwceq @ XP @ (cco @ XS @ XB2 @ ccress)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (cco @ XX @ XY @ (ccfv @ XU @ ccmulr)) @ (cco @ XX @ XY @ (ccfv @ XP @ ccmulr)))))))))))))))))))))).
...
thf(csubrgpsr_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (cco @ XI @ XH @ ccmps)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => (cwi @ (cwa @ (cwcel @ XI @ XV) @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) @ (cwcel @ XB2 @ (ccfv @ XS @ ccsubrg)))))))))))))))).
