...
thf(apsgndif_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xq:$i] : (cwceq @ XP @ (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : (cwceq @ (XS @ Xq) @ (ccfv @ (XN @ Xq) @ ccpsgn))) => ((! [Xq:$i] : (cwceq @ (XZ @ Xq) @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpsgn))) => (! [Xq:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xq) @ ccfn) @ (cwcel @ XK @ (XN @ Xq))) @ (cwi @ (cwcel @ XQ @ (ccrab @ (^ [Xq:$i] : (cwceq @ (ccfv @ XK @ (ccv @ Xq)) @ XK)) @ (^ [Xq:$i] : XP))) @ (cwceq @ (ccfv @ (ccres @ XQ @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) @ (XZ @ Xq)) @ (ccfv @ XQ @ (XS @ Xq)))))))))))))))).
...
thf(czrhcopsgndif_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xq:$i] : (cwceq @ XP @ (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : (cwceq @ (XS @ Xq) @ (ccfv @ (XN @ Xq) @ ccpsgn))) => ((! [Xq:$i] : (cwceq @ (XZ @ Xq) @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpsgn))) => ((! [Xq:$i] : (cwceq @ (XY @ Xq) @ (ccfv @ (XR @ Xq) @ cczrh))) => (! [Xq:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xq) @ ccfn) @ (cwcel @ XK @ (XN @ Xq))) @ (cwi @ (cwcel @ XQ @ (ccrab @ (^ [Xq:$i] : (cwceq @ (ccfv @ XK @ (ccv @ Xq)) @ XK)) @ (^ [Xq:$i] : XP))) @ (cwceq @ (ccfv @ (ccres @ XQ @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) @ (cccom @ (XY @ Xq) @ (XZ @ Xq))) @ (ccfv @ XQ @ (cccom @ (XY @ Xq) @ (XS @ Xq)))))))))))))))))))).
