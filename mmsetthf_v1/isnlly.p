...
thf(adf_nlly_ax,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccnlly @ XA2) @ (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xu) @ ccrest) @ XA2)) @ (^ [Xu:$i] : (ccin @ (ccfv @ (ccsn @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xj) @ ccnei)) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xj)))) @ (^ [Xj:$i] : cctop))))).
thf(cisnlly_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ (ccnlly @ XA2)) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ XA2)) @ (^ [Xu:$i] : (ccin @ (ccfv @ (ccsn @ (ccv @ Xy1)) @ (ccfv @ XJ @ ccnei)) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ))))))).
