...
thf(abj_eqs_thm,axiom,(! [Xph:$o] : (! [Xy1:$i] : (cwb @ Xph @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ Xph))))))).
thf(cbj_sb_conj,conjecture,(! [Xph:($i > $o)] : (! [Xx3:$i] : (cwb @ (Xph @ Xx3) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3))))))))))).
