...
thf(clswccats1fst_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwceq @ (ccfv @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ cclsw) @ (ccfv @ ccc0 @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat))))))).
