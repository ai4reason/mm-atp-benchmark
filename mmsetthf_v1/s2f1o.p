...
thf(cs2f1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwne @ XA2 @ XB2)) @ (cwi @ (cwceq @ XE @ (ccs2 @ XA2 @ XB2)) @ (cwf1o @ (ccpr @ ccc0 @ cc1) @ (ccpr @ XA2 @ XB2) @ XE)))))))).
