...
thf(cpmtridfv2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwi @ Xph @ (cwcel @ XY @ XA2)) => ((cwceq @ XT @ (ccif @ (cwceq @ XX @ XY) @ (ccres @ ccid @ XA2) @ (ccfv @ (ccpr @ XX @ XY) @ (ccfv @ XA2 @ ccpmtr)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XY @ XT) @ XX))))))))))))).
