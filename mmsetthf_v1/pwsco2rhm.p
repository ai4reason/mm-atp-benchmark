...
thf(cpwsco2rhm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XA2 @ ccpws)) => ((cwceq @ XZ @ (cco @ XS @ XA2 @ ccpws)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xg1)))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xg1:$i] : XB2) @ (^ [Xg1:$i] : (cccom @ XF @ (ccv @ Xg1)))) @ (cco @ XY @ XZ @ ccrh)))))))))))))))))).
