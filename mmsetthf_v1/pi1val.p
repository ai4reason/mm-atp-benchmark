...
thf(adf_pi1_ax,axiom,(cwceq @ ccpi1 @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xy1:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xy1:$i] : (ccuni @ (ccv @ Xj)))) @ (^ [Xj:$i] : (^ [Xy1:$i] : (cco @ (cco @ (ccv @ Xj) @ (ccv @ Xy1) @ ccomi) @ (ccfv @ (ccv @ Xj) @ ccphtpc) @ ccqus)))))).
...
thf(cpi1val_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((cwceq @ XO @ (cco @ XJ @ XY @ ccomi)) => (cwi @ Xph @ (cwceq @ XG @ (cco @ XO @ (ccfv @ XJ @ ccphtpc) @ ccqus)))))))))))))).
