...
thf(ahvaddsub4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwa @ (cwcel @ XC @ cchil) @ (cwcel @ XD @ cchil))) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccva) @ (cco @ XC @ XD @ ccva)) @ (cwceq @ (cco @ XA2 @ XC @ ccmv) @ (cco @ XD @ XB2 @ ccmv))))))))).
...
thf(ccdjreui_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwi @ (cwa @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccph)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)) @ (cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XC @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
