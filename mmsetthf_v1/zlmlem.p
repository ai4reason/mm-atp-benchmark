...
thf(czlmlem_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccfv @ XG @ cczlm)) => ((cwceq @ XE @ (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwbr @ XN @ cc5 @ cclt) => (cwceq @ (ccfv @ XG @ XE) @ (ccfv @ XW @ XE))))))))))).
