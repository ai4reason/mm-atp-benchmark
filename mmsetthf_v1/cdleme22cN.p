...
thf(ccdleme22cN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwa @ (cwcel @ XS @ XA2) @ (cwn @ (cwbr @ XS @ XW @ Xc_le))) @ (cwcel @ XT @ XA2) @ (cwa @ (cwcel @ XV @ XA2) @ (cwbr @ XV @ XW @ Xc_le))) @ (cw3a @ (cwa @ (cwne @ XP @ XQ) @ (cwne @ XS @ XT)) @ (cwa @ (cwbr @ XS @ (cco @ XT @ XV @ Xc_or) @ Xc_le) @ (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) @ (cwne @ (cco @ XT @ XV @ Xc_or) @ (cco @ XP @ XQ @ Xc_or)))) @ (cwn @ (cwbr @ XV @ (cco @ XP @ XQ @ Xc_or) @ Xc_le))))))))))))))))))))).
