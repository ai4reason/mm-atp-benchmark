...
thf(alsmfval_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xt:$i] : (cwceq @ (Xc_po @ Xx3 @ Xy1 @ Xu @ Xt) @ (ccfv @ XG @ cclsm)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xt:$i] : (cwi @ (cwcel @ XG @ (XV @ Xx3 @ Xy1 @ Xu @ Xt)) @ (cwceq @ (Xc_po @ Xx3 @ Xy1 @ Xu @ Xt) @ (ccmpt2 @ (^ [Xt:$i] : (^ [Xu:$i] : (ccpw @ XB2))) @ (^ [Xt:$i] : (^ [Xu:$i] : (ccpw @ XB2))) @ (^ [Xt:$i] : (^ [Xu:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xt))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xu))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl))))))))))))))))))))))).
