...
thf(advdsr01_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2)) @ (cwbr @ XX @ Xc_0 @ Xc_pa))))))))))).
...
thf(ar1pdeglt_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XE @ (ccfv @ XR @ ccr1p)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) @ (cwbr @ (ccfv @ (cco @ XF @ XG @ XE) @ XD) @ (ccfv @ XG @ XD) @ cclt)))))))))))))))).
...
thf(ar1pval_thm,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XE @ (ccfv @ XR @ ccr1p)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XQ @ (ccfv @ XR @ ccq1p)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => (cwi @ (cwa @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) @ (cwceq @ (cco @ XF @ XG @ XE) @ (cco @ XF @ (cco @ (cco @ XF @ XG @ XQ) @ XG @ Xc_x) @ Xc_mi))))))))))))))))))).
...
thf(alidlmcl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XI))) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI))))))))))))).
thf(ccsubg_tp,type,(ccsubg : ($i > $o))).
thf(alidlsubcl_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ Xc_mi @ (ccfv @ XR @ ccsg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU)) @ (cwa @ (cwcel @ XX @ XI) @ (cwcel @ XY @ XI))) @ (cwcel @ (cco @ XX @ XY @ Xc_mi) @ XI))))))))))).
...
thf(adeg1n0ima_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwss @ (ccima @ XD @ (ccdif @ XB2 @ (ccsn @ Xc_0))) @ ccn0)))))))))))).
...
thf(alidl0cl_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU)) @ (cwcel @ Xc_0 @ XI))))))))).
...
thf(afnimaeq0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwss @ XB2 @ XA2)) @ (cwb @ (cwceq @ (ccima @ XF @ XB2) @ cc0) @ (cwceq @ XB2 @ cc0))))))).
...
thf(ainfssuzle_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ (ccfv @ XM @ ccuz)) @ (cwcel @ XA2 @ XS)) @ (cwbr @ (ccinf @ XS @ ccr @ cclt) @ XA2 @ ccle)))))).
thf(ccgrp_tp,type,(ccgrp : ($i > $o))).
thf(advdsr1p_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_pa @ (ccfv @ XP @ ccdsr)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwceq @ XE @ (ccfv @ XR @ ccr1p)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) @ (cwb @ (cwbr @ XG @ XF @ Xc_pa) @ (cwceq @ (cco @ XF @ XG @ XE) @ Xc_0))))))))))))))))))).
thf(cig1pdvds_conj,conjecture,(! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XG @ (ccfv @ XR @ ccig1p)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ Xc_pa @ (ccfv @ XP @ ccdsr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ XU) @ (cwcel @ XX @ XI)) @ (cwbr @ (ccfv @ XI @ XG) @ XX @ Xc_pa)))))))))))))).
