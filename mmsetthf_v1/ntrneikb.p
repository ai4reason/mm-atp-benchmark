...
thf(aimnot_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwn @ Xps) @ (cwb @ (cwi @ Xph @ Xps) @ (cwn @ Xph)))))).
...
thf(ar3al_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1 @ Xz))) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))))))).
thf(cntrneikb_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XO @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : (cco @ (ccpw @ (ccv @ Xj)) @ (ccv @ Xi) @ ccmap)) @ (^ [Xk:$i] : (ccmpt @ (^ [Xl:$i] : (ccv @ Xj)) @ (^ [Xl:$i] : (ccrab @ (^ [Xm:$i] : (cwcel @ (ccv @ Xl) @ (ccfv @ (ccv @ Xm) @ (ccv @ Xk)))) @ (^ [Xm:$i] : (ccv @ Xi))))))))))))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwceq @ (XF @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (cco @ (ccpw @ XB2) @ XB2 @ (XO @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl))))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xm) @ (cwbr @ (XI @ Xt @ Xi @ Xj @ Xs1) @ (XN @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (XF @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl))))))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xm) @ (cwb @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwi @ (cwceq @ (ccin @ (ccv @ Xs1) @ (ccv @ Xt)) @ cc0) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xs1) @ (XI @ Xt @ Xi @ Xj @ Xs1)) @ (ccfv @ (ccv @ Xt) @ (XI @ Xt @ Xi @ Xj @ Xs1))) @ cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xx3) @ (XN @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl))) @ (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xx3) @ (XN @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl)))) @ (cwne @ (ccin @ (ccv @ Xs1) @ (ccv @ Xt)) @ cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2)))) @ (^ [Xx3:$i] : XB2))))))))))))))))))).
