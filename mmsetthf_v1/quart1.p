...
thf(abinom4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc4 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc4 @ ccexp) @ (cco @ cc4 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ cc6 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmul) @ (cco @ (cco @ cc4 @ (cco @ XA2 @ (cco @ XB2 @ cc3 @ ccexp) @ ccmul) @ ccmul) @ (cco @ XB2 @ cc4 @ ccexp) @ ccaddc) @ ccaddc) @ ccaddc)))))).
...
thf(adivcan5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwa @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwne @ XC @ ccc0))) @ (cwceq @ (cco @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccdiv) @ (cco @ XA2 @ XB2 @ ccdiv))))))).
...
thf(aquart1lem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwceq @ XP @ (cco @ XB2 @ (cco @ (cco @ cc3 @ cc8 @ ccdiv) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ ccmin))) => ((cwi @ Xph @ (cwceq @ XQ @ (cco @ (cco @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc8 @ ccdiv) @ ccaddc))) => ((cwi @ Xph @ (cwceq @ XR @ (cco @ (cco @ XD @ (cco @ (cco @ XC @ XA2 @ ccmul) @ cc4 @ ccdiv) @ ccmin) @ (cco @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XB2 @ ccmul) @ (ccdc @ cc1 @ cc6) @ ccdiv) @ (cco @ (cco @ cc3 @ (ccdc @ (ccdc @ cc2 @ cc5) @ cc6) @ ccdiv) @ (cco @ XA2 @ cc4 @ ccexp) @ ccmul) @ ccmin) @ ccaddc))) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwceq @ XY @ (cco @ XX @ (cco @ XA2 @ cc4 @ ccdiv) @ ccaddc))) => (cwi @ Xph @ (cwceq @ XD @ (cco @ (cco @ (cco @ (cco @ XA2 @ cc4 @ ccexp) @ (ccdc @ (ccdc @ cc2 @ cc5) @ cc6) @ ccdiv) @ (cco @ XP @ (cco @ (cco @ XA2 @ cc4 @ ccdiv) @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ XQ @ (cco @ XA2 @ cc4 @ ccdiv) @ ccmul) @ XR @ ccaddc) @ ccaddc))))))))))))))))))))))).
thf(cquart1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwceq @ XP @ (cco @ XB2 @ (cco @ (cco @ cc3 @ cc8 @ ccdiv) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ ccmin))) => ((cwi @ Xph @ (cwceq @ XQ @ (cco @ (cco @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc8 @ ccdiv) @ ccaddc))) => ((cwi @ Xph @ (cwceq @ XR @ (cco @ (cco @ XD @ (cco @ (cco @ XC @ XA2 @ ccmul) @ cc4 @ ccdiv) @ ccmin) @ (cco @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XB2 @ ccmul) @ (ccdc @ cc1 @ cc6) @ ccdiv) @ (cco @ (cco @ cc3 @ (ccdc @ (ccdc @ cc2 @ cc5) @ cc6) @ ccdiv) @ (cco @ XA2 @ cc4 @ ccexp) @ ccmul) @ ccmin) @ ccaddc))) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwceq @ XY @ (cco @ XX @ (cco @ XA2 @ cc4 @ ccdiv) @ ccaddc))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ XX @ cc4 @ ccexp) @ (cco @ XA2 @ (cco @ XX @ cc3 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ XB2 @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ (cco @ (cco @ XC @ XX @ ccmul) @ XD @ ccaddc) @ ccaddc) @ ccaddc) @ (cco @ (cco @ (cco @ XY @ cc4 @ ccexp) @ (cco @ XP @ (cco @ XY @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ XQ @ XY @ ccmul) @ XR @ ccaddc) @ ccaddc))))))))))))))))))))))).
