...
thf(cwrdsplex_conj,conjecture,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XS)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwrex @ (^ [Xv:$i] : (cwceq @ XW @ (cco @ (ccres @ XW @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccv @ Xv) @ ccconcat))) @ (^ [Xv:$i] : (ccword @ XS)))))))).
