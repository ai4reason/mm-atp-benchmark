...
thf(arereb_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccre) @ XA2))))).
...
thf(cmulre_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) @ (cwb @ (cwcel @ XA2 @ ccr) @ (cwcel @ (cco @ XB2 @ XA2 @ ccmul) @ ccr)))))).
