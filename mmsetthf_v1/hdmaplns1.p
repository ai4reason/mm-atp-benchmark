...
thf(alflsub_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ XM @ (ccfv @ XD @ ccsg)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XG @ XF) @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV))) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_mi) @ XG) @ (cco @ (ccfv @ XX @ XG) @ (ccfv @ XY @ XG) @ XM)))))))))))))))))).
thf(chdmaplns1_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XU @ ccsg)) => ((cwceq @ XR @ (ccfv @ XU @ ccsca)) => ((cwceq @ XN @ (ccfv @ XR @ ccsg)) => ((cwceq @ XS @ (ccfv @ XW @ (ccfv @ XK @ cchdma))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_mi) @ (ccfv @ XZ @ XS)) @ (cco @ (ccfv @ XX @ (ccfv @ XZ @ XS)) @ (ccfv @ XY @ (ccfv @ XZ @ XS)) @ XN)))))))))))))))))))))))))))).
