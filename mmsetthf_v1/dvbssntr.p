...
thf(cdvbssntr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwceq @ XJ @ (cco @ XK @ XS @ ccrest)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (cwi @ Xph @ (cwss @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)))))))))))))))).
