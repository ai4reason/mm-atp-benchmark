...
thf(achsupid_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccch)) @ cchsup) @ XA2)))).
...
thf(achsupunss_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccch) @ (cwss @ (ccuni @ XA2) @ (ccfv @ XA2 @ cchsup))))).
...
thf(achocini_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwceq @ (ccin @ XA2 @ (ccfv @ XA2 @ ccort)) @ cc0h)))).
...
thf(chatomistici_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwceq @ XA2 @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccat)) @ cchsup))))).
