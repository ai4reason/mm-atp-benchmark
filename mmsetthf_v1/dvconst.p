...
thf(advidlem_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccc @ ccc @ XF)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xz) @ ccc) @ (cwne @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (cwceq @ (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ ccmin) @ ccdiv) @ XB2)))) => ((cwcel @ XB2 @ ccc) => (cwi @ Xph @ (cwceq @ (cco @ ccc @ XF @ ccdv) @ (ccxp @ ccc @ (ccsn @ XB2))))))))))).
...
thf(cdvconst_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ ccc @ (ccxp @ ccc @ (ccsn @ XA2)) @ ccdv) @ (ccxp @ ccc @ (ccsn @ ccc0)))))).
