...
thf(cm2detleiblem4_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccpr @ cc1 @ cc2)) => ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (cco @ XN @ XR @ ccmat))) => ((! [Xn:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xn) @ ccbs))) => ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccfv @ XR @ ccmgp))) => ((! [Xn:$i] : (cwceq @ (Xc_x @ Xn) @ (ccfv @ (XG @ Xn) @ ccplusg))) => (! [Xn:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwceq @ XQ @ (ccpr @ (ccop @ cc1 @ cc2) @ (ccop @ cc2 @ cc1))) @ (cwcel @ XM @ XB2)) @ (cwceq @ (cco @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccv @ Xn) @ XM))) @ ccgsu) @ (cco @ (cco @ cc2 @ cc1 @ XM) @ (cco @ cc1 @ cc2 @ XM) @ (Xc_x @ Xn))))))))))))))))))))).
