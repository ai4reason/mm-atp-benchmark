...
thf(alco0_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccmnd) @ (cwceq @ (cco @ XM @ cc0 @ cclinco) @ (ccsn @ (ccfv @ XM @ cc0g)))))).
...
thf(clcoel0_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) @ (cwcel @ (ccfv @ XM @ cc0g) @ (cco @ XM @ XV @ cclinco)))))).
