...
thf(awlknwwlksnfun_thm,axiom,(! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (XT @ Xp) @ (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) @ XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))))) => ((! [Xp:$i] : (cwceq @ (XW @ Xp) @ (cco @ XN @ XG @ ccwwlksn))) => ((! [Xt:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xt @ Xp) @ (ccmpt @ (^ [Xt:$i] : (XT @ Xp)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd)))))) => (! [Xt:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XN @ ccn0)) @ (cwf @ (XT @ Xp) @ (XW @ Xp) @ (XF @ Xt @ Xp)))))))))))))).
...
thf(cwlknwwlksninj_conj,conjecture,(! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (XT @ Xp) @ (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) @ XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))))) => ((! [Xp:$i] : (cwceq @ (XW @ Xp) @ (cco @ XN @ XG @ ccwwlksn))) => ((! [Xt:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xt @ Xp) @ (ccmpt @ (^ [Xt:$i] : (XT @ Xp)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd)))))) => (! [Xt:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XN @ ccn0)) @ (cwf1 @ (XT @ Xp) @ (XW @ Xp) @ (XF @ Xt @ Xp)))))))))))))).
