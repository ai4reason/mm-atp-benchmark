...
thf(asalexct_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ XA2)))) => (cwi @ Xph @ (cwcel @ XS @ ccsalg))))))))).
...
thf(asalexct2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XA2 @ (cco @ ccc0 @ cc2 @ ccicc)) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ XA2))))) => ((cwceq @ XB2 @ (cco @ ccc0 @ cc1 @ ccicc)) => (! [Xx3:$i] : (cwn @ (cwcel @ XB2 @ (XS @ Xx3))))))))))).
...
thf(adfiun3g_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (XC @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwceq @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccuni @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
thf(aiunid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3)))) @ XA2))).
thf(csalexct3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XA2 @ Xy1) @ (cco @ ccc0 @ cc2 @ ccicc))) => ((! [Xy1:$i] : (cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwbr @ (ccdif @ (XA2 @ Xy1) @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xy1)))))) => ((! [Xy1:$i] : (cwceq @ (XX @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xy1:$i] : (ccsn @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (cw3a @ (cwcel @ XS @ ccsalg) @ (cwss @ (XX @ Xy1) @ XS) @ (cwn @ (cwcel @ (ccuni @ (XX @ Xy1)) @ XS))))))))))).
