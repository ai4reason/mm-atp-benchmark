...
thf(c_2if2_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ (cwa @ Xph @ Xps) @ (cwceq @ XD @ XA2)) => ((cwi @ (cw3a @ Xph @ (cwn @ Xps) @ Xth) @ (cwceq @ XD @ XB2)) => ((cwi @ (cw3a @ Xph @ (cwn @ Xps) @ (cwn @ Xth)) @ (cwceq @ XD @ XC)) => (cwi @ Xph @ (cwceq @ XD @ (ccif @ Xps @ XA2 @ (ccif @ Xth @ XB2 @ XC))))))))))))))).
