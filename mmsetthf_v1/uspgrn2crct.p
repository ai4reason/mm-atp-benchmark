...
thf(af1cofveqaeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwf1 @ XB2 @ XC @ XF) @ (cwf1 @ XA2 @ XB2 @ XG)) @ (cwa @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2))) @ (cwi @ (cwceq @ (ccfv @ (ccfv @ XX @ XG) @ XF) @ (ccfv @ (ccfv @ XY @ XG) @ XF)) @ (cwceq @ XX @ XY))))))))))).
...
thf(cuspgrn2crct_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts))) @ (cwne @ (ccfv @ XF @ cchash) @ cc2)))))).
