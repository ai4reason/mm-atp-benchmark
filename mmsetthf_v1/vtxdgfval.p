...
thf(adf_vtxdg_ax,axiom,(cwceq @ ccvtxdg @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccsb @ (ccfv @ (ccv @ Xg1) @ ccvtx) @ (^ [Xv:$i] : (ccsb @ (ccfv @ (ccv @ Xg1) @ cciedg) @ (^ [Xe:$i] : (ccmpt @ (^ [Xu:$i] : (ccv @ Xv)) @ (^ [Xu:$i] : (cco @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xu) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xe)))) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xe)))) @ cchash) @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xe)) @ (ccsn @ (ccv @ Xu)))) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xe)))) @ cchash) @ ccxad))))))))))).
