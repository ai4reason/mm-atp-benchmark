...
thf(arelexpaddnn_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ ccn) @ (cwcel @ XR @ XV)) @ (cwceq @ (cccom @ (cco @ XR @ XN @ ccrelexp) @ (cco @ XR @ XM @ ccrelexp)) @ (cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp)))))))).
...
thf(asimp2r3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (cwi @ (cw3a @ Xta @ (cwa @ Xth @ (cw3a @ Xph @ Xps @ Xch)) @ Xet) @ Xch)))))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xch))))).
thf(asimp2r2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (cwi @ (cw3a @ Xta @ (cwa @ Xth @ (cw3a @ Xph @ Xps @ Xch)) @ Xet) @ Xps)))))))).
