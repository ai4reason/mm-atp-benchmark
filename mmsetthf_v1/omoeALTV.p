...
thf(aonego_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccodd) @ (cwcel @ (ccneg @ XA2) @ ccodd)))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(aopoeALTV_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccodd) @ (cwcel @ XB2 @ ccodd)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ cceven))))).
thf(comoeALTV_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccodd) @ (cwcel @ XB2 @ ccodd)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ cceven))))).
