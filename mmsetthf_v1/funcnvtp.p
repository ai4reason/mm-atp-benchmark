...
thf(cfuncnvtp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XC @ XV) @ (cwcel @ XE @ XW)) @ (cw3a @ (cwne @ XB2 @ XD) @ (cwne @ XB2 @ XF) @ (cwne @ XD @ XF))) @ (cwfun @ (cccnv @ (cctp @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ (ccop @ XE @ XF))))))))))))))).
