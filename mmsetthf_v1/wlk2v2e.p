...
thf(auspgr2v1e2w_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY)) @ (cwcel @ (ccop @ (ccpr @ XA2 @ XB2) @ (ccs1 @ (ccpr @ XA2 @ XB2))) @ ccuspgr))))))).
...
thf(awlk2v2elem1_thm,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccs1 @ (ccpr @ XX @ XY))) => ((cwceq @ XF @ (ccs2 @ ccc0 @ ccc0)) => (cwcel @ XF @ (ccword @ (ccdm @ XI)))))))))).
...
thf(awlk2v2elem2_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ XI @ (ccs1 @ (ccpr @ (XX @ Xk) @ (XY @ Xk))))) => ((cwceq @ XF @ (ccs2 @ ccc0 @ ccc0)) => ((! [Xk:$i] : (cwcel @ (XX @ Xk) @ ccvv)) => ((! [Xk:$i] : (cwcel @ (XY @ Xk) @ ccvv)) => ((! [Xk:$i] : (cwceq @ XP @ (ccs3 @ (XX @ Xk) @ (XY @ Xk) @ (XX @ Xk)))) => (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))))).
...
thf(cwlk2v2e_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccs1 @ (ccpr @ XX @ XY))) => ((cwceq @ XF @ (ccs2 @ ccc0 @ ccc0)) => ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwceq @ XP @ (ccs3 @ XX @ XY @ XX)) => ((cwceq @ XG @ (ccop @ (ccpr @ XX @ XY) @ XI)) => (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))))))))))).
