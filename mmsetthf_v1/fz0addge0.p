...
thf(cfz0addge0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ XM @ ccfz)) @ (cwcel @ XB2 @ (cco @ ccc0 @ XN @ ccfz))) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ ccle))))))).
