...
thf(cpsgndmsubg_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwcel @ XD @ XV) @ (cwcel @ (ccdm @ XN) @ (ccfv @ XG @ ccsubg)))))))))).
