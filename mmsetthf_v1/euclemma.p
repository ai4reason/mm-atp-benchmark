...
thf(aordvdsmul_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwo @ (cwbr @ XK @ XM @ ccdvds) @ (cwbr @ XK @ XN @ ccdvds)) @ (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds))))))).
thf(ceuclemma_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XP @ (cco @ XM @ XN @ ccmul) @ ccdvds) @ (cwo @ (cwbr @ XP @ XM @ ccdvds) @ (cwbr @ XP @ XN @ ccdvds)))))))).
