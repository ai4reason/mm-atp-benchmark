...
thf(adf_clwwlk_ax,axiom,(cwceq @ ccclwwlk @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrab @ (^ [Xw:$i] : (cw3a @ (cwne @ (ccv @ Xw) @ cc0) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xw)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xw))) @ (ccfv @ (ccv @ Xg1) @ ccedg))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ (ccv @ Xw) @ cclsw) @ (ccfv @ ccc0 @ (ccv @ Xw))) @ (ccfv @ (ccv @ Xg1) @ ccedg)))) @ (^ [Xw:$i] : (ccword @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))))).
