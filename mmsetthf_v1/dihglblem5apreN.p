...
thf(alatmle1_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => (cwi @ (cw3a @ (cwcel @ XK @ cclat) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwbr @ (cco @ XX @ XY @ Xc_an) @ XX @ Xc_le)))))))))))).
...
thf(adihopelvalc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xg1:$i] : (cwceq @ (XB2 @ Xg1) @ (ccfv @ XK @ ccbs))) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xg1:$i] : (cwceq @ (Xc_or @ Xg1) @ (ccfv @ XK @ ccjn))) => ((! [Xg1:$i] : (cwceq @ (Xc_an @ Xg1) @ (ccfv @ XK @ ccmee))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XP @ (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xg1:$i] : (cwceq @ (XR @ Xg1) @ (ccfv @ XW @ (ccfv @ XK @ cctrl)))) => ((! [Xg1:$i] : (cwceq @ (XE @ Xg1) @ (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xg1:$i] : (cwceq @ (XI @ Xg1) @ (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((! [Xg1:$i] : (cwceq @ (XG @ Xg1) @ (ccrio @ (^ [Xg1:$i] : (cwceq @ (ccfv @ XP @ (ccv @ Xg1)) @ XQ)) @ (^ [Xg1:$i] : XT)))) => ((! [Xg1:$i] : (cwcel @ (XF @ Xg1) @ ccvv)) => ((! [Xg1:$i] : (cwcel @ (XS @ Xg1) @ ccvv)) => (! [Xg1:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ (XX @ Xg1) @ (XB2 @ Xg1)) @ (cwn @ (cwbr @ (XX @ Xg1) @ XW @ Xc_le))) @ (cwa @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le))) @ (cwceq @ (cco @ XQ @ (cco @ (XX @ Xg1) @ XW @ (Xc_an @ Xg1)) @ (Xc_or @ Xg1)) @ (XX @ Xg1)))) @ (cwb @ (cwcel @ (ccop @ (XF @ Xg1) @ (XS @ Xg1)) @ (ccfv @ (XX @ Xg1) @ (XI @ Xg1))) @ (cwa @ (cwa @ (cwcel @ (XF @ Xg1) @ XT) @ (cwcel @ (XS @ Xg1) @ (XE @ Xg1))) @ (cwbr @ (ccfv @ (cccom @ (XF @ Xg1) @ (cccnv @ (ccfv @ (XG @ Xg1) @ (XS @ Xg1)))) @ (XR @ Xg1)) @ (XX @ Xg1) @ Xc_le)))))))))))))))))))))))))))))))))))))).
...
thf(alatlem12_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => (cwi @ (cwa @ (cwcel @ XK @ cclat) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) @ (cwb @ (cwa @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XX @ XZ @ Xc_le)) @ (cwbr @ XX @ (cco @ XY @ XZ @ Xc_an) @ Xc_le)))))))))))))).
thf(cdihglblem5apreN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xh:$i] : (cwceq @ (Xc_an @ Xh) @ (ccfv @ XK @ ccmee))) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((! [Xh:$i] : (cwceq @ (XI @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (Xc_or @ Xh @ Xq) @ (ccfv @ XK @ ccjn)))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xq:$i] : (cwceq @ (XP @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ ccoc)))) => ((! [Xq:$i] : (cwceq @ (XT @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ ccltrn)))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XR @ Xh @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ cctrl))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XE @ Xh @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ cctendo))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (XG @ Xh @ Xq) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ (XP @ Xq) @ (ccv @ Xh)) @ (ccv @ Xq))) @ (^ [Xh:$i] : (XT @ Xq)))))) => ((! [Xh:$i] : (! [Xq:$i] : (cwceq @ (Xc_0 @ Xh @ Xq) @ (ccmpt @ (^ [Xh:$i] : (XT @ Xq)) @ (^ [Xh:$i] : (ccres @ ccid @ XB2)))))) => (! [Xh:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ (XX @ Xh) @ XB2) @ (cwn @ (cwbr @ (XX @ Xh) @ XW @ Xc_le)))) @ (cwceq @ (ccfv @ (cco @ (XX @ Xh) @ XW @ (Xc_an @ Xh)) @ (XI @ Xh)) @ (ccin @ (ccfv @ (XX @ Xh) @ (XI @ Xh)) @ (ccfv @ XW @ (XI @ Xh)))))))))))))))))))))))))))))))))))).
