...
thf(aetransclem8_thm,axiom,(! [Xph:$o] : (! [XP:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XX @ ccc)) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XP @ Xx3 @ Xj) @ ccn)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XF @ Xx3 @ Xj) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ (XP @ Xx3 @ Xj) @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ (XM @ Xx3) @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (XP @ Xx3 @ Xj) @ ccexp))) @ ccmul)))))) => (! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ XX @ ccc @ (XF @ Xx3 @ Xj)))))))))))))).
...
thf(agtnelioc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwbr @ XB2 @ XC @ cclt)) => (cwi @ Xph @ (cwn @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))))))))))))).
...
thf(acxpcncf2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ cccxp))) @ (cco @ ccc @ ccc @ cccncf))))).
thf(anegcncf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccneg @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwss @ XA2 @ ccc) @ (cwcel @ (XF @ Xx3) @ (cco @ XA2 @ ccc @ cccncf)))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(aetransclem13_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwss @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XP @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XF @ Xx3 @ Xj) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => (! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XY @ (XF @ Xx3 @ Xj)) @ (ccprod @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ XY @ (ccv @ Xj) @ ccmin) @ (ccif @ (cwceq @ (ccv @ Xj) @ ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ ccexp))))))))))))))))))).
...
thf(acncfcompt2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XR @ Xx3))) @ (cco @ (XA2 @ Xy1) @ (XB2 @ Xy1) @ cccncf))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (ccmpt @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XS @ Xy1))) @ (cco @ XC @ (XE @ Xx3 @ Xy1) @ cccncf))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwss @ (XB2 @ Xy1) @ XC)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XR @ Xx3)) @ (cwceq @ (XS @ Xy1) @ (XT @ Xx3))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XT @ Xx3))) @ (cco @ (XA2 @ Xy1) @ (XE @ Xx3 @ Xy1) @ cccncf))))))))))))))))))).
thf(anfv_thm,axiom,(! [Xph:$o] : (cwnf @ (^ [Xx3:$i] : Xph)))).
thf(asubcncf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XX @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XX @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccmin))) @ (cco @ XX @ ccc @ cccncf)))))))))).
...
thf(aexpcncf_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccexp))) @ (cco @ ccc @ ccc @ cccncf))))).
...
thf(cetransclem18_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ ccr @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwcel @ ccr @ (cco @ (ccfv @ cccnfld @ cctopn) @ ccr @ ccrest))) => ((cwi @ Xph @ (cwcel @ XP @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XF @ Xx3 @ Xj) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xj) @ ccr))) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xj) @ ccr))) => (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ cceu @ (ccneg @ (ccv @ Xx3)) @ cccxp) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3 @ Xj)) @ ccmul))) @ ccibl))))))))))))))))).
