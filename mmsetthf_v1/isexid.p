...
thf(adf_exid_ax,axiom,(cwceq @ ccexid @ (ccab @ (^ [Xg1:$i] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xy1)) @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccdm @ (ccdm @ (ccv @ Xg1)))))) @ (^ [Xx3:$i] : (ccdm @ (ccdm @ (ccv @ Xg1))))))))).
thf(cisexid_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ (ccdm @ XG))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XG @ (XA2 @ Xx3 @ Xy1)) @ (cwb @ (cwcel @ XG @ ccexid) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xy1)) @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))).
