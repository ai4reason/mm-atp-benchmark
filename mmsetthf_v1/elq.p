...
thf(adf_q_ax,axiom,(cwceq @ ccq @ (ccima @ ccdiv @ (ccxp @ ccz @ ccn)))).
...
thf(celq_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccq) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccz))))).
