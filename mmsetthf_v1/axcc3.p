...
thf(caxcc3_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwcel @ (XF @ Xn) @ ccvv)) => ((cwbr @ XN @ ccom @ ccen) => (cwex @ (^ [Xf1:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ XN) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwne @ (XF @ Xn) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (XF @ Xn)))) @ (^ [Xn:$i] : XN)))))))))).
