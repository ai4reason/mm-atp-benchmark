...
thf(cmrcval_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XU @ XX)) @ (cwceq @ (ccfv @ XU @ XF) @ (ccint @ (ccrab @ (^ [Xs1:$i] : (cwss @ XU @ (ccv @ Xs1))) @ (^ [Xs1:$i] : XC))))))))))).
