...
thf(adf_minusg_ax,axiom,(cwceq @ ccminusg @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xw:$i] : (cwceq @ (cco @ (ccv @ Xw) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xg1) @ ccplusg)) @ (ccfv @ (ccv @ Xg1) @ cc0g))) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))))))))).
...
thf(cgrpinvfval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xy1:$i] : (cwceq @ (Xc_pl @ Xy1) @ (ccfv @ XG @ ccplusg))) => ((! [Xy1:$i] : (cwceq @ (Xc_0 @ Xy1) @ (ccfv @ XG @ cc0g))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (ccfv @ XG @ ccminusg)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_pl @ Xy1)) @ (Xc_0 @ Xy1))) @ (^ [Xy1:$i] : XB2))))))))))))))))).
