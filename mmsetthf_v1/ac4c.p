...
thf(aac4_thm,axiom,(! [Xx3:$i] : (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3))))))).
thf(cac4c_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))).
