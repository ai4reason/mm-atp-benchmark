...
thf(cmapsnf1o2_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XS @ (ccsn @ (XX @ Xx3)))) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XX @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ XS @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (XX @ Xx3) @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwf1o @ (cco @ XB2 @ XS @ ccmap) @ XB2 @ (XF @ Xx3)))))))))))).
