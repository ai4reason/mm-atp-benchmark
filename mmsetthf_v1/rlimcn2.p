...
thf(crlimcn2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xv @ Xu) @ (cwcel @ (ccv @ Xz) @ (XA2 @ Xv @ Xu))) @ (cwcel @ (XB2 @ Xz) @ (XX @ Xx3 @ Xv @ Xs1 @ Xr))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xv @ Xu) @ (cwcel @ (ccv @ Xz) @ (XA2 @ Xv @ Xu))) @ (cwcel @ (XC @ Xz @ Xu) @ (XY @ Xx3 @ Xs1 @ Xr))))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xv @ Xu) @ (cwcel @ XR @ (XX @ Xx3 @ Xv @ Xs1 @ Xr)))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xv @ Xu) @ (cwcel @ XS @ (XY @ Xx3 @ Xs1 @ Xr)))))))) => ((! [Xv:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xv @ Xu) @ (cwbr @ (ccmpt @ (^ [Xz:$i] : (XA2 @ Xv @ Xu)) @ (^ [Xz:$i] : (XB2 @ Xz))) @ XR @ ccrli)))) => ((! [Xv:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xv @ Xu) @ (cwbr @ (ccmpt @ (^ [Xz:$i] : (XA2 @ Xv @ Xu)) @ (^ [Xz:$i] : (XC @ Xz @ Xu))) @ XS @ ccrli)))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xv @ Xu) @ (cwf @ (ccxp @ (XX @ Xx3 @ Xv @ Xs1 @ Xr) @ (XY @ Xx3 @ Xs1 @ Xr)) @ ccc @ XF))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwa @ (Xph @ Xv @ Xu) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwi @ (cwa @ (cwbr @ (ccfv @ (cco @ (ccv @ Xu) @ XR @ ccmin) @ ccabs) @ (ccv @ Xr) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xv) @ XS @ ccmin) @ ccabs) @ (ccv @ Xs1) @ cclt)) @ (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ XF) @ (cco @ XR @ XS @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xv:$i] : (XY @ Xx3 @ Xs1 @ Xr)))) @ (^ [Xu:$i] : (XX @ Xx3 @ Xv @ Xs1 @ Xr)))) @ (^ [Xs1:$i] : ccrp))) @ (^ [Xr:$i] : ccrp)))))) => (! [Xv:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xv @ Xu) @ (cwbr @ (ccmpt @ (^ [Xz:$i] : (XA2 @ Xv @ Xu)) @ (^ [Xz:$i] : (cco @ (XB2 @ Xz) @ (XC @ Xz @ Xu) @ XF))) @ (cco @ XR @ XS @ XF) @ ccrli)))))))))))))))))))))).
