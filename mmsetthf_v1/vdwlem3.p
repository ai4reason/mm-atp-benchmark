...
thf(cvdwlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XV @ ccn)) => ((cwi @ Xph @ (cwcel @ XW @ ccn)) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ cc1 @ XV @ ccfz))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ cc1 @ XW @ ccfz))) => (cwi @ Xph @ (cwcel @ (cco @ XB2 @ (cco @ XW @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XV @ ccaddc) @ ccmul) @ ccaddc) @ (cco @ cc1 @ (cco @ XW @ (cco @ cc2 @ XV @ ccmul) @ ccmul) @ ccfz))))))))))))).
