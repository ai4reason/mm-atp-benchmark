...
thf(csmatlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (cco @ XK @ XL @ (ccfv @ XA2 @ ccsmat))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XN @ ccfz)) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XI @ ccn)) => ((cwi @ Xph @ (cwcel @ XJ @ ccn)) => ((cwi @ Xph @ (cwceq @ (ccif @ (cwbr @ XI @ XK @ cclt) @ XI @ (cco @ XI @ cc1 @ ccaddc)) @ XX)) => ((cwi @ Xph @ (cwceq @ (ccif @ (cwbr @ XJ @ XL @ cclt) @ XJ @ (cco @ XJ @ cc1 @ ccaddc)) @ XY)) => (cwi @ Xph @ (cwceq @ (cco @ XI @ XJ @ XS) @ (cco @ XX @ XY @ XA2)))))))))))))))))))))))))).
