...
thf(cregsep2_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ ccreg) @ (cw3a @ (cwcel @ XC @ (ccfv @ XJ @ cccld)) @ (cwcel @ XA2 @ XX) @ (cwn @ (cwcel @ XA2 @ XC)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwss @ XC @ (ccv @ Xx3)) @ (cwcel @ XA2 @ (ccv @ Xy1)) @ (cwceq @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))))).
