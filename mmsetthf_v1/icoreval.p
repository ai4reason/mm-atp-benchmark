...
thf(cicoreval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccico) @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xz) @ ccle) @ (cwbr @ (ccv @ Xz) @ XB2 @ cclt))) @ (^ [Xz:$i] : ccr))))))).
