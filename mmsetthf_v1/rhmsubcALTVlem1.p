...
thf(crhmsubcALTVlem1_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccrngcALTV)) => ((cwi @ Xph @ (cwceq @ XR @ (ccin @ ccrg @ XU))) => ((cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XR @ XR))) => (cwi @ Xph @ (cwfn @ XH @ (ccxp @ XR @ XR)))))))))))))).
