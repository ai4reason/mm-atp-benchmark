...
thf(afunvtxdmge2valOLD_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ XV) @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) @ (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ ccbs)))))).
...
thf(cbasvtxvalOLD_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XG @ XX)) => ((cwi @ Xph @ (cwfun @ XG)) => ((cwi @ Xph @ (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) => ((cwi @ Xph @ (cwcel @ XV @ XY)) => ((cwi @ Xph @ (cwcel @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ XG)) => (cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV))))))))))))).
