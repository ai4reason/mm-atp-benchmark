...
thf(celxp5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ XB2 @ XC)) @ (cwa @ (cwceq @ XA2 @ (ccop @ (ccint @ (ccint @ XA2)) @ (ccuni @ (ccrn @ (ccsn @ XA2))))) @ (cwa @ (cwcel @ (ccint @ (ccint @ XA2)) @ XB2) @ (cwcel @ (ccuni @ (ccrn @ (ccsn @ XA2))) @ XC)))))))).
