...
thf(cringcbasbasALTV_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccringcALTV)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => (cwi @ (cwa @ Xph @ (cwcel @ XR @ XB2)) @ (cwcel @ (ccfv @ XR @ ccbs) @ XU))))))))))).
