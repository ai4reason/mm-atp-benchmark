...
thf(arelun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwrel @ (ccun @ XA2 @ XB2)) @ (cwa @ (cwrel @ XA2) @ (cwrel @ XB2)))))).
...
thf(afununmo_thm,axiom,(! [Xx3:$i] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwfun @ (ccun @ XF @ XG)) @ (cwmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF)))))))).
...
thf(cfununfun_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwfun @ (ccun @ XF @ XG)) @ (cwa @ (cwfun @ XF) @ (cwfun @ XG)))))).
