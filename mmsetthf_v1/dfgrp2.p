...
thf(cdfgrp2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwb @ (cwcel @ XG @ ccgrp) @ (cwa @ (cwcel @ XG @ ccsgrp) @ (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xx3)) @ (cwrex @ (^ [Xi:$i] : (cwceq @ (cco @ (ccv @ Xi) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xn))) @ (^ [Xi:$i] : XB2)))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xn:$i] : XB2)))))))))).
