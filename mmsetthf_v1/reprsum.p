...
thf(creprsum_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwss @ (XA2 @ Xa) @ ccn))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ (XM @ Xa) @ ccz))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XS @ ccn0))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XC @ (cco @ (XA2 @ Xa) @ (XM @ Xa) @ (ccfv @ XS @ ccrepr))))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwceq @ (ccsu @ (cco @ ccc0 @ XS @ ccfzo) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xa) @ XC))) @ (XM @ Xa)))))))))))))).
