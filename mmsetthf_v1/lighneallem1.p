...
thf(anbrne1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ XR) @ (cwn @ (cwbr @ XA2 @ XC @ XR))) @ (cwne @ XB2 @ XC))))))).
thf(clighneallem1_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwceq @ XP @ cc2) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwne @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin) @ (cco @ XP @ XM @ ccexp))))))).
