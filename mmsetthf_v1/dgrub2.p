...
thf(cdgrub2_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwceq @ (ccima @ XA2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0)))))))))).
