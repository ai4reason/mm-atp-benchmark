...
thf(aphicl_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (ccfv @ XN @ ccphi) @ ccn)))).
...
thf(adfphi2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccphi) @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XN @ ccgcd) @ cc1)) @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfzo))) @ cchash))))).
...
thf(aeulerthlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ XN @ ccgcd) @ cc1)) @ (^ [Xy1:$i] : (cco @ ccc0 @ XN @ ccfzo))))) => ((cwceq @ XT @ (cco @ cc1 @ (ccfv @ XN @ ccphi) @ ccfz)) => ((! [Xy1:$i] : (cwi @ Xph @ (cwf1o @ XT @ (XS @ Xy1) @ XF))) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : XT) @ (^ [Xx3:$i] : (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmul) @ XN @ ccmo)))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ (ccfv @ XN @ ccphi) @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo)))))))))))))))).
...
thf(ceulerth_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwceq @ (cco @ (cco @ XA2 @ (ccfv @ XN @ ccphi) @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo)))))).
