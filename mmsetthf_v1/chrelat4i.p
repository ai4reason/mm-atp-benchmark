...
thf(achrelat3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwss @ XA2 @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccat)))))))).
...
thf(cchrelat4i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwceq @ XA2 @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwb @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccat)))))))).
