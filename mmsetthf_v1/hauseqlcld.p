...
thf(chauseqlcld_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XK @ ccha)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (cwi @ Xph @ (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XJ @ cccld)))))))))))).
