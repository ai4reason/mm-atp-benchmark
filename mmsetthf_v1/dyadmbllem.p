...
thf(adyadmax_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (cwi @ (cwa @ (cwss @ XA2 @ (ccrn @ XF)) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwss @ (ccfv @ (ccv @ Xz) @ ccicc) @ (ccfv @ (ccv @ Xw) @ ccicc)) @ (cwceq @ (ccv @ Xz) @ (ccv @ Xw)))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : XA2))))))).
...
thf(cdyadmbllem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xw) @ (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwss @ (ccfv @ (ccv @ Xz) @ ccicc) @ (ccfv @ (ccv @ Xw) @ ccicc)) @ (cwceq @ (ccv @ Xz) @ (ccv @ Xw)))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwss @ XA2 @ (ccrn @ XF))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (ccuni @ (ccima @ ccicc @ XA2)) @ (ccuni @ (ccima @ ccicc @ (XG @ Xx3 @ Xy1 @ Xw)))))))))))))))).
