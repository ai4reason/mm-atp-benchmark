...
thf(afieq0_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwceq @ XA2 @ cc0) @ (cwceq @ (ccfv @ XA2 @ ccfi) @ cc0)))))).
...
thf(afipwss_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccpw @ XX)) @ (cwss @ (ccfv @ XA2 @ ccfi) @ (ccpw @ XX)))))).
...
thf(cfsubbas_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwb @ (cwcel @ (ccfv @ XA2 @ ccfi) @ (ccfv @ XX @ ccfbas)) @ (cw3a @ (cwss @ XA2 @ (ccpw @ XX)) @ (cwne @ XA2 @ cc0) @ (cwn @ (cwcel @ cc0 @ (ccfv @ XA2 @ ccfi)))))))))).
