...
thf(afourierdlem23_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf))) => ((cwi @ Xph @ (cwss @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xs1) @ XB2)) @ (cwcel @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XA2))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xs1:$i] : XB2) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))) @ (cco @ XB2 @ ccc @ cccncf)))))))))))))).
...
thf(acdivcncf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccdiv))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (XF @ Xx3) @ (cco @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccc @ cccncf)))))))).
...
thf(afourierdlem62_thm,axiom,(! [XK:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XK @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ ccc0) @ cc1 @ (cco @ (ccv @ Xy1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => (! [Xy1:$i] : (cwcel @ (XK @ Xy1) @ (cco @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccr @ cccncf)))))).
...
thf(cfourierdlem78_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (cco @ XA2 @ XB2 @ ccioo)))) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ (cco @ (cco @ XA2 @ XX @ ccaddc) @ (cco @ XB2 @ XX @ ccaddc) @ ccioo)) @ (cco @ (cco @ (cco @ XA2 @ XX @ ccaddc) @ (cco @ XB2 @ XX @ ccaddc) @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XY @ ccr)) => ((cwi @ Xph @ (cwcel @ XW @ ccr)) => ((! [Xs1:$i] : (cwceq @ (XH @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF) @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xs1) @ cclt) @ XY @ XW) @ ccmin) @ (ccv @ Xs1) @ ccdiv)))))) => ((! [Xs1:$i] : (cwceq @ (XK @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ cc1 @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => ((! [Xs1:$i] : (cwceq @ (XU @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XH @ Xs1)) @ (ccfv @ (ccv @ Xs1) @ (XK @ Xs1)) @ ccmul))))) => ((cwi @ Xph @ (cwcel @ XN @ ccr)) => ((! [Xs1:$i] : (cwceq @ (XS @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin))))) => ((! [Xs1:$i] : (cwceq @ (XG @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XU @ Xs1)) @ (ccfv @ (ccv @ Xs1) @ (XS @ Xs1)) @ ccmul))))) => (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (ccres @ (XG @ Xs1) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf)))))))))))))))))))))))))))))))).
