...
thf(caddpipq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi)) @ (cwa @ (cwcel @ XC @ ccnpi) @ (cwcel @ XD @ ccnpi))) @ (cwceq @ (cco @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccplpq) @ (ccop @ (cco @ (cco @ XA2 @ XD @ ccmi) @ (cco @ XC @ XB2 @ ccmi) @ ccpli) @ (cco @ XB2 @ XD @ ccmi))))))))).
