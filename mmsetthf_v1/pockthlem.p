...
thf(arpexp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwceq @ (cco @ (cco @ XA2 @ XN @ ccexp) @ XB2 @ ccgcd) @ cc1) @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1))))))).
...
thf(aodzcl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwcel @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccn))))).
...
thf(aodzdvds_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwcel @ XK @ ccn0)) @ (cwb @ (cwbr @ XN @ (cco @ (cco @ XA2 @ XK @ ccexp) @ cc1 @ ccmin) @ ccdvds) @ (cwbr @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ XK @ ccdvds))))))).
...
thf(aprmpwdvds_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ ccz) @ (cwcel @ XD @ ccz)) @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccn)) @ (cwa @ (cwbr @ XD @ (cco @ XK @ (cco @ XP @ XN @ ccexp) @ ccmul) @ ccdvds) @ (cwn @ (cwbr @ XD @ (cco @ XK @ (cco @ XP @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ ccdvds)))) @ (cwbr @ (cco @ XP @ XN @ ccexp) @ XD @ ccdvds))))))).
thf(aodzphi_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwbr @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ (ccfv @ XN @ ccphi) @ ccdvds))))).
thf(aphiprm_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwceq @ (ccfv @ XP @ ccphi) @ (cco @ XP @ cc1 @ ccmin))))).
...
thf(cpockthlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccn)) => ((cwi @ Xph @ (cwbr @ XB2 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwceq @ XN @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc1 @ ccaddc))) => ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwbr @ XP @ XN @ ccdvds)) => ((cwi @ Xph @ (cwcel @ XQ @ ccprime)) => ((cwi @ Xph @ (cwcel @ (cco @ XQ @ XA2 @ ccpc) @ ccn)) => ((cwi @ Xph @ (cwcel @ XC @ ccz)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XC @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) @ cc1)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ XC @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XQ @ ccdiv) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) @ cc1)) => (cwi @ Xph @ (cwbr @ (cco @ XQ @ XA2 @ ccpc) @ (cco @ XQ @ (cco @ XP @ cc1 @ ccmin) @ ccpc) @ ccle))))))))))))))))))))).
