...
thf(cncoprmgcdne1b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwrex @ (^ [Xi:$i] : (cwa @ (cwbr @ (ccv @ Xi) @ XA2 @ ccdvds) @ (cwbr @ (ccv @ Xi) @ XB2 @ ccdvds))) @ (^ [Xi:$i] : (ccfv @ cc2 @ ccuz))) @ (cwne @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1)))))).
