...
thf(aetransclem18_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ ccr @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwcel @ ccr @ (cco @ (ccfv @ cccnfld @ cctopn) @ ccr @ ccrest))) => ((cwi @ Xph @ (cwcel @ XP @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XF @ Xx3 @ Xj) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xj) @ ccr))) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xj) @ ccr))) => (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ cceu @ (ccneg @ (ccv @ Xx3)) @ cccxp) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3 @ Xj)) @ ccmul))) @ ccibl))))))))))))))))).
...
thf(arecxpcld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XB2 @ cccxp) @ ccr))))))))).
...
thf(acxpge0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ cccxp) @ ccle))))))))).
...
thf(alt0neg2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ (ccneg @ XA2) @ ccc0 @ cclt))))))).
thf(acxpltd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ cc1 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XB2 @ XC @ cclt) @ (cwbr @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ cclt)))))))))))).
...
thf(afprodabs_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XN @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccabs) @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (XA2 @ Xk) @ ccabs)))))))))))))).
...
thf(ahashfz0_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccn0) @ (cwceq @ (ccfv @ (cco @ ccc0 @ XB2 @ ccfz) @ cchash) @ (cco @ XB2 @ cc1 @ ccaddc))))).
