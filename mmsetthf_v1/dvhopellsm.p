...
thf(aexopxfr2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1 @ Xz)))))) => (cwi @ (cwrel @ XA2) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ XA2) @ (Xps @ Xy1 @ Xz))))))))))))).
...
thf(cdvhopellsm_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [Xc_po:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XH @ Xz @ Xw) @ (ccfv @ (XK @ Xz @ Xw) @ cclh)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccfv @ (XW @ Xz @ Xw) @ (ccfv @ (XK @ Xz @ Xw) @ ccdvh))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ Xc_pl @ (ccfv @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xz @ Xw) @ (ccfv @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ cclss)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (Xc_po @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccfv @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ cclsm)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ (XK @ Xz @ Xw) @ cchlt) @ (cwcel @ (XW @ Xz @ Xw) @ (XH @ Xz @ Xw))) @ (cwcel @ XX @ (XS @ Xz @ Xw)) @ (cwcel @ XY @ (XS @ Xz @ Xw))) @ (cwb @ (cwcel @ (ccop @ XF @ XT) @ (cco @ XX @ XY @ (Xc_po @ Xx3 @ Xy1 @ Xz @ Xw))) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (cwa @ (cwa @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XX) @ (cwcel @ (ccop @ (ccv @ Xz) @ (ccv @ Xw)) @ XY)) @ (cwceq @ (ccop @ XF @ XT) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xz) @ (ccv @ Xw)) @ Xc_pl)))))))))))))))))))))))))))))))))).
