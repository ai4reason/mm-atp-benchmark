...
thf(cupgrtrls_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XV @ Xf1) @ (ccfv @ XG @ ccvtx))) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ ccupgr) @ (cwceq @ (ccfv @ XG @ cctrls) @ (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cw3a @ (cwa @ (cwcel @ (ccv @ Xf1) @ (ccword @ (ccdm @ XI))) @ (cwfun @ (cccnv @ (ccv @ Xf1)))) @ (cwf @ (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfz) @ (XV @ Xf1) @ (ccv @ Xp)) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ XI) @ (ccpr @ (ccfv @ (ccv @ Xk) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xp))))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo))))))))))))))).
