...
thf(adivrcnv_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccdiv))) @ ccc0 @ ccrli)))).
...
thf(a_2sumeq2dv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xj))) @ (cwceq @ (XC @ Xj @ Xk) @ (XD @ Xj @ Xk))))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ (XB2 @ Xj) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))) @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ (XB2 @ Xj) @ (^ [Xk:$i] : (XD @ Xj @ Xk)))))))))))))).
