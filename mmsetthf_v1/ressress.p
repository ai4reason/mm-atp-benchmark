...
thf(asetsabs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XC @ XW)) @ (cwceq @ (cco @ (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts) @ (ccop @ XA2 @ XC) @ ccsts) @ (cco @ XS @ (ccop @ XA2 @ XC) @ ccsts)))))))))).
...
thf(cressress_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY)) @ (cwceq @ (cco @ (cco @ XW @ XA2 @ ccress) @ XB2 @ ccress) @ (cco @ XW @ (ccin @ XA2 @ XB2) @ ccress))))))))).
