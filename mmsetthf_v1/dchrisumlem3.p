...
thf(acaucvg_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xj) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccrp))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XF @ (XV @ Xx3 @ Xj @ Xk)))))) => (cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccli))))))))))))).
...
thf(adchrisumlema_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ XL @ (ccfv @ XZ @ cczrh)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xn) @ (ccfv @ XN @ ccdchr)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ XD @ (ccfv @ (XG @ Xx3 @ Xn) @ ccbs)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ Xc_1 @ (ccfv @ (XG @ Xx3 @ Xn) @ cc0g)))) => ((cwi @ Xph @ (cwcel @ XX @ XD)) => ((cwi @ Xph @ (cwne @ XX @ Xc_1)) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xx3)) @ (cwceq @ (XA2 @ Xn) @ (XB2 @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccrp)) @ (cwcel @ (XA2 @ Xn) @ ccr))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xn) @ ccrp) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwa @ (cwbr @ XM @ (ccv @ Xn) @ ccle) @ (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccle))) @ (cwbr @ (XB2 @ Xx3) @ (XA2 @ Xn) @ ccle)))) => ((cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccc0 @ ccrli)) => ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (XA2 @ Xn) @ ccmul)))) => (cwi @ Xph @ (cwa @ (cwi @ (cwcel @ XI @ ccrp) @ (cwcel @ (ccsb @ XI @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccr)) @ (cwi @ (cwcel @ XI @ (cco @ XM @ ccpnf @ ccico)) @ (cwbr @ ccc0 @ (ccsb @ XI @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccle)))))))))))))))))))))))))))))))).
...
thf(adchrisumlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xu:$i] : (cwceq @ (XZ @ Xu) @ (ccfv @ XN @ cczn))) => ((! [Xu:$i] : (cwceq @ XL @ (ccfv @ (XZ @ Xu) @ cczrh))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xu @ Xn) @ (ccfv @ XN @ ccdchr))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xu) @ (ccfv @ (XG @ Xx3 @ Xu @ Xn) @ ccbs))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (Xc_1 @ Xu) @ (ccfv @ (XG @ Xx3 @ Xu @ Xn) @ cc0g))))) => ((! [Xu:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xu)))) => ((! [Xu:$i] : (cwi @ Xph @ (cwne @ XX @ (Xc_1 @ Xu)))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xx3)) @ (cwceq @ (XA2 @ Xu @ Xn) @ (XB2 @ Xx3 @ Xu)))))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((! [Xu:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccrp)) @ (cwcel @ (XA2 @ Xu @ Xn) @ ccr)))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xn) @ ccrp) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwa @ (cwbr @ XM @ (ccv @ Xn) @ ccle) @ (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccle))) @ (cwbr @ (XB2 @ Xx3 @ Xu) @ (XA2 @ Xu @ Xn) @ ccle))))) => ((! [Xu:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (XA2 @ Xu @ Xn))) @ ccc0 @ ccrli))) => ((! [Xu:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (XA2 @ Xu @ Xn) @ ccmul))))) => ((cwi @ Xph @ (cwcel @ XR @ ccr)) => ((cwi @ Xph @ (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (ccsu @ (cco @ ccc0 @ (ccv @ Xu) @ ccfzo) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX))) @ ccabs) @ XR @ ccle)) @ (^ [Xu:$i] : (cco @ ccc0 @ XN @ ccfzo)))) => ((cwi @ Xph @ (cwcel @ XU @ ccrp)) => ((cwi @ Xph @ (cwbr @ XM @ XU @ ccle)) => ((cwi @ Xph @ (cwbr @ XU @ (cco @ XI @ cc1 @ ccaddc) @ ccle)) => ((cwi @ Xph @ (cwcel @ XI @ ccn)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XI @ ccuz))) => (! [Xu:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (ccfv @ XJ @ (ccseq @ ccaddc @ XF @ cc1)) @ (ccfv @ XI @ (ccseq @ ccaddc @ XF @ cc1)) @ ccmin) @ ccabs) @ (cco @ (cco @ cc2 @ XR @ ccmul) @ (ccsb @ XU @ (^ [Xn:$i] : (XA2 @ Xu @ Xn))) @ ccmul) @ ccle))))))))))))))))))))))))))))))))))))))))).
...
thf(cdchrisumlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xu:$i] : (! [Xt:$i] : (! [Xc:$i] : (cwceq @ (XZ @ Xu @ Xt @ Xc) @ (ccfv @ XN @ cczn))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xc:$i] : (cwceq @ XL @ (ccfv @ (XZ @ Xu @ Xt @ Xc) @ cczrh))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwceq @ (XG @ Xx3 @ Xu @ Xt @ Xn @ Xc) @ (ccfv @ XN @ ccdchr))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwceq @ (XD @ Xu) @ (ccfv @ (XG @ Xx3 @ Xu @ Xt @ Xn @ Xc) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwceq @ (Xc_1 @ Xu) @ (ccfv @ (XG @ Xx3 @ Xu @ Xt @ Xn @ Xc) @ cc0g))))))) => ((! [Xu:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xu)))) => ((! [Xu:$i] : (cwi @ Xph @ (cwne @ XX @ (Xc_1 @ Xu)))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xx3)) @ (cwceq @ (XA2 @ Xu @ Xn) @ (XB2 @ Xx3 @ Xu @ Xt))))))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xt) @ ccn))) => ((! [Xu:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccrp)) @ (cwcel @ (XA2 @ Xu @ Xn) @ ccr)))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xn) @ ccrp) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwa @ (cwbr @ (XM @ Xt) @ (ccv @ Xn) @ ccle) @ (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccle))) @ (cwbr @ (XB2 @ Xx3 @ Xu @ Xt) @ (XA2 @ Xu @ Xn) @ ccle)))))) => ((! [Xu:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (XA2 @ Xu @ Xn))) @ ccc0 @ ccrli))) => ((! [Xu:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (XA2 @ Xu @ Xn) @ ccmul))))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xt) @ ccr))) => ((! [Xt:$i] : (cwi @ Xph @ (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (ccsu @ (cco @ ccc0 @ (ccv @ Xu) @ ccfzo) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX))) @ ccabs) @ (XR @ Xt) @ ccle)) @ (^ [Xu:$i] : (cco @ ccc0 @ XN @ ccfzo))))) => (! [Xu:$i] : (cwi @ Xph @ (cwex @ (^ [Xt:$i] : (cwrex @ (^ [Xc:$i] : (cwa @ (cwbr @ (ccseq @ ccaddc @ XF @ cc1) @ (ccv @ Xt) @ ccli) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfl) @ (ccseq @ ccaddc @ XF @ cc1)) @ (ccv @ Xt) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xc) @ (XB2 @ Xx3 @ Xu @ Xt) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : (cco @ (XM @ Xt) @ ccpnf @ ccico))))) @ (^ [Xc:$i] : (cco @ ccc0 @ ccpnf @ ccico))))))))))))))))))))))))))))))))))))).
