...
thf(cel2xptp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ (ccxp @ XB2 @ XC) @ XD)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ XA2 @ (ccotp @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XD))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : XB2)))))))).
