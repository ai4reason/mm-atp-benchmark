...
thf(acosatan_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccatan) @ cccos) @ (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ ccdiv))))).
...
thf(ccosatanne0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwne @ (ccfv @ (ccfv @ XA2 @ ccatan) @ cccos) @ ccc0)))).
