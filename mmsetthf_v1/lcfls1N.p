...
thf(clcfls1N_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XC @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe) @ Xc_pe) @ (ccfv @ (ccv @ Xf1) @ XL)) @ (cwss @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe) @ XQ))) @ (^ [Xf1:$i] : XF)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XG @ XF))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwb @ (cwcel @ XG @ (XC @ Xf1)) @ (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ Xc_pe) @ (ccfv @ XG @ XL)) @ (cwss @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ XQ))))))))))))))).
