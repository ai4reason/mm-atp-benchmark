...
thf(crelexpsucnnl_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) @ (cccom @ XR @ (cco @ XR @ XN @ ccrelexp)))))))).
