...
thf(alsatcvat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XQ @ XA2)) => ((cwi @ Xph @ (cwcel @ XR @ XA2)) => ((cwi @ Xph @ (cwne @ XU @ (ccsn @ Xc_0))) => ((cwi @ Xph @ (cwpss @ XU @ (cco @ XQ @ XR @ Xc_po))) => (cwi @ Xph @ (cwcel @ XU @ XA2)))))))))))))))))))))).
...
thf(alsatcv1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XQ @ XA2)) => ((cwi @ Xph @ (cwcel @ XR @ XA2)) => ((cwi @ Xph @ (cwbr @ XU @ (cco @ XQ @ XR @ Xc_po) @ XC)) => (cwi @ Xph @ (cwb @ (cwceq @ XU @ (ccsn @ Xc_0)) @ (cwceq @ XQ @ XR)))))))))))))))))))))))).
...
thf(clsatcvat2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XQ @ XA2)) => ((cwi @ Xph @ (cwcel @ XR @ XA2)) => ((cwi @ Xph @ (cwne @ XQ @ XR)) => ((cwi @ Xph @ (cwbr @ XU @ (cco @ XQ @ XR @ Xc_po) @ XC)) => (cwi @ Xph @ (cwcel @ XU @ XA2)))))))))))))))))))))).
