...
thf(abdaydm_thm,axiom,(cwceq @ (ccdm @ ccbday) @ ccsur)).
thf(ampan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ Xps @ Xch))))))).
thf(abdayfun_thm,axiom,(cwfun @ ccbday)).
...
thf(abdayrn_thm,axiom,(cwceq @ (ccrn @ ccbday) @ ccon0)).
...
thf(anodense_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur)) @ (cwa @ (cwceq @ (ccfv @ XA2 @ ccbday) @ (ccfv @ XB2 @ ccbday)) @ (cwbr @ XA2 @ XB2 @ ccslt))) @ (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xx3) @ ccbday) @ (ccfv @ XA2 @ ccbday)) @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccslt) @ (cwbr @ (ccv @ Xx3) @ XB2 @ ccslt))) @ (^ [Xx3:$i] : ccsur)))))).
thf(cnocvxminlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwss @ XA2 @ ccsur) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccslt) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccslt)) @ (cwcel @ (ccv @ Xz) @ XA2))) @ (^ [Xz:$i] : ccsur))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ (cwi @ (cwa @ (cwa @ (cwcel @ XX @ XA2) @ (cwcel @ (XY @ Xx3) @ XA2)) @ (cwa @ (cwceq @ (ccfv @ XX @ ccbday) @ (ccint @ (ccima @ ccbday @ XA2))) @ (cwceq @ (ccfv @ (XY @ Xx3) @ ccbday) @ (ccint @ (ccima @ ccbday @ XA2))))) @ (cwn @ (cwbr @ XX @ (XY @ Xx3) @ ccslt))))))))).
