...
thf(cringprop_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ (ccfv @ XK @ ccbs) @ (ccfv @ XL @ ccbs)) => ((cwceq @ (ccfv @ XK @ ccplusg) @ (ccfv @ XL @ ccplusg)) => ((cwceq @ (ccfv @ XK @ ccmulr) @ (ccfv @ XL @ ccmulr)) => (cwb @ (cwcel @ XK @ ccrg) @ (cwcel @ XL @ ccrg)))))))).
