...
thf(ccoep_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ (cccom @ ccep @ XR)) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XR)) @ (^ [Xx3:$i] : XB2))))))))).
