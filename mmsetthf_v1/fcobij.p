...
thf(cfcobij_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((cwi @ Xph @ (cwf1o @ XS @ XT @ XG)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XR @ (XU @ Xf1)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XS @ (XV @ Xf1)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XT @ (XW @ Xf1)))) => (cwi @ Xph @ (cwf1o @ (cco @ XS @ XR @ ccmap) @ (cco @ XT @ XR @ ccmap) @ (ccmpt @ (^ [Xf1:$i] : (cco @ XS @ XR @ ccmap)) @ (^ [Xf1:$i] : (cccom @ XG @ (ccv @ Xf1))))))))))))))))))).
