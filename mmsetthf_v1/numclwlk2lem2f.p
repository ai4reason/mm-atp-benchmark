...
thf(awwlksubclwwlk_thm,axiom,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) @ (cwi @ (cwcel @ XX @ (cco @ XN @ XG @ ccclwwlkn)) @ (cwcel @ (cco @ XX @ (ccop @ ccc0 @ XM) @ ccsubstr) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccwwlksn))))))))).
...
thf(aaddsubass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccmin) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccaddc))))))).
thf(aoveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF)))))))).
thf(a_2m1e1_thm,axiom,(cwceq @ (cco @ cc2 @ cc1 @ ccmin) @ cc1)).
thf(aelfzp1b_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (cwcel @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ cc1 @ XN @ ccfz))))))).
thf(aoveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF)))))))).
thf(aswrd0fv0_thm,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XI @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ ccc0 @ (cco @ XW @ (ccop @ ccc0 @ XI) @ ccsubstr)) @ (ccfv @ ccc0 @ XW))))))).
...
thf(aswrd0fvlsw_thm,axiom,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ (cco @ XW @ (ccop @ ccc0 @ XL) @ ccsubstr) @ cclsw) @ (ccfv @ (cco @ XL @ cc1 @ ccmin) @ XW))))))).
