...
thf(aop2nda_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwceq @ (ccuni @ (ccrn @ (ccsn @ (ccop @ XA2 @ XB2)))) @ XB2)))))).
...
thf(aop1sta_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwceq @ (ccuni @ (ccdm @ (ccsn @ (ccop @ XA2 @ XB2)))) @ XA2)))))).
...
thf(celxp4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ XB2 @ XC)) @ (cwa @ (cwceq @ XA2 @ (ccop @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ (ccuni @ (ccrn @ (ccsn @ XA2))))) @ (cwa @ (cwcel @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ XB2) @ (cwcel @ (ccuni @ (ccrn @ (ccsn @ XA2))) @ XC)))))))).
