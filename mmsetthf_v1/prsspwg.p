...
thf(cprsspwg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwss @ (ccpr @ XA2 @ XB2) @ (ccpw @ XC)) @ (cwa @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XC)))))))))).
