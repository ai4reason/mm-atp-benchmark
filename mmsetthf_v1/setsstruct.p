...
thf(axrmineq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XB2 @ XA2 @ ccle)) @ (cwceq @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XA2 @ XB2) @ XB2))))).
...
thf(csetsstruct_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XE @ XV) @ (cwcel @ XI @ (ccfv @ XM @ ccuz)) @ (cwbr @ XG @ (ccop @ XM @ XN) @ ccstr)) @ (cwbr @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ (ccop @ XM @ (ccif @ (cwbr @ XI @ XN @ ccle) @ XN @ XI)) @ ccstr))))))))).
