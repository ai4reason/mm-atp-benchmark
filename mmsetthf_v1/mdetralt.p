...
thf(agsummptfidmsplitres_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (cwceq @ (Xc_pl @ Xk) @ (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xk) @ cccmn))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XY @ Xk) @ XB2))) => ((cwi @ Xph @ (cwceq @ (ccin @ XC @ XD) @ cc0)) => ((cwi @ Xph @ (cwceq @ XA2 @ (ccun @ XC @ XD))) => ((! [Xk:$i] : (cwceq @ (XF @ Xk) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XY @ Xk))))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xk) @ (XF @ Xk) @ ccgsu) @ (cco @ (cco @ (XG @ Xk) @ (ccres @ (XF @ Xk) @ XC) @ ccgsu) @ (cco @ (XG @ Xk) @ (ccres @ (XF @ Xk) @ XD) @ ccgsu) @ (Xc_pl @ Xk))))))))))))))))))))))).
...
thf(azrhpsgnodpm_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ cczrh)) => ((cwceq @ XS @ (ccfv @ XN @ ccpsgn)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((cwceq @ XI @ (ccfv @ XR @ ccminusg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XN @ ccevpm)))) @ (cwceq @ (ccfv @ XF @ (cccom @ XY @ XS)) @ (ccfv @ Xc_1 @ XI))))))))))))))))).
...
thf(agsummptfidminv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ (XG @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccminusg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ ccabl))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xx3) @ (cccom @ (XI @ Xx3) @ (XF @ Xx3)) @ ccgsu) @ (ccfv @ (cco @ (XG @ Xx3) @ (XF @ Xx3) @ ccgsu) @ (XI @ Xx3))))))))))))))))))))).
...
thf(agsummptfif1o_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xi) @ ccbs))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XG @ Xi) @ cccmn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XN @ ccfn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xi:$i] : (cwcel @ (XX @ Xi) @ XB2)) @ (^ [Xi:$i] : XN)))) => ((! [Xi:$i] : (cwceq @ (XF @ Xi) @ (ccmpt @ (^ [Xi:$i] : XN) @ (^ [Xi:$i] : (XX @ Xi))))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwf1o @ (XC @ Xi) @ XN @ (XH @ Xi)))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwceq @ (cco @ (XG @ Xi) @ (XF @ Xi) @ ccgsu) @ (cco @ (XG @ Xi) @ (cccom @ (XF @ Xi) @ (XH @ Xi)) @ ccgsu))))))))))))))))))).
...
thf(apmtrodpm_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ XT)) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm))))))))))))).
thf(aevpmodpmf1o_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => (cwi @ (cwa @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) @ (cwf1o @ (ccfv @ XD @ ccevpm) @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)) @ (ccmpt @ (^ [Xf1:$i] : (ccfv @ XD @ ccevpm)) @ (^ [Xf1:$i] : (cco @ XF @ (ccv @ Xf1) @ (ccfv @ XS @ ccplusg))))))))))))).
...
thf(cmdetralt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XD @ Xa) @ (cco @ XN @ (XR @ Xa) @ ccmdat))) => ((! [Xa:$i] : (cwceq @ (XA2 @ Xa) @ (cco @ XN @ (XR @ Xa) @ ccmat))) => ((! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccfv @ (XA2 @ Xa) @ ccbs))) => ((! [Xa:$i] : (cwceq @ (Xc_0 @ Xa) @ (ccfv @ (XR @ Xa) @ cc0g))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ (XR @ Xa) @ cccrg))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XX @ (XB2 @ Xa)))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XI @ XN))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XJ @ XN))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwne @ XI @ XJ))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwral @ (^ [Xa:$i] : (cwceq @ (cco @ XI @ (ccv @ Xa) @ XX) @ (cco @ XJ @ (ccv @ Xa) @ XX))) @ (^ [Xa:$i] : XN)))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwceq @ (ccfv @ XX @ (XD @ Xa)) @ (Xc_0 @ Xa))))))))))))))))))))))))).
