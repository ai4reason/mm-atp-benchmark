...
thf(alo1dm_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ cclo1) @ (cwss @ (ccdm @ XF) @ ccr)))).
thf(arexanre_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccr) @ (cwb @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) @ (cwa @ (Xph @ Xk) @ (Xps @ Xk)))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : ccr)) @ (cwa @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) @ (Xph @ Xk))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : ccr)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) @ (Xps @ Xk))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : ccr))))))))).
...
thf(alo1mptrcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1)) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccr)))))))))).
...
thf(alemul12b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwa @ (cwcel @ XD @ ccr) @ (cwbr @ ccc0 @ XD @ ccle)))) @ (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ XC @ XD @ ccle)) @ (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ ccle)))))))).
