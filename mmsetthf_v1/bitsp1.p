...
thf(cbitsp1_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0)) @ (cwb @ (cwcel @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ XN @ ccbits)) @ (cwcel @ XM @ (ccfv @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ ccbits))))))).
