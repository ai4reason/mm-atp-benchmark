...
thf(celfvmptrab_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : (XV @ Xy1)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XM))))))) => ((! [Xy1:$i] : (cwi @ (cwcel @ XX @ (XV @ Xy1)) @ (cwcel @ XM @ ccvv))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ (XY @ Xx3) @ (ccfv @ XX @ (XF @ Xx3 @ Xy1))) @ (cwa @ (cwcel @ XX @ (XV @ Xy1)) @ (cwcel @ (XY @ Xx3) @ XM)))))))))))))).
