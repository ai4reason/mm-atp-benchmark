...
thf(alesub3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XX @ XC @ ccaddc) @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XB2 @ XX @ ccle)) => (cwi @ Xph @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ ccle)))))))))))))).
...
thf(aprmgaplem7_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XN @ ccn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XF @ (cco @ ccn @ ccn @ ccmap)))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xi:$i] : (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ XF) @ (ccv @ Xi) @ ccaddc) @ (ccv @ Xi) @ ccgcd) @ cclt)) @ (^ [Xi:$i] : (cco @ cc2 @ XN @ ccfz))))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwbr @ (ccv @ Xp) @ (cco @ (ccfv @ XN @ XF) @ cc2 @ ccaddc) @ cclt) @ (cwbr @ (cco @ (ccfv @ XN @ XF) @ XN @ ccaddc) @ (ccv @ Xq) @ cclt) @ (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))))))))))).
thf(cprmgaplem8_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XN @ ccn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XF @ (cco @ ccn @ ccn @ ccmap)))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xi:$i] : (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ XF) @ (ccv @ Xi) @ ccaddc) @ (ccv @ Xi) @ ccgcd) @ cclt)) @ (^ [Xi:$i] : (cco @ cc2 @ XN @ ccfz))))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwbr @ XN @ (cco @ (ccv @ Xq) @ (ccv @ Xp) @ ccmin) @ ccle) @ (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))))))))))).
