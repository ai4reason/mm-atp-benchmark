...
thf(c_0ringdif_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwb @ (cwcel @ XR @ (ccdif @ ccrg @ ccnzr)) @ (cwa @ (cwcel @ XR @ ccrg) @ (cwceq @ XB2 @ (ccsn @ Xc_0)))))))))).
