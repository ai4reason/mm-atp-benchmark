...
thf(afacwordi_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0) @ (cwbr @ XM @ XN @ ccle)) @ (cwbr @ (ccfv @ XM @ ccfa) @ (ccfv @ XN @ ccfa) @ ccle))))).
...
thf(caaliou3lem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (cwceq @ (XF @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ cc2 @ (ccneg @ (ccfv @ (ccv @ Xa) @ ccfa)) @ ccexp))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xa @ Xb) @ (ccsu @ ccn @ (^ [Xb:$i] : (ccfv @ (ccv @ Xb) @ (XF @ Xa))))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XH @ Xa @ Xb @ Xc) @ (ccmpt @ (^ [Xc:$i] : ccn) @ (^ [Xc:$i] : (ccsu @ (cco @ cc1 @ (ccv @ Xc) @ ccfz) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xb) @ (XF @ Xa)))))))))) => (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwcel @ (cco @ (ccfv @ XA2 @ (XH @ Xa @ Xb @ Xc)) @ (cco @ cc2 @ (ccfv @ XA2 @ ccfa) @ ccexp) @ ccmul) @ ccz))))))))))))).
