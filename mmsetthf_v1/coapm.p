...
thf(admcoass_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XC @ cccoa)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => (cwss @ (ccdm @ Xc_x) @ (ccxp @ XA2 @ XA2)))))))).
...
thf(ahomarw_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => ((cwceq @ XH @ (ccfv @ XC @ cchoma)) => (cwss @ (cco @ XX @ XY @ XH) @ XA2))))))))).
thf(cchom_tp,type,(cchom : ($i > $o))).
thf(ccbs_tp,type,(ccbs : ($i > $o))).
thf(acoahom_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XC @ cccoa)) => ((cwceq @ XH @ (ccfv @ XC @ cchoma)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XY @ XZ @ XH))) => (cwi @ Xph @ (cwcel @ (cco @ XG @ XF @ Xc_x) @ (cco @ XX @ XZ @ XH))))))))))))))))).
...
thf(aeldmcoa_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XC @ cccoa)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => (cwb @ (cwbr @ XG @ XF @ (ccdm @ Xc_x)) @ (cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XG @ XA2) @ (cwceq @ (ccfv @ XF @ cccoda) @ (ccfv @ XG @ ccdoma)))))))))))).
...
thf(ccoapm_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XC @ cccoa)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => (cwcel @ Xc_x @ (cco @ XA2 @ (ccxp @ XA2 @ XA2) @ ccpm)))))))).
