...
thf(cbcp1ctr_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (cco @ XN @ cc1 @ ccaddc) @ ccbc) @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ (cco @ cc2 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ (cco @ XN @ cc1 @ ccaddc) @ ccdiv) @ ccmul) @ ccmul))))).
