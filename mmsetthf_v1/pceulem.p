...
thf(cpceulem_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xn) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xn) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xs1) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XV @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xt) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (cwcel @ XP @ ccprime))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (cwne @ XN @ ccc0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccz) @ (cwcel @ (ccv @ Xy1) @ ccn)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (cwceq @ XN @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (cwa @ (cwcel @ (ccv @ Xs1) @ ccz) @ (cwcel @ (ccv @ Xt) @ ccn)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (cwceq @ XN @ (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ ccdiv)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (cwceq @ (cco @ (XS @ Xx3 @ Xy1 @ Xn) @ (XT @ Xx3 @ Xy1 @ Xn) @ ccmin) @ (cco @ (XU @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ (XV @ Xx3 @ Xy1 @ Xt @ Xn @ Xs1) @ ccmin)))))))))))))))))))))))))).
