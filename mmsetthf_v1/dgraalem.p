...
thf(cdgraalem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwa @ (cwcel @ (ccfv @ XA2 @ ccdgraa) @ ccn) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccfv @ XA2 @ ccdgraa)) @ (cwceq @ (ccfv @ XA2 @ (ccv @ Xp)) @ ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))).
