...
thf(afmf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2) @ (cwf @ XY @ XX @ XF)) @ (cwf @ (ccfv @ XY @ ccfbas) @ (ccfv @ XX @ ccfil) @ (cco @ XX @ XF @ ccfm))))))))).
...
thf(aimp44_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ Xta)))) => (cwi @ (cwa @ Xph @ (cwa @ (cwa @ Xps @ Xch) @ Xth)) @ Xta)))))))).
...
thf(crnelfm_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XY @ XA2) @ (cwcel @ XL @ (ccfv @ XX @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwb @ (cwcel @ XL @ (ccrn @ (cco @ XX @ XF @ ccfm))) @ (cwcel @ (ccrn @ XF) @ XL))))))))).
