...
thf(ainmap_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XC @ XZ)) => (cwi @ Xph @ (cwceq @ (ccin @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap)) @ (cco @ (ccin @ XA2 @ XB2) @ XC @ ccmap)))))))))))))).
...
thf(adifmapsn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XC @ XZ)) => (cwi @ Xph @ (cwceq @ (ccdif @ (cco @ XA2 @ (ccsn @ XC) @ ccmap) @ (cco @ XB2 @ (ccsn @ XC) @ ccmap)) @ (cco @ (ccdif @ XA2 @ XB2) @ (ccsn @ XC) @ ccmap)))))))))))))).
...
thf(aovnovol_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (ccfv @ (ccsn @ XA2) @ ccovoln)) @ (ccfv @ XB2 @ ccovol)))))))))).
...
thf(avonvolmbllem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XA2 @ Xy1) @ (XV @ Xy1 @ Xf1))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1) @ (cwss @ (XB2 @ Xf1) @ ccr)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1) @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ ccovol) @ (cco @ (ccfv @ (ccin @ (ccv @ Xy1) @ (XB2 @ Xf1)) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xy1) @ (XB2 @ Xf1)) @ ccovol) @ ccxad))) @ (^ [Xy1:$i] : (ccpw @ ccr)))))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwss @ (XX @ Xy1) @ (cco @ ccr @ (ccsn @ (XA2 @ Xy1)) @ ccmap)))) => ((! [Xy1:$i] : (cwceq @ XY @ (cciun @ (^ [Xf1:$i] : (XX @ Xy1)) @ (^ [Xf1:$i] : (ccrn @ (ccv @ Xf1)))))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ (cco @ (ccfv @ (ccin @ (XX @ Xy1) @ (cco @ (XB2 @ Xf1) @ (ccsn @ (XA2 @ Xy1)) @ ccmap)) @ (ccfv @ (ccsn @ (XA2 @ Xy1)) @ ccovoln)) @ (ccfv @ (ccdif @ (XX @ Xy1) @ (cco @ (XB2 @ Xf1) @ (ccsn @ (XA2 @ Xy1)) @ ccmap)) @ (ccfv @ (ccsn @ (XA2 @ Xy1)) @ ccovoln)) @ ccxad) @ (ccfv @ (XX @ Xy1) @ (ccfv @ (ccsn @ (XA2 @ Xy1)) @ ccovoln)))))))))))))))))).
...
thf(aisvonmbl_thm,axiom,(! [Xph:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XX @ ccfn))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwb @ (cwcel @ XE @ (ccdm @ (ccfv @ XX @ ccvoln))) @ (cwa @ (cwss @ XE @ (cco @ ccr @ XX @ ccmap)) @ (cwral @ (^ [Xa:$i] : (cwceq @ (cco @ (ccfv @ (ccin @ (ccv @ Xa) @ XE) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccdif @ (ccv @ Xa) @ XE) @ (ccfv @ XX @ ccovoln)) @ ccxad) @ (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)))) @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))))))))))))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(aismbl4_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwa @ (cwss @ XA2 @ ccr) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ ccovol) @ (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccxad))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
thf(cvonvolmbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwcel @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (ccdm @ (ccfv @ (ccsn @ XA2) @ ccvoln))) @ (cwcel @ XB2 @ (ccdm @ ccvol))))))))))).
