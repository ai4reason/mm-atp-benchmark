...
thf(atrin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwtr @ XA2) @ (cwtr @ XB2)) @ (cwtr @ (ccin @ XA2 @ XB2)))))).
...
thf(agrudomon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ ccgru) @ (cwcel @ XA2 @ ccon0) @ (cwa @ (cwcel @ XB2 @ XU) @ (cwbr @ XA2 @ XB2 @ ccdom))) @ (cwcel @ XA2 @ XU)))))).
...
thf(acflm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XB2 @ Xx3 @ Xy1)) @ (cwlim @ XA2)) @ (cwceq @ (ccfv @ XA2 @ cccf) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwceq @ XA2 @ (ccuni @ (ccv @ Xy1))))))))))))))))).
...
thf(agruen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ ccgru) @ (cwss @ XA2 @ XU) @ (cwa @ (cwcel @ XB2 @ XU) @ (cwbr @ XB2 @ XA2 @ ccen))) @ (cwcel @ XA2 @ XU)))))).
thf(cciun_tp,type,(cciun : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(agruuni_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ ccgru) @ (cwcel @ XA2 @ XU)) @ (cwcel @ (ccuni @ XA2) @ XU))))).
...
thf(cgruina_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XA2 @ (ccin @ XU @ ccon0)) => (cwi @ (cwa @ (cwcel @ XU @ ccgru) @ (cwne @ XU @ cc0)) @ (cwcel @ XA2 @ ccina)))))).
