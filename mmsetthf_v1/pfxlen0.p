...
thf(cpfxlen0_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ ccn0) @ (cwceq @ (ccfv @ XW @ cchash) @ (cco @ XL @ cc1 @ ccaddc))) @ (cwceq @ (ccfv @ (cco @ XW @ XL @ ccpfx) @ cchash) @ XL)))))).
