...
thf(antrss3_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwss @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ XX))))))).
...
thf(abln0_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccrp)) @ (cwne @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ cc0))))))).
...
thf(adifopn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XA2 @ XJ) @ (cwcel @ XB2 @ (ccfv @ XJ @ cccld))) @ (cwcel @ (ccdif @ XA2 @ XB2) @ XJ)))))))).
...
thf(aimp5d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))))) => (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ (cwi @ (cwa @ Xth @ Xta) @ Xet)))))))))).
thf(acom35_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))))) => (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xta @ (cwi @ Xth @ (cwi @ Xch @ Xet))))))))))))).
...
thf(ablsscls_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cw3a @ (cwcel @ XR @ ccxr) @ (cwcel @ XS @ ccxr) @ (cwbr @ XR @ XS @ cclt))) @ (cwss @ (ccfv @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccfv @ XJ @ cccl)) @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl)))))))))))).
...
thf(aaxdc4uz_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((cwcel @ XM @ ccz) => ((! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ XM @ ccuz))) => (! [Xg1:$i] : (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xg1 @ Xk)) @ (cwcel @ (XC @ Xk) @ XA2) @ (cwf @ (ccxp @ (XZ @ Xk) @ XA2) @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ XF)) @ (cwex @ (^ [Xg1:$i] : (cw3a @ (cwf @ (XZ @ Xk) @ XA2 @ (ccv @ Xg1)) @ (cwceq @ (ccfv @ XM @ (ccv @ Xg1)) @ (XC @ Xk)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ XF))) @ (^ [Xk:$i] : (XZ @ Xk)))))))))))))))))).
...
thf(abcthlem4_thm,axiom,(! [Xph:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XD @ (ccfv @ XX @ ccms)))) => ((cwceq @ XF @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccn)) @ (^ [Xk:$i] : (^ [Xz:$i] : (ccxp @ XX @ ccrp))) @ (^ [Xk:$i] : (^ [Xz:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xr) @ ccrp)) @ (cwa @ (cwbr @ (ccv @ Xr) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ cclt) @ (cwss @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ (ccfv @ XJ @ cccl)) @ (ccdif @ (ccfv @ (ccv @ Xz) @ (ccfv @ XD @ ccbl)) @ (ccfv @ (ccv @ Xk) @ XM)))))))))))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ (XR @ Xz @ Xg1 @ Xk @ Xr) @ ccrp)))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ (XC @ Xz @ Xg1 @ Xk) @ XX))))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwf @ ccn @ (ccxp @ XX @ ccrp) @ (ccv @ Xg1)))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xg1) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xg1)) @ (ccop @ (XC @ Xz @ Xg1 @ Xk) @ (XR @ Xz @ Xg1 @ Xk @ Xr)))))))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ XF))) @ (^ [Xk:$i] : ccn)))) => (! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xg1) @ (cwne @ (ccdif @ (cco @ (XC @ Xz @ Xg1 @ Xk) @ (XR @ Xz @ Xg1 @ Xk @ Xr) @ (ccfv @ XD @ ccbl)) @ (ccuni @ (ccrn @ XM))) @ cc0)))))))))))))))))))))))).
...
thf(cbcthlem5_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccms))) => ((cwceq @ XF @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccn)) @ (^ [Xk:$i] : (^ [Xz:$i] : (ccxp @ XX @ ccrp))) @ (^ [Xk:$i] : (^ [Xz:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xr) @ ccrp)) @ (cwa @ (cwbr @ (ccv @ Xr) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ cclt) @ (cwss @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ (ccfv @ XJ @ cccl)) @ (ccdif @ (ccfv @ (ccv @ Xz) @ (ccfv @ XD @ ccbl)) @ (ccfv @ (ccv @ Xk) @ XM)))))))))))) => ((cwi @ Xph @ (cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM)) => ((cwi @ Xph @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ ccnt)) @ cc0)) @ (^ [Xk:$i] : ccn))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccuni @ (ccrn @ XM)) @ (ccfv @ XJ @ ccnt)) @ cc0)))))))))))))).
