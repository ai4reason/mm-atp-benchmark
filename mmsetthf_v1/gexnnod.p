...
thf(a_0dvds_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwbr @ ccc0 @ XN @ ccdvds) @ (cwceq @ XN @ ccc0))))).
...
thf(agexod_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX)) @ (cwbr @ (ccfv @ XA2 @ XO) @ XE @ ccdvds))))))))))).
...
thf(cgexnnod_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XE @ ccn) @ (cwcel @ XA2 @ XX)) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn))))))))))).
