...
thf(cdirtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccdir) @ (cwcel @ XC @ XV)) @ (cwa @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XB2 @ XC @ XR))) @ (cwbr @ XA2 @ XC @ XR)))))))).
