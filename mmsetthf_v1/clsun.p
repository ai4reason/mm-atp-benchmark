...
thf(antrdif_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwceq @ (ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ ccnt)) @ (ccdif @ XX @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)))))))))).
...
thf(cclsun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX) @ (cwss @ XB2 @ XX)) @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ (ccfv @ XJ @ cccl)) @ (ccun @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ XB2 @ (ccfv @ XJ @ cccl))))))))))).
