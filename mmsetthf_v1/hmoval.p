...
thf(adf_hmo_ax,axiom,(cwceq @ cchmo @ (ccmpt @ (^ [Xu:$i] : ccnv) @ (^ [Xu:$i] : (ccrab @ (^ [Xt:$i] : (cwceq @ (ccfv @ (ccv @ Xt) @ (cco @ (ccv @ Xu) @ (ccv @ Xu) @ ccaj)) @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccdm @ (cco @ (ccv @ Xu) @ (ccv @ Xu) @ ccaj)))))))).
...
thf(chmoval_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XH @ Xt) @ (ccfv @ XU @ cchmo))) => ((cwceq @ XA2 @ (cco @ XU @ XU @ ccaj)) => (! [Xt:$i] : (cwi @ (cwcel @ XU @ ccnv) @ (cwceq @ (XH @ Xt) @ (ccrab @ (^ [Xt:$i] : (cwceq @ (ccfv @ (ccv @ Xt) @ XA2) @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccdm @ XA2)))))))))))).
