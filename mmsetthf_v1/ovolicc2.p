...
thf(acmpsub_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwss @ XS @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwss @ XS @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ XJ)))))))))).
...
thf(aovolicc2lem5_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ ccr))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XB2 @ ccr))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ XA2 @ XB2 @ ccle))) => ((! [Xu:$i] : (! [Xt:$i] : (cwceq @ (XS @ Xu @ Xt) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XF @ Xu)) @ cc1)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ (XF @ Xu)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XU @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ (XF @ Xu)))) @ ccfn)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ XU)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwf @ XU @ ccn @ (XG @ Xu)))) => ((! [Xu:$i] : (! [Xt:$i] : (cwi @ (cwa @ (Xph @ Xu) @ (cwcel @ (ccv @ Xt) @ XU)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (cccom @ ccioo @ (XF @ Xu))) @ (ccv @ Xt))))) => ((! [Xu:$i] : (cwceq @ (XT @ Xu) @ (ccrab @ (^ [Xu:$i] : (cwne @ (ccin @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccicc)) @ cc0)) @ (^ [Xu:$i] : XU)))) => (! [Xu:$i] : (! [Xt:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccsup @ (ccrn @ (XS @ Xu @ Xt)) @ ccxr @ cclt) @ ccle))))))))))))))))))))))).
...
thf(covolicc2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xf1:$i] : (cwceq @ (XM @ Xf1) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) @ (cwceq @ (ccv @ Xy1) @ (ccsup @ (ccrn @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccv @ Xf1)) @ cc1)) @ ccxr @ cclt)))) @ (^ [Xf1:$i] : (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr)))) => (cwi @ Xph @ (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccovol) @ ccle))))))))))).
