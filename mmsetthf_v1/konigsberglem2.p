...
thf(avdegp1ai_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((cwcel @ XU @ XV) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwcel @ (XI @ Xx3) @ (ccword @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0))))))) => ((! [Xx3:$i] : (cwceq @ (ccfv @ XU @ (ccfv @ (XG @ Xx3) @ ccvtxdg)) @ (XP @ Xx3))) => ((! [Xx3:$i] : (cwceq @ (ccfv @ (XF @ Xx3) @ ccvtx) @ XV)) => ((cwcel @ XX @ XV) => ((cwne @ XX @ XU) => ((cwcel @ XY @ XV) => ((cwne @ XY @ XU) => ((! [Xx3:$i] : (cwceq @ (ccfv @ (XF @ Xx3) @ cciedg) @ (cco @ (XI @ Xx3) @ (ccs1 @ (ccpr @ XX @ XY)) @ ccconcat))) => (! [Xx3:$i] : (cwceq @ (ccfv @ XU @ (ccfv @ (XF @ Xx3) @ ccvtxdg)) @ (XP @ Xx3))))))))))))))))))))))).
...
thf(akonigsbergssiedgw_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3)))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccop @ XV @ (XE @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ (XA2 @ Xx3) @ (ccword @ ccvv)) @ (cwcel @ (XB2 @ Xx3) @ (ccword @ ccvv)) @ (cwceq @ (XE @ Xx3) @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccconcat))) @ (cwcel @ (XA2 @ Xx3) @ (ccword @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0))))))))))))))))).
...
thf(as5s2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ (cco @ (ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) @ (ccs2 @ XF @ XG) @ ccconcat)))))))))).
...
thf(as3s4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ (cco @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs4 @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
thf(as2s5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ (cco @ (ccs2 @ XA2 @ XB2) @ (ccs5 @ XC @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
thf(as1s6_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ (cco @ (ccs1 @ XA2) @ (ccs6 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
...
thf(avtxdg0e_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XU @ XV) @ (cwceq @ XI @ cc0)) @ (cwceq @ (ccfv @ XU @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((cwi @ Xph @ Xps) => Xps))))).
thf(a_0elfz_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ ccc0 @ (cco @ ccc0 @ XN @ ccfz))))).
thf(a_0ne1_thm,axiom,(cwne @ ccc0 @ cc1)).
thf(as0s1_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccs1 @ XA2) @ (cco @ cc0 @ (ccs1 @ XA2) @ ccconcat)))).
...
thf(akonigsbergvtx_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((cwceq @ XE @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwceq @ (ccfv @ XG @ ccvtx) @ (cco @ ccc0 @ cc3 @ ccfz))))))))).
thf(akonigsbergiedg_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((cwceq @ XE @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwceq @ (ccfv @ XG @ cciedg) @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3)))))))))).
thf(ckonigsberglem2_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((cwceq @ XE @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwceq @ (ccfv @ cc1 @ (ccfv @ XG @ ccvtxdg)) @ cc3)))))))).
