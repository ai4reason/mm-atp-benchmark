...
thf(aofpreima_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xp:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XB2 @ Xp) @ XF))) => ((! [Xp:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XC @ Xp) @ XG))) => ((! [Xp:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xp)))) => ((! [Xp:$i] : (cwi @ Xph @ (cwfn @ XR @ (ccxp @ (XB2 @ Xp) @ (XC @ Xp))))) => (cwi @ Xph @ (cwceq @ (ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ XR))) @ XD) @ (cciun @ (^ [Xp:$i] : (ccima @ (cccnv @ XR) @ XD)) @ (^ [Xp:$i] : (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccfv @ (ccv @ Xp) @ cc1st))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccfv @ (ccv @ Xp) @ cc2nd)))))))))))))))))))))).
...
thf(cofpreima2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xp:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XB2 @ Xp) @ XF))) => ((! [Xp:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XC @ Xp) @ XG))) => ((! [Xp:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xp)))) => ((! [Xp:$i] : (cwi @ Xph @ (cwfn @ XR @ (ccxp @ (XB2 @ Xp) @ (XC @ Xp))))) => (cwi @ Xph @ (cwceq @ (ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ XR))) @ XD) @ (cciun @ (^ [Xp:$i] : (ccin @ (ccima @ (cccnv @ XR) @ XD) @ (ccxp @ (ccrn @ XF) @ (ccrn @ XG)))) @ (^ [Xp:$i] : (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccfv @ (ccv @ Xp) @ cc1st))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccfv @ (ccv @ Xp) @ cc2nd)))))))))))))))))))))).
