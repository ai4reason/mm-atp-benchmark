...
thf(adf_singles_ax,axiom,(cwceq @ ccsingles @ (ccrn @ ccsingle))).
...
thf(celsingles_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccsingles) @ (cwex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsn @ (ccv @ Xx3)))))))).
