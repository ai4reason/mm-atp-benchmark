...
thf(aprel12g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwa @ (cwcel @ XC @ XX) @ (cwcel @ XD @ XY))) @ (cwi @ (cwn @ (cwceq @ XA2 @ XB2)) @ (cwb @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ (cwa @ (cwcel @ XA2 @ (ccpr @ XC @ XD)) @ (cwcel @ XB2 @ (ccpr @ XC @ XD))))))))))))))).
thf(chash2prd_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ XV) @ (cwceq @ (ccfv @ XP @ cchash) @ cc2)) @ (cwi @ (cw3a @ (cwcel @ XX @ XP) @ (cwcel @ XY @ XP) @ (cwne @ XX @ XY)) @ (cwceq @ XP @ (ccpr @ XX @ XY))))))))).
