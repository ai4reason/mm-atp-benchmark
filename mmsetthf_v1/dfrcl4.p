...
thf(adfrcl3_thm,axiom,(cwceq @ ccrcl @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccun @ (cco @ (ccv @ Xx3) @ ccc0 @ ccrelexp) @ (cco @ (ccv @ Xx3) @ cc1 @ ccrelexp)))))).
...
thf(cdfrcl4_conj,conjecture,(cwceq @ ccrcl @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : (ccpr @ ccc0 @ cc1)) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp))))))).
