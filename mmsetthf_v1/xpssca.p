...
thf(aimassca_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwfo @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ XZ)) => ((cwceq @ XG @ (ccfv @ XR @ ccsca)) => (cwi @ Xph @ (cwceq @ XG @ (ccfv @ XU @ ccsca))))))))))))))))).
...
thf(aprdssca_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwcel @ XR @ XW)) => (cwi @ Xph @ (cwceq @ XS @ (ccfv @ XP @ ccsca))))))))))))).
...
thf(cxpssca_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XT @ (cco @ XR @ XS @ ccxps)) => ((cwceq @ XG @ (ccfv @ XR @ ccsca)) => ((cwi @ Xph @ (cwcel @ XR @ XV)) => ((cwi @ Xph @ (cwcel @ XS @ XW)) => (cwi @ Xph @ (cwceq @ XG @ (ccfv @ XT @ ccsca))))))))))))))).
