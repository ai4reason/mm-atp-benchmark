...
thf(aiinxsng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (XB2 @ Xx3) @ XC))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwceq @ (cciin @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC))))))))).
...
thf(cpolatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_pe:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XK @ ccoc)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => ((cwceq @ XP @ (ccfv @ XK @ ccpolN)) => (cwi @ (cwa @ (cwcel @ XK @ ccol) @ (cwcel @ XQ @ XA2)) @ (cwceq @ (ccfv @ (ccsn @ XQ) @ XP) @ (ccfv @ (ccfv @ XQ @ Xc_pe) @ XM)))))))))))))).
