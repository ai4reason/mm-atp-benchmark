...
thf(csupgtoreq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwor @ XA2 @ XR)) => ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XC @ XB2)) => ((cwi @ Xph @ (cwceq @ XS @ (ccsup @ XB2 @ XA2 @ XR))) => (cwi @ Xph @ (cwo @ (cwbr @ XC @ XS @ XR) @ (cwceq @ XC @ XS))))))))))))))).
