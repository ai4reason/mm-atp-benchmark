...
thf(alspsnvs_thm,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cw3a @ (cwcel @ XW @ cclvec) @ (cwa @ (cwcel @ XR @ XK) @ (cwne @ XR @ Xc_0)) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ (ccsn @ (cco @ XR @ XX @ Xc_x)) @ XN) @ (ccfv @ (ccsn @ XX) @ XN))))))))))))))))))).
