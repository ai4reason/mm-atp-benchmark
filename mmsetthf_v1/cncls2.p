...
thf(acncls2i_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwss @ XS @ XY)) @ (cwss @ (ccfv @ (ccima @ (cccnv @ XF) @ XS) @ (ccfv @ XJ @ cccl)) @ (ccima @ (cccnv @ XF) @ (ccfv @ XS @ (ccfv @ XK @ cccl)))))))))))).
...
thf(aiscld4_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XS @ (ccfv @ XJ @ cccld)) @ (cwss @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ XS)))))))).
...
thf(ccncls2_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) @ (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ (ccfv @ XJ @ cccl)) @ (ccima @ (cccnv @ XF) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XK @ cccl))))) @ (^ [Xx3:$i] : (ccpw @ XY)))))))))))).
