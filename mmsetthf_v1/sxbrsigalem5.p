...
thf(abr2base_thm,axiom,(cwceq @ (ccuni @ (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccbrsiga)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccbrsiga)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))) @ (ccxp @ ccr @ ccr))).
...
thf(assoprab2i_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz) @ (Xps @ Xx3 @ Xy1 @ Xz))))) => (cwss @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)))))))))).
...
thf(asssigagen2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwss @ XB2 @ XA2)) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccsigagen))))))).
...
thf(asxbrsigalem4_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xv @ Xu @ Xn) @ (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xn:$i] : (cwceq @ (XI @ Xn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico)))))) => ((! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xv @ Xu) @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (ccv @ Xu) @ (ccv @ Xv))))))))) => (! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (ccfv @ (cco @ (XJ @ Xv @ Xu @ Xn) @ (XJ @ Xv @ Xu @ Xn) @ cctx) @ ccsigagen) @ (ccfv @ (ccrn @ (XR @ Xv @ Xu)) @ ccsigagen)))))))))))).
thf(asxval_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1) @ (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XT)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XS @ (XV @ Xx3 @ Xy1)) @ (cwcel @ XT @ (XW @ Xx3 @ Xy1))) @ (cwceq @ (cco @ XS @ XT @ ccsx) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccsigagen)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(csxbrsigalem5_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XJ @ Xn) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xn:$i] : (cwceq @ (XI @ Xn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico)))))) => ((! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xv @ Xu) @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (ccv @ Xu) @ (ccv @ Xv))))))))) => (! [Xn:$i] : (cwss @ (ccfv @ (cco @ (XJ @ Xn) @ (XJ @ Xn) @ cctx) @ ccsigagen) @ (cco @ ccbrsiga @ ccbrsiga @ ccsx)))))))))).
