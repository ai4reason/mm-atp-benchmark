...
thf(adf_chsup_ax,axiom,(cwceq @ cchsup @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccpw @ cchil))) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ ccort) @ ccort))))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(chsupval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccpw @ cchil)) @ (cwceq @ (ccfv @ XA2 @ cchsup) @ (ccfv @ (ccfv @ (ccuni @ XA2) @ ccort) @ ccort))))).
