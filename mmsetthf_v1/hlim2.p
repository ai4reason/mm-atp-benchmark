...
thf(chlim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf @ ccn @ cchil @ XF) @ (cwcel @ XA2 @ cchil)) @ (cwb @ (cwbr @ XF @ XA2 @ cchli) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ XA2 @ ccmv) @ ccno) @ (ccv @ Xx3) @ cclt)) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccrp))))))).
