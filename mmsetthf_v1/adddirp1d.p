...
thf(cadddirp1d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XB2 @ ccmul) @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XB2 @ ccaddc))))))))).
