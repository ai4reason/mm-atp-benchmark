...
thf(aaddrfn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD)) @ (cwfn @ (cco @ XA2 @ XB2 @ ccplusr) @ ccr))))))).
...
thf(aaddcomgi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XB2 @ XA2 @ ccaddc))))).
thf(aaddrfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XE) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ ccr)) @ (cwceq @ (ccfv @ XC @ (cco @ XA2 @ XB2 @ ccplusr)) @ (cco @ (ccfv @ XC @ XA2) @ (ccfv @ XC @ XB2) @ ccaddc))))))))).
...
thf(caddrcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccplusr) @ (cco @ XB2 @ XA2 @ ccplusr)))))))).
