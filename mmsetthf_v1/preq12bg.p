...
thf(cpreq12bg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwa @ (cwcel @ XC @ XX) @ (cwcel @ XD @ XY))) @ (cwb @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ (cwo @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)) @ (cwa @ (cwceq @ XA2 @ XD) @ (cwceq @ XB2 @ XC)))))))))))))).
