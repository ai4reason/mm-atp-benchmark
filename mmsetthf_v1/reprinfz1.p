...
thf(creprinfz1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XN @ (ccfv @ XS @ ccrepr)) @ (cco @ (ccin @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ XN @ (ccfv @ XS @ ccrepr)))))))))))).
