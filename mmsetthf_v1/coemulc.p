...
thf(ccoemulc_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XF @ (ccfv @ XS @ ccply))) @ (cwceq @ (ccfv @ (cco @ (ccxp @ ccc @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ cccoe) @ (cco @ (ccxp @ ccn0 @ (ccsn @ XA2)) @ (ccfv @ XF @ cccoe) @ (ccof @ ccmul)))))))).
