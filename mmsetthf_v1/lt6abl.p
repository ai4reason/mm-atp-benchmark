...
thf(amt3i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwn @ Xch) => ((cwi @ Xph @ (cwi @ (cwn @ Xps) @ Xch)) => (cwi @ Xph @ Xps))))))).
...
thf(afzo12sn_thm,axiom,(cwceq @ (cco @ cc1 @ cc2 @ ccfzo) @ (ccsn @ cc1))).
...
thf(aprmcyg_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ (ccfv @ XB2 @ cchash) @ ccprime)) @ (cwcel @ XG @ cccyg)))))).
...
thf(agex2abl_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwbr @ XE @ cc2 @ ccdvds)) @ (cwcel @ XG @ ccabl)))))))).
...
thf(aiscygodd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwi @ Xph @ (cwcel @ XG @ ccgrp)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XX @ XO) @ (ccfv @ XB2 @ cchash))) => (cwi @ Xph @ (cwcel @ XG @ cccyg))))))))))))).
...
thf(clt6abl_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwbr @ (ccfv @ XB2 @ cchash) @ cc6 @ cclt)) @ (cwcel @ XG @ ccabl)))))).
