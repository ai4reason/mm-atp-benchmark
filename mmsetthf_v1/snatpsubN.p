...
thf(csnatpsubN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => (cwi @ (cwa @ (cwcel @ XK @ ccal) @ (cwcel @ XP @ XA2)) @ (cwcel @ (ccsn @ XP) @ XS))))))))).
