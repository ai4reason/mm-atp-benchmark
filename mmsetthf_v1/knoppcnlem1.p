...
thf(cknoppcnlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xy1 @ Xn) @ (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XC @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ XT) @ ccmul)))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xy1) @ ccn0))) => (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XM @ Xy1) @ (ccfv @ XA2 @ (XF @ Xy1 @ Xn))) @ (cco @ (cco @ XC @ (XM @ Xy1) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (XM @ Xy1) @ ccexp) @ XA2 @ ccmul) @ XT) @ ccmul)))))))))))))))).
