...
thf(aqexpcl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccq) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccq))))).
...
thf(cqabvexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (cco @ cccnfld @ ccq @ ccress)) => ((cwceq @ XA2 @ (ccfv @ XQ @ ccabv)) => (cwi @ (cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XM @ ccq) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ (cco @ XM @ XN @ ccexp) @ XF) @ (cco @ (ccfv @ XM @ XF) @ XN @ ccexp))))))))))).
