...
thf(aftp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwne @ XA2 @ XB2) => ((cwne @ XA2 @ XC) => ((cwne @ XB2 @ XC) => (cwf @ (cctp @ XA2 @ XB2 @ XC) @ (cctp @ XX @ XY @ XZ) @ (cctp @ (ccop @ XA2 @ XX) @ (ccop @ XB2 @ XY) @ (ccop @ XC @ XZ))))))))))))))))))).
...
thf(afztp_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccz) @ (cwceq @ (cco @ XM @ (cco @ XM @ cc2 @ ccaddc) @ ccfz) @ (cctp @ XM @ (cco @ XM @ cc1 @ ccaddc) @ (cco @ XM @ cc2 @ ccaddc)))))).
...
thf(asumtp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XA2) @ (cwceq @ (XD @ Xk) @ XE))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XB2) @ (cwceq @ (XD @ Xk) @ XF))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XC) @ (cwceq @ (XD @ Xk) @ XG))) => ((cwi @ Xph @ (cw3a @ (cwcel @ XE @ ccc) @ (cwcel @ XF @ ccc) @ (cwcel @ XG @ ccc))) => ((cwi @ Xph @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX))) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwne @ XA2 @ XC)) => ((cwi @ Xph @ (cwne @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cctp @ XA2 @ XB2 @ XC) @ (^ [Xk:$i] : (XD @ Xk))) @ (cco @ (cco @ XE @ XF @ ccaddc) @ XG @ ccaddc))))))))))))))))))))))).
thf(asyl6eq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwceq @ XB2 @ XC) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(afveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(amp2an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => ((cwi @ (cwa @ Xph @ Xps) @ Xch) => Xch))))))).
thf(afvtp1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XD @ ccvv) => (cwi @ (cwa @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC)) @ (cwceq @ (ccfv @ XA2 @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) @ XD))))))))))).
thf(afvtp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XE @ ccvv) => (cwi @ (cwa @ (cwne @ XA2 @ XB2) @ (cwne @ XB2 @ XC)) @ (cwceq @ (ccfv @ XB2 @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) @ XE))))))))))).
thf(afvtp3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)) @ (cwceq @ (ccfv @ XC @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) @ XF))))))))))).
...
thf(cnnsum4primesoddALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc7 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc8 @ ccuz)) @ (cwcel @ XN @ ccodd)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XN @ (ccsu @ (cco @ cc1 @ cc3 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))))))).
