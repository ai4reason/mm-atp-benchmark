...
thf(alenegsq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ ccle)) @ (cwb @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (ccneg @ XA2) @ XB2 @ ccle)) @ (cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccle)))))).
...
thf(csinbnd_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwa @ (cwbr @ (ccneg @ cc1) @ (ccfv @ XA2 @ ccsin) @ ccle) @ (cwbr @ (ccfv @ XA2 @ ccsin) @ cc1 @ ccle))))).
