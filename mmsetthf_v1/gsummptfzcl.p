...
thf(agsumval2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwf @ (cco @ XM @ XN @ ccfz) @ XB2 @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ ccgsu) @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)))))))))))))))))).
