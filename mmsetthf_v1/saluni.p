...
thf(a_0sal_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ ccsalg) @ (cwcel @ cc0 @ XS)))).
thf(asaldifcl_thm,axiom,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ ccsalg) @ (cwcel @ XE @ XS)) @ (cwcel @ (ccdif @ (ccuni @ XS) @ XE) @ XS))))).
thf(csaluni_conj,conjecture,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ ccsalg) @ (cwcel @ (ccuni @ XS) @ XS)))).
