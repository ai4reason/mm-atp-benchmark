...
thf(crhmsscrnghm_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwceq @ XR @ (ccin @ ccrg @ XU))) => ((cwi @ Xph @ (cwceq @ XS @ (ccin @ ccrng @ XU))) => (cwi @ Xph @ (cwbr @ (ccres @ ccrh @ (ccxp @ XR @ XR)) @ (ccres @ ccrngh @ (ccxp @ XS @ XS)) @ ccssc))))))))))).
