...
thf(ariinopn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XJ)) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ (ccin @ XX @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ XJ)))))))).
...
thf(ciuncld_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccfv @ XJ @ cccld))) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ XJ @ cccld))))))))).
