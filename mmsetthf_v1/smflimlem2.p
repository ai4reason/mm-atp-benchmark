...
thf(aiineq1d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ XA2 @ XB2))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(aclimleltrp_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XN @ (XZ @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (ccfv @ XN @ ccuz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccr))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XF @ Xk) @ XA2 @ ccli))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XC @ Xj @ Xk) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ XA2 @ (XC @ Xj @ Xk) @ ccle)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XX @ ccrp))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccr) @ (cwbr @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ (cco @ (XC @ Xj @ Xk) @ XX @ ccaddc) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xk))))))))))))))))))))))).
...
thf(afnlimfv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xm:$i] : (cwnfc @ (^ [Xx3:$i] : (XD @ Xx3 @ Xm)))) => ((! [Xm:$i] : (cwnfc @ (^ [Xx3:$i] : (XF @ Xx3 @ Xm)))) => ((! [Xx3:$i] : (! [Xm:$i] : (cwceq @ (XG @ Xx3 @ Xm) @ (ccmpt @ (^ [Xx3:$i] : (XD @ Xx3 @ Xm)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xm:$i] : (XZ @ Xm)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))) @ ccli)))))) => ((! [Xx3:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xm) @ (cwcel @ (XX @ Xx3) @ (XD @ Xx3 @ Xm))))) => (! [Xx3:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xm) @ (cwceq @ (ccfv @ (XX @ Xx3) @ (XG @ Xx3 @ Xm)) @ (ccfv @ (ccmpt @ (^ [Xm:$i] : (XZ @ Xm)) @ (^ [Xm:$i] : (ccfv @ (XX @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))) @ ccli)))))))))))))))).
...
thf(annrecrp_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ cc1 @ XN @ ccdiv) @ ccrp)))).
...
thf(csmflimlem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XM:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XZ @ Xs1 @ Xr) @ (ccfv @ (XM @ Xx3 @ Xk @ Xm @ Xn @ Xs1 @ Xr) @ ccuz)))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XS @ Xx3 @ Xk @ Xm @ Xn @ Xr) @ ccsalg)))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwf @ (XZ @ Xs1 @ Xr) @ (ccfv @ (XS @ Xx3 @ Xk @ Xm @ Xn @ Xr) @ ccsmblfn) @ (XF @ Xk @ Xm @ Xr))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XD @ Xx3 @ Xs1 @ Xr) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccmpt @ (^ [Xm:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xk @ Xm @ Xr))))) @ (ccdm @ ccli))) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xk @ Xm @ Xr)))))))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XG @ Xx3 @ Xs1 @ Xr) @ (ccmpt @ (^ [Xx3:$i] : (XD @ Xx3 @ Xs1 @ Xr)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xm:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xk @ Xm @ Xr))))) @ ccli)))))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XA2 @ Xx3 @ Xr) @ ccr))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XP @ Xx3 @ Xk @ Xm @ Xn @ Xs1) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xk:$i] : (XZ @ Xs1 @ Xr))) @ (^ [Xm:$i] : (^ [Xk:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xk @ Xm @ Xr))) @ (cco @ (XA2 @ Xx3 @ Xr) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ cclt)) @ (^ [Xx3:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xk @ Xm @ Xr))))) @ (ccin @ (ccv @ Xs1) @ (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xk @ Xm @ Xr)))))) @ (^ [Xs1:$i] : (XS @ Xx3 @ Xk @ Xm @ Xn @ Xr))))))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XH @ Xx3 @ Xk @ Xm @ Xn @ Xr) @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xk:$i] : (XZ @ Xs1 @ Xr))) @ (^ [Xm:$i] : (^ [Xk:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xk:$i] : (ccfv @ (cco @ (ccv @ Xm) @ (ccv @ Xk) @ (XP @ Xx3 @ Xk @ Xm @ Xn @ Xs1)) @ (XC @ Xx3 @ Xk @ Xm @ Xn @ Xs1)))))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XI @ Xk @ Xm @ Xn @ Xs1 @ Xr) @ (cciin @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cciun @ (^ [Xn:$i] : (XZ @ Xs1 @ Xr)) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (cco @ (ccv @ Xm) @ (ccv @ Xk) @ (XH @ Xx3 @ Xk @ Xm @ Xn @ Xr))))))))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (cwa @ (Xph @ Xs1) @ (cwcel @ (ccv @ Xr) @ (ccrn @ (XP @ Xx3 @ Xk @ Xm @ Xn @ Xs1)))) @ (cwcel @ (ccfv @ (ccv @ Xr) @ (XC @ Xx3 @ Xk @ Xm @ Xn @ Xs1)) @ (ccv @ Xr))))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xs1) @ (cwss @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XG @ Xx3 @ Xs1 @ Xr)) @ (XA2 @ Xx3 @ Xr) @ ccle)) @ (^ [Xx3:$i] : (XD @ Xx3 @ Xs1 @ Xr))) @ (ccin @ (XD @ Xx3 @ Xs1 @ Xr) @ (XI @ Xk @ Xm @ Xn @ Xs1 @ Xr))))))))))))))))))))))))))))))))).
