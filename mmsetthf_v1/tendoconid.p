...
thf(ctendoconid_conj,conjecture,(! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ XB2 @ (ccfv @ (XK @ Xf1) @ ccbs))) => ((! [Xf1:$i] : (cwceq @ (XH @ Xf1) @ (ccfv @ (XK @ Xf1) @ cclh))) => ((! [Xf1:$i] : (cwceq @ XT @ (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ ccltrn)))) => ((! [Xf1:$i] : (cwceq @ (XE @ Xf1) @ (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ cctendo)))) => ((! [Xf1:$i] : (cwceq @ (XO @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccres @ ccid @ XB2))))) => (! [Xf1:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ (XK @ Xf1) @ cchlt) @ (cwcel @ (XW @ Xf1) @ (XH @ Xf1))) @ (cwa @ (cwcel @ (XU @ Xf1) @ (XE @ Xf1)) @ (cwne @ (XU @ Xf1) @ (XO @ Xf1))) @ (cwa @ (cwcel @ (XV @ Xf1) @ (XE @ Xf1)) @ (cwne @ (XV @ Xf1) @ (XO @ Xf1)))) @ (cwne @ (cccom @ (XU @ Xf1) @ (XV @ Xf1)) @ (XO @ Xf1))))))))))))))))))).
