...
thf(alttri4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cw3o @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwceq @ XA2 @ XB2) @ (cwbr @ XB2 @ XA2 @ cclt))))))))).
...
thf(ciscgrglt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_sm:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xi @ Xj) @ (ccfv @ XG @ ccbs)))) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_sm @ Xi @ Xj) @ (ccfv @ XG @ cccgrg)))) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwss @ (XD @ Xi @ Xj) @ ccr)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ (XD @ Xi @ Xj) @ (XP @ Xi @ Xj) @ XA2)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ (XD @ Xi @ Xj) @ (XP @ Xi @ Xj) @ XB2)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ (Xc_sm @ Xi @ Xj)) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xi) @ (ccv @ Xj) @ cclt) @ (cwceq @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xj) @ XA2) @ Xc_mi) @ (cco @ (ccfv @ (ccv @ Xi) @ XB2) @ (ccfv @ (ccv @ Xj) @ XB2) @ Xc_mi)))) @ (^ [Xj:$i] : (ccdm @ XA2)))) @ (^ [Xi:$i] : (ccdm @ XA2))))))))))))))))))))))).
