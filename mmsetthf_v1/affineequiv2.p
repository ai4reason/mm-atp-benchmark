...
thf(caffineequiv2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => (cwi @ Xph @ (cwb @ (cwceq @ XB2 @ (cco @ (cco @ XD @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XD @ ccmin) @ XC @ ccmul) @ ccaddc)) @ (cwceq @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ (cco @ cc1 @ XD @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccmul)))))))))))))).
