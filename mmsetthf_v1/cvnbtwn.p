...
thf(acvbr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwa @ (cwpss @ XA2 @ XB2) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwpss @ XA2 @ (ccv @ Xx3)) @ (cwpss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccch))))))))).
...
thf(ccvnbtwn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwn @ (cwa @ (cwpss @ XA2 @ XC) @ (cwpss @ XC @ XB2))))))))).
