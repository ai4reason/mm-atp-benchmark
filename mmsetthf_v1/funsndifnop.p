...
thf(afunop_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => (cwb @ (cwfun @ (ccop @ XX @ XY)) @ (cwex @ (^ [Xa:$i] : (cwa @ (cwceq @ XX @ (ccsn @ (ccv @ Xa))) @ (cwceq @ (ccop @ XX @ XY) @ (ccsn @ (ccop @ (ccv @ Xa) @ (ccv @ Xa))))))))))))).
...
thf(cfunsndifnop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwceq @ XG @ (ccsn @ (ccop @ XA2 @ XB2))) => (cwi @ (cwne @ XA2 @ XB2) @ (cwn @ (cwcel @ XG @ (ccxp @ ccvv @ ccvv))))))))))).
