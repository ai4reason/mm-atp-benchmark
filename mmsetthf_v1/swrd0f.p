...
thf(cswrd0f_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwf @ (cco @ ccc0 @ XN @ ccfzo) @ XV @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr))))))).
