...
thf(adf_phtpc_ax,axiom,(cwceq @ ccphtpc @ (ccmpt @ (^ [Xx3:$i] : cctop) @ (^ [Xx3:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cwa @ (cwss @ (ccpr @ (ccv @ Xf1) @ (ccv @ Xg1)) @ (cco @ ccii @ (ccv @ Xx3) @ cccn)) @ (cwne @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccfv @ (ccv @ Xx3) @ ccphtpy)) @ cc0))))))))).
