...
thf(apcovalg_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwceq @ (ccfv @ XX @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) @ (ccif @ (cwbr @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (ccfv @ (cco @ cc2 @ XX @ ccmul) @ XF) @ (ccfv @ (cco @ (cco @ cc2 @ XX @ ccmul) @ cc1 @ ccmin) @ XG)))))))))))).
...
thf(cpcoval1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccicc))) @ (cwceq @ (ccfv @ XX @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) @ (ccfv @ (cco @ cc2 @ XX @ ccmul) @ XF))))))))))).
