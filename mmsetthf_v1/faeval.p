...
thf(adf_fae_ax,axiom,(cwceq @ ccfae @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xm:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xm:$i] : (ccuni @ (ccrn @ ccmeas)))) @ (^ [Xr:$i] : (^ [Xm:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xf1) @ (cco @ (ccdm @ (ccv @ Xr)) @ (ccuni @ (ccdm @ (ccv @ Xm))) @ ccmap)) @ (cwcel @ (ccv @ Xg1) @ (cco @ (ccdm @ (ccv @ Xr)) @ (ccuni @ (ccdm @ (ccv @ Xm))) @ ccmap))) @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccv @ Xr))) @ (^ [Xx3:$i] : (ccuni @ (ccdm @ (ccv @ Xm))))) @ (ccv @ Xm) @ ccae)))))))))).
