...
thf(a_41prothprmlem1_thm,axiom,(! [XP:($i > $o)] : ((cwceq @ XP @ (ccdc @ cc4 @ cc1)) => (cwceq @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccdc @ cc2 @ ccc0))))).
...
thf(a_3exp4mod41_thm,axiom,(cwceq @ (cco @ (cco @ cc3 @ cc4 @ ccexp) @ (ccdc @ cc4 @ cc1) @ ccmo) @ (cco @ (ccneg @ cc1) @ (ccdc @ cc4 @ cc1) @ ccmo))).
...
thf(c_41prothprmlem2_conj,conjecture,(! [XP:($i > $o)] : ((cwceq @ XP @ (ccdc @ cc4 @ cc1)) => (cwceq @ (cco @ (cco @ cc3 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) @ (cco @ (ccneg @ cc1) @ XP @ ccmo))))).
