...
thf(cello1mpt2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccr))) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1) @ (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (XB2 @ Xx3) @ (ccv @ Xm) @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xy1:$i] : (cco @ XC @ ccpnf @ ccico))))))))))))).
