...
thf(adf_wwlks_ax,axiom,(cwceq @ ccwwlks @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrab @ (^ [Xw:$i] : (cwa @ (cwne @ (ccv @ Xw) @ cc0) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xw)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xw))) @ (ccfv @ (ccv @ Xg1) @ ccedg))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1 @ ccmin) @ ccfzo))))) @ (^ [Xw:$i] : (ccword @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))))).
...
thf(a_0wrd0_thm,axiom,(! [XW:($i > $o)] : (cwb @ (cwcel @ XW @ (ccword @ cc0)) @ (cwceq @ XW @ cc0)))).
