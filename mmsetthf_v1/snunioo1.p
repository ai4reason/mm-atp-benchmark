...
thf(csnunioo1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwceq @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XA2)) @ (cco @ XA2 @ XB2 @ ccico)))))).
