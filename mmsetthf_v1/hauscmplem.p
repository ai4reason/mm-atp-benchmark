...
thf(aclstop_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XX @ (ccfv @ XJ @ cccl)) @ XX)))))).
...
thf(afiinopn_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwi @ (cw3a @ (cwss @ XA2 @ XJ) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ (ccint @ XA2) @ XJ)))))).
...
thf(chauscmplem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((! [Xy1:$i] : (! [Xw:$i] : (cwceq @ (XO @ Xy1 @ Xw) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xw)) @ (cwss @ (ccfv @ (ccv @ Xw) @ (ccfv @ XJ @ cccl)) @ (ccdif @ XX @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XJ))) @ (^ [Xy1:$i] : XJ))))) => ((cwi @ Xph @ (cwcel @ XJ @ ccha)) => ((cwi @ Xph @ (cwss @ XS @ XX)) => ((cwi @ Xph @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdif @ XX @ XS))) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xz)) @ (cwss @ (ccfv @ (ccv @ Xz) @ (ccfv @ XJ @ cccl)) @ (ccdif @ XX @ XS)))) @ (^ [Xz:$i] : XJ)))))))))))))))).
