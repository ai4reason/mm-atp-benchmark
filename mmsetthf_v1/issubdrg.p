...
thf(cissubdrg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((cwceq @ XS @ (cco @ XR @ XA2 @ ccress)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ XR @ ccinvr))) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwcel @ XA2 @ (ccfv @ XR @ ccsubrg))) @ (cwb @ (cwcel @ XS @ ccdr) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XI @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ Xc_0))))))))))))))).
