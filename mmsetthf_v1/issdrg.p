...
thf(adf_sdrg_ax,axiom,(cwceq @ ccsdrg @ (ccmpt @ (^ [Xw:$i] : ccdr) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : (cwcel @ (cco @ (ccv @ Xw) @ (ccv @ Xs1) @ ccress) @ ccdr)) @ (^ [Xs1:$i] : (ccfv @ (ccv @ Xw) @ ccsubrg))))))).
...
thf(cissdrg_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwb @ (cwcel @ XS @ (ccfv @ XR @ ccsdrg)) @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XS @ (ccfv @ XR @ ccsubrg)) @ (cwcel @ (cco @ XR @ XS @ ccress) @ ccdr)))))).
