...
thf(austref_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU) @ (cwcel @ XA2 @ XX)) @ (cwbr @ XA2 @ XA2 @ XV))))))).
...
thf(ccstucnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XX @ ccust))) => ((cwi @ Xph @ (cwcel @ XV @ (ccfv @ XY @ ccust))) => ((cwi @ Xph @ (cwcel @ XA2 @ XY)) => (cwi @ Xph @ (cwcel @ (ccxp @ XX @ (ccsn @ XA2)) @ (cco @ XU @ XV @ ccucn))))))))))))).
