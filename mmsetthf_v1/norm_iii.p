...
thf(cnorm_iii_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccsm) @ ccno) @ (cco @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccno) @ ccmul)))))).
