...
thf(atendoco2_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ cctendo))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XU @ XE) @ (cwcel @ XV @ XE)) @ (cwa @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT))) @ (cwceq @ (cccom @ (ccfv @ (cccom @ XF @ XG) @ XU) @ (ccfv @ (cccom @ XF @ XG) @ XV)) @ (cccom @ (cccom @ (ccfv @ XF @ XU) @ (ccfv @ XF @ XV)) @ (cccom @ (ccfv @ XG @ XU) @ (ccfv @ XG @ XV)))))))))))))))))).
