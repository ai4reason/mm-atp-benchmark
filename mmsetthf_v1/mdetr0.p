...
thf(cmdetr0_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XD @ Xi @ Xj) @ (cco @ XN @ XR @ ccmdat)))) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) @ (cwcel @ (XX @ Xi @ Xj) @ XK)))) => ((cwi @ Xph @ (cwcel @ XI @ XN)) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ XI) @ Xc_0 @ (XX @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) @ Xc_0)))))))))))))))))))).
