...
thf(ccdlemf2_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xq @ Xp) @ (ccfv @ XK @ ccjn)))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_an @ Xq @ Xp) @ (ccfv @ XK @ ccmee)))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XU @ XA2) @ (cwbr @ XU @ XW @ Xc_le))) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwa @ (cwn @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)) @ (cwn @ (cwbr @ (ccv @ Xq) @ XW @ Xc_le))) @ (cwceq @ XU @ (cco @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp)) @ XW @ (Xc_an @ Xq @ Xp))))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))))))))))))).
