...
thf(acdainflem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ (ccun @ XA2 @ XB2) @ ccom @ ccen) @ (cwo @ (cwbr @ XA2 @ ccom @ ccen) @ (cwbr @ XB2 @ ccom @ ccen)))))).
...
thf(ccdainf_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ ccom @ (cco @ XA2 @ XA2 @ cccda) @ ccdom)))).
