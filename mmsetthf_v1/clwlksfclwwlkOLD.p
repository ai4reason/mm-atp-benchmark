...
thf(aupgrclwlkcompim_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((! [Xk:$i] : (cwceq @ XF @ (ccfv @ (XW @ Xk) @ cc1st))) => ((! [Xk:$i] : (cwceq @ XP @ (ccfv @ (XW @ Xk) @ cc2nd))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ (XW @ Xk) @ (ccfv @ XG @ ccclwlks))) @ (cw3a @ (cwa @ (cwcel @ XF @ (ccword @ (ccdm @ XI))) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP)) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP)))))))))))))))).
...
thf(affz0hash_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwf @ (cco @ ccc0 @ XN @ ccfz) @ XB2 @ XF)) @ (cwceq @ (ccfv @ XF @ cchash) @ (cco @ XN @ cc1 @ ccaddc))))))).
...
thf(aswrdn0_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccn) @ (cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle)) @ (cwne @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ cc0)))))).
...
thf(aclwlkclwwlklem2_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwf1 @ (ccdm @ XE) @ XR @ XE) @ (cwcel @ XF @ (ccword @ (ccdm @ XE)))) @ (cwa @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwa @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XE) @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP)))) @ (cw3a @ (cwceq @ (ccfv @ XP @ cclsw) @ (ccfv @ ccc0 @ XP)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ XP) @ (ccfv @ ccc0 @ XP)) @ (ccrn @ XE)))))))))).
...
thf(aelfzom1elp1fzo_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(aclwlksfclwwlk2sswdOLD_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xc:$i] : (cwceq @ (XA2 @ Xc) @ (ccfv @ (ccv @ Xc) @ cc1st))) => ((! [Xc:$i] : (cwceq @ (XB2 @ Xc) @ (ccfv @ (ccv @ Xc) @ cc2nd))) => ((! [Xc:$i] : (cwceq @ (XC @ Xc) @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (XA2 @ Xc) @ cchash) @ XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks))))) => ((! [Xc:$i] : (cwceq @ (XF @ Xc) @ (ccmpt @ (^ [Xc:$i] : (XC @ Xc)) @ (^ [Xc:$i] : (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr))))) => (! [Xc:$i] : (cwi @ (cwcel @ (ccv @ Xc) @ (XC @ Xc)) @ (cwceq @ (ccfv @ (XA2 @ Xc) @ cchash) @ (ccfv @ (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr) @ cchash))))))))))))))).
...
thf(cclwlksfclwwlkOLD_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xc:$i] : (cwceq @ (XA2 @ Xc) @ (ccfv @ (ccv @ Xc) @ cc1st))) => ((! [Xc:$i] : (cwceq @ (XB2 @ Xc) @ (ccfv @ (ccv @ Xc) @ cc2nd))) => ((cwceq @ XC @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (XA2 @ Xc) @ cchash) @ XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks)))) => ((! [Xc:$i] : (cwceq @ (XF @ Xc) @ (ccmpt @ (^ [Xc:$i] : XC) @ (^ [Xc:$i] : (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr))))) => (! [Xc:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ ccprime)) @ (cwf @ XC @ (cco @ XN @ XG @ ccclwwlkn) @ (XF @ Xc))))))))))))))).
