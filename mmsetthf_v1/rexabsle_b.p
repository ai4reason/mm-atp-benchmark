...
thf(arexabslelem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (^ [Xy1:$i] : ccr)) @ (cwa @ (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xw) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (^ [Xw:$i] : ccr)) @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xz) @ (XB2 @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (^ [Xz:$i] : ccr)))))))))))).
