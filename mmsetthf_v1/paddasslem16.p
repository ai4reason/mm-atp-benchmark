...
thf(asyl3anl3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xth) => ((cwi @ (cwa @ (cw3a @ Xps @ Xch @ Xth) @ Xta) @ Xet) => (cwi @ (cwa @ (cw3a @ Xps @ Xch @ Xph) @ Xta) @ Xet)))))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(apaddasslem15_thm,axiom,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (! [Xr:$i] : (! [Xp:$i] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2) @ (cwss @ XZ @ XA2)) @ (cwa @ (cwne @ XY @ cc0) @ (cwne @ XZ @ cc0))) @ (cw3a @ (cwcel @ (ccv @ Xp) @ XA2) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xr) @ (cco @ XY @ XZ @ Xc_pl))) @ (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ Xc_or) @ Xc_le))) @ (cwcel @ (ccv @ Xp) @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl))))))))))))))))))).
thf(cpaddasslem16_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2) @ (cwss @ XZ @ XA2)) @ (cwa @ (cwa @ (cwne @ XX @ cc0) @ (cwne @ (cco @ XY @ XZ @ Xc_pl) @ cc0)) @ (cwa @ (cwne @ XY @ cc0) @ (cwne @ XZ @ cc0)))) @ (cwss @ (cco @ XX @ (cco @ XY @ XZ @ Xc_pl) @ Xc_pl) @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl)))))))))))))))).
