...
thf(aelfm2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XL @ (cco @ XY @ XB2 @ ccfg)) => (cwi @ (cw3a @ (cwcel @ XX @ XC) @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwf @ XY @ XX @ XF)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))) @ (cwa @ (cwss @ XA2 @ XX) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : XL)))))))))))))).
...
thf(celfm3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XL @ (cco @ XY @ XB2 @ ccfg)) => (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwfo @ XY @ XX @ XF)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccima @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XL)))))))))))).
