...
thf(adf_cpmat_ax,axiom,(cwceq @ cccpmat @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccfn)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)) @ ccco1)) @ (ccfv @ (ccv @ Xr) @ cc0g))) @ (^ [Xk:$i] : ccn))) @ (^ [Xj:$i] : (ccv @ Xn)))) @ (^ [Xi:$i] : (ccv @ Xn)))) @ (^ [Xm:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccmat) @ ccbs)))))))).
