...
thf(abj_spimt2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1))))) @ (cwi @ (cwi @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1))) @ (Xps @ Xx3 @ Xy1)) @ (cwi @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))) @ (Xps @ Xx3 @ Xy1))))))))).
...
thf(cbj_cbv3ta_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1))))))) @ (cwi @ (cwa @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1))) @ (Xps @ Xx3 @ Xy1)))) @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))))) @ (cwi @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))) @ (cwal @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))))))))).
