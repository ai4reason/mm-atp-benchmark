...
thf(cfcnre_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwceq @ XT @ (ccuni @ XJ)) => ((cwceq @ XC @ (cco @ XJ @ XK @ cccn)) => ((cwi @ Xph @ (cwcel @ XF @ XC)) => (cwi @ Xph @ (cwf @ XT @ ccr @ XF))))))))))))).
