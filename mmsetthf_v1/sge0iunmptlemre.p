...
thf(afge0iccico_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwn @ (cwcel @ ccpnf @ (ccrn @ XF)))) => (cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)))))))).
...
thf(asge0rern_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (cwi @ Xph @ (cwn @ (cwcel @ ccpnf @ (ccrn @ XF)))))))))))).
...
thf(afsumiunss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xk))))) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) @ (cwcel @ (XC @ Xk) @ ccc)))) => ((cwi @ Xph @ (cwcel @ XD @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccin @ (XB2 @ Xx3) @ XD))) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ (XB2 @ Xx3) @ XD) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ (^ [Xx3:$i] : (ccsu @ (ccin @ (XB2 @ Xx3) @ XD) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))))).
...
thf(adisjinfi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ XV))) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XC @ ccfn)) => (cwi @ Xph @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ (XB2 @ Xx3) @ XC) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ ccfn))))))))))).
thf(afsumge0cl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => (cwi @ Xph @ (cwcel @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (cco @ ccc0 @ ccpnf @ ccico))))))))).
...
thf(asge0lefi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ XF @ ccsumge0) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ XA2 @ ccle)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
...
thf(asge0ge0_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XF @ ccsumge0) @ ccle))))))))).
thf(ccltrr_tp,type,(ccltrr : ($i > $o))).
thf(altpnf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ XA2 @ ccpnf @ cclt)))).
thf(asge0gerpmpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xy1) @ ccrp)) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (XC @ Xx3) @ (cco @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xz)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ (ccv @ Xy1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (XC @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ ccle)))))))))))))).
...
thf(asge0ltfirpmpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XY @ Xx3) @ ccrp))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ ccr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ (cco @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ (XY @ Xx3) @ ccaddc) @ cclt)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))))))))))))).
...
thf(asge0iunmptlemfi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xk))))) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) @ (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (XB2 @ Xx3)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ ccr))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xk:$i] : (XB2 @ Xx3)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0))) @ ccsumge0)))))))))))))).
...
thf(csge0iunmptlemre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XW @ Xk))))) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) @ (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (XB2 @ Xx3)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ ccr))) => ((cwi @ Xph @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ ccxr)) => ((cwi @ Xph @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xk:$i] : (XB2 @ Xx3)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0))) @ ccsumge0) @ ccxr)) => ((cwi @ Xph @ (cwf @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (ccmpt @ (^ [Xk:$i] : (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (^ [Xk:$i] : (XC @ Xk))))) => ((cwi @ Xph @ (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xk:$i] : (XB2 @ Xx3)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0))) @ ccsumge0))))))))))))))))))).
