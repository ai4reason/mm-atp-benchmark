...
thf(alspsolvlem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (ccfv @ XW @ cclss))) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((! [Xz:$i] : (cwceq @ (XF @ Xz) @ (ccfv @ XW @ ccsca))) => ((! [Xz:$i] : (cwceq @ XB2 @ (ccfv @ (XF @ Xz) @ ccbs))) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((! [Xz:$i] : (! [Xr:$i] : (cwceq @ (XQ @ Xz @ Xr) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xr:$i] : (cwcel @ (cco @ (ccv @ Xz) @ (cco @ (ccv @ Xr) @ XY @ Xc_x) @ Xc_pl) @ (ccfv @ XA2 @ XN))) @ (^ [Xr:$i] : XB2))) @ (^ [Xz:$i] : XV))))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ XW @ cclmod))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwss @ XA2 @ XV))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ XY @ XV))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ XX @ (ccfv @ (ccun @ XA2 @ (ccsn @ XY)) @ XN)))) => (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwrex @ (^ [Xr:$i] : (cwcel @ (cco @ XX @ (cco @ (ccv @ Xr) @ XY @ Xc_x) @ Xc_pl) @ (ccfv @ XA2 @ XN))) @ (^ [Xr:$i] : XB2)))))))))))))))))))))))))))))).
...
thf(almodvpncan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ XB2 @ Xc_mi) @ XA2)))))))))))).
thf(almodcom_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) @ (cwceq @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XY @ XX @ Xc_pl))))))))))).
...
thf(clspsolv_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwa @ (cwcel @ XW @ cclvec) @ (cw3a @ (cwss @ XA2 @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ XX @ (ccdif @ (ccfv @ (ccun @ XA2 @ (ccsn @ XY)) @ XN) @ (ccfv @ XA2 @ XN))))) @ (cwcel @ XY @ (ccfv @ (ccun @ XA2 @ (ccsn @ XX)) @ XN)))))))))))))).
