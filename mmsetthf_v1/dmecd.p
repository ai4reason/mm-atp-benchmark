...
thf(cdmecd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccdm @ XR) @ XA2)) => ((cwi @ Xph @ (cwceq @ (ccec @ XB2 @ XR) @ (ccec @ XC @ XR))) => (cwi @ Xph @ (cwb @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2))))))))))).
