...
thf(a_2sq_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwceq @ (cco @ XP @ cc4 @ ccmo) @ cc1)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XP @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))).
thf(c_2sqb_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XP @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)) @ (cwo @ (cwceq @ XP @ cc2) @ (cwceq @ (cco @ XP @ cc4 @ ccmo) @ cc1)))))).
