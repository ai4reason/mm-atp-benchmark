...
thf(anumclwlk2lem2fvOLD_thm,axiom,(! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XQ @ Xw @ Xv @ Xn) @ (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xv)) @ (cwne @ (ccfv @ (ccv @ Xw) @ cclsw) @ (ccv @ Xv)))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn)))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xw @ Xv @ Xn) @ (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xv)) @ (cwne @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccfv @ ccc0 @ (ccv @ Xw))))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn)))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xx3 @ Xw @ Xv @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ (cco @ XN @ cc2 @ ccaddc) @ (XH @ Xw @ Xv @ Xn))) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr)))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xw)) @ (cwcel @ XN @ ccn)) @ (cwi @ (cwcel @ (XW @ Xn) @ (cco @ XX @ (cco @ XN @ cc2 @ ccaddc) @ (XH @ Xw @ Xv @ Xn))) @ (cwceq @ (ccfv @ (XW @ Xn) @ (XR @ Xx3 @ Xw @ Xv @ Xn)) @ (cco @ (XW @ Xn) @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr))))))))))))))))))))).
...
thf(cnumclwlk2lem2f1oOLD_conj,conjecture,(! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XQ @ Xw @ Xv @ Xn) @ (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xv)) @ (cwne @ (ccfv @ (ccv @ Xw) @ cclsw) @ (ccv @ Xv)))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn)))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xw @ Xv @ Xn) @ (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xv)) @ (cwne @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccfv @ ccc0 @ (ccv @ Xw))))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn)))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xx3 @ Xw @ Xv @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ (cco @ XN @ cc2 @ ccaddc) @ (XH @ Xw @ Xv @ Xn))) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr)))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XX @ (XV @ Xw)) @ (cwcel @ XN @ ccn)) @ (cwf1o @ (cco @ XX @ (cco @ XN @ cc2 @ ccaddc) @ (XH @ Xw @ Xv @ Xn)) @ (cco @ XX @ XN @ (XQ @ Xw @ Xv @ Xn)) @ (XR @ Xx3 @ Xw @ Xv @ Xn))))))))))))))))))).
