...
thf(aefif1o_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XF @ Xw) @ (ccmpt @ (^ [Xw:$i] : XD) @ (^ [Xw:$i] : (ccfv @ (cco @ cci @ (ccv @ Xw) @ ccmul) @ cce))))) => ((cwceq @ XC @ (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => ((cwceq @ XD @ (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccaddc) @ ccioc)) => (! [Xw:$i] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwf1o @ XD @ XC @ (XF @ Xw)))))))))))).
...
thf(cefifo_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XF @ Xz) @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccfv @ (cco @ cci @ (ccv @ Xz) @ ccmul) @ cce))))) => ((cwceq @ XC @ (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => (! [Xz:$i] : (cwfo @ ccr @ XC @ (XF @ Xz)))))))).
