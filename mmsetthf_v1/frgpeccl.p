...
thf(cfrgpeccl_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XI @ ccfrgp)) => ((cwceq @ Xc_sm @ (ccfv @ XI @ ccefg)) => ((cwceq @ XW @ (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwcel @ XX @ XW) @ (cwcel @ (ccec @ XX @ Xc_sm) @ XB2))))))))))))).
