...
thf(advres3a_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwf @ XA2 @ ccc @ XF)) @ (cwa @ (cwcel @ XA2 @ XJ) @ (cwceq @ (ccdm @ (cco @ ccc @ XF @ ccdv)) @ XA2))) @ (cwceq @ (cco @ XS @ (ccres @ XF @ XS) @ ccdv) @ (ccres @ (cco @ ccc @ XF @ ccdv) @ XS))))))))).
