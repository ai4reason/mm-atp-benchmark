...
thf(aexpneg_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ (ccneg @ XN) @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccdiv)))))).
thf(cefexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccz)) @ (cwceq @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ cce) @ (cco @ (ccfv @ XA2 @ cce) @ XN @ ccexp)))))).
