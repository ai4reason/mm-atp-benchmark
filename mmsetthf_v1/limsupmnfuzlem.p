...
thf(climsupmnfuzlem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3) @ ccz))) => ((! [Xx3:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3) @ ccuz))) => ((cwi @ Xph @ (cwf @ XZ @ ccxr @ XF)) => (cwi @ Xph @ (cwb @ (cwceq @ (ccfv @ XF @ cclsp) @ ccmnf) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccv @ Xj) @ XF) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))).
