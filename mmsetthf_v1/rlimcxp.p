...
thf(aabscxp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ ccabs) @ (cco @ (ccfv @ XA2 @ ccabs) @ XB2 @ cccxp)))))).
...
thf(crlimcxp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XA2)) @ (cwcel @ (XB2 @ Xn) @ (XV @ Xn)))) => ((cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccc0 @ ccrli)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (cco @ (XB2 @ Xn) @ XC @ cccxp))) @ ccc0 @ ccrli))))))))))).
