...
thf(adf_vrgp_ax,axiom,(cwceq @ ccvrgp @ (ccmpt @ (^ [Xi:$i] : ccvv) @ (^ [Xi:$i] : (ccmpt @ (^ [Xj:$i] : (ccv @ Xi)) @ (^ [Xj:$i] : (ccec @ (ccs1 @ (ccop @ (ccv @ Xj) @ cc0)) @ (ccfv @ (ccv @ Xi) @ ccefg)))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(cvrgpfval_conj,conjecture,(! [Xc_sm:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XI @ ccefg)) => ((! [Xj:$i] : (cwceq @ (XU @ Xj) @ (ccfv @ XI @ ccvrgp))) => (! [Xj:$i] : (cwi @ (cwcel @ XI @ XV) @ (cwceq @ (XU @ Xj) @ (ccmpt @ (^ [Xj:$i] : XI) @ (^ [Xj:$i] : (ccec @ (ccs1 @ (ccop @ (ccv @ Xj) @ cc0)) @ Xc_sm))))))))))))).
