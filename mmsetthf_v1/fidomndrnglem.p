...
thf(aghmf1_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XS @ ccbs)) => ((cwceq @ XY @ (ccfv @ XT @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => ((cwceq @ XU @ (ccfv @ XT @ cc0g)) => (cwi @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwb @ (cwf1 @ XX @ XY @ XF) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XU) @ (cwceq @ (ccv @ Xx3) @ Xc_0))) @ (^ [Xx3:$i] : XX)))))))))))))))).
...
thf(cfidomndrnglem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pa:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XR @ cc0g))) => ((! [Xx3:$i] : (cwceq @ (Xc_1 @ Xx3) @ (ccfv @ XR @ ccur))) => ((! [Xx3:$i] : (cwceq @ (Xc_pa @ Xx3) @ (ccfv @ XR @ ccdsr))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XR @ ccdomn))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccfn))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (ccdif @ XB2 @ (ccsn @ (Xc_0 @ Xx3)))))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XA2 @ (Xc_1 @ Xx3) @ (Xc_pa @ Xx3))))))))))))))))))))))).
