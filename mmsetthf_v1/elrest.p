...
thf(celrest_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XJ @ (XV @ Xx3)) @ (cwcel @ XB2 @ (XW @ Xx3))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XB2 @ ccrest)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccin @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XJ))))))))))).
