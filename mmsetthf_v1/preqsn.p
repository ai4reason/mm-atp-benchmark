...
thf(cpreqsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccsn @ XC)) @ (cwa @ (cwceq @ XA2 @ XB2) @ (cwceq @ XB2 @ XC)))))))))).
