...
thf(abndmet_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwcel @ XM @ (ccfv @ XX @ ccme)))))).
...
thf(aisbnd3_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwrex @ (^ [Xx3:$i] : (cwf @ (ccxp @ XX @ XX) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccicc) @ XM)) @ (^ [Xx3:$i] : ccr))))))).
...
thf(cprdsbnd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccres @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ XY @ ccds))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XS @ (XW @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XI @ ccfn)) => ((cwi @ Xph @ (cwfn @ XR @ XI)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ ccbnd)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XD @ Xx3) @ (ccfv @ XB2 @ ccbnd)))))))))))))))))))))))).
