...
thf(atelgsumfzs_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XG @ Xk) @ ccabl))) => ((! [Xk:$i] : (cwceq @ (Xc_mi @ Xk) @ (ccfv @ (XG @ Xk) @ ccsg))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XN @ (ccfv @ XM @ ccuz)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XC @ Xk) @ XB2)) @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xi:$i] : (cco @ (ccsb @ (ccv @ Xi) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsb @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (^ [Xk:$i] : (XC @ Xk))) @ (Xc_mi @ Xk)))) @ ccgsu) @ (cco @ (ccsb @ XM @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsb @ (cco @ XN @ cc1 @ ccaddc) @ (^ [Xk:$i] : (XC @ Xk))) @ (Xc_mi @ Xk)))))))))))))))))).
thf(aelfvexd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ XB2))) => (cwi @ Xph @ (cwcel @ XC @ ccvv)))))))).
thf(ctelgsumfz_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xk) @ ccabl))) => ((! [Xk:$i] : (cwceq @ (Xc_mi @ Xk) @ (ccfv @ (XG @ Xk) @ ccsg))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xk) @ XB2)) @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccv @ Xi)) @ (cwceq @ (XA2 @ Xk) @ (XL @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc)) @ (cwceq @ (XA2 @ Xk) @ (XC @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XM) @ (cwceq @ (XA2 @ Xk) @ (XD @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (cco @ XN @ cc1 @ ccaddc)) @ (cwceq @ (XA2 @ Xk) @ (XE @ Xi))))) => (! [Xi:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xi:$i] : (cco @ (XL @ Xi) @ (XC @ Xi) @ (Xc_mi @ Xk)))) @ ccgsu) @ (cco @ (XD @ Xi) @ (XE @ Xi) @ (Xc_mi @ Xk))))))))))))))))))))))))))).
