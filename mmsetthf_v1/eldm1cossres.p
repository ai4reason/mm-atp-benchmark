...
thf(aeldmcoss_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ (ccdm @ (cccoss @ XR))) @ (cwex @ (^ [Xu:$i] : (cwbr @ (ccv @ Xu) @ XA2 @ XR))))))))).
...
thf(celdm1cossres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwcel @ XB2 @ (ccdm @ (cccoss @ (ccres @ XR @ XA2)))) @ (cwrex @ (^ [Xu:$i] : (cwbr @ (ccv @ Xu) @ XB2 @ XR)) @ (^ [Xu:$i] : XA2))))))))).
