...
thf(covelimab_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwss @ (ccxp @ XB2 @ XC) @ XA2)) @ (cwb @ (cwcel @ XD @ (ccima @ XF @ (ccxp @ XB2 @ XC))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XD @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : XB2)))))))))).
