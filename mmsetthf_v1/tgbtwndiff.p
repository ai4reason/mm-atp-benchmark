...
thf(ctgbtwndiff_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xc:$i] : (cwceq @ XP @ (ccfv @ (XG @ Xc) @ ccbs))) => ((! [Xc:$i] : (cwceq @ Xc_mi @ (ccfv @ (XG @ Xc) @ ccds))) => ((! [Xc:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xc) @ ccitv))) => ((! [Xc:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xc) @ ccstrkg))) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwa @ (cwcel @ XB2 @ (cco @ XA2 @ (ccv @ Xc) @ XI)) @ (cwne @ XB2 @ (ccv @ Xc)))) @ (^ [Xc:$i] : XP)))))))))))))))))).
