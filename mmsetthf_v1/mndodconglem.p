...
thf(aodlem2_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ XN @ XA2 @ Xc_x) @ Xc_0)) @ (cwcel @ (ccfv @ XA2 @ XO) @ (cco @ cc1 @ XN @ ccfz))))))))))))))).
...
thf(cmndodconglem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwbr @ XM @ (ccfv @ XA2 @ XO) @ cclt)) => ((cwi @ Xph @ (cwbr @ XN @ (ccfv @ XA2 @ XO) @ cclt)) => ((cwi @ Xph @ (cwceq @ (cco @ XM @ XA2 @ Xc_x) @ (cco @ XN @ XA2 @ Xc_x))) => (cwi @ (cwa @ Xph @ (cwbr @ XM @ XN @ ccle)) @ (cwceq @ XM @ XN)))))))))))))))))))))))).
