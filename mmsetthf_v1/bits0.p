...
thf(abitsval2_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0)) @ (cwb @ (cwcel @ XM @ (ccfv @ XN @ ccbits)) @ (cwn @ (cwbr @ cc2 @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccdiv) @ ccfl) @ ccdvds))))))).
...
thf(cbits0_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwcel @ ccc0 @ (ccfv @ XN @ ccbits)) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)))))).
