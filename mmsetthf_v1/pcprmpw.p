...
thf(cpcprmpw_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccn)) @ (cwb @ (cwrex @ (^ [Xn:$i] : (cwceq @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)) @ (cwceq @ XA2 @ (cco @ XP @ (cco @ XP @ XA2 @ ccpc) @ ccexp))))))).
