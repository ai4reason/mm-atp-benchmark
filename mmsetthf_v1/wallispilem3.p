...
thf(cwallispilem3_conj,conjecture,(! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XI @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwcel @ (XN @ Xx3 @ Xn) @ ccn0) @ (cwcel @ (ccfv @ (XN @ Xx3 @ Xn) @ (XI @ Xx3 @ Xn)) @ ccrp)))))))).
