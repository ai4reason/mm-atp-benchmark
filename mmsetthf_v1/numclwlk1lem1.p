...
thf(aclwlknon2num_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XV @ ccfn) @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ cc2) @ (cwceq @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xw) @ cc2nd)) @ XX))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ cchash) @ XK)))))))).
...
thf(awlkl0_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XX @ XV) @ (cwceq @ (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccc0) @ (cwceq @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xw) @ cc2nd)) @ XX))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ (ccsn @ (ccop @ cc0 @ (ccsn @ (ccop @ ccc0 @ XX))))))))))).
