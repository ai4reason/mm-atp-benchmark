...
thf(af1od2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2))) @ (cwcel @ (XC @ Xx3 @ Xy1) @ (XW @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XD)) @ (cwa @ (cwcel @ (XI @ Xz) @ (XX @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ (XJ @ Xz) @ (XY @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwb @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwceq @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1))) @ (cwa @ (cwcel @ (ccv @ Xz) @ XD) @ (cwa @ (cwceq @ (ccv @ Xx3) @ (XI @ Xz)) @ (cwceq @ (ccv @ Xy1) @ (XJ @ Xz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwf1o @ (ccxp @ XA2 @ XB2) @ XD @ (XF @ Xx3 @ Xy1 @ Xz)))))))))))))))))))))).
...
thf(anexple_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccr) @ (cwbr @ cc2 @ XB2 @ ccle)) @ (cwbr @ XA2 @ (cco @ XB2 @ XA2 @ ccexp) @ ccle))))).
...
thf(coddpwdc_conj,conjecture,(! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwn @ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XJ @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ (ccv @ Xx3) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwf1o @ (ccxp @ (XJ @ Xz) @ ccn0) @ ccn @ (XF @ Xx3 @ Xy1 @ Xz)))))))))).
