...
thf(ajoiniooico_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XB2 @ XC @ ccle))) @ (cwa @ (cwceq @ (ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XB2 @ XC @ ccico)) @ cc0) @ (cwceq @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XB2 @ XC @ ccico)) @ (cco @ XA2 @ XC @ ccioo)))))))).
...
thf(adifeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwceq @ (ccdif @ XA2 @ XB2) @ XC) @ (cwa @ (cwceq @ (ccin @ XC @ XB2) @ cc0) @ (cwceq @ (ccun @ XC @ XB2) @ (ccun @ XA2 @ XB2)))))))).
...
thf(cdifioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwceq @ (ccdif @ (cco @ XA2 @ XC @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ XB2 @ XC @ ccico))))))).
