...
thf(clidlmcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XI))) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI))))))))))))).
