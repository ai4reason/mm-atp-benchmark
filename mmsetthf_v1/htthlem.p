...
thf(aipblnfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (cco @ XU @ (XC @ Xx3) @ ccblo))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ XP))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ XX) @ (cwcel @ (XF @ Xx3) @ (XB2 @ Xx3)))))))))))))))))).
...
thf(asii_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => (cwi @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ XP) @ ccabs) @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccmul) @ ccle))))))))))))).
...
thf(anmblore_thm,axiom,(! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => ((cwceq @ XB2 @ (cco @ XU @ XW @ ccblo)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwcel @ XT @ XB2)) @ (cwcel @ (ccfv @ XT @ XN) @ ccr)))))))))))))).
thf(acnnvba_thm,axiom,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwceq @ ccc @ (ccfv @ XU @ ccba))))).
...
thf(anmooge0_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwf @ XX @ XY @ XT)) @ (cwbr @ ccc0 @ (ccfv @ XT @ XN) @ ccle)))))))))))).
...
thf(anmobndi_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xr:$i] : (cwceq @ XX @ (ccfv @ (XU @ Xr) @ ccba))) => ((! [Xr:$i] : (cwceq @ XY @ (ccfv @ (XW @ Xr) @ ccba))) => ((! [Xr:$i] : (cwceq @ XL @ (ccfv @ (XU @ Xr) @ ccnmcv))) => ((! [Xr:$i] : (cwceq @ XM @ (ccfv @ (XW @ Xr) @ ccnmcv))) => ((! [Xr:$i] : (cwceq @ XN @ (cco @ (XU @ Xr) @ (XW @ Xr) @ ccnmoo))) => ((! [Xr:$i] : (cwcel @ (XU @ Xr) @ ccnv)) => ((! [Xr:$i] : (cwcel @ (XW @ Xr) @ ccnv)) => (cwi @ (cwf @ XX @ XY @ XT) @ (cwb @ (cwcel @ (ccfv @ XT @ XN) @ ccr) @ (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xy1) @ XL) @ cc1 @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ XM) @ (ccv @ Xr) @ ccle))) @ (^ [Xy1:$i] : XX))) @ (^ [Xr:$i] : ccr)))))))))))))))))))).
...
thf(chtthlem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XP @ Xx3 @ Xy1) @ (ccfv @ XU @ ccdip)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XL @ Xx3 @ Xy1 @ Xz @ Xw) @ (cco @ XU @ XU @ cclno)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (cco @ XU @ XU @ ccblo)))))) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwcel @ XU @ cchlo) => ((cwceq @ XW @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ Xph @ (cwcel @ XT @ (XL @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ (XP @ Xx3 @ Xy1)) @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ (XP @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xz) @ (ccmpt @ (^ [Xz:$i] : XX) @ (^ [Xz:$i] : (ccmpt @ (^ [Xw:$i] : XX) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccfv @ (ccv @ Xz) @ XT) @ (XP @ Xx3 @ Xy1)))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ XK @ (ccima @ (XF @ Xx3 @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccv @ Xz) @ XN) @ cc1 @ ccle)) @ (^ [Xz:$i] : XX)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ Xph @ (cwcel @ XT @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))))))))))))))))))).
