...
thf(atsan3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (cwi @ Xth @ (cwo @ Xps @ (cwn @ (cwa @ Xph @ Xps)))))))).
...
thf(cts3an3_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ Xth @ (cwo @ Xch @ (cwn @ (cw3a @ Xph @ Xps @ Xch))))))))).
