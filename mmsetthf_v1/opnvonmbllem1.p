...
thf(ahoi2toco_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwceq @ (XI @ Xk) @ (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccop @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk))))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))))) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccico)))))))))))))).
