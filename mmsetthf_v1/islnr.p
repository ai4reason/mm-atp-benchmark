...
thf(adf_lnr_ax,axiom,(cwceq @ cclnr @ (ccrab @ (^ [Xa:$i] : (cwcel @ (ccfv @ (ccv @ Xa) @ ccrglmod) @ cclnm)) @ (^ [Xa:$i] : ccrg)))).
thf(cislnr_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ cclnr) @ (cwa @ (cwcel @ XA2 @ ccrg) @ (cwcel @ (ccfv @ XA2 @ ccrglmod) @ cclnm))))).
