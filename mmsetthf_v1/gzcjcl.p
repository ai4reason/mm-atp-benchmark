...
thf(arecjd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cccj) @ ccre) @ (ccfv @ XA2 @ ccre))))))).
...
thf(aimcjd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cccj) @ ccim) @ (ccneg @ (ccfv @ XA2 @ ccim)))))))).
...
thf(cgzcjcl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccgz) @ (cwcel @ (ccfv @ XA2 @ cccj) @ ccgz)))).
