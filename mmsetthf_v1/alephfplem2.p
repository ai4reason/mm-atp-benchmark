...
thf(calephfplem2_conj,conjecture,(! [Xw:$i] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (cwi @ (cwcel @ (ccv @ Xw) @ ccom) @ (cwceq @ (ccfv @ (ccsuc @ (ccv @ Xw)) @ XH) @ (ccfv @ (ccfv @ (ccv @ Xw) @ XH) @ ccale))))))).
