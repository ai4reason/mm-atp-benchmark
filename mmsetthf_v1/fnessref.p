...
thf(afnessex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cw3a @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwcel @ XS @ XA2) @ (cwcel @ XP @ XS)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XS))) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(aisfne2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XX @ Xx3 @ Xy1 @ Xz) @ (ccuni @ XA2))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XY @ Xx3 @ Xy1 @ Xz) @ (ccuni @ XB2))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XB2 @ XC) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwa @ (cwceq @ (XX @ Xx3 @ Xy1 @ Xz) @ (XY @ Xx3 @ Xy1 @ Xz)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))))))))))))).
...
thf(afnebas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwi @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwceq @ XX @ XY))))))))).
...
thf(afness_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwi @ (cw3a @ (cwcel @ XB2 @ XC) @ (cwss @ XA2 @ XB2) @ (cwceq @ XX @ XY)) @ (cwbr @ XA2 @ XB2 @ ccfne)))))))))).
thf(afnetr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwbr @ XB2 @ XC @ ccfne)) @ (cwbr @ XA2 @ XC @ ccfne)))))).
thf(cfnessref_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwi @ (cwceq @ XX @ XY) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwex @ (^ [Xc:$i] : (cwa @ (cwss @ (ccv @ Xc) @ XB2) @ (cwa @ (cwbr @ XA2 @ (ccv @ Xc) @ ccfne) @ (cwbr @ (ccv @ Xc) @ XA2 @ ccref)))))))))))))).
