...
thf(aefcj_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cccj) @ cce) @ (ccfv @ (ccfv @ XA2 @ cce) @ cccj))))).
...
thf(crecosval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ cccos) @ (ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccre))))).
