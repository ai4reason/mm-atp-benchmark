...
thf(csplfv1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccword @ XA2))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((cwi @ Xph @ (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((cwi @ Xph @ (cwcel @ XR @ (ccword @ XA2))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ XF @ ccfzo))) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice)) @ (ccfv @ XX @ XS)))))))))))))))).
