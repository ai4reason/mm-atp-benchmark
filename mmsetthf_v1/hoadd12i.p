...
thf(choadd12i_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (cwceq @ (cco @ XR @ (cco @ XS @ XT @ cchos) @ cchos) @ (cco @ XS @ (cco @ XR @ XT @ cchos) @ cchos))))))))).
