...
thf(aubioc1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwcel @ XB2 @ (cco @ XA2 @ XB2 @ ccioc)))))).
...
thf(aelbl3_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XR @ ccxr)) @ (cwa @ (cwcel @ XP @ XX) @ (cwcel @ XA2 @ XX))) @ (cwb @ (cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) @ (cwbr @ (cco @ XA2 @ XP @ XD) @ XR @ cclt))))))))).
...
thf(aiscnp_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwcel @ (ccfv @ XP @ XF) @ (ccv @ Xy1)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ (ccv @ Xy1)))) @ (^ [Xx3:$i] : XJ)))) @ (^ [Xy1:$i] : XK)))))))))))).
...
thf(arexxfr2d_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) @ (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1))) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => (cwi @ Xph @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) @ (cwrex @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))))))).
...
thf(cxrlimcnp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((cwi @ Xph @ (cwceq @ XA2 @ (ccun @ XB2 @ (ccsn @ ccpnf)))) => ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XR @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ ccpnf) @ (cwceq @ (XR @ Xx3) @ XC))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (cco @ (ccfv @ ccle @ ccordt) @ XA2 @ ccrest))) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XR @ Xx3))) @ XC @ ccrli) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XR @ Xx3))) @ (ccfv @ ccpnf @ (cco @ (XK @ Xx3) @ (XJ @ Xx3) @ cccnp)))))))))))))))))))).
