...
thf(ainawina_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccina) @ (cwcel @ XA2 @ ccwina)))).
thf(awinaon_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccwina) @ (cwcel @ XA2 @ ccon0)))).
thf(awinalim_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccwina) @ (cwlim @ XA2)))).
thf(ar1lim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ (cwlim @ XA2)) @ (cwceq @ (ccfv @ XA2 @ ccr1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccr1))))))))).
...
thf(atfinds2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:$o] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ cc0) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccsuc @ (ccv @ Xy1))) @ (cwb @ (Xph @ Xx3) @ (Xth @ Xy1))))) => ((! [Xy1:$i] : (cwi @ Xta @ (Xps @ Xy1))) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccon0) @ (cwi @ Xta @ (cwi @ (Xch @ Xy1) @ (Xth @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwlim @ (ccv @ Xx3)) @ (cwi @ Xta @ (cwi @ (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccon0) @ (cwi @ Xta @ (Xph @ Xx3)))))))))))))))).
...
thf(awinacard_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccwina) @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2)))).
thf(asylancr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(acardsdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwcel @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) @ (cwbr @ XA2 @ XB2 @ ccsdm)))))))).
...
thf(aiundom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XC @ Xx3) @ XB2 @ ccdom)) @ (^ [Xx3:$i] : XA2))) @ (cwbr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccxp @ XA2 @ XB2) @ ccdom)))))))).
...
thf(ainfxpidm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
...
thf(amtord_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwn @ Xch)) => ((cwi @ Xph @ (cwn @ Xth)) => ((cwi @ Xph @ (cwi @ Xps @ (cwo @ Xch @ Xth))) => (cwi @ Xph @ (cwn @ Xps)))))))))).
...
thf(aordequn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cword @ XB2) @ (cword @ XC)) @ (cwi @ (cwceq @ XA2 @ (ccun @ XB2 @ XC)) @ (cwo @ (cwceq @ XA2 @ XB2) @ (cwceq @ XA2 @ XC)))))))).
...
thf(awinainf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccwina) @ (cwss @ ccom @ XA2)))).
...
thf(cinar1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccina) @ (cwbr @ (ccfv @ XA2 @ ccr1) @ XA2 @ ccen)))).
