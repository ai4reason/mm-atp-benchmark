...
thf(adf_fbas_ax,axiom,(cwceq @ ccfbas @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccrab @ (^ [Xx3:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwnel @ cc0 @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwne @ (ccin @ (ccv @ Xx3) @ (ccpw @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz)))) @ cc0)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ (ccpw @ (ccv @ Xw))))))))).
...
thf(cisfbas_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1)) @ (cwb @ (cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) @ (cwa @ (cwss @ XF @ (ccpw @ XB2)) @ (cw3a @ (cwne @ XF @ cc0) @ (cwnel @ cc0 @ XF) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwne @ (ccin @ XF @ (ccpw @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ cc0)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF)))))))))))).
