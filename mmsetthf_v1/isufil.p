...
thf(aelmptrab2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xx3) @ XX) @ (cwceq @ (ccv @ Xy1) @ XY)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ Xps)))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XX) @ (cwceq @ (XB2 @ Xx3) @ XC))) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => ((cwi @ (cwcel @ XY @ XC) @ (cwcel @ XX @ XW)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwcel @ XY @ (ccfv @ XX @ (XF @ Xx3 @ Xy1))) @ (cwa @ (cwcel @ XY @ XC) @ Xps)))))))))))))))))).
thf(adf_ufil_ax,axiom,(cwceq @ ccufil @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwo @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (cwcel @ (ccdif @ (ccv @ Xg1) @ (ccv @ Xx3)) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xg1))))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xg1) @ ccfil))))))).
...
thf(cisufil_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwral @ (^ [Xx3:$i] : (cwo @ (cwcel @ (ccv @ Xx3) @ XF) @ (cwcel @ (ccdif @ XX @ (ccv @ Xx3)) @ XF))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
