...
thf(cknatar_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XX @ Xz) @ (ccint @ (ccrab @ (^ [Xz:$i] : (cwss @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz))) @ (^ [Xz:$i] : (ccpw @ XA2)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)) @ (cwss @ (ccfv @ XA2 @ XF) @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ XA2)))) @ (cwa @ (cwss @ (XX @ Xz) @ XA2) @ (cwceq @ (ccfv @ (XX @ Xz) @ XF) @ (XX @ Xz))))))))))))).
