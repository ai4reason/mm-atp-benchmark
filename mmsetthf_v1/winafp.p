...
thf(awinalim2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccwina) @ (cwne @ XA2 @ ccom)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ ccale) @ XA2) @ (cwlim @ (ccv @ Xx3)))))))).
...
thf(aalephsing_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwlim @ XA2) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccale) @ cccf) @ (ccfv @ XA2 @ cccf))))).
...
thf(cwinafp_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccwina) @ (cwne @ XA2 @ ccom)) @ (cwceq @ (ccfv @ XA2 @ ccale) @ XA2)))).
