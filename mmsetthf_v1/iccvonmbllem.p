...
thf(aiooiinicc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwceq @ (cciin @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccmin) @ (cco @ XB2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccioo))) @ (cco @ XA2 @ XB2 @ ccicc))))))))).
...
thf(ciccvonmbllem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccdm @ (ccfv @ XX @ ccvoln)))) => ((! [Xi:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XA2 @ Xi)))) => ((! [Xi:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XB2 @ Xi)))) => ((! [Xn:$i] : (cwceq @ (XC @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XA2 @ Xi)) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccmin))))))) => ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc))))))) => (! [Xi:$i] : (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XA2 @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ ccicc))) @ (XS @ Xi)))))))))))))))))).
