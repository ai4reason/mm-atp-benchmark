...
thf(caxlowdimlem13_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XP @ (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((cwceq @ XQ @ (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ (cwne @ XP @ XQ))))))))).
