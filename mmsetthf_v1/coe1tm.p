...
thf(amulgpropd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_x @ Xx3 @ Xy1) @ (ccfv @ XG @ ccmg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_xp @ Xx3 @ Xy1) @ (ccfv @ XH @ ccmg)))) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XG @ ccbs))) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XH @ ccbs))) => ((cwi @ Xph @ (cwss @ XB2 @ XK)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XK) @ (cwcel @ (ccv @ Xy1) @ XK))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XG @ ccplusg)) @ XK)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XK) @ (cwcel @ (ccv @ Xy1) @ XK))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XG @ ccplusg)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XH @ ccplusg)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (Xc_x @ Xx3 @ Xy1) @ (Xc_xp @ Xx3 @ Xy1)))))))))))))))))))).
...
thf(ccoe1tm_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XC @ XK) @ (cwcel @ XD @ ccn0)) @ (cwceq @ (ccfv @ (cco @ XC @ (cco @ XD @ XX @ Xc_ex) @ Xc_x) @ ccco1) @ (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XD) @ XC @ Xc_0))))))))))))))))))))))).
