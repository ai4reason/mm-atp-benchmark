...
thf(adf_acos_ax,axiom,(cwceq @ ccacos @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ ccasin) @ ccmin))))).
...
thf(aasincl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccasin) @ ccc)))).
...
thf(advasin_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => (cwceq @ (cco @ ccc @ (ccres @ ccasin @ XD) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))))).
...
thf(aorcoms_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwo @ Xph @ Xps) @ Xch) => (cwi @ (cwo @ Xps @ Xph) @ Xch)))))).
...
thf(asubeq0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0)) => (cwi @ Xph @ (cwceq @ XA2 @ XB2))))))))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xph @ Xch) @ Xps)))))).
thf(asqcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccc)))).
thf(asqr00d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccsqrt) @ ccc0)) => (cwi @ Xph @ (cwceq @ XA2 @ ccc0))))))).
...
thf(cdvacos_conj,conjecture,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => (cwceq @ (cco @ ccc @ (ccres @ ccacos @ XD) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))))).
