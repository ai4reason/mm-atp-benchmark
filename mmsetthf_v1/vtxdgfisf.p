...
thf(avtxdgf_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XW) @ (cwf @ XV @ ccxnn0 @ (ccfv @ XG @ ccvtxdg)))))))).
...
thf(cvtxdgfisf_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XA2 @ (ccdm @ XI)) => (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwcel @ XA2 @ ccfn)) @ (cwf @ XV @ ccn0 @ (ccfv @ XG @ ccvtxdg)))))))))))).
