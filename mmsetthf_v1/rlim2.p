...
thf(crlim2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xz:$i] : (cwcel @ (XB2 @ Xz) @ ccc)) @ (^ [Xz:$i] : XA2)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XA2 @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XC @ ccc))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwb @ (cwbr @ (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (XB2 @ Xz))) @ XC @ ccrli) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccle) @ (cwbr @ (ccfv @ (cco @ (XB2 @ Xz) @ XC @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccrp))))))))))))).
