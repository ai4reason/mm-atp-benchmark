...
thf(acfslbn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cw3a @ (cwlim @ XA2) @ (cwss @ XB2 @ XA2) @ (cwbr @ XB2 @ (ccfv @ XA2 @ cccf) @ ccsdm)) @ (cwcel @ (ccuni @ XB2) @ XA2)))))).
...
thf(ccfslb2n_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwa @ (cwlim @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ cccf) @ ccsdm))) @ (^ [Xx3:$i] : XB2))) @ (cwi @ (cwbr @ XB2 @ (ccfv @ XA2 @ cccf) @ ccsdm) @ (cwne @ (ccuni @ XB2) @ XA2))))))).
