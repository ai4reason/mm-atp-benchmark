...
thf(advdsprmpweq_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccn0)) @ (cwi @ (cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))))))).
...
thf(altsubnn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwi @ (cwbr @ XB2 @ XA2 @ cclt) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccn0)))))).
...
thf(cdvdsprmpweqle_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccn0)) @ (cwi @ (cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwa @ (cwbr @ (ccv @ Xn) @ XN @ ccle) @ (cwceq @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp)))) @ (^ [Xn:$i] : ccn0)))))))).
