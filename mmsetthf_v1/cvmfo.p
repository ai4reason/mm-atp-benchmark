...
thf(ccvmfo_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccuni @ XC)) => ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XF @ (cco @ XC @ XJ @ cccvm)) @ (cwfo @ XB2 @ XX @ XF)))))))))).
