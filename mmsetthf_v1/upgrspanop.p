...
thf(aupgrspan_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwcel @ XS @ XW)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XS @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XS @ cciedg) @ (ccres @ XE @ XA2))) => ((cwi @ Xph @ (cwcel @ XG @ ccupgr)) => (cwi @ Xph @ (cwcel @ XS @ ccupgr)))))))))))))))).
...
thf(cupgrspanop_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ ccupgr) @ (cwcel @ (ccop @ XV @ (ccres @ XE @ XA2)) @ ccupgr))))))))).
