...
thf(alogb1_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) @ (cwceq @ (cco @ XB2 @ cc1 @ cclogb) @ ccc0)))).
...
thf(alogbge0b_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp)) @ (cwb @ (cwbr @ ccc0 @ (cco @ XB2 @ XX @ cclogb) @ ccle) @ (cwbr @ cc1 @ XX @ ccle)))))).
thf(alogblt1b_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp)) @ (cwb @ (cwbr @ (cco @ XB2 @ XX @ cclogb) @ cc1 @ cclt) @ (cwbr @ XX @ XB2 @ cclt)))))).
...
thf(cnnlog2ge0lt1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwb @ (cwceq @ XN @ cc1) @ (cwa @ (cwbr @ ccc0 @ (cco @ cc2 @ XN @ cclogb) @ ccle) @ (cwbr @ (cco @ cc2 @ XN @ cclogb) @ cc1 @ cclt)))))).
