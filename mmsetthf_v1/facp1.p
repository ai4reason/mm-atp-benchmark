...
thf(afacnn_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccfa) @ (ccfv @ XN @ (ccseq @ ccmul @ ccid @ cc1)))))).
...
thf(cfacp1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfa) @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ XN @ cc1 @ ccaddc) @ ccmul))))).
