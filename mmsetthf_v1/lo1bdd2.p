...
thf(clo1bdd2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((! [Xm:$i] : (cwi @ (Xph @ Xm) @ (cwss @ XA2 @ ccr))) => ((! [Xm:$i] : (cwi @ (Xph @ Xm) @ (cwcel @ (XC @ Xm) @ ccr))) => ((! [Xx3:$i] : (! [Xm:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xm:$i] : (cwi @ (Xph @ Xm) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1))) => ((! [Xy1:$i] : (! [Xm:$i] : (cwi @ (cwa @ (Xph @ Xm) @ (cwa @ (cwcel @ (ccv @ Xy1) @ ccr) @ (cwbr @ (XC @ Xm) @ (ccv @ Xy1) @ ccle))) @ (cwcel @ (XM @ Xy1) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xm) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xy1) @ ccr) @ (cwbr @ (XC @ Xm) @ (ccv @ Xy1) @ ccle)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt))) @ (cwbr @ (XB2 @ Xx3) @ (XM @ Xy1) @ ccle))))) => (! [Xm:$i] : (cwi @ (Xph @ Xm) @ (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xm) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xm:$i] : ccr)))))))))))))))).
