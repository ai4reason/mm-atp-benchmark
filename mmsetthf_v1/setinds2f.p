...
thf(asetinds_thm,axiom,(! [Xph:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3))) => (! [Xx3:$i] : (Xph @ Xx3))))).
...
thf(csetinds2f_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3))) => (! [Xx3:$i] : (Xph @ Xx3)))))))).
