...
thf(cdfioo2_conj,conjecture,(cwceq @ ccioo @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xw:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xw) @ cclt) @ (cwbr @ (ccv @ Xw) @ (ccv @ Xy1) @ cclt))) @ (^ [Xw:$i] : ccr))))))).
