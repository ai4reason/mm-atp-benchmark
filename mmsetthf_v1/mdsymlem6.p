...
thf(amdsymlem5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xr:$i] : (! [Xq:$i] : (! [Xc:$i] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : (cwceq @ (XC @ Xp) @ (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xq) @ ccat) @ (cwcel @ (ccv @ Xr) @ ccat)) @ (cwi @ (cwn @ (cwceq @ (ccv @ Xq) @ (ccv @ Xp))) @ (cwi @ (cwa @ (cwss @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ cchj)) @ (cwa @ (cwss @ (ccv @ Xq) @ XA2) @ (cwss @ (ccv @ Xr) @ XB2))) @ (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xc) @ ccch) @ (cwss @ XA2 @ (ccv @ Xc))) @ (cwcel @ (ccv @ Xp) @ ccat)) @ (cwi @ (cwss @ (ccv @ Xp) @ (ccv @ Xc)) @ (cwss @ (ccv @ Xp) @ (cco @ (ccin @ (ccv @ Xc) @ XB2) @ XA2 @ cchj)))))))))))))))))).
...
thf(achrelat3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccat))))))).
