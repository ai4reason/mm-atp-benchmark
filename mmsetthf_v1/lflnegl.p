...
thf(acaofinvl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xv:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3 @ Xv))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3) @ XS @ XF))) => ((! [Xx3:$i] : (! [Xv:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xv) @ (XW @ Xx3 @ Xv))))) => ((cwi @ Xph @ (cwf @ XS @ XS @ XN)) => ((! [Xx3:$i] : (! [Xv:$i] : (cwi @ Xph @ (cwceq @ (XG @ Xv) @ (ccmpt @ (^ [Xv:$i] : (XA2 @ Xx3)) @ (^ [Xv:$i] : (ccfv @ (ccfv @ (ccv @ Xv) @ XF) @ XN))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XN) @ (ccv @ Xx3) @ (XR @ Xv)) @ (XB2 @ Xv))))) => (! [Xx3:$i] : (! [Xv:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xv) @ XF @ (ccof @ (XR @ Xv))) @ (ccxp @ (XA2 @ Xx3) @ (ccsn @ (XB2 @ Xv)))))))))))))))))))))))).
...
thf(alflf_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XD @ ccbs)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => (cwi @ (cwa @ (cwcel @ XW @ XX) @ (cwcel @ XG @ XF)) @ (cwf @ XV @ XK @ XG)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(agrpinvf1o_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XG @ ccminusg)) => ((cwi @ Xph @ (cwcel @ XG @ ccgrp)) => (cwi @ Xph @ (cwf1o @ XB2 @ XB2 @ XN)))))))))).
