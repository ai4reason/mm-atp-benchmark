...
thf(a_6nprm_thm,axiom,(cwn @ (cwcel @ cc6 @ ccprime))).
...
thf(aprmo5_thm,axiom,(cwceq @ (ccfv @ cc5 @ ccprmo) @ (ccdc @ cc3 @ ccc0))).
thf(cprmo6_conj,conjecture,(cwceq @ (ccfv @ cc6 @ ccprmo) @ (ccdc @ cc3 @ ccc0))).
