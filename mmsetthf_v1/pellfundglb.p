...
thf(aelpell1qr2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwbr @ cc1 @ XA2 @ ccle))))))).
...
thf(cpellfundglb_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ XD @ ccpellfund) @ XA2 @ cclt)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ XD @ ccpellfund) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccv @ Xx3) @ XA2 @ cclt))) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell1qr))))))).
