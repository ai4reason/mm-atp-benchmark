...
thf(acomet_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XD @ (ccfv @ (XX @ Xx3 @ Xy1) @ ccxmt))))) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccxr @ XF)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwb @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0) @ (cwceq @ (ccv @ Xx3) @ ccc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccicc)))) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccle))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccicc)))) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccxad) @ XF) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccxad) @ ccle)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (cccom @ XF @ XD) @ (ccfv @ (XX @ Xx3 @ Xy1) @ ccxmt))))))))))))))).
...
thf(cstdbdxmet_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XD @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR @ ccle) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XR @ ccxr) @ (cwbr @ ccc0 @ XR @ cclt)) @ (cwcel @ (XD @ Xx3 @ Xy1) @ (ccfv @ XX @ ccxmt))))))))))).
