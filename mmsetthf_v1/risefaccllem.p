...
thf(crisefaccllem_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((cwss @ XS @ ccc) => ((cwcel @ cc1 @ XS) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS)))) => ((! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwcel @ (cco @ XA2 @ (ccv @ Xk) @ ccaddc) @ XS))) => (cwi @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (cco @ XA2 @ XN @ ccrisefac) @ XS)))))))))).
