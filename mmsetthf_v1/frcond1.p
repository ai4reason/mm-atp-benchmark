...
thf(apreq1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccpr @ XA2 @ XC) @ (ccpr @ XB2 @ XC))))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aprcom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccpr @ XA2 @ XB2) @ (ccpr @ XB2 @ XA2))))).
thf(cfrcond1_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : (cwceq @ (XE @ Xb) @ (ccfv @ XG @ ccedg))) => (cwi @ (cwcel @ XG @ ccfrgr) @ (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV) @ (cwne @ XA2 @ XC)) @ (cwreu @ (^ [Xb:$i] : (cwss @ (ccpr @ (ccpr @ XA2 @ (ccv @ Xb)) @ (ccpr @ (ccv @ Xb) @ XC)) @ (XE @ Xb))) @ (^ [Xb:$i] : XV)))))))))))).
