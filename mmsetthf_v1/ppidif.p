...
thf(cppidif_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XM @ ccppi) @ ccmin) @ (ccfv @ (ccin @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ ccprime) @ cchash)))))).
