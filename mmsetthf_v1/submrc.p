...
thf(asubmre_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwcel @ XA2 @ XC)) @ (cwcel @ (ccin @ XC @ (ccpw @ XA2)) @ (ccfv @ XA2 @ ccmre))))))).
...
thf(csubmrc_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => ((cwceq @ XG @ (ccfv @ (ccin @ XC @ (ccpw @ XD)) @ ccmrc)) => (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwcel @ XD @ XC) @ (cwss @ XU @ XD)) @ (cwceq @ (ccfv @ XU @ XG) @ (ccfv @ XU @ XF)))))))))))).
