...
thf(atrel3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwtr @ XA2) @ (cwi @ (cw3a @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XD) @ (cwcel @ XD @ XA2)) @ (cwcel @ XB2 @ XA2)))))))).
...
thf(cordelord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cwcel @ XB2 @ XA2)) @ (cword @ XB2))))).
