...
thf(alogm1_thm,axiom,(cwceq @ (ccfv @ (ccneg @ cc1) @ cclog) @ (cco @ cci @ ccpi @ ccmul))).
...
thf(acoshalfpip_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccaddc) @ cccos) @ (ccneg @ (ccfv @ XA2 @ ccsin)))))).
...
thf(ahalfpm6th_thm,axiom,(cwa @ (cwceq @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccmin) @ (cco @ cc1 @ cc3 @ ccdiv)) @ (cwceq @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccaddc) @ (cco @ cc2 @ cc3 @ ccdiv)))).
...
thf(asincos6thpi_thm,axiom,(cwa @ (cwceq @ (ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ ccsin) @ (cco @ cc1 @ cc2 @ ccdiv)) @ (cwceq @ (ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ cccos) @ (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)))).
...
thf(asinhalfpip_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccaddc) @ ccsin) @ (ccfv @ XA2 @ cccos))))).
...
thf(aroot1cj_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccz)) @ (cwceq @ (ccfv @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ XK @ ccexp) @ cccj) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ (cco @ XN @ XK @ ccmin) @ ccexp)))))).
...
thf(acjaddi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccj) @ (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccaddc))))))).
...
thf(c_1cubrlem_conj,conjecture,(cwa @ (cwceq @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ cc3 @ ccdiv) @ cccxp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccaddc) @ cc2 @ ccdiv)) @ (cwceq @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ cc3 @ ccdiv) @ cccxp) @ cc2 @ ccexp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccmin) @ cc2 @ ccdiv)))).
