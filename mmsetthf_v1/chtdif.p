...
thf(cchtdif_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (cco @ (ccfv @ XN @ cccht) @ (ccfv @ XM @ cccht) @ ccmin) @ (ccsu @ (ccin @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog)))))))).
