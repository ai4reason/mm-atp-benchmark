...
thf(aiuncom4_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwceq @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccuni @ (XB2 @ Xx3)))) @ (ccuni @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
thf(arspcev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ Xps) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(aeqeq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XC @ XA2) @ (cwceq @ XC @ XB2))))))))).
thf(ctxcmplem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xv:$i] : (cwceq @ XX @ (ccuni @ (XR @ Xv)))) => ((cwceq @ XY @ (ccuni @ XS)) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwcel @ (XR @ Xv) @ cccmp))) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwcel @ XS @ cccmp))) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwss @ XW @ (cco @ (XR @ Xv) @ XS @ cctx)))) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwceq @ (ccxp @ XX @ XY) @ (ccuni @ XW)))) => (! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwrex @ (^ [Xv:$i] : (cwceq @ (ccxp @ XX @ XY) @ (ccuni @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XW) @ ccfn)))))))))))))))))).
