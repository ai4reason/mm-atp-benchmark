...
thf(ann0negleid_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwbr @ (ccneg @ XA2) @ XA2 @ ccle)))).
thf(cdifgtsumgt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn0) @ (cwcel @ XC @ ccr)) @ (cwi @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ cclt) @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))))).
