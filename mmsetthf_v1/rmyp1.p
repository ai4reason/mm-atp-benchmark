...
thf(crmyp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmx) @ ccaddc)))))).
