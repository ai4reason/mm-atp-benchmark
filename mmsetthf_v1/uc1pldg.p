...
thf(cuc1pldg_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => (cwi @ (cwcel @ XF @ XC) @ (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) @ XU))))))))))).
