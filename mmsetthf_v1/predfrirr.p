...
thf(apredel_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) @ (cwcel @ XY @ XA2))))))).
thf(cpredfrirr_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwfr @ XA2 @ XR) @ (cwn @ (cwcel @ XX @ (ccpred @ XA2 @ XR @ XX)))))))).
