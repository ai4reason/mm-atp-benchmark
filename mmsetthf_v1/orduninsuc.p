...
thf(aonuninsuci_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwb @ (cwceq @ XA2 @ (ccuni @ XA2)) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(corduninsuc_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwb @ (cwceq @ XA2 @ (ccuni @ XA2)) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))).
