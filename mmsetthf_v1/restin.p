...
thf(crestin_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ XV) @ (cwcel @ XA2 @ XW)) @ (cwceq @ (cco @ XJ @ XA2 @ ccrest) @ (cco @ XJ @ (ccin @ XA2 @ XX) @ ccrest)))))))))).
