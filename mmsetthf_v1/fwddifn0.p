...
thf(cfwddifn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ (cco @ ccc0 @ XF @ ccfwddifn)) @ (ccfv @ XX @ XF))))))))))).
