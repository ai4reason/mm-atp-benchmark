...
thf(are1tbw2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ Xph @ (cwi @ Xps @ Xph))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(cclaut_tp,type,(cclaut : ($i > $o))).
thf(cwf1o_tp,type,(cwf1o : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(altrneq2_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xp) @ ccatm))) => ((! [Xp:$i] : (cwceq @ (XH @ Xp) @ (ccfv @ (XK @ Xp) @ cclh))) => ((! [Xp:$i] : (cwceq @ (XT @ Xp) @ (ccfv @ (XW @ Xp) @ (ccfv @ (XK @ Xp) @ ccltrn)))) => (! [Xp:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ (XK @ Xp) @ cchlt) @ (cwcel @ (XW @ Xp) @ (XH @ Xp))) @ (cwcel @ XF @ (XT @ Xp)) @ (cwcel @ XG @ (XT @ Xp))) @ (cwb @ (cwral @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccv @ Xp) @ XF) @ (ccfv @ (ccv @ Xp) @ XG))) @ (^ [Xp:$i] : XA2)) @ (cwceq @ XF @ XG))))))))))))))).
thf(cltrneq_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xp:$i] : (cwceq @ (Xc_le @ Xp) @ (ccfv @ XK @ ccple))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) @ (cwb @ (cwral @ (^ [Xp:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xp) @ XW @ (Xc_le @ Xp))) @ (cwceq @ (ccfv @ (ccv @ Xp) @ XF) @ (ccfv @ (ccv @ Xp) @ XG)))) @ (^ [Xp:$i] : XA2)) @ (cwceq @ XF @ XG)))))))))))))))).
