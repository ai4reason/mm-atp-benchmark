...
thf(areprle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => (cwi @ Xph @ (cwbr @ (ccfv @ XX @ XC) @ XM @ ccle)))))))))))))).
...
thf(aoddprm2_thm,axiom,(! [XO:($i > $o)] : ((cwceq @ XO @ (ccrab @ (^ [Xz:$i] : (cwn @ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccz))) => (cwceq @ (ccdif @ ccprime @ (ccsn @ cc2)) @ (ccin @ XO @ ccprime))))).
...
thf(aundif3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccun @ XA2 @ (ccdif @ XB2 @ XC)) @ (ccdif @ (ccun @ XA2 @ XB2) @ (ccdif @ XC @ XA2))))))).
...
thf(aaddrsub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ XC) @ (cwceq @ XB2 @ (cco @ XC @ XA2 @ ccmin)))))))))))).
...
thf(afsumxp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccop @ (ccv @ Xj) @ (ccv @ Xk))) @ (cwceq @ (XD @ Xz) @ (XC @ Xj @ Xk)))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XB2))) @ (cwcel @ (XC @ Xj @ Xk) @ ccc)))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xj @ Xk))))) @ (ccsu @ (ccxp @ XA2 @ XB2) @ (^ [Xz:$i] : (XD @ Xz))))))))))))))).
thf(aadantrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xth)) @ Xch))))))).
thf(chgt750lemb_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwceq @ (XO @ Xi @ Xj @ Xn @ Xc) @ (ccrab @ (^ [Xz:$i] : (cwn @ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccz))))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XN @ Xz) @ ccn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ cc2 @ (XN @ Xz) @ ccle))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xz) @ (ccrab @ (^ [Xc:$i] : (cwn @ (cwcel @ (ccfv @ ccc0 @ (ccv @ Xc)) @ (ccin @ (XO @ Xi @ Xj @ Xn @ Xc) @ ccprime)))) @ (^ [Xc:$i] : (cco @ ccn @ (XN @ Xz) @ (ccfv @ cc3 @ ccrepr))))))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccsu @ (XA2 @ Xz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xn)) @ ccvma) @ (cco @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xn)) @ ccvma) @ (ccfv @ (ccfv @ cc2 @ (ccv @ Xn)) @ ccvma) @ ccmul) @ ccmul))) @ (cco @ (ccfv @ (XN @ Xz) @ cclog) @ (cco @ (ccsu @ (ccun @ (ccdif @ (cco @ cc1 @ (XN @ Xz) @ ccfz) @ ccprime) @ (ccsn @ cc2)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ ccvma))) @ (ccsu @ (cco @ cc1 @ (XN @ Xz) @ ccfz) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ ccvma))) @ ccmul) @ ccmul) @ ccle)))))))))))).
