...
thf(c_1pthdlem2_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccs2 @ XX @ XY)) => ((cwceq @ XF @ (ccs1 @ XJ)) => (cwceq @ (ccin @ (ccima @ XP @ (ccpr @ ccc0 @ (ccfv @ XF @ cchash))) @ (ccima @ XP @ (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo))) @ cc0))))))))).
