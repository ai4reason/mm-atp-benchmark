...
thf(cfourierdlem9_conj,conjecture,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xs1:$i] : (cwi @ Xph @ (cwf @ ccr @ ccr @ (XF @ Xs1)))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xs1) @ ccr))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XY @ Xs1) @ ccr))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XW @ Xs1) @ ccr))) => ((! [Xs1:$i] : (cwceq @ (XH @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccv @ Xs1) @ ccc0) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ (XX @ Xs1) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xs1)) @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xs1) @ cclt) @ (XY @ Xs1) @ (XW @ Xs1)) @ ccmin) @ (ccv @ Xs1) @ ccdiv)))))) => (! [Xs1:$i] : (cwi @ Xph @ (cwf @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccr @ (XH @ Xs1)))))))))))))))).
