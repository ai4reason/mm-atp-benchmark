...
thf(adivadddivi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwcel @ XD @ ccc) => ((cwne @ XB2 @ ccc0) => ((cwne @ XD @ ccc0) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccaddc) @ (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccaddc) @ (cco @ XB2 @ XD @ ccmul) @ ccdiv))))))))))))).
...
thf(a_3t1e3_thm,axiom,(cwceq @ (cco @ cc3 @ cc1 @ ccmul) @ cc3)).
...
thf(altmul1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ cclt))))))))))).
...
thf(adivcan2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwne @ XB2 @ ccc0) => (cwceq @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccmul) @ XA2))))))).
...
thf(cstoweidlem13_conj,conjecture,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ (XE @ Xj) @ ccrp))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ (XX @ Xj) @ ccr))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ (XY @ Xj) @ ccr))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ (ccv @ Xj) @ ccr))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc4 @ cc3 @ ccdiv) @ ccmin) @ (XE @ Xj) @ ccmul) @ (XX @ Xj) @ cclt))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwbr @ (XX @ Xj) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) @ (XE @ Xj) @ ccmul) @ ccle))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc4 @ cc3 @ ccdiv) @ ccmin) @ (XE @ Xj) @ ccmul) @ (XY @ Xj) @ cclt))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwbr @ (XY @ Xj) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ (XE @ Xj) @ ccmul) @ cclt))) => (! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwbr @ (ccfv @ (cco @ (XY @ Xj) @ (XX @ Xj) @ ccmin) @ ccabs) @ (cco @ cc2 @ (XE @ Xj) @ ccmul) @ cclt)))))))))))))))).
