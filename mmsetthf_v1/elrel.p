...
thf(celrel_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwrel @ (XR @ Xx3 @ Xy1)) @ (cwcel @ XA2 @ (XR @ Xx3 @ Xy1))) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))))))))))))).
