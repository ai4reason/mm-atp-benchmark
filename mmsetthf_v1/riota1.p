...
thf(criota1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwb @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3)) @ (cwceq @ (ccrio @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (ccv @ Xx3)))))))).
