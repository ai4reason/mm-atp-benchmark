...
thf(adf_apply_ax,axiom,(cwceq @ ccapply @ (cccom @ (cccom @ ccbigcup @ ccbigcup) @ (cccom @ (ccdif @ (ccxp @ ccvv @ ccvv) @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ (ccres @ ccep @ ccsingles) @ ccvv)))) @ (cccom @ (cccom @ ccsingle @ ccimg) @ (ccpprod @ ccid @ ccsingle)))))).
...
thf(adffv5_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ XF) @ (ccuni @ (ccuni @ (ccin @ (ccsn @ (ccima @ XF @ (ccsn @ XA2))) @ ccsingles))))))).
thf(cbrapply_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwbr @ (ccop @ XA2 @ XB2) @ XC @ ccapply) @ (cwceq @ XC @ (ccfv @ XB2 @ XA2)))))))))).
