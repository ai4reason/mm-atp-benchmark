...
thf(areuen1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwb @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ cc1o @ ccen))))).
...
thf(ceuen1_conj,conjecture,(! [Xph:($i > $o)] : (cwb @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwbr @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ cc1o @ ccen)))).
