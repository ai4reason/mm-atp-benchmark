...
thf(arelfi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwb @ (cwcel @ XA2 @ ccfn) @ (cwa @ (cwcel @ (ccdm @ XA2) @ ccfn) @ (cwcel @ (ccrn @ XA2) @ ccfn)))))).
...
thf(affsrn_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XZ @ XW)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwfun @ XF)) => ((cwi @ Xph @ (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn)) => (cwi @ Xph @ (cwcel @ (ccrn @ XF) @ ccfn)))))))))))).
...
thf(aopabdm_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XR @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwceq @ (ccdm @ XR) @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))))).
...
thf(aunifi3_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ (ccuni @ XA2) @ ccfn) @ (cwss @ XA2 @ ccfn)))).
thf(aopabrn_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XR @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwceq @ (ccrn @ XR) @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))))))))).
...
thf(cfpwrelmapffslem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwf @ XA2 @ (ccpw @ (XB2 @ Xx3 @ Xy1)) @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwceq @ XR @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwb @ (cwcel @ XR @ ccfn) @ (cwa @ (cwss @ (ccrn @ XF) @ ccfn) @ (cwcel @ (cco @ XF @ cc0 @ ccsupp) @ ccfn)))))))))))))))).
