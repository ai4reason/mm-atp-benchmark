...
thf(afh2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) => ((cwbr @ XA2 @ XC @ cccm) => (cwceq @ (ccin @ XB2 @ (cco @ XA2 @ XC @ cchj)) @ (cco @ (ccin @ XB2 @ XA2) @ (ccin @ XB2 @ XC) @ cchj))))))))))).
...
thf(cfh4i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) => ((cwbr @ XA2 @ XC @ cccm) => (cwceq @ (cco @ XB2 @ (ccin @ XA2 @ XC) @ cchj) @ (ccin @ (cco @ XB2 @ XA2 @ cchj) @ (cco @ XB2 @ XC @ cchj)))))))))))).
