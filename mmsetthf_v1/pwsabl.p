...
thf(aprdsabld_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccabl @ XR)) => (cwi @ Xph @ (cwcel @ XY @ ccabl)))))))))))))).
...
thf(cpwsabl_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccpws)) => (cwi @ (cwa @ (cwcel @ XR @ ccabl) @ (cwcel @ XI @ XV)) @ (cwcel @ XY @ ccabl)))))))).
