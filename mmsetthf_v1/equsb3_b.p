...
thf(aequsb3lem_b_thm,axiom,(! [Xx3:$i] : (cwb @ (cwsb @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3))) @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3))))).
thf(cequsb3_b_conj,conjecture,(! [Xx3:$i] : (cwb @ (cwsb @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3))) @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3))))).
