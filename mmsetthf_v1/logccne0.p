...
thf(alogeq0im1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwceq @ (ccfv @ XA2 @ cclog) @ ccc0)) @ (cwceq @ XA2 @ cc1)))).
thf(clogccne0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) @ (cwne @ (ccfv @ XA2 @ cclog) @ ccc0)))).
