...
thf(ashsidmi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => (cwceq @ (cco @ XA2 @ XA2 @ ccph) @ XA2)))).
...
thf(cshslubi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => (cwb @ (cwa @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XC)) @ (cwss @ (cco @ XA2 @ XB2 @ ccph) @ XC))))))))).
