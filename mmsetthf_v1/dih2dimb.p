...
thf(cdih2dimb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwa @ (cwcel @ XP @ XA2) @ (cwbr @ XP @ XW @ Xc_le))) => ((cwi @ Xph @ (cwa @ (cwcel @ XQ @ XA2) @ (cwbr @ XQ @ XW @ Xc_le))) => (cwi @ Xph @ (cwss @ (ccfv @ (cco @ XP @ XQ @ Xc_or) @ XI) @ (cco @ (ccfv @ XP @ XI) @ (ccfv @ XQ @ XI) @ Xc_po)))))))))))))))))))))))))).
