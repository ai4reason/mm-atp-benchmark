...
thf(cwilthlem1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))) @ (cwb @ (cwceq @ XN @ (cco @ (cco @ XN @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) @ (cwo @ (cwceq @ XN @ cc1) @ (cwceq @ XN @ (cco @ XP @ cc1 @ ccmin)))))))).
