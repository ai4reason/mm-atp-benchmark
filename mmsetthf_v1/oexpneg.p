...
thf(coexpneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) @ (cwceq @ (cco @ (ccneg @ XA2) @ XN @ ccexp) @ (ccneg @ (cco @ XA2 @ XN @ ccexp))))))).
