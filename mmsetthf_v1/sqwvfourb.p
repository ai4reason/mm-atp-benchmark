...
thf(aitgsincmulx_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XB2 @ XC @ ccle)) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ XB2 @ XC @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ ccsin))) @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ cccos) @ (ccfv @ (cco @ XA2 @ XC @ ccmul) @ cccos) @ ccmin) @ XA2 @ ccdiv))))))))))))).
...
thf(acosknegpi_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ XK @ (ccneg @ ccpi) @ ccmul) @ cccos) @ (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
...
thf(acoskpi2_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ XK @ ccpi @ ccmul) @ cccos) @ (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
...
thf(csqwvfourb_conj,conjecture,(! [Xph:$o] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (cco @ cc2 @ ccpi @ ccmul))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (XT @ Xx3) @ ccmo) @ ccpi @ cclt) @ cc1 @ (ccneg @ cc1)))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ (ccfv @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv) @ (ccif @ (cwbr @ cc2 @ XN @ ccdvds) @ ccc0 @ (cco @ cc4 @ (cco @ XN @ ccpi @ ccmul) @ ccdiv)))))))))))).
