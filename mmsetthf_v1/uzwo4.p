...
thf(cuzwo4_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xps @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xps @ Xj @ Xk))))) => (! [Xj:$i] : (cwi @ (cwa @ (cwss @ XS @ (ccfv @ (XM @ Xj) @ ccuz)) @ (cwrex @ (^ [Xj:$i] : (Xph @ Xj)) @ (^ [Xj:$i] : XS))) @ (cwrex @ (^ [Xj:$i] : (cwa @ (Xph @ Xj) @ (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ cclt) @ (cwn @ (Xps @ Xj @ Xk)))) @ (^ [Xk:$i] : XS)))) @ (^ [Xj:$i] : XS))))))))))).
