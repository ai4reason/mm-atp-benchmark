...
thf(apell14qrval_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwceq @ (ccfv @ XD @ ccpell14qr) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (cco @ (ccfv @ XD @ ccsqrt) @ (ccv @ Xw) @ ccmul) @ ccaddc)) @ (cwceq @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccn0))) @ (^ [Xy1:$i] : ccr)))))).
...
thf(apellfund14b_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (cco @ (ccfv @ XD @ ccpellfund) @ (ccv @ Xx3) @ ccexp))) @ (^ [Xx3:$i] : ccz))))))).
thf(crmxyelqirr_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ (XN @ Xc @ Xd) @ ccz)) @ (cwcel @ (cco @ (cco @ XA2 @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ ccaddc) @ (XN @ Xc @ Xd) @ ccexp) @ (ccab @ (^ [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : (cwceq @ (ccv @ Xa) @ (cco @ (ccv @ Xc) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ (ccv @ Xd) @ ccmul) @ ccaddc))) @ (^ [Xd:$i] : ccz))) @ (^ [Xc:$i] : ccn0))))))))))).
