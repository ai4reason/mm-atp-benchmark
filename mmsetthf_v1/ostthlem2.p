...
thf(costthlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xp:$i] : (cwceq @ (XQ @ Xp) @ (cco @ cccnfld @ ccq @ ccress))) => ((! [Xp:$i] : (cwceq @ XA2 @ (ccfv @ (XQ @ Xp) @ ccabv))) => ((cwi @ Xph @ (cwcel @ XF @ XA2)) => ((cwi @ Xph @ (cwcel @ XG @ XA2)) => ((! [Xp:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xp) @ ccprime)) @ (cwceq @ (ccfv @ (ccv @ Xp) @ XF) @ (ccfv @ (ccv @ Xp) @ XG)))) => (cwi @ Xph @ (cwceq @ XF @ XG))))))))))))).
