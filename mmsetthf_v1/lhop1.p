...
thf(axrltmin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwb @ (cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ ccle) @ XB2 @ XC) @ cclt) @ (cwa @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XA2 @ XC @ cclt)))))))).
...
thf(aelioo5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwb @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) @ (cwa @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XC @ XB2 @ cclt)))))))).
...
thf(alhop1lem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XA2 @ ccr))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XB2 @ Xt) @ ccxr))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwbr @ XA2 @ (XB2 @ Xt) @ cclt))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwf @ (cco @ XA2 @ (XB2 @ Xt) @ ccioo) @ ccr @ XF))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwf @ (cco @ XA2 @ (XB2 @ Xt) @ ccioo) @ ccr @ XG))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ (XB2 @ Xt) @ ccioo)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwceq @ (ccdm @ (cco @ ccr @ XG @ ccdv)) @ (cco @ XA2 @ (XB2 @ Xt) @ ccioo)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ ccc0 @ (cco @ XF @ XA2 @ cclimc)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ ccc0 @ (cco @ XG @ XA2 @ cclimc)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwn @ (cwcel @ ccc0 @ (ccrn @ XG))))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwn @ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XG @ ccdv)))))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ (XB2 @ Xt) @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv))) @ XA2 @ cclimc)))) => ((! [Xz:$i] : (! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XE @ Xz) @ ccrp)))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XD @ Xz @ Xr) @ ccr))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xt) @ (cwbr @ (XD @ Xz @ Xr) @ (XB2 @ Xt) @ ccle))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XX @ Xt) @ (cco @ XA2 @ (XD @ Xz @ Xr) @ ccioo)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xt) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv) @ XC @ ccmin) @ ccabs) @ (XE @ Xz) @ cclt)) @ (^ [Xt:$i] : (cco @ XA2 @ (XD @ Xz @ Xr) @ ccioo))))))) => ((! [Xt:$i] : (! [Xr:$i] : (cwceq @ (XR @ Xt @ Xr) @ (cco @ XA2 @ (cco @ (ccv @ Xr) @ cc2 @ ccdiv) @ ccaddc)))) => (! [Xz:$i] : (! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (XX @ Xt) @ XF) @ (ccfv @ (XX @ Xt) @ XG) @ ccdiv) @ XC @ ccmin) @ ccabs) @ (cco @ cc2 @ (XE @ Xz) @ ccmul) @ cclt))))))))))))))))))))))))))))))))).
