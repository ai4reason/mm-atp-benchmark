...
thf(cnatrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ XC @ XD @ ccnat)) => (cwi @ (cwcel @ XA2 @ (cco @ XF @ XG @ XN)) @ (cwa @ (cwcel @ XF @ (cco @ XC @ XD @ ccfunc)) @ (cwcel @ XG @ (cco @ XC @ XD @ ccfunc)))))))))))).
