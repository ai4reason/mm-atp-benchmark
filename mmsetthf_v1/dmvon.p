...
thf(acaragenss_thm,axiom,(! [XS:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => (cwi @ (cwcel @ XO @ ccome) @ (cwss @ XS @ (ccdm @ XO))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(assdmres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwss @ XA2 @ (ccdm @ XB2)) @ (cwceq @ (ccdm @ (ccres @ XB2 @ XA2)) @ XA2))))).
thf(aeqidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (cwi @ Xph @ (cwceq @ XA2 @ XA2))))).
thf(cdmvon_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccdm @ (ccfv @ XX @ ccvoln)) @ (ccfv @ (ccfv @ XX @ ccovoln) @ cccaragen))))))).
