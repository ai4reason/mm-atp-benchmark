...
thf(ccpmadurid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XC @ (cco @ XN @ XR @ ccchpmat)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XY @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => ((cwceq @ Xc_mi @ (ccfv @ XY @ ccsg)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccvsca)) => ((cwceq @ Xc_1 @ (ccfv @ XY @ ccur)) => ((cwceq @ XI @ (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (ccfv @ XM @ XT) @ Xc_mi)) => ((cwceq @ XJ @ (cco @ XN @ XP @ ccmadu)) => ((cwceq @ Xc_xp @ (ccfv @ XY @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) @ (cwceq @ (cco @ XI @ (ccfv @ XI @ XJ) @ Xc_xp) @ (cco @ (ccfv @ XM @ XC) @ Xc_1 @ Xc_x))))))))))))))))))))))))))))))))).
