...
thf(arelexprelg_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XR @ XV) @ (cwi @ (cwceq @ XN @ cc1) @ (cwrel @ XR))) @ (cwrel @ (cco @ XR @ XN @ ccrelexp))))))).
...
thf(arelexpnnrn_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XR @ XV)) @ (cwss @ (ccrn @ (cco @ XR @ XN @ ccrelexp)) @ (ccrn @ XR))))))).
...
thf(crelexpfld_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XR @ XV)) @ (cwss @ (ccuni @ (ccuni @ (cco @ XR @ XN @ ccrelexp))) @ (ccuni @ (ccuni @ XR)))))))).
