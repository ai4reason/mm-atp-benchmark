...
thf(cdrngmcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XX @ (ccdif @ XB2 @ (ccsn @ Xc_0))) @ (cwcel @ XY @ (ccdif @ XB2 @ (ccsn @ Xc_0)))) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ (ccdif @ XB2 @ (ccsn @ Xc_0)))))))))))))).
