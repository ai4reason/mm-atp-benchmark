...
thf(cfzostep1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) @ (cwo @ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ (cco @ XB2 @ XC @ ccfzo)) @ (cwceq @ (cco @ XA2 @ cc1 @ ccaddc) @ XC))))))).
