...
thf(cledivdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ cclt))) @ (cwa @ (cwa @ (cwcel @ XC @ ccr) @ (cwbr @ ccc0 @ XC @ cclt)) @ (cwa @ (cwcel @ XD @ ccr) @ (cwbr @ ccc0 @ XD @ cclt)))) @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccle) @ (cwbr @ (cco @ XD @ XC @ ccdiv) @ (cco @ XB2 @ XA2 @ ccdiv) @ ccle)))))))).
