...
thf(abj_intss_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccpw @ XX)) @ (cwi @ (cwne @ XA2 @ cc0) @ (cwss @ (ccint @ XA2) @ XX)))))).
...
thf(abj_raldifsn_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwcel @ XB2 @ XA2) @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwa @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ XB2)))) @ Xps))))))))).
...
thf(cbj_0int_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccpw @ XX)) @ (cwb @ (cwa @ (cwcel @ XX @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccint @ (ccv @ Xx3)) @ XB2)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0))))) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccin @ XX @ (ccint @ (ccv @ Xx3))) @ XB2)) @ (^ [Xx3:$i] : (ccpw @ XA2))))))))).
