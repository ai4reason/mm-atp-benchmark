...
thf(aphplem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwi @ (cwbr @ (ccsuc @ XA2) @ (ccsuc @ XB2) @ ccen) @ (cwbr @ XA2 @ XB2 @ ccen)))))))).
...
thf(cnneneq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwceq @ XA2 @ XB2)))))).
