...
thf(ahashuni_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3)))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cchash) @ (ccsu @ XA2 @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash))))))))))).
...
thf(aqsdisj2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwer @ XX @ XR) @ (cwdisj @ (^ [Xx3:$i] : (ccqs @ XA2 @ XR)) @ (^ [Xx3:$i] : (ccv @ Xx3)))))))).
thf(cqshash_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : ((cwi @ Xph @ (cwer @ XA2 @ Xc_sm)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ cchash) @ (ccsu @ (ccqs @ XA2 @ Xc_sm) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash))))))))))).
