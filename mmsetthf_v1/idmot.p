...
thf(cidmot_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => (cwi @ Xph @ (cwcel @ (ccres @ ccid @ XP) @ (cco @ XG @ XG @ ccismt)))))))))))).
