...
thf(aatdmd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccch)) @ (cwbr @ XA2 @ XB2 @ ccdmd))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(aatelch_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccat) @ (cwcel @ XA2 @ ccch)))).
thf(amddmd2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccmd)) @ (^ [Xx3:$i] : ccch)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccdmd)) @ (^ [Xx3:$i] : ccch)))))).
...
thf(catmd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccch)) @ (cwbr @ XA2 @ XB2 @ ccmd))))).
