...
thf(aharn0_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwne @ (ccfv @ XS @ cchar) @ cc0))))).
...
thf(aisnumbasgrplem3_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccdm @ cccrd)) @ (cwne @ XS @ cc0)) @ (cwcel @ XS @ (ccima @ ccbs @ ccabl))))).
...
thf(cisnumbasabl_conj,conjecture,(! [XS:($i > $o)] : (cwb @ (cwcel @ XS @ (ccdm @ cccrd)) @ (cwcel @ (ccun @ XS @ (ccfv @ XS @ cchar)) @ (ccima @ ccbs @ ccabl))))).
