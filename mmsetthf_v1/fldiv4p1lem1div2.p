...
thf(adiv4p1lem1div2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccr) @ (cwbr @ cc6 @ XN @ ccle)) @ (cwbr @ (cco @ (cco @ XN @ cc4 @ ccdiv) @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
...
thf(cfldiv4p1lem1div2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwo @ (cwceq @ XN @ cc3) @ (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) @ (cwbr @ (cco @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
