...
thf(aharval_thm,axiom,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwcel @ XX @ (XV @ Xy1)) @ (cwceq @ (ccfv @ XX @ cchar) @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ ccdom)) @ (^ [Xy1:$i] : ccon0)))))))).
...
thf(charval2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwceq @ (ccfv @ XA2 @ cchar) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))))))).
