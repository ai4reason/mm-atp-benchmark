...
thf(agsumws2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XS @ XB2) @ (cwcel @ XT @ XB2)) @ (cwceq @ (cco @ XG @ (ccs2 @ XS @ XT) @ ccgsu) @ (cco @ XS @ XT @ Xc_pl))))))))))).
...
thf(camgm2d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ cc1 @ cc2 @ ccdiv) @ cccxp) @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ ccle)))))))).
