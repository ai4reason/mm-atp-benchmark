...
thf(adf_htpy_ax,axiom,(cwceq @ cchtpy @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : cctop)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : cctop)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccrab @ (^ [Xh:$i] : (cwral @ (^ [Xs1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xs1) @ ccc0 @ (ccv @ Xh)) @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xf1))) @ (cwceq @ (cco @ (ccv @ Xs1) @ cc1 @ (ccv @ Xh)) @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xg1))))) @ (^ [Xs1:$i] : (ccuni @ (ccv @ Xx3))))) @ (^ [Xh:$i] : (cco @ (cco @ (ccv @ Xx3) @ ccii @ cctx) @ (ccv @ Xy1) @ cccn))))))))))).
...
thf(cishtpy_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ (XK @ Xs1) @ cccn)))) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ XG @ (cco @ XJ @ (XK @ Xs1) @ cccn)))) => (! [Xs1:$i] : (cwi @ Xph @ (cwb @ (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ (XK @ Xs1) @ cchtpy))) @ (cwa @ (cwcel @ XH @ (cco @ (cco @ XJ @ ccii @ cctx) @ (XK @ Xs1) @ cccn)) @ (cwral @ (^ [Xs1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xs1) @ ccc0 @ XH) @ (ccfv @ (ccv @ Xs1) @ XF)) @ (cwceq @ (cco @ (ccv @ Xs1) @ cc1 @ XH) @ (ccfv @ (ccv @ Xs1) @ XG)))) @ (^ [Xs1:$i] : XX))))))))))))))))).
