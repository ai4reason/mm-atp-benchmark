...
thf(ckmlem4_conj,conjecture,(! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwne @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwceq @ (ccin @ (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz))))) @ (ccv @ Xw)) @ cc0)))))).
