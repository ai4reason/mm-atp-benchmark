...
thf(arelint_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwrel @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwrel @ (ccint @ XA2))))).
thf(cclrellem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XY @ ccvv)) => ((cwi @ Xph @ (cwrel @ XX)) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cccnv @ (cccnv @ XY))) @ (cwb @ (Xps @ Xx3) @ Xch))) => ((cwi @ Xph @ (cwss @ XX @ XY)) => ((cwi @ Xph @ Xch) => (cwi @ Xph @ (cwrel @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XX @ (ccv @ Xx3)) @ (Xps @ Xx3)))))))))))))))))).
