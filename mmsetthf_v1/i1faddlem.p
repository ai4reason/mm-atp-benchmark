...
thf(ci1faddlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ ccc)) @ (cwceq @ (ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccaddc))) @ (ccsn @ XA2)) @ (cciun @ (^ [Xy1:$i] : (ccrn @ XG)) @ (^ [Xy1:$i] : (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XA2 @ (ccv @ Xy1) @ ccmin))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xy1))))))))))))))).
