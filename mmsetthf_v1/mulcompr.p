...
thf(ampv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmp) @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmq))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XA2))))))))).
...
thf(cmulcompr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ ccmp) @ (cco @ XB2 @ XA2 @ ccmp))))).
