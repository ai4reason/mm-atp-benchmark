...
thf(caxpowndlem2_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwi @ (cwn @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xz))))) @ (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwex @ (^ [Xz:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))))).
