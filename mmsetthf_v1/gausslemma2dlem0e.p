...
thf(aflodddiv4t2lthalf_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) @ (cwbr @ (cco @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ cc2 @ ccmul) @ (cco @ XN @ cc2 @ ccdiv) @ cclt)))).
thf(cgausslemma2dlem0e_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XM @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => (cwi @ Xph @ (cwbr @ (cco @ XM @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt)))))))).
