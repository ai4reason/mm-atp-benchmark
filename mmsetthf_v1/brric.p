...
thf(abrwitnlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XR @ (ccima @ (cccnv @ XO) @ (ccdif @ ccvv @ cc1o))) => ((cwfn @ XO @ XX) => (cwb @ (cwbr @ XA2 @ XB2 @ XR) @ (cwne @ (cco @ XA2 @ XB2 @ XO) @ cc0)))))))))).
thf(adf_ric_ax,axiom,(cwceq @ ccric @ (ccima @ (cccnv @ ccrs) @ (ccdif @ ccvv @ cc1o)))).
...
thf(adf_rngiso_ax,axiom,(cwceq @ ccrs @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xs1:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccrab @ (^ [Xf1:$i] : (cwcel @ (cccnv @ (ccv @ Xf1)) @ (cco @ (ccv @ Xs1) @ (ccv @ Xr) @ ccrh))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccrh)))))))).
thf(cbrric_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwb @ (cwbr @ XR @ XS @ ccric) @ (cwne @ (cco @ XR @ XS @ ccrs) @ cc0))))).
