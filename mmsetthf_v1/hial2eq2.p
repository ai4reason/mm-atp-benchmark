...
thf(chial2eq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XA2 @ ccsp) @ (cco @ (ccv @ Xx3) @ XB2 @ ccsp))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XA2 @ XB2)))))).
