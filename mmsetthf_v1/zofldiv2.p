...
thf(czofldiv2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz)) @ (cwceq @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv))))).
