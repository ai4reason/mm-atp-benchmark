...
thf(cnrgdsdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XR @ ccbs)) => ((cwceq @ XN @ (ccfv @ XR @ ccnm)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XD @ (ccfv @ XR @ ccds)) => (cwi @ (cwa @ (cwcel @ XR @ ccnrg) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ (ccfv @ XA2 @ XN) @ (cco @ XB2 @ XC @ XD) @ ccmul) @ (cco @ (cco @ XA2 @ XB2 @ Xc_x) @ (cco @ XA2 @ XC @ Xc_x) @ XD)))))))))))))))).
