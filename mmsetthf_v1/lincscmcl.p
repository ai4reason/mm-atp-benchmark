...
thf(armfsupp_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XR @ (ccfv @ XM @ ccbs)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XM @ ccrg) @ (cwcel @ XV @ XX) @ (cwcel @ XC @ XR)) @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) @ (cwbr @ XA2 @ (ccfv @ XM @ cc0g) @ ccfsupp)) @ (cwbr @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (cco @ XC @ (ccfv @ (ccv @ Xv) @ XA2) @ (ccfv @ XM @ ccmulr)))) @ (ccfv @ XM @ cc0g) @ ccfsupp)))))))))).
...
thf(alincscm_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (Xc_xb @ Xx3) @ (ccfv @ XM @ ccvsca))) => ((cwceq @ Xc_x @ (ccfv @ (ccfv @ XM @ ccsca) @ ccmulr)) => ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (cco @ XA2 @ XV @ (ccfv @ XM @ cclinc)))) => ((cwceq @ XR @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ XS @ (ccfv @ (ccv @ Xx3) @ XA2) @ Xc_x))))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) @ (cwa @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) @ (cwcel @ XS @ XR)) @ (cwbr @ XA2 @ (ccfv @ (ccfv @ XM @ ccsca) @ cc0g) @ ccfsupp)) @ (cwceq @ (cco @ XS @ (XX @ Xx3) @ (Xc_xb @ Xx3)) @ (cco @ (XF @ Xx3) @ XV @ (ccfv @ XM @ cclinc)))))))))))))))))))).
thf(arspcev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ Xps) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(aanbi12d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ Xph @ (cwb @ Xth @ Xta)) => (cwi @ Xph @ (cwb @ (cwa @ Xps @ Xth) @ (cwa @ Xch @ Xta))))))))))).
thf(abreq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwbr @ XA2 @ XC @ XR) @ (cwbr @ XB2 @ XC @ XR)))))))).
thf(aeqeq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XC @ XA2) @ (cwceq @ XC @ XB2))))))))).
thf(aoveq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF)))))))).
thf(clincscmcl_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => ((cwceq @ XR @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) @ (cwcel @ XC @ XR) @ (cwcel @ XD @ (cco @ XM @ XV @ cclinco))) @ (cwcel @ (cco @ XC @ XD @ Xc_x) @ (cco @ XM @ XV @ cclinco)))))))))))).
