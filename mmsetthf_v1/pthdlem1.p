...
thf(afzosplitsnm1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccuz))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccfzo) @ (ccun @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ ccfzo) @ (ccsn @ (cco @ XB2 @ cc1 @ ccmin)))))))).
