...
thf(advdivf_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwf @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ XX)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ XS @ XG @ ccdv)) @ XX)) => (cwi @ Xph @ (cwceq @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ ccdv) @ (cco @ (cco @ (cco @ (cco @ XS @ XF @ ccdv) @ XG @ (ccof @ ccmul)) @ (cco @ (cco @ XS @ XG @ ccdv) @ XF @ (ccof @ ccmul)) @ (ccof @ ccmin)) @ (cco @ XG @ XG @ (ccof @ ccmul)) @ (ccof @ ccdiv))))))))))))))).
...
thf(adivcncff_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ cccncf))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (cco @ XX @ ccc @ cccncf)))))))))).
thf(asubcncff_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XX @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (cco @ XX @ ccc @ cccncf)))))))))).
thf(amulcncff_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XX @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (cco @ XX @ ccc @ cccncf)))))))))).
...
thf(cdvdivcncf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwf @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((cwi @ Xph @ (cwcel @ (cco @ XS @ XF @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ (cco @ XS @ XG @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ ccdv) @ (cco @ XX @ ccc @ cccncf)))))))))))))).
