...
thf(arabss3d_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xps @ Xx3))) @ (cwcel @ (ccv @ Xx3) @ XB2))) => (cwi @ Xph @ (cwss @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))))).
...
thf(cxpinpreima2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XE) @ (cwss @ XB2 @ XF)) @ (cwceq @ (ccxp @ XA2 @ XB2) @ (ccin @ (ccima @ (cccnv @ (ccres @ cc1st @ (ccxp @ XE @ XF))) @ XA2) @ (ccima @ (cccnv @ (ccres @ cc2nd @ (ccxp @ XE @ XF))) @ XB2))))))))).
