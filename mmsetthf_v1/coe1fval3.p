...
thf(acoe1fval_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccfv @ XF @ ccco1))) => (! [Xn:$i] : (cwi @ (cwcel @ XF @ (XV @ Xn)) @ (cwceq @ (XA2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccfv @ (ccxp @ cc1o @ (ccsn @ (ccv @ Xn))) @ XF))))))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(asylancl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (Xch => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(apsr1basf_thm,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccps1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => (cwi @ (cwcel @ XF @ XB2) @ (cwf @ (cco @ ccn0 @ cc1o @ ccmap) @ XK @ XF))))))))))).
...
thf(ccoe1fval3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XA2 @ Xy1) @ (ccfv @ XF @ ccco1))) => ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (ccfv @ (XP @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (cwceq @ (XP @ Xy1) @ (ccfv @ (XR @ Xy1) @ ccps1))) => ((! [Xy1:$i] : (cwceq @ (XG @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : ccn0) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (cwi @ (cwcel @ XF @ (XB2 @ Xy1)) @ (cwceq @ (XA2 @ Xy1) @ (cccom @ XF @ (XG @ Xy1)))))))))))))))).
