...
thf(cho01i_conj,conjecture,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp) @ ccc0)) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XT @ cch0o))))).
