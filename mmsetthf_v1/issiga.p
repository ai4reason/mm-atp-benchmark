...
thf(aabfmpel_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (cwcel @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XB2)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ Xps)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ (XW @ Xx3))) @ (cwb @ (cwcel @ XB2 @ (ccfv @ XA2 @ XF)) @ Xps)))))))))))))).
...
thf(cissiga_conj,conjecture,(! [XS:($i > $o)] : (! [XO:($i > $o)] : (cwi @ (cwcel @ XS @ ccvv) @ (cwb @ (cwcel @ XS @ (ccfv @ XO @ ccsiga)) @ (cwa @ (cwss @ XS @ (ccpw @ XO)) @ (cw3a @ (cwcel @ XO @ XS) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XO @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XS)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwcel @ (ccuni @ (ccv @ Xx3)) @ XS))) @ (^ [Xx3:$i] : (ccpw @ XS)))))))))).
