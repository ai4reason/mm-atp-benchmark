...
thf(asubadd4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwcel @ XD @ ccc))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccmin) @ (cco @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ ccmin)))))))).
...
thf(cpntibndlem2_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ (XA2 @ Xy1 @ Xz @ Xa) @ ccrp)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwceq @ (XL @ Xy1 @ Xa) @ (cco @ (cco @ cc1 @ cc4 @ ccdiv) @ (cco @ (XA2 @ Xy1 @ Xz @ Xa) @ cc3 @ ccaddc) @ ccdiv))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ ccabs) @ (XA2 @ Xy1 @ Xz @ Xa) @ ccle)) @ (^ [Xx3:$i] : ccrp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xu @ Xa) @ ccrp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwceq @ (XK @ Xx3 @ Xy1 @ Xz @ Xu @ Xa) @ (ccfv @ (cco @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xu @ Xa) @ (cco @ XE @ cc2 @ ccdiv) @ ccdiv) @ cce))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwceq @ (XC @ Xz @ Xa) @ (cco @ (cco @ cc2 @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xu @ Xa) @ ccmul) @ (ccfv @ cc2 @ cclog) @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ XE @ (cco @ ccc0 @ cc1 @ ccioo))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ (XZ @ Xz @ Xa) @ ccrp)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ XN @ ccn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ (XT @ Xz @ Xu @ Xa) @ ccrp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xy1) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ ccchp) @ ccmin) @ (cco @ (cco @ cc2 @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccmul) @ (cco @ (XT @ Xz @ Xu @ Xa) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmul) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccicc)))) @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwceq @ (XX @ Xx3 @ Xy1 @ Xz @ Xu @ Xa) @ (cco @ (ccfv @ (cco @ (XT @ Xz @ Xu @ Xa) @ (cco @ XE @ cc4 @ ccdiv) @ ccdiv) @ cce) @ (XZ @ Xz @ Xa) @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ (XM @ Xx3 @ Xy1 @ Xu @ Xa) @ (cco @ (ccfv @ (cco @ (XC @ Xz @ Xa) @ XE @ ccdiv) @ cce) @ ccpnf @ ccico)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ (XY @ Xx3 @ Xy1 @ Xu @ Xa) @ (cco @ (XX @ Xx3 @ Xy1 @ Xz @ Xu @ Xa) @ ccpnf @ ccioo)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwa @ (cwa @ (cwbr @ (XY @ Xx3 @ Xy1 @ Xu @ Xa) @ XN @ cclt) @ (cwbr @ XN @ (cco @ (cco @ (XM @ Xx3 @ Xy1 @ Xu @ Xa) @ cc2 @ ccdiv) @ (XY @ Xx3 @ Xy1 @ Xu @ Xa) @ ccmul) @ ccle)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ XN @ (XR @ Xa)) @ XN @ ccdiv) @ ccabs) @ (cco @ XE @ cc2 @ ccdiv) @ ccle)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwa @ (cwbr @ (XY @ Xx3 @ Xy1 @ Xu @ Xa) @ (ccv @ Xz) @ cclt) @ (cwbr @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xy1 @ Xa) @ XE @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ (cco @ (XM @ Xx3 @ Xy1 @ Xu @ Xa) @ (XY @ Xx3 @ Xy1 @ Xu @ Xa) @ ccmul) @ cclt)) @ (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xu) @ (XR @ Xa)) @ (ccv @ Xu) @ ccdiv) @ ccabs) @ XE @ ccle)) @ (^ [Xu:$i] : (cco @ (ccv @ Xz) @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xy1 @ Xa) @ XE @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ ccicc))))) @ (^ [Xz:$i] : ccrp))))))))))))))))))))))))))))))))))))))).
