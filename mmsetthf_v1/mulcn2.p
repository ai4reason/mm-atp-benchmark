...
thf(aaddgegt0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ XB2 @ cclt))) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))).
...
thf(alemul1a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwa @ (cwcel @ XC @ ccr) @ (cwbr @ ccc0 @ XC @ ccle))) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccle)))))).
...
thf(aabs3lem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwcel @ XD @ ccr))) @ (cwi @ (cwa @ (cwbr @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt) @ (cwbr @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XD @ cclt)))))))).
