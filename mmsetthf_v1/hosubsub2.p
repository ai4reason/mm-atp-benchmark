...
thf(ahonegsubdi2_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) @ (cwceq @ (cco @ (ccneg @ cc1) @ (cco @ XT @ XU @ cchod) @ cchot) @ (cco @ XU @ XT @ cchod)))))).
thf(chosubsub2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cw3a @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) @ (cwceq @ (cco @ XS @ (cco @ XT @ XU @ cchod) @ cchod) @ (cco @ XS @ (cco @ XU @ XT @ cchod) @ cchos))))))).
