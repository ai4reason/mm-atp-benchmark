...
thf(clshpcmp_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XW @ cclsh)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XT @ XH)) => ((cwi @ Xph @ (cwcel @ XU @ XH)) => (cwi @ Xph @ (cwb @ (cwss @ XT @ XU) @ (cwceq @ XT @ XU))))))))))))).
