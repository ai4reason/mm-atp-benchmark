...
thf(adf_salg_ax,axiom,(cwceq @ ccsalg @ (ccab @ (^ [Xx3:$i] : (cw3a @ (cwcel @ cc0 @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccdif @ (ccuni @ (ccv @ Xx3)) @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ ccom @ ccdom) @ (cwcel @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xx3))))))))).
thf(cissal_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwcel @ XS @ (XV @ Xy1)) @ (cwb @ (cwcel @ XS @ ccsalg) @ (cw3a @ (cwcel @ cc0 @ XS) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccdif @ (ccuni @ XS) @ (ccv @ Xy1)) @ XS)) @ (^ [Xy1:$i] : XS)) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ ccom @ ccdom) @ (cwcel @ (ccuni @ (ccv @ Xy1)) @ XS))) @ (^ [Xy1:$i] : (ccpw @ XS)))))))))).
