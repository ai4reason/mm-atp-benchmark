...
thf(agsummptmhm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ (XG @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ cccmn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XH @ Xx3) @ ccmnd))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XK @ (cco @ (XG @ Xx3) @ (XH @ Xx3) @ ccmhm)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (Xc_0 @ Xx3) @ ccfsupp))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XC @ Xx3) @ XK))) @ ccgsu) @ (ccfv @ (cco @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccgsu) @ XK)))))))))))))))))))))).
...
thf(apm2mpghm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_as @ (ccfv @ XQ @ ccvsca)) => ((cwceq @ Xc_ex @ (ccfv @ (ccfv @ XQ @ ccmgp) @ ccmg)) => ((cwceq @ XX @ (ccfv @ XA2 @ ccv1)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XQ @ (ccfv @ XA2 @ ccpl1)) => ((cwceq @ XL @ (ccfv @ XQ @ ccbs)) => ((cwceq @ XT @ (cco @ XN @ XR @ ccpm2mp)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwcel @ XT @ (cco @ XC @ XQ @ ccghm)))))))))))))))))))))))))).
...
thf(acsbfv2g_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ (XC @ Xx3)) @ (cwceq @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ XF))) @ (ccfv @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XF))))))))).
...
thf(amat2pmatghm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XH @ (ccfv @ XC @ ccbs)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwcel @ XT @ (cco @ XA2 @ XC @ ccghm)))))))))))))))))).
...
thf(amonmat2matmon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_as @ (ccfv @ XQ @ ccvsca)) => ((cwceq @ Xc_ex @ (ccfv @ (ccfv @ XQ @ ccmgp) @ ccmg)) => ((cwceq @ XX @ (ccfv @ XA2 @ ccv1)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XK @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XQ @ (ccfv @ XA2 @ ccpl1)) => ((cwceq @ XI @ (cco @ XN @ XR @ ccpm2mp)) => ((cwceq @ XE @ (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((cwceq @ XY @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccvsca)) => ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg)) @ (cwa @ (cwcel @ XM @ XK) @ (cwcel @ XL @ ccn0))) @ (cwceq @ (ccfv @ (cco @ (cco @ XL @ XY @ XE) @ (ccfv @ XM @ XT) @ Xc_x) @ XI) @ (cco @ XM @ (cco @ XL @ XX @ Xc_ex) @ Xc_as)))))))))))))))))))))))))))))))))))).
thf(cpm2mp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_as:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XP @ Xn) @ (ccfv @ XR @ ccpl1))) => ((! [Xn:$i] : (cwceq @ (XC @ Xn) @ (cco @ XN @ (XP @ Xn) @ ccmat))) => ((! [Xn:$i] : (cwceq @ XB2 @ (ccfv @ (XC @ Xn) @ ccbs))) => ((! [Xn:$i] : (cwceq @ (Xc_as @ Xn) @ (ccfv @ (XQ @ Xn) @ ccvsca))) => ((! [Xn:$i] : (cwceq @ (Xc_ex @ Xn) @ (ccfv @ (ccfv @ (XQ @ Xn) @ ccmgp) @ ccmg))) => ((! [Xn:$i] : (cwceq @ (XX @ Xn) @ (ccfv @ XA2 @ ccv1))) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XK @ (ccfv @ XA2 @ ccbs)) => ((! [Xn:$i] : (cwceq @ (XQ @ Xn) @ (ccfv @ XA2 @ ccpl1))) => ((cwceq @ XI @ (cco @ XN @ XR @ ccpm2mp)) => ((! [Xn:$i] : (cwceq @ XE @ (ccfv @ (ccfv @ (XP @ Xn) @ ccmgp) @ ccmg))) => ((cwceq @ XY @ (ccfv @ XR @ ccv1)) => ((! [Xn:$i] : (cwceq @ Xc_x @ (ccfv @ (XC @ Xn) @ ccvsca))) => ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => (! [Xn:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg)) @ (cwa @ (cwcel @ XM @ (cco @ XK @ ccn0 @ ccmap)) @ (cwbr @ XM @ (ccfv @ XA2 @ cc0g) @ ccfsupp))) @ (cwceq @ (ccfv @ (cco @ (XC @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ XY @ XE) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XM) @ XT) @ Xc_x))) @ ccgsu) @ XI) @ (cco @ (XQ @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XM) @ (cco @ (ccv @ Xn) @ (XX @ Xn) @ (Xc_ex @ Xn)) @ (Xc_as @ Xn)))) @ ccgsu)))))))))))))))))))))))))))))))))))).
