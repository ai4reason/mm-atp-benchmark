...
thf(atxtube_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XR)) => ((cwceq @ XY @ (ccuni @ XS)) => ((cwi @ Xph @ (cwcel @ XR @ cccmp)) => ((cwi @ Xph @ (cwcel @ XS @ cctop)) => ((cwi @ Xph @ (cwcel @ XU @ (cco @ XR @ XS @ cctx))) => ((cwi @ Xph @ (cwss @ (ccxp @ XX @ (ccsn @ XA2)) @ XU)) => ((cwi @ Xph @ (cwcel @ XA2 @ XY)) => (cwi @ Xph @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xu)) @ (cwss @ (ccxp @ XX @ (ccv @ Xu)) @ XU))) @ (^ [Xu:$i] : XS)))))))))))))))))).
...
thf(cxkoinjcn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccop @ (ccv @ Xy1) @ (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XR @ (ccfv @ XX @ cctopon)) @ (cwcel @ XS @ (ccfv @ XY @ cctopon))) @ (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ XR @ (cco @ (cco @ XS @ XR @ cctx) @ XS @ ccxko) @ cccn)))))))))))).
