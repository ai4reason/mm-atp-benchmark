...
thf(anrgtrg_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccnrg) @ (cwcel @ XR @ cctrg)))).
...
thf(asubmtmd_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => (cwi @ (cwa @ (cwcel @ XG @ cctmd) @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd))) @ (cwcel @ XH @ cctmd))))))).
...
thf(anrginvrcn_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => ((cwceq @ XJ @ (ccfv @ XR @ cctopn)) => (cwi @ (cwcel @ XR @ ccnrg) @ (cwcel @ XI @ (cco @ (cco @ XJ @ XU @ ccrest) @ (cco @ XJ @ XU @ ccrest) @ cccn))))))))))))).
...
thf(cnrgtdrg_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccnrg) @ (cwcel @ XR @ ccdr)) @ (cwcel @ XR @ cctdrg)))).
