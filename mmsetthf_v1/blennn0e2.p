...
thf(cblennn0e2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)) @ (cwceq @ (ccfv @ XN @ ccblen) @ (cco @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccblen) @ cc1 @ ccaddc))))).
