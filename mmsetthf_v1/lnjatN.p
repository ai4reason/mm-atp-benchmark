...
thf(alnatexN_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xq:$i] : (cwceq @ (XB2 @ Xq) @ (ccfv @ (XK @ Xq) @ ccbs))) => ((! [Xq:$i] : (cwceq @ Xc_le @ (ccfv @ (XK @ Xq) @ ccple))) => ((! [Xq:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xq) @ ccatm))) => ((! [Xq:$i] : (cwceq @ (XN @ Xq) @ (ccfv @ (XK @ Xq) @ cclines))) => ((! [Xq:$i] : (cwceq @ (XM @ Xq) @ (ccfv @ (XK @ Xq) @ ccpmap))) => (! [Xq:$i] : (cwi @ (cw3a @ (cwcel @ (XK @ Xq) @ cchlt) @ (cwcel @ XX @ (XB2 @ Xq)) @ (cwcel @ (ccfv @ XX @ (XM @ Xq)) @ (XN @ Xq))) @ (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ (ccv @ Xq) @ XP) @ (cwbr @ (ccv @ Xq) @ XX @ Xc_le))) @ (^ [Xq:$i] : XA2)))))))))))))))))).
...
thf(clnjatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xq:$i] : (cwceq @ (Xc_or @ Xq) @ (ccfv @ XK @ ccjn))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XN @ (ccfv @ XK @ cclines)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XP @ XA2)) @ (cwa @ (cwcel @ (ccfv @ XX @ XM) @ XN) @ (cwbr @ XP @ XX @ Xc_le))) @ (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ (ccv @ Xq) @ XP) @ (cwceq @ XX @ (cco @ XP @ (ccv @ Xq) @ (Xc_or @ Xq))))) @ (^ [Xq:$i] : XA2))))))))))))))))))).
