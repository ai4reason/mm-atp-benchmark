...
thf(acosordlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpi @ ccicc))) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwi @ Xph @ (cwbr @ (ccfv @ XB2 @ cccos) @ (ccfv @ XA2 @ cccos) @ cclt))))))))).
...
thf(ccosord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpi @ ccicc))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (ccfv @ XB2 @ cccos) @ (ccfv @ XA2 @ cccos) @ cclt)))))).
