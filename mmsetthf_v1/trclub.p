...
thf(ctrclub_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XR @ (XV @ Xr)) @ (cwrel @ XR)) @ (cwss @ (ccint @ (ccab @ (^ [Xr:$i] : (cwa @ (cwss @ XR @ (ccv @ Xr)) @ (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr)))))) @ (ccxp @ (ccdm @ XR) @ (ccrn @ XR)))))))).
