...
thf(aoppgcntz_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccoppg)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => (cwceq @ (ccfv @ XA2 @ XZ) @ (ccfv @ XA2 @ (ccfv @ XO @ cccntz)))))))))).
...
thf(coppgcntr_conj,conjecture,(! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccoppg)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntr)) => (cwceq @ XZ @ (ccfv @ XO @ cccntr)))))))).
