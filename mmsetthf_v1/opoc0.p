...
thf(aopcon1b_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccoc)) => (cwi @ (cw3a @ (cwcel @ XK @ ccops) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwceq @ (ccfv @ XX @ Xc_pe) @ XY) @ (cwceq @ (ccfv @ XY @ Xc_pe) @ XX))))))))))).
thf(copoc0_conj,conjecture,(! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ Xc_1 @ (ccfv @ XK @ ccp1)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccoc)) => (cwi @ (cwcel @ XK @ ccops) @ (cwceq @ (ccfv @ Xc_0 @ Xc_pe) @ Xc_1)))))))))).
