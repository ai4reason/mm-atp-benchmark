...
thf(aemoo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cceven) @ (cwcel @ XB2 @ ccodd)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccodd))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(annsum4primesoddALTV_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc7 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc8 @ ccuz)) @ (cwcel @ XN @ ccodd)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XN @ (ccsu @ (cco @ cc1 @ cc3 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))))))).
...
thf(afsnunf_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwf @ XS @ XT @ XF) @ (cwa @ (cwcel @ XX @ XV) @ (cwn @ (cwcel @ XX @ XS))) @ (cwcel @ XY @ XT)) @ (cwf @ (ccun @ XS @ (ccsn @ XX)) @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY)))))))))))).
...
thf(aevengpoap3_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc7 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ (ccdc @ cc1 @ cc2) @ ccuz)) @ (cwcel @ XN @ cceven)) @ (cwrex @ (^ [Xo:$i] : (cwceq @ XN @ (cco @ (ccv @ Xo) @ cc3 @ ccaddc))) @ (^ [Xo:$i] : ccgbo)))))).
thf(cnnsum4primesevenALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc7 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ (ccdc @ cc1 @ cc2) @ ccuz)) @ (cwcel @ XN @ cceven)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XN @ (ccsu @ (cco @ cc1 @ cc4 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc4 @ ccfz) @ ccmap))))))).
