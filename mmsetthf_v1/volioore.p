...
thf(cvolioore_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccvol) @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ (cco @ XB2 @ XA2 @ ccmin) @ ccc0)))))).
