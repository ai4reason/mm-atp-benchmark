...
thf(cnssdmovg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ (ccdm @ XF) @ (ccxp @ XR @ XS)) @ (cwn @ (cwa @ (cwcel @ XA2 @ XR) @ (cwcel @ XB2 @ XS)))) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ cc0)))))))).
