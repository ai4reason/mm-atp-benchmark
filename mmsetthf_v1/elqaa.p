...
thf(aelqaalem3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccc))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XF @ Xk @ Xn) @ (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (ccfv @ XA2 @ (XF @ Xk @ Xn)) @ ccc0)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ XB2 @ (ccfv @ (XF @ Xk @ Xn) @ cccoe)))) => ((cwceq @ XN @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccinf @ (ccrab @ (^ [Xn:$i] : (cwcel @ (cco @ (ccfv @ (ccv @ Xk) @ XB2) @ (ccv @ Xn) @ ccmul) @ ccz)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xn) @ (ccfv @ (ccfv @ (XF @ Xk @ Xn) @ ccdgr) @ (ccseq @ ccmul @ XN @ ccc0))))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccaa)))))))))))))))).
...
thf(celqaa_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccaa) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ (ccfv @ XA2 @ (ccv @ Xf1)) @ ccc0)) @ (^ [Xf1:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))).
