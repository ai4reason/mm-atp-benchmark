...
thf(clidlssbas_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XR @ cclidl)) => ((cwceq @ XI @ (cco @ XR @ XU @ ccress)) => (cwi @ (cwcel @ XU @ XL) @ (cwss @ (ccfv @ XI @ ccbs) @ (ccfv @ XR @ ccbs)))))))))).
