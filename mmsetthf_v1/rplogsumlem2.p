...
thf(afsumvma2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp)) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xk @ Xp)))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz))) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ ccvma) @ ccc0))) @ (cwceq @ (XB2 @ Xx3) @ ccc0))) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ (ccv @ Xp) @ cclog) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk @ Xp)))))))))))))))).
...
thf(avmaprm_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwceq @ (ccfv @ XP @ ccvma) @ (ccfv @ XP @ cclog))))).
...
thf(avmappw_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XK @ ccn)) @ (cwceq @ (ccfv @ (cco @ XP @ XK @ ccexp) @ ccvma) @ (ccfv @ XP @ cclog)))))).
...
thf(afsum1p_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XM) @ (cwceq @ (XA2 @ Xk) @ XB2))) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (cco @ XB2 @ (ccsu @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccaddc)))))))))))).
...
thf(aexpnprm_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccq) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) @ (cwn @ (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccprime)))))).
...
thf(admdcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwcel @ XC @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ ccmul) @ (cco @ XC @ XB2 @ ccdiv))))))).
...
thf(arecgt1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwb @ (cwbr @ cc1 @ XA2 @ cclt) @ (cwbr @ (cco @ cc1 @ XA2 @ ccdiv) @ cc1 @ cclt))))).
...
thf(ageoserg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ cc1)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) @ (cco @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmin) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv)))))))))))).
...
thf(arplogsumlem1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwbr @ (ccsu @ (cco @ cc2 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccmul) @ ccdiv))) @ cc2 @ ccle)))).
thf(crplogsumlem2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwbr @ (ccsu @ (cco @ cc1 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccc0) @ ccmin) @ (ccv @ Xn) @ ccdiv))) @ cc2 @ ccle)))).
