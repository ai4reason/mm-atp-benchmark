...
thf(achpdifbnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ ccle)) @ (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xy1) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ ccchp) @ ccmin) @ (cco @ (cco @ cc2 @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccmul) @ (cco @ (ccv @ Xc) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmul) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ ccicc)))) @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)))) @ (^ [Xc:$i] : ccrp))))).
...
thf(arplogcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwcel @ (ccfv @ XA2 @ cclog) @ ccrp)))).
...
thf(cpntibndlem3_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xz @ Xv @ Xi @ Xm @ Xa) @ (cwcel @ (XA2 @ Xy1 @ Xz @ Xi @ Xk @ Xm @ Xa) @ ccrp)))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XL @ Xy1 @ Xi @ Xk @ Xm @ Xa) @ (cco @ (cco @ cc1 @ cc4 @ ccdiv) @ (cco @ (XA2 @ Xy1 @ Xz @ Xi @ Xk @ Xm @ Xa) @ cc3 @ ccaddc) @ ccdiv)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xz @ Xv @ Xi @ Xm @ Xa) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ ccabs) @ (XA2 @ Xy1 @ Xz @ Xi @ Xk @ Xm @ Xa) @ ccle)) @ (^ [Xx3:$i] : ccrp))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xz @ Xv @ Xi @ Xm @ Xa) @ (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xi @ Xk @ Xm @ Xa) @ ccrp))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XK @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xi @ Xk @ Xa) @ (ccfv @ (cco @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xi @ Xk @ Xm @ Xa) @ (cco @ XE @ cc2 @ ccdiv) @ ccdiv) @ cce))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XC @ Xz @ Xi @ Xk @ Xm @ Xa) @ (cco @ (cco @ cc2 @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xi @ Xk @ Xm @ Xa) @ ccmul) @ (ccfv @ cc2 @ cclog) @ ccaddc))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xz @ Xv @ Xi @ Xm @ Xa) @ (cwcel @ XE @ (cco @ ccc0 @ cc1 @ ccioo))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xz @ Xv @ Xi @ Xm @ Xa) @ (cwcel @ (XZ @ Xz @ Xi @ Xa) @ ccrp)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xz @ Xv @ Xi @ Xm @ Xa) @ (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xv:$i] : (cwrex @ (^ [Xi:$i] : (cwa @ (cwa @ (cwbr @ (ccv @ Xv) @ (ccv @ Xi) @ cclt) @ (cwbr @ (ccv @ Xi) @ (cco @ (ccv @ Xm) @ (ccv @ Xv) @ ccmul) @ ccle)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xi) @ (XR @ Xa)) @ (ccv @ Xi) @ ccdiv) @ ccabs) @ (cco @ XE @ cc2 @ ccdiv) @ ccle))) @ (^ [Xi:$i] : ccn))) @ (^ [Xv:$i] : (cco @ (XZ @ Xz @ Xi @ Xa) @ ccpnf @ ccioo)))) @ (^ [Xm:$i] : (cco @ (XK @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xi @ Xk @ Xa) @ ccpnf @ ccico))))))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xz @ Xv @ Xi @ Xm @ Xa) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwa @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt) @ (cwbr @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xy1 @ Xi @ Xk @ Xm @ Xa) @ XE @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ (cco @ (ccv @ Xk) @ (ccv @ Xy1) @ ccmul) @ cclt)) @ (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xu) @ (XR @ Xa)) @ (ccv @ Xu) @ ccdiv) @ ccabs) @ XE @ ccle)) @ (^ [Xu:$i] : (cco @ (ccv @ Xz) @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xy1 @ Xi @ Xk @ Xm @ Xa) @ XE @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ ccicc))))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)))) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (XC @ Xz @ Xi @ Xk @ Xm @ Xa) @ XE @ ccdiv) @ cce) @ ccpnf @ ccico)))) @ (^ [Xx3:$i] : ccrp))))))))))))))))))))))))))))).
