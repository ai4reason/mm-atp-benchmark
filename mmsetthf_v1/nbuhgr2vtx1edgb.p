...
thf(ahash2prb_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XV @ XW) @ (cwb @ (cwceq @ (ccfv @ XV @ cchash) @ cc2) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
...
thf(anbuhgr2vtx1edgblem_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccuhgr) @ (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) @ (cwcel @ (ccv @ Xa) @ (cco @ XG @ (ccv @ Xb) @ ccnbgr))) @ (cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ XE)))))))))).
...
thf(cnbuhgr2vtx1edgb_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (cwceq @ (XE @ Xv) @ (ccfv @ XG @ ccedg))) => (! [Xv:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccuhgr) @ (cwceq @ (ccfv @ XV @ cchash) @ cc2)) @ (cwb @ (cwcel @ XV @ (XE @ Xv)) @ (cwral @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
