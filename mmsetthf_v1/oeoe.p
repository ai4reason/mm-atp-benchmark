...
thf(aoe0m0_thm,axiom,(cwceq @ (cco @ cc0 @ cc0 @ ccoe) @ cc1o)).
...
thf(aoe1m_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (cco @ cc1o @ XA2 @ ccoe) @ cc1o)))).
...
thf(aom00_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccomu) @ cc0) @ (cwo @ (cwceq @ XA2 @ cc0) @ (cwceq @ XB2 @ cc0))))))).
...
thf(aoeoelem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ cc0 @ XA2) => (cwi @ (cwa @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccoe) @ XC @ ccoe) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccoe))))))))).
...
thf(coeoe_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccoe) @ XC @ ccoe) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccoe))))))).
