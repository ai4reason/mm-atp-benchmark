...
thf(aax_ac_ax,axiom,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))) @ (cwex @ (^ [Xv:$i] : (cwal @ (^ [Xu:$i] : (cwb @ (cwex @ (^ [Xt:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xt))) @ (cwa @ (cwcel @ (ccv @ Xu) @ (ccv @ Xt)) @ (cwcel @ (ccv @ Xt) @ (ccv @ Xy1)))))) @ (cwceq @ (ccv @ Xu) @ (ccv @ Xv)))))))))))))))).
...
thf(czfac_conj,conjecture,(! [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwex @ (^ [Xw:$i] : (cwal @ (^ [Xy1:$i] : (cwb @ (cwex @ (^ [Xw:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)))))) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xw)))))))))))))))).
