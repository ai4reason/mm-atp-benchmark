...
thf(cntrclsk13_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XO @ Xt @ Xi @ Xj @ Xk @ Xs1) @ (ccmpt @ (^ [Xi:$i] : ccvv) @ (^ [Xi:$i] : (ccmpt @ (^ [Xk:$i] : (cco @ (ccpw @ (ccv @ Xi)) @ (ccpw @ (ccv @ Xi)) @ ccmap)) @ (^ [Xk:$i] : (ccmpt @ (^ [Xj:$i] : (ccpw @ (ccv @ Xi))) @ (^ [Xj:$i] : (ccdif @ (ccv @ Xi) @ (ccfv @ (ccdif @ (ccv @ Xi) @ (ccv @ Xj)) @ (ccv @ Xk))))))))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XD @ Xt @ Xi @ Xj @ Xk @ Xs1) @ (ccfv @ XB2 @ (XO @ Xt @ Xi @ Xj @ Xk @ Xs1)))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwbr @ XI @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1) @ (XD @ Xt @ Xi @ Xj @ Xk @ Xs1)))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwceq @ (ccfv @ (ccin @ (ccv @ Xs1) @ (ccv @ Xt)) @ XI) @ (ccin @ (ccfv @ (ccv @ Xs1) @ XI) @ (ccfv @ (ccv @ Xt) @ XI)))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2))) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwceq @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccv @ Xt)) @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1)) @ (ccun @ (ccfv @ (ccv @ Xs1) @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1)) @ (ccfv @ (ccv @ Xt) @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1))))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2)))))))))))))))))).
