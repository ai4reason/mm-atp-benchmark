...
thf(clgsfle1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccif @ (cwceq @ (ccv @ Xn) @ cc2) @ (ccif @ (cwbr @ cc2 @ XA2 @ ccdvds) @ ccc0 @ (ccif @ (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ cc1 @ (ccneg @ cc1))) @ (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccmo) @ cc1 @ ccmin)) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) @ (cwcel @ XM @ ccn)) @ (cwbr @ (ccfv @ (ccfv @ XM @ (XF @ Xn)) @ ccabs) @ cc1 @ ccle))))))))).
