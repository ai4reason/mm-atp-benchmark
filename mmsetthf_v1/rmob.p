...
thf(crmob_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XC) @ (cwb @ (Xph @ Xx3) @ Xch))) => (cwi @ (cwa @ (cwrmo @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwa @ (cwcel @ XB2 @ XA2) @ Xps)) @ (cwb @ (cwceq @ XB2 @ XC) @ (cwa @ (cwcel @ XC @ XA2) @ Xch)))))))))))).
