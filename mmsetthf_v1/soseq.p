...
thf(aposeq_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xg1:$i] : (cwpo @ (ccun @ (XA2 @ Xy1 @ Xg1) @ (ccsn @ cc0)) @ (XR @ Xy1)))) => ((! [Xy1:$i] : (! [Xg1:$i] : (cwceq @ (XF @ Xy1) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwf @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xg1) @ (ccv @ Xf1))) @ (^ [Xx3:$i] : ccon0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xf1) @ (XF @ Xy1)) @ (cwcel @ (ccv @ Xg1) @ (XF @ Xy1))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)))) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (XR @ Xy1)))) @ (^ [Xx3:$i] : ccon0))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwpo @ (XF @ Xy1) @ (XS @ Xx3 @ Xy1 @ Xf1 @ Xg1)))))))))))))).
...
thf(aorderseqlem_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xf1:$i] : (cwceq @ (XF @ Xx3 @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwf @ (ccv @ Xx3) @ XA2 @ (ccv @ Xf1))) @ (^ [Xx3:$i] : ccon0))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (cwcel @ XG @ (XF @ Xx3 @ Xf1)) @ (cwcel @ (ccfv @ (XX @ Xf1) @ XG) @ (ccun @ XA2 @ (ccsn @ cc0)))))))))))).
...
thf(atfisg_thm,axiom,(! [Xph:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : ccon0)) @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccon0))))).
...
thf(a_3orel13_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ (cwn @ Xph) @ (cwn @ Xch)) @ (cwi @ (cw3o @ Xph @ Xps @ Xch) @ Xps)))))).
...
thf(csoseq_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xg1:$i] : (cwor @ (ccun @ (XA2 @ Xg1) @ (ccsn @ cc0)) @ (XR @ Xy1)))) => ((! [Xy1:$i] : (! [Xg1:$i] : (cwceq @ (XF @ Xy1) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwf @ (ccv @ Xx3) @ (XA2 @ Xg1) @ (ccv @ Xf1))) @ (^ [Xx3:$i] : ccon0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xf1) @ (XF @ Xy1)) @ (cwcel @ (ccv @ Xg1) @ (XF @ Xy1))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)))) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (XR @ Xy1)))) @ (^ [Xx3:$i] : ccon0))))))))))) => ((! [Xg1:$i] : (cwn @ (cwcel @ cc0 @ (XA2 @ Xg1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwor @ (XF @ Xy1) @ (XS @ Xx3 @ Xy1 @ Xf1 @ Xg1))))))))))))))).
