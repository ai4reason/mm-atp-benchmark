...
thf(aun2122_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cw3a @ (cwa @ Xph @ Xps) @ Xps @ Xps) @ Xch) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(ajaoded_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xth @ (cwi @ Xta @ Xch)) => ((cwi @ Xet @ (cwo @ Xps @ Xta)) => (cwi @ (cw3a @ Xph @ Xth @ Xet) @ Xch))))))))))).
...
thf(atrelded_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwtr @ XA2)) => ((cwi @ Xps @ (cwcel @ XB2 @ XC)) => ((cwi @ Xch @ (cwcel @ XC @ XA2)) => (cwi @ (cw3a @ Xph @ Xps @ Xch) @ (cwcel @ XB2 @ XA2)))))))))))).
...
thf(csuctrALT3_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwtr @ XA2) @ (cwtr @ (ccsuc @ XA2))))).
