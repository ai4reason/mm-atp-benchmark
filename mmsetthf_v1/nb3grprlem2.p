...
thf(arextpg_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xch))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XC) @ (cwb @ (Xph @ Xx3) @ Xth))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ XB2 @ (XW @ Xx3)) @ (cwcel @ XC @ (XX @ Xx3))) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cctp @ XA2 @ XB2 @ XC))) @ (cw3o @ Xps @ Xch @ Xth)))))))))))))))))).
...
thf(adiftpsn3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)) @ (cwceq @ (ccdif @ (cctp @ XA2 @ XB2 @ XC) @ (ccsn @ XC)) @ (ccpr @ XA2 @ XB2))))))).
...
thf(cnb3grprlem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (cwceq @ (XE @ Xw) @ (ccfv @ XG @ ccedg))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XG @ ccusgr))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwceq @ XV @ (cctp @ XA2 @ XB2 @ XC)))) => ((! [Xw:$i] : (! [Xv:$i] : (cwi @ (Xph @ Xw) @ (cw3a @ (cwcel @ XA2 @ (XX @ Xw @ Xv)) @ (cwcel @ XB2 @ (XY @ Xw @ Xv)) @ (cwcel @ XC @ (XZ @ Xw @ Xv)))))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)))) => (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwb @ (cwceq @ (cco @ XG @ XA2 @ ccnbgr) @ (ccpr @ XB2 @ XC)) @ (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (cco @ XG @ XA2 @ ccnbgr) @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV)))))))))))))))))))))).
