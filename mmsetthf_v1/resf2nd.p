...
thf(cresf2nd_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwcel @ XH @ XW)) => ((cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => ((cwi @ Xph @ (cwcel @ XY @ XS)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ (ccfv @ (cco @ XF @ XH @ ccresf) @ cc2nd)) @ (ccres @ (cco @ XX @ XY @ (ccfv @ XF @ cc2nd)) @ (cco @ XX @ XY @ XH)))))))))))))))))).
