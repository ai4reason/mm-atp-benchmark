...
thf(adm1cosscnvepres_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccdm @ (cccoss @ (ccres @ (cccnv @ ccep) @ XA2))) @ (ccuni @ XA2)))).
thf(cdmcoels_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (ccdm @ (cccoels @ XA2)) @ (ccuni @ XA2)))).
