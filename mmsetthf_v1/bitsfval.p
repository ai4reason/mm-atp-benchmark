...
thf(cbitsfval_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccfv @ XN @ ccbits) @ (ccrab @ (^ [Xm:$i] : (cwn @ (cwbr @ cc2 @ (ccfv @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv) @ ccfl) @ ccdvds))) @ (^ [Xm:$i] : ccn0)))))).
