...
thf(anegiso_thm,axiom,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccneg @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwa @ (cwiso @ ccr @ ccr @ cclt @ (cccnv @ cclt) @ (XF @ Xx3)) @ (cwceq @ (cccnv @ (XF @ Xx3)) @ (XF @ Xx3))))))).
...
thf(cinfrenegsup_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cwceq @ (ccinf @ XA2 @ ccr @ cclt) @ (ccneg @ (ccsup @ (ccrab @ (^ [Xz:$i] : (cwcel @ (ccneg @ (ccv @ Xz)) @ XA2)) @ (^ [Xz:$i] : ccr)) @ ccr @ cclt)))))).
