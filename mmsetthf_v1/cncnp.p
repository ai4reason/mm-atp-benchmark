...
thf(ccncnp_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) @ (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xx3:$i] : (cwcel @ XF @ (ccfv @ (ccv @ Xx3) @ (cco @ XJ @ XK @ cccnp)))) @ (^ [Xx3:$i] : XX))))))))))).
