...
thf(aflimclslem_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (cco @ XX @ (ccfv @ (ccun @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ (ccsn @ XS)) @ ccfi) @ ccfg)) => (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XS @ XX) @ (cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))) @ (cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ XS @ XF) @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim))))))))))).
...
thf(cflimcls_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwcel @ XS @ (ccv @ Xf1)) @ (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xf1) @ ccflim)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))))).
