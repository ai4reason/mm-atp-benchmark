...
thf(cac6c4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (cwi @ (cwral @ (^ [Xx3:$i] : (cwne @ (XB2 @ Xx3) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))))).
