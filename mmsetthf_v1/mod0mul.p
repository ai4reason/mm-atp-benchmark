...
thf(cmod0mul_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn)) @ (cwi @ (cwceq @ (cco @ XA2 @ XN @ ccmo) @ ccc0) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ XN @ ccmul))) @ (^ [Xx3:$i] : ccz))))))).
