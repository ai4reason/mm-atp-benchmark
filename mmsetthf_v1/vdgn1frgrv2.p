...
thf(ausgr2edg1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ ccedg))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwne @ XA2 @ XB2)) @ (cwa @ (cwcel @ (ccpr @ XN @ XA2) @ (XE @ Xx3)) @ (cwcel @ (ccpr @ XB2 @ XN) @ (XE @ Xx3)))) @ (cwn @ (cwreu @ (^ [Xx3:$i] : (cwcel @ XN @ (ccfv @ (ccv @ Xx3) @ XI))) @ (^ [Xx3:$i] : (ccdm @ XI))))))))))))))).
...
thf(cvdgn1frgrv2_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XN @ XV)) @ (cwi @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt) @ (cwne @ (ccfv @ XN @ (ccfv @ XG @ ccvtxdg)) @ cc1)))))))).
