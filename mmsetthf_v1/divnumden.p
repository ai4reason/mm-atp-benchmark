...
thf(cdivnumden_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccn)) @ (cwa @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))))))).
