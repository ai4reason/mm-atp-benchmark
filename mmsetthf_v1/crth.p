...
thf(ccrth_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (cco @ ccc0 @ (cco @ XM @ XN @ ccmul) @ ccfzo)) => ((cwceq @ XT @ (ccxp @ (cco @ ccc0 @ XM @ ccfzo) @ (cco @ ccc0 @ XN @ ccfzo))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccop @ (cco @ (ccv @ Xx3) @ XM @ ccmo) @ (cco @ (ccv @ Xx3) @ XN @ ccmo)))))) => ((cwi @ Xph @ (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1))) => (! [Xx3:$i] : (cwi @ Xph @ (cwf1o @ XS @ XT @ (XF @ Xx3))))))))))))))).
