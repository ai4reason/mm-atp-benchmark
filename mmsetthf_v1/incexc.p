...
thf(aincexclem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwceq @ (cco @ (ccfv @ XB2 @ cchash) @ (ccfv @ (ccin @ XB2 @ (ccuni @ XA2)) @ cchash) @ ccmin) @ (ccsu @ (ccpw @ XA2) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccexp) @ (ccfv @ (ccin @ XB2 @ (ccint @ (ccv @ Xs1))) @ cchash) @ ccmul)))))))).
...
thf(cincexc_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwss @ XA2 @ ccfn)) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cchash) @ (ccsu @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccfv @ (ccv @ Xs1) @ cchash) @ cc1 @ ccmin) @ ccexp) @ (ccfv @ (ccint @ (ccv @ Xs1)) @ cchash) @ ccmul))))))).
