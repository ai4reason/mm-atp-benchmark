...
thf(alcmfunsn_thm,axiom,(! [XN:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwss @ XY @ ccz) @ (cwcel @ XY @ ccfn) @ (cwcel @ XN @ ccz)) @ (cwceq @ (ccfv @ (ccun @ XY @ (ccsn @ XN)) @ cclcmf) @ (cco @ (ccfv @ XY @ cclcmf) @ XN @ cclcm)))))).
...
thf(alcmass_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XP @ ccz)) @ (cwceq @ (cco @ (cco @ XN @ XM @ cclcm) @ XP @ cclcm) @ (cco @ XN @ (cco @ XM @ XP @ cclcm) @ cclcm))))))).
thf(aeqeq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XC @ XA2) @ (cwceq @ XC @ XB2))))))))).
thf(a_3jca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ Xth) => (cwi @ Xph @ (cw3a @ Xps @ Xch @ Xth)))))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(clcmfun_conj,conjecture,(! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XY @ ccz) @ (cwcel @ XY @ ccfn)) @ (cwa @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn))) @ (cwceq @ (ccfv @ (ccun @ XY @ XZ) @ cclcmf) @ (cco @ (ccfv @ XY @ cclcmf) @ (ccfv @ XZ @ cclcmf) @ cclcm)))))).
