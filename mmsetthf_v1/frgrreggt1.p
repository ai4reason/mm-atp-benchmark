...
thf(afinrusgrfusgr_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XV @ ccfn)) @ (cwcel @ XG @ ccfusgr))))))).
thf(asimp1l_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cw3a @ (cwa @ Xph @ Xps) @ Xch @ Xth) @ Xph)))))).
thf(anumclwwlk8_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) @ ccc0))))).
...
thf(anumclwwlk7_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwa @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XG @ ccfrgr)) @ (cwa @ (cwne @ XV @ cc0) @ (cwcel @ XV @ ccfn)) @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) @ (cwceq @ (cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) @ cc1)))))))).
...
thf(cfrgrreggt1_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) @ (cwi @ (cwa @ (cwbr @ XG @ XK @ ccrusgr) @ (cwbr @ cc1 @ XK @ cclt)) @ (cwceq @ XK @ cc2)))))))).
