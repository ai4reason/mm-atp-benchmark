...
thf(adfac8a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XB2 @ Xy1)) @ (cwi @ (cwex @ (^ [Xh:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwne @ (ccv @ Xy1) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xh)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ XA2))))) @ (cwcel @ XA2 @ (ccdm @ cccrd)))))))).
thf(cween_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwex @ (^ [Xr:$i] : (cwwe @ XA2 @ (ccv @ Xr))))))).
