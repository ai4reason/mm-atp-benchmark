...
thf(ao1res_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ cco1) @ (cwcel @ (ccres @ XF @ XA2) @ cco1))))).
...
thf(aelo1mpt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => (cwi @ Xph @ (cwb @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1) @ (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ (ccv @ Xm) @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xy1:$i] : ccr)))))))))).
...
thf(aelo12r_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XM @ ccr)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ XC @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ XM @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ XF @ cco1))))))).
thf(co1resb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ cco1) @ (cwcel @ (ccres @ XF @ (cco @ XB2 @ ccpnf @ ccico)) @ cco1))))))))))).
