...
thf(aintnex_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwn @ (cwcel @ (ccint @ XA2) @ ccvv)) @ (cwceq @ (ccint @ XA2) @ ccvv)))).
...
thf(cintabs_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccint @ (ccab @ (^ [Xy1:$i] : (Xps @ Xy1))))) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xy1:$i] : (cwa @ (cwss @ (ccint @ (ccab @ (^ [Xy1:$i] : (Xps @ Xy1)))) @ (XA2 @ Xy1)) @ (Xch @ Xy1))) => (! [Xy1:$i] : (cwceq @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (Xph @ Xx3))))) @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))))))))))))).
