...
thf(clsm02_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cwcel @ XX @ (ccfv @ XG @ ccsubg)) @ (cwceq @ (cco @ (ccsn @ Xc_0) @ XX @ Xc_po) @ XX))))))))).
