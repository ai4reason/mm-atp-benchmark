...
thf(cfsumsupp0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))))))))))).
