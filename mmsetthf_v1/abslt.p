...
thf(cabslt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccabs) @ XB2 @ cclt) @ (cwa @ (cwbr @ (ccneg @ XB2) @ XA2 @ cclt) @ (cwbr @ XA2 @ XB2 @ cclt))))))).
