...
thf(ac0snghm_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XT @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => ((cwceq @ XZ @ (ccfv @ XT @ cc0g)) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XS @ ccgrp) @ (cwcel @ XT @ ccgrp) @ (cwceq @ XB2 @ (ccsn @ XZ))) @ (cwcel @ (XH @ Xx3) @ (cco @ XT @ XS @ ccghm))))))))))))))).
...
thf(arnglz_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccrng) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ Xc_0 @ XX @ Xc_x) @ Xc_0))))))))))).
...
thf(czrrnghm_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XT @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XS @ ccrng) @ (cwcel @ XT @ (ccdif @ ccrg @ ccnzr))) @ (cwcel @ (XH @ Xx3) @ (cco @ XT @ XS @ ccrngh))))))))))))).
