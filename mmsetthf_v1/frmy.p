...
thf(adf_rmy_ax,axiom,(cwceq @ ccrmy @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xn:$i] : (ccfv @ cc2 @ ccuz))) @ (^ [Xa:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xa:$i] : (^ [Xn:$i] : (ccfv @ (ccfv @ (cco @ (cco @ (ccv @ Xa) @ (ccfv @ (cco @ (cco @ (ccv @ Xa) @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ ccaddc) @ (ccv @ Xn) @ ccexp) @ (cccnv @ (ccmpt @ (^ [Xb:$i] : (ccxp @ ccn0 @ ccz)) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xb) @ cc1st) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xa) @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ (ccfv @ (ccv @ Xb) @ cc2nd) @ ccmul) @ ccaddc))))) @ cc2nd)))))).
thf(cfrmy_conj,conjecture,(cwf @ (ccxp @ (ccfv @ cc2 @ ccuz) @ ccz) @ ccz @ ccrmy)).
