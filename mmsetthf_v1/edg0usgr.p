...
thf(arelrn0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwb @ (cwceq @ XA2 @ cc0) @ (cwceq @ (ccrn @ XA2) @ cc0))))).
...
thf(cedg0usgr_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ XW) @ (cwceq @ (ccfv @ XG @ ccedg) @ cc0) @ (cwfun @ (ccfv @ XG @ cciedg))) @ (cwcel @ XG @ ccusgr))))).
