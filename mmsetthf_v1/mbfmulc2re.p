...
thf(ambfmulc2lem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => (cwi @ Xph @ (cwcel @ (cco @ (ccxp @ XA2 @ (ccsn @ XB2)) @ XF @ (ccof @ ccmul)) @ ccmbf)))))))))).
...
thf(cmbfmulc2re_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => (cwi @ Xph @ (cwcel @ (cco @ (ccxp @ XA2 @ (ccsn @ XB2)) @ XF @ (ccof @ ccmul)) @ ccmbf)))))))))).
