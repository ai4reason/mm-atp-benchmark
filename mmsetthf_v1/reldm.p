...
thf(areleldm2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwb @ (cwcel @ XB2 @ (ccdm @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cc1st) @ XB2)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(creldm_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwceq @ (ccdm @ XA2) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cc1st)))))))).
