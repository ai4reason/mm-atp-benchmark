...
thf(celcncf2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccc) @ (cwss @ XB2 @ ccc)) @ (cwb @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf)) @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccfv @ (cco @ (ccv @ Xw) @ (ccv @ Xx3) @ ccmin) @ ccabs) @ (ccv @ Xz) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : XA2))))))))).
