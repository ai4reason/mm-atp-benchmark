...
thf(aefcan_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ (ccfv @ XA2 @ cce) @ (ccfv @ (ccneg @ XA2) @ cce) @ ccmul) @ cc1)))).
thf(cefneg_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (ccneg @ XA2) @ cce) @ (cco @ cc1 @ (ccfv @ XA2 @ cce) @ ccdiv))))).
