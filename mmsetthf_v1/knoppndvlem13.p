...
thf(cknoppndvlem13_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (cwi @ Xph @ (cwne @ XC @ ccc0))))))))).
