...
thf(afo00_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwfo @ cc0 @ XA2 @ XF) @ (cwa @ (cwceq @ XF @ cc0) @ (cwceq @ XA2 @ cc0)))))).
...
thf(afprod_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccfv @ (ccv @ Xn) @ XF)) @ (cwceq @ (XB2 @ Xk) @ (XC @ Xn))))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwf1o @ (cco @ cc1 @ XM @ ccfz) @ XA2 @ XF)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XM @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XG) @ (XC @ Xn)))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccfv @ XM @ (ccseq @ ccmul @ XG @ cc1))))))))))))))))).
...
thf(aprodfc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwceq @ (ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))))) @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))))))).
