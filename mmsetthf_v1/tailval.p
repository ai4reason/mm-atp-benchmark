...
thf(ctailval_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwa @ (cwcel @ XD @ ccdir) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XD @ cctail)) @ (ccima @ XD @ (ccsn @ XA2))))))))).
