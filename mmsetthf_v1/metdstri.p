...
thf(axblpnf_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XA2 @ (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl))) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ (cco @ XP @ XA2 @ XD) @ ccr))))))))).
thf(cwer_tp,type,(cwer : (($i > $o) > (($i > $o) > $o)))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccec_tp,type,(ccec : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ablpnfctr_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XA2 @ (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)))) @ (cwceq @ (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)) @ (cco @ XA2 @ ccpnf @ (ccfv @ XD @ ccbl))))))))).
...
thf(anecon1bbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwb @ (cwne @ XA2 @ XB2) @ Xps)) => (cwi @ Xph @ (cwb @ (cwn @ Xps) @ (cwceq @ XA2 @ XB2))))))))).
...
thf(axbln0_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccxr)) @ (cwb @ (cwne @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ cc0) @ (cwbr @ ccc0 @ XR @ cclt)))))))).
thf(axposdif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ ccc0 @ (cco @ XB2 @ (ccxne @ XA2) @ ccxad) @ cclt)))))).
...
thf(axlesubadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cw3a @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwne @ XB2 @ ccmnf) @ (cwbr @ ccc0 @ XC @ ccle))) @ (cwb @ (cwbr @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ XC @ ccle) @ (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccxad) @ ccle))))))).
thf(axaddcom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccxad) @ (cco @ XB2 @ XA2 @ ccxad)))))).
thf(cmetdstri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) @ (cwbr @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ (cco @ (cco @ XA2 @ XB2 @ XD) @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1)) @ ccxad) @ ccle)))))))))))).
