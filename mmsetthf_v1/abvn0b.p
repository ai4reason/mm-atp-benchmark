...
thf(aabvdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccabv)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XF @ XA2) @ (cwa @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0)) @ (cwa @ (cwcel @ XY @ XB2) @ (cwne @ XY @ Xc_0))) @ (cwne @ (cco @ XX @ XY @ Xc_x) @ Xc_0))))))))))))))).
...
thf(cabvn0b_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccabv)) => (cwb @ (cwcel @ XR @ ccdomn) @ (cwa @ (cwcel @ XR @ ccnzr) @ (cwne @ XA2 @ cc0))))))).
