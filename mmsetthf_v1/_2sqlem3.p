...
thf(c_2sqlem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XN @ Xw) @ ccn))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XP @ Xw) @ ccprime))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XA2 @ Xw) @ ccz))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XB2 @ Xw) @ ccz))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XC @ Xw) @ ccz))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XD @ Xw) @ ccz))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwceq @ (cco @ (XN @ Xw) @ (XP @ Xw) @ ccmul) @ (cco @ (cco @ (XA2 @ Xw) @ cc2 @ ccexp) @ (cco @ (XB2 @ Xw) @ cc2 @ ccexp) @ ccaddc)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwceq @ (XP @ Xw) @ (cco @ (cco @ (XC @ Xw) @ cc2 @ ccexp) @ (cco @ (XD @ Xw) @ cc2 @ ccexp) @ ccaddc)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwbr @ (XP @ Xw) @ (cco @ (cco @ (XC @ Xw) @ (XB2 @ Xw) @ ccmul) @ (cco @ (XA2 @ Xw) @ (XD @ Xw) @ ccmul) @ ccaddc) @ ccdvds))) => (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XN @ Xw) @ (XS @ Xw))))))))))))))))))))))).
