...
thf(aclimsuselem1_thm,axiom,(! [Xph:$o] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XM @ XI) @ XZ)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XI) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XI) @ cc1 @ ccaddc) @ ccuz)))) => (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (XK @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (XK @ Xk) @ XI) @ (ccfv @ (XK @ Xk) @ ccuz)))))))))))))).
