...
thf(cgrporcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwcel @ XG @ ccgr) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwb @ (cwceq @ (cco @ XA2 @ XC @ XG) @ (cco @ XB2 @ XC @ XG)) @ (cwceq @ XA2 @ XB2)))))))))).
