...
thf(aelfzoext_thm,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XZ @ (cco @ XM @ XN @ ccfzo)) @ (cwcel @ XI @ ccn0)) @ (cwcel @ XZ @ (cco @ XM @ (cco @ XN @ XI @ ccaddc) @ ccfzo)))))))).
thf(afvexd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))))).
thf(cccatval1_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XS @ XT @ ccconcat)) @ (ccfv @ XI @ XS)))))))).
