...
thf(aimp4c_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ Xta)))) => (cwi @ Xph @ (cwi @ (cwa @ (cwa @ Xps @ Xch) @ Xth) @ Xta))))))))).
...
thf(aanabss1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xph) @ Xch) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(comordi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwcel @ cc0 @ XC)) @ (cwi @ (cwcel @ XA2 @ XB2) @ (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
