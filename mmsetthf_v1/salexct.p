...
thf(aunictb_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ ccom @ ccdom)) @ (^ [Xx3:$i] : XA2))) @ (cwbr @ (ccuni @ XA2) @ ccom @ ccdom)))).
...
thf(csalexct_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((cwceq @ XS @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ XA2)))) => (cwi @ Xph @ (cwcel @ XS @ ccsalg))))))))).
