...
thf(adf_drngo_ax,axiom,(cwceq @ ccdrng @ (ccopab @ (^ [Xg1:$i] : (^ [Xh:$i] : (cwa @ (cwcel @ (ccop @ (ccv @ Xg1) @ (ccv @ Xh)) @ ccrngo) @ (cwcel @ (ccres @ (ccv @ Xh) @ (ccxp @ (ccdif @ (ccrn @ (ccv @ Xg1)) @ (ccsn @ (ccfv @ (ccv @ Xg1) @ ccgi))) @ (ccdif @ (ccrn @ (ccv @ Xg1)) @ (ccsn @ (ccfv @ (ccv @ Xg1) @ ccgi))))) @ ccgr))))))).
...
thf(arngoablo2_thm,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwcel @ (ccop @ XG @ XH) @ ccrngo) @ (cwcel @ XG @ ccablo))))).
...
thf(cisdivrngo_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ XA2) @ (cwb @ (cwcel @ (ccop @ XG @ XH) @ ccdrng) @ (cwa @ (cwcel @ (ccop @ XG @ XH) @ ccrngo) @ (cwcel @ (ccres @ XH @ (ccxp @ (ccdif @ (ccrn @ XG) @ (ccsn @ (ccfv @ XG @ ccgi))) @ (ccdif @ (ccrn @ XG) @ (ccsn @ (ccfv @ XG @ ccgi))))) @ ccgr)))))))).
