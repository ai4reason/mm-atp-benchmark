...
thf(assdifeq0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwss @ XA2 @ (ccdif @ XB2 @ XA2)) @ (cwceq @ XA2 @ cc0))))).
...
thf(axrge0addge_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccxad) @ ccle))))).
...
thf(cpmeasmono_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwf @ XR @ (cco @ ccc0 @ ccpnf @ ccicc) @ XP)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XP) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwss @ (ccv @ Xx3) @ XR) @ (cwdisj @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccv @ Xy1))))) @ (cwceq @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XP) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XP)))))) => ((cwi @ Xph @ (cwcel @ XA2 @ XR)) => ((cwi @ Xph @ (cwcel @ XB2 @ XR)) => ((cwi @ Xph @ (cwcel @ (ccdif @ XB2 @ XA2) @ XR)) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => (cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ XP) @ (ccfv @ XB2 @ XP) @ ccle))))))))))))))).
