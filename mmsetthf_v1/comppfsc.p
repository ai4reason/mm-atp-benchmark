...
thf(afinptfin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XA2 @ ccptfin)))).
...
thf(aptfinfin_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccptfin) @ (cwcel @ XP @ XX)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XP @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ ccfn))))))).
...
thf(ccomppfsc_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwb @ (cwcel @ XJ @ cccmp) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwa @ (cwss @ (ccv @ Xd) @ (ccv @ Xc)) @ (cwceq @ XX @ (ccuni @ (ccv @ Xd))))) @ (^ [Xd:$i] : ccptfin)))) @ (^ [Xc:$i] : (ccpw @ XJ))))))))).
