...
thf(aipass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ Xc_xp @ (ccfv @ XF @ ccmulr)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ Xc_x) @ XC @ Xc_xi) @ (cco @ XA2 @ (cco @ XB2 @ XC @ Xc_xi) @ Xc_xp)))))))))))))))))))).
