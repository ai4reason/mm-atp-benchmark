...
thf(adf_fallfac_ax,axiom,(cwceq @ ccfallfac @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccmin)))))))).
...
thf(cfallfacval_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ XN @ ccfallfac) @ (ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccmin)))))))).
