...
thf(adf_umgr_ax,axiom,(cwceq @ ccumgr @ (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xe:$i] : (cwf @ (ccdm @ (ccv @ Xe)) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ (ccv @ Xv)) @ (ccsn @ cc0)))) @ (ccv @ Xe))) @ (ccfv @ (ccv @ Xg1) @ cciedg))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
...
thf(cisumgr_conj,conjecture,(! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : (cwi @ (cwcel @ XG @ (XU @ Xx3)) @ (cwb @ (cwcel @ XG @ ccumgr) @ (cwf @ (ccdm @ (XE @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)))) @ (XE @ Xx3)))))))))))).
