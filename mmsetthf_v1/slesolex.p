...
thf(amavmulcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ Xc_xp @ (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ XA2 @ ccbs))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XB2 @ XN @ ccmap))) => (cwi @ Xph @ (cwcel @ (cco @ XX @ XY @ Xc_xp) @ (cco @ XB2 @ XN @ ccmap))))))))))))))))))))).
