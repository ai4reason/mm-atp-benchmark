...
thf(aoddprmdvds_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccn) @ (cwn @ (cwrex @ (^ [Xn:$i] : (cwceq @ XK @ (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))) @ (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XK @ ccdvds)) @ (^ [Xp:$i] : (ccdif @ ccprime @ (ccsn @ cc2))))))).
...
thf(anndivides_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (ccv @ Xn) @ XM @ ccmul) @ XN)) @ (^ [Xn:$i] : ccn))))))).
...
thf(advdsnprmd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwbr @ cc1 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwbr @ XA2 @ XN @ cclt)) => ((cwi @ Xph @ (cwbr @ XA2 @ XN @ ccdvds)) => (cwi @ Xph @ (cwn @ (cwcel @ XN @ ccprime)))))))))).
...
thf(apwdif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccmin) @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (ccsu @ (cco @ ccc0 @ XN @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (cco @ XB2 @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccmin) @ ccexp) @ ccmul))) @ ccmul))))))).
...
thf(c_2pwp1prm_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccn) @ (cwcel @ (cco @ (cco @ cc2 @ XK @ ccexp) @ cc1 @ ccaddc) @ ccprime)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XK @ (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0))))).
