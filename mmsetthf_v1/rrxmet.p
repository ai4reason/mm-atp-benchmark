...
thf(arrxfsupp_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XF @ (XX @ Xh)))) => (! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ (cco @ XF @ ccc0 @ ccsupp) @ ccfn)))))))))).
...
thf(arrxsuppss_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XF @ (XX @ Xh)))) => (! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwss @ (cco @ XF @ ccc0 @ ccsupp) @ XI)))))))))).
...
thf(araldifeq_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ XB2))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ XB2 @ XA2))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))))))).
...
thf(atrirn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XC @ Xk) @ ccr))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ (cco @ (XB2 @ Xk) @ (XC @ Xk) @ ccaddc) @ cc2 @ ccexp))) @ ccsqrt) @ (cco @ (ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ cc2 @ ccexp))) @ ccsqrt) @ (ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ (XC @ Xk) @ cc2 @ ccexp))) @ ccsqrt) @ ccaddc) @ ccle)))))))))).
...
thf(asqsubswap_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc2 @ ccexp) @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ cc2 @ ccexp)))))).
thf(aeqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(arrxmetlem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : (! [Xk:$i] : (cwceq @ (XD @ Xh @ Xk) @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XI @ XV))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XF @ (XX @ Xh)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XG @ (XX @ Xh)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwss @ (XA2 @ Xh) @ XI))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ (XA2 @ Xh) @ ccfn))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwss @ (ccun @ (cco @ XF @ ccc0 @ ccsupp) @ (cco @ XG @ ccc0 @ ccsupp)) @ (XA2 @ Xh)))) => (! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwceq @ (ccsu @ (ccun @ (cco @ XF @ ccc0 @ ccsupp) @ (cco @ XG @ ccc0 @ ccsupp)) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin) @ cc2 @ ccexp))) @ (ccsu @ (XA2 @ Xh) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin) @ cc2 @ ccexp))))))))))))))))))))))).
...
thf(crrxmet_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XX @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : (cwceq @ (XD @ Xh) @ (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => (! [Xh:$i] : (cwi @ (cwcel @ XI @ XV) @ (cwcel @ (XD @ Xh) @ (ccfv @ (XX @ Xh) @ ccme))))))))))).
