...
thf(armxp1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmx) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ XA2 @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccaddc)))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(armxm1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmx) @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmin)))))).
...
thf(armspecnonsq_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (ccdif @ ccn @ ccsquarenn))))).
...
thf(crmxluc_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmx) @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmx) @ ccmin)))))).
