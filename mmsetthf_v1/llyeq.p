...
thf(adf_lly_ax,axiom,(! [XA2:($i > $o)] : (cwceq @ (cclly @ XA2) @ (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)) @ (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xu) @ ccrest) @ XA2))) @ (^ [Xu:$i] : (ccin @ (ccv @ Xj) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xj)))) @ (^ [Xj:$i] : cctop))))).
thf(cllyeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cclly @ XA2) @ (cclly @ XB2)))))).
