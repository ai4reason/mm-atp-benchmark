...
thf(asneqrg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwi @ (cwceq @ (ccsn @ XA2) @ (ccsn @ XB2)) @ (cwceq @ XA2 @ XB2))))))).
thf(caltopth2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwi @ (cwceq @ (ccaltop @ XA2 @ XB2) @ (ccaltop @ XC @ XD)) @ (cwceq @ XB2 @ XD))))))))).
