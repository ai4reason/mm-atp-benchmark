...
thf(arnpropg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (ccrn @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))) @ (ccpr @ XC @ XD)))))))))).
...
thf(adisjpr2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)) @ (cwa @ (cwne @ XA2 @ XD) @ (cwne @ XB2 @ XD))) @ (cwceq @ (ccin @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ cc0))))))).
