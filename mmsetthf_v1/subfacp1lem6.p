...
thf(asubfacp1lem5_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XD @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccfv @ (ccab @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (cwral @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))) @ cchash)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XS @ Xf1 @ Xg1) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (XD @ Xx3 @ Xy1 @ Xf1 @ Xg1))))))))) => ((cwceq @ XA2 @ (ccab @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccv @ Xf1)) @ (cwral @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xn) @ (cwcel @ XN @ ccn))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xn) @ (cwcel @ (XM @ Xn) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)))))) => ((! [Xn:$i] : (cwcel @ (XM @ Xn) @ ccvv)) => ((! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XK @ Xg1) @ (ccdif @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccsn @ (XM @ Xn)))))) => ((! [Xn:$i] : (cwceq @ (XB2 @ Xn) @ (ccrab @ (^ [Xg1:$i] : (cwa @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xg1)) @ (XM @ Xn)) @ (cwne @ (ccfv @ (XM @ Xn) @ (ccv @ Xg1)) @ cc1))) @ (^ [Xg1:$i] : XA2)))) => ((! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccun @ (ccres @ ccid @ (XK @ Xg1)) @ (ccpr @ (ccop @ cc1 @ (XM @ Xn)) @ (ccop @ (XM @ Xn) @ cc1)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XC @ Xf1 @ Xg1 @ Xn) @ (ccab @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccv @ Xf1)) @ (cwral @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)))))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xg1 @ Xn) @ (cwceq @ (ccfv @ (XB2 @ Xn) @ cchash) @ (ccfv @ XN @ (XS @ Xf1 @ Xg1)))))))))))))))))))))))))))).
