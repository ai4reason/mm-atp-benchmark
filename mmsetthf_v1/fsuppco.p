...
thf(acofunex2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwfun @ (cccnv @ XB2))) @ (cwcel @ (cccom @ XA2 @ XB2) @ ccvv)))))).
...
thf(afsuppcolem_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn)) => ((cwi @ Xph @ (cwf1 @ XX @ XY @ XG)) => (cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ (cccom @ XF @ XG)) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn))))))))))).
...
thf(cfsuppco_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp)) => ((cwi @ Xph @ (cwf1 @ XX @ XY @ XG)) => ((cwi @ Xph @ (cwcel @ XZ @ XW)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => (cwi @ Xph @ (cwbr @ (cccom @ XF @ XG) @ XZ @ ccfsupp))))))))))))))).
