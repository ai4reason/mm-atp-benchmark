...
thf(csaliincl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwbr @ XK @ ccom @ ccdom)) => ((cwi @ Xph @ (cwne @ XK @ cc0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XK)) @ (cwcel @ (XE @ Xk) @ XS))) => (cwi @ Xph @ (cwcel @ (cciin @ (^ [Xk:$i] : XK) @ (^ [Xk:$i] : (XE @ Xk))) @ XS))))))))))).
