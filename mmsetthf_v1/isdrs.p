...
thf(adf_drs_ax,axiom,(cwceq @ ccdrs @ (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xr:$i] : (cwa @ (cwne @ (ccv @ Xb) @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xr)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xr)))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb))))) @ (ccfv @ (ccv @ Xf1) @ ccple))) @ (ccfv @ (ccv @ Xf1) @ ccbs))) @ (^ [Xf1:$i] : ccpreset)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(cisdrs_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => (cwb @ (cwcel @ XK @ ccdrs) @ (cw3a @ (cwcel @ XK @ ccpreset) @ (cwne @ XB2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_le))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
