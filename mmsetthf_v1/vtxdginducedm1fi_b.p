...
thf(avtxdginducedm1_b_thm,axiom,(! [XP:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XV @ Xv @ Xi) @ (ccfv @ (XG @ Xv @ Xi) @ ccvtx)))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XE @ Xv) @ (ccfv @ (XG @ Xv @ Xi) @ cciedg)))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XK @ Xv @ Xi) @ (ccdif @ (XV @ Xv @ Xi) @ (ccsn @ (XN @ Xv)))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XI @ Xv @ Xi) @ (ccrab @ (^ [Xi:$i] : (cwnel @ (XN @ Xv) @ (ccfv @ (ccv @ Xi) @ (XE @ Xv)))) @ (^ [Xi:$i] : (ccdm @ (XE @ Xv))))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XP @ Xv @ Xi) @ (ccres @ (XE @ Xv) @ (XI @ Xv @ Xi))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XS @ Xv @ Xi) @ (ccop @ (XK @ Xv @ Xi) @ (XP @ Xv @ Xi))))) => ((! [Xv:$i] : (cwceq @ (XJ @ Xv) @ (ccrab @ (^ [Xi:$i] : (cwcel @ (XN @ Xv) @ (ccfv @ (ccv @ Xi) @ (XE @ Xv)))) @ (^ [Xi:$i] : (ccdm @ (XE @ Xv)))))) => (! [Xi:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ (XG @ Xv @ Xi) @ ccvtxdg)) @ (cco @ (ccfv @ (ccv @ Xv) @ (ccfv @ (XS @ Xv @ Xi) @ ccvtxdg)) @ (ccfv @ (ccrab @ (^ [Xi:$i] : (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xi) @ (XE @ Xv)))) @ (^ [Xi:$i] : (XJ @ Xv))) @ cchash) @ ccxad))) @ (^ [Xv:$i] : (ccdif @ (XV @ Xv @ Xi) @ (ccsn @ (XN @ Xv))))))))))))))))))))))).
...
thf(cvtxdginducedm1fi_b_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XV @ Xv @ Xi) @ (ccfv @ (XG @ Xv @ Xi) @ ccvtx)))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ XE @ (ccfv @ (XG @ Xv @ Xi) @ cciedg)))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XK @ Xv @ Xi) @ (ccdif @ (XV @ Xv @ Xi) @ (ccsn @ (XN @ Xv)))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XI @ Xv @ Xi) @ (ccrab @ (^ [Xi:$i] : (cwnel @ (XN @ Xv) @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE)))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XP @ Xv @ Xi) @ (ccres @ XE @ (XI @ Xv @ Xi))))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XS @ Xv @ Xi) @ (ccop @ (XK @ Xv @ Xi) @ (XP @ Xv @ Xi))))) => ((! [Xv:$i] : (cwceq @ (XJ @ Xv) @ (ccrab @ (^ [Xi:$i] : (cwcel @ (XN @ Xv) @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE))))) => (! [Xi:$i] : (cwi @ (cwcel @ XE @ ccfn) @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ (XG @ Xv @ Xi) @ ccvtxdg)) @ (cco @ (ccfv @ (ccv @ Xv) @ (ccfv @ (XS @ Xv @ Xi) @ ccvtxdg)) @ (ccfv @ (ccrab @ (^ [Xi:$i] : (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (XJ @ Xv))) @ cchash) @ ccaddc))) @ (^ [Xv:$i] : (ccdif @ (XV @ Xv @ Xi) @ (ccsn @ (XN @ Xv)))))))))))))))))))))))).
