...
thf(altrniotacnvval_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (cwceq @ (XF @ Xf1) @ (ccrio @ (^ [Xf1:$i] : (cwceq @ (ccfv @ XP @ (ccv @ Xf1)) @ XQ)) @ (^ [Xf1:$i] : XT)))) => (! [Xf1:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le)))) @ (cwceq @ (ccfv @ XQ @ (cccnv @ (XF @ Xf1))) @ XP)))))))))))))))))).
...
thf(cdihjatcclem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((! [Xd:$i] : (cwceq @ (Xc_or @ Xd) @ (ccfv @ XK @ ccjn))) => ((! [Xd:$i] : (cwceq @ (Xc_an @ Xd) @ (ccfv @ XK @ ccmee))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xd:$i] : (cwceq @ (XU @ Xd) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xd:$i] : (cwceq @ (Xc_po @ Xd) @ (ccfv @ (XU @ Xd) @ cclsm))) => ((! [Xd:$i] : (cwceq @ (XI @ Xd) @ (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((! [Xd:$i] : (cwceq @ (XV @ Xd) @ (cco @ (cco @ XP @ XQ @ (Xc_or @ Xd)) @ XW @ (Xc_an @ Xd)))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le))))) => ((cwceq @ XC @ (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xd:$i] : (cwceq @ (XR @ Xd) @ (ccfv @ XW @ (ccfv @ XK @ cctrl)))) => ((! [Xd:$i] : (cwceq @ (XE @ Xd) @ (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xd:$i] : (cwceq @ (XG @ Xd) @ (ccrio @ (^ [Xd:$i] : (cwceq @ (ccfv @ XC @ (ccv @ Xd)) @ XP)) @ (^ [Xd:$i] : XT)))) => ((! [Xd:$i] : (cwceq @ (XD @ Xd) @ (ccrio @ (^ [Xd:$i] : (cwceq @ (ccfv @ XC @ (ccv @ Xd)) @ XQ)) @ (^ [Xd:$i] : XT)))) => (! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwceq @ (ccfv @ (cccom @ (XG @ Xd) @ (cccnv @ (XD @ Xd))) @ (XR @ Xd)) @ (XV @ Xd))))))))))))))))))))))))))))))))))))))))))))).
