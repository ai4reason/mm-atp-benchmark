...
thf(ccrngoppr_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => ((cwceq @ Xc_xb @ (ccfv @ XO @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwceq @ (cco @ XX @ XY @ Xc_x) @ (cco @ XX @ XY @ Xc_xb))))))))))))))).
