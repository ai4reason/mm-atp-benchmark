...
thf(a_2lgslem1a2_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ ccz)) @ (cwb @ (cwbr @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ XI @ cclt) @ (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ (cco @ XI @ cc2 @ ccmul) @ cclt)))))).
thf(abreq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwbr @ XC @ XA2 @ XR) @ (cwbr @ XC @ XB2 @ XR)))))))))).
thf(asylan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ Xph @ Xch) @ Xth)))))))).
thf(ccrp_tp,type,(ccrp : ($i > $o))).
thf(a_2lgslem1a1_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccn) @ (cwn @ (cwbr @ cc2 @ XP @ ccdvds))) @ (cwral @ (^ [Xi:$i] : (cwceq @ (cco @ (ccv @ Xi) @ cc2 @ ccmul) @ (cco @ (cco @ (ccv @ Xi) @ cc2 @ ccmul) @ XP @ ccmo))) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))))).
