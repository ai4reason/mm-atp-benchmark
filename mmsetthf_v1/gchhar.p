...
thf(acdadom3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cccda) @ ccdom))))))).
...
thf(aharwdom_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwbr @ (ccfv @ XX @ cchar) @ (ccpw @ (ccxp @ XX @ XX)) @ ccwdom))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(awdompwdom_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwbr @ XX @ XY @ ccwdom) @ (cwbr @ (ccpw @ XX) @ (ccpw @ XY) @ ccdom))))).
thf(axpdom2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ XV) @ (cwbr @ XA2 @ XB2 @ ccdom)) @ (cwbr @ (ccxp @ XC @ XA2) @ (ccxp @ XC @ XB2) @ ccdom))))))).
...
thf(agchxpidm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
...
thf(agchcdaidm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwbr @ (cco @ XA2 @ XA2 @ cccda) @ XA2 @ ccen)))).
...
thf(agchen1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccsdm))) @ (cwbr @ XA2 @ XB2 @ ccen))))).
...
thf(agchen2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom))) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccen))))).
thf(aendom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwbr @ XA2 @ XB2 @ ccdom))))).
thf(apwcdadom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ (ccpw @ (cco @ XA2 @ XA2 @ cccda)) @ (cco @ XA2 @ XB2 @ cccda) @ ccdom) @ (cwbr @ (ccpw @ XA2) @ XB2 @ ccdom))))).
...
thf(cgchhar_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwcel @ XA2 @ ccgch) @ (cwcel @ (ccpw @ XA2) @ ccgch)) @ (cwbr @ (ccfv @ XA2 @ cchar) @ (ccpw @ XA2) @ ccen)))).
