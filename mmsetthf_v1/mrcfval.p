...
thf(adf_mrc_ax,axiom,(cwceq @ ccmrc @ (ccmpt @ (^ [Xc:$i] : (ccuni @ (ccrn @ ccmre))) @ (^ [Xc:$i] : (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xc)))) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xs1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccv @ Xc)))))))))).
thf(cwa_tp,type,(cwa : ($o > ($o > $o)))).
thf(asylancl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (Xch => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(asylbi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(amreunirn_thm,axiom,(! [XC:($i > $o)] : (cwb @ (cwcel @ XC @ (ccuni @ (ccrn @ ccmre))) @ (cwcel @ XC @ (ccfv @ (ccuni @ XC) @ ccmre))))).
...
thf(amreuni_thm,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwceq @ (ccuni @ XC) @ XX))))).
thf(cmrcfval_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xs1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : XC)))))))))))).
