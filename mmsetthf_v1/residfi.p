...
thf(aresfnfinfin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ ccfn)) @ (cwcel @ (ccres @ XF @ XB2) @ ccfn)))))).
thf(cresidfi_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ (ccres @ ccid @ XA2) @ ccfn) @ (cwcel @ XA2 @ ccfn)))).
