...
thf(cpsgnprfval_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccpr @ cc1 @ cc2)) => ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((! [Xw:$i] : (! [Xs1:$i] : (cwceq @ (XB2 @ Xw @ Xs1) @ (ccfv @ XG @ ccbs)))) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (! [Xw:$i] : (! [Xs1:$i] : (cwi @ (cwcel @ XX @ (XB2 @ Xw @ Xs1)) @ (cwceq @ (ccfv @ XX @ XN) @ (ccio @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ XX @ (cco @ XG @ (ccv @ Xw) @ ccgsu)) @ (cwceq @ (ccv @ Xs1) @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ XT))))))))))))))))))))).
