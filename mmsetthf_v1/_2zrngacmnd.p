...
thf(c_2zrngacmnd_conj,conjecture,(! [XR:($i > $o)] : (! [XE:($i > $o)] : ((cwceq @ XE @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))) => ((cwceq @ XR @ (cco @ cccnfld @ XE @ ccress)) => (cwcel @ XR @ cccmn)))))).
