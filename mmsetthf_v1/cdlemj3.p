...
thf(acdlemfnid_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccfv @ XK @ ccbs))) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (cwceq @ (XR @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ cctrl)))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XU @ XA2) @ (cwbr @ XU @ XW @ Xc_le))) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xf1) @ (XR @ Xf1)) @ XU) @ (cwne @ (ccv @ Xf1) @ (ccres @ ccid @ (XB2 @ Xf1))))) @ (^ [Xf1:$i] : XT))))))))))))))))))).
...
thf(acdlemj2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xg1:$i] : (! [Xh:$i] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ cctendo))) => (cwi @ (cw3a @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwcel @ XU @ XE) @ (cwcel @ XV @ XE) @ (cwceq @ (ccfv @ XF @ XU) @ (ccfv @ XF @ XV))) @ (cw3a @ (cwcel @ XF @ XT) @ (cwne @ XF @ (ccres @ ccid @ XB2)) @ (cwcel @ (ccv @ Xh) @ XT))) @ (cw3a @ (cwne @ (ccv @ Xh) @ (ccres @ ccid @ XB2)) @ (cwcel @ (ccv @ Xg1) @ XT) @ (cwne @ (ccv @ Xg1) @ (ccres @ ccid @ XB2))) @ (cwa @ (cwne @ (ccfv @ XF @ XR) @ (ccfv @ (ccv @ Xg1) @ XR)) @ (cwne @ (ccfv @ (ccv @ Xg1) @ XR) @ (ccfv @ (ccv @ Xh) @ XR)))) @ (cwceq @ (ccfv @ (ccv @ Xh) @ XU) @ (ccfv @ (ccv @ Xh) @ XV))))))))))))))))))))).
thf(ccdlemj3_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xh:$i] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ cctendo))) => (cwi @ (cwa @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwcel @ XU @ XE) @ (cwcel @ XV @ XE) @ (cwceq @ (ccfv @ XF @ XU) @ (ccfv @ XF @ XV))) @ (cw3a @ (cwcel @ XF @ XT) @ (cwne @ XF @ (ccres @ ccid @ XB2)) @ (cwcel @ (ccv @ Xh) @ XT))) @ (cwne @ (ccv @ Xh) @ (ccres @ ccid @ XB2))) @ (cwceq @ (ccfv @ (ccv @ Xh) @ XU) @ (ccfv @ (ccv @ Xh) @ XV)))))))))))))))))))).
