...
thf(cbrfvrcld_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ (ccfv @ XR @ ccrcl)) @ (cwo @ (cwbr @ XA2 @ XB2 @ (cco @ XR @ ccc0 @ ccrelexp)) @ (cwbr @ XA2 @ XB2 @ (cco @ XR @ cc1 @ ccrelexp))))))))))).
