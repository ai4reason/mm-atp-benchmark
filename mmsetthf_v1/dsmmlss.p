...
thf(adsmmsubg_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XH @ (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccgrp @ XR)) => (cwi @ Xph @ (cwcel @ XH @ (ccfv @ XP @ ccsubg))))))))))))))))).
...
thf(adsmmelbas_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xa:$i] : (cwceq @ (XP @ Xa) @ (cco @ XS @ XR @ ccprds))) => ((! [Xa:$i] : (cwceq @ (XC @ Xa) @ (cco @ XS @ XR @ ccdsmm))) => ((! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccfv @ (XP @ Xa) @ ccbs))) => ((! [Xa:$i] : (cwceq @ (XH @ Xa) @ (ccfv @ (XC @ Xa) @ ccbs))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XI @ (XV @ Xa)))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwfn @ XR @ XI))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwb @ (cwcel @ XX @ (XH @ Xa)) @ (cwa @ (cwcel @ XX @ (XB2 @ Xa)) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XX) @ (ccfv @ (ccfv @ (ccv @ Xa) @ XR) @ cc0g))) @ (^ [Xa:$i] : XI)) @ ccfn)))))))))))))))))))))).
...
thf(aprdsvscafval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccvsca)) => ((cwceq @ XK @ (ccfv @ XS @ ccbs)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwfn @ XR @ XI)) => ((cwi @ Xph @ (cwcel @ XF @ XK)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => ((cwi @ Xph @ (cwcel @ XJ @ XI)) => (cwi @ Xph @ (cwceq @ (ccfv @ XJ @ (cco @ XF @ XG @ Xc_x)) @ (cco @ XF @ (ccfv @ XJ @ XG) @ (ccfv @ (ccfv @ XJ @ XR) @ ccvsca)))))))))))))))))))))))))))).
...
thf(cdsmmlss_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XI @ (XW @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XS @ ccrg)) => ((cwi @ Xph @ (cwf @ XI @ cclmod @ XR)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccsca) @ XS))) => ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ XP @ cclss))) => ((cwceq @ XH @ (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XH @ (XU @ Xx3)))))))))))))))))))).
