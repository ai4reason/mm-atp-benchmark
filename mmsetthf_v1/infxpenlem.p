...
thf(aisoini_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwcel @ XD @ XA2)) @ (cwceq @ (ccima @ XH @ (ccin @ XA2 @ (ccima @ (cccnv @ XR) @ (ccsn @ XD)))) @ (ccin @ XB2 @ (ccima @ (cccnv @ XS) @ (ccsn @ (ccfv @ XD @ XH))))))))))))).
...
thf(aiscard_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2) @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(aelsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ (ccsuc @ XB2)) @ (cwo @ (cwcel @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2))))))).
...
thf(cinfxpenlem_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XL @ Xx3 @ Xy1 @ Xm @ Xa) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) @ (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) @ (cwo @ (cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XR @ Xx3 @ Xy1 @ Xz @ Xw @ Xm @ Xa) @ (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xz) @ (ccxp @ ccon0 @ ccon0)) @ (cwcel @ (ccv @ Xw) @ (ccxp @ ccon0 @ ccon0))) @ (cwo @ (cwcel @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) @ (cwa @ (cwceq @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XL @ Xx3 @ Xy1 @ Xm @ Xa))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XQ @ Xx3 @ Xy1 @ Xw @ Xm @ Xa) @ (ccin @ (XR @ Xx3 @ Xy1 @ Xz @ Xw @ Xm @ Xa) @ (ccxp @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwb @ (Xph @ Xx3 @ Xy1 @ Xm @ Xa) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ ccon0) @ (cwral @ (^ [Xm:$i] : (cwi @ (cwss @ ccom @ (ccv @ Xm)) @ (cwbr @ (ccxp @ (ccv @ Xm) @ (ccv @ Xm)) @ (ccv @ Xm) @ ccen))) @ (^ [Xm:$i] : (ccv @ Xa)))) @ (cwa @ (cwss @ ccom @ (ccv @ Xa)) @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xa) @ ccsdm)) @ (^ [Xm:$i] : (ccv @ Xa)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xa:$i] : (cwceq @ (XM @ Xx3 @ Xy1 @ Xw @ Xa) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XJ @ Xx3 @ Xy1 @ Xz @ Xm @ Xa) @ (ccoi @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ (XQ @ Xx3 @ Xy1 @ Xw @ Xm @ Xa))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xm:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm) @ ccon0) @ (cwss @ ccom @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm))) @ (cwbr @ (ccxp @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm) @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm)) @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xm) @ ccen))))))))))))))))))))).
