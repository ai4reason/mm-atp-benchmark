...
thf(clinepsubN_conj,conjecture,(! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XK @ cclines)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => (cwi @ (cwa @ (cwcel @ XK @ cclat) @ (cwcel @ XX @ XN)) @ (cwcel @ XX @ XS))))))))).
