...
thf(a_2lgslem3a_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XK @ ccn0) @ (cwceq @ XP @ (cco @ (cco @ cc8 @ XK @ ccmul) @ cc1 @ ccaddc))) @ (cwceq @ XN @ (cco @ cc2 @ XK @ ccmul)))))))).
...
thf(amulmod0_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ XA2 @ XM @ ccmul) @ XM @ ccmo) @ ccc0))))).
thf(c_2lgslem3a1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XP @ ccn) @ (cwceq @ (cco @ XP @ cc8 @ ccmo) @ cc1)) @ (cwceq @ (cco @ XN @ cc2 @ ccmo) @ ccc0)))))).
