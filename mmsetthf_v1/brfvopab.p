...
thf(cbrfvopab_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (XX @ Xy1 @ Xz) @ ccvv) @ (cwceq @ (ccfv @ (XX @ Xy1 @ Xz) @ (XF @ Xy1 @ Xz)) @ (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xy1 @ Xz)))))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwbr @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xy1 @ Xz) @ (ccfv @ (XX @ Xy1 @ Xz) @ (XF @ Xy1 @ Xz))) @ (cw3a @ (cwcel @ (XX @ Xy1 @ Xz) @ ccvv) @ (cwcel @ (XA2 @ Xy1 @ Xz) @ ccvv) @ (cwcel @ (XB2 @ Xy1 @ Xz) @ ccvv)))))))))))).
