...
thf(asumsns_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XM @ (XV @ Xk)) @ (cwcel @ (ccsb @ XM @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccc)) @ (cwceq @ (ccsu @ (ccsn @ XM) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsb @ XM @ (^ [Xk:$i] : (XA2 @ Xk)))))))))).
thf(cflcidc_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xj:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xj) @ (ccmpt @ (^ [Xj:$i] : XS) @ (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xj) @ XK) @ cc1 @ ccc0)))))) => ((cwi @ Xph @ (cwcel @ XS @ ccfn)) => ((cwi @ Xph @ (cwcel @ XK @ XS)) => ((! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ XS)) @ (cwcel @ (XB2 @ Xi) @ ccc))) => (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XS @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XF @ Xj)) @ (XB2 @ Xi) @ ccmul))) @ (ccsb @ XK @ (^ [Xi:$i] : (XB2 @ Xi)))))))))))))))).
