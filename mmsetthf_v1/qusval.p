...
thf(adf_qus_ax,axiom,(cwceq @ ccqus @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xe:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xe:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xe:$i] : (cco @ (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xr) @ ccbs)) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ (ccv @ Xe)))) @ (ccv @ Xr) @ ccimas)))))).
