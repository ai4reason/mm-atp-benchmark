...
thf(adf_asin_ax,axiom,(cwceq @ ccasin @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccneg @ cci) @ (ccfv @ (cco @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccaddc) @ cclog) @ ccmul))))).
...
thf(aeqsqrtor_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwb @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ XB2) @ (cwo @ (cwceq @ XA2 @ (ccfv @ XB2 @ ccsqrt)) @ (cwceq @ XA2 @ (ccneg @ (ccfv @ XB2 @ ccsqrt))))))))).
...
thf(advcnsqrt_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccsqrt))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccmul) @ ccdiv))))))).
...
thf(cdvasin_conj,conjecture,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => (cwceq @ (cco @ ccc @ (ccres @ ccasin @ XD) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))))).
