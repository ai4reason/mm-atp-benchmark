...
thf(cal3im_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwi @ (Xps @ Xx3) @ (cwi @ (Xch @ Xx3) @ (Xth @ Xx3)))))) @ (cwi @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwi @ (cwal @ (^ [Xx3:$i] : (Xps @ Xx3))) @ (cwi @ (cwal @ (^ [Xx3:$i] : (Xch @ Xx3))) @ (cwal @ (^ [Xx3:$i] : (Xth @ Xx3)))))))))))).
