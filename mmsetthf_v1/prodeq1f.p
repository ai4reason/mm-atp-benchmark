...
thf(cprodeq1f_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => (! [Xk:$i] : (cwi @ (cwceq @ (XA2 @ Xk) @ (XB2 @ Xk)) @ (cwceq @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccprod @ (^ [Xk:$i] : (XB2 @ Xk)) @ (^ [Xk:$i] : (XC @ Xk)))))))))))).
