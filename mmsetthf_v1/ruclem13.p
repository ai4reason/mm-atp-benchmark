...
thf(aruclem12_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm) @ (cwf @ ccn @ ccr @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm) @ (cwceq @ (XD @ Xx3 @ Xy1 @ Xm) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ ccr @ ccr))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccsb @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (^ [Xm:$i] : (ccif @ (cwbr @ (ccv @ Xm) @ (ccv @ Xy1) @ cclt) @ (ccop @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccv @ Xm)) @ (ccop @ (cco @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccaddc) @ cc2 @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ cc2nd))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (cwceq @ (XC @ Xx3 @ Xy1 @ Xm) @ (ccun @ (ccsn @ (ccop @ ccc0 @ (ccop @ ccc0 @ cc1))) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (cwceq @ XG @ (ccseq @ (XD @ Xx3 @ Xy1 @ Xm) @ (XC @ Xx3 @ Xy1 @ Xm) @ ccc0))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xm) @ (ccsup @ (ccrn @ (cccom @ cc1st @ XG)) @ ccr @ cclt))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xm) @ (cwcel @ (XS @ Xx3 @ Xy1 @ Xm) @ (ccdif @ ccr @ (ccrn @ XF))))))))))))))))))).
...
thf(cruclem13_conj,conjecture,(! [XF:($i > $o)] : (cwn @ (cwfo @ ccn @ ccr @ XF)))).
