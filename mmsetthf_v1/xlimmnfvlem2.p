...
thf(amnfnei_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ ccle @ ccordt)) @ (cwcel @ ccmnf @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ ccmnf @ (ccv @ Xx3) @ ccico) @ XA2)) @ (^ [Xx3:$i] : ccr))))).
...
thf(amnfled_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => (cwi @ Xph @ (cwbr @ ccmnf @ XA2 @ ccle)))))).
...
thf(cxlimmnfvlem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xj @ Xk)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ (XM @ Xx3 @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xx3) @ (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwf @ (XZ @ Xx3) @ ccxr @ XF))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xx3)))) @ (^ [Xx3:$i] : ccr))))) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwbr @ XF @ ccmnf @ cclsxlim))))))))))))))).
