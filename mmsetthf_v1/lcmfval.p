...
thf(adf_lcmf_ax,axiom,(cwceq @ cclcmf @ (ccmpt @ (^ [Xz:$i] : (ccpw @ ccz)) @ (^ [Xz:$i] : (ccif @ (cwcel @ ccc0 @ (ccv @ Xz)) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : (ccv @ Xz)))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
...
thf(clcmfval_conj,conjecture,(! [XZ:($i > $o)] : (cwi @ (cwa @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn)) @ (cwceq @ (ccfv @ XZ @ cclcmf) @ (ccif @ (cwcel @ ccc0 @ XZ) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XZ))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
