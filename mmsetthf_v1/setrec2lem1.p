...
thf(atz6_12_2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwn @ (cweu @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF)))) @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0))))).
thf(csetrec2lem1_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [Xa:$i] : (cwceq @ (ccfv @ (ccv @ Xa) @ (ccres @ (XF @ Xa) @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XF @ Xa)))))))) @ (ccfv @ (ccv @ Xa) @ (XF @ Xa)))))).
