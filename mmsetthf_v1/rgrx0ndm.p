...
thf(argrprcx_thm,axiom,(cwnel @ (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ (ccv @ Xg1) @ ccvtxdg)) @ ccc0)) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xg1) @ ccvtx))))) @ ccvv)).
...
thf(crgrx0ndm_conj,conjecture,(! [XR:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xg1:$i] : (! [Xk:$i] : (cwceq @ (XR @ Xv @ Xg1 @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccxnn0) @ (^ [Xk:$i] : (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ (ccv @ Xg1) @ ccvtxdg)) @ (ccv @ Xk))) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xg1) @ ccvtx))))))))))) => (! [Xv:$i] : (! [Xg1:$i] : (! [Xk:$i] : (cwnel @ ccc0 @ (ccdm @ (XR @ Xv @ Xg1 @ Xk))))))))).
