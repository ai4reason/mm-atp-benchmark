...
thf(afunopfvb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwcel @ XA2 @ (ccdm @ XF))) @ (cwb @ (cwceq @ (ccfv @ XA2 @ XF) @ XB2) @ (cwcel @ (ccop @ XA2 @ XB2) @ XF))))))).
...
thf(cf1eqcocnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwf1 @ XA2 @ XB2 @ XG)) @ (cwb @ (cwceq @ XF @ XG) @ (cwceq @ (cccom @ (cccnv @ XF) @ XG) @ (ccres @ ccid @ XA2))))))))).
