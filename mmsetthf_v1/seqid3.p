...
thf(cseqid3_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwceq @ (cco @ XZ @ XZ @ Xc_pl) @ XZ)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XZ))) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) @ XZ)))))))))))).
