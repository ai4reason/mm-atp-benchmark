...
thf(adf_fin4_ax,axiom,(cwceq @ ccfin4 @ (ccab @ (^ [Xx3:$i] : (cwn @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccen))))))))).
thf(cisfin4_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xy1)) @ (cwb @ (cwcel @ XA2 @ ccfin4) @ (cwn @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwpss @ (ccv @ Xy1) @ XA2) @ (cwbr @ (ccv @ Xy1) @ XA2 @ ccen))))))))))).
