...
thf(asdom1_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwbr @ XA2 @ cc1o @ ccsdm) @ (cwceq @ XA2 @ cc0)))).
...
thf(a_0frgp_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (ccfv @ cc0 @ ccfrgp)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwbr @ XB2 @ cc1o @ ccen)))))).
thf(ccc0_tp,type,(ccc0 : ($i > $o))).
thf(a_0cyg_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwbr @ XB2 @ cc1o @ ccen)) @ (cwcel @ XG @ cccyg)))))).
...
thf(aen1uniel_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwbr @ XS @ cc1o @ ccen) @ (cwcel @ (ccuni @ XS) @ XS)))).
...
thf(amulgghm2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ Xc_1 @ Xc_x))))) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XR @ ccgrp) @ (cwcel @ Xc_1 @ XB2)) @ (cwcel @ (XF @ Xn) @ (cco @ czring @ XR @ ccghm))))))))))))).
...
thf(acygabl_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ cccyg) @ (cwcel @ XG @ ccabl)))).
...
thf(afrgpnabl_thm,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XG @ (ccfv @ XI @ ccfrgp)) => (cwi @ (cwbr @ cc1o @ XI @ ccsdm) @ (cwn @ (cwcel @ XG @ ccabl))))))).
...
thf(afidomtri2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ ccfn)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwn @ (cwbr @ XB2 @ XA2 @ ccsdm)))))))).
thf(cfrgpcyg_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XG @ (ccfv @ XI @ ccfrgp)) => (cwb @ (cwbr @ XI @ cc1o @ ccdom) @ (cwcel @ XG @ cccyg)))))).
