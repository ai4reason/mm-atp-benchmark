...
thf(clpolconN_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XP @ (ccfv @ XW @ cclpoN)) => ((cwi @ Xph @ (cwcel @ XW @ XX)) => ((cwi @ Xph @ (cwcel @ Xc_pe @ XP)) => ((cwi @ Xph @ (cwss @ XX @ XV)) => ((cwi @ Xph @ (cwss @ XY @ XV)) => ((cwi @ Xph @ (cwss @ XX @ XY)) => (cwi @ Xph @ (cwss @ (ccfv @ XY @ Xc_pe) @ (ccfv @ XX @ Xc_pe)))))))))))))))))).
