...
thf(coddpwdcv_conj,conjecture,(! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwn @ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XJ @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ (ccv @ Xx3) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (XW @ Xz) @ (ccxp @ (XJ @ Xz) @ ccn0)) @ (cwceq @ (ccfv @ (XW @ Xz) @ (XF @ Xx3 @ Xy1 @ Xz)) @ (cco @ (cco @ cc2 @ (ccfv @ (XW @ Xz) @ cc2nd) @ ccexp) @ (ccfv @ (XW @ Xz) @ cc1st) @ ccmul)))))))))))).
