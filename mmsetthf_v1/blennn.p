...
thf(ablenn0_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ XV) @ (cwne @ XN @ ccc0)) @ (cwceq @ (ccfv @ XN @ ccblen) @ (cco @ (ccfv @ (cco @ cc2 @ (ccfv @ XN @ ccabs) @ cclogb) @ ccfl) @ cc1 @ ccaddc)))))).
...
thf(cblennn_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccblen) @ (cco @ (ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc))))).
