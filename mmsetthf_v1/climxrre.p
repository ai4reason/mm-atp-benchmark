...
thf(aclimxrrelem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ ccxr @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ ccli)) => ((cwi @ Xph @ (cwcel @ XD @ ccrp)) => ((cwi @ (cwa @ Xph @ (cwcel @ ccpnf @ ccc)) @ (cwbr @ XD @ (ccfv @ (cco @ ccpnf @ XA2 @ ccmin) @ ccabs) @ ccle)) => ((cwi @ (cwa @ Xph @ (cwcel @ ccmnf @ ccc)) @ (cwbr @ XD @ (ccfv @ (cco @ ccmnf @ XA2 @ ccmin) @ ccabs) @ ccle)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwf @ (ccfv @ (ccv @ Xj) @ ccuz) @ ccr @ (ccres @ XF @ (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))))))))))))))))).
...
thf(amin1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XA2 @ XB2) @ XA2 @ ccle)))))))).
thf(arpred_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => (cwi @ Xph @ (cwcel @ XA2 @ ccr)))))).
thf(amin2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XA2 @ XB2) @ XB2 @ ccle)))))))).
...
thf(cclimxrre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ ccxr @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ ccli)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwf @ (ccfv @ (ccv @ Xj) @ ccuz) @ ccr @ (ccres @ XF @ (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))).
