...
thf(calxfr_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwal @ (^ [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ (XB2 @ Xx3 @ Xy1)))) @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1))))))) @ (cwb @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwal @ (^ [Xy1:$i] : (Xps @ Xy1)))))))))))).
