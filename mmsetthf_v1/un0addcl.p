...
thf(cun0addcl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwceq @ XT @ (ccun @ XS @ (ccsn @ ccc0))) => ((cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XM @ XS) @ (cwcel @ XN @ XS))) @ (cwcel @ (cco @ XM @ XN @ ccaddc) @ XS)) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XM @ XT) @ (cwcel @ XN @ XT))) @ (cwcel @ (cco @ XM @ XN @ ccaddc) @ XT))))))))))).
