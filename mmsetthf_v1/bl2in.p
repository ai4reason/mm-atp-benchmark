...
thf(cbl2in_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ XP @ XX) @ (cwcel @ XQ @ XX)) @ (cwa @ (cwcel @ XR @ ccr) @ (cwbr @ XR @ (cco @ (cco @ XP @ XQ @ XD) @ cc2 @ ccdiv) @ ccle))) @ (cwceq @ (ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XR @ (ccfv @ XD @ ccbl))) @ cc0)))))))).
