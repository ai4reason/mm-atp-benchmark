...
thf(cfourierdlem58_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xs1:$i] : (cwceq @ (XK @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : XA2) @ (^ [Xs1:$i] : (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ XA2))) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg))) => (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (cco @ ccr @ (XK @ Xs1) @ ccdv) @ (cco @ XA2 @ ccr @ cccncf)))))))))))).
