...
thf(afilconn_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ (ccun @ XF @ (ccsn @ cc0)) @ ccconn))))).
...
thf(cufildr_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccun @ XF @ (ccsn @ cc0))) => (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwceq @ (ccun @ XJ @ (ccfv @ XJ @ cccld)) @ (ccpw @ XX)))))))).
