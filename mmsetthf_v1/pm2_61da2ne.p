...
thf(cpm2_61da2ne_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ (cwa @ Xph @ (cwceq @ XA2 @ XB2)) @ Xps) => ((cwi @ (cwa @ Xph @ (cwceq @ XC @ XD)) @ Xps) => ((cwi @ (cwa @ Xph @ (cwa @ (cwne @ XA2 @ XB2) @ (cwne @ XC @ XD))) @ Xps) => (cwi @ Xph @ Xps))))))))))).
