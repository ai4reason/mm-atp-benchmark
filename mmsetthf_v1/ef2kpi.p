...
thf(aef2pi_thm,axiom,(cwceq @ (ccfv @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ cce) @ cc1)).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(a_1exp_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (cco @ cc1 @ XN @ ccexp) @ cc1)))).
thf(cef2kpi_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ XK @ ccmul) @ cce) @ cc1)))).
