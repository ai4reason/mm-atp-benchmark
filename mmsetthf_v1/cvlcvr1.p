...
thf(acvrval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_lt:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xz:$i] : (cwceq @ (Xc_le @ Xz) @ (ccfv @ XK @ ccple))) => ((! [Xz:$i] : (cwceq @ (Xc_lt @ Xz) @ (ccfv @ XK @ ccplt))) => ((! [Xz:$i] : (cwceq @ (XC @ Xz) @ (ccfv @ XK @ cccvr))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XK @ XA2) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwbr @ XX @ XY @ (XC @ Xz)) @ (cwa @ (cwbr @ XX @ XY @ (Xc_lt @ Xz)) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (cwbr @ XX @ (ccv @ Xz) @ (Xc_lt @ Xz)) @ (cwbr @ (ccv @ Xz) @ XY @ (Xc_le @ Xz))) @ (cwceq @ (ccv @ Xz) @ XY))) @ (^ [Xz:$i] : XB2))))))))))))))))))).
