...
thf(axrmaxeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XB2 @ XA2 @ ccle)) @ (cwceq @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XB2 @ XA2) @ XA2))))).
...
thf(cmax0sub_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (cco @ (ccif @ (cwbr @ ccc0 @ XA2 @ ccle) @ XA2 @ ccc0) @ (ccif @ (cwbr @ ccc0 @ (ccneg @ XA2) @ ccle) @ (ccneg @ XA2) @ ccc0) @ ccmin) @ XA2)))).
