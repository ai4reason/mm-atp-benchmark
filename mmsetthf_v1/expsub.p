...
thf(aexpnegz_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (ccneg @ XN) @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccdiv)))))).
...
thf(cexpsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz))) @ (cwceq @ (cco @ XA2 @ (cco @ XM @ XN @ ccmin) @ ccexp) @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccdiv))))))).
