...
thf(coneqmini_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XB2 @ ccon0) @ (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XA2))) @ (cwceq @ XA2 @ (ccint @ XB2))))))).
