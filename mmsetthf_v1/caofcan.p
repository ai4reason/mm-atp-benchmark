...
thf(ccaofcan_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz) @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XT @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XS @ XG))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XS @ XH))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XT) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwcel @ (ccv @ Xz) @ XS))) @ (cwb @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XR)) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz))))))) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XF @ XG @ (ccof @ XR)) @ (cco @ XF @ XH @ (ccof @ XR))) @ (cwceq @ XG @ XH)))))))))))))))))).
