...
thf(asge0pnffigt_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ ccpnf)) => ((cwi @ Xph @ (cwcel @ XY @ ccr)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwbr @ XY @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ cclt)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
...
thf(comeiunltfirp_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((! [Xz:$i] : (cwceq @ (XX @ Xz) @ (ccuni @ (ccdm @ XO)))) => ((! [Xz:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xz @ Xn) @ ccuz)))) => ((! [Xz:$i] : (cwi @ Xph @ (cwf @ XZ @ (ccpw @ (XX @ Xz)) @ XE))) => ((cwi @ Xph @ (cwcel @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XO) @ ccr)) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XY @ Xn) @ ccrp))) => (! [Xn:$i] : (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XO) @ (cco @ (ccsu @ (ccv @ Xz) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XO))) @ (XY @ Xn) @ ccaddc) @ cclt)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XZ) @ ccfn))))))))))))))))))).
