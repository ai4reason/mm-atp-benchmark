...
thf(adfconngr1_thm,axiom,(cwceq @ ccconngr @ (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ (ccfv @ (ccv @ Xg1) @ ccpthson)))))))) @ (^ [Xn:$i] : (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : (ccv @ Xv)))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
