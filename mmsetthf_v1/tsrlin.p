...
thf(ctsrlin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cw3a @ (cwcel @ XR @ cctsr) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwo @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XB2 @ XA2 @ XR))))))))).
