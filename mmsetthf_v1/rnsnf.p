...
thf(crnsnf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ (ccsn @ XA2) @ XB2 @ XF)) => (cwi @ Xph @ (cwceq @ (ccrn @ XF) @ (ccsn @ (ccfv @ XA2 @ XF)))))))))))).
