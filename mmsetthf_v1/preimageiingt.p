...
thf(axrralrecnnge_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccr))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XB2 @ ccxr))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwral @ (^ [Xn:$i] : (cwbr @ (cco @ XA2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccmin) @ XB2 @ ccle)) @ (^ [Xn:$i] : ccn)))))))))))).
...
thf(cpreimageiingt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ ccr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XC @ Xx3) @ (XB2 @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cciin @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ (XC @ Xx3) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccmin) @ (XB2 @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
