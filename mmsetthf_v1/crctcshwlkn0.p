...
thf(acrctiswlk_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))).
...
thf(asyl2an23an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xth @ Xph) @ Xta) => ((cwi @ (cw3a @ Xps @ Xch @ Xta) @ Xet) => (cwi @ (cwa @ Xth @ Xph) @ Xet)))))))))))).
...
thf(acrctcshlem2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts))) => ((cwceq @ XN @ (ccfv @ XF @ cchash)) => ((cwi @ Xph @ (cwcel @ XS @ (cco @ ccc0 @ XN @ ccfzo))) => ((cwceq @ XH @ (cco @ XF @ XS @ cccsh)) => (cwi @ Xph @ (cwceq @ (ccfv @ XH @ cchash) @ XN)))))))))))))))))).
...
thf(acrctcshwlkn0lem7_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (cco @ cc1 @ XN @ ccfzo))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XQ @ Xx3 @ Xi) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ (XP @ Xj)) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ (XP @ Xj))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XH @ Xx3 @ Xi) @ (cco @ (XF @ Xx3 @ Xj) @ XS @ cccsh))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ XN @ (ccfv @ (XF @ Xx3 @ Xj) @ cchash)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3 @ Xj) @ (ccword @ (XA2 @ Xx3 @ Xi @ Xj))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwral @ (^ [Xi:$i] : (cwif @ (cwceq @ (ccfv @ (ccv @ Xi) @ (XP @ Xj)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XP @ Xj))) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3 @ Xj)) @ (XI @ Xx3)) @ (ccsn @ (ccfv @ (ccv @ Xi) @ (XP @ Xj)))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xi) @ (XP @ Xj)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XP @ Xj))) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3 @ Xj)) @ (XI @ Xx3))))) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfzo)))))) => ((! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (XP @ Xj)) @ (ccfv @ ccc0 @ (XP @ Xj))))) => (! [Xx3:$i] : (! [Xi:$i] : (cwi @ Xph @ (cwral @ (^ [Xj:$i] : (cwif @ (cwceq @ (ccfv @ (ccv @ Xj) @ (XQ @ Xx3 @ Xi)) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi))) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xj) @ (XH @ Xx3 @ Xi)) @ (XI @ Xx3)) @ (ccsn @ (ccfv @ (ccv @ Xj) @ (XQ @ Xx3 @ Xi)))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xj) @ (XQ @ Xx3 @ Xi)) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi))) @ (ccfv @ (ccfv @ (ccv @ Xj) @ (XH @ Xx3 @ Xi)) @ (XI @ Xx3))))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfzo))))))))))))))))))))))).
thf(asimplbi2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ (cwa @ Xps @ Xch)) => (cwi @ Xps @ (cwi @ Xch @ Xph))))))).
thf(afzo1fzo0n0_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfzo)) @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwne @ XK @ ccc0)))))).
...
thf(awkslem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwif @ (cwceq @ (ccfv @ XA2 @ XP) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ XF) @ XI) @ (ccsn @ (ccfv @ XA2 @ XP))) @ (cwss @ (ccpr @ (ccfv @ XA2 @ XP) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ XA2 @ XF) @ XI))) @ (cwif @ (cwceq @ (ccfv @ XB2 @ XP) @ (ccfv @ (cco @ XB2 @ cc1 @ ccaddc) @ XP)) @ (cwceq @ (ccfv @ (ccfv @ XB2 @ XF) @ XI) @ (ccsn @ (ccfv @ XB2 @ XP))) @ (cwss @ (ccpr @ (ccfv @ XB2 @ XP) @ (ccfv @ (cco @ XB2 @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ XB2 @ XF) @ XI))))))))))).
thf(aad2antrl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xch @ (cwa @ Xph @ Xth)) @ Xps))))))).
thf(acrctprop_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts)) @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) @ (cwceq @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP)))))))).
...
thf(acrctcshlem3_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (XF @ Xx3) @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ cccrcts)))) => ((! [Xx3:$i] : (cwceq @ XN @ (ccfv @ (XF @ Xx3) @ cchash))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XS @ Xx3) @ (cco @ ccc0 @ XN @ ccfzo)))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (cco @ (XF @ Xx3) @ (XS @ Xx3) @ cccsh))) => ((! [Xx3:$i] : (cwceq @ (XQ @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ (XS @ Xx3) @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ (XS @ Xx3) @ ccaddc) @ (XP @ Xx3)) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (XS @ Xx3) @ ccaddc) @ XN @ ccmin) @ (XP @ Xx3))))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cw3a @ (cwcel @ (XG @ Xx3) @ ccvv) @ (cwcel @ (XH @ Xx3) @ ccvv) @ (cwcel @ (XQ @ Xx3) @ ccvv)))))))))))))))))))))).
