...
thf(ametidss_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwss @ (ccfv @ XD @ ccmetid) @ (ccxp @ XX @ XX)))))).
...
thf(ametideq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwa @ (cwbr @ XA2 @ XB2 @ (ccfv @ XD @ ccmetid)) @ (cwbr @ XE @ XF @ (ccfv @ XD @ ccmetid)))) @ (cwceq @ (cco @ XA2 @ XE @ XD) @ (cco @ XB2 @ XF @ XD)))))))))).
...
thf(cpstmfval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XD @ ccmetid)) => (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ (ccec @ XA2 @ Xc_sm) @ (ccec @ XB2 @ Xc_sm) @ (ccfv @ XD @ ccpstm)) @ (cco @ XA2 @ XB2 @ XD)))))))))).
