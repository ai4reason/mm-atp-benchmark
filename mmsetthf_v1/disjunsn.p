...
thf(cdisjunsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XM) @ (cwceq @ (XB2 @ Xx3) @ XC))) => (cwi @ (cwa @ (cwcel @ XM @ XV) @ (cwn @ (cwcel @ XM @ XA2))) @ (cwb @ (cwdisj @ (^ [Xx3:$i] : (ccun @ XA2 @ (ccsn @ XM))) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwa @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwceq @ (ccin @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC) @ cc0))))))))))).
