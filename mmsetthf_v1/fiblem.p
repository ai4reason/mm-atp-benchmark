...
thf(cfiblem_conj,conjecture,(cwf @ (ccin @ (ccword @ ccn0) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ (ccs2 @ ccc0 @ cc1) @ cchash) @ ccuz))) @ ccn0 @ (ccmpt @ (^ [Xw:$i] : (ccin @ (ccword @ ccn0) @ (ccima @ (cccnv @ cchash) @ (ccfv @ cc2 @ ccuz)))) @ (^ [Xw:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1 @ ccmin) @ (ccv @ Xw)) @ ccaddc))))).
