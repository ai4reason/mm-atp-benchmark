...
thf(achjo_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwceq @ (cco @ XA2 @ (ccfv @ XA2 @ ccort) @ cchj) @ cchil)))).
thf(chstoc_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ cchst) @ (cwcel @ XA2 @ ccch)) @ (cwceq @ (cco @ (ccfv @ XA2 @ XS) @ (ccfv @ (ccfv @ XA2 @ ccort) @ XS) @ ccva) @ (ccfv @ cchil @ XS)))))).
