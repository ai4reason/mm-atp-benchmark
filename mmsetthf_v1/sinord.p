...
thf(csinord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)) @ (cwcel @ XB2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ cclt)))))).
