...
thf(aabslt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccabs) @ XB2 @ cclt) @ (cwa @ (cwbr @ (ccneg @ XB2) @ XA2 @ cclt) @ (cwbr @ XA2 @ XB2 @ cclt))))))).
...
thf(altsubadd2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ cclt) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cclt))))))).
thf(cabsdiflt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ cclt) @ (cwa @ (cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ cclt) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))).
