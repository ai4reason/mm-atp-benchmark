...
thf(afneer_thm,axiom,(! [Xc_sm:($i > $o)] : ((cwceq @ Xc_sm @ (ccin @ ccfne @ (cccnv @ ccfne))) => (cwer @ ccvv @ Xc_sm)))).
...
thf(ctopfneec_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ Xc_sm @ (ccin @ ccfne @ (cccnv @ ccfne))) => (cwi @ (cwcel @ XJ @ cctop) @ (cwb @ (cwcel @ XA2 @ (ccec @ XJ @ Xc_sm)) @ (cwceq @ (ccfv @ XA2 @ cctg) @ XJ)))))))).
