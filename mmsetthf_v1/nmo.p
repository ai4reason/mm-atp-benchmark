...
thf(cnmo_conj,conjecture,(! [Xph:($i > ($i > $o))] : ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => (! [Xy1:$i] : (cwb @ (cwn @ (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) @ (cwal @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)))))))))))).
