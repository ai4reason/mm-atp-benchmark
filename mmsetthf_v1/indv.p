...
thf(adf_ind_ax,axiom,(cwceq @ ccind @ (ccmpt @ (^ [Xo:$i] : ccvv) @ (^ [Xo:$i] : (ccmpt @ (^ [Xa:$i] : (ccpw @ (ccv @ Xo))) @ (^ [Xa:$i] : (ccmpt @ (^ [Xx3:$i] : (ccv @ Xo)) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) @ cc1 @ ccc0))))))))).
...
thf(cindv_conj,conjecture,(! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XO @ (XV @ Xx3)) @ (cwceq @ (ccfv @ XO @ ccind) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ XO)) @ (^ [Xa:$i] : (ccmpt @ (^ [Xx3:$i] : XO) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) @ cc1 @ ccc0))))))))))).
