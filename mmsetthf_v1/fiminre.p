...
thf(anegfi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ (ccrab @ (^ [Xn:$i] : (cwcel @ (ccneg @ (ccv @ Xn)) @ XA2)) @ (^ [Xn:$i] : ccr)) @ ccfn)))).
...
thf(cfiminre_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
