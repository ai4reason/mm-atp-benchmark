...
thf(anmcvfval_thm,axiom,(! [XU:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => (cwceq @ XN @ (ccfv @ XU @ cc2nd)))))).
...
thf(ccnnvnm_conj,conjecture,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwceq @ ccabs @ (ccfv @ XU @ ccnmcv))))).
