...
thf(cdoca2N_conj,conjecture,(! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((cwceq @ Xc_pe @ (ccfv @ XW @ (ccfv @ XK @ ccocaN))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XX @ (ccdm @ XI))) @ (cwceq @ (ccfv @ (ccfv @ (ccfv @ XX @ XI) @ Xc_pe) @ Xc_pe) @ (ccfv @ XX @ XI))))))))))))).
