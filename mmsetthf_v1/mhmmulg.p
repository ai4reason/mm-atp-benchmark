...
thf(cmhmmulg_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_xp @ (ccfv @ XH @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ (cco @ XN @ XX @ Xc_x) @ XF) @ (cco @ XN @ (ccfv @ XX @ XF) @ Xc_xp))))))))))))))).
