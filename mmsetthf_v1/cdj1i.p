...
thf(ccdj1i_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xv:$i] : (cwcel @ (XA2 @ Xv) @ ccsh)) => ((cwcel @ XB2 @ ccsh) => (! [Xv:$i] : (cwi @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwbr @ ccc0 @ (ccv @ Xw) @ cclt) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xv:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xy1) @ ccno) @ (ccfv @ (ccv @ Xv) @ ccno) @ ccaddc) @ (cco @ (ccv @ Xw) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xv) @ ccva) @ ccno) @ ccmul) @ ccle)) @ (^ [Xv:$i] : XB2))) @ (^ [Xy1:$i] : (XA2 @ Xv))))) @ (^ [Xw:$i] : ccr)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xy1) @ ccno) @ cc1) @ (cwbr @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmv) @ ccno) @ ccle))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : (XA2 @ Xv))))) @ (^ [Xx3:$i] : ccr))))))))).
