...
thf(ausgr0eop_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XV @ XW) @ (cwcel @ (ccop @ XV @ cc0) @ ccusgr))))).
...
thf(ausgr0edg0rusgr_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccusgr) @ (cwb @ (cwbr @ XG @ ccc0 @ ccrusgr) @ (cwceq @ (ccfv @ XG @ ccedg) @ cc0))))).
...
thf(crgrusgrprc_conj,conjecture,(cwnel @ (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ (ccv @ Xg1) @ ccvtxdg)) @ ccc0)) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xg1) @ ccvtx)))) @ (^ [Xg1:$i] : ccusgr)) @ ccvv)).
