...
thf(crecan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmul) @ ccre) @ (ccfv @ (cco @ (ccv @ Xx3) @ XB2 @ ccmul) @ ccre))) @ (^ [Xx3:$i] : ccc)) @ (cwceq @ XA2 @ XB2)))))).
