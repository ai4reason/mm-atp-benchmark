...
thf(awfrrel_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (ccwrecs @ XA2 @ XR @ XG)) => (cwrel @ XF))))))).
...
thf(cwfrfun_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((cwceq @ XF @ (ccwrecs @ XA2 @ XR @ XG)) => (cwfun @ XF))))))))).
