...
thf(arelcnvexb_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwrel @ XR) @ (cwb @ (cwcel @ XR @ ccvv) @ (cwcel @ (cccnv @ XR) @ ccvv))))).
thf(cf1oexrnex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwcel @ XB2 @ XV)) @ (cwcel @ XF @ ccvv))))))).
