...
thf(cspansnj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ ccph) @ (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ cchj)))))).
