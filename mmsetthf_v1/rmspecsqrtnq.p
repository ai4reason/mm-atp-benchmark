...
thf(anonsq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwa @ (cwbr @ (cco @ XB2 @ cc2 @ ccexp) @ XA2 @ cclt) @ (cwbr @ XA2 @ (cco @ (cco @ XB2 @ cc1 @ ccaddc) @ cc2 @ ccexp) @ cclt))) @ (cwn @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccq)))))).
thf(crmspecsqrtnq_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ (ccdif @ ccc @ ccq))))).
