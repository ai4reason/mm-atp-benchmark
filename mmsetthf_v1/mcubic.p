...
thf(adcubic_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccc)) => ((cwi @ Xph @ (cwcel @ XQ @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ XT @ cc3 @ ccexp) @ (cco @ (XG @ Xr) @ (XN @ Xr) @ ccmin)))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xr) @ ccc))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xr) @ cc2 @ ccexp) @ (cco @ (cco @ (XN @ Xr) @ cc2 @ ccexp) @ (cco @ XM @ cc3 @ ccexp) @ ccaddc)))) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ XP @ cc3 @ ccdiv))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (XN @ Xr) @ (cco @ XQ @ cc2 @ ccdiv)))) => ((cwi @ Xph @ (cwne @ XT @ ccc0)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ XP @ XX @ ccmul) @ XQ @ ccaddc) @ ccaddc) @ ccc0) @ (cwrex @ (^ [Xr:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xr) @ cc3 @ ccexp) @ cc1) @ (cwceq @ XX @ (cco @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ (cco @ XM @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ ccdiv) @ ccmin)))) @ (^ [Xr:$i] : ccc))))))))))))))))))))))).
...
thf(abinom3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc3 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ (cco @ cc3 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ cc3 @ (cco @ XA2 @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmul) @ (cco @ XB2 @ cc3 @ ccexp) @ ccaddc) @ ccaddc)))))).
...
thf(cmcubic_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xr) @ ccc))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XD @ Xr) @ ccc))) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ XT @ cc3 @ ccexp) @ (cco @ (cco @ XN @ (XG @ Xr) @ ccaddc) @ cc2 @ ccdiv)))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xr) @ ccc))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xr) @ cc2 @ ccexp) @ (cco @ (cco @ XN @ cc2 @ ccexp) @ (cco @ cc4 @ (cco @ XM @ cc3 @ ccexp) @ ccmul) @ ccmin)))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ XM @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc3 @ (XC @ Xr) @ ccmul) @ ccmin)))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ XN @ (cco @ (cco @ (cco @ cc2 @ (cco @ XB2 @ cc3 @ ccexp) @ ccmul) @ (cco @ cc9 @ (cco @ XB2 @ (XC @ Xr) @ ccmul) @ ccmul) @ ccmin) @ (cco @ (ccdc @ cc2 @ cc7) @ (XD @ Xr) @ ccmul) @ ccaddc)))) => ((cwi @ Xph @ (cwne @ XT @ ccc0)) => (! [Xr:$i] : (cwi @ Xph @ (cwb @ (cwceq @ (cco @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ XB2 @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ (XC @ Xr) @ XX @ ccmul) @ (XD @ Xr) @ ccaddc) @ ccaddc) @ ccc0) @ (cwrex @ (^ [Xr:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xr) @ cc3 @ ccexp) @ cc1) @ (cwceq @ XX @ (ccneg @ (cco @ (cco @ (cco @ XB2 @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ ccaddc) @ (cco @ XM @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ ccdiv) @ ccaddc) @ cc3 @ ccdiv))))) @ (^ [Xr:$i] : ccc)))))))))))))))))))))))))).
