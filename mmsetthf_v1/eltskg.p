...
thf(adf_tsk_ax,axiom,(cwceq @ cctsk @ (ccab @ (^ [Xy1:$i] : (cwa @ (cwral @ (^ [Xz:$i] : (cwa @ (cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)) @ (cwrex @ (^ [Xw:$i] : (cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (cwral @ (^ [Xz:$i] : (cwo @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccen) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xy1))))))))).
thf(celtskg_conj,conjecture,(! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwcel @ XT @ (XV @ Xz @ Xw)) @ (cwb @ (cwcel @ XT @ cctsk) @ (cwa @ (cwral @ (^ [Xz:$i] : (cwa @ (cwss @ (ccpw @ (ccv @ Xz)) @ XT) @ (cwrex @ (^ [Xw:$i] : (cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xw))) @ (^ [Xw:$i] : XT)))) @ (^ [Xz:$i] : XT)) @ (cwral @ (^ [Xz:$i] : (cwo @ (cwbr @ (ccv @ Xz) @ XT @ ccen) @ (cwcel @ (ccv @ Xz) @ XT))) @ (^ [Xz:$i] : (ccpw @ XT))))))))))).
