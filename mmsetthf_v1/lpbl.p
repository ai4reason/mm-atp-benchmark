...
thf(clpbl_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX) @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cclp)))) @ (cwcel @ XR @ ccrp)) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)))) @ (^ [Xx3:$i] : XS))))))))))).
