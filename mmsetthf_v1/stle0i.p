...
thf(astge0_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ ccst) @ (cwi @ (cwcel @ XA2 @ ccch) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ XS) @ ccle)))))).
...
thf(cstle0i_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwcel @ XS @ ccst) @ (cwb @ (cwbr @ (ccfv @ XA2 @ XS) @ ccc0 @ ccle) @ (cwceq @ (ccfv @ XA2 @ XS) @ ccc0))))))).
