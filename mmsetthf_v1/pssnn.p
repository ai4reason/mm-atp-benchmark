...
thf(anpss0_thm,axiom,(! [XA2:($i > $o)] : (cwn @ (cwpss @ XA2 @ cc0)))).
...
thf(aim2anan9r_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xth @ (cwi @ Xta @ Xet)) => (cwi @ (cwa @ Xth @ Xph) @ (cwi @ (cwa @ Xps @ Xta) @ (cwa @ Xch @ Xet)))))))))))).
...
thf(aorddif_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwceq @ XA2 @ (ccdif @ (ccsuc @ XA2) @ (ccsn @ XA2)))))).
...
thf(aorddisj_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwceq @ (ccin @ XA2 @ (ccsn @ XA2)) @ cc0)))).
...
thf(aeqelsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwceq @ XA2 @ XB2) @ (cwcel @ XA2 @ (ccsuc @ XB2))))))).
...
thf(cpssnn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwpss @ XB2 @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccen)) @ (^ [Xx3:$i] : XA2)))))).
