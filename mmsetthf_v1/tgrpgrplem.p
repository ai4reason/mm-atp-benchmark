...
thf(atgrpbase_thm,axiom,(! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XG @ (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => ((cwceq @ XC @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XW @ XH)) @ (cwceq @ XC @ XT)))))))))))))).
...
thf(atgrpov_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XG @ (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XK @ XV) @ (cwcel @ XW @ XH) @ (cwa @ (cwcel @ XX @ XT) @ (cwcel @ XY @ XT))) @ (cwceq @ (cco @ XX @ XY @ Xc_pl) @ (cccom @ XX @ XY))))))))))))))))).
...
thf(ctgrpgrplem_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XG @ (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XG @ ccgrp))))))))))))))).
