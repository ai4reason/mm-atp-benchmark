...
thf(aicoltubd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) => (cwi @ Xph @ (cwbr @ XC @ XB2 @ cclt)))))))))).
...
thf(cicomnfinre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => (cwi @ Xph @ (cwceq @ (ccin @ (cco @ ccmnf @ XA2 @ ccico) @ ccr) @ (cco @ ccmnf @ XA2 @ ccioo))))))).
