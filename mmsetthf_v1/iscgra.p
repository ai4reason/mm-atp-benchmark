...
thf(ciscgra_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XK @ (ccfv @ XG @ cchlg)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwcel @ XE @ XP)) => ((cwi @ Xph @ (cwcel @ XF @ XP)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XD @ XE @ XF) @ (ccfv @ XG @ cccgra)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ (ccv @ Xx3) @ XE @ (ccv @ Xy1)) @ (ccfv @ XG @ cccgrg)) @ (cwbr @ (ccv @ Xx3) @ XD @ (ccfv @ XE @ XK)) @ (cwbr @ (ccv @ Xy1) @ XF @ (ccfv @ XE @ XK)))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))))))).
