...
thf(arngo0rid_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ XA2 @ XZ @ XG) @ XA2))))))))))).
...
thf(c_0idl_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwcel @ (ccsn @ XZ) @ (ccfv @ XR @ ccidl))))))))).
