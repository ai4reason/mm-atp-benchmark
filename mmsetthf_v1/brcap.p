...
thf(adf_cap_ax,axiom,(cwceq @ cccap @ (ccdif @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv) @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ (ccin @ (cccom @ (cccnv @ cc1st) @ ccep) @ (cccom @ (cccnv @ cc2nd) @ ccep)) @ ccvv)))))).
...
thf(cbrcap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwbr @ (ccop @ XA2 @ XB2) @ XC @ cccap) @ (cwceq @ XC @ (ccin @ XA2 @ XB2)))))))))).
