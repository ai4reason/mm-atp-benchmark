...
thf(astoweidlem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnf @ (^ [Xt:$i] : (Xph @ Xt))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XA2 @ Xt)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (cwi @ (cwa @ (Xph @ Xt) @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xx3))) @ (XA2 @ Xt))))) => ((! [Xt:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt))) @ (cwf @ XT @ ccr @ (ccv @ Xf1))))) => ((! [Xt:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XE @ Xg1) @ ccr)))) => ((! [Xx3:$i] : (! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XF @ Xx3) @ (XA2 @ Xt))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (XE @ Xg1) @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3)) @ ccmul))) @ (XA2 @ Xt)))))))))))))))))).
...
thf(cstoweidlem17_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((cwnf @ (^ [Xt:$i] : (Xph @ Xt))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (XN @ Xx3 @ Xf1 @ Xg1) @ ccn)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt) @ (cwf @ (cco @ ccc0 @ (XN @ Xx3 @ Xf1 @ Xg1) @ ccfz) @ (XA2 @ Xt @ Xi) @ (XX @ Xx3)))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt @ Xi))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt @ Xi))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt @ Xi))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XA2 @ Xt @ Xi))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt) @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xx3))) @ (XA2 @ Xt @ Xi)))))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XE @ ccr))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt @ Xi))) @ (cwf @ XT @ ccr @ (ccv @ Xf1)))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ (XN @ Xx3 @ Xf1 @ Xg1) @ ccfz) @ (^ [Xi:$i] : (cco @ XE @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xx3))) @ ccmul))))) @ (XA2 @ Xt @ Xi))))))))))))))))))))))).
