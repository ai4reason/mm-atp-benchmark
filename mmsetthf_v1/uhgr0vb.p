...
thf(auhgr0e_thm,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XG @ XW)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ cc0)) => (cwi @ Xph @ (cwcel @ XG @ ccuhgr)))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(cuhgr0vb_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwceq @ (ccfv @ XG @ ccvtx) @ cc0)) @ (cwb @ (cwcel @ XG @ ccuhgr) @ (cwceq @ (ccfv @ XG @ cciedg) @ cc0)))))).
