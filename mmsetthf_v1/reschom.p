...
thf(creschom_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XD @ (cco @ XC @ XH @ ccresc)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS))) => ((cwi @ Xph @ (cwss @ XS @ XB2)) => (cwi @ Xph @ (cwceq @ XH @ (ccfv @ XD @ cchom)))))))))))))))).
