...
thf(anormsub0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwb @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ ccc0) @ (cwceq @ XA2 @ XB2))))))).
thf(aifhvhv0_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XA2 @ cchil) @ XA2 @ cc0v) @ cchil))).
thf(cnormsub0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ ccc0) @ (cwceq @ XA2 @ XB2)))))).
