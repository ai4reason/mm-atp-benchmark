...
thf(ccflem_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : XA2)))))))))))))))).
