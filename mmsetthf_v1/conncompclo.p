...
thf(aconnsubclo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ Xph @ (cwss @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn)) => ((cwi @ Xph @ (cwcel @ XB2 @ XJ)) => ((cwi @ Xph @ (cwne @ (ccin @ XB2 @ XA2) @ cc0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XJ @ cccld))) => (cwi @ Xph @ (cwss @ XA2 @ XB2)))))))))))))).
...
thf(aconncompcld_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccuni @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xx3)) @ (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccconn))) @ (^ [Xx3:$i] : (ccpw @ XX)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XA2 @ XX)) @ (cwcel @ (XS @ Xx3) @ (ccfv @ XJ @ cccld)))))))))).
...
thf(cconncompclo_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccuni @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xx3)) @ (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccconn))) @ (^ [Xx3:$i] : (ccpw @ XX)))))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ (XT @ Xx3) @ (ccin @ XJ @ (ccfv @ XJ @ cccld))) @ (cwcel @ XA2 @ (XT @ Xx3))) @ (cwss @ (XS @ Xx3) @ (XT @ Xx3))))))))))).
