...
thf(cdivmulzi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => (cwi @ (cwne @ XB2 @ ccc0) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ XC) @ (cwceq @ (cco @ XB2 @ XC @ ccmul) @ XA2)))))))))).
