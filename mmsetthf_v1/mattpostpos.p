...
thf(atpostpos2_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwa @ (cwrel @ XF) @ (cwrel @ (ccdm @ XF))) @ (cwceq @ (cctpos @ (cctpos @ XF)) @ XF)))).
thf(cmattpostpos_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => (cwi @ (cwcel @ XM @ XB2) @ (cwceq @ (cctpos @ (cctpos @ XM)) @ XM)))))))))).
