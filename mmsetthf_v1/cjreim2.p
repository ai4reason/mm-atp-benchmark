...
thf(ccjreim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccmin) @ cccj) @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc)))))).
