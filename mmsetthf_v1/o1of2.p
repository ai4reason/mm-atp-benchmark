...
thf(ao1bdd_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ cco1) @ (cwf @ XA2 @ ccc @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xm) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))).
...
thf(co1of2_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xm) @ ccr) @ (cwcel @ (ccv @ Xn) @ ccr)) @ (cwcel @ (XM @ Xm @ Xn) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ ccc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccv @ Xm) @ ccr) @ (cwcel @ (ccv @ Xn) @ ccr)) @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc))) @ (cwi @ (cwa @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ (ccv @ Xm) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xy1) @ ccabs) @ (ccv @ Xn) @ ccle)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ ccabs) @ (XM @ Xm @ Xn) @ ccle))))))) => (cwi @ (cwa @ (cwcel @ XF @ cco1) @ (cwcel @ XG @ cco1)) @ (cwcel @ (cco @ XF @ XG @ (ccof @ XR)) @ cco1)))))))))).
