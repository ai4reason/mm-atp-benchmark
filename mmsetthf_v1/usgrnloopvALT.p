...
thf(afvfundmfvn0_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwne @ (ccfv @ XA2 @ XF) @ cc0) @ (cwa @ (cwcel @ XA2 @ (ccdm @ XF)) @ (cwfun @ (ccres @ XF @ (ccsn @ XA2)))))))).
...
thf(ausgredg2_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwceq @ (ccfv @ (ccfv @ XX @ XE) @ cchash) @ cc2))))))).
...
thf(cusgrnloopvALT_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XM @ XW)) @ (cwi @ (cwceq @ (ccfv @ XX @ XE) @ (ccpr @ XM @ XN)) @ (cwne @ XM @ XN))))))))))).
