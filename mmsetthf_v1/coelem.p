...
thf(ccoelem_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwcel @ XF @ (ccfv @ (XS @ Xz @ Xk) @ ccply)) @ (cwa @ (cwcel @ (ccfv @ XF @ cccoe) @ (cco @ ccc @ ccn0 @ ccmap)) @ (cwrex @ (^ [Xn:$i] : (cwa @ (cwceq @ (ccima @ (ccfv @ XF @ cccoe) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0)) @ (cwceq @ XF @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ XF @ cccoe)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))) @ (^ [Xn:$i] : ccn0))))))))).
