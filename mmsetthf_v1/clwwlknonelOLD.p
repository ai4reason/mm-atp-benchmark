...
thf(aisclwwlknonOLD_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) @ (cwa @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) @ (cwceq @ (ccfv @ ccc0 @ XW) @ XX))))))))))).
...
thf(cclwwlknonelOLD_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XV @ Xi) @ (ccfv @ XG @ ccvtx))) => ((! [Xi:$i] : (cwceq @ (XE @ Xi) @ (ccfv @ XG @ ccedg))) => (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ (XX @ Xi) @ (XV @ Xi)) @ (cwcel @ (XN @ Xi) @ ccn)) @ (cwb @ (cwcel @ XW @ (cco @ (XX @ Xi) @ (XN @ Xi) @ (ccfv @ XG @ ccclwwlknon))) @ (cw3a @ (cw3a @ (cwcel @ XW @ (ccword @ (XV @ Xi))) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XW)) @ (XE @ Xi))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW)) @ (XE @ Xi))) @ (cwceq @ (ccfv @ XW @ cchash) @ (XN @ Xi)) @ (cwceq @ (ccfv @ ccc0 @ XW) @ (XX @ Xi))))))))))))))).
