...
thf(axrge0infssd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwss @ XC @ XB2)) => ((cwi @ Xph @ (cwss @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (cwi @ Xph @ (cwbr @ (ccinf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ (ccinf @ XC @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ ccle)))))))).
...
thf(comsmon_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccoms)) => ((cwi @ Xph @ (cwcel @ XQ @ XV)) => ((cwi @ Xph @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwss @ XB2 @ (ccuni @ XQ))) => (cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccle))))))))))))))).
