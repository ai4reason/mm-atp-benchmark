...
thf(cshocel_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ ccsh) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XH @ ccort)) @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccsp) @ ccc0)) @ (^ [Xx3:$i] : XH)))))))).
