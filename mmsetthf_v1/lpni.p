...
thf(atncp_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xl:$i] : (cwceq @ (XP @ Xl) @ (ccuni @ XG))) => (! [Xl:$i] : (cwi @ (cwcel @ XG @ ccplig) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xl:$i] : (cwn @ (cw3a @ (cwcel @ (ccv @ Xa) @ (ccv @ Xl)) @ (cwcel @ (ccv @ Xb) @ (ccv @ Xl)) @ (cwcel @ (ccv @ Xc) @ (ccv @ Xl))))) @ (^ [Xl:$i] : XG))) @ (^ [Xc:$i] : (XP @ Xl)))) @ (^ [Xb:$i] : (XP @ Xl)))) @ (^ [Xa:$i] : (XP @ Xl))))))))).
...
thf(a_3jaao_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xth @ (cwi @ Xta @ Xch)) => ((cwi @ Xet @ (cwi @ Xze @ Xch)) => (cwi @ (cw3a @ Xph @ Xth @ Xet) @ (cwi @ (cw3o @ Xps @ Xta @ Xze) @ Xch))))))))))))).
...
thf(clpni_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XP @ (ccuni @ XG)) => (cwi @ (cwa @ (cwcel @ XG @ ccplig) @ (cwcel @ XL @ XG)) @ (cwrex @ (^ [Xa:$i] : (cwnel @ (ccv @ Xa) @ XL)) @ (^ [Xa:$i] : XP)))))))).
