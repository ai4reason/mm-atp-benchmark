...
thf(cchmatval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XY @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XT @ (cco @ XN @ XR @ ccmat2pmat)) => ((cwceq @ Xc_mi @ (ccfv @ XY @ ccsg)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccvsca)) => ((cwceq @ Xc_1 @ (ccfv @ XY @ ccur)) => ((cwceq @ XH @ (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (ccfv @ XM @ XT) @ Xc_mi)) => ((cwceq @ Xc_sm @ (ccfv @ XP @ ccsg)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) @ (cwa @ (cwcel @ XI @ XN) @ (cwcel @ XJ @ XN))) @ (cwceq @ (cco @ XI @ XJ @ XH) @ (ccif @ (cwceq @ XI @ XJ) @ (cco @ XX @ (cco @ XI @ XJ @ (ccfv @ XM @ XT)) @ Xc_sm) @ (cco @ Xc_0 @ (cco @ XI @ XJ @ (ccfv @ XM @ XT)) @ Xc_sm)))))))))))))))))))))))))))))))))).
