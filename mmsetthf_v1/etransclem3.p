...
thf(cetransclem3_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccn)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ ccc0 @ XN @ ccfz) @ XC)) => ((cwi @ Xph @ (cwcel @ XJ @ (cco @ ccc0 @ XM @ ccfz))) => ((cwi @ Xph @ (cwcel @ XK @ ccz)) => (cwi @ Xph @ (cwcel @ (ccif @ (cwbr @ XP @ (ccfv @ XJ @ XC) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ XP @ ccfa) @ (ccfv @ (cco @ XP @ (ccfv @ XJ @ XC) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ XK @ XJ @ ccmin) @ (cco @ XP @ (ccfv @ XJ @ XC) @ ccmin) @ ccexp) @ ccmul)) @ ccz)))))))))))))).
