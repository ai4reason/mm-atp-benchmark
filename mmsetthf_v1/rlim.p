...
thf(crlim_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3 @ Xy1) @ ccc @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xx3 @ Xy1) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ (XA2 @ Xx3 @ Xy1))) @ (cwceq @ (ccfv @ (ccv @ Xz) @ XF) @ (XB2 @ Xx3 @ Xy1 @ Xz)))))) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XC @ ccrli) @ (cwa @ (cwcel @ XC @ ccc) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccle) @ (cwbr @ (ccfv @ (cco @ (XB2 @ Xx3 @ Xy1 @ Xz) @ XC @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xz:$i] : (XA2 @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccrp)))))))))))))).
