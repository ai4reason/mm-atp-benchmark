...
thf(cpsgneldm_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwb @ (cwcel @ XP @ (ccdm @ XN)) @ (cwa @ (cwcel @ XP @ XB2) @ (cwcel @ (ccdm @ (ccdif @ XP @ ccid)) @ ccfn)))))))))))).
