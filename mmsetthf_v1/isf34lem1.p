...
thf(cisf34lem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwss @ (XX @ Xx3) @ XA2)) @ (cwceq @ (ccfv @ (XX @ Xx3) @ (XF @ Xx3)) @ (ccdif @ XA2 @ (XX @ Xx3))))))))))).
