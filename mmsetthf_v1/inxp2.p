...
thf(cinxp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwceq @ (ccin @ XR @ (ccxp @ XA2 @ XB2)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR)))))))))).
