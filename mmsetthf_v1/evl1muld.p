...
thf(cevl1muld_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XP @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwa @ (cwcel @ XM @ XU) @ (cwceq @ (ccfv @ XY @ (ccfv @ XM @ XO)) @ XV))) => ((cwi @ Xph @ (cwa @ (cwcel @ XN @ XU) @ (cwceq @ (ccfv @ XY @ (ccfv @ XN @ XO)) @ XW))) => ((cwceq @ Xc_xb @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ Xph @ (cwa @ (cwcel @ (cco @ XM @ XN @ Xc_xb) @ XU) @ (cwceq @ (ccfv @ XY @ (ccfv @ (cco @ XM @ XN @ Xc_xb) @ XO)) @ (cco @ XV @ XW @ Xc_x)))))))))))))))))))))))))))).
