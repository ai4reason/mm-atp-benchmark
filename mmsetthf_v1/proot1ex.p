...
thf(aodeq_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwceq @ XN @ (ccfv @ XA2 @ XO)) @ (cwral @ (^ [Xy1:$i] : (cwb @ (cwbr @ XN @ (ccv @ Xy1) @ ccdvds) @ (cwceq @ (cco @ (ccv @ Xy1) @ XA2 @ Xc_x) @ Xc_0))) @ (^ [Xy1:$i] : ccn0)))))))))))))))).
...
thf(aodf_thm,axiom,(! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwf @ XX @ ccn0 @ XO))))))).
...
thf(cproot1ex_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XG @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ (ccima @ (cccnv @ XO) @ (ccsn @ XN)))))))))).
