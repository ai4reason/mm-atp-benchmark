...
thf(cgrpinvadd_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XN @ (ccfv @ XG @ ccminusg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ XN) @ (cco @ (ccfv @ XY @ XN) @ (ccfv @ XX @ XN) @ Xc_pl))))))))))))).
