...
thf(adf_rngisom_ax,axiom,(cwceq @ ccrngs @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xs1:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccrab @ (^ [Xf1:$i] : (cwcel @ (cccnv @ (ccv @ Xf1)) @ (cco @ (ccv @ Xs1) @ (ccv @ Xr) @ ccrngh))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccrngh)))))))).
...
thf(cisrngisom_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW)) @ (cwb @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngs)) @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngh)) @ (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ ccrngh))))))))))).
