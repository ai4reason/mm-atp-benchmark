...
thf(aqtopeu_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xy1) @ (ccfv @ (XX @ Xf1) @ cctopon))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwfo @ (XX @ Xf1) @ (XY @ Xy1) @ XF)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XG @ (cco @ (XJ @ Xy1) @ (XK @ Xy1) @ cccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XX @ Xf1)) @ (cwcel @ (ccv @ Xy1) @ (XX @ Xf1)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccv @ Xy1) @ XG)))))) => (! [Xy1:$i] : (cwi @ Xph @ (cwreu @ (^ [Xf1:$i] : (cwceq @ XG @ (cccom @ (ccv @ Xf1) @ XF))) @ (^ [Xf1:$i] : (cco @ (cco @ (XJ @ Xy1) @ XF @ ccqtop) @ (XK @ Xy1) @ cccn))))))))))))))))).
...
thf(cqtophmeo_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XJ @ (ccfv @ (XX @ Xf1) @ cctopon)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwfo @ (XX @ Xf1) @ (XY @ Xy1) @ XF)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwfo @ (XX @ Xf1) @ (XY @ Xy1) @ XG)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XX @ Xf1)) @ (cwcel @ (ccv @ Xy1) @ (XX @ Xf1)))) @ (cwb @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccv @ Xy1) @ XG))))))) => (cwi @ Xph @ (cwreu @ (^ [Xf1:$i] : (cwceq @ XG @ (cccom @ (ccv @ Xf1) @ XF))) @ (^ [Xf1:$i] : (cco @ (cco @ XJ @ XF @ ccqtop) @ (cco @ XJ @ XG @ ccqtop) @ cchmeo))))))))))))))).
