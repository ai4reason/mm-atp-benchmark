...
thf(celovmpt2rab_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XO @ Xx3 @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (^ [Xz:$i] : XM))))))))) => ((cwi @ (cwa @ (cwcel @ XX @ ccvv) @ (cwcel @ XY @ ccvv)) @ (cwcel @ XM @ ccvv)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (XZ @ Xx3 @ Xy1) @ (cco @ XX @ XY @ (XO @ Xx3 @ Xy1 @ Xz))) @ (cw3a @ (cwcel @ XX @ ccvv) @ (cwcel @ XY @ ccvv) @ (cwcel @ (XZ @ Xx3 @ Xy1) @ XM))))))))))))))).
