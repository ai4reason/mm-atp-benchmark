...
thf(clenelioc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwbr @ XC @ XA2 @ ccle)) => (cwi @ Xph @ (cwn @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))))))))))))).
