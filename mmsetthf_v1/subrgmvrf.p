...
thf(csubrgmvrf_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (cco @ XI @ XR @ ccmvr)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (cco @ XI @ XH @ ccmpl)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => (cwi @ Xph @ (cwf @ XI @ XB2 @ XV)))))))))))))))))).
