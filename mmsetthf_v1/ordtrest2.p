...
thf(aordtrest_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccps) @ (cwcel @ XA2 @ XV)) @ (cwss @ (ccfv @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccordt) @ (cco @ (ccfv @ XR @ ccordt) @ XA2 @ ccrest))))))).
...
thf(apsss_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccps) @ (cwcel @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccps))))).
thf(aordtcnv_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccps) @ (cwceq @ (ccfv @ (cccnv @ XR) @ ccordt) @ (ccfv @ XR @ ccordt))))).
...
thf(cordtrest2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => ((cwi @ Xph @ (cwcel @ XR @ cctsr)) => ((cwi @ Xph @ (cwss @ XA2 @ XX)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2))) @ (cwss @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR))) @ (^ [Xz:$i] : XX)) @ XA2)))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccordt) @ (cco @ (ccfv @ XR @ ccordt) @ XA2 @ ccrest)))))))))))).
