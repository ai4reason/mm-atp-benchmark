...
thf(cghmlin_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XS @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XS @ ccplusg)) => ((cwceq @ Xc_pd @ (ccfv @ XT @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XU @ XX) @ (cwcel @ XV @ XX)) @ (cwceq @ (ccfv @ (cco @ XU @ XV @ Xc_pl) @ XF) @ (cco @ (ccfv @ XU @ XF) @ (ccfv @ XV @ XF) @ Xc_pd))))))))))))))).
