...
thf(cdvdsext_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwb @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccdvds) @ (cwbr @ XB2 @ (ccv @ Xx3) @ ccdvds))) @ (^ [Xx3:$i] : ccn0))))))).
