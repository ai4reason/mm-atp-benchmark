...
thf(cmpstrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => (cwi @ (cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) @ (cw3a @ (cwcel @ XD @ ccvv) @ (cwcel @ XH @ ccvv) @ (cwcel @ XA2 @ ccvv)))))))))).
