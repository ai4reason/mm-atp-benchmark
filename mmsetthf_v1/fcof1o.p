...
thf(cfcof1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ XB2 @ XA2 @ XG)) @ (cwa @ (cwceq @ (cccom @ XF @ XG) @ (ccres @ ccid @ XB2)) @ (cwceq @ (cccom @ XG @ XF) @ (ccres @ ccid @ XA2)))) @ (cwa @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwceq @ (cccnv @ XF) @ XG)))))))).
