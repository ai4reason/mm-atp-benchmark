...
thf(aisfcls2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwral @ (^ [Xs1:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xs1) @ (ccfv @ XJ @ cccl)))) @ (^ [Xs1:$i] : XF))))))))).
thf(asimpl2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwa @ (cw3a @ Xph @ Xps @ Xch) @ Xth) @ Xps)))))).
thf(cfclsss2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XF @ XG)) @ (cwss @ (cco @ XJ @ XG @ ccfcls) @ (cco @ XJ @ XF @ ccfcls)))))))).
