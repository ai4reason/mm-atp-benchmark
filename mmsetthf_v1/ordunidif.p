...
thf(aunidif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccdif @ XA2 @ XB2)))) @ (^ [Xx3:$i] : XA2)) @ (cwceq @ (ccuni @ (ccdif @ XA2 @ XB2)) @ (ccuni @ XA2)))))).
thf(cordunidif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cwcel @ XB2 @ XA2)) @ (cwceq @ (ccuni @ (ccdif @ XA2 @ XB2)) @ (ccuni @ XA2)))))).
