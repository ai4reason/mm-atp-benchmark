...
thf(abnj90_thm,axiom,(! [Xz:$i] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XY @ Xx3) @ ccvv)) => (! [Xx3:$i] : (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwfn @ (ccv @ Xz) @ (ccv @ Xx3))) @ (XY @ Xx3)) @ (cwfn @ (ccv @ Xz) @ (XY @ Xx3)))))))).
...
thf(cbnj121_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xze:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xbnjwphm:($i > ($i > ($i > $o)))] : (! [Xbnjwpsm:($i > ($i > ($i > $o)))] : (! [Xbnjwzem:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwb @ (Xze @ Xx3 @ Xf1 @ Xn) @ (cwi @ (cwa @ (cw_bnj15 @ (XA2 @ Xx3 @ Xf1) @ (XR @ Xx3 @ Xf1)) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xf1))) @ (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xx3 @ Xf1 @ Xn) @ (Xps @ Xx3 @ Xf1 @ Xn))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwb @ (Xbnjwzem @ Xx3 @ Xf1 @ Xn) @ (cwsbc @ (^ [Xn:$i] : (Xze @ Xx3 @ Xf1 @ Xn)) @ cc1o))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwb @ (Xbnjwphm @ Xx3 @ Xf1 @ Xn) @ (cwsbc @ (^ [Xn:$i] : (Xph @ Xx3 @ Xf1 @ Xn)) @ cc1o))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwb @ (Xbnjwpsm @ Xx3 @ Xf1 @ Xn) @ (cwsbc @ (^ [Xn:$i] : (Xps @ Xx3 @ Xf1 @ Xn)) @ cc1o))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwb @ (Xbnjwzem @ Xx3 @ Xf1 @ Xn) @ (cwi @ (cwa @ (cw_bnj15 @ (XA2 @ Xx3 @ Xf1) @ (XR @ Xx3 @ Xf1)) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xf1))) @ (cw3a @ (cwfn @ (ccv @ Xf1) @ cc1o) @ (Xbnjwphm @ Xx3 @ Xf1 @ Xn) @ (Xbnjwpsm @ Xx3 @ Xf1 @ Xn)))))))))))))))))))).
