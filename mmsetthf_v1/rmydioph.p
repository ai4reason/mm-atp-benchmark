...
thf(army0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (cco @ XA2 @ ccc0 @ ccrmy) @ ccc0)))).
...
thf(ajm2_27_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwb @ (cwceq @ XC @ (cco @ XA2 @ XB2 @ ccrmy)) @ (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : (cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwrex @ (^ [Xh:$i] : (cwrex @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : (cwa @ (cwa @ (cw3a @ (cwceq @ (cco @ (cco @ (ccv @ Xd) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ XC @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1) @ (cwceq @ (cco @ (cco @ (ccv @ Xf1) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (ccv @ Xe) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1) @ (cwcel @ (ccv @ Xg1) @ (ccfv @ cc2 @ ccuz))) @ (cw3a @ (cwceq @ (cco @ (cco @ (ccv @ Xi) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ (ccv @ Xg1) @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (ccv @ Xh) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1) @ (cwceq @ (ccv @ Xe) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ (cco @ cc2 @ (cco @ XC @ cc2 @ ccexp) @ ccmul) @ ccmul)) @ (cwbr @ (ccv @ Xf1) @ (cco @ (ccv @ Xg1) @ XA2 @ ccmin) @ ccdvds))) @ (cwa @ (cwa @ (cwbr @ (cco @ cc2 @ XC @ ccmul) @ (cco @ (ccv @ Xg1) @ cc1 @ ccmin) @ ccdvds) @ (cwbr @ (ccv @ Xf1) @ (cco @ (ccv @ Xh) @ XC @ ccmin) @ ccdvds)) @ (cwa @ (cwbr @ (cco @ cc2 @ XC @ ccmul) @ (cco @ (ccv @ Xh) @ XB2 @ ccmin) @ ccdvds) @ (cwbr @ XB2 @ XC @ ccle))))) @ (^ [Xj:$i] : ccn0))) @ (^ [Xi:$i] : ccn0))) @ (^ [Xh:$i] : ccn0))) @ (^ [Xg1:$i] : ccn0))) @ (^ [Xf1:$i] : ccn0))) @ (^ [Xe:$i] : ccn0))) @ (^ [Xd:$i] : ccn0)))))))).
...
thf(asbc3ie_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3)) @ (cwceq @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1))) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz) @ Xps))))) => (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (XC @ Xx3 @ Xy1))) @ (XB2 @ Xx3))) @ XA2) @ Xps))))))))))).
...
thf(a_3anrabdioph_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ (ccrab @ (^ [Xt:$i] : (Xph @ Xt)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (Xps @ Xt)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (Xch @ Xt)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph))) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (cw3a @ (Xph @ Xt) @ (Xps @ Xt) @ (Xch @ Xt))) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))))).
...
thf(alerabdioph_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (XA2 @ Xt))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp)) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (XB2 @ Xt))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp))) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (cwbr @ (XA2 @ Xt) @ (XB2 @ Xt) @ ccle)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph))))))).
thf(a_7rexfrabdioph_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => ((cwceq @ XL @ (cco @ XM @ cc1 @ ccaddc)) => ((cwceq @ XK @ (cco @ XL @ cc1 @ ccaddc)) => ((cwceq @ XJ @ (cco @ XK @ cc1 @ ccaddc)) => ((cwceq @ XI @ (cco @ XJ @ cc1 @ ccaddc)) => ((cwceq @ XH @ (cco @ XI @ cc1 @ ccaddc)) => ((cwceq @ XG @ (cco @ XH @ cc1 @ ccaddc)) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xw:$i] : (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xz:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xq:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xq @ Xp)) @ (ccfv @ XG @ (ccv @ Xt)))) @ (ccfv @ XH @ (ccv @ Xt)))) @ (ccfv @ XI @ (ccv @ Xt)))) @ (ccfv @ XJ @ (ccv @ Xt)))) @ (ccfv @ XK @ (ccv @ Xt)))) @ (ccfv @ XL @ (ccv @ Xt)))) @ (ccfv @ XM @ (ccv @ Xt)))) @ (ccres @ (ccv @ Xt) @ (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XG @ ccfz) @ ccmap))) @ (ccfv @ XG @ ccdioph))) @ (cwcel @ (ccrab @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xw:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xq @ Xp)) @ (^ [Xq:$i] : ccn0))) @ (^ [Xp:$i] : ccn0))) @ (^ [Xz:$i] : ccn0))) @ (^ [Xy1:$i] : ccn0))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xw:$i] : ccn0))) @ (^ [Xv:$i] : ccn0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))))))))))))))))).
thf(aeq0rabdioph_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (XA2 @ Xt))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp))) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (cwceq @ (XA2 @ Xt) @ ccc0)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))).
...
thf(crmydioph_conj,conjecture,(cwcel @ (ccrab @ (^ [Xa:$i] : (cwa @ (cwcel @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (ccfv @ cc3 @ (ccv @ Xa)) @ (cco @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ (ccv @ Xa)) @ ccrmy)))) @ (^ [Xa:$i] : (cco @ ccn0 @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))) @ (ccfv @ cc3 @ ccdioph))).
