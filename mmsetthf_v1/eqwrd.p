...
thf(ceqwrd_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ XU @ (ccword @ (XV @ Xi))) @ (cwcel @ XW @ (ccword @ (XV @ Xi)))) @ (cwb @ (cwceq @ XU @ XW) @ (cwa @ (cwceq @ (ccfv @ XU @ cchash) @ (ccfv @ XW @ cchash)) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XU) @ (ccfv @ (ccv @ Xi) @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XU @ cchash) @ ccfzo))))))))))).
