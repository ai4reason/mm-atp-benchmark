...
thf(adf_cot_ax,axiom,(cwceq @ cccot @ (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ ccsin) @ ccc0)) @ (^ [Xy1:$i] : ccc))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cccos) @ (ccfv @ (ccv @ Xx3) @ ccsin) @ ccdiv))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(ccotval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ cccot) @ (cco @ (ccfv @ XA2 @ cccos) @ (ccfv @ XA2 @ ccsin) @ ccdiv))))).
