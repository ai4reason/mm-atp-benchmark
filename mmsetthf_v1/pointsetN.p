...
thf(adf_pointsN_ax,axiom,(cwceq @ ccpointsN @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccab @ (^ [Xq:$i] : (cwrex @ (^ [Xp:$i] : (cwceq @ (ccv @ Xq) @ (ccsn @ (ccv @ Xp)))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xk) @ ccatm))))))))).
...
thf(cpointsetN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xa) @ ccatm))) => ((! [Xp:$i] : (! [Xa:$i] : (cwceq @ (XP @ Xp @ Xa) @ (ccfv @ (XK @ Xa) @ ccpointsN)))) => (! [Xp:$i] : (! [Xa:$i] : (cwi @ (cwcel @ (XK @ Xa) @ (XB2 @ Xp @ Xa)) @ (cwceq @ (XP @ Xp @ Xa) @ (ccab @ (^ [Xp:$i] : (cwrex @ (^ [Xa:$i] : (cwceq @ (ccv @ Xp) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xa:$i] : XA2))))))))))))))).
