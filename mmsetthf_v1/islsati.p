...
thf(cislsati_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((! [Xv:$i] : (cwceq @ (XA2 @ Xv) @ (ccfv @ XW @ cclsa))) => (! [Xv:$i] : (cwi @ (cwa @ (cwcel @ XW @ XX) @ (cwcel @ XU @ (XA2 @ Xv))) @ (cwrex @ (^ [Xv:$i] : (cwceq @ XU @ (ccfv @ (ccsn @ (ccv @ Xv)) @ XN))) @ (^ [Xv:$i] : XV)))))))))))))).
