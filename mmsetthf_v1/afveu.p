...
thf(adfdfat2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwdfat @ XA2 @ XF) @ (cwa @ (cwcel @ XA2 @ (ccdm @ XF)) @ (cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF)))))))).
...
thf(afveu_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cweu @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccuni @ (ccab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))))))))).
thf(cafveu_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cweu @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))) @ (cwceq @ (ccafv @ XA2 @ XF) @ (ccuni @ (ccab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))))))))).
