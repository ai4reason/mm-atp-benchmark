...
thf(aragperp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccrn @ XL))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccrn @ XL))) => ((cwi @ Xph @ (cwcel @ XX @ (ccin @ XA2 @ XB2))) => ((cwi @ Xph @ (cwcel @ XU @ XA2)) => ((cwi @ Xph @ (cwcel @ XV @ XB2)) => ((cwi @ Xph @ (cwne @ XU @ XX)) => ((cwi @ Xph @ (cwne @ XV @ XX)) => ((cwi @ Xph @ (cwcel @ (ccs3 @ XU @ XX @ XV) @ (ccfv @ XG @ ccrag))) => (cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg)))))))))))))))))))))))))))).
...
thf(clmimid_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => ((cwceq @ XM @ (ccfv @ XD @ (ccfv @ XG @ cclmi))) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XD @ (ccrn @ XL))) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwceq @ XS @ (ccfv @ XB2 @ (ccfv @ XG @ ccmir))) => ((cwi @ Xph @ (cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccrag))) => ((cwi @ Xph @ (cwcel @ XA2 @ XD)) => ((cwi @ Xph @ (cwcel @ XB2 @ XD)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ XM) @ (ccfv @ XC @ XS))))))))))))))))))))))))))))))).
