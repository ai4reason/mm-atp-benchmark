...
thf(cdplti_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => ((cwcel @ XC @ ccn0) => ((cwbr @ XB2 @ (ccdc @ cc1 @ ccc0) @ cclt) => ((cwceq @ (cco @ XA2 @ cc1 @ ccaddc) @ XC) => (cwbr @ (cco @ XA2 @ XB2 @ ccdp) @ XC @ cclt)))))))))).
