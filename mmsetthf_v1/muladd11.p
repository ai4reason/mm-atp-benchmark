...
thf(cmuladd11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ cc1 @ XB2 @ ccaddc) @ ccmul) @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccaddc) @ ccaddc)))))).
