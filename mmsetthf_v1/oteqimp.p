...
thf(coteqimp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwceq @ XT @ (ccotp @ XA2 @ XB2 @ XC)) @ (cwi @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XZ)) @ (cw3a @ (cwceq @ (ccfv @ (ccfv @ XT @ cc1st) @ cc1st) @ XA2) @ (cwceq @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) @ XB2) @ (cwceq @ (ccfv @ XT @ cc2nd) @ XC)))))))))))).
