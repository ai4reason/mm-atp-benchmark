...
thf(adeg1leb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccdg1))) => ((! [Xx3:$i] : (cwceq @ (XP @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccpl1))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XP @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (cwceq @ XA2 @ (ccfv @ (XF @ Xx3) @ ccco1))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XF @ Xx3) @ (XB2 @ Xx3)) @ (cwcel @ XG @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ (XF @ Xx3) @ (XD @ Xx3)) @ XG @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ XG @ (ccv @ Xx3) @ cclt) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XA2) @ Xc_0))) @ (^ [Xx3:$i] : ccn0))))))))))))))))))).
thf(cdeg1tmle_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XC @ XK) @ (cwcel @ XF @ ccn0)) @ (cwbr @ (ccfv @ (cco @ XC @ (cco @ XF @ XX @ Xc_ex) @ Xc_x) @ XD) @ XF @ ccle)))))))))))))))))))).
