...
thf(aaxdclem_thm,axiom,(! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwceq @ (XF @ Xx3 @ Xg1 @ Xs1) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccfv @ (ccab @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (ccv @ Xg1)))) @ (ccv @ Xs1)) @ ccom))))) => (! [Xx3:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (cw3a @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwne @ (ccv @ Xy1) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (ccdm @ (ccv @ Xx3))))) @ (cwss @ (ccrn @ (ccv @ Xx3)) @ (ccdm @ (ccv @ Xx3))) @ (cwex @ (^ [Xz:$i] : (cwbr @ (ccfv @ (XK @ Xx3 @ Xg1 @ Xs1) @ (XF @ Xx3 @ Xg1 @ Xs1)) @ (ccv @ Xz) @ (ccv @ Xx3))))) @ (cwi @ (cwcel @ (XK @ Xx3 @ Xg1 @ Xs1) @ ccom) @ (cwbr @ (ccfv @ (XK @ Xx3 @ Xg1 @ Xs1) @ (XF @ Xx3 @ Xg1 @ Xs1)) @ (ccfv @ (ccsuc @ (XK @ Xx3 @ Xg1 @ Xs1)) @ (XF @ Xx3 @ Xg1 @ Xs1)) @ (ccv @ Xx3))))))))))).
