...
thf(aelfv_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xy1:$i] : (cwb @ (cwcel @ (XA2 @ Xy1) @ (ccfv @ XB2 @ XF)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (XA2 @ Xy1) @ (ccv @ Xx3)) @ (cwal @ (^ [Xy1:$i] : (cwb @ (cwbr @ XB2 @ (ccv @ Xy1) @ XF) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))))))).
...
thf(cfv3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ XF) @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwbr @ XA2 @ (ccv @ Xy1) @ XF)))) @ (cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF)))))))))).
