...
thf(cpntibndlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ (XA2 @ Xa) @ ccrp))) => ((! [Xa:$i] : (cwceq @ (XL @ Xa) @ (cco @ (cco @ cc1 @ cc4 @ ccdiv) @ (cco @ (XA2 @ Xa) @ cc3 @ ccaddc) @ ccdiv))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ (XL @ Xa) @ (cco @ ccc0 @ cc1 @ ccioo)))))))))))).
