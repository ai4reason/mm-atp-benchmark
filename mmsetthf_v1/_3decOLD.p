...
thf(c_3decOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => (cwceq @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ (cco @ (cco @ (cco @ (cco @ cc10 @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ cc10 @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
