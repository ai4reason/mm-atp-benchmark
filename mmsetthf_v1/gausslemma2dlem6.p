...
thf(agausslemma2dlem3_thm,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XP @ Xk) @ (ccdif @ ccprime @ (ccsn @ cc2))))) => ((! [Xk:$i] : (cwceq @ XH @ (cco @ (cco @ (XP @ Xk) @ cc1 @ ccmin) @ cc2 @ ccdiv))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XR @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin))))))) => ((! [Xk:$i] : (cwceq @ (XM @ Xk) @ (ccfv @ (cco @ (XP @ Xk) @ cc4 @ ccdiv) @ ccfl))) => (! [Xx3:$i] : (cwi @ Xph @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ (XR @ Xx3)) @ (cco @ (XP @ Xk) @ (cco @ (ccv @ Xk) @ cc2 @ ccmul) @ ccmin))) @ (^ [Xk:$i] : (cco @ (cco @ (XM @ Xk) @ cc1 @ ccaddc) @ XH @ ccfz))))))))))))))).
...
thf(amodmulmodr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XM @ ccmo) @ ccmul) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XM @ ccmo))))))).
thf(aoveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF)))))))))).
thf(agausslemma2dlem5_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XH @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((cwceq @ XM @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XN @ Xx3 @ Xk) @ (cco @ XH @ XM @ ccmin)))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XR @ Xx3)))) @ XP @ ccmo) @ (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XN @ Xx3 @ Xk) @ ccexp) @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ cc2 @ ccmul))) @ ccmul) @ XP @ ccmo))))))))))))))))).
...
thf(ann0oddm1d2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0))))).
