...
thf(aasinbnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ ccasin) @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc))))).
...
thf(cacosbnd_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ ccacos) @ ccre) @ (cco @ ccc0 @ ccpi @ ccicc))))).
