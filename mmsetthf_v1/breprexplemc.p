...
thf(abreprexplemb_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XZ @ ccc)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => ((cwi @ Xph @ (cwcel @ XY @ ccn)) => (cwi @ Xph @ (cwcel @ (ccfv @ XY @ (ccfv @ XX @ XL)) @ ccc)))))))))))))))).
...
thf(afsum2mul_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (XC @ Xj) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XB2)) @ (cwcel @ (XD @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (cco @ (XC @ Xj) @ (XD @ Xk) @ ccmul))))) @ (cco @ (ccsu @ XA2 @ (^ [Xj:$i] : (XC @ Xj))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (XD @ Xk))) @ ccmul))))))))))))).
thf(areprfi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ ccfn))))))))))).
...
thf(aad5ant15_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ Xph @ Xth) @ Xta) @ Xet) @ Xps) @ Xch))))))))).
...
thf(abreprexplema_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3 @ Xy1) @ ccn0)))) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xy1) @ ccn0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwbr @ (XM @ Xx3 @ Xy1) @ (cco @ (cco @ XS @ cc1 @ ccaddc) @ (XN @ Xx3 @ Xy1) @ ccmul) @ ccle)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ (cco @ XS @ cc1 @ ccaddc) @ ccfzo))) @ (cwcel @ (ccv @ Xy1) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XL)) @ ccc)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ (cco @ cc1 @ (XN @ Xx3 @ Xy1) @ ccfz) @ (XM @ Xx3 @ Xy1) @ (ccfv @ (cco @ XS @ cc1 @ ccaddc) @ ccrepr)) @ (^ [Xd:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ (cco @ XS @ cc1 @ ccaddc) @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xd)) @ (ccfv @ (ccv @ Xa) @ XL)))))) @ (ccsu @ (cco @ cc1 @ (XN @ Xx3 @ Xy1) @ ccfz) @ (^ [Xb:$i] : (ccsu @ (cco @ (cco @ cc1 @ (XN @ Xx3 @ Xy1) @ ccfz) @ (cco @ (XM @ Xx3 @ Xy1) @ (ccv @ Xb) @ ccmin) @ (ccfv @ XS @ ccrepr)) @ (^ [Xd:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xd)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (ccfv @ (ccv @ Xb) @ (ccfv @ XS @ XL)) @ ccmul)))))))))))))))))))).
...
thf(afsum2dsub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xi) @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ ccmin)) @ (cwceq @ (XA2 @ Xi @ Xj) @ (XB2 @ Xj @ Xk)))))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ (ccfv @ (ccneg @ (ccv @ Xj)) @ ccuz)) @ (cwcel @ (ccv @ Xj) @ (cco @ cc1 @ XN @ ccfz))) @ (cwcel @ (XA2 @ Xi @ Xj) @ ccc)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ (cco @ cc1 @ XN @ ccfz))) @ (cwcel @ (ccv @ Xk) @ (cco @ (cco @ (cco @ XM @ (ccv @ Xj) @ ccaddc) @ cc1 @ ccaddc) @ (cco @ XM @ XN @ ccaddc) @ ccfz))) @ (cwceq @ (XB2 @ Xj @ Xk) @ ccc0)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ (cco @ cc1 @ XN @ ccfz))) @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ (ccv @ Xj) @ ccfzo))) @ (cwceq @ (XB2 @ Xj @ Xk) @ ccc0)))) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xi:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (XA2 @ Xi @ Xj))))) @ (ccsu @ (cco @ ccc0 @ (cco @ XM @ XN @ ccaddc) @ ccfz) @ (^ [Xk:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (XB2 @ Xj @ Xk))))))))))))))))))).
...
thf(areprgt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ cc1 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwbr @ (cco @ XS @ XN @ ccmul) @ XM @ cclt)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ cc0))))))))))))).
...
thf(afz2ssnn0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XM @ ccn0) @ (cwss @ (cco @ XM @ XN @ ccfz) @ ccn0))))).
...
thf(areprlt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwbr @ XM @ XS @ cclt)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ cc0))))))))))).
...
thf(cbreprexplemc_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((! [Xb:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xb @ Xd) @ ccn0)))) => ((cwi @ Xph @ (cwcel @ XZ @ ccc)) => ((! [Xb:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwf @ (cco @ ccc0 @ (XS @ Xb @ Xd) @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)))) => ((cwi @ Xph @ (cwcel @ XT @ ccn0)) => ((! [Xb:$i] : (! [Xd:$i] : (cwi @ Xph @ (cwbr @ (cco @ XT @ cc1 @ ccaddc) @ (XS @ Xb @ Xd) @ ccle)))) => ((cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XT @ ccfzo)) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xb) @ (ccfv @ (ccv @ Xa) @ XL)) @ (cco @ XZ @ (ccv @ Xb) @ ccexp) @ ccmul))))) @ (ccsu @ (cco @ ccc0 @ (cco @ XT @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ XT @ ccrepr)) @ (^ [Xd:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XT @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xd)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (cco @ XZ @ (ccv @ Xm) @ ccexp) @ ccmul))))))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ (cco @ XT @ cc1 @ ccaddc) @ ccfzo)) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xb) @ (ccfv @ (ccv @ Xa) @ XL)) @ (cco @ XZ @ (ccv @ Xb) @ ccexp) @ ccmul))))) @ (ccsu @ (cco @ ccc0 @ (cco @ (cco @ XT @ cc1 @ ccaddc) @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ (cco @ XT @ cc1 @ ccaddc) @ ccrepr)) @ (^ [Xd:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ (cco @ XT @ cc1 @ ccaddc) @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xd)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (cco @ XZ @ (ccv @ Xm) @ ccexp) @ ccmul))))))))))))))))))))).
