...
thf(ctrclublem_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XR @ (XV @ Xx3)) @ (cwcel @ (ccun @ XR @ (ccxp @ (ccdm @ XR) @ (ccrn @ XR))) @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XR @ (ccv @ Xx3)) @ (cwss @ (cccom @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (ccv @ Xx3))))))))))).
