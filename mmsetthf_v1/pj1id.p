...
thf(apj1val_thm,axiom,(! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1) @ (ccfv @ XG @ ccplusg)))) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XP @ Xx3 @ Xy1) @ (ccfv @ XG @ ccpj1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ XV) @ (cwss @ XT @ XB2) @ (cwss @ XU @ XB2)) @ (cwcel @ XX @ (cco @ XT @ XU @ Xc_po))) @ (cwceq @ (ccfv @ XX @ (cco @ XT @ XU @ (XP @ Xx3 @ Xy1))) @ (ccrio @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XX @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : XT)))))))))))))))))))).
...
thf(cpj1id_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwceq @ (ccin @ XT @ XU) @ (ccsn @ Xc_0))) => ((cwi @ Xph @ (cwss @ XT @ (ccfv @ XU @ XZ))) => ((cwceq @ XP @ (ccfv @ XG @ ccpj1)) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ (cco @ XT @ XU @ Xc_po))) @ (cwceq @ XX @ (cco @ (ccfv @ XX @ (cco @ XT @ XU @ XP)) @ (ccfv @ XX @ (cco @ XU @ XT @ XP)) @ Xc_pl))))))))))))))))))))))).
