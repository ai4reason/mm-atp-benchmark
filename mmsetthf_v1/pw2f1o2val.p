...
thf(cpw2f1o2val_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2o @ XA2 @ ccmap)) @ (^ [Xx3:$i] : (ccima @ (cccnv @ (ccv @ Xx3)) @ (ccsn @ cc1o)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XX @ (cco @ cc2o @ XA2 @ ccmap)) @ (cwceq @ (ccfv @ XX @ (XF @ Xx3)) @ (ccima @ (cccnv @ XX) @ (ccsn @ cc1o)))))))))).
