...
thf(cfztpval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccif @ (cwceq @ (ccv @ Xx3) @ cc1) @ XA2 @ (ccif @ (cwceq @ (ccv @ Xx3) @ cc2) @ XB2 @ XC)))) @ (^ [Xx3:$i] : (cco @ cc1 @ cc3 @ ccfz))) @ (cw3a @ (cwceq @ (ccfv @ cc1 @ XF) @ XA2) @ (cwceq @ (ccfv @ cc2 @ XF) @ XB2) @ (cwceq @ (ccfv @ cc3 @ XF) @ XC)))))))).
