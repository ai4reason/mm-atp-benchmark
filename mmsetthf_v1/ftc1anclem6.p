...
thf(aftc1anclem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XG @ Xx3 @ Xt) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ ccibl)) => ((cwi @ Xph @ (cwf @ XD @ ccc @ XF)) => (cwi @ (cwa @ Xph @ (cwcel @ XY @ ccrp)) @ (cwrex @ (^ [Xf1:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccfv @ (ccif @ (cwcel @ (ccv @ Xt) @ XD) @ (ccfv @ (ccv @ Xt) @ XF) @ ccc0) @ ccre) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ ccmin) @ ccabs))) @ ccitg2) @ XY @ cclt)) @ (^ [Xf1:$i] : (ccdm @ ccitg1)))))))))))))))))))).
...
thf(aftc1anclem4_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ ccibl) @ (cwf @ ccr @ ccr @ XG)) @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ XG) @ (ccfv @ (ccv @ Xt) @ XF) @ ccmin) @ ccabs))) @ ccitg2) @ ccr))))).
...
thf(acofmpt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XC @ (XD @ Xx3) @ XF))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ XC))) => (cwi @ Xph @ (cwceq @ (cccom @ XF @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ XF)))))))))))))).
...
thf(aismbf2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xx3) @ ccr @ XF))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccdm @ ccvol)))) => (cwi @ Xph @ (cwcel @ XF @ ccmbf)))))))))).
...
thf(amp3an3an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => ((cwi @ Xps @ Xch) => ((cwi @ Xth @ Xta) => ((cwi @ (cw3a @ Xph @ Xch @ Xta) @ Xet) => (cwi @ (cwa @ Xps @ Xth) @ Xet)))))))))))).
