...
thf(aznf1o_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XN @ cczn)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XF @ (ccres @ (ccfv @ XY @ cczrh) @ XW)) => ((cwceq @ XW @ (ccif @ (cwceq @ XN @ ccc0) @ ccz @ (cco @ ccc0 @ XN @ ccfzo))) => (cwi @ (cwcel @ XN @ ccn0) @ (cwf1o @ XW @ XB2 @ XF)))))))))))).
...
thf(adchrsum_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : (cwceq @ (XG @ Xa) @ (ccfv @ (XN @ Xa) @ ccdchr))) => ((! [Xa:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : (cwceq @ (XD @ Xa) @ (ccfv @ (XG @ Xa) @ ccbs))) => ((! [Xa:$i] : (cwceq @ Xc_1 @ (ccfv @ (XG @ Xa) @ cc0g))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xa)))) => ((cwceq @ XB2 @ (ccfv @ XZ @ ccbs)) => (! [Xa:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XB2 @ (^ [Xa:$i] : (ccfv @ (ccv @ Xa) @ XX))) @ (ccif @ (cwceq @ XX @ Xc_1) @ (ccfv @ (XN @ Xa) @ ccphi) @ ccc0))))))))))))))))))).
