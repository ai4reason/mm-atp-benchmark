...
thf(adf_lmat_ax,axiom,(cwceq @ cclmat @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xm) @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xm)) @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xm)))))))))).
...
thf(clmatval_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwcel @ XM @ (XV @ Xi @ Xj)) @ (cwceq @ (ccfv @ XM @ cclmat) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ XM @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ ccc0 @ XM) @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ XM)))))))))))).
