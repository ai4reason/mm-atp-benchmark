...
thf(ambfdm_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccmbf) @ (cwcel @ (ccdm @ XF) @ (ccdm @ ccvol))))).
...
thf(ambfsub_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccmbf)))))))).
thf(ccli_tp,type,(ccli : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccitg1_tp,type,(ccitg1 : ($i > $o))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(ambfmullem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XG)) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf))))))))))).
...
thf(cmbfmul_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf)))))))).
