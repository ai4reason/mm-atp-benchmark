...
thf(csumnnodd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ ccc @ XF)) => ((! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xk) @ ccn) @ (cwcel @ (cco @ (ccv @ Xk) @ cc2 @ ccdiv) @ ccn)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ ccc0))) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ XF @ cc1) @ (XB2 @ Xk) @ ccli))) => (! [Xk:$i] : (cwi @ Xph @ (cwa @ (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ XF))) @ cc1) @ (XB2 @ Xk) @ ccli) @ (cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (ccsu @ ccn @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ XF)))))))))))))).
