...
thf(aralxfrd2_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ (XC @ Xy1))) @ (cwcel @ (XA2 @ Xy1) @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xy1) @ (XC @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1))) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => (cwi @ Xph @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) @ (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xy1))))))))))))))).
...
thf(ainss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwo @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XC)) @ (cwss @ (ccin @ XA2 @ XB2) @ XC)))))).
thf(asscon34b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XC) @ (cwss @ XB2 @ XC)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwss @ (ccdif @ XC @ XB2) @ (ccdif @ XC @ XA2)))))))).
...
thf(cntrclsk3_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XO @ Xt @ Xi @ Xj @ Xk @ Xs1) @ (ccmpt @ (^ [Xi:$i] : ccvv) @ (^ [Xi:$i] : (ccmpt @ (^ [Xk:$i] : (cco @ (ccpw @ (ccv @ Xi)) @ (ccpw @ (ccv @ Xi)) @ ccmap)) @ (^ [Xk:$i] : (ccmpt @ (^ [Xj:$i] : (ccpw @ (ccv @ Xi))) @ (^ [Xj:$i] : (ccdif @ (ccv @ Xi) @ (ccfv @ (ccdif @ (ccv @ Xi) @ (ccv @ Xj)) @ (ccv @ Xk))))))))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XD @ Xt @ Xi @ Xj @ Xk @ Xs1) @ (ccfv @ XB2 @ (XO @ Xt @ Xi @ Xj @ Xk @ Xs1)))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwi @ Xph @ (cwbr @ XI @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1) @ (XD @ Xt @ Xi @ Xj @ Xk @ Xs1)))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwss @ (ccin @ (ccfv @ (ccv @ Xs1) @ XI) @ (ccfv @ (ccv @ Xt) @ XI)) @ (ccfv @ (ccin @ (ccv @ Xs1) @ (ccv @ Xt)) @ XI))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2))) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwss @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccv @ Xt)) @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1)) @ (ccun @ (ccfv @ (ccv @ Xs1) @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1)) @ (ccfv @ (ccv @ Xt) @ (XK @ Xt @ Xi @ Xj @ Xk @ Xs1))))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2)))))))))))))))))).
