...
thf(aclwlksf1oclwwlkOLD_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xc:$i] : (cwceq @ (XA2 @ Xc) @ (ccfv @ (ccv @ Xc) @ cc1st))) => ((! [Xc:$i] : (cwceq @ (XB2 @ Xc) @ (ccfv @ (ccv @ Xc) @ cc2nd))) => ((cwceq @ XC @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (XA2 @ Xc) @ cchash) @ XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks)))) => ((cwceq @ XF @ (ccmpt @ (^ [Xc:$i] : XC) @ (^ [Xc:$i] : (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr)))) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ ccprime)) @ (cwf1o @ XC @ (cco @ XN @ XG @ ccclwwlkn) @ XF))))))))))))).
...
thf(cclwlkssizeeqOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ ccprime)) @ (cwceq @ (ccfv @ (cco @ XN @ XG @ ccclwwlkn) @ cchash) @ (ccfv @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) @ XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks))) @ cchash)))))).
