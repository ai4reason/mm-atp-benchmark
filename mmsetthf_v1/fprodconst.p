...
thf(aexpnnval_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XA2 @ XN @ ccexp) @ (ccfv @ XN @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ XA2)) @ cc1))))))).
...
thf(cfprodconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : XB2)) @ (cco @ XB2 @ (ccfv @ XA2 @ cchash) @ ccexp)))))).
