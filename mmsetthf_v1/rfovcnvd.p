...
thf(crfovcnvd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XO @ Xx3 @ Xy1 @ Xf1 @ Xr @ Xa @ Xb) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xb:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccmpt @ (^ [Xr:$i] : (ccpw @ (ccxp @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xr:$i] : (ccmpt @ (^ [Xx3:$i] : (ccv @ Xa)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr))) @ (^ [Xy1:$i] : (ccv @ Xb))))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xf1 @ Xr @ Xa @ Xb))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XW @ Xy1 @ Xf1 @ Xr @ Xb))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xf1 @ Xr @ Xa @ Xb) @ (cco @ XA2 @ XB2 @ (XO @ Xx3 @ Xy1 @ Xf1 @ Xr @ Xa @ Xb))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ (cccnv @ (XF @ Xx3 @ Xy1 @ Xf1 @ Xr @ Xa @ Xb)) @ (ccmpt @ (^ [Xf1:$i] : (cco @ (ccpw @ XB2) @ XA2 @ ccmap)) @ (^ [Xf1:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))))))))))))))))))))))))))))).
