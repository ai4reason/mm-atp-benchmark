...
thf(cmeaiunlelem_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XM @ Xi) @ ccmea)))) => ((! [Xi:$i] : (cwceq @ XS @ (ccdm @ (XM @ Xi)))) => ((! [Xi:$i] : (cwceq @ (XZ @ Xi) @ (ccfv @ XN @ ccuz))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwf @ (XZ @ Xi) @ XS @ XE)))) => ((! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xi @ Xn) @ (ccmpt @ (^ [Xn:$i] : (XZ @ Xi)) @ (^ [Xn:$i] : (ccdif @ (ccfv @ (ccv @ Xn) @ XE) @ (cciun @ (^ [Xi:$i] : (cco @ XN @ (ccv @ Xn) @ ccfzo)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XE))))))))) => (! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : (XZ @ Xi)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ (XM @ Xi)) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : (XZ @ Xi)) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ (XM @ Xi)))) @ ccsumge0) @ ccle)))))))))))))))))).
