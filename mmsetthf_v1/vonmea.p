...
thf(acaratheodory_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => (cwi @ Xph @ (cwcel @ (ccres @ XO @ XS) @ ccmea)))))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(ccmap_tp,type,(ccmap : ($i > $o))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(aovnome_thm,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ ccovoln) @ ccome)))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(cvonmea_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ ccvoln) @ ccmea)))))).
