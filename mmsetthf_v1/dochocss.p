...
thf(adochval2_thm,axiom,(! [XU:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwceq @ (Xc_pe @ Xz) @ (ccfv @ XK @ ccoc))) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((! [Xz:$i] : (cwceq @ (XU @ Xz) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xz:$i] : (cwceq @ XV @ (ccfv @ (XU @ Xz) @ ccbs))) => ((! [Xz:$i] : (cwceq @ (XN @ Xz) @ (ccfv @ XW @ (ccfv @ XK @ ccoch)))) => (! [Xz:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwss @ XX @ XV)) @ (cwceq @ (ccfv @ XX @ (XN @ Xz)) @ (ccfv @ (ccfv @ (ccfv @ (ccint @ (ccrab @ (^ [Xz:$i] : (cwss @ XX @ (ccv @ Xz))) @ (^ [Xz:$i] : (ccrn @ XI)))) @ (cccnv @ XI)) @ (Xc_pe @ Xz)) @ XI)))))))))))))))))))).
...
thf(adihintcl_thm,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwss @ XS @ (ccrn @ XI)) @ (cwne @ XS @ cc0))) @ (cwcel @ (ccint @ XS) @ (ccrn @ XI))))))))))).
...
thf(cdochocss_conj,conjecture,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ (ccfv @ XK @ ccoch))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwss @ XX @ XV)) @ (cwss @ XX @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe))))))))))))))).
