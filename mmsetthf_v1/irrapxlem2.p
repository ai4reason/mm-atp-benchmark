...
thf(aintfrac_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ XA2 @ (cco @ (ccfv @ XA2 @ ccfl) @ (cco @ XA2 @ cc1 @ ccmo) @ ccaddc))))).
...
thf(amodelico_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmo) @ (cco @ ccc0 @ XB2 @ ccico)))))).
...
thf(cirrapxlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccn)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) @ (cwbr @ (ccfv @ (cco @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmo) @ (cco @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ cc1 @ ccmo) @ ccmin) @ ccabs) @ (cco @ cc1 @ XB2 @ ccdiv) @ cclt))) @ (^ [Xy1:$i] : (cco @ ccc0 @ XB2 @ ccfz)))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XB2 @ ccfz))))))).
