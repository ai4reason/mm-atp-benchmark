...
thf(acrefi_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XX @ Xz) @ (ccuni @ XJ))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ (cccref @ XA2)) @ (cwss @ XC @ XJ) @ (cwceq @ (XX @ Xz) @ (ccuni @ XC))) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ XC @ ccref)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XJ) @ XA2))))))))))).
...
thf(ccrefdf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XX @ Xz) @ (ccuni @ XJ))) => ((! [Xz:$i] : (cwceq @ (XB2 @ Xz) @ (cccref @ XA2))) => ((! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ XA2) @ (Xph @ Xz))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ (XB2 @ Xz)) @ (cwss @ XC @ XJ) @ (cwceq @ (XX @ Xz) @ (ccuni @ XC))) @ (cwrex @ (^ [Xz:$i] : (cwa @ (Xph @ Xz) @ (cwbr @ (ccv @ Xz) @ XC @ ccref))) @ (^ [Xz:$i] : (ccpw @ XJ))))))))))))))).
