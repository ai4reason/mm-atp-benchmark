...
thf(ccdaenun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwbr @ XC @ XD @ ccen) @ (cwceq @ (ccin @ XB2 @ XD) @ cc0)) @ (cwbr @ (cco @ XA2 @ XC @ cccda) @ (ccun @ XB2 @ XD) @ ccen))))))).
