...
thf(crtrclexi_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ XA2 @ (XV @ Xx3))) => (cwcel @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XA2 @ (ccv @ Xx3)) @ (cwa @ (cwss @ (cccom @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (ccv @ Xx3)) @ (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (ccv @ Xx3)) @ (ccrn @ (ccv @ Xx3)))) @ (ccv @ Xx3))))))) @ ccvv))))).
