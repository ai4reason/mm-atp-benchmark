...
thf(cgencl_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwb @ (Xth @ Xx3) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xch @ Xx3) @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (Xch @ Xx3) @ (Xph @ Xx3))) => (! [Xx3:$i] : (cwi @ (Xth @ Xx3) @ Xps)))))))))))).
