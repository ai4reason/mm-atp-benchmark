...
thf(adf_uc1p_ax,axiom,(cwceq @ ccuc1p @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccrab @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cc0g)) @ (cwcel @ (ccfv @ (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xr) @ ccdg1)) @ (ccfv @ (ccv @ Xf1) @ ccco1)) @ (ccfv @ (ccv @ Xr) @ ccui)))) @ (^ [Xf1:$i] : (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccbs))))))).
...
thf(cuc1pval_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XP @ Xf1) @ (ccfv @ XR @ ccpl1))) => ((! [Xf1:$i] : (cwceq @ XB2 @ (ccfv @ (XP @ Xf1) @ ccbs))) => ((! [Xf1:$i] : (cwceq @ Xc_0 @ (ccfv @ (XP @ Xf1) @ cc0g))) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((! [Xf1:$i] : (cwceq @ (XC @ Xf1) @ (ccfv @ XR @ ccuc1p))) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => (! [Xf1:$i] : (cwceq @ (XC @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccv @ Xf1) @ Xc_0) @ (cwcel @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XD) @ (ccfv @ (ccv @ Xf1) @ ccco1)) @ XU))) @ (^ [Xf1:$i] : XB2)))))))))))))))))).
