...
thf(a_0dig1_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (cco @ ccc0 @ cc1 @ (ccfv @ XB2 @ ccdig)) @ cc1)))).
thf(c_0dig2pr01_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccpr @ ccc0 @ cc1)) @ (cwceq @ (cco @ ccc0 @ XN @ (ccfv @ cc2 @ ccdig)) @ XN)))).
