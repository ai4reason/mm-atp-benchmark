...
thf(ciunpw_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccuni @ XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwceq @ (ccpw @ (ccuni @ XA2)) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xx3))))))))).
