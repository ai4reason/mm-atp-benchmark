...
thf(ahhsscms_thm,axiom,(! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwceq @ XD @ (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccch) => (cwcel @ XD @ (ccfv @ XH @ ccms))))))))).
...
thf(chhssbn_conj,conjecture,(! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XH @ ccch) => (cwcel @ XW @ cccbn)))))).
