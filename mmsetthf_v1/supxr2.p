...
thf(asupxr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwa @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwbr @ XB2 @ (ccv @ Xx3) @ cclt))) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ XB2 @ cclt) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)))) @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ XB2))))).
thf(csupxr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwa @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ ccle)) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ XB2 @ cclt) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)))) @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ XB2))))).
