...
thf(achpssati_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwpss @ XA2 @ XB2) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwn @ (cwss @ (ccv @ Xx3) @ XA2)))) @ (^ [Xx3:$i] : ccat)))))))).
...
thf(achcv1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwn @ (cwss @ XB2 @ XA2)) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
...
thf(achnle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwn @ (cwss @ XB2 @ XA2)) @ (cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj))))))).
...
thf(ccvexchlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv))))))).
