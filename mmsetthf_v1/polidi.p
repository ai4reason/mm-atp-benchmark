...
thf(cpolidi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwceq @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ (cco @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmin) @ (cco @ cci @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccsm) @ ccva) @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccsm) @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ ccaddc) @ cc4 @ ccdiv))))))).
