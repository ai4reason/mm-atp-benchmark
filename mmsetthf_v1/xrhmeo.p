...
thf(aiccpnfcnv_thm,axiom,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc1) @ ccpnf @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ ccdiv)))))) => (! [Xx3:$i] : (cwa @ (cwf1o @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xx3)) @ (cwceq @ (cccnv @ (XF @ Xx3)) @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ ccpnf @ ccicc)) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ ccpnf) @ cc1 @ (cco @ (ccv @ Xy1) @ (cco @ cc1 @ (ccv @ Xy1) @ ccaddc) @ ccdiv)))))))))).
...
thf(ale0neg2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ (ccneg @ XA2) @ ccc0 @ ccle))))).
...
thf(axle0neg1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwbr @ XA2 @ ccc0 @ ccle) @ (cwbr @ ccc0 @ (ccxne @ XA2) @ ccle))))).
...
thf(aiccneg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (ccneg @ XC) @ (cco @ (ccneg @ XB2) @ (ccneg @ XA2) @ ccicc)))))))).
...
thf(axle0neg2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ (ccxne @ XA2) @ ccc0 @ ccle))))).
...
thf(axlt0neg2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ (ccxne @ XA2) @ ccc0 @ cclt))))).
...
thf(aleiso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwss @ XB2 @ ccxr)) @ (cwb @ (cwiso @ XA2 @ XB2 @ cclt @ cclt @ XF) @ (cwiso @ XA2 @ XB2 @ ccle @ ccle @ XF))))))).
thf(aisores1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwb @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwiso @ XA2 @ XB2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ XS @ XH)))))))).
thf(cccn_tp,type,(cccn : ($i > $o))).
thf(aordthmeo_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => ((cwceq @ XY @ (ccdm @ XS)) => (cwi @ (cw3a @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW) @ (cwiso @ XX @ XY @ XR @ XS @ XF)) @ (cwcel @ XF @ (cco @ (ccfv @ XR @ ccordt) @ (ccfv @ XS @ ccordt) @ cchmeo))))))))))))).
...
thf(axrrest2_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XX @ (ccfv @ ccle @ ccordt)) => (cwi @ (cwss @ XA2 @ ccr) @ (cwceq @ (cco @ XJ @ XA2 @ ccrest) @ (cco @ XX @ XA2 @ ccrest))))))))).
