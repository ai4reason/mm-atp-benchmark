...
thf(aaddassnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccplq) @ XC @ ccplq) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccplq) @ ccplq)))))).
thf(caddasspr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccpp) @ XC @ ccpp) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccpp) @ ccpp)))))).
