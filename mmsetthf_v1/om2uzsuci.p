...
thf(com2uzsuci_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwcel @ XC @ ccz) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XC) @ ccom))) => (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ ccom) @ (cwceq @ (ccfv @ (ccsuc @ (XA2 @ Xx3)) @ (XG @ Xx3)) @ (cco @ (ccfv @ (XA2 @ Xx3) @ (XG @ Xx3)) @ cc1 @ ccaddc)))))))))).
