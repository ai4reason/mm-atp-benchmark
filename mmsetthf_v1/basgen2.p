...
thf(abasgen_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XB2 @ XJ) @ (cwss @ XJ @ (ccfv @ XB2 @ cctg))) @ (cwceq @ (ccfv @ XB2 @ cctg) @ XJ))))).
thf(cbasgen2_conj,conjecture,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XB2 @ XJ) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ))) @ (cwceq @ (ccfv @ XB2 @ cctg) @ XJ))))).
