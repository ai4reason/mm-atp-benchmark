...
thf(cstoweidlem11_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xt @ Xj) @ (cwcel @ (XN @ Xj) @ ccn)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xt @ Xj) @ (cwcel @ (ccv @ Xt) @ (XT @ Xi @ Xj)))))) => ((! [Xt:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xt @ Xj) @ (cwcel @ (ccv @ Xj) @ (cco @ cc1 @ (XN @ Xj) @ ccfz))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xj) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz))) @ (cwf @ (XT @ Xi @ Xj) @ ccr @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xj) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz))) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ cc1 @ ccle))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xj) @ (cwcel @ (ccv @ Xi) @ (cco @ (ccv @ Xj) @ (XN @ Xj) @ ccfz))) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ (cco @ (XE @ Xj) @ (XN @ Xj) @ ccdiv) @ cclt))))) => ((! [Xt:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xt @ Xj) @ (cwcel @ (XE @ Xj) @ ccrp)))) => ((! [Xt:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xt @ Xj) @ (cwbr @ (XE @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ cclt)))) => (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xt @ Xj) @ (cwbr @ (ccfv @ (ccv @ Xt) @ (ccmpt @ (^ [Xt:$i] : (XT @ Xi @ Xj)) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ (XN @ Xj) @ ccfz) @ (^ [Xi:$i] : (cco @ (XE @ Xj) @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ ccmul)))))) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ (XE @ Xj) @ ccmul) @ cclt))))))))))))))))))).
