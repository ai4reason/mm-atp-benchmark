...
thf(adf_ass_ax,axiom,(cwceq @ ccass @ (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xz) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xg1)))) @ (^ [Xz:$i] : (ccdm @ (ccdm @ (ccv @ Xg1)))))) @ (^ [Xy1:$i] : (ccdm @ (ccdm @ (ccv @ Xg1)))))) @ (^ [Xx3:$i] : (ccdm @ (ccdm @ (ccv @ Xg1))))))))).
thf(cisass_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ (ccdm @ XG))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XG @ (XA2 @ Xx3 @ Xy1 @ Xz)) @ (cwb @ (cwcel @ XG @ ccass) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))).
