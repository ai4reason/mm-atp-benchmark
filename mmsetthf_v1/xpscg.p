...
thf(cxpscg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (cccnv @ (cco @ (ccsn @ XA2) @ (ccsn @ XB2) @ cccda)) @ (ccpr @ (ccop @ cc0 @ XA2) @ (ccop @ cc1o @ XB2))))))))).
