...
thf(cadd20_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ ccle))) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ ccc0) @ (cwa @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ ccc0))))))).
