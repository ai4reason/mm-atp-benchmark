...
thf(aedgumgr_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg))) @ (cwa @ (cwcel @ XE @ (ccpw @ (ccfv @ XG @ ccvtx))) @ (cwceq @ (ccfv @ XE @ cchash) @ cc2)))))).
thf(ampd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ (cwi @ Xps @ Xch)) => (cwi @ Xph @ Xch))))))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ahash2prde_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ XW) @ (cwceq @ (ccfv @ XV @ cchash) @ cc2)) @ (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwa @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))))))))))).
...
thf(cumgredg_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XE @ Xa @ Xb) @ (ccfv @ XG @ ccedg)))) => (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwcel @ XC @ (XE @ Xa @ Xb))) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwceq @ XC @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))))))))).
