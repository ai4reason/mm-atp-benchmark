...
thf(adf_prob_ax,axiom,(cwceq @ ccprb @ (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccuni @ (ccdm @ (ccv @ Xp))) @ (ccv @ Xp)) @ cc1)) @ (^ [Xp:$i] : (ccuni @ (ccrn @ ccmeas)))))).
thf(celprob_conj,conjecture,(! [XP:($i > $o)] : (cwb @ (cwcel @ XP @ ccprb) @ (cwa @ (cwcel @ XP @ (ccuni @ (ccrn @ ccmeas))) @ (cwceq @ (ccfv @ (ccuni @ (ccdm @ XP)) @ XP) @ cc1))))).
