...
thf(csotrd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwor @ XA2 @ XR)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwi @ Xph @ (cwcel @ XY @ XA2)) => ((cwi @ Xph @ (cwcel @ XZ @ XA2)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ XR)) => ((cwi @ Xph @ (cwbr @ XY @ XZ @ XR)) => (cwi @ Xph @ (cwbr @ XX @ XZ @ XR))))))))))))))).
