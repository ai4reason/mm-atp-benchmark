...
thf(ciprodefisumlem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccc @ XF)) => (cwi @ Xph @ (cwceq @ (ccseq @ ccmul @ (cccom @ cce @ XF) @ XM) @ (cccom @ cce @ (ccseq @ ccaddc @ XF @ XM)))))))))))).
