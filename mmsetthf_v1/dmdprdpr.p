...
thf(cdmdprdpr_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => (cwi @ Xph @ (cwb @ (cwbr @ XG @ (cccnv @ (cco @ (ccsn @ XS) @ (ccsn @ XT) @ cccda)) @ (ccdm @ ccdprd)) @ (cwa @ (cwss @ XS @ (ccfv @ XT @ XZ)) @ (cwceq @ (ccin @ XS @ XT) @ (ccsn @ Xc_0)))))))))))))))).
