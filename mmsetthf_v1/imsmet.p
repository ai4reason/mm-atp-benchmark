...
thf(aimsmetlem_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XM @ (ccfv @ XG @ ccgn)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XZ @ (ccfv @ XU @ ccn0v)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => ((cwcel @ XU @ ccnv) => (cwcel @ XD @ (ccfv @ XX @ ccme))))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(aelimnvu_thm,axiom,(! [XU:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XU @ ccnv) @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) @ ccnv))).
thf(cimsmet_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwcel @ XD @ (ccfv @ XX @ ccme))))))))).
