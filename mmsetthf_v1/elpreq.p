...
thf(celpreq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ (ccpr @ XA2 @ XB2))) => ((cwi @ Xph @ (cwcel @ XY @ (ccpr @ XA2 @ XB2))) => ((cwi @ Xph @ (cwb @ (cwceq @ XX @ XA2) @ (cwceq @ XY @ XA2))) => (cwi @ Xph @ (cwceq @ XX @ XY))))))))))).
