...
thf(ageo2lim_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XF @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccdiv))))) => (! [Xk:$i] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccseq @ ccaddc @ (XF @ Xk) @ cc1) @ XA2 @ ccli))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(csge0ad2en_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XA2 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv))) @ ccsumge0) @ XA2)))))).
