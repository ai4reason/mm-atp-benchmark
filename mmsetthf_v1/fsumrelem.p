...
thf(aaddcani_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XC @ ccaddc)) @ (cwceq @ XB2 @ XC))))))))).
...
thf(aseqhomo_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XS))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XH) @ (cco @ (ccfv @ (ccv @ Xx3) @ XH) @ (ccfv @ (ccv @ Xy1) @ XH) @ XQ))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XH) @ (ccfv @ (ccv @ Xx3) @ (XG @ Xy1)))))) => (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) @ XH) @ (ccfv @ XN @ (ccseq @ XQ @ (XG @ Xy1) @ XM)))))))))))))))))))).
...
thf(afsum_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccfv @ (ccv @ Xn) @ XF)) @ (cwceq @ (XB2 @ Xk) @ (XC @ Xn))))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwf1o @ (cco @ cc1 @ XM @ ccfz) @ XA2 @ XF)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XM @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XG) @ (XC @ Xn)))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccfv @ XM @ (ccseq @ ccaddc @ XG @ cc1))))))))))))))))).
thf(afveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(asumfc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwceq @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))))) @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))))))).
thf(ccen_tp,type,(ccen : ($i > $o))).
thf(ccn0_tp,type,(ccn0 : ($i > $o))).
thf(afz1f1o_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwo @ (cwceq @ XA2 @ cc0) @ (cwa @ (cwcel @ (ccfv @ XA2 @ cchash) @ ccn) @ (cwex @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ XA2 @ (ccv @ Xf1))))))))).
thf(cfsumrelem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((cwf @ ccc @ ccc @ XF) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XF) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccaddc))))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ XF) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ XF)))))))))))))).
