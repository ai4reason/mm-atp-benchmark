...
thf(ctrer_conj,conjecture,(! [Xc_le:($i > $o)] : (cwi @ (cwal @ (^ [Xa:$i] : (cwal @ (^ [Xb:$i] : (cwal @ (^ [Xc:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ Xc_le) @ (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ Xc_le)) @ (cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ Xc_le)))))))) @ (cwer @ (ccdm @ (ccin @ Xc_le @ (cccnv @ Xc_le))) @ (ccin @ Xc_le @ (cccnv @ Xc_le)))))).
