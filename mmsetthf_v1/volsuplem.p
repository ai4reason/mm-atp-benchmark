...
thf(cvolsuplem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xn:$i] : (cwi @ (cwa @ (cwral @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF))) @ (^ [Xn:$i] : ccn)) @ (cwa @ (cwcel @ (XA2 @ Xn) @ ccn) @ (cwcel @ (XB2 @ Xn) @ (ccfv @ (XA2 @ Xn) @ ccuz)))) @ (cwss @ (ccfv @ (XA2 @ Xn) @ XF) @ (ccfv @ (XB2 @ Xn) @ XF)))))))).
