...
thf(ccompss_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwceq @ (ccima @ (XF @ Xx3) @ (XG @ Xx3)) @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccdif @ XA2 @ (ccv @ Xy1)) @ (XG @ Xx3))) @ (^ [Xy1:$i] : (ccpw @ XA2)))))))))).
