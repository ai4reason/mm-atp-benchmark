...
thf(copfusgr_conj,conjecture,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ XX) @ (cwcel @ XE @ XY)) @ (cwb @ (cwcel @ (ccop @ XV @ XE) @ ccfusgr) @ (cwa @ (cwcel @ (ccop @ XV @ XE) @ ccusgr) @ (cwcel @ XV @ ccfn))))))))).
