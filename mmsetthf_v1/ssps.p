...
thf(anvsf_thm,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwf @ (ccxp @ ccc @ XX) @ XX @ XS)))))))).
...
thf(cssps_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XR @ (ccfv @ XW @ ccns)) => ((cwceq @ XH @ (ccfv @ XU @ ccss)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ XH)) @ (cwceq @ XR @ (ccres @ XS @ (ccxp @ ccc @ XY))))))))))))))).
