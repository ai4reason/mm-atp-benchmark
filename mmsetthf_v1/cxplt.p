...
thf(ccxplt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr))) @ (cwb @ (cwbr @ XB2 @ XC @ cclt) @ (cwbr @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ cclt))))))).
