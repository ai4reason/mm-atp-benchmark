...
thf(aiotavalb_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))) @ (cwb @ (cwal @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwceq @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))) @ (ccv @ Xy1))))))).
...
thf(ciotavalsb_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3 @ Xz) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (cwb @ (cwsbc @ (^ [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)) @ (ccv @ Xy1)) @ (cwsbc @ (^ [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)) @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xz)))))))))))).
