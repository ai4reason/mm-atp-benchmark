...
thf(atskpw_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cctsk) @ (cwcel @ XA2 @ XT)) @ (cwcel @ (ccpw @ XA2) @ XT))))).
...
thf(atskpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ cctsk) @ (cwcel @ XA2 @ XT) @ (cwcel @ XB2 @ XT)) @ (cwcel @ (ccpr @ XA2 @ XB2) @ XT)))))).
...
thf(ctskwun_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ cctsk) @ (cwtr @ XT) @ (cwne @ XT @ cc0)) @ (cwcel @ XT @ ccwun)))).
