...
thf(acncficcgt0_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XA2 @ ccr))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XB2 @ ccr))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwbr @ XA2 @ XB2 @ ccle))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XF @ Xx3) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdif @ ccr @ (ccsn @ ccc0)) @ cccncf))))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xy1) @ (ccfv @ (XC @ Xx3) @ ccabs) @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xy1:$i] : ccrp))))))))))))))).
...
thf(afourierdlem28_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwceq @ XD @ (cco @ ccr @ (ccres @ XF @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo)) @ ccdv)) => ((cwi @ Xph @ (cwf @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo) @ ccr @ XD)) => (cwi @ Xph @ (cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))) @ ccdv) @ (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XD)))))))))))))))))).
