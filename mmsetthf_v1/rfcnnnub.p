...
thf(crfcnnnub_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((cwnfc @ (^ [Xt:$i] : (XF @ Xt))) => ((! [Xn:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xt @ Xn)))) => ((! [Xn:$i] : (cwceq @ (XK @ Xn) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xt:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xt @ Xn) @ (cwcel @ (XJ @ Xn) @ cccmp)))) => ((! [Xn:$i] : (cwceq @ XT @ (ccuni @ (XJ @ Xn)))) => ((! [Xt:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xt @ Xn) @ (cwne @ XT @ cc0)))) => ((! [Xt:$i] : (! [Xn:$i] : (cwceq @ (XC @ Xt @ Xn) @ (cco @ (XJ @ Xn) @ (XK @ Xn) @ cccn)))) => ((! [Xt:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xt @ Xn) @ (cwcel @ (XF @ Xt) @ (XC @ Xt @ Xn))))) => (! [Xt:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xt @ Xn) @ (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (XF @ Xt)) @ (ccv @ Xn) @ cclt)) @ (^ [Xt:$i] : XT))) @ (^ [Xn:$i] : ccn)))))))))))))))))))).
