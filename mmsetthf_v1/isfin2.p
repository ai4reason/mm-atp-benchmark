...
thf(adf_fin2_ax,axiom,(cwceq @ ccfin2 @ (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwne @ (ccv @ Xy1) @ cc0) @ (cwor @ (ccv @ Xy1) @ ccrpss)) @ (cwcel @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (ccpw @ (ccv @ Xx3))))))))).
thf(cisfin2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xy1)) @ (cwb @ (cwcel @ XA2 @ ccfin2) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwne @ (ccv @ Xy1) @ cc0) @ (cwor @ (ccv @ Xy1) @ ccrpss)) @ (cwcel @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (ccpw @ XA2)))))))))).
