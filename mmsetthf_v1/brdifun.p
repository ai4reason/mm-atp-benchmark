...
thf(cbrdifun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XR @ (ccdif @ (ccxp @ XX @ XX) @ (ccun @ Xc_lt @ (cccnv @ Xc_lt)))) => (cwi @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwb @ (cwbr @ XA2 @ XB2 @ XR) @ (cwn @ (cwo @ (cwbr @ XA2 @ XB2 @ Xc_lt) @ (cwbr @ XB2 @ XA2 @ Xc_lt)))))))))))).
