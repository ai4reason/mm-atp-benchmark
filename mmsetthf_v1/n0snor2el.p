...
thf(aissn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwex @ (^ [Xz:$i] : (cwceq @ XA2 @ (ccsn @ (ccv @ Xz)))))))).
...
thf(cn0snor2el_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwne @ XA2 @ cc0) @ (cwo @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwne @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwex @ (^ [Xz:$i] : (cwceq @ XA2 @ (ccsn @ (ccv @ Xz))))))))).
