...
thf(csubrgvr1_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => (cwi @ Xph @ (cwceq @ XX @ (ccfv @ XH @ ccv1)))))))))))).
