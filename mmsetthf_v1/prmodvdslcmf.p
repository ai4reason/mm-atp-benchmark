...
thf(aprmoval_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ XN @ ccprmo) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (ccv @ Xk) @ cc1))))))).
...
thf(afvprmselgcd1_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xm:$i] : (cwceq @ (XF @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccif @ (cwcel @ (ccv @ Xm) @ ccprime) @ (ccv @ Xm) @ cc1))))) => (! [Xm:$i] : (cwi @ (cw3a @ (cwcel @ XX @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ XY @ (cco @ cc1 @ XN @ ccfz)) @ (cwne @ XX @ XY)) @ (cwceq @ (cco @ (ccfv @ XX @ (XF @ Xm)) @ (ccfv @ XY @ (XF @ Xm)) @ ccgcd) @ cc1))))))))).
...
thf(advdslcmf_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwa @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XZ @ cclcmf) @ ccdvds)) @ (^ [Xx3:$i] : XZ))))).
...
thf(acoprmproddvds_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xn:$i] : (cwi @ (cw3a @ (cwa @ (cwss @ XM @ ccn) @ (cwcel @ XM @ ccfn)) @ (cwa @ (cwcel @ (XK @ Xn) @ ccn) @ (cwf @ ccn @ ccn @ XF)) @ (cwa @ (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (ccv @ Xn) @ XF) @ ccgcd) @ cc1)) @ (^ [Xn:$i] : (ccdif @ XM @ (ccsn @ (ccv @ Xm)))))) @ (^ [Xm:$i] : XM)) @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ XF) @ (XK @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XM)))) @ (cwbr @ (ccprod @ (^ [Xm:$i] : XM) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xm) @ XF))) @ (XK @ Xn) @ ccdvds))))))).
thf(cprmodvdslcmf_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwbr @ (ccfv @ XN @ ccprmo) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ cclcmf) @ ccdvds)))).
