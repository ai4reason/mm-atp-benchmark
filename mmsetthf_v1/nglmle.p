...
thf(anmval2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((cwceq @ XX @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XD @ (ccfv @ XW @ ccds)) => ((cwceq @ XE @ (ccres @ XD @ (ccxp @ XX @ XX))) => (cwi @ (cwa @ (cwcel @ XW @ ccgrp) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ XA2 @ XN) @ (cco @ XA2 @ Xc_0 @ XE)))))))))))))))).
...
thf(almle_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((cwi @ Xph @ (cwcel @ XQ @ XX)) => ((cwi @ Xph @ (cwcel @ XR @ ccxr)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ (cco @ XQ @ (ccfv @ (ccv @ Xk) @ XF) @ XD) @ XR @ ccle))) => (cwi @ Xph @ (cwbr @ (cco @ XQ @ XP @ XD) @ XR @ ccle))))))))))))))))))))).
...
thf(cnglmle_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XD @ (ccres @ (ccfv @ XG @ ccds) @ (ccxp @ XX @ XX))) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xk:$i] : (cwceq @ (XN @ Xk) @ (ccfv @ XG @ ccnm))) => ((cwi @ Xph @ (cwcel @ XG @ ccngp)) => ((cwi @ Xph @ (cwf @ ccn @ XX @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((cwi @ Xph @ (cwcel @ XR @ ccxr)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (XN @ Xk)) @ XR @ ccle))) => (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ XP @ (XN @ Xk)) @ XR @ ccle)))))))))))))))))))))).
