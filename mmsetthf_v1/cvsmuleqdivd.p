...
thf(aclmring_thm,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => (cwi @ (cwcel @ XW @ ccclm) @ (cwcel @ XF @ ccrg)))))).
...
thf(acvsdivcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ cccvs) @ (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XK) @ (cwne @ XB2 @ ccc0))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ XK)))))))))).
...
thf(ccvsmuleqdivd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwi @ Xph @ (cwcel @ XW @ cccvs)) => ((cwi @ Xph @ (cwcel @ XA2 @ XK)) => ((cwi @ Xph @ (cwcel @ XB2 @ XK)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XX @ Xc_x) @ (cco @ XB2 @ XY @ Xc_x))) => (cwi @ Xph @ (cwceq @ XX @ (cco @ (cco @ XB2 @ XA2 @ ccdiv) @ XY @ Xc_x))))))))))))))))))))))))).
