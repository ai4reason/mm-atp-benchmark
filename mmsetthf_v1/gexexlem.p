...
thf(agexnnod_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XE @ ccn) @ (cwcel @ XA2 @ XX)) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn))))))))))).
...
thf(aodadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccabl) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccgcd) @ cc1)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XO) @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccmul))))))))))))).
...
thf(cgexexlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XE @ ccn)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XX)) @ (cwbr @ (ccfv @ (ccv @ Xy1) @ XO) @ (ccfv @ XA2 @ XO) @ ccle))) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XO) @ XE)))))))))))))))).
