...
thf(celiuniincex_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (ccsn @ cc0))) => ((! [Xx3:$i] : (cwceq @ (XC @ Xx3) @ cc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XD @ Xx3 @ Xy1) @ cc0))) => ((! [Xy1:$i] : (cwceq @ (XZ @ Xy1) @ ccvv)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwn @ (cwb @ (cwcel @ (XZ @ Xy1) @ (XA2 @ Xx3 @ Xy1)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (XZ @ Xy1) @ (XD @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xy1))))))))))))))))).
