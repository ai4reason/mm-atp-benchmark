...
thf(apaddcom_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cw3a @ (cwcel @ XK @ cclat) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) @ (cwceq @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XY @ XX @ Xc_pl))))))))))).
...
thf(cpmod2iN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XS) @ (cwss @ XY @ XA2) @ (cwss @ XZ @ XA2))) @ (cwi @ (cwss @ XZ @ XX) @ (cwceq @ (cco @ (ccin @ XX @ XY) @ XZ @ Xc_pl) @ (ccin @ XX @ (cco @ XY @ XZ @ Xc_pl)))))))))))))))).
