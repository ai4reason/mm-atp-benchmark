...
thf(cqtopcmplem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ (cwcel @ XJ @ XA2) @ (cwcel @ XJ @ cctop)) => ((cwi @ (cw3a @ (cwcel @ XJ @ XA2) @ (cwfo @ XX @ (ccuni @ (cco @ XJ @ XF @ ccqtop)) @ XF) @ (cwcel @ XF @ (cco @ XJ @ (cco @ XJ @ XF @ ccqtop) @ cccn))) @ (cwcel @ (cco @ XJ @ XF @ ccqtop) @ XA2)) => (cwi @ (cwa @ (cwcel @ XJ @ XA2) @ (cwfn @ XF @ XX)) @ (cwcel @ (cco @ XJ @ XF @ ccqtop) @ XA2)))))))))).
