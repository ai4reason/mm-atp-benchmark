...
thf(cunxpdomlem1_conj,conjecture,(! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XF @ Xx3 @ Xt @ Xm @ Xn @ Xs1 @ Xa @ Xb) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xa) @ (ccv @ Xb))) @ (^ [Xx3:$i] : (XG @ Xx3 @ Xz @ Xt @ Xm @ Xn @ Xs1 @ Xa @ Xb)))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XG @ Xx3 @ Xz @ Xt @ Xm @ Xn @ Xs1 @ Xa @ Xb) @ (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) @ (ccop @ (ccv @ Xx3) @ (ccif @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xm)) @ (ccv @ Xt) @ (ccv @ Xs1))) @ (ccop @ (ccif @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xt)) @ (ccv @ Xn) @ (ccv @ Xm)) @ (ccv @ Xx3)))))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccun @ (ccv @ Xa) @ (ccv @ Xb))) @ (cwceq @ (ccfv @ (ccv @ Xz) @ (XF @ Xx3 @ Xt @ Xm @ Xn @ Xs1 @ Xa @ Xb)) @ (ccif @ (cwcel @ (ccv @ Xz) @ (ccv @ Xa)) @ (ccop @ (ccv @ Xz) @ (ccif @ (cwceq @ (ccv @ Xz) @ (ccv @ Xm)) @ (ccv @ Xt) @ (ccv @ Xs1))) @ (ccop @ (ccif @ (cwceq @ (ccv @ Xz) @ (ccv @ Xt)) @ (ccv @ Xn) @ (ccv @ Xm)) @ (ccv @ Xz)))))))))))))))))).
