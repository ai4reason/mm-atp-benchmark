...
thf(a_4001lem1_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => (cwceq @ (cco @ (cco @ cc2 @ (ccdc @ (ccdc @ cc2 @ ccc0) @ ccc0) @ ccexp) @ XN @ ccmo) @ (cco @ (ccdc @ (ccdc @ cc9 @ ccc0) @ cc2) @ XN @ ccmo))))).
...
thf(c_4001lem2_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => (cwceq @ (cco @ (cco @ cc2 @ (ccdc @ (ccdc @ cc8 @ ccc0) @ ccc0) @ ccexp) @ XN @ ccmo) @ (cco @ (ccdc @ (ccdc @ (ccdc @ cc2 @ cc3) @ cc1) @ cc1) @ XN @ ccmo))))).
