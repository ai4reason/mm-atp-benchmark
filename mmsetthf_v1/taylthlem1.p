...
thf(advntaylp0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))))) => ((cwceq @ XT @ (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl))) => (cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ (ccfv @ XM @ (cco @ ccc @ XT @ ccdvn))) @ (ccfv @ XB2 @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)))))))))))))))))))).
...
thf(advnf_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) @ (cwcel @ XN @ ccn0)) @ (cwf @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))) @ ccc @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn)))))))).
...
thf(advnbss_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) @ (cwcel @ XN @ ccn0)) @ (cwss @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))) @ (ccdm @ XF))))))).
...
thf(advn2bss_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) @ (cwss @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))) @ (ccdm @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)))))))))).
...
thf(ataylpf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))))) => ((cwceq @ XT @ (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl))) => (cwi @ Xph @ (cwf @ ccc @ ccc @ XT)))))))))))))))).
...
thf(advn1_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ ccc) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) @ (cwceq @ (ccfv @ cc1 @ (cco @ XS @ XF @ ccdvn)) @ (cco @ XS @ XF @ ccdv)))))).
...
thf(advntaylp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))) => (cwi @ Xph @ (cwceq @ (ccfv @ XM @ (cco @ ccc @ (cco @ (cco @ XN @ XM @ ccaddc) @ XB2 @ (cco @ XS @ XF @ cctayl)) @ ccdvn)) @ (cco @ XN @ XB2 @ (cco @ XS @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)) @ cctayl)))))))))))))))))).
...
thf(ctaylthlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))) @ XA2)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XB2 @ XA2)) => ((cwceq @ XT @ (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccmin) @ (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ XN @ ccexp) @ ccdiv))))))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfzo)) @ (cwcel @ ccc0 @ (cco @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xy1:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (cco @ XN @ (ccv @ Xn) @ ccmin) @ (cco @ XS @ XF @ ccdvn))) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (cco @ XN @ (ccv @ Xn) @ ccmin) @ (cco @ ccc @ XT @ ccdvn))) @ ccmin) @ (cco @ (cco @ (ccv @ Xy1) @ XB2 @ ccmin) @ (ccv @ Xn) @ ccexp) @ ccdiv))) @ XB2 @ cclimc)))) @ (cwcel @ ccc0 @ (cco @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmin) @ (cco @ XS @ XF @ ccdvn))) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmin) @ (cco @ ccc @ XT @ ccdvn))) @ ccmin) @ (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccexp) @ ccdiv))) @ XB2 @ cclimc)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ ccc0 @ (cco @ (XR @ Xx3 @ Xy1 @ Xn) @ XB2 @ cclimc)))))))))))))))))))))))).
