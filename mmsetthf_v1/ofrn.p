...
thf(cofrn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XG)) => ((cwi @ Xph @ (cwf @ (ccxp @ XB2 @ XB2) @ XC @ Xc_pl)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => (cwi @ Xph @ (cwss @ (ccrn @ (cco @ XF @ XG @ (ccof @ Xc_pl))) @ XC))))))))))))))).
