...
thf(ctchcphlem1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwi @ Xph @ (cwcel @ XW @ ccphl)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ XF @ (cco @ cccnfld @ (XK @ Xx3) @ ccress)))) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XK @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ (XK @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XV)) @ (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccle))) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ XF @ ccbs))) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XX @ XY @ Xc_mi) @ Xc_xi) @ ccsqrt) @ (cco @ (ccfv @ (cco @ XX @ XX @ Xc_xi) @ ccsqrt) @ (ccfv @ (cco @ XY @ XY @ Xc_xi) @ ccsqrt) @ ccaddc) @ ccle))))))))))))))))))))))))).
