...
thf(celsnxpOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwb @ (cwcel @ XZ @ (ccxp @ (ccsn @ XX) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ XZ @ (ccop @ XX @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))))))).
