...
thf(ccoe1sclmul2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ Xc_xb @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XB2)) @ (cwceq @ (ccfv @ (cco @ XY @ (ccfv @ XX @ XA2) @ Xc_xb) @ ccco1) @ (cco @ (ccfv @ XY @ ccco1) @ (ccxp @ ccn0 @ (ccsn @ XX)) @ (ccof @ Xc_x)))))))))))))))))))).
