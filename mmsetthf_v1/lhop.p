...
thf(aioojoin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XB2 @ XC @ cclt))) @ (cwceq @ (ccun @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XB2)) @ (cco @ XB2 @ XC @ ccioo)) @ (cco @ XA2 @ XC @ ccioo))))))).
...
thf(alimcun_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwss @ XB2 @ ccc)) => ((cwi @ Xph @ (cwf @ (ccun @ XA2 @ XB2) @ ccc @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XC @ cclimc) @ (ccin @ (cco @ (ccres @ XF @ XA2) @ XC @ cclimc) @ (cco @ (ccres @ XF @ XB2) @ XC @ cclimc))))))))))))).
