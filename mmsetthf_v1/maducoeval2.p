...
thf(apm2_1_thm,axiom,(! [Xph:$o] : (cwo @ (cwn @ Xph) @ Xph))).
...
thf(cmaducoeval2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XA2 @ Xk @ Xl) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XD @ Xk @ Xl) @ (cco @ XN @ XR @ ccmdat)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XJ @ Xk @ Xl) @ (cco @ XN @ XR @ ccmadu)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xk @ Xl) @ ccbs)))) => ((! [Xl:$i] : (cwceq @ (Xc_1 @ Xl) @ (ccfv @ XR @ ccur))) => ((! [Xl:$i] : (cwceq @ (Xc_0 @ Xl) @ (ccfv @ XR @ cc0g))) => (! [Xk:$i] : (! [Xl:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) @ (cwcel @ XI @ XN) @ (cwcel @ XH @ XN)) @ (cwceq @ (cco @ XI @ XH @ (ccfv @ XM @ (XJ @ Xk @ Xl))) @ (ccfv @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccif @ (cwo @ (cwceq @ (ccv @ Xk) @ XH) @ (cwceq @ (ccv @ Xl) @ XI)) @ (ccif @ (cwa @ (cwceq @ (ccv @ Xl) @ XI) @ (cwceq @ (ccv @ Xk) @ XH)) @ (Xc_1 @ Xl) @ (Xc_0 @ Xl)) @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ XM))))) @ (XD @ Xk @ Xl)))))))))))))))))))))))).
