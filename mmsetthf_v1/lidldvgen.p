...
thf(arspsn_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccrsp)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XG @ XB2)) @ (cwceq @ (ccfv @ (ccsn @ XG) @ XK) @ (ccab @ (^ [Xx3:$i] : (cwbr @ XG @ (ccv @ Xx3) @ Xc_pa)))))))))))))).
...
thf(clidldvgen_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ XK @ (ccfv @ XR @ ccrsp)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwcel @ XG @ XB2)) @ (cwb @ (cwceq @ XI @ (ccfv @ (ccsn @ XG) @ XK)) @ (cwa @ (cwcel @ XG @ XI) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XG @ (ccv @ Xx3) @ Xc_pa)) @ (^ [Xx3:$i] : XI))))))))))))))))).
