...
thf(ccvxcl_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XD) @ (cwcel @ (ccv @ Xy1) @ XD))) @ (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XD)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwcel @ (XT @ Xx3 @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwcel @ (cco @ (cco @ (XT @ Xx3 @ Xy1) @ XX @ ccmul) @ (cco @ (cco @ cc1 @ (XT @ Xx3 @ Xy1) @ ccmin) @ XY @ ccmul) @ ccaddc) @ XD)))))))))))).
