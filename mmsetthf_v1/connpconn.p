...
thf(aconnclo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ Xph @ (cwcel @ XJ @ ccconn)) => ((cwi @ Xph @ (cwcel @ XA2 @ XJ)) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XJ @ cccld))) => (cwi @ Xph @ (cwceq @ XA2 @ XX)))))))))))).
...
thf(apconncn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XX @ Xf1) @ (ccuni @ XJ))) => (! [Xf1:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ ccpconn) @ (cwcel @ XA2 @ (XX @ Xf1)) @ (cwcel @ XB2 @ (XX @ Xf1))) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ XA2) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xf1)) @ XB2))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))))))).
...
thf(aisclo2_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ XA2 @ (ccin @ XJ @ (ccfv @ XJ @ cccld))) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ XA2) @ (cwss @ (ccv @ Xy1) @ XA2))) @ (^ [Xz:$i] : (ccv @ Xy1))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XX))))))))).
...
thf(cconnpconn_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccconn) @ (cwcel @ XJ @ (ccnlly @ ccpconn))) @ (cwcel @ XJ @ ccpconn)))).
