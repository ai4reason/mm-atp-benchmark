...
thf(cresmgmhm2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XU @ ccmgmhm)) @ (cwcel @ XX @ (ccfv @ XT @ ccsubmgm))) @ (cwcel @ XF @ (cco @ XS @ XT @ ccmgmhm)))))))))).
