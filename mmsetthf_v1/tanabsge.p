...
thf(atan0_thm,axiom,(cwceq @ (ccfv @ ccc0 @ cctan) @ ccc0)).
...
thf(ctanabsge_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccabs) @ ccle)))).
