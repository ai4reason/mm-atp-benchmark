...
thf(asotri3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwor @ XS @ XR) => ((cwss @ XR @ (ccxp @ XS @ XS)) => (cwi @ (cw3a @ (cwcel @ XC @ XS) @ (cwbr @ XA2 @ XB2 @ XR) @ (cwn @ (cwbr @ XC @ XB2 @ XR))) @ (cwbr @ XA2 @ XC @ XR)))))))))).
...
thf(apinq_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ (ccop @ XA2 @ cc1o) @ ccnq)))).
...
thf(carchnq_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccnq) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccop @ (ccv @ Xx3) @ cc1o) @ ccltq)) @ (^ [Xx3:$i] : ccnpi))))).
