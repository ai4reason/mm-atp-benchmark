...
thf(aceilcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccceil) @ ccz)))).
...
thf(cflleceil_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ XA2 @ ccfl) @ (ccfv @ XA2 @ ccceil) @ ccle)))).
