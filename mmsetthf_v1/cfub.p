...
thf(ccfub_conj,conjecture,(! [XA2:($i > $o)] : (cwss @ (ccfv @ XA2 @ cccf) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ XA2 @ (ccuni @ (ccv @ Xy1))))))))))))).
