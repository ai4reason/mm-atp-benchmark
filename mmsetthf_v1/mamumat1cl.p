...
thf(cmamumat1cl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xi @ Xj) @ ccrg)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_1 @ Xi @ Xj) @ (ccfv @ (XR @ Xi @ Xj) @ ccur)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_0 @ Xi @ Xj) @ (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ (ccv @ Xj)) @ (Xc_1 @ Xi @ Xj) @ (Xc_0 @ Xi @ Xj)))))))) => ((cwi @ Xph @ (cwcel @ XM @ ccfn)) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XI @ Xi @ Xj) @ (cco @ XB2 @ (ccxp @ XM @ XM) @ ccmap))))))))))))))))))).
