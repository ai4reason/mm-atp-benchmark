...
thf(cbpolysum_conj,conjecture,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ ccc)) @ (cwceq @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (ccv @ Xk) @ XX @ ccbp) @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ (cco @ XX @ XN @ ccexp)))))).
