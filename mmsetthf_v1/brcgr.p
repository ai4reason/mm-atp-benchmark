...
thf(adf_cgr_ax,axiom,(cwceq @ cccgr @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccxp @ (ccfv @ (ccv @ Xn) @ ccee) @ (ccfv @ (ccv @ Xn) @ ccee))) @ (cwcel @ (ccv @ Xy1) @ (ccxp @ (ccfv @ (ccv @ Xn) @ ccee) @ (ccfv @ (ccv @ Xn) @ ccee)))) @ (cwceq @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xi:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (ccfv @ (ccv @ Xx3) @ cc1st)) @ (ccfv @ (ccv @ Xi) @ (ccfv @ (ccv @ Xx3) @ cc2nd)) @ ccmin) @ cc2 @ ccexp))) @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xi:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (ccfv @ (ccv @ Xi) @ (ccfv @ (ccv @ Xy1) @ cc2nd)) @ ccmin) @ cc2 @ ccexp)))))) @ (^ [Xn:$i] : ccn))))))).
...
thf(aeedimeq_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XM @ ccee))) @ (cwceq @ XN @ XM)))))).
