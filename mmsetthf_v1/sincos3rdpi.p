...
thf(acoshalfpim_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccmin) @ cccos) @ (ccfv @ XA2 @ ccsin))))).
...
thf(asinhalfpim_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccmin) @ ccsin) @ (ccfv @ XA2 @ cccos))))).
thf(csincos3rdpi_conj,conjecture,(cwa @ (cwceq @ (ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ ccsin) @ (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)) @ (cwceq @ (ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ cccos) @ (cco @ cc1 @ cc2 @ ccdiv)))).
