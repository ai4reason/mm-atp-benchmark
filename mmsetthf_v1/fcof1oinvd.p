...
thf(cfcof1oinvd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf1o @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XB2 @ XA2 @ XG)) => ((cwi @ Xph @ (cwceq @ (cccom @ XF @ XG) @ (ccres @ ccid @ XB2))) => (cwi @ Xph @ (cwceq @ (cccnv @ XF) @ XG))))))))))).
