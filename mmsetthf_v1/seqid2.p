...
thf(auzind4_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ XM) @ (cwb @ (Xph @ Xj) @ (Xps @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xch @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xj) @ (Xth @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (XN @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xta @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwcel @ XM @ ccz) @ (Xps @ Xk))) => ((! [Xk:$i] : (cwi @ (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz)) @ (cwi @ (Xch @ Xk) @ (Xth @ Xk)))) => (! [Xk:$i] : (cwi @ (cwcel @ (XN @ Xk) @ (ccfv @ XM @ ccuz)) @ (Xta @ Xk))))))))))))))))).
...
thf(apeano2fzr_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ (ccfv @ XM @ ccuz)) @ (cwcel @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ XK @ (cco @ XM @ XN @ ccfz))))))).
...
thf(cseqid2_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwceq @ (cco @ (ccv @ Xx3) @ XZ @ Xc_pl) @ (ccv @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XK @ ccuz))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XK @ (ccseq @ Xc_pl @ XF @ XM)) @ XS)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XZ))) => (cwi @ Xph @ (cwceq @ (ccfv @ XK @ (ccseq @ Xc_pl @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)))))))))))))))))).
