...
thf(cisfne3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XX @ Xx3 @ Xy1) @ (ccuni @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XY @ Xx3 @ Xy1) @ (ccuni @ XB2)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XB2 @ XC) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwa @ (cwceq @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1)) @ (cwral @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwss @ (ccv @ Xy1) @ XB2) @ (cwceq @ (ccv @ Xx3) @ (ccuni @ (ccv @ Xy1))))))) @ (^ [Xx3:$i] : XA2))))))))))))))).
