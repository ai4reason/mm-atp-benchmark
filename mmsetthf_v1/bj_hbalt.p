...
thf(cbj_hbalt_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwal @ (^ [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))))) @ (cwi @ (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))))).
