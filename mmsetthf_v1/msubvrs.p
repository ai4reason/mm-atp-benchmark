...
thf(aelmsubrn_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((! [Xf1:$i] : (cwceq @ XE @ (ccfv @ (XT @ Xf1) @ ccmex))) => ((! [Xf1:$i] : (cwceq @ XO @ (ccfv @ (XT @ Xf1) @ ccmrsub))) => ((! [Xe:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xe @ Xf1) @ (ccfv @ (XT @ Xf1) @ ccmsub)))) => (! [Xe:$i] : (! [Xf1:$i] : (cwceq @ (ccrn @ (XS @ Xe @ Xf1)) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : (ccrn @ XO)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xe:$i] : XE) @ (^ [Xe:$i] : (ccop @ (ccfv @ (ccv @ Xe) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xe) @ cc2nd) @ (ccv @ Xf1))))))))))))))))))).
...
thf(amrsubvrs_thm,axiom,(! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccfv @ XT @ ccmrex))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XX @ (XR @ Xx3))) @ (cwceq @ (ccin @ (ccrn @ (ccfv @ XX @ XF)) @ XV) @ (cciun @ (^ [Xx3:$i] : (ccin @ (ccrn @ XX) @ XV)) @ (^ [Xx3:$i] : (ccin @ (ccrn @ (ccfv @ (ccs1 @ (ccv @ Xx3)) @ XF)) @ XV)))))))))))))))).
...
thf(amvrsval_thm,axiom,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XW @ (ccfv @ XT @ ccmvrs)) => (cwi @ (cwcel @ XX @ XE) @ (cwceq @ (ccfv @ XX @ XW) @ (ccin @ (ccrn @ (ccfv @ XX @ cc2nd)) @ XV)))))))))))).
...
thf(amvhval_thm,axiom,(! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XY @ (ccfv @ XT @ ccmty)) => ((cwceq @ XH @ (ccfv @ XT @ ccmvh)) => (cwi @ (cwcel @ XX @ XV) @ (cwceq @ (ccfv @ XX @ XH) @ (ccop @ (ccfv @ XX @ XY) @ (ccs1 @ XX))))))))))))).
