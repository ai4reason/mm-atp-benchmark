...
thf(clssatomic_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xq:$i] : (cwceq @ (XS @ Xq) @ (ccfv @ XW @ cclss))) => ((! [Xq:$i] : (cwceq @ (Xc_0 @ Xq) @ (ccfv @ XW @ cc0g))) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((! [Xq:$i] : (cwi @ (Xph @ Xq) @ (cwcel @ XW @ cclmod))) => ((! [Xq:$i] : (cwi @ (Xph @ Xq) @ (cwcel @ XU @ (XS @ Xq)))) => ((! [Xq:$i] : (cwi @ (Xph @ Xq) @ (cwne @ XU @ (ccsn @ (Xc_0 @ Xq))))) => (! [Xq:$i] : (cwi @ (Xph @ Xq) @ (cwrex @ (^ [Xq:$i] : (cwss @ (ccv @ Xq) @ XU)) @ (^ [Xq:$i] : XA2))))))))))))))))).
