...
thf(amuleqadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccaddc)) @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ XB2 @ cc1 @ ccmin) @ ccmul) @ cc1)))))).
thf(cconjmul_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XP @ ccc) @ (cwne @ XP @ ccc0)) @ (cwa @ (cwcel @ XQ @ ccc) @ (cwne @ XQ @ ccc0))) @ (cwb @ (cwceq @ (cco @ (cco @ cc1 @ XP @ ccdiv) @ (cco @ cc1 @ XQ @ ccdiv) @ ccaddc) @ cc1) @ (cwceq @ (cco @ (cco @ XP @ cc1 @ ccmin) @ (cco @ XQ @ cc1 @ ccmin) @ ccmul) @ cc1)))))).
