...
thf(aexpcnv_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccc))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccexp))) @ ccc0 @ ccli)))))))).
...
thf(aexpdiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwa @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ XN @ ccexp) @ (cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccdiv))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(a_1exp_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (cco @ cc1 @ XN @ ccexp) @ cc1)))).
thf(cstoweidlem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XF @ Xi) @ (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ (ccv @ Xi) @ ccexp))))) => ((! [Xi:$i] : (cwceq @ (XG @ Xi) @ (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ XB2 @ (ccv @ Xi) @ ccexp))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ cc1 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ XB2 @ cc1 @ cclt)) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => (cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (cwa @ (cwbr @ (cco @ cc1 @ XE @ ccmin) @ (cco @ cc1 @ (cco @ XB2 @ (ccv @ Xn) @ ccexp) @ ccmin) @ cclt) @ (cwbr @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ XE @ cclt))) @ (^ [Xn:$i] : ccn))))))))))))))))).
