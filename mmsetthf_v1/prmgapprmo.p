...
thf(aprmgaplem8_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XN @ ccn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XF @ (cco @ ccn @ ccn @ ccmap)))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xi:$i] : (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ XF) @ (ccv @ Xi) @ ccaddc) @ (ccv @ Xi) @ ccgcd) @ cclt)) @ (^ [Xi:$i] : (cco @ cc2 @ XN @ ccfz))))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwbr @ XN @ (cco @ (ccv @ Xq) @ (ccv @ Xp) @ ccmin) @ ccle) @ (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))))))))))).
...
thf(aprmgapprmolem_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) @ (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ ccprmo) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
...
thf(cprmgapprmo_conj,conjecture,(cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwbr @ (ccv @ Xn) @ (cco @ (ccv @ Xq) @ (ccv @ Xp) @ ccmin) @ ccle) @ (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))) @ (^ [Xn:$i] : ccn))).
