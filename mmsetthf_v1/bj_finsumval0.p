...
thf(adf_bj_finsum_ax,axiom,(cwceq @ ccfinsum @ (ccmpt @ (^ [Xx3:$i] : (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ cccmn) @ (cwrex @ (^ [Xt:$i] : (cwf @ (ccv @ Xt) @ (ccfv @ (ccv @ Xy1) @ ccbs) @ (ccv @ Xz))) @ (^ [Xt:$i] : ccfn))))))) @ (^ [Xx3:$i] : (ccio @ (^ [Xs1:$i] : (cwrex @ (^ [Xm:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (ccdm @ (ccfv @ (ccv @ Xx3) @ cc2nd)) @ (ccv @ Xf1)) @ (cwceq @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xm) @ (ccseq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ ccplusg) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ cc2nd)))) @ cc1))))))) @ (^ [Xm:$i] : ccn0)))))))).
...
thf(aseqeq123d_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwceq @ XM @ XN)) => ((cwi @ Xph @ (cwceq @ Xc_pl @ XQ)) => ((cwi @ Xph @ (cwceq @ XF @ XG)) => (cwi @ Xph @ (cwceq @ (ccseq @ Xc_pl @ XF @ XM) @ (ccseq @ XQ @ XG @ XN)))))))))))))).
...
thf(cbj_finsumval0_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ cccmn))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XI @ Xm @ Xs1) @ ccfn))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xn) @ (cwf @ (XI @ Xm @ Xs1) @ (ccfv @ XA2 @ ccbs) @ XB2))))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (cco @ XA2 @ XB2 @ ccfinsum) @ (ccio @ (^ [Xs1:$i] : (cwrex @ (^ [Xm:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (XI @ Xm @ Xs1) @ (ccv @ Xf1)) @ (cwceq @ (ccv @ Xs1) @ (ccfv @ (ccfv @ (XI @ Xm @ Xs1) @ cchash) @ (ccseq @ (ccfv @ XA2 @ ccplusg) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ XB2))) @ cc1))))))) @ (^ [Xm:$i] : ccn0))))))))))))))).
