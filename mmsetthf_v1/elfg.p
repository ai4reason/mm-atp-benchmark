...
thf(celfg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XF @ (ccfv @ (XX @ Xx3) @ ccfbas)) @ (cwb @ (cwcel @ XA2 @ (cco @ (XX @ Xx3) @ XF @ ccfg)) @ (cwa @ (cwss @ XA2 @ (XX @ Xx3)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XF)))))))))).
