...
thf(anvnd_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XZ @ (ccfv @ XU @ ccn0v)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ XA2 @ XN) @ (cco @ XA2 @ XZ @ XD)))))))))))))).
...
thf(abcth2_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwne @ XX @ cc0)) @ (cwa @ (cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM) @ (cwceq @ (ccuni @ (ccrn @ XM)) @ XX))) @ (cwrex @ (^ [Xk:$i] : (cwne @ (ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ ccnt)) @ cc0)) @ (^ [Xk:$i] : ccn))))))))).
