...
thf(amulgnnass_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cwa @ (cwcel @ XG @ ccsgrp) @ (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn) @ (cwcel @ XX @ XB2))) @ (cwceq @ (cco @ (cco @ XM @ XN @ ccmul) @ XX @ Xc_x) @ (cco @ XM @ (cco @ XN @ XX @ Xc_x) @ Xc_x)))))))))))).
...
thf(cmulgnn0ass_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => (cwi @ (cwa @ (cwcel @ XG @ ccmnd) @ (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XB2))) @ (cwceq @ (cco @ (cco @ XM @ XN @ ccmul) @ XX @ Xc_x) @ (cco @ XM @ (cco @ XN @ XX @ Xc_x) @ Xc_x)))))))))))).
