...
thf(c_0rngo_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwb @ (cwceq @ XZ @ XU) @ (cwceq @ XX @ (ccsn @ XZ)))))))))))))))).
