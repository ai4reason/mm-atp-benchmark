...
thf(adf_ph_ax,axiom,(cwceq @ cccphlo @ (ccin @ ccnv @ (ccoprab @ (^ [Xg1:$i] : (^ [Xs1:$i] : (^ [Xn:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xn)) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (ccneg @ cc1) @ (ccv @ Xy1) @ (ccv @ Xs1)) @ (ccv @ Xg1)) @ (ccv @ Xn)) @ cc2 @ ccexp) @ ccaddc) @ (cco @ cc2 @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xn)) @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xn)) @ cc2 @ ccexp) @ ccaddc) @ ccmul))) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xg1))))) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1))))))))))).
