...
thf(clsmless12_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) @ (cwa @ (cwss @ XR @ XS) @ (cwss @ XT @ XU))) @ (cwss @ (cco @ XR @ XT @ Xc_po) @ (cco @ XS @ XU @ Xc_po))))))))))).
