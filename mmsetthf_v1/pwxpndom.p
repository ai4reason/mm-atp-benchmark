...
thf(apwxpndom2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwn @ (cwbr @ (ccpw @ XA2) @ (cco @ XA2 @ (ccxp @ XA2 @ XA2) @ cccda) @ ccdom))))).
...
thf(cpwxpndom_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwn @ (cwbr @ (ccpw @ XA2) @ (ccxp @ XA2 @ XA2) @ ccdom))))).
