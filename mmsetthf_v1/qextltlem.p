...
thf(cqextltlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwn @ (cwb @ (cwbr @ (ccv @ Xx3) @ XA2 @ cclt) @ (cwbr @ (ccv @ Xx3) @ XB2 @ cclt))) @ (cwn @ (cwb @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccle) @ (cwbr @ (ccv @ Xx3) @ XB2 @ ccle))))) @ (^ [Xx3:$i] : ccq))))))).
