...
thf(cmatgsumcl_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xr:$i] : (cwceq @ (XA2 @ Xr) @ (cco @ XN @ XR @ ccmat))) => ((! [Xr:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xr) @ ccbs))) => ((! [Xr:$i] : (cwceq @ (XU @ Xr) @ (ccfv @ XR @ ccmgp))) => (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) @ (cwcel @ (cco @ (XU @ Xr) @ (ccmpt @ (^ [Xr:$i] : XN) @ (^ [Xr:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xr) @ XM))) @ ccgsu) @ (ccfv @ XR @ ccbs)))))))))))))).
