...
thf(aaddid0_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ ccc) @ (cwcel @ XY @ ccc)) @ (cwb @ (cwceq @ (cco @ XX @ XY @ ccaddc) @ XX) @ (cwceq @ XY @ ccc0)))))).
thf(caddn0nid_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ ccc) @ (cwcel @ XY @ ccc) @ (cwne @ XY @ ccc0)) @ (cwne @ (cco @ XX @ XY @ ccaddc) @ XX))))).
