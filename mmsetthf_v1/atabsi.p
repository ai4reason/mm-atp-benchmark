...
thf(aatmd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccch)) @ (cwbr @ XA2 @ XB2 @ ccmd))))).
...
thf(aatnssm0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwn @ (cwss @ XB2 @ XA2)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)))))).
thf(ccort_tp,type,(ccort : ($i > $o))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccfv_tp,type,(ccfv : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(achj0i_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwceq @ (cco @ XA2 @ cc0h @ cchj) @ XA2)))).
thf(catabsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwcel @ XC @ ccat) @ (cwi @ (cwn @ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj))) @ (cwceq @ (ccin @ (cco @ XA2 @ XC @ cchj) @ XB2) @ (ccin @ XA2 @ XB2)))))))))).
