...
thf(adf_t1_ax,axiom,(cwceq @ cct1 @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xa:$i] : (cwcel @ (ccsn @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ cccld))) @ (^ [Xa:$i] : (ccuni @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : cctop)))).
thf(cist1_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XX @ Xa) @ (ccuni @ XJ))) => (cwb @ (cwcel @ XJ @ cct1) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xa:$i] : (cwcel @ (ccsn @ (ccv @ Xa)) @ (ccfv @ XJ @ cccld))) @ (^ [Xa:$i] : (XX @ Xa))))))))).
