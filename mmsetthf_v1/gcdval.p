...
thf(adf_gcd_ax,axiom,(cwceq @ ccgcd @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwa @ (cwceq @ (ccv @ Xx3) @ ccc0) @ (cwceq @ (ccv @ Xy1) @ ccc0)) @ ccc0 @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccdvds) @ (cwbr @ (ccv @ Xn) @ (ccv @ Xy1) @ ccdvds))) @ (^ [Xn:$i] : ccz)) @ ccr @ cclt))))))).
...
thf(cgcdval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ (ccif @ (cwa @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)) @ ccc0 @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwbr @ (ccv @ Xn) @ XM @ ccdvds) @ (cwbr @ (ccv @ Xn) @ XN @ ccdvds))) @ (^ [Xn:$i] : ccz)) @ ccr @ cclt))))))).
