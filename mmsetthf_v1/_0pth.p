...
thf(c_0pth_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XW) @ (cwb @ (cwbr @ cc0 @ XP @ (ccfv @ XG @ ccpths)) @ (cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP))))))))).
