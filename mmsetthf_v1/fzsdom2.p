...
thf(cfzsdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) @ (cwcel @ XC @ ccz)) @ (cwbr @ XB2 @ XC @ cclt)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccfz) @ (cco @ XA2 @ XC @ ccfz) @ ccsdm)))))).
