...
thf(agrpoinvfval_thm,axiom,(! [XU:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((! [Xy1:$i] : (cwceq @ (XU @ Xy1) @ (ccfv @ XG @ ccgi))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (ccfv @ XG @ ccgn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XG @ ccgr) @ (cwceq @ (XN @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) @ (XU @ Xy1))) @ (^ [Xy1:$i] : XX)))))))))))))))).
...
thf(cgrpoinvf_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XN @ (ccfv @ XG @ ccgn)) => (cwi @ (cwcel @ XG @ ccgr) @ (cwf1o @ XX @ XX @ XN)))))))).
