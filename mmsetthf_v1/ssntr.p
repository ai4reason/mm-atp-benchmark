...
thf(cssntr_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwa @ (cwcel @ XO @ XJ) @ (cwss @ XO @ XS))) @ (cwss @ XO @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)))))))))).
