...
thf(csge0nemnf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwi @ Xph @ (cwne @ (ccfv @ XF @ ccsumge0) @ ccmnf))))))))).
