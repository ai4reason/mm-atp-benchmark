...
thf(adf_fin1a_ax,axiom,(cwceq @ ccfin1a @ (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwo @ (cwcel @ (ccv @ Xy1) @ ccfn) @ (cwcel @ (ccdif @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccfn))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xx3)))))))).
thf(cisfin1a_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xy1)) @ (cwb @ (cwcel @ XA2 @ ccfin1a) @ (cwral @ (^ [Xy1:$i] : (cwo @ (cwcel @ (ccv @ Xy1) @ ccfn) @ (cwcel @ (ccdif @ XA2 @ (ccv @ Xy1)) @ ccfn))) @ (^ [Xy1:$i] : (ccpw @ XA2))))))))).
