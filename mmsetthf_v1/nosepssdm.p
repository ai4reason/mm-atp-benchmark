...
thf(afuneldmb_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwn @ (cwcel @ cc0 @ (ccrn @ XF)))) @ (cwb @ (cwcel @ XA2 @ (ccdm @ XF)) @ (cwne @ (ccfv @ XA2 @ XF) @ cc0)))))).
...
thf(cnosepssdm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwne @ XA2 @ XB2)) @ (cwss @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccon0))) @ (ccdm @ XA2)))))).
