...
thf(analset_thm,axiom,(cwn @ (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))).
...
thf(ckmlem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xw:$i] : (cwb @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (cwral @ (^ [Xz:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))))).
