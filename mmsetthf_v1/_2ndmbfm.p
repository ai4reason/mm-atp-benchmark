...
thf(asxuni_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) @ (cwceq @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT)) @ (ccuni @ (cco @ XS @ XT @ ccsx))))))).
...
thf(aunielsiga_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ (ccuni @ XS) @ XS)))).
...
thf(asgon_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ XS @ (ccfv @ (ccuni @ XS) @ ccsiga))))).
...
thf(apwssb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwss @ XA2 @ (ccpw @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XB2)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(asylanblrc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (Xch => ((cwb @ Xth @ (cwa @ Xps @ Xch)) => (cwi @ Xph @ Xth))))))))).
...
thf(aelsx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XT @ XW)) @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XT))) @ (cwcel @ (ccxp @ XA2 @ XB2) @ (cco @ XS @ XT @ ccsx)))))))))).
...
thf(c_2ndmbfm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => (cwi @ Xph @ (cwcel @ (ccres @ cc2nd @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT))) @ (cco @ (cco @ XS @ XT @ ccsx) @ XT @ ccmbfm))))))))).
