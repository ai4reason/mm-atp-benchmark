...
thf(adfid6_thm,axiom,(cwceq @ ccid @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : (ccsn @ cc1)) @ (^ [Xn:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccrelexp))))))).
...
thf(cfvilbdRP_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => (cwi @ Xph @ (cwss @ XR @ (ccfv @ XR @ ccid))))))).
