...
thf(aopelcnvg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD)) @ (cwb @ (cwcel @ (ccop @ XA2 @ XB2) @ (cccnv @ XR)) @ (cwcel @ (ccop @ XB2 @ XA2) @ XR))))))))).
...
thf(cfvimacnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwcel @ XA2 @ (ccdm @ XF))) @ (cwb @ (cwcel @ (ccfv @ XA2 @ XF) @ XB2) @ (cwcel @ XA2 @ (ccima @ (cccnv @ XF) @ XB2)))))))).
