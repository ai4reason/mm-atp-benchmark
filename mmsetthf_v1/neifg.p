...
thf(aopnfbas_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ XS @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XJ)) @ (ccfv @ XX @ ccfbas)))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(ccmpt2_tp,type,(ccmpt2 : (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > ($i > $o)))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(afgval_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwceq @ (cco @ XX @ XF @ ccfg) @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ XF @ (ccpw @ (ccv @ Xx3))) @ cc0)) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
...
thf(cneifg_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) @ (cwceq @ (cco @ XX @ (ccrab @ (^ [Xx3:$i] : (cwss @ XS @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XJ)) @ ccfg) @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))).
