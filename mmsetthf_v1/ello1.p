...
thf(adf_lo1_ax,axiom,(cwceq @ cclo1 @ (ccrab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xm) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ (ccv @ Xf1)) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))) @ (^ [Xf1:$i] : (cco @ ccr @ ccr @ ccpm))))).
thf(cello1_conj,conjecture,(! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ cclo1) @ (cwa @ (cwcel @ XF @ (cco @ ccr @ ccr @ ccpm)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xm) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))).
