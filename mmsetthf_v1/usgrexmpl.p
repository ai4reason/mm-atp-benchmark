...
thf(ausgrexmplef_thm,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc4 @ ccfz)) => ((cwceq @ XE @ (ccs4 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ ccc0) @ (ccpr @ ccc0 @ cc3))) => (cwf1 @ (ccdm @ XE) @ (ccrab @ (^ [Xe:$i] : (cwceq @ (ccfv @ (ccv @ Xe) @ cchash) @ cc2)) @ (^ [Xe:$i] : (ccpw @ XV))) @ XE)))))).
...
thf(cusgrexmpl_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc4 @ ccfz)) => ((cwceq @ XE @ (ccs4 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ ccc0) @ (ccpr @ ccc0 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwcel @ XG @ ccusgr)))))))).
