...
thf(cmvlladdd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ XC)) => (cwi @ Xph @ (cwceq @ XB2 @ (cco @ XC @ XA2 @ ccmin))))))))))).
