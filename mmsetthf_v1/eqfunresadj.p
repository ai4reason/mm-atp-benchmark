...
thf(ceqfunresadj_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwfun @ XF) @ (cwfun @ XG)) @ (cwceq @ (ccres @ XF @ XX) @ (ccres @ XG @ XX)) @ (cw3a @ (cwcel @ XY @ (ccdm @ XF)) @ (cwcel @ XY @ (ccdm @ XG)) @ (cwceq @ (ccfv @ XY @ XF) @ (ccfv @ XY @ XG)))) @ (cwceq @ (ccres @ XF @ (ccun @ XX @ (ccsn @ XY))) @ (ccres @ XG @ (ccun @ XX @ (ccsn @ XY)))))))))).
