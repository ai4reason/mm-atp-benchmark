...
thf(aralnex2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (Xph @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))))))).
...
thf(aralnex3_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwn @ (Xph @ Xx3 @ Xy1 @ Xz))) @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz)))))))))))).
...
thf(caxtgupdim2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XY @ XP)) => ((cwi @ Xph @ (cwcel @ XZ @ XP)) => ((cwi @ Xph @ (cwcel @ XU @ XP)) => ((cwi @ Xph @ (cwcel @ XV @ XP)) => ((cwi @ Xph @ (cwne @ XU @ XV)) => ((cwi @ Xph @ (cwceq @ (cco @ XU @ XX @ Xc_mi) @ (cco @ XV @ XX @ Xc_mi))) => ((cwi @ Xph @ (cwceq @ (cco @ XU @ XY @ Xc_mi) @ (cco @ XV @ XY @ Xc_mi))) => ((cwi @ Xph @ (cwceq @ (cco @ XU @ XZ @ Xc_mi) @ (cco @ XV @ XZ @ Xc_mi))) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => ((cwi @ Xph @ (cwn @ (cwbr @ XG @ cc3 @ ccstrkgld))) => (cwi @ Xph @ (cw3o @ (cwcel @ XZ @ (cco @ XX @ XY @ XI)) @ (cwcel @ XX @ (cco @ XZ @ XY @ XI)) @ (cwcel @ XY @ (cco @ XX @ XZ @ XI))))))))))))))))))))))))))))).
