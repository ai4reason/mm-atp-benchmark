...
thf(cmgpsumn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => ((! [Xk:$i] : (cwceq @ (Xc_x @ Xk) @ (ccfv @ XR @ ccmulr))) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((cwi @ Xph @ (cwcel @ XI @ XN)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XN)) @ (cwcel @ (XA2 @ Xk) @ (ccfv @ XR @ ccbs)))) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XI) @ (cwceq @ (XA2 @ Xk) @ Xc_1))) => (cwi @ Xph @ (cwceq @ (cco @ XM @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccgsu) @ (cco @ XM @ (ccmpt @ (^ [Xk:$i] : (ccdif @ XN @ (ccsn @ XI))) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccgsu)))))))))))))))))))).
