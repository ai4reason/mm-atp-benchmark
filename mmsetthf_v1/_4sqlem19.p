...
thf(aprmind2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ cc1) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwb @ (Xph @ Xx3) @ (Xth @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmul)) @ (cwb @ (Xph @ Xx3) @ (Xta @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xz)) @ (cwb @ (Xph @ Xx3) @ (Xet @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)))) => ((! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccprime) @ (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc1 @ ccmin) @ ccfz)))) @ (Xph @ Xx3))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ (ccv @ Xz) @ (ccfv @ cc2 @ ccuz))) @ (cwi @ (cwa @ (Xch @ Xy1) @ (Xth @ Xy1 @ Xz)) @ (Xta @ Xy1 @ Xz))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (XA2 @ Xy1 @ Xz) @ ccn) @ (Xet @ Xy1 @ Xz)))))))))))))))))))).
...
thf(a_4sqlem4a_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccgz) @ (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccgz)) @ (cwcel @ (cco @ (cco @ (ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccabs) @ cc2 @ ccexp) @ ccaddc) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
...
thf(a_4sqlem18_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ (cwcel @ (XN @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ ccn))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ (cwceq @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ (cco @ (cco @ cc2 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ ccmul) @ cc1 @ ccaddc)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ (cwcel @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccprime))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ (cwss @ (cco @ ccc0 @ (cco @ cc2 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ ccmul) @ ccfz) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw @ Xi @ Xn) @ (ccrab @ (^ [Xi:$i] : (cwcel @ (cco @ (ccv @ Xi) @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmul) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw))) @ (^ [Xi:$i] : ccn))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XM @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccinf @ (XT @ Xx3 @ Xy1 @ Xz @ Xw @ Xi @ Xn) @ ccr @ cclt)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xi) @ (cwcel @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))))))))))).
...
thf(amul4sq_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw))) @ (cwcel @ (cco @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmul) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
thf(asyl6eqel_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwcel @ XB2 @ XC) => (cwi @ Xph @ (cwcel @ XA2 @ XC))))))))).
thf(aid_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ Xph))).
thf(a_4sqlem1_thm,axiom,(! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwss @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ ccn0)))))))).
thf(c_4sqlem19_conj,conjecture,(! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ ccn0 @ (XS @ Xx3 @ Xy1 @ Xz @ Xw))))))))).
