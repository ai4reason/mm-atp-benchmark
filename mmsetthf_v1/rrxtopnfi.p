...
thf(afidmfisupp_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwf @ XD @ XR @ XF)) => ((cwi @ Xph @ (cwcel @ XD @ ccfn)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => (cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp)))))))))))).
...
thf(afsumsupp0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))))))))))).
...
thf(crrxtopnfi_conj,conjecture,(! [Xph:$o] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwcel @ XI @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XI @ ccrrx) @ cctopn) @ (ccfv @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccr @ XI @ ccmap))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccr @ XI @ ccmap))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (ccsu @ XI @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt)))) @ ccmopn))))))).
