...
thf(adf_mbfm_ax,axiom,(cwceq @ ccmbfm @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccuni @ (ccrn @ ccsiga)))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccuni @ (ccrn @ ccsiga)))) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccv @ Xx3)) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccv @ Xt)))) @ (^ [Xf1:$i] : (cco @ (ccuni @ (ccv @ Xt)) @ (ccuni @ (ccv @ Xs1)) @ ccmap)))))))).
...
thf(cismbfm_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccmbfm)) @ (cwa @ (cwcel @ XF @ (cco @ (ccuni @ XT) @ (ccuni @ XS) @ ccmap)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XT))))))))))))).
