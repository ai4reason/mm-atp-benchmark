...
thf(apmresg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XF @ (cco @ XA2 @ XC @ ccpm))) @ (cwcel @ (ccres @ XF @ XB2) @ (cco @ XA2 @ XB2 @ ccpm))))))))).
...
thf(advnres_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ ccc @ ccpm)) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccdm @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn))) @ (ccdm @ XF))) @ (cwceq @ (ccfv @ XN @ (cco @ XS @ (ccres @ XF @ XS) @ ccdvn)) @ (ccres @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn)) @ XS))))))).
...
thf(ccpnres_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (ccfv @ XN @ (ccfv @ ccc @ cccpn)))) @ (cwcel @ (ccres @ XF @ XS) @ (ccfv @ XN @ (ccfv @ XS @ cccpn)))))))).
