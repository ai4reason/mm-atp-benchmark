...
thf(ce211_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwvd2 @ Xph @ Xps @ Xch) => ((cwvd1 @ Xph @ Xth) => ((cwvd1 @ Xph @ Xta) => ((cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwvd2 @ Xph @ Xps @ Xet)))))))))))).
