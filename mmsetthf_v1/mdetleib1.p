...
thf(amdetfval1_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XD @ Xx3 @ Xm @ Xp) @ (cco @ XN @ XR @ ccmdat))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xx3 @ Xm @ Xp) @ (cco @ XN @ XR @ ccmat))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XA2 @ Xx3 @ Xm @ Xp) @ ccbs))))) => ((! [Xx3:$i] : (cwceq @ (XP @ Xx3) @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XY @ Xx3 @ Xp) @ (ccfv @ XR @ cczrh)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xx3 @ Xp) @ (ccfv @ XN @ ccpsgn)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (Xc_x @ Xx3 @ Xp) @ (ccfv @ XR @ ccmulr)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XU @ Xx3 @ Xp) @ (ccfv @ XR @ ccmgp)))) => (! [Xx3:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XD @ Xx3 @ Xm @ Xp) @ (ccmpt @ (^ [Xm:$i] : (XB2 @ Xx3)) @ (^ [Xm:$i] : (cco @ XR @ (ccmpt @ (^ [Xp:$i] : (XP @ Xx3)) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xp) @ (XS @ Xx3 @ Xp)) @ (XY @ Xx3 @ Xp)) @ (cco @ (XU @ Xx3 @ Xp) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ (ccv @ Xx3) @ (ccv @ Xm)))) @ ccgsu) @ (Xc_x @ Xx3 @ Xp)))) @ ccgsu)))))))))))))))))))))))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cmdetleib1_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XD @ Xx3 @ Xp) @ (cco @ XN @ XR @ ccmdat)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xx3 @ Xp) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XA2 @ Xx3 @ Xp) @ ccbs)))) => ((! [Xx3:$i] : (cwceq @ (XP @ Xx3) @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XY @ Xx3 @ Xp) @ (ccfv @ XR @ cczrh)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xx3 @ Xp) @ (ccfv @ XN @ ccpsgn)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (Xc_x @ Xx3 @ Xp) @ (ccfv @ XR @ ccmulr)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwceq @ (XU @ Xx3 @ Xp) @ (ccfv @ XR @ ccmgp)))) => (! [Xx3:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XM @ (XB2 @ Xx3)) @ (cwceq @ (ccfv @ XM @ (XD @ Xx3 @ Xp)) @ (cco @ XR @ (ccmpt @ (^ [Xp:$i] : (XP @ Xx3)) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xp) @ (XS @ Xx3 @ Xp)) @ (XY @ Xx3 @ Xp)) @ (cco @ (XU @ Xx3 @ Xp) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ (ccv @ Xx3) @ XM))) @ ccgsu) @ (Xc_x @ Xx3 @ Xp)))) @ ccgsu))))))))))))))))))))))))).
