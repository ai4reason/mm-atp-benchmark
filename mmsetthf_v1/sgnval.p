...
thf(adf_sgn_ax,axiom,(cwceq @ ccsgn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (ccif @ (cwbr @ (ccv @ Xx3) @ ccc0 @ cclt) @ (ccneg @ cc1) @ cc1)))))).
...
thf(csgnval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwceq @ (ccfv @ XA2 @ ccsgn) @ (ccif @ (cwceq @ XA2 @ ccc0) @ ccc0 @ (ccif @ (cwbr @ XA2 @ ccc0 @ cclt) @ (ccneg @ cc1) @ cc1)))))).
