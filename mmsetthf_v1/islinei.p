...
thf(cislinei_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (Xc_le @ Xp) @ (ccfv @ XK @ ccple))) => ((! [Xp:$i] : (cwceq @ (Xc_or @ Xp) @ (ccfv @ XK @ ccjn))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : (cwceq @ (XN @ Xp) @ (ccfv @ XK @ cclines))) => (! [Xp:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ (XD @ Xp)) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwa @ (cwne @ XQ @ XR) @ (cwceq @ (XX @ Xp) @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (cco @ XQ @ XR @ (Xc_or @ Xp)) @ (Xc_le @ Xp))) @ (^ [Xp:$i] : XA2))))) @ (cwcel @ (XX @ Xp) @ (XN @ Xp)))))))))))))))))).
