...
thf(afzpreddisj_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (ccin @ (ccsn @ XM) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz)) @ cc0))))).
...
thf(adifininv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwceq @ (ccin @ (ccdif @ XA2 @ XC) @ XB2) @ cc0) @ (cwceq @ (ccin @ (ccdif @ XC @ XA2) @ XB2) @ cc0)) @ (cwceq @ (ccin @ XA2 @ XB2) @ (ccin @ XC @ XB2))))))).
thf(asyldan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => ((cwi @ (cwa @ Xph @ Xch) @ Xth) => (cwi @ (cwa @ Xph @ Xps) @ Xth)))))))).
thf(abiimpa_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(aznnnlt1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwn @ (cwcel @ XN @ ccn)) @ (cwbr @ XN @ cc1 @ cclt))))).
...
thf(auzssico_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccz) @ (cwss @ (ccfv @ XM @ ccuz) @ (cco @ XM @ ccpnf @ ccico))))).
...
thf(aicodisj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwceq @ (ccin @ (cco @ XA2 @ XB2 @ ccico) @ (cco @ XB2 @ XC @ ccico)) @ cc0)))))).
...
thf(aexmidd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ Xph @ (cwo @ Xps @ (cwn @ Xps)))))).
thf(cchtvalz_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (ccfv @ XN @ cccht) @ (ccsu @ (ccin @ (cco @ cc1 @ XN @ ccfz) @ ccprime) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ cclog))))))).
