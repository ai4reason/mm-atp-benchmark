...
thf(anormlem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccc) => ((cwcel @ XF @ cchil) => ((cwcel @ XG @ cchil) => ((cwceq @ XB2 @ (ccneg @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XF @ XG @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XG @ XF @ ccsp) @ ccmul) @ ccaddc))) => ((cwceq @ XA2 @ (cco @ XG @ XG @ ccsp)) => ((cwceq @ XC @ (cco @ XF @ XF @ ccsp)) => ((cwcel @ XR @ ccr) => ((cwceq @ (ccfv @ XS @ ccabs) @ cc1) => (cwceq @ (cco @ (cco @ XF @ (cco @ (cco @ XS @ XR @ ccmul) @ XG @ ccsm) @ ccmv) @ (cco @ XF @ (cco @ (cco @ XS @ XR @ ccmul) @ XG @ ccsm) @ ccmv) @ ccsp) @ (cco @ (cco @ (cco @ XA2 @ (cco @ XR @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ XR @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))))))))))))).
thf(cnormlem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccc) => ((cwcel @ XF @ cchil) => ((cwcel @ XG @ cchil) => ((cwceq @ XB2 @ (ccneg @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XF @ XG @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XG @ XF @ ccsp) @ ccmul) @ ccaddc))) => ((cwceq @ XA2 @ (cco @ XG @ XG @ ccsp)) => ((cwceq @ XC @ (cco @ XF @ XF @ ccsp)) => ((cwcel @ XR @ ccr) => ((cwceq @ (ccfv @ XS @ ccabs) @ cc1) => (cwbr @ ccc0 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XR @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ XR @ ccmul) @ ccaddc) @ XC @ ccaddc) @ ccle))))))))))))))))).
