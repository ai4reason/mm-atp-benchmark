...
thf(cpellexlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ ccn) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwn @ (cwcel @ (ccfv @ XD @ ccsqrt) @ ccq))) @ (cwne @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmin) @ ccc0)))))).
