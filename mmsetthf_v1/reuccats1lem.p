...
thf(accats1swrdeqrex_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwceq @ (ccfv @ XU @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) @ (cwi @ (cwceq @ XW @ (cco @ XU @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) @ (cwrex @ (^ [Xs1:$i] : (cwceq @ XU @ (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat))) @ (^ [Xs1:$i] : XV)))))))).
...
thf(creuccats1lem_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (XU @ Xs1) @ XX) @ (cwcel @ (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat) @ XX)) @ (cwa @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat) @ XX) @ (cwceq @ (XS @ Xx3) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : XV)) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccword @ XV)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : XX)))) @ (cwi @ (cwceq @ XW @ (cco @ (XU @ Xs1) @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) @ (cwceq @ (XU @ Xs1) @ (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat)))))))))))).
