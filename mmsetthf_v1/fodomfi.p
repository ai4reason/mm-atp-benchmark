...
thf(afunressn_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwss @ (ccres @ XF @ (ccsn @ XB2)) @ (ccsn @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)))))))).
...
thf(cfodomfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwfo @ XA2 @ XB2 @ XF)) @ (cwbr @ XB2 @ XA2 @ ccdom)))))).
