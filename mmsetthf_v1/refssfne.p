...
thf(assref_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwi @ (cw3a @ (cwcel @ XA2 @ XC) @ (cwss @ XA2 @ XB2) @ (cwceq @ XX @ XY)) @ (cwbr @ XA2 @ XB2 @ ccref)))))))))).
thf(asimprrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ (cwa @ Xch @ Xth))) @ Xth)))))).
thf(areftr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccref) @ (cwbr @ XB2 @ XC @ ccref)) @ (cwbr @ XA2 @ XC @ ccref)))))).
thf(crefssfne_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwi @ (cwceq @ XX @ XY) @ (cwb @ (cwbr @ XB2 @ XA2 @ ccref) @ (cwex @ (^ [Xc:$i] : (cwa @ (cwss @ XB2 @ (ccv @ Xc)) @ (cwa @ (cwbr @ XA2 @ (ccv @ Xc) @ ccfne) @ (cwbr @ (ccv @ Xc) @ XA2 @ ccref)))))))))))))).
