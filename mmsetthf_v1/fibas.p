...
thf(afiin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XC @ ccfi)) @ (cwcel @ XB2 @ (ccfv @ XC @ ccfi))) @ (cwcel @ (ccin @ XA2 @ XB2) @ (ccfv @ XC @ ccfi))))))).
...
thf(cfibas_conj,conjecture,(! [XA2:($i > $o)] : (cwcel @ (ccfv @ XA2 @ ccfi) @ cctb))).
