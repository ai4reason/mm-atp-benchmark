...
thf(adf_logb_ax,axiom,(cwceq @ cclogb @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccpr @ ccc0 @ cc1)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv)))))).
...
thf(clogbmpt_conj,conjecture,(! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) @ (cwceq @ (ccfv @ XB2 @ (cccur @ cclogb)) @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0))) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ (ccfv @ XB2 @ cclog) @ ccdiv))))))).
