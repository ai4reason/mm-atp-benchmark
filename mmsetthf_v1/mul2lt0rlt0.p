...
thf(cmul2lt0rlt0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) => (cwi @ (cwa @ Xph @ (cwbr @ XB2 @ ccc0 @ cclt)) @ (cwbr @ ccc0 @ XA2 @ cclt))))))))).
