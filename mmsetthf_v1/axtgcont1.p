...
thf(caxtgcont1_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ XP @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xa @ Xb) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ Xc_mi @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xa @ Xb) @ ccds)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3 @ Xy1 @ Xa @ Xb) @ ccitv)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xa @ Xb) @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xa @ Xb) @ ccstrkg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xa @ Xb) @ (cwss @ (XS @ Xy1) @ XP)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xa @ Xb) @ (cwss @ XT @ XP)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xa @ Xb) @ (cwi @ (cwrex @ (^ [Xa:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xa) @ (ccv @ Xy1) @ XI))) @ (^ [Xy1:$i] : XT))) @ (^ [Xx3:$i] : (XS @ Xy1)))) @ (^ [Xa:$i] : XP)) @ (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xb) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XI))) @ (^ [Xy1:$i] : XT))) @ (^ [Xx3:$i] : (XS @ Xy1)))) @ (^ [Xb:$i] : XP)))))))))))))))))))))).
