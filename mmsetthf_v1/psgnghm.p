...
thf(acnmsgnbas_thm,axiom,(! [XU:($i > $o)] : ((cwceq @ XU @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccpr @ cc1 @ (ccneg @ cc1)) @ ccress)) => (cwceq @ (ccpr @ cc1 @ (ccneg @ cc1)) @ (ccfv @ XU @ ccbs))))).
...
thf(apsgndmsubg_thm,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwcel @ XD @ XV) @ (cwcel @ (ccdm @ XN) @ (ccfv @ XG @ ccsubg)))))))))).
...
thf(acnmsgngrp_thm,axiom,(! [XU:($i > $o)] : ((cwceq @ XU @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccpr @ cc1 @ (ccneg @ cc1)) @ ccress)) => (cwcel @ XU @ ccgrp)))).
...
thf(apsgnvali_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwcel @ XP @ (ccdm @ XN)) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ XP @ (cco @ XG @ (ccv @ Xw) @ ccgsu)) @ (cwceq @ (ccfv @ XP @ XN) @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ XT))))))))))))).
...
thf(cpsgnghm_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => ((cwceq @ XF @ (cco @ XS @ (ccdm @ XN) @ ccress)) => ((cwceq @ XU @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccpr @ cc1 @ (ccneg @ cc1)) @ ccress)) => (cwi @ (cwcel @ XD @ XV) @ (cwcel @ XN @ (cco @ XF @ XU @ ccghm)))))))))))))).
