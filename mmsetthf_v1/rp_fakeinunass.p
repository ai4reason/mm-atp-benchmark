...
thf(arp_fakeanorass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwi @ Xch @ Xph) @ (cwb @ (cwo @ (cwa @ Xph @ Xps) @ Xch) @ (cwa @ Xph @ (cwo @ Xps @ Xch)))))))).
...
thf(crp_fakeinunass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwss @ XC @ XA2) @ (cwceq @ (ccun @ (ccin @ XA2 @ XB2) @ XC) @ (ccin @ XA2 @ (ccun @ XB2 @ XC)))))))).
