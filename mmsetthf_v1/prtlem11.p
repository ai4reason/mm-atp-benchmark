...
thf(cprtlem11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (cwi @ (cwcel @ XB2 @ XD) @ (cwi @ (cwcel @ XC @ XA2) @ (cwi @ (cwceq @ XB2 @ (ccec @ XC @ Xc_sm)) @ (cwcel @ XB2 @ (ccqs @ XA2 @ Xc_sm))))))))))).
