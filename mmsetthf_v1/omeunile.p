...
thf(aomedm_thm,axiom,(! [XO:($i > $o)] : (cwi @ (cwcel @ XO @ ccome) @ (cwceq @ (ccdm @ XO) @ (ccpw @ (ccuni @ (ccdm @ XO))))))).
...
thf(comeunile_conj,conjecture,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwi @ Xph @ (cwss @ XY @ (ccpw @ XX))) => ((cwi @ Xph @ (cwbr @ XY @ ccom @ ccdom)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccuni @ XY) @ XO) @ (ccfv @ (ccres @ XO @ XY) @ ccsumge0) @ ccle))))))))))).
