...
thf(cpjsumi_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (cwi @ (cwcel @ XA2 @ cchil) @ (cwi @ (cwss @ XG @ (ccfv @ XH @ ccort)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ (cco @ XG @ XH @ ccph) @ ccpjh)) @ (cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccva)))))))))).
