...
thf(aovolval3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XM @ Xy1 @ Xf1) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr))))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ (ccinf @ (XM @ Xy1 @ Xf1) @ ccxr @ cclt))))))))))).
...
thf(aovolval4lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ (ccxp @ ccxr @ ccxr) @ XF)) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ (ccif @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ ccle) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st)))))) => ((cwceq @ XA2 @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ ccle)) @ (^ [Xn:$i] : ccn))) => (cwi @ Xph @ (cwa @ (cwceq @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG)))) @ (cwceq @ (cccom @ ccvol @ (cccom @ ccioo @ XF)) @ (cccom @ ccvol @ (cccom @ ccioo @ XG))))))))))))).
