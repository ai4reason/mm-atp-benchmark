...
thf(cssblex_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cwa @ (cwcel @ XR @ ccrp) @ (cwcel @ XS @ ccrp))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ XR @ cclt) @ (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl))))) @ (^ [Xx3:$i] : ccrp))))))))).
