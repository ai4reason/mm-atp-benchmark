...
thf(ccantnf0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwceq @ XS @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ cc0 @ XA2)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccxp @ XB2 @ (ccsn @ cc0)) @ (cco @ XA2 @ XB2 @ cccnf)) @ cc0))))))))))).
