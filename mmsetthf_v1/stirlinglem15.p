...
thf(astirlinglem8_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((cwnfc @ (^ [Xn:$i] : (XA2 @ Xn))) => ((cwnfc @ (^ [Xn:$i] : (XD @ Xn))) => ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XA2 @ Xn)))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwf @ ccn @ ccrp @ (XA2 @ Xn)))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XL @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp))))) => ((! [Xn:$i] : (cwceq @ (XM @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp))))) => ((! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ ccrp))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XC @ Xn) @ ccrp))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (XA2 @ Xn) @ (XC @ Xn) @ ccli))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (XF @ Xn) @ (cco @ (XC @ Xn) @ cc2 @ ccexp) @ ccli)))))))))))))))))))))).
...
thf(astirlinglem1_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ ccmin))))) => ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XL @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (XH @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccli))))))))))).
...
thf(astirlinglem3_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XA2 @ Xn)))))) => ((! [Xn:$i] : (cwceq @ (XE @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : (cwceq @ (XV @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (ccv @ Xn) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwceq @ (XV @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ ccdiv) @ ccmul)))))))))))))).
thf(aoveq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XD)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XD @ XF)))))))))))).
thf(ccfz_tp,type,(ccfz : ($i > $o))).
thf(ccseq_tp,type,(ccseq : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(awallispi2_thm,axiom,(! [XV:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XV @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (ccv @ Xn) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (XV @ Xn) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccli))))).
...
thf(cstirlinglem15_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XA2 @ Xn)))))) => ((! [Xn:$i] : (cwceq @ (XE @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : (cwceq @ (XV @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (ccv @ Xn) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XC @ ccrp))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (XA2 @ Xn) @ XC @ ccli))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (ccfv @ (ccv @ Xn) @ (XS @ Xn)) @ ccdiv))) @ cc1 @ ccli))))))))))))))))))))))).
