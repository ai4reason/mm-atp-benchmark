...
thf(cbinomcxplemwb_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XK @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ XC @ XK @ ccmin) @ (cco @ XC @ XK @ ccbcc) @ ccmul) @ (cco @ (cco @ XC @ (cco @ XK @ cc1 @ ccmin) @ ccmin) @ (cco @ XC @ (cco @ XK @ cc1 @ ccmin) @ ccbcc) @ ccmul) @ ccaddc) @ (cco @ XC @ (cco @ XC @ XK @ ccbcc) @ ccmul))))))))).
