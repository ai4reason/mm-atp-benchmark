...
thf(a_0enwwlksnge1_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwceq @ (ccfv @ XG @ ccedg) @ cc0) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XN @ XG @ ccwwlksn) @ cc0))))).
...
thf(crusgr0edg_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwceq @ (XL @ Xw @ Xv @ Xn) @ (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn))) @ cchash)))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (cwi @ (cw3a @ (cwbr @ XG @ ccc0 @ ccrusgr) @ (cwcel @ XP @ XV) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XP @ XN @ (XL @ Xw @ Xv @ Xn)) @ ccc0))))))))))))).
