...
thf(ausgr2pthspth_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccfv @ XF @ cchash) @ cc2)) @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)))))))).
...
thf(aupgrf1istrl_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ ccupgr) @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) @ (cw3a @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))))).
...
thf(ausgr2pthlem_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XV @ Xi) @ (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xi) @ cciedg))) => (! [Xi:$i] : (cwi @ (cw3a @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ (XV @ Xi) @ XP) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XI) @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))) @ (cwi @ (cwa @ (cwcel @ (XG @ Xi) @ ccusgr) @ (cwceq @ (ccfv @ XF @ cchash) @ cc2)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cw3a @ (cwceq @ (ccfv @ ccc0 @ XP) @ (ccv @ Xx3)) @ (cwceq @ (ccfv @ cc1 @ XP) @ (ccv @ Xy1)) @ (cwceq @ (ccfv @ cc2 @ XP) @ (ccv @ Xz))) @ (cwa @ (cwceq @ (ccfv @ (ccfv @ ccc0 @ XF) @ XI) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwceq @ (ccfv @ (ccfv @ cc1 @ XF) @ XI) @ (ccpr @ (ccv @ Xy1) @ (ccv @ Xz)))))) @ (^ [Xz:$i] : (ccdif @ (XV @ Xi) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : (ccdif @ (XV @ Xi) @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : (XV @ Xi)))))))))))))).
