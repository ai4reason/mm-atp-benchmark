...
thf(adf_ginv_ax,axiom,(cwceq @ ccgn @ (ccmpt @ (^ [Xg1:$i] : ccgr) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1))) @ (^ [Xx3:$i] : (ccrio @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xg1) @ ccgi))) @ (^ [Xz:$i] : (ccrn @ (ccv @ Xg1)))))))))).
thf(cgrpoinvfval_conj,conjecture,(! [XU:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((! [Xy1:$i] : (cwceq @ (XU @ Xy1) @ (ccfv @ XG @ ccgi))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (ccfv @ XG @ ccgn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XG @ ccgr) @ (cwceq @ (XN @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) @ (XU @ Xy1))) @ (^ [Xy1:$i] : XX)))))))))))))))).
