...
thf(adchrisum0lem1a_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ XX @ ccrp)) @ (cwcel @ XD @ (cco @ cc1 @ (ccfv @ XX @ ccfl) @ ccfz))) @ (cwa @ (cwbr @ XX @ (cco @ (cco @ XX @ cc2 @ ccexp) @ XD @ ccdiv) @ ccle) @ (cwcel @ (ccfv @ (cco @ (cco @ XX @ cc2 @ ccexp) @ XD @ ccdiv) @ ccfl) @ (ccfv @ (ccfv @ XX @ ccfl) @ ccuz)))))))).
...
thf(cdchrisum0lem1b_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : (! [Xd:$i] : ((! [Xa:$i] : (cwceq @ (XZ @ Xa) @ (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : (cwceq @ XL @ (ccfv @ (XZ @ Xa) @ cczrh))) => ((! [Xy1:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwcel @ (XN @ Xa) @ ccn)))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XG @ Xy1 @ Xm @ Xa) @ (ccfv @ (XN @ Xa) @ ccdchr))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XD @ Xa) @ (ccfv @ (XG @ Xy1 @ Xm @ Xa) @ ccbs))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (Xc_1 @ Xa) @ (ccfv @ (XG @ Xy1 @ Xm @ Xa) @ cc0g))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwceq @ (XW @ Xy1 @ Xm @ Xa) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) @ ccc0)) @ (^ [Xy1:$i] : (ccdif @ (XD @ Xa) @ (ccsn @ (Xc_1 @ Xa))))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwcel @ XX @ (XW @ Xy1 @ Xm @ Xa)))))) => ((! [Xa:$i] : (cwceq @ (XF @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccfv @ (ccv @ Xa) @ ccsqrt) @ ccdiv))))) => ((! [Xy1:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwcel @ (XC @ Xa) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xy1:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (XS @ Xa) @ ccli)))) => ((! [Xy1:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xa) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (XS @ Xa) @ ccmin) @ ccabs) @ (cco @ (XC @ Xa) @ (ccfv @ (ccv @ Xy1) @ ccsqrt) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwa @ (Xph @ Xy1 @ Xa) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwcel @ (ccv @ Xd) @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz))) @ (cwbr @ (ccfv @ (ccsu @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ ccfl) @ cc1 @ ccaddc) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (ccv @ Xd) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ XX) @ (ccfv @ (ccv @ Xm) @ ccsqrt) @ ccdiv))) @ ccabs) @ (cco @ (cco @ cc2 @ (XC @ Xa) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccdiv) @ ccle))))))))))))))))))))))))))))))).
