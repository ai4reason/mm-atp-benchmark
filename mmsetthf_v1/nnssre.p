...
thf(apeano5nni_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ cc1 @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XA2)) @ (^ [Xx3:$i] : XA2))) @ (cwss @ ccn @ XA2)))).
thf(cnnssre_conj,conjecture,(cwss @ ccn @ ccr)).
