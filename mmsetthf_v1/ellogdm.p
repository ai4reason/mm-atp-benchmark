...
thf(cellogdm_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwb @ (cwcel @ XA2 @ XD) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ XA2 @ ccrp)))))))).
