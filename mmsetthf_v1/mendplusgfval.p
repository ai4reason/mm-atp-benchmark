...
thf(amendbas_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XM @ ccmend)) => (cwceq @ (cco @ XM @ XM @ cclmhm) @ (ccfv @ XA2 @ ccbs)))))).
...
thf(aalgaddg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_xp)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccsca) @ XS) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ Xc_x)))) => (cwi @ (cwcel @ Xc_pl @ XV) @ (cwceq @ Xc_pl @ (ccfv @ XA2 @ ccplusg)))))))))))).
...
thf(cmendplusgfval_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1) @ (ccfv @ XM @ ccmend)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccbs)))) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccof @ Xc_pl)))))))))))))))).
