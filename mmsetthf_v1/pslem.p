...
thf(cpslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccps) @ (cw3a @ (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XB2 @ XC @ XR)) @ (cwbr @ XA2 @ XC @ XR)) @ (cwi @ (cwcel @ XA2 @ (ccuni @ (ccuni @ XR))) @ (cwbr @ XA2 @ XA2 @ XR)) @ (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XB2 @ XA2 @ XR)) @ (cwceq @ XA2 @ XB2))))))))).
