...
thf(ctrelded_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwtr @ XA2)) => ((cwi @ Xps @ (cwcel @ XB2 @ XC)) => ((cwi @ Xch @ (cwcel @ XC @ XA2)) => (cwi @ (cw3a @ Xph @ Xps @ Xch) @ (cwcel @ XB2 @ XA2)))))))))))).
