...
thf(abcp1nk_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwceq @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XK @ cc1 @ ccaddc) @ ccbc) @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv) @ ccmul)))))).
...
thf(abcxmaslem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cco @ (cco @ XN @ XA2 @ ccaddc) @ XA2 @ ccbc) @ (cco @ (cco @ XN @ XB2 @ ccaddc) @ XB2 @ ccbc))))))).
...
thf(apc1_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwceq @ (cco @ XP @ cc1 @ ccpc) @ ccc0)))).
...
thf(apcqmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XA2 @ ccq) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccq) @ (cwne @ XB2 @ ccc0))) @ (cwceq @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccmul) @ ccpc) @ (cco @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccaddc))))))).
...
thf(apcadd2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccq)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccq)) => ((cwi @ Xph @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ cclt)) => (cwi @ Xph @ (cwceq @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc)))))))))))).
...
thf(csylow1lem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XG @ ccgrp))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XX @ ccfn))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XP @ ccprime))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XN @ ccn0))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwbr @ (cco @ XP @ XN @ ccexp) @ (ccfv @ XX @ cchash) @ ccdvds))) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((! [Xs1:$i] : (cwceq @ (XS @ Xs1) @ (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccfv @ (ccv @ Xs1) @ cchash) @ (cco @ XP @ XN @ ccexp))) @ (^ [Xs1:$i] : (ccpw @ XX))))) => (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwa @ (cwcel @ (ccfv @ (XS @ Xs1) @ cchash) @ ccn) @ (cwceq @ (cco @ XP @ (ccfv @ (XS @ Xs1) @ cchash) @ ccpc) @ (cco @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ XN @ ccmin))))))))))))))))))))).
