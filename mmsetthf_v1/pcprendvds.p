...
thf(apcprecl_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwa @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0))) @ (cwa @ (cwcel @ (XS @ Xn) @ ccn0) @ (cwbr @ (cco @ XP @ (XS @ Xn) @ ccexp) @ XN @ ccdvds))))))))))).
...
thf(apclem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwa @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0))) @ (cw3a @ (cwss @ (XA2 @ Xn) @ ccz) @ (cwne @ (XA2 @ Xn) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XA2 @ Xn)))) @ (^ [Xx3:$i] : ccz)))))))))).
...
thf(asuprzub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwss @ XA2 @ ccz) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccz)) @ (cwcel @ (XB2 @ Xy1) @ XA2)) @ (cwbr @ (XB2 @ Xy1) @ (ccsup @ XA2 @ ccr @ cclt) @ ccle)))))).
thf(cpcprendvds_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwa @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0))) @ (cwn @ (cwbr @ (cco @ XP @ (cco @ (XS @ Xn) @ cc1 @ ccaddc) @ ccexp) @ XN @ ccdvds))))))))))).
