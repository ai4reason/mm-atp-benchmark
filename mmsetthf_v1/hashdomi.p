...
thf(astoic1b_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xth) => (cwi @ (cwa @ Xps @ (cwn @ Xth)) @ (cwn @ Xph))))))).
thf(ccen_tp,type,(ccen : ($i > $o))).
thf(adomfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwbr @ XB2 @ XA2 @ ccdom)) @ (cwcel @ XB2 @ ccfn))))).
thf(chashdomi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccle))))).
