...
thf(aelriin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XB2 @ (ccin @ XA2 @ (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XS @ Xx3))))) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ XB2 @ (XS @ Xx3))) @ (^ [Xx3:$i] : XX))))))))).
...
thf(arintopn_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XJ) @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ (ccin @ XX @ (ccint @ XA2)) @ XJ))))))).
...
thf(climciun_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (cwss @ (XB2 @ Xx3) @ ccc)) @ (^ [Xx3:$i] : XA2)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccc @ XF))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XC @ ccc))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (cco @ XF @ XC @ cclimc) @ (ccin @ ccc @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccres @ XF @ (XB2 @ Xx3)) @ XC @ cclimc))))))))))))))))).
