...
thf(covncvrrp_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XE:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > $o)] : ((! [Xh:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xh @ Xl) @ (cwcel @ XX @ ccfn)))) => ((! [Xh:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xh @ Xl) @ (cwne @ XX @ cc0)))) => ((! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xh @ Xl) @ (cwss @ (XA2 @ Xh @ Xj @ Xk) @ (cco @ ccr @ XX @ ccmap))))))) => ((! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xh @ Xl) @ (cwcel @ (XE @ Xh @ Xj @ Xk @ Xa @ Xl) @ ccrp))))))) => ((! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xl:$i] : (cwceq @ (XC @ Xh @ Xj @ Xk @ Xa @ Xl) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccrab @ (^ [Xl:$i] : (cwss @ (ccv @ Xa) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xl)))))))))) @ (^ [Xl:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap))))))))))) => ((! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XL @ Xh @ Xi @ Xj @ Xk @ Xl) @ (ccmpt @ (^ [Xh:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xh:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xh))) @ ccvol))))))))))) => ((! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xl:$i] : (cwceq @ (XD @ Xe @ Xh @ Xi @ Xj @ Xk @ Xa @ Xl) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccmpt @ (^ [Xe:$i] : ccrp) @ (^ [Xe:$i] : (ccrab @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)) @ (XL @ Xh @ Xi @ Xj @ Xk @ Xl)))) @ ccsumge0) @ (cco @ (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)) @ (ccv @ Xe) @ ccxad) @ ccle)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xa) @ (XC @ Xh @ Xj @ Xk @ Xa @ Xl)))))))))))))))) => (! [Xe:$i] : (! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xh @ Xl) @ (cwex @ (^ [Xi:$i] : (cwcel @ (ccv @ Xi) @ (ccfv @ (XE @ Xh @ Xj @ Xk @ Xa @ Xl) @ (ccfv @ (XA2 @ Xh @ Xj @ Xk) @ (XD @ Xe @ Xh @ Xi @ Xj @ Xk @ Xa @ Xl)))))))))))))))))))))))))))).
