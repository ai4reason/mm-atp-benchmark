...
thf(aisipodrs_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) @ (cw3a @ (cwcel @ XA2 @ ccvv) @ (cwne @ XA2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
thf(cfpwipodrs_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccfv @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccipo) @ ccdrs))))).
