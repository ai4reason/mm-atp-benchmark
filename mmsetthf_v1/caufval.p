...
thf(adf_cau_ax,axiom,(cwceq @ ccca @ (ccmpt @ (^ [Xd:$i] : (ccuni @ (ccrn @ ccxmt))) @ (^ [Xd:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwf @ (ccfv @ (ccv @ Xj) @ ccuz) @ (cco @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xd) @ ccbl)) @ (ccres @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xf1:$i] : (cco @ (ccdm @ (ccdm @ (ccv @ Xd))) @ ccc @ ccpm))))))).
...
thf(ccaufval_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwceq @ (ccfv @ XD @ ccca) @ (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwf @ (ccfv @ (ccv @ Xk) @ ccuz) @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (ccres @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xf1:$i] : (cco @ XX @ ccc @ ccpm)))))))).
