...
thf(cdvcn_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwss @ XS @ ccc) @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ XS)) @ (cwceq @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ XA2)) @ (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf))))))).
