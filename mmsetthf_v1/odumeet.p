...
thf(aoduglb_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XD @ (ccfv @ XO @ ccodu)) => ((cwceq @ XU @ (ccfv @ XO @ cclub)) => (cwi @ (cwcel @ XO @ XV) @ (cwceq @ XU @ (ccfv @ XD @ ccglb)))))))))).
...
thf(ameet0_thm,axiom,(cwceq @ (ccfv @ cc0 @ ccmee) @ cc0)).
thf(codumeet_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XD @ (ccfv @ XO @ ccodu)) => ((cwceq @ Xc_or @ (ccfv @ XO @ ccjn)) => (cwceq @ Xc_or @ (ccfv @ XD @ ccmee)))))))).
