...
thf(asdomel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwi @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwcel @ XA2 @ XB2)))))).
...
thf(cfindcard3_conj,conjecture,(! [Xph:($i > $o)] : (! [Xch:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xta @ Xy1))))) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccfn) @ (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3)))) @ (Xch @ Xy1)))) => (! [Xy1:$i] : (cwi @ (cwcel @ (XA2 @ Xy1) @ ccfn) @ (Xta @ Xy1))))))))))).
