...
thf(cusgrun_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XG @ ccusgr)) => ((cwi @ Xph @ (cwcel @ XH @ ccusgr)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwceq @ XF @ (ccfv @ XH @ cciedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XH @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ (ccin @ (ccdm @ XE) @ (ccdm @ XF)) @ cc0)) => ((cwi @ Xph @ (cwcel @ XU @ XW)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XU @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XU @ cciedg) @ (ccun @ XE @ XF))) => (cwi @ Xph @ (cwcel @ XU @ ccumgr))))))))))))))))))))).
