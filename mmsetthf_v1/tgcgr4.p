...
thf(aiscgrglt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_sm:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xi @ Xj) @ (ccfv @ XG @ ccbs)))) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_sm @ Xi @ Xj) @ (ccfv @ XG @ cccgrg)))) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwss @ (XD @ Xi @ Xj) @ ccr)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ (XD @ Xi @ Xj) @ (XP @ Xi @ Xj) @ XA2)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ (XD @ Xi @ Xj) @ (XP @ Xi @ Xj) @ XB2)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ (Xc_sm @ Xi @ Xj)) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xi) @ (ccv @ Xj) @ cclt) @ (cwceq @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xj) @ XA2) @ Xc_mi) @ (cco @ (ccfv @ (ccv @ Xi) @ XB2) @ (ccfv @ (ccv @ Xj) @ XB2) @ Xc_mi)))) @ (^ [Xj:$i] : (ccdm @ XA2)))) @ (^ [Xi:$i] : (ccdm @ XA2))))))))))))))))))))))).
...
thf(araltpd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwb @ (Xps @ Xx3) @ Xch))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XB2)) @ (cwb @ (Xps @ Xx3) @ Xth))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XC)) @ (cwb @ (Xps @ Xx3) @ Xta))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XC @ (XX @ Xx3)))) => (cwi @ Xph @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (cctp @ XA2 @ XB2 @ XC))) @ (cw3a @ Xch @ Xth @ Xta))))))))))))))))))))).
...
thf(as4fv3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XD @ XV) @ (cwceq @ (ccfv @ cc3 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) @ XD)))))))).
thf(a_1lt3_thm,axiom,(cwbr @ cc1 @ cc3 @ cclt)).
thf(as4fv1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwceq @ (ccfv @ cc1 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) @ XB2)))))))).
thf(a_2lt3_thm,axiom,(cwbr @ cc2 @ cc3 @ cclt)).
thf(as4fv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XC @ XV) @ (cwceq @ (ccfv @ cc2 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) @ XC)))))))).
thf(a_0red_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ (cwcel @ ccc0 @ ccr)))).
thf(a_1red_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ (cwcel @ cc1 @ ccr)))).
thf(a_2re_thm,axiom,(cwcel @ cc2 @ ccr)).
thf(ctgcgr4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ Xc_sm @ (ccfv @ XG @ cccgrg)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwcel @ XW @ XP)) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XY @ XP)) => ((cwi @ Xph @ (cwcel @ XZ @ XP)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs4 @ XW @ XX @ XY @ XZ) @ Xc_sm) @ (cwa @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XW @ XX @ XY) @ Xc_sm) @ (cw3a @ (cwceq @ (cco @ XA2 @ XD @ Xc_mi) @ (cco @ XW @ XZ @ Xc_mi)) @ (cwceq @ (cco @ XB2 @ XD @ Xc_mi) @ (cco @ XX @ XZ @ Xc_mi)) @ (cwceq @ (cco @ XC @ XD @ Xc_mi) @ (cco @ XY @ XZ @ Xc_mi)))))))))))))))))))))))))))))))))).
