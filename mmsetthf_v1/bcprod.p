...
thf(abcm1nt_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccbc) @ (cco @ XN @ (cco @ XN @ XK @ ccmin) @ ccdiv) @ ccmul)))))).
...
thf(afprodfac_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwceq @ (ccfv @ XA2 @ ccfa) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XA2 @ ccfz)) @ (^ [Xk:$i] : (ccv @ Xk))))))).
...
thf(cbcprod_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ cc1 @ ccmin) @ (ccv @ Xk) @ ccbc))) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ XN @ ccmin) @ ccexp))))))).
