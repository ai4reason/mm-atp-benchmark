...
thf(anbgrnself_thm,axiom,(! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xv:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xv) @ ccvtx))) => (cwral @ (^ [Xv:$i] : (cwnel @ (ccv @ Xv) @ (cco @ (XG @ Xv) @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xv:$i] : XV)))))).
...
thf(cnbgrnself2OLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XG @ XW) @ (cwnel @ XN @ (cco @ XG @ XN @ ccnbgr))))))).
