...
thf(amodcyc2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XN @ ccmul) @ ccmin) @ XB2 @ ccmo) @ (cco @ XA2 @ XB2 @ ccmo))))))).
thf(cmodadd1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccrp)) @ (cwceq @ (cco @ XA2 @ XD @ ccmo) @ (cco @ XB2 @ XD @ ccmo))) @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccaddc) @ XD @ ccmo) @ (cco @ (cco @ XB2 @ XC @ ccaddc) @ XD @ ccmo)))))))).
