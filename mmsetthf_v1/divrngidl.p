...
thf(a_1idl_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XI @ (ccfv @ XR @ ccidl))) @ (cwb @ (cwcel @ XU @ XI) @ (cwceq @ XI @ XX)))))))))))))).
...
thf(arngoidl_thm,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwcel @ XX @ (ccfv @ XR @ ccidl))))))))).
...
thf(cdivrngidl_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => (cwi @ (cwcel @ XR @ ccdrng) @ (cwceq @ (ccfv @ XR @ ccidl) @ (ccpr @ (ccsn @ XZ) @ XX))))))))))))).
