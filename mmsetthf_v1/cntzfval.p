...
thf(adf_cntz_ax,axiom,(cwceq @ cccntz @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xm) @ ccbs))) @ (^ [Xs1:$i] : (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xm) @ ccplusg)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ ccplusg)))) @ (^ [Xy1:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xm) @ ccbs))))))))).
