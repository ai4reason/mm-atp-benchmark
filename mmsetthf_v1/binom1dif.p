...
thf(cbinom1dif_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XN @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmin) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))))).
