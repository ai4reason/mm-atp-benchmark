...
thf(aifpimpda_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => ((cwi @ (cwa @ Xph @ (cwn @ Xps)) @ Xth) => (cwi @ Xph @ (cwif @ Xps @ Xch @ Xth))))))))).
...
thf(a_1wlkdlem2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccs2 @ XX @ XY)) => ((cwceq @ XF @ (ccs1 @ XJ)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ (cwa @ Xph @ (cwceq @ XX @ XY)) @ (cwceq @ (ccfv @ XJ @ XI) @ (ccsn @ XX))) => ((cwi @ (cwa @ Xph @ (cwne @ XX @ XY)) @ (cwss @ (ccpr @ XX @ XY) @ (ccfv @ XJ @ XI))) => (cwi @ Xph @ (cwcel @ XX @ (ccfv @ XJ @ XI)))))))))))))))))).
...
thf(c_1wlkdlem4_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ XP @ (ccs2 @ (XX @ Xk) @ (XY @ Xk)))) => ((! [Xk:$i] : (cwceq @ XF @ (ccs1 @ (XJ @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XX @ Xk) @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XY @ Xk) @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwceq @ (XX @ Xk) @ (XY @ Xk))) @ (cwceq @ (ccfv @ (XJ @ Xk) @ XI) @ (ccsn @ (XX @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwne @ (XX @ Xk) @ (XY @ Xk))) @ (cwss @ (ccpr @ (XX @ Xk) @ (XY @ Xk)) @ (ccfv @ (XJ @ Xk) @ XI)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwral @ (^ [Xk:$i] : (cwif @ (cwceq @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) @ (ccsn @ (ccfv @ (ccv @ Xk) @ XP))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))))))))))).
