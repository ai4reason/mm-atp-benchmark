...
thf(cyon2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XY @ (ccfv @ XC @ ccyon)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((cwi @ Xph @ (cwcel @ XW @ XB2)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ XZ @ XH))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XW @ XX @ XH))) => (cwi @ Xph @ (cwceq @ (ccfv @ XG @ (ccfv @ XW @ (ccfv @ XF @ (cco @ XX @ XZ @ (ccfv @ XY @ cc2nd))))) @ (cco @ XF @ XG @ (cco @ (ccop @ XW @ XX) @ XZ @ Xc_x)))))))))))))))))))))))))).
