...
thf(aringccatidALTV_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccringcALTV)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => (cwi @ (cwcel @ XU @ XV) @ (cwa @ (cwcel @ XC @ cccat) @ (cwceq @ (ccfv @ XC @ cccid) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xx3) @ ccbs)))))))))))))).
...
thf(cringcidALTV_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccringcALTV)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ XC @ cccid)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwceq @ XS @ (ccfv @ XX @ ccbs)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ Xc_1) @ (ccres @ ccid @ XS)))))))))))))))))).
