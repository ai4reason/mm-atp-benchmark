...
thf(aindm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccdif @ ccvv @ (ccin @ XA2 @ XB2)) @ (ccun @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2)))))).
thf(adifeq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccdif @ XC @ XA2) @ (ccdif @ XC @ XB2))))))).
thf(cdifdifdir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccdif @ (ccdif @ XA2 @ XB2) @ XC) @ (ccdif @ (ccdif @ XA2 @ XC) @ (ccdif @ XB2 @ XC))))))).
