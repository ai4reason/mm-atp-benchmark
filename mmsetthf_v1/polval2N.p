...
thf(apmapglb2xN_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xy1:$i] : (! [Xi:$i] : (cwceq @ (XG @ Xy1 @ Xi) @ (ccfv @ XK @ ccglb)))) => ((! [Xy1:$i] : (cwceq @ (XA2 @ Xy1) @ (ccfv @ XK @ ccatm))) => ((! [Xy1:$i] : (! [Xi:$i] : (cwceq @ (XM @ Xy1 @ Xi) @ (ccfv @ XK @ ccpmap)))) => (! [Xy1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwral @ (^ [Xi:$i] : (cwcel @ (XS @ Xi) @ XB2)) @ (^ [Xi:$i] : XI))) @ (cwceq @ (ccfv @ (ccfv @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xi:$i] : (cwceq @ (ccv @ Xy1) @ (XS @ Xi))) @ (^ [Xi:$i] : XI)))) @ (XG @ Xy1 @ Xi)) @ (XM @ Xy1 @ Xi)) @ (ccin @ (XA2 @ Xy1) @ (cciin @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (XS @ Xi) @ (XM @ Xy1 @ Xi))))))))))))))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))))).
thf(aeqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aglbconxN_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_pe:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XK @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XU @ Xx3 @ Xi) @ (ccfv @ (XK @ Xx3) @ cclub)))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XG @ Xx3 @ Xi) @ (ccfv @ (XK @ Xx3) @ ccglb)))) => ((! [Xx3:$i] : (cwceq @ Xc_pe @ (ccfv @ (XK @ Xx3) @ ccoc))) => (! [Xx3:$i] : (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ (XK @ Xx3) @ cchlt) @ (cwral @ (^ [Xi:$i] : (cwcel @ (XS @ Xi) @ XB2)) @ (^ [Xi:$i] : (XI @ Xi)))) @ (cwceq @ (ccfv @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : (cwceq @ (ccv @ Xx3) @ (XS @ Xi))) @ (^ [Xi:$i] : (XI @ Xi))))) @ (XG @ Xx3 @ Xi)) @ (ccfv @ (ccfv @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : (cwceq @ (ccv @ Xx3) @ (ccfv @ (XS @ Xi) @ Xc_pe))) @ (^ [Xi:$i] : (XI @ Xi))))) @ (XU @ Xx3 @ Xi)) @ Xc_pe))))))))))))))))).
...
thf(cpolval2N_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XK @ cclub)) => ((cwceq @ Xc_pe @ (ccfv @ XK @ ccoc)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => ((cwceq @ XP @ (ccfv @ XK @ ccpolN)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwss @ XX @ XA2)) @ (cwceq @ (ccfv @ XX @ XP) @ (ccfv @ (ccfv @ (ccfv @ XX @ XU) @ Xc_pe) @ XM)))))))))))))))).
