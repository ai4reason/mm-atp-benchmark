...
thf(cnmf2_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((cwceq @ XX @ (ccfv @ XW @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccds)) => ((cwceq @ XE @ (ccres @ XD @ (ccxp @ XX @ XX))) => (cwi @ (cwa @ (cwcel @ XW @ ccgrp) @ (cwcel @ XE @ (ccfv @ XX @ ccme))) @ (cwf @ XX @ ccr @ XN)))))))))))).
