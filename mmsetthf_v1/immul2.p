...
thf(aimmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccim) @ (cco @ (cco @ (ccfv @ XA2 @ ccre) @ (ccfv @ XB2 @ ccim) @ ccmul) @ (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XB2 @ ccre) @ ccmul) @ ccaddc)))))).
...
thf(areim0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccim) @ ccc0)))).
...
thf(cimmul2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccim) @ (cco @ XA2 @ (ccfv @ XB2 @ ccim) @ ccmul)))))).
