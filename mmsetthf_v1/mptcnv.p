...
thf(cmptcnv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwb @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3))) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (XC @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (XD @ Xy1))))))) => (cwi @ Xph @ (cwceq @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (ccmpt @ (^ [Xy1:$i] : (XC @ Xy1)) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))).
