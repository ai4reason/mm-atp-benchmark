...
thf(admresv_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccdm @ (ccres @ XA2 @ ccvv)) @ (ccdm @ XA2)))).
...
thf(areldm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwceq @ (ccdm @ XA2) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cc1st)))))))).
...
thf(cfidomdm_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccfn) @ (cwbr @ (ccdm @ XF) @ XF @ ccdom)))).
