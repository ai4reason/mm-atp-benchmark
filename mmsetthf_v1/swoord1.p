...
thf(aswopolem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwcel @ (ccv @ Xz) @ XA2))) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwo @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ (XY @ Xx3) @ XA2) @ (cwcel @ (XZ @ Xx3 @ Xy1) @ XA2))) @ (cwi @ (cwbr @ XX @ (XY @ Xx3) @ XR) @ (cwo @ (cwbr @ XX @ (XZ @ Xx3 @ Xy1) @ XR) @ (cwbr @ (XZ @ Xx3 @ Xy1) @ (XY @ Xx3) @ XR)))))))))))))).
...
thf(cswoord1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [Xc_lt:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XR @ Xx3 @ Xy1 @ Xz) @ (ccdif @ (ccxp @ XX @ XX) @ (ccun @ Xc_lt @ (cccnv @ Xc_lt))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX))) @ (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_lt) @ (cwn @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_lt)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX))) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_lt) @ (cwo @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_lt) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_lt))))))) => ((cwi @ Xph @ (cwcel @ XB2 @ XX)) => ((cwi @ Xph @ (cwcel @ XC @ XX)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (XR @ Xx3 @ Xy1 @ Xz)))))) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XC @ Xc_lt) @ (cwbr @ XB2 @ XC @ Xc_lt))))))))))))))))).
