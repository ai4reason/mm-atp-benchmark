...
thf(cdvmul_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XX @ XS)) => ((cwi @ Xph @ (cwf @ XY @ ccc @ XG)) => ((cwi @ Xph @ (cwss @ XY @ XS)) => ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwcel @ XC @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => ((cwi @ Xph @ (cwcel @ XC @ (ccdm @ (cco @ XS @ XG @ ccdv)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdv)) @ (cco @ (cco @ (ccfv @ XC @ (cco @ XS @ XF @ ccdv)) @ (ccfv @ XC @ XG) @ ccmul) @ (cco @ (ccfv @ XC @ (cco @ XS @ XG @ ccdv)) @ (ccfv @ XC @ XF) @ ccmul) @ ccaddc)))))))))))))))))).
