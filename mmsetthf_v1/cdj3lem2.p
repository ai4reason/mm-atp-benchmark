...
thf(acdjreui_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwi @ (cwa @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccph)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)) @ (cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XC @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(ccdj3lem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xz @ Xw) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccph)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xz) @ (ccv @ Xw) @ ccva))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XA2)))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cw3a @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)) @ (cwceq @ (ccfv @ (cco @ XC @ XD @ ccva) @ (XS @ Xx3 @ Xz @ Xw)) @ XC)))))))))))))).
