...
thf(aplyss_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ XT) @ (cwss @ XT @ ccc)) @ (cwss @ (ccfv @ XS @ ccply) @ (ccfv @ XT @ ccply)))))).
thf(aid_thm,axiom,(! [Xph:$o] : (cwi @ Xph @ Xph))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cccoe_tp,type,(cccoe : ($i > $o))).
thf(ccdgr_tp,type,(ccdgr : ($i > $o))).
thf(aplyrecj_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ ccr @ ccply)) @ (cwcel @ XA2 @ ccc)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ XF) @ cccj) @ (ccfv @ (ccfv @ XA2 @ cccj) @ XF)))))).
...
thf(caacjcl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwcel @ (ccfv @ XA2 @ cccj) @ ccaa)))).
