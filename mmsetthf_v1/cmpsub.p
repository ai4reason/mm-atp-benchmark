...
thf(acmpsublem_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwi @ (cwral @ (^ [Xc:$i] : (cwi @ (cwss @ XS @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwss @ XS @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ XJ))) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwceq @ (ccuni @ (cco @ XJ @ XS @ ccrest)) @ (ccuni @ (ccv @ Xs1))) @ (cwrex @ (^ [Xt:$i] : (cwceq @ (ccuni @ (cco @ XJ @ XS @ ccrest)) @ (ccuni @ (ccv @ Xt)))) @ (^ [Xt:$i] : (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))))) @ (^ [Xs1:$i] : (ccpw @ (cco @ XJ @ XS @ ccrest))))))))))).
thf(ccmpsub_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwss @ XS @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwss @ XS @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ XJ)))))))))).
