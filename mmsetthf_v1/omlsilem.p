...
thf(ahvsubaddi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmv) @ XC) @ (cwceq @ (cco @ XB2 @ XC @ ccva) @ XA2))))))))).
...
thf(comlsilem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccsh) => ((cwcel @ XH @ ccsh) => ((cwss @ XG @ XH) => ((cwceq @ (ccin @ XH @ (ccfv @ XG @ ccort)) @ cc0h) => ((cwcel @ XA2 @ XH) => ((cwcel @ XB2 @ XG) => ((cwcel @ XC @ (ccfv @ XG @ ccort)) => (cwi @ (cwceq @ XA2 @ (cco @ XB2 @ XC @ ccva)) @ (cwcel @ XA2 @ XG))))))))))))))).
