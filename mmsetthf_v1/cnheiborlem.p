...
thf(acmpcld_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cccmp) @ (cwcel @ XS @ (ccfv @ XJ @ cccld))) @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp))))).
thf(ccnheiborlem_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XT @ (cco @ XJ @ XX @ ccrest)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XY @ Xx3 @ Xy1 @ Xz) @ (ccima @ (XF @ Xx3 @ Xy1) @ (ccxp @ (cco @ (ccneg @ (XR @ Xx3 @ Xy1)) @ (XR @ Xx3 @ Xy1) @ ccicc) @ (cco @ (ccneg @ (XR @ Xx3 @ Xy1)) @ (XR @ Xx3 @ Xy1) @ ccicc))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XX @ (ccfv @ XJ @ cccld)) @ (cwa @ (cwcel @ (XR @ Xx3 @ Xy1) @ ccr) @ (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccv @ Xz) @ ccabs) @ (XR @ Xx3 @ Xy1) @ ccle)) @ (^ [Xz:$i] : XX)))) @ (cwcel @ XT @ cccmp))))))))))))))).
