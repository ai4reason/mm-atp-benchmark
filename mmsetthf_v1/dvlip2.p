...
thf(advlipcn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XX @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XX @ Xx3) @ ccc @ XF))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (cwceq @ XB2 @ (cco @ (XA2 @ Xx3) @ (XR @ Xx3) @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => ((cwi @ Xph @ (cwss @ XB2 @ (ccdm @ (cco @ ccc @ XF @ ccdv)))) => ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccc @ XF @ ccdv)) @ ccabs) @ XM @ ccle))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (XY @ Xx3) @ XB2) @ (cwcel @ (XZ @ Xx3) @ XB2))) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (XY @ Xx3) @ XF) @ (ccfv @ (XZ @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ XM @ (ccfv @ (cco @ (XY @ Xx3) @ (XZ @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle))))))))))))))))))))).
...
thf(cdvlip2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwceq @ XJ @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XS @ XS))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XX @ Xx3) @ XS))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XX @ Xx3) @ ccc @ XF))) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XR @ ccxr)) => ((cwceq @ XB2 @ (cco @ XA2 @ XR @ (ccfv @ XJ @ ccbl))) => ((cwi @ Xph @ (cwss @ XB2 @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ XS @ XF @ ccdv)) @ ccabs) @ XM @ ccle))) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) @ (cwbr @ (ccfv @ (cco @ (ccfv @ XY @ XF) @ (ccfv @ XZ @ XF) @ ccmin) @ ccabs) @ (cco @ XM @ (ccfv @ (cco @ XY @ XZ @ ccmin) @ ccabs) @ ccmul) @ ccle)))))))))))))))))))))))).
