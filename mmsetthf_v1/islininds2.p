...
thf(cislininds2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XE @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ (ccpw @ XB2)) @ (cwcel @ XR @ ccnzr)) @ (cwi @ (cwbr @ XS @ XM @ cclininds) @ (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xf1:$i] : (cwo @ (cwn @ (cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp)) @ (cwne @ (cco @ (ccv @ Xf1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ (ccfv @ XM @ cclinc)) @ (ccv @ Xs1)))) @ (^ [Xf1:$i] : (cco @ XE @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ ccmap)))) @ (^ [Xs1:$i] : XS))))))))))))))))).
