...
thf(adf_dir_ax,axiom,(cwceq @ ccdir @ (ccab @ (^ [Xr:$i] : (cwa @ (cwa @ (cwrel @ (ccv @ Xr)) @ (cwss @ (ccres @ ccid @ (ccuni @ (ccuni @ (ccv @ Xr)))) @ (ccv @ Xr))) @ (cwa @ (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr)) @ (cwss @ (ccxp @ (ccuni @ (ccuni @ (ccv @ Xr))) @ (ccuni @ (ccuni @ (ccv @ Xr)))) @ (cccom @ (cccnv @ (ccv @ Xr)) @ (ccv @ Xr))))))))).
thf(cisdir_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (ccuni @ (ccuni @ XR))) => (cwi @ (cwcel @ XR @ XV) @ (cwb @ (cwcel @ XR @ ccdir) @ (cwa @ (cwa @ (cwrel @ XR) @ (cwss @ (ccres @ ccid @ XA2) @ XR)) @ (cwa @ (cwss @ (cccom @ XR @ XR) @ XR) @ (cwss @ (ccxp @ XA2 @ XA2) @ (cccom @ (cccnv @ XR) @ XR))))))))))).
