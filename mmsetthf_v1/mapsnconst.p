...
thf(cmapsnconst_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccsn @ XX)) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XX @ ccvv) => (cwi @ (cwcel @ XF @ (cco @ XB2 @ XS @ ccmap)) @ (cwceq @ XF @ (ccxp @ XS @ (ccsn @ (ccfv @ XX @ XF))))))))))))).
