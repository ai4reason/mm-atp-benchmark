...
thf(aincexc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwss @ XA2 @ ccfn)) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cchash) @ (ccsu @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccfv @ (ccv @ Xs1) @ cchash) @ cc1 @ ccmin) @ ccexp) @ (ccfv @ (ccint @ (ccv @ Xs1)) @ cchash) @ ccmul))))))).
...
thf(cincexc2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwss @ XA2 @ ccfn)) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cchash) @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccexp) @ (ccsu @ (ccrab @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ cchash) @ (ccv @ Xn))) @ (^ [Xk:$i] : (ccpw @ XA2))) @ (^ [Xs1:$i] : (ccfv @ (ccint @ (ccv @ Xs1)) @ cchash))) @ ccmul))))))).
