...
thf(aexse2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwse @ XA2 @ XR)))))).
...
thf(cdfac8clem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xs1:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XF @ Xs1 @ Xr @ Xa @ Xb) @ (ccmpt @ (^ [Xs1:$i] : (ccdif @ XA2 @ (ccsn @ cc0))) @ (^ [Xs1:$i] : (ccrio @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwn @ (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ (ccv @ Xr)))) @ (^ [Xb:$i] : (ccv @ Xs1)))) @ (^ [Xa:$i] : (ccv @ Xs1)))))))))) => (! [Xz:$i] : (! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwcel @ XA2 @ (XB2 @ Xz @ Xf1 @ Xa @ Xb)) @ (cwi @ (cwex @ (^ [Xr:$i] : (cwwe @ (ccuni @ XA2) @ (ccv @ Xr)))) @ (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XA2))))))))))))))).
