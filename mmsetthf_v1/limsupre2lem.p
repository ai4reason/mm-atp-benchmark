...
thf(axrre4_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwcel @ XA2 @ ccr) @ (cwa @ (cwne @ XA2 @ ccmnf) @ (cwne @ XA2 @ ccpnf)))))).
...
thf(alimsuppnf_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwf @ XA2 @ ccxr @ (XF @ Xj)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwb @ (cwceq @ (ccfv @ (XF @ Xj) @ cclsp) @ ccpnf) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwa @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ ccle))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))))))))))).
