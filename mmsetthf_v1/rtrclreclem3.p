...
thf(arelexpaddd_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwrel @ XR)) => ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => (cwi @ Xph @ (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn0)) @ (cwceq @ (cccom @ (cco @ XR @ XN @ ccrelexp) @ (cco @ XR @ XM @ ccrelexp)) @ (cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp))))))))))).
...
thf(crtrclreclem3_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwrel @ XR)) => ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => (cwi @ Xph @ (cwss @ (cccom @ (ccfv @ XR @ ccrtrcl) @ (ccfv @ XR @ ccrtrcl)) @ (ccfv @ XR @ ccrtrcl)))))))).
