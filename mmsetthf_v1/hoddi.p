...
thf(ahoddii_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XR @ cclo) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (cwceq @ (cccom @ XR @ (cco @ XS @ XT @ cchod)) @ (cco @ (cccom @ XR @ XS) @ (cccom @ XR @ XT) @ cchod))))))))).
...
thf(choddi_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ cclo) @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) @ (cwceq @ (cccom @ XR @ (cco @ XS @ XT @ cchod)) @ (cco @ (cccom @ XR @ XS) @ (cccom @ XR @ XT) @ cchod))))))).
