...
thf(csmcnlem_conj,conjecture,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (cwceq @ (XN @ Xx3 @ Xy1 @ Xr) @ (ccfv @ XU @ ccnmcv))))) => ((cwcel @ XU @ ccnv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xr) @ (cco @ cc1 @ (cco @ cc1 @ (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ (XN @ Xx3 @ Xy1 @ Xr)) @ (ccfv @ (ccv @ Xx3) @ ccabs) @ ccaddc) @ cc1 @ ccaddc) @ (ccv @ Xr) @ ccdiv) @ ccaddc) @ ccdiv))))) => (cwcel @ XS @ (cco @ (cco @ XK @ XJ @ cctx) @ XJ @ cccn))))))))))))))))))).
