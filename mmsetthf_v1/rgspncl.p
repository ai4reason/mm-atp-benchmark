...
thf(crgspncl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XN @ (ccfv @ XR @ ccrgspn))) => ((cwi @ Xph @ (cwceq @ XU @ (ccfv @ XA2 @ XN))) => (cwi @ Xph @ (cwcel @ XU @ (ccfv @ XR @ ccsubrg))))))))))))))).
