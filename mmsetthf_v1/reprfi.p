...
thf(creprfi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ ccfn))))))))))).
