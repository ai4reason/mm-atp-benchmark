...
thf(adiadm_thm,axiom,(! [XB2:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccfv @ XK @ cclh))) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ XW @ (ccfv @ XK @ ccdia)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XK @ (XV @ Xx3)) @ (cwcel @ XW @ (XH @ Xx3))) @ (cwceq @ (ccdm @ (XI @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XW @ Xc_le)) @ (^ [Xx3:$i] : XB2))))))))))))))))).
...
thf(adiaelval_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdia))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwbr @ XX @ XW @ Xc_le))) @ (cwb @ (cwcel @ XF @ (ccfv @ XX @ XI)) @ (cwa @ (cwcel @ XF @ XT) @ (cwbr @ (ccfv @ XF @ XR) @ XX @ Xc_le)))))))))))))))))))))).
...
thf(cdiaglbN_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XK @ ccglb)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdia))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwss @ XS @ (ccdm @ XI)) @ (cwne @ XS @ cc0))) @ (cwceq @ (ccfv @ (ccfv @ XS @ XG) @ XI) @ (cciin @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XI))))))))))))))).
