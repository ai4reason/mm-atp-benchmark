...
thf(crnmptsn_conj,conjecture,(! [XA2:($i > ($i > $o))] : (cwceq @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3))))) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xu) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
