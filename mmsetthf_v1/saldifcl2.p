...
thf(asalincl_thm,axiom,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ ccsalg) @ (cwcel @ XE @ XS) @ (cwcel @ XF @ XS)) @ (cwcel @ (ccin @ XE @ XF) @ XS)))))).
thf(csaldifcl2_conj,conjecture,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ ccsalg) @ (cwcel @ XE @ XS) @ (cwcel @ XF @ XS)) @ (cwcel @ (ccdif @ XE @ XF) @ XS)))))).
