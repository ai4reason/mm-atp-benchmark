...
thf(cedginwlk_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwfun @ XI) @ (cwcel @ XF @ (ccword @ (ccdm @ XI))) @ (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) @ (cwcel @ (ccfv @ (ccfv @ XK @ XF) @ XI) @ XE)))))))))).
