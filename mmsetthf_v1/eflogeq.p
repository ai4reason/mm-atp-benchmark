...
thf(ceflogeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cce) @ XB2) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XA2 @ (cco @ (ccfv @ XB2 @ cclog) @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccaddc))) @ (^ [Xn:$i] : ccz))))))).
