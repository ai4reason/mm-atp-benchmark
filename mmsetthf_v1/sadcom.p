...
thf(ahadcoma_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwhad @ Xph @ Xps @ Xch) @ (cwhad @ Xps @ Xph @ Xch)))))).
...
thf(acadcoma_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwcad @ Xph @ Xps @ Xch) @ (cwcad @ Xps @ Xph @ Xch)))))).
...
thf(csadcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccn0) @ (cwss @ XB2 @ ccn0)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccsad) @ (cco @ XB2 @ XA2 @ ccsad)))))).
