...
thf(acoeeulem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xz @ Xk) @ (ccfv @ (XS @ Xz @ Xk) @ ccply))))) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ ccc @ ccn0 @ ccmap))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ ccc @ ccn0 @ ccmap))) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwceq @ (ccima @ XA2 @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0))) => ((cwi @ Xph @ (cwceq @ (ccima @ XB2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xz @ Xk) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xz @ Xk) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XB2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => (cwi @ Xph @ (cwceq @ XA2 @ XB2))))))))))))))))))).
...
thf(asimp1rr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (cwi @ (cw3a @ (cwa @ Xch @ (cwa @ Xph @ Xps)) @ Xth @ Xta) @ Xps))))))).
...
thf(ccoeeu_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwcel @ (XF @ Xz @ Xk) @ (ccfv @ (XS @ Xz @ Xk) @ ccply)) @ (cwreu @ (^ [Xa:$i] : (cwrex @ (^ [Xn:$i] : (cwa @ (cwceq @ (ccima @ (ccv @ Xa) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0)) @ (cwceq @ (XF @ Xz @ Xk) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xa:$i] : (cco @ ccc @ ccn0 @ ccmap))))))))).
