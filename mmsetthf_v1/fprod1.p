...
thf(cfprod1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XM) @ (cwceq @ (XA2 @ Xk) @ XB2))) => (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XM @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XB2))))))).
