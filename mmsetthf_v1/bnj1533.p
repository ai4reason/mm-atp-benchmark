...
thf(abnj1142_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (Xps @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))).
...
thf(abnj1211_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (Xps @ Xx3))))))))))).
...
thf(cbnj1533_conj,conjecture,(! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xz:$i] : (cwi @ (Xth @ Xz) @ (cwral @ (^ [Xz:$i] : (cwn @ (cwcel @ (ccv @ Xz) @ (XD @ Xz)))) @ (^ [Xz:$i] : (XB2 @ Xz))))) => ((! [Xz:$i] : (cwss @ (XB2 @ Xz) @ (XA2 @ Xz))) => ((! [Xz:$i] : (cwceq @ (XD @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwne @ (XC @ Xz) @ (XE @ Xz))) @ (^ [Xz:$i] : (XA2 @ Xz))))) => (! [Xz:$i] : (cwi @ (Xth @ Xz) @ (cwral @ (^ [Xz:$i] : (cwceq @ (XC @ Xz) @ (XE @ Xz))) @ (^ [Xz:$i] : (XB2 @ Xz))))))))))))))).
