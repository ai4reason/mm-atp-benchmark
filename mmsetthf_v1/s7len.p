...
thf(as6len_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ (ccs6 @ XA2 @ XB2 @ XC @ XD @ XE @ XF) @ cchash) @ cc6)))))))).
thf(a_6p1e7_thm,axiom,(cwceq @ (cco @ cc6 @ cc1 @ ccaddc) @ cc7)).
thf(cs7len_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccfv @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ cchash) @ cc7))))))))).
