...
thf(almhmeql_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XU @ (ccfv @ XS @ cclss)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XG @ (cco @ XS @ XT @ cclmhm))) @ (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ XU))))))))).
...
thf(afneqeql_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XA2)) @ (cwb @ (cwceq @ XF @ XG) @ (cwceq @ (ccdm @ (ccin @ XF @ XG)) @ XA2))))))).
...
thf(clspextmo_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XK @ (ccfv @ XS @ cclspn)) => (cwi @ (cwa @ (cwss @ XX @ XB2) @ (cwceq @ (ccfv @ XX @ XK) @ XB2)) @ (cwrmo @ (^ [Xg1:$i] : (cwceq @ (ccres @ (ccv @ Xg1) @ XX) @ XF)) @ (^ [Xg1:$i] : (cco @ XS @ XT @ cclmhm))))))))))))).
