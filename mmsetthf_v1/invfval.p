...
thf(cinvfval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XN @ (ccfv @ XC @ ccinv)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwceq @ XS @ (ccfv @ XC @ ccsect)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ XN) @ (ccin @ (cco @ XX @ XY @ XS) @ (cccnv @ (cco @ XY @ XX @ XS))))))))))))))))))).
