...
thf(chis35_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwcel @ XC @ cchil) @ (cwcel @ XD @ cchil))) @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccsm) @ (cco @ XB2 @ XD @ ccsm) @ ccsp) @ (cco @ (cco @ XA2 @ (ccfv @ XB2 @ cccj) @ ccmul) @ (cco @ XC @ XD @ ccsp) @ ccmul)))))))).
