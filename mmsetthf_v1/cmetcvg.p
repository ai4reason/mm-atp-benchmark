...
thf(ccmetcvg_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwcel @ XF @ (ccfv @ XD @ cccfil))) @ (cwne @ (cco @ XJ @ XF @ ccflim) @ cc0)))))))).
