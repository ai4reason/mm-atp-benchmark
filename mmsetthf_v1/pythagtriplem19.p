...
thf(apythagtriplem18_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ XC @ cc2 @ ccexp)) @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds)))) @ (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cw3a @ (cwceq @ XA2 @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin)) @ (cwceq @ XB2 @ (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul)) @ (cwceq @ XC @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc)))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn))))))).
