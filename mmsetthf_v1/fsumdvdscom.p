...
thf(advdsflip_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : (XA2 @ Xx3)) @ (^ [Xy1:$i] : (cco @ XN @ (ccv @ Xy1) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwf1o @ (XA2 @ Xx3) @ (XA2 @ Xx3) @ (XF @ Xx3 @ Xy1))))))))))).
...
thf(afsumdvdsdiag_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XN @ ccn))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwa @ (cwcel @ (ccv @ Xj) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn))) @ (cwcel @ (ccv @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XN @ (ccv @ Xj) @ ccdiv) @ ccdvds)) @ (^ [Xx3:$i] : ccn))))) @ (cwcel @ (XA2 @ Xx3 @ Xj @ Xk) @ ccc))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xj:$i] : (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XN @ (ccv @ Xj) @ ccdiv) @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xj @ Xk))))) @ (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xk:$i] : (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XN @ (ccv @ Xk) @ ccdiv) @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xj:$i] : (XA2 @ Xx3 @ Xj @ Xk)))))))))))))).
...
thf(afsumdvdsdiaglem_thm,axiom,(! [Xph:($i > $o)] : (! [Xj:$i] : (! [Xk:$i] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XN @ ccn))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwi @ (cwa @ (cwcel @ (ccv @ Xj) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn))) @ (cwcel @ (ccv @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XN @ (ccv @ Xj) @ ccdiv) @ ccdvds)) @ (^ [Xx3:$i] : ccn)))) @ (cwa @ (cwcel @ (ccv @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn))) @ (cwcel @ (ccv @ Xj) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XN @ (ccv @ Xk) @ ccdiv) @ ccdvds)) @ (^ [Xx3:$i] : ccn))))))))))))).
...
thf(cfsumdvdscom_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XN @ ccn))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ (ccv @ Xk) @ (ccv @ Xm) @ ccmul)) @ (cwceq @ (XA2 @ Xx3 @ Xj @ Xk) @ (XB2 @ Xx3 @ Xk @ Xm))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwa @ (cwcel @ (ccv @ Xj) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn))) @ (cwcel @ (ccv @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xj) @ ccdvds)) @ (^ [Xx3:$i] : ccn))))) @ (cwcel @ (XA2 @ Xx3 @ Xj @ Xk) @ ccc))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xj:$i] : (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xj) @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xj @ Xk))))) @ (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xk:$i] : (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XN @ (ccv @ Xk) @ ccdiv) @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xm:$i] : (XB2 @ Xx3 @ Xk @ Xm)))))))))))))))).
