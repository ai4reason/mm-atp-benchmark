...
thf(celss2prb_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwb @ (cwcel @ XP @ (ccrab @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ cchash) @ cc2)) @ (^ [Xz:$i] : (ccpw @ XV)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ XP @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV)))))).
