...
thf(cpi1addval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XM @ (ccuni @ XB2))) => ((cwi @ Xph @ (cwcel @ XN @ (ccuni @ XB2))) => (cwi @ Xph @ (cwceq @ (cco @ (ccec @ XM @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ XN @ (ccfv @ XJ @ ccphtpc)) @ Xc_pl) @ (ccec @ (cco @ XM @ XN @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc))))))))))))))))))))).
