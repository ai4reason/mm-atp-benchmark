...
thf(aressval3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (cco @ XS @ XA2 @ ccress)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XE @ (ccfv @ ccnx @ ccbs)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwfun @ XS)) => ((cwi @ Xph @ (cwcel @ XE @ (ccdm @ XS))) => ((cwi @ Xph @ (cwcel @ XA2 @ XY)) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ XR @ (cco @ XS @ (ccop @ XE @ XA2) @ ccsts)))))))))))))))))))).
...
thf(aslotsbhcdif_thm,axiom,(cw3a @ (cwne @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ cchom)) @ (cwne @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ ccco)) @ (cwne @ (ccfv @ ccnx @ cchom) @ (ccfv @ ccnx @ ccco)))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(afuntpg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XZ @ XW)) @ (cw3a @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XG) @ (cwcel @ XC @ XH)) @ (cw3a @ (cwne @ XX @ XY) @ (cwne @ XX @ XZ) @ (cwne @ XY @ XZ))) @ (cwfun @ (cctp @ (ccop @ XX @ XA2) @ (ccop @ XY @ XB2) @ (ccop @ XZ @ XC))))))))))))))))).
thf(afuneqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwfun @ XA2) @ (cwfun @ XB2)))))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(aestrreslem2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwceq @ XC @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ (ccop @ (ccfv @ ccnx @ ccco) @ Xc_x)))) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwcel @ XH @ XX)) => ((cwi @ Xph @ (cwcel @ Xc_x @ XY)) => (cwi @ Xph @ (cwcel @ (ccfv @ ccnx @ ccbs) @ (ccdm @ XC)))))))))))))))).
thf(asseqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwss @ XA2 @ XC))))))))).
thf(aestrreslem1_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwceq @ XC @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ (ccop @ (ccfv @ ccnx @ ccco) @ Xc_x)))) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => (cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XC @ ccbs)))))))))))).
thf(asyl2anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(atpres_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwceq @ XT @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF)))) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwcel @ XE @ XV)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwne @ XB2 @ XA2)) => ((cwi @ Xph @ (cwne @ XC @ XA2)) => (cwi @ Xph @ (cwceq @ (ccres @ XT @ (ccdif @ ccvv @ (ccsn @ XA2))) @ (ccpr @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))))))))))))))))))))).
