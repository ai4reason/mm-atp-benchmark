...
thf(cmplmul_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_xb:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwceq @ (XP @ Xx3 @ Xy1 @ Xh @ Xk) @ (cco @ XI @ (XR @ Xy1 @ Xh) @ ccmpl)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xh @ Xk) @ (ccfv @ (XP @ Xx3 @ Xy1 @ Xh @ Xk) @ ccbs)))))) => ((! [Xy1:$i] : (! [Xh:$i] : (cwceq @ (Xc_x @ Xy1 @ Xh) @ (ccfv @ (XR @ Xy1 @ Xh) @ ccmulr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwceq @ (Xc_xb @ Xx3 @ Xy1 @ Xh @ Xk) @ (ccfv @ (XP @ Xx3 @ Xy1 @ Xh @ Xk) @ ccmulr)))))) => ((! [Xh:$i] : (cwceq @ (XD @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xy1 @ Xh) @ (cwcel @ (XF @ Xy1 @ Xh) @ (XB2 @ Xx3 @ Xy1 @ Xh @ Xk))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xy1 @ Xh) @ (cwcel @ (XG @ Xy1 @ Xh) @ (XB2 @ Xx3 @ Xy1 @ Xh @ Xk))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xy1 @ Xh) @ (cwceq @ (cco @ (XF @ Xy1 @ Xh) @ (XG @ Xy1 @ Xh) @ (Xc_xb @ Xx3 @ Xy1 @ Xh @ Xk)) @ (ccmpt @ (^ [Xk:$i] : (XD @ Xh)) @ (^ [Xk:$i] : (cco @ (XR @ Xy1 @ Xh) @ (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xk) @ (ccofr @ ccle))) @ (^ [Xy1:$i] : (XD @ Xh)))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xy1 @ Xh)) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ (ccof @ ccmin)) @ (XG @ Xy1 @ Xh)) @ (Xc_x @ Xy1 @ Xh)))) @ ccgsu))))))))))))))))))))))))))).
