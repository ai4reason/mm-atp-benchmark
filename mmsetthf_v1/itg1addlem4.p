...
thf(afunimassov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ (ccxp @ XA2 @ XB2) @ (ccdm @ XF))) @ (cwb @ (cwss @ (ccima @ XF @ (ccxp @ XA2 @ XB2)) @ XC) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XC)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
thf(aitg1val2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwss @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)) @ XA2) @ (cwss @ XA2 @ (ccdif @ ccr @ (ccsn @ ccc0))))) @ (cwceq @ (ccfv @ XF @ ccitg1) @ (ccsu @ XA2 @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccmul)))))))).
...
thf(aitg1addlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwf @ (XX @ Xk) @ (XY @ Xk) @ XF))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwss @ (XB2 @ Xk) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xk)))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (ccdm @ ccvol)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (ccfv @ (XB2 @ Xk) @ ccvol) @ ccr))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccvol) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccvol))))))))))))))))).
...
thf(aitg1addlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwa @ (cwceq @ (ccv @ Xi) @ ccc0) @ (cwceq @ (ccv @ Xj) @ ccc0)) @ ccc0 @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xi))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xj)))) @ ccvol)))))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwn @ (cwa @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ ccc0)))) @ (cwceq @ (cco @ XA2 @ XB2 @ (XI @ Xi @ Xj)) @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ XA2)) @ (ccima @ (cccnv @ XG) @ (ccsn @ XB2))) @ ccvol))))))))))))))).
...
thf(aitg1addlem2_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwa @ (cwceq @ (ccv @ Xi) @ ccc0) @ (cwceq @ (ccv @ Xj) @ ccc0)) @ ccc0 @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xi))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xj)))) @ ccvol)))))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwf @ (ccxp @ ccr @ ccr) @ ccr @ (XI @ Xi @ Xj))))))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))))).
thf(asyldan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => ((cwi @ (cwa @ Xph @ Xch) @ Xth) => (cwi @ (cwa @ Xph @ Xps) @ Xth)))))))).
thf(ai1faddlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ ccc)) @ (cwceq @ (ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccaddc))) @ (ccsn @ XA2)) @ (cciun @ (^ [Xy1:$i] : (ccrn @ XG)) @ (^ [Xy1:$i] : (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XA2 @ (ccv @ Xy1) @ ccmin))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xy1))))))))))))))).
...
thf(afsumcom_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XB2))) @ (cwcel @ (XC @ Xj @ Xk) @ ccc)))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xj @ Xk))))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (ccsu @ XA2 @ (^ [Xj:$i] : (XC @ Xj @ Xk))))))))))))))).
...
thf(adom2lem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (XC @ Xx3) @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2)) @ (cwb @ (cwceq @ (XC @ Xx3) @ (XD @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))))) => (cwi @ Xph @ (cwf1 @ XA2 @ XB2 @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))))).
thf(aex_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ Xph @ (cwi @ Xps @ Xch))))))).
thf(asubcan2ad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin)) @ (cwceq @ XA2 @ XB2))))))))))).
...
thf(abrelrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwbr @ XA2 @ XB2 @ XC) @ (cwcel @ XB2 @ (ccrn @ XC))))))))).
...
thf(citg1addlem4_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > $o))))] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xz @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwa @ (cwceq @ (ccv @ Xi) @ ccc0) @ (cwceq @ (ccv @ Xj) @ ccc0)) @ ccc0 @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xi))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xj)))) @ ccvol))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xi @ Xj) @ (ccres @ ccaddc @ (ccxp @ (ccrn @ XF) @ (ccrn @ XG)))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccitg1) @ (ccsu @ (ccrn @ XF) @ (^ [Xy1:$i] : (ccsu @ (ccrn @ XG) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccaddc) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (XI @ Xz @ Xi @ Xj)) @ ccmul))))))))))))))))))).
