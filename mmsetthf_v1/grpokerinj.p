...
thf(agrpoeqdivid_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XU @ (ccfv @ XG @ ccgi)) => ((cwceq @ XD @ (ccfv @ XG @ ccgs)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgr) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cco @ XA2 @ XB2 @ XD) @ XU))))))))))))).
...
thf(cgrpokerinj_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XW @ (ccfv @ XG @ ccgi)) => ((cwceq @ XY @ (ccrn @ XH)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgr) @ (cwcel @ XH @ ccgr) @ (cwcel @ XF @ (cco @ XG @ XH @ ccghomOLD))) @ (cwb @ (cwf1 @ XX @ XY @ XF) @ (cwceq @ (ccima @ (cccnv @ XF) @ (ccsn @ XU)) @ (ccsn @ XW)))))))))))))))).
