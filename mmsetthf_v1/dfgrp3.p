...
thf(agrpsgrp_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccgrp) @ (cwcel @ XG @ ccsgrp)))).
...
thf(adfgrp3lem_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccsgrp) @ (cwne @ XB2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwrex @ (^ [Xl:$i] : (cwceq @ (cco @ (ccv @ Xl) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xy1))) @ (^ [Xl:$i] : XB2)) @ (cwrex @ (^ [Xr:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ Xc_pl) @ (ccv @ Xy1))) @ (^ [Xr:$i] : XB2)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) @ (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xa:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xu) @ (ccv @ Xa) @ Xc_pl) @ (ccv @ Xa)) @ (cwrex @ (^ [Xi:$i] : (cwceq @ (cco @ (ccv @ Xi) @ (ccv @ Xa) @ Xc_pl) @ (ccv @ Xu))) @ (^ [Xi:$i] : XB2)))) @ (^ [Xa:$i] : XB2))) @ (^ [Xu:$i] : XB2))))))))).
thf(ccmgm_tp,type,(ccmgm : ($i > $o))).
thf(adfgrp2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwb @ (cwcel @ XG @ ccgrp) @ (cwa @ (cwcel @ XG @ ccsgrp) @ (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xx3)) @ (cwrex @ (^ [Xi:$i] : (cwceq @ (cco @ (ccv @ Xi) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xn))) @ (^ [Xi:$i] : XB2)))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xn:$i] : XB2)))))))))).
thf(cdfgrp3_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwb @ (cwcel @ XG @ ccgrp) @ (cw3a @ (cwcel @ XG @ ccsgrp) @ (cwne @ XB2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwrex @ (^ [Xl:$i] : (cwceq @ (cco @ (ccv @ Xl) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xy1))) @ (^ [Xl:$i] : XB2)) @ (cwrex @ (^ [Xr:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ Xc_pl) @ (ccv @ Xy1))) @ (^ [Xr:$i] : XB2)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
