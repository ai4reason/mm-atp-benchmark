...
thf(adgreq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xz @ Xk) @ (ccfv @ (XS @ Xz @ Xk) @ ccply))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwf @ ccn0 @ ccc @ XA2)) => ((cwi @ Xph @ (cwceq @ (ccima @ XA2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xz @ Xk) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => ((cwi @ Xph @ (cwne @ (ccfv @ XN @ XA2) @ ccc0)) => (! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XF @ Xz @ Xk) @ ccdgr) @ XN)))))))))))))))).
...
thf(cbasellem2_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => ((! [Xt:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xt @ Xj) @ (ccmpt @ (^ [Xt:$i] : ccc) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ ccbc) @ (cco @ (ccneg @ cc1) @ (cco @ XM @ (ccv @ Xj) @ ccmin) @ ccexp) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccv @ Xj) @ ccexp) @ ccmul)))))))) => (! [Xt:$i] : (! [Xj:$i] : (cwi @ (cwcel @ XM @ ccn) @ (cw3a @ (cwcel @ (XP @ Xt @ Xj) @ (ccfv @ ccc @ ccply)) @ (cwceq @ (ccfv @ (XP @ Xt @ Xj) @ ccdgr) @ XM) @ (cwceq @ (ccfv @ (XP @ Xt @ Xj) @ cccoe) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccbc) @ (cco @ (ccneg @ cc1) @ (cco @ XM @ (ccv @ Xn) @ ccmin) @ ccexp) @ ccmul)))))))))))))).
