...
thf(cisotone1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwss @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwss @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xb) @ XF)))) @ (^ [Xb:$i] : (ccpw @ XA2)))) @ (^ [Xa:$i] : (ccpw @ XA2))) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwss @ (ccun @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xb) @ XF)) @ (ccfv @ (ccun @ (ccv @ Xa) @ (ccv @ Xb)) @ XF))) @ (^ [Xb:$i] : (ccpw @ XA2)))) @ (^ [Xa:$i] : (ccpw @ XA2))))))).
