...
thf(ajensenlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ (XD @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ (XD @ Xz) @ ccr @ (XF @ Xz)))) => ((! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwa @ (cwcel @ (ccv @ Xa) @ (XD @ Xz)) @ (cwcel @ (ccv @ Xb) @ (XD @ Xz)))) @ (cwss @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccicc) @ (XD @ Xz)))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XA2 @ Xz) @ ccfn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ (XA2 @ Xz) @ (cco @ ccc0 @ ccpnf @ ccico) @ (XT @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ (XA2 @ Xz) @ (XD @ Xz) @ (XX @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ ccc0 @ (cco @ cccnfld @ (XT @ Xz) @ ccgsu) @ cclt))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XD @ Xz)) @ (cwcel @ (ccv @ Xy1) @ (XD @ Xz)) @ (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xt) @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccv @ Xy1) @ ccmul) @ ccaddc) @ (XF @ Xz)) @ (cco @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xz)) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xy1) @ (XF @ Xz)) @ ccmul) @ ccaddc) @ ccle)))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwn @ (cwcel @ (ccv @ Xz) @ XB2)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ (ccun @ XB2 @ (ccsn @ (ccv @ Xz))) @ (XA2 @ Xz)))) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (cco @ cccnfld @ (ccres @ (XT @ Xz) @ XB2) @ ccgsu))) => ((! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xz @ Xa @ Xb) @ (cco @ cccnfld @ (ccres @ (XT @ Xz) @ (ccun @ XB2 @ (ccsn @ (ccv @ Xz)))) @ ccgsu))))) => (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz) @ (cwceq @ (XL @ Xz @ Xa @ Xb) @ (cco @ (XS @ Xz) @ (ccfv @ (ccv @ Xz) @ (XT @ Xz)) @ ccaddc)))))))))))))))))))))))))))).
...
thf(acvxcl_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XD) @ (cwcel @ (ccv @ Xy1) @ XD))) @ (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XD)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwcel @ (XT @ Xx3 @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwcel @ (cco @ (cco @ (XT @ Xx3 @ Xy1) @ XX @ ccmul) @ (cco @ (cco @ cc1 @ (XT @ Xx3 @ Xy1) @ ccmin) @ XY @ ccmul) @ ccaddc) @ XD)))))))))))).
...
thf(avtocl3ga_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz) @ (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3)) @ (cwb @ (Xps @ Xy1 @ Xz) @ (Xch @ Xx3 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1)) @ (cwb @ (Xch @ Xx3 @ Xz) @ (Xth @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XD) @ (cwcel @ (ccv @ Xy1) @ XR) @ (cwcel @ (ccv @ Xz) @ XS)) @ (Xph @ Xx3 @ Xy1 @ Xz))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ (XB2 @ Xx3) @ XR) @ (cwcel @ (XC @ Xx3 @ Xy1) @ XS)) @ (Xth @ Xx3 @ Xy1))))))))))))))))))).
