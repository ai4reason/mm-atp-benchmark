...
thf(cmulgval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ XS @ (ccseq @ Xc_pl @ (ccxp @ ccn @ (ccsn @ XX)) @ cc1)) => (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ XN @ XX @ Xc_x) @ (ccif @ (cwceq @ XN @ ccc0) @ Xc_0 @ (ccif @ (cwbr @ ccc0 @ XN @ cclt) @ (ccfv @ XN @ XS) @ (ccfv @ (ccfv @ (ccneg @ XN) @ XS) @ XI))))))))))))))))))))).
