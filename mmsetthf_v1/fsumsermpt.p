...
thf(cfsumsermpt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XM @ ccz))) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccc)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccsu @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk)))))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xk @ Xn) @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XM)))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (XF @ Xk @ Xn) @ (XG @ Xk @ Xn))))))))))))))))).
