...
thf(adf_reverse_ax,axiom,(cwceq @ ccreverse @ (ccmpt @ (^ [Xs1:$i] : ccvv) @ (^ [Xs1:$i] : (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xs1) @ cchash) @ cc1 @ ccmin) @ (ccv @ Xx3) @ ccmin) @ (ccv @ Xs1)))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(crevval_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwcel @ XW @ (XV @ Xx3)) @ (cwceq @ (ccfv @ XW @ ccreverse) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccv @ Xx3) @ ccmin) @ XW))))))))).
