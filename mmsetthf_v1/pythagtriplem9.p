...
thf(cpythagtriplem9_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ XC @ cc2 @ ccexp)) @ (cwa @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds)))) @ (cwcel @ (ccfv @ (cco @ XC @ XB2 @ ccaddc) @ ccsqrt) @ ccn)))))).
