...
thf(anmbdoplb_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ ccbo) @ (cwcel @ XA2 @ cchil)) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccno) @ (cco @ (ccfv @ XT @ ccnop) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))).
...
thf(cleopnmid_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ ccho) @ (cwcel @ (ccfv @ XT @ ccnop) @ ccr)) @ (cwbr @ XT @ (cco @ (ccfv @ XT @ ccnop) @ cchio @ cchot) @ ccleo)))).
