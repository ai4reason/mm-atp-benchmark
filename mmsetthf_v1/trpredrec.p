...
thf(aeltrpred_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwb @ (cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) @ (cwrex @ (^ [Xi:$i] : (cwcel @ XY @ (ccfv @ (ccv @ Xi) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xy1:$i] : (ccv @ Xa)) @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))))) @ (ccpred @ XA2 @ XR @ XX)) @ ccom)))) @ (^ [Xi:$i] : ccom)))))))).
...
thf(atrpredlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xi:$i] : (! [XX:($i > ($i > $o))] : (! [Xy1:$i] : (! [Xa:$i] : (cwi @ (cwcel @ (ccpred @ XA2 @ XR @ (XX @ Xy1)) @ (XB2 @ Xy1 @ Xa)) @ (cwss @ (ccfv @ (ccv @ Xi) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xy1:$i] : (ccv @ Xa)) @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))))) @ (ccpred @ XA2 @ XR @ (XX @ Xy1))) @ ccom)) @ XA2)))))))))).
...
thf(aelpredim_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccvv) => (cwi @ (cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) @ (cwbr @ XY @ XX @ XR)))))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(ctrpredrec_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwse @ XA2 @ XR)) @ (cwi @ (cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) @ (cwo @ (cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) @ (cwrex @ (^ [Xz:$i] : (cwbr @ XY @ (ccv @ Xz) @ XR)) @ (^ [Xz:$i] : (cctrpred @ XA2 @ XR @ XX))))))))))).
