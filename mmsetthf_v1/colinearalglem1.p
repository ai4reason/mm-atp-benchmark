...
thf(ccolinearalglem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cw3a @ (cwcel @ XD @ ccc) @ (cwcel @ XE @ ccc) @ (cwcel @ XF @ ccc))) @ (cwb @ (cwceq @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ XF @ XD @ ccmin) @ ccmul) @ (cco @ (cco @ XE @ XD @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccmul)) @ (cwceq @ (cco @ (cco @ XB2 @ XF @ ccmul) @ (cco @ (cco @ XA2 @ XF @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ ccaddc) @ ccmin) @ (cco @ (cco @ XC @ XE @ ccmul) @ (cco @ (cco @ XA2 @ XE @ ccmul) @ (cco @ XC @ XD @ ccmul) @ ccaddc) @ ccmin))))))))))).
