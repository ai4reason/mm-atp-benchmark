...
thf(cxrmaxlt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwb @ (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XB2 @ XA2) @ XC @ cclt) @ (cwa @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XB2 @ XC @ cclt)))))))).
