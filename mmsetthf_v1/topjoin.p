...
thf(ctopjoin_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwss @ XS @ (ccfv @ XX @ cctopon))) @ (cwceq @ (ccfv @ (ccfv @ (ccun @ (ccsn @ XX) @ (ccuni @ XS)) @ ccfi) @ cctg) @ (ccint @ (ccrab @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwss @ (ccv @ Xj) @ (ccv @ Xk))) @ (^ [Xj:$i] : XS))) @ (^ [Xk:$i] : (ccfv @ XX @ cctopon)))))))))).
