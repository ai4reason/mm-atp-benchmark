...
thf(cunblem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccdif @ XA2 @ (ccsuc @ (ccv @ Xx3)))))) @ (ccint @ XA2)) @ ccom))) => (! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwss @ XA2 @ ccom) @ (cwral @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwcel @ (ccv @ Xw) @ (ccv @ Xv))) @ (^ [Xv:$i] : XA2))) @ (^ [Xw:$i] : ccom))) @ (cwi @ (cwcel @ (ccv @ Xz) @ ccom) @ (cwcel @ (ccfv @ (ccv @ Xz) @ (XF @ Xx3)) @ XA2))))))))).
