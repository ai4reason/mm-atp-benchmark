...
thf(aissmfle2d_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwnf @ (^ [Xa:$i] : (Xph @ Xa))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XS @ ccsalg))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwss @ (XD @ Xa) @ (ccuni @ XS)))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwf @ (XD @ Xa) @ ccr @ XF))) => ((! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xa) @ (cwcel @ (ccv @ Xa) @ ccr)) @ (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ ccmnf @ (ccv @ Xa) @ ccioc)) @ (cco @ XS @ (XD @ Xa) @ ccrest)))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn)))))))))))))).
...
thf(asmfsuplem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwcel @ (XM @ Xx3 @ Xy1 @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xn) @ ccuz))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwcel @ (XS @ Xx3 @ Xn) @ ccsalg)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xn) @ ccsmblfn) @ XF)))) => ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdm @ (ccfv @ (ccv @ Xn) @ XF)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (XD @ Xn)) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt))))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwcel @ (XA2 @ Xx3) @ ccr)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwcel @ (ccima @ (cccnv @ (XG @ Xx3 @ Xy1 @ Xn)) @ (cco @ ccmnf @ (XA2 @ Xx3) @ ccioc)) @ (cco @ (XS @ Xx3 @ Xn) @ (XD @ Xn) @ ccrest)))))))))))))))))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(csmfsuplem3_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xy1) @ ccz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xy1) @ ccuz)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xx3) @ ccsalg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XZ @ (ccfv @ (XS @ Xx3) @ ccsmblfn) @ XF))) => ((cwceq @ XD @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdm @ (ccfv @ (ccv @ Xn) @ XF))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccfv @ (XS @ Xx3) @ ccsmblfn)))))))))))))))))))).
