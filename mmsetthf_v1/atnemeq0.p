...
thf(aatsseq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2)))))).
...
thf(catnemeq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwne @ XA2 @ XB2) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)))))).
