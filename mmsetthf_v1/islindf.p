...
thf(cislindf_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XB2 @ Xx3 @ Xk) @ (ccfv @ XW @ ccbs)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (Xc_x @ Xx3 @ Xk) @ (ccfv @ XW @ ccvsca)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XK @ Xx3 @ Xk) @ (ccfv @ XW @ cclspn)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XS @ Xx3 @ Xk) @ (ccfv @ XW @ ccsca)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XN @ Xx3) @ (ccfv @ (XS @ Xx3 @ Xk) @ ccbs)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ (XS @ Xx3 @ Xk) @ cc0g)))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XW @ (XY @ Xx3 @ Xk)) @ (cwcel @ XF @ (XX @ Xx3 @ Xk))) @ (cwb @ (cwbr @ XF @ XW @ cclindf) @ (cwa @ (cwf @ (ccdm @ XF) @ (XB2 @ Xx3 @ Xk) @ XF) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwn @ (cwcel @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xx3) @ XF) @ (Xc_x @ Xx3 @ Xk)) @ (ccfv @ (ccima @ XF @ (ccdif @ (ccdm @ XF) @ (ccsn @ (ccv @ Xx3)))) @ (XK @ Xx3 @ Xk))))) @ (^ [Xk:$i] : (ccdif @ (XN @ Xx3) @ (ccsn @ (Xc_0 @ Xx3)))))) @ (^ [Xx3:$i] : (ccdm @ XF))))))))))))))))))))))))).
