...
thf(alogdivbnd_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ (ccv @ Xn) @ ccdiv))) @ (cco @ (cco @ (cco @ (ccfv @ XN @ cclog) @ cc1 @ ccaddc) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccle)))).
...
thf(alediv2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XC @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ ccle))))))))))).
...
thf(aremsqsqrt_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ XA2)))).
...
thf(alemul2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccle))))))))))).
...
thf(cpntlemk_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwcel @ (XA2 @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ ccrp))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwcel @ (XB2 @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ ccrp))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwcel @ (XL @ Xa) @ (cco @ ccc0 @ cc1 @ ccioo))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwceq @ (XD @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ (cco @ (XA2 @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ cc1 @ ccaddc))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwceq @ (XF @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (XD @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ ccdiv) @ ccmin) @ (cco @ (cco @ (XL @ Xa) @ (cco @ (ccdc @ cc3 @ cc2) @ (XB2 @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ ccmul) @ ccdiv) @ (cco @ (XD @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ cc2 @ ccexp) @ ccdiv) @ ccmul))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwcel @ (XU @ Xy1 @ Xu @ Xa) @ ccrp)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwbr @ (XU @ Xy1 @ Xu @ Xa) @ (XA2 @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ ccle))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwceq @ XE @ (cco @ (XU @ Xy1 @ Xu @ Xa) @ (XD @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwceq @ (XK @ Xu @ Xa) @ (ccfv @ (cco @ (XB2 @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ XE @ ccdiv) @ cce))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwa @ (cwcel @ (XY @ Xy1 @ Xu @ Xa) @ ccrp) @ (cwbr @ cc1 @ (XY @ Xy1 @ Xu @ Xa) @ ccle))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwa @ (cwcel @ (XX @ Xu @ Xa) @ ccrp) @ (cwbr @ (XY @ Xy1 @ Xu @ Xa) @ (XX @ Xu @ Xa) @ cclt))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwcel @ (XC @ Xy1 @ Xu @ Xn @ Xa) @ ccrp))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwceq @ (XW @ Xy1 @ Xu @ Xa) @ (cco @ (cco @ (cco @ (XY @ Xy1 @ Xu @ Xa) @ (cco @ cc4 @ (cco @ (XL @ Xa) @ XE @ ccmul) @ ccdiv) @ ccaddc) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ (XX @ Xu @ Xa) @ (cco @ (XK @ Xu @ Xa) @ cc2 @ ccexp) @ ccmul) @ cc4 @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ (ccdc @ cc3 @ cc2) @ (XB2 @ Xy1 @ Xz @ Xu @ Xn @ Xa) @ ccmul) @ (cco @ (cco @ (XU @ Xy1 @ Xu @ Xa) @ XE @ ccmin) @ (cco @ (XL @ Xa) @ (cco @ XE @ cc2 @ ccexp) @ ccmul) @ ccmul) @ ccdiv) @ (cco @ (cco @ (XU @ Xy1 @ Xu @ Xa) @ cc3 @ ccmul) @ (XC @ Xy1 @ Xu @ Xn @ Xa) @ ccaddc) @ ccmul) @ cce) @ ccaddc) @ ccaddc))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwcel @ (XZ @ Xy1 @ Xa) @ (cco @ (XW @ Xy1 @ Xu @ Xa) @ ccpnf @ ccico))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwceq @ (XM @ Xy1 @ Xu @ Xa) @ (cco @ (ccfv @ (cco @ (ccfv @ (XX @ Xu @ Xa) @ cclog) @ (ccfv @ (XK @ Xu @ Xa) @ cclog) @ ccdiv) @ ccfl) @ cc1 @ ccaddc))))) => ((! [Xy1:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwceq @ (XN @ Xy1 @ Xu @ Xa) @ (ccfv @ (cco @ (cco @ (ccfv @ (XZ @ Xy1 @ Xa) @ cclog) @ (ccfv @ (XK @ Xu @ Xa) @ cclog) @ ccdiv) @ cc2 @ ccdiv) @ ccfl))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ (XR @ Xa)) @ (ccv @ Xz) @ ccdiv) @ ccabs) @ (XU @ Xy1 @ Xu @ Xa) @ ccle)) @ (^ [Xz:$i] : (cco @ (XY @ Xy1 @ Xu @ Xa) @ ccpnf @ ccico)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwa @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt) @ (cwbr @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xa) @ XE @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ (cco @ (XK @ Xu @ Xa) @ (ccv @ Xy1) @ ccmul) @ cclt)) @ (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xu) @ (XR @ Xa)) @ (ccv @ Xu) @ ccdiv) @ ccabs) @ XE @ ccle)) @ (^ [Xu:$i] : (cco @ (ccv @ Xz) @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xa) @ XE @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ ccicc))))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : (cco @ (XX @ Xu @ Xa) @ ccpnf @ ccioo)))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xy1 @ Xz @ Xu @ Xa) @ (cwbr @ (cco @ cc2 @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (XZ @ Xy1 @ Xa) @ (XY @ Xy1 @ Xu @ Xa) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (XU @ Xy1 @ Xu @ Xa) @ (ccv @ Xn) @ ccdiv) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul))) @ ccmul) @ (cco @ (cco @ (XU @ Xy1 @ Xu @ Xa) @ (cco @ (ccfv @ (XZ @ Xy1 @ Xa) @ cclog) @ cc3 @ ccaddc) @ ccmul) @ (ccfv @ (XZ @ Xy1 @ Xa) @ cclog) @ ccmul) @ ccle))))))))))))))))))))))))))))))))))))))))))).
