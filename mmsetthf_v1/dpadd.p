...
thf(adecdiv10_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccr) => (cwceq @ (cco @ (ccdc @ XA2 @ XB2) @ (ccdc @ cc1 @ ccc0) @ ccdiv) @ (cco @ XA2 @ XB2 @ ccdp))))))).
thf(ann0rei_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => (cwcel @ XA2 @ ccr)))).
thf(cdpadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwcel @ XE @ ccn0) => ((cwcel @ XF @ ccn0) => ((cwceq @ (cco @ (ccdc @ XA2 @ XB2) @ (ccdc @ XC @ XD) @ ccaddc) @ (ccdc @ XE @ XF)) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdp) @ (cco @ XC @ XD @ ccdp) @ ccaddc) @ (cco @ XE @ XF @ ccdp)))))))))))))))).
