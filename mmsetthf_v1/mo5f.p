...
thf(cmo5f_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : (cwnf @ (^ [Xi:$i] : (Xph @ Xx3 @ Xi @ Xj))))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xx3 @ Xi @ Xj))))) => (! [Xi:$i] : (! [Xj:$i] : (cwb @ (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xi @ Xj))) @ (cwal @ (^ [Xi:$i] : (cwal @ (^ [Xj:$i] : (cwi @ (cwa @ (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xi @ Xj)) @ Xi) @ (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xi @ Xj)) @ Xj)) @ (cwceq @ (ccv @ Xi) @ (ccv @ Xj)))))))))))))).
