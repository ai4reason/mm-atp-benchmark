...
thf(asxbrsigalem2_thm,axiom,(! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xv @ Xu @ Xe @ Xf1 @ Xn) @ (ccfv @ (ccrn @ ccioo) @ cctg))))))) => ((! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XI @ Xe @ Xf1 @ Xn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico)))))))) => ((! [Xv:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xv @ Xu @ Xe @ Xf1) @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xe @ Xf1 @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xe @ Xf1 @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (ccv @ Xu) @ (ccv @ Xv))))))))))) => (! [Xv:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xf1:$i] : (cwss @ (ccfv @ (ccrn @ (XR @ Xv @ Xu @ Xe @ Xf1)) @ ccsigagen) @ (ccfv @ (ccun @ (ccrn @ (ccmpt @ (^ [Xe:$i] : ccr) @ (^ [Xe:$i] : (ccxp @ (cco @ (ccv @ Xe) @ ccpnf @ ccico) @ ccr)))) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : ccr) @ (^ [Xf1:$i] : (ccxp @ ccr @ (cco @ (ccv @ Xf1) @ ccpnf @ ccico)))))) @ ccsigagen))))))))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(asxbrsigalem3_thm,axiom,(! [XJ:($i > ($i > ($i > $o)))] : ((! [Xe:$i] : (! [Xf1:$i] : (cwceq @ (XJ @ Xe @ Xf1) @ (ccfv @ (ccrn @ ccioo) @ cctg)))) => (! [Xe:$i] : (! [Xf1:$i] : (cwss @ (ccfv @ (ccun @ (ccrn @ (ccmpt @ (^ [Xe:$i] : ccr) @ (^ [Xe:$i] : (ccxp @ (cco @ (ccv @ Xe) @ ccpnf @ ccico) @ ccr)))) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : ccr) @ (^ [Xf1:$i] : (ccxp @ ccr @ (cco @ (ccv @ Xf1) @ ccpnf @ ccico)))))) @ ccsigagen) @ (ccfv @ (ccfv @ (cco @ (XJ @ Xe @ Xf1) @ (XJ @ Xe @ Xf1) @ cctx) @ cccld) @ ccsigagen))))))).
...
thf(acldssbrsiga_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwss @ (ccfv @ XJ @ cccld) @ (ccfv @ XJ @ ccsigagen))))).
...
thf(csxbrsigalem4_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xv @ Xu @ Xn) @ (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xn:$i] : (cwceq @ (XI @ Xn) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico)))))) => ((! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xv @ Xu) @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (ccv @ Xu) @ (ccv @ Xv))))))))) => (! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwceq @ (ccfv @ (cco @ (XJ @ Xv @ Xu @ Xn) @ (XJ @ Xv @ Xu @ Xn) @ cctx) @ ccsigagen) @ (ccfv @ (ccrn @ (XR @ Xv @ Xu)) @ ccsigagen)))))))))))).
