...
thf(asitmcl_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XW @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XW @ ccxme)) => ((cwi @ Xph @ (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (cco @ XW @ XM @ ccsitm)) @ (cco @ ccc0 @ ccpnf @ ccicc)))))))))))))).
...
thf(csitmf_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XW @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XW @ ccxme)) => ((cwi @ Xph @ (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => (cwi @ Xph @ (cwf @ (ccxp @ (ccdm @ (cco @ XW @ XM @ ccsitg)) @ (ccdm @ (cco @ XW @ XM @ ccsitg))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (cco @ XW @ XM @ ccsitm)))))))))).
