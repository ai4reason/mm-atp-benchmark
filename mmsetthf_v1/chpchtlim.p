...
thf(ao1rlimmul_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ cco1) @ (cwbr @ XG @ ccc0 @ ccrli)) @ (cwbr @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccc0 @ ccrli))))).
...
thf(achpub_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ ccle)) @ (cwbr @ (ccfv @ XA2 @ ccchp) @ (cco @ (ccfv @ XA2 @ cccht) @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccaddc) @ ccle)))).
...
thf(achtlepsi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ XA2 @ cccht) @ (ccfv @ XA2 @ ccchp) @ ccle)))).
