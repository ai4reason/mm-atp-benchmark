...
thf(ahstoh_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ cchst) @ (cwcel @ XA2 @ ccch) @ (cwceq @ (cco @ (ccfv @ XA2 @ XS) @ (ccfv @ cchil @ XS) @ ccsp) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ XS) @ cc0v))))).
thf(chst0_conj,conjecture,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ cchst) @ (cwceq @ (ccfv @ cc0h @ XS) @ cc0v)))).
