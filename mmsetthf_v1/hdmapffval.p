...
thf(adf_hdmap_ax,axiom,(cwceq @ cchdma @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccab @ (^ [Xa:$i] : (cwsbc @ (^ [Xe:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xi:$i] : (cwcel @ (ccv @ Xa) @ (ccmpt @ (^ [Xt:$i] : (ccv @ Xv)) @ (^ [Xt:$i] : (ccrio @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccun @ (ccfv @ (ccsn @ (ccv @ Xe)) @ (ccfv @ (ccv @ Xu) @ cclspn)) @ (ccfv @ (ccsn @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xu) @ cclspn))))) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccotp @ (ccv @ Xz) @ (ccfv @ (ccotp @ (ccv @ Xe) @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cchvm))) @ (ccv @ Xz)) @ (ccv @ Xi)) @ (ccv @ Xt)) @ (ccv @ Xi))))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cclcd)) @ ccbs))))))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cchdma1)))) @ (ccfv @ (ccv @ Xu) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)))) @ (ccop @ (ccres @ ccid @ (ccfv @ (ccv @ Xk) @ ccbs)) @ (ccres @ ccid @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccltrn))))))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(chdmapffval_conj,conjecture,(! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XH @ Xy1 @ Xz @ Xv @ Xu @ Xt @ Xe @ Xi @ Xa) @ (ccfv @ XK @ cclh)))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwi @ (cwcel @ XK @ (XX @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xe @ Xi @ Xa)) @ (cwceq @ (ccfv @ XK @ cchdma) @ (ccmpt @ (^ [Xw:$i] : (XH @ Xy1 @ Xz @ Xv @ Xu @ Xt @ Xe @ Xi @ Xa)) @ (^ [Xw:$i] : (ccab @ (^ [Xa:$i] : (cwsbc @ (^ [Xe:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xi:$i] : (cwcel @ (ccv @ Xa) @ (ccmpt @ (^ [Xt:$i] : (ccv @ Xv)) @ (^ [Xt:$i] : (ccrio @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccun @ (ccfv @ (ccsn @ (ccv @ Xe)) @ (ccfv @ (ccv @ Xu) @ cclspn)) @ (ccfv @ (ccsn @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xu) @ cclspn))))) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccotp @ (ccv @ Xz) @ (ccfv @ (ccotp @ (ccv @ Xe) @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cchvm))) @ (ccv @ Xz)) @ (ccv @ Xi)) @ (ccv @ Xt)) @ (ccv @ Xi))))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cclcd)) @ ccbs))))))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cchdma1)))) @ (ccfv @ (ccv @ Xu) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)))) @ (ccop @ (ccres @ ccid @ (ccfv @ XK @ ccbs)) @ (ccres @ ccid @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccltrn))))))))))))))))))))))))).
