...
thf(crnghmval2_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccrng) @ (cwcel @ XS @ ccrng)) @ (cwceq @ (cco @ XR @ XS @ ccrngh) @ (ccin @ (cco @ XR @ XS @ ccghm) @ (cco @ (ccfv @ XR @ ccmgp) @ (ccfv @ XS @ ccmgp) @ ccmgmhm))))))).
