...
thf(aflidz_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccfl) @ XA2) @ (cwcel @ XA2 @ ccz))))).
thf(cflltnz_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwn @ (cwcel @ XA2 @ ccz))) @ (cwbr @ (ccfv @ XA2 @ ccfl) @ XA2 @ cclt)))).
