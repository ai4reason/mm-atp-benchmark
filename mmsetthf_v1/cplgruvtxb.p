...
thf(adf_cplgr_ax,axiom,(cwceq @ cccplgr @ (ccab @ (^ [Xg1:$i] : (cwceq @ (ccfv @ (ccv @ Xg1) @ ccuvtx) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
thf(ccplgruvtxb_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XW) @ (cwb @ (cwcel @ XG @ cccplgr) @ (cwceq @ (ccfv @ XG @ ccuvtx) @ XV)))))))).
