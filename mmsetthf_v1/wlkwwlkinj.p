...
thf(auspgr2wlkeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XN @ ccn0)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cc1st) @ cchash) @ XN)) @ (cwa @ (cwcel @ XB2 @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccfv @ XB2 @ cc1st) @ cchash) @ XN))) @ (cwi @ (cwceq @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XB2 @ cc2nd)) @ (cwceq @ XA2 @ XB2)))))))).
