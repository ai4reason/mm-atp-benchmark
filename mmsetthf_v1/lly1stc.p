...
thf(a_1stcrest_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cc1stc) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ cc1stc)))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(a_1stctop_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cc1stc) @ (cwcel @ XJ @ cctop)))).
thf(clly1stc_conj,conjecture,(cwceq @ (cclly @ cc1stc) @ cc1stc)).
