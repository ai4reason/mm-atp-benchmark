...
thf(crerest_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XR @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwi @ (cwss @ XA2 @ ccr) @ (cwceq @ (cco @ XJ @ XA2 @ ccrest) @ (cco @ XR @ XA2 @ ccrest))))))))).
