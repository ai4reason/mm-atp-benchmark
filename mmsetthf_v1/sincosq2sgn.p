...
thf(csincosq2sgn_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ ccpi @ ccioo)) @ (cwa @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt) @ (cwbr @ (ccfv @ XA2 @ cccos) @ ccc0 @ cclt))))).
