...
thf(ametuel_thm,axiom,(! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xw:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwne @ (XX @ Xw) @ cc0) @ (cwcel @ XD @ (ccfv @ (XX @ Xw) @ ccpsmet))) @ (cwb @ (cwcel @ (XV @ Xa) @ (ccfv @ XD @ ccmetu)) @ (cwa @ (cwss @ (XV @ Xa) @ (ccxp @ (XX @ Xw) @ (XX @ Xw))) @ (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xw) @ (XV @ Xa))) @ (^ [Xw:$i] : (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))))))))))))).
...
thf(cmetuel2_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xd:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xd) @ (ccfv @ XD @ ccmetu))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xd:$i] : (cwi @ (cwa @ (cwne @ XX @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) @ (cwb @ (cwcel @ XV @ (XU @ Xx3 @ Xy1 @ Xd)) @ (cwa @ (cwss @ XV @ (ccxp @ XX @ XX)) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XV))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) @ (^ [Xd:$i] : ccrp)))))))))))))).
