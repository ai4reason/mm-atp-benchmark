...
thf(cist1_3_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XJ @ cct1) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccint @ (ccrab @ (^ [Xo:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xo))) @ (^ [Xo:$i] : XJ))) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))))).
