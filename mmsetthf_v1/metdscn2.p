...
thf(axrsdsre_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccfv @ ccxrs @ ccds)) => (cwceq @ (ccres @ XD @ (ccxp @ ccr @ ccr)) @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr)))))).
...
thf(ametdscn_thm,axiom,(! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XC @ Xx3 @ Xy1) @ (ccfv @ ccxrs @ ccds)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XK @ Xx3 @ Xy1) @ (ccfv @ (XC @ Xx3 @ Xy1) @ ccmopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX)) @ (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3 @ Xy1) @ cccn))))))))))))))))).
...
thf(cmetdscn2_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XK @ Xx3 @ Xy1) @ (ccfv @ cccnfld @ cctopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) @ (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3 @ Xy1) @ cccn))))))))))))))).
