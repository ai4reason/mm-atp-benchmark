...
thf(adf_cbn_ax,axiom,(cwceq @ cccbn @ (ccrab @ (^ [Xu:$i] : (cwcel @ (ccfv @ (ccv @ Xu) @ ccims) @ (ccfv @ (ccfv @ (ccv @ Xu) @ ccba) @ ccms))) @ (^ [Xu:$i] : ccnv)))).
thf(ciscbn_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwb @ (cwcel @ XU @ cccbn) @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XD @ (ccfv @ XX @ ccms)))))))))).
