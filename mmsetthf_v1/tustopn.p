...
thf(ctustopn_conj,conjecture,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ XU @ cctus)) => ((cwceq @ XJ @ (ccfv @ XU @ ccutop)) => (cwi @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwceq @ XJ @ (ccfv @ XK @ cctopn)))))))))).
