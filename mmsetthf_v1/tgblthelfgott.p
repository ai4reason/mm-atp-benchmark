...
thf(aax_hgprmladder_ax,axiom,(cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cw3a @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ cc7) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xf1)) @ (ccdc @ cc1 @ cc3)) @ (cwceq @ (ccfv @ (ccv @ Xd) @ (ccv @ Xf1)) @ (cco @ (ccdc @ cc8 @ cc9) @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul))) @ (cwral @ (^ [Xi:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccmin) @ (cco @ (cco @ cc4 @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ cc4 @ ccmin) @ cclt) @ (cwbr @ cc4 @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccmin) @ cclt))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xd) @ ccfzo))))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xd) @ cciccp)))) @ (^ [Xd:$i] : (ccfv @ cc3 @ ccuz)))).
...
thf(abgoldbtbnd_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XM @ Xi @ Xn) @ (ccfv @ (ccdc @ cc1 @ cc1) @ ccuz))))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XN @ (ccfv @ (ccdc @ cc1 @ cc1) @ ccuz)))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwa @ (cwbr @ cc4 @ (ccv @ Xn) @ cclt) @ (cwbr @ (ccv @ Xn) @ XN @ cclt)) @ (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XD @ Xn) @ (ccfv @ cc3 @ ccuz))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XF @ Xn) @ (ccfv @ (XD @ Xn) @ cciccp))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xi:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ ccmin) @ (cco @ XN @ cc4 @ ccmin) @ cclt) @ (cwbr @ cc4 @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ ccmin) @ cclt))) @ (^ [Xi:$i] : (cco @ ccc0 @ (XD @ Xn) @ ccfzo)))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwceq @ (ccfv @ ccc0 @ (XF @ Xn)) @ cc7)))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwceq @ (ccfv @ cc1 @ (XF @ Xn)) @ (ccdc @ cc1 @ cc3))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwbr @ (XM @ Xi @ Xn) @ (ccfv @ (XD @ Xn) @ (XF @ Xn)) @ cclt)))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (ccfv @ (XD @ Xn) @ (XF @ Xn)) @ ccr)))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwa @ (cwbr @ cc7 @ (ccv @ Xn) @ cclt) @ (cwbr @ (ccv @ Xn) @ (XM @ Xi @ Xn) @ cclt)) @ (cwcel @ (ccv @ Xn) @ ccgbo))) @ (^ [Xn:$i] : ccodd)))))))))))))))))))).
...
thf(a_1t10e1p1e11_thm,axiom,(cwceq @ (ccdc @ cc1 @ cc1) @ (cco @ (cco @ cc1 @ (cco @ (ccdc @ cc1 @ ccc0) @ cc1 @ ccexp) @ ccmul) @ cc1 @ ccaddc))).
...
thf(aevenz_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ cceven) @ (cwcel @ XZ @ ccz)))).
thf(altle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XA2 @ XB2 @ ccle)))))).
thf(aax_bgbltosilva_ax,axiom,(! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (cwbr @ XN @ (cco @ cc4 @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ ccle)) @ (cwcel @ XN @ ccgbe)))).
...
thf(altmul1a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwa @ (cwcel @ XC @ ccr) @ (cwbr @ ccc0 @ XC @ cclt))) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ cclt)))))).
...
thf(ctgblthelfgott_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccodd) @ (cwbr @ cc7 @ XN @ cclt) @ (cwbr @ XN @ (cco @ (ccdc @ cc8 @ cc8) @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul) @ cclt)) @ (cwcel @ XN @ ccgbo)))).
