...
thf(aclimrlim2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccfv @ (ccv @ Xx3) @ ccfl)) @ (cwceq @ (XB2 @ Xn) @ (XC @ Xx3))))) => ((! [Xn:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xn) @ ccz)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xn))) @ (XD @ Xn) @ ccli))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwcel @ (XB2 @ Xn) @ ccc))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xn))) @ (cwbr @ (XM @ Xx3 @ Xn) @ (ccv @ Xx3) @ ccle)))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xn)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xn) @ ccrli)))))))))))))))))).
