...
thf(cm1expaddsub_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ ccz) @ (cwcel @ XY @ ccz)) @ (cwceq @ (cco @ (ccneg @ cc1) @ (cco @ XX @ XY @ ccmin) @ ccexp) @ (cco @ (ccneg @ cc1) @ (cco @ XX @ XY @ ccaddc) @ ccexp)))))).
