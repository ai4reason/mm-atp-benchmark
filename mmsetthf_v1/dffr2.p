...
thf(cdffr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwb @ (cwfr @ XA2 @ XR) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwne @ (ccv @ Xx3) @ cc0)) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccrab @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR)) @ (^ [Xz:$i] : (ccv @ Xx3))) @ cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))).
