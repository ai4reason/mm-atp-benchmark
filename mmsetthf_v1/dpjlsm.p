...
thf(cdpjlsm_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XS @ ccdprd) @ (cco @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ Xc_po)))))))))))))).
