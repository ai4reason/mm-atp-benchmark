...
thf(ccxprec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ cccxp) @ (cco @ cc1 @ (cco @ XA2 @ XB2 @ cccxp) @ ccdiv)))))).
