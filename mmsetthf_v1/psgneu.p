...
thf(apsgneldm2_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (! [Xw:$i] : (cwi @ (cwcel @ XD @ (XV @ Xw)) @ (cwb @ (cwcel @ XP @ (ccdm @ XN)) @ (cwrex @ (^ [Xw:$i] : (cwceq @ XP @ (cco @ XG @ (ccv @ Xw) @ ccgsu))) @ (^ [Xw:$i] : (ccword @ XT)))))))))))))))).
...
thf(cpsgneu_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwcel @ XP @ (ccdm @ XN)) @ (cweu @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ XP @ (cco @ XG @ (ccv @ Xw) @ ccgsu)) @ (cwceq @ (ccv @ Xs1) @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ XT))))))))))))))).
