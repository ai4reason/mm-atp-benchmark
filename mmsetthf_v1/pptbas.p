...
thf(appttop_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XP @ XA2)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwceq @ (ccv @ Xx3) @ cc0))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ cctopon))))))).
...
thf(cpptbas_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XP @ XA2)) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwceq @ (ccv @ Xx3) @ cc0))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccpr @ (ccv @ Xx3) @ XP)))) @ cctg))))))).
