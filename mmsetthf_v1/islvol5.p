...
thf(aislvol3_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xy1:$i] : (cwceq @ (Xc_le @ Xy1) @ (ccfv @ XK @ ccple))) => ((! [Xy1:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xy1 @ Xp) @ (ccfv @ XK @ ccjn)))) => ((! [Xy1:$i] : (cwceq @ (XA2 @ Xy1) @ (ccfv @ XK @ ccatm))) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => ((! [Xy1:$i] : (! [Xp:$i] : (cwceq @ (XV @ Xy1 @ Xp) @ (ccfv @ XK @ cclvol)))) => (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwcel @ XX @ (XV @ Xy1 @ Xp)) @ (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xp:$i] : (cwa @ (cwn @ (cwbr @ (ccv @ Xp) @ (ccv @ Xy1) @ (Xc_le @ Xy1))) @ (cwceq @ XX @ (cco @ (ccv @ Xy1) @ (ccv @ Xp) @ (Xc_or @ Xy1 @ Xp))))) @ (^ [Xp:$i] : (XA2 @ Xy1)))) @ (^ [Xy1:$i] : XP))))))))))))))))))))).
...
thf(aan13_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ (cwa @ Xch @ (cwa @ Xps @ Xph))))))).
