...
thf(acnrmi_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cccnrm) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccnrm)))))).
thf(ccnrmnrm_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cccnrm) @ (cwcel @ XJ @ ccnrm)))).
