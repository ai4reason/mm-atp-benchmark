...
thf(cfrege97d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => ((cwi @ Xph @ (cwceq @ XA2 @ (ccima @ (ccfv @ XR @ cctcl) @ XU))) => (cwi @ Xph @ (cwss @ (ccima @ XR @ XA2) @ XA2))))))))).
