...
thf(cee202_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => (Xth => ((cwi @ Xph @ (cwi @ Xps @ Xta)) => ((cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwi @ Xph @ (cwi @ Xps @ Xet))))))))))))).
