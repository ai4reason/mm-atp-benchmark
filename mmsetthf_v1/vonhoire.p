...
thf(ahoimbl2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XX @ ccfn))) => ((! [Xk:$i] : (cwceq @ (XS @ Xk) @ (ccdm @ (ccfv @ XX @ ccvoln)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwcel @ (XA2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwcel @ (XB2 @ Xk) @ ccr))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccico))) @ (XS @ Xk))))))))))))))).
...
thf(cvonhoire_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XX @ ccfn))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwcel @ (XA2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwcel @ (XB2 @ Xk) @ ccr))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccfv @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccico))) @ (ccfv @ XX @ ccvoln)) @ ccr)))))))))))).
