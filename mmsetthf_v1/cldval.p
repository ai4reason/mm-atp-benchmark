...
thf(adf_cld_ax,axiom,(cwceq @ cccld @ (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ (ccuni @ (ccv @ Xj)) @ (ccv @ Xx3)) @ (ccv @ Xj))) @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xj))))))))).
thf(ccldval_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XJ @ cccld) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XX @ (ccv @ Xx3)) @ XJ)) @ (^ [Xx3:$i] : (ccpw @ XX))))))))).
