...
thf(csubcidcl_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XC @ ccsubc))) => ((cwi @ Xph @ (cwfn @ XJ @ (ccxp @ XS @ XS))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => ((cwceq @ Xc_1 @ (ccfv @ XC @ cccid)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ Xc_1) @ (cco @ XX @ XX @ XJ)))))))))))))).
