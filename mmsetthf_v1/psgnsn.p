...
thf(apmtrsn_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccsn @ XA2) @ ccpmtr) @ cc0))).
...
thf(cpsgnsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccsn @ XA2)) => ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ XX @ XN) @ cc1)))))))))))))).
