...
thf(adf_ovol_ax,axiom,(cwceq @ ccovol @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ ccr)) @ (^ [Xx3:$i] : (ccinf @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) @ (cwceq @ (ccv @ Xy1) @ (ccsup @ (ccrn @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccv @ Xf1)) @ cc1)) @ ccxr @ cclt)))) @ (^ [Xf1:$i] : (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr)) @ ccxr @ cclt))))).
...
thf(covolf_conj,conjecture,(cwf @ (ccpw @ ccr) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccovol)).
