...
thf(adihmeetlem15N_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [Xr:$i] : (! [Xp:$i] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwceq @ Xc_0 @ (ccfv @ XU @ cc0g)) => (cwi @ (cwa @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XY @ XB2) @ (cwa @ (cwcel @ (ccv @ Xp) @ XA2) @ (cwn @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)))) @ (cw3a @ (cwa @ (cwcel @ (ccv @ Xr) @ XA2) @ (cwn @ (cwbr @ (ccv @ Xr) @ XW @ Xc_le))) @ (cwbr @ (ccv @ Xr) @ XY @ Xc_le) @ (cwbr @ (cco @ XY @ (ccv @ Xp) @ Xc_an) @ XW @ Xc_le))) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xr) @ XI) @ (ccfv @ (ccv @ Xp) @ XI)) @ (ccsn @ Xc_0))))))))))))))))))))))))))))).
...
thf(adihmeetlem14N_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [Xr:$i] : (! [Xp:$i] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => (cwi @ (cwa @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XY @ XB2) @ (cwcel @ (ccv @ Xp) @ XB2)) @ (cw3a @ (cwa @ (cwcel @ (ccv @ Xr) @ XA2) @ (cwn @ (cwbr @ (ccv @ Xr) @ XW @ Xc_le))) @ (cwbr @ (ccv @ Xr) @ XY @ Xc_le) @ (cwbr @ (cco @ XY @ (ccv @ Xp) @ Xc_an) @ XW @ Xc_le))) @ (cwceq @ (cco @ (ccfv @ (cco @ XY @ (ccv @ Xp) @ Xc_an) @ XI) @ (ccin @ (ccfv @ (ccv @ Xr) @ XI) @ (ccfv @ (ccv @ Xp) @ XI)) @ Xc_po) @ (ccin @ (ccfv @ XY @ XI) @ (ccfv @ (ccv @ Xp) @ XI)))))))))))))))))))))))))))).
...
thf(cdihmeetlem16N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [Xr:$i] : (! [Xp:$i] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => (cwi @ (cwa @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XY @ XB2) @ (cwa @ (cwcel @ (ccv @ Xp) @ XA2) @ (cwn @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)))) @ (cw3a @ (cwa @ (cwcel @ (ccv @ Xr) @ XA2) @ (cwn @ (cwbr @ (ccv @ Xr) @ XW @ Xc_le))) @ (cwbr @ (ccv @ Xr) @ XY @ Xc_le) @ (cwbr @ (cco @ XY @ (ccv @ Xp) @ Xc_an) @ XW @ Xc_le))) @ (cwceq @ (ccfv @ (cco @ XY @ (ccv @ Xp) @ Xc_an) @ XI) @ (ccin @ (ccfv @ XY @ XI) @ (ccfv @ (ccv @ Xp) @ XI)))))))))))))))))))))))))))).
