...
thf(anvex_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ (ccop @ (ccop @ XG @ XS) @ XN) @ ccnv) @ (cw3a @ (cwcel @ XG @ ccvv) @ (cwcel @ XS @ ccvv) @ (cwcel @ XN @ ccvv))))))).
thf(asimp1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xph))))).
thf(asimp2i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xps))))).
thf(ch2hva_conj,conjecture,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ ccnv) => (cwceq @ ccva @ (ccfv @ XU @ ccpv)))))).
