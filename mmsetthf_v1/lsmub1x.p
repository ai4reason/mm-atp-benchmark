...
thf(clsmub1x_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cwa @ (cwss @ XT @ XB2) @ (cwcel @ XU @ (ccfv @ XG @ ccsubmnd))) @ (cwss @ XT @ (cco @ XT @ XU @ Xc_po))))))))))).
