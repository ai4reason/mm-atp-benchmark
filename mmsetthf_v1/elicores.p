...
thf(celicores_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccrn @ (ccres @ ccico @ (ccxp @ ccr @ ccr)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccico))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))).
