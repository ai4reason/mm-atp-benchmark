...
thf(areslmhm2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => ((cwceq @ XL @ (ccfv @ XT @ cclss)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XS @ XU @ cclmhm)) @ (cwcel @ XT @ cclmod) @ (cwcel @ XX @ XL)) @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)))))))))))).
thf(creslmhm2b_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => ((cwceq @ XL @ (ccfv @ XT @ cclss)) => (cwi @ (cw3a @ (cwcel @ XT @ cclmod) @ (cwcel @ XX @ XL) @ (cwss @ (ccrn @ XF) @ XX)) @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XF @ (cco @ XS @ XU @ cclmhm))))))))))))).
