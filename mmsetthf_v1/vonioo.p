...
thf(ahoidmv0val_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xx3 @ Xk @ Xa @ Xb) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol)))))))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ cc0 @ ccr @ (XA2 @ Xx3))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ cc0 @ ccr @ (XB2 @ Xx3))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (ccfv @ cc0 @ (XL @ Xx3 @ Xk @ Xa @ Xb))) @ ccc0)))))))))))))).
...
thf(avon0val_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ (ccfv @ cc0 @ ccvoln)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (ccfv @ cc0 @ ccvoln)) @ ccc0)))))).
thf(aioovonmbl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccdm @ (ccfv @ XX @ ccvoln)))) => ((cwi @ Xph @ (cwf @ XX @ ccxr @ XA2)) => ((cwi @ Xph @ (cwf @ XX @ ccxr @ XB2)) => (! [Xi:$i] : (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccioo))) @ (XS @ Xi)))))))))))))).
...
thf(avonioolem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XA2)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XB2)) => ((cwi @ Xph @ (cwne @ XX @ cc0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwbr @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ cclt))) => ((! [Xk:$i] : (cwceq @ (XI @ Xk) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccioo))))) => ((cwceq @ XC @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc)))))) => ((! [Xk:$i] : (cwceq @ (XD @ Xk) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xn) @ XC)) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccico))))))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XI @ Xk) @ (ccfv @ XX @ ccvoln)) @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XB2) @ (ccfv @ (ccv @ Xk) @ XA2) @ ccmin)))))))))))))))))))))).
...
thf(aixpeq2dv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xx3)))) => (cwi @ Xph @ (cwceq @ (ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
...
thf(amea0_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => (cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0)))))).
...
thf(aixp0_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ cc0)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwceq @ (ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cc0))))).
...
thf(afprodeq0g_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XC @ XA2))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwceq @ (ccv @ Xk) @ XC)) @ (cwceq @ (XB2 @ Xk) @ ccc0))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccc0))))))))))))).
...
thf(cvonioo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XA2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ XX @ ccr @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XI @ Xx3 @ Xk @ Xa @ Xb) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xx3)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xx3)) @ ccioo)))))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xx3 @ Xa @ Xb) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XI @ Xx3 @ Xk @ Xa @ Xb) @ (ccfv @ XX @ ccvoln)) @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (ccfv @ XX @ (XL @ Xx3 @ Xa @ Xb))))))))))))))))))))).
