...
thf(ar111_thm,axiom,(cwf1 @ ccon0 @ ccvv @ ccr1)).
thf(cwlim_tp,type,(cwlim : (($i > $o) > $o))).
thf(ccsuc_tp,type,(ccsuc : (($i > $o) > ($i > $o)))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aomsson_thm,axiom,(cwss @ ccom @ ccon0)).
thf(af1imaen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XC @ ccvv) => (cwi @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwss @ XC @ XA2)) @ (cwbr @ (ccima @ XF @ XC) @ XC @ ccen)))))))).
...
thf(atskr1om_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cctsk) @ (cwne @ XT @ cc0)) @ (cwss @ (ccima @ ccr1 @ ccom) @ XT)))).
...
thf(ctskinf_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cctsk) @ (cwne @ XT @ cc0)) @ (cwbr @ ccom @ XT @ ccdom)))).
