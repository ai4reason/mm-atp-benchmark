...
thf(ccnmbfm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwceq @ XS @ (ccfv @ XJ @ ccsigagen))) => ((cwi @ Xph @ (cwceq @ XT @ (ccfv @ XK @ ccsigagen))) => (cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ ccmbfm))))))))))))).
