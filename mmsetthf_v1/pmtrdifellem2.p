...
thf(adifsnexi_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ (ccdif @ XN @ (ccsn @ XK)) @ ccvv) @ (cwcel @ XN @ ccvv))))).
...
thf(cpmtrdifellem2_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XT @ (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccpmtr))) => ((cwceq @ XR @ (ccrn @ (ccfv @ XN @ ccpmtr))) => ((cwceq @ XS @ (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ XN @ ccpmtr))) => (cwi @ (cwcel @ XQ @ XT) @ (cwceq @ (ccdm @ (ccdif @ XS @ ccid)) @ (ccdm @ (ccdif @ XQ @ ccid)))))))))))))).
