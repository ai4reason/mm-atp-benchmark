...
thf(apwsmulg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccpws)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_xb @ (ccfv @ XY @ ccmg)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccmnd) @ (cwcel @ XI @ XV)) @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XB2) @ (cwcel @ XA2 @ XI))) @ (cwceq @ (ccfv @ XA2 @ (cco @ XN @ XX @ Xc_xb)) @ (cco @ XN @ (ccfv @ XA2 @ XX) @ Xc_x)))))))))))))))))).
