...
thf(climinfresxr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwfun @ XF)) => ((cwceq @ XA2 @ (ccima @ (cccnv @ XF) @ ccxr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ XA2) @ cclsi) @ (ccfv @ XF @ cclsi))))))))))).
