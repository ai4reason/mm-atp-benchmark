...
thf(age0nemnf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwne @ XA2 @ ccmnf)))).
...
thf(axrs10_thm,axiom,(! [XR:($i > $o)] : ((cwceq @ XR @ (cco @ ccxrs @ (ccdif @ ccxr @ (ccsn @ ccmnf)) @ ccress)) => (cwceq @ ccc0 @ (ccfv @ XR @ cc0g))))).
...
thf(axrtgioo_thm,axiom,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (cco @ (ccfv @ ccle @ ccordt) @ ccr @ ccrest)) => (cwceq @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XJ)))).
...
thf(atg2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) @ (cwcel @ XC @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XC @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XA2))) @ (^ [Xx3:$i] : XB2))))))).
...
thf(aovelrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwb @ (cwcel @ XC @ (ccrn @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XC @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(aresfifsupp_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwfun @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => (cwi @ Xph @ (cwbr @ (ccres @ XF @ XX) @ XZ @ ccfsupp))))))))))).
...
thf(axrge0gsumle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccin @ (ccpw @ XA2) @ ccfn))) => ((cwi @ Xph @ (cwss @ XC @ XB2)) => (cwi @ Xph @ (cwbr @ (cco @ XG @ (ccres @ XF @ XC) @ ccgsu) @ (cco @ XG @ (ccres @ XF @ XB2) @ ccgsu) @ ccle))))))))))))))).
...
thf(apnfnei_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ ccle @ ccordt)) @ (cwcel @ ccpnf @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioc) @ XA2)) @ (^ [Xx3:$i] : ccr))))).
...
thf(aresstset_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwceq @ XJ @ (ccfv @ XG @ ccts)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ XJ @ (ccfv @ XH @ ccts))))))))))).
thf(axrstset_thm,axiom,(cwceq @ (ccfv @ ccle @ ccordt) @ (ccfv @ ccxrs @ ccts))).
...
thf(ahaustsms2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctps)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwi @ Xph @ (cwcel @ XJ @ ccha)) => (cwi @ Xph @ (cwi @ (cwcel @ XX @ (cco @ XG @ XF @ cctsu)) @ (cwceq @ (cco @ XG @ XF @ cctsu) @ (ccsn @ XX)))))))))))))))))))).
thf(amp1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((cwi @ Xph @ Xps) => (cwi @ Xch @ Xps))))))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(ccps_tp,type,(ccps : ($i > $o))).
thf(aletsr_thm,axiom,(cwcel @ ccle @ cctsr)).
thf(aordthaus_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ cctsr) @ (cwcel @ (ccfv @ XR @ ccordt) @ ccha)))).
thf(aresthaus_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccha) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccha)))))).
thf(cxrge0tsmsd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwceq @ XG @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xs1)))) => ((cwi @ Xph @ (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((! [Xs1:$i] : (cwi @ Xph @ (cwceq @ (XS @ Xs1) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xs1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)) @ (^ [Xs1:$i] : (cco @ XG @ (ccres @ XF @ (ccv @ Xs1)) @ ccgsu)))) @ ccxr @ cclt)))) => (! [Xs1:$i] : (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ cctsu) @ (ccsn @ (XS @ Xs1)))))))))))))))).
