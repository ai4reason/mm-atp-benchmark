...
thf(auniqs2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwer @ XA2 @ XR)) => ((cwi @ Xph @ (cwcel @ XR @ XV)) => (cwi @ Xph @ (cwceq @ (ccuni @ (ccqs @ XA2 @ XR)) @ XA2))))))))).
...
thf(ahmeocld_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XJ @ cccld)) @ (cwcel @ (ccima @ XF @ XA2) @ (ccfv @ XK @ cccld))))))))))).
thf(aeleq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC))))))).
thf(cciun_tp,type,(cciun : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(aunicld_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (cwss @ XA2 @ (ccfv @ XJ @ cccld))) @ (cwcel @ (ccuni @ XA2) @ (ccfv @ XJ @ cccld)))))))).
...
thf(ccldsubg_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ XR @ (cco @ XG @ XS @ ccqg)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XG @ cctgp) @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ (ccqs @ XX @ XR) @ ccfn)) @ (cwb @ (cwcel @ XS @ (ccfv @ XJ @ cccld)) @ (cwcel @ XS @ XJ)))))))))))).
