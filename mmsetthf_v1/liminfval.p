...
thf(adf_liminf_ax,axiom,(cwceq @ cclsi @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt)))) @ ccxr @ cclt))))).
...
thf(climinfval_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (cwcel @ XF @ (XV @ Xk)) @ (cwceq @ (ccfv @ XF @ cclsi) @ (ccsup @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))).
