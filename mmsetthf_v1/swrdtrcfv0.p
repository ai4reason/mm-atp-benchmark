...
thf(awrdlenge2n0_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) @ (cwne @ XW @ cc0))))).
...
thf(aswrdtrcfv_thm,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr)) @ (ccfv @ XI @ XW))))))).
thf(cswrdtrcfv0_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) @ (cwceq @ (ccfv @ ccc0 @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr)) @ (ccfv @ ccc0 @ XW)))))).
