...
thf(aidlaut_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwcel @ XK @ XA2) @ (cwcel @ (ccres @ ccid @ XB2) @ XI))))))))).
...
thf(aisldil_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (Xc_le @ Xx3) @ (ccfv @ XK @ ccple))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccfv @ XK @ cclh))) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ XK @ cclaut))) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ XW @ (ccfv @ XK @ ccldil)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XK @ (XC @ Xx3)) @ (cwcel @ XW @ (XH @ Xx3))) @ (cwb @ (cwcel @ XF @ (XD @ Xx3)) @ (cwa @ (cwcel @ XF @ (XI @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ XW @ (Xc_le @ Xx3)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XB2))))))))))))))))))))).
thf(cidldil_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XD @ (ccfv @ XW @ (ccfv @ XK @ ccldil))) => (cwi @ (cwa @ (cwcel @ XK @ XA2) @ (cwcel @ XW @ XH)) @ (cwcel @ (ccres @ ccid @ XB2) @ XD)))))))))))).
