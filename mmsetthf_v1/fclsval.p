...
thf(adf_fcls_ax,axiom,(cwceq @ ccfcls @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xf1:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xf1:$i] : (ccuni @ (ccrn @ ccfil)))) @ (^ [Xj:$i] : (^ [Xf1:$i] : (ccif @ (cwceq @ (ccuni @ (ccv @ Xj)) @ (ccuni @ (ccv @ Xf1))) @ (cciin @ (^ [Xx3:$i] : (ccv @ Xf1)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ cccl)))) @ cc0)))))).
...
thf(cfclsval_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XX @ Xt) @ (ccuni @ XJ))) => (! [Xt:$i] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XF @ (ccfv @ (XY @ Xt) @ ccfil))) @ (cwceq @ (cco @ XJ @ XF @ ccfcls) @ (ccif @ (cwceq @ (XX @ Xt) @ (XY @ Xt)) @ (cciin @ (^ [Xt:$i] : XF) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ XJ @ cccl)))) @ cc0)))))))))).
