...
thf(almatval_thm,axiom,(! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwcel @ XM @ (XV @ Xi @ Xj)) @ (cwceq @ (ccfv @ XM @ cclmat) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ XM @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ ccc0 @ XM) @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ XM)))))))))))).
...
thf(afz1fzo0m1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XM @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (cco @ XM @ cc1 @ ccmin) @ (cco @ ccc0 @ XN @ ccfzo)))))).
