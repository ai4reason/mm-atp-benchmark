...
thf(adf_hpg_ax,axiom,(cwceq @ cchpg @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xd:$i] : (ccrn @ (ccfv @ (ccv @ Xg1) @ cclng))) @ (^ [Xd:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xi:$i] : (cwrex @ (^ [Xc:$i] : (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ (ccdif @ (ccv @ Xp) @ (ccv @ Xd))) @ (cwcel @ (ccv @ Xc) @ (ccdif @ (ccv @ Xp) @ (ccv @ Xd)))) @ (cwrex @ (^ [Xt:$i] : (cwcel @ (ccv @ Xt) @ (cco @ (ccv @ Xa) @ (ccv @ Xc) @ (ccv @ Xi)))) @ (^ [Xt:$i] : (ccv @ Xd)))) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xb) @ (ccdif @ (ccv @ Xp) @ (ccv @ Xd))) @ (cwcel @ (ccv @ Xc) @ (ccdif @ (ccv @ Xp) @ (ccv @ Xd)))) @ (cwrex @ (^ [Xt:$i] : (cwcel @ (ccv @ Xt) @ (cco @ (ccv @ Xb) @ (ccv @ Xc) @ (ccv @ Xi)))) @ (^ [Xt:$i] : (ccv @ Xd)))))) @ (^ [Xc:$i] : (ccv @ Xp)))) @ (ccfv @ (ccv @ Xg1) @ ccitv))) @ (ccfv @ (ccv @ Xg1) @ ccbs))))))))))).
...
thf(cishpg_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xt:$i] : (! [Xc:$i] : (cwceq @ XP @ (ccfv @ (XG @ Xt @ Xc) @ ccbs)))) => ((! [Xt:$i] : (! [Xc:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xt @ Xc) @ ccitv)))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XL @ Xt @ Xa @ Xb @ Xc) @ (ccfv @ (XG @ Xt @ Xc) @ cclng)))))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XO @ Xt @ Xa @ Xb @ Xc) @ (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ (ccdif @ XP @ XD)) @ (cwcel @ (ccv @ Xb) @ (ccdif @ XP @ XD))) @ (cwrex @ (^ [Xt:$i] : (cwcel @ (ccv @ Xt) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XI))) @ (^ [Xt:$i] : XD))))))))))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xt @ Xa @ Xb @ Xc) @ (cwcel @ (XG @ Xt @ Xc) @ ccstrkg)))))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xt @ Xa @ Xb @ Xc) @ (cwcel @ XD @ (ccrn @ (XL @ Xt @ Xa @ Xb @ Xc)))))))) => (! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xt @ Xa @ Xb @ Xc) @ (cwceq @ (ccfv @ XD @ (ccfv @ (XG @ Xt @ Xc) @ cchpg)) @ (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwa @ (cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ (XO @ Xt @ Xa @ Xb @ Xc)) @ (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ (XO @ Xt @ Xa @ Xb @ Xc)))) @ (^ [Xc:$i] : XP))))))))))))))))))))))))).
