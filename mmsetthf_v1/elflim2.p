...
thf(adf_flim_ax,axiom,(cwceq @ ccflim @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xf1:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xf1:$i] : (ccuni @ (ccrn @ ccfil)))) @ (^ [Xj:$i] : (^ [Xf1:$i] : (ccrab @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xj) @ ccnei)) @ (ccv @ Xf1)) @ (cwss @ (ccv @ Xf1) @ (ccpw @ (ccuni @ (ccv @ Xj)))))) @ (^ [Xx3:$i] : (ccuni @ (ccv @ Xj))))))))).
thf(asyl6bb_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwb @ Xch @ Xth) => (cwi @ Xph @ (cwb @ Xps @ Xth))))))))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(aeleq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwcel @ XC @ XA2) @ (cwcel @ XC @ XB2))))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(aflimval_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XF @ (ccuni @ (ccrn @ ccfil)))) @ (cwceq @ (cco @ XJ @ XF @ ccflim) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XF) @ (cwss @ XF @ (ccpw @ XX)))) @ (^ [Xx3:$i] : XX))))))))).
...
thf(celflim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) @ (cwa @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XF @ (ccuni @ (ccrn @ ccfil))) @ (cwss @ XF @ (ccpw @ XX))) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwss @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ XF)))))))))).
