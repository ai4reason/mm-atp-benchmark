...
thf(aphicld_thm,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwcel @ (ccfv @ XN @ ccphi) @ ccn)))))).
...
thf(aeulerthlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ XN @ ccgcd) @ cc1)) @ (^ [Xy1:$i] : (cco @ ccc0 @ XN @ ccfzo))))) => ((cwceq @ XT @ (cco @ cc1 @ (ccfv @ XN @ ccphi) @ ccfz)) => ((! [Xy1:$i] : (cwi @ Xph @ (cwf1o @ XT @ (XS @ Xy1) @ XF))) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : XT) @ (^ [Xx3:$i] : (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmul) @ XN @ ccmo)))) => (! [Xy1:$i] : (cwi @ Xph @ (cwf @ XT @ (XS @ Xy1) @ XG)))))))))))))))).
...
thf(arpmul_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwa @ (cwceq @ (cco @ XK @ XM @ ccgcd) @ cc1) @ (cwceq @ (cco @ XK @ XN @ ccgcd) @ cc1)) @ (cwceq @ (cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) @ cc1))))))).
