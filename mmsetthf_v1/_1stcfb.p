...
thf(c_1stcfb_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XX @ Xf1) @ (ccuni @ XJ))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XJ @ cc1stc) @ (cwcel @ XA2 @ (XX @ Xf1))) @ (cwex @ (^ [Xf1:$i] : (cw3a @ (cwf @ ccn @ XJ @ (ccv @ Xf1)) @ (cwral @ (^ [Xk:$i] : (cwa @ (cwcel @ XA2 @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))) @ (cwss @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))) @ (^ [Xk:$i] : ccn)) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xy1)) @ (cwrex @ (^ [Xk:$i] : (cwss @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xy1))) @ (^ [Xk:$i] : ccn)))) @ (^ [Xy1:$i] : XJ)))))))))))).
