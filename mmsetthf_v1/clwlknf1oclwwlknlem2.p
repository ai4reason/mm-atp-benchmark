...
thf(cclwlknf1oclwwlknlem2_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ (ccrab @ (^ [Xc:$i] : (cwa @ (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) @ ccle) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) @ XN))) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks)))))))).
