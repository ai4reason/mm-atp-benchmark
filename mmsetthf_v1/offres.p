...
thf(coffres_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XG @ XW)) @ (cwceq @ (ccres @ (cco @ XF @ XG @ (ccof @ XR)) @ XD) @ (cco @ (ccres @ XF @ XD) @ (ccres @ XG @ XD) @ (ccof @ XR))))))))))).
