...
thf(adf_resc_ax,axiom,(cwceq @ ccresc @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xh:$i] : ccvv)) @ (^ [Xc:$i] : (^ [Xh:$i] : ccvv)) @ (^ [Xc:$i] : (^ [Xh:$i] : (cco @ (cco @ (ccv @ Xc) @ (ccdm @ (ccdm @ (ccv @ Xh))) @ ccress) @ (ccop @ (ccfv @ ccnx @ cchom) @ (ccv @ Xh)) @ ccsts)))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(crescval_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XD @ (cco @ XC @ XH @ ccresc)) => (cwi @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XH @ XW)) @ (cwceq @ XD @ (cco @ (cco @ XC @ (ccdm @ (ccdm @ XH)) @ ccress) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ ccsts)))))))))).
