...
thf(cnrmsep3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccnrm) @ (cw3a @ (cwcel @ XA2 @ XJ) @ (cwcel @ XB2 @ (ccfv @ XJ @ cccld)) @ (cwss @ XB2 @ XA2))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwss @ XB2 @ (ccv @ Xx3)) @ (cwss @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XA2))) @ (^ [Xx3:$i] : XJ))))))).
