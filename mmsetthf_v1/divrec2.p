...
thf(cdivrec2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ (cco @ cc1 @ XB2 @ ccdiv) @ XA2 @ ccmul)))))).
