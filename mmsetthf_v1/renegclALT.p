...
thf(adedths_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccif @ (Xph @ Xx3) @ (ccv @ Xx3) @ (XB2 @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (Xps @ Xx3)))))))).
...
thf(acsbnegg_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) @ (cwceq @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccneg @ (XB2 @ Xx3)))) @ (ccneg @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(crenegclALT_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccneg @ XA2) @ ccr)))).
