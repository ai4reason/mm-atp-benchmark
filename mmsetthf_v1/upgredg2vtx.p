...
thf(aelpr2elpr_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ XA2 @ (ccpr @ XX @ XY))) @ (cwrex @ (^ [Xb:$i] : (cwceq @ (ccpr @ XX @ XY) @ (ccpr @ XA2 @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV)))))))).
...
thf(cupgredg2vtx_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : (cwceq @ (XE @ Xb) @ (ccfv @ XG @ ccedg))) => (! [Xb:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XC @ (XE @ Xb)) @ (cwcel @ XA2 @ XC)) @ (cwrex @ (^ [Xb:$i] : (cwceq @ XC @ (ccpr @ XA2 @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV)))))))))))).
