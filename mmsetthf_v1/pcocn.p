...
thf(cpcocn_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc1 @ XF) @ (ccfv @ ccc0 @ XG))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco)) @ (cco @ ccii @ XJ @ cccn))))))))))).
