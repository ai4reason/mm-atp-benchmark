...
thf(aphplem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ (ccsuc @ XA2))) @ (cwbr @ XA2 @ (ccdif @ (ccsuc @ XA2) @ (ccsn @ XB2)) @ ccen))))))).
...
thf(cphplem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwi @ (cwbr @ (ccsuc @ XA2) @ (ccsuc @ XB2) @ ccen) @ (cwbr @ XA2 @ XB2 @ ccen)))))))).
