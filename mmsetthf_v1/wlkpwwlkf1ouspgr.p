...
thf(awlkiswwlks_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccuspgr) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)))) @ (cwcel @ XP @ (ccfv @ XG @ ccwwlks))))))).
...
thf(auspgr2wlkeqi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ ccuspgr) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XG @ ccwlks)) @ (cwcel @ XB2 @ (ccfv @ XG @ ccwlks))) @ (cwceq @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XB2 @ cc2nd))) @ (cwceq @ XA2 @ XB2)))))).
...
thf(cwlkpwwlkf1ouspgr_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XF @ Xw) @ (ccmpt @ (^ [Xw:$i] : (ccfv @ XG @ ccwlks)) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xw) @ cc2nd))))) => (! [Xw:$i] : (cwi @ (cwcel @ XG @ ccuspgr) @ (cwf1o @ (ccfv @ XG @ ccwlks) @ (ccfv @ XG @ ccwwlks) @ (XF @ Xw)))))))).
