...
thf(cfaclimlem1_conj,conjecture,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccn0) @ (cwceq @ (ccseq @ ccmul @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ XM @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccmul) @ (cco @ cc1 @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccdiv))) @ cc1) @ (ccmpt @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ (ccv @ Xx3) @ (cco @ XM @ cc1 @ ccaddc) @ ccaddc) @ ccdiv) @ ccmul))))))).
