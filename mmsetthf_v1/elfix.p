...
thf(adf_fix_ax,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfix @ XA2) @ (ccdm @ (ccin @ XA2 @ ccid))))).
...
thf(celfix_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ (ccfix @ XR)) @ (cwbr @ XA2 @ XA2 @ XR)))))).
