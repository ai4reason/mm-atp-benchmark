...
thf(cpsrplusgpropd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XS @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XR @ ccplusg)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XS @ ccplusg)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ (XI @ Xx3 @ Xy1) @ XR @ ccmps) @ ccplusg) @ (ccfv @ (cco @ (XI @ Xx3 @ Xy1) @ XS @ ccmps) @ ccplusg)))))))))))))).
