...
thf(aimasng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XB2 @ Xy1)) @ (cwceq @ (ccima @ XR @ (ccsn @ XA2)) @ (ccab @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XR)))))))))).
...
thf(aiccval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccicc) @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccv @ Xx3) @ XB2 @ ccle))) @ (^ [Xx3:$i] : ccxr))))))).
