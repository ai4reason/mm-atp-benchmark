...
thf(cisneip_conj,conjecture,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))) @ (cwa @ (cwss @ XN @ XX) @ (cwrex @ (^ [Xg1:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : XJ))))))))))).
