...
thf(adf_lines2_ax,axiom,(cwceq @ cclines2 @ (ccrn @ ccline2))).
thf(arneqi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccrn @ XA2) @ (ccrn @ XB2)))))).
thf(adf_line2_ax,axiom,(cwceq @ ccline2 @ (ccoprab @ (^ [Xa:$i] : (^ [Xb:$i] : (^ [Xl:$i] : (cwrex @ (^ [Xn:$i] : (cwa @ (cw3a @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ (ccv @ Xb) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwne @ (ccv @ Xa) @ (ccv @ Xb))) @ (cwceq @ (ccv @ Xl) @ (ccec @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (cccnv @ cccolin))))) @ (^ [Xn:$i] : ccn)))))))).
...
thf(cellines_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ cclines2) @ (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ (ccv @ Xp) @ (ccv @ Xq)) @ (cwceq @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccline2)))) @ (^ [Xq:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xn:$i] : ccn))))).
