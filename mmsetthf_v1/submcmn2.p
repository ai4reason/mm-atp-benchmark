...
thf(csubmcmn2_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => (cwi @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) @ (cwb @ (cwcel @ XH @ cccmn) @ (cwss @ XS @ (ccfv @ XS @ XZ))))))))))).
