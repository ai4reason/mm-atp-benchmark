...
thf(alcmfval_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwa @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn)) @ (cwceq @ (ccfv @ XZ @ cclcmf) @ (ccif @ (cwcel @ ccc0 @ XZ) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XZ))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
...
thf(clcmfpr_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (ccfv @ (ccpr @ XM @ XN) @ cclcmf) @ (cco @ XM @ XN @ cclcm)))))).
