...
thf(cfclsnei_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ (XX @ Xn) @ cctopon)) @ (cwcel @ XF @ (ccfv @ (XX @ Xn) @ ccfil))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwa @ (cwcel @ XA2 @ (XX @ Xn)) @ (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xn) @ (ccv @ Xs1)) @ cc0)) @ (^ [Xs1:$i] : XF))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei))))))))))))).
