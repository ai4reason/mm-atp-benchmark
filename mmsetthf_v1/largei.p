...
thf(ast0_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ ccst) @ (cwceq @ (ccfv @ cc0h @ XS) @ ccc0)))).
...
thf(astrb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwceq @ (ccfv @ XA2 @ (ccv @ Xf1)) @ cc1) @ (cwceq @ (ccfv @ XB2 @ (ccv @ Xf1)) @ cc1))) @ (^ [Xf1:$i] : ccst)) @ (cwss @ XA2 @ XB2))))))).
...
thf(clargei_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwb @ (cwn @ (cwceq @ XA2 @ cc0h)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ (ccfv @ XA2 @ (ccv @ Xf1)) @ cc1)) @ (^ [Xf1:$i] : ccst)))))).
