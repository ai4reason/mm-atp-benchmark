...
thf(cbcm1n_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccbc) @ (cco @ XN @ XK @ ccbc) @ ccdiv) @ (cco @ (cco @ XN @ XK @ ccmin) @ XN @ ccdiv)))))).
