...
thf(advdsleabs_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) @ (cwi @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ XM @ (ccfv @ XN @ ccabs) @ ccle)))))).
...
thf(cpclem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwa @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0))) @ (cw3a @ (cwss @ (XA2 @ Xn) @ ccz) @ (cwne @ (XA2 @ Xn) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XA2 @ Xn)))) @ (^ [Xx3:$i] : ccz)))))))))).
