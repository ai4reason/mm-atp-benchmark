...
thf(cuhgrunop_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XG @ ccuhgr)) => ((cwi @ Xph @ (cwcel @ XH @ ccuhgr)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => ((cwceq @ XF @ (ccfv @ XH @ cciedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XH @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ (ccin @ (ccdm @ XE) @ (ccdm @ XF)) @ cc0)) => (cwi @ Xph @ (cwcel @ (ccop @ XV @ (ccun @ XE @ XF)) @ ccuhgr)))))))))))))))).
