...
thf(alhp2atne_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwcel @ XQ @ XA2)) @ (cwa @ (cwa @ (cwcel @ XU @ XA2) @ (cwbr @ XU @ XW @ Xc_le)) @ (cwa @ (cwcel @ XV @ XA2) @ (cwbr @ XV @ XW @ Xc_le))) @ (cwne @ XU @ XV)) @ (cwne @ (cco @ XP @ XU @ Xc_or) @ (cco @ XQ @ XV @ Xc_or)))))))))))))))))).
thf(a_2atmat0_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2) @ (cwne @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XR @ XS @ Xc_or)))) @ (cwo @ (cwcel @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XR @ XS @ Xc_or) @ Xc_an) @ XA2) @ (cwceq @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XR @ XS @ Xc_or) @ Xc_an) @ Xc_0))))))))))))))))).
...
thf(ccdlemg31b0N_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xv:$i] : (cwceq @ (Xc_le @ Xv) @ (ccfv @ (XK @ Xv) @ ccple))) => ((! [Xv:$i] : (cwceq @ (Xc_or @ Xv) @ (ccfv @ (XK @ Xv) @ ccjn))) => ((! [Xv:$i] : (cwceq @ (Xc_an @ Xv) @ (ccfv @ (XK @ Xv) @ ccmee))) => ((! [Xv:$i] : (cwceq @ (XA2 @ Xv) @ (ccfv @ (XK @ Xv) @ ccatm))) => ((! [Xv:$i] : (cwceq @ (XH @ Xv) @ (ccfv @ (XK @ Xv) @ cclh))) => ((! [Xv:$i] : (cwceq @ (XT @ Xv) @ (ccfv @ (XW @ Xv) @ (ccfv @ (XK @ Xv) @ ccltrn)))) => ((! [Xv:$i] : (cwceq @ (XR @ Xv) @ (ccfv @ (XW @ Xv) @ (ccfv @ (XK @ Xv) @ cctrl)))) => ((! [Xv:$i] : (cwceq @ (XN @ Xv) @ (cco @ (cco @ (XP @ Xv) @ (ccv @ Xv) @ (Xc_or @ Xv)) @ (cco @ (XQ @ Xv) @ (ccfv @ (XF @ Xv) @ (XR @ Xv)) @ (Xc_or @ Xv)) @ (Xc_an @ Xv)))) => (! [Xv:$i] : (cwi @ (cw3a @ (cw3a @ (cwcel @ (XK @ Xv) @ cchlt) @ (cwcel @ (XW @ Xv) @ (XH @ Xv)) @ (cwcel @ (XF @ Xv) @ (XT @ Xv))) @ (cwa @ (cwa @ (cwcel @ (XP @ Xv) @ (XA2 @ Xv)) @ (cwn @ (cwbr @ (XP @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv)))) @ (cwa @ (cwcel @ (XQ @ Xv) @ (XA2 @ Xv)) @ (cwn @ (cwbr @ (XQ @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv))))) @ (cw3a @ (cwa @ (cwcel @ (ccv @ Xv) @ (XA2 @ Xv)) @ (cwbr @ (ccv @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv))) @ (cwne @ (ccv @ Xv) @ (ccfv @ (XF @ Xv) @ (XR @ Xv))) @ (cwne @ (ccfv @ (XP @ Xv) @ (XF @ Xv)) @ (XP @ Xv)))) @ (cwo @ (cwcel @ (XN @ Xv) @ (XA2 @ Xv)) @ (cwceq @ (XN @ Xv) @ (ccfv @ (XK @ Xv) @ ccp0))))))))))))))))))))))))))).
