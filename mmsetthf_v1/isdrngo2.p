...
thf(arngomndo_thm,axiom,(! [XR:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwcel @ XH @ ccmndo)))))).
thf(amndomgmid_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccmndo) @ (cwcel @ XG @ (ccin @ ccmagm @ ccexid))))).
...
thf(arngorn1eq_thm,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwceq @ (ccrn @ XG) @ (ccrn @ XH))))))))).
...
thf(agrpomndo_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccgr) @ (cwcel @ XG @ ccmndo)))).
thf(ccsem_tp,type,(ccsem : ($i > $o))).
thf(amndoismgmOLD_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccmndo) @ (cwcel @ XG @ ccmagm)))).
thf(aexidresid_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XU @ (ccfv @ XG @ ccgi)) => ((cwceq @ XH @ (ccres @ XG @ (ccxp @ XY @ XY))) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ (ccin @ ccmagm @ ccexid)) @ (cwss @ XY @ XX) @ (cwcel @ XU @ XY)) @ (cwcel @ XH @ ccmagm)) @ (cwceq @ (ccfv @ XH @ ccgi) @ XU))))))))))).
...
thf(aisgrpda_thm,axiom,(! [Xph:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XX @ ccvv))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwf @ (ccxp @ XX @ XX) @ XX @ XG))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX))) @ (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG))))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XU @ XX))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ (ccv @ Xx3) @ XX)) @ (cwceq @ (cco @ XU @ (ccv @ Xx3) @ XG) @ (ccv @ Xx3))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ (ccv @ Xx3) @ XX)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ XG) @ XU)) @ (^ [Xn:$i] : XX))))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XG @ ccgr)))))))))))))).
...
thf(azerdivemp1x_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : (cwceq @ (XG @ Xa) @ (ccfv @ XR @ cc1st))) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((! [Xa:$i] : (cwceq @ XZ @ (ccfv @ (XG @ Xa) @ ccgi))) => ((! [Xa:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xa)))) => ((! [Xa:$i] : (cwceq @ (XU @ Xa) @ (ccfv @ XH @ ccgi))) => (cwi @ (cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XA2 @ XX) @ (cwrex @ (^ [Xa:$i] : (cwceq @ (cco @ (ccv @ Xa) @ XA2 @ XH) @ (XU @ Xa))) @ (^ [Xa:$i] : XX))) @ (cwi @ (cwcel @ XB2 @ XX) @ (cwi @ (cwceq @ (cco @ XA2 @ XB2 @ XH) @ XZ) @ (cwceq @ XB2 @ XZ)))))))))))))))))).
...
thf(cisdrngo2_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccfv @ XR @ cc1st)))) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XZ @ (ccfv @ (XG @ Xx3 @ Xy1) @ ccgi)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xx3 @ Xy1))))) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => (cwb @ (cwcel @ XR @ ccdrng) @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwa @ (cwne @ XU @ XZ) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XH) @ XU)) @ (^ [Xy1:$i] : (ccdif @ XX @ (ccsn @ XZ))))) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccsn @ XZ))))))))))))))))))).
