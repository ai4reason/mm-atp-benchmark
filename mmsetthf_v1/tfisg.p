...
thf(ctfisg_conj,conjecture,(! [Xph:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : ccon0)) @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccon0))))).
