...
thf(areconnlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn)) @ (cwa @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2))) @ (cwss @ (cco @ XX @ XY @ ccicc) @ XA2)))))).
...
thf(areconnlem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwss @ XA2 @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (XU @ Xx3 @ Xy1) @ (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (XV @ Xx3 @ Xy1) @ (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ XB2 @ (ccin @ (XU @ Xx3 @ Xy1) @ XA2))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (XC @ Xx3) @ (ccin @ (XV @ Xx3 @ Xy1) @ XA2))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwss @ (ccin @ (XU @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1)) @ (ccdif @ ccr @ XA2))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwbr @ XB2 @ (XC @ Xx3) @ ccle)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XS @ Xx3 @ Xy1) @ (ccsup @ (ccin @ (XU @ Xx3 @ Xy1) @ (cco @ XB2 @ (XC @ Xx3) @ ccicc)) @ ccr @ cclt)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwn @ (cwss @ XA2 @ (ccun @ (XU @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1)))))))))))))))))))))))).
...
thf(aconnsub_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ ccconn) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cw3a @ (cwne @ (ccin @ (ccv @ Xx3) @ XS) @ cc0) @ (cwne @ (ccin @ (ccv @ Xy1) @ XS) @ cc0) @ (cwss @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccdif @ XX @ XS))) @ (cwn @ (cwss @ XS @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))))))).
thf(creconn_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccr) @ (cwb @ (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
