...
thf(cclwlkclwwlklem2fv2_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ cclt) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ ccc0 @ XP)) @ (cccnv @ XE))))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (ccfv @ XP @ cchash) @ ccn0) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ (XF @ Xx3)) @ (ccfv @ (ccpr @ (ccfv @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ XP) @ (ccfv @ ccc0 @ XP)) @ (cccnv @ XE)))))))))).
