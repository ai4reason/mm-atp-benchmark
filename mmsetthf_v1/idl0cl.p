...
thf(cidl0cl_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XI @ (ccfv @ XR @ ccidl))) @ (cwcel @ XZ @ XI))))))))).
