...
thf(cstructgrssvtxlem_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XX @ ccstr)) => ((cwi @ Xph @ (cwcel @ XV @ XY)) => ((cwi @ Xph @ (cwcel @ XE @ XZ)) => ((cwi @ Xph @ (cwss @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE)) @ XG)) => (cwi @ Xph @ (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)))))))))))))).
