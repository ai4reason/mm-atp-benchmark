...
thf(adfcnvrefrels2_thm,axiom,(cwceq @ cccnvrefrels @ (ccrab @ (^ [Xr:$i] : (cwss @ (ccv @ Xr) @ (ccin @ ccid @ (ccxp @ (ccdm @ (ccv @ Xr)) @ (ccrn @ (ccv @ Xr)))))) @ (^ [Xr:$i] : ccrels)))).
...
thf(celcnvrefrels2_conj,conjecture,(! [XR:($i > $o)] : (cwb @ (cwcel @ XR @ cccnvrefrels) @ (cwa @ (cwss @ XR @ (ccin @ ccid @ (ccxp @ (ccdm @ XR) @ (ccrn @ XR)))) @ (cwcel @ XR @ ccrels))))).
