...
thf(aswrdccatin12lem2c_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XN @ (cco @ XL @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz)))) @ (cw3a @ (cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccword @ XV)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ (cco @ XA2 @ XB2 @ ccconcat) @ cchash) @ ccfz)))))))))))).
...
thf(aswrdccatin12lem2a_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) @ (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) @ (cwn @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) @ (cwcel @ (cco @ XK @ XM @ ccaddc) @ (cco @ XL @ XX @ ccfzo)))))))))).
...
thf(alesubadd2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccle) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccle))))))).
thf(aswrdccatin12lem2b_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) @ (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) @ (cwn @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) @ (cwcel @ (cco @ XK @ (cco @ XL @ XM @ ccmin) @ ccmin) @ (cco @ ccc0 @ (cco @ (cco @ XN @ XL @ ccmin) @ ccc0 @ ccmin) @ ccfzo)))))))))).
...
thf(cswrdccatin12lem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XN @ (cco @ XL @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz)))) @ (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) @ (cwn @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) @ (cwceq @ (ccfv @ XK @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ XM @ XN) @ ccsubstr)) @ (ccfv @ (cco @ XK @ (ccfv @ (cco @ XA2 @ (ccop @ XM @ XL) @ ccsubstr) @ cchash) @ ccmin) @ (cco @ XB2 @ (ccop @ ccc0 @ (cco @ XN @ XL @ ccmin)) @ ccsubstr)))))))))))))).
