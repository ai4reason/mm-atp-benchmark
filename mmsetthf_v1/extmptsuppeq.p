...
thf(amptsuppdifd_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XZ @ (XW @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (cco @ (XF @ Xx3) @ XZ @ ccsupp) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccdif @ ccvv @ (ccsn @ XZ)))) @ (^ [Xx3:$i] : XA2)))))))))))))))).
...
thf(cextmptsuppeq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XW @ Xn)))) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (ccdif @ XB2 @ XA2))) @ (cwceq @ (XX @ Xn) @ XZ))) => (cwi @ Xph @ (cwceq @ (cco @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XX @ Xn))) @ XZ @ ccsupp) @ (cco @ (ccmpt @ (^ [Xn:$i] : XB2) @ (^ [Xn:$i] : (XX @ Xn))) @ XZ @ ccsupp))))))))))))).
