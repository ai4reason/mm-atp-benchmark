...
thf(ckardex_conj,conjecture,(! [XA2:($i > $o)] : (cwcel @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccen) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ XA2 @ ccen) @ (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk)))))))) @ ccvv))).
