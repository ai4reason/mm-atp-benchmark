...
thf(aiblss2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ ccvol))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3) @ XV))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccdif @ XB2 @ XA2))) @ (cwceq @ (XC @ Xx3) @ ccc0))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl)) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl))))))))))))).
...
thf(aareaval_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ (ccdm @ ccarea)) @ (cwceq @ (ccfv @ XS @ ccarea) @ (ccitg @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccima @ XS @ (ccsn @ (ccv @ Xx3))) @ ccvol))))))).
...
thf(aitgss2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (cwi @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccitg @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (XC @ Xx3) @ ccc0))))))))).
...
thf(aitgpowd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccexp))) @ (cco @ (cco @ (cco @ XB2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccmin) @ (cco @ XN @ cc1 @ ccaddc) @ ccdiv)))))))))))).
...
thf(careaquad_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((! [Xy1:$i] : (cwcel @ (XC @ Xy1) @ ccr)) => ((! [Xy1:$i] : (cwcel @ (XD @ Xy1) @ ccr)) => ((! [Xy1:$i] : (cwcel @ (XE @ Xy1) @ ccr)) => ((! [Xy1:$i] : (cwcel @ (XF @ Xy1) @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) => ((! [Xy1:$i] : (cwbr @ (XC @ Xy1) @ (XE @ Xy1) @ ccle)) => ((! [Xy1:$i] : (cwbr @ (XD @ Xy1) @ (XF @ Xy1) @ ccle)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XU @ Xx3) @ (cco @ (XC @ Xy1) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv) @ (cco @ (XD @ Xy1) @ (XC @ Xy1) @ ccmin) @ ccmul) @ ccaddc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XV @ Xx3) @ (cco @ (XE @ Xy1) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv) @ (cco @ (XF @ Xy1) @ (XE @ Xy1) @ ccmin) @ ccmul) @ ccaddc)))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (ccv @ Xy1) @ (cco @ (XU @ Xx3) @ (XV @ Xx3) @ ccicc)))))))) => (! [Xy1:$i] : (cwceq @ (ccfv @ (XS @ Xy1) @ ccarea) @ (cco @ (cco @ (cco @ (cco @ (XF @ Xy1) @ (XE @ Xy1) @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (cco @ (XD @ Xy1) @ (XC @ Xy1) @ ccaddc) @ cc2 @ ccdiv) @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccmul))))))))))))))))))))))))).
