...
thf(azfpair_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccvv)))).
...
thf(cax_pr_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xw:$i] : (cwi @ (cwo @ (cwceq @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwceq @ (ccv @ Xw) @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xz)))))))))).
