...
thf(asizusglecusglem1_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XV @ (ccfv @ XH @ ccvtx)) => ((cwceq @ XF @ (ccfv @ XH @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XH @ cccusgr)) @ (cwf1 @ XE @ XF @ (ccres @ ccid @ XE))))))))))))).
...
thf(asizusglecusglem2_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XV @ (ccfv @ XH @ ccvtx)) => ((cwceq @ XF @ (ccfv @ XH @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XH @ cccusgr) @ (cwcel @ XF @ ccfn)) @ (cwcel @ XE @ ccfn)))))))))))).
...
thf(anfile_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwn @ (cwcel @ XB2 @ ccfn))) @ (cwbr @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccle))))))).
thf(csizusglecusg_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XV @ (ccfv @ XH @ ccvtx)) => ((cwceq @ XF @ (ccfv @ XH @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XH @ cccusgr)) @ (cwbr @ (ccfv @ XE @ cchash) @ (ccfv @ XF @ cchash) @ ccle)))))))))))).
