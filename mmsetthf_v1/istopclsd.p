...
thf(afnelfp_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XX @ XA2)) @ (cwb @ (cwcel @ XX @ (ccdm @ (ccin @ XF @ ccid))) @ (cwceq @ (ccfv @ XX @ XF) @ XX))))))).
...
thf(amretopd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (ccfv @ XB2 @ ccmre))) => ((cwi @ Xph @ (cwcel @ cc0 @ XM)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XM) @ (cwcel @ (ccv @ Xy1) @ XM)) @ (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XM)))) => ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwcel @ (ccdif @ XB2 @ (ccv @ Xz)) @ XM)) @ (^ [Xz:$i] : (ccpw @ XB2))))) => (! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XJ @ Xz) @ (ccfv @ XB2 @ cctopon)) @ (cwceq @ XM @ (ccfv @ (XJ @ Xz) @ cccld)))))))))))))).
...
thf(amrccls_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XF @ (ccfv @ (ccfv @ XJ @ cccld) @ ccmrc)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XJ @ cccl) @ XF)))))).
...
thf(cistopclsd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwf @ (ccpw @ XB2) @ (ccpw @ XB2) @ XF)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwss @ (ccv @ Xx3) @ XB2)) @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwss @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XF) @ cc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwss @ (ccv @ Xy1) @ XB2)) @ (cwceq @ (ccfv @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF) @ (ccun @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))))) => ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccdif @ XB2 @ (ccv @ Xz)) @ XF) @ (ccdif @ XB2 @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccpw @ XB2))))) => (! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XJ @ Xz) @ (ccfv @ XB2 @ cctopon)) @ (cwceq @ (ccfv @ (XJ @ Xz) @ cccl) @ XF))))))))))))))))).
