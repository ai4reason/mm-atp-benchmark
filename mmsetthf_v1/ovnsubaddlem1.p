...
thf(aovnxrcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ ccr @ XX @ ccmap))) => (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ (ccfv @ XX @ ccovoln)) @ ccxr)))))))).
...
thf(ahoiprodcl2_thm,axiom,(! [Xph:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XX @ ccfn))) => ((! [Xi:$i] : (! [Xk:$i] : (cwceq @ (XL @ Xi @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xi:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xi))) @ ccvol)))))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XX @ (ccxp @ ccr @ ccr) @ XI))) => (! [Xi:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccfv @ XI @ (XL @ Xi @ Xk)) @ (cco @ ccc0 @ ccpnf @ ccico)))))))))))))).
...
thf(aovnval2b_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xz @ Xi @ Xj @ Xk) @ (cwcel @ XX @ ccfn)))))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xz @ Xi @ Xj @ Xk) @ (cwss @ (XA2 @ Xj @ Xk) @ (cco @ ccr @ XX @ ccmap))))))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwceq @ (XL @ Xz @ Xi @ Xj @ Xk @ Xa) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : (cwa @ (cwss @ (ccv @ Xa) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) @ (cwceq @ (ccv @ Xz) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr)))))))))) => (! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xi @ Xj @ Xk) @ (cwceq @ (ccfv @ (XA2 @ Xj @ Xk) @ (ccfv @ XX @ ccovoln)) @ (ccif @ (cwceq @ XX @ cc0) @ ccc0 @ (ccinf @ (ccfv @ (XA2 @ Xj @ Xk) @ (XL @ Xz @ Xi @ Xj @ Xk @ Xa)) @ ccxr @ cclt))))))))))))))))).
...
thf(aovnlecvr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwne @ XX @ cc0)) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XL @ Xj @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xi:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xi))) @ ccvol)))))))) => ((cwi @ Xph @ (cwf @ ccn @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ XI)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xj @ Xk) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ XI))))))))))) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XA2 @ Xj @ Xk) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ XI) @ (XL @ Xj @ Xk)))) @ ccsumge0) @ ccle))))))))))))))).
...
thf(asge0f1o_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xk @ Xn)))) => ((! [Xk:$i] : (cwnf @ (^ [Xn:$i] : (Xph @ Xk @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (XG @ Xn)) @ (cwceq @ (XB2 @ Xk) @ (XD @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwcel @ XC @ (XV @ Xk @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwf1o @ XC @ XA2 @ XF)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xk @ Xn) @ (cwcel @ (ccv @ Xn) @ XC)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ XF) @ (XG @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xk @ Xn) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : XC) @ (^ [Xn:$i] : (XD @ Xn))) @ ccsumge0))))))))))))))))))))).
thf(aeqidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (cwi @ Xph @ (cwceq @ XA2 @ XA2))))).
thf(aeqcomd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ XB2 @ XA2))))))).
thf(cwdisj_tp,type,(cwdisj : (($i > ($i > $o)) > (($i > ($i > $o)) > $o)))).
thf(asge0xp_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccop @ (ccv @ Xj) @ (ccv @ Xk))) @ (cwceq @ (XD @ Xz) @ (XC @ Xj @ Xk)))))) => ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xz @ Xj @ Xk)))))) => ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XB2 @ (XW @ Xz @ Xj @ Xk)))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cw3a @ (Xph @ Xk) @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XB2)) @ (cwcel @ (XC @ Xj @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccfv @ (ccmpt @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xj @ Xk))) @ ccsumge0))) @ ccsumge0) @ (ccfv @ (ccmpt @ (^ [Xz:$i] : (ccxp @ XA2 @ XB2)) @ (^ [Xz:$i] : (XD @ Xz))) @ ccsumge0))))))))))))))))).
...
thf(covnsubaddlem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XE:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : ((! [Xz:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xh) @ (cwcel @ XX @ ccfn)))) => ((! [Xz:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xh) @ (cwne @ XX @ cc0)))) => ((! [Xz:$i] : (! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xz @ Xh) @ (cwf @ ccn @ (ccpw @ (cco @ ccr @ XX @ ccmap)) @ (XA2 @ Xj @ Xk @ Xm)))))))) => ((! [Xz:$i] : (! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xh) @ (cwcel @ (XE @ Xz @ Xh @ Xj @ Xk @ Xm @ Xa) @ ccrp)))))))) => ((! [Xz:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwceq @ (XZ @ Xz @ Xe @ Xh @ Xi @ Xj @ Xk @ Xm @ Xn @ Xa) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : (cwa @ (cwss @ (ccv @ Xa) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) @ (cwceq @ (ccv @ Xz) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr)))))))))))))) => ((! [Xz:$i] : (! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XC @ Xz @ Xh @ Xj @ Xk @ Xm @ Xn) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccrab @ (^ [Xh:$i] : (cwss @ (ccv @ Xa) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xh)))))))))) @ (^ [Xh:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))))))))))) => ((! [Xz:$i] : (! [Xh:$i] : (! [Xk:$i] : (cwceq @ (XL @ Xz @ Xh @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xi:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xi))) @ ccvol))))))))) => ((! [Xz:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwceq @ (XD @ Xz @ Xe @ Xh @ Xi @ Xj @ Xk @ Xm @ Xa) @ (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccmpt @ (^ [Xe:$i] : ccrp) @ (^ [Xe:$i] : (ccrab @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)) @ (XL @ Xz @ Xh @ Xk)))) @ ccsumge0) @ (cco @ (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)) @ (ccv @ Xe) @ ccxad) @ ccle)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xa) @ (XC @ Xz @ Xh @ Xj @ Xk @ Xm @ Xn)))))))))))))))))) => ((! [Xz:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xz @ Xh) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (XI @ Xz @ Xe @ Xa)) @ (ccfv @ (cco @ (XE @ Xz @ Xh @ Xj @ Xk @ Xm @ Xa) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xj @ Xk @ Xm)) @ (XD @ Xz @ Xe @ Xh @ Xi @ Xj @ Xk @ Xm @ Xa)))))))))))))) => ((! [Xz:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xz @ Xh) @ (cwf1o @ ccn @ (ccxp @ ccn @ ccn) @ (XF @ Xz))))) => ((! [Xz:$i] : (! [Xe:$i] : (! [Xh:$i] : (! [Xa:$i] : (cwceq @ (XG @ Xz @ Xe @ Xh @ Xa) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xm) @ (XF @ Xz)) @ cc2nd) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xm) @ (XF @ Xz)) @ cc1st) @ (XI @ Xz @ Xe @ Xa)))))))))) => (! [Xz:$i] : (! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xh) @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (XA2 @ Xj @ Xk @ Xm)))) @ (ccfv @ XX @ ccovoln)) @ (cco @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xj @ Xk @ Xm)) @ (ccfv @ XX @ ccovoln)))) @ ccsumge0) @ (XE @ Xz @ Xh @ Xj @ Xk @ Xm @ Xa) @ ccxad) @ ccle))))))))))))))))))))))))))))))).
