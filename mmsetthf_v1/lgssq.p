...
thf(algsabs1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwceq @ (ccfv @ (cco @ XA2 @ XN @ cclgs) @ ccabs) @ cc1) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)))))).
...
thf(clgssq_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ XN @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XN @ cclgs) @ cc1))))).
