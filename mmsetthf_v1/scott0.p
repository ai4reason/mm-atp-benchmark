...
thf(cscott0_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwceq @ XA2 @ cc0) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ cc0)))).
