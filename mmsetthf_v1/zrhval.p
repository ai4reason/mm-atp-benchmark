...
thf(adf_zrh_ax,axiom,(cwceq @ cczrh @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccuni @ (cco @ czring @ (ccv @ Xr) @ ccrh)))))).
...
thf(czrhval_conj,conjecture,(! [XR:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => (cwceq @ XL @ (ccuni @ (cco @ czring @ XR @ ccrh))))))).
