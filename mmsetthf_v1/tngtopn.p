...
thf(atngtset_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ XD @ (ccfv @ XT @ ccds)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XG @ XV) @ (cwcel @ XN @ XW)) @ (cwceq @ XJ @ (ccfv @ XT @ ccts)))))))))))))).
...
thf(ctngtopn_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ XD @ (ccfv @ XT @ ccds)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XG @ XV) @ (cwcel @ XN @ XW)) @ (cwceq @ XJ @ (ccfv @ XT @ cctopn)))))))))))))).
