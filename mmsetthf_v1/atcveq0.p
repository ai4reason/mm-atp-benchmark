...
thf(aatcv0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccat) @ (cwbr @ cc0h @ XA2 @ cccv)))).
...
thf(acvnbtwn3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwi @ (cwa @ (cwss @ XA2 @ XC) @ (cwpss @ XC @ XB2)) @ (cwceq @ XC @ XA2)))))))).
...
thf(catcveq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwceq @ XA2 @ cc0h)))))).
