...
thf(afgss_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwcel @ XG @ (ccfv @ XX @ ccfbas)) @ (cwss @ XF @ XG)) @ (cwss @ (cco @ XX @ XF @ ccfg) @ (cco @ XX @ XG @ ccfg))))))).
...
thf(adf_fg_ax,axiom,(cwceq @ ccfg @ (ccmpt2 @ (^ [Xw:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ ccfbas))) @ (^ [Xw:$i] : (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwne @ (ccin @ (ccv @ Xx3) @ (ccpw @ (ccv @ Xy1))) @ cc0)) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xw))))))))).
thf(cfgabs_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XY @ ccfbas)) @ (cwss @ XY @ XX)) @ (cwceq @ (cco @ XX @ (cco @ XY @ XF @ ccfg) @ ccfg) @ (cco @ XX @ XF @ ccfg))))))).
