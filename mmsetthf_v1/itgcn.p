...
thf(aitg2cn_thm,axiom,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XF @ ccmbf))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ (ccfv @ XF @ ccitg2) @ ccr))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XC @ ccrp))) => (! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xu:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2) @ XC @ cclt))) @ (^ [Xu:$i] : (ccdm @ ccvol)))) @ (^ [Xd:$i] : ccrp)))))))))))).
