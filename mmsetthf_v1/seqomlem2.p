...
thf(aseqomlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ XQ @ (ccrdg @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xv:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xv:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xv:$i] : (ccop @ (ccsuc @ (ccv @ Xi)) @ (cco @ (ccv @ Xi) @ (ccv @ Xv) @ XF))))) @ (ccop @ cc0 @ (ccfv @ (XI @ Xv @ Xi) @ ccid)))))) => (cwi @ (cwcel @ XA2 @ ccom) @ (cwceq @ (ccfv @ XA2 @ XQ) @ (ccop @ XA2 @ (ccfv @ (ccfv @ XA2 @ XQ) @ cc2nd)))))))))).
...
thf(adff3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwf @ XA2 @ XB2 @ XF) @ (cwa @ (cwss @ XF @ (ccxp @ XA2 @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF)))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(cseqomlem2_conj,conjecture,(! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ XQ @ (ccrdg @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xv:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xv:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xv:$i] : (ccop @ (ccsuc @ (ccv @ Xi)) @ (cco @ (ccv @ Xi) @ (ccv @ Xv) @ XF))))) @ (ccop @ cc0 @ (ccfv @ (XI @ Xv @ Xi) @ ccid)))))) => (cwfn @ (ccima @ XQ @ ccom) @ ccom)))))).
