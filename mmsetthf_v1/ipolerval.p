...
thf(cipolerval_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XI @ (ccfv @ XF @ ccipo)) => (cwi @ (cwcel @ XF @ XV) @ (cwceq @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (ccfv @ XI @ ccple)))))))).
