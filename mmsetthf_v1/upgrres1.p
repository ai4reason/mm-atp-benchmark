...
thf(aedgupgr_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg))) @ (cw3a @ (cwcel @ XE @ (ccpw @ (ccfv @ XG @ ccvtx))) @ (cwne @ XE @ cc0) @ (cwbr @ (ccfv @ XE @ cchash) @ cc2 @ ccle)))))).
...
thf(aelpwdifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ XW) @ (cwss @ XS @ XV) @ (cwnel @ XA2 @ XS)) @ (cwcel @ XS @ (ccpw @ (ccdif @ XV @ (ccsn @ XA2)))))))))).
...
thf(aisupgr_thm,axiom,(! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : (cwi @ (cwcel @ XG @ (XU @ Xx3)) @ (cwb @ (cwcel @ XG @ ccupgr) @ (cwf @ (ccdm @ (XE @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)))) @ (XE @ Xx3)))))))))))).
...
thf(cupgrres1_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XF @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => ((! [Xe:$i] : (cwceq @ (XS @ Xe) @ (ccop @ (ccdif @ XV @ (ccsn @ XN)) @ (ccres @ ccid @ (XF @ Xe))))) => (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XN @ XV)) @ (cwcel @ (XS @ Xe) @ ccupgr)))))))))))))).
