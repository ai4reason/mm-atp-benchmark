...
thf(atpnei_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwb @ (cwss @ XS @ XX) @ (cwcel @ XX @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))))))))).
...
thf(aelnei_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XP @ XA2) @ (cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)))) @ (cwcel @ XP @ XN))))))).
thf(cgneispa_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (XX @ Xp) @ (ccuni @ XJ))) => (cwi @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xp:$i] : (cwa @ (cwne @ (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei)) @ cc0) @ (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xp) @ (ccv @ Xn))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei)))))) @ (^ [Xp:$i] : (XX @ Xp)))))))).
