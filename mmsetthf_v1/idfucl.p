...
thf(aidfu2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccfv @ XC @ ccidfu)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ XY @ XH))) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ (cco @ XX @ XY @ (ccfv @ XI @ cc2nd))) @ XF)))))))))))))))))).
...
thf(cidfucl_conj,conjecture,(! [XC:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XI @ (ccfv @ XC @ ccidfu)) => (cwi @ (cwcel @ XC @ cccat) @ (cwcel @ XI @ (cco @ XC @ XC @ ccfunc))))))).
