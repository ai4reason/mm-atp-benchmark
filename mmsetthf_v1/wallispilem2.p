...
thf(aitgsin0pi_thm,axiom,(cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccsin))) @ cc2)).
...
thf(cwallispilem2_conj,conjecture,(! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XI @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xn:$i] : (cw3a @ (cwceq @ (ccfv @ ccc0 @ (XI @ Xx3 @ Xn)) @ ccpi) @ (cwceq @ (ccfv @ cc1 @ (XI @ Xx3 @ Xn)) @ cc2) @ (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (ccfv @ XN @ (XI @ Xx3 @ Xn)) @ (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XN @ ccdiv) @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ (XI @ Xx3 @ Xn)) @ ccmul)))))))))).
