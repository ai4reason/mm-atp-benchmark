...
thf(aresin4p_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccsin) @ (cco @ (cco @ XA2 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc6 @ ccdiv) @ ccmin) @ (ccfv @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccim) @ ccaddc)))))))).
...
thf(aabsimle_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs) @ (ccfv @ XA2 @ ccabs) @ ccle)))).
...
thf(aef01bndlem_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) @ (cwbr @ (ccfv @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccabs) @ (cco @ (cco @ XA2 @ cc4 @ ccexp) @ cc6 @ ccdiv) @ cclt))))))).
thf(aleexp2rd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ ccle)))))))))))).
...
thf(csin01bnd_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) @ (cwa @ (cwbr @ (cco @ XA2 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ (ccfv @ XA2 @ ccsin) @ cclt) @ (cwbr @ (ccfv @ XA2 @ ccsin) @ XA2 @ cclt))))).
