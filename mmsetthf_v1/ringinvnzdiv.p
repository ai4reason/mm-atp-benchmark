...
thf(cringinvnzdiv_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccfv @ (XR @ Xa) @ ccbs))) => ((! [Xa:$i] : (cwceq @ Xc_x @ (ccfv @ (XR @ Xa) @ ccmulr))) => ((! [Xa:$i] : (cwceq @ Xc_1 @ (ccfv @ (XR @ Xa) @ ccur))) => ((! [Xa:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xa) @ cc0g))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xa) @ ccrg))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XX @ (XB2 @ Xa)))) => ((cwi @ Xph @ (cwrex @ (^ [Xa:$i] : (cwceq @ (cco @ (ccv @ Xa) @ XX @ Xc_x) @ Xc_1)) @ (^ [Xa:$i] : (XB2 @ Xa)))) => ((! [Xa:$i] : (cwi @ Xph @ (cwcel @ XY @ (XB2 @ Xa)))) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XX @ XY @ Xc_x) @ Xc_0) @ (cwceq @ XY @ Xc_0)))))))))))))))))))).
