...
thf(aclimserle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XN @ XZ)) => ((cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ XA2 @ ccli)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ XA2 @ ccle)))))))))))))).
...
thf(cioombl1lem4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((! [Xn:$i] : (cwceq @ XB2 @ (cco @ (XA2 @ Xn) @ ccpnf @ ccioo))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xn) @ ccr))) => ((cwi @ Xph @ (cwss @ XE @ ccr)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XE @ ccovol) @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwceq @ XS @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1)) => ((! [Xn:$i] : (cwceq @ (XT @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1))) => ((! [Xn:$i] : (cwceq @ (XU @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XH) @ cc1))) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwss @ XE @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))))) => ((cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ XS) @ ccxr @ cclt) @ (cco @ (ccfv @ XE @ ccovol) @ XC @ ccaddc) @ ccle)) => ((! [Xn:$i] : (cwceq @ (XP @ Xn) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st))) => ((! [Xn:$i] : (cwceq @ (XQ @ Xn) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd))) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (ccif @ (cwbr @ (ccif @ (cwbr @ (XP @ Xn) @ (XA2 @ Xn) @ ccle) @ (XA2 @ Xn) @ (XP @ Xn)) @ (XQ @ Xn) @ ccle) @ (ccif @ (cwbr @ (XP @ Xn) @ (XA2 @ Xn) @ ccle) @ (XA2 @ Xn) @ (XP @ Xn)) @ (XQ @ Xn)) @ (XQ @ Xn))))) => ((cwceq @ XH @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (XP @ Xn) @ (ccif @ (cwbr @ (ccif @ (cwbr @ (XP @ Xn) @ (XA2 @ Xn) @ ccle) @ (XA2 @ Xn) @ (XP @ Xn)) @ (XQ @ Xn) @ ccle) @ (ccif @ (cwbr @ (XP @ Xn) @ (XA2 @ Xn) @ ccle) @ (XA2 @ Xn) @ (XP @ Xn)) @ (XQ @ Xn)))))) => (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ (ccin @ XE @ XB2) @ ccovol) @ (ccfv @ (ccdif @ XE @ XB2) @ ccovol) @ ccaddc) @ (cco @ (ccfv @ XE @ ccovol) @ XC @ ccaddc) @ ccle))))))))))))))))))))))))))))))).
