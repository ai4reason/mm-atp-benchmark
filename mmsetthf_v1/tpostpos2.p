...
thf(atpostpos_thm,axiom,(! [XF:($i > $o)] : (cwceq @ (cctpos @ (cctpos @ XF)) @ (ccin @ XF @ (ccxp @ (ccun @ (ccxp @ ccvv @ ccvv) @ (ccsn @ cc0)) @ ccvv))))).
...
thf(ctpostpos2_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwa @ (cwrel @ XF) @ (cwrel @ (ccdm @ XF))) @ (cwceq @ (cctpos @ (cctpos @ XF)) @ XF)))).
