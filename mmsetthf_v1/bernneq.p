...
thf(amuladd11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ cc1 @ XB2 @ ccaddc) @ ccmul) @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccaddc) @ ccaddc)))))).
...
thf(cbernneq_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ (ccneg @ cc1) @ XA2 @ ccle)) @ (cwbr @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccmul) @ ccaddc) @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ XN @ ccexp) @ ccle))))).
