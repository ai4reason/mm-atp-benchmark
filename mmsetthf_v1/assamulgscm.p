...
thf(aassamulgscmlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XG @ (ccfv @ XF @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwceq @ XH @ (ccfv @ XW @ ccmgp)) => ((cwceq @ XE @ (ccfv @ XH @ ccmg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwcel @ XX @ XV)) @ (cwcel @ XW @ ccasa)) @ (cwceq @ (cco @ ccc0 @ (cco @ XA2 @ XX @ Xc_x) @ XE) @ (cco @ (cco @ ccc0 @ XA2 @ Xc_ex) @ (cco @ ccc0 @ XX @ XE) @ Xc_x))))))))))))))))))))))).
...
thf(aassamulgscmlem2_thm,axiom,(! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XG @ (ccfv @ XF @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwceq @ XH @ (ccfv @ XW @ ccmgp)) => ((cwceq @ XE @ (ccfv @ XH @ ccmg)) => (cwi @ (cwcel @ (ccv @ Xy1) @ ccn0) @ (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwcel @ XX @ XV)) @ (cwcel @ XW @ ccasa)) @ (cwi @ (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ XA2 @ XX @ Xc_x) @ XE) @ (cco @ (cco @ (ccv @ Xy1) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xy1) @ XX @ XE) @ Xc_x)) @ (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ (cco @ XA2 @ XX @ Xc_x) @ XE) @ (cco @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ XA2 @ Xc_ex) @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ XX @ XE) @ Xc_x)))))))))))))))))))))))))).
thf(cassamulgscm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XG @ (ccfv @ XF @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwceq @ XH @ (ccfv @ XW @ ccmgp)) => ((cwceq @ XE @ (ccfv @ XH @ ccmg)) => (cwi @ (cwa @ (cwcel @ XW @ ccasa) @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ XB2) @ (cwcel @ XX @ XV))) @ (cwceq @ (cco @ XN @ (cco @ XA2 @ XX @ Xc_x) @ XE) @ (cco @ (cco @ XN @ XA2 @ Xc_ex) @ (cco @ XN @ XX @ XE) @ Xc_x)))))))))))))))))))))))).
