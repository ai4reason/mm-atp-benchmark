...
thf(awrecseq3_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwceq @ XF @ XG) @ (cwceq @ (ccwrecs @ XA2 @ XR @ XF) @ (ccwrecs @ XA2 @ XR @ XG)))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(adf_bpoly_ax,axiom,(cwceq @ ccbp @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xx3:$i] : ccn0)) @ (^ [Xm:$i] : (^ [Xx3:$i] : ccc)) @ (^ [Xm:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xm) @ (ccwrecs @ ccn0 @ cclt @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccsb @ (ccfv @ (ccdm @ (ccv @ Xg1)) @ cchash) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ (ccsu @ (ccdm @ (ccv @ Xg1)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccbc) @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin)))))))))))).
...
thf(aprednn0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccpred @ ccn0 @ cclt @ XN) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))).
...
thf(cbpolylem_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xg1 @ Xk @ Xn) @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccsb @ (ccfv @ (ccdm @ (ccv @ Xg1)) @ cchash) @ (^ [Xn:$i] : (cco @ (cco @ XX @ (ccv @ Xn) @ ccexp) @ (ccsu @ (ccdm @ (ccv @ Xg1)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccbc) @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin))))))))) => ((! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ XF @ (ccwrecs @ ccn0 @ cclt @ (XG @ Xg1 @ Xk @ Xn)))))) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ ccc)) @ (cwceq @ (cco @ XN @ XX @ ccbp) @ (cco @ (cco @ XX @ XN @ ccexp) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (ccv @ Xk) @ XX @ ccbp) @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin)))))))))).
