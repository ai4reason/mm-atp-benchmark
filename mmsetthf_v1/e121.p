...
thf(ce121_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwvd1 @ Xph @ Xps) => ((cwvd2 @ Xph @ Xch @ Xth) => ((cwvd1 @ Xph @ Xta) => ((cwi @ Xps @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwvd2 @ Xph @ Xch @ Xet)))))))))))).
