...
thf(afrpomin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwfr @ XA2 @ XR) @ (cwpo @ XA2 @ XR) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))).
...
thf(cfrpomin2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwfr @ XA2 @ XR) @ (cwpo @ XA2 @ XR) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0))) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccpred @ XB2 @ XR @ (ccv @ Xx3)) @ cc0)) @ (^ [Xx3:$i] : XB2))))))).
