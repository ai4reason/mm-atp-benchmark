...
thf(aaxunnd_thm,axiom,(! [Xz:$i] : (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))).
...
thf(czfcndun_conj,conjecture,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwex @ (^ [Xw:$i] : (cwa @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))))) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
