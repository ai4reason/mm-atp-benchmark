...
thf(aeupth2lemb_thm,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ ccupgr))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwfun @ (XI @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (XF @ Xx3) @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ cceupth)))) => (cwi @ Xph @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwn @ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccop @ (XV @ Xx3) @ (ccres @ (XI @ Xx3) @ (ccima @ (XF @ Xx3) @ (cco @ ccc0 @ ccc0 @ ccfzo)))) @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : (XV @ Xx3))) @ cc0)))))))))))))).
...
thf(ceupth2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ ccupgr))) => ((cwi @ Xph @ (cwfun @ XI)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ XF @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ cceupth)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwn @ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)) @ (ccif @ (cwceq @ (ccfv @ ccc0 @ (XP @ Xx3)) @ (ccfv @ (ccfv @ XF @ cchash) @ (XP @ Xx3))) @ cc0 @ (ccpr @ (ccfv @ ccc0 @ (XP @ Xx3)) @ (ccfv @ (ccfv @ XF @ cchash) @ (XP @ Xx3))))))))))))))))))).
