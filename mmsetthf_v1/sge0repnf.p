...
thf(csge0repnf_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwi @ Xph @ (cwb @ (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr) @ (cwn @ (cwceq @ (ccfv @ XF @ ccsumge0) @ ccpnf))))))))))).
