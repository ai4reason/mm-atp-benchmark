...
thf(cvolcn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccin @ XA2 @ (cco @ XB2 @ (ccv @ Xx3) @ ccicc)) @ ccvol))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ ccr)) @ (cwcel @ (XF @ Xx3) @ (cco @ ccr @ ccr @ cccncf))))))))).
