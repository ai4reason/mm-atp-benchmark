...
thf(adf_lco_ax,axiom,(cwceq @ cclinco @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xv:$i] : ccvv)) @ (^ [Xm:$i] : (^ [Xv:$i] : (ccpw @ (ccfv @ (ccv @ Xm) @ ccbs)))) @ (^ [Xm:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xc:$i] : (cwrex @ (^ [Xs1:$i] : (cwa @ (cwbr @ (ccv @ Xs1) @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ cc0g) @ ccfsupp) @ (cwceq @ (ccv @ Xc) @ (cco @ (ccv @ Xs1) @ (ccv @ Xv) @ (ccfv @ (ccv @ Xm) @ cclinc))))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ ccbs) @ (ccv @ Xv) @ ccmap)))) @ (^ [Xc:$i] : (ccfv @ (ccv @ Xm) @ ccbs)))))))).
