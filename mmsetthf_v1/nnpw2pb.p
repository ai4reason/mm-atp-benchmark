...
thf(annpw2p_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwrex @ (^ [Xi:$i] : (cwrex @ (^ [Xr:$i] : (cwceq @ XN @ (cco @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ (ccv @ Xr) @ ccaddc))) @ (^ [Xr:$i] : (cco @ ccc0 @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ ccfzo)))) @ (^ [Xi:$i] : ccn0))))).
...
thf(cnnpw2pb_conj,conjecture,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn) @ (cwrex @ (^ [Xi:$i] : (cwrex @ (^ [Xr:$i] : (cwceq @ XN @ (cco @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ (ccv @ Xr) @ ccaddc))) @ (^ [Xr:$i] : (cco @ ccc0 @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ ccfzo)))) @ (^ [Xi:$i] : ccn0))))).
