...
thf(cfh3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) => ((cwbr @ XA2 @ XC @ cccm) => (cwceq @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ cchj) @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XA2 @ XC @ cchj)))))))))))).
