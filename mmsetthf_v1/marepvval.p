...
thf(amarepvval0_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk) @ (cco @ XN @ XR @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XQ @ Xi @ Xj @ Xk) @ (cco @ XN @ XR @ ccmatrepV))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XV @ Xi @ Xj @ Xk) @ (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XM @ (XB2 @ Xi @ Xj @ Xk)) @ (cwcel @ XC @ (XV @ Xi @ Xj @ Xk))) @ (cwceq @ (cco @ XM @ XC @ (XQ @ Xi @ Xj @ Xk)) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (ccfv @ (ccv @ Xi) @ XC) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM))))))))))))))))))))))))).
...
thf(cmarepvval_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XB2 @ Xi @ Xj) @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XQ @ Xi @ Xj) @ (cco @ XN @ XR @ ccmatrepV)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XV @ Xi @ Xj) @ (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cw3a @ (cwcel @ XM @ (XB2 @ Xi @ Xj)) @ (cwcel @ XC @ (XV @ Xi @ Xj)) @ (cwcel @ XK @ XN)) @ (cwceq @ (ccfv @ XK @ (cco @ XM @ XC @ (XQ @ Xi @ Xj))) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xj) @ XK) @ (ccfv @ (ccv @ Xi) @ XC) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM))))))))))))))))))))))).
