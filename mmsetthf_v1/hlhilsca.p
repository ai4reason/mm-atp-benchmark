...
thf(aphlsca_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccsca) @ XT)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccvsca) @ Xc_x) @ (ccop @ (ccfv @ ccnx @ ccip) @ Xc_xi)))) => (cwi @ (cwcel @ XT @ XX) @ (cwceq @ XT @ (ccfv @ XH @ ccsca)))))))))))).
thf(chlhilsca_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ ccedring))) => ((cwceq @ XG @ (ccfv @ XW @ (ccfv @ XK @ cchg))) => ((cwceq @ XR @ (cco @ XE @ (ccop @ (ccfv @ ccnx @ ccstv) @ XG) @ ccsts)) => (cwi @ Xph @ (cwceq @ XR @ (ccfv @ XU @ ccsca)))))))))))))))))).
