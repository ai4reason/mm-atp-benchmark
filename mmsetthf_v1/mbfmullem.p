...
thf(ambfi1flim_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => (cwi @ Xph @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : XA2)))))))))))).
...
thf(ambfmullem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XG)) => ((cwi @ Xph @ (cwf @ ccn @ (ccdm @ ccitg1) @ XP)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XP)))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli))) => ((cwi @ Xph @ (cwf @ ccn @ (ccdm @ ccitg1) @ XQ)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XQ)))) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccli))) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf))))))))))))))))).
...
thf(cmbfmullem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XG)) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf))))))))))).
