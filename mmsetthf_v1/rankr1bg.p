...
thf(crankr1bg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ XB2 @ (ccdm @ ccr1))) @ (cwb @ (cwss @ XA2 @ (ccfv @ XB2 @ ccr1)) @ (cwss @ (ccfv @ XA2 @ ccrnk) @ XB2)))))).
