...
thf(cdgrnznn_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XP @ (ccfv @ XS @ ccply)) @ (cwne @ XP @ cc0p)) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ XP) @ ccc0))) @ (cwcel @ (ccfv @ XP @ ccdgr) @ ccn)))))).
