...
thf(arei_thm,axiom,(cwceq @ (ccfv @ cci @ ccre) @ ccc0)).
...
thf(are0_thm,axiom,(cwceq @ (ccfv @ ccc0 @ ccre) @ ccc0)).
...
thf(alogimul_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) @ (cwceq @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cclog) @ (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccaddc))))).
...
thf(alogneg2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccim) @ cclt)) @ (cwceq @ (ccfv @ (ccneg @ XA2) @ cclog) @ (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ ccpi @ ccmul) @ ccmin))))).
...
thf(aimi_thm,axiom,(cwceq @ (ccfv @ cci @ ccim) @ cc1)).
...
thf(catanlogsublem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) @ (cwcel @ (ccfv @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))))).
