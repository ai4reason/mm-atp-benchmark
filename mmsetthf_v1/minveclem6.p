...
thf(cminveclem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XU @ ccsg)) => ((cwceq @ XN @ (ccfv @ XU @ ccnm)) => ((cwi @ Xph @ (cwcel @ XU @ cccph)) => ((cwi @ Xph @ (cwcel @ XY @ (ccfv @ XU @ cclss))) => ((cwi @ Xph @ (cwcel @ (cco @ XU @ XY @ ccress) @ cccms)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwceq @ XJ @ (ccfv @ XU @ cctopn)) => ((cwceq @ XR @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi) @ XN))))) => ((cwceq @ XS @ (ccinf @ XR @ ccr @ cclt)) => ((cwceq @ XD @ (ccres @ (ccfv @ XU @ ccds) @ (ccxp @ XX @ XX))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XY)) @ (cwb @ (cwbr @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ XD) @ cc2 @ ccexp) @ (cco @ (cco @ XS @ cc2 @ ccexp) @ ccc0 @ ccaddc) @ ccle) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ Xc_mi) @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi) @ XN) @ ccle)) @ (^ [Xy1:$i] : XY)))))))))))))))))))))))))))).
