...
thf(auzind_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ XM) @ (cwb @ (Xph @ Xj) @ (Xps @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xch @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xj) @ (Xth @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (XN @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xta @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwcel @ XM @ ccz) @ (Xps @ Xk))) => ((! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ (ccv @ Xk) @ ccz) @ (cwbr @ XM @ (ccv @ Xk) @ ccle)) @ (cwi @ (Xch @ Xk) @ (Xth @ Xk)))) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ (XN @ Xk) @ ccz) @ (cwbr @ XM @ (XN @ Xk) @ ccle)) @ (Xta @ Xk))))))))))))))))).
...
thf(aalgcvg_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwf @ XS @ XS @ XF) => ((! [Xz:$i] : (cwceq @ XR @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xz))) @ ccc0))) => ((cwf @ XS @ ccn0 @ XC) => ((! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ XS) @ (cwi @ (cwne @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ ccc0) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ (ccfv @ (ccv @ Xz) @ XC) @ cclt)))) => ((! [Xz:$i] : (cwceq @ (XN @ Xz) @ (ccfv @ (XA2 @ Xz) @ XC))) => (! [Xz:$i] : (cwi @ (cwcel @ (XA2 @ Xz) @ XS) @ (cwceq @ (ccfv @ (ccfv @ (XN @ Xz) @ XR) @ XC) @ ccc0))))))))))))))).
...
thf(aalgcvgb_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwf @ XS @ XS @ XF) => ((cwf @ XS @ ccn0 @ XC) => (cwi @ (cwcel @ XX @ XS) @ (cwb @ (cwi @ (cwne @ (ccfv @ (ccfv @ XX @ XF) @ XC) @ ccc0) @ (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XC) @ (ccfv @ XX @ XC) @ cclt)) @ (cwa @ (cwi @ (cwne @ (ccfv @ XX @ XC) @ ccc0) @ (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XC) @ (ccfv @ XX @ XC) @ cclt)) @ (cwi @ (cwceq @ (ccfv @ XX @ XC) @ ccc0) @ (cwceq @ (ccfv @ (ccfv @ XX @ XF) @ XC) @ ccc0)))))))))))).
...
thf(calgcvga_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwf @ XS @ XS @ XF) => ((! [Xz:$i] : (cwceq @ XR @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xz))) @ ccc0))) => ((cwf @ XS @ ccn0 @ XC) => ((! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ XS) @ (cwi @ (cwne @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ ccc0) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ (ccfv @ (ccv @ Xz) @ XC) @ cclt)))) => ((! [Xz:$i] : (cwceq @ (XN @ Xz) @ (ccfv @ (XA2 @ Xz) @ XC))) => (! [Xz:$i] : (cwi @ (cwcel @ (XA2 @ Xz) @ XS) @ (cwi @ (cwcel @ (XK @ Xz) @ (ccfv @ (XN @ Xz) @ ccuz)) @ (cwceq @ (ccfv @ (ccfv @ (XK @ Xz) @ XR) @ XC) @ ccc0))))))))))))))))).
