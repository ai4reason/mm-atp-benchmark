...
thf(cevengpoap3_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xm:$i] : (cwi @ (cwbr @ cc7 @ (ccv @ Xm) @ cclt) @ (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) @ (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ (ccdc @ cc1 @ cc2) @ ccuz)) @ (cwcel @ XN @ cceven)) @ (cwrex @ (^ [Xo:$i] : (cwceq @ XN @ (cco @ (ccv @ Xo) @ cc3 @ ccaddc))) @ (^ [Xo:$i] : ccgbo)))))).
