...
thf(aismred2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XC @ (ccpw @ XX))) => ((! [Xs1:$i] : (cwi @ (cwa @ Xph @ (cwss @ (ccv @ Xs1) @ XC)) @ (cwcel @ (ccin @ XX @ (ccint @ (ccv @ Xs1))) @ XC))) => (cwi @ Xph @ (cwcel @ XC @ (ccfv @ XX @ ccmre))))))))).
...
thf(amrerintcl_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XS @ XC)) @ (cwcel @ (ccin @ XX @ (ccint @ XS)) @ XC)))))).
...
thf(aacsfiel2_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccacs)) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XS @ XC) @ (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ XF) @ XS)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
...
thf(aelrint2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwcel @ XX @ (XA2 @ Xy1)) @ (cwb @ (cwcel @ XX @ (ccin @ (XA2 @ Xy1) @ (ccint @ XB2))) @ (cwral @ (^ [Xy1:$i] : (cwcel @ XX @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))))))))).
...
thf(cmreacs_conj,conjecture,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwcel @ (ccfv @ XX @ ccacs) @ (ccfv @ (ccpw @ XX) @ ccmre)))))).
