...
thf(aresresdm_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XF @ (ccres @ XE @ XA2)) @ (cwceq @ XF @ (ccres @ XE @ (ccdm @ XF)))))))).
...
thf(cuhgrspan1_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XV @ Xi) @ (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xi) @ cciedg))) => ((! [Xi:$i] : (cwceq @ (XF @ Xi) @ (ccrab @ (^ [Xi:$i] : (cwnel @ XN @ (ccfv @ (ccv @ Xi) @ XI))) @ (^ [Xi:$i] : (ccdm @ XI))))) => ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccop @ (ccdif @ (XV @ Xi) @ (ccsn @ XN)) @ (ccres @ XI @ (XF @ Xi))))) => (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ (XG @ Xi) @ ccuhgr) @ (cwcel @ XN @ (XV @ Xi))) @ (cwbr @ (XS @ Xi) @ (XG @ Xi) @ ccsubgr)))))))))))))).
