...
thf(aasclpropd_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccfv @ XK @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccfv @ XL @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ XP @ (ccfv @ (XF @ Xx3 @ Xy1) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ XP @ (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XP) @ (cwcel @ (ccv @ Xy1) @ XW))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XK @ ccvsca)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XL @ ccvsca)))))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ ccur) @ (ccfv @ XL @ ccur))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XK @ ccur) @ XW)) => (cwi @ Xph @ (cwceq @ (ccfv @ XK @ ccascl) @ (ccfv @ XL @ ccascl)))))))))))))))))).
...
thf(cply1ascl_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => (cwceq @ XA2 @ (ccfv @ (cco @ cc1o @ XR @ ccmpl) @ ccascl)))))))).
