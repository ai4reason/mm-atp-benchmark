...
thf(cunopab_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (cwceq @ (ccun @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwo @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1))))))))).
