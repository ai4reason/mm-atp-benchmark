...
thf(aresssetc_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccsetc)) => ((cwceq @ XD @ (ccfv @ XV @ ccsetc)) => ((cwi @ Xph @ (cwcel @ XU @ XW)) => ((cwi @ Xph @ (cwss @ XV @ XU)) => (cwi @ Xph @ (cwa @ (cwceq @ (ccfv @ (cco @ XC @ XV @ ccress) @ cchomf) @ (ccfv @ XD @ cchomf)) @ (cwceq @ (ccfv @ (cco @ XC @ XV @ ccress) @ cccomf) @ (ccfv @ XD @ cccomf))))))))))))))).
...
thf(cfuncsetcres2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccsetc)) => ((cwceq @ XD @ (ccfv @ XV @ ccsetc)) => ((cwi @ Xph @ (cwcel @ XU @ XW)) => ((cwi @ Xph @ (cwss @ XV @ XU)) => (cwi @ Xph @ (cwss @ (cco @ XE @ XD @ ccfunc) @ (cco @ XE @ XC @ ccfunc))))))))))))))).
