...
thf(ablsconn_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XS @ (cco @ XP @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((cwceq @ XK @ (cco @ XJ @ XS @ ccrest)) => (cwi @ (cwa @ (cwcel @ XP @ ccc) @ (cwcel @ XR @ ccxr)) @ (cwcel @ XK @ ccsconn))))))))))).
...
thf(ccnllysconn_conj,conjecture,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwcel @ XJ @ (cclly @ ccsconn))))).
