...
thf(cecopqsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XR @ ccvv) => ((cwceq @ XS @ (ccqs @ (ccxp @ XA2 @ XA2) @ XR)) => (cwi @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) @ (cwcel @ (ccec @ (ccop @ XB2 @ XC) @ XR) @ XS)))))))))).
