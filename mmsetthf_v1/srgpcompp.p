...
thf(asrgpcomp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_xp @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XG @ (ccfv @ XR @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwi @ Xph @ (cwcel @ XR @ ccsrg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XB2 @ XS)) => ((cwi @ Xph @ (cwcel @ XK @ ccn0)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_xp) @ (cco @ XB2 @ XA2 @ Xc_xp))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XK @ XB2 @ Xc_ex) @ XA2 @ Xc_xp) @ (cco @ XA2 @ (cco @ XK @ XB2 @ Xc_ex) @ Xc_xp)))))))))))))))))))))).
