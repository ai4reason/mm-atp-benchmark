...
thf(aisperf3_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccperf) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccsn @ (ccv @ Xx3)) @ XJ))) @ (^ [Xx3:$i] : XX)))))))).
thf(ct1connperf_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cct1) @ (cwcel @ XJ @ ccconn) @ (cwn @ (cwbr @ XX @ cc1o @ ccen))) @ (cwcel @ XJ @ ccperf)))))).
