...
thf(altaddpos2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ XB2 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))))))).
...
thf(citg2gt0cn_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwbr @ XX @ XY @ cclt)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XX @ XY @ ccioo))) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ cclt))) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ (cco @ XX @ XY @ ccioo)) @ (cco @ (cco @ XX @ XY @ ccioo) @ ccc @ cccncf))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XF @ ccitg2) @ cclt))))))))))).
