...
thf(adf_squarenn_ax,axiom,(cwceq @ ccsquarenn @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccq)) @ (^ [Xx3:$i] : ccn)))).
...
thf(apellex_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ ccn) @ (cwn @ (cwcel @ (ccfv @ XD @ ccsqrt) @ ccq))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1)) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccn))))).
...
thf(cpellqrex_conj,conjecture,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ cc1 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell1qr)))))).
