...
thf(ansspssun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwn @ (cwss @ XA2 @ XB2)) @ (cwpss @ XB2 @ (ccun @ XA2 @ XB2)))))).
...
thf(cdisjpss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwne @ XB2 @ cc0)) @ (cwpss @ XA2 @ (ccun @ XA2 @ XB2)))))).
