...
thf(cnmfnsetre_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ ccc @ XT) @ (cwss @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xy1) @ ccno) @ cc1 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccabs)))) @ (^ [Xy1:$i] : cchil)))) @ ccr)))).
