...
thf(adf_word_ax,axiom,(! [XS:($i > $o)] : (cwceq @ (ccword @ XS) @ (ccab @ (^ [Xw:$i] : (cwrex @ (^ [Xl:$i] : (cwf @ (cco @ ccc0 @ (ccv @ Xl) @ ccfzo) @ XS @ (ccv @ Xw))) @ (^ [Xl:$i] : ccn0))))))).
...
thf(asbcfg_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwf @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XF @ Xx3))) @ XX) @ (cwf @ (ccsb @ XX @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsb @ XX @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ XX @ (^ [Xx3:$i] : (XF @ Xx3)))))))))))).
...
thf(ccsbwrdg_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwceq @ (ccsb @ XS @ (^ [Xx3:$i] : (ccword @ (ccv @ Xx3)))) @ (ccword @ XS)))))).
