...
thf(aintabs_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccint @ (ccab @ (^ [Xy1:$i] : (Xps @ Xy1))))) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xy1:$i] : (cwa @ (cwss @ (ccint @ (ccab @ (^ [Xy1:$i] : (Xps @ Xy1)))) @ (XA2 @ Xy1)) @ (Xch @ Xy1))) => (! [Xy1:$i] : (cwceq @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (Xph @ Xx3))))) @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))))))))))))).
...
thf(adfnn2_thm,axiom,(cwceq @ ccn @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwcel @ cc1 @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
...
thf(cdfnn3_conj,conjecture,(cwceq @ ccn @ (ccint @ (ccab @ (^ [Xx3:$i] : (cw3a @ (cwss @ (ccv @ Xx3) @ ccr) @ (cwcel @ cc1 @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
