...
thf(adf_uhgr_ax,axiom,(cwceq @ ccuhgr @ (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xe:$i] : (cwf @ (ccdm @ (ccv @ Xe)) @ (ccdif @ (ccpw @ (ccv @ Xv)) @ (ccsn @ cc0)) @ (ccv @ Xe))) @ (ccfv @ (ccv @ Xg1) @ cciedg))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
...
thf(cisuhgr_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ XU) @ (cwb @ (cwcel @ XG @ ccuhgr) @ (cwf @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)))))))))).
