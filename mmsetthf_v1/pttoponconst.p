...
thf(cpttoponconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt)) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XR @ (ccfv @ XX @ cctopon))) @ (cwcel @ XJ @ (ccfv @ (cco @ XX @ XA2 @ ccmap) @ cctopon)))))))))).
