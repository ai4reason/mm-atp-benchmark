...
thf(auhgredgiedgb_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => (! [Xx3:$i] : (cwi @ (cwcel @ (XG @ Xx3) @ ccuhgr) @ (cwb @ (cwcel @ XE @ (ccfv @ (XG @ Xx3) @ ccedg)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XE @ (ccfv @ (ccv @ Xx3) @ XI))) @ (^ [Xx3:$i] : (ccdm @ XI))))))))))).
...
thf(aumgr2adedgwlk_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XF @ (ccs2 @ XJ @ XK)) => ((cwceq @ XP @ (ccs3 @ XA2 @ XB2 @ XC)) => ((cwi @ Xph @ (cwcel @ XG @ ccumgr)) => ((cwi @ Xph @ (cwa @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XJ @ XI) @ (ccpr @ XA2 @ XB2))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ XI) @ (ccpr @ XB2 @ XC))) => (cwi @ Xph @ (cw3a @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ XF @ cchash) @ cc2) @ (cw3a @ (cwceq @ XA2 @ (ccfv @ ccc0 @ XP)) @ (cwceq @ XB2 @ (ccfv @ cc1 @ XP)) @ (cwceq @ XC @ (ccfv @ cc2 @ XP))))))))))))))))))))))))).
...
thf(cumgr2wlk_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xf1 @ Xp) @ (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccumgr) @ (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp))) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc2) @ (cw3a @ (cwceq @ XA2 @ (ccfv @ ccc0 @ (ccv @ Xp))) @ (cwceq @ XB2 @ (ccfv @ cc1 @ (ccv @ Xp))) @ (cwceq @ XC @ (ccfv @ cc2 @ (ccv @ Xp))))))))))))))))))).
