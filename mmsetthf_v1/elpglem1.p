...
thf(celpglem1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ ccpg) @ (cwa @ (cwcel @ (ccfv @ XA2 @ cc1st) @ (ccpw @ (ccv @ Xx3))) @ (cwcel @ (ccfv @ XA2 @ cc2nd) @ (ccpw @ (ccv @ Xx3))))))) @ (cwa @ (cwss @ (ccfv @ XA2 @ cc1st) @ ccpg) @ (cwss @ (ccfv @ XA2 @ cc2nd) @ ccpg))))).
