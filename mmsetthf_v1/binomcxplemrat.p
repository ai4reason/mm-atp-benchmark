...
thf(adivcnvshft_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ XA2 @ (cco @ (ccv @ Xk) @ XB2 @ ccaddc) @ ccdiv)))) => (cwi @ Xph @ (cwbr @ XF @ ccc0 @ ccli)))))))))))))))).
...
thf(cbinomcxplemrat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xk) @ ccrp))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XB2 @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xk) @ ccabs) @ cclt))) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ XC @ (ccv @ Xk) @ ccmin) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccdiv) @ ccabs))) @ cc1 @ ccli))))))))))).
