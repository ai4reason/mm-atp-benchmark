...
thf(adf_mpl_ax,axiom,(cwceq @ ccmpl @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xr:$i] : (ccsb @ (cco @ (ccv @ Xi) @ (ccv @ Xr) @ ccmps) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccrab @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xr) @ cc0g) @ ccfsupp)) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xw) @ ccbs))) @ ccress)))))))).
