...
thf(cresgrpisgrp_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XS @ (ccfv @ XH @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XH @ ccgrp)) @ (cwi @ (cwa @ (cwss @ XS @ XB2) @ (cwceq @ (ccfv @ XH @ ccplusg) @ (ccres @ (ccfv @ XG @ ccplusg) @ (ccxp @ XS @ XS)))) @ (cwcel @ (cco @ XG @ XS @ ccress) @ ccgrp)))))))))).
