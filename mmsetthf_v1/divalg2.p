...
thf(adivalg_thm,axiom,(! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccz) @ (cwne @ XD @ ccc0)) @ (cwreu @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwbr @ ccc0 @ (ccv @ Xr) @ ccle) @ (cwbr @ (ccv @ Xr) @ (ccfv @ XD @ ccabs) @ cclt) @ (cwceq @ XN @ (cco @ (cco @ (ccv @ Xq) @ XD @ ccmul) @ (ccv @ Xr) @ ccaddc)))) @ (^ [Xq:$i] : ccz))) @ (^ [Xr:$i] : ccz)))))).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(adivalgb_thm,axiom,(! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccz) @ (cwne @ XD @ ccc0)) @ (cwb @ (cwreu @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwbr @ ccc0 @ (ccv @ Xr) @ ccle) @ (cwbr @ (ccv @ Xr) @ (ccfv @ XD @ ccabs) @ cclt) @ (cwceq @ XN @ (cco @ (cco @ (ccv @ Xq) @ XD @ ccmul) @ (ccv @ Xr) @ ccaddc)))) @ (^ [Xq:$i] : ccz))) @ (^ [Xr:$i] : ccz)) @ (cwreu @ (^ [Xr:$i] : (cwa @ (cwbr @ (ccv @ Xr) @ (ccfv @ XD @ ccabs) @ cclt) @ (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds))) @ (^ [Xr:$i] : ccn0))))))).
...
thf(cdivalg2_conj,conjecture,(! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn)) @ (cwreu @ (^ [Xr:$i] : (cwa @ (cwbr @ (ccv @ Xr) @ XD @ cclt) @ (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds))) @ (^ [Xr:$i] : ccn0)))))).
