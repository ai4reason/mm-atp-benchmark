...
thf(aareaf_thm,axiom,(cwf @ (ccdm @ ccarea) @ (cco @ ccc0 @ ccpnf @ ccico) @ ccarea)).
...
thf(careage0_conj,conjecture,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ (ccdm @ ccarea)) @ (cwbr @ ccc0 @ (ccfv @ XS @ ccarea) @ ccle)))).
