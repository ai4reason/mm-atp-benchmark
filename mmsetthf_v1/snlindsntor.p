...
thf(araldifsni_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwn @ (Xph @ Xx3))) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccsn @ (XB2 @ Xx3))))) @ (cwral @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(asnlindsntorlem_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XR @ Xf1 @ Xs1) @ (ccfv @ XM @ ccsca)))) => ((! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ XS @ (ccfv @ (XR @ Xf1 @ Xs1) @ ccbs)))) => ((! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xf1 @ Xs1) @ cc0g)))) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XX @ XB2)) @ (cwi @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwceq @ (cco @ (ccv @ Xf1) @ (ccsn @ XX) @ (ccfv @ XM @ cclinc)) @ XZ) @ (cwceq @ (ccfv @ XX @ (ccv @ Xf1)) @ Xc_0))) @ (^ [Xf1:$i] : (cco @ XS @ (ccsn @ XX) @ ccmap))) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwceq @ (cco @ (ccv @ Xs1) @ XX @ Xc_x) @ XZ) @ (cwceq @ (ccv @ Xs1) @ Xc_0))) @ (^ [Xs1:$i] : XS))))))))))))))))))).
...
thf(csnlindsntor_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((! [Xs1:$i] : (cwceq @ (XR @ Xs1) @ (ccfv @ XM @ ccsca))) => ((! [Xs1:$i] : (cwceq @ XS @ (ccfv @ (XR @ Xs1) @ ccbs))) => ((! [Xs1:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xs1) @ cc0g))) => ((cwceq @ XZ @ (ccfv @ XM @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwral @ (^ [Xs1:$i] : (cwne @ (cco @ (ccv @ Xs1) @ XX @ Xc_x) @ XZ)) @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ Xc_0)))) @ (cwbr @ (ccsn @ XX) @ XM @ cclininds)))))))))))))))))).
