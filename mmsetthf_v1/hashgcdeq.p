...
thf(ahashgcdlem_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XA2 @ Xy1 @ Xz) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ XM @ XN @ ccdiv) @ ccgcd) @ cc1)) @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XM @ XN @ ccdiv) @ ccfzo)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XB2 @ Xy1 @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xz) @ XM @ ccgcd) @ XN)) @ (^ [Xz:$i] : (cco @ ccc0 @ XM @ ccfzo)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xz)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccmul))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn) @ (cwbr @ XN @ XM @ ccdvds)) @ (cwf1o @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xy1 @ Xz) @ (XF @ Xx3 @ Xy1 @ Xz))))))))))))))).
...
thf(chashgcdeq_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XM @ ccgcd) @ XN)) @ (^ [Xx3:$i] : (cco @ ccc0 @ XM @ ccfzo))) @ cchash) @ (ccif @ (cwbr @ XN @ XM @ ccdvds) @ (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccphi) @ ccc0)))))).
