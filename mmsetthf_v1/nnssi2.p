...
thf(cnnssi2_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ ccn @ XD) => ((cwi @ (cwcel @ XB2 @ ccn) @ Xph) => ((cwi @ (cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ Xph) @ Xps) => (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ Xps)))))))))).
