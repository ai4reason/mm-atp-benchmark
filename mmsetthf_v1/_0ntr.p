...
thf(c_0ntr_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwne @ XX @ cc0)) @ (cwa @ (cwss @ XS @ XX) @ (cwceq @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ cc0))) @ (cwne @ (ccdif @ XX @ XS) @ cc0))))))).
