...
thf(ciccpartxr_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfz))) => (cwi @ Xph @ (cwcel @ (ccfv @ XI @ XP) @ ccxr)))))))))).
