...
thf(aunisn0_thm,axiom,(cwceq @ (ccuni @ (ccsn @ cc0)) @ cc0)).
...
thf(cfouniiun0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfo @ XA2 @ (ccun @ XB2 @ (ccsn @ cc0)) @ XF) @ (cwceq @ (ccuni @ XB2) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))).
