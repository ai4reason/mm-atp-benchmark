...
thf(cxpiindi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (cwi @ (cwne @ XA2 @ cc0) @ (cwceq @ (ccxp @ XC @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ XC @ (XB2 @ Xx3)))))))))).
