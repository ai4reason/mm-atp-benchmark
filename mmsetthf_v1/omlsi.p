...
thf(adedth2v_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ (cwceq @ XA2 @ (ccif @ Xph @ XA2 @ XC)) @ (cwb @ Xps @ Xch)) => ((cwi @ (cwceq @ XB2 @ (ccif @ Xph @ XB2 @ XD)) @ (cwb @ Xch @ Xth)) => (Xth => (cwi @ Xph @ Xps))))))))))))).
...
thf(aelimhyp2v_thm,axiom,(! [Xph:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ (cwceq @ XA2 @ (ccif @ Xph @ XA2 @ XC)) @ (cwb @ Xph @ Xch)) => ((cwi @ (cwceq @ XB2 @ (ccif @ Xph @ XB2 @ XD)) @ (cwb @ Xch @ Xth)) => ((cwi @ (cwceq @ XC @ (ccif @ Xph @ XA2 @ XC)) @ (cwb @ Xta @ Xet)) => ((cwi @ (cwceq @ XD @ (ccif @ Xph @ XB2 @ XD)) @ (cwb @ Xet @ Xth)) => (Xta => Xth))))))))))))))).
...
thf(comlsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccsh) => (cwi @ (cwa @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccin @ XB2 @ (ccfv @ XA2 @ ccort)) @ cc0h)) @ (cwceq @ XA2 @ XB2))))))).
