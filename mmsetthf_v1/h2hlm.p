...
thf(adf_hlim_ax,axiom,(cwceq @ cchli @ (ccopab @ (^ [Xf1:$i] : (^ [Xw:$i] : (cwa @ (cwa @ (cwf @ ccn @ cchil @ (ccv @ Xf1)) @ (cwcel @ (ccv @ Xw) @ cchil)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xw) @ ccmv) @ ccno) @ (ccv @ Xx3) @ cclt)) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccrp)))))))).
...
thf(ch2hlm_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ ccnv) => ((cwceq @ cchil @ (ccfv @ XU @ ccba)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwceq @ cchli @ (ccres @ (ccfv @ XJ @ cclm) @ (cco @ cchil @ ccn @ ccmap)))))))))))).
