...
thf(crexcom4a_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xy1) @ (Xps @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XA2 @ Xy1))))) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xy1) @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1))))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))))))).
