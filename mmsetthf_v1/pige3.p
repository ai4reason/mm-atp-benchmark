...
thf(asincos3rdpi_thm,axiom,(cwa @ (cwceq @ (ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ ccsin) @ (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)) @ (cwceq @ (ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ cccos) @ (cco @ cc1 @ cc2 @ ccdiv)))).
thf(adiv11i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwne @ XC @ ccc0) => (cwb @ (cwceq @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv)) @ (cwceq @ XA2 @ XB2)))))))))).
