...
thf(cngpinvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccngp) @ (cwcel @ XG @ ccabl)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) @ (cwceq @ (cco @ (ccfv @ XA2 @ XI) @ (ccfv @ XB2 @ XI) @ XD) @ (cco @ XA2 @ XB2 @ XD))))))))))))).
