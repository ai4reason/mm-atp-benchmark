...
thf(aimasgrpf1_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XU @ (cco @ XF @ XR @ ccimas)) => ((cwceq @ XV @ (ccfv @ XR @ ccbs)) => (cwi @ (cwa @ (cwf1 @ XV @ XB2 @ XF) @ (cwcel @ XR @ ccgrp)) @ (cwcel @ XU @ ccgrp)))))))))).
thf(cxpsgrp_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (cco @ XR @ XS @ ccxps)) => (cwi @ (cwa @ (cwcel @ XR @ ccgrp) @ (cwcel @ XS @ ccgrp)) @ (cwcel @ XT @ ccgrp))))))).
