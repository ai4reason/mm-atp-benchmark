...
thf(anabbi_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3) @ (cwn @ (Xps @ Xx3))))) @ (cwne @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3)))))))).
...
thf(csuppvalbr_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XR @ (XV @ Xx3 @ Xy1)) @ (cwcel @ XZ @ (XW @ Xx3 @ Xy1))) @ (cwceq @ (cco @ XR @ XZ @ ccsupp) @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (cwex @ (^ [Xy1:$i] : (cwb @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwne @ (ccv @ Xy1) @ XZ)))))))))))))))).
