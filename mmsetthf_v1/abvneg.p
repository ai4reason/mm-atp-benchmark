...
thf(aring1eq0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwi @ (cwceq @ Xc_1 @ Xc_0) @ (cwceq @ XX @ XY))))))))))))).
...
thf(cabvneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XR @ ccabv)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XN @ (ccfv @ XR @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XF @ XA2) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ (ccfv @ XX @ XN) @ XF) @ (ccfv @ XX @ XF))))))))))))).
