...
thf(axreceu_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) @ (cwreu @ (^ [Xx3:$i] : (cwceq @ (cco @ XB2 @ (ccv @ Xx3) @ ccxmu) @ XA2)) @ (^ [Xx3:$i] : ccxr)))))).
...
thf(cxrmulc1cn_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ ccle @ ccordt))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccxmu)))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))))).
