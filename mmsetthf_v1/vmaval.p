...
thf(adf_vma_ax,axiom,(cwceq @ ccvma @ (ccmpt @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccsb @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (ccfv @ (ccv @ Xs1) @ cchash) @ cc1) @ (ccfv @ (ccuni @ (ccv @ Xs1)) @ cclog) @ ccc0))))))).
...
thf(cvmaval_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (XS @ Xp) @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)))) => (! [Xp:$i] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwceq @ (ccfv @ XA2 @ ccvma) @ (ccif @ (cwceq @ (ccfv @ (XS @ Xp) @ cchash) @ cc1) @ (ccfv @ (ccuni @ (XS @ Xp)) @ cclog) @ ccc0)))))))).
