...
thf(celovimad_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XC)) => ((cwi @ Xph @ (cwcel @ XB2 @ XD)) => ((cwi @ Xph @ (cwfun @ XF)) => ((cwi @ Xph @ (cwss @ (ccxp @ XC @ XD) @ (ccdm @ XF))) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XB2 @ XF) @ (ccima @ XF @ (ccxp @ XC @ XD))))))))))))))).
