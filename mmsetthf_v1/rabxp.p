...
thf(crabxp_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1 @ Xz)))))) => (cwceq @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccxp @ XA2 @ XB2))) @ (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (cw3a @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwcel @ (ccv @ Xz) @ XB2) @ (Xps @ Xy1 @ Xz)))))))))))).
