...
thf(afzo0addelr_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ XC @ ccfzo)) @ (cwcel @ XD @ ccz)) @ (cwcel @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XD @ (cco @ XD @ XC @ ccaddc) @ ccfzo))))))).
...
thf(cccatval3_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XT @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ (cco @ XI @ (ccfv @ XS @ cchash) @ ccaddc) @ (cco @ XS @ XT @ ccconcat)) @ (ccfv @ XI @ XT)))))))).
