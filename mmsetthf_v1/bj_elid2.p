...
thf(abj_elid_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccid) @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ (cwceq @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd)))))).
...
thf(cbj_elid2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccxp @ XV @ XW)) @ (cwb @ (cwcel @ XA2 @ ccid) @ (cwceq @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd)))))))).
