...
thf(aconngrv2edg_thm,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : (cwceq @ (XV @ Xe) @ (ccfv @ XG @ ccvtx))) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (! [Xe:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccconngr) @ (cwcel @ XN @ (XV @ Xe)) @ (cwbr @ cc1 @ (ccfv @ (XV @ Xe) @ cchash) @ cclt)) @ (cwrex @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccrn @ XI)))))))))))).
...
thf(cvdn0conngrumgrv2_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccconngr) @ (cwcel @ XG @ ccumgr)) @ (cwa @ (cwcel @ XN @ XV) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt))) @ (cwne @ (ccfv @ XN @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))).
