...
thf(cisuhgrop_conj,conjecture,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XE @ XX)) @ (cwb @ (cwcel @ (ccop @ XV @ XE) @ ccuhgr) @ (cwf @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)))))))).
