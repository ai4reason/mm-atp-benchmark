...
thf(ahashwrdn_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ XN)) @ (^ [Xw:$i] : (ccword @ XV))) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ XN @ ccexp)))))).
...
thf(cwrdnfi_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ XN)) @ (^ [Xw:$i] : (ccword @ XV))) @ ccfn))))).
