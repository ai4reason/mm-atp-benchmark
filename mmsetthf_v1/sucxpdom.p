...
thf(aundom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ XC @ XD @ ccdom)) @ (cwceq @ (ccin @ XB2 @ XD) @ cc0)) @ (cwbr @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ ccdom))))))).
...
thf(csucxpdom_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwbr @ cc1o @ XA2 @ ccsdm) @ (cwbr @ (ccsuc @ XA2) @ (ccxp @ XA2 @ XA2) @ ccdom)))).
