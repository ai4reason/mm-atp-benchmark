...
thf(aelpmi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ ccpm)) @ (cwss @ (ccdm @ XF) @ XB2)))))).
thf(cmbfdmssre_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ ccmbf) @ (cwss @ (ccdm @ XF) @ ccr)))).
