...
thf(cisumnn0nn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ ccc0) @ (cwceq @ (XA2 @ Xk) @ XB2))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XA2 @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ ccc0) @ (ccdm @ ccli))) => (cwi @ Xph @ (cwceq @ (ccsu @ ccn0 @ (^ [Xk:$i] : (XA2 @ Xk))) @ (cco @ XB2 @ (ccsu @ ccn @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccaddc)))))))))))).
