...
thf(asq11d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp))) => (cwi @ Xph @ (cwceq @ XA2 @ XB2))))))))))).
...
thf(asubaddeqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc))) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XD @ ccmin) @ (cco @ XC @ XB2 @ ccmin)))))))))))))).
...
thf(asqeq0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ ccc0)) => (cwi @ Xph @ (cwceq @ XA2 @ ccc0))))))).
...
thf(a_2sqn0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ XP)) => (cwi @ Xph @ (cwne @ XA2 @ ccc0))))))))))).
...
thf(abhmafibid1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccr))) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ XC @ cc2 @ ccexp) @ (cco @ XD @ cc2 @ ccexp) @ ccaddc) @ ccmul) @ (cco @ (cco @ (cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ ccmin) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccaddc) @ cc2 @ ccexp) @ ccaddc)))))))).
...
thf(a_2sqcoprm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ XP)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1))))))))))).
...
thf(amulcan2ad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul))) => (cwi @ Xph @ (cwceq @ XA2 @ XB2)))))))))))).
...
thf(asubeqxfrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin))) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XD @ ccmin)))))))))))))).
...
thf(aznsqcld_thm,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwne @ XN @ ccc0)) => (cwi @ Xph @ (cwcel @ (cco @ XN @ cc2 @ ccexp) @ ccn))))))).
...
thf(abhmafibid2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccr))) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ XC @ cc2 @ ccexp) @ (cco @ XD @ cc2 @ ccexp) @ ccaddc) @ ccmul) @ (cco @ (cco @ (cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ ccaddc) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccmin) @ cc2 @ ccexp) @ ccaddc)))))))).
...
thf(aeuclemma_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XP @ (cco @ XM @ XN @ ccmul) @ ccdvds) @ (cwo @ (cwbr @ XP @ XM @ ccdvds) @ (cwbr @ XP @ XN @ ccdvds)))))))).
thf(c_2sqmod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccn0)) => ((cwi @ Xph @ (cwcel @ XC @ ccn0)) => ((cwi @ Xph @ (cwcel @ XD @ ccn0)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XC @ XD @ ccle)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ XP)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XC @ cc2 @ ccexp) @ (cco @ XD @ cc2 @ ccexp) @ ccaddc) @ XP)) => (cwi @ Xph @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD))))))))))))))))))).
