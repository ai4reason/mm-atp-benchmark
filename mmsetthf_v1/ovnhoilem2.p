...
thf(ahoidmvle_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XL @ Xk) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XX @ ccfn))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XX @ ccr @ (XA2 @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XX @ ccr @ (XB2 @ Xx3 @ Xj @ Xa))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xk) @ (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XC @ Xx3 @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xk) @ (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XD @ Xx3 @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xk) @ (cwss @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xx3 @ Xj)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xx3 @ Xj @ Xa)) @ ccico))) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xa @ Xb))) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xa @ Xb))) @ ccico)))))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (cco @ (XA2 @ Xx3 @ Xj) @ (XB2 @ Xx3 @ Xj @ Xa) @ (ccfv @ XX @ (XL @ Xk))) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xa @ Xb)) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xa @ Xb)) @ (ccfv @ XX @ (XL @ Xk))))) @ ccsumge0) @ ccle)))))))))))))))))))))).
...
thf(covnhoilem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XX:($i > $o)] : ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwcel @ XX @ ccfn))) => ((! [Xj:$i] : (cwi @ (Xph @ Xj) @ (cwne @ XX @ cc0))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xj) @ (cwf @ XX @ ccr @ (XA2 @ Xx3 @ Xj @ Xn @ Xl))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xj) @ (cwf @ XX @ ccr @ (XB2 @ Xx3 @ Xj @ Xn @ Xl))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xl:$i] : (cwceq @ (XI @ Xj @ Xk @ Xl) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xx3 @ Xj @ Xn @ Xl)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xx3 @ Xj @ Xn @ Xl)) @ ccico))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XL @ Xj @ Xk @ Xl) @ (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xl:$i] : (cwceq @ (XM @ Xx3 @ Xj @ Xk @ Xn @ Xa @ Xb @ Xl) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : (cwa @ (cwss @ (XI @ Xj @ Xk @ Xl) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) @ (cwceq @ (ccv @ Xz) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xl:$i] : (cwceq @ (XF @ Xx3 @ Xz @ Xi @ Xj @ Xa @ Xb @ Xl) @ (ccmpt @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)) @ (^ [Xi:$i] : (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xl:$i] : XX) @ (^ [Xl:$i] : (ccfv @ (ccfv @ (ccv @ Xl) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xi))) @ cc1st))))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xl:$i] : (cwceq @ (XS @ Xx3 @ Xz @ Xi @ Xj @ Xa @ Xb @ Xl) @ (ccmpt @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)) @ (^ [Xi:$i] : (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xl:$i] : XX) @ (^ [Xl:$i] : (ccfv @ (ccfv @ (ccv @ Xl) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xi))) @ cc2nd))))))))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xl:$i] : (cwi @ (Xph @ Xj) @ (cwbr @ (cco @ (XA2 @ Xx3 @ Xj @ Xn @ Xl) @ (XB2 @ Xx3 @ Xj @ Xn @ Xl) @ (ccfv @ XX @ (XL @ Xj @ Xk @ Xl))) @ (ccfv @ (XI @ Xj @ Xk @ Xl) @ (ccfv @ XX @ ccovoln)) @ ccle)))))))))))))))))))))))))).
