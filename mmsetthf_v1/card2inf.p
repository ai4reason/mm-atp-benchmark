...
thf(asucdom2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ (ccsuc @ XA2) @ XB2 @ ccdom))))).
...
thf(ccard2inf_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwn @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XA2 @ ccen)) @ (^ [Xy1:$i] : ccon0))) @ (cwss @ ccom @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : ccon0))))))).
