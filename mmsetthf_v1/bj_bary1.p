...
thf(abj_bary1lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XS @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => (cwi @ Xph @ (cwi @ (cwa @ (cwceq @ XX @ (cco @ (cco @ XS @ XA2 @ ccmul) @ (cco @ XT @ XB2 @ ccmul) @ ccaddc)) @ (cwceq @ (cco @ XS @ XT @ ccaddc) @ cc1)) @ (cwceq @ XT @ (cco @ (cco @ XX @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv))))))))))))))))).
...
thf(abj_bary1lem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ XX @ (cco @ (cco @ (cco @ (cco @ XB2 @ XX @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv) @ XA2 @ ccmul) @ (cco @ (cco @ (cco @ XX @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv) @ XB2 @ ccmul) @ ccaddc)))))))))))).
...
thf(cbj_bary1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XS @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => (cwi @ Xph @ (cwb @ (cwa @ (cwceq @ XX @ (cco @ (cco @ XS @ XA2 @ ccmul) @ (cco @ XT @ XB2 @ ccmul) @ ccaddc)) @ (cwceq @ (cco @ XS @ XT @ ccaddc) @ cc1)) @ (cwa @ (cwceq @ XS @ (cco @ (cco @ XB2 @ XX @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv)) @ (cwceq @ XT @ (cco @ (cco @ XX @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv)))))))))))))))))).
