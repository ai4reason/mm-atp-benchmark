...
thf(cimdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccim) @ (cco @ (ccfv @ XA2 @ ccim) @ XB2 @ ccdiv)))))).
