...
thf(anndvdslegcd_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccn) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwi @ (cwa @ (cwbr @ XK @ XM @ ccdvds) @ (cwbr @ XK @ XN @ ccdvds)) @ (cwbr @ XK @ (cco @ XM @ XN @ ccgcd) @ ccle))))))).
...
thf(ccoprmgcdb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwral @ (^ [Xi:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xi) @ XA2 @ ccdvds) @ (cwbr @ (ccv @ Xi) @ XB2 @ ccdvds)) @ (cwceq @ (ccv @ Xi) @ cc1))) @ (^ [Xi:$i] : ccn)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1)))))).
