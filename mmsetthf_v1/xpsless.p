...
thf(aimasless_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwfo @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ XZ)) => ((cwceq @ Xc_le @ (ccfv @ XU @ ccple)) => (cwi @ Xph @ (cwss @ Xc_le @ (ccxp @ XB2 @ XB2))))))))))))))))).
...
thf(cxpsless_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XT @ (cco @ XR @ XS @ ccxps)) => ((cwceq @ XX @ (ccfv @ XR @ ccbs)) => ((cwceq @ XY @ (ccfv @ XS @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ XV)) => ((cwi @ Xph @ (cwcel @ XS @ XW)) => ((cwceq @ Xc_le @ (ccfv @ XT @ ccple)) => (cwi @ Xph @ (cwss @ Xc_le @ (ccxp @ (ccxp @ XX @ XY) @ (ccxp @ XX @ XY)))))))))))))))))))).
