...
thf(cresin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfun @ (cccnv @ XF)) @ (cwfo @ XA2 @ XC @ (ccres @ XF @ XA2)) @ (cwfo @ XB2 @ XD @ (ccres @ XF @ XB2))) @ (cwf1o @ (ccin @ XA2 @ XB2) @ (ccin @ XC @ XD) @ (ccres @ XF @ (ccin @ XA2 @ XB2)))))))))).
