...
thf(asylancbr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwb @ Xps @ Xph) => ((cwb @ Xch @ Xph) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
...
thf(cunixpid_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (ccuni @ (ccuni @ (ccxp @ XA2 @ XA2))) @ XA2))).
