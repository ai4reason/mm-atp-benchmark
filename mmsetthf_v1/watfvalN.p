...
thf(adf_watsN_ax,axiom,(cwceq @ ccwpointsN @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xd:$i] : (ccfv @ (ccv @ Xk) @ ccatm)) @ (^ [Xd:$i] : (ccdif @ (ccfv @ (ccv @ Xk) @ ccatm) @ (ccfv @ (ccsn @ (ccv @ Xd)) @ (ccfv @ (ccv @ Xk) @ ccpolN))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cwatfvalN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xd:$i] : (cwceq @ (XP @ Xd) @ (ccfv @ XK @ ccpolN))) => ((! [Xd:$i] : (cwceq @ (XW @ Xd) @ (ccfv @ XK @ ccwpointsN))) => (! [Xd:$i] : (cwi @ (cwcel @ XK @ (XB2 @ Xd)) @ (cwceq @ (XW @ Xd) @ (ccmpt @ (^ [Xd:$i] : XA2) @ (^ [Xd:$i] : (ccdif @ XA2 @ (ccfv @ (ccsn @ (ccv @ Xd)) @ (ccfv @ XK @ ccpolN))))))))))))))))).
