...
thf(atg1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) @ (cwss @ XA2 @ (ccuni @ XB2)))))).
...
thf(contgval_conj,conjecture,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccon0) @ (cwceq @ (ccfv @ XB2 @ cctg) @ (ccsuc @ (ccuni @ XB2)))))).
