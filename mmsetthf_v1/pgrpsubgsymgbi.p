...
thf(cpgrpsubgsymgbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ XA2 @ ccsymg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XP @ (ccfv @ XG @ ccsubg)) @ (cwa @ (cwss @ XP @ XB2) @ (cwcel @ (cco @ XG @ XP @ ccress) @ ccgrp)))))))))))).
