...
thf(cfsumsplitsndif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XX @ XA2) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : XA2))) @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (cco @ (ccsu @ (ccdif @ XA2 @ (ccsn @ XX)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsb @ XX @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccaddc))))))).
