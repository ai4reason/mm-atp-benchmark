...
thf(cbfplem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccms))) => ((cwi @ Xph @ (cwne @ XX @ cc0)) => ((cwi @ Xph @ (cwcel @ XK @ ccrp)) => ((cwi @ Xph @ (cwbr @ XK @ cc1 @ cclt)) => ((cwi @ Xph @ (cwf @ XX @ XX @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XD) @ (cco @ XK @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccmul) @ ccle)))) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3 @ Xy1) @ XX)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XG @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn @ (ccsn @ (XA2 @ Xx3 @ Xy1))) @ cc1)))) => (cwi @ Xph @ (cwbr @ XG @ (ccfv @ XG @ (ccfv @ XJ @ cclm)) @ (ccfv @ XJ @ cclm))))))))))))))))))))).
