...
thf(adf_vts_ax,axiom,(cwceq @ ccvts @ (ccmpt2 @ (^ [Xl:$i] : (^ [Xn:$i] : (cco @ ccc @ ccn @ ccmap))) @ (^ [Xl:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xl:$i] : (^ [Xn:$i] : (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ (ccv @ Xl)) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccv @ Xa) @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce) @ ccmul)))))))))).
...
thf(cvtsval_conj,conjecture,(! [Xph:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XN @ ccn0))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XX @ ccc))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwf @ ccn @ ccc @ XL))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwceq @ (ccfv @ XX @ (cco @ XL @ XN @ ccvts)) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ XL) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccv @ Xa) @ XX @ ccmul) @ ccmul) @ cce) @ ccmul)))))))))))))).
