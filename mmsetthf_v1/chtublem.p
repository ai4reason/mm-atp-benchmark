...
thf(abinom11_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ cc2 @ XN @ ccexp) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ XN @ (ccv @ Xk) @ ccbc))))))).
...
thf(cchtublem_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccmin) @ cccht) @ (cco @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc4 @ cclog) @ (cco @ XN @ cc1 @ ccmin) @ ccmul) @ ccaddc) @ ccle)))).
