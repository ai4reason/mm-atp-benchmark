...
thf(atmdmulg_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ cctmd) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XN @ (ccv @ Xx3) @ Xc_x))) @ (cco @ XJ @ XJ @ cccn)))))))))))).
...
thf(ctgpmulg_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwi @ (cwa @ (cwcel @ XG @ cctgp) @ (cwcel @ XN @ ccz)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XN @ (ccv @ Xx3) @ Xc_x))) @ (cco @ XJ @ XJ @ cccn)))))))))))).
