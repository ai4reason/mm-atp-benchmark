...
thf(csymgmatr01lem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xq:$i] : (cwceq @ XP @ (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => (! [Xq:$i] : (cwi @ (cwa @ (cwcel @ XK @ (XN @ Xq)) @ (cwcel @ XL @ (XN @ Xq))) @ (cwi @ (cwcel @ XQ @ (ccdif @ XP @ (ccrab @ (^ [Xq:$i] : (cwceq @ (ccfv @ XK @ (ccv @ Xq)) @ XL)) @ (^ [Xq:$i] : XP)))) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (ccif @ (cwceq @ (ccv @ Xk) @ XK) @ (ccif @ (cwceq @ (ccfv @ (ccv @ Xk) @ XQ) @ XL) @ (XA2 @ Xq) @ (XB2 @ Xq)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ XQ) @ (XM @ Xq))) @ (XB2 @ Xq))) @ (^ [Xk:$i] : (XN @ Xq)))))))))))))))).
