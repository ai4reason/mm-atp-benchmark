...
thf(cneitr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX) @ (cwss @ XB2 @ XA2)) @ (cwceq @ (ccfv @ XB2 @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ ccnei)) @ (cco @ (ccfv @ XB2 @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest))))))))).
