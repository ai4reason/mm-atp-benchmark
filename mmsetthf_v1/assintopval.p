...
thf(adf_assintop_ax,axiom,(cwceq @ ccassintop @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccrab @ (^ [Xo:$i] : (cwbr @ (ccv @ Xo) @ (ccv @ Xm) @ ccasslaw)) @ (^ [Xo:$i] : (ccfv @ (ccv @ Xm) @ ccclintop))))))).
...
thf(cassintopval_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xo:$i] : (cwi @ (cwcel @ XM @ (XV @ Xo)) @ (cwceq @ (ccfv @ XM @ ccassintop) @ (ccrab @ (^ [Xo:$i] : (cwbr @ (ccv @ Xo) @ XM @ ccasslaw)) @ (^ [Xo:$i] : (ccfv @ XM @ ccclintop))))))))).
