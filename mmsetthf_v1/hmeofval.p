...
thf(adf_hmeo_ax,axiom,(cwceq @ cchmeo @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : (ccrab @ (^ [Xf1:$i] : (cwcel @ (cccnv @ (ccv @ Xf1)) @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ cccn))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xj) @ (ccv @ Xk) @ cccn)))))))).
...
thf(chmeofval_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwceq @ (cco @ XJ @ XK @ cchmeo) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (cccnv @ (ccv @ Xf1)) @ (cco @ XK @ XJ @ cccn))) @ (^ [Xf1:$i] : (cco @ XJ @ XK @ cccn))))))).
