...
thf(cwrdlenccats1lenm1_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ (ccword @ XV)) @ (cwceq @ (cco @ (ccfv @ (cco @ XW @ (ccs1 @ XS) @ ccconcat) @ cchash) @ cc1 @ ccmin) @ (ccfv @ XW @ cchash))))))).
