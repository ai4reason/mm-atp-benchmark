...
thf(adf_vdwap_ax,axiom,(cwceq @ ccvdwa @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : (ccrn @ (ccmpt @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccfz)) @ (^ [Xm:$i] : (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc))))))))))).
...
thf(cvdwapfval_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccn0) @ (cwceq @ (ccfv @ XK @ ccvdwa) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : (ccrn @ (ccmpt @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)) @ (^ [Xm:$i] : (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc))))))))))).
