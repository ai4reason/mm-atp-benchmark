...
thf(cwlkRes_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ (XW @ Xf1 @ Xp))) @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks))))) => (cwcel @ (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ (XW @ Xf1 @ Xp))) @ (Xph @ Xf1 @ Xp))))) @ ccvv)))))).
