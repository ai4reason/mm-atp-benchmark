...
thf(cefper_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XK @ ccz)) @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ XK @ ccmul) @ ccaddc) @ cce) @ (ccfv @ XA2 @ cce)))))).
