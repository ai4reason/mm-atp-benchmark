...
thf(aiss2_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwss @ XA2 @ ccid) @ (cwceq @ XA2 @ (ccin @ ccid @ (ccxp @ (ccdm @ XA2) @ (ccrn @ XA2))))))).
...
thf(ccossssid_conj,conjecture,(! [XR:($i > $o)] : (cwb @ (cwss @ (cccoss @ XR) @ ccid) @ (cwss @ (cccoss @ XR) @ (ccin @ ccid @ (ccxp @ (ccdm @ (cccoss @ XR)) @ (ccrn @ (cccoss @ XR)))))))).
