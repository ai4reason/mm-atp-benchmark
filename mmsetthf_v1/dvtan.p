...
thf(adf_tan_ax,axiom,(cwceq @ cctan @ (ccmpt @ (^ [Xx3:$i] : (ccima @ (cccnv @ cccos) @ (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccfv @ (ccv @ Xx3) @ cccos) @ ccdiv))))).
...
thf(cdvtan_conj,conjecture,(cwceq @ (cco @ ccc @ cctan @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ cctan)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cccos) @ (ccneg @ cc2) @ ccexp))))).
