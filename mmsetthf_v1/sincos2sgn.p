...
thf(acos2bnd_thm,axiom,(cwa @ (cwbr @ (ccneg @ (cco @ cc7 @ cc9 @ ccdiv)) @ (ccfv @ cc2 @ cccos) @ cclt) @ (cwbr @ (ccfv @ cc2 @ cccos) @ (ccneg @ (cco @ cc1 @ cc9 @ ccdiv)) @ cclt))).
...
thf(csincos2sgn_conj,conjecture,(cwa @ (cwbr @ ccc0 @ (ccfv @ cc2 @ ccsin) @ cclt) @ (cwbr @ (ccfv @ cc2 @ cccos) @ ccc0 @ cclt))).
