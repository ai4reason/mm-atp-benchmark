...
thf(ar1ordg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccdm @ ccr1)) @ (cwi @ (cwcel @ XA2 @ XB2) @ (cwcel @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
...
thf(cr1ord3g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccr1)) @ (cwcel @ XB2 @ (ccdm @ ccr1))) @ (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
