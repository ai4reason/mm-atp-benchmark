...
thf(adf_psgn_ax,axiom,(cwceq @ ccpsgn @ (ccmpt @ (^ [Xd:$i] : ccvv) @ (^ [Xd:$i] : (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xp:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xp) @ ccid)) @ ccfn)) @ (^ [Xp:$i] : (ccfv @ (ccfv @ (ccv @ Xd) @ ccsymg) @ ccbs)))) @ (^ [Xx3:$i] : (ccio @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccfv @ (ccv @ Xd) @ ccsymg) @ (ccv @ Xw) @ ccgsu)) @ (cwceq @ (ccv @ Xs1) @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ (ccrn @ (ccfv @ (ccv @ Xd) @ ccpmtr))))))))))))).
...
thf(cpsgnfval_conj,conjecture,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XG @ Xx3 @ Xw @ Xs1 @ Xp) @ (ccfv @ (XD @ Xp) @ ccsymg)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XB2 @ Xx3 @ Xw @ Xs1) @ (ccfv @ (XG @ Xx3 @ Xw @ Xs1 @ Xp) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xw @ Xs1 @ Xp) @ (ccrab @ (^ [Xp:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xp) @ ccid)) @ ccfn)) @ (^ [Xp:$i] : (XB2 @ Xx3 @ Xw @ Xs1)))))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XT @ Xx3 @ Xs1 @ Xp) @ (ccrn @ (ccfv @ (XD @ Xp) @ ccpmtr)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xx3 @ Xw @ Xs1 @ Xp) @ (ccfv @ (XD @ Xp) @ ccpsgn)))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xx3 @ Xw @ Xs1 @ Xp) @ (ccmpt @ (^ [Xx3:$i] : (XF @ Xw @ Xs1 @ Xp)) @ (^ [Xx3:$i] : (ccio @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (cco @ (XG @ Xx3 @ Xw @ Xs1 @ Xp) @ (ccv @ Xw) @ ccgsu)) @ (cwceq @ (ccv @ Xs1) @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ (XT @ Xx3 @ Xs1 @ Xp))))))))))))))))))))))))).
