...
thf(acongrep_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccz)) @ (cwrex @ (^ [Xa:$i] : (cwbr @ XA2 @ (cco @ (ccv @ Xa) @ XN @ ccmin) @ ccdvds)) @ (^ [Xa:$i] : (cco @ ccc0 @ (cco @ XA2 @ cc1 @ ccmin) @ ccfz))))))).
...
thf(cacongrep_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccz)) @ (cwrex @ (^ [Xa:$i] : (cwo @ (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ XN @ ccmin) @ ccdvds) @ (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ (ccneg @ XN) @ ccmin) @ ccdvds))) @ (^ [Xa:$i] : (cco @ ccc0 @ XA2 @ ccfz))))))).
