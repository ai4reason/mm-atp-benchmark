...
thf(ahmopbdoptHIL_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccho) @ (cwcel @ XT @ ccbo)))).
thf(ccnop_tp,type,(ccnop : ($i > $o))).
thf(alnopcnbd_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ cclo) @ (cwb @ (cwcel @ XT @ cccop) @ (cwcel @ XT @ ccbo))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ahhcno_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XD @ (cccom @ ccno @ ccmv)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwceq @ cccop @ (cco @ XJ @ XJ @ cccn))))))).
...
thf(avmcn_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwcel @ XM @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))))).
...
thf(chmopidmchi_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ ccho) => ((cwceq @ (cccom @ XT @ XT) @ XT) => (cwcel @ (ccrn @ XT) @ ccch))))).
