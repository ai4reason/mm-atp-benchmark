...
thf(aghmeqker_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XT @ cc0g)) => ((cwceq @ XK @ (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((cwceq @ Xc_mi @ (ccfv @ XS @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XU @ XB2) @ (cwcel @ XV @ XB2)) @ (cwb @ (cwceq @ (ccfv @ XU @ XF) @ (ccfv @ XV @ XF)) @ (cwcel @ (cco @ XU @ XV @ Xc_mi) @ XK))))))))))))))))).
...
thf(ckercvrlsm_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XU @ (ccfv @ XS @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XS @ cclsm)) => ((cwceq @ Xc_0 @ (ccfv @ XT @ cc0g)) => ((cwceq @ XK @ (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm))) => ((cwi @ Xph @ (cwcel @ XD @ XU)) => ((cwi @ Xph @ (cwceq @ (ccima @ XF @ XD) @ (ccrn @ XF))) => (cwi @ Xph @ (cwceq @ (cco @ XK @ XD @ Xc_po) @ XB2))))))))))))))))))))).
