...
thf(cdecmul10add_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XM @ ccn0) => ((cwceq @ XE @ (cco @ XM @ XA2 @ ccmul)) => ((cwceq @ XF @ (cco @ XM @ XB2 @ ccmul)) => (cwceq @ (cco @ XM @ (ccdc @ XA2 @ XB2) @ ccmul) @ (cco @ (ccdc @ XE @ ccc0) @ XF @ ccaddc))))))))))))).
