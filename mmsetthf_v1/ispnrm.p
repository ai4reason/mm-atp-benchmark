...
thf(adf_pnrm_ax,axiom,(cwceq @ ccpnrm @ (ccrab @ (^ [Xj:$i] : (cwss @ (ccfv @ (ccv @ Xj) @ cccld) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : (cco @ (ccv @ Xj) @ ccn @ ccmap)) @ (^ [Xf1:$i] : (ccint @ (ccrn @ (ccv @ Xf1)))))))) @ (^ [Xj:$i] : ccnrm)))).
thf(cispnrm_conj,conjecture,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccpnrm) @ (cwa @ (cwcel @ XJ @ ccnrm) @ (cwss @ (ccfv @ XJ @ cccld) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : (cco @ XJ @ ccn @ ccmap)) @ (^ [Xf1:$i] : (ccint @ (ccrn @ (ccv @ Xf1))))))))))).
