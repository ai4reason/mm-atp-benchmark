...
thf(ameadjuni_thm,axiom,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XM @ Xx3) @ ccmea))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccdm @ (XM @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XX @ (XS @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XX @ ccom @ ccdom))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwdisj @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ (ccuni @ XX) @ (XM @ Xx3)) @ (ccfv @ (ccres @ (XM @ Xx3) @ XX) @ ccsumge0)))))))))))))).
...
thf(adisjrnmpt2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) @ (cwdisj @ (^ [Xy1:$i] : (ccrn @ (XF @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xy1))))))))))).
...
thf(ameadjiunlem_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xi:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xi) @ ccmea))) => ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccdm @ (XM @ Xi)))) => ((! [Xi:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xi)))) => ((! [Xi:$i] : (cwi @ Xph @ (cwf @ XX @ (XS @ Xi) @ XG))) => ((cwceq @ XY @ (ccrab @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XG) @ cc0)) @ (^ [Xi:$i] : XX))) => ((cwi @ Xph @ (cwdisj @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XG)))) => (! [Xi:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ (XM @ Xi) @ (ccrn @ XG)) @ ccsumge0) @ (ccfv @ (cccom @ (XM @ Xi) @ XG) @ ccsumge0)))))))))))))))))).
...
thf(adisjeq2dv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xx3)))) => (cwi @ Xph @ (cwb @ (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
