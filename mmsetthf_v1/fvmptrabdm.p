...
thf(aordir_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwo @ (cwa @ Xph @ Xps) @ Xch) @ (cwa @ (cwo @ Xph @ Xch) @ (cwo @ Xps @ Xch))))))).
...
thf(cfvmptrabdm_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XF @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : (XV @ Xy1)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccfv @ XY @ XG))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XX) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xy1))))) => ((! [Xy1:$i] : (cwi @ (cwcel @ XY @ (ccdm @ XG)) @ (cwcel @ XX @ (ccdm @ (XF @ Xy1))))) => (! [Xy1:$i] : (cwceq @ (ccfv @ XX @ (XF @ Xy1)) @ (ccrab @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (ccfv @ XY @ XG)))))))))))))))).
