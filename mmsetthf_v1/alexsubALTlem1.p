...
thf(calexsubALTlem1_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cccmp) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwceq @ XJ @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3)))))))))))).
