...
thf(avdwapun_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccn0) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XD @ ccn)) @ (cwceq @ (cco @ XA2 @ XD @ (ccfv @ (cco @ XK @ cc1 @ ccaddc) @ ccvdwa)) @ (ccun @ (ccsn @ XA2) @ (cco @ (cco @ XA2 @ XD @ ccaddc) @ XD @ (ccfv @ XK @ ccvdwa))))))))).
...
thf(cvdwlem8_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3) @ ccfn))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XW @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (cco @ cc1 @ (cco @ cc2 @ XW @ ccmul) @ ccfz) @ (XR @ Xx3) @ XF))) => ((cwcel @ XC @ ccvv) => ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XD @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (cco @ XA2 @ XD @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ (XG @ Xx3)) @ (ccsn @ XC))))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XW @ ccfz)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XW @ ccaddc) @ XF))))) => (cwi @ Xph @ (cwbr @ (ccop @ cc1 @ XK) @ XF @ ccvdwp))))))))))))))))))))).
