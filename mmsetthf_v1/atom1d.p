...
thf(achne0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwb @ (cwne @ XA2 @ cc0h) @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0v)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(ah1dn0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwne @ XA2 @ cc0v)) @ (cwne @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccort) @ ccort) @ cc0h)))).
...
thf(ach1dle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ XA2)) @ (cwss @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort) @ XA2))))).
...
thf(catom1d_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccat) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ cc0v) @ (cwceq @ XA2 @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ ccspn)))) @ (^ [Xx3:$i] : cchil))))).
