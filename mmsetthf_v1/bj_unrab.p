...
thf(cbj_unrab_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccun @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2))) @ (ccrab @ (^ [Xx3:$i] : (cwo @ (Xph @ Xx3) @ (Xps @ Xx3))) @ (^ [Xx3:$i] : (ccun @ XA2 @ XB2))))))))).
