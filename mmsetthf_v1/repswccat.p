...
thf(arepswlen_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ (cco @ XS @ XN @ ccreps) @ cchash) @ XN)))))).
...
thf(arepswsymb_thm,axiom,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0) @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XS @ XN @ ccreps)) @ XS))))))).
...
thf(crepswccat_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn0)) @ (cwceq @ (cco @ (cco @ XS @ XN @ ccreps) @ (cco @ XS @ XM @ ccreps) @ ccconcat) @ (cco @ XS @ (cco @ XN @ XM @ ccaddc) @ ccreps)))))))).
