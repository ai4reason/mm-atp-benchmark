...
thf(adf_ina_ax,axiom,(cwceq @ ccina @ (ccab @ (^ [Xx3:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cccf) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccpw @ (ccv @ Xy1)) @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))).
thf(celina_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccina) @ (cw3a @ (cwne @ XA2 @ cc0) @ (cwceq @ (ccfv @ XA2 @ cccf) @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccpw @ (ccv @ Xx3)) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : XA2)))))).
