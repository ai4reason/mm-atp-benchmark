...
thf(ann0indd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [Xet:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ ccc0) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwb @ (Xps @ Xx3) @ (Xta @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xet @ Xy1))))) => ((! [Xy1:$i] : (cwi @ Xph @ (Xch @ Xy1))) => ((! [Xy1:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ ccn0)) @ (Xth @ Xy1)) @ (Xta @ Xy1))) => (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (XA2 @ Xy1) @ ccn0)) @ (Xet @ Xy1))))))))))))))))).
...
thf(arepr0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XM @ (ccfv @ ccc0 @ ccrepr)) @ (ccif @ (cwceq @ XM @ ccc0) @ (ccsn @ cc0) @ cc0))))))))))).
...
thf(cbreprexp_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((cwi @ Xph @ (cwcel @ XZ @ ccc)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xb) @ (ccfv @ (ccv @ Xa) @ XL)) @ (cco @ XZ @ (ccv @ Xb) @ ccexp) @ ccmul))))) @ (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (cco @ XZ @ (ccv @ Xm) @ ccexp) @ ccmul))))))))))))))))).
