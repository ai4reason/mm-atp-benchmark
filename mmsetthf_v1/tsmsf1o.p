...
thf(af1imass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwa @ (cwss @ XC @ XA2) @ (cwss @ XD @ XA2))) @ (cwb @ (cwss @ (ccima @ XF @ XC) @ (ccima @ XF @ XD)) @ (cwss @ XC @ XD))))))))).
...
thf(ctsmsf1o_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctps)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf1o @ XC @ XA2 @ XH)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ cctsu) @ (cco @ XG @ (cccom @ XF @ XH) @ cctsu)))))))))))))))))).
