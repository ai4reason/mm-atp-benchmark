...
thf(aarwdm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => (cwi @ (cwcel @ XF @ XA2) @ (cwcel @ (ccfv @ XF @ ccdoma) @ XB2))))))))).
...
thf(cdmaf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => (cwf @ XA2 @ XB2 @ (ccres @ ccdoma @ XA2)))))))).
