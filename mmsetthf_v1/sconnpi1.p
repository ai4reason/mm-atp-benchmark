...
thf(aelpi1_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ XB2) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xf1)) @ XY) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xf1)) @ XY)) @ (cwceq @ XF @ (ccec @ (ccv @ Xf1) @ (ccfv @ XJ @ ccphtpc))))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))))))))))))).
...
thf(api1id_thm,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwceq @ Xc_0 @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ XY))) => (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XY @ XX)) @ (cwceq @ (ccec @ Xc_0 @ (ccfv @ XJ @ ccphtpc)) @ (ccfv @ XG @ cc0g))))))))))).
...
thf(api1grp_thm,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XY @ XX)) @ (cwcel @ XG @ ccgrp)))))))).
...
thf(apconnpi1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XP @ (cco @ XJ @ XA2 @ ccpi1)) => ((cwceq @ XQ @ (cco @ XJ @ XB2 @ ccpi1)) => ((cwceq @ XS @ (ccfv @ XP @ ccbs)) => ((cwceq @ XT @ (ccfv @ XQ @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XJ @ ccpconn) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ XP @ XQ @ ccgic)))))))))))))))).
thf(agicen_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (ccfv @ XS @ ccbs)) => (cwi @ (cwbr @ XR @ XS @ ccgic) @ (cwbr @ XB2 @ XC @ ccen))))))))).
...
thf(csconnpi1_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ ccpconn) @ (cwcel @ XY @ XX)) @ (cwb @ (cwcel @ XJ @ ccsconn) @ (cwbr @ (ccfv @ (cco @ XJ @ XY @ ccpi1) @ ccbs) @ cc1o @ ccen)))))))).
