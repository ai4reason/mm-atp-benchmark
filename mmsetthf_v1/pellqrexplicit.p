...
thf(cpellqrexplicit_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1)) @ (cwcel @ (cco @ XA2 @ (cco @ (ccfv @ XD @ ccsqrt) @ XB2 @ ccmul) @ ccaddc) @ (ccfv @ XD @ ccpell1qr))))))).
