...
thf(actbnfien_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwbr @ XX @ ccom @ ccen) @ (cwbr @ XY @ ccom @ ccen)) @ (cwa @ (cwss @ XA2 @ XX) @ (cwn @ (cwcel @ XA2 @ ccfn)))) @ (cwbr @ XA2 @ XY @ ccen)))))).
thf(cfiphp3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : ((cwi @ Xph @ (cwbr @ XA2 @ ccn @ ccen)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XD @ Xx3) @ XB2))) => (cwi @ Xph @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccv @ Xy1))) @ (^ [Xx3:$i] : XA2)) @ ccn @ ccen)) @ (^ [Xy1:$i] : XB2))))))))))).
