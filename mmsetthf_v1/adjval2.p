...
thf(cadjval2_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ (ccdm @ ccado)) @ (cwceq @ (ccfv @ XT @ ccado) @ (ccrio @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xu)) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xu:$i] : (cco @ cchil @ cchil @ ccmap))))))).
