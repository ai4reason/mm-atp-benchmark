...
thf(alhop1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XG)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XG @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ ccc0 @ (cco @ XF @ XA2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ ccc0 @ (cco @ XG @ XA2 @ cclimc))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccrn @ XG)))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XG @ ccdv))))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv))) @ XA2 @ cclimc))) => (cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xz) @ XG) @ ccdiv))) @ XA2 @ cclimc)))))))))))))))))))))).
...
thf(alimcrecl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ (ccfv @ cccnfld @ cctopn) @ cclp)))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => (cwi @ Xph @ (cwcel @ XL @ ccr)))))))))))).
...
thf(alptioo1cn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (ccfv @ XJ @ cclp))))))))))))).
...
thf(asublimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccmin))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XE @ Xx3) @ (cco @ (XF @ Xx3) @ (XD @ Xx3) @ cclimc)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XI @ Xx3) @ (cco @ (XG @ Xx3) @ (XD @ Xx3) @ cclimc)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (cco @ (XE @ Xx3) @ (XI @ Xx3) @ ccmin) @ (cco @ (XH @ Xx3) @ (XD @ Xx3) @ cclimc)))))))))))))))))))))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(alimcco_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwne @ (XR @ Xx3) @ XC))) @ (cwcel @ (XR @ Xx3) @ XB2)))) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwcel @ (XS @ Xy1) @ ccc))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XR @ Xx3))) @ (XX @ Xx3 @ Xy1) @ cclimc))))) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (XS @ Xy1))) @ XC @ cclimc))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XR @ Xx3)) @ (cwceq @ (XS @ Xy1) @ (XT @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwceq @ (XR @ Xx3) @ XC))) @ (cwceq @ (XT @ Xx3) @ XD)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XD @ (cco @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XT @ Xx3))) @ (XX @ Xx3 @ Xy1) @ cclimc))))))))))))))))))))).
thf(aadantrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xth)) @ Xch))))))).
thf(aeqeltrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XB2 @ XC)) => (cwi @ Xph @ (cwcel @ XA2 @ XC))))))))).
thf(aaddlimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccaddc))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XE @ Xx3) @ (cco @ (XF @ Xx3) @ (XD @ Xx3) @ cclimc)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XI @ Xx3) @ (cco @ (XG @ Xx3) @ (XD @ Xx3) @ cclimc)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (cco @ (XE @ Xx3) @ (XI @ Xx3) @ ccaddc) @ (cco @ (XH @ Xx3) @ (XD @ Xx3) @ cclimc)))))))))))))))))))))).
thf(cwnfc_tp,type,(cwnfc : (($i > ($i > $o)) > $o))).
thf(ccsb_tp,type,(ccsb : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aconstlimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)))) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XC @ Xx3) @ ccc))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (cco @ (XF @ Xx3) @ (XC @ Xx3) @ cclimc)))))))))))))).
thf(aidlimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (cco @ (XF @ Xx3) @ XX @ cclimc)))))))))))).
...
thf(albioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwn @ (cwcel @ XA2 @ (cco @ XA2 @ XB2 @ ccioo)))))).
...
thf(cfourierdlem61_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XF @ XA2 @ cclimc))) => ((cwceq @ XG @ (cco @ ccr @ XF @ ccdv)) => ((cwi @ Xph @ (cwceq @ (ccdm @ XG) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XE @ (cco @ XG @ XA2 @ cclimc))) => ((! [Xs1:$i] : (cwceq @ (XH @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ ccc0 @ (cco @ XB2 @ XA2 @ ccmin) @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin) @ (ccv @ Xs1) @ ccdiv))))) => ((cwceq @ XN @ (ccmpt @ (^ [Xs1:$i] : (cco @ ccc0 @ (cco @ XB2 @ XA2 @ ccmin) @ ccioo)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin)))) => ((cwceq @ XD @ (ccmpt @ (^ [Xs1:$i] : (cco @ ccc0 @ (cco @ XB2 @ XA2 @ ccmin) @ ccioo)) @ (^ [Xs1:$i] : (ccv @ Xs1)))) => (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ XE @ (cco @ (XH @ Xs1) @ ccc0 @ cclimc)))))))))))))))))))))))))).
