...
thf(c_2503lem1_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => (cwceq @ (cco @ (cco @ cc2 @ (ccdc @ cc1 @ cc8) @ ccexp) @ XN @ ccmo) @ (cco @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc8) @ cc3) @ cc2) @ XN @ ccmo))))).
