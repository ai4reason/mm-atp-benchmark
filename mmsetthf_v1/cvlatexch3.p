...
thf(acvlatexchb2_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cclc) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwne @ XP @ XR)) @ (cwb @ (cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le) @ (cwceq @ (cco @ XP @ XR @ Xc_or) @ (cco @ XQ @ XR @ Xc_or))))))))))))))).
thf(ccvlatexch3_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cclc) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwa @ (cwne @ XP @ XQ) @ (cwne @ XP @ XR))) @ (cwi @ (cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le) @ (cwceq @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XP @ XR @ Xc_or))))))))))))))).
