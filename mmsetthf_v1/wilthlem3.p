...
thf(afindcard3_thm,axiom,(! [Xph:($i > $o)] : (! [Xch:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xta @ Xy1))))) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccfn) @ (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3)))) @ (Xch @ Xy1)))) => (! [Xy1:$i] : (cwi @ (cwcel @ (XA2 @ Xy1) @ ccfn) @ (Xta @ Xy1))))))))))).
...
thf(awilthlem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XT @ (ccfv @ cccnfld @ ccmgp)) => ((cwceq @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwcel @ (cco @ XP @ cc1 @ ccmin) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xy1) @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XP @ ccprime))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XS @ XA2))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwpss @ (ccv @ Xs1) @ XS) @ (cwceq @ (cco @ (cco @ XT @ (ccres @ ccid @ (ccv @ Xs1)) @ ccgsu) @ XP @ ccmo) @ (cco @ (ccneg @ cc1) @ XP @ ccmo)))) @ (^ [Xs1:$i] : XA2)))) => (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwceq @ (cco @ (cco @ XT @ (ccres @ ccid @ XS) @ ccgsu) @ XP @ ccmo) @ (cco @ (ccneg @ cc1) @ XP @ ccmo))))))))))))))).
...
thf(agsumval3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ XZ))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwf1 @ (cco @ cc1 @ XM @ ccfz) @ XA2 @ XH)) => ((cwi @ Xph @ (cwss @ (cco @ XF @ Xc_0 @ ccsupp) @ (ccrn @ XH))) => ((cwceq @ XW @ (cco @ (cccom @ XF @ XH) @ Xc_0 @ ccsupp)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ ccgsu) @ (ccfv @ XM @ (ccseq @ Xc_pl @ (cccom @ XF @ XH) @ cc1))))))))))))))))))))))))))))).
