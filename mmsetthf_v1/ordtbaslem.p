...
thf(atsrlemax_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cwa @ (cwcel @ XR @ cctsr) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwb @ (cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ XR) @ XC @ XB2) @ XR) @ (cwo @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XA2 @ XC @ XR))))))))))).
...
thf(cordtbaslem_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XR @ cctsr) @ (cwceq @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccfi) @ (XA2 @ Xx3 @ Xy1))))))))))).
