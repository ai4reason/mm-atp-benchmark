...
thf(cintfrac2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XA2 @ ccfl)) => ((cwceq @ XF @ (cco @ XA2 @ XZ @ ccmin)) => (cwi @ (cwcel @ XA2 @ ccr) @ (cw3a @ (cwbr @ ccc0 @ XF @ ccle) @ (cwbr @ XF @ cc1 @ cclt) @ (cwceq @ XA2 @ (cco @ XZ @ XF @ ccaddc)))))))))).
