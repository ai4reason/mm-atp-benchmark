...
thf(clogblt_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp) @ (cwcel @ XY @ ccrp)) @ (cwb @ (cwbr @ XX @ XY @ cclt) @ (cwbr @ (cco @ XB2 @ XX @ cclogb) @ (cco @ XB2 @ XY @ cclogb) @ cclt))))))).
