...
thf(cxmulasslem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwa @ (cwcel @ XB2 @ ccxr) @ (cwbr @ ccc0 @ XB2 @ cclt)) @ (cwa @ (cwcel @ XC @ ccxr) @ (cwbr @ ccc0 @ XC @ cclt))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccxmu) @ XC @ ccxmu) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccxmu) @ ccxmu))))))).
