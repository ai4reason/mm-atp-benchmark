...
thf(atanval2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ cctan) @ (cco @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ XA2 @ ccmul) @ cce) @ ccmin) @ (cco @ cci @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ XA2 @ ccmul) @ cce) @ ccaddc) @ ccmul) @ ccdiv))))).
thf(ctanval3_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ cctan) @ (cco @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccmin) @ (cco @ cci @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))).
