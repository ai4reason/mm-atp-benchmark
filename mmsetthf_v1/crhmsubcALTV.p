...
thf(ccrhmsubcALTV_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccin @ XU @ cccrg)) => ((! [Xs1:$i] : (! [Xr:$i] : (cwceq @ (XJ @ Xs1 @ Xr) @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : XC)) @ (^ [Xr:$i] : (^ [Xs1:$i] : XC)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccrh))))))) => (! [Xs1:$i] : (! [Xr:$i] : (cwi @ (cwcel @ XU @ XV) @ (cwcel @ (XJ @ Xs1 @ Xr) @ (ccfv @ (ccfv @ XU @ ccringcALTV) @ ccsubc)))))))))))).
