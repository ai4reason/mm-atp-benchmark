...
thf(auntuni_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccuni @ XA2))) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))).
...
thf(adfon2lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xz)) @ (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xx3) @ XA2) @ (cwtr @ (ccv @ Xx3))) @ (cwcel @ (ccv @ Xx3) @ XA2)))) @ (cwa @ (cwtr @ XA2) @ (cwral @ (^ [Xz:$i] : (cwn @ (cwcel @ (ccv @ Xz) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XA2)))))))))).
thf(auntelirr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)) @ (cwn @ (cwcel @ XA2 @ XA2))))).
...
thf(adfon2lem2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (cwss @ (ccuni @ (ccab @ (^ [Xx3:$i] : (cw3a @ (cwss @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3) @ (Xps @ Xx3))))) @ XA2))))).
...
thf(adfon2lem1_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwtr @ (ccuni @ (ccab @ (^ [Xx3:$i] : (cw3a @ (Xph @ Xx3) @ (cwtr @ (ccv @ Xx3)) @ (Xps @ Xx3))))))))).
thf(asuctr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwtr @ XA2) @ (cwtr @ (ccsuc @ XA2))))).
...
thf(adfon2lem6_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwa @ (cwtr @ XS) @ (cwral @ (^ [Xx3:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xz))) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XS))) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ XS) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ XS))))))).
...
thf(cdfon2lem7_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xx3) @ XA2) @ (cwtr @ (ccv @ Xx3))) @ (cwcel @ (ccv @ Xx3) @ XA2)))) @ (cwi @ (cwcel @ XB2 @ XA2) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ XB2) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ XB2)))))))))).
