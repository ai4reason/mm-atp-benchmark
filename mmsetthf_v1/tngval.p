...
thf(ctngval_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ XD @ (cccom @ XN @ Xc_mi)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XG @ XV) @ (cwcel @ XN @ XW)) @ (cwceq @ XT @ (cco @ (cco @ XG @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ ccsts)))))))))))))))).
