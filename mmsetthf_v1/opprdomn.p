...
thf(aopprnzr_thm,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => (cwi @ (cwcel @ XR @ ccnzr) @ (cwcel @ XO @ ccnzr)))))).
...
thf(copprdomn_conj,conjecture,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => (cwi @ (cwcel @ XR @ ccdomn) @ (cwcel @ XO @ ccdomn)))))).
