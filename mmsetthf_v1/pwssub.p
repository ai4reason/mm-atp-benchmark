...
thf(apwsinvg_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccpws)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XM @ (ccfv @ XR @ ccminusg)) => ((cwceq @ XN @ (ccfv @ XY @ ccminusg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccgrp) @ (cwcel @ XI @ XV) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ XX @ XN) @ (cccom @ XM @ XX)))))))))))))))).
...
thf(cpwssub_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccpws)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XM @ (ccfv @ XR @ ccsg)) => ((cwceq @ Xc_mi @ (ccfv @ XY @ ccsg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccgrp) @ (cwcel @ XI @ XV)) @ (cwa @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2))) @ (cwceq @ (cco @ XF @ XG @ Xc_mi) @ (cco @ XF @ XG @ (ccof @ XM)))))))))))))))))).
