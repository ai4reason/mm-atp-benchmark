...
thf(adf_va_ax,axiom,(cwceq @ ccpv @ (cccom @ cc1st @ cc1st))).
...
thf(a_1st0_thm,axiom,(cwceq @ (ccfv @ cc0 @ cc1st) @ cc0)).
thf(cvafval_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => (cwceq @ XG @ (ccfv @ (ccfv @ XU @ cc1st) @ cc1st)))))).
