...
thf(c_1smat1_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ Xc_1 @ (ccfv @ (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmat) @ ccur)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XI @ (cco @ cc1 @ XN @ ccfz))) => (cwi @ Xph @ (cwceq @ (cco @ XI @ XI @ (ccfv @ Xc_1 @ ccsmat)) @ (ccfv @ (cco @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ XR @ ccmat) @ ccur))))))))))))).
