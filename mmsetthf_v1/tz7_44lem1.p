...
thf(amoeq3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwn @ (cwa @ Xph @ Xps)) => (cwmo @ (^ [Xx3:$i] : (cw3o @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwa @ (cwn @ (cwo @ Xph @ Xps)) @ (cwceq @ (ccv @ Xx3) @ XB2)) @ (cwa @ Xps @ (cwceq @ (ccv @ Xx3) @ XC)))))))))))))).
...
thf(ctz7_44lem1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cw3o @ (cwa @ (cwceq @ (ccv @ Xx3) @ cc0) @ (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3))) @ (cwa @ (cwn @ (cwo @ (cwceq @ (ccv @ Xx3) @ cc0) @ (cwlim @ (ccdm @ (ccv @ Xx3))))) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccfv @ (ccuni @ (ccdm @ (ccv @ Xx3))) @ (ccv @ Xx3)) @ (XH @ Xx3)))) @ (cwa @ (cwlim @ (ccdm @ (ccv @ Xx3))) @ (cwceq @ (ccv @ Xy1) @ (ccuni @ (ccrn @ (ccv @ Xx3)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwfun @ (XG @ Xx3 @ Xy1))))))))).
