...
thf(aisuvtx_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (! [Xk:$i] : (cwceq @ (XE @ Xv @ Xk) @ (ccfv @ XG @ ccedg)))) => (cwceq @ (ccfv @ XG @ ccuvtx) @ (ccrab @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xk) @ (ccv @ Xv)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xv @ Xk)))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))).
thf(cuvtxel1_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : (cwceq @ (XE @ Xk) @ (ccfv @ XG @ ccedg))) => (cwb @ (cwcel @ XN @ (ccfv @ XG @ ccuvtx)) @ (cwa @ (cwcel @ XN @ XV) @ (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xk) @ XN) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xk)))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))))).
