...
thf(aitgoval_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwss @ XS @ ccc) @ (cwceq @ (ccfv @ XS @ ccitgo) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xp:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ ccc0) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccfv @ (ccv @ Xp) @ cccoe)) @ cc1))) @ (^ [Xp:$i] : (ccfv @ XS @ ccply)))) @ (^ [Xx3:$i] : ccc)))))).
...
thf(ampaacl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwcel @ (ccfv @ XA2 @ ccmpaa) @ (ccfv @ ccq @ ccply))))).
thf(ampaaroot_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XA2 @ ccmpaa)) @ ccc0)))).
thf(aeqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))))).
thf(ampaadgr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccmpaa) @ ccdgr) @ (ccfv @ XA2 @ ccdgraa))))).
thf(ampaamn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccaa) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccfv @ XA2 @ ccmpaa) @ cccoe)) @ cc1)))).
...
thf(aelqaa_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccaa) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ (ccfv @ XA2 @ (ccv @ Xf1)) @ ccc0)) @ (^ [Xf1:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))).
thf(caaitgo_conj,conjecture,(cwceq @ ccaa @ (ccfv @ ccq @ ccitgo))).
