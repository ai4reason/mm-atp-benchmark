...
thf(arepsf_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0)) @ (cwf @ (cco @ ccc0 @ XN @ ccfzo) @ XV @ (cco @ XS @ XN @ ccreps))))))).
...
thf(crepsco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ XA2) @ (cwcel @ XN @ ccn0) @ (cwf @ XA2 @ XB2 @ XF)) @ (cwceq @ (cccom @ XF @ (cco @ XS @ XN @ ccreps)) @ (cco @ (ccfv @ XS @ XF) @ XN @ ccreps))))))))).
