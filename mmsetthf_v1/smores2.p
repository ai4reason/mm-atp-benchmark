...
thf(adfsmo2_thm,axiom,(! [XF:($i > $o)] : (cwb @ (cwsmo @ XF) @ (cw3a @ (cwf @ (ccdm @ XF) @ ccon0 @ XF) @ (cword @ (ccdm @ XF)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdm @ XF))))))).
...
thf(asmodm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwsmo @ XA2) @ (cword @ (ccdm @ XA2))))).
...
thf(csmores2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwsmo @ XF) @ (cword @ XA2)) @ (cwsmo @ (ccres @ XF @ XA2)))))).
