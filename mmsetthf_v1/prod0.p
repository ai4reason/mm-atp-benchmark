...
thf(aprodfclim1_thm,axiom,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XM @ ccz) @ (cwbr @ (ccseq @ ccmul @ (ccxp @ XZ @ (ccsn @ cc1)) @ XM) @ cc1 @ ccli)))))).
...
thf(cprod0_conj,conjecture,(! [XA2:($i > ($i > $o))] : (cwceq @ (ccprod @ (^ [Xk:$i] : cc0) @ (^ [Xk:$i] : (XA2 @ Xk))) @ cc1))).
