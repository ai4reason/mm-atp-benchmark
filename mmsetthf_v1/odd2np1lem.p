...
thf(codd2np1lem_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwo @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ XN)) @ (^ [Xn:$i] : ccz)) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (cco @ (ccv @ Xk) @ cc2 @ ccmul) @ XN)) @ (^ [Xk:$i] : ccz)))))).
