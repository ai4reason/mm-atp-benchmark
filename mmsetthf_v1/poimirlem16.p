...
thf(axpundir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccxp @ (ccun @ XA2 @ XB2) @ XC) @ (ccun @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC))))))).
thf(aun23_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccun @ (ccun @ XA2 @ XB2) @ XC) @ (ccun @ (ccun @ XA2 @ XC) @ XB2)))))).
...
thf(cpoimirlem16_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccrab @ (^ [Xt:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xt) @ cc2nd) @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ (cco @ ccc0 @ XN @ ccfz))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ XF)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XT @ (XS @ Xf1)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz))) @ (cwrex @ (^ [Xp:$i] : (cwne @ (ccfv @ (ccv @ Xn) @ (ccv @ Xp)) @ (XK @ Xy1))) @ (^ [Xp:$i] : (ccrn @ XF))))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccfv @ XT @ cc2nd) @ ccc0))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ XF @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (cco @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccfv @ XT @ cc1st) @ cc1st)) @ (ccif @ (cwceq @ (ccv @ Xn) @ (ccfv @ cc1 @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd))) @ cc1 @ ccc0) @ ccaddc))) @ (ccun @ (ccxp @ (ccima @ (cccom @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ XN) @ cc1 @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc))))) @ (cco @ cc1 @ (ccv @ Xy1) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (cccom @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ XN) @ cc1 @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc))))) @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))))))))))))))).
