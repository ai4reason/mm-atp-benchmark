...
thf(acantnfp1lem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ XG @ XS)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XA2)) => ((cwi @ Xph @ (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : (cwceq @ (XF @ Xt) @ (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ (cwceq @ (ccv @ Xt) @ XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => ((cwi @ Xph @ (cwcel @ cc0 @ XY)) => ((! [Xt:$i] : (cwceq @ (XO @ Xt) @ (ccoi @ (cco @ (XF @ Xt) @ cc0 @ ccsupp) @ ccep))) => (! [Xt:$i] : (cwi @ Xph @ (cwceq @ (ccdm @ (XO @ Xt)) @ (ccsuc @ (ccuni @ (ccdm @ (XO @ Xt))))))))))))))))))))))))))).
...
thf(asuppss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xk) @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccdif @ (XA2 @ Xk) @ XW))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ XZ))) => (cwi @ Xph @ (cwss @ (cco @ XF @ XZ @ ccsupp) @ XW))))))))))).
...
thf(aisores3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwss @ XK @ XA2) @ (cwceq @ XX @ (ccima @ XH @ XK))) @ (cwiso @ XK @ XX @ XR @ XS @ (ccres @ XH @ XK))))))))))).
...
thf(aordsucelsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cword @ XB2) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwcel @ (ccsuc @ XA2) @ (ccsuc @ XB2))))))).
