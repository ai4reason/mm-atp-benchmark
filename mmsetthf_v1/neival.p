...
thf(aneifval_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XJ @ ccnei) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX))))))))))).
...
thf(cneival_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwceq @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : (cwa @ (cwss @ XS @ (ccv @ Xg1)) @ (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX)))))))))).
