...
thf(alhop2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XG)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XG @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ ccc0 @ (cco @ XF @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ ccc0 @ (cco @ XG @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccrn @ XG)))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XG @ ccdv))))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv))) @ XB2 @ cclimc))) => (cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xz) @ XG) @ ccdiv))) @ XB2 @ cclimc)))))))))))))))))))))).
...
thf(alptioo2cn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (ccfv @ XJ @ cclp))))))))))))).
...
thf(aubioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwn @ (cwcel @ XB2 @ (cco @ XA2 @ XB2 @ ccioo)))))).
...
thf(cfourierdlem60_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XF @ XB2 @ cclimc))) => ((cwceq @ XG @ (cco @ ccr @ XF @ ccdv)) => ((cwi @ Xph @ (cwceq @ (ccdm @ XG) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XE @ (cco @ XG @ XB2 @ cclimc))) => ((! [Xs1:$i] : (cwceq @ (XH @ Xs1) @ (ccmpt @ (^ [Xs1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XB2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin) @ (ccv @ Xs1) @ ccdiv))))) => ((cwceq @ XN @ (ccmpt @ (^ [Xs1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (cco @ XB2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin)))) => ((cwceq @ XD @ (ccmpt @ (^ [Xs1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ ccioo)) @ (^ [Xs1:$i] : (ccv @ Xs1)))) => (! [Xs1:$i] : (cwi @ Xph @ (cwcel @ XE @ (cco @ (XH @ Xs1) @ ccc0 @ cclimc)))))))))))))))))))))))))).
