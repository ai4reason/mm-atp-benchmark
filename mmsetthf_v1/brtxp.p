...
thf(cbrtxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => (cwb @ (cwbr @ XX @ (ccop @ XY @ XZ) @ (cctxp @ XA2 @ XB2)) @ (cwa @ (cwbr @ XX @ XY @ XA2) @ (cwbr @ XX @ XZ @ XB2)))))))))))).
