...
thf(adf_ch_ax,axiom,(cwceq @ ccch @ (ccrab @ (^ [Xh:$i] : (cwss @ (ccima @ cchli @ (cco @ (ccv @ Xh) @ ccn @ ccmap)) @ (ccv @ Xh))) @ (^ [Xh:$i] : ccsh)))).
thf(cisch_conj,conjecture,(! [XH:($i > $o)] : (cwb @ (cwcel @ XH @ ccch) @ (cwa @ (cwcel @ XH @ ccsh) @ (cwss @ (ccima @ cchli @ (cco @ XH @ ccn @ ccmap)) @ XH))))).
