...
thf(ceuotd_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccvv)) => ((cwi @ Xph @ (cwcel @ XC @ ccvv)) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwi @ Xph @ (cwb @ (Xps @ Xx3 @ Xa @ Xb @ Xc) @ (cw3a @ (cwceq @ (ccv @ Xa) @ XA2) @ (cwceq @ (ccv @ Xb) @ XB2) @ (cwceq @ (ccv @ Xc) @ XC)))))))) => (cwi @ Xph @ (cweu @ (^ [Xx3:$i] : (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwex @ (^ [Xc:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccotp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc))) @ (Xps @ Xx3 @ Xa @ Xb @ Xc))))))))))))))))))))).
