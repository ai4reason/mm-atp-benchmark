...
thf(ac1liplem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccc @ ccr @ ccpm))) => ((cwi @ Xph @ (cwcel @ (ccres @ (cco @ ccr @ XF @ ccdv) @ (cco @ XA2 @ XB2 @ ccicc)) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccicc)) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XK @ Xx3 @ Xy1) @ (ccsup @ (ccima @ ccabs @ (ccima @ (cco @ ccr @ XF @ ccdv) @ (cco @ XA2 @ XB2 @ ccicc))) @ ccr @ cclt)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XK @ Xx3 @ Xy1) @ ccr) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ (XK @ Xx3 @ Xy1) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle))) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))))))))))))))))))).
