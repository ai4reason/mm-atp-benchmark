...
thf(annindf_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ cc1) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xta @ Xy1))))) => ((! [Xy1:$i] : (Xps @ Xy1)) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccn) @ (cwi @ (Xch @ Xy1) @ (Xth @ Xy1)))) => (! [Xy1:$i] : (cwi @ (cwcel @ (XA2 @ Xy1) @ ccn) @ (Xta @ Xy1))))))))))))))))).
...
thf(cnn0min_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : ((! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ ccc0) @ (cwb @ (Xps @ Xn) @ Xch))) => ((! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xm)) @ (cwb @ (Xps @ Xn) @ (Xth @ Xm))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc)) @ (cwb @ (Xps @ Xn) @ (Xta @ Xm))))) => ((cwi @ Xph @ (cwn @ Xch)) => ((cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (Xps @ Xn)) @ (^ [Xn:$i] : ccn))) => (cwi @ Xph @ (cwrex @ (^ [Xm:$i] : (cwa @ (cwn @ (Xth @ Xm)) @ (Xta @ Xm))) @ (^ [Xm:$i] : ccn0)))))))))))))).
