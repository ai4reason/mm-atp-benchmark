...
thf(aelmapsnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwfn @ XF @ (ccsn @ XA2))) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XF) @ XB2)) => (cwi @ Xph @ (cwcel @ XF @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap)))))))))))).
...
thf(afvmap_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ ccmap))) => ((cwi @ Xph @ (cwcel @ XC @ XB2)) => (cwi @ Xph @ (cwcel @ (ccfv @ XC @ XF) @ XA2)))))))))))))).
...
thf(afsneqrn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwceq @ XB2 @ (ccsn @ XA2)) => ((cwi @ Xph @ (cwfn @ XF @ XB2)) => ((cwi @ Xph @ (cwfn @ XG @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XF @ XG) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccrn @ XG))))))))))))))).
...
thf(cssmapsn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xf1:$i] : (XD @ Xf1))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xf1)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwss @ XC @ (cco @ (XB2 @ Xf1) @ (ccsn @ XA2) @ ccmap)))) => ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (cciun @ (^ [Xf1:$i] : XC) @ (^ [Xf1:$i] : (ccrn @ (ccv @ Xf1)))))) => (! [Xf1:$i] : (cwi @ Xph @ (cwceq @ XC @ (cco @ (XD @ Xf1) @ (ccsn @ XA2) @ ccmap))))))))))))))).
