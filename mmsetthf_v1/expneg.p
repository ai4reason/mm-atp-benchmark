...
thf(aexpval_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ XN @ ccexp) @ (ccif @ (cwceq @ XN @ ccc0) @ cc1 @ (ccif @ (cwbr @ ccc0 @ XN @ cclt) @ (ccfv @ XN @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ XA2)) @ cc1)) @ (cco @ cc1 @ (ccfv @ (ccneg @ XN) @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ XA2)) @ cc1)) @ ccdiv)))))))).
...
thf(cexpneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ (ccneg @ XN) @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccdiv)))))).
