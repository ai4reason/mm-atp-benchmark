...
thf(cressds_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ XD @ (ccfv @ XH @ ccds))))))))))).
