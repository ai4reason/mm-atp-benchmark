...
thf(cwlklenvclwlk_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) @ (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ ccle)) @ (cwi @ (cwcel @ (ccop @ XF @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat)) @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ XF @ cchash) @ (ccfv @ XW @ cchash)))))))).
