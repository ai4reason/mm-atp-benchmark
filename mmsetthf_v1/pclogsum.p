...
thf(apcprod_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ XN))))))).
thf(cpclogsum_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwceq @ (ccsu @ (ccin @ (cco @ cc1 @ XA2 @ ccfz) @ ccprime) @ (^ [Xp:$i] : (cco @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ (ccfv @ (ccv @ Xp) @ cclog) @ ccmul))) @ (ccfv @ XA2 @ cclog))))).
