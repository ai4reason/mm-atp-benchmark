...
thf(aclimi0_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XB2 @ Xj @ Xk))))) => ((cwi @ Xph @ (cwbr @ XF @ ccc0 @ ccli)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (XB2 @ Xj @ Xk) @ ccabs) @ XC @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))))))))))))))).
...
thf(aabelthlem7_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ ccn0 @ ccc @ XA2))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XM @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ ccc0 @ XM @ ccle))) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ cc1 @ (ccv @ Xz) @ ccmin) @ ccabs) @ (cco @ XM @ (cco @ cc1 @ (ccfv @ (ccv @ Xz) @ ccabs) @ ccmin) @ ccmul) @ ccle)) @ (^ [Xz:$i] : ccc)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xz @ Xk @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (XS @ Xz)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul)))))))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccseq @ ccaddc @ XA2 @ ccc0) @ ccc0 @ ccli))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XX @ (ccdif @ (XS @ Xz) @ (ccsn @ cc1))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XR @ ccrp))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XN @ Xx3 @ Xz) @ ccn0)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccseq @ ccaddc @ XA2 @ ccc0)) @ ccabs) @ XR @ cclt)) @ (^ [Xk:$i] : (ccfv @ (XN @ Xx3 @ Xz) @ ccuz)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccfv @ (cco @ cc1 @ XX @ ccmin) @ ccabs) @ (cco @ XR @ (cco @ (ccsu @ (cco @ ccc0 @ (cco @ (XN @ Xx3 @ Xz) @ cc1 @ ccmin) @ ccfz) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccseq @ ccaddc @ XA2 @ ccc0)) @ ccabs))) @ cc1 @ ccaddc) @ ccdiv) @ cclt)))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccfv @ (ccfv @ XX @ (XF @ Xx3 @ Xz @ Xk @ Xn)) @ ccabs) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XR @ ccmul) @ cclt))))))))))))))))))))))))))).
