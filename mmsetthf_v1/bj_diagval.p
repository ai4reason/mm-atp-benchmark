...
thf(adf_bj_diag_ax,axiom,(cwceq @ ccdiag2 @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccin @ ccid @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))))))).
thf(cbj_diagval_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (ccfv @ XA2 @ ccdiag2) @ (ccin @ ccid @ (ccxp @ XA2 @ XA2))))))).
