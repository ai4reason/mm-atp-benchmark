...
thf(clspval_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ XV @ (ccfv @ (XW @ Xt) @ ccbs))) => ((! [Xt:$i] : (cwceq @ XS @ (ccfv @ (XW @ Xt) @ cclss))) => ((! [Xt:$i] : (cwceq @ (XN @ Xt) @ (ccfv @ (XW @ Xt) @ cclspn))) => (! [Xt:$i] : (cwi @ (cwa @ (cwcel @ (XW @ Xt) @ cclmod) @ (cwss @ XU @ XV)) @ (cwceq @ (ccfv @ XU @ (XN @ Xt)) @ (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ XU @ (ccv @ Xt))) @ (^ [Xt:$i] : XS))))))))))))))).
