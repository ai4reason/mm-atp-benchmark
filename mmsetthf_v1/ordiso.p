...
thf(aisoid_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwiso @ XA2 @ XA2 @ XR @ XR @ (ccres @ ccid @ XA2))))).
...
thf(aordiso2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwiso @ XA2 @ XB2 @ ccep @ ccep @ XF) @ (cword @ XA2) @ (cword @ XB2)) @ (cwceq @ XA2 @ XB2)))))).
thf(cordiso_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwex @ (^ [Xf1:$i] : (cwiso @ XA2 @ XB2 @ ccep @ ccep @ (ccv @ Xf1))))))))).
