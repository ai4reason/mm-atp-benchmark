...
thf(aennum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwb @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd))))))).
thf(ccomu_tp,type,(ccomu : ($i > $o))).
thf(axpnum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd))) @ (cwcel @ (ccxp @ XA2 @ XB2) @ (ccdm @ cccrd)))))).
...
thf(cqnnen_conj,conjecture,(cwbr @ ccq @ ccn @ ccen)).
