...
thf(adf_odz_ax,axiom,(cwceq @ ccodz @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccgcd) @ cc1)) @ (^ [Xx3:$i] : ccz))) @ (^ [Xx3:$i] : (ccinf @ (ccrab @ (^ [Xm:$i] : (cwbr @ (ccv @ Xn) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xm) @ ccexp) @ cc1 @ ccmin) @ ccdvds)) @ (^ [Xm:$i] : ccn)) @ ccr @ cclt))))))).
...
thf(codzval_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwceq @ (cco @ XA2 @ XN @ ccgcd) @ cc1)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ cc1 @ ccmin) @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
