...
thf(careacirclem2_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle)) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
