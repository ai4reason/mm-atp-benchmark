...
thf(crestlly_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xj)))) @ (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ ccrest) @ XA2)))) => ((cwi @ Xph @ (cwss @ XA2 @ cctop)) => (cwi @ Xph @ (cwss @ XA2 @ (cclly @ XA2)))))))).
