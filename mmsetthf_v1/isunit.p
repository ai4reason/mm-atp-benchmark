...
thf(adf_unit_ax,axiom,(cwceq @ ccui @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccima @ (cccnv @ (ccin @ (ccfv @ (ccv @ Xw) @ ccdsr) @ (ccfv @ (ccfv @ (ccv @ Xw) @ ccoppr) @ ccdsr))) @ (ccsn @ (ccfv @ (ccv @ Xw) @ ccur))))))).
...
thf(cisunit_conj,conjecture,(! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => ((cwceq @ XS @ (ccfv @ XR @ ccoppr)) => ((cwceq @ XE @ (ccfv @ XS @ ccdsr)) => (cwb @ (cwcel @ XX @ XU) @ (cwa @ (cwbr @ XX @ Xc_1 @ Xc_pa) @ (cwbr @ XX @ Xc_1 @ XE)))))))))))))))).
