...
thf(awwlktovf_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xw @ Xn) @ (ccrab @ (^ [Xw:$i] : (cw3a @ (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ cc2) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xw)) @ XP) @ (cwcel @ (ccpr @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ cc1 @ (ccv @ Xw))) @ (XX @ Xt)))) @ (^ [Xw:$i] : (ccword @ XV))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xw @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwcel @ (ccpr @ XP @ (ccv @ Xn)) @ (XX @ Xt))) @ (^ [Xn:$i] : XV)))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xw @ Xt @ Xn) @ (ccmpt @ (^ [Xt:$i] : (XD @ Xw @ Xn)) @ (^ [Xt:$i] : (ccfv @ cc1 @ (ccv @ Xt)))))))) => (! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwf @ (XD @ Xw @ Xn) @ (XR @ Xw @ Xn) @ (XF @ Xw @ Xt @ Xn))))))))))))))).
