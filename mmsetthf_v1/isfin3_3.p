...
thf(cisfin3_3_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xf1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xf1)) @ (cwb @ (cwcel @ XA2 @ ccfin3) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : ccom)) @ (cwcel @ (ccint @ (ccrn @ (ccv @ Xf1))) @ (ccrn @ (ccv @ Xf1))))) @ (^ [Xf1:$i] : (cco @ (ccpw @ XA2) @ ccom @ ccmap))))))))).
