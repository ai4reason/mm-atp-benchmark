...
thf(alesub1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin) @ ccle))))))).
...
thf(ciccshftl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ (cco @ XA2 @ XR @ ccmin) @ XC) => ((cwceq @ (cco @ XB2 @ XR @ ccmin) @ XD) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XX @ ccr) @ (cwcel @ XR @ ccr))) @ (cwb @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (cco @ XX @ XR @ ccmin) @ (cco @ XC @ XD @ ccicc))))))))))))).
