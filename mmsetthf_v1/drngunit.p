...
thf(cdrngunit_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwcel @ XR @ ccdr) @ (cwb @ (cwcel @ XX @ XU) @ (cwa @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0))))))))))))).
