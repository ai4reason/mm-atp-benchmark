...
thf(cdivalglem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwcel @ XX @ (cco @ ccc0 @ (cco @ XA2 @ cc1 @ ccmin) @ ccfz)) => ((cwcel @ XK @ ccz) => (cwi @ (cwne @ XK @ ccc0) @ (cwn @ (cwcel @ (cco @ XX @ (cco @ XK @ XA2 @ ccmul) @ ccaddc) @ (cco @ ccc0 @ (cco @ XA2 @ cc1 @ ccmin) @ ccfz))))))))))).
