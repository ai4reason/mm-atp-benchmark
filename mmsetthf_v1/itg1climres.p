...
thf(aclimfsum_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwbr @ (XF @ Xk) @ (XB2 @ Xk) @ ccli))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XH @ Xk) @ (XW @ Xk @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xk) @ XA2) @ (cwcel @ (ccv @ Xn) @ XZ))) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (XF @ Xk)) @ ccc)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (XH @ Xk)) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xn) @ (XF @ Xk)))))))) => (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (XH @ Xk) @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccli))))))))))))))))))).
...
thf(avolsup_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwa @ (cwf @ ccn @ (ccdm @ ccvol) @ XF) @ (cwral @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF))) @ (^ [Xn:$i] : ccn))) @ (cwceq @ (ccfv @ (ccuni @ (ccrn @ XF)) @ ccvol) @ (ccsup @ (ccima @ ccvol @ (ccrn @ XF)) @ ccxr @ cclt))))).
