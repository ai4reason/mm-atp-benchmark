...
thf(aofcfn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwfn @ XF @ XA2)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XC @ XW)) => (cwi @ Xph @ (cwfn @ (cco @ XF @ XC @ (ccofc @ XR)) @ XA2))))))))))))).
...
thf(ccoinflipspace_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((cwne @ XH @ XT) => ((cwceq @ XP @ (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((cwceq @ XX @ (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => (cwceq @ (ccdm @ XP) @ (ccpw @ (ccpr @ XH @ XT))))))))))))).
