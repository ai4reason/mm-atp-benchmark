...
thf(crestabs_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ XV) @ (cwss @ XS @ XT) @ (cwcel @ XT @ XW)) @ (cwceq @ (cco @ (cco @ XJ @ XT @ ccrest) @ XS @ ccrest) @ (cco @ XJ @ XS @ ccrest))))))))).
