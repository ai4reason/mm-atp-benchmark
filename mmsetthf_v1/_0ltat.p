...
thf(c_0ltat_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cwa @ (cwcel @ XK @ ccops) @ (cwcel @ XP @ XA2)) @ (cwbr @ Xc_0 @ XP @ Xc_lt))))))))))).
