...
thf(csbcies_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xw:$i] : (! [XA2:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XW:($i > $o)] : ((! [Xa:$i] : (cwceq @ (XA2 @ Xa) @ (ccfv @ XW @ XE))) => ((! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xa) @ (XA2 @ Xa)) @ (cwb @ Xph @ (Xps @ Xa)))) => (cwi @ (cwceq @ (ccv @ Xw) @ XW) @ (cwb @ (cwsbc @ (^ [Xa:$i] : (Xps @ Xa)) @ (ccfv @ (ccv @ Xw) @ XE)) @ Xph))))))))))).
