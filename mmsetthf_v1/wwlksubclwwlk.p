...
thf(cwwlksubclwwlk_conj,conjecture,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) @ (cwi @ (cwcel @ XX @ (cco @ XN @ XG @ ccclwwlkn)) @ (cwcel @ (cco @ XX @ (ccop @ ccc0 @ XM) @ ccsubstr) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccwwlksn))))))))).
