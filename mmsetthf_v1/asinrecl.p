...
thf(aasinrebnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc)) @ (cwcel @ (ccfv @ XA2 @ ccasin) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc))))).
thf(casinrecl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc)) @ (cwcel @ (ccfv @ XA2 @ ccasin) @ ccr)))).
