...
thf(adf_clat_ax,axiom,(cwceq @ cccla @ (ccrab @ (^ [Xp:$i] : (cwa @ (cwceq @ (ccdm @ (ccfv @ (ccv @ Xp) @ cclub)) @ (ccpw @ (ccfv @ (ccv @ Xp) @ ccbs))) @ (cwceq @ (ccdm @ (ccfv @ (ccv @ Xp) @ ccglb)) @ (ccpw @ (ccfv @ (ccv @ Xp) @ ccbs))))) @ (^ [Xp:$i] : ccpo)))).
thf(cisclat_conj,conjecture,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XU @ (ccfv @ XK @ cclub)) => ((cwceq @ XG @ (ccfv @ XK @ ccglb)) => (cwb @ (cwcel @ XK @ cccla) @ (cwa @ (cwcel @ XK @ ccpo) @ (cwa @ (cwceq @ (ccdm @ XU) @ (ccpw @ XB2)) @ (cwceq @ (ccdm @ XG) @ (ccpw @ XB2))))))))))))).
