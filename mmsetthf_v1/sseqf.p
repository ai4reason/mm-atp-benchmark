...
thf(asseqmw_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwcel @ XM @ (ccword @ XS))) => ((cwceq @ XW @ (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XW @ XS @ XF)) => (cwi @ Xph @ (cwcel @ XM @ XW)))))))))))).
...
thf(accatws1n0_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ cc0)))))).
...
thf(csseqf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwcel @ XM @ (ccword @ XS))) => ((cwceq @ XW @ (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XW @ XS @ XF)) => (cwi @ Xph @ (cwf @ ccn0 @ XS @ (cco @ XM @ XF @ ccsseq))))))))))))).
