...
thf(aancrb_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwi @ Xph @ Xps) @ (cwi @ Xph @ (cwa @ Xps @ Xph)))))).
...
thf(crababg_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwb @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))))) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))))))).
