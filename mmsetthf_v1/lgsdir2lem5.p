...
thf(algsdir2lem1_thm,axiom,(cwa @ (cwa @ (cwceq @ (cco @ cc1 @ cc8 @ ccmo) @ cc1) @ (cwceq @ (cco @ (ccneg @ cc1) @ cc8 @ ccmo) @ cc7)) @ (cwa @ (cwceq @ (cco @ cc3 @ cc8 @ ccmo) @ cc3) @ (cwceq @ (cco @ (ccneg @ cc3) @ cc8 @ ccmo) @ cc5)))).
...
thf(clgsdir2lem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc3 @ cc5)) @ (cwcel @ (cco @ XB2 @ cc8 @ ccmo) @ (ccpr @ cc3 @ cc5)))) @ (cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))))).
