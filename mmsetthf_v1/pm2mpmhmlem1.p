...
thf(cpm2mpmhmlem1_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xl:$i] : (cwceq @ (XP @ Xl) @ (ccfv @ XR @ ccpl1))) => ((! [Xl:$i] : (cwceq @ XC @ (cco @ XN @ (XP @ Xl) @ ccmat))) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((! [Xl:$i] : (cwceq @ Xc_as @ (ccfv @ (XQ @ Xl) @ ccvsca))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_ex @ Xk) @ (ccfv @ (ccfv @ (XQ @ Xl) @ ccmgp) @ ccmg)))) => ((! [Xk:$i] : (cwceq @ (XX @ Xk) @ (ccfv @ XA2 @ ccv1))) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((! [Xl:$i] : (cwceq @ (XQ @ Xl) @ (ccfv @ XA2 @ ccpl1))) => ((! [Xl:$i] : (cwceq @ (XL @ Xl) @ (ccfv @ (XQ @ Xl) @ ccbs))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XT @ Xk @ Xl) @ (cco @ XN @ XR @ ccpm2mp)))) => (! [Xk:$i] : (! [Xl:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg)) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2))) @ (cwbr @ (ccmpt @ (^ [Xl:$i] : ccn0) @ (^ [Xl:$i] : (cco @ (cco @ XA2 @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ (ccv @ Xl) @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccdecpmat) @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xl) @ (ccv @ Xk) @ ccmin) @ ccdecpmat) @ (ccfv @ XA2 @ ccmulr)))) @ ccgsu) @ (cco @ (ccv @ Xl) @ (XX @ Xk) @ (Xc_ex @ Xk)) @ Xc_as))) @ (ccfv @ (XQ @ Xl) @ cc0g) @ ccfsupp))))))))))))))))))))))))))))).
