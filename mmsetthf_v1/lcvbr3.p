...
thf(clcvbr3_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((! [Xs1:$i] : (cwceq @ (XC @ Xs1) @ (ccfv @ XW @ cclcv))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XW @ (XX @ Xs1)))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XT @ XS))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XU @ XS))) => (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwb @ (cwbr @ XT @ XU @ (XC @ Xs1)) @ (cwa @ (cwpss @ XT @ XU) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwa @ (cwss @ XT @ (ccv @ Xs1)) @ (cwss @ (ccv @ Xs1) @ XU)) @ (cwo @ (cwceq @ (ccv @ Xs1) @ XT) @ (cwceq @ (ccv @ Xs1) @ XU)))) @ (^ [Xs1:$i] : XS))))))))))))))))))).
