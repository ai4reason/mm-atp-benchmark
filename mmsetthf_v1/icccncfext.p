...
thf(aunopn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ XJ) @ (cwcel @ XB2 @ XJ)) @ (cwcel @ (ccun @ XA2 @ XB2) @ XJ)))))).
...
thf(adifreicc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccdif @ ccr @ (cco @ XA2 @ XB2 @ ccicc)) @ (ccun @ (cco @ ccmnf @ XA2 @ ccioo) @ (cco @ XB2 @ ccpnf @ ccioo))))))).
...
thf(aifeq123d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XD)) => (cwi @ Xph @ (cwceq @ (ccif @ Xps @ XA2 @ XC) @ (ccif @ Xch @ XB2 @ XD)))))))))))))).
...
thf(aunima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwss @ XB2 @ XA2) @ (cwss @ XC @ XA2)) @ (cwceq @ (ccima @ XF @ (ccun @ XB2 @ XC)) @ (ccun @ (ccima @ XF @ XB2) @ (ccima @ XF @ XC))))))))).
...
thf(a_3adantll2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xta) => (cwi @ (cwa @ (cwa @ (cw3a @ Xph @ Xet @ Xps) @ Xch) @ Xth) @ Xta))))))))).
