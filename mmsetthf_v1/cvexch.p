...
thf(acvexchi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv))))))).
thf(aifchhv_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XA2 @ ccch) @ XA2 @ cchil) @ ccch))).
thf(ccvexch_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) @ (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
