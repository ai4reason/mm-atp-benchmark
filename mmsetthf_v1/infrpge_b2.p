...
thf(cinfrpge_b2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwne @ XA2 @ cc0))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XB2 @ Xx3) @ ccrp))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (cco @ (ccinf @ XA2 @ ccxr @ cclt) @ (XB2 @ Xx3) @ ccxad) @ ccle)) @ (^ [Xy1:$i] : XA2))))))))))))).
