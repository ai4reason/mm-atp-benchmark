...
thf(acosmpi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ XA2 @ ccpi @ ccmin) @ cccos) @ (ccneg @ (ccfv @ XA2 @ cccos)))))).
...
thf(asinmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cccos) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccmin) @ cc2 @ ccdiv)))))).
...
thf(acosppi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ XA2 @ ccpi @ ccaddc) @ cccos) @ (ccneg @ (ccfv @ XA2 @ cccos)))))).
...
thf(cptolemy_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwcel @ XD @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccaddc) @ ccpi)) @ (cwceq @ (cco @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) @ (cco @ (ccfv @ XC @ ccsin) @ (ccfv @ XD @ ccsin) @ ccmul) @ ccaddc) @ (cco @ (ccfv @ (cco @ XB2 @ XC @ ccaddc) @ ccsin) @ (ccfv @ (cco @ XA2 @ XC @ ccaddc) @ ccsin) @ ccmul)))))))).
