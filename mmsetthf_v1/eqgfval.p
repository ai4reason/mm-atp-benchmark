...
thf(adf_eqg_ax,axiom,(cwceq @ ccqg @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xr) @ ccbs)) @ (cwcel @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xr) @ ccminusg)) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xr) @ ccplusg)) @ (ccv @ Xi))))))))))).
...
thf(ceqgfval_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XG @ ccminusg)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XR @ Xx3 @ Xy1) @ (cco @ XG @ XS @ ccqg)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XG @ (XV @ Xx3 @ Xy1)) @ (cwss @ XS @ XX)) @ (cwceq @ (XR @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XX) @ (cwcel @ (cco @ (ccfv @ (ccv @ Xx3) @ XN) @ (ccv @ Xy1) @ Xc_pl) @ XS))))))))))))))))))))).
