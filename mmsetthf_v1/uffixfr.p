...
thf(auffix_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwcel @ (ccsn @ (ccsn @ XA2)) @ (ccfv @ XX @ ccfbas)) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XX))) @ (cco @ XX @ (ccsn @ (ccsn @ XA2)) @ ccfg)))))))).
...
thf(cuffixfr_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwb @ (cwcel @ XA2 @ (ccint @ XF)) @ (cwceq @ XF @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))))).
