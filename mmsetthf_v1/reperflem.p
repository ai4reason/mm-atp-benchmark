...
thf(aneibl_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))) @ (cwa @ (cwss @ XN @ XX) @ (cwrex @ (^ [Xr:$i] : (cwss @ (cco @ XP @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XN)) @ (^ [Xr:$i] : ccrp)))))))))))).
...
thf(aislp2_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cclp))) @ (cwral @ (^ [Xn:$i] : (cwne @ (ccin @ (ccv @ Xn) @ (ccdif @ XS @ (ccsn @ XP))) @ cc0)) @ (^ [Xn:$i] : (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)))))))))))).
...
thf(arestperf_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XK @ (cco @ XJ @ XY @ ccrest)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XY @ XX)) @ (cwb @ (cwcel @ XK @ ccperf) @ (cwss @ XY @ (ccfv @ XY @ (ccfv @ XJ @ cclp)))))))))))).
thf(creperflem_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xv:$i] : (cwceq @ (XJ @ Xv) @ (ccfv @ cccnfld @ cctopn))) => ((! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xu) @ XS) @ (cwcel @ (ccv @ Xv) @ ccr)) @ (cwcel @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ ccaddc) @ XS)))) => ((cwss @ XS @ ccc) => (! [Xv:$i] : (cwcel @ (cco @ (XJ @ Xv) @ XS @ ccrest) @ ccperf)))))))).
