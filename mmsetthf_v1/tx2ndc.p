...
thf(ais2ndc_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ cc2ndc) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cctg) @ XJ))) @ (^ [Xx3:$i] : cctb))))).
...
thf(atxbasval_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW)) @ (cwceq @ (cco @ (ccfv @ XR @ cctg) @ (ccfv @ XS @ cctg) @ cctx) @ (cco @ XR @ XS @ cctx)))))))).
...
thf(atxbas_thm,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1) @ (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XR)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XR @ cctb) @ (cwcel @ XS @ cctb)) @ (cwcel @ (XB2 @ Xx3 @ Xy1) @ cctb))))))))).
...
thf(axpdom1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => (cwi @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC) @ ccdom))))))).
...
thf(aondomen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwbr @ XB2 @ XA2 @ ccdom)) @ (cwcel @ XB2 @ (ccdm @ cccrd)))))).
...
thf(ctx2ndc_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ cc2ndc) @ (cwcel @ XS @ cc2ndc)) @ (cwcel @ (cco @ XR @ XS @ cctx) @ cc2ndc))))).
