...
thf(cgsummptcl_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xi) @ ccbs))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XG @ Xi) @ cccmn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XN @ ccfn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwral @ (^ [Xi:$i] : (cwcel @ (XX @ Xi) @ XB2)) @ (^ [Xi:$i] : XN)))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (cco @ (XG @ Xi) @ (ccmpt @ (^ [Xi:$i] : XN) @ (^ [Xi:$i] : (XX @ Xi))) @ ccgsu) @ XB2))))))))))))).
