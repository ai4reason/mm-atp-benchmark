...
thf(cknoppndvlem16_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ XM @ ccmul)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ (cco @ XM @ cc1 @ ccaddc) @ ccmul)) => ((cwi @ Xph @ (cwcel @ XJ @ ccn0)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => (cwi @ Xph @ (cwceq @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv))))))))))))))).
