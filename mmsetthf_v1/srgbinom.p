...
thf(asrgidcl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwcel @ XR @ ccsrg) @ (cwcel @ Xc_1 @ XB2)))))))).
thf(asrglidm_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccsrg) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ Xc_1 @ XX @ Xc_x) @ XX))))))))))).
...
thf(csrgbinom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_xp @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccfv @ XR @ ccmgp))) => ((! [Xk:$i] : (cwceq @ Xc_ex @ (ccfv @ (XG @ Xk) @ ccmg))) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccsrg) @ (cwcel @ XN @ ccn0)) @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_xp) @ (cco @ XB2 @ XA2 @ Xc_xp)))) @ (cwceq @ (cco @ XN @ (cco @ XA2 @ XB2 @ Xc_pl) @ Xc_ex) @ (cco @ XR @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xk) @ XB2 @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu)))))))))))))))))))).
