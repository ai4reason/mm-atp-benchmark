...
thf(acff1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1 @ (ccfv @ XA2 @ cccf) @ XA2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (ccfv @ XA2 @ cccf)))) @ (^ [Xz:$i] : XA2)))))))).
...
thf(atfis2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccon0) @ (cwi @ (cwral @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ (Xph @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccon0) @ (Xph @ Xx3)))))))).
...
thf(arecsfnon_thm,axiom,(! [XF:($i > $o)] : (cwfn @ (ccrecs @ XF) @ ccon0))).
...
thf(acfflb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwi @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XB2 @ XA2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XA2))))) @ (cwss @ (ccfv @ XA2 @ cccf) @ XB2)))))).
...
thf(aissmo2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwf @ (XA2 @ Xy1) @ (XB2 @ Xx3 @ Xy1) @ XF) @ (cwi @ (cw3a @ (cwss @ (XB2 @ Xx3 @ Xy1) @ ccon0) @ (cword @ (XA2 @ Xy1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) @ (cwsmo @ XF))))))))).
...
thf(asmoeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwsmo @ XA2) @ (cwsmo @ XB2)))))).
thf(ccfsmolem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xw:$i] : (! [Xg1:$i] : (cwceq @ (XF @ Xw @ Xg1) @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccun @ (ccfv @ (ccdm @ (ccv @ Xz)) @ (ccv @ Xg1)) @ (cciun @ (^ [Xt:$i] : (ccdm @ (ccv @ Xz))) @ (^ [Xt:$i] : (ccsuc @ (ccfv @ (ccv @ Xt) @ (ccv @ Xz))))))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xg1:$i] : (cwceq @ (XG @ Xt @ Xg1) @ (ccres @ (ccrecs @ (XF @ Xw @ Xg1)) @ (ccfv @ XA2 @ cccf)))))) => (cwi @ (cwcel @ XA2 @ ccon0) @ (cwex @ (^ [Xf1:$i] : (cw3a @ (cwf @ (ccfv @ XA2 @ cccf) @ XA2 @ (ccv @ Xf1)) @ (cwsmo @ (ccv @ Xf1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (ccfv @ XA2 @ cccf)))) @ (^ [Xz:$i] : XA2)))))))))))).
