...
thf(auniwf_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ (ccuni @ XA2) @ (ccuni @ (ccima @ ccr1 @ ccon0)))))).
...
thf(ar1pwcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwlim @ XB2) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) @ (cwcel @ (ccpw @ XA2) @ (ccfv @ XB2 @ ccr1))))))).
...
thf(cr1limwun_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwlim @ XA2)) @ (cwcel @ (ccfv @ XA2 @ ccr1) @ ccwun))))).
