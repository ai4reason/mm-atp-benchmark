...
thf(aiccvonmbl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (ccdm @ (ccfv @ XX @ ccvoln)))) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XA2)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XB2)) => (! [Xi:$i] : (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccicc))) @ (XS @ Xi)))))))))))))).
...
thf(avolico2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ (cco @ XB2 @ XA2 @ ccmin) @ ccc0)))))).
...
thf(avonicclem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XA2)) => ((cwi @ Xph @ (cwf @ XX @ ccr @ XB2)) => ((cwi @ Xph @ (cwne @ XX @ cc0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XX)) @ (cwbr @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccle))) => ((! [Xk:$i] : (cwceq @ (XI @ Xk) @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccicc))))) => ((cwceq @ XC @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XB2) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc)))))) => ((! [Xk:$i] : (cwceq @ (XD @ Xk) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xn) @ XC)) @ ccico))))))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XI @ Xk) @ (ccfv @ XX @ ccvoln)) @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XB2) @ (ccfv @ (ccv @ Xk) @ XA2) @ ccmin)))))))))))))))))))))).
