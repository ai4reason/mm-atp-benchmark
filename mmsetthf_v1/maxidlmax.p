...
thf(cmaxidlmax_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XM @ (ccfv @ XR @ ccmaxidl))) @ (cwa @ (cwcel @ XI @ (ccfv @ XR @ ccidl)) @ (cwss @ XM @ XI))) @ (cwo @ (cwceq @ XI @ XM) @ (cwceq @ XI @ XX))))))))))).
