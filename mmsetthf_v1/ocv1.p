...
thf(cocv1_conj,conjecture,(! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => (cwi @ (cwcel @ XW @ ccphl) @ (cwceq @ (ccfv @ XV @ Xc_pe) @ (ccsn @ Xc_0))))))))))).
