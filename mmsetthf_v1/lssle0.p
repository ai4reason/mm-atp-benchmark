...
thf(clssle0_conj,conjecture,(! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XX @ XS)) @ (cwb @ (cwss @ XX @ (ccsn @ Xc_0)) @ (cwceq @ XX @ (ccsn @ Xc_0))))))))))).
