...
thf(aelioo3g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XC @ XB2 @ cclt)))))))).
...
thf(aislptre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp))) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwcel @ XB2 @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo)) @ (cwne @ (ccin @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo) @ (ccdif @ XA2 @ (ccsn @ XB2))) @ cc0))) @ (^ [Xb:$i] : ccxr))) @ (^ [Xa:$i] : ccxr)))))))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(aioossre_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ ccr)))).
thf(clptioo1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (ccfv @ XJ @ cclp))))))))))))).
