...
thf(anonrel_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccdif @ XA2 @ (cccnv @ (cccnv @ XA2))) @ (ccdif @ XA2 @ (ccxp @ ccvv @ ccvv))))).
...
thf(celnonrel_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwb @ (cwcel @ (ccop @ XX @ XY) @ (ccdif @ XA2 @ (cccnv @ (cccnv @ XA2)))) @ (cwa @ (cwcel @ cc0 @ XA2) @ (cwn @ (cwa @ (cwcel @ XX @ ccvv) @ (cwcel @ XY @ ccvv))))))))).
