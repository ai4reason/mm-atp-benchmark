...
thf(cccatws1lenOLD_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))))))).
