...
thf(cmexval2_conj,conjecture,(! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XK @ (ccfv @ XT @ ccmtc)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XC @ (ccfv @ XT @ ccmcn)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => (cwceq @ XE @ (ccxp @ XK @ (ccword @ (ccun @ XC @ XV)))))))))))))).
