...
thf(aumgr2wlk_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xf1 @ Xp) @ (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccumgr) @ (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp))) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc2) @ (cw3a @ (cwceq @ XA2 @ (ccfv @ ccc0 @ (ccv @ Xp))) @ (cwceq @ XB2 @ (ccfv @ cc1 @ (ccv @ Xp))) @ (cwceq @ XC @ (ccfv @ cc2 @ (ccv @ Xp))))))))))))))))))).
...
thf(cumgr2wlkon_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccumgr) @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE)) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ XA2 @ XC @ (ccfv @ XG @ ccwlkson))))))))))))))).
