...
thf(aislpcn_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwss @ XS @ ccc)) => ((cwi @ Xph @ (cwcel @ XP @ ccc)) => (cwi @ Xph @ (cwb @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ (ccfv @ cccnfld @ cctopn) @ cclp))) @ (cwral @ (^ [Xe:$i] : (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XP @ ccmin) @ ccabs) @ (ccv @ Xe) @ cclt)) @ (^ [Xx3:$i] : (ccdif @ XS @ (ccsn @ XP))))) @ (^ [Xe:$i] : ccrp)))))))))).
...
thf(aabsnpncan3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwcel @ XE @ ccc)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XA2 @ XE @ ccmin) @ ccabs) @ (cco @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs) @ ccaddc) @ (ccfv @ (cco @ XC @ XD @ ccmin) @ ccabs) @ ccaddc) @ (ccfv @ (cco @ XD @ XE @ ccmin) @ ccabs) @ ccaddc) @ ccle)))))))))))))).
thf(alt4addmuld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwcel @ XE @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XE @ cclt)) => ((cwi @ Xph @ (cwbr @ XB2 @ XE @ cclt)) => ((cwi @ Xph @ (cwbr @ XC @ XE @ cclt)) => ((cwi @ Xph @ (cwbr @ XD @ XE @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccaddc) @ XD @ ccaddc) @ (cco @ cc4 @ XE @ ccmul) @ cclt)))))))))))))))))).
...
thf(aabssubrp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XA2 @ XB2)) @ (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ ccrp))))).
...
thf(climclner_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ (ccin @ XA2 @ (cco @ ccmnf @ XB2 @ ccioo)) @ (ccfv @ XJ @ cclp)))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ (ccin @ XA2 @ (cco @ XB2 @ ccpnf @ ccioo)) @ (ccfv @ XJ @ cclp)))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ (ccres @ XF @ (cco @ ccmnf @ XB2 @ ccioo)) @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ (ccres @ XF @ (cco @ XB2 @ ccpnf @ ccioo)) @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwne @ XL @ XR)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XB2 @ cclimc) @ cc0)))))))))))))))))))).
