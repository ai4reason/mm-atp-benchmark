...
thf(apntlemp_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwcel @ (XA2 @ Xu @ Xe @ Xk @ Xa) @ ccrp))))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ ccabs) @ (XA2 @ Xu @ Xe @ Xk @ Xa) @ ccle)) @ (^ [Xx3:$i] : ccrp)))))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwcel @ (XB2 @ Xu @ Xa) @ ccrp))))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwcel @ (XL @ Xa) @ (cco @ ccc0 @ cc1 @ ccioo)))))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwceq @ XD @ (cco @ (XA2 @ Xu @ Xe @ Xk @ Xa) @ cc1 @ ccaddc)))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwceq @ (XF @ Xx3 @ Xu @ Xe @ Xk @ Xa) @ (cco @ (cco @ cc1 @ (cco @ cc1 @ XD @ ccdiv) @ ccmin) @ (cco @ (cco @ (XL @ Xa) @ (cco @ (ccdc @ cc3 @ cc2) @ (XB2 @ Xu @ Xa) @ ccmul) @ ccdiv) @ (cco @ XD @ cc2 @ ccexp) @ ccdiv) @ ccmul))))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwral @ (^ [Xe:$i] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwa @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt) @ (cwbr @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xa) @ (ccv @ Xe) @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ (cco @ (ccv @ Xk) @ (ccv @ Xy1) @ ccmul) @ cclt)) @ (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xu) @ (XR @ Xa)) @ (ccv @ Xu) @ ccdiv) @ ccabs) @ (ccv @ Xe) @ ccle)) @ (^ [Xu:$i] : (cco @ (ccv @ Xz) @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xa) @ (ccv @ Xe) @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ ccicc))))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)))) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (XB2 @ Xu @ Xa) @ (ccv @ Xe) @ ccdiv) @ cce) @ ccpnf @ ccico)))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xe:$i] : (cco @ ccc0 @ cc1 @ ccioo))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwcel @ (XU @ Xx3 @ Xy1 @ Xu @ Xe @ Xk @ Xa) @ ccrp))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwbr @ (XU @ Xx3 @ Xy1 @ Xu @ Xe @ Xk @ Xa) @ (XA2 @ Xu @ Xe @ Xk @ Xa) @ ccle))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwceq @ XE @ (cco @ (XU @ Xx3 @ Xy1 @ Xu @ Xe @ Xk @ Xa) @ XD @ ccdiv)))))))) => ((! [Xu:$i] : (! [Xa:$i] : (cwceq @ (XK @ Xu @ Xa) @ (ccfv @ (cco @ (XB2 @ Xu @ Xa) @ XE @ ccdiv) @ cce)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwa @ (cwcel @ (XY @ Xx3 @ Xu @ Xe) @ ccrp) @ (cwbr @ cc1 @ (XY @ Xx3 @ Xu @ Xe) @ ccle))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ (XR @ Xa)) @ (ccv @ Xz) @ ccdiv) @ ccabs) @ (XU @ Xx3 @ Xy1 @ Xu @ Xe @ Xk @ Xa) @ ccle)) @ (^ [Xz:$i] : (cco @ (XY @ Xx3 @ Xu @ Xe) @ ccpnf @ ccico))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xz @ Xu @ Xe @ Xk @ Xa) @ (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xv) @ (XR @ Xa)) @ (ccv @ Xv) @ ccdiv) @ ccabs) @ (cco @ (XU @ Xx3 @ Xy1 @ Xu @ Xe @ Xk @ Xa) @ (cco @ (XF @ Xx3 @ Xu @ Xe @ Xk @ Xa) @ (cco @ (XU @ Xx3 @ Xy1 @ Xu @ Xe @ Xk @ Xa) @ cc3 @ ccexp) @ ccmul) @ ccmin) @ ccle)) @ (^ [Xv:$i] : (cco @ (ccv @ Xw) @ ccpnf @ ccico)))) @ (^ [Xw:$i] : ccrp)))))))))))))))))))))))))))))))))))).
...
thf(cpntleml_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xu @ Xe @ Xk @ Xa) @ (cwcel @ (XA2 @ Xu @ Xe @ Xk @ Xa) @ ccrp)))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xu @ Xe @ Xk @ Xa) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ ccabs) @ (XA2 @ Xu @ Xe @ Xk @ Xa) @ ccle)) @ (^ [Xx3:$i] : ccrp))))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xu @ Xe @ Xk @ Xa) @ (cwcel @ (XB2 @ Xu @ Xa) @ ccrp)))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xu @ Xe @ Xk @ Xa) @ (cwcel @ (XL @ Xa) @ (cco @ ccc0 @ cc1 @ ccioo))))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwceq @ XD @ (cco @ (XA2 @ Xu @ Xe @ Xk @ Xa) @ cc1 @ ccaddc)))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwceq @ (XF @ Xx3 @ Xu @ Xe @ Xk @ Xa) @ (cco @ (cco @ cc1 @ (cco @ cc1 @ XD @ ccdiv) @ ccmin) @ (cco @ (cco @ (XL @ Xa) @ (cco @ (ccdc @ cc3 @ cc2) @ (XB2 @ Xu @ Xa) @ ccmul) @ ccdiv) @ (cco @ XD @ cc2 @ ccexp) @ ccdiv) @ ccmul))))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xu @ Xe @ Xk @ Xa) @ (cwral @ (^ [Xe:$i] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwa @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt) @ (cwbr @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xa) @ (ccv @ Xe) @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ (cco @ (ccv @ Xk) @ (ccv @ Xy1) @ ccmul) @ cclt)) @ (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xu) @ (XR @ Xa)) @ (ccv @ Xu) @ ccdiv) @ ccabs) @ (ccv @ Xe) @ ccle)) @ (^ [Xu:$i] : (cco @ (ccv @ Xz) @ (cco @ (cco @ cc1 @ (cco @ (XL @ Xa) @ (ccv @ Xe) @ ccmul) @ ccaddc) @ (ccv @ Xz) @ ccmul) @ ccicc))))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)))) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (XB2 @ Xu @ Xa) @ (ccv @ Xe) @ ccdiv) @ cce) @ ccpnf @ ccico)))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xe:$i] : (cco @ ccc0 @ cc1 @ ccioo)))))))) => (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xu @ Xe @ Xk @ Xa) @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccv @ Xx3) @ ccdiv))) @ cc1 @ ccrli)))))))))))))))))))))).
