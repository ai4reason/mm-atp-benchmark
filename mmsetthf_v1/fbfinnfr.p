...
thf(anssinpss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwn @ (cwss @ XA2 @ XB2)) @ (cwpss @ (ccin @ XA2 @ XB2) @ XA2))))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(asspsstr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XB2) @ (cwpss @ XB2 @ XC)) @ (cwpss @ XA2 @ XC)))))).
...
thf(cfbfinnfr_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) @ (cwcel @ XS @ XF) @ (cwcel @ XS @ ccfn)) @ (cwne @ (ccint @ XF) @ cc0)))))).
