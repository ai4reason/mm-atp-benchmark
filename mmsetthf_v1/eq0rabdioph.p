...
thf(amptfcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [Xt:$i] : (cwi @ (cwf @ XA2 @ XC @ (ccmpt @ (^ [Xt:$i] : XA2) @ (^ [Xt:$i] : (XB2 @ Xt)))) @ (cwi @ (cwcel @ (ccv @ Xt) @ XA2) @ (cwcel @ (XB2 @ Xt) @ XC)))))))).
...
thf(aeldioph_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ (ccfv @ (cco @ cc1 @ XK @ ccfz) @ ccmzp))) @ (cwcel @ (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwceq @ (ccv @ Xt) @ (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xu) @ XP) @ ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ XK @ ccfz) @ ccmap))))) @ (ccfv @ XN @ ccdioph))))))).
thf(ceq0rabdioph_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (XA2 @ Xt))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp))) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (cwceq @ (XA2 @ Xt) @ ccc0)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))).
