...
thf(cexprec_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XN @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccdiv)))))).
