...
thf(cbj_exlimh_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (Xps @ Xx3)))) @ (cwi @ (cwi @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3))) @ (Xch @ Xx3)) @ (cwi @ (cwex @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (Xch @ Xx3))))))))).
