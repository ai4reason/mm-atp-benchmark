...
thf(cfsnex_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccfv @ XA2 @ (ccv @ Xf1))) @ (cwb @ (Xps @ Xx3) @ (Xph @ Xf1))))) => (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (ccsn @ XA2) @ XD @ (ccv @ Xf1)) @ (Xph @ Xf1)))) @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XD))))))))))).
