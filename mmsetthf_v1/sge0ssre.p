...
thf(csge0ssre_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (cwi @ Xph @ (cwcel @ (ccfv @ (ccres @ XF @ XY) @ ccsumge0) @ ccr))))))))))).
