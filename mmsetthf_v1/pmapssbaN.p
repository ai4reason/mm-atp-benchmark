...
thf(cpmapssbaN_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ XC) @ (cwcel @ XX @ XB2)) @ (cwss @ (ccfv @ XX @ XM) @ XB2)))))))))).
