...
thf(adgrcolem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XG @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwi @ Xph @ (cwcel @ XD @ ccn0)) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ XD @ cc1 @ ccaddc))) => ((cwi @ Xph @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XD @ ccle) @ (cwceq @ (ccfv @ (cccom @ (ccv @ Xf1) @ XG) @ ccdgr) @ (cco @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XN @ ccmul)))) @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply)))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cccom @ XF @ XG) @ ccdgr) @ (cco @ XM @ XN @ ccmul)))))))))))))))))))).
...
thf(cdgrco_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XN @ (ccfv @ XG @ ccdgr)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ XS @ ccply))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cccom @ XF @ XG) @ ccdgr) @ (cco @ XM @ XN @ ccmul)))))))))))))).
