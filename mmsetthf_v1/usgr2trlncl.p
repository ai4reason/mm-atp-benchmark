...
thf(af12dfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccpr @ XX @ XY)) => (cwi @ (cwa @ (cwa @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV)) @ (cwne @ XX @ XY)) @ (cwb @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwne @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF)))))))))))))).
thf(ampcom_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xps @ Xph) => ((cwi @ Xph @ (cwi @ Xps @ Xch)) => (cwi @ Xps @ Xch))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(ausgrf1oedg_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwf1o @ (ccdm @ XI) @ XE @ XI)))))))).
...
thf(cusgr2trlncl_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccfv @ XF @ cchash) @ cc2)) @ (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) @ (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ cc2 @ XP)))))))).
