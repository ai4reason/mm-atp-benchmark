...
thf(abreqan12rd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xps @ (cwceq @ XC @ XD)) => (cwi @ (cwa @ Xps @ Xph) @ (cwb @ (cwbr @ XA2 @ XC @ XR) @ (cwbr @ XB2 @ XD @ XR))))))))))))).
...
thf(advferm1lem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ XX @ ccr @ XF))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XX @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XU @ XB2 @ ccioo))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ ccc0 @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ cclt))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XT @ Xy1) @ ccrp)))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (cwne @ (ccv @ Xz) @ XU) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XU @ ccmin) @ ccabs) @ (XT @ Xy1) @ cclt)) @ (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XU @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XU @ ccmin) @ ccdiv) @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccmin) @ ccabs) @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ cclt))) @ (^ [Xz:$i] : (ccdif @ XX @ (ccsn @ XU))))))) => ((! [Xy1:$i] : (cwceq @ XS @ (cco @ (cco @ XU @ (ccif @ (cwbr @ XB2 @ (cco @ XU @ (XT @ Xy1) @ ccaddc) @ ccle) @ XB2 @ (cco @ XU @ (XT @ Xy1) @ ccaddc)) @ ccaddc) @ cc2 @ ccdiv))) => (! [Xz:$i] : (cwn @ (Xph @ Xz)))))))))))))))))))))).
...
thf(cdvferm1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ ccr @ XF)) => ((cwi @ Xph @ (cwss @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX)) => ((cwi @ Xph @ (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => ((cwi @ Xph @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XU @ XB2 @ ccioo)))) => (cwi @ Xph @ (cwbr @ (ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) @ ccc0 @ ccle))))))))))))))).
