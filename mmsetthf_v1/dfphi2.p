...
thf(aphi1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccphi) @ cc1)).
...
thf(aphibndlem_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwss @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XN @ ccgcd) @ cc1)) @ (^ [Xx3:$i] : (cco @ cc1 @ XN @ ccfz))) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))).
...
thf(cdfphi2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccphi) @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XN @ ccgcd) @ cc1)) @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfzo))) @ cchash))))).
