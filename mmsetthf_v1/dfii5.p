...
thf(aordtresticc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ (ccfv @ ccle @ ccordt) @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest) @ (ccfv @ (ccin @ ccle @ (ccxp @ (cco @ XA2 @ XB2 @ ccicc) @ (cco @ XA2 @ XB2 @ ccicc))) @ ccordt))))).
thf(cdfii5_conj,conjecture,(cwceq @ ccii @ (ccfv @ (ccin @ ccle @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ cc1 @ ccicc))) @ ccordt))).
