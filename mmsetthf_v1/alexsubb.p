...
thf(aalexsub_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccufl)) => ((cwi @ Xph @ (cwceq @ XX @ (ccuni @ XB2))) => ((cwi @ Xph @ (cwceq @ XJ @ (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwss @ (ccv @ Xx3) @ XB2) @ (cwceq @ XX @ (ccuni @ (ccv @ Xx3))))) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) => (cwi @ Xph @ (cwcel @ XJ @ cccmp))))))))))).
...
thf(calexsubb_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ ccufl) @ (cwceq @ XX @ (ccuni @ XB2))) @ (cwb @ (cwcel @ (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg) @ cccmp) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xx3))) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) @ (^ [Xx3:$i] : (ccpw @ XB2)))))))).
