...
thf(adf_edg_ax,axiom,(cwceq @ ccedg @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrn @ (ccfv @ (ccv @ Xg1) @ cciedg)))))).
...
thf(cedgvalOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XG @ XV) @ (cwceq @ (ccfv @ XG @ ccedg) @ (ccrn @ (ccfv @ XG @ cciedg))))))).
