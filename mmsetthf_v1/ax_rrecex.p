...
thf(agencl_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwb @ (Xth @ Xx3) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xch @ Xx3) @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (Xch @ Xx3) @ (Xph @ Xx3))) => (! [Xx3:$i] : (cwi @ (Xth @ Xx3) @ Xps)))))))))))).
...
thf(arecexsr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnr) @ (cwne @ XA2 @ cc0r)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccmr) @ cc1r)) @ (^ [Xx3:$i] : ccnr))))).
...
thf(cax_rrecex_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwne @ XA2 @ ccc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cc1)) @ (^ [Xx3:$i] : ccr))))).
