...
thf(admadjrn_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ (ccdm @ ccado)) @ (cwcel @ (ccfv @ XT @ ccado) @ (ccdm @ ccado))))).
...
thf(cadjmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XT @ (ccdm @ ccado))) @ (cwceq @ (ccfv @ (cco @ XA2 @ XT @ cchot) @ ccado) @ (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XT @ ccado) @ cchot)))))).
