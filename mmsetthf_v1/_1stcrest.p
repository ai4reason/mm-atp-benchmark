...
thf(a_1stctop_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ cc1stc) @ (cwcel @ XJ @ cctop)))).
...
thf(arestuni2_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ XV)) @ (cwceq @ (ccin @ XA2 @ XX) @ (ccuni @ (cco @ XJ @ XA2 @ ccrest)))))))))).
...
thf(a_1stcclb_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cc1stc) @ (cwcel @ XA2 @ XX)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xy1)) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : XJ)))) @ (^ [Xx3:$i] : (ccpw @ XJ))))))))).
...
thf(ais1stc2_thm,axiom,(! [XJ:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XX @ Xy1 @ Xz @ Xw) @ (ccuni @ (XJ @ Xw)))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwb @ (cwcel @ (XJ @ Xw) @ cc1stc) @ (cwa @ (cwcel @ (XJ @ Xw) @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xy1) @ ccom @ ccdom) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xw)) @ (cwss @ (ccv @ Xw) @ (ccv @ Xz)))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (XJ @ Xw))))) @ (^ [Xy1:$i] : (ccpw @ (XJ @ Xw))))) @ (^ [Xx3:$i] : (XX @ Xy1 @ Xz @ Xw)))))))))))).
thf(c_1stcrest_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cc1stc) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ cc1stc)))))).
