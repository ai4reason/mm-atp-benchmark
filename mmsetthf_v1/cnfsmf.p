...
thf(aunirestss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => (cwi @ Xph @ (cwss @ (ccuni @ (cco @ XA2 @ XB2 @ ccrest)) @ (ccuni @ XA2))))))))))).
...
thf(ccnfsmf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ cctop)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XJ @ (ccdm @ XF) @ ccrest) @ XK @ cccn))) => ((cwceq @ XS @ (ccfv @ XJ @ ccsalgen)) => (cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))))))))))))).
