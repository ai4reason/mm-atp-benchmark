...
thf(abtwndiff_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cwrex @ (^ [Xc:$i] : (cwa @ (cwbr @ XB2 @ (ccop @ XA2 @ (ccv @ Xc)) @ ccbtwn) @ (cwne @ XB2 @ (ccv @ Xc)))) @ (^ [Xc:$i] : (ccfv @ XN @ ccee)))))))).
...
thf(abtwnexchand_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XN @ ccee))) => ((cwi @ (cwa @ Xph @ Xps) @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn)) => ((cwi @ (cwa @ Xph @ Xps) @ (cwbr @ XC @ (ccop @ XA2 @ XD) @ ccbtwn)) => (cwi @ (cwa @ Xph @ Xps) @ (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn))))))))))))))))).
...
thf(acgrextendand_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XE @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XN @ ccee))) => ((cwi @ (cwa @ Xph @ Xps) @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn)) => ((cwi @ (cwa @ Xph @ Xps) @ (cwbr @ XE @ (ccop @ XD @ XF) @ ccbtwn)) => ((cwi @ (cwa @ Xph @ Xps) @ (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XD @ XE) @ cccgr)) => ((cwi @ (cwa @ Xph @ Xps) @ (cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XE @ XF) @ cccgr)) => (cwi @ (cwa @ Xph @ Xps) @ (cwbr @ (ccop @ XA2 @ XC) @ (ccop @ XD @ XF) @ cccgr))))))))))))))))))))))).
...
thf(ccgrxfr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XF @ (ccfv @ XN @ ccee)))) @ (cwi @ (cwa @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ (ccop @ XA2 @ XC) @ (ccop @ XD @ XF) @ cccgr)) @ (cwrex @ (^ [Xe:$i] : (cwa @ (cwbr @ (ccv @ Xe) @ (ccop @ XD @ XF) @ ccbtwn) @ (cwbr @ (ccop @ XA2 @ (ccop @ XB2 @ XC)) @ (ccop @ XD @ (ccop @ (ccv @ Xe) @ XF)) @ cccgr3))) @ (^ [Xe:$i] : (ccfv @ XN @ ccee)))))))))))).
