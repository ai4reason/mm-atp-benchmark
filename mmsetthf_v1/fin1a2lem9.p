...
thf(acarden2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd))) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) @ (cwbr @ XA2 @ XB2 @ ccen)))))).
thf(abiimpd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ Xph @ (cwi @ Xps @ Xch))))))).
thf(a_3expa_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth))))))).
thf(afin23lem25_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn) @ (cwo @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ XA2))) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccen) @ (cwceq @ XA2 @ XB2)))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(adomfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwbr @ XB2 @ XA2 @ ccdom)) @ (cwcel @ XB2 @ ccfn))))).
thf(cfin1a2lem9_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwor @ XX @ ccrpss) @ (cwss @ XX @ ccfn) @ (cwcel @ XA2 @ ccom)) @ (cwcel @ (ccrab @ (^ [Xb:$i] : (cwbr @ (ccv @ Xb) @ XA2 @ ccdom)) @ (^ [Xb:$i] : XX)) @ ccfn))))).
