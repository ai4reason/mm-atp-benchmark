...
thf(alautlt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cwcel @ XK @ XA2) @ (cw3a @ (cwcel @ XF @ XI) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwb @ (cwbr @ XX @ XY @ Xc_lt) @ (cwbr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ Xc_lt))))))))))))))).
...
thf(acvrval_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_lt:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xz:$i] : (cwceq @ (Xc_lt @ Xz) @ (ccfv @ XK @ ccplt))) => ((! [Xz:$i] : (cwceq @ (XC @ Xz) @ (ccfv @ XK @ cccvr))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XK @ (XA2 @ Xz)) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwbr @ XX @ XY @ (XC @ Xz)) @ (cwa @ (cwbr @ XX @ XY @ (Xc_lt @ Xz)) @ (cwn @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ XX @ (ccv @ Xz) @ (Xc_lt @ Xz)) @ (cwbr @ (ccv @ Xz) @ XY @ (Xc_lt @ Xz)))) @ (^ [Xz:$i] : XB2)))))))))))))))))).
...
thf(clautcvr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cwcel @ XK @ XA2) @ (cw3a @ (cwcel @ XF @ XI) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwb @ (cwbr @ XX @ XY @ XC) @ (cwbr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XC))))))))))))))).
