...
thf(aclimxlim2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ ccxr @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ ccli)) => (cwi @ Xph @ (cwbr @ XF @ XA2 @ cclsxlim)))))))))))).
...
thf(ameaiunincf_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwnf @ (^ [Xn:$i] : (Xph @ Xx3 @ Xn)))) => ((cwnfc @ (^ [Xn:$i] : (XE @ Xn))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwcel @ XM @ ccmea)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwcel @ (XN @ Xx3 @ Xn) @ ccz)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwf @ XZ @ (ccdm @ XM) @ (XE @ Xn))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xn) @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (XE @ Xn)))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xx3:$i] : ccr))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ XM)))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xn) @ (cwbr @ (XS @ Xx3 @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xn)))) @ XM) @ ccli)))))))))))))))))))).
...
thf(assinc_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ (cco @ XM @ XN @ ccfzo))) @ (cwss @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF)))) => (cwi @ Xph @ (cwss @ (ccfv @ XM @ XF) @ (ccfv @ XN @ XF)))))))))).
...
thf(auzssd3_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (cwi @ (cwcel @ XN @ XZ) @ (cwss @ (ccfv @ XN @ ccuz) @ XZ))))))).
...
thf(aralrimia_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (Xps @ Xx3))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
...
thf(axrpnf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwceq @ XA2 @ ccpnf) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccle)) @ (^ [Xx3:$i] : ccr)))))).
thf(cmeaiuninc3v_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xn) @ ccz))) => ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xn) @ ccuz))) => ((cwi @ Xph @ (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (ccv @ Xn) @ XE) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE)))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XS @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ cclsxlim)))))))))))))))).
