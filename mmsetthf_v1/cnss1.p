...
thf(ccnss1_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XK @ (ccfv @ XX @ cctopon)) @ (cwss @ XJ @ XK)) @ (cwss @ (cco @ XJ @ XL @ cccn) @ (cco @ XK @ XL @ cccn))))))))).
