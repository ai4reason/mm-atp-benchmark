...
thf(caxbnd_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (cwo @ (cwal @ (^ [Xz:$i] : (cwceq @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (cwo @ (cwal @ (^ [Xz:$i] : (cwceq @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwal @ (^ [Xz:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))))))))))))).
