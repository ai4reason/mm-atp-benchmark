...
thf(a_4cycl2v2nb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE)) @ (cwa @ (cwcel @ (ccpr @ XC @ XD) @ XE) @ (cwcel @ (ccpr @ XD @ XA2) @ XE))) @ (cwa @ (cwss @ (ccpr @ (ccpr @ XA2 @ XB2) @ (ccpr @ XB2 @ XC)) @ XE) @ (cwss @ (ccpr @ (ccpr @ XA2 @ XD) @ (ccpr @ XD @ XC)) @ XE))))))))).
...
thf(c_4cycl2vnunb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE)) @ (cwa @ (cwcel @ (ccpr @ XC @ (XD @ Xx3)) @ XE) @ (cwcel @ (ccpr @ (XD @ Xx3) @ XA2) @ XE)) @ (cw3a @ (cwcel @ XB2 @ XV) @ (cwcel @ (XD @ Xx3) @ XV) @ (cwne @ XB2 @ (XD @ Xx3)))) @ (cwn @ (cwreu @ (^ [Xx3:$i] : (cwss @ (ccpr @ (ccpr @ XA2 @ (ccv @ Xx3)) @ (ccpr @ (ccv @ Xx3) @ XC)) @ XE)) @ (^ [Xx3:$i] : XV)))))))))))).
