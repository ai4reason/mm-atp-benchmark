...
thf(aqmulz_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ ccz)) @ (^ [Xx3:$i] : ccn))))).
...
thf(celqaalem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccc))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XF @ Xk @ Xn) @ (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (ccfv @ XA2 @ (XF @ Xk @ Xn)) @ ccc0)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ XB2 @ (ccfv @ (XF @ Xk @ Xn) @ cccoe)))) => ((cwceq @ XN @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccinf @ (ccrab @ (^ [Xn:$i] : (cwcel @ (cco @ (ccfv @ (ccv @ Xk) @ XB2) @ (ccv @ Xn) @ ccmul) @ ccz)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xn) @ (ccfv @ (ccfv @ (XF @ Xk @ Xn) @ ccdgr) @ (ccseq @ ccmul @ XN @ ccc0))))) => (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ XK @ ccn0)) @ (cwa @ (cwcel @ (ccfv @ XK @ XN) @ ccn) @ (cwcel @ (cco @ (ccfv @ XK @ XB2) @ (ccfv @ XK @ XN) @ ccmul) @ ccz)))))))))))))))))).
