...
thf(arecoscl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ cccos) @ ccr)))).
thf(asin2t_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ cc2 @ XA2 @ ccmul) @ ccsin) @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XA2 @ cccos) @ ccmul) @ ccmul))))).
...
thf(asincosq1eq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ cc1)) @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccsin) @ (ccfv @ (cco @ XB2 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ cccos)))))).
...
thf(altdiv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ cclt)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwbr @ ccc0 @ XC @ cclt))) @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ XC @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ cclt))))))).
...
thf(asincosq1sgn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) @ (cwa @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ cccos) @ cclt))))).
...
thf(asqdivi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwne @ XB2 @ ccc0) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ cc2 @ ccexp) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccdiv)))))))).
...
thf(asqrtge0i_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwi @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsqrt) @ ccle))))).
thf(adivge0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (cwi @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ XB2 @ cclt)) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccle))))))).
thf(asqrtsqi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwi @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccsqrt) @ XA2))))).
...
thf(asqrecii_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) => (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ cc2 @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccdiv)))))).
...
thf(csincos6thpi_conj,conjecture,(cwa @ (cwceq @ (ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ ccsin) @ (cco @ cc1 @ cc2 @ ccdiv)) @ (cwceq @ (ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ cccos) @ (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)))).
