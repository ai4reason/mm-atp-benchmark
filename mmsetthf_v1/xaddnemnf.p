...
thf(ajaoian_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => ((cwi @ (cwa @ Xth @ Xps) @ Xch) => (cwi @ (cwa @ (cwo @ Xph @ Xth) @ Xps) @ Xch)))))))).
...
thf(cxaddnemnf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwne @ XA2 @ ccmnf)) @ (cwa @ (cwcel @ XB2 @ ccxr) @ (cwne @ XB2 @ ccmnf))) @ (cwne @ (cco @ XA2 @ XB2 @ ccxad) @ ccmnf))))).
