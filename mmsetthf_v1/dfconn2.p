...
thf(aconndisj_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ Xph @ (cwcel @ XJ @ ccconn)) => ((cwi @ Xph @ (cwcel @ XA2 @ XJ)) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => ((cwi @ Xph @ (cwcel @ XB2 @ XJ)) => ((cwi @ Xph @ (cwne @ XB2 @ cc0)) => ((cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) => (cwi @ Xph @ (cwne @ (ccun @ XA2 @ XB2) @ XX))))))))))))))).
...
thf(cdfconn2_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XJ @ ccconn) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cw3a @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwne @ (ccv @ Xy1) @ cc0) @ (cwceq @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0)) @ (cwne @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XX))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))).
