...
thf(as7len_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccfv @ (ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ cchash) @ cc7))))))))).
thf(a_7p1e8_thm,axiom,(cwceq @ (cco @ cc7 @ cc1 @ ccaddc) @ cc8)).
thf(cs8len_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwceq @ (ccfv @ (ccs8 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG @ XH) @ cchash) @ cc8)))))))))).
