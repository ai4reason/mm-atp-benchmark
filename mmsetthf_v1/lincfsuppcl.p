...
thf(clincfsuppcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XR @ (ccfv @ XM @ ccsca)) => ((cwceq @ XS @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwa @ (cwcel @ XV @ XW) @ (cwss @ XV @ XB2)) @ (cwa @ (cwcel @ XF @ (cco @ XS @ XV @ ccmap)) @ (cwbr @ XF @ Xc_0 @ ccfsupp))) @ (cwcel @ (cco @ XF @ XV @ (ccfv @ XM @ cclinc)) @ XB2))))))))))))))).
