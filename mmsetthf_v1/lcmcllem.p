...
thf(alcmn0val_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwn @ (cwo @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)))) @ (cwceq @ (cco @ XM @ XN @ cclcm) @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwbr @ XM @ (ccv @ Xn) @ ccdvds) @ (cwbr @ XN @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
...
thf(clcmcllem_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwn @ (cwo @ (cwceq @ XM @ ccc0) @ (cwceq @ XN @ ccc0)))) @ (cwcel @ (cco @ XM @ XN @ cclcm) @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwbr @ XM @ (ccv @ Xn) @ ccdvds) @ (cwbr @ XN @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn))))))).
