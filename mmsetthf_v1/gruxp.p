...
thf(agruun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ ccgru) @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XU)) @ (cwcel @ (ccun @ XA2 @ XB2) @ XU)))))).
...
thf(cgruxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ ccgru) @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XU)) @ (cwcel @ (ccxp @ XA2 @ XB2) @ XU)))))).
