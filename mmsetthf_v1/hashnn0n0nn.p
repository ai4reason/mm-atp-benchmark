...
thf(chashnn0n0nn_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XY @ ccn0)) @ (cwa @ (cwceq @ (ccfv @ XV @ cchash) @ XY) @ (cwcel @ XN @ XV))) @ (cwcel @ XY @ ccn))))))).
