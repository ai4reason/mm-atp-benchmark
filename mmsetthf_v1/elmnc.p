...
thf(adf_mnc_ax,axiom,(cwceq @ ccmnc @ (ccmpt @ (^ [Xs1:$i] : (ccpw @ ccc)) @ (^ [Xs1:$i] : (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccfv @ (ccv @ Xp) @ cccoe)) @ cc1)) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xs1) @ ccply))))))).
...
thf(celmnc_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (cwb @ (cwcel @ XP @ (ccfv @ XS @ ccmnc)) @ (cwa @ (cwcel @ XP @ (ccfv @ XS @ ccply)) @ (cwceq @ (ccfv @ (ccfv @ XP @ ccdgr) @ (ccfv @ XP @ cccoe)) @ cc1)))))).
