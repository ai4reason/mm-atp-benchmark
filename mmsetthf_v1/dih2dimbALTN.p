...
thf(adibvalrel_thm,axiom,(! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdib))) => (cwi @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XW @ XH)) @ (cwrel @ (ccfv @ XX @ XI)))))))))))).
...
thf(adibopelval2_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccfv @ XK @ ccbs))) => ((! [Xf1:$i] : (cwceq @ (Xc_le @ Xf1) @ (ccfv @ XK @ ccple))) => ((! [Xf1:$i] : (cwceq @ (XH @ Xf1) @ (ccfv @ XK @ cclh))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (cwceq @ (Xc_0 @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccres @ ccid @ (XB2 @ Xf1)))))) => ((! [Xf1:$i] : (cwceq @ (XJ @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdia)))) => ((! [Xf1:$i] : (cwceq @ (XI @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ (XV @ Xf1)) @ (cwcel @ XW @ (XH @ Xf1))) @ (cwa @ (cwcel @ (XX @ Xf1) @ (XB2 @ Xf1)) @ (cwbr @ (XX @ Xf1) @ XW @ (Xc_le @ Xf1)))) @ (cwb @ (cwcel @ (ccop @ (XF @ Xf1) @ (XS @ Xf1)) @ (ccfv @ (XX @ Xf1) @ (XI @ Xf1))) @ (cwa @ (cwcel @ (XF @ Xf1) @ (ccfv @ (XX @ Xf1) @ (XJ @ Xf1))) @ (cwceq @ (XS @ Xf1) @ (Xc_0 @ Xf1))))))))))))))))))))))))))).
...
thf(adiblsmopel_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pb:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xf1:$i] : (cwceq @ (Xc_le @ Xf1) @ (ccfv @ XK @ ccple))) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (cwceq @ (XO @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccres @ ccid @ XB2))))) => ((! [Xf1:$i] : (cwceq @ (XV @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdveca)))) => ((! [Xf1:$i] : (cwceq @ (XU @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xf1:$i] : (cwceq @ (Xc_po @ Xf1) @ (ccfv @ (XV @ Xf1) @ cclsm))) => ((! [Xf1:$i] : (cwceq @ (Xc_pb @ Xf1) @ (ccfv @ (XU @ Xf1) @ cclsm))) => ((! [Xf1:$i] : (cwceq @ (XJ @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdia)))) => ((! [Xf1:$i] : (cwceq @ (XI @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwa @ (cwcel @ (XX @ Xf1) @ XB2) @ (cwbr @ (XX @ Xf1) @ XW @ (Xc_le @ Xf1))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwa @ (cwcel @ (XY @ Xf1) @ XB2) @ (cwbr @ (XY @ Xf1) @ XW @ (Xc_le @ Xf1))))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwb @ (cwcel @ (ccop @ (XF @ Xf1) @ (XS @ Xf1)) @ (cco @ (ccfv @ (XX @ Xf1) @ (XI @ Xf1)) @ (ccfv @ (XY @ Xf1) @ (XI @ Xf1)) @ (Xc_pb @ Xf1))) @ (cwa @ (cwcel @ (XF @ Xf1) @ (cco @ (ccfv @ (XX @ Xf1) @ (XJ @ Xf1)) @ (ccfv @ (XY @ Xf1) @ (XJ @ Xf1)) @ (Xc_po @ Xf1))) @ (cwceq @ (XS @ Xf1) @ (XO @ Xf1))))))))))))))))))))))))))))))))))))))).
...
thf(cdih2dimbALTN_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwa @ (cwcel @ XP @ XA2) @ (cwbr @ XP @ XW @ Xc_le))) => ((cwi @ Xph @ (cwa @ (cwcel @ XQ @ XA2) @ (cwbr @ XQ @ XW @ Xc_le))) => (cwi @ Xph @ (cwss @ (ccfv @ (cco @ XP @ XQ @ Xc_or) @ XI) @ (cco @ (ccfv @ XP @ XI) @ (ccfv @ XQ @ XI) @ Xc_po)))))))))))))))))))))))))).
