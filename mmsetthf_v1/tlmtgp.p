...
thf(atlmlmod_thm,axiom,(! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ cctlm) @ (cwcel @ XW @ cclmod)))).
thf(ccmulr_tp,type,(ccmulr : ($i > $o))).
thf(ccplusg_tp,type,(ccplusg : ($i > $o))).
thf(cwa_tp,type,(cwa : ($o > ($o > $o)))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(almodgrp_thm,axiom,(! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ cclmod) @ (cwcel @ XW @ ccgrp)))).
thf(atlmtmd_thm,axiom,(! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ cctlm) @ (cwcel @ XW @ cctmd)))).
...
thf(acnmpt1vsca_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((! [Xx3:$i] : (cwceq @ (Xc_x @ Xx3) @ (ccfv @ XW @ ccvsca))) => ((cwceq @ XJ @ (ccfv @ XW @ cctopn)) => ((cwceq @ XK @ (ccfv @ XF @ cctopn)) => ((cwi @ Xph @ (cwcel @ XW @ cctlm)) => ((cwi @ Xph @ (cwcel @ XL @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XL @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XL @ XJ @ cccn))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (Xc_x @ Xx3)))) @ (cco @ XL @ XJ @ cccn)))))))))))))))))))))).
...
thf(ctlmtgp_conj,conjecture,(! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ cctlm) @ (cwcel @ XW @ cctgp)))).
