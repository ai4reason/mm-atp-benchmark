...
thf(aelpreq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ (ccpr @ XA2 @ XB2))) => ((cwi @ Xph @ (cwcel @ XY @ (ccpr @ XA2 @ XB2))) => ((cwi @ Xph @ (cwb @ (cwceq @ XX @ XA2) @ (cwceq @ XY @ XA2))) => (cwi @ Xph @ (cwceq @ XX @ XY))))))))))).
...
thf(cindpreima_conj,conjecture,(! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XO @ XV) @ (cwf @ XO @ (ccpr @ ccc0 @ cc1) @ XF)) @ (cwceq @ XF @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ cc1)) @ (ccfv @ XO @ ccind)))))))).
