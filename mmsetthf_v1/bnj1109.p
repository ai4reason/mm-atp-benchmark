...
thf(cbnj1109_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwex @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwne @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (Xph @ Xx3)) @ (Xps @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (Xph @ Xx3)) @ (Xps @ Xx3))) => (cwex @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (Xps @ Xx3))))))))))).
