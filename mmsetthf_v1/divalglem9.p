...
thf(adivalglem2_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : (cwceq @ (XS @ Xr) @ (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => (! [Xr:$i] : (cwcel @ (ccinf @ (XS @ Xr) @ ccr @ cclt) @ (XS @ Xr))))))))))).
thf(asimpri_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwa @ Xph @ Xps) => Xps)))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(adivalglem5_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : (cwceq @ (XS @ Xr) @ (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => ((! [Xr:$i] : (cwceq @ (XR @ Xr) @ (ccinf @ (XS @ Xr) @ ccr @ cclt))) => (! [Xr:$i] : (cwa @ (cwbr @ ccc0 @ (XR @ Xr) @ ccle) @ (cwbr @ (XR @ Xr) @ (ccfv @ XD @ ccabs) @ cclt))))))))))))).
...
thf(adivalglem8_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : (cwceq @ (XS @ Xr) @ (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => (! [Xr:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (XX @ Xr) @ (XS @ Xr)) @ (cwcel @ (XY @ Xr) @ (XS @ Xr))) @ (cwa @ (cwbr @ (XX @ Xr) @ (ccfv @ XD @ ccabs) @ cclt) @ (cwbr @ (XY @ Xr) @ (ccfv @ XD @ ccabs) @ cclt))) @ (cwi @ (cwcel @ (XK @ Xr) @ ccz) @ (cwi @ (cwceq @ (cco @ (XK @ Xr) @ (ccfv @ XD @ ccabs) @ ccmul) @ (cco @ (XY @ Xr) @ (XX @ Xr) @ ccmin)) @ (cwceq @ (XX @ Xr) @ (XY @ Xr))))))))))))))))).
...
thf(cdivalglem9_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : (cwceq @ (XS @ Xr) @ (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => ((! [Xr:$i] : (cwceq @ (XR @ Xr) @ (ccinf @ (XS @ Xr) @ ccr @ cclt))) => (! [Xr:$i] : (cwreu @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XD @ ccabs) @ cclt)) @ (^ [Xx3:$i] : (XS @ Xr)))))))))))))).
