...
thf(aelovmpt2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XD @ Xa @ Xb) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XA2)) @ (^ [Xa:$i] : (^ [Xb:$i] : XB2)) @ (^ [Xa:$i] : (^ [Xb:$i] : (XC @ Xa @ Xb))))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwcel @ (XC @ Xa @ Xb) @ ccvv))) => ((! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xa) @ XX) @ (cwceq @ (ccv @ Xb) @ XY)) @ (cwceq @ (XC @ Xa @ Xb) @ XE)))) => (! [Xa:$i] : (! [Xb:$i] : (cwb @ (cwcel @ XF @ (cco @ XX @ XY @ (XD @ Xa @ Xb))) @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2) @ (cwcel @ XF @ XE))))))))))))))))).
thf(adf_gim_ax,axiom,(cwceq @ ccgim @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : ccgrp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : ccgrp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccrab @ (^ [Xg1:$i] : (cwf1o @ (ccfv @ (ccv @ Xs1) @ ccbs) @ (ccfv @ (ccv @ Xt) @ ccbs) @ (ccv @ Xg1))) @ (^ [Xg1:$i] : (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ ccghm)))))))).
...
thf(cisgim_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (ccfv @ XS @ ccbs)) => (cwb @ (cwcel @ XF @ (cco @ XR @ XS @ ccgim)) @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ ccghm)) @ (cwf1o @ XB2 @ XC @ XF))))))))))).
