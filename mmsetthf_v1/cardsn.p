...
thf(acard1_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ cc1o) @ (cwex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsn @ (ccv @ Xx3)))))))).
thf(ccardsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (ccfv @ (ccsn @ XA2) @ cccrd) @ cc1o))))).
