...
thf(cfproddvdsd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xx3) @ ccz))) => (cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xx3)) @ (^ [Xk:$i] : (ccv @ Xk))) @ ccdvds)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
