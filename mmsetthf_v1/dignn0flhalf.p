...
thf(ann0eo_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwo @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0))))).
...
thf(azefldiv2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccz)) @ (cwceq @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ (cco @ XN @ cc2 @ ccdiv))))).
...
thf(adignn0flhalflem2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccdiv) @ ccfl) @ (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccfl) @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl)))))).
...
thf(cdignn0flhalf_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XI @ ccn0)) @ (cwceq @ (cco @ (cco @ XI @ cc1 @ ccaddc) @ XA2 @ (ccfv @ cc2 @ ccdig)) @ (cco @ XI @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccfl) @ (ccfv @ cc2 @ ccdig))))))).
