...
thf(clmhmvsca_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XN @ ccvsca)) => ((cwceq @ XJ @ (ccfv @ XN @ ccsca)) => ((cwceq @ XK @ (ccfv @ XJ @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XJ @ cccrg) @ (cwcel @ XA2 @ XK) @ (cwcel @ XF @ (cco @ XM @ XN @ cclmhm))) @ (cwcel @ (cco @ (ccxp @ XV @ (ccsn @ XA2)) @ XF @ (ccof @ Xc_x)) @ (cco @ XM @ XN @ cclmhm)))))))))))))))).
