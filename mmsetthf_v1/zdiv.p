...
thf(czdiv_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwrex @ (^ [Xk:$i] : (cwceq @ (cco @ XM @ (ccv @ Xk) @ ccmul) @ XN)) @ (^ [Xk:$i] : ccz)) @ (cwcel @ (cco @ XN @ XM @ ccdiv) @ ccz)))))).
