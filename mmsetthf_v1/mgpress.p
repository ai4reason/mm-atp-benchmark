...
thf(amgpval_thm,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwceq @ XM @ (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_x) @ ccsts)))))))).
thf(aressval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (cco @ XW @ XA2 @ ccress)) => ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => (cwi @ (cw3a @ (cwn @ (cwss @ XB2 @ XA2)) @ (cwcel @ XW @ XX) @ (cwcel @ XA2 @ XY)) @ (cwceq @ XR @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccin @ XA2 @ XB2)) @ ccsts)))))))))))).
...
thf(asetscom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwa @ (cwcel @ XS @ XV) @ (cwne @ XA2 @ XB2)) @ (cwa @ (cwcel @ XC @ XW) @ (cwcel @ XD @ XX))) @ (cwceq @ (cco @ (cco @ XS @ (ccop @ XA2 @ XC) @ ccsts) @ (ccop @ XB2 @ XD) @ ccsts) @ (cco @ (cco @ XS @ (ccop @ XB2 @ XD) @ ccsts) @ (ccop @ XA2 @ XC) @ ccsts)))))))))))))).
thf(cmgpress_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (cco @ XR @ XA2 @ ccress)) => ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XA2 @ XW)) @ (cwceq @ (cco @ XM @ XA2 @ ccress) @ (ccfv @ XS @ ccmgp)))))))))))).
