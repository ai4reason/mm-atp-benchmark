...
thf(cfargshiftfva_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xl:$i] : (cwceq @ (XG @ Xx3 @ Xl) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (ccdm @ XE) @ XF)) @ (cwi @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XE) @ (ccsb @ (ccv @ Xk) @ (^ [Xx3:$i] : (XP @ Xx3))))) @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz))) @ (cwral @ (^ [Xl:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xl) @ (XG @ Xx3 @ Xl)) @ XE) @ (ccsb @ (cco @ (ccv @ Xl) @ cc1 @ ccaddc) @ (^ [Xx3:$i] : (XP @ Xx3))))) @ (^ [Xl:$i] : (cco @ ccc0 @ XN @ ccfzo))))))))))))).
