...
thf(cumgredg2_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwcel @ XX @ (ccdm @ XE))) @ (cwceq @ (ccfv @ (ccfv @ XX @ XE) @ cchash) @ cc2))))))))).
