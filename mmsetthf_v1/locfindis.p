...
thf(alfinpfin_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ XJ @ cclocfin)) @ (cwcel @ XA2 @ ccptfin))))).
...
thf(clocfindis_conj,conjecture,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccuni @ XC)) => (cwb @ (cwcel @ XC @ (ccfv @ (ccpw @ XX) @ cclocfin)) @ (cwa @ (cwcel @ XC @ ccptfin) @ (cwceq @ XX @ XY)))))))).
