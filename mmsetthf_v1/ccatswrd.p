...
thf(afzass4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwb @ (cwa @ (cwcel @ XB2 @ (cco @ XA2 @ XD @ ccfz)) @ (cwcel @ XC @ (cco @ XB2 @ XD @ ccfz))) @ (cwa @ (cwcel @ XB2 @ (cco @ XA2 @ XC @ ccfz)) @ (cwcel @ XC @ (cco @ XA2 @ XD @ ccfz))))))))).
...
thf(afzosubel3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ XB2 @ (cco @ XB2 @ XD @ ccaddc) @ ccfzo)) @ (cwcel @ XD @ ccz)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ ccc0 @ XD @ ccfzo))))))).
...
thf(cccatswrd_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XA2)) @ (cw3a @ (cwcel @ XX @ (cco @ ccc0 @ XY @ ccfz)) @ (cwcel @ XY @ (cco @ ccc0 @ XZ @ ccfz)) @ (cwcel @ XZ @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz)))) @ (cwceq @ (cco @ (cco @ XS @ (ccop @ XX @ XY) @ ccsubstr) @ (cco @ XS @ (ccop @ XY @ XZ) @ ccsubstr) @ ccconcat) @ (cco @ XS @ (ccop @ XX @ XZ) @ ccsubstr))))))))).
