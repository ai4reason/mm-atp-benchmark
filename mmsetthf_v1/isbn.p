...
thf(adf_bn_ax,axiom,(cwceq @ ccbn @ (ccrab @ (^ [Xw:$i] : (cwcel @ (ccfv @ (ccv @ Xw) @ ccsca) @ cccms)) @ (^ [Xw:$i] : (ccin @ ccnvc @ cccms))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cisbn_conj,conjecture,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => (cwb @ (cwcel @ XW @ ccbn) @ (cw3a @ (cwcel @ XW @ ccnvc) @ (cwcel @ XW @ cccms) @ (cwcel @ XF @ cccms))))))).
