...
thf(cltexp2r_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwbr @ XA2 @ cc1 @ cclt)) @ (cwb @ (cwbr @ XM @ XN @ cclt) @ (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ cclt))))))).
