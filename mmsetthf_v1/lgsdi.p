...
thf(algsdilem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwne @ XA2 @ ccc0) @ (cwne @ XB2 @ ccc0))) @ (cwceq @ (ccif @ (cwa @ (cwbr @ XN @ ccc0 @ cclt) @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (cco @ (ccif @ (cwa @ (cwbr @ XN @ ccc0 @ cclt) @ (cwbr @ XA2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccif @ (cwa @ (cwbr @ XN @ ccc0 @ cclt) @ (cwbr @ XB2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ ccmul))))))).
...
thf(apcmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwne @ XB2 @ ccc0))) @ (cwceq @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccmul) @ ccpc) @ (cco @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccaddc))))))).
...
thf(clgsdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwne @ XM @ ccc0) @ (cwne @ XN @ ccc0))) @ (cwceq @ (cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ cclgs) @ (cco @ (cco @ XA2 @ XM @ cclgs) @ (cco @ XA2 @ XN @ cclgs) @ ccmul))))))).
