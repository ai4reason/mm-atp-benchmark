...
thf(atngtopn_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ XD @ (ccfv @ XT @ ccds)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XG @ XV) @ (cwcel @ XN @ XW)) @ (cwceq @ XJ @ (ccfv @ XT @ cctopn)))))))))))))).
...
thf(ctchtopn_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwi @ (cwcel @ XW @ XV) @ (cwceq @ XJ @ (ccfv @ XD @ ccmopn)))))))))))).
