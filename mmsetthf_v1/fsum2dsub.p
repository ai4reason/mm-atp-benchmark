...
thf(auzneg_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwcel @ (ccneg @ XM) @ (ccfv @ (ccneg @ XN) @ ccuz)))))).
...
thf(aeluzmn_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccn0)) @ (cwcel @ XM @ (ccfv @ (cco @ XM @ XN @ ccmin) @ ccuz)))))).
