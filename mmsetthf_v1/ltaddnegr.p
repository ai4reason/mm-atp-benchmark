...
thf(altaddneg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ XA2 @ ccc0 @ cclt) @ (cwbr @ (cco @ XB2 @ XA2 @ ccaddc) @ XB2 @ cclt)))))).
...
thf(cltaddnegr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ XA2 @ ccc0 @ cclt) @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XB2 @ cclt)))))).
