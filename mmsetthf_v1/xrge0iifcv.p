...
thf(cxrge0iifcv_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog))))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccioc)) @ (cwceq @ (ccfv @ XX @ (XF @ Xx3)) @ (ccneg @ (ccfv @ XX @ cclog))))))))).
