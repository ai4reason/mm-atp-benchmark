...
thf(a_3oalem1_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XR @ ccch) => ((cwcel @ XS @ ccch) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XR)) @ (cwceq @ (ccv @ Xv) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xz) @ XC) @ (cwcel @ (ccv @ Xw) @ XS)) @ (cwceq @ (ccv @ Xv) @ (cco @ (ccv @ Xz) @ (ccv @ Xw) @ ccva)))) @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ cchil) @ (cwcel @ (ccv @ Xy1) @ cchil)) @ (cwcel @ (ccv @ Xv) @ cchil)) @ (cwa @ (cwcel @ (ccv @ Xz) @ cchil) @ (cwcel @ (ccv @ Xw) @ cchil)))))))))))))))))).
...
thf(c_3oalem2_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XR @ ccch) => ((cwcel @ XS @ ccch) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XR)) @ (cwceq @ (ccv @ Xv) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xz) @ XC) @ (cwcel @ (ccv @ Xw) @ XS)) @ (cwceq @ (ccv @ Xv) @ (cco @ (ccv @ Xz) @ (ccv @ Xw) @ ccva)))) @ (cwcel @ (ccv @ Xv) @ (cco @ XB2 @ (ccin @ XR @ (cco @ XS @ (ccin @ (cco @ XB2 @ XC @ ccph) @ (cco @ XR @ XS @ ccph)) @ ccph)) @ ccph))))))))))))))))).
