...
thf(cdfnfc2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3 @ Xy1)))) @ (cwb @ (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwal @ (^ [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3)))))))))))).
