...
thf(atfr2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (ccrecs @ XG)) => (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ (ccres @ XF @ XA2) @ XG)))))))).
thf(adf_made_ax,axiom,(cwceq @ ccmade @ (ccrecs @ (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (ccima @ ccscut @ (ccxp @ (ccpw @ (ccuni @ (ccrn @ (ccv @ Xf1)))) @ (ccpw @ (ccuni @ (ccrn @ (ccv @ Xf1))))))))))).
...
thf(afunimaexg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwfun @ XA2) @ (cwcel @ XB2 @ XC)) @ (cwcel @ (ccima @ XA2 @ XB2) @ ccvv)))))).
...
thf(cmadeval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ ccmade) @ (ccima @ ccscut @ (ccxp @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))) @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))))))))).
