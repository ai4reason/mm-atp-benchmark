...
thf(ausgrislfuspgr_thm,axiom,(! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : (cwb @ (cwcel @ XG @ ccusgr) @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwf @ (ccdm @ (XI @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (XI @ Xx3))))))))))).
...
thf(cusgr1vr_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XX) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccsn @ XA2))) @ (cwi @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccfv @ XG @ cciedg) @ cc0))))))).
