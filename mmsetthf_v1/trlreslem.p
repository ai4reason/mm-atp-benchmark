...
thf(awlkreslem0_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccword @ XS)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ cchash) @ XN)))))).
...
thf(ctrlreslem_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls))) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) => ((cwceq @ XH @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo))) => (cwi @ Xph @ (cwf1o @ (cco @ ccc0 @ (ccfv @ XH @ cchash) @ ccfzo) @ (ccdm @ (ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ XN @ ccfzo)))) @ XH)))))))))))))))).
