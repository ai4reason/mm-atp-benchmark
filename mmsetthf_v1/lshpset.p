...
thf(adf_lshyp_ax,axiom,(cwceq @ cclsh @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : (cwa @ (cwne @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xw) @ ccbs)) @ (cwrex @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xv))) @ (ccfv @ (ccv @ Xw) @ cclspn)) @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xw) @ ccbs))))) @ (^ [Xs1:$i] : (ccfv @ (ccv @ Xw) @ cclss))))))).
