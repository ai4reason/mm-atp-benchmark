...
thf(catl0dm_conj,conjecture,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XU @ (ccfv @ XK @ cclub)) => ((cwceq @ XG @ (ccfv @ XK @ ccglb)) => (cwi @ (cwcel @ XK @ ccal) @ (cwcel @ XB2 @ (ccdm @ XG))))))))))).
