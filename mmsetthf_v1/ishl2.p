...
thf(acphnvc_thm,axiom,(! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ cccph) @ (cwcel @ XW @ ccnvc)))).
...
thf(cishl2_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwb @ (cwcel @ XW @ cchl) @ (cw3a @ (cwcel @ XW @ cccms) @ (cwcel @ XW @ cccph) @ (cwcel @ XK @ (ccpr @ ccr @ ccc)))))))))).
