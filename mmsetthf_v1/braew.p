...
thf(adf_ae_ax,axiom,(cwceq @ ccae @ (ccopab @ (^ [Xa:$i] : (^ [Xm:$i] : (cwceq @ (ccfv @ (ccdif @ (ccuni @ (ccdm @ (ccv @ Xm))) @ (ccv @ Xa)) @ (ccv @ Xm)) @ ccc0)))))).
...
thf(cbraew_conj,conjecture,(! [Xph:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (ccuni @ (ccdm @ (XM @ Xx3))) @ XO)) => (! [Xx3:$i] : (cwi @ (cwcel @ (XM @ Xx3) @ (ccuni @ (ccrn @ ccmeas))) @ (cwb @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwn @ (Xph @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3)) @ ccc0))))))))).
