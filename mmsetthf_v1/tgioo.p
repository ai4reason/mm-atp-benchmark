...
thf(ablssioo_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (cwss @ (ccrn @ (ccfv @ XD @ ccbl)) @ (ccrn @ ccioo))))).
...
thf(abasis2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ cctb) @ (cwcel @ XC @ XB2)) @ (cwa @ (cwcel @ XD @ XB2) @ (cwcel @ XA2 @ (ccin @ XC @ XD)))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ (ccin @ XC @ XD)))) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(aioo2blex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccioo) @ (ccrn @ (ccfv @ XD @ ccbl))))))))).
thf(ainss1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccin @ XA2 @ XB2) @ XA2)))).
thf(arspcev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ Xps) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(asylancr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(ablssex_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XA2))) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ XD @ ccbl)))) @ (cwrex @ (^ [Xr:$i] : (cwss @ (cco @ XP @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XA2)) @ (^ [Xr:$i] : ccrp))))))))).
...
thf(ctgioo_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XD @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwceq @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XJ)))))).
