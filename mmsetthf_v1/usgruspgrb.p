...
thf(aedgusgr_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg))) @ (cwa @ (cwcel @ XE @ (ccpw @ (ccfv @ XG @ ccvtx))) @ (cwceq @ (ccfv @ XE @ cchash) @ cc2)))))).
...
thf(cusgruspgrb_conj,conjecture,(! [XG:($i > $o)] : (cwb @ (cwcel @ XG @ ccusgr) @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwral @ (^ [Xe:$i] : (cwceq @ (ccfv @ (ccv @ Xe) @ cchash) @ cc2)) @ (^ [Xe:$i] : (ccfv @ XG @ ccedg))))))).
