...
thf(atz6_12c_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [Xy1:$i] : (cwi @ (cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF))) @ (cwb @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccv @ Xy1)) @ (cwbr @ XA2 @ (ccv @ Xy1) @ XF))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(abreq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwbr @ XC @ XA2 @ XR) @ (cwbr @ XC @ XB2 @ XR)))))))).
thf(ctz6_12i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwne @ XB2 @ cc0) @ (cwi @ (cwceq @ (ccfv @ XA2 @ XF) @ XB2) @ (cwbr @ XA2 @ XB2 @ XF))))))).
