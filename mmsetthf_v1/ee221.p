...
thf(cee221_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xph @ (cwi @ Xps @ Xth)) => ((cwi @ Xph @ Xta) => ((cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwi @ Xph @ (cwi @ Xps @ Xet))))))))))))).
