...
thf(anbuhgr_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xn:$i] : (cwceq @ (XE @ Xn) @ (ccfv @ XG @ ccedg))) => (cwi @ (cwa @ (cwcel @ XG @ ccuhgr) @ (cwcel @ XN @ XX)) @ (cwceq @ (cco @ XG @ XN @ ccnbgr) @ (ccrab @ (^ [Xn:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XN @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xn)))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))))))).
...
thf(cuhgrnbgr0nb_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccuhgr) @ (cwral @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccfv @ XG @ ccedg)))) @ (cwceq @ (cco @ XG @ XN @ ccnbgr) @ cc0))))).
