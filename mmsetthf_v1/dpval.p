...
thf(adf_dp_ax,axiom,(cwceq @ ccdp @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdp2 @ (ccv @ Xx3) @ (ccv @ Xy1))))))).
thf(aovexi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ (cco @ XB2 @ XC @ XF)) => (cwcel @ XA2 @ ccvv))))))).
thf(cdpval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccdp) @ (ccdp2 @ XA2 @ XB2)))))).
