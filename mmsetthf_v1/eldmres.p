...
thf(celdmres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwcel @ XB2 @ (XV @ Xy1)) @ (cwb @ (cwcel @ XB2 @ (ccdm @ (ccres @ XR @ XA2))) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwex @ (^ [Xy1:$i] : (cwbr @ XB2 @ (ccv @ Xy1) @ XR)))))))))))).
