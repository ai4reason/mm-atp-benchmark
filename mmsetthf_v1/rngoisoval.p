...
thf(adf_rngoiso_ax,axiom,(cwceq @ ccrngiso @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrngo)) @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrngo)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccrab @ (^ [Xf1:$i] : (cwf1o @ (ccrn @ (ccfv @ (ccv @ Xr) @ cc1st)) @ (ccrn @ (ccfv @ (ccv @ Xs1) @ cc1st)) @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccrnghom)))))))).
thf(arabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(crngoisoval_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XG @ Xf1) @ (ccfv @ XR @ cc1st))) => ((! [Xf1:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xf1)))) => ((! [Xf1:$i] : (cwceq @ (XJ @ Xf1) @ (ccfv @ XS @ cc1st))) => ((! [Xf1:$i] : (cwceq @ XY @ (ccrn @ (XJ @ Xf1)))) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo)) @ (cwceq @ (cco @ XR @ XS @ ccrngiso) @ (ccrab @ (^ [Xf1:$i] : (cwf1o @ XX @ XY @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ XR @ XS @ ccrnghom)))))))))))))))).
