...
thf(aditgeq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccdit @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3))) @ (ccdit @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3)))))))))).
