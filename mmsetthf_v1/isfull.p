...
thf(adf_full_ax,axiom,(cwceq @ ccful @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xg1) @ (cco @ (ccv @ Xc) @ (ccv @ Xd) @ ccfunc)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccrn @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1))) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xd) @ cchom)))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xc) @ ccbs)))))))))))).
...
thf(cisfull_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XJ @ (ccfv @ XD @ cchom)) => (cwb @ (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccful)) @ (cwa @ (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfunc)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccrn @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG)) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XJ))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))).
