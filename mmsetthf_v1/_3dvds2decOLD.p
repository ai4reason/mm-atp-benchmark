...
thf(a_3decOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => (cwceq @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ (cco @ (cco @ (cco @ (cco @ cc10 @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ cc10 @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
...
thf(asq10e99m1OLD_thm,axiom,(cwceq @ (cco @ cc10 @ cc2 @ ccexp) @ (cco @ (ccdc @ cc9 @ cc9) @ cc1 @ ccaddc))).
...
thf(c_3dvds2decOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => (cwb @ (cwbr @ cc3 @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ ccdvds) @ (cwbr @ cc3 @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccaddc) @ ccdvds))))))))).
