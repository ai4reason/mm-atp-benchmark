...
thf(cswrdccat1_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2))) @ (cwceq @ (cco @ (cco @ XS @ XT @ ccconcat) @ (ccop @ ccc0 @ (ccfv @ XS @ cchash)) @ ccsubstr) @ XS)))))).
