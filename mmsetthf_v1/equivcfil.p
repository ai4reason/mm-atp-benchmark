...
thf(aiscfil3_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwb @ (cwcel @ XF @ (ccfv @ XD @ cccfil)) @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XF)) @ (^ [Xx3:$i] : XX))) @ (^ [Xr:$i] : ccrp))))))))).
thf(cequivcfil_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ (cco @ XR @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccmul) @ ccle)))) => (cwi @ Xph @ (cwss @ (ccfv @ XD @ cccfil) @ (ccfv @ XC @ cccfil))))))))))))).
