...
thf(adf_cusp_ax,axiom,(cwceq @ cccusp @ (ccrab @ (^ [Xw:$i] : (cwral @ (^ [Xc:$i] : (cwi @ (cwcel @ (ccv @ Xc) @ (ccfv @ (ccfv @ (ccv @ Xw) @ ccuss) @ cccfilu)) @ (cwne @ (cco @ (ccfv @ (ccv @ Xw) @ cctopn) @ (ccv @ Xc) @ ccflim) @ cc0))) @ (^ [Xc:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ ccbs) @ ccfil)))) @ (^ [Xw:$i] : ccusp)))).
thf(ciscusp_conj,conjecture,(! [XW:($i > $o)] : (cwb @ (cwcel @ XW @ cccusp) @ (cwa @ (cwcel @ XW @ ccusp) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwcel @ (ccv @ Xc) @ (ccfv @ (ccfv @ XW @ ccuss) @ cccfilu)) @ (cwne @ (cco @ (ccfv @ XW @ cctopn) @ (ccv @ Xc) @ ccflim) @ cc0))) @ (^ [Xc:$i] : (ccfv @ (ccfv @ XW @ ccbs) @ ccfil))))))).
