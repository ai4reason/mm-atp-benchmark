...
thf(aclimprod1_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => (cwi @ Xph @ (cwbr @ (ccseq @ ccmul @ (ccxp @ XZ @ (ccsn @ cc1)) @ XM) @ cc1 @ ccli)))))))).
...
thf(afaclimlem2_thm,axiom,(! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ ccn0) @ (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ XM @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccmul) @ (cco @ cc1 @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccdiv))) @ cc1) @ (cco @ XM @ cc1 @ ccaddc) @ ccli)))).
...
thf(cfaclim_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ XA2 @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwbr @ (ccseq @ ccmul @ (XF @ Xn) @ cc1) @ (ccfv @ XA2 @ ccfa) @ ccli))))))).
