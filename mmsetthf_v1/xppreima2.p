...
thf(axppreima_thm,axiom,(! [XF:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ (ccrn @ XF) @ (ccxp @ ccvv @ ccvv))) @ (cwceq @ (ccima @ (cccnv @ XF) @ (ccxp @ XY @ XZ)) @ (ccin @ (ccima @ (cccnv @ (cccom @ cc1st @ XF)) @ XY) @ (ccima @ (cccnv @ (cccom @ cc2nd @ XF)) @ XZ)))))))).
...
thf(aopfv_thm,axiom,(! [Xx3:$i] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwfun @ XF) @ (cwss @ (ccrn @ XF) @ (ccxp @ ccvv @ ccvv))) @ (cwcel @ (ccv @ Xx3) @ (ccdm @ XF))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccop @ (ccfv @ (ccv @ Xx3) @ (cccom @ cc1st @ XF)) @ (ccfv @ (ccv @ Xx3) @ (cccom @ cc2nd @ XF)))))))).
