...
thf(ciinpreima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwne @ XA2 @ cc0)) @ (cwceq @ (ccima @ (cccnv @ XF) @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (XB2 @ Xx3)))))))))).
