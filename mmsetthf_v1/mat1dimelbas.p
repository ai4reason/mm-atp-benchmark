...
thf(af1o2sn_thm,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XE @ XV) @ (cwcel @ XX @ XW)) @ (cwf1o @ (ccxp @ (ccsn @ XE) @ (ccsn @ XE)) @ (ccsn @ XX) @ (ccsn @ (ccop @ (ccop @ XE @ XE) @ XX))))))))).
...
thf(cmat1dimelbas_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xr:$i] : (cwceq @ (XA2 @ Xr) @ (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xr:$i] : (cwceq @ (XO @ Xr) @ (ccop @ XE @ XE))) => (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV)) @ (cwb @ (cwcel @ XM @ (ccfv @ (XA2 @ Xr) @ ccbs)) @ (cwrex @ (^ [Xr:$i] : (cwceq @ XM @ (ccsn @ (ccop @ (XO @ Xr) @ (ccv @ Xr))))) @ (^ [Xr:$i] : XB2)))))))))))))))).
