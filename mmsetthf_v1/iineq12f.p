...
thf(ciineq12f_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (XC @ Xx3) @ (XD @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ (cwceq @ (cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cciin @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XD @ Xx3))))))))))))).
