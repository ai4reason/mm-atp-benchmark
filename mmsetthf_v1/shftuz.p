...
thf(cshftuz_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccfv @ XB2 @ ccuz))) @ (^ [Xx3:$i] : ccc)) @ (ccfv @ (cco @ XB2 @ XA2 @ ccaddc) @ ccuz)))))).
