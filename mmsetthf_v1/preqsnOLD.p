...
thf(apreq12b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (cwb @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ (cwo @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)) @ (cwa @ (cwceq @ XA2 @ XD) @ (cwceq @ XB2 @ XC))))))))))))).
...
thf(cpreqsnOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccsn @ XC)) @ (cwa @ (cwceq @ XA2 @ XB2) @ (cwceq @ XB2 @ XC)))))))))).
