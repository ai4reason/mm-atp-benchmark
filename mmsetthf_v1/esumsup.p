...
thf(cesumsup_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (cwi @ Xph @ (cwceq @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk)))))) @ ccxr @ cclt))))))))).
