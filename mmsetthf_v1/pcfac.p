...
thf(apcfaclem_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (ccfv @ (cco @ XN @ (cco @ XP @ XM @ ccexp) @ ccdiv) @ ccfl) @ ccc0)))))).
...
thf(afldivp1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ (ccfv @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccdiv) @ ccfl) @ (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccfl) @ ccmin) @ (ccif @ (cwbr @ XN @ (cco @ XM @ cc1 @ ccaddc) @ ccdvds) @ cc1 @ ccc0)))))).
...
thf(asumhash_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ ccfn) @ (cwss @ XA2 @ XB2)) @ (cwceq @ (ccsu @ XB2 @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ cc1 @ ccc0))) @ (ccfv @ XA2 @ cchash)))))).
...
thf(cpcfac_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (cco @ XP @ (ccfv @ XN @ ccfa) @ ccpc) @ (ccsu @ (cco @ cc1 @ XM @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ XN @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl))))))))).
