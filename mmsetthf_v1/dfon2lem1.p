...
thf(atruni_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwtr @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwtr @ (ccuni @ XA2))))).
...
thf(cdfon2lem1_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwtr @ (ccuni @ (ccab @ (^ [Xx3:$i] : (cw3a @ (Xph @ Xx3) @ (cwtr @ (ccv @ Xx3)) @ (Xps @ Xx3))))))))).
