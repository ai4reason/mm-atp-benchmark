...
thf(acos2kpi_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ cccos) @ cc1)))).
...
thf(ccoskpi2_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ XK @ ccpi @ ccmul) @ cccos) @ (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
