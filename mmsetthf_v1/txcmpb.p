...
thf(ctxcmpb_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XR)) => ((cwceq @ XY @ (ccuni @ XS)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ cctop)) @ (cwa @ (cwne @ XX @ cc0) @ (cwne @ XY @ cc0))) @ (cwb @ (cwcel @ (cco @ XR @ XS @ cctx) @ cccmp) @ (cwa @ (cwcel @ XR @ cccmp) @ (cwcel @ XS @ cccmp))))))))))).
