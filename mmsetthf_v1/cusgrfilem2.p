...
thf(apreqr1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwceq @ (ccpr @ XA2 @ XC) @ (ccpr @ XB2 @ XC)) @ (cwceq @ XA2 @ XB2)))))))).
...
thf(ccusgrfilem2_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xa:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xa) @ ccvtx))) => ((! [Xa:$i] : (cwceq @ (XP @ Xa) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xa:$i] : (cwa @ (cwne @ (ccv @ Xa) @ XN) @ (cwceq @ (ccv @ Xx3) @ (ccpr @ (ccv @ Xa) @ XN)))) @ (^ [Xa:$i] : XV))) @ (^ [Xx3:$i] : (ccpw @ XV))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XF @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ XV @ (ccsn @ XN))) @ (^ [Xx3:$i] : (ccpr @ (ccv @ Xx3) @ XN)))))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwcel @ XN @ XV) @ (cwf1o @ (ccdif @ XV @ (ccsn @ XN)) @ (XP @ Xa) @ (XF @ Xx3 @ Xa)))))))))))))).
