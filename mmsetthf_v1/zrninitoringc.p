...
thf(czrninitoringc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XU @ Xr) @ (XV @ Xr)))) => ((! [Xr:$i] : (cwceq @ XC @ (ccfv @ (XU @ Xr) @ ccringc))) => ((cwi @ Xph @ (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ XZ @ (XU @ Xr)))) => ((cwi @ Xph @ (cwrex @ (^ [Xr:$i] : (cwcel @ (ccv @ Xr) @ ccnzr)) @ (^ [Xr:$i] : (ccfv @ XC @ ccbs)))) => (cwi @ Xph @ (cwnel @ XZ @ (ccfv @ XC @ ccinito)))))))))))))).
