...
thf(adipsubdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cwa @ (cwcel @ XU @ cccphlo) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ XM) @ XP) @ (cco @ (cco @ XA2 @ XB2 @ XP) @ (cco @ XA2 @ XC @ XP) @ ccmin)))))))))))))).
...
thf(adipassr2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cwa @ (cwcel @ XU @ cccphlo) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ XX))) @ (cwceq @ (cco @ XA2 @ (cco @ (ccfv @ XB2 @ cccj) @ XC @ XS) @ XP) @ (cco @ XB2 @ (cco @ XA2 @ XC @ XP) @ ccmul)))))))))))))).
...
thf(csiilem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XA2 @ XX) => ((cwcel @ XB2 @ XX) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwcel @ XC @ ccc) => ((cwcel @ (cco @ XC @ (cco @ XA2 @ XB2 @ XP) @ ccmul) @ ccr) => ((cwbr @ ccc0 @ (cco @ XC @ (cco @ XA2 @ XB2 @ XP) @ ccmul) @ ccle) => (cwi @ (cwceq @ (cco @ XB2 @ XA2 @ XP) @ (cco @ XC @ (cco @ (ccfv @ XB2 @ XN) @ cc2 @ ccexp) @ ccmul)) @ (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ XP) @ (cco @ XC @ (cco @ (ccfv @ XB2 @ XN) @ cc2 @ ccexp) @ ccmul) @ ccmul) @ ccsqrt) @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccmul) @ ccle))))))))))))))))))))))).
