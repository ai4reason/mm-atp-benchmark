...
thf(ar0cld_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ (ccfv @ XJ @ cckq) @ cct1) @ (cwcel @ XA2 @ XX)) @ (cwcel @ (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xo:$i] : (cwb @ (cwcel @ (ccv @ Xz) @ (ccv @ Xo)) @ (cwcel @ XA2 @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ))) @ (^ [Xz:$i] : XX)) @ (ccfv @ XJ @ cccld))))))))).
...
thf(cnrmr0reg_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccnrm) @ (cwcel @ (ccfv @ XJ @ cckq) @ cct1)) @ (cwcel @ XJ @ ccreg)))).
