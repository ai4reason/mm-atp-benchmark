...
thf(asinq12ge0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ ccle)))).
...
thf(csin2h_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ cc2 @ ccpi @ ccmul) @ ccicc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) @ (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccmin) @ cc2 @ ccdiv) @ ccsqrt))))).
