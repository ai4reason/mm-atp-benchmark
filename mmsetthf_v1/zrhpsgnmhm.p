...
thf(acnmsgnsubg_thm,axiom,(! [XM:($i > $o)] : ((cwceq @ XM @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => (cwcel @ (ccpr @ cc1 @ (ccneg @ cc1)) @ (ccfv @ XM @ ccsubg))))).
...
thf(asubsubm_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => (cwi @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XH @ ccsubmnd)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XG @ ccsubmnd)) @ (cwss @ XA2 @ XS)))))))))).
...
thf(aresmhm2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XU @ ccmhm)) @ (cwcel @ XX @ (ccfv @ XT @ ccsubmnd))) @ (cwcel @ XF @ (cco @ XS @ XT @ ccmhm)))))))))).
...
thf(czrhpsgnmhm_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ (cccom @ (ccfv @ XR @ cczrh) @ (ccfv @ XA2 @ ccpsgn)) @ (cco @ (ccfv @ XA2 @ ccsymg) @ (ccfv @ XR @ ccmgp) @ ccmhm)))))).
