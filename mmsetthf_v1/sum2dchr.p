...
thf(asumdchr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XZ @ Xx3) @ (ccfv @ XN @ cczn))) => ((! [Xx3:$i] : (cwceq @ Xc_1 @ (ccfv @ (XZ @ Xx3) @ ccur))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XZ @ Xx3) @ ccbs))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XB2 @ Xx3)))) => (cwi @ Xph @ (cwceq @ (ccsu @ XD @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccv @ Xx3)))) @ (ccif @ (cwceq @ XA2 @ Xc_1) @ (ccfv @ XN @ ccphi) @ ccc0))))))))))))))))))).
...
thf(advreq1_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XU)) @ (cwb @ (cwceq @ (cco @ XX @ XY @ Xc_dv) @ Xc_1) @ (cwceq @ XX @ XY))))))))))))))).
thf(csum2dchr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ XZ @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ XZ @ ccui))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XC @ (XU @ Xx3)))) => (cwi @ Xph @ (cwceq @ (ccsu @ XD @ (^ [Xx3:$i] : (cco @ (ccfv @ XA2 @ (ccv @ Xx3)) @ (ccfv @ (ccfv @ XC @ (ccv @ Xx3)) @ cccj) @ ccmul))) @ (ccif @ (cwceq @ XA2 @ XC) @ (ccfv @ XN @ ccphi) @ ccc0))))))))))))))))))))).
