...
thf(creueubd_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (Xps @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ (XV @ Xx3)))) => (cwi @ Xph @ (cwb @ (cwreu @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XV @ Xx3))) @ (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))))))))).
