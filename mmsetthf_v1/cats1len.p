...
thf(ccats1len_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XT @ (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwcel @ XS @ (ccword @ ccvv)) => ((cwceq @ (ccfv @ XS @ cchash) @ XM) => ((cwceq @ (cco @ XM @ cc1 @ ccaddc) @ XN) => (cwceq @ (ccfv @ XT @ cchash) @ XN))))))))))).
