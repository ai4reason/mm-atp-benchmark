...
thf(cshless_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh) @ (cwcel @ XC @ ccsh)) @ (cwss @ XA2 @ XB2)) @ (cwss @ (cco @ XA2 @ XC @ ccph) @ (cco @ XB2 @ XC @ ccph))))))).
