...
thf(axleadd1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XC @ ccxad) @ (cco @ XB2 @ XC @ ccxad) @ ccle))))))))))).
...
thf(csge0prle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((cwi @ Xph @ (cwcel @ XE @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XA2) @ (cwceq @ (XC @ Xk) @ XD))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XB2) @ (cwceq @ (XC @ Xk) @ XE))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ (cco @ XD @ XE @ ccxad) @ ccle))))))))))))))))).
