...
thf(aovolunlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwa @ (cwss @ XB2 @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ ccovol) @ (cco @ (cco @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccaddc) @ XC @ ccaddc) @ ccle)))))))))).
...
thf(covolun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) @ (cwa @ (cwss @ XB2 @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr))) @ (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ ccovol) @ (cco @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccaddc) @ ccle))))).
