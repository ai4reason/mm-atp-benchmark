...
thf(choidifhspval_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwceq @ (XD @ Xx3 @ Xk @ Xa) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xa:$i] : (cco @ ccr @ (XX @ Xk) @ ccmap)) @ (^ [Xa:$i] : (ccmpt @ (^ [Xk:$i] : (XX @ Xk)) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (XK @ Xk @ Xa)) @ (ccif @ (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ ccle) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa))))))))))))) => ((! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xk @ Xa) @ (cwcel @ XY @ ccr)))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xk @ Xa) @ (cwceq @ (ccfv @ XY @ (XD @ Xx3 @ Xk @ Xa)) @ (ccmpt @ (^ [Xa:$i] : (cco @ ccr @ (XX @ Xk) @ ccmap)) @ (^ [Xa:$i] : (ccmpt @ (^ [Xk:$i] : (XX @ Xk)) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (XK @ Xk @ Xa)) @ (ccif @ (cwbr @ XY @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ ccle) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ XY) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)))))))))))))))))))).
