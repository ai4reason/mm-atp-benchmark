...
thf(ahashxplem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccfn) => (cwi @ (cwcel @ XA2 @ ccfn) @ (cwceq @ (ccfv @ (ccxp @ XA2 @ XB2) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccmul))))))).
...
thf(chashxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwceq @ (ccfv @ (ccxp @ XA2 @ XB2) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccmul)))))).
