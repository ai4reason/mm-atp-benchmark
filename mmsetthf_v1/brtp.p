...
thf(cbrtp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => (cwb @ (cwbr @ XX @ XY @ (cctp @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ (ccop @ XE @ XF))) @ (cw3o @ (cwa @ (cwceq @ XX @ XA2) @ (cwceq @ XY @ XB2)) @ (cwa @ (cwceq @ XX @ XC) @ (cwceq @ XY @ XD)) @ (cwa @ (cwceq @ XX @ XE) @ (cwceq @ XY @ XF))))))))))))))).
