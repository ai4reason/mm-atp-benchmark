...
thf(asge0seq_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((cwceq @ XG @ (ccseq @ ccaddc @ XF @ XM)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccsup @ (ccrn @ XG) @ ccxr @ cclt))))))))))))).
...
thf(afcoss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ XC @ XA2)) => ((cwi @ Xph @ (cwf @ XD @ XC @ XG)) => (cwi @ Xph @ (cwf @ XD @ XB2 @ (cccom @ XF @ XG)))))))))))))).
...
thf(covolval2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XM @ Xy1 @ Xf1) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr))))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccovol) @ (ccinf @ (XM @ Xy1 @ Xf1) @ ccxr @ cclt))))))))))).
