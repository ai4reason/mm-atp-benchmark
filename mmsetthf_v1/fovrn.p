...
thf(cfovrn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwf @ (ccxp @ XR @ XS) @ XC @ XF) @ (cwcel @ XA2 @ XR) @ (cwcel @ XB2 @ XS)) @ (cwcel @ (cco @ XA2 @ XB2 @ XF) @ XC))))))))).
