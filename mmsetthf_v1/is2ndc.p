...
thf(adf_2ndc_ax,axiom,(cwceq @ cc2ndc @ (ccab @ (^ [Xj:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cctg) @ (ccv @ Xj)))) @ (^ [Xx3:$i] : cctb)))))).
...
thf(cis2ndc_conj,conjecture,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ cc2ndc) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cctg) @ XJ))) @ (^ [Xx3:$i] : cctb))))).
