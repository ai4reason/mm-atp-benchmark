...
thf(amrsubff1_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwi @ (cwcel @ XT @ XW) @ (cwf1 @ (cco @ XR @ XV @ ccmap) @ (cco @ XR @ XR @ ccmap) @ (ccres @ XS @ (cco @ XR @ XV @ ccmap))))))))))))).
...
thf(cmsubff1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmsub)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => (cwi @ (cwcel @ XT @ ccmfs) @ (cwf1 @ (cco @ XR @ XV @ ccmap) @ (cco @ XE @ XE @ ccmap) @ (ccres @ XS @ (cco @ XR @ XV @ ccmap)))))))))))))).
