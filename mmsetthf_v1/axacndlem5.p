...
thf(aaxacndlem4_thm,axiom,(! [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw))))) @ (cwex @ (^ [Xw:$i] : (cwal @ (^ [Xy1:$i] : (cwb @ (cwex @ (^ [Xw:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)))))) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xw)))))))))))))))).
...
thf(caxacndlem5_conj,conjecture,(! [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw))))) @ (cwex @ (^ [Xw:$i] : (cwal @ (^ [Xy1:$i] : (cwb @ (cwex @ (^ [Xw:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)))))) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xw)))))))))))))))).
