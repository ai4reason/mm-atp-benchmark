...
thf(agrplrinv_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ XG @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (Xc_pl @ Xx3) @ (ccfv @ XG @ ccplusg))) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XG @ cc0g))) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_pl @ Xx3)) @ (Xc_0 @ Xx3)) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3)) @ (Xc_0 @ Xx3)))) @ (^ [Xy1:$i] : (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))).
...
thf(cgrpidinv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XB2)) @ (cwa @ (cwa @ (cwceq @ (cco @ Xc_0 @ XA2 @ Xc_pl) @ XA2) @ (cwceq @ (cco @ XA2 @ Xc_0 @ Xc_pl) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xy1) @ XA2 @ Xc_pl) @ Xc_0) @ (cwceq @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_pl) @ Xc_0))) @ (^ [Xy1:$i] : XB2))))))))))))).
