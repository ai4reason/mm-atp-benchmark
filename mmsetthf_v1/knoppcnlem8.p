...
thf(cknoppcnlem8_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : (! [Xm:$i] : (cwceq @ (XT @ Xx3 @ Xz @ Xm) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3 @ Xz @ Xm) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xz @ Xm) @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xz @ Xm)) @ ccmul))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwcel @ (XN @ Xz @ Xm) @ ccn))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwcel @ (XC @ Xx3 @ Xz @ Xm) @ ccr))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwf @ ccn0 @ (cco @ ccc @ ccr @ ccmap) @ (ccseq @ (ccof @ ccaddc) @ (ccmpt @ (^ [Xm:$i] : ccn0) @ (^ [Xm:$i] : (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xm) @ (ccfv @ (ccv @ Xz) @ (XF @ Xx3 @ Xy1 @ Xn))))))) @ ccc0))))))))))))))))).
