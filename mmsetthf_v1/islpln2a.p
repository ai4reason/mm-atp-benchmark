...
thf(a_2atnelpln_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwn @ (cwcel @ (cco @ XQ @ XR @ Xc_or) @ XP))))))))))))).
