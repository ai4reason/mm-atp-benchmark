...
thf(adf_cnext_ax,axiom,(cwceq @ cccnext @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : (ccmpt @ (^ [Xf1:$i] : (cco @ (ccuni @ (ccv @ Xk)) @ (ccuni @ (ccv @ Xj)) @ ccpm)) @ (^ [Xf1:$i] : (cciun @ (^ [Xx3:$i] : (ccfv @ (ccdm @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xj) @ cccl))) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xf1) @ (cco @ (ccv @ Xk) @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xj) @ ccnei)) @ (ccdm @ (ccv @ Xf1)) @ ccrest) @ ccflf)))))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(ccnextval_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwceq @ (cco @ XJ @ XK @ cccnext) @ (ccmpt @ (^ [Xf1:$i] : (cco @ (ccuni @ XK) @ (ccuni @ XJ) @ ccpm)) @ (^ [Xf1:$i] : (cciun @ (^ [Xx3:$i] : (ccfv @ (ccdm @ (ccv @ Xf1)) @ (ccfv @ XJ @ cccl))) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xf1) @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ (ccdm @ (ccv @ Xf1)) @ ccrest) @ ccflf)))))))))))).
