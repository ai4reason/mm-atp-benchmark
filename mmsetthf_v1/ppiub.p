...
thf(appifl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccfl) @ ccppi) @ (ccfv @ XA2 @ ccppi))))).
thf(appi3_thm,axiom,(cwceq @ (ccfv @ cc3 @ ccppi) @ cc2)).
...
thf(appidif_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XM @ ccppi) @ ccmin) @ (ccfv @ (ccin @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ ccprime) @ cchash)))))).
...
thf(appiublem2_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ cc4 @ XP @ ccle)) @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))).
...
thf(alenegi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (ccneg @ XB2) @ (ccneg @ XA2) @ ccle))))))).
...
thf(cppiub_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccr) @ (cwbr @ ccc0 @ XN @ ccle)) @ (cwbr @ (ccfv @ XN @ ccppi) @ (cco @ (cco @ XN @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ ccle)))).
