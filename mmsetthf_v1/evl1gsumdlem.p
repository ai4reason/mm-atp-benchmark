...
thf(aevl1addd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XP @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwa @ (cwcel @ XM @ XU) @ (cwceq @ (ccfv @ XY @ (ccfv @ XM @ XO)) @ XV))) => ((cwi @ Xph @ (cwa @ (cwcel @ XN @ XU) @ (cwceq @ (ccfv @ XY @ (ccfv @ XN @ XO)) @ XW))) => ((cwceq @ Xc_pb @ (ccfv @ XP @ ccplusg)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => (cwi @ Xph @ (cwa @ (cwcel @ (cco @ XM @ XN @ Xc_pb) @ XU) @ (cwceq @ (ccfv @ XY @ (ccfv @ (cco @ XM @ XN @ Xc_pb) @ XO)) @ (cco @ XV @ XW @ Xc_pl)))))))))))))))))))))))))))).
...
thf(afveval1fvcl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XP @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XM @ XU)) => (cwi @ Xph @ (cwcel @ (ccfv @ XY @ (ccfv @ XM @ XO)) @ XB2)))))))))))))))))).
thf(acsbhypf_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xy1)) @ (cwceq @ (XB2 @ Xx3 @ Xy1) @ (XC @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3 @ Xy1)) @ (cwceq @ (ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) @ (XC @ Xx3 @ Xy1)))))))))))).
thf(anffv_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccfv @ (XA2 @ Xx3) @ (XF @ Xx3))))))))).
thf(cevl1gsumdlem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > $o))] : (! [Xm:$i] : (! [XM:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XO @ Xa) @ (ccfv @ (XR @ Xx3 @ Xa) @ cce1)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XP @ Xx3 @ Xa) @ (ccfv @ (XR @ Xx3 @ Xa) @ ccpl1)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XB2 @ Xx3 @ Xa) @ (ccfv @ (XR @ Xx3 @ Xa) @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XU @ Xa) @ (ccfv @ (XP @ Xx3 @ Xa) @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XR @ Xx3 @ Xa) @ cccrg)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XY @ Xa) @ (XB2 @ Xx3 @ Xa))))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cw3a @ (cwcel @ (ccv @ Xm) @ ccfn) @ (cwn @ (cwcel @ (ccv @ Xa) @ (ccv @ Xm))) @ (Xph @ Xx3 @ Xa)) @ (cwi @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XU @ Xa))) @ (^ [Xx3:$i] : (ccv @ Xm))) @ (cwceq @ (ccfv @ (XY @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ (XO @ Xa))) @ (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (ccfv @ (XY @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ (XO @ Xa))))) @ ccgsu))) @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XU @ Xa))) @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa))))) @ (cwceq @ (ccfv @ (XY @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ (XO @ Xa))) @ (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (ccfv @ (XY @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ (XO @ Xa))))) @ ccgsu))))))))))))))))))))))).
