...
thf(acsbdm_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (cwceq @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccdm @ (XB2 @ Xx3)))) @ (ccdm @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))).
...
thf(csbcfng_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwfn @ (XF @ Xx3) @ (XA2 @ Xx3))) @ XX) @ (cwfn @ (ccsb @ XX @ (^ [Xx3:$i] : (XF @ Xx3))) @ (ccsb @ XX @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
