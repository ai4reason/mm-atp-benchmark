...
thf(cwrdres_conj,conjecture,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XS)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwcel @ (ccres @ XW @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccword @ XS))))))).
