...
thf(aex_fl_thm,axiom,(cwa @ (cwceq @ (ccfv @ (cco @ cc3 @ cc2 @ ccdiv) @ ccfl) @ cc1) @ (cwceq @ (ccfv @ (ccneg @ (cco @ cc3 @ cc2 @ ccdiv)) @ ccfl) @ (ccneg @ cc2)))).
...
thf(cex_ceil_conj,conjecture,(cwa @ (cwceq @ (ccfv @ (cco @ cc3 @ cc2 @ ccdiv) @ ccceil) @ cc2) @ (cwceq @ (ccfv @ (ccneg @ (cco @ cc3 @ cc2 @ ccdiv)) @ ccceil) @ (ccneg @ cc1)))).
