...
thf(cdvmptconst_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : ccc0)))))))))))).
