...
thf(csseqmw_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwcel @ XM @ (ccword @ XS))) => ((cwceq @ XW @ (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XW @ XS @ XF)) => (cwi @ Xph @ (cwcel @ XM @ XW)))))))))))).
