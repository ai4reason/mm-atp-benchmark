...
thf(almrcl_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) @ (cwcel @ XJ @ cctop)))))).
...
thf(clmcvg_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((cwi @ Xph @ (cwcel @ XP @ XU)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((cwi @ Xph @ (cwcel @ XU @ XJ)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XU)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))))).
