...
thf(apell1qrss14_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwss @ (ccfv @ XD @ ccpell1qr) @ (ccfv @ XD @ ccpell14qr))))).
thf(ccc0_tp,type,(ccc0 : ($i > $o))).
thf(ccq_tp,type,(ccq : ($i > $o))).
thf(apellqrex_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ cc1 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell1qr)))))).
...
thf(apell14qrgap_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ XA2 @ ccle))))).
thf(ainfmrgelbi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwcel @ XB2 @ ccr)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (cwbr @ XB2 @ (ccinf @ XA2 @ ccr @ cclt) @ ccle))))).
thf(apellfundval_thm,axiom,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwceq @ (ccfv @ XD @ ccpellfund) @ (ccinf @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc1 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell14qr))) @ ccr @ cclt))))).
thf(cpellfundge_conj,conjecture,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ (ccfv @ XD @ ccpellfund) @ ccle)))).
