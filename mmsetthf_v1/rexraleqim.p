...
thf(crexraleqim_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwb @ (Xps @ Xx3) @ (Xph @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ XY) @ (cwb @ (Xph @ Xz) @ (Xth @ Xx3))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwrex @ (^ [Xz:$i] : (Xph @ Xz)) @ (^ [Xz:$i] : XA2)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (Xps @ Xx3) @ (cwceq @ (ccv @ Xx3) @ XY))) @ (^ [Xx3:$i] : XA2))) @ (Xth @ Xx3))))))))))).
