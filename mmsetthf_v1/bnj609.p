...
thf(cbnj609_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xbnjwphn:($i > $o)] : ((! [Xf1:$i] : (cwb @ (Xph @ Xf1) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xf1)) @ (cc_bnj14 @ XA2 @ XR @ XX)))) => ((! [Xf1:$i] : (cwb @ (Xbnjwphn @ Xf1) @ (cwsbc @ (^ [Xf1:$i] : (Xph @ Xf1)) @ (XG @ Xf1)))) => ((! [Xf1:$i] : (cwcel @ (XG @ Xf1) @ ccvv)) => (! [Xf1:$i] : (cwb @ (Xbnjwphn @ Xf1) @ (cwceq @ (ccfv @ cc0 @ (XG @ Xf1)) @ (cc_bnj14 @ XA2 @ XR @ XX)))))))))))))).
