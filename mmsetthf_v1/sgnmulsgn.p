...
thf(apm2_21ddne_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ Xps)))))))).
thf(alt0ne0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwbr @ XA2 @ ccc0 @ cclt)) => (cwi @ Xph @ (cwne @ XA2 @ ccc0)))))).
...
thf(asgnnbi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccsgn) @ (ccneg @ cc1)) @ (cwbr @ XA2 @ ccc0 @ cclt))))).
thf(abreq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XC @ XR) @ (cwbr @ XB2 @ XC @ XR)))))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(asgnmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccsgn) @ (cco @ (ccfv @ XA2 @ ccsgn) @ (ccfv @ XB2 @ ccsgn) @ ccmul)))))).
thf(csgnmulsgn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt) @ (cwbr @ (cco @ (ccfv @ XA2 @ ccsgn) @ (ccfv @ XB2 @ ccsgn) @ ccmul) @ ccc0 @ cclt)))))).
