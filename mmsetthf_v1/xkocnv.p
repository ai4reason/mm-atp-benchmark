...
thf(acnmptk2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xy1) @ (ccfv @ XX @ cctopon)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xy1) @ (ccfv @ XY @ cctopon)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XL @ Xy1) @ (ccfv @ (XZ @ Xx3) @ cctopon))))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xy1) @ (ccnlly @ cccmp)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))))) @ (cco @ (XJ @ Xy1) @ (cco @ (XL @ Xy1) @ (XK @ Xy1) @ ccxko) @ cccn)))) => (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XJ @ Xy1) @ (XK @ Xy1) @ cctx) @ (XL @ Xy1) @ cccn)))))))))))))))))).
...
thf(cxkocnv_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwceq @ XF @ (ccmpt @ (^ [Xf1:$i] : (cco @ (cco @ XJ @ XK @ cctx) @ XL @ cccn)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xf1))))))))) => ((cwi @ Xph @ (cwcel @ XJ @ (ccnlly @ cccmp))) => ((cwi @ Xph @ (cwcel @ XK @ (ccnlly @ cccmp))) => ((cwi @ Xph @ (cwcel @ XL @ cctop)) => (cwi @ Xph @ (cwceq @ (cccnv @ XF) @ (ccmpt @ (^ [Xg1:$i] : (cco @ XJ @ (cco @ XL @ XK @ ccxko) @ cccn)) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)))))))))))))))))))))))).
