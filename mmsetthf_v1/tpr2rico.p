...
thf(asqsscirc2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwcel @ XD @ ccrp)) @ (cwi @ (cwa @ (cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccre) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt) @ (cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccim) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) @ (cwbr @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ XD @ cclt))))))).
