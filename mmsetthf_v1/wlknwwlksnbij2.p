...
thf(cwlknwwlksnbij2_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XN @ ccn0)) @ (cwex @ (^ [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) @ XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ (cco @ XN @ XG @ ccwwlksn) @ (ccv @ Xf1)))))))).
