...
thf(coprpiece1res2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ XA2 @ XB2 @ ccle) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XR @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XS @ Xx3 @ Xy1) @ ccvv))) => ((cwcel @ XK @ (cco @ XA2 @ XB2 @ ccicc)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ XK @ ccle) @ (XR @ Xx3 @ Xy1) @ (XS @ Xx3 @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XK) @ (cwceq @ (XR @ Xx3 @ Xy1) @ (XP @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XK) @ (cwceq @ (XS @ Xx3 @ Xy1) @ (XQ @ Xy1))))) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ XC) @ (cwceq @ (XP @ Xy1) @ (XQ @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ XK @ XB2 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XS @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (ccres @ (XF @ Xx3 @ Xy1) @ (ccxp @ (cco @ XK @ XB2 @ ccicc) @ XC)) @ (XG @ Xx3 @ Xy1)))))))))))))))))))))))))).
