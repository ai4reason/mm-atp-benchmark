...
thf(aprmreclem6_thm,axiom,(! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => (cwn @ (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli)))))).
...
thf(cprmrec_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xk @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsu @ (ccin @ ccprime @ (cco @ cc1 @ (ccv @ Xn) @ ccfz)) @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xk) @ ccdiv)))))))) => (! [Xk:$i] : (! [Xn:$i] : (cwn @ (cwcel @ (XF @ Xk @ Xn) @ (ccdm @ ccli)))))))).
