...
thf(ciccshftr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ (cco @ XA2 @ XR @ ccaddc) @ XC) => ((cwceq @ (cco @ XB2 @ XR @ ccaddc) @ XD) => (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XX @ ccr) @ (cwcel @ XR @ ccr))) @ (cwb @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (cco @ XX @ XR @ ccaddc) @ (cco @ XC @ XD @ ccicc))))))))))))).
