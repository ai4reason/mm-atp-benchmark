...
thf(aoddnn02np1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ XN)) @ (^ [Xn:$i] : ccn0)))))).
...
thf(ann0ledivnn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XA2 @ ccle))))).
...
thf(aflodddiv4_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc))) @ (cwceq @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ (ccif @ (cwbr @ cc2 @ XM @ ccdvds) @ (cco @ XM @ cc2 @ ccdiv) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv))))))).
...
thf(c_2lgslem1c_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwn @ (cwbr @ cc2 @ XP @ ccdvds))) @ (cwbr @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
