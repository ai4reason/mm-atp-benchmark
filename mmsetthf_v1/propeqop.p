...
thf(cpropeqop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => ((cwcel @ XE @ ccvv) => ((cwcel @ XF @ ccvv) => (cwb @ (cwceq @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (ccop @ XE @ XF)) @ (cwa @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XE @ (ccsn @ XA2))) @ (cwo @ (cwa @ (cwceq @ XA2 @ XB2) @ (cwceq @ XF @ (ccpr @ XA2 @ XD))) @ (cwa @ (cwceq @ XA2 @ XD) @ (cwceq @ XF @ (ccpr @ XA2 @ XB2))))))))))))))))))).
