...
thf(ckonigsberglem3_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((cwceq @ XE @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwceq @ (ccfv @ cc3 @ (ccfv @ XG @ ccvtxdg)) @ cc3)))))))).
