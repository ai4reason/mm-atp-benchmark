...
thf(adf_0o_ax,axiom,(cwceq @ cc0o @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xw:$i] : ccnv)) @ (^ [Xu:$i] : (^ [Xw:$i] : ccnv)) @ (^ [Xu:$i] : (^ [Xw:$i] : (ccxp @ (ccfv @ (ccv @ Xu) @ ccba) @ (ccsn @ (ccfv @ (ccv @ Xw) @ ccn0v)))))))).
...
thf(c_0ofval_conj,conjecture,(! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XZ @ (ccfv @ XW @ ccn0v)) => ((cwceq @ XO @ (cco @ XU @ XW @ cc0o)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv)) @ (cwceq @ XO @ (ccxp @ XX @ (ccsn @ XZ))))))))))))).
