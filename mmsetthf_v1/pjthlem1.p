...
thf(aabs00d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccabs) @ ccc0)) => (cwi @ Xph @ (cwceq @ XA2 @ ccc0))))))).
...
thf(areipcl_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cwcel @ XA2 @ XV)) @ (cwcel @ (cco @ XA2 @ XA2 @ Xc_xi) @ ccr))))))))).
...
thf(ahlress_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cwcel @ XW @ cchl) @ (cwss @ ccr @ XK)))))))).
...
thf(acphdivcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XK) @ (cwne @ XB2 @ ccc0))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ XK)))))))))).
...
thf(acphsubdir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ Xc_mi) @ XC @ Xc_xi) @ (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ ccmin)))))))))))))).
thf(aoveq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF)))))))))).
thf(acphsubdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ Xc_mi) @ Xc_xi) @ (cco @ (cco @ XA2 @ XB2 @ Xc_xi) @ (cco @ XA2 @ XC @ Xc_xi) @ ccmin)))))))))))))).
...
thf(acjdivd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ cccj) @ (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccdiv)))))))))).
thf(acjred_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ cccj) @ XA2)))))).
...
thf(acphipcj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_xi) @ cccj) @ (cco @ XB2 @ XA2 @ Xc_xi))))))))))).
...
thf(age0divd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccle))))))))).
...
thf(aprodge02_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XB2 @ cclt) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle))) @ (cwbr @ ccc0 @ XA2 @ ccle))))).
...
thf(cpjthlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_xi:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((! [Xx3:$i] : (cwceq @ (Xc_pl @ Xx3) @ (ccfv @ XW @ ccplusg))) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((! [Xx3:$i] : (cwceq @ (Xc_xi @ Xx3) @ (ccfv @ XW @ ccip))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccfv @ XW @ cclss))) => ((cwi @ Xph @ (cwcel @ XW @ cchl)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XU @ (XL @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XU)) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ XA2 @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ Xc_mi) @ XN) @ ccle)) @ (^ [Xx3:$i] : XU))) => ((! [Xx3:$i] : (cwceq @ XT @ (cco @ (cco @ XA2 @ XB2 @ (Xc_xi @ Xx3)) @ (cco @ (cco @ XB2 @ XB2 @ (Xc_xi @ Xx3)) @ cc1 @ ccaddc) @ ccdiv))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ (Xc_xi @ Xx3)) @ ccc0)))))))))))))))))))))))))))).
