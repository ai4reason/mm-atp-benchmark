...
thf(cmdetrlin_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XD @ (cco @ XN @ XR @ ccmdat)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwcel @ XI @ XN)) => ((cwi @ Xph @ (cwceq @ (ccres @ XX @ (ccxp @ (ccsn @ XI) @ XN)) @ (cco @ (ccres @ XY @ (ccxp @ (ccsn @ XI) @ XN)) @ (ccres @ XZ @ (ccxp @ (ccsn @ XI) @ XN)) @ (ccof @ Xc_pl)))) => ((cwi @ Xph @ (cwceq @ (ccres @ XX @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)) @ (ccres @ XY @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)))) => ((cwi @ Xph @ (cwceq @ (ccres @ XX @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)) @ (ccres @ XZ @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ XD) @ (cco @ (ccfv @ XY @ XD) @ (ccfv @ XZ @ XD) @ Xc_pl))))))))))))))))))))))))))).
