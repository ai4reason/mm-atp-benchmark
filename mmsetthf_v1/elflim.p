...
thf(celflim_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil))) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwss @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ XF))))))))).
