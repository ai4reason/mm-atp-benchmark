...
thf(clhpex2leN_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le) @ (cwbr @ (ccv @ Xq) @ XW @ Xc_le) @ (cwne @ (ccv @ Xp) @ (ccv @ Xq)))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2)))))))))))).
