...
thf(aeqop2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwceq @ XA2 @ (ccop @ XB2 @ XC)) @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ (cwa @ (cwceq @ (ccfv @ XA2 @ cc1st) @ XB2) @ (cwceq @ (ccfv @ XA2 @ cc2nd) @ XC)))))))))).
...
thf(cevlslem4_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XR @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1) @ (ccfv @ (XR @ Xx3 @ Xy1) @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ Xc_x @ (ccfv @ (XR @ Xx3 @ Xy1) @ ccmulr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3 @ Xy1) @ ccrg)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XX @ Xx3) @ XB2))) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XJ)) @ (cwcel @ (XY @ Xy1) @ XB2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XI @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XJ @ (XW @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwss @ (cco @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XI)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XJ)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (XX @ Xx3) @ (XY @ Xy1) @ Xc_x)))) @ (Xc_0 @ Xx3 @ Xy1) @ ccsupp) @ (ccxp @ (cco @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XX @ Xx3))) @ (Xc_0 @ Xx3 @ Xy1) @ ccsupp) @ (cco @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (XY @ Xy1))) @ (Xc_0 @ Xx3 @ Xy1) @ ccsupp)))))))))))))))))))))))))).
