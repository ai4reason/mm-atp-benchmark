...
thf(cfvn0elsupp_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XX @ XB2)) @ (cwa @ (cwfn @ XG @ XB2) @ (cwne @ (ccfv @ XX @ XG) @ cc0))) @ (cwcel @ XX @ (cco @ XG @ cc0 @ ccsupp)))))))).
