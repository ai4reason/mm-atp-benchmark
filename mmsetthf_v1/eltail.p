...
thf(atailval_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwa @ (cwcel @ XD @ ccdir) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XD @ cctail)) @ (ccima @ XD @ (ccsn @ XA2))))))))).
...
thf(celtail_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cw3a @ (cwcel @ XD @ ccdir) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XC)) @ (cwb @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XD @ cctail))) @ (cwbr @ XA2 @ XB2 @ XD)))))))))).
