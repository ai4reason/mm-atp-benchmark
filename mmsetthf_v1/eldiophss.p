...
thf(aeldioph3b_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccfv @ XN @ ccdioph)) @ (cwa @ (cwcel @ XN @ ccn0) @ (cwrex @ (^ [Xp:$i] : (cwceq @ XA2 @ (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwceq @ (ccv @ Xt) @ (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xu) @ (ccv @ Xp)) @ ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ ccn @ ccmap))))))) @ (^ [Xp:$i] : (ccfv @ ccn @ ccmzp)))))))).
...
thf(celdiophss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccdioph)) @ (cwss @ XA2 @ (cco @ ccn0 @ (cco @ cc1 @ XB2 @ ccfz) @ ccmap)))))).
