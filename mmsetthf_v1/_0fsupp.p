...
thf(asupp0_thm,axiom,(! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ XW) @ (cwceq @ (cco @ cc0 @ XZ @ ccsupp) @ cc0))))).
...
thf(c_0fsupp_conj,conjecture,(! [XV:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ XV) @ (cwbr @ cc0 @ XZ @ ccfsupp))))).
