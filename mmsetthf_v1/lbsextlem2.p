...
thf(aiunn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwb @ (cwrex @ (^ [Xx3:$i] : (cwne @ (XB2 @ Xx3) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ (cwne @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cc0))))).
...
thf(asorpssun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwor @ XA2 @ ccrpss) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2))) @ (cwcel @ (ccun @ XB2 @ XC) @ XA2)))))).
