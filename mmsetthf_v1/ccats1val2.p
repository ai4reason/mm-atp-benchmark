...
thf(aelfzomin_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ ccz) @ (cwcel @ XZ @ (cco @ XZ @ (cco @ XZ @ cc1 @ ccaddc) @ ccfzo))))).
...
thf(cccats1val2_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XS @ XV) @ (cwceq @ XI @ (ccfv @ XW @ cchash))) @ (cwceq @ (ccfv @ XI @ (cco @ XW @ (ccs1 @ XS) @ ccconcat)) @ XS))))))).
