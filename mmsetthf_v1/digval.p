...
thf(adigfval_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccn) @ (cwceq @ (ccfv @ XB2 @ ccdig) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xr:$i] : ccz)) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccneg @ (ccv @ Xk)) @ ccexp) @ (ccv @ Xr) @ ccmul) @ ccfl) @ XB2 @ ccmo)))))))).
...
thf(cdigval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ ccz) @ (cwcel @ XR @ (cco @ ccc0 @ ccpnf @ ccico))) @ (cwceq @ (cco @ XK @ XR @ (ccfv @ XB2 @ ccdig)) @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccneg @ XK) @ ccexp) @ XR @ ccmul) @ ccfl) @ XB2 @ ccmo))))))).
