...
thf(apm5_32rd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwb @ Xch @ Xth))) => (cwi @ Xph @ (cwb @ (cwa @ Xch @ Xps) @ (cwa @ Xth @ Xps))))))))).
...
thf(aupgrwlkdvde_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwfun @ (cccnv @ XP))) @ (cwfun @ (cccnv @ XF))))))).
thf(aistrl_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwb @ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwfun @ (cccnv @ XF)))))))).
thf(cupgrspthswlk_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccupgr) @ (cwceq @ (ccfv @ XG @ ccspths) @ (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ (cwfun @ (cccnv @ (ccv @ Xp))))))))))).
