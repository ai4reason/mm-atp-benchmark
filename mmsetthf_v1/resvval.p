...
thf(cresvval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (cco @ XW @ XA2 @ ccresv)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ XX) @ (cwcel @ XA2 @ XY)) @ (cwceq @ XR @ (ccif @ (cwss @ XB2 @ XA2) @ XW @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ XF @ XA2 @ ccress)) @ ccsts))))))))))))))).
