...
thf(anegcon2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (cwb @ (cwceq @ XA2 @ (ccneg @ XB2)) @ (cwceq @ XB2 @ (ccneg @ XA2)))))))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(aax_1cn_thm,axiom,(cwcel @ cc1 @ ccc)).
thf(amulcli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ ccc)))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(adivmuli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwne @ XB2 @ ccc0) => (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ XC) @ (cwceq @ (cco @ XB2 @ XC @ ccmul) @ XA2)))))))))).
thf(anegicn_thm,axiom,(cwcel @ (ccneg @ cci) @ ccc)).
thf(aine0_thm,axiom,(cwne @ cci @ ccc0)).
thf(cirec_conj,conjecture,(cwceq @ (cco @ cc1 @ cci @ ccdiv) @ (ccneg @ cci))).
