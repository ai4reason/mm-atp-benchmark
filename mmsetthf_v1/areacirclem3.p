...
thf(acnicciblnc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) @ (cwcel @ XF @ ccibl)))))).
thf(careacirclem3_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle)) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ cc2 @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul))) @ ccibl)))).
