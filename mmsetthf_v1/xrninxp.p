...
thf(ainxp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwceq @ (ccin @ XR @ (ccxp @ XA2 @ XB2)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR)))))))))).
...
thf(cxrninxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwceq @ (ccin @ (ccxrn @ XR @ XS) @ (ccxp @ XA2 @ (ccxp @ XB2 @ XC))) @ (cccnv @ (ccoprab @ (^ [Xy1:$i] : (^ [Xz:$i] : (^ [Xu:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwcel @ (ccv @ Xz) @ XC)) @ (cwa @ (cwcel @ (ccv @ Xu) @ XA2) @ (cwbr @ (ccv @ Xu) @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccxrn @ XR @ XS)))))))))))))))).
