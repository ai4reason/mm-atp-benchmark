...
thf(acoe1addfv_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_pb @ (ccfv @ XY @ ccplusg)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) @ (cwcel @ XX @ ccn0)) @ (cwceq @ (ccfv @ XX @ (ccfv @ (cco @ XF @ XG @ Xc_pb) @ ccco1)) @ (cco @ (ccfv @ XX @ (ccfv @ XF @ ccco1)) @ (ccfv @ XX @ (ccfv @ XG @ ccco1)) @ Xc_pl)))))))))))))))).
...
thf(ccoe1fzgsumdlem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xm:$i] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XP @ Xx3 @ Xa) @ (ccfv @ (XR @ Xx3 @ Xa) @ ccpl1)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccfv @ (XP @ Xx3 @ Xa) @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XR @ Xx3 @ Xa) @ ccrg)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XK @ Xa) @ ccn0)))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cw3a @ (cwcel @ (ccv @ Xm) @ ccfn) @ (cwn @ (cwcel @ (ccv @ Xa) @ (ccv @ Xm))) @ (Xph @ Xx3 @ Xa)) @ (cwi @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XB2 @ Xa))) @ (^ [Xx3:$i] : (ccv @ Xm))) @ (cwceq @ (ccfv @ (XK @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ ccco1)) @ (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (ccfv @ (XK @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ ccco1)))) @ ccgsu))) @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XB2 @ Xa))) @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa))))) @ (cwceq @ (ccfv @ (XK @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ ccco1)) @ (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (ccfv @ (XK @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ ccco1)))) @ ccgsu))))))))))))))))))).
