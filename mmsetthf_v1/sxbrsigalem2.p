...
thf(a_1stpreima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccima @ (cccnv @ (ccres @ cc1st @ (ccxp @ XB2 @ XC))) @ XA2) @ (ccxp @ XA2 @ XC))))))).
...
thf(adifxp1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccxp @ (ccdif @ XA2 @ XB2) @ XC) @ (ccdif @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC))))))).
...
thf(adifico_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ XB2 @ XC @ ccle))) @ (cwceq @ (ccdif @ (cco @ XA2 @ XC @ ccico) @ (cco @ XB2 @ XC @ ccico)) @ (cco @ XA2 @ XB2 @ ccico))))))).
...
thf(a_2ndpreima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ XA2 @ XC) @ (cwceq @ (ccima @ (cccnv @ (ccres @ cc2nd @ (ccxp @ XB2 @ XC))) @ XA2) @ (ccxp @ XB2 @ XA2))))))).
thf(axpeq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccxp @ XC @ XA2) @ (ccxp @ XC @ XB2))))))))).
thf(adifxp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccxp @ XA2 @ (ccdif @ XB2 @ XC)) @ (ccdif @ (ccxp @ XA2 @ XB2) @ (ccxp @ XA2 @ XC))))))).
