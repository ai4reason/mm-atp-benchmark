...
thf(adf_tdrg_ax,axiom,(cwceq @ cctdrg @ (ccrab @ (^ [Xr:$i] : (cwcel @ (cco @ (ccfv @ (ccv @ Xr) @ ccmgp) @ (ccfv @ (ccv @ Xr) @ ccui) @ ccress) @ cctgp)) @ (^ [Xr:$i] : (ccin @ cctrg @ ccdr))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cistdrg_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => (cwb @ (cwcel @ XR @ cctdrg) @ (cw3a @ (cwcel @ XR @ cctrg) @ (cwcel @ XR @ ccdr) @ (cwcel @ (cco @ XM @ XU @ ccress) @ cctgp))))))))).
