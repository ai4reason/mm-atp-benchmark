...
thf(ausgredg2vtxeu_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg)) @ (cwcel @ XY @ XE)) @ (cwreu @ (^ [Xy1:$i] : (cwceq @ XE @ (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XG @ ccvtx)))))))).
...
thf(cedgnbusgreu_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xn:$i] : (cwceq @ (XN @ Xn) @ (cco @ XG @ XM @ ccnbgr))) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XM @ XV)) @ (cwa @ (cwcel @ XC @ XE) @ (cwcel @ XM @ XC))) @ (cwreu @ (^ [Xn:$i] : (cwceq @ XC @ (ccpr @ XM @ (ccv @ Xn)))) @ (^ [Xn:$i] : (XN @ Xn)))))))))))))).
