...
thf(annaword2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccoa)))))).
...
thf(cnnawordex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccoa) @ XB2)) @ (^ [Xx3:$i] : ccom))))))).
