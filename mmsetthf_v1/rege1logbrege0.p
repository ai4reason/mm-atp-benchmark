...
thf(aregt1loggt0_thm,axiom,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (cco @ cc1 @ ccpnf @ ccioo)) @ (cwbr @ ccc0 @ (ccfv @ XB2 @ cclog) @ cclt)))).
...
thf(crege1logbrege0_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (cco @ cc1 @ ccpnf @ ccioo)) @ (cwcel @ XX @ (cco @ cc1 @ ccpnf @ ccico))) @ (cwbr @ ccc0 @ (cco @ XB2 @ XX @ cclogb) @ ccle))))).
