...
thf(afprg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ XE) @ (cwcel @ XB2 @ XF)) @ (cwa @ (cwcel @ XC @ XG) @ (cwcel @ XD @ XH)) @ (cwne @ XA2 @ XB2)) @ (cwf @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD) @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))))))))))))).
...
thf(aopth1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwi @ (cwceq @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (cwceq @ XA2 @ XC)))))))))).
...
thf(cwrdlen2i_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XT @ XV)) @ (cwi @ (cwceq @ XW @ (ccpr @ (ccop @ ccc0 @ XS) @ (ccop @ cc1 @ XT))) @ (cwa @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwceq @ (ccfv @ XW @ cchash) @ cc2)) @ (cwa @ (cwceq @ (ccfv @ ccc0 @ XW) @ XS) @ (cwceq @ (ccfv @ cc1 @ XW) @ XT)))))))))).
