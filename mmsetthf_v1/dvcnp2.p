...
thf(cdvcnp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (cco @ XK @ XA2 @ ccrest)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwa @ (cw3a @ (cwss @ XS @ ccc) @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ XS)) @ (cwcel @ XB2 @ (ccdm @ (cco @ XS @ XF @ ccdv)))) @ (cwcel @ XF @ (ccfv @ XB2 @ (cco @ XJ @ XK @ cccnp))))))))))))).
