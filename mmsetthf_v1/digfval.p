...
thf(adf_dig_ax,axiom,(cwceq @ ccdig @ (ccmpt @ (^ [Xb:$i] : ccn) @ (^ [Xb:$i] : (ccmpt2 @ (^ [Xk:$i] : (^ [Xr:$i] : ccz)) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xb) @ (ccneg @ (ccv @ Xk)) @ ccexp) @ (ccv @ Xr) @ ccmul) @ ccfl) @ (ccv @ Xb) @ ccmo)))))))).
...
thf(cdigfval_conj,conjecture,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccn) @ (cwceq @ (ccfv @ XB2 @ ccdig) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xr:$i] : ccz)) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccneg @ (ccv @ Xk)) @ ccexp) @ (ccv @ Xr) @ ccmul) @ ccfl) @ XB2 @ ccmo)))))))).
