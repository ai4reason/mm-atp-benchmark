...
thf(apell1234qrdich_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr))) @ (cwo @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwcel @ (ccneg @ XA2) @ (ccfv @ XD @ ccpell14qr))))))).
thf(aorel2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwn @ Xph) @ (cwi @ (cwo @ Xps @ Xph) @ Xps))))).
thf(celpell14qr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr)) @ (cwbr @ ccc0 @ XA2 @ cclt))))))).
