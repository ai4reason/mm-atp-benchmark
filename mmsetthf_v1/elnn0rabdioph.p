...
thf(arabdiophlem2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccmpt @ (^ [Xu:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xu:$i] : (XA2 @ Xu))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XM @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (ccsb @ (ccres @ (ccv @ Xt) @ (cco @ cc1 @ XN @ ccfz)) @ (^ [Xu:$i] : (XA2 @ Xu))))) @ (ccfv @ (cco @ cc1 @ XM @ ccfz) @ ccmzp)))))))).
...
thf(celnn0rabdioph_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (XA2 @ Xt))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp))) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (cwcel @ (XA2 @ Xt) @ ccn0)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))).
