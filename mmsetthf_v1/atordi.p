...
thf(aatoml2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwa @ (cwcel @ XB2 @ ccat) @ (cwn @ (cwss @ XB2 @ XA2))) @ (cwcel @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ XA2 @ ccort)) @ ccat)))))).
thf(aad2antrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ (cwa @ Xph @ Xch) @ Xth) @ Xps))))))).
thf(ampan2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xps => ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ Xph @ Xch))))))).
thf(aatssma_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwcel @ (ccin @ XA2 @ XB2) @ ccat)))))).
thf(catordi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwa @ (cwcel @ XB2 @ ccat) @ (cwbr @ XA2 @ XB2 @ cccm)) @ (cwo @ (cwss @ XB2 @ XA2) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))))))).
