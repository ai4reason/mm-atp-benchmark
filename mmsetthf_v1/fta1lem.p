...
thf(cfta1lem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xg1:$i] : (cwceq @ (XR @ Xg1) @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0)))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XD @ ccn0))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XF @ (ccdif @ (ccfv @ ccc @ ccply) @ (ccsn @ cc0p))))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwceq @ (ccfv @ XF @ ccdgr) @ (cco @ XD @ cc1 @ ccaddc)))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XA2 @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0))))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwral @ (^ [Xg1:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xg1) @ ccdgr) @ XD) @ (cwa @ (cwcel @ (ccima @ (cccnv @ (ccv @ Xg1)) @ (ccsn @ ccc0)) @ ccfn) @ (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xg1)) @ (ccsn @ ccc0)) @ cchash) @ (ccfv @ (ccv @ Xg1) @ ccdgr) @ ccle)))) @ (^ [Xg1:$i] : (ccdif @ (ccfv @ ccc @ ccply) @ (ccsn @ cc0p)))))) => (! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwa @ (cwcel @ (XR @ Xg1) @ ccfn) @ (cwbr @ (ccfv @ (XR @ Xg1) @ cchash) @ (ccfv @ XF @ ccdgr) @ ccle)))))))))))))))).
