...
thf(adf_lcv_ax,axiom,(cwceq @ cclcv @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xw) @ cclss)) @ (cwcel @ (ccv @ Xu) @ (ccfv @ (ccv @ Xw) @ cclss))) @ (cwa @ (cwpss @ (ccv @ Xt) @ (ccv @ Xu)) @ (cwn @ (cwrex @ (^ [Xs1:$i] : (cwa @ (cwpss @ (ccv @ Xt) @ (ccv @ Xs1)) @ (cwpss @ (ccv @ Xs1) @ (ccv @ Xu)))) @ (^ [Xs1:$i] : (ccfv @ (ccv @ Xw) @ cclss))))))))))))).
