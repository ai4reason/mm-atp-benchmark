...
thf(agsumzadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((cwi @ Xph @ (cwbr @ XH @ Xc_0 @ ccfsupp)) => ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd))) => ((cwi @ Xph @ (cwss @ XS @ (ccfv @ XS @ XZ))) => ((cwi @ Xph @ (cwf @ XA2 @ XS @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XS @ XH)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ (cco @ XF @ XH @ (ccof @ Xc_pl)) @ ccgsu) @ (cco @ (cco @ XG @ XF @ ccgsu) @ (cco @ XG @ XH @ ccgsu) @ Xc_pl))))))))))))))))))))))))))).
thf(afsuppmptif_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XZ @ (XW @ Xk)))) => ((cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp)) => (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XD @ Xk)) @ (ccfv @ (ccv @ Xk) @ XF) @ XZ))) @ XZ @ ccfsupp))))))))))))))).
...
thf(acntzspan_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwceq @ XK @ (ccfv @ (ccfv @ XG @ ccsubmnd) @ ccmrc)) => ((cwceq @ XH @ (cco @ XG @ (ccfv @ XS @ XK) @ ccress)) => (cwi @ (cwa @ (cwcel @ XG @ ccmnd) @ (cwss @ XS @ (ccfv @ XS @ XZ))) @ (cwcel @ XH @ cccmn))))))))))).
