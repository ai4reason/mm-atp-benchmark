...
thf(aprodss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XC @ Xk) @ ccc))) => ((cwi @ Xph @ (cwrex @ (^ [Xn:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xy1) @ ccc0) @ (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : (ccfv @ XM @ ccuz)) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XB2) @ (XC @ Xk) @ cc1))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli))))) @ (^ [Xn:$i] : (ccfv @ XM @ ccuz)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccdif @ XB2 @ XA2))) @ (cwceq @ (XC @ Xk) @ cc1))) => ((cwi @ Xph @ (cwss @ XB2 @ (ccfv @ XM @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))).
...
thf(afprodntriv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xy1 @ Xk @ Xn) @ ccuz))))) => ((! [Xy1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xy1 @ Xk) @ (cwcel @ (XN @ Xk) @ XZ)))) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1 @ Xk) @ (cwss @ XA2 @ (cco @ (XM @ Xy1 @ Xk @ Xn) @ (XN @ Xk) @ ccfz)))))) => (! [Xy1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xy1 @ Xk) @ (cwrex @ (^ [Xn:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xy1) @ ccc0) @ (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli))))) @ (^ [Xn:$i] : XZ))))))))))))))).
...
thf(afisuppfi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => (cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ XF) @ XC) @ ccfn)))))))))).
...
thf(cfprodss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XC @ Xk) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccdif @ XB2 @ XA2))) @ (cwceq @ (XC @ Xk) @ cc1))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))).
