...
thf(annpw2blenfzo2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwo @ (cwceq @ XN @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp)) @ (cwcel @ XN @ (cco @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccfv @ XN @ ccblen) @ ccexp) @ ccfzo)))))).
...
thf(ablennnelnn_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (ccfv @ XN @ ccblen) @ ccn)))).
...
thf(alogbleb_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp) @ (cwcel @ XY @ ccrp)) @ (cwb @ (cwbr @ XX @ XY @ ccle) @ (cwbr @ (cco @ XB2 @ XX @ cclogb) @ (cco @ XB2 @ XY @ cclogb) @ ccle))))))).
...
thf(annpw2even_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc2 @ ccdiv) @ ccn)))).
...
thf(afllog2_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XI @ ccn0) @ (cwcel @ XN @ (cco @ (cco @ cc2 @ XI @ ccexp) @ (cco @ cc2 @ (cco @ XI @ cc1 @ ccaddc) @ ccexp) @ ccfzo))) @ (cwceq @ (ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) @ XI))))).
...
thf(cnnolog2flm1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn)) @ (cwceq @ (ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) @ (ccfv @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ cclogb) @ ccfl))))).
