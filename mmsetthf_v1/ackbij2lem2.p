...
thf(acard0_thm,axiom,(cwceq @ (ccfv @ cc0 @ cccrd) @ cc0)).
...
thf(aackbij1b_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwi @ (cwcel @ XA2 @ ccom) @ (cwceq @ (ccima @ XF @ (ccpw @ XA2)) @ (ccfv @ (ccpw @ XA2) @ cccrd))))))).
...
thf(af1opw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwf1o @ (ccpw @ XA2) @ (ccpw @ XB2) @ (ccmpt @ (^ [Xb:$i] : (ccpw @ XA2)) @ (^ [Xb:$i] : (ccima @ XF @ (ccv @ Xb)))))))))).
