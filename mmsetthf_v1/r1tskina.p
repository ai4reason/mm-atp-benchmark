...
thf(ar1sdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ XA2)) @ (cwbr @ (ccfv @ XB2 @ ccr1) @ (ccfv @ XA2 @ ccr1) @ ccsdm))))).
...
thf(ainatsk_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccina) @ (cwcel @ (ccfv @ XA2 @ ccr1) @ cctsk)))).
thf(cr1tskina_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwb @ (cwcel @ (ccfv @ XA2 @ ccr1) @ cctsk) @ (cwo @ (cwceq @ XA2 @ cc0) @ (cwcel @ XA2 @ ccina)))))).
