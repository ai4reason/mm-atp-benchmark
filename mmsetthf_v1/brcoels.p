...
thf(adfcoels_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (cccoels @ XA2) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2)))))))).
thf(cbrcoels_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xu:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ (XV @ Xu)) @ (cwcel @ XC @ (XW @ Xu))) @ (cwb @ (cwbr @ XB2 @ XC @ (cccoels @ XA2)) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ XB2 @ (ccv @ Xu)) @ (cwcel @ XC @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2))))))))))).
