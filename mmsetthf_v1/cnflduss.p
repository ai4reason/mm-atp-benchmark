...
thf(axmetpsmet_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)))))).
...
thf(ametuust_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwne @ XX @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) @ (cwcel @ (ccfv @ XD @ ccmetu) @ (ccfv @ XX @ ccust)))))).
...
thf(acnfldunif_thm,axiom,(cwceq @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccmetu) @ (ccfv @ cccnfld @ ccunif))).
thf(ccnflduss_conj,conjecture,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccfv @ cccnfld @ ccuss)) => (cwceq @ XU @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccmetu))))).
