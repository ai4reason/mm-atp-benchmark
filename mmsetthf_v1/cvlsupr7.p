...
thf(ccvlsupr7_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => (cwi @ (cw3a @ (cwcel @ XK @ cclc) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwa @ (cwne @ XP @ XQ) @ (cwceq @ (cco @ XP @ XR @ Xc_or) @ (cco @ XQ @ XR @ Xc_or)))) @ (cwceq @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XR @ XQ @ Xc_or)))))))))))).
