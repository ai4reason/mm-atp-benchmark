...
thf(adirkerdenne0_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ ccr) @ (cwn @ (cwceq @ (cco @ XS @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0))) @ (cwne @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ XS @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccc0)))).
...
thf(cdirkerper_conj,conjecture,(! [Xx3:$i] : (! [XD:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xy1 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xy1 @ Xn) @ (cco @ cc2 @ ccpi @ ccmul)))) => (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xn) @ ccn) @ (cwcel @ (ccv @ Xx3) @ ccr)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (XT @ Xy1 @ Xn) @ ccaddc) @ (ccfv @ (XN @ Xn) @ (XD @ Xy1 @ Xn))) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (XN @ Xn) @ (XD @ Xy1 @ Xn)))))))))))))).
