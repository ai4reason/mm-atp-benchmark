...
thf(caxregndlem2_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))))))).
