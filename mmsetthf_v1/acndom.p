...
thf(afinacn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwceq @ (cwacn @ XA2) @ ccvv)))).
thf(cacndom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwi @ (cwcel @ XX @ (cwacn @ XB2)) @ (cwcel @ XX @ (cwacn @ XA2)))))))).
