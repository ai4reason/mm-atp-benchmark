...
thf(cpsgnodpmr_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XP @ (ccfv @ XS @ ccbs)) => ((cwceq @ XN @ (ccfv @ XD @ ccpsgn)) => (cwi @ (cw3a @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ XP) @ (cwceq @ (ccfv @ XF @ XN) @ (ccneg @ cc1))) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm))))))))))))).
