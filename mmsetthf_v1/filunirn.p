...
thf(adf_fil_ax,axiom,(cwceq @ ccfil @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwne @ (ccin @ (ccv @ Xf1) @ (ccpw @ (ccv @ Xx3))) @ cc0) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xz))))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xz) @ ccfbas))))))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(afnunirn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwfn @ XF @ XI) @ (cwb @ (cwcel @ XA2 @ (ccuni @ (ccrn @ XF))) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : XI)))))))).
...
thf(cfilunirn_conj,conjecture,(! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ (ccuni @ (ccrn @ ccfil))) @ (cwcel @ XF @ (ccfv @ (ccuni @ XF) @ ccfil))))).
