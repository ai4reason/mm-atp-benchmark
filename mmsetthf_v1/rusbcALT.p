...
thf(asbcnel12g_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) @ (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwnel @ (XB2 @ Xx3) @ (XC @ Xx3))) @ (XA2 @ Xx3)) @ (cwnel @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(crusbcALT_conj,conjecture,(cwnel @ (ccab @ (^ [Xx3:$i] : (cwnel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ ccvv)).
