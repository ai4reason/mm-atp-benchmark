...
thf(amotplusg_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XP @ Xf1 @ Xg1) @ (ccfv @ XG @ ccbs)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (Xc_mi @ Xf1 @ Xg1) @ (ccfv @ XG @ ccds)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xf1 @ Xg1) @ (cwcel @ XG @ (XV @ Xf1 @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XI @ Xf1 @ Xg1) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (cco @ XG @ XG @ ccismt)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XG @ XG @ ccismt))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XG @ XG @ ccismt))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xf1 @ Xg1) @ (cwcel @ (XF @ Xf1 @ Xg1) @ (cco @ XG @ XG @ ccismt))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xf1 @ Xg1) @ (cwcel @ (XH @ Xf1 @ Xg1) @ (cco @ XG @ XG @ ccismt))))) => (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (Xph @ Xf1 @ Xg1) @ (cwceq @ (cco @ (XF @ Xf1 @ Xg1) @ (XH @ Xf1 @ Xg1) @ (ccfv @ (XI @ Xf1 @ Xg1) @ ccplusg)) @ (cccom @ (XF @ Xf1 @ Xg1) @ (XH @ Xf1 @ Xg1))))))))))))))))))))).
thf(a_3ad2ant1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xch) => (cwi @ (cw3a @ Xph @ Xps @ Xth) @ Xch))))))).
thf(asimp2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xps))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xch))))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(amotco_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XG @ XG @ ccismt))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XG @ XG @ ccismt))) => (cwi @ Xph @ (cwcel @ (cccom @ XF @ XH) @ (cco @ XG @ XG @ ccismt)))))))))))))))).
...
thf(aidmot_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => (cwi @ Xph @ (cwcel @ (ccres @ ccid @ XP) @ (cco @ XG @ XG @ ccismt)))))))))))).
...
thf(acnvmot_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwi @ Xph @ (cwcel @ XG @ XV)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XG @ XG @ ccismt))) => (cwi @ Xph @ (cwcel @ (cccnv @ XF) @ (cco @ XG @ XG @ ccismt)))))))))))))).
