...
thf(c_2submod_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwa @ (cwbr @ XB2 @ XA2 @ ccle) @ (cwbr @ XA2 @ (cco @ cc2 @ XB2 @ ccmul) @ cclt))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ (cco @ XA2 @ XB2 @ ccmin)))))).
