...
thf(ccncffvrn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XC @ ccc) @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf))) @ (cwb @ (cwcel @ XF @ (cco @ XA2 @ XC @ cccncf)) @ (cwf @ XA2 @ XC @ XF)))))))).
