...
thf(ahashnzfz_thm,axiom,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XJ @ ccz)) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ (cco @ XJ @ cc1 @ ccmin) @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccin @ (ccima @ ccdvds @ (ccsn @ XN)) @ (cco @ XJ @ XK @ ccfz)) @ cchash) @ (cco @ (ccfv @ (cco @ XK @ XN @ ccdiv) @ ccfl) @ (ccfv @ (cco @ (cco @ XJ @ cc1 @ ccmin) @ XN @ ccdiv) @ ccfl) @ ccmin))))))))))).
...
thf(chashnzfzclim_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XJ @ ccz)) => (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : (ccfv @ (cco @ XJ @ cc1 @ ccmin) @ ccuz)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccin @ (ccima @ ccdvds @ (ccsn @ XM)) @ (cco @ XJ @ (ccv @ Xk) @ ccfz)) @ cchash) @ (ccv @ Xk) @ ccdiv))) @ (cco @ cc1 @ XM @ ccdiv) @ ccli)))))))).
