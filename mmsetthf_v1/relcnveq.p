...
thf(arelcnveq3_thm,axiom,(! [XR:($i > $o)] : (cwi @ (cwrel @ XR) @ (cwb @ (cwceq @ XR @ (cccnv @ XR)) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)))))))))).
...
thf(crelcnveq_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwrel @ XR) @ (cwb @ (cwss @ (cccnv @ XR) @ XR) @ (cwceq @ (cccnv @ XR) @ XR))))).
