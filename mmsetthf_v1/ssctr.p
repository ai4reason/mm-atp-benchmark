...
thf(asscfn1_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XH @ XJ @ ccssc)) => ((cwi @ Xph @ (cwceq @ XS @ (ccdm @ (ccdm @ XH)))) => (cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS)))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xph)))).
thf(aeqidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (cwi @ Xph @ (cwceq @ XA2 @ XA2))))).
thf(asscfn2_thm,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XH @ XJ @ ccssc)) => ((cwi @ Xph @ (cwceq @ XT @ (ccdm @ (ccdm @ XJ)))) => (cwi @ Xph @ (cwfn @ XJ @ (ccxp @ XT @ XT)))))))))).
...
thf(cssctr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccssc) @ (cwbr @ XB2 @ XC @ ccssc)) @ (cwbr @ XA2 @ XC @ ccssc)))))).
