...
thf(arefldivcl_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccr) @ (cwcel @ XL @ ccrp)) @ (cwcel @ (ccfv @ (cco @ XK @ XL @ ccdiv) @ ccfl) @ ccr))))).
...
thf(cltdifltdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp) @ (cwcel @ XC @ ccr)) @ (cwi @ (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ cclt) @ (cwbr @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (cco @ XC @ XB2 @ ccdiv) @ cclt))))))).
