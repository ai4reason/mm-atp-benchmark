...
thf(admadjrnb_thm,axiom,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ (ccdm @ ccado)) @ (cwcel @ (ccfv @ XT @ ccado) @ (ccdm @ ccado))))).
...
thf(acnvadj_thm,axiom,(cwceq @ (cccnv @ ccado) @ ccado)).
...
thf(cadjbdlnb_conj,conjecture,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ ccbo) @ (cwcel @ (ccfv @ XT @ ccado) @ ccbo)))).
