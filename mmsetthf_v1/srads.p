...
thf(csrads_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ (ccfv @ XS @ (ccfv @ XW @ ccsra)))) => ((cwi @ Xph @ (cwss @ XS @ (ccfv @ XW @ ccbs))) => (cwi @ Xph @ (cwceq @ (ccfv @ XW @ ccds) @ (ccfv @ XA2 @ ccds)))))))))).
