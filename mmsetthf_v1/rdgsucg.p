...
thf(atz7_44_21_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ cc0) @ (XA2 @ Xy1) @ (ccif @ (cwlim @ (ccdm @ (ccv @ Xx3))) @ (ccuni @ (ccrn @ (ccv @ Xx3))) @ (ccfv @ (ccfv @ (ccuni @ (ccdm @ (ccv @ Xx3))) @ (ccv @ Xx3)) @ (XH @ Xy1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ (XX @ Xx3)) @ (cwceq @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccres @ XF @ (ccv @ Xy1)) @ (XG @ Xx3)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ (XX @ Xx3)) @ (cwcel @ (ccres @ XF @ (ccv @ Xy1)) @ ccvv)))) => ((! [Xx3:$i] : (cwfn @ XF @ (XX @ Xx3))) => ((! [Xx3:$i] : (cword @ (XX @ Xx3))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ (ccsuc @ XB2) @ (XX @ Xx3)) @ (cwceq @ (ccfv @ (ccsuc @ XB2) @ XF) @ (ccfv @ (ccfv @ XB2 @ XF) @ (XH @ Xy1)))))))))))))))))).
...
thf(crdgsucg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccdm @ (ccrdg @ XF @ XA2))) @ (cwceq @ (ccfv @ (ccsuc @ XB2) @ (ccrdg @ XF @ XA2)) @ (ccfv @ (ccfv @ XB2 @ (ccrdg @ XF @ XA2)) @ XF))))))).
