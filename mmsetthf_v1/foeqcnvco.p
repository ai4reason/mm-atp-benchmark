...
thf(afococnv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfo @ XA2 @ XB2 @ XF) @ (cwceq @ (cccom @ XF @ (cccnv @ XF)) @ (ccres @ ccid @ XB2))))))).
...
thf(afnopfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ XA2)) @ (cwcel @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)) @ XF)))))).
...
thf(cfoeqcnvco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfo @ XA2 @ XB2 @ XF) @ (cwfo @ XA2 @ XB2 @ XG)) @ (cwb @ (cwceq @ XF @ XG) @ (cwceq @ (cccom @ XF @ (cccnv @ XG)) @ (ccres @ ccid @ XB2))))))))).
