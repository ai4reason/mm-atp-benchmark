...
thf(achpval2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccchp) @ (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ cclog) @ (ccfv @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ (ccv @ Xp) @ cclog) @ ccdiv) @ ccfl) @ ccmul))))))).
...
thf(cchpchtsum_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ XA2 @ ccchp) @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ XA2 @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ cccxp) @ cccht))))))).
