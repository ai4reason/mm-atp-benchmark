...
thf(apjomli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccsh) => (cwi @ (cwa @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccin @ XB2 @ (ccfv @ XA2 @ ccort)) @ cc0h)) @ (cwceq @ XA2 @ XB2))))))).
...
thf(cpjoml2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwss @ XA2 @ XB2) @ (cwceq @ (cco @ XA2 @ (ccin @ (ccfv @ XA2 @ ccort) @ XB2) @ cchj) @ XB2))))))).
