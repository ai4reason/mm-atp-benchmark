...
thf(aser1const_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn)) @ (cwceq @ (ccfv @ XN @ (ccseq @ ccaddc @ (ccxp @ ccn @ (ccsn @ XA2)) @ cc1)) @ (cco @ XN @ XA2 @ ccmul)))))).
...
thf(cfsumconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : XB2)) @ (cco @ (ccfv @ XA2 @ cchash) @ XB2 @ ccmul)))))).
