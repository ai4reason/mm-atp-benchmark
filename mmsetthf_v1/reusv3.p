...
thf(areusv3i_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwb @ (Xph @ Xy1) @ (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwceq @ (XC @ Xy1) @ (XD @ Xz))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (Xps @ Xz)) @ (cwceq @ (XC @ Xy1) @ (XD @ Xz)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)))))))))))))).
thf(creusv3_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwb @ (Xph @ Xy1) @ (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwceq @ (XC @ Xy1) @ (XD @ Xz))))) => (cwi @ (cwrex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xy1) @ (cwcel @ (XC @ Xy1) @ XA2))) @ (^ [Xy1:$i] : XB2)) @ (cwb @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (Xps @ Xz)) @ (cwceq @ (XC @ Xy1) @ (XD @ Xz)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))))))).
