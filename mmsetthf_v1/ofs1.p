...
thf(cofs1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XT)) @ (cwceq @ (cco @ (ccs1 @ XA2) @ (ccs1 @ XB2) @ (ccof @ XR)) @ (ccs1 @ (cco @ XA2 @ XB2 @ XR)))))))))).
