...
thf(csuppvalfn_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XX) @ (cwcel @ XX @ XV) @ (cwcel @ XZ @ XW)) @ (cwceq @ (cco @ XF @ XZ @ ccsupp) @ (ccrab @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XF) @ XZ)) @ (^ [Xi:$i] : XX)))))))))).
