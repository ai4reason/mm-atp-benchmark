...
thf(crankunb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ XB2 @ (ccuni @ (ccima @ ccr1 @ ccon0)))) @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk) @ (ccun @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk))))))).
