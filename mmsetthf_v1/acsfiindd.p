...
thf(aacsficl2d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xx3) @ (ccfv @ (XX @ Xx3) @ ccacs)))) => ((! [Xx3:$i] : (cwceq @ XN @ (ccfv @ (XA2 @ Xx3) @ ccmrc))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XS @ (XX @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwb @ (cwcel @ XY @ (ccfv @ XS @ XN)) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ XY @ (ccfv @ (ccv @ Xx3) @ XN))) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XS) @ ccfn)))))))))))))))).
...
thf(cacsfiindd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XX @ ccacs))) => ((cwceq @ XN @ (ccfv @ XA2 @ ccmrc)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccmri)) => ((cwi @ Xph @ (cwss @ XS @ XX)) => (cwi @ Xph @ (cwb @ (cwcel @ XS @ XI) @ (cwss @ (ccin @ (ccpw @ XS) @ ccfn) @ XI)))))))))))))).
