...
thf(arestmetu_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwss @ XA2 @ XX)) @ (cwceq @ (cco @ (ccfv @ XD @ ccmetu) @ (ccxp @ XA2 @ XA2) @ ccrest) @ (ccfv @ (ccres @ XD @ (ccxp @ XA2 @ XA2)) @ ccmetu))))))).
...
thf(creust_conj,conjecture,(cwceq @ (ccfv @ ccrefld @ ccuss) @ (ccfv @ (ccres @ (ccfv @ ccrefld @ ccds) @ (ccxp @ ccr @ ccr)) @ ccmetu))).
