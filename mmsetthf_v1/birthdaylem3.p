...
thf(anecon4abid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwb @ (cwne @ XA2 @ XB2) @ (cwn @ Xps))) => (cwi @ Xph @ (cwb @ (cwceq @ XA2 @ XB2) @ Xps)))))))).
...
thf(adiv0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ ccc0 @ XA2 @ ccdiv) @ ccc0))))))).
...
thf(abirthdaylem1_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))))) => ((! [Xf1:$i] : (cwceq @ (XT @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))))) => (! [Xf1:$i] : (cw3a @ (cwss @ (XT @ Xf1) @ (XS @ Xf1)) @ (cwcel @ (XS @ Xf1) @ ccfn) @ (cwi @ (cwcel @ XN @ ccn) @ (cwne @ (XS @ Xf1) @ cc0))))))))))).
...
thf(abirthdaylem2_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XS @ Xf1 @ Xk) @ (ccab @ (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xf1 @ Xk) @ (ccab @ (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))))) => (! [Xf1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz))) @ (cwceq @ (cco @ (ccfv @ (XT @ Xf1 @ Xk) @ cchash) @ (ccfv @ (XS @ Xf1 @ Xk) @ cchash) @ ccdiv) @ (ccfv @ (ccsu @ (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xk) @ XN @ ccdiv) @ ccmin) @ cclog))) @ cce)))))))))))).
...
thf(aeflegeo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ cclt)) => (cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ cce) @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccle)))))))).
...
thf(alerec2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ cclt))) @ (cwb @ (cwbr @ XA2 @ (cco @ cc1 @ XB2 @ ccdiv) @ ccle) @ (cwbr @ XB2 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccle)))))).
...
thf(aarisum2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (ccv @ Xk))) @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ XN @ ccmin) @ cc2 @ ccdiv))))).
...
thf(cbirthdaylem3_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))))) => ((! [Xf1:$i] : (cwceq @ (XT @ Xf1) @ (ccab @ (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XK @ ccn0) @ (cwcel @ XN @ ccn)) @ (cwbr @ (cco @ (ccfv @ (XT @ Xf1) @ cchash) @ (ccfv @ (XS @ Xf1) @ cchash) @ ccdiv) @ (ccfv @ (ccneg @ (cco @ (cco @ (cco @ (cco @ XK @ cc2 @ ccexp) @ XK @ ccmin) @ cc2 @ ccdiv) @ XN @ ccdiv)) @ cce) @ ccle)))))))))).
