...
thf(acnss1_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XK @ (ccfv @ XX @ cctopon)) @ (cwss @ XJ @ XK)) @ (cwss @ (cco @ XJ @ XL @ cccn) @ (cco @ XK @ XL @ cccn))))))))).
...
thf(cxkopjcn_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XR)) => (cwi @ (cw3a @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ cctop) @ (cwcel @ XA2 @ XX)) @ (cwcel @ (ccmpt @ (^ [Xf1:$i] : (cco @ XR @ XS @ cccn)) @ (^ [Xf1:$i] : (ccfv @ XA2 @ (ccv @ Xf1)))) @ (cco @ (cco @ XS @ XR @ ccxko) @ XS @ cccn))))))))).
