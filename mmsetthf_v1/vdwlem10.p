...
thf(cvdwlem10_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XR @ ccfn))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XK @ (ccfv @ cc2 @ ccuz)))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwbr @ XK @ (ccv @ Xf1) @ ccvdwm)) @ (^ [Xf1:$i] : (cco @ (ccv @ Xs1) @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))) @ (^ [Xs1:$i] : ccfn)))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XM @ Xs1) @ ccn))) => (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwo @ (cwbr @ (ccop @ (XM @ Xs1) @ XK) @ (ccv @ Xf1) @ ccvdwp) @ (cwbr @ (cco @ XK @ cc1 @ ccaddc) @ (ccv @ Xf1) @ ccvdwm))) @ (^ [Xf1:$i] : (cco @ XR @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))))))))))))).
