...
thf(cmon1psubm_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XM @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XU @ (ccfv @ XP @ ccmgp)) => (cwi @ (cwcel @ XR @ ccnzr) @ (cwcel @ XM @ (ccfv @ XU @ ccsubmnd))))))))))).
