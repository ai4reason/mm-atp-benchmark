...
thf(cfallfacfwd_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccfallfac) @ ccmin) @ (cco @ XN @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccfallfac) @ ccmul)))))).
