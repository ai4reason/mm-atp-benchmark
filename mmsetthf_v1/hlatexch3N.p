...
thf(chlatexch3N_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwa @ (cwne @ XQ @ XR) @ (cwceq @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XP @ XR @ Xc_or)))) @ (cwceq @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XQ @ XR @ Xc_or)))))))))))).
