...
thf(ccongr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XM @ ccn)) @ (cwb @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XB2 @ XM @ ccmo)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (ccv @ Xn) @ XM @ ccmul) @ (cco @ XA2 @ XB2 @ ccmin))) @ (^ [Xn:$i] : ccz)))))))).
