...
thf(adprd2db_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((cwi @ Xph @ (cwrel @ XA2)) => ((cwi @ Xph @ (cwf @ XA2 @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xj:$i] : (cwi @ Xph @ (cwss @ (ccdm @ XA2) @ (XI @ Xj)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ (XI @ Xj))) @ (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ (ccdm @ ccdprd))))) => ((! [Xj:$i] : (cwi @ Xph @ (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ (ccdm @ ccdprd)))) => ((! [Xj:$i] : (cwceq @ (XK @ Xj) @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc))) => (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (cco @ XG @ XS @ ccdprd) @ (cco @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ ccdprd))))))))))))))))).
thf(aeqtr3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XA2 @ XC)) => (cwi @ Xph @ (cwceq @ XB2 @ XC))))))))).
thf(cdprd2d2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xi) @ XI) @ (cwcel @ (ccv @ Xj) @ (XJ @ Xi)))) @ (cwcel @ (XS @ Xi @ Xj) @ (ccfv @ XG @ ccsubg))))) => ((! [Xi:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xi) @ XI)) @ (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ (ccdm @ ccdprd)))) => ((cwi @ Xph @ (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ ccdprd))) @ (ccdm @ ccdprd))) => (cwi @ Xph @ (cwa @ (cwbr @ XG @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XI)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XJ @ Xi))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XS @ Xi @ Xj)))) @ (ccdm @ ccdprd)) @ (cwceq @ (cco @ XG @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XI)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XJ @ Xi))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XS @ Xi @ Xj)))) @ ccdprd) @ (cco @ XG @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ ccdprd))) @ ccdprd))))))))))))).
