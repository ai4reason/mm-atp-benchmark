...
thf(anmcfnlbi_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwi @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))))).
...
thf(cnmcfnlb_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ cclf) @ (cwcel @ XT @ cccnfn) @ (cwcel @ XA2 @ cchil)) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))).
