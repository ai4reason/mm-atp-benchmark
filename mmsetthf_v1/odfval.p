...
thf(adf_od_ax,axiom,(cwceq @ ccod @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)) @ (^ [Xx3:$i] : (ccsb @ (ccrab @ (^ [Xn:$i] : (cwceq @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xg1) @ ccmg)) @ (ccfv @ (ccv @ Xg1) @ cc0g))) @ (^ [Xn:$i] : ccn)) @ (^ [Xi:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ cc0) @ ccc0 @ (ccinf @ (ccv @ Xi) @ ccr @ cclt)))))))))).
