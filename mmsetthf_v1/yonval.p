...
thf(adf_yon_ax,axiom,(cwceq @ ccyon @ (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (cco @ (ccop @ (ccv @ Xc) @ (ccfv @ (ccv @ Xc) @ ccoppc)) @ (ccfv @ (ccfv @ (ccv @ Xc) @ ccoppc) @ cchof) @ cccurf))))).
...
thf(cyonval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XC @ ccyon)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => ((cwceq @ XM @ (ccfv @ XO @ cchof)) => (cwi @ Xph @ (cwceq @ XY @ (cco @ (ccop @ XC @ XO) @ XM @ cccurf))))))))))))).
