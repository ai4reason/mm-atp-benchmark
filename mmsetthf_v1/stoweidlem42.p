...
thf(abernneq_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ (ccneg @ cc1) @ XA2 @ ccle)) @ (cwbr @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccmul) @ ccaddc) @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ XN @ ccexp) @ ccle))))).
...
thf(afmuldfeq_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xt:$i] : (cwnf @ (^ [Xi:$i] : (Xph @ Xt @ Xi)))) => ((! [Xi:$i] : (cwnfc @ (^ [Xt:$i] : (XY @ Xt @ Xi)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XX @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccfv @ (XM @ Xt) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ XU @ cc1))))))) => ((! [Xt:$i] : (! [Xi:$i] : (cwceq @ (XF @ Xt @ Xi) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (XM @ Xt) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XZ @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (XM @ Xt) @ (ccseq @ ccmul @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ cc1))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwcel @ XT @ ccvv)))) => ((! [Xt:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwcel @ (XM @ Xt) @ ccn)))) => ((! [Xt:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwf @ (cco @ cc1 @ (XM @ Xt) @ ccfz) @ (XY @ Xt @ Xi) @ XU)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi))) @ (cwf @ XT @ ccr @ (ccv @ Xf1)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cw3a @ (Xph @ Xt @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XY @ Xt @ Xi))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XY @ Xt @ Xi))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xi) @ (cwcel @ (ccv @ Xt) @ XT)) @ (cwceq @ (ccfv @ (ccv @ Xt) @ (XX @ Xt @ Xf1 @ Xg1 @ Xi)) @ (ccfv @ (ccv @ Xt) @ (XZ @ Xt @ Xf1 @ Xg1 @ Xi))))))))))))))))))))))))))))).
thf(cstoweidlem42_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xt:$i] : (cwnf @ (^ [Xi:$i] : (Xph @ Xt @ Xi)))) => ((! [Xi:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xt @ Xi)))) => ((! [Xi:$i] : (cwnfc @ (^ [Xt:$i] : (XY @ Xt @ Xi)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XX @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccfv @ (XM @ Xt) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ XU @ cc1))))))) => ((! [Xt:$i] : (! [Xi:$i] : (cwceq @ (XF @ Xt @ Xi) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (XM @ Xt) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwceq @ (XZ @ Xt @ Xf1 @ Xg1 @ Xi) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (XM @ Xt) @ (ccseq @ ccmul @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ cc1))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwcel @ (XM @ Xt) @ ccn)))) => ((! [Xt:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwf @ (cco @ cc1 @ (XM @ Xt) @ ccfz) @ (XY @ Xt @ Xi) @ XU)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xi) @ (cwcel @ (ccv @ Xi) @ (cco @ cc1 @ (XM @ Xt) @ ccfz))) @ (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (cco @ (XE @ Xt @ Xf1 @ Xg1) @ (XM @ Xt) @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU)) @ cclt)) @ (^ [Xt:$i] : (XB2 @ Xt @ Xf1 @ Xg1)))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwcel @ (XE @ Xt @ Xf1 @ Xg1) @ ccrp)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwbr @ (XE @ Xt @ Xf1 @ Xg1) @ (cco @ cc1 @ cc3 @ ccdiv) @ cclt)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xt @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi))) @ (cwf @ XT @ ccr @ (ccv @ Xf1)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (cw3a @ (Xph @ Xt @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XY @ Xt @ Xi))) @ (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XY @ Xt @ Xi))))))) => ((! [Xt:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwcel @ XT @ ccvv)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwss @ (XB2 @ Xt @ Xf1 @ Xg1) @ XT)))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xt @ Xi) @ (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (XE @ Xt @ Xf1 @ Xg1) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (XX @ Xt @ Xf1 @ Xg1 @ Xi)) @ cclt)) @ (^ [Xt:$i] : (XB2 @ Xt @ Xf1 @ Xg1)))))))))))))))))))))))))))))))))))).
