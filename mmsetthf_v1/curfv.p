...
thf(acureq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (cccur @ XA2) @ (cccur @ XB2)))))).
...
thf(ccurfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwfn @ XF @ (ccxp @ XV @ XW)) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwcel @ XW @ XX)) @ (cwceq @ (ccfv @ XB2 @ (ccfv @ XA2 @ (cccur @ XF))) @ (cco @ XA2 @ XB2 @ XF)))))))))).
