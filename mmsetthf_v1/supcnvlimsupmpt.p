...
thf(asupcnvlimsup_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XZ @ ccr @ XF))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccfv @ XF @ cclsp) @ ccr))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccsup @ (ccrn @ (ccres @ XF @ (ccfv @ (ccv @ Xk) @ ccuz))) @ ccxr @ cclt))) @ (ccfv @ XF @ cclsp) @ ccli)))))))))))).
