...
thf(c_2pthfrgrrn_conj,conjecture,(! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XE @ Xa @ Xb @ Xc) @ (ccfv @ XG @ ccedg))))) => (cwi @ (cwcel @ XG @ ccfrgr) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xc:$i] : (cwrex @ (^ [Xb:$i] : (cwa @ (cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ (XE @ Xa @ Xb @ Xc)) @ (cwcel @ (ccpr @ (ccv @ Xb) @ (ccv @ Xc)) @ (XE @ Xa @ Xb @ Xc)))) @ (^ [Xb:$i] : XV))) @ (^ [Xc:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xa)))))) @ (^ [Xa:$i] : XV))))))))).
