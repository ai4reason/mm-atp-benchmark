...
thf(appiublem1_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwa @ (cwbr @ XN @ cc6 @ ccle) @ (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ cc4 @ XP @ ccle)) @ (cwi @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (cco @ XN @ cc5 @ ccfz)) @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))) => ((cwcel @ XM @ ccn0) => ((cwceq @ XN @ (cco @ XM @ cc1 @ ccaddc)) => ((cw3o @ (cwbr @ cc2 @ XM @ ccdvds) @ (cwbr @ cc3 @ XM @ ccdvds) @ (cwcel @ XM @ (ccpr @ cc1 @ cc5))) => (cwa @ (cwbr @ XM @ cc6 @ ccle) @ (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ cc4 @ XP @ ccle)) @ (cwi @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (cco @ XM @ cc5 @ ccfz)) @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))))))))))).
...
thf(a_3mix3i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (cw3o @ Xps @ Xch @ Xph)))))).
...
thf(a_3mix1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (cw3o @ Xph @ Xps @ Xch)))))).
...
thf(a_3mix2i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (cw3o @ Xps @ Xph @ Xch)))))).
...
thf(cppiublem2_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ cc4 @ XP @ ccle)) @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))).
