...
thf(anbgrclOLD_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XN @ (cco @ XG @ XX @ ccnbgr)) @ (cwcel @ XX @ (ccfv @ XG @ ccvtx))))))).
...
thf(cnbgrelOLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (! [Xe:$i] : (cwi @ (cwcel @ XG @ (XW @ Xe)) @ (cwb @ (cwcel @ XK @ (cco @ XG @ XN @ ccnbgr)) @ (cw3a @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XN @ XV)) @ (cwne @ XK @ XN) @ (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XN @ XK) @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
