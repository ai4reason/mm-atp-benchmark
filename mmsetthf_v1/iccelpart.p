...
thf(aiccpartres_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XP @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ cciccp))) @ (cwcel @ (ccres @ XP @ (cco @ ccc0 @ XM @ ccfz)) @ (ccfv @ XM @ cciccp)))))).
...
thf(asbcrex_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (XA2 @ Xx3)) @ (cwrex @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (XA2 @ Xx3))) @ (^ [Xy1:$i] : (XB2 @ Xy1))))))))).
...
thf(ciccelpart_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XM @ ccn) @ (cwral @ (^ [Xp:$i] : (cwi @ (cwcel @ XX @ (cco @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccfv @ XM @ (ccv @ Xp)) @ ccico)) @ (cwrex @ (^ [Xi:$i] : (cwcel @ XX @ (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ ccico))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo))))) @ (^ [Xp:$i] : (ccfv @ XM @ cciccp))))))).
