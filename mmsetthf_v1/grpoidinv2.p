...
thf(cgrpoidinv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XU @ (ccfv @ XG @ ccgi)) => (cwi @ (cwa @ (cwcel @ XG @ ccgr) @ (cwcel @ XA2 @ XX)) @ (cwa @ (cwa @ (cwceq @ (cco @ XU @ XA2 @ XG) @ XA2) @ (cwceq @ (cco @ XA2 @ XU @ XG) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xy1) @ XA2 @ XG) @ XU) @ (cwceq @ (cco @ XA2 @ (ccv @ Xy1) @ XG) @ XU))) @ (^ [Xy1:$i] : XX))))))))))).
