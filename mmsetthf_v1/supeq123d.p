...
thf(csupeq123d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XD)) => ((cwi @ Xph @ (cwceq @ XB2 @ XE)) => ((cwi @ Xph @ (cwceq @ XC @ XF)) => (cwi @ Xph @ (cwceq @ (ccsup @ XA2 @ XB2 @ XC) @ (ccsup @ XD @ XE @ XF)))))))))))))).
