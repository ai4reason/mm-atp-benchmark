...
thf(adf_dde_ax,axiom,(cwceq @ ccdde @ (ccmpt @ (^ [Xa:$i] : (ccpw @ ccr)) @ (^ [Xa:$i] : (ccif @ (cwcel @ ccc0 @ (ccv @ Xa)) @ cc1 @ ccc0))))).
...
thf(cddeval1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ ccc0 @ XA2)) @ (cwceq @ (ccfv @ XA2 @ ccdde) @ cc1)))).
