...
thf(aisinfcard_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwa @ (cwss @ ccom @ XA2) @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2)) @ (cwcel @ XA2 @ (ccrn @ ccale))))).
...
thf(aalephle_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwss @ XA2 @ (ccfv @ XA2 @ ccale))))).
...
thf(aeluniima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwb @ (cwcel @ XB2 @ (ccuni @ (ccima @ XF @ XA2))) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ XB2 @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(aalephfplem3_thm,axiom,(! [XH:($i > $o)] : ((cwceq @ XH @ (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (! [Xv:$i] : (cwi @ (cwcel @ (ccv @ Xv) @ ccom) @ (cwcel @ (ccfv @ (ccv @ Xv) @ XH) @ (ccrn @ ccale))))))).
...
thf(aalephfplem2_thm,axiom,(! [Xw:$i] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (cwi @ (cwcel @ (ccv @ Xw) @ ccom) @ (cwceq @ (ccfv @ (ccsuc @ (ccv @ Xw)) @ XH) @ (ccfv @ (ccfv @ (ccv @ Xw) @ XH) @ ccale))))))).
...
thf(aordtri4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cword @ XB2)) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cwa @ (cwss @ XA2 @ XB2) @ (cwn @ (cwcel @ XA2 @ XB2)))))))).
thf(aadantl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ Xch @ Xph) @ Xps)))))).
thf(aeqeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwceq @ XC @ XA2) @ (cwceq @ XC @ XB2))))))).
thf(calephfp_conj,conjecture,(! [XH:($i > $o)] : ((cwceq @ XH @ (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (cwceq @ (ccfv @ (ccuni @ (ccima @ XH @ ccom)) @ ccale) @ (ccuni @ (ccima @ XH @ ccom)))))).
