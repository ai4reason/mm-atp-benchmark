...
thf(afndmu_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwfn @ XF @ XB2)) @ (cwceq @ XA2 @ XB2)))))).
...
thf(clmodfopnelem1_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XW @ ccscaf)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusf)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XS @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XS @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwceq @ Xc_pl @ Xc_x)) @ (cwceq @ XV @ XK)))))))))))))).
