...
thf(anlmdsdir_thm,axiom,(! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccds)) => ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((cwceq @ XE @ (ccfv @ XF @ ccds)) => (cwi @ (cwa @ (cwcel @ XW @ ccnlm) @ (cw3a @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XK) @ (cwcel @ XZ @ XV))) @ (cwceq @ (cco @ (cco @ XX @ XY @ XE) @ (ccfv @ XZ @ XN) @ ccmul) @ (cco @ (cco @ XX @ XZ @ Xc_x) @ (cco @ XY @ XZ @ Xc_x) @ XD)))))))))))))))))))))).
