...
thf(ajoineu_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (Xc_le @ Xx3 @ Xz) @ (ccfv @ XK @ ccple)))) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XK @ (XV @ Xx3 @ Xz))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XX @ XB2))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XY @ XB2))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (ccop @ XX @ XY) @ (ccdm @ Xc_or)))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwreu @ (^ [Xx3:$i] : (cwa @ (cwa @ (cwbr @ XX @ (ccv @ Xx3) @ (Xc_le @ Xx3 @ Xz)) @ (cwbr @ XY @ (ccv @ Xx3) @ (Xc_le @ Xx3 @ Xz))) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (cwbr @ XX @ (ccv @ Xz) @ (Xc_le @ Xx3 @ Xz)) @ (cwbr @ XY @ (ccv @ Xz) @ (Xc_le @ Xx3 @ Xz))) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_le @ Xx3 @ Xz)))) @ (^ [Xz:$i] : XB2)))) @ (^ [Xx3:$i] : XB2)))))))))))))))))))).
...
thf(ajoinval2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (Xc_le @ Xx3 @ Xz) @ (ccfv @ XK @ ccple)))) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwcel @ XK @ (XV @ Xx3 @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwcel @ XX @ XB2)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwcel @ XY @ XB2)))) => (! [Xx3:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwceq @ (cco @ XX @ XY @ Xc_or) @ (ccrio @ (^ [Xx3:$i] : (cwa @ (cwa @ (cwbr @ XX @ (ccv @ Xx3) @ (Xc_le @ Xx3 @ Xz)) @ (cwbr @ XY @ (ccv @ Xx3) @ (Xc_le @ Xx3 @ Xz))) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (cwbr @ XX @ (ccv @ Xz) @ (Xc_le @ Xx3 @ Xz)) @ (cwbr @ XY @ (ccv @ Xz) @ (Xc_le @ Xx3 @ Xz))) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_le @ Xx3 @ Xz)))) @ (^ [Xz:$i] : XB2)))) @ (^ [Xx3:$i] : XB2))))))))))))))))))))).
