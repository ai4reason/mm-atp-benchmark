...
thf(cpsrvscaval_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XS @ Xh) @ (cco @ XI @ (XR @ Xh) @ ccmps))) => ((! [Xh:$i] : (cwceq @ (Xc_xb @ Xh) @ (ccfv @ (XS @ Xh) @ ccvsca))) => ((! [Xh:$i] : (cwceq @ (XK @ Xh) @ (ccfv @ (XR @ Xh) @ ccbs))) => ((! [Xh:$i] : (cwceq @ (XB2 @ Xh) @ (ccfv @ (XS @ Xh) @ ccbs))) => ((! [Xh:$i] : (cwceq @ (Xc_x @ Xh) @ (ccfv @ (XR @ Xh) @ ccmulr))) => ((! [Xh:$i] : (cwceq @ (XD @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ (XX @ Xh) @ (XK @ Xh)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ (XF @ Xh) @ (XB2 @ Xh)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ (XY @ Xh) @ (XD @ Xh)))) => (! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwceq @ (ccfv @ (XY @ Xh) @ (cco @ (XX @ Xh) @ (XF @ Xh) @ (Xc_xb @ Xh))) @ (cco @ (XX @ Xh) @ (ccfv @ (XY @ Xh) @ (XF @ Xh)) @ (Xc_x @ Xh))))))))))))))))))))))))))).
