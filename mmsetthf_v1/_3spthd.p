...
thf(afuncnvs4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XD @ XV))) @ (cw3a @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XA2 @ XD)) @ (cwa @ (cwne @ XB2 @ XC) @ (cwne @ XB2 @ XD)) @ (cwne @ XC @ XD))) @ (cwfun @ (cccnv @ (ccs4 @ XA2 @ XB2 @ XC @ XD)))))))))).
