...
thf(adfac12r_thm,axiom,(cwb @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccpw @ (ccv @ Xx3)) @ (ccdm @ cccrd))) @ (^ [Xx3:$i] : ccon0)) @ (cwss @ (ccuni @ (ccima @ ccr1 @ ccon0)) @ (ccdm @ cccrd)))).
thf(cdfac12a_conj,conjecture,(cwb @ cwac @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccpw @ (ccv @ Xx3)) @ (ccdm @ cccrd))) @ (^ [Xx3:$i] : ccon0)))).
