...
thf(csrgbinomlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_xp @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwceq @ XG @ (ccfv @ XR @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XG @ ccmg)) => ((cwi @ Xph @ (cwcel @ XR @ ccsrg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XB2 @ XS)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_xp) @ (cco @ XB2 @ XA2 @ Xc_xp))) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ XC @ ccn0) @ (cwcel @ XD @ ccn0) @ (cwcel @ XE @ ccn0))) @ (cwcel @ (cco @ XC @ (cco @ (cco @ XD @ XA2 @ Xc_ex) @ (cco @ XE @ XB2 @ Xc_ex) @ Xc_xp) @ Xc_x) @ XS)))))))))))))))))))))))))))).
