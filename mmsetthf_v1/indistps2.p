...
thf(aistpsi_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ (ccfv @ XK @ ccbs) @ XA2) => ((cwceq @ (ccfv @ XK @ cctopn) @ XJ) => ((cwceq @ XA2 @ (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => (cwcel @ XK @ cctps))))))))).
...
thf(cindistps2_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ (ccfv @ XK @ ccbs) @ XA2) => ((cwceq @ (ccfv @ XK @ cctopn) @ (ccpr @ cc0 @ XA2)) => (cwcel @ XK @ cctps)))))).
