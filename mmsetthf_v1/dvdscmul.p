...
thf(cdvdscmul_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XK @ ccz)) @ (cwi @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccdvds))))))).
