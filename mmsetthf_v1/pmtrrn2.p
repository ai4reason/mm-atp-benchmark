...
thf(cpmtrrn2_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => ((cwceq @ XR @ (ccrn @ XT)) => (cwi @ (cwcel @ XF @ XR) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ XF @ (ccfv @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XT)))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD)))))))))).
