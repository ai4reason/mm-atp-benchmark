...
thf(covnprodcl_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XX @ ccfn))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ ccn @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ (XF @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XI @ Xk) @ ccn))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (XI @ Xk) @ (XF @ Xk)))) @ ccvol))) @ (cco @ ccc0 @ ccpnf @ ccico))))))))))))).
