...
thf(awlkiswwlks2lem1_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ (XE @ Xx3))))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XP @ (ccword @ (XV @ Xx3))) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwceq @ (ccfv @ (XF @ Xx3) @ cchash) @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)))))))))).
...
thf(awlkiswwlks2lem2_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (ccfv @ XP @ cchash) @ ccn0) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (XF @ Xx3)) @ (ccfv @ (ccpr @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE))))))))))).
