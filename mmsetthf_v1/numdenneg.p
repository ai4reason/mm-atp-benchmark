...
thf(aqnumdencoprm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccnumer) @ (ccfv @ XA2 @ ccdenom) @ ccgcd) @ cc1)))).
...
thf(cnumdenneg_conj,conjecture,(! [XQ:($i > $o)] : (cwi @ (cwcel @ XQ @ ccq) @ (cwa @ (cwceq @ (ccfv @ (ccneg @ XQ) @ ccnumer) @ (ccneg @ (ccfv @ XQ @ ccnumer))) @ (cwceq @ (ccfv @ (ccneg @ XQ) @ ccdenom) @ (ccfv @ XQ @ ccdenom)))))).
