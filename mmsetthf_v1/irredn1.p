...
thf(airrednu_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ ccir)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => (cwi @ (cwcel @ XX @ XI) @ (cwn @ (cwcel @ XX @ XU)))))))))).
...
thf(cirredn1_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ ccir)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XI)) @ (cwne @ XX @ Xc_1))))))))).
