...
thf(adf_mrex_ax,axiom,(cwceq @ ccmrex @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccword @ (ccun @ (ccfv @ (ccv @ Xt) @ ccmcn) @ (ccfv @ (ccv @ Xt) @ ccmvar))))))).
...
thf(cmrexval_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XC @ (ccfv @ XT @ ccmcn)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => (cwi @ (cwcel @ XT @ XW) @ (cwceq @ XR @ (ccword @ (ccun @ XC @ XV))))))))))))).
