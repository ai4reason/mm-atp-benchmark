...
thf(aclmsubcl_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ ccclm) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XK)) @ (cwcel @ (cco @ XX @ XY @ ccmin) @ XK)))))))))).
...
thf(acvsdiveqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwi @ Xph @ (cwcel @ XW @ cccvs)) => ((cwi @ Xph @ (cwcel @ XA2 @ XK)) => ((cwi @ Xph @ (cwcel @ XB2 @ XK)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwceq @ XX @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ XY @ Xc_x))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XB2 @ XA2 @ ccdiv) @ XX @ Xc_x) @ XY))))))))))))))))))))))))).
...
thf(agrpnnncan2_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) @ (cwceq @ (cco @ (cco @ XX @ XZ @ Xc_mi) @ (cco @ XY @ XZ @ Xc_mi) @ Xc_mi) @ (cco @ XX @ XY @ Xc_mi)))))))))))).
...
thf(aablpncan2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccabl) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwceq @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XX @ Xc_mi) @ XY)))))))))))).
...
thf(cttgcontlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (ccfv @ XH @ ccttg)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XP @ (ccfv @ XH @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XH @ ccsg)) => ((cwceq @ Xc_x @ (ccfv @ XH @ ccvsca)) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XY @ XP)) => ((cwceq @ XR @ (ccfv @ (ccfv @ XH @ ccsca) @ ccbs)) => ((cwi @ Xph @ (cwss @ (cco @ ccc0 @ cc1 @ ccicc) @ XR)) => ((cwceq @ Xc_pl @ (ccfv @ XH @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XH @ cccvs)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XN @ XP)) => ((cwi @ Xph @ (cwne @ XM @ ccc0)) => ((cwi @ Xph @ (cwne @ XK @ ccc0)) => ((cwi @ Xph @ (cwne @ XK @ cc1)) => ((cwi @ Xph @ (cwne @ XL @ XM)) => ((cwi @ Xph @ (cwbr @ XL @ (cco @ XM @ XK @ ccdiv) @ ccle)) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ ccc0 @ cc1 @ ccicc))) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ ccc0 @ cc1 @ ccicc))) => ((cwi @ Xph @ (cwcel @ XM @ (cco @ ccc0 @ XL @ ccicc))) => ((cwi @ Xph @ (cwceq @ (cco @ XX @ XA2 @ Xc_mi) @ (cco @ XK @ (cco @ XY @ XA2 @ Xc_mi) @ Xc_x))) => ((cwi @ Xph @ (cwceq @ (cco @ XX @ XA2 @ Xc_mi) @ (cco @ XM @ (cco @ XN @ XA2 @ Xc_mi) @ Xc_x))) => ((cwi @ Xph @ (cwceq @ XB2 @ (cco @ XA2 @ (cco @ XL @ (cco @ XN @ XA2 @ Xc_mi) @ Xc_x) @ Xc_pl))) => (cwi @ Xph @ (cwcel @ XB2 @ (cco @ XX @ XY @ XI))))))))))))))))))))))))))))))))))))))))))))).
