...
thf(aislmim_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (ccfv @ XS @ ccbs)) => (cwb @ (cwcel @ XF @ (cco @ XR @ XS @ cclmim)) @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ cclmhm)) @ (cwf1o @ XB2 @ XC @ XF))))))))))).
...
thf(almhmco_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XN @ XO @ cclmhm)) @ (cwcel @ XG @ (cco @ XM @ XN @ cclmhm))) @ (cwcel @ (cccom @ XF @ XG) @ (cco @ XM @ XO @ cclmhm))))))))).
...
thf(clmimco_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmim)) @ (cwcel @ XG @ (cco @ XR @ XS @ cclmim))) @ (cwcel @ (cccom @ XF @ XG) @ (cco @ XR @ XT @ cclmim))))))))).
