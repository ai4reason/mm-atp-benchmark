...
thf(aexpsub_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz))) @ (cwceq @ (cco @ XA2 @ (cco @ XM @ XN @ ccmin) @ ccexp) @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccdiv))))))).
...
thf(ann0digval_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ ccn0) @ (cwcel @ XR @ (cco @ ccc0 @ ccpnf @ ccico))) @ (cwceq @ (cco @ XK @ XR @ (ccfv @ XB2 @ ccdig)) @ (cco @ (ccfv @ (cco @ XR @ (cco @ XB2 @ XK @ ccexp) @ ccdiv) @ ccfl) @ XB2 @ ccmo))))))).
...
thf(aeluz2gt1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwbr @ cc1 @ XN @ cclt)))).
...
thf(asublt0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ cclt) @ (cwbr @ XA2 @ XB2 @ cclt))))))))).
thf(ann0re_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XA2 @ ccr)))).
thf(ccxr_tp,type,(ccxr : ($i > $o))).
thf(aexpnegico01_thm,axiom,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz) @ (cwbr @ XN @ ccc0 @ cclt)) @ (cwcel @ (cco @ XB2 @ XN @ ccexp) @ (cco @ ccc0 @ cc1 @ ccico)))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(aico01fl0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccico)) @ (cwceq @ (ccfv @ XA2 @ ccfl) @ ccc0)))).
thf(annrpd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => (cwi @ Xph @ (cwcel @ XA2 @ ccrp)))))).
thf(a_0mod_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccrp) @ (cwceq @ (cco @ ccc0 @ XN @ ccmo) @ ccc0)))).
...
thf(apm4_56_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwa @ (cwn @ Xph) @ (cwn @ Xps)) @ (cwn @ (cwo @ Xph @ Xps)))))).
...
thf(aznnsub_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ cclt) @ (cwcel @ (cco @ XN @ XM @ ccmin) @ ccn)))))).
...
thf(cdigexp_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XK @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XK @ (cco @ XB2 @ XN @ ccexp) @ (ccfv @ XB2 @ ccdig)) @ (ccif @ (cwceq @ XK @ XN) @ cc1 @ ccc0))))))).
