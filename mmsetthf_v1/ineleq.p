...
thf(cineleq_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwo @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (ccin @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1)) @ cc0))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))) @ (cwral @ (^ [Xx3:$i] : (cwal @ (^ [Xz:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1)) @ (cwcel @ (ccv @ Xz) @ (XD @ Xx3 @ Xy1))) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))))))))).
