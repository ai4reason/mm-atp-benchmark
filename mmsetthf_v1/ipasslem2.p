...
thf(aipasslem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XB2 @ XX) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ (cco @ XN @ XA2 @ XS) @ XB2 @ XP) @ (cco @ XN @ (cco @ XA2 @ XB2 @ XP) @ ccmul)))))))))))))))))).
...
thf(amulneg1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (ccneg @ XA2) @ XB2 @ ccmul) @ (ccneg @ (cco @ XA2 @ XB2 @ ccmul))))))).
...
thf(aipdiri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => (cwi @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XG) @ XC @ XP) @ (cco @ (cco @ XA2 @ XC @ XP) @ (cco @ XB2 @ XC @ XP) @ ccaddc))))))))))))))))).
...
thf(cipasslem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XB2 @ XX) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ (cco @ (ccneg @ XN) @ XA2 @ XS) @ XB2 @ XP) @ (cco @ (ccneg @ XN) @ (cco @ XA2 @ XB2 @ XP) @ ccmul)))))))))))))))))).
