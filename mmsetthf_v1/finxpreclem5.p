...
thf(cfinxpreclem5_conj,conjecture,(! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xn) @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xx3:$i] : ccom)) @ (^ [Xn:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xx3:$i] : (ccif @ (cwa @ (cwceq @ (ccv @ Xn) @ cc1o) @ (cwcel @ (ccv @ Xx3) @ (XU @ Xx3 @ Xn))) @ cc0 @ (ccif @ (cwcel @ (ccv @ Xx3) @ (ccxp @ ccvv @ (XU @ Xx3 @ Xn))) @ (ccop @ (ccuni @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xx3) @ cc1st)) @ (ccop @ (ccv @ Xn) @ (ccv @ Xx3)))))))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xn) @ ccom) @ (cwcel @ cc1o @ (ccv @ Xn))) @ (cwi @ (cwn @ (cwcel @ (ccv @ Xx3) @ (ccxp @ ccvv @ (XU @ Xx3 @ Xn)))) @ (cwceq @ (ccfv @ (ccop @ (ccv @ Xn) @ (ccv @ Xx3)) @ (XF @ Xx3 @ Xn)) @ (ccop @ (ccv @ Xn) @ (ccv @ Xx3))))))))))).
