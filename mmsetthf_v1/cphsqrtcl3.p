...
thf(acphsqrtcl2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ XA2 @ XK) @ (cwn @ (cwcel @ (ccneg @ XA2) @ ccrp))) @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
thf(ccphsqrtcl3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ cci @ XK) @ (cwcel @ XA2 @ XK)) @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
