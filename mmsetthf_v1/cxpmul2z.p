...
thf(acxpmul2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccn0)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ cccxp) @ (cco @ (cco @ XA2 @ XB2 @ cccxp) @ XC @ ccexp))))))).
...
thf(ccxpmul2z_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwa @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccz))) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ cccxp) @ (cco @ (cco @ XA2 @ XB2 @ cccxp) @ XC @ ccexp))))))).
