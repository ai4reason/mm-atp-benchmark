...
thf(cofaddmndmap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XM @ ccmnd) @ (cwcel @ XV @ XY) @ (cwa @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) @ (cwcel @ XB2 @ (cco @ XR @ XV @ ccmap)))) @ (cwcel @ (cco @ XA2 @ XB2 @ (ccof @ Xc_pl)) @ (cco @ XR @ XV @ ccmap))))))))))))).
