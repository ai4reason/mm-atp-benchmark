...
thf(asmfpimbor1_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((cwceq @ XD @ (ccdm @ XF)) => ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwceq @ XB2 @ (ccfv @ XJ @ ccsalgen)) => ((cwi @ Xph @ (cwcel @ XE @ XB2)) => ((cwceq @ XP @ (ccima @ (cccnv @ XF) @ XE)) => (cwi @ Xph @ (cwcel @ XP @ (cco @ XS @ XD @ ccrest))))))))))))))))))).
...
thf(asmfpimcclem_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > ($i > $o))] : ((! [Xh:$i] : (! [Xs1:$i] : (cwnf @ (^ [Xn:$i] : (Xph @ Xh @ Xn @ Xs1))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwcel @ (XZ @ Xs1) @ (XV @ Xy1 @ Xh @ Xn @ Xs1)))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xh @ Xn @ Xs1) @ (cwcel @ XS @ (XW @ Xy1 @ Xh @ Xn @ Xs1))))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (Xph @ Xh @ Xn @ Xs1) @ (cwcel @ (ccv @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xn:$i] : (XZ @ Xs1)) @ (^ [Xn:$i] : (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (XA2 @ Xn)) @ (ccin @ (ccv @ Xs1) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ (^ [Xs1:$i] : XS))))))) @ (cwcel @ (ccfv @ (ccv @ Xy1) @ (XC @ Xh @ Xn)) @ (ccv @ Xy1))))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwceq @ (XH @ Xy1 @ Xn @ Xs1) @ (ccmpt @ (^ [Xn:$i] : (XZ @ Xs1)) @ (^ [Xn:$i] : (ccfv @ (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (XA2 @ Xn)) @ (ccin @ (ccv @ Xs1) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ (^ [Xs1:$i] : XS)) @ (XC @ Xh @ Xn))))))))) => (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xh @ Xn @ Xs1) @ (cwex @ (^ [Xh:$i] : (cwa @ (cwf @ (XZ @ Xs1) @ XS @ (ccv @ Xh)) @ (cwral @ (^ [Xn:$i] : (cwceq @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (XA2 @ Xn)) @ (ccin @ (ccfv @ (ccv @ Xn) @ (ccv @ Xh)) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ (^ [Xn:$i] : (XZ @ Xs1))))))))))))))))))))))))).
