...
thf(crspssid_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ XR @ ccrsp)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwss @ XG @ XB2)) @ (cwss @ XG @ (ccfv @ XG @ XK)))))))))).
