...
thf(aisbndx_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (cwceq @ XX @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
...
thf(cisbnd2_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwne @ XX @ cc0)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (cwceq @ XX @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
