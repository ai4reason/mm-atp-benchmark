...
thf(chsmexlem8_conj,conjecture,(! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xa:$i] : ((! [Xz:$i] : (cwceq @ (XH @ Xz) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ XX @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ XX) @ cchar)) @ ccom))) => (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xa) @ ccom) @ (cwceq @ (ccfv @ (ccsuc @ (ccv @ Xa)) @ (XH @ Xz)) @ (ccfv @ (ccpw @ (ccxp @ XX @ (ccfv @ (ccv @ Xa) @ (XH @ Xz)))) @ cchar))))))))).
