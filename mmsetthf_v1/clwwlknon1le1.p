...
thf(aclwwlknon1loop_thm,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XC @ (ccfv @ XG @ ccclwwlknon)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ (ccsn @ XX) @ XE)) @ (cwceq @ (cco @ XX @ cc1 @ XC) @ (ccsn @ (ccs1 @ XX))))))))))))).
...
thf(aclwwlknon1nloop_thm,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XC @ (ccfv @ XG @ ccclwwlknon)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwnel @ (ccsn @ XX) @ XE) @ (cwceq @ (cco @ XX @ cc1 @ XC) @ cc0))))))))))).
...
thf(aclwwlknon0_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwn @ (cwa @ (cwcel @ XX @ (ccfv @ XG @ ccvtx)) @ (cwcel @ XN @ ccn))) @ (cwceq @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ cc0)))))).
