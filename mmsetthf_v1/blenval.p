...
thf(adf_blen_ax,axiom,(cwceq @ ccblen @ (ccmpt @ (^ [Xn:$i] : ccvv) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ cc1 @ (cco @ (ccfv @ (cco @ cc2 @ (ccfv @ (ccv @ Xn) @ ccabs) @ cclogb) @ ccfl) @ cc1 @ ccaddc)))))).
...
thf(cblenval_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XN @ XV) @ (cwceq @ (ccfv @ XN @ ccblen) @ (ccif @ (cwceq @ XN @ ccc0) @ cc1 @ (cco @ (ccfv @ (cco @ cc2 @ (ccfv @ XN @ ccabs) @ cclogb) @ ccfl) @ cc1 @ ccaddc))))))).
