...
thf(alhpexlt_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : (cwceq @ (XH @ Xp) @ (ccfv @ XK @ cclh))) => (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ (XH @ Xp))) @ (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XW @ Xc_lt)) @ (^ [Xp:$i] : XA2))))))))))))).
...
thf(clhp0lt_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwbr @ Xc_0 @ XW @ Xc_lt))))))))))).
