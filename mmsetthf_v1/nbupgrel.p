...
thf(cnbupgrel_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XK @ XV)) @ (cwa @ (cwcel @ XN @ XV) @ (cwne @ XN @ XK))) @ (cwb @ (cwcel @ XN @ (cco @ XG @ XK @ ccnbgr)) @ (cwcel @ (ccpr @ XN @ XK) @ XE))))))))))).
