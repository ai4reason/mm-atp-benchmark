...
thf(advnxpaek_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XK @ ccn0)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ XA2 @ ccaddc) @ XK @ ccexp))))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ XN @ (cco @ XS @ (XF @ Xx3) @ ccdvn)) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccif @ (cwbr @ XK @ XN @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ XK @ ccfa) @ (ccfv @ (cco @ XK @ XN @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ XA2 @ ccaddc) @ (cco @ XK @ XN @ ccmin) @ ccexp) @ ccmul)))))))))))))))))))).
