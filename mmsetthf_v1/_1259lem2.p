...
thf(c_1259lem2_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => (cwceq @ (cco @ (cco @ cc2 @ (ccdc @ cc3 @ cc4) @ ccexp) @ XN @ ccmo) @ (cco @ (ccdc @ (ccdc @ cc8 @ cc7) @ ccc0) @ XN @ ccmo))))).
