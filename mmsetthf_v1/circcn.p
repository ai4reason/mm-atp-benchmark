...
thf(ccirccn_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (cco @ ccc0 @ (cco @ cc2 @ ccpi @ ccmul) @ ccicc))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ cce))))) => ((cwceq @ XC @ (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => (! [Xx3:$i] : (cwcel @ (XF @ Xx3) @ (cco @ (XJ @ Xx3) @ (cco @ (XJ @ Xx3) @ (XF @ Xx3) @ ccqtop) @ cccn)))))))))))).
