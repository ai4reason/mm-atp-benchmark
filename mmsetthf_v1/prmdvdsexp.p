...
thf(cprmdvdsexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwbr @ XP @ (cco @ XA2 @ XN @ ccexp) @ ccdvds) @ (cwbr @ XP @ XA2 @ ccdvds))))))).
