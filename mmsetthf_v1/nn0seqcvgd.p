...
thf(afnn0ind_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ ccc0) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xx3) @ (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XK @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xta @ Xy1))))) => ((! [Xy1:$i] : (cwi @ (cwcel @ XN @ ccn0) @ (Xps @ Xy1))) => ((! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccv @ Xy1) @ ccn0) @ (cwbr @ (ccv @ Xy1) @ XN @ cclt)) @ (cwi @ (Xch @ Xy1) @ (Xth @ Xy1)))) => (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ (XK @ Xy1) @ ccn0) @ (cwbr @ (XK @ Xy1) @ XN @ ccle)) @ (Xta @ Xy1))))))))))))))))).
...
thf(cnn0seqcvgd_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn0 @ ccn0 @ XF)) => ((cwi @ Xph @ (cwceq @ XN @ (ccfv @ ccc0 @ XF))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ ccn0)) @ (cwi @ (cwne @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ ccc0) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xk) @ XF) @ cclt)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ XF) @ ccc0))))))))).
