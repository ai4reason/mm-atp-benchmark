...
thf(cssprss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwss @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ (cwa @ (cwo @ (cwceq @ XA2 @ XC) @ (cwceq @ XA2 @ XD)) @ (cwo @ (cwceq @ XB2 @ XC) @ (cwceq @ XB2 @ XD)))))))))))).
