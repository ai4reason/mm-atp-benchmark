...
thf(ahomndx_thm,axiom,(cwceq @ (ccfv @ ccnx @ cchom) @ (ccdc @ cc1 @ cc4))).
thf(accondx_thm,axiom,(cwceq @ (ccfv @ ccnx @ ccco) @ (ccdc @ cc1 @ cc5))).
...
thf(atpos0_thm,axiom,(cwceq @ (cctpos @ cc0) @ cc0)).
...
thf(coppchomfval_conj,conjecture,(! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => (cwceq @ (cctpos @ XH) @ (ccfv @ XO @ cchom)))))))).
