...
thf(ceqop2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwceq @ XA2 @ (ccop @ XB2 @ XC)) @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ (cwa @ (cwceq @ (ccfv @ XA2 @ cc1st) @ XB2) @ (cwceq @ (ccfv @ XA2 @ cc2nd) @ XC)))))))))).
