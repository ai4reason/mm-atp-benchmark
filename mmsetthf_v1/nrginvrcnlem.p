...
thf(anmrpcl_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XG @ ccngp) @ (cwcel @ XA2 @ XX) @ (cwne @ XA2 @ Xc_0)) @ (cwcel @ (ccfv @ XA2 @ XN) @ ccrp))))))))))).
...
thf(anm2dif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccngp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_mi) @ XN) @ ccle)))))))))))).
...
thf(cnrginvrcnlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XX @ Xx3 @ Xy1) @ (ccfv @ XR @ ccbs)))) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (ccfv @ XR @ ccnm)))) => ((! [Xy1:$i] : (cwceq @ (XD @ Xy1) @ (ccfv @ XR @ ccds))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XR @ ccnrg))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XR @ ccnzr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xy1) @ XU)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XB2 @ Xy1) @ ccrp)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ XT @ (cco @ (ccif @ (cwbr @ cc1 @ (cco @ (ccfv @ (XA2 @ Xy1) @ (XN @ Xx3 @ Xy1)) @ (XB2 @ Xy1) @ ccmul) @ ccle) @ cc1 @ (cco @ (ccfv @ (XA2 @ Xy1) @ (XN @ Xx3 @ Xy1)) @ (XB2 @ Xy1) @ ccmul)) @ (cco @ (ccfv @ (XA2 @ Xy1) @ (XN @ Xx3 @ Xy1)) @ cc2 @ ccdiv) @ ccmul)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (cco @ (XA2 @ Xy1) @ (ccv @ Xy1) @ (XD @ Xy1)) @ (ccv @ Xx3) @ cclt) @ (cwbr @ (cco @ (ccfv @ (XA2 @ Xy1) @ XI) @ (ccfv @ (ccv @ Xy1) @ XI) @ (XD @ Xy1)) @ (XB2 @ Xy1) @ cclt))) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : ccrp))))))))))))))))))))))))).
