...
thf(adf_2idl_ax,axiom,(cwceq @ cc2idl @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccin @ (ccfv @ (ccv @ Xr) @ cclidl) @ (ccfv @ (ccfv @ (ccv @ Xr) @ ccoppr) @ cclidl)))))).
...
thf(c_2idlval_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ cclidl)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => ((cwceq @ XJ @ (ccfv @ XO @ cclidl)) => ((cwceq @ XT @ (ccfv @ XR @ cc2idl)) => (cwceq @ XT @ (ccin @ XI @ XJ)))))))))))).
