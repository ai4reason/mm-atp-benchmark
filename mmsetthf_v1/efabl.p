...
thf(aghmabl_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XY @ (ccfv @ XH @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_pd @ (ccfv @ XH @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XF) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ Xc_pd))))) => ((cwi @ Xph @ (cwfo @ XX @ XY @ XF)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => (cwi @ Xph @ (cwcel @ XH @ ccabl)))))))))))))))))).
...
thf(aefgh_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cce))))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XX @ (ccfv @ cccnfld @ ccsubg))) @ (cwcel @ (XB2 @ Xx3) @ XX) @ (cwcel @ (XC @ Xx3) @ XX)) @ (cwceq @ (ccfv @ (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccaddc) @ (XF @ Xx3)) @ (cco @ (ccfv @ (XB2 @ Xx3) @ (XF @ Xx3)) @ (ccfv @ (XC @ Xx3) @ (XF @ Xx3)) @ ccmul))))))))))).
...
thf(cefabl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cce)))) => ((cwceq @ XG @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccrn @ XF) @ ccress)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ cccnfld @ ccsubg))) => (cwi @ Xph @ (cwcel @ XG @ ccabl)))))))))))).
