...
thf(cot2ndg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) @ (cwceq @ (ccfv @ (ccfv @ (ccotp @ XA2 @ XB2 @ XC) @ cc1st) @ cc2nd) @ XB2))))))))).
