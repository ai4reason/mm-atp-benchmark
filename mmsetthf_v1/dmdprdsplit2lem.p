...
thf(alsmdisj3_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwceq @ (ccin @ (cco @ XS @ XT @ Xc_po) @ XU) @ (ccsn @ Xc_0))) => ((cwi @ Xph @ (cwceq @ (ccin @ XS @ XT) @ (ccsn @ Xc_0))) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwi @ Xph @ (cwss @ XS @ (ccfv @ XT @ XZ))) => (cwi @ Xph @ (cwceq @ (ccin @ XS @ (cco @ XT @ XU @ Xc_po)) @ (ccsn @ Xc_0))))))))))))))))))))).
...
thf(cdmdprdsplit2lem_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS)) => ((cwi @ Xph @ (cwceq @ (ccin @ XC @ XD) @ cc0)) => ((cwi @ Xph @ (cwceq @ XI @ (ccun @ XC @ XD))) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwbr @ XG @ (ccres @ XS @ XC) @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwbr @ XG @ (ccres @ XS @ XD) @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwss @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (ccfv @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd) @ XZ))) => ((cwi @ Xph @ (cwceq @ (ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) @ (ccsn @ Xc_0))) => ((cwceq @ XK @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ XC)) @ (cwa @ (cwi @ (cwcel @ XY @ XI) @ (cwi @ (cwne @ XX @ XY) @ (cwss @ (ccfv @ XX @ XS) @ (ccfv @ (ccfv @ XY @ XS) @ XZ)))) @ (cwss @ (ccin @ (ccfv @ XX @ XS) @ (ccfv @ (ccuni @ (ccima @ XS @ (ccdif @ XI @ (ccsn @ XX)))) @ XK)) @ (ccsn @ Xc_0)))))))))))))))))))))))))).
