...
thf(cxkoco2cn_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ cctop)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ cccn))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xg1:$i] : (cco @ XR @ XS @ cccn)) @ (^ [Xg1:$i] : (cccom @ XF @ (ccv @ Xg1)))) @ (cco @ (cco @ XS @ XR @ ccxko) @ (cco @ XT @ XR @ ccxko) @ cccn))))))))))).
