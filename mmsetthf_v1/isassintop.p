...
thf(aassintopmap_thm,axiom,(! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xo:$i] : (cwi @ (cwcel @ XM @ (XV @ Xo)) @ (cwceq @ (ccfv @ XM @ ccassintop) @ (ccrab @ (^ [Xo:$i] : (cwbr @ (ccv @ Xo) @ XM @ ccasslaw)) @ (^ [Xo:$i] : (cco @ XM @ (ccxp @ XM @ XM) @ ccmap))))))))).
...
thf(aisclintop_thm,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ XM @ XV) @ (cwb @ (cwcel @ Xc_op @ (ccfv @ XM @ ccclintop)) @ (cwf @ (ccxp @ XM @ XM) @ XM @ Xc_op))))))).
...
thf(cisassintop_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xc_op:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XM @ (XV @ Xx3 @ Xy1 @ Xz)) @ (cwb @ (cwcel @ Xc_op @ (ccfv @ XM @ ccassintop)) @ (cwa @ (cwf @ (ccxp @ XM @ XM) @ XM @ Xc_op) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_op) @ (ccv @ Xz) @ Xc_op) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_op) @ Xc_op))) @ (^ [Xz:$i] : XM))) @ (^ [Xy1:$i] : XM))) @ (^ [Xx3:$i] : XM)))))))))))).
