...
thf(cdivalg_conj,conjecture,(! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccz) @ (cwne @ XD @ ccc0)) @ (cwreu @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwbr @ ccc0 @ (ccv @ Xr) @ ccle) @ (cwbr @ (ccv @ Xr) @ (ccfv @ XD @ ccabs) @ cclt) @ (cwceq @ XN @ (cco @ (cco @ (ccv @ Xq) @ XD @ ccmul) @ (ccv @ Xr) @ ccaddc)))) @ (^ [Xq:$i] : ccz))) @ (^ [Xr:$i] : ccz)))))).
