...
thf(ccnambpcma_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccaddc) @ XA2 @ ccmin) @ (cco @ XC @ XB2 @ ccmin))))))).
