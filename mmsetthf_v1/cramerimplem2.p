...
thf(amavmulsolcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap)) => ((cwceq @ XD @ (cco @ XB2 @ XN @ ccmap)) => ((cwceq @ Xc_x @ (cco @ XR @ (ccop @ XM @ XN) @ ccmvmul)) => ((cwceq @ XE @ (cco @ XB2 @ XM @ ccmap)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XM @ ccfn) @ (cwcel @ XN @ ccfn) @ (cwne @ XM @ cc0)) @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XY @ XE))) @ (cwi @ (cwceq @ (cco @ XA2 @ XX @ Xc_x) @ XY) @ (cwcel @ XX @ XD))))))))))))))))))))).
...
thf(ccramerimplem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XV @ (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((cwceq @ XE @ (ccfv @ XI @ (cco @ (ccfv @ XA2 @ ccur) @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((cwceq @ XH @ (ccfv @ XI @ (cco @ XX @ XY @ (cco @ XN @ XR @ ccmatrepV)))) => ((cwceq @ Xc_x @ (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((cwceq @ Xc_xp @ (cco @ XR @ (ccotp @ XN @ XN @ XN) @ ccmmul)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XI @ XN)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XV)) @ (cwceq @ (cco @ XX @ XZ @ Xc_x) @ XY)) @ (cwceq @ (cco @ XX @ XE @ Xc_xp) @ XH))))))))))))))))))))))).
