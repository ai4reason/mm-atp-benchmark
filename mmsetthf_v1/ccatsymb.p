...
thf(awrdsymb0_thm,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XI @ ccz)) @ (cwi @ (cwo @ (cwbr @ XI @ ccc0 @ cclt) @ (cwbr @ (ccfv @ XW @ cchash) @ XI @ ccle)) @ (cwceq @ (ccfv @ XI @ XW) @ cc0))))))).
...
thf(cccatsymb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwcel @ XI @ ccz)) @ (cwceq @ (ccfv @ XI @ (cco @ XA2 @ XB2 @ ccconcat)) @ (ccif @ (cwbr @ XI @ (ccfv @ XA2 @ cchash) @ cclt) @ (ccfv @ XI @ XA2) @ (ccfv @ (cco @ XI @ (ccfv @ XA2 @ cchash) @ ccmin) @ XB2))))))))).
