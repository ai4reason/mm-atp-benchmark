...
thf(acvrnbtwn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => (cwi @ (cw3a @ (cwcel @ XK @ XA2) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) @ (cwbr @ XX @ XY @ XC)) @ (cwn @ (cwa @ (cwbr @ XX @ XZ @ Xc_lt) @ (cwbr @ XZ @ XY @ Xc_lt)))))))))))))))).
...
thf(ccvrnbtwn3_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_lt @ (ccfv @ XK @ ccplt)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => (cwi @ (cw3a @ (cwcel @ XK @ ccpo) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) @ (cwbr @ XX @ XY @ XC)) @ (cwb @ (cwa @ (cwbr @ XX @ XZ @ Xc_le) @ (cwbr @ XZ @ XY @ Xc_lt)) @ (cwceq @ XX @ XZ)))))))))))))))).
