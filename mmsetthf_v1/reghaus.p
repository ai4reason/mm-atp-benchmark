...
thf(aregr1_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ ccreg) @ (cwcel @ (ccfv @ XJ @ cckq) @ ccha)))).
thf(aishaus3_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccha) @ (cwa @ (cwcel @ XJ @ cct0) @ (cwcel @ (ccfv @ XJ @ cckq) @ ccha))))).
thf(creghaus_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ ccreg) @ (cwb @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ cct0))))).
