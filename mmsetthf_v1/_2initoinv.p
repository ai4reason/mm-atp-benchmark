...
thf(ainitoid_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => (cwi @ (cwa @ Xph @ (cwcel @ XO @ (ccfv @ XC @ ccinito))) @ (cwceq @ (cco @ XO @ XO @ XH) @ (ccsn @ (ccfv @ XO @ (ccfv @ XC @ cccid)))))))))))))).
...
thf(c_2initoinv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XC @ ccinito))) => (cwi @ (cw3a @ Xph @ (cwcel @ XG @ (cco @ XB2 @ XA2 @ (ccfv @ XC @ cchom))) @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cchom)))) @ (cwbr @ XF @ XG @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ ccinv)))))))))))))).
