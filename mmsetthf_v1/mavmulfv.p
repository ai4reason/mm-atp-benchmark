...
thf(cmavmulfv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xj:$i] : (cwceq @ (XA2 @ Xj) @ (cco @ XN @ XR @ ccmat))) => ((! [Xj:$i] : (cwceq @ (Xc_xp @ Xj) @ (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul))) => ((! [Xj:$i] : (cwceq @ (XB2 @ Xj) @ (ccfv @ XR @ ccbs))) => ((! [Xj:$i] : (cwceq @ (Xc_x @ Xj) @ (ccfv @ XR @ ccmulr))) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ XR @ (XV @ Xj)))) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ XX @ (ccfv @ (XA2 @ Xj) @ ccbs)))) => ((! [Xj:$i] : (cwi @ Xph @ (cwcel @ XY @ (cco @ (XB2 @ Xj) @ XN @ ccmap)))) => ((cwi @ Xph @ (cwcel @ XI @ XN)) => (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XI @ (cco @ XX @ XY @ (Xc_xp @ Xj))) @ (cco @ XR @ (ccmpt @ (^ [Xj:$i] : XN) @ (^ [Xj:$i] : (cco @ (cco @ XI @ (ccv @ Xj) @ XX) @ (ccfv @ (ccv @ Xj) @ XY) @ (Xc_x @ Xj)))) @ ccgsu))))))))))))))))))))))))).
