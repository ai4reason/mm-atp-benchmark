...
thf(ahvmul0or_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccsm) @ cc0v) @ (cwo @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ cc0v))))))).
...
thf(cnmlnop0iALT_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (cwb @ (cwceq @ (ccfv @ XT @ ccnop) @ ccc0) @ (cwceq @ XT @ cch0o))))).
