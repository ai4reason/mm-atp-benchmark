...
thf(cfrcond3_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XG @ ccfrgr) @ (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV) @ (cwne @ XA2 @ XC)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ (cco @ XG @ XA2 @ ccnbgr) @ (cco @ XG @ XC @ ccnbgr)) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XV)))))))))))).
