...
thf(anfdisj_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) => (cwnf @ (^ [Xy1:$i] : (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))))))))).
...
thf(cdisjxiun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (cwi @ (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (XB2 @ Xy1))) @ (cwb @ (cwdisj @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cwa @ (cwral @ (^ [Xy1:$i] : (cwdisj @ (^ [Xx3:$i] : (XB2 @ Xy1)) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (^ [Xy1:$i] : XA2)) @ (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (cciun @ (^ [Xx3:$i] : (XB2 @ Xy1)) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
