...
thf(adf_polarityN_ax,axiom,(cwceq @ ccpolN @ (ccmpt @ (^ [Xl:$i] : ccvv) @ (^ [Xl:$i] : (ccmpt @ (^ [Xm:$i] : (ccpw @ (ccfv @ (ccv @ Xl) @ ccatm))) @ (^ [Xm:$i] : (ccin @ (ccfv @ (ccv @ Xl) @ ccatm) @ (cciin @ (^ [Xp:$i] : (ccv @ Xm)) @ (^ [Xp:$i] : (ccfv @ (ccfv @ (ccv @ Xp) @ (ccfv @ (ccv @ Xl) @ ccoc)) @ (ccfv @ (ccv @ Xl) @ ccpmap))))))))))).
