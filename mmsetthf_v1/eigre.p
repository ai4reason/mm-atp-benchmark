...
thf(ceigre_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwceq @ (ccfv @ XA2 @ XT) @ (cco @ XB2 @ XA2 @ ccsm)) @ (cwne @ XA2 @ cc0v))) @ (cwb @ (cwceq @ (cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) @ (cco @ (ccfv @ XA2 @ XT) @ XA2 @ ccsp)) @ (cwcel @ XB2 @ ccr))))))).
