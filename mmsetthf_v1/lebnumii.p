...
thf(clebnumii_conj,conjecture,(! [XU:($i > $o)] : (cwi @ (cwa @ (cwss @ XU @ ccii) @ (cwceq @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccuni @ XU))) @ (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (cco @ (cco @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xn) @ ccdiv) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ ccdiv) @ ccicc) @ (ccv @ Xu))) @ (^ [Xu:$i] : XU))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)))) @ (^ [Xn:$i] : ccn))))).
