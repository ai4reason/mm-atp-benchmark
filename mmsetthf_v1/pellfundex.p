...
thf(apellfundglb_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ XD @ ccpellfund) @ XA2 @ cclt)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ XD @ ccpellfund) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccv @ Xx3) @ XA2 @ cclt))) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell1qr))))))).
...
thf(apell14qrdivcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwcel @ XB2 @ (ccfv @ XD @ ccpell14qr))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ (ccfv @ XD @ ccpell14qr))))))).
...
thf(apell14qrgapw_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwbr @ cc2 @ XA2 @ cclt))))).
...
thf(cpellfundex_conj,conjecture,(! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ (ccfv @ XD @ ccpellfund) @ (ccfv @ XD @ ccpell1qr))))).
