...
thf(adf_gex_ax,axiom,(cwceq @ ccgex @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccsb @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xg1) @ ccmg)) @ (ccfv @ (ccv @ Xg1) @ cc0g))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)))) @ (^ [Xn:$i] : ccn)) @ (^ [Xi:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ cc0) @ ccc0 @ (ccinf @ (ccv @ Xi) @ ccr @ cclt)))))))).
