...
thf(ccju_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwreu @ (^ [Xx3:$i] : (cwa @ (cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccaddc) @ ccr) @ (cwcel @ (cco @ cci @ (cco @ XA2 @ (ccv @ Xx3) @ ccmin) @ ccmul) @ ccr))) @ (^ [Xx3:$i] : ccc))))).
