...
thf(cinficc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwss @ XS @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwne @ XS @ cc0)) => (cwi @ Xph @ (cwcel @ (ccinf @ XS @ ccxr @ cclt) @ (cco @ XA2 @ XB2 @ ccicc)))))))))))).
