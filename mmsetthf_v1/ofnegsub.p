...
thf(cofnegsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG)) @ (cwceq @ (cco @ XF @ (cco @ (ccxp @ XA2 @ (ccsn @ (ccneg @ cc1))) @ XG @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ (cco @ XF @ XG @ (ccof @ ccmin))))))))).
