...
thf(apsseq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwb @ (cwpss @ XC @ XA2) @ (cwpss @ XC @ XB2))))))).
...
thf(cinfeq5i_conj,conjecture,(cwi @ (cwcel @ ccom @ ccvv) @ (cwex @ (^ [Xx3:$i] : (cwpss @ (ccv @ Xx3) @ (ccuni @ (ccv @ Xx3))))))).
