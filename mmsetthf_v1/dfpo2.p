...
thf(cdfpo2_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwb @ (cwpo @ XA2 @ XR) @ (cwa @ (cwceq @ (ccin @ XR @ (ccres @ ccid @ XA2)) @ cc0) @ (cwss @ (cccom @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ (ccin @ XR @ (ccxp @ XA2 @ XA2))) @ XR)))))).
