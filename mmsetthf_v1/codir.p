...
thf(abrcodir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwbr @ XA2 @ XB2 @ (cccom @ (cccnv @ XR) @ XR)) @ (cwex @ (^ [Xz:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xz) @ XR) @ (cwbr @ XB2 @ (ccv @ Xz) @ XR)))))))))))).
...
thf(ccodir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwb @ (cwss @ (ccxp @ XA2 @ XB2) @ (cccom @ (cccnv @ XR) @ XR)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR))))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))).
