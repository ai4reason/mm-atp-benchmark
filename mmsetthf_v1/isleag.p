...
thf(adf_leag_ax,axiom,(cwceq @ ccleag @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccmap)) @ (cwcel @ (ccv @ Xb) @ (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccmap))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccs3 @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (ccfv @ cc1 @ (ccv @ Xb)) @ (ccfv @ cc2 @ (ccv @ Xb))) @ (ccfv @ (ccv @ Xg1) @ ccinag)) @ (cwbr @ (ccs3 @ (ccfv @ ccc0 @ (ccv @ Xa)) @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ (ccv @ Xa))) @ (ccs3 @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (ccfv @ cc1 @ (ccv @ Xb)) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xg1) @ cccgra)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))))))))))).
...
thf(awrdmap_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ XX) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwceq @ (ccfv @ XW @ cchash) @ XN)) @ (cwcel @ XW @ (cco @ XV @ (cco @ ccc0 @ XN @ ccfzo) @ ccmap))))))))).
thf(cisleag_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwcel @ XE @ XP)) => ((cwi @ Xph @ (cwcel @ XF @ XP)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XD @ XE @ XF) @ (ccfv @ XG @ ccleag)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccs3 @ XD @ XE @ XF) @ (ccfv @ XG @ ccinag)) @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XD @ XE @ (ccv @ Xx3)) @ (ccfv @ XG @ cccgra)))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))).
