...
thf(ac1lip2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ cc1 @ (ccfv @ ccr @ cccpn)))) => ((cwi @ Xph @ (cwss @ (ccrn @ XF) @ ccr)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdm @ XF))) => (cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xk:$i] : ccr))))))))))))).
...
thf(cc1lip3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ ccr) @ (ccfv @ cc1 @ (ccfv @ ccr @ cccpn)))) => ((cwi @ Xph @ (cwss @ (ccima @ XF @ ccr) @ ccr)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdm @ XF))) => (cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xk:$i] : ccr))))))))))))).
