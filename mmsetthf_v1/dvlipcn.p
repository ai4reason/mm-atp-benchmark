...
thf(advlip_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccioo))) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccabs) @ XM @ ccle))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (XX @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (XY @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc)))) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (XX @ Xx3) @ XF) @ (ccfv @ (XY @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ XM @ (ccfv @ (cco @ (XX @ Xx3) @ (XY @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle))))))))))))))))).
...
thf(ablcvx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XS @ (cco @ XP @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => (cwi @ (cwa @ (cwa @ (cwcel @ XP @ ccc) @ (cwcel @ XR @ ccxr)) @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwcel @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc) @ XS)))))))))).
...
thf(cdvlipcn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XX @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwf @ (XX @ Xx3) @ ccc @ XF))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (cwceq @ XB2 @ (cco @ (XA2 @ Xx3) @ (XR @ Xx3) @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => ((cwi @ Xph @ (cwss @ XB2 @ (ccdm @ (cco @ ccc @ XF @ ccdv)))) => ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccc @ XF @ ccdv)) @ ccabs) @ XM @ ccle))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (XY @ Xx3) @ XB2) @ (cwcel @ (XZ @ Xx3) @ XB2))) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (XY @ Xx3) @ XF) @ (ccfv @ (XZ @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ XM @ (ccfv @ (cco @ (XY @ Xx3) @ (XZ @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle))))))))))))))))))))).
