...
thf(adf_vtx_ax,axiom,(cwceq @ ccvtx @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccif @ (cwcel @ (ccv @ Xg1) @ (ccxp @ ccvv @ ccvv)) @ (ccfv @ (ccv @ Xg1) @ cc1st) @ (ccfv @ (ccv @ Xg1) @ ccbs)))))).
...
thf(aprcnel_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwn @ (cwcel @ XA2 @ XV)))))).
thf(cvtxval_conj,conjecture,(! [XG:($i > $o)] : (cwceq @ (ccfv @ XG @ ccvtx) @ (ccif @ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)) @ (ccfv @ XG @ cc1st) @ (ccfv @ XG @ ccbs))))).
