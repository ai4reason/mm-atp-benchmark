...
thf(alimsupval2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ XA2 @ ccr))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ XF @ cclsp) @ (ccinf @ (ccima @ (XG @ Xk) @ XA2) @ ccxr @ cclt)))))))))))))).
...
thf(alimsupgre_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwf @ XZ @ ccr @ XF) @ (cwbr @ (ccfv @ XF @ cclsp) @ ccpnf @ cclt)) @ (cwf @ ccr @ ccr @ (XG @ Xk))))))))))).
...
thf(alimsupgf_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwf @ ccr @ ccxr @ (XG @ Xk))))))).
...
thf(alimsupgle_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XG @ Xj @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt)))))) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cw3a @ (cwa @ (cwss @ (XB2 @ Xk) @ ccr) @ (cwf @ (XB2 @ Xk) @ ccxr @ XF)) @ (cwcel @ XC @ ccr) @ (cwcel @ (XA2 @ Xk) @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ XC @ (XG @ Xj @ Xk)) @ (XA2 @ Xk) @ ccle) @ (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ XC @ (ccv @ Xj) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xj) @ XF) @ (XA2 @ Xk) @ ccle))) @ (^ [Xj:$i] : (XB2 @ Xk)))))))))))))).
...
thf(ambfinf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xn) @ ccuz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xx3 @ Xn)))) @ ccr @ cclt))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xy1 @ Xn) @ ccz))))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xn))) @ ccmbf))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xn) @ XZ) @ (cwcel @ (ccv @ Xx3) @ XA2))) @ (cwcel @ (XB2 @ Xx3 @ Xn) @ ccr)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xn) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xn) @ ccmbf)))))))))))))))))).
...
thf(ambfsup_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xn) @ ccuz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xx3 @ Xn)))) @ ccr @ cclt))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xy1 @ Xn) @ ccz))))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xn))) @ ccmbf))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xn) @ XZ) @ (cwcel @ (ccv @ Xx3) @ XA2))) @ (cwcel @ (XB2 @ Xx3 @ Xn) @ ccr)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (XB2 @ Xx3 @ Xn) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xn) @ ccmbf)))))))))))))))))).
