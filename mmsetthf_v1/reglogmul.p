...
thf(creglogmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp) @ (cwa @ (cwcel @ XC @ ccrp) @ (cwne @ XC @ cc1))) @ (cwceq @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ ccaddc))))))).
