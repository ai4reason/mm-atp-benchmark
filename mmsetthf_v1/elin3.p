...
thf(celin3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccin @ (ccin @ XB2 @ XC) @ XD)) => (cwb @ (cwcel @ XA2 @ XX) @ (cw3a @ (cwcel @ XA2 @ XB2) @ (cwcel @ XA2 @ XC) @ (cwcel @ XA2 @ XD)))))))))).
