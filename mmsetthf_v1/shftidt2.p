...
thf(adfres2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwceq @ (ccres @ XR @ XA2) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))))))))).
thf(cshftidt2_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwceq @ (cco @ XF @ ccc0 @ ccshi) @ (ccres @ XF @ ccc))))).
