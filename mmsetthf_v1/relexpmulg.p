...
thf(arelexpmulnn_thm,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ XV) @ (cwceq @ XI @ (cco @ XJ @ XK @ ccmul))) @ (cwa @ (cwcel @ XJ @ ccn) @ (cwcel @ XK @ ccn))) @ (cwceq @ (cco @ (cco @ XR @ XJ @ ccrelexp) @ XK @ ccrelexp) @ (cco @ XR @ XI @ ccrelexp))))))))).
...
thf(crelexpmulg_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XR @ XV) @ (cwceq @ XI @ (cco @ XJ @ XK @ ccmul)) @ (cwi @ (cwceq @ XI @ ccc0) @ (cwbr @ XJ @ XK @ ccle))) @ (cwa @ (cwcel @ XJ @ ccn0) @ (cwcel @ XK @ ccn0))) @ (cwceq @ (cco @ (cco @ XR @ XJ @ ccrelexp) @ XK @ ccrelexp) @ (cco @ XR @ XI @ ccrelexp))))))))).
