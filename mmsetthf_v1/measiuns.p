...
thf(aiundisj2cnt_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (cwnfc @ (^ [Xn:$i] : (XB2 @ Xk @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xk)) @ (cwceq @ (XA2 @ Xn) @ (XB2 @ Xk @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwo @ (cwceq @ (XN @ Xk) @ ccn) @ (cwceq @ (XN @ Xk) @ (cco @ cc1 @ XM @ ccfzo)))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk @ Xn) @ (cwdisj @ (^ [Xn:$i] : (XN @ Xk)) @ (^ [Xn:$i] : (ccdif @ (XA2 @ Xn) @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfzo)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xn)))))))))))))))))).
thf(ccxad_tp,type,(ccxad : ($i > $o))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ameasvuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XS)) @ (^ [Xx3:$i] : XA2)) @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) @ (cwceq @ (ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XM) @ (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ XM)))))))))).
thf(cmeasiuns_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwnfc @ (^ [Xn:$i] : (XB2 @ Xk @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xn) @ (ccv @ Xk)) @ (cwceq @ (XA2 @ Xn) @ (XB2 @ Xk @ Xn))))) => ((cwi @ Xph @ (cwo @ (cwceq @ XN @ ccn) @ (cwceq @ XN @ (cco @ cc1 @ XI @ ccfzo)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ (ccfv @ XS @ ccmeas)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XN)) @ (cwcel @ (XA2 @ Xn) @ XS))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (XA2 @ Xn))) @ (XM @ Xk)) @ (ccesum @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (ccfv @ (ccdif @ (XA2 @ Xn) @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfzo)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xn)))) @ (XM @ Xk)))))))))))))))))))).
