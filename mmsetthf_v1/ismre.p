...
thf(cismre_conj,conjecture,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cw3a @ (cwss @ XC @ (ccpw @ XX)) @ (cwcel @ XX @ XC) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwne @ (ccv @ Xs1) @ cc0) @ (cwcel @ (ccint @ (ccv @ Xs1)) @ XC))) @ (^ [Xs1:$i] : (ccpw @ XC)))))))).
