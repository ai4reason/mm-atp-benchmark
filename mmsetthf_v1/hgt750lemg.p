...
thf(aprodtp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XA2) @ (cwceq @ (XD @ Xk) @ XE))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XB2) @ (cwceq @ (XD @ Xk) @ XF))) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XE @ ccc)) => ((cwi @ Xph @ (cwcel @ XF @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XC) @ (cwceq @ (XD @ Xk) @ XG))) => ((cwi @ Xph @ (cwcel @ XC @ XX)) => ((cwi @ Xph @ (cwcel @ XG @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ XC)) => ((cwi @ Xph @ (cwne @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cctp @ XA2 @ XB2 @ XC)) @ (^ [Xk:$i] : (XD @ Xk))) @ (cco @ (cco @ XE @ XF @ ccmul) @ XG @ ccmul))))))))))))))))))))))))))).
...
thf(chgt750lemg_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xc:$i] : (cwceq @ (XF @ Xc) @ (ccmpt @ (^ [Xc:$i] : XR) @ (^ [Xc:$i] : (cccom @ (ccv @ Xc) @ XT))))) => ((cwi @ Xph @ (cwf1o @ (cco @ ccc0 @ cc3 @ ccfzo) @ (cco @ ccc0 @ cc3 @ ccfzo) @ XT)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccn @ XN)) => ((! [Xc:$i] : (cwi @ Xph @ (cwf @ ccn @ ccr @ (XL @ Xc)))) => ((cwi @ Xph @ (cwcel @ XN @ XR)) => (! [Xc:$i] : (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (ccfv @ ccc0 @ (ccfv @ XN @ (XF @ Xc))) @ (XL @ Xc)) @ (cco @ (ccfv @ (ccfv @ cc1 @ (ccfv @ XN @ (XF @ Xc))) @ (XL @ Xc)) @ (ccfv @ (ccfv @ cc2 @ (ccfv @ XN @ (XF @ Xc))) @ (XL @ Xc)) @ ccmul) @ ccmul) @ (cco @ (ccfv @ (ccfv @ ccc0 @ XN) @ (XL @ Xc)) @ (cco @ (ccfv @ (ccfv @ cc1 @ XN) @ (XL @ Xc)) @ (ccfv @ (ccfv @ cc2 @ XN) @ (XL @ Xc)) @ ccmul) @ ccmul)))))))))))))))).
