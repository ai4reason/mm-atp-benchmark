...
thf(alimsupgtlem_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ cclsp) @ ccr)) => ((cwi @ Xph @ (cwcel @ XX @ ccrp)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ XX @ ccmin) @ (ccfv @ XF @ cclsp) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))).
...
thf(climsupgt_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwf @ (XZ @ Xk) @ ccr @ (XF @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ (ccfv @ (XF @ Xk) @ cclsp) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ XX @ ccrp)))) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ XX @ ccmin) @ (ccfv @ (XF @ Xk) @ cclsp) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xk)))))))))))))))))).
