...
thf(cfthoppc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => ((cwceq @ XP @ (ccfv @ XD @ ccoppc)) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth))) => (cwi @ Xph @ (cwbr @ XF @ (cctpos @ XG) @ (cco @ XO @ XP @ ccfth)))))))))))))).
