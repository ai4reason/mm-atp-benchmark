...
thf(adf_xps_ax,axiom,(cwceq @ ccxps @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xs1:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (cco @ (cccnv @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xr) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xs1) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccnv @ (cco @ (ccsn @ (ccv @ Xx3)) @ (ccsn @ (ccv @ Xy1)) @ cccda)))))) @ (cco @ (ccfv @ (ccv @ Xr) @ ccsca) @ (cccnv @ (cco @ (ccsn @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xs1)) @ cccda)) @ ccprds) @ ccimas)))))).
