...
thf(ccantnfp1lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ XG @ XS)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XA2)) => ((cwi @ Xph @ (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : (cwceq @ (XF @ Xt) @ (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ (cwceq @ (ccv @ Xt) @ XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => (! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xt) @ XS)))))))))))))))))))).
