...
thf(certh2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwer @ XX @ XR)) => ((cwi @ Xph @ (cwcel @ XB2 @ XX)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ XR) @ (cwceq @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)))))))))))).
