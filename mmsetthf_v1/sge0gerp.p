...
thf(asupxrge_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ XB2 @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccxad) @ ccle)) @ (^ [Xy1:$i] : XA2)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))))))).
...
thf(asge0sup_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0)))) @ ccxr @ cclt)))))))))).
thf(csge0gerp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3 @ Xz))))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwrex @ (^ [Xz:$i] : (cwbr @ XA2 @ (cco @ (ccfv @ (ccres @ XF @ (ccv @ Xz)) @ ccsumge0) @ (ccv @ Xx3) @ ccxad) @ ccle)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XX) @ ccfn))))) => (cwi @ Xph @ (cwbr @ XA2 @ (ccfv @ XF @ ccsumge0) @ ccle)))))))))))).
