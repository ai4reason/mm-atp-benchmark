...
thf(adf_lgam_ax,axiom,(cwceq @ cclgam @ (ccmpt @ (^ [Xz:$i] : (ccdif @ ccc @ (ccdif @ ccz @ ccn))) @ (^ [Xz:$i] : (cco @ (ccsu @ ccn @ (^ [Xm:$i] : (cco @ (cco @ (ccv @ Xz) @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccdiv) @ cclog) @ ccmul) @ (ccfv @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xm) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin))) @ (ccfv @ (ccv @ Xz) @ cclog) @ ccmin))))).
...
thf(admgmdivn0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => (cwi @ Xph @ (cwne @ (cco @ (cco @ XA2 @ XM @ ccdiv) @ cc1 @ ccaddc) @ ccc0)))))))).
...
thf(ciprodgam_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ ccgam) @ (cco @ (ccprod @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ XA2 @ cccxp) @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ ccdiv))) @ XA2 @ ccdiv))))))).
