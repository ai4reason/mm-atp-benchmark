...
thf(cfvovco_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwf @ XX @ (ccxp @ XV @ XW) @ XF)) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => (cwi @ Xph @ (cwceq @ (ccfv @ XY @ (cccom @ XO @ XF)) @ (cco @ (ccfv @ (ccfv @ XY @ XF) @ cc1st) @ (ccfv @ (ccfv @ XY @ XF) @ cc2nd) @ XO))))))))))))).
