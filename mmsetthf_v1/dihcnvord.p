...
thf(cdihcnvord_conj,conjecture,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ (ccrn @ XI))) => ((cwi @ Xph @ (cwcel @ XY @ (ccrn @ XI))) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ XX @ (cccnv @ XI)) @ (ccfv @ XY @ (cccnv @ XI)) @ Xc_le) @ (cwss @ XX @ XY)))))))))))))))))).
