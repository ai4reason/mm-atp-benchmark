...
thf(axrmulc1cn_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ ccle @ ccordt))) => ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccxmu)))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))))).
...
thf(aletopuni_thm,axiom,(cwceq @ ccxr @ (ccuni @ (ccfv @ ccle @ ccordt)))).
...
thf(age0xmulcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwcel @ (cco @ XA2 @ XB2 @ ccxmu) @ (cco @ ccc0 @ ccpnf @ ccicc)))))).
...
thf(aelicoelioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwb @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) @ (cwo @ (cwceq @ XC @ XA2) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))))))))).
thf(cxrge0mulc1cn_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpnf @ ccicc)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccxmu))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccico)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XF @ Xx3) @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))))).
