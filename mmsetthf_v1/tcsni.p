...
thf(atc2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwceq @ (ccun @ (ccfv @ XA2 @ cctc) @ (ccsn @ XA2)) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwcel @ XA2 @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xx3)))))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((cwi @ Xph @ Xps) => Xps))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asnex_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccsn @ XA2) @ ccvv))).
thf(atcvalg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwceq @ (ccfv @ XA2 @ cctc) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwss @ XA2 @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xx3)))))))))))).
thf(ctcsni_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwceq @ (ccfv @ (ccsn @ XA2) @ cctc) @ (ccun @ (ccfv @ XA2 @ cctc) @ (ccsn @ XA2)))))).
