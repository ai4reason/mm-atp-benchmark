...
thf(cqliftfuns_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (ccec @ (ccv @ Xx3) @ XR) @ (XA2 @ Xx3))))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XX)) @ (cwcel @ (XA2 @ Xx3) @ XY))) => ((cwi @ Xph @ (cwer @ XX @ XR)) => ((cwi @ Xph @ (cwcel @ XX @ ccvv)) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwfun @ (XF @ Xx3)) @ (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR) @ (cwceq @ (ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsb @ (ccv @ Xz) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))))))))))))))).
