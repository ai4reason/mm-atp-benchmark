...
thf(arecgt1i_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwa @ (cwbr @ ccc0 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt) @ (cwbr @ (cco @ cc1 @ XA2 @ ccdiv) @ cc1 @ cclt))))).
...
thf(areclt1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ cc1 @ cclt) @ (cwbr @ cc1 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt))))))).
thf(altadd2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ XC @ XA2 @ ccaddc) @ (cco @ XC @ XB2 @ ccaddc) @ cclt))))))))))).
thf(cxov1plusxeqvd_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwne @ XX @ (ccneg @ cc1))) => (cwi @ Xph @ (cwb @ (cwcel @ XX @ ccrp) @ (cwcel @ (cco @ XX @ (cco @ cc1 @ XX @ ccaddc) @ ccdiv) @ (cco @ ccc0 @ cc1 @ ccioo))))))))).
