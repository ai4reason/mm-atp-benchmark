...
thf(anndivtr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccc)) @ (cwa @ (cwcel @ (cco @ XB2 @ XA2 @ ccdiv) @ ccn) @ (cwcel @ (cco @ XC @ XB2 @ ccdiv) @ ccn))) @ (cwcel @ (cco @ XC @ XA2 @ ccdiv) @ ccn)))))).
thf(cpermnn_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XR @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ (cco @ (ccfv @ XN @ ccfa) @ (ccfv @ XR @ ccfa) @ ccdiv) @ ccn))))).
