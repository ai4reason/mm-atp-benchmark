...
thf(akgencn3_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccrn @ cckgen)) @ (cwcel @ XK @ cctop)) @ (cwceq @ (cco @ XJ @ XK @ cccn) @ (cco @ XJ @ (ccfv @ XK @ cckgen) @ cccn)))))).
...
thf(cqtopkgen_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ (ccrn @ cckgen)) @ (cwfn @ XF @ XX)) @ (cwcel @ (cco @ XJ @ XF @ ccqtop) @ (ccrn @ cckgen)))))))).
