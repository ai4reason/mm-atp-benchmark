...
thf(csmfmullem4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XS @ Xx3 @ Xv @ Xu) @ ccsalg))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xq:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xv @ Xu @ Xq))))))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XC)) @ (cwcel @ (XD @ Xx3) @ ccr))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ (XS @ Xx3 @ Xv @ Xu) @ ccsmblfn)))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3))) @ (ccfv @ (XS @ Xx3 @ Xv @ Xu) @ ccsmblfn)))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XR @ Xx3) @ ccr))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XK @ Xv @ Xu) @ (ccrab @ (^ [Xq:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwbr @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ ccmul) @ (XR @ Xx3) @ cclt)) @ (^ [Xv:$i] : (cco @ (ccfv @ cc2 @ (ccv @ Xq)) @ (ccfv @ cc3 @ (ccv @ Xq)) @ ccioo)))) @ (^ [Xu:$i] : (cco @ (ccfv @ ccc0 @ (ccv @ Xq)) @ (ccfv @ cc1 @ (ccv @ Xq)) @ ccioo)))) @ (^ [Xq:$i] : (cco @ ccq @ (cco @ ccc0 @ cc3 @ ccfz) @ ccmap))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XE @ Xx3 @ Xv @ Xu @ Xq) @ (ccmpt @ (^ [Xq:$i] : (XK @ Xv @ Xu)) @ (^ [Xq:$i] : (ccrab @ (^ [Xx3:$i] : (cwa @ (cwcel @ (XB2 @ Xx3) @ (cco @ (ccfv @ ccc0 @ (ccv @ Xq)) @ (ccfv @ cc1 @ (ccv @ Xq)) @ ccioo)) @ (cwcel @ (XD @ Xx3) @ (cco @ (ccfv @ cc2 @ (ccv @ Xq)) @ (ccfv @ cc3 @ (ccv @ Xq)) @ ccioo)))) @ (^ [Xx3:$i] : (ccin @ XA2 @ XC)))))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ (XB2 @ Xx3) @ (XD @ Xx3) @ ccmul) @ (XR @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (ccin @ XA2 @ XC))) @ (cco @ (XS @ Xx3 @ Xv @ Xu) @ (ccin @ XA2 @ XC) @ ccrest))))))))))))))))))))))))))).
