...
thf(crdglem1_conj,conjecture,(! [XG:($i > $o)] : (cwceq @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)) @ XG))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0)))) @ (ccab @ (^ [Xg1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwfn @ (ccv @ Xg1) @ (ccv @ Xz)) @ (cwral @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xg1)) @ (ccfv @ (ccres @ (ccv @ Xg1) @ (ccv @ Xw)) @ XG))) @ (^ [Xw:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : ccon0))))))).
