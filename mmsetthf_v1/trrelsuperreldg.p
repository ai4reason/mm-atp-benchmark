...
thf(ctrrelsuperreldg_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwrel @ XR)) => ((cwi @ Xph @ (cwceq @ XS @ (ccxp @ (ccdm @ XR) @ (ccrn @ XR)))) => (cwi @ Xph @ (cwa @ (cwss @ XR @ XS) @ (cwss @ (cccom @ XS @ XS) @ XS))))))))).
