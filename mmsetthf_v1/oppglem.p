...
thf(aoppgval_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppg)) => (cwceq @ XO @ (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (cctpos @ Xc_pl)) @ ccsts)))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(coppglem_conj,conjecture,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccoppg)) => ((cwceq @ XE @ (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwne @ XN @ cc2) => (cwceq @ (ccfv @ XR @ XE) @ (ccfv @ XO @ XE))))))))))).
