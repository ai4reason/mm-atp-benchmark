...
thf(ccnextfres1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XC @ (ccuni @ XJ)) => ((cwceq @ XB2 @ (ccuni @ XK)) => ((cwi @ Xph @ (cwcel @ XJ @ cctop)) => ((cwi @ Xph @ (cwcel @ XK @ ccha)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XC)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ XC)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XC)) @ (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => ((cwi @ Xph @ (cwcel @ XK @ ccreg)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccn))) => (cwi @ Xph @ (cwceq @ (ccres @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)) @ XA2) @ XF)))))))))))))))))))).
