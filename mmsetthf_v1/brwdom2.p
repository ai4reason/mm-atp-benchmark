...
thf(a_0wdom_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwbr @ cc0 @ XX @ ccwdom))))).
...
thf(cbrwdom2_conj,conjecture,(! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XY @ (XV @ Xy1 @ Xz)) @ (cwb @ (cwbr @ XX @ XY @ ccwdom) @ (cwrex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwfo @ (ccv @ Xy1) @ XX @ (ccv @ Xz))))) @ (^ [Xy1:$i] : (ccpw @ XY))))))))))).
