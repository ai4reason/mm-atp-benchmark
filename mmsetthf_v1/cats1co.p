...
thf(ccats1co_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XT @ (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwi @ Xph @ (cwcel @ XS @ (ccword @ XA2))) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwceq @ (cccom @ XF @ XS) @ XU)) => ((cwceq @ XV @ (cco @ XU @ (ccs1 @ (ccfv @ XX @ XF)) @ ccconcat)) => (cwi @ Xph @ (cwceq @ (cccom @ XF @ XT) @ XV)))))))))))))))))).
