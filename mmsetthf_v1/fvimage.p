...
thf(aimageval_thm,axiom,(! [XR:($i > $o)] : (cwceq @ (ccimage @ XR) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccima @ XR @ (ccv @ Xx3))))))).
thf(cfvimage_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccima @ XR @ XA2) @ XW)) @ (cwceq @ (ccfv @ XA2 @ (ccimage @ XR)) @ (ccima @ XR @ XA2)))))))).
