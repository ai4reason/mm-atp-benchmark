...
thf(adifeq12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwceq @ XA2 @ XB2) @ (cwceq @ XC @ XD)) @ (cwceq @ (ccdif @ XA2 @ XC) @ (ccdif @ XB2 @ XD)))))))).
thf(cresdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfun @ (cccnv @ XF)) @ (cwfo @ XA2 @ XC @ (ccres @ XF @ XA2)) @ (cwfo @ XB2 @ XD @ (ccres @ XF @ XB2))) @ (cwf1o @ (ccdif @ XA2 @ XB2) @ (ccdif @ XC @ XD) @ (ccres @ XF @ (ccdif @ XA2 @ XB2)))))))))).
