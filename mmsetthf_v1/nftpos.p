...
thf(adftpos4_thm,axiom,(! [XF:($i > $o)] : (cwceq @ (cctpos @ XF) @ (cccom @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccxp @ ccvv @ ccvv) @ (ccsn @ cc0))) @ (^ [Xx3:$i] : (ccuni @ (cccnv @ (ccsn @ (ccv @ Xx3)))))))))).
...
thf(cnftpos_conj,conjecture,(! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (cctpos @ (XF @ Xx3))))))).
