...
thf(csylow1lem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XG @ ccgrp))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XX @ ccfn))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XP @ ccprime))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ XN @ ccn0))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwbr @ (cco @ XP @ XN @ ccexp) @ (ccfv @ XX @ cchash) @ ccdvds))) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((! [Xs1:$i] : (cwceq @ (XS @ Xs1) @ (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccfv @ (ccv @ Xs1) @ cchash) @ (cco @ XP @ XN @ ccexp))) @ (^ [Xs1:$i] : (ccpw @ XX))))) => ((! [Xs1:$i] : (cwceq @ (Xc_po @ Xs1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XS @ Xs1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl))))))))) => (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (Xc_po @ Xs1) @ (cco @ XG @ (XS @ Xs1) @ ccga)))))))))))))))))))))).
