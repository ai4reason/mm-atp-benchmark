...
thf(adf_lmhm_ax,axiom,(cwceq @ cclmhm @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : cclmod)) @ (^ [Xs1:$i] : (^ [Xt:$i] : cclmod)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xt) @ ccsca) @ (ccv @ Xw)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xs1) @ ccvsca)) @ (ccv @ Xf1)) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ ccvsca)))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xs1) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ ccbs))))) @ (ccfv @ (ccv @ Xs1) @ ccsca))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ ccghm)))))))).
