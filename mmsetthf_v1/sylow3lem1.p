...
thf(afislw_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XP @ ccprime)) @ (cwb @ (cwcel @ XH @ (cco @ XP @ XG @ ccslw)) @ (cwa @ (cwcel @ XH @ (ccfv @ XG @ ccsubg)) @ (cwceq @ (ccfv @ XH @ cchash) @ (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp))))))))))).
...
thf(csylow3lem1_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XG @ ccgrp)) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ Xc_po @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ XP @ XG @ ccslw))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl) @ (ccv @ Xx3) @ Xc_mi)))))))) => (cwi @ Xph @ (cwcel @ Xc_po @ (cco @ XG @ (cco @ XP @ XG @ ccslw) @ ccga)))))))))))))))))).
