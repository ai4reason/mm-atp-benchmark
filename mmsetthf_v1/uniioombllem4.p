...
thf(auniiccdif_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => (cwi @ Xph @ (cwa @ (cwss @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))) @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF)))) @ (cwceq @ (ccfv @ (ccdif @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF))) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) @ ccovol) @ ccc0))))))).
...
thf(auniioombllem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((cwceq @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XE @ Xx3) @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XE @ Xx3) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG)))))) => ((cwceq @ XT @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3) @ ccovol) @ XC @ ccaddc) @ ccle))) => (cwi @ Xph @ (cwcel @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccr))))))))))))))))))))).
...
thf(aovollecl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ (ccfv @ XA2 @ ccovol) @ XB2 @ ccle)) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr))))).
...
thf(auzsplit_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (ccfv @ XM @ ccuz) @ (ccun @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (ccfv @ XN @ ccuz))))))).
...
thf(aovolfiniun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xk:$i] : (cwa @ (cwss @ (XB2 @ Xk) @ ccr) @ (cwcel @ (ccfv @ (XB2 @ Xk) @ ccovol) @ ccr))) @ (^ [Xk:$i] : XA2))) @ (cwbr @ (ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccovol) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccovol))) @ ccle))))).
...
thf(afiniunmbl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ (ccdm @ ccvol))) @ (^ [Xk:$i] : XA2))) @ (cwcel @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccdm @ ccvol)))))).
...
thf(aovolioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccovol) @ (cco @ XB2 @ XA2 @ ccmin)))))).
...
thf(amblsplit_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwss @ XB2 @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr)) @ (cwceq @ (ccfv @ XB2 @ ccovol) @ (cco @ (ccfv @ (ccin @ XB2 @ XA2) @ ccovol) @ (ccfv @ (ccdif @ XB2 @ XA2) @ ccovol) @ ccaddc)))))).
...
thf(aindifdir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccin @ (ccdif @ XA2 @ XB2) @ XC) @ (ccdif @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XC))))))).
...
thf(auzdisj_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwceq @ (ccin @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (ccfv @ XN @ ccuz)) @ cc0)))).
thf(cwrmo_tp,type,(cwrmo : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(adisjiun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cw3a @ (cwss @ XC @ XA2) @ (cwss @ XD @ XA2) @ (cwceq @ (ccin @ XC @ XD) @ cc0))) @ (cwceq @ (ccin @ (cciun @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciun @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ cc0))))))).
...
thf(aabsdifltd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ cclt) @ (cwa @ (cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ cclt) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))))))).
...
thf(avolfiniun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xk:$i] : (cwa @ (cwcel @ (XB2 @ Xk) @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ (XB2 @ Xk) @ ccvol) @ ccr))) @ (^ [Xk:$i] : XA2)) @ (cwdisj @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))) @ (cwceq @ (ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccvol) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccvol)))))))).
...
thf(aleadd2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XC @ XA2 @ ccaddc) @ (cco @ XC @ XB2 @ ccaddc) @ ccle))))))))))).
...
thf(cuniioombllem4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XS @ Xx3 @ Xi @ Xj) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))))) => ((! [Xi:$i] : (cwceq @ (XA2 @ Xi) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XE @ Xx3 @ Xi @ Xj) @ ccovol) @ ccr))))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwss @ (XE @ Xx3 @ Xi @ Xj) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG)))))))) => ((cwceq @ XT @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3 @ Xi @ Xj) @ ccovol) @ XC @ ccaddc) @ ccle))))) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (ccfv @ XM @ XT) @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccmin) @ ccabs) @ XC @ cclt)) => ((! [Xi:$i] : (cwceq @ (XK @ Xi) @ (ccuni @ (ccima @ (cccom @ ccioo @ XG) @ (cco @ cc1 @ XM @ ccfz))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3) @ ccn))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwi @ Xph @ (cwral @ (^ [Xj:$i] : (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccin @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ ccioo) @ (ccfv @ (ccfv @ (ccv @ Xj) @ XG) @ ccioo)) @ ccovol))) @ (ccfv @ (ccin @ (ccfv @ (ccfv @ (ccv @ Xj) @ XG) @ ccioo) @ (XA2 @ Xi)) @ ccovol) @ ccmin) @ ccabs) @ (cco @ XC @ XM @ ccdiv) @ cclt)) @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XL @ Xx3 @ Xi @ Xj) @ (ccuni @ (ccima @ (cccom @ ccioo @ XF) @ (cco @ cc1 @ (XN @ Xx3) @ ccfz))))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (ccin @ (XK @ Xi) @ (XA2 @ Xi)) @ ccovol) @ (cco @ (ccfv @ (ccin @ (XK @ Xi) @ (XL @ Xx3 @ Xi @ Xj)) @ ccovol) @ XC @ ccaddc) @ ccle)))))))))))))))))))))))))))))))))).
