...
thf(cnumclwlk3lem3_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccc) @ (cwcel @ XY @ ccc) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) @ (cwceq @ (cco @ (cco @ (cco @ XK @ (cco @ XN @ cc2 @ ccmin) @ ccexp) @ XY @ ccmin) @ (cco @ XK @ XY @ ccmul) @ ccaddc) @ (cco @ (cco @ (cco @ XK @ cc1 @ ccmin) @ XY @ ccmul) @ (cco @ XK @ (cco @ XN @ cc2 @ ccmin) @ ccexp) @ ccaddc))))))).
