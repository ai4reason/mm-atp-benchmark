...
thf(aussval_thm,axiom,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XU @ (ccfv @ XW @ ccunif)) => (cwceq @ (cco @ XU @ (ccxp @ XB2 @ XB2) @ ccrest) @ (ccfv @ XW @ ccuss)))))))).
...
thf(aressunif_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwceq @ XU @ (ccfv @ XG @ ccunif)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ XU @ (ccfv @ XH @ ccunif))))))))))).
thf(cressuss_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ (ccfv @ (cco @ XW @ XA2 @ ccress) @ ccuss) @ (cco @ (ccfv @ XW @ ccuss) @ (ccxp @ XA2 @ XA2) @ ccrest))))))).
