...
thf(aequsb2_thm,axiom,(! [Xy1:$i] : (cwsb @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3))) @ Xy1))).
...
thf(cbj_sbidmOLD_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xy1:$i] : (cwb @ (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1)) @ Xy1) @ (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1))))).
