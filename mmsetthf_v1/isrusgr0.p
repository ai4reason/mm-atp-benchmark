...
thf(aisrusgr_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwcel @ XK @ XZ)) @ (cwb @ (cwbr @ XG @ XK @ ccrusgr) @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwbr @ XG @ XK @ ccrgr))))))))).
...
thf(cisrusgr0_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xv:$i] : (cwceq @ (XV @ Xv) @ (ccfv @ XG @ ccvtx))) => ((! [Xv:$i] : (cwceq @ (XD @ Xv) @ (ccfv @ XG @ ccvtxdg))) => (! [Xv:$i] : (cwi @ (cwa @ (cwcel @ XG @ (XW @ Xv)) @ (cwcel @ XK @ (XZ @ Xv))) @ (cwb @ (cwbr @ XG @ XK @ ccrusgr) @ (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XK @ ccxnn0) @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (XD @ Xv)) @ XK)) @ (^ [Xv:$i] : (XV @ Xv)))))))))))))))).
