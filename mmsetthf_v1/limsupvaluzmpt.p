...
thf(climsupvaluzmpt_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xj @ Xk) @ (cwcel @ (ccv @ Xj) @ XZ)) @ (cwcel @ (XB2 @ Xj) @ ccxr)))) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xj @ Xk) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xj:$i] : XZ) @ (^ [Xj:$i] : (XB2 @ Xj))) @ cclsp) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ ccuz)) @ (^ [Xj:$i] : (XB2 @ Xj)))) @ ccxr @ cclt)))) @ ccxr @ cclt)))))))))))))).
