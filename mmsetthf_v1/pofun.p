...
thf(cpofun_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XS @ Xx3 @ Xy1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwbr @ (XX @ Xx3) @ (XY @ Xy1) @ XR))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XX @ Xx3) @ (XY @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwpo @ (XB2 @ Xy1) @ XR) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XX @ Xx3) @ (XB2 @ Xy1))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) @ (cwpo @ (XA2 @ Xy1) @ (XS @ Xx3 @ Xy1)))))))))))))).
