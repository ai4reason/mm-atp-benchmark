...
thf(ctxcmp_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ cccmp) @ (cwcel @ XS @ cccmp)) @ (cwcel @ (cco @ XR @ XS @ cctx) @ cccmp))))).
