...
thf(adf_psubsp_ax,axiom,(cwceq @ ccpsubsp @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccab @ (^ [Xs1:$i] : (cwa @ (cwss @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xk) @ ccatm)) @ (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : (cwral @ (^ [Xr:$i] : (cwi @ (cwbr @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (ccfv @ (ccv @ Xk) @ ccjn)) @ (ccfv @ (ccv @ Xk) @ ccple)) @ (cwcel @ (ccv @ Xr) @ (ccv @ Xs1)))) @ (^ [Xr:$i] : (ccfv @ (ccv @ Xk) @ ccatm)))) @ (^ [Xq:$i] : (ccv @ Xs1)))) @ (^ [Xp:$i] : (ccv @ Xs1)))))))))).
...
thf(cpsubspset_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_or:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_le @ Xs1 @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccple)))))) => ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xs1 @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccjn)))))) => ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XA2 @ Xq @ Xp) @ (ccfv @ XK @ ccatm)))) => ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xs1 @ Xr @ Xq @ Xp) @ (ccfv @ XK @ ccpsubsp)))))) => (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwcel @ XK @ (XB2 @ Xs1 @ Xr @ Xq @ Xp)) @ (cwceq @ (XS @ Xs1 @ Xr @ Xq @ Xp) @ (ccab @ (^ [Xs1:$i] : (cwa @ (cwss @ (ccv @ Xs1) @ (XA2 @ Xq @ Xp)) @ (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : (cwral @ (^ [Xr:$i] : (cwi @ (cwbr @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xs1 @ Xr @ Xq @ Xp)) @ (Xc_le @ Xs1 @ Xr @ Xq @ Xp)) @ (cwcel @ (ccv @ Xr) @ (ccv @ Xs1)))) @ (^ [Xr:$i] : (XA2 @ Xq @ Xp)))) @ (^ [Xq:$i] : (ccv @ Xs1)))) @ (^ [Xp:$i] : (ccv @ Xs1))))))))))))))))))))))).
