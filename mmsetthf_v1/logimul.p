...
thf(clogimul_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) @ (cwceq @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cclog) @ (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccaddc))))).
