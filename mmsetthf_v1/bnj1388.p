...
thf(abnj1152_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwb @ (cwcel @ XY @ (cc_bnj14 @ XA2 @ XR @ XX)) @ (cwa @ (cwcel @ XY @ XA2) @ (cwbr @ XY @ XX @ XR)))))))).
...
thf(cbnj1388_conj,conjecture,(! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [Xta:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xbnjwtam:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xd) @ (ccab @ (^ [Xd:$i] : (cwa @ (cwss @ (ccv @ Xd) @ (XA2 @ Xf1 @ Xd)) @ (cwral @ (^ [Xx3:$i] : (cwss @ (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3)) @ (ccv @ Xd))) @ (^ [Xx3:$i] : (ccv @ Xd))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwceq @ (XY @ Xx3 @ Xy1 @ Xf1 @ Xd) @ (ccop @ (ccv @ Xx3) @ (ccres @ (ccv @ Xf1) @ (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwceq @ (XC @ Xx3 @ Xy1 @ Xf1 @ Xd) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xd:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xd)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (XY @ Xx3 @ Xy1 @ Xf1 @ Xd) @ (XG @ Xx3 @ Xy1 @ Xf1 @ Xd)))) @ (^ [Xx3:$i] : (ccv @ Xd))))) @ (^ [Xd:$i] : (XB2 @ Xx3 @ Xy1 @ Xd)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwb @ (Xta @ Xx3 @ Xf1 @ Xd) @ (cwa @ (cwcel @ (ccv @ Xf1) @ (XC @ Xx3 @ Xy1 @ Xf1 @ Xd)) @ (cwceq @ (ccdm @ (ccv @ Xf1)) @ (ccun @ (ccsn @ (ccv @ Xx3)) @ (cc_bnj18 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3)))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwceq @ (XD @ Xx3 @ Xf1 @ Xd) @ (ccrab @ (^ [Xx3:$i] : (cwn @ (cwex @ (^ [Xf1:$i] : (Xta @ Xx3 @ Xf1 @ Xd))))) @ (^ [Xx3:$i] : (XA2 @ Xf1 @ Xd))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwb @ (Xps @ Xx3 @ Xf1 @ Xd) @ (cwa @ (cw_bnj15 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd)) @ (cwne @ (XD @ Xx3 @ Xf1 @ Xd) @ cc0)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwb @ (Xch @ Xx3 @ Xy1 @ Xf1 @ Xd) @ (cw3a @ (Xps @ Xx3 @ Xf1 @ Xd) @ (cwcel @ (ccv @ Xx3) @ (XD @ Xx3 @ Xf1 @ Xd)) @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (XR @ Xf1 @ Xd)))) @ (^ [Xy1:$i] : (XD @ Xx3 @ Xf1 @ Xd))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwb @ (Xbnjwtam @ Xx3 @ Xy1 @ Xf1 @ Xd) @ (cwsbc @ (^ [Xx3:$i] : (Xta @ Xx3 @ Xf1 @ Xd)) @ (ccv @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : (cwi @ (Xch @ Xx3 @ Xy1 @ Xf1 @ Xd) @ (cwral @ (^ [Xy1:$i] : (cwex @ (^ [Xf1:$i] : (Xbnjwtam @ Xx3 @ Xy1 @ Xf1 @ Xd)))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3))))))))))))))))))))))))))))).
