...
thf(aliminflelimsuplem_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (XV @ Xj @ Xk))))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwne @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xj) @ ccpnf @ ccico)) @ ccxr) @ cc0)) @ (^ [Xj:$i] : (cco @ (ccv @ Xk) @ ccpnf @ ccico)))) @ (^ [Xk:$i] : ccr)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccfv @ XF @ cclsi) @ (ccfv @ XF @ cclsp) @ ccle))))))))).
