...
thf(adf_idfu_ax,axiom,(cwceq @ ccidfu @ (ccmpt @ (^ [Xt:$i] : cccat) @ (^ [Xt:$i] : (ccsb @ (ccfv @ (ccv @ Xt) @ ccbs) @ (^ [Xb:$i] : (ccop @ (ccres @ ccid @ (ccv @ Xb)) @ (ccmpt @ (^ [Xz:$i] : (ccxp @ (ccv @ Xb) @ (ccv @ Xb))) @ (^ [Xz:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xt) @ cchom)))))))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aopex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (ccop @ XA2 @ XB2) @ ccvv)))).
thf(cidfuval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XI @ Xz) @ (ccfv @ XC @ ccidfu))) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => (! [Xz:$i] : (cwi @ Xph @ (cwceq @ (XI @ Xz) @ (ccop @ (ccres @ ccid @ XB2) @ (ccmpt @ (^ [Xz:$i] : (ccxp @ XB2 @ XB2)) @ (^ [Xz:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xz) @ XH)))))))))))))))))).
