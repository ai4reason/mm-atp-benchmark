...
thf(celiunov2_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((cwceq @ XC @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ Xc_ex)))))) => (! [Xn:$i] : (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XR @ (XU @ Xn @ Xr)) @ (cwcel @ XN @ (XV @ Xn @ Xr))) @ (cwb @ (cwcel @ (XX @ Xr) @ (ccfv @ XR @ XC)) @ (cwrex @ (^ [Xn:$i] : (cwcel @ (XX @ Xr) @ (cco @ XR @ (ccv @ Xn) @ Xc_ex))) @ (^ [Xn:$i] : XN))))))))))))))).
