...
thf(apockthg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccn)) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xx3 @ Xp) @ ccn)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwbr @ (XB2 @ Xx3 @ Xp) @ XA2 @ cclt)))) => ((! [Xx3:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwceq @ XN @ (cco @ (cco @ XA2 @ (XB2 @ Xx3 @ Xp) @ ccmul) @ cc1 @ ccaddc))))) => ((cwi @ Xph @ (cwral @ (^ [Xp:$i] : (cwi @ (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) @ cc1) @ (cwceq @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ (ccv @ Xp) @ ccdiv) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) @ cc1))) @ (^ [Xx3:$i] : ccz)))) @ (^ [Xp:$i] : ccprime))) => (cwi @ Xph @ (cwcel @ XN @ ccprime)))))))))))).
...
thf(aproththdlem_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XK @ ccn)) => ((cwi @ Xph @ (cwceq @ XP @ (cco @ (cco @ XK @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc))) => (cwi @ Xph @ (cw3a @ (cwcel @ XP @ ccn) @ (cwbr @ cc1 @ XP @ cclt) @ (cwcel @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn))))))))))).
...
thf(amodexp2m1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => ((cwi @ Xph @ (cwbr @ cc1 @ XE @ cclt)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XE @ ccmo) @ (cco @ (ccneg @ cc1) @ XE @ ccmo))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XE @ ccmo) @ cc1)))))))))).
...
thf(amodsub12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwcel @ XE @ ccrp)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XE @ ccmo) @ (cco @ XB2 @ XE @ ccmo))) => ((cwi @ Xph @ (cwceq @ (cco @ XC @ XE @ ccmo) @ (cco @ XD @ XE @ ccmo))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccmin) @ XE @ ccmo) @ (cco @ (cco @ XB2 @ XD @ ccmin) @ XE @ ccmo))))))))))))))))).
...
thf(anegdi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccneg @ (cco @ XA2 @ XB2 @ ccaddc)) @ (cco @ (ccneg @ XA2) @ XB2 @ ccmin)))))).
...
thf(annnegz_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (ccneg @ XN) @ ccz)))).
...
thf(aisoddgcd1_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ ccz) @ (cwb @ (cwn @ (cwbr @ cc2 @ XZ @ ccdvds)) @ (cwceq @ (cco @ cc2 @ XZ @ ccgcd) @ cc1))))).
thf(cproththd_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xx3) @ ccn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ XP @ (cco @ (cco @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ cclt))) => ((cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) @ (cco @ (ccneg @ cc1) @ XP @ ccmo))) @ (^ [Xx3:$i] : ccz))) => (cwi @ Xph @ (cwcel @ XP @ ccprime)))))))))))).
