...
thf(cpfxsuff1eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwbr @ ccc0 @ (ccfv @ XW @ cchash) @ cclt)) @ (cwb @ (cwceq @ XW @ XU) @ (cwa @ (cwceq @ (ccfv @ XW @ cchash) @ (ccfv @ XU @ cchash)) @ (cwa @ (cwceq @ (cco @ XW @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx) @ (cco @ XU @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx)) @ (cwceq @ (ccfv @ XW @ cclsw) @ (ccfv @ XU @ cclsw)))))))))).
