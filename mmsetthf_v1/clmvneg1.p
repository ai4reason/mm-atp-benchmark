...
thf(cclmvneg1_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ ccminusg)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => (cwi @ (cwa @ (cwcel @ XW @ ccclm) @ (cwcel @ XX @ XV)) @ (cwceq @ (cco @ (ccneg @ cc1) @ XX @ Xc_x) @ (ccfv @ XX @ XN)))))))))))))).
