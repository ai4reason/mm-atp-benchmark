...
thf(clnmlsslnm_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XS @ (ccfv @ XM @ cclss)) => ((cwceq @ XR @ (cco @ XM @ XU @ ccress)) => (cwi @ (cwa @ (cwcel @ XM @ cclnm) @ (cwcel @ XU @ XS)) @ (cwcel @ XR @ cclnm))))))))).
