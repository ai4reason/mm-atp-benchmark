...
thf(adf_quot_ax,axiom,(cwceq @ ccquot @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ ccc @ ccply))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccdif @ (ccfv @ ccc @ ccply) @ (ccsn @ cc0p)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccrio @ (^ [Xq:$i] : (cwsbc @ (^ [Xr:$i] : (cwo @ (cwceq @ (ccv @ Xr) @ cc0p) @ (cwbr @ (ccfv @ (ccv @ Xr) @ ccdgr) @ (ccfv @ (ccv @ Xg1) @ ccdgr) @ cclt))) @ (cco @ (ccv @ Xf1) @ (cco @ (ccv @ Xg1) @ (ccv @ Xq) @ (ccof @ ccmul)) @ (ccof @ ccmin)))) @ (^ [Xq:$i] : (ccfv @ ccc @ ccply)))))))).
thf(ariotaex_thm,axiom,(! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwcel @ (ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccvv)))).
thf(cquotval_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xq:$i] : (cwceq @ (XR @ Xq) @ (cco @ XF @ (cco @ XG @ (ccv @ Xq) @ (ccof @ ccmul)) @ (ccof @ ccmin)))) => (! [Xq:$i] : (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ (XS @ Xq) @ ccply)) @ (cwcel @ XG @ (ccfv @ (XS @ Xq) @ ccply)) @ (cwne @ XG @ cc0p)) @ (cwceq @ (cco @ XF @ XG @ ccquot) @ (ccrio @ (^ [Xq:$i] : (cwo @ (cwceq @ (XR @ Xq) @ cc0p) @ (cwbr @ (ccfv @ (XR @ Xq) @ ccdgr) @ (ccfv @ XG @ ccdgr) @ cclt))) @ (^ [Xq:$i] : (ccfv @ ccc @ ccply)))))))))))).
