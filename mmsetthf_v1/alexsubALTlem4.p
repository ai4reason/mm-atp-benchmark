...
thf(aalexsubALTlem2_thm,axiom,(! [Xx3:$i] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xa:$i] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cw3a @ (cwceq @ XJ @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3)))) @ (cwcel @ (ccv @ Xa) @ (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi)))) @ (cwral @ (^ [Xb:$i] : (cwn @ (cwceq @ XX @ (ccuni @ (ccv @ Xb))))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xa)) @ ccfn)))) @ (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwn @ (cwpss @ (ccv @ Xu) @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccun @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xa) @ (ccv @ Xz)) @ (cwral @ (^ [Xb:$i] : (cwn @ (cwceq @ XX @ (ccuni @ (ccv @ Xb))))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xz)) @ ccfn))))) @ (^ [Xz:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi)))) @ (ccsn @ cc0))))) @ (^ [Xu:$i] : (ccun @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xa) @ (ccv @ Xz)) @ (cwral @ (^ [Xb:$i] : (cwn @ (cwceq @ XX @ (ccuni @ (ccv @ Xb))))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xz)) @ ccfn))))) @ (^ [Xz:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi)))) @ (ccsn @ cc0))))))))))).
...
thf(aelfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccint @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XB2) @ ccfn)))))))))).
...
thf(aalexsubALTlem3_thm,axiom,(! [Xt:$i] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xa:$i] : ((cwceq @ XX @ (ccuni @ XJ)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwa @ (cwa @ (cw3a @ (cwceq @ XJ @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) @ (cwral @ (^ [Xc:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3)))) @ (cwcel @ (ccv @ Xa) @ (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi)))) @ (cwa @ (cwcel @ (ccv @ Xu) @ (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi))) @ (cwa @ (cwss @ (ccv @ Xa) @ (ccv @ Xu)) @ (cwral @ (^ [Xb:$i] : (cwn @ (cwceq @ XX @ (ccuni @ (ccv @ Xb))))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xu)) @ ccfn)))))) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xu))) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xt) @ (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn)) @ (cwceq @ (ccv @ Xw) @ (ccint @ (ccv @ Xt)))) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xw)) @ (cwn @ (cwcel @ (ccv @ Xy1) @ (ccuni @ (ccin @ (ccv @ Xx3) @ (ccv @ Xu)))))))) @ (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xn:$i] : (cwn @ (cwceq @ XX @ (ccuni @ (ccv @ Xn))))) @ (^ [Xn:$i] : (ccin @ (ccpw @ (ccun @ (ccv @ Xu) @ (ccsn @ (ccv @ Xs1)))) @ ccfn)))) @ (^ [Xs1:$i] : (ccv @ Xt)))))))))))))).
...
thf(aimp55_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))))) => (cwi @ (cwa @ (cwa @ Xph @ (cwa @ Xps @ (cwa @ Xch @ Xth))) @ Xta) @ Xet))))))))).
...
thf(calexsubALTlem4_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (! [Xx3:$i] : (cwi @ (cwceq @ XJ @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) @ (cwi @ (cwral @ (^ [Xc:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xc))) @ (cwrex @ (^ [Xd:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3)))) @ (cwral @ (^ [Xa:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xa))) @ (cwrex @ (^ [Xb:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xb)))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xa)) @ ccfn))))) @ (^ [Xa:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi))))))))))).
