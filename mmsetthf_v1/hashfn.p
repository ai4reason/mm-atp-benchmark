...
thf(afndmeng_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XA2 @ XC)) @ (cwbr @ XA2 @ XF @ ccen)))))).
...
thf(chashfn_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ XA2) @ (cwceq @ (ccfv @ XF @ cchash) @ (ccfv @ XA2 @ cchash)))))).
