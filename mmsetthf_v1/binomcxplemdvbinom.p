...
thf(abinomcxplemradcnv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwcel @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccrp)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwcel @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwbr @ (ccfv @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ cclt)))))) => ((! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwcel @ (XC @ Xr @ Xb) @ ccc)))) => ((! [Xj:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwceq @ (XF @ Xj @ Xr) @ (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (XC @ Xr @ Xb) @ (ccv @ Xj) @ ccbcc))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwceq @ (XS @ Xj @ Xk @ Xb) @ (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ (cco @ (ccv @ Xb) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwceq @ (XR @ Xj @ Xk @ Xr @ Xb) @ (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XS @ Xj @ Xk @ Xb)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xr @ Xb) @ (cwn @ (cwcel @ (XC @ Xr @ Xb) @ ccn0))) @ (cwceq @ (XR @ Xj @ Xk @ Xr @ Xb) @ cc1))))))))))))))))))))).
...
thf(advcncxp1_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ cccxp))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ XA2 @ (cco @ (ccv @ Xx3) @ (cco @ XA2 @ cc1 @ ccmin) @ cccxp) @ ccmul))))))))).
...
thf(cbinomcxplemdvbinom_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwcel @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccrp)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwcel @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwbr @ (ccfv @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ cclt)))))) => ((! [Xr:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xr @ Xb) @ (cwcel @ (XC @ Xr) @ ccc)))) => ((! [Xj:$i] : (! [Xr:$i] : (cwceq @ (XF @ Xj @ Xr) @ (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (XC @ Xr) @ (ccv @ Xj) @ ccbcc)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwceq @ (XS @ Xj @ Xk @ Xb) @ (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ (cco @ (ccv @ Xb) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwceq @ (XR @ Xj @ Xk @ Xr @ Xb) @ (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XS @ Xj @ Xk @ Xb)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwceq @ (XE @ Xj @ Xk @ Xr @ Xb) @ (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ ccmul) @ (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwceq @ (XD @ Xj @ Xk @ Xr @ Xb) @ (ccima @ (cccnv @ ccabs) @ (cco @ ccc0 @ (XR @ Xj @ Xk @ Xr @ Xb) @ ccico))))))) => (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xr @ Xb) @ (cwn @ (cwcel @ (XC @ Xr) @ ccn0))) @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xb:$i] : (XD @ Xj @ Xk @ Xr @ Xb)) @ (^ [Xb:$i] : (cco @ (cco @ cc1 @ (ccv @ Xb) @ ccaddc) @ (ccneg @ (XC @ Xr)) @ cccxp))) @ ccdv) @ (ccmpt @ (^ [Xb:$i] : (XD @ Xj @ Xk @ Xr @ Xb)) @ (^ [Xb:$i] : (cco @ (ccneg @ (XC @ Xr)) @ (cco @ (cco @ cc1 @ (ccv @ Xb) @ ccaddc) @ (cco @ (ccneg @ (XC @ Xr)) @ cc1 @ ccmin) @ cccxp) @ ccmul)))))))))))))))))))))))))))).
