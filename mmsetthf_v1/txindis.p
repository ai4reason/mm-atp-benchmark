...
thf(aindisuni_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ XA2 @ ccid) @ (ccuni @ (ccpr @ cc0 @ XA2))))).
...
thf(atxindislem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccxp @ (ccfv @ XA2 @ ccid) @ (ccfv @ XB2 @ ccid)) @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccid))))).
thf(ctxindis_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (cco @ (ccpr @ cc0 @ XA2) @ (ccpr @ cc0 @ XB2) @ cctx) @ (ccpr @ cc0 @ (ccxp @ XA2 @ XB2)))))).
