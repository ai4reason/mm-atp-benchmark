...
thf(cldual0_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XR @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XD @ (ccfv @ XW @ ccld)) => ((cwceq @ XS @ (ccfv @ XD @ ccsca)) => ((cwceq @ XO @ (ccfv @ XS @ cc0g)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => (cwi @ Xph @ (cwceq @ XO @ Xc_0)))))))))))))))).
