...
thf(akmlem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xw:$i] : (cwb @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (cwral @ (^ [Xz:$i] : (cwi @ (Xph @ Xz @ Xw) @ (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))))).
thf(apm4_64_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwi @ (cwn @ Xph) @ Xps) @ (cwo @ Xph @ Xps))))).
thf(ckmlem8_conj,conjecture,(! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xy1:$i] : (! [Xu:$i] : (cwb @ (cwi @ (cwn @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (Xps @ Xy1 @ Xz @ Xw @ Xu)) @ (^ [Xw:$i] : (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xu)))) @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (ccv @ Xu)))))) @ (cwo @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (Xps @ Xy1 @ Xz @ Xw @ Xu)) @ (^ [Xw:$i] : (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xu))) @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu))) @ (cwral @ (^ [Xz:$i] : (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1)))))) @ (^ [Xz:$i] : (ccv @ Xu)))))))))))).
