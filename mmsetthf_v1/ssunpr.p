...
thf(assunsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwa @ (cwss @ XB2 @ XA2) @ (cwss @ XA2 @ (ccun @ XB2 @ (ccsn @ XC)))) @ (cwo @ (cwceq @ XA2 @ XB2) @ (cwceq @ XA2 @ (ccun @ XB2 @ (ccsn @ XC))))))))).
...
thf(cssunpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwb @ (cwa @ (cwss @ XB2 @ XA2) @ (cwss @ XA2 @ (ccun @ XB2 @ (ccpr @ XC @ XD)))) @ (cwo @ (cwo @ (cwceq @ XA2 @ XB2) @ (cwceq @ XA2 @ (ccun @ XB2 @ (ccsn @ XC)))) @ (cwo @ (cwceq @ XA2 @ (ccun @ XB2 @ (ccsn @ XD))) @ (cwceq @ XA2 @ (ccun @ XB2 @ (ccpr @ XC @ XD))))))))))).
