...
thf(annledivrp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccrp)) @ (cwb @ (cwbr @ cc1 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XA2 @ ccle)))))).
...
thf(cnn0ledivnn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn)) @ (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XA2 @ ccle))))).
