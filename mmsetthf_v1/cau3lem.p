...
thf(ccau3lem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [Xta:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwss @ (XZ @ Xj @ Xk @ Xm) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwi @ (Xta @ Xj @ Xk @ Xm) @ (Xps @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj))) @ (cwb @ (Xps @ Xj @ Xk) @ (Xch @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xm) @ (XF @ Xj))) @ (cwb @ (Xps @ Xj @ Xk) @ (Xth @ Xx3 @ Xj @ Xm))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cw3a @ Xph @ (Xch @ Xx3 @ Xj) @ (Xps @ Xj @ Xk)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xm:$i] : (cwi @ (cw3a @ Xph @ (Xth @ Xx3 @ Xj @ Xm) @ (Xch @ Xx3 @ Xj)) @ (cwceq @ (ccfv @ (cco @ (ccfv @ (ccv @ Xm) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xm) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (Xps @ Xj @ Xk) @ (Xth @ Xx3 @ Xj @ Xm)) @ (cwa @ (Xch @ Xx3 @ Xj) @ (cwcel @ (ccv @ Xx3) @ ccr))) @ (cwi @ (cwa @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj)) @ (cco @ (ccv @ Xx3) @ cc2 @ ccdiv) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xm) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj)) @ (cco @ (ccv @ Xx3) @ cc2 @ ccdiv) @ cclt)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xm) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj)) @ (ccv @ Xx3) @ cclt))))))) => (! [Xk:$i] : (! [Xm:$i] : (cwi @ Xph @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (Xta @ Xj @ Xk @ Xm) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj)) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xj @ Xk @ Xm)))) @ (^ [Xx3:$i] : ccrp)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (Xta @ Xj @ Xk @ Xm) @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (ccfv @ (ccv @ Xm) @ (XF @ Xj)) @ (XD @ Xj)) @ (XG @ Xj)) @ (ccv @ Xx3) @ cclt)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xk) @ ccuz))))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xj @ Xk @ Xm)))) @ (^ [Xx3:$i] : ccrp))))))))))))))))))))))).
