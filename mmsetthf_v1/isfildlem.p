...
thf(cisfildlem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccv @ Xx3) @ XF) @ (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (Xps @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (XB2 @ Xx3) @ XF) @ (cwa @ (cwss @ (XB2 @ Xx3) @ XA2) @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XB2 @ Xx3)))))))))))))).
