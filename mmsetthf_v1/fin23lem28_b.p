...
thf(af1co_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwf1 @ XB2 @ XC @ XF) @ (cwf1 @ XA2 @ XB2 @ XG)) @ (cwf1 @ XA2 @ XC @ (cccom @ XF @ XG))))))))).
