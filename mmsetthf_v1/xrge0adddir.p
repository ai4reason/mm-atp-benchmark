...
thf(axadddir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccr)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxmu) @ (cco @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccxad))))))).
...
thf(axrge0addgt0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccxad) @ cclt))))).
...
thf(cxrge0adddir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxmu) @ (cco @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccxad))))))).
