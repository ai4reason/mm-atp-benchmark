...
thf(ainfxpdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccdom)) @ (cwbr @ (ccxp @ XA2 @ XB2) @ XA2 @ ccdom))))).
...
thf(cinfxpabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom)) @ (cwa @ (cwne @ XB2 @ cc0) @ (cwbr @ XB2 @ XA2 @ ccdom))) @ (cwbr @ (ccxp @ XA2 @ XB2) @ XA2 @ ccen))))).
