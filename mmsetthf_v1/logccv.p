...
thf(advcvx_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwiso @ (cco @ XA2 @ XB2 @ ccioo) @ XW @ cclt @ cclt @ (cco @ ccr @ XF @ ccdv))) => ((cwi @ Xph @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) => ((cwceq @ XC @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc)) => (cwi @ Xph @ (cwbr @ (ccfv @ XC @ XF) @ (cco @ (cco @ XT @ (ccfv @ XA2 @ XF) @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ XB2 @ XF) @ ccmul) @ ccaddc) @ cclt))))))))))))))))).
...
thf(altnegd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (ccneg @ XB2) @ (ccneg @ XA2) @ cclt))))))))).
...
thf(altrecd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ cc1 @ XB2 @ ccdiv) @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt))))))))).
...
thf(asoisoi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwor @ XA2 @ XR) @ (cwpo @ XB2 @ XS)) @ (cwa @ (cwfo @ XA2 @ XB2 @ XH) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XH) @ (ccfv @ (ccv @ Xy1) @ XH) @ XS))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))) @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH)))))))).
...
thf(advrelog_thm,axiom,(cwceq @ (cco @ ccr @ (ccres @ cclog @ ccrp) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccv @ Xx3) @ ccdiv))))).
...
thf(alincmb01cmp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwcel @ (cco @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XA2 @ ccmul) @ (cco @ XT @ XB2 @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc))))))).
...
thf(amulneg2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (ccneg @ XB2) @ ccmul) @ (ccneg @ (cco @ XA2 @ XB2 @ ccmul)))))))))).
...
thf(clogccv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) @ (cwbr @ (cco @ (cco @ XT @ (ccfv @ XA2 @ cclog) @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ XB2 @ cclog) @ ccmul) @ ccaddc) @ (ccfv @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc) @ cclog) @ cclt)))))).
