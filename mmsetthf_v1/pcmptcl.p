...
thf(cpcmptcl_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (XA2 @ Xn) @ ccexp) @ cc1))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwral @ (^ [Xn:$i] : (cwcel @ (XA2 @ Xn) @ ccn0)) @ (^ [Xn:$i] : ccprime)))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwa @ (cwf @ ccn @ ccn @ (XF @ Xn)) @ (cwf @ ccn @ ccn @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))))).
