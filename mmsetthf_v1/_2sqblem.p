...
thf(asqnprm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwn @ (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccprime))))).
...
thf(c_2sqblem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwa @ (cwcel @ XP @ ccprime) @ (cwne @ XP @ cc2))) => ((cwi @ Xph @ (cwa @ (cwcel @ XX @ ccz) @ (cwcel @ XY @ ccz))) => ((cwi @ Xph @ (cwceq @ XP @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((cwi @ Xph @ (cwceq @ (cco @ XP @ XY @ ccgcd) @ (cco @ (cco @ XP @ XA2 @ ccmul) @ (cco @ XY @ XB2 @ ccmul) @ ccaddc))) => (cwi @ Xph @ (cwceq @ (cco @ XP @ cc4 @ ccmo) @ cc1))))))))))))))).
