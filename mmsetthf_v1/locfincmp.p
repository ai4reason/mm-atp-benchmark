...
thf(clocfincmp_conj,conjecture,(! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XC)) => (cwi @ (cwcel @ XJ @ cccmp) @ (cwb @ (cwcel @ XC @ (ccfv @ XJ @ cclocfin)) @ (cwa @ (cwcel @ XC @ ccfn) @ (cwceq @ XX @ XY))))))))))).
