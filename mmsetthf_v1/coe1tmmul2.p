...
thf(acoe1mul_thm,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XY @ Xx3 @ Xk) @ (ccfv @ XR @ ccpl1)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (Xc_xb @ Xx3) @ (ccfv @ (XY @ Xx3 @ Xk) @ ccmulr)))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XB2 @ Xx3 @ Xk) @ (ccfv @ (XY @ Xx3 @ Xk) @ ccbs)))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ (XB2 @ Xx3 @ Xk)) @ (cwcel @ XG @ (XB2 @ Xx3 @ Xk))) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (Xc_xb @ Xx3)) @ ccco1) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ ccco1)) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ ccmin) @ (ccfv @ XG @ ccco1)) @ Xc_x))) @ ccgsu))))))))))))))))))).
...
thf(agsumpt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwcel @ XG @ ccmnd)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ (cco @ XF @ Xc_0 @ ccsupp) @ (ccsn @ XX))) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ ccgsu) @ (ccfv @ XX @ XF))))))))))))))))))).
...
thf(ann0sub_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwbr @ XM @ XN @ ccle) @ (cwcel @ (cco @ XN @ XM @ ccmin) @ ccn0)))))).
...
thf(afznn0_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwa @ (cwcel @ XK @ ccn0) @ (cwbr @ XK @ XN @ ccle))))))).
...
thf(acoe1tmfv2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XC @ XK)) => ((cwi @ Xph @ (cwcel @ XD @ ccn0)) => ((cwi @ Xph @ (cwcel @ XF @ ccn0)) => ((cwi @ Xph @ (cwne @ XD @ XF)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ (ccfv @ (cco @ XC @ (cco @ XD @ XX @ Xc_ex) @ Xc_x) @ ccco1)) @ Xc_0))))))))))))))))))))))))))).
...
thf(ccoe1tmmul2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccvsca)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ XP @ ccbs))) => ((cwceq @ Xc_xb @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_xp @ (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XB2 @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XC @ XK)) => ((cwi @ Xph @ (cwcel @ XD @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ XC @ (cco @ XD @ XX @ Xc_ex) @ Xc_x) @ Xc_xb) @ ccco1) @ (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccif @ (cwbr @ XD @ (ccv @ Xx3) @ ccle) @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ XD @ ccmin) @ (ccfv @ XA2 @ ccco1)) @ XC @ Xc_xp) @ Xc_0))))))))))))))))))))))))))))))))))).
