...
thf(cecin0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwceq @ (ccin @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)) @ cc0) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwbr @ XA2 @ (ccv @ Xx3) @ XR) @ (cwn @ (cwbr @ XB2 @ (ccv @ Xx3) @ XR))))))))))))).
