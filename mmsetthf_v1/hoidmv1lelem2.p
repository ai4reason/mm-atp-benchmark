...
thf(asge0repnfmpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwb @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ ccr) @ (cwn @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ ccpnf))))))))))))).
...
thf(asge0splitsn_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XB2 @ (XW @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwn @ (cwcel @ XB2 @ XA2)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XB2) @ (cwceq @ (XC @ Xk) @ XD))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XD @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ (cco @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ XD @ ccxad))))))))))))))))))).
...
thf(choidmv1lelem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwcel @ (XA2 @ Xu @ Xj) @ ccr))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwcel @ (XB2 @ Xu @ Xj) @ ccr))))) => ((! [Xz:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwf @ ccn @ ccr @ (XC @ Xu))))) => ((! [Xz:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwf @ ccn @ ccr @ (XD @ Xu))))) => ((! [Xz:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xu)) @ (ccfv @ (ccv @ Xj) @ (XD @ Xu)) @ ccico) @ ccvol))) @ ccsumge0) @ ccr)))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwceq @ (XU @ Xz @ Xj) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xz) @ (XA2 @ Xu @ Xj) @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xu)) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ (XD @ Xu)) @ (ccv @ Xz) @ ccle) @ (ccfv @ (ccv @ Xj) @ (XD @ Xu)) @ (ccv @ Xz)) @ ccico) @ ccvol))) @ ccsumge0) @ ccle)) @ (^ [Xz:$i] : (cco @ (XA2 @ Xu @ Xj) @ (XB2 @ Xu @ Xj) @ ccicc))))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwcel @ XS @ (XU @ Xz @ Xj)))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwbr @ (XA2 @ Xu @ Xj) @ XS @ ccle))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwbr @ XS @ (XB2 @ Xu @ Xj) @ cclt))))) => ((! [Xz:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwcel @ (XK @ Xz @ Xu) @ ccn)))) => ((! [Xz:$i] : (! [Xu:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwcel @ XS @ (cco @ (ccfv @ (XK @ Xz @ Xu) @ (XC @ Xu)) @ (ccfv @ (XK @ Xz @ Xu) @ (XD @ Xu)) @ ccico))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwceq @ XM @ (ccif @ (cwbr @ (ccfv @ (XK @ Xz @ Xu) @ (XD @ Xu)) @ (XB2 @ Xu @ Xj) @ ccle) @ (ccfv @ (XK @ Xz @ Xu) @ (XD @ Xu)) @ (XB2 @ Xu @ Xj)))))) => (! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xz @ Xu) @ (cwrex @ (^ [Xu:$i] : (cwbr @ XS @ (ccv @ Xu) @ cclt)) @ (^ [Xu:$i] : (XU @ Xz @ Xj))))))))))))))))))))))))))))).
