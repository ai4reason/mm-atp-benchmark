...
thf(adfss6_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwss @ XA2 @ XB2) @ (cwn @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwn @ (cwcel @ (ccv @ Xx3) @ XB2)))))))))).
...
thf(avvdifopab_thm,axiom,(! [Xph:($i > ($i > $o))] : (cwceq @ (ccdif @ (ccxp @ ccvv @ ccvv) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwn @ (Xph @ Xx3 @ Xy1)))))))).
thf(adf_ssr_ax,axiom,(cwceq @ ccssr @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))))))).
thf(cdfssr2_conj,conjecture,(cwceq @ ccssr @ (ccdif @ (ccxp @ ccvv @ ccvv) @ (ccrn @ (ccxrn @ ccep @ (ccdif @ ccvv @ ccep)))))).
