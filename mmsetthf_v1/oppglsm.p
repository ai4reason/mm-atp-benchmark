...
thf(afunforn_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwfun @ XA2) @ (cwfo @ (ccdm @ XA2) @ (ccrn @ XA2) @ XA2)))).
...
thf(coppglsm_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccoppg)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwceq @ (cco @ XT @ XU @ (ccfv @ XO @ cclsm)) @ (cco @ XU @ XT @ Xc_po)))))))))).
