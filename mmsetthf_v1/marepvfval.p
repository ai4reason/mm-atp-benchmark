...
thf(adf_marepv_ax,axiom,(cwceq @ ccmatrepV @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccmpt2 @ (^ [Xm:$i] : (^ [Xv:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ ccbs))) @ (^ [Xm:$i] : (^ [Xv:$i] : (cco @ (ccfv @ (ccv @ Xr) @ ccbs) @ (ccv @ Xn) @ ccmap))) @ (^ [Xm:$i] : (^ [Xv:$i] : (ccmpt @ (^ [Xk:$i] : (ccv @ Xn)) @ (^ [Xk:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccv @ Xn))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccv @ Xn))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xv)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)))))))))))))))).
