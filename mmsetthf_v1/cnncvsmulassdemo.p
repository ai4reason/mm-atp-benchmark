...
thf(acnrbas_thm,axiom,(! [XC:($i > $o)] : ((cwceq @ XC @ (ccfv @ cccnfld @ ccrglmod)) => (cwceq @ (ccfv @ XC @ ccbs) @ ccc)))).
...
thf(ccnncvsmulassdemo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XC @ ccmul) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccmul))))))).
