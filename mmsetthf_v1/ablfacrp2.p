...
thf(aablfacrplem_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XM @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ cchash) @ (cco @ XM @ XN @ ccmul))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (XK @ Xx3) @ cchash) @ XN @ ccgcd) @ cc1))))))))))))))))))))).
...
thf(aablfacrp_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XM @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ cchash) @ (cco @ XM @ XN @ ccmul))) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (Xc_po @ Xx3) @ (ccfv @ XG @ cclsm))) => (! [Xx3:$i] : (cwi @ Xph @ (cwa @ (cwceq @ (ccin @ (XK @ Xx3) @ (XL @ Xx3)) @ (ccsn @ Xc_0)) @ (cwceq @ (cco @ (XK @ Xx3) @ (XL @ Xx3) @ (Xc_po @ Xx3)) @ XB2)))))))))))))))))))))))))).
...
thf(advdsmulc_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XK @ ccz)) @ (cwi @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ (cco @ XM @ XK @ ccmul) @ (cco @ XN @ XK @ ccmul) @ ccdvds))))))).
thf(advdscmulr_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwa @ (cwcel @ XK @ ccz) @ (cwne @ XK @ ccc0))) @ (cwb @ (cwbr @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccdvds) @ (cwbr @ XM @ XN @ ccdvds))))))).
thf(cablfacrp2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XM @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XB2 @ cchash) @ (cco @ XM @ XN @ ccmul))) => (! [Xx3:$i] : (cwi @ Xph @ (cwa @ (cwceq @ (ccfv @ (XK @ Xx3) @ cchash) @ XM) @ (cwceq @ (ccfv @ (XL @ Xx3) @ cchash) @ XN)))))))))))))))))))))).
