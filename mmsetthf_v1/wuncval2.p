...
thf(awuncss_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ ccwun) @ (cwss @ XA2 @ XU)) @ (cwss @ (ccfv @ XA2 @ ccwunm) @ XU))))).
...
thf(awuncid_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwss @ XA2 @ (ccfv @ XA2 @ ccwunm)))))).
...
thf(awunccl_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccfv @ XA2 @ ccwunm) @ ccwun))))).
...
thf(awunelss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwss @ XA2 @ XU)))))))).
...
thf(cwuncval2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccun @ (ccun @ (ccv @ Xz) @ (ccuni @ (ccv @ Xz))) @ (cciun @ (^ [Xx3:$i] : (ccv @ Xz)) @ (^ [Xx3:$i] : (ccun @ (ccpr @ (ccpw @ (ccv @ Xx3)) @ (ccuni @ (ccv @ Xx3))) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : (ccv @ Xz)) @ (^ [Xy1:$i] : (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))))))))) @ (ccun @ (XA2 @ Xz) @ cc1o)) @ ccom))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xz) @ (ccuni @ (ccrn @ (XF @ Xx3 @ Xy1 @ Xz))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (XA2 @ Xz) @ (XV @ Xz)) @ (cwceq @ (ccfv @ (XA2 @ Xz) @ ccwunm) @ (XU @ Xx3 @ Xy1 @ Xz))))))))))))).
