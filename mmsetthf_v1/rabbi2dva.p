...
thf(crabbi2dva_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwb @ (cwcel @ (ccv @ Xx3) @ XB2) @ (Xps @ Xx3)))) => (cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))))).
