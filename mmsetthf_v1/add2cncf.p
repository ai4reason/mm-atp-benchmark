...
thf(cadd2cncf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccaddc))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf)))))))))).
