...
thf(adf_evl1_ax,axiom,(cwceq @ cce1 @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccsb @ (ccfv @ (ccv @ Xr) @ ccbs) @ (^ [Xb:$i] : (cccom @ (ccmpt @ (^ [Xx3:$i] : (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xb) @ cc1o @ ccmap) @ ccmap)) @ (^ [Xx3:$i] : (cccom @ (ccv @ Xx3) @ (ccmpt @ (^ [Xy1:$i] : (ccv @ Xb)) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1)))))))) @ (cco @ cc1o @ (ccv @ Xr) @ ccevl)))))))).
...
thf(cevl1fval_conj,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XO @ Xx3 @ Xy1) @ (ccfv @ (XR @ Xy1) @ cce1)))) => ((! [Xy1:$i] : (cwceq @ (XQ @ Xy1) @ (cco @ cc1o @ (XR @ Xy1) @ ccevl))) => ((! [Xy1:$i] : (cwceq @ XB2 @ (ccfv @ (XR @ Xy1) @ ccbs))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XO @ Xx3 @ Xy1) @ (cccom @ (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ (cco @ XB2 @ cc1o @ ccmap) @ ccmap)) @ (^ [Xx3:$i] : (cccom @ (ccv @ Xx3) @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1)))))))) @ (XQ @ Xy1))))))))))))).
