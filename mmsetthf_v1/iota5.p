...
thf(ciota5_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ XV)) @ (cwb @ (Xps @ Xx3) @ (cwceq @ (ccv @ Xx3) @ XA2)))) => (cwi @ (cwa @ Xph @ (cwcel @ XA2 @ XV)) @ (cwceq @ (ccio @ (^ [Xx3:$i] : (Xps @ Xx3))) @ XA2)))))))).
