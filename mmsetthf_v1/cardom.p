...
thf(aonsseli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ XB2 @ ccon0) => (cwb @ (cwss @ XA2 @ XB2) @ (cwo @ (cwcel @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2)))))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(acardon_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccfv @ XA2 @ cccrd) @ ccon0))).
thf(ccardom_conj,conjecture,(cwceq @ (ccfv @ ccom @ cccrd) @ ccom)).
