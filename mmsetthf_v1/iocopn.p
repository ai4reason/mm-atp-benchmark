...
thf(ciocopn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwceq @ XJ @ (cco @ XK @ (cco @ XA2 @ XB2 @ ccioc) @ ccrest)) => ((cwi @ Xph @ (cwbr @ XA2 @ XC @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwcel @ (cco @ XC @ XB2 @ ccioc) @ XJ)))))))))))))))).
