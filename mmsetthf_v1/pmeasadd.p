...
thf(cpmeasadd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwf @ (XR @ Xs1) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XP @ Xs1)))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwceq @ (ccfv @ cc0 @ (XP @ Xs1)) @ ccc0))) => ((! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (Xph @ Xs1) @ (cw3a @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwss @ (ccv @ Xx3) @ (XR @ Xs1)) @ (cwdisj @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccv @ Xy1))))) @ (cwceq @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ (XP @ Xs1)) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (XP @ Xs1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwceq @ (XQ @ Xx3 @ Xy1 @ Xk @ Xs1) @ (ccrab @ (^ [Xs1:$i] : (cwa @ (cwcel @ cc0 @ (ccv @ Xs1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xs1)) @ (cwcel @ (ccdif @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ (XO @ Xx3 @ Xy1 @ Xk @ Xs1)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwcel @ (XR @ Xs1) @ (XQ @ Xx3 @ Xy1 @ Xk @ Xs1))))))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwbr @ (XA2 @ Xs1) @ ccom @ ccdom))) => ((! [Xk:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (Xph @ Xs1) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xs1))) @ (cwcel @ (XB2 @ Xk @ Xs1) @ (XR @ Xs1))))) => ((! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwdisj @ (^ [Xk:$i] : (XA2 @ Xs1)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xs1))))) => (! [Xs1:$i] : (cwi @ (Xph @ Xs1) @ (cwceq @ (ccfv @ (cciun @ (^ [Xk:$i] : (XA2 @ Xs1)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xs1))) @ (XP @ Xs1)) @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xs1)) @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk @ Xs1) @ (XP @ Xs1))))))))))))))))))))))).
