...
thf(csge0less_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccres @ XF @ XY) @ ccsumge0) @ (ccfv @ XF @ ccsumge0) @ ccle)))))))))).
