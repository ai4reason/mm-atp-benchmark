...
thf(altrneq3_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le)))) @ (cwb @ (cwceq @ (ccfv @ XP @ XF) @ (ccfv @ XP @ XG)) @ (cwceq @ XF @ XG))))))))))))))))).
thf(ccdlemn3_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XP @ (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : (cwceq @ (XF @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ XP @ (ccv @ Xh)) @ XQ)) @ (^ [Xh:$i] : XT)))) => ((! [Xh:$i] : (cwceq @ (XG @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ XP @ (ccv @ Xh)) @ XR)) @ (^ [Xh:$i] : XT)))) => ((! [Xh:$i] : (cwceq @ (XJ @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ XQ @ (ccv @ Xh)) @ XR)) @ (^ [Xh:$i] : XT)))) => (! [Xh:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le))) @ (cwa @ (cwcel @ XR @ XA2) @ (cwn @ (cwbr @ XR @ XW @ Xc_le)))) @ (cwceq @ (cccom @ (XJ @ Xh) @ (XF @ Xh)) @ (XG @ Xh))))))))))))))))))))))))).
