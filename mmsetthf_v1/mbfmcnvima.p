...
thf(cmbfmcnvima_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ ccmbfm))) => ((cwi @ Xph @ (cwcel @ XA2 @ XT)) => (cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ XS)))))))))))).
