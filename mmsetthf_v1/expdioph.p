...
thf(aexpdiophlem2_thm,axiom,(cwcel @ (ccrab @ (^ [Xa:$i] : (cwa @ (cwa @ (cwcel @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ (ccfv @ cc2 @ (ccv @ Xa)) @ ccn)) @ (cwceq @ (ccfv @ cc3 @ (ccv @ Xa)) @ (cco @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ (ccv @ Xa)) @ ccexp)))) @ (^ [Xa:$i] : (cco @ ccn0 @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))) @ (ccfv @ cc3 @ ccdioph))).
...
thf(cexpdioph_conj,conjecture,(cwcel @ (ccrab @ (^ [Xa:$i] : (cwceq @ (ccfv @ cc3 @ (ccv @ Xa)) @ (cco @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ (ccv @ Xa)) @ ccexp))) @ (^ [Xa:$i] : (cco @ ccn0 @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))) @ (ccfv @ cc3 @ ccdioph))).
