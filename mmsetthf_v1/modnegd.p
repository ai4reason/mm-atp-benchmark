...
thf(cmodnegd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XC @ ccmo) @ (cco @ XB2 @ XC @ ccmo))) => (cwi @ Xph @ (cwceq @ (cco @ (ccneg @ XA2) @ XC @ ccmo) @ (cco @ (ccneg @ XB2) @ XC @ ccmo)))))))))))).
