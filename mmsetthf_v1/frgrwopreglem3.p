...
thf(cfrgrwopreglem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XD @ (ccfv @ XG @ ccvtxdg)) => ((cwceq @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XD) @ XK)) @ (^ [Xx3:$i] : XV))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccdif @ XV @ XA2))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ (XB2 @ Xx3))) @ (cwne @ (ccfv @ XX @ XD) @ (ccfv @ XY @ XD))))))))))))))))).
