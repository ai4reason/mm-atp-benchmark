...
thf(cbj_exlimmpbi_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xch @ Xx3) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3)))) => ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (cwi @ (cwex @ (^ [Xx3:$i] : (Xch @ Xx3))) @ (Xps @ Xx3)))))))))).
