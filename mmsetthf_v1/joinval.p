...
thf(cjoinval_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XU @ (ccfv @ XK @ cclub)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwi @ Xph @ (cwcel @ XK @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XW)) => ((cwi @ Xph @ (cwcel @ XY @ XZ)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ Xc_or) @ (ccfv @ (ccpr @ XX @ XY) @ XU)))))))))))))))))).
