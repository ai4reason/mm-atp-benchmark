...
thf(arnnonrel_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccrn @ (ccdif @ XA2 @ (cccnv @ (cccnv @ XA2)))) @ cc0))).
...
thf(cfvnonrel_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwceq @ (ccfv @ XX @ (ccdif @ XA2 @ (cccnv @ (cccnv @ XA2)))) @ cc0)))).
