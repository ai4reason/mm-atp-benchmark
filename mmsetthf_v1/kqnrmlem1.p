...
thf(akqid_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ XJ @ (ccfv @ XJ @ cckq) @ cccn)))))))))).
...
thf(anrmsep3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccnrm) @ (cw3a @ (cwcel @ XA2 @ XJ) @ (cwcel @ XB2 @ (ccfv @ XJ @ cccld)) @ (cwss @ XB2 @ XA2))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwss @ XB2 @ (ccv @ Xx3)) @ (cwss @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XA2))) @ (^ [Xx3:$i] : XJ))))))).
...
thf(afunimass1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ XA2 @ (ccrn @ XF))) @ (cwi @ (cwss @ (ccima @ (cccnv @ XF) @ XA2) @ XB2) @ (cwss @ XA2 @ (ccima @ XF @ XB2)))))))).
...
thf(akqcld_thm,axiom,(! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ (XU @ Xx3 @ Xy1) @ (ccfv @ XJ @ cccld))) @ (cwcel @ (ccima @ (XF @ Xx3 @ Xy1) @ (XU @ Xx3 @ Xy1)) @ (ccfv @ (ccfv @ XJ @ cckq) @ cccld))))))))))).
...
thf(aisnrm_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccnrm) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwss @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccfv @ (ccv @ Xz) @ (ccfv @ XJ @ cccl)) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XJ))) @ (^ [Xy1:$i] : (ccin @ (ccfv @ XJ @ cccld) @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XJ)))))).
thf(ckqnrmlem1_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XJ @ ccnrm)) @ (cwcel @ (ccfv @ XJ @ cckq) @ ccnrm))))))).
