...
thf(a_3adantll3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xta) => (cwi @ (cwa @ (cwa @ (cw3a @ Xph @ Xps @ Xet) @ Xch) @ Xth) @ Xta))))))))).
...
thf(atgiooss_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwi @ (cwss @ XA2 @ ccr) @ (cwceq @ (cco @ XJ @ XA2 @ ccrest) @ (cco @ XK @ XA2 @ ccrest))))))))).
...
thf(alimcperiod_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ (ccdm @ XF) @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwss @ XA2 @ (ccdm @ XF))) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ XT @ ccaddc))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccc))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwss @ (XB2 @ Xx3 @ Xy1) @ (ccdm @ XF))))) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XA2)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xy1) @ XT @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccres @ XF @ XA2) @ XD @ cclimc))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XC @ (cco @ (ccres @ XF @ (XB2 @ Xx3 @ Xy1)) @ (cco @ XD @ XT @ ccaddc) @ cclimc))))))))))))))))))))).
...
thf(afourierdlem33_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwbr @ XC @ XD @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XC @ XD @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwceq @ XY @ (ccif @ (cwceq @ XD @ XB2) @ XL @ (ccfv @ XD @ XF))) => ((cwceq @ XJ @ (cco @ (ccfv @ cccnfld @ cctopn) @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XB2)) @ ccrest)) => (cwi @ Xph @ (cwcel @ XY @ (cco @ (ccres @ XF @ (cco @ XC @ XD @ ccioo)) @ XD @ cclimc)))))))))))))))))))))))).
thf(ane0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ XA2) @ (cwne @ XA2 @ cc0))))).
thf(cfourierdlem49_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ (XA2 @ Xk) @ ccr))))) => ((! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ XB2 @ ccr)))) => ((! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwbr @ (XA2 @ Xk) @ XB2 @ cclt))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XP @ Xx3 @ Xi @ Xk @ Xm @ Xp) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : (cwa @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (XA2 @ Xk)) @ (cwceq @ (ccfv @ (ccv @ Xm) @ (ccv @ Xp)) @ XB2)) @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap))))))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XT @ Xi @ Xm @ Xp) @ (cco @ XB2 @ (XA2 @ Xk) @ ccmin)))))) => ((! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ XM @ ccn)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ (XQ @ Xm) @ (ccfv @ XM @ (XP @ Xx3 @ Xi @ Xk @ Xm @ Xp))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwss @ (XD @ Xi @ Xm @ Xp) @ ccr))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwf @ (XD @ Xi @ Xm @ Xp) @ ccr @ (XF @ Xm @ Xp)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (Xph @ Xm @ Xp) @ (cwcel @ (ccv @ Xx3) @ (XD @ Xi @ Xm @ Xp)) @ (cwcel @ (ccv @ Xk) @ ccz)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (XT @ Xi @ Xm @ Xp) @ ccmul) @ ccaddc) @ (XD @ Xi @ Xm @ Xp)))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (Xph @ Xm @ Xp) @ (cwcel @ (ccv @ Xx3) @ (XD @ Xi @ Xm @ Xp)) @ (cwcel @ (ccv @ Xk) @ ccz)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (XT @ Xi @ Xm @ Xp) @ ccmul) @ ccaddc) @ (XF @ Xm @ Xp)) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xm @ Xp))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xm @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwcel @ (ccres @ (XF @ Xm @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo) @ ccc @ cccncf)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xm @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwcel @ (XL @ Xx3 @ Xi @ Xk @ Xm @ Xp) @ (cco @ (ccres @ (XF @ Xm @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ cclimc)))))))) => ((! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwcel @ (XX @ Xm @ Xp) @ ccr)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XZ @ Xi @ Xm @ Xp) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ (XT @ Xi @ Xm @ Xp) @ ccdiv) @ ccfl) @ (XT @ Xi @ Xm @ Xp) @ ccmul))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xm @ Xp) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (XZ @ Xi @ Xm @ Xp)) @ ccaddc))))))) => (! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xm @ Xp) @ (cwne @ (cco @ (ccres @ (XF @ Xm @ Xp) @ (cco @ ccmnf @ (XX @ Xm @ Xp) @ ccioo)) @ (XX @ Xm @ Xp) @ cclimc) @ cc0)))))))))))))))))))))))))))))))))).
