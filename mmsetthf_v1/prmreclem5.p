...
thf(aprmreclem4_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => ((cwi @ Xph @ (cwcel @ XK @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwceq @ XM @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xp:$i] : (cwn @ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xp:$i] : (ccdif @ ccprime @ (cco @ cc1 @ XK @ ccfz))))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli))) => ((cwi @ Xph @ (cwbr @ (ccsu @ (ccfv @ (cco @ XK @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccc0))) @ (cco @ cc1 @ cc2 @ ccdiv) @ cclt)) => ((! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XW @ Xn @ Xp) @ (ccmpt @ (^ [Xp:$i] : ccn) @ (^ [Xp:$i] : (ccrab @ (^ [Xn:$i] : (cwa @ (cwcel @ (ccv @ Xp) @ ccprime) @ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))))))) => (! [Xn:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwi @ (cwcel @ XN @ (ccfv @ XK @ ccuz)) @ (cwbr @ (ccfv @ (cciun @ (^ [Xk:$i] : (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XW @ Xn @ Xp)))) @ cchash) @ (cco @ XN @ (ccsu @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccc0))) @ ccmul) @ ccle))))))))))))))))))).
...
thf(aprmreclem3_thm,axiom,(! [Xph:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ (XK @ Xr) @ ccn))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ (XN @ Xr) @ ccn))) => ((! [Xr:$i] : (cwceq @ (XM @ Xr) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xp:$i] : (cwn @ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xp:$i] : (ccdif @ ccprime @ (cco @ cc1 @ (XK @ Xr) @ ccfz))))) @ (^ [Xn:$i] : (cco @ cc1 @ (XN @ Xr) @ ccfz))))) => ((cwceq @ XQ @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsup @ (ccrab @ (^ [Xr:$i] : (cwbr @ (cco @ (ccv @ Xr) @ cc2 @ ccexp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xr:$i] : ccn)) @ ccr @ cclt)))) => (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwbr @ (ccfv @ (XM @ Xr) @ cchash) @ (cco @ (cco @ cc2 @ (XK @ Xr) @ ccexp) @ (ccfv @ (XN @ Xr) @ ccsqrt) @ ccmul) @ ccle))))))))))))))).
...
thf(cprmreclem5_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((cwceq @ XF @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => ((cwi @ Xph @ (cwcel @ XK @ ccn)) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwceq @ XM @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xp:$i] : (cwn @ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xp:$i] : (ccdif @ ccprime @ (cco @ cc1 @ XK @ ccfz))))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))) => ((cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli))) => ((cwi @ Xph @ (cwbr @ (ccsu @ (ccfv @ (cco @ XK @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccc0))) @ (cco @ cc1 @ cc2 @ ccdiv) @ cclt)) => ((! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XW @ Xn @ Xp) @ (ccmpt @ (^ [Xp:$i] : ccn) @ (^ [Xp:$i] : (ccrab @ (^ [Xn:$i] : (cwa @ (cwcel @ (ccv @ Xp) @ ccprime) @ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))))))) => (cwi @ Xph @ (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ (cco @ (cco @ cc2 @ XK @ ccexp) @ (ccfv @ XN @ ccsqrt) @ ccmul) @ cclt)))))))))))))))).
