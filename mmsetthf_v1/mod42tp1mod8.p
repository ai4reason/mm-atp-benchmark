...
thf(amodremain_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn) @ (cwa @ (cwcel @ XR @ ccn0) @ (cwbr @ XR @ XD @ cclt))) @ (cwb @ (cwceq @ (cco @ XN @ XD @ ccmo) @ XR) @ (cwrex @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xz) @ XD @ ccmul) @ XR @ ccaddc) @ XN)) @ (^ [Xz:$i] : ccz)))))))).
...
thf(cmod42tp1mod8_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwceq @ (cco @ XN @ cc4 @ ccmo) @ cc3)) @ (cwceq @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ cc8 @ ccmo) @ cc7)))).
