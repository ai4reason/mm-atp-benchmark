...
thf(alemuldiv3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwbr @ (cco @ XB2 @ XA2 @ ccmul) @ XC @ ccle)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccdiv) @ ccle)))))))))))).
...
thf(alemuldiv4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccdiv) @ ccle)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwbr @ (cco @ XB2 @ XA2 @ ccmul) @ XC @ ccle)))))))))))).
thf(aimo72b2lem2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccabs) @ XC @ ccle)) @ (^ [Xz:$i] : ccr))) => (cwi @ Xph @ (cwbr @ (ccsup @ (ccima @ ccabs @ (ccima @ XF @ ccr)) @ ccr @ cclt) @ XC @ ccle))))))))).
...
thf(aimo72b2lem0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((! [Xy1:$i] : (cwi @ Xph @ (cwf @ ccr @ ccr @ (XG @ Xy1)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1) @ ccr))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xy1) @ ccr))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (cco @ (XA2 @ Xy1) @ (XB2 @ Xy1) @ ccaddc) @ XF) @ (ccfv @ (cco @ (XA2 @ Xy1) @ (XB2 @ Xy1) @ ccmin) @ XF) @ ccaddc) @ (cco @ cc2 @ (cco @ (ccfv @ (XA2 @ Xy1) @ XF) @ (ccfv @ (XB2 @ Xy1) @ (XG @ Xy1)) @ ccmul) @ ccmul)))) => ((cwi @ Xph @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ cc1 @ ccle)) @ (^ [Xy1:$i] : ccr))) => (! [Xy1:$i] : (cwi @ Xph @ (cwbr @ (cco @ (ccfv @ (ccfv @ (XA2 @ Xy1) @ XF) @ ccabs) @ (ccfv @ (ccfv @ (XB2 @ Xy1) @ (XG @ Xy1)) @ ccabs) @ ccmul) @ (ccsup @ (ccima @ ccabs @ (ccima @ XF @ ccr)) @ ccr @ cclt) @ ccle))))))))))))))).
...
thf(arspcdvinvd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwb @ (Xps @ Xx3) @ Xch))) => ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2))) => (cwi @ Xph @ Xch)))))))))).
...
thf(aimo72b2lem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0)) @ (^ [Xx3:$i] : ccr))) => ((cwi @ Xph @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ cc1 @ ccle)) @ (^ [Xy1:$i] : ccr))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccsup @ (ccima @ ccabs @ (ccima @ XF @ ccr)) @ ccr @ cclt) @ cclt)))))))).
...
thf(cimo72b2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwi @ Xph @ (cwf @ ccr @ ccr @ XG)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (cco @ (ccfv @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ ccaddc) @ XF) @ (ccfv @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ ccmin) @ XF) @ ccaddc) @ (cco @ cc2 @ (cco @ (ccfv @ (ccv @ Xu) @ XF) @ (ccfv @ (ccv @ Xv) @ XG) @ ccmul) @ ccmul))) @ (^ [Xv:$i] : ccr))) @ (^ [Xu:$i] : ccr))) => ((cwi @ Xph @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ cc1 @ ccle)) @ (^ [Xy1:$i] : ccr))) => ((cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0)) @ (^ [Xx3:$i] : ccr))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccfv @ XB2 @ XG) @ ccabs) @ cc1 @ ccle))))))))))))).
