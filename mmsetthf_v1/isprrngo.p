...
thf(adf_prrngo_ax,axiom,(cwceq @ ccprrng @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccsn @ (ccfv @ (ccfv @ (ccv @ Xr) @ cc1st) @ ccgi)) @ (ccfv @ (ccv @ Xr) @ ccpridl))) @ (^ [Xr:$i] : ccrngo)))).
thf(cisprrngo_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => (cwb @ (cwcel @ XR @ ccprrng) @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwcel @ (ccsn @ XZ) @ (ccfv @ XR @ ccpridl)))))))))).
