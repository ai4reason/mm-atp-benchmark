...
thf(aleopmuli_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XT @ ccho)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ cch0o @ XT @ ccleo))) @ (cwbr @ cch0o @ (cco @ XA2 @ XT @ cchot) @ ccleo))))).
...
thf(cleopmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XT @ ccho) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwb @ (cwbr @ cch0o @ XT @ ccleo) @ (cwbr @ cch0o @ (cco @ XA2 @ XT @ cchot) @ ccleo)))))).
