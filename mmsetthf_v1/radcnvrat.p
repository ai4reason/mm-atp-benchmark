...
thf(ansyld_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwn @ Xch))) => ((cwi @ Xph @ (cwi @ Xta @ Xch)) => (cwi @ Xph @ (cwi @ Xps @ (cwn @ Xta)))))))))).
...
thf(aclimge0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ ccli)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => (cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle))))))))))))).
...
thf(acvgdvgrat_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwceq @ XW @ (ccfv @ XN @ ccuz)) => ((cwi @ Xph @ (cwcel @ XN @ XZ)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XW)) @ (cwne @ (ccfv @ (ccv @ Xk) @ XF) @ ccc0))) => ((cwceq @ XR @ (ccmpt @ (^ [Xk:$i] : XW) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xk) @ XF) @ ccdiv) @ ccabs)))) => ((cwi @ Xph @ (cwbr @ XR @ XL @ ccli)) => ((cwi @ Xph @ (cwne @ XL @ cc1)) => (cwi @ Xph @ (cwb @ (cwbr @ XL @ cc1 @ cclt) @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))))))))))))))))))))))).
