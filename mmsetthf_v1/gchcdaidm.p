...
thf(agchcda1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ XA2 @ ccen)))).
...
thf(agchinf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwbr @ ccom @ XA2 @ ccdom)))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(apwcdandom_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwn @ (cwbr @ (ccpw @ XA2) @ (cco @ XA2 @ XA2 @ cccda) @ ccdom))))).
...
thf(cgchcdaidm_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccgch) @ (cwn @ (cwcel @ XA2 @ ccfn))) @ (cwbr @ (cco @ XA2 @ XA2 @ cccda) @ XA2 @ ccen)))).
