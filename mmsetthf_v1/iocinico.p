...
thf(ciocinico_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XB2 @ XC @ cclt))) @ (cwceq @ (ccin @ (cco @ XA2 @ XB2 @ ccioc) @ (cco @ XB2 @ XC @ ccico)) @ (ccsn @ XB2))))))).
