...
thf(cfsng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD)) @ (cwb @ (cwf @ (ccsn @ XA2) @ (ccsn @ XB2) @ XF) @ (cwceq @ XF @ (ccsn @ (ccop @ XA2 @ XB2))))))))))).
