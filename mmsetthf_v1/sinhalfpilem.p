...
thf(altnsymi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (cwi @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwn @ (cwbr @ XB2 @ XA2 @ cclt)))))))).
...
thf(asqeqori_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (cwb @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp)) @ (cwo @ (cwceq @ XA2 @ XB2) @ (cwceq @ XA2 @ (ccneg @ XB2))))))))).
thf(ccnr_tp,type,(ccnr : ($i > $o))).
thf(cc0r_tp,type,(cc0r : ($i > $o))).
thf(cc1r_tp,type,(cc1r : ($i > $o))).
thf(aax_1cn_thm,axiom,(cwcel @ cc1 @ ccc)).
thf(csinhalfpilem_conj,conjecture,(cwa @ (cwceq @ (ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ ccsin) @ cc1) @ (cwceq @ (ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ cccos) @ ccc0))).
