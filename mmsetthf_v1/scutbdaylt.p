...
thf(cscutbdaylt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ ccsur) @ (cwa @ (cwbr @ XA2 @ (ccsn @ XX) @ ccsslt) @ (cwbr @ (ccsn @ XX) @ XB2 @ ccsslt)) @ (cwne @ XX @ (cco @ XA2 @ XB2 @ ccscut))) @ (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccscut) @ ccbday) @ (ccfv @ XX @ ccbday))))))).
