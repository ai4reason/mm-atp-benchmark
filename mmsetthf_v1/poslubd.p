...
thf(aposlubmo_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => (cwi @ (cwa @ (cwcel @ XK @ ccpo) @ (cwss @ XS @ XB2)) @ (cwrmo @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_le)) @ (^ [Xy1:$i] : XS)) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_le)) @ (^ [Xy1:$i] : XS)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le))) @ (^ [Xz:$i] : XB2)))) @ (^ [Xx3:$i] : XB2)))))))))).
...
thf(cposlubd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XU @ (ccfv @ XK @ cclub)) => ((cwi @ Xph @ (cwcel @ XK @ ccpo)) => ((cwi @ Xph @ (cwss @ XS @ XB2)) => ((cwi @ Xph @ (cwcel @ XT @ XB2)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwbr @ (ccv @ Xx3) @ XT @ Xc_le))) => ((! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xx3:$i] : XS))) @ (cwbr @ XT @ (ccv @ Xy1) @ Xc_le))) => (cwi @ Xph @ (cwceq @ (ccfv @ XS @ XU) @ XT)))))))))))))))))).
