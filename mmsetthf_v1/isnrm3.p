...
thf(anrmsep_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccnrm) @ (cw3a @ (cwcel @ XC @ (ccfv @ XJ @ cccld)) @ (cwcel @ XD @ (ccfv @ XJ @ cccld)) @ (cwceq @ (ccin @ XC @ XD) @ cc0))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwss @ XC @ (ccv @ Xx3)) @ (cwss @ XD @ (ccv @ Xy1)) @ (cwceq @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))).
...
thf(aisnrm2_thm,axiom,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccnrm) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xd:$i] : (cwi @ (cwceq @ (ccin @ (ccv @ Xc) @ (ccv @ Xd)) @ cc0) @ (cwrex @ (^ [Xo:$i] : (cwa @ (cwss @ (ccv @ Xc) @ (ccv @ Xo)) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xo) @ (ccfv @ XJ @ cccl)) @ (ccv @ Xd)) @ cc0))) @ (^ [Xo:$i] : XJ)))) @ (^ [Xd:$i] : (ccfv @ XJ @ cccld)))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld))))))).
thf(cisnrm3_conj,conjecture,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccnrm) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xd:$i] : (cwi @ (cwceq @ (ccin @ (ccv @ Xc) @ (ccv @ Xd)) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwss @ (ccv @ Xc) @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xd) @ (ccv @ Xy1)) @ (cwceq @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))) @ (^ [Xd:$i] : (ccfv @ XJ @ cccld)))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld))))))).
