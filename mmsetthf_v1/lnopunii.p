...
thf(alnopunilem2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) @ (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)) => ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ cchil)) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ cchil)) => (! [Xx3:$i] : (cwceq @ (cco @ (ccfv @ (XA2 @ Xx3) @ XT) @ (ccfv @ (XB2 @ Xx3) @ XT) @ ccsp) @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccsp))))))))))).
...
thf(clnopunii_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwfo @ cchil @ cchil @ XT) => ((cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) @ (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)) => (cwcel @ XT @ ccuo)))))).
