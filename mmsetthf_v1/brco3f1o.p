...
thf(abrcofffn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwfn @ XC @ XZ)) => ((cwi @ Xph @ (cwf @ XY @ XZ @ XD)) => ((cwi @ Xph @ (cwf @ XX @ XY @ XE)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (cccom @ XC @ (cccom @ XD @ XE)))) => (cwi @ Xph @ (cw3a @ (cwbr @ XA2 @ (ccfv @ XA2 @ XE) @ XE) @ (cwbr @ (ccfv @ XA2 @ XE) @ (ccfv @ (ccfv @ XA2 @ XE) @ XD) @ XD) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XE) @ XD) @ XB2 @ XC))))))))))))))))).
...
thf(cbrco3f1o_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwf1o @ XY @ XZ @ XC)) => ((cwi @ Xph @ (cwf1o @ XX @ XY @ XD)) => ((cwi @ Xph @ (cwf1o @ XW @ XX @ XE)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (cccom @ XC @ (cccom @ XD @ XE)))) => (cwi @ Xph @ (cw3a @ (cwbr @ (ccfv @ XB2 @ (cccnv @ XC)) @ XB2 @ XC) @ (cwbr @ (ccfv @ (ccfv @ XB2 @ (cccnv @ XC)) @ (cccnv @ XD)) @ (ccfv @ XB2 @ (cccnv @ XC)) @ XD) @ (cwbr @ XA2 @ (ccfv @ (ccfv @ XB2 @ (cccnv @ XC)) @ (cccnv @ XD)) @ XE)))))))))))))))))).
