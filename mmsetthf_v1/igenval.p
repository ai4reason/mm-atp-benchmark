...
thf(asyl3an2br_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwb @ Xch @ Xph) => ((cwi @ (cw3a @ Xps @ Xch @ Xth) @ Xta) => (cwi @ (cw3a @ Xps @ Xph @ Xth) @ Xta))))))))).
...
thf(adf_igen_ax,axiom,(cwceq @ ccigen @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrngo)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccpw @ (ccrn @ (ccfv @ (ccv @ Xr) @ cc1st))))) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccint @ (ccrab @ (^ [Xj:$i] : (cwss @ (ccv @ Xs1) @ (ccv @ Xj))) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xr) @ ccidl))))))))).
thf(cigenval_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xj:$i] : (cwceq @ (XG @ Xj) @ (ccfv @ XR @ cc1st))) => ((! [Xj:$i] : (cwceq @ XX @ (ccrn @ (XG @ Xj)))) => (cwi @ (cwa @ (cwcel @ XR @ ccrngo) @ (cwss @ XS @ XX)) @ (cwceq @ (cco @ XR @ XS @ ccigen) @ (ccint @ (ccrab @ (^ [Xj:$i] : (cwss @ XS @ (ccv @ Xj))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))))))))))).
