...
thf(cdibelval3_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xg1:$i] : (cwceq @ (XB2 @ Xg1) @ (ccfv @ XK @ ccbs))) => ((! [Xg1:$i] : (cwceq @ (Xc_le @ Xg1) @ (ccfv @ XK @ ccple))) => ((! [Xg1:$i] : (cwceq @ (XH @ Xg1) @ (ccfv @ XK @ cclh))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XR @ Xf1 @ Xg1) @ (ccfv @ XW @ (ccfv @ XK @ cctrl))))) => ((! [Xg1:$i] : (cwceq @ (Xc_0 @ Xg1) @ (ccmpt @ (^ [Xg1:$i] : XT) @ (^ [Xg1:$i] : (ccres @ ccid @ (XB2 @ Xg1)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XI @ Xf1 @ Xg1) @ (ccfv @ XW @ (ccfv @ XK @ ccdib))))) => (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ (XV @ Xg1)) @ (cwcel @ XW @ (XH @ Xg1))) @ (cwa @ (cwcel @ (XX @ Xg1) @ (XB2 @ Xg1)) @ (cwbr @ (XX @ Xg1) @ XW @ (Xc_le @ Xg1)))) @ (cwb @ (cwcel @ (XY @ Xg1) @ (ccfv @ (XX @ Xg1) @ (XI @ Xf1 @ Xg1))) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwceq @ (XY @ Xg1) @ (ccop @ (ccv @ Xf1) @ (Xc_0 @ Xg1))) @ (cwbr @ (ccfv @ (ccv @ Xf1) @ (XR @ Xf1 @ Xg1)) @ (XX @ Xg1) @ (Xc_le @ Xg1)))) @ (^ [Xf1:$i] : XT)))))))))))))))))))))))))).
