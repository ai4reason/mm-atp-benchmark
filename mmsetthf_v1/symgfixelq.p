...
thf(csymgfixelq_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xq:$i] : (cwceq @ XP @ (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : (cwceq @ (XQ @ Xq) @ (ccrab @ (^ [Xq:$i] : (cwceq @ (ccfv @ XK @ (ccv @ Xq)) @ XK)) @ (^ [Xq:$i] : XP)))) => (! [Xq:$i] : (cwi @ (cwcel @ (XF @ Xq) @ (XV @ Xq)) @ (cwb @ (cwcel @ (XF @ Xq) @ (XQ @ Xq)) @ (cwa @ (cwf1o @ (XN @ Xq) @ (XN @ Xq) @ (XF @ Xq)) @ (cwceq @ (ccfv @ XK @ (XF @ Xq)) @ XK)))))))))))))).
