...
thf(celwlim_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XX @ (ccwlim @ XA2 @ XR)) @ (cw3a @ (cwcel @ XX @ XA2) @ (cwne @ XX @ (ccinf @ XA2 @ XA2 @ XR)) @ (cwceq @ XX @ (ccsup @ (ccpred @ XA2 @ XR @ XX) @ XA2 @ XR)))))))).
