...
thf(crencldnfilem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwa @ (cwne @ XA2 @ cc0) @ (cwn @ (cwcel @ XB2 @ XA2)))) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XB2 @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccrp))) @ (cwn @ (cwcel @ XA2 @ ccfn)))))).
