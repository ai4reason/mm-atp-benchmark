...
thf(alsatlss_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => (cwi @ (cwcel @ XW @ cclmod) @ (cwss @ XA2 @ XS)))))))).
...
thf(aunimax_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwceq @ (ccuni @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XB2))) @ XA2))))).
...
thf(alssats_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XS @ (ccfv @ (XW @ Xx3) @ cclss))) => ((! [Xx3:$i] : (cwceq @ XN @ (ccfv @ (XW @ Xx3) @ cclspn))) => ((! [Xx3:$i] : (cwceq @ XA2 @ (ccfv @ (XW @ Xx3) @ cclsa))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XW @ Xx3) @ cclmod) @ (cwcel @ XU @ XS)) @ (cwceq @ XU @ (ccfv @ (ccuni @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XU)) @ (^ [Xx3:$i] : XA2))) @ XN))))))))))))).
thf(adfrex2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwn @ (cwral @ (^ [Xx3:$i] : (cwn @ (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
thf(clssat_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XS) @ (cwcel @ XV @ XS)) @ (cwpss @ XU @ XV)) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwss @ (ccv @ Xp) @ XV) @ (cwn @ (cwss @ (ccv @ Xp) @ XU)))) @ (^ [Xp:$i] : XA2))))))))))).
