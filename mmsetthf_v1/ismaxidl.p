...
thf(amaxidlval_thm,axiom,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XG @ Xi @ Xj) @ (ccfv @ XR @ cc1st)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XX @ Xi @ Xj) @ (ccrn @ (XG @ Xi @ Xj))))) => (! [Xj:$i] : (cwi @ (cwcel @ XR @ ccrngo) @ (cwceq @ (ccfv @ XR @ ccmaxidl) @ (ccrab @ (^ [Xi:$i] : (cwa @ (cwne @ (ccv @ Xi) @ (XX @ Xi @ Xj)) @ (cwral @ (^ [Xj:$i] : (cwi @ (cwss @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwo @ (cwceq @ (ccv @ Xj) @ (ccv @ Xi)) @ (cwceq @ (ccv @ Xj) @ (XX @ Xi @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ XR @ ccidl)))))))))))).
...
thf(cismaxidl_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xj:$i] : (cwceq @ (XG @ Xj) @ (ccfv @ XR @ cc1st))) => ((! [Xj:$i] : (cwceq @ (XX @ Xj) @ (ccrn @ (XG @ Xj)))) => (! [Xj:$i] : (cwi @ (cwcel @ XR @ ccrngo) @ (cwb @ (cwcel @ XM @ (ccfv @ XR @ ccmaxidl)) @ (cw3a @ (cwcel @ XM @ (ccfv @ XR @ ccidl)) @ (cwne @ XM @ (XX @ Xj)) @ (cwral @ (^ [Xj:$i] : (cwi @ (cwss @ XM @ (ccv @ Xj)) @ (cwo @ (cwceq @ (ccv @ Xj) @ XM) @ (cwceq @ (ccv @ Xj) @ (XX @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl)))))))))))))).
