...
thf(asalpreimaltle_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xa:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xa)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xa:$i] : (Xph @ Xx3 @ Xa)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XS @ Xx3) @ ccsalg)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xa) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccxr)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xa) @ (cwcel @ (ccv @ Xa) @ ccr)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xa) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (XS @ Xx3))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ XC @ ccr)))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ XC @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (XS @ Xx3))))))))))))))))).
...
thf(auniexd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => (cwi @ Xph @ (cwcel @ (ccuni @ XA2) @ ccvv))))))).
...
thf(aissmflelem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((! [Xa:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xa)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xa:$i] : (Xph @ Xx3 @ Xa)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ XS @ ccsalg)))) => ((cwceq @ XD @ (ccdm @ XF)) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwss @ XD @ (ccuni @ XS))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwf @ XD @ ccr @ XF)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xa) @ (cwcel @ (ccv @ Xa) @ ccr)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xa) @ ccle)) @ (^ [Xx3:$i] : XD)) @ (cco @ XS @ XD @ ccrest))))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))))))))))))))))).
...
thf(cissmfle_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XS @ Xx3) @ ccsalg)))) => ((cwceq @ XD @ (ccdm @ XF)) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwb @ (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccsmblfn)) @ (cw3a @ (cwss @ XD @ (ccuni @ (XS @ Xx3))) @ (cwf @ XD @ ccr @ XF) @ (cwral @ (^ [Xa:$i] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xa) @ ccle)) @ (^ [Xx3:$i] : XD)) @ (cco @ (XS @ Xx3) @ XD @ ccrest))) @ (^ [Xa:$i] : ccr)))))))))))))).
