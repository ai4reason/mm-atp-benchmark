...
thf(anatffn_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ XC @ XD @ ccnat)) => (cwfn @ XN @ (ccxp @ (cco @ XC @ XD @ ccfunc) @ (cco @ XC @ XD @ ccfunc)))))))).
...
thf(cfuchom_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (cco @ XC @ XD @ ccfuc)) => ((cwceq @ XN @ (cco @ XC @ XD @ ccnat)) => (cwceq @ XN @ (ccfv @ XQ @ cchom))))))))).
