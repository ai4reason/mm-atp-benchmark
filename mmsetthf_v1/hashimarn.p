...
thf(chashimarn_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwf1 @ (ccdm @ XE) @ (ccrn @ XE) @ XE) @ (cwcel @ XE @ XV)) @ (cwi @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ XF) @ (cwceq @ (ccfv @ (ccima @ XE @ (ccrn @ XF)) @ cchash) @ (ccfv @ XF @ cchash)))))))).
