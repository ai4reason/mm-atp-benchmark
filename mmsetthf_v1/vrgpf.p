...
thf(cvrgpf_conj,conjecture,(! [Xc_sm:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_sm @ (ccfv @ XI @ ccefg)) => ((cwceq @ XU @ (ccfv @ XI @ ccvrgp)) => ((cwceq @ XG @ (ccfv @ XI @ ccfrgp)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cwcel @ XI @ XV) @ (cwf @ XI @ XX @ XU))))))))))))).
