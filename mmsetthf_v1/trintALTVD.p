...
thf(ae323_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwvd3 @ Xph @ Xps @ Xch @ Xth) => ((cwvd2 @ Xph @ Xps @ Xta) => ((cwvd3 @ Xph @ Xps @ Xch @ Xet) => ((cwi @ Xth @ (cwi @ Xta @ (cwi @ Xet @ Xze))) => (cwvd3 @ Xph @ Xps @ Xch @ Xze))))))))))))).
...
thf(ae31_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwvd3 @ Xph @ Xps @ Xch @ Xth) => ((cwvd1 @ Xph @ Xta) => ((cwi @ Xth @ (cwi @ Xta @ Xet)) => (cwvd3 @ Xph @ Xps @ Xch @ Xet))))))))))).
...
thf(atrsbc_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwb @ (cwsbc @ (^ [Xx3:$i] : (cwtr @ (ccv @ Xx3))) @ XA2) @ (cwtr @ XA2))))))).
...
thf(ctrintALTVD_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwtr @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwtr @ (ccint @ XA2))))).
