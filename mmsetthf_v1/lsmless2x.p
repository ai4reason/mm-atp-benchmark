...
thf(clsmless2x_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ XV) @ (cwss @ XR @ XB2) @ (cwss @ XU @ XB2)) @ (cwss @ XT @ XU)) @ (cwss @ (cco @ XR @ XT @ Xc_po) @ (cco @ XR @ XU @ Xc_po))))))))))))).
