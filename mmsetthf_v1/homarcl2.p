...
thf(chomarcl2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XC @ cchoma)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => (cwi @ (cwcel @ XF @ (cco @ XX @ XY @ XH)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)))))))))))).
