...
thf(aissubmd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (cwceq @ XB2 @ (ccfv @ (XM @ Xz) @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1) @ (ccfv @ (XM @ Xz) @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1) @ (ccfv @ (XM @ Xz) @ cc0g))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XM @ Xz) @ ccmnd))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (Xch @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwa @ (Xth @ Xx3 @ Xy1) @ (Xta @ Xx3 @ Xy1)))) @ (Xet @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (Xc_0 @ Xx3 @ Xy1)) @ (cwb @ (Xps @ Xz) @ (Xch @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwb @ (Xps @ Xz) @ (Xth @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwb @ (Xps @ Xz) @ (Xta @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1))) @ (cwb @ (Xps @ Xz) @ (Xet @ Xx3 @ Xy1)))))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (ccrab @ (^ [Xz:$i] : (Xps @ Xz)) @ (^ [Xz:$i] : XB2)) @ (ccfv @ (XM @ Xz) @ ccsubmnd))))))))))))))))))))))))).
...
thf(cmrcmndind_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xps @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl)) @ (cwb @ (Xps @ Xx3) @ (Xth @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (Xc_0 @ Xy1 @ Xz)) @ (cwb @ (Xps @ Xx3) @ (Xta @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xz)) @ (cwb @ (Xps @ Xx3) @ (Xet @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (Xc_0 @ Xy1 @ Xz) @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ cc0g))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ Xc_pl @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xy1 @ Xz) @ ccmnd))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwss @ (XG @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XG @ Xx3) @ (ccfv @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccsubmnd) @ ccmrc))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (Xta @ Xy1 @ Xz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cw3a @ Xph @ (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3)) @ (cwcel @ (ccv @ Xz) @ (XG @ Xx3))) @ (Xch @ Xy1)) @ (Xth @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xx3)))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (Xet @ Xy1 @ Xz)))))))))))))))))))))))))))))).
