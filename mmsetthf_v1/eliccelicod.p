...
thf(aeliccxr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccicc)) @ (cwcel @ XA2 @ ccxr)))))).
...
thf(celiccelicod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwne @ XC @ XB2)) => (cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)))))))))))).
