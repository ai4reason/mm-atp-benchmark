...
thf(ccncfco_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XB2 @ XC @ cccncf))) => (cwi @ Xph @ (cwcel @ (cccom @ XG @ XF) @ (cco @ XA2 @ XC @ cccncf)))))))))))).
