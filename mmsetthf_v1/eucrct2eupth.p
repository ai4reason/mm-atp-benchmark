...
thf(acrctcshlem1_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts))) => ((cwceq @ XN @ (ccfv @ XF @ cchash)) => (cwi @ Xph @ (cwcel @ XN @ ccn0)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(afz0sn0fz1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ ccc0 @ XN @ ccfz) @ (ccun @ (ccsn @ ccc0) @ (cco @ cc1 @ XN @ ccfz)))))).
...
thf(annnle0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwn @ (cwbr @ XA2 @ ccc0 @ ccle))))).
...
thf(acshimadifsn0_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccword @ XS)) @ (cwceq @ XN @ (ccfv @ XF @ cchash)) @ (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo))) @ (cwceq @ (ccima @ XF @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ))) @ (ccima @ (cco @ XF @ (cco @ XJ @ cc1 @ ccaddc) @ cccsh) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))))))))).
...
thf(aeucrctshift_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ (XG @ Xx3) @ cccrcts)))) => ((cwceq @ XN @ (ccfv @ XF @ cchash)) => ((cwi @ Xph @ (cwcel @ XS @ (cco @ ccc0 @ XN @ ccfzo))) => ((cwceq @ XH @ (cco @ XF @ XS @ cccsh)) => ((! [Xx3:$i] : (cwceq @ (XQ @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP)))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ (XG @ Xx3) @ cceupth)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwa @ (cwbr @ XH @ (XQ @ Xx3) @ (ccfv @ (XG @ Xx3) @ cceupth)) @ (cwbr @ XH @ (XQ @ Xx3) @ (ccfv @ (XG @ Xx3) @ cccrcts)))))))))))))))))))))))).
...
thf(ceucrct2eupth_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ (XG @ Xx3) @ cceupth)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ (XG @ Xx3) @ cccrcts)))) => ((! [Xx3:$i] : (cwceq @ (ccfv @ (XS @ Xx3) @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ XN @ (ccfv @ XF @ cchash))) => ((cwi @ Xph @ (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XS @ Xx3) @ cciedg) @ (ccres @ XI @ (ccima @ XF @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ))))))) => ((cwceq @ XK @ (cco @ XJ @ cc1 @ ccaddc)) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccres @ (cco @ XF @ XK @ cccsh) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo)))) => ((! [Xx3:$i] : (cwceq @ (XQ @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XK @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XK @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XK @ ccaddc) @ XN @ ccmin) @ XP)))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwbr @ (XH @ Xx3) @ (XQ @ Xx3) @ (ccfv @ (XS @ Xx3) @ cceupth)))))))))))))))))))))))))))).
