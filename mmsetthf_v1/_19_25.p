...
thf(c_19_25_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (cwi @ (cwal @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1)))))) @ (cwi @ (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))))))))).
