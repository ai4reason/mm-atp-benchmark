...
thf(aprlem2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwb @ (cwo @ (cwa @ Xph @ Xps) @ (cwa @ Xch @ Xth)) @ (cwa @ (cwo @ Xph @ Xch) @ (cwo @ (cwa @ Xph @ Xps) @ (cwa @ Xch @ Xth))))))))).
...
thf(azfrep4_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : ((cwcel @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ ccvv) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (Xps @ Xx3 @ Xy1) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz))))))))) => (cwcel @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3 @ Xy1)))))) @ ccvv)))))).
...
thf(aspimev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwi @ (Xph @ Xy1) @ (Xps @ Xx3 @ Xy1))))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1))))))))).
thf(aalrimdv_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwi @ Xps @ (Xch @ Xx3)))) => (cwi @ Xph @ (cwi @ Xps @ (cwal @ (^ [Xx3:$i] : (Xch @ Xx3)))))))))).
thf(aprlem1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwb @ Xet @ Xch)) => ((cwi @ Xps @ (cwn @ Xth)) => (cwi @ Xph @ (cwi @ Xps @ (cwi @ (cwo @ (cwa @ Xps @ Xch) @ (cwa @ Xth @ Xta)) @ Xet)))))))))))).
thf(aequequ2_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (cwceq @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwceq @ (ccv @ Xz) @ (ccv @ Xy1)))))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(a_0inp0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwceq @ XA2 @ cc0) @ (cwn @ (cwceq @ XA2 @ (ccsn @ cc0)))))).
