...
thf(c_0wlkonlem1_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP) @ (cwceq @ (ccfv @ ccc0 @ XP) @ XN)) @ (cwa @ (cwcel @ XN @ XV) @ (cwcel @ XN @ XV))))))))).
