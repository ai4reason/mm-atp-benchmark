...
thf(cprmpwdvds_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ ccz) @ (cwcel @ XD @ ccz)) @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccn)) @ (cwa @ (cwbr @ XD @ (cco @ XK @ (cco @ XP @ XN @ ccexp) @ ccmul) @ ccdvds) @ (cwn @ (cwbr @ XD @ (cco @ XK @ (cco @ XP @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ ccdvds)))) @ (cwbr @ (cco @ XP @ XN @ ccexp) @ XD @ ccdvds))))))).
