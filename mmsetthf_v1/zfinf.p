...
thf(aax_inf_ax,axiom,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwex @ (^ [Xw:$i] : (cwa @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1))))))))))))).
...
thf(czfinf_conj,conjecture,(! [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3))))))))))))).
