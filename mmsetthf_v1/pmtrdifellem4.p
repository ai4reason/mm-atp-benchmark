...
thf(apmtrdifellem2_thm,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XT @ (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccpmtr))) => ((cwceq @ XR @ (ccrn @ (ccfv @ XN @ ccpmtr))) => ((cwceq @ XS @ (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ XN @ ccpmtr))) => (cwi @ (cwcel @ XQ @ XT) @ (cwceq @ (ccdm @ (ccdif @ XS @ ccid)) @ (ccdm @ (ccdif @ XQ @ ccid)))))))))))))).
thf(cpmtrdifellem4_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XT @ (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccpmtr))) => ((cwceq @ XR @ (ccrn @ (ccfv @ XN @ ccpmtr))) => ((cwceq @ XS @ (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ XN @ ccpmtr))) => (cwi @ (cwa @ (cwcel @ XQ @ XT) @ (cwcel @ XK @ XN)) @ (cwceq @ (ccfv @ XK @ XS) @ XK)))))))))))).
