...
thf(ainfpssrlem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => ((cwi @ Xph @ (cwf1o @ XB2 @ XA2 @ XF)) => ((cwi @ Xph @ (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((cwceq @ XG @ (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => (cwi @ (cw3a @ Xph @ (cwcel @ XM @ ccom) @ (cwcel @ XN @ XM)) @ (cwne @ (ccfv @ XM @ XG) @ (ccfv @ XN @ XG)))))))))))))))).
...
thf(cinfpssrlem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => ((cwi @ Xph @ (cwf1o @ XB2 @ XA2 @ XF)) => ((cwi @ Xph @ (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((cwceq @ XG @ (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => (cwi @ Xph @ (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ ccom @ XA2 @ ccdom))))))))))))))).
