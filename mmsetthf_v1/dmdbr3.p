...
thf(achlejb2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwceq @ (cco @ XB2 @ XA2 @ cchj) @ XB2)))))).
...
thf(cdmdbr3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj) @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
