...
thf(cinitoid_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => (cwi @ (cwa @ Xph @ (cwcel @ XO @ (ccfv @ XC @ ccinito))) @ (cwceq @ (cco @ XO @ XO @ XH) @ (ccsn @ (ccfv @ XO @ (ccfv @ XC @ cccid)))))))))))))).
