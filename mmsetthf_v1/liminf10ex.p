...
thf(aliminfval5_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XA2 @ Xk) @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ (XA2 @ Xk) @ ccxr @ XF))) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ XF @ cclsi) @ (ccsup @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt)))))))))))))).
...
thf(alimsup10exlem_thm,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds) @ ccc0 @ cc1))))) => ((cwi @ Xph @ (cwcel @ XK @ ccr)) => (! [Xn:$i] : (cwi @ Xph @ (cwceq @ (ccima @ (XF @ Xn) @ (cco @ XK @ ccpnf @ ccico)) @ (ccpr @ ccc0 @ cc1)))))))))).
...
thf(ainfpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) @ (cwceq @ (ccinf @ (ccpr @ XB2 @ XC) @ XA2 @ XR) @ (ccif @ (cwbr @ XB2 @ XC @ XR) @ XB2 @ XC)))))))).
...
thf(climinf10ex_conj,conjecture,(! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds) @ ccc0 @ cc1))))) => (! [Xn:$i] : (cwceq @ (ccfv @ (XF @ Xn) @ cclsi) @ ccc0))))).
