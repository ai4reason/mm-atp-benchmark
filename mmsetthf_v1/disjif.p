...
thf(adisji2f_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XY:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XY) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ XY @ XA2)) @ (cwne @ (ccv @ Xx3) @ XY)) @ (cwceq @ (ccin @ (XB2 @ Xx3) @ (XC @ Xx3)) @ cc0)))))))))).
thf(cdisjif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XY) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ XY @ XA2)) @ (cwa @ (cwcel @ (XZ @ Xx3) @ (XB2 @ Xx3)) @ (cwcel @ (XZ @ Xx3) @ (XC @ Xx3)))) @ (cwceq @ (ccv @ Xx3) @ XY))))))))))).
