...
thf(afrege55lem2b_thm,axiom,(! [Xy1:$i] : (! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwsb @ (^ [Xz:$i] : (cwceq @ (ccv @ Xz) @ (ccv @ Xx3))) @ Xy1))))).
...
thf(cfrege55b_conj,conjecture,(! [Xy1:$i] : (! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xx3)))))).
