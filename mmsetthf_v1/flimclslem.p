...
thf(aneindisj_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwa @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) @ (cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))) @ (cwne @ (ccin @ XN @ XS) @ cc0))))))))).
...
thf(asnfbas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ XB2) @ (cwne @ XA2 @ cc0) @ (cwcel @ XB2 @ XV)) @ (cwcel @ (ccsn @ XA2) @ (ccfv @ XB2 @ ccfbas))))))).
...
thf(cflimclslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (cco @ XX @ (ccfv @ (ccun @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ (ccsn @ XS)) @ ccfi) @ ccfg)) => (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XS @ XX) @ (cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))) @ (cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ XS @ XF) @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim))))))))))).
