...
thf(aclsdif_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwceq @ (ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ cccl)) @ (ccdif @ XX @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)))))))))).
...
thf(ctopbnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwceq @ (ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ cccl))) @ (ccdif @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)))))))))).
