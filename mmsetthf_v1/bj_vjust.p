...
thf(abj_sbtv_thm,axiom,(! [Xph:($i > $o)] : (! [Xy1:$i] : ((! [Xx3:$i] : (Xph @ Xx3)) => (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3)) @ Xy1))))).
...
thf(cbj_vjust_conj,conjecture,(cwceq @ (ccab @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (ccab @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xy1)))))).
