...
thf(cresshom_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XD @ (cco @ XC @ XA2 @ ccress)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwceq @ XH @ (ccfv @ XD @ cchom))))))))))).
