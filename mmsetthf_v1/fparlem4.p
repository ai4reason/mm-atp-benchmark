...
thf(acoiun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (cwceq @ (cccom @ XA2 @ (cciun @ (^ [Xx3:$i] : (XC @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (cciun @ (^ [Xx3:$i] : (XC @ Xx3)) @ (^ [Xx3:$i] : (cccom @ XA2 @ (XB2 @ Xx3))))))))).
...
thf(adfco2a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ (ccin @ (ccdm @ XA2) @ (ccrn @ XB2)) @ XC) @ (cwceq @ (cccom @ XA2 @ XB2) @ (cciun @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccxp @ (ccima @ (cccnv @ XB2) @ (ccsn @ (ccv @ Xx3))) @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3)))))))))))).
...
thf(afparlem2_thm,axiom,(! [Xy1:$i] : (cwceq @ (ccima @ (cccnv @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))) @ (ccsn @ (ccv @ Xy1))) @ (ccxp @ ccvv @ (ccsn @ (ccv @ Xy1)))))).
...
thf(cfparlem4_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwfn @ XG @ XB2) @ (cwceq @ (cccom @ (cccnv @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))) @ (cccom @ XG @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv)))) @ (cciun @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ (ccxp @ ccvv @ (ccsn @ (ccv @ Xy1))) @ (ccxp @ ccvv @ (ccsn @ (ccfv @ (ccv @ Xy1) @ XG))))))))))).
