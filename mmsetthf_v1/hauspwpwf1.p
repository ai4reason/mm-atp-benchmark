...
thf(chauspwpwf1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XX @ Xa) @ (ccuni @ XJ))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xa:$i] : (cwceq @ (XF @ Xx3 @ Xj @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccfv @ XJ @ cccl))) @ (^ [Xx3:$i] : (ccab @ (^ [Xa:$i] : (cwrex @ (^ [Xj:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xj)) @ (cwceq @ (ccv @ Xa) @ (ccin @ (ccv @ Xj) @ XA2)))) @ (^ [Xj:$i] : XJ)))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwcel @ XJ @ ccha) @ (cwss @ XA2 @ (XX @ Xa))) @ (cwf1 @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccpw @ (ccpw @ XA2)) @ (XF @ Xx3 @ Xj @ Xa))))))))))))).
