...
thf(aprssspr_thm,axiom,(! [XP:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwss @ (XP @ Xa @ Xb) @ (ccfv @ XV @ ccspr)) @ (cwcel @ XX @ (XP @ Xa @ Xb))) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ XX @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
...
thf(csprsymrelf1lem_conj,conjecture,(! [XV:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xb:$i] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwss @ (ccv @ Xa) @ (ccfv @ (XV @ Xx3 @ Xy1) @ ccspr)) @ (cwss @ (ccv @ Xb) @ (ccfv @ (XV @ Xx3 @ Xy1) @ ccspr))) @ (cwi @ (cwceq @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xc:$i] : (cwceq @ (ccv @ Xc) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xc:$i] : (ccv @ Xa)))))) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xc:$i] : (cwceq @ (ccv @ Xc) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xc:$i] : (ccv @ Xb))))))) @ (cwss @ (ccv @ Xa) @ (ccv @ Xb)))))))))).
