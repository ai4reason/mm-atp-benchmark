...
thf(aecase3d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xth)) => ((cwi @ Xph @ (cwi @ Xch @ Xth)) => ((cwi @ Xph @ (cwi @ (cwn @ (cwo @ Xps @ Xch)) @ Xth)) => (cwi @ Xph @ Xth))))))))).
...
thf(agenpprecl_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ (ccmpt2 @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : ccnp)) @ (^ [Xw:$i] : (^ [Xv:$i] : (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccv @ Xw)))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xy1) @ ccnq) @ (cwcel @ (ccv @ Xz) @ ccnq)) @ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ ccnq)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xw @ Xv) @ ccnp) @ (cwcel @ (XB2 @ Xw @ Xv) @ ccnp)) @ (cwi @ (cwa @ (cwcel @ (XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ (XA2 @ Xw @ Xv)) @ (cwcel @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ (XB2 @ Xw @ Xv))) @ (cwcel @ (cco @ (XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv) @ XG) @ (cco @ (XA2 @ Xw @ Xv) @ (XB2 @ Xw @ Xv) @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv))))))))))))))))))).
...
thf(cdistrlem4pr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp) @ (cwcel @ XC @ ccnp)) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwa @ (cwcel @ (ccv @ Xf1) @ XA2) @ (cwcel @ (ccv @ Xz) @ XC)))) @ (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmq) @ (cco @ (ccv @ Xf1) @ (ccv @ Xz) @ ccmq) @ ccplq) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccpp) @ ccmp))))))))))).
