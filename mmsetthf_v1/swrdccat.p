...
thf(aswrdlend_thm,axiom,(! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XF @ ccz) @ (cwcel @ XL @ ccz)) @ (cwi @ (cwbr @ XL @ XF @ ccle) @ (cwceq @ (cco @ XW @ (ccop @ XF @ XL) @ ccsubstr) @ cc0)))))))).
