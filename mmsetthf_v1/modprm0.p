...
thf(areumodprminv_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ (cco @ cc1 @ XP @ ccfzo))) @ (cwreu @ (^ [Xi:$i] : (cwceq @ (cco @ (cco @ XN @ (ccv @ Xi) @ ccmul) @ XP @ ccmo) @ cc1)) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))))))).
...
thf(amodaddmulmod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccz)) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ (cco @ XB2 @ XM @ ccmo) @ XC @ ccmul) @ ccaddc) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccaddc) @ XM @ ccmo)))))))).
...
thf(amodmulmod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XM @ ccmo) @ XB2 @ ccmul) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XM @ ccmo))))))).
...
thf(amodadd2mod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ XB2 @ (cco @ XA2 @ XM @ ccmo) @ ccaddc) @ XM @ ccmo) @ (cco @ (cco @ XB2 @ XA2 @ ccaddc) @ XM @ ccmo))))))).
...
thf(cmodprm0_conj,conjecture,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ (cco @ cc1 @ XP @ ccfzo)) @ (cwcel @ XI @ (cco @ cc1 @ XP @ ccfzo))) @ (cwrex @ (^ [Xj:$i] : (cwceq @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XN @ ccmul) @ ccaddc) @ XP @ ccmo) @ ccc0)) @ (^ [Xj:$i] : (cco @ ccc0 @ XP @ ccfzo)))))))).
