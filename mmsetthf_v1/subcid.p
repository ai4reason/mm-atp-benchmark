...
thf(csubcid_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (cco @ XC @ XJ @ ccresc)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XC @ ccsubc))) => ((cwi @ Xph @ (cwfn @ XJ @ (ccxp @ XS @ XS))) => ((cwceq @ Xc_1 @ (ccfv @ XC @ cccid)) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ Xc_1) @ (ccfv @ XX @ (ccfv @ XD @ cccid))))))))))))))))).
