...
thf(cocvi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XS @ Xc_pe)) @ (cwcel @ XB2 @ XS)) @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_xi) @ Xc_0))))))))))))))))).
