...
thf(aleabs_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccle)))).
...
thf(aabsor_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwo @ (cwceq @ (ccfv @ XA2 @ ccabs) @ XA2) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ (ccneg @ XA2)))))).
thf(aancomsd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwi @ (cwa @ Xps @ Xch) @ Xth)) => (cwi @ Xph @ (cwi @ (cwa @ Xch @ Xps) @ Xth)))))))).
thf(ajaoa_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xth @ (cwi @ Xta @ Xch)) => (cwi @ (cwo @ Xph @ Xth) @ (cwi @ (cwa @ Xps @ Xta) @ Xch)))))))))).
...
thf(alenegcon1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccneg @ XA2) @ XB2 @ ccle) @ (cwbr @ (ccneg @ XB2) @ XA2 @ ccle)))))).
thf(cabsle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccle) @ (cwa @ (cwbr @ (ccneg @ XB2) @ XA2 @ ccle) @ (cwbr @ XA2 @ XB2 @ ccle))))))).
