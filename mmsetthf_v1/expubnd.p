...
thf(cexpubnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ cc2 @ XA2 @ ccle)) @ (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ (cco @ cc2 @ XN @ ccexp) @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccexp) @ ccmul) @ ccle))))).
