...
thf(acopco_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc1 @ XF) @ (ccfv @ ccc0 @ XG))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XJ @ XK @ cccn))) => (cwi @ Xph @ (cwceq @ (cccom @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) @ (cco @ (cccom @ XH @ XF) @ (cccom @ XH @ XG) @ (ccfv @ XK @ ccpco))))))))))))))).
...
thf(cpi1coghm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwceq @ XP @ (cco @ XJ @ XA2 @ ccpi1)) => ((! [Xg1:$i] : (cwceq @ XQ @ (cco @ XK @ (XB2 @ Xg1) @ ccpi1))) => ((cwceq @ XV @ (ccfv @ XP @ ccbs)) => ((! [Xg1:$i] : (cwceq @ (XG @ Xg1) @ (ccrn @ (ccmpt @ (^ [Xg1:$i] : (ccuni @ XV)) @ (^ [Xg1:$i] : (ccop @ (ccec @ (ccv @ Xg1) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cccom @ XF @ (ccv @ Xg1)) @ (ccfv @ XK @ ccphtpc)))))))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XJ @ (ccfv @ (XX @ Xg1) @ cctopon)))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XX @ Xg1)))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ (XB2 @ Xg1)))) => (! [Xg1:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xg1) @ (cco @ XP @ XQ @ ccghm)))))))))))))))))))))))).
