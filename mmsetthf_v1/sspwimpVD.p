...
thf(aun0_1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwvd1 @ cwtru @ Xph) => ((cwvd1 @ Xps @ Xch) => ((cwvd1 @ (cwvhc2 @ cwtru @ Xps) @ Xth) => (cwvd1 @ Xps @ Xth))))))))).
...
thf(csspwimpVD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccpw @ XA2) @ (ccpw @ XB2)))))).
