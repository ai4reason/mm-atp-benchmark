...
thf(asetsidvald_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XE @ (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwfun @ XS)) => ((cwi @ Xph @ (cwcel @ (ccfv @ ccnx @ XE) @ (ccdm @ XS))) => (cwi @ Xph @ (cwceq @ XS @ (cco @ XS @ (ccop @ (ccfv @ ccnx @ XE) @ (ccfv @ XS @ XE)) @ ccsts)))))))))))))).
