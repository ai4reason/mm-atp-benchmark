...
thf(cax8dfeq_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwex @ (^ [Xz:$i] : (cwi @ (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))) @ (cwi @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))))))))).
