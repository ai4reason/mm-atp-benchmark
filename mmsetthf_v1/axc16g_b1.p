...
thf(aaevlem_b2_thm,axiom,(! [Xy1:$i] : (! [Xt:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwal @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (ccv @ Xt)))))))).
...
thf(caxc16g_b1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (cwi @ (Xph @ Xx3 @ Xy1) @ (cwal @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))))))).
