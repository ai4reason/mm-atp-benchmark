...
thf(cmccl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xk) @ (cco @ ccn0 @ XA2 @ ccmap)))) => (cwi @ Xph @ (cwcel @ (cco @ (ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)))) @ ccfa) @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccfa))) @ ccdiv) @ ccn))))))))).
