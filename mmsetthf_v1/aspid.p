...
thf(caspid_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ ccasp)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => (cwi @ (cw3a @ (cwcel @ XW @ ccasa) @ (cwcel @ XS @ (ccfv @ XW @ ccsubrg)) @ (cwcel @ XS @ XL)) @ (cwceq @ (ccfv @ XS @ XA2) @ XS))))))))))).
