...
thf(ahashgval2_thm,axiom,(cwceq @ (ccres @ cchash @ ccom) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccsuc_tp,type,(ccsuc : (($i > $o) > ($i > $o)))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(aackbij1_thm,axiom,(! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwf1o @ (ccin @ (ccpw @ ccom) @ ccfn) @ ccom @ XF)))).
...
thf(af1opwfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwf1o @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccin @ (ccpw @ XB2) @ ccfn) @ (ccmpt @ (^ [Xb:$i] : (ccin @ (ccpw @ XA2) @ ccfn)) @ (^ [Xb:$i] : (ccima @ XF @ (ccv @ Xb)))))))))).
...
thf(admhashres_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccdm @ (ccres @ cchash @ XA2)) @ XA2))).
...
thf(ahashpw_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwceq @ (ccfv @ (ccpw @ XA2) @ cchash) @ (cco @ cc2 @ (ccfv @ XA2 @ cchash) @ ccexp))))).
...
thf(cackbijnn_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccn0) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (cco @ cc2 @ (ccv @ Xy1) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwf1o @ (ccin @ (ccpw @ ccn0) @ ccfn) @ ccn0 @ (XF @ Xx3 @ Xy1))))))).
