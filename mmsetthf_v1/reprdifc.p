...
thf(adifrab2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwceq @ (ccdif @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))).
...
thf(creprdifc_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xc:$i] : (cwceq @ (XC @ Xx3 @ Xc) @ (ccrab @ (^ [Xc:$i] : (cwn @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xc)) @ XB2))) @ (^ [Xc:$i] : (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))))))) => ((! [Xc:$i] : (cwi @ (Xph @ Xc) @ (cwss @ XA2 @ ccn))) => ((! [Xc:$i] : (cwi @ (Xph @ Xc) @ (cwss @ XB2 @ ccn))) => ((! [Xc:$i] : (cwi @ (Xph @ Xc) @ (cwcel @ XM @ ccn0))) => ((! [Xc:$i] : (cwi @ (Xph @ Xc) @ (cwcel @ XS @ ccn0))) => (! [Xc:$i] : (cwi @ (Xph @ Xc) @ (cwceq @ (ccdif @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ (cco @ XB2 @ XM @ (ccfv @ XS @ ccrepr))) @ (cciun @ (^ [Xx3:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xc)))))))))))))))))).
