...
thf(cfsum0diaglem_conj,conjecture,(! [Xj:$i] : (! [Xk:$i] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ (cco @ XN @ (ccv @ Xj) @ ccmin) @ ccfz))) @ (cwa @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ ccfz)))))))).
