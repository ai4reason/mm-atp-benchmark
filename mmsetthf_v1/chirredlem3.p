...
thf(achirredlem2_thm,axiom,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccat) @ (cwss @ (ccv @ Xp) @ XA2)) @ (cwa @ (cwcel @ (ccv @ Xq) @ ccch) @ (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xr) @ ccat) @ (cwss @ (ccv @ Xr) @ XA2)) @ (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xr) @ ccort) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)) @ (ccv @ Xq))))))))).
...
thf(aorthin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh)) @ (cwi @ (cwss @ XA2 @ (ccfv @ XB2 @ ccort)) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0h)))))).
...
thf(cchirredlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccat) @ (cwss @ (ccv @ Xp) @ XA2)) @ (cwa @ (cwcel @ (ccv @ Xq) @ ccat) @ (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) @ (cwa @ (cwcel @ (ccv @ Xr) @ ccat) @ (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) @ (cwi @ (cwss @ (ccv @ Xr) @ XA2) @ (cwceq @ (ccv @ Xr) @ (ccv @ Xp))))))))))).
