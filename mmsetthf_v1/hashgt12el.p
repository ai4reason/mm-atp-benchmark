...
thf(chashgt12el_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XV @ (XW @ Xb)) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwne @ (ccv @ Xa) @ (ccv @ Xb))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
