...
thf(ahlimveci_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwbr @ XF @ XA2 @ cchli) @ (cwcel @ XA2 @ cchil)))))).
...
thf(almmo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ ccha)) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ (ccfv @ XJ @ cclm))) => ((cwi @ Xph @ (cwbr @ XF @ XB2 @ (ccfv @ XJ @ cclm))) => (cwi @ Xph @ (cwceq @ XA2 @ XB2))))))))))).
...
thf(almcn_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (cwi @ Xph @ (cwbr @ (cccom @ XG @ XF) @ (ccfv @ XP @ XG) @ (ccfv @ XK @ cclm)))))))))))).
...
thf(ahhlm_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwceq @ cchli @ (ccres @ (ccfv @ XJ @ cclm) @ (cco @ cchil @ ccn @ ccmap)))))))))).
...
thf(ahhcnf_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XD @ (cccom @ ccno @ ccmv)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (cwceq @ cccnfn @ (cco @ XJ @ XK @ cccn))))))))).
...
thf(aelnlfn2_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ ccc @ XT) @ (cwcel @ XA2 @ (ccfv @ XT @ ccnl))) @ (cwceq @ (ccfv @ XA2 @ XT) @ ccc0))))).
...
thf(afnfco_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwf @ XB2 @ XA2 @ XG)) @ (cwfn @ (cccom @ XF @ XG) @ XB2))))))).
...
thf(aelnlfn_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ ccc @ XT) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XT @ ccnl)) @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwceq @ (ccfv @ XA2 @ XT) @ ccc0))))))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(aisch2_thm,axiom,(! [XH:($i > $o)] : (cwb @ (cwcel @ XH @ ccch) @ (cwa @ (cwcel @ XH @ ccsh) @ (cwal @ (^ [Xf1:$i] : (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwf @ ccn @ XH @ (ccv @ Xf1)) @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ cchli)) @ (cwcel @ (ccv @ Xx3) @ XH)))))))))).
thf(cnlelchi_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwcel @ (ccfv @ XT @ ccnl) @ ccch))))).
