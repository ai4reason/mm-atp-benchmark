...
thf(cnmoubi_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XL @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XM @ (ccfv @ XW @ ccnmcv)) => ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (cco @ XU @ XW @ ccnmoo))) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (! [Xx3:$i] : (cwi @ (cwa @ (cwf @ XX @ XY @ XT) @ (cwcel @ XA2 @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ XT @ (XN @ Xx3)) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XL) @ cc1 @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ XM) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XX)))))))))))))))))))))).
