...
thf(ccncls2i_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccuni @ XK)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwss @ XS @ XY)) @ (cwss @ (ccfv @ (ccima @ (cccnv @ XF) @ XS) @ (ccfv @ XJ @ cccl)) @ (ccima @ (cccnv @ XF) @ (ccfv @ XS @ (ccfv @ XK @ cccl)))))))))))).
