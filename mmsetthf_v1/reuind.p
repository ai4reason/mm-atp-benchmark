...
thf(creuind_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xy1))))) => (cwi @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (XA2 @ Xx3) @ XC) @ (Xph @ Xx3)) @ (cwa @ (cwcel @ (XB2 @ Xy1) @ XC) @ (Xps @ Xy1))) @ (cwceq @ (XA2 @ Xx3) @ (XB2 @ Xy1))))))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (XA2 @ Xx3) @ XC) @ (Xph @ Xx3))))) @ (cwreu @ (^ [Xz:$i] : (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xx3) @ XC) @ (Xph @ Xx3)) @ (cwceq @ (ccv @ Xz) @ (XA2 @ Xx3)))))) @ (^ [Xz:$i] : XC))))))))))).
