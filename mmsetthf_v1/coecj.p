...
thf(aplycj_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (cccom @ (cccom @ cccj @ XF) @ cccj))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ cccj) @ XS))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccply))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ (ccfv @ XS @ ccply)))))))))))))).
...
thf(aplycjlem_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((! [Xz:$i] : (! [Xk:$i] : (cwceq @ (XG @ Xz @ Xk) @ (cccom @ (cccom @ cccj @ XF) @ cccj)))) => ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => (! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwceq @ (XG @ Xz @ Xk) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (cccom @ cccj @ XA2)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))))))))))).
thf(ccoecj_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XG @ (cccom @ (cccom @ cccj @ XF) @ cccj)) => ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwceq @ (ccfv @ XG @ cccoe) @ (cccom @ cccj @ XA2)))))))))))).
