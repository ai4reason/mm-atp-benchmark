...
thf(algsfcl3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) @ (cwf @ ccn @ ccz @ (XF @ Xn))))))))).
...
thf(apcabs_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccq)) @ (cwceq @ (cco @ XP @ (ccfv @ XA2 @ ccabs) @ ccpc) @ (cco @ XP @ XA2 @ ccpc)))))).
...
thf(clgsdilem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccz))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XM @ ccz))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XN @ ccz))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwne @ XM @ ccc0))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwne @ XN @ ccc0))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XM @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (ccfv @ (ccfv @ XM @ ccabs) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ (ccfv @ (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))))))))))).
