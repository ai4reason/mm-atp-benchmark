...
thf(afnrnov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwceq @ (ccrn @ XF) @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(covelrn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwb @ (cwcel @ XC @ (ccrn @ XF)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XC @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
