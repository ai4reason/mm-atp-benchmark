...
thf(corngmul_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XR @ ccple)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccorng) @ (cwa @ (cwcel @ XX @ XB2) @ (cwbr @ Xc_0 @ XX @ Xc_le)) @ (cwa @ (cwcel @ XY @ XB2) @ (cwbr @ Xc_0 @ XY @ Xc_le))) @ (cwbr @ Xc_0 @ (cco @ XX @ XY @ Xc_x) @ Xc_le)))))))))))))).
