...
thf(cswrdccatid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwceq @ XN @ (ccfv @ XA2 @ cchash))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ ccc0 @ XN) @ ccsubstr) @ XA2))))))).
