...
thf(cralbinrald_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ XA2)) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xx3) @ XX))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XX) @ (cwb @ (Xps @ Xx3) @ Xth))) => (cwi @ Xph @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ Xth))))))))))).
