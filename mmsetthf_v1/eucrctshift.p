...
thf(arspcedeq2vd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwceq @ XC @ (XD @ Xx3)))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XC @ (XD @ Xx3))) @ (^ [Xx3:$i] : XB2))))))))))).
...
thf(alelttrdi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr))) => ((cwi @ Xph @ (cwbr @ XB2 @ XC @ ccle)) => (cwi @ Xph @ (cwi @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XA2 @ XC @ cclt)))))))))).
...
thf(azmodidfzoimp_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwceq @ (cco @ XM @ XN @ ccmo) @ XM))))).
...
thf(anppcand_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccaddc) @ XB2 @ ccaddc) @ (cco @ XA2 @ XC @ ccaddc))))))))))).
