...
thf(assrankr1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwcel @ XB2 @ ccon0) @ (cwb @ (cwss @ XB2 @ (ccfv @ XA2 @ ccrnk)) @ (cwn @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1))))))))).
...
thf(crankr1a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwcel @ XB2 @ ccon0) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) @ (cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2))))))).
