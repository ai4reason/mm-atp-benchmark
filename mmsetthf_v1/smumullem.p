...
thf(asmu02_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccn0) @ (cwceq @ (cco @ cc0 @ XA2 @ ccsmu) @ cc0)))).
...
thf(asmup1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn0)) => ((cwi @ Xph @ (cwss @ XB2 @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ (ccin @ XA2 @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)) @ XB2 @ ccsmu) @ (cco @ (cco @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ XB2 @ ccsmu) @ (ccrab @ (^ [Xn:$i] : (cwa @ (cwcel @ XN @ XA2) @ (cwcel @ (cco @ (ccv @ Xn) @ XN @ ccmin) @ XB2))) @ (^ [Xn:$i] : ccn0)) @ ccsad))))))))))).
...
thf(abitsinv1lem_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0)) @ (cwceq @ (cco @ XN @ (cco @ cc2 @ (cco @ XM @ cc1 @ ccaddc) @ ccexp) @ ccmo) @ (cco @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccmo) @ (ccif @ (cwcel @ XM @ (ccfv @ XN @ ccbits)) @ (cco @ cc2 @ XM @ ccexp) @ ccc0) @ ccaddc)))))).
...
thf(asadadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwceq @ (cco @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XB2 @ ccbits) @ ccsad) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ ccbits)))))).
...
thf(abitsshft_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccrab @ (^ [Xn:$i] : (cwcel @ (cco @ (ccv @ Xn) @ XN @ ccmin) @ (ccfv @ XA2 @ ccbits))) @ (^ [Xn:$i] : ccn0)) @ (ccfv @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ ccbits)))))).
...
thf(csmumullem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ (ccin @ (ccfv @ XA2 @ ccbits) @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccfv @ XB2 @ ccbits) @ ccsmu) @ (ccfv @ (cco @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccmo) @ XB2 @ ccmul) @ ccbits))))))))))).
