...
thf(advdsrmul1_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XZ @ XB2) @ (cwbr @ XX @ XY @ Xc_pa)) @ (cwbr @ (cco @ XX @ XZ @ Xc_x) @ (cco @ XY @ XZ @ Xc_x) @ Xc_pa))))))))))))).
...
thf(advdsrtr_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_pa @ (ccfv @ XR @ ccdsr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwbr @ XY @ XZ @ Xc_pa) @ (cwbr @ XZ @ XX @ Xc_pa)) @ (cwbr @ XY @ XX @ Xc_pa))))))))))).
...
thf(cunitmulcl_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XU)) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ XU)))))))))).
