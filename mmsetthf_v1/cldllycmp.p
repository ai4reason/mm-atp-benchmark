...
thf(arestcld_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ (cco @ XJ @ XS @ ccrest) @ cccld)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccin @ (ccv @ Xx3) @ XS))) @ (^ [Xx3:$i] : (ccfv @ XJ @ cccld))))))))))).
...
thf(ccldllycmp_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccnlly @ cccmp)) @ (cwcel @ XA2 @ (ccfv @ XJ @ cccld))) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ (ccnlly @ cccmp)))))).
