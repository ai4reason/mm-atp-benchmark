...
thf(aoppcval_thm,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XB2 @ Xz @ Xu) @ (ccfv @ XC @ ccbs)))) => ((! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XH @ Xz @ Xu) @ (ccfv @ XC @ cchom)))) => ((! [Xz:$i] : (! [Xu:$i] : (cwceq @ (Xc_x @ Xz @ Xu) @ (ccfv @ XC @ ccco)))) => ((! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XO @ Xz @ Xu) @ (ccfv @ XC @ ccoppc)))) => (! [Xz:$i] : (! [Xu:$i] : (cwi @ (cwcel @ XC @ (XV @ Xz @ Xu)) @ (cwceq @ (XO @ Xz @ Xu) @ (cco @ (cco @ XC @ (ccop @ (ccfv @ ccnx @ cchom) @ (cctpos @ (XH @ Xz @ Xu))) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccco) @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xz:$i] : (ccxp @ (XB2 @ Xz @ Xu) @ (XB2 @ Xz @ Xu)))) @ (^ [Xu:$i] : (^ [Xz:$i] : (XB2 @ Xz @ Xu))) @ (^ [Xu:$i] : (^ [Xz:$i] : (cctpos @ (cco @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccv @ Xu) @ cc2nd)) @ (ccfv @ (ccv @ Xu) @ cc1st) @ (Xc_x @ Xz @ Xu))))))) @ ccsts)))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(awunsets_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XS @ XU)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwcel @ (cco @ XS @ XA2 @ ccsts) @ XU)))))))))).
...
thf(awunop_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XB2 @ XU)) => (cwi @ Xph @ (cwcel @ (ccop @ XA2 @ XB2) @ XU)))))))))).
...
thf(awuntpos_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwcel @ (cctpos @ XA2) @ XU)))))))).
...
thf(awunun_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XB2 @ XU)) => (cwi @ Xph @ (cwcel @ (ccun @ XA2 @ XB2) @ XU)))))))))).
thf(awuncnv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwcel @ (cccnv @ XA2) @ XU)))))))).
...
thf(awunsn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => (cwi @ Xph @ (cwcel @ (ccsn @ XA2) @ XU)))))))).
...
thf(atposssxp_thm,axiom,(! [XF:($i > $o)] : (cwss @ (cctpos @ XF) @ (ccxp @ (ccun @ (cccnv @ (ccdm @ XF)) @ (ccsn @ cc0)) @ (ccrn @ XF))))).
...
thf(ccatcoppccl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ cccatc)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XO @ (ccfv @ XX @ ccoppc)) => ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ ccom @ XU)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => (cwi @ Xph @ (cwcel @ XO @ XB2))))))))))))))).
