...
thf(af1imaen2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwcel @ XB2 @ XV)) @ (cwa @ (cwss @ XC @ XA2) @ (cwcel @ XC @ XV))) @ (cwbr @ (ccima @ XF @ XC) @ XC @ ccen)))))))).
...
thf(cfiint_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cw3a @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwcel @ (ccv @ Xx3) @ ccfn)) @ (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2))))))).
