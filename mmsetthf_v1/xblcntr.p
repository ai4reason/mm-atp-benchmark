...
thf(cxblcntr_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwa @ (cwcel @ XR @ ccxr) @ (cwbr @ ccc0 @ XR @ cclt))) @ (cwcel @ XP @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))))))))).
