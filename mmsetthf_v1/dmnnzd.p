...
thf(cdmnnzd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => (cwi @ (cwa @ (cwcel @ XR @ ccdmn) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwceq @ (cco @ XA2 @ XB2 @ XH) @ XZ))) @ (cwo @ (cwceq @ XA2 @ XZ) @ (cwceq @ XB2 @ XZ))))))))))))))).
