...
thf(ahoadd12i_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (cwceq @ (cco @ XR @ (cco @ XS @ XT @ cchos) @ cchos) @ (cco @ XS @ (cco @ XR @ XT @ cchos) @ cchos))))))))).
...
thf(cho0subi_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (cwceq @ (cco @ XS @ XT @ cchod) @ (cco @ XS @ (cco @ cch0o @ XT @ cchod) @ cchos))))))).
