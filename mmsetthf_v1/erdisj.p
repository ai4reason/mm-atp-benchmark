...
thf(aecexr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccec @ XB2 @ XR)) @ (cwcel @ XB2 @ ccvv)))))).
...
thf(cerdisj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwer @ XX @ XR) @ (cwo @ (cwceq @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)) @ (cwceq @ (ccin @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)) @ cc0)))))))).
