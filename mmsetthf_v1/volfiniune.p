...
thf(aesumpfinvalf_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XA2 @ Xk) @ ccfn))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xk))) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsu @ (XA2 @ Xk) @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))))).
...
thf(cvolfiniune_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xn:$i] : (cwcel @ (XB2 @ Xn) @ (ccdm @ ccvol))) @ (^ [Xn:$i] : XA2)) @ (cwdisj @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn)))) @ (cwceq @ (ccfv @ (cciun @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccvol) @ (ccesum @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccfv @ (XB2 @ Xn) @ ccvol)))))))).
