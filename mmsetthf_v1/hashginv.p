...
thf(chashginv_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cchash) @ (cccnv @ (XG @ Xx3))) @ (ccfv @ XA2 @ cccrd)))))))).
