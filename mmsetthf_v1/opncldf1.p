...
thf(copncldf1_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((! [Xu:$i] : (cwceq @ (XF @ Xu) @ (ccmpt @ (^ [Xu:$i] : XJ) @ (^ [Xu:$i] : (ccdif @ XX @ (ccv @ Xu)))))) => (! [Xu:$i] : (cwi @ (cwcel @ XJ @ cctop) @ (cwa @ (cwf1o @ XJ @ (ccfv @ XJ @ cccld) @ (XF @ Xu)) @ (cwceq @ (cccnv @ (XF @ Xu)) @ (ccmpt @ (^ [Xx3:$i] : (ccfv @ XJ @ cccld)) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccv @ Xx3)))))))))))))).
