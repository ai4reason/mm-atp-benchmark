...
thf(aoiiso2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccoi @ XA2 @ XR)) => (cwi @ (cwa @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR)) @ (cwiso @ (ccdm @ XF) @ (ccrn @ XF) @ ccep @ XR @ XF))))))).
...
thf(aoiiniseg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XF @ (ccoi @ XA2 @ XR)) => (cwi @ (cwa @ (cwa @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwcel @ XN @ XA2) @ (cwcel @ XM @ (ccdm @ XF)))) @ (cwo @ (cwbr @ (ccfv @ XM @ XF) @ XN @ XR) @ (cwcel @ XN @ (ccrn @ XF))))))))))).
...
thf(asmogt_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwsmo @ XF) @ (cwcel @ XC @ XA2)) @ (cwss @ XC @ (ccfv @ XC @ XF))))))).
...
thf(aordtype2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccoi @ XA2 @ XR)) => (cwi @ (cw3a @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR) @ (cwcel @ XF @ ccvv)) @ (cwiso @ (ccdm @ XF) @ XA2 @ ccep @ XR @ XF))))))).
...
thf(coismo_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccoi @ XA2 @ ccep)) => (cwi @ (cwss @ XA2 @ ccon0) @ (cwa @ (cwsmo @ XF) @ (cwceq @ (ccrn @ XF) @ XA2))))))).
