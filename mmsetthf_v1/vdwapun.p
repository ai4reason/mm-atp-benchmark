...
thf(cvdwapun_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccn0) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XD @ ccn)) @ (cwceq @ (cco @ XA2 @ XD @ (ccfv @ (cco @ XK @ cc1 @ ccaddc) @ ccvdwa)) @ (ccun @ (ccsn @ XA2) @ (cco @ (cco @ XA2 @ XD @ ccaddc) @ XD @ (ccfv @ XK @ ccvdwa))))))))).
