...
thf(adf_sigagen_ax,axiom,(cwceq @ ccsigagen @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xs1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccfv @ (ccuni @ (ccv @ Xx3)) @ ccsiga)))))))).
...
thf(cbrsiga_conj,conjecture,(cwcel @ ccbrsiga @ (ccima @ ccsigagen @ cctop))).
