...
thf(aringvcl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap)) @ (cwcel @ XY @ (cco @ XB2 @ XI @ ccmap))) @ (cwcel @ (cco @ XX @ XY @ (ccof @ Xc_x)) @ (cco @ XB2 @ XI @ ccmap)))))))))))).
