...
thf(acongr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XM @ ccn)) @ (cwb @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XB2 @ XM @ ccmo)) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (ccv @ Xn) @ XM @ ccmul) @ (cco @ XA2 @ XB2 @ ccmin))) @ (^ [Xn:$i] : ccz)))))))).
...
thf(adivgcdcoprmex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ XM @ (cco @ XA2 @ XB2 @ ccgcd))) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cw3a @ (cwceq @ XA2 @ (cco @ XM @ (ccv @ Xa) @ ccmul)) @ (cwceq @ XB2 @ (cco @ XM @ (ccv @ Xb) @ ccmul)) @ (cwceq @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccgcd) @ cc1))) @ (^ [Xb:$i] : ccz))) @ (^ [Xa:$i] : ccz))))))).
...
thf(agcd2n0cl_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) @ (cwcel @ (cco @ XM @ XN @ ccgcd) @ ccn))))).
...
thf(adivgcdnnr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccz)) @ (cwcel @ (cco @ XA2 @ (cco @ XB2 @ XA2 @ ccgcd) @ ccdiv) @ ccn))))).
...
thf(ccncongr1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwa @ (cwcel @ XN @ ccn) @ (cwceq @ XM @ (cco @ XN @ (cco @ XC @ XN @ ccgcd) @ ccdiv)))) @ (cwi @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccmul) @ XN @ ccmo) @ (cco @ (cco @ XB2 @ XC @ ccmul) @ XN @ ccmo)) @ (cwceq @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XB2 @ XM @ ccmo)))))))))).
