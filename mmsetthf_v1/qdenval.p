...
thf(cqdenval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwceq @ (ccfv @ XA2 @ ccdenom) @ (ccfv @ (ccrio @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccgcd) @ cc1) @ (cwceq @ XA2 @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccdiv)))) @ (^ [Xx3:$i] : (ccxp @ ccz @ ccn))) @ cc2nd))))).
