...
thf(acoe1mul2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XS @ Xx3 @ Xk) @ (ccfv @ XR @ ccps1)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (Xc_xb @ Xx3) @ (ccfv @ (XS @ Xx3 @ Xk) @ ccmulr)))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XB2 @ (ccfv @ (XS @ Xx3 @ Xk) @ ccbs)))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (Xc_xb @ Xx3)) @ ccco1) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ ccco1)) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ ccmin) @ (ccfv @ XG @ ccco1)) @ Xc_x))) @ ccgsu)))))))))))))))))).
...
thf(ccoe1mul_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XY @ Xx3 @ Xk) @ (ccfv @ XR @ ccpl1)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (Xc_xb @ Xx3) @ (ccfv @ (XY @ Xx3 @ Xk) @ ccmulr)))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XB2 @ Xx3 @ Xk) @ (ccfv @ (XY @ Xx3 @ Xk) @ ccbs)))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ (XB2 @ Xx3 @ Xk)) @ (cwcel @ XG @ (XB2 @ Xx3 @ Xk))) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (Xc_xb @ Xx3)) @ ccco1) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ ccco1)) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ ccmin) @ (ccfv @ XG @ ccco1)) @ Xc_x))) @ ccgsu))))))))))))))))))).
