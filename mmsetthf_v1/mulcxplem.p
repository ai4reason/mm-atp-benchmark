...
thf(cmulcxplem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ ccc0 @ XC @ cccxp) @ (cco @ (cco @ XA2 @ XC @ cccxp) @ (cco @ ccc0 @ XC @ cccxp) @ ccmul))))))))).
