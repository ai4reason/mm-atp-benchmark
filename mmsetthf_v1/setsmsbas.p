...
thf(csetsmsbas_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwceq @ XX @ (ccfv @ XM @ ccbs))) => ((cwi @ Xph @ (cwceq @ XD @ (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX)))) => ((cwi @ Xph @ (cwceq @ XK @ (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts))) => (cwi @ Xph @ (cwceq @ XX @ (ccfv @ XK @ ccbs)))))))))))).
