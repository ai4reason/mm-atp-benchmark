...
thf(aerdsze_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwf1 @ (cco @ cc1 @ XN @ ccfz) @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ ccn)) => ((cwi @ Xph @ (cwcel @ XS @ ccn)) => ((cwi @ Xph @ (cwbr @ (cco @ (cco @ XR @ cc1 @ ccmin) @ (cco @ XS @ cc1 @ ccmin) @ ccmul) @ XN @ cclt)) => (cwi @ Xph @ (cwrex @ (^ [Xs1:$i] : (cwo @ (cwa @ (cwbr @ XR @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) @ (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xs1)))) @ (cwa @ (cwbr @ XS @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) @ (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ (cco @ cc1 @ XN @ ccfz)))))))))))))))).
...
thf(cerdsze2lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccn)) => ((cwi @ Xph @ (cwcel @ XS @ ccn)) => ((cwi @ Xph @ (cwf1 @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ ccr)) => ((cwceq @ XN @ (cco @ (cco @ XR @ cc1 @ ccmin) @ (cco @ XS @ cc1 @ ccmin) @ ccmul)) => ((cwi @ Xph @ (cwbr @ XN @ (ccfv @ XA2 @ cchash) @ cclt)) => ((cwi @ Xph @ (cwf1 @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ XA2 @ XG)) => ((cwi @ Xph @ (cwiso @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccrn @ XG) @ cclt @ cclt @ XG)) => (cwi @ Xph @ (cwrex @ (^ [Xs1:$i] : (cwo @ (cwa @ (cwbr @ XR @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) @ (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xs1)))) @ (cwa @ (cwbr @ XS @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) @ (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ XA2)))))))))))))))))))).
