...
thf(cisbnd3_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwrex @ (^ [Xx3:$i] : (cwf @ (ccxp @ XX @ XX) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccicc) @ XM)) @ (^ [Xx3:$i] : ccr))))))).
