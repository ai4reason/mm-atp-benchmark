...
thf(adf_spr_ax,axiom,(cwceq @ ccspr @ (ccmpt @ (^ [Xv:$i] : ccvv) @ (^ [Xv:$i] : (ccab @ (^ [Xp:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xp) @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : (ccv @ Xv)))) @ (^ [Xa:$i] : (ccv @ Xv))))))))).
...
thf(aeuabex_thm,axiom,(! [Xph:($i > $o)] : (cwi @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwcel @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ ccvv)))).
...
thf(csprval_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XV @ XW) @ (cwceq @ (ccfv @ XV @ ccspr) @ (ccab @ (^ [Xp:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xp) @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
