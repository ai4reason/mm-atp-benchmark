...
thf(cacsfn1p_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwral @ (^ [Xb:$i] : (cwcel @ (XE @ Xb) @ XX)) @ (^ [Xb:$i] : XY))) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (XE @ Xb) @ (ccv @ Xa))) @ (^ [Xb:$i] : (ccin @ (ccv @ Xa) @ XY)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
