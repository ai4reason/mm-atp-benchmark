...
thf(aomndmul2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XM @ ccple)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XM @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XM @ ccomnd) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XN @ ccn0)) @ (cwbr @ Xc_0 @ XX @ Xc_le)) @ (cwbr @ Xc_0 @ (cco @ XN @ XX @ Xc_x) @ Xc_le)))))))))))))).
...
thf(comndmul3_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XM @ ccple)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XM @ cc0g)) => ((cwi @ Xph @ (cwcel @ XM @ ccomnd)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XP @ ccn0)) => ((cwi @ Xph @ (cwbr @ XN @ XP @ ccle)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XX @ Xc_le)) => (cwi @ Xph @ (cwbr @ (cco @ XN @ XX @ Xc_x) @ (cco @ XP @ XX @ Xc_x) @ Xc_le)))))))))))))))))))))).
