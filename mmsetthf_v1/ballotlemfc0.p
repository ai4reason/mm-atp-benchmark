...
thf(ann1m1nn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwo @ (cwceq @ XA2 @ cc1) @ (cwcel @ (cco @ XA2 @ cc1 @ ccmin) @ ccn))))).
...
thf(apm5_6_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwi @ (cwa @ Xph @ (cwn @ Xps)) @ Xch) @ (cwi @ Xph @ (cwo @ Xps @ Xch))))))).
...
thf(afimaxre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
...
thf(cballotlemfc0_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XM @ Xx3) @ ccn)) => ((! [Xx3:$i] : (cwcel @ (XN @ Xx3) @ ccn)) => ((! [Xx3:$i] : (cwceq @ (XO @ Xx3) @ (ccrab @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ cchash) @ (XM @ Xx3))) @ (^ [Xc:$i] : (ccpw @ (cco @ cc1 @ (cco @ (XM @ Xx3) @ (XN @ Xx3) @ ccaddc) @ ccfz)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xc:$i] : (cwceq @ (XP @ Xx3 @ Xi @ Xk @ Xc) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ (XO @ Xx3))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cchash) @ (ccfv @ (XO @ Xx3) @ cchash) @ ccdiv)))))))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xc:$i] : (XO @ Xx3)) @ (^ [Xc:$i] : (ccmpt @ (^ [Xi:$i] : ccz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccin @ (cco @ cc1 @ (ccv @ Xi) @ ccfz) @ (ccv @ Xc)) @ cchash) @ (ccfv @ (ccdif @ (cco @ cc1 @ (ccv @ Xi) @ ccfz) @ (ccv @ Xc)) @ cchash) @ ccmin))))))) => ((! [Xx3:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xx3 @ Xc) @ (cwcel @ (XC @ Xx3 @ Xc) @ (XO @ Xx3))))) => ((! [Xx3:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xx3 @ Xc) @ (cwcel @ (XJ @ Xx3 @ Xc) @ ccn)))) => ((! [Xx3:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xx3 @ Xc) @ (cwrex @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccfv @ (XC @ Xx3 @ Xc) @ (XF @ Xx3))) @ ccc0 @ ccle)) @ (^ [Xi:$i] : (cco @ cc1 @ (XJ @ Xx3 @ Xc) @ ccfz)))))) => ((! [Xx3:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xx3 @ Xc) @ (cwbr @ ccc0 @ (ccfv @ (XJ @ Xx3 @ Xc) @ (ccfv @ (XC @ Xx3 @ Xc) @ (XF @ Xx3))) @ cclt)))) => (! [Xx3:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xx3 @ Xc) @ (cwrex @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ (ccfv @ (XC @ Xx3 @ Xc) @ (XF @ Xx3))) @ ccc0)) @ (^ [Xk:$i] : (cco @ cc1 @ (XJ @ Xx3 @ Xc) @ ccfz)))))))))))))))))))))))).
