...
thf(cidlimc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (cco @ (XF @ Xx3) @ XX @ cclimc)))))))))))).
