...
thf(a_0mbf_thm,axiom,(cwcel @ cc0 @ ccmbf)).
...
thf(afeq123_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwceq @ XF @ XG) @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)) @ (cwb @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ XC @ XD @ XG)))))))))).
...
thf(cmbfresfi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XS @ ccfn)) => ((cwi @ Xph @ (cwral @ (^ [Xs1:$i] : (cwcel @ (ccres @ XF @ (ccv @ Xs1)) @ ccmbf)) @ (^ [Xs1:$i] : XS))) => ((cwi @ Xph @ (cwceq @ (ccuni @ XS) @ XA2)) => (cwi @ Xph @ (cwcel @ XF @ ccmbf))))))))))).
