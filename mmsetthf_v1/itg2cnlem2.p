...
thf(aitg2split_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccdm @ ccvol))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ ccvol))) => ((cwi @ Xph @ (cwceq @ (ccfv @ (ccin @ XA2 @ XB2) @ ccovol) @ ccc0)) => ((cwi @ Xph @ (cwceq @ XU @ (ccun @ XA2 @ XB2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XU)) @ (cwcel @ (XC @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (XC @ Xx3) @ ccc0))))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XB2) @ (XC @ Xx3) @ ccc0))))) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XU) @ (XC @ Xx3) @ ccc0))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XF @ Xx3) @ ccitg2) @ ccr))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccfv @ (XG @ Xx3) @ ccitg2) @ ccr))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XH @ Xx3) @ ccitg2) @ (cco @ (ccfv @ (XF @ Xx3) @ ccitg2) @ (ccfv @ (XG @ Xx3) @ ccitg2) @ ccaddc))))))))))))))))))))))).
...
thf(aifle_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XB2 @ XA2 @ ccle)) @ (cwi @ Xph @ Xps)) @ (cwbr @ (ccif @ Xph @ XA2 @ XB2) @ (ccif @ Xps @ XA2 @ XB2) @ ccle))))))).
...
thf(citg2cnlem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XF @ ccmbf))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ (ccfv @ XF @ ccitg2) @ ccr))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XC @ ccrp))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwcel @ XM @ ccn))) => ((! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwn @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XM @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2) @ (cco @ (ccfv @ XF @ ccitg2) @ (cco @ XC @ cc2 @ ccdiv) @ ccmin) @ ccle)))) => (! [Xd:$i] : (cwi @ (Xph @ Xd) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xu:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2) @ XC @ cclt))) @ (^ [Xu:$i] : (ccdm @ ccvol)))) @ (^ [Xd:$i] : ccrp))))))))))))))).
