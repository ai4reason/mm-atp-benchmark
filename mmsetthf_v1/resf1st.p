...
thf(cresf1st_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwcel @ XH @ XW)) => ((cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XF @ XH @ ccresf) @ cc1st) @ (ccres @ (ccfv @ XF @ cc1st) @ XS))))))))))))).
