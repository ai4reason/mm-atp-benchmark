...
thf(adflim4_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwlim @ XA2) @ (cw3a @ (cword @ XA2) @ (cwcel @ cc0 @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccsuc @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : XA2)))))).
thf(coelimcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) @ (cwa @ (cwcel @ XB2 @ XC) @ (cwlim @ XB2))) @ (cwlim @ (cco @ XA2 @ XB2 @ ccoe))))))).
