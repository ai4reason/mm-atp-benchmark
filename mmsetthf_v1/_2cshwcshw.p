...
thf(adifelfznle_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (cwn @ (cwbr @ XK @ XM @ ccle))) @ (cwcel @ (cco @ (cco @ XM @ XN @ ccaddc) @ XK @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))))).
...
thf(acshwsublen_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XW @ XN @ cccsh) @ (cco @ XW @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmin) @ cccsh))))))).
...
thf(a_2cshwid_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ (cco @ XW @ XN @ cccsh) @ (cco @ (ccfv @ XW @ cchash) @ XN @ ccmin) @ cccsh) @ XW)))))).
thf(arexbidv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwb @ (Xps @ Xx3) @ (Xch @ Xx3)))) => (cwi @ Xph @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
thf(aeqeq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XC))))))).
thf(adifelfzle_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (cwbr @ XK @ XM @ ccle)) @ (cwcel @ (cco @ XM @ XK @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))))).
...
thf(c_2cshwcshw_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XY @ (ccword @ XV)) @ (cwceq @ (ccfv @ XY @ cchash) @ XN)) @ (cwi @ (cw3a @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwceq @ XX @ (cco @ XY @ XK @ cccsh)) @ (cwrex @ (^ [Xm:$i] : (cwceq @ XZ @ (cco @ XY @ (ccv @ Xm) @ cccsh))) @ (^ [Xm:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XZ @ (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))).
