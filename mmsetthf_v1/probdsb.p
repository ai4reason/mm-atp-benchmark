...
thf(aprobdif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) @ (cwceq @ (ccfv @ (ccdif @ XA2 @ XB2) @ XP) @ (cco @ (ccfv @ XA2 @ XP) @ (ccfv @ (ccin @ XA2 @ XB2) @ XP) @ ccmin))))))).
...
thf(cprobdsb_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP))) @ (cwceq @ (ccfv @ (ccdif @ (ccuni @ (ccdm @ XP)) @ XA2) @ XP) @ (cco @ cc1 @ (ccfv @ XA2 @ XP) @ ccmin)))))).
