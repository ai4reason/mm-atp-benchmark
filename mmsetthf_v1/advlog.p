...
thf(cadvlog_conj,conjecture,(cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ cc1 @ ccmin) @ ccmul))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cclog))))).
