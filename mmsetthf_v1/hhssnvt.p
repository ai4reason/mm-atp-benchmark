...
thf(chhssnvt_conj,conjecture,(! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => (cwi @ (cwcel @ XH @ ccsh) @ (cwcel @ XW @ ccnv)))))).
