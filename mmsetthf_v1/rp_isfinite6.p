...
thf(arp_isfinite5_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfn) @ (cwrex @ (^ [Xn:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ XA2 @ ccen)) @ (^ [Xn:$i] : ccn0))))).
...
thf(crp_isfinite6_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfn) @ (cwo @ (cwceq @ XA2 @ cc0) @ (cwrex @ (^ [Xn:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ XA2 @ ccen)) @ (^ [Xn:$i] : ccn)))))).
