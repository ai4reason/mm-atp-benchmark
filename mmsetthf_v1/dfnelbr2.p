...
thf(adifopab_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (cwceq @ (ccdif @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ (cwn @ (Xps @ Xx3 @ Xy1)))))))))).
...
thf(adf_eprel_ax,axiom,(cwceq @ ccep @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))))))).
thf(aeqtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XB2 @ XC) => (cwceq @ XA2 @ XC))))))).
thf(adf_nelbr_ax,axiom,(cwceq @ ccnelbr @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))))))).
...
thf(cdfnelbr2_conj,conjecture,(cwceq @ ccnelbr @ (ccdif @ (ccxp @ ccvv @ ccvv) @ ccep))).
