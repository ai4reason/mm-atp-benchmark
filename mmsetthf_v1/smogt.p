...
thf(asmofvon2_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwsmo @ XF) @ (cwcel @ (ccfv @ XB2 @ XF) @ ccon0))))).
...
thf(csmogt_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwsmo @ XF) @ (cwcel @ XC @ XA2)) @ (cwss @ XC @ (ccfv @ XC @ XF))))))).
