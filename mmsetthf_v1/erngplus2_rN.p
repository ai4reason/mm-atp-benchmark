...
thf(aerngplus_rN_thm,axiom,(! [XD:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XH @ Xf1) @ (ccfv @ XK @ cclh))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (cwceq @ (XE @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccedring_rN)))) => ((! [Xf1:$i] : (cwceq @ (Xc_pl @ Xf1) @ (ccfv @ (XD @ Xf1) @ ccplusg))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ (XH @ Xf1))) @ (cwa @ (cwcel @ XU @ (XE @ Xf1)) @ (cwcel @ XV @ (XE @ Xf1)))) @ (cwceq @ (cco @ XU @ XV @ (Xc_pl @ Xf1)) @ (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (cccom @ (ccfv @ (ccv @ Xf1) @ XU) @ (ccfv @ (ccv @ Xf1) @ XV)))))))))))))))))))))).
...
thf(cerngplus2_rN_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((cwceq @ XD @ (ccfv @ XW @ (ccfv @ XK @ ccedring_rN))) => ((cwceq @ Xc_pl @ (ccfv @ XD @ ccplusg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwcel @ XU @ XE) @ (cwcel @ XV @ XE) @ (cwcel @ XF @ XT))) @ (cwceq @ (ccfv @ XF @ (cco @ XU @ XV @ Xc_pl)) @ (cccom @ (ccfv @ XF @ XU) @ (ccfv @ XF @ XV)))))))))))))))))))).
