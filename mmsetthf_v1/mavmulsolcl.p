...
thf(amavmuldm_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap)) => ((cwceq @ XD @ (cco @ XB2 @ XN @ ccmap)) => ((cwceq @ Xc_x @ (cco @ XR @ (ccop @ XM @ XN) @ ccmvmul)) => (cwi @ (cw3a @ (cwcel @ XR @ XV) @ (cwcel @ XM @ ccfn) @ (cwcel @ XN @ ccfn)) @ (cwceq @ (ccdm @ Xc_x) @ (ccxp @ XC @ XD)))))))))))))))).
...
thf(af0dom0_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwf @ XX @ XY @ XF) @ (cwb @ (cwceq @ XX @ cc0) @ (cwceq @ XF @ cc0))))))).
