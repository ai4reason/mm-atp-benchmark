...
thf(afuniun_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwceq @ XF @ (cciun @ (^ [Xx3:$i] : (ccdm @ XF)) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XF))))))))).
...
thf(aiunopeqop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XB2 @ Xx3 @ Xz) @ ccvv))) => ((! [Xz:$i] : (cwcel @ (XC @ Xz) @ ccvv)) => ((! [Xz:$i] : (cwcel @ (XD @ Xz) @ ccvv)) => (! [Xz:$i] : (cwi @ (cwne @ XA2 @ cc0) @ (cwi @ (cwceq @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (XB2 @ Xx3 @ Xz))))) @ (ccop @ (XC @ Xz) @ (XD @ Xz))) @ (cwex @ (^ [Xz:$i] : (cwceq @ XA2 @ (ccsn @ (ccv @ Xz)))))))))))))))).
...
thf(asnopeqop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (cwb @ (cwceq @ (ccsn @ (ccop @ XA2 @ XB2)) @ (ccop @ XC @ XD)) @ (cw3a @ (cwceq @ XA2 @ XB2) @ (cwceq @ XC @ XD) @ (cwceq @ XC @ (ccsn @ XA2))))))))))))).
...
thf(cfunopsn_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => (cwi @ (cwa @ (cwfun @ XF) @ (cwceq @ XF @ (ccop @ XX @ XY))) @ (cwex @ (^ [Xa:$i] : (cwa @ (cwceq @ XX @ (ccsn @ (ccv @ Xa))) @ (cwceq @ XF @ (ccsn @ (ccop @ (ccv @ Xa) @ (ccv @ Xa)))))))))))))).
