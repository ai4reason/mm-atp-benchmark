...
thf(ccphnm_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cwcel @ XA2 @ XV)) @ (cwceq @ (ccfv @ XA2 @ XN) @ (ccfv @ (cco @ XA2 @ XA2 @ Xc_xi) @ ccsqrt)))))))))))).
