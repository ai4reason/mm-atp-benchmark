...
thf(crnghmresfn_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccin @ XU @ ccrng))) => ((cwi @ Xph @ (cwceq @ XH @ (ccres @ ccrngh @ (ccxp @ XB2 @ XB2)))) => (cwi @ Xph @ (cwfn @ XH @ (ccxp @ XB2 @ XB2)))))))))).
