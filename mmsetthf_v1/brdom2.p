...
thf(adfdom2_thm,axiom,(cwceq @ ccdom @ (ccun @ ccsdm @ ccen))).
...
thf(cbrdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwo @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ XA2 @ XB2 @ ccen)))))).
