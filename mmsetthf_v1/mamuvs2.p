...
thf(acmn12_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ cccmn) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) @ (cwceq @ (cco @ XX @ (cco @ XY @ XZ @ Xc_pl) @ Xc_pl) @ (cco @ XY @ (cco @ XX @ XZ @ Xc_pl) @ Xc_pl)))))))))))).
...
thf(cmamuvs2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XF @ (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((cwi @ Xph @ (cwcel @ XM @ ccfn)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((cwi @ Xph @ (cwcel @ XO @ ccfn)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => (cwi @ Xph @ (cwceq @ (cco @ XX @ (cco @ (ccxp @ (ccxp @ XN @ XO) @ (ccsn @ XY)) @ XZ @ (ccof @ Xc_x)) @ XF) @ (cco @ (ccxp @ (ccxp @ XM @ XO) @ (ccsn @ XY)) @ (cco @ XX @ XZ @ XF) @ (ccof @ Xc_x)))))))))))))))))))))))))).
