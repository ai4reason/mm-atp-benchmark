...
thf(ann0e_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XN @ cceven)) @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)))).
...
thf(cnn0enn0exALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XN @ cceven)) @ (cwrex @ (^ [Xm:$i] : (cwceq @ XN @ (cco @ cc2 @ (ccv @ Xm) @ ccmul))) @ (^ [Xm:$i] : ccn0))))).
