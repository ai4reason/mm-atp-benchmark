...
thf(aelspansni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => (cwb @ (cwcel @ XB2 @ (ccfv @ (ccsn @ XA2) @ ccspn)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XB2 @ (cco @ (ccv @ Xx3) @ XA2 @ ccsm))) @ (^ [Xx3:$i] : ccc))))))).
...
thf(aspansnmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ ccc)) @ (cwcel @ (cco @ XB2 @ XA2 @ ccsm) @ (ccfv @ (ccsn @ XA2) @ ccspn)))))).
...
thf(ahvm1neg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ (ccneg @ cc1) @ (cco @ XA2 @ XB2 @ ccsm) @ ccsm) @ (cco @ (ccneg @ XA2) @ XB2 @ ccsm)))))).
...
thf(cspanunsni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => (cwceq @ (ccfv @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccspn) @ (ccfv @ (ccun @ XA2 @ (ccsn @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccpjh)))) @ ccspn))))))).
