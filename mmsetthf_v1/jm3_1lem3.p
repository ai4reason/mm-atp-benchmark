...
thf(ajm3_1lem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ XK @ XN @ ccexp) @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ cclt))))))))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(aelnnz_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XN @ ccz) @ (cwbr @ ccc0 @ XN @ cclt))))).
thf(cjm3_1lem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => (cwi @ Xph @ (cwcel @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ ccn))))))))))).
