...
thf(amt4i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xch => ((cwi @ Xph @ (cwi @ (cwn @ Xps) @ (cwn @ Xch))) => (cwi @ Xph @ Xps))))))).
...
thf(c_0mnnnnn0_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwnel @ (cco @ ccc0 @ XN @ ccmin) @ ccn0)))).
