...
thf(cldualsbase_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XL @ (ccfv @ XF @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccld)) => ((cwceq @ XR @ (ccfv @ XD @ ccsca)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwi @ Xph @ (cwcel @ XW @ XV)) => (cwi @ Xph @ (cwceq @ XK @ XL))))))))))))))))).
