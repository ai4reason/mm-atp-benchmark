...
thf(ahalfcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwcel @ (cco @ XA2 @ cc2 @ ccdiv) @ ccc)))).
...
thf(aatandm2_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ ccc0) @ (cwne @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ ccc0))))).
...
thf(amulneg12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (ccneg @ XA2) @ XB2 @ ccmul) @ (cco @ XA2 @ (ccneg @ XB2) @ ccmul)))))).
...
thf(aefsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cce) @ (cco @ (ccfv @ XA2 @ cce) @ (ccfv @ XB2 @ cce) @ ccdiv)))))).
...
thf(acxpsqrt_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ cccxp) @ (ccfv @ XA2 @ ccsqrt))))).
thf(cefiatan_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdm @ ccatan)) @ (cwceq @ (ccfv @ (cco @ cci @ (ccfv @ XA2 @ ccatan) @ ccmul) @ cce) @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ ccsqrt) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ ccsqrt) @ ccdiv))))).
