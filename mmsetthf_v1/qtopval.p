...
thf(cqtopval_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ XJ @ XV) @ (cwcel @ XF @ (XW @ Xs1))) @ (cwceq @ (cco @ XJ @ XF @ ccqtop) @ (ccrab @ (^ [Xs1:$i] : (cwcel @ (ccin @ (ccima @ (cccnv @ XF) @ (ccv @ Xs1)) @ XX) @ XJ)) @ (^ [Xs1:$i] : (ccpw @ (ccima @ XF @ XX)))))))))))))).
