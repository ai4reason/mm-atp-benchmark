...
thf(ahvadd32i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccva) @ XC @ ccva) @ (cco @ (cco @ XA2 @ XC @ ccva) @ XB2 @ ccva))))))))).
...
thf(ahvsubcan2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccva) @ (cco @ XA2 @ XB2 @ ccmv) @ ccva) @ (cco @ cc2 @ XA2 @ ccsm))))))).
...
thf(anormpari_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwceq @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ (ccfv @ XB2 @ ccno) @ cc2 @ ccexp) @ ccmul) @ ccaddc))))))).
...
thf(cnormpar2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => (cwceq @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ (ccfv @ (cco @ XB2 @ XC @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccva) @ (cco @ cc2 @ XC @ ccsm) @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmin))))))))).
