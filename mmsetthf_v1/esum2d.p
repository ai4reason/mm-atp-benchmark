...
thf(aesumgsum_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XA2 @ Xk) @ ccfn))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xk))) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (cco @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ (ccmpt @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccgsu)))))))))))).
thf(ccxad_tp,type,(ccxad : ($i > $o))).
thf(aesummono_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XC @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XC)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ XA2 @ XC))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccesum @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccle))))))))))))).
...
thf(aesumlub_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xk @ Xa))))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XX @ Xk) @ ccxr))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XX @ Xk) @ (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ cclt))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xa:$i] : (cwbr @ (XX @ Xk) @ (ccesum @ (^ [Xk:$i] : (ccv @ Xa)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ cclt)) @ (^ [Xa:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))))))))))))).
...
thf(admiun_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwceq @ (ccdm @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccdm @ (XB2 @ Xx3)))))))).
...
thf(agsummpt2d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xz:$i] : (XC @ Xx3 @ Xz)))) => ((cwnf @ (^ [Xy1:$i] : (Xph @ Xy1))) => ((! [Xz:$i] : (cwceq @ XB2 @ (ccfv @ (XW @ Xz) @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwceq @ (XC @ Xx3 @ Xz) @ (XD @ Xy1 @ Xz)))))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwrel @ XA2))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XA2 @ ccfn))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XW @ Xz) @ cccmn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XC @ Xx3 @ Xz) @ XB2))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ (cco @ (XW @ Xz) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xz))) @ ccgsu) @ (cco @ (XW @ Xz) @ (ccmpt @ (^ [Xy1:$i] : (ccdm @ XA2)) @ (^ [Xy1:$i] : (cco @ (XW @ Xz) @ (ccmpt @ (^ [Xz:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (XD @ Xy1 @ Xz))) @ ccgsu))) @ ccgsu)))))))))))))))))))).
...
thf(aiunsnima_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwceq @ (ccima @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3)))) @ (ccsn @ (ccv @ Xx3))) @ (XB2 @ Xx3)))))))))))).
...
thf(aimafi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwcel @ (ccima @ XA2 @ XB2) @ ccfn))))).
...
thf(cesum2d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : (cwnfc @ (^ [Xk:$i] : (XF @ Xz @ Xk)))) => ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccop @ (ccv @ Xj) @ (ccv @ Xk))) @ (cwceq @ (XF @ Xz @ Xk) @ (XC @ Xj @ Xk)))))) => ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xz @ Xj @ Xk)))))) => ((! [Xz:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (XB2 @ Xj) @ (XW @ Xz))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xj)))) @ (cwcel @ (XC @ Xj @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccesum @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccesum @ (^ [Xk:$i] : (XB2 @ Xj)) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))) @ (ccesum @ (^ [Xz:$i] : (cciun @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccxp @ (ccsn @ (ccv @ Xj)) @ (XB2 @ Xj))))) @ (^ [Xz:$i] : (XF @ Xz @ Xk))))))))))))))))))).
