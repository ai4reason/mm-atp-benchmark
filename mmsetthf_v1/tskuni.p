...
thf(atskcard_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cctsk) @ (cwne @ XT @ cc0)) @ (cwcel @ (ccfv @ XT @ cccrd) @ ccina)))).
...
thf(acfslb2n_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwa @ (cwlim @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ cccf) @ ccsdm))) @ (^ [Xx3:$i] : XB2))) @ (cwi @ (cwbr @ XB2 @ (ccfv @ XA2 @ cccf) @ ccsdm) @ (cwne @ (ccuni @ XB2) @ XA2))))))).
...
thf(atsken_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ cctsk) @ (cwss @ XA2 @ XT)) @ (cwo @ (cwbr @ XA2 @ XT @ ccen) @ (cwcel @ XA2 @ XT)))))).
thf(ctskuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ cctsk) @ (cwtr @ XT) @ (cwcel @ XA2 @ XT)) @ (cwcel @ (ccuni @ XA2) @ XT))))).
