...
thf(cnnssi3_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ ccn @ XD) => ((cwi @ (cwcel @ XC @ ccn) @ Xph) => ((cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XD)) @ Xph) @ Xps) => (cwi @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ Xps))))))))))).
