...
thf(adf_covers_ax,axiom,(cwceq @ cccvr @ (ccmpt @ (^ [Xp:$i] : ccvv) @ (^ [Xp:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cw3a @ (cwa @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ ccbs)) @ (cwcel @ (ccv @ Xb) @ (ccfv @ (ccv @ Xp) @ ccbs))) @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xp) @ ccplt)) @ (cwn @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xa) @ (ccv @ Xz) @ (ccfv @ (ccv @ Xp) @ ccplt)) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xp) @ ccplt)))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xp) @ ccbs)))))))))))).
...
thf(ccvrfval_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [Xc_lt:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (Xc_lt @ Xx3 @ Xy1 @ Xz) @ (ccfv @ XK @ ccplt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XC @ Xx3 @ Xy1 @ Xz) @ (ccfv @ XK @ cccvr))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XK @ (XA2 @ Xx3 @ Xy1 @ Xz)) @ (cwceq @ (XC @ Xx3 @ Xy1 @ Xz) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cw3a @ (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_lt @ Xx3 @ Xy1 @ Xz)) @ (cwn @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_lt @ Xx3 @ Xy1 @ Xz)) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (Xc_lt @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xz:$i] : XB2))))))))))))))))))))).
