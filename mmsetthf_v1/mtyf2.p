...
thf(cmtyf2_conj,conjecture,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XK @ (ccfv @ XT @ ccmtc)) => ((cwceq @ XY @ (ccfv @ XT @ ccmty)) => (cwi @ (cwcel @ XT @ ccmfs) @ (cwf @ XV @ XK @ XY)))))))))).
