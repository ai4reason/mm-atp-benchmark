...
thf(amap2psrpr_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnr) => (cwb @ (cwbr @ (cco @ XC @ ccm1r @ ccplr) @ XA2 @ ccltr) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XC @ (ccec @ (ccop @ (ccv @ Xx3) @ cc1p) @ ccer) @ ccplr) @ XA2)) @ (^ [Xx3:$i] : ccnp))))))).
...
thf(altpsrpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnr) => (cwb @ (cwbr @ (cco @ XC @ (ccec @ (ccop @ XA2 @ cc1p) @ ccer) @ ccplr) @ (cco @ XC @ (ccec @ (ccop @ XB2 @ cc1p) @ ccer) @ ccplr) @ ccltr) @ (cwbr @ XA2 @ XB2 @ ccltp))))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(asupexpr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnp))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltp))) @ (^ [Xy1:$i] : XA2)) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltp)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccnp)))) @ (^ [Xx3:$i] : ccnp))))).
...
thf(amappsrpr_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnr) => (cwb @ (cwbr @ (cco @ XC @ ccm1r @ ccplr) @ (cco @ XC @ (ccec @ (ccop @ XA2 @ cc1p) @ ccer) @ ccplr) @ ccltr) @ (cwcel @ XA2 @ ccnp)))))).
...
thf(asotri2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwor @ XS @ XR) => ((cwss @ XR @ (ccxp @ XS @ XS)) => (cwi @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwn @ (cwbr @ XB2 @ XA2 @ XR)) @ (cwbr @ XB2 @ XC @ XR)) @ (cwbr @ XA2 @ XC @ XR)))))))))).
...
thf(csupsrlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XB2 @ (ccab @ (^ [Xw:$i] : (cwcel @ (cco @ XC @ (ccec @ (ccop @ (ccv @ Xw) @ cc1p) @ ccer) @ ccplr) @ XA2)))) => ((cwcel @ XC @ ccnr) => (cwi @ (cwa @ (cwcel @ XC @ XA2) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltr)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnr))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltr))) @ (^ [Xy1:$i] : XA2)) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltr) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltr)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccnr)))) @ (^ [Xx3:$i] : ccnr))))))))).
