...
thf(adf_mre_ax,axiom,(cwceq @ ccmre @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xc:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xc)) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwne @ (ccv @ Xs1) @ cc0) @ (cwcel @ (ccint @ (ccv @ Xs1)) @ (ccv @ Xc)))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xc)))))) @ (^ [Xc:$i] : (ccpw @ (ccpw @ (ccv @ Xx3))))))))).
