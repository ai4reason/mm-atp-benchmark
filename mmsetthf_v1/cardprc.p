...
thf(acardprclem_thm,axiom,(! [XA2:($i > $o)] : ((cwceq @ XA2 @ (ccab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cccrd) @ (ccv @ Xx3))))) => (cwn @ (cwcel @ XA2 @ ccvv))))).
...
thf(ccardprc_conj,conjecture,(cwnel @ (ccab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cccrd) @ (ccv @ Xx3)))) @ ccvv)).
