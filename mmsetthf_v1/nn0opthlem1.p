...
thf(ann0le2msqi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ XB2 @ XB2 @ ccmul) @ ccle))))))).
...
thf(cnn0opthlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XC @ ccn0) => (cwb @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ (cco @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ cc2 @ XA2 @ ccmul) @ ccaddc) @ (cco @ XC @ XC @ ccmul) @ cclt))))))).
