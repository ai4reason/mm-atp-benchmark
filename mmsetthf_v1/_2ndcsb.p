...
thf(afictb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwb @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwbr @ (ccfv @ XA2 @ ccfi) @ ccom @ ccdom)))))).
...
thf(c_2ndcsb_conj,conjecture,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ cc2ndc) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg) @ XJ))))))).
