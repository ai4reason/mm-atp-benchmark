...
thf(adistrlem4pr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp) @ (cwcel @ XC @ ccnp)) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2)) @ (cwa @ (cwcel @ (ccv @ Xf1) @ XA2) @ (cwcel @ (ccv @ Xz) @ XC)))) @ (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmq) @ (cco @ (ccv @ Xf1) @ (ccv @ Xz) @ ccmq) @ ccplq) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccpp) @ ccmp))))))))))).
...
thf(cdistrlem5pr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp) @ (cwcel @ XC @ ccnp)) @ (cwss @ (cco @ (cco @ XA2 @ XB2 @ ccmp) @ (cco @ XA2 @ XC @ ccmp) @ ccpp) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccpp) @ ccmp))))))).
