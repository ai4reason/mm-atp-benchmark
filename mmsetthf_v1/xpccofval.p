...
thf(axpchomfval_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XT @ Xv @ Xu) @ (cco @ XC @ XD @ ccxpc)))) => ((! [Xv:$i] : (! [Xu:$i] : (cwceq @ XB2 @ (ccfv @ (XT @ Xv @ Xu) @ ccbs)))) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ XJ @ (ccfv @ XD @ cchom)) => ((! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XK @ Xv @ Xu) @ (ccfv @ (XT @ Xv @ Xu) @ cchom)))) => (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XK @ Xv @ Xu) @ (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : XB2)) @ (^ [Xu:$i] : (^ [Xv:$i] : XB2)) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (cco @ (ccfv @ (ccv @ Xu) @ cc1st) @ (ccfv @ (ccv @ Xv) @ cc1st) @ XH) @ (cco @ (ccfv @ (ccv @ Xu) @ cc2nd) @ (ccfv @ (ccv @ Xv) @ cc2nd) @ XJ))))))))))))))))))))).
...
thf(cxpccofval_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (cco @ XC @ XD @ ccxpc)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ XB2 @ (ccfv @ (XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ XK @ (ccfv @ (XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ cchom)))))) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((cwceq @ Xc_xb @ (ccfv @ XD @ ccco)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XO @ Xf1 @ Xg1) @ (ccfv @ (XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ ccco)))))) => (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XO @ Xf1 @ Xg1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ XB2 @ XB2))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt2 @ (^ [Xg1:$i] : (^ [Xf1:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccv @ Xy1) @ XK))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccfv @ (ccv @ Xx3) @ XK))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccop @ (cco @ (ccfv @ (ccv @ Xg1) @ cc1st) @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (cco @ (ccop @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc1st)) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ Xc_x)) @ (cco @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ (ccfv @ (ccv @ Xf1) @ cc2nd) @ (cco @ (ccop @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc2nd) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc2nd)) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ Xc_xb))))))))))))))))))))))))))).
