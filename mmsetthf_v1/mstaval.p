...
thf(adf_msta_ax,axiom,(cwceq @ ccmsta @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccrn @ (ccfv @ (ccv @ Xt) @ ccmsr)))))).
...
thf(cmstaval_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XR @ (ccfv @ XT @ ccmsr)) => ((cwceq @ XS @ (ccfv @ XT @ ccmsta)) => (cwceq @ XS @ (ccrn @ XR)))))))).
