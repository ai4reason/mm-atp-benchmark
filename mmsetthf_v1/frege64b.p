...
thf(cfrege64b_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwi @ (cwsb @ (^ [Xy1:$i] : (Xph @ Xy1 @ Xz)) @ Xx3) @ (cwsb @ (^ [Xy1:$i] : (Xps @ Xy1 @ Xz)) @ Xz)) @ (cwi @ (cwal @ (^ [Xy1:$i] : (cwi @ (Xps @ Xy1 @ Xz) @ (Xch @ Xy1 @ Xz)))) @ (cwi @ (cwsb @ (^ [Xy1:$i] : (Xph @ Xy1 @ Xz)) @ Xx3) @ (cwsb @ (^ [Xy1:$i] : (Xch @ Xy1 @ Xz)) @ Xz)))))))))).
