...
thf(cnfcprod_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))) => (cwnfc @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk)))))))))).
