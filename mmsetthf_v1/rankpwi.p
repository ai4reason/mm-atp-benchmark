...
thf(arankidn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwn @ (cwcel @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccrnk) @ ccr1)))))).
...
thf(crankpwi_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwceq @ (ccfv @ (ccpw @ XA2) @ ccrnk) @ (ccsuc @ (ccfv @ XA2 @ ccrnk)))))).
