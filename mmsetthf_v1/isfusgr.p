...
thf(adf_fusgr_ax,axiom,(cwceq @ ccfusgr @ (ccrab @ (^ [Xg1:$i] : (cwcel @ (ccfv @ (ccv @ Xg1) @ ccvtx) @ ccfn)) @ (^ [Xg1:$i] : ccusgr)))).
thf(cisfusgr_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwb @ (cwcel @ XG @ ccfusgr) @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XV @ ccfn))))))).
