...
thf(amulcan2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul)) @ (cwceq @ XA2 @ XB2)))))))))))).
...
thf(aquad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwceq @ XD @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ (cco @ XA2 @ XC @ ccmul) @ ccmul) @ ccmin))) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ (cco @ XA2 @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ (cco @ (cco @ XB2 @ XX @ ccmul) @ XC @ ccaddc) @ ccaddc) @ ccc0) @ (cwo @ (cwceq @ XX @ (cco @ (cco @ (ccneg @ XB2) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ (cco @ cc2 @ XA2 @ ccmul) @ ccdiv)) @ (cwceq @ XX @ (cco @ (cco @ (ccneg @ XB2) @ (ccfv @ XD @ ccsqrt) @ ccmin) @ (cco @ cc2 @ XA2 @ ccmul) @ ccdiv)))))))))))))))))).
...
thf(adcubic2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccc)) => ((cwi @ Xph @ (cwcel @ XQ @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ XT @ cc3 @ ccexp) @ (cco @ (XG @ Xr) @ (XN @ Xr) @ ccmin)))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xr) @ ccc))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xr) @ cc2 @ ccexp) @ (cco @ (cco @ (XN @ Xr) @ cc2 @ ccexp) @ (cco @ XM @ cc3 @ ccexp) @ ccaddc)))) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ XP @ cc3 @ ccdiv))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (XN @ Xr) @ (cco @ XQ @ cc2 @ ccdiv)))) => ((cwi @ Xph @ (cwne @ XT @ ccc0)) => ((cwi @ Xph @ (cwcel @ XU @ ccc)) => ((cwi @ Xph @ (cwne @ XU @ ccc0)) => ((cwi @ Xph @ (cwceq @ XX @ (cco @ XU @ (cco @ XM @ XU @ ccdiv) @ ccmin))) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ XP @ XX @ ccmul) @ XQ @ ccaddc) @ ccaddc) @ ccc0)) => (cwi @ Xph @ (cwrex @ (^ [Xr:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xr) @ cc3 @ ccexp) @ cc1) @ (cwceq @ XX @ (cco @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ (cco @ XM @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ ccdiv) @ ccmin)))) @ (^ [Xr:$i] : ccc))))))))))))))))))))))))))).
...
thf(adcubic1_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccc)) => ((cwi @ Xph @ (cwcel @ XQ @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XT @ cc3 @ ccexp) @ (cco @ XG @ XN @ ccmin))) => ((cwi @ Xph @ (cwcel @ XG @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XG @ cc2 @ ccexp) @ (cco @ (cco @ XN @ cc2 @ ccexp) @ (cco @ XM @ cc3 @ ccexp) @ ccaddc))) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ XP @ cc3 @ ccdiv))) => ((cwi @ Xph @ (cwceq @ XN @ (cco @ XQ @ cc2 @ ccdiv))) => ((cwi @ Xph @ (cwne @ XT @ ccc0)) => ((cwi @ Xph @ (cwceq @ XX @ (cco @ XT @ (cco @ XM @ XT @ ccdiv) @ ccmin))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ XP @ XX @ ccmul) @ XQ @ ccaddc) @ ccaddc) @ ccc0)))))))))))))))))))))).
...
thf(cdcubic_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccc)) => ((cwi @ Xph @ (cwcel @ XQ @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ XT @ cc3 @ ccexp) @ (cco @ (XG @ Xr) @ (XN @ Xr) @ ccmin)))) => ((! [Xr:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xr) @ ccc))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xr) @ cc2 @ ccexp) @ (cco @ (cco @ (XN @ Xr) @ cc2 @ ccexp) @ (cco @ XM @ cc3 @ ccexp) @ ccaddc)))) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ XP @ cc3 @ ccdiv))) => ((! [Xr:$i] : (cwi @ Xph @ (cwceq @ (XN @ Xr) @ (cco @ XQ @ cc2 @ ccdiv)))) => ((cwi @ Xph @ (cwne @ XT @ ccc0)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ XP @ XX @ ccmul) @ XQ @ ccaddc) @ ccaddc) @ ccc0) @ (cwrex @ (^ [Xr:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xr) @ cc3 @ ccexp) @ cc1) @ (cwceq @ XX @ (cco @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ (cco @ XM @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ ccdiv) @ ccmin)))) @ (^ [Xr:$i] : ccc))))))))))))))))))))))).
