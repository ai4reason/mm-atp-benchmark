...
thf(aex3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xta) => (cwi @ (cw3a @ Xph @ Xps @ Xch) @ (cwi @ Xth @ Xta))))))))).
...
thf(ainjresinj_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XK @ ccn0) @ (cwi @ (cw3a @ (cwf @ (cco @ ccc0 @ XK @ ccfz) @ XV @ XF) @ (cwfun @ (cccnv @ (ccres @ XF @ (cco @ cc1 @ XK @ ccfzo)))) @ (cwne @ (ccfv @ ccc0 @ XF) @ (ccfv @ XK @ XF))) @ (cwi @ (cwceq @ (ccin @ (ccima @ XF @ (ccpr @ ccc0 @ XK)) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) @ cc0) @ (cwfun @ (cccnv @ XF))))))))).
thf(aisspth_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwb @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) @ (cwfun @ (cccnv @ XP)))))))).
thf(cpthdepisspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) @ (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP))) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))).
