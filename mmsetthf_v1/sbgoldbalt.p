...
thf(aoddneven_thm,axiom,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ ccodd) @ (cwn @ (cwcel @ XZ @ cceven))))).
...
thf(asbgoldbaltlem2_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime)) @ (cwi @ (cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (cwceq @ XN @ (cco @ XP @ XQ @ ccaddc))) @ (cwa @ (cwcel @ XP @ ccodd) @ (cwcel @ XQ @ ccodd)))))))).
thf(csbgoldbalt_conj,conjecture,(cwb @ (cwral @ (^ [Xn:$i] : (cwi @ (cwbr @ cc4 @ (ccv @ Xn) @ cclt) @ (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) @ (cwral @ (^ [Xn:$i] : (cwi @ (cwbr @ cc2 @ (ccv @ Xn) @ cclt) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))) @ (^ [Xn:$i] : cceven)))).
