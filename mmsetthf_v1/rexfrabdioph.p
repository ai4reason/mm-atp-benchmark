...
thf(arexrabdioph_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (cco @ XN @ cc1 @ ccaddc)) => ((! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (cwi @ (cwceq @ (ccv @ Xv) @ (ccfv @ XM @ (ccv @ Xt))) @ (cwb @ (Xps @ Xv @ Xu) @ (Xch @ Xu @ Xt)))))) => ((! [Xu:$i] : (! [Xt:$i] : (cwi @ (cwceq @ (ccv @ Xu) @ (ccres @ (ccv @ Xt) @ (cco @ cc1 @ XN @ ccfz))) @ (cwb @ (Xch @ Xu @ Xt) @ (Xph @ Xt))))) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (Xph @ Xt)) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XM @ ccfz) @ ccmap))) @ (ccfv @ XM @ ccdioph))) @ (cwcel @ (ccrab @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (Xps @ Xv @ Xu)) @ (^ [Xv:$i] : ccn0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))))))))).
