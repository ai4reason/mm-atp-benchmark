...
thf(ciotasbcq_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1)))) @ (cwb @ (cwsbc @ (^ [Xy1:$i] : (Xch @ Xx3 @ Xy1)) @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) @ (cwsbc @ (^ [Xy1:$i] : (Xch @ Xx3 @ Xy1)) @ (ccio @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))))))))))).
