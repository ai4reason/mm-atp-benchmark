...
thf(aoddprmuzge3_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XP @ ccodd)) @ (cwcel @ XP @ (ccfv @ cc3 @ ccuz))))).
...
thf(cgboge9_conj,conjecture,(! [XZ:($i > $o)] : (cwi @ (cwcel @ XZ @ ccgbo) @ (cwbr @ cc9 @ XZ @ ccle)))).
