...
thf(alatmlej22_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => (cwi @ (cwa @ (cwcel @ XK @ cclat) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) @ (cwbr @ (cco @ XY @ XX @ Xc_an) @ (cco @ XZ @ XX @ Xc_or) @ Xc_le))))))))))))))).
...
thf(cdalawlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwa @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cwa @ (cwcel @ XS @ XA2) @ (cwcel @ XT @ XA2))) @ (cwbr @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XS @ XT @ Xc_or) @ Xc_an) @ (cco @ (cco @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XT @ Xc_or) @ XS @ Xc_an) @ (cco @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XS @ Xc_or) @ XT @ Xc_an) @ Xc_or) @ Xc_le)))))))))))))))).
