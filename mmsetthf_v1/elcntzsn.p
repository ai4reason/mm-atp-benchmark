...
thf(celcntzsn_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwcel @ XY @ XB2) @ (cwb @ (cwcel @ XX @ (ccfv @ (ccsn @ XY) @ XZ)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwceq @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XY @ XX @ Xc_pl))))))))))))))).
