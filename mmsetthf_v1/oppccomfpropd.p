...
thf(coppccomfpropd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XC @ cchomf) @ (ccfv @ XD @ cchomf))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XC @ cccomf) @ (ccfv @ XD @ cccomf))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XC @ ccoppc) @ cccomf) @ (ccfv @ (ccfv @ XD @ ccoppc) @ cccomf))))))))).
