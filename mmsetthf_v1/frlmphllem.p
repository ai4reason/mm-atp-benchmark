...
thf(cfrlmphllem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xh:$i] : (! [Xc_xi:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_as:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XV @ (ccfv @ XY @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XY @ ccip)) => ((! [Xx3:$i] : (cwceq @ (XO @ Xx3) @ (ccfv @ XY @ cc0g))) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((! [Xg1:$i] : (cwceq @ (Xc_as @ Xg1) @ (ccfv @ XR @ ccstv))) => ((cwi @ Xph @ (cwcel @ XR @ ccfield)) => ((! [Xx3:$i] : (! [Xg1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xg1) @ XV) @ (cwceq @ (cco @ (ccv @ Xg1) @ (ccv @ Xg1) @ Xc_xi) @ Xc_0)) @ (cwceq @ (ccv @ Xg1) @ (XO @ Xx3))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ (Xc_as @ Xg1)) @ (ccv @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => (! [Xg1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xg1) @ XV) @ (cwcel @ (ccv @ Xh) @ XV)) @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xh)) @ Xc_x))) @ Xc_0 @ ccfsupp))))))))))))))))))))))))))))).
