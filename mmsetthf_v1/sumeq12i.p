...
thf(csumeq12i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwceq @ XA2 @ XB2) => ((! [Xk:$i] : (cwi @ (cwcel @ (ccv @ Xk) @ XA2) @ (cwceq @ (XC @ Xk) @ (XD @ Xk)))) => (cwceq @ (ccsu @ XA2 @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (XD @ Xk))))))))))).
