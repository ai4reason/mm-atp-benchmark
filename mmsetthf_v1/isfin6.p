...
thf(adf_fin6_ax,axiom,(cwceq @ ccfin6 @ (ccab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccv @ Xx3) @ cc2o @ ccsdm) @ (cwbr @ (ccv @ Xx3) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)) @ ccsdm)))))).
...
thf(cisfin6_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccfin6) @ (cwo @ (cwbr @ XA2 @ cc2o @ ccsdm) @ (cwbr @ XA2 @ (ccxp @ XA2 @ XA2) @ ccsdm))))).
