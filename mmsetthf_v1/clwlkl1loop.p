...
thf(awlkl1loop_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwfun @ (ccfv @ XG @ cciedg)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) @ (cwa @ (cwceq @ (ccfv @ XF @ cchash) @ cc1) @ (cwceq @ (ccfv @ ccc0 @ XP) @ (ccfv @ cc1 @ XP)))) @ (cwcel @ (ccsn @ (ccfv @ ccc0 @ XP)) @ (ccfv @ XG @ ccedg))))))).
thf(cclwlkl1loop_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwfun @ (ccfv @ XG @ cciedg)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccclwlks)) @ (cwceq @ (ccfv @ XF @ cchash) @ cc1)) @ (cwa @ (cwceq @ (ccfv @ ccc0 @ XP) @ (ccfv @ cc1 @ XP)) @ (cwcel @ (ccsn @ (ccfv @ ccc0 @ XP)) @ (ccfv @ XG @ ccedg)))))))).
