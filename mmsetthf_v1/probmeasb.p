...
thf(ameasdivcstOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwcel @ XA2 @ ccrp)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XM) @ XA2 @ ccxdiv))) @ (ccfv @ XS @ ccmeas))))))).
...
thf(cprobmeasb_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwcel @ XA2 @ XS) @ (cwcel @ (ccfv @ XA2 @ XM) @ ccrp)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ XM) @ (ccfv @ XA2 @ XM) @ ccdiv))) @ ccprb)))))).
