...
thf(ahashgcdeq_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XM @ ccgcd) @ XN)) @ (^ [Xx3:$i] : (cco @ ccc0 @ XM @ ccfzo))) @ cchash) @ (ccif @ (cwbr @ XN @ XM @ ccdvds) @ (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccphi) @ ccc0)))))).
...
thf(cphisum_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xd:$i] : (ccfv @ (ccv @ Xd) @ ccphi))) @ XN)))).
