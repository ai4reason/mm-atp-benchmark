...
thf(adf_carsg_ax,axiom,(cwceq @ cccarsg @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xe:$i] : (cwceq @ (cco @ (ccfv @ (ccin @ (ccv @ Xe) @ (ccv @ Xa)) @ (ccv @ Xm)) @ (ccfv @ (ccdif @ (ccv @ Xe) @ (ccv @ Xa)) @ (ccv @ Xm)) @ ccxad) @ (ccfv @ (ccv @ Xe) @ (ccv @ Xm)))) @ (^ [Xe:$i] : (ccpw @ (ccuni @ (ccdm @ (ccv @ Xm))))))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ (ccv @ Xm)))))))))).
...
thf(ccarsgval_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xe:$i] : (! [Xa:$i] : (cwi @ Xph @ (cwcel @ XO @ (XV @ Xe @ Xa))))) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => (cwi @ Xph @ (cwceq @ (ccfv @ XM @ cccarsg) @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xe:$i] : (cwceq @ (cco @ (ccfv @ (ccin @ (ccv @ Xe) @ (ccv @ Xa)) @ XM) @ (ccfv @ (ccdif @ (ccv @ Xe) @ (ccv @ Xa)) @ XM) @ ccxad) @ (ccfv @ (ccv @ Xe) @ XM))) @ (^ [Xe:$i] : (ccpw @ XO)))) @ (^ [Xa:$i] : (ccpw @ XO)))))))))))).
