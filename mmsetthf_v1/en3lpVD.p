...
thf(azfregs2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwne @ XA2 @ cc0) @ (cwn @ (cwral @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(aen3lplem2VD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XA2)) @ (cwi @ (cwcel @ (ccv @ Xx3) @ (cctp @ XA2 @ XB2 @ XC)) @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (cctp @ XA2 @ XB2 @ XC)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))))).
...
thf(cen3lpVD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwn @ (cw3a @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XA2))))))).
