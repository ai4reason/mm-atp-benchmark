...
thf(aprmexpb_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime)) @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn))) @ (cwb @ (cwceq @ (cco @ XP @ XM @ ccexp) @ (cco @ XQ @ XN @ ccexp)) @ (cwa @ (cwceq @ XP @ XQ) @ (cwceq @ XM @ XN))))))))).
...
thf(arbaibd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwb @ Xps @ (cwa @ Xch @ Xth))) => (cwi @ (cwa @ Xph @ Xth) @ (cwb @ Xps @ Xch)))))))).
...
thf(cfsumvma_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xp:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp)) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xk @ Xp)))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ ccfn)) => ((! [Xk:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwb @ (cwa @ (cwcel @ (ccv @ Xp) @ XP) @ (cwcel @ (ccv @ Xk) @ (XK @ Xp))) @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccprime) @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwcel @ (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp) @ XA2)))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ ccvma) @ ccc0))) @ (cwceq @ (XB2 @ Xx3) @ ccc0))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsu @ XP @ (^ [Xp:$i] : (ccsu @ (XK @ Xp) @ (^ [Xk:$i] : (XC @ Xk @ Xp))))))))))))))))))))).
