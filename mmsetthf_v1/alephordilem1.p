...
thf(aalephsuc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccfv @ (ccfv @ XA2 @ ccale) @ cchar))))).
thf(calephordilem1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccsdm)))).
