...
thf(cmetdsge_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX) @ (cwcel @ XA2 @ XX)) @ (cwcel @ (XR @ Xx3 @ Xy1) @ ccxr)) @ (cwb @ (cwbr @ (XR @ Xx3 @ Xy1) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ ccle) @ (cwceq @ (ccin @ XS @ (cco @ XA2 @ (XR @ Xx3 @ Xy1) @ (ccfv @ XD @ ccbl))) @ cc0))))))))))))).
