...
thf(csectcan_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XS @ (ccfv @ XC @ ccsect)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwbr @ XG @ XF @ (cco @ XX @ XY @ XS))) => ((cwi @ Xph @ (cwbr @ XF @ XH @ (cco @ XY @ XX @ XS))) => (cwi @ Xph @ (cwceq @ XG @ XH))))))))))))))))))).
