...
thf(anneo_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwb @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn) @ (cwn @ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn)))))).
...
thf(asupxrbnd_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt)) @ (cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccr)))).
...
thf(covolunlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : ((cwi @ Xph @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwa @ (cwss @ XB2 @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((! [Xn:$i] : (cwceq @ (XT @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1))) => ((! [Xn:$i] : (cwceq @ (XU @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XH @ Xn)) @ cc1))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap))) => ((cwi @ Xph @ (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))))) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ XA2 @ ccovol) @ (cco @ XC @ cc2 @ ccdiv) @ ccaddc) @ ccle))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap))) => ((cwi @ Xph @ (cwss @ XB2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG))))) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccsup @ (ccrn @ (XT @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ XB2 @ ccovol) @ (cco @ XC @ cc2 @ ccdiv) @ ccaddc) @ ccle))) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ ccn) @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ XG) @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ XF)))))) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ ccovol) @ (cco @ (cco @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccaddc) @ XC @ ccaddc) @ ccle)))))))))))))))))))))))))).
