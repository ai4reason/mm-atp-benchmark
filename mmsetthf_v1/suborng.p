...
thf(aressinbas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => (cwi @ (cwcel @ XA2 @ XX) @ (cwceq @ (cco @ XW @ XA2 @ ccress) @ (cco @ XW @ (ccin @ XA2 @ XB2) @ ccress))))))))).
...
thf(csuborng_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ ccorng) @ (cwcel @ (cco @ XR @ XA2 @ ccress) @ ccrg)) @ (cwcel @ (cco @ XR @ XA2 @ ccress) @ ccorng))))).
