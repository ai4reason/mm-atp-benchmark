...
thf(adf_madu_ax,axiom,(cwceq @ ccmadu @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccmpt @ (^ [Xm:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ ccbs)) @ (^ [Xm:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccv @ Xn))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccv @ Xn))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : (ccv @ Xn))) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccv @ Xn))) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (ccv @ Xj)) @ (ccif @ (cwceq @ (ccv @ Xl) @ (ccv @ Xi)) @ (ccfv @ (ccv @ Xr) @ ccur) @ (ccfv @ (ccv @ Xr) @ cc0g)) @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ (ccv @ Xm)))))) @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmdat)))))))))))).
...
thf(cmadufval_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (cco @ XN @ XR @ ccmat))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XD @ Xi @ Xj @ Xk @ Xm @ Xl) @ (cco @ XN @ XR @ ccmdat))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XJ @ Xi @ Xj @ Xk @ Xm @ Xl) @ (cco @ XN @ XR @ ccmadu))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XB2 @ Xi @ Xj @ Xk @ Xl) @ (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ ccbs))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (Xc_1 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (ccfv @ XR @ ccur))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (ccfv @ XR @ cc0g))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (cwceq @ (XJ @ Xi @ Xj @ Xk @ Xm @ Xl) @ (ccmpt @ (^ [Xm:$i] : (XB2 @ Xi @ Xj @ Xk @ Xl)) @ (^ [Xm:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (ccv @ Xj)) @ (ccif @ (cwceq @ (ccv @ Xl) @ (ccv @ Xi)) @ (Xc_1 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xl)) @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ (ccv @ Xm)))))) @ (XD @ Xi @ Xj @ Xk @ Xm @ Xl)))))))))))))))))))))))))))).
