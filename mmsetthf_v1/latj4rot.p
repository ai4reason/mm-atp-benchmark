...
thf(clatj4rot_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => (cwi @ (cw3a @ (cwcel @ XK @ cclat) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwa @ (cwcel @ XZ @ XB2) @ (cwcel @ XW @ XB2))) @ (cwceq @ (cco @ (cco @ XX @ XY @ Xc_or) @ (cco @ XZ @ XW @ Xc_or) @ Xc_or) @ (cco @ (cco @ XW @ XX @ Xc_or) @ (cco @ XY @ XZ @ Xc_or) @ Xc_or))))))))))))).
