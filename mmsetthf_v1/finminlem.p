...
thf(awefrc_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwwe @ (XA2 @ Xx3) @ ccep) @ (cwss @ XB2 @ (XA2 @ Xx3)) @ (cwne @ XB2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ XB2 @ (ccv @ Xx3)) @ cc0)) @ (^ [Xx3:$i] : XB2))))))).
...
thf(cfinminlem_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => (cwi @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccfn)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwss @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (Xps @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))))))))))).
