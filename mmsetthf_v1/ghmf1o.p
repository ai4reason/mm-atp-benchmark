...
thf(cghmf1o_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XS @ ccbs)) => ((cwceq @ XY @ (ccfv @ XT @ ccbs)) => (cwi @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwb @ (cwf1o @ XX @ XY @ XF) @ (cwcel @ (cccnv @ XF) @ (cco @ XT @ XS @ ccghm)))))))))))).
