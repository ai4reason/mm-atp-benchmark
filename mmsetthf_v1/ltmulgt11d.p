...
thf(cltmulgt11d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwb @ (cwbr @ cc1 @ XA2 @ cclt) @ (cwbr @ XB2 @ (cco @ XB2 @ XA2 @ ccmul) @ cclt))))))))).
