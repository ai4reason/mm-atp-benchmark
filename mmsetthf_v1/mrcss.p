...
thf(cmrcss_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XU @ XV) @ (cwss @ XV @ XX)) @ (cwss @ (ccfv @ XU @ XF) @ (ccfv @ XV @ XF)))))))))).
