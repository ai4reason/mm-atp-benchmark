...
thf(aulmdvlem2_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xz) @ ccuz))) => ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xz) @ ccz))) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc @ XX @ ccmap) @ XF)) => ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XX @ ccc @ (XG @ Xk)))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XX)) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccfv @ (ccv @ Xz) @ (XG @ Xk)) @ ccli)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv))) @ (XH @ Xk) @ (ccfv @ XX @ cculm)))) => (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccdm @ (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv)) @ XX))))))))))))))))))).
...
thf(aulmdvlem3_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xz) @ ccuz))) => ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xz) @ ccz))) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc @ XX @ ccmap) @ XF)) => ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XX @ ccc @ (XG @ Xk)))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XX)) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccfv @ (ccv @ Xz) @ (XG @ Xk)) @ ccli)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv))) @ (XH @ Xk) @ (ccfv @ XX @ cculm)))) => (! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XX)) @ (cwbr @ (ccv @ Xz) @ (ccfv @ (ccv @ Xz) @ (XH @ Xk)) @ (cco @ XS @ (XG @ Xk) @ ccdv))))))))))))))))))))).
...
thf(culmdv_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xz) @ ccuz))) => ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xz) @ ccz))) => ((cwi @ Xph @ (cwf @ XZ @ (cco @ ccc @ XX @ ccmap) @ XF)) => ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XX @ ccc @ (XG @ Xk)))) => ((! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XX)) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccfv @ (ccv @ Xz) @ (XG @ Xk)) @ ccli)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv))) @ (XH @ Xk) @ (ccfv @ XX @ cculm)))) => (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ XS @ (XG @ Xk) @ ccdv) @ (XH @ Xk)))))))))))))))))))).
