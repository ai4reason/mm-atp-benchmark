...
thf(comv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (XB2 @ Xx3) @ ccon0)) @ (cwceq @ (cco @ XA2 @ (XB2 @ Xx3) @ ccomu) @ (ccfv @ (XB2 @ Xx3) @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccoa))) @ cc0)))))))).
