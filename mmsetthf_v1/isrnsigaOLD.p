...
thf(cisrnsigaOLD_conj,conjecture,(! [XS:($i > $o)] : (cwb @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwa @ (cwcel @ XS @ ccvv) @ (cwex @ (^ [Xo:$i] : (cwa @ (cwss @ XS @ (ccpw @ (ccv @ Xo))) @ (cw3a @ (cwcel @ (ccv @ Xo) @ XS) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ (ccv @ Xo) @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XS)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwcel @ (ccuni @ (ccv @ Xx3)) @ XS))) @ (^ [Xx3:$i] : (ccpw @ XS))))))))))).
