...
thf(chvdistr1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccva) @ ccsm) @ (cco @ (cco @ XA2 @ XB2 @ ccsm) @ (cco @ XA2 @ XC @ ccsm) @ ccva))))))))).
