...
thf(c_19_41vvv_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (cwb @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwa @ (Xph @ Xx3 @ Xy1 @ Xz) @ Xps))))))) @ (cwa @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))) @ Xps))))).
