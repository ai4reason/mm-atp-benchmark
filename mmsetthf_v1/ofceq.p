...
thf(adf_ofc_ax,axiom,(! [XR:($i > $o)] : (cwceq @ (ccofc @ XR) @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xc:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xc:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xc:$i] : (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xc) @ XR))))))))).
thf(cofceq_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwceq @ (ccofc @ XR) @ (ccofc @ XS)))))).
