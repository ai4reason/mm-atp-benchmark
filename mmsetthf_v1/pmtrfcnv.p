...
thf(apmtrfrn_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => ((cwceq @ XR @ (ccrn @ XT)) => ((cwceq @ XP @ (ccdm @ (ccdif @ XF @ ccid))) => (cwi @ (cwcel @ XF @ XR) @ (cwa @ (cw3a @ (cwcel @ XD @ ccvv) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) @ (cwceq @ XF @ (ccfv @ XP @ XT))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(ccsuc_tp,type,(ccsuc : (($i > $o) > ($i > $o)))).
thf(ccom_tp,type,(ccom : ($i > $o))).
thf(cc1o_tp,type,(cc1o : ($i > $o))).
thf(apmtrf_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => (cwi @ (cw3a @ (cwcel @ XD @ XV) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) @ (cwf @ XD @ XD @ (ccfv @ XP @ XT))))))))).
...
thf(cpmtrfcnv_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => ((cwceq @ XR @ (ccrn @ XT)) => (cwi @ (cwcel @ XF @ XR) @ (cwceq @ (cccnv @ XF) @ XF))))))))).
