...
thf(aeel1111_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ Xth) => ((cwi @ Xph @ Xta) => ((cwi @ (cwa @ (cwa @ (cwa @ Xps @ Xch) @ Xth) @ Xta) @ Xet) => (cwi @ Xph @ Xet))))))))))))).
...
thf(aabsefib_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccabs) @ cc1))))).
thf(a_4an31_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ (cwa @ (cwa @ Xch @ Xps) @ Xph) @ Xth) @ Xta) => (cwi @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xta)))))))).
thf(a_4animp1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ (cwb @ Xta @ Xth)) => (cwi @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xta)))))))).
thf(amulre_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) @ (cwb @ (cwcel @ XA2 @ ccr) @ (cwcel @ (cco @ XB2 @ XA2 @ ccmul) @ ccr)))))).
...
thf(aabssinper_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XK @ ccz)) @ (cwceq @ (ccfv @ (ccfv @ (cco @ XA2 @ (cco @ XK @ ccpi @ ccmul) @ ccaddc) @ ccsin) @ ccabs) @ (ccfv @ (ccfv @ XA2 @ ccsin) @ ccabs)))))).
...
thf(a_4an4132_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ (cwa @ (cwa @ Xth @ Xch) @ Xps) @ Xph) @ Xta) => (cwi @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xta)))))))).
...
thf(anot12an2impnot1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ (cwn @ (cwa @ Xph @ Xps)) @ Xps) @ (cwn @ Xph))))).
...
thf(csineq0ALT_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccsin) @ ccc0) @ (cwcel @ (cco @ XA2 @ ccpi @ ccdiv) @ ccz))))).
