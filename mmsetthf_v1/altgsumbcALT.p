...
thf(abcpascm1_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccz)) @ (cwceq @ (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ (cco @ XK @ cc1 @ ccmin) @ ccbc) @ ccaddc) @ (cco @ XN @ XK @ ccbc)))))).
...
thf(caltgsumbcALT_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ ccmul))) @ ccc0)))).
