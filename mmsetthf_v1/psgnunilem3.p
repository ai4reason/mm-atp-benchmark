...
thf(apmtrfmvdn0_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => ((cwceq @ XR @ (ccrn @ XT)) => (cwi @ (cwcel @ XF @ XR) @ (cwne @ (ccdm @ (ccdif @ XF @ ccid)) @ cc0))))))))).
...
thf(apsgnunilem2_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > $o)] : ((! [Xk:$i] : (cwceq @ XG @ (ccfv @ (XD @ Xk) @ ccsymg))) => ((! [Xk:$i] : (cwceq @ (XT @ Xk) @ (ccrn @ (ccfv @ (XD @ Xk) @ ccpmtr)))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwcel @ (XD @ Xk) @ (XV @ Xx3 @ Xw @ Xj @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwcel @ XW @ (ccword @ (XT @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwceq @ (cco @ XG @ XW @ ccgsu) @ (ccres @ ccid @ (XD @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwceq @ (ccfv @ XW @ cchash) @ (XL @ Xj @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwcel @ XI @ (cco @ ccc0 @ (XL @ Xj @ Xk) @ ccfzo))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ XI @ XW) @ ccid))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwral @ (^ [Xk:$i] : (cwn @ (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xk) @ XW) @ ccid))))) @ (^ [Xk:$i] : (cco @ ccc0 @ XI @ ccfzo))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ (cco @ (XL @ Xj @ Xk) @ cc2 @ ccmin)) @ (cwceq @ (cco @ XG @ (ccv @ Xx3) @ ccgsu) @ (ccres @ ccid @ (XD @ Xk))))) @ (^ [Xx3:$i] : (ccword @ (XT @ Xk)))))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xw @ Xk) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwa @ (cwceq @ (cco @ XG @ (ccv @ Xw) @ ccgsu) @ (ccres @ ccid @ (XD @ Xk))) @ (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ (XL @ Xj @ Xk))) @ (cw3a @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ (XL @ Xj @ Xk) @ ccfzo)) @ (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ (ccv @ Xw)) @ ccid))) @ (cwral @ (^ [Xj:$i] : (cwn @ (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xj) @ (ccv @ Xw)) @ ccid))))) @ (^ [Xj:$i] : (cco @ ccc0 @ (cco @ XI @ cc1 @ ccaddc) @ ccfzo)))))) @ (^ [Xw:$i] : (ccword @ (XT @ Xk))))))))))))))))))))))))))))).
...
thf(cpsgnunilem3_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XD @ ccsymg)) => ((cwceq @ XT @ (ccrn @ (ccfv @ XD @ ccpmtr))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XD @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XW @ (ccword @ XT))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XW @ cchash) @ XL)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XW @ cchash) @ ccn)) => ((cwi @ Xph @ (cwceq @ (cco @ XG @ XW @ ccgsu) @ (ccres @ ccid @ XD))) => ((cwi @ Xph @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ (cco @ XL @ cc2 @ ccmin)) @ (cwceq @ (cco @ XG @ (ccv @ Xx3) @ ccgsu) @ (ccres @ ccid @ XD)))) @ (^ [Xx3:$i] : (ccword @ XT))))) => (cwn @ Xph))))))))))))))))).
