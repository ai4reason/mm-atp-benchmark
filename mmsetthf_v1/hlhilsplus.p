...
thf(chlhilsplus_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ ccedring))) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((cwceq @ XR @ (ccfv @ XU @ ccsca)) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwceq @ Xc_pl @ (ccfv @ XE @ ccplusg)) => (cwi @ Xph @ (cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)))))))))))))))))).
