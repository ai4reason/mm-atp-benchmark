...
thf(astoweidlem5_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : ((! [Xd:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xt @ Xd)))) => ((! [Xt:$i] : (! [Xd:$i] : (cwceq @ XD @ (ccif @ (cwbr @ (XC @ Xt @ Xd) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (XC @ Xt @ Xd) @ (cco @ cc1 @ cc2 @ ccdiv))))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwf @ (XT @ Xt @ Xd) @ ccr @ (XP @ Xt))))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwss @ (XQ @ Xt) @ (XT @ Xt @ Xd))))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwcel @ (XC @ Xt @ Xd) @ ccrp)))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwral @ (^ [Xt:$i] : (cwbr @ (XC @ Xt @ Xd) @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ ccle)) @ (^ [Xt:$i] : (XQ @ Xt)))))) => (! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwex @ (^ [Xd:$i] : (cw3a @ (cwcel @ (ccv @ Xd) @ ccrp) @ (cwbr @ (ccv @ Xd) @ cc1 @ cclt) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccv @ Xd) @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ ccle)) @ (^ [Xt:$i] : (XQ @ Xt)))))))))))))))))))))).
...
thf(cstoweidlem28_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : ((cwnfc @ (^ [Xt:$i] : (XU @ Xt))) => ((! [Xd:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xt @ Xd)))) => ((! [Xt:$i] : (! [Xd:$i] : (cwceq @ (XK @ Xt @ Xd) @ (ccfv @ (ccrn @ ccioo) @ cctg)))) => ((! [Xd:$i] : (cwceq @ XT @ (ccuni @ (XJ @ Xd)))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwcel @ (XJ @ Xd) @ cccmp)))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwcel @ XP @ (cco @ (XJ @ Xd) @ (XK @ Xt @ Xd) @ cccn))))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwral @ (^ [Xt:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ XP) @ cclt)) @ (^ [Xt:$i] : (ccdif @ XT @ (XU @ Xt))))))) => ((! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwcel @ (XU @ Xt) @ (XJ @ Xd))))) => (! [Xt:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xt @ Xd) @ (cwex @ (^ [Xd:$i] : (cw3a @ (cwcel @ (ccv @ Xd) @ ccrp) @ (cwbr @ (ccv @ Xd) @ cc1 @ cclt) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccv @ Xd) @ (ccfv @ (ccv @ Xt) @ XP) @ ccle)) @ (^ [Xt:$i] : (ccdif @ XT @ (XU @ Xt))))))))))))))))))))))))).
