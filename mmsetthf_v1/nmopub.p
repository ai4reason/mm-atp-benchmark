...
thf(anmopsetretALT_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ cchil @ XT) @ (cwss @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xy1) @ ccno) @ cc1 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccno)))) @ (^ [Xy1:$i] : cchil)))) @ ccr)))).
...
thf(cnmopub_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XT) @ (cwcel @ XA2 @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ XT @ ccnop) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xx3) @ ccno) @ cc1 @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) @ XA2 @ ccle))) @ (^ [Xx3:$i] : cchil))))))).
