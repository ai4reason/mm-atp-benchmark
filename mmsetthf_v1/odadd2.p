...
thf(codadd2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccod)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccabl) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccmul) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XO) @ (cco @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccgcd) @ cc2 @ ccexp) @ ccmul) @ ccdvds)))))))))))).
