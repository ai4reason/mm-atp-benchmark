...
thf(cptopn2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ cctop @ XF)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XO @ Xk) @ (ccfv @ XY @ XF)))) => (cwi @ Xph @ (cwcel @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ XY) @ (XO @ Xk) @ (ccuni @ (ccfv @ (ccv @ Xk) @ XF))))) @ (ccfv @ XF @ ccpt))))))))))))).
