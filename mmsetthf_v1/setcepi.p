...
thf(aepihom_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((cwceq @ XE @ (ccfv @ XC @ ccepi)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwss @ (cco @ XX @ XY @ XE) @ (cco @ XX @ XY @ XH))))))))))))))))))).
...
thf(aepii_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((cwceq @ XE @ (ccfv @ XC @ ccepi)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ XY @ XE))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XY @ XZ @ XH))) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ XY @ XZ @ XH))) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_x)) @ (cco @ XK @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_x))) @ (cwceq @ XG @ XK))))))))))))))))))))))))))).
...
thf(aisepi2_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xh:$i] : (cwceq @ (XB2 @ Xh) @ (ccfv @ (XC @ Xh) @ ccbs))) => ((! [Xh:$i] : (cwceq @ XH @ (ccfv @ (XC @ Xh) @ cchom))) => ((! [Xh:$i] : (cwceq @ Xc_x @ (ccfv @ (XC @ Xh) @ ccco))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwceq @ (XE @ Xz @ Xg1 @ Xh) @ (ccfv @ (XC @ Xh) @ ccepi))))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ (XC @ Xh) @ cccat))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XX @ (XB2 @ Xh)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XY @ (XB2 @ Xh)))) => (! [Xz:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwb @ (cwcel @ XF @ (cco @ XX @ XY @ (XE @ Xz @ Xg1 @ Xh))) @ (cwa @ (cwcel @ XF @ (cco @ XX @ XY @ XH)) @ (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xg1:$i] : (cwral @ (^ [Xh:$i] : (cwi @ (cwceq @ (cco @ (ccv @ Xg1) @ XF @ (cco @ (ccop @ XX @ XY) @ (ccv @ Xz) @ Xc_x)) @ (cco @ (ccv @ Xh) @ XF @ (cco @ (ccop @ XX @ XY) @ (ccv @ Xz) @ Xc_x))) @ (cwceq @ (ccv @ Xg1) @ (ccv @ Xh)))) @ (^ [Xh:$i] : (cco @ XY @ (ccv @ Xz) @ XH)))) @ (^ [Xg1:$i] : (cco @ XY @ (ccv @ Xz) @ XH)))) @ (^ [Xz:$i] : (XB2 @ Xh)))))))))))))))))))))))))).
thf(csetcepi_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccsetc)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XU)) => ((cwi @ Xph @ (cwcel @ XY @ XU)) => ((cwceq @ XE @ (ccfv @ XC @ ccepi)) => ((cwi @ Xph @ (cwcel @ cc2o @ XU)) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ (cco @ XX @ XY @ XE)) @ (cwfo @ XX @ XY @ XF)))))))))))))))))).
