...
thf(cresunimafz0_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwfun @ XI)) => ((cwi @ Xph @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF)) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) => (cwi @ Xph @ (cwceq @ (ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ XN @ ccfz))) @ (ccun @ (ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ XN @ ccfzo))) @ (ccsn @ (ccop @ (ccfv @ XN @ XF) @ (ccfv @ (ccfv @ XN @ XF) @ XI)))))))))))))).
