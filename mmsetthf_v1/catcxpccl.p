...
thf(awuntp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XB2 @ XU)) => ((cwi @ Xph @ (cwcel @ XC @ XU)) => (cwi @ Xph @ (cwcel @ (cctp @ XA2 @ XB2 @ XC) @ XU)))))))))))).
...
thf(ccatcxpccl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ cccatc)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XT @ (cco @ XX @ XY @ ccxpc)) => ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ ccom @ XU)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwcel @ XT @ XB2))))))))))))))))).
