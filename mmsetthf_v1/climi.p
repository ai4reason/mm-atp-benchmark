...
thf(cclimi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwcel @ XC @ ccrp)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XB2 @ Xj @ Xk))))) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ ccli)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (cwcel @ (XB2 @ Xj @ Xk) @ ccc) @ (cwbr @ (ccfv @ (cco @ (XB2 @ Xj @ Xk) @ XA2 @ ccmin) @ ccabs) @ XC @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))))).
