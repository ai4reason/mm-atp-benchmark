...
thf(ctxss12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XD @ XW)) @ (cwa @ (cwss @ XA2 @ XB2) @ (cwss @ XC @ XD))) @ (cwss @ (cco @ XA2 @ XC @ cctx) @ (cco @ XB2 @ XD @ cctx)))))))))).
