...
thf(agrpinvfn_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccfv @ XG @ ccminusg)) => (cwfn @ XN @ XB2))))))).
...
thf(cisgrpinv_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwceq @ XN @ (ccfv @ XG @ ccminusg)) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwb @ (cwa @ (cwf @ XB2 @ XB2 @ XM) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccv @ Xx3) @ Xc_pl) @ Xc_0)) @ (^ [Xx3:$i] : XB2))) @ (cwceq @ XN @ XM)))))))))))))).
