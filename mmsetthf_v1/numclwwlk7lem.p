...
thf(cnumclwwlk7lem_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwa @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XG @ ccfrgr)) @ (cwa @ (cwne @ XV @ cc0) @ (cwcel @ XV @ ccfn))) @ (cwcel @ XK @ ccn0))))))).
