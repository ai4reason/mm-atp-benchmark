...
thf(ccncfmet_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XC @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XA2 @ XA2))) => ((cwceq @ XD @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XB2 @ XB2))) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XK @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwss @ XA2 @ ccc) @ (cwss @ XB2 @ ccc)) @ (cwceq @ (cco @ XA2 @ XB2 @ cccncf) @ (cco @ XJ @ XK @ cccn)))))))))))))).
