...
thf(cprmlem1_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwbr @ cc1 @ XN @ cclt) => ((cwn @ (cwbr @ cc2 @ XN @ ccdvds)) => ((cwn @ (cwbr @ cc3 @ XN @ ccdvds)) => ((cwbr @ XN @ (ccdc @ cc2 @ cc5) @ cclt) => (cwcel @ XN @ ccprime)))))))).
