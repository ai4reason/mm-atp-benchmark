...
thf(cdochkr1OLDN_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccfv @ (XK @ Xx3) @ cclh))) => ((! [Xx3:$i] : (cwceq @ Xc_pe @ (ccfv @ (XW @ Xx3) @ (ccfv @ (XK @ Xx3) @ ccoch)))) => ((! [Xx3:$i] : (cwceq @ XU @ (ccfv @ (XW @ Xx3) @ (ccfv @ (XK @ Xx3) @ ccdvh)))) => ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ XU @ ccbs))) => ((cwceq @ XR @ (ccfv @ XU @ ccsca)) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XR @ cc0g))) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccfv @ XU @ cclfn))) => ((cwceq @ XL @ (ccfv @ XU @ cclk)) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwa @ (cwcel @ (XK @ Xx3) @ cchlt) @ (cwcel @ (XW @ Xx3) @ (XH @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XG @ (XF @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwne @ (ccfv @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ Xc_pe) @ (XV @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XG) @ Xc_1)) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ XG @ XL) @ Xc_pe))))))))))))))))))))))))))))))).
