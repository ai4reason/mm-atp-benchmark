...
thf(cpi1id_conj,conjecture,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwceq @ Xc_0 @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ XY))) => (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XY @ XX)) @ (cwceq @ (ccec @ Xc_0 @ (ccfv @ XJ @ ccphtpc)) @ (ccfv @ XG @ cc0g))))))))))).
