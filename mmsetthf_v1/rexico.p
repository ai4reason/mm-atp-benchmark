...
thf(crexico_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) @ (Xph @ Xk))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : (cco @ XB2 @ ccpnf @ ccico))) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwi @ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) @ (Xph @ Xk))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : ccr)))))))).
