...
thf(afsuppco_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwbr @ XF @ XZ @ ccfsupp)) => ((cwi @ Xph @ (cwf1 @ XX @ XY @ XG)) => ((cwi @ Xph @ (cwcel @ XZ @ XW)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => (cwi @ Xph @ (cwbr @ (cccom @ XF @ XG) @ XZ @ ccfsupp))))))))))))))).
...
thf(cmapfienlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [Xf1:$i] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XZ @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ XB2 @ XA2 @ ccmap))))) => ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XW @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ XD @ XC @ ccmap))))) => ((cwceq @ XW @ (ccfv @ XZ @ XG)) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf1o @ XC @ XA2 @ XF))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwf1o @ XB2 @ XD @ XG))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccvv))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccvv))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XC @ ccvv))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XD @ ccvv))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XZ @ XB2))) => (! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xf1) @ (XS @ Xx3))) @ (cwbr @ (cccom @ XG @ (cccom @ (ccv @ Xf1) @ XF)) @ XW @ ccfsupp)))))))))))))))))))))))))).
