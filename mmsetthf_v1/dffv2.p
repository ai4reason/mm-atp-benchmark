...
thf(afunfv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccuni @ (ccima @ XF @ (ccsn @ XA2)))))))).
...
thf(anfunsn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwn @ (cwfun @ (ccres @ XF @ (ccsn @ XA2)))) @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0))))).
...
thf(adffun3_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwfun @ XA2) @ (cwa @ (cwrel @ XA2) @ (cwal @ (^ [Xx3:$i] : (cwex @ (^ [Xz:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz))))))))))))).
...
thf(andmima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ (ccdm @ XB2))) @ (cwceq @ (ccima @ XB2 @ (ccsn @ XA2)) @ cc0))))).
thf(a_0dif_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccdif @ cc0 @ XA2) @ cc0))).
thf(cdffv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (ccfv @ XA2 @ XF) @ (ccuni @ (ccdif @ (ccima @ XF @ (ccsn @ XA2)) @ (ccuni @ (ccuni @ (ccdif @ (cccom @ (ccres @ XF @ (ccsn @ XA2)) @ (cccnv @ (ccres @ XF @ (ccsn @ XA2)))) @ ccid))))))))).
