...
thf(cfmco_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XW) @ (cwcel @ XB2 @ (ccfv @ XZ @ ccfbas))) @ (cwa @ (cwf @ XY @ XX @ XF) @ (cwf @ XZ @ XY @ XG))) @ (cwceq @ (ccfv @ XB2 @ (cco @ XX @ (cccom @ XF @ XG) @ ccfm)) @ (ccfv @ (ccfv @ XB2 @ (cco @ XY @ XG @ ccfm)) @ (cco @ XX @ XF @ ccfm))))))))))))).
