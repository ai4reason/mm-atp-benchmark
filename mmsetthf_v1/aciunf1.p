...
thf(aaciunf1lem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XA2 @ Xj) @ (XV @ Xx3 @ Xf1 @ Xj)))))) => ((! [Xf1:$i] : (! [Xj:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xj) @ (XA2 @ Xj))) @ (cwne @ (XB2 @ Xj) @ cc0)))) => ((cwnfc @ (^ [Xj:$i] : (XA2 @ Xj))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xj) @ (XA2 @ Xj))) @ (cwcel @ (XB2 @ Xj) @ (XW @ Xx3 @ Xf1)))))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1 @ (cciun @ (^ [Xj:$i] : (XA2 @ Xj)) @ (^ [Xj:$i] : (XB2 @ Xj))) @ (cciun @ (^ [Xj:$i] : (XA2 @ Xj)) @ (^ [Xj:$i] : (ccxp @ (ccsn @ (ccv @ Xj)) @ (XB2 @ Xj)))) @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ cc2nd) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (cciun @ (^ [Xj:$i] : (XA2 @ Xj)) @ (^ [Xj:$i] : (XB2 @ Xj)))))))))))))))))))).
...
thf(arabtru_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : (cwceq @ (ccrab @ (^ [Xx3:$i] : cwtru) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (XA2 @ Xx3)))))).
