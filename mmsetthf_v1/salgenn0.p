...
thf(csalgenn0_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xs1:$i] : (cwi @ (cwcel @ XX @ (XV @ Xs1)) @ (cwne @ (ccrab @ (^ [Xs1:$i] : (cwa @ (cwceq @ (ccuni @ (ccv @ Xs1)) @ (ccuni @ XX)) @ (cwss @ XX @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : ccsalg)) @ cc0)))))).
