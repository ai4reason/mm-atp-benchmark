...
thf(cndisj2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xy1))))) => (cwb @ (cwn @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwne @ (ccin @ (XB2 @ Xx3) @ (XC @ Xy1)) @ cc0))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))))).
