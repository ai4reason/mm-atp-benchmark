...
thf(adf_ablo_ax,axiom,(cwceq @ ccablo @ (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xg1)))) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xg1))))) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1))))) @ (^ [Xg1:$i] : ccgr)))).
thf(cisablo_conj,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwb @ (cwcel @ XG @ ccablo) @ (cwa @ (cwcel @ XG @ ccgr) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))).
