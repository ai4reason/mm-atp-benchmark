...
thf(cefif1olem2_conj,conjecture,(! [Xz:$i] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccaddc) @ ccioc)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccv @ Xz) @ ccr)) @ (cwrex @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ ccmin) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ ccz)) @ (^ [Xy1:$i] : XD)))))))).
