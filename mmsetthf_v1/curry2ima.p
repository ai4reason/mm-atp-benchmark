...
thf(acurry2f_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ (ccsn @ XC)))))) => (cwi @ (cwa @ (cwf @ (ccxp @ XA2 @ XB2) @ XD @ XF) @ (cwcel @ XC @ XB2)) @ (cwf @ XA2 @ XD @ XG)))))))))).
...
thf(acurry2val_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ (ccsn @ XC)))))) => (cwi @ (cwa @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwcel @ XC @ XB2)) @ (cwceq @ (ccfv @ XD @ XG) @ (cco @ XD @ XC @ XF))))))))))).
thf(aeqcom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwceq @ XA2 @ XB2) @ (cwceq @ XB2 @ XA2))))).
thf(ccurry2ima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ (ccsn @ XC)))))) => (cwi @ (cw3a @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwcel @ XC @ XB2) @ (cwss @ XD @ XA2)) @ (cwceq @ (ccima @ XG @ XD) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ XC @ XF))) @ (^ [Xx3:$i] : XD)))))))))))))).
