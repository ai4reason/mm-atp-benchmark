...
thf(aomelon2_thm,axiom,(cwi @ (cwcel @ ccom @ ccvv) @ (cwcel @ ccom @ ccon0))).
...
thf(afifo_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XF @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccsn @ cc0))) @ (^ [Xy1:$i] : (ccint @ (ccv @ Xy1)))))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ XV) @ (cwfo @ (ccdif @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccsn @ cc0)) @ (ccfv @ XA2 @ ccfi) @ (XF @ Xy1))))))))).
...
thf(cfictb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwb @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwbr @ (ccfv @ XA2 @ ccfi) @ ccom @ ccdom)))))).
