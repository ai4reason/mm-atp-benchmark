...
thf(cdiporthcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ XP) @ ccc0) @ (cwceq @ (cco @ XB2 @ XA2 @ XP) @ ccc0))))))))))).
