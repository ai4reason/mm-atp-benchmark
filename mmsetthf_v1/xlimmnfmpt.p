...
thf(axlimmnf_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwcel @ (XM @ Xx3 @ Xj @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ (XM @ Xx3 @ Xj @ Xk) @ ccuz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwf @ (XZ @ Xk) @ ccxr @ (XF @ Xk)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwb @ (cwbr @ (XF @ Xk) @ ccmnf @ cclsxlim) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ (ccv @ Xx3) @ ccle)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xk)))) @ (^ [Xx3:$i] : ccr)))))))))))))))).
...
thf(cxlimmnfmpt_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xx3 @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwcel @ (XM @ Xx3 @ Xj @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xj @ Xk) @ ccuz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xj @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XB2 @ Xk) @ ccxr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XF @ Xx3 @ Xj @ Xk) @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwb @ (cwbr @ (XF @ Xx3 @ Xj @ Xk) @ ccmnf @ cclsxlim) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (XB2 @ Xk) @ (ccv @ Xx3) @ ccle)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))))))))).
