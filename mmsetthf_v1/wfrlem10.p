...
thf(awfrlem8_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccwrecs @ XA2 @ XR @ XG)) => (cwb @ (cwceq @ (ccpred @ (ccdif @ XA2 @ (ccdm @ XF)) @ XR @ XX) @ cc0) @ (cwceq @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ (ccdm @ XF) @ XR @ XX)))))))))).
...
thf(aelpred_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ ccvv) => (cwi @ (cwcel @ XX @ XD) @ (cwb @ (cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) @ (cwa @ (cwcel @ XY @ XA2) @ (cwbr @ XY @ XX @ XR))))))))))).
thf(cwfrlem10_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xz:$i] : (cwwe @ XA2 @ (XR @ Xz))) => ((! [Xz:$i] : (cwceq @ (XF @ Xz) @ (ccwrecs @ XA2 @ (XR @ Xz) @ (XG @ Xz)))) => (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz)))) @ (cwceq @ (ccpred @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz))) @ (XR @ Xz) @ (ccv @ Xz)) @ cc0)) @ (cwceq @ (ccpred @ XA2 @ (XR @ Xz) @ (ccv @ Xz)) @ (ccdm @ (XF @ Xz)))))))))))).
