...
thf(afiluni_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwss @ XF @ (ccfv @ XX @ ccfil)) @ (cwne @ XF @ cc0) @ (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : (cwcel @ (ccun @ (ccv @ Xf1) @ (ccv @ Xg1)) @ XF)) @ (^ [Xg1:$i] : XF))) @ (^ [Xf1:$i] : XF))) @ (cwcel @ (ccuni @ XF) @ (ccfv @ XX @ ccfil)))))).
...
thf(aisufil2_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwss @ XF @ (ccv @ Xf1)) @ (cwceq @ XF @ (ccv @ Xf1)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))).
thf(asimplr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xps))))).
thf(cfilssufilg_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ (ccpw @ (ccpw @ XX)) @ (ccdm @ cccrd))) @ (cwrex @ (^ [Xf1:$i] : (cwss @ XF @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil))))))).
