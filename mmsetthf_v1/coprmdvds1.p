...
thf(acoprmgcdb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwral @ (^ [Xi:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xi) @ XA2 @ ccdvds) @ (cwbr @ (ccv @ Xi) @ XB2 @ ccdvds)) @ (cwceq @ (ccv @ Xi) @ cc1))) @ (^ [Xi:$i] : ccn)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1)))))).
...
thf(ccoprmdvds1_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ ccn) @ (cwcel @ XG @ ccn) @ (cwceq @ (cco @ XF @ XG @ ccgcd) @ cc1)) @ (cwi @ (cw3a @ (cwcel @ XI @ ccn) @ (cwbr @ XI @ XF @ ccdvds) @ (cwbr @ XI @ XG @ ccdvds)) @ (cwceq @ XI @ cc1))))))).
