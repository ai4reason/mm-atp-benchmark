...
thf(adf_fz_ax,axiom,(cwceq @ ccfz @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xm:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xk:$i] : (cwa @ (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccle) @ (cwbr @ (ccv @ Xk) @ (ccv @ Xn) @ ccle))) @ (^ [Xk:$i] : ccz))))))).
...
thf(cfzval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XM @ XN @ ccfz) @ (ccrab @ (^ [Xk:$i] : (cwa @ (cwbr @ XM @ (ccv @ Xk) @ ccle) @ (cwbr @ (ccv @ Xk) @ XN @ ccle))) @ (^ [Xk:$i] : ccz))))))).
