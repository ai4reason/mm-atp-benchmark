...
thf(azrhre_thm,axiom,(cwceq @ (ccfv @ ccrefld @ cczrh) @ (ccres @ ccid @ ccz))).
...
thf(azrhchr_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwb @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0) @ (cwf1 @ ccz @ XB2 @ XL))))))))))).
...
thf(azrhf1ker_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwb @ (cwf1 @ ccz @ XB2 @ XL) @ (cwceq @ (ccima @ (cccnv @ XL) @ (ccsn @ Xc_0)) @ (ccsn @ ccc0)))))))))))).
...
thf(aredvr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ (cco @ XA2 @ XB2 @ (ccfv @ ccrefld @ ccdvr)) @ (cco @ XA2 @ XB2 @ ccdiv)))))).
...
thf(cqqhre_conj,conjecture,(cwceq @ (ccfv @ ccrefld @ ccqqh) @ (ccres @ ccid @ ccq))).
