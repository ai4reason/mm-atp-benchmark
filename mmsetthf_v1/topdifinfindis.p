...
thf(ctopdifinfindis_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XT @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwn @ (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) @ (cwo @ (cwceq @ (ccv @ Xx3) @ cc0) @ (cwceq @ (ccv @ Xx3) @ XA2)))) @ (^ [Xx3:$i] : (ccpw @ XA2))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwceq @ (XT @ Xx3) @ (ccpr @ cc0 @ XA2)))))))).
