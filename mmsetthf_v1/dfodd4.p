...
thf(adfodd2_thm,axiom,(cwceq @ ccodd @ (ccrab @ (^ [Xz:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xz) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccz)) @ (^ [Xz:$i] : ccz)))).
...
thf(am1mod0mod1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccr) @ (cwbr @ cc1 @ XN @ cclt)) @ (cwb @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmo) @ ccc0) @ (cwceq @ (cco @ XA2 @ XN @ ccmo) @ cc1)))))).
thf(cdfodd4_conj,conjecture,(cwceq @ ccodd @ (ccrab @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xz) @ cc2 @ ccmo) @ cc1)) @ (^ [Xz:$i] : ccz)))).
