...
thf(aecex2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ (ccres @ XR @ XA2) @ XV) @ (cwi @ (cwcel @ XB2 @ XA2) @ (cwcel @ (ccec @ XB2 @ XR) @ ccvv)))))))).
...
thf(cuniqsALTV_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ (ccres @ XR @ XA2) @ XV) @ (cwceq @ (ccuni @ (ccqs @ XA2 @ XR)) @ (ccima @ XR @ XA2))))))).
