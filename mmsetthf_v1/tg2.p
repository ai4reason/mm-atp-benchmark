...
thf(ctg2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) @ (cwcel @ XC @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XC @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XA2))) @ (^ [Xx3:$i] : XB2))))))).
