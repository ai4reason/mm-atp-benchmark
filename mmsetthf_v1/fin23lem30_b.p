...
thf(aominf_thm,axiom,(cwn @ (cwcel @ ccom @ ccfn))).
...
thf(afin23lem20_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XU @ Xt) @ (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) @ cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))) => (! [Xt:$i] : (cwi @ (cwcel @ (XA2 @ Xt) @ ccom) @ (cwo @ (cwss @ (ccint @ (ccrn @ (XU @ Xt))) @ (ccfv @ (XA2 @ Xt) @ (ccv @ Xt))) @ (cwceq @ (ccin @ (ccint @ (ccrn @ (XU @ Xt))) @ (ccfv @ (XA2 @ Xt) @ (ccv @ Xt))) @ cc0)))))))).
...
thf(cfin23lem30_b_conj,conjecture,(! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xt:$i] : (cwceq @ (XU @ Xx3 @ Xw @ Xt) @ (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ (cwceq @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) @ cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xi:$i] : (cwceq @ (XF @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xi) @ (ccab @ (^ [Xw:$i] : (cwral @ (^ [Xa:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) @ (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xw)) @ ccom @ ccmap)))))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (cwceq @ (XP @ Xv @ Xu @ Xt @ Xi) @ (ccrab @ (^ [Xv:$i] : (cwss @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt))) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xt)))) @ (^ [Xv:$i] : ccom))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XQ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi @ Xa) @ (ccmpt @ (^ [Xw:$i] : ccom) @ (^ [Xw:$i] : (ccrio @ (^ [Xx3:$i] : (cwbr @ (ccin @ (ccv @ Xx3) @ (XP @ Xv @ Xu @ Xt @ Xi)) @ (ccv @ Xw) @ ccen)) @ (^ [Xx3:$i] : (XP @ Xv @ Xu @ Xt @ Xi)))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (cwceq @ (XR @ Xx3 @ Xz @ Xw @ Xt) @ (ccmpt @ (^ [Xw:$i] : ccom) @ (^ [Xw:$i] : (ccrio @ (^ [Xx3:$i] : (cwbr @ (ccin @ (ccv @ Xx3) @ (ccdif @ ccom @ (XP @ Xv @ Xu @ Xt @ Xi))) @ (ccv @ Xw) @ ccen)) @ (^ [Xx3:$i] : (ccdif @ ccom @ (XP @ Xv @ Xu @ Xt @ Xi)))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xa:$i] : (cwceq @ (XZ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi) @ (ccif @ (cwcel @ (XP @ Xv @ Xu @ Xt @ Xi) @ ccfn) @ (cccom @ (ccv @ Xt) @ (XR @ Xx3 @ Xz @ Xw @ Xt)) @ (cccom @ (ccmpt @ (^ [Xz:$i] : (XP @ Xv @ Xu @ Xt @ Xi)) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt)))))) @ (XQ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi @ Xa)))))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (cwi @ (cwfun @ (ccv @ Xt)) @ (cwceq @ (ccin @ (ccuni @ (ccrn @ (XZ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi))) @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt)))) @ cc0)))))))))))))))))))))).
