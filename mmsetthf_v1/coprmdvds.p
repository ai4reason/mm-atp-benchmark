...
thf(advdsmulgcd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwb @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XB2 @ (cco @ XC @ XA2 @ ccgcd) @ ccmul) @ ccdvds))))))).
...
thf(ccoprmdvds_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwa @ (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds) @ (cwceq @ (cco @ XK @ XM @ ccgcd) @ cc1)) @ (cwbr @ XK @ XN @ ccdvds))))))).
