...
thf(cnormpyc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwi @ (cwceq @ (cco @ XA2 @ XB2 @ ccsp) @ ccc0) @ (cwbr @ (ccfv @ XA2 @ ccno) @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ ccle)))))).
