...
thf(cfprodm1s_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) @ (cwcel @ (XA2 @ Xk) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (cco @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsb @ XN @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccmul)))))))))).
