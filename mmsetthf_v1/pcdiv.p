...
thf(cpcdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ XB2 @ ccn)) @ (cwceq @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccdiv) @ ccpc) @ (cco @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccmin))))))).
