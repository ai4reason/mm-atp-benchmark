...
thf(adf_ur_ax,axiom,(cwceq @ ccur @ (cccom @ cc0g @ ccmgp))).
...
thf(cprds1_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccrg @ XR)) => (cwi @ Xph @ (cwceq @ (cccom @ ccur @ XR) @ (ccfv @ XY @ ccur))))))))))))))).
