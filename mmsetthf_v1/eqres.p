...
thf(ceqres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XR @ (ccres @ XS @ XC)) => (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ XR) @ (cwa @ (cwcel @ XA2 @ XC) @ (cwbr @ XA2 @ XB2 @ XS)))))))))))).
