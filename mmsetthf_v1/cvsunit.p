...
thf(ccvsunit_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cwcel @ XW @ cccvs) @ (cwceq @ (ccdif @ XK @ (ccsn @ ccc0)) @ (ccfv @ XF @ ccui))))))))).
