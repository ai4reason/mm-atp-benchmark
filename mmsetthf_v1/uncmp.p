...
thf(cuncmp_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwceq @ XX @ (ccun @ XS @ XT))) @ (cwa @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp) @ (cwcel @ (cco @ XJ @ XT @ ccrest) @ cccmp))) @ (cwcel @ XJ @ cccmp)))))))).
