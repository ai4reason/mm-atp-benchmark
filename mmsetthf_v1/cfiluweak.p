...
thf(ccfiluweak_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwss @ XA2 @ XX) @ (cwcel @ XF @ (ccfv @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ cccfilu))) @ (cwcel @ XF @ (ccfv @ XU @ cccfilu)))))))).
