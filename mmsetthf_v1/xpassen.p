...
thf(aen2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (XC @ Xx3) @ ccvv))) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwcel @ (XD @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (XC @ Xx3))) @ (cwa @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwceq @ (ccv @ Xx3) @ (XD @ Xy1)))))) => (cwbr @ XA2 @ XB2 @ ccen))))))))))).
...
thf(aeq2tri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ (cwceq @ XA2 @ XC) @ (cwceq @ XD @ XF)) => ((cwi @ (cwceq @ XB2 @ XD) @ (cwceq @ XC @ XG)) => (cwb @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XF)) @ (cwa @ (cwceq @ XB2 @ XD) @ (cwceq @ XA2 @ XG)))))))))))).
