...
thf(copthprc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwb @ (cwceq @ (ccun @ (ccxp @ XA2 @ (ccsn @ cc0)) @ (ccxp @ XB2 @ (ccsn @ (ccsn @ cc0)))) @ (ccun @ (ccxp @ XC @ (ccsn @ cc0)) @ (ccxp @ XD @ (ccsn @ (ccsn @ cc0))))) @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)))))))).
