...
thf(copelopab4_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xv:$i] : (! [Xu:$i] : (cwb @ (cwcel @ (ccop @ (ccv @ Xu) @ (ccv @ Xv)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwa @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xu)) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xv))) @ (Xph @ Xx3 @ Xy1))))))))))).
