...
thf(crnghmsubcsetclem1_conj,conjecture,(! [Xph:$o] : (! [Xx3:$i] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccestrc)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccin @ ccrng @ XU))) => ((cwi @ Xph @ (cwceq @ XH @ (ccres @ ccrngh @ (ccxp @ XB2 @ XB2)))) => (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XC @ cccid)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XH))))))))))))))).
