...
thf(aqsqcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccq)))).
...
thf(amsqsqrtd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ XA2)))))).
...
thf(crmxyadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwceq @ (cco @ XA2 @ (cco @ XM @ XN @ ccaddc) @ ccrmx) @ (cco @ (cco @ (cco @ XA2 @ XM @ ccrmx) @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmul) @ ccaddc)) @ (cwceq @ (cco @ XA2 @ (cco @ XM @ XN @ ccaddc) @ ccrmy) @ (cco @ (cco @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ (cco @ XA2 @ XM @ ccrmx) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccaddc)))))))).
