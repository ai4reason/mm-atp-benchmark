...
thf(cuntsucf_conj,conjecture,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xy1:$i] : (XA2 @ Xy1))) => (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccsuc @ (XA2 @ Xy1))))))))).
