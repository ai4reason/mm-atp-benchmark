...
thf(aperpln2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (cwi @ Xph @ (cwcel @ XB2 @ (ccrn @ XL)))))))))))).
...
thf(chlperpnel_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccrn @ XL))) => ((cwceq @ XK @ (ccfv @ XG @ cchlg)) => ((cwi @ Xph @ (cwcel @ XU @ XA2)) => ((cwi @ Xph @ (cwcel @ XV @ XP)) => ((cwi @ Xph @ (cwcel @ XW @ XP)) => ((cwi @ Xph @ (cwbr @ XA2 @ (cco @ XU @ XV @ XL) @ (ccfv @ XG @ ccperpg))) => ((cwi @ Xph @ (cwbr @ XV @ XW @ (ccfv @ XU @ XK))) => (cwi @ Xph @ (cwn @ (cwcel @ XW @ XA2))))))))))))))))))))))))))).
