...
thf(cficardun2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwss @ (ccfv @ (ccun @ XA2 @ XB2) @ cccrd) @ (cco @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd) @ ccoa)))))).
