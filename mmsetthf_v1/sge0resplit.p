...
thf(asge0supre_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XF)))))) @ ccr @ cclt))))))))))).
...
thf(asge0rnre_thm,axiom,(! [Xph:$o] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ (XF @ Xx3 @ Xy1))))) => (cwi @ Xph @ (cwss @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (XF @ Xx3 @ Xy1))))))) @ ccr))))))).
...
thf(anelrnres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ (ccrn @ XB2))) @ (cwn @ (cwcel @ XA2 @ (ccrn @ (ccres @ XB2 @ XC))))))))).
thf(asge0rnn0_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xy1:$i] : (cwne @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ (XX @ Xy1)) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (XF @ Xy1))))))) @ cc0))))).
thf(ampbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ Xph @ Xch))))))).
thf(aeqcomd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ XB2 @ XA2))))))).
thf(asge0reval_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ (XX @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwf @ (XX @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ (XX @ Xy1)) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XF)))))) @ ccxr @ cclt)))))))))))).
thf(asupxrre3_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0)) @ (cwb @ (cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)))))).
...
thf(assin0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwss @ XC @ XA2) @ (cwss @ XD @ XB2)) @ (cwceq @ (ccin @ XC @ XD) @ cc0))))))).
...
thf(csge0resplit_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwceq @ XU @ (ccun @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) => ((cwi @ Xph @ (cwf @ XU @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (cco @ (ccfv @ (ccres @ XF @ XA2) @ ccsumge0) @ (ccfv @ (ccres @ XF @ XB2) @ ccsumge0) @ ccaddc))))))))))))))))).
