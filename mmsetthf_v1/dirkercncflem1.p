...
thf(acoseq0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccos) @ ccc0) @ (cwcel @ (cco @ (cco @ XA2 @ ccpi @ ccdiv) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccz))))).
thf(cdirkercncflem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XA2 @ Xy1) @ (cco @ XY @ ccpi @ ccmin))) => ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (cco @ XY @ ccpi @ ccaddc))) => ((cwi @ Xph @ (cwcel @ XY @ ccr)) => ((cwi @ Xph @ (cwceq @ (cco @ XY @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0)) => (! [Xy1:$i] : (cwi @ Xph @ (cwa @ (cwcel @ XY @ (cco @ (XA2 @ Xy1) @ (XB2 @ Xy1) @ ccioo)) @ (cwral @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccc0) @ (cwne @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ cccos) @ ccc0))) @ (^ [Xy1:$i] : (ccdif @ (cco @ (XA2 @ Xy1) @ (XB2 @ Xy1) @ ccioo) @ (ccsn @ XY)))))))))))))))).
