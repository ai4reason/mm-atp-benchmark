...
thf(csymgfcoeu_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ (ccfv @ XD @ ccsymg) @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XD @ XV) @ (cwcel @ XP @ XG) @ (cwcel @ XQ @ XG)) @ (cwreu @ (^ [Xp:$i] : (cwceq @ XQ @ (cccom @ XP @ (ccv @ Xp)))) @ (^ [Xp:$i] : XG)))))))))).
