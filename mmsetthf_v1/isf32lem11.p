...
thf(cisf32lem11_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XG @ (XV @ Xb)) @ (cw3a @ (cwf @ ccom @ (ccpw @ XG) @ XF) @ (cwral @ (^ [Xb:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xb)) @ XF) @ (ccfv @ (ccv @ Xb) @ XF))) @ (^ [Xb:$i] : ccom)) @ (cwn @ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF))))) @ (cwbr @ ccom @ XG @ ccwdom))))))).
