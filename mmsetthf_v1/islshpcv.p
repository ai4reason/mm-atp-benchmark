...
thf(aislshpat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((! [Xq:$i] : (cwceq @ (XH @ Xq) @ (ccfv @ XW @ cclsh))) => ((! [Xq:$i] : (cwceq @ (XA2 @ Xq) @ (ccfv @ XW @ cclsa))) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => (! [Xq:$i] : (cwi @ Xph @ (cwb @ (cwcel @ XU @ (XH @ Xq)) @ (cw3a @ (cwcel @ XU @ XS) @ (cwne @ XU @ XV) @ (cwrex @ (^ [Xq:$i] : (cwceq @ (cco @ XU @ (ccv @ Xq) @ Xc_po) @ XV)) @ (^ [Xq:$i] : (XA2 @ Xq)))))))))))))))))))))).
...
thf(alcv2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwcel @ XQ @ XA2)) => (cwi @ Xph @ (cwb @ (cwpss @ XU @ (cco @ XU @ XQ @ Xc_po)) @ (cwbr @ XU @ (cco @ XU @ XQ @ Xc_po) @ XC))))))))))))))))))).
...
thf(alcvat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((! [Xq:$i] : (cwceq @ (Xc_po @ Xq) @ (ccfv @ XW @ cclsm))) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((! [Xq:$i] : (cwceq @ (XC @ Xq) @ (ccfv @ XW @ cclcv))) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((! [Xq:$i] : (cwi @ Xph @ (cwbr @ XT @ XU @ (XC @ Xq)))) => (cwi @ Xph @ (cwrex @ (^ [Xq:$i] : (cwceq @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq)) @ XU)) @ (^ [Xq:$i] : XA2)))))))))))))))))))).
thf(cislshpcv_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XH @ (ccfv @ XW @ cclsh)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => (cwi @ Xph @ (cwb @ (cwcel @ XU @ XH) @ (cwa @ (cwcel @ XU @ XS) @ (cwbr @ XU @ XV @ XC))))))))))))))))).
