...
thf(cissubc3_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XH @ (ccfv @ XC @ cchomf)) => ((! [Xx3:$i] : (cwceq @ (Xc_1 @ Xx3) @ (ccfv @ XC @ cccid))) => ((cwceq @ XD @ (cco @ XC @ XJ @ ccresc)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwfn @ XJ @ (ccxp @ XS @ XS))) => (cwi @ Xph @ (cwb @ (cwcel @ XJ @ (ccfv @ XC @ ccsubc)) @ (cw3a @ (cwbr @ XJ @ XH @ ccssc) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (Xc_1 @ Xx3)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XJ))) @ (^ [Xx3:$i] : XS)) @ (cwcel @ XD @ cccat))))))))))))))))).
