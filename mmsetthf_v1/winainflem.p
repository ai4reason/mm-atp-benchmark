...
thf(aintn3an3d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ (cwn @ Xps)) => (cwi @ Xph @ (cwn @ (cw3a @ Xch @ Xth @ Xps))))))))).
thf(apm2_65d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xph @ (cwi @ Xps @ (cwn @ Xch))) => (cwi @ Xph @ (cwn @ Xps)))))))).
...
thf(cwinainflem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccon0) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ (cwss @ ccom @ XA2)))).
