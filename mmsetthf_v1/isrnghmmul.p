...
thf(cisrnghmmul_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => ((cwceq @ XN @ (ccfv @ XS @ ccmgp)) => (cwb @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngh)) @ (cwa @ (cwa @ (cwcel @ XR @ ccrng) @ (cwcel @ XS @ ccrng)) @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ ccghm)) @ (cwcel @ XF @ (cco @ XM @ XN @ ccmgmhm))))))))))))).
