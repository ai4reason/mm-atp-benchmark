...
thf(adf_evls1_ax,axiom,(cwceq @ cces1 @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xr:$i] : (ccpw @ (ccfv @ (ccv @ Xs1) @ ccbs)))) @ (^ [Xs1:$i] : (^ [Xr:$i] : (ccsb @ (ccfv @ (ccv @ Xs1) @ ccbs) @ (^ [Xb:$i] : (cccom @ (ccmpt @ (^ [Xx3:$i] : (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xb) @ cc1o @ ccmap) @ ccmap)) @ (^ [Xx3:$i] : (cccom @ (ccv @ Xx3) @ (ccmpt @ (^ [Xy1:$i] : (ccv @ Xb)) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1)))))))) @ (ccfv @ (ccv @ Xr) @ (cco @ cc1o @ (ccv @ Xs1) @ cces)))))))))).
