...
thf(cusgredgffibi_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XG @ ccusgr) @ (cwb @ (cwcel @ XE @ ccfn) @ (cwcel @ XI @ ccfn))))))))).
