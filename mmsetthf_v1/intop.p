...
thf(adf_intop_ax,axiom,(cwceq @ ccintop @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : ccvv)) @ (^ [Xm:$i] : (^ [Xn:$i] : ccvv)) @ (^ [Xm:$i] : (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccxp @ (ccv @ Xm) @ (ccv @ Xm)) @ ccmap)))))).
...
thf(aintopval_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ XV) @ (cwcel @ XN @ XW)) @ (cwceq @ (cco @ XM @ XN @ ccintop) @ (cco @ XN @ (ccxp @ XM @ XM) @ ccmap)))))))).
thf(aelmapi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) @ (cwf @ XC @ XB2 @ XA2)))))).
thf(cintop_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_op:($i > $o)] : (cwi @ (cwcel @ Xc_op @ (cco @ XM @ XN @ ccintop)) @ (cwf @ (ccxp @ XM @ XM) @ XN @ Xc_op)))))).
