...
thf(asyl6eqbrr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ XA2)) => ((cwbr @ XB2 @ XC @ XR) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ XR)))))))))).
...
thf(abasellem7_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((! [Xn:$i] : (cwcel @ (XA2 @ Xn) @ ccc)) => (! [Xn:$i] : (cwbr @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (cco @ (ccxp @ ccn @ (ccsn @ (XA2 @ Xn))) @ (XG @ Xn) @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ cc1 @ ccli))))))).
...
thf(abasellem6_thm,axiom,(! [XG:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (XG @ Xn) @ ccc0 @ ccli))))).
...
thf(abasellem8_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((cwceq @ XF @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccneg @ cc2) @ ccexp))) @ cc1)) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ (cco @ (cco @ ccpi @ cc2 @ ccexp) @ cc6 @ ccdiv))) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccmin)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : (cwceq @ XJ @ (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (cco @ (ccxp @ ccn @ (ccsn @ (ccneg @ cc2))) @ (XG @ Xn) @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : (cwceq @ (XK @ Xn) @ (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => (! [Xn:$i] : (cwi @ (cwcel @ XM @ ccn) @ (cwa @ (cwbr @ (ccfv @ XM @ XJ) @ (ccfv @ XM @ XF) @ ccle) @ (cwbr @ (ccfv @ XM @ XF) @ (ccfv @ XM @ (XK @ Xn)) @ ccle)))))))))))))))))).
