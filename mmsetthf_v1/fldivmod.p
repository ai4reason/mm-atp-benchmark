...
thf(cfldivmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XB2 @ ccdiv)))))).
