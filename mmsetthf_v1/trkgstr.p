...
thf(ctrkgstr_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XW @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XU) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ (ccop @ (ccfv @ ccnx @ ccitv) @ XI))) => (cwbr @ XW @ (ccop @ cc1 @ (ccdc @ cc1 @ cc6)) @ ccstr))))))).
