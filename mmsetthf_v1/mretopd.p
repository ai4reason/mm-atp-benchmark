...
thf(amreiincl_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwne @ XI @ cc0) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (XS @ Xy1) @ XC)) @ (^ [Xy1:$i] : XI))) @ (cwcel @ (cciin @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (XS @ Xy1))) @ XC))))))).
...
thf(acldval_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XJ @ cccld) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XX @ (ccv @ Xx3)) @ XJ)) @ (^ [Xx3:$i] : (ccpw @ XX))))))))).
...
thf(cmretopd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (ccfv @ XB2 @ ccmre))) => ((cwi @ Xph @ (cwcel @ cc0 @ XM)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XM) @ (cwcel @ (ccv @ Xy1) @ XM)) @ (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XM)))) => ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwcel @ (ccdif @ XB2 @ (ccv @ Xz)) @ XM)) @ (^ [Xz:$i] : (ccpw @ XB2))))) => (! [Xz:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XJ @ Xz) @ (ccfv @ XB2 @ cctopon)) @ (cwceq @ XM @ (ccfv @ (XJ @ Xz) @ cccld)))))))))))))).
