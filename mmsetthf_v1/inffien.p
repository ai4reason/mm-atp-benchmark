...
thf(ainfpwfien_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom)) @ (cwbr @ (ccin @ (ccpw @ XA2) @ ccfn) @ XA2 @ ccen)))).
...
thf(cinffien_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom)) @ (cwbr @ (ccfv @ XA2 @ ccfi) @ XA2 @ ccen)))).
