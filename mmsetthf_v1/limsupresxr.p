...
thf(assrind_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => (cwi @ Xph @ (cwss @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XC))))))))).
...
thf(afvelima2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ (ccima @ XF @ XC))) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : (ccin @ XA2 @ XC))))))))).
...
thf(afunresd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwfun @ XF)) => (cwi @ Xph @ (cwfun @ (ccres @ XF @ XA2)))))))).
...
thf(climsupresxr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwfun @ XF)) => ((cwceq @ XA2 @ (ccima @ (cccnv @ XF) @ ccxr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ XA2) @ cclsp) @ (ccfv @ XF @ cclsp))))))))))).
