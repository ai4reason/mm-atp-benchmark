...
thf(areperf_thm,axiom,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwcel @ (cco @ XJ @ ccr @ ccrest) @ ccperf)))).
...
thf(acnperf_thm,axiom,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwcel @ XJ @ ccperf)))).
thf(crecnperf_conj,conjecture,(! [XS:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ (cco @ XK @ XS @ ccrest) @ ccperf)))))).
