...
thf(asetsval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts) @ (ccun @ (ccres @ XS @ (ccdif @ ccvv @ (ccsn @ XA2))) @ (ccsn @ (ccop @ XA2 @ XB2))))))))))).
...
thf(csetsid_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XE @ (ccslot @ (ccfv @ ccnx @ XE))) => (cwi @ (cwa @ (cwcel @ XW @ XA2) @ (cwcel @ XC @ XV)) @ (cwceq @ XC @ (ccfv @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ XE) @ XC) @ ccsts) @ XE)))))))))).
