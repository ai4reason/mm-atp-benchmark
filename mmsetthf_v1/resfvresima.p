...
thf(cresfvresima_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwfun @ XF)) => ((cwi @ Xph @ (cwss @ XS @ (ccdm @ XF))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XX @ (ccres @ XF @ XS)) @ (ccres @ XH @ (ccima @ XF @ XS))) @ (ccfv @ (ccfv @ XX @ XF) @ XH)))))))))))).
