...
thf(ameasvnul_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0))))).
thf(cprobnul_conj,conjecture,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprb) @ (cwceq @ (ccfv @ cc0 @ XP) @ ccc0)))).
