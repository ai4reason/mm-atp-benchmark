...
thf(cmbfimaicc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XF @ ccmbf) @ (cwf @ XA2 @ ccr @ XF)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr))) @ (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ XB2 @ XC @ ccicc)) @ (ccdm @ ccvol)))))))).
