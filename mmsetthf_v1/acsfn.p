...
thf(aisacs1i_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xs1)) @ (cwf @ (ccpw @ XX) @ (ccpw @ XX) @ XF)) @ (cwcel @ (ccrab @ (^ [Xs1:$i] : (cwss @ (ccuni @ (ccima @ XF @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
thf(cacsfn_conj,conjecture,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XK @ XX)) @ (cwa @ (cwss @ XT @ XX) @ (cwcel @ XT @ ccfn))) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (cwi @ (cwss @ XT @ (ccv @ Xa)) @ (cwcel @ XK @ (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
