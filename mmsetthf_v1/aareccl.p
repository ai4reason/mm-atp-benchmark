...
thf(ane0p_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ XF) @ ccc0)) @ (cwne @ XF @ cc0p))))).
...
thf(caareccl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccaa) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccaa)))).
