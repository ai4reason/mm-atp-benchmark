...
thf(crhmresel_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XB2 @ XB2)))) => (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwcel @ XF @ (cco @ XX @ XY @ XH))) @ (cwcel @ XF @ (cco @ XX @ XY @ ccrh))))))))))).
