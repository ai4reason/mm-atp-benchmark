...
thf(aiszeroi_thm,axiom,(! [XC:($i > $o)] : (! [XO:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ cccat) @ (cwcel @ XO @ (ccfv @ XC @ cczeroo))) @ (cwa @ (cwcel @ XO @ (ccfv @ XC @ ccbs)) @ (cwa @ (cwcel @ XO @ (ccfv @ XC @ ccinito)) @ (cwcel @ XO @ (ccfv @ XC @ cctermo)))))))).
...
thf(azrtermoringc_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccringc)) => ((cwi @ Xph @ (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr))) => ((cwi @ Xph @ (cwcel @ XZ @ XU)) => (cwi @ Xph @ (cwcel @ XZ @ (ccfv @ XC @ cctermo))))))))))))).
thf(ccmg_tp,type,(ccmg : ($i > $o))).
thf(ccur_tp,type,(ccur : ($i > $o))).
thf(ccz_tp,type,(ccz : ($i > $o))).
thf(airinitoringc_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ czring @ XU)) => ((cwceq @ XC @ (ccfv @ XU @ ccringc)) => (cwi @ Xph @ (cwcel @ czring @ (ccfv @ XC @ ccinito))))))))))).
...
thf(ainitoeu1w_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XC @ ccinito))) => (cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XC @ cccic))))))))))).
...
thf(atermoeu1w_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ cctermo))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XC @ cctermo))) => (cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XC @ cccic))))))))))).
...
thf(anrhmzr_thm,axiom,(! [XR:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr)) @ (cwcel @ XR @ ccnzr)) @ (cwceq @ (cco @ XZ @ XR @ ccrh) @ cc0))))).
thf(aeqneqall_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwi @ (cwne @ XA2 @ XB2) @ Xph)))))).
thf(cnzerooringczr_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccringc)) => ((cwi @ Xph @ (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr))) => ((cwi @ Xph @ (cwcel @ XZ @ XU)) => ((cwi @ Xph @ (cwcel @ czring @ XU)) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ cczeroo) @ cc0))))))))))))).
