...
thf(apwpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccpw @ (ccpr @ XA2 @ XB2)) @ (ccun @ (ccpr @ cc0 @ (ccsn @ XA2)) @ (ccpr @ (ccsn @ XB2) @ (ccpr @ XA2 @ XB2))))))).
...
thf(cord3ex_conj,conjecture,(cwcel @ (cctp @ cc0 @ (ccsn @ cc0) @ (ccpr @ cc0 @ (ccsn @ cc0))) @ ccvv)).
