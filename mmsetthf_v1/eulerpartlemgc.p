...
thf(abitsfi_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccfv @ XN @ ccbits) @ ccfn)))).
...
thf(abitsinv1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccsu @ (ccfv @ XN @ ccbits) @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ XN)))).
...
thf(aeulerpartlemsv3_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XR @ (ccab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)))) => ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))))))) => (! [Xf1:$i] : (cwi @ (cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (cwceq @ (ccfv @ XA2 @ (XS @ Xf1)) @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ (XS @ Xf1)) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul)))))))))))).
thf(ceulerpartlemgc_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xn:$i] : ((cwceq @ XR @ (ccab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)))) => ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))))))) => (! [Xt:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (cwa @ (cwcel @ (ccv @ Xt) @ ccn) @ (cwcel @ (ccv @ Xn) @ (ccfv @ (ccfv @ (ccv @ Xt) @ XA2) @ ccbits)))) @ (cwbr @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ (ccv @ Xt) @ ccmul) @ (ccfv @ XA2 @ (XS @ Xf1)) @ ccle))))))))))).
