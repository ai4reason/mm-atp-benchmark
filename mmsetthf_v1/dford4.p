...
thf(adford3_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cword @ XN) @ (cwa @ (cwtr @ XN) @ (cwral @ (^ [Xx3:$i] : (cwtr @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XN)))))).
...
thf(cdford4_conj,conjecture,(! [XN:($i > $o)] : (cwb @ (cword @ XN) @ (cwal @ (^ [Xa:$i] : (cwal @ (^ [Xb:$i] : (cwal @ (^ [Xc:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xa) @ XN) @ (cwcel @ (ccv @ Xb) @ (ccv @ Xa))) @ (cwa @ (cwcel @ (ccv @ Xb) @ XN) @ (cwi @ (cwcel @ (ccv @ Xc) @ (ccv @ Xb)) @ (cwcel @ (ccv @ Xc) @ (ccv @ Xa)))))))))))))).
