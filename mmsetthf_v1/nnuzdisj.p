...
thf(ann0disj_thm,axiom,(! [XN:($i > $o)] : (cwceq @ (ccin @ (cco @ ccc0 @ XN @ ccfz) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ cc0))).
thf(asseq0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ XB2) @ (cwceq @ XB2 @ cc0)) @ (cwceq @ XA2 @ cc0))))).
thf(cnnuzdisj_conj,conjecture,(! [XN:($i > $o)] : (cwceq @ (ccin @ (cco @ cc1 @ XN @ ccfz) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ cc0))).
