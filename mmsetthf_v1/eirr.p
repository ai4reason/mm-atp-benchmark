...
thf(aeirrlem_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XP @ Xn) @ ccz))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XQ @ ccn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ cceu @ (cco @ (XP @ Xn) @ XQ @ ccdiv)))) => (! [Xn:$i] : (cwn @ (Xph @ Xn)))))))))))).
