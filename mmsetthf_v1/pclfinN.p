...
thf(apclclN_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwcel @ XK @ XV) @ (cwss @ XX @ XA2)) @ (cwcel @ (ccfv @ XX @ XU) @ XS)))))))))))).
...
thf(apclbtwnN_thm,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XX @ XS)) @ (cwa @ (cwss @ XY @ XX) @ (cwss @ XX @ (ccfv @ XY @ XU)))) @ (cwceq @ XX @ (ccfv @ XY @ XU)))))))))))).
thf(cpclfinN_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwcel @ XK @ ccal) @ (cwss @ XX @ XA2)) @ (cwceq @ (ccfv @ XX @ XU) @ (cciun @ (^ [Xy1:$i] : (ccin @ ccfn @ (ccpw @ XX))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XU)))))))))))).
