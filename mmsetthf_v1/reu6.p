...
thf(creu6_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwb @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwb @ (Xph @ Xx3) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XA2)))))).
