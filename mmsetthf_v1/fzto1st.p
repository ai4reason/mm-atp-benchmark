...
thf(aidresperm_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ XA2 @ ccsymg)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccres @ ccid @ XA2) @ (ccfv @ XG @ ccbs)))))))).
...
thf(cfzto1st_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XD @ (cco @ cc1 @ XN @ ccfz)) => ((! [Xi:$i] : (cwceq @ (XP @ Xi) @ (ccmpt @ (^ [Xi:$i] : XD) @ (^ [Xi:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ cc1) @ XI @ (ccif @ (cwbr @ (ccv @ Xi) @ XI @ ccle) @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xi))))))) => ((! [Xi:$i] : (cwceq @ (XG @ Xi) @ (ccfv @ XD @ ccsymg))) => ((! [Xi:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xi) @ ccbs))) => (! [Xi:$i] : (cwi @ (cwcel @ XI @ XD) @ (cwcel @ (XP @ Xi) @ XB2)))))))))))))).
