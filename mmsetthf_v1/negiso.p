...
thf(cnegiso_conj,conjecture,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccneg @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwa @ (cwiso @ ccr @ ccr @ cclt @ (cccnv @ cclt) @ (XF @ Xx3)) @ (cwceq @ (cccnv @ (XF @ Xx3)) @ (XF @ Xx3))))))).
