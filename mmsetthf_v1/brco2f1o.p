...
thf(abrcoffn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwfn @ XC @ XY)) => ((cwi @ Xph @ (cwf @ XX @ XY @ XD)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (cccom @ XC @ XD))) => (cwi @ Xph @ (cwa @ (cwbr @ XA2 @ (ccfv @ XA2 @ XD) @ XD) @ (cwbr @ (ccfv @ XA2 @ XD) @ XB2 @ XC)))))))))))))).
...
thf(cbrco2f1o_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwf1o @ XY @ XZ @ XC)) => ((cwi @ Xph @ (cwf1o @ XX @ XY @ XD)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (cccom @ XC @ XD))) => (cwi @ Xph @ (cwa @ (cwbr @ (ccfv @ XB2 @ (cccnv @ XC)) @ XB2 @ XC) @ (cwbr @ XA2 @ (ccfv @ XB2 @ (cccnv @ XC)) @ XD))))))))))))))).
