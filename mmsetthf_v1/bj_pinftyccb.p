...
thf(adf_bj_pinfty_ax,axiom,(cwceq @ ccpinfty @ (ccfv @ ccc0 @ ccinftyexpi))).
...
thf(abj_elccinfty_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) @ (cwcel @ (ccfv @ XA2 @ ccinftyexpi) @ ccccinfty)))).
