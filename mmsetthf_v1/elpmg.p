...
thf(apmvalg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XC @ Xf1)) @ (cwcel @ XB2 @ (XD @ Xf1))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccpm) @ (ccrab @ (^ [Xf1:$i] : (cwfun @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccpw @ (ccxp @ XB2 @ XA2)))))))))))).
...
thf(celpmg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccpm)) @ (cwa @ (cwfun @ XC) @ (cwss @ XC @ (ccxp @ XB2 @ XA2))))))))))).
