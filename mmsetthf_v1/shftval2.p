...
thf(cshftval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XF @ (cco @ XA2 @ XB2 @ ccmin) @ ccshi)) @ (ccfv @ (cco @ XB2 @ XC @ ccaddc) @ XF))))))))).
