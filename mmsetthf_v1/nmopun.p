...
thf(aunoplin_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccuo) @ (cwcel @ XT @ cclo)))).
...
thf(aunopnorm_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ ccuo) @ (cwcel @ XA2 @ cchil)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ XT) @ ccno) @ (ccfv @ XA2 @ ccno)))))).
...
thf(ahne0_thm,axiom,(cwb @ (cwne @ cchil @ cc0h) @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0v)) @ (^ [Xx3:$i] : cchil)))).
thf(anorm1hex_b_thm,axiom,(cwb @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0v)) @ (^ [Xx3:$i] : cchil)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ ccno) @ cc1)) @ (^ [Xx3:$i] : cchil)))).
...
thf(cnmopun_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwne @ cchil @ cc0h) @ (cwcel @ XT @ ccuo)) @ (cwceq @ (ccfv @ XT @ ccnop) @ cc1)))).
