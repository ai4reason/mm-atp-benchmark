...
thf(cex_res_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwceq @ XF @ (ccpr @ (ccop @ cc2 @ cc6) @ (ccop @ cc3 @ cc9))) @ (cwceq @ XB2 @ (ccpr @ cc1 @ cc2))) @ (cwceq @ (ccres @ XF @ XB2) @ (ccsn @ (ccop @ cc2 @ cc6))))))).
