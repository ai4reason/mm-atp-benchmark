...
thf(assxr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccxr) @ (cw3o @ (cwss @ XA2 @ ccr) @ (cwcel @ ccpnf @ XA2) @ (cwcel @ ccmnf @ XA2))))).
...
thf(cxrssre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwn @ (cwcel @ ccpnf @ XA2))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccmnf @ XA2))) => (cwi @ Xph @ (cwss @ XA2 @ ccr)))))))).
