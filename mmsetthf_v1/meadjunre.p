...
thf(cmeadjunre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwceq @ XS @ (ccdm @ XM)) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XB2 @ XS)) => ((cwi @ Xph @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XB2 @ XM) @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ XM) @ (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccaddc)))))))))))))))).
