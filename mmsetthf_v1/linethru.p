...
thf(aellines_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ cclines2) @ (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ (ccv @ Xp) @ (ccv @ Xq)) @ (cwceq @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccline2)))) @ (^ [Xq:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xn:$i] : ccn))))).
...
thf(aliness_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwne @ XA2 @ XB2))) @ (cwss @ (cco @ XA2 @ XB2 @ ccline2) @ (ccfv @ XN @ ccee))))))).
...
thf(alineelsb2_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XQ @ (ccfv @ XN @ ccee)) @ (cwne @ XP @ XQ)) @ (cwa @ (cwcel @ XS @ (ccfv @ XN @ ccee)) @ (cwne @ XP @ XS))) @ (cwi @ (cwcel @ XS @ (cco @ XP @ XQ @ ccline2)) @ (cwceq @ (cco @ XP @ XQ @ ccline2) @ (cco @ XP @ XS @ ccline2))))))))).
...
thf(clinethru_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cclines2) @ (cwa @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cwne @ XP @ XQ)) @ (cwceq @ XA2 @ (cco @ XP @ XQ @ ccline2))))))).
