...
thf(cqtopf1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwf1 @ XX @ XY @ XF)) => (cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ (cco @ XJ @ XF @ ccqtop) @ cchmeo))))))))))).
