...
thf(awemapso2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ XS) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XZ @ Xy1 @ Xz @ Xw) @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xy1 @ Xz @ Xw) @ XA2 @ ccmap)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwor @ XA2 @ XR) @ (cwor @ (XB2 @ Xy1 @ Xz @ Xw) @ XS)) @ (cwor @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))))))).
...
thf(coemapso_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xw:$i] : (cwceq @ (XS @ Xw) @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ ccon0))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XB2 @ ccon0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xz:$i] : XB2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwor @ (XS @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))))).
