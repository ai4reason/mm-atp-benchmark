...
thf(cevlrhm_conj,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XQ @ (cco @ XI @ XR @ ccevl)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XW @ (cco @ XI @ XR @ ccmpl)) => ((cwceq @ XT @ (cco @ XR @ (cco @ XB2 @ XI @ ccmap) @ ccpws)) => (cwi @ (cwa @ (cwcel @ XI @ XV) @ (cwcel @ XR @ cccrg)) @ (cwcel @ XQ @ (cco @ XW @ XT @ ccrh))))))))))))))).
