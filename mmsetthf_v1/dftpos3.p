...
thf(admtpos_thm,axiom,(! [XF:($i > $o)] : (cwi @ (cwrel @ (ccdm @ XF)) @ (cwceq @ (ccdm @ (cctpos @ XF)) @ (cccnv @ (ccdm @ XF)))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(areltpos_thm,axiom,(! [XF:($i > $o)] : (cwrel @ (cctpos @ XF)))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(arelrelss_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwa @ (cwrel @ XA2) @ (cwrel @ (ccdm @ XA2))) @ (cwss @ XA2 @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv))))).
thf(aelvvv_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv)) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwceq @ XA2 @ (ccop @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz)))))))))))).
...
thf(cdftpos3_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwrel @ (ccdm @ XF)) @ (cwceq @ (cctpos @ XF) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccop @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (ccv @ Xz) @ XF))))))))).
