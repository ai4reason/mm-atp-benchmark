...
thf(apeano2fzor_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ (ccfv @ XM @ ccuz)) @ (cwcel @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ XM @ XN @ ccfzo))) @ (cwcel @ XK @ (cco @ XM @ XN @ ccfzo))))))).
...
thf(aelfzolt2b_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) @ (cwcel @ XK @ (cco @ XK @ XN @ ccfzo))))))).
thf(aelfzo3_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwb @ (cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) @ (cwa @ (cwcel @ XK @ (ccfv @ XM @ ccuz)) @ (cwcel @ XK @ (cco @ XK @ XN @ ccfzo)))))))).
...
thf(cefgsrel_conj,conjecture,(! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > $o)] : ((! [Xk:$i] : (cwceq @ XW @ (ccfv @ (ccword @ (ccxp @ (XI @ Xk) @ cc2o)) @ ccid))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (Xc_sm @ Xw @ Xv @ Xk @ Xn) @ (ccfv @ (XI @ Xk) @ ccefg)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwceq @ (XM @ Xy1 @ Xz @ Xk) @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : (XI @ Xk))) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz)))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (ccmpt @ (^ [Xv:$i] : XW) @ (^ [Xv:$i] : (ccmpt2 @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xv) @ cchash) @ ccfz))) @ (^ [Xn:$i] : (^ [Xw:$i] : (ccxp @ (XI @ Xk) @ cc2o))) @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ (XM @ Xy1 @ Xz @ Xk)))) @ ccsplice))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xk @ Xn) @ (ccdif @ XW @ (cciun @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ (ccv @ Xx3) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn)))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) @ (ccmpt @ (^ [Xm:$i] : (ccrab @ (^ [Xt:$i] : (cwa @ (cwcel @ (ccfv @ ccc0 @ (ccv @ Xt)) @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xk @ Xn)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ (ccv @ Xt)) @ (ccrn @ (ccfv @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xt)) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn))))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xt) @ cchash) @ ccfzo))))) @ (^ [Xt:$i] : (ccdif @ (ccword @ XW) @ (ccsn @ cc0))))) @ (^ [Xm:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xm) @ cchash) @ cc1 @ ccmin) @ (ccv @ Xm)))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwcel @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn))) @ (cwbr @ (ccfv @ ccc0 @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn)) @ (ccfv @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn)) @ (Xc_sm @ Xw @ Xv @ Xk @ Xn))))))))))))))))))))))))))).
