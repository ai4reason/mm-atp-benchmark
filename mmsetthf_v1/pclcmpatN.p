...
thf(apclfinN_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cwa @ (cwcel @ XK @ ccal) @ (cwss @ XX @ XA2)) @ (cwceq @ (ccfv @ XX @ XU) @ (cciun @ (^ [Xy1:$i] : (ccin @ ccfn @ (ccpw @ XX))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XU)))))))))))).
...
thf(cpclcmpatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cw3a @ (cwcel @ XK @ ccal) @ (cwss @ XX @ XA2) @ (cwcel @ XP @ (ccfv @ XX @ XU))) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwss @ (ccv @ Xy1) @ XX) @ (cwcel @ XP @ (ccfv @ (ccv @ Xy1) @ XU)))) @ (^ [Xy1:$i] : ccfn))))))))))).
