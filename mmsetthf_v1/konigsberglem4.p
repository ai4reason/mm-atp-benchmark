...
thf(an2dvds3_thm,axiom,(cwn @ (cwbr @ cc2 @ cc3 @ ccdvds))).
...
thf(akonigsberglem1_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((cwceq @ XE @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwceq @ (ccfv @ ccc0 @ (ccfv @ XG @ ccvtxdg)) @ cc3)))))))).
...
thf(akonigsberglem2_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((cwceq @ XE @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwceq @ (ccfv @ cc1 @ (ccfv @ XG @ ccvtxdg)) @ cc3)))))))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(aleidi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ XA2 @ XA2 @ ccle)))).
thf(a_3re_thm,axiom,(cwcel @ cc3 @ ccr)).
thf(akonigsberglem3_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (cco @ ccc0 @ cc3 @ ccfz)) => ((cwceq @ XE @ (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((cwceq @ XG @ (ccop @ XV @ XE)) => (cwceq @ (ccfv @ cc3 @ (ccfv @ XG @ ccvtxdg)) @ cc3)))))))).
