...
thf(cdfac9_conj,conjecture,(cwb @ cwac @ (cwal @ (^ [Xf1:$i] : (cwi @ (cwa @ (cwfun @ (ccv @ Xf1)) @ (cwnel @ cc0 @ (ccrn @ (ccv @ Xf1)))) @ (cwne @ (ccixp @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ cc0)))))).
