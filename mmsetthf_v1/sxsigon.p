...
thf(csxsigon_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) @ (cwcel @ (cco @ XS @ XT @ ccsx) @ (ccfv @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT)) @ ccsiga)))))).
