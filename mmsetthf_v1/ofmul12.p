...
thf(cofmul12_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ ccc @ XF)) @ (cwa @ (cwf @ XA2 @ ccc @ XG) @ (cwf @ XA2 @ ccc @ XH))) @ (cwceq @ (cco @ XF @ (cco @ XG @ XH @ (ccof @ ccmul)) @ (ccof @ ccmul)) @ (cco @ XG @ (cco @ XF @ XH @ (ccof @ ccmul)) @ (ccof @ ccmul)))))))))).
