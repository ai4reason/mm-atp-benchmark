...
thf(adf_dib_ax,axiom,(cwceq @ ccdib @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdia)))) @ (^ [Xx3:$i] : (ccxp @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdia))) @ (ccsn @ (ccmpt @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccltrn))) @ (^ [Xf1:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xk) @ ccbs)))))))))))))).
