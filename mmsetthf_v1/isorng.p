...
thf(adf_orng_ax,axiom,(cwceq @ ccorng @ (ccrab @ (^ [Xr:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xz:$i] : (cwsbc @ (^ [Xt:$i] : (cwsbc @ (^ [Xl:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xz) @ (ccv @ Xa) @ (ccv @ Xl)) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xb) @ (ccv @ Xl))) @ (cwbr @ (ccv @ Xz) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xt)) @ (ccv @ Xl)))) @ (^ [Xb:$i] : (ccv @ Xv)))) @ (^ [Xa:$i] : (ccv @ Xv)))) @ (ccfv @ (ccv @ Xr) @ ccple))) @ (ccfv @ (ccv @ Xr) @ ccmulr))) @ (ccfv @ (ccv @ Xr) @ cc0g))) @ (ccfv @ (ccv @ Xr) @ ccbs))) @ (^ [Xr:$i] : (ccin @ ccrg @ ccogrp))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cisorng_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (Xc_0 @ Xa @ Xb) @ (ccfv @ XR @ cc0g)))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (Xc_x @ Xa @ Xb) @ (ccfv @ XR @ ccmulr)))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (Xc_le @ Xa @ Xb) @ (ccfv @ XR @ ccple)))) => (cwb @ (cwcel @ XR @ ccorng) @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XR @ ccogrp) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwi @ (cwa @ (cwbr @ (Xc_0 @ Xa @ Xb) @ (ccv @ Xa) @ (Xc_le @ Xa @ Xb)) @ (cwbr @ (Xc_0 @ Xa @ Xb) @ (ccv @ Xb) @ (Xc_le @ Xa @ Xb))) @ (cwbr @ (Xc_0 @ Xa @ Xb) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (Xc_x @ Xa @ Xb)) @ (Xc_le @ Xa @ Xb)))) @ (^ [Xb:$i] : XB2))) @ (^ [Xa:$i] : XB2)))))))))))))).
