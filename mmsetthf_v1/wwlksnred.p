...
thf(aswrd0len0_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ XW @ cchash) @ (cco @ XN @ cc1 @ ccaddc))) @ (cwceq @ (ccfv @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ cchash) @ XN)))))).
...
thf(cwwlksnred_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwi @ (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) @ (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) @ (cco @ XN @ XG @ ccwwlksn)))))))).
