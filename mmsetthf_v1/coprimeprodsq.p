...
thf(agcdabs1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz)) @ (cwceq @ (cco @ (ccfv @ XN @ ccabs) @ XM @ ccgcd) @ (cco @ XN @ XM @ ccgcd)))))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ccsup_tp,type,(ccsup : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(agcdass_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XP @ ccz)) @ (cwceq @ (cco @ (cco @ XN @ XM @ ccgcd) @ XP @ ccgcd) @ (cco @ XN @ (cco @ XM @ XP @ ccgcd) @ ccgcd))))))).
...
thf(ccoprimeprodsq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccgcd) @ cc1)) @ (cwi @ (cwceq @ (cco @ XC @ cc2 @ ccexp) @ (cco @ XA2 @ XB2 @ ccmul)) @ (cwceq @ XA2 @ (cco @ (cco @ XA2 @ XC @ ccgcd) @ cc2 @ ccexp)))))))).
