...
thf(cfourierdlem16_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwf @ ccr @ ccr @ XF)) => ((cwceq @ XC @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XC) @ ccibl)) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv)))))) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwa @ (cwa @ (cwcel @ (ccfv @ XN @ (XA2 @ Xx3 @ Xn)) @ ccr) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) @ ccibl)) @ (cwcel @ (ccitg @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccr)))))))))))))))).
