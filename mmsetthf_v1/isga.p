...
thf(adf_ga_ax,axiom,(cwceq @ ccga @ (ccmpt2 @ (^ [Xg1:$i] : (^ [Xs1:$i] : ccgrp)) @ (^ [Xg1:$i] : (^ [Xs1:$i] : ccvv)) @ (^ [Xg1:$i] : (^ [Xs1:$i] : (ccsb @ (ccfv @ (ccv @ Xg1) @ ccbs) @ (^ [Xb:$i] : (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccfv @ (ccv @ Xg1) @ cc0g) @ (ccv @ Xx3) @ (ccv @ Xm)) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccfv @ (ccv @ Xg1) @ ccplusg)) @ (ccv @ Xx3) @ (ccv @ Xm)) @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccv @ Xm)) @ (ccv @ Xm)))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xy1:$i] : (ccv @ Xb))))) @ (^ [Xx3:$i] : (ccv @ Xs1)))) @ (^ [Xm:$i] : (cco @ (ccv @ Xs1) @ (ccxp @ (ccv @ Xb) @ (ccv @ Xs1)) @ ccmap)))))))))).
...
thf(cisga_conj,conjecture,(! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (ccfv @ XG @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1 @ Xz) @ (ccfv @ XG @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1 @ Xz) @ (ccfv @ XG @ cc0g))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) @ (cwa @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XY @ ccvv)) @ (cwa @ (cwf @ (ccxp @ (XX @ Xx3) @ XY) @ XY @ Xc_po) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (Xc_0 @ Xx3 @ Xy1 @ Xz) @ (ccv @ Xx3) @ Xc_po) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_pl @ Xx3 @ Xy1 @ Xz)) @ (ccv @ Xx3) @ Xc_po) @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ Xc_po) @ Xc_po))) @ (^ [Xz:$i] : (XX @ Xx3)))) @ (^ [Xy1:$i] : (XX @ Xx3))))) @ (^ [Xx3:$i] : XY)))))))))))))))))).
