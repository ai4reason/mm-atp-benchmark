...
thf(amt4_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((cwi @ (cwn @ Xps) @ (cwn @ Xph)) => Xps))))).
...
thf(ahatomici_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwne @ XA2 @ cc0h) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccat)))))).
...
thf(aatne0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccat) @ (cwne @ XA2 @ cc0h)))).
...
thf(achssoc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccch) @ (cwb @ (cwss @ XA2 @ (ccfv @ XA2 @ ccort)) @ (cwceq @ XA2 @ cc0h))))).
...
thf(asuperpos_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccat) @ (cwne @ XA2 @ XB2)) @ (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ XA2) @ (cwne @ (ccv @ Xx3) @ XB2) @ (cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccat)))))).
...
thf(achirredlem4_thm,axiom,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xp) @ ccat) @ (cwss @ (ccv @ Xp) @ XA2)) @ (cwa @ (cwcel @ (ccv @ Xq) @ ccat) @ (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) @ (cwa @ (cwcel @ (ccv @ Xr) @ ccat) @ (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) @ (cwo @ (cwceq @ (ccv @ Xr) @ (ccv @ Xp)) @ (cwceq @ (ccv @ Xr) @ (ccv @ Xq))))))))))).
...
thf(cchirredi_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => (cwo @ (cwceq @ XA2 @ cc0h) @ (cwceq @ XA2 @ cchil)))))).
