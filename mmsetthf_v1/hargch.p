...
thf(aelgch_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwb @ (cwcel @ XA2 @ ccgch) @ (cwo @ (cwcel @ XA2 @ ccfn) @ (cwal @ (^ [Xx3:$i] : (cwn @ (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm) @ (cwbr @ (ccv @ Xx3) @ (ccpw @ XA2) @ ccsdm)))))))))))).
thf(chargch_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwbr @ (ccfv @ XA2 @ cchar) @ (ccpw @ XA2) @ ccen) @ (cwcel @ XA2 @ ccgch)))).
