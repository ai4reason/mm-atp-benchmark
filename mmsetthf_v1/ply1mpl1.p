...
thf(cply1mpl1_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (cco @ cc1o @ XR @ ccmpl)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_1 @ (ccfv @ XP @ ccur)) => (cwceq @ Xc_1 @ (ccfv @ XM @ ccur)))))))))).
