...
thf(adf_css_ax,axiom,(cwceq @ cccss @ (ccmpt @ (^ [Xh:$i] : ccvv) @ (^ [Xh:$i] : (ccab @ (^ [Xs1:$i] : (cwceq @ (ccv @ Xs1) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xh) @ ccocv)) @ (ccfv @ (ccv @ Xh) @ ccocv))))))))).
...
thf(ccssval_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((! [Xs1:$i] : (cwceq @ (XC @ Xs1) @ (ccfv @ XW @ cccss))) => (! [Xs1:$i] : (cwi @ (cwcel @ XW @ (XX @ Xs1)) @ (cwceq @ (XC @ Xs1) @ (ccab @ (^ [Xs1:$i] : (cwceq @ (ccv @ Xs1) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ Xc_pe) @ Xc_pe)))))))))))))).
