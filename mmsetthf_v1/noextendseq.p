...
thf(aordtri2or2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cword @ XB2)) @ (cwo @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ XA2)))))).
...
thf(asylanblc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => (Xch => ((cwb @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
...
thf(cnoextendseq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccpr @ cc1o @ cc2o)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccon0)) @ (cwcel @ (ccun @ XA2 @ (ccxp @ (ccdif @ XB2 @ (ccdm @ XA2)) @ (ccsn @ XX))) @ ccsur))))))).
