...
thf(cmatval_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XG @ (cco @ XR @ (ccxp @ XN @ XN) @ ccfrlm)) => ((cwceq @ Xc_x @ (cco @ XR @ (ccotp @ XN @ XN @ XN) @ ccmmul)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ XV)) @ (cwceq @ XA2 @ (cco @ XG @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x) @ ccsts))))))))))))).
