...
thf(aom1elbas_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (cco @ XJ @ XY @ ccomi)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XO @ ccbs))) => (cwi @ Xph @ (cwb @ (cwcel @ XF @ XB2) @ (cw3a @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) @ (cwceq @ (ccfv @ ccc0 @ XF) @ XY) @ (cwceq @ (ccfv @ cc1 @ XF) @ XY)))))))))))))))).
...
thf(cpi1blem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((cwceq @ XO @ (cco @ XJ @ XY @ ccomi)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XG @ ccbs))) => ((cwi @ Xph @ (cwceq @ XK @ (ccfv @ XO @ ccbs))) => (cwi @ Xph @ (cwa @ (cwss @ (ccima @ (ccfv @ XJ @ ccphtpc) @ XK) @ XK) @ (cwss @ XK @ (cco @ ccii @ XJ @ cccn))))))))))))))))))).
