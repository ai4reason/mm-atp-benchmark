...
thf(ccdlemg46_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xh:$i] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XF @ XT) @ (cwcel @ (ccv @ Xh) @ XT)) @ (cw3a @ (cwne @ XF @ (ccres @ ccid @ XB2)) @ (cwne @ (ccv @ Xh) @ (ccres @ ccid @ XB2)) @ (cwne @ (ccfv @ (ccv @ Xh) @ XR) @ (ccfv @ XF @ XR)))) @ (cwne @ (ccfv @ (cccom @ (ccv @ Xh) @ XF) @ XR) @ (ccfv @ XF @ XR)))))))))))))))).
