...
thf(aifeq2da_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ (cwa @ Xph @ (cwn @ Xps)) @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccif @ Xps @ XC @ XA2) @ (ccif @ Xps @ XC @ XB2)))))))))).
...
thf(apcoval_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco)) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (ccfv @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ XF) @ (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmin) @ XG))))))))))))).
...
thf(areparpht_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ ccii @ cccn))) => ((cwi @ Xph @ (cwceq @ (ccfv @ ccc0 @ XG) @ ccc0)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc1 @ XG) @ cc1)) => (cwi @ Xph @ (cwbr @ (cccom @ XF @ XG) @ XF @ (ccfv @ XJ @ ccphtpc)))))))))))).
...
thf(acnmpt2c_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xx3 @ Xy1) @ (ccfv @ XX @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xx3 @ Xy1) @ (ccfv @ XY @ cctopon))))) => ((cwi @ Xph @ (cwcel @ XL @ (ccfv @ XZ @ cctopon))) => ((cwi @ Xph @ (cwcel @ XP @ XZ)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XP))) @ (cco @ (cco @ (XJ @ Xx3 @ Xy1) @ (XK @ Xx3 @ Xy1) @ cctx) @ XL @ cccn)))))))))))))))))).
...
thf(cpcopt2_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ XY))) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) @ (cwceq @ (ccfv @ cc1 @ XF) @ XY)) @ (cwbr @ (cco @ XF @ XP @ (ccfv @ XJ @ ccpco)) @ XF @ (ccfv @ XJ @ ccphtpc))))))))).
