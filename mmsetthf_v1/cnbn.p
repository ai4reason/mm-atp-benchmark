...
thf(acnims_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => ((cwceq @ XD @ (cccom @ ccabs @ ccmin)) => (cwceq @ XD @ (ccfv @ XU @ ccims))))))).
...
thf(ccnbn_conj,conjecture,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwcel @ XU @ cccbn)))).
