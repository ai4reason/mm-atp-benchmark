...
thf(acmcm3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ (ccfv @ XA2 @ ccort) @ XB2 @ cccm))))))).
...
thf(ccmcm3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwbr @ (ccfv @ XA2 @ ccort) @ XB2 @ cccm)))))).
