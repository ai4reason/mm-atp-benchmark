...
thf(algsdir2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc2 @ cclgs) @ (cco @ (cco @ XA2 @ cc2 @ cclgs) @ (cco @ XB2 @ cc2 @ cclgs) @ ccmul)))))).
...
thf(advdsmod0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwbr @ XM @ XN @ ccdvds)) @ (cwceq @ (cco @ XN @ XM @ ccmo) @ ccc0))))).
thf(clgsdirprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XP @ cclgs) @ (cco @ (cco @ XA2 @ XP @ cclgs) @ (cco @ XB2 @ XP @ cclgs) @ ccmul))))))).
