...
thf(aomsf_thm,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XQ @ XV) @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) @ (cwf @ (ccpw @ (ccuni @ (ccdm @ XR))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (ccfv @ XR @ ccoms))))))).
...
thf(acarsgcl_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ XV)) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => (cwi @ Xph @ (cwss @ (ccfv @ XM @ cccarsg) @ (ccpw @ XO)))))))))).
...
thf(a_0elcarsg_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ XV)) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0)) => (cwi @ Xph @ (cwcel @ cc0 @ (ccfv @ XM @ cccarsg))))))))))).
thf(aoms0_thm,axiom,(! [Xph:$o] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccoms)) => ((cwi @ Xph @ (cwcel @ XQ @ XV)) => ((cwi @ Xph @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((cwi @ Xph @ (cwcel @ cc0 @ (ccdm @ XR))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XR) @ ccc0)) => (cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0))))))))))))).
...
thf(aomssubadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XM @ Xy1) @ (ccfv @ XR @ ccoms))) => ((cwi @ Xph @ (cwcel @ XQ @ XV)) => ((cwi @ Xph @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XX)) @ (cwss @ (XA2 @ Xy1) @ (ccuni @ XQ)))) => ((cwi @ Xph @ (cwbr @ XX @ ccom @ ccdom)) => (! [Xy1:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (XA2 @ Xy1))) @ (XM @ Xy1)) @ (ccesum @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccfv @ (XA2 @ Xy1) @ (XM @ Xy1)))) @ ccle)))))))))))))))).
...
thf(aomsmon_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccoms)) => ((cwi @ Xph @ (cwcel @ XQ @ XV)) => ((cwi @ Xph @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((cwi @ Xph @ (cwss @ XA2 @ XB2)) => ((cwi @ Xph @ (cwss @ XB2 @ (ccuni @ XQ))) => (cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccle))))))))))))))).
...
thf(acarsggect_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ XO @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cw3a @ Xph @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwss @ (ccv @ Xx3) @ (ccpw @ XO))) @ (cwbr @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XM) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XM))) @ ccle))) => ((cwi @ Xph @ (cwn @ (cwcel @ cc0 @ XA2))) => ((cwi @ Xph @ (cwbr @ XA2 @ ccom @ ccdom)) => ((cwi @ Xph @ (cwss @ XA2 @ (ccfv @ XM @ cccarsg))) => ((cwi @ Xph @ (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (ccv @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccpw @ XO))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccle)))) => (cwi @ Xph @ (cwbr @ (ccesum @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xz) @ XM))) @ (ccfv @ (ccuni @ XA2) @ XM) @ ccle))))))))))))))))).
...
thf(aunidif0_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccuni @ (ccdif @ XA2 @ (ccsn @ cc0))) @ (ccuni @ XA2)))).
...
thf(acarsgsiga_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XO @ (XV @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XM) @ ccc0)) => ((! [Xx3:$i] : (cwi @ (cw3a @ Xph @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwss @ (ccv @ Xx3) @ (ccpw @ XO))) @ (cwbr @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XM) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XM))) @ ccle))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccpw @ XO))) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccle)))) => (cwi @ Xph @ (cwcel @ (ccfv @ XM @ cccarsg) @ (ccfv @ XO @ ccsiga))))))))))))).
...
thf(comsmeas_conj,conjecture,(! [Xph:$o] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XM @ (ccfv @ XR @ ccoms)) => ((cwceq @ XS @ (ccfv @ XM @ cccarsg)) => ((cwi @ Xph @ (cwcel @ XQ @ XV)) => ((cwi @ Xph @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((cwi @ Xph @ (cwcel @ cc0 @ (ccdm @ XR))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc0 @ XR) @ ccc0)) => (cwi @ Xph @ (cwcel @ (ccres @ XM @ XS) @ (ccfv @ XS @ ccmeas)))))))))))))))).
