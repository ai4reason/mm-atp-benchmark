...
thf(cldualvsdi2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ cclfn)) => ((cwceq @ XR @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccld)) => ((cwceq @ Xc_pb @ (ccfv @ XD @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XD @ ccvsca)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XX @ XK)) => ((cwi @ Xph @ (cwcel @ XY @ XK)) => ((cwi @ Xph @ (cwcel @ XG @ XF)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XG @ Xc_x) @ (cco @ (cco @ XX @ XG @ Xc_x) @ (cco @ XY @ XG @ Xc_x) @ Xc_pb))))))))))))))))))))))))))).
