...
thf(cpell1234qrdich_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr))) @ (cwo @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwcel @ (ccneg @ XA2) @ (ccfv @ XD @ ccpell14qr))))))).
