...
thf(almimf1o_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XC @ (ccfv @ XS @ ccbs)) => (cwi @ (cwcel @ XF @ (cco @ XR @ XS @ cclmim)) @ (cwf1o @ XB2 @ XC @ XF)))))))))).
...
thf(aislmim2_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ (cco @ XR @ XS @ cclmim)) @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ cclmhm)) @ (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ cclmhm)))))))).
...
thf(clnmlmic_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwbr @ XR @ XS @ cclmic) @ (cwb @ (cwcel @ XR @ cclnm) @ (cwcel @ XS @ cclnm)))))).
