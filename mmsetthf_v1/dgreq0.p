...
thf(adgrlb_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ ccn0) @ (cwceq @ (ccima @ XA2 @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz)) @ (ccsn @ ccc0))) @ (cwbr @ XN @ XM @ ccle)))))))))).
...
thf(cdgreq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwb @ (cwceq @ XF @ cc0p) @ (cwceq @ (ccfv @ XN @ XA2) @ ccc0)))))))))).
