...
thf(awlkeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ (XG @ Xx3) @ ccwlks)) @ (cwcel @ XB2 @ (ccfv @ (XG @ Xx3) @ ccwlks)) @ (cwceq @ XN @ (ccfv @ (ccfv @ XA2 @ cc1st) @ cchash))) @ (cwb @ (cwceq @ XA2 @ XB2) @ (cw3a @ (cwceq @ XN @ (ccfv @ (ccfv @ XB2 @ cc1st) @ cchash)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XA2 @ cc1st)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XB2 @ cc1st)))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfzo))) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XA2 @ cc2nd)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XB2 @ cc2nd)))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))).
...
thf(aupgrwlkcompim_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((! [Xk:$i] : (cwceq @ XF @ (ccfv @ (XW @ Xk) @ cc1st))) => ((! [Xk:$i] : (cwceq @ XP @ (ccfv @ (XW @ Xk) @ cc2nd))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ (XW @ Xk) @ (ccfv @ XG @ ccwlks))) @ (cw3a @ (cwcel @ XF @ (ccword @ (ccdm @ XI))) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))))))))))).
...
thf(auspgrf1oedg_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ ccuspgr) @ (cwf1o @ (ccdm @ XE) @ (ccfv @ XG @ ccedg) @ XE)))))).
...
thf(awlkelwrd_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XF @ (ccfv @ XW @ cc1st)) => ((cwceq @ XP @ (ccfv @ XW @ cc2nd)) => (cwi @ (cwcel @ XW @ (ccfv @ XG @ ccwlks)) @ (cwa @ (cwcel @ XF @ (ccword @ (ccdm @ XI))) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP)))))))))))))).
