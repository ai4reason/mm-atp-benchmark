...
thf(celdmcoa_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XC @ cccoa)) => ((cwceq @ XA2 @ (ccfv @ XC @ ccarw)) => (cwb @ (cwbr @ XG @ XF @ (ccdm @ Xc_x)) @ (cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XG @ XA2) @ (cwceq @ (ccfv @ XF @ cccoda) @ (ccfv @ XG @ ccdoma)))))))))))).
