...
thf(adf_smat_ax,axiom,(cwceq @ ccsmat @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : ccn)) @ (^ [Xk:$i] : (^ [Xl:$i] : ccn)) @ (^ [Xk:$i] : (^ [Xl:$i] : (cccom @ (ccv @ Xm) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccn)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccn)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccop @ (ccif @ (cwbr @ (ccv @ Xi) @ (ccv @ Xk) @ cclt) @ (ccv @ Xi) @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc)) @ (ccif @ (cwbr @ (ccv @ Xj) @ (ccv @ Xl) @ cclt) @ (ccv @ Xj) @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc)))))))))))))).
