...
thf(cinn0f_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (! [Xx3:$i] : (cwb @ (cwne @ (ccin @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))).
