...
thf(celimif_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XA2) @ (cwb @ Xps @ Xch)) => ((cwi @ (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XB2) @ (cwb @ Xps @ Xth)) => (cwb @ Xps @ (cwo @ (cwa @ Xph @ Xch) @ (cwa @ (cwn @ Xph) @ Xth)))))))))))).
