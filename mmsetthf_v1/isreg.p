...
thf(adf_reg_ax,axiom,(cwceq @ ccreg @ (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xj) @ cccl)) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xj)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xj)))) @ (^ [Xj:$i] : cctop)))).
thf(cisreg_conj,conjecture,(! [XJ:($i > $o)] : (cwb @ (cwcel @ XJ @ ccreg) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwss @ (ccfv @ (ccv @ Xz) @ (ccfv @ XJ @ cccl)) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XJ))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ)))))).
