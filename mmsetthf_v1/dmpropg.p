...
thf(cdmpropg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ XV) @ (cwcel @ XD @ XW)) @ (cwceq @ (ccdm @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD))) @ (ccpr @ XA2 @ XC)))))))))).
