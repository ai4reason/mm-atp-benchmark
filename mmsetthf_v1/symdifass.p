...
thf(abiass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwb @ (cwb @ Xph @ Xps) @ Xch) @ (cwb @ Xph @ (cwb @ Xps @ Xch))))))).
...
thf(csymdifass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccsymdif @ XA2 @ (ccsymdif @ XB2 @ XC)) @ (ccsymdif @ (ccsymdif @ XA2 @ XB2) @ XC)))))).
