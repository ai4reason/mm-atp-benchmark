...
thf(celmpps_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => ((cwceq @ XJ @ (ccfv @ XT @ ccmpps)) => ((cwceq @ XC @ (ccfv @ XT @ ccmcls)) => (cwb @ (cwcel @ (ccotp @ XD @ XH @ XA2) @ XJ) @ (cwa @ (cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) @ (cwcel @ XA2 @ (cco @ XD @ XH @ XC))))))))))))))).
