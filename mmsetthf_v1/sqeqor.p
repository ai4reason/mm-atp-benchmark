...
thf(csqeqor_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwb @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp)) @ (cwo @ (cwceq @ XA2 @ XB2) @ (cwceq @ XA2 @ (ccneg @ XB2)))))))).
