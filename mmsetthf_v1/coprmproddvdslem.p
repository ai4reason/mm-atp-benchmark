...
thf(araldifb_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwnel @ (ccv @ Xx3) @ (XB2 @ Xx3)) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))).
thf(abiimpi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwb @ Xph @ Xps) => (cwi @ Xph @ Xps))))).
thf(acoprmprod_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xn:$i] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XM @ ccfn) @ (cwss @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwf @ ccn @ ccn @ (XF @ Xn)) @ (cwral @ (^ [Xm:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xm) @ (XF @ Xn)) @ XN @ ccgcd) @ cc1)) @ (^ [Xm:$i] : XM))) @ (cwi @ (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xm) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)) @ ccgcd) @ cc1)) @ (^ [Xn:$i] : (ccdif @ XM @ (ccsn @ (ccv @ Xm)))))) @ (^ [Xm:$i] : XM)) @ (cwceq @ (cco @ (ccprod @ (^ [Xm:$i] : XM) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xm) @ (XF @ Xn)))) @ XN @ ccgcd) @ cc1)))))))).
