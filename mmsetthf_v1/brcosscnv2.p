...
thf(cbrcosscnv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwbr @ XA2 @ XB2 @ (cccoss @ (cccnv @ XR))) @ (cwne @ (ccin @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)) @ cc0))))))))).
