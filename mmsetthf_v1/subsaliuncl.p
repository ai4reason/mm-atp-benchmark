...
thf(aaxccdom_thm,axiom,(! [Xph:($i > $o)] : (! [XX:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwbr @ XX @ ccom @ ccdom))) => ((! [Xz:$i] : (! [Xf1:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xz) @ XX)) @ (cwne @ (ccv @ Xz) @ cc0)))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwfn @ (ccv @ Xf1) @ XX) @ (cwral @ (^ [Xz:$i] : (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : XX)))))))))))).
...
thf(asubsaliuncllem_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xe:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xe))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xe:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xe) @ (cwcel @ XS @ (XV @ Xx3 @ Xy1 @ Xe @ Xn))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xe:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xe @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xn) @ (XF @ Xy1 @ Xn)) @ (ccin @ (ccv @ Xx3) @ (XD @ Xy1 @ Xn)))) @ (^ [Xx3:$i] : XS))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xe:$i] : (! [Xn:$i] : (cwceq @ (XE @ Xy1) @ (cccom @ (XH @ Xx3 @ Xe @ Xn) @ (XG @ Xx3 @ Xe @ Xn))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xe:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xe) @ (cwfn @ (XH @ Xx3 @ Xe @ Xn) @ (ccrn @ (XG @ Xx3 @ Xe @ Xn)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xe:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xe) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ (XH @ Xx3 @ Xe @ Xn)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccrn @ (XG @ Xx3 @ Xe @ Xn))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xe:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xe) @ (cwrex @ (^ [Xe:$i] : (cwral @ (^ [Xn:$i] : (cwceq @ (ccfv @ (ccv @ Xn) @ (XF @ Xy1 @ Xn)) @ (ccin @ (ccfv @ (ccv @ Xn) @ (ccv @ Xe)) @ (XD @ Xy1 @ Xn)))) @ (^ [Xn:$i] : ccn))) @ (^ [Xe:$i] : (cco @ XS @ ccn @ ccmap)))))))))))))))))))))).
...
thf(csubsaliuncl_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XD @ (XV @ Xn)))) => ((! [Xn:$i] : (cwceq @ (XT @ Xn) @ (cco @ XS @ XD @ ccrest))) => ((! [Xn:$i] : (cwi @ Xph @ (cwf @ ccn @ (XT @ Xn) @ XF))) => (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) @ (XT @ Xn))))))))))))))).
