...
thf(cfcoss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwss @ XC @ XA2)) => ((cwi @ Xph @ (cwf @ XD @ XC @ XG)) => (cwi @ Xph @ (cwf @ XD @ XB2 @ (cccom @ XF @ XG)))))))))))))).
