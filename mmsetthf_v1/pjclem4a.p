...
thf(cpjclem4a_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (cwi @ (cwcel @ XA2 @ (ccin @ XG @ XH)) @ (cwceq @ (ccfv @ XA2 @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh))) @ XA2)))))))).
