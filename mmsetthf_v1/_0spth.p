...
thf(a_0trl_thm,axiom,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XU) @ (cwb @ (cwbr @ cc0 @ XP @ (ccfv @ XG @ cctrls)) @ (cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP))))))))).
...
thf(afz0sn_thm,axiom,(cwceq @ (cco @ ccc0 @ ccc0 @ ccfz) @ (ccsn @ ccc0))).
...
thf(c_0spth_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XW) @ (cwb @ (cwbr @ cc0 @ XP @ (ccfv @ XG @ ccspths)) @ (cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP))))))))).
