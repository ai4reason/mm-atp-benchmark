...
thf(cdeg1ge_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XA2 @ (ccfv @ XF @ ccco1)) => (cwi @ (cw3a @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ ccn0) @ (cwne @ (ccfv @ XG @ XA2) @ Xc_0)) @ (cwbr @ XG @ (ccfv @ XF @ XD) @ ccle)))))))))))))))).
