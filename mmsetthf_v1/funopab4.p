...
thf(afunopabeq_thm,axiom,(! [XA2:($i > ($i > $o))] : (cwfun @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3)))))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(cccom_tp,type,(cccom : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(afunss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwi @ (cwfun @ XB2) @ (cwfun @ XA2)))))).
thf(cfunopab4_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (cwfun @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (Xph @ Xx3 @ Xy1) @ (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3)))))))))).
