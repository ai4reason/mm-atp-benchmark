...
thf(afuneu_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwfun @ XF) @ (cwbr @ XA2 @ (XB2 @ Xy1) @ XF)) @ (cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF))))))))).
thf(cwtru_tp,type,(cwtru : $o)).
thf(aeubii_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (cwb @ (Xph @ Xx3) @ (Xps @ Xx3))) => (cwb @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))))))).
thf(cfuneu2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwfun @ XF) @ (cwcel @ (ccop @ XA2 @ (XB2 @ Xy1)) @ XF)) @ (cweu @ (^ [Xy1:$i] : (cwcel @ (ccop @ XA2 @ (ccv @ Xy1)) @ XF))))))))).
