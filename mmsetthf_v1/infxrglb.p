...
thf(cinfxrglb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwb @ (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ XB2 @ cclt) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ cclt)) @ (^ [Xx3:$i] : XA2))))))).
