...
thf(asinpi_thm,axiom,(cwceq @ (ccfv @ ccpi @ ccsin) @ ccc0)).
...
thf(csinppi_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ XA2 @ ccpi @ ccaddc) @ ccsin) @ (ccneg @ (ccfv @ XA2 @ ccsin)))))).
