...
thf(cfsuppcolem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn)) => ((cwi @ Xph @ (cwf1 @ XX @ XY @ XG)) => (cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ (cccom @ XF @ XG)) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn))))))))))).
