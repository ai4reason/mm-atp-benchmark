...
thf(ctsmssubm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctps)) => ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd))) => ((cwi @ Xph @ (cwf @ XA2 @ XS @ XF)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => (cwi @ Xph @ (cwceq @ (cco @ XH @ XF @ cctsu) @ (ccin @ (cco @ XG @ XF @ cctsu) @ XS))))))))))))))))).
