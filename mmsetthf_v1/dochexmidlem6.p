...
thf(adihoml4_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XS @ (ccfv @ XU @ cclss)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => ((cwi @ Xph @ (cwcel @ XY @ XS)) => ((cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XY @ Xc_pe) @ Xc_pe) @ XY)) => ((cwi @ Xph @ (cwss @ XX @ XY)) => (cwi @ Xph @ (cwceq @ (ccin @ (ccfv @ (ccin @ (ccfv @ XX @ Xc_pe) @ XY) @ Xc_pe) @ XY) @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe)))))))))))))))))))))).
...
thf(cdochexmidlem6_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (XH @ Xp) @ (ccfv @ (XK @ Xp) @ cclh))) => ((! [Xp:$i] : (cwceq @ (Xc_pe @ Xp) @ (ccfv @ (XW @ Xp) @ (ccfv @ (XK @ Xp) @ ccoch)))) => ((! [Xp:$i] : (cwceq @ (XU @ Xp) @ (ccfv @ (XW @ Xp) @ (ccfv @ (XK @ Xp) @ ccdvh)))) => ((! [Xp:$i] : (cwceq @ (XV @ Xp) @ (ccfv @ (XU @ Xp) @ ccbs))) => ((! [Xp:$i] : (cwceq @ (XS @ Xp) @ (ccfv @ (XU @ Xp) @ cclss))) => ((! [Xp:$i] : (cwceq @ (XN @ Xp) @ (ccfv @ (XU @ Xp) @ cclspn))) => ((! [Xp:$i] : (cwceq @ (Xc_po @ Xp) @ (ccfv @ (XU @ Xp) @ cclsm))) => ((! [Xp:$i] : (cwceq @ (XA2 @ Xp) @ (ccfv @ (XU @ Xp) @ cclsa))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwa @ (cwcel @ (XK @ Xp) @ cchlt) @ (cwcel @ (XW @ Xp) @ (XH @ Xp))))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XX @ Xp) @ (XS @ Xp)))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (ccv @ Xp) @ (XA2 @ Xp)))) => ((! [Xp:$i] : (cwceq @ (Xc_0 @ Xp) @ (ccfv @ (XU @ Xp) @ cc0g))) => ((! [Xp:$i] : (cwceq @ (XM @ Xp) @ (cco @ (XX @ Xp) @ (ccv @ Xp) @ (Xc_po @ Xp)))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwne @ (XX @ Xp) @ (ccsn @ (Xc_0 @ Xp))))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwceq @ (ccfv @ (ccfv @ (XX @ Xp) @ (Xc_pe @ Xp)) @ (Xc_pe @ Xp)) @ (XX @ Xp)))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwn @ (cwss @ (ccv @ Xp) @ (cco @ (XX @ Xp) @ (ccfv @ (XX @ Xp) @ (Xc_pe @ Xp)) @ (Xc_po @ Xp)))))) => (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwceq @ (XM @ Xp) @ (XX @ Xp))))))))))))))))))))))))))))))))))).
