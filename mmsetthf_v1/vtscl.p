...
thf(cvtscl_conj,conjecture,(! [Xph:$o] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwf @ ccn @ ccc @ XL)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ (cco @ XL @ XN @ ccvts)) @ ccc)))))))))).
