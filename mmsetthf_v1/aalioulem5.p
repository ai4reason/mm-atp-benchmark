...
thf(aaalioulem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xx3 @ Xq @ Xp) @ (ccfv @ XF @ ccdgr))))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xx3:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3 @ Xq @ Xp) @ ccn))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ ccc0)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : (cwi @ (cwa @ (cwne @ (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ XF) @ ccc0) @ (cwbr @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ cc1 @ ccle)) @ (cwo @ (cwceq @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) @ (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (XN @ Xx3 @ Xq @ Xp) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ ccle)))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))))))).
...
thf(caalioulem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xq @ Xp) @ (ccfv @ XF @ ccdgr)))) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xq:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xq @ Xp) @ ccn)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ XF) @ ccc0)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : (cwi @ (cwne @ (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ XF) @ ccc0) @ (cwo @ (cwceq @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) @ (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (XN @ Xq @ Xp) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ ccle)))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))))))).
