...
thf(ccomfffval2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XO @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (ccfv @ XC @ cccomf)))))) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XH @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (ccfv @ XC @ cchomf)))))) => ((! [Xy1:$i] : (cwceq @ (Xc_x @ Xy1) @ (ccfv @ XC @ ccco))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwceq @ (XO @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ XB2 @ XB2))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt2 @ (^ [Xg1:$i] : (^ [Xf1:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccv @ Xy1) @ (XH @ Xx3 @ Xy1 @ Xf1 @ Xg1)))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccfv @ (ccv @ Xx3) @ (XH @ Xx3 @ Xy1 @ Xf1 @ Xg1)))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xy1)))))))))))))))))))))))).
