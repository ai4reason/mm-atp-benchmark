...
thf(cjm2_17b_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwbr @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XN @ ccexp) @ ccle))))).
