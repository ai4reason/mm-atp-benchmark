...
thf(amdslmd4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (cwi @ (cw3a @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwa @ (cwss @ (ccin @ XA2 @ XB2) @ XC) @ (cwss @ XC @ XA2)) @ (cwa @ (cwss @ (ccin @ XA2 @ XB2) @ XD) @ (cwss @ XD @ XB2))) @ (cwbr @ XC @ XD @ ccmd))))))))))).
...
thf(admdi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdmd) @ (cwss @ XB2 @ XC))) @ (cwceq @ (cco @ (ccin @ XC @ XA2) @ XB2 @ cchj) @ (ccin @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
...
thf(amdsl2bi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwss @ (ccin @ XA2 @ XB2) @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) @ (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch)))))))).
thf(ccsmdsymi_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xc:$i] : (cwcel @ (XA2 @ Xc) @ ccch)) => ((cwcel @ XB2 @ ccch) => (! [Xc:$i] : (cwi @ (cwa @ (cwral @ (^ [Xc:$i] : (cwi @ (cwbr @ (ccv @ Xc) @ XB2 @ ccmd) @ (cwbr @ XB2 @ (ccv @ Xc) @ ccdmd))) @ (^ [Xc:$i] : ccch)) @ (cwbr @ (XA2 @ Xc) @ XB2 @ ccmd)) @ (cwbr @ XB2 @ (XA2 @ Xc) @ ccmd)))))))).
