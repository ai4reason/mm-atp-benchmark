...
thf(clspss_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwss @ XU @ XV) @ (cwss @ XT @ XU)) @ (cwss @ (ccfv @ XT @ XN) @ (ccfv @ XU @ XN))))))))))).
