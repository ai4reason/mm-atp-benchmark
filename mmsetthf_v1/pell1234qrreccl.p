...
thf(cpell1234qrreccl_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr))) @ (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ (ccfv @ XD @ ccpell1234qr)))))).
