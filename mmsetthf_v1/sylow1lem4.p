...
thf(csylow1lem4_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xg1 @ Xs1) @ (cwcel @ XG @ ccgrp)))) => ((! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xg1 @ Xs1) @ (cwcel @ XX @ ccfn)))) => ((! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xg1 @ Xs1) @ (cwcel @ XP @ ccprime)))) => ((! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xg1 @ Xs1) @ (cwcel @ XN @ ccn0)))) => ((! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xg1 @ Xs1) @ (cwbr @ (cco @ XP @ XN @ ccexp) @ (ccfv @ XX @ cchash) @ ccdvds)))) => ((! [Xg1:$i] : (cwceq @ (Xc_pl @ Xg1) @ (ccfv @ XG @ ccplusg))) => ((! [Xs1:$i] : (cwceq @ (XS @ Xs1) @ (ccrab @ (^ [Xs1:$i] : (cwceq @ (ccfv @ (ccv @ Xs1) @ cchash) @ (cco @ XP @ XN @ ccexp))) @ (^ [Xs1:$i] : (ccpw @ XX))))) => ((! [Xg1:$i] : (! [Xs1:$i] : (cwceq @ (Xc_po @ Xs1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XS @ Xs1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_pl @ Xg1))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwceq @ (Xc_sm @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xs1) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XS @ Xs1)) @ (cwrex @ (^ [Xg1:$i] : (cwceq @ (cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ (Xc_po @ Xs1)) @ (ccv @ Xy1))) @ (^ [Xg1:$i] : XX)))))))))))) => ((! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xg1 @ Xs1) @ (cwcel @ XB2 @ (XS @ Xs1))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xs1:$i] : (cwceq @ (XH @ Xz @ Xu @ Xs1) @ (ccrab @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ XB2 @ (Xc_po @ Xs1)) @ XB2)) @ (^ [Xu:$i] : XX)))))) => (! [Xz:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xs1:$i] : (cwi @ (Xph @ Xg1 @ Xs1) @ (cwbr @ (ccfv @ (XH @ Xz @ Xu @ Xs1) @ cchash) @ (cco @ XP @ XN @ ccexp) @ ccle)))))))))))))))))))))))))))))).
