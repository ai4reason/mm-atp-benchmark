...
thf(adf_bigo_ax,axiom,(cwceq @ ccbigo @ (ccmpt @ (^ [Xg1:$i] : (cco @ ccr @ ccr @ ccpm)) @ (^ [Xg1:$i] : (ccrab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ (ccv @ Xf1)) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))) @ (^ [Xf1:$i] : (cco @ ccr @ ccr @ ccpm))))))).
...
thf(cbigoval_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ (cco @ ccr @ ccr @ ccpm)) @ (cwceq @ (ccfv @ XG @ ccbigo) @ (ccrab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ (ccv @ Xf1)) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))) @ (^ [Xf1:$i] : (cco @ ccr @ ccr @ ccpm))))))).
