...
thf(auntsucf_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xy1:$i] : (XA2 @ Xy1))) => (! [Xy1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccsuc @ (XA2 @ Xy1))))))))).
...
thf(cdfon2lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xz)) @ (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xx3) @ XA2) @ (cwtr @ (ccv @ Xx3))) @ (cwcel @ (ccv @ Xx3) @ XA2)))) @ (cwa @ (cwtr @ XA2) @ (cwral @ (^ [Xz:$i] : (cwn @ (cwcel @ (ccv @ Xz) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XA2)))))))))).
