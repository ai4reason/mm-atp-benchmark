...
thf(coppccofval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => (cwi @ Xph @ (cwceq @ (cco @ (ccop @ XX @ XY) @ XZ @ (ccfv @ XO @ ccco)) @ (cctpos @ (cco @ (ccop @ XZ @ XY) @ XX @ Xc_x))))))))))))))))))).
