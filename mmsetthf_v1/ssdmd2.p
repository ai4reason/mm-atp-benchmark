...
thf(assmd1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ XB2)) @ (cwbr @ XA2 @ XB2 @ ccmd))))).
thf(cssdmd2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ XB2)) @ (cwbr @ (ccfv @ XB2 @ ccort) @ (ccfv @ XA2 @ ccort) @ ccmd))))).
