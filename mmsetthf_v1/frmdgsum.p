...
thf(cfrmdgsum_conj,conjecture,(! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XM @ (ccfv @ XI @ ccfrmd)) => ((cwceq @ XU @ (ccfv @ XI @ ccvrmd)) => (cwi @ (cwa @ (cwcel @ XI @ XV) @ (cwcel @ XW @ (ccword @ XI))) @ (cwceq @ (cco @ XM @ (cccom @ XU @ XW) @ ccgsu) @ XW)))))))))).
