...
thf(acoshval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cccos) @ (cco @ (cco @ (ccfv @ XA2 @ cce) @ (ccfv @ (ccneg @ XA2) @ cce) @ ccaddc) @ cc2 @ ccdiv))))).
...
thf(arpefcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ cce) @ ccrp)))).
...
thf(crpcoshcl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cccos) @ ccrp)))).
