...
thf(adf_srng_ax,axiom,(cwceq @ ccsr @ (ccab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xi:$i] : (cwa @ (cwcel @ (ccv @ Xi) @ (cco @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xf1) @ ccoppr) @ ccrh)) @ (cwceq @ (ccv @ Xi) @ (cccnv @ (ccv @ Xi))))) @ (ccfv @ (ccv @ Xf1) @ ccstf)))))).
...
thf(cissrng_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XR @ ccoppr)) => ((cwceq @ Xc_as @ (ccfv @ XR @ ccstf)) => (cwb @ (cwcel @ XR @ ccsr) @ (cwa @ (cwcel @ Xc_as @ (cco @ XR @ XO @ ccrh)) @ (cwceq @ Xc_as @ (cccnv @ Xc_as)))))))))).
