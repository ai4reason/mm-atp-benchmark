...
thf(aftalem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ XF @ (ccfv @ (XS @ Xx3 @ Xr) @ ccply))))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ XN @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ (XE @ Xx3 @ Xk) @ ccrp))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XT @ (cco @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ XA2) @ ccabs))) @ (XE @ Xx3 @ Xk) @ ccdiv)))) => (! [Xk:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xr) @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ (ccfv @ XN @ XA2) @ (cco @ (ccv @ Xx3) @ XN @ ccexp) @ ccmul) @ ccmin) @ ccabs) @ (cco @ (XE @ Xx3 @ Xk) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XN @ ccexp) @ ccmul) @ cclt))) @ (^ [Xx3:$i] : ccc))) @ (^ [Xr:$i] : ccr))))))))))))))))))).
...
thf(cftalem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ XF @ (ccfv @ (XS @ Xx3 @ Xr) @ ccply))))) => ((! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwcel @ XN @ ccn))) => ((! [Xs1:$i] : (cwceq @ (XU @ Xs1) @ (ccif @ (cwbr @ (ccif @ (cwbr @ cc1 @ (ccv @ Xs1) @ ccle) @ (ccv @ Xs1) @ cc1) @ (XT @ Xs1) @ ccle) @ (XT @ Xs1) @ (ccif @ (cwbr @ cc1 @ (ccv @ Xs1) @ ccle) @ (ccv @ Xs1) @ cc1)))) => ((! [Xs1:$i] : (cwceq @ (XT @ Xs1) @ (cco @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (cco @ (ccfv @ (ccfv @ XN @ XA2) @ ccabs) @ cc2 @ ccdiv) @ ccdiv))) => (! [Xr:$i] : (cwi @ (Xph @ Xr) @ (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xr) @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cclt) @ (cwbr @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ cclt))) @ (^ [Xx3:$i] : ccc))) @ (^ [Xr:$i] : ccrp)))))))))))))))))).
