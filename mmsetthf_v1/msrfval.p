...
thf(adf_msr_ax,axiom,(cwceq @ ccmsr @ (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccmpt @ (^ [Xs1:$i] : (ccfv @ (ccv @ Xt) @ ccmpst)) @ (^ [Xs1:$i] : (ccsb @ (ccfv @ (ccfv @ (ccv @ Xs1) @ cc1st) @ cc2nd) @ (^ [Xh:$i] : (ccsb @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (^ [Xa:$i] : (ccotp @ (ccin @ (ccfv @ (ccfv @ (ccv @ Xs1) @ cc1st) @ cc1st) @ (ccsb @ (ccuni @ (ccima @ (ccfv @ (ccv @ Xt) @ ccmvrs) @ (ccun @ (ccv @ Xh) @ (ccsn @ (ccv @ Xa))))) @ (^ [Xz:$i] : (ccxp @ (ccv @ Xz) @ (ccv @ Xz))))) @ (ccv @ Xh) @ (ccv @ Xa)))))))))))).
