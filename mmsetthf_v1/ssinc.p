...
thf(cssinc_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ (cco @ XM @ XN @ ccfzo))) @ (cwss @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF)))) => (cwi @ Xph @ (cwss @ (ccfv @ XM @ XF) @ (ccfv @ XN @ XF)))))))))).
