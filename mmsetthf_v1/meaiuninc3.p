...
thf(ameaiuninc3v_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xn) @ ccz))) => ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xn) @ ccuz))) => ((cwi @ Xph @ (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (ccv @ Xn) @ XE) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE)))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XS @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ cclsxlim)))))))))))))))).
...
thf(cmeaiuninc3_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((cwnfc @ (^ [Xn:$i] : (XE @ Xn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XM @ ccmea))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccz))) => ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwf @ XZ @ (ccdm @ XM) @ (XE @ Xn)))) => ((! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (XE @ Xn))))) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ XM))))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (XS @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xn)))) @ XM) @ cclsxlim)))))))))))))))))).
