...
thf(annesuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwceq @ (cco @ XA2 @ (ccsuc @ XB2) @ ccoe) @ (cco @ (cco @ XA2 @ XB2 @ ccoe) @ XA2 @ ccomu)))))).
thf(cnnecl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccoe) @ ccom))))).
