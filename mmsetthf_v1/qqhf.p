...
thf(aqqhval2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0)) @ (cwceq @ (ccfv @ XR @ ccqqh) @ (ccmpt @ (^ [Xq:$i] : ccq) @ (^ [Xq:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xq) @ ccnumer) @ XL) @ (ccfv @ (ccfv @ (ccv @ Xq) @ ccdenom) @ XL) @ Xc_dv))))))))))))).
...
thf(cqqhf_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0)) @ (cwf @ ccq @ XB2 @ (ccfv @ XR @ ccqqh))))))))))).
