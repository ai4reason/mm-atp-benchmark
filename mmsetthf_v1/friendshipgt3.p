...
thf(afrgrogt3nreg_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwbr @ cc3 @ (ccfv @ XV @ cchash) @ cclt)) @ (cwral @ (^ [Xk:$i] : (cwn @ (cwbr @ XG @ (ccv @ Xk) @ ccrusgr))) @ (^ [Xk:$i] : ccn0))))))).
...
thf(afusgrn0degnn0_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XV @ Xn) @ (ccfv @ XG @ ccvtx))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwne @ (XV @ Xn) @ cc0)) @ (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ (ccv @ Xn))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xv:$i] : (XV @ Xn))))))))).
...
thf(cfriendshipgt3_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwbr @ cc3 @ (ccfv @ XV @ cchash) @ cclt)) @ (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ (ccfv @ XG @ ccedg))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))).
