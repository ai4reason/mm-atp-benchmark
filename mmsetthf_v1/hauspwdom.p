...
thf(ahausmapdom_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ cc1stc) @ (cwss @ XA2 @ XX)) @ (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (cco @ XA2 @ ccn @ ccmap) @ ccdom))))))).
...
thf(apw2eng_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwbr @ (ccpw @ XA2) @ (cco @ cc2o @ XA2 @ ccmap) @ ccen))))).
...
thf(amappwen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XB2 @ ccdom)) @ (cwa @ (cwbr @ cc2o @ XA2 @ ccdom) @ (cwbr @ XA2 @ (ccpw @ XB2) @ ccdom))) @ (cwbr @ (cco @ XA2 @ XB2 @ ccmap) @ (ccpw @ XB2) @ ccen))))).
...
thf(chauspwdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ cc1stc) @ (cwss @ XA2 @ XX)) @ (cwa @ (cwbr @ XA2 @ (ccpw @ XB2) @ ccdom) @ (cwbr @ ccn @ XB2 @ ccdom))) @ (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccpw @ XB2) @ ccdom)))))))).
