...
thf(acntzsubr_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwss @ XS @ XB2)) @ (cwcel @ (ccfv @ XS @ XZ) @ (ccfv @ XR @ ccsubrg)))))))))))).
...
thf(adrngmgp_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XG @ (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => (cwi @ (cwcel @ XR @ ccdr) @ (cwcel @ XG @ ccgrp)))))))))).
...
thf(acntz2ss_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwa @ (cwss @ XS @ XB2) @ (cwss @ XT @ XS)) @ (cwss @ (ccfv @ XS @ XZ) @ (ccfv @ XT @ XZ))))))))))).
...
thf(aresscntz_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XA2 @ ccress)) => ((cwceq @ XZ @ (ccfv @ XG @ cccntz)) => ((cwceq @ XY @ (ccfv @ XH @ cccntz)) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwss @ XS @ XA2)) @ (cwceq @ (ccfv @ XS @ XY) @ (ccin @ (ccfv @ XS @ XZ) @ XA2)))))))))))))).
...
thf(aissdrg2_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ XR @ ccinvr))) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwb @ (cwcel @ XS @ (ccfv @ XR @ ccsdrg)) @ (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XS @ (ccfv @ XR @ ccsubrg)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XI @ Xx3)) @ XS)) @ (^ [Xx3:$i] : (ccdif @ XS @ (ccsn @ Xc_0))))))))))))).
thf(ccntzsdrg_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XM @ (ccfv @ XR @ ccmgp)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwss @ XS @ XB2)) @ (cwcel @ (ccfv @ XS @ XZ) @ (ccfv @ XR @ ccsdrg)))))))))))).
