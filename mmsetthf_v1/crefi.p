...
thf(ccrefi_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XX @ Xz) @ (ccuni @ XJ))) => (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ (cccref @ XA2)) @ (cwss @ XC @ XJ) @ (cwceq @ (XX @ Xz) @ (ccuni @ XC))) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ XC @ ccref)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XJ) @ XA2))))))))))).
