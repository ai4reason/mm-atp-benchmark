...
thf(adf_rag_ax,axiom,(cwceq @ ccrag @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrab @ (^ [Xw:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xw) @ cchash) @ cc3) @ (cwceq @ (cco @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ cc2 @ (ccv @ Xw)) @ (ccfv @ (ccv @ Xg1) @ ccds)) @ (cco @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ (ccfv @ cc2 @ (ccv @ Xw)) @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xw)) @ (ccfv @ (ccv @ Xg1) @ ccmir))) @ (ccfv @ (ccv @ Xg1) @ ccds))))) @ (^ [Xw:$i] : (ccword @ (ccfv @ (ccv @ Xg1) @ ccbs)))))))).
...
thf(cisrag_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwceq @ XS @ (ccfv @ XG @ ccmir)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => (cwi @ Xph @ (cwb @ (cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccrag)) @ (cwceq @ (cco @ XA2 @ XC @ Xc_mi) @ (cco @ XA2 @ (ccfv @ XC @ (ccfv @ XB2 @ XS)) @ Xc_mi)))))))))))))))))))))))).
