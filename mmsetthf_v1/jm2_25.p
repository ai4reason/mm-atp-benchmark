...
thf(azindbi_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccz) @ (cwb @ (Xps @ Xy1) @ (Xch @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xx3) @ (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ ccc0) @ (cwb @ (Xph @ Xx3) @ (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ (Xta @ Xy1))))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwb @ (Xth @ Xy1) @ (Xta @ Xy1)))))))))))))))).
...
thf(armxdbl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccmul) @ ccrmx) @ (cco @ (cco @ cc2 @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ cc2 @ ccexp) @ ccmul) @ cc1 @ ccmin)))))).
...
thf(armydbl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccmul) @ ccrmy) @ (cco @ (cco @ cc2 @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul)))))).
...
thf(ajm2_25lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ XC @ ccz) @ (cwcel @ XD @ ccz)) @ (cwo @ (cwbr @ XA2 @ (cco @ XC @ XD @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XC @ (ccneg @ XD) @ ccmin) @ ccdvds))) @ (cwb @ (cwo @ (cwbr @ XA2 @ (cco @ XD @ XB2 @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XD @ (ccneg @ XB2) @ ccmin) @ ccdvds)) @ (cwo @ (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XC @ (ccneg @ XB2) @ ccmin) @ ccdvds))))))))).
