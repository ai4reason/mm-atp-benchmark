...
thf(abezoutr1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ XX @ ccz) @ (cwcel @ XY @ ccz))) @ (cwi @ (cwceq @ (cco @ (cco @ XA2 @ XX @ ccmul) @ (cco @ XB2 @ XY @ ccmul) @ ccaddc) @ cc1) @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1)))))))).
thf(cjm2_19lem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccz)) @ (cwceq @ (cco @ (cco @ XA2 @ XM @ ccrmx) @ (cco @ XA2 @ XM @ ccrmy) @ ccgcd) @ cc1))))).
