...
thf(aprssd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XC)) => ((cwi @ Xph @ (cwcel @ XB2 @ XC)) => (cwi @ Xph @ (cwss @ (ccpr @ XA2 @ XB2) @ XC))))))))).
...
thf(ceupth2lems_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [Xn:$i] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ ccupgr))) => ((cwi @ Xph @ (cwfun @ XI)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwbr @ XF @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ cceupth)))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn0)) @ (cwi @ (cwi @ (cwbr @ (ccv @ Xn) @ (ccfv @ XF @ cchash) @ ccle) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwn @ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccop @ XV @ (ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ (ccv @ Xn) @ ccfzo)))) @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)) @ (ccif @ (cwceq @ (ccfv @ ccc0 @ (XP @ Xx3)) @ (ccfv @ (ccv @ Xn) @ (XP @ Xx3))) @ cc0 @ (ccpr @ (ccfv @ ccc0 @ (XP @ Xx3)) @ (ccfv @ (ccv @ Xn) @ (XP @ Xx3)))))) @ (cwi @ (cwbr @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccfv @ XF @ cchash) @ ccle) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwn @ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccop @ XV @ (ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccfzo)))) @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)) @ (ccif @ (cwceq @ (ccfv @ ccc0 @ (XP @ Xx3)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (XP @ Xx3))) @ cc0 @ (ccpr @ (ccfv @ ccc0 @ (XP @ Xx3)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (XP @ Xx3)))))))))))))))))))))).
