...
thf(clsmdisj2_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((cwi @ Xph @ (cwceq @ (ccin @ (cco @ XS @ XT @ Xc_po) @ XU) @ (ccsn @ Xc_0))) => ((cwi @ Xph @ (cwceq @ (ccin @ XS @ XT) @ (ccsn @ Xc_0))) => (cwi @ Xph @ (cwceq @ (ccin @ XT @ (cco @ XS @ XU @ Xc_po)) @ (ccsn @ Xc_0)))))))))))))))))).
