...
thf(cifeqda_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ (cwa @ Xph @ Xps) @ (cwceq @ XA2 @ XC)) => ((cwi @ (cwa @ Xph @ (cwn @ Xps)) @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ (ccif @ Xps @ XA2 @ XB2) @ XC)))))))))).
