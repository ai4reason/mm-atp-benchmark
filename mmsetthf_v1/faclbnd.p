...
thf(cfaclbnd_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwbr @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ (cco @ (cco @ XM @ XM @ ccexp) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
