...
thf(amndvcl_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XM @ ccmnd) @ (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap)) @ (cwcel @ XY @ (cco @ XB2 @ XI @ ccmap))) @ (cwcel @ (cco @ XX @ XY @ (ccof @ Xc_pl)) @ (cco @ XB2 @ XI @ ccmap)))))))))))).
...
thf(cmamudir_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwceq @ XF @ (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((cwi @ Xph @ (cwcel @ XM @ ccfn)) => ((cwi @ Xph @ (cwcel @ XN @ ccfn)) => ((cwi @ Xph @ (cwcel @ XO @ ccfn)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => ((cwi @ Xph @ (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => (cwi @ Xph @ (cwceq @ (cco @ XX @ (cco @ XY @ XZ @ (ccof @ Xc_pl)) @ XF) @ (cco @ (cco @ XX @ XY @ XF) @ (cco @ XX @ XZ @ XF) @ (ccof @ Xc_pl)))))))))))))))))))))))))).
