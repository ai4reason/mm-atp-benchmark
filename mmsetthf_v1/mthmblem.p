...
thf(cmthmblem_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XR @ (ccfv @ XT @ ccmsr)) => ((cwceq @ XU @ (ccfv @ XT @ ccmthm)) => (cwi @ (cwceq @ (ccfv @ XX @ XR) @ (ccfv @ XY @ XR)) @ (cwi @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XU))))))))))).
