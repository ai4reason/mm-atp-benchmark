...
thf(atrsucss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwtr @ XA2) @ (cwi @ (cwcel @ XB2 @ (ccsuc @ XA2)) @ (cwss @ XB2 @ XA2)))))).
...
thf(cefgmnvl_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XM @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (XA2 @ Xy1 @ Xz) @ (ccxp @ XI @ cc2o)) @ (cwceq @ (ccfv @ (ccfv @ (XA2 @ Xy1 @ Xz) @ (XM @ Xy1 @ Xz)) @ (XM @ Xy1 @ Xz)) @ (XA2 @ Xy1 @ Xz)))))))))).
