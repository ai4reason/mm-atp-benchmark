...
thf(aralss_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwb @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(amreacs_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ XV) @ (cwcel @ (ccfv @ XX @ ccacs) @ (ccfv @ (ccpw @ XX) @ ccmre)))))).
...
thf(aacsfn_thm,axiom,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XX @ XV) @ (cwcel @ XK @ XX)) @ (cwa @ (cwss @ XT @ XX) @ (cwcel @ XT @ ccfn))) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (cwi @ (cwss @ XT @ (ccv @ Xa)) @ (cwcel @ XK @ (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
thf(amreriincl_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (XS @ Xy1) @ XC)) @ (^ [Xy1:$i] : XI))) @ (cwcel @ (ccin @ XX @ (cciin @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (XS @ Xy1)))) @ XC))))))).
thf(cacsfn1_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ XV) @ (cwral @ (^ [Xb:$i] : (cwcel @ (XE @ Xb) @ XX)) @ (^ [Xb:$i] : XX))) @ (cwcel @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (XE @ Xb) @ (ccv @ Xa))) @ (^ [Xb:$i] : (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs))))))).
