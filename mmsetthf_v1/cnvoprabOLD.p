...
thf(ccnvoprabOLD_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwnf @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xa) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwb @ (Xps @ Xx3 @ Xy1 @ Xz @ Xa) @ (Xph @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xps @ Xx3 @ Xy1 @ Xz @ Xa) @ (cwcel @ (ccv @ Xa) @ (ccxp @ ccvv @ ccvv))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (cccnv @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) @ (ccopab @ (^ [Xz:$i] : (^ [Xa:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)))))))))))))).
