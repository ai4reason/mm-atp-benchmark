...
thf(afgreu_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwcel @ XX @ (ccdm @ XF))) @ (cwreu @ (^ [Xp:$i] : (cwceq @ XX @ (ccfv @ (ccv @ Xp) @ cc1st))) @ (^ [Xp:$i] : XF)))))).
...
thf(a_2nd1st_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccxp @ XB2 @ XC)) @ (cwceq @ (ccuni @ (cccnv @ (ccsn @ XA2))) @ (ccop @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XA2 @ cc1st)))))))).
thf(ampan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ Xps @ Xch))))))).
thf(arelcnv_thm,axiom,(! [XA2:($i > $o)] : (cwrel @ (cccnv @ XA2)))).
thf(asimpld_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwa @ Xps @ Xch)) => (cwi @ Xph @ Xps)))))).
thf(acnvf1olem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwrel @ XA2) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwceq @ XC @ (ccuni @ (cccnv @ (ccsn @ XB2)))))) @ (cwa @ (cwcel @ XC @ (cccnv @ XA2)) @ (cwceq @ XB2 @ (ccuni @ (cccnv @ (ccsn @ XC)))))))))).
...
thf(cfcnvgreu_conj,conjecture,(! [XA2:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwrel @ XA2) @ (cwfun @ (cccnv @ XA2))) @ (cwcel @ XY @ (ccrn @ XA2))) @ (cwreu @ (^ [Xp:$i] : (cwceq @ XY @ (ccfv @ (ccv @ Xp) @ cc2nd))) @ (^ [Xp:$i] : XA2)))))).
