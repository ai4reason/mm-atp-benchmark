...
thf(cpfxccatpfx1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ XL @ ccfz))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccconcat) @ XN @ ccpfx) @ (cco @ XA2 @ XN @ ccpfx)))))))))).
