...
thf(arelexp1d_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => (cwi @ Xph @ (cwceq @ (cco @ XR @ cc1 @ ccrelexp) @ XR)))))).
...
thf(crelexpmulnn_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ XV) @ (cwceq @ XI @ (cco @ XJ @ XK @ ccmul))) @ (cwa @ (cwcel @ XJ @ ccn) @ (cwcel @ XK @ ccn))) @ (cwceq @ (cco @ (cco @ XR @ XJ @ ccrelexp) @ XK @ ccrelexp) @ (cco @ XR @ XI @ ccrelexp))))))))).
