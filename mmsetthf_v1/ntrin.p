...
thf(cntrin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX) @ (cwss @ XB2 @ XX)) @ (cwceq @ (ccfv @ (ccin @ XA2 @ XB2) @ (ccfv @ XJ @ ccnt)) @ (ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XB2 @ (ccfv @ XJ @ ccnt))))))))))).
