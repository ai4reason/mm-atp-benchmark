...
thf(adf_ntr_ax,axiom,(cwceq @ ccnt @ (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xj)))) @ (^ [Xx3:$i] : (ccuni @ (ccin @ (ccv @ Xj) @ (ccpw @ (ccv @ Xx3)))))))))).
thf(cntrfval_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwceq @ (ccfv @ XJ @ ccnt) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccuni @ (ccin @ XJ @ (ccpw @ (ccv @ Xx3)))))))))))).
