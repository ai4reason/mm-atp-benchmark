...
thf(aonnbtwn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwn @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ (ccsuc @ XA2)))))))).
...
thf(aomord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) @ (cwb @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwcel @ cc0 @ XC)) @ (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
...
thf(aoa1suc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (cco @ XA2 @ cc1o @ ccoa) @ (ccsuc @ XA2))))).
...
thf(coneo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwceq @ XC @ (cco @ cc2o @ XA2 @ ccomu))) @ (cwn @ (cwceq @ (ccsuc @ XC) @ (cco @ cc2o @ XB2 @ ccomu)))))))).
