...
thf(ahashgt12el_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XV @ (XW @ Xb)) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwne @ (ccv @ Xa) @ (ccv @ Xb))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
...
thf(cring1ne0_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwbr @ cc1 @ (ccfv @ XB2 @ cchash) @ cclt)) @ (cwne @ Xc_1 @ Xc_0)))))))))).
