...
thf(aleadd1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ ccle))))))))).
...
thf(cppiublem1_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwa @ (cwbr @ XN @ cc6 @ ccle) @ (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ cc4 @ XP @ ccle)) @ (cwi @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (cco @ XN @ cc5 @ ccfz)) @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))) => ((cwcel @ XM @ ccn0) => ((cwceq @ XN @ (cco @ XM @ cc1 @ ccaddc)) => ((cw3o @ (cwbr @ cc2 @ XM @ ccdvds) @ (cwbr @ cc3 @ XM @ ccdvds) @ (cwcel @ XM @ (ccpr @ cc1 @ cc5))) => (cwa @ (cwbr @ XM @ cc6 @ ccle) @ (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ cc4 @ XP @ ccle)) @ (cwi @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (cco @ XM @ cc5 @ ccfz)) @ (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))))))))))).
