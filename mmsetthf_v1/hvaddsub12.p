...
thf(ahvadd12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccva) @ ccva) @ (cco @ XB2 @ (cco @ XA2 @ XC @ ccva) @ ccva))))))).
...
thf(chvaddsub12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmv) @ ccva) @ (cco @ XB2 @ (cco @ XA2 @ XC @ ccmv) @ ccva))))))).
