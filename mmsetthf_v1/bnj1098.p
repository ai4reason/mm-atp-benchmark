...
thf(cbnj1098_conj,conjecture,(! [XD:($i > $o)] : (! [Xi:$i] : (! [Xn:$i] : ((cwceq @ XD @ (ccdif @ ccom @ (ccsn @ cc0))) => (cwex @ (^ [Xj:$i] : (cwi @ (cw3a @ (cwne @ (ccv @ Xi) @ cc0) @ (cwcel @ (ccv @ Xi) @ (ccv @ Xn)) @ (cwcel @ (ccv @ Xn) @ XD)) @ (cwa @ (cwcel @ (ccv @ Xj) @ (ccv @ Xn)) @ (cwceq @ (ccv @ Xi) @ (ccsuc @ (ccv @ Xj)))))))))))).
