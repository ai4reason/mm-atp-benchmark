...
thf(ciblcncfioo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ XF @ XA2 @ cclimc))) => (cwi @ Xph @ (cwcel @ XF @ ccibl)))))))))))))).
