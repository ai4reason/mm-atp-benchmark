...
thf(csetsres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwceq @ (ccres @ (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts) @ (ccdif @ ccvv @ (ccsn @ XA2))) @ (ccres @ XS @ (ccdif @ ccvv @ (ccsn @ XA2)))))))))).
