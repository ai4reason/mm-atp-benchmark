...
thf(cfneval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_sm @ (ccin @ ccfne @ (cccnv @ ccfne))) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwbr @ XA2 @ XB2 @ Xc_sm) @ (cwceq @ (ccfv @ XA2 @ cctg) @ (ccfv @ XB2 @ cctg))))))))))).
