...
thf(cpcfaclem_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ ccprime)) @ (cwceq @ (ccfv @ (cco @ XN @ (cco @ XP @ XM @ ccexp) @ ccdiv) @ ccfl) @ ccc0)))))).
