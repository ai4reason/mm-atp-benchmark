...
thf(aswrd00_thm,axiom,(! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwceq @ (cco @ XS @ (ccop @ XX @ XX) @ ccsubstr) @ cc0)))).
...
thf(aleaddle0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XA2 @ ccle) @ (cwbr @ XB2 @ ccc0 @ ccle)))))).
thf(apm2_24_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ Xph @ (cwi @ (cwn @ Xph) @ Xps))))).
thf(cswrdccat3blem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XL @ (ccfv @ XA2 @ cchash)) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV))) @ (cwcel @ XM @ (cco @ ccc0 @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz))) @ (cwbr @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ XL @ ccle)) @ (cwceq @ (ccif @ (cwbr @ XL @ XM @ ccle) @ (cco @ XB2 @ (ccop @ (cco @ XM @ XL @ ccmin) @ (ccfv @ XB2 @ cchash)) @ ccsubstr) @ (cco @ (cco @ XA2 @ (ccop @ XM @ XL) @ ccsubstr) @ XB2 @ ccconcat)) @ (cco @ XA2 @ (ccop @ XM @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc)) @ ccsubstr)))))))))).
