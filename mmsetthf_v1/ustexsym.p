...
thf(austinvel_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU)) @ (cwcel @ (cccnv @ XV) @ XU)))))).
...
thf(austssco_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU)) @ (cwss @ XV @ (cccom @ XV @ XV))))))).
...
thf(austexhalf_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU)) @ (cwrex @ (^ [Xw:$i] : (cwss @ (cccom @ (ccv @ Xw) @ (ccv @ Xw)) @ XV)) @ (^ [Xw:$i] : XU))))))).
thf(custexsym_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ (XX @ Xw) @ ccust)) @ (cwcel @ XV @ XU)) @ (cwrex @ (^ [Xw:$i] : (cwa @ (cwceq @ (cccnv @ (ccv @ Xw)) @ (ccv @ Xw)) @ (cwss @ (ccv @ Xw) @ XV))) @ (^ [Xw:$i] : XU)))))))).
