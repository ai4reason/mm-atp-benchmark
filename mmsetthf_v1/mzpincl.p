...
thf(amzpval_thm,axiom,(! [XV:($i > $o)] : (cwi @ (cwcel @ XV @ ccvv) @ (cwceq @ (ccfv @ XV @ ccmzp) @ (ccint @ (ccfv @ XV @ ccmzpcl)))))).
...
thf(amzpclall_thm,axiom,(! [XV:($i > $o)] : (cwi @ (cwcel @ XV @ ccvv) @ (cwcel @ (cco @ ccz @ (cco @ ccz @ XV @ ccmap) @ ccmap) @ (ccfv @ XV @ ccmzpcl))))).
...
thf(amzpcl1_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) @ (cwcel @ XF @ ccz)) @ (cwcel @ (ccxp @ (cco @ ccz @ XV @ ccmap) @ (ccsn @ XF)) @ XP)))))).
...
thf(cmzpincl_conj,conjecture,(! [XV:($i > $o)] : (cwi @ (cwcel @ XV @ ccvv) @ (cwcel @ (ccfv @ XV @ ccmzp) @ (ccfv @ XV @ ccmzpcl))))).
