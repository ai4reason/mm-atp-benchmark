...
thf(abiancom_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ (cwa @ Xch @ Xps)) => (cwb @ Xph @ (cwa @ Xps @ Xch))))))).
thf(aopelinxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (cwb @ (cwcel @ (ccop @ XC @ XD) @ (ccin @ XR @ (ccxp @ XA2 @ XB2))) @ (cwa @ (cwa @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) @ (cwcel @ (ccop @ XC @ XD) @ XR))))))))).
...
thf(ciss2_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwss @ XA2 @ ccid) @ (cwceq @ XA2 @ (ccin @ ccid @ (ccxp @ (ccdm @ XA2) @ (ccrn @ XA2))))))).
