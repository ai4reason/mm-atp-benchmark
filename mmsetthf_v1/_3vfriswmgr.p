...
thf(afrgr3v_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XZ)) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC))) @ (cwi @ (cwa @ (cwceq @ XV @ (cctp @ XA2 @ XB2 @ XC)) @ (cwcel @ XG @ ccusgr)) @ (cwb @ (cwcel @ XG @ ccfrgr) @ (cw3a @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE) @ (cwcel @ (ccpr @ XC @ XA2) @ XE))))))))))))))))).
...
thf(a_3vfriswmgrlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwne @ XA2 @ XB2)) @ (cwa @ (cwceq @ XV @ (cctp @ XA2 @ XB2 @ XC)) @ (cwcel @ XG @ ccusgr))) @ (cwi @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwreu @ (^ [Xw:$i] : (cwcel @ (ccpr @ XA2 @ (ccv @ Xw)) @ XE)) @ (^ [Xw:$i] : (ccpr @ XA2 @ XB2)))))))))))))))).
