...
thf(ccgrcomland_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XN @ ccee))) => ((cwi @ (cwa @ Xph @ Xps) @ (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cccgr)) => (cwi @ (cwa @ Xph @ Xps) @ (cwbr @ (ccop @ XB2 @ XA2) @ (ccop @ XC @ XD) @ cccgr)))))))))))))))).
