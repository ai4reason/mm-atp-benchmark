...
thf(cprodgt0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))) @ (cwbr @ ccc0 @ XB2 @ cclt))))).
