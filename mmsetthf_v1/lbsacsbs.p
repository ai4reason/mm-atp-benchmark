...
thf(clbsacsbs_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XW @ cclss)) => ((cwceq @ XN @ (ccfv @ XA2 @ ccmrc)) => ((cwceq @ XX @ (ccfv @ XW @ ccbs)) => ((cwceq @ XI @ (ccfv @ XA2 @ ccmri)) => ((cwceq @ XJ @ (ccfv @ XW @ cclbs)) => (cwi @ (cwcel @ XW @ cclvec) @ (cwb @ (cwcel @ XS @ XJ) @ (cwa @ (cwcel @ XS @ XI) @ (cwceq @ (ccfv @ XS @ XN) @ XX))))))))))))))))).
