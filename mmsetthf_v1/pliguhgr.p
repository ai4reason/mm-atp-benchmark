...
thf(an0lplig_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccplig) @ (cwn @ (cwcel @ cc0 @ XG))))).
...
thf(aisuhgrop_thm,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ XW) @ (cwcel @ XE @ XX)) @ (cwb @ (cwcel @ (ccop @ XV @ XE) @ ccuhgr) @ (cwf @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)))))))).
thf(cpliguhgr_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccplig) @ (cwcel @ (ccop @ (ccuni @ XG) @ (ccres @ ccid @ XG)) @ ccuhgr)))).
