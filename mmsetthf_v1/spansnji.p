...
thf(ashjshsi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwceq @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ (ccfv @ (cco @ XA2 @ XB2 @ ccph) @ ccort) @ ccort))))))).
...
thf(aspanuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ cchil) => ((cwss @ XB2 @ cchil) => (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ ccspn) @ (cco @ (ccfv @ XA2 @ ccspn) @ (ccfv @ XB2 @ ccspn) @ ccph))))))).
...
thf(aspanunsni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => (cwceq @ (ccfv @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccspn) @ (ccfv @ (ccun @ XA2 @ (ccsn @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccpjh)))) @ ccspn))))))).
thf(achjcli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwcel @ (cco @ XA2 @ XB2 @ cchj) @ ccch)))))).
thf(cspansnji_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => (cwceq @ (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ ccph) @ (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ cchj))))))).
