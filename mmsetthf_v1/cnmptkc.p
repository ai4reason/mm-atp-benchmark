...
thf(axkoccn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ (ccfv @ XX @ cctopon)) @ (cwcel @ XS @ (ccfv @ XY @ cctopon))) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (ccxp @ XX @ (ccsn @ (ccv @ Xx3))))) @ (cco @ XS @ (cco @ XS @ XR @ ccxko) @ cccn)))))))).
thf(ccnmptkc_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (cco @ XJ @ (cco @ XJ @ XK @ ccxko) @ cccn))))))))))).
