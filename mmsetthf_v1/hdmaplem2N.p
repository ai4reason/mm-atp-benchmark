...
thf(chdmaplem2N_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => ((cwi @ Xph @ (cwn @ (cwcel @ XZ @ (ccun @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN))))) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => (cwi @ Xph @ (cwne @ (ccfv @ (ccsn @ XZ) @ XN) @ (ccfv @ (ccsn @ XY) @ XN))))))))))))))))).
