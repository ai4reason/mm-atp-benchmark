...
thf(czgeltp1eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cwa @ (cwcel @ XI @ ccz) @ (cwcel @ XA2 @ ccz)) @ (cwi @ (cwa @ (cwbr @ XA2 @ XI @ ccle) @ (cwbr @ XI @ (cco @ XA2 @ cc1 @ ccaddc) @ cclt)) @ (cwceq @ XI @ XA2)))))).
