...
thf(axmullem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwn @ (cwo @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ ccc0)))) @ (cwn @ (cwo @ (cwo @ (cwa @ (cwbr @ ccc0 @ XB2 @ cclt) @ (cwceq @ XA2 @ ccpnf)) @ (cwa @ (cwbr @ XB2 @ ccc0 @ cclt) @ (cwceq @ XA2 @ ccmnf))) @ (cwo @ (cwa @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwceq @ XB2 @ ccpnf)) @ (cwa @ (cwbr @ XA2 @ ccc0 @ cclt) @ (cwceq @ XB2 @ ccmnf)))))) @ (cwn @ (cwo @ (cwo @ (cwa @ (cwbr @ ccc0 @ XB2 @ cclt) @ (cwceq @ XA2 @ ccmnf)) @ (cwa @ (cwbr @ XB2 @ ccc0 @ cclt) @ (cwceq @ XA2 @ ccpnf))) @ (cwo @ (cwa @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwceq @ XB2 @ ccmnf)) @ (cwa @ (cwbr @ XA2 @ ccc0 @ cclt) @ (cwceq @ XB2 @ ccpnf)))))) @ (cwcel @ XA2 @ ccr))))).
...
thf(cxmulneg1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwceq @ (cco @ (ccxne @ XA2) @ XB2 @ ccxmu) @ (ccxne @ (cco @ XA2 @ XB2 @ ccxmu))))))).
