...
thf(aefopnlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrp) @ (cwbr @ XR @ ccpi @ cclt)) @ (cwcel @ XA2 @ (cco @ ccc0 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs) @ ccpi @ cclt))))).
...
thf(alogf1o2_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwf1o @ XD @ (ccima @ (cccnv @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (ccres @ cclog @ XD))))).
...
thf(cefopnlem2_conj,conjecture,(! [XR:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwa @ (cwcel @ XR @ ccrp) @ (cwbr @ XR @ ccpi @ cclt)) @ (cwcel @ (ccima @ cce @ (cco @ ccc0 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) @ XJ)))))).
