...
thf(aresinhcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccsin) @ cci @ ccdiv) @ ccr)))).
thf(cretanhcl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cctan) @ cci @ ccdiv) @ ccr)))).
