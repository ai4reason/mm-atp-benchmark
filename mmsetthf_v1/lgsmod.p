...
thf(amodexp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ XC @ ccn0) @ (cwcel @ XD @ ccrp)) @ (cwceq @ (cco @ XA2 @ XD @ ccmo) @ (cco @ XB2 @ XD @ ccmo))) @ (cwceq @ (cco @ (cco @ XA2 @ XC @ ccexp) @ XD @ ccmo) @ (cco @ (cco @ XB2 @ XC @ ccexp) @ XD @ ccmo)))))))).
...
thf(algsval4a_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XA2 @ XN @ cclgs) @ (ccfv @ XN @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(clgsmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) @ (cwceq @ (cco @ (cco @ XA2 @ XN @ ccmo) @ XN @ cclgs) @ (cco @ XA2 @ XN @ cclgs)))))).
