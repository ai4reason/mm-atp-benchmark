...
thf(cdecaddm10_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => (cwceq @ (cco @ (ccdc @ XA2 @ ccc0) @ (ccdc @ XB2 @ ccc0) @ ccaddc) @ (ccdc @ (cco @ XA2 @ XB2 @ ccaddc) @ ccc0))))))).
