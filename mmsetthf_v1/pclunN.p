...
thf(cpclunN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => ((cwceq @ XU @ (ccfv @ XK @ ccpclN)) => (cwi @ (cw3a @ (cwcel @ XK @ XV) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) @ (cwceq @ (ccfv @ (ccun @ XX @ XY) @ XU) @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ XU)))))))))))))).
