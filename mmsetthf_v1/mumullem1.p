...
thf(aisnsqf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccmu) @ ccc0) @ (cwrex @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ cc2 @ ccexp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)))))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(annmulcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ ccn))))).
thf(cmumullem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwceq @ (ccfv @ XA2 @ ccmu) @ ccc0)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccmu) @ ccc0))))).
