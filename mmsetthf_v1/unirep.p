...
thf(cunirep_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XD @ Xz)) @ (cwb @ (Xph @ Xy1) @ (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XD @ Xz)) @ (cwceq @ (XB2 @ Xy1) @ (XC @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwb @ (Xph @ Xy1) @ (Xch @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwceq @ (XB2 @ Xy1) @ (XF @ Xz))))) => ((! [Xy1:$i] : (cwcel @ (XB2 @ Xy1) @ ccvv)) => (! [Xz:$i] : (cwi @ (cwa @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (Xch @ Xz)) @ (cwceq @ (XB2 @ Xy1) @ (XF @ Xz)))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : XA2)) @ (cwa @ (cwcel @ (XD @ Xz) @ XA2) @ (Xps @ Xz))) @ (cwceq @ (ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (XB2 @ Xy1)))) @ (^ [Xy1:$i] : XA2)))) @ (XC @ Xz)))))))))))))))))).
