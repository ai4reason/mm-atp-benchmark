...
thf(apw2f1o2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2o @ XA2 @ ccmap)) @ (^ [Xx3:$i] : (ccima @ (cccnv @ (ccv @ Xx3)) @ (ccsn @ cc1o)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ XV) @ (cwf1o @ (cco @ cc2o @ XA2 @ ccmap) @ (ccpw @ XA2) @ (XF @ Xx3))))))))).
...
thf(apw2f1o2val2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2o @ XA2 @ ccmap)) @ (^ [Xx3:$i] : (ccima @ (cccnv @ (ccv @ Xx3)) @ (ccsn @ cc1o)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XX @ (cco @ cc2o @ XA2 @ ccmap)) @ (cwcel @ XY @ XA2)) @ (cwb @ (cwcel @ XY @ (ccfv @ XX @ (XF @ Xx3))) @ (cwceq @ (ccfv @ XY @ XX) @ cc1o)))))))))).
...
thf(abi2bian9_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ Xth @ (cwb @ Xta @ Xet)) => (cwi @ (cwa @ Xph @ Xth) @ (cwb @ (cwb @ Xps @ Xta) @ (cwb @ Xch @ Xet)))))))))))).
...
thf(cwepwsolem_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwn @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) @ (cwb @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ ccep) @ (cwral @ (^ [Xw:$i] : (cwi @ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) @ (cwceq @ (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => ((! [Xa:$i] : (cwceq @ (XF @ Xa) @ (ccmpt @ (^ [Xa:$i] : (cco @ cc2o @ XA2 @ ccmap)) @ (^ [Xa:$i] : (ccima @ (cccnv @ (ccv @ Xa)) @ (ccsn @ cc1o)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (cwi @ (cwcel @ XA2 @ ccvv) @ (cwiso @ (cco @ cc2o @ XA2 @ ccmap) @ (ccpw @ XA2) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw) @ (XF @ Xa))))))))))))))))).
