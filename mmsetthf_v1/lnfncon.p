...
thf(alnfnconi_thm,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => (cwb @ (cwcel @ XT @ cccnfn) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccabs) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccno) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccr)))))).
...
thf(clnfncon_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ cclf) @ (cwb @ (cwcel @ XT @ cccnfn) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccabs) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccno) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccr)))))).
