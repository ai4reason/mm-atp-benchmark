...
thf(adf_inftm_ax,axiom,(cwceq @ ccinftm @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccbs)) @ (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (cwa @ (cwbr @ (ccfv @ (ccv @ Xw) @ cc0g) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccplt)) @ (cwral @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccmg)) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccplt))) @ (^ [Xn:$i] : ccn))))))))))).
...
thf(cinftmrel_conj,conjecture,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => (cwi @ (cwcel @ XW @ XV) @ (cwss @ (ccfv @ XW @ ccinftm) @ (ccxp @ XB2 @ XB2)))))))).
