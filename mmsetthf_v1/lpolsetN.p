...
thf(adf_lpolN_ax,axiom,(cwceq @ cclpoN @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccrab @ (^ [Xo:$i] : (cw3a @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xw) @ ccbs) @ (ccv @ Xo)) @ (ccsn @ (ccfv @ (ccv @ Xw) @ cc0g))) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cw3a @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccbs)) @ (cwss @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccbs)) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwss @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xo)))))))) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xw) @ cclsh)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xo)) @ (ccv @ Xo)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ cclsa))))) @ (^ [Xo:$i] : (cco @ (ccfv @ (ccv @ Xw) @ cclss) @ (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)) @ ccmap))))))).
