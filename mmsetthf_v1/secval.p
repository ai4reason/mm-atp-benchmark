...
thf(adf_sec_ax,axiom,(cwceq @ ccsec @ (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ cccos) @ ccc0)) @ (^ [Xy1:$i] : ccc))) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ cccos) @ ccdiv))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(csecval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ ccsec) @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccdiv))))).
