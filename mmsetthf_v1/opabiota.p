...
thf(aopabiotafun_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwceq @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ (ccsn @ (ccv @ Xy1))))))) => (cwfun @ XF))))).
...
thf(aopabiotadm_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwceq @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ (ccsn @ (ccv @ Xy1))))))) => (cwceq @ (ccdm @ XF) @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))))).
thf(aiota1_thm,axiom,(! [Xph:($i > $o)] : (! [Xx3:$i] : (cwi @ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwb @ (Xph @ Xx3) @ (cwceq @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccv @ Xx3))))))).
thf(copabiota_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwceq @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ (ccsn @ (ccv @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xy1))))) => (cwi @ (cwcel @ XB2 @ (ccdm @ XF)) @ (cwceq @ (ccfv @ XB2 @ XF) @ (ccio @ (^ [Xy1:$i] : (Xps @ Xy1)))))))))))).
