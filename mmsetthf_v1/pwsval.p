...
thf(adf_pws_ax,axiom,(cwceq @ ccpws @ (ccmpt2 @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xr) @ ccsca) @ (ccxp @ (ccv @ Xi) @ (ccsn @ (ccv @ Xr))) @ ccprds)))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cpwsval_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccpws)) => ((cwceq @ XF @ (ccfv @ XR @ ccsca)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XI @ XW)) @ (cwceq @ XY @ (cco @ XF @ (ccxp @ XI @ (ccsn @ XR)) @ ccprds)))))))))))).
