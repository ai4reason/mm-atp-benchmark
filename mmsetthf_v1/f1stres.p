...
thf(adf_1st_ax,axiom,(cwceq @ cc1st @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccuni @ (ccdm @ (ccsn @ (ccv @ Xx3)))))))).
...
thf(cf1stres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwf @ (ccxp @ XA2 @ XB2) @ XA2 @ (ccres @ cc1st @ (ccxp @ XA2 @ XB2)))))).
