...
thf(asprval_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XV @ XW) @ (cwceq @ (ccfv @ XV @ ccspr) @ (ccab @ (^ [Xp:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xp) @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
...
thf(csprssspr_conj,conjecture,(! [XV:($i > $o)] : (cwss @ (ccfv @ XV @ ccspr) @ (ccab @ (^ [Xp:$i] : (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwceq @ (ccv @ Xp) @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))))))))))).
