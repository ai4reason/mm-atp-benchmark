...
thf(calginv_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XR @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xx3))) @ ccc0))) => ((cwf @ XS @ XS @ XF) => ((cwfn @ XI @ XS) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XI) @ (ccfv @ (ccv @ Xx3) @ XI)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xx3) @ XS) @ (cwcel @ (XK @ Xx3) @ ccn0)) @ (cwceq @ (ccfv @ (ccfv @ (XK @ Xx3) @ XR) @ XI) @ (ccfv @ (ccfv @ ccc0 @ XR) @ XI))))))))))))))).
