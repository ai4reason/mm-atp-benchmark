...
thf(caddsubeq4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwcel @ XD @ ccc))) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc)) @ (cwceq @ (cco @ XC @ XA2 @ ccmin) @ (cco @ XB2 @ XD @ ccmin))))))))).
