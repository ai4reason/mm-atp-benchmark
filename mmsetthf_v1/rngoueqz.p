...
thf(arngone0_thm,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwne @ XX @ cc0)))))))).
...
thf(crngoueqz_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XR @ cc1st)) => ((cwceq @ XH @ (ccfv @ XR @ cc2nd)) => ((cwceq @ XZ @ (ccfv @ XG @ ccgi)) => ((cwceq @ XU @ (ccfv @ XH @ ccgi)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwcel @ XR @ ccrngo) @ (cwb @ (cwbr @ XX @ cc1o @ ccen) @ (cwceq @ XU @ XZ))))))))))))))).
