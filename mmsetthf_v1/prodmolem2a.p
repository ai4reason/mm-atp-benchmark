...
thf(afprodcvg_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwss @ XA2 @ (cco @ XM @ XN @ ccfz))) => (cwi @ Xph @ (cwbr @ (ccseq @ ccmul @ XF @ XM) @ (ccfv @ XN @ (ccseq @ ccmul @ XF @ XM)) @ ccli))))))))))))).
...
thf(aleisorel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwiso @ XA2 @ XB2 @ cclt @ cclt @ XF) @ (cwa @ (cwss @ XA2 @ ccxr) @ (cwss @ XB2 @ ccxr)) @ (cwa @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XA2))) @ (cwb @ (cwbr @ XC @ XD @ ccle) @ (cwbr @ (ccfv @ XC @ XF) @ (ccfv @ XD @ XF) @ ccle))))))))).
...
thf(aseqcoll_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XS)) @ (cwceq @ (cco @ (XZ @ Xn) @ (ccv @ Xk) @ Xc_pl) @ (ccv @ Xk))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XS)) @ (cwceq @ (cco @ (ccv @ Xk) @ (XZ @ Xn) @ Xc_pl) @ (ccv @ Xk))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xk) @ XS) @ (cwcel @ (ccv @ Xn) @ XS))) @ (cwcel @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ Xc_pl) @ XS)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XZ @ Xn) @ XS))) => ((cwi @ Xph @ (cwiso @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ XA2 @ cclt @ cclt @ XG)) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xk @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz))))) => ((cwi @ Xph @ (cwss @ XA2 @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ (ccfv @ (ccfv @ XA2 @ cchash) @ XG) @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XS))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccdif @ (cco @ XM @ (ccfv @ (ccfv @ XA2 @ cchash) @ XG) @ ccfz) @ XA2))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XZ @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (XH @ Xk)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XG) @ XF))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ (XN @ Xk @ Xn) @ XG) @ (ccseq @ Xc_pl @ XF @ XM)) @ (ccfv @ (XN @ Xk @ Xn) @ (ccseq @ Xc_pl @ (XH @ Xk) @ cc1))))))))))))))))))))))))))).
...
thf(avtoclf_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3)))) => ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (Xps @ Xx3)))))))))).
...
thf(aprodmolem3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xj:$i] : (cwceq @ (XF @ Xf1 @ Xj) @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xf1 @ Xj)) @ (XB2 @ Xf1 @ Xk) @ cc1)))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xf1 @ Xj))) @ (cwcel @ (XB2 @ Xf1 @ Xk) @ ccc))))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XG @ Xf1 @ Xk) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xf1 @ Xk)))))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XH @ Xf1 @ Xj @ Xk) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (XK @ Xf1 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xf1 @ Xk))))))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwa @ (cwcel @ (XM @ Xf1 @ Xk) @ ccn) @ (cwcel @ (XN @ Xf1 @ Xj @ Xk) @ ccn)))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (cco @ cc1 @ (XM @ Xf1 @ Xk) @ ccfz) @ (XA2 @ Xf1 @ Xj) @ (ccv @ Xf1)))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (cco @ cc1 @ (XN @ Xf1 @ Xj @ Xk) @ ccfz) @ (XA2 @ Xf1 @ Xj) @ (XK @ Xf1 @ Xk)))))) => (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccfv @ (XM @ Xf1 @ Xk) @ (ccseq @ ccmul @ (XG @ Xf1 @ Xk) @ cc1)) @ (ccfv @ (XN @ Xf1 @ Xj @ Xk) @ (ccseq @ ccmul @ (XH @ Xf1 @ Xj @ Xk) @ cc1)))))))))))))))))))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => (cwi @ Xph @ (cwa @ Xps @ Xch)))))))).
thf(cprodmolem2a_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xj:$i] : (cwceq @ (XF @ Xf1 @ Xj) @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xf1)) @ (XB2 @ Xf1 @ Xk) @ cc1)))))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xf1) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xf1))) @ (cwcel @ (XB2 @ Xf1 @ Xk) @ ccc)))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XG @ Xf1 @ Xk) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xf1 @ Xk)))))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XH @ Xf1 @ Xj @ Xk) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (XK @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xf1 @ Xk))))))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XN @ Xf1) @ ccn))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XM @ Xf1) @ ccz))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwss @ (XA2 @ Xf1) @ (ccfv @ (XM @ Xf1) @ ccuz)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf1o @ (cco @ cc1 @ (XN @ Xf1) @ ccfz) @ (XA2 @ Xf1) @ (ccv @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwiso @ (cco @ cc1 @ (ccfv @ (XA2 @ Xf1) @ cchash) @ ccfz) @ (XA2 @ Xf1) @ cclt @ cclt @ (XK @ Xf1)))) => (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwbr @ (ccseq @ ccmul @ (XF @ Xf1 @ Xj) @ (XM @ Xf1)) @ (ccfv @ (XN @ Xf1) @ (ccseq @ ccmul @ (XG @ Xf1 @ Xk) @ cc1)) @ ccli)))))))))))))))))))))))).
