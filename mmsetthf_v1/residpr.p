...
thf(cresidpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (ccres @ ccid @ (ccpr @ XA2 @ XB2)) @ (ccpr @ (ccop @ XA2 @ XA2) @ (ccop @ XB2 @ XB2))))))))).
