...
thf(cmbfres2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XB2) @ ccmbf)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XC) @ ccmbf)) => ((cwi @ Xph @ (cwceq @ (ccun @ XB2 @ XC) @ XA2)) => (cwi @ Xph @ (cwcel @ XF @ ccmbf)))))))))))).
