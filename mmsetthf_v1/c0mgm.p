...
thf(cc0mgm_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XT @ cc0g)) => ((! [Xx3:$i] : (cwceq @ (XH @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XS @ ccmgm) @ (cwcel @ XT @ ccmnd)) @ (cwcel @ (XH @ Xx3) @ (cco @ XS @ XT @ ccmgmhm))))))))))))).
