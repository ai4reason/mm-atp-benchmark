...
thf(c_2lgslem1a2_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ ccz)) @ (cwb @ (cwbr @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ XI @ cclt) @ (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ (cco @ XI @ cc2 @ ccmul) @ cclt)))))).
