...
thf(cmapsnf1o3_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccsn @ XX)) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XX @ ccvv) => ((! [Xy1:$i] : (cwceq @ (XF @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ XS @ (ccsn @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (cwf1o @ XB2 @ (cco @ XB2 @ XS @ ccmap) @ (XF @ Xy1)))))))))))).
