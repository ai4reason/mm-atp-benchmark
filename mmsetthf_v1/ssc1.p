...
thf(assclem_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS))) => (cwi @ Xph @ (cwb @ (cwcel @ XH @ ccvv) @ (cwcel @ XS @ ccvv)))))))).
thf(cssc1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS))) => ((cwi @ Xph @ (cwfn @ XJ @ (ccxp @ XT @ XT))) => ((cwi @ Xph @ (cwbr @ XH @ XJ @ ccssc)) => (cwi @ Xph @ (cwss @ XS @ XT))))))))))).
