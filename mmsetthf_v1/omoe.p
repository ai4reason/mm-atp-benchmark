...
thf(comoe_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwn @ (cwbr @ cc2 @ XA2 @ ccdvds))) @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwn @ (cwbr @ cc2 @ XB2 @ ccdvds)))) @ (cwbr @ cc2 @ (cco @ XA2 @ XB2 @ ccmin) @ ccdvds))))).
