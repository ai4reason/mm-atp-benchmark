...
thf(afargshiftf_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xx3) @ ccn0) @ (cwf @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (ccdm @ XE) @ XF)) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ (XG @ Xx3)))))))))).
thf(ampcom_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xps @ Xph) => ((cwi @ Xph @ (cwi @ Xps @ Xch)) => (cwi @ Xps @ Xch))))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(affn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwfn @ XF @ XA2)))))).
thf(afseq1hash_thm,axiom,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwfn @ XF @ (cco @ cc1 @ XN @ ccfz))) @ (cwceq @ (ccfv @ XF @ cchash) @ XN))))).
...
thf(afz0add1fz1_thm,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ (cco @ ccc0 @ XN @ ccfzo))) @ (cwcel @ (cco @ XX @ cc1 @ ccaddc) @ (cco @ cc1 @ XN @ ccfz)))))).
...
thf(afargshiftfv_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xx3) @ ccn0) @ (cwf @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (ccdm @ XE) @ XF)) @ (cwi @ (cwcel @ XX @ (cco @ ccc0 @ (XN @ Xx3) @ ccfzo)) @ (cwceq @ (ccfv @ XX @ (XG @ Xx3)) @ (ccfv @ (cco @ XX @ cc1 @ ccaddc) @ XF)))))))))))).
...
thf(cfargshiftf1_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (XN @ Xx3) @ ccn0) @ (cwf1 @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (ccdm @ XE) @ XF)) @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ (XG @ Xx3)))))))))).
