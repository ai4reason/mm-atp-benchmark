...
thf(cisnsg3_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwb @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwa @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (ccv @ Xx3) @ Xc_mi) @ XS)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XX))))))))))))).
