...
thf(aovif12_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (cco @ (ccif @ Xph @ XA2 @ XB2) @ (ccif @ Xph @ XC @ XD) @ XF) @ (ccif @ Xph @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XD @ XF)))))))))).
...
thf(atxcnp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xx3) @ (ccfv @ XX @ cctopon)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xx3) @ (ccfv @ XY @ cctopon)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XL @ Xx3) @ (ccfv @ XZ @ cctopon)))) => ((cwi @ Xph @ (cwcel @ XD @ XX)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccfv @ XD @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccnp))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ XD @ (cco @ (XJ @ Xx3) @ (XL @ Xx3) @ cccnp))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) @ (ccfv @ XD @ (cco @ (XJ @ Xx3) @ (cco @ (XK @ Xx3) @ (XL @ Xx3) @ cctx) @ cccnp)))))))))))))))))))))).
...
thf(alimcmpt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xz) @ XA2)) @ (cwcel @ (XD @ Xz) @ ccc))) => ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (cco @ (XK @ Xz) @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((! [Xz:$i] : (cwceq @ (XK @ Xz) @ (ccfv @ cccnfld @ cctopn))) => (! [Xz:$i] : (cwi @ Xph @ (cwb @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (XD @ Xz))) @ XB2 @ cclimc)) @ (cwcel @ (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ (cwceq @ (ccv @ Xz) @ XB2) @ XC @ (XD @ Xz)))) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ (XK @ Xz) @ cccnp))))))))))))))))))).
...
thf(climccnp2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XR @ Xx3) @ XX))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XS @ Xx3) @ XY))) => ((cwi @ Xph @ (cwss @ XX @ ccc)) => ((cwi @ Xph @ (cwss @ XY @ ccc)) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (cco @ (cco @ (XK @ Xx3) @ (XK @ Xx3) @ cctx) @ (ccxp @ XX @ XY) @ ccrest))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XR @ Xx3))) @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XS @ Xx3))) @ XB2 @ cclimc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XH @ (ccfv @ (ccop @ XC @ XD) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccnp))))) => (cwi @ Xph @ (cwcel @ (cco @ XC @ XD @ XH) @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XR @ Xx3) @ (XS @ Xx3) @ XH))) @ XB2 @ cclimc))))))))))))))))))))))))).
