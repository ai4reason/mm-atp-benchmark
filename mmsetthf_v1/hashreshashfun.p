...
thf(ahashres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwfun @ XA2) @ (cwcel @ XA2 @ ccfn) @ (cwss @ XB2 @ (ccdm @ XA2))) @ (cwceq @ (ccfv @ (ccres @ XA2 @ XB2) @ cchash) @ (ccfv @ XB2 @ cchash)))))).
thf(chashreshashfun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwfun @ XA2) @ (cwcel @ XA2 @ ccfn) @ (cwss @ XB2 @ (ccdm @ XA2))) @ (cwceq @ (ccfv @ XA2 @ cchash) @ (cco @ (ccfv @ (ccres @ XA2 @ XB2) @ cchash) @ (ccfv @ (ccdif @ (ccdm @ XA2) @ XB2) @ cchash) @ ccaddc)))))).
