...
thf(alswccats1fst_thm,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwceq @ (ccfv @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ cclsw) @ (ccfv @ ccc0 @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat))))))).
...
thf(aclwlkclwwlk_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccclwlks)))) @ (cwa @ (cwceq @ (ccfv @ XP @ cclsw) @ (ccfv @ ccc0 @ XP)) @ (cwcel @ (cco @ XP @ (ccop @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ (ccfv @ XG @ ccclwwlk)))))))))))).
thf(cclwlkclwwlk2_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ (ccfv @ XG @ ccclwlks)))) @ (cwcel @ XP @ (ccfv @ XG @ ccclwwlk))))))))))).
