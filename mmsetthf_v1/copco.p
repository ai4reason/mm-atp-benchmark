...
thf(ccopco_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc1 @ XF) @ (ccfv @ ccc0 @ XG))) => ((cwi @ Xph @ (cwcel @ XH @ (cco @ XJ @ XK @ cccn))) => (cwi @ Xph @ (cwceq @ (cccom @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) @ (cco @ (cccom @ XH @ XF) @ (cccom @ XH @ XG) @ (ccfv @ XK @ ccpco))))))))))))))).
