...
thf(atgbtwnconn1lem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XA2 @ XD @ XI))) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwi @ Xph @ (cwcel @ XE @ XP)) => ((cwi @ Xph @ (cwcel @ XF @ XP)) => ((cwi @ Xph @ (cwcel @ XH @ XP)) => ((cwi @ Xph @ (cwcel @ XJ @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ XA2 @ XE @ XI))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XF @ XI))) => ((cwi @ Xph @ (cwcel @ XE @ (cco @ XA2 @ XH @ XI))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XA2 @ XJ @ XI))) => ((cwi @ Xph @ (cwceq @ (cco @ XE @ XD @ Xc_mi) @ (cco @ XC @ XD @ Xc_mi))) => ((cwi @ Xph @ (cwceq @ (cco @ XC @ XF @ Xc_mi) @ (cco @ XC @ XD @ Xc_mi))) => ((cwi @ Xph @ (cwceq @ (cco @ XE @ XH @ Xc_mi) @ (cco @ XB2 @ XC @ Xc_mi))) => ((cwi @ Xph @ (cwceq @ (cco @ XF @ XJ @ Xc_mi) @ (cco @ XB2 @ XD @ Xc_mi))) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XC @ XE @ XI))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XD @ XF @ XI))) => ((cwi @ Xph @ (cwne @ XC @ XE)) => (cwi @ Xph @ (cwceq @ XD @ XF)))))))))))))))))))))))))))))))))))))))))))).
...
thf(asimp_11l_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (! [Xmu:$o] : (! [Xla:$o] : (! [Xka:$o] : (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ Xth) @ Xta) @ Xet) @ Xze) @ Xsi) @ Xrh) @ Xmu) @ Xla) @ Xka) @ Xph)))))))))))))).
...
thf(ctgbtwnconn1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ XA2 @ XD @ XI))) => (cwi @ Xph @ (cwo @ (cwcel @ XC @ (cco @ XA2 @ XD @ XI)) @ (cwcel @ XD @ (cco @ XA2 @ XC @ XI))))))))))))))))))))))).
