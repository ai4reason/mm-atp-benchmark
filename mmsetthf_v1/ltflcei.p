...
thf(aceim1l_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (cco @ (ccneg @ (ccfv @ (ccneg @ XA2) @ ccfl)) @ cc1 @ ccmin) @ XA2 @ cclt)))).
...
thf(cltflcei_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccfl) @ XB2 @ cclt) @ (cwbr @ XA2 @ (ccneg @ (ccfv @ (ccneg @ XB2) @ ccfl)) @ cclt)))))).
