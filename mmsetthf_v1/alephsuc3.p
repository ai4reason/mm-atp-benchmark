...
thf(aalephsuc2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ ccale) @ ccdom)) @ (^ [Xx3:$i] : ccon0)))))).
...
thf(ainfdif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccsdm)) @ (cwbr @ (ccdif @ XA2 @ XB2) @ XA2 @ ccen))))).
thf(calephsuc3_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ ccale) @ ccen)) @ (^ [Xx3:$i] : ccon0)) @ ccen)))).
