...
thf(ah1datom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ cchil)) @ (cwi @ (cwss @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) @ (cwo @ (cwceq @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) @ (cwceq @ XA2 @ cc0h))))))).
...
thf(ch1da_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwne @ XA2 @ cc0v)) @ (cwcel @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccort) @ ccort) @ ccat)))).
