...
thf(aclatl_thm,axiom,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ cccla) @ (cwcel @ XK @ cclat)))).
...
thf(alubl_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (ccfv @ XK @ ccbs))) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XU @ (ccfv @ XK @ cclub)) => (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XK @ cccla) @ (cwss @ XS @ (XB2 @ Xy1)) @ (cwcel @ XX @ (XB2 @ Xy1))) @ (cwi @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ Xc_le)) @ (^ [Xy1:$i] : XS)) @ (cwbr @ (ccfv @ XS @ XU) @ XX @ Xc_le)))))))))))))).
...
thf(clubun_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XU @ (ccfv @ XK @ cclub)) => (cwi @ (cw3a @ (cwcel @ XK @ cccla) @ (cwss @ XS @ XB2) @ (cwss @ XT @ XB2)) @ (cwceq @ (ccfv @ (ccun @ XS @ XT) @ XU) @ (cco @ (ccfv @ XS @ XU) @ (ccfv @ XT @ XU) @ Xc_or))))))))))))).
