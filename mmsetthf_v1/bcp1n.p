...
thf(cbcp1n_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwceq @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccbc) @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccmin) @ ccdiv) @ ccmul)))))).
