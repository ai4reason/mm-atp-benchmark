...
thf(cpaddss12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cw3a @ (cwcel @ XK @ XB2) @ (cwss @ XY @ XA2) @ (cwss @ XW @ XA2)) @ (cwi @ (cwa @ (cwss @ XX @ XY) @ (cwss @ XZ @ XW)) @ (cwss @ (cco @ XX @ XZ @ Xc_pl) @ (cco @ XY @ XW @ Xc_pl))))))))))))))).
