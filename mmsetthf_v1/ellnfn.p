...
thf(adf_lnfn_ax,axiom,(cwceq @ cclf @ (ccrab @ (^ [Xt:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsm) @ (ccv @ Xz) @ ccva) @ (ccv @ Xt)) @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xt)) @ ccmul) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ ccaddc))) @ (^ [Xz:$i] : cchil))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccc))) @ (^ [Xt:$i] : (cco @ ccc @ cchil @ ccmap))))).
...
thf(cellnfn_conj,conjecture,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ cclf) @ (cwa @ (cwf @ cchil @ ccc @ XT) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwceq @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsm) @ (ccv @ Xz) @ ccva) @ XT) @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccmul) @ (ccfv @ (ccv @ Xz) @ XT) @ ccaddc))) @ (^ [Xz:$i] : cchil))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccc)))))).
