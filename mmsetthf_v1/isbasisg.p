...
thf(adf_bases_ax,axiom,(cwceq @ cctb @ (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwss @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccuni @ (ccin @ (ccv @ Xx3) @ (ccpw @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))).
thf(cisbasisg_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XB2 @ (XC @ Xx3 @ Xy1)) @ (cwb @ (cwcel @ XB2 @ cctb) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccuni @ (ccin @ XB2 @ (ccpw @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1))))))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))).
