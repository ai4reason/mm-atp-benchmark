...
thf(adfon2_thm,axiom,(cwceq @ ccon0 @ (ccab @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))).
...
thf(abrsset_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ ccsset) @ (cwss @ XA2 @ XB2)))))).
...
thf(aeltrans_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ cctrans) @ (cwtr @ XA2))))).
...
thf(cdfon3_conj,conjecture,(cwceq @ ccon0 @ (ccdif @ ccvv @ (ccrn @ (ccdif @ (ccin @ ccsset @ (ccxp @ cctrans @ ccvv)) @ (ccun @ ccid @ ccep)))))).
