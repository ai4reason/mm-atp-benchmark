...
thf(axpncan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccxad) @ (ccxne @ XB2) @ ccxad) @ XA2))))).
...
thf(cxaddeq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccxad) @ ccc0) @ (cwceq @ XA2 @ (ccxne @ XB2))))))).
