...
thf(aupgrreslem_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XV @ Xi) @ (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (cwceq @ XE @ (ccfv @ (XG @ Xi) @ cciedg))) => ((! [Xi:$i] : (! [Xp:$i] : (cwceq @ (XF @ Xi @ Xp) @ (ccrab @ (^ [Xi:$i] : (cwnel @ XN @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE)))))) => (! [Xi:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ (XG @ Xi) @ ccupgr) @ (cwcel @ XN @ (XV @ Xi))) @ (cwss @ (ccrn @ (ccres @ XE @ (XF @ Xi @ Xp))) @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccfv @ (ccv @ Xp) @ cchash) @ cc2 @ ccle)) @ (^ [Xp:$i] : (ccdif @ (ccpw @ (ccdif @ (XV @ Xi) @ (ccsn @ XN))) @ (ccsn @ cc0))))))))))))))))).
