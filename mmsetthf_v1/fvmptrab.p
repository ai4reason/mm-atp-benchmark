...
thf(cfvmptrab_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : (XV @ Xy1)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XM @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XX) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XX) @ (cwceq @ (XM @ Xx3) @ XN))) => ((! [Xy1:$i] : (cwi @ (cwcel @ XX @ (XV @ Xy1)) @ (cwcel @ XN @ ccvv))) => ((! [Xy1:$i] : (cwi @ (cwnel @ XX @ (XV @ Xy1)) @ (cwceq @ XN @ cc0))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (ccfv @ XX @ (XF @ Xx3 @ Xy1)) @ (ccrab @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : XN)))))))))))))))))).
