...
thf(cxpopth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccxp @ XC @ XD)) @ (cwcel @ XB2 @ (ccxp @ XR @ XS))) @ (cwb @ (cwa @ (cwceq @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc1st)) @ (cwceq @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XB2 @ cc2nd))) @ (cwceq @ XA2 @ XB2)))))))))).
