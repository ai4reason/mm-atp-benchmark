...
thf(aivth_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((cwi @ Xph @ (cwa @ (cwbr @ (ccfv @ XA2 @ XF) @ XU @ cclt) @ (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt))) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ XF) @ XU)) @ (^ [Xc:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))))))).
...
thf(civthle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XU @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((cwi @ Xph @ (cwa @ (cwbr @ (ccfv @ XA2 @ XF) @ XU @ ccle) @ (cwbr @ XU @ (ccfv @ XB2 @ XF) @ ccle))) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ XF) @ XU)) @ (^ [Xc:$i] : (cco @ XA2 @ XB2 @ ccicc))))))))))))))))))).
