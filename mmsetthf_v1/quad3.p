...
thf(cquad3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwceq @ (cco @ (cco @ XA2 @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ (cco @ (cco @ XB2 @ XX @ ccmul) @ XC @ ccaddc) @ ccaddc) @ ccc0) => (cwo @ (cwceq @ XX @ (cco @ (cco @ (ccneg @ XB2) @ (ccfv @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ (cco @ XA2 @ XC @ ccmul) @ ccmul) @ ccmin) @ ccsqrt) @ ccaddc) @ (cco @ cc2 @ XA2 @ ccmul) @ ccdiv)) @ (cwceq @ XX @ (cco @ (cco @ (ccneg @ XB2) @ (ccfv @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ (cco @ XA2 @ XC @ ccmul) @ ccmul) @ ccmin) @ ccsqrt) @ ccmin) @ (cco @ cc2 @ XA2 @ ccmul) @ ccdiv)))))))))))))).
