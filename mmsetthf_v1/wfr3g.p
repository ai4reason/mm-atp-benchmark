...
thf(cwfr3g_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwfn @ XF @ XA2) @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2))) @ (cwa @ (cwfn @ XG @ XA2) @ (cwral @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ XG) @ (ccfv @ (ccres @ XG @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2)))) @ (cwceq @ XF @ XG)))))))).
