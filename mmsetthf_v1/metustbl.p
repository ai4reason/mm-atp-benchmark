...
thf(ablssexps_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XA2))) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ XD @ ccbl)))) @ (cwrex @ (^ [Xr:$i] : (cwss @ (cco @ XP @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XA2)) @ (^ [Xr:$i] : ccrp))))))))).
thf(cmetustbl_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XV @ (ccfv @ XD @ ccmetu)) @ (cwcel @ XP @ XX)) @ (cwrex @ (^ [Xa:$i] : (cwa @ (cwcel @ XP @ (ccv @ Xa)) @ (cwss @ (ccv @ Xa) @ (ccima @ XV @ (ccsn @ XP))))) @ (^ [Xa:$i] : (ccrn @ (ccfv @ XD @ ccbl)))))))))).
