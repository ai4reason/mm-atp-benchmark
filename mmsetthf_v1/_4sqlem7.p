...
thf(c_4sqlem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwceq @ XB2 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (cwi @ Xph @ (cwbr @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ ccle)))))))))).
