...
thf(cmvth_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ (cco @ (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)))))))))))))).
