...
thf(advdsnegb_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ XM @ (ccneg @ XN) @ ccdvds)))))).
thf(anegdvdsb_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ (ccneg @ XM) @ XN @ ccdvds)))))).
thf(amuldvds1_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwi @ (cwbr @ (cco @ XK @ XM @ ccmul) @ XN @ ccdvds) @ (cwbr @ XK @ XN @ ccdvds))))))).
...
thf(amuls1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ ccmul) @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XA2 @ ccmin))))))))).
...
thf(c_3dvds_conj,conjecture,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwf @ (cco @ ccc0 @ XN @ ccfz) @ ccz @ XF)) @ (cwb @ (cwbr @ cc3 @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccv @ Xk) @ ccexp) @ ccmul))) @ ccdvds) @ (cwbr @ cc3 @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ ccdvds)))))).
