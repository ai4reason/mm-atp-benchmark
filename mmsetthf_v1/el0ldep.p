...
thf(aring1ne0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwbr @ cc1 @ (ccfv @ XB2 @ cchash) @ cclt)) @ (cwne @ Xc_1 @ Xc_0)))))))))).
...
thf(cel0ldep_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XM @ cclmod) @ (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs) @ cchash) @ cclt)) @ (cwcel @ XS @ (ccpw @ (ccfv @ XM @ ccbs))) @ (cwcel @ (ccfv @ XM @ cc0g) @ XS)) @ (cwbr @ XS @ XM @ cclindeps))))).
