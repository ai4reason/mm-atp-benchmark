...
thf(annrecgt0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwbr @ ccc0 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt)))).
...
thf(aminvecolem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XX @ Xy1) @ (ccfv @ (XU @ Xn) @ ccba)))) => ((! [Xn:$i] : (cwceq @ (XM @ Xn) @ (ccfv @ (XU @ Xn) @ ccnsb))) => ((! [Xn:$i] : (cwceq @ (XN @ Xn) @ (ccfv @ (XU @ Xn) @ ccnmcv))) => ((! [Xn:$i] : (cwceq @ XY @ (ccfv @ (XW @ Xn) @ ccba))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XU @ Xn) @ cccphlo))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XW @ Xn) @ (ccin @ (ccfv @ (XU @ Xn) @ ccss) @ cccbn)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XX @ Xy1)))) => ((! [Xn:$i] : (cwceq @ XD @ (ccfv @ (XU @ Xn) @ ccims))) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XR @ Xy1 @ Xn) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ (XM @ Xn)) @ (XN @ Xn)))))))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ XS @ (ccinf @ (XR @ Xy1 @ Xn) @ ccr @ cclt)))) => ((cwi @ Xph @ (cwf @ ccn @ XY @ XF)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwbr @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xn) @ XF) @ XD) @ cc2 @ ccexp) @ (cco @ (cco @ XS @ cc2 @ ccexp) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccle))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XT @ Xx3 @ Xy1) @ (cco @ cc1 @ (cco @ (cco @ (cco @ (cco @ (cco @ XA2 @ (ccfv @ XF @ (ccfv @ XJ @ cclm)) @ XD) @ XS @ ccaddc) @ cc2 @ ccdiv) @ cc2 @ ccexp) @ (cco @ XS @ cc2 @ ccexp) @ ccmin) @ ccdiv)))) => (! [Xn:$i] : (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ (XM @ Xn)) @ (XN @ Xn)) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ (XM @ Xn)) @ (XN @ Xn)) @ ccle)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XY))))))))))))))))))))))))))))))))).
...
thf(cminvecolem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XX @ Xy1) @ (ccfv @ XU @ ccba))) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwi @ Xph @ (cwcel @ XU @ cccphlo)) => ((cwi @ Xph @ (cwcel @ XW @ (ccin @ (ccfv @ XU @ ccss) @ cccbn))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XX @ Xy1)))) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : (cwceq @ (XR @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN)))))) => ((! [Xy1:$i] : (cwceq @ XS @ (ccinf @ (XR @ Xy1) @ ccr @ cclt))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ XM) @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN) @ ccle)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XY))))))))))))))))))))))))))).
