...
thf(acusgrexi_thm,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))) => (cwi @ (cwcel @ XV @ XW) @ (cwcel @ (ccop @ XV @ (ccres @ ccid @ XP)) @ cccusgr))))))).
...
thf(ccusgrexg_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xe:$i] : (cwi @ (cwcel @ XV @ (XW @ Xe)) @ (cwex @ (^ [Xe:$i] : (cwcel @ (ccop @ XV @ (ccv @ Xe)) @ cccusgr)))))))).
