...
thf(apsgndmfi_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XS @ (ccfv @ XD @ ccpsgn)) => ((cwceq @ XG @ (ccfv @ (ccfv @ XD @ ccsymg) @ ccbs)) => (cwi @ (cwcel @ XD @ ccfn) @ (cwfn @ XS @ XG)))))))).
...
thf(asymgfcoeu_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ (ccfv @ XD @ ccsymg) @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XD @ XV) @ (cwcel @ XP @ XG) @ (cwcel @ XQ @ XG)) @ (cwreu @ (^ [Xp:$i] : (cwceq @ XQ @ (cccom @ XP @ (ccv @ Xp)))) @ (^ [Xp:$i] : XG)))))))))).
...
thf(cmdetpmtr1_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XD @ Xi @ Xj) @ (cco @ XN @ XR @ ccmdat)))) => ((cwceq @ XG @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XS @ Xi @ Xj) @ (ccfv @ XN @ ccpsgn)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XZ @ Xi @ Xj) @ (ccfv @ XR @ cczrh)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (Xc_x @ Xi @ Xj) @ (ccfv @ XR @ ccmulr)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XE @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccv @ Xj) @ XM))))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XN @ ccfn)) @ (cwa @ (cwcel @ XM @ XB2) @ (cwcel @ XP @ XG))) @ (cwceq @ (ccfv @ XM @ (XD @ Xi @ Xj)) @ (cco @ (ccfv @ XP @ (cccom @ (XZ @ Xi @ Xj) @ (XS @ Xi @ Xj))) @ (ccfv @ (XE @ Xi @ Xj) @ (XD @ Xi @ Xj)) @ (Xc_x @ Xi @ Xj))))))))))))))))))))))))))).
