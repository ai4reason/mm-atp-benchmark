...
thf(alsmmod_thm,axiom,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) @ (cwss @ XS @ XU)) @ (cwceq @ (cco @ XS @ (ccin @ XT @ XU) @ Xc_po) @ (ccin @ (cco @ XS @ XT @ Xc_po) @ XU)))))))))).
...
thf(clsmmod2_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) @ (cwss @ XU @ XS)) @ (cwceq @ (ccin @ XS @ (cco @ XT @ XU @ Xc_po)) @ (cco @ (ccin @ XS @ XT) @ XU @ Xc_po)))))))))).
