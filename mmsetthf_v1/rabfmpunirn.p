...
thf(azfausab_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3)))) @ ccvv))))).
...
thf(crabfmpunirn_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XW @ Xx3)))))) => ((! [Xx3:$i] : (cwcel @ (XW @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ XB2) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3))))) => (cwb @ (cwcel @ XB2 @ (ccuni @ (ccrn @ XF))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ XB2 @ (XW @ Xx3)) @ (Xps @ Xx3))) @ (^ [Xx3:$i] : XV))))))))))))).
