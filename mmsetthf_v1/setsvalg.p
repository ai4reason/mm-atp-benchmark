...
thf(adf_sets_ax,axiom,(cwceq @ ccsts @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xe:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xe:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xe:$i] : (ccun @ (ccres @ (ccv @ Xs1) @ (ccdif @ ccvv @ (ccdm @ (ccsn @ (ccv @ Xe))))) @ (ccsn @ (ccv @ Xe)))))))).
thf(csetsvalg_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XA2 @ XW)) @ (cwceq @ (cco @ XS @ XA2 @ ccsts) @ (ccun @ (ccres @ XS @ (ccdif @ ccvv @ (ccdm @ (ccsn @ XA2)))) @ (ccsn @ XA2))))))))).
