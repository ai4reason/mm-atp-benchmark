...
thf(adfeven2_thm,axiom,(cwceq @ cceven @ (ccrab @ (^ [Xz:$i] : (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds)) @ (^ [Xz:$i] : ccz)))).
thf(ciseven2_conj,conjecture,(! [XZ:($i > $o)] : (cwb @ (cwcel @ XZ @ cceven) @ (cwa @ (cwcel @ XZ @ ccz) @ (cwbr @ cc2 @ XZ @ ccdvds))))).
