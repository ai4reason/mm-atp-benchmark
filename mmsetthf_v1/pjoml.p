...
thf(cpjoml_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccsh)) @ (cwa @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccin @ XB2 @ (ccfv @ XA2 @ ccort)) @ cc0h))) @ (cwceq @ XA2 @ XB2))))).
