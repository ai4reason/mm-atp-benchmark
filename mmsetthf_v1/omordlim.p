...
thf(comordlim_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwa @ (cwcel @ XB2 @ (XD @ Xx3)) @ (cwlim @ XB2))) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccomu))) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ XC @ (cco @ XA2 @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : XB2))))))))).
