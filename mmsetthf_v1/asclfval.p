...
thf(adf_ascl_ax,axiom,(cwceq @ ccascl @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ ccsca) @ ccbs)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccur) @ (ccfv @ (ccv @ Xw) @ ccvsca)))))))).
...
thf(casclfval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccfv @ XW @ ccascl))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccfv @ XW @ ccsca))) => ((! [Xx3:$i] : (cwceq @ XK @ (ccfv @ (XF @ Xx3) @ ccbs))) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ Xc_1 @ (ccfv @ XW @ ccur)) => (! [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_1 @ Xc_x))))))))))))))))).
