...
thf(cdvreasin_conj,conjecture,(cwceq @ (cco @ ccr @ (ccres @ ccasin @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))).
