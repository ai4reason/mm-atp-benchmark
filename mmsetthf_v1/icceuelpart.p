...
thf(aiccelpart_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XM @ ccn) @ (cwral @ (^ [Xp:$i] : (cwi @ (cwcel @ XX @ (cco @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccfv @ XM @ (ccv @ Xp)) @ ccico)) @ (cwrex @ (^ [Xi:$i] : (cwcel @ XX @ (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ ccico))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo))))) @ (^ [Xp:$i] : (ccfv @ XM @ cciccp))))))).
...
thf(aicceuelpartlem_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (cwi @ Xph @ (cwi @ (cwa @ (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo)) @ (cwcel @ XJ @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwi @ (cwbr @ XI @ XJ @ cclt) @ (cwbr @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP) @ (ccfv @ XJ @ XP) @ ccle)))))))))))).
...
thf(anltle2tri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwn @ (cw3a @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XB2 @ XC @ ccle) @ (cwbr @ XC @ XA2 @ ccle)))))))).
...
thf(cicceuelpart_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ (cco @ (ccfv @ ccc0 @ XP) @ (ccfv @ XM @ XP) @ ccico))) @ (cwreu @ (^ [Xi:$i] : (cwcel @ XX @ (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP) @ ccico))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo))))))))))).
