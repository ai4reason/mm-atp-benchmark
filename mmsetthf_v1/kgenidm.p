...
thf(akgencmp2_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwcel @ XJ @ cctop) @ (cwb @ (cwcel @ (cco @ XJ @ XK @ ccrest) @ cccmp) @ (cwcel @ (cco @ (ccfv @ XJ @ cckgen) @ XK @ ccrest) @ cccmp)))))).
...
thf(akgencmp_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ (cco @ XJ @ XK @ ccrest) @ cccmp)) @ (cwceq @ (cco @ XJ @ XK @ ccrest) @ (cco @ (ccfv @ XJ @ cckgen) @ XK @ ccrest)))))).
...
thf(ckgenidm_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccrn @ cckgen)) @ (cwceq @ (ccfv @ XJ @ cckgen) @ XJ)))).
