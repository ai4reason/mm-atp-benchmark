...
thf(ajensenlem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ (XD @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ (XD @ Xz) @ ccr @ (XF @ Xz)))) => ((! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cwa @ (cwcel @ (ccv @ Xa) @ (XD @ Xz)) @ (cwcel @ (ccv @ Xb) @ (XD @ Xz)))) @ (cwss @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccicc) @ (XD @ Xz)))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XA2 @ Xz) @ ccfn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ (XA2 @ Xz) @ (cco @ ccc0 @ ccpnf @ ccico) @ (XT @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ (XA2 @ Xz) @ (XD @ Xz) @ (XX @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ ccc0 @ (cco @ cccnfld @ (XT @ Xz) @ ccgsu) @ cclt))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (cwi @ (cwa @ (Xph @ Xz) @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XD @ Xz)) @ (cwcel @ (ccv @ Xy1) @ (XD @ Xz)) @ (cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ cc1 @ ccicc)))) @ (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xt) @ (ccv @ Xx3) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccv @ Xy1) @ ccmul) @ ccaddc) @ (XF @ Xz)) @ (cco @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xz)) @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xy1) @ (XF @ Xz)) @ ccmul) @ ccaddc) @ ccle)))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwn @ (cwcel @ (ccv @ Xz) @ XB2)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ (ccun @ XB2 @ (ccsn @ (ccv @ Xz))) @ (XA2 @ Xz)))) => ((! [Xz:$i] : (cwceq @ (XS @ Xz) @ (cco @ cccnfld @ (ccres @ (XT @ Xz) @ XB2) @ ccgsu))) => ((! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XL @ Xz @ Xa @ Xb) @ (cco @ cccnfld @ (ccres @ (XT @ Xz) @ (ccun @ XB2 @ (ccsn @ (ccv @ Xz)))) @ ccgsu))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XS @ Xz) @ ccrp))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (cco @ (cco @ cccnfld @ (ccres @ (cco @ (XT @ Xz) @ (XX @ Xz) @ (ccof @ ccmul)) @ XB2) @ ccgsu) @ (XS @ Xz) @ ccdiv) @ (XD @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (ccfv @ (cco @ (cco @ cccnfld @ (ccres @ (cco @ (XT @ Xz) @ (XX @ Xz) @ (ccof @ ccmul)) @ XB2) @ ccgsu) @ (XS @ Xz) @ ccdiv) @ (XF @ Xz)) @ (cco @ (cco @ cccnfld @ (ccres @ (cco @ (XT @ Xz) @ (cccom @ (XF @ Xz) @ (XX @ Xz)) @ (ccof @ ccmul)) @ XB2) @ ccgsu) @ (XS @ Xz) @ ccdiv) @ ccle))) => (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xz) @ (cwa @ (cwcel @ (cco @ (cco @ cccnfld @ (ccres @ (cco @ (XT @ Xz) @ (XX @ Xz) @ (ccof @ ccmul)) @ (ccun @ XB2 @ (ccsn @ (ccv @ Xz)))) @ ccgsu) @ (XL @ Xz @ Xa @ Xb) @ ccdiv) @ (XD @ Xz)) @ (cwbr @ (ccfv @ (cco @ (cco @ cccnfld @ (ccres @ (cco @ (XT @ Xz) @ (XX @ Xz) @ (ccof @ ccmul)) @ (ccun @ XB2 @ (ccsn @ (ccv @ Xz)))) @ ccgsu) @ (XL @ Xz @ Xa @ Xb) @ ccdiv) @ (XF @ Xz)) @ (cco @ (cco @ cccnfld @ (ccres @ (cco @ (XT @ Xz) @ (cccom @ (XF @ Xz) @ (XX @ Xz)) @ (ccof @ ccmul)) @ (ccun @ XB2 @ (ccsn @ (ccv @ Xz)))) @ ccgsu) @ (XL @ Xz @ Xa @ Xb) @ ccdiv) @ ccle))))))))))))))))))))))))))))))).
