...
thf(cmeadjuni_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XM @ Xx3) @ ccmea))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccdm @ (XM @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XX @ (XS @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XX @ ccom @ ccdom))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwdisj @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ (ccuni @ XX) @ (XM @ Xx3)) @ (ccfv @ (ccres @ (XM @ Xx3) @ XX) @ ccsumge0)))))))))))))).
