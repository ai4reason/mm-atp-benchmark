...
thf(aovoliunlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : ((! [Xw:$i] : (cwceq @ (XT @ Xw) @ (ccseq @ ccaddc @ (XG @ Xw) @ cc1))) => ((! [Xw:$i] : (cwceq @ (XG @ Xw) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xw @ Xn) @ ccovol))))) => ((! [Xw:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xw) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xw @ Xn) @ ccr)))) => ((! [Xw:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xw) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (XA2 @ Xw @ Xn) @ ccovol) @ ccr)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (ccsup @ (ccrn @ (XT @ Xw)) @ ccxr @ cclt) @ ccr))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XB2 @ Xw) @ ccrp))) => ((! [Xw:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xw @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccfv @ (ccv @ Xn) @ (XF @ Xw))) @ cc1)))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XU @ Xw @ Xk @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XH @ Xw @ Xk)) @ cc1))))) => ((! [Xw:$i] : (! [Xk:$i] : (cwceq @ (XH @ Xw @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc2nd) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc1st) @ (XF @ Xw)))))))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwf1o @ ccn @ (ccxp @ ccn @ ccn) @ XJ))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwf @ ccn @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap) @ (XF @ Xw)))) => ((! [Xw:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xw) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xw @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccfv @ (ccv @ Xn) @ (XF @ Xw))))))))) => ((! [Xw:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xw) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwbr @ (ccsup @ (ccrn @ (XS @ Xw @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ (XA2 @ Xw @ Xn) @ ccovol) @ (cco @ (XB2 @ Xw) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccaddc) @ ccle)))) => ((! [Xw:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ (XK @ Xk) @ ccn)))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XL @ ccz))) => ((! [Xw:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xw) @ (cwral @ (^ [Xw:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xw) @ XJ) @ cc1st) @ XL @ ccle)) @ (^ [Xw:$i] : (cco @ cc1 @ (XK @ Xk) @ ccfz)))))) => (! [Xw:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xw) @ (cwbr @ (ccfv @ (XK @ Xk) @ (XU @ Xw @ Xk @ Xn)) @ (cco @ (ccsup @ (ccrn @ (XT @ Xw)) @ ccxr @ cclt) @ (XB2 @ Xw) @ ccaddc) @ ccle)))))))))))))))))))))))))))))))))).
...
thf(covoliunlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : ((cwceq @ XT @ (ccseq @ ccaddc @ XG @ cc1)) => ((cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => ((cwi @ Xph @ (cwcel @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccfv @ (ccv @ Xn) @ XF)) @ cc1))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XU @ Xk @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XH @ Xk)) @ cc1)))) => ((! [Xk:$i] : (cwceq @ (XH @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc2nd) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc1st) @ XF)))))) => ((cwi @ Xph @ (cwf1o @ ccn @ (ccxp @ ccn @ ccn) @ XJ)) => ((cwi @ Xph @ (cwf @ ccn @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap) @ XF)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccfv @ (ccv @ Xn) @ XF))))))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwbr @ (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ (XA2 @ Xn) @ ccovol) @ (cco @ XB2 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccaddc) @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (cco @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ XB2 @ ccaddc) @ ccle)))))))))))))))))))))))))).
