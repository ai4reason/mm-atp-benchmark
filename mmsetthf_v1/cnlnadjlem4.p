...
thf(ccnlnadjlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > $o)))] : ((cwcel @ XT @ cclo) => ((cwcel @ XT @ cccop) => ((! [Xy1:$i] : (! [Xg1:$i] : (cwceq @ (XG @ Xy1 @ Xg1) @ (ccmpt @ (^ [Xg1:$i] : cchil) @ (^ [Xg1:$i] : (cco @ (ccfv @ (ccv @ Xg1) @ XT) @ (ccv @ Xy1) @ ccsp)))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xg1:$i] : (cwceq @ (XB2 @ Xy1 @ Xw @ Xv @ Xg1) @ (ccrio @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xv) @ XT) @ (ccv @ Xy1) @ ccsp) @ (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil))))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xg1:$i] : (cwceq @ (XF @ Xy1 @ Xv @ Xg1) @ (ccmpt @ (^ [Xy1:$i] : cchil) @ (^ [Xy1:$i] : (XB2 @ Xy1 @ Xw @ Xv @ Xg1)))))))) => (! [Xy1:$i] : (! [Xv:$i] : (! [Xg1:$i] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwcel @ (ccfv @ XA2 @ (XF @ Xy1 @ Xv @ Xg1)) @ cchil)))))))))))))))).
