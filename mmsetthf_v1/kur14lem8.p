...
thf(ahashtplei_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwa @ (cwcel @ (cctp @ XA2 @ XB2 @ XC) @ ccfn) @ (cwbr @ (ccfv @ (cctp @ XA2 @ XB2 @ XC) @ cchash) @ cc3 @ ccle)))))).
