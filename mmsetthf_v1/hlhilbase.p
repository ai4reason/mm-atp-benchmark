...
thf(aphlbase_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccsca) @ XT)) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccvsca) @ Xc_x) @ (ccop @ (ccfv @ ccnx @ ccip) @ Xc_xi)))) => (cwi @ (cwcel @ XB2 @ XX) @ (cwceq @ XB2 @ (ccfv @ XH @ ccbs)))))))))))).
thf(chlhilbase_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwceq @ XL @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XM @ (ccfv @ XL @ ccbs)) => (cwi @ Xph @ (cwceq @ XM @ (ccfv @ XU @ ccbs)))))))))))))))).
