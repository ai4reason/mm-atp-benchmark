...
thf(chdmaplem4_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((cwi @ Xph @ (cwne @ (ccfv @ (ccsn @ XZ) @ XN) @ (ccfv @ (ccsn @ XX) @ XN))) => ((cwi @ Xph @ (cwne @ (ccfv @ (ccsn @ XZ) @ XN) @ (ccfv @ (ccsn @ XY) @ XN))) => (cwi @ Xph @ (cwn @ (cwcel @ XZ @ (ccun @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN))))))))))))))))))))))).
