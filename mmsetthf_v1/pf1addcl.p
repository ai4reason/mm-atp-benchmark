...
thf(apf1subrg_thm,axiom,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XQ @ (ccrn @ (ccfv @ XR @ cce1))) => (cwi @ (cwcel @ XR @ cccrg) @ (cwcel @ XQ @ (ccfv @ (cco @ XR @ XB2 @ ccpws) @ ccsubrg))))))))).
...
thf(cpf1addcl_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XQ @ (ccrn @ (ccfv @ XR @ cce1))) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XF @ XQ) @ (cwcel @ XG @ XQ)) @ (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ XQ)))))))))).
