...
thf(cfrgrnbnb_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XD @ (cco @ XG @ XX @ ccnbgr)) => (cwi @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwa @ (cwcel @ XU @ XD) @ (cwcel @ XW @ XD)) @ (cwne @ XU @ XW)) @ (cwi @ (cwa @ (cwcel @ (ccpr @ XU @ XA2) @ XE) @ (cwcel @ (ccpr @ XW @ XA2) @ XE)) @ (cwceq @ XA2 @ XX))))))))))))).
