...
thf(csqrt2irrlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccn)) => ((cwi @ Xph @ (cwceq @ (ccfv @ cc2 @ ccsqrt) @ (cco @ XA2 @ XB2 @ ccdiv))) => (cwi @ Xph @ (cwa @ (cwcel @ (cco @ XA2 @ cc2 @ ccdiv) @ ccz) @ (cwcel @ (cco @ XB2 @ cc2 @ ccdiv) @ ccn)))))))))).
