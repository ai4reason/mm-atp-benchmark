...
thf(aafvfv0bi_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0) @ (cwo @ (cwceq @ (ccafv @ XA2 @ XF) @ cc0) @ (cwceq @ (ccafv @ XA2 @ XF) @ ccvv)))))).
...
thf(caovov0bi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ cc0) @ (cwo @ (cwceq @ (ccaov @ XA2 @ XB2 @ XF) @ cc0) @ (cwceq @ (ccaov @ XA2 @ XB2 @ XF) @ ccvv))))))).
