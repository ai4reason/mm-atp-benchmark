...
thf(cnvcli_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XA2 @ XX) => (cwcel @ (ccfv @ XA2 @ XN) @ ccr)))))))))).
