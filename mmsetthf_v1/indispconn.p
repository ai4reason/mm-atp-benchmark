...
thf(aprprc2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwn @ (cwcel @ XB2 @ ccvv)) @ (cwceq @ (ccpr @ XA2 @ XB2) @ (ccsn @ XA2)))))).
...
thf(acnindis_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XA2 @ XV)) @ (cwceq @ (cco @ XJ @ (ccpr @ cc0 @ XA2) @ cccn) @ (cco @ XA2 @ XX @ ccmap)))))))).
...
thf(cindispconn_conj,conjecture,(! [XA2:($i > $o)] : (cwcel @ (ccpr @ cc0 @ XA2) @ ccpconn))).
