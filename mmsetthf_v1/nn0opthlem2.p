...
thf(ann0opthlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XC @ ccn0) => (cwb @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ (cco @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ cc2 @ XA2 @ ccmul) @ ccaddc) @ (cco @ XC @ XC @ ccmul) @ cclt))))))).
...
thf(ann0lele2xi_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccn0) => ((cwcel @ XN @ ccn0) => (cwi @ (cwbr @ XN @ XM @ ccle) @ (cwbr @ XN @ (cco @ cc2 @ XM @ ccmul) @ ccle))))))).
...
thf(cnn0opthlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => (cwi @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt) @ (cwne @ (cco @ (cco @ XC @ XC @ ccmul) @ XD @ ccaddc) @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccmul) @ XB2 @ ccaddc)))))))))))).
