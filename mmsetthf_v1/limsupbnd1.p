...
thf(climsupbnd1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((cwi @ Xph @ (cwf @ XB2 @ ccxr @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xj) @ XF) @ XA2 @ ccle))) @ (^ [Xj:$i] : XB2))) @ (^ [Xk:$i] : ccr))) => (cwi @ Xph @ (cwbr @ (ccfv @ XF @ cclsp) @ XA2 @ ccle))))))))))).
