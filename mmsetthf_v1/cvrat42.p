...
thf(ccvrat42_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((! [Xr:$i] : (cwceq @ (Xc_0 @ Xr) @ (ccfv @ XK @ ccp0))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2))) @ (cwi @ (cwa @ (cwne @ XX @ (Xc_0 @ Xr)) @ (cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le)) @ (cwrex @ (^ [Xr:$i] : (cwa @ (cwbr @ (ccv @ Xr) @ XX @ Xc_le) @ (cwbr @ XP @ (cco @ (ccv @ Xr) @ XQ @ Xc_or) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))))))).
