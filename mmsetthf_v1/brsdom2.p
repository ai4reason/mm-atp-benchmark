...
thf(adfsdom2_thm,axiom,(cwceq @ ccsdm @ (ccdif @ ccdom @ (cccnv @ ccdom)))).
...
thf(cbrsdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwa @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwn @ (cwbr @ XB2 @ XA2 @ ccdom))))))))).
