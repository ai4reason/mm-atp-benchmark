...
thf(csymgextfv_conj,conjecture,(! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XS @ (ccfv @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccsymg) @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XK) @ XK @ (ccfv @ (ccv @ Xx3) @ XZ)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XK @ XN) @ (cwcel @ XZ @ XS)) @ (cwi @ (cwcel @ XX @ (ccdif @ XN @ (ccsn @ XK))) @ (cwceq @ (ccfv @ XX @ (XE @ Xx3)) @ (ccfv @ XX @ XZ)))))))))))))).
