...
thf(cltexp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwb @ (cwbr @ XM @ XN @ cclt) @ (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ cclt))))))).
