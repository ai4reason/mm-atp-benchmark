...
thf(aevthicc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccrn @ XF) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))))))))).
...
thf(cdvcnvrelem1_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XX @ ccr @ cccncf))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ XX)) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XF @ ccdv))))) => ((cwi @ Xph @ (cwf1o @ XX @ XY @ XF)) => ((cwi @ Xph @ (cwcel @ XC @ XX)) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((cwi @ Xph @ (cwss @ (cco @ (cco @ XC @ XR @ ccmin) @ (cco @ XC @ XR @ ccaddc) @ ccicc) @ XX)) => (cwi @ Xph @ (cwcel @ (ccfv @ XC @ XF) @ (ccfv @ (ccima @ XF @ (cco @ (cco @ XC @ XR @ ccmin) @ (cco @ XC @ XR @ ccaddc) @ ccicc)) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ ccnt)))))))))))))))))).
