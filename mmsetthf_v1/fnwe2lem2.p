...
thf(cfnwe2lem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xz) @ (ccfv @ (ccv @ Xx3) @ XF)) @ (cwceq @ (XS @ Xz) @ (XU @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xz) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwo @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (XR @ Xz)) @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XU @ Xx3))))))))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xa) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwwe @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : XA2)) @ (XU @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwf @ XA2 @ (XB2 @ Xx3 @ Xy1 @ Xz) @ (ccres @ XF @ XA2))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwwe @ (XB2 @ Xx3 @ Xy1 @ Xz) @ (XR @ Xz))))))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwss @ (ccv @ Xa) @ XA2))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwne @ (ccv @ Xa) @ cc0))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwn @ (cwbr @ (ccv @ Xc) @ (ccv @ Xb) @ (XT @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xc:$i] : (ccv @ Xa)))) @ (^ [Xb:$i] : (ccv @ Xa)))))))))))))))))))))))).
