...
thf(celbl2ps_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XR @ ccxr)) @ (cwa @ (cwcel @ XP @ XX) @ (cwcel @ XA2 @ XX))) @ (cwb @ (cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) @ (cwbr @ (cco @ XP @ XA2 @ XD) @ XR @ cclt))))))))).
