...
thf(cisfne4b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XA2)) => ((cwceq @ XY @ (ccuni @ XB2)) => (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwa @ (cwceq @ XX @ XY) @ (cwss @ (ccfv @ XA2 @ cctg) @ (ccfv @ XB2 @ cctg))))))))))))).
