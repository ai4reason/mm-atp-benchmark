...
thf(a_1arith_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (! [Xp:$i] : (cwceq @ (XM @ Xn @ Xp) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccpc)))))))) => ((! [Xe:$i] : (! [Xp:$i] : (cwceq @ (XR @ Xe @ Xp) @ (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xe)) @ ccn) @ ccfn)) @ (^ [Xe:$i] : (cco @ ccn0 @ ccprime @ ccmap)))))) => (! [Xe:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwf1o @ ccn @ (XR @ Xe @ Xp) @ (XM @ Xn @ Xp)))))))))).
...
thf(aissqf_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwb @ (cwne @ (ccfv @ XA2 @ ccmu) @ ccc0) @ (cwral @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ cc1 @ ccle)) @ (^ [Xp:$i] : ccprime)))))).
...
thf(apcge0_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccz)) @ (cwbr @ ccc0 @ (cco @ XP @ XN @ ccpc) @ ccle))))).
...
thf(apw2f1olem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XA2 @ (XV @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XB2 @ (XW @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ XC @ (XW @ Xz)))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwne @ XB2 @ XC))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwb @ (cwa @ (cwcel @ XS @ (ccpw @ XA2)) @ (cwceq @ (XG @ Xz) @ (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccif @ (cwcel @ (ccv @ Xz) @ XS) @ XC @ XB2))))) @ (cwa @ (cwcel @ (XG @ Xz) @ (cco @ (ccpr @ XB2 @ XC) @ XA2 @ ccmap)) @ (cwceq @ XS @ (ccima @ (cccnv @ (XG @ Xz)) @ (ccsn @ XC)))))))))))))))))))).
