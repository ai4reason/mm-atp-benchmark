...
thf(afzoaddel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) @ (cwcel @ XD @ ccz)) @ (cwcel @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ (cco @ XB2 @ XD @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccfzo)))))))).
...
thf(csplfv2a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccword @ XA2))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((cwi @ Xph @ (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((cwi @ Xph @ (cwcel @ XR @ (ccword @ XA2))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ (ccfv @ XR @ cchash) @ ccfzo))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XF @ XX @ ccaddc) @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice)) @ (ccfv @ XX @ XR)))))))))))))))).
