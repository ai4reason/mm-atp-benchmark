...
thf(adf_shft_ax,axiom,(cwceq @ ccshi @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xx3:$i] : ccc)) @ (^ [Xf1:$i] : (^ [Xx3:$i] : (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ ccc) @ (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ (ccv @ Xz) @ (ccv @ Xf1))))))))))).
thf(cshftfval_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XF @ XA2 @ ccshi) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwbr @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccv @ Xy1) @ XF))))))))))).
