...
thf(cuzind4s_conj,conjecture,(! [Xph:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwi @ (cwcel @ XM @ ccz) @ (cwsbc @ (^ [Xk:$i] : (Xph @ Xk)) @ XM)) => ((! [Xk:$i] : (cwi @ (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz)) @ (cwi @ (Xph @ Xk) @ (cwsbc @ (^ [Xk:$i] : (Xph @ Xk)) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc))))) => (! [Xk:$i] : (cwi @ (cwcel @ (XN @ Xk) @ (ccfv @ XM @ ccuz)) @ (cwsbc @ (^ [Xk:$i] : (Xph @ Xk)) @ (XN @ Xk)))))))))).
