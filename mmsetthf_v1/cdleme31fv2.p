...
thf(ccdleme31fv2_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccif @ (cwa @ (cwne @ XP @ XQ) @ (cwn @ (cwbr @ (ccv @ Xx3) @ XW @ Xc_le))) @ (XO @ Xx3) @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XX @ XB2) @ (cwn @ (cwa @ (cwne @ XP @ XQ) @ (cwn @ (cwbr @ XX @ XW @ Xc_le))))) @ (cwceq @ (ccfv @ XX @ (XF @ Xx3)) @ XX))))))))))))).
