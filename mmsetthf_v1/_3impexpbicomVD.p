...
thf(ae00_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => ((cwi @ Xph @ (cwi @ Xps @ Xch)) => Xch))))))).
...
thf(a_3impexp_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwb @ (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) @ (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ Xth))))))))).
...
thf(c_3impexpbicomVD_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (cwb @ (cwi @ (cw3a @ Xph @ Xps @ Xch) @ (cwb @ Xth @ Xta)) @ (cwi @ Xph @ (cwi @ Xps @ (cwi @ Xch @ (cwb @ Xta @ Xth))))))))))).
