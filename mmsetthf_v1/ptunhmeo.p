...
thf(aundifixp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (cwcel @ XG @ (ccixp @ (^ [Xx3:$i] : (ccdif @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (cwss @ XB2 @ XA2)) @ (cwcel @ (ccun @ XF @ XG) @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
...
thf(aptrescn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XX @ (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XF @ ccpt))) => ((cwceq @ XK @ (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF) @ (cwss @ XB2 @ XA2)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XB2))) @ (cco @ (XJ @ Xx3) @ XK @ cccn))))))))))))))).
