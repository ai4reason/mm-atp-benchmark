...
thf(adf_lbs_ax,axiom,(cwceq @ cclbs @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccrab @ (^ [Xb:$i] : (cwsbc @ (^ [Xn:$i] : (cwsbc @ (^ [Xs1:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xw) @ ccbs)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccvsca)) @ (ccfv @ (ccdif @ (ccv @ Xb) @ (ccsn @ (ccv @ Xx3))) @ (ccv @ Xn))))) @ (^ [Xy1:$i] : (ccdif @ (ccfv @ (ccv @ Xs1) @ ccbs) @ (ccsn @ (ccfv @ (ccv @ Xs1) @ cc0g)))))) @ (^ [Xx3:$i] : (ccv @ Xb))))) @ (ccfv @ (ccv @ Xw) @ ccsca))) @ (ccfv @ (ccv @ Xw) @ cclspn))) @ (^ [Xb:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))))))).
