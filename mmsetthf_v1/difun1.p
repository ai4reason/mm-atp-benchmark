...
thf(aundm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccdif @ ccvv @ (ccun @ XA2 @ XB2)) @ (ccin @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2)))))).
thf(adifeq1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccdif @ XA2 @ XC) @ (ccdif @ XB2 @ XC))))))).
thf(cdifun1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccdif @ XA2 @ (ccun @ XB2 @ XC)) @ (ccdif @ (ccdif @ XA2 @ XB2) @ XC)))))).
