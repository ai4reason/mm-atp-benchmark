...
thf(cbitsmod_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0)) @ (cwceq @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccmo) @ ccbits) @ (ccin @ (ccfv @ XN @ ccbits) @ (cco @ ccc0 @ XM @ ccfzo))))))).
