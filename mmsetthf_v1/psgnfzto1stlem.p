...
thf(apmtrprfv2_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => (cwi @ (cwa @ (cwcel @ XD @ XV) @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwne @ XX @ XY))) @ (cwceq @ (ccfv @ XY @ (ccfv @ (ccpr @ XX @ XY) @ XT)) @ XX))))))))).
...
thf(apmtrprfv3_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XT @ (ccfv @ XD @ ccpmtr)) => (cwi @ (cw3a @ (cwcel @ XD @ XV) @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwcel @ XZ @ XD)) @ (cw3a @ (cwne @ XX @ XY) @ (cwne @ XX @ XZ) @ (cwne @ XY @ XZ))) @ (cwceq @ (ccfv @ XZ @ (ccfv @ (ccpr @ XX @ XY) @ XT)) @ XZ)))))))))).
...
thf(cpsgnfzto1stlem_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ XD @ (cco @ cc1 @ (XN @ Xi) @ ccfz))) => (cwi @ (cwa @ (cwcel @ XK @ ccn) @ (cwcel @ (cco @ XK @ cc1 @ ccaddc) @ XD)) @ (cwceq @ (ccmpt @ (^ [Xi:$i] : XD) @ (^ [Xi:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ cc1) @ (cco @ XK @ cc1 @ ccaddc) @ (ccif @ (cwbr @ (ccv @ Xi) @ (cco @ XK @ cc1 @ ccaddc) @ ccle) @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xi))))) @ (cccom @ (ccfv @ (ccpr @ XK @ (cco @ XK @ cc1 @ ccaddc)) @ (ccfv @ XD @ ccpmtr)) @ (ccmpt @ (^ [Xi:$i] : XD) @ (^ [Xi:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ cc1) @ XK @ (ccif @ (cwbr @ (ccv @ Xi) @ XK @ ccle) @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xi))))))))))))).
