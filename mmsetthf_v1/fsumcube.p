...
thf(afsumkthpow_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccn0) @ (cwcel @ XM @ ccn0)) @ (cwceq @ (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ XK @ ccexp))) @ (cco @ (cco @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ XM @ cc1 @ ccaddc) @ ccbp) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ ccc0 @ ccbp) @ ccmin) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv)))))).
...
thf(abpoly4_thm,axiom,(! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ ccc) @ (cwceq @ (cco @ cc4 @ XX @ ccbp) @ (cco @ (cco @ (cco @ (cco @ XX @ cc4 @ ccexp) @ (cco @ cc2 @ (cco @ XX @ cc3 @ ccexp) @ ccmul) @ ccmin) @ (cco @ XX @ cc2 @ ccexp) @ ccaddc) @ (cco @ cc1 @ (ccdc @ cc3 @ ccc0) @ ccdiv) @ ccmin))))).
...
thf(asq0_thm,axiom,(cwceq @ (cco @ ccc0 @ cc2 @ ccexp) @ ccc0)).
...
thf(cfsumcube_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ ccn0) @ (cwceq @ (ccsu @ (cco @ ccc0 @ XT @ ccfz) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ cc3 @ ccexp))) @ (cco @ (cco @ (cco @ XT @ cc2 @ ccexp) @ (cco @ (cco @ XT @ cc1 @ ccaddc) @ cc2 @ ccexp) @ ccmul) @ cc4 @ ccdiv))))).
