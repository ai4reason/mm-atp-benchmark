...
thf(agsumsubm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd))) => ((cwi @ Xph @ (cwf @ XA2 @ XS @ XF)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XF @ ccgsu) @ (cco @ XH @ XF @ ccgsu))))))))))))))).
...
thf(cresspsrmul_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XH @ (cco @ XR @ XT @ ccress)) => ((cwceq @ XU @ (cco @ XI @ XH @ ccmps)) => ((cwceq @ XB2 @ (ccfv @ XU @ ccbs)) => ((cwceq @ XP @ (cco @ XS @ XB2 @ ccress)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (cco @ XX @ XY @ (ccfv @ XU @ ccmulr)) @ (cco @ XX @ XY @ (ccfv @ XP @ ccmulr)))))))))))))))))))))).
