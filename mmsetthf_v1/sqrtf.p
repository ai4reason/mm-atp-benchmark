...
thf(adf_sqrt_ax,axiom,(cwceq @ ccsqrt @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cw3a @ (cwceq @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ (ccv @ Xx3)) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xy1) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccrp))) @ (^ [Xy1:$i] : ccc)))))).
...
thf(csqrtf_conj,conjecture,(cwf @ ccc @ ccc @ ccsqrt)).
