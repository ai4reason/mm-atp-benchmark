...
thf(adffi2_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwceq @ (ccfv @ XA2 @ ccfi) @ (ccint @ (ccab @ (^ [Xz:$i] : (cwa @ (cwss @ XA2 @ (ccv @ Xz)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xy1:$i] : (ccv @ Xz)))) @ (^ [Xx3:$i] : (ccv @ Xz))))))))))))).
...
thf(cdffi3_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xu:$i] : (cwceq @ (XR @ Xz @ Xu) @ (ccmpt @ (^ [Xu:$i] : ccvv) @ (^ [Xu:$i] : (ccrn @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccv @ Xu))) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccv @ Xu))) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))))))) => (! [Xz:$i] : (! [Xu:$i] : (cwi @ (cwcel @ (XA2 @ Xz @ Xu) @ (XV @ Xz @ Xu)) @ (cwceq @ (ccfv @ (XA2 @ Xz @ Xu) @ ccfi) @ (ccuni @ (ccima @ (ccrdg @ (XR @ Xz @ Xu) @ (XA2 @ Xz @ Xu)) @ ccom))))))))))).
