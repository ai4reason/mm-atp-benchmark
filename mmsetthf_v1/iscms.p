...
thf(adf_cms_ax,axiom,(cwceq @ cccms @ (ccrab @ (^ [Xw:$i] : (cwsbc @ (^ [Xb:$i] : (cwcel @ (ccres @ (ccfv @ (ccv @ Xw) @ ccds) @ (ccxp @ (ccv @ Xb) @ (ccv @ Xb))) @ (ccfv @ (ccv @ Xb) @ ccms))) @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xw:$i] : ccmt)))).
thf(ciscms_conj,conjecture,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XM @ ccbs)) => ((cwceq @ XD @ (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX))) => (cwb @ (cwcel @ XM @ cccms) @ (cwa @ (cwcel @ XM @ ccmt) @ (cwcel @ XD @ (ccfv @ XX @ ccms)))))))))).
