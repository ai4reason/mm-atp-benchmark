...
thf(apjhthlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwi @ Xph @ (cwcel @ XA2 @ cchil)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XA2 @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : (ccfv @ XH @ ccort)))) @ (^ [Xx3:$i] : XH))))))))).
...
thf(aomlsilem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccsh) => ((cwcel @ XH @ ccsh) => ((cwss @ XG @ XH) => ((cwceq @ (ccin @ XH @ (ccfv @ XG @ ccort)) @ cc0h) => ((cwcel @ XA2 @ XH) => ((cwcel @ XB2 @ XG) => ((cwcel @ XC @ (ccfv @ XG @ ccort)) => (cwi @ (cwceq @ XA2 @ (cco @ XB2 @ XC @ ccva)) @ (cwcel @ XA2 @ XG))))))))))))))).
...
thf(ach0_thm,axiom,(! [XH:($i > $o)] : (cwi @ (cwcel @ XH @ ccch) @ (cwcel @ cc0v @ XH)))).
thf(ashocsh_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccsh) @ (cwcel @ (ccfv @ XA2 @ ccort) @ ccsh)))).
thf(comlsii_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccsh) => ((cwss @ XA2 @ XB2) => ((cwceq @ (ccin @ XB2 @ (ccfv @ XA2 @ ccort)) @ cc0h) => (cwceq @ XA2 @ XB2)))))))).
