...
thf(ce212_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwvd2 @ Xph @ Xps @ Xch) => ((cwvd1 @ Xph @ Xth) => ((cwvd2 @ Xph @ Xps @ Xta) => ((cwi @ Xch @ (cwi @ Xth @ (cwi @ Xta @ Xet))) => (cwvd2 @ Xph @ Xps @ Xet)))))))))))).
