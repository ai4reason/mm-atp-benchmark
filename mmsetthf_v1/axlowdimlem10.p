...
thf(afznatpl1_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ cc1 @ XN @ ccfz)))))).
...
thf(caxlowdimlem10_conj,conjecture,(! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ (cwcel @ XQ @ (ccfv @ XN @ ccee)))))))).
