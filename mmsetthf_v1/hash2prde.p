...
thf(ahash2pr_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XV @ (XW @ Xa @ Xb)) @ (cwceq @ (ccfv @ XV @ cchash) @ cc2)) @ (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))))).
...
thf(chash2prde_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XV @ XW) @ (cwceq @ (ccfv @ XV @ cchash) @ cc2)) @ (cwex @ (^ [Xa:$i] : (cwex @ (^ [Xb:$i] : (cwa @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwceq @ XV @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))))))))))).
