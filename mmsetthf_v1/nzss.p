...
thf(arelimasn_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwrel @ XR) @ (cwceq @ (ccima @ XR @ (ccsn @ XA2)) @ (ccab @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XR)))))))).
...
thf(cnzss_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ XV)) => (cwi @ Xph @ (cwb @ (cwss @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) @ (cwbr @ XN @ XM @ ccdvds)))))))))).
