...
thf(crelexp0a_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XN @ ccn0)) @ (cwss @ (cco @ (cco @ XA2 @ XN @ ccrelexp) @ ccc0 @ ccrelexp) @ (cco @ XA2 @ ccc0 @ ccrelexp))))))).
