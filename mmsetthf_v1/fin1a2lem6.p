...
thf(afin1a2lem2_thm,axiom,(! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwf1 @ ccon0 @ ccon0 @ (XS @ Xx3)))))).
...
thf(afin1a2lem5_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => (! [Xx3:$i] : (cwi @ (cwcel @ (XA2 @ Xx3) @ ccom) @ (cwb @ (cwcel @ (XA2 @ Xx3) @ (ccrn @ (XE @ Xx3))) @ (cwn @ (cwcel @ (ccsuc @ (XA2 @ Xx3)) @ (ccrn @ (XE @ Xx3))))))))))).
...
thf(aom0x_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (cco @ XA2 @ cc0 @ ccomu) @ cc0))).
...
thf(cfin1a2lem6_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwf1o @ (ccrn @ (XE @ Xx3)) @ (ccdif @ ccom @ (ccrn @ (XE @ Xx3))) @ (ccres @ (XS @ Xx3) @ (ccrn @ (XE @ Xx3)))))))))).
