...
thf(cmndifsplit_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XM @ cc0g)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XM @ ccmnd) @ (cwcel @ XA2 @ XB2) @ (cwn @ (cwa @ Xph @ Xps))) @ (cwceq @ (ccif @ (cwo @ Xph @ Xps) @ XA2 @ Xc_0) @ (cco @ (ccif @ Xph @ XA2 @ Xc_0) @ (ccif @ Xps @ XA2 @ Xc_0) @ Xc_pl)))))))))))))).
