...
thf(ann0ge2m1nn0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwbr @ cc2 @ XN @ ccle)) @ (cwcel @ (cco @ XN @ cc1 @ ccmin) @ ccn0)))).
...
thf(cwwlksm1edg_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccfv @ XG @ ccwwlks)) @ (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) @ (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ (ccfv @ XG @ ccwwlks)))))).
