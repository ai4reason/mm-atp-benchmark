...
thf(cgrplrinv_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ XG @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (Xc_pl @ Xx3) @ (ccfv @ XG @ ccplusg))) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XG @ cc0g))) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_pl @ Xx3)) @ (Xc_0 @ Xx3)) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3)) @ (Xc_0 @ Xx3)))) @ (^ [Xy1:$i] : (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))).
