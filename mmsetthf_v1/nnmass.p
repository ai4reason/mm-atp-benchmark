...
thf(annm0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccom) @ (cwceq @ (cco @ XA2 @ cc0 @ ccomu) @ cc0)))).
...
thf(annmsuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwceq @ (cco @ XA2 @ (ccsuc @ XB2) @ ccomu) @ (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XA2 @ ccoa)))))).
...
thf(anndi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccomu) @ (cco @ (cco @ XA2 @ XB2 @ ccomu) @ (cco @ XA2 @ XC @ ccomu) @ ccoa))))))).
thf(cnnmass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccomu) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccomu))))))).
