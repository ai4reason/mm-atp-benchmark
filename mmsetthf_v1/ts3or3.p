...
thf(atsor3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (cwi @ Xth @ (cwo @ (cwn @ Xps) @ (cwo @ Xph @ Xps))))))).
...
thf(cts3or3_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ Xth @ (cwo @ (cwn @ Xch) @ (cw3o @ Xph @ Xps @ Xch)))))))).
