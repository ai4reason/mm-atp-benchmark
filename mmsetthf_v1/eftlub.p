...
thf(areeftlcl_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccn0)) @ (cwcel @ (ccsu @ (ccfv @ XM @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccr)))))))).
...
thf(aiserabs_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ XG @ XM) @ (XB2 @ Xk) @ ccli))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccabs)))) => (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XA2 @ Xk) @ ccabs) @ (XB2 @ Xk) @ ccle))))))))))))))))).
...
thf(ashftval4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (ccfv @ XB2 @ (cco @ XF @ (ccneg @ XA2) @ ccshi)) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ XF)))))))).
...
thf(afaclbnd6_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn0)) @ (cwbr @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XM @ ccexp) @ ccmul) @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ ccfa) @ ccle))))).
...
thf(aisumshft_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xj) @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ XW @ (ccfv @ (cco @ (XM @ Xj @ Xk) @ XK @ ccaddc) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ XK @ (ccv @ Xk) @ ccaddc)) @ (cwceq @ (XA2 @ Xj) @ (XB2 @ Xk))))) => ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XW)) @ (cwcel @ (XA2 @ Xj) @ ccc))) => (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XW @ (^ [Xj:$i] : (XA2 @ Xj))) @ (ccsu @ (XZ @ Xj) @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))))))))))).
