...
thf(aoppchomfval_thm,axiom,(! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => (cwceq @ (cctpos @ XH) @ (ccfv @ XO @ cchom)))))))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(aovtpos_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (cco @ XA2 @ XB2 @ (cctpos @ XF)) @ (cco @ XB2 @ XA2 @ XF)))))).
thf(coppchom_conj,conjecture,(! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => (cwceq @ (cco @ XX @ XY @ (ccfv @ XO @ cchom)) @ (cco @ XY @ XX @ XH)))))))))).
