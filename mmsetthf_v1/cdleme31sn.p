...
thf(ccdleme31sn_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xs1:$i] : (cwceq @ (XN @ Xs1) @ (ccif @ (cwbr @ (ccv @ Xs1) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) @ (XI @ Xs1) @ (XD @ Xs1)))) => ((! [Xs1:$i] : (cwceq @ (XC @ Xs1) @ (ccif @ (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) @ (ccsb @ XR @ (^ [Xs1:$i] : (XI @ Xs1))) @ (ccsb @ XR @ (^ [Xs1:$i] : (XD @ Xs1)))))) => (! [Xs1:$i] : (cwi @ (cwcel @ XR @ XA2) @ (cwceq @ (ccsb @ XR @ (^ [Xs1:$i] : (XN @ Xs1))) @ (XC @ Xs1))))))))))))))))).
