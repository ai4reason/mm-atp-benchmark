...
thf(aatans2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwb @ (cwcel @ XA2 @ (XS @ Xy1)) @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ XD) @ (cwcel @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ XD)))))))))).
...
thf(aatansopn_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwcel @ (XS @ Xy1) @ (ccfv @ cccnfld @ cctopn)))))))).
...
thf(airec_thm,axiom,(cwceq @ (cco @ cc1 @ cci @ ccdiv) @ (ccneg @ cci))).
thf(a_3eqtr3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XA2 @ XC)) => ((cwi @ Xph @ (cwceq @ XB2 @ XD)) => (cwi @ Xph @ (cwceq @ XC @ XD))))))))))).
thf(arecdiv2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ ccdiv) @ (cco @ cc1 @ (cco @ XA2 @ XB2 @ ccmul) @ ccdiv))))))))))).
...
thf(adf_atan_ax,axiom,(cwceq @ ccatan @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccpr @ (ccneg @ cci) @ cci))) @ (^ [Xx3:$i] : (cco @ (cco @ cci @ cc2 @ ccdiv) @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccmin) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ cclog) @ ccmin) @ ccmul))))).
...
thf(cdvatan_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwceq @ (cco @ ccc @ (ccres @ ccatan @ (XS @ Xy1)) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (XS @ Xy1)) @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccaddc) @ ccdiv)))))))))).
