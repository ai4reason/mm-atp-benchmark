...
thf(cntreq0_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwb @ (cwceq @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XS) @ (cwceq @ (ccv @ Xx3) @ cc0))) @ (^ [Xx3:$i] : XJ))))))))).
