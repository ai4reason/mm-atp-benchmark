...
thf(aepee_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cceven) @ (cwcel @ XB2 @ cceven)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ cceven))))).
...
thf(aemee_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cceven) @ (cwcel @ XB2 @ cceven)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ cceven))))).
thf(cevensumeven_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ cceven)) @ (cwb @ (cwcel @ XA2 @ cceven) @ (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ cceven)))))).
