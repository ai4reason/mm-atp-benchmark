...
thf(cmpfrcl_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XQ @ (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => (cwi @ (cwcel @ XX @ XQ) @ (cw3a @ (cwcel @ XI @ ccvv) @ (cwcel @ XS @ cccrg) @ (cwcel @ XR @ (ccfv @ XS @ ccsubrg))))))))))).
