...
thf(cpsrass1lem_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XD @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ (XI @ Xj @ Xk) @ ccmap))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xy1 @ Xf1) @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XF @ (ccofr @ ccle))) @ (^ [Xy1:$i] : (XD @ Xf1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) @ (cwcel @ (XI @ Xj @ Xk) @ (XV @ Xf1 @ Xj @ Xk))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) @ (cwcel @ XF @ (XD @ Xf1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xn) @ (ccfv @ XG @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) @ (cwcel @ XG @ cccmn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) @ (cwa @ (cwcel @ (ccv @ Xj) @ (XS @ Xy1 @ Xf1)) @ (cwcel @ (ccv @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XF @ (ccv @ Xj) @ (ccof @ ccmin)) @ (ccofr @ ccle))) @ (^ [Xx3:$i] : (XD @ Xf1)))))) @ (cwcel @ (XX @ Xj @ Xk) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xn))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (cco @ (ccv @ Xn) @ (ccv @ Xj) @ (ccof @ ccmin))) @ (cwceq @ (XX @ Xj @ Xk) @ (XY @ Xj @ Xn)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) @ (cwceq @ (cco @ XG @ (ccmpt @ (^ [Xn:$i] : (XS @ Xy1 @ Xf1)) @ (^ [Xn:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xn) @ (ccofr @ ccle))) @ (^ [Xx3:$i] : (XD @ Xf1)))) @ (^ [Xj:$i] : (XY @ Xj @ Xn))) @ ccgsu))) @ ccgsu) @ (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XS @ Xy1 @ Xf1)) @ (^ [Xj:$i] : (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XF @ (ccv @ Xj) @ (ccof @ ccmin)) @ (ccofr @ ccle))) @ (^ [Xx3:$i] : (XD @ Xf1)))) @ (^ [Xk:$i] : (XX @ Xj @ Xk))) @ ccgsu))) @ ccgsu)))))))))))))))))))))))))).
