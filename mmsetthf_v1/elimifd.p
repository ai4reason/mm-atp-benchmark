...
thf(celimifd_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwi @ (cwceq @ (ccif @ Xps @ XA2 @ XB2) @ XA2) @ (cwb @ Xch @ Xth))) => ((cwi @ Xph @ (cwi @ (cwceq @ (ccif @ Xps @ XA2 @ XB2) @ XB2) @ (cwb @ Xch @ Xta))) => (cwi @ Xph @ (cwb @ Xch @ (cwo @ (cwa @ Xps @ Xth) @ (cwa @ (cwn @ Xps) @ Xta)))))))))))))).
