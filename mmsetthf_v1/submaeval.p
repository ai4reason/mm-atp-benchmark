...
thf(asubmaval_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XQ @ Xi @ Xj) @ (cco @ XN @ XR @ ccsubma)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XB2 @ Xi @ Xj) @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cw3a @ (cwcel @ XM @ (XB2 @ Xi @ Xj)) @ (cwcel @ XK @ XN) @ (cwcel @ XL @ XN)) @ (cwceq @ (cco @ XK @ XL @ (ccfv @ XM @ (XQ @ Xi @ Xj))) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ XN @ (ccsn @ XK)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ XN @ (ccsn @ XL)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM)))))))))))))))))))).
...
thf(csubmaeval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XQ @ (cco @ XN @ XR @ ccsubma)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XM @ XB2) @ (cwa @ (cwcel @ XK @ XN) @ (cwcel @ XL @ XN)) @ (cwa @ (cwcel @ XI @ (ccdif @ XN @ (ccsn @ XK))) @ (cwcel @ XJ @ (ccdif @ XN @ (ccsn @ XL))))) @ (cwceq @ (cco @ XI @ XJ @ (cco @ XK @ XL @ (ccfv @ XM @ XQ))) @ (cco @ XI @ XJ @ XM))))))))))))))))).
