...
thf(cmapdcnvordN_conj,conjecture,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XM @ (ccfv @ XW @ (ccfv @ XK @ ccmpd))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwcel @ XX @ (ccrn @ XM))) => ((cwi @ Xph @ (cwcel @ XY @ (ccrn @ XM))) => (cwi @ Xph @ (cwb @ (cwss @ (ccfv @ XX @ (cccnv @ XM)) @ (ccfv @ XY @ (cccnv @ XM))) @ (cwss @ XX @ XY)))))))))))))))).
