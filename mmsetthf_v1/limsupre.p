...
thf(alimsupcl_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XF @ XV) @ (cwcel @ (ccfv @ XF @ cclsp) @ ccxr))))).
thf(amnfltd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwbr @ ccmnf @ XA2 @ cclt)))))).
thf(alimsupbnd2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((cwi @ Xph @ (cwf @ XB2 @ ccxr @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwceq @ (ccsup @ XB2 @ ccxr @ cclt) @ ccpnf)) => ((cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ XA2 @ (ccfv @ (ccv @ Xj) @ XF) @ ccle))) @ (^ [Xj:$i] : XB2))) @ (^ [Xk:$i] : ccr))) => (cwi @ Xph @ (cwbr @ XA2 @ (ccfv @ XF @ cclsp) @ ccle)))))))))))).
...
thf(alimsupbnd1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((cwi @ Xph @ (cwf @ XB2 @ ccxr @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ (ccfv @ (ccv @ Xj) @ XF) @ XA2 @ ccle))) @ (^ [Xj:$i] : XB2))) @ (^ [Xk:$i] : ccr))) => (cwi @ Xph @ (cwbr @ (ccfv @ XF @ cclsp) @ XA2 @ ccle))))))))))).
...
thf(climsupre_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xb:$i] : (cwi @ Xph @ (cwss @ (XB2 @ Xb) @ ccr))) => ((! [Xb:$i] : (cwi @ Xph @ (cwceq @ (ccsup @ (XB2 @ Xb) @ ccxr @ cclt) @ ccpnf))) => ((! [Xb:$i] : (cwi @ Xph @ (cwf @ (XB2 @ Xb) @ ccr @ XF))) => ((cwi @ Xph @ (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xj) @ XF) @ ccabs) @ (ccv @ Xb) @ ccle))) @ (^ [Xj:$i] : (XB2 @ Xb)))) @ (^ [Xk:$i] : ccr))) @ (^ [Xb:$i] : ccr))) => (cwi @ Xph @ (cwcel @ (ccfv @ XF @ cclsp) @ ccr)))))))))).
