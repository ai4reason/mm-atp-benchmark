...
thf(cpjss2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XG @ ccch) => (cwi @ (cwss @ XH @ XG) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh))))))))))).
