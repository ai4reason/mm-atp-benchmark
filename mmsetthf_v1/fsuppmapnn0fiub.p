...
thf(afsuppmapnn0fiublem_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XU @ (cciun @ (^ [Xf1:$i] : XM) @ (^ [Xf1:$i] : (cco @ (ccv @ Xf1) @ XZ @ ccsupp)))) => ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccsup @ XU @ ccr @ cclt))) => (! [Xf1:$i] : (cwi @ (cw3a @ (cwss @ XM @ (cco @ XR @ ccn0 @ ccmap)) @ (cwcel @ XM @ ccfn) @ (cwcel @ XZ @ XV)) @ (cwi @ (cwa @ (cwral @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XZ @ ccfsupp)) @ (^ [Xf1:$i] : XM)) @ (cwne @ XU @ cc0)) @ (cwcel @ (XS @ Xf1) @ ccn0))))))))))))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(asupfirege_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XC @ XB2)) => ((cwi @ Xph @ (cwceq @ XS @ (ccsup @ XB2 @ ccr @ cclt))) => (cwi @ Xph @ (cwbr @ XC @ XS @ ccle))))))))))).
...
thf(cfsuppmapnn0fiub_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XU @ (cciun @ (^ [Xf1:$i] : XM) @ (^ [Xf1:$i] : (cco @ (ccv @ Xf1) @ XZ @ ccsupp)))) => ((! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccsup @ XU @ ccr @ cclt))) => (cwi @ (cw3a @ (cwss @ XM @ (cco @ XR @ ccn0 @ ccmap)) @ (cwcel @ XM @ ccfn) @ (cwcel @ XZ @ XV)) @ (cwi @ (cwa @ (cwral @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XZ @ ccfsupp)) @ (^ [Xf1:$i] : XM)) @ (cwne @ XU @ cc0)) @ (cwral @ (^ [Xf1:$i] : (cwss @ (cco @ (ccv @ Xf1) @ XZ @ ccsupp) @ (cco @ ccc0 @ (XS @ Xf1) @ ccfz))) @ (^ [Xf1:$i] : XM))))))))))))).
