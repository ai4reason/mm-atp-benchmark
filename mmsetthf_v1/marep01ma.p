...
thf(cmarep01ma_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (XA2 @ Xk @ Xl) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xk @ Xl) @ ccbs)))) => ((cwcel @ XR @ cccrg) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_0 @ Xk @ Xl) @ (ccfv @ XR @ cc0g)))) => ((! [Xk:$i] : (! [Xl:$i] : (cwceq @ (Xc_1 @ Xk @ Xl) @ (ccfv @ XR @ ccur)))) => (cwi @ (cwcel @ XM @ XB2) @ (cwcel @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ (XH @ Xk @ Xl)) @ (ccif @ (cwceq @ (ccv @ Xl) @ (XI @ Xk @ Xl)) @ (Xc_1 @ Xk @ Xl) @ (Xc_0 @ Xk @ Xl)) @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ XM))))) @ XB2))))))))))))))))).
