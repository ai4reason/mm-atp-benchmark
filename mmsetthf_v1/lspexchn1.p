...
thf(clspexchn1_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwi @ Xph @ (cwcel @ XW @ cclvec)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => ((cwi @ Xph @ (cwcel @ XZ @ XV)) => ((cwi @ Xph @ (cwn @ (cwcel @ XY @ (ccfv @ (ccsn @ XZ) @ XN)))) => ((cwi @ Xph @ (cwn @ (cwcel @ XX @ (ccfv @ (ccpr @ XY @ XZ) @ XN)))) => (cwi @ Xph @ (cwn @ (cwcel @ XY @ (ccfv @ (ccpr @ XX @ XZ) @ XN)))))))))))))))))))).
