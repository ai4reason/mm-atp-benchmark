...
thf(aelfm3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XL @ (cco @ XY @ XB2 @ ccfg)) => (cwi @ (cwa @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwfo @ XY @ XX @ XF)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccima @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XL)))))))))))).
...
thf(cfmid_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwceq @ (ccfv @ XF @ (cco @ XX @ (ccres @ ccid @ XX) @ ccfm)) @ XF))))).
