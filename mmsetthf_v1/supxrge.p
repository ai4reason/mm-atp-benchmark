...
thf(asupxrgelem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ XB2 @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccxad) @ cclt)) @ (^ [Xy1:$i] : XA2)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))))))).
...
thf(axaddmnf2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwne @ XA2 @ ccpnf)) @ (cwceq @ (cco @ ccmnf @ XA2 @ ccxad) @ ccmnf)))).
...
thf(aad5ant125_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ Xph @ Xps) @ Xta) @ Xet) @ Xch) @ Xth))))))))).
...
thf(csupxrge_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ XB2 @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccxad) @ ccle)) @ (^ [Xy1:$i] : XA2)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))))))).
