...
thf(cbj_rexvwv_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xps @ Xx3 @ Xy1))) => (! [Xy1:$i] : (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))) @ (cwex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))))))))).
