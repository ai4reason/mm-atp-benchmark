...
thf(almimlbs_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XS @ cclbs)) => ((cwceq @ XK @ (ccfv @ XT @ cclbs)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmim)) @ (cwcel @ XB2 @ XJ)) @ (cwcel @ (ccima @ XF @ XB2) @ XK))))))))))).
thf(ane0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ XA2) @ (cwne @ XA2 @ cc0))))).
thf(clmiclbs_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XS @ cclbs)) => ((cwceq @ XK @ (ccfv @ XT @ cclbs)) => (cwi @ (cwbr @ XS @ XT @ cclmic) @ (cwi @ (cwne @ XJ @ cc0) @ (cwne @ XK @ cc0)))))))))).
