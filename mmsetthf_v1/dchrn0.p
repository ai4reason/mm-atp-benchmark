...
thf(cdchrn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XN @ ccdchr)) => ((cwceq @ XZ @ (ccfv @ XN @ cczn)) => ((cwceq @ XD @ (ccfv @ XG @ ccbs)) => ((cwceq @ XB2 @ (ccfv @ XZ @ ccbs)) => ((cwceq @ XU @ (ccfv @ XZ @ ccui)) => ((cwi @ Xph @ (cwcel @ XX @ XD)) => ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwne @ (ccfv @ XA2 @ XX) @ ccc0) @ (cwcel @ XA2 @ XU)))))))))))))))))))).
