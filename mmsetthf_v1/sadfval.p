...
thf(ahadbi123d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ Xph @ (cwb @ Xth @ Xta)) => ((cwi @ Xph @ (cwb @ Xet @ Xze)) => (cwi @ Xph @ (cwb @ (cwhad @ Xps @ Xth @ Xet) @ (cwhad @ Xch @ Xta @ Xze)))))))))))))).
...
thf(aseqeq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccseq @ XA2 @ XF @ XM) @ (ccseq @ XB2 @ XF @ XM)))))))))).
...
thf(acadbi123d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ Xph @ (cwb @ Xth @ Xta)) => ((cwi @ Xph @ (cwb @ Xet @ Xze)) => (cwi @ Xph @ (cwb @ (cwcad @ Xps @ Xth @ Xet) @ (cwcad @ Xch @ Xta @ Xze)))))))))))))).
...
thf(adf_sad_ax,axiom,(cwceq @ ccsad @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ ccn0))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ ccn0))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xk:$i] : (cwhad @ (cwcel @ (ccv @ Xk) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xk) @ (ccv @ Xy1)) @ (cwcel @ cc0 @ (ccfv @ (ccv @ Xk) @ (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xm) @ (ccv @ Xy1)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) @ (^ [Xk:$i] : ccn0))))))).
thf(arabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(csadfval_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xm @ Xn @ Xc) @ (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xm @ Xn @ Xc) @ (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwceq @ (XC @ Xm @ Xn @ Xc) @ (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) @ (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ (cwceq @ (ccv @ Xn) @ ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : (cwi @ (Xph @ Xm @ Xn @ Xc) @ (cwceq @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccsad) @ (ccrab @ (^ [Xk:$i] : (cwhad @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xn)) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xn)) @ (cwcel @ cc0 @ (ccfv @ (ccv @ Xk) @ (XC @ Xm @ Xn @ Xc))))) @ (^ [Xk:$i] : ccn0))))))))))))))).
