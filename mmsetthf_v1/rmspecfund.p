...
thf(apellqrexplicit_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1)) @ (cwcel @ (cco @ XA2 @ (cco @ (ccfv @ XD @ ccsqrt) @ XB2 @ ccmul) @ ccaddc) @ (ccfv @ XD @ ccpell1qr))))))).
...
thf(apellfundlb_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwbr @ (ccfv @ XD @ ccpellfund) @ XA2 @ ccle))))).
...
thf(crmspecfund_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccpellfund) @ (cco @ XA2 @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ ccaddc))))).
