...
thf(arlimcld2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : ((cwi @ Xph @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf)) => ((cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC @ ccrli)) => ((cwi @ Xph @ (cwss @ XD @ ccc)) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ (ccdif @ ccc @ XD))) @ (cwcel @ (XR @ Xy1) @ ccrp))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ (ccdif @ ccc @ XD))) @ (cwcel @ (ccv @ Xz) @ XD)) @ (cwbr @ (XR @ Xy1) @ (ccfv @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ ccle)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ XD))) => (cwi @ Xph @ (cwcel @ XC @ XD))))))))))))))).
...
thf(crlimrege0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf)) => ((cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC @ ccrli)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwbr @ ccc0 @ (ccfv @ (XB2 @ Xx3) @ ccre) @ ccle))) => (cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XC @ ccre) @ ccle))))))))))).
