...
thf(acbviuneq12dv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XC)) @ (cwcel @ (XX @ Xy1) @ XA2))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XY @ Xx3) @ XC))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xy1) @ XC) @ (cwceq @ (ccv @ Xx3) @ (XX @ Xy1))) @ (cwceq @ (XB2 @ Xx3) @ (XF @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ (XY @ Xx3))) @ (cwceq @ (XD @ Xy1) @ (XG @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwceq @ (XB2 @ Xx3) @ (XG @ Xx3)))) => ((! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xy1) @ XC)) @ (cwceq @ (XD @ Xy1) @ (XF @ Xy1)))) => (cwi @ Xph @ (cwceq @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciun @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XD @ Xy1))))))))))))))))))))).
...
thf(ctrclfvdecomr_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwceq @ (ccfv @ XR @ cctcl) @ (ccun @ XR @ (cccom @ (ccfv @ XR @ cctcl) @ XR))))))).
