...
thf(albreu_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwa @ (cwss @ XS @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS))) @ (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS))))).
...
thf(clble_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xx3:$i] : (cwi @ (cw3a @ (cwss @ XS @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS)) @ (cwcel @ (XA2 @ Xx3) @ XS)) @ (cwbr @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS)) @ (XA2 @ Xx3) @ ccle)))))).
