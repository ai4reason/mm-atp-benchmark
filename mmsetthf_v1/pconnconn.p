...
thf(aconncn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwi @ Xph @ (cwcel @ XJ @ ccconn)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XU @ XK)) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XK @ cccld))) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XF) @ XU)) => (cwi @ Xph @ (cwf @ XX @ XU @ XF))))))))))))))))).
...
thf(cpconnconn_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ ccpconn) @ (cwcel @ XJ @ ccconn)))).
