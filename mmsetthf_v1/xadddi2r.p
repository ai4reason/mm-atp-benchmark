...
thf(axadddi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwa @ (cwcel @ XB2 @ ccxr) @ (cwbr @ ccc0 @ XB2 @ ccle)) @ (cwa @ (cwcel @ XC @ ccxr) @ (cwbr @ ccc0 @ XC @ ccle))) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxmu) @ (cco @ (cco @ XA2 @ XB2 @ ccxmu) @ (cco @ XA2 @ XC @ ccxmu) @ ccxad))))))).
...
thf(cxadddi2r_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwa @ (cwcel @ XB2 @ ccxr) @ (cwbr @ ccc0 @ XB2 @ ccle)) @ (cwcel @ XC @ ccxr)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxmu) @ (cco @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccxad))))))).
