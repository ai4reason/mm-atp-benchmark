...
thf(aan33rean_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (cwb @ (cw3a @ (cw3a @ Xph @ Xps @ Xch) @ (cw3a @ Xth @ Xta @ Xet) @ (cw3a @ Xze @ Xsi @ Xrh)) @ (cwa @ (cw3a @ Xph @ Xta @ Xrh) @ (cw3a @ (cwa @ Xps @ Xth) @ (cwa @ Xet @ Xsi) @ (cwa @ Xch @ Xze)))))))))))))).
...
thf(ctrgcgrg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccds)) => ((cwceq @ Xc_sm @ (ccfv @ XG @ cccgrg)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwcel @ XE @ XP)) => ((cwi @ Xph @ (cwcel @ XF @ XP)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XD @ XE @ XF) @ Xc_sm) @ (cw3a @ (cwceq @ (cco @ XA2 @ XB2 @ Xc_mi) @ (cco @ XD @ XE @ Xc_mi)) @ (cwceq @ (cco @ XB2 @ XC @ Xc_mi) @ (cco @ XE @ XF @ Xc_mi)) @ (cwceq @ (cco @ XC @ XA2 @ Xc_mi) @ (cco @ XF @ XD @ Xc_mi))))))))))))))))))))))))))).
