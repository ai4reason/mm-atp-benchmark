...
thf(crescco_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XD @ (cco @ XC @ XH @ ccresc)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwfn @ XH @ (ccxp @ XS @ XS))) => ((cwi @ Xph @ (cwss @ XS @ XB2)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => (cwi @ Xph @ (cwceq @ Xc_x @ (ccfv @ XD @ ccco)))))))))))))))))).
