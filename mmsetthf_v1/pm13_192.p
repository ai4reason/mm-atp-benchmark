...
thf(cpm13_192_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [Xx3:$i] : (cwb @ (cwex @ (^ [Xy1:$i] : (cwa @ (cwal @ (^ [Xx3:$i] : (cwb @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (Xph @ Xx3 @ Xy1)))) @ (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ XA2)))))).
