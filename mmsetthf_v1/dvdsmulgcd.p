...
thf(cdvdsmulgcd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwb @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccdvds) @ (cwbr @ XA2 @ (cco @ XB2 @ (cco @ XC @ XA2 @ ccgcd) @ ccmul) @ ccdvds))))))).
