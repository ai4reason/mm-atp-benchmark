...
thf(cmeasiun_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xn) @ XS))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (XB2 @ Xn) @ XS))) => ((! [Xn:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xn) @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XB2 @ Xn)))))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XA2 @ Xn) @ XM) @ (ccesum @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XB2 @ Xn) @ XM))) @ ccle))))))))))))).
