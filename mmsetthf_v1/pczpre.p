...
thf(apceu_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xn) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xn) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XN @ ccq) @ (cwne @ XN @ ccc0))) @ (cweu @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ XN @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv)) @ (cwceq @ (ccv @ Xz) @ (cco @ (XS @ Xx3 @ Xy1 @ Xn) @ (XT @ Xx3 @ Xy1 @ Xn) @ ccmin)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccz))))))))))))).
...
thf(cpczpre_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccsup @ (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwa @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0))) @ (cwceq @ (cco @ XP @ XN @ ccpc) @ (XS @ Xn))))))))).
