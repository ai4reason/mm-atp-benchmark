...
thf(cifeq3da_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ (cwceq @ (ccif @ Xps @ XE @ XF) @ XE) @ (cwceq @ XC @ XG)) => ((cwi @ (cwceq @ (ccif @ Xps @ XE @ XF) @ XF) @ (cwceq @ XC @ XH)) => ((cwi @ Xph @ (cwceq @ XG @ XA2)) => ((cwi @ Xph @ (cwceq @ XH @ XB2)) => (cwi @ Xph @ (cwceq @ (ccif @ Xps @ XA2 @ XB2) @ XC)))))))))))))))).
