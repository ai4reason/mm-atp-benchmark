...
thf(aelicore_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) @ (cwcel @ XC @ ccr)))))).
...
thf(aicogelbd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ ccle)))))))))).
thf(altpnfd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwbr @ XA2 @ ccpnf @ cclt)))))).
thf(aresima2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwss @ XB2 @ XC) @ (cwceq @ (ccima @ (ccres @ XA2 @ XC) @ XB2) @ (ccima @ XA2 @ XB2))))))).
thf(amptima2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XC @ XA2))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccima @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC) @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))))).
...
thf(aicopnfsup_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwne @ XA2 @ ccpnf)) @ (cwceq @ (ccsup @ (cco @ XA2 @ ccpnf @ ccico) @ ccxr @ cclt) @ ccpnf)))).
thf(climinfresico_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((cwceq @ XZ @ (cco @ XM @ ccpnf @ ccico)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ XZ) @ cclsi) @ (ccfv @ XF @ cclsi)))))))))))).
