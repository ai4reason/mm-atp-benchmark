...
thf(cpmtrdifellem3_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XT @ (ccrn @ (ccfv @ (ccdif @ (XN @ Xx3) @ (ccsn @ (XK @ Xx3))) @ ccpmtr)))) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccrn @ (ccfv @ (XN @ Xx3) @ ccpmtr)))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ (XN @ Xx3) @ ccpmtr)))) => (cwi @ (cwcel @ XQ @ XT) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XQ) @ (ccfv @ (ccv @ Xx3) @ (XS @ Xx3)))) @ (^ [Xx3:$i] : (ccdif @ (XN @ Xx3) @ (ccsn @ (XK @ Xx3)))))))))))))))).
