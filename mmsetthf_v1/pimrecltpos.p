...
thf(areclt0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ ccc0 @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ cc1 @ XA2 @ ccdiv) @ ccc0 @ cclt))))))).
...
thf(cpimrecltpos_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwne @ (XB2 @ Xx3) @ ccc0))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ ccrp))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ cc1 @ (XB2 @ Xx3) @ ccdiv) @ (XC @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccun @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ cc1 @ (XC @ Xx3) @ ccdiv) @ (XB2 @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ ccc0 @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
