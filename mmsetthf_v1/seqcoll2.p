...
thf(aseqid2_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwceq @ (cco @ (ccv @ Xx3) @ XZ @ Xc_pl) @ (ccv @ Xx3)))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XK @ ccuz))) => ((cwi @ Xph @ (cwcel @ (ccfv @ XK @ (ccseq @ Xc_pl @ XF @ XM)) @ XS)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XZ))) => (cwi @ Xph @ (cwceq @ (ccfv @ XK @ (ccseq @ Xc_pl @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)))))))))))))))))).
...
thf(cseqcoll2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XS)) @ (cwceq @ (cco @ (XZ @ Xn) @ (ccv @ Xk) @ Xc_pl) @ (ccv @ Xk))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XS)) @ (cwceq @ (cco @ (ccv @ Xk) @ (XZ @ Xn) @ Xc_pl) @ (ccv @ Xk))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xk) @ XS) @ (cwcel @ (ccv @ Xn) @ XS))) @ (cwcel @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ Xc_pl) @ XS)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XZ @ Xn) @ XS))) => ((cwi @ Xph @ (cwiso @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ XA2 @ cclt @ cclt @ XG)) => ((cwi @ Xph @ (cwne @ XA2 @ cc0)) => ((! [Xn:$i] : (cwi @ Xph @ (cwss @ XA2 @ (cco @ XM @ (XN @ Xn) @ ccfz)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XM @ (XN @ Xn) @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XS)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccdif @ (cco @ XM @ (XN @ Xn) @ ccfz) @ XA2))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XZ @ Xn))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (XH @ Xk)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XG) @ XF))))) => (! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XN @ Xn) @ (ccseq @ Xc_pl @ XF @ XM)) @ (ccfv @ (ccfv @ XA2 @ cchash) @ (ccseq @ Xc_pl @ (XH @ Xk) @ cc1))))))))))))))))))))))))))).
