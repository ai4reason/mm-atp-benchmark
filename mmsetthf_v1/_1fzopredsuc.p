...
thf(afzopredsuc_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (cco @ XM @ XN @ ccfz) @ (ccun @ (ccun @ (ccsn @ XM) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfzo)) @ (ccsn @ XN))))))).
...
thf(c_1fzopredsuc_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ ccc0 @ XN @ ccfz) @ (ccun @ (ccun @ (ccsn @ ccc0) @ (cco @ cc1 @ XN @ ccfzo)) @ (ccsn @ XN)))))).
