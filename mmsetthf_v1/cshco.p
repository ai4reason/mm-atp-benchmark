...
thf(acshwrn_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccz)) @ (cwss @ (ccrn @ (cco @ XW @ XN @ cccsh)) @ XV)))))).
...
thf(ccshco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XA2)) @ (cwcel @ XN @ ccz) @ (cwf @ XA2 @ XB2 @ XF)) @ (cwceq @ (cccom @ XF @ (cco @ XW @ XN @ cccsh)) @ (cco @ (cccom @ XF @ XW) @ XN @ cccsh))))))))).
