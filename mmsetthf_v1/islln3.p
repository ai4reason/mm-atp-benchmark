...
thf(aislln4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xp:$i] : (cwceq @ (XB2 @ Xp) @ (ccfv @ XK @ ccbs))) => ((! [Xp:$i] : (cwceq @ (XC @ Xp) @ (ccfv @ XK @ cccvr))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : (cwceq @ (XN @ Xp) @ (ccfv @ XK @ cclln))) => (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XK @ (XD @ Xp)) @ (cwcel @ XX @ (XB2 @ Xp))) @ (cwb @ (cwcel @ XX @ (XN @ Xp)) @ (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XX @ (XC @ Xp))) @ (^ [Xp:$i] : XA2))))))))))))))))).
...
thf(cislln3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (Xc_or @ Xq @ Xp) @ (ccfv @ XK @ ccjn)))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((! [Xq:$i] : (! [Xp:$i] : (cwceq @ (XN @ Xq @ Xp) @ (ccfv @ XK @ cclln)))) => (! [Xq:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwcel @ XX @ (XN @ Xq @ Xp)) @ (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwa @ (cwne @ (ccv @ Xp) @ (ccv @ Xq)) @ (cwceq @ XX @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp))))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))))))))))))).
