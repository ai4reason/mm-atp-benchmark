...
thf(axrtgioo2_thm,axiom,(cwceq @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ (ccfv @ ccle @ ccordt) @ ccr @ ccrest))).
...
thf(cxlimclim_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XA2 @ cclsxlim) @ (cwbr @ XF @ XA2 @ ccli))))))))))))).
