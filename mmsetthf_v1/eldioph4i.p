...
thf(aeldioph4b_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ ccvv) => ((cwn @ (cwcel @ XW @ ccfn)) => ((cwceq @ (ccin @ XW @ ccn) @ cc0) => (cwb @ (cwcel @ XS @ (ccfv @ XN @ ccdioph)) @ (cwa @ (cwcel @ XN @ ccn0) @ (cwrex @ (^ [Xp:$i] : (cwceq @ XS @ (ccrab @ (^ [Xt:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccun @ (ccv @ Xt) @ (ccv @ Xw)) @ (ccv @ Xp)) @ ccc0)) @ (^ [Xw:$i] : (cco @ ccn0 @ XW @ ccmap)))) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))))) @ (^ [Xp:$i] : (ccfv @ (ccun @ XW @ (cco @ cc1 @ XN @ ccfz)) @ ccmzp)))))))))))).
thf(celdioph4i_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ ccvv) => ((cwn @ (cwcel @ XW @ ccfn)) => ((cwceq @ (ccin @ XW @ ccn) @ cc0) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XP @ (ccfv @ (ccun @ XW @ (cco @ cc1 @ XN @ ccfz)) @ ccmzp))) @ (cwcel @ (ccrab @ (^ [Xt:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccfv @ (ccun @ (ccv @ Xt) @ (ccv @ Xw)) @ XP) @ ccc0)) @ (^ [Xw:$i] : (cco @ ccn0 @ XW @ ccmap)))) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))))))).
