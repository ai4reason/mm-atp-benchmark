...
thf(afvn0elsuppb_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ XV) @ (cwcel @ XX @ XB2) @ (cwfn @ XG @ XB2)) @ (cwb @ (cwne @ (ccfv @ XX @ XG) @ cc0) @ (cwcel @ XX @ (cco @ XG @ cc0 @ ccsupp))))))))).
thf(cbrcic_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccfv @ XC @ cciso)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => (cwi @ Xph @ (cwb @ (cwbr @ XX @ XY @ (ccfv @ XC @ cccic)) @ (cwne @ (cco @ XX @ XY @ XI) @ cc0))))))))))))))).
