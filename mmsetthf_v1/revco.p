...
thf(crevco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XA2)) @ (cwf @ XA2 @ XB2 @ XF)) @ (cwceq @ (cccom @ XF @ (ccfv @ XW @ ccreverse)) @ (ccfv @ (cccom @ XF @ XW) @ ccreverse)))))))).
