...
thf(adf_oppg_ax,axiom,(cwceq @ ccoppg @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (cctpos @ (ccfv @ (ccv @ Xw) @ ccplusg))) @ ccsts))))).
...
thf(coppgval_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppg)) => (cwceq @ XO @ (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (cctpos @ Xc_pl)) @ ccsts)))))))).
