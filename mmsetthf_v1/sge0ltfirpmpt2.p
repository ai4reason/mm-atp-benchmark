...
thf(asge0ltfirp_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwcel @ XY @ ccrp)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ XF @ ccsumge0) @ (cco @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ XY @ ccaddc) @ cclt)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
