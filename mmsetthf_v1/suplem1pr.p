...
thf(altprord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccltp) @ (cwpss @ XA2 @ XB2)))))).
...
thf(aprnmax_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccltq)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(aelnp_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccnp) @ (cwa @ (cwa @ (cwpss @ cc0 @ XA2) @ (cwpss @ XA2 @ ccnq)) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltq) @ (cwcel @ (ccv @ Xy1) @ XA2)))) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)))))).
thf(csuplem1pr_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnp))) @ (cwcel @ (ccuni @ XA2) @ ccnp)))).
