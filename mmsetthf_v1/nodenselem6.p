...
thf(cnodenselem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur)) @ (cwa @ (cwceq @ (ccfv @ XA2 @ ccbday) @ (ccfv @ XB2 @ ccbday)) @ (cwbr @ XA2 @ XB2 @ ccslt))) @ (cwcel @ (ccres @ XA2 @ (ccint @ (ccrab @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XA2) @ (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0)))) @ ccsur))))).
