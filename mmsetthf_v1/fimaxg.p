...
thf(afimax2g_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(apm4_64_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwi @ (cwn @ Xph) @ Xps) @ (cwo @ Xph @ Xps))))).
...
thf(cfimaxg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
