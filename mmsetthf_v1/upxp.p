...
thf(cupxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xh:$i] : (cwceq @ (XP @ Xh) @ (ccres @ cc1st @ (ccxp @ XB2 @ XC)))) => ((! [Xh:$i] : (cwceq @ (XQ @ Xh) @ (ccres @ cc2nd @ (ccxp @ XB2 @ XC)))) => (cwi @ (cw3a @ (cwcel @ XA2 @ XD) @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ XA2 @ XC @ XG)) @ (cweu @ (^ [Xh:$i] : (cw3a @ (cwf @ XA2 @ (ccxp @ XB2 @ XC) @ (ccv @ Xh)) @ (cwceq @ XF @ (cccom @ (XP @ Xh) @ (ccv @ Xh))) @ (cwceq @ XG @ (cccom @ (XQ @ Xh) @ (ccv @ Xh)))))))))))))))))).
