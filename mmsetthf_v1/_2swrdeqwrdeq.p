...
thf(afzosplit_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwcel @ XD @ (cco @ XB2 @ XC @ ccfz)) @ (cwceq @ (cco @ XB2 @ XC @ ccfzo) @ (ccun @ (cco @ XB2 @ XD @ ccfzo) @ (cco @ XD @ XC @ ccfzo)))))))).
...
thf(aelfzo0le_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)) @ (cwbr @ XA2 @ XB2 @ ccle))))).
...
thf(aswrdspsleq_thm,axiom,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV))) @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwa @ (cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle) @ (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) @ (cwb @ (cwceq @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) @ (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr)) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (ccv @ Xi) @ XU))) @ (^ [Xi:$i] : (cco @ XM @ XN @ ccfzo))))))))))).
