...
thf(coddprmdvds_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccn) @ (cwn @ (cwrex @ (^ [Xn:$i] : (cwceq @ XK @ (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))) @ (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XK @ ccdvds)) @ (^ [Xp:$i] : (ccdif @ ccprime @ (ccsn @ cc2))))))).
