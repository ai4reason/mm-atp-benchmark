...
thf(ahilid_thm,axiom,(cwceq @ (ccfv @ ccva @ ccgi) @ cc0v)).
...
thf(anvinvfval_thm,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XN @ (cccom @ XS @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ (ccneg @ cc1)) @ ccvv))))) => (cwi @ (cwcel @ XU @ ccnv) @ (cwceq @ XN @ (ccfv @ XG @ ccgn))))))))))).
...
thf(acurry1val_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XC) @ ccvv))))) => (cwi @ (cwa @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwcel @ XC @ XA2)) @ (cwceq @ (ccfv @ XD @ XG) @ (cco @ XC @ XD @ XF))))))))))).
...
thf(chhssabloilem_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) => (cw3a @ (cwcel @ ccva @ ccgr) @ (cwcel @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ ccgr) @ (cwss @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ ccva))))).
