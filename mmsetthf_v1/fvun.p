...
thf(cfvun_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwfun @ XF) @ (cwfun @ XG)) @ (cwceq @ (ccin @ (ccdm @ XF) @ (ccdm @ XG)) @ cc0)) @ (cwceq @ (ccfv @ XA2 @ (ccun @ XF @ XG)) @ (ccun @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG)))))))).
