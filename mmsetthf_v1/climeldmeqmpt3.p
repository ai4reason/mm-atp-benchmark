...
thf(cclimeldmeqmpt3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XC @ (XW @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ XZ @ XA2))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ XZ @ XC))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XB2 @ Xk) @ XU))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (XB2 @ Xk) @ (XD @ Xk)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwb @ (cwcel @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccdm @ ccli)) @ (cwcel @ (ccmpt @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (XD @ Xk))) @ (ccdm @ ccli))))))))))))))))))))))))).
