...
thf(aiunhoiioolem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XX @ Xn) @ ccfn)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk) @ (cwne @ (XX @ Xn) @ cc0)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (XX @ Xn))) @ (cwcel @ (XA2 @ Xk @ Xn) @ ccr)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ (XX @ Xn))) @ (cwcel @ (XB2 @ Xk @ Xn) @ ccxr)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (ccixp @ (^ [Xk:$i] : (XX @ Xn)) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk @ Xn) @ (XB2 @ Xk @ Xn) @ ccioo))))))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XC @ Xk) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : (XX @ Xn)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (XA2 @ Xk @ Xn) @ ccmin)))) @ ccr @ cclt)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XF @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccixp @ (^ [Xk:$i] : (XX @ Xn)) @ (^ [Xk:$i] : (cco @ (cco @ (XA2 @ Xk @ Xn) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ (XB2 @ Xk @ Xn) @ ccico)))))))))))))))))))))).
