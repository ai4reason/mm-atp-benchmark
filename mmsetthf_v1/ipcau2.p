...
thf(atchclm_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwi @ Xph @ (cwcel @ XW @ ccphl)) => ((cwi @ Xph @ (cwceq @ XF @ (cco @ cccnfld @ XK @ ccress))) => (cwi @ Xph @ (cwcel @ XW @ ccclm)))))))))))))).
...
thf(atchcphlem3_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwi @ Xph @ (cwcel @ XW @ ccphl)) => ((cwi @ Xph @ (cwceq @ XF @ (cco @ cccnfld @ XK @ ccress))) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ XV)) @ (cwcel @ (cco @ XX @ XX @ Xc_xi) @ ccr))))))))))))))))).
...
thf(acjcjd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cccj) @ cccj) @ XA2)))))).
...
thf(acphreccllem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwi @ Xph @ (cwceq @ XF @ (cco @ cccnfld @ XA2 @ ccress))) => ((cwi @ Xph @ (cwcel @ XF @ ccdr)) => (cwi @ (cw3a @ Xph @ (cwcel @ XX @ XK) @ (cwne @ XX @ ccc0)) @ (cwcel @ (cco @ cc1 @ XX @ ccdiv) @ XK))))))))))).
...
thf(aclmmcl_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ ccclm) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XK)) @ (cwcel @ (cco @ XX @ XY @ ccmul) @ XK)))))))))).
...
thf(aip2subdi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwceq @ XS @ (ccfv @ XF @ ccsg)) => ((cwceq @ Xc_pl @ (ccfv @ XF @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XW @ ccphl)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwcel @ XD @ XV)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ Xc_mi) @ (cco @ XC @ XD @ Xc_mi) @ Xc_xi) @ (cco @ (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XD @ Xc_xi) @ Xc_pl) @ (cco @ (cco @ XA2 @ XD @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ Xc_pl) @ XS))))))))))))))))))))))))))).
...
thf(atchnmval_thm,axiom,(! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => (cwi @ (cwa @ (cwcel @ XW @ ccgrp) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ XX @ XN) @ (ccfv @ (cco @ XX @ XX @ Xc_xi) @ ccsqrt)))))))))))))).
