...
thf(celkgen_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XJ @ cckgen)) @ (cwa @ (cwss @ XA2 @ XX) @ (cwral @ (^ [Xk:$i] : (cwi @ (cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp) @ (cwcel @ (ccin @ XA2 @ (ccv @ Xk)) @ (cco @ XJ @ (ccv @ Xk) @ ccrest)))) @ (^ [Xk:$i] : (ccpw @ XX)))))))))).
