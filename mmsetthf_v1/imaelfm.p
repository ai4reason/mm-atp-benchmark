...
thf(cimaelfm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XL @ (cco @ XY @ XB2 @ ccfg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwf @ XY @ XX @ XF)) @ (cwcel @ XS @ XL)) @ (cwcel @ (ccima @ XF @ XS) @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))))))))))))).
