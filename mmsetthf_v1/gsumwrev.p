...
thf(cgsumwrev_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XO @ (ccfv @ XM @ ccoppg)) => (cwi @ (cwa @ (cwcel @ XM @ ccmnd) @ (cwcel @ XW @ (ccword @ XB2))) @ (cwceq @ (cco @ XO @ XW @ ccgsu) @ (cco @ XM @ (ccfv @ XW @ ccreverse) @ ccgsu)))))))))).
