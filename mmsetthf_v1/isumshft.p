...
thf(cisumshft_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XZ @ Xj) @ (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ XW @ (ccfv @ (cco @ (XM @ Xj @ Xk) @ XK @ ccaddc) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ XK @ (ccv @ Xk) @ ccaddc)) @ (cwceq @ (XA2 @ Xj) @ (XB2 @ Xk))))) => ((cwi @ Xph @ (cwcel @ XK @ ccz)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XW)) @ (cwcel @ (XA2 @ Xj) @ ccc))) => (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (ccsu @ XW @ (^ [Xj:$i] : (XA2 @ Xj))) @ (ccsu @ (XZ @ Xj) @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))))))))))).
