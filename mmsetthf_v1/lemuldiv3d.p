...
thf(clemuldiv3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwbr @ (cco @ XB2 @ XA2 @ ccmul) @ XC @ ccle)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => (cwi @ Xph @ (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccdiv) @ ccle)))))))))))).
