...
thf(afcfval_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwceq @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)) @ (cco @ XJ @ (ccfv @ XL @ (cco @ XX @ XF @ ccfm)) @ ccfcls))))))))).
...
thf(aimaelfm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XL @ (cco @ XY @ XB2 @ ccfg)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwf @ XY @ XX @ XF)) @ (cwcel @ XS @ XL)) @ (cwcel @ (ccima @ XF @ XS) @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))))))))))))).
...
thf(cisfcf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwb @ (cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf))) @ (cwa @ (cwcel @ (XA2 @ Xs1) @ XX) @ (cwral @ (^ [Xo:$i] : (cwi @ (cwcel @ (XA2 @ Xs1) @ (ccv @ Xo)) @ (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xo) @ (ccima @ XF @ (ccv @ Xs1))) @ cc0)) @ (^ [Xs1:$i] : XL)))) @ (^ [Xo:$i] : XJ))))))))))))).
