...
thf(acscval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ cccsc) @ (cco @ cc1 @ (ccfv @ XA2 @ ccsin) @ ccdiv))))).
...
thf(crecsccl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) @ (cwcel @ (ccfv @ XA2 @ cccsc) @ ccr)))).
