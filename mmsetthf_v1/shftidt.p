...
thf(ashftidt2_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwceq @ (cco @ XF @ ccc0 @ ccshi) @ (ccres @ XF @ ccc))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afvres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ (ccres @ XF @ XB2)) @ (ccfv @ XA2 @ XF))))))).
thf(cshftidt_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ (cco @ XF @ ccc0 @ ccshi)) @ (ccfv @ XA2 @ XF))))))).
