...
thf(cgrpoidinvlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccgr) @ (cwa @ (cwcel @ XY @ XX) @ (cwcel @ XA2 @ XX))) @ (cwa @ (cwceq @ (cco @ XY @ XA2 @ XG) @ XU) @ (cwceq @ (cco @ XA2 @ XA2 @ XG) @ XA2))) @ (cwceq @ (cco @ XU @ XA2 @ XG) @ XU))))))))).
