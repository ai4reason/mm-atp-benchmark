...
thf(cfsneq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwceq @ XB2 @ (ccsn @ XA2)) => ((cwi @ Xph @ (cwfn @ XF @ XB2)) => ((cwi @ Xph @ (cwfn @ XG @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XF @ XG) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG))))))))))))))).
