...
thf(aafv0nbfvbi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwnel @ cc0 @ XB2) @ (cwb @ (cwcel @ (ccafv @ XA2 @ XF) @ XB2) @ (cwcel @ (ccfv @ XA2 @ XF) @ XB2))))))).
...
thf(caov0nbovbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwnel @ cc0 @ XC) @ (cwb @ (cwcel @ (ccaov @ XA2 @ XB2 @ XF) @ XC) @ (cwcel @ (cco @ XA2 @ XB2 @ XF) @ XC)))))))).
