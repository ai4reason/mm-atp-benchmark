...
thf(chmeoco_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) @ (cwcel @ XG @ (cco @ XK @ XL @ cchmeo))) @ (cwcel @ (cccom @ XG @ XF) @ (cco @ XJ @ XL @ cchmeo))))))))).
