...
thf(crectan_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) @ (cwceq @ (ccfv @ XA2 @ cccot) @ (cco @ cc1 @ (ccfv @ XA2 @ cctan) @ ccdiv))))).
