...
thf(cnmoco_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XU @ ccnmo)) => ((cwceq @ XL @ (cco @ XT @ XU @ ccnmo)) => ((cwceq @ XM @ (cco @ XS @ XT @ ccnmo)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XT @ XU @ ccnghm)) @ (cwcel @ XG @ (cco @ XS @ XT @ ccnghm))) @ (cwbr @ (ccfv @ (cccom @ XF @ XG) @ XN) @ (cco @ (ccfv @ XF @ XL) @ (ccfv @ XG @ XM) @ ccmul) @ ccle)))))))))))))).
