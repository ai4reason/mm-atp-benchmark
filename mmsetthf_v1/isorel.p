...
thf(cisorel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwa @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XH) @ (cwa @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XA2))) @ (cwb @ (cwbr @ XC @ XD @ XR) @ (cwbr @ (ccfv @ XC @ XH) @ (ccfv @ XD @ XH) @ XS))))))))))).
