...
thf(aisfiniteg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ ccom @ ccvv) @ (cwb @ (cwcel @ XA2 @ ccfn) @ (cwbr @ XA2 @ ccom @ ccsdm))))).
...
thf(adifabs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccdif @ (ccdif @ XA2 @ XB2) @ XB2) @ (ccdif @ XA2 @ XB2))))).
...
thf(caxcclem_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xg1:$i] : (cwceq @ (XA2 @ Xx3 @ Xg1) @ (ccdif @ (ccv @ Xx3) @ (ccsn @ cc0))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xw @ Xf1 @ Xg1 @ Xn) @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xy1:$i] : ccom)) @ (^ [Xn:$i] : (^ [Xy1:$i] : (ccuni @ (XA2 @ Xx3 @ Xg1)))) @ (^ [Xn:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xw @ Xf1 @ Xh @ Xn) @ (ccmpt @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xg1)) @ (^ [Xw:$i] : (ccfv @ (ccsuc @ (ccfv @ (ccv @ Xw) @ (cccnv @ (ccv @ Xf1)))) @ (ccv @ Xh)))))))))))) => (! [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ ccom @ ccen) @ (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwne @ (ccv @ Xz) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3)))))))))))))).
