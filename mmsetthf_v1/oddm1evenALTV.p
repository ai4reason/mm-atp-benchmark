...
thf(aisodd2_thm,axiom,(! [XZ:($i > $o)] : (cwb @ (cwcel @ XZ @ ccodd) @ (cwa @ (cwcel @ XZ @ ccz) @ (cwcel @ (cco @ (cco @ XZ @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccz))))).
...
thf(coddm1evenALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwcel @ XN @ ccodd) @ (cwcel @ (cco @ XN @ cc1 @ ccmin) @ cceven))))).
