...
thf(afaclbnd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) @ (cwbr @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ (cco @ (cco @ XM @ XM @ ccexp) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
...
thf(cfaclbnd2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwbr @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc2 @ ccdiv) @ (ccfv @ XN @ ccfa) @ ccle)))).
