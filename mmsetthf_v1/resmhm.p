...
thf(cresmhm_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XS @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) @ (cwcel @ XX @ (ccfv @ XS @ ccsubmnd))) @ (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccmhm)))))))))).
