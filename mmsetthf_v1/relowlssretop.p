...
thf(aicoreelrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > ($i > $o))] : ((! [Xz:$i] : (cwceq @ (XI @ Xz) @ (ccima @ ccico @ (ccxp @ ccr @ ccr)))) => (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwcel @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xz) @ ccle) @ (cwbr @ (ccv @ Xz) @ XB2 @ cclt))) @ (^ [Xz:$i] : ccr)) @ (XI @ Xz))))))))).
...
thf(aicoreval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccico) @ (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xz) @ ccle) @ (cwbr @ (ccv @ Xz) @ XB2 @ cclt))) @ (^ [Xz:$i] : ccr))))))).
...
thf(aicoreunrn_thm,axiom,(! [XI:($i > $o)] : ((cwceq @ XI @ (ccima @ ccico @ (ccxp @ ccr @ ccr))) => (cwceq @ ccr @ (ccuni @ XI))))).
thf(atgss2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ XB2 @ (XV @ Xz)) @ (cwceq @ (ccuni @ XB2) @ (ccuni @ XC))) @ (cwb @ (cwss @ (ccfv @ XB2 @ cctg) @ (ccfv @ XC @ cctg)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : XC)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (ccuni @ XB2)))))))))).
...
thf(crelowlssretop_conj,conjecture,(! [XI:($i > $o)] : ((cwceq @ XI @ (ccima @ ccico @ (ccxp @ ccr @ ccr))) => (cwss @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (ccfv @ XI @ cctg))))).
