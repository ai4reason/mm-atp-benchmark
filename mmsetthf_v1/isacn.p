...
thf(adf_acn_ax,axiom,(! [XA2:($i > $o)] : (cwceq @ (cwacn @ XA2) @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwcel @ XA2 @ ccvv) @ (cwral @ (^ [Xf1:$i] : (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : XA2))))) @ (^ [Xf1:$i] : (cco @ (ccdif @ (ccpw @ (ccv @ Xx3)) @ (ccsn @ cc0)) @ XA2 @ ccmap))))))))).
...
thf(cisacn_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xx3 @ Xf1 @ Xg1)) @ (cwcel @ XA2 @ (XW @ Xx3 @ Xf1 @ Xg1))) @ (cwb @ (cwcel @ XX @ (cwacn @ XA2)) @ (cwral @ (^ [Xf1:$i] : (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : XA2))))) @ (^ [Xf1:$i] : (cco @ (ccdif @ (ccpw @ XX) @ (ccsn @ cc0)) @ XA2 @ ccmap))))))))))))).
