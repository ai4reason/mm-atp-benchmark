...
thf(csuppeqfsuppbi_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XF @ XU) @ (cwfun @ XF)) @ (cwa @ (cwcel @ XG @ XV) @ (cwfun @ XG))) @ (cwi @ (cwceq @ (cco @ XF @ XZ @ ccsupp) @ (cco @ XG @ XZ @ ccsupp)) @ (cwb @ (cwbr @ XF @ XZ @ ccfsupp) @ (cwbr @ XG @ XZ @ ccfsupp)))))))))).
