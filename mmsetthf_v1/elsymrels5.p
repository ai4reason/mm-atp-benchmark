...
thf(adfsymrels5_thm,axiom,(cwceq @ ccsymrels @ (ccrab @ (^ [Xr:$i] : (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwb @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xr)))))))) @ (^ [Xr:$i] : ccrels)))).
...
thf(celsymrels5_conj,conjecture,(! [XR:($i > $o)] : (cwb @ (cwcel @ XR @ ccsymrels) @ (cwa @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwb @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)))))) @ (cwcel @ XR @ ccrels))))).
