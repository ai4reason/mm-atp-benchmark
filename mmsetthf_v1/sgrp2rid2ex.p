...
thf(csgrp2rid2ex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [Xc_op:($i > $o)] : ((cwceq @ XS @ (ccpr @ XA2 @ XB2)) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (ccfv @ (XM @ Xy1 @ Xz) @ ccbs) @ XS))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (ccfv @ (XM @ Xy1 @ Xz) @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ XA2 @ XB2))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwceq @ Xc_op @ (ccfv @ (XM @ Xy1 @ Xz) @ ccplusg)))) => (cwi @ (cwceq @ (ccfv @ XS @ cchash) @ cc2) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xy1:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_op) @ (ccv @ Xy1)) @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_op) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS))) @ (^ [Xz:$i] : XS))) @ (^ [Xx3:$i] : XS))))))))))))).
