...
thf(ccnlimc_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwss @ XA2 @ ccc) @ (cwb @ (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf)) @ (cwa @ (cwf @ XA2 @ ccc @ XF) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ XF @ (ccv @ Xx3) @ cclimc))) @ (^ [Xx3:$i] : XA2)))))))).
