...
thf(aefchpcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ ccchp) @ cce) @ ccn)))).
...
thf(cchpge0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccchp) @ ccle)))).
