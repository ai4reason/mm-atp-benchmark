...
thf(aopwo0id_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwceq @ (ccop @ XX @ XY) @ (ccdif @ (ccop @ XX @ XY) @ (ccsn @ cc0)))))).
...
thf(afunopdmsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (ccop @ XX @ XY)) => ((cwcel @ XX @ XV) => ((cwcel @ XY @ XW) => (cwi @ (cw3a @ (cwfun @ XG) @ (cwcel @ XA2 @ (ccdm @ XG)) @ (cwcel @ XB2 @ (ccdm @ XG))) @ (cwceq @ XA2 @ XB2))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(aprcnel_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwn @ (cwcel @ XA2 @ XV)))))).
thf(cfundmge2nop0_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwa @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) @ (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) @ (cwn @ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)))))).
