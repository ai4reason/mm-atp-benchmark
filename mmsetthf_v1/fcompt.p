...
thf(cfcompt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cwa @ (cwf @ XD @ XE @ XA2) @ (cwf @ XC @ XD @ XB2)) @ (cwceq @ (cccom @ XA2 @ XB2) @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XB2) @ XA2))))))))))).
