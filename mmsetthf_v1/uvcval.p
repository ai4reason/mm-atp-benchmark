...
thf(cuvcval_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XU @ Xk) @ (cco @ XR @ XI @ ccuvc))) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XR @ (XV @ Xk)) @ (cwcel @ XI @ (XW @ Xk)) @ (cwcel @ XJ @ XI)) @ (cwceq @ (ccfv @ XJ @ (XU @ Xk)) @ (ccmpt @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ XJ) @ Xc_1 @ Xc_0)))))))))))))))))).
