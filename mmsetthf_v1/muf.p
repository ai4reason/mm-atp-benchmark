...
thf(adf_mu_ax,axiom,(cwceq @ ccmu @ (ccmpt @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccif @ (cwrex @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ cc2 @ ccexp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccc0 @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ cchash) @ ccexp)))))).
...
thf(aprmdvdsfi_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwcel @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccfn)))).
