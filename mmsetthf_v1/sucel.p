...
thf(csucel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : (cwb @ (cwcel @ (ccsuc @ XA2) @ (XB2 @ Xy1)) @ (cwrex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwb @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwo @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XA2)))))) @ (^ [Xx3:$i] : (XB2 @ Xy1)))))))).
