...
thf(afo1stres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwne @ XB2 @ cc0) @ (cwfo @ (ccxp @ XA2 @ XB2) @ XA2 @ (ccres @ cc1st @ (ccxp @ XA2 @ XB2))))))).
...
thf(asylanr2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ Xth) => ((cwi @ (cwa @ Xps @ (cwa @ Xch @ Xth)) @ Xta) => (cwi @ (cwa @ Xps @ (cwa @ Xch @ Xph)) @ Xta))))))))).
...
thf(c_1stconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwf1o @ (ccxp @ XA2 @ (ccsn @ XB2)) @ XA2 @ (ccres @ cc1st @ (ccxp @ XA2 @ (ccsn @ XB2))))))))).
