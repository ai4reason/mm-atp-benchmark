...
thf(cesumcocn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwceq @ (XJ @ Xx3 @ Xy1 @ Xk) @ (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xx3 @ Xy1))) @ (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XC @ (cco @ (XJ @ Xx3 @ Xy1 @ Xk) @ (XJ @ Xx3 @ Xy1 @ Xk) @ cccn)))))) => ((cwi @ Xph @ (cwceq @ (ccfv @ ccc0 @ XC) @ ccc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccicc))) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccxad) @ XC) @ (cco @ (ccfv @ (ccv @ Xx3) @ XC) @ (ccfv @ (ccv @ Xy1) @ XC) @ ccxad))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xy1 @ Xk))) @ XC) @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xx3 @ Xy1 @ Xk) @ XC)))))))))))))))))))).
