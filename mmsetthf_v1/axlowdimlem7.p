...
thf(caxlowdimlem7_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XP @ (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => (cwi @ (cwcel @ XN @ (ccfv @ cc3 @ ccuz)) @ (cwcel @ XP @ (ccfv @ XN @ ccee))))))).
