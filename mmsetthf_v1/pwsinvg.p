...
thf(cpwsinvg_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccpws)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XM @ (ccfv @ XR @ ccminusg)) => ((cwceq @ XN @ (ccfv @ XY @ ccminusg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccgrp) @ (cwcel @ XI @ XV) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ XX @ XN) @ (cccom @ XM @ XX)))))))))))))))).
