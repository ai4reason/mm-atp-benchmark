...
thf(ahhshsslem2_thm,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XW @ (ccfv @ XU @ ccss)) => ((cwss @ XH @ cchil) => (cwcel @ XH @ ccsh))))))))).
...
thf(asspid_thm,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccfv @ XU @ ccss)) => (cwi @ (cwcel @ XU @ ccnv) @ (cwcel @ XU @ XH)))))).
thf(assid_thm,axiom,(! [XA2:($i > $o)] : (cwss @ XA2 @ XA2))).
thf(asimpri_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwa @ Xph @ Xps) => Xps)))).
thf(chhsssh_conj,conjecture,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwceq @ XW @ (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => (cwb @ (cwcel @ XH @ ccsh) @ (cwa @ (cwcel @ XW @ (ccfv @ XU @ ccss)) @ (cwss @ XH @ cchil))))))))).
