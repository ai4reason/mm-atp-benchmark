...
thf(aafv0fv0_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ (ccafv @ XA2 @ XF) @ cc0) @ (cwceq @ (ccfv @ XA2 @ XF) @ cc0))))).
...
thf(caov0ov0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ (ccaov @ XA2 @ XB2 @ XF) @ cc0) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ cc0)))))).
