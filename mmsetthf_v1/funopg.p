...
thf(arelop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwrel @ (ccop @ XA2 @ XB2)) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ XA2 @ (ccsn @ (ccv @ Xx3))) @ (cwceq @ XB2 @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))))))))))).
...
thf(cfunopg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwfun @ (ccop @ XA2 @ XB2))) @ (cwceq @ XA2 @ XB2))))))).
