...
thf(cordtopn1_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XP @ XX)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ XP @ XR))) @ (^ [Xx3:$i] : XX)) @ (ccfv @ XR @ ccordt))))))))).
