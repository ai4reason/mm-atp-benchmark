...
thf(cfnhomeqhomf_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ cchomf)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => (cwi @ (cwfn @ XH @ (ccxp @ XB2 @ XB2)) @ (cwceq @ XF @ XH)))))))))).
