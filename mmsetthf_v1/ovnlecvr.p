...
thf(ahoissrrn_thm,axiom,(! [Xph:$o] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwf @ XX @ (ccxp @ ccr @ ccr) @ (XI @ Xk)))) => (cwi @ Xph @ (cwss @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))))) @ (cco @ ccr @ XX @ ccmap)))))))).
