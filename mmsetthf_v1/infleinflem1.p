...
thf(axaddass2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwne @ XA2 @ ccpnf)) @ (cwa @ (cwcel @ XB2 @ ccxr) @ (cwne @ XB2 @ ccpnf)) @ (cwa @ (cwcel @ XC @ ccxr) @ (cwne @ XC @ ccpnf))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxad) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxad))))))).
...
thf(cinfleinflem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwss @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XW @ ccrp)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwbr @ XX @ (cco @ (ccinf @ XB2 @ ccxr @ cclt) @ (cco @ XW @ cc2 @ ccdiv) @ ccxad) @ ccle)) => ((cwi @ Xph @ (cwcel @ XZ @ XA2)) => ((cwi @ Xph @ (cwbr @ XZ @ (cco @ XX @ (cco @ XW @ cc2 @ ccdiv) @ ccxad) @ ccle)) => (cwi @ Xph @ (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ (cco @ (ccinf @ XB2 @ ccxr @ cclt) @ XW @ ccxad) @ ccle)))))))))))))))).
