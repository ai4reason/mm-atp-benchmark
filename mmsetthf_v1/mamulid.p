...
thf(cmamulid_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xi @ Xj) @ ccrg)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ Xc_1 @ (ccfv @ (XR @ Xi @ Xj) @ ccur)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwceq @ (ccv @ Xi) @ (ccv @ Xj)) @ Xc_1 @ Xc_0))))))) => ((cwi @ Xph @ (cwcel @ XM @ ccfn)) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xi @ Xj) @ ccfn)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XF @ Xi @ Xj) @ (cco @ (XR @ Xi @ Xj) @ (ccotp @ XM @ XM @ (XN @ Xi @ Xj)) @ ccmmul)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xi @ Xj) @ (cco @ XB2 @ (ccxp @ XM @ (XN @ Xi @ Xj)) @ ccmap))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XI @ Xi @ Xj) @ (XX @ Xi @ Xj) @ (XF @ Xi @ Xj)) @ (XX @ Xi @ Xj))))))))))))))))))))))))).
