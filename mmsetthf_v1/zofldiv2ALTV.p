...
thf(aflbi2_thm,axiom,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XF @ ccr)) @ (cwb @ (cwceq @ (ccfv @ (cco @ XN @ XF @ ccaddc) @ ccfl) @ XN) @ (cwa @ (cwbr @ ccc0 @ XF @ ccle) @ (cwbr @ XF @ cc1 @ cclt))))))).
thf(czofldiv2ALTV_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccodd) @ (cwceq @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv))))).
