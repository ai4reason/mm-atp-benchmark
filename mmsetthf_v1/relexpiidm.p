...
thf(arelexpsucrd_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwrel @ XR)) => ((cwi @ Xph @ (cwcel @ XR @ ccvv)) => (cwi @ Xph @ (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) @ (cccom @ (cco @ XR @ XN @ ccrelexp) @ XR)))))))))).
...
thf(crelexpiidm_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ (ccres @ ccid @ XA2) @ XN @ ccrelexp) @ (ccres @ ccid @ XA2))))))).
