...
thf(cmodaddmodlo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccn)) @ (cwi @ (cwcel @ XB2 @ (cco @ ccc0 @ (cco @ XM @ (cco @ XA2 @ XM @ ccmo) @ ccmin) @ ccfzo)) @ (cwceq @ (cco @ XB2 @ (cco @ XA2 @ XM @ ccmo) @ ccaddc) @ (cco @ (cco @ XB2 @ XA2 @ ccaddc) @ XM @ ccmo)))))))).
