...
thf(asqrt9_thm,axiom,(cwceq @ (ccfv @ cc9 @ ccsqrt) @ cc3)).
...
thf(appi1_thm,axiom,(cwceq @ (ccfv @ cc1 @ ccppi) @ ccc0)).
...
thf(a_1nprm_thm,axiom,(cwn @ (cwcel @ cc1 @ ccprime))).
...
thf(appiprm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccppi) @ (cco @ (ccfv @ XA2 @ ccppi) @ cc1 @ ccaddc))))).
...
thf(appinprm_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwn @ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime))) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccppi) @ (ccfv @ XA2 @ ccppi))))).
...
thf(appiub_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccr) @ (cwbr @ ccc0 @ XN @ ccle)) @ (cwbr @ (ccfv @ XN @ ccppi) @ (cco @ (cco @ XN @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ ccle)))).
