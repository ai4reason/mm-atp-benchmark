...
thf(awloglei_thm,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwceq @ (ccv @ Xw) @ (ccv @ Xy1))) @ (cwb @ (Xps @ Xz @ Xw) @ (Xch @ Xx3 @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwceq @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwceq @ (ccv @ Xw) @ (ccv @ Xx3))) @ (cwb @ (Xps @ Xz @ Xw) @ (Xth @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((cwi @ Xph @ (cwss @ XS @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) @ (Xth @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) @ (Xch @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (Xch @ Xx3 @ Xy1))))))))))))))).
...
thf(areconn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ ccr) @ (cwb @ (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(cresconn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest)) => (cwi @ (cwss @ XA2 @ ccr) @ (cwb @ (cwcel @ XJ @ ccsconn) @ (cwcel @ XJ @ ccconn))))))).
