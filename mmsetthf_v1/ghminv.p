...
thf(cghminv_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XM @ (ccfv @ XS @ ccminusg)) => ((cwceq @ XN @ (ccfv @ XT @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XX @ XB2)) @ (cwceq @ (ccfv @ (ccfv @ XX @ XM) @ XF) @ (ccfv @ (ccfv @ XX @ XF) @ XN)))))))))))))).
