...
thf(ccurry2f_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cccom @ XF @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ (ccsn @ XC)))))) => (cwi @ (cwa @ (cwf @ (ccxp @ XA2 @ XB2) @ XD @ XF) @ (cwcel @ XC @ XB2)) @ (cwf @ XA2 @ XD @ XG)))))))))).
