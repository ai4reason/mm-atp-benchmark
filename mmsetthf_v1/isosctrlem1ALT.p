...
thf(aeel12131_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwi @ Xph @ Xps) => ((cwi @ (cwa @ Xph @ Xch) @ Xth) => ((cwi @ (cwa @ Xph @ Xta) @ Xet) => ((cwi @ (cw3a @ Xps @ Xth @ Xet) @ Xze) => (cwi @ (cw3a @ Xph @ Xch @ Xta) @ Xze))))))))))))).
...
thf(a_3impcombi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ (cw3a @ Xph @ Xps @ Xph) @ (cwb @ Xch @ Xth)) => (cwi @ (cw3a @ Xps @ Xph @ Xch) @ Xth))))))).
...
thf(cisosctrlem1ALT_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccabs) @ cc1) @ (cwn @ (cwceq @ cc1 @ XA2))) @ (cwne @ (ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) @ ccpi)))).
