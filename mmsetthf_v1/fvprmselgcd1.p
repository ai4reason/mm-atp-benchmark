...
thf(cfvprmselgcd1_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xm:$i] : (cwceq @ (XF @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccif @ (cwcel @ (ccv @ Xm) @ ccprime) @ (ccv @ Xm) @ cc1))))) => (! [Xm:$i] : (cwi @ (cw3a @ (cwcel @ XX @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ XY @ (cco @ cc1 @ XN @ ccfz)) @ (cwne @ XX @ XY)) @ (cwceq @ (cco @ (ccfv @ XX @ (XF @ Xm)) @ (ccfv @ XY @ (XF @ Xm)) @ ccgcd) @ cc1))))))))).
