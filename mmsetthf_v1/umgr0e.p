...
thf(af10d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XF @ cc0)) => (cwi @ Xph @ (cwf1 @ (ccdm @ XF) @ XA2 @ XF))))))).
...
thf(cumgr0e_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XG @ XW)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ cc0)) => (cwi @ Xph @ (cwcel @ XG @ ccumgr)))))))).
