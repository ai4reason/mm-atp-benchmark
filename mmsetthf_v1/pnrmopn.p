...
thf(apnrmtop_thm,axiom,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ ccpnrm) @ (cwcel @ XJ @ cctop)))).
...
thf(apnrmcld_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccpnrm) @ (cwcel @ XA2 @ (ccfv @ XJ @ cccld))) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XA2 @ (ccint @ (ccrn @ (ccv @ Xf1))))) @ (^ [Xf1:$i] : (cco @ XJ @ ccn @ ccmap))))))).
...
thf(cpnrmopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ ccpnrm) @ (cwcel @ XA2 @ XJ)) @ (cwrex @ (^ [Xf1:$i] : (cwceq @ XA2 @ (ccuni @ (ccrn @ (ccv @ Xf1))))) @ (^ [Xf1:$i] : (cco @ (ccfv @ XJ @ cccld) @ ccn @ ccmap))))))).
