...
thf(cintopsn_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_op:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ Xc_op) @ (cwcel @ XZ @ XB2)) @ (cwb @ (cwceq @ XB2 @ (ccsn @ XZ)) @ (cwceq @ Xc_op @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))))))))).
