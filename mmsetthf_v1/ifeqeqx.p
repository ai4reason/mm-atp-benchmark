...
thf(cifeqeqx_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XX @ Xa)) @ (cwceq @ (XA2 @ Xx3 @ Xa) @ (XC @ Xa))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XY @ Xa)) @ (cwceq @ (XB2 @ Xx3 @ Xa) @ (ccv @ Xa))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XX @ Xa)) @ (cwb @ (Xch @ Xx3 @ Xa) @ (Xth @ Xa))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XY @ Xa)) @ (cwb @ (Xch @ Xx3 @ Xa) @ (Xps @ Xa))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwceq @ (ccv @ Xa) @ (XC @ Xa))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xa) @ (Xps @ Xa)) @ (Xth @ Xa)))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XY @ Xa) @ (XV @ Xa))))) => ((! [Xx3:$i] : (! [Xa:$i] : (cwi @ (Xph @ Xx3 @ Xa) @ (cwcel @ (XX @ Xa) @ (XW @ Xa))))) => (! [Xx3:$i] : (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xx3 @ Xa) @ (cwceq @ (ccv @ Xx3) @ (ccif @ (Xps @ Xa) @ (XX @ Xa) @ (XY @ Xa)))) @ (cwceq @ (ccv @ Xa) @ (ccif @ (Xch @ Xx3 @ Xa) @ (XA2 @ Xx3 @ Xa) @ (XB2 @ Xx3 @ Xa)))))))))))))))))))))))))).
