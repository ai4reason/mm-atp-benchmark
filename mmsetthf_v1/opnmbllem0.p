...
thf(adyadf_thm,axiom,(! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (cwf @ (ccxp @ ccz @ ccn0) @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)))).
...
thf(aledivmul2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwa @ (cwcel @ XC @ ccr) @ (cwbr @ ccc0 @ XC @ cclt))) @ (cwb @ (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccle))))))).
...
thf(adyadval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccn0)) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ (ccop @ (cco @ XA2 @ (cco @ cc2 @ XB2 @ ccexp) @ ccdiv) @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ (cco @ cc2 @ XB2 @ ccexp) @ ccdiv))))))))).
...
thf(copnmbllem0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) @ (cwceq @ (ccuni @ (ccima @ ccicc @ (ccrab @ (^ [Xz:$i] : (cwss @ (ccfv @ (ccv @ Xz) @ ccicc) @ XA2)) @ (^ [Xz:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))))))) @ XA2)))).
