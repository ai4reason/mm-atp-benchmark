...
thf(almodfopnelem1_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XW @ ccscaf)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusf)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XS @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XS @ ccbs)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwceq @ Xc_pl @ Xc_x)) @ (cwceq @ XV @ XK)))))))))))))).
...
thf(clmodfopnelem2_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XW @ ccscaf)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusf)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XS @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XS @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XS @ ccur)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cwceq @ Xc_pl @ Xc_x)) @ (cwa @ (cwcel @ Xc_0 @ XV) @ (cwcel @ Xc_1 @ XV))))))))))))))))))).
