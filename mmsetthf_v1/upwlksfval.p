...
thf(adf_upwlks_ax,axiom,(cwceq @ ccupwlks @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cw3a @ (cwcel @ (ccv @ Xf1) @ (ccword @ (ccdm @ (ccfv @ (ccv @ Xg1) @ cciedg)))) @ (cwf @ (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfz) @ (ccfv @ (ccv @ Xg1) @ ccvtx) @ (ccv @ Xp)) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xg1) @ cciedg)) @ (ccpr @ (ccfv @ (ccv @ Xk) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xp))))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo))))))))))).
...
thf(aopabex3d_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XA2 @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccab @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))) @ ccvv)))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xps @ Xx3 @ Xy1))))) @ ccvv))))))))).
