...
thf(aax_rnegex_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccaddc) @ ccc0)) @ (^ [Xx3:$i] : ccr))))).
...
thf(aax_rrecex_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwne @ XA2 @ ccc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cc1)) @ (^ [Xx3:$i] : ccr))))).
...
thf(c_00id_conj,conjecture,(cwceq @ (cco @ ccc0 @ ccc0 @ ccaddc) @ ccc0)).
