...
thf(abaspartn_thm,axiom,(! [XP:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XP @ (XV @ Xx3 @ Xy1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwo @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP))) @ (cwcel @ XP @ cctb))))))).
...
thf(atgdom_thm,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwbr @ (ccfv @ XB2 @ cctg) @ (ccpw @ XB2) @ ccdom))))).
...
thf(ckelac2lem_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwcel @ (ccfv @ (ccpr @ XS @ (ccsn @ (ccpw @ (ccuni @ XS)))) @ cctg) @ cccmp))))).
