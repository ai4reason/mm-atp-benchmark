...
thf(aaxpasch_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee)))) @ (cwi @ (cwa @ (cwbr @ XD @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ XE @ (ccop @ XB2 @ XC) @ ccbtwn)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccop @ XD @ XB2) @ ccbtwn) @ (cwbr @ (ccv @ Xx3) @ (ccop @ XE @ XA2) @ ccbtwn))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee)))))))))))).
...
thf(asyland_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwi @ Xps @ Xch)) => ((cwi @ Xph @ (cwi @ (cwa @ Xch @ Xth) @ Xta)) => (cwi @ Xph @ (cwi @ (cwa @ Xps @ Xth) @ Xta)))))))))).
...
thf(cbtwnintr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)))) @ (cwi @ (cwa @ (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn) @ (cwbr @ XC @ (ccop @ XB2 @ XD) @ ccbtwn)) @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn))))))))).
