...
thf(cgrpoideu_conj,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwcel @ XG @ ccgr) @ (cwreu @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX))))))).
