...
thf(csubglsm_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XH @ cclsm)) => (cwi @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwss @ XT @ XS) @ (cwss @ XU @ XS)) @ (cwceq @ (cco @ XT @ XU @ Xc_po) @ (cco @ XT @ XU @ XA2)))))))))))))).
