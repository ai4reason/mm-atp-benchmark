...
thf(cuntint_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccint @ XA2)))))).
