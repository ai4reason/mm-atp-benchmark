...
thf(aiscusgredg_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XE @ Xk @ Xn) @ (ccfv @ XG @ ccedg)))) => (cwb @ (cwcel @ XG @ cccusgr) @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccpr @ (ccv @ Xn) @ (ccv @ Xk)) @ (XE @ Xk @ Xn))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : XV)))))))))).
...
thf(aelss2prb_thm,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (cwb @ (cwcel @ XP @ (ccrab @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ cchash) @ cc2)) @ (^ [Xz:$i] : (ccpw @ XV)))) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ XP @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV)))))).
...
thf(ccusgredg_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ ccedg))) => (! [Xx3:$i] : (cwi @ (cwcel @ XG @ cccusgr) @ (cwceq @ (XE @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))))))))))).
