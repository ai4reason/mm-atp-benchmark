...
thf(cfrege131d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccvv)) => ((cwi @ Xph @ (cwceq @ XA2 @ (ccun @ XU @ (ccun @ (ccima @ (cccnv @ (ccfv @ XF @ cctcl)) @ XU) @ (ccima @ (ccfv @ XF @ cctcl) @ XU))))) => ((cwi @ Xph @ (cwfun @ XF)) => (cwi @ Xph @ (cwss @ (ccima @ XF @ XA2) @ XA2)))))))))).
