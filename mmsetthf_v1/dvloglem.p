...
thf(alogdmss_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwss @ XD @ (ccdif @ ccc @ (ccsn @ ccc0)))))).
...
thf(aellogdm_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwb @ (cwcel @ XA2 @ XD) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ XA2 @ ccrp)))))))).
thf(alogdmn0_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwi @ (cwcel @ XA2 @ XD) @ (cwne @ XA2 @ ccc0)))))).
...
thf(alogdmnrp_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwi @ (cwcel @ XA2 @ XD) @ (cwn @ (cwcel @ (ccneg @ XA2) @ ccrp))))))).
...
thf(aixxssixx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XO @ Xx3 @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (XR @ Xw)) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (XS @ Xw)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XP @ Xx3 @ Xy1 @ Xz) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (XT @ Xw)) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (XU @ Xw)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xw:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ (ccv @ Xw) @ ccxr)) @ (cwi @ (cwbr @ XA2 @ (ccv @ Xw) @ (XR @ Xw)) @ (cwbr @ XA2 @ (ccv @ Xw) @ (XT @ Xw))))) => ((! [Xw:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xw) @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwi @ (cwbr @ (ccv @ Xw) @ XB2 @ (XS @ Xw)) @ (cwbr @ (ccv @ Xw) @ XB2 @ (XU @ Xw))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwss @ (cco @ XA2 @ XB2 @ (XO @ Xx3 @ Xy1 @ Xz)) @ (cco @ XA2 @ XB2 @ (XP @ Xx3 @ Xy1 @ Xz))))))))))))))))))).
...
thf(alogrn_thm,axiom,(cwceq @ (ccrn @ cclog) @ (ccima @ (cccnv @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)))).
thf(alogef_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccrn @ cclog)) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cce) @ cclog) @ XA2)))).
...
thf(alt0neg1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ ccc0 @ cclt) @ (cwbr @ ccc0 @ (ccneg @ XA2) @ cclt))))))).
...
thf(cdvloglem_conj,conjecture,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccima @ cclog @ XD) @ (ccfv @ cccnfld @ cctopn))))).
