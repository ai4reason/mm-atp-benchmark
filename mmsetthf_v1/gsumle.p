...
thf(aomndadd2d_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XM @ ccple)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwi @ Xph @ (cwcel @ XM @ ccomnd)) => ((cwi @ Xph @ (cwcel @ XW @ XB2)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwi @ Xph @ (cwbr @ XX @ XZ @ Xc_le)) => ((cwi @ Xph @ (cwbr @ XY @ XW @ Xc_le)) => ((cwi @ Xph @ (cwcel @ XM @ cccmn)) => (cwi @ Xph @ (cwbr @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XW @ Xc_pl) @ Xc_le))))))))))))))))))))))).
...
thf(cgsumle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XM @ ccple)) => ((cwi @ Xph @ (cwcel @ XM @ ccomnd)) => ((cwi @ Xph @ (cwcel @ XM @ cccmn)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XG)) => ((cwi @ Xph @ (cwbr @ XF @ XG @ (ccofr @ Xc_le))) => (cwi @ Xph @ (cwbr @ (cco @ XM @ XF @ ccgsu) @ (cco @ XM @ XG @ ccgsu) @ Xc_le)))))))))))))))))).
