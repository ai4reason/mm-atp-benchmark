...
thf(ciswrdsymb_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ ccvv)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccfv @ (ccv @ Xi) @ XW) @ XV)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (cwcel @ XW @ (ccword @ XV)))))).
