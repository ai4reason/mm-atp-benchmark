...
thf(cbj_cleljustab_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (cwb @ (cwcel @ (ccv @ Xx3) @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) @ (cwex @ (^ [Xz:$i] : (cwa @ (cwceq @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xz) @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))))))))).
