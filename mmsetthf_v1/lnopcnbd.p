...
thf(alnopcon_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ cclo) @ (cwb @ (cwcel @ XT @ cccop) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccno) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccno) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccr)))))).
thf(clnopcnbd_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwcel @ XT @ cclo) @ (cwb @ (cwcel @ XT @ cccop) @ (cwcel @ XT @ ccbo))))).
