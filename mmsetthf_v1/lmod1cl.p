...
thf(clmod1cl_conj,conjecture,(! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_1 @ (ccfv @ XF @ ccur)) => (cwi @ (cwcel @ XW @ cclmod) @ (cwcel @ Xc_1 @ XK)))))))))).
