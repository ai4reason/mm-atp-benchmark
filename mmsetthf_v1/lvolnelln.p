...
thf(alvolnlelln_thm,axiom,(! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XN @ (ccfv @ XK @ cclln)) => ((cwceq @ XV @ (ccfv @ XK @ cclvol)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XN)) @ (cwn @ (cwbr @ XX @ XY @ Xc_le))))))))))))).
thf(clvolnelln_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XK @ cclln)) => ((cwceq @ XV @ (ccfv @ XK @ cclvol)) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XV)) @ (cwn @ (cwcel @ XX @ XN)))))))))).
