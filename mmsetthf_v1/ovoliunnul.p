...
thf(covoliunnul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwa @ (cwbr @ XA2 @ ccn @ ccdom) @ (cwral @ (^ [Xn:$i] : (cwa @ (cwss @ (XB2 @ Xn) @ ccr) @ (cwceq @ (ccfv @ (XB2 @ Xn) @ ccovol) @ ccc0))) @ (^ [Xn:$i] : XA2))) @ (cwceq @ (ccfv @ (cciun @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccovol) @ ccc0))))).
