...
thf(auncf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ (cco @ XC @ XB2 @ ccmap) @ XF) @ (cwf @ (ccxp @ XA2 @ XB2) @ XC @ (ccunc @ XF)))))))).
...
thf(auncov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (cco @ XA2 @ XB2 @ (ccunc @ XF)) @ (ccfv @ XB2 @ (ccfv @ XA2 @ XF)))))))))).
...
thf(ccurunc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf @ XA2 @ (cco @ XC @ XB2 @ ccmap) @ XF) @ (cwne @ XB2 @ cc0)) @ (cwceq @ (cccur @ (ccunc @ XF)) @ XF))))))).
