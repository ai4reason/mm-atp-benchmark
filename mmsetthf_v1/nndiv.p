...
thf(cnndiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ XB2)) @ (^ [Xx3:$i] : ccn)) @ (cwcel @ (cco @ XB2 @ XA2 @ ccdiv) @ ccn)))))).
