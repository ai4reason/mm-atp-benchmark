...
thf(cldillaut_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => ((cwceq @ XD @ (ccfv @ XW @ (ccfv @ XK @ ccldil))) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XW @ XH)) @ (cwcel @ XF @ XD)) @ (cwcel @ XF @ XI))))))))))))).
