...
thf(alogbid1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) @ (cwceq @ (cco @ XA2 @ XA2 @ cclogb) @ cc1)))).
...
thf(crelogbmulbexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ (ccdif @ ccrp @ (ccsn @ cc1))) @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XC @ ccr))) @ (cwceq @ (cco @ XB2 @ (cco @ XA2 @ (cco @ XB2 @ XC @ cccxp) @ ccmul) @ cclogb) @ (cco @ (cco @ XB2 @ XA2 @ cclogb) @ XC @ ccaddc))))))).
