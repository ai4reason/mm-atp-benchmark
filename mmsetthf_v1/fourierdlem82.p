...
thf(aitgioo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) @ (cwcel @ (XC @ Xx3) @ ccc))) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))))).
...
thf(aitgsbtaddcnst_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => (cwi @ Xph @ (cwceq @ (ccdit @ (^ [Xs1:$i] : (cco @ XA2 @ XX @ ccmin)) @ (^ [Xs1:$i] : (cco @ XB2 @ XX @ ccmin)) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))) @ (ccdit @ (^ [Xt:$i] : XA2) @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))))))))))).
thf(cctop_tp,type,(cctop : ($i > $o))).
thf(ccrest_tp,type,(ccrest : ($i > $o))).
thf(cccn_tp,type,(cccn : ($i > $o))).
thf(cwnf_tp,type,(cwnf : (($i > $o) > $o))).
thf(acncfiooicc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : Xph)) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ XR @ (ccif @ (cwceq @ (ccv @ Xx3) @ XB2) @ XL @ (ccfv @ (ccv @ Xx3) @ XF))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ XF @ XA2 @ cclimc))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))))))))))))))))))).
...
thf(cfourierdlem82_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ (XR @ Xt) @ (ccif @ (cwceq @ (ccv @ Xx3) @ XB2) @ (XL @ Xt) @ (ccfv @ (ccv @ Xx3) @ (ccres @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ ccioo)))))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xt:$i] : (cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ (XF @ Xt)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (ccres @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XL @ Xt) @ (cco @ (XF @ Xt) @ XB2 @ cclimc)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xt) @ (cco @ (XF @ Xt) @ XA2 @ cclimc)))) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (XF @ Xt)))) @ (ccitg @ (^ [Xt:$i] : (cco @ (cco @ XA2 @ XX @ ccmin) @ (cco @ XB2 @ XX @ ccmin) @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (cco @ XX @ (ccv @ Xt) @ ccaddc) @ (XF @ Xt)))))))))))))))))))))))).
