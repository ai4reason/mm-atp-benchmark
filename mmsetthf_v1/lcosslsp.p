...
thf(aellcoellss_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ (ccfv @ XM @ cclss)) @ (cwss @ XV @ XS)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XS)) @ (^ [Xx3:$i] : (cco @ XM @ XV @ cclinco)))))))).
...
thf(clcosslsp_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => (cwi @ (cwa @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ XB2))) @ (cwss @ (cco @ XM @ XV @ cclinco) @ (ccfv @ XV @ (ccfv @ XM @ cclspn))))))))).
