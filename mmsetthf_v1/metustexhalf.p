...
thf(apsmettri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) @ (cwbr @ (cco @ XA2 @ XB2 @ XD) @ (cco @ (cco @ XA2 @ XC @ XD) @ (cco @ XC @ XB2 @ XD) @ ccxad) @ ccle)))))))).
...
thf(cmetustexhalf_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (cwi @ (cwa @ (cwa @ (cwne @ XX @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) @ (cwcel @ XA2 @ XF)) @ (cwrex @ (^ [Xv:$i] : (cwss @ (cccom @ (ccv @ Xv) @ (ccv @ Xv)) @ XA2)) @ (^ [Xv:$i] : XF))))))))).
