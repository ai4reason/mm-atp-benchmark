...
thf(amdsl2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwss @ (ccin @ XA2 @ XB2) @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XB2)) @ (cwss @ (ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) @ (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch)))))))).
...
thf(achlej2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) @ (cwss @ XA2 @ XB2)) @ (cwss @ (cco @ XC @ XA2 @ cchj) @ (cco @ XC @ XB2 @ cchj))))))).
...
thf(cmdsl2bi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwb @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwss @ (ccin @ XA2 @ XB2) @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) @ (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch)))))))).
