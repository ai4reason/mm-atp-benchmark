...
thf(cpfxfv0_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ ccc0 @ (cco @ XW @ XL @ ccpfx)) @ (ccfv @ ccc0 @ XW))))))).
