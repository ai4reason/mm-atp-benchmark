...
thf(agexdvds3_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn)) @ (cwbr @ XE @ (ccfv @ XX @ cchash) @ ccdvds)))))))).
...
thf(cpgpfac1lem3a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XK @ (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cwceq @ XS @ (ccfv @ (ccsn @ XA2) @ XK)) => ((! [Xw:$i] : (cwceq @ (XB2 @ Xw) @ (ccfv @ XG @ ccbs))) => ((! [Xw:$i] : (cwceq @ (XO @ Xw) @ (ccfv @ XG @ ccod))) => ((! [Xw:$i] : (cwceq @ (XE @ Xw) @ (ccfv @ XG @ ccgex))) => ((! [Xw:$i] : (cwceq @ (Xc_0 @ Xw) @ (ccfv @ XG @ cc0g))) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwbr @ XP @ XG @ ccpgp)) => ((cwi @ Xph @ (cwcel @ XG @ ccabl)) => ((! [Xw:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xw) @ ccfn))) => ((! [Xw:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XA2 @ (XO @ Xw)) @ (XE @ Xw)))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XW @ (ccfv @ XG @ ccsubg))) => ((! [Xw:$i] : (cwi @ Xph @ (cwceq @ (ccin @ XS @ XW) @ (ccsn @ (Xc_0 @ Xw))))) => ((cwi @ Xph @ (cwss @ (cco @ XS @ XW @ Xc_po) @ XU)) => ((cwi @ Xph @ (cwral @ (^ [Xw:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xw) @ XU) @ (cwcel @ XA2 @ (ccv @ Xw))) @ (cwn @ (cwpss @ (cco @ XS @ XW @ Xc_po) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccfv @ XG @ ccsubg)))) => ((cwi @ Xph @ (cwcel @ XC @ (ccdif @ XU @ (cco @ XS @ XW @ Xc_po)))) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((! [Xw:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xw) @ ccz))) => ((! [Xw:$i] : (cwi @ Xph @ (cwcel @ (cco @ (cco @ XP @ XC @ Xc_x) @ (cco @ (XM @ Xw) @ XA2 @ Xc_x) @ (ccfv @ XG @ ccplusg)) @ XW))) => (! [Xw:$i] : (cwi @ Xph @ (cwa @ (cwbr @ XP @ (XE @ Xw) @ ccdvds) @ (cwbr @ XP @ (XM @ Xw) @ ccdvds)))))))))))))))))))))))))))))))))))))))))).
