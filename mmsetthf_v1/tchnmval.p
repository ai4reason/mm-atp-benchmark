...
thf(ctchnmval_conj,conjecture,(! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => (cwi @ (cwa @ (cwcel @ XW @ ccgrp) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ XX @ XN) @ (ccfv @ (cco @ XX @ XX @ Xc_xi) @ ccsqrt)))))))))))))).
