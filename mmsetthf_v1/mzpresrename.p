...
thf(amzprename_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ ccvv) @ (cwcel @ XF @ (ccfv @ XV @ ccmzp)) @ (cwf @ XV @ XW @ XR)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (cccom @ (ccv @ Xx3) @ XR) @ XF))) @ (ccfv @ XW @ ccmzp)))))))).
thf(cmzpresrename_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ ccvv) @ (cwss @ XV @ XW) @ (cwcel @ XF @ (ccfv @ XV @ ccmzp))) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (ccres @ (ccv @ Xx3) @ XV) @ XF))) @ (ccfv @ XW @ ccmzp))))))).
