...
thf(anmorepnf_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XN @ (cco @ XU @ XW @ ccnmoo)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwf @ XX @ XY @ XT)) @ (cwb @ (cwcel @ (ccfv @ XT @ XN) @ ccr) @ (cwne @ (ccfv @ XT @ XN) @ ccpnf))))))))))))).
...
thf(cnmounbi_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xr:$i] : (cwceq @ XX @ (ccfv @ (XU @ Xr) @ ccba))) => ((! [Xr:$i] : (cwceq @ XY @ (ccfv @ (XW @ Xr) @ ccba))) => ((! [Xr:$i] : (cwceq @ XL @ (ccfv @ (XU @ Xr) @ ccnmcv))) => ((! [Xr:$i] : (cwceq @ XM @ (ccfv @ (XW @ Xr) @ ccnmcv))) => ((! [Xr:$i] : (cwceq @ XN @ (cco @ (XU @ Xr) @ (XW @ Xr) @ ccnmoo))) => ((! [Xr:$i] : (cwcel @ (XU @ Xr) @ ccnv)) => ((! [Xr:$i] : (cwcel @ (XW @ Xr) @ ccnv)) => (cwi @ (cwf @ XX @ XY @ XT) @ (cwb @ (cwceq @ (ccfv @ XT @ XN) @ ccpnf) @ (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xy1) @ XL) @ cc1 @ ccle) @ (cwbr @ (ccv @ Xr) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ XM) @ cclt))) @ (^ [Xy1:$i] : XX))) @ (^ [Xr:$i] : ccr)))))))))))))))))))).
