...
thf(aidreseqidinxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccin @ ccid @ (ccxp @ XA2 @ XB2)) @ (ccres @ ccid @ XA2)))))).
thf(csymrefref2_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwss @ (cccnv @ XR) @ XR) @ (cwb @ (cwss @ (ccin @ ccid @ (ccxp @ (ccdm @ XR) @ (ccrn @ XR))) @ XR) @ (cwss @ (ccres @ ccid @ (ccdm @ XR)) @ XR))))).
