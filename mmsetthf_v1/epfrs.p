...
thf(atz9_1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwex @ (^ [Xx3:$i] : (cw3a @ (cwss @ XA2 @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xx3)) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwss @ XA2 @ (ccv @ Xy1)) @ (cwtr @ (ccv @ Xy1))) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))))))))))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asnex_thm,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccsn @ XA2) @ ccvv))).
thf(cepfrs_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwfr @ XA2 @ ccep) @ (cwne @ XA2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ (ccv @ Xx3) @ XA2) @ cc0)) @ (^ [Xx3:$i] : XA2))))).
