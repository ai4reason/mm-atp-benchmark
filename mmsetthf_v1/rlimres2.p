...
thf(crlimres2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ XB2))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xx3) @ ccrli))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xx3) @ ccrli))))))))))).
