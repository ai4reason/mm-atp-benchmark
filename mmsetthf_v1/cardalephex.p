...
thf(acardaleph_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwss @ ccom @ XA2) @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2)) @ (cwceq @ XA2 @ (ccfv @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccale))) @ (^ [Xx3:$i] : ccon0))) @ ccale))))).
...
thf(ccardalephex_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwss @ ccom @ XA2) @ (cwb @ (cwceq @ (ccfv @ XA2 @ cccrd) @ XA2) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccale))) @ (^ [Xx3:$i] : ccon0)))))).
