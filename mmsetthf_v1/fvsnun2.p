...
thf(cfvsnun2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwceq @ XG @ (ccun @ (ccsn @ (ccop @ XA2 @ XB2)) @ (ccres @ XF @ (ccdif @ XC @ (ccsn @ XA2))))) => (cwi @ (cwcel @ XD @ (ccdif @ XC @ (ccsn @ XA2))) @ (cwceq @ (ccfv @ XD @ XG) @ (ccfv @ XD @ XF))))))))))))).
