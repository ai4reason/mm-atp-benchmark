...
thf(alinds2_thm,axiom,(! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ (ccfv @ XW @ cclinds)) @ (cwbr @ (ccres @ ccid @ XX) @ XW @ cclindf))))).
...
thf(alindfind2_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XK @ (ccfv @ XW @ cclspn)) => ((cwceq @ XL @ (ccfv @ XW @ ccsca)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XL @ ccnzr)) @ (cwbr @ XF @ XW @ cclindf) @ (cwcel @ XE @ (ccdm @ XF))) @ (cwn @ (cwcel @ (ccfv @ XE @ XF) @ (ccfv @ (ccima @ XF @ (ccdif @ (ccdm @ XF) @ (ccsn @ XE))) @ XK)))))))))))).
...
thf(clindsind2_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XK @ (ccfv @ XW @ cclspn)) => ((cwceq @ XL @ (ccfv @ XW @ ccsca)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XL @ ccnzr)) @ (cwcel @ XF @ (ccfv @ XW @ cclinds)) @ (cwcel @ XE @ XF)) @ (cwn @ (cwcel @ XE @ (ccfv @ (ccdif @ XF @ (ccsn @ XE)) @ XK)))))))))))).
