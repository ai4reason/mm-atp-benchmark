...
thf(aiffv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwceq @ (ccfv @ XA2 @ (ccif @ Xph @ XF @ XG)) @ (ccif @ Xph @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG)))))))).
...
thf(aply1idvr1_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ XN @ (ccfv @ XP @ ccmgp)) => ((cwceq @ Xc_ex @ (ccfv @ XN @ ccmg)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ (cco @ ccc0 @ XX @ Xc_ex) @ (ccfv @ XP @ ccur))))))))))))).
...
thf(cdecpmatid_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XI @ (ccfv @ XC @ ccur)) => ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ Xc_0 @ (ccfv @ XA2 @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XA2 @ ccur)) => (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ ccn0)) @ (cwceq @ (cco @ XI @ XK @ ccdecpmat) @ (ccif @ (cwceq @ XK @ ccc0) @ Xc_1 @ Xc_0))))))))))))))))))).
