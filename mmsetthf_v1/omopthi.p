...
thf(aomopthlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XB2 @ ccom) => ((cwcel @ XC @ ccom) => ((cwcel @ XD @ ccom) => (cwi @ (cwcel @ (cco @ XA2 @ XB2 @ ccoa) @ XC) @ (cwn @ (cwceq @ (cco @ (cco @ XC @ XC @ ccomu) @ XD @ ccoa) @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccoa) @ (cco @ XA2 @ XB2 @ ccoa) @ ccomu) @ XB2 @ ccoa))))))))))))).
...
thf(comopthi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XB2 @ ccom) => ((cwcel @ XC @ ccom) => ((cwcel @ XD @ ccom) => (cwb @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccoa) @ (cco @ XA2 @ XB2 @ ccoa) @ ccomu) @ XB2 @ ccoa) @ (cco @ (cco @ (cco @ XC @ XD @ ccoa) @ (cco @ XC @ XD @ ccoa) @ ccomu) @ XD @ ccoa)) @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)))))))))))).
