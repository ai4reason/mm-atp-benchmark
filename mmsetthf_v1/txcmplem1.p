...
thf(ctxcmplem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xv:$i] : (cwceq @ XX @ (ccuni @ (XR @ Xv)))) => ((cwceq @ XY @ (ccuni @ XS)) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwcel @ (XR @ Xv) @ cccmp))) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwcel @ XS @ cccmp))) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwss @ XW @ (cco @ (XR @ Xv) @ XS @ cctx)))) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwceq @ (ccxp @ XX @ XY) @ (ccuni @ XW)))) => ((! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwcel @ (XA2 @ Xv) @ XY))) => (! [Xv:$i] : (cwi @ (Xph @ Xv) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (XA2 @ Xv) @ (ccv @ Xu)) @ (cwrex @ (^ [Xv:$i] : (cwss @ (ccxp @ XX @ (ccv @ Xu)) @ (ccuni @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XW) @ ccfn))))) @ (^ [Xu:$i] : XS))))))))))))))))))).
