...
thf(ahashunif_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ ccfn))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cchash) @ (ccsu @ XA2 @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash))))))))))))).
...
thf(adifinf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwn @ (cwcel @ XA2 @ ccfn)) @ (cwcel @ XB2 @ ccfn)) @ (cwn @ (cwcel @ (ccdif @ XA2 @ XB2) @ ccfn)))))).
...
thf(chasheuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3)))) @ (cwceq @ (ccfv @ (ccuni @ XA2) @ cchash) @ (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash)))))))).
