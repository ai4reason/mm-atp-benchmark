...
thf(ccaragensplit_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwi @ Xph @ (cwcel @ XE @ XS)) => ((cwi @ Xph @ (cwss @ XA2 @ XX)) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (ccin @ XA2 @ XE) @ XO) @ (ccfv @ (ccdif @ XA2 @ XE) @ XO) @ ccxad) @ (ccfv @ XA2 @ XO))))))))))))))).
