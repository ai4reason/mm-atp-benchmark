...
thf(aelspansn4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ cchil)) @ (cwa @ (cwcel @ XC @ (ccfv @ (ccsn @ XB2) @ ccspn)) @ (cwne @ XC @ cc0v))) @ (cwb @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2))))))).
thf(celspansn5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccsh) @ (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ cchil) @ (cwn @ (cwcel @ XB2 @ XA2))) @ (cwa @ (cwcel @ XC @ (ccfv @ (ccsn @ XB2) @ ccspn)) @ (cwcel @ XC @ XA2))) @ (cwceq @ XC @ cc0v))))))).
