...
thf(cpj1eu_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xy1) @ (ccfv @ XG @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XZ @ Xx3 @ Xy1) @ (ccfv @ XG @ cccntz)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (ccin @ XT @ XU) @ (ccsn @ (Xc_0 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwss @ XT @ (ccfv @ XU @ (XZ @ Xx3 @ Xy1)))))) => (cwi @ (cwa @ Xph @ (cwcel @ XX @ (cco @ XT @ XU @ Xc_po))) @ (cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ XX @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl))) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : XT))))))))))))))))))))).
