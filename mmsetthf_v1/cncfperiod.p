...
thf(ccncfperiod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XT @ ccr)) => ((cwceq @ XB2 @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ XT @ ccaddc))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccc))) => ((cwi @ Xph @ (cwf @ (ccdm @ XF) @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XB2 @ (ccdm @ XF))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ XA2) @ (cco @ XA2 @ ccc @ cccncf))) => (cwi @ Xph @ (cwcel @ (ccres @ XF @ XB2) @ (cco @ XB2 @ ccc @ cccncf)))))))))))))))).
