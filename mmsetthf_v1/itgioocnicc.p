...
thf(citgioocnicc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwf @ (ccdm @ XF) @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdm @ XF))) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XA2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XL @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XB2 @ cclimc))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ XR @ (ccif @ (cwceq @ (ccv @ Xx3) @ XB2) @ XL @ (ccfv @ (ccv @ Xx3) @ XF))))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwa @ (cwcel @ (XG @ Xx3) @ ccibl) @ (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XG @ Xx3)))) @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))))))))))))))))).
