...
thf(cisumclim3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xk) @ (ccdm @ ccli)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xj) @ (XF @ Xk)) @ (ccsu @ (cco @ XM @ (ccv @ Xj) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))))))) => (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (XF @ Xk) @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccli)))))))))))))).
