...
thf(adf_vdwpc_ax,axiom,(cwceq @ ccvdwp @ (ccoprab @ (^ [Xm:$i] : (^ [Xk:$i] : (^ [Xf1:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwa @ (cwral @ (^ [Xi:$i] : (cwss @ (cco @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ (ccfv @ (ccv @ Xk) @ ccvdwa)) @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccfv @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ (ccv @ Xf1)))))) @ (^ [Xi:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccfz))) @ (cwceq @ (ccfv @ (ccrn @ (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ (ccv @ Xf1))))) @ cchash) @ (ccv @ Xm)))) @ (^ [Xd:$i] : (cco @ ccn @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ ccmap)))) @ (^ [Xa:$i] : ccn)))))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(cwex_tp,type,(cwex : (($i > $o) > $o))).
thf(aeloprabga_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccv @ Xy1) @ XB2) @ (cwceq @ (ccv @ Xz) @ XC)) @ (cwb @ (Xph @ Xx3 @ Xy1 @ Xz) @ Xps))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XB2 @ (XW @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XC @ (XX @ Xx3 @ Xy1 @ Xz))) @ (cwb @ (cwcel @ (ccop @ (ccop @ XA2 @ XB2) @ XC) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) @ Xps))))))))))))))).
...
thf(cvdwpc_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwcel @ (XX @ Xi @ Xa @ Xd) @ ccvv)))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xi @ Xa @ Xd) @ (cwcel @ XK @ ccn0))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xi @ Xa @ Xd) @ (cwf @ (XX @ Xi @ Xa @ Xd) @ (XR @ Xi @ Xa @ Xd) @ XF))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xi @ Xa @ Xd) @ (cwcel @ XM @ ccn))))) => ((! [Xa:$i] : (cwceq @ (XJ @ Xa) @ (cco @ cc1 @ XM @ ccfz))) => (! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xi @ Xa @ Xd) @ (cwb @ (cwbr @ (ccop @ XM @ XK) @ XF @ ccvdwp) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwa @ (cwral @ (^ [Xi:$i] : (cwss @ (cco @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccfv @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ XF))))) @ (^ [Xi:$i] : (XJ @ Xa))) @ (cwceq @ (ccfv @ (ccrn @ (ccmpt @ (^ [Xi:$i] : (XJ @ Xa)) @ (^ [Xi:$i] : (ccfv @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ XF)))) @ cchash) @ XM))) @ (^ [Xd:$i] : (cco @ ccn @ (XJ @ Xa) @ ccmap)))) @ (^ [Xa:$i] : ccn)))))))))))))))))))).
