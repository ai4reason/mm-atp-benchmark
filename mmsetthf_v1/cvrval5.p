...
thf(ccvrval5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xp:$i] : (cwceq @ (Xc_or @ Xp) @ (ccfv @ XK @ ccjn))) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwbr @ (cco @ XX @ XY @ Xc_an) @ XX @ XC) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwn @ (cwbr @ (ccv @ Xp) @ XY @ Xc_le)) @ (cwceq @ (cco @ (ccv @ Xp) @ (cco @ XX @ XY @ Xc_an) @ (Xc_or @ Xp)) @ XX))) @ (^ [Xp:$i] : XA2)))))))))))))))))))).
