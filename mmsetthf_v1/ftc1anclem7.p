...
thf(aad6antlr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : ((cwi @ Xph @ Xps) => (cwi @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ (cwa @ Xch @ Xph) @ Xth) @ Xta) @ Xet) @ Xze) @ Xsi) @ Xps))))))))))).
...
thf(aftc1anclem3_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ (ccdm @ ccitg1))) @ (cwcel @ (cccom @ ccabs @ (cco @ XF @ (cco @ (ccxp @ ccr @ (ccsn @ cci)) @ XG @ (ccof @ ccmul)) @ (ccof @ ccaddc))) @ (ccdm @ ccitg1)))))).
...
thf(aitg2const_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico))) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ XB2 @ ccc0))) @ ccitg2) @ (cco @ XB2 @ (ccfv @ XA2 @ ccvol) @ ccmul)))))).
