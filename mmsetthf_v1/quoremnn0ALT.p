...
thf(afldivnn0_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ ccn0) @ (cwcel @ XL @ ccn)) @ (cwcel @ (ccfv @ (cco @ XK @ XL @ ccdiv) @ ccfl) @ ccn0))))).
...
thf(ann0sub2_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0) @ (cwbr @ XM @ XN @ ccle)) @ (cwcel @ (cco @ XN @ XM @ ccmin) @ ccn0))))).
...
thf(afraclt1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (cco @ XA2 @ (ccfv @ XA2 @ ccfl) @ ccmin) @ cc1 @ cclt)))).
...
thf(cquoremnn0ALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XQ @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl)) => ((cwceq @ XR @ (cco @ XA2 @ (cco @ XB2 @ XQ @ ccmul) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn)) @ (cwa @ (cwa @ (cwcel @ XQ @ ccn0) @ (cwcel @ XR @ ccn0)) @ (cwa @ (cwbr @ XR @ XB2 @ cclt) @ (cwceq @ XA2 @ (cco @ (cco @ XB2 @ XQ @ ccmul) @ XR @ ccaddc)))))))))))).
