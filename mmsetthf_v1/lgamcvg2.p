...
thf(advlog2lem_thm,axiom,(! [XS:($i > $o)] : ((cwceq @ XS @ (cco @ cc1 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => (cwss @ XS @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc)))))).
...
thf(admgmaddn0_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) @ (cwcel @ XN @ ccn0)) @ (cwne @ (cco @ XA2 @ XN @ ccaddc) @ ccc0))))).
...
thf(alogdiv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XB2 @ ccrp)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ cclog) @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XB2 @ cclog) @ ccmin)))))).
...
thf(clgamcvg2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xm:$i] : (cwceq @ (XG @ Xm) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (cco @ (cco @ XA2 @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccdiv) @ cclog) @ ccmul) @ (ccfv @ (cco @ (cco @ XA2 @ (ccv @ Xm) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin))))) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => (! [Xm:$i] : (cwi @ Xph @ (cwbr @ (ccseq @ ccaddc @ (XG @ Xm) @ cc1) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclgam) @ ccli))))))))).
