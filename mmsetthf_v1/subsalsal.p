...
thf(arestuni3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => (cwi @ Xph @ (cwceq @ (ccuni @ (cco @ XA2 @ XB2 @ ccrest)) @ (ccin @ (ccuni @ XA2) @ XB2))))))))))).
...
thf(asubsaliuncl_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XD @ (XV @ Xn)))) => ((! [Xn:$i] : (cwceq @ (XT @ Xn) @ (cco @ XS @ XD @ ccrest))) => ((! [Xn:$i] : (cwi @ Xph @ (cwf @ ccn @ (XT @ Xn) @ XF))) => (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) @ (XT @ Xn))))))))))))))).
thf(csubsalsal_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XD @ XV)) => ((cwceq @ XT @ (cco @ XS @ XD @ ccrest)) => (cwi @ Xph @ (cwcel @ XT @ ccsalg))))))))))).
