...
thf(afnunres1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XB2) @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0)) @ (cwceq @ (ccres @ (ccun @ XF @ XG) @ XA2) @ XF))))))).
...
thf(cactfunsnf1o_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xk) @ (XC @ Xx3 @ Xk))) @ (cwss @ (XA2 @ Xk) @ (cco @ (XC @ Xx3 @ Xk) @ (XB2 @ Xx3 @ Xk) @ ccmap))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3 @ Xk) @ ccvv)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XI @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3) @ (cwn @ (cwcel @ XI @ (XB2 @ Xx3 @ Xk)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XF @ Xx3 @ Xk) @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xk)) @ (^ [Xx3:$i] : (ccun @ (ccv @ Xx3) @ (ccsn @ (ccop @ XI @ (ccv @ Xk))))))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xk) @ (XC @ Xx3 @ Xk))) @ (cwf1o @ (XA2 @ Xk) @ (ccrn @ (XF @ Xx3 @ Xk)) @ (XF @ Xx3 @ Xk)))))))))))))))))).
