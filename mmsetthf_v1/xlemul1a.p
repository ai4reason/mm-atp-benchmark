...
thf(axmulpnf1n_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ XA2 @ ccc0 @ cclt)) @ (cwceq @ (cco @ XA2 @ ccpnf @ ccxmu) @ ccmnf)))).
...
thf(axmul02_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwceq @ (cco @ ccc0 @ XA2 @ ccxmu) @ ccc0)))).
...
thf(axmulmnf2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwceq @ (cco @ ccmnf @ XA2 @ ccxmu) @ ccmnf)))).
...
thf(cxlemul1a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwa @ (cwcel @ XC @ ccxr) @ (cwbr @ ccc0 @ XC @ ccle))) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwbr @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccle)))))).
