...
thf(cchrdvds_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XC @ (ccfv @ XR @ ccchr)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XC @ XN @ ccdvds) @ (cwceq @ (ccfv @ XN @ XL) @ Xc_0)))))))))))).
