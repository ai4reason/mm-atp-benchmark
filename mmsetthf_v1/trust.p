...
thf(austssel_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU) @ (cwss @ XW @ (ccxp @ XX @ XX))) @ (cwi @ (cwss @ XV @ XW) @ (cwcel @ XW @ XU)))))))).
...
thf(aiss_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwss @ XA2 @ ccid) @ (cwceq @ XA2 @ (ccres @ ccid @ (ccdm @ XA2)))))).
...
thf(adminxp_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xy1:$i] : (cwb @ (cwceq @ (ccdm @ (ccin @ XC @ (ccxp @ (XA2 @ Xy1) @ XB2))) @ (XA2 @ Xy1)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))))))).
...
thf(ctrust_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwss @ XA2 @ XX)) @ (cwcel @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ (ccfv @ XA2 @ ccust))))))).
