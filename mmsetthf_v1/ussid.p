...
thf(cussid_conj,conjecture,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XU @ (ccfv @ XW @ ccunif)) => (cwi @ (cwceq @ (ccxp @ XB2 @ XB2) @ (ccuni @ XU)) @ (cwceq @ XU @ (ccfv @ XW @ ccuss))))))))).
