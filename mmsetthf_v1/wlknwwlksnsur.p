...
thf(awlklnwwlkn_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XG @ ccuspgr) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ XN)))) @ (cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn)))))))).
...
thf(cwlknwwlksnsur_conj,conjecture,(! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XT @ (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) @ XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks)))) => ((cwceq @ XW @ (cco @ XN @ XG @ ccwwlksn)) => ((! [Xt:$i] : (cwceq @ (XF @ Xt) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd))))) => (! [Xt:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XN @ ccn0)) @ (cwfo @ XT @ XW @ (XF @ Xt))))))))))))).
