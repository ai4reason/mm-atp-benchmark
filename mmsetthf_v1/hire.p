...
thf(chire_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwcel @ (cco @ XA2 @ XB2 @ ccsp) @ ccr) @ (cwceq @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XA2 @ ccsp))))))).
