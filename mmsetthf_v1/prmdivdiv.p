...
thf(cprmdivdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XR @ (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) => (cwi @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))) @ (cwceq @ XA2 @ (cco @ (cco @ XR @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)))))))).
