...
thf(adf_mgmOLD_ax,axiom,(cwceq @ ccmagm @ (ccab @ (^ [Xg1:$i] : (cwex @ (^ [Xt:$i] : (cwf @ (ccxp @ (ccv @ Xt) @ (ccv @ Xt)) @ (ccv @ Xt) @ (ccv @ Xg1)))))))).
...
thf(cismgmOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ (ccdm @ XG))) => (cwi @ (cwcel @ XG @ XA2) @ (cwb @ (cwcel @ XG @ ccmagm) @ (cwf @ (ccxp @ XX @ XX) @ XX @ XG)))))))).
