...
thf(cnumsuc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XT @ ccn0) => ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwceq @ (cco @ XB2 @ cc1 @ ccaddc) @ XC) => ((cwceq @ XN @ (cco @ (cco @ XT @ XA2 @ ccmul) @ XB2 @ ccaddc)) => (cwceq @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ (cco @ XT @ XA2 @ ccmul) @ XC @ ccaddc))))))))))))).
