...
thf(aseeq1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwb @ (cwse @ XA2 @ XR) @ (cwse @ XA2 @ XS))))))).
...
thf(coieq1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwceq @ (ccoi @ XA2 @ XR) @ (ccoi @ XA2 @ XS))))))).
