...
thf(adf_cn_ax,axiom,(cwceq @ cccn @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : cctop)) @ (^ [Xj:$i] : (^ [Xk:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccv @ Xy1)) @ (ccv @ Xj))) @ (^ [Xy1:$i] : (ccv @ Xk)))) @ (^ [Xf1:$i] : (cco @ (ccuni @ (ccv @ Xk)) @ (ccuni @ (ccv @ Xj)) @ ccmap)))))))).
...
thf(ciscn2_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XY @ (ccuni @ XK)) => (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XK))))))))))))).
