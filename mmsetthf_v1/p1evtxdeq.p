...
thf(a_1hevtxdg0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ cciedg) @ (ccsn @ (ccop @ XA2 @ XE)))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XG @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XD @ XV)) => ((cwi @ Xph @ (cwcel @ XE @ XY)) => ((cwi @ Xph @ (cwnel @ XD @ XE)) => (cwi @ Xph @ (cwceq @ (ccfv @ XD @ (ccfv @ XG @ ccvtxdg)) @ ccc0))))))))))))))))).
...
thf(axaddid1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ ccc0 @ ccxad) @ XA2)))))).
thf(a_3syl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => ((cwi @ Xch @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(avtxdgelxnn0_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XX @ XV) @ (cwcel @ (ccfv @ XX @ (ccfv @ XG @ ccvtxdg)) @ ccxnn0))))))).
thf(ccpnf_tp,type,(ccpnf : ($i > $o))).
thf(ccn0_tp,type,(ccn0 : ($i > $o))).
thf(cwo_tp,type,(cwo : ($o > ($o > $o)))).
thf(axnn0xr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxnn0) @ (cwcel @ XA2 @ ccxr)))).
thf(cp1evtxdeq_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwfun @ XI)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccvtx) @ XV)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ cciedg) @ (ccun @ XI @ (ccsn @ (ccop @ XK @ XE))))) => ((cwi @ Xph @ (cwcel @ XK @ XX)) => ((cwi @ Xph @ (cwnel @ XK @ (ccdm @ XI))) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwcel @ XE @ XY)) => ((cwi @ Xph @ (cwnel @ XU @ XE)) => (cwi @ Xph @ (cwceq @ (ccfv @ XU @ (ccfv @ XF @ ccvtxdg)) @ (ccfv @ XU @ (ccfv @ XG @ ccvtxdg))))))))))))))))))))))))).
