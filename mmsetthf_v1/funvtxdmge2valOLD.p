...
thf(avtxvalOLD_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XG @ XV) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccif @ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)) @ (ccfv @ XG @ cc1st) @ (ccfv @ XG @ ccbs))))))).
...
thf(cfunvtxdmge2valOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XG @ XV) @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) @ (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ ccbs)))))).
