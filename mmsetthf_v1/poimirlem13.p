...
thf(cpoimirlem13_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xf1) @ (ccrab @ (^ [Xt:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xt) @ cc2nd) @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ (cco @ ccc0 @ XN @ ccfz))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwf @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ XF)))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwrmo @ (^ [Xz:$i] : (cwceq @ (ccfv @ (ccv @ Xz) @ cc2nd) @ ccc0)) @ (^ [Xz:$i] : (XS @ Xf1)))))))))))))).
