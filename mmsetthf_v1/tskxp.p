...
thf(atskwun_thm,axiom,(! [XT:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XT @ cctsk) @ (cwtr @ XT) @ (cwne @ XT @ cc0)) @ (cwcel @ XT @ ccwun)))).
thf(asimp2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xps))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xch))))).
thf(ctskxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XT @ cctsk) @ (cwtr @ XT)) @ (cwcel @ XA2 @ XT) @ (cwcel @ XB2 @ XT)) @ (cwcel @ (ccxp @ XA2 @ XB2) @ XT)))))).
