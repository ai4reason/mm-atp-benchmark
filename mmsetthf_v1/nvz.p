...
thf(cnvz_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XZ @ (ccfv @ XU @ ccn0v)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ XX)) @ (cwb @ (cwceq @ (ccfv @ XA2 @ XN) @ ccc0) @ (cwceq @ XA2 @ XZ)))))))))))).
