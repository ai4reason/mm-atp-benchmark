...
thf(acfub_thm,axiom,(! [XA2:($i > $o)] : (cwss @ (ccfv @ XA2 @ cccf) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ XA2 @ (ccuni @ (ccv @ Xy1))))))))))))).
...
thf(ccflm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XB2 @ Xx3 @ Xy1)) @ (cwlim @ XA2)) @ (cwceq @ (ccfv @ XA2 @ cccf) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwceq @ XA2 @ (ccuni @ (ccv @ Xy1))))))))))))))))).
