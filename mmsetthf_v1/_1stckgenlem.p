...
thf(almcvg_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((cwi @ Xph @ (cwcel @ XP @ XU)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((cwi @ Xph @ (cwcel @ XU @ XJ)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XU)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))))).
...
thf(c_1stckgenlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwf @ ccn @ XX @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ XA2 @ (ccfv @ XJ @ cclm))) => (cwi @ Xph @ (cwcel @ (cco @ XJ @ (ccun @ (ccrn @ XF) @ (ccsn @ XA2)) @ ccrest) @ cccmp))))))))))).
