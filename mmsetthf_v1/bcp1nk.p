...
thf(abcp1n_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwceq @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccbc) @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccmin) @ ccdiv) @ ccmul)))))).
...
thf(abcrpcl_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ (cco @ XN @ XK @ ccbc) @ ccrp))))).
...
thf(cbcp1nk_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwceq @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XK @ cc1 @ ccaddc) @ ccbc) @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv) @ ccmul)))))).
