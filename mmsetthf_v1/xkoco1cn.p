...
thf(axkobval_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XX @ Xv @ Xf1 @ Xs1) @ (ccuni @ XR))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XK @ Xx3 @ Xf1) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ XR @ (ccv @ Xx3) @ ccrest) @ cccmp)) @ (^ [Xx3:$i] : (ccpw @ (XX @ Xv @ Xf1 @ Xs1))))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xv @ Xf1 @ Xk) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xv:$i] : (XK @ Xx3 @ Xf1))) @ (^ [Xk:$i] : (^ [Xv:$i] : XS)) @ (^ [Xk:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xk)) @ (ccv @ Xv))) @ (^ [Xf1:$i] : (cco @ XR @ XS @ cccn))))))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (ccrn @ (XT @ Xx3 @ Xv @ Xf1 @ Xk)) @ (ccab @ (^ [Xs1:$i] : (cwrex @ (^ [Xk:$i] : (cwrex @ (^ [Xv:$i] : (cwa @ (cwcel @ (cco @ XR @ (ccv @ Xk) @ ccrest) @ cccmp) @ (cwceq @ (ccv @ Xs1) @ (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xk)) @ (ccv @ Xv))) @ (^ [Xf1:$i] : (cco @ XR @ XS @ cccn)))))) @ (^ [Xv:$i] : XS))) @ (^ [Xk:$i] : (ccpw @ (XX @ Xv @ Xf1 @ Xs1)))))))))))))))))))).
...
thf(axkoopn_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : (cwceq @ (XX @ Xf1) @ (ccuni @ XR))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XR @ cctop))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XS @ cctop))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwss @ XA2 @ (XX @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (cco @ XR @ XA2 @ ccrest) @ cccmp))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XU @ XS))) => (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (ccv @ Xf1) @ XA2) @ XU)) @ (^ [Xf1:$i] : (cco @ XR @ XS @ cccn))) @ (cco @ XS @ XR @ ccxko))))))))))))))))).
...
thf(aimacmp_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ cccmp)) @ (cwcel @ (cco @ XK @ (ccima @ XF @ XA2) @ ccrest) @ cccmp))))))).
...
thf(asubbascn_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XB2 @ (XV @ Xy1)))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ XK @ (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg)))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XK @ (ccfv @ XY @ cctopon)))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XB2))))))))))))))))))).
...
thf(axkotf_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xf1:$i] : (cwceq @ (XX @ Xv @ Xf1) @ (ccuni @ XR)))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (cwceq @ (XK @ Xx3 @ Xf1) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ XR @ (ccv @ Xx3) @ ccrest) @ cccmp)) @ (^ [Xx3:$i] : (ccpw @ (XX @ Xv @ Xf1)))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xv @ Xf1 @ Xk) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xv:$i] : (XK @ Xx3 @ Xf1))) @ (^ [Xk:$i] : (^ [Xv:$i] : XS)) @ (^ [Xk:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xk)) @ (ccv @ Xv))) @ (^ [Xf1:$i] : (cco @ XR @ XS @ cccn))))))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwf @ (ccxp @ (XK @ Xx3 @ Xf1) @ XS) @ (ccpw @ (cco @ XR @ XS @ cccn)) @ (XT @ Xx3 @ Xv @ Xf1 @ Xk))))))))))))))).
thf(acntop1_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwcel @ XJ @ cctop)))))).
thf(axkoval_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xf1:$i] : (cwceq @ (XX @ Xv @ Xf1) @ (ccuni @ XR)))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (cwceq @ (XK @ Xx3 @ Xf1) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ XR @ (ccv @ Xx3) @ ccrest) @ cccmp)) @ (^ [Xx3:$i] : (ccpw @ (XX @ Xv @ Xf1)))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XT @ Xx3 @ Xv @ Xf1 @ Xk) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xv:$i] : (XK @ Xx3 @ Xf1))) @ (^ [Xk:$i] : (^ [Xv:$i] : XS)) @ (^ [Xk:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xk)) @ (ccv @ Xv))) @ (^ [Xf1:$i] : (cco @ XR @ XS @ cccn))))))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ cctop)) @ (cwceq @ (cco @ XS @ XR @ ccxko) @ (ccfv @ (ccfv @ (ccrn @ (XT @ Xx3 @ Xv @ Xf1 @ Xk)) @ ccfi) @ cctg)))))))))))))))).
thf(cxkoco1cn_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XT @ cctop)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XR @ XS @ cccn))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xg1:$i] : (cco @ XS @ XT @ cccn)) @ (^ [Xg1:$i] : (cccom @ (ccv @ Xg1) @ XF))) @ (cco @ (cco @ XT @ XS @ ccxko) @ (cco @ XT @ XR @ ccxko) @ cccn))))))))))).
