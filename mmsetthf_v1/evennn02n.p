...
thf(arexss_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : XB2)))))))).
thf(aeven2n_thm,axiom,(! [XN:($i > $o)] : (cwb @ (cwbr @ cc2 @ XN @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ XN)) @ (^ [Xn:$i] : ccz))))).
thf(cevennn02n_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwbr @ cc2 @ XN @ ccdvds) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ XN)) @ (^ [Xn:$i] : ccn0)))))).
