...
thf(awwlksnwwlksnonOLD_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XG @ XU)) @ (cwb @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwlksnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))))).
...
thf(awwlknonOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwb @ (cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon))) @ (cw3a @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwceq @ (ccfv @ ccc0 @ XW) @ XA2) @ (cwceq @ (ccfv @ XN @ XW) @ XB2)))))))))))).
...
thf(awspthnonOLDOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwb @ (cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwspthsnon))) @ (cwa @ (cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon))) @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XW @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson)))))))))))))))).
thf(cwspthsnwspthsnonOLD_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XG @ XU)) @ (cwb @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwspthsn)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwspthsnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))))).
