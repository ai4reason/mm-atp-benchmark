...
thf(cinfmrgelbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwcel @ XB2 @ ccr)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (cwbr @ XB2 @ (ccinf @ XA2 @ ccr @ cclt) @ ccle))))).
