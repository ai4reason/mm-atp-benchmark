...
thf(auspgredg2vlem_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xe:$i] : (cwceq @ (XV @ Xe) @ (ccfv @ (XG @ Xe) @ ccvtx))) => ((! [Xz:$i] : (! [Xe:$i] : (cwceq @ (XE @ Xz) @ (ccfv @ (XG @ Xe) @ ccedg)))) => ((! [Xz:$i] : (! [Xe:$i] : (cwceq @ (XA2 @ Xz @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xz)))))) => (! [Xz:$i] : (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ (XG @ Xe) @ ccuspgr) @ (cwcel @ XY @ (XA2 @ Xz @ Xe))) @ (cwcel @ (ccrio @ (^ [Xz:$i] : (cwceq @ XY @ (ccpr @ XN @ (ccv @ Xz)))) @ (^ [Xz:$i] : (XV @ Xe))) @ (XV @ Xe))))))))))))))).
thf(aralrimivva_thm,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) @ (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1)))) @ (Xps @ Xx3 @ Xy1)))) => (cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(aex_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ Xph @ (cwi @ Xps @ Xch))))))).
thf(ccsb_tp,type,(ccsb : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ariotaeqimp_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccrio @ (^ [Xa:$i] : (cwceq @ XX @ (XA2 @ Xa))) @ (^ [Xa:$i] : XV))) => ((cwceq @ XJ @ (ccrio @ (^ [Xa:$i] : (cwceq @ XY @ (XA2 @ Xa))) @ (^ [Xa:$i] : XV))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwreu @ (^ [Xa:$i] : (cwceq @ XX @ (XA2 @ Xa))) @ (^ [Xa:$i] : XV)))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwreu @ (^ [Xa:$i] : (cwceq @ XY @ (XA2 @ Xa))) @ (^ [Xa:$i] : XV)))) => (! [Xa:$i] : (cwi @ (cwa @ (Xph @ Xa) @ (cwceq @ XI @ XJ)) @ (cwceq @ XX @ XY))))))))))))))).
