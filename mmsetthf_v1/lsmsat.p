...
thf(clsmsat_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ (Xc_0 @ Xp) @ (ccfv @ XW @ cc0g))) => ((! [Xp:$i] : (cwceq @ (XS @ Xp) @ (ccfv @ XW @ cclss))) => ((cwceq @ Xc_po @ (ccfv @ XW @ cclsm)) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XW @ cclmod))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XT @ (XS @ Xp)))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XU @ (XS @ Xp)))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XQ @ XA2))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwne @ XT @ (ccsn @ (Xc_0 @ Xp))))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwss @ XQ @ (cco @ XT @ XU @ Xc_po)))) => (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwss @ (ccv @ Xp) @ XT) @ (cwss @ XQ @ (cco @ (ccv @ Xp) @ XU @ Xc_po)))) @ (^ [Xp:$i] : XA2)))))))))))))))))))))))).
