...
thf(cfnunsn_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccvv)) => ((cwi @ Xph @ (cwcel @ XY @ ccvv)) => ((cwi @ Xph @ (cwfn @ XF @ XD)) => ((cwceq @ XG @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY)))) => ((cwceq @ XE @ (ccun @ XD @ (ccsn @ XX))) => ((cwi @ Xph @ (cwn @ (cwcel @ XX @ XD))) => (cwi @ Xph @ (cwfn @ XG @ XE)))))))))))))))).
