...
thf(cuspgropssxp_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((cwceq @ XP @ (ccpw @ (ccfv @ XV @ ccspr))) => ((! [Xv:$i] : (! [Xe:$i] : (! [Xq:$i] : (cwceq @ (XG @ Xv @ Xe @ Xq) @ (ccopab @ (^ [Xv:$i] : (^ [Xe:$i] : (cwa @ (cwceq @ (ccv @ Xv) @ XV) @ (cwrex @ (^ [Xq:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xq) @ ccvtx) @ (ccv @ Xv)) @ (cwceq @ (ccfv @ (ccv @ Xq) @ ccedg) @ (ccv @ Xe)))) @ (^ [Xq:$i] : ccuspgr)))))))))) => (! [Xv:$i] : (! [Xe:$i] : (! [Xq:$i] : (cwi @ (cwcel @ XV @ (XW @ Xq)) @ (cwss @ (XG @ Xv @ Xe @ Xq) @ (ccxp @ (XW @ Xq) @ XP))))))))))))).
