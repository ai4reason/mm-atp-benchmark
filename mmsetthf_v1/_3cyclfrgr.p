...
thf(aumgr3cyclex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XV @ Xf1 @ Xp) @ (ccfv @ XG @ ccvtx)))) => ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xf1 @ Xp) @ (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccumgr) @ (cw3a @ (cwcel @ XA2 @ (XV @ Xf1 @ Xp)) @ (cwcel @ XB2 @ (XV @ Xf1 @ Xp)) @ (cwcel @ XC @ (XV @ Xf1 @ Xp))) @ (cw3a @ (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XC @ XA2) @ (XE @ Xf1 @ Xp)))) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cccycls)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc3) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ XA2)))))))))))))))))).
thf(c_3cyclfrgr_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XV @ Xf1 @ Xp) @ (ccfv @ XG @ ccvtx)))) => (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccfrgr) @ (cwbr @ cc1 @ (ccfv @ (XV @ Xf1 @ Xp) @ cchash) @ cclt)) @ (cwral @ (^ [Xv:$i] : (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cccycls)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc3) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccv @ Xv)))))))) @ (^ [Xv:$i] : (XV @ Xf1 @ Xp)))))))))).
