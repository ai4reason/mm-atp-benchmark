...
thf(aop2ndb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwceq @ (ccint @ (ccint @ (ccint @ (cccnv @ (ccsn @ (ccop @ XA2 @ XB2)))))) @ XB2)))))).
...
thf(c_2ndval2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ (cwceq @ (ccfv @ XA2 @ cc2nd) @ (ccint @ (ccint @ (ccint @ (cccnv @ (ccsn @ XA2))))))))).
