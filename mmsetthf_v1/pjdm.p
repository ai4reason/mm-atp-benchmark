...
thf(cpjdm_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XP @ (ccfv @ XW @ ccpj1)) => ((cwceq @ XK @ (ccfv @ XW @ ccpj)) => (cwb @ (cwcel @ XT @ (ccdm @ XK)) @ (cwa @ (cwcel @ XT @ XL) @ (cwf @ XV @ XV @ (cco @ XT @ (ccfv @ XT @ Xc_pe) @ XP))))))))))))))))).
