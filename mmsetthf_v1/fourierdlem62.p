...
thf(alhop_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((! [Xz:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xz) @ ccr))) => ((! [Xz:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xz) @ ccr @ XF))) => ((! [Xz:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xz) @ ccr @ XG))) => ((cwi @ Xph @ (cwcel @ XI @ (ccfv @ (ccrn @ ccioo) @ cctg))) => ((cwi @ Xph @ (cwcel @ XB2 @ XI)) => ((cwceq @ XD @ (ccdif @ XI @ (ccsn @ XB2))) => ((cwi @ Xph @ (cwss @ XD @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => ((cwi @ Xph @ (cwss @ XD @ (ccdm @ (cco @ ccr @ XG @ ccdv)))) => ((cwi @ Xph @ (cwcel @ ccc0 @ (cco @ XF @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ ccc0 @ (cco @ XG @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccima @ XG @ XD)))) => ((cwi @ Xph @ (cwn @ (cwcel @ ccc0 @ (ccima @ (cco @ ccr @ XG @ ccdv) @ XD)))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : XD) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv))) @ XB2 @ cclimc))) => (cwi @ Xph @ (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : XD) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xz) @ XG) @ ccdiv))) @ XB2 @ cclimc))))))))))))))))))))))))).
...
thf(asncldre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccsn @ XA2) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))).
...
thf(advasinbx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccfv @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccsin) @ ccmul))) @ ccdv) @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (ccfv @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ cccos) @ ccmul)))))))).
...
thf(acnlimc_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwss @ XA2 @ ccc) @ (cwb @ (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf)) @ (cwa @ (cwf @ XA2 @ ccc @ XF) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ XF @ (ccv @ Xx3) @ cclimc))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(acosne0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)))).
...
thf(areclimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ cc1 @ (XB2 @ Xx3) @ ccdiv))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XC @ (cco @ (XF @ Xx3) @ XD @ cclimc)))) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (cco @ cc1 @ XC @ ccdiv) @ (cco @ (XG @ Xx3) @ XD @ cclimc))))))))))))))))).
...
thf(arestopnb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ XV)) @ (cw3a @ (cwcel @ XB2 @ XJ) @ (cwss @ XB2 @ XA2) @ (cwss @ XC @ XB2))) @ (cwb @ (cwcel @ XC @ XJ) @ (cwcel @ XC @ (cco @ XJ @ XA2 @ ccrest)))))))))).
...
thf(cfourierdlem62_conj,conjecture,(! [XK:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XK @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ ccc0) @ cc1 @ (cco @ (ccv @ Xy1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => (! [Xy1:$i] : (cwcel @ (XK @ Xy1) @ (cco @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccr @ cccncf)))))).
