...
thf(aisclwwlknOLD_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwb @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlknold)) @ (cwa @ (cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) @ (cwceq @ (ccfv @ XW @ cchash) @ XN)))))))).
...
thf(aiswwlksnx_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xi:$i] : (cwceq @ (XV @ Xi) @ (ccfv @ XG @ ccvtx))) => ((! [Xi:$i] : (cwceq @ (XE @ Xi) @ (ccfv @ XG @ ccedg))) => (! [Xi:$i] : (cwi @ (cwcel @ (XN @ Xi) @ ccn0) @ (cwb @ (cwcel @ XW @ (cco @ (XN @ Xi) @ XG @ ccwwlksn)) @ (cw3a @ (cwcel @ XW @ (ccword @ (XV @ Xi))) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XW)) @ (XE @ Xi))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwceq @ (ccfv @ XW @ cchash) @ (cco @ (XN @ Xi) @ cc1 @ ccaddc)))))))))))))).
thf(cclwwlknwwlksnOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlknold))) @ (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XG @ ccwwlksn))))))).
