...
thf(cfunfvima2d_conj,conjecture,(! [Xph:$o] : (! [Xx3:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccima @ XF @ XA2)))))))))).
