...
thf(cupgrpredgv_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwa @ (cwcel @ XM @ XU) @ (cwcel @ XN @ XW)) @ (cwcel @ (ccpr @ XM @ XN) @ XE)) @ (cwa @ (cwcel @ XM @ XV) @ (cwcel @ XN @ XV))))))))))))).
