...
thf(cmdslmd1lem3_conj,conjecture,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwa @ (cwa @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwbr @ XB2 @ XA2 @ ccdmd)) @ (cwa @ (cwa @ (cwss @ XA2 @ XC) @ (cwss @ XA2 @ XD)) @ (cwa @ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)) @ (cwss @ XD @ (cco @ XA2 @ XB2 @ cchj)))))) @ (cwi @ (cwi @ (cwss @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XD) @ (cwss @ (ccin @ (cco @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XC @ cchj) @ XD) @ (cco @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ (ccin @ XC @ XD) @ cchj))) @ (cwi @ (cwa @ (cwss @ (ccin @ (ccin @ XC @ XB2) @ (ccin @ XD @ XB2)) @ (ccv @ Xx3)) @ (cwss @ (ccv @ Xx3) @ (ccin @ XD @ XB2))) @ (cwss @ (ccin @ (cco @ (ccv @ Xx3) @ (ccin @ XC @ XB2) @ cchj) @ (ccin @ XD @ XB2)) @ (cco @ (ccv @ Xx3) @ (ccin @ (ccin @ XC @ XB2) @ (ccin @ XD @ XB2)) @ cchj))))))))))))))).
