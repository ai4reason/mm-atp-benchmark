...
thf(adfun2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccun @ XA2 @ XB2) @ (ccdif @ ccvv @ (ccdif @ (ccdif @ ccvv @ XA2) @ XB2)))))).
...
thf(cdfun3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccun @ XA2 @ XB2) @ (ccdif @ ccvv @ (ccin @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2))))))).
