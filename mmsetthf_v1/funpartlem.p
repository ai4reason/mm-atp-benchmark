...
thf(cfunpartlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdm @ (ccin @ (cccom @ (ccimage @ XF) @ ccsingle) @ (ccxp @ ccvv @ ccsingles)))) @ (cwex @ (^ [Xx3:$i] : (cwceq @ (ccima @ XF @ (ccsn @ XA2)) @ (ccsn @ (ccv @ Xx3))))))))).
