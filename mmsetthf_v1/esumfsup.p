...
thf(aesumfzf_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : (cwi @ (cwa @ (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xk)) @ (cwcel @ XN @ ccn)) @ (cwceq @ (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) @ (ccfv @ XN @ (ccseq @ ccxad @ (XF @ Xk) @ cc1))))))))).
...
thf(assnnssfz_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccin @ (ccpw @ ccn) @ ccfn)) @ (cwrex @ (^ [Xn:$i] : (cwss @ XA2 @ (cco @ cc1 @ (ccv @ Xn) @ ccfz))) @ (^ [Xn:$i] : ccn))))).
...
thf(cesumfsup_conj,conjecture,(! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : (cwi @ (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xk)) @ (cwceq @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) @ (ccsup @ (ccrn @ (ccseq @ ccxad @ (XF @ Xk) @ cc1)) @ ccxr @ cclt))))))).
