...
thf(aconnhmph_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwbr @ XJ @ XK @ cchmph) @ (cwi @ (cwcel @ XJ @ ccconn) @ (cwcel @ XK @ ccconn)))))).
thf(cxrconn_conj,conjecture,(cwcel @ (ccfv @ ccle @ ccordt) @ ccconn)).
