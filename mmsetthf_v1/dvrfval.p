...
thf(adf_dvr_ax,axiom,(cwceq @ ccdvr @ (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xr) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xr) @ ccui))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xr) @ ccinvr)) @ (ccfv @ (ccv @ Xr) @ ccmulr))))))))).
...
thf(cdvrfval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_dv @ Xx3 @ Xy1) @ (ccfv @ XR @ ccdvr)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_dv @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XU)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XI) @ Xc_x))))))))))))))))))).
