...
thf(aliminfresre_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ ccr) @ cclsi) @ (ccfv @ XF @ cclsi)))))))).
thf(climinfresuz_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XF @ XV)) => ((cwi @ Xph @ (cwss @ (ccdm @ (ccres @ XF @ ccr)) @ ccz)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccres @ XF @ XZ) @ cclsi) @ (ccfv @ XF @ cclsi))))))))))))).
