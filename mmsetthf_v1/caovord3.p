...
thf(ccaovord3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ XS) @ (cwb @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XF) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XF) @ XR)))))) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XF)))) => ((cwcel @ XD @ ccvv) => (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS)) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ (cco @ XC @ XD @ XF))) @ (cwb @ (cwbr @ XA2 @ XC @ XR) @ (cwbr @ XD @ XB2 @ XR))))))))))))))))).
