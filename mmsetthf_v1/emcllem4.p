...
thf(arelogefd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cce) @ cclog) @ XA2)))))).
thf(arpge0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => (cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)))))).
thf(cemcllem4_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xm @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmin)))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xm @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ cclog) @ ccmin)))))) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ cclog))))) => (! [Xn:$i] : (cwbr @ (XH @ Xn) @ ccc0 @ ccli))))))))).
