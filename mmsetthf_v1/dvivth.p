...
thf(advivthlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwbr @ XM @ XN @ cclt)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ XM @ (cco @ ccr @ XF @ ccdv)) @ ccicc))) => ((! [Xy1:$i] : (cwceq @ (XG @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ XC @ (ccv @ Xy1) @ ccmul) @ ccmin))))) => (cwi @ Xph @ (cwcel @ XC @ (ccrn @ (cco @ ccr @ XF @ ccdv)))))))))))))))))))).
...
thf(cdvivth_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ XA2 @ XB2 @ ccioo))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ ccr @ XF @ ccdv)) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwi @ Xph @ (cwss @ (cco @ (ccfv @ XM @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdv)) @ ccicc) @ (ccrn @ (cco @ ccr @ XF @ ccdv))))))))))))))).
