...
thf(aopnssneib_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XS @ XJ) @ (cwss @ XN @ XX)) @ (cwb @ (cwss @ XS @ XN) @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))))).
thf(aneiss_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) @ (cwss @ XR @ XS)) @ (cwcel @ XN @ (ccfv @ XR @ (ccfv @ XJ @ ccnei))))))))).
thf(cneissex_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))) @ (cwrex @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwss @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwcel @ XN @ (ccfv @ (ccv @ Xy1) @ (ccfv @ XJ @ ccnei))))))) @ (^ [Xx3:$i] : (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))).
