...
thf(cfctop_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn) @ (cwceq @ (ccv @ Xx3) @ cc0))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ cctopon))))))).
