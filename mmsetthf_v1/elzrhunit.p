...
thf(celzrhunit_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccdr) @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0)) @ (cwa @ (cwcel @ XM @ ccz) @ (cwne @ XM @ ccc0))) @ (cwcel @ (ccfv @ XM @ XL) @ (ccfv @ XR @ ccui)))))))))))).
