...
thf(celpaddatriN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ Xc_pl @ (ccfv @ XK @ ccpadd)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cclat) @ (cwss @ XX @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwcel @ XR @ XX) @ (cwcel @ XS @ XA2) @ (cwbr @ XS @ (cco @ XR @ XQ @ Xc_or) @ Xc_le))) @ (cwcel @ XS @ (cco @ XX @ (ccsn @ XQ) @ Xc_pl))))))))))))))))).
