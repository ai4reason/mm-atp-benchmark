...
thf(celo12r_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XM @ ccr)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ XC @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ XM @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ XF @ cco1))))))).
