...
thf(asge0ltfirpmpt2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XY @ Xx3) @ ccrp))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ ccr))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ (cco @ (ccsu @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (XY @ Xx3) @ ccaddc) @ cclt)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))))))))))))).
...
thf(asge0pnffsumgt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xx3 @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ ccpnf))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XY @ Xk) @ ccr))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xx3:$i] : (cwbr @ (XY @ Xk) @ (ccsu @ (ccv @ Xx3) @ (^ [Xk:$i] : (XB2 @ Xk))) @ cclt)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))))))))))))).
thf(anfeq1_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwnf @ (^ [Xx3:$i] : (cwceq @ (XA2 @ Xx3) @ XB2))))))).
thf(csge0gtfsumgt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xy1:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xy1 @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XC @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XC @ Xk) @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ cclt))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (XC @ Xk) @ (ccsu @ (ccv @ Xy1) @ (^ [Xk:$i] : (XB2 @ Xk))) @ cclt)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))))))))))))).
