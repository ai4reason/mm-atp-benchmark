...
thf(clindff1_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XL @ (ccfv @ XW @ ccsca)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XL @ ccnzr) @ (cwbr @ XF @ XW @ cclindf)) @ (cwf1 @ (ccdm @ XF) @ XB2 @ XF))))))))).
