...
thf(ageoisum1c_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XR @ ccc) @ (cwbr @ (ccfv @ XR @ ccabs) @ cc1 @ cclt)) @ (cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ XR @ (ccv @ Xk) @ ccexp) @ ccmul))) @ (cco @ (cco @ XA2 @ XR @ ccmul) @ (cco @ cc1 @ XR @ ccmin) @ ccdiv)))))).
thf(aoveq12i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XC @ XD) => (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XD @ XF)))))))))).
thf(adivreci_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwne @ XB2 @ ccc0) => (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XA2 @ (cco @ cc1 @ XB2 @ ccdiv) @ ccmul)))))))).
...
thf(amulcani_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwne @ XC @ ccc0) => (cwb @ (cwceq @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul)) @ (cwceq @ XA2 @ XB2)))))))))).
...
thf(c_0_999____conj,conjecture,(cwceq @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ cc9 @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccv @ Xk) @ ccexp) @ ccdiv))) @ cc1)).
