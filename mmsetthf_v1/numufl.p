...
thf(afilssufilg_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ (ccpw @ (ccpw @ XX)) @ (ccdm @ cccrd))) @ (cwrex @ (^ [Xf1:$i] : (cwss @ XF @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil))))))).
...
thf(cnumufl_conj,conjecture,(! [XX:($i > $o)] : (cwi @ (cwcel @ (ccpw @ (ccpw @ XX)) @ (ccdm @ cccrd)) @ (cwcel @ XX @ ccufl)))).
