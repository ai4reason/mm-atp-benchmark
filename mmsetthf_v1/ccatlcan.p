...
thf(cccatlcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccword @ XX)) @ (cwcel @ XB2 @ (ccword @ XX)) @ (cwcel @ XC @ (ccword @ XX))) @ (cwb @ (cwceq @ (cco @ XC @ XA2 @ ccconcat) @ (cco @ XC @ XB2 @ ccconcat)) @ (cwceq @ XA2 @ XB2)))))))).
