...
thf(coteq123d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwceq @ XC @ XD)) => ((cwi @ Xph @ (cwceq @ XE @ XF)) => (cwi @ Xph @ (cwceq @ (ccotp @ XA2 @ XC @ XE) @ (ccotp @ XB2 @ XD @ XF)))))))))))))).
