...
thf(amopick2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (cwi @ (cw3a @ (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3)))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xch @ Xx3))))) @ (cwex @ (^ [Xx3:$i] : (cw3a @ (Xph @ Xx3) @ (Xps @ Xx3) @ (Xch @ Xx3))))))))).
...
thf(cmoantr_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (cwi @ (cwmo @ (^ [Xx3:$i] : (Xps @ Xx3))) @ (cwi @ (cwa @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3)))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xps @ Xx3) @ (Xch @ Xx3))))) @ (cwex @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xch @ Xx3)))))))))).
