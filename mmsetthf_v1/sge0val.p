...
thf(adf_sumge0_ax,axiom,(cwceq @ ccsumge0 @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccif @ (cwcel @ ccpnf @ (ccrn @ (ccv @ Xx3))) @ ccpnf @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccdm @ (ccv @ Xx3))) @ ccfn)) @ (^ [Xy1:$i] : (ccsu @ (ccv @ Xy1) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xw) @ (ccv @ Xx3))))))) @ ccxr @ cclt)))))).
...
thf(csge0val_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [Xy1:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ (XX @ Xw) @ (XV @ Xy1 @ Xw)) @ (cwf @ (XX @ Xw) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) @ (cwceq @ (ccfv @ XF @ ccsumge0) @ (ccif @ (cwcel @ ccpnf @ (ccrn @ XF)) @ ccpnf @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : (ccin @ (ccpw @ (XX @ Xw)) @ ccfn)) @ (^ [Xy1:$i] : (ccsu @ (ccv @ Xy1) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xw) @ XF)))))) @ ccxr @ cclt)))))))))).
