...
thf(aitg2add_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => ((cwi @ Xph @ (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XG)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XG @ ccitg2) @ ccr)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccitg2) @ (cco @ (ccfv @ XF @ ccitg2) @ (ccfv @ XG @ ccitg2) @ ccaddc))))))))))))).
