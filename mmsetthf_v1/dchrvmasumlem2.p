...
thf(cdchrvmasumlem2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xd:$i] : (cwceq @ (XZ @ Xd) @ (ccfv @ (XN @ Xd) @ cczn))) => ((! [Xd:$i] : (cwceq @ XL @ (ccfv @ (XZ @ Xd) @ cczrh))) => ((! [Xd:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xd) @ ccn))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : (cwceq @ (XG @ Xx3 @ Xm @ Xd) @ (ccfv @ (XN @ Xd) @ ccdchr))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : (cwceq @ (XD @ Xd) @ (ccfv @ (XG @ Xx3 @ Xm @ Xd) @ ccbs))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : (cwceq @ (Xc_1 @ Xd) @ (ccfv @ (XG @ Xx3 @ Xm @ Xd) @ cc0g))))) => ((! [Xd:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xd)))) => ((! [Xd:$i] : (cwi @ Xph @ (cwne @ XX @ (Xc_1 @ Xd)))) => ((! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ ccrp)) @ (cwcel @ (XF @ Xm) @ ccc))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : (cwi @ (cwceq @ (ccv @ Xm) @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ ccdiv)) @ (cwceq @ (XF @ Xm) @ (XK @ Xx3 @ Xd)))))) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccico))) => ((cwi @ Xph @ (cwcel @ XT @ ccc)) => ((! [Xm:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ (cco @ cc3 @ ccpnf @ ccico))) @ (cwbr @ (ccfv @ (cco @ (XF @ Xm) @ XT @ ccmin) @ ccabs) @ (cco @ XC @ (cco @ (ccfv @ (ccv @ Xm) @ cclog) @ (ccv @ Xm) @ ccdiv) @ ccmul) @ ccle))) => ((cwi @ Xph @ (cwcel @ XR @ ccr)) => ((cwi @ Xph @ (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (cco @ (XF @ Xm) @ XT @ ccmin) @ ccabs) @ XR @ ccle)) @ (^ [Xm:$i] : (cco @ cc1 @ cc3 @ ccico)))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (ccfv @ (cco @ (XK @ Xx3 @ Xd) @ XT @ ccmin) @ ccabs) @ (ccv @ Xd) @ ccdiv))))) @ cco1))))))))))))))))))))))))))))))).
