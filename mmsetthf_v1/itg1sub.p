...
thf(citg1sub_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ (ccdm @ ccitg1))) @ (cwceq @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccitg1) @ (cco @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccmin)))))).
