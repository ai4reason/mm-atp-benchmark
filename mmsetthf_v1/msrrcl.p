...
thf(andmfvrcl_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ (ccdm @ XF) @ XS) => ((cwn @ (cwcel @ cc0 @ XS)) => (cwi @ (cwcel @ (ccfv @ XA2 @ XF) @ XS) @ (cwcel @ XA2 @ XS)))))))).
...
thf(ampstssv_thm,axiom,(! [XP:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => (cwss @ XP @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv)))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(abiimpa_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cmsrrcl_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ XT @ ccmpst)) => ((cwceq @ XR @ (ccfv @ XT @ ccmsr)) => (cwi @ (cwceq @ (ccfv @ XX @ XR) @ (ccfv @ XY @ XR)) @ (cwb @ (cwcel @ XX @ XP) @ (cwcel @ XY @ XP))))))))))).
