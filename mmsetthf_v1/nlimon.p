...
thf(cnlimon_conj,conjecture,(cwceq @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwceq @ (ccv @ Xx3) @ cc0) @ (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccsuc @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : ccon0)))) @ (^ [Xx3:$i] : ccon0)) @ (ccrab @ (^ [Xx3:$i] : (cwn @ (cwlim @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))).
