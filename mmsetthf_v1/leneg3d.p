...
thf(cleneg3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (ccneg @ XA2) @ XB2 @ ccle) @ (cwbr @ (ccneg @ XB2) @ XA2 @ ccle))))))))).
