...
thf(aprdsdsfn_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwcel @ XR @ XW)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwi @ Xph @ (cwceq @ (ccdm @ XR) @ XI)) => ((cwceq @ XD @ (ccfv @ XP @ ccds)) => (cwi @ Xph @ (cwfn @ XD @ (ccxp @ XB2 @ XB2))))))))))))))))))).
...
thf(cressprdsds_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XY @ Xx3) @ (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XR @ Xx3))) @ ccprds)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XH @ Xx3) @ (cco @ (XT @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (XR @ Xx3) @ (XA2 @ Xx3) @ ccress))) @ ccprds)))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XH @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ (XY @ Xx3) @ ccds))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ (XH @ Xx3) @ ccds))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xx3) @ (XU @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XT @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XI @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XR @ Xx3) @ (XX @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XA2 @ Xx3) @ (XZ @ Xx3)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XE @ Xx3) @ (ccres @ (XD @ Xx3) @ (ccxp @ (XB2 @ Xx3) @ (XB2 @ Xx3))))))))))))))))))))))))))))))))).
