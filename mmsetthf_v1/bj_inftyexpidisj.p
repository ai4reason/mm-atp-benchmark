...
thf(aelopg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwcel @ XC @ (ccop @ XA2 @ XB2)) @ (cwo @ (cwceq @ XC @ (ccsn @ XA2)) @ (cwceq @ XC @ (ccpr @ XA2 @ XB2))))))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(abj_imn3ani_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwn @ (cw3a @ Xph @ Xps @ Xch)) => (cwi @ (cwa @ Xph @ Xps) @ (cwn @ Xch))))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aen3lp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwn @ (cw3a @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XA2))))))).
thf(aopprc1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ ccvv)) @ (cwceq @ (ccop @ XA2 @ XB2) @ cc0))))).
...
thf(cbj_inftyexpidisj_conj,conjecture,(! [XA2:($i > $o)] : (cwn @ (cwcel @ (ccfv @ XA2 @ ccinftyexpi) @ ccc)))).
