...
thf(cclwlkcompbp_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ cc1st)) => ((cwceq @ XP @ (ccfv @ XW @ cc2nd)) => (cwi @ (cwcel @ XW @ (ccfv @ XG @ ccclwlks)) @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP))))))))))).
