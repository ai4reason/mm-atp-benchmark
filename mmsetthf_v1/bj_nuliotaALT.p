...
thf(aiotassuni_thm,axiom,(! [Xph:($i > $o)] : (cwss @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccuni @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
...
thf(cbj_nuliotaALT_conj,conjecture,(cwceq @ cc0 @ (ccio @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))).
