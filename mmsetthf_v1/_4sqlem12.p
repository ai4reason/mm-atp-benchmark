...
thf(a_4sqlem11_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwcel @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwceq @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ (cco @ (cco @ cc2 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmul) @ cc1 @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwcel @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccprime)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xm:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xm:$i] : (cwceq @ (ccv @ Xu) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmo))) @ (^ [Xm:$i] : (cco @ ccc0 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccfz)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xm) @ (ccmpt @ (^ [Xv:$i] : (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm)) @ (^ [Xv:$i] : (cco @ (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ cc1 @ ccmin) @ (ccv @ Xv) @ ccmin))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwne @ (ccin @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm) @ (ccrn @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xm))) @ cc0)))))))))))))))))))))).
...
thf(amodsubdir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccrp)) @ (cwb @ (cwbr @ (cco @ XB2 @ XC @ ccmo) @ (cco @ XA2 @ XC @ ccmo) @ ccle) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccmo) @ (cco @ (cco @ XA2 @ XC @ ccmo) @ (cco @ XB2 @ XC @ ccmo) @ ccmin)))))))).
...
thf(advdssubr_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ XM @ (cco @ XN @ XM @ ccmin) @ ccdvds)))))).
...
thf(agzreim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwcel @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ ccgz))))).
...
thf(c_4sqlem12_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xn) @ (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwcel @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwceq @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ (cco @ (cco @ cc2 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmul) @ cc1 @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwcel @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccprime)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xm:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xm:$i] : (cwceq @ (ccv @ Xu) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmo))) @ (^ [Xm:$i] : (cco @ ccc0 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccfz)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xm:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xk @ Xm) @ (ccmpt @ (^ [Xv:$i] : (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm)) @ (^ [Xv:$i] : (cco @ (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ cc1 @ ccmin) @ (ccv @ Xv) @ ccmin)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw) @ (cwrex @ (^ [Xk:$i] : (cwrex @ (^ [Xu:$i] : (cwceq @ (cco @ (cco @ (ccfv @ (ccv @ Xu) @ ccabs) @ cc2 @ ccexp) @ cc1 @ ccaddc) @ (cco @ (ccv @ Xk) @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmul))) @ (^ [Xu:$i] : ccgz))) @ (^ [Xk:$i] : (cco @ cc1 @ (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ cc1 @ ccmin) @ ccfz))))))))))))))))))))).
