...
thf(avc2OLD_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cc1st)) => ((cwceq @ XS @ (ccfv @ XW @ cc2nd)) => ((cwceq @ XX @ (ccrn @ XG)) => (cwi @ (cwa @ (cwcel @ XW @ ccvc) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ XA2 @ XA2 @ XG) @ (cco @ cc2 @ XA2 @ XS)))))))))))).
...
thf(cnv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ XA2 @ XA2 @ XG) @ (cco @ cc2 @ XA2 @ XS)))))))))))).
