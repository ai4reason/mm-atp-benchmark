...
thf(aisf34lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ XV) @ (cwf @ (ccpw @ XA2) @ (ccpw @ XA2) @ (XF @ Xx3))))))))).
...
thf(a_3eltr3g_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((cwceq @ XA2 @ XC) => ((cwceq @ XB2 @ XD) => (cwi @ Xph @ (cwcel @ XC @ XD))))))))))).
...
thf(aisf34lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwss @ (XX @ Xx3) @ XA2)) @ (cwceq @ (ccfv @ (XX @ Xx3) @ (XF @ Xx3)) @ (ccdif @ XA2 @ (XX @ Xx3))))))))))).
...
thf(afin33i_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfin3) @ (cwf @ ccom @ (ccpw @ XA2) @ XF) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) @ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))))).
thf(ainteqi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccint @ XA2) @ (ccint @ XB2)))))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(arnco2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccrn @ (cccom @ XA2 @ XB2)) @ (ccima @ XA2 @ (ccrn @ XB2)))))).
...
thf(aisf34lem5_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwa @ (cwss @ (XX @ Xx3) @ (ccpw @ XA2)) @ (cwne @ (XX @ Xx3) @ cc0))) @ (cwceq @ (ccfv @ (ccint @ (XX @ Xx3)) @ (XF @ Xx3)) @ (ccuni @ (ccima @ (XF @ Xx3) @ (XX @ Xx3)))))))))))).
thf(aunieqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ (ccuni @ XA2) @ (ccuni @ XB2)))))))).
thf(cwf1_tp,type,(cwf1 : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aisf34lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwss @ (XX @ Xx3) @ (ccpw @ XA2))) @ (cwceq @ (ccima @ (XF @ Xx3) @ (ccima @ (XF @ Xx3) @ (XX @ Xx3))) @ (XX @ Xx3)))))))))).
thf(cisf34lem7_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfin3) @ (cwf @ ccom @ (ccpw @ XA2) @ (XG @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ (XG @ Xx3)) @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ (XG @ Xx3)))) @ (^ [Xy1:$i] : ccom))) @ (cwcel @ (ccuni @ (ccrn @ (XG @ Xx3))) @ (ccrn @ (XG @ Xx3)))))))))).
