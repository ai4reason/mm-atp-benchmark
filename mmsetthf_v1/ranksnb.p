...
thf(aonsucmin_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccsuc @ XA2) @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : ccon0))))))).
thf(cranksnb_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwceq @ (ccfv @ (ccsn @ XA2) @ ccrnk) @ (ccsuc @ (ccfv @ XA2 @ ccrnk)))))).
