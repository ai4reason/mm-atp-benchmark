...
thf(asnunioo1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwceq @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XA2)) @ (cco @ XA2 @ XB2 @ ccico)))))).
...
thf(asnmbl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccsn @ XA2) @ (ccdm @ ccvol))))).
...
thf(avolsn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwceq @ (ccfv @ (ccsn @ XA2) @ ccvol) @ ccc0)))).
...
thf(avol0_thm,axiom,(cwceq @ (ccfv @ cc0 @ ccvol) @ ccc0)).
thf(aiffalse_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwn @ Xph) @ (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XB2)))))).
thf(cvolico_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) @ (ccif @ (cwbr @ XA2 @ XB2 @ cclt) @ (cco @ XB2 @ XA2 @ ccmin) @ ccc0)))))).
