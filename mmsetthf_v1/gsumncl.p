...
thf(cgsumncl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwceq @ XK @ (ccfv @ (XM @ Xk) @ ccbs))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccmnd))) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XN @ ccuz))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ XN @ XP @ ccfz))) @ (cwcel @ (XB2 @ Xk) @ XK))) => (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (cco @ (XM @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ XN @ XP @ ccfz)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccgsu) @ XK)))))))))))))).
