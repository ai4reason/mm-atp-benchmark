...
thf(cswopo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwcel @ (ccv @ Xz) @ XA2))) @ (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR) @ (cwn @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwcel @ (ccv @ Xz) @ XA2))) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwo @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR))))))) => (cwi @ Xph @ (cwpo @ XA2 @ XR)))))))).
