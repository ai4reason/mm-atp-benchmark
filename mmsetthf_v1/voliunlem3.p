...
thf(avoliunlem2_thm,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwf @ ccn @ (ccdm @ ccvol) @ XF))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwdisj @ (^ [Xi:$i] : ccn) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XF))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xx3 @ Xi @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccin @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccovol))))))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (ccuni @ (ccrn @ XF)) @ (ccdm @ ccvol))))))))))).
...
thf(avoliunlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwf @ ccn @ (ccdm @ ccvol) @ XF))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwdisj @ (^ [Xi:$i] : ccn) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XF))))) => ((! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xi @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccin @ (XE @ Xi) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccovol)))))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwss @ (XE @ Xi) @ ccr))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (ccfv @ (XE @ Xi) @ ccovol) @ ccr))) => (! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xi) @ (cwcel @ (ccv @ Xk) @ ccn)) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ (ccseq @ ccaddc @ (XH @ Xi @ Xn) @ cc1)) @ (ccfv @ (ccdif @ (XE @ Xi) @ (ccuni @ (ccrn @ XF))) @ ccovol) @ ccaddc) @ (ccfv @ (XE @ Xi) @ ccovol) @ ccle))))))))))))))).
