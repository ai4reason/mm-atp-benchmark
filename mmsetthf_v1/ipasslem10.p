...
thf(cipasslem10_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XA2 @ XX) => ((cwcel @ XB2 @ XX) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => (cwceq @ (cco @ (cco @ cci @ XA2 @ XS) @ XB2 @ XP) @ (cco @ cci @ (cco @ XA2 @ XB2 @ XP) @ ccmul))))))))))))))))))).
