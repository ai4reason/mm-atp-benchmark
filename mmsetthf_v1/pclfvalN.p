...
thf(adf_pclN_ax,axiom,(cwceq @ ccpclN @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccfv @ (ccv @ Xk) @ ccatm))) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xk) @ ccpsubsp)))))))))).
...
thf(cpclfvalN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XS @ (ccfv @ XK @ ccpsubsp)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XU @ Xx3 @ Xy1) @ (ccfv @ XK @ ccpclN)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XK @ (XV @ Xx3 @ Xy1)) @ (cwceq @ (XU @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XS)))))))))))))))))).
