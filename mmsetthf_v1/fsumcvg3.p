...
thf(cfsumcvg3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ Xph @ (cwss @ XA2 @ (XZ @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (XZ @ Xk))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ ccc))) => (cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli)))))))))))))))).
