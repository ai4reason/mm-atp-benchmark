...
thf(acbncms_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XD @ (ccfv @ XU @ ccims)) => (cwi @ (cwcel @ XU @ cccbn) @ (cwcel @ XD @ (ccfv @ XX @ ccms))))))))).
...
thf(anvsge0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ XS) @ XN) @ (cco @ XA2 @ (ccfv @ XB2 @ XN) @ ccmul))))))))))))).
...
thf(ablocn2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccims)) => ((cwceq @ XD @ (ccfv @ XW @ ccims)) => ((cwceq @ XJ @ (ccfv @ XC @ ccmopn)) => ((cwceq @ XK @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XB2 @ (cco @ XU @ XW @ ccblo)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (cwi @ (cwcel @ XT @ XB2) @ (cwcel @ XT @ (cco @ XJ @ XK @ cccn))))))))))))))))))).
...
thf(aiscncl_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) @ (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xy1)) @ (ccfv @ XJ @ cccld))) @ (^ [Xy1:$i] : (ccfv @ XK @ cccld)))))))))))).
...
thf(alnomul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XR @ (ccfv @ XU @ ccns)) => ((cwceq @ XS @ (ccfv @ XW @ ccns)) => ((cwceq @ XL @ (cco @ XU @ XW @ cclno)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwcel @ XT @ XL)) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ XX))) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ XR) @ XT) @ (cco @ XA2 @ (ccfv @ XB2 @ XT) @ XS))))))))))))))))).
thf(affvelrnda_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => (cwi @ (cwa @ Xph @ (cwcel @ XC @ XA2)) @ (cwcel @ (ccfv @ XC @ XF) @ XB2))))))))).
thf(anvmtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XM @ (ccfv @ XU @ ccnsb)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => (cwi @ (cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ XM) @ XN) @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccaddc) @ ccle)))))))))))).
...
thf(anmoubi_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XY @ (ccfv @ XW @ ccba)) => ((cwceq @ XL @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XM @ (ccfv @ XW @ ccnmcv)) => ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (cco @ XU @ XW @ ccnmoo))) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (! [Xx3:$i] : (cwi @ (cwa @ (cwf @ XX @ XY @ XT) @ (cwcel @ XA2 @ ccxr)) @ (cwb @ (cwbr @ (ccfv @ XT @ (XN @ Xx3)) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XL) @ cc1 @ ccle) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ XM) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XX)))))))))))))))))))))).
thf(arspcev_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => (cwi @ (cwa @ (cwcel @ XA2 @ XB2) @ Xps) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(cubthlem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwceq @ XX @ (ccfv @ (XU @ Xk) @ ccba))) => ((! [Xz:$i] : (! [Xk:$i] : (cwceq @ XN @ (ccfv @ (XW @ Xz @ Xk) @ ccnmcv)))) => ((! [Xk:$i] : (! [Xd:$i] : (cwceq @ (XD @ Xd) @ (ccfv @ (XU @ Xk) @ ccims)))) => ((! [Xz:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (XJ @ Xz @ Xc @ Xd) @ (ccfv @ (XD @ Xd) @ ccmopn))))) => ((! [Xk:$i] : (cwcel @ (XU @ Xk) @ cccbn)) => ((! [Xz:$i] : (! [Xk:$i] : (cwcel @ (XW @ Xz @ Xk) @ ccnv))) => ((! [Xz:$i] : (! [Xk:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xz @ Xd) @ (cwss @ XT @ (cco @ (XU @ Xk) @ (XW @ Xz @ Xk) @ ccblo)))))) => ((! [Xz:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xz @ Xd) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xt)) @ XN) @ (ccv @ Xc) @ ccle)) @ (^ [Xt:$i] : XT))) @ (^ [Xc:$i] : ccr))) @ (^ [Xx3:$i] : XX))))) => ((! [Xt:$i] : (! [Xd:$i] : (cwceq @ (XA2 @ Xt @ Xd) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ XN) @ (ccv @ Xk) @ ccle)) @ (^ [Xt:$i] : XT))) @ (^ [Xz:$i] : XX))))))) => ((! [Xz:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xz @ Xd) @ (cwcel @ (XK @ Xc) @ ccn))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xz @ Xd) @ (cwcel @ (XP @ Xx3 @ Xk @ Xc @ Xd) @ XX))))))) => ((! [Xz:$i] : (! [Xk:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xz @ Xd) @ (cwcel @ (XR @ Xk @ Xc) @ ccrp)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xz @ Xd) @ (cwss @ (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (XP @ Xx3 @ Xk @ Xc @ Xd) @ (ccv @ Xz) @ (XD @ Xd)) @ (XR @ Xk @ Xc) @ ccle)) @ (^ [Xz:$i] : XX)) @ (ccfv @ (XK @ Xc) @ (XA2 @ Xt @ Xd)))))))))) => (! [Xz:$i] : (! [Xk:$i] : (! [Xd:$i] : (cwi @ (Xph @ Xz @ Xd) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (cco @ (XU @ Xk) @ (XW @ Xz @ Xk) @ ccnmoo)) @ (ccv @ Xd) @ ccle)) @ (^ [Xt:$i] : XT))) @ (^ [Xd:$i] : ccr)))))))))))))))))))))))))))))))).
