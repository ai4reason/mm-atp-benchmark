...
thf(ah1dei_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ cchil) => (cwb @ (cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwceq @ (cco @ XB2 @ (ccv @ Xx3) @ ccsp) @ ccc0) @ (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccsp) @ ccc0))) @ (^ [Xx3:$i] : cchil)))))))).
...
thf(abcseqi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwb @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XA2 @ ccsp) @ ccmul) @ (cco @ (cco @ XA2 @ XA2 @ ccsp) @ (cco @ XB2 @ XB2 @ ccsp) @ ccmul)) @ (cwceq @ (cco @ (cco @ XB2 @ XB2 @ ccsp) @ XA2 @ ccsm) @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ XB2 @ ccsm)))))))).
thf(ch1de2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwi @ (cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) @ (cwceq @ (cco @ (cco @ XB2 @ XB2 @ ccsp) @ XA2 @ ccsm) @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ XB2 @ ccsm)))))))).
