...
thf(c_0wlk_conj,conjecture,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XG @ XU) @ (cwb @ (cwbr @ cc0 @ XP @ (ccfv @ XG @ ccwlks)) @ (cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP))))))))).
