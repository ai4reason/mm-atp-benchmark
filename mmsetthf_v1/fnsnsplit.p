...
thf(cfnsnsplit_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XX @ XA2)) @ (cwceq @ XF @ (ccun @ (ccres @ XF @ (ccdif @ XA2 @ (ccsn @ XX))) @ (ccsn @ (ccop @ XX @ (ccfv @ XX @ XF)))))))))).
