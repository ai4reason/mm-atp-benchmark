...
thf(afprodex01_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xl:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ (ccv @ Xl)) @ (cwceq @ (XB2 @ Xk) @ (XC @ Xl))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XA2)) @ (cwcel @ (XB2 @ Xk) @ (ccpr @ ccc0 @ cc1)))) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccif @ (cwral @ (^ [Xl:$i] : (cwceq @ (XC @ Xl) @ cc1)) @ (^ [Xl:$i] : XA2)) @ cc1 @ ccc0))))))))))).
...
thf(aind1a_thm,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO) @ (cwcel @ XX @ XO)) @ (cwb @ (cwceq @ (ccfv @ XX @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) @ cc1) @ (cwcel @ XX @ XA2)))))))).
...
thf(cprodindf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XO @ (XV @ Xk)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwss @ XB2 @ XO)) => ((cwi @ Xph @ (cwf @ XA2 @ XO @ XF)) => (cwi @ Xph @ (cwceq @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ XB2 @ (ccfv @ XO @ ccind))))) @ (ccif @ (cwss @ (ccrn @ XF) @ XB2) @ cc1 @ ccc0)))))))))))))).
