...
thf(atskwe_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwss @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ XA2)) @ (cwcel @ XA2 @ (ccdm @ cccrd))))))).
...
thf(aaxgroth6_thm,axiom,(! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : (cwa @ (cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)) @ (cwcel @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (cwral @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccsdm) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xy1))))))))).
thf(cgrothac_conj,conjecture,(cwceq @ (ccdm @ cccrd) @ ccvv)).
