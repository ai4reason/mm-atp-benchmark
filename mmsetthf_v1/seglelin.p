...
thf(asegcon2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XQ @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwo @ (cwbr @ XA2 @ (ccop @ XQ @ (ccv @ Xx3)) @ ccbtwn) @ (cwbr @ (ccv @ Xx3) @ (ccop @ XQ @ XA2) @ ccbtwn)) @ (cwbr @ (ccop @ XQ @ (ccv @ Xx3)) @ (ccop @ XB2 @ XC) @ cccgr))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee)))))))))).
...
thf(cseglelin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)))) @ (cwo @ (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccsegle) @ (cwbr @ (ccop @ XC @ XD) @ (ccop @ XA2 @ XB2) @ ccsegle))))))))).
