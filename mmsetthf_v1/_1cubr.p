...
thf(acxpeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (cwcel @ XB2 @ ccc)) @ (cwb @ (cwceq @ (cco @ XA2 @ XN @ ccexp) @ XB2) @ (cwrex @ (^ [Xn:$i] : (cwceq @ XA2 @ (cco @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccdiv) @ cccxp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ (ccv @ Xn) @ ccexp) @ ccmul))) @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))))))).
...
thf(a_1cxp_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ cc1 @ XA2 @ cccxp) @ cc1)))).
thf(arextp_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xch))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XC) @ (cwb @ (Xph @ Xx3) @ Xth))) => (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cctp @ XA2 @ XB2 @ XC))) @ (cw3o @ Xps @ Xch @ Xth)))))))))))))))).
...
thf(a_1cubrlem_thm,axiom,(cwa @ (cwceq @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ cc3 @ ccdiv) @ cccxp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccaddc) @ cc2 @ ccdiv)) @ (cwceq @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ cc3 @ ccdiv) @ cccxp) @ cc2 @ ccexp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccmin) @ cc2 @ ccdiv)))).
thf(asqcli_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccc)))).
thf(asimpri_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((cwa @ Xph @ Xps) => Xps)))).
thf(c_1cubr_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XR @ (cctp @ cc1 @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccmin) @ cc2 @ ccdiv))) => (cwb @ (cwcel @ XA2 @ XR) @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XA2 @ cc3 @ ccexp) @ cc1))))))).
