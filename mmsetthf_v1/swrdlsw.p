...
thf(cswrdlsw_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)) @ (cwceq @ (cco @ XW @ (ccop @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (ccs1 @ (ccfv @ XW @ cclsw))))))).
