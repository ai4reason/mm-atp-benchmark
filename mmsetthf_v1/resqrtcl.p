...
thf(aresqrex_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle) @ (cwceq @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2))) @ (^ [Xx3:$i] : ccr))))).
...
thf(arennim_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwnel @ (cco @ cci @ XA2 @ ccmul) @ ccrp)))).
...
thf(cresqrtcl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccr)))).
