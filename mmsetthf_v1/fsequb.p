...
thf(cfsequb_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr)) @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)))) @ (^ [Xx3:$i] : ccr))))))).
