...
thf(cpwsco1mhm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xg1:$i] : (cwceq @ XY @ (cco @ (XR @ Xg1) @ (XA2 @ Xg1) @ ccpws))) => ((! [Xg1:$i] : (cwceq @ XZ @ (cco @ (XR @ Xg1) @ (XB2 @ Xg1) @ ccpws))) => ((cwceq @ XC @ (ccfv @ XZ @ ccbs)) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xg1) @ ccmnd))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xg1) @ (XV @ Xg1)))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xg1) @ (XW @ Xg1)))) => ((! [Xg1:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xg1) @ (XB2 @ Xg1) @ XF))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xg1:$i] : XC) @ (^ [Xg1:$i] : (cccom @ (ccv @ Xg1) @ XF))) @ (cco @ XZ @ XY @ ccmhm))))))))))))))))))))).
