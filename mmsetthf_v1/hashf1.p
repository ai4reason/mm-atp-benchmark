...
thf(ahashf1lem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XA2 @ Xz) @ ccfn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwcel @ (XB2 @ Xz) @ ccfn))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwn @ (cwcel @ (ccv @ Xz) @ (XA2 @ Xz))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwbr @ (cco @ (ccfv @ (XA2 @ Xz) @ cchash) @ cc1 @ ccaddc) @ (ccfv @ (XB2 @ Xz) @ cchash) @ ccle))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwceq @ (ccfv @ (ccab @ (^ [Xf1:$i] : (cwf1 @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (XB2 @ Xz) @ (ccv @ Xf1)))) @ cchash) @ (cco @ (cco @ (ccfv @ (XB2 @ Xz) @ cchash) @ (ccfv @ (XA2 @ Xz) @ cchash) @ ccmin) @ (ccfv @ (ccab @ (^ [Xf1:$i] : (cwf1 @ (XA2 @ Xz) @ (XB2 @ Xz) @ (ccv @ Xf1)))) @ cchash) @ ccmul)))))))))))).
...
thf(chashf1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwceq @ (ccfv @ (ccab @ (^ [Xf1:$i] : (cwf1 @ XA2 @ XB2 @ (ccv @ Xf1)))) @ cchash) @ (cco @ (ccfv @ (ccfv @ XA2 @ cchash) @ ccfa) @ (cco @ (ccfv @ XB2 @ cchash) @ (ccfv @ XA2 @ cchash) @ ccbc) @ ccmul)))))).
