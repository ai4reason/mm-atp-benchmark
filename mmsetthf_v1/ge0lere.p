...
thf(cge0lere_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((cwi @ Xph @ (cwbr @ XB2 @ XA2 @ ccle)) => (cwi @ Xph @ (cwcel @ XB2 @ ccr))))))))).
