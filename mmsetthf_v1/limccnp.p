...
thf(climccnp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XD @ XF)) => ((cwi @ Xph @ (cwss @ XD @ ccc)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XJ @ (cco @ XK @ XD @ ccrest)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XF @ XB2 @ cclimc))) => ((cwi @ Xph @ (cwcel @ XG @ (ccfv @ XC @ (cco @ XJ @ XK @ cccnp)))) => (cwi @ Xph @ (cwcel @ (ccfv @ XC @ XG) @ (cco @ (cccom @ XG @ XF) @ XB2 @ cclimc))))))))))))))))))).
