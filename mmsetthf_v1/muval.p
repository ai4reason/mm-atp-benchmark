...
thf(cmuval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwceq @ (ccfv @ XA2 @ ccmu) @ (ccif @ (cwrex @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ cc2 @ ccexp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccc0 @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ cchash) @ ccexp)))))).
