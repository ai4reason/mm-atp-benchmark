...
thf(csubmabas_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XA2 @ Xi @ Xj) @ (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ XB2 @ (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => (cwi @ (cwa @ (cwcel @ XM @ XB2) @ (cwss @ XD @ XN)) @ (cwcel @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XD)) @ (^ [Xi:$i] : (^ [Xj:$i] : XD)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM)))) @ (ccfv @ (cco @ XD @ XR @ ccmat) @ ccbs)))))))))))).
