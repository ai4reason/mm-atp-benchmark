...
thf(adf_lvols_ax,axiom,(cwceq @ cclvol @ (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ cccvr))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xk) @ cclpl)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccbs))))))).
