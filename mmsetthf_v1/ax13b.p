...
thf(cax13b_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwi @ (cwn @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (Xph @ Xx3 @ Xy1 @ Xz))) @ (cwi @ (cwn @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwi @ (cwn @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xz))) @ (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (Xph @ Xx3 @ Xy1 @ Xz)))))))))).
