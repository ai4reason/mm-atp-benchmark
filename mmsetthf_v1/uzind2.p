...
thf(cuzind2_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ XM @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xj) @ (Xps @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (ccv @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xch @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc)) @ (cwb @ (Xph @ Xj) @ (Xth @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xj) @ (XN @ Xk)) @ (cwb @ (Xph @ Xj) @ (Xta @ Xk))))) => ((! [Xk:$i] : (cwi @ (cwcel @ XM @ ccz) @ (Xps @ Xk))) => ((! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ (ccv @ Xk) @ ccz) @ (cwbr @ XM @ (ccv @ Xk) @ cclt)) @ (cwi @ (Xch @ Xk) @ (Xth @ Xk)))) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ (XN @ Xk) @ ccz) @ (cwbr @ XM @ (XN @ Xk) @ cclt)) @ (Xta @ Xk))))))))))))))))).
