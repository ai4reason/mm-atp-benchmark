...
thf(asshaus_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XK @ (ccfv @ XX @ cctopon)) @ (cwss @ XJ @ XK)) @ (cwcel @ XK @ ccha))))))).
thf(ckgenhaus_conj,conjecture,(! [XJ:($i > $o)] : (cwi @ (cwcel @ XJ @ ccha) @ (cwcel @ (ccfv @ XJ @ cckgen) @ ccha)))).
