...
thf(ccantnfcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XS @ (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccon0)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccon0)) => ((cwceq @ XG @ (ccoi @ (cco @ XF @ cc0 @ ccsupp) @ ccep)) => ((cwi @ Xph @ (cwcel @ XF @ XS)) => (cwi @ Xph @ (cwa @ (cwwe @ (cco @ XF @ cc0 @ ccsupp) @ ccep) @ (cwcel @ (ccdm @ XG) @ ccom))))))))))))))).
