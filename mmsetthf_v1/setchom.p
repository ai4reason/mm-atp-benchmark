...
thf(csetchom_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccsetc)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwi @ Xph @ (cwcel @ XX @ XU)) => ((cwi @ Xph @ (cwcel @ XY @ XU)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ XH) @ (cco @ XY @ XX @ ccmap)))))))))))))))).
