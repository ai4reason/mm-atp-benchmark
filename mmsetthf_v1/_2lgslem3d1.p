...
thf(a_2lgslem3d_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XK @ ccn0) @ (cwceq @ XP @ (cco @ (cco @ cc8 @ XK @ ccmul) @ cc7 @ ccaddc))) @ (cwceq @ XN @ (cco @ (cco @ cc2 @ XK @ ccmul) @ cc2 @ ccaddc)))))))).
...
thf(c_2lgslem3d1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (cwi @ (cwa @ (cwcel @ XP @ ccn) @ (cwceq @ (cco @ XP @ cc8 @ ccmo) @ cc7)) @ (cwceq @ (cco @ XN @ cc2 @ ccmo) @ ccc0)))))).
