...
thf(cdfon2lem6_conj,conjecture,(! [XS:($i > $o)] : (cwi @ (cwa @ (cwtr @ XS) @ (cwral @ (^ [Xx3:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xz))) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XS))) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwpss @ (ccv @ Xy1) @ XS) @ (cwtr @ (ccv @ Xy1))) @ (cwcel @ (ccv @ Xy1) @ XS))))))).
