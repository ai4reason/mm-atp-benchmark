...
thf(acnflf_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) @ (cwb @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwa @ (cwf @ XX @ XY @ XF) @ (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ XF @ (cco @ XK @ (ccv @ Xf1) @ ccflf)))) @ (^ [Xx3:$i] : (cco @ XJ @ (ccv @ Xf1) @ ccflim)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))))))).
...
thf(aneiflim_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XA2 @ XX)) @ (cwcel @ XA2 @ (cco @ XJ @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ ccflim))))))).
...
thf(aneitr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX) @ (cwss @ XB2 @ XA2)) @ (cwceq @ (ccfv @ XB2 @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ ccnei)) @ (cco @ (ccfv @ XB2 @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest))))))))).
thf(aeleq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC))))))))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(cflfcntr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccuni @ XJ)) => ((cwceq @ XB2 @ (ccuni @ XK)) => ((cwi @ Xph @ (cwcel @ XJ @ cctop)) => ((cwi @ Xph @ (cwss @ XA2 @ XC)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccn))) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ XF) @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf))))))))))))))))))).
