...
thf(adf_fdiv_ax,axiom,(cwceq @ ccfdiv @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccres @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccof @ ccdiv)) @ (cco @ (ccv @ Xg1) @ ccc0 @ ccsupp))))))).
...
thf(aoffval0_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XF @ (XV @ Xx3)) @ (cwcel @ XG @ (XW @ Xx3))) @ (cwceq @ (cco @ XF @ XG @ (ccof @ XR)) @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccdm @ XF) @ (ccdm @ XG))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ XR)))))))))))).
...
thf(cfdivval_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XG @ XW)) @ (cwceq @ (cco @ XF @ XG @ ccfdiv) @ (ccres @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (cco @ XG @ ccc0 @ ccsupp))))))))).
