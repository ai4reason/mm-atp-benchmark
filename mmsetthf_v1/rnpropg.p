...
thf(crnpropg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwceq @ (ccrn @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))) @ (ccpr @ XC @ XD)))))))))).
