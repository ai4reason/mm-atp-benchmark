...
thf(abrafval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwceq @ (ccfv @ XA2 @ ccbr) @ (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccsp))))))).
...
thf(ahfmmval_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwf @ cchil @ ccc @ XT)) @ (cwceq @ (cco @ XA2 @ XT @ cchft) @ (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XT) @ ccmul)))))))).
...
thf(cbrafnmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccsm) @ ccbr) @ (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ ccbr) @ cchft)))))).
