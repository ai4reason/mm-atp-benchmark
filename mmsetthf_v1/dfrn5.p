...
thf(aelima2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ (ccima @ XB2 @ XC)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XC) @ (cwbr @ (ccv @ Xx3) @ XA2 @ XB2)))))))))).
thf(cdfrn5_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (ccrn @ XA2) @ (ccima @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv)) @ XA2)))).
