...
thf(adf_bday_ax,axiom,(cwceq @ ccbday @ (ccmpt @ (^ [Xx3:$i] : ccsur) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xx3)))))).
thf(cbdayval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccsur) @ (cwceq @ (ccfv @ XA2 @ ccbday) @ (ccdm @ XA2))))).
