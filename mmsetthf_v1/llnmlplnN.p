...
thf(cllnmlplnN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ Xc_0 @ (ccfv @ XK @ ccp0)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XN @ (ccfv @ XK @ cclln)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XP)) @ (cwa @ (cwn @ (cwbr @ XX @ XY @ Xc_le)) @ (cwne @ (cco @ XX @ XY @ Xc_an) @ Xc_0))) @ (cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2)))))))))))))))))).
