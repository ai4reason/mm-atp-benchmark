...
thf(atanaddlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0) @ (cwne @ (ccfv @ XB2 @ cccos) @ ccc0))) @ (cwb @ (cwne @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccc0) @ (cwne @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) @ cc1)))))).
...
thf(ctanadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cw3a @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0) @ (cwne @ (ccfv @ XB2 @ cccos) @ ccc0) @ (cwne @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccc0))) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cctan) @ (cco @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccaddc) @ (cco @ cc1 @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) @ ccmin) @ ccdiv)))))).
