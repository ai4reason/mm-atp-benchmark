...
thf(axpsfrnel2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwb @ (cwcel @ (cccnv @ (cco @ (ccsn @ XX) @ (ccsn @ XY) @ cccda)) @ (ccixp @ (^ [Xk:$i] : cc2o) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ cc0) @ XA2 @ XB2)))) @ (cwa @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2)))))))).
...
thf(axpsfval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccnv @ (cco @ (ccsn @ (ccv @ Xx3)) @ (ccsn @ (ccv @ Xy1)) @ cccda)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2)) @ (cwceq @ (cco @ XX @ XY @ (XF @ Xx3 @ Xy1)) @ (cccnv @ (cco @ (ccsn @ XX) @ (ccsn @ XY) @ cccda))))))))))))).
...
thf(axpsfrnel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (cwb @ (cwcel @ XG @ (ccixp @ (^ [Xk:$i] : cc2o) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ cc0) @ XA2 @ XB2)))) @ (cw3a @ (cwfn @ XG @ cc2o) @ (cwcel @ (ccfv @ cc0 @ XG) @ XA2) @ (cwcel @ (ccfv @ cc1o @ XG) @ XB2))))))).
...
thf(axpsfeq_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwfn @ XG @ cc2o) @ (cwceq @ (cccnv @ (cco @ (ccsn @ (ccfv @ cc0 @ XG)) @ (ccsn @ (ccfv @ cc1o @ XG)) @ cccda)) @ XG)))).
...
thf(cxpsff1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwceq @ (XF @ Xx3 @ Xy1 @ Xk) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccnv @ (cco @ (ccsn @ (ccv @ Xx3)) @ (ccsn @ (ccv @ Xy1)) @ cccda))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (cwf1o @ (ccxp @ XA2 @ XB2) @ (ccixp @ (^ [Xk:$i] : cc2o) @ (^ [Xk:$i] : (ccif @ (cwceq @ (ccv @ Xk) @ cc0) @ XA2 @ XB2))) @ (XF @ Xx3 @ Xy1 @ Xk)))))))))).
