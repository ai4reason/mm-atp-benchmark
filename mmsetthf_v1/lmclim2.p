...
thf(almmbrf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XJ @ Xj @ Xk) @ (ccfv @ XD @ ccmopn)))) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XF) @ (XA2 @ Xx3 @ Xj @ Xk)))))) => ((cwi @ Xph @ (cwf @ XZ @ XX @ XF)) => (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ (XJ @ Xj @ Xk) @ cclm)) @ (cwa @ (cwcel @ XP @ XX) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ (XA2 @ Xx3 @ Xj @ Xk) @ XP @ XD) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccrp))))))))))))))))))))))).
...
thf(a_3bitrrd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ Xph @ (cwb @ Xch @ Xth)) => ((cwi @ Xph @ (cwb @ Xth @ Xta)) => (cwi @ Xph @ (cwb @ Xta @ Xps))))))))))).
...
thf(clmclim2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwf @ ccn @ XX @ XF)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XG @ (ccmpt @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ XY @ XD)))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XY @ (ccfv @ XJ @ cclm)) @ (cwbr @ XG @ ccc0 @ ccli)))))))))))))))).
