...
thf(aclwwlkgt0_thm,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) @ (cwbr @ ccc0 @ (ccfv @ XW @ cchash) @ cclt))))).
...
thf(aclwlkclwwlk2_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) @ (cwb @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ (ccfv @ XG @ ccclwlks)))) @ (cwcel @ XP @ (ccfv @ XG @ ccclwwlk))))))))))).
...
thf(aclwlkclwwlkfolem_thm,axiom,(! [XC:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xw:$i] : (! [Xf1:$i] : (cwceq @ (XC @ Xw @ Xf1) @ (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))))) => (! [Xw:$i] : (! [Xf1:$i] : (cwi @ (cw3a @ (cwcel @ (XW @ Xw @ Xf1) @ (ccword @ (ccfv @ XG @ ccvtx))) @ (cwbr @ cc1 @ (ccfv @ (XW @ Xw @ Xf1) @ cchash) @ ccle) @ (cwcel @ (ccop @ (ccv @ Xf1) @ (cco @ (XW @ Xw @ Xf1) @ (ccs1 @ (ccfv @ ccc0 @ (XW @ Xw @ Xf1))) @ ccconcat)) @ (ccfv @ XG @ ccclwlks))) @ (cwcel @ (ccop @ (ccv @ Xf1) @ (cco @ (XW @ Xw @ Xf1) @ (ccs1 @ (ccfv @ ccc0 @ (XW @ Xw @ Xf1))) @ ccconcat)) @ (XC @ Xw @ Xf1)))))))))).
...
thf(awrdsymb1_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ ccle)) @ (cwcel @ (ccfv @ ccc0 @ XW) @ XV))))).
...
thf(cclwlkclwwlkfo_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XC @ (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))) => ((cwceq @ XF @ (ccmpt @ (^ [Xc:$i] : XC) @ (^ [Xc:$i] : (cco @ (ccfv @ (ccv @ Xc) @ cc2nd) @ (ccop @ ccc0 @ (cco @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc2nd) @ cchash) @ cc1 @ ccmin)) @ ccsubstr)))) => (cwi @ (cwcel @ XG @ ccuspgr) @ (cwfo @ XC @ (ccfv @ XG @ ccclwwlk) @ XF)))))))).
