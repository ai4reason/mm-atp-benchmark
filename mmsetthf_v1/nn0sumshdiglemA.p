...
thf(ablennn0em1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)) @ (cwceq @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccblen) @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin))))).
...
thf(a_0dig2nn0e_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)) @ (cwceq @ (cco @ ccc0 @ XN @ (ccfv @ cc2 @ ccdig)) @ ccc0)))).
...
thf(adignn0ehalf_thm,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (cwi @ (cw3a @ (cwcel @ (cco @ XA2 @ cc2 @ ccdiv) @ ccn0) @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XI @ ccn0)) @ (cwceq @ (cco @ (cco @ XI @ cc1 @ ccaddc) @ XA2 @ (ccfv @ cc2 @ ccdig)) @ (cco @ XI @ (cco @ XA2 @ cc2 @ ccdiv) @ (ccfv @ cc2 @ ccdig))))))).
