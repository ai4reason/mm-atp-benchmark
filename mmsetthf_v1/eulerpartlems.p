...
thf(afsumcvg4_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XS @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XS @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ ccfn)) => (cwi @ Xph @ (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli)))))))))))).
...
thf(asuppss3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XZ @ (XW @ Xx3)))) => ((cwi @ Xph @ (cwfn @ XF @ XA2)) => ((! [Xx3:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XZ)) @ (cwceq @ (XB2 @ Xx3) @ XZ))) => (! [Xx3:$i] : (cwi @ Xph @ (cwss @ (cco @ (XG @ Xx3) @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp)))))))))))))))))).
...
thf(ceulerpartlems_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((cwceq @ XR @ (ccab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)))) => ((! [Xf1:$i] : (! [Xk:$i] : (cwceq @ (XS @ Xf1 @ Xk) @ (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (cwcel @ (ccv @ Xt) @ (ccfv @ (cco @ (ccfv @ XA2 @ (XS @ Xf1 @ Xk)) @ cc1 @ ccaddc) @ ccuz))) @ (cwceq @ (ccfv @ (ccv @ Xt) @ XA2) @ ccc0))))))))))).
