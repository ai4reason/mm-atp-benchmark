...
thf(cupgrres1lem1_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XF @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : (cwa @ (cwcel @ (ccdif @ XV @ (ccsn @ XN)) @ ccvv) @ (cwcel @ (ccres @ ccid @ (XF @ Xe)) @ ccvv)))))))))))).
