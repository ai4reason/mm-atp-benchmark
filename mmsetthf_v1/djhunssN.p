...
thf(cdjhunssN_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XV @ (ccfv @ XU @ ccbs)) => ((cwceq @ Xc_or @ (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((cwi @ Xph @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH))) => ((cwi @ Xph @ (cwss @ XX @ XV)) => ((cwi @ Xph @ (cwss @ XY @ XV)) => (cwi @ Xph @ (cwss @ (ccun @ XX @ XY) @ (cco @ XX @ XY @ Xc_or)))))))))))))))))))).
