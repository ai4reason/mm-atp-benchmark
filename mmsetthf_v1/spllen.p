...
thf(cspllen_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccword @ XA2))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((cwi @ Xph @ (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((cwi @ Xph @ (cwcel @ XR @ (ccword @ XA2))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) @ cchash) @ (cco @ (ccfv @ XS @ cchash) @ (cco @ (ccfv @ XR @ cchash) @ (cco @ XT @ XF @ ccmin) @ ccmin) @ ccaddc)))))))))))))).
