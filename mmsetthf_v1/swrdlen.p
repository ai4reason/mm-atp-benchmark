...
thf(cswrdlen_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XF @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) @ (cwceq @ (ccfv @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) @ cchash) @ (cco @ XL @ XF @ ccmin)))))))).
