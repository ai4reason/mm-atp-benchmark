...
thf(aclel5_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XX @ XA2) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XX @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)))))).
thf(cdfss5_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xy1:$i] : (cwb @ (cwss @ (XA2 @ Xy1) @ XB2) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))))).
