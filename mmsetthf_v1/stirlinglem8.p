...
thf(aclimexp_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XH @ Xk))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XZ @ ccc @ (XF @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XF @ Xk) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XN @ ccn0))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XH @ Xk) @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XH @ Xk)) @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ XN @ ccexp)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XH @ Xk) @ (cco @ (XA2 @ Xk) @ XN @ ccexp) @ ccli)))))))))))))))))))))).
...
thf(aclimsuse_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XG @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XI @ Xk))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XF @ Xk) @ (XX @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccc))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XF @ Xk) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccfv @ (XM @ Xk) @ (XI @ Xk)) @ XZ))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XI @ Xk)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XI @ Xk)) @ cc1 @ ccaddc) @ ccuz)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XG @ Xk) @ (XY @ Xk)))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XI @ Xk)) @ (XF @ Xk))))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwbr @ (XG @ Xk) @ (XA2 @ Xk) @ ccli)))))))))))))))))))))))))).
...
thf(cstirlinglem8_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((cwnfc @ (^ [Xn:$i] : (XA2 @ Xn))) => ((cwnfc @ (^ [Xn:$i] : (XD @ Xn))) => ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XA2 @ Xn)))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwf @ ccn @ ccrp @ (XA2 @ Xn)))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp) @ ccdiv))))) => ((! [Xn:$i] : (cwceq @ (XL @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp))))) => ((! [Xn:$i] : (cwceq @ (XM @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp))))) => ((! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xn) @ (cwcel @ (ccv @ Xn) @ ccn)) @ (cwcel @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ ccrp))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XC @ Xn) @ ccrp))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (XA2 @ Xn) @ (XC @ Xn) @ ccli))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (XF @ Xn) @ (cco @ (XC @ Xn) @ cc2 @ ccexp) @ ccli)))))))))))))))))))))).
