...
thf(ccnplimc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XJ @ (cco @ XK @ XA2 @ ccrest)) => (cwi @ (cwa @ (cwss @ XA2 @ ccc) @ (cwcel @ XB2 @ XA2)) @ (cwb @ (cwcel @ XF @ (ccfv @ XB2 @ (cco @ XJ @ XK @ cccnp))) @ (cwa @ (cwf @ XA2 @ ccc @ XF) @ (cwcel @ (ccfv @ XB2 @ XF) @ (cco @ XF @ XB2 @ cclimc))))))))))))).
