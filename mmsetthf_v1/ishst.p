...
thf(adf_hst_ax,axiom,(cwceq @ cchst @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwceq @ (ccfv @ (ccfv @ cchil @ (ccv @ Xf1)) @ ccno) @ cc1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) @ (cwa @ (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ ccsp) @ ccc0) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cchj) @ (ccv @ Xf1)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ ccva))))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))) @ (^ [Xf1:$i] : (cco @ cchil @ ccch @ ccmap))))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(cishst_conj,conjecture,(! [XS:($i > $o)] : (cwb @ (cwcel @ XS @ cchst) @ (cw3a @ (cwf @ ccch @ cchil @ XS) @ (cwceq @ (ccfv @ (ccfv @ cchil @ XS) @ ccno) @ cc1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) @ (cwa @ (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccsp) @ ccc0) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cchj) @ XS) @ (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccva))))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))))).
