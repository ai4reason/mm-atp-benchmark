...
thf(c_2zlidl_conj,conjecture,(! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XE @ Xx3 @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XU @ Xx3 @ Xz) @ (ccfv @ czring @ cclidl)))) => (! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XE @ Xx3 @ Xz) @ (XU @ Xx3 @ Xz))))))))).
