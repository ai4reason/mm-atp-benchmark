...
thf(apsrbagfsupp_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xh:$i] : (cwceq @ (XD @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => (! [Xh:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XD @ Xh)) @ (cwcel @ XI @ (XV @ Xh))) @ (cwbr @ XX @ ccc0 @ ccfsupp))))))))).
...
thf(cpsrbagev1_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xh:$i] : (cwceq @ (XD @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xh:$i] : (cwceq @ (XC @ Xh) @ (ccfv @ (XT @ Xh) @ ccbs))) => ((! [Xh:$i] : (cwceq @ (Xc_x @ Xh) @ (ccfv @ (XT @ Xh) @ ccmg))) => ((! [Xh:$i] : (cwceq @ (Xc_0 @ Xh) @ (ccfv @ (XT @ Xh) @ cc0g))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ (XT @ Xh) @ cccmn))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XB2 @ (XD @ Xh)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwf @ XI @ (XC @ Xh) @ (XG @ Xh)))) => ((! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwcel @ XI @ ccvv))) => (! [Xh:$i] : (cwi @ (Xph @ Xh) @ (cwa @ (cwf @ XI @ (XC @ Xh) @ (cco @ XB2 @ (XG @ Xh) @ (ccof @ (Xc_x @ Xh)))) @ (cwbr @ (cco @ XB2 @ (XG @ Xh) @ (ccof @ (Xc_x @ Xh))) @ (Xc_0 @ Xh) @ ccfsupp)))))))))))))))))))))).
