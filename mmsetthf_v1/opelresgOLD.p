...
thf(copelresgOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwcel @ (ccop @ XA2 @ XB2) @ (ccres @ XC @ XD)) @ (cwa @ (cwcel @ (ccop @ XA2 @ XB2) @ XC) @ (cwcel @ XA2 @ XD)))))))))).
