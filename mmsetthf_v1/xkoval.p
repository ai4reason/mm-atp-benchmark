...
thf(adf_xko_ax,axiom,(cwceq @ ccxko @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xr:$i] : cctop)) @ (^ [Xs1:$i] : (^ [Xr:$i] : cctop)) @ (^ [Xs1:$i] : (^ [Xr:$i] : (ccfv @ (ccfv @ (ccrn @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xr) @ (ccv @ Xx3) @ ccrest) @ cccmp)) @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xr))))))) @ (^ [Xk:$i] : (^ [Xv:$i] : (ccv @ Xs1))) @ (^ [Xk:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (ccv @ Xf1) @ (ccv @ Xk)) @ (ccv @ Xv))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ cccn))))))) @ ccfi) @ cctg)))))).
