...
thf(cnati_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (cco @ XC @ XD @ ccnat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ (ccop @ XF @ XG) @ (ccop @ XK @ XL) @ XN))) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ Xc_x @ (ccfv @ XD @ ccco)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ XX @ XY @ XH))) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ XY @ XA2) @ (ccfv @ XR @ (cco @ XX @ XY @ XG)) @ (cco @ (ccop @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF)) @ (ccfv @ XY @ XK) @ Xc_x)) @ (cco @ (ccfv @ XR @ (cco @ XX @ XY @ XL)) @ (ccfv @ XX @ XA2) @ (cco @ (ccop @ (ccfv @ XX @ XF) @ (ccfv @ XX @ XK)) @ (ccfv @ XY @ XK) @ Xc_x)))))))))))))))))))))))))))).
