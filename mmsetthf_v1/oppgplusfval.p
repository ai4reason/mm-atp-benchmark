...
thf(coppgplusfval_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwceq @ XO @ (ccfv @ XR @ ccoppg)) => ((cwceq @ Xc_pb @ (ccfv @ XO @ ccplusg)) => (cwceq @ Xc_pb @ (cctpos @ Xc_pl)))))))))).
