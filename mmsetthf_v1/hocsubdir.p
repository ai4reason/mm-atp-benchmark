...
thf(chocsubdir_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cw3a @ (cwf @ cchil @ cchil @ XR) @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) @ (cwceq @ (cccom @ (cco @ XR @ XS @ cchod) @ XT) @ (cco @ (cccom @ XR @ XT) @ (cccom @ XS @ XT) @ cchod))))))).
