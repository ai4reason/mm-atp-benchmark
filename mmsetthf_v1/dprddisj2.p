...
thf(admdprdsplitlem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (Xc_0 @ Xi) @ (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : (cwceq @ (XW @ Xh @ Xi) @ (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS)))))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwceq @ (ccdm @ XS) @ XI)))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwss @ XA2 @ XI)))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ (XF @ Xi) @ (XW @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : (cwi @ (Xph @ Xh @ Xi) @ (cwcel @ (cco @ XG @ (XF @ Xi) @ ccgsu) @ (cco @ XG @ (ccres @ XS @ XA2) @ ccdprd))))) => (! [Xh:$i] : (! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xh @ Xi) @ (cwcel @ (XX @ Xh @ Xi) @ (ccdif @ XI @ XA2))) @ (cwceq @ (ccfv @ (XX @ Xh @ Xi) @ (XF @ Xi)) @ (Xc_0 @ Xi)))))))))))))))))))))).
...
thf(cdprddisj2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwi @ Xph @ (cwss @ XC @ XI)) => ((cwi @ Xph @ (cwss @ XD @ XI)) => ((cwi @ Xph @ (cwceq @ (ccin @ XC @ XD) @ cc0)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ Xph @ (cwceq @ (ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) @ (ccsn @ Xc_0))))))))))))))))).
