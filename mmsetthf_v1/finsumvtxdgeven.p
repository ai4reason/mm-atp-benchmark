...
thf(cfinsumvtxdgeven_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (cwceq @ (XI @ Xv) @ (ccfv @ XG @ cciedg))) => ((! [Xv:$i] : (cwceq @ (XD @ Xv) @ (ccfv @ XG @ ccvtxdg))) => (! [Xv:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ (XI @ Xv) @ ccfn)) @ (cwbr @ cc2 @ (ccsu @ XV @ (^ [Xv:$i] : (ccfv @ (ccv @ Xv) @ (XD @ Xv)))) @ ccdvds))))))))))).
