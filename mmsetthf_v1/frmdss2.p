...
thf(cfrmdss2_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XM @ (ccfv @ XI @ ccfrmd)) => ((cwceq @ XU @ (ccfv @ XI @ ccvrmd)) => (cwi @ (cw3a @ (cwcel @ XI @ XV) @ (cwss @ XJ @ XI) @ (cwcel @ XA2 @ (ccfv @ XM @ ccsubmnd))) @ (cwb @ (cwss @ (ccima @ XU @ XJ) @ XA2) @ (cwss @ (ccword @ XJ) @ XA2)))))))))))).
