...
thf(anmods_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XC @ (ccfv @ XS @ ccds)) => ((cwceq @ XD @ (ccfv @ XT @ ccds)) => (cwi @ (cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwbr @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ XD) @ (cco @ (ccfv @ XF @ XN) @ (cco @ XA2 @ XB2 @ XC) @ ccmul) @ ccle)))))))))))))))).
...
thf(cnghmcn_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XS @ cctopn)) => ((cwceq @ XK @ (ccfv @ XT @ cctopn)) => (cwi @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))).
