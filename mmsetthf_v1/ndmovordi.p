...
thf(cndmovordi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ (ccdm @ XF) @ (ccxp @ XS @ XS)) => ((cwss @ XR @ (ccxp @ XS @ XS)) => ((cwn @ (cwcel @ cc0 @ XS)) => ((cwi @ (cwcel @ XC @ XS) @ (cwb @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF) @ XR))) => (cwi @ (cwbr @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF) @ XR) @ (cwbr @ XA2 @ XB2 @ XR))))))))))))).
