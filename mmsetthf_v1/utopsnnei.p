...
thf(cutopsnnei_conj,conjecture,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XU @ ccutop)) => (cwi @ (cw3a @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU) @ (cwcel @ XP @ XX)) @ (cwcel @ (ccima @ XV @ (ccsn @ XP)) @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))))))))).
