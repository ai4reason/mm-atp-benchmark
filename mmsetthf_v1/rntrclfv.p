...
thf(atrclfvdecoml_thm,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwceq @ (ccfv @ XR @ cctcl) @ (ccun @ XR @ (cccom @ XR @ (ccfv @ XR @ cctcl)))))))).
...
thf(crntrclfv_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XR @ XV) @ (cwceq @ (ccrn @ (ccfv @ XR @ cctcl)) @ (ccrn @ XR)))))).
