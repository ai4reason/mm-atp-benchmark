...
thf(cftc2re_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xt:$i] : (cwceq @ (XE @ Xt) @ (cco @ (XC @ Xt) @ (XD @ Xt) @ ccioo))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XE @ Xt)))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XE @ Xt)))) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xt:$i] : (cwi @ Xph @ (cwf @ (XE @ Xt) @ ccc @ XF))) => ((! [Xt:$i] : (cwi @ Xph @ (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ (XE @ Xt) @ ccc @ cccncf)))) => (cwi @ Xph @ (cwceq @ (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)))) @ (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin))))))))))))))))).
