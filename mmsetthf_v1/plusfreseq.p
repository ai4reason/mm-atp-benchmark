...
thf(afveqressseq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdm @ XB2)) => (cwi @ (cw3a @ (cwfun @ XB2) @ (cwnel @ cc0 @ (ccrn @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) @ (cwceq @ (ccres @ XA2 @ XD) @ XB2))))))).
thf(afndm_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ XA2) @ (cwceq @ (ccdm @ XF) @ XA2))))).
thf(cplusfreseq_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XM @ ccplusg)) => ((cwceq @ Xc_pd @ (ccfv @ XM @ ccplusf)) => (cwi @ (cwnel @ cc0 @ (ccrn @ Xc_pd)) @ (cwceq @ (ccres @ Xc_pl @ (ccxp @ XB2 @ XB2)) @ Xc_pd)))))))))).
