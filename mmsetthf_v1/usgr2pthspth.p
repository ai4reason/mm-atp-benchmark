...
thf(ausgr2trlspth_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccfv @ XF @ cchash) @ cc2)) @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)))))))).
thf(ccz_tp,type,(ccz : ($i > $o))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(aspthispth_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccpths))))))).
thf(cusgr2pthspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwceq @ (ccfv @ XF @ cchash) @ cc2)) @ (cwb @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)))))))).
