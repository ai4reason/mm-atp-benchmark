...
thf(cdvmptresicc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccc)) @ (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ ccc @ (XF @ Xx3) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccc)) @ (cwcel @ (XB2 @ Xx3) @ ccc))) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => (cwi @ Xph @ (cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : (cco @ XC @ XD @ ccicc)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XC @ XD @ ccioo)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))))))).
