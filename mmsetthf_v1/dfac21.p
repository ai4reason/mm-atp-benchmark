...
thf(akelac2lem_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwcel @ (ccfv @ (ccpr @ XS @ (ccsn @ (ccpw @ (ccuni @ XS)))) @ cctg) @ cccmp))))).
...
thf(akelac2_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XS @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwne @ (XS @ Xx3) @ cc0))) => ((cwi @ Xph @ (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (XS @ Xx3) @ (ccsn @ (ccpw @ (ccuni @ (XS @ Xx3))))) @ cctg))) @ ccpt) @ cccmp)) => (cwi @ Xph @ (cwne @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XS @ Xx3))) @ cc0)))))))))).
...
thf(cdfac21_conj,conjecture,(cwb @ cwac @ (cwal @ (^ [Xf1:$i] : (cwi @ (cwf @ (ccdm @ (ccv @ Xf1)) @ cccmp @ (ccv @ Xf1)) @ (cwcel @ (ccfv @ (ccv @ Xf1) @ ccpt) @ cccmp)))))).
