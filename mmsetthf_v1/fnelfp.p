...
thf(afninfp_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ XA2) @ (cwceq @ (ccdm @ (ccin @ XF @ ccid)) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cfnelfp_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XX @ XA2)) @ (cwb @ (cwcel @ XX @ (ccdm @ (ccin @ XF @ ccid))) @ (cwceq @ (ccfv @ XX @ XF) @ XX))))))).
