...
thf(aseqcaopr_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_pl))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwcel @ (ccv @ Xz) @ XS))) @ (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (ccv @ Xz) @ Xc_pl) @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl) @ Xc_pl)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccuz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ (XM @ Xx3 @ Xy1 @ Xz) @ (XN @ Xx3 @ Xy1 @ Xz) @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xx3 @ Xy1 @ Xz)) @ XS)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ (XM @ Xx3 @ Xy1 @ Xz) @ (XN @ Xx3 @ Xy1 @ Xz) @ ccfz))) @ (cwcel @ (ccfv @ (ccv @ Xk) @ (XG @ Xx3 @ Xy1 @ Xz)) @ XS)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ (XM @ Xx3 @ Xy1 @ Xz) @ (XN @ Xx3 @ Xy1 @ Xz) @ ccfz))) @ (cwceq @ (ccfv @ (ccv @ Xk) @ (XH @ Xx3 @ Xy1 @ Xz)) @ (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xx3 @ Xy1 @ Xz)) @ (ccfv @ (ccv @ Xk) @ (XG @ Xx3 @ Xy1 @ Xz)) @ Xc_pl))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccseq @ Xc_pl @ (XH @ Xx3 @ Xy1 @ Xz) @ (XM @ Xx3 @ Xy1 @ Xz))) @ (cco @ (ccfv @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccseq @ Xc_pl @ (XF @ Xx3 @ Xy1 @ Xz) @ (XM @ Xx3 @ Xy1 @ Xz))) @ (ccfv @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccseq @ Xc_pl @ (XG @ Xx3 @ Xy1 @ Xz) @ (XM @ Xx3 @ Xy1 @ Xz))) @ Xc_pl)))))))))))))))))))))).
...
thf(amulgnn_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ XS @ (ccseq @ Xc_pl @ (ccxp @ ccn @ (ccsn @ XX)) @ cc1)) => (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ XN @ XX @ Xc_x) @ (ccfv @ XN @ XS))))))))))))))).
...
thf(cmulgnn0di_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ cccmn) @ (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (cco @ XM @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) @ (cco @ (cco @ XM @ XX @ Xc_x) @ (cco @ XM @ XY @ Xc_x) @ Xc_pl)))))))))))))).
