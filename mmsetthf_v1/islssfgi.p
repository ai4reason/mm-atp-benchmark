...
thf(cislssfgi_conj,conjecture,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XX @ (cco @ XW @ (ccfv @ XB2 @ XN) @ ccress)) => (cwi @ (cw3a @ (cwcel @ XW @ cclmod) @ (cwss @ XB2 @ XV) @ (cwcel @ XB2 @ ccfn)) @ (cwcel @ XX @ cclfig))))))))))).
