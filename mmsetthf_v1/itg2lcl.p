...
thf(citg2lcl_conj,conjecture,(! [XF:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xg1:$i] : (cwceq @ (XL @ Xx3 @ Xg1) @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xg1:$i] : (cwa @ (cwbr @ (ccv @ Xg1) @ XF @ (ccofr @ ccle)) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xg1) @ ccitg1)))) @ (^ [Xg1:$i] : (ccdm @ ccitg1)))))))) => (! [Xx3:$i] : (! [Xg1:$i] : (cwss @ (XL @ Xx3 @ Xg1) @ ccxr))))))).
