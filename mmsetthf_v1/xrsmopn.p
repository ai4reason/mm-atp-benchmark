...
thf(axrsblre_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XD @ (ccfv @ ccxrs @ ccds)) => (cwi @ (cwa @ (cwcel @ XP @ ccr) @ (cwcel @ XR @ ccxr)) @ (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ ccr))))))).
...
thf(axrsdsreclb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccfv @ ccxrs @ ccds)) => (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwne @ XA2 @ XB2)) @ (cwb @ (cwcel @ (cco @ XA2 @ XB2 @ XD) @ ccr) @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr))))))))).
...
thf(cxrsmopn_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XD @ (ccfv @ ccxrs @ ccds)) => ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwss @ (ccfv @ ccle @ ccordt) @ XJ)))))).
