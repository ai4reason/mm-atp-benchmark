...
thf(crevccat_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XT @ (ccword @ XA2))) @ (cwceq @ (ccfv @ (cco @ XS @ XT @ ccconcat) @ ccreverse) @ (cco @ (ccfv @ XT @ ccreverse) @ (ccfv @ XS @ ccreverse) @ ccconcat))))))).
