...
thf(ccntzrcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwi @ (cwcel @ XX @ (ccfv @ XS @ XZ)) @ (cwa @ (cwcel @ XM @ ccvv) @ (cwss @ XS @ XB2))))))))))).
