...
thf(calgcvg_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwf @ XS @ XS @ XF) => ((! [Xz:$i] : (cwceq @ XR @ (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xz))) @ ccc0))) => ((cwf @ XS @ ccn0 @ XC) => ((! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ XS) @ (cwi @ (cwne @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ ccc0) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ (ccfv @ (ccv @ Xz) @ XC) @ cclt)))) => ((! [Xz:$i] : (cwceq @ (XN @ Xz) @ (ccfv @ (XA2 @ Xz) @ XC))) => (! [Xz:$i] : (cwi @ (cwcel @ (XA2 @ Xz) @ XS) @ (cwceq @ (ccfv @ (ccfv @ (XN @ Xz) @ XR) @ XC) @ ccc0))))))))))))))).
