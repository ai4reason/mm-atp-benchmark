...
thf(cdedth3h_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwi @ (cwceq @ XA2 @ (ccif @ Xph @ XA2 @ XD)) @ (cwb @ Xth @ Xta)) => ((cwi @ (cwceq @ XB2 @ (ccif @ Xps @ XB2 @ XR)) @ (cwb @ Xta @ Xet)) => ((cwi @ (cwceq @ XC @ (ccif @ Xch @ XC @ XS)) @ (cwb @ Xet @ Xze)) => (Xze => (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xth))))))))))))))))))).
