...
thf(anosupbnd1lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ (ccif @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccun @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccsn @ (ccop @ (ccdm @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ cc2o))) @ (ccmpt @ (^ [Xg1:$i] : (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xy1)))))) @ (^ [Xv:$i] : XA2)))) @ (^ [Xu:$i] : XA2))))) @ (^ [Xg1:$i] : (ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xg1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xg1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xg1)))))) @ (^ [Xv:$i] : XA2)) @ (cwceq @ (ccfv @ (ccv @ Xg1) @ (ccv @ Xu)) @ (ccv @ Xx3)))) @ (^ [Xu:$i] : XA2))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (cwi @ (cw3a @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ (cwa @ (cwss @ XA2 @ ccsur) @ (cwcel @ XA2 @ ccvv)) @ (cwa @ (cwa @ (cwcel @ (XU @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ XA2) @ (cwceq @ (ccres @ (XU @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1))) @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1))) @ (cwa @ (cwcel @ (XW @ Xx3 @ Xy1 @ Xu @ Xg1) @ XA2) @ (cwn @ (cwbr @ (XW @ Xx3 @ Xy1 @ Xu @ Xg1) @ (XU @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ ccslt))))) @ (cwceq @ (ccres @ (XW @ Xx3 @ Xy1 @ Xu @ Xg1) @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1))) @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1)))))))))))))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(anosupbnd1lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ (ccif @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccun @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccsn @ (ccop @ (ccdm @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ cc2o))) @ (ccmpt @ (^ [Xg1:$i] : (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xy1)))))) @ (^ [Xv:$i] : XA2)))) @ (^ [Xu:$i] : XA2))))) @ (^ [Xg1:$i] : (ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xg1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xg1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xg1)))))) @ (^ [Xv:$i] : XA2)) @ (cwceq @ (ccfv @ (ccv @ Xg1) @ (ccv @ Xu)) @ (ccv @ Xx3)))) @ (^ [Xu:$i] : XA2))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (cwi @ (cw3a @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ (cwa @ (cwss @ XA2 @ ccsur) @ (cwcel @ XA2 @ ccvv)) @ (cwa @ (cwcel @ (XU @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ XA2) @ (cwceq @ (ccres @ (XU @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1))) @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1)))) @ (cwne @ (ccfv @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1)) @ (XU @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1)) @ cc2o)))))))))))).
...
thf(anolt02o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XX @ ccon0)) @ (cwa @ (cwceq @ (ccres @ XA2 @ XX) @ (ccres @ XB2 @ XX)) @ (cwbr @ XA2 @ XB2 @ ccslt)) @ (cwceq @ (ccfv @ XX @ XA2) @ cc0)) @ (cwceq @ (ccfv @ XX @ XB2) @ cc2o)))))).
thf(cnosupbnd1lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ (ccif @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccun @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccsn @ (ccop @ (ccdm @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ cc2o))) @ (ccmpt @ (^ [Xg1:$i] : (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xy1)))))) @ (^ [Xv:$i] : XA2)))) @ (^ [Xu:$i] : XA2))))) @ (^ [Xg1:$i] : (ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xg1) @ (ccdm @ (ccv @ Xu))) @ (cwral @ (^ [Xv:$i] : (cwi @ (cwn @ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) @ (cwceq @ (ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xg1))) @ (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xg1)))))) @ (^ [Xv:$i] : XA2)) @ (cwceq @ (ccfv @ (ccv @ Xg1) @ (ccv @ Xu)) @ (ccv @ Xx3)))) @ (^ [Xu:$i] : XA2))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (cwi @ (cw3a @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ (cwa @ (cwss @ XA2 @ ccsur) @ (cwcel @ XA2 @ ccvv)) @ (cwa @ (cwcel @ (XU @ Xx3 @ Xy1 @ Xv @ Xg1) @ XA2) @ (cwceq @ (ccres @ (XU @ Xx3 @ Xy1 @ Xv @ Xg1) @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1))) @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1)))) @ (cwne @ (ccfv @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1)) @ (XU @ Xx3 @ Xy1 @ Xv @ Xg1)) @ cc0)))))))))))).
