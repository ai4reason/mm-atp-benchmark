...
thf(adf_vc_ax,axiom,(cwceq @ ccvc @ (ccopab @ (^ [Xg1:$i] : (^ [Xs1:$i] : (cw3a @ (cwcel @ (ccv @ Xg1) @ ccablo) @ (cwf @ (ccxp @ ccc @ (ccrn @ (ccv @ Xg1))) @ (ccrn @ (ccv @ Xg1)) @ (ccv @ Xs1)) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ cc1 @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwa @ (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xs1)) @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xs1)) @ (ccv @ Xg1)))) @ (^ [Xz:$i] : (ccrn @ (ccv @ Xg1)))) @ (cwral @ (^ [Xz:$i] : (cwa @ (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccaddc) @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (ccv @ Xg1))) @ (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmul) @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (ccv @ Xs1))))) @ (^ [Xz:$i] : ccc)))) @ (^ [Xy1:$i] : ccc)))) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1)))))))))).
thf(cvciOLD_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ XG @ (ccfv @ (XW @ Xx3 @ Xy1 @ Xz) @ cc1st))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ XS @ (ccfv @ (XW @ Xx3 @ Xy1 @ Xz) @ cc2nd))))) => ((cwceq @ XX @ (ccrn @ XG)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (XW @ Xx3 @ Xy1 @ Xz) @ ccvc) @ (cw3a @ (cwcel @ XG @ ccablo) @ (cwf @ (ccxp @ ccc @ XX) @ XX @ XS) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ cc1 @ (ccv @ Xx3) @ XS) @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwa @ (cwral @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XG) @ XS) @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XS) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XS) @ XG))) @ (^ [Xz:$i] : XX)) @ (cwral @ (^ [Xz:$i] : (cwa @ (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccaddc) @ (ccv @ Xx3) @ XS) @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XS) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XS) @ XG)) @ (cwceq @ (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmul) @ (ccv @ Xx3) @ XS) @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XS) @ XS)))) @ (^ [Xz:$i] : ccc)))) @ (^ [Xy1:$i] : ccc)))) @ (^ [Xx3:$i] : XX))))))))))))))).
