...
thf(alecmi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwss @ XA2 @ XB2) @ (cwbr @ XA2 @ XB2 @ cccm))))))).
...
thf(clecm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ XB2)) @ (cwbr @ XA2 @ XB2 @ cccm))))).
