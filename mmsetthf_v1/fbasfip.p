...
thf(afbssint_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) @ (cwss @ XA2 @ XF) @ (cwcel @ XA2 @ ccfn)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccint @ XA2))) @ (^ [Xx3:$i] : XF))))))).
...
thf(cfbasfip_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwn @ (cwcel @ cc0 @ (ccfv @ XF @ ccfi))))))).
