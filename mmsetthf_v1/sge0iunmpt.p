...
thf(csge0iunmpt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ (XW @ Xk))))) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) @ (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xk:$i] : (XB2 @ Xx3)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0))) @ ccsumge0)))))))))))))).
