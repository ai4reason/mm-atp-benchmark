...
thf(advge0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((cwi @ Xph @ (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ ccc0 @ ccpnf @ ccico) @ (cco @ ccr @ XF @ ccdv))) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwcel @ XY @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwbr @ XX @ XY @ ccle)) => (cwi @ Xph @ (cwbr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccle)))))))))))))))).
