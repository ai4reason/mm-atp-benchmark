...
thf(alrelat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((! [Xq:$i] : (cwceq @ (Xc_po @ Xq) @ (ccfv @ XW @ cclsm))) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwpss @ XT @ XU)) => (cwi @ Xph @ (cwrex @ (^ [Xq:$i] : (cwa @ (cwpss @ XT @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq))) @ (cwss @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq)) @ XU))) @ (^ [Xq:$i] : XA2)))))))))))))))))).
...
thf(alcvnbtwn2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((cwceq @ XC @ (ccfv @ XW @ cclcv)) => ((cwi @ Xph @ (cwcel @ XW @ XX)) => ((cwi @ Xph @ (cwcel @ XR @ XS)) => ((cwi @ Xph @ (cwcel @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((cwi @ Xph @ (cwbr @ XR @ XT @ XC)) => ((cwi @ Xph @ (cwpss @ XR @ XU)) => ((cwi @ Xph @ (cwss @ XU @ XT)) => (cwi @ Xph @ (cwceq @ XU @ XT)))))))))))))))))))).
...
thf(clcvat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XS @ (ccfv @ XW @ cclss)) => ((! [Xq:$i] : (cwceq @ (Xc_po @ Xq) @ (ccfv @ XW @ cclsm))) => ((cwceq @ XA2 @ (ccfv @ XW @ cclsa)) => ((! [Xq:$i] : (cwceq @ (XC @ Xq) @ (ccfv @ XW @ cclcv))) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XT @ XS)) => ((cwi @ Xph @ (cwcel @ XU @ XS)) => ((! [Xq:$i] : (cwi @ Xph @ (cwbr @ XT @ XU @ (XC @ Xq)))) => (cwi @ Xph @ (cwrex @ (^ [Xq:$i] : (cwceq @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq)) @ XU)) @ (^ [Xq:$i] : XA2)))))))))))))))))))).
