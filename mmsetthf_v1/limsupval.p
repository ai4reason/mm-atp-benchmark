...
thf(adf_limsup_ax,axiom,(cwceq @ cclsp @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt)))) @ ccxr @ cclt))))).
...
thf(climsupval_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (cwcel @ XF @ (XV @ Xk)) @ (cwceq @ (ccfv @ XF @ cclsp) @ (ccinf @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))).
