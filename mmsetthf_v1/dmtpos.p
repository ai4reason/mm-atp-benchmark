...
thf(areldmtpos_thm,axiom,(! [XF:($i > $o)] : (cwb @ (cwrel @ (ccdm @ (cctpos @ XF))) @ (cwn @ (cwcel @ cc0 @ (ccdm @ XF)))))).
...
thf(cdmtpos_conj,conjecture,(! [XF:($i > $o)] : (cwi @ (cwrel @ (ccdm @ XF)) @ (cwceq @ (ccdm @ (cctpos @ XF)) @ (cccnv @ (ccdm @ XF)))))).
