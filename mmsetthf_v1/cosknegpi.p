...
thf(acosper_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XK @ ccz)) @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccaddc) @ cccos) @ (ccfv @ XA2 @ cccos)))))).
...
thf(acosnegpi_thm,axiom,(cwceq @ (ccfv @ (ccneg @ ccpi) @ cccos) @ (ccneg @ cc1))).
thf(ccosknegpi_conj,conjecture,(! [XK:($i > $o)] : (cwi @ (cwcel @ XK @ ccz) @ (cwceq @ (ccfv @ (cco @ XK @ (ccneg @ ccpi) @ ccmul) @ cccos) @ (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
