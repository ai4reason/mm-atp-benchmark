...
thf(aalephreg_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ (ccsuc @ XA2) @ ccale) @ cccf) @ (ccfv @ (ccsuc @ XA2) @ ccale)))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(amp2b_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => Xch))))))).
thf(ccrecs_tp,type,(ccrecs : (($i > $o) > ($i > $o)))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acfsmo_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwex @ (^ [Xf1:$i] : (cw3a @ (cwf @ (ccfv @ XA2 @ cccf) @ XA2 @ (ccv @ Xf1)) @ (cwsmo @ (ccv @ Xf1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (ccfv @ XA2 @ cccf)))) @ (^ [Xz:$i] : XA2)))))))).
...
thf(aalephislim_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccon0) @ (cwlim @ (ccfv @ XA2 @ ccale))))).
...
thf(aharcard_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ XA2 @ cchar) @ cccrd) @ (ccfv @ XA2 @ cchar)))).
...
thf(akonigth_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xi:$i] : (cwceq @ (XS @ Xi) @ (cciun @ (^ [Xi:$i] : XA2) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (XM @ Xi)))))) => ((! [Xi:$i] : (cwceq @ (XP @ Xi) @ (ccixp @ (^ [Xi:$i] : XA2) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (XN @ Xi)))))) => (! [Xi:$i] : (cwi @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (XM @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XN @ Xi)) @ ccsdm)) @ (^ [Xi:$i] : XA2)) @ (cwbr @ (XS @ Xi) @ (XP @ Xi) @ ccsdm)))))))))))).
...
thf(aalephlim_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwlim @ XA2)) @ (cwceq @ (ccfv @ XA2 @ ccale) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccale))))))))).
...
thf(aalephcard_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ XA2 @ ccale) @ cccrd) @ (ccfv @ XA2 @ ccale)))).
...
thf(cpwcfsdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XH @ Xy1 @ Xf1) @ (ccmpt @ (^ [Xy1:$i] : (ccfv @ (ccfv @ XA2 @ ccale) @ cccf)) @ (^ [Xy1:$i] : (ccfv @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ cchar)))))) => (cwbr @ (ccfv @ XA2 @ ccale) @ (cco @ (ccfv @ XA2 @ ccale) @ (ccfv @ (ccfv @ XA2 @ ccale) @ cccf) @ ccmap) @ ccsdm))))).
