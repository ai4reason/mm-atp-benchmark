...
thf(ainxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwceq @ (ccin @ (ccxp @ XA2 @ XB2) @ (ccxp @ XC @ XD)) @ (ccxp @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XD)))))))).
...
thf(cmbfmcst_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccuni @ XS)) @ (^ [Xx3:$i] : XA2))))) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccuni @ XT))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xx3) @ (cco @ XS @ XT @ ccmbfm)))))))))))))).
