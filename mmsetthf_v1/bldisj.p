...
thf(cbldisj_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XQ @ XX)) @ (cw3a @ (cwcel @ XR @ ccxr) @ (cwcel @ XS @ ccxr) @ (cwbr @ (cco @ XR @ XS @ ccxad) @ (cco @ XP @ XQ @ XD) @ ccle))) @ (cwceq @ (ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))) @ cc0))))))))).
