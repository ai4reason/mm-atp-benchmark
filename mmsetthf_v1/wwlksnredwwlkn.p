...
thf(awwlksnred_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwi @ (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) @ (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) @ (cco @ XN @ XG @ ccwwlksn)))))))).
...
thf(cwwlksnredwwlkn_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwcel @ XN @ ccn0) @ (cwi @ (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) @ (cwrex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) @ (ccv @ Xy1)) @ (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ XW @ cclsw)) @ XE))) @ (^ [Xy1:$i] : (cco @ XN @ XG @ ccwwlksn))))))))))).
