...
thf(chi2eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwb @ (cwceq @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmv) @ ccsp) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccmv) @ ccsp)) @ (cwceq @ XA2 @ XB2)))))).
