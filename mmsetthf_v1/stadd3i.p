...
thf(cstadd3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwi @ (cwcel @ XS @ ccst) @ (cwi @ (cwceq @ (cco @ (cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XB2 @ XS) @ ccaddc) @ (ccfv @ XC @ XS) @ ccaddc) @ cc3) @ (cwceq @ (ccfv @ XA2 @ XS) @ cc1))))))))))).
