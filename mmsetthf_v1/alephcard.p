...
thf(acardiun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwi @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (XB2 @ Xx3) @ cccrd) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwceq @ (ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cccrd) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(calephcard_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ XA2 @ ccale) @ cccrd) @ (ccfv @ XA2 @ ccale)))).
