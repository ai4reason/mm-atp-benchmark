...
thf(anmf2_thm,axiom,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XW @ ccnm)) => ((cwceq @ XX @ (ccfv @ XW @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccds)) => ((cwceq @ XE @ (ccres @ XD @ (ccxp @ XX @ XX))) => (cwi @ (cwa @ (cwcel @ XW @ ccgrp) @ (cwcel @ XE @ (ccfv @ XX @ ccme))) @ (cwf @ XX @ ccr @ XN)))))))))))).
...
thf(amsf_thm,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XM @ ccbs)) => ((cwceq @ XD @ (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX))) => (cwi @ (cwcel @ XM @ ccmt) @ (cwf @ (ccxp @ XX @ XX) @ ccr @ XD)))))))).
...
thf(cisngp2_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (ccfv @ XG @ ccnm)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ XD @ (ccfv @ XG @ ccds)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccres @ XD @ (ccxp @ XX @ XX))) => (cwb @ (cwcel @ XG @ ccngp) @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XG @ ccmt) @ (cwceq @ (cccom @ XN @ Xc_mi) @ XE))))))))))))))).
