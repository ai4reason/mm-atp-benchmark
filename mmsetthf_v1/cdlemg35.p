...
thf(ccdlemg35_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xv:$i] : (cwceq @ (Xc_or @ Xv) @ (ccfv @ XK @ ccjn))) => ((! [Xv:$i] : (cwceq @ (Xc_an @ Xv) @ (ccfv @ XK @ ccmee))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XR @ (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) @ (cw3a @ (cwne @ (ccfv @ XP @ XF) @ XP) @ (cwne @ (ccfv @ XP @ XG) @ XP) @ (cwne @ (ccfv @ XF @ XR) @ (ccfv @ XG @ XR)))) @ (cwrex @ (^ [Xv:$i] : (cwa @ (cwbr @ (ccv @ Xv) @ XW @ Xc_le) @ (cwa @ (cwne @ (ccv @ Xv) @ (ccfv @ XF @ XR)) @ (cwne @ (ccv @ Xv) @ (ccfv @ XG @ XR))))) @ (^ [Xv:$i] : XA2))))))))))))))))))))))).
