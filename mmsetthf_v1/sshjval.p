...
thf(adf_chj_ax,axiom,(cwceq @ cchj @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ cchil))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ cchil))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccort) @ ccort)))))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(csshjval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwss @ XA2 @ cchil) @ (cwss @ XB2 @ cchil)) @ (cwceq @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ (ccfv @ (ccun @ XA2 @ XB2) @ ccort) @ ccort)))))).
