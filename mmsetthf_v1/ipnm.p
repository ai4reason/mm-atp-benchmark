...
thf(cipnm_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XN @ (ccfv @ XU @ ccnmcv)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (ccfv @ XA2 @ XN) @ (ccfv @ (cco @ XA2 @ XA2 @ XP) @ ccsqrt)))))))))))).
