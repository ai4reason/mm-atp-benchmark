...
thf(c_2ndcomap_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (ccuni @ XK))) => ((cwi @ Xph @ (cwcel @ XJ @ cc2ndc)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccrn @ XF) @ (XY @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XJ)) @ (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ XK))) => (cwi @ Xph @ (cwcel @ XK @ cc2ndc))))))))))))).
