...
thf(cressuppssdif_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ XV) @ (cwcel @ XZ @ XW)) @ (cwss @ (cco @ XF @ XZ @ ccsupp) @ (ccun @ (cco @ (ccres @ XF @ XB2) @ XZ @ ccsupp) @ (ccdif @ (ccdm @ XF) @ XB2)))))))))).
