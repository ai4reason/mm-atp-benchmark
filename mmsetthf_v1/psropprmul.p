...
thf(acaonncan_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XI @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf @ (XI @ Xx3 @ Xy1) @ XS @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf @ (XI @ Xx3 @ Xy1) @ XS @ (XB2 @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) @ XM) @ (ccv @ Xy1))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (cco @ XA2 @ (XB2 @ Xx3) @ (ccof @ XM)) @ (ccof @ XM)) @ (XB2 @ Xx3)))))))))))))))).
...
thf(apsrbaspropd_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XR @ ccbs) @ (ccfv @ XS @ ccbs))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XI @ XR @ ccmps) @ ccbs) @ (ccfv @ (cco @ XI @ XS @ ccmps) @ ccbs))))))))).
thf(aeqtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XB2 @ XC) => (cwceq @ XA2 @ XC))))))).
thf(afveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(cpsropprmul_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XY @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XS @ (ccfv @ XR @ ccoppr)) => ((cwceq @ XZ @ (cco @ XI @ XS @ ccmps)) => ((cwceq @ Xc_x @ (ccfv @ XY @ ccmulr)) => ((cwceq @ Xc_xb @ (ccfv @ XZ @ ccmulr)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) @ (cwceq @ (cco @ XF @ XG @ Xc_xb) @ (cco @ XG @ XF @ Xc_x)))))))))))))))))))).
