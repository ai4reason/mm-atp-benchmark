...
thf(adf_tpos_ax,axiom,(! [XF:($i > $o)] : (cwceq @ (cctpos @ XF) @ (cccom @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (cccnv @ (ccdm @ XF)) @ (ccsn @ cc0))) @ (^ [Xx3:$i] : (ccuni @ (cccnv @ (ccsn @ (ccv @ Xx3)))))))))).
...
thf(ctposssxp_conj,conjecture,(! [XF:($i > $o)] : (cwss @ (cctpos @ XF) @ (ccxp @ (ccun @ (cccnv @ (ccdm @ XF)) @ (ccsn @ cc0)) @ (ccrn @ XF))))).
