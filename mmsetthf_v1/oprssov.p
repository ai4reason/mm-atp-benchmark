...
thf(coprssov_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwfun @ XF) @ (cwfn @ XG @ (ccxp @ XC @ XD)) @ (cwss @ XG @ XF)) @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD))) @ (cwceq @ (cco @ XA2 @ XB2 @ XF) @ (cco @ XA2 @ XB2 @ XG)))))))))).
