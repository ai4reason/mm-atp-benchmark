...
thf(crecnnltrp_conj,conjecture,(! [XE:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (ccfv @ (cco @ cc1 @ XE @ ccdiv) @ ccfl) @ cc1 @ ccaddc)) => (cwi @ (cwcel @ XE @ ccrp) @ (cwa @ (cwcel @ XN @ ccn) @ (cwbr @ (cco @ cc1 @ XN @ ccdiv) @ XE @ cclt))))))).
