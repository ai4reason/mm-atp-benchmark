...
thf(axpexcnv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwne @ XB2 @ cc0) @ (cwcel @ (ccxp @ XA2 @ XB2) @ ccvv)) @ (cwcel @ XA2 @ ccvv))))).
...
thf(cfczsupp0_conj,conjecture,(! [XB2:($i > $o)] : (! [XZ:($i > $o)] : (cwceq @ (cco @ (ccxp @ XB2 @ (ccsn @ XZ)) @ XZ @ ccsupp) @ cc0)))).
