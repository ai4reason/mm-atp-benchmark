...
thf(abposlem4_thm,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => ((cwi @ Xph @ (cwn @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ XN @ (ccv @ Xp) @ cclt) @ (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ cc1))))) => ((cwceq @ XK @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ ccfl)) => ((! [Xn:$i] : (cwceq @ (XM @ Xn) @ (ccfv @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ ccfl))) => (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xn) @ (cco @ cc3 @ XK @ ccfz))))))))))))))).
...
thf(apcmptdvds_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (XA2 @ Xn) @ ccexp) @ cc1))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwral @ (^ [Xn:$i] : (cwcel @ (XA2 @ Xn) @ ccn0)) @ (^ [Xn:$i] : ccprime)))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XM @ Xn) @ (ccfv @ (XN @ Xn) @ ccuz)))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccfv @ (XN @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ (ccfv @ (XM @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ ccdvds))))))))))))).
...
thf(aefchtdvds_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ cccht) @ cce) @ (ccfv @ (ccfv @ XB2 @ cccht) @ cce) @ ccdvds))))).
thf(ccicc_tp,type,(ccicc : ($i > $o))).
thf(aefchtcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ (ccfv @ XA2 @ cccht) @ cce) @ ccn)))).
...
thf(altexp2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwi @ Xph @ (cwbr @ cc1 @ XA2 @ cclt)) => (cwi @ Xph @ (cwb @ (cwbr @ XM @ XN @ cclt) @ (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ cclt)))))))))))).
...
thf(alt2sqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XB2 @ ccle)) => (cwi @ Xph @ (cwb @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ cclt))))))))))).
...
thf(aprmorcht_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccv @ Xn) @ cc1))))) => (! [Xn:$i] : (cwi @ (cwcel @ (XA2 @ Xn) @ ccn) @ (cwceq @ (ccfv @ (ccfv @ (XA2 @ Xn) @ cccht) @ cce) @ (ccfv @ (XA2 @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))).
...
thf(acht3_thm,axiom,(cwceq @ (ccfv @ cc3 @ cccht) @ (ccfv @ cc6 @ cclog))).
...
thf(achtwordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwbr @ (ccfv @ XA2 @ cccht) @ (ccfv @ XB2 @ cccht) @ ccle))))).
...
thf(achtub_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccr) @ (cwbr @ cc2 @ XN @ cclt)) @ (cwbr @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc2 @ cclog) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccmin) @ ccmul) @ cclt)))).
...
thf(areexplog_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XN @ ccz)) @ (cwceq @ (cco @ XA2 @ XN @ ccexp) @ (ccfv @ (cco @ XN @ (ccfv @ XA2 @ cclog) @ ccmul) @ cce)))))).
...
thf(abposlem5_thm,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => ((cwi @ Xph @ (cwn @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ XN @ (ccv @ Xp) @ cclt) @ (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ cc1))))) => ((cwceq @ XK @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ ccfl)) => ((! [Xn:$i] : (cwceq @ (XM @ Xn) @ (ccfv @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ ccfl))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XM @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ cccxp) @ ccle)))))))))))))).
...
thf(cbposlem6_conj,conjecture,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => ((cwi @ Xph @ (cwn @ (cwrex @ (^ [Xp:$i] : (cwa @ (cwbr @ XN @ (ccv @ Xp) @ cclt) @ (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ cc1))))) => ((cwceq @ XK @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ ccfl)) => ((! [Xn:$i] : (cwceq @ (XM @ Xn) @ (ccfv @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ ccfl))) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ cccxp) @ (cco @ cc2 @ (cco @ (cco @ (cco @ cc4 @ XN @ ccmul) @ cc3 @ ccdiv) @ cc5 @ ccmin) @ cccxp) @ ccmul) @ cclt))))))))))))).
