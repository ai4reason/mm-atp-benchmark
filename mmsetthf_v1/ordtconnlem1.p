...
thf(anconnsubb_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwss @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ XU @ XJ)) => ((cwi @ Xph @ (cwcel @ XV @ XJ)) => ((cwi @ Xph @ (cwne @ (ccin @ XU @ XA2) @ cc0)) => ((cwi @ Xph @ (cwne @ (ccin @ XV @ XA2) @ cc0)) => ((cwi @ Xph @ (cwceq @ (ccin @ (ccin @ XU @ XV) @ XA2) @ cc0)) => ((cwi @ Xph @ (cwss @ XA2 @ (ccun @ XU @ XV))) => (cwi @ Xph @ (cwn @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn)))))))))))))))))).
...
thf(atrleile_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cw3a @ (cwcel @ XK @ cctos) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwo @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XY @ XX @ Xc_le))))))))))).
thf(aoran_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwo @ Xph @ Xps) @ (cwn @ (cwa @ (cwn @ Xph) @ (cwn @ Xps))))))).
...
thf(an0f_thm,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : (cwb @ (cwne @ (XA2 @ Xx3) @ cc0) @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))))))))).
...
thf(aposrasymb_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cw3a @ (cwcel @ XK @ ccpo) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwa @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ XY @ XX @ Xc_le)) @ (cwceq @ XX @ XY))))))))))).
...
thf(apm5_17_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwb @ (cwa @ (cwo @ Xph @ Xps) @ (cwn @ (cwa @ Xph @ Xps))) @ (cwb @ Xph @ (cwn @ Xps)))))).
thf(anecomd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwne @ XB2 @ XA2))))))).
thf(cordtconnlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((! [Xr:$i] : (cwceq @ (Xc_le @ Xr) @ (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccfv @ (Xc_le @ Xr) @ ccordt))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XK @ cctos) @ (cwss @ XA2 @ XB2)) @ (cwi @ (cwcel @ (cco @ (XJ @ Xx3 @ Xy1) @ XA2 @ ccrest) @ ccconn) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xr:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xr) @ (Xc_le @ Xr)) @ (cwbr @ (ccv @ Xr) @ (ccv @ Xy1) @ (Xc_le @ Xr))) @ (cwcel @ (ccv @ Xr) @ XA2))) @ (^ [Xr:$i] : XB2))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))))))))))))).
