...
thf(afclssscls_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwi @ (cwcel @ XS @ XF) @ (cwss @ (cco @ XJ @ XF @ ccfcls) @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))))))).
...
thf(cfclscmp_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XJ @ cccmp) @ (cwral @ (^ [Xf1:$i] : (cwne @ (cco @ XJ @ (ccv @ Xf1) @ ccfcls) @ cc0)) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))).
