...
thf(adf_tmd_ax,axiom,(cwceq @ cctmd @ (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xj:$i] : (cwcel @ (ccfv @ (ccv @ Xf1) @ ccplusf) @ (cco @ (cco @ (ccv @ Xj) @ (ccv @ Xj) @ cctx) @ (ccv @ Xj) @ cccn))) @ (ccfv @ (ccv @ Xf1) @ cctopn))) @ (^ [Xf1:$i] : (ccin @ ccmnd @ cctps))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cistmd_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XF @ (ccfv @ XG @ ccplusf)) => ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => (cwb @ (cwcel @ XG @ cctmd) @ (cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XG @ cctps) @ (cwcel @ XF @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn)))))))))).
