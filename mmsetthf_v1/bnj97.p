...
thf(cbnj97_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccsn @ (ccop @ cc0 @ (cc_bnj14 @ XA2 @ XR @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cw_bnj15 @ XA2 @ XR) @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwceq @ (ccfv @ cc0 @ (XF @ Xx3)) @ (cc_bnj14 @ XA2 @ XR @ (ccv @ Xx3)))))))))).
