...
thf(afpwwe2lem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (cwceq @ XW @ (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (cwa @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) @ (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => (! [Xy1:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XX @ XR @ XW) @ (cwa @ (cwa @ (cwss @ XX @ (XA2 @ Xy1 @ Xu)) @ (cwss @ XR @ (ccxp @ XX @ XX))) @ (cwa @ (cwwe @ XX @ XR) @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccin @ XR @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) @ (ccv @ Xy1))) @ (ccima @ (cccnv @ XR) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XX))))))))))))))))).
...
thf(afpwwe2lem10_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (cwceq @ XW @ (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (cwa @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) @ (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xr:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ XF) @ (XA2 @ Xy1 @ Xu))))))) => ((cwi @ Xph @ (cwbr @ XX @ XR @ XW)) => ((cwi @ Xph @ (cwbr @ XY @ XS @ XW)) => (cwi @ Xph @ (cwo @ (cwa @ (cwss @ XX @ XY) @ (cwceq @ XR @ (ccin @ XS @ (ccxp @ XY @ XX)))) @ (cwa @ (cwss @ XY @ XX) @ (cwceq @ XS @ (ccin @ XR @ (ccxp @ XX @ XY)))))))))))))))))))).
...
thf(arelelrni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => (cwi @ (cwbr @ XA2 @ XB2 @ XR) @ (cwcel @ XB2 @ (ccrn @ XR)))))))).
...
thf(afpwwe2lem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (cwceq @ XW @ (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (cwa @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) @ (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((cwi @ Xph @ (cwbr @ XX @ XR @ XW)) => (! [Xx3:$i] : (! [Xr:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (XB2 @ Xx3 @ Xr) @ XX)) @ (cwceq @ (cco @ (ccima @ (cccnv @ XR) @ (ccsn @ (XB2 @ Xx3 @ Xr))) @ (ccin @ XR @ (ccxp @ (ccima @ (cccnv @ XR) @ (ccsn @ (XB2 @ Xx3 @ Xr))) @ (ccima @ (cccnv @ XR) @ (ccsn @ (XB2 @ Xx3 @ Xr))))) @ XF) @ (XB2 @ Xx3 @ Xr)))))))))))))))).
thf(afpwwe2cbv_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xa:$i] : (cwceq @ (XW @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xs1 @ Xr @ Xa) @ (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xv @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (cwa @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) @ (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xa:$i] : (cwceq @ (XW @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xs1 @ Xr @ Xa) @ (ccopab @ (^ [Xa:$i] : (^ [Xs1:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xa) @ (XA2 @ Xy1 @ Xv @ Xu)) @ (cwss @ (ccv @ Xs1) @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)))) @ (cwa @ (cwwe @ (ccv @ Xa) @ (ccv @ Xs1)) @ (cwral @ (^ [Xz:$i] : (cwsbc @ (^ [Xv:$i] : (cwceq @ (cco @ (ccv @ Xv) @ (ccin @ (ccv @ Xs1) @ (ccxp @ (ccv @ Xv) @ (ccv @ Xv))) @ XF) @ (ccv @ Xz))) @ (ccima @ (cccnv @ (ccv @ Xs1)) @ (ccsn @ (ccv @ Xz))))) @ (^ [Xz:$i] : (ccv @ Xa)))))))))))))))))))))).
...
thf(cfpwwe2lem12_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (cwceq @ XW @ (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (cwa @ (cwa @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (cwa @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) @ (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : (cwceq @ (cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) @ (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xr:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ XF) @ (XA2 @ Xy1 @ Xu))))))) => ((cwceq @ XX @ (ccuni @ (ccdm @ XW))) => (cwi @ Xph @ (cwcel @ XX @ (ccdm @ XW))))))))))))).
