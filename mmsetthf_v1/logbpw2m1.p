...
thf(apw2m1lepw2m1_thm,axiom,(! [XI:($i > $o)] : (cwi @ (cwcel @ XI @ ccn) @ (cwbr @ (cco @ cc2 @ (cco @ XI @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ XI @ ccexp) @ cc1 @ ccmin) @ ccle)))).
...
thf(clogbpw2m1_conj,conjecture,(! [XI:($i > $o)] : (cwi @ (cwcel @ XI @ ccn) @ (cwceq @ (ccfv @ (cco @ cc2 @ (cco @ (cco @ cc2 @ XI @ ccexp) @ cc1 @ ccmin) @ cclogb) @ ccfl) @ (cco @ XI @ cc1 @ ccmin))))).
