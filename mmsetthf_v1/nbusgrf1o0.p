...
thf(aedgnbusgreu_thm,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xn:$i] : (cwceq @ (XN @ Xn) @ (cco @ XG @ XM @ ccnbgr))) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XM @ XV)) @ (cwa @ (cwcel @ XC @ XE) @ (cwcel @ XM @ XC))) @ (cwreu @ (^ [Xn:$i] : (cwceq @ XC @ (ccpr @ XM @ (ccv @ Xn)))) @ (^ [Xn:$i] : (XN @ Xn)))))))))))))).
...
thf(cnbusgrf1o0_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XN @ (cco @ XG @ XU @ ccnbgr)) => ((cwceq @ XI @ (ccrab @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))) => ((! [Xn:$i] : (cwceq @ (XF @ Xn) @ (ccmpt @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (ccpr @ XU @ (ccv @ Xn)))))) => (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XU @ XV)) @ (cwf1o @ XN @ XI @ (XF @ Xn))))))))))))))))).
