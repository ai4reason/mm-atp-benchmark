...
thf(cipasslem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XG @ (ccfv @ XU @ ccpv)) => ((cwceq @ XS @ (ccfv @ XU @ ccns)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XB2 @ XX) => (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ XX)) @ (cwceq @ (cco @ (cco @ (cco @ cc1 @ XN @ ccdiv) @ XA2 @ XS) @ XB2 @ XP) @ (cco @ (cco @ cc1 @ XN @ ccdiv) @ (cco @ XA2 @ XB2 @ XP) @ ccmul)))))))))))))))))).
