...
thf(adrngnidl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => (cwi @ (cwcel @ XR @ ccdr) @ (cwceq @ XU @ (ccpr @ (ccsn @ Xc_0) @ XB2))))))))))).
...
thf(alpi1_thm,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ cclpidl)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwcel @ XB2 @ XP)))))))).
...
thf(cdrnglpir_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccdr) @ (cwcel @ XR @ cclpir)))).
