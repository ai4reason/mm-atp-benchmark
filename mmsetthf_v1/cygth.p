...
thf(acygzn_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ XN @ (ccif @ (cwcel @ XB2 @ ccfn) @ (ccfv @ XB2 @ cchash) @ ccc0)) => ((cwceq @ XY @ (ccfv @ XN @ cczn)) => (cwi @ (cwcel @ XG @ cccyg) @ (cwbr @ XG @ XY @ ccgic)))))))))).
...
thf(azncyg_thm,axiom,(! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (ccfv @ XN @ cczn)) => (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ XY @ cccyg)))))).
thf(ccghm_tp,type,(ccghm : ($i > $o))).
thf(agiccyg_thm,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (cwi @ (cwbr @ XG @ XH @ ccgic) @ (cwi @ (cwcel @ XG @ cccyg) @ (cwcel @ XH @ cccyg)))))).
thf(ccygth_conj,conjecture,(! [XG:($i > $o)] : (cwb @ (cwcel @ XG @ cccyg) @ (cwrex @ (^ [Xn:$i] : (cwbr @ XG @ (ccfv @ (ccv @ Xn) @ cczn) @ ccgic)) @ (^ [Xn:$i] : ccn0))))).
