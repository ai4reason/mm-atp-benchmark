...
thf(ahashfzo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccfzo) @ cchash) @ (cco @ XB2 @ XA2 @ ccmin)))))).
...
thf(chashfzo0_conj,conjecture,(! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccn0) @ (cwceq @ (ccfv @ (cco @ ccc0 @ XB2 @ ccfzo) @ cchash) @ XB2)))).
