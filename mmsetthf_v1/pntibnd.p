...
thf(apntpbnd_thm,axiom,(! [XR:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xe:$i] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : (cwa @ (cwa @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ cclt) @ (cwbr @ (ccv @ Xn) @ (cco @ (ccv @ Xk) @ (ccv @ Xy1) @ ccmul) @ ccle)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xn) @ (XR @ Xa)) @ (ccv @ Xn) @ ccdiv) @ ccabs) @ (ccv @ Xe) @ ccle))) @ (^ [Xn:$i] : ccn))) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)))) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (ccv @ Xc) @ (ccv @ Xe) @ ccdiv) @ cce) @ ccpnf @ ccico)))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xe:$i] : (cco @ ccc0 @ cc1 @ ccioo)))) @ (^ [Xc:$i] : ccrp)))))).
