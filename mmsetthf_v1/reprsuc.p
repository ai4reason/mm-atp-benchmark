...
thf(afnsnsplit_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwcel @ XX @ XA2)) @ (cwceq @ XF @ (ccun @ (ccres @ XF @ (ccdif @ XA2 @ (ccsn @ XX))) @ (ccsn @ (ccop @ XX @ (ccfv @ XX @ XF)))))))))).
...
thf(afzodif2_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwceq @ (ccdif @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo) @ (ccsn @ XN)) @ (cco @ XM @ XN @ ccfzo)))))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ar19_29ffa_thm,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) @ (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1))) @ (Xps @ Xx3 @ Xy1)) @ Xch))) => (cwi @ (cwa @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ Xch)))))))).
...
thf(creprsuc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwss @ XA2 @ ccn)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XS @ ccn0)) => ((! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XF @ Xb @ Xc) @ (ccmpt @ (^ [Xc:$i] : (cco @ XA2 @ (cco @ XM @ (ccv @ Xb) @ ccmin) @ (ccfv @ XS @ ccrepr))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccop @ XS @ (ccv @ Xb))))))))) => (! [Xc:$i] : (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XM @ (ccfv @ (cco @ XS @ cc1 @ ccaddc) @ ccrepr)) @ (cciun @ (^ [Xb:$i] : XA2) @ (^ [Xb:$i] : (ccrn @ (XF @ Xb @ Xc))))))))))))))))).
