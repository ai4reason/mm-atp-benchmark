...
thf(adf_np_ax,axiom,(cwceq @ ccnp @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwa @ (cwpss @ cc0 @ (ccv @ Xx3)) @ (cwpss @ (ccv @ Xx3) @ ccnq)) @ (cwral @ (^ [Xy1:$i] : (cwa @ (cwal @ (^ [Xz:$i] : (cwi @ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccltq) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3))))) @ (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltq)) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))).
