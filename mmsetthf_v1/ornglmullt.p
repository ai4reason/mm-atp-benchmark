...
thf(aornglmulle_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwi @ Xph @ (cwcel @ XR @ ccorng)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwceq @ Xc_le @ (ccfv @ XR @ ccple)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ Xc_le)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XZ @ Xc_le)) => (cwi @ Xph @ (cwbr @ (cco @ XZ @ XX @ Xc_x) @ (cco @ XZ @ XY @ Xc_x) @ Xc_le)))))))))))))))))))))).
...
thf(aunitlinv_thm,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ XI @ (ccfv @ XR @ ccinvr)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XU)) @ (cwceq @ (cco @ (ccfv @ XX @ XI) @ XX @ Xc_x) @ Xc_1))))))))))))).
...
thf(cornglmullt_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwi @ Xph @ (cwcel @ XR @ ccorng)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwi @ Xph @ (cwcel @ XZ @ XB2)) => ((cwceq @ Xc_lt @ (ccfv @ XR @ ccplt)) => ((cwi @ Xph @ (cwcel @ XR @ ccdr)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ Xc_lt)) => ((cwi @ Xph @ (cwbr @ Xc_0 @ XZ @ Xc_lt)) => (cwi @ Xph @ (cwbr @ (cco @ XZ @ XX @ Xc_x) @ (cco @ XZ @ XY @ Xc_x) @ Xc_lt))))))))))))))))))))))).
