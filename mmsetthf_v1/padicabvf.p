...
thf(apadicfval_thm,axiom,(! [XP:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xq:$i] : (cwceq @ (XJ @ Xx3 @ Xq) @ (ccmpt @ (^ [Xq:$i] : ccprime) @ (^ [Xq:$i] : (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ (ccv @ Xq) @ (ccneg @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ ccpc)) @ ccexp))))))))) => (! [Xx3:$i] : (! [Xq:$i] : (cwi @ (cwcel @ XP @ ccprime) @ (cwceq @ (ccfv @ XP @ (XJ @ Xx3 @ Xq)) @ (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ XP @ (ccneg @ (cco @ XP @ (ccv @ Xx3) @ ccpc)) @ ccexp)))))))))))).
...
thf(cpadicabvf_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : (cwceq @ (XQ @ Xq) @ (cco @ cccnfld @ ccq @ ccress))) => ((! [Xq:$i] : (cwceq @ XA2 @ (ccfv @ (XQ @ Xq) @ ccabv))) => ((! [Xx3:$i] : (! [Xq:$i] : (cwceq @ (XJ @ Xx3 @ Xq) @ (ccmpt @ (^ [Xq:$i] : ccprime) @ (^ [Xq:$i] : (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ ccc0) @ ccc0 @ (cco @ (ccv @ Xq) @ (ccneg @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ ccpc)) @ ccexp))))))))) => (! [Xx3:$i] : (! [Xq:$i] : (cwf @ ccprime @ XA2 @ (XJ @ Xx3 @ Xq))))))))))).
