...
thf(catbtwnexOLDN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xr:$i] : (cwceq @ (Xc_or @ Xr) @ (ccfv @ XK @ ccjn))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwbr @ XP @ XX @ Xc_le) @ (cwn @ (cwbr @ XQ @ XX @ Xc_le)))) @ (cwrex @ (^ [Xr:$i] : (cw3a @ (cwne @ (ccv @ Xr) @ XQ) @ (cwn @ (cwbr @ (ccv @ Xr) @ XX @ Xc_le)) @ (cwbr @ (ccv @ Xr) @ (cco @ XP @ XQ @ (Xc_or @ Xr)) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))).
