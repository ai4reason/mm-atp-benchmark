...
thf(ctz7_48_11_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0)) @ (cwss @ (ccrn @ XF) @ XA2)))))).
