...
thf(cpjval_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XP @ (ccfv @ XW @ ccpj1)) => ((cwceq @ XK @ (ccfv @ XW @ ccpj)) => (cwi @ (cwcel @ XT @ (ccdm @ XK)) @ (cwceq @ (ccfv @ XT @ XK) @ (cco @ XT @ (ccfv @ XT @ Xc_pe) @ XP)))))))))))).
