...
thf(adom3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (XC @ Xx3) @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XA2)) @ (cwb @ (cwceq @ (XC @ Xx3) @ (XD @ Xy1)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))))) => (cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccdom)))))))))))))).
...
thf(aelxp4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ XB2 @ XC)) @ (cwa @ (cwceq @ XA2 @ (ccop @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ (ccuni @ (ccrn @ (ccsn @ XA2))))) @ (cwa @ (cwcel @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ XB2) @ (cwcel @ (ccuni @ (ccrn @ (ccsn @ XA2))) @ XC)))))))).
...
thf(cxpdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => (cwi @ (cwbr @ XA2 @ XB2 @ ccdom) @ (cwbr @ (ccxp @ XC @ XA2) @ (ccxp @ XC @ XB2) @ ccdom))))))).
