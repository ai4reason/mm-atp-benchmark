...
thf(aadd12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwceq @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccaddc) @ (cco @ XB2 @ (cco @ XA2 @ XC @ ccaddc) @ ccaddc))))))).
...
thf(cadd4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwcel @ XC @ ccc) @ (cwcel @ XD @ ccc))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccaddc) @ (cco @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XD @ ccaddc) @ ccaddc)))))))).
