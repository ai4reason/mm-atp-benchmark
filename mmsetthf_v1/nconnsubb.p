...
thf(aconnsuba_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cw3a @ (cwne @ (ccin @ (ccv @ Xx3) @ XA2) @ cc0) @ (cwne @ (ccin @ (ccv @ Xy1) @ XA2) @ cc0) @ (cwceq @ (ccin @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) @ cc0)) @ (cwne @ (ccin @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) @ XA2))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))))))).
