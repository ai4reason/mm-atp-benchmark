...
thf(arabrsn_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwceq @ (XM @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ XA2)))) @ (cwo @ (cwceq @ (XM @ Xx3) @ cc0) @ (cwceq @ (XM @ Xx3) @ (ccsn @ XA2))))))))).
...
thf(chashrabrsn_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwcel @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ XA2))) @ cchash) @ ccn0)))).
