...
thf(amsubff_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmsub)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => (cwi @ (cwcel @ XT @ XW) @ (cwf @ (cco @ XR @ XV @ ccpm) @ (cco @ XE @ XE @ ccmap) @ XS))))))))))))).
...
thf(cmclsind_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xm:$i] : (! [Xo:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XD @ Xx3 @ Xy1 @ Xv @ Xm @ Xo @ Xs1 @ Xp) @ (ccfv @ (XT @ Xv) @ ccmdv))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (cwceq @ (XE @ Xx3 @ Xy1) @ (ccfv @ (XT @ Xv) @ ccmex))))) => ((! [Xy1:$i] : (! [Xv:$i] : (cwceq @ (XC @ Xy1) @ (ccfv @ (XT @ Xv) @ ccmcls)))) => ((! [Xv:$i] : (cwi @ Xph @ (cwcel @ (XT @ Xv) @ ccmfs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xm:$i] : (! [Xo:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwss @ XK @ (XD @ Xx3 @ Xy1 @ Xv @ Xm @ Xo @ Xs1 @ Xp)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwss @ XB2 @ (XE @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (cwceq @ (XA2 @ Xx3 @ Xy1 @ Xv) @ (ccfv @ (XT @ Xv) @ ccmax))))) => ((! [Xv:$i] : (cwceq @ (XL @ Xv) @ (ccfv @ (XT @ Xv) @ ccmsub))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xm:$i] : (! [Xo:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XV @ Xy1 @ Xm @ Xo @ Xs1 @ Xp) @ (ccfv @ (XT @ Xv) @ ccmvar)))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (cwceq @ (XH @ Xy1) @ (ccfv @ (XT @ Xv) @ ccmvh)))) => ((! [Xy1:$i] : (! [Xv:$i] : (cwceq @ (XW @ Xy1 @ Xv) @ (ccfv @ (XT @ Xv) @ ccmvrs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwss @ XB2 @ (XQ @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xm:$i] : (! [Xo:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xv) @ (XV @ Xy1 @ Xm @ Xo @ Xs1 @ Xp))) @ (cwcel @ (ccfv @ (ccv @ Xv) @ (XH @ Xy1)) @ (XQ @ Xx3 @ Xy1)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xm:$i] : (! [Xo:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (cw3a @ Xph @ (cw3a @ (cwcel @ (ccotp @ (ccv @ Xm) @ (ccv @ Xo) @ (ccv @ Xp)) @ (XA2 @ Xx3 @ Xy1 @ Xv)) @ (cwcel @ (ccv @ Xs1) @ (ccrn @ (XL @ Xv))) @ (cwss @ (ccima @ (ccv @ Xs1) @ (ccun @ (ccv @ Xo) @ (ccrn @ (XH @ Xy1)))) @ (XQ @ Xx3 @ Xy1))) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xm)) @ (cwss @ (ccxp @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XH @ Xy1)) @ (ccv @ Xs1)) @ (XW @ Xy1 @ Xv)) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xy1) @ (XH @ Xy1)) @ (ccv @ Xs1)) @ (XW @ Xy1 @ Xv))) @ XK))))))) @ (cwcel @ (ccfv @ (ccv @ Xp) @ (ccv @ Xs1)) @ (XQ @ Xx3 @ Xy1)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwss @ (cco @ XK @ XB2 @ (XC @ Xy1)) @ (XQ @ Xx3 @ Xy1))))))))))))))))))))))))))))))))).
