...
thf(cpjoml6i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwi @ (cwss @ XA2 @ XB2) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccort)) @ (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ cchj) @ XB2))) @ (^ [Xx3:$i] : ccch)))))))).
