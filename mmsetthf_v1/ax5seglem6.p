...
thf(aax5seglem5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [Xj:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwcel @ (XT @ Xj) @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XB2) @ (cco @ (cco @ (cco @ cc1 @ (XT @ Xj) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ (XT @ Xj) @ (ccfv @ (ccv @ Xi) @ XC) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))) @ (cwne @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xj) @ XA2) @ (ccfv @ (ccv @ Xj) @ XC) @ ccmin) @ cc2 @ ccexp))) @ ccc0))))))))).
...
thf(cax5seglem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XN @ ccn) @ (cwa @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee)) @ (cwcel @ XF @ (ccfv @ XN @ ccee))))) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwa @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwcel @ XS @ (cco @ ccc0 @ cc1 @ ccicc))) @ (cwa @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XB2) @ (cco @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ XT @ (ccfv @ (ccv @ Xi) @ XC) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XE) @ (cco @ (cco @ (cco @ cc1 @ XS @ ccmin) @ (ccfv @ (ccv @ Xi) @ XD) @ ccmul) @ (cco @ XS @ (ccfv @ (ccv @ Xi) @ XF) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))) @ (cwa @ (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XD @ XE) @ cccgr) @ (cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XE @ XF) @ cccgr))) @ (cwceq @ XT @ XS)))))))))))).
