...
thf(cdvds1lem_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwi @ Xph @ (cwa @ (cwcel @ XJ @ ccz) @ (cwcel @ XK @ ccz))) => ((cwi @ Xph @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccz)) @ (cwcel @ (XZ @ Xx3) @ ccz))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ ccz)) @ (cwi @ (cwceq @ (cco @ (ccv @ Xx3) @ XJ @ ccmul) @ XK) @ (cwceq @ (cco @ (XZ @ Xx3) @ XM @ ccmul) @ XN)))) => (cwi @ Xph @ (cwi @ (cwbr @ XJ @ XK @ ccdvds) @ (cwbr @ XM @ XN @ ccdvds)))))))))))))).
