...
thf(afrlmlss_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => ((cwceq @ XU @ (ccfv @ (cco @ (ccfv @ XR @ ccrglmod) @ XI @ ccpws) @ cclss)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XW)) @ (cwcel @ XB2 @ XU)))))))))))).
...
thf(areslmhm_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (ccfv @ XS @ cclss)) => ((cwceq @ XR @ (cco @ XS @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XX @ XU)) @ (cwcel @ (ccres @ XF @ XX) @ (cco @ XR @ XT @ cclmhm)))))))))))).
...
thf(areslmhm2b_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => ((cwceq @ XL @ (ccfv @ XT @ cclss)) => (cwi @ (cw3a @ (cwcel @ XT @ cclmod) @ (cwcel @ XX @ XL) @ (cwss @ (ccrn @ XF) @ XX)) @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XF @ (cco @ XS @ XU @ cclmhm))))))))))))).
...
thf(cfrlmsplit2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XU @ ccfrlm)) => ((cwceq @ XZ @ (cco @ XR @ XV @ ccfrlm)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XC @ (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XU @ XX) @ (cwss @ XV @ XU)) @ (cwcel @ (XF @ Xx3) @ (cco @ XY @ XZ @ cclmhm))))))))))))))))))).
