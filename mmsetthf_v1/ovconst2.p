...
thf(covconst2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XC @ ccvv) => (cwi @ (cwa @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XB2)) @ (cwceq @ (cco @ XR @ XS @ (ccxp @ (ccxp @ XA2 @ XB2) @ (ccsn @ XC))) @ XC))))))))).
