...
thf(ccoprmdvds2_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XK @ ccz)) @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1)) @ (cwi @ (cwa @ (cwbr @ XM @ XK @ ccdvds) @ (cwbr @ XN @ XK @ ccdvds)) @ (cwbr @ (cco @ XM @ XN @ ccmul) @ XK @ ccdvds))))))).
