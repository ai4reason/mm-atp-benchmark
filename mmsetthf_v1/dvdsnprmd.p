...
thf(cdvdsnprmd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwbr @ cc1 @ XA2 @ cclt)) => ((cwi @ Xph @ (cwbr @ XA2 @ XN @ cclt)) => ((cwi @ Xph @ (cwbr @ XA2 @ XN @ ccdvds)) => (cwi @ Xph @ (cwn @ (cwcel @ XN @ ccprime)))))))))).
