...
thf(csubgrprop3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XS @ ccvtx)) => ((cwceq @ XA2 @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XS @ ccedg)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccedg)) => (cwi @ (cwbr @ XS @ XG @ ccsubgr) @ (cwa @ (cwss @ XV @ XA2) @ (cwss @ XE @ XB2)))))))))))))).
