...
thf(aimasaddf_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwfo @ XV @ (XB2 @ Xa @ Xb) @ XF)))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xa) @ XV) @ (cwcel @ (ccv @ Xb) @ XV)) @ (cwa @ (cwcel @ (ccv @ Xp) @ XV) @ (cwcel @ (ccv @ Xq) @ XV))) @ (cwi @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xp) @ XF)) @ (cwceq @ (ccfv @ (ccv @ Xb) @ XF) @ (ccfv @ (ccv @ Xq) @ XF))) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (Xc_x @ Xa @ Xb)) @ XF) @ (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_x @ Xa @ Xb)) @ XF)))))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ (XU @ Xq @ Xp @ Xa @ Xb) @ (cco @ XF @ (XR @ Xa @ Xb) @ ccimas))))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ XV @ (ccfv @ (XR @ Xa @ Xb) @ ccbs))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xa @ Xb) @ (XZ @ Xq @ Xp @ Xa @ Xb))))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (Xc_x @ Xa @ Xb) @ (ccfv @ (XR @ Xa @ Xb) @ ccplusg)))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ Xc_xb @ (ccfv @ (XU @ Xq @ Xp @ Xa @ Xb) @ ccplusg)))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xp) @ XV) @ (cwcel @ (ccv @ Xq) @ XV))) @ (cwcel @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_x @ Xa @ Xb)) @ XV)))))) => (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwf @ (ccxp @ (XB2 @ Xa @ Xb) @ (XB2 @ Xa @ Xb)) @ (XB2 @ Xa @ Xb) @ Xc_xb)))))))))))))))))))))).
...
thf(a_3reeanv_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xz:$i] : (cwb @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cw3a @ (Xph @ Xx3) @ (Xps @ Xy1) @ (Xch @ Xz))) @ (^ [Xz:$i] : (XC @ Xz)))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz))) @ (cw3a @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz))) @ (cwrex @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1))) @ (cwrex @ (^ [Xz:$i] : (Xch @ Xz)) @ (^ [Xz:$i] : (XC @ Xz))))))))))))).
...
thf(agrpidd2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ (XG @ Xx3) @ ccbs)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwceq @ Xc_pl @ (ccfv @ (XG @ Xx3) @ ccplusg)))) => ((cwi @ Xph @ (cwcel @ Xc_0 @ XB2)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (cco @ Xc_0 @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3) @ ccgrp))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ Xc_0 @ (ccfv @ (XG @ Xx3) @ cc0g))))))))))))))).
thf(cimasgrp2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xc_0:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ (XR @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) @ ccimas)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ XV @ (ccfv @ (XR @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) @ ccbs)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwceq @ (Xc_pl @ Xz @ Xa @ Xb) @ (ccfv @ (XR @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) @ ccplusg)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwfo @ XV @ (XB2 @ Xy1 @ Xz @ Xa @ Xb) @ XF)))))) => ((! [Xz:$i] : (! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xa) @ XV) @ (cwcel @ (ccv @ Xb) @ XV)) @ (cwa @ (cwcel @ (ccv @ Xp) @ XV) @ (cwcel @ (ccv @ Xq) @ XV))) @ (cwi @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xp) @ XF)) @ (cwceq @ (ccfv @ (ccv @ Xb) @ XF) @ (ccfv @ (ccv @ Xq) @ XF))) @ (cwceq @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (Xc_pl @ Xz @ Xa @ Xb)) @ XF) @ (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_pl @ Xz @ Xa @ Xb)) @ XF))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) @ (XW @ Xx3 @ Xy1 @ Xz @ Xq @ Xp @ Xa @ Xb)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XV) @ (cwcel @ (ccv @ Xy1) @ XV)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xz @ Xa @ Xb)) @ XV))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XV) @ (cwcel @ (ccv @ Xy1) @ XV) @ (cwcel @ (ccv @ Xz) @ XV))) @ (cwceq @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xz @ Xa @ Xb)) @ (ccv @ Xz) @ (Xc_pl @ Xz @ Xa @ Xb)) @ XF) @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_pl @ Xz @ Xa @ Xb)) @ (Xc_pl @ Xz @ Xa @ Xb)) @ XF)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwcel @ (Xc_0 @ Xy1 @ Xz @ Xa @ Xb) @ XV)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XV)) @ (cwceq @ (ccfv @ (cco @ (Xc_0 @ Xy1 @ Xz @ Xa @ Xb) @ (ccv @ Xx3) @ (Xc_pl @ Xz @ Xa @ Xb)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XV)) @ (cwcel @ (XN @ Xx3 @ Xy1 @ Xz @ Xq @ Xa @ Xb) @ XV)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XV)) @ (cwceq @ (ccfv @ (cco @ (XN @ Xx3 @ Xy1 @ Xz @ Xq @ Xa @ Xb) @ (ccv @ Xx3) @ (Xc_pl @ Xz @ Xa @ Xb)) @ XF) @ (ccfv @ (Xc_0 @ Xy1 @ Xz @ Xa @ Xb) @ XF))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ Xph @ (cwa @ (cwcel @ XU @ ccgrp) @ (cwceq @ (ccfv @ (Xc_0 @ Xy1 @ Xz @ Xa @ Xb) @ XF) @ (ccfv @ XU @ cc0g))))))))))))))))))))))))))))))).
