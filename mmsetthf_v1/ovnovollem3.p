...
thf(aovnovollem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XA2 @ (XV @ Xi @ Xj))))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XF @ Xi) @ (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) => ((! [Xi:$i] : (cwceq @ XI @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsn @ (ccop @ XA2 @ (ccfv @ (ccv @ Xj) @ (XF @ Xi)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xi) @ (cwss @ (XB2 @ Xj @ Xk) @ (ccuni @ (ccrn @ (cccom @ ccico @ (XF @ Xi))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ (XB2 @ Xj @ Xk) @ (XW @ Xi @ Xj @ Xk)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xi) @ (cwceq @ (XZ @ Xj @ Xk) @ (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (XF @ Xi)) @ ccsumge0)))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xi) @ (cwrex @ (^ [Xi:$i] : (cwa @ (cwss @ (cco @ (XB2 @ Xj @ Xk) @ (ccsn @ XA2) @ ccmap) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) @ (cwceq @ (XZ @ Xj @ Xk) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ (ccsn @ XA2) @ ccmap) @ ccn @ ccmap)))))))))))))))))))))).
...
thf(aovnovollem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XA2 @ Xf1) @ (XV @ Xf1 @ Xj))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XB2 @ Xj @ Xk) @ (XW @ Xf1 @ Xj @ Xk)))))) => ((! [Xf1:$i] : (! [Xj:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XI @ Xf1 @ Xj) @ (cco @ (cco @ (ccxp @ ccr @ ccr) @ (ccsn @ (XA2 @ Xf1)) @ ccmap) @ ccn @ ccmap))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwss @ (cco @ (XB2 @ Xj @ Xk) @ (ccsn @ (XA2 @ Xf1)) @ ccmap) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : (ccsn @ (XA2 @ Xf1))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (XI @ Xf1 @ Xj))))))))))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (XZ @ Xj @ Xk) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (ccsn @ (XA2 @ Xf1))) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (XI @ Xf1 @ Xj)))) @ ccvol))))) @ ccsumge0)))))) => ((! [Xf1:$i] : (cwceq @ XF @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (XA2 @ Xf1) @ (ccfv @ (ccv @ Xj) @ (XI @ Xf1 @ Xj))))))) => (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xf1) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwss @ (XB2 @ Xj @ Xk) @ (ccuni @ (ccrn @ (cccom @ ccico @ (ccv @ Xf1))))) @ (cwceq @ (XZ @ Xj @ Xk) @ (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))))))))))))))))))))).
...
thf(covnovollem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xz:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xz @ Xf1 @ Xi @ Xj))))))) => ((cwi @ Xph @ (cwss @ XB2 @ ccr)) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XM @ Xz @ Xf1 @ Xi @ Xj @ Xk) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : (cwa @ (cwss @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) @ (cwceq @ (ccv @ Xz) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ (ccsn @ XA2) @ ccmap) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr)))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XN @ Xf1 @ Xi @ Xj @ Xk) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : (cwa @ (cwss @ XB2 @ (ccuni @ (ccrn @ (cccom @ ccico @ (ccv @ Xf1))))) @ (cwceq @ (ccv @ Xz) @ (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))))))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (ccfv @ (ccsn @ XA2) @ ccovoln)) @ (ccfv @ XB2 @ ccovol)))))))))))))).
