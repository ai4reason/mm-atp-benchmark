...
thf(advcos_thm,axiom,(cwceq @ (cco @ ccc @ cccos @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccv @ Xx3) @ ccsin)))))).
...
thf(cdvcosax_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cccos))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccneg @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ ccsin)) @ ccmul))))))).
