...
thf(cdfer2_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwer @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XR) @ (cw3a @ (cwrel @ XR) @ (cwceq @ (ccdm @ XR) @ (XA2 @ Xx3 @ Xy1 @ Xz)) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwa @ (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)) @ (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR)) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR))))))))))))))))).
