...
thf(cselbergr_conj,conjecture,(! [XR:($i > ($i > $o))] : ((! [Xa:$i] : (cwceq @ (XR @ Xa) @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (ccfv @ (ccv @ Xd) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ ccdiv) @ (XR @ Xa)) @ ccmul))) @ ccaddc) @ (ccv @ Xx3) @ ccdiv))) @ cco1))))).
