...
thf(agcdmultiple_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XM @ (cco @ XM @ XN @ ccmul) @ ccgcd) @ XM))))).
...
thf(crpmulgcd_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ ccn) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ XK @ XM @ ccgcd) @ cc1)) @ (cwceq @ (cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) @ (cco @ XK @ XN @ ccgcd))))))).
