...
thf(cdyaddisj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccrn @ XF)) @ (cwcel @ XB2 @ (ccrn @ XF))) @ (cw3o @ (cwss @ (ccfv @ XA2 @ ccicc) @ (ccfv @ XB2 @ ccicc)) @ (cwss @ (ccfv @ XB2 @ ccicc) @ (ccfv @ XA2 @ ccicc)) @ (cwceq @ (ccin @ (ccfv @ XA2 @ ccioo) @ (ccfv @ XB2 @ ccioo)) @ cc0)))))))).
