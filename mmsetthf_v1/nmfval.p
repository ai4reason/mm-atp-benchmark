...
thf(adf_nm_ax,axiom,(cwceq @ ccnm @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ ccbs)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ cc0g) @ (ccfv @ (ccv @ Xw) @ ccds)))))))).
...
thf(cnmfval_conj,conjecture,(! [XD:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (ccfv @ XW @ ccnm))) => ((cwceq @ XX @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((cwceq @ XD @ (ccfv @ XW @ ccds)) => (! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_0 @ XD))))))))))))))).
