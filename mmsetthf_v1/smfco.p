...
thf(afco3_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwfun @ XF)) => ((cwi @ Xph @ (cwfun @ XG)) => (cwi @ Xph @ (cwf @ (ccima @ (cccnv @ XG) @ (ccdm @ XF)) @ (ccrn @ XF) @ (cccom @ XF @ XG))))))))).
...
thf(csmfco_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwceq @ XB2 @ (ccfv @ XJ @ ccsalgen)) => ((cwi @ Xph @ (cwcel @ XH @ (ccfv @ XB2 @ ccsmblfn))) => (cwi @ Xph @ (cwcel @ (cccom @ XH @ XF) @ (ccfv @ XS @ ccsmblfn))))))))))))))).
