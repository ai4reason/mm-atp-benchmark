...
thf(adf_ushgr_ax,axiom,(cwceq @ ccushgr @ (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xe:$i] : (cwf1 @ (ccdm @ (ccv @ Xe)) @ (ccdif @ (ccpw @ (ccv @ Xv)) @ (ccsn @ cc0)) @ (ccv @ Xe))) @ (ccfv @ (ccv @ Xg1) @ cciedg))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
...
thf(cisushgr_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwcel @ XG @ XU) @ (cwb @ (cwcel @ XG @ ccushgr) @ (cwf1 @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)))))))))).
