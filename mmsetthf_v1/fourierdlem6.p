...
thf(aiccsuble_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccicc))) => (cwi @ Xph @ (cwbr @ (cco @ XC @ XD @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccle)))))))))))).
...
thf(cfourierdlem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwceq @ XT @ (cco @ XB2 @ XA2 @ ccmin)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => ((cwi @ Xph @ (cwcel @ XI @ ccz)) => ((cwi @ Xph @ (cwcel @ XJ @ ccz)) => ((cwi @ Xph @ (cwbr @ XI @ XJ @ cclt)) => ((cwi @ Xph @ (cwcel @ (cco @ XX @ (cco @ XI @ XT @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc))) => ((cwi @ Xph @ (cwcel @ (cco @ XX @ (cco @ XJ @ XT @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwi @ Xph @ (cwceq @ XJ @ (cco @ XI @ cc1 @ ccaddc))))))))))))))))))))).
