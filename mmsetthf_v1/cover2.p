...
thf(ccover2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((! [Xy1:$i] : (cwceq @ (XA2 @ Xy1) @ (ccuni @ XB2))) => (! [Xy1:$i] : (cwb @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwceq @ (ccuni @ (ccv @ Xz)) @ (XA2 @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccpw @ XB2))))))))))).
