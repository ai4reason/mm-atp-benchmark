...
thf(cspcimedv_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwi @ Xch @ (Xps @ Xx3)))) => (cwi @ Xph @ (cwi @ Xch @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3))))))))))))).
