...
thf(cnnaordex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ cc0 @ (ccv @ Xx3)) @ (cwceq @ (cco @ XA2 @ (ccv @ Xx3) @ ccoa) @ XB2))) @ (^ [Xx3:$i] : ccom))))))).
