...
thf(choiprodcl_conj,conjecture,(! [Xph:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XX @ ccfn))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwf @ XX @ (ccxp @ ccr @ ccr) @ (XI @ Xk)))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))) @ ccvol))) @ (cco @ ccc0 @ ccpnf @ ccico))))))))))).
