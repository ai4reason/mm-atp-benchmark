...
thf(adrsdirfi_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => (cwi @ (cw3a @ (cwcel @ XK @ ccdrs) @ (cwss @ XX @ XB2) @ (cwcel @ XX @ ccfn)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XB2)))))))))).
...
thf(cisdrs2_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => (cwb @ (cwcel @ XK @ ccdrs) @ (cwa @ (cwcel @ XK @ ccpreset) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XB2) @ ccfn))))))))))).
