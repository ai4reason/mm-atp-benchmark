...
thf(ciooshift_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XA2 @ ccr))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XB2 @ ccr))) => ((! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwcel @ XT @ ccr))) => (! [Xw:$i] : (cwi @ (Xph @ Xw) @ (cwceq @ (cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccioo) @ (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : (cwceq @ (ccv @ Xw) @ (cco @ (ccv @ Xz) @ XT @ ccaddc))) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)))) @ (^ [Xw:$i] : ccc))))))))))))).
