...
thf(ar1pcl_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XE @ (ccfv @ XR @ ccr1p)) => ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) @ (cwcel @ (cco @ XF @ XG @ XE) @ XB2)))))))))))))).
...
thf(ar1pid_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XC @ (ccfv @ XR @ ccuc1p)) => ((cwceq @ XQ @ (ccfv @ XR @ ccq1p)) => ((cwceq @ XE @ (ccfv @ XR @ ccr1p)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_pl @ (ccfv @ XP @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) @ (cwceq @ XF @ (cco @ (cco @ (cco @ XF @ XG @ XQ) @ XG @ Xc_x) @ (cco @ XF @ XG @ XE) @ Xc_pl))))))))))))))))))))).
...
thf(cply1rem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_mi @ (ccfv @ XP @ ccsg)) => ((cwceq @ XA2 @ (ccfv @ XP @ ccascl)) => ((cwceq @ XG @ (cco @ XX @ (ccfv @ XN @ XA2) @ Xc_mi)) => ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwi @ Xph @ (cwcel @ XR @ ccnzr)) => ((cwi @ Xph @ (cwcel @ XR @ cccrg)) => ((cwi @ Xph @ (cwcel @ XN @ XK)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwceq @ XE @ (ccfv @ XR @ ccr1p)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XG @ XE) @ (ccfv @ (ccfv @ XN @ (ccfv @ XF @ XO)) @ XA2)))))))))))))))))))))))))))))).
