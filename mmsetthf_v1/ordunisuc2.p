...
thf(aorduninsuc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwb @ (cwceq @ XA2 @ (ccuni @ XA2)) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(aordsssuc2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cword @ XA2) @ (cwcel @ XB2 @ ccon0)) @ (cwb @ (cwss @ XA2 @ XB2) @ (cwcel @ XA2 @ (ccsuc @ XB2))))))).
...
thf(cordunisuc2_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cword @ XA2) @ (cwb @ (cwceq @ XA2 @ (ccuni @ XA2)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccsuc @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : XA2)))))).
