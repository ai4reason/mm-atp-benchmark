...
thf(ceqrelriv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XB2)))) => (cwi @ (cwa @ (cwrel @ XA2) @ (cwrel @ XB2)) @ (cwceq @ XA2 @ XB2)))))).
