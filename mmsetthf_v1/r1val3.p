...
thf(ar1val2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ ccr1) @ (ccab @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ XA2))))))).
thf(cr1val3_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ ccr1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccpw @ (ccab @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrnk) @ (ccv @ Xx3))))))))))).
