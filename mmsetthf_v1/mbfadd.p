...
thf(ambfaddlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ ccr @ XG)) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccmbf))))))))))).
...
thf(cmbfadd_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ ccmbf)) => ((cwi @ Xph @ (cwcel @ XG @ ccmbf)) => (cwi @ Xph @ (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccmbf)))))))).
