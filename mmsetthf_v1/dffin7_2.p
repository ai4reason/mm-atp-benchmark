...
thf(aisfin7_2_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ ccfin7) @ (cwi @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XA2 @ ccfn))))))).
...
thf(cdffin7_2_conj,conjecture,(cwceq @ ccfin7 @ (ccun @ ccfn @ (ccdif @ ccvv @ (ccdm @ cccrd))))).
