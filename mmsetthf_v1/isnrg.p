...
thf(adf_nrg_ax,axiom,(cwceq @ ccnrg @ (ccrab @ (^ [Xw:$i] : (cwcel @ (ccfv @ (ccv @ Xw) @ ccnm) @ (ccfv @ (ccv @ Xw) @ ccabv))) @ (^ [Xw:$i] : ccngp)))).
thf(cisnrg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (ccfv @ XR @ ccnm)) => ((cwceq @ XA2 @ (ccfv @ XR @ ccabv)) => (cwb @ (cwcel @ XR @ ccnrg) @ (cwa @ (cwcel @ XR @ ccngp) @ (cwcel @ XN @ XA2))))))))).
