...
thf(cfuniunfvf_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (! [Xx3:$i] : (cwi @ (cwfun @ (XF @ Xx3)) @ (cwceq @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (ccuni @ (ccima @ (XF @ Xx3) @ XA2))))))))).
