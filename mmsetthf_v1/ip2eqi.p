...
thf(aipz_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XZ @ (ccfv @ XU @ ccn0v)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cwa @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ XX)) @ (cwb @ (cwceq @ (cco @ XA2 @ XA2 @ XP) @ ccc0) @ (cwceq @ XA2 @ XZ)))))))))))).
...
thf(cip2eqi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => (cwi @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xx3) @ XA2 @ XP) @ (cco @ (ccv @ Xx3) @ XB2 @ XP))) @ (^ [Xx3:$i] : XX)) @ (cwceq @ XA2 @ XB2)))))))))))).
