...
thf(awrdred1_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ XF @ (ccword @ XS)) @ (cwcel @ (ccres @ XF @ (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (ccword @ XS)))))).
...
thf(aredwlklem_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XF @ (ccword @ XS)) @ (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ ccle) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP)) @ (cwf @ (cco @ ccc0 @ (ccfv @ (ccres @ XF @ (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ cchash) @ ccfz) @ XV @ (ccres @ XP @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))).
...
thf(awrdred1hash_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccword @ XS)) @ (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ ccle)) @ (cwceq @ (ccfv @ (ccres @ XF @ (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ cchash) @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin)))))).
...
thf(credwlk_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ ccle)) @ (cwbr @ (ccres @ XF @ (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (ccres @ XP @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (ccfv @ XG @ ccwlks))))))).
