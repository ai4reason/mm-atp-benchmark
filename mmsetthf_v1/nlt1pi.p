...
thf(aelsucg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ XA2 @ (ccsuc @ XB2)) @ (cwo @ (cwcel @ XA2 @ XB2) @ (cwceq @ XA2 @ XB2)))))))).
...
thf(cnlt1pi_conj,conjecture,(! [XA2:($i > $o)] : (cwn @ (cwbr @ XA2 @ cc1o @ cclti)))).
