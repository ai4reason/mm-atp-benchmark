...
thf(afusgreghash2wsp_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwne @ XV @ cc0)) @ (cwi @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ XK)) @ (^ [Xv:$i] : XV)) @ (cwceq @ (ccfv @ (cco @ cc2 @ XG @ ccwwspthsn) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ ccmul))))))))).
...
thf(afrgrhash2wsp_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn)) @ (cwceq @ (ccfv @ (cco @ cc2 @ XG @ ccwwspthsn) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ ccmul))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(afrrusgrord0lem_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ XK)) @ (^ [Xv:$i] : XV))) @ (cw3a @ (cwcel @ XK @ ccc) @ (cwcel @ (ccfv @ XV @ cchash) @ ccc) @ (cwne @ (ccfv @ XV @ cchash) @ ccc0)))))))).
...
thf(cfrrusgrord0_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) @ (cwi @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ XK)) @ (^ [Xv:$i] : XV)) @ (cwceq @ (ccfv @ XV @ cchash) @ (cco @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ cc1 @ ccaddc))))))))).
