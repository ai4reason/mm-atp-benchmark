...
thf(celfi2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XA2 @ (ccint @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdif @ (ccin @ (ccpw @ XB2) @ ccfn) @ (ccsn @ cc0)))))))))).
