...
thf(cisuvtxaOLD_conj,conjecture,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (! [Xk:$i] : (cwceq @ (XE @ Xv @ Xk) @ (ccfv @ XG @ ccedg)))) => (cwi @ (cwcel @ XG @ XW) @ (cwceq @ (ccfv @ XG @ ccuvtx) @ (ccrab @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xk) @ (ccv @ Xv)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xv @ Xk)))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
