...
thf(afrgpup3_thm,axiom,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XG @ (ccfv @ XI @ ccfrgp)) => ((cwceq @ XB2 @ (ccfv @ XH @ ccbs)) => ((cwceq @ XU @ (ccfv @ XI @ ccvrgp)) => (cwi @ (cw3a @ (cwcel @ XH @ ccgrp) @ (cwcel @ XI @ XV) @ (cwf @ XI @ XB2 @ XF)) @ (cwreu @ (^ [Xm:$i] : (cwceq @ (cccom @ (ccv @ Xm) @ XU) @ XF)) @ (^ [Xm:$i] : (cco @ XG @ XH @ ccghm))))))))))))))).
...
thf(a_0ghm_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XN @ cc0g)) => ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => (cwi @ (cwa @ (cwcel @ XM @ ccgrp) @ (cwcel @ XN @ ccgrp)) @ (cwcel @ (ccxp @ XB2 @ (ccsn @ Xc_0)) @ (cco @ XM @ XN @ ccghm)))))))))).
thf(armoi_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwb @ (Xph @ Xx3) @ Xps))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XC) @ (cwb @ (Xph @ Xx3) @ Xch))) => (cwi @ (cw3a @ (cwrmo @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwa @ (cwcel @ XB2 @ XA2) @ Xps) @ (cwa @ (cwcel @ XC @ XA2) @ Xch)) @ (cwceq @ XB2 @ XC))))))))))).
...
thf(c_0frgp_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (ccfv @ cc0 @ ccfrgp)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => (cwbr @ XB2 @ cc1o @ ccen)))))).
