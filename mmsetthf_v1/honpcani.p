...
thf(ahopncani_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwf @ cchil @ cchil @ XU) => (cwceq @ (cco @ (cco @ XT @ XU @ cchos) @ XU @ cchod) @ XT)))))).
thf(chonpcani_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwf @ cchil @ cchil @ XU) => (cwceq @ (cco @ (cco @ XT @ XU @ cchod) @ XU @ cchos) @ XT)))))).
