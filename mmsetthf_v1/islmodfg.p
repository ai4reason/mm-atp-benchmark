...
thf(cislmodfg_conj,conjecture,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => (cwi @ (cwcel @ XW @ cclmod) @ (cwb @ (cwcel @ XW @ cclfig) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwcel @ (ccv @ Xb) @ ccfn) @ (cwceq @ (ccfv @ (ccv @ Xb) @ XN) @ XB2))) @ (^ [Xb:$i] : (ccpw @ XB2))))))))))).
