...
thf(am1modmmod_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmo) @ (cco @ XA2 @ XN @ ccmo) @ ccmin) @ (ccif @ (cwceq @ (cco @ XA2 @ XN @ ccmo) @ ccc0) @ (cco @ XN @ cc1 @ ccmin) @ (ccneg @ cc1))))))).
...
thf(axp1d2m1eqxm1d2_thm,axiom,(! [XX:($i > $o)] : (cwi @ (cwcel @ XX @ ccc) @ (cwceq @ (cco @ (cco @ (cco @ XX @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ cc1 @ ccmin) @ (cco @ (cco @ XX @ cc1 @ ccmin) @ cc2 @ ccdiv))))).
...
thf(aexpn1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XA2 @ (ccneg @ cc1) @ ccexp) @ (cco @ cc1 @ XA2 @ ccdiv))))).
...
thf(altsubadd2b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccr))) @ (cwb @ (cwbr @ (cco @ XD @ XC @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ cclt) @ (cwbr @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))).
...
thf(amodsubmodmod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XB2 @ XM @ ccmo) @ ccmin) @ XM @ ccmo) @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XM @ ccmo))))))).
...
thf(adivsub1dir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1 @ ccmin) @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XB2 @ ccdiv)))))).
thf(afldivmod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XB2 @ ccdiv)))))).
thf(cdignn0flhalflem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn) @ (cwcel @ XN @ ccn)) @ (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ cc1 @ ccmin) @ ccfl) @ (ccfv @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl) @ cclt))))).
