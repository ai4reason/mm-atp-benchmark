...
thf(crrextust_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XD @ (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XB2 @ XB2))) => (cwi @ (cwcel @ XR @ ccrrext) @ (cwceq @ (ccfv @ XR @ ccuss) @ (ccfv @ XD @ ccmetu))))))))).
