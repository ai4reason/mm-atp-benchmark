...
thf(cfucrid_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XQ @ (cco @ XC @ XD @ ccfuc)) => ((cwceq @ XN @ (cco @ XC @ XD @ ccnat)) => ((cwceq @ Xc_xb @ (ccfv @ XQ @ ccco)) => ((cwceq @ Xc_1 @ (ccfv @ XD @ cccid)) => ((cwi @ Xph @ (cwcel @ XR @ (cco @ XF @ XG @ XN))) => (cwi @ Xph @ (cwceq @ (cco @ XR @ (cccom @ Xc_1 @ (ccfv @ XF @ cc1st)) @ (cco @ (ccop @ XF @ XF) @ XG @ Xc_xb)) @ XR)))))))))))))))))).
