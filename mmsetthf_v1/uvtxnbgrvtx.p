...
thf(avtxnbuvtx_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XN @ (ccfv @ XG @ ccuvtx)) @ (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ XN @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))).
...
thf(cuvtxnbgrvtx_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwcel @ XN @ (ccfv @ XG @ ccuvtx)) @ (cwral @ (^ [Xv:$i] : (cwcel @ XN @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xv:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))).
