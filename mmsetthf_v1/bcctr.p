...
thf(cbcctr_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccfa) @ (cco @ (ccfv @ XN @ ccfa) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccdiv))))).
