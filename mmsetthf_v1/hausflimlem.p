...
thf(chausflimlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) @ (cwcel @ XB2 @ (cco @ XJ @ XF @ ccflim))) @ (cwa @ (cwcel @ XU @ XJ) @ (cwcel @ XV @ XJ)) @ (cwa @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV))) @ (cwne @ (ccin @ XU @ XV) @ cc0))))))))).
