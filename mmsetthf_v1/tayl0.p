...
thf(axnn0ge0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccxnn0) @ (cwbr @ ccc0 @ XN @ ccle)))).
...
thf(ctayl0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xk:$i] : (cwi @ Xph @ (cwf @ (XA2 @ Xk) @ ccc @ XF))) => ((! [Xk:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xk) @ XS))) => ((cwi @ Xph @ (cwo @ (cwcel @ XN @ ccn0) @ (cwceq @ XN @ ccpnf))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (ccin @ (cco @ ccc0 @ XN @ ccicc) @ ccz))) @ (cwcel @ XB2 @ (ccdm @ (ccfv @ (ccv @ Xk) @ (cco @ XS @ XF @ ccdvn)))))) => ((! [Xk:$i] : (cwceq @ (XT @ Xk) @ (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl)))) => (! [Xk:$i] : (cwi @ Xph @ (cwa @ (cwcel @ XB2 @ (ccdm @ (XT @ Xk))) @ (cwceq @ (ccfv @ XB2 @ (XT @ Xk)) @ (ccfv @ XB2 @ XF))))))))))))))))))).
