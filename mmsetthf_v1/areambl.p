...
thf(careambl_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccdm @ ccarea)) @ (cwcel @ XA2 @ ccr)) @ (cwa @ (cwcel @ (ccima @ XS @ (ccsn @ XA2)) @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ (ccima @ XS @ (ccsn @ XA2)) @ ccvol) @ ccr)))))).
