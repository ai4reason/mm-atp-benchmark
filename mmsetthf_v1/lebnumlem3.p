...
thf(alebnumlem1_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XJ @ cccmp)) => ((cwi @ Xph @ (cwss @ XU @ XJ)) => ((cwi @ Xph @ (cwceq @ XX @ (ccuni @ XU))) => ((cwi @ Xph @ (cwcel @ XU @ ccfn)) => ((cwi @ Xph @ (cwn @ (cwcel @ XX @ XU))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwceq @ (XF @ Xy1 @ Xz @ Xk) @ (ccmpt @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccsu @ XU @ (^ [Xk:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccv @ Xk))) @ (^ [Xz:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD)))) @ ccxr @ cclt))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwf @ XX @ ccrp @ (XF @ Xy1 @ Xz @ Xk))))))))))))))))))))).
...
thf(alebnumlem2_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((cwi @ Xph @ (cwcel @ XJ @ cccmp)) => ((cwi @ Xph @ (cwss @ XU @ XJ)) => ((cwi @ Xph @ (cwceq @ XX @ (ccuni @ XU))) => ((cwi @ Xph @ (cwcel @ XU @ ccfn)) => ((cwi @ Xph @ (cwn @ (cwcel @ XX @ XU))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwceq @ (XF @ Xy1 @ Xz @ Xk) @ (ccmpt @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccsu @ XU @ (^ [Xk:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccv @ Xk))) @ (^ [Xz:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD)))) @ ccxr @ cclt))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwceq @ (XK @ Xy1 @ Xz @ Xk) @ (ccfv @ (ccrn @ ccioo) @ cctg))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XF @ Xy1 @ Xz @ Xk) @ (cco @ XJ @ (XK @ Xy1 @ Xz @ Xk) @ cccn))))))))))))))))))))))).
...
thf(ametdsval_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ XX) @ (cwceq @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))))))))).
...
thf(ametdsre_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XF @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) @ (cwf @ XX @ ccr @ (XF @ Xx3 @ Xy1))))))))))).
...
thf(adifin0ss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ (ccin @ (ccdif @ XA2 @ XB2) @ XC) @ cc0) @ (cwi @ (cwss @ XC @ XA2) @ (cwss @ XC @ XB2))))))).
...
thf(clebnumlem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > $o)] : ((! [Xu:$i] : (cwceq @ (XJ @ Xu) @ (ccfv @ XD @ ccmopn))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XD @ (ccfv @ XX @ ccme)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XJ @ Xu) @ cccmp))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwss @ XU @ (XJ @ Xu)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwceq @ XX @ (ccuni @ XU)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XU @ ccfn))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwn @ (cwcel @ XX @ XU)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xd:$i] : (cwceq @ (XF @ Xy1 @ Xz @ Xu @ Xk @ Xd) @ (ccmpt @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccsu @ XU @ (^ [Xk:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccv @ Xk))) @ (^ [Xz:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD)))) @ ccxr @ cclt))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xk:$i] : (! [Xd:$i] : (cwceq @ (XK @ Xy1 @ Xz @ Xu @ Xk @ Xd) @ (ccfv @ (ccrn @ ccioo) @ cctg))))))) => (! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XD @ ccbl)) @ (ccv @ Xu))) @ (^ [Xu:$i] : XU))) @ (^ [Xx3:$i] : XX))) @ (^ [Xd:$i] : ccrp))))))))))))))))))))).
