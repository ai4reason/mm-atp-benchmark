...
thf(cepfrc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwi @ (cw3a @ (cwfr @ XA2 @ ccep) @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ XB2 @ (ccv @ Xx3)) @ cc0)) @ (^ [Xx3:$i] : XB2))))))).
