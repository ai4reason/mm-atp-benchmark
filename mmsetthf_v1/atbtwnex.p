...
thf(anbrne2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ XC @ XR) @ (cwn @ (cwbr @ XB2 @ XC @ XR))) @ (cwne @ XA2 @ XB2))))))).
...
thf(aatbtwn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cwa @ (cwcel @ XR @ XA2) @ (cwcel @ XX @ XB2)) @ (cw3a @ (cwbr @ XP @ XX @ Xc_le) @ (cwn @ (cwbr @ XQ @ XX @ Xc_le)) @ (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le))) @ (cwb @ (cwne @ XR @ XP) @ (cwn @ (cwbr @ XR @ XX @ Xc_le)))))))))))))))))).
...
thf(catbtwnex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((! [Xr:$i] : (cwceq @ (Xc_or @ Xr) @ (ccfv @ XK @ ccjn))) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwbr @ XP @ XX @ Xc_le) @ (cwn @ (cwbr @ XQ @ XX @ Xc_le)))) @ (cwrex @ (^ [Xr:$i] : (cw3a @ (cwne @ (ccv @ Xr) @ XQ) @ (cwn @ (cwbr @ (ccv @ Xr) @ XX @ Xc_le)) @ (cwbr @ XP @ (cco @ XQ @ (ccv @ Xr) @ (Xc_or @ Xr)) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))).
