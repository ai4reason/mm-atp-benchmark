...
thf(aac6sfi_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xf1)))))) => (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (XA2 @ Xy1) @ ccfn) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ (XA2 @ Xy1) @ XB2 @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xf1)) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))))))))))).
...
thf(afimass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwf @ XA2 @ XB2 @ XF) @ (cwss @ (ccima @ XF @ XX) @ XB2))))))).
...
thf(aresiima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwss @ XB2 @ XA2) @ (cwceq @ (ccima @ (ccres @ ccid @ XA2) @ XB2) @ XB2))))).
...
thf(cfipreima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XB2) @ (cwss @ XA2 @ (ccrn @ XF)) @ (cwcel @ XA2 @ ccfn)) @ (cwrex @ (^ [Xc:$i] : (cwceq @ (ccima @ XF @ (ccv @ Xc)) @ XA2)) @ (^ [Xc:$i] : (ccin @ (ccpw @ XB2) @ ccfn)))))))).
