...
thf(adf_unop_ax,axiom,(cwceq @ ccuo @ (ccab @ (^ [Xt:$i] : (cwa @ (cwfo @ cchil @ cchil @ (ccv @ Xt)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xt)) @ ccsp) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))))))).
thf(celunop_conj,conjecture,(! [XT:($i > $o)] : (cwb @ (cwcel @ XT @ ccuo) @ (cwa @ (cwfo @ cchil @ cchil @ XT) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwceq @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccsp) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)))))).
