...
thf(adf_ltpq_ax,axiom,(cwceq @ ccltpq @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ (ccv @ Xy1) @ (ccxp @ ccnpi @ ccnpi))) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ ccmi) @ (cco @ (ccfv @ (ccv @ Xy1) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccmi) @ cclti))))))).
...
thf(cordpipq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwb @ (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccltpq) @ (cwbr @ (cco @ XA2 @ XD @ ccmi) @ (cco @ XC @ XB2 @ ccmi) @ cclti))))))).
