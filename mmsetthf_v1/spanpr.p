...
thf(aelspansn3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ (ccfv @ (ccsn @ XB2) @ ccspn))) @ (cwcel @ XC @ XA2)))))).
...
thf(cspanpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwss @ (ccfv @ (ccsn @ (cco @ XA2 @ XB2 @ ccva)) @ ccspn) @ (ccfv @ (ccpr @ XA2 @ XB2) @ ccspn)))))).
