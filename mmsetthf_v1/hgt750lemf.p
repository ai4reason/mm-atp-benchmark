...
thf(chgt750lemf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XP @ ccr)) => ((cwi @ Xph @ (cwcel @ XQ @ ccr)) => ((! [Xn:$i] : (cwi @ Xph @ (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccico) @ (XH @ Xn)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccico) @ (XK @ Xn)))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XA2)) @ (cwcel @ (ccfv @ ccc0 @ (ccv @ Xn)) @ ccn))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XA2)) @ (cwcel @ (ccfv @ cc1 @ (ccv @ Xn)) @ ccn))) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XA2)) @ (cwcel @ (ccfv @ cc2 @ (ccv @ Xn)) @ ccn))) => ((! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ ccn)) @ (cwbr @ (ccfv @ (ccv @ Xm) @ (XK @ Xn)) @ XP @ ccle)))) => ((! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xm) @ ccn)) @ (cwbr @ (ccfv @ (ccv @ Xm) @ (XH @ Xn)) @ XQ @ ccle)))) => (cwi @ Xph @ (cwbr @ (ccsu @ XA2 @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xn)) @ ccvma) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xn)) @ (XH @ Xn)) @ ccmul) @ (cco @ (cco @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xn)) @ ccvma) @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xn)) @ (XK @ Xn)) @ ccmul) @ (cco @ (ccfv @ (ccfv @ cc2 @ (ccv @ Xn)) @ ccvma) @ (ccfv @ (ccfv @ cc2 @ (ccv @ Xn)) @ (XK @ Xn)) @ ccmul) @ ccmul) @ ccmul))) @ (cco @ (cco @ (cco @ XP @ cc2 @ ccexp) @ XQ @ ccmul) @ (ccsu @ XA2 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xn)) @ ccvma) @ (cco @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xn)) @ ccvma) @ (ccfv @ (ccfv @ cc2 @ (ccv @ Xn)) @ ccvma) @ ccmul) @ ccmul))) @ ccmul) @ ccle))))))))))))))))))).
