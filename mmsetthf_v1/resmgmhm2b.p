...
thf(asubmgmmgm_thm,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XH @ (cco @ XM @ XS @ ccress)) => (cwi @ (cwcel @ XS @ (ccfv @ XM @ ccsubmgm)) @ (cwcel @ XH @ ccmgm))))))).
...
thf(asubmgmbas_thm,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XH @ (cco @ XM @ XS @ ccress)) => (cwi @ (cwcel @ XS @ (ccfv @ XM @ ccsubmgm)) @ (cwceq @ XS @ (ccfv @ XH @ ccbs)))))))).
...
thf(aresmgmhm2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XU @ ccmgmhm)) @ (cwcel @ XX @ (ccfv @ XT @ ccsubmgm))) @ (cwcel @ XF @ (cco @ XS @ XT @ ccmgmhm)))))))))).
thf(cresmgmhm2b_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XT @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XX @ (ccfv @ XT @ ccsubmgm)) @ (cwss @ (ccrn @ XF) @ XX)) @ (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccmgmhm)) @ (cwcel @ XF @ (cco @ XS @ XU @ ccmgmhm))))))))))).
