...
thf(cgsumws3_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ ccmnd) @ (cwa @ (cwcel @ XS @ XB2) @ (cwa @ (cwcel @ XT @ XB2) @ (cwcel @ XU @ XB2)))) @ (cwceq @ (cco @ XG @ (ccs3 @ XS @ XT @ XU) @ ccgsu) @ (cco @ XS @ (cco @ XT @ XU @ Xc_pl) @ Xc_pl)))))))))))).
