...
thf(aesumfsup_thm,axiom,(! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : (cwi @ (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xk)) @ (cwceq @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) @ (ccsup @ (ccrn @ (ccseq @ ccxad @ (XF @ Xk) @ cc1)) @ ccxr @ cclt))))))).
...
thf(aseqfeq3_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (ccfv @ XM @ ccuz))) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XS))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS))) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XQ))))) => (cwi @ Xph @ (cwceq @ (ccseq @ Xc_pl @ XF @ XM) @ (ccseq @ XQ @ XF @ XM)))))))))))))).
...
thf(cesumfsupre_conj,conjecture,(! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : (cwi @ (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccico) @ (XF @ Xk)) @ (cwceq @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) @ (ccsup @ (ccrn @ (ccseq @ ccaddc @ (XF @ Xk) @ cc1)) @ ccxr @ cclt))))))).
