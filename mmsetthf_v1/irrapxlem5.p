...
thf(airrapxlem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccn)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ (cco @ cc1 @ (ccif @ (cwbr @ (ccv @ Xx3) @ XB2 @ ccle) @ XB2 @ (ccv @ Xx3)) @ ccdiv) @ cclt)) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccn)))))).
...
thf(adivdenle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccn)) @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) @ XB2 @ ccle))))).
thf(asyl22anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ Xph @ Xth) => ((cwi @ Xph @ Xta) => ((cwi @ (cwa @ (cwa @ Xps @ Xch) @ (cwa @ Xth @ Xta)) @ Xet) => (cwi @ Xph @ Xet))))))))))))).
thf(ale2msq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwa @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ ccle))) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ XB2 @ XB2 @ ccmul) @ ccle)))))).
...
thf(cirrapxlem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp)) @ (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ XB2 @ cclt) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccdenom) @ (ccneg @ cc2) @ ccexp) @ cclt))) @ (^ [Xx3:$i] : ccq)))))).
