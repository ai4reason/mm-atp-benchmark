...
thf(cdquartlem2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XS @ ccc)) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ (cco @ cc2 @ XS @ ccmul) @ cc2 @ ccexp))) => ((cwi @ Xph @ (cwne @ XM @ ccc0)) => ((cwi @ Xph @ (cwcel @ XI @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XI @ cc2 @ ccexp) @ (cco @ (cco @ (ccneg @ (cco @ XS @ cc2 @ ccexp)) @ (cco @ XB2 @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XC @ cc4 @ ccdiv) @ XS @ ccdiv) @ ccaddc))) => ((cwi @ Xph @ (cwcel @ XD @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ XM @ cc3 @ ccexp) @ (cco @ (cco @ cc2 @ XB2 @ ccmul) @ (cco @ XM @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ XD @ ccmul) @ ccmin) @ XM @ ccmul) @ (ccneg @ (cco @ XC @ cc2 @ ccexp)) @ ccaddc) @ ccaddc) @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ (cco @ (cco @ XM @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XC @ cc2 @ ccexp) @ cc4 @ ccdiv) @ XM @ ccdiv) @ ccmin) @ XD))))))))))))))))))))).
