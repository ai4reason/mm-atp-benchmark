...
thf(afunbrafvb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwcel @ XA2 @ (ccdm @ XF))) @ (cwb @ (cwceq @ (ccafv @ XA2 @ XF) @ XB2) @ (cwbr @ XA2 @ XB2 @ XF))))))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(adfima2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccima @ XA2 @ XB2) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2)) @ (^ [Xx3:$i] : XB2)))))))).
thf(cdfaimafn_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfun @ XF) @ (cwss @ XA2 @ (ccdm @ XF))) @ (cwceq @ (ccima @ XF @ XA2) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccafv @ (ccv @ Xx3) @ XF) @ (ccv @ Xy1))) @ (^ [Xx3:$i] : XA2))))))))).
