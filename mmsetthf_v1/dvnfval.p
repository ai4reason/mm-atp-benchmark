...
thf(adf_dvn_ax,axiom,(cwceq @ ccdvn @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccpw @ ccc))) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (cco @ ccc @ (ccv @ Xs1) @ ccpm))) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccseq @ (cccom @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xs1) @ (ccv @ Xx3) @ ccdv))) @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (ccv @ Xf1))) @ ccc0)))))).
...
thf(cdvnfval_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ XS @ (ccv @ Xx3) @ ccdv))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwss @ XS @ ccc) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) @ (cwceq @ (cco @ XS @ XF @ ccdvn) @ (ccseq @ (cccom @ (XG @ Xx3) @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ XF)) @ ccc0))))))))).
