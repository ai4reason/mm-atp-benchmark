...
thf(cmvhf1_conj,conjecture,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => ((cwceq @ XH @ (ccfv @ XT @ ccmvh)) => (cwi @ (cwcel @ XT @ ccmfs) @ (cwf1 @ XV @ XE @ XH)))))))))).
