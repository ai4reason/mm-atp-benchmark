...
thf(celdv_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XT @ Xz) @ (cco @ XK @ XS @ ccrest))) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((! [Xz:$i] : (cwceq @ (XG @ Xz) @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XB2 @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XB2 @ ccmin) @ ccdiv))))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XS @ ccc))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwf @ XA2 @ ccc @ XF))) => ((! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwss @ XA2 @ XS))) => (! [Xz:$i] : (cwi @ (Xph @ Xz) @ (cwb @ (cwbr @ XB2 @ XC @ (cco @ XS @ XF @ ccdv)) @ (cwa @ (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ (XT @ Xz) @ ccnt))) @ (cwcel @ XC @ (cco @ (XG @ Xz) @ XB2 @ cclimc)))))))))))))))))))))).
