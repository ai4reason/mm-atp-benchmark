...
thf(affzo0hash_thm,axiom,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwfn @ XF @ (cco @ ccc0 @ XN @ ccfzo))) @ (cwceq @ (ccfv @ XF @ cchash) @ XN))))).
...
thf(crepsdf2_conj,conjecture,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ XS @ (XV @ Xi)) @ (cwcel @ XN @ ccn0)) @ (cwb @ (cwceq @ XW @ (cco @ XS @ XN @ ccreps)) @ (cw3a @ (cwcel @ XW @ (ccword @ (XV @ Xi))) @ (cwceq @ (ccfv @ XW @ cchash) @ XN) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XW) @ XS)) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfzo)))))))))))).
