...
thf(cefiarg_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwceq @ (ccfv @ (cco @ cci @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccmul) @ cce) @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv))))).
