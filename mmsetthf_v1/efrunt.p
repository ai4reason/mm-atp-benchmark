...
thf(aepel_b_thm,axiom,(! [Xy1:$i] : (cwb @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xy1) @ ccep) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1))))).
thf(cefrunt_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwfr @ XA2 @ ccep) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))).
