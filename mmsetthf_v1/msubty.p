...
thf(cmsubty_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmsub)) => ((cwceq @ XE @ (ccfv @ XT @ ccmex)) => (cwi @ (cw3a @ (cwf @ XA2 @ XR @ XF) @ (cwss @ XA2 @ XV) @ (cwcel @ XX @ XE)) @ (cwceq @ (ccfv @ (ccfv @ XX @ (ccfv @ XF @ XS)) @ cc1st) @ (ccfv @ XX @ cc1st)))))))))))))))).
