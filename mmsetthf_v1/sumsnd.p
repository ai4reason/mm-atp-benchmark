...
thf(csumsnd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))))) => ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (cwa @ (Xph @ Xk) @ (cwceq @ (ccv @ Xk) @ XM)) @ (cwceq @ (XA2 @ Xk) @ (XB2 @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XM @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ (XB2 @ Xk) @ ccc))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccsu @ (ccsn @ XM) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (XB2 @ Xk))))))))))))))).
