...
thf(cphtpyhtpy_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (cwi @ Xph @ (cwss @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)) @ (cco @ XF @ XG @ (cco @ ccii @ XJ @ cchtpy))))))))))).
