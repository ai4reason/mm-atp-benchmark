...
thf(aelcnvcnvintab_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (cccnv @ (cccnv @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))))) @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (ccv @ Xx3)))))))))).
...
thf(ccnvcnvintabd_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3)))))) => (! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwceq @ (cccnv @ (cccnv @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3)))))) @ (ccint @ (ccrab @ (^ [Xw:$i] : (cwex @ (^ [Xx3:$i] : (cwa @ (cwceq @ (ccv @ Xw) @ (cccnv @ (cccnv @ (ccv @ Xx3)))) @ (Xps @ Xx3))))) @ (^ [Xw:$i] : (ccpw @ (ccxp @ ccvv @ ccvv))))))))))))).
