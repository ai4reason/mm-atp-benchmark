...
thf(aelplyr_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwss @ XS @ ccc) @ (cwcel @ XN @ ccn0) @ (cwf @ ccn0 @ XS @ XA2)) @ (cwcel @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))) @ (ccfv @ XS @ ccply))))))).
...
thf(acoeid2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XN @ (ccfv @ XF @ ccdgr)) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XX @ ccc)) @ (cwceq @ (ccfv @ XX @ XF) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ XX @ (ccv @ Xk) @ ccexp) @ ccmul))))))))))))).
...
thf(celaa2lem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xn) @ (cwcel @ (XA2 @ Xn) @ ccaa)))) => ((! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xn) @ (cwne @ (XA2 @ Xn) @ ccc0)))) => ((! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xn) @ (cwcel @ (XG @ Xf1) @ (ccfv @ ccz @ ccply))))) => ((! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xn) @ (cwne @ (XG @ Xf1) @ cc0p)))) => ((! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xn) @ (cwceq @ (ccfv @ (XA2 @ Xn) @ (XG @ Xf1)) @ ccc0)))) => ((! [Xf1:$i] : (cwceq @ (XM @ Xf1) @ (ccinf @ (ccrab @ (^ [Xn:$i] : (cwne @ (ccfv @ (ccv @ Xn) @ (ccfv @ (XG @ Xf1) @ cccoe)) @ ccc0)) @ (^ [Xn:$i] : ccn0)) @ ccr @ cclt))) => ((! [Xf1:$i] : (! [Xn:$i] : (cwceq @ (XI @ Xf1 @ Xn) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccv @ Xk) @ (XM @ Xf1) @ ccaddc) @ (ccfv @ (XG @ Xf1) @ cccoe))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xz @ Xk @ Xn) @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ (cco @ (ccfv @ (XG @ Xf1) @ ccdgr) @ (XM @ Xf1) @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XI @ Xf1 @ Xn)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))) => (! [Xf1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xf1 @ Xn) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ ccc0) @ (cwceq @ (ccfv @ (XA2 @ Xn) @ (ccv @ Xf1)) @ ccc0))) @ (^ [Xf1:$i] : (ccfv @ ccz @ ccply))))))))))))))))))))).
