...
thf(crestcls_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XK @ (cco @ XJ @ XY @ ccrest)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XY @ XX) @ (cwss @ XS @ XY)) @ (cwceq @ (ccfv @ XS @ (ccfv @ XK @ cccl)) @ (ccin @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ XY))))))))))).
