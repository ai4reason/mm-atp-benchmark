...
thf(chomaf_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (ccfv @ XC @ cchoma)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => (cwi @ Xph @ (cwf @ (ccxp @ XB2 @ XB2) @ (ccpw @ (ccxp @ (ccxp @ XB2 @ XB2) @ ccvv)) @ XH)))))))))).
