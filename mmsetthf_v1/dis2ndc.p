...
thf(asnelpw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwb @ (cwcel @ XA2 @ XB2) @ (cwcel @ (ccsn @ XA2) @ (ccpw @ XB2))))))).
...
thf(cdis2ndc_conj,conjecture,(! [XX:($i > $o)] : (cwb @ (cwbr @ XX @ ccom @ ccdom) @ (cwcel @ (ccpw @ XX) @ cc2ndc)))).
