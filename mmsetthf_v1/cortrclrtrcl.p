...
thf(acotrclrcl_thm,axiom,(cwceq @ (cccom @ cctcl @ ccrcl) @ ccrtcl)).
...
thf(acorclrtrcl_thm,axiom,(cwceq @ (cccom @ ccrcl @ ccrtcl) @ ccrtcl)).
thf(acotrclrtrcl_thm,axiom,(cwceq @ (cccom @ cctcl @ ccrtcl) @ ccrtcl)).
thf(ccortrclrtrcl_conj,conjecture,(cwceq @ (cccom @ ccrtcl @ ccrtcl) @ ccrtcl)).
