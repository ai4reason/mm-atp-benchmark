...
thf(cqus0_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwceq @ (ccec @ Xc_0 @ (cco @ XG @ XS @ ccqg)) @ (ccfv @ XH @ cc0g)))))))))).
