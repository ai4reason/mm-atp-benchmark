...
thf(ccbvditgv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XC @ Xx3) @ (XD @ Xy1))))) => (cwceq @ (ccdit @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccdit @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))).
