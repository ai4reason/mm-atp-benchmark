...
thf(cabsprodnn_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwss @ XZ @ ccz)) => ((cwi @ Xph @ (cwcel @ XZ @ ccfn)) => ((! [Xz:$i] : (cwceq @ (XP @ Xz) @ (ccfv @ (ccprod @ (^ [Xz:$i] : XZ) @ (^ [Xz:$i] : (ccv @ Xz))) @ ccabs))) => ((cwi @ Xph @ (cwnel @ ccc0 @ XZ)) => (! [Xz:$i] : (cwi @ Xph @ (cwcel @ (XP @ Xz) @ ccn))))))))))).
