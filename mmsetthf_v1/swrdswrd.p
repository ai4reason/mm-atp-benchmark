...
thf(aelfz0ubfz0_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XL @ (cco @ XK @ XN @ ccfz))) @ (cwcel @ XK @ (cco @ ccc0 @ XL @ ccfz))))))).
...
thf(aswrdswrdlem_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) @ (cwa @ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfz)) @ (cwcel @ XL @ (cco @ XK @ (cco @ XN @ XM @ ccmin) @ ccfz)))) @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (cco @ XM @ XK @ ccaddc) @ (cco @ ccc0 @ (cco @ XM @ XL @ ccaddc) @ ccfz)) @ (cwcel @ (cco @ XM @ XL @ ccaddc) @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))))))))))).
...
thf(ann0readdcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccr))))).
