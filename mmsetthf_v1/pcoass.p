...
thf(aiccdili_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XR @ ccrp) => ((cwceq @ (cco @ XA2 @ XR @ ccmul) @ XC) => ((cwceq @ (cco @ XB2 @ XR @ ccmul) @ XD) => (cwi @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (cco @ XX @ XR @ ccmul) @ (cco @ XC @ XD @ ccicc))))))))))))))).
...
thf(aiccshftli_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XR @ ccr) => ((cwceq @ (cco @ XA2 @ XR @ ccmin) @ XC) => ((cwceq @ (cco @ XB2 @ XR @ ccmin) @ XD) => (cwi @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (cco @ XX @ XR @ ccmin) @ (cco @ XC @ XD @ ccicc))))))))))))))).
...
thf(aicccntri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XR @ ccrp) => ((cwceq @ (cco @ XA2 @ XR @ ccdiv) @ XC) => ((cwceq @ (cco @ XB2 @ XR @ ccdiv) @ XD) => (cwi @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (cco @ XX @ XR @ ccdiv) @ (cco @ XC @ XD @ ccicc))))))))))))))).
thf(adiv0i_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) => (cwceq @ (cco @ ccc0 @ XA2 @ ccdiv) @ ccc0))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(aiccshftri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XR @ ccr) => ((cwceq @ (cco @ XA2 @ XR @ ccaddc) @ XC) => ((cwceq @ (cco @ XB2 @ XR @ ccaddc) @ XD) => (cwi @ (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (cco @ XX @ XR @ ccaddc) @ (cco @ XC @ XD @ ccicc))))))))))))))).
...
thf(adivccn_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccdiv))) @ (cco @ XJ @ XJ @ cccn))))))).
