...
thf(climcfval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : (cwceq @ (XJ @ Xz) @ (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => (! [Xz:$i] : (cwi @ (cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwa @ (cwceq @ (cco @ XF @ XB2 @ cclimc) @ (ccab @ (^ [Xy1:$i] : (cwcel @ (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ (cwceq @ (ccv @ Xz) @ XB2) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XF)))) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ XK @ cccnp)))))) @ (cwss @ (cco @ XF @ XB2 @ cclimc) @ ccc)))))))))))).
