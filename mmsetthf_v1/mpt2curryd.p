...
thf(adf_cur_ax,axiom,(! [XF:($i > $o)] : (cwceq @ (cccur @ XF) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccdm @ XF))) @ (^ [Xx3:$i] : (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ XF))))))))).
...
thf(cmpt2curryd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) => ((cwi @ Xph @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ XV)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))) => ((cwi @ Xph @ (cwne @ XY @ cc0)) => (cwi @ Xph @ (cwceq @ (cccur @ XF) @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))))))))))))).
