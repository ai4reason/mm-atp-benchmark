...
thf(a_19_27v_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (cwb @ (cwal @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ Xps))) @ (cwa @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3))) @ Xps))))).
...
thf(apm2_83_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwi @ Xph @ (cwi @ Xps @ Xch)) @ (cwi @ (cwi @ Xph @ (cwi @ Xch @ Xth)) @ (cwi @ Xph @ (cwi @ Xps @ Xth))))))))).
thf(crexrsb_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XA2)))))).
