...
thf(amodid2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ XA2) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ XA2 @ XB2 @ cclt))))))).
...
thf(czmodid2_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwceq @ (cco @ XM @ XN @ ccmo) @ XM) @ (cwcel @ XM @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))))).
