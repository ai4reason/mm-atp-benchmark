...
thf(cfimaxre3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (XB2 @ Xy1) @ ccr)) @ (^ [Xy1:$i] : XA2))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (XB2 @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)))))).
