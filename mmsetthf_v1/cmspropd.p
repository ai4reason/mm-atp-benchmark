...
thf(amspropd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XK @ ccbs))) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XL @ ccbs))) => ((cwi @ Xph @ (cwceq @ (ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XB2 @ XB2)) @ (ccres @ (ccfv @ XL @ ccds) @ (ccxp @ XB2 @ XB2)))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ cctopn) @ (ccfv @ XL @ cctopn))) => (cwi @ Xph @ (cwb @ (cwcel @ XK @ ccmt) @ (cwcel @ XL @ ccmt)))))))))))).
...
thf(ccmspropd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XK @ ccbs))) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XL @ ccbs))) => ((cwi @ Xph @ (cwceq @ (ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XB2 @ XB2)) @ (ccres @ (ccfv @ XL @ ccds) @ (ccxp @ XB2 @ XB2)))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ cctopn) @ (ccfv @ XL @ cctopn))) => (cwi @ Xph @ (cwb @ (cwcel @ XK @ cccms) @ (cwcel @ XL @ cccms)))))))))))).
