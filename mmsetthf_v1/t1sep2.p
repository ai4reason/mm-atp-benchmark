...
thf(aist1_2_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwb @ (cwcel @ XJ @ cct1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwral @ (^ [Xo:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xo)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))).
...
thf(ct1sep2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cct1) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwi @ (cwral @ (^ [Xo:$i] : (cwi @ (cwcel @ XA2 @ (ccv @ Xo)) @ (cwcel @ XB2 @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ)) @ (cwceq @ XA2 @ XB2))))))))).
