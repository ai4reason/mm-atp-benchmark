...
thf(citg1addlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccitg1))) => ((cwi @ Xph @ (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (cwa @ (cwceq @ (ccv @ Xi) @ ccc0) @ (cwceq @ (ccv @ Xj) @ ccc0)) @ ccc0 @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xi))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xj)))) @ ccvol)))))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwn @ (cwa @ (cwceq @ XA2 @ ccc0) @ (cwceq @ XB2 @ ccc0)))) @ (cwceq @ (cco @ XA2 @ XB2 @ (XI @ Xi @ Xj)) @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ XA2)) @ (ccima @ (cccnv @ XG) @ (ccsn @ XB2))) @ ccvol))))))))))))))).
