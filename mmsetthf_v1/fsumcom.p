...
thf(cfsumcom_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xk) @ XB2))) @ (cwcel @ (XC @ Xj @ Xk) @ ccc)))) => (cwi @ Xph @ (cwceq @ (ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xj @ Xk))))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (ccsu @ XA2 @ (^ [Xj:$i] : (XC @ Xj @ Xk))))))))))))))).
