...
thf(ashftfval_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ XF @ XA2 @ ccshi) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwbr @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccv @ Xy1) @ XF))))))))))).
...
thf(ashftdm_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccdm @ (cco @ XF @ XA2 @ ccshi)) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccdm @ XF))) @ (^ [Xx3:$i] : ccc)))))))).
...
thf(cshftfn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwfn @ XF @ XB2) @ (cwcel @ XA2 @ ccc)) @ (cwfn @ (cco @ XF @ XA2 @ ccshi) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ XB2)) @ (^ [Xx3:$i] : ccc))))))))).
