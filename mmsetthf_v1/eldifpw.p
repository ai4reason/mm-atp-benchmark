...
thf(celdifpw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ (ccpw @ XB2)) @ (cwn @ (cwss @ XC @ XB2))) @ (cwcel @ (ccun @ XA2 @ XC) @ (ccdif @ (ccpw @ (ccun @ XB2 @ XC)) @ (ccpw @ XB2))))))))).
