...
thf(aushgredgedg_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ ccedg))) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (! [Xe:$i] : (! [Xi:$i] : (cwceq @ (XA2 @ Xx3 @ Xe @ Xi) @ (ccrab @ (^ [Xi:$i] : (cwcel @ XN @ (ccfv @ (ccv @ Xi) @ XI))) @ (^ [Xi:$i] : (ccdm @ XI))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XB2 @ Xx3 @ Xi) @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xx3)))))) => ((! [Xx3:$i] : (! [Xe:$i] : (! [Xi:$i] : (cwceq @ (XF @ Xx3 @ Xe @ Xi) @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xe @ Xi)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XI))))))) => (! [Xx3:$i] : (! [Xe:$i] : (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccushgr) @ (cwcel @ XN @ XV)) @ (cwf1o @ (XA2 @ Xx3 @ Xe @ Xi) @ (XB2 @ Xx3 @ Xi) @ (XF @ Xx3 @ Xe @ Xi))))))))))))))))))))).
...
thf(cvtxdushgrfvedglem_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccushgr) @ (cwcel @ XU @ XV)) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xi:$i] : (cwcel @ XU @ (ccfv @ (ccv @ Xi) @ (ccfv @ XG @ cciedg)))) @ (^ [Xi:$i] : (ccdm @ (ccfv @ XG @ cciedg)))) @ cchash) @ (ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash)))))))))).
