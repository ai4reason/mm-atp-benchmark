...
thf(c_2shfti_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ (cco @ XF @ XA2 @ ccshi) @ XB2 @ ccshi) @ (cco @ XF @ (cco @ XA2 @ XB2 @ ccaddc) @ ccshi)))))))).
