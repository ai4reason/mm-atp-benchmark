...
thf(auffixsn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwcel @ XA2 @ (ccint @ XF))) @ (cwcel @ (ccsn @ XA2) @ XF)))))).
...
thf(ccfinufil_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwb @ (cwceq @ (ccint @ XF) @ cc0) @ (cwss @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XX @ (ccv @ Xx3)) @ ccfn)) @ (^ [Xx3:$i] : (ccpw @ XX))) @ XF)))))).
