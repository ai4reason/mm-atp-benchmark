...
thf(adf_sitm_ax,axiom,(cwceq @ ccsitm @ (ccmpt2 @ (^ [Xw:$i] : (^ [Xm:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xm:$i] : (ccuni @ (ccrn @ ccmeas)))) @ (^ [Xw:$i] : (^ [Xm:$i] : (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccdm @ (cco @ (ccv @ Xw) @ (ccv @ Xm) @ ccsitg)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccdm @ (cco @ (ccv @ Xw) @ (ccv @ Xm) @ ccsitg)))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccof @ (ccfv @ (ccv @ Xw) @ ccds))) @ (cco @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ (ccv @ Xm) @ ccsitg)))))))))).
