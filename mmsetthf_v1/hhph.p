...
thf(anormpar_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ (ccfv @ XB2 @ ccno) @ cc2 @ ccexp) @ ccmul) @ ccaddc)))))).
...
thf(chhph_conj,conjecture,(! [XU:($i > $o)] : ((cwceq @ XU @ (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => (cwcel @ XU @ cccphlo)))).
