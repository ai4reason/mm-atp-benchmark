...
thf(ccongsym_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ XC @ ccz) @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds))) @ (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ ccdvds)))))).
