...
thf(atmdcn2_thm,axiom,(! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu) @ (ccfv @ XG @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XJ @ Xx3 @ Xy1) @ (ccfv @ XG @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu) @ (ccfv @ XG @ ccplusg)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XG @ cctmd) @ (cwcel @ XU @ (XJ @ Xx3 @ Xy1))) @ (cw3a @ (cwcel @ (XX @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu)) @ (cwcel @ (XY @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu)) @ (cwcel @ (cco @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu)) @ XU))) @ (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cw3a @ (cwcel @ (XX @ Xx3 @ Xy1) @ (ccv @ Xu)) @ (cwcel @ (XY @ Xx3 @ Xy1) @ (ccv @ Xv)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu)) @ XU)) @ (^ [Xy1:$i] : (ccv @ Xv)))) @ (^ [Xx3:$i] : (ccv @ Xu))))) @ (^ [Xv:$i] : (XJ @ Xx3 @ Xy1)))) @ (^ [Xu:$i] : (XJ @ Xx3 @ Xy1))))))))))))))))))).
...
thf(atmdgsum2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((! [Xu:$i] : (! [Xf1:$i] : (cwceq @ (Xc_x @ Xu @ Xf1) @ (ccfv @ XG @ ccmg)))) => ((! [Xu:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xu @ Xf1) @ (cwcel @ XG @ cccmn)))) => ((! [Xu:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xu @ Xf1) @ (cwcel @ XG @ cctmd)))) => ((! [Xu:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xu @ Xf1) @ (cwcel @ XA2 @ ccfn)))) => ((! [Xu:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xu @ Xf1) @ (cwcel @ XU @ XJ)))) => ((! [Xu:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xu @ Xf1) @ (cwcel @ XX @ XB2)))) => ((! [Xu:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xu @ Xf1) @ (cwcel @ (cco @ (ccfv @ XA2 @ cchash) @ XX @ (Xc_x @ Xu @ Xf1)) @ XU)))) => (! [Xu:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xu @ Xf1) @ (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ XX @ (ccv @ Xu)) @ (cwral @ (^ [Xf1:$i] : (cwcel @ (cco @ XG @ (ccv @ Xf1) @ ccgsu) @ XU)) @ (^ [Xf1:$i] : (cco @ (ccv @ Xu) @ XA2 @ ccmap))))) @ (^ [Xu:$i] : XJ))))))))))))))))))))))).
...
thf(atsmsxplem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xx3 @ Xj @ Xn) @ (ccfv @ XG @ ccbs))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XG @ cccmn))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XG @ cctgp))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3 @ Xj @ Xk @ Xn))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XC @ Xx3) @ (XW @ Xx3 @ Xj @ Xk @ Xn))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ (ccxp @ (XA2 @ Xx3) @ (XC @ Xx3)) @ (XB2 @ Xx3 @ Xj @ Xn) @ XF))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwf @ (XA2 @ Xx3) @ (XB2 @ Xx3 @ Xj @ Xn) @ XH))))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xj) @ (XA2 @ Xx3))) @ (cwcel @ (ccfv @ (ccv @ Xj) @ XH) @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (XC @ Xx3)) @ (^ [Xk:$i] : (cco @ (ccv @ Xj) @ (ccv @ Xk) @ XF))) @ cctsu))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XJ @ Xx3 @ Xj @ Xk @ Xn) @ (ccfv @ XG @ cctopn)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwceq @ (Xc_0 @ Xx3 @ Xj @ Xn) @ (ccfv @ XG @ cc0g))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (Xc_pl @ Xx3 @ Xj @ Xk @ Xn) @ (ccfv @ XG @ ccplusg)))))) => ((! [Xk:$i] : (cwceq @ (Xc_mi @ Xk) @ (ccfv @ XG @ ccsg))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XL @ Xk) @ (XJ @ Xx3 @ Xj @ Xk @ Xn))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (Xc_0 @ Xx3 @ Xj @ Xn) @ (XL @ Xk))))))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XK @ (ccin @ (ccpw @ (XA2 @ Xx3)) @ ccfn)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ (ccdm @ XD) @ XK))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XD @ (ccin @ (ccpw @ (ccxp @ (XA2 @ Xx3) @ (XC @ Xx3))) @ ccfn)))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3) @ (cwrex @ (^ [Xn:$i] : (cwa @ (cwss @ (ccrn @ XD) @ (ccv @ Xn)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccfv @ (ccv @ Xx3) @ XH) @ (cco @ XG @ (ccres @ XF @ (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccv @ Xn))) @ ccgsu) @ (Xc_mi @ Xk)) @ (XL @ Xk))) @ (^ [Xx3:$i] : XK)))) @ (^ [Xn:$i] : (ccin @ (ccpw @ (XC @ Xx3)) @ ccfn)))))))))))))))))))))))))))))))))))))))).
...
thf(ctsmsxp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (cwceq @ (XB2 @ Xj) @ (ccfv @ XG @ ccbs))) => ((cwi @ Xph @ (cwcel @ XG @ cccmn)) => ((cwi @ Xph @ (cwcel @ XG @ cctgp)) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xj @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XC @ (XW @ Xj @ Xk))))) => ((! [Xj:$i] : (cwi @ Xph @ (cwf @ (ccxp @ XA2 @ XC) @ (XB2 @ Xj) @ XF))) => ((! [Xj:$i] : (cwi @ Xph @ (cwf @ XA2 @ (XB2 @ Xj) @ XH))) => ((! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (ccfv @ (ccv @ Xj) @ XH) @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (cco @ (ccv @ Xj) @ (ccv @ Xk) @ XF))) @ cctsu)))) => (cwi @ Xph @ (cwss @ (cco @ XG @ XF @ cctsu) @ (cco @ XG @ XH @ cctsu))))))))))))))))))))).
