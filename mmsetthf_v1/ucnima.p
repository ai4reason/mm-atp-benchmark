...
thf(aisucn_thm,axiom,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ (XV @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccust))) @ (cwb @ (cwcel @ XF @ (cco @ XU @ (XV @ Xy1) @ ccucn)) @ (cwa @ (cwf @ XX @ (XY @ Xy1) @ XF) @ (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) @ (^ [Xr:$i] : XU))) @ (^ [Xs1:$i] : (XV @ Xy1))))))))))))).
...
thf(aucnimalem_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xp) @ (cwcel @ (XU @ Xx3 @ Xy1 @ Xp) @ (ccfv @ XX @ ccust)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xp) @ (cwcel @ (XV @ Xx3 @ Xy1 @ Xp) @ (ccfv @ (XY @ Xx3 @ Xy1 @ Xp) @ ccust)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xp) @ (cwcel @ XF @ (cco @ (XU @ Xx3 @ Xy1 @ Xp) @ (XV @ Xx3 @ Xy1 @ Xp) @ ccucn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xp) @ (cwcel @ (XW @ Xx3 @ Xy1 @ Xp) @ (XV @ Xx3 @ Xy1 @ Xp)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xp) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xp) @ (ccmpt @ (^ [Xp:$i] : (ccxp @ XX @ XX)) @ (^ [Xp:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ XF) @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc2nd) @ XF)))))))))))))))))))))).
...
thf(cucnima_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XX @ ccust))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XV @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccust)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ XU @ (XV @ Xy1) @ ccucn)))) => ((! [Xy1:$i] : (cwi @ Xph @ (cwcel @ XW @ (XV @ Xy1)))) => ((! [Xr:$i] : (cwceq @ (XG @ Xr) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))))))) => (cwi @ Xph @ (cwrex @ (^ [Xr:$i] : (cwss @ (ccima @ (XG @ Xr) @ (ccv @ Xr)) @ XW)) @ (^ [Xr:$i] : XU))))))))))))))))).
