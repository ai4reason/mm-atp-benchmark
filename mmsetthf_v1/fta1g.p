...
thf(afta1glem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XW @ (ccfv @ XR @ cc0g)) => ((! [Xg1:$i] : (cwceq @ (Xc_0 @ Xg1) @ (ccfv @ XP @ cc0g))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XR @ ccidom))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XF @ XB2))) => ((! [Xg1:$i] : (cwceq @ (XK @ Xg1) @ (ccfv @ XR @ ccbs))) => ((! [Xg1:$i] : (cwceq @ (XX @ Xg1) @ (ccfv @ XR @ ccv1))) => ((! [Xg1:$i] : (cwceq @ (Xc_mi @ Xg1) @ (ccfv @ XP @ ccsg))) => ((! [Xg1:$i] : (cwceq @ (XA2 @ Xg1) @ (ccfv @ XP @ ccascl))) => ((! [Xg1:$i] : (cwceq @ XG @ (cco @ (XX @ Xg1) @ (ccfv @ (XT @ Xg1) @ (XA2 @ Xg1)) @ (Xc_mi @ Xg1)))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ XN @ ccn0))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwceq @ (ccfv @ XF @ XD) @ (cco @ XN @ cc1 @ ccaddc)))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwcel @ (XT @ Xg1) @ (ccima @ (cccnv @ (ccfv @ XF @ XO)) @ (ccsn @ XW))))) => ((! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwral @ (^ [Xg1:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xg1) @ XD) @ XN) @ (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xg1) @ XO)) @ (ccsn @ XW)) @ cchash) @ (ccfv @ (ccv @ Xg1) @ XD) @ ccle))) @ (^ [Xg1:$i] : XB2)))) => (! [Xg1:$i] : (cwi @ (Xph @ Xg1) @ (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccfv @ XF @ XO)) @ (ccsn @ XW)) @ cchash) @ (ccfv @ XF @ XD) @ ccle))))))))))))))))))))))))))))))))))))).
...
thf(cfta1g_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => ((cwceq @ XO @ (ccfv @ XR @ cce1)) => ((cwceq @ XW @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => ((cwi @ Xph @ (cwcel @ XR @ ccidom)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwne @ XF @ Xc_0)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccfv @ XF @ XO)) @ (ccsn @ XW)) @ cchash) @ (ccfv @ XF @ XD) @ ccle))))))))))))))))))))).
