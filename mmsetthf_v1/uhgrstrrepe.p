...
thf(cuhgrstrrepe_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ ccnx @ ccedgf)) => ((cwi @ Xph @ (cwbr @ XG @ XX @ ccstr)) => ((cwi @ Xph @ (cwcel @ (ccfv @ ccnx @ ccbs) @ (ccdm @ XG))) => ((cwi @ Xph @ (cwcel @ XE @ XW)) => ((cwi @ Xph @ (cwf @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)) => (cwi @ Xph @ (cwcel @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ ccuhgr)))))))))))))))).
