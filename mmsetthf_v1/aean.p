...
thf(aunelsiga_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS)) @ (cwcel @ (ccun @ XA2 @ XB2) @ XS)))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(assun1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ XA2 @ (ccun @ XA2 @ XB2))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ Xph @ Xps) @ Xps)))).
thf(ameasle0_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwcel @ XA2 @ XS) @ (cwbr @ (ccfv @ XA2 @ XM) @ ccc0 @ ccle)) @ (cwceq @ (ccfv @ XA2 @ XM) @ ccc0)))))).
...
thf(ameasunl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((cwi @ Xph @ (cwcel @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XB2 @ XS)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ XM) @ (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccxad) @ ccle))))))))))).
...
thf(abraew_thm,axiom,(! [Xph:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (ccuni @ (ccdm @ (XM @ Xx3))) @ XO)) => (! [Xx3:$i] : (cwi @ (cwcel @ (XM @ Xx3) @ (ccuni @ (ccrn @ ccmeas))) @ (cwb @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) @ (cwceq @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwn @ (Xph @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3)) @ ccc0))))))))).
thf(aanbi12d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => ((cwi @ Xph @ (cwb @ Xth @ Xta)) => (cwi @ Xph @ (cwb @ (cwa @ Xps @ Xth) @ (cwa @ Xch @ Xta))))))))))).
thf(caean_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (ccuni @ (ccdm @ (XM @ Xx3))) @ XO)) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ (XM @ Xx3) @ (ccuni @ (ccrn @ ccmeas))) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwn @ (Xph @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (ccdm @ (XM @ Xx3))) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwn @ (Xps @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (ccdm @ (XM @ Xx3)))) @ (cwb @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (cwa @ (Xph @ Xx3) @ (Xps @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) @ (cwa @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) @ (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae))))))))))).
