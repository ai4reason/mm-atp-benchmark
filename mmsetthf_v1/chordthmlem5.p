...
thf(achordthmlem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccicc))) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv))) => ((cwi @ Xph @ (cwceq @ XP @ (cco @ (cco @ XX @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XX @ ccmin) @ XB2 @ ccmul) @ ccaddc))) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (cco @ XP @ XA2 @ ccmin) @ ccabs) @ (ccfv @ (cco @ XP @ XB2 @ ccmin) @ ccabs) @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ XB2 @ XM @ ccmin) @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XP @ XM @ ccmin) @ ccabs) @ cc2 @ ccexp) @ ccmin))))))))))))))).
thf(cchordthmlem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XQ @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccicc))) => ((cwi @ Xph @ (cwceq @ XP @ (cco @ (cco @ XX @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XX @ ccmin) @ XB2 @ ccmul) @ ccaddc))) => ((cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XQ @ ccmin) @ ccabs) @ (ccfv @ (cco @ XB2 @ XQ @ ccmin) @ ccabs))) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (cco @ XP @ XA2 @ ccmin) @ ccabs) @ (ccfv @ (cco @ XP @ XB2 @ ccmin) @ ccabs) @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ XB2 @ XQ @ ccmin) @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XP @ XQ @ ccmin) @ ccabs) @ cc2 @ ccexp) @ ccmin)))))))))))))))).
