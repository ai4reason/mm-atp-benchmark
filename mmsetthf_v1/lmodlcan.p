...
thf(clmodlcan_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XW @ cclmod) @ (cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ XZ @ XV))) @ (cwb @ (cwceq @ (cco @ XZ @ XX @ Xc_pl) @ (cco @ XZ @ XY @ Xc_pl)) @ (cwceq @ XX @ XY)))))))))))).
