...
thf(aigamval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccigam) @ (ccif @ (cwcel @ XA2 @ (ccdif @ ccz @ ccn)) @ ccc0 @ (cco @ cc1 @ (ccfv @ XA2 @ ccgam) @ ccdiv)))))).
thf(cwa_tp,type,(cwa : ($o > ($o > $o)))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(aiftrue_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ Xph @ (cwceq @ (ccif @ Xph @ XA2 @ XB2) @ XA2)))))).
thf(cigamz_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdif @ ccz @ ccn)) @ (cwceq @ (ccfv @ XA2 @ ccigam) @ ccc0)))).
