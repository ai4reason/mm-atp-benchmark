...
thf(adiv13d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ ccmul) @ (cco @ (cco @ XC @ XB2 @ ccdiv) @ XA2 @ ccmul)))))))))))).
...
thf(cdyaddisjlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XF @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwa @ (cwcel @ XC @ ccn0) @ (cwcel @ XD @ ccn0))) @ (cwbr @ XC @ XD @ ccle)) @ (cw3o @ (cwss @ (ccfv @ (cco @ XA2 @ XC @ XF) @ ccicc) @ (ccfv @ (cco @ XB2 @ XD @ XF) @ ccicc)) @ (cwss @ (ccfv @ (cco @ XB2 @ XD @ XF) @ ccicc) @ (ccfv @ (cco @ XA2 @ XC @ XF) @ ccicc)) @ (cwceq @ (ccin @ (ccfv @ (cco @ XA2 @ XC @ XF) @ ccioo) @ (ccfv @ (cco @ XB2 @ XD @ XF) @ ccioo)) @ cc0)))))))))).
