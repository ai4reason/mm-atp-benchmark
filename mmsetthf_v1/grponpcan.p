...
thf(cgrponpcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccrn @ XG)) => ((cwceq @ XD @ (ccfv @ XG @ ccgs)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgr) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ XD) @ XB2 @ XG) @ XA2)))))))))).
