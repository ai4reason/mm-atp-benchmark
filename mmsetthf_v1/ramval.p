...
thf(adf_ram_ax,axiom,(cwceq @ ccram @ (ccmpt2 @ (^ [Xm:$i] : (^ [Xr:$i] : ccn0)) @ (^ [Xm:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xm:$i] : (^ [Xr:$i] : (ccinf @ (ccrab @ (^ [Xn:$i] : (cwal @ (^ [Xs1:$i] : (cwi @ (cwbr @ (ccv @ Xn) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) @ (cwral @ (^ [Xf1:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccfv @ (ccv @ Xc) @ (ccv @ Xr)) @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xy1) @ cchash) @ (ccv @ Xm)) @ (cwceq @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xc)))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xs1))))) @ (^ [Xc:$i] : (ccdm @ (ccv @ Xr))))) @ (^ [Xf1:$i] : (cco @ (ccdm @ (ccv @ Xr)) @ (ccrab @ (^ [Xy1:$i] : (cwceq @ (ccfv @ (ccv @ Xy1) @ cchash) @ (ccv @ Xm))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xs1)))) @ ccmap))))))) @ (^ [Xn:$i] : ccn0)) @ ccxr @ cclt)))))).
