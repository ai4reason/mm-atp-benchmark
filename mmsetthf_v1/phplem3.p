...
thf(aphplem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ XA2)) @ (cwbr @ XA2 @ (ccdif @ (ccsuc @ XA2) @ (ccsn @ XB2)) @ ccen))))))).
...
thf(cphplem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ (ccsuc @ XA2))) @ (cwbr @ XA2 @ (ccdif @ (ccsuc @ XA2) @ (ccsn @ XB2)) @ ccen))))))).
