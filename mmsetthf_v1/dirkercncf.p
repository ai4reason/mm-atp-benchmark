...
thf(adirkercncflem3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))) => ((! [Xn:$i] : (cwceq @ (XA2 @ Xn) @ (cco @ (XY @ Xn) @ ccpi @ ccmin))) => ((! [Xn:$i] : (cwceq @ (XB2 @ Xn) @ (cco @ (XY @ Xn) @ ccpi @ ccaddc))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xy1 @ Xn) @ (ccmpt @ (^ [Xy1:$i] : (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccioo)) @ (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xy1 @ Xn) @ (ccmpt @ (^ [Xy1:$i] : (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccioo)) @ (^ [Xy1:$i] : (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul)))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XY @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwceq @ (cco @ (XY @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (ccfv @ (XY @ Xn) @ (ccfv @ (XN @ Xn) @ (XD @ Xn))) @ (cco @ (ccfv @ (XN @ Xn) @ (XD @ Xn)) @ (XY @ Xn) @ cclimc))))))))))))))))))))).
...
thf(adirkercncflem4_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (XY @ Xn) @ ccr))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwne @ (cco @ (XY @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XA2 @ Xy1 @ Xn) @ (ccfv @ (cco @ (XY @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ ccfl)))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XB2 @ Xy1 @ Xn) @ (cco @ (XA2 @ Xy1 @ Xn) @ cc1 @ ccaddc)))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XC @ Xn) @ (cco @ (XA2 @ Xy1 @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul)))) => ((! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XE @ Xn) @ (cco @ (XB2 @ Xy1 @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul)))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ (ccfv @ (XN @ Xn) @ (XD @ Xn)) @ (ccfv @ (XY @ Xn) @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccnp)))))))))))))))))))))).
...
thf(cdirkercncf_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XD @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))) => (! [Xn:$i] : (cwi @ (cwcel @ (XN @ Xn) @ ccn) @ (cwcel @ (ccfv @ (XN @ Xn) @ (XD @ Xn)) @ (cco @ ccr @ ccr @ cccncf)))))))).
