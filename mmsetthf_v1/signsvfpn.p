...
thf(asgnmulsgp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt) @ (cwbr @ ccc0 @ (cco @ (ccfv @ XA2 @ ccsgn) @ (ccfv @ XB2 @ ccsgn) @ ccmul) @ cclt)))))).
...
thf(amulne0bad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0)) => (cwi @ Xph @ (cwne @ XA2 @ ccc0))))))))).
...
thf(asgnsgn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccxr) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccsgn) @ ccsgn) @ (ccfv @ XA2 @ ccsgn))))).
thf(aeqeltrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => ((cwi @ Xph @ (cwcel @ XB2 @ XC)) => (cwi @ Xph @ (cwcel @ XA2 @ XC))))))))).
thf(asgnclre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ XA2 @ ccsgn) @ ccr)))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(asignsvtp_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_pd:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwceq @ (Xc_pd @ Xf1 @ Xi @ Xj @ Xn) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xb) @ ccc0) @ (ccv @ Xa) @ (ccv @ Xb)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XW @ Xj @ Xa @ Xb) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (Xc_pd @ Xf1 @ Xi @ Xj @ Xn)))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XT @ Xi) @ (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)) @ (^ [Xn:$i] : (cco @ (XW @ Xj @ Xa @ Xb) @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccsgn))) @ ccgsu)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo) @ (^ [Xj:$i] : (ccif @ (cwne @ (ccfv @ (ccv @ Xj) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xi))) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xi)))) @ cc1 @ ccc0)))))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwcel @ XE @ (ccdif @ (ccword @ ccr) @ (ccsn @ cc0)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwne @ (ccfv @ ccc0 @ XE) @ ccc0)))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwceq @ (XF @ Xj @ Xa @ Xb) @ (cco @ XE @ (ccs1 @ XA2) @ ccconcat))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwcel @ XA2 @ ccr)))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XN @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (ccfv @ XE @ cchash)))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XB2 @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (ccfv @ (cco @ (XN @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ cc1 @ ccmin) @ (ccfv @ XE @ (XT @ Xi)))))))))) => (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwbr @ ccc0 @ (cco @ XA2 @ (XB2 @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ ccmul) @ cclt)) @ (cwceq @ (ccfv @ (XF @ Xj @ Xa @ Xb) @ (XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb)) @ (ccfv @ XE @ (XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb))))))))))))))))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(csignsvfpn_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_pd:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwceq @ (Xc_pd @ Xf1 @ Xi @ Xj @ Xn) @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ (cwceq @ (ccv @ Xb) @ ccc0) @ (ccv @ Xa) @ (ccv @ Xb)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XW @ Xj @ Xa @ Xb) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (Xc_pd @ Xf1 @ Xi @ Xj @ Xn)))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XT @ Xi) @ (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)) @ (^ [Xn:$i] : (cco @ (XW @ Xj @ Xa @ Xb) @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccsgn))) @ ccgsu)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo) @ (^ [Xj:$i] : (ccif @ (cwne @ (ccfv @ (ccv @ Xj) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xi))) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xi)))) @ cc1 @ ccc0)))))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwcel @ XE @ (ccdif @ (ccword @ ccr) @ (ccsn @ cc0)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwne @ (ccfv @ ccc0 @ XE) @ ccc0)))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwceq @ (XF @ Xj @ Xa @ Xb) @ (cco @ XE @ (ccs1 @ XA2) @ ccconcat))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwcel @ XA2 @ ccr)))))))) => ((! [Xj:$i] : (cwceq @ (XN @ Xj) @ (ccfv @ XE @ cchash))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XB2 @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (ccfv @ (cco @ (XN @ Xj) @ cc1 @ ccmin) @ XE)))))))) => (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (Xph @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (cwbr @ ccc0 @ (cco @ (XB2 @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ XA2 @ ccmul) @ cclt)) @ (cwceq @ (ccfv @ (XF @ Xj @ Xa @ Xb) @ (XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb)) @ (ccfv @ XE @ (XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb))))))))))))))))))))))))))))))).
