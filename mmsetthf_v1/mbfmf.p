...
thf(cmbfmf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ ccmbfm))) => (cwi @ Xph @ (cwf @ (ccuni @ XS) @ (ccuni @ XT) @ XF)))))))))).
