...
thf(ahonegsubdi_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) @ (cwceq @ (cco @ (ccneg @ cc1) @ (cco @ XT @ XU @ cchod) @ cchot) @ (cco @ (cco @ (ccneg @ cc1) @ XT @ cchot) @ XU @ cchos)))))).
...
thf(chonegsubdi2_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) @ (cwceq @ (cco @ (ccneg @ cc1) @ (cco @ XT @ XU @ cchod) @ cchot) @ (cco @ XU @ XT @ cchod)))))).
