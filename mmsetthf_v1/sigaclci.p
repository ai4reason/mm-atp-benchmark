...
thf(aabrexdom2jm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) @ (cwbr @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) @ XA2 @ ccdom)))))))).
...
thf(aiundifdifd_thm,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (cwi @ (cwss @ XA2 @ (ccpw @ XO)) @ (cwi @ (cwne @ XA2 @ cc0) @ (cwceq @ (ccint @ XA2) @ (ccdif @ XO @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccdif @ XO @ (ccv @ Xx3))))))))))).
thf(csigaclci_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ XA2 @ (ccpw @ XS))) @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwne @ XA2 @ cc0))) @ (cwcel @ (ccint @ XA2) @ XS))))).
