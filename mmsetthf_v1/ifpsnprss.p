...
thf(a_1fpid3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwif @ Xph @ Xps @ Xch) @ Xch)))))).
...
thf(cifpsnprss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (cwi @ (cwif @ (cwceq @ XA2 @ XB2) @ (cwceq @ XE @ (ccsn @ XA2)) @ (cwss @ (ccpr @ XA2 @ XB2) @ XE)) @ (cwss @ (ccpr @ XA2 @ XB2) @ XE)))))).
