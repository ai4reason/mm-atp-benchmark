...
thf(cxporderlem_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (XT @ Xx3 @ Xy1 @ Xa @ Xb @ Xc @ Xd) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ (ccxp @ (XA2 @ Xa @ Xb @ Xc @ Xd) @ (XB2 @ Xa @ Xb @ Xc @ Xd))) @ (cwcel @ (ccv @ Xy1) @ (ccxp @ (XA2 @ Xa @ Xb @ Xc @ Xd) @ (XB2 @ Xa @ Xb @ Xc @ Xd)))) @ (cwo @ (cwbr @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ (XR @ Xa @ Xb @ Xc @ Xd)) @ (cwa @ (cwceq @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ (XS @ Xa @ Xb @ Xc @ Xd))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwb @ (cwbr @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (ccop @ (ccv @ Xc) @ (ccv @ Xd)) @ (XT @ Xx3 @ Xy1 @ Xa @ Xb @ Xc @ Xd)) @ (cwa @ (cwa @ (cwa @ (cwcel @ (ccv @ Xa) @ (XA2 @ Xa @ Xb @ Xc @ Xd)) @ (cwcel @ (ccv @ Xc) @ (XA2 @ Xa @ Xb @ Xc @ Xd))) @ (cwa @ (cwcel @ (ccv @ Xb) @ (XB2 @ Xa @ Xb @ Xc @ Xd)) @ (cwcel @ (ccv @ Xd) @ (XB2 @ Xa @ Xb @ Xc @ Xd)))) @ (cwo @ (cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ (XR @ Xa @ Xb @ Xc @ Xd)) @ (cwa @ (cwceq @ (ccv @ Xa) @ (ccv @ Xc)) @ (cwbr @ (ccv @ Xb) @ (ccv @ Xd) @ (XS @ Xa @ Xb @ Xc @ Xd))))))))))))))))))).
