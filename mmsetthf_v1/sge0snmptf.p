...
thf(csge0snmptf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xk) @ XA2) @ (cwceq @ (XB2 @ Xk) @ XC))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ XC))))))))))))).
