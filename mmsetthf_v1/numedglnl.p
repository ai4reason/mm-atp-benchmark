...
thf(aiedgedg_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwfun @ XE) @ (cwcel @ XI @ (ccdm @ XE))) @ (cwcel @ (ccfv @ XI @ XE) @ (ccfv @ XG @ ccedg)))))))).
thf(aupgredg_thm,axiom,(! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XE @ Xa @ Xb) @ (ccfv @ XG @ ccedg)))) => (! [Xa:$i] : (! [Xb:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XC @ (XE @ Xa @ Xb))) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwceq @ XC @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))))))))).
...
thf(a_3elpr2eq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XX @ (ccpr @ XA2 @ XB2)) @ (cwcel @ XY @ (ccpr @ XA2 @ XB2)) @ (cwcel @ XZ @ (ccpr @ XA2 @ XB2))) @ (cwa @ (cwne @ XY @ XX) @ (cwne @ XZ @ XX))) @ (cwceq @ XY @ XZ)))))))).
...
thf(aedglnl_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xv:$i] : (cwceq @ XV @ (ccfv @ (XG @ Xv) @ ccvtx))) => ((! [Xv:$i] : (! [Xi:$i] : (cwceq @ (XE @ Xi) @ (ccfv @ (XG @ Xv) @ cciedg)))) => (! [Xv:$i] : (cwi @ (cwa @ (cwcel @ (XG @ Xv) @ ccupgr) @ (cwcel @ XN @ XV)) @ (cwceq @ (ccun @ (cciun @ (^ [Xv:$i] : (ccdif @ XV @ (ccsn @ XN))) @ (^ [Xv:$i] : (ccrab @ (^ [Xi:$i] : (cwa @ (cwcel @ XN @ (ccfv @ (ccv @ Xi) @ (XE @ Xi))) @ (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xi) @ (XE @ Xi))))) @ (^ [Xi:$i] : (ccdm @ (XE @ Xi)))))) @ (ccrab @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ (XE @ Xi)) @ (ccsn @ XN))) @ (^ [Xi:$i] : (ccdm @ (XE @ Xi))))) @ (ccrab @ (^ [Xi:$i] : (cwcel @ XN @ (ccfv @ (ccv @ Xi) @ (XE @ Xi)))) @ (^ [Xi:$i] : (ccdm @ (XE @ Xi)))))))))))))).
thf(cnumedglnl_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccupgr) @ (cwa @ (cwcel @ XV @ ccfn) @ (cwcel @ XE @ ccfn)) @ (cwcel @ XN @ XV)) @ (cwceq @ (cco @ (ccsu @ (ccdif @ XV @ (ccsn @ XN)) @ (^ [Xv:$i] : (ccfv @ (ccrab @ (^ [Xi:$i] : (cwa @ (cwcel @ XN @ (ccfv @ (ccv @ Xi) @ XE)) @ (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xi) @ XE)))) @ (^ [Xi:$i] : (ccdm @ XE))) @ cchash))) @ (ccfv @ (ccrab @ (^ [Xi:$i] : (cwceq @ (ccfv @ (ccv @ Xi) @ XE) @ (ccsn @ XN))) @ (^ [Xi:$i] : (ccdm @ XE))) @ cchash) @ ccaddc) @ (ccfv @ (ccrab @ (^ [Xi:$i] : (cwcel @ XN @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE))) @ cchash)))))))))).
