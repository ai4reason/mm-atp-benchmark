...
thf(cseqp1i_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwcel @ XN @ XZ) => ((cwceq @ XK @ (cco @ XN @ cc1 @ ccaddc)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) @ XA2)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ XF) @ XB2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XK @ (ccseq @ Xc_pl @ XF @ XM)) @ (cco @ XA2 @ XB2 @ Xc_pl)))))))))))))))))).
