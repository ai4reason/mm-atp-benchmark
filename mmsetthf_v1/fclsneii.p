...
thf(cfclsneii_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) @ (cwcel @ XN @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei))) @ (cwcel @ XS @ XF)) @ (cwne @ (ccin @ XN @ XS) @ cc0)))))))).
