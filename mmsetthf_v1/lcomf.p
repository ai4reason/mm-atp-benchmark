...
thf(clcomf_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ XB2 @ (ccfv @ XW @ ccbs)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwf @ XI @ XK @ XG)) => ((cwi @ Xph @ (cwf @ XI @ XB2 @ XH)) => ((cwi @ Xph @ (cwcel @ XI @ XV)) => (cwi @ Xph @ (cwf @ XI @ XB2 @ (cco @ XG @ XH @ (ccof @ Xc_x))))))))))))))))))))))).
