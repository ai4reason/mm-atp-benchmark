...
thf(cltmul12a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ XA2 @ XB2 @ cclt))) @ (cwa @ (cwa @ (cwcel @ XC @ ccr) @ (cwcel @ XD @ ccr)) @ (cwa @ (cwbr @ ccc0 @ XC @ ccle) @ (cwbr @ XC @ XD @ cclt)))) @ (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ cclt))))))).
