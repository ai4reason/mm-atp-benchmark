...
thf(clplnnlelln_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XN @ (ccfv @ XK @ cclln)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XP) @ (cwcel @ XY @ XN)) @ (cwn @ (cwbr @ XX @ XY @ Xc_le))))))))))))).
