...
thf(cm2detleiblem6_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccpr @ cc1 @ cc2)) => ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((cwceq @ XY @ (ccfv @ XR @ cczrh)) => ((cwceq @ XS @ (ccfv @ XN @ ccpsgn)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ XI @ (ccfv @ XR @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwceq @ XQ @ (ccpr @ (ccop @ cc1 @ cc2) @ (ccop @ cc2 @ cc1)))) @ (cwceq @ (ccfv @ (ccfv @ XQ @ XS) @ XY) @ (ccfv @ Xc_1 @ XI)))))))))))))))))).
