...
thf(asinval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (ccfv @ XA2 @ ccsin) @ (cco @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ XA2 @ ccmul) @ cce) @ ccmin) @ (cco @ cc2 @ cci @ ccmul) @ ccdiv))))).
thf(csinper_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XK @ ccz)) @ (cwceq @ (ccfv @ (cco @ XA2 @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccaddc) @ ccsin) @ (ccfv @ XA2 @ ccsin)))))).
