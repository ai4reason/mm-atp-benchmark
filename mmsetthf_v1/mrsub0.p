...
thf(amrsubff_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwi @ (cwcel @ XT @ XW) @ (cwf @ (cco @ XR @ XV @ ccpm) @ (cco @ XR @ XR @ ccmap) @ XS))))))))))).
...
thf(amrsubrn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwceq @ (ccrn @ XS) @ (ccima @ XS @ (cco @ XR @ XV @ ccmap))))))))))).
...
thf(amrsubval_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XC @ (ccfv @ XT @ ccmcn)) => ((cwceq @ XV @ (ccfv @ XT @ ccmvar)) => ((cwceq @ XR @ (ccfv @ XT @ ccmrex)) => ((! [Xv:$i] : (cwceq @ (XS @ Xv) @ (ccfv @ XT @ ccmrsub))) => ((! [Xv:$i] : (cwceq @ (XG @ Xv) @ (ccfv @ (ccun @ XC @ XV) @ ccfrmd))) => (! [Xv:$i] : (cwi @ (cw3a @ (cwf @ XA2 @ XR @ XF) @ (cwss @ XA2 @ XV) @ (cwcel @ XX @ XR)) @ (cwceq @ (ccfv @ XX @ (ccfv @ XF @ (XS @ Xv))) @ (cco @ (XG @ Xv) @ (cccom @ (ccmpt @ (^ [Xv:$i] : (ccun @ XC @ XV)) @ (^ [Xv:$i] : (ccif @ (cwcel @ (ccv @ Xv) @ XA2) @ (ccfv @ (ccv @ Xv) @ XF) @ (ccs1 @ (ccv @ Xv))))) @ XX) @ ccgsu))))))))))))))))))).
...
thf(afrmd0_thm,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XM @ (ccfv @ XI @ ccfrmd)) => (cwceq @ cc0 @ (ccfv @ XM @ cc0g)))))).
thf(cwal_tp,type,(cwal : (($i > $o) > $o))).
thf(aeqeq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwb @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XC))))))))).
thf(afveq1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwceq @ XF @ XG) @ (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG))))))).
thf(cmrsub0_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XS @ (ccfv @ XT @ ccmrsub)) => (cwi @ (cwcel @ XF @ (ccrn @ XS)) @ (cwceq @ (ccfv @ cc0 @ XF) @ cc0))))))).
