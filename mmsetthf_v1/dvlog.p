...
thf(alogdmopn_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ XD @ (ccfv @ cccnfld @ cctopn))))).
...
thf(adf_log_ax,axiom,(cwceq @ cclog @ (cccnv @ (ccres @ cce @ (ccima @ (cccnv @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)))))).
...
thf(afuncnvres2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfun @ XF) @ (cwceq @ (cccnv @ (ccres @ (cccnv @ XF) @ XA2)) @ (ccres @ XF @ (ccima @ (cccnv @ XF) @ XA2))))))).
...
thf(alogrncn_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccrn @ cclog)) @ (cwcel @ XA2 @ ccc)))).
...
thf(alogcn_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccres @ cclog @ XD) @ (cco @ XD @ ccc @ cccncf))))).
...
thf(advloglem_thm,axiom,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccima @ cclog @ XD) @ (ccfv @ cccnfld @ cctopn))))).
...
thf(cdvlog_conj,conjecture,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwceq @ (cco @ ccc @ (ccres @ cclog @ XD) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccv @ Xx3) @ ccdiv))))))).
