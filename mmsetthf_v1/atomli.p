...
thf(ahatomic_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwne @ XA2 @ cc0h)) @ (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccat))))).
...
thf(aibd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwi @ Xps @ (cwb @ Xps @ Xch))) => (cwi @ Xph @ (cwi @ Xps @ Xch))))))).
...
thf(apjoml3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwi @ (cwss @ XB2 @ XA2) @ (cwceq @ (ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) @ XB2)))))).
...
thf(catomli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwi @ (cwcel @ XB2 @ ccat) @ (cwcel @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ XA2 @ ccort)) @ (ccun @ ccat @ (ccsn @ cc0h)))))))).
