...
thf(anmfn0_thm,axiom,(cwceq @ (ccfv @ (ccxp @ cchil @ (ccsn @ ccc0)) @ ccnmf) @ ccc0)).
thf(afveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF))))))).
thf(abra0_thm,axiom,(cwceq @ (ccfv @ cc0v @ ccbr) @ (ccxp @ cchil @ (ccsn @ ccc0)))).
thf(anorm0_thm,axiom,(cwceq @ (ccfv @ cc0v @ ccno) @ ccc0)).
thf(cbranmfn_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ cchil) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ ccbr) @ ccnmf) @ (ccfv @ XA2 @ ccno))))).
