...
thf(clflsc0N_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XD @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XD @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XD @ ccmulr)) => ((cwceq @ Xc_0 @ (ccfv @ XD @ cc0g)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XX @ XK)) => (cwi @ Xph @ (cwceq @ (cco @ (ccxp @ XV @ (ccsn @ Xc_0)) @ (ccxp @ XV @ (ccsn @ XX)) @ (ccof @ Xc_x)) @ (ccxp @ XV @ (ccsn @ Xc_0)))))))))))))))))))).
