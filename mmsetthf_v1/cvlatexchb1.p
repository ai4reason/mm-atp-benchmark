...
thf(asyl3anr3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwi @ Xph @ Xta) => ((cwi @ (cwa @ Xch @ (cw3a @ Xps @ Xth @ Xta)) @ Xet) => (cwi @ (cwa @ Xch @ (cw3a @ Xps @ Xth @ Xph)) @ Xet)))))))))).
...
thf(ccvlatexchb1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cclc) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwne @ XP @ XR)) @ (cwb @ (cwbr @ XP @ (cco @ XR @ XQ @ Xc_or) @ Xc_le) @ (cwceq @ (cco @ XR @ XP @ Xc_or) @ (cco @ XR @ XQ @ Xc_or))))))))))))))).
