...
thf(adf_cart_ax,axiom,(cwceq @ cccart @ (ccdif @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv) @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ (ccpprod @ ccep @ ccep) @ ccvv)))))).
...
thf(abrpprod3b_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => (cwb @ (cwbr @ XX @ (ccop @ XY @ XZ) @ (ccpprod @ XR @ XS)) @ (cwex @ (^ [Xz:$i] : (cwex @ (^ [Xw:$i] : (cw3a @ (cwceq @ XX @ (ccop @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwbr @ (ccv @ Xz) @ XY @ XR) @ (cwbr @ (ccv @ Xw) @ XZ @ XS)))))))))))))))).
...
thf(cbrcart_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (cwb @ (cwbr @ (ccop @ XA2 @ XB2) @ XC @ cccart) @ (cwceq @ XC @ (ccxp @ XA2 @ XB2)))))))))).
