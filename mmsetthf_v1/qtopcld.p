...
thf(cqtopcld_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwfo @ XX @ XY @ XF)) @ (cwb @ (cwcel @ XA2 @ (ccfv @ (cco @ XJ @ XF @ ccqtop) @ cccld)) @ (cwa @ (cwss @ XA2 @ XY) @ (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ (ccfv @ XJ @ cccld))))))))))).
