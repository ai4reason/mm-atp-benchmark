...
thf(asdom0_thm,axiom,(! [XA2:($i > $o)] : (cwn @ (cwbr @ XA2 @ cc0 @ ccsdm)))).
...
thf(a_0sdom1dom_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwbr @ cc0 @ XA2 @ ccsdm) @ (cwbr @ cc1o @ XA2 @ ccdom)))).
...
thf(aabrexexg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) @ (cwcel @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))) @ ccvv)))))))).
...
thf(aabrexco_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xw:$i] : (cwcel @ (XB2 @ Xx3 @ Xw) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xw)) @ (cwceq @ (XC @ Xx3 @ Xy1 @ Xz) @ (XD @ Xx3 @ Xz @ Xw))))))) => (! [Xz:$i] : (cwceq @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwceq @ (ccv @ Xx3) @ (XC @ Xx3 @ Xy1 @ Xz))) @ (^ [Xy1:$i] : (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xz) @ (XB2 @ Xx3 @ Xw))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xw))))))))) @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xw:$i] : (cwceq @ (ccv @ Xx3) @ (XD @ Xx3 @ Xz @ Xw))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xw)))))))))))))).
thf(cciin_tp,type,(cciin : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(acfslb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cw3a @ (cwlim @ XA2) @ (cwss @ XB2 @ XA2) @ (cwceq @ (ccuni @ XB2) @ XA2)) @ (cwbr @ (ccfv @ XA2 @ cccf) @ XB2 @ ccdom)))))).
...
thf(crankcf_conj,conjecture,(! [XA2:($i > $o)] : (cwn @ (cwbr @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccrnk) @ cccf) @ ccsdm)))).
