...
thf(croot1eq1_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccz)) @ (cwb @ (cwceq @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ XK @ ccexp) @ cc1) @ (cwbr @ XN @ XK @ ccdvds)))))).
