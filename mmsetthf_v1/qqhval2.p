...
thf(aqqhval_thm,axiom,(! [Xc_dv:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_dv @ Xx3 @ Xy1) @ (ccfv @ XR @ ccdvr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (Xc_1 @ Xx3 @ Xy1) @ (ccfv @ XR @ ccur)))) => ((! [Xx3:$i] : (cwceq @ (XL @ Xx3) @ (ccfv @ XR @ cczrh))) => (cwi @ (cwcel @ XR @ ccvv) @ (cwceq @ (ccfv @ XR @ ccqqh) @ (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccima @ (cccnv @ (XL @ Xx3)) @ (ccfv @ XR @ ccui)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv) @ (cco @ (ccfv @ (ccv @ Xx3) @ (XL @ Xx3)) @ (ccfv @ (ccv @ Xy1) @ (XL @ Xx3)) @ (Xc_dv @ Xx3 @ Xy1))))))))))))))))).
...
thf(azrhunitpreima_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0)) @ (cwceq @ (ccima @ (cccnv @ XL) @ (ccfv @ XR @ ccui)) @ (ccdif @ ccz @ (ccsn @ ccc0)))))))))))).
...
thf(cqqhval2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0)) @ (cwceq @ (ccfv @ XR @ ccqqh) @ (ccmpt @ (^ [Xq:$i] : ccq) @ (^ [Xq:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xq) @ ccnumer) @ XL) @ (ccfv @ (ccfv @ (ccv @ Xq) @ ccdenom) @ XL) @ Xc_dv))))))))))))).
