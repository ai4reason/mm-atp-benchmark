...
thf(aliminflelimsupuz_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ ccxr @ XF)) => (cwi @ Xph @ (cwbr @ (ccfv @ XF @ cclsi) @ (ccfv @ XF @ cclsp) @ ccle)))))))))).
...
thf(climinflimsupclim_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XF)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XF @ cclsi) @ ccr)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XF @ cclsp) @ (ccfv @ XF @ cclsi) @ ccle)) => (cwi @ Xph @ (cwcel @ XF @ (ccdm @ ccli))))))))))))).
