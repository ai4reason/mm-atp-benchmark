...
thf(ahashf1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwceq @ (ccfv @ (ccab @ (^ [Xf1:$i] : (cwf1 @ XA2 @ XB2 @ (ccv @ Xf1)))) @ cchash) @ (cco @ (ccfv @ (ccfv @ XA2 @ cchash) @ ccfa) @ (cco @ (ccfv @ XB2 @ cchash) @ (ccfv @ XA2 @ cchash) @ ccbc) @ ccmul)))))).
...
thf(chashfac_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccfn) @ (cwceq @ (ccfv @ (ccab @ (^ [Xf1:$i] : (cwf1o @ XA2 @ XA2 @ (ccv @ Xf1)))) @ cchash) @ (ccfv @ (ccfv @ XA2 @ cchash) @ ccfa))))).
