...
thf(acarageniuncl_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccfv @ XO @ cccaragen))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xn:$i] : (cwi @ Xph @ (cwf @ XZ @ (XS @ Xn) @ XE))) => (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ (XS @ Xn)))))))))))))))).
...
thf(ccaragenunicl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => ((cwi @ Xph @ (cwss @ XX @ XS)) => ((cwi @ Xph @ (cwbr @ XX @ ccom @ ccdom)) => (cwi @ Xph @ (cwcel @ (ccuni @ XX) @ XS))))))))))).
