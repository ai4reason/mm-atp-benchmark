...
thf(afveqdmss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdm @ XB2)) => (cwi @ (cw3a @ (cwfun @ XB2) @ (cwnel @ cc0 @ (ccrn @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) @ (cwss @ XD @ (ccdm @ XA2)))))))).
...
thf(anelrnfvne_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwfun @ XF) @ (cwcel @ XX @ (ccdm @ XF)) @ (cwnel @ XY @ (ccrn @ XF))) @ (cwne @ (ccfv @ XX @ XF) @ XY)))))).
...
thf(afvn0ssdmfun_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwral @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XF) @ cc0)) @ (^ [Xa:$i] : XD)) @ (cwa @ (cwss @ XD @ (ccdm @ XF)) @ (cwfun @ (ccres @ XF @ XD))))))).
...
thf(cfveqressseq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwceq @ XD @ (ccdm @ XB2)) => (cwi @ (cw3a @ (cwfun @ XB2) @ (cwnel @ cc0 @ (ccrn @ XB2)) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) @ (cwceq @ (ccres @ XA2 @ XD) @ XB2))))))).
