...
thf(ctendocoval_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cwceq @ XE @ (ccfv @ XW @ (ccfv @ XK @ cctendo))) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ XX) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XU @ XE) @ (cwcel @ XV @ XE)) @ (cwcel @ XF @ XT)) @ (cwceq @ (ccfv @ XF @ (cccom @ XU @ XV)) @ (ccfv @ (ccfv @ XF @ XV) @ XU)))))))))))))))).
