...
thf(adih1dimb2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XB2 @ Xf1) @ (ccfv @ XK @ ccbs))) => ((! [Xh:$i] : (cwceq @ (Xc_le @ Xh) @ (ccfv @ XK @ ccple))) => ((! [Xh:$i] : (cwceq @ (XA2 @ Xh) @ (ccfv @ XK @ ccatm))) => ((! [Xh:$i] : (cwceq @ (XH @ Xh) @ (ccfv @ XK @ cclh))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XO @ Xf1 @ Xh) @ (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ (XB2 @ Xf1))))))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XU @ Xf1 @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XI @ Xf1 @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdih))))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XN @ Xf1 @ Xh) @ (ccfv @ (XU @ Xf1 @ Xh) @ cclspn)))) => (! [Xh:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ (XH @ Xh))) @ (cwa @ (cwcel @ (XQ @ Xh) @ (XA2 @ Xh)) @ (cwbr @ (XQ @ Xh) @ XW @ (Xc_le @ Xh)))) @ (cwrex @ (^ [Xf1:$i] : (cwa @ (cwne @ (ccv @ Xf1) @ (ccres @ ccid @ (XB2 @ Xf1))) @ (cwceq @ (ccfv @ (XQ @ Xh) @ (XI @ Xf1 @ Xh)) @ (ccfv @ (ccsn @ (ccop @ (ccv @ Xf1) @ (XO @ Xf1 @ Xh))) @ (XN @ Xf1 @ Xh))))) @ (^ [Xf1:$i] : XT)))))))))))))))))))))))))).
...
thf(adih1dimc_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XP @ (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (cwceq @ (XI @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((! [Xf1:$i] : (cwceq @ (XU @ Xf1) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xf1:$i] : (cwceq @ (XN @ Xf1) @ (ccfv @ (XU @ Xf1) @ cclspn))) => ((! [Xf1:$i] : (cwceq @ (XF @ Xf1) @ (ccrio @ (^ [Xf1:$i] : (cwceq @ (ccfv @ XP @ (ccv @ Xf1)) @ XQ)) @ (^ [Xf1:$i] : XT)))) => (! [Xf1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le)))) @ (cwceq @ (ccfv @ XQ @ (XI @ Xf1)) @ (ccfv @ (ccsn @ (ccop @ (XF @ Xf1) @ (ccres @ ccid @ XT))) @ (XN @ Xf1))))))))))))))))))))))))))).
...
thf(cdihatlat_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwceq @ XL @ (ccfv @ XU @ cclsa)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwcel @ XQ @ XA2)) @ (cwcel @ (ccfv @ XQ @ XI) @ XL)))))))))))))))).
