...
thf(anqereu_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwreu @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ cceq)) @ (^ [Xx3:$i] : ccnq))))).
...
thf(cenqeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccnq) @ (cwcel @ XB2 @ ccnq) @ (cwbr @ XA2 @ XB2 @ cceq)) @ (cwceq @ XA2 @ XB2))))).
