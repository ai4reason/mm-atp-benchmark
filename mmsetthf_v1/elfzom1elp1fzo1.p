...
thf(celfzom1elp1fzo1_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ cc1 @ XN @ ccfzo)))))).
