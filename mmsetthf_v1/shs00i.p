...
thf(ashs0i_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => (cwceq @ (cco @ XA2 @ cc0h @ ccph) @ XA2)))).
...
thf(cshs00i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwb @ (cwa @ (cwceq @ XA2 @ cc0h) @ (cwceq @ XB2 @ cc0h)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccph) @ cc0h))))))).
