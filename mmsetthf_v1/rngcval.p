...
thf(adf_rngc_ax,axiom,(cwceq @ ccrngc @ (ccmpt @ (^ [Xu:$i] : ccvv) @ (^ [Xu:$i] : (cco @ (ccfv @ (ccv @ Xu) @ ccestrc) @ (ccres @ ccrngh @ (ccxp @ (ccin @ (ccv @ Xu) @ ccrng) @ (ccin @ (ccv @ Xu) @ ccrng))) @ ccresc))))).
...
thf(crngcval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XC @ (ccfv @ XU @ ccrngc)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccin @ XU @ ccrng))) => ((cwi @ Xph @ (cwceq @ XH @ (ccres @ ccrngh @ (ccxp @ XB2 @ XB2)))) => (cwi @ Xph @ (cwceq @ XC @ (cco @ (ccfv @ XU @ ccestrc) @ XH @ ccresc)))))))))))))).
