...
thf(cmarepvcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (cco @ XN @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XA2 @ ccbs)) => ((cwceq @ XV @ (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cw3a @ (cwcel @ XM @ XB2) @ (cwcel @ XC @ XV) @ (cwcel @ XK @ XN))) @ (cwcel @ (ccfv @ XK @ (cco @ XM @ XC @ (cco @ XN @ XR @ ccmatrepV))) @ XB2)))))))))))))).
