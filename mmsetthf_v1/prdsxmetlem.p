...
thf(aisxmet2d_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XX @ ccvv)) => ((cwi @ Xph @ (cwf @ (ccxp @ XX @ XX) @ ccxr @ XD)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccle)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX))) @ (cwb @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccc0 @ ccle) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cw3a @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX)) @ (cwa @ (cwcel @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XD) @ ccr) @ (cwcel @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XD) @ ccr))) @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XD) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XD) @ ccaddc) @ ccle))))) => (cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)))))))))))).
...
thf(aprdsdsf_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XR @ Xx3))) @ ccprds))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccfv @ (XY @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccres @ (ccfv @ (XR @ Xx3) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ (XD @ Xx3) @ (ccfv @ (XY @ Xx3) @ ccds))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xx3) @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XI @ (XX @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XR @ Xx3) @ (XZ @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ ccxmt)))) => (! [Xx3:$i] : (cwi @ Xph @ (cwf @ (ccxp @ (XB2 @ Xx3) @ (XB2 @ Xx3)) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XD @ Xx3)))))))))))))))))))))))))).
...
thf(cprdsxmetlem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XR @ Xx3))) @ ccprds))) => ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XY @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XV @ Xx3) @ (ccfv @ (XR @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccres @ (ccfv @ (XR @ Xx3) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : (cwceq @ XD @ (ccfv @ (XY @ Xx3) @ ccds))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xx3) @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XI @ (XX @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XR @ Xx3) @ (XZ @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XI)) @ (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ ccxmt)))) => (cwi @ Xph @ (cwcel @ XD @ (ccfv @ XB2 @ ccxmt))))))))))))))))))))))))).
