...
thf(ccofurid_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((cwceq @ XI @ (ccfv @ XC @ ccidfu)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XI @ cccofu) @ XF)))))))))).
