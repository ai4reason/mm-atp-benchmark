...
thf(crisefacp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrisefac) @ (cco @ (cco @ XA2 @ XN @ ccrisefac) @ (cco @ XA2 @ XN @ ccaddc) @ ccmul)))))).
