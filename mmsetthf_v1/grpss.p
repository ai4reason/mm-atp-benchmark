...
thf(astrss_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : ((cwcel @ XT @ ccvv) => ((cwfun @ XT) => ((cwss @ XS @ XT) => ((cwceq @ XE @ (ccslot @ (ccfv @ ccnx @ XE))) => ((cwcel @ (ccop @ (ccfv @ ccnx @ XE) @ XC) @ XS) => (cwceq @ (ccfv @ XT @ XE) @ (ccfv @ XS @ XE)))))))))))).
...
thf(cgrpss_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl))) => ((cwcel @ XR @ ccvv) => ((cwss @ XG @ XR) => ((cwfun @ XR) => (cwb @ (cwcel @ XG @ ccgrp) @ (cwcel @ XR @ ccgrp))))))))))).
