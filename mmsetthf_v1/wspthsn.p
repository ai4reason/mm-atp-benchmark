...
thf(cwspthsn_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xf1:$i] : (cwceq @ (cco @ (XN @ Xf1) @ XG @ ccwwspthsn) @ (ccrab @ (^ [Xw:$i] : (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xw) @ (ccfv @ XG @ ccspths))))) @ (^ [Xw:$i] : (cco @ (XN @ Xf1) @ XG @ ccwwlksn)))))))).
