...
thf(adf_mnd_ax,axiom,(cwceq @ ccmnd @ (ccrab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xp:$i] : (cwrex @ (^ [Xe:$i] : (cwral @ (^ [Xx3:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xe) @ (ccv @ Xx3) @ (ccv @ Xp)) @ (ccv @ Xx3)) @ (cwceq @ (cco @ (ccv @ Xx3) @ (ccv @ Xe) @ (ccv @ Xp)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (^ [Xe:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xg1) @ ccplusg))) @ (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xg1:$i] : ccsgrp)))).
thf(cismnddef_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xe:$i] : (! [Xa:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xe @ Xa) @ ccbs)))) => ((! [Xe:$i] : (! [Xa:$i] : (cwceq @ Xc_pl @ (ccfv @ (XG @ Xe @ Xa) @ ccplusg)))) => (! [Xe:$i] : (! [Xa:$i] : (cwb @ (cwcel @ (XG @ Xe @ Xa) @ ccmnd) @ (cwa @ (cwcel @ (XG @ Xe @ Xa) @ ccsgrp) @ (cwrex @ (^ [Xe:$i] : (cwral @ (^ [Xa:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xe) @ (ccv @ Xa) @ Xc_pl) @ (ccv @ Xa)) @ (cwceq @ (cco @ (ccv @ Xa) @ (ccv @ Xe) @ Xc_pl) @ (ccv @ Xa)))) @ (^ [Xa:$i] : XB2))) @ (^ [Xe:$i] : XB2)))))))))))).
