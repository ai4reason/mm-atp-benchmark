...
thf(cpsgnran_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XP @ (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((cwceq @ XS @ (ccfv @ XN @ ccpsgn)) => (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XQ @ XP)) @ (cwcel @ (ccfv @ XQ @ XS) @ (ccpr @ cc1 @ (ccneg @ cc1))))))))))).
