...
thf(adifrab0eq_thm,axiom,(! [Xph:($i > $o)] : (! [XV:($i > $o)] : (cwb @ (cwceq @ (ccdif @ XV @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XV))) @ cc0) @ (cwceq @ XV @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XV))))))).
