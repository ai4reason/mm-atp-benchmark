...
thf(acvrexch_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwbr @ (cco @ XX @ XY @ Xc_an) @ XY @ XC) @ (cwbr @ XX @ (cco @ XX @ XY @ Xc_or) @ XC))))))))))))))).
...
thf(allncvrlpln2_thm,axiom,(! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => ((cwceq @ XN @ (ccfv @ XK @ cclln)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XP)) @ (cwbr @ XX @ XY @ Xc_le)) @ (cwbr @ XX @ XY @ XC)))))))))))))).
...
thf(alplncvrlvol_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XC @ (ccfv @ XK @ cccvr)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => ((cwceq @ XV @ (ccfv @ XK @ cclvol)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwbr @ XX @ XY @ XC)) @ (cwb @ (cwcel @ XX @ XP) @ (cwcel @ XY @ XV))))))))))))))).
thf(c_2lplnmj_conj,conjecture,(! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XN @ (ccfv @ XK @ cclln)) => ((cwceq @ XP @ (ccfv @ XK @ cclpl)) => ((cwceq @ XV @ (ccfv @ XK @ cclvol)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XP) @ (cwcel @ XY @ XP)) @ (cwb @ (cwcel @ (cco @ XX @ XY @ Xc_an) @ XN) @ (cwcel @ (cco @ XX @ XY @ Xc_or) @ XV))))))))))))))))).
