...
thf(cupgr1wlkdlem1_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccs2 @ XX @ XY)) => ((cwceq @ XF @ (ccs1 @ XJ)) => ((cwi @ Xph @ (cwcel @ XX @ (ccfv @ XG @ ccvtx))) => ((cwi @ Xph @ (cwcel @ XY @ (ccfv @ XG @ ccvtx))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XJ @ (ccfv @ XG @ cciedg)) @ (ccpr @ XX @ XY))) => (cwi @ (cwa @ Xph @ (cwceq @ XX @ XY)) @ (cwceq @ (ccfv @ XJ @ (ccfv @ XG @ cciedg)) @ (ccsn @ XX)))))))))))))))).
