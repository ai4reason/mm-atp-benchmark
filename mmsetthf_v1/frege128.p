...
thf(afrege127_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ XU) => ((cwcel @ XY @ XV) => ((cwcel @ XM @ XW) => ((cwcel @ XR @ XS) => (cwi @ (cwfun @ (cccnv @ (cccnv @ XR))) @ (cwi @ (cwbr @ XY @ XM @ (ccfv @ XR @ cctcl)) @ (cwi @ (cwbr @ XY @ XX @ XR) @ (cwi @ (cwn @ (cwbr @ XX @ XM @ (ccfv @ XR @ cctcl))) @ (cwbr @ XM @ XX @ (ccun @ (ccfv @ XR @ cctcl) @ ccid))))))))))))))))))).
thf(afrege51_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (cwi @ (cwi @ Xph @ (cwi @ Xps @ Xch)) @ (cwi @ (cwi @ Xth @ Xch) @ (cwi @ Xph @ (cwi @ (cwi @ (cwn @ Xps) @ Xth) @ Xch))))))))).
