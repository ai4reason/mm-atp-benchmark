...
thf(amplmon2cl_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XP @ Xy1 @ Xf1) @ (cco @ (XI @ Xy1) @ (XR @ Xf1) @ ccmpl)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XD @ Xf1) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ (XI @ Xy1) @ ccmap)))))) => ((! [Xf1:$i] : (cwceq @ (Xc_0 @ Xf1) @ (ccfv @ (XR @ Xf1) @ cc0g))) => ((! [Xf1:$i] : (cwceq @ (XC @ Xf1) @ (ccfv @ (XR @ Xf1) @ ccbs))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XI @ Xy1) @ (XW @ Xy1 @ Xf1))))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XR @ Xf1) @ ccrg))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ (XB2 @ Xy1 @ Xf1) @ (ccfv @ (XP @ Xy1 @ Xf1) @ ccbs)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XX @ Xf1) @ (XC @ Xf1)))) => ((! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ XK @ (XD @ Xf1)))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (ccmpt @ (^ [Xy1:$i] : (XD @ Xf1)) @ (^ [Xy1:$i] : (ccif @ (cwceq @ (ccv @ Xy1) @ XK) @ (XX @ Xf1) @ (Xc_0 @ Xf1)))) @ (XB2 @ Xy1 @ Xf1)))))))))))))))))))))))))).
...
thf(cevlslem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_ex:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwceq @ (XP @ Xx3 @ Xh @ Xp @ Xb) @ (cco @ (XI @ Xx3 @ Xp @ Xb) @ (XR @ Xh @ Xp @ Xb) @ ccmpl)))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwceq @ (XB2 @ Xx3 @ Xh @ Xb) @ (ccfv @ (XP @ Xx3 @ Xh @ Xp @ Xb) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (cwceq @ (XC @ Xx3 @ Xh @ Xp) @ (ccfv @ (XS @ Xx3 @ Xh) @ ccbs))))) => ((! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwceq @ (XK @ Xh @ Xp @ Xb) @ (ccfv @ (XR @ Xh @ Xp @ Xb) @ ccbs))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwceq @ (XD @ Xh) @ (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ (XI @ Xx3 @ Xp @ Xb) @ ccmap)))))))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwceq @ (XT @ Xx3 @ Xh) @ (ccfv @ (XS @ Xx3 @ Xh) @ ccmgp)))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwceq @ (Xc_ex @ Xx3 @ Xh) @ (ccfv @ (XT @ Xx3 @ Xh) @ ccmg)))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwceq @ (Xc_x @ Xx3 @ Xh) @ (ccfv @ (XS @ Xx3 @ Xh) @ ccmulr)))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwceq @ (XV @ Xx3 @ Xh @ Xp @ Xb) @ (cco @ (XI @ Xx3 @ Xp @ Xb) @ (XR @ Xh @ Xp @ Xb) @ ccmvr)))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwceq @ (XE @ Xx3 @ Xh @ Xp @ Xb) @ (ccmpt @ (^ [Xp:$i] : (XB2 @ Xx3 @ Xh @ Xb)) @ (^ [Xp:$i] : (cco @ (XS @ Xx3 @ Xh) @ (ccmpt @ (^ [Xb:$i] : (XD @ Xh)) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xb) @ (ccv @ Xp)) @ (XF @ Xx3 @ Xh)) @ (cco @ (XT @ Xx3 @ Xh) @ (cco @ (ccv @ Xb) @ (XG @ Xx3 @ Xh) @ (ccof @ (Xc_ex @ Xx3 @ Xh))) @ ccgsu) @ (Xc_x @ Xx3 @ Xh)))) @ ccgsu)))))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwcel @ (XI @ Xx3 @ Xp @ Xb) @ ccvv)))))) => ((! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwcel @ (XR @ Xh @ Xp @ Xb) @ cccrg))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwcel @ (XS @ Xx3 @ Xh) @ cccrg))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwcel @ (XF @ Xx3 @ Xh) @ (cco @ (XR @ Xh @ Xp @ Xb) @ (XS @ Xx3 @ Xh) @ ccrh))))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwf @ (XI @ Xx3 @ Xp @ Xb) @ (XC @ Xx3 @ Xh @ Xp) @ (XG @ Xx3 @ Xh))))))) => ((! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwceq @ (Xc_0 @ Xh) @ (ccfv @ (XR @ Xh @ Xp @ Xb) @ cc0g))))) => ((! [Xh:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwcel @ XA2 @ (XD @ Xh))))) => ((! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwcel @ (XH @ Xh) @ (XK @ Xh @ Xp @ Xb)))))) => (! [Xx3:$i] : (! [Xh:$i] : (! [Xp:$i] : (! [Xb:$i] : (cwi @ (Xph @ Xh @ Xp) @ (cwceq @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : (XD @ Xh)) @ (^ [Xx3:$i] : (ccif @ (cwceq @ (ccv @ Xx3) @ XA2) @ (XH @ Xh) @ (Xc_0 @ Xh)))) @ (XE @ Xx3 @ Xh @ Xp @ Xb)) @ (cco @ (ccfv @ (XH @ Xh) @ (XF @ Xx3 @ Xh)) @ (cco @ (XT @ Xx3 @ Xh) @ (cco @ XA2 @ (XG @ Xx3 @ Xh) @ (ccof @ (Xc_ex @ Xx3 @ Xh))) @ ccgsu) @ (Xc_x @ Xx3 @ Xh)))))))))))))))))))))))))))))))))))))))))))))).
