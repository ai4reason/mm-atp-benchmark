...
thf(cdisjxpin_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xp) @ cc1st)) @ (cwceq @ (XC @ Xx3 @ Xy1) @ (XE @ Xy1 @ Xp)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xp) @ cc2nd)) @ (cwceq @ (XD @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xp)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xp) @ (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xp) @ (cwdisj @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (XD @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xp) @ (cwdisj @ (^ [Xp:$i] : (ccxp @ (XA2 @ Xy1) @ (XB2 @ Xx3))) @ (^ [Xp:$i] : (ccin @ (XE @ Xy1 @ Xp) @ (XF @ Xx3 @ Xp)))))))))))))))))))).
