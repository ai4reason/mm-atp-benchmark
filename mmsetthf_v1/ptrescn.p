...
thf(aresixp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwss @ XB2 @ XA2) @ (cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) @ (cwcel @ (ccres @ XF @ XB2) @ (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))).
...
thf(aptval2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xw:$i] : (! [Xu:$i] : (! [Xk:$i] : (cwceq @ (XJ @ Xw @ Xu @ Xk) @ (ccfv @ XF @ ccpt))))) => ((! [Xw:$i] : (! [Xu:$i] : (! [Xk:$i] : (cwceq @ (XX @ Xu @ Xk) @ (ccuni @ (XJ @ Xw @ Xu @ Xk)))))) => ((! [Xw:$i] : (! [Xu:$i] : (! [Xk:$i] : (cwceq @ (XG @ Xw @ Xu @ Xk) @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xu:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccima @ (cccnv @ (ccmpt @ (^ [Xw:$i] : (XX @ Xu @ Xk)) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xw))))) @ (ccv @ Xu))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF)) @ (cwceq @ (XJ @ Xw @ Xu @ Xk) @ (ccfv @ (ccfv @ (ccun @ (ccsn @ (XX @ Xu @ Xk)) @ (ccrn @ (XG @ Xw @ Xu @ Xk))) @ ccfi) @ cctg)))))))))))))))).
thf(cptrescn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XX @ (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XF @ ccpt))) => ((cwceq @ XK @ (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF) @ (cwss @ XB2 @ XA2)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XB2))) @ (cco @ (XJ @ Xx3) @ XK @ cccn))))))))))))))).
