...
thf(ccdlemn2a_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xh:$i] : (cwceq @ (XB2 @ Xh) @ (ccfv @ XK @ ccbs))) => ((! [Xf1:$i] : (cwceq @ (Xc_le @ Xf1) @ (ccfv @ XK @ ccple))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (Xc_or @ Xf1 @ Xh) @ (ccfv @ XK @ ccjn)))) => ((! [Xf1:$i] : (cwceq @ (XA2 @ Xf1) @ (ccfv @ XK @ ccatm))) => ((! [Xf1:$i] : (cwceq @ (XH @ Xf1) @ (ccfv @ XK @ cclh))) => ((cwceq @ XT @ (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XR @ Xf1 @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ cctrl))))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XO @ Xf1 @ Xh) @ (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccres @ ccid @ (XB2 @ Xh))))))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XI @ Xf1 @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdib))))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XU @ Xf1 @ Xh) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XN @ Xf1 @ Xh) @ (ccfv @ (XU @ Xf1 @ Xh) @ cclspn)))) => ((! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XF @ Xf1 @ Xh) @ (ccrio @ (^ [Xh:$i] : (cwceq @ (ccfv @ (XQ @ Xf1) @ (ccv @ Xh)) @ (XS @ Xf1))) @ (^ [Xh:$i] : XT))))) => (! [Xf1:$i] : (! [Xh:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ (XH @ Xf1))) @ (cw3a @ (cwa @ (cwcel @ (XQ @ Xf1) @ (XA2 @ Xf1)) @ (cwn @ (cwbr @ (XQ @ Xf1) @ XW @ (Xc_le @ Xf1)))) @ (cwa @ (cwcel @ (XS @ Xf1) @ (XA2 @ Xf1)) @ (cwn @ (cwbr @ (XS @ Xf1) @ XW @ (Xc_le @ Xf1)))) @ (cwa @ (cwcel @ (XX @ Xf1 @ Xh) @ (XB2 @ Xh)) @ (cwbr @ (XX @ Xf1 @ Xh) @ XW @ (Xc_le @ Xf1)))) @ (cwbr @ (XS @ Xf1) @ (cco @ (XQ @ Xf1) @ (XX @ Xf1 @ Xh) @ (Xc_or @ Xf1 @ Xh)) @ (Xc_le @ Xf1))) @ (cwss @ (ccfv @ (ccsn @ (ccop @ (XF @ Xf1 @ Xh) @ (XO @ Xf1 @ Xh))) @ (XN @ Xf1 @ Xh)) @ (ccfv @ (XX @ Xf1 @ Xh) @ (XI @ Xf1 @ Xh)))))))))))))))))))))))))))))))))))).
