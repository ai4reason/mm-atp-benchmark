...
thf(aswrdccat2_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2))) @ (cwceq @ (cco @ (cco @ XS @ XT @ ccconcat) @ (ccop @ (ccfv @ XS @ cchash) @ (cco @ (ccfv @ XS @ cchash) @ (ccfv @ XT @ cchash) @ ccaddc)) @ ccsubstr) @ XT)))))).
...
thf(cccatopth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XA2 @ (ccword @ XX)) @ (cwcel @ XB2 @ (ccword @ XX))) @ (cwa @ (cwcel @ XC @ (ccword @ XX)) @ (cwcel @ XD @ (ccword @ XX))) @ (cwceq @ (ccfv @ XA2 @ cchash) @ (ccfv @ XC @ cchash))) @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccconcat) @ (cco @ XC @ XD @ ccconcat)) @ (cwa @ (cwceq @ XA2 @ XC) @ (cwceq @ XB2 @ XD)))))))))).
