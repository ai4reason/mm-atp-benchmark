...
thf(auhgr0edg0rgr_thm,axiom,(! [XG:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccuhgr) @ (cwceq @ (ccfv @ XG @ ccedg) @ cc0)) @ (cwbr @ XG @ ccc0 @ ccrgr)))).
thf(cuhgr0edg0rgrb_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccuhgr) @ (cwb @ (cwbr @ XG @ ccc0 @ ccrgr) @ (cwceq @ (ccfv @ XG @ ccedg) @ cc0))))).
