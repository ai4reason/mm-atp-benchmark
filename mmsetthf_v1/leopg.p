...
thf(adf_leop_ax,axiom,(cwceq @ ccleo @ (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cwa @ (cwcel @ (cco @ (ccv @ Xu) @ (ccv @ Xt) @ cchod) @ ccho) @ (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (cco @ (ccfv @ (ccv @ Xx3) @ (cco @ (ccv @ Xu) @ (ccv @ Xt) @ cchod)) @ (ccv @ Xx3) @ ccsp) @ ccle)) @ (^ [Xx3:$i] : cchil)))))))).
thf(cleopg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ XA2) @ (cwcel @ XU @ XB2)) @ (cwb @ (cwbr @ XT @ XU @ ccleo) @ (cwa @ (cwcel @ (cco @ XU @ XT @ cchod) @ ccho) @ (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (cco @ (ccfv @ (ccv @ Xx3) @ (cco @ XU @ XT @ cchod)) @ (ccv @ Xx3) @ ccsp) @ ccle)) @ (^ [Xx3:$i] : cchil)))))))))).
