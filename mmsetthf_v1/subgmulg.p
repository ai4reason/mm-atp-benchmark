...
thf(csubgmulg_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ XH @ (cco @ XG @ XS @ ccress)) => ((cwceq @ Xc_xb @ (ccfv @ XH @ ccmg)) => (cwi @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XS)) @ (cwceq @ (cco @ XN @ XX @ Xc_x) @ (cco @ XN @ XX @ Xc_xb)))))))))))))).
