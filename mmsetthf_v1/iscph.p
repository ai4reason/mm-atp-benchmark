...
thf(adf_cph_ax,axiom,(cwceq @ cccph @ (ccrab @ (^ [Xw:$i] : (cwsbc @ (^ [Xf1:$i] : (cwsbc @ (^ [Xk:$i] : (cw3a @ (cwceq @ (ccv @ Xf1) @ (cco @ cccnfld @ (ccv @ Xk) @ ccress)) @ (cwss @ (ccima @ ccsqrt @ (ccin @ (ccv @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico))) @ (ccv @ Xk)) @ (cwceq @ (ccfv @ (ccv @ Xw) @ ccnm) @ (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ ccbs)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccip)) @ ccsqrt)))))) @ (ccfv @ (ccv @ Xf1) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ ccsca))) @ (^ [Xw:$i] : (ccin @ ccphl @ ccnlm))))).
