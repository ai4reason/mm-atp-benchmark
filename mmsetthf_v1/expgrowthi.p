...
thf(cexpgrowthi_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XS @ (ccpr @ ccr @ ccc)))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XK @ ccc))) => ((! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwcel @ XC @ ccc))) => ((! [Xt:$i] : (cwceq @ (XY @ Xt) @ (ccmpt @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (cco @ XC @ (ccfv @ (cco @ XK @ (ccv @ Xt) @ ccmul) @ cce) @ ccmul))))) => (! [Xt:$i] : (cwi @ (Xph @ Xt) @ (cwceq @ (cco @ XS @ (XY @ Xt) @ ccdv) @ (cco @ (ccxp @ XS @ (ccsn @ XK)) @ (XY @ Xt) @ (ccof @ ccmul))))))))))))))).
