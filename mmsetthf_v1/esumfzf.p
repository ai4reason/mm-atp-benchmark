...
thf(cesumfzf_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : (cwi @ (cwa @ (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xk)) @ (cwcel @ XN @ ccn)) @ (cwceq @ (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) @ (ccfv @ XN @ (ccseq @ ccxad @ (XF @ Xk) @ cc1))))))))).
