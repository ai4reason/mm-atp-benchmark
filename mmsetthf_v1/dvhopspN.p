...
thf(cdvhopspN_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xs1:$i] : (cwceq @ (XS @ Xf1 @ Xs1) @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xf1:$i] : XE)) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccxp @ XT @ XE))) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (ccv @ Xs1)) @ (cccom @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xf1) @ cc2nd))))))))) => (! [Xf1:$i] : (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ (XR @ Xf1 @ Xs1) @ XE) @ (cwa @ (cwcel @ (XF @ Xf1 @ Xs1) @ XT) @ (cwcel @ (XU @ Xf1 @ Xs1) @ XE))) @ (cwceq @ (cco @ (XR @ Xf1 @ Xs1) @ (ccop @ (XF @ Xf1 @ Xs1) @ (XU @ Xf1 @ Xs1)) @ (XS @ Xf1 @ Xs1)) @ (ccop @ (ccfv @ (XF @ Xf1 @ Xs1) @ (XR @ Xf1 @ Xs1)) @ (cccom @ (XR @ Xf1 @ Xs1) @ (XU @ Xf1 @ Xs1))))))))))))))).
