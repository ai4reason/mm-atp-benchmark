...
thf(afsnunf2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwf @ (ccdif @ XS @ (ccsn @ XX)) @ XT @ XF) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XT)) @ (cwf @ XS @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))))))))))).
...
thf(cfsets_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwa @ (cwcel @ XF @ XV) @ (cwf @ XA2 @ XB2 @ XF)) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2)) @ (cwf @ XA2 @ XB2 @ (cco @ XF @ (ccop @ XX @ XY) @ ccsts)))))))))).
