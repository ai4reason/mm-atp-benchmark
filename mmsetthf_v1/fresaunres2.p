...
thf(cfresaunres2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cw3a @ (cwf @ XA2 @ XC @ XF) @ (cwf @ XB2 @ XC @ XG) @ (cwceq @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccres @ XG @ (ccin @ XA2 @ XB2)))) @ (cwceq @ (ccres @ (ccun @ XF @ XG) @ XB2) @ XG)))))))).
