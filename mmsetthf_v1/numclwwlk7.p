...
thf(anumclwwlk6_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cw3a @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn)) @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) @ (cwceq @ (cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) @ (cco @ (ccfv @ XV @ cchash) @ XP @ ccmo))))))))).
...
thf(afrrusgrord_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) @ (cwi @ (cwa @ (cwcel @ XG @ ccfrgr) @ (cwbr @ XG @ XK @ ccrusgr)) @ (cwceq @ (ccfv @ XV @ cchash) @ (cco @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ cc1 @ ccaddc))))))))).
thf(anumclwwlk7lem_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwa @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XG @ ccfrgr)) @ (cwa @ (cwne @ XV @ cc0) @ (cwcel @ XV @ ccfn))) @ (cwcel @ XK @ ccn0))))))).
...
thf(amulmoddvds_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwi @ (cwbr @ XN @ XA2 @ ccdvds) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ ccmo) @ ccc0))))))).
...
thf(amodaddabs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccrp)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XC @ ccmo) @ (cco @ XB2 @ XC @ ccmo) @ ccaddc) @ XC @ ccmo) @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccmo))))))).
thf(asyl5eq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwi @ Xph @ (cwceq @ XB2 @ XC)) => (cwi @ Xph @ (cwceq @ XA2 @ XC))))))))).
thf(aoveq1i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ XB2) => (cwceq @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF)))))))).
thf(a_0p1e1_thm,axiom,(cwceq @ (cco @ ccc0 @ cc1 @ ccaddc) @ cc1)).
thf(asyl2anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => ((cwi @ (cwa @ Xps @ Xch) @ Xth) => (cwi @ Xph @ Xth))))))))).
thf(cnumclwwlk7_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cw3a @ (cwa @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XG @ ccfrgr)) @ (cwa @ (cwne @ XV @ cc0) @ (cwcel @ XV @ ccfn)) @ (cwa @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) @ (cwceq @ (cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) @ cc1)))))))).
