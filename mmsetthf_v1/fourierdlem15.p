...
thf(afz0fzelfz0_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ (cco @ ccc0 @ XR @ ccfz)) @ (cwcel @ XM @ (cco @ XN @ XR @ ccfz))) @ (cwcel @ XM @ (cco @ ccc0 @ XR @ ccfz))))))).
