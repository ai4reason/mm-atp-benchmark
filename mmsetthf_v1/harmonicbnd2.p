...
thf(charmonicbnd2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ cclog) @ ccmin) @ (cco @ (cco @ cc1 @ (ccfv @ cc2 @ cclog) @ ccmin) @ ccem @ ccicc))))).
