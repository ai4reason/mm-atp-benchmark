...
thf(akmlem5_thm,axiom,(! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) @ (cwne @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwceq @ (ccin @ (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz))))) @ (ccdif @ (ccv @ Xw) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xw)))))) @ cc0)))))).
...
thf(ckmlem9_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (cwceq @ (XA2 @ Xx3 @ Xu @ Xt) @ (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xt:$i] : (cwceq @ (ccv @ Xu) @ (ccdif @ (ccv @ Xt) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xt))))))) @ (^ [Xt:$i] : (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwne @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccin @ (ccv @ Xz) @ (ccv @ Xw)) @ cc0))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xu @ Xt)))) @ (^ [Xz:$i] : (XA2 @ Xx3 @ Xu @ Xt))))))))).
