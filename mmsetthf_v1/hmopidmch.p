...
thf(ahmopidmchi_thm,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccho) => ((cwceq @ (cccom @ XT @ XT) @ XT) => (cwcel @ (ccrn @ XT) @ ccch))))).
...
thf(chmopidmch_conj,conjecture,(! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XT @ ccho) @ (cwceq @ (cccom @ XT @ XT) @ XT)) @ (cwcel @ (ccrn @ XT) @ ccch)))).
