...
thf(aisf34lem7_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccfin3) @ (cwf @ ccom @ (ccpw @ XA2) @ (XG @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ (XG @ Xx3)) @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ (XG @ Xx3)))) @ (^ [Xy1:$i] : ccom))) @ (cwcel @ (ccuni @ (ccrn @ (XG @ Xx3))) @ (ccrn @ (XG @ Xx3)))))))))).
...
thf(apwexb_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccvv) @ (cwcel @ (ccpw @ XA2) @ ccvv)))).
...
thf(aisf34lem4_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwa @ (cwss @ (XX @ Xx3) @ (ccpw @ XA2)) @ (cwne @ (XX @ Xx3) @ cc0))) @ (cwceq @ (ccfv @ (ccuni @ (XX @ Xx3)) @ (XF @ Xx3)) @ (ccint @ (ccima @ (XF @ Xx3) @ (XX @ Xx3)))))))))))).
...
thf(aisfin3_3_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xf1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xf1)) @ (cwb @ (cwcel @ XA2 @ ccfin3) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : ccom)) @ (cwcel @ (ccint @ (ccrn @ (ccv @ Xf1))) @ (ccrn @ (ccv @ Xf1))))) @ (^ [Xf1:$i] : (cco @ (ccpw @ XA2) @ ccom @ ccmap))))))))).
thf(cisf34lem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xf1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xf1)) @ (cwb @ (cwcel @ XA2 @ ccfin3) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : ccom)) @ (cwcel @ (ccuni @ (ccrn @ (ccv @ Xf1))) @ (ccrn @ (ccv @ Xf1))))) @ (^ [Xf1:$i] : (cco @ (ccpw @ XA2) @ ccom @ ccmap))))))))))).
