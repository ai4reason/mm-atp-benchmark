...
thf(cexpcl2lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwss @ XF @ ccc) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XF) @ (cwcel @ (ccv @ Xy1) @ XF)) @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XF)))) => ((cwcel @ cc1 @ XF) => ((! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xx3) @ XF) @ (cwne @ (ccv @ Xx3) @ ccc0)) @ (cwcel @ (cco @ cc1 @ (ccv @ Xx3) @ ccdiv) @ XF))) => (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ XF) @ (cwne @ XA2 @ ccc0) @ (cwcel @ (XB2 @ Xy1) @ ccz)) @ (cwcel @ (cco @ XA2 @ (XB2 @ Xy1) @ ccexp) @ XF))))))))))).
