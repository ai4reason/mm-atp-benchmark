...
thf(coelim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwa @ (cwcel @ XB2 @ (XC @ Xx3)) @ (cwlim @ XB2))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccoe) @ (cciun @ (^ [Xx3:$i] : (ccdif @ XB2 @ cc1o)) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoe)))))))))).
