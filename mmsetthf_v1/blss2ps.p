...
thf(axblss2ps_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => ((cwi @ Xph @ (cwcel @ XP @ XX)) => ((cwi @ Xph @ (cwcel @ XQ @ XX)) => ((cwi @ Xph @ (cwcel @ XR @ ccxr)) => ((cwi @ Xph @ (cwcel @ XS @ ccxr)) => ((cwi @ Xph @ (cwcel @ (cco @ XP @ XQ @ XD) @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ (ccxne @ XR) @ ccxad) @ ccle)) => (cwi @ Xph @ (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))))))))))).
...
thf(apsmetlecl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwa @ (cwcel @ XC @ ccr) @ (cwbr @ (cco @ XA2 @ XB2 @ XD) @ XC @ ccle))) @ (cwcel @ (cco @ XA2 @ XB2 @ XD) @ ccr)))))))).
...
thf(cblss2ps_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XP @ XX) @ (cwcel @ XQ @ XX)) @ (cw3a @ (cwcel @ XR @ ccr) @ (cwcel @ XS @ ccr) @ (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ XR @ ccmin) @ ccle))) @ (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))).
