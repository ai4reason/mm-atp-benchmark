...
thf(aharmonicbnd2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwcel @ (cco @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ cclog) @ ccmin) @ (cco @ (cco @ cc1 @ (ccfv @ cc2 @ cclog) @ ccmin) @ ccem @ ccicc))))).
...
thf(charmonicbnd3_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (cco @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ cclog) @ ccmin) @ (cco @ ccc0 @ ccem @ ccicc))))).
