...
thf(adf_mpq_ax,axiom,(cwceq @ ccmpq @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ ccnpi @ ccnpi))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ ccnpi @ ccnpi))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ ccmi) @ (cco @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ ccmi))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aopex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (ccop @ XA2 @ XB2) @ ccvv)))).
thf(cmulpipq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi))) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmpq) @ (ccop @ (cco @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc1st) @ ccmi) @ (cco @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XB2 @ cc2nd) @ ccmi))))))).
