...
thf(ccoprmdvdsb_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XN @ ccz) @ (cwa @ (cwcel @ XM @ ccz) @ (cwceq @ (cco @ XK @ XM @ ccgcd) @ cc1))) @ (cwb @ (cwbr @ XK @ XN @ ccdvds) @ (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds))))))).
