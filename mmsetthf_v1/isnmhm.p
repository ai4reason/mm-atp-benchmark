...
thf(cisnmhm_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwcel @ XF @ (cco @ XS @ XT @ ccnmhm)) @ (cwa @ (cwa @ (cwcel @ XS @ ccnlm) @ (cwcel @ XT @ ccnlm)) @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm))))))))).
