...
thf(aac5b_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwral @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XA2 @ (ccuni @ XA2) @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(cacunirnmpt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xy1 @ Xf1) @ (XV @ Xy1 @ Xf1 @ Xj)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ (XA2 @ Xy1 @ Xf1))) @ (cwne @ (XB2 @ Xy1 @ Xf1 @ Xj) @ cc0))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwceq @ XC @ (ccrn @ (ccmpt @ (^ [Xj:$i] : (XA2 @ Xy1 @ Xf1)) @ (^ [Xj:$i] : (XB2 @ Xy1 @ Xf1 @ Xj))))))) => (cwi @ Xph @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ XC @ (ccuni @ XC) @ (ccv @ Xf1)) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xj:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (XB2 @ Xy1 @ Xf1 @ Xj))) @ (^ [Xj:$i] : (XA2 @ Xy1 @ Xf1)))) @ (^ [Xy1:$i] : XC))))))))))))))).
