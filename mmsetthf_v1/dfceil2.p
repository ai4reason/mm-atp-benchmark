...
thf(adf_ceil_ax,axiom,(cwceq @ ccceil @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccneg @ (ccv @ Xx3)) @ ccfl)))))).
...
thf(azbtwnre_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwreu @ (^ [Xx3:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccv @ Xx3) @ (cco @ XA2 @ cc1 @ ccaddc) @ cclt))) @ (^ [Xx3:$i] : ccz))))).
thf(cwtru_tp,type,(cwtru : $o)).
thf(azriotaneg_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccneg @ (ccv @ Xy1))) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1))))) => (cwi @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccz)) @ (cwceq @ (ccrio @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccz)) @ (ccneg @ (ccrio @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : ccz))))))))).
...
thf(cdfceil2_conj,conjecture,(cwceq @ ccceil @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) @ (cwbr @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ cclt))) @ (^ [Xy1:$i] : ccz)))))).
