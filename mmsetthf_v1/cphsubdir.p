...
thf(aipsubdir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => ((cwceq @ XS @ (ccfv @ XF @ ccsg)) => (cwi @ (cwa @ (cwcel @ XW @ ccphl) @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ Xc_mi) @ XC @ Xc_xi) @ (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ XS)))))))))))))))))).
...
thf(aclmsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (ccfv @ XW @ ccsca)) => ((cwceq @ XK @ (ccfv @ XF @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XW @ ccclm) @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XK)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XA2 @ XB2 @ (ccfv @ XF @ ccsg)))))))))))).
thf(ccphsubdir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_xi @ (ccfv @ XW @ ccip)) => ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XW @ ccsg)) => (cwi @ (cwa @ (cwcel @ XW @ cccph) @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ Xc_mi) @ XC @ Xc_xi) @ (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ ccmin)))))))))))))).
