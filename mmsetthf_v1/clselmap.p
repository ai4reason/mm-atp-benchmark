...
thf(aclsf2_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XK @ (ccfv @ XJ @ cccl)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwf @ (ccpw @ XX) @ (ccpw @ XX) @ XK)))))))).
...
thf(cclselmap_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ XK @ (ccfv @ XJ @ cccl)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ (cco @ (ccpw @ XX) @ (ccpw @ XX) @ ccmap))))))))).
