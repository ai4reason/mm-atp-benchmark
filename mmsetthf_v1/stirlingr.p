...
thf(astirling_thm,axiom,(! [XS:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (ccfv @ (ccv @ Xn) @ (XS @ Xn)) @ ccdiv))) @ cc1 @ ccli)))).
...
thf(aclimreeq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XR @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cclm)) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwf @ XZ @ ccr @ XF)) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XA2 @ XR) @ (cwbr @ XF @ XA2 @ ccli)))))))))))))).
...
thf(cstirlingr_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XS @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : (cwceq @ (XR @ Xn) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cclm))) => (! [Xn:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (ccfv @ (ccv @ Xn) @ (XS @ Xn)) @ ccdiv))) @ cc1 @ (XR @ Xn)))))))).
