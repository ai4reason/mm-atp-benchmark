...
thf(adfafn5a_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwfn @ XF @ XA2) @ (cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccafv @ (ccv @ Xx3) @ XF)))))))).
...
thf(cdfafn5b_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccafv @ (ccv @ Xx3) @ XF) @ (XV @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwb @ (cwfn @ XF @ XA2) @ (cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccafv @ (ccv @ Xx3) @ XF)))))))))).
