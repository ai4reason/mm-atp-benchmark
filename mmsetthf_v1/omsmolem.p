...
thf(comsmolem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccom) @ (cwi @ (cwa @ (cwa @ (cwss @ (XA2 @ Xx3) @ ccon0) @ (cwf @ ccom @ (XA2 @ Xx3) @ XF)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF))) @ (^ [Xx3:$i] : ccom))) @ (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwcel @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))))))))))).
