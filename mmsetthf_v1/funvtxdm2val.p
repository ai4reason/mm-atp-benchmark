...
thf(cfunvtxdm2val_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwi @ (cw3a @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) @ (cwne @ XA2 @ XB2) @ (cwss @ (ccpr @ XA2 @ XB2) @ (ccdm @ XG))) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ ccbs))))))))).
