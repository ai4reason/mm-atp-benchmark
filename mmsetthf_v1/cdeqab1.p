...
thf(ccdeqab1_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwcdeq @ (cwb @ (Xph @ Xx3) @ (Xps @ Xy1)) @ Xx3 @ Xy1))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwcdeq @ (cwceq @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccab @ (^ [Xy1:$i] : (Xps @ Xy1)))) @ Xx3 @ Xy1))))))).
