...
thf(cumgrfn_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwfn @ (XE @ Xx3) @ (XA2 @ Xx3))) @ (cwf @ (XA2 @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (XE @ Xx3))))))))))).
