...
thf(cimaiinfv_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwa @ (cwfn @ XF @ (XA2 @ Xx3)) @ (cwss @ XB2 @ (XA2 @ Xx3))) @ (cwceq @ (cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) @ (ccint @ (ccima @ XF @ XB2))))))))).
