...
thf(cfrlmval_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ XI @ ccfrlm)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XI @ XW)) @ (cwceq @ XF @ (cco @ XR @ (ccxp @ XI @ (ccsn @ (ccfv @ XR @ ccrglmod))) @ ccdsmm)))))))))).
