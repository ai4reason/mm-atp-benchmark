...
thf(apmtrdifellem4_thm,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XT @ (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccpmtr))) => ((cwceq @ XR @ (ccrn @ (ccfv @ XN @ ccpmtr))) => ((cwceq @ XS @ (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ XN @ ccpmtr))) => (cwi @ (cwa @ (cwcel @ XQ @ XT) @ (cwcel @ XK @ XN)) @ (cwceq @ (ccfv @ XK @ XS) @ XK)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(cpmtrdifwrdel2lem1_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XT @ (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ (XK @ Xx3))) @ ccpmtr)))) => ((! [Xi:$i] : (cwceq @ (XR @ Xi) @ (ccrn @ (ccfv @ XN @ ccpmtr)))) => ((! [Xx3:$i] : (! [Xi:$i] : (cwceq @ (XU @ Xx3 @ Xi) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xx3) @ XW) @ ccid)) @ (ccfv @ XN @ ccpmtr))))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XT)) @ (cwcel @ (XK @ Xx3) @ XN)) @ (cwral @ (^ [Xi:$i] : (cwceq @ (ccfv @ (XK @ Xx3) @ (ccfv @ (ccv @ Xi) @ (XU @ Xx3 @ Xi))) @ (XK @ Xx3))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))))))))))))))).
