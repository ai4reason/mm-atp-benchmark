...
thf(ar10_thm,axiom,(cwceq @ (ccfv @ cc0 @ ccr1) @ cc0)).
...
thf(apwtr_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwtr @ XA2) @ (cwtr @ (ccpw @ XA2))))).
...
thf(atriun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwi @ (cwral @ (^ [Xx3:$i] : (cwtr @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwtr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
thf(aancoms_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xch) => (cwi @ (cwa @ Xps @ Xph) @ Xch)))))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ar1limg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ ccr1)) @ (cwlim @ XA2)) @ (cwceq @ (ccfv @ XA2 @ ccr1) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccr1))))))).
