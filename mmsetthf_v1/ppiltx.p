...
thf(appival2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccz) @ (cwceq @ (ccfv @ XA2 @ ccppi) @ (ccfv @ (ccin @ (cco @ cc2 @ XA2 @ ccfz) @ ccprime) @ cchash))))).
...
thf(appieq0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccppi) @ ccc0) @ (cwbr @ XA2 @ cc2 @ cclt))))).
...
thf(cppiltx_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwbr @ (ccfv @ XA2 @ ccppi) @ XA2 @ cclt)))).
