...
thf(aliminfreuzlem_thm,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xj:$i] : (cwi @ Xph @ (cwf @ XZ @ ccr @ (XF @ Xj)))) => (! [Xj:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccfv @ (XF @ Xj) @ cclsi) @ ccr) @ (cwa @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr))))))))))))))).
...
thf(climinfreuz_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwcel @ (XM @ Xx3 @ Xj @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xj @ Xk) @ ccuz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwf @ XZ @ ccr @ (XF @ Xj)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (Xph @ Xx3 @ Xj @ Xk) @ (cwb @ (cwcel @ (ccfv @ (XF @ Xj) @ cclsi) @ ccr) @ (cwa @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr))))))))))))))))).
