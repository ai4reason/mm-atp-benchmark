...
thf(achtppilimlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ cclt)) => ((cwi @ Xph @ (cwcel @ XN @ (cco @ cc2 @ ccpnf @ ccico))) => ((cwi @ Xph @ (cwbr @ (cco @ (cco @ XN @ XA2 @ cccxp) @ (ccfv @ XN @ ccppi) @ ccdiv) @ (cco @ cc1 @ XA2 @ ccmin) @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XN @ cclog) @ ccmul) @ ccmul) @ (ccfv @ XN @ cccht) @ cclt)))))))))).
thf(asimprl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xps))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xch))))).
thf(cchtppilimlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwbr @ XA2 @ cc1 @ cclt)) => (cwi @ Xph @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ ccle) @ (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccppi) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccht) @ cclt))) @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)))) @ (^ [Xz:$i] : ccr)))))))).
