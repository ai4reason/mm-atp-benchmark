...
thf(cislly2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xj) @ XA2) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xj)))) @ (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ ccrest) @ XA2)))) => ((! [Xx3:$i] : (! [Xj:$i] : (cwceq @ (XX @ Xx3 @ Xj) @ (ccuni @ XJ)))) => (! [Xx3:$i] : (! [Xj:$i] : (cwi @ Xph @ (cwb @ (cwcel @ XJ @ (cclly @ XA2)) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)) @ (cwcel @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ XA2))) @ (^ [Xu:$i] : XJ))) @ (^ [Xy1:$i] : (XX @ Xx3 @ Xj))))))))))))))).
