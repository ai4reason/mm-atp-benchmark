...
thf(climcres_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XC @ XA2)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwceq @ XK @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XJ @ (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ (ccun @ XC @ (ccsn @ XB2)) @ (ccfv @ XJ @ ccnt)))) => (cwi @ Xph @ (cwceq @ (cco @ (ccres @ XF @ XC) @ XB2 @ cclimc) @ (cco @ XF @ XB2 @ cclimc))))))))))))))))).
