...
thf(csalunicl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XT @ (ccpw @ XS))) => ((cwi @ Xph @ (cwbr @ XT @ ccom @ ccdom)) => (cwi @ Xph @ (cwcel @ (ccuni @ XT) @ XS))))))))).
