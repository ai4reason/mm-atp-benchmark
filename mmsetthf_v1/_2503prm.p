...
thf(apockthi_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XP @ ccprime) => ((cwcel @ XG @ ccn) => ((cwceq @ XM @ (cco @ XG @ XP @ ccmul)) => ((cwceq @ XN @ (cco @ XM @ cc1 @ ccaddc)) => ((cwcel @ XD @ ccn) => ((cwcel @ XE @ ccn) => ((cwcel @ XA2 @ ccn) => ((cwceq @ XM @ (cco @ XD @ (cco @ XP @ XE @ ccexp) @ ccmul)) => ((cwbr @ XD @ (cco @ XP @ XE @ ccexp) @ cclt) => ((cwceq @ (cco @ (cco @ XA2 @ XM @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo)) => ((cwceq @ (cco @ (cco @ (cco @ XA2 @ XG @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) @ cc1) => (cwcel @ XN @ ccprime)))))))))))))))))))).
thf(a_139prm_thm,axiom,(cwcel @ (ccdc @ (ccdc @ cc1 @ cc3) @ cc9) @ ccprime)).
...
thf(a_2503lem2_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => (cwceq @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) @ (cco @ cc1 @ XN @ ccmo))))).
thf(cwn_tp,type,(cwn : ($o > $o))).
thf(a_2503lem3_thm,axiom,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => (cwceq @ (cco @ (cco @ (cco @ cc2 @ (ccdc @ cc1 @ cc8) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) @ cc1)))).
thf(c_2503prm_conj,conjecture,(! [XN:($i > $o)] : ((cwceq @ XN @ (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => (cwcel @ XN @ ccprime)))).
