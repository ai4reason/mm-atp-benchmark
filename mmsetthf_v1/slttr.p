...
thf(cslttr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XC @ ccsur)) @ (cwi @ (cwa @ (cwbr @ XA2 @ XB2 @ ccslt) @ (cwbr @ XB2 @ XC @ ccslt)) @ (cwbr @ XA2 @ XC @ ccslt))))))).
