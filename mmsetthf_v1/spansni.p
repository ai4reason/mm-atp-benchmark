...
thf(aspanssoc_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwss @ XA2 @ cchil) @ (cwss @ (ccfv @ XA2 @ ccspn) @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccort))))).
...
thf(cspansni_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => (cwceq @ (ccfv @ (ccsn @ XA2) @ ccspn) @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccort) @ ccort))))).
