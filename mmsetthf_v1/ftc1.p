...
thf(cftc1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XG @ Xx3 @ Xt) @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((cwi @ Xph @ (cwss @ XD @ ccr)) => ((cwi @ Xph @ (cwcel @ XF @ ccibl)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => ((! [Xx3:$i] : (! [Xt:$i] : (cwi @ Xph @ (cwcel @ XF @ (ccfv @ XC @ (cco @ (XK @ Xx3 @ Xt) @ (XL @ Xt) @ cccnp)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XJ @ Xx3 @ Xt) @ (cco @ (XL @ Xt) @ ccr @ ccrest)))) => ((! [Xx3:$i] : (! [Xt:$i] : (cwceq @ (XK @ Xx3 @ Xt) @ (cco @ (XL @ Xt) @ XD @ ccrest)))) => ((! [Xt:$i] : (cwceq @ (XL @ Xt) @ (ccfv @ cccnfld @ cctopn))) => (! [Xx3:$i] : (! [Xt:$i] : (cwi @ Xph @ (cwbr @ XC @ (ccfv @ XC @ XF) @ (cco @ ccr @ (XG @ Xx3 @ Xt) @ ccdv)))))))))))))))))))))))))))).
