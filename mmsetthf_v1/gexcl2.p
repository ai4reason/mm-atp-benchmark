...
thf(agexcl3_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => ((! [Xx3:$i] : (cwceq @ (XO @ Xx3) @ (ccfv @ XG @ ccod))) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XO @ Xx3)) @ (cco @ cc1 @ XN @ ccfz))) @ (^ [Xx3:$i] : XX))) @ (cwcel @ XE @ ccn))))))))))).
thf(cgexcl2_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn)) @ (cwcel @ XE @ ccn)))))))).
