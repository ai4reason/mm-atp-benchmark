...
thf(annmordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) @ (cwcel @ cc0 @ XC)) @ (cwi @ (cwcel @ XA2 @ XB2) @ (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
...
thf(annm0r_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccom) @ (cwceq @ (cco @ cc0 @ XA2 @ ccomu) @ cc0)))).
...
thf(cnnmord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) @ (cwb @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwcel @ cc0 @ XC)) @ (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
