...
thf(crescabs2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ XV)) => ((cwi @ Xph @ (cwfn @ XJ @ (ccxp @ XT @ XT))) => ((cwi @ Xph @ (cwcel @ XS @ XW)) => ((cwi @ Xph @ (cwss @ XT @ XS)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XC @ XS @ ccress) @ XJ @ ccresc) @ (cco @ XC @ XJ @ ccresc))))))))))))))).
