...
thf(abj_restsn_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XY @ XV) @ (cwcel @ XA2 @ XW)) @ (cwceq @ (cco @ (ccsn @ XY) @ XA2 @ ccrest) @ (ccsn @ (ccin @ XY @ XA2))))))))).
thf(abiimpa_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(aeqeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwceq @ XC @ XA2) @ (cwceq @ XC @ XB2))))))).
thf(cbj_restsnss2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwss @ XY @ XA2)) @ (cwceq @ (cco @ (ccsn @ XY) @ XA2 @ ccrest) @ (ccsn @ XY))))))).
