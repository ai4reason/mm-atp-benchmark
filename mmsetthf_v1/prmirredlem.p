...
thf(airredn1_thm,axiom,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ ccir)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XI)) @ (cwne @ XX @ Xc_1))))))))).
...
thf(airredmul_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XI @ (ccfv @ XR @ ccir)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XU @ (ccfv @ XR @ ccui)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI)) @ (cwo @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XU))))))))))))))).
...
thf(cprmirredlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : ((cwceq @ XI @ (ccfv @ czring @ ccir)) => (cwi @ (cwcel @ XA2 @ ccn) @ (cwb @ (cwcel @ XA2 @ XI) @ (cwcel @ XA2 @ ccprime))))))).
