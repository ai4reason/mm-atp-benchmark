...
thf(aprmgaplem1_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) @ (cwbr @ XI @ (cco @ (ccfv @ XN @ ccfa) @ XI @ ccaddc) @ ccdvds))))).
...
thf(ancoprmgcdgt1b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn)) @ (cwb @ (cwrex @ (^ [Xi:$i] : (cwa @ (cwbr @ (ccv @ Xi) @ XA2 @ ccdvds) @ (cwbr @ (ccv @ Xi) @ XB2 @ ccdvds))) @ (^ [Xi:$i] : (ccfv @ cc2 @ ccuz))) @ (cwbr @ cc1 @ (cco @ XA2 @ XB2 @ ccgcd) @ cclt)))))).
thf(cprmgaplem2_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) @ (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ ccfa) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
