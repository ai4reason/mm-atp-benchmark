...
thf(cfwddifnval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwss @ XA2 @ ccc)) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ XN @ ccfz))) @ (cwcel @ (cco @ XX @ (ccv @ Xk) @ ccaddc) @ XA2))) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ (cco @ XN @ XF @ ccfwddifn)) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ ccexp) @ (ccfv @ (cco @ XX @ (ccv @ Xk) @ ccaddc) @ XF) @ ccmul) @ ccmul)))))))))))))))).
