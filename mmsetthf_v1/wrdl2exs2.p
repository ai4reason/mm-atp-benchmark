...
thf(cwrdl2exs2_conj,conjecture,(! [XS:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XS)) @ (cwceq @ (ccfv @ XW @ cchash) @ cc2)) @ (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xt:$i] : (cwceq @ XW @ (ccs2 @ (ccv @ Xs1) @ (ccv @ Xt)))) @ (^ [Xt:$i] : XS))) @ (^ [Xs1:$i] : XS)))))).
