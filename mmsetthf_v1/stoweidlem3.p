...
thf(cstoweidlem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwnfc @ (^ [Xi:$i] : (XF @ Xi))) => ((cwnf @ (^ [Xi:$i] : (Xph @ Xi))) => ((! [Xi:$i] : (cwceq @ (XX @ Xi) @ (ccseq @ ccmul @ (XF @ Xi) @ cc1))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XM @ ccn))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwf @ (cco @ cc1 @ XM @ ccfz) @ ccr @ (XF @ Xi)))) => ((! [Xi:$i] : (cwi @ (cwa @ (Xph @ Xi) @ (cwcel @ (ccv @ Xi) @ (cco @ cc1 @ XM @ ccfz))) @ (cwbr @ XA2 @ (ccfv @ (ccv @ Xi) @ (XF @ Xi)) @ cclt))) => ((! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwcel @ XA2 @ ccrp))) => (! [Xi:$i] : (cwi @ (Xph @ Xi) @ (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (ccfv @ XM @ (XX @ Xi)) @ cclt)))))))))))))))).
