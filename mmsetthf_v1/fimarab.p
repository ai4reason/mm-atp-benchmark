...
thf(cfimarab_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwa @ (cwf @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XF) @ (cwss @ XX @ (XA2 @ Xx3))) @ (cwceq @ (ccima @ XF @ XX) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xy1))) @ (^ [Xx3:$i] : XX))) @ (^ [Xy1:$i] : (XB2 @ Xx3))))))))))).
