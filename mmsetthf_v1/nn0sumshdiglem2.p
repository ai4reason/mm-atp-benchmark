...
thf(ann0rp0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ XN @ (cco @ ccc0 @ ccpnf @ ccico))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(ccmo_tp,type,(ccmo : ($i > $o))).
thf(ccfl_tp,type,(ccfl : ($i > $o))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(adigvalnn0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ ccz) @ (cwcel @ XR @ (cco @ ccc0 @ ccpnf @ ccico))) @ (cwcel @ (cco @ XK @ XR @ (ccfv @ XB2 @ ccdig)) @ ccn0)))))).
...
thf(ablen1b_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwb @ (cwceq @ (ccfv @ XN @ ccblen) @ cc1) @ (cwo @ (cwceq @ XN @ ccc0) @ (cwceq @ XN @ cc1)))))).
...
thf(a_0dig2pr01_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccpr @ ccc0 @ cc1)) @ (cwceq @ (cco @ ccc0 @ XN @ (ccfv @ cc2 @ ccdig)) @ XN)))).
thf(ann0sumshdiglem1_thm,axiom,(! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccn) @ (cwi @ (cwral @ (^ [Xa:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xa) @ ccblen) @ (ccv @ Xy1)) @ (cwceq @ (ccv @ Xa) @ (ccsu @ (cco @ ccc0 @ (ccv @ Xy1) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xa:$i] : ccn0)) @ (cwral @ (^ [Xa:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xa) @ ccblen) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwceq @ (ccv @ Xa) @ (ccsu @ (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xa:$i] : ccn0)))))).
thf(cnn0sumshdiglem2_conj,conjecture,(! [XL:($i > $o)] : (cwi @ (cwcel @ XL @ ccn) @ (cwral @ (^ [Xa:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xa) @ ccblen) @ XL) @ (cwceq @ (ccv @ Xa) @ (ccsu @ (cco @ ccc0 @ XL @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xa:$i] : ccn0))))).
