...
thf(cablfac1c_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ XB2 @ (ccfv @ (XG @ Xw) @ ccbs))) => ((! [Xw:$i] : (cwceq @ (XO @ Xw) @ (ccfv @ (XG @ Xw) @ ccod))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : (cwceq @ (XS @ Xx3 @ Xw @ Xp) @ (ccmpt @ (^ [Xp:$i] : (XA2 @ Xw)) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xw)) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2)))))))) => ((! [Xw:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xw) @ ccabl))) => ((cwi @ Xph @ (cwcel @ XB2 @ ccfn)) => ((! [Xw:$i] : (cwi @ Xph @ (cwss @ (XA2 @ Xw) @ ccprime))) => ((! [Xw:$i] : (cwceq @ (XD @ Xw) @ (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccfv @ XB2 @ cchash) @ ccdvds)) @ (^ [Xw:$i] : ccprime)))) => ((! [Xw:$i] : (cwi @ Xph @ (cwss @ (XD @ Xw) @ (XA2 @ Xw)))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : (cwi @ Xph @ (cwceq @ (cco @ (XG @ Xw) @ (XS @ Xx3 @ Xw @ Xp) @ ccdprd) @ XB2))))))))))))))))))))).
