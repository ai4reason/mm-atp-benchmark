...
thf(cdrsdir_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => (cwi @ (cw3a @ (cwcel @ XK @ ccdrs) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwbr @ XX @ (ccv @ Xz) @ Xc_le) @ (cwbr @ XY @ (ccv @ Xz) @ Xc_le))) @ (^ [Xz:$i] : XB2))))))))))).
