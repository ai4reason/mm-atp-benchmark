...
thf(cmeetval_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XG @ (ccfv @ XK @ ccglb)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwi @ Xph @ (cwcel @ XK @ XV)) => ((cwi @ Xph @ (cwcel @ XX @ XW)) => ((cwi @ Xph @ (cwcel @ XY @ XZ)) => (cwi @ Xph @ (cwceq @ (cco @ XX @ XY @ Xc_an) @ (ccfv @ (ccpr @ XX @ XY) @ XG)))))))))))))))))).
