...
thf(ckarden_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XC @ Xx3 @ Xy1) @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccen) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ XA2 @ ccen) @ (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XD @ Xx3 @ Xy1) @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ XB2 @ ccen) @ (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xy1) @ XB2 @ ccen) @ (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwb @ (cwceq @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1)) @ (cwbr @ XA2 @ XB2 @ ccen))))))))))))).
