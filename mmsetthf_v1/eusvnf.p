...
thf(asbnfc2_thm,axiom,(! [XA2:($i > ($i > $o))] : (cwb @ (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwal @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwceq @ (ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsb @ (ccv @ Xz) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
thf(ceusvnf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (cwi @ (cweu @ (^ [Xy1:$i] : (cwal @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xy1) @ (XA2 @ Xx3)))))) @ (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3)))))).
