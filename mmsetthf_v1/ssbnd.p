...
thf(aisbnd2_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwne @ XX @ cc0)) @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (cwceq @ XX @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
...
thf(ablbnd_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XY @ XX) @ (cwcel @ XR @ ccr)) @ (cwcel @ (ccres @ XM @ (ccxp @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)))) @ (ccfv @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ ccbnd)))))))).
thf(abndss_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)) @ (cwss @ XS @ XX)) @ (cwcel @ (ccres @ XM @ (ccxp @ XS @ XS)) @ (ccfv @ XS @ ccbnd))))))).
thf(cssbnd_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccres @ XM @ (ccxp @ XY @ XY))) => (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ XY @ ccbnd)) @ (cwrex @ (^ [Xd:$i] : (cwss @ XY @ (cco @ XP @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xd:$i] : ccr))))))))))).
