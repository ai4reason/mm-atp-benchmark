...
thf(adf_mri_ax,axiom,(cwceq @ ccmri @ (ccmpt @ (^ [Xc:$i] : (ccuni @ (ccrn @ ccmre))) @ (^ [Xc:$i] : (ccrab @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xx3))) @ (ccfv @ (ccv @ Xc) @ ccmrc))))) @ (^ [Xx3:$i] : (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ (ccuni @ (ccv @ Xc))))))))).
...
thf(cmrisval_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xs1:$i] : (cwceq @ (XN @ Xx3 @ Xs1) @ (ccfv @ XA2 @ ccmrc)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (cwceq @ (XI @ Xx3 @ Xs1) @ (ccfv @ XA2 @ ccmri)))) => (! [Xx3:$i] : (! [Xs1:$i] : (cwi @ (cwcel @ XA2 @ (ccfv @ (XX @ Xx3) @ ccmre)) @ (cwceq @ (XI @ Xx3 @ Xs1) @ (ccrab @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xx3))) @ (XN @ Xx3 @ Xs1))))) @ (^ [Xx3:$i] : (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ (XX @ Xx3))))))))))))))).
