...
thf(aevenprm2_thm,axiom,(! [XP:($i > $o)] : (cwi @ (cwcel @ XP @ ccprime) @ (cwb @ (cwcel @ XP @ cceven) @ (cwceq @ XP @ cc2))))).
...
thf(coddprmne2_conj,conjecture,(! [XP:($i > $o)] : (cwb @ (cwa @ (cwcel @ XP @ ccprime) @ (cwcel @ XP @ ccodd)) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))))).
