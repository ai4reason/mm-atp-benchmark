...
thf(adf_nmo_ax,axiom,(cwceq @ ccnmo @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : ccngp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : ccngp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccmpt @ (^ [Xf1:$i] : (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ ccghm)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ ccnm)) @ (cco @ (ccv @ Xr) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xs1) @ ccnm)) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xs1) @ ccbs)))) @ (^ [Xr:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ ccxr @ cclt)))))))).
...
thf(cnmoffn_conj,conjecture,(cwfn @ ccnmo @ (ccxp @ ccngp @ ccngp))).
