...
thf(crngcrescrhm_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwceq @ XC @ (ccfv @ XU @ ccrngc)) => ((cwi @ Xph @ (cwceq @ XR @ (ccin @ ccrg @ XU))) => ((cwceq @ XH @ (ccres @ ccrh @ (ccxp @ XR @ XR))) => (cwi @ Xph @ (cwceq @ (cco @ XC @ XH @ ccresc) @ (cco @ (cco @ XC @ XR @ ccress) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ ccsts)))))))))))))).
