...
thf(azfregcl_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) @ (cwi @ (cwex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwn @ (cwcel @ (ccv @ Xy1) @ XA2))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(celirrv_conj,conjecture,(! [Xx3:$i] : (cwn @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3))))).
