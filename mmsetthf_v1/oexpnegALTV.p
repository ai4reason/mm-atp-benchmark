...
thf(aodd2np1ALTV_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwcel @ XN @ ccodd) @ (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ XN)) @ (^ [Xn:$i] : ccz)))))).
...
thf(asqneg_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ (ccneg @ XA2) @ cc2 @ ccexp) @ (cco @ XA2 @ cc2 @ ccexp))))).
...
thf(coexpnegALTV_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (cwcel @ XN @ ccodd)) @ (cwceq @ (cco @ (ccneg @ XA2) @ XN @ ccexp) @ (ccneg @ (cco @ XA2 @ XN @ ccexp))))))).
