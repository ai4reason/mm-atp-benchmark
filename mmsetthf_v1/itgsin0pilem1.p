...
thf(advcosre_thm,axiom,(cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cccos))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccv @ Xx3) @ ccsin)))))).
...
thf(acncfmptss_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (XF @ Xx3) @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ cccncf)))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XC @ (XA2 @ Xx3)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (cco @ XC @ (XB2 @ Xx3) @ cccncf))))))))))))).
...
thf(acospi_thm,axiom,(cwceq @ (ccfv @ ccpi @ cccos) @ (ccneg @ cc1))).
...
thf(citgsin0pilem1_conj,conjecture,(! [XC:($i > ($i > $o))] : ((! [Xt:$i] : (cwceq @ (XC @ Xt) @ (ccmpt @ (^ [Xt:$i] : (cco @ ccc0 @ ccpi @ ccicc)) @ (^ [Xt:$i] : (ccneg @ (ccfv @ (ccv @ Xt) @ cccos)))))) => (cwceq @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccsin))) @ cc2)))).
