...
thf(ashsval3i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwceq @ (cco @ XA2 @ XB2 @ ccph) @ (ccfv @ (ccun @ XA2 @ XB2) @ ccspn))))))).
...
thf(cshs0i_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => (cwceq @ (cco @ XA2 @ cc0h @ ccph) @ XA2)))).
