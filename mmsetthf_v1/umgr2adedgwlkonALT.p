...
thf(cumgr2adedgwlkonALT_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XF @ (ccs2 @ XJ @ XK)) => ((cwceq @ XP @ (ccs3 @ XA2 @ XB2 @ XC)) => ((cwi @ Xph @ (cwcel @ XG @ ccumgr)) => ((cwi @ Xph @ (cwa @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XJ @ XI) @ (ccpr @ XA2 @ XB2))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ XI) @ (ccpr @ XB2 @ XC))) => (cwi @ Xph @ (cwbr @ XF @ XP @ (cco @ XA2 @ XC @ (ccfv @ XG @ ccwlkson)))))))))))))))))))))))).
