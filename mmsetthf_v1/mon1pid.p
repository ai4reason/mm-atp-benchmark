...
thf(cmon1pid_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ Xc_1 @ (ccfv @ XP @ ccur)) => ((cwceq @ XM @ (ccfv @ XR @ ccmn1)) => ((cwceq @ XD @ (ccfv @ XR @ ccdg1)) => (cwi @ (cwcel @ XR @ ccnzr) @ (cwa @ (cwcel @ Xc_1 @ XM) @ (cwceq @ (ccfv @ Xc_1 @ XD) @ ccc0))))))))))))).
