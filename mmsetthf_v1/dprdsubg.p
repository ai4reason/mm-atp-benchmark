...
thf(adprddomprc_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwnel @ (ccdm @ XS) @ ccvv) @ (cwn @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))))))).
...
thf(cdprdsubg_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwbr @ XG @ XS @ (ccdm @ ccdprd)) @ (cwcel @ (cco @ XG @ XS @ ccdprd) @ (ccfv @ XG @ ccsubg)))))).
