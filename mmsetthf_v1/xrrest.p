...
thf(cxrrest_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ ccle @ ccordt)) => ((cwceq @ XR @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwi @ (cwss @ XA2 @ ccr) @ (cwceq @ (cco @ XX @ XA2 @ ccrest) @ (cco @ XR @ XA2 @ ccrest))))))))).
