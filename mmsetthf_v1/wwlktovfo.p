...
thf(awrdlen2i_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ XV) @ (cwcel @ XT @ XV)) @ (cwi @ (cwceq @ XW @ (ccpr @ (ccop @ ccc0 @ XS) @ (ccop @ cc1 @ XT))) @ (cwa @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwceq @ (ccfv @ XW @ cchash) @ cc2)) @ (cwa @ (cwceq @ (ccfv @ ccc0 @ XW) @ XS) @ (cwceq @ (ccfv @ cc1 @ XW) @ XT)))))))))).
