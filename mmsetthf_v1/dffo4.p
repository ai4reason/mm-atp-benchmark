...
thf(cdffo4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwb @ (cwfo @ XA2 @ XB2 @ XF) @ (cwa @ (cwf @ XA2 @ XB2 @ XF) @ (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XB2)))))))).
