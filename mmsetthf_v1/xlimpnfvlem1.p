...
thf(aiocgtlbd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))) => (cwi @ Xph @ (cwbr @ XA2 @ XC @ cclt)))))))))).
...
thf(cxlimpnfvlem1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((cwi @ Xph @ (cwf @ XZ @ ccxr @ XF)) => ((cwi @ Xph @ (cwbr @ XF @ ccpnf @ cclsxlim)) => ((cwi @ Xph @ (cwcel @ XX @ ccr)) => (cwi @ Xph @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ XX @ (ccfv @ (ccv @ Xk) @ XF) @ ccle)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))).
