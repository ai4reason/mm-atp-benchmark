...
thf(agcd0id_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwceq @ (cco @ ccc0 @ XN @ ccgcd) @ (ccfv @ XN @ ccabs))))).
...
thf(azrh0_thm,axiom,(! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ (ccfv @ ccc0 @ XL) @ Xc_0)))))))).
...
thf(advr1_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ XX @ Xc_1 @ Xc_dv) @ XX))))))))))).
thf(cqqh0_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_dv @ (ccfv @ XR @ ccdvr)) => ((cwceq @ XL @ (ccfv @ XR @ cczrh)) => (cwi @ (cwa @ (cwcel @ XR @ ccdr) @ (cwceq @ (ccfv @ XR @ ccchr) @ ccc0)) @ (cwceq @ (ccfv @ ccc0 @ (ccfv @ XR @ ccqqh)) @ (ccfv @ XR @ cc0g))))))))))).
