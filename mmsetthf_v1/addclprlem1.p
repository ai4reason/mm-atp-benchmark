...
thf(altrnq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwbr @ XA2 @ XB2 @ ccltq) @ (cwbr @ (ccfv @ XB2 @ ccrq) @ (ccfv @ XA2 @ ccrq) @ ccltq))))).
...
thf(caddclprlem1_conj,conjecture,(! [Xx3:$i] : (! [XA2:($i > ($i > $o))] : (! [Xh:$i] : (! [Xg1:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ (XA2 @ Xg1) @ ccnp) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xg1))) @ (cwcel @ (ccv @ Xx3) @ ccnq)) @ (cwi @ (cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ ccplq) @ ccltq) @ (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ ccplq) @ ccrq) @ ccmq) @ (ccv @ Xg1) @ ccmq) @ (XA2 @ Xg1))))))))).
