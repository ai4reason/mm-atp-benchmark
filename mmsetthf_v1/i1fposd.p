...
thf(ci1fposd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccdm @ ccitg1))) => (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (XA2 @ Xx3) @ ccle) @ (XA2 @ Xx3) @ ccc0))) @ (ccdm @ ccitg1))))))).
