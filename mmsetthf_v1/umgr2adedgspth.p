...
thf(a_2spthd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XP @ (ccs3 @ XA2 @ XB2 @ XC)) => ((cwceq @ XF @ (ccs2 @ XJ @ XK)) => ((cwi @ Xph @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((cwi @ Xph @ (cwa @ (cwne @ XA2 @ XB2) @ (cwne @ XB2 @ XC))) => ((cwi @ Xph @ (cwa @ (cwss @ (ccpr @ XA2 @ XB2) @ (ccfv @ XJ @ XI)) @ (cwss @ (ccpr @ XB2 @ XC) @ (ccfv @ XK @ XI)))) => ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwi @ Xph @ (cwne @ XJ @ XK)) => ((cwi @ Xph @ (cwne @ XA2 @ XC)) => (cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)))))))))))))))))))))))).
...
thf(apreqr1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwi @ (cwceq @ (ccpr @ XA2 @ XC) @ (ccpr @ XB2 @ XC)) @ (cwceq @ XA2 @ XB2))))))))).
...
thf(cumgr2adedgspth_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => ((cwceq @ XF @ (ccs2 @ XJ @ XK)) => ((cwceq @ XP @ (ccs3 @ XA2 @ XB2 @ XC)) => ((cwi @ Xph @ (cwcel @ XG @ ccumgr)) => ((cwi @ Xph @ (cwa @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XJ @ XI) @ (ccpr @ XA2 @ XB2))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XK @ XI) @ (ccpr @ XB2 @ XC))) => ((cwi @ Xph @ (cwne @ XA2 @ XC)) => (cwi @ Xph @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)))))))))))))))))))))))).
