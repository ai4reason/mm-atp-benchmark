...
thf(cldualneg_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XR @ (ccfv @ XW @ ccsca)) => ((cwceq @ XM @ (ccfv @ XR @ ccminusg)) => ((cwceq @ XD @ (ccfv @ XW @ ccld)) => ((cwceq @ XS @ (ccfv @ XD @ ccsca)) => ((cwceq @ XN @ (ccfv @ XS @ ccminusg)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => (cwi @ Xph @ (cwceq @ XN @ XM)))))))))))))))).
