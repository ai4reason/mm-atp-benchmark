...
thf(adpjlsm_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => (cwi @ Xph @ (cwceq @ (cco @ XG @ XS @ ccdprd) @ (cco @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ Xc_po)))))))))))))).
thf(cdpjghm_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((cwceq @ XP @ (cco @ XG @ XS @ ccdpj)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ XP) @ (cco @ (cco @ XG @ (cco @ XG @ XS @ ccdprd) @ ccress) @ XG @ ccghm)))))))))))))).
