...
thf(agexval_thm,axiom,(! [Xc_x:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XX @ Xy1) @ (ccfv @ XG @ ccbs))) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XE @ Xx3 @ Xy1) @ (ccfv @ XG @ ccgex)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XI @ Xx3 @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_x) @ Xc_0)) @ (^ [Xx3:$i] : (XX @ Xy1)))) @ (^ [Xy1:$i] : ccn))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwcel @ XG @ XV) @ (cwceq @ (XE @ Xx3 @ Xy1) @ (ccif @ (cwceq @ (XI @ Xx3 @ Xy1) @ cc0) @ ccc0 @ (ccinf @ (XI @ Xx3 @ Xy1) @ ccr @ cclt))))))))))))))))))).
...
thf(cgexlem2_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ XE @ (ccfv @ XG @ ccgex)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cw3a @ (cwcel @ XG @ XV) @ (cwcel @ XN @ ccn) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (cco @ XN @ (ccv @ Xx3) @ Xc_x) @ Xc_0)) @ (^ [Xx3:$i] : XX))) @ (cwcel @ XE @ (cco @ cc1 @ XN @ ccfz))))))))))))))).
