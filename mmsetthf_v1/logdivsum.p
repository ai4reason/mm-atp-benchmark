...
thf(clogdivsum_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xi:$i] : (cwceq @ (XF @ Xy1 @ Xi) @ (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccv @ Xi) @ ccdiv))) @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin)))))) => (! [Xy1:$i] : (! [Xi:$i] : (cw3a @ (cwf @ ccrp @ ccr @ (XF @ Xy1 @ Xi)) @ (cwcel @ (XF @ Xy1 @ Xi) @ (ccdm @ ccrli)) @ (cwi @ (cw3a @ (cwbr @ (XF @ Xy1 @ Xi) @ (XL @ Xy1 @ Xi) @ ccrli) @ (cwcel @ XA2 @ ccrp) @ (cwbr @ cceu @ XA2 @ ccle)) @ (cwbr @ (ccfv @ (cco @ (ccfv @ XA2 @ (XF @ Xy1 @ Xi)) @ (XL @ Xy1 @ Xi) @ ccmin) @ ccabs) @ (cco @ (ccfv @ XA2 @ cclog) @ XA2 @ ccdiv) @ ccle)))))))))).
