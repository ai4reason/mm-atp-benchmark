...
thf(ccnclsi_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwss @ XS @ XX)) @ (cwss @ (ccima @ XF @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) @ (ccfv @ (ccima @ XF @ XS) @ (ccfv @ XK @ cccl))))))))))).
