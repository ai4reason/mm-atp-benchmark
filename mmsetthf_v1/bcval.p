...
thf(adf_bc_ax,axiom,(cwceq @ ccbc @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xk:$i] : ccn0)) @ (^ [Xn:$i] : (^ [Xk:$i] : ccz)) @ (^ [Xn:$i] : (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ ccfa) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccmul) @ ccdiv) @ ccc0)))))).
...
thf(cbcval_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccz)) @ (cwceq @ (cco @ XN @ XK @ ccbc) @ (ccif @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ (ccfv @ (cco @ XN @ XK @ ccmin) @ ccfa) @ (ccfv @ XK @ ccfa) @ ccmul) @ ccdiv) @ ccc0)))))).
