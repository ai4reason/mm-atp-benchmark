...
thf(adf_caragen_ax,axiom,(cwceq @ cccaragen @ (ccmpt @ (^ [Xo:$i] : ccome) @ (^ [Xo:$i] : (ccrab @ (^ [Xe:$i] : (cwral @ (^ [Xa:$i] : (cwceq @ (cco @ (ccfv @ (ccin @ (ccv @ Xa) @ (ccv @ Xe)) @ (ccv @ Xo)) @ (ccfv @ (ccdif @ (ccv @ Xa) @ (ccv @ Xe)) @ (ccv @ Xo)) @ ccxad) @ (ccfv @ (ccv @ Xa) @ (ccv @ Xo)))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ (ccv @ Xo))))))) @ (^ [Xe:$i] : (ccpw @ (ccuni @ (ccdm @ (ccv @ Xo)))))))))).
thf(ccaragenval_conj,conjecture,(! [XO:($i > $o)] : (cwi @ (cwcel @ XO @ ccome) @ (cwceq @ (ccfv @ XO @ cccaragen) @ (ccrab @ (^ [Xe:$i] : (cwral @ (^ [Xa:$i] : (cwceq @ (cco @ (ccfv @ (ccin @ (ccv @ Xa) @ (ccv @ Xe)) @ XO) @ (ccfv @ (ccdif @ (ccv @ Xa) @ (ccv @ Xe)) @ XO) @ ccxad) @ (ccfv @ (ccv @ Xa) @ XO))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ XO)))))) @ (^ [Xe:$i] : (ccpw @ (ccuni @ (ccdm @ XO))))))))).
