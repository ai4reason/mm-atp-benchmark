...
thf(aarisum_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xk:$i] : (ccv @ Xk))) @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ XN @ ccaddc) @ cc2 @ ccdiv))))).
...
thf(carisum2_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (ccv @ Xk))) @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ XN @ ccmin) @ cc2 @ ccdiv))))).
