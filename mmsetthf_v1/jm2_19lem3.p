...
thf(ajm2_19lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwb @ (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccdvds) @ (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ (cco @ XN @ XM @ ccaddc) @ ccrmy) @ ccdvds))))))).
...
thf(cjm2_19lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwa @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) @ (cwcel @ XI @ ccn0)) @ (cwb @ (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccdvds) @ (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ (cco @ XN @ (cco @ XI @ XM @ ccmul) @ ccaddc) @ ccrmy) @ ccdvds)))))))).
