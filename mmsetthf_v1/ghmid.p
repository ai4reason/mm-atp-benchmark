...
thf(cghmid_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XY @ (ccfv @ XS @ cc0g)) => ((cwceq @ Xc_0 @ (ccfv @ XT @ cc0g)) => (cwi @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwceq @ (ccfv @ XY @ XF) @ Xc_0)))))))))).
