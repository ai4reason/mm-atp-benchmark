...
thf(cuniioovol_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (cwceq @ (XS @ Xx3) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))) @ ccovol) @ (ccsup @ (ccrn @ (XS @ Xx3)) @ ccxr @ cclt))))))))))).
