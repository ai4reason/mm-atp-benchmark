...
thf(csnstriedgval_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => ((cwceq @ XG @ (ccsn @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV))) => (cwi @ (cwne @ XV @ (ccfv @ ccnx @ ccbs)) @ (cwceq @ (ccfv @ XG @ cciedg) @ cc0))))))).
