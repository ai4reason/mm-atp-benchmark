...
thf(cnnpw2blen_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwa @ (cwbr @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ XN @ ccle) @ (cwbr @ XN @ (cco @ cc2 @ (ccfv @ XN @ ccblen) @ ccexp) @ cclt))))).
