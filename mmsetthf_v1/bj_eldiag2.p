...
thf(abj_elid3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwcel @ (ccop @ XA2 @ XB2) @ ccid) @ (cwa @ (cwcel @ XA2 @ ccvv) @ (cwceq @ XA2 @ XB2)))))).
...
thf(cbj_eldiag2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ (ccop @ XB2 @ XC) @ (ccfv @ XA2 @ ccdiag2)) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwceq @ XB2 @ XC))))))))).
