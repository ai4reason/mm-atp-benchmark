...
thf(cnehash2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ XV)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)))))))))))).
