...
thf(ccply1mul_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xc:$i] : (cwceq @ (XP @ Xc) @ (ccfv @ (XR @ Xc) @ ccpl1))) => ((! [Xc:$i] : (cwceq @ (XB2 @ Xc) @ (ccfv @ (XP @ Xc) @ ccbs))) => ((! [Xc:$i] : (cwceq @ Xc_0 @ (ccfv @ (XR @ Xc) @ cc0g))) => ((! [Xc:$i] : (cwceq @ Xc_xp @ (ccfv @ (XP @ Xc) @ ccmulr))) => (! [Xc:$i] : (cwi @ (cwa @ (cwcel @ (XR @ Xc) @ ccrg) @ (cwa @ (cwcel @ XF @ (XB2 @ Xc)) @ (cwcel @ XG @ (XB2 @ Xc)))) @ (cwi @ (cwral @ (^ [Xc:$i] : (cwa @ (cwceq @ (ccfv @ (ccv @ Xc) @ (ccfv @ XF @ ccco1)) @ Xc_0) @ (cwceq @ (ccfv @ (ccv @ Xc) @ (ccfv @ XG @ ccco1)) @ Xc_0))) @ (^ [Xc:$i] : ccn)) @ (cwral @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ (ccfv @ (cco @ XF @ XG @ Xc_xp) @ ccco1)) @ Xc_0)) @ (^ [Xc:$i] : ccn))))))))))))))))).
