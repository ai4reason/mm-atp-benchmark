...
thf(ccshwsiun_conj,conjecture,(! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xw:$i] : (! [Xn:$i] : (cwceq @ (XM @ Xw @ Xn) @ (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : (cwceq @ (cco @ XW @ (ccv @ Xn) @ cccsh) @ (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ XV)))))) => (! [Xw:$i] : (! [Xn:$i] : (cwi @ (cwcel @ XW @ (ccword @ XV)) @ (cwceq @ (XM @ Xw @ Xn) @ (cciun @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xn:$i] : (ccsn @ (cco @ XW @ (ccv @ Xn) @ cccsh))))))))))))).
