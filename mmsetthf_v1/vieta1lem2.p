...
thf(afta1_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XR @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0))) => (cwi @ (cwa @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwne @ XF @ cc0p)) @ (cwa @ (cwcel @ XR @ ccfn) @ (cwbr @ (ccfv @ XR @ cchash) @ (ccfv @ XF @ ccdgr) @ ccle)))))))).
...
thf(aofmulrt_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG)) @ (cwceq @ (ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccmul))) @ (ccsn @ ccc0)) @ (ccun @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0)) @ (ccima @ (cccnv @ XG) @ (ccsn @ ccc0)))))))))).
...
thf(acoeidp_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn0) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ ccidp @ cccoe)) @ (ccif @ (cwceq @ XA2 @ cc1) @ cc1 @ ccc0))))).
...
thf(acoemul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => ((cwceq @ XB2 @ (ccfv @ XG @ cccoe)) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (ccfv @ XN @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XB2) @ ccmul)))))))))))))).
...
thf(acoefv0_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XF @ cccoe)) => (cwi @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwceq @ (ccfv @ ccc0 @ XF) @ (ccfv @ ccc0 @ XA2)))))))).
...
thf(cvieta1lem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XA2 @ Xx3) @ (ccfv @ (XF @ Xx3 @ Xz) @ cccoe)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XN @ Xx3) @ (ccfv @ (XF @ Xx3 @ Xz) @ ccdgr)))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ XR @ (ccima @ (cccnv @ (XF @ Xx3 @ Xz)) @ (ccsn @ ccc0))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XF @ Xx3 @ Xz) @ (ccfv @ (XS @ Xx3 @ Xz @ Xf1) @ ccply)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccfv @ XR @ cchash) @ (XN @ Xx3))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwcel @ (XD @ Xx3 @ Xz) @ ccn))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (cco @ (XD @ Xx3 @ Xz) @ cc1 @ ccaddc) @ (XN @ Xx3)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwral @ (^ [Xf1:$i] : (cwi @ (cwa @ (cwceq @ (XD @ Xx3 @ Xz) @ (ccfv @ (ccv @ Xf1) @ ccdgr)) @ (cwceq @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ cchash) @ (ccfv @ (ccv @ Xf1) @ ccdgr))) @ (cwceq @ (ccsu @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ (^ [Xx3:$i] : (ccv @ Xx3))) @ (ccneg @ (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ ccdiv))))) @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XQ @ Xz) @ (cco @ (XF @ Xx3 @ Xz) @ (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ (ccv @ Xz))) @ (ccof @ ccmin)) @ ccquot)))) => (! [Xx3:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xf1) @ (cwceq @ (ccsu @ XR @ (^ [Xx3:$i] : (ccv @ Xx3))) @ (ccneg @ (cco @ (ccfv @ (cco @ (XN @ Xx3) @ cc1 @ ccmin) @ (XA2 @ Xx3)) @ (ccfv @ (XN @ Xx3) @ (XA2 @ Xx3)) @ ccdiv)))))))))))))))))))))))).
