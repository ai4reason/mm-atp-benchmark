...
thf(celrelscnveq3_conj,conjecture,(! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccrels) @ (cwb @ (cwceq @ XR @ (cccnv @ XR)) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)))))))))).
