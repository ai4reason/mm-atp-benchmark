...
thf(adf_ssc_ax,axiom,(cwceq @ ccssc @ (ccopab @ (^ [Xh:$i] : (^ [Xj:$i] : (cwex @ (^ [Xt:$i] : (cwa @ (cwfn @ (ccv @ Xj) @ (ccxp @ (ccv @ Xt) @ (ccv @ Xt))) @ (cwrex @ (^ [Xs1:$i] : (cwcel @ (ccv @ Xh) @ (ccixp @ (^ [Xx3:$i] : (ccxp @ (ccv @ Xs1) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xj))))))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xt)))))))))))).
