...
thf(auncmp_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwa @ (cwcel @ XJ @ cctop) @ (cwceq @ XX @ (ccun @ XS @ XT))) @ (cwa @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp) @ (cwcel @ (cco @ XJ @ XT @ ccrest) @ cccmp))) @ (cwcel @ XJ @ cccmp)))))))).
thf(cfiuncmp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XX @ Xx3) @ (ccuni @ XJ))) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ XJ @ (XB2 @ Xx3) @ ccrest) @ cccmp)) @ (^ [Xx3:$i] : XA2))) @ (cwcel @ (cco @ XJ @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccrest) @ cccmp)))))))).
