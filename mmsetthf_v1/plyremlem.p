...
thf(adgrid_thm,axiom,(cwceq @ (ccfv @ ccidp @ ccdgr) @ cc1)).
...
thf(cplyremlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XG @ (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => (cwi @ (cwcel @ XA2 @ ccc) @ (cw3a @ (cwcel @ XG @ (ccfv @ ccc @ ccply)) @ (cwceq @ (ccfv @ XG @ ccdgr) @ cc1) @ (cwceq @ (ccima @ (cccnv @ XG) @ (ccsn @ ccc0)) @ (ccsn @ XA2)))))))).
