...
thf(antridm_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX)) @ (cwceq @ (ccfv @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XS @ (ccfv @ XJ @ ccnt))))))))).
...
thf(ccldregopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwceq @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ XJ @ ccnt)) @ XA2) @ (cwrex @ (^ [Xc:$i] : (cwceq @ XA2 @ (ccfv @ (ccv @ Xc) @ (ccfv @ XJ @ ccnt)))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld)))))))))).
