...
thf(acnextval_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop)) @ (cwceq @ (cco @ XJ @ XK @ cccnext) @ (ccmpt @ (^ [Xf1:$i] : (cco @ (ccuni @ XK) @ (ccuni @ XJ) @ ccpm)) @ (^ [Xf1:$i] : (cciun @ (^ [Xx3:$i] : (ccfv @ (ccdm @ (ccv @ Xf1)) @ (ccfv @ XJ @ cccl))) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xf1) @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ (ccdm @ (ccv @ Xf1)) @ ccrest) @ ccflf)))))))))))).
