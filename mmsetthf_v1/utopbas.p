...
thf(austne0_thm,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwne @ XU @ cc0))))).
thf(ar19_2zb_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwb @ (cwne @ XA2 @ cc0) @ (cwi @ (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cutopbas_conj,conjecture,(! [XU:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwceq @ XX @ (ccuni @ (ccfv @ XU @ ccutop))))))).
