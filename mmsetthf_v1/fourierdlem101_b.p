...
thf(cfourierdlem101_b_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (cwceq @ (XD @ Xi @ Xm @ Xp) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ (cwceq @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xm) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XP @ Xt @ Xi @ Xm @ Xs1 @ Xp) @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : (cwa @ (cwa @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccneg @ ccpi)) @ (cwceq @ (ccfv @ (ccv @ Xm) @ (ccv @ Xp)) @ ccpi)) @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap))))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwceq @ (XG @ Xm @ Xp) @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xi @ Xm @ Xs1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xt) @ (XX @ Xm @ Xp) @ ccmin) @ (ccfv @ (XN @ Xi @ Xp) @ (XD @ Xi @ Xm @ Xp))) @ ccmul)))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XQ @ Xm) @ (ccfv @ XM @ (XP @ Xt @ Xi @ Xm @ Xs1 @ Xp))))))))) => ((! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ XM @ ccn))) => ((! [Xi:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XN @ Xi @ Xp) @ ccn)))) => ((! [Xm:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwcel @ (XX @ Xm @ Xp) @ ccr)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwf @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccc @ (XF @ Xi @ Xm @ Xs1 @ Xp))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwcel @ (ccres @ (XF @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo) @ ccc @ cccncf))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwcel @ (XR @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ cclimc))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (cwa @ (Xph @ Xp) @ (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwcel @ (XL @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ cclimc))))))) => (! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (cwi @ (Xph @ Xp) @ (cwceq @ (ccitg @ (^ [Xt:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xi @ Xm @ Xs1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xt) @ (XX @ Xm @ Xp) @ ccmin) @ (ccfv @ (XN @ Xi @ Xp) @ (XD @ Xi @ Xm @ Xp))) @ ccmul))) @ (ccitg @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ ccpi) @ (XX @ Xm @ Xp) @ ccmin) @ (cco @ ccpi @ (XX @ Xm @ Xp) @ ccmin) @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (cco @ (XX @ Xm @ Xp) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xi @ Xm @ Xs1 @ Xp)) @ (ccfv @ (ccv @ Xs1) @ (ccfv @ (XN @ Xi @ Xp) @ (XD @ Xi @ Xm @ Xp))) @ ccmul)))))))))))))))))))))))))))))))).
