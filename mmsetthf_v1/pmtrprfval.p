...
thf(apr2pwpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xp:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xp)) @ (cwcel @ XB2 @ (XW @ Xp)) @ (cwne @ XA2 @ XB2)) @ (cwceq @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ cc2o @ ccen)) @ (^ [Xp:$i] : (ccpw @ (ccpr @ XA2 @ XB2)))) @ (ccsn @ (ccpr @ XA2 @ XB2)))))))))).
...
thf(cpmtrprfval_conj,conjecture,(cwceq @ (ccfv @ (ccpr @ cc1 @ cc2) @ ccpmtr) @ (ccmpt @ (^ [Xp:$i] : (ccsn @ (ccpr @ cc1 @ cc2))) @ (^ [Xp:$i] : (ccmpt @ (^ [Xz:$i] : (ccpr @ cc1 @ cc2)) @ (^ [Xz:$i] : (ccif @ (cwceq @ (ccv @ Xz) @ cc1) @ cc2 @ cc1))))))).
