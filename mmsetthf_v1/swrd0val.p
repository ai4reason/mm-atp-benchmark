...
thf(cswrd0val_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) @ (cwceq @ (cco @ XS @ (ccop @ ccc0 @ XL) @ ccsubstr) @ (ccres @ XS @ (cco @ ccc0 @ XL @ ccfzo)))))))).
