...
thf(celqsg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XB2 @ (XV @ Xx3)) @ (cwb @ (cwcel @ XB2 @ (ccqs @ XA2 @ XR)) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ XB2 @ (ccec @ (ccv @ Xx3) @ XR))) @ (^ [Xx3:$i] : XA2)))))))))).
