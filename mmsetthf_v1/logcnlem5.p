...
thf(alogcnlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((cwceq @ XS @ (ccif @ (cwcel @ XA2 @ ccrp) @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs))) => ((cwceq @ XT @ (cco @ (ccfv @ XA2 @ ccabs) @ (cco @ XR @ (cco @ cc1 @ XR @ ccaddc) @ ccdiv) @ ccmul)) => ((cwi @ Xph @ (cwcel @ XA2 @ XD)) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => (cwi @ Xph @ (cwcel @ (ccif @ (cwbr @ XS @ XT @ ccle) @ XS @ XT) @ ccrp)))))))))))))).
...
thf(alogcnlem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((cwceq @ XS @ (ccif @ (cwcel @ XA2 @ ccrp) @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs))) => ((cwceq @ XT @ (cco @ (ccfv @ XA2 @ ccabs) @ (cco @ XR @ (cco @ cc1 @ XR @ ccaddc) @ ccdiv) @ ccmul)) => ((cwi @ Xph @ (cwcel @ XA2 @ XD)) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ XD)) => ((cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (ccif @ (cwbr @ XS @ XT @ ccle) @ XS @ XT) @ cclt)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (ccfv @ (ccfv @ XB2 @ cclog) @ ccim) @ ccmin) @ ccabs) @ XR @ cclt))))))))))))))))).
...
thf(clogcnlem5_conj,conjecture,(! [XD:($i > $o)] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccim))) @ (cco @ XD @ ccr @ cccncf))))).
