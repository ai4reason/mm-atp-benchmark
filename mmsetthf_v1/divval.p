...
thf(cdivval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ (ccrio @ (^ [Xx3:$i] : (cwceq @ (cco @ XB2 @ (ccv @ Xx3) @ ccmul) @ XA2)) @ (^ [Xx3:$i] : ccc))))))).
