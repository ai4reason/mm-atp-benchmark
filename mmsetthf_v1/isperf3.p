...
thf(aisperf2_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccperf) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwss @ XX @ (ccfv @ XX @ (ccfv @ XJ @ cclp))))))))).
...
thf(amaxlp_thm,axiom,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwcel @ XJ @ cctop) @ (cwb @ (cwcel @ XP @ (ccfv @ XX @ (ccfv @ XJ @ cclp))) @ (cwa @ (cwcel @ XP @ XX) @ (cwn @ (cwcel @ (ccsn @ XP) @ XJ)))))))))).
thf(cisperf3_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccperf) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwral @ (^ [Xx3:$i] : (cwn @ (cwcel @ (ccsn @ (ccv @ Xx3)) @ XJ))) @ (^ [Xx3:$i] : XX)))))))).
