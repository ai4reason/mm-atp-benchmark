...
thf(aisfildlem_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccv @ Xx3) @ XF) @ (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (Xps @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (XB2 @ Xx3) @ XF) @ (cwa @ (cwss @ (XB2 @ Xx3) @ XA2) @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XB2 @ Xx3)))))))))))))).
...
thf(aisfil2_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwb @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cw3a @ (cw3a @ (cwss @ XF @ (ccpw @ XX)) @ (cwn @ (cwcel @ cc0 @ XF)) @ (cwcel @ XX @ XF)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XF)) @ (cwcel @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : (ccpw @ XX))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF))))))).
thf(cisfild_b_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccv @ Xx3) @ XF) @ (cwa @ (cwss @ (ccv @ Xx3) @ XA2) @ (Xps @ Xx3))))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccvv)) => ((cwi @ Xph @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ XA2)) => ((cwi @ Xph @ (cwn @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ cc0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwi @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xx3)) @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xx3) @ XA2)) @ (cwi @ (cwa @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xy1)) @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xx3))) @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xx3))))))) => (cwi @ Xph @ (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
