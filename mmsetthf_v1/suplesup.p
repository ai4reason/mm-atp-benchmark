...
thf(asupxrgere_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XB2 @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ ccrp)) @ (cwrex @ (^ [Xy1:$i] : (cwbr @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) => (! [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))))))).
...
thf(csuplesup_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwss @ (XA2 @ Xy1) @ ccr))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwss @ XB2 @ ccxr))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwbr @ (ccsup @ (XA2 @ Xy1) @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle)))))))))).
