...
thf(afindfvcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ (ccfv @ cc0 @ XF) @ XP)) => ((! [Xy1:$i] : (cwi @ (cwcel @ (ccv @ Xy1) @ ccom) @ (cwi @ Xph @ (cwi @ (cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ XP) @ (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ XF) @ XP))))) => (! [Xy1:$i] : (cwi @ (cwcel @ (XA2 @ Xy1) @ ccom) @ (cwi @ Xph @ (cwcel @ (ccfv @ (XA2 @ Xy1) @ XF) @ XP))))))))))).
...
thf(cfindreccl_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : ((! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ XP) @ (cwcel @ (ccfv @ (ccv @ Xz) @ XG) @ XP))) => (! [Xz:$i] : (cwi @ (cwcel @ (XC @ Xz) @ ccom) @ (cwi @ (cwcel @ XA2 @ XP) @ (cwcel @ (ccfv @ (XC @ Xz) @ (ccrdg @ XG @ XA2)) @ XP)))))))))).
