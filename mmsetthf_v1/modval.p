...
thf(adf_mod_ax,axiom,(cwceq @ ccmo @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccrp)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv) @ ccfl) @ ccmul) @ ccmin)))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cmodval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ (cco @ XA2 @ (cco @ XB2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ ccmul) @ ccmin)))))).
