...
thf(aofccat_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwi @ Xph @ (cwcel @ XE @ (ccword @ XS))) => ((cwi @ Xph @ (cwcel @ XF @ (ccword @ XS))) => ((cwi @ Xph @ (cwcel @ XG @ (ccword @ XT))) => ((cwi @ Xph @ (cwcel @ XH @ (ccword @ XT))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XE @ cchash) @ (ccfv @ XG @ cchash))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ cchash) @ (ccfv @ XH @ cchash))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XE @ XF @ ccconcat) @ (cco @ XG @ XH @ ccconcat) @ (ccof @ XR)) @ (cco @ (cco @ XE @ XG @ (ccof @ XR)) @ (cco @ XF @ XH @ (ccof @ XR)) @ ccconcat)))))))))))))))))).
...
thf(aofcof_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwcel @ XC @ XW)) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XC @ (ccofc @ XR)) @ (cco @ XF @ (ccxp @ XA2 @ (ccsn @ XC)) @ (ccof @ XR)))))))))))))))).
...
thf(accatmulgnn0dir_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XA2 @ (ccxp @ (cco @ ccc0 @ XM @ ccfzo) @ (ccsn @ XK))) => ((cwceq @ XB2 @ (ccxp @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XK))) => ((cwceq @ XC @ (ccxp @ (cco @ ccc0 @ (cco @ XM @ XN @ ccaddc) @ ccfzo) @ (ccsn @ XK))) => ((cwi @ Xph @ (cwcel @ XK @ XS)) => ((cwi @ Xph @ (cwcel @ XM @ ccn0)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccconcat) @ XC))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (cwi @ Xps @ Xph))))).
thf(cofcccat_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XF @ (ccword @ XS))) => ((cwi @ Xph @ (cwcel @ XG @ (ccword @ XS))) => ((cwi @ Xph @ (cwcel @ XK @ XT)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XF @ XG @ ccconcat) @ XK @ (ccofc @ XR)) @ (cco @ (cco @ XF @ XK @ (ccofc @ XR)) @ (cco @ XG @ XK @ (ccofc @ XR)) @ ccconcat)))))))))))))).
