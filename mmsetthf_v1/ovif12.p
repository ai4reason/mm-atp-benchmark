...
thf(covif12_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwceq @ (cco @ (ccif @ Xph @ XA2 @ XB2) @ (ccif @ Xph @ XC @ XD) @ XF) @ (ccif @ Xph @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XD @ XF)))))))))).
