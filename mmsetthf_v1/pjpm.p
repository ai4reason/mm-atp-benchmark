...
thf(apjfval_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => ((cwceq @ Xc_pe @ (ccfv @ XW @ ccocv)) => ((cwceq @ XP @ (ccfv @ XW @ ccpj1)) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ XW @ ccpj))) => (! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccin @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XP))) @ (ccxp @ ccvv @ (cco @ XV @ XV @ ccmap))))))))))))))))).
...
thf(aelpm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwb @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ ccpm)) @ (cwa @ (cwfun @ XF) @ (cwss @ XF @ (ccxp @ XB2 @ XA2)))))))))).
...
thf(cpjpm_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ XL @ (ccfv @ XW @ cclss)) => ((cwceq @ XK @ (ccfv @ XW @ ccpj)) => (cwcel @ XK @ (cco @ (cco @ XV @ XV @ ccmap) @ XL @ ccpm)))))))))).
