...
thf(clgslem2_conj,conjecture,(! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XZ @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cc1 @ ccle)) @ (^ [Xx3:$i] : ccz)))) => (! [Xx3:$i] : (cw3a @ (cwcel @ (ccneg @ cc1) @ (XZ @ Xx3)) @ (cwcel @ ccc0 @ (XZ @ Xx3)) @ (cwcel @ cc1 @ (XZ @ Xx3))))))).
