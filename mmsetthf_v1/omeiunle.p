...
thf(aomeunile_thm,axiom,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwi @ Xph @ (cwss @ XY @ (ccpw @ XX))) => ((cwi @ Xph @ (cwbr @ XY @ ccom @ ccdom)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccuni @ XY) @ XO) @ (ccfv @ (ccres @ XO @ XY) @ ccsumge0) @ ccle))))))))))).
...
thf(asge0resrn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XV)) => ((cwi @ Xph @ (cwf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwf @ XA2 @ XB2 @ XG)) => ((cwi @ Xph @ (cwwe @ XA2 @ XR)) => (cwi @ Xph @ (cwbr @ (ccfv @ (ccres @ XF @ (ccrn @ XG)) @ ccsumge0) @ (ccfv @ (cccom @ XF @ XG) @ ccsumge0) @ ccle)))))))))))))).
