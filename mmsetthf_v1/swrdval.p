...
thf(cswrdval_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XF @ ccz) @ (cwcel @ XL @ ccz)) @ (cwceq @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) @ (ccif @ (cwss @ (cco @ XF @ XL @ ccfzo) @ (ccdm @ XS)) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ XL @ XF @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XF @ ccaddc) @ XS))) @ cc0)))))))).
