...
thf(clmhmfgima_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XT @ (ccima @ XF @ XA2) @ ccress)) => ((cwceq @ XX @ (cco @ XS @ XA2 @ ccress)) => ((cwceq @ XU @ (ccfv @ XS @ cclss)) => ((cwi @ Xph @ (cwcel @ XX @ cclfig)) => ((cwi @ Xph @ (cwcel @ XA2 @ XU)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm))) => (cwi @ Xph @ (cwcel @ XY @ cclfig))))))))))))))))).
