...
thf(arintn0_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwss @ XX @ (ccpw @ XA2)) @ (cwne @ XX @ cc0)) @ (cwceq @ (ccin @ XA2 @ (ccint @ XX)) @ (ccint @ XX)))))).
thf(amreintcl_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XS @ XC) @ (cwne @ XS @ cc0)) @ (cwcel @ (ccint @ XS) @ XC)))))).
thf(cmrerintcl_conj,conjecture,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XS @ XC)) @ (cwcel @ (ccin @ XX @ (ccint @ XS)) @ XC)))))).
