...
thf(cfsuppsssupp_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XG @ XV) @ (cwfun @ XG)) @ (cwa @ (cwbr @ XF @ XZ @ ccfsupp) @ (cwss @ (cco @ XG @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp)))) @ (cwbr @ XG @ XZ @ ccfsupp))))))).
