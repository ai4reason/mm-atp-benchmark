...
thf(afallfacp1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) @ (cco @ (cco @ XA2 @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccmin) @ ccmul)))))).
...
thf(afallfacp1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) @ (cco @ (cco @ XA2 @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccmin) @ ccmul))))))))).
...
thf(abinomfallfaclem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ (cwa @ Xph @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz))) @ (cwcel @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ XK @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccaddc) @ ccfallfac) @ ccmul) @ ccmul) @ ccc))))))))))).
