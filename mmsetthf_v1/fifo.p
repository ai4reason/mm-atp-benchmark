...
thf(cfifo_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XF @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccsn @ cc0))) @ (^ [Xy1:$i] : (ccint @ (ccv @ Xy1)))))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ XV) @ (cwfo @ (ccdif @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccsn @ cc0)) @ (ccfv @ XA2 @ ccfi) @ (XF @ Xy1))))))))).
