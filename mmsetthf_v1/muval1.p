...
thf(amuval_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwceq @ (ccfv @ XA2 @ ccmu) @ (ccif @ (cwrex @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ cc2 @ ccexp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccc0 @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ cchash) @ ccexp)))))).
...
thf(advdssqlem_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwbr @ XM @ XN @ ccdvds) @ (cwbr @ (cco @ XM @ cc2 @ ccexp) @ (cco @ XN @ cc2 @ ccexp) @ ccdvds)))))).
...
thf(cmuval1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XP @ (ccfv @ cc2 @ ccuz)) @ (cwbr @ (cco @ XP @ cc2 @ ccexp) @ XA2 @ ccdvds)) @ (cwceq @ (ccfv @ XA2 @ ccmu) @ ccc0))))).
