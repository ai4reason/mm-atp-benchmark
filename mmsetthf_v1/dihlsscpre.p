...
thf(adihvalc_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xc_po:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XB2 @ Xu @ Xq) @ (ccfv @ XK @ ccbs)))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (Xc_le @ Xu @ Xq) @ (ccfv @ XK @ ccple)))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (Xc_or @ Xu @ Xq) @ (ccfv @ XK @ ccjn)))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (Xc_an @ Xu @ Xq) @ (ccfv @ XK @ ccmee)))) => ((! [Xu:$i] : (cwceq @ (XA2 @ Xu) @ (ccfv @ XK @ ccatm))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XH @ Xu @ Xq) @ (ccfv @ XK @ cclh)))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XI @ Xu @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ ccdih))))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XD @ Xu @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ ccdib))))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XC @ Xu @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ ccdic))))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XU @ Xu @ Xq) @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (XS @ Xq) @ (ccfv @ (XU @ Xu @ Xq) @ cclss)))) => ((! [Xu:$i] : (! [Xq:$i] : (cwceq @ (Xc_po @ Xu @ Xq) @ (ccfv @ (XU @ Xu @ Xq) @ cclsm)))) => (! [Xu:$i] : (! [Xq:$i] : (cwi @ (cwa @ (cwa @ (cwcel @ XK @ (XV @ Xu @ Xq)) @ (cwcel @ XW @ (XH @ Xu @ Xq))) @ (cwa @ (cwcel @ XX @ (XB2 @ Xu @ Xq)) @ (cwn @ (cwbr @ XX @ XW @ (Xc_le @ Xu @ Xq))))) @ (cwceq @ (ccfv @ XX @ (XI @ Xu @ Xq)) @ (ccrio @ (^ [Xu:$i] : (cwral @ (^ [Xq:$i] : (cwi @ (cwa @ (cwn @ (cwbr @ (ccv @ Xq) @ XW @ (Xc_le @ Xu @ Xq))) @ (cwceq @ (cco @ (ccv @ Xq) @ (cco @ XX @ XW @ (Xc_an @ Xu @ Xq)) @ (Xc_or @ Xu @ Xq)) @ XX)) @ (cwceq @ (ccv @ Xu) @ (cco @ (ccfv @ (ccv @ Xq) @ (XC @ Xu @ Xq)) @ (ccfv @ (cco @ XX @ XW @ (Xc_an @ Xu @ Xq)) @ (XD @ Xu @ Xq)) @ (Xc_po @ Xu @ Xq))))) @ (^ [Xq:$i] : (XA2 @ Xu)))) @ (^ [Xu:$i] : (XS @ Xq)))))))))))))))))))))))))))))))))))).
...
thf(adihjust_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((cwceq @ XJ @ (ccfv @ XW @ (ccfv @ XK @ ccdic))) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le))) @ (cwa @ (cwcel @ XR @ XA2) @ (cwn @ (cwbr @ XR @ XW @ Xc_le))) @ (cwcel @ XX @ XB2)) @ (cwceq @ (cco @ XQ @ (cco @ XX @ XW @ Xc_an) @ Xc_or) @ (cco @ XR @ (cco @ XX @ XW @ Xc_an) @ Xc_or))) @ (cwceq @ (cco @ (ccfv @ XQ @ XJ) @ (ccfv @ (cco @ XX @ XW @ Xc_an) @ XI) @ Xc_po) @ (cco @ (ccfv @ XR @ XJ) @ (ccfv @ (cco @ XX @ XW @ Xc_an) @ XI) @ Xc_po))))))))))))))))))))))))))))).
...
thf(areusv3_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwb @ (Xph @ Xy1) @ (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz)) @ (cwceq @ (XC @ Xy1) @ (XD @ Xz))))) => (cwi @ (cwrex @ (^ [Xy1:$i] : (cwa @ (Xph @ Xy1) @ (cwcel @ (XC @ Xy1) @ XA2))) @ (^ [Xy1:$i] : XB2)) @ (cwb @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (Xps @ Xz)) @ (cwceq @ (XC @ Xy1) @ (XD @ Xz)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))))))).
...
thf(cdihlsscpre_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ Xc_an @ (ccfv @ XK @ ccmee)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cwceq @ XD @ (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((cwceq @ XC @ (ccfv @ XW @ (ccfv @ XK @ ccdic))) => ((cwceq @ XU @ (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((cwceq @ XS @ (ccfv @ XU @ cclss)) => ((cwceq @ Xc_po @ (ccfv @ XU @ cclsm)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwn @ (cwbr @ XX @ XW @ Xc_le)))) @ (cwcel @ (ccfv @ XX @ XI) @ XS)))))))))))))))))))))))))))))).
