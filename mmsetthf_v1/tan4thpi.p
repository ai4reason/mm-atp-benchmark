...
thf(asincos4thpi_thm,axiom,(cwa @ (cwceq @ (ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ ccsin) @ (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)) @ (cwceq @ (ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ cccos) @ (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)))).
...
thf(ctan4thpi_conj,conjecture,(cwceq @ (ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ cctan) @ cc1)).
