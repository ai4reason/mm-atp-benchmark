...
thf(ccfss_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwlim @ XA2) @ (cwex @ (^ [Xx3:$i] : (cw3a @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ cccf) @ ccen) @ (cwceq @ (ccuni @ (ccv @ Xx3)) @ XA2)))))))).
