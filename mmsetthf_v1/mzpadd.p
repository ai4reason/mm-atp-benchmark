...
thf(cmzpadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ XV @ ccmzp)) @ (cwcel @ XB2 @ (ccfv @ XV @ ccmzp))) @ (cwcel @ (cco @ XA2 @ XB2 @ (ccof @ ccaddc)) @ (ccfv @ XV @ ccmzp))))))).
