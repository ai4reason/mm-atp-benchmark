...
thf(ccsbieb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => (! [Xx3:$i] : (cwb @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xx3))))) @ (cwceq @ (ccsb @ XA2 @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (XC @ Xx3)))))))))).
