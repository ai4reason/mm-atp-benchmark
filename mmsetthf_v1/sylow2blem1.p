...
thf(agrplmulf1o_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XX @ (ccv @ Xx3) @ Xc_pl))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ XB2)) @ (cwf1o @ XB2 @ XB2 @ (XF @ Xx3))))))))))))).
thf(af1of1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwf1 @ XA2 @ XB2 @ XF)))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(af1ssres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwss @ XC @ XA2)) @ (cwf1 @ XC @ XB2 @ (ccres @ XF @ XC)))))))).
...
thf(aeqgen_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_sm @ (cco @ XG @ XY @ ccqg)) => (cwi @ (cwa @ (cwcel @ XY @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XA2 @ (ccqs @ XX @ Xc_sm))) @ (cwbr @ XY @ XA2 @ ccen)))))))))).
...
thf(csylow2blem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ XX @ ccfn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ XH @ (ccfv @ XG @ ccsubg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (Xph @ Xx3 @ Xy1) @ (cwcel @ XK @ (ccfv @ XG @ ccsubg))))) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_sm @ (cco @ XG @ XK @ ccqg)) => ((cwceq @ Xc_x @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XH)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (Xph @ Xx3 @ Xy1) @ (cwcel @ XB2 @ XH) @ (cwcel @ XC @ XX)) @ (cwceq @ (cco @ XB2 @ (ccec @ XC @ Xc_sm) @ Xc_x) @ (ccec @ (cco @ XB2 @ XC @ Xc_pl) @ Xc_sm))))))))))))))))))))))).
