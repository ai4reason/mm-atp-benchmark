...
thf(c_1pmatscmul_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XC @ (cco @ XN @ XP @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XE @ (ccfv @ XP @ ccbs)) => ((cwceq @ Xc_as @ (ccfv @ XC @ ccvsca)) => ((cwceq @ Xc_1 @ (ccfv @ XC @ ccur)) => (cwi @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XQ @ XE)) @ (cwcel @ (cco @ XQ @ Xc_1 @ Xc_as) @ XB2)))))))))))))))))).
