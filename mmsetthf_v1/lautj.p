...
thf(alautcl_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XF @ XI)) @ (cwcel @ XX @ XB2)) @ (cwcel @ (ccfv @ XX @ XF) @ XB2))))))))))).
...
thf(alaut1o_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cwcel @ XK @ XA2) @ (cwcel @ XF @ XI)) @ (cwf1o @ XB2 @ XB2 @ XF)))))))))).
...
thf(alautle_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XF @ XI)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwb @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ Xc_le))))))))))))))).
...
thf(alautcnvle_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cwa @ (cwcel @ XK @ XV) @ (cwcel @ XF @ XI)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwb @ (cwbr @ XX @ XY @ Xc_le) @ (cwbr @ (ccfv @ XX @ (cccnv @ XF)) @ (ccfv @ XY @ (cccnv @ XF)) @ Xc_le))))))))))))))).
thf(ampbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ (cwb @ Xps @ Xch)) => (cwi @ Xph @ Xch))))))).
thf(clautj_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XI @ (ccfv @ XK @ cclaut)) => (cwi @ (cwa @ (cwcel @ XK @ cclat) @ (cw3a @ (cwcel @ XF @ XI) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_or) @ XF) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ Xc_or)))))))))))))).
