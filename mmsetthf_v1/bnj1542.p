...
thf(cbnj1542_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwfn @ (XF @ Xx3) @ (XA2 @ Xw))))) => ((! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwfn @ XG @ (XA2 @ Xw))))) => ((! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwne @ (XF @ Xx3) @ XG)))) => ((! [Xx3:$i] : (! [Xw:$i] : (cwi @ (cwcel @ (ccv @ Xw) @ (XF @ Xx3)) @ (cwal @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xw) @ (XF @ Xx3))))))) => (! [Xx3:$i] : (! [Xw:$i] : (cwi @ (Xph @ Xx3 @ Xw) @ (cwrex @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : (XA2 @ Xw))))))))))))))).
