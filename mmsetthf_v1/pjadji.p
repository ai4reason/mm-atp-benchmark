...
thf(cpjadji_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwi @ (cwa @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) @ (cwceq @ (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ XB2 @ ccsp) @ (cco @ XA2 @ (ccfv @ XB2 @ (ccfv @ XH @ ccpjh)) @ ccsp)))))))).
