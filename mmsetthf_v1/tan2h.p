...
thf(asin2h_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ cc2 @ ccpi @ ccmul) @ ccicc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) @ (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccmin) @ cc2 @ ccdiv) @ ccsqrt))))).
...
thf(acos2h_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ cccos) @ (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccaddc) @ cc2 @ ccdiv) @ ccsqrt))))).
thf(ccrp_tp,type,(ccrp : ($i > $o))).
thf(asqrtdivd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccsqrt) @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ ccdiv)))))))))).
...
thf(ahalfnneg2_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwb @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ (cco @ XA2 @ cc2 @ ccdiv) @ ccle))))).
...
thf(ctan2h_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccico)) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ cctan) @ (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccmin) @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccaddc) @ ccdiv) @ ccsqrt))))).
