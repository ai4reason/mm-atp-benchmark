...
thf(celmapintab_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (cwb @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))))))) => ((! [Xx3:$i] : (cwb @ (cwcel @ XA2 @ (XE @ Xx3)) @ (cwa @ (cwcel @ XA2 @ XC) @ (cwcel @ (ccfv @ XA2 @ XF) @ (ccv @ Xx3))))) => (! [Xx3:$i] : (cwb @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ (cwa @ (cwcel @ XA2 @ XC) @ (cwal @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (cwcel @ XA2 @ (XE @ Xx3))))))))))))))))).
