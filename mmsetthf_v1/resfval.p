...
thf(adf_resf_ax,axiom,(cwceq @ ccresf @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xh:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xh:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xh:$i] : (ccop @ (ccres @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (ccdm @ (ccdm @ (ccv @ Xh)))) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xh))) @ (^ [Xx3:$i] : (ccres @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xf1) @ cc2nd)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xh))))))))))).
...
thf(cresfval_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XF @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XH @ (XW @ Xx3)))) => (cwi @ Xph @ (cwceq @ (cco @ XF @ XH @ ccresf) @ (ccop @ (ccres @ (ccfv @ XF @ cc1st) @ (ccdm @ (ccdm @ XH))) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ XH)) @ (^ [Xx3:$i] : (ccres @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ cc2nd)) @ (ccfv @ (ccv @ Xx3) @ XH))))))))))))))).
