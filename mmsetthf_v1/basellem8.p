...
thf(aexpnegd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ (ccneg @ XN) @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccdiv)))))))))).
...
thf(atangtx_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) @ (cwbr @ XA2 @ (ccfv @ XA2 @ cctan) @ cclt)))).
...
thf(abasellem5_thm,axiom,(! [XP:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => ((! [Xt:$i] : (! [Xj:$i] : (cwceq @ (XP @ Xt @ Xj) @ (ccmpt @ (^ [Xt:$i] : ccc) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ ccbc) @ (cco @ (ccneg @ cc1) @ (cco @ XM @ (ccv @ Xj) @ ccmin) @ ccexp) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccv @ Xj) @ ccexp) @ ccmul)))))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xn:$i] : (cwceq @ (XT @ Xt @ Xj @ Xn) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ ccpi @ ccmul) @ XN @ ccdiv) @ cctan) @ (ccneg @ cc2) @ ccexp))))))) => (cwi @ (cwcel @ XM @ ccn) @ (cwceq @ (ccsu @ (cco @ cc1 @ XM @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xk) @ ccpi @ ccmul) @ XN @ ccdiv) @ cctan) @ (ccneg @ cc2) @ ccexp))) @ (cco @ (cco @ (cco @ cc2 @ XM @ ccmul) @ (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccmin) @ ccmul) @ cc6 @ ccdiv))))))))))).
...
thf(asinltx_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccrp) @ (cwbr @ (ccfv @ XA2 @ ccsin) @ XA2 @ cclt)))).
