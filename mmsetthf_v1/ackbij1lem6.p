...
thf(cackbij1lem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ (cwcel @ XB2 @ (ccin @ (ccpw @ ccom) @ ccfn))) @ (cwcel @ (ccun @ XA2 @ XB2) @ (ccin @ (ccpw @ ccom) @ ccfn)))))).
