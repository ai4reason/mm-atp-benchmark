...
thf(cquotcan_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwceq @ XH @ (cco @ XF @ XG @ (ccof @ ccmul))) => (cwi @ (cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwne @ XG @ cc0p)) @ (cwceq @ (cco @ XH @ XG @ ccquot) @ XF)))))))).
