...
thf(ageomulcvg_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ (XF @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul))))) => (! [Xk:$i] : (cwi @ (cwa @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) @ (cwcel @ (ccseq @ ccaddc @ (XF @ Xk) @ ccc0) @ (ccdm @ ccli)))))))).
