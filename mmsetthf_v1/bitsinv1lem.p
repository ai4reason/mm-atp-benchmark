...
thf(adiveq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1)) => (cwi @ Xph @ (cwceq @ XA2 @ XB2)))))))))).
...
thf(adiveq0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0)) => (cwi @ Xph @ (cwceq @ XA2 @ ccc0)))))))))).
...
thf(cbitsinv1lem_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0)) @ (cwceq @ (cco @ XN @ (cco @ cc2 @ (cco @ XM @ cc1 @ ccaddc) @ ccexp) @ ccmo) @ (cco @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccmo) @ (ccif @ (cwcel @ XM @ (ccfv @ XN @ ccbits)) @ (cco @ cc2 @ XM @ ccexp) @ ccc0) @ ccaddc)))))).
