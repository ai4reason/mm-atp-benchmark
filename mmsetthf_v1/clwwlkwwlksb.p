...
thf(afstwrdne_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)) @ (cwcel @ (ccfv @ ccc0 @ XW) @ XV))))).
...
thf(aelfzom1elfzo_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(accat0_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2))) @ (cwb @ (cwceq @ (cco @ XS @ XT @ ccconcat) @ cc0) @ (cwa @ (cwceq @ XS @ cc0) @ (cwceq @ XT @ cc0)))))))).
...
thf(accatalpha_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccword @ ccvv)) @ (cwcel @ XB2 @ (ccword @ ccvv))) @ (cwb @ (cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccword @ XS)) @ (cwa @ (cwcel @ XA2 @ (ccword @ XS)) @ (cwcel @ XB2 @ (ccword @ XS))))))))).
...
thf(cclwwlkwwlksb_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0)) @ (cwb @ (cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) @ (cwcel @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat) @ (ccfv @ XG @ ccwwlks))))))))).
