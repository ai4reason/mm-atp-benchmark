...
thf(agamf_thm,axiom,(cwf @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)) @ ccc @ ccgam)).
thf(cgamcl_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) @ (cwcel @ (ccfv @ XA2 @ ccgam) @ ccc)))).
