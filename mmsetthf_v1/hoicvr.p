...
thf(admfco_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfun @ XG) @ (cwcel @ XA2 @ (ccdm @ XG))) @ (cwb @ (cwcel @ XA2 @ (ccdm @ (cccom @ XF @ XG))) @ (cwcel @ (ccfv @ XA2 @ XG) @ (ccdm @ XF)))))))).
...
thf(choicvr_conj,conjecture,(! [Xph:$o] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XI @ Xx3 @ Xi @ Xj) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (ccneg @ (ccv @ Xj)) @ (ccv @ Xj)))))))))) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => (! [Xx3:$i] : (cwi @ Xph @ (cwss @ (cco @ ccr @ XX @ ccmap) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (XI @ Xx3 @ Xi @ Xj))))))))))))))))).
