...
thf(afusgreg2wsplem_thm,axiom,(! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xp:$i] : ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : (! [Xa:$i] : (cwceq @ (XM @ Xw @ Xa) @ (ccmpt @ (^ [Xa:$i] : (XV @ Xw)) @ (^ [Xa:$i] : (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ cc1 @ (ccv @ Xw)) @ (ccv @ Xa))) @ (^ [Xw:$i] : (cco @ cc2 @ XG @ ccwwspthsn)))))))) => (! [Xw:$i] : (! [Xa:$i] : (cwi @ (cwcel @ XN @ (XV @ Xw)) @ (cwb @ (cwcel @ (ccv @ Xp) @ (ccfv @ XN @ (XM @ Xw @ Xa))) @ (cwa @ (cwcel @ (ccv @ Xp) @ (cco @ cc2 @ XG @ ccwwspthsn)) @ (cwceq @ (ccfv @ cc1 @ (ccv @ Xp)) @ XN)))))))))))))).
...
thf(awspthsnwspthsnon_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwb @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwspthsn)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwspthsnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
...
thf(ausgr2wspthon_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : (cwceq @ (XE @ Xb) @ (ccfv @ XG @ ccedg))) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV))) @ (cwb @ (cwcel @ XT @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))) @ (cwrex @ (^ [Xb:$i] : (cwa @ (cwa @ (cwceq @ XT @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) @ (cwne @ XA2 @ XC)) @ (cwa @ (cwcel @ (ccpr @ XA2 @ (ccv @ Xb)) @ (XE @ Xb)) @ (cwcel @ (ccpr @ (ccv @ Xb) @ XC) @ (XE @ Xb))))) @ (^ [Xb:$i] : XV))))))))))))).
...
thf(arspcebdv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwb @ (Xps @ Xx3) @ Xch))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (Xps @ Xx3)) @ (cwceq @ (ccv @ Xx3) @ XA2))) => (cwi @ Xph @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) @ Xch))))))))))).
...
thf(as3eq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwceq @ XB2 @ XD) @ (cwceq @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XA2 @ XD @ XC)))))))).
...
thf(aumgrpredgv_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccumgr) @ (cwcel @ (ccpr @ XM @ XN) @ XE)) @ (cwa @ (cwcel @ XM @ XV) @ (cwcel @ XN @ XV))))))))))).
...
thf(adfiunv2_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (cwceq @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))))))))))).
thf(cfusgr2wsp2nb_conj,conjecture,(! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xw:$i] : (cwceq @ (XV @ Xw) @ (ccfv @ XG @ ccvtx))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xa:$i] : (cwceq @ (XM @ Xx3 @ Xy1 @ Xw @ Xa) @ (ccmpt @ (^ [Xa:$i] : (XV @ Xw)) @ (^ [Xa:$i] : (ccrab @ (^ [Xw:$i] : (cwceq @ (ccfv @ cc1 @ (ccv @ Xw)) @ (ccv @ Xa))) @ (^ [Xw:$i] : (cco @ cc2 @ XG @ ccwwspthsn)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xa:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ (XV @ Xw))) @ (cwceq @ (ccfv @ XN @ (XM @ Xx3 @ Xy1 @ Xw @ Xa)) @ (cciun @ (^ [Xx3:$i] : (cco @ XG @ XN @ ccnbgr)) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (ccdif @ (cco @ XG @ XN @ ccnbgr) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccsn @ (ccs3 @ (ccv @ Xx3) @ XN @ (ccv @ Xy1)))))))))))))))))))).
