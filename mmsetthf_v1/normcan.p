...
thf(cnormcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ cchil) @ (cwne @ XB2 @ cc0v) @ (cwcel @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn))) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ (ccfv @ XB2 @ ccno) @ cc2 @ ccexp) @ ccdiv) @ XB2 @ ccsm) @ XA2))))).
