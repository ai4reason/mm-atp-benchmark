...
thf(asmodm2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwsmo @ XF)) @ (cword @ XA2))))).
...
thf(asmoword_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwfn @ XF @ XA2) @ (cwsmo @ XF)) @ (cwa @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XA2))) @ (cwb @ (cwss @ XC @ XD) @ (cwss @ (ccfv @ XC @ XF) @ (ccfv @ XD @ XF))))))))).
...
thf(ccoftr_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (cwceq @ (XH @ Xx3 @ Xy1 @ Xz @ Xt @ Xf1 @ Xg1 @ Xn) @ (ccmpt @ (^ [Xt:$i] : (XC @ Xx3 @ Xy1 @ Xn)) @ (^ [Xt:$i] : (ccint @ (ccrab @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)))) @ (^ [Xn:$i] : (XB2 @ Xz)))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xn:$i] : (cwi @ (cwex @ (^ [Xf1:$i] : (cw3a @ (cwf @ (XB2 @ Xz) @ (XA2 @ Xy1 @ Xt @ Xh @ Xn) @ (ccv @ Xf1)) @ (cwsmo @ (ccv @ Xf1)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (XB2 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xt @ Xh @ Xn)))))) @ (cwi @ (cwex @ (^ [Xg1:$i] : (cwa @ (cwf @ (XC @ Xx3 @ Xy1 @ Xn) @ (XA2 @ Xy1 @ Xt @ Xh @ Xn) @ (ccv @ Xg1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xg1)))) @ (^ [Xw:$i] : (XC @ Xx3 @ Xy1 @ Xn)))) @ (^ [Xz:$i] : (XA2 @ Xy1 @ Xt @ Xh @ Xn)))))) @ (cwex @ (^ [Xh:$i] : (cwa @ (cwf @ (XC @ Xx3 @ Xy1 @ Xn) @ (XB2 @ Xz) @ (ccv @ Xh)) @ (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xh)))) @ (^ [Xw:$i] : (XC @ Xx3 @ Xy1 @ Xn)))) @ (^ [Xs1:$i] : (XB2 @ Xz)))))))))))))))))))).
