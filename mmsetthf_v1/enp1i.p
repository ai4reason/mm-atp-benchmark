...
thf(cenp1i_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwcel @ (XM @ Xx3) @ ccom)) => ((! [Xx3:$i] : (cwceq @ XN @ (ccsuc @ (XM @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwbr @ (ccdif @ XA2 @ (ccsn @ (ccv @ Xx3))) @ (XM @ Xx3) @ ccen) @ (Xph @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwi @ (Xph @ Xx3) @ (Xps @ Xx3)))) => (cwi @ (cwbr @ XA2 @ XN @ ccen) @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3)))))))))))))).
