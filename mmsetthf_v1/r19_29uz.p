...
thf(cr19_29uz_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => (cwi @ (cwa @ (cwral @ (^ [Xk:$i] : (Xph @ Xk)) @ (^ [Xk:$i] : XZ)) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xps @ Xj @ Xk)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwa @ (Xph @ Xk) @ (Xps @ Xj @ Xk))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))))))))).
