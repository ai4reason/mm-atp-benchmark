...
thf(algsquad2_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwn @ (cwbr @ cc2 @ XM @ ccdvds))) => ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds))) => ((cwi @ Xph @ (cwceq @ (cco @ XM @ XN @ ccgcd) @ cc1)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XM @ XN @ cclgs) @ (cco @ XN @ XM @ cclgs) @ ccmul) @ (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp)))))))))))).
...
thf(clgsquad3_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XM @ ccn) @ (cwn @ (cwbr @ cc2 @ XM @ ccdvds))) @ (cwa @ (cwcel @ XN @ ccn) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)))) @ (cwceq @ (cco @ XM @ XN @ cclgs) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp) @ (cco @ XN @ XM @ cclgs) @ ccmul)))))).
