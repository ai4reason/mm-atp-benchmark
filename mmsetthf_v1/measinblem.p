...
thf(cmeasinblem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwcel @ XA2 @ XS)) @ (cwcel @ XB2 @ (ccpw @ XS))) @ (cwa @ (cwbr @ XB2 @ ccom @ ccdom) @ (cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) @ (cwceq @ (ccfv @ (ccin @ (ccuni @ XB2) @ XA2) @ XM) @ (ccesum @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ XM)))))))))).
