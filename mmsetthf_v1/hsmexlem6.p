...
thf(arankr1ag_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwcel @ XB2 @ (ccdm @ ccr1))) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) @ (cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2)))))).
thf(chsmexlem6_conj,conjecture,(! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwcel @ (XX @ Xx3 @ Xy1 @ Xc @ Xd) @ ccvv))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (XH @ Xx3 @ Xy1 @ Xz @ Xb) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ (XX @ Xx3 @ Xy1 @ Xc @ Xd) @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ (XX @ Xx3 @ Xy1 @ Xc @ Xd)) @ cchar)) @ ccom)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwceq @ (XU @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (XS @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwbr @ (ccv @ Xb) @ (XX @ Xx3 @ Xy1 @ Xc @ Xd) @ ccdom)) @ (^ [Xb:$i] : (ccfv @ (ccsn @ (ccv @ Xa)) @ cctc)))) @ (^ [Xa:$i] : (ccuni @ (ccima @ ccr1 @ ccon0)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwceq @ (XO @ Xx3 @ Xy1 @ Xz @ Xa @ Xb @ Xc @ Xd) @ (ccoi @ (ccima @ ccrnk @ (ccfv @ (ccv @ Xc) @ (ccfv @ (ccv @ Xd) @ (XU @ Xx3 @ Xy1 @ Xz @ Xa @ Xb)))) @ ccep))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (cwcel @ (XS @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) @ ccvv))))))))))))))))).
