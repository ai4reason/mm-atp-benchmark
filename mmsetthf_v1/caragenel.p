...
thf(ccaragenel_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwcel @ XO @ ccome))) => ((! [Xa:$i] : (cwceq @ (XS @ Xa) @ (ccfv @ XO @ cccaragen))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwb @ (cwcel @ XE @ (XS @ Xa)) @ (cwa @ (cwcel @ XE @ (ccpw @ (ccuni @ (ccdm @ XO)))) @ (cwral @ (^ [Xa:$i] : (cwceq @ (cco @ (ccfv @ (ccin @ (ccv @ Xa) @ XE) @ XO) @ (ccfv @ (ccdif @ (ccv @ Xa) @ XE) @ XO) @ ccxad) @ (ccfv @ (ccv @ Xa) @ XO))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ XO)))))))))))))))).
