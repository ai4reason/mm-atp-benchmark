...
thf(acomfeqd_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwceq @ (ccfv @ XC @ ccco) @ (ccfv @ XD @ ccco))) => ((cwi @ Xph @ (cwceq @ (ccfv @ XC @ cchomf) @ (ccfv @ XD @ cchomf))) => (cwi @ Xph @ (cwceq @ (ccfv @ XC @ cccomf) @ (ccfv @ XD @ cccomf))))))))).
