...
thf(aiccpartgt_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (cwi @ Xph @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwbr @ (ccv @ Xi) @ (ccv @ Xj) @ cclt) @ (cwbr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XP) @ cclt))) @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))).
...
thf(axrltnsym_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwi @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwn @ (cwbr @ XB2 @ XA2 @ cclt))))))).
thf(a_3ad2ant2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwi @ Xph @ Xch) => (cwi @ (cw3a @ Xps @ Xph @ Xth) @ Xch))))))).
thf(aax_1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ Xph @ (cwi @ Xps @ Xph))))).
thf(ciccpartnel_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => ((cwi @ Xph @ (cwcel @ XX @ (ccrn @ XP))) => (cwi @ (cwa @ Xph @ (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo))) @ (cwn @ (cwcel @ XX @ (cco @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP) @ ccioo))))))))))))).
