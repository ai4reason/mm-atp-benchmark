...
thf(ahmphsym_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwi @ (cwbr @ XJ @ XK @ cchmph) @ (cwbr @ XK @ XJ @ cchmph))))).
thf(cwb_tp,type,(cwb : ($o > ($o > $o)))).
thf(asylbi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ Xps) => ((cwi @ Xps @ Xch) => (cwi @ Xph @ Xch))))))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ahmph_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (cwb @ (cwbr @ XJ @ XK @ cchmph) @ (cwne @ (cco @ XJ @ XK @ cchmeo) @ cc0))))).
...
thf(chaushmphlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ (cwcel @ XJ @ XA2) @ (cwcel @ XJ @ cctop)) => ((! [Xf1:$i] : (cwi @ (cw3a @ (cwcel @ XJ @ XA2) @ (cwf1 @ (ccuni @ XK) @ (ccuni @ XJ) @ (ccv @ Xf1)) @ (cwcel @ (ccv @ Xf1) @ (cco @ XK @ XJ @ cccn))) @ (cwcel @ XK @ XA2))) => (cwi @ (cwbr @ XJ @ XK @ cchmph) @ (cwi @ (cwcel @ XJ @ XA2) @ (cwcel @ XK @ XA2))))))))).
