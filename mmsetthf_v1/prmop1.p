...
thf(cprmop1_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccprmo) @ (ccif @ (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ ccprime) @ (cco @ (ccfv @ XN @ ccprmo) @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (ccfv @ XN @ ccprmo)))))).
