...
thf(aeluni2f_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (! [Xx3:$i] : (cwb @ (cwcel @ (XA2 @ Xx3) @ (ccuni @ (XB2 @ Xx3))) @ (cwrex @ (^ [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(csmfresal_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccsalg)) => ((cwi @ Xph @ (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((cwceq @ XD @ (ccdm @ XF)) => ((! [Xe:$i] : (cwceq @ (XT @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xe)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xe:$i] : (ccpw @ ccr))))) => (! [Xe:$i] : (cwi @ Xph @ (cwcel @ (XT @ Xe) @ ccsalg))))))))))))).
