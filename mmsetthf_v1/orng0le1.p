...
thf(aorngsqr_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XR @ ccple)) => ((cwceq @ Xc_0 @ (ccfv @ XR @ cc0g)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (cwi @ (cwa @ (cwcel @ XR @ ccorng) @ (cwcel @ XX @ XB2)) @ (cwbr @ Xc_0 @ (cco @ XX @ XX @ Xc_x) @ Xc_le))))))))))))).
...
thf(corng0le1_conj,conjecture,(! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XF @ cc0g)) => ((cwceq @ Xc_1 @ (ccfv @ XF @ ccur)) => ((cwceq @ Xc_le @ (ccfv @ XF @ ccple)) => (cwi @ (cwcel @ XF @ ccorng) @ (cwbr @ Xc_0 @ Xc_1 @ Xc_le)))))))))).
