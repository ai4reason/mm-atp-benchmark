...
thf(alply1binom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_pl @ (ccfv @ XP @ ccplusg)) => ((cwceq @ Xc_xp @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmg)) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (cwceq @ Xc_ex @ (ccfv @ (XG @ Xk) @ ccmg))) => ((! [Xk:$i] : (cwceq @ (XB2 @ Xk) @ (ccfv @ XP @ ccbs))) => (! [Xk:$i] : (cwi @ (cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ (XB2 @ Xk))) @ (cwceq @ (cco @ XN @ (cco @ XX @ XA2 @ Xc_pl) @ Xc_ex) @ (cco @ XP @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu)))))))))))))))))))))))).
...
thf(clply1binomsc_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XX @ (ccfv @ XR @ ccv1)) => ((cwceq @ Xc_pl @ (ccfv @ XP @ ccplusg)) => ((cwceq @ Xc_xp @ (ccfv @ XP @ ccmulr)) => ((cwceq @ Xc_x @ (ccfv @ XP @ ccmg)) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (cwceq @ Xc_ex @ (ccfv @ (XG @ Xk) @ ccmg))) => ((cwceq @ XK @ (ccfv @ XR @ ccbs)) => ((cwceq @ XS @ (ccfv @ XP @ ccascl)) => ((! [Xk:$i] : (cwceq @ (XH @ Xk) @ (ccfv @ XR @ ccmgp))) => ((! [Xk:$i] : (cwceq @ (XE @ Xk) @ (ccfv @ (XH @ Xk) @ ccmg))) => (cwi @ (cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ XK)) @ (cwceq @ (cco @ XN @ (cco @ XX @ (ccfv @ XA2 @ XS) @ Xc_pl) @ Xc_ex) @ (cco @ XP @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (ccfv @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ (XE @ Xk)) @ XS) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu))))))))))))))))))))))))))))).
