...
thf(arspcedeq1vd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ XB2)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwceq @ (XC @ Xx3) @ XD))) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (XC @ Xx3) @ XD)) @ (^ [Xx3:$i] : XB2))))))))))).
...
thf(cmod2eq1n2dvds_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwceq @ (cco @ XN @ cc2 @ ccmo) @ cc1) @ (cwn @ (cwbr @ cc2 @ XN @ ccdvds)))))).
