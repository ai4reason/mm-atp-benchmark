...
thf(ar1ord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccon0) @ (cwi @ (cwcel @ XA2 @ XB2) @ (cwcel @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
...
thf(awfelirr_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) @ (cwn @ (cwcel @ XA2 @ XA2))))).
...
thf(cr1wunlim_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XA2 @ XV) @ (cwb @ (cwcel @ (ccfv @ XA2 @ ccr1) @ ccwun) @ (cwlim @ XA2)))))).
