...
thf(auznn0sub_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ XM @ ccuz)) @ (cwcel @ (cco @ XN @ XM @ ccmin) @ ccn0))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aexpge1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ cc1 @ XA2 @ ccle)) @ (cwbr @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccle))))).
...
thf(cleexp2a_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ ccle) @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) @ (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle)))))).
