...
thf(crecreclt_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt)) @ (cwa @ (cwbr @ (cco @ cc1 @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccaddc) @ ccdiv) @ cc1 @ cclt) @ (cwbr @ (cco @ cc1 @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccaddc) @ ccdiv) @ XA2 @ cclt))))).
