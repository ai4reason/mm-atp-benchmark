...
thf(aqdivcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccq) @ (cwcel @ XB2 @ ccq) @ (cwne @ XB2 @ ccc0)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ ccq))))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(aqaddcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccq) @ (cwcel @ XB2 @ ccq)) @ (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccq))))).
thf(cdp2clq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccq) => (cwcel @ (ccdp2 @ XA2 @ XB2) @ ccq)))))).
