...
thf(cfargshiftfo_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwfo @ (cco @ cc1 @ XN @ ccfz) @ (ccdm @ XE) @ XF)) @ (cwfo @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ (XG @ Xx3)))))))))).
