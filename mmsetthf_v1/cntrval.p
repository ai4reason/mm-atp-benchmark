...
thf(adf_cntr_ax,axiom,(cwceq @ cccntr @ (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccfv @ (ccfv @ (ccv @ Xm) @ ccbs) @ (ccfv @ (ccv @ Xm) @ cccntz)))))).
...
thf(ccntrval_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XZ @ (ccfv @ XM @ cccntz)) => (cwceq @ (ccfv @ XB2 @ XZ) @ (ccfv @ XM @ cccntr)))))))).
