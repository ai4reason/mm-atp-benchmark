...
thf(adf_dpj_ax,axiom,(cwceq @ ccdpj @ (ccmpt2 @ (^ [Xg1:$i] : (^ [Xs1:$i] : ccgrp)) @ (^ [Xg1:$i] : (^ [Xs1:$i] : (ccima @ (ccdm @ ccdprd) @ (ccsn @ (ccv @ Xg1))))) @ (^ [Xg1:$i] : (^ [Xs1:$i] : (ccmpt @ (^ [Xi:$i] : (ccdm @ (ccv @ Xs1))) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xs1)) @ (cco @ (ccv @ Xg1) @ (ccres @ (ccv @ Xs1) @ (ccdif @ (ccdm @ (ccv @ Xs1)) @ (ccsn @ (ccv @ Xi)))) @ ccdprd) @ (ccfv @ (ccv @ Xg1) @ ccpj1))))))))).
...
thf(cdpjfval_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cwi @ Xph @ (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((cwi @ Xph @ (cwceq @ (ccdm @ XS) @ XI)) => ((! [Xi:$i] : (cwceq @ (XP @ Xi) @ (cco @ XG @ XS @ ccdpj))) => ((! [Xi:$i] : (cwceq @ (XQ @ Xi) @ (ccfv @ XG @ ccpj1))) => (! [Xi:$i] : (cwi @ Xph @ (cwceq @ (XP @ Xi) @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ (ccv @ Xi)))) @ ccdprd) @ (XQ @ Xi)))))))))))))))))).
