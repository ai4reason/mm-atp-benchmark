...
thf(aunundir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwceq @ (ccun @ (ccun @ XA2 @ XB2) @ XC) @ (ccun @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XC))))))).
...
thf(aioounsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) @ (cwceq @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XB2)) @ (cco @ XA2 @ XB2 @ ccioc)))))).
...
thf(ciocunico_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XB2 @ cclt) @ (cwbr @ XB2 @ XC @ cclt))) @ (cwceq @ (ccun @ (cco @ XA2 @ XB2 @ ccioc) @ (cco @ XB2 @ XC @ ccico)) @ (cco @ XA2 @ XC @ ccioo))))))).
