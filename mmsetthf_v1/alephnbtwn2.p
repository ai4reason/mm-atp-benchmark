...
thf(aalephnbtwn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwceq @ (ccfv @ XB2 @ cccrd) @ XB2) @ (cwn @ (cwa @ (cwcel @ (ccfv @ XA2 @ ccale) @ XB2) @ (cwcel @ XB2 @ (ccfv @ (ccsuc @ XA2) @ ccale)))))))).
...
thf(calephnbtwn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwn @ (cwa @ (cwbr @ (ccfv @ XA2 @ ccale) @ XB2 @ ccsdm) @ (cwbr @ XB2 @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccsdm)))))).
