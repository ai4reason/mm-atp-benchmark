...
thf(auhgrn0_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XE @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccuhgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) @ (cwne @ (ccfv @ XF @ XE) @ cc0)))))))).
thf(aeldifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC))) @ (cwa @ (cwcel @ XA2 @ XB2) @ (cwne @ XA2 @ XC))))))).
thf(csubgruhgredgd_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XV @ (ccfv @ XS @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XS @ cciedg)) => ((cwi @ Xph @ (cwcel @ XG @ ccuhgr)) => ((cwi @ Xph @ (cwbr @ XS @ XG @ ccsubgr)) => ((cwi @ Xph @ (cwcel @ XX @ (ccdm @ XI))) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ XI) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)))))))))))))))).
