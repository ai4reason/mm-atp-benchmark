...
thf(cmeaiuninc_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccmea)) => ((cwi @ Xph @ (cwcel @ XN @ ccz)) => ((cwceq @ XZ @ (ccfv @ XN @ ccuz)) => ((cwi @ Xph @ (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xn) @ XZ)) @ (cwss @ (ccfv @ (ccv @ Xn) @ XE) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE)))) => ((cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xx3:$i] : ccr))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xx3 @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM)))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XS @ Xx3 @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ ccli)))))))))))))))))).
