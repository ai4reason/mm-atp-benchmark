...
thf(apredeq1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwceq @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ XA2 @ XS @ XX)))))))).
thf(ardgeq12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwceq @ XF @ XG) @ (cwceq @ XA2 @ XB2)) @ (cwceq @ (ccrdg @ XF @ XA2) @ (ccrdg @ XG @ XB2)))))))).
thf(adf_trpred_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwceq @ (cctrpred @ XA2 @ XR @ XX) @ (ccuni @ (ccrn @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xy1:$i] : (ccv @ Xa)) @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))))) @ (ccpred @ XA2 @ XR @ XX)) @ ccom)))))))).
thf(ctrpredeq1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwceq @ (cctrpred @ XA2 @ XR @ XX) @ (cctrpred @ XA2 @ XS @ XX)))))))).
