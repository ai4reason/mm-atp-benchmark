...
thf(ansnlplig_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccplig) @ (cwn @ (cwcel @ (ccsn @ XA2) @ XG)))))).
...
thf(cn0lplig_conj,conjecture,(! [XG:($i > $o)] : (cwi @ (cwcel @ XG @ ccplig) @ (cwn @ (cwcel @ cc0 @ XG))))).
