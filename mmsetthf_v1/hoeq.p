...
thf(choeq_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) @ (cwb @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccfv @ (ccv @ Xx3) @ XU))) @ (^ [Xx3:$i] : cchil)) @ (cwceq @ XT @ XU)))))).
