...
thf(clpss3_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwss @ XT @ XS)) @ (cwss @ (ccfv @ XT @ (ccfv @ XJ @ cclp)) @ (ccfv @ XS @ (ccfv @ XJ @ cclp)))))))))).
