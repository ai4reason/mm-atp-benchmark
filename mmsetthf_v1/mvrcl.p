...
thf(amvrcl2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XS @ (cco @ XI @ XR @ ccmps)) => ((cwceq @ XV @ (cco @ XI @ XR @ ccmvr)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ XV) @ XB2))))))))))))))))).
...
thf(cmvrcl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (cco @ XI @ XR @ ccmpl)) => ((cwceq @ XV @ (cco @ XI @ XR @ ccmvr)) => ((cwceq @ XB2 @ (ccfv @ XP @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XR @ ccrg)) => ((cwi @ Xph @ (cwcel @ XX @ XI)) => (cwi @ Xph @ (cwcel @ (ccfv @ XX @ XV) @ XB2))))))))))))))))).
