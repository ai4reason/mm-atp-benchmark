...
thf(atxflf_thm,axiom,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xn) @ (ccfv @ XX @ cctopon)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xn) @ (ccfv @ XY @ cctopon)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XL @ Xn) @ (ccfv @ XZ @ ccfil)))) => ((cwi @ Xph @ (cwf @ XZ @ XX @ XF)) => ((cwi @ Xph @ (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG)))))) => (! [Xn:$i] : (cwi @ Xph @ (cwb @ (cwcel @ (ccop @ (XR @ Xn) @ (XS @ Xn)) @ (ccfv @ (XH @ Xn) @ (cco @ (cco @ (XJ @ Xn) @ (XK @ Xn) @ cctx) @ (XL @ Xn) @ ccflf))) @ (cwa @ (cwcel @ (XR @ Xn) @ (ccfv @ XF @ (cco @ (XJ @ Xn) @ (XL @ Xn) @ ccflf))) @ (cwcel @ (XS @ Xn) @ (ccfv @ XG @ (cco @ (XK @ Xn) @ (XL @ Xn) @ ccflf)))))))))))))))))))))))))).
...
thf(aflfcnp_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) @ (cwa @ (cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) @ (cwcel @ XG @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))))) @ (cwcel @ (ccfv @ XA2 @ XG) @ (ccfv @ (cccom @ XG @ XF) @ (cco @ XK @ XL @ ccflf))))))))))))).
...
thf(cflfcnp2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xx3) @ (ccfv @ XX @ cctopon)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XK @ Xx3) @ (ccfv @ XY @ cctopon)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XL @ Xx3) @ (ccfv @ XZ @ ccfil)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XZ)) @ (cwcel @ (XA2 @ Xx3) @ XX))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XZ)) @ (cwcel @ (XB2 @ Xx3) @ XY))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XR @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ (XJ @ Xx3) @ (XL @ Xx3) @ ccflf))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ (XK @ Xx3) @ (XL @ Xx3) @ ccflf))))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XO @ (ccfv @ (ccop @ (XR @ Xx3) @ (XS @ Xx3)) @ (cco @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cctx) @ (XN @ Xx3) @ cccnp))))) => (! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (cco @ (XR @ Xx3) @ (XS @ Xx3) @ XO) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XO))) @ (cco @ (XN @ Xx3) @ (XL @ Xx3) @ ccflf))))))))))))))))))))))))))).
