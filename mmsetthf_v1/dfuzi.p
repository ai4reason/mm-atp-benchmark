...
thf(apeano5uzi_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwi @ (cwa @ (cwcel @ XN @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XA2)) @ (^ [Xx3:$i] : XA2))) @ (cwss @ (ccrab @ (^ [Xk:$i] : (cwbr @ XN @ (ccv @ Xk) @ ccle)) @ (^ [Xk:$i] : ccz)) @ XA2)))))).
...
thf(apeano2uz2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : ccz)))) @ (cwcel @ (cco @ XB2 @ cc1 @ ccaddc) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : ccz))))))).
...
thf(cdfuzi_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwceq @ (ccrab @ (^ [Xz:$i] : (cwbr @ XN @ (ccv @ Xz) @ ccle)) @ (^ [Xz:$i] : ccz)) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwa @ (cwcel @ XN @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))).
