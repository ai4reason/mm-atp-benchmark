...
thf(azcld_thm,axiom,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwcel @ ccz @ (ccfv @ XJ @ cccld))))).
...
thf(czcld2_conj,conjecture,(! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwcel @ ccz @ (ccfv @ XJ @ cccld))))).
