...
thf(adf_dvdsr_ax,axiom,(cwceq @ ccdsr @ (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccbs)) @ (cwrex @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccmulr)) @ (ccv @ Xy1))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xw) @ ccbs))))))))))).
...
thf(aopabex3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwi @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ ccvv))) => (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3 @ Xy1))))) @ ccvv)))))).
...
thf(cdvdsrval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pa:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xz:$i] : (cwceq @ (Xc_pa @ Xz) @ (ccfv @ XR @ ccdsr))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (! [Xz:$i] : (cwceq @ (Xc_pa @ Xz) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwrex @ (^ [Xz:$i] : (cwceq @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ Xc_x) @ (ccv @ Xy1))) @ (^ [Xz:$i] : XB2)))))))))))))))).
