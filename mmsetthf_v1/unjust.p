...
thf(cunjust_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccab @ (^ [Xx3:$i] : (cwo @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xx3) @ XB2)))) @ (ccab @ (^ [Xy1:$i] : (cwo @ (cwcel @ (ccv @ Xy1) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2)))))))).
