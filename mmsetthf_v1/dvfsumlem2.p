...
thf(aiccssioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwa @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XD @ XB2 @ cclt))) @ (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(advmptrecl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwi @ Xph @ (cwss @ XS @ ccr)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (XA2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (XB2 @ Xx3) @ ccr))))))))))))).
...
thf(alesubd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccle)) => (cwi @ Xph @ (cwbr @ XC @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))))))).
...
thf(advfsumlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (cwceq @ XS @ (cco @ (XT @ Xk) @ ccpnf @ ccioo))) => ((! [Xk:$i] : (cwceq @ (XZ @ Xk) @ (ccfv @ XM @ ccuz))) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => ((cwi @ Xph @ (cwcel @ XD @ ccr)) => ((cwi @ Xph @ (cwbr @ XM @ (cco @ XD @ cc1 @ ccaddc) @ ccle)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XT @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (XA2 @ Xx3 @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XS)) @ (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ (XZ @ Xk))) @ (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwceq @ (cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ ccdv) @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xk)) @ (cwceq @ (XB2 @ Xx3) @ (XC @ Xk))))) => ((cwi @ Xph @ (cwcel @ XU @ ccxr)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cw3a @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xk) @ XS)) @ (cw3a @ (cwbr @ XD @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xk) @ ccle) @ (cwbr @ (ccv @ Xk) @ XU @ ccle))) @ (cwbr @ (XC @ Xk) @ (XB2 @ Xx3) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwceq @ (XH @ Xx3 @ Xk) @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccmin) @ (XB2 @ Xx3) @ ccmul) @ (cco @ (ccsu @ (cco @ XM @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk))) @ (XA2 @ Xx3 @ Xk) @ ccmin) @ ccaddc)))))) => ((cwi @ Xph @ (cwcel @ XX @ XS)) => ((cwi @ Xph @ (cwcel @ XY @ XS)) => ((cwi @ Xph @ (cwbr @ XD @ XX @ ccle)) => ((cwi @ Xph @ (cwbr @ XX @ XY @ ccle)) => ((cwi @ Xph @ (cwbr @ XY @ XU @ ccle)) => ((cwi @ Xph @ (cwbr @ XY @ (cco @ (ccfv @ XX @ ccfl) @ cc1 @ ccaddc) @ ccle)) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwceq @ (ccfv @ XY @ (XH @ Xx3 @ Xk)) @ (cco @ (cco @ (cco @ (cco @ XY @ (ccfv @ XX @ ccfl) @ ccmin) @ (ccsb @ XY @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmul) @ (ccsb @ XY @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ ccmin) @ (ccsu @ (cco @ XM @ (ccfv @ XX @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk))) @ ccaddc)))))))))))))))))))))))))))))))))))))))).
...
thf(avtoclg1f_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ XA2) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3)))) => ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (Xps @ Xx3))))))))))).
...
thf(asuble0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => (cwi @ Xph @ (cwb @ (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ ccle) @ (cwbr @ XA2 @ XB2 @ ccle))))))))).
