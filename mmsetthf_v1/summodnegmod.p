...
thf(csummodnegmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccn)) @ (cwb @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccmo) @ ccc0) @ (cwceq @ (cco @ XA2 @ XN @ ccmo) @ (cco @ (ccneg @ XB2) @ XN @ ccmo)))))))).
