...
thf(advconst_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ ccc @ (ccxp @ ccc @ (ccsn @ XA2)) @ ccdv) @ (ccxp @ ccc @ (ccsn @ ccc0)))))).
...
thf(cdvcmulf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XX @ ccc @ XF)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ XX)) => (cwi @ Xph @ (cwceq @ (cco @ XS @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdv) @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ (cco @ XS @ XF @ ccdv) @ (ccof @ ccmul)))))))))))))).
