...
thf(acshwsidrepswmod0_thm,axiom,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime) @ (cwcel @ XL @ ccz)) @ (cwi @ (cwceq @ (cco @ XW @ XL @ cccsh) @ XW) @ (cwo @ (cwceq @ (cco @ XL @ (ccfv @ XW @ cchash) @ ccmo) @ ccc0) @ (cwceq @ XW @ (cco @ (ccfv @ ccc0 @ XW) @ (ccfv @ XW @ cchash) @ ccreps))))))))).
...
thf(afzofzim_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwne @ XK @ XM) @ (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfz))) @ (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfzo)))))).
...
thf(ccshwshashlem1_conj,conjecture,(! [Xph:$o] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => (cwi @ (cw3a @ Xph @ (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwne @ (cco @ XW @ XL @ cccsh) @ XW)))))))).
