...
thf(afvsnun1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwceq @ XG @ (ccun @ (ccsn @ (ccop @ XA2 @ XB2)) @ (ccres @ XF @ (ccdif @ XC @ (ccsn @ XA2))))) => (cwceq @ (ccfv @ XA2 @ XG) @ XB2)))))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(ac0ex_thm,axiom,(cwcel @ ccc0 @ ccvv)).
thf(a_1ex_thm,axiom,(cwcel @ cc1 @ ccvv)).
thf(aeqtr4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwceq @ XA2 @ XB2) => ((cwceq @ XC @ XB2) => (cwceq @ XA2 @ XC))))))).
thf(adf_fac_ax,axiom,(cwceq @ ccfa @ (ccun @ (ccsn @ (ccop @ ccc0 @ cc1)) @ (ccseq @ ccmul @ ccid @ cc1)))).
...
thf(adfn2_thm,axiom,(cwceq @ ccn @ (ccdif @ ccn0 @ (ccsn @ ccc0)))).
...
thf(cfac0_conj,conjecture,(cwceq @ (ccfv @ ccc0 @ ccfa) @ cc1)).
