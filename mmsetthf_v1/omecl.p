...
thf(comecl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwi @ Xph @ (cwss @ XA2 @ XX)) => (cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc))))))))))).
