...
thf(cxrralrecnnle_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XA2 @ ccxr))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XB2 @ ccr))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwral @ (^ [Xn:$i] : (cwbr @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccle)) @ (^ [Xn:$i] : ccn)))))))))))).
