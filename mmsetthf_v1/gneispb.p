...
thf(cgneispb_conj,conjecture,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XP @ XX) @ (cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)))) @ (cwral @ (^ [Xs1:$i] : (cwi @ (cwss @ XN @ (ccv @ Xs1)) @ (cwcel @ (ccv @ Xs1) @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xs1:$i] : (ccpw @ XX)))))))))).
