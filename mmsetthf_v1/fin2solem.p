...
thf(cfin2solem_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : (! [XR:($i > $o)] : (! [Xx3:$i] : (cwi @ (cwa @ (cwor @ (ccv @ Xx3) @ XR) @ (cwa @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (cwi @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR) @ (cwbr @ (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xy1) @ XR)) @ (^ [Xw:$i] : (ccv @ Xx3))) @ (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR)) @ (^ [Xw:$i] : (ccv @ Xx3))) @ ccrpss)))))))).
