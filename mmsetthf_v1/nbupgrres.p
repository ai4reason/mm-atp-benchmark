...
thf(anbupgrel_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XK @ XV)) @ (cwa @ (cwcel @ XN @ XV) @ (cwne @ XN @ XK))) @ (cwb @ (cwcel @ XN @ (cco @ XG @ XK @ ccnbgr)) @ (cwcel @ (ccpr @ XN @ XK) @ XE))))))))))).
...
thf(aupgrres1_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : (cwceq @ (XF @ Xe) @ (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => ((! [Xe:$i] : (cwceq @ (XS @ Xe) @ (ccop @ (ccdif @ XV @ (ccsn @ XN)) @ (ccres @ ccid @ (XF @ Xe))))) => (! [Xe:$i] : (cwi @ (cwa @ (cwcel @ XG @ ccupgr) @ (cwcel @ XN @ XV)) @ (cwcel @ (XS @ Xe) @ ccupgr)))))))))))))).
