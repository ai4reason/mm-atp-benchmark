...
thf(a_0vconngr_thm,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwceq @ (ccfv @ XG @ ccvtx) @ cc0)) @ (cwcel @ XG @ ccconngr))))).
thf(c_1conngr_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ XW) @ (cwceq @ (ccfv @ XG @ ccvtx) @ (ccsn @ XN))) @ (cwcel @ XG @ ccconngr)))))).
