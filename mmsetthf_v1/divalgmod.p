...
thf(asubexsub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwb @ (cwceq @ XA2 @ (cco @ XC @ XB2 @ ccmin)) @ (cwceq @ XB2 @ (cco @ XC @ XA2 @ ccmin)))))))))))).
...
thf(adivalg2_thm,axiom,(! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn)) @ (cwreu @ (^ [Xr:$i] : (cwa @ (cwbr @ (ccv @ Xr) @ XD @ cclt) @ (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds))) @ (^ [Xr:$i] : ccn0)))))).
...
thf(asnriota_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwi @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsn @ (ccrio @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
...
thf(cdivalgmod_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn)) @ (cwb @ (cwceq @ XR @ (cco @ XN @ XD @ ccmo)) @ (cwa @ (cwcel @ XR @ ccn0) @ (cwa @ (cwbr @ XR @ XD @ cclt) @ (cwbr @ XD @ (cco @ XN @ XR @ ccmin) @ ccdvds))))))))).
