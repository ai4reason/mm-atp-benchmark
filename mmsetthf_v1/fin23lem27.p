...
thf(annsdomel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom)) @ (cwb @ (cwcel @ XA2 @ XB2) @ (cwbr @ XA2 @ XB2 @ ccsdm)))))).
...
thf(afin23lem23_thm,axiom,(! [XS:($i > $o)] : (! [Xi:$i] : (cwi @ (cwa @ (cwa @ (cwss @ XS @ ccom) @ (cwn @ (cwcel @ XS @ ccfn))) @ (cwcel @ (ccv @ Xi) @ ccom)) @ (cwreu @ (^ [Xj:$i] : (cwbr @ (ccin @ (ccv @ Xj) @ XS) @ (ccv @ Xi) @ ccen)) @ (^ [Xj:$i] : XS)))))).
...
thf(ariotaprop_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((! [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (ccrio @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (XB2 @ Xx3)) @ (cwb @ (Xph @ Xx3) @ (Xps @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwa @ (cwcel @ (XB2 @ Xx3) @ XA2) @ (Xps @ Xx3)))))))))))).
...
thf(aonsdominel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwbr @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XC) @ ccsdm)) @ (cwcel @ XA2 @ XB2)))))).
...
thf(cfin23lem27_conj,conjecture,(! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XC @ Xi @ Xj) @ (ccmpt @ (^ [Xi:$i] : ccom) @ (^ [Xi:$i] : (ccrio @ (^ [Xj:$i] : (cwbr @ (ccin @ (ccv @ Xj) @ XS) @ (ccv @ Xi) @ ccen)) @ (^ [Xj:$i] : XS))))))) => (! [Xi:$i] : (! [Xj:$i] : (cwi @ (cwa @ (cwss @ XS @ ccom) @ (cwn @ (cwcel @ XS @ ccfn))) @ (cwiso @ ccom @ XS @ ccep @ ccep @ (XC @ Xi @ Xj))))))))).
