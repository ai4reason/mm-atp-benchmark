...
thf(afnemeet1_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XX @ (XV @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS)) @ (cwcel @ XA2 @ XS)) @ (cwbr @ (ccin @ (ccpw @ XX) @ (cciin @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cctg)))) @ XA2 @ ccfne)))))))).
...
thf(cfnemeet2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (cwi @ (cwa @ (cwcel @ XX @ (XV @ Xy1)) @ (cwral @ (^ [Xy1:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS))) @ (cwb @ (cwbr @ (XT @ Xy1) @ (ccin @ (ccpw @ XX) @ (cciin @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cctg)))) @ ccfne) @ (cwa @ (cwceq @ XX @ (ccuni @ (XT @ Xy1))) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (XT @ Xy1) @ (ccv @ Xx3) @ ccfne)) @ (^ [Xx3:$i] : XS))))))))))).
