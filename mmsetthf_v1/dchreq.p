...
thf(cdchreq_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccfv @ (XN @ Xk) @ ccdchr))) => ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xk) @ cczn))) => ((! [Xk:$i] : (cwceq @ (XD @ Xk) @ (ccfv @ (XG @ Xk) @ ccbs))) => ((cwceq @ XU @ (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xk)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XY @ (XD @ Xk)))) => (cwi @ Xph @ (cwb @ (cwceq @ XX @ XY) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccv @ Xk) @ XX) @ (ccfv @ (ccv @ Xk) @ XY))) @ (^ [Xk:$i] : XU))))))))))))))))))).
