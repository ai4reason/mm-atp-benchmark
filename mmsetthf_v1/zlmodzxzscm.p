...
thf(afmptpr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XB2 @ (XW @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XC @ (XX @ Xx3)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XD @ (XY @ Xx3)))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XA2)) @ (cwceq @ (XE @ Xx3) @ XC))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwceq @ (ccv @ Xx3) @ XB2)) @ (cwceq @ (XE @ Xx3) @ XD))) => (cwi @ Xph @ (cwceq @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD)) @ (ccmpt @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XE @ Xx3)))))))))))))))))))))).
...
thf(afvpr1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XW) @ (cwne @ XA2 @ XB2)) @ (cwceq @ (ccfv @ XA2 @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))) @ XC))))))))).
thf(aprid2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwcel @ XB2 @ (ccpr @ XA2 @ XB2)))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cw3a @ Xph @ Xps @ Xch) @ Xch))))).
thf(afvpr2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XB2 @ XV) @ (cwcel @ XD @ XW) @ (cwne @ XA2 @ XB2)) @ (cwceq @ (ccfv @ XB2 @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))) @ XD))))))))).
thf(czlmodzxzscm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XZ @ (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((cwceq @ Xc_xb @ (ccfv @ XZ @ ccvsca)) => (cwi @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ (cwceq @ (cco @ XA2 @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XC)) @ Xc_xb) @ (ccpr @ (ccop @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul)) @ (ccop @ cc1 @ (cco @ XA2 @ XC @ ccmul))))))))))))).
