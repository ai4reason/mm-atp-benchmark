...
thf(atxlm_thm,axiom,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xn) @ ccz))) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwi @ Xph @ (cwf @ XZ @ XX @ XF)) => ((cwi @ Xph @ (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG)))))) => (! [Xn:$i] : (cwi @ Xph @ (cwb @ (cwa @ (cwbr @ XF @ (XR @ Xn) @ (ccfv @ XJ @ cclm)) @ (cwbr @ XG @ (XS @ Xn) @ (ccfv @ XK @ cclm))) @ (cwbr @ (XH @ Xn) @ (ccop @ (XR @ Xn) @ (XS @ Xn)) @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cclm))))))))))))))))))))))))).
thf(clmcn2_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xn) @ ccz))) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwi @ Xph @ (cwf @ XZ @ XX @ XF)) => ((cwi @ Xph @ (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ XF @ (XR @ Xn) @ (ccfv @ XJ @ cclm)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ XG @ (XS @ Xn) @ (ccfv @ XK @ cclm)))) => ((! [Xn:$i] : (cwi @ Xph @ (cwcel @ XO @ (cco @ (cco @ XJ @ XK @ cctx) @ (XN @ Xn) @ cccn)))) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG) @ XO))))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XH @ Xn) @ (cco @ (XR @ Xn) @ (XS @ Xn) @ XO) @ (ccfv @ (XN @ Xn) @ cclm))))))))))))))))))))))))))))).
