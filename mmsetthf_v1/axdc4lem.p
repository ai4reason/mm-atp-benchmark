...
thf(aaxdc3_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XC @ XA2) @ (cwf @ XA2 @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ XF)) @ (cwex @ (^ [Xg1:$i] : (cw3a @ (cwf @ ccom @ XA2 @ (ccv @ Xg1)) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xg1)) @ XC) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ XF))) @ (^ [Xk:$i] : ccom))))))))))).
...
thf(a_2ndcof_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwf @ XA2 @ (ccxp @ XB2 @ XC) @ XF) @ (cwf @ XA2 @ XC @ (cccom @ cc2nd @ XF)))))))).
...
thf(caxdc4lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xg1 @ Xn) @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xx3:$i] : ccom)) @ (^ [Xn:$i] : (^ [Xx3:$i] : XA2)) @ (^ [Xn:$i] : (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccsuc @ (ccv @ Xn))) @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ (XF @ Xk))))))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (cwcel @ (XC @ Xx3 @ Xn) @ XA2) @ (cwf @ (ccxp @ ccom @ XA2) @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ (XF @ Xk))) @ (cwex @ (^ [Xg1:$i] : (cw3a @ (cwf @ ccom @ XA2 @ (ccv @ Xg1)) @ (cwceq @ (ccfv @ cc0 @ (ccv @ Xg1)) @ (XC @ Xx3 @ Xn)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (XF @ Xk)))) @ (^ [Xk:$i] : ccom)))))))))))))))).
