...
thf(amulgnn0di_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ cccmn) @ (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (cco @ XM @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) @ (cco @ (cco @ XM @ XX @ Xc_x) @ (cco @ XM @ XY @ Xc_x) @ Xc_pl)))))))))))))).
...
thf(cmulgdi_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmg)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => (cwi @ (cwa @ (cwcel @ XG @ ccabl) @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (cco @ XM @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) @ (cco @ (cco @ XM @ XX @ Xc_x) @ (cco @ XM @ XY @ Xc_x) @ Xc_pl)))))))))))))).
