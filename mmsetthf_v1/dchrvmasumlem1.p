...
thf(cdchrvmasumlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xd:$i] : (cwceq @ (XZ @ Xd) @ (ccfv @ (XN @ Xd) @ cczn))) => ((! [Xd:$i] : (cwceq @ XL @ (ccfv @ (XZ @ Xd) @ cczrh))) => ((! [Xd:$i] : (cwi @ Xph @ (cwcel @ (XN @ Xd) @ ccn))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xd:$i] : (cwceq @ (XG @ Xm @ Xn @ Xd) @ (ccfv @ (XN @ Xd) @ ccdchr))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xd:$i] : (cwceq @ (XD @ Xd) @ (ccfv @ (XG @ Xm @ Xn @ Xd) @ ccbs))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xd:$i] : (cwceq @ (Xc_1 @ Xd) @ (ccfv @ (XG @ Xm @ Xn @ Xd) @ cc0g))))) => ((! [Xd:$i] : (cwi @ Xph @ (cwcel @ XX @ (XD @ Xd)))) => ((! [Xd:$i] : (cwi @ Xph @ (cwne @ XX @ (Xc_1 @ Xd)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => (cwi @ Xph @ (cwceq @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv) @ ccmul))) @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xd) @ XL) @ XX) @ (cco @ (ccfv @ (ccv @ Xd) @ ccmu) @ (ccv @ Xd) @ ccdiv) @ ccmul) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ XA2 @ (ccv @ Xd) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ XX) @ (cco @ (ccfv @ (ccv @ Xm) @ cclog) @ (ccv @ Xm) @ ccdiv) @ ccmul))) @ ccmul)))))))))))))))))))))))).
