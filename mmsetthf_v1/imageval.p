...
thf(afnimage_thm,axiom,(! [XR:($i > $o)] : (cwfn @ (ccimage @ XR) @ (ccab @ (^ [Xx3:$i] : (cwcel @ (ccima @ XR @ (ccv @ Xx3)) @ ccvv)))))).
...
thf(cimageval_conj,conjecture,(! [XR:($i > $o)] : (cwceq @ (ccimage @ XR) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccima @ XR @ (ccv @ Xx3))))))).
