...
thf(asseqfres_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwcel @ XM @ (ccword @ XS))) => ((cwceq @ XW @ (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XW @ XS @ XF)) => (cwi @ Xph @ (cwceq @ (ccres @ (cco @ XM @ XF @ ccsseq) @ (cco @ ccc0 @ (ccfv @ XM @ cchash) @ ccfzo)) @ XM)))))))))))).
...
thf(aiwrdsplit_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwf @ ccn0 @ XS @ XF)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => (cwi @ Xph @ (cwceq @ (ccres @ XF @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)) @ (cco @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccs1 @ (ccfv @ XN @ XF)) @ ccconcat))))))))))).
thf(csseqp1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ ccvv)) => ((cwi @ Xph @ (cwcel @ XM @ (ccword @ XS))) => ((cwceq @ XW @ (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((cwi @ Xph @ (cwf @ XW @ XS @ XF)) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccfv @ XN @ (cco @ XM @ XF @ ccsseq)) @ (ccfv @ (ccres @ (cco @ XM @ XF @ ccsseq) @ (cco @ ccc0 @ XN @ ccfzo)) @ XF))))))))))))))).
