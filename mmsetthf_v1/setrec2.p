...
thf(asetrec2fun_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xa:$i] : (XF @ Xa))) => ((! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccsetrecs @ (XF @ Xa)))) => ((! [Xa:$i] : (cwfun @ (XF @ Xa))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwal @ (^ [Xa:$i] : (cwi @ (cwss @ (ccv @ Xa) @ XC) @ (cwss @ (ccfv @ (ccv @ Xa) @ (XF @ Xa)) @ XC)))))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwss @ (XB2 @ Xa) @ XC)))))))))))).
...
thf(asetrec2lem1_thm,axiom,(! [XF:($i > ($i > $o))] : (! [Xa:$i] : (cwceq @ (ccfv @ (ccv @ Xa) @ (ccres @ (XF @ Xa) @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XF @ Xa)))))))) @ (ccfv @ (ccv @ Xa) @ (XF @ Xa)))))).
...
thf(asetrec2lem2_thm,axiom,(! [XF:($i > $o)] : (cwfun @ (ccres @ XF @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))))))))).
thf(asylibr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwb @ Xch @ Xps) => (cwi @ Xph @ Xch))))))).
thf(csetrec2_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xa:$i] : (XF @ Xa))) => ((! [Xa:$i] : (cwceq @ (XB2 @ Xa) @ (ccsetrecs @ (XF @ Xa)))) => ((! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwal @ (^ [Xa:$i] : (cwi @ (cwss @ (ccv @ Xa) @ XC) @ (cwss @ (ccfv @ (ccv @ Xa) @ (XF @ Xa)) @ XC)))))) => (! [Xa:$i] : (cwi @ (Xph @ Xa) @ (cwss @ (XB2 @ Xa) @ XC))))))))))).
