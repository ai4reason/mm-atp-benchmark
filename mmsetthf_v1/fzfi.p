...
thf(afzen2_thm,axiom,(! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XG @ Xx3) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : (cwi @ (cwcel @ (XN @ Xx3) @ (ccfv @ (XM @ Xx3) @ ccuz)) @ (cwbr @ (cco @ (XM @ Xx3) @ (XN @ Xx3) @ ccfz) @ (ccfv @ (cco @ (cco @ (XN @ Xx3) @ cc1 @ ccaddc) @ (XM @ Xx3) @ ccmin) @ (cccnv @ (XG @ Xx3))) @ ccen)))))))).
