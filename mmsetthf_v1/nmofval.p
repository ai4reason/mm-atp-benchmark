...
thf(cnmofval_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xf1:$i] : (cwceq @ (XN @ Xf1) @ (cco @ XS @ XT @ ccnmo))) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => (! [Xf1:$i] : (cwi @ (cwa @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp)) @ (cwceq @ (XN @ Xf1) @ (ccmpt @ (^ [Xf1:$i] : (cco @ XS @ XT @ ccghm)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ XM) @ (cco @ (ccv @ Xr) @ (ccfv @ (ccv @ Xx3) @ XL) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : XV))) @ (^ [Xr:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ ccxr @ cclt))))))))))))))))).
