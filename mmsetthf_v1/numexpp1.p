...
thf(cnumexpp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XM @ ccn0) => ((cwceq @ (cco @ XM @ cc1 @ ccaddc) @ XN) => ((cwceq @ (cco @ (cco @ XA2 @ XM @ ccexp) @ XA2 @ ccmul) @ XC) => (cwceq @ (cco @ XA2 @ XN @ ccexp) @ XC)))))))))).
