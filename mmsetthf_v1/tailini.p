...
thf(adirref_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cwa @ (cwcel @ XR @ ccdir) @ (cwcel @ XA2 @ XX)) @ (cwbr @ XA2 @ XA2 @ XR))))))).
...
thf(ctailini_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XD)) => (cwi @ (cwa @ (cwcel @ XD @ ccdir) @ (cwcel @ XA2 @ XX)) @ (cwcel @ XA2 @ (ccfv @ XA2 @ (ccfv @ XD @ cctail))))))))).
