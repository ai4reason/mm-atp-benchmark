...
thf(aqden1elz_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwb @ (cwceq @ (ccfv @ XA2 @ ccdenom) @ cc1) @ (cwcel @ XA2 @ ccz))))).
thf(adensq_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccq) @ (cwceq @ (ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccdenom) @ (cco @ (ccfv @ XA2 @ ccdenom) @ cc2 @ ccexp))))).
thf(czsqrtelqelz_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccz) @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccq)) @ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccz)))).
