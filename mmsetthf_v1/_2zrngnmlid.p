...
thf(a_2even_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XE @ Xx3 @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => (! [Xx3:$i] : (! [Xz:$i] : (cwcel @ cc2 @ (XE @ Xx3 @ Xz))))))).
...
thf(a_1neven_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XE @ Xx3 @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => (! [Xx3:$i] : (! [Xz:$i] : (cwnel @ cc1 @ (XE @ Xx3 @ Xz))))))).
...
thf(c_2zrngnmlid_conj,conjecture,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((cwceq @ XE @ (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xz) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))) => ((cwceq @ XR @ (cco @ cccnfld @ XE @ ccress)) => ((! [Xx3:$i] : (! [Xz:$i] : (cwceq @ (XM @ Xx3 @ Xz) @ (ccfv @ XR @ ccmgp)))) => (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xa:$i] : (cwne @ (cco @ (ccv @ Xb) @ (ccv @ Xa) @ ccmul) @ (ccv @ Xa))) @ (^ [Xa:$i] : XE))) @ (^ [Xb:$i] : XE))))))))).
