...
thf(adf_inv_ax,axiom,(cwceq @ ccinv @ (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccin @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xc) @ ccsect)) @ (cccnv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xc) @ ccsect))))))))))).
...
thf(cinvffval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XN @ Xx3 @ Xy1) @ (ccfv @ XC @ ccinv)))) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XY @ XB2)) => ((cwceq @ XS @ (ccfv @ XC @ ccsect)) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwceq @ (XN @ Xx3 @ Xy1) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccin @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XS) @ (cccnv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XS)))))))))))))))))))))))).
