...
thf(cdfnbgr3_conj,conjecture,(! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : (cwceq @ (XV @ Xi) @ (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xi) @ cciedg))) => (! [Xi:$i] : (cwi @ (cwa @ (cwcel @ XN @ (XV @ Xi)) @ (cwfun @ XI)) @ (cwceq @ (cco @ (XG @ Xi) @ XN @ ccnbgr) @ (ccrab @ (^ [Xn:$i] : (cwrex @ (^ [Xi:$i] : (cwss @ (ccpr @ XN @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xi) @ XI))) @ (^ [Xi:$i] : (ccdm @ XI)))) @ (^ [Xn:$i] : (ccdif @ (XV @ Xi) @ (ccsn @ XN)))))))))))))).
