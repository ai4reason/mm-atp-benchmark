...
thf(cnacsfg_conj,conjecture,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccnacs)) @ (cwcel @ XS @ XC)) @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XS @ (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))).
