...
thf(ciccpartrn_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (cwi @ Xph @ (cwss @ (ccrn @ XP) @ (cco @ (ccfv @ ccc0 @ XP) @ (ccfv @ XM @ XP) @ ccicc))))))))).
