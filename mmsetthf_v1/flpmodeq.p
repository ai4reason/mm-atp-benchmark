...
thf(amodvalr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwceq @ (cco @ XA2 @ XB2 @ ccmo) @ (cco @ XA2 @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ XB2 @ ccmul) @ ccmin)))))).
...
thf(cflpmodeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp)) @ (cwceq @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccmo) @ ccaddc) @ XA2))))).
