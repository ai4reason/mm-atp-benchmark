...
thf(celuzsubi_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => ((cwcel @ XK @ ccz) => (cwi @ (cwcel @ XN @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz)) @ (cwcel @ (cco @ XN @ XK @ ccmin) @ (ccfv @ XM @ ccuz))))))))).
