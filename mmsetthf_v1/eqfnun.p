...
thf(ceqfnun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ (ccun @ XA2 @ XB2)) @ (cwfn @ XG @ (ccun @ XA2 @ XB2))) @ (cwb @ (cwceq @ XF @ XG) @ (cwa @ (cwceq @ (ccres @ XF @ XA2) @ (ccres @ XG @ XA2)) @ (cwceq @ (ccres @ XF @ XB2) @ (ccres @ XG @ XB2)))))))))).
