...
thf(aubmelm1fzo_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ (cco @ (cco @ XN @ XK @ ccmin) @ cc1 @ ccmin) @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(acshwidxmod_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ XI @ (cco @ XW @ XN @ cccsh)) @ (ccfv @ (cco @ (cco @ XI @ XN @ ccaddc) @ (ccfv @ XW @ cchash) @ ccmo) @ XW)))))))).
...
thf(annpcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cwceq @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccmin) @ XB2 @ ccaddc) @ (cco @ XA2 @ XC @ ccmin))))))).
...
thf(annm1ge0_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwbr @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccle)))).
...
thf(ccshwidxm1_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwceq @ (ccfv @ (cco @ (cco @ (ccfv @ XW @ cchash) @ XN @ ccmin) @ cc1 @ ccmin) @ (cco @ XW @ XN @ cccsh)) @ (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ XW))))))).
