...
thf(avtxdgfusgr_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xv:$i] : (cwceq @ (XV @ Xv) @ (ccfv @ XG @ ccvtx))) => (cwi @ (cwcel @ XG @ ccfusgr) @ (cwral @ (^ [Xv:$i] : (cwcel @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ ccn0)) @ (^ [Xv:$i] : (XV @ Xv)))))))).
...
thf(cfusgrregdegfi_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (cwceq @ (XD @ Xv) @ (ccfv @ XG @ ccvtxdg))) => (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwne @ XV @ cc0)) @ (cwi @ (cwral @ (^ [Xv:$i] : (cwceq @ (ccfv @ (ccv @ Xv) @ (XD @ Xv)) @ XK)) @ (^ [Xv:$i] : XV)) @ (cwcel @ XK @ ccn0)))))))))).
