...
thf(cfullres2c_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XE @ (cco @ XD @ XS @ ccress)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XA2 @ XS @ XF)) => (cwi @ Xph @ (cwb @ (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccful)) @ (cwbr @ XF @ XG @ (cco @ XC @ XE @ ccful))))))))))))))))))).
