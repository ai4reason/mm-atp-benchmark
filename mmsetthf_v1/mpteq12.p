...
thf(cmpteq12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (cwi @ (cwa @ (cwceq @ XA2 @ XC) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (XB2 @ Xx3) @ (XD @ Xx3))) @ (^ [Xx3:$i] : XA2))) @ (cwceq @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3)))))))))).
