...
thf(coyoncl_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XO @ (ccfv @ XC @ ccoppc)) => ((cwceq @ XY @ (ccfv @ XO @ ccyon)) => ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwceq @ XS @ (ccfv @ XU @ ccsetc)) => ((cwi @ Xph @ (cwcel @ XU @ XV)) => ((cwi @ Xph @ (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => ((cwceq @ XQ @ (cco @ XC @ XS @ ccfuc)) => (cwi @ Xph @ (cwcel @ XY @ (cco @ XO @ XQ @ ccfunc))))))))))))))))))).
