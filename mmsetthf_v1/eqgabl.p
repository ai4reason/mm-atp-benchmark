...
thf(ceqgabl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ Xc_sm @ (cco @ XG @ XS @ ccqg)) => (cwi @ (cwa @ (cwcel @ XG @ ccabl) @ (cwss @ XS @ XX)) @ (cwb @ (cwbr @ XA2 @ XB2 @ Xc_sm) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ (cco @ XB2 @ XA2 @ Xc_mi) @ XS))))))))))))))).
