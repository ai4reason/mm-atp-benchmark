...
thf(aeltg4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) @ (cwceq @ XA2 @ (ccuni @ (ccin @ XB2 @ (ccpw @ XA2)))))))).
...
thf(ctgdom_conj,conjecture,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XB2 @ XV) @ (cwbr @ (ccfv @ XB2 @ cctg) @ (ccpw @ XB2) @ ccdom))))).
