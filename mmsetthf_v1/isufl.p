...
thf(adf_ufl_ax,axiom,(cwceq @ ccufl @ (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwss @ (ccv @ Xf1) @ (ccv @ Xg1))) @ (^ [Xg1:$i] : (ccfv @ (ccv @ Xx3) @ ccufil)))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xx3) @ ccfil))))))).
thf(cisufl_conj,conjecture,(! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [Xf1:$i] : (! [Xg1:$i] : (cwi @ (cwcel @ XX @ (XV @ Xf1 @ Xg1)) @ (cwb @ (cwcel @ XX @ ccufl) @ (cwral @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwss @ (ccv @ Xf1) @ (ccv @ Xg1))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccufil)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))))).
