...
thf(age0div_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ cclt)) @ (cwb @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccle)))))).
...
thf(abtwnzge0_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccz)) @ (cwa @ (cwbr @ XN @ XA2 @ ccle) @ (cwbr @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ cclt))) @ (cwb @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ ccc0 @ XN @ ccle)))))).
thf(c_2tnp1ge0ge0_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccz) @ (cwb @ (cwbr @ ccc0 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccle) @ (cwbr @ ccc0 @ XN @ ccle))))).
