...
thf(aaovvdm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwcel @ (ccaov @ XA2 @ XB2 @ XF) @ XC) @ (cwcel @ (ccop @ XA2 @ XB2) @ (ccdm @ XF)))))))).
...
thf(andmaov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwn @ (cwcel @ (ccop @ XA2 @ XB2) @ (ccdm @ XF))) @ (cwceq @ (ccaov @ XA2 @ XB2 @ XF) @ ccvv)))))).
...
thf(cndmaovass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwceq @ (ccdm @ XF) @ (ccxp @ XS @ XS)) => (cwi @ (cwn @ (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS))) @ (cwceq @ (ccaov @ (ccaov @ XA2 @ XB2 @ XF) @ XC @ XF) @ (ccaov @ XA2 @ (ccaov @ XB2 @ XC @ XF) @ XF)))))))))).
