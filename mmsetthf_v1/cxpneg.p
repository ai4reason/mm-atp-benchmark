...
thf(ccxpneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XB2 @ ccc)) @ (cwceq @ (cco @ XA2 @ (ccneg @ XB2) @ cccxp) @ (cco @ cc1 @ (cco @ XA2 @ XB2 @ cccxp) @ ccdiv)))))).
