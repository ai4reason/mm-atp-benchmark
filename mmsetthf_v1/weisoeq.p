...
thf(aweniso_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cw3a @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR) @ (cwiso @ XA2 @ XA2 @ XR @ XR @ XF)) @ (cwceq @ XF @ (ccres @ ccid @ XA2))))))).
...
thf(af1eqcocnv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwf1 @ XA2 @ XB2 @ XG)) @ (cwb @ (cwceq @ XF @ XG) @ (cwceq @ (cccom @ (cccnv @ XF) @ XG) @ (ccres @ ccid @ XA2))))))))).
thf(cweisoeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR)) @ (cwa @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XF) @ (cwiso @ XA2 @ XB2 @ XR @ XS @ XG))) @ (cwceq @ XF @ XG))))))))).
