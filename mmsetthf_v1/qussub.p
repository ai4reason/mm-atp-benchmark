...
thf(aqusinv_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((cwceq @ XV @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => ((cwceq @ XN @ (ccfv @ XH @ ccminusg)) => (cwi @ (cwa @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwcel @ XX @ XV)) @ (cwceq @ (ccfv @ (ccec @ XX @ (cco @ XG @ XS @ ccqg)) @ XN) @ (ccec @ (ccfv @ XX @ XI) @ (cco @ XG @ XS @ ccqg)))))))))))))))).
...
thf(cqussub_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XH @ (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((cwceq @ XV @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ XN @ (ccfv @ XH @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) @ (cwceq @ (cco @ (ccec @ XX @ (cco @ XG @ XS @ ccqg)) @ (ccec @ XY @ (cco @ XG @ XS @ ccqg)) @ XN) @ (ccec @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XG @ XS @ ccqg))))))))))))))))).
