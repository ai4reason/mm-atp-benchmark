...
thf(apell1qrgaplem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ ccn) @ (cwa @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0))) @ (cwa @ (cwbr @ cc1 @ (cco @ XA2 @ (cco @ (ccfv @ XD @ ccsqrt) @ XB2 @ ccmul) @ ccaddc) @ cclt) @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmin) @ cc1))) @ (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ (cco @ XA2 @ (cco @ (ccfv @ XD @ ccsqrt) @ XB2 @ ccmul) @ ccaddc) @ ccle)))))).
thf(cpell1qrgap_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr)) @ (cwbr @ cc1 @ XA2 @ cclt)) @ (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ XA2 @ ccle))))).
