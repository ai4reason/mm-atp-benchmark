...
thf(aqtopval_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (! [Xs1:$i] : (cwi @ (cwa @ (cwcel @ XJ @ XV) @ (cwcel @ XF @ (XW @ Xs1))) @ (cwceq @ (cco @ XJ @ XF @ ccqtop) @ (ccrab @ (^ [Xs1:$i] : (cwcel @ (ccin @ (ccima @ (cccnv @ XF) @ (ccv @ Xs1)) @ XX) @ XJ)) @ (^ [Xs1:$i] : (ccpw @ (ccima @ XF @ XX)))))))))))))).
...
thf(cimastopn_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwfo @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ XW)) => ((cwceq @ XJ @ (ccfv @ XR @ cctopn)) => ((cwceq @ XO @ (ccfv @ XU @ cctopn)) => (cwi @ Xph @ (cwceq @ XO @ (cco @ XJ @ XF @ ccqtop))))))))))))))))))).
