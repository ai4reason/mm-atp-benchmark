...
thf(caxpre_lttri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccltrr) @ (cwn @ (cwo @ (cwceq @ XA2 @ XB2) @ (cwbr @ XB2 @ XA2 @ ccltrr)))))))).
