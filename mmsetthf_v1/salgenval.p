...
thf(adf_salgen_ax,axiom,(cwceq @ ccsalgen @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xs1:$i] : (cwa @ (cwceq @ (ccuni @ (ccv @ Xs1)) @ (ccuni @ (ccv @ Xx3))) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : ccsalg))))))).
...
thf(csalgenval_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xs1:$i] : (cwi @ (cwcel @ XX @ (XV @ Xs1)) @ (cwceq @ (ccfv @ XX @ ccsalgen) @ (ccint @ (ccrab @ (^ [Xs1:$i] : (cwa @ (cwceq @ (ccuni @ (ccv @ Xs1)) @ (ccuni @ XX)) @ (cwss @ XX @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : ccsalg))))))))).
