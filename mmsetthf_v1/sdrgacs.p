...
thf(arbaibr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwb @ Xph @ (cwa @ Xps @ Xch)) => (cwi @ Xch @ (cwb @ Xps @ Xph))))))).
...
thf(asubrgacs_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (cwi @ (cwcel @ XR @ ccrg) @ (cwcel @ (ccfv @ XR @ ccsubrg) @ (ccfv @ XB2 @ ccacs))))))).
...
thf(csdrgacs_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => (cwi @ (cwcel @ XR @ ccdr) @ (cwcel @ (ccfv @ XR @ ccsdrg) @ (ccfv @ XB2 @ ccacs))))))).
