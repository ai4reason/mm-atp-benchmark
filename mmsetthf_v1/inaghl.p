...
thf(abtwnhl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XK @ (ccfv @ XG @ cchlg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XD @ XK))) => ((cwi @ Xph @ (cwcel @ XD @ (cco @ XA2 @ XC @ XI))) => (cwi @ Xph @ (cwcel @ XD @ (cco @ XB2 @ XC @ XI))))))))))))))))))))))).
...
thf(ahlpasch_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XK @ (ccfv @ XG @ cchlg)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => ((cwi @ Xph @ (cwbr @ XC @ XD @ (ccfv @ XB2 @ XK))) => ((cwi @ Xph @ (cwcel @ XA2 @ (cco @ XX @ XC @ XI))) => (cwi @ Xph @ (cwrex @ (^ [Xe:$i] : (cwa @ (cwbr @ XA2 @ (ccv @ Xe) @ (ccfv @ XB2 @ XK)) @ (cwcel @ (ccv @ Xe) @ (cco @ XX @ XD @ XI)))) @ (^ [Xe:$i] : XP)))))))))))))))))))))))))).
...
thf(aisinag_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (cwceq @ (XI @ Xx3) @ (ccfv @ XG @ ccitv))) => ((! [Xx3:$i] : (cwceq @ (XK @ Xx3) @ (ccfv @ XG @ cchlg))) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XG @ (XV @ Xx3)))) => (cwi @ Xph @ (cwb @ (cwbr @ XX @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccinag)) @ (cwa @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XC @ XB2) @ (cwne @ XX @ XB2)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XC @ (XI @ Xx3))) @ (cwo @ (cwceq @ (ccv @ Xx3) @ XB2) @ (cwbr @ (ccv @ Xx3) @ XX @ (ccfv @ XB2 @ (XK @ Xx3)))))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))))).
thf(cinaghl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XK @ (ccfv @ XG @ cchlg)) => ((cwi @ Xph @ (cwcel @ XX @ XP)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwcel @ XC @ XP)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XX @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccinag))) => ((cwi @ Xph @ (cwcel @ XD @ XP)) => ((cwi @ Xph @ (cwcel @ XF @ XP)) => ((cwi @ Xph @ (cwcel @ XY @ XP)) => ((cwi @ Xph @ (cwbr @ XD @ XA2 @ (ccfv @ XB2 @ XK))) => ((cwi @ Xph @ (cwbr @ XF @ XC @ (ccfv @ XB2 @ XK))) => ((cwi @ Xph @ (cwbr @ XY @ XX @ (ccfv @ XB2 @ XK))) => (cwi @ Xph @ (cwbr @ XY @ (ccs3 @ XD @ XB2 @ XF) @ (ccfv @ XG @ ccinag))))))))))))))))))))))))))))))).
