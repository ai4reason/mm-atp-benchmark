...
thf(cpsr1bas2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XS @ (ccfv @ XR @ ccps1)) => ((cwceq @ XB2 @ (ccfv @ XS @ ccbs)) => ((cwceq @ XO @ (cco @ cc1o @ XR @ ccmps)) => (cwceq @ XB2 @ (ccfv @ XO @ ccbs)))))))))).
