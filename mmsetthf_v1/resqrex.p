...
thf(a_01sqrex_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccrp) @ (cwbr @ XA2 @ cc1 @ ccle)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ cc1 @ ccle) @ (cwceq @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2))) @ (^ [Xx3:$i] : ccrp))))).
...
thf(asqrecd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ cc2 @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccdiv)))))))).
...
thf(cresqrex_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle) @ (cwceq @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2))) @ (^ [Xx3:$i] : ccr))))).
