...
thf(arecoshcl_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwcel @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cccos) @ ccr)))).
...
thf(adivne0bd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => (cwi @ Xph @ (cwb @ (cwne @ XA2 @ ccc0) @ (cwne @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0)))))))))).
...
thf(ctanhlt1_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cctan) @ cci @ ccdiv) @ cc1 @ cclt)))).
