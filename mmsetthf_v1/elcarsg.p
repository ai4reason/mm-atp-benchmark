...
thf(celcarsg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : (cwi @ Xph @ (cwcel @ XO @ (XV @ Xe)))) => ((cwi @ Xph @ (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => (cwi @ Xph @ (cwb @ (cwcel @ XA2 @ (ccfv @ XM @ cccarsg)) @ (cwa @ (cwss @ XA2 @ XO) @ (cwral @ (^ [Xe:$i] : (cwceq @ (cco @ (ccfv @ (ccin @ (ccv @ Xe) @ XA2) @ XM) @ (ccfv @ (ccdif @ (ccv @ Xe) @ XA2) @ XM) @ ccxad) @ (ccfv @ (ccv @ Xe) @ XM))) @ (^ [Xe:$i] : (ccpw @ XO)))))))))))))).
