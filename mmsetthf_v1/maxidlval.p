...
thf(adf_maxidl_ax,axiom,(cwceq @ ccmaxidl @ (ccmpt @ (^ [Xr:$i] : ccrngo) @ (^ [Xr:$i] : (ccrab @ (^ [Xi:$i] : (cwa @ (cwne @ (ccv @ Xi) @ (ccrn @ (ccfv @ (ccv @ Xr) @ cc1st))) @ (cwral @ (^ [Xj:$i] : (cwi @ (cwss @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwo @ (cwceq @ (ccv @ Xj) @ (ccv @ Xi)) @ (cwceq @ (ccv @ Xj) @ (ccrn @ (ccfv @ (ccv @ Xr) @ cc1st)))))) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xr) @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xr) @ ccidl))))))).
thf(arabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cmaxidlval_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XG @ Xi @ Xj) @ (ccfv @ XR @ cc1st)))) => ((! [Xi:$i] : (! [Xj:$i] : (cwceq @ (XX @ Xi @ Xj) @ (ccrn @ (XG @ Xi @ Xj))))) => (! [Xj:$i] : (cwi @ (cwcel @ XR @ ccrngo) @ (cwceq @ (ccfv @ XR @ ccmaxidl) @ (ccrab @ (^ [Xi:$i] : (cwa @ (cwne @ (ccv @ Xi) @ (XX @ Xi @ Xj)) @ (cwral @ (^ [Xj:$i] : (cwi @ (cwss @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwo @ (cwceq @ (ccv @ Xj) @ (ccv @ Xi)) @ (cwceq @ (ccv @ Xj) @ (XX @ Xi @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ XR @ ccidl)))))))))))).
