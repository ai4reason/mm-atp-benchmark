...
thf(cdjudisj_b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (cwi @ (cwceq @ (ccin @ XA2 @ XB2) @ cc0) @ (cwceq @ (ccin @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XC @ Xx3)))) @ (cciun @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XD @ Xx3))))) @ cc0))))))).
