...
thf(clincvalsng_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XM @ ccbs)) => ((cwceq @ XS @ (ccfv @ XM @ ccsca)) => ((cwceq @ XR @ (ccfv @ XS @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XM @ ccvsca)) => (cwi @ (cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ XB2) @ (cwcel @ XY @ XR)) @ (cwceq @ (cco @ (ccsn @ (ccop @ XV @ XY)) @ (ccsn @ XV) @ (ccfv @ XM @ cclinc)) @ (cco @ XY @ XV @ Xc_x))))))))))))))).
