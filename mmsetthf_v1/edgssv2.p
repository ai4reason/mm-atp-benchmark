...
thf(cedgssv2_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => (cwi @ (cwa @ (cwcel @ XG @ ccusgr) @ (cwcel @ XC @ XE)) @ (cwa @ (cwss @ XC @ XV) @ (cwceq @ (ccfv @ XC @ cchash) @ cc2)))))))))).
