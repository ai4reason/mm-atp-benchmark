...
thf(adf_cm_ax,axiom,(cwceq @ cccm @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwcel @ (ccv @ Xy1) @ ccch)) @ (cwceq @ (ccv @ Xx3) @ (cco @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccin @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) @ cchj)))))))).
thf(ccmbr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccm) @ (cwceq @ XA2 @ (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ (ccfv @ XB2 @ ccort)) @ cchj))))))).
