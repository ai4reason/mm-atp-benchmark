...
thf(cccatw2s1lenOLD_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) @ (cwceq @ (ccfv @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat) @ cchash) @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccaddc)))))))).
