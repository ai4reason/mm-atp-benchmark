...
thf(cfmufil_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XL @ (ccfv @ XY @ ccufil)) @ (cwf @ XY @ XX @ XF)) @ (cwcel @ (ccfv @ XL @ (cco @ XX @ XF @ ccfm)) @ (ccfv @ XX @ ccufil))))))))).
