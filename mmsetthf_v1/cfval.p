...
thf(acflem_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : XA2)))))))))))))))).
...
thf(adf_cf_ax,axiom,(cwceq @ cccf @ (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccint @ (ccab @ (^ [Xy1:$i] : (cwex @ (^ [Xz:$i] : (cwa @ (cwceq @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwral @ (^ [Xv:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (ccv @ Xv) @ (ccv @ Xu))) @ (^ [Xu:$i] : (ccv @ Xz)))) @ (^ [Xv:$i] : (ccv @ Xx3)))))))))))))).
thf(ccfval_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwceq @ (ccfv @ XA2 @ cccf) @ (ccint @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ cccrd)) @ (cwa @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : XA2))))))))))))).
