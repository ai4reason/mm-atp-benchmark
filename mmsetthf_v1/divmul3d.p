...
thf(cdivmul3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwne @ XC @ ccc0)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XC @ ccdiv) @ XB2) @ (cwceq @ XA2 @ (cco @ XB2 @ XC @ ccmul))))))))))))).
