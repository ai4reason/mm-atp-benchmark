...
thf(cqustps_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XR @ XE @ ccqus))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwcel @ XE @ XW)) => ((cwi @ Xph @ (cwcel @ XR @ cctps)) => (cwi @ Xph @ (cwcel @ XU @ cctps))))))))))))).
