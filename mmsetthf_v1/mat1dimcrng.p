...
thf(amat1dimelbas_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xr:$i] : (cwceq @ (XA2 @ Xr) @ (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xr:$i] : (cwceq @ (XO @ Xr) @ (ccop @ XE @ XE))) => (! [Xr:$i] : (cwi @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV)) @ (cwb @ (cwcel @ XM @ (ccfv @ (XA2 @ Xr) @ ccbs)) @ (cwrex @ (^ [Xr:$i] : (cwceq @ XM @ (ccsn @ (ccop @ (XO @ Xr) @ (ccv @ Xr))))) @ (^ [Xr:$i] : XB2)))))))))))))))).
...
thf(amat1dimmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XA2 @ (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XO @ (ccop @ XE @ XE)) => (cwi @ (cwa @ (cwa @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV)) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) @ (cwceq @ (cco @ (ccsn @ (ccop @ XO @ XX)) @ (ccsn @ (ccop @ XO @ XY)) @ (ccfv @ XA2 @ ccmulr)) @ (ccsn @ (ccop @ XO @ (cco @ XX @ XY @ (ccfv @ XR @ ccmulr)))))))))))))))))).
...
thf(cmat1dimcrng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XA2 @ (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ XO @ (ccop @ XE @ XE)) => (cwi @ (cwa @ (cwcel @ XR @ cccrg) @ (cwcel @ XE @ XV)) @ (cwcel @ XA2 @ cccrg)))))))))))).
