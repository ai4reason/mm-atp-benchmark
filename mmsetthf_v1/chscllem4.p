...
thf(achscllem3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ ccch))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XB2 @ ccch))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwf @ ccn @ (cco @ XA2 @ XB2 @ ccph) @ XH))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ XH @ (ccv @ Xu) @ cchli))) => ((! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xu @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XA2 @ ccpjh))))))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XN @ Xu) @ ccn))) => ((! [Xu:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XC @ Xu @ Xn) @ XA2)))) => ((! [Xu:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XD @ Xu @ Xn) @ XB2)))) => ((! [Xu:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwceq @ (ccfv @ (XN @ Xu) @ XH) @ (cco @ (XC @ Xu @ Xn) @ (XD @ Xu @ Xn) @ ccva))))) => (! [Xu:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwceq @ (XC @ Xu @ Xn) @ (ccfv @ (XN @ Xu) @ (XF @ Xu @ Xn))))))))))))))))))))))))).
...
thf(achsscon2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwss @ XA2 @ (ccfv @ XB2 @ ccort)) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccort))))))).
...
thf(ahlimadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : ((cwi @ Xph @ (cwf @ ccn @ cchil @ XF)) => ((cwi @ Xph @ (cwf @ ccn @ cchil @ XG)) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ XF @ (XA2 @ Xn) @ cchli))) => ((! [Xn:$i] : (cwi @ Xph @ (cwbr @ XG @ (XB2 @ Xn) @ cchli))) => ((! [Xn:$i] : (cwceq @ (XH @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG) @ ccva))))) => (! [Xn:$i] : (cwi @ Xph @ (cwbr @ (XH @ Xn) @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccva) @ cchli))))))))))))))).
...
thf(achscllem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ ccch))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XB2 @ ccch))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwf @ ccn @ (cco @ XA2 @ XB2 @ ccph) @ XH))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ XH @ (ccv @ Xu) @ cchli))) => ((! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xu @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XA2 @ ccpjh))))))) => (! [Xu:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XF @ Xu @ Xn) @ (ccdm @ cchli))))))))))))))))).
...
thf(cchscllem4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ ccch))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XB2 @ ccch))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwf @ ccn @ (cco @ XA2 @ XB2 @ ccph) @ XH))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ XH @ (ccv @ Xu) @ cchli))) => ((! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xu @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XA2 @ ccpjh))))))) => ((! [Xu:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xu @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XB2 @ ccpjh))))))) => (! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccph)))))))))))))))))).
