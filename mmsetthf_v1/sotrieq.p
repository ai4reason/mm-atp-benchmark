...
thf(csotrieq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwa @ (cwor @ XA2 @ XR) @ (cwa @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2))) @ (cwb @ (cwceq @ XB2 @ XC) @ (cwn @ (cwo @ (cwbr @ XB2 @ XC @ XR) @ (cwbr @ XC @ XB2 @ XR)))))))))).
