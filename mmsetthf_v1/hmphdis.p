...
thf(ahmeoopn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) @ (cwss @ XA2 @ XX)) @ (cwb @ (cwcel @ XA2 @ XJ) @ (cwcel @ (ccima @ XF @ XA2) @ XK)))))))))).
thf(chmphdis_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwbr @ XJ @ (ccpw @ XA2) @ cchmph) @ (cwceq @ XJ @ (ccpw @ XX)))))))).
