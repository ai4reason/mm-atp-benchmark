...
thf(ahlateq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => (cwi @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwb @ (cwral @ (^ [Xp:$i] : (cwb @ (cwbr @ (ccv @ Xp) @ XX @ Xc_le) @ (cwbr @ (ccv @ Xp) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2)) @ (cwceq @ XX @ XY))))))))))))).
...
thf(cltrneq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : (cwceq @ XA2 @ (ccfv @ (XK @ Xp) @ ccatm))) => ((! [Xp:$i] : (cwceq @ (XH @ Xp) @ (ccfv @ (XK @ Xp) @ cclh))) => ((! [Xp:$i] : (cwceq @ (XT @ Xp) @ (ccfv @ (XW @ Xp) @ (ccfv @ (XK @ Xp) @ ccltrn)))) => (! [Xp:$i] : (cwi @ (cw3a @ (cwa @ (cwcel @ (XK @ Xp) @ cchlt) @ (cwcel @ (XW @ Xp) @ (XH @ Xp))) @ (cwcel @ XF @ (XT @ Xp)) @ (cwcel @ XG @ (XT @ Xp))) @ (cwb @ (cwral @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccv @ Xp) @ XF) @ (ccfv @ (ccv @ Xp) @ XG))) @ (^ [Xp:$i] : XA2)) @ (cwceq @ XF @ XG))))))))))))))).
