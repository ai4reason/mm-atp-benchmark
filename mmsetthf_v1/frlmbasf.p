...
thf(cfrlmbasf_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (cco @ XR @ XI @ ccfrlm)) => ((cwceq @ XN @ (ccfv @ XR @ ccbs)) => ((cwceq @ XB2 @ (ccfv @ XF @ ccbs)) => (cwi @ (cwa @ (cwcel @ XI @ XW) @ (cwcel @ XX @ XB2)) @ (cwf @ XI @ XN @ XX))))))))))))).
