...
thf(aalephsucdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwcel @ XB2 @ ccon0) @ (cwb @ (cwbr @ XA2 @ (ccfv @ XB2 @ ccale) @ ccdom) @ (cwbr @ XA2 @ (ccfv @ (ccsuc @ XB2) @ ccale) @ ccsdm)))))).
...
thf(calephreg_conj,conjecture,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ (ccfv @ (ccsuc @ XA2) @ ccale) @ cccf) @ (ccfv @ (ccsuc @ XA2) @ ccale)))).
