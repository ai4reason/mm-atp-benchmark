...
thf(adf_nghm_ax,axiom,(cwceq @ ccnghm @ (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : ccngp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : ccngp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccima @ (cccnv @ (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ ccnmo)) @ ccr)))))).
thf(creldmnghm_conj,conjecture,(cwrel @ (ccdm @ ccnghm))).
