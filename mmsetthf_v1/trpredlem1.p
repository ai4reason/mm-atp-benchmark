...
thf(afrsucmptn_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XD @ Xx3))) => ((! [Xx3:$i] : (cwceq @ (XF @ Xx3) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XA2 @ Xx3)) @ ccom))) => ((! [Xx3:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (XB2 @ Xx3) @ (XF @ Xx3))) @ (cwceq @ (XC @ Xx3) @ (XD @ Xx3)))) => (! [Xx3:$i] : (cwi @ (cwn @ (cwcel @ (XD @ Xx3) @ ccvv)) @ (cwceq @ (ccfv @ (ccsuc @ (XB2 @ Xx3)) @ (XF @ Xx3)) @ cc0)))))))))))))).
thf(a_0ss_thm,axiom,(! [XA2:($i > $o)] : (cwss @ cc0 @ XA2))).
thf(anfvres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwn @ (cwcel @ XA2 @ XB2)) @ (cwceq @ (ccfv @ XA2 @ (ccres @ XF @ XB2)) @ cc0)))))).
thf(ctrpredlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xi:$i] : (! [XX:($i > ($i > $o))] : (! [Xy1:$i] : (! [Xa:$i] : (cwi @ (cwcel @ (ccpred @ XA2 @ XR @ (XX @ Xy1)) @ (XB2 @ Xy1 @ Xa)) @ (cwss @ (ccfv @ (ccv @ Xi) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xy1:$i] : (ccv @ Xa)) @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))))) @ (ccpred @ XA2 @ XR @ (XX @ Xy1))) @ ccom)) @ XA2)))))))))).
