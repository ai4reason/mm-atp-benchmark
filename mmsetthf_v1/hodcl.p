...
thf(chodcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) @ (cwcel @ XA2 @ cchil)) @ (cwcel @ (ccfv @ XA2 @ (cco @ XS @ XT @ cchod)) @ cchil)))))).
