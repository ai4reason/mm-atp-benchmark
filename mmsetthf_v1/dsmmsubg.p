...
thf(adsmm0cl_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XH @ (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccmnd @ XR)) => ((cwceq @ Xc_0 @ (ccfv @ XP @ cc0g)) => (cwi @ Xph @ (cwcel @ Xc_0 @ XH)))))))))))))))))).
...
thf(adsmmacl_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XH @ (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccmnd @ XR)) => ((cwi @ Xph @ (cwcel @ XJ @ XH)) => ((cwi @ Xph @ (cwcel @ XK @ XH)) => ((cwceq @ Xc_pl @ (ccfv @ XP @ ccplusg)) => (cwi @ Xph @ (cwcel @ (cco @ XJ @ XK @ Xc_pl) @ XH)))))))))))))))))))))).
...
thf(aprdsinvgd2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XS @ XR @ ccprds)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccgrp @ XR)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XN @ (ccfv @ XY @ ccminusg)) => ((cwi @ Xph @ (cwcel @ XX @ XB2)) => ((cwi @ Xph @ (cwcel @ XJ @ XI)) => (cwi @ Xph @ (cwceq @ (ccfv @ XJ @ (ccfv @ XX @ XN)) @ (ccfv @ (ccfv @ XJ @ XX) @ (ccfv @ (ccfv @ XJ @ XR) @ ccminusg)))))))))))))))))))))))).
...
thf(cdsmmsubg_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XP @ (cco @ XS @ XR @ ccprds)) => ((cwceq @ XH @ (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XS @ XV)) => ((cwi @ Xph @ (cwf @ XI @ ccgrp @ XR)) => (cwi @ Xph @ (cwcel @ XH @ (ccfv @ XP @ ccsubg))))))))))))))))).
