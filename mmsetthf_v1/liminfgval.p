...
thf(climinfgval_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwi @ (cwcel @ XM @ ccr) @ (cwceq @ (ccfv @ XM @ (XG @ Xk)) @ (ccinf @ (ccin @ (ccima @ XF @ (cco @ XM @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))))))).
