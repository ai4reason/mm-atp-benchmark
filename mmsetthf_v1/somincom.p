...
thf(csomincom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwor @ XX @ XR) @ (cwa @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) @ (cwceq @ (ccif @ (cwbr @ XA2 @ XB2 @ XR) @ XA2 @ XB2) @ (ccif @ (cwbr @ XB2 @ XA2 @ XR) @ XB2 @ XA2)))))))).
