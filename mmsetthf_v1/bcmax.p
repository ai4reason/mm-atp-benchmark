...
thf(abcmono_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) @ (cwbr @ XB2 @ (cco @ XN @ cc2 @ ccdiv) @ ccle)) @ (cwbr @ (cco @ XN @ XA2 @ ccbc) @ (cco @ XN @ XB2 @ ccbc) @ ccle)))))).
...
thf(cbcmax_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccz)) @ (cwbr @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XK @ ccbc) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccle))))).
