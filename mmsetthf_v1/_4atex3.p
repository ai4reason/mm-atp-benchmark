...
thf(c_4atex3_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ Xc_or @ (ccfv @ XK @ ccjn)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XH @ (ccfv @ XK @ cclh)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cw3a @ (cwa @ (cwcel @ XP @ XA2) @ (cwn @ (cwbr @ XP @ XW @ Xc_le))) @ (cwa @ (cwcel @ XQ @ XA2) @ (cwn @ (cwbr @ XQ @ XW @ Xc_le))) @ (cwa @ (cwcel @ XS @ XA2) @ (cwn @ (cwbr @ XS @ XW @ Xc_le)))) @ (cw3a @ (cwne @ XP @ XQ) @ (cwa @ (cwcel @ XT @ XA2) @ (cwne @ XS @ XT)) @ (cwrex @ (^ [Xr:$i] : (cwa @ (cwn @ (cwbr @ (ccv @ Xr) @ XW @ Xc_le)) @ (cwceq @ (cco @ XP @ (ccv @ Xr) @ Xc_or) @ (cco @ XQ @ (ccv @ Xr) @ Xc_or)))) @ (^ [Xr:$i] : XA2)))) @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwn @ (cwbr @ (ccv @ Xz) @ XW @ Xc_le)) @ (cw3a @ (cwne @ (ccv @ Xz) @ XS) @ (cwne @ (ccv @ Xz) @ XT) @ (cwbr @ (ccv @ Xz) @ (cco @ XS @ XT @ Xc_or) @ Xc_le)))) @ (^ [Xz:$i] : XA2)))))))))))))))))).
