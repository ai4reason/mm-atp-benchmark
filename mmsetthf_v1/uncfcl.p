...
thf(cuncfcl_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ XF @ (cco @ (ccs3 @ XC @ XD @ XE) @ XG @ ccuncf)) => ((cwi @ Xph @ (cwcel @ XD @ cccat)) => ((cwi @ Xph @ (cwcel @ XE @ cccat)) => ((cwi @ Xph @ (cwcel @ XG @ (cco @ XC @ (cco @ XD @ XE @ ccfuc) @ ccfunc))) => (cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XC @ XD @ ccxpc) @ XE @ ccfunc)))))))))))))).
