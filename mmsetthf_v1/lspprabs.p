...
thf(alsmelvalmi_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XX @ XT)) => ((cwi @ Xph @ (cwcel @ XY @ XU)) => (cwi @ Xph @ (cwcel @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XT @ XU @ Xc_po)))))))))))))))))).
...
thf(clspprabs_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => ((cwceq @ XN @ (ccfv @ XW @ cclspn)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((cwi @ Xph @ (cwcel @ XX @ XV)) => ((cwi @ Xph @ (cwcel @ XY @ XV)) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccpr @ XX @ (cco @ XX @ XY @ Xc_pl)) @ XN) @ (ccfv @ (ccpr @ XX @ XY) @ XN))))))))))))))))).
