...
thf(csqeqd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp))) => ((cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) => ((cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle)) => ((cwi @ (cw3a @ Xph @ (cwceq @ (ccfv @ XA2 @ ccre) @ ccc0) @ (cwceq @ (ccfv @ XB2 @ ccre) @ ccc0)) @ (cwceq @ XA2 @ XB2)) => (cwi @ Xph @ (cwceq @ XA2 @ XB2)))))))))))).
