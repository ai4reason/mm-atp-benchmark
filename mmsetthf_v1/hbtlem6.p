...
thf(ahbtlem2_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XP @ (ccfv @ XR @ ccpl1)) => ((cwceq @ XU @ (ccfv @ XP @ cclidl)) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((cwceq @ XT @ (ccfv @ XR @ cclidl)) => (cwi @ (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwcel @ XX @ ccn0)) @ (cwcel @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ XT)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ XA2 @ XA2))).
thf(alnr2i_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XU @ (ccfv @ XR @ cclidl)) => ((cwceq @ XN @ (ccfv @ XR @ ccrsp)) => (cwi @ (cwa @ (cwcel @ XR @ cclnr) @ (cwcel @ XI @ XU)) @ (cwrex @ (^ [Xg1:$i] : (cwceq @ XI @ (ccfv @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XI) @ ccfn))))))))))).
...
thf(chbtlem6_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XP @ Xk) @ (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : (cwceq @ (XU @ Xk) @ (ccfv @ (XP @ Xk) @ cclidl))) => ((cwceq @ XS @ (ccfv @ XR @ ccldgis)) => ((! [Xk:$i] : (cwceq @ (XN @ Xk) @ (ccfv @ (XP @ Xk) @ ccrsp))) => ((cwi @ Xph @ (cwcel @ XR @ cclnr)) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XI @ (XU @ Xk)))) => ((cwi @ Xph @ (cwcel @ XX @ ccn0)) => (cwi @ Xph @ (cwrex @ (^ [Xk:$i] : (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XX @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XN @ Xk)) @ XS)))) @ (^ [Xk:$i] : (ccin @ (ccpw @ XI) @ ccfn)))))))))))))))))))).
