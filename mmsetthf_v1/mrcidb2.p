...
thf(amrcidb_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwb @ (cwcel @ XU @ XC) @ (cwceq @ (ccfv @ XU @ XF) @ XU))))))))).
...
thf(cmrcidb2_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XF @ (ccfv @ XC @ ccmrc)) => (cwi @ (cwa @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwss @ XU @ XX)) @ (cwb @ (cwcel @ XU @ XC) @ (cwss @ (ccfv @ XU @ XF) @ XU))))))))).
