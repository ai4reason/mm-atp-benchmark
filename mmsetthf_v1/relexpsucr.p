...
thf(arelexp0_thm,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwrel @ XR)) @ (cwceq @ (cco @ XR @ ccc0 @ ccrelexp) @ (ccres @ ccid @ (ccuni @ (ccuni @ XR)))))))).
thf(crelexpsucr_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ XV) @ (cwrel @ XR) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) @ (cccom @ (cco @ XR @ XN @ ccrelexp) @ XR))))))).
