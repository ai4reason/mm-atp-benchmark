...
thf(cisrim0_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW)) @ (cwb @ (cwcel @ XF @ (cco @ XR @ XS @ ccrs)) @ (cwa @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh)) @ (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ ccrh))))))))))).
