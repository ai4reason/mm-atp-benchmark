...
thf(apw0_thm,axiom,(cwceq @ (ccpw @ cc0) @ (ccsn @ cc0))).
...
thf(ahashun3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwceq @ (ccfv @ (ccun @ XA2 @ XB2) @ cchash) @ (cco @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccaddc) @ (ccfv @ (ccin @ XA2 @ XB2) @ cchash) @ ccmin)))))).
...
thf(aintunsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (cwceq @ (ccint @ (ccun @ XA2 @ (ccsn @ XB2))) @ (ccin @ (ccint @ XA2) @ XB2)))))).
...
thf(cincexclem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn)) @ (cwceq @ (cco @ (ccfv @ XB2 @ cchash) @ (ccfv @ (ccin @ XB2 @ (ccuni @ XA2)) @ cchash) @ ccmin) @ (ccsu @ (ccpw @ XA2) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccexp) @ (ccfv @ (ccin @ XB2 @ (ccint @ (ccv @ Xs1))) @ cchash) @ ccmul)))))))).
