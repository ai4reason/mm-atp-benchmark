...
thf(cspansneleq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ cchil) @ (cwne @ XA2 @ cc0v)) @ (cwi @ (cwcel @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn)) @ (cwceq @ (ccfv @ (ccsn @ XA2) @ ccspn) @ (ccfv @ (ccsn @ XB2) @ ccspn))))))).
