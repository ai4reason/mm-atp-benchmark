...
thf(aabscn_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwcel @ ccabs @ (cco @ XJ @ XK @ cccn))))))).
...
thf(cabscncfALT_conj,conjecture,(cwcel @ ccabs @ (cco @ ccc @ ccr @ cccncf))).
