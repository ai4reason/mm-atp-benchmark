...
thf(ahashsn01_thm,axiom,(! [XA2:($i > $o)] : (cwo @ (cwceq @ (ccfv @ (ccsn @ XA2) @ cchash) @ ccc0) @ (cwceq @ (ccfv @ (ccsn @ XA2) @ cchash) @ cc1)))).
...
thf(alfgredgge2_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((cwceq @ XA2 @ (ccdm @ XI)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))))) => (! [Xx3:$i] : (cwi @ (cwa @ (cwf @ XA2 @ (XE @ Xx3) @ XI) @ (cwcel @ (XX @ Xx3) @ XA2)) @ (cwbr @ cc2 @ (ccfv @ (ccfv @ (XX @ Xx3) @ XI) @ cchash) @ ccle))))))))))))).
...
thf(clfgrnloop_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XI @ (ccfv @ (XG @ Xx3) @ cciedg))) => ((cwceq @ XA2 @ (ccdm @ XI)) => ((! [Xx3:$i] : (cwceq @ (XE @ Xx3) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))))) => (! [Xx3:$i] : (cwi @ (cwf @ XA2 @ (XE @ Xx3) @ XI) @ (cwceq @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccv @ Xx3) @ XI) @ (ccsn @ XU))) @ (^ [Xx3:$i] : XA2)) @ cc0))))))))))))).
