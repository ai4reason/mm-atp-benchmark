...
thf(ctngnm_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ ccvv) => (cwi @ (cwa @ (cwcel @ XG @ ccgrp) @ (cwf @ XX @ XA2 @ XN)) @ (cwceq @ XN @ (ccfv @ XT @ ccnm)))))))))))).
