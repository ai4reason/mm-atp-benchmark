...
thf(adf_rng0_ax,axiom,(cwceq @ ccrng @ (ccrab @ (^ [Xf1:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xf1) @ ccmgp) @ ccsgrp) @ (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xt:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xp)) @ (ccv @ Xt)) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xt)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xt)) @ (ccv @ Xp))) @ (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xp)) @ (ccv @ Xz) @ (ccv @ Xt)) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xt)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xt)) @ (ccv @ Xp))))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xf1) @ ccmulr))) @ (ccfv @ (ccv @ Xf1) @ ccplusg))) @ (ccfv @ (ccv @ Xf1) @ ccbs)))) @ (^ [Xf1:$i] : ccabl)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(cisrng_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xz) @ (ccfv @ XR @ ccmgp))))) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmulr)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwb @ (cwcel @ XR @ ccrng) @ (cw3a @ (cwcel @ XR @ ccabl) @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xz) @ ccsgrp) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwa @ (cwceq @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl) @ Xc_x) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_x) @ Xc_pl)) @ (cwceq @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (ccv @ Xz) @ Xc_x) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_x) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_x) @ Xc_pl)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))))))).
