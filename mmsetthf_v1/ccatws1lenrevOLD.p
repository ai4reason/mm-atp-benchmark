...
thf(cccatws1lenrevOLD_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XX @ XV)) @ (cwi @ (cwceq @ (ccfv @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ cchash) @ XN) @ (cwceq @ (ccfv @ XW @ cchash) @ (cco @ XN @ cc1 @ ccmin))))))))).
