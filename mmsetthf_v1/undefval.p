...
thf(adf_undef_ax,axiom,(cwceq @ ccund @ (ccmpt @ (^ [Xs1:$i] : ccvv) @ (^ [Xs1:$i] : (ccpw @ (ccuni @ (ccv @ Xs1))))))).
thf(cundefval_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XS @ XV) @ (cwceq @ (ccfv @ XS @ ccund) @ (ccpw @ (ccuni @ XS))))))).
