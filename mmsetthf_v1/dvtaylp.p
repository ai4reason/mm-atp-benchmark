...
thf(advnadd_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) @ (cwa @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0))) @ (cwceq @ (ccfv @ XN @ (cco @ XS @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)) @ ccdvn)) @ (ccfv @ (cco @ XM @ XN @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))))))).
...
thf(cdvtaylp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((cwi @ Xph @ (cwf @ XA2 @ ccc @ XF)) => ((cwi @ Xph @ (cwss @ XA2 @ XS)) => ((cwi @ Xph @ (cwcel @ XN @ ccn0)) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccdm @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))) => (cwi @ Xph @ (cwceq @ (cco @ ccc @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XB2 @ (cco @ XS @ XF @ cctayl)) @ ccdv) @ (cco @ XN @ XB2 @ (cco @ XS @ (cco @ XS @ XF @ ccdv) @ cctayl)))))))))))))))).
