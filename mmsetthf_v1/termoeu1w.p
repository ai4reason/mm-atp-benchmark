...
thf(atermoeu1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ cctermo))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XC @ cctermo))) => (cwi @ Xph @ (cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cciso)))))))))))))).
...
thf(atermoo_thm,axiom,(! [XC:($i > $o)] : (! [XO:($i > $o)] : (cwi @ (cwcel @ XC @ cccat) @ (cwi @ (cwcel @ XO @ (ccfv @ XC @ cctermo)) @ (cwcel @ XO @ (ccfv @ XC @ ccbs))))))).
thf(ctermoeu1w_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ cccat)) => ((cwi @ Xph @ (cwcel @ XA2 @ (ccfv @ XC @ cctermo))) => ((cwi @ Xph @ (cwcel @ XB2 @ (ccfv @ XC @ cctermo))) => (cwi @ Xph @ (cwbr @ XA2 @ XB2 @ (ccfv @ XC @ cccic))))))))))).
