...
thf(cacni_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XX @ (cwacn @ XA2)) @ (cwf @ XA2 @ (ccdif @ (ccpw @ XX) @ (ccsn @ cc0)) @ XF)) @ (cwex @ (^ [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : XA2))))))))).
