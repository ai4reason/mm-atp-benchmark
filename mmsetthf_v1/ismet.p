...
thf(adf_met_ax,axiom,(cwceq @ ccme @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xd:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwa @ (cwb @ (cwceq @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xd)) @ ccc0) @ (cwceq @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwral @ (^ [Xw:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xd)) @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xy1) @ (ccv @ Xd)) @ (cco @ (ccv @ Xw) @ (ccv @ Xz) @ (ccv @ Xd)) @ ccaddc) @ ccle)) @ (^ [Xw:$i] : (ccv @ Xx3))))) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xd:$i] : (cco @ ccr @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)) @ ccmap))))))).
