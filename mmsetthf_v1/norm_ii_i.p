...
thf(anormlem7_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccc) => ((cwcel @ XF @ cchil) => ((cwcel @ XG @ cchil) => ((cwceq @ (ccfv @ XS @ ccabs) @ cc1) => (cwbr @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XF @ XG @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XG @ XF @ ccsp) @ ccmul) @ ccaddc) @ (cco @ cc2 @ (cco @ (ccfv @ (cco @ XG @ XG @ ccsp) @ ccsqrt) @ (ccfv @ (cco @ XF @ XF @ ccsp) @ ccsqrt) @ ccmul) @ ccmul) @ ccle))))))))).
