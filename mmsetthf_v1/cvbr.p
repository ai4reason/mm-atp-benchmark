...
thf(adf_cv_ax,axiom,(cwceq @ cccv @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwa @ (cwa @ (cwcel @ (ccv @ Xx3) @ ccch) @ (cwcel @ (ccv @ Xy1) @ ccch)) @ (cwa @ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwn @ (cwrex @ (^ [Xz:$i] : (cwa @ (cwpss @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwpss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : ccch)))))))))).
thf(ccvbr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch)) @ (cwb @ (cwbr @ XA2 @ XB2 @ cccv) @ (cwa @ (cwpss @ XA2 @ XB2) @ (cwn @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwpss @ XA2 @ (ccv @ Xx3)) @ (cwpss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccch))))))))).
