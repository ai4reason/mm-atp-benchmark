...
thf(afmtnorec2_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfmtno) @ (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc))))).
...
thf(abinom2sub1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cwceq @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ cc2 @ XA2 @ ccmul) @ ccmin) @ cc1 @ ccaddc))))).
...
thf(afmtnom1nn_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ (ccfv @ XN @ ccfmtno) @ cc1 @ ccmin) @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp))))).
...
thf(cfmtnorec3_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwceq @ (ccfv @ XN @ ccfmtno) @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfmtno) @ (cco @ (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccexp) @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ XN @ cc2 @ ccmin) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ ccmul) @ ccaddc))))).
