...
thf(cbnj1534_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XD @ Xx3 @ Xz @ Xw) @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ (ccfv @ (ccv @ Xx3) @ XH))) @ (^ [Xx3:$i] : XA2)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (cwi @ (cwcel @ (ccv @ Xw) @ (XF @ Xx3)) @ (cwal @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xw) @ (XF @ Xx3))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwceq @ (XD @ Xx3 @ Xz @ Xw) @ (ccrab @ (^ [Xz:$i] : (cwne @ (ccfv @ (ccv @ Xz) @ (XF @ Xx3)) @ (ccfv @ (ccv @ Xz) @ XH))) @ (^ [Xz:$i] : XA2))))))))))))).
