...
thf(ceupthseg_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwbr @ XF @ XP @ (ccfv @ XG @ cceupth)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) @ (cwss @ (ccpr @ (ccfv @ XN @ XP) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ XN @ XF) @ XI)))))))))).
