...
thf(afacgam_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (ccfv @ XN @ ccfa) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccgam))))).
...
thf(cgamfac_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (ccfv @ XN @ ccgam) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa))))).
