...
thf(adifsnen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwbr @ (ccdif @ XX @ (ccsn @ XA2)) @ (ccdif @ XX @ (ccsn @ XB2)) @ ccen))))))).
...
thf(cenfixsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwbr @ XX @ XY @ ccen)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1o @ XX @ XY @ (ccv @ Xf1)) @ (cwceq @ (ccfv @ XA2 @ (ccv @ Xf1)) @ XB2)))))))))).
