...
thf(asmfinflem_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xx3 @ Xy1 @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xn) @ ccuz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwcel @ (XS @ Xx3 @ Xy1) @ ccsalg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ Xph @ (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xy1) @ ccsmblfn) @ XF)))) => ((cwceq @ XD @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdm @ (ccfv @ (ccv @ Xn) @ XF))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccfv @ (XS @ Xx3 @ Xy1) @ ccsmblfn)))))))))))))))))))).
...
thf(acbvrabcsf_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) @ (ccrab @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))))))))))))))))).
...
thf(acbviin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwceq @ (XB2 @ Xx3 @ Xy1) @ (XC @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) @ (cciin @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))))))))).
...
thf(csmfinf_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwnfc @ (^ [Xn:$i] : (XF @ Xx3 @ Xn)))) => ((! [Xn:$i] : (cwnfc @ (^ [Xx3:$i] : (XF @ Xx3 @ Xn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xn) @ (cwcel @ (XM @ Xx3 @ Xy1 @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xn) @ ccuz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xn) @ (cwcel @ (XS @ Xx3 @ Xy1 @ Xn) @ ccsalg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xn) @ (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xy1 @ Xn) @ ccsmblfn) @ (XF @ Xx3 @ Xn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XD @ Xx3 @ Xy1 @ Xn) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XF @ Xx3 @ Xn))) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xx3 @ Xn))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccmpt @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1 @ Xn)) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XF @ Xx3 @ Xn)))))) @ ccr @ cclt))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xn) @ (cwcel @ (XG @ Xx3 @ Xy1 @ Xn) @ (ccfv @ (XS @ Xx3 @ Xy1 @ Xn) @ ccsmblfn)))))))))))))))))))))).
