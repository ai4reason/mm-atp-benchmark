...
thf(aimasf1oxmet_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwf1o @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ XZ)) => ((cwceq @ XE @ (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XV @ XV))) => ((cwceq @ XD @ (ccfv @ XU @ ccds)) => ((cwi @ Xph @ (cwcel @ XE @ (ccfv @ XV @ ccxmt))) => (cwi @ Xph @ (cwcel @ XD @ (ccfv @ XB2 @ ccxmt)))))))))))))))))))).
...
thf(aunirnbl_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwceq @ (ccuni @ (ccrn @ (ccfv @ XD @ ccbl))) @ XX))))).
thf(af1oeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwceq @ XA2 @ XB2) @ (cwb @ (cwf1o @ XA2 @ XC @ XF) @ (cwf1o @ XB2 @ XC @ XF)))))))).
thf(cctopon_tp,type,(cctopon : ($i > $o))).
thf(atgqtop_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ cctb) @ (cwf1o @ XX @ XY @ XF)) @ (cwceq @ (cco @ (ccfv @ XJ @ cctg) @ XF @ ccqtop) @ (ccfv @ (cco @ XJ @ XF @ ccqtop) @ cctg))))))))).
...
thf(aimasf1obl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwf1o @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ XZ)) => ((cwceq @ XE @ (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XV @ XV))) => ((cwceq @ XD @ (ccfv @ XU @ ccds)) => ((cwi @ Xph @ (cwcel @ XE @ (ccfv @ XV @ ccxmt))) => ((cwi @ Xph @ (cwcel @ XP @ XV)) => ((cwi @ Xph @ (cwcel @ XS @ ccxr)) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ XP @ XF) @ XS @ (ccfv @ XD @ ccbl)) @ (ccima @ XF @ (cco @ XP @ XS @ (ccfv @ XE @ ccbl)))))))))))))))))))))))))).
...
thf(aelqtop2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cwa @ (cwcel @ XJ @ XV) @ (cwfo @ XX @ XY @ XF)) @ (cwb @ (cwcel @ XA2 @ (cco @ XJ @ XF @ ccqtop)) @ (cwa @ (cwss @ XA2 @ XY) @ (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ XJ)))))))))))).
...
thf(cimasf1oxms_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwf1o @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ ccxme)) => (cwi @ Xph @ (cwcel @ XU @ ccxme))))))))))))).
