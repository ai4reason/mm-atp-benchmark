...
thf(cuhgrissubgr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XS @ ccvtx)) => ((cwceq @ XA2 @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XI @ (ccfv @ XS @ cciedg)) => ((cwceq @ XB2 @ (ccfv @ XG @ cciedg)) => (cwi @ (cw3a @ (cwcel @ XG @ XW) @ (cwfun @ XB2) @ (cwcel @ XS @ ccuhgr)) @ (cwb @ (cwbr @ XS @ XG @ ccsubgr) @ (cwa @ (cwss @ XV @ XA2) @ (cwss @ XI @ XB2)))))))))))))))).
