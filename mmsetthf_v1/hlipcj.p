...
thf(chlipcj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XU @ ccba)) => ((cwceq @ XP @ (ccfv @ XU @ ccdip)) => (cwi @ (cw3a @ (cwcel @ XU @ cchlo) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) @ (cwceq @ (cco @ XA2 @ XB2 @ XP) @ (ccfv @ (cco @ XB2 @ XA2 @ XP) @ cccj))))))))))).
