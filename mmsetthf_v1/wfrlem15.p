...
thf(awfrlem10_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xz:$i] : (cwwe @ XA2 @ (XR @ Xz))) => ((! [Xz:$i] : (cwceq @ (XF @ Xz) @ (ccwrecs @ XA2 @ (XR @ Xz) @ (XG @ Xz)))) => (! [Xz:$i] : (cwi @ (cwa @ (cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz)))) @ (cwceq @ (ccpred @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz))) @ (XR @ Xz) @ (ccv @ Xz)) @ cc0)) @ (cwceq @ (ccpred @ XA2 @ (XR @ Xz) @ (ccv @ Xz)) @ (ccdm @ (XF @ Xz)))))))))))).
...
thf(awfrlem14_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : (cwceq @ XF @ (ccwrecs @ XA2 @ XR @ (XG @ Xz)))) => ((! [Xz:$i] : (cwceq @ (XC @ Xz) @ (ccun @ XF @ (ccsn @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ (XG @ Xz))))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ XF))) @ (cwi @ (cwcel @ (ccv @ Xy1) @ (ccun @ (ccdm @ XF) @ (ccsn @ (ccv @ Xz)))) @ (cwceq @ (ccfv @ (ccv @ Xy1) @ (XC @ Xz)) @ (ccfv @ (ccres @ (XC @ Xz) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ (XG @ Xz))))))))))))))))).
