...
thf(cbnj168_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [Xn:$i] : ((! [Xm:$i] : (cwceq @ (XD @ Xm) @ (ccdif @ ccom @ (ccsn @ cc0)))) => (! [Xm:$i] : (cwi @ (cwa @ (cwne @ (ccv @ Xn) @ cc1o) @ (cwcel @ (ccv @ Xn) @ (XD @ Xm))) @ (cwrex @ (^ [Xm:$i] : (cwceq @ (ccv @ Xn) @ (ccsuc @ (ccv @ Xm)))) @ (^ [Xm:$i] : (XD @ Xm))))))))).
