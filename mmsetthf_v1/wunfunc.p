...
thf(cwunfunc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : ((cwi @ Xph @ (cwcel @ XU @ ccwun)) => ((cwi @ Xph @ (cwcel @ XC @ XU)) => ((cwi @ Xph @ (cwcel @ XD @ XU)) => (cwi @ Xph @ (cwcel @ (cco @ XC @ XD @ ccfunc) @ XU)))))))))).
