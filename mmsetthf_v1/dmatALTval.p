...
thf(adf_dmatalt_ax,axiom,(cwceq @ ccdmatalt @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccfn)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccsb @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ (^ [Xa:$i] : (cco @ (ccv @ Xa) @ (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwne @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwceq @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)) @ (ccfv @ (ccv @ Xr) @ cc0g)))) @ (^ [Xj:$i] : (ccv @ Xn)))) @ (^ [Xi:$i] : (ccv @ Xn)))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xa) @ ccbs))) @ ccress)))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cdmatALTval_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (cwceq @ (XA2 @ Xi @ Xj @ Xm) @ (cco @ XN @ XR @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (cwceq @ (XB2 @ Xi @ Xj) @ (ccfv @ (XA2 @ Xi @ Xj @ Xm) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (cwceq @ (Xc_0 @ Xi @ Xj @ Xm) @ (ccfv @ XR @ cc0g))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (cwceq @ (XD @ Xi @ Xj @ Xm) @ (cco @ XN @ XR @ ccdmatalt))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (cwi @ (cwa @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccvv)) @ (cwceq @ (XD @ Xi @ Xj @ Xm) @ (cco @ (XA2 @ Xi @ Xj @ Xm) @ (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwi @ (cwne @ (ccv @ Xi) @ (ccv @ Xj)) @ (cwceq @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)) @ (Xc_0 @ Xi @ Xj @ Xm)))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN))) @ (^ [Xm:$i] : (XB2 @ Xi @ Xj))) @ ccress))))))))))))))))).
