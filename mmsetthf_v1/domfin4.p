...
thf(assfin4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfin4) @ (cwss @ XB2 @ XA2)) @ (cwcel @ XB2 @ ccfin4))))).
...
thf(cdomfin4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccfin4) @ (cwbr @ XB2 @ XA2 @ ccdom)) @ (cwcel @ XB2 @ ccfin4))))).
