...
thf(assindif0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwb @ (cwss @ XA2 @ XB2) @ (cwceq @ (ccin @ XA2 @ (ccdif @ ccvv @ XB2)) @ cc0))))).
...
thf(azfregs_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccin @ (ccv @ Xx3) @ XA2) @ cc0)) @ (^ [Xx3:$i] : XA2))))).
thf(avdif0_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ XA2 @ ccvv) @ (cwceq @ (ccdif @ ccvv @ XA2) @ cc0)))).
thf(csetind_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xx3) @ XA2)))) @ (cwceq @ XA2 @ ccvv)))).
