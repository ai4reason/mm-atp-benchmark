...
thf(amsqge0_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ (cco @ XA2 @ XA2 @ ccmul) @ ccle)))).
...
thf(csqge0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ (cco @ XA2 @ cc2 @ ccexp) @ ccle)))).
