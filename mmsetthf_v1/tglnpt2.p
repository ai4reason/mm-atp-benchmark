...
thf(ctglnpt2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwceq @ (XP @ Xy1) @ (ccfv @ (XG @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (cwceq @ (XI @ Xy1) @ (ccfv @ (XG @ Xy1) @ ccitv))) => ((! [Xy1:$i] : (cwceq @ (XL @ Xy1) @ (ccfv @ (XG @ Xy1) @ cclng))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ (XG @ Xy1) @ ccstrkg))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XA2 @ (ccrn @ (XL @ Xy1))))) => ((! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwcel @ XX @ XA2))) => (! [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwrex @ (^ [Xy1:$i] : (cwne @ XX @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2)))))))))))))))))).
