...
thf(agrppropstr_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ (ccfv @ XK @ ccbs) @ XB2) => ((cwceq @ (ccfv @ XK @ ccplusg) @ Xc_pl) => ((cwceq @ XL @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl))) => (cwb @ (cwcel @ XK @ ccgrp) @ (cwcel @ XL @ ccgrp)))))))))).
...
thf(amndprop_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ (ccfv @ XK @ ccbs) @ (ccfv @ XL @ ccbs)) => ((cwceq @ (ccfv @ XK @ ccplusg) @ (ccfv @ XL @ ccplusg)) => (cwb @ (cwcel @ XK @ ccmnd) @ (cwcel @ XL @ ccmnd))))))).
...
thf(cring1_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XM @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccsn @ XZ)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))))) => (cwi @ (cwcel @ XZ @ XV) @ (cwcel @ XM @ ccrg))))))).
