...
thf(csegconeu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn) @ (cw3a @ (cwa @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cwa @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee))) @ (cwne @ XC @ XD))) @ (cwreu @ (^ [Xr:$i] : (cwa @ (cwbr @ XD @ (ccop @ XC @ (ccv @ Xr)) @ ccbtwn) @ (cwbr @ (ccop @ XD @ (ccv @ Xr)) @ (ccop @ XA2 @ XB2) @ cccgr))) @ (^ [Xr:$i] : (ccfv @ XN @ ccee)))))))))).
