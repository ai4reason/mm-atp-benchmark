...
thf(cwlklnwwlkln2lem_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwi @ (cwcel @ XP @ (ccfv @ XG @ ccwwlks)) @ (cwex @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)))))) => (cwi @ Xph @ (cwi @ (cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn)) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ XN)))))))))))).
