...
thf(comessre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwi @ Xph @ (cwss @ XA2 @ XX)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XO) @ ccr)) => ((cwi @ Xph @ (cwss @ XB2 @ XA2)) => (cwi @ Xph @ (cwcel @ (ccfv @ XB2 @ XO) @ ccr))))))))))))).
