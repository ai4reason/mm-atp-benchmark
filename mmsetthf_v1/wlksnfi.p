...
thf(cwlksnfi_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XG @ ccfusgr) @ (cwcel @ XN @ ccn0)) @ (cwcel @ (ccrab @ (^ [Xp:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) @ XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ ccfn))))).
