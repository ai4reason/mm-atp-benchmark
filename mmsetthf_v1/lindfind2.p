...
thf(clindfind2_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XK @ (ccfv @ XW @ cclspn)) => ((cwceq @ XL @ (ccfv @ XW @ ccsca)) => (cwi @ (cw3a @ (cwa @ (cwcel @ XW @ cclmod) @ (cwcel @ XL @ ccnzr)) @ (cwbr @ XF @ XW @ cclindf) @ (cwcel @ XE @ (ccdm @ XF))) @ (cwn @ (cwcel @ (ccfv @ XE @ XF) @ (ccfv @ (ccima @ XF @ (ccdif @ (ccdm @ XF) @ (ccsn @ XE))) @ XK)))))))))))).
