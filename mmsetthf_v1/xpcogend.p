...
thf(cxpcogend_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwi @ Xph @ (cwne @ (ccin @ XB2 @ XC) @ cc0)) => (cwi @ Xph @ (cwceq @ (cccom @ (ccxp @ XC @ XD) @ (ccxp @ XA2 @ XB2)) @ (ccxp @ XA2 @ XD)))))))))).
