...
thf(aiscat_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (cwi @ (cwcel @ XC @ (XV @ Xx3 @ Xy1 @ Xz @ Xw @ Xf1 @ Xg1 @ Xk)) @ (cwb @ (cwcel @ XC @ cccat) @ (cwral @ (^ [Xx3:$i] : (cwa @ (cwrex @ (^ [Xg1:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwral @ (^ [Xf1:$i] : (cwceq @ (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xy1) @ (ccv @ Xx3)) @ (ccv @ Xx3) @ Xc_x)) @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XH))) @ (cwral @ (^ [Xf1:$i] : (cwceq @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (ccv @ Xy1) @ Xc_x)) @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH))))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xg1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XH))) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : (cwa @ (cwcel @ (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ Xc_x)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XH)) @ (cwral @ (^ [Xw:$i] : (cwral @ (^ [Xk:$i] : (cwceq @ (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xg1) @ (cco @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xw) @ Xc_x)) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xw) @ Xc_x)) @ (cco @ (ccv @ Xk) @ (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ Xc_x)) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ (ccv @ Xw) @ Xc_x)))) @ (^ [Xk:$i] : (cco @ (ccv @ Xz) @ (ccv @ Xw) @ XH)))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xg1:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XH)))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)))) @ (^ [Xx3:$i] : XB2)))))))))))))))))))).
...
thf(ccatidex_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XC @ ccbs)) => ((cwceq @ XH @ (ccfv @ XC @ cchom)) => ((cwceq @ Xc_x @ (ccfv @ XC @ ccco)) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1 @ Xf1) @ (cwcel @ XC @ cccat)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1 @ Xf1) @ (cwcel @ XX @ XB2)))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwi @ (Xph @ Xy1 @ Xf1) @ (cwrex @ (^ [Xg1:$i] : (cwral @ (^ [Xy1:$i] : (cwa @ (cwral @ (^ [Xf1:$i] : (cwceq @ (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xy1) @ XX) @ XX @ Xc_x)) @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xy1) @ XX @ XH))) @ (cwral @ (^ [Xf1:$i] : (cwceq @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (cco @ (ccop @ XX @ XX) @ (ccv @ Xy1) @ Xc_x)) @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ XX @ (ccv @ Xy1) @ XH))))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xg1:$i] : (cco @ XX @ XX @ XH)))))))))))))))))).
