...
thf(clesub0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwa @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwbr @ XB2 @ (cco @ XB2 @ XA2 @ ccmin) @ ccle)) @ (cwceq @ XA2 @ ccc0)))))).
