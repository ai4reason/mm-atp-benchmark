...
thf(cuvtxel_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => (cwb @ (cwcel @ XN @ (ccfv @ XG @ ccuvtx)) @ (cwa @ (cwcel @ XN @ XV) @ (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ XN @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))).
