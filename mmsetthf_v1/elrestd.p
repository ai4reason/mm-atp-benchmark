...
thf(celrestd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XJ @ XV)) => ((cwi @ Xph @ (cwcel @ XB2 @ XW)) => ((cwi @ Xph @ (cwcel @ XX @ XJ)) => ((cwceq @ XA2 @ (ccin @ XX @ XB2)) => (cwi @ Xph @ (cwcel @ XA2 @ (cco @ XJ @ XB2 @ ccrest))))))))))))))).
