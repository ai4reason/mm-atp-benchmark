...
thf(csqrtthlem_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccc) @ (cw3a @ (cwceq @ (cco @ (ccfv @ XA2 @ ccsqrt) @ cc2 @ ccexp) @ XA2) @ (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ ccsqrt) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccrp))))).
