...
thf(cabfmpunirn_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XF @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (cwcel @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cwceq @ (ccv @ Xy1) @ XB2) @ (cwb @ (Xph @ Xx3 @ Xy1) @ (Xps @ Xx3))))) => (cwb @ (cwcel @ XB2 @ (ccuni @ (ccrn @ XF))) @ (cwa @ (cwcel @ XB2 @ ccvv) @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XV))))))))))))).
