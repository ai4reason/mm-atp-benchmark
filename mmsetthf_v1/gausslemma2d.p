...
thf(agausslemma2dlem0i_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XM @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((cwceq @ XH @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((cwceq @ XN @ (cco @ XH @ XM @ ccmin)) => (cwi @ Xph @ (cwi @ (cwceq @ (cco @ (cco @ cc2 @ XP @ cclgs) @ XP @ ccmo) @ (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ XP @ ccmo)) @ (cwceq @ (cco @ cc2 @ XP @ cclgs) @ (cco @ (ccneg @ cc1) @ XN @ ccexp)))))))))))))).
thf(cgausslemma2d_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cwceq @ XH @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : (cwceq @ (XR @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((cwceq @ XM @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : (cwceq @ (XN @ Xx3) @ (cco @ XH @ XM @ ccmin))) => (! [Xx3:$i] : (cwi @ Xph @ (cwceq @ (cco @ cc2 @ XP @ cclgs) @ (cco @ (ccneg @ cc1) @ (XN @ Xx3) @ ccexp)))))))))))))))).
