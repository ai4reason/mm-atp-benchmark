...
thf(codsubdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((cwceq @ XO @ (ccfv @ XG @ ccod)) => (cwi @ (cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XS @ ccfn) @ (cwcel @ XA2 @ XS)) @ (cwbr @ (ccfv @ XA2 @ XO) @ (ccfv @ XS @ cchash) @ ccdvds)))))))).
