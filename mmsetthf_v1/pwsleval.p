...
thf(apwsle_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XY @ (cco @ XR @ XI @ ccpws)) => ((cwceq @ XB2 @ (ccfv @ XY @ ccbs)) => ((cwceq @ XO @ (ccfv @ XR @ ccple)) => ((cwceq @ Xc_le @ (ccfv @ XY @ ccple)) => (cwi @ (cwa @ (cwcel @ XR @ XV) @ (cwcel @ XI @ XW)) @ (cwceq @ Xc_le @ (ccin @ (ccofr @ XO) @ (ccxp @ XB2 @ XB2))))))))))))))))).
...
thf(cpwsleval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (cwceq @ (XY @ Xx3) @ (cco @ XR @ XI @ ccpws))) => ((! [Xx3:$i] : (cwceq @ XB2 @ (ccfv @ (XY @ Xx3) @ ccbs))) => ((cwceq @ XO @ (ccfv @ XR @ ccple)) => ((! [Xx3:$i] : (cwceq @ (Xc_le @ Xx3) @ (ccfv @ (XY @ Xx3) @ ccple))) => ((cwi @ Xph @ (cwcel @ XR @ XV)) => ((cwi @ Xph @ (cwcel @ XI @ XW)) => ((cwi @ Xph @ (cwcel @ XF @ XB2)) => ((cwi @ Xph @ (cwcel @ XG @ XB2)) => (! [Xx3:$i] : (cwi @ Xph @ (cwb @ (cwbr @ XF @ XG @ (Xc_le @ Xx3)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ XO)) @ (^ [Xx3:$i] : XI))))))))))))))))))))))))).
