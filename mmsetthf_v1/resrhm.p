...
thf(aresghm_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XS @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XX @ (ccfv @ XS @ ccsubg))) @ (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccghm)))))))))).
...
thf(aresmhm_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XS @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) @ (cwcel @ XX @ (ccfv @ XS @ ccsubmnd))) @ (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccmhm)))))))))).
...
thf(cresrhm_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XU @ (cco @ XS @ XX @ ccress)) => (cwi @ (cwa @ (cwcel @ XF @ (cco @ XS @ XT @ ccrh)) @ (cwcel @ XX @ (ccfv @ XS @ ccsubrg))) @ (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccrh)))))))))).
