...
thf(asgmppw_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccn0)) @ (cwceq @ (cco @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccsgm) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XP @ XA2 @ cccxp) @ (ccv @ Xk) @ ccexp))))))))).
...
thf(c_1sgm2ppw_conj,conjecture,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn) @ (cwceq @ (cco @ cc1 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccsgm) @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin))))).
