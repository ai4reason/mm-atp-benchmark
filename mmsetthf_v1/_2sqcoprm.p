...
thf(ann0sqeq1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ cc2 @ ccexp) @ cc1)) @ (cwceq @ XN @ cc1)))).
thf(c_2sqcoprm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwi @ Xph @ (cwcel @ XA2 @ ccz)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccz)) => ((cwi @ Xph @ (cwceq @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ XP)) => (cwi @ Xph @ (cwceq @ (cco @ XA2 @ XB2 @ ccgcd) @ cc1))))))))))).
