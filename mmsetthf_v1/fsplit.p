...
thf(adfid2_thm,axiom,(cwceq @ ccid @ (ccopab @ (^ [Xx3:$i] : (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ (ccv @ Xx3))))))).
...
thf(aelopab_b_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccopab @ (^ [Xx3:$i] : (^ [Xx3:$i] : (Xph @ Xx3))))) @ (cwex @ (^ [Xx3:$i] : (cwex @ (^ [Xx3:$i] : (cwa @ (cwceq @ XA2 @ (ccop @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (Xph @ Xx3)))))))))).
...
thf(cfsplit_conj,conjecture,(cwceq @ (cccnv @ (ccres @ cc1st @ ccid)) @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccop @ (ccv @ Xx3) @ (ccv @ Xx3)))))).
