...
thf(apm5_21_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (cwi @ (cwa @ (cwn @ Xph) @ (cwn @ Xps)) @ (cwb @ Xph @ Xps))))).
...
thf(aonsuctopon_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccsuc @ XA2) @ (ccfv @ XA2 @ cctopon))))).
...
thf(consuct0_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccsuc @ XA2) @ cct0)))).
