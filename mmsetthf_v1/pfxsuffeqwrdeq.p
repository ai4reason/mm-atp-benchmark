...
thf(cpfxsuffeqwrdeq_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XS @ (ccword @ XV)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwb @ (cwceq @ XW @ XS) @ (cwa @ (cwceq @ (ccfv @ XW @ cchash) @ (ccfv @ XS @ cchash)) @ (cwa @ (cwceq @ (cco @ XW @ XI @ ccpfx) @ (cco @ XS @ XI @ ccpfx)) @ (cwceq @ (cco @ XW @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (cco @ XS @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr))))))))))).
