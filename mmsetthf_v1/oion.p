...
thf(aoiexg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XF @ (ccoi @ XA2 @ XR)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ XF @ ccvv)))))))).
...
thf(coion_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XF @ (ccoi @ XA2 @ XR)) => (cwi @ (cwcel @ XA2 @ XV) @ (cwcel @ (ccdm @ XF) @ ccon0)))))))).
