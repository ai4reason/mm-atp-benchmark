...
thf(clsateln0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ Xc_0 @ (ccfv @ XW @ cc0g)) => ((! [Xv:$i] : (cwceq @ (XA2 @ Xv) @ (ccfv @ XW @ cclsa))) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => ((! [Xv:$i] : (cwi @ Xph @ (cwcel @ XU @ (XA2 @ Xv)))) => (cwi @ Xph @ (cwrex @ (^ [Xv:$i] : (cwne @ (ccv @ Xv) @ Xc_0)) @ (^ [Xv:$i] : XU))))))))))))).
