...
thf(ametelcls_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((! [Xf1:$i] : (cwi @ Xph @ (cwcel @ XD @ (ccfv @ (XX @ Xf1) @ ccxmt)))) => ((! [Xf1:$i] : (cwi @ Xph @ (cwss @ XS @ (XX @ Xf1)))) => (cwi @ Xph @ (cwb @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf @ ccn @ XS @ (ccv @ Xf1)) @ (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XJ @ cclm))))))))))))))))).
...
thf(cmetcld_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX)) @ (cwb @ (cwcel @ XS @ (ccfv @ XJ @ cccld)) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xf1:$i] : (cwi @ (cwa @ (cwf @ ccn @ XS @ (ccv @ Xf1)) @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ (ccfv @ XJ @ cclm))) @ (cwcel @ (ccv @ Xx3) @ XS)))))))))))))).
