...
thf(ctgcmp_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XB2 @ cctb) @ (cwceq @ XX @ (ccuni @ XB2))) @ (cwb @ (cwcel @ (ccfv @ XB2 @ cctg) @ cccmp) @ (cwral @ (^ [Xy1:$i] : (cwi @ (cwceq @ XX @ (ccuni @ (ccv @ Xy1))) @ (cwrex @ (^ [Xz:$i] : (cwceq @ XX @ (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (ccv @ Xy1)) @ ccfn))))) @ (^ [Xy1:$i] : (ccpw @ XB2)))))))).
