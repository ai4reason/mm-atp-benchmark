...
thf(cinf0_conj,conjecture,((cwcel @ ccom @ ccvv) => (! [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwal @ (^ [Xz:$i] : (cwi @ (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwex @ (^ [Xw:$i] : (cwa @ (cwcel @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))))))))))))).
