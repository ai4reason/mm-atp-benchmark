...
thf(cclsneibex_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XD @ (ccfv @ XB2 @ XP)) => ((cwceq @ XH @ (cccom @ XF @ XD)) => ((cwi @ Xph @ (cwbr @ XK @ XN @ XH)) => (cwi @ Xph @ (cwcel @ XB2 @ ccvv)))))))))))))).
