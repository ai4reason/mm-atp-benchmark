...
thf(aiccpartigtl_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (cwi @ Xph @ (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccv @ Xi) @ XP) @ cclt)) @ (^ [Xi:$i] : (cco @ cc1 @ XM @ ccfzo)))))))))).
...
thf(ciccpartlt_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XM @ ccn)) => ((cwi @ Xph @ (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (cwi @ Xph @ (cwbr @ (ccfv @ ccc0 @ XP) @ (ccfv @ XM @ XP) @ cclt)))))))).
