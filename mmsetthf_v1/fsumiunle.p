...
thf(aaciunf1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ XA2 @ (XV @ Xf1 @ Xj @ Xk)))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xj) @ XA2)) @ (cwcel @ (XB2 @ Xj) @ (XW @ Xf1 @ Xk)))))) => (cwi @ Xph @ (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1 @ (cciun @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xj))) @ (cciun @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccxp @ (ccsn @ (ccv @ Xj)) @ (XB2 @ Xj)))) @ (ccv @ Xf1)) @ (cwral @ (^ [Xk:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ cc2nd) @ (ccv @ Xk))) @ (^ [Xk:$i] : (cciun @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xj))))))))))))))))).
...
thf(cfsumiunle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) @ (cwcel @ (XC @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2)) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) @ (cwbr @ ccc0 @ (XC @ Xk) @ ccle)))) => (cwi @ Xph @ (cwbr @ (ccsu @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ XA2 @ (^ [Xx3:$i] : (ccsu @ (XB2 @ Xx3) @ (^ [Xk:$i] : (XC @ Xk))))) @ ccle))))))))))).
