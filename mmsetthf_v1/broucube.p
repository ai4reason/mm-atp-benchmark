...
thf(apoimir_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwceq @ XI @ (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((cwceq @ XR @ (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn))) => ((! [Xz:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xz) @ XI) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (ccv @ Xz)) @ ccc0))) @ (cwbr @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccc0 @ ccle)))) => ((! [Xz:$i] : (! [Xn:$i] : (cwi @ (cwa @ Xph @ (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xz) @ XI) @ (cwceq @ (ccfv @ (ccv @ Xn) @ (ccv @ Xz)) @ cc1))) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccle)))) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwceq @ (ccfv @ (ccv @ Xc) @ XF) @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ ccc0)))) @ (^ [Xc:$i] : XI))))))))))))))).
...
thf(aptcn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xk:$i] : (cwceq @ (XK @ Xk) @ (ccfv @ XF @ ccpt))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XJ @ Xx3) @ (ccfv @ XX @ cctopon)))) => ((cwi @ Xph @ (cwcel @ XI @ XV)) => ((cwi @ Xph @ (cwf @ XI @ cctop @ XF)) => ((! [Xx3:$i] : (! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XI)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ (cco @ (XJ @ Xx3) @ (ccfv @ (ccv @ Xk) @ XF) @ cccn))))) => (! [Xx3:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xk))))) @ (cco @ (XJ @ Xx3) @ (XK @ Xk) @ cccn))))))))))))))))))).
...
thf(aptpjcn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XY @ (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : (cwceq @ (XJ @ Xx3) @ (ccfv @ XF @ ccpt))) => (! [Xx3:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF) @ (cwcel @ XI @ XA2)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (ccfv @ XI @ (ccv @ Xx3)))) @ (cco @ (XJ @ Xx3) @ (ccfv @ XI @ XF) @ cccn))))))))))))).
...
thf(cbroucube_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwceq @ XI @ (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((cwceq @ XR @ (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ (cco @ XR @ XI @ ccrest) @ cccn))) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwceq @ (ccv @ Xc) @ (ccfv @ (ccv @ Xc) @ XF))) @ (^ [Xc:$i] : XI))))))))))))).
