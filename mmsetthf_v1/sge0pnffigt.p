...
thf(csge0pnffigt_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XX @ (XV @ Xx3)))) => ((cwi @ Xph @ (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((cwi @ Xph @ (cwceq @ (ccfv @ XF @ ccsumge0) @ ccpnf)) => ((cwi @ Xph @ (cwcel @ XY @ ccr)) => (cwi @ Xph @ (cwrex @ (^ [Xx3:$i] : (cwbr @ XY @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ cclt)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
