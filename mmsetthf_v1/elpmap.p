...
thf(celpmap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XK @ ccbs)) => ((cwceq @ Xc_le @ (ccfv @ XK @ ccple)) => ((cwceq @ XA2 @ (ccfv @ XK @ ccatm)) => ((cwceq @ XM @ (ccfv @ XK @ ccpmap)) => (cwi @ (cwa @ (cwcel @ XK @ XC) @ (cwcel @ XX @ XB2)) @ (cwb @ (cwcel @ XP @ (ccfv @ XX @ XM)) @ (cwa @ (cwcel @ XP @ XA2) @ (cwbr @ XP @ XX @ Xc_le))))))))))))))))).
