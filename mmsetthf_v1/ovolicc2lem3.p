...
thf(annnlt1_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ ccn) @ (cwn @ (cwbr @ XA2 @ cc1 @ cclt))))).
...
thf(aovolicc2lem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ ccr))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XB2 @ ccr))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ XA2 @ XB2 @ ccle))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xu @ Xt @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XF @ Xu)) @ cc1))))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ (XF @ Xu)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XU @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ (XF @ Xu)))) @ ccfn)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ XU)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwf @ XU @ ccn @ (XG @ Xu)))) => ((! [Xu:$i] : (! [Xt:$i] : (cwi @ (cwa @ (Xph @ Xu) @ (cwcel @ (ccv @ Xt) @ XU)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (cccom @ ccioo @ (XF @ Xu))) @ (ccv @ Xt))))) => ((! [Xu:$i] : (cwceq @ (XT @ Xu) @ (ccrab @ (^ [Xu:$i] : (cwne @ (ccin @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccicc)) @ cc0)) @ (^ [Xu:$i] : XU)))) => ((! [Xu:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwf @ (XT @ Xu) @ (XT @ Xu) @ (XH @ Xu @ Xn))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xu) @ (cwcel @ (ccv @ Xt) @ (XT @ Xu))) @ (cwcel @ (ccif @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2 @ ccle) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2) @ (ccfv @ (ccv @ Xt) @ (XH @ Xu @ Xn))))))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ (XC @ Xu)))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XC @ Xu) @ (XT @ Xu)))) => ((! [Xu:$i] : (! [Xn:$i] : (cwceq @ XK @ (ccseq @ (cccom @ (XH @ Xu @ Xn) @ cc1st) @ (ccxp @ ccn @ (ccsn @ (XC @ Xu))) @ cc1)))) => ((! [Xu:$i] : (! [Xt:$i] : (cwceq @ (XW @ Xu @ Xt) @ (ccrab @ (^ [Xn:$i] : (cwcel @ XB2 @ (ccfv @ (ccv @ Xn) @ XK))) @ (^ [Xn:$i] : ccn))))) => (! [Xu:$i] : (! [Xt:$i] : (cwi @ (cwa @ (Xph @ Xu) @ (cwa @ (cwcel @ XN @ ccn) @ (cwn @ (cwcel @ XN @ (XW @ Xu @ Xt))))) @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ XN @ XK) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2 @ ccle)))))))))))))))))))))))))))))))))).
...
thf(aovolicc2lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xt:$i] : (cwceq @ (XS @ Xt) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((cwi @ Xph @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwi @ Xph @ (cwcel @ XU @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ XF))) @ ccfn))) => ((cwi @ Xph @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ XU))) => ((cwi @ Xph @ (cwf @ XU @ ccn @ XG)) => ((! [Xt:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xt) @ XU)) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xt) @ XG) @ (cccom @ ccioo @ XF)) @ (ccv @ Xt)))) => (! [Xt:$i] : (cwi @ (cwa @ Xph @ (cwcel @ XX @ XU)) @ (cwb @ (cwcel @ (XP @ Xt) @ XX) @ (cw3a @ (cwcel @ (XP @ Xt) @ ccr) @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ XX @ XG) @ XF) @ cc1st) @ (XP @ Xt) @ cclt) @ (cwbr @ (XP @ Xt) @ (ccfv @ (ccfv @ (ccfv @ XX @ XG) @ XF) @ cc2nd) @ cclt)))))))))))))))))))))))).
...
thf(covolicc2lem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ ccr))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XB2 @ ccr))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwbr @ XA2 @ XB2 @ ccle))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xu @ Xt @ Xm @ Xn) @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XF @ Xu @ Xm)) @ cc1)))))) => ((! [Xu:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xu) @ (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ (XF @ Xu @ Xm))))) => ((! [Xu:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XU @ Xm) @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ (XF @ Xu @ Xm)))) @ ccfn))))) => ((! [Xu:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xu) @ (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ (XU @ Xm)))))) => ((! [Xu:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xu) @ (cwf @ (XU @ Xm) @ ccn @ (XG @ Xu @ Xm))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (cwi @ (cwa @ (Xph @ Xu) @ (cwcel @ (ccv @ Xt) @ (XU @ Xm))) @ (cwceq @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu @ Xm)) @ (cccom @ ccioo @ (XF @ Xu @ Xm))) @ (ccv @ Xt)))))) => ((! [Xu:$i] : (! [Xm:$i] : (cwceq @ (XT @ Xu @ Xm) @ (ccrab @ (^ [Xu:$i] : (cwne @ (ccin @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccicc)) @ cc0)) @ (^ [Xu:$i] : (XU @ Xm)))))) => ((! [Xu:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xu) @ (cwf @ (XT @ Xu @ Xm) @ (XT @ Xu @ Xm) @ (XH @ Xu @ Xm @ Xn)))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xu) @ (cwcel @ (ccv @ Xt) @ (XT @ Xu @ Xm))) @ (cwcel @ (ccif @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd) @ XB2 @ ccle) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd) @ XB2) @ (ccfv @ (ccv @ Xt) @ (XH @ Xu @ Xm @ Xn)))))))) => ((! [Xu:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ XA2 @ (XC @ Xu)))) => ((! [Xu:$i] : (! [Xm:$i] : (cwi @ (Xph @ Xu) @ (cwcel @ (XC @ Xu) @ (XT @ Xu @ Xm))))) => ((! [Xu:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XK @ Xm) @ (ccseq @ (cccom @ (XH @ Xu @ Xm @ Xn) @ cc1st) @ (ccxp @ ccn @ (ccsn @ (XC @ Xu))) @ cc1))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (cwceq @ (XW @ Xu @ Xt) @ (ccrab @ (^ [Xn:$i] : (cwcel @ XB2 @ (ccfv @ (ccv @ Xn) @ (XK @ Xm)))) @ (^ [Xn:$i] : ccn)))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xu) @ (cwa @ (cwcel @ (XN @ Xm) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ ccle)) @ (^ [Xm:$i] : (XW @ Xu @ Xt)))) @ (^ [Xn:$i] : ccn))) @ (cwcel @ (XP @ Xu @ Xt @ Xm @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ ccle)) @ (^ [Xm:$i] : (XW @ Xu @ Xt)))) @ (^ [Xn:$i] : ccn))))) @ (cwb @ (cwceq @ (XN @ Xm) @ (XP @ Xu @ Xt @ Xm @ Xn)) @ (cwceq @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ (XN @ Xm) @ (XK @ Xm)) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd) @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ (XP @ Xu @ Xt @ Xm @ Xn) @ (XK @ Xm)) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd))))))))))))))))))))))))))))))))))))))).
