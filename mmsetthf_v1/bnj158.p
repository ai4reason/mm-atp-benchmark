...
thf(cbnj158_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [Xm:$i] : ((! [Xp:$i] : (cwceq @ (XD @ Xp) @ (ccdif @ ccom @ (ccsn @ cc0)))) => (! [Xp:$i] : (cwi @ (cwcel @ (ccv @ Xm) @ (XD @ Xp)) @ (cwrex @ (^ [Xp:$i] : (cwceq @ (ccv @ Xm) @ (ccsuc @ (ccv @ Xp)))) @ (^ [Xp:$i] : ccom)))))))).
