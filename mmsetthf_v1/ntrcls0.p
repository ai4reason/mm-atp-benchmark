...
thf(cntrcls0_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwi @ (cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwceq @ (ccfv @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XJ @ ccnt)) @ cc0)) @ (cwceq @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ cc0))))))).
