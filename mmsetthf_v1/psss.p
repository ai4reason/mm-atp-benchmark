...
thf(atrinxp_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwss @ (cccom @ XR @ XR) @ XR) @ (cwss @ (cccom @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ (ccin @ XR @ (ccxp @ XA2 @ XA2))) @ (ccin @ XR @ (ccxp @ XA2 @ XA2))))))).
...
thf(aunixpid_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccuni @ (ccuni @ (ccxp @ XA2 @ XA2))) @ XA2))).
...
thf(apsref_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccdm @ XR)) => (cwi @ (cwa @ (cwcel @ XR @ ccps) @ (cwcel @ XA2 @ XX)) @ (cwbr @ XA2 @ XA2 @ XR))))))).
...
thf(apsasym_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XR @ ccps) @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XB2 @ XA2 @ XR)) @ (cwceq @ XA2 @ XB2)))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aasymref2_thm,axiom,(! [XR:($i > $o)] : (cwb @ (cwceq @ (ccin @ XR @ (cccnv @ XR)) @ (ccres @ ccid @ (ccuni @ (ccuni @ XR)))) @ (cwa @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XR)) @ (^ [Xx3:$i] : (ccuni @ (ccuni @ XR)))) @ (cwal @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) @ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)) @ (cwceq @ (ccv @ Xx3) @ (ccv @ Xy1))))))))))).
...
thf(cpsss_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (cwi @ (cwcel @ XR @ ccps) @ (cwcel @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccps))))).
