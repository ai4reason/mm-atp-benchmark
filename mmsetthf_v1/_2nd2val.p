...
thf(arnsnn0_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) @ (cwne @ (ccrn @ (ccsn @ XA2)) @ cc0)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(auni0_thm,axiom,(cwceq @ (ccuni @ cc0) @ cc0)).
thf(a_2ndval_thm,axiom,(! [XA2:($i > $o)] : (cwceq @ (ccfv @ XA2 @ cc2nd) @ (ccuni @ (ccrn @ (ccsn @ XA2)))))).
thf(c_2nd2val_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwceq @ (ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwceq @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ cc2nd))))))).
