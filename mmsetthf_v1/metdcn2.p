...
thf(axmetdcn_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XK @ (ccfv @ ccle @ ccordt)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XD @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn)))))))))).
...
thf(cmetdcn2_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => ((cwceq @ XK @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ XD @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn)))))))))).
