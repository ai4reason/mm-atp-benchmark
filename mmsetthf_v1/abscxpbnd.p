...
thf(acxple2ad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XC @ ccle)) => ((cwi @ Xph @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XB2 @ XC @ cccxp) @ ccle))))))))))))).
...
thf(aabsle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr)) @ (cwb @ (cwbr @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccle) @ (cwa @ (cwbr @ (ccneg @ XB2) @ XA2 @ ccle) @ (cwbr @ XA2 @ XB2 @ ccle))))))).
...
thf(cabscxpbnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle)) => ((cwi @ Xph @ (cwcel @ XM @ ccr)) => ((cwi @ Xph @ (cwbr @ (ccfv @ XA2 @ ccabs) @ XM @ ccle)) => (cwi @ Xph @ (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ ccabs) @ (cco @ (cco @ XM @ (ccfv @ XB2 @ ccre) @ cccxp) @ (ccfv @ (cco @ (ccfv @ XB2 @ ccabs) @ ccpi @ ccmul) @ cce) @ ccmul) @ ccle)))))))))))).
