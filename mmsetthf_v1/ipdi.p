...
thf(asrngadd_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_as @ (ccfv @ XR @ ccstv)) => ((cwceq @ XB2 @ (ccfv @ XR @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XR @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XR @ ccsr) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwceq @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ Xc_as) @ (cco @ (ccfv @ XX @ Xc_as) @ (ccfv @ XY @ Xc_as) @ Xc_pl))))))))))))).
