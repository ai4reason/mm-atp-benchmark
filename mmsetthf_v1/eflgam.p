...
thf(adf_gam_ax,axiom,(cwceq @ ccgam @ (cccom @ cce @ cclgam))).
...
thf(algamf_thm,axiom,(cwf @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)) @ ccc @ cclgam)).
...
thf(ceflgam_conj,conjecture,(! [XA2:($i > $o)] : (cwi @ (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) @ (cwceq @ (ccfv @ (ccfv @ XA2 @ cclgam) @ cce) @ (ccfv @ XA2 @ ccgam))))).
