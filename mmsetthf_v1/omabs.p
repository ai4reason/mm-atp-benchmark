...
thf(aomabslem_thm,axiom,(! [XA2:($i > $o)] : (cwi @ (cw3a @ (cwcel @ ccom @ ccon0) @ (cwcel @ XA2 @ ccom) @ (cwcel @ cc0 @ XA2)) @ (cwceq @ (cco @ XA2 @ ccom @ ccomu) @ ccom)))).
...
thf(aomword2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0)) @ (cwcel @ cc0 @ XB2)) @ (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccomu)))))).
...
thf(comabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XA2 @ ccom) @ (cwcel @ cc0 @ XA2)) @ (cwa @ (cwcel @ XB2 @ ccon0) @ (cwcel @ cc0 @ XB2))) @ (cwceq @ (cco @ XA2 @ (cco @ ccom @ XB2 @ ccoe) @ ccomu) @ (cco @ ccom @ XB2 @ ccoe)))))).
