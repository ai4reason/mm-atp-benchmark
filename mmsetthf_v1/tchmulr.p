...
thf(atngmulr_thm,axiom,(! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ Xc_x @ (ccfv @ XG @ ccmulr)) => (cwi @ (cwcel @ XN @ XV) @ (cwceq @ Xc_x @ (ccfv @ XT @ ccmulr))))))))))).
...
thf(ctchmulr_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XG @ (ccfv @ XW @ cctch)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccmulr)) => (cwceq @ Xc_x @ (ccfv @ XG @ ccmulr)))))))).
