...
thf(cfvvolioof_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwf @ XA2 @ (ccxp @ ccxr @ ccxr) @ XF)) => ((cwi @ Xph @ (cwcel @ XX @ XA2)) => (cwi @ Xph @ (cwceq @ (ccfv @ XX @ (cccom @ (cccom @ ccvol @ ccioo) @ XF)) @ (ccfv @ (cco @ (ccfv @ (ccfv @ XX @ XF) @ cc1st) @ (ccfv @ (ccfv @ XX @ XF) @ cc2nd) @ ccioo) @ ccvol)))))))))).
