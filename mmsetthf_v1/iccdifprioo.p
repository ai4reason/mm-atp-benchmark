...
thf(aiooinlbub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwceq @ (ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (ccpr @ XA2 @ XB2)) @ cc0)))).
...
thf(ciccdifprioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr)) @ (cwceq @ (ccdif @ (cco @ XA2 @ XB2 @ ccicc) @ (ccpr @ XA2 @ XB2)) @ (cco @ XA2 @ XB2 @ ccioo)))))).
