...
thf(ctng0_conj,conjecture,(! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XT @ (cco @ XG @ XN @ cctng)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwcel @ XN @ XV) @ (cwceq @ Xc_0 @ (ccfv @ XT @ cc0g))))))))))).
