...
thf(csbcthdv_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwi @ Xph @ (Xps @ Xx3))) => (! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3))) @ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XA2 @ Xx3)))))))))).
