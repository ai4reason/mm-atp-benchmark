...
thf(afnct_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwi @ (cwa @ (cwfn @ XF @ XA2) @ (cwbr @ XA2 @ ccom @ ccdom)) @ (cwbr @ XF @ ccom @ ccdom))))).
thf(cmptctf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : (cwi @ (cwbr @ (XA2 @ Xx3) @ ccom @ ccdom) @ (cwbr @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccom @ ccdom))))))).
