...
thf(cldual1_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XR @ (ccfv @ XW @ ccsca)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => ((cwceq @ XD @ (ccfv @ XW @ ccld)) => ((cwceq @ XS @ (ccfv @ XD @ ccsca)) => ((cwceq @ XI @ (ccfv @ XS @ ccur)) => ((cwi @ Xph @ (cwcel @ XW @ cclmod)) => (cwi @ Xph @ (cwceq @ XI @ Xc_1)))))))))))))))).
