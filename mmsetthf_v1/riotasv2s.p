...
thf(criotasv2s_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XD @ Xx3 @ Xy1) @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwi @ (Xph @ Xy1) @ (cwceq @ (ccv @ Xx3) @ (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwi @ (cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) @ (cwcel @ (XD @ Xx3 @ Xy1) @ XA2) @ (cwa @ (cwcel @ XE @ XB2) @ (cwsbc @ (^ [Xy1:$i] : (Xph @ Xy1)) @ XE))) @ (cwceq @ (XD @ Xx3 @ Xy1) @ (ccsb @ XE @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))))))).
