...
thf(aomeiunle_thm,axiom,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((cwnfc @ (^ [Xn:$i] : (XE @ Xn))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwcel @ XO @ ccome))) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((! [Xn:$i] : (cwceq @ XZ @ (ccfv @ (XN @ Xn) @ ccuz))) => ((! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwf @ XZ @ (ccpw @ XX) @ (XE @ Xn)))) => (! [Xn:$i] : (cwi @ (Xph @ Xn) @ (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xn)))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ XO))) @ ccsumge0) @ ccle)))))))))))))))).
...
thf(acaragensspw_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((cwceq @ XX @ (ccuni @ (ccdm @ XO))) => ((cwceq @ XS @ (ccfv @ XO @ cccaragen)) => (cwi @ Xph @ (cwss @ XS @ (ccpw @ XX))))))))))).
...
thf(auzfissfz_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XM @ ccz))) => ((cwceq @ XZ @ (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwss @ XA2 @ XZ))) => ((! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwcel @ XA2 @ ccfn))) => (! [Xk:$i] : (cwi @ (Xph @ Xk) @ (cwrex @ (^ [Xk:$i] : (cwss @ XA2 @ (cco @ XM @ (ccv @ Xk) @ ccfz))) @ (^ [Xk:$i] : XZ))))))))))))).
...
thf(acaratheodorylem1_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((! [Xi:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xi @ Xn) @ (ccfv @ XO @ cccaragen)))) => ((! [Xi:$i] : (cwceq @ (XZ @ Xi) @ (ccfv @ XM @ ccuz))) => ((! [Xi:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwf @ (XZ @ Xi) @ (XS @ Xi @ Xn) @ XE)))) => ((! [Xi:$i] : (cwi @ Xph @ (cwdisj @ (^ [Xn:$i] : (XZ @ Xi)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))))) => ((! [Xi:$i] : (cwceq @ XG @ (ccmpt @ (^ [Xn:$i] : (XZ @ Xi)) @ (^ [Xn:$i] : (cciun @ (^ [Xi:$i] : (cco @ XM @ (ccv @ Xn) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XE))))))) => ((cwi @ Xph @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwi @ Xph @ (cwceq @ (ccfv @ (ccfv @ XN @ XG) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XO))) @ ccsumge0))))))))))))))))))).
...
thf(ccaratheodorylem2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwi @ Xph @ (cwcel @ XO @ ccome)) => ((! [Xk:$i] : (cwceq @ (XX @ Xk) @ (ccuni @ (ccdm @ XO)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwceq @ (XS @ Xk @ Xn) @ (ccfv @ XO @ cccaragen)))) => ((! [Xk:$i] : (! [Xn:$i] : (cwi @ Xph @ (cwf @ ccn @ (XS @ Xk @ Xn) @ XE)))) => ((cwi @ Xph @ (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE)))) => ((! [Xk:$i] : (cwceq @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cciun @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xk) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))))))) => (cwi @ Xph @ (cwceq @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XO))) @ ccsumge0)))))))))))))))).
