...
thf(cprodmo_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (cwceq @ (XF @ Xy1) @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xy1)) @ (XB2 @ Xx3 @ Xy1 @ Xk @ Xn) @ cc1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (cwa @ (Xph @ Xy1) @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xy1))) @ (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xk @ Xn) @ ccc)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (cwceq @ (XG @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xy1 @ Xk @ Xn)))))))))))) => (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwi @ (Xph @ Xy1) @ (cwmo @ (^ [Xx3:$i] : (cwo @ (cwrex @ (^ [Xm:$i] : (cw3a @ (cwss @ (XA2 @ Xy1) @ (ccfv @ (ccv @ Xm) @ ccuz)) @ (cwrex @ (^ [Xn:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwne @ (ccv @ Xy1) @ ccc0) @ (cwbr @ (ccseq @ ccmul @ (XF @ Xy1) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli))))) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xm) @ ccuz))) @ (cwbr @ (ccseq @ ccmul @ (XF @ Xy1) @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz)) @ (cwrex @ (^ [Xm:$i] : (cwex @ (^ [Xf1:$i] : (cwa @ (cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (XA2 @ Xy1) @ (ccv @ Xf1)) @ (cwceq @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (ccseq @ ccmul @ (XG @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) @ cc1))))))) @ (^ [Xm:$i] : ccn)))))))))))))))))).
