...
thf(cfsnunf_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cw3a @ (cwf @ XS @ XT @ XF) @ (cwa @ (cwcel @ XX @ XV) @ (cwn @ (cwcel @ XX @ XS))) @ (cwcel @ XY @ XT)) @ (cwf @ (ccun @ XS @ (ccsn @ XX)) @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY)))))))))))).
