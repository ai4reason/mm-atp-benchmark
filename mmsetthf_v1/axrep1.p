...
thf(a_19_35ri_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((cwi @ (cwal @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (cwex @ (^ [Xx3:$i] : (Xps @ Xx3)))) => (cwex @ (^ [Xx3:$i] : (cwi @ (Xph @ Xx3) @ (Xps @ Xx3)))))))).
...
thf(caxrep1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xy1:$i] : (cwex @ (^ [Xx3:$i] : (cwi @ (cwex @ (^ [Xy1:$i] : (cwal @ (^ [Xz:$i] : (cwi @ (Xph @ Xx3 @ Xz) @ (cwceq @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (cwal @ (^ [Xz:$i] : (cwb @ (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwex @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (Xph @ Xx3 @ Xz))))))))))))).
