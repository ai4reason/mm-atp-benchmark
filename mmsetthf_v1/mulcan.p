...
thf(cmulcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwa @ (cwcel @ XC @ ccc) @ (cwne @ XC @ ccc0))) @ (cwb @ (cwceq @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul)) @ (cwceq @ XA2 @ XB2))))))).
