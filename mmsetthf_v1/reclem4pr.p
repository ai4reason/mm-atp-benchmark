...
thf(areclem2pr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq) @ (cwn @ (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrq) @ XA2))))))))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ ccnp) @ (cwcel @ (XB2 @ Xy1) @ ccnp))))))).
...
thf(areclem3pr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq) @ (cwn @ (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrq) @ XA2))))))))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ ccnp) @ (cwss @ cc1p @ (cco @ XA2 @ (XB2 @ Xy1) @ ccmp)))))))).
thf(creclem4pr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwceq @ (XB2 @ Xy1) @ (ccab @ (^ [Xx3:$i] : (cwex @ (^ [Xy1:$i] : (cwa @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq) @ (cwn @ (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrq) @ XA2))))))))) => (! [Xy1:$i] : (cwi @ (cwcel @ XA2 @ ccnp) @ (cwceq @ (cco @ XA2 @ (XB2 @ Xy1) @ ccmp) @ cc1p))))))).
