...
thf(atotbndbnd_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XM @ (ccfv @ XX @ cctotbnd)) @ (cwcel @ XM @ (ccfv @ XX @ ccbnd)))))).
...
thf(abnd2lem_thm,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XD @ (ccres @ XM @ (ccxp @ XY @ XY))) => (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwcel @ XD @ (ccfv @ XY @ ccbnd))) @ (cwss @ XY @ XX)))))))).
...
thf(aredivd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XB2 @ XA2 @ ccdiv) @ ccre) @ (cco @ (ccfv @ XB2 @ ccre) @ XA2 @ ccdiv)))))))))).
thf(arpred_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => (cwi @ Xph @ (cwcel @ XA2 @ ccr)))))).
thf(aimdivd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => (cwi @ Xph @ (cwceq @ (ccfv @ (cco @ XB2 @ XA2 @ ccdiv) @ ccim) @ (cco @ (ccfv @ XB2 @ ccim) @ XA2 @ ccdiv)))))))))).
...
thf(alt2halvesd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XC @ ccr)) => ((cwi @ Xph @ (cwbr @ XA2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt)) => ((cwi @ Xph @ (cwbr @ XB2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt)) => (cwi @ Xph @ (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt)))))))))))).
...
thf(assbnd_thm,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccres @ XM @ (ccxp @ XY @ XY))) => (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwcel @ XP @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ XY @ ccbnd)) @ (cwrex @ (^ [Xd:$i] : (cwss @ XY @ (cco @ XP @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xd:$i] : ccr))))))))))).
...
thf(asstotbnd3_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XN @ (ccres @ XM @ (ccxp @ XY @ XY))) => (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XX @ ccme)) @ (cwss @ XY @ XX)) @ (cwb @ (cwcel @ XN @ (ccfv @ XY @ cctotbnd)) @ (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (cwa @ (cwss @ XY @ (cciun @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl))))) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)) @ XY) @ cc0)) @ (^ [Xx3:$i] : (ccv @ Xv))) @ ccfn))) @ (^ [Xv:$i] : (ccpw @ XX)))) @ (^ [Xd:$i] : ccrp)))))))))).
thf(ccntotbnd_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XD @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XX @ XX))) => (cwb @ (cwcel @ XD @ (ccfv @ XX @ cctotbnd)) @ (cwcel @ XD @ (ccfv @ XX @ ccbnd))))))).
