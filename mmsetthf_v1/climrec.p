...
thf(cclimrec_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwceq @ XZ @ (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XM @ Xk) @ ccz))) => ((cwi @ Xph @ (cwbr @ XG @ XA2 @ ccli)) => ((cwi @ Xph @ (cwne @ XA2 @ ccc0)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ XZ)) @ (cwceq @ (ccfv @ (ccv @ Xk) @ XH) @ (cco @ cc1 @ (ccfv @ (ccv @ Xk) @ XG) @ ccdiv)))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ XH @ (XW @ Xk)))) => (cwi @ Xph @ (cwbr @ XH @ (cco @ cc1 @ XA2 @ ccdiv) @ ccli))))))))))))))))).
