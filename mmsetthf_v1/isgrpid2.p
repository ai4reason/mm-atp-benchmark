...
thf(cisgrpid2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_0 @ (ccfv @ XG @ cc0g)) => (cwi @ (cwcel @ XG @ ccgrp) @ (cwb @ (cwa @ (cwcel @ XZ @ XB2) @ (cwceq @ (cco @ XZ @ XZ @ Xc_pl) @ XZ)) @ (cwceq @ Xc_0 @ XZ)))))))))))).
