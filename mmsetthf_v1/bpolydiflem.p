...
thf(abpolycl_thm,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ ccc)) @ (cwcel @ (cco @ XN @ XX @ ccbp) @ ccc))))).
...
thf(abcnm1_thm,axiom,(! [XN:($i > $o)] : (cwi @ (cwcel @ XN @ ccn0) @ (cwceq @ (cco @ XN @ (cco @ XN @ cc1 @ ccmin) @ ccbc) @ XN)))).
...
thf(cbpolydiflem_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((! [Xk:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xk) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ (cwceq @ (cco @ (cco @ (ccv @ Xk) @ (cco @ XX @ cc1 @ ccaddc) @ ccbp) @ (cco @ (ccv @ Xk) @ XX @ ccbp) @ ccmin) @ (cco @ (ccv @ Xk) @ (cco @ XX @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ ccmul)))) => (cwi @ Xph @ (cwceq @ (cco @ (cco @ XN @ (cco @ XX @ cc1 @ ccaddc) @ ccbp) @ (cco @ XN @ XX @ ccbp) @ ccmin) @ (cco @ XN @ (cco @ XX @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul)))))))))).
