...
thf(celmapsnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwfn @ XF @ (ccsn @ XA2))) => ((cwi @ Xph @ (cwcel @ XB2 @ XV)) => ((cwi @ Xph @ (cwcel @ (ccfv @ XA2 @ XF) @ XB2)) => (cwi @ Xph @ (cwcel @ XF @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap)))))))))))).
