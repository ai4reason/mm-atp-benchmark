...
thf(adf_om_ax,axiom,(cwceq @ ccom @ (ccrab @ (^ [Xx3:$i] : (cwal @ (^ [Xy1:$i] : (cwi @ (cwlim @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xx3:$i] : ccon0)))).
...
thf(cdfom2_conj,conjecture,(cwceq @ ccom @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccsuc @ (ccv @ Xx3)) @ (ccrab @ (^ [Xy1:$i] : (cwn @ (cwlim @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : ccon0)))) @ (^ [Xx3:$i] : ccon0)))).
