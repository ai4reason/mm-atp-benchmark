...
thf(apredpredss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwss @ XA2 @ XB2) @ (cwss @ (ccpred @ XA2 @ XR @ XX) @ (ccpred @ XB2 @ XR @ XX)))))))).
...
thf(cpreddowncl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwa @ (cwss @ XB2 @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xx3)) @ XB2)) @ (^ [Xx3:$i] : XB2))) @ (cwi @ (cwcel @ (XX @ Xx3) @ XB2) @ (cwceq @ (ccpred @ XB2 @ XR @ (XX @ Xx3)) @ (ccpred @ XA2 @ XR @ (XX @ Xx3))))))))))).
