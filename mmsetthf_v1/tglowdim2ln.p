...
thf(atglowdim2l_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (cwceq @ (XL @ Xa @ Xb @ Xc) @ (ccfv @ XG @ cclng))))) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => (cwi @ Xph @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwn @ (cwo @ (cwcel @ (ccv @ Xc) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (XL @ Xa @ Xb @ Xc))) @ (cwceq @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xc:$i] : XP))) @ (^ [Xb:$i] : XP))) @ (^ [Xa:$i] : XP)))))))))))))).
...
thf(ctglowdim2ln_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((cwceq @ XP @ (ccfv @ XG @ ccbs)) => ((cwceq @ XI @ (ccfv @ XG @ ccitv)) => ((cwceq @ XL @ (ccfv @ XG @ cclng)) => ((cwi @ Xph @ (cwcel @ XG @ ccstrkg)) => ((cwi @ Xph @ (cwbr @ XG @ cc2 @ ccstrkgld)) => ((cwi @ Xph @ (cwcel @ XA2 @ XP)) => ((cwi @ Xph @ (cwcel @ XB2 @ XP)) => ((cwi @ Xph @ (cwne @ XA2 @ XB2)) => (cwi @ Xph @ (cwrex @ (^ [Xc:$i] : (cwn @ (cwcel @ (ccv @ Xc) @ (cco @ XA2 @ XB2 @ XL)))) @ (^ [Xc:$i] : XP))))))))))))))))))).
