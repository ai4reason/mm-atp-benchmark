...
thf(aslwn0_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => (cwi @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XP @ ccprime)) @ (cwne @ (cco @ XP @ XG @ ccslw) @ cc0))))))).
...
thf(asylow3lem6_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xs1:$i] : (cwceq @ (XX @ Xs1) @ (ccfv @ XG @ ccbs))) => ((cwi @ Xph @ (cwcel @ XG @ ccgrp)) => ((! [Xs1:$i] : (cwi @ Xph @ (cwcel @ (XX @ Xs1) @ ccfn))) => ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((! [Xs1:$i] : (cwceq @ (Xc_pl @ Xs1) @ (ccfv @ XG @ ccplusg))) => ((! [Xs1:$i] : (cwceq @ (Xc_mi @ Xs1) @ (ccfv @ XG @ ccsg))) => ((cwi @ Xph @ (cwcel @ XK @ (cco @ XP @ XG @ ccslw))) => ((! [Xs1:$i] : (cwceq @ Xc_po @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XK)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ XP @ XG @ ccslw))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_pl @ Xs1)) @ (ccv @ Xx3) @ (Xc_mi @ Xs1)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : (cwceq @ (XN @ Xx3 @ Xy1 @ Xs1) @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwb @ (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xs1)) @ (ccv @ Xs1)) @ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_pl @ Xs1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (XX @ Xs1)))) @ (^ [Xx3:$i] : (XX @ Xs1))))))) => (cwi @ Xph @ (cwceq @ (cco @ (ccfv @ (cco @ XP @ XG @ ccslw) @ cchash) @ XP @ ccmo) @ cc1))))))))))))))))))))).
thf(csylow3_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccfv @ XG @ ccbs)) => ((cwi @ Xph @ (cwcel @ XG @ ccgrp)) => ((cwi @ Xph @ (cwcel @ XX @ ccfn)) => ((cwi @ Xph @ (cwcel @ XP @ ccprime)) => ((cwceq @ XN @ (ccfv @ (cco @ XP @ XG @ ccslw) @ cchash)) => (cwi @ Xph @ (cwa @ (cwbr @ XN @ (cco @ (ccfv @ XX @ cchash) @ (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp) @ ccdiv) @ ccdvds) @ (cwceq @ (cco @ XN @ XP @ ccmo) @ cc1)))))))))))))).
