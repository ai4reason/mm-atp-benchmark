...
thf(celmsubrn_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((! [Xf1:$i] : (cwceq @ XE @ (ccfv @ (XT @ Xf1) @ ccmex))) => ((! [Xf1:$i] : (cwceq @ XO @ (ccfv @ (XT @ Xf1) @ ccmrsub))) => ((! [Xe:$i] : (! [Xf1:$i] : (cwceq @ (XS @ Xe @ Xf1) @ (ccfv @ (XT @ Xf1) @ ccmsub)))) => (! [Xe:$i] : (! [Xf1:$i] : (cwceq @ (ccrn @ (XS @ Xe @ Xf1)) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : (ccrn @ XO)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xe:$i] : XE) @ (^ [Xe:$i] : (ccop @ (ccfv @ (ccv @ Xe) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xe) @ cc2nd) @ (ccv @ Xf1))))))))))))))))))).
