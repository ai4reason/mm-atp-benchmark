...
thf(anmocl_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => (cwi @ (cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) @ (cwcel @ (ccfv @ XF @ XN) @ ccxr)))))))).
...
thf(axmulcld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccxr)) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XB2 @ ccxmu) @ ccxr)))))))).
...
thf(anmoix_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => (cwi @ (cwa @ (cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) @ (cwcel @ XX @ XV)) @ (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XM) @ (cco @ (ccfv @ XF @ XN) @ (ccfv @ XX @ XL) @ ccxmu) @ ccle))))))))))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cwi @ Xph @ Xps) => ((cwi @ Xph @ Xch) => (cwi @ Xph @ (cwa @ Xps @ Xch)))))))).
thf(ccico_tp,type,(ccico : ($i > $o))).
thf(anmoge0_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => (cwi @ (cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) @ (cwbr @ ccc0 @ (ccfv @ XF @ XN) @ ccle)))))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwi @ (cwa @ Xph @ (cwa @ Xps @ Xch)) @ Xch))))).
thf(axlemul2a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cwa @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwa @ (cwcel @ XC @ ccxr) @ (cwbr @ ccc0 @ XC @ ccle))) @ (cwbr @ XA2 @ XB2 @ ccle)) @ (cwbr @ (cco @ XC @ XA2 @ ccxmu) @ (cco @ XC @ XB2 @ ccxmu) @ ccle)))))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(axlemul1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccrp)) @ (cwb @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccle))))))).
...
thf(anmolb2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((cwceq @ XN @ (cco @ XS @ XT @ ccnmo)) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((cwceq @ XM @ (ccfv @ XT @ ccnm)) => ((! [Xx3:$i] : (cwceq @ (Xc_0 @ Xx3) @ (ccfv @ XS @ cc0g))) => ((cwi @ Xph @ (cwcel @ XS @ ccngp)) => ((cwi @ Xph @ (cwcel @ XT @ ccngp)) => ((cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwa @ (cwcel @ (ccv @ Xx3) @ XV) @ (cwne @ (ccv @ Xx3) @ (Xc_0 @ Xx3)))) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XL) @ ccmul) @ ccle))) => (cwi @ Xph @ (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle)))))))))))))))))))))))).
...
thf(cnmoleub2lem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (cwceq @ XN @ (cco @ XS @ (XT @ Xx3) @ ccnmo))) => ((cwceq @ XV @ (ccfv @ XS @ ccbs)) => ((cwceq @ XL @ (ccfv @ XS @ ccnm)) => ((! [Xx3:$i] : (cwceq @ XM @ (ccfv @ (XT @ Xx3) @ ccnm))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XG @ Xx3 @ Xy1) @ (ccfv @ XS @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwceq @ (XK @ Xx3 @ Xy1) @ (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((cwi @ Xph @ (cwcel @ XS @ (ccin @ ccnlm @ ccclm))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ (XT @ Xx3) @ (ccin @ ccnlm @ ccclm)))) => ((! [Xx3:$i] : (cwi @ Xph @ (cwcel @ XF @ (cco @ XS @ (XT @ Xx3) @ cclmhm)))) => ((cwi @ Xph @ (cwcel @ XA2 @ ccxr)) => ((cwi @ Xph @ (cwcel @ XR @ ccrp)) => ((cwi @ (cwa @ Xph @ (cwral @ (^ [Xx3:$i] : (cwi @ (Xps @ Xx3) @ (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ XR @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV))) @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((! [Xy1:$i] : (cwi @ (cwa @ (cwa @ (cwa @ Xph @ (cwral @ (^ [Xx3:$i] : (cwi @ (Xps @ Xx3) @ (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ XR @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV))) @ (cwcel @ XA2 @ ccr)) @ (cwa @ (cwcel @ (ccv @ Xy1) @ XV) @ (cwne @ (ccv @ Xy1) @ (ccfv @ XS @ cc0g)))) @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ XM) @ (cco @ XA2 @ (ccfv @ (ccv @ Xy1) @ XL) @ ccmul) @ ccle))) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XV)) @ (cwi @ (Xps @ Xx3) @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XL) @ XR @ ccle)))) => (cwi @ Xph @ (cwb @ (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwi @ (Xps @ Xx3) @ (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ XR @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV)))))))))))))))))))))))))))))))).
