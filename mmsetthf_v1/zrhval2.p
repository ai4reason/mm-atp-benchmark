...
thf(czrhval2_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XL:($i > ($i > $o))] : ((! [Xn:$i] : (cwceq @ (XL @ Xn) @ (ccfv @ XR @ cczrh))) => ((cwceq @ Xc_x @ (ccfv @ XR @ ccmg)) => ((cwceq @ Xc_1 @ (ccfv @ XR @ ccur)) => (! [Xn:$i] : (cwi @ (cwcel @ XR @ ccrg) @ (cwceq @ (XL @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ Xc_1 @ Xc_x)))))))))))))).
