...
thf(cknoppndvlem1_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwi @ Xph @ (cwcel @ XN @ ccn)) => ((cwi @ Xph @ (cwcel @ XJ @ ccz)) => ((cwi @ Xph @ (cwcel @ XM @ ccz)) => (cwi @ Xph @ (cwcel @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ XM @ ccmul) @ ccr)))))))))).
