...
thf(cabladdsub4_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwceq @ XB2 @ (ccfv @ XG @ ccbs)) => ((cwceq @ Xc_pl @ (ccfv @ XG @ ccplusg)) => ((cwceq @ Xc_mi @ (ccfv @ XG @ ccsg)) => (cwi @ (cw3a @ (cwcel @ XG @ ccabl) @ (cwa @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cwa @ (cwcel @ XZ @ XB2) @ (cwcel @ XW @ XB2))) @ (cwb @ (cwceq @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XW @ Xc_pl)) @ (cwceq @ (cco @ XX @ XZ @ Xc_mi) @ (cco @ XW @ XY @ Xc_mi)))))))))))))))).
