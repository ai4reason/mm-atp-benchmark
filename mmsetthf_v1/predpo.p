...
thf(cpredpo_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwa @ (cwpo @ XA2 @ XR) @ (cwcel @ XX @ XA2)) @ (cwi @ (cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) @ (cwss @ (ccpred @ XA2 @ XR @ XY) @ (ccpred @ XA2 @ XR @ XX))))))))).
