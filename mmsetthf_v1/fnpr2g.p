...
thf(cfnpr2g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) @ (cwb @ (cwfn @ XF @ (ccpr @ XA2 @ XB2)) @ (cwceq @ XF @ (ccpr @ (ccop @ XA2 @ (ccfv @ XA2 @ XF)) @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)))))))))))).
