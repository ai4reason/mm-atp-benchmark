...
thf(crexsupp_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (cwi @ (cw3a @ (cwfn @ XF @ XX) @ (cwcel @ XX @ XV) @ (cwcel @ XZ @ XW)) @ (cwb @ (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cco @ XF @ XZ @ ccsupp))) @ (cwrex @ (^ [Xx3:$i] : (cwa @ (cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ XZ) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : XX))))))))))).
