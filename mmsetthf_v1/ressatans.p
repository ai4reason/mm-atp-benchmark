...
thf(cressatans_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwceq @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : (cwceq @ (XS @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwss @ ccr @ (XS @ Xy1)))))))).
