...
thf(cghmf1_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((cwceq @ XX @ (ccfv @ XS @ ccbs)) => ((cwceq @ XY @ (ccfv @ XT @ ccbs)) => ((cwceq @ Xc_0 @ (ccfv @ XS @ cc0g)) => ((cwceq @ XU @ (ccfv @ XT @ cc0g)) => (cwi @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwb @ (cwf1 @ XX @ XY @ XF) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwceq @ (ccfv @ (ccv @ Xx3) @ XF) @ XU) @ (cwceq @ (ccv @ Xx3) @ Xc_0))) @ (^ [Xx3:$i] : XX)))))))))))))))).
