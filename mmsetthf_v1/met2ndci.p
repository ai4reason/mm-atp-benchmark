...
thf(ablcom_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwa @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XR @ ccxr)) @ (cwa @ (cwcel @ XP @ XX) @ (cwcel @ XA2 @ XX))) @ (cwb @ (cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) @ (cwcel @ XP @ (cco @ XA2 @ XR @ (ccfv @ XD @ ccbl))))))))))).
...
thf(cmet2ndci_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XD @ ccmopn)) => (cwi @ (cwa @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cw3a @ (cwss @ XA2 @ XX) @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwceq @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ XX))) @ (cwcel @ XJ @ cc2ndc)))))))).
