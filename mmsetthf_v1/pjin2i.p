...
thf(apjss2coi_thm,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (cwb @ (cwss @ XG @ XH) @ (cwceq @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XG @ ccpjh)))))))).
...
thf(apjidmcoi_thm,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwceq @ (cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XH @ ccpjh))))).
...
thf(cpjin2i_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (cwb @ (cwa @ (cwceq @ (ccfv @ XG @ ccpjh) @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh))) @ (cwceq @ (ccfv @ XH @ ccpjh) @ (cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XG @ ccpjh)))) @ (cwceq @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)))))))).
