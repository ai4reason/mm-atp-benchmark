...
thf(auni0c_thm,axiom,(! [XA2:($i > $o)] : (cwb @ (cwceq @ (ccuni @ XA2) @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwceq @ (ccv @ Xx3) @ cc0)) @ (^ [Xx3:$i] : XA2))))).
...
thf(accase2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwi @ (cwa @ Xph @ Xps) @ Xta) => ((cwi @ Xch @ Xta) => ((cwi @ Xth @ Xta) => (cwi @ (cwa @ (cwo @ Xph @ Xch) @ (cwo @ Xps @ Xth)) @ Xta)))))))))).
...
thf(aunctb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwbr @ XB2 @ ccom @ ccdom)) @ (cwbr @ (ccun @ XA2 @ XB2) @ ccom @ ccdom))))).
...
thf(ccctop_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (cwi @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwo @ (cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom) @ (cwceq @ (ccv @ Xx3) @ cc0))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ cctopon))))))).
