...
thf(aindf1o_thm,axiom,(! [XO:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwcel @ XO @ XV) @ (cwf1o @ (ccpw @ XO) @ (cco @ (ccpr @ ccc0 @ cc1) @ XO @ ccmap) @ (ccfv @ XO @ ccind)))))).
...
thf(aindpi1_thm,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO)) @ (cwceq @ (ccima @ (cccnv @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) @ (ccsn @ cc1)) @ XA2)))))).
...
thf(aindpreima_thm,axiom,(! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (cwi @ (cwa @ (cwcel @ XO @ XV) @ (cwf @ XO @ (ccpr @ ccc0 @ cc1) @ XF)) @ (cwceq @ XF @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ cc1)) @ (ccfv @ XO @ ccind)))))))).
...
thf(cindf1ofs_conj,conjecture,(! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xf1:$i] : (cwi @ (cwcel @ XO @ (XV @ Xf1)) @ (cwf1o @ (ccin @ (ccpw @ XO) @ ccfn) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ cc1)) @ ccfn)) @ (^ [Xf1:$i] : (cco @ (ccpr @ ccc0 @ cc1) @ XO @ ccmap))) @ (ccres @ (ccfv @ XO @ ccind) @ ccfn))))))).
