...
thf(auhgr3cyclexlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwceq @ XV @ (ccfv @ XG @ ccvtx)) => ((cwceq @ XE @ (ccfv @ XG @ ccedg)) => ((cwceq @ XI @ (ccfv @ XG @ cciedg)) => (cwi @ (cwa @ (cwa @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwne @ XA2 @ XB2)) @ (cwa @ (cwa @ (cwcel @ XJ @ (ccdm @ XI)) @ (cwceq @ (ccpr @ XB2 @ XC) @ (ccfv @ XJ @ XI))) @ (cwa @ (cwcel @ XK @ (ccdm @ XI)) @ (cwceq @ (ccpr @ XC @ XA2) @ (ccfv @ XK @ XI))))) @ (cwne @ XJ @ XK))))))))))))))).
...
thf(cuhgr3cyclex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XV @ Xf1 @ Xp) @ (ccfv @ XG @ ccvtx)))) => ((! [Xf1:$i] : (! [Xp:$i] : (cwceq @ (XE @ Xf1 @ Xp) @ (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : (cwi @ (cw3a @ (cwcel @ XG @ ccuhgr) @ (cwa @ (cw3a @ (cwcel @ XA2 @ (XV @ Xf1 @ Xp)) @ (cwcel @ XB2 @ (XV @ Xf1 @ Xp)) @ (cwcel @ XC @ (XV @ Xf1 @ Xp))) @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC))) @ (cw3a @ (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XC @ XA2) @ (XE @ Xf1 @ Xp)))) @ (cwex @ (^ [Xf1:$i] : (cwex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cccycls)) @ (cwceq @ (ccfv @ (ccv @ Xf1) @ cchash) @ cc3) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ XA2)))))))))))))))))).
