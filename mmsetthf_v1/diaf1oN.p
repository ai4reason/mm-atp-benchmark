...
thf(cdiaf1oN_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > ($i > $o))] : (! [XW:($i > $o)] : ((cwceq @ XH @ (ccfv @ XK @ cclh)) => ((! [Xx3:$i] : (cwceq @ (XU @ Xx3) @ (ccfv @ XW @ (ccfv @ XK @ ccdveca)))) => ((cwceq @ XI @ (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((! [Xx3:$i] : (cwceq @ (Xc_pe @ Xx3) @ (ccfv @ XW @ (ccfv @ XK @ ccocaN)))) => ((! [Xx3:$i] : (cwceq @ XS @ (ccfv @ (XU @ Xx3) @ cclss))) => (cwi @ (cwa @ (cwcel @ XK @ cchlt) @ (cwcel @ XW @ XH)) @ (cwf1o @ (ccdm @ XI) @ (ccrab @ (^ [Xx3:$i] : (cwceq @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (Xc_pe @ Xx3)) @ (Xc_pe @ Xx3)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XS)) @ XI))))))))))))))).
