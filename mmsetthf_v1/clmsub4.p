...
thf(cclmsub4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwceq @ XV @ (ccfv @ XW @ ccbs)) => ((cwceq @ Xc_x @ (ccfv @ XW @ ccvsca)) => ((cwceq @ Xc_pl @ (ccfv @ XW @ ccplusg)) => (cwi @ (cw3a @ (cwcel @ XW @ ccclm) @ (cwa @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) @ (cwa @ (cwcel @ XC @ XV) @ (cwcel @ XD @ XV))) @ (cwceq @ (cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ (cco @ (ccneg @ cc1) @ (cco @ XC @ XD @ Xc_pl) @ Xc_x) @ Xc_pl) @ (cco @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XC @ Xc_x) @ Xc_pl) @ (cco @ XB2 @ (cco @ (ccneg @ cc1) @ XD @ Xc_x) @ Xc_pl) @ Xc_pl))))))))))))))).
