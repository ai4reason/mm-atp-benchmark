...
thf(ametreslem_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwceq @ (ccdm @ XD) @ (ccxp @ XX @ XX)) @ (cwceq @ (ccres @ XD @ (ccxp @ XR @ XR)) @ (ccres @ XD @ (ccxp @ (ccin @ XX @ XR) @ (ccin @ XX @ XR))))))))).
...
thf(cmetres_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ (ccres @ XD @ (ccxp @ XR @ XR)) @ (ccfv @ (ccin @ XX @ XR) @ ccme))))))).
