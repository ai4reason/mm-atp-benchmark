...
thf(api1bas_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((cwceq @ XO @ (cco @ XJ @ XY @ ccomi)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XG @ ccbs))) => ((cwi @ Xph @ (cwceq @ XK @ (ccfv @ XO @ ccbs))) => (cwi @ Xph @ (cwceq @ XB2 @ (ccqs @ XK @ (ccfv @ XJ @ ccphtpc))))))))))))))))))).
...
thf(cpi1buni_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XG @ (cco @ XJ @ XY @ ccpi1)) => ((cwi @ Xph @ (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwi @ Xph @ (cwcel @ XY @ XX)) => ((cwceq @ XO @ (cco @ XJ @ XY @ ccomi)) => ((cwi @ Xph @ (cwceq @ XB2 @ (ccfv @ XG @ ccbs))) => ((cwi @ Xph @ (cwceq @ XK @ (ccfv @ XO @ ccbs))) => (cwi @ Xph @ (cwceq @ (ccuni @ XB2) @ XK))))))))))))))))).
