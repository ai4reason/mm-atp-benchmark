...
thf(adf_tgp_ax,axiom,(cwceq @ cctgp @ (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xj:$i] : (cwcel @ (ccfv @ (ccv @ Xf1) @ ccminusg) @ (cco @ (ccv @ Xj) @ (ccv @ Xj) @ cccn))) @ (ccfv @ (ccv @ Xf1) @ cctopn))) @ (^ [Xf1:$i] : (ccin @ ccgrp @ cctmd))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ (cwa @ Xph @ Xps) @ Xch)))))).
thf(cistgp_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((cwceq @ XJ @ (ccfv @ XG @ cctopn)) => ((cwceq @ XI @ (ccfv @ XG @ ccminusg)) => (cwb @ (cwcel @ XG @ cctgp) @ (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XG @ cctmd) @ (cwcel @ XI @ (cco @ XJ @ XJ @ cccn)))))))))).
