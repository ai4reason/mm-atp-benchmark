...
thf(acdanum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd))) @ (cwcel @ (cco @ XA2 @ XB2 @ cccda) @ (ccdm @ cccrd)))))).
...
thf(cunnum_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd))) @ (cwcel @ (ccun @ XA2 @ XB2) @ (ccdm @ cccrd)))))).
