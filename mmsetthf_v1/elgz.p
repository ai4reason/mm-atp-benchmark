...
thf(adf_gz_ax,axiom,(cwceq @ ccgz @ (ccrab @ (^ [Xx3:$i] : (cwa @ (cwcel @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccz) @ (cwcel @ (ccfv @ (ccv @ Xx3) @ ccim) @ ccz))) @ (^ [Xx3:$i] : ccc)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cw3a @ Xph @ Xps @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(celgz_conj,conjecture,(! [XA2:($i > $o)] : (cwb @ (cwcel @ XA2 @ ccgz) @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ (ccfv @ XA2 @ ccre) @ ccz) @ (cwcel @ (ccfv @ XA2 @ ccim) @ ccz))))).
