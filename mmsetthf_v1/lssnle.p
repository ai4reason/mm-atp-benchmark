...
thf(clssnle_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((cwceq @ Xc_po @ (ccfv @ XG @ cclsm)) => ((cwi @ Xph @ (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((cwi @ Xph @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => (cwi @ Xph @ (cwb @ (cwn @ (cwss @ XU @ XT)) @ (cwpss @ XT @ (cco @ XT @ XU @ Xc_po))))))))))))).
