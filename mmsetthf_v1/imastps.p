...
thf(cimastps_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwi @ Xph @ (cwceq @ XU @ (cco @ XF @ XR @ ccimas))) => ((cwi @ Xph @ (cwceq @ XV @ (ccfv @ XR @ ccbs))) => ((cwi @ Xph @ (cwfo @ XV @ XB2 @ XF)) => ((cwi @ Xph @ (cwcel @ XR @ cctps)) => (cwi @ Xph @ (cwcel @ XU @ cctps))))))))))))).
