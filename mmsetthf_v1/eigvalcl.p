...
thf(aeleigvec_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwf @ cchil @ cchil @ XT) @ (cwb @ (cwcel @ XA2 @ (ccfv @ XT @ ccei)) @ (cw3a @ (cwcel @ XA2 @ cchil) @ (cwne @ XA2 @ cc0v) @ (cwrex @ (^ [Xx3:$i] : (cwceq @ (ccfv @ XA2 @ XT) @ (cco @ (ccv @ Xx3) @ XA2 @ ccsm))) @ (^ [Xx3:$i] : ccc)))))))).
...
thf(ceigvalcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (cwi @ (cwa @ (cwf @ cchil @ cchil @ XT) @ (cwcel @ XA2 @ (ccfv @ XT @ ccei))) @ (cwcel @ (ccfv @ XA2 @ (ccfv @ XT @ ccel)) @ ccc))))).
