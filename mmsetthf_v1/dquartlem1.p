...
thf(adiveq0ad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwne @ XB2 @ ccc0)) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0) @ (cwceq @ XA2 @ ccc0)))))))))).
...
thf(cdquartlem1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwi @ Xph @ (cwcel @ XB2 @ ccc)) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XX @ ccc)) => ((cwi @ Xph @ (cwcel @ XS @ ccc)) => ((cwi @ Xph @ (cwceq @ XM @ (cco @ (cco @ cc2 @ XS @ ccmul) @ cc2 @ ccexp))) => ((cwi @ Xph @ (cwne @ XM @ ccc0)) => ((cwi @ Xph @ (cwcel @ XI @ ccc)) => ((cwi @ Xph @ (cwceq @ (cco @ XI @ cc2 @ ccexp) @ (cco @ (cco @ (ccneg @ (cco @ XS @ cc2 @ ccexp)) @ (cco @ XB2 @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XC @ cc4 @ ccdiv) @ XS @ ccdiv) @ ccaddc))) => (cwi @ Xph @ (cwb @ (cwceq @ (cco @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ (cco @ XM @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ ccaddc) @ (cco @ (cco @ (cco @ (cco @ XM @ cc2 @ ccdiv) @ XX @ ccmul) @ (cco @ XC @ cc4 @ ccdiv) @ ccmin) @ XS @ ccdiv) @ ccaddc) @ ccc0) @ (cwo @ (cwceq @ XX @ (cco @ (ccneg @ XS) @ XI @ ccaddc)) @ (cwceq @ XX @ (cco @ (ccneg @ XS) @ XI @ ccmin))))))))))))))))))))).
