...
thf(cexpcn_conj,conjecture,(! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cwceq @ XJ @ (ccfv @ cccnfld @ cctopn)) => (cwi @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccexp))) @ (cco @ XJ @ XJ @ cccn))))))).
