...
thf(adfac9_thm,axiom,(cwb @ cwac @ (cwal @ (^ [Xf1:$i] : (cwi @ (cwa @ (cwfun @ (ccv @ Xf1)) @ (cwnel @ cc0 @ (ccrn @ (ccv @ Xf1)))) @ (cwne @ (ccixp @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ cc0)))))).
thf(cdfac14_conj,conjecture,(cwb @ cwac @ (cwal @ (^ [Xf1:$i] : (cwi @ (cwf @ (ccdm @ (ccv @ Xf1)) @ cctop @ (ccv @ Xf1)) @ (cwral @ (^ [Xs1:$i] : (cwceq @ (ccfv @ (ccixp @ (^ [Xk:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)))) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ ccpt) @ cccl)) @ (ccixp @ (^ [Xk:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ cccl)))))) @ (^ [Xs1:$i] : (ccixp @ (^ [Xk:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xk:$i] : (ccpw @ (ccuni @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))))))))).
