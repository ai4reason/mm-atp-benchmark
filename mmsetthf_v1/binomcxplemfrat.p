...
thf(abccp1k_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((cwi @ Xph @ (cwcel @ XK @ ccn0)) => (cwi @ Xph @ (cwceq @ (cco @ XC @ (cco @ XK @ cc1 @ ccaddc) @ ccbcc) @ (cco @ (cco @ XC @ XK @ ccbcc) @ (cco @ (cco @ XC @ XK @ ccmin) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv) @ ccmul))))))))).
...
thf(abinomcxplemrat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xk) @ ccrp))) => ((! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XB2 @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xk) @ ccabs) @ cclt))) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => (cwi @ Xph @ (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ XC @ (ccv @ Xk) @ ccmin) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccdiv) @ ccabs))) @ cc1 @ ccli))))))))))).
thf(cbinomcxplemfrat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XA2 @ Xj @ Xk) @ ccrp)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwcel @ (XB2 @ Xj @ Xk) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : (cwi @ Xph @ (cwbr @ (ccfv @ (XB2 @ Xj @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk) @ ccabs) @ cclt)))) => ((cwi @ Xph @ (cwcel @ XC @ ccc)) => ((! [Xj:$i] : (! [Xk:$i] : (cwceq @ (XF @ Xj @ Xk) @ (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ XC @ (ccv @ Xj) @ ccbcc)))))) => (! [Xj:$i] : (cwi @ (cwa @ Xph @ (cwn @ (cwcel @ XC @ ccn0))) @ (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XF @ Xj @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xk)) @ ccdiv) @ ccabs))) @ cc1 @ ccli)))))))))))))).
