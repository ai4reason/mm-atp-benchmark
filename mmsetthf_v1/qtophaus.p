...
thf(aopeldifid_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (cwi @ (cwrel @ XA2) @ (cwb @ (cwcel @ (ccop @ XX @ XY) @ (ccdif @ XA2 @ ccid)) @ (cwa @ (cwcel @ (ccop @ XX @ XY) @ XA2) @ (cwne @ XX @ XY)))))))).
...
thf(afcoinvbr_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ Xc_sm @ (cccom @ (cccnv @ XF) @ XF)) => (cwi @ (cw3a @ (cwfn @ XF @ XA2) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2)) @ (cwb @ (cwbr @ XX @ XY @ Xc_sm) @ (cwceq @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF))))))))))).
...
thf(afcoinver_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (cwi @ (cwfn @ XF @ XX) @ (cwer @ XX @ (cccom @ (cccnv @ XF) @ XF)))))).
thf(aereq1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (cwi @ (cwceq @ XR @ XS) @ (cwb @ (cwer @ XA2 @ XR) @ (cwer @ XA2 @ XS))))))).
...
thf(ahausdiag_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => (cwb @ (cwcel @ XJ @ ccha) @ (cwa @ (cwcel @ XJ @ cctop) @ (cwcel @ (ccres @ ccid @ XX) @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccld)))))))).
thf(cqtophaus_conj,conjecture,(! [Xph:$o] : (! [Xc_sm:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwceq @ XX @ (ccuni @ XJ)) => ((cwceq @ Xc_sm @ (cccom @ (cccnv @ XF) @ XF)) => ((cwceq @ XH @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))))) => ((cwi @ Xph @ (cwcel @ XJ @ ccha)) => ((cwi @ Xph @ (cwfo @ XX @ XY @ XF)) => ((! [Xx3:$i] : (cwi @ (cwa @ Xph @ (cwcel @ (ccv @ Xx3) @ XJ)) @ (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ (cco @ XJ @ XF @ ccqtop)))) => ((cwi @ Xph @ (cwcel @ Xc_sm @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccld))) => (cwi @ Xph @ (cwcel @ (cco @ XJ @ XF @ ccqtop) @ ccha))))))))))))))))).
