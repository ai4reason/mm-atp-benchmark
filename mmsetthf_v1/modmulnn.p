...
thf(aflmulnn0_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ ccr)) @ (cwbr @ (cco @ XN @ (ccfv @ XA2 @ ccfl) @ ccmul) @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ ccfl) @ ccle))))).
...
thf(cmodmulnn_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccn)) @ (cwbr @ (cco @ (cco @ XN @ (ccfv @ XA2 @ ccfl) @ ccmul) @ (cco @ XN @ XM @ ccmul) @ ccmo) @ (cco @ (ccfv @ (cco @ XN @ XA2 @ ccmul) @ ccfl) @ (cco @ XN @ XM @ ccmul) @ ccmo) @ ccle)))))).
