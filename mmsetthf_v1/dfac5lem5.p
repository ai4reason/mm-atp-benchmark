...
thf(adfac5lem4_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwceq @ (XA2 @ Xv @ Xu @ Xt @ Xh) @ (ccab @ (^ [Xu:$i] : (cwa @ (cwne @ (ccv @ Xu) @ cc0) @ (cwrex @ (^ [Xt:$i] : (cwceq @ (ccv @ Xu) @ (ccxp @ (ccsn @ (ccv @ Xt)) @ (ccv @ Xt)))) @ (^ [Xt:$i] : (ccv @ Xh))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu @ Xt @ Xh) @ (ccin @ (ccuni @ (XA2 @ Xv @ Xu @ Xt @ Xh)) @ (ccv @ Xy1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwb @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xh) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwral @ (^ [Xz:$i] : (cwne @ (ccv @ Xz) @ cc0)) @ (^ [Xz:$i] : (ccv @ Xx3))) @ (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwne @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccin @ (ccv @ Xz) @ (ccv @ Xw)) @ cc0))) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1)))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xh) @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1)))))) @ (^ [Xz:$i] : (XA2 @ Xv @ Xu @ Xt @ Xh))))))))))))))))))))).
...
thf(adfac5lem3_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwceq @ (XA2 @ Xu @ Xt @ Xh) @ (ccab @ (^ [Xu:$i] : (cwa @ (cwne @ (ccv @ Xu) @ cc0) @ (cwrex @ (^ [Xt:$i] : (cwceq @ (ccv @ Xu) @ (ccxp @ (ccsn @ (ccv @ Xt)) @ (ccv @ Xt)))) @ (^ [Xt:$i] : (ccv @ Xh)))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwb @ (cwcel @ (ccxp @ (ccsn @ (ccv @ Xw)) @ (ccv @ Xw)) @ (XA2 @ Xu @ Xt @ Xh)) @ (cwa @ (cwne @ (ccv @ Xw) @ cc0) @ (cwcel @ (ccv @ Xw) @ (ccv @ Xh))))))))))).
thf(adfac5lem1_thm,axiom,(! [Xy1:$i] : (! [Xw:$i] : (cwb @ (cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccxp @ (ccsn @ (ccv @ Xw)) @ (ccv @ Xw)) @ (ccv @ Xy1))))) @ (cweu @ (^ [Xg1:$i] : (cwa @ (cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) @ (cwcel @ (ccop @ (ccv @ Xw) @ (ccv @ Xg1)) @ (ccv @ Xy1))))))))).
...
thf(adfac5lem2_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [Xg1:$i] : ((! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwceq @ (XA2 @ Xu @ Xt @ Xh) @ (ccab @ (^ [Xu:$i] : (cwa @ (cwne @ (ccv @ Xu) @ cc0) @ (cwrex @ (^ [Xt:$i] : (cwceq @ (ccv @ Xu) @ (ccxp @ (ccsn @ (ccv @ Xt)) @ (ccv @ Xt)))) @ (^ [Xt:$i] : (ccv @ Xh)))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : (cwb @ (cwcel @ (ccop @ (ccv @ Xw) @ (ccv @ Xg1)) @ (ccuni @ (XA2 @ Xu @ Xt @ Xh))) @ (cwa @ (cwcel @ (ccv @ Xw) @ (ccv @ Xh)) @ (cwcel @ (ccv @ Xg1) @ (ccv @ Xw)))))))))))).
thf(aanass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (cwb @ (cwa @ (cwa @ Xph @ Xps) @ Xch) @ (cwa @ Xph @ (cwa @ Xps @ Xch))))))).
thf(aeuanv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (cwb @ (cweu @ (^ [Xx3:$i] : (cwa @ Xph @ (Xps @ Xx3)))) @ (cwa @ Xph @ (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))))))).
...
thf(cdfac5lem5_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XA2 @ Xv @ Xu @ Xt @ Xf1 @ Xh) @ (ccab @ (^ [Xu:$i] : (cwa @ (cwne @ (ccv @ Xu) @ cc0) @ (cwrex @ (^ [Xt:$i] : (cwceq @ (ccv @ Xu) @ (ccxp @ (ccsn @ (ccv @ Xt)) @ (ccv @ Xt)))) @ (^ [Xt:$i] : (ccv @ Xh)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : (cwceq @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu @ Xt @ Xh) @ (ccin @ (ccuni @ (XA2 @ Xv @ Xu @ Xt @ Xf1 @ Xh)) @ (ccv @ Xy1)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : (cwb @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xf1 @ Xh) @ (cwal @ (^ [Xx3:$i] : (cwi @ (cwa @ (cwral @ (^ [Xz:$i] : (cwne @ (ccv @ Xz) @ cc0)) @ (^ [Xz:$i] : (ccv @ Xx3))) @ (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwne @ (ccv @ Xz) @ (ccv @ Xw)) @ (cwceq @ (ccin @ (ccv @ Xz) @ (ccv @ Xw)) @ cc0))) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (cwex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1)))))) @ (^ [Xz:$i] : (ccv @ Xx3)))))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : (cwi @ (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xf1 @ Xh) @ (cwex @ (^ [Xf1:$i] : (cwral @ (^ [Xw:$i] : (cwi @ (cwne @ (ccv @ Xw) @ cc0) @ (cwcel @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)) @ (ccv @ Xw)))) @ (^ [Xw:$i] : (ccv @ Xh)))))))))))))))))))))).
