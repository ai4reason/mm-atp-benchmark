...
thf(adf_clwlks_ax,axiom,(cwceq @ ccclwlks @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ (ccv @ Xg1) @ ccwlks)) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ cchash) @ (ccv @ Xp))))))))))).
thf(cclwlks_conj,conjecture,(! [XG:($i > $o)] : (cwceq @ (ccfv @ XG @ ccclwlks) @ (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cwa @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ (cwceq @ (ccfv @ ccc0 @ (ccv @ Xp)) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ cchash) @ (ccv @ Xp)))))))))).
