...
thf(cdnibndlem10_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccr)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccr)) => ((cwi @ Xph @ (cwbr @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ cc2 @ ccaddc) @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ ccle)) => (cwi @ Xph @ (cwbr @ cc1 @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))))).
