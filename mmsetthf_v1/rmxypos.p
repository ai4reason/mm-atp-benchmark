...
thf(crmxypos_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (cwi @ (cwa @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) @ (cwa @ (cwbr @ ccc0 @ (cco @ XA2 @ XN @ ccrmx) @ cclt) @ (cwbr @ ccc0 @ (cco @ XA2 @ XN @ ccrmy) @ ccle)))))).
