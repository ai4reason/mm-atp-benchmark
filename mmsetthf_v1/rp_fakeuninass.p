...
thf(arp_fakeinunass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwss @ XC @ XA2) @ (cwceq @ (ccun @ (ccin @ XA2 @ XB2) @ XC) @ (ccin @ XA2 @ (ccun @ XB2 @ XC)))))))).
...
thf(crp_fakeuninass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwb @ (cwss @ XA2 @ XC) @ (cwceq @ (ccin @ (ccun @ XA2 @ XB2) @ XC) @ (ccun @ XA2 @ (ccin @ XB2 @ XC)))))))).
