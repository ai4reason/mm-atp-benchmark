...
thf(aisrnsigau_thm,axiom,(! [XS:($i > $o)] : (cwi @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwa @ (cwss @ XS @ (ccpw @ (ccuni @ XS))) @ (cw3a @ (cwcel @ (ccuni @ XS) @ XS) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ (ccuni @ XS) @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XS)) @ (cwral @ (^ [Xx3:$i] : (cwi @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwcel @ (ccuni @ (ccv @ Xx3)) @ XS))) @ (^ [Xx3:$i] : (ccpw @ XS)))))))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(arpxdivcld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwi @ Xph @ (cwcel @ XA2 @ ccrp)) => ((cwi @ Xph @ (cwcel @ XB2 @ ccrp)) => (cwi @ Xph @ (cwcel @ (cco @ XA2 @ XB2 @ ccxdiv) @ ccrp)))))))).
...
thf(cprobfinmeasbOLD_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (cwi @ (cwa @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwcel @ (ccfv @ (ccuni @ XS) @ XM) @ ccrp)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccuni @ XS) @ XM) @ ccxdiv))) @ ccprb))))).
