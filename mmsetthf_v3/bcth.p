...
thf(cbcth_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccms)) & (cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM) & ((ccfv @ (ccuni @ (ccrn @ XM)) @ (ccfv @ XJ @ ccnt)) != cc0)) => (cwrex @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ ccnt)) != cc0)) @ (^ [Xk:$i] : ccn))))))))).
