...
thf(adeg1scl_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XK) & (XF != Xc_0)) => ((ccfv @ (ccfv @ XF @ XA2) @ XD) = ccc0))))))))))))))).
...
thf(cmon1pid_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_1 = (ccfv @ XP @ ccur)) => ((XM = (ccfv @ XR @ ccmn1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((cwcel @ XR @ ccnzr) => ((cwcel @ Xc_1 @ XM) & ((ccfv @ Xc_1 @ XD) = ccc0))))))))))))).
