...
thf(adfac8alem_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XF @ Xg1) = (ccrecs @ (XG @ Xy1 @ Xf1 @ Xg1)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XG @ Xy1 @ Xf1 @ Xg1) = (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (ccfv @ (ccdif @ XA2 @ (ccrn @ (ccv @ Xf1))) @ (ccv @ Xg1)))))))) => (! [Xy1:$i] : (! [Xf1:$i] : ((cwcel @ XA2 @ (XC @ Xy1 @ Xf1)) => ((? [Xg1:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xy1) != cc0) => (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ XA2)))) => (cwcel @ XA2 @ (ccdm @ cccrd))))))))))))).
...
thf(cdfac8a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XB2 @ Xy1)) => ((? [Xh:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xy1) != cc0) => (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xh)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ XA2)))) => (cwcel @ XA2 @ (ccdm @ cccrd)))))))).
