...
thf(cexpghm_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((! [Xx3:$i] : ((XM @ Xx3) = (ccfv @ cccnfld @ ccmgp))) => ((! [Xx3:$i] : ((XU @ Xx3) = (cco @ (XM @ Xx3) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccz) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccexp))) @ (cco @ czring @ (XU @ Xx3) @ ccghm)))))))))).
