...
thf(amapdffval_thm,axiom,(! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xs1:$i] : ((XH @ Xf1 @ Xs1) = (ccfv @ XK @ cclh)))) => (! [Xw:$i] : (! [Xf1:$i] : (! [Xs1:$i] : ((cwcel @ XK @ (XX @ Xw @ Xf1 @ Xs1)) => ((ccfv @ XK @ ccmpd) = (ccmpt @ (^ [Xw:$i] : (XH @ Xf1 @ Xs1)) @ (^ [Xw:$i] : (ccmpt @ (^ [Xs1:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclss)) @ (^ [Xs1:$i] : (ccrab @ (^ [Xf1:$i] : (((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclk)) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccoch))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccoch))) = (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclk))) & (cwss @ (ccfv @ (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclk)) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccoch))) @ (ccv @ Xs1)))) @ (^ [Xf1:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclfn))))))))))))))))).
