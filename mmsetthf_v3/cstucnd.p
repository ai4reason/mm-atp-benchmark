...
thf(austne0_thm,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (XU != cc0))))).
...
thf(austref_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU) & (cwcel @ XA2 @ XX)) => (cwbr @ XA2 @ XA2 @ XV))))))).
...
thf(ccstucnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XU @ (ccfv @ XX @ ccust))) => ((Xph => (cwcel @ XV @ (ccfv @ XY @ ccust))) => ((Xph => (cwcel @ XA2 @ XY)) => (Xph => (cwcel @ (ccxp @ XX @ (ccsn @ XA2)) @ (cco @ XU @ XV @ ccucn))))))))))))).
