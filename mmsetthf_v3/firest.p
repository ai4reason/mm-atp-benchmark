...
thf(aelfi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (ccint @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdif @ (ccin @ (ccpw @ XB2) @ ccfn) @ (ccsn @ cc0)))))))))).
...
thf(aintrnfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & ((cwf @ XA2 @ XB2 @ XF) & (XA2 != cc0) & (cwcel @ XA2 @ ccfn))) => (cwcel @ (ccint @ (ccrn @ XF)) @ (ccfv @ XB2 @ ccfi)))))))).
...
thf(cfirest_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((ccfv @ (cco @ XJ @ XA2 @ ccrest) @ ccfi) = (cco @ (ccfv @ XJ @ ccfi) @ XA2 @ ccrest))))).
