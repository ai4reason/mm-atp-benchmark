...
thf(anndiffz1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccdif @ ccn @ (cco @ cc1 @ XN @ ccfz)) = (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz))))).
...
thf(affs2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XC = (ccdif @ XB2 @ (ccsn @ XZ))) => (((cwcel @ XA2 @ XV) & (cwcel @ XZ @ XW) & (cwf @ XA2 @ XB2 @ XF)) => ((cco @ XF @ XZ @ ccsupp) = (ccima @ (cccnv @ XF) @ XC)))))))))))).
...
thf(asuppss3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XZ @ (XW @ Xx3)))) => ((Xph => (cwfn @ XF @ XA2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2) & ((ccfv @ (ccv @ Xx3) @ XF) = XZ)) => ((XB2 @ Xx3) = XZ))) => (! [Xx3:$i] : (Xph => (cwss @ (cco @ (XG @ Xx3) @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp)))))))))))))))))).
...
thf(ceulerpartlems_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xk:$i] : (((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) & (cwcel @ (ccv @ Xt) @ (ccfv @ (cco @ (ccfv @ XA2 @ (XS @ Xf1 @ Xk)) @ cc1 @ ccaddc) @ ccuz))) => ((ccfv @ (ccv @ Xt) @ XA2) = ccc0))))))))))).
