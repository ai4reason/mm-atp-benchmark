...
thf(avrgpfval_thm,axiom,(! [Xc_sm:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((Xc_sm = (ccfv @ XI @ ccefg)) => ((! [Xj:$i] : ((XU @ Xj) = (ccfv @ XI @ ccvrgp))) => (! [Xj:$i] : ((cwcel @ XI @ XV) => ((XU @ Xj) = (ccmpt @ (^ [Xj:$i] : XI) @ (^ [Xj:$i] : (ccec @ (ccs1 @ (ccop @ (ccv @ Xj) @ cc0)) @ Xc_sm))))))))))))).
thf(cvrgpf_conj,conjecture,(! [Xc_sm:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccfv @ XI @ ccefg)) => ((XU = (ccfv @ XI @ ccvrgp)) => ((XG = (ccfv @ XI @ ccfrgp)) => ((XX = (ccfv @ XG @ ccbs)) => ((cwcel @ XI @ XV) => (cwf @ XI @ XX @ XU))))))))))))).
