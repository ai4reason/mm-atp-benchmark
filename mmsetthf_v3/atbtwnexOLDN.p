...
thf(catbtwnexOLDN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xr:$i] : ((Xc_or @ Xr) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & ((cwcel @ XX @ XB2) & (cwbr @ XP @ XX @ Xc_le) & (~ (cwbr @ XQ @ XX @ Xc_le)))) => (cwrex @ (^ [Xr:$i] : (((ccv @ Xr) != XQ) & (~ (cwbr @ (ccv @ Xr) @ XX @ Xc_le)) & (cwbr @ (ccv @ Xr) @ (cco @ XP @ XQ @ (Xc_or @ Xr)) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))).
