...
thf(carglem1N_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XF = (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XS @ XT @ Xc_or) @ Xc_an)) => ((XG = (cco @ (cco @ XP @ XS @ Xc_or) @ (cco @ XQ @ XT @ Xc_or) @ Xc_an)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & ((cwcel @ XS @ XA2) & (cwcel @ XT @ XA2) & (XP != XQ)) & ((XP != XS) & (XQ != XT) & (XS != XT))) & (cwcel @ XG @ XA2)) => (cwcel @ XF @ XA2)))))))))))))))))).
