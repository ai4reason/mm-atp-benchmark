...
thf(ambfimasn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ ccmbf) & (cwf @ XA2 @ ccr @ XF) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ XB2)) @ (ccdm @ ccvol))))))).
...
thf(aftc1anclem4_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ ccibl) & (cwf @ ccr @ ccr @ XG)) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ XG) @ (ccfv @ (ccv @ Xt) @ XF) @ ccmin) @ ccabs))) @ ccitg2) @ ccr))))).
...
thf(cftc1anclem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xt:$i] : ((XG @ Xx3 @ Xt) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((Xph => (cwss @ XD @ ccr)) => ((Xph => (cwcel @ XF @ ccibl)) => ((Xph => (cwf @ XD @ ccc @ XF)) => ((Xph & (cwcel @ XY @ ccrp)) => (cwrex @ (^ [Xf1:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccfv @ (ccif @ (cwcel @ (ccv @ Xt) @ XD) @ (ccfv @ (ccv @ Xt) @ XF) @ ccc0) @ ccre) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ ccmin) @ ccabs))) @ ccitg2) @ XY @ cclt)) @ (^ [Xf1:$i] : (ccdm @ ccitg1)))))))))))))))))))).
