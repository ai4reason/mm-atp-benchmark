...
thf(asumrb_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XF = (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwss @ XA2 @ (ccfv @ XM @ ccuz))) => ((Xph => (cwss @ XA2 @ (ccfv @ XN @ ccuz))) => (! [Xk:$i] : (Xph => ((cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (XC @ Xk) @ ccli) <=> (cwbr @ (ccseq @ ccaddc @ XF @ XN) @ (XC @ Xk) @ ccli)))))))))))))))))).
...
thf(acsbco_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : ((ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xy1:$i] : (ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) = (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))).
...
thf(adf_sum_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xk:$i] : ((ccsu @ (XA2 @ Xk) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccio @ (^ [Xx3:$i] : ((cwrex @ (^ [Xm:$i] : ((cwss @ (XA2 @ Xk) @ (ccfv @ (ccv @ Xm) @ ccuz)) & (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ (XA2 @ Xk)) @ (ccsb @ (ccv @ Xn) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccc0))) @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz)) | (cwrex @ (^ [Xm:$i] : (? [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (XA2 @ Xk) @ (ccv @ Xf1)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xm) @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))) @ cc1)))))) @ (^ [Xm:$i] : ccn)))))))))).
thf(adf_fv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ XF) = (ccio @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))))))).
thf(czsum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwss @ XA2 @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (Xph => ((ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccfv @ (ccseq @ ccaddc @ XF @ XM) @ ccli))))))))))))))).
