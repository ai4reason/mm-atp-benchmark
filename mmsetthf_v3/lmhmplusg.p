...
thf(aghmplusg_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xc_pl = (ccfv @ XN @ ccplusg)) => (((cwcel @ XN @ ccabl) & (cwcel @ XF @ (cco @ XM @ XN @ ccghm)) & (cwcel @ XG @ (cco @ XM @ XN @ ccghm))) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ (cco @ XM @ XN @ ccghm)))))))))).
...
thf(clmhmplusg_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xc_pl = (ccfv @ XN @ ccplusg)) => (((cwcel @ XF @ (cco @ XM @ XN @ cclmhm)) & (cwcel @ XG @ (cco @ XM @ XN @ cclmhm))) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ (cco @ XM @ XN @ cclmhm)))))))))).
