...
thf(amamudm_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XE = (cco @ XR @ (ccxp @ XM @ XN) @ ccfrlm)) => ((XB2 = (ccfv @ XE @ ccbs)) => ((XF = (cco @ XR @ (ccxp @ XN @ XP) @ ccfrlm)) => ((XC = (ccfv @ XF @ ccbs)) => ((Xc_xp = (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => (((cwcel @ XR @ XV) & ((cwcel @ XM @ ccfn) & (cwcel @ XN @ ccfn) & (cwcel @ XP @ ccfn))) => ((ccdm @ Xc_xp) = (ccxp @ XB2 @ XC))))))))))))))))))).
thf(aintnand_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (~ Xps)) => (Xph => (~ (Xch & Xps)))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(andmovg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((((ccdm @ XF) = (ccxp @ XR @ XS)) & (~ ((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS)))) => ((cco @ XA2 @ XB2 @ XF) = cc0)))))))).
...
thf(aelfrlmbasn0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XN = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XF @ ccbs)) => (((cwcel @ XI @ XV) & (XI != cc0)) => ((cwcel @ XX @ XB2) => (XX != cc0)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aeqneqall_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((XA2 != XB2) => Xph)))))).
thf(cmamufacex_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XE = (cco @ XR @ (ccxp @ XM @ XN) @ ccfrlm)) => ((XB2 = (ccfv @ XE @ ccbs)) => ((XF = (cco @ XR @ (ccxp @ XN @ XP) @ ccfrlm)) => ((XC = (ccfv @ XF @ ccbs)) => ((Xc_xp = (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => ((XG = (cco @ XR @ (ccxp @ XM @ XP) @ ccfrlm)) => ((XD = (ccfv @ XG @ ccbs)) => ((((XM != cc0) & (XP != cc0)) & ((cwcel @ XR @ XV) & (cwcel @ XY @ XD)) & ((cwcel @ XM @ ccfn) & (cwcel @ XN @ ccfn) & (cwcel @ XP @ ccfn))) => (((cco @ XX @ XZ @ Xc_xp) = XY) => (cwcel @ XZ @ XC)))))))))))))))))))))))))).
