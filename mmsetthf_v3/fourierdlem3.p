...
thf(cfourierdlem3_conj,conjecture,(! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XP @ Xi @ Xm @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap))))))))) => (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((cwcel @ XM @ ccn) => ((cwcel @ (XQ @ Xm) @ (ccfv @ XM @ (XP @ Xi @ Xm @ Xp))) <=> ((cwcel @ (XQ @ Xm) @ (cco @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (cco @ ccc0 @ XM @ ccfz) @ ccmap)) & ((((ccfv @ ccc0 @ (XQ @ Xm)) = (ccneg @ ccpi)) & ((ccfv @ XM @ (XQ @ Xm)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo))))))))))))))).
