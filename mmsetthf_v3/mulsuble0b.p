...
thf(cmulsuble0b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XB2 @ ccmin) @ ccmul) @ ccc0 @ ccle) <=> (((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ XB2 @ XC @ ccle)) | ((cwbr @ XC @ XB2 @ ccle) & (cwbr @ XB2 @ XA2 @ ccle))))))))).
