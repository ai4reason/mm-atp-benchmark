...
thf(adprdval_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xc_0 @ Xf1 @ Xh @ Xi) = (ccfv @ XG @ cc0g))))) => ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XW @ Xf1 @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xf1 @ Xh @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS))))))))) => (! [Xh:$i] : (! [Xi:$i] : (((cwbr @ XG @ XS @ (ccdm @ ccdprd)) & ((ccdm @ XS) = XI)) => ((cco @ XG @ XS @ ccdprd) = (ccrn @ (ccmpt @ (^ [Xf1:$i] : (XW @ Xf1 @ Xh @ Xi)) @ (^ [Xf1:$i] : (cco @ XG @ (ccv @ Xf1) @ ccgsu)))))))))))))))).
...
thf(celdprd_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xc_0 @ Xf1 @ Xh @ Xi) = (ccfv @ XG @ cc0g))))) => ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XW @ Xf1 @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xf1 @ Xh @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS))))))))) => (! [Xh:$i] : (! [Xi:$i] : (((ccdm @ XS) = XI) => ((cwcel @ (XA2 @ Xh @ Xi) @ (cco @ XG @ XS @ ccdprd)) <=> ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) & (cwrex @ (^ [Xf1:$i] : ((XA2 @ Xh @ Xi) = (cco @ XG @ (ccv @ Xf1) @ ccgsu))) @ (^ [Xf1:$i] : (XW @ Xf1 @ Xh @ Xi))))))))))))))))).
