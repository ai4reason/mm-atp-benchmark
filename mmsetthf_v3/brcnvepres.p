...
thf(cbrcnvepres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XC @ XW)) => ((cwbr @ XB2 @ XC @ (ccres @ (cccnv @ ccep) @ XA2)) <=> ((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XB2)))))))))).
