...
thf(aslelttrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccsur)) => ((Xph => (cwcel @ XB2 @ ccsur)) => ((Xph => (cwcel @ XC @ ccsur)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccsle)) => ((Xph => (cwbr @ XB2 @ XC @ ccslt)) => (Xph => (cwbr @ XA2 @ XC @ ccslt)))))))))))).
...
thf(ascutcut_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => ((cwcel @ (cco @ XA2 @ XB2 @ ccscut) @ ccsur) & (cwbr @ XA2 @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ ccsslt) & (cwbr @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ XB2 @ ccsslt)))))).
...
thf(asltletrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccsur)) => ((Xph => (cwcel @ XB2 @ ccsur)) => ((Xph => (cwcel @ XC @ ccsur)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccslt)) => ((Xph => (cwbr @ XB2 @ XC @ ccsle)) => (Xph => (cwbr @ XA2 @ XC @ ccslt)))))))))))).
...
thf(asltnle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur)) => ((cwbr @ XA2 @ XB2 @ ccslt) <=> (~ (cwbr @ XB2 @ XA2 @ ccsle))))))).
...
thf(asltirr_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsur) => (~ (cwbr @ XA2 @ XA2 @ ccslt))))).
thf(anotbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps <=> Xch)) => (Xph => ((~ Xps) <=> (~ Xch)))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(ascutbdaylt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccsur) & ((cwbr @ XA2 @ (ccsn @ XX) @ ccsslt) & (cwbr @ (ccsn @ XX) @ XB2 @ ccsslt)) & (XX != (cco @ XA2 @ XB2 @ ccscut))) => (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccscut) @ ccbday) @ (ccfv @ XX @ ccbday))))))).
...
thf(cslerec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwbr @ XA2 @ XB2 @ ccsslt) & (cwbr @ XC @ XD @ ccsslt)) & ((XX = (cco @ XA2 @ XB2 @ ccscut)) & (XY = (cco @ XC @ XD @ ccscut)))) => ((cwbr @ XX @ XY @ ccsle) <=> ((cwral @ (^ [Xd:$i] : (cwbr @ XX @ (ccv @ Xd) @ ccslt)) @ (^ [Xd:$i] : XD)) & (cwral @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ XY @ ccslt)) @ (^ [Xa:$i] : XA2)))))))))))).
