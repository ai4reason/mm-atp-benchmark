...
thf(apadd02_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ XB2) & (cwss @ XX @ XA2)) => ((cco @ cc0 @ XX @ Xc_pl) = XX)))))))))).
...
thf(apmap0_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XM = (ccfv @ XK @ ccpmap)) => ((cwcel @ XK @ ccal) => ((ccfv @ Xc_0 @ XM) = cc0)))))))).
...
thf(aolj02_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => (((cwcel @ XK @ ccol) & (cwcel @ XX @ XB2)) => ((cco @ Xc_0 @ XX @ Xc_or) = XX))))))))))).
...
thf(acvrat42_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((! [Xr:$i] : ((Xc_0 @ Xr) = (ccfv @ XK @ ccp0))) => ((XA2 = (ccfv @ XK @ ccatm)) => (! [Xr:$i] : (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XB2) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2))) => (((XX != (Xc_0 @ Xr)) & (cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le)) => (cwrex @ (^ [Xr:$i] : ((cwbr @ (ccv @ Xr) @ XX @ Xc_le) & (cwbr @ XP @ (cco @ (ccv @ Xr) @ XQ @ Xc_or) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))))))).
...
thf(aelpmap_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ XC) & (cwcel @ XX @ XB2)) => ((cwcel @ XP @ (ccfv @ XX @ XM)) <=> ((cwcel @ XP @ XA2) & (cwbr @ XP @ XX @ Xc_le))))))))))))))))).
...
thf(aelpmapat_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2)) => ((cwcel @ XX @ (ccfv @ XP @ XM)) <=> (XX = XP))))))))))).
...
thf(apmapeq0_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2)) => (((ccfv @ XX @ XM) = cc0) <=> (XX = Xc_0)))))))))))).
...
thf(aelpaddn0_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xr:$i] : (! [Xq:$i] : ((Xc_pl @ Xr @ Xq) = (ccfv @ XK @ ccpadd)))) => (! [Xr:$i] : (! [Xq:$i] : ((((cwcel @ XK @ cclat) & (cwss @ XX @ XA2) & (cwss @ XY @ XA2)) & ((XX != cc0) & (XY != cc0))) => ((cwcel @ XS @ (cco @ XX @ XY @ (Xc_pl @ Xr @ Xq))) <=> ((cwcel @ XS @ XA2) & (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ XS @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ Xc_or) @ Xc_le)) @ (^ [Xr:$i] : XY))) @ (^ [Xq:$i] : XX)))))))))))))))))))).
...
thf(cpmapjat1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XQ @ XA2)) => ((ccfv @ (cco @ XX @ XQ @ Xc_or) @ XM) = (cco @ (ccfv @ XX @ XM) @ (ccfv @ XQ @ XM) @ Xc_pl))))))))))))))))).
