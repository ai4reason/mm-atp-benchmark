...
thf(atnggrpr_thm,axiom,(! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => (((cwcel @ XN @ XV) & (cwcel @ XT @ ccngp)) => (cwcel @ XG @ ccgrp)))))))).
...
thf(anmtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XN) @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccaddc) @ ccle)))))))))))).
...
thf(ctngngp3_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cwf @ XX @ ccr @ XN) => ((cwcel @ XT @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwral @ (^ [Xx3:$i] : ((((ccfv @ (ccv @ Xx3) @ XN) = ccc0) <=> ((ccv @ Xx3) = Xc_0)) & ((ccfv @ (ccfv @ (ccv @ Xx3) @ XI) @ XN) = (ccfv @ (ccv @ Xx3) @ XN)) & (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XN) @ (cco @ (ccfv @ (ccv @ Xx3) @ XN) @ (ccfv @ (ccv @ Xy1) @ XN) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : XX)))) @ (^ [Xx3:$i] : XX)))))))))))))))))).
