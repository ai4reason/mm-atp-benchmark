...
thf(a_2503lem2_thm,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) = (cco @ cc1 @ XN @ ccmo))))).
thf(a_2503lem3_thm,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => ((cco @ (cco @ (cco @ cc2 @ (ccdc @ cc1 @ cc8) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) = cc1)))).
thf(c_2503prm_conj,conjecture,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => (cwcel @ XN @ ccprime)))).
