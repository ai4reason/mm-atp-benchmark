...
thf(aeldioph3b_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XN @ ccdioph)) <=> ((cwcel @ XN @ ccn0) & (cwrex @ (^ [Xp:$i] : (XA2 = (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ (ccv @ Xp)) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ ccn @ ccmap)))))) @ (^ [Xp:$i] : (ccfv @ ccn @ ccmzp)))))))).
...
thf(celdiophss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ ccdioph)) => (cwss @ XA2 @ (cco @ ccn0 @ (cco @ cc1 @ XB2 @ ccfz) @ ccmap)))))).
