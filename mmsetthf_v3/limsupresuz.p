...
thf(alimsupresico_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccr)) => ((XZ = (cco @ XM @ ccpnf @ ccico)) => ((Xph => (cwcel @ XF @ XV)) => (Xph => ((ccfv @ (ccres @ XF @ XZ) @ cclsp) = (ccfv @ XF @ cclsp)))))))))))).
...
thf(alimsupresre_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => (Xph => ((ccfv @ (ccres @ XF @ ccr) @ cclsp) = (ccfv @ XF @ cclsp)))))))).
thf(climsupresuz_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwss @ (ccdm @ (ccres @ XF @ ccr)) @ ccz)) => (Xph => ((ccfv @ (ccres @ XF @ XZ) @ cclsp) = (ccfv @ XF @ cclsp))))))))))))).
