...
thf(cfinminlem_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccfn)) => (? [Xx3:$i] : ((Xph @ Xx3) & (! [Xy1:$i] : (((cwss @ (ccv @ Xy1) @ (ccv @ Xx3)) & (Xps @ Xy1)) => ((ccv @ Xx3) = (ccv @ Xy1))))))))))).
