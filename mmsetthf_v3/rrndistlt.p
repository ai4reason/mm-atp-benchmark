...
thf(crrndistlt_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (XI != cc0)) => ((! [Xi:$i] : ((XN @ Xi) = (ccfv @ XI @ cchash))) => ((Xph => (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((Xph => (cwcel @ XY @ (cco @ ccr @ XI @ ccmap))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xi) @ XX) @ (ccfv @ (ccv @ Xi) @ XY) @ ccmin) @ ccabs) @ XE @ cclt))) => ((Xph => (cwcel @ XE @ ccrp)) => ((! [Xi:$i] : ((XD @ Xi) = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => (! [Xi:$i] : (Xph => (cwbr @ (cco @ XX @ XY @ (XD @ Xi)) @ (cco @ (ccfv @ (XN @ Xi) @ ccsqrt) @ XE @ ccmul) @ cclt))))))))))))))))))).
