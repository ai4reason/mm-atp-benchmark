...
thf(creusv2lem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (((cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xy1) @ XA2)) @ (^ [Xy1:$i] : XB2)) & (XB2 != cc0)) => ((cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XC @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)) <=> (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XC @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))).
