...
thf(afndmin_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) => ((ccdm @ (ccin @ XF @ XG)) = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(chausgraph_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XK @ ccha) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => (cwcel @ XF @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cccld))))))).
