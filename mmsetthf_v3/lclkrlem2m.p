...
thf(alflsub_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((XM = (ccfv @ XD @ ccsg)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((XF = (ccfv @ XW @ cclfn)) => (((cwcel @ XW @ cclmod) & (cwcel @ XG @ XF) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ (cco @ XX @ XY @ Xc_mi) @ XG) = (cco @ (ccfv @ XX @ XG) @ (ccfv @ XY @ XG) @ XM)))))))))))))))))).
...
thf(clclkrlem2m_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XU @ ccbs)) => ((Xc_x = (ccfv @ XU @ ccvsca)) => ((XS = (ccfv @ XU @ ccsca)) => ((Xc_xp = (ccfv @ XS @ ccmulr)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XI = (ccfv @ XS @ ccinvr)) => ((Xc_mi = (ccfv @ XU @ ccsg)) => ((XF = (ccfv @ XU @ cclfn)) => ((XD = (ccfv @ XU @ ccld)) => ((Xc_pl = (ccfv @ XD @ ccplusg)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XE @ XF)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XU @ cclvec)) => ((XB2 = (cco @ XX @ (cco @ (cco @ (ccfv @ XX @ (cco @ XE @ XG @ Xc_pl)) @ (ccfv @ (ccfv @ XY @ (cco @ XE @ XG @ Xc_pl)) @ XI) @ Xc_xp) @ XY @ Xc_x) @ Xc_mi)) => ((Xph => ((ccfv @ XY @ (cco @ XE @ XG @ Xc_pl)) != Xc_0)) => (Xph => ((cwcel @ XB2 @ XV) & ((ccfv @ XB2 @ (cco @ XE @ XG @ Xc_pl)) = Xc_0)))))))))))))))))))))))))))))))))))))).
