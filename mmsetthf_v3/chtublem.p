...
thf(advdsfac_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccn) & (cwcel @ XN @ (ccfv @ XK @ ccuz))) => (cwbr @ XK @ (ccfv @ XN @ ccfa) @ ccdvds))))).
...
thf(abinom11_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ cc2 @ XN @ ccexp) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ XN @ (ccv @ Xk) @ ccbc))))))).
