...
thf(cac5b_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwral @ (^ [Xx3:$i] : ((ccv @ Xx3) != cc0)) @ (^ [Xx3:$i] : XA2)) => (? [Xf1:$i] : ((cwf @ XA2 @ (ccuni @ XA2) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)))))))).
