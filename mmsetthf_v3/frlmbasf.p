...
thf(cfrlmbasf_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XN = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XF @ ccbs)) => (((cwcel @ XI @ XW) & (cwcel @ XX @ XB2)) => (cwf @ XI @ XN @ XX))))))))))))).
