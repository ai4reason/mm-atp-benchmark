...
thf(auntuni_thm,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccuni @ XA2))) <=> (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))).
...
thf(auntelirr_thm,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)) => (~ (cwcel @ XA2 @ XA2))))).
thf(cuntangtr_conj,conjecture,(! [XA2:($i > $o)] : ((cwtr @ XA2) => ((cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))).
