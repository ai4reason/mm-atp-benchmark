...
thf(ahomahom2_thm,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((XJ = (ccfv @ XC @ cchom)) => ((cwbr @ XZ @ XF @ (cco @ XX @ XY @ XH)) => (cwcel @ XF @ (cco @ XX @ XY @ XJ))))))))))))).
