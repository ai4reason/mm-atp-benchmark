...
thf(amsmet2_thm,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccfv @ XM @ ccds)) => ((cwcel @ XM @ ccmt) => (cwcel @ (ccres @ XD @ (ccxp @ XX @ XX)) @ (ccfv @ XX @ ccme))))))))).
...
thf(atngds_thm,axiom,(! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cwcel @ XN @ XV) => ((cccom @ XN @ Xc_mi) = (ccfv @ XT @ ccds))))))))))).
...
thf(atngtopn_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XD = (ccfv @ XT @ ccds)) => ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XG @ XV) & (cwcel @ XN @ XW)) => (XJ = (ccfv @ XT @ cctopn)))))))))))))).
thf(ccxme_tp,type,(ccxme : ($i > $o))).
thf(aisms2_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XK @ cctopn)) => ((XX = (ccfv @ XK @ ccbs)) => ((XD = (ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XX @ XX))) => ((cwcel @ XK @ ccmt) <=> ((cwcel @ XD @ (ccfv @ XX @ ccme)) & (XJ = (ccfv @ XD @ ccmopn)))))))))))).
...
thf(aisngp_thm,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => ((cwcel @ XG @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ ccmt) & (cwss @ (cccom @ XN @ Xc_mi) @ XD))))))))))).
thf(ctngngp2_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XX = (ccfv @ XG @ ccbs)) => ((XD = (ccfv @ XT @ ccds)) => ((cwf @ XX @ ccr @ XN) => ((cwcel @ XT @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XD @ (ccfv @ XX @ ccme)))))))))))))).
