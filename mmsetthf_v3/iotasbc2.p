...
thf(ciotasbc2_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (((cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) & (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))) => ((cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xz:$i] : (Xch @ Xx3 @ Xy1 @ Xz)) @ (ccio @ (^ [Xx3:$i] : (Xps @ Xx3))))) @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3)))) <=> (? [Xy1:$i] : (? [Xz:$i] : ((! [Xx3:$i] : ((Xph @ Xx3) <=> ((ccv @ Xx3) = (ccv @ Xy1)))) & (! [Xx3:$i] : ((Xps @ Xx3) <=> ((ccv @ Xx3) = (ccv @ Xz)))) & (Xch @ Xx3 @ Xy1 @ Xz))))))))))).
