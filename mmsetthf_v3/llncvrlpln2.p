...
thf(cllncvrlpln2_conj,conjecture,(! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XC = (ccfv @ XK @ cccvr)) => ((XN = (ccfv @ XK @ cclln)) => ((XP = (ccfv @ XK @ cclpl)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XN) & (cwcel @ XY @ XP)) & (cwbr @ XX @ XY @ Xc_le)) => (cwbr @ XX @ XY @ XC)))))))))))))).
