...
thf(ai1fmullem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => ((Xph & (cwcel @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccmul))) @ (ccsn @ XA2)) = (cciun @ (^ [Xy1:$i] : (ccdif @ (ccrn @ XG) @ (ccsn @ ccc0))) @ (^ [Xy1:$i] : (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XA2 @ (ccv @ Xy1) @ ccdiv))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xy1))))))))))))))).
...
thf(ai1fima2sn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XA2 @ (ccdif @ XB2 @ (ccsn @ ccc0)))) => (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ XA2)) @ ccvol) @ ccr)))))).
...
thf(ci1fmul_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (ccdm @ ccitg1))))))))).
