...
thf(celfm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XC) & (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) & (cwf @ XY @ XX @ XF)) => ((cwcel @ XA2 @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))) <=> ((cwss @ XA2 @ XX) & (cwrex @ (^ [Xx3:$i] : (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : XB2)))))))))))).
