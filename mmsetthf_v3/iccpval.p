...
thf(ciccpval_conj,conjecture,(! [XM:($i > $o)] : ((cwcel @ XM @ ccn) => ((ccfv @ XM @ cciccp) = (ccrab @ (^ [Xp:$i] : (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)))) @ (^ [Xp:$i] : (cco @ ccxr @ (cco @ ccc0 @ XM @ ccfz) @ ccmap))))))).
