...
thf(cmsrval_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XT @ ccmvrs)) => ((XP = (ccfv @ XT @ ccmpst)) => ((XR = (ccfv @ XT @ ccmsr)) => ((XZ = (ccuni @ (ccima @ XV @ (ccun @ XH @ (ccsn @ XA2))))) => ((cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) => ((ccfv @ (ccotp @ XD @ XH @ XA2) @ XR) = (ccotp @ (ccin @ XD @ (ccxp @ XZ @ XZ)) @ XH @ XA2)))))))))))))))).
