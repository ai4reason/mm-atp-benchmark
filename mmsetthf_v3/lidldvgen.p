...
thf(clidldvgen_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ cclidl)) => ((XK = (ccfv @ XR @ ccrsp)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU) & (cwcel @ XG @ XB2)) => ((XI = (ccfv @ (ccsn @ XG) @ XK)) <=> ((cwcel @ XG @ XI) & (cwral @ (^ [Xx3:$i] : (cwbr @ XG @ (ccv @ Xx3) @ Xc_pa)) @ (^ [Xx3:$i] : XI))))))))))))))))).
