...
thf(cbj_ldiv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (XB2 != ccc0)) => (Xph => (((cco @ XA2 @ XB2 @ ccmul) = XC) <=> (XA2 = (cco @ XC @ XB2 @ ccdiv))))))))))))).
