...
thf(cflimss2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwss @ XG @ XF)) => (cwss @ (cco @ XJ @ XG @ ccflim) @ (cco @ XJ @ XF @ ccflim)))))))).
