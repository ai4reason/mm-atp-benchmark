...
thf(acnre2csqlem_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((ccres @ (XG @ Xy1) @ (ccxp @ ccr @ ccr)) = (cccom @ XH @ XF))) => ((cwfn @ XF @ (ccxp @ ccr @ ccr)) => ((! [Xy1:$i] : (cwfn @ (XG @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccxp @ ccr @ ccr)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (XG @ Xy1)) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccrn @ XF)) & (cwcel @ (ccv @ Xy1) @ (ccrn @ XF))) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ XH) = (cco @ (ccfv @ (ccv @ Xx3) @ XH) @ (ccfv @ (ccv @ Xy1) @ XH) @ ccmin))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XX @ (ccxp @ ccr @ ccr)) & (cwcel @ XY @ (ccxp @ ccr @ ccr)) & (cwcel @ (XD @ Xx3 @ Xy1) @ ccrp)) => ((cwcel @ XY @ (ccima @ (cccnv @ (ccres @ (XG @ Xy1) @ (ccxp @ ccr @ ccr))) @ (cco @ (cco @ (ccfv @ XX @ (XG @ Xy1)) @ (XD @ Xx3 @ Xy1) @ ccmin) @ (cco @ (ccfv @ XX @ (XG @ Xy1)) @ (XD @ Xx3 @ Xy1) @ ccaddc) @ ccioo))) => (cwbr @ (ccfv @ (ccfv @ (cco @ (ccfv @ XY @ XF) @ (ccfv @ XX @ XF) @ ccmin) @ XH) @ ccabs) @ (XD @ Xx3 @ Xy1) @ cclt))))))))))))))))).
...
thf(afmpt2co_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xz) & ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xz)))) => (cwcel @ (XR @ Xx3 @ Xy1) @ XC))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => ((XF @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XR @ Xx3 @ Xy1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => ((XG @ Xx3 @ Xy1 @ Xz) = (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (XS @ Xz)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (XR @ Xx3 @ Xy1)) => ((XS @ Xz) = (XT @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => ((cccom @ (XG @ Xx3 @ Xy1 @ Xz) @ (XF @ Xx3 @ Xy1 @ Xz)) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XT @ Xx3 @ Xy1))))))))))))))))))))))).
...
thf(adf1stres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccres @ cc1st @ (ccxp @ XA2 @ XB2)) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xx3)))))))).
...
thf(adf2ndres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccres @ cc2nd @ (ccxp @ XA2 @ XB2)) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xy1)))))))).
