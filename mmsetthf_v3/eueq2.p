...
thf(aeuorv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (((~ Xph) & (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))) => (cweu @ (^ [Xx3:$i] : (Xph | (Xps @ Xx3)))))))).
...
thf(ceueq2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cweu @ (^ [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) | ((~ Xph) & ((ccv @ Xx3) = XB2))))))))))).
