...
thf(cssfzunsn_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwss @ XS @ (cco @ XM @ XN @ ccfz)) & (cwcel @ XN @ ccz) & (cwcel @ XI @ (ccfv @ XM @ ccuz))) => (cwss @ (ccun @ XS @ (ccsn @ XI)) @ (cco @ XM @ (ccif @ (cwbr @ XI @ XN @ ccle) @ XN @ XI) @ ccfz)))))))).
