...
thf(cismaxidl_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xj:$i] : ((XG @ Xj) = (ccfv @ XR @ cc1st))) => ((! [Xj:$i] : ((XX @ Xj) = (ccrn @ (XG @ Xj)))) => (! [Xj:$i] : ((cwcel @ XR @ ccrngo) => ((cwcel @ XM @ (ccfv @ XR @ ccmaxidl)) <=> ((cwcel @ XM @ (ccfv @ XR @ ccidl)) & (XM != (XX @ Xj)) & (cwral @ (^ [Xj:$i] : ((cwss @ XM @ (ccv @ Xj)) => (((ccv @ Xj) = XM) | ((ccv @ Xj) = (XX @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl)))))))))))))).
