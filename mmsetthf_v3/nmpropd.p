...
thf(cnmpropd_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => ((ccfv @ XK @ ccbs) = (ccfv @ XL @ ccbs))) => ((Xph => ((ccfv @ XK @ ccplusg) = (ccfv @ XL @ ccplusg))) => ((Xph => ((ccfv @ XK @ ccds) = (ccfv @ XL @ ccds))) => (Xph => ((ccfv @ XK @ ccnm) = (ccfv @ XL @ ccnm)))))))))).
