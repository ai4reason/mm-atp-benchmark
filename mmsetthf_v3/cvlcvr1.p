...
thf(acvrval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_lt:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xz:$i] : ((Xc_le @ Xz) = (ccfv @ XK @ ccple))) => ((! [Xz:$i] : ((Xc_lt @ Xz) = (ccfv @ XK @ ccplt))) => ((! [Xz:$i] : ((XC @ Xz) = (ccfv @ XK @ cccvr))) => (! [Xz:$i] : (((cwcel @ XK @ XA2) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ (XC @ Xz)) <=> ((cwbr @ XX @ XY @ (Xc_lt @ Xz)) & (cwral @ (^ [Xz:$i] : (((cwbr @ XX @ (ccv @ Xz) @ (Xc_lt @ Xz)) & (cwbr @ (ccv @ Xz) @ XY @ (Xc_le @ Xz))) => ((ccv @ Xz) = XY))) @ (^ [Xz:$i] : XB2))))))))))))))))))).
...
thf(ccvlcvr1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ ccoml) & (cwcel @ XK @ cccla) & (cwcel @ XK @ cclc)) & (cwcel @ XX @ XB2) & (cwcel @ XP @ XA2)) => ((~ (cwbr @ XP @ XX @ Xc_le)) <=> (cwbr @ XX @ (cco @ XX @ XP @ Xc_or) @ XC))))))))))))))))).
