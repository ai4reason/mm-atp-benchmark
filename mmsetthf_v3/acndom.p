...
thf(aacneq_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XC) => ((cwacn @ XA2) = (cwacn @ XC)))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(ccom_tp,type,(ccom : ($i > $o))).
thf(a_0fin_thm,axiom,(cwcel @ cc0 @ ccfn)).
thf(afinacn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => ((cwacn @ XA2) = ccvv)))).
thf(cacndom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => ((cwcel @ XX @ (cwacn @ XB2)) => (cwcel @ XX @ (cwacn @ XA2)))))))).
