...
thf(cwlkonwlk1l_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) => (Xph => (cwbr @ XF @ XP @ (cco @ (ccfv @ ccc0 @ XP) @ (ccfv @ XP @ cclsw) @ (ccfv @ XG @ ccwlkson)))))))))).
