...
thf(afsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwf @ (ccsn @ XA2) @ (ccsn @ XB2) @ XF) <=> (XF = (ccsn @ (ccop @ XA2 @ XB2)))))))))).
...
thf(caxlowdimlem7_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) => (cwcel @ XP @ (ccfv @ XN @ ccee))))))).
