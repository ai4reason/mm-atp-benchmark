...
thf(csqrtpwpw2p_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XM @ ccn0) & (cwbr @ XM @ (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccaddc) @ cclt)) => ((ccfv @ (ccfv @ (cco @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp) @ XM @ ccaddc) @ ccsqrt) @ ccfl) = (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccexp)))))).
