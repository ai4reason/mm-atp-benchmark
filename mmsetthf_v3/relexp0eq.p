...
thf(crelexp0eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV)) => (((ccun @ (ccdm @ XA2) @ (ccrn @ XA2)) = (ccun @ (ccdm @ XB2) @ (ccrn @ XB2))) <=> ((cco @ XA2 @ ccc0 @ ccrelexp) = (cco @ XB2 @ ccc0 @ ccrelexp))))))))).
