...
thf(cnbuhgr2vtx1edgblem_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccuhgr) & (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) & (cwcel @ (ccv @ Xa) @ (cco @ XG @ (ccv @ Xb) @ ccnbgr))) => (cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ XE)))))))))).
