...
thf(alsmdisj3_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xph => (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => ((ccin @ (cco @ XS @ XT @ Xc_po) @ XU) = (ccsn @ Xc_0))) => ((Xph => ((ccin @ XS @ XT) = (ccsn @ Xc_0))) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xph => (cwss @ XS @ (ccfv @ XT @ XZ))) => (Xph => ((ccin @ XS @ (cco @ XT @ XU @ Xc_po)) = (ccsn @ Xc_0))))))))))))))))))))).
...
thf(afuniunfv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) = (ccuni @ (ccima @ XF @ XA2))))))).
...
thf(cdmdprdsplit2lem_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XI = (ccun @ XC @ XD))) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwbr @ XG @ (ccres @ XS @ XC) @ (ccdm @ ccdprd))) => ((Xph => (cwbr @ XG @ (ccres @ XS @ XD) @ (ccdm @ ccdprd))) => ((Xph => (cwss @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (ccfv @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd) @ XZ))) => ((Xph => ((ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) = (ccsn @ Xc_0))) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((Xph & (cwcel @ XX @ XC)) => (((cwcel @ XY @ XI) => ((XX != XY) => (cwss @ (ccfv @ XX @ XS) @ (ccfv @ (ccfv @ XY @ XS) @ XZ)))) & (cwss @ (ccin @ (ccfv @ XX @ XS) @ (ccfv @ (ccuni @ (ccima @ XS @ (ccdif @ XI @ (ccsn @ XX)))) @ XK)) @ (ccsn @ Xc_0)))))))))))))))))))))))))).
