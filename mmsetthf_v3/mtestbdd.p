...
thf(aclimbdd_thm,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => (((cwcel @ XM @ ccz) & (cwcel @ XF @ (ccdm @ ccli)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc)) @ (^ [Xk:$i] : XZ))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(aulmbdd_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (XZ = (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XM @ Xx3) @ ccz))) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XS))) @ (^ [Xx3:$i] : ccr)))) => ((Xph => (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XG) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XS))) @ (^ [Xx3:$i] : ccr))))))))))))))).
...
thf(cmtestbdd_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ ccuz)) => ((Xph => (cwcel @ XN @ ccz)) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (Xph => (cwcel @ XS @ (XV @ Xx3 @ Xz @ Xk)))))) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (Xph => (cwcel @ XM @ (XW @ Xx3 @ Xz @ Xk)))))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XM) @ ccr))) => ((! [Xz:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xk) @ XZ) & (cwcel @ (ccv @ Xz) @ XS))) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)) @ ccabs) @ (ccfv @ (ccv @ Xk) @ XM) @ ccle)))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XM @ XN) @ (ccdm @ ccli))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccseq @ (ccof @ ccaddc) @ XF @ XN) @ (XT @ Xk) @ (ccfv @ XS @ cculm)))) => (! [Xk:$i] : (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ (XT @ Xk)) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XS))) @ (^ [Xx3:$i] : ccr))))))))))))))))))))))).
