...
thf(aelex22_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XB2) & (cwcel @ XA2 @ XC)) => (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xx3) @ XC)))))))).
thf(cen3lplem1VD_conj,conjecture,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XB2) & (cwcel @ XB2 @ XC) & (cwcel @ XC @ XA2)) => (((ccv @ Xx3) = XA2) => (? [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))))).
