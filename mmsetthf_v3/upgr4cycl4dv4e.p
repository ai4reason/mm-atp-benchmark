...
thf(apthdivtx_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & ((cwcel @ XI @ (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo)) & (cwcel @ XJ @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz)) & (XI != XJ))) => ((ccfv @ XI @ XP) != (ccfv @ XJ @ XP))))))))).
