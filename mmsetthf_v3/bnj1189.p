...
thf(abnj1190_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) <=> ((cw_bnj15 @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ XR) & (cwss @ XB2 @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw)) & (XB2 != cc0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xps @ Xx3 @ Xy1 @ Xz @ Xw) <=> ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((Xph @ Xx3 @ Xy1 @ Xz @ Xw) & (Xps @ Xx3 @ Xy1 @ Xz @ Xw)) => (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xz:$i] : (~ (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ XR))) @ (^ [Xz:$i] : XB2))) @ (^ [Xw:$i] : XB2))))))))))))))).
...
thf(cbnj1189_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph <=> ((cw_bnj15 @ (XA2 @ Xx3 @ Xy1) @ XR) & (cwss @ XB2 @ (XA2 @ Xx3 @ Xy1)) & (XB2 != cc0))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xps @ Xx3 @ Xy1) <=> ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xch @ Xx3 @ Xy1) <=> (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))).
