...
thf(atgbtwnconn1lem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (XA2 != XB2)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XD @ XI))) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((Xph => (cwcel @ XE @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XH @ XP)) => ((Xph => (cwcel @ XJ @ XP)) => ((Xph => (cwcel @ XD @ (cco @ XA2 @ XE @ XI))) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XF @ XI))) => ((Xph => (cwcel @ XE @ (cco @ XA2 @ XH @ XI))) => ((Xph => (cwcel @ XF @ (cco @ XA2 @ XJ @ XI))) => ((Xph => ((cco @ XE @ XD @ Xc_mi) = (cco @ XC @ XD @ Xc_mi))) => ((Xph => ((cco @ XC @ XF @ Xc_mi) = (cco @ XC @ XD @ Xc_mi))) => ((Xph => ((cco @ XE @ XH @ Xc_mi) = (cco @ XB2 @ XC @ Xc_mi))) => ((Xph => ((cco @ XF @ XJ @ Xc_mi) = (cco @ XB2 @ XD @ Xc_mi))) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XX @ (cco @ XC @ XE @ XI))) => ((Xph => (cwcel @ XX @ (cco @ XD @ XF @ XI))) => ((Xph => (XC != XE)) => (Xph => (XD = XF)))))))))))))))))))))))))))))))))))))))))))).
