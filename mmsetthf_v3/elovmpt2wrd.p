...
thf(aelovmpt2rab1_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xm:$i] : ((XO @ Xx3 @ Xy1 @ Xz @ Xm) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xm)) @ (^ [Xz:$i] : (ccsb @ (ccv @ Xx3) @ (^ [Xm:$i] : (XM @ Xm))))))))))))) => ((! [Xm:$i] : (((cwcel @ (XX @ Xm) @ ccvv) & (cwcel @ (XY @ Xm) @ ccvv)) => (cwcel @ (ccsb @ (XX @ Xm) @ (^ [Xm:$i] : (XM @ Xm))) @ ccvv))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xm:$i] : ((cwcel @ (XZ @ Xx3 @ Xy1 @ Xm) @ (cco @ (XX @ Xm) @ (XY @ Xm) @ (XO @ Xx3 @ Xy1 @ Xz @ Xm))) => ((cwcel @ (XX @ Xm) @ ccvv) & (cwcel @ (XY @ Xm) @ ccvv) & (cwcel @ (XZ @ Xx3 @ Xy1 @ Xm) @ (ccsb @ (XX @ Xm) @ (^ [Xm:$i] : (XM @ Xm))))))))))))))))))).
