...
thf(abinomfallfaclem2_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : ((Xps @ Xk) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccfallfac) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul)))))) => (! [Xk:$i] : ((Xph & (Xps @ Xk)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) = (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul)))))))))))))))).
thf(asimprl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xps))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(aid_thm,axiom,(! [Xph:$o] : (Xph => Xph))).
thf(cbinomfallfac_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccfallfac) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul))))))))).
