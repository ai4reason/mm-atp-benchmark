...
thf(arepr0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => (Xph => ((cco @ XA2 @ XM @ (ccfv @ ccc0 @ ccrepr)) = (ccif @ (XM = ccc0) @ (ccsn @ cc0) @ cc0))))))))))).
...
thf(cbreprexp_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XZ @ ccc)) => ((Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (Xph => ((ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xb) @ (ccfv @ (ccv @ Xa) @ XL)) @ (cco @ XZ @ (ccv @ Xb) @ ccexp) @ ccmul))))) = (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (cco @ XZ @ (ccv @ Xm) @ ccexp) @ ccmul))))))))))))))))).
