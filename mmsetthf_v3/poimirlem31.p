...
thf(cpoimirlem31_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [Xr:$i] : ((! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xf1 @ Xa @ Xb) => (cwcel @ XN @ ccn))))) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xf1 @ Xa @ Xb) => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn)))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & ((cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) & (cwcel @ (ccv @ Xz) @ XI) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = ccc0))) => (cwbr @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccc0 @ ccle))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((XP @ Xj @ Xk) = (cco @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))))) => ((! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xf1 @ Xa @ Xb) => (cwf @ ccn @ (ccxp @ (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))) @ XG))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & (cwcel @ (ccv @ Xk) @ ccn)) => (cwss @ (ccrn @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc1st)) @ (cco @ ccc0 @ (ccv @ Xk) @ ccfzo))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & ((cwcel @ (ccv @ Xk) @ ccn) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XN @ ccfz)))) => (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsup @ (ccun @ (ccsn @ ccc0) @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xb) @ (ccfv @ (cco @ (XP @ Xj @ Xk) @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccv @ Xk))) @ (ccof @ ccdiv)) @ XF)) @ ccle) & ((ccfv @ (ccv @ Xb) @ (XP @ Xj @ Xk)) != ccc0))) @ (^ [Xb:$i] : (cco @ cc1 @ (ccv @ Xa) @ ccfz)))) @ (^ [Xa:$i] : (cco @ cc1 @ XN @ ccfz)))) @ ccr @ cclt))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz))))))))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & ((cwcel @ (ccv @ Xk) @ ccn) & (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) & (cwcel @ (ccv @ Xr) @ (ccpr @ ccle @ (cccnv @ ccle))))) => (cwrex @ (^ [Xj:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ (XP @ Xj @ Xk) @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccv @ Xk))) @ (ccof @ ccdiv)) @ XF)) @ (ccv @ Xr))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))))))))))))))))))).
