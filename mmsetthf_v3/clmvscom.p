...
thf(cclmvscom_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & ((cwcel @ XQ @ XK) & (cwcel @ XR @ XK) & (cwcel @ XX @ XV))) => ((cco @ XQ @ (cco @ XR @ XX @ Xc_x) @ Xc_x) = (cco @ XR @ (cco @ XQ @ XX @ Xc_x) @ Xc_x)))))))))))))))).
