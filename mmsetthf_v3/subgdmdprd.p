...
thf(admdprd_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XZ @ Xx3 @ Xy1) = (ccfv @ XG @ cccntz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ XG @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)))) => (! [Xy1:$i] : (((cwcel @ XI @ XV) & ((ccdm @ XS) = XI)) => ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) <=> ((cwcel @ XG @ ccgrp) & (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS) & (cwral @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XS) @ (XZ @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : (ccdif @ XI @ (ccsn @ (ccv @ Xx3))))) & ((ccin @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccuni @ (ccima @ XS @ (ccdif @ XI @ (ccsn @ (ccv @ Xx3))))) @ (XK @ Xx3 @ Xy1))) = (ccsn @ (Xc_0 @ Xx3 @ Xy1))))) @ (^ [Xx3:$i] : XI))))))))))))))))).
...
thf(csubgdmdprd_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XG @ ccsubg)) => ((cwbr @ XH @ XS @ (ccdm @ ccdprd)) <=> ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) & (cwss @ (ccrn @ XS) @ (ccpw @ XA2))))))))))).
