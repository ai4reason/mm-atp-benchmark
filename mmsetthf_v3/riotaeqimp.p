...
thf(criotaeqimp_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccrio @ (^ [Xa:$i] : (XX = (XA2 @ Xa))) @ (^ [Xa:$i] : XV))) => ((XJ = (ccrio @ (^ [Xa:$i] : (XY = (XA2 @ Xa))) @ (^ [Xa:$i] : XV))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwreu @ (^ [Xa:$i] : (XX = (XA2 @ Xa))) @ (^ [Xa:$i] : XV)))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwreu @ (^ [Xa:$i] : (XY = (XA2 @ Xa))) @ (^ [Xa:$i] : XV)))) => (! [Xa:$i] : (((Xph @ Xa) & (XI = XJ)) => (XX = XY))))))))))))))).
