...
thf(cminmar1eval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XQ = (cco @ XN @ XR @ ccminmar1)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XM @ XB2) & ((cwcel @ XK @ XN) & (cwcel @ XL @ XN)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XK @ XL @ (ccfv @ XM @ XQ))) = (ccif @ (XI = XK) @ (ccif @ (XJ = XL) @ Xc_1 @ Xc_0) @ (cco @ XI @ XJ @ XM)))))))))))))))))))))).
