...
thf(cindfval_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XO @ XV) & (cwss @ XA2 @ XO) & (cwcel @ XX @ XO)) => ((ccfv @ XX @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) = (ccif @ (cwcel @ XX @ XA2) @ cc1 @ ccc0)))))))).
