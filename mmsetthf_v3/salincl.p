...
thf(asaluncl_thm,axiom,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ ccsalg) & (cwcel @ XE @ XS) & (cwcel @ XF @ XS)) => (cwcel @ (ccun @ XE @ XF) @ XS)))))).
thf(csalincl_conj,conjecture,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ ccsalg) & (cwcel @ XE @ XS) & (cwcel @ XF @ XS)) => (cwcel @ (ccin @ XE @ XF) @ XS)))))).
