...
thf(aovolficcss_thm,axiom,(! [XF:($i > $o)] : ((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) => (cwss @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF))) @ ccr)))).
...
thf(aeluzsub_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XK @ ccz) & (cwcel @ XN @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz))) => (cwcel @ (cco @ XN @ XK @ ccmin) @ (ccfv @ XM @ ccuz))))))).
...
thf(aovolfsval_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => (((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) & (cwcel @ XN @ ccn)) => ((ccfv @ XN @ XG) = (cco @ (ccfv @ (ccfv @ XN @ XF) @ cc2nd) @ (ccfv @ (ccfv @ XN @ XF) @ cc1st) @ ccmin)))))))).
