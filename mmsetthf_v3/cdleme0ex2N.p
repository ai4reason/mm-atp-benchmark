...
thf(acdleme0ex1N_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xu:$i] : (Xc_le = (ccfv @ (XK @ Xu) @ ccple))) => ((! [Xu:$i] : (Xc_or = (ccfv @ (XK @ Xu) @ ccjn))) => ((! [Xu:$i] : ((Xc_an @ Xu) = (ccfv @ (XK @ Xu) @ ccmee))) => ((! [Xu:$i] : (XA2 = (ccfv @ (XK @ Xu) @ ccatm))) => ((! [Xu:$i] : ((XH @ Xu) = (ccfv @ (XK @ Xu) @ cclh))) => ((! [Xu:$i] : (XU = (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ (Xc_an @ Xu)))) => (! [Xu:$i] : ((((cwcel @ (XK @ Xu) @ cchlt) & (cwcel @ XW @ (XH @ Xu))) & (((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & (cwcel @ XQ @ XA2)) & (XP != XQ)) => (cwrex @ (^ [Xu:$i] : ((cwbr @ (ccv @ Xu) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) & (cwbr @ (ccv @ Xu) @ XW @ Xc_le))) @ (^ [Xu:$i] : XA2))))))))))))))))))))).
...
thf(ccdleme0ex2N_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((! [Xu:$i] : ((Xc_an @ Xu) = (ccfv @ XK @ ccmee))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xu:$i] : (XU = (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ (Xc_an @ Xu)))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) & (XP != XQ)) => (cwrex @ (^ [Xu:$i] : (((cco @ XP @ (ccv @ Xu) @ Xc_or) = (cco @ XQ @ (ccv @ Xu) @ Xc_or)) & (cwbr @ (ccv @ Xu) @ XW @ Xc_le))) @ (^ [Xu:$i] : XA2)))))))))))))))))))).
