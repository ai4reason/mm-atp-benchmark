...
thf(aiblabsnc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccabs))) @ ccmbf)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccabs))) @ ccibl)))))))))).
...
thf(aftc1anclem1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwcel @ XF @ ccmbf)) => (cwcel @ (cccom @ ccabs @ XF) @ ccmbf))))).
...
thf(cftc1anclem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf @ XA2 @ ccc @ XF) & (cwcel @ XF @ ccibl) & (cwcel @ XG @ (ccpr @ ccre @ ccim))) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccif @ (cwcel @ (ccv @ Xt) @ XA2) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ XF) @ XG) @ ccabs) @ ccc0))) @ ccitg2) @ ccr)))))).
