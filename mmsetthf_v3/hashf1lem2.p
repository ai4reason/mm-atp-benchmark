...
thf(amapvalg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xf1:$i] : (((cwcel @ XA2 @ (XC @ Xf1)) & (cwcel @ XB2 @ (XD @ Xf1))) => ((cco @ XA2 @ XB2 @ ccmap) = (^ [Xf1:$i] : (cwf @ XB2 @ XA2 @ (ccv @ Xf1))))))))))).
