...
thf(aprmreclem5_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((XF = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => ((Xph => (cwcel @ XK @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((XM = (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xp:$i] : (~ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xp:$i] : (ccdif @ ccprime @ (cco @ cc1 @ XK @ ccfz))))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli))) => ((Xph => (cwbr @ (ccsu @ (ccfv @ (cco @ XK @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccc0))) @ (cco @ cc1 @ cc2 @ ccdiv) @ cclt)) => ((! [Xn:$i] : (! [Xp:$i] : ((XW @ Xn @ Xp) = (ccmpt @ (^ [Xp:$i] : ccn) @ (^ [Xp:$i] : (ccrab @ (^ [Xn:$i] : ((cwcel @ (ccv @ Xp) @ ccprime) & (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))))))) => (Xph => (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ (cco @ (cco @ cc2 @ XK @ ccexp) @ (ccfv @ XN @ ccsqrt) @ ccmul) @ cclt)))))))))))))))).
