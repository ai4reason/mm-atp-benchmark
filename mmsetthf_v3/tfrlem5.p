...
thf(atfrlem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccon0))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((cwfun @ XF) & (cwss @ XA2 @ (ccdm @ XF))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((cwfun @ XG) & (cwss @ XA2 @ (ccdm @ XG))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ XB2))) @ (^ [Xx3:$i] : XA2)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XG) = (ccfv @ (ccres @ XG @ (ccv @ Xx3)) @ XB2))) @ (^ [Xx3:$i] : XA2)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2))))))))))))))).
...
thf(ctfrlem5_conj,conjecture,(! [Xv:$i] : (! [Xu:$i] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XA2 @ Xx3 @ Xy1 @ Xf1) = (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((cwcel @ (ccv @ Xg1) @ (XA2 @ Xx3 @ Xy1 @ Xf1)) & (cwcel @ (ccv @ Xh) @ (XA2 @ Xx3 @ Xy1 @ Xf1))) => (((cwbr @ (ccv @ Xx3) @ (ccv @ Xu) @ (ccv @ Xg1)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccv @ Xh))) => ((ccv @ Xu) = (ccv @ Xv))))))))))))))).
