...
thf(cfuncnvs4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & ((cwcel @ XC @ XV) & (cwcel @ XD @ XV))) & (((XA2 != XB2) & (XA2 != XC) & (XA2 != XD)) & ((XB2 != XC) & (XB2 != XD)) & (XC != XD))) => (cwfun @ (cccnv @ (ccs4 @ XA2 @ XB2 @ XC @ XD)))))))))).
