...
thf(citg2cn_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xd:$i] : ((Xph @ Xd) => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xd:$i] : ((Xph @ Xd) => (cwcel @ XF @ ccmbf))) => ((! [Xd:$i] : ((Xph @ Xd) => (cwcel @ (ccfv @ XF @ ccitg2) @ ccr))) => ((! [Xd:$i] : ((Xph @ Xd) => (cwcel @ XC @ ccrp))) => (! [Xd:$i] : ((Xph @ Xd) => (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xu:$i] : ((cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (ccv @ Xd) @ cclt) => (cwbr @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2) @ XC @ cclt))) @ (^ [Xu:$i] : (ccdm @ ccvol)))) @ (^ [Xd:$i] : ccrp)))))))))))).
