...
thf(am1expcl_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwcel @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ ccz)))).
...
thf(aoexpneg_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn) & (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((cco @ (ccneg @ XA2) @ XN @ ccexp) = (ccneg @ (cco @ XA2 @ XN @ ccexp))))))).
...
thf(algseisenlem3_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (XP != XQ)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xx3 @ Xy1) = (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ XP @ ccmo)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XM @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XR @ Xx3 @ Xy1) @ ccexp) @ (XR @ Xx3 @ Xy1) @ ccmul) @ XP @ ccmo) @ cc2 @ ccdiv)))))) => ((! [Xy1:$i] : ((XS @ Xy1) = (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xy1) @ ccmul) @ ccmul) @ XP @ ccmo))) => ((! [Xy1:$i] : ((XY @ Xy1) = (ccfv @ XP @ cczn))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccfv @ (XY @ Xy1) @ ccmgp))) => ((! [Xy1:$i] : ((XL @ Xy1) = (ccfv @ (XY @ Xy1) @ cczrh))) => (! [Xy1:$i] : (Xph => ((cco @ (XG @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ (ccneg @ cc1) @ (XR @ Xx3 @ Xy1) @ ccexp) @ XQ @ ccmul) @ (XL @ Xy1)))) @ ccgsu) = (ccfv @ (XY @ Xy1) @ ccur))))))))))))))))))))))).
...
thf(agsumsubm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XS @ (ccfv @ XG @ ccsubmnd))) => ((Xph => (cwf @ XA2 @ XS @ XF)) => ((XH = (cco @ XG @ XS @ ccress)) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ XH @ XF @ ccgsu))))))))))))))).
thf(asubrgsubg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => (cwcel @ XA2 @ (ccfv @ XR @ ccsubg)))))).
thf(ccminusg_tp,type,(ccminusg : ($i > $o))).
thf(asubgsubm_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) => (cwcel @ XS @ (ccfv @ XG @ ccsubmnd)))))).
...
thf(clgseisenlem4_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (XP != XQ)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xx3 @ Xy1) = (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ XP @ ccmo)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XM @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XR @ Xx3 @ Xy1) @ ccexp) @ (XR @ Xx3 @ Xy1) @ ccmul) @ XP @ ccmo) @ cc2 @ ccdiv)))))) => ((! [Xy1:$i] : ((XS @ Xy1) = (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xy1) @ ccmul) @ ccmul) @ XP @ ccmo))) => ((! [Xy1:$i] : ((XY @ Xy1) = (ccfv @ XP @ cczn))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccfv @ (XY @ Xy1) @ ccmgp))) => ((! [Xy1:$i] : ((XL @ Xy1) = (ccfv @ (XY @ Xy1) @ cczrh))) => (Xph => ((cco @ (cco @ XQ @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) = (cco @ (cco @ (ccneg @ cc1) @ (ccsu @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ XQ @ XP @ ccdiv) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ ccfl))) @ ccexp) @ XP @ ccmo)))))))))))))))))))))).
