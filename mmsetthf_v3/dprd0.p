...
thf(adprdz_thm,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XI @ XV)) => ((cwbr @ XG @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccsn @ Xc_0))) @ (ccdm @ ccdprd)) & ((cco @ XG @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccsn @ Xc_0))) @ ccdprd) = (ccsn @ Xc_0)))))))))).
...
thf(cdprd0_conj,conjecture,(! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XG @ ccgrp) => ((cwbr @ XG @ cc0 @ (ccdm @ ccdprd)) & ((cco @ XG @ cc0 @ ccdprd) = (ccsn @ Xc_0)))))))).
