...
thf(ctan2h_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccico)) => ((ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ cctan) = (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccmin) @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccaddc) @ ccdiv) @ ccsqrt))))).
