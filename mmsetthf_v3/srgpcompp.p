...
thf(csrgpcompp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XR @ ccbs)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((XG = (ccfv @ XR @ ccmgp)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ ccsrg)) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => ((Xph => (cwcel @ XK @ ccn0)) => ((Xph => ((cco @ XA2 @ XB2 @ Xc_xp) = (cco @ XB2 @ XA2 @ Xc_xp))) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (cco @ (cco @ XN @ XA2 @ Xc_ex) @ (cco @ XK @ XB2 @ Xc_ex) @ Xc_xp) @ XA2 @ Xc_xp) = (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XA2 @ Xc_ex) @ (cco @ XK @ XB2 @ Xc_ex) @ Xc_xp)))))))))))))))))))))))).
