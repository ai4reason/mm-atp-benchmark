...
thf(cncvr1_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ ccops) & (cwcel @ XX @ XB2)) => (~ (cwbr @ Xc_1 @ XX @ XC)))))))))))).
