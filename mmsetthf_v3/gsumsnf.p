...
thf(cgsumsnf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XC @ Xk))) => ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = (XC @ Xk)))) => (! [Xk:$i] : (((cwcel @ XG @ ccmnd) & (cwcel @ XM @ XV) & (cwcel @ (XC @ Xk) @ XB2)) => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccgsu) = (XC @ Xk)))))))))))))).
