...
thf(cdivdiv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((cwcel @ XB2 @ ccc) & (XB2 != ccc0)) & ((cwcel @ XC @ ccc) & (XC != ccc0))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccdiv) @ ccdiv) = (cco @ (cco @ XA2 @ XC @ ccmul) @ XB2 @ ccdiv))))))).
