...
thf(atmdgsum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ cccmn) & (cwcel @ XG @ cctmd) & (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ XA2 @ ccmap)) @ (^ [Xx3:$i] : (cco @ XG @ (ccv @ Xx3) @ ccgsu))) @ (cco @ (cco @ XJ @ (ccpw @ XA2) @ ccxko) @ XJ @ cccn)))))))))).
...
thf(axkopt_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ cctop) & (cwcel @ XA2 @ XV)) => ((cco @ XR @ (ccpw @ XA2) @ ccxko) = (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt))))))).
...
thf(arexab2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xy1)))) <=> (? [Xy1:$i] : ((Xph @ Xy1) & (Xch @ Xy1))))))))).
