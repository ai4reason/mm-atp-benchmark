...
thf(cintfrac2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XA2 @ ccfl)) => ((XF = (cco @ XA2 @ XZ @ ccmin)) => ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XF @ ccle) & (cwbr @ XF @ cc1 @ cclt) & (XA2 = (cco @ XZ @ XF @ ccaddc)))))))))).
