...
thf(celioc2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc)) <=> ((cwcel @ XC @ ccr) & (cwbr @ XA2 @ XC @ cclt) & (cwbr @ XC @ XB2 @ ccle)))))))).
