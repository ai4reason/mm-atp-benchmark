...
thf(awlklnwwlkln2_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XG @ ccuspgr) => ((cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn)) => (? [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = XN))))))))).
