...
thf(apsrvscacl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((Xc_x = (ccfv @ XS @ ccvsca)) => ((XK = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XK)) => ((Xph => (cwcel @ XF @ XB2)) => (Xph => (cwcel @ (cco @ XX @ XF @ Xc_x) @ XB2))))))))))))))))))).
thf(apsrvsca_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : ((XS @ Xh) = (cco @ XI @ (XR @ Xh) @ ccmps))) => ((! [Xh:$i] : ((Xc_xb @ Xh) = (ccfv @ (XS @ Xh) @ ccvsca))) => ((! [Xh:$i] : ((XK @ Xh) = (ccfv @ (XR @ Xh) @ ccbs))) => ((! [Xh:$i] : ((XB2 @ Xh) = (ccfv @ (XS @ Xh) @ ccbs))) => ((! [Xh:$i] : ((Xc_x @ Xh) = (ccfv @ (XR @ Xh) @ ccmulr))) => ((! [Xh:$i] : ((XD @ Xh) = (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xh:$i] : ((Xph @ Xh) => (cwcel @ (XX @ Xh) @ (XK @ Xh)))) => ((! [Xh:$i] : ((Xph @ Xh) => (cwcel @ (XF @ Xh) @ (XB2 @ Xh)))) => (! [Xh:$i] : ((Xph @ Xh) => ((cco @ (XX @ Xh) @ (XF @ Xh) @ (Xc_xb @ Xh)) = (cco @ (ccxp @ (XD @ Xh) @ (ccsn @ (XX @ Xh))) @ (XF @ Xh) @ (ccof @ (Xc_x @ Xh)))))))))))))))))))))))))).
