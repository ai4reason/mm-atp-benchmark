...
thf(adecpmataa0_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xs1:$i] : ((XP @ Xx3 @ Xs1) = (ccfv @ XR @ ccpl1)))) => ((! [Xx3:$i] : (! [Xs1:$i] : ((XC @ Xx3 @ Xs1) = (cco @ XN @ (XP @ Xx3 @ Xs1) @ ccmat)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (XB2 = (ccfv @ (XC @ Xx3 @ Xs1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xs1:$i] : ((XA2 @ Xx3 @ Xs1) = (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (Xc_0 = (ccfv @ (XA2 @ Xx3 @ Xs1) @ cc0g)))) => (((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) => ((cco @ XM @ (ccv @ Xx3) @ ccdecpmat) = Xc_0))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))))).
...
thf(apmatcollpw_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((! [Xn:$i] : ((XC @ Xn) = (cco @ XN @ XP @ ccmat))) => ((! [Xn:$i] : (XB2 = (ccfv @ (XC @ Xn) @ ccbs))) => ((! [Xn:$i] : ((Xc_as @ Xn) = (ccfv @ (XC @ Xn) @ ccvsca))) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => ((! [Xn:$i] : ((XT @ Xn) = (cco @ XN @ XR @ ccmat2pmat))) => (! [Xn:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => (XM = (cco @ (XC @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ XX @ Xc_ex) @ (ccfv @ (cco @ XM @ (ccv @ Xn) @ ccdecpmat) @ (XT @ Xn)) @ (Xc_as @ Xn)))) @ ccgsu)))))))))))))))))))))).
