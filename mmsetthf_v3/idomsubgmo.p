...
thf(aodsubdvds_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XS @ ccfn) & (cwcel @ XA2 @ XS)) => (cwbr @ (ccfv @ XA2 @ XO) @ (ccfv @ XS @ cchash) @ ccdvds)))))))).
...
thf(cidomsubgmo_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccfv @ XR @ ccui) @ ccress)) => (((cwcel @ XR @ ccidom) & (cwcel @ XN @ ccn)) => (cwrmo @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ cchash) = XN)) @ (^ [Xy1:$i] : (ccfv @ XG @ ccsubg))))))))).
