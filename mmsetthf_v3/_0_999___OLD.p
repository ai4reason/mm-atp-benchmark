...
thf(ageoisum1c_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XR @ ccc) & (cwbr @ (ccfv @ XR @ ccabs) @ cc1 @ cclt)) => ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ XR @ (ccv @ Xk) @ ccexp) @ ccmul))) = (cco @ (cco @ XA2 @ XR @ ccmul) @ (cco @ cc1 @ XR @ ccmin) @ ccdiv)))))).
