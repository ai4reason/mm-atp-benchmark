...
thf(afconst2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ XC) => ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> (XF = (ccxp @ XA2 @ (ccsn @ XB2)))))))))).
...
thf(cpadct_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccdom) & (cwcel @ XZ @ XV) & (~ (cwcel @ XZ @ XA2))) => (? [Xf1:$i] : ((cwf @ ccn @ (ccun @ XA2 @ (ccsn @ XZ)) @ (ccv @ Xf1)) & (cwss @ XA2 @ (ccrn @ (ccv @ Xf1))) & (cwfun @ (ccres @ (cccnv @ (ccv @ Xf1)) @ XA2))))))))).
