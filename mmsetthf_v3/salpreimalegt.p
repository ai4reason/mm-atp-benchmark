...
thf(apreimalegt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ ccxr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccdif @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2))) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (XC @ Xx3) @ (XB2 @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2))))))))))))).
...
thf(csalpreimalegt_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xa:$i] : ((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xa)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xa)) @ X)))) => ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xa:$i] : (Xph @ Xx3 @ Xa)) @ X)) => (! [X:$i] : ((^ [Xa:$i] : (Xph @ Xx3 @ Xa)) @ X)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xa) => (cwcel @ (XS @ Xx3) @ ccsalg)))) => ((! [Xx3:$i] : (XA2 = (ccuni @ (XS @ Xx3)))) => ((! [Xx3:$i] : (! [Xa:$i] : (((Xph @ Xx3 @ Xa) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr)))) => ((! [Xx3:$i] : (! [Xa:$i] : (((Xph @ Xx3 @ Xa) & (cwcel @ (ccv @ Xa) @ ccr)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xa) @ ccle)) @ (^ [Xx3:$i] : XA2)) @ (XS @ Xx3))))) => ((! [Xx3:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xa) => (cwcel @ XC @ ccr)))) => (! [Xx3:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xa) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XC @ (XB2 @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2)) @ (XS @ Xx3)))))))))))))))))).
