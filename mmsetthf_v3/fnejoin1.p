...
thf(cfnejoin1_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (((cwcel @ XX @ (XV @ Xy1)) & (cwral @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS)) & (cwcel @ XA2 @ XS)) => (cwbr @ XA2 @ (ccif @ (XS = cc0) @ (ccsn @ XX) @ (ccuni @ XS)) @ ccfne)))))))).
