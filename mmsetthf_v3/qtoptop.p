...
thf(aqtoptop2_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ XF @ XV) & (cwfun @ XF)) => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ cctop)))))).
thf(cqtoptop_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwfn @ XF @ XX)) => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ cctop))))))).
