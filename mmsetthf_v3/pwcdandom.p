...
thf(apwxpndom2_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (~ (cwbr @ (ccpw @ XA2) @ (cco @ XA2 @ (ccxp @ XA2 @ XA2) @ cccda) @ ccdom))))).
...
thf(cpwcdandom_conj,conjecture,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (~ (cwbr @ (ccpw @ XA2) @ (cco @ XA2 @ XA2 @ cccda) @ ccdom))))).
