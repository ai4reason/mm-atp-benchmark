...
thf(ciccbnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((XJ = (cco @ XA2 @ XB2 @ ccicc)) => ((XM = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XJ @ XJ))) => (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ XM @ (ccfv @ XJ @ ccbnd)))))))))).
