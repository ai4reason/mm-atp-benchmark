...
thf(aqexpcl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccq) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccq))))).
...
thf(cqabvexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => (((cwcel @ XF @ XA2) & (cwcel @ XM @ ccq) & (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XM @ XN @ ccexp) @ XF) = (cco @ (ccfv @ XM @ XF) @ XN @ ccexp))))))))))).
