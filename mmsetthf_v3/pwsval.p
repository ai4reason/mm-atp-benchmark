...
thf(cpwsval_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XF = (ccfv @ XR @ ccsca)) => (((cwcel @ XR @ XV) & (cwcel @ XI @ XW)) => (XY = (cco @ XF @ (ccxp @ XI @ (ccsn @ XR)) @ ccprds)))))))))))).
