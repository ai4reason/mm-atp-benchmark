...
thf(cipval3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XP = (ccfv @ XU @ ccdip)) => ((XM = (ccfv @ XU @ ccnsb)) => (((cwcel @ XU @ ccnv) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cco @ XA2 @ XB2 @ XP) = (cco @ (cco @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ XG) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ XM) @ XN) @ cc2 @ ccexp) @ ccmin) @ (cco @ cci @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ XS) @ XM) @ XN) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ ccaddc) @ cc4 @ ccdiv))))))))))))))))))).
