...
thf(cxpsfrnel2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ (cccnv @ (cco @ (ccsn @ XX) @ (ccsn @ XY) @ cccda)) @ (ccixp @ (^ [Xk:$i] : cc2o) @ (^ [Xk:$i] : (ccif @ ((ccv @ Xk) = cc0) @ XA2 @ XB2)))) <=> ((cwcel @ XX @ XA2) & (cwcel @ XY @ XB2)))))))).
