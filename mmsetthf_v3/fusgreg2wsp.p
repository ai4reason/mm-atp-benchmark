...
thf(amidwwlks2s3_thm,axiom,(! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xb:$i] : (XV = (ccfv @ (XG @ Xb) @ ccvtx))) => (! [Xb:$i] : ((cwcel @ XW @ (cco @ cc2 @ (XG @ Xb) @ ccwwlksn)) => (cwrex @ (^ [Xb:$i] : ((ccfv @ cc1 @ XW) = (ccv @ Xb))) @ (^ [Xb:$i] : XV))))))))).
...
thf(cfusgreg2wsp_conj,conjecture,(! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > $o))] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xa:$i] : ((XM @ Xx3 @ Xw @ Xa) = (ccmpt @ (^ [Xa:$i] : (XV @ Xw)) @ (^ [Xa:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ cc1 @ (ccv @ Xw)) = (ccv @ Xa))) @ (^ [Xw:$i] : (cco @ cc2 @ XG @ ccwwspthsn))))))))) => (! [Xw:$i] : (! [Xa:$i] : ((cwcel @ XG @ ccfusgr) => ((cco @ cc2 @ XG @ ccwwspthsn) = (cciun @ (^ [Xx3:$i] : (XV @ Xw)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XM @ Xx3 @ Xw @ Xa)))))))))))))).
