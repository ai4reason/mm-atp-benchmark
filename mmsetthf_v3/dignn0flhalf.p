...
thf(ann0eo_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0) | (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0))))).
...
thf(azefldiv2_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccz)) => ((ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) = (cco @ XN @ cc2 @ ccdiv))))).
...
thf(anno_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn)))).
...
thf(cdignn0flhalf_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XI @ ccn0)) => ((cco @ (cco @ XI @ cc1 @ ccaddc) @ XA2 @ (ccfv @ cc2 @ ccdig)) = (cco @ XI @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccfl) @ (ccfv @ cc2 @ ccdig))))))).
