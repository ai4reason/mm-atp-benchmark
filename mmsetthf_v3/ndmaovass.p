...
thf(cndmaovass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((ccdm @ XF) = (ccxp @ XS @ XS)) => ((~ ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS) & (cwcel @ XC @ XS))) => ((ccaov @ (ccaov @ XA2 @ XB2 @ XF) @ XC @ XF) = (ccaov @ XA2 @ (ccaov @ XB2 @ XC @ XF) @ XF)))))))))).
