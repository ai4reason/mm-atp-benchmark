...
thf(abreprexp_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XZ @ ccc)) => ((Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (Xph => ((ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xb) @ (ccfv @ (ccv @ Xa) @ XL)) @ (cco @ XZ @ (ccv @ Xb) @ ccexp) @ ccmul))))) = (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (cco @ XZ @ (ccv @ Xm) @ ccexp) @ ccmul))))))))))))))))).
...
thf(ahashreprin_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwss @ XB2 @ ccn)) => (Xph => ((ccfv @ (cco @ (ccin @ XA2 @ XB2) @ XM @ (ccfv @ XS @ ccrepr)) @ cchash) = (ccsu @ (cco @ XB2 @ XM @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ XA2 @ (ccfv @ ccn @ ccind)))))))))))))))))))).
...
thf(cbreprexpnat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XZ @ ccc)) => ((Xph => (cwss @ XA2 @ ccn)) => ((! [Xm:$i] : (! [Xb:$i] : ((XP @ Xm @ Xb) = (ccsu @ (ccin @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ (^ [Xb:$i] : (cco @ XZ @ (ccv @ Xb) @ ccexp)))))) => ((! [Xm:$i] : (! [Xb:$i] : ((XR @ Xm @ Xb) = (ccfv @ (cco @ (ccin @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ cchash)))) => (! [Xm:$i] : (! [Xb:$i] : (Xph => ((cco @ (XP @ Xm @ Xb) @ XS @ ccexp) = (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (cco @ (XR @ Xm @ Xb) @ (cco @ XZ @ (ccv @ Xm) @ ccexp) @ ccmul))))))))))))))))))))).
