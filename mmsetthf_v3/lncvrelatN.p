...
thf(clncvrelatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclines)) => ((XM = (ccfv @ XK @ ccpmap)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XP @ XB2)) & ((cwcel @ (ccfv @ XX @ XM) @ XN) & (cwbr @ XP @ XX @ XC))) => (cwcel @ XP @ XA2)))))))))))))))).
