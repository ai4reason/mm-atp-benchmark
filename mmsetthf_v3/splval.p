...
thf(adf_splice_ax,axiom,(ccsplice = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xb:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xb:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xb:$i] : (cco @ (cco @ (cco @ (ccv @ Xs1) @ (ccop @ ccc0 @ (ccfv @ (ccfv @ (ccv @ Xb) @ cc1st) @ cc1st)) @ ccsubstr) @ (ccfv @ (ccv @ Xb) @ cc2nd) @ ccconcat) @ (cco @ (ccv @ Xs1) @ (ccop @ (ccfv @ (ccfv @ (ccv @ Xb) @ cc1st) @ cc2nd) @ (ccfv @ (ccv @ Xs1) @ cchash)) @ ccsubstr) @ ccconcat)))))).
...
thf(csplval_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XS @ XV) & ((cwcel @ XF @ XW) & (cwcel @ XT @ XX) & (cwcel @ XR @ XY))) => ((cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) = (cco @ (cco @ (cco @ XS @ (ccop @ ccc0 @ XF) @ ccsubstr) @ XR @ ccconcat) @ (cco @ XS @ (ccop @ XT @ (ccfv @ XS @ cchash)) @ ccsubstr) @ ccconcat)))))))))))).
