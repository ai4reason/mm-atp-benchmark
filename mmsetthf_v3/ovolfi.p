...
thf(aovolctb2_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwbr @ XA2 @ ccn @ ccdom)) => ((ccfv @ XA2 @ ccovol) = ccc0)))).
thf(covolfi_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwss @ XA2 @ ccr)) => ((ccfv @ XA2 @ ccovol) = ccc0)))).
