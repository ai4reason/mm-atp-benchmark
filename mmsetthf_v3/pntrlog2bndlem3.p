...
thf(apntrlog2bndlem2_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : ((XR @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xa) => (cwcel @ XA2 @ ccrp))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xa) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ ccchp) @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : ccrp)))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xa) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccdiv) @ (XR @ Xi @ Xa)) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccmin) @ ccabs) @ ccmul))) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccdiv))) @ cco1)))))))))))))).
