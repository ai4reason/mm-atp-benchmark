...
thf(cmuladdmodid_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccrp) & (cwcel @ XA2 @ (cco @ ccc0 @ XM @ ccico))) => ((cco @ (cco @ (cco @ XN @ XM @ ccmul) @ XA2 @ ccaddc) @ XM @ ccmo) = XA2)))))).
