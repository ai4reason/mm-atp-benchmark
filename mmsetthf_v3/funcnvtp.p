...
thf(cfuncnvtp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XA2 @ XU) & (cwcel @ XC @ XV) & (cwcel @ XE @ XW)) & ((XB2 != XD) & (XB2 != XF) & (XD != XF))) => (cwfun @ (cccnv @ (cctp @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ (ccop @ XE @ XF))))))))))))))).
