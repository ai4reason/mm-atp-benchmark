...
thf(anzss_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ XV)) => (Xph => ((cwss @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) <=> (cwbr @ XN @ XM @ ccdvds)))))))))).
...
thf(cnzin_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => ((ccin @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) = (ccima @ ccdvds @ (ccsn @ (cco @ XM @ XN @ cclcm))))))))))).
