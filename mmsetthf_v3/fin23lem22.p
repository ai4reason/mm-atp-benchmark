...
thf(cfin23lem22_conj,conjecture,(! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : ((XC @ Xi @ Xj) = (ccmpt @ (^ [Xi:$i] : ccom) @ (^ [Xi:$i] : (ccrio @ (^ [Xj:$i] : (cwbr @ (ccin @ (ccv @ Xj) @ XS) @ (ccv @ Xi) @ ccen)) @ (^ [Xj:$i] : XS))))))) => (! [Xi:$i] : (! [Xj:$i] : (((cwss @ XS @ ccom) & (~ (cwcel @ XS @ ccfn))) => (cwf1o @ ccom @ XS @ (XC @ Xi @ Xj))))))))).
