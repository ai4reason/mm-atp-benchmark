...
thf(ctrnei_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XY @ cctopon)) & (cwss @ XA2 @ XY) & (cwcel @ XP @ XY)) => ((cwcel @ XP @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl))) <=> (cwcel @ (cco @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfil))))))))).
