...
thf(alsmcss_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XC = (ccfv @ XW @ cccss)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((Xph => (cwcel @ XW @ ccphl)) => ((Xph => (cwss @ XS @ XV)) => ((Xph => (cwss @ (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe) @ (cco @ XS @ (ccfv @ XS @ Xc_pe) @ Xc_po))) => (Xph => (cwcel @ XS @ XC))))))))))))))))).
