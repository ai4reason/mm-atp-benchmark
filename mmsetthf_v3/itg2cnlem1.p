...
thf(citg2cnlem1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => (Xph => ((ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xn) @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))) @ ccitg2)))) @ ccxr @ cclt) = (ccfv @ XF @ ccitg2))))))))).
