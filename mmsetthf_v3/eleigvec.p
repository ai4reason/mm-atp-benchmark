...
thf(celeigvec_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwcel @ XA2 @ (ccfv @ XT @ ccei)) <=> ((cwcel @ XA2 @ cchil) & (XA2 != cc0v) & (cwrex @ (^ [Xx3:$i] : ((ccfv @ XA2 @ XT) = (cco @ (ccv @ Xx3) @ XA2 @ ccsm))) @ (^ [Xx3:$i] : ccc)))))))).
