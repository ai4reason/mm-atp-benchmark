...
thf(aranksn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccfv @ (ccsn @ XA2) @ ccrnk) = (ccsuc @ (ccfv @ XA2 @ ccrnk)))))).
...
thf(cranksuc_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccfv @ (ccsuc @ XA2) @ ccrnk) = (ccsuc @ (ccfv @ XA2 @ ccrnk)))))).
