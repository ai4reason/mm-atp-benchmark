...
thf(adveeq1_b_thm,axiom,(! [Xx3:$i] : (! [Xz:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))) => (((ccv @ Xx3) = (ccv @ Xz)) => (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz)))))))).
...
thf(cnfeqf_b3_conj,conjecture,(! [Xx3:$i] : (((~ (! [Xy1:$i] : ((ccv @ Xy1) = (ccv @ Xx3)))) & (~ (! [Xy1:$i] : ((ccv @ Xy1) = (ccv @ Xy1))))) => ((? [X:$i] : ((^ [Xy1:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) @ X)))))).
