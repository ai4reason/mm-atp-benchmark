...
thf(cpwssplit0_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XW @ XU @ ccpws)) => ((XZ = (cco @ XW @ XV @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : (((cwcel @ XW @ XT) & (cwcel @ XU @ XX) & (cwss @ XV @ XU)) => (cwf @ XB2 @ XC @ (XF @ Xx3)))))))))))))))))))).
