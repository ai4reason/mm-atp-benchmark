...
thf(aaxcc4_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwbr @ (XN @ Xx3) @ ccom @ ccen)) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))) => ((Xph @ Xx3 @ Xn) <=> (Xps @ Xf1 @ Xn)))))) => (! [Xx3:$i] : ((cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xn)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xn:$i] : (XN @ Xx3))) => (? [Xf1:$i] : ((cwf @ (XN @ Xx3) @ XA2 @ (ccv @ Xf1)) & (cwral @ (^ [Xn:$i] : (Xps @ Xf1 @ Xn)) @ (^ [Xn:$i] : (XN @ Xx3))))))))))))))).
...
thf(afilfi_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((ccfv @ XF @ ccfi) = XF))))).
...
thf(aiscmet3lem1_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xu:$i] : ((XZ @ Xv @ Xu) = (ccfv @ (XM @ Xv @ Xu) @ ccuz)))) => ((! [Xv:$i] : (! [Xu:$i] : ((XJ @ Xv @ Xu) = (ccfv @ XD @ ccmopn)))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ (XM @ Xv @ Xu) @ ccz)))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XD @ (ccfv @ (XX @ Xv @ Xu) @ ccme))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwf @ (XZ @ Xv @ Xu) @ (XX @ Xv @ Xu) @ XF)))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwbr @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ XD) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccv @ Xk) @ ccexp) @ cclt)) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xk) @ XS)))) @ (^ [Xu:$i] : (ccfv @ (ccv @ Xk) @ XS)))) @ (^ [Xk:$i] : ccz))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xn) @ XS))) @ (^ [Xn:$i] : (cco @ (XM @ Xv @ Xu) @ (ccv @ Xk) @ ccfz)))) @ (^ [Xk:$i] : (XZ @ Xv @ Xu)))))) => (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XF @ (ccfv @ XD @ ccca))))))))))))))))))))).
...
thf(ciscmet3_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => (Xph => ((cwcel @ XD @ (ccfv @ XX @ ccms)) <=> (cwral @ (^ [Xf1:$i] : ((cwf @ XZ @ XX @ (ccv @ Xf1)) => (cwcel @ (ccv @ Xf1) @ (ccdm @ (ccfv @ XJ @ cclm))))) @ (^ [Xf1:$i] : (ccfv @ XD @ ccca)))))))))))))))).
