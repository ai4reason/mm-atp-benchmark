...
thf(amgm0b_thm,axiom,(! [XO:($i > $o)] : (cwcel @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ cc0) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ XO)) @ ccmgm))).
...
thf(csgrp0b_conj,conjecture,(! [XO:($i > $o)] : (cwcel @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ cc0) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ XO)) @ ccsgrp))).
