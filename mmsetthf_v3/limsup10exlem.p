...
thf(a_2teven_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (XB2 = (cco @ cc2 @ XA2 @ ccmul))) => (cwbr @ cc2 @ XB2 @ ccdvds))))).
...
thf(a_2tp1odd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (XB2 = (cco @ (cco @ cc2 @ XA2 @ ccmul) @ cc1 @ ccaddc))) => (~ (cwbr @ cc2 @ XB2 @ ccdvds)))))).
...
thf(climsup10exlem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds) @ ccc0 @ cc1))))) => ((Xph => (cwcel @ XK @ ccr)) => (! [Xn:$i] : (Xph => ((ccima @ (XF @ Xn) @ (cco @ XK @ ccpnf @ ccico)) = (ccpr @ ccc0 @ cc1)))))))))).
