...
thf(adyadovol_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccn0)) => ((ccfv @ (ccfv @ (cco @ XA2 @ XB2 @ XF) @ ccicc) @ ccovol) = (cco @ cc1 @ (cco @ cc2 @ XB2 @ ccexp) @ ccdiv)))))))).
