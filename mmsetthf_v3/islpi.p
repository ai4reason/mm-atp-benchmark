...
thf(cislpi_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) & ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) & (~ (cwcel @ XP @ XS)))) => (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cclp)))))))))).
