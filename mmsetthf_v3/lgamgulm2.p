...
thf(algamgulm_thm,axiom,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XR @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XU @ Xx3 @ Xk) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XR @ ccle) & (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ XR @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((XG @ Xx3 @ Xz @ Xk @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xz:$i] : (XU @ Xx3 @ Xk)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xz) @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccdiv) @ cclog) @ ccmul) @ (ccfv @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xm) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin)))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk) => (cwcel @ (ccseq @ (ccof @ ccaddc) @ (XG @ Xx3 @ Xz @ Xk @ Xm) @ cc1) @ (ccdm @ (ccfv @ (XU @ Xx3 @ Xk) @ cculm)))))))))))))))).
...
thf(aseqof2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3 @ Xz))))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xz:$i] : (Xph => (cwss @ (cco @ XM @ XN @ ccfz) @ (XB2 @ Xz)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XB2 @ Xz)) & (cwcel @ (ccv @ Xz) @ XA2))) => (cwcel @ (XX @ Xx3 @ Xz) @ (XW @ Xx3 @ Xz))))) => (! [Xx3:$i] : (! [Xz:$i] : (Xph => ((ccfv @ XN @ (ccseq @ (ccof @ (Xc_pl @ Xx3)) @ (ccmpt @ (^ [Xx3:$i] : (XB2 @ Xz)) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (XX @ Xx3 @ Xz))))) @ XM)) = (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccfv @ XN @ (ccseq @ (Xc_pl @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : (XB2 @ Xz)) @ (^ [Xx3:$i] : (XX @ Xx3 @ Xz))) @ XM)))))))))))))))))))))).
...
thf(clgamgulm2_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XR @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XU @ Xx3 @ Xk) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XR @ ccle) & (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ XR @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((XG @ Xx3 @ Xz @ Xk @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xz:$i] : (XU @ Xx3 @ Xk)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xz) @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccdiv) @ cclog) @ ccmul) @ (ccfv @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xm) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin)))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk) => ((cwral @ (^ [Xz:$i] : (cwcel @ (ccfv @ (ccv @ Xz) @ cclgam) @ ccc)) @ (^ [Xz:$i] : (XU @ Xx3 @ Xk))) & (cwbr @ (ccseq @ (ccof @ ccaddc) @ (XG @ Xx3 @ Xz @ Xk @ Xm) @ cc1) @ (ccmpt @ (^ [Xz:$i] : (XU @ Xx3 @ Xk)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ cclgam) @ (ccfv @ (ccv @ Xz) @ cclog) @ ccaddc))) @ (ccfv @ (XU @ Xx3 @ Xk) @ cculm)))))))))))))))).
