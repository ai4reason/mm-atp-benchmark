...
thf(cfunopdmsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccop @ XX @ XY)) => ((cwcel @ XX @ XV) => ((cwcel @ XY @ XW) => (((cwfun @ XG) & (cwcel @ XA2 @ (ccdm @ XG)) & (cwcel @ XB2 @ (ccdm @ XG))) => (XA2 = XB2))))))))))))).
