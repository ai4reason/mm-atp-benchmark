...
thf(adgraacl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => (cwcel @ (ccfv @ XA2 @ ccdgraa) @ ccn)))).
...
thf(adgraaub_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((((cwcel @ XP @ (ccfv @ ccq @ ccply)) & (XP != cc0p)) & ((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ XP) = ccc0))) => (cwbr @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ XP @ ccdgr) @ ccle))))).
...
thf(cdgraa0p_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccaa) & (cwcel @ XP @ (ccfv @ ccq @ ccply)) & (cwbr @ (ccfv @ XP @ ccdgr) @ (ccfv @ XA2 @ ccdgraa) @ cclt)) => (((ccfv @ XA2 @ XP) = ccc0) <=> (XP = cc0p)))))).
