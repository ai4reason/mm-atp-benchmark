...
thf(anssdmovg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ (ccdm @ XF) @ (ccxp @ XR @ XS)) & (~ ((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS)))) => ((cco @ XA2 @ XB2 @ XF) = cc0)))))))).
thf(cmpt2ndm0_conj,conjecture,(! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((~ ((cwcel @ (XV @ Xx3 @ Xy1) @ XX) & (cwcel @ (XW @ Xx3 @ Xy1) @ XY))) => ((cco @ (XV @ Xx3 @ Xy1) @ (XW @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) = cc0)))))))))))).
