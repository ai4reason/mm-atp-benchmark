...
thf(adf_pj1_ax,axiom,(ccpj1 = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt2 @ (^ [Xt:$i] : (^ [Xu:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))) @ (^ [Xt:$i] : (^ [Xu:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))) @ (^ [Xt:$i] : (^ [Xu:$i] : (ccmpt @ (^ [Xz:$i] : (cco @ (ccv @ Xt) @ (ccv @ Xu) @ (ccfv @ (ccv @ Xw) @ cclsm))) @ (^ [Xz:$i] : (ccrio @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccplusg)))) @ (^ [Xy1:$i] : (ccv @ Xu)))) @ (^ [Xx3:$i] : (ccv @ Xt)))))))))))).
