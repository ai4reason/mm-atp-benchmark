...
thf(ctmdmulg_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ cctmd) & (cwcel @ XN @ ccn0)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XN @ (ccv @ Xx3) @ Xc_x))) @ (cco @ XJ @ XJ @ cccn)))))))))))).
