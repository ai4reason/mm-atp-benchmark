...
thf(cglbconxN_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_pe:($i > $o)] : ((! [Xx3:$i] : (XB2 = (ccfv @ (XK @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XU @ Xx3 @ Xi) = (ccfv @ (XK @ Xx3) @ cclub)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XG @ Xx3 @ Xi) = (ccfv @ (XK @ Xx3) @ ccglb)))) => ((! [Xx3:$i] : (Xc_pe = (ccfv @ (XK @ Xx3) @ ccoc))) => (! [Xx3:$i] : (! [Xi:$i] : (((cwcel @ (XK @ Xx3) @ cchlt) & (cwral @ (^ [Xi:$i] : (cwcel @ (XS @ Xi) @ XB2)) @ (^ [Xi:$i] : (XI @ Xi)))) => ((ccfv @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xx3) = (XS @ Xi))) @ (^ [Xi:$i] : (XI @ Xi)))) @ (XG @ Xx3 @ Xi)) = (ccfv @ (ccfv @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xx3) = (ccfv @ (XS @ Xi) @ Xc_pe))) @ (^ [Xi:$i] : (XI @ Xi)))) @ (XU @ Xx3 @ Xi)) @ Xc_pe))))))))))))))))).
