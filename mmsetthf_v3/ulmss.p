...
thf(culmss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (XZ = (ccfv @ (XM @ Xx3) @ ccuz))) => ((Xph => (cwss @ XT @ XS)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XZ)) => (cwcel @ (XA2 @ Xx3) @ (XW @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (XG @ Xx3) @ (ccfv @ XS @ cculm)))) => (! [Xx3:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (ccres @ (XA2 @ Xx3) @ XT))) @ (ccres @ (XG @ Xx3) @ XT) @ (ccfv @ XT @ cculm))))))))))))))))).
