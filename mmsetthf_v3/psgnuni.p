...
thf(asymgtrinv_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XG = (ccfv @ XD @ ccsymg)) => ((XI = (ccfv @ XG @ ccminusg)) => (((cwcel @ XD @ XV) & (cwcel @ XW @ (ccword @ XT))) => ((ccfv @ (cco @ XG @ XW @ ccgsu) @ XI) = (cco @ XG @ (ccfv @ XW @ ccreverse) @ ccgsu))))))))))))).
...
thf(cpsgnuni_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XD @ ccsymg)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((Xph => (cwcel @ XD @ XV)) => ((Xph => (cwcel @ XW @ (ccword @ XT))) => ((Xph => (cwcel @ XX @ (ccword @ XT))) => ((Xph => ((cco @ XG @ XW @ ccgsu) = (cco @ XG @ XX @ ccgsu))) => (Xph => ((cco @ (ccneg @ cc1) @ (ccfv @ XW @ cchash) @ ccexp) = (cco @ (ccneg @ cc1) @ (ccfv @ XX @ cchash) @ ccexp))))))))))))))))).
