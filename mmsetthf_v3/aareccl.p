...
thf(aaacn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => (cwcel @ XA2 @ ccc)))).
...
thf(acoeeq2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XF @ Xz @ Xk) @ (ccfv @ (XS @ Xz @ Xk) @ ccply))))) => ((Xph => (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ XN @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xz:$i] : (! [Xk:$i] : (Xph => ((XF @ Xz @ Xk) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => (! [Xz:$i] : (! [Xk:$i] : (Xph => ((ccfv @ (XF @ Xz @ Xk) @ cccoe) = (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccif @ (cwbr @ (ccv @ Xk) @ XN @ ccle) @ (XA2 @ Xk) @ ccc0))))))))))))))))).
...
thf(caareccl_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccaa) & (XA2 != ccc0)) => (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccaa)))).
