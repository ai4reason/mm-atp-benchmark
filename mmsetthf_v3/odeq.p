...
thf(codeq_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccn0)) => ((XN = (ccfv @ XA2 @ XO)) <=> (cwral @ (^ [Xy1:$i] : ((cwbr @ XN @ (ccv @ Xy1) @ ccdvds) <=> ((cco @ (ccv @ Xy1) @ XA2 @ Xc_x) = Xc_0))) @ (^ [Xy1:$i] : ccn0)))))))))))))))).
