...
thf(a_2lplnj_thm,axiom,(! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XP = (ccfv @ XK @ cclpl)) => ((XV = (ccfv @ XK @ cclvol)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XP) & (cwcel @ XY @ XP) & (cwcel @ XW @ XV)) & ((cwbr @ XX @ XW @ Xc_le) & (cwbr @ XY @ XW @ Xc_le) & (XX != XY))) => ((cco @ XX @ XY @ Xc_or) = XW))))))))))))))).
