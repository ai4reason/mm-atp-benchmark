...
thf(codcau_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xg1:$i] : ((XO @ Xg1) = (ccfv @ XG @ ccod))) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn) & (cwcel @ XP @ ccprime)) & (cwbr @ XP @ (ccfv @ XX @ cchash) @ ccdvds)) => (cwrex @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ (XO @ Xg1)) = XP)) @ (^ [Xg1:$i] : XX)))))))))).
