...
thf(celtsk2g_conj,conjecture,(! [XT:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : ((cwcel @ XT @ (XV @ Xz)) => ((cwcel @ XT @ cctsk) <=> ((cwral @ (^ [Xz:$i] : ((cwss @ (ccpw @ (ccv @ Xz)) @ XT) & (cwcel @ (ccpw @ (ccv @ Xz)) @ XT))) @ (^ [Xz:$i] : XT)) & (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ XT @ ccen) | (cwcel @ (ccv @ Xz) @ XT))) @ (^ [Xz:$i] : (ccpw @ XT)))))))))).
