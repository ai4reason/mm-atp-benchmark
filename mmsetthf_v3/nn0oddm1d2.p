...
thf(aoddp1d2_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz))))).
...
thf(cnn0oddm1d2_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0))))).
