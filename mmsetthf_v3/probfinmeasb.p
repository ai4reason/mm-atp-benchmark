...
thf(ameasdivcst_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ (ccfv @ XS @ ccmeas)) & (cwcel @ XA2 @ ccrp)) => (cwcel @ (cco @ XM @ XA2 @ (ccofc @ ccxdiv)) @ (ccfv @ XS @ ccmeas))))))).
...
thf(aofcval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XC @ XW)) => (((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ XF) = XB2)) => ((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ (cco @ XF @ XC @ (ccofc @ XR))) = (cco @ XB2 @ XC @ XR))))))))))))))))).
...
thf(cprobfinmeasb_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ (ccfv @ XS @ ccmeas)) & (cwcel @ (ccfv @ (ccuni @ XS) @ XM) @ ccrp)) => (cwcel @ (cco @ XM @ (ccfv @ (ccuni @ XS) @ XM) @ (ccofc @ ccxdiv)) @ ccprb))))).
