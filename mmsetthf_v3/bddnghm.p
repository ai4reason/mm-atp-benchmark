...
thf(cbddnghm_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((((cwcel @ XS @ ccngp) & (cwcel @ XT @ ccngp) & (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) & ((cwcel @ XA2 @ ccr) & (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle))) => (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)))))))))).
