...
thf(agsum2dlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xj @ Xk))))) => ((Xph => (cwrel @ XA2)) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ XD @ (XW @ Xj @ Xk))))) => ((Xph => (cwss @ (ccdm @ XA2) @ XD)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XG @ (ccres @ XF @ (ccres @ XA2 @ (ccdm @ (cco @ XF @ Xc_0 @ ccsupp)))) @ ccgsu) = (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccdm @ (cco @ XF @ Xc_0 @ ccsupp))) @ (^ [Xj:$i] : (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xj)))) @ (^ [Xk:$i] : (cco @ (ccv @ Xj) @ (ccv @ Xk) @ XF))) @ ccgsu))) @ ccgsu)))))))))))))))))))))).
