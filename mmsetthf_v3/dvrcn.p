...
thf(ainvrcn_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XR @ cctopn)) => ((XI = (ccfv @ XR @ ccinvr)) => ((XU = (ccfv @ XR @ ccui)) => ((cwcel @ XR @ cctdrg) => (cwcel @ XI @ (cco @ (cco @ XJ @ XU @ ccrest) @ XJ @ cccn))))))))))).
thf(cdvrcn_conj,conjecture,(! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XR @ cctopn)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XU = (ccfv @ XR @ ccui)) => ((cwcel @ XR @ cctdrg) => (cwcel @ Xc_dv @ (cco @ (cco @ XJ @ (cco @ XJ @ XU @ ccrest) @ cctx) @ XJ @ cccn))))))))))).
