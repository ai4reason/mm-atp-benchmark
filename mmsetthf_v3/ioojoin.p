...
thf(cioojoin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & ((cwbr @ XA2 @ XB2 @ cclt) & (cwbr @ XB2 @ XC @ cclt))) => ((ccun @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XB2)) @ (cco @ XB2 @ XC @ ccioo)) = (cco @ XA2 @ XC @ ccioo))))))).
