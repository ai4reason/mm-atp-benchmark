...
thf(af1oresrab_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf1o @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2) & ((ccv @ Xy1) = (XC @ Xx3))) => ((Xch @ Xy1) <=> (Xps @ Xx3))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf1o @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XB2)) @ (ccres @ (XF @ Xx3 @ Xy1) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))))))))))))).
...
thf(aclwlknf1oclwwlknlem1_thm,axiom,(! [XC:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XC @ (ccfv @ XG @ ccclwlks)) & (cwbr @ cc1 @ (ccfv @ (ccfv @ XC @ cc1st) @ cchash) @ ccle)) => ((ccfv @ (cco @ (ccfv @ XC @ cc2nd) @ (ccop @ ccc0 @ (cco @ (ccfv @ (ccfv @ XC @ cc2nd) @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ cchash) = (ccfv @ (ccfv @ XC @ cc1st) @ cchash)))))).
thf(aclwlknf1oclwwlknlem3_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xw:$i] : (! [Xc:$i] : ((XA2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc1st)))) => ((! [Xw:$i] : (! [Xc:$i] : ((XB2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc2nd)))) => ((! [Xw:$i] : (! [Xc:$i] : ((XC @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = (XN @ Xc))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))))) => ((! [Xw:$i] : (! [Xc:$i] : ((XF @ Xw @ Xc) = (ccmpt @ (^ [Xc:$i] : (XC @ Xw)) @ (^ [Xc:$i] : (cco @ (XB2 @ Xw @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xw @ Xc) @ cchash)) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xc:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ (XN @ Xc) @ ccn)) => ((XF @ Xw @ Xc) = (ccres @ (ccmpt @ (^ [Xc:$i] : (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))) @ (^ [Xc:$i] : (cco @ (XB2 @ Xw @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xw @ Xc) @ cchash)) @ ccsubstr))) @ (XC @ Xw))))))))))))))))).
...
thf(aclwlknf1oclwwlknlem2_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) = (ccrab @ (^ [Xc:$i] : ((cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) @ ccle) & ((ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) = XN))) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks)))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(aclwwlkn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cco @ XN @ XG @ ccclwwlkn) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwwlk))))))).
thf(cclwlknf1oclwwlkn_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xw:$i] : (! [Xc:$i] : ((XA2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc1st)))) => ((! [Xw:$i] : (! [Xc:$i] : ((XB2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc2nd)))) => ((! [Xw:$i] : ((XC @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))))) => ((! [Xw:$i] : (! [Xc:$i] : ((XF @ Xw @ Xc) = (ccmpt @ (^ [Xc:$i] : (XC @ Xw)) @ (^ [Xc:$i] : (cco @ (XB2 @ Xw @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xw @ Xc) @ cchash)) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xc:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn)) => (cwf1o @ (XC @ Xw) @ (cco @ XN @ XG @ ccclwwlkn) @ (XF @ Xw @ Xc)))))))))))))))).
