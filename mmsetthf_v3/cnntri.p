...
thf(ccnntri_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccuni @ XK)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) & (cwss @ XS @ XY)) => (cwss @ (ccima @ (cccnv @ XF) @ (ccfv @ XS @ (ccfv @ XK @ ccnt))) @ (ccfv @ (ccima @ (cccnv @ XF) @ XS) @ (ccfv @ XJ @ ccnt))))))))))).
