...
thf(adf_itg1_ax,axiom,(ccitg1 = (ccmpt @ (^ [Xf1:$i] : (ccrab @ (^ [Xg1:$i] : ((cwf @ ccr @ ccr @ (ccv @ Xg1)) & (cwcel @ (ccrn @ (ccv @ Xg1)) @ ccfn) & (cwcel @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xg1)) @ (ccdif @ ccr @ (ccsn @ ccc0))) @ ccvol) @ ccr))) @ (^ [Xg1:$i] : ccmbf))) @ (^ [Xf1:$i] : (ccsu @ (ccdif @ (ccrn @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccmul))))))).
...
thf(citg1val_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => ((ccfv @ XF @ ccitg1) = (ccsu @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccmul))))))).
