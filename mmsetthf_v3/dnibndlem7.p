...
thf(cdnibndlem7_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwbr @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ XB2 @ ccmin) @ ccabs) @ ccmin) @ (cco @ XB2 @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin) @ ccmin) @ ccle)))))).
