...
thf(aalephfplem2_thm,axiom,(! [Xw:$i] : (! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => ((cwcel @ (ccv @ Xw) @ ccom) => ((ccfv @ (ccsuc @ (ccv @ Xw)) @ XH) = (ccfv @ (ccfv @ (ccv @ Xw) @ XH) @ ccale))))))).
thf(calephfplem3_conj,conjecture,(! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (! [Xv:$i] : ((cwcel @ (ccv @ Xv) @ ccom) => (cwcel @ (ccfv @ (ccv @ Xv) @ XH) @ (ccrn @ ccale))))))).
