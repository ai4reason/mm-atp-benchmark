...
thf(cqredeq_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn) & ((cco @ XM @ XN @ ccgcd) = cc1)) & ((cwcel @ XP @ ccz) & (cwcel @ XQ @ ccn) & ((cco @ XP @ XQ @ ccgcd) = cc1)) & ((cco @ XM @ XN @ ccdiv) = (cco @ XP @ XQ @ ccdiv))) => ((XM = XP) & (XN = XQ)))))))).
