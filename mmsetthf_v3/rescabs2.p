...
thf(crescabs2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XC @ XV)) => ((Xph => (cwfn @ XJ @ (ccxp @ XT @ XT))) => ((Xph => (cwcel @ XS @ XW)) => ((Xph => (cwss @ XT @ XS)) => (Xph => ((cco @ (cco @ XC @ XS @ ccress) @ XJ @ ccresc) = (cco @ XC @ XJ @ ccresc))))))))))))))).
