...
thf(amoeq3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((~ (Xph & Xps)) => (cwmo @ (^ [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) | ((~ (Xph | Xps)) & ((ccv @ Xx3) = XB2)) | (Xps & ((ccv @ Xx3) = XC)))))))))))))).
...
thf(ctz7_44lem1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((((ccv @ Xx3) = cc0) & ((ccv @ Xy1) = (XA2 @ Xx3))) | ((~ (((ccv @ Xx3) = cc0) | (cwlim @ (ccdm @ (ccv @ Xx3))))) & ((ccv @ Xy1) = (ccfv @ (ccfv @ (ccuni @ (ccdm @ (ccv @ Xx3))) @ (ccv @ Xx3)) @ (XH @ Xx3)))) | ((cwlim @ (ccdm @ (ccv @ Xx3))) & ((ccv @ Xy1) = (ccuni @ (ccrn @ (ccv @ Xx3)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwfun @ (XG @ Xx3 @ Xy1))))))))).
