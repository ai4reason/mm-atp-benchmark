...
thf(af1imass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & ((cwss @ XC @ XA2) & (cwss @ XD @ XA2))) => ((cwss @ (ccima @ XF @ XC) @ (ccima @ XF @ XD)) <=> (cwss @ XC @ XD))))))))).
...
thf(ctsmsf1o_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf1o @ XC @ XA2 @ XH)) => (Xph => ((cco @ XG @ XF @ cctsu) = (cco @ XG @ (cccom @ XF @ XH) @ cctsu)))))))))))))))))).
