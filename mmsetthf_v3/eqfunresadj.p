...
thf(ceqfunresadj_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwfun @ XF) & (cwfun @ XG)) & ((ccres @ XF @ XX) = (ccres @ XG @ XX)) & ((cwcel @ XY @ (ccdm @ XF)) & (cwcel @ XY @ (ccdm @ XG)) & ((ccfv @ XY @ XF) = (ccfv @ XY @ XG)))) => ((ccres @ XF @ (ccun @ XX @ (ccsn @ XY))) = (ccres @ XG @ (ccun @ XX @ (ccsn @ XY)))))))))).
