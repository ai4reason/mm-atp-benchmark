...
thf(cishst_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ cchst) <=> ((cwf @ ccch @ cchil @ XS) & ((ccfv @ (ccfv @ cchil @ XS) @ ccno) = cc1) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) => (((cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccsp) = ccc0) & ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cchj) @ XS) = (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccva))))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))))).
