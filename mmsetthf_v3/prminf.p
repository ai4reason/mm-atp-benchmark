...
thf(aunben_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccn) & (cwral @ (^ [Xm:$i] : (cwrex @ (^ [Xn:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ cclt)) @ (^ [Xn:$i] : XA2))) @ (^ [Xm:$i] : ccn))) => (cwbr @ XA2 @ ccn @ ccen)))).
thf(cprminf_conj,conjecture,(cwbr @ ccprime @ ccn @ ccen)).
