...
thf(aspthdep_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) & ((ccfv @ XF @ cchash) != ccc0)) => ((ccfv @ ccc0 @ XP) != (ccfv @ (ccfv @ XF @ cchash) @ XP))))))).
thf(ccyclnspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF != cc0) => ((cwbr @ XF @ XP @ (ccfv @ XG @ cccycls)) => (~ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))))).
