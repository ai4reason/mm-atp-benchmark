...
thf(asralmod0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xph => (XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra)))) => ((Xph => (Xc_0 = (ccfv @ XW @ cc0g))) => ((Xph => (cwss @ XS @ (ccfv @ XW @ ccbs))) => (Xph => (Xc_0 = (ccfv @ XA2 @ cc0g)))))))))))).
