...
thf(aioodisj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) & (cwbr @ XB2 @ XC @ ccle)) => ((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XC @ XD @ ccioo)) = cc0))))))).
...
thf(creconnlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwss @ XA2 @ ccr) & (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn)) & ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2))) => (cwss @ (cco @ XX @ XY @ ccicc) @ XA2)))))).
