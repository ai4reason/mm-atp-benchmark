...
thf(cfpropnf1_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XF = (ccpr @ (ccop @ XX @ XZ) @ (ccop @ XY @ XZ))) => ((((cwcel @ XX @ XU) & (cwcel @ XY @ XV) & (cwcel @ XZ @ XW)) & (XX != XY)) => ((cwfun @ XF) & (~ (cwfun @ (cccnv @ XF)))))))))))))).
