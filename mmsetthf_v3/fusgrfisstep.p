...
thf(cfusgrfisstep_conj,conjecture,(! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xp:$i] : ((((cwcel @ XV @ (XX @ Xp)) & (cwcel @ XE @ (XY @ Xp))) & (cwcel @ (ccop @ XV @ XE) @ ccfusgr) & (cwcel @ XN @ XV)) => ((cwcel @ (ccres @ ccid @ (ccrab @ (^ [Xp:$i] : (cwnel @ XN @ (ccv @ Xp))) @ (^ [Xp:$i] : (ccfv @ (ccop @ XV @ XE) @ ccedg)))) @ ccfn) => (cwcel @ XE @ ccfn)))))))))).
