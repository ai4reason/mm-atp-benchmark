...
thf(cnormpar2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => ((cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ cc2 @ ccexp) = (cco @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ (ccfv @ (cco @ XB2 @ XC @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccva) @ (cco @ cc2 @ XC @ ccsm) @ ccmv) @ ccno) @ cc2 @ ccexp) @ ccmin))))))))).
