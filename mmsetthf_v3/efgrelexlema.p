...
thf(cefgrelexlema_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))))))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > $o)] : ((! [Xk:$i] : (! [Xd:$i] : (XW = (ccfv @ (ccword @ (ccxp @ (XI @ Xk @ Xd) @ cc2o)) @ ccid)))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : ((Xc_sm @ Xw @ Xv @ Xk @ Xn) = (ccfv @ (XI @ Xk @ Xd) @ ccefg))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xd:$i] : ((XM @ Xy1 @ Xz @ Xk @ Xd) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : (XI @ Xk @ Xd))) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : ((XT @ Xy1 @ Xz @ Xw @ Xv @ Xn @ Xd) = (ccmpt @ (^ [Xv:$i] : XW) @ (^ [Xv:$i] : (ccmpt2 @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xv) @ cchash) @ ccfz))) @ (^ [Xn:$i] : (^ [Xw:$i] : (ccxp @ (XI @ Xk @ Xd) @ cc2o))) @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ (XM @ Xy1 @ Xz @ Xk @ Xd)))) @ ccsplice)))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : ((XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xk @ Xn) = (ccdif @ XW @ (cciun @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ (ccv @ Xx3) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn @ Xd))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xd:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) = (ccmpt @ (^ [Xm:$i] : (ccrab @ (^ [Xt:$i] : ((cwcel @ (ccfv @ ccc0 @ (ccv @ Xt)) @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xk @ Xn)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ (ccv @ Xt)) @ (ccrn @ (ccfv @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xt)) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn @ Xd))))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xt) @ cchash) @ ccfzo))))) @ (^ [Xt:$i] : (ccdif @ (ccword @ XW) @ (ccsn @ cc0))))) @ (^ [Xm:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xm) @ cchash) @ cc1 @ ccmin) @ (ccv @ Xm))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XL @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xi @ Xj @ Xk @ Xm @ Xn @ Xc @ Xd) = (ccopab @ (^ [Xi:$i] : (^ [Xj:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : ((ccfv @ ccc0 @ (ccv @ Xc)) = (ccfv @ ccc0 @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccima @ (cccnv @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn)) @ (ccsn @ (ccv @ Xj)))))) @ (^ [Xc:$i] : (ccima @ (cccnv @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn)) @ (ccsn @ (ccv @ Xi)))))))))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cwbr @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) @ (XL @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xi @ Xj @ Xk @ Xm @ Xn @ Xc @ Xd)) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((ccfv @ ccc0 @ (ccv @ Xa)) = (ccfv @ ccc0 @ (ccv @ Xb)))) @ (^ [Xb:$i] : (ccima @ (cccnv @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn)) @ (ccsn @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn)))))) @ (^ [Xa:$i] : (ccima @ (cccnv @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn)) @ (ccsn @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn))))))))))))))))))))))))))))))))))))).
