...
thf(crspcsbela_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xx3:$i] : (((cwcel @ (XA2 @ Xx3) @ XB2) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XC @ Xx3) @ XD)) @ (^ [Xx3:$i] : XB2))) => (cwcel @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3))) @ XD)))))))).
