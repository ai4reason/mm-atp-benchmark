...
thf(atgpcn_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XF = (ccfv @ XG @ ccplusf)) => ((cwcel @ XG @ cctgp) => (cwcel @ XF @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))).
...
thf(amulrcn_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XR @ cctopn)) => ((XT = (ccfv @ (ccfv @ XR @ ccmgp) @ ccplusf)) => ((cwcel @ XR @ cctrg) => (cwcel @ XT @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))).
...
thf(acnconst2_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon)) & (cwcel @ XB2 @ XY)) => (cwcel @ (ccxp @ XX @ (ccsn @ XB2)) @ (cco @ XJ @ XK @ cccn))))))))).
thf(aidcn_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => (cwcel @ (ccres @ ccid @ XX) @ (cco @ XJ @ XJ @ cccn)))))).
...
thf(cpl1cn_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XE = (ccfv @ XR @ cce1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((XJ = (ccfv @ XR @ cctopn)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XR @ cctrg)) => ((Xph => (cwcel @ XF @ XB2)) => (Xph => (cwcel @ (ccfv @ XF @ XE) @ (cco @ XJ @ XJ @ cccn)))))))))))))))))))).
