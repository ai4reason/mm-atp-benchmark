...
thf(aitg1val2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & ((cwcel @ XA2 @ ccfn) & (cwss @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)) @ XA2) & (cwss @ XA2 @ (ccdif @ ccr @ (ccsn @ ccc0))))) => ((ccfv @ XF @ ccitg1) = (ccsu @ XA2 @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccmul)))))))).
...
thf(ai1faddlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => ((Xph & (cwcel @ XA2 @ ccc)) => ((ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccaddc))) @ (ccsn @ XA2)) = (cciun @ (^ [Xy1:$i] : (ccrn @ XG)) @ (^ [Xy1:$i] : (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XA2 @ (ccv @ Xy1) @ ccmin))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xy1))))))))))))))).
