...
thf(cmodsubdir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccrp)) => ((cwbr @ (cco @ XB2 @ XC @ ccmo) @ (cco @ XA2 @ XC @ ccmo) @ ccle) <=> ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccmo) = (cco @ (cco @ XA2 @ XC @ ccmo) @ (cco @ XB2 @ XC @ ccmo) @ ccmin)))))))).
