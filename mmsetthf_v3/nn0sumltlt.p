...
thf(cnn0sumltlt_conj,conjecture,(! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((cwcel @ (ccv @ Xa) @ ccn0) & (cwcel @ (ccv @ Xb) @ ccn0) & (cwcel @ (ccv @ Xc) @ ccn0)) => ((cwbr @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccaddc) @ (ccv @ Xc) @ cclt) => (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ cclt))))))).
