...
thf(cbrssc_conj,conjecture,(! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((cwbr @ XH @ XJ @ ccssc) <=> (? [Xt:$i] : ((cwfn @ XJ @ (ccxp @ (ccv @ Xt) @ (ccv @ Xt))) & (cwrex @ (^ [Xs1:$i] : (cwcel @ XH @ (ccixp @ (^ [Xx3:$i] : (ccxp @ (ccv @ Xs1) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ XJ)))))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xt)))))))))).
