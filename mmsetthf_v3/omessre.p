...
thf(comessre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XO) @ ccr)) => ((Xph => (cwss @ XB2 @ XA2)) => (Xph => (cwcel @ (ccfv @ XB2 @ XO) @ ccr))))))))))))).
