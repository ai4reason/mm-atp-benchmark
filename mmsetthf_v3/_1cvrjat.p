...
thf(aopoc0_thm,axiom,(! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XK @ ccp0)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((cwcel @ XK @ ccops) => ((ccfv @ Xc_0 @ Xc_pe) = Xc_1)))))))))).
thf(c_1cvrjat_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XP @ XA2)) & ((cwbr @ XX @ Xc_1 @ XC) & (~ (cwbr @ XP @ XX @ Xc_le)))) => ((cco @ XX @ XP @ Xc_or) = Xc_1)))))))))))))))))).
