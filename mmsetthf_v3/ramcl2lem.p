...
thf(ainfmin_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwor @ XA2 @ XR)) => ((Xph => (cwcel @ XC @ XA2)) => ((Xph => (cwcel @ XC @ XB2)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (~ (cwbr @ (ccv @ Xy1) @ XC @ XR)))) => (Xph => ((ccinf @ XB2 @ XA2 @ XR) = XC)))))))))))).
