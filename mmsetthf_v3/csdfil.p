...
thf(aisfild_thm,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3 @ Xz)))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => ((! [Xz:$i] : (Xph => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ XA2))) => ((! [Xz:$i] : (Xph => (~ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ cc0)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xz) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz)) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xz) @ XA2)) => (((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz))) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))) => (Xph => (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
...
thf(asdomirr_thm,axiom,(! [XA2:($i > $o)] : (~ (cwbr @ XA2 @ XA2 @ ccsdm)))).
...
thf(ainfunsdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XX @ (ccdm @ cccrd)) & (cwbr @ ccom @ XX @ ccdom)) & ((cwbr @ XA2 @ XX @ ccsdm) & (cwbr @ XB2 @ XX @ ccsdm))) => (cwbr @ (ccun @ XA2 @ XB2) @ XX @ ccsdm)))))).
...
thf(ccsdfil_conj,conjecture,(! [XX:($i > $o)] : (((cwcel @ XX @ (ccdm @ cccrd)) & (cwbr @ ccom @ XX @ ccdom)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccdif @ XX @ (ccv @ Xx3)) @ XX @ ccsdm)) @ (^ [Xx3:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccfil))))).
