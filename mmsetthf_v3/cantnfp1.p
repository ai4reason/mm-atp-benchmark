...
thf(acantnfp1lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XG @ XS)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XA2)) => ((Xph => (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ ((ccv @ Xt) = XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => (! [Xt:$i] : (Xph => (cwcel @ (XF @ Xt) @ XS)))))))))))))))))))).
...
thf(acantnfp1lem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XG @ XS)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XA2)) => ((Xph => (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ ((ccv @ Xt) = XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => ((Xph => (cwcel @ cc0 @ XY)) => ((! [Xt:$i] : ((XO @ Xt) = (ccoi @ (cco @ (XF @ Xt) @ cc0 @ ccsupp) @ ccep))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : ((XH @ Xz @ Xt @ Xk) = (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xk) @ (XO @ Xt)) @ ccoe) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XO @ Xt)) @ (XF @ Xt)) @ ccomu) @ (ccv @ Xz) @ ccoa)))) @ cc0))))) => ((XK = (ccoi @ (cco @ XG @ cc0 @ ccsupp) @ ccep)) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xk:$i] : ((XM @ Xz @ Xt @ Xk) = (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xk) @ XK) @ ccoe) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XK) @ XG) @ ccomu) @ (ccv @ Xz) @ ccoa)))) @ cc0))))) => (! [Xt:$i] : (Xph => ((ccfv @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ cccnf)) = (cco @ (cco @ (cco @ XA2 @ XX @ ccoe) @ XY @ ccomu) @ (ccfv @ XG @ (cco @ XA2 @ XB2 @ cccnf)) @ ccoa)))))))))))))))))))))))))))))).
...
thf(ccantnfp1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XG @ XS)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XA2)) => ((Xph => (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ ((ccv @ Xt) = XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => (! [Xt:$i] : (Xph => ((cwcel @ (XF @ Xt) @ XS) & ((ccfv @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ cccnf)) = (cco @ (cco @ (cco @ XA2 @ XX @ ccoe) @ XY @ ccomu) @ (ccfv @ XG @ (cco @ XA2 @ XB2 @ cccnf)) @ ccoa)))))))))))))))))))))).
