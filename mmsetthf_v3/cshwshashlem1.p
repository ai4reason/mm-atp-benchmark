...
thf(acshwsidrepswmod0_thm,axiom,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime) & (cwcel @ XL @ ccz)) => (((cco @ XW @ XL @ cccsh) = XW) => (((cco @ XL @ (ccfv @ XW @ cchash) @ ccmo) = ccc0) | (XW = (cco @ (ccfv @ ccc0 @ XW) @ (ccfv @ XW @ cchash) @ ccreps))))))))).
...
thf(ccshwshashlem1_conj,conjecture,(! [Xph:$o] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => ((Xph & (cwrex @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) != (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) & (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((cco @ XW @ XL @ cccsh) != XW)))))))).
