...
thf(anumclwwlk4_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ ccn)) => ((ccfv @ (cco @ XN @ XG @ ccclwwlkn) @ cchash) = (ccsu @ XV @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XN @ (ccfv @ XG @ ccclwwlknon)) @ cchash)))))))))).
...
thf(anumclwwlk5_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr) & (cwcel @ XV @ ccfn)) & ((cwcel @ XX @ XV) & (cwcel @ XP @ ccprime) & (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) => ((cco @ (ccfv @ (cco @ XX @ XP @ (ccfv @ XG @ ccclwwlknon)) @ cchash) @ XP @ ccmo) = cc1))))))))).
...
thf(cnumclwwlk6_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr) & (cwcel @ XV @ ccfn)) & ((cwcel @ XP @ ccprime) & (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) => ((cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) = (cco @ (ccfv @ XV @ cchash) @ XP @ ccmo))))))))).
