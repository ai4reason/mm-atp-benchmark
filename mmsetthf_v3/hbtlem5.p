...
thf(adeg1lt0_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XB2 = (ccfv @ XP @ ccbs)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XB2)) => ((cwbr @ (ccfv @ XF @ XD) @ ccc0 @ cclt) <=> (XF = Xc_0)))))))))))))).
...
thf(adegltp1le_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ (ccun @ ccn0 @ (ccsn @ ccmnf))) & (cwcel @ XY @ ccz)) => ((cwbr @ XX @ (cco @ XY @ cc1 @ ccaddc) @ cclt) <=> (cwbr @ XX @ XY @ ccle)))))).
