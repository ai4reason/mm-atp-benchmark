...
thf(apmtr3ncomlem2_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XF = (ccfv @ (ccpr @ XX @ XY) @ XT)) => ((XG = (ccfv @ (ccpr @ XY @ XZ) @ XT)) => (((cwcel @ XD @ XV) & ((cwcel @ XX @ XD) & (cwcel @ XY @ XD) & (cwcel @ XZ @ XD)) & ((XX != XY) & (XX != XZ) & (XY != XZ))) => ((cccom @ XG @ XF) != (cccom @ XF @ XG))))))))))))))).
...
thf(cpmtr3ncom_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((XT = (ccfv @ XD @ ccpmtr)) => (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XD @ (XV @ Xf1 @ Xg1)) & (cwbr @ cc3 @ (ccfv @ XD @ cchash) @ ccle)) => (cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : ((cccom @ (ccv @ Xg1) @ (ccv @ Xf1)) != (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))) @ (^ [Xg1:$i] : (ccrn @ XT)))) @ (^ [Xf1:$i] : (ccrn @ XT))))))))))).
