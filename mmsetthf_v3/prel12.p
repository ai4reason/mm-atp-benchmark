...
thf(cprel12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => ((~ (XA2 = XB2)) => (((ccpr @ XA2 @ XB2) = (ccpr @ XC @ XD)) <=> ((cwcel @ XA2 @ (ccpr @ XC @ XD)) & (cwcel @ XB2 @ (ccpr @ XC @ XD)))))))))))))).
