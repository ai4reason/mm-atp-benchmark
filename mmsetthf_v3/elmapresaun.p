...
thf(celmapresaun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XC @ XA2 @ ccmap)) & (cwcel @ XG @ (cco @ XC @ XB2 @ ccmap)) & ((ccres @ XF @ (ccin @ XA2 @ XB2)) = (ccres @ XG @ (ccin @ XA2 @ XB2)))) => (cwcel @ (ccun @ XF @ XG) @ (cco @ XC @ (ccun @ XA2 @ XB2) @ ccmap))))))))).
