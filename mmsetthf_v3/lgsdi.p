...
thf(algsdilem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XN @ ccz)) & ((XA2 != ccc0) & (XB2 != ccc0))) => ((ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) = (cco @ (ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ XA2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ XB2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ ccmul))))))).
...
thf(aseqcaopr_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_pl))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS) & (cwcel @ (ccv @ Xz) @ XS))) => ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (ccv @ Xz) @ Xc_pl) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl) @ Xc_pl)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccuz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ (XM @ Xx3 @ Xy1 @ Xz) @ (XN @ Xx3 @ Xy1 @ Xz) @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xx3 @ Xy1 @ Xz)) @ XS)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ (XM @ Xx3 @ Xy1 @ Xz) @ (XN @ Xx3 @ Xy1 @ Xz) @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xk) @ (XG @ Xx3 @ Xy1 @ Xz)) @ XS)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ (XM @ Xx3 @ Xy1 @ Xz) @ (XN @ Xx3 @ Xy1 @ Xz) @ ccfz))) => ((ccfv @ (ccv @ Xk) @ (XH @ Xx3 @ Xy1 @ Xz)) = (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xx3 @ Xy1 @ Xz)) @ (ccfv @ (ccv @ Xk) @ (XG @ Xx3 @ Xy1 @ Xz)) @ Xc_pl))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((ccfv @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccseq @ Xc_pl @ (XH @ Xx3 @ Xy1 @ Xz) @ (XM @ Xx3 @ Xy1 @ Xz))) = (cco @ (ccfv @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccseq @ Xc_pl @ (XF @ Xx3 @ Xy1 @ Xz) @ (XM @ Xx3 @ Xy1 @ Xz))) @ (ccfv @ (XN @ Xx3 @ Xy1 @ Xz) @ (ccseq @ Xc_pl @ (XG @ Xx3 @ Xy1 @ Xz) @ (XM @ Xx3 @ Xy1 @ Xz))) @ Xc_pl)))))))))))))))))))))).
...
thf(algsfcl3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz) & (XN != ccc0)) => (cwf @ ccn @ ccz @ (XF @ Xn))))))))).
...
thf(algscl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XA2 @ XN @ cclgs) @ ccz))))).
...
thf(algsdilem2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XA2 @ ccz))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XM @ ccz))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XN @ ccz))) => ((! [Xn:$i] : ((Xph @ Xn) => (XM != ccc0))) => ((! [Xn:$i] : ((Xph @ Xn) => (XN != ccc0))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XM @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : ((Xph @ Xn) => ((ccfv @ (ccfv @ XM @ ccabs) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) = (ccfv @ (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))))))))))).
...
thf(algsval4_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz) & (XN != ccc0)) => ((cco @ XA2 @ XN @ cclgs) = (cco @ (ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ XA2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccfv @ (ccfv @ XN @ ccabs) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ ccmul))))))))).
...
thf(clgsdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((XM != ccc0) & (XN != ccc0))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ cclgs) = (cco @ (cco @ XA2 @ XM @ cclgs) @ (cco @ XA2 @ XN @ cclgs) @ ccmul))))))).
