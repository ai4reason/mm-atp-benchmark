...
thf(cressiooinf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwss @ XA2 @ ccr)) => ((XS = (ccinf @ XA2 @ ccxr @ cclt)) => ((Xph => (~ (cwcel @ XS @ XA2))) => ((XI = (cco @ XS @ ccpnf @ ccioo)) => (Xph => (cwss @ XA2 @ XI))))))))))).
