...
thf(aexpnegico01_thm,axiom,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz) & (cwbr @ XN @ ccc0 @ cclt)) => (cwcel @ (cco @ XB2 @ XN @ ccexp) @ (cco @ ccc0 @ cc1 @ ccico)))))).
...
thf(cdigexp_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XK @ ccn0) & (cwcel @ XN @ ccn0)) => ((cco @ XK @ (cco @ XB2 @ XN @ ccexp) @ (ccfv @ XB2 @ ccdig)) = (ccif @ (XK = XN) @ cc1 @ ccc0))))))).
