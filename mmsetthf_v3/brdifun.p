...
thf(cbrdifun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccdif @ (ccxp @ XX @ XX) @ (ccun @ Xc_lt @ (cccnv @ Xc_lt)))) => (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cwbr @ XA2 @ XB2 @ XR) <=> (~ ((cwbr @ XA2 @ XB2 @ Xc_lt) | (cwbr @ XB2 @ XA2 @ Xc_lt)))))))))))).
