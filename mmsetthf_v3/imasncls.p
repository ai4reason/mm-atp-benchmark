...
thf(cimasncls_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) & ((cwss @ XR @ (ccxp @ XX @ XY)) & (cwcel @ XA2 @ XX))) => (cwss @ (ccfv @ (ccima @ XR @ (ccsn @ XA2)) @ (ccfv @ XK @ cccl)) @ (ccima @ (ccfv @ XR @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cccl)) @ (ccsn @ XA2))))))))))))).
