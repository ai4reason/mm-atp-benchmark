...
thf(cimasncld_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) & ((cwcel @ XR @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cccld)) & (cwcel @ XA2 @ XX))) => (cwcel @ (ccima @ XR @ (ccsn @ XA2)) @ (ccfv @ XK @ cccld)))))))))).
