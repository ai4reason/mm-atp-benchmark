...
thf(alfl0_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XZ = (ccfv @ XW @ cc0g)) => ((XF = (ccfv @ XW @ cclfn)) => (((cwcel @ XW @ cclmod) & (cwcel @ XG @ XF)) => ((ccfv @ XZ @ XG) = Xc_0))))))))))))).
