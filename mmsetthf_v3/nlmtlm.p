...
thf(angptgp_thm,axiom,(! [XG:($i > $o)] : (((cwcel @ XG @ ccngp) & (cwcel @ XG @ ccabl)) => (cwcel @ XG @ cctgp)))).
...
thf(anlmvscn_thm,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccscaf)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XK = (ccfv @ XF @ cctopn)) => ((cwcel @ XW @ ccnlm) => (cwcel @ Xc_x @ (cco @ (cco @ XK @ XJ @ cctx) @ XJ @ cccn))))))))))))).
