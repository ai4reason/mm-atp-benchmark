...
thf(csge0snmptf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (((ccv @ Xk) = XA2) => ((XB2 @ Xk) = XC))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ (ccmpt @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) = XC))))))))))))).
