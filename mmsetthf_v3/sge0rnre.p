...
thf(csge0rnre_conj,conjecture,(! [Xph:$o] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ (XF @ Xx3 @ Xy1))))) => (Xph => (cwss @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (XF @ Xx3 @ Xy1))))))) @ ccr))))))).
