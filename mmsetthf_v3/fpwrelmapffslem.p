...
thf(affsrn_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwfun @ XF)) => ((Xph => (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn)) => (Xph => (cwcel @ (ccrn @ XF) @ ccfn)))))))))))).
...
thf(aunifi3_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ (ccuni @ XA2) @ ccfn) => (cwss @ XA2 @ ccfn)))).
...
thf(cfpwrelmapffslem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ XA2 @ (ccpw @ (XB2 @ Xx3 @ Xy1)) @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (XR = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwcel @ XR @ ccfn) <=> ((cwss @ (ccrn @ XF) @ ccfn) & (cwcel @ (cco @ XF @ cc0 @ ccsupp) @ ccfn)))))))))))))))).
