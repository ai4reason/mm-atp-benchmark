...
thf(aetasslt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccsn @ (ccv @ Xx3)) @ ccsslt) & (cwbr @ (ccsn @ (ccv @ Xx3)) @ XB2 @ ccsslt) & (cwss @ (ccfv @ (ccv @ Xx3) @ ccbday) @ (ccsuc @ (ccuni @ (ccima @ ccbday @ (ccun @ XA2 @ XB2))))))) @ (^ [Xx3:$i] : ccsur)))))).
