...
thf(ccvlatexch2_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cclc) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & (XP != XR)) => ((cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le) => (cwbr @ XQ @ (cco @ XP @ XR @ Xc_or) @ Xc_le)))))))))))))).
