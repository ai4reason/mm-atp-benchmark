...
thf(ampllss_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XP = (cco @ XI @ XR @ ccmpl)) => ((XU = (ccfv @ XP @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwcel @ XU @ (ccfv @ XS @ cclss)))))))))))))))).
...
thf(alsslss_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XS = (ccfv @ XW @ cclss)) => ((XT = (ccfv @ XX @ cclss)) => (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS)) => ((cwcel @ XV @ XT) <=> ((cwcel @ XV @ XS) & (cwss @ XV @ XU)))))))))))))).
...
thf(amplcoe2_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [Xc_ex:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XP @ Xy1 @ Xf1) = (cco @ XI @ (XR @ Xk) @ ccmpl))))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xk:$i] : (Xc_0 = (ccfv @ (XR @ Xk) @ cc0g))) => ((! [Xf1:$i] : (! [Xk:$i] : ((Xc_1 @ Xf1) = (ccfv @ (XR @ Xk) @ ccur)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XI @ (XW @ Xf1)))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XG @ Xf1) = (ccfv @ (XP @ Xy1 @ Xf1) @ ccmgp)))) => ((! [Xf1:$i] : ((Xc_ex @ Xf1) = (ccfv @ (XG @ Xf1) @ ccmg))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XV @ Xf1) = (cco @ XI @ (XR @ Xk) @ ccmvr)))) => ((! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xf1) => (cwcel @ (XR @ Xk) @ cccrg)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XY @ (XD @ Xf1)))) => (! [Xf1:$i] : ((Xph @ Xf1) => ((ccmpt @ (^ [Xy1:$i] : (XD @ Xf1)) @ (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = XY) @ (Xc_1 @ Xf1) @ Xc_0))) = (cco @ (XG @ Xf1) @ (ccmpt @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XY) @ (ccfv @ (ccv @ Xk) @ (XV @ Xf1)) @ (Xc_ex @ Xf1)))) @ ccgsu))))))))))))))))))))))))))).
...
thf(amplcrng_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XP = (cco @ XI @ XR @ ccmpl)) => (((cwcel @ XI @ XV) & (cwcel @ XR @ cccrg)) => (cwcel @ XP @ cccrg)))))))).
...
thf(amulgnn0subcl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xy1:$i] : ((Xc_x @ Xy1) = (ccfv @ XG @ ccmg))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XG @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwss @ XS @ XB2)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS)) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ XG @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (Xc_0 @ Xx3 @ Xy1) @ XS)))) => (! [Xy1:$i] : ((Xph & (cwcel @ XN @ ccn0) & (cwcel @ XX @ XS)) => (cwcel @ (cco @ XN @ XX @ (Xc_x @ Xy1)) @ XS)))))))))))))))))))))).
...
thf(cmplbas2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XI @ XR @ ccmpl)) => ((XS = (cco @ XI @ XR @ ccmps)) => ((XV = (cco @ XI @ XR @ ccmvr)) => ((XA2 = (ccfv @ XS @ ccasp)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ cccrg)) => (Xph => ((ccfv @ (ccrn @ XV) @ XA2) = (ccfv @ XP @ ccbs)))))))))))))))))).
