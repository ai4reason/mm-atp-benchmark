...
thf(aquad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (XA2 != ccc0)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (XD = (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ (cco @ XA2 @ XC @ ccmul) @ ccmul) @ ccmin))) => (Xph => (((cco @ (cco @ XA2 @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ (cco @ (cco @ XB2 @ XX @ ccmul) @ XC @ ccaddc) @ ccaddc) = ccc0) <=> ((XX = (cco @ (cco @ (ccneg @ XB2) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ (cco @ cc2 @ XA2 @ ccmul) @ ccdiv)) | (XX = (cco @ (cco @ (ccneg @ XB2) @ (ccfv @ XD @ ccsqrt) @ ccmin) @ (cco @ cc2 @ XA2 @ ccmul) @ ccdiv)))))))))))))))))).
...
thf(adcubic2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccc)) => ((Xph => (cwcel @ XQ @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XT @ ccc)) => ((! [Xr:$i] : (Xph => ((cco @ XT @ cc3 @ ccexp) = (cco @ (XG @ Xr) @ (XN @ Xr) @ ccmin)))) => ((! [Xr:$i] : (Xph => (cwcel @ (XG @ Xr) @ ccc))) => ((! [Xr:$i] : (Xph => ((cco @ (XG @ Xr) @ cc2 @ ccexp) = (cco @ (cco @ (XN @ Xr) @ cc2 @ ccexp) @ (cco @ XM @ cc3 @ ccexp) @ ccaddc)))) => ((Xph => (XM = (cco @ XP @ cc3 @ ccdiv))) => ((! [Xr:$i] : (Xph => ((XN @ Xr) = (cco @ XQ @ cc2 @ ccdiv)))) => ((Xph => (XT != ccc0)) => ((Xph => (cwcel @ XU @ ccc)) => ((Xph => (XU != ccc0)) => ((Xph => (XX = (cco @ XU @ (cco @ XM @ XU @ ccdiv) @ ccmin))) => ((Xph => ((cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ XP @ XX @ ccmul) @ XQ @ ccaddc) @ ccaddc) = ccc0)) => (Xph => (cwrex @ (^ [Xr:$i] : (((cco @ (ccv @ Xr) @ cc3 @ ccexp) = cc1) & (XX = (cco @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ (cco @ XM @ (cco @ (ccv @ Xr) @ XT @ ccmul) @ ccdiv) @ ccmin)))) @ (^ [Xr:$i] : ccc))))))))))))))))))))))))))).
...
thf(adcubic1_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccc)) => ((Xph => (cwcel @ XQ @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XT @ ccc)) => ((Xph => ((cco @ XT @ cc3 @ ccexp) = (cco @ XG @ XN @ ccmin))) => ((Xph => (cwcel @ XG @ ccc)) => ((Xph => ((cco @ XG @ cc2 @ ccexp) = (cco @ (cco @ XN @ cc2 @ ccexp) @ (cco @ XM @ cc3 @ ccexp) @ ccaddc))) => ((Xph => (XM = (cco @ XP @ cc3 @ ccdiv))) => ((Xph => (XN = (cco @ XQ @ cc2 @ ccdiv))) => ((Xph => (XT != ccc0)) => ((Xph => (XX = (cco @ XT @ (cco @ XM @ XT @ ccdiv) @ ccmin))) => (Xph => ((cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ XP @ XX @ ccmul) @ XQ @ ccaddc) @ ccaddc) = ccc0)))))))))))))))))))))).
