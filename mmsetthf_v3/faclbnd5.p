...
thf(altmulgt12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwbr @ cc1 @ XB2 @ cclt) <=> (cwbr @ XA2 @ (cco @ XB2 @ XA2 @ ccmul) @ cclt)))))).
...
thf(cfaclbnd5_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccn0) & (cwcel @ XM @ ccn)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ cclt)))))).
