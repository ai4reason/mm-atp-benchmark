...
thf(atmsval_thm,axiom,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XX) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD))) => ((XK = (ccfv @ XD @ cctmt)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (XK = (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts)))))))))).
...
thf(ctmslem_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XX) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD))) => ((XK = (ccfv @ XD @ cctmt)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((XX = (ccfv @ XK @ ccbs)) & (XD = (ccfv @ XK @ ccds)) & ((ccfv @ XD @ ccmopn) = (ccfv @ XK @ cctopn))))))))))).
