...
thf(afin1ai_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccfin1a) & (cwss @ XX @ XA2)) => ((cwcel @ XX @ ccfn) | (cwcel @ (ccdif @ XA2 @ XX) @ ccfn)))))).
...
thf(aisfin1a_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xy1)) => ((cwcel @ XA2 @ ccfin1a) <=> (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccfn) | (cwcel @ (ccdif @ XA2 @ (ccv @ Xy1)) @ ccfn))) @ (^ [Xy1:$i] : (ccpw @ XA2))))))))).
thf(cenfin1ai_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwcel @ XA2 @ ccfin1a) => (cwcel @ XB2 @ ccfin1a)))))).
