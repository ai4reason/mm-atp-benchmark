...
thf(ampt2v_thm,axiom,(! [XC:($i > ($i > ($i > $o)))] : ((ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((ccv @ Xz) = (XC @ Xx3 @ Xy1))))))))).
...
thf(c_2nd2val_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((ccv @ Xz) = (ccv @ Xy1))))))) = (ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz) @ cc2nd))))))).
