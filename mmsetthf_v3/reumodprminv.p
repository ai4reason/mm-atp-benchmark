...
thf(amodprminveq_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) => (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz) & (~ (cwbr @ XP @ XA2 @ ccdvds))) => (((cwcel @ XS @ (cco @ ccc0 @ (cco @ XP @ cc1 @ ccmin) @ ccfz)) & ((cco @ (cco @ XA2 @ XS @ ccmul) @ XP @ ccmo) = cc1)) <=> (XS = XR))))))))).
