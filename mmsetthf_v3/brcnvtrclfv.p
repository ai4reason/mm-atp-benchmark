...
thf(cbrcnvtrclfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xr:$i] : (((cwcel @ XR @ (XU @ Xr)) & (cwcel @ XA2 @ (XV @ Xr)) & (cwcel @ XB2 @ (XW @ Xr))) => ((cwbr @ XA2 @ XB2 @ (cccnv @ (ccfv @ XR @ cctcl))) <=> (! [Xr:$i] : (((cwss @ XR @ (ccv @ Xr)) & (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr))) => (cwbr @ XB2 @ XA2 @ (ccv @ Xr)))))))))))))).
