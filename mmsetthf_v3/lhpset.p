...
thf(adf_lhyp_ax,axiom,(cclh = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ ccp1) @ (ccfv @ (ccv @ Xk) @ cccvr))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccbs))))))).
thf(arabex_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(clhpset_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XC = (ccfv @ XK @ cccvr)) => ((! [Xw:$i] : ((XH @ Xw) = (ccfv @ XK @ cclh))) => (! [Xw:$i] : ((cwcel @ XK @ (XA2 @ Xw)) => ((XH @ Xw) = (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ Xc_1 @ XC)) @ (^ [Xw:$i] : XB2)))))))))))))))).
