...
thf(ccdleme23c_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XV = (cco @ (cco @ XS @ XT @ Xc_or) @ (cco @ XX @ XW @ Xc_an) @ Xc_an)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le))) & ((cwcel @ XT @ XA2) & (~ (cwbr @ XT @ XW @ Xc_le)))) & ((cwcel @ XX @ XB2) & (~ (cwbr @ XX @ XW @ Xc_le))) & ((XS != XT) & ((cco @ XS @ (cco @ XX @ XW @ Xc_an) @ Xc_or) = XX) & ((cco @ XT @ (cco @ XX @ XW @ Xc_an) @ Xc_or) = XX))) => (cwbr @ XS @ (cco @ XT @ XV @ Xc_or) @ Xc_le)))))))))))))))))))))).
