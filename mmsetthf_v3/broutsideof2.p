...
thf(cbroutsideof2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XP @ (ccfv @ XN @ ccee)) & (cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee)))) => ((cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof) <=> ((XA2 != XP) & (XB2 != XP) & ((cwbr @ XA2 @ (ccop @ XP @ XB2) @ ccbtwn) | (cwbr @ XB2 @ (ccop @ XP @ XA2) @ ccbtwn)))))))))).
