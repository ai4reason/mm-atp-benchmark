...
thf(cmulgcd_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccn0) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccgcd) = (cco @ XK @ (cco @ XM @ XN @ ccgcd) @ ccmul))))))).
