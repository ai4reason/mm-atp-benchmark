...
thf(cdvge0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ ccc0 @ ccpnf @ ccico) @ (cco @ ccr @ XF @ ccdv))) => ((Xph => (cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (cwcel @ XY @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (cwbr @ XX @ XY @ ccle)) => (Xph => (cwbr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccle)))))))))))))))).
