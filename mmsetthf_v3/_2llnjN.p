...
thf(c_2llnjN_conj,conjecture,(! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XN = (ccfv @ XK @ cclln)) => ((XP = (ccfv @ XK @ cclpl)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XN) & (cwcel @ XY @ XN) & (cwcel @ XW @ XP)) & ((cwbr @ XX @ XW @ Xc_le) & (cwbr @ XY @ XW @ Xc_le) & (XX != XY))) => ((cco @ XX @ XY @ Xc_or) = XW))))))))))))))).
