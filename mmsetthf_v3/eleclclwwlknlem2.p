...
thf(aeleclclwwlknlem1_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xm:$i] : (! [Xn:$i] : ((XW @ Xm @ Xn) = (cco @ XN @ XG @ ccclwwlkn)))) => (! [Xm:$i] : (! [Xn:$i] : (((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) & ((cwcel @ XX @ (XW @ Xm @ Xn)) & (cwcel @ XY @ (XW @ Xm @ Xn)))) => (((XX = (cco @ XY @ XK @ cccsh)) & (cwrex @ (^ [Xm:$i] : (XZ = (cco @ XY @ (ccv @ Xm) @ cccsh))) @ (^ [Xm:$i] : (cco @ ccc0 @ XN @ ccfz)))) => (cwrex @ (^ [Xn:$i] : (XZ = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))))))).
