...
thf(careacirclem5_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccr) & (cwcel @ (ccv @ Xy1) @ ccr)) & (cwbr @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ XR @ cc2 @ ccexp) @ ccle)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (((cwcel @ XR @ ccr) & (cwbr @ ccc0 @ XR @ ccle) & (cwcel @ (ccv @ Xt) @ ccr)) => ((ccima @ (XS @ Xx3 @ Xy1) @ (ccsn @ (ccv @ Xt))) = (ccif @ (cwbr @ (ccfv @ (ccv @ Xt) @ ccabs) @ XR @ ccle) @ (cco @ (ccneg @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt)) @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccicc) @ cc0)))))))))).
