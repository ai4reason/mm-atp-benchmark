...
thf(cressffth_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XD = (cco @ XC @ XS @ ccress)) => ((XI = (ccfv @ XD @ ccidfu)) => (((cwcel @ XC @ cccat) & (cwcel @ XS @ XV)) => (cwcel @ XI @ (ccin @ (cco @ XD @ XC @ ccful) @ (cco @ XD @ XC @ ccfth)))))))))))).
