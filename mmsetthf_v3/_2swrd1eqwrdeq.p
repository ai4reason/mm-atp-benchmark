...
thf(c_2swrd1eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV)) & (cwbr @ ccc0 @ (ccfv @ XW @ cchash) @ cclt)) => ((XW = XU) <=> (((ccfv @ XW @ cchash) = (ccfv @ XU @ cchash)) & (((cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) = (cco @ XU @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr)) & ((ccfv @ XW @ cclsw) = (ccfv @ XU @ cclsw)))))))))).
