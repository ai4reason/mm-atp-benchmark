...
thf(awlklnwwlkn_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XG @ ccuspgr) => ((? [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = XN))) <=> (cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn)))))))).
...
thf(cwlkwwlksur_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((XT = (ccrab @ (^ [Xp:$i] : (((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN) & ((ccfv @ ccc0 @ (ccfv @ (ccv @ Xp) @ cc2nd)) = XP))) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks)))) => ((! [Xw:$i] : ((XW @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XP)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd))))) => (! [Xw:$i] : (! [Xt:$i] : (! [Xp:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XP @ (XV @ Xp)) & (cwcel @ XN @ ccn0)) => (cwfo @ XT @ (XW @ Xw) @ (XF @ Xt))))))))))))))))).
