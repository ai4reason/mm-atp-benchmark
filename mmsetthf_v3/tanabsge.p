...
thf(atan0_thm,axiom,((ccfv @ ccc0 @ cctan) = ccc0)).
thf(cwor_tp,type,(cwor : (($i > $o) > (($i > $o) > $o)))).
thf(alttri4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) | (XA2 = XB2) | (cwbr @ XB2 @ XA2 @ cclt)))))).
thf(ctanabsge_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => (cwbr @ (ccfv @ XA2 @ ccabs) @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccabs) @ ccle)))).
