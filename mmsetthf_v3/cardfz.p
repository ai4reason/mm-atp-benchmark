...
thf(ccardfz_conj,conjecture,(! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : ((cwcel @ (XN @ Xx3) @ ccn0) => ((ccfv @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ cccrd) = (ccfv @ (XN @ Xx3) @ (cccnv @ (XG @ Xx3)))))))))).
