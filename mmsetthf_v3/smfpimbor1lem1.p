...
thf(asalunicl_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XT @ (ccpw @ XS))) => ((Xph => (cwbr @ XT @ ccom @ ccdom)) => (Xph => (cwcel @ (ccuni @ XT) @ XS))))))))).
...
thf(asmfresal_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((XD = (ccdm @ XF)) => ((! [Xe:$i] : ((XT @ Xe) = (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xe)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xe:$i] : (ccpw @ ccr))))) => (! [Xe:$i] : (Xph => (cwcel @ (XT @ Xe) @ ccsalg))))))))))))).
...
thf(asmfpimioo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((XD = (ccdm @ XF)) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => (Xph => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ XS @ XD @ ccrest))))))))))))))).
...
thf(csmfpimbor1lem1_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((XD = (ccdm @ XF)) => ((! [Xe:$i] : ((XJ @ Xe) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xe:$i] : (Xph => (cwcel @ (XG @ Xe) @ (XJ @ Xe)))) => ((! [Xe:$i] : ((XT @ Xe) = (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xe)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xe:$i] : (ccpw @ ccr))))) => (! [Xe:$i] : (Xph => (cwcel @ (XG @ Xe) @ (XT @ Xe)))))))))))))))))).
