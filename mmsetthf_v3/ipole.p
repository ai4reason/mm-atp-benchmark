...
thf(cipole_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XF @ ccipo)) => ((Xc_le = (ccfv @ XI @ ccple)) => (((cwcel @ XF @ XV) & (cwcel @ XX @ XF) & (cwcel @ XY @ XF)) => ((cwbr @ XX @ XY @ Xc_le) <=> (cwss @ XX @ XY)))))))))))).
