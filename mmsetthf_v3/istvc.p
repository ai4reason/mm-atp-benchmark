...
thf(adf_tvc_ax,axiom,(cctvc = (ccrab @ (^ [Xw:$i] : (cwcel @ (ccfv @ (ccv @ Xw) @ ccsca) @ cctdrg)) @ (^ [Xw:$i] : cctlm)))).
thf(cistvc_conj,conjecture,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ cctvc) <=> ((cwcel @ XW @ cctlm) & (cwcel @ XF @ cctdrg))))))).
