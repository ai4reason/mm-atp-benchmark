...
thf(adibdmN_thm,axiom,(! [XB2:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ XK @ cclh))) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => (! [Xx3:$i] : (((cwcel @ XK @ (XV @ Xx3)) & (cwcel @ XW @ (XH @ Xx3))) => ((ccdm @ (XI @ Xx3)) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XW @ Xc_le)) @ (^ [Xx3:$i] : XB2))))))))))))))))).
...
thf(cdibglbN_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XK @ ccglb)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => (! [Xx3:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwss @ XS @ (ccdm @ (XI @ Xx3))) & (XS != cc0))) => ((ccfv @ (ccfv @ XS @ XG) @ (XI @ Xx3)) = (cciin @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XI @ Xx3))))))))))))))))).
