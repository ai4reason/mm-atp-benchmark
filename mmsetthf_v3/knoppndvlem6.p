...
thf(aknoppndvlem5_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xi:$i] : ((XT @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xy1 @ Xi @ Xn) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3 @ Xi) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xi) @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xi)) @ ccmul)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xi) @ ccr)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3 @ Xi) @ ccr)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XN @ Xi) @ ccn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwcel @ (ccsu @ (cco @ ccc0 @ (XJ @ Xx3) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ (XA2 @ Xi) @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ ccr)))))))))))))))))).
thf(cknoppndvlem6_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xi:$i] : ((XT @ Xx3 @ Xw @ Xi) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xy1 @ Xn) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3 @ Xw @ Xi) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xw @ Xi) @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xw @ Xi)) @ ccmul))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XW @ Xx3 @ Xy1 @ Xw @ Xi @ Xn) = (ccmpt @ (^ [Xw:$i] : ccr) @ (^ [Xw:$i] : (ccsu @ ccn0 @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ (ccv @ Xw) @ (XF @ Xx3 @ Xy1 @ Xn))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : (XA2 = (cco @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xw @ Xi) @ ccmul) @ (ccneg @ (XJ @ Xx3 @ Xw)) @ ccexp) @ cc2 @ ccdiv) @ (XM @ Xx3 @ Xy1 @ Xw @ Xi @ Xn) @ ccmul))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3 @ Xw @ Xi) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)))))) => ((! [Xx3:$i] : (! [Xw:$i] : ((Xph @ Xx3) => (cwcel @ (XJ @ Xx3 @ Xw) @ ccn0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwcel @ (XM @ Xx3 @ Xy1 @ Xw @ Xi @ Xn) @ ccz))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XN @ Xw @ Xi) @ ccn))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xx3) => ((ccfv @ XA2 @ (XW @ Xx3 @ Xy1 @ Xw @ Xi @ Xn)) = (ccsu @ (cco @ ccc0 @ (XJ @ Xx3 @ Xw) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1 @ Xn)))))))))))))))))))))))))))))).
