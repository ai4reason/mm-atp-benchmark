...
thf(cresf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccdif @ XB2 @ (ccsn @ XZ))) @ XC)) @ (^ [Xf1:$i] : (cco @ XB2 @ XA2 @ ccmap)))) => ((! [Xf1:$i] : ((XF @ Xf1) = (ccmpt @ (^ [Xf1:$i] : XX) @ (^ [Xf1:$i] : (ccres @ (ccv @ Xf1) @ XC))))) => (! [Xf1:$i] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwss @ XC @ XA2)) & (cwcel @ XZ @ XB2)) => (cwf1o @ XX @ (cco @ XB2 @ XC @ ccmap) @ (XF @ Xf1))))))))))))))).
