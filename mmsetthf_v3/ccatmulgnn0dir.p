...
thf(cccatmulgnn0dir_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccxp @ (cco @ ccc0 @ XM @ ccfzo) @ (ccsn @ XK))) => ((XB2 = (ccxp @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XK))) => ((XC = (ccxp @ (cco @ ccc0 @ (cco @ XM @ XN @ ccaddc) @ ccfzo) @ (ccsn @ XK))) => ((Xph => (cwcel @ XK @ XS)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ XA2 @ XB2 @ ccconcat) = XC))))))))))))))))).
