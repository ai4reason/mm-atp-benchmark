...
thf(ciunrelexp0_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XR @ XV) & (cwss @ XZ @ ccn0) & ((ccin @ (ccpr @ ccc0 @ cc1) @ XZ) != cc0)) => ((cco @ (cciun @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (cco @ XR @ (ccv @ Xx3) @ ccrelexp))) @ ccc0 @ ccrelexp) = (cco @ XR @ ccc0 @ ccrelexp))))))).
