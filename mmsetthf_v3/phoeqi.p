...
thf(aip2eqi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XA2 @ XP) = (cco @ (ccv @ Xx3) @ XB2 @ XP))) @ (^ [Xx3:$i] : XX)) <=> (XA2 = XB2)))))))))))).
...
thf(cphoeqi_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (XX = (ccfv @ (XU @ Xy1) @ ccba))) => ((! [Xy1:$i] : ((XP @ Xy1) = (ccfv @ (XU @ Xy1) @ ccdip))) => ((! [Xy1:$i] : (cwcel @ (XU @ Xy1) @ cccphlo)) => (((cwf @ XY @ XX @ XS) & (cwf @ XY @ XX @ XT)) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XS) @ (XP @ Xy1)) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ (XP @ Xy1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX)) <=> (XS = XT))))))))))))).
