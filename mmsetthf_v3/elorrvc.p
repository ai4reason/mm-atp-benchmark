...
thf(arrvdm_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => (Xph => ((ccdm @ XX) = (ccuni @ (ccdm @ XP)))))))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aelorvc_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwfun @ XX))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XX @ (XV @ Xz)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XA2 @ (XW @ Xz)))) => (! [Xz:$i] : (((Xph @ Xz) & (cwcel @ (ccv @ Xz) @ (ccdm @ XX))) => ((cwcel @ (ccv @ Xz) @ (cco @ XX @ XA2 @ (ccorvc @ XR))) <=> (cwbr @ (ccfv @ (ccv @ Xz) @ XX) @ XA2 @ XR)))))))))))))).
thf(arrvfn_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => (Xph => (cwfn @ XX @ (ccuni @ (ccdm @ XP)))))))))).
