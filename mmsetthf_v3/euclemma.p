...
thf(aordvdsmul_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (((cwbr @ XK @ XM @ ccdvds) | (cwbr @ XK @ XN @ ccdvds)) => (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds))))))).
thf(ceuclemma_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XP @ (cco @ XM @ XN @ ccmul) @ ccdvds) <=> ((cwbr @ XP @ XM @ ccdvds) | (cwbr @ XP @ XN @ ccdvds)))))))).
