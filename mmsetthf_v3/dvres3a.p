...
thf(advres2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((((cwss @ XS @ ccc) & (cwf @ XA2 @ ccc @ XF)) & ((cwss @ XA2 @ XS) & (cwss @ XB2 @ XS))) => (cwss @ (ccres @ (cco @ XS @ XF @ ccdv) @ XB2) @ (cco @ XB2 @ (ccres @ XF @ XB2) @ ccdv)))))))).
