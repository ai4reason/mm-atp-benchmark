...
thf(asumnnodd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccn @ ccc @ XF)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn) & (cwcel @ (cco @ (ccv @ Xk) @ cc2 @ ccdiv) @ ccn)) => ((ccfv @ (ccv @ Xk) @ XF) = ccc0))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ cc1) @ (XB2 @ Xk) @ ccli))) => (! [Xk:$i] : (Xph => ((cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ XF))) @ cc1) @ (XB2 @ Xk) @ ccli) & ((ccsu @ ccn @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) = (ccsu @ ccn @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ XF)))))))))))))).
...
thf(advresioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwf @ XA2 @ ccc @ XF)) => ((cco @ ccr @ (ccres @ XF @ (cco @ XB2 @ XC @ ccioo)) @ ccdv) = (ccres @ (cco @ ccr @ XF @ ccdv) @ (cco @ XB2 @ XC @ ccioo))))))))).
...
thf(acncfuni_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ (ccuni @ XB2))) => ((! [Xb:$i] : ((Xph & (cwcel @ (ccv @ Xb) @ XB2)) => (cwcel @ (ccin @ XA2 @ (ccv @ Xb)) @ (cco @ (ccfv @ cccnfld @ cctopn) @ XA2 @ ccrest)))) => ((! [Xb:$i] : ((Xph & (cwcel @ (ccv @ Xb) @ XB2)) => (cwcel @ (ccres @ XF @ (ccv @ Xb)) @ (cco @ (ccin @ XA2 @ (ccv @ Xb)) @ ccc @ cccncf)))) => (Xph => (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf))))))))))))).
...
thf(ajumpncnp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XK = (ccfv @ cccnfld @ cctopn)) => ((Xph => (cwss @ XA2 @ ccr)) => ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XB2 @ (ccfv @ (ccin @ XA2 @ (cco @ ccmnf @ XB2 @ ccioo)) @ (ccfv @ XJ @ cclp)))) => ((Xph => (cwcel @ XB2 @ (ccfv @ (ccin @ XA2 @ (cco @ XB2 @ ccpnf @ ccioo)) @ (ccfv @ XJ @ cclp)))) => ((Xph => (cwcel @ XL @ (cco @ (ccres @ XF @ (cco @ ccmnf @ XB2 @ ccioo)) @ XB2 @ cclimc))) => ((Xph => (cwcel @ XR @ (cco @ (ccres @ XF @ (cco @ XB2 @ ccpnf @ ccioo)) @ XB2 @ cclimc))) => ((Xph => (XL != XR)) => (Xph => (~ (cwcel @ XF @ (ccfv @ XB2 @ (cco @ XJ @ (ccfv @ cccnfld @ cctopn) @ cccnp)))))))))))))))))))))))).
thf(asyl6eleq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((XB2 = XC) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(alptioo2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwcel @ XB2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (ccfv @ XJ @ cclp))))))))))))).
...
thf(alptioo1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwcel @ XA2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (ccfv @ XJ @ cclp))))))))))))).
thf(apnfxr_thm,axiom,(cwcel @ ccpnf @ ccxr)).
thf(altpnfd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwbr @ XA2 @ ccpnf @ cclt)))))).
thf(cwnfc_tp,type,(cwnfc : (($i > ($i > $o)) > $o))).
thf(aconstlimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)))) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XC @ Xx3) @ ccc))) => (! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (cco @ (XF @ Xx3) @ (XC @ Xx3) @ cclimc)))))))))))))).
...
thf(aiocssre_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccr)) => (cwss @ (cco @ XA2 @ XB2 @ ccioc) @ ccr))))).
...
thf(advcnp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (cco @ XK @ XA2 @ ccrest)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((((cwss @ XS @ ccc) & (cwf @ XA2 @ ccc @ XF) & (cwss @ XA2 @ XS)) & (cwcel @ XB2 @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => (cwcel @ XF @ (ccfv @ XB2 @ (cco @ XJ @ XK @ cccnp))))))))))))).
...
thf(aelprn1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccpr @ XB2 @ XC)) & (XA2 != XB2)) => (XA2 = XC)))))).
...
thf(alimcresioolb_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccxr)) => ((Xph => (cwbr @ XB2 @ XC @ cclt)) => ((Xph => (cwss @ (cco @ XB2 @ XC @ ccioo) @ XA2)) => ((Xph => (cwcel @ XD @ ccxr)) => ((Xph => (cwbr @ XC @ XD @ ccle)) => (Xph => ((cco @ (ccres @ XF @ (cco @ XB2 @ XC @ ccioo)) @ XB2 @ cclimc) = (cco @ (ccres @ XF @ (cco @ XB2 @ XD @ ccioo)) @ XB2 @ cclimc))))))))))))))))).
...
thf(aicogelb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) => (cwbr @ XA2 @ XC @ ccle)))))).
...
thf(aiooin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) => ((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XC @ XD @ ccioo)) = (cco @ (ccif @ (cwbr @ XA2 @ XC @ ccle) @ XC @ XA2) @ (ccif @ (cwbr @ XB2 @ XD @ ccle) @ XB2 @ XD) @ ccioo)))))))).
...
thf(alimcresiooub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XB2 @ XC @ cclt)) => ((Xph => (cwss @ (cco @ XB2 @ XC @ ccioo) @ XA2)) => ((Xph => (cwcel @ XD @ ccxr)) => ((Xph => (cwbr @ XD @ XB2 @ ccle)) => (Xph => ((cco @ (ccres @ XF @ (cco @ XB2 @ XC @ ccioo)) @ XC @ cclimc) = (cco @ (ccres @ XF @ (cco @ XD @ XC @ ccioo)) @ XC @ cclimc))))))))))))))))).
...
thf(altmod_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XA2 @ ccico))) => (Xph => (cwbr @ (cco @ XC @ XB2 @ ccmo) @ (cco @ XA2 @ XB2 @ ccmo) @ cclt)))))))))).
...
thf(altsub1dd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin) @ cclt))))))))))).
...
thf(aubioc1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ cclt)) => (cwcel @ XB2 @ (cco @ XA2 @ XB2 @ ccioc)))))).
...
thf(altsub2dd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwbr @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ cclt))))))))))).
...
thf(altaddsublt_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwbr @ XB2 @ XC @ cclt) <=> (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccmin) @ XA2 @ cclt))))))).
...
thf(aaddgegt0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ ccc0 @ XB2 @ cclt)) => (Xph => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt)))))))))).
thf(ccvol_tp,type,(ccvol : ($i > $o))).
thf(ccibl_tp,type,(ccibl : ($i > $o))).
thf(asqwvfoura_thm,axiom,(! [Xph:$o] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XT @ Xx3) = (cco @ cc2 @ ccpi @ ccmul))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (XT @ Xx3) @ ccmo) @ ccpi @ cclt) @ cc1 @ (ccneg @ cc1)))))) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ (ccfv @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv) = ccc0)))))))))).
thf(asqwvfourb_thm,axiom,(! [Xph:$o] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XT @ Xx3) = (cco @ cc2 @ ccpi @ ccmul))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (XT @ Xx3) @ ccmo) @ ccpi @ cclt) @ cc1 @ (ccneg @ cc1)))))) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => ((cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ (ccfv @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv) = (ccif @ (cwbr @ cc2 @ XN @ ccdvds) @ ccc0 @ (cco @ cc4 @ (cco @ XN @ ccpi @ ccmul) @ ccdiv)))))))))))).
...
thf(aoddp1even_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwbr @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccdvds))))).
...
thf(afourierswlem_thm,axiom,(! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((XT = (cco @ cc2 @ ccpi @ ccmul)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ XT @ ccmo) @ ccpi @ cclt) @ cc1 @ (ccneg @ cc1)))))) => ((cwcel @ XX @ ccr) => ((! [Xx3:$i] : ((XY @ Xx3) = (ccif @ ((cco @ XX @ ccpi @ ccmo) = ccc0) @ ccc0 @ (ccfv @ XX @ (XF @ Xx3))))) => (! [Xx3:$i] : ((XY @ Xx3) = (cco @ (cco @ (ccif @ (cwcel @ (cco @ XX @ XT @ ccmo) @ (cco @ ccc0 @ ccpi @ ccioc)) @ cc1 @ (ccneg @ cc1)) @ (ccfv @ XX @ (XF @ Xx3)) @ ccaddc) @ cc2 @ ccdiv)))))))))))).
...
thf(cfouriersw_conj,conjecture,(! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xn:$i] : ((XT @ Xk @ Xn) = (cco @ cc2 @ ccpi @ ccmul)))) => ((! [Xk:$i] : (! [Xn:$i] : ((XF @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (XT @ Xk @ Xn) @ ccmo) @ ccpi @ cclt) @ cc1 @ (ccneg @ cc1))))))) => ((cwcel @ XX @ ccr) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XS @ Xx3 @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccmin) @ XX @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccmin) @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XY @ Xx3 @ Xn) = (ccif @ ((cco @ XX @ ccpi @ ccmo) = ccc0) @ ccc0 @ (ccfv @ XX @ (XF @ Xk))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (((cco @ (cco @ cc4 @ ccpi @ ccdiv) @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ XX @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ ccdiv))) @ ccmul) = (XY @ Xx3 @ Xn)) & (cwbr @ (ccseq @ ccaddc @ (XS @ Xx3 @ Xk @ Xn) @ cc1) @ (cco @ (cco @ ccpi @ cc4 @ ccdiv) @ (XY @ Xx3 @ Xn) @ ccmul) @ ccli)))))))))))))))).
