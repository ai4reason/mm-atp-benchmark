...
thf(ccnapbmcpd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ ccc) & (cwcel @ XD @ ccc))) => ((cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccmin) @ XD @ ccaddc) = (cco @ (cco @ (cco @ XA2 @ XD @ ccaddc) @ XB2 @ ccaddc) @ XC @ ccmin)))))))).
