...
thf(cbj_bary1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (XA2 != XB2)) => ((Xph => (cwcel @ XS @ ccc)) => ((Xph => (cwcel @ XT @ ccc)) => (Xph => (((XX = (cco @ (cco @ XS @ XA2 @ ccmul) @ (cco @ XT @ XB2 @ ccmul) @ ccaddc)) & ((cco @ XS @ XT @ ccaddc) = cc1)) <=> ((XS = (cco @ (cco @ XB2 @ XX @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv)) & (XT = (cco @ (cco @ XX @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv)))))))))))))))))).
