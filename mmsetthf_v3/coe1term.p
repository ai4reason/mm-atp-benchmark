...
thf(ccoe1term_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ XA2 @ (cco @ (ccv @ Xz) @ XN @ ccexp) @ ccmul))))) => (! [Xz:$i] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0) & (cwcel @ (XM @ Xz) @ ccn0)) => ((ccfv @ (XM @ Xz) @ (ccfv @ (XF @ Xz) @ cccoe)) = (ccif @ ((XM @ Xz) = XN) @ XA2 @ ccc0)))))))))).
