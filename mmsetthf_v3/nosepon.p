...
thf(cnosepon_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur) & (XA2 != XB2)) => (cwcel @ (ccint @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) != (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccon0))) @ ccon0))))).
