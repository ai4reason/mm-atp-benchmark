...
thf(cshftdm_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwcel @ XA2 @ ccc) => ((ccdm @ (cco @ XF @ XA2 @ ccshi)) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccdm @ XF))) @ (^ [Xx3:$i] : ccc)))))))).
