...
thf(amulgnn_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XS = (ccseq @ Xc_pl @ (ccxp @ ccn @ (ccsn @ XX)) @ cc1)) => (((cwcel @ XN @ ccn) & (cwcel @ XX @ XB2)) => ((cco @ XN @ XX @ Xc_x) = (ccfv @ XN @ XS))))))))))))))).
...
thf(asubginv_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((XI = (ccfv @ XG @ ccminusg)) => ((XJ = (ccfv @ XH @ ccminusg)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XX @ XS)) => ((ccfv @ XX @ XI) = (ccfv @ XX @ XJ))))))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(amulgval_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XI = (ccfv @ XG @ ccminusg)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XS = (ccseq @ Xc_pl @ (ccxp @ ccn @ (ccsn @ XX)) @ cc1)) => (((cwcel @ XN @ ccz) & (cwcel @ XX @ XB2)) => ((cco @ XN @ XX @ Xc_x) = (ccif @ (XN = ccc0) @ Xc_0 @ (ccif @ (cwbr @ ccc0 @ XN @ cclt) @ (ccfv @ XN @ XS) @ (ccfv @ (ccfv @ (ccneg @ XN) @ XS) @ XI))))))))))))))))))))).
...
thf(csubgmulg_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_x = (ccfv @ XG @ ccmg)) => ((XH = (cco @ XG @ XS @ ccress)) => ((Xc_xb = (ccfv @ XH @ ccmg)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XN @ ccz) & (cwcel @ XX @ XS)) => ((cco @ XN @ XX @ Xc_x) = (cco @ XN @ XX @ Xc_xb)))))))))))))).
