...
thf(aplusfreseq_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((Xc_pd = (ccfv @ XM @ ccplusf)) => ((cwnel @ cc0 @ (ccrn @ Xc_pd)) => ((ccres @ Xc_pl @ (ccxp @ XB2 @ XB2)) = Xc_pd)))))))))).
