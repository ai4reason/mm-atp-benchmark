...
thf(csshhococi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ cchil) => ((cwss @ XB2 @ cchil) => ((cco @ XA2 @ XB2 @ cchj) = (cco @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccort) @ (ccfv @ (ccfv @ XB2 @ ccort) @ ccort) @ cchj))))))).
