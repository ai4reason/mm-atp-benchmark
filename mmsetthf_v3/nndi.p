...
thf(cnndi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccomu) = (cco @ (cco @ XA2 @ XB2 @ ccomu) @ (cco @ XA2 @ XC @ ccomu) @ ccoa))))))).
