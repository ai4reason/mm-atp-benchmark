...
thf(assclem_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwfn @ XH @ (ccxp @ XS @ XS))) => (Xph => ((cwcel @ XH @ ccvv) <=> (cwcel @ XS @ ccvv)))))))).
thf(cssc1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwfn @ XH @ (ccxp @ XS @ XS))) => ((Xph => (cwfn @ XJ @ (ccxp @ XT @ XT))) => ((Xph => (cwbr @ XH @ XJ @ ccssc)) => (Xph => (cwss @ XS @ XT))))))))))).
