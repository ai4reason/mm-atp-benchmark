...
thf(cdfon2lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((! [Xx3:$i] : (((cwpss @ (ccv @ Xx3) @ XA2) & (cwtr @ (ccv @ Xx3))) => (cwcel @ (ccv @ Xx3) @ XA2))) & (! [Xy1:$i] : (((cwpss @ (ccv @ Xy1) @ XB2) & (cwtr @ (ccv @ Xy1))) => (cwcel @ (ccv @ Xy1) @ XB2)))) => ((cwss @ XA2 @ XB2) | (cwss @ XB2 @ XA2)))))))).
