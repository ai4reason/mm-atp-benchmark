...
thf(afprodp1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (((ccv @ Xk) = (cco @ XN @ cc1 @ ccaddc)) => ((XA2 @ Xk) = XB2))) => (Xph => ((ccprod @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) = (cco @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XB2 @ ccmul)))))))))))).
...
thf(cfmtnorec2lem_conj,conjecture,(! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccn0) => (((ccfv @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfmtno) = (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (ccv @ Xy1) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc)) => ((ccfv @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ ccfmtno) = (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc)))))).
