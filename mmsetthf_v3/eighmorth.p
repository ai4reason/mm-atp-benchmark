...
thf(ceighmorth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((((cwcel @ XT @ ccho) & (cwcel @ XA2 @ (ccfv @ XT @ ccei))) & ((cwcel @ XB2 @ (ccfv @ XT @ ccei)) & ((ccfv @ XA2 @ (ccfv @ XT @ ccel)) != (ccfv @ XB2 @ (ccfv @ XT @ ccel))))) => ((cco @ XA2 @ XB2 @ ccsp) = ccc0)))))).
