...
thf(alhop1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XG)) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => ((ccdm @ (cco @ ccr @ XG @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ ccc0 @ (cco @ XF @ XA2 @ cclimc))) => ((Xph => (cwcel @ ccc0 @ (cco @ XG @ XA2 @ cclimc))) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ XG)))) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XG @ ccdv))))) => ((Xph => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv))) @ XA2 @ cclimc))) => (Xph => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xz) @ XG) @ ccdiv))) @ XA2 @ cclimc)))))))))))))))))))))).
...
thf(alimcrecl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ (ccfv @ cccnfld @ cctopn) @ cclp)))) => ((Xph => (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => (Xph => (cwcel @ XL @ ccr)))))))))))).
...
thf(asublimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccmin))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XE @ Xx3) @ (cco @ (XF @ Xx3) @ (XD @ Xx3) @ cclimc)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XI @ Xx3) @ (cco @ (XG @ Xx3) @ (XD @ Xx3) @ cclimc)))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ (XE @ Xx3) @ (XI @ Xx3) @ ccmin) @ (cco @ (XH @ Xx3) @ (XD @ Xx3) @ cclimc)))))))))))))))))))))).
thf(alimcco_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) & ((XR @ Xx3) != XC))) => (cwcel @ (XR @ Xx3) @ XB2)))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (cwcel @ (XS @ Xy1) @ ccc))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XR @ Xx3))) @ (XX @ Xx3 @ Xy1) @ cclimc))))) => ((Xph => (cwcel @ XD @ (cco @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (XS @ Xy1))) @ XC @ cclimc))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XR @ Xx3)) => ((XS @ Xy1) = (XT @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) & ((XR @ Xx3) = XC))) => ((XT @ Xx3) = XD)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XD @ (cco @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XT @ Xx3))) @ (XX @ Xx3 @ Xy1) @ cclimc))))))))))))))))))))).
thf(aadantrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((Xph & (Xps & Xth)) => Xch))))))).
thf(aeqeltrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(aaddlimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccaddc))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XE @ Xx3) @ (cco @ (XF @ Xx3) @ (XD @ Xx3) @ cclimc)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XI @ Xx3) @ (cco @ (XG @ Xx3) @ (XD @ Xx3) @ cclimc)))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ (XE @ Xx3) @ (XI @ Xx3) @ ccaddc) @ (cco @ (XH @ Xx3) @ (XD @ Xx3) @ cclimc)))))))))))))))))))))).
...
thf(aidlimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((Xph => (cwcel @ XX @ ccc)) => (! [Xx3:$i] : (Xph => (cwcel @ XX @ (cco @ (XF @ Xx3) @ XX @ cclimc)))))))))))).
