...
thf(clsmless1x_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((((cwcel @ XG @ XV) & (cwss @ XT @ XB2) & (cwss @ XU @ XB2)) & (cwss @ XR @ XT)) => (cwss @ (cco @ XR @ XU @ Xc_po) @ (cco @ XT @ XU @ Xc_po))))))))))))).
