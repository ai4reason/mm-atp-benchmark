...
thf(cfrgpcpbl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((XG = (ccfv @ XI @ ccfrgp)) => ((XM = (ccfv @ (ccxp @ XI @ cc2o) @ ccfrmd)) => ((Xc_sm = (ccfv @ XI @ ccefg)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => (((cwbr @ XA2 @ XC @ Xc_sm) & (cwbr @ XB2 @ XD @ Xc_sm)) => (cwbr @ (cco @ XA2 @ XB2 @ Xc_pl) @ (cco @ XC @ XD @ Xc_pl) @ Xc_sm)))))))))))))))).
