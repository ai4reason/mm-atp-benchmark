...
thf(cghmlin_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XS @ ccbs)) => ((Xc_pl = (ccfv @ XS @ ccplusg)) => ((Xc_pd = (ccfv @ XT @ ccplusg)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XU @ XX) & (cwcel @ XV @ XX)) => ((ccfv @ (cco @ XU @ XV @ Xc_pl) @ XF) = (cco @ (ccfv @ XU @ XF) @ (ccfv @ XV @ XF) @ Xc_pd))))))))))))))).
