...
thf(asspid_thm,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : ((XH = (ccfv @ XU @ ccss)) => ((cwcel @ XU @ ccnv) => (cwcel @ XU @ XH)))))).
thf(assid_thm,axiom,(! [XA2:($i > $o)] : (cwss @ XA2 @ XA2))).
thf(asimpri_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(chhsssh_conj,conjecture,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XH @ ccsh) <=> ((cwcel @ XW @ (ccfv @ XU @ ccss)) & (cwss @ XH @ cchil))))))))).
