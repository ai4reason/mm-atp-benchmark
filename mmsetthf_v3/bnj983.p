...
thf(a_19_42_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => (! [Xx3:$i] : ((? [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3))) <=> ((Xph @ Xx3) & (? [Xx3:$i] : (Xps @ Xx3))))))))).
...
thf(cbnj983_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xf1 @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ XA2 @ XR @ XX)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xf1 @ Xi @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XD @ Xy1 @ Xf1 @ Xn) = (ccdif @ ccom @ (ccsn @ cc0)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XB2 @ Xy1 @ Xf1 @ Xi @ Xn) = (^ [Xf1:$i] : (cwrex @ (^ [Xn:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) & (Xph @ Xy1 @ Xf1 @ Xn) & (Xps @ Xy1 @ Xf1 @ Xi @ Xn))) @ (^ [Xn:$i] : (XD @ Xy1 @ Xf1 @ Xn))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xch @ Xy1 @ Xf1 @ Xi @ Xn) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xn) @ (XD @ Xy1 @ Xf1 @ Xn)) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xy1 @ Xf1 @ Xn) @ (Xps @ Xy1 @ Xf1 @ Xi @ Xn))))))) => (! [Xy1:$i] : ((cwcel @ (XZ @ Xy1) @ (cc_bnj18 @ XA2 @ XR @ XX)) <=> (? [Xf1:$i] : (? [Xn:$i] : (? [Xi:$i] : ((Xch @ Xy1 @ Xf1 @ Xi @ Xn) & (cwcel @ (ccv @ Xi) @ (ccv @ Xn)) & (cwcel @ (XZ @ Xy1) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)))))))))))))))))))))))).
