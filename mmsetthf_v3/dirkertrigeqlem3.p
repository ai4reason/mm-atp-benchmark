...
thf(adirkertrigeqlem1_thm,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn) => ((ccsu @ (cco @ cc1 @ (cco @ cc2 @ XK @ ccmul) @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ ccpi @ ccmul) @ cccos))) = ccc0)))).
...
thf(asinppi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ XA2 @ ccpi @ ccaddc) @ ccsin) = (ccneg @ (ccfv @ XA2 @ ccsin)))))).
...
thf(cdirkertrigeqlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((! [Xn:$i] : (Xph => (cwcel @ (XK @ Xn) @ ccz))) => ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ (cco @ (cco @ cc2 @ (XK @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccpi @ ccmul))) => (! [Xn:$i] : (Xph => ((cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (XA2 @ Xn) @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv) = (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (XA2 @ Xn) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (XA2 @ Xn) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))))).
