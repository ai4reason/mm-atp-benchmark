...
thf(cisconngr_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XV @ Xf1 @ Xp) = (ccfv @ XG @ ccvtx)))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xp:$i] : ((cwcel @ XG @ (XW @ Xf1 @ Xk @ Xn @ Xp)) => ((cwcel @ XG @ ccconngr) <=> (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ (ccfv @ XG @ ccpthson)))))) @ (^ [Xn:$i] : (XV @ Xf1 @ Xp)))) @ (^ [Xk:$i] : (XV @ Xf1 @ Xp)))))))))))))).
