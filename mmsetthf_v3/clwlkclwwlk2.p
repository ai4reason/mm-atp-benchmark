...
thf(cclwlkclwwlk2_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccuspgr) & (cwcel @ XP @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ (ccfv @ XG @ ccclwlks))) <=> (cwcel @ XP @ (ccfv @ XG @ ccclwwlk))))))))))).
