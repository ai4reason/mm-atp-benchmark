...
thf(cbrfi1indlem_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XV @ XW) & (cwcel @ XN @ XV) & (cwcel @ XY @ ccn0)) => (((ccfv @ XV @ cchash) = (cco @ XY @ cc1 @ ccaddc)) => ((ccfv @ (ccdif @ XV @ (ccsn @ XN)) @ cchash) = XY)))))))).
