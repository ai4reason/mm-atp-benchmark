...
thf(advdsrval_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xz:$i] : ((Xc_pa @ Xz) = (ccfv @ XR @ ccdsr))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (! [Xz:$i] : ((Xc_pa @ Xz) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) & (cwrex @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ (ccv @ Xx3) @ Xc_x) = (ccv @ Xy1))) @ (^ [Xz:$i] : XB2)))))))))))))))).
