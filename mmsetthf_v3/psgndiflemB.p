...
thf(agsmsymgrfix_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xi:$i] : ((XS @ Xi) = (ccfv @ XN @ ccsymg))) => ((! [Xi:$i] : (XB2 = (ccfv @ (XS @ Xi) @ ccbs))) => (! [Xi:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XK @ XN) & (cwcel @ XW @ (ccword @ XB2))) => ((cwral @ (^ [Xi:$i] : ((ccfv @ XK @ (ccfv @ (ccv @ Xi) @ XW)) = XK)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((ccfv @ XK @ (cco @ (XS @ Xi) @ XW @ ccgsu)) = XK)))))))))))).
