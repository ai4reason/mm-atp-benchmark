...
thf(cvtxduhgr0nedg_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : ((XE @ Xv) = (ccfv @ XG @ ccedg))) => ((! [Xv:$i] : ((XD @ Xv) = (ccfv @ XG @ ccvtxdg))) => (! [Xv:$i] : (((cwcel @ XG @ ccuhgr) & (cwcel @ XU @ XV) & ((ccfv @ XU @ (XD @ Xv)) = ccc0)) => (~ (cwrex @ (^ [Xv:$i] : (cwcel @ (ccpr @ XU @ (ccv @ Xv)) @ (XE @ Xv))) @ (^ [Xv:$i] : XV)))))))))))))).
