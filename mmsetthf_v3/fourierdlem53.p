...
thf(alimccog_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwss @ (ccrn @ XF) @ (ccdif @ (ccdm @ XG) @ (ccsn @ XB2)))) => ((Xph => (cwcel @ XB2 @ (cco @ XF @ XA2 @ cclimc))) => ((Xph => (cwcel @ XC @ (cco @ XG @ XB2 @ cclimc))) => (Xph => (cwcel @ XC @ (cco @ (cccom @ XG @ XF) @ XA2 @ cclimc))))))))))))).
...
thf(cfourierdlem53_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : XA2) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))))) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ XA2)) => (cwcel @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XB2))) => ((Xph => (cwss @ XB2 @ ccr)) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ XA2)) => ((ccv @ Xs1) != XD))) => ((! [Xs1:$i] : (Xph => (cwcel @ (XC @ Xs1) @ (cco @ (ccres @ XF @ XB2) @ (cco @ XX @ XD @ ccaddc) @ cclimc)))) => ((Xph => (cwcel @ XD @ ccc)) => (! [Xs1:$i] : (Xph => (cwcel @ (XC @ Xs1) @ (cco @ (XG @ Xs1) @ XD @ cclimc)))))))))))))))))))))).
