...
thf(azeqzmulgcd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ (ccv @ Xn) @ (cco @ XA2 @ XB2 @ ccgcd) @ ccmul))) @ (^ [Xn:$i] : ccz)))))).
...
thf(cdivgcdcoprmex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccz) & ((cwcel @ XB2 @ ccz) & (XB2 != ccc0)) & (XM = (cco @ XA2 @ XB2 @ ccgcd))) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((XA2 = (cco @ XM @ (ccv @ Xa) @ ccmul)) & (XB2 = (cco @ XM @ (ccv @ Xb) @ ccmul)) & ((cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccgcd) = cc1))) @ (^ [Xb:$i] : ccz))) @ (^ [Xa:$i] : ccz))))))).
