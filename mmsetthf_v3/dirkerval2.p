...
thf(adirker2re_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn) & (cwcel @ XS @ ccr)) & (~ ((cco @ XS @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0))) => (cwcel @ (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ XS @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ XS @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv) @ ccr))))).
