...
thf(alimcmo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp)))) => ((XK = (ccfv @ cccnfld @ cctopn)) => (Xph => (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XF @ XB2 @ cclimc))))))))))))))).
...
thf(aelpm2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwcel @ XF @ (cco @ XA2 @ XB2 @ ccpm)) <=> ((cwf @ (ccdm @ XF) @ XA2 @ XF) & (cwss @ (ccdm @ XF) @ XB2)))))))))).
