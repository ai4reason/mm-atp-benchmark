...
thf(amatinvgcell_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (ccfv @ XR @ ccminusg)) => ((XW = (ccfv @ XA2 @ ccminusg)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (ccfv @ XX @ XW)) = (ccfv @ (cco @ XI @ XJ @ XX) @ XV))))))))))))))))).
...
thf(ccpmatinvcl_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XS @ Xx3) = (cco @ XN @ XR @ cccpmat))) => ((! [Xx3:$i] : ((XP @ Xx3) = (ccfv @ XR @ ccpl1))) => ((! [Xx3:$i] : ((XC @ Xx3) = (cco @ XN @ (XP @ Xx3) @ ccmat))) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (XC @ Xx3) @ ccminusg)) @ (XS @ Xx3))) @ (^ [Xx3:$i] : (XS @ Xx3))))))))))))).
