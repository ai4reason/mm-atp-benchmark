...
thf(cuvcff_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XU = (cco @ XR @ XI @ ccuvc)) => ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XW)) => (cwf @ XI @ XB2 @ XU)))))))))))).
