...
thf(asqoddm1div8z_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds))) => (cwcel @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccz)))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(am1exp1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (((cco @ (ccneg @ cc1) @ XN @ ccexp) = cc1) <=> (cwbr @ cc2 @ XN @ ccdvds))))).
...
thf(algscl1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XA2 @ XN @ cclgs) @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1)))))).
...
thf(am1expo_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((cco @ (ccneg @ cc1) @ XN @ ccexp) = (ccneg @ cc1))))).
