...
thf(arngmgmbs4_thm,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwf @ (ccxp @ XX @ XX) @ XX @ XG) & (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xu) @ XG) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX))) => ((ccrn @ XG) = XX))))).
