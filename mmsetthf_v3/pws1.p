...
thf(aprds1_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccrg @ XR)) => (Xph => ((cccom @ ccur @ XR) = (ccfv @ XY @ ccur))))))))))))))).
...
thf(adf_ur_ax,axiom,(ccur = (cccom @ cc0g @ ccmgp))).
thf(aelex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ XB2) => (cwcel @ XA2 @ ccvv))))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(afcoconst_thm,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwfn @ XF @ XX) & (cwcel @ XY @ XX)) => ((cccom @ XF @ (ccxp @ XI @ (ccsn @ XY))) = (ccxp @ XI @ (ccsn @ (ccfv @ XY @ XF)))))))))).
...
thf(cpws1_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XV)) => ((ccxp @ XI @ (ccsn @ Xc_1)) = (ccfv @ XY @ ccur))))))))))).
