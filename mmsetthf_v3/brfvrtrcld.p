...
thf(cbrfvrtrcld_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XR @ ccvv))) => (! [Xn:$i] : ((Xph @ Xn) => ((cwbr @ XA2 @ XB2 @ (ccfv @ XR @ ccrtcl)) <=> (cwrex @ (^ [Xn:$i] : (cwbr @ XA2 @ XB2 @ (cco @ XR @ (ccv @ Xn) @ ccrelexp))) @ (^ [Xn:$i] : ccn0))))))))))).
