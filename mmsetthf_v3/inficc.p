...
thf(cinficc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwss @ XS @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (XS != cc0)) => (Xph => (cwcel @ (ccinf @ XS @ ccxr @ cclt) @ (cco @ XA2 @ XB2 @ ccicc)))))))))))).
