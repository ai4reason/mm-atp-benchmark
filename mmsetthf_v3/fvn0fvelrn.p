...
thf(afvressn_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((ccfv @ XX @ (ccres @ XF @ (ccsn @ XX))) = (ccfv @ XX @ XF))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(afvrnressn_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((cwcel @ (ccfv @ XX @ XF) @ (ccrn @ (ccres @ XF @ (ccsn @ XX)))) => (cwcel @ (ccfv @ XX @ XF) @ (ccrn @ XF)))))))).
thf(cfvn0fvelrn_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((ccfv @ XX @ XF) != cc0) => (cwcel @ (ccfv @ XX @ XF) @ (ccrn @ XF)))))).
