...
thf(cmarypha2lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XT @ Xx3) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xx3) @ XF)))))) => (! [Xx3:$i] : (((cwfn @ XF @ XA2) & (cwss @ XX @ XA2)) => ((ccima @ (XT @ Xx3) @ XX) = (ccuni @ (ccima @ XF @ XX))))))))))).
