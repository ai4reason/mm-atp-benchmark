...
thf(cxkoptsub_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XR)) => ((XJ = (ccfv @ (ccxp @ XX @ (ccsn @ XS)) @ ccpt)) => (((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) => (cwss @ (cco @ XJ @ (cco @ XR @ XS @ cccn) @ ccrest) @ (cco @ XS @ XR @ ccxko)))))))))).
