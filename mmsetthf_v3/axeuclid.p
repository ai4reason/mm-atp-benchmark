...
thf(aaxeuclidlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (((((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XT @ (ccfv @ XN @ ccee)))) & ((cwcel @ XP @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ XQ @ (cco @ ccc0 @ cc1 @ ccicc)) & (XP != ccc0)) & (cwral @ (^ [Xi:$i] : ((cco @ (cco @ (cco @ cc1 @ XP @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ XP @ (ccfv @ (ccv @ Xi) @ XT) @ ccmul) @ ccaddc) = (cco @ (cco @ (cco @ cc1 @ XQ @ ccmin) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccmul) @ (cco @ XQ @ (ccfv @ (ccv @ Xi) @ XC) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xi:$i] : (((ccfv @ (ccv @ Xi) @ XB2) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xr) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ (ccv @ Xr) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) @ ccmul) @ ccaddc)) & ((ccfv @ (ccv @ Xi) @ XC) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xs1) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xy1)) @ ccmul) @ ccaddc)) & ((ccfv @ (ccv @ Xi) @ XT) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xu) @ ccmin) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) @ ccmul) @ (cco @ (ccv @ Xu) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xy1)) @ ccmul) @ ccaddc)))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xu:$i] : (cco @ ccc0 @ cc1 @ ccicc)))) @ (^ [Xs1:$i] : (cco @ ccc0 @ cc1 @ ccicc)))) @ (^ [Xr:$i] : (cco @ ccc0 @ cc1 @ ccicc)))) @ (^ [Xy1:$i] : (ccfv @ XN @ ccee)))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee)))))))))))).
...
thf(ar19_26_3_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3) & (Xch @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) & (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) & (cwral @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))).
