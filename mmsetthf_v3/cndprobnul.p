...
thf(anuleldmp_thm,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprb) => (cwcel @ cc0 @ (ccdm @ XP))))).
...
thf(ccndprobnul_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprb) & (cwcel @ XA2 @ (ccdm @ XP)) & ((ccfv @ XA2 @ XP) != ccc0)) => ((ccfv @ (ccop @ cc0 @ XA2) @ (ccfv @ XP @ cccprob)) = ccc0))))).
