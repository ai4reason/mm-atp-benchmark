...
thf(cogrpinv0le_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_le = (ccfv @ XG @ ccple)) => ((XI = (ccfv @ XG @ ccminusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccogrp) & (cwcel @ XX @ XB2)) => ((cwbr @ Xc_0 @ XX @ Xc_le) <=> (cwbr @ (ccfv @ XX @ XI) @ Xc_0 @ Xc_le)))))))))))))).
