...
thf(cscmatf1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ XN @ XR @ ccmat))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XA2 @ Xx3) @ ccur))) => ((! [Xx3:$i] : (Xc_as = (ccfv @ (XA2 @ Xx3) @ ccvsca))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_1 @ Xc_as))))) => ((XC = (cco @ XN @ XR @ ccscmat)) => (! [Xx3:$i] : (((cwcel @ XN @ ccfn) & (XN != cc0) & (cwcel @ XR @ ccrg)) => (cwf1 @ XK @ XC @ (XF @ Xx3))))))))))))))))))).
