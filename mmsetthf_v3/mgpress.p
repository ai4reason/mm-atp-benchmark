...
thf(amgpval_thm,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (XM = (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_x) @ ccsts)))))))).
...
thf(cmgpress_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XM = (ccfv @ XR @ ccmgp)) => (((cwcel @ XR @ XV) & (cwcel @ XA2 @ XW)) => ((cco @ XM @ XA2 @ ccress) = (ccfv @ XS @ ccmgp)))))))))))).
