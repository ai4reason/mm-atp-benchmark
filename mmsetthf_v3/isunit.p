...
thf(adf_unit_ax,axiom,(ccui = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccima @ (cccnv @ (ccin @ (ccfv @ (ccv @ Xw) @ ccdsr) @ (ccfv @ (ccfv @ (ccv @ Xw) @ ccoppr) @ ccdsr))) @ (ccsn @ (ccfv @ (ccv @ Xw) @ ccur))))))).
...
thf(areldvdsr_thm,axiom,(! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : ((Xc_pa = (ccfv @ XR @ ccdsr)) => (cwrel @ Xc_pa))))).
...
thf(cisunit_conj,conjecture,(! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => ((XS = (ccfv @ XR @ ccoppr)) => ((XE = (ccfv @ XS @ ccdsr)) => ((cwcel @ XX @ XU) <=> ((cwbr @ XX @ Xc_1 @ Xc_pa) & (cwbr @ XX @ Xc_1 @ XE)))))))))))))))).
