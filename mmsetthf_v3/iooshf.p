...
thf(ciooshf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr))) => ((cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccioo)) <=> (cwcel @ XA2 @ (cco @ (cco @ XC @ XB2 @ ccaddc) @ (cco @ XD @ XB2 @ ccaddc) @ ccioo))))))))).
