...
thf(cltmod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XA2 @ ccico))) => (Xph => (cwbr @ (cco @ XC @ XB2 @ ccmo) @ (cco @ XA2 @ XB2 @ ccmo) @ cclt)))))))))).
