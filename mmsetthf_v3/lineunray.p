...
thf(clineunray_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XP @ (ccfv @ XN @ ccee)) & (cwcel @ XQ @ (ccfv @ XN @ ccee)) & (cwcel @ XR @ (ccfv @ XN @ ccee))) & ((XP != XQ) & (XP != XR))) => ((cwbr @ XP @ (ccop @ XQ @ XR) @ ccbtwn) => ((cco @ XP @ XQ @ ccline2) = (ccun @ (ccun @ (cco @ XP @ XQ @ ccray) @ (ccsn @ XP)) @ (cco @ XP @ XR @ ccray)))))))))).
