...
thf(afbasrn_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((XC @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccima @ XF @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XB2 @ (ccfv @ XX @ ccfbas)) & (cwf @ XX @ XY @ XF) & (cwcel @ XY @ XV)) => (cwcel @ (XC @ Xx3) @ (ccfv @ XY @ ccfbas)))))))))))).
...
thf(cfmss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XX @ XA2) & (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) & (cwcel @ XC @ (ccfv @ XY @ ccfbas))) & ((cwf @ XY @ XX @ XF) & (cwss @ XB2 @ XC))) => (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ (ccfv @ XC @ (cco @ XX @ XF @ ccfm))))))))))).
