...
thf(cscafval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_xb = (ccfv @ XW @ ccscaf)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => (((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_xb) = (cco @ XX @ XY @ Xc_x))))))))))))))))).
