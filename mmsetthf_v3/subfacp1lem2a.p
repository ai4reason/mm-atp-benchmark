...
thf(csubfacp1lem2a_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XD @ Xx3 @ Xy1 @ Xf1) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccfv @ (^ [Xf1:$i] : ((cwf1o @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xf1)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) != (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ cchash))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xf1) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (XD @ Xx3 @ Xy1 @ Xf1)))))))) => ((XA2 = (^ [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccv @ Xf1)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) != (ccv @ Xy1))) @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)))))) => ((! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => (cwcel @ XN @ ccn)))) => ((! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => (cwcel @ (XM @ Xn) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))))) => ((! [Xn:$i] : (cwcel @ (XM @ Xn) @ ccvv)) => ((! [Xn:$i] : (XK = (ccdif @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccsn @ (XM @ Xn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XF @ Xn) = (ccun @ (XG @ Xx3 @ Xy1 @ Xf1 @ Xn) @ (ccpr @ (ccop @ cc1 @ (XM @ Xn)) @ (ccop @ (XM @ Xn) @ cc1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => (cwf1o @ XK @ XK @ (XG @ Xx3 @ Xy1 @ Xf1 @ Xn))))))) => (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => ((cwf1o @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (XF @ Xn)) & ((ccfv @ cc1 @ (XF @ Xn)) = (XM @ Xn)) & ((ccfv @ (XM @ Xn) @ (XF @ Xn)) = cc1)))))))))))))))))))))))).
