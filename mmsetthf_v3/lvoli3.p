...
thf(clvoli3_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ cclpl)) => ((XV = (ccfv @ XK @ cclvol)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XP) & (cwcel @ XQ @ XA2)) & (~ (cwbr @ XQ @ XX @ Xc_le))) => (cwcel @ (cco @ XX @ XQ @ Xc_or) @ XV)))))))))))))))).
