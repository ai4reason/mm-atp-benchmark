...
thf(cvtxdusgr0edgnelALT_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XD @ Xe) = (ccfv @ XG @ ccvtxdg))) => (! [Xe:$i] : (((cwcel @ XG @ ccusgr) & (cwcel @ XU @ XV)) => (((ccfv @ XU @ (XD @ Xe)) = ccc0) <=> (~ (cwrex @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
