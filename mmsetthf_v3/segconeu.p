...
thf(csegconeu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee))) & (XC != XD))) => (cwreu @ (^ [Xr:$i] : ((cwbr @ XD @ (ccop @ XC @ (ccv @ Xr)) @ ccbtwn) & (cwbr @ (ccop @ XD @ (ccv @ Xr)) @ (ccop @ XA2 @ XB2) @ cccgr))) @ (^ [Xr:$i] : (ccfv @ XN @ ccee)))))))))).
