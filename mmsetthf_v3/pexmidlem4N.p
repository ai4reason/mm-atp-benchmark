...
thf(aelpaddatiN_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : ((Xc_pl @ Xp) = (ccfv @ XK @ ccpadd))) => (! [Xp:$i] : ((((cwcel @ XK @ cclat) & (cwss @ XX @ XA2) & (cwcel @ XQ @ XA2)) & ((XX != cc0) & (cwcel @ XR @ (cco @ XX @ (ccsn @ XQ) @ (Xc_pl @ Xp))))) => (cwrex @ (^ [Xp:$i] : (cwbr @ XR @ (cco @ (ccv @ Xp) @ XQ @ Xc_or) @ Xc_le)) @ (^ [Xp:$i] : XX))))))))))))))))).
...
thf(cpexmidlem4N_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xq:$i] : ((! [Xp:$i] : ((Xc_le @ Xp) = (ccfv @ (XK @ Xp) @ ccple))) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ (XK @ Xp) @ ccjn))) => ((! [Xp:$i] : ((XA2 @ Xp) = (ccfv @ (XK @ Xp) @ ccatm))) => ((! [Xp:$i] : ((Xc_pl @ Xp) = (ccfv @ (XK @ Xp) @ ccpadd))) => ((! [Xp:$i] : ((Xc_pe @ Xp) = (ccfv @ (XK @ Xp) @ ccpolN))) => ((! [Xp:$i] : ((XM @ Xp) = (cco @ (XX @ Xp) @ (ccsn @ (ccv @ Xp)) @ (Xc_pl @ Xp)))) => (! [Xp:$i] : ((((cwcel @ (XK @ Xp) @ cchlt) & (cwss @ (XX @ Xp) @ (XA2 @ Xp)) & (cwcel @ (ccv @ Xp) @ (XA2 @ Xp))) & (((XX @ Xp) != cc0) & (cwcel @ (ccv @ Xq) @ (ccin @ (ccfv @ (XX @ Xp) @ (Xc_pe @ Xp)) @ (XM @ Xp))))) => (cwcel @ (ccv @ Xp) @ (cco @ (XX @ Xp) @ (ccfv @ (XX @ Xp) @ (Xc_pe @ Xp)) @ (Xc_pl @ Xp))))))))))))))))))))).
