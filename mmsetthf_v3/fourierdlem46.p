...
thf(aicocncflimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccico) @ ccc @ cccncf))) => (Xph => (cwcel @ (ccfv @ XA2 @ XF) @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XA2 @ cclimc)))))))))))).
...
thf(aioccncflimc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioc) @ ccc @ cccncf))) => (Xph => (cwcel @ (ccfv @ XB2 @ XF) @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XB2 @ cclimc)))))))))))).
