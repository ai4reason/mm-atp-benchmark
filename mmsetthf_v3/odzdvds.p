...
thf(aodzval_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) => ((ccfv @ XA2 @ (ccfv @ XN @ ccodz)) = (ccinf @ (ccrab @ (^ [Xn:$i] : (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ cc1 @ ccmin) @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
...
thf(aodzid_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) => (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccexp) @ cc1 @ ccmin) @ ccdvds))))).
...
thf(codzdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) & (cwcel @ XK @ ccn0)) => ((cwbr @ XN @ (cco @ (cco @ XA2 @ XK @ ccexp) @ cc1 @ ccmin) @ ccdvds) <=> (cwbr @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ XK @ ccdvds))))))).
