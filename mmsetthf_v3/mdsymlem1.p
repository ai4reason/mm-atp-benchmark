...
thf(cmdsymlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : ((XC @ Xp) = (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (! [Xp:$i] : ((((cwcel @ (ccv @ Xp) @ ccch) & (cwss @ (ccin @ XB2 @ (XC @ Xp)) @ XA2)) & ((cwbr @ XB2 @ XA2 @ ccdmd) & (cwss @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ cchj)))) => (cwss @ (ccv @ Xp) @ XA2)))))))))).
