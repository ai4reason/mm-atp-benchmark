...
thf(ccply1coe0_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xn:$i] : ((Xc_0 @ Xn) = (ccfv @ XR @ cc0g))) => ((! [Xn:$i] : ((XP @ Xn) = (ccfv @ XR @ ccpl1))) => ((! [Xn:$i] : ((XB2 @ Xn) = (ccfv @ (XP @ Xn) @ ccbs))) => ((! [Xn:$i] : ((XA2 @ Xn) = (ccfv @ (XP @ Xn) @ ccascl))) => (((cwcel @ XR @ ccrg) & (cwcel @ XS @ XK)) => (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ (ccfv @ (ccfv @ XS @ (XA2 @ Xn)) @ ccco1)) = (Xc_0 @ Xn))) @ (^ [Xn:$i] : ccn)))))))))))))))).
