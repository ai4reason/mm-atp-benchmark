...
thf(astoweidlem58_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((cwnfc @ (^ [Xt:$i] : (XD @ Xt))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xt:$i] : (XU @ Xx3 @ Xt)))) => ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xx3 @ Xt)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xx3 @ Xt)) @ X)))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xa:$i] : ((XK @ Xx3 @ Xf1 @ Xg1 @ Xr @ Xq @ Xa) = (ccfv @ (ccrn @ ccioo) @ cctg)))))))) => ((! [Xx3:$i] : (! [Xq:$i] : (! [Xa:$i] : (XT = (ccuni @ (XJ @ Xx3 @ Xq @ Xa)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xa:$i] : ((XC @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xr @ Xq @ Xa) = (cco @ (XJ @ Xx3 @ Xq @ Xa) @ (XK @ Xx3 @ Xf1 @ Xg1 @ Xr @ Xq @ Xa) @ cccn))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwcel @ (XJ @ Xx3 @ Xq @ Xa) @ cccmp)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwss @ XA2 @ (XC @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xr @ Xq @ Xa)))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xx3 @ Xt) & (cwcel @ (ccv @ Xf1) @ XA2) & (cwcel @ (ccv @ Xg1) @ XA2)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ XA2)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xx3 @ Xt) & (cwcel @ (ccv @ Xf1) @ XA2) & (cwcel @ (ccv @ Xg1) @ XA2)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ XA2)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xa:$i] : (((Xph @ Xx3 @ Xt) & (cwcel @ (ccv @ Xa) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xa))) @ XA2))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xr:$i] : (((Xph @ Xx3 @ Xt) & ((cwcel @ (ccv @ Xr) @ XT) & (cwcel @ (ccv @ Xt) @ XT) & ((ccv @ Xr) != (ccv @ Xt)))) => (cwrex @ (^ [Xq:$i] : ((ccfv @ (ccv @ Xr) @ (ccv @ Xq)) != (ccfv @ (ccv @ Xt) @ (ccv @ Xq)))) @ (^ [Xq:$i] : XA2)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwcel @ (XB2 @ Xt @ Xq @ Xa) @ (ccfv @ (XJ @ Xx3 @ Xq @ Xa) @ cccld))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwcel @ (XD @ Xt) @ (ccfv @ (XJ @ Xx3 @ Xq @ Xa) @ cccld))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => ((ccin @ (XB2 @ Xt @ Xq @ Xa) @ (XD @ Xt)) = cc0)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((XU @ Xx3 @ Xt) = (ccdif @ XT @ (XB2 @ Xt @ Xq @ Xa))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwcel @ (XE @ Xq @ Xa) @ ccrp)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwbr @ (XE @ Xq @ Xa) @ (cco @ cc1 @ cc3 @ ccdiv) @ cclt)))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xt:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ ccle) & (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ cc1 @ ccle))) @ (^ [Xt:$i] : XT)) & (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ (XE @ Xq @ Xa) @ cclt)) @ (^ [Xt:$i] : (XD @ Xt))) & (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (XE @ Xq @ Xa) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ cclt)) @ (^ [Xt:$i] : (XB2 @ Xt @ Xq @ Xa))))) @ (^ [Xx3:$i] : XA2)))))))))))))))))))))))))))))))))))).
...
thf(achfnrn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))) => (cwss @ (ccrn @ XF) @ (ccuni @ XA2)))))).
...
thf(cstoweidlem59_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XN:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : (cwnfc @ (^ [Xt:$i] : (XF @ Xx3 @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq)))))))))) => (((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XK @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xr @ Xq) = (ccfv @ (ccrn @ ccioo) @ cctg))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : (! [Xq:$i] : ((XT @ Xj) = (ccuni @ (XJ @ Xx3 @ Xy1 @ Xj @ Xq))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XC @ Xx3 @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq) = (cco @ (XJ @ Xx3 @ Xy1 @ Xj @ Xq) @ (XK @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xr @ Xq) @ cccn)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XD @ Xt @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xj:$i] : (ccrab @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq)) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) @ (XE @ Xj @ Xq) @ ccmul) @ ccle)) @ (^ [Xt:$i] : (XT @ Xj)))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XB2 @ Xt @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xj:$i] : (ccrab @ (^ [Xt:$i] : (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ (XE @ Xj @ Xq) @ ccmul) @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq)) @ ccle)) @ (^ [Xt:$i] : (XT @ Xj)))))))))))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XY @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xr @ Xq) = (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xt:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xy1)) @ ccle) & (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xy1)) @ cc1 @ ccle))) @ (^ [Xt:$i] : (XT @ Xj)))) @ (^ [Xy1:$i] : (XA2 @ Xj))))))))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((XH @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xj:$i] : (ccrab @ (^ [Xy1:$i] : ((cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xy1)) @ (cco @ (XE @ Xj @ Xq) @ XN @ ccdiv) @ cclt)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xj) @ (XD @ Xt @ Xj)))) & (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (cco @ (XE @ Xj @ Xq) @ XN @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xy1)) @ cclt)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xj) @ (XB2 @ Xt @ Xj)))))) @ (^ [Xy1:$i] : (XY @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xr @ Xq))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xq:$i] : ((Xph @ Xt) => (cwcel @ (XJ @ Xx3 @ Xy1 @ Xj @ Xq) @ cccmp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((Xph @ Xt) => (cwss @ (XA2 @ Xj) @ (XC @ Xx3 @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xj)) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xj))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xj)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xj))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xj)) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xj))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xj)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XA2 @ Xj))))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xj:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xy1) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xj)) @ (^ [Xt:$i] : (ccv @ Xy1))) @ (XA2 @ Xj)))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xr:$i] : (((Xph @ Xt) & ((cwcel @ (ccv @ Xr) @ (XT @ Xj)) & (cwcel @ (ccv @ Xt) @ (XT @ Xj)) & ((ccv @ Xr) != (ccv @ Xt)))) => (cwrex @ (^ [Xq:$i] : ((ccfv @ (ccv @ Xr) @ (ccv @ Xq)) != (ccfv @ (ccv @ Xt) @ (ccv @ Xq)))) @ (^ [Xq:$i] : (XA2 @ Xj))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xj:$i] : (! [Xr:$i] : (! [Xq:$i] : ((Xph @ Xt) => (cwcel @ (XF @ Xx3 @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq) @ (XC @ Xx3 @ Xy1 @ Xt @ Xf1 @ Xg1 @ Xj @ Xr @ Xq))))))))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xq:$i] : ((Xph @ Xt) => (cwcel @ (XE @ Xj @ Xq) @ ccrp))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xq:$i] : ((Xph @ Xt) => (cwbr @ (XE @ Xj @ Xq) @ (cco @ cc1 @ cc3 @ ccdiv) @ cclt))))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XN @ ccn))) => (! [Xt:$i] : (! [Xj:$i] : (! [Xq:$i] : ((Xph @ Xt) => (? [Xx3:$i] : ((cwf @ (cco @ ccc0 @ XN @ ccfz) @ (XA2 @ Xj) @ (ccv @ Xx3)) & (cwral @ (^ [Xj:$i] : ((cwral @ (^ [Xt:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xx3))) @ ccle) & (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xx3))) @ cc1 @ ccle))) @ (^ [Xt:$i] : (XT @ Xj))) & (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xx3))) @ (cco @ (XE @ Xj @ Xq) @ XN @ ccdiv) @ cclt)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xj) @ (XD @ Xt @ Xj)))) & (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (cco @ (XE @ Xj @ Xq) @ XN @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xx3))) @ cclt)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xj) @ (XB2 @ Xt @ Xj)))))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))))))))))))))))))))))))))))))))).
