...
thf(cclwwlknclwwlkdif_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xw:$i] : ((XA2 @ Xw) = (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = XX) & ((ccfv @ (ccv @ Xw) @ cclsw) != XX))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => ((! [Xw:$i] : ((XB2 @ Xw) = (cco @ XX @ XX @ (cco @ XN @ XG @ ccwwlksnon)))) => ((! [Xw:$i] : ((XC @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XX)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => (! [Xw:$i] : ((XA2 @ Xw) = (ccdif @ (XC @ Xw) @ (XB2 @ Xw)))))))))))))).
