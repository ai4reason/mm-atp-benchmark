...
thf(alimsupre_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xb:$i] : (Xph => (cwss @ (XB2 @ Xb) @ ccr))) => ((! [Xb:$i] : (Xph => ((ccsup @ (XB2 @ Xb) @ ccxr @ cclt) = ccpnf))) => ((! [Xb:$i] : (Xph => (cwf @ (XB2 @ Xb) @ ccr @ XF))) => ((Xph => (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xj) @ XF) @ ccabs) @ (ccv @ Xb) @ ccle))) @ (^ [Xj:$i] : (XB2 @ Xb)))) @ (^ [Xk:$i] : ccr))) @ (^ [Xb:$i] : ccr))) => (Xph => (cwcel @ (ccfv @ XF @ cclsp) @ ccr)))))))))).
...
thf(alesub2dd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => (Xph => (cwbr @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccle))))))))))).
...
thf(advbdfbdioo_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xb) => (cwcel @ XA2 @ ccr)))) => ((! [Xx3:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xb) => (cwcel @ XB2 @ ccr)))) => ((! [Xx3:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xb) => (cwbr @ XA2 @ XB2 @ cclt)))) => ((! [Xx3:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xb) => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)))) => ((! [Xx3:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xb) => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))))) => ((! [Xx3:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xb) => (cwrex @ (^ [Xa:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)))) @ (^ [Xa:$i] : ccr))))) => (! [Xx3:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xb) => (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ (ccv @ Xb) @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)))) @ (^ [Xb:$i] : ccr)))))))))))))))).
...
thf(aleltaddd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XA2 @ XC @ ccle)) => ((Xph => (cwbr @ XB2 @ XD @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ cclt)))))))))))))).
...
thf(altsub23d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XC @ ccmin) @ XB2 @ cclt))))))))))).
...
thf(aioodvbdlimc1lem1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => (cwcel @ (XA2 @ Xj) @ ccr)))) => ((! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => (cwcel @ (XB2 @ Xj) @ ccr)))) => ((! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => (cwbr @ (XA2 @ Xj) @ (XB2 @ Xj) @ cclt)))) => ((! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => (cwcel @ XF @ (cco @ (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo) @ ccr @ cccncf))))) => ((! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo))))) => ((! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccabs) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo)))) @ (^ [Xy1:$i] : ccr))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XM @ Xy1 @ Xz) @ ccz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => (cwf @ (ccfv @ (XM @ Xy1 @ Xz) @ ccuz) @ (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo) @ (XR @ Xx3 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : ((XS @ Xy1 @ Xz @ Xj) = (ccmpt @ (^ [Xj:$i] : (ccfv @ (XM @ Xy1 @ Xz) @ ccuz)) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (XR @ Xx3 @ Xz)) @ XF)))))))) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XR @ Xx3 @ Xz) @ (ccdm @ ccli))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : ((XK @ Xx3 @ Xz) = (ccinf @ (ccrab @ (^ [Xk:$i] : (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xi) @ (XR @ Xx3 @ Xz)) @ (ccfv @ (ccv @ Xk) @ (XR @ Xx3 @ Xz)) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xx3) @ (cco @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xz:$i] : (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo)) @ (^ [Xz:$i] : (ccfv @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ ccabs)))) @ ccr @ cclt) @ cc1 @ ccaddc) @ ccdiv) @ cclt)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : (ccfv @ (XM @ Xy1 @ Xz) @ ccuz))) @ ccr @ cclt)))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : ((Xph @ Xz) => (cwbr @ (XS @ Xy1 @ Xz @ Xj) @ (ccfv @ (XS @ Xy1 @ Xz @ Xj) @ cclsp) @ ccli))))))))))))))))))))))))).
...
thf(aclimsub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((! [Xk:$i] : (Xph => (cwcel @ XH @ (XX @ Xk)))) => ((Xph => (cwbr @ XG @ XB2 @ ccli)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XH) = (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin)))) => (Xph => (cwbr @ XH @ (cco @ XA2 @ XB2 @ ccmin) @ ccli)))))))))))))))))))).
thf(aclimconst_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (Xph => (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (Xph => (cwcel @ XF @ (XV @ Xk)))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = XA2))) => (Xph => (cwbr @ XF @ XA2 @ ccli)))))))))))))).
...
thf(adivcnvg_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XM @ ccn)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : (ccfv @ XM @ ccuz)) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccdiv))) @ ccc0 @ ccli))))).
...
thf(aellimc3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cwcel @ XC @ (cco @ XF @ XB2 @ cclimc)) <=> ((cwcel @ XC @ ccc) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((((ccv @ Xz) != XB2) & (cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XB2 @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ XC @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : ccrp)))))))))))))).
thf(aioosscn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ ccc)))).
thf(cioodvbdlimc2lem_conj,conjecture,(! [Xph:$o] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccabs) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)))) @ (^ [Xy1:$i] : ccr))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : ((XY @ Xy1 @ Xz @ Xj) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccabs)))) @ ccr @ cclt))))) => ((! [Xz:$i] : ((XM @ Xz) = (cco @ (ccfv @ (cco @ cc1 @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv) @ ccfl) @ cc1 @ ccaddc))) => ((! [Xz:$i] : (XS = (ccmpt @ (^ [Xj:$i] : (ccfv @ (XM @ Xz) @ ccuz)) @ (^ [Xj:$i] : (ccfv @ (cco @ XB2 @ (cco @ cc1 @ (ccv @ Xj) @ ccdiv) @ ccmin) @ XF))))) => ((! [Xz:$i] : ((XR @ Xz) = (ccmpt @ (^ [Xj:$i] : (ccfv @ (XM @ Xz) @ ccuz)) @ (^ [Xj:$i] : (cco @ XB2 @ (cco @ cc1 @ (ccv @ Xj) @ ccdiv) @ ccmin))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : ((XN @ Xx3 @ Xy1) = (ccif @ (cwbr @ (XM @ Xz) @ (cco @ (ccfv @ (cco @ (XY @ Xy1 @ Xz @ Xj) @ (cco @ (ccv @ Xx3) @ cc2 @ ccdiv) @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ ccle) @ (cco @ (ccfv @ (cco @ (XY @ Xy1 @ Xz @ Xj) @ (cco @ (ccv @ Xx3) @ cc2 @ ccdiv) @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (XM @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : ((Xch @ Xx3 @ Xy1 @ Xz @ Xj) <=> (((((Xph & (cwcel @ (ccv @ Xx3) @ ccrp)) & (cwcel @ (ccv @ Xj) @ (ccfv @ (XN @ Xx3 @ Xy1) @ ccuz))) & (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ XS) @ (ccfv @ XS @ cclsp) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xx3) @ cc2 @ ccdiv) @ cclt)) & (cwcel @ (ccv @ Xz) @ (cco @ XA2 @ XB2 @ ccioo))) & (cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XB2 @ ccmin) @ ccabs) @ (cco @ cc1 @ (ccv @ Xj) @ ccdiv) @ cclt))))))) => (Xph => (cwcel @ (ccfv @ XS @ cclsp) @ (cco @ XF @ XB2 @ cclimc)))))))))))))))))))))))))).
