...
thf(amonfval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xc_x = (ccfv @ XC @ ccco)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((XM @ Xx3 @ Xy1 @ Xz @ Xg1) = (ccfv @ XC @ ccmon)))))) => ((Xph => (cwcel @ XC @ cccat)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (Xph => ((XM @ Xx3 @ Xy1 @ Xz @ Xg1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xz:$i] : (cwfun @ (cccnv @ (ccmpt @ (^ [Xg1:$i] : (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XH)) @ (^ [Xg1:$i] : (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (cco @ (ccop @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccv @ Xy1) @ Xc_x))))))) @ (^ [Xz:$i] : XB2))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)))))))))))))))))))))))).
thf(cmonpropd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => ((ccfv @ XC @ cchomf) = (ccfv @ XD @ cchomf))) => ((Xph => ((ccfv @ XC @ cccomf) = (ccfv @ XD @ cccomf))) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => (Xph => ((ccfv @ XC @ ccmon) = (ccfv @ XD @ ccmon))))))))))).
