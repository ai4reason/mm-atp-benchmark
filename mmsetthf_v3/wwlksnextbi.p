...
thf(cwwlksnextbi_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XN @ ccn0) & (cwcel @ XS @ XV)) & ((cwcel @ XT @ (ccword @ XV)) & (XW = (cco @ XT @ (ccs1 @ XS) @ ccconcat)) & (cwcel @ (ccpr @ (ccfv @ XT @ cclsw) @ XS) @ XE))) => ((cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) <=> (cwcel @ XT @ (cco @ XN @ XG @ ccwwlksn)))))))))))))).
