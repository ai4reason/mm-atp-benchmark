...
thf(cmdetpmtr12_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (XB2 = (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ XR @ ccmdat)))) => ((XG = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xi:$i] : (! [Xj:$i] : ((XS @ Xi @ Xj) = (ccfv @ XN @ ccpsgn)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XZ @ Xi @ Xj) = (ccfv @ XR @ cczrh)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_x @ Xi @ Xj) = (ccfv @ XR @ ccmulr)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XE @ Xi @ Xj) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XQ) @ XM))))))) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XM @ XB2)) => ((Xph => (cwcel @ XP @ XG)) => ((Xph => (cwcel @ XQ @ XG)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((ccfv @ XM @ (XD @ Xi @ Xj)) = (cco @ (ccfv @ (cco @ (ccfv @ XP @ (XS @ Xi @ Xj)) @ (ccfv @ XQ @ (XS @ Xi @ Xj)) @ ccmul) @ (XZ @ Xi @ Xj)) @ (ccfv @ (XE @ Xi @ Xj) @ (XD @ Xi @ Xj)) @ (Xc_x @ Xi @ Xj)))))))))))))))))))))))))))))))))).
