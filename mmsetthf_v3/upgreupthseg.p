...
thf(cupgreupthseg_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccupgr) & (cwbr @ XF @ XP @ (ccfv @ XG @ cceupth)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) => ((ccfv @ (ccfv @ XN @ XF) @ XI) = (ccpr @ (ccfv @ XN @ XP) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XP))))))))))).
