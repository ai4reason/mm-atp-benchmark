...
thf(aisuvtxaOLD_thm,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (! [Xk:$i] : ((XE @ Xv @ Xk) = (ccfv @ XG @ ccedg)))) => ((cwcel @ XG @ XW) => ((ccfv @ XG @ ccuvtx) = (ccrab @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xk) @ (ccv @ Xv)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xv @ Xk)))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
...
thf(cuvtxael1OLD_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : ((XE @ Xk) = (ccfv @ XG @ ccedg))) => ((cwcel @ XG @ XW) => ((cwcel @ XN @ (ccfv @ XG @ ccuvtx)) <=> ((cwcel @ XN @ XV) & (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xk) @ XN) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xk)))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))))))).
