...
thf(ahomarcl_thm,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((cwcel @ XF @ (cco @ XX @ XY @ XH)) => (cwcel @ XC @ cccat))))))))).
...
thf(ccoahom_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_x = (ccfv @ XC @ cccoa)) => ((XH = (ccfv @ XC @ cchoma)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ XH))) => (Xph => (cwcel @ (cco @ XG @ XF @ Xc_x) @ (cco @ XX @ XZ @ XH))))))))))))))))).
