...
thf(aovolfiniun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xk:$i] : ((cwss @ (XB2 @ Xk) @ ccr) & (cwcel @ (ccfv @ (XB2 @ Xk) @ ccovol) @ ccr))) @ (^ [Xk:$i] : XA2))) => (cwbr @ (ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccovol) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccovol))) @ ccle))))).
