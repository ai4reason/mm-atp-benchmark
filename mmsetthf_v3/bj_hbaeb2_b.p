...
thf(aaxc9_b3_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : ((~ (! [Xy1:$i] : ((ccv @ Xy1) = (ccv @ Xx3)))) => ((~ (! [Xy1:$i] : ((ccv @ Xy1) = (ccv @ Xy1)))) => (((ccv @ Xx3) = (ccv @ Xy1)) => (! [Xy1:$i] : ((ccv @ Xx3) = (ccv @ Xy1))))))))).
...
thf(cbj_hbaeb2_b_conj,conjecture,(! [Xy1:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) <=> (! [Xx3:$i] : (! [Xy1:$i] : ((ccv @ Xx3) = (ccv @ Xy1))))))).
