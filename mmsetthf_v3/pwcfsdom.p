...
thf(aaleph0_thm,axiom,((ccfv @ cc0 @ ccale) = ccom)).
...
thf(aalephgeom_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) <=> (cwss @ ccom @ (ccfv @ XA2 @ ccale))))).
...
thf(amapdom1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap) @ ccdom)))))).
...
thf(acfsmo_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (? [Xf1:$i] : ((cwf @ (ccfv @ XA2 @ cccf) @ XA2 @ (ccv @ Xf1)) & (cwsmo @ (ccv @ Xf1)) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (ccfv @ XA2 @ cccf)))) @ (^ [Xz:$i] : XA2))))))).
...
thf(aalephislim_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) <=> (cwlim @ (ccfv @ XA2 @ ccale))))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(afrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwss @ (ccrn @ XF) @ XB2)))))).
thf(acoflim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwlim @ XA2) & (cwss @ XB2 @ XA2)) => (((ccuni @ XB2) = XA2) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(aalephlim_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwlim @ XA2)) => ((ccfv @ XA2 @ ccale) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccale))))))))).
...
thf(aalephcard_thm,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ XA2 @ ccale) @ cccrd) = (ccfv @ XA2 @ ccale)))).
...
thf(aalephord2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ XB2) => (cwcel @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale))))))).
...
thf(acf0_thm,axiom,((ccfv @ cc0 @ cccf) = cc0)).
thf(a_0ex_thm,axiom,(cwcel @ cc0 @ ccvv)).
thf(amap0e_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cco @ XA2 @ cc0 @ ccmap) = cc1o))))).
thf(cpwcfsdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xf1:$i] : ((XH @ Xy1 @ Xf1) = (ccmpt @ (^ [Xy1:$i] : (ccfv @ (ccfv @ XA2 @ ccale) @ cccf)) @ (^ [Xy1:$i] : (ccfv @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ cchar)))))) => (cwbr @ (ccfv @ XA2 @ ccale) @ (cco @ (ccfv @ XA2 @ ccale) @ (ccfv @ (ccfv @ XA2 @ ccale) @ cccf) @ ccmap) @ ccsdm))))).
