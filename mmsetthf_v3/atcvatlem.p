...
thf(catcvatlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((((cwcel @ XB2 @ ccat) & (cwcel @ XC @ ccat)) & ((XA2 != cc0h) & (cwpss @ XA2 @ (cco @ XB2 @ XC @ cchj)))) => ((~ (cwss @ XB2 @ XA2)) => (cwcel @ XA2 @ ccat)))))))).
