...
thf(cxpcdaen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwcel @ XC @ XX)) => (cwbr @ (ccxp @ XA2 @ (cco @ XB2 @ XC @ cccda)) @ (cco @ (ccxp @ XA2 @ XB2) @ (ccxp @ XA2 @ XC) @ cccda) @ ccen))))))))).
