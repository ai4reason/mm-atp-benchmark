...
thf(clplnllnneN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ cclpl)) => ((XY = (cco @ (cco @ XQ @ XR @ Xc_or) @ XS @ Xc_or)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2) & (cwcel @ XS @ XA2)) & (cwcel @ XY @ XP)) => ((cco @ XQ @ XS @ Xc_or) != (cco @ XR @ XS @ Xc_or)))))))))))))))).
