...
thf(aismri2dad_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccfv @ XA2 @ ccmrc)) => ((XI = (ccfv @ XA2 @ ccmri)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((Xph => (cwcel @ XS @ XI)) => ((Xph => (cwcel @ XY @ XS)) => (Xph => (~ (cwcel @ XY @ (ccfv @ (ccdif @ XS @ (ccsn @ XY)) @ XN))))))))))))))))).
...
thf(amreexmrid_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xz @ Xs1) @ (ccfv @ (XX @ Xz) @ ccmre)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (XN = (ccfv @ (XA2 @ Xy1 @ Xz @ Xs1) @ ccmrc))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : ((XI @ Xy1 @ Xz @ Xs1) = (ccfv @ (XA2 @ Xy1 @ Xz @ Xs1) @ ccmri))))) => ((! [Xz:$i] : (Xph => (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xz))) @ XN))) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xy1))) @ XN) @ (ccfv @ (ccv @ Xs1) @ XN))))) @ (^ [Xy1:$i] : (XX @ Xz)))) @ (^ [Xs1:$i] : (ccpw @ (XX @ Xz)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (Xph => (cwcel @ XS @ (XI @ Xy1 @ Xz @ Xs1)))))) => ((! [Xz:$i] : (Xph => (cwcel @ XY @ (XX @ Xz)))) => ((Xph => (~ (cwcel @ XY @ (ccfv @ XS @ XN)))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (Xph => (cwcel @ (ccun @ XS @ (ccsn @ XY)) @ (XI @ Xy1 @ Xz @ Xs1))))))))))))))))))))).
thf(amrissmrid_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((XI = (ccfv @ XA2 @ ccmri)) => ((Xph => (cwcel @ XS @ XI)) => ((Xph => (cwss @ XT @ XS)) => (Xph => (cwcel @ XT @ XI))))))))))))))).
