...
thf(advdsmultr1d_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwbr @ XK @ XM @ ccdvds)) => (Xph => (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds))))))))))).
