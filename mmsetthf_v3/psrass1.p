...
thf(apsrmulcl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xc_x = (ccfv @ XS @ ccmulr)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XB2))))))))))))))))).
...
thf(apsrass1lem_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ (XI @ Xj @ Xk) @ ccmap))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xy1 @ Xf1) = (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XF @ (ccofr @ ccle))) @ (^ [Xy1:$i] : (XD @ Xf1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) => (cwcel @ (XI @ Xj @ Xk) @ (XV @ Xf1 @ Xj @ Xk))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) => (cwcel @ XF @ (XD @ Xf1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XB2 @ Xx3 @ Xy1 @ Xf1 @ Xn) = (ccfv @ XG @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) => (cwcel @ XG @ cccmn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) & ((cwcel @ (ccv @ Xj) @ (XS @ Xy1 @ Xf1)) & (cwcel @ (ccv @ Xk) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XF @ (ccv @ Xj) @ (ccof @ ccmin)) @ (ccofr @ ccle))) @ (^ [Xx3:$i] : (XD @ Xf1)))))) => (cwcel @ (XX @ Xj @ Xk) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xn))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (((ccv @ Xk) = (cco @ (ccv @ Xn) @ (ccv @ Xj) @ (ccof @ ccmin))) => ((XX @ Xj @ Xk) = (XY @ Xj @ Xn)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) => ((cco @ XG @ (ccmpt @ (^ [Xn:$i] : (XS @ Xy1 @ Xf1)) @ (^ [Xn:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xn) @ (ccofr @ ccle))) @ (^ [Xx3:$i] : (XD @ Xf1)))) @ (^ [Xj:$i] : (XY @ Xj @ Xn))) @ ccgsu))) @ ccgsu) = (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XS @ Xy1 @ Xf1)) @ (^ [Xj:$i] : (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XF @ (ccv @ Xj) @ (ccof @ ccmin)) @ (ccofr @ ccle))) @ (^ [Xx3:$i] : (XD @ Xf1)))) @ (^ [Xk:$i] : (XX @ Xj @ Xk))) @ ccgsu))) @ ccgsu)))))))))))))))))))))))))).
...
thf(cpsrass1_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (cco @ XI @ XR @ ccmps))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XI @ (XV @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XR @ ccrg))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xf1:$i] : ((Xc_xp @ Xf1) = (ccfv @ (XS @ Xf1) @ ccmulr))) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ (XS @ Xf1) @ ccbs))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XX @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XY @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XZ @ (XB2 @ Xf1)))) => (! [Xf1:$i] : ((Xph @ Xf1) => ((cco @ (cco @ XX @ XY @ (Xc_xp @ Xf1)) @ XZ @ (Xc_xp @ Xf1)) = (cco @ XX @ (cco @ XY @ XZ @ (Xc_xp @ Xf1)) @ (Xc_xp @ Xf1)))))))))))))))))))))))))).
