...
thf(aexopxfr2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) => ((Xph @ Xx3) <=> (Xps @ Xy1 @ Xz)))))) => ((cwrel @ XA2) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (? [Xy1:$i] : (? [Xz:$i] : ((cwcel @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ XA2) & (Xps @ Xy1 @ Xz))))))))))).
