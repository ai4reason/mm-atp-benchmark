...
thf(adeg1mul3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((XA2 = (ccfv @ XP @ ccascl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XE) & (cwcel @ XG @ XB2)) => ((ccfv @ (cco @ (ccfv @ XF @ XA2) @ XG @ Xc_x) @ XD) = (ccfv @ XG @ XD))))))))))))))))))).
