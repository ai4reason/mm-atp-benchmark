...
thf(cfsumrev2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xj) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (cco @ (cco @ XM @ XN @ ccaddc) @ (ccv @ Xk) @ ccmin)) => ((XA2 @ Xj) = (XB2 @ Xk))))) => (Xph => ((ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xj:$i] : (XA2 @ Xj))) = (ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk))))))))))))).
