...
thf(a_2pthfrgrrn_thm,axiom,(! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XE @ Xa @ Xb @ Xc) = (ccfv @ XG @ ccedg))))) => ((cwcel @ XG @ ccfrgr) => (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xc:$i] : (cwrex @ (^ [Xb:$i] : ((cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ (XE @ Xa @ Xb @ Xc)) & (cwcel @ (ccpr @ (ccv @ Xb) @ (ccv @ Xc)) @ (XE @ Xa @ Xb @ Xc)))) @ (^ [Xb:$i] : XV))) @ (^ [Xc:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xa)))))) @ (^ [Xa:$i] : XV))))))))).
