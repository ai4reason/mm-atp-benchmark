...
thf(anfdisj_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) => ((? [X:$i] : ((^ [Xy1:$i] : (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))) @ X)))))))).
...
thf(adisjors_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) | ((ccin @ (ccsb @ (ccv @ Xi) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (ccv @ Xj) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = cc0))) @ (^ [Xj:$i] : XA2))) @ (^ [Xi:$i] : XA2)))))).
...
thf(cdisjxiun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (XB2 @ Xy1))) => ((cwdisj @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : (XC @ Xx3))) <=> ((cwral @ (^ [Xy1:$i] : (cwdisj @ (^ [Xx3:$i] : (XB2 @ Xy1)) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (^ [Xy1:$i] : XA2)) & (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (cciun @ (^ [Xx3:$i] : (XB2 @ Xy1)) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
