...
thf(aisrnsiga_thm,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) <=> ((cwcel @ XS @ ccvv) & (? [Xo:$i] : ((cwss @ XS @ (ccpw @ (ccv @ Xo))) & ((cwcel @ (ccv @ Xo) @ XS) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ (ccv @ Xo) @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XS)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ XS))) @ (^ [Xx3:$i] : (ccpw @ XS)))))))))).
...
thf(c_0elsiga_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) => (cwcel @ cc0 @ XS)))).
