...
thf(albico1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ cclt)) => (cwcel @ XA2 @ (cco @ XA2 @ XB2 @ ccico)))))).
...
thf(cdchrvmasumlem2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xd:$i] : ((XZ @ Xd) = (ccfv @ (XN @ Xd) @ cczn))) => ((! [Xd:$i] : (XL = (ccfv @ (XZ @ Xd) @ cczrh))) => ((! [Xd:$i] : (Xph => (cwcel @ (XN @ Xd) @ ccn))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : ((XG @ Xx3 @ Xm @ Xd) = (ccfv @ (XN @ Xd) @ ccdchr))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : ((XD @ Xd) = (ccfv @ (XG @ Xx3 @ Xm @ Xd) @ ccbs))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : ((Xc_1 @ Xd) = (ccfv @ (XG @ Xx3 @ Xm @ Xd) @ cc0g))))) => ((! [Xd:$i] : (Xph => (cwcel @ XX @ (XD @ Xd)))) => ((! [Xd:$i] : (Xph => (XX != (Xc_1 @ Xd)))) => ((! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xm) @ ccrp)) => (cwcel @ (XF @ Xm) @ ccc))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xd:$i] : (((ccv @ Xm) = (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ ccdiv)) => ((XF @ Xm) = (XK @ Xx3 @ Xd)))))) => ((Xph => (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccico))) => ((Xph => (cwcel @ XT @ ccc)) => ((! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xm) @ (cco @ cc3 @ ccpnf @ ccico))) => (cwbr @ (ccfv @ (cco @ (XF @ Xm) @ XT @ ccmin) @ ccabs) @ (cco @ XC @ (cco @ (ccfv @ (ccv @ Xm) @ cclog) @ (ccv @ Xm) @ ccdiv) @ ccmul) @ ccle))) => ((Xph => (cwcel @ XR @ ccr)) => ((Xph => (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (cco @ (XF @ Xm) @ XT @ ccmin) @ ccabs) @ XR @ ccle)) @ (^ [Xm:$i] : (cco @ cc1 @ cc3 @ ccico)))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (ccfv @ (cco @ (XK @ Xx3 @ Xd) @ XT @ ccmin) @ ccabs) @ (ccv @ Xd) @ ccdiv))))) @ cco1))))))))))))))))))))))))))))))).
