...
thf(cpreddowncl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xx3:$i] : (((cwss @ XB2 @ XA2) & (cwral @ (^ [Xx3:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xx3)) @ XB2)) @ (^ [Xx3:$i] : XB2))) => ((cwcel @ (XX @ Xx3) @ XB2) => ((ccpred @ XB2 @ XR @ (XX @ Xx3)) = (ccpred @ XA2 @ XR @ (XX @ Xx3))))))))))).
