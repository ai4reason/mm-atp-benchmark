...
thf(algsval3_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cco @ XA2 @ XP @ cclgs) = (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ XP @ ccmo) @ cc1 @ ccmin)))))).
...
thf(clgseisen_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (XP != XQ)) => (Xph => ((cco @ XQ @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ (ccsu @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ XQ @ XP @ ccdiv) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ ccfl))) @ ccexp)))))))))).
