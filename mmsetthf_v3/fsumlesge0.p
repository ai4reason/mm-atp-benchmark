...
thf(cfsumlesge0_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XX @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ (XX @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XY @ (XX @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XY @ ccfn))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (ccsu @ XY @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) @ (ccfv @ XF @ ccsumge0) @ ccle))))))))))))).
