...
thf(cnmooval_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccfv @ XU @ ccba))) => ((! [Xz:$i] : ((XY @ Xz) = (ccfv @ XW @ ccba))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XL @ Xx3 @ Xz) = (ccfv @ XU @ ccnmcv)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XM @ Xx3 @ Xz) = (ccfv @ XW @ ccnmcv)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XN @ Xx3 @ Xz) = (cco @ XU @ XW @ ccnmoo)))) => (! [Xx3:$i] : (! [Xz:$i] : (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv) & (cwf @ (XX @ Xx3) @ (XY @ Xz) @ XT)) => ((ccfv @ XT @ (XN @ Xx3 @ Xz)) = (ccsup @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (XL @ Xx3 @ Xz)) @ cc1 @ ccle) & ((ccv @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xz) @ XT) @ (XM @ Xx3 @ Xz))))) @ (^ [Xz:$i] : (XX @ Xx3)))) @ ccxr @ cclt))))))))))))))))))).
