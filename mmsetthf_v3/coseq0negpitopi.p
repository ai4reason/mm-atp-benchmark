...
thf(acoseq00topi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) => (((ccfv @ XA2 @ cccos) = ccc0) <=> (XA2 = (cco @ ccpi @ cc2 @ ccdiv)))))).
...
thf(acoshalfpi_thm,axiom,((ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ cccos) = ccc0)).
thf(acosneghalfpi_thm,axiom,((ccfv @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ cccos) = ccc0)).
thf(ccoseq0negpitopi_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) => (((ccfv @ XA2 @ cccos) = ccc0) <=> (cwcel @ XA2 @ (ccpr @ (cco @ ccpi @ cc2 @ ccdiv) @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)))))))).
