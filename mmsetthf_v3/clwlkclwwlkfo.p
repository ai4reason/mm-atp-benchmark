...
thf(aswrdccatid_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XB2 @ (ccword @ XV)) & (XN = (ccfv @ XA2 @ cchash))) => ((cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ ccc0 @ XN) @ ccsubstr) = XA2))))))).
