...
thf(cmapfzcons1cl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (cco @ XN @ cc1 @ ccaddc)) => ((cwcel @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ XM @ ccfz) @ ccmap)) => (cwcel @ (ccres @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))))))))).
