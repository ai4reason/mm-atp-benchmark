...
thf(cbinomfallfaclem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph & (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz))) => (cwcel @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ XK @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccaddc) @ ccfallfac) @ ccmul) @ ccmul) @ ccc))))))))))).
