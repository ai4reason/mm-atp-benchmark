...
thf(chcaucvg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ cccau) & (cwcel @ XA2 @ ccrp)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xz) @ XF) @ ccmv) @ ccno) @ XA2 @ cclt)) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn)))))).
