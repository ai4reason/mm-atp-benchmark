...
thf(cnoresle_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : ((((cwcel @ XU @ ccsur) & (cwcel @ XS @ ccsur)) & ((cwss @ (ccdm @ XU) @ XA2) & (cwss @ (ccdm @ XS) @ XA2) & (cwral @ (^ [Xg1:$i] : (~ (cwbr @ (ccres @ XS @ (ccsuc @ (ccv @ Xg1))) @ (ccres @ XU @ (ccsuc @ (ccv @ Xg1))) @ ccslt))) @ (^ [Xg1:$i] : XA2)))) => (~ (cwbr @ XS @ XU @ ccslt))))))).
