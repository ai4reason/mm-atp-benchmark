...
thf(cirrapxlem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ XB2 @ cclt)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : ((cwbr @ ccc0 @ (ccv @ Xy1) @ cclt) & (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xy1) @ ccdenom) @ (ccneg @ cc2) @ ccexp) @ cclt))) @ (^ [Xy1:$i] : ccq)))))))).
