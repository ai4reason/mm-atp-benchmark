...
thf(awinalim2_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccwina) & (XA2 != ccom)) => (? [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ ccale) = XA2) & (cwlim @ (ccv @ Xx3))))))).
...
thf(aalephle_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwss @ XA2 @ (ccfv @ XA2 @ ccale))))).
...
thf(aalephsing_thm,axiom,(! [XA2:($i > $o)] : ((cwlim @ XA2) => ((ccfv @ (ccfv @ XA2 @ ccale) @ cccf) = (ccfv @ XA2 @ cccf))))).
thf(aad2antrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xph & Xch) & Xth) => Xps))))))).
thf(asimp2bi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph <=> (Xps & Xch & Xth)) => (Xph => Xch))))))).
thf(aelwina_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccwina) <=> ((XA2 != cc0) & ((ccfv @ XA2 @ cccf) = XA2) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
thf(acfle_thm,axiom,(! [XA2:($i > $o)] : (cwss @ (ccfv @ XA2 @ cccf) @ XA2))).
thf(cwinafp_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccwina) & (XA2 != ccom)) => ((ccfv @ XA2 @ ccale) = XA2)))).
