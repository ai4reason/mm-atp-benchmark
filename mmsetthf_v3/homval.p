...
thf(chomval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwf @ cchil @ cchil @ XT) & (cwcel @ XB2 @ cchil)) => ((ccfv @ XB2 @ (cco @ XA2 @ XT @ cchot)) = (cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccsm))))))).
