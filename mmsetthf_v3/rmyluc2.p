...
thf(crmyluc2_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) = (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmy) @ ccmin)))))).
