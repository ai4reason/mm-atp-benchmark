...
thf(cclimxrre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccxr @ XF)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => (Xph => (cwrex @ (^ [Xj:$i] : (cwf @ (ccfv @ (ccv @ Xj) @ ccuz) @ ccr @ (ccres @ XF @ (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))).
