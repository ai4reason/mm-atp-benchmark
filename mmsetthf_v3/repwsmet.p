...
thf(crepwsmet_conj,conjecture,(! [XD:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ (cco @ cccnfld @ ccr @ ccress) @ XI @ ccpws)) => ((XD = (ccfv @ XY @ ccds)) => ((XX = (cco @ ccr @ XI @ ccmap)) => ((cwcel @ XI @ ccfn) => (cwcel @ XD @ (ccfv @ XX @ ccme))))))))))).
