...
thf(cswrdfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XS @ (ccword @ XA2)) & (cwcel @ XF @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) & (cwcel @ XX @ (cco @ ccc0 @ (cco @ XL @ XF @ ccmin) @ ccfzo))) => ((ccfv @ XX @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr)) = (ccfv @ (cco @ XX @ XF @ ccaddc) @ XS))))))))).
