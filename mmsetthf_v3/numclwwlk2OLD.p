...
thf(cnumclwwlk2OLD_conj,conjecture,(! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XQ @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv)) & ((ccfv @ (ccv @ Xw) @ cclsw) != (ccv @ Xv)))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn)))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XH @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv)) & ((ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) != (ccfv @ ccc0 @ (ccv @ Xw))))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn)))))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((((cwbr @ XG @ (XK @ Xv @ Xn) @ ccrusgr) & (cwcel @ XG @ ccfrgr)) & ((cwcel @ XV @ ccfn) & (cwcel @ XX @ XV) & (cwcel @ XN @ (ccfv @ cc3 @ ccuz)))) => ((ccfv @ (cco @ XX @ XN @ (XH @ Xw @ Xv @ Xn)) @ cchash) = (cco @ (cco @ (XK @ Xv @ Xn) @ (cco @ XN @ cc2 @ ccmin) @ ccexp) @ (ccfv @ (cco @ XX @ (cco @ XN @ cc2 @ ccmin) @ (ccfv @ XG @ ccclwwlknon)) @ cchash) @ ccmin))))))))))))))))).
