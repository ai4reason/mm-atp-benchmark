...
thf(aftalem6_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => ((ccfv @ ccc0 @ XF) != ccc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ cclt)) @ (^ [Xx3:$i] : ccc)))))))))))))).
...
thf(adgrco_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((Xph => (cwcel @ XG @ (ccfv @ XS @ ccply))) => (Xph => ((ccfv @ (cccom @ XF @ XG) @ ccdgr) = (cco @ XM @ XN @ ccmul)))))))))))))).
...
thf(cftalem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => ((ccfv @ XX @ XF) != ccc0)) => (Xph => (~ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle)) @ (^ [Xx3:$i] : ccc))))))))))))))))).
