...
thf(cmbfmco_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XR @ (ccuni @ (ccrn @ ccsiga)))) => ((Xph => (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((Xph => (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => ((Xph => (cwcel @ XF @ (cco @ XR @ XS @ ccmbfm))) => ((Xph => (cwcel @ XG @ (cco @ XS @ XT @ ccmbfm))) => (Xph => (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccmbfm))))))))))))))).
