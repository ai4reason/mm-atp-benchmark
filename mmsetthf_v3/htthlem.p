...
thf(aipblnfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (cco @ XU @ (XC @ Xx3) @ ccblo))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ XP))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ XX) => (cwcel @ (XF @ Xx3) @ (XB2 @ Xx3)))))))))))))))))).
