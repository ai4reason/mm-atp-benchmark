...
thf(adsmmbas2_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xf1) @ (cccom @ cc0g @ XR))) @ ccfn)) @ (^ [Xf1:$i] : (ccfv @ XP @ ccbs))))) => (! [Xf1:$i] : (((cwfn @ XR @ XI) & (cwcel @ XI @ XV)) => ((XB2 @ Xf1) = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs))))))))))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(aressid_thm,axiom,(! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((cwcel @ XW @ XX) => ((cco @ XW @ XB2 @ ccress) = XW))))))).
thf(cdsmmfi_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (((cwfn @ XR @ XI) & (cwcel @ XI @ ccfn)) => ((cco @ XS @ XR @ ccdsmm) = (cco @ XS @ XR @ ccprds))))))).
