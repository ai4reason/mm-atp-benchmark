...
thf(cfrnsuppeq_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XI @ XV) & (cwcel @ XZ @ XW)) => ((cwf @ XI @ XS @ XF) => ((cco @ XF @ XZ @ ccsupp) = (ccima @ (cccnv @ XF) @ (ccdif @ XS @ (ccsn @ XZ))))))))))))).
