...
thf(afpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => ((XA2 != XB2) => (cwf @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD) @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))))))))))))).
...
thf(acoinflipuniv_thm,axiom,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((XH != XT) => ((XP = (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((XX = (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => ((ccuni @ (ccdm @ XP)) = (ccpr @ XH @ XT)))))))))))).
...
thf(acoinflipspace_thm,axiom,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((XH != XT) => ((XP = (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((XX = (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => ((ccdm @ XP) = (ccpw @ (ccpr @ XH @ XT))))))))))))).
...
thf(aisrrvv_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XP @ ccprb))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cwcel @ XX @ (ccfv @ XP @ ccrrv)) <=> ((cwf @ (ccuni @ (ccdm @ XP)) @ ccr @ XX) & (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ XX) @ (ccv @ Xy1)) @ (ccdm @ XP))) @ (^ [Xy1:$i] : ccbrsiga))))))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(ccrp_tp,type,(ccrp : ($i > $o))).
thf(ccmeas_tp,type,(ccmeas : ($i > $o))).
thf(ccxdiv_tp,type,(ccxdiv : ($i > $o))).
thf(acoinflipprob_thm,axiom,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((XH != XT) => ((XP = (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((XX = (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => (cwcel @ XP @ ccprb))))))))))).
thf(ccoinfliprv_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((XH != XT) => ((XP = (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((XX = (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => (cwcel @ XX @ (ccfv @ XP @ ccrrv)))))))))))).
