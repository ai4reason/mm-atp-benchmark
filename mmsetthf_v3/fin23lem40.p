...
thf(asornom_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ ccom) & (cwral @ (^ [Xa:$i] : ((cwbr @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF) @ XR) | ((ccfv @ (ccv @ Xa) @ XF) = (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF)))) @ (^ [Xa:$i] : ccom)) & (cwpo @ (ccrn @ XF) @ XR)) => (cwor @ (ccrn @ XF) @ XR))))).
...
thf(cfin23lem40_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xg1:$i] : ((XF @ Xx3 @ Xg1) = (^ [Xg1:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xg1)) @ ccom @ ccmap))))))) => (! [Xx3:$i] : (! [Xg1:$i] : ((cwcel @ XA2 @ ccfin2) => (cwcel @ XA2 @ (XF @ Xx3 @ Xg1))))))))).
