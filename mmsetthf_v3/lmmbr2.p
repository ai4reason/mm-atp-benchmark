...
thf(almmbr_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> ((cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) & (cwcel @ XP @ XX) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (ccres @ XF @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz)))) @ (^ [Xx3:$i] : ccrp))))))))))))))).
...
thf(aelpmg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccpm)) <=> ((cwfun @ XC) & (cwss @ XC @ (ccxp @ XB2 @ XA2))))))))))).
