...
thf(aelrfirn_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (((cwcel @ (XB2 @ Xy1) @ (XV @ Xy1)) & (cwf @ (XI @ Xy1) @ (ccpw @ (XB2 @ Xy1)) @ XF)) => ((cwcel @ (XA2 @ Xy1) @ (ccfv @ (ccun @ (ccsn @ (XB2 @ Xy1)) @ (ccrn @ XF)) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : ((XA2 @ Xy1) = (ccin @ (XB2 @ Xy1) @ (cciin @ (^ [Xy1:$i] : (ccv @ Xv)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XF)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ (XI @ Xy1)) @ ccfn)))))))))))).
