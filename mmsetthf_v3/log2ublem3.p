...
thf(alog2ublem2_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwbr @ (cco @ (cco @ (cco @ cc3 @ cc7 @ ccexp) @ (cco @ cc5 @ cc7 @ ccmul) @ ccmul) @ (ccsu @ (cco @ ccc0 @ XK @ ccfz) @ (^ [Xn:$i] : (cco @ cc2 @ (cco @ (cco @ cc3 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ (cco @ cc9 @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))) @ ccmul) @ (cco @ cc2 @ (XB2 @ Xn) @ ccmul) @ ccle)) => ((! [Xn:$i] : (cwcel @ (XB2 @ Xn) @ ccn0)) => ((! [Xn:$i] : (cwcel @ (XF @ Xn) @ ccn0)) => ((cwcel @ XN @ ccn0) => (((cco @ XN @ cc1 @ ccmin) = XK) => ((! [Xn:$i] : ((cco @ (XB2 @ Xn) @ (XF @ Xn) @ ccaddc) = (XG @ Xn))) => ((! [Xn:$i] : (cwcel @ (XM @ Xn) @ ccn0)) => ((! [Xn:$i] : ((cco @ (XM @ Xn) @ XN @ ccaddc) = cc3)) => ((! [Xn:$i] : ((cco @ (cco @ cc5 @ cc7 @ ccmul) @ (cco @ cc9 @ (XM @ Xn) @ ccexp) @ ccmul) = (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ (XF @ Xn) @ ccmul))) => (! [Xn:$i] : (cwbr @ (cco @ (cco @ (cco @ cc3 @ cc7 @ ccexp) @ (cco @ cc5 @ cc7 @ ccmul) @ ccmul) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xn:$i] : (cco @ cc2 @ (cco @ (cco @ cc3 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ (cco @ cc9 @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))) @ ccmul) @ (cco @ cc2 @ (XG @ Xn) @ ccmul) @ ccle)))))))))))))))))).
...
thf(arisefall0lem_thm,axiom,((cco @ ccc0 @ (cco @ ccc0 @ cc1 @ ccmin) @ ccfz) = cc0)).
