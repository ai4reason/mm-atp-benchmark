...
thf(axpsc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cccnv @ (cco @ (ccsn @ XA2) @ (ccsn @ XB2) @ cccda)) = (ccun @ (ccxp @ (ccsn @ cc0) @ (ccsn @ XA2)) @ (ccxp @ (ccsn @ cc1o) @ (ccsn @ XB2))))))).
...
thf(cxpsc1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((ccfv @ cc1o @ (cccnv @ (cco @ (ccsn @ XA2) @ (ccsn @ XB2) @ cccda))) = XB2)))))).
