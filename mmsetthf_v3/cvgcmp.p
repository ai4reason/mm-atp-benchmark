...
thf(acaurcvg2_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ XF @ (XV @ Xx3 @ Xj @ Xk)))))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr) & (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xj) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccrp))) => (Xph => (cwcel @ XF @ (ccdm @ ccli)))))))))))).
