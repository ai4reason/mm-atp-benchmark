...
thf(ciunxdif3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XE @ Xx3))) => ((cwral @ (^ [Xx3:$i] : ((XB2 @ Xx3) = cc0)) @ (^ [Xx3:$i] : (XE @ Xx3))) => ((cciun @ (^ [Xx3:$i] : (ccdif @ XA2 @ (XE @ Xx3))) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
