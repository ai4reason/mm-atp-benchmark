...
thf(apwspjmhm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XY @ Xx3) = (cco @ XR @ XI @ ccpws))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XY @ Xx3) @ ccbs))) => (! [Xx3:$i] : (((cwcel @ XR @ ccmnd) & (cwcel @ XI @ XV) & (cwcel @ XA2 @ XI)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccv @ Xx3)))) @ (cco @ (XY @ Xx3) @ XR @ ccmhm))))))))))))).
...
thf(cpwsmulg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_xb = (ccfv @ XY @ ccmg)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((((cwcel @ XR @ ccmnd) & (cwcel @ XI @ XV)) & ((cwcel @ XN @ ccn0) & (cwcel @ XX @ XB2) & (cwcel @ XA2 @ XI))) => ((ccfv @ XA2 @ (cco @ XN @ XX @ Xc_xb)) = (cco @ XN @ (ccfv @ XA2 @ XX) @ Xc_x)))))))))))))))))).
