...
thf(cundifixp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) & (cwcel @ XG @ (ccixp @ (^ [Xx3:$i] : (ccdif @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3)))) & (cwss @ XB2 @ XA2)) => (cwcel @ (ccun @ XF @ XG) @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
