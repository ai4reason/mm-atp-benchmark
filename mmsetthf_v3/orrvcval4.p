...
thf(corrvcval4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XP @ Xy1) @ ccprb))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XX @ (ccfv @ (XP @ Xy1) @ ccrrv)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ (XV @ Xy1)))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cco @ XX @ XA2 @ (ccorvc @ XR)) = (ccima @ (cccnv @ XX) @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XA2 @ XR)) @ (^ [Xy1:$i] : ccr)))))))))))))))).
