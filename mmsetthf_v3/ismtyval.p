...
thf(cismtyval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((cco @ XM @ XN @ ccismty) = (^ [Xf1:$i] : ((cwf1o @ XX @ XY @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))).
