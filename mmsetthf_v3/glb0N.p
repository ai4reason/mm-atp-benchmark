...
thf(aop1le_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => (((cwcel @ XK @ ccops) & (cwcel @ XX @ XB2)) => ((cwbr @ Xc_1 @ XX @ Xc_le) <=> (XX = Xc_1)))))))))))).
...
thf(cglb0N_conj,conjecture,(! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XG = (ccfv @ XK @ ccglb)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((cwcel @ XK @ ccops) => ((ccfv @ cc0 @ XG) = Xc_1)))))))).
