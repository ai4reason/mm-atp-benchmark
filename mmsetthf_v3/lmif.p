...
thf(almieu_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : ((XP = (ccfv @ XG @ ccbs)) => ((! [Xb:$i] : ((Xc_mi @ Xb) = (ccfv @ XG @ ccds))) => ((! [Xb:$i] : ((XI @ Xb) = (ccfv @ XG @ ccitv))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XD @ (ccrn @ XL))) => ((Xph => (cwcel @ XA2 @ XP)) => (Xph => (cwreu @ (^ [Xb:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xb) @ (ccfv @ XG @ ccmid)) @ XD) & ((cwbr @ XD @ (cco @ XA2 @ (ccv @ Xb) @ XL) @ (ccfv @ XG @ ccperpg)) | (XA2 = (ccv @ Xb))))) @ (^ [Xb:$i] : XP)))))))))))))))))))).
...
thf(clmif_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => ((XM = (ccfv @ XD @ (ccfv @ XG @ cclmi))) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XD @ (ccrn @ XL))) => (Xph => (cwf @ XP @ XP @ XM))))))))))))))))))).
