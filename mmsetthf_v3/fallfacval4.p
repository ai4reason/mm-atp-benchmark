...
thf(afallfacval3_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (cco @ ccc0 @ XA2 @ ccfz)) => ((cco @ XA2 @ XN @ ccfallfac) = (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccmin) @ XA2 @ ccfz)) @ (^ [Xk:$i] : (ccv @ Xk)))))))).
