...
thf(cinfxpenc2lem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XA2 @ ccon0))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2)))) => ((! [Xn:$i] : (! [Xb:$i] : ((XW @ Xn @ Xb) = (ccfv @ (ccrn @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccon0 @ cc1o)) @ (^ [Xx3:$i] : (cco @ ccom @ (ccv @ Xx3) @ ccoe)))))))) => (! [Xn:$i] : (! [Xb:$i] : (((Xph @ Xn) & ((cwcel @ (ccv @ Xb) @ XA2) & (cwss @ ccom @ (ccv @ Xb)))) => ((cwcel @ (XW @ Xn @ Xb) @ (ccdif @ ccon0 @ cc1o)) & (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (XW @ Xn @ Xb) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)))))))))))))).
