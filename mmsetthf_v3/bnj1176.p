...
thf(cbnj1176_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xw:$i] : ((Xph & Xps) => (cw_bnj17 @ (cwfr @ (XA2 @ Xz @ Xw) @ (XR @ Xz @ Xw)) @ (cwss @ (XC @ Xz) @ (XA2 @ Xz @ Xw)) @ ((XC @ Xz) != cc0) @ (cwcel @ (XC @ Xz) @ ccvv))))) => ((! [Xz:$i] : (! [Xw:$i] : ((cw_bnj17 @ (cwfr @ (XA2 @ Xz @ Xw) @ (XR @ Xz @ Xw)) @ (cwss @ (XC @ Xz) @ (XA2 @ Xz @ Xw)) @ ((XC @ Xz) != cc0) @ (cwcel @ (XC @ Xz) @ ccvv)) => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (~ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)))) @ (^ [Xw:$i] : (XC @ Xz)))) @ (^ [Xz:$i] : (XC @ Xz)))))) => (? [Xz:$i] : (! [Xw:$i] : ((Xph & Xps) => ((cwcel @ (ccv @ Xz) @ (XC @ Xz)) & ((Xth @ Xz @ Xw) => ((cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)) => (~ (cwcel @ (ccv @ Xw) @ (XC @ Xz)))))))))))))))))).
