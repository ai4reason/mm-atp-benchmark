...
thf(cusgredgop_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XG @ ccusgr) & (XE = (ccfv @ XG @ cciedg)) & (cwcel @ XX @ (ccdm @ XE))) => (((ccfv @ XX @ XE) = (ccpr @ XM @ XN)) <=> (cwcel @ (ccop @ XX @ (ccpr @ XM @ XN)) @ XE))))))))).
