...
thf(af1lindf_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwbr @ XF @ XW @ cclindf) & (cwf1 @ XK @ (ccdm @ XF) @ XG)) => (cwbr @ (cccom @ XF @ XG) @ XW @ cclindf))))))).
thf(cf1linds_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwcel @ XS @ (ccfv @ XW @ cclinds)) & (cwf1 @ XD @ XS @ XF)) => (cwbr @ XF @ XW @ cclindf))))))).
