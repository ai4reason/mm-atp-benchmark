...
thf(ameasinblem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (((((cwcel @ XM @ (ccfv @ XS @ ccmeas)) & (cwcel @ XA2 @ XS)) & (cwcel @ XB2 @ (ccpw @ XS))) & ((cwbr @ XB2 @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((ccfv @ (ccin @ (ccuni @ XB2) @ XA2) @ XM) = (ccesum @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ XM)))))))))).
