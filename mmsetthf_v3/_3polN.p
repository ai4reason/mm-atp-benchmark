...
thf(c_3polN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ cchlt) & (cwss @ XS @ XA2)) => ((ccfv @ (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe) @ Xc_pe) = (ccfv @ XS @ Xc_pe)))))))))).
