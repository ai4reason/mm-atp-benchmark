...
thf(aefexp_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccz)) => ((ccfv @ (cco @ XN @ XA2 @ ccmul) @ cce) = (cco @ (ccfv @ XA2 @ cce) @ XN @ ccexp)))))).
...
thf(amulcand_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (XC != ccc0)) => (Xph => (((cco @ XC @ XA2 @ ccmul) = (cco @ XC @ XB2 @ ccmul)) <=> (XA2 = XB2)))))))))))).
thf(a_2ne0_thm,axiom,(cc2 != ccc0)).
thf(aoveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(ait0e0_thm,axiom,((cco @ cci @ ccc0 @ ccmul) = ccc0)).
thf(cccos_tp,type,(cccos : ($i > $o))).
thf(atanval3_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) != ccc0)) => ((ccfv @ XA2 @ cctan) = (cco @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccmin) @ (cco @ cci @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))).
...
thf(ctanarg_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ ccre) != ccc0)) => ((ccfv @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ cctan) = (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XA2 @ ccre) @ ccdiv))))).
