...
thf(aodadd2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccabl) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwbr @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccmul) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XO) @ (cco @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccgcd) @ cc2 @ ccexp) @ ccmul) @ ccdvds)))))))))))).
...
thf(codadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((((cwcel @ XG @ ccabl) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) & ((cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccgcd) = cc1)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XO) = (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccmul))))))))))))).
