...
thf(a_0wdom_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwbr @ cc0 @ XX @ ccwdom))))).
...
thf(abrwdomn0_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX != cc0) => ((cwbr @ XX @ XY @ ccwdom) <=> (? [Xz:$i] : (cwfo @ XY @ XX @ (ccv @ Xz)))))))).
...
thf(cbrwdom2_conj,conjecture,(! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XY @ (XV @ Xy1 @ Xz)) => ((cwbr @ XX @ XY @ ccwdom) <=> (cwrex @ (^ [Xy1:$i] : (? [Xz:$i] : (cwfo @ (ccv @ Xy1) @ XX @ (ccv @ Xz)))) @ (^ [Xy1:$i] : (ccpw @ XY))))))))))).
