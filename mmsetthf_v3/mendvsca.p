...
thf(amendvscafval_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (ccfv @ XM @ ccmend)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XM @ ccvsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XB2 = (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccfv @ XM @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XK = (ccfv @ (XS @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccfv @ XM @ ccbs)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ (XA2 @ Xx3 @ Xy1) @ ccvsca) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XK)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccxp @ (XE @ Xx3 @ Xy1) @ (ccsn @ (ccv @ Xx3))) @ (ccv @ Xy1) @ (ccof @ (Xc_x @ Xx3 @ Xy1))))))))))))))))))))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cmendvsca_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XM @ ccmend)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((XK = (ccfv @ XS @ ccbs)) => ((XE = (ccfv @ XM @ ccbs)) => ((Xc_xb = (ccfv @ XA2 @ ccvsca)) => (((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_xb) = (cco @ (ccxp @ XE @ (ccsn @ XX)) @ XY @ (ccof @ Xc_x)))))))))))))))))))))).
