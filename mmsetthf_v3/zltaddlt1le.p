...
thf(czltaddlt1le_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioo))) => ((cwbr @ (cco @ XM @ XA2 @ ccaddc) @ XN @ cclt) <=> (cwbr @ (cco @ XM @ XA2 @ ccaddc) @ XN @ ccle))))))).
