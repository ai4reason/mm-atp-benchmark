...
thf(cioo2bl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cco @ XA2 @ XB2 @ ccioo) = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ XD @ ccbl))))))))).
