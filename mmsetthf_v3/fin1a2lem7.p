...
thf(aisfin3_2_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfin3) <=> (~ (cwbr @ ccom @ XA2 @ ccwdom))))))).
thf(afin1a2lem6_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwf1o @ (ccrn @ (XE @ Xx3)) @ (ccdif @ ccom @ (ccrn @ (XE @ Xx3))) @ (ccres @ (XS @ Xx3) @ (ccrn @ (XE @ Xx3)))))))))).
