...
thf(asseqp1_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XS @ ccvv)) => ((Xph => (cwcel @ XM @ (ccword @ XS))) => ((XW = (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((Xph => (cwf @ XW @ XS @ XF)) => ((Xph => (cwcel @ XN @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz))) => (Xph => ((ccfv @ XN @ (cco @ XM @ XF @ ccsseq)) = (ccfv @ (ccres @ (cco @ XM @ XF @ ccsseq) @ (cco @ ccc0 @ XN @ ccfzo)) @ XF))))))))))))))).
...
thf(cfibp1_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfib) = (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfib) @ (ccfv @ XN @ ccfib) @ ccaddc))))).
