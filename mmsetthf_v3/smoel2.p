...
thf(asmoel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwsmo @ XB2) & (cwcel @ XA2 @ (ccdm @ XB2)) & (cwcel @ XC @ XA2)) => (cwcel @ (ccfv @ XC @ XB2) @ (ccfv @ XA2 @ XB2))))))).
thf(csmoel2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((((cwfn @ XF @ XA2) & (cwsmo @ XF)) & ((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XB2))) => (cwcel @ (ccfv @ XC @ XF) @ (ccfv @ XB2 @ XF)))))))).
