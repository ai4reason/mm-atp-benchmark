...
thf(crlimcxp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XA2)) => (cwcel @ (XB2 @ Xn) @ (XV @ Xn)))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccc0 @ ccrli)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (cco @ (XB2 @ Xn) @ XC @ cccxp))) @ ccc0 @ ccrli))))))))))).
