...
thf(acdaxpdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ cc1o @ XA2 @ ccsdm) & (cwbr @ cc1o @ XB2 @ ccsdm)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (ccxp @ XA2 @ XB2) @ ccdom))))).
...
thf(adomunsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) => (cwbr @ (ccun @ XA2 @ (ccsn @ XC)) @ XB2 @ ccdom)))))).
...
thf(ccanthp1lem1_conj,conjecture,(! [XA2:($i > $o)] : ((cwbr @ cc1o @ XA2 @ ccsdm) => (cwbr @ (cco @ XA2 @ cc2o @ cccda) @ (ccpw @ XA2) @ ccdom)))).
