...
thf(asscpwex_thm,axiom,(! [XJ:($i > $o)] : (cwcel @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ XJ @ ccssc)) @ ccvv))).
...
thf(adf_subc_ax,axiom,(ccsubc = (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (^ [Xh:$i] : ((cwbr @ (ccv @ Xh) @ (ccfv @ (ccv @ Xc) @ cchomf) @ ccssc) & (cwsbc @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xc) @ cccid)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xh))) & (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : (cwcel @ (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ (ccfv @ (ccv @ Xc) @ ccco))) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xh)))) @ (^ [Xg1:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xh))))) @ (^ [Xf1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xh))))) @ (^ [Xz:$i] : (ccv @ Xs1)))) @ (^ [Xy1:$i] : (ccv @ Xs1))))) @ (^ [Xx3:$i] : (ccv @ Xs1)))) @ (ccdm @ (ccdm @ (ccv @ Xh)))))))))).
...
thf(asscrel_thm,axiom,(cwrel @ ccssc)).
