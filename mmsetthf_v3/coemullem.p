...
thf(adgrub2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((ccima @ XA2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) = (ccsn @ ccc0)))))))))).
...
thf(adgrle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XF @ Xz @ Xk) @ (ccfv @ (XS @ Xz @ Xk) @ ccply))))) => ((Xph => (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ XN @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xz:$i] : (! [Xk:$i] : (Xph => ((XF @ Xz @ Xk) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => (! [Xz:$i] : (! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (XF @ Xz @ Xk) @ ccdgr) @ XN @ ccle)))))))))))))).
thf(ccoemullem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => ((! [Xn:$i] : ((XM @ Xn) = (ccfv @ XF @ ccdgr))) => ((XN = (ccfv @ XG @ ccdgr)) => (! [Xn:$i] : (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (((ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccsu @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ XB2) @ ccmul)))))) & (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdgr) @ (cco @ (XM @ Xn) @ XN @ ccaddc) @ ccle)))))))))))))))).
