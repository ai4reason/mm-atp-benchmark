...
thf(celpmap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ XC) & (cwcel @ XX @ XB2)) => ((cwcel @ XP @ (ccfv @ XX @ XM)) <=> ((cwcel @ XP @ XA2) & (cwbr @ XP @ XX @ Xc_le))))))))))))))))).
