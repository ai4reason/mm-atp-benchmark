...
thf(af1cofveqaeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwf1 @ XB2 @ XC @ XF) & (cwf1 @ XA2 @ XB2 @ XG)) & ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2))) => (((ccfv @ (ccfv @ XX @ XG) @ XF) = (ccfv @ (ccfv @ XY @ XG) @ XF)) => (XX = XY))))))))))).
...
thf(cuspgrn2crct_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccuspgr) & (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts))) => ((ccfv @ XF @ cchash) != cc2)))))).
