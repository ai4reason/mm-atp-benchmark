...
thf(cllnset_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xp:$i] : ((XB2 @ Xp) = (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XC @ Xx3 @ Xp) = (ccfv @ XK @ cccvr)))) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccfv @ XK @ ccatm))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XN @ Xx3 @ Xp) = (ccfv @ XK @ cclln)))) => (! [Xx3:$i] : (! [Xp:$i] : ((cwcel @ XK @ (XD @ Xx3 @ Xp)) => ((XN @ Xx3 @ Xp) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ (XC @ Xx3 @ Xp))) @ (^ [Xp:$i] : (XA2 @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xp)))))))))))))))))).
