...
thf(ciccpartnel_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => ((Xph => (cwcel @ XX @ (ccrn @ XP))) => ((Xph & (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo))) => (~ (cwcel @ XX @ (cco @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP) @ ccioo))))))))))))).
