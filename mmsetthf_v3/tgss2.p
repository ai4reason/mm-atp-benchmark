...
thf(aralcom3_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)) => (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) => (Xph @ Xx3))) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
...
thf(ctgss2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xz:$i] : (((cwcel @ XB2 @ (XV @ Xz)) & ((ccuni @ XB2) = (ccuni @ XC))) => ((cwss @ (ccfv @ XB2 @ cctg) @ (ccfv @ XC @ cctg)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) & (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : XC)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (ccuni @ XB2)))))))))).
