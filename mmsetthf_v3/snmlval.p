...
thf(csnmlval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XS @ Xx3 @ Xk @ Xn @ Xr @ Xb) = (ccmpt @ (^ [Xr:$i] : (ccfv @ cc2 @ ccuz)) @ (^ [Xr:$i] : (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xb:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccrab @ (^ [Xk:$i] : ((ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xr) @ (ccv @ Xk) @ ccexp) @ ccmul) @ (ccv @ Xr) @ ccmo) @ ccfl) = (ccv @ Xb))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz))) @ cchash) @ (ccv @ Xn) @ ccdiv))) @ (cco @ cc1 @ (ccv @ Xr) @ ccdiv) @ ccli)) @ (^ [Xb:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xr) @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xx3:$i] : ccr)))))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xb:$i] : ((cwcel @ (XA2 @ Xr) @ (ccfv @ XR @ (XS @ Xx3 @ Xk @ Xn @ Xr @ Xb))) <=> ((cwcel @ XR @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (XA2 @ Xr) @ ccr) & (cwral @ (^ [Xb:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccrab @ (^ [Xk:$i] : ((ccfv @ (cco @ (cco @ (XA2 @ Xr) @ (cco @ XR @ (ccv @ Xk) @ ccexp) @ ccmul) @ XR @ ccmo) @ ccfl) = (ccv @ Xb))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz))) @ cchash) @ (ccv @ Xn) @ ccdiv))) @ (cco @ cc1 @ XR @ ccdiv) @ ccli)) @ (^ [Xb:$i] : (cco @ ccc0 @ (cco @ XR @ cc1 @ ccmin) @ ccfz))))))))))))))).
