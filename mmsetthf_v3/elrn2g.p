...
thf(adfrn3_thm,axiom,(! [XA2:($i > $o)] : ((ccrn @ XA2) = (^ [Xy1:$i] : (? [Xx3:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)))))).
thf(celrn2g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwcel @ XA2 @ (ccrn @ XB2)) <=> (? [Xx3:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ XA2) @ XB2))))))))).
