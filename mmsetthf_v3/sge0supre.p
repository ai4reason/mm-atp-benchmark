...
thf(csge0supre_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XX @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (Xph => ((ccfv @ XF @ ccsumge0) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XF)))))) @ ccr @ cclt))))))))))).
