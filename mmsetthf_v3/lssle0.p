...
thf(clssle0_conj,conjecture,(! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XS = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ cclmod) & (cwcel @ XX @ XS)) => ((cwss @ XX @ (ccsn @ Xc_0)) <=> (XX = (ccsn @ Xc_0))))))))))).
