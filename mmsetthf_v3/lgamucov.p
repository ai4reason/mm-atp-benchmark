...
thf(clgamucov_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : ((XU @ Xx3 @ Xk @ Xr) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ (ccv @ Xr) @ ccle) & (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xr) @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc)))))) => ((Xph => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : ((XJ @ Xx3 @ Xk @ Xr) = (ccfv @ cccnfld @ cctopn))))) => (! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwrex @ (^ [Xr:$i] : (cwcel @ XA2 @ (ccfv @ (XU @ Xx3 @ Xk @ Xr) @ (ccfv @ (XJ @ Xx3 @ Xk @ Xr) @ ccnt)))) @ (^ [Xr:$i] : ccn))))))))))))).
