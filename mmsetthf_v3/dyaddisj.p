...
thf(adyaddisjlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ XC @ ccn0) & (cwcel @ XD @ ccn0))) & (cwbr @ XC @ XD @ ccle)) => ((cwss @ (ccfv @ (cco @ XA2 @ XC @ XF) @ ccicc) @ (ccfv @ (cco @ XB2 @ XD @ XF) @ ccicc)) | (cwss @ (ccfv @ (cco @ XB2 @ XD @ XF) @ ccicc) @ (ccfv @ (cco @ XA2 @ XC @ XF) @ ccicc)) | ((ccin @ (ccfv @ (cco @ XA2 @ XC @ XF) @ ccioo) @ (ccfv @ (cco @ XB2 @ XD @ XF) @ ccioo)) = cc0)))))))))).
