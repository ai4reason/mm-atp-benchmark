...
thf(adf_ina_ax,axiom,(ccina = (^ [Xx3:$i] : (((ccv @ Xx3) != cc0) & ((ccfv @ (ccv @ Xx3) @ cccf) = (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwbr @ (ccpw @ (ccv @ Xy1)) @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xy1:$i] : (ccv @ Xx3))))))).
thf(celina_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccina) <=> ((XA2 != cc0) & ((ccfv @ XA2 @ cccf) = XA2) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccpw @ (ccv @ Xx3)) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : XA2)))))).
