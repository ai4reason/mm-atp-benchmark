...
thf(afictb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ XB2) => ((cwbr @ XA2 @ ccom @ ccdom) <=> (cwbr @ (ccfv @ XA2 @ ccfi) @ ccom @ ccdom)))))).
...
thf(c_2ndcsb_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cc2ndc) <=> (? [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg) = XJ)))))).
