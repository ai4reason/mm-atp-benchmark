...
thf(arngosn4_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XA2 @ XX)) => ((cwbr @ XX @ cc1o @ ccen) <=> (XR = (ccop @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2)) @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2))))))))))))).
