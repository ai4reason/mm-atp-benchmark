...
thf(aqtopval2_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ XV) & (cwfo @ XZ @ XY @ XF) & (cwss @ XZ @ XX)) => ((cco @ XJ @ XF @ ccqtop) = (ccrab @ (^ [Xs1:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xs1)) @ XJ)) @ (^ [Xs1:$i] : (ccpw @ XY))))))))))))).
...
thf(celqtop_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ XV) & (cwfo @ XZ @ XY @ XF) & (cwss @ XZ @ XX)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccqtop)) <=> ((cwss @ XA2 @ XY) & (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ XJ))))))))))))).
