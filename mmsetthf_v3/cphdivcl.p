...
thf(ccphdivcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & ((cwcel @ XA2 @ XK) & (cwcel @ XB2 @ XK) & (XB2 != ccc0))) => (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ XK)))))))))).
