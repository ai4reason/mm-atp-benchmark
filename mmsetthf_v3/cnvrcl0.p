...
thf(ccnvrcl0_conj,conjecture,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((cccnv @ (ccint @ (^ [Xx3:$i] : ((cwss @ XX @ (ccv @ Xx3)) & (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (ccv @ Xx3)) @ (ccrn @ (ccv @ Xx3)))) @ (ccv @ Xx3)))))) = (ccint @ (^ [Xy1:$i] : ((cwss @ (cccnv @ XX) @ (ccv @ Xy1)) & (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (ccv @ Xy1)) @ (ccrn @ (ccv @ Xy1)))) @ (ccv @ Xy1)))))))))).
