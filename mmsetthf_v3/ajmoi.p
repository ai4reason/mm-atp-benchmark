...
thf(aphoeqi_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (XX = (ccfv @ (XU @ Xy1) @ ccba))) => ((! [Xy1:$i] : ((XP @ Xy1) = (ccfv @ (XU @ Xy1) @ ccdip))) => ((! [Xy1:$i] : (cwcel @ (XU @ Xy1) @ cccphlo)) => (((cwf @ XY @ XX @ XS) & (cwf @ XY @ XX @ XT)) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XS) @ (XP @ Xy1)) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ (XP @ Xy1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX)) <=> (XS = XT))))))))))))).
