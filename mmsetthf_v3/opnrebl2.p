...
thf(amopnss_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XA2 @ XJ)) => (cwss @ XA2 @ XX)))))))).
...
thf(copnrebl2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccle) & (cwss @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ ccmin) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ ccaddc) @ ccioo) @ XA2))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : XA2)))))).
