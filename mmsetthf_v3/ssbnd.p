...
thf(cssbnd_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccres @ XM @ (ccxp @ XY @ XY))) => (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwcel @ XP @ XX)) => ((cwcel @ XN @ (ccfv @ XY @ ccbnd)) <=> (cwrex @ (^ [Xd:$i] : (cwss @ XY @ (cco @ XP @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xd:$i] : ccr))))))))))).
