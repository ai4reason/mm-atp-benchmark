...
thf(aevthicc_b_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc))) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))))))))))))).
...
thf(aiccssioo2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) & (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccioo))) => (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(abreqan12rd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xps => (XC = XD)) => ((Xps & Xph) => ((cwbr @ XA2 @ XC @ XR) <=> (cwbr @ XB2 @ XD @ XR))))))))))))).
...
thf(advferm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ XX @ ccr @ XF)) => ((Xph => (cwss @ XX @ ccr)) => ((Xph => (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XX)) => ((Xph => (cwcel @ XU @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => ((Xph => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccioo)))) => (Xph => ((ccfv @ XU @ (cco @ ccr @ XF @ ccdv)) = ccc0))))))))))))))).
...
thf(cdvivthlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ XN @ (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwbr @ XM @ XN @ cclt)) => ((Xph => (cwcel @ XC @ (cco @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ XM @ (cco @ ccr @ XF @ ccdv)) @ ccicc))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ XC @ (ccv @ Xy1) @ ccmul) @ ccmin))))) => (Xph => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) = XC)) @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccicc)))))))))))))))))))).
