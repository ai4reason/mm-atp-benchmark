...
thf(aofmul12_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccc @ XF)) & ((cwf @ XA2 @ ccc @ XG) & (cwf @ XA2 @ ccc @ XH))) => ((cco @ XF @ (cco @ XG @ XH @ (ccof @ ccmul)) @ (ccof @ ccmul)) = (cco @ XG @ (cco @ XF @ XH @ (ccof @ ccmul)) @ (ccof @ ccmul)))))))))).
...
thf(aofsubid_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccc @ XF)) => ((cco @ XF @ XF @ (ccof @ ccmin)) = (ccxp @ XA2 @ (ccsn @ ccc0)))))))).
...
thf(advconstbi_thm,axiom,(! [Xph:($i > $o)] : (! [XS:($i > $o)] : (! [XY:($i > $o)] : ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XS @ (ccpr @ ccr @ ccc)))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwf @ XS @ ccc @ XY))) => ((! [Xc:$i] : ((Xph @ Xc) => ((ccdm @ (cco @ XS @ XY @ ccdv)) = XS))) => (! [Xc:$i] : ((Xph @ Xc) => (((cco @ XS @ XY @ ccdv) = (ccxp @ XS @ (ccsn @ ccc0))) <=> (cwrex @ (^ [Xc:$i] : (XY = (ccxp @ XS @ (ccsn @ (ccv @ Xc))))) @ (^ [Xc:$i] : ccc)))))))))))).
...
thf(aexpgrowthi_thm,axiom,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XS @ (ccpr @ ccr @ ccc)))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XK @ ccc))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XC @ ccc))) => ((! [Xt:$i] : ((XY @ Xt) = (ccmpt @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (cco @ XC @ (ccfv @ (cco @ XK @ (ccv @ Xt) @ ccmul) @ cce) @ ccmul))))) => (! [Xt:$i] : ((Xph @ Xt) => ((cco @ XS @ (XY @ Xt) @ ccdv) = (cco @ (ccxp @ XS @ (ccsn @ XK)) @ (XY @ Xt) @ (ccof @ ccmul))))))))))))))).
...
thf(cexpgrowth_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : (! [Xc:$i] : ((Xph @ Xt @ Xc) => (cwcel @ XS @ (ccpr @ ccr @ ccc))))) => ((! [Xt:$i] : (! [Xc:$i] : ((Xph @ Xt @ Xc) => (cwcel @ XK @ ccc)))) => ((! [Xt:$i] : (! [Xc:$i] : ((Xph @ Xt @ Xc) => (cwf @ XS @ ccc @ (XY @ Xt))))) => ((! [Xt:$i] : (! [Xc:$i] : ((Xph @ Xt @ Xc) => ((ccdm @ (cco @ XS @ (XY @ Xt) @ ccdv)) = XS)))) => (! [Xt:$i] : (! [Xc:$i] : ((Xph @ Xt @ Xc) => (((cco @ XS @ (XY @ Xt) @ ccdv) = (cco @ (ccxp @ XS @ (ccsn @ XK)) @ (XY @ Xt) @ (ccof @ ccmul))) <=> (cwrex @ (^ [Xc:$i] : ((XY @ Xt) = (ccmpt @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (cco @ (ccv @ Xc) @ (ccfv @ (cco @ XK @ (ccv @ Xt) @ ccmul) @ cce) @ ccmul))))) @ (^ [Xc:$i] : ccc))))))))))))))).
