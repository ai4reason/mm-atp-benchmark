...
thf(admtpos_thm,axiom,(! [XF:($i > $o)] : ((cwrel @ (ccdm @ XF)) => ((ccdm @ (cctpos @ XF)) = (cccnv @ (ccdm @ XF)))))).
...
thf(a_19_41vvv_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : ((? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) & Xps)))) <=> ((? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))) & Xps))))).
