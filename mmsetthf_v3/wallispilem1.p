...
thf(asinbnd_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ (ccneg @ cc1) @ (ccfv @ XA2 @ ccsin) @ ccle) & (cwbr @ (ccfv @ XA2 @ ccsin) @ cc1 @ ccle))))).
...
thf(cwallispilem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : ((XI @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XN @ ccn0))) => (! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XI @ Xx3 @ Xn)) @ (ccfv @ XN @ (XI @ Xx3 @ Xn)) @ ccle)))))))))).
