...
thf(cisfne3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XX @ Xx3 @ Xy1) = (ccuni @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XY @ Xx3 @ Xy1) = (ccuni @ XB2)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ XC) => ((cwbr @ XA2 @ XB2 @ ccfne) <=> (((XX @ Xx3 @ Xy1) = (XY @ Xx3 @ Xy1)) & (cwral @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwss @ (ccv @ Xy1) @ XB2) & ((ccv @ Xx3) = (ccuni @ (ccv @ Xy1)))))) @ (^ [Xx3:$i] : XA2))))))))))))))).
