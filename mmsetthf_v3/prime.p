...
thf(cprime_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwral @ (^ [Xx3:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ ccn) => (((ccv @ Xx3) = cc1) | ((ccv @ Xx3) = XA2)))) @ (^ [Xx3:$i] : ccn)) <=> (cwral @ (^ [Xx3:$i] : (((cwbr @ cc1 @ (ccv @ Xx3) @ cclt) & (cwbr @ (ccv @ Xx3) @ XA2 @ ccle) & (cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ ccn)) => ((ccv @ Xx3) = XA2))) @ (^ [Xx3:$i] : ccn)))))).
