...
thf(cxrralrecnnge_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((? [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X)) => (! [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XA2 @ ccr))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XB2 @ ccxr))) => (! [Xn:$i] : ((Xph @ Xn) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwral @ (^ [Xn:$i] : (cwbr @ (cco @ XA2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccmin) @ XB2 @ ccle)) @ (^ [Xn:$i] : ccn)))))))))))).
