...
thf(cpridlc3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((((cwcel @ XR @ cccring) & (cwcel @ XP @ (ccfv @ XR @ ccpridl))) & ((cwcel @ XA2 @ (ccdif @ XX @ XP)) & (cwcel @ XB2 @ (ccdif @ XX @ XP)))) => (cwcel @ (cco @ XA2 @ XB2 @ XH) @ (ccdif @ XX @ XP)))))))))))))).
