...
thf(aatans2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : ((cwcel @ XA2 @ (XS @ Xy1)) <=> ((cwcel @ XA2 @ ccc) & (cwcel @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ XD) & (cwcel @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ XD)))))))))).
...
thf(aatansopn_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwcel @ (XS @ Xy1) @ (ccfv @ cccnfld @ cctopn)))))))).
...
thf(aatandm_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) <=> ((cwcel @ XA2 @ ccc) & (XA2 != (ccneg @ cci)) & (XA2 != cci))))).
