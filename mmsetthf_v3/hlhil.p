...
thf(apjcss_thm,axiom,(! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ ccpj)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ ccphl) => (cwss @ (ccdm @ XK) @ XC)))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aeqsstrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwss @ XB2 @ XC)) => (Xph => (cwss @ XA2 @ XC))))))))).
thf(acldcss2_thm,axiom,(! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XL = (ccfv @ XW @ cclss)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ cchl) => (XC = (ccin @ XL @ (ccfv @ XJ @ cccld)))))))))))))).
...
thf(apjth2_thm,axiom,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cctopn)) => ((XL = (ccfv @ XW @ cclss)) => ((XK = (ccfv @ XW @ ccpj)) => (((cwcel @ XW @ cchl) & (cwcel @ XU @ XL) & (cwcel @ XU @ (ccfv @ XJ @ cccld))) => (cwcel @ XU @ (ccdm @ XK)))))))))))).
thf(aishil_thm,axiom,(! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ XH @ ccpj)) => ((XC = (ccfv @ XH @ cccss)) => ((cwcel @ XH @ cchs) <=> ((cwcel @ XH @ ccphl) & ((ccdm @ XK) = XC))))))))).
