...
thf(acph2di_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((Xph => (cwcel @ XW @ cccph)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (cwcel @ XD @ XV)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ (cco @ XC @ XD @ Xc_pl) @ Xc_xi) = (cco @ (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XD @ Xc_xi) @ ccaddc) @ (cco @ (cco @ XA2 @ XD @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ ccaddc) @ ccaddc))))))))))))))))))))).
...
thf(acphassir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((((cwcel @ XW @ cccph) & (cwcel @ cci @ XK)) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cco @ XA2 @ (cco @ cci @ XB2 @ Xc_x) @ Xc_xi) = (cco @ (ccneg @ cci) @ (cco @ XA2 @ XB2 @ Xc_xi) @ ccmul))))))))))))))))).
thf(acphassi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((((cwcel @ XW @ cccph) & (cwcel @ cci @ XK)) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cco @ (cco @ cci @ XB2 @ Xc_x) @ XA2 @ Xc_xi) = (cco @ cci @ (cco @ XB2 @ XA2 @ Xc_xi) @ ccmul))))))))))))))))).
