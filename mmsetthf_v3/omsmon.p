...
thf(axrge0infssd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XC @ XB2)) => ((Xph => (cwss @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (Xph => (cwbr @ (ccinf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ (ccinf @ XC @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ ccle)))))))).
