...
thf(cevengpop3_conj,conjecture,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc5 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ cc9 @ ccuz)) & (cwcel @ XN @ cceven)) => (cwrex @ (^ [Xo:$i] : (XN = (cco @ (ccv @ Xo) @ cc3 @ ccaddc))) @ (^ [Xo:$i] : ccgbow)))))).
