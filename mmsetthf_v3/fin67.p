...
thf(afin17_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ XA2 @ ccfin7)))).
...
thf(aisfin7_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xy1)) => ((cwcel @ XA2 @ ccfin7) <=> (~ (cwrex @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ ccen)) @ (^ [Xy1:$i] : (ccdif @ ccon0 @ ccom)))))))))).
