...
thf(chashimarn_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwf1 @ (ccdm @ XE) @ (ccrn @ XE) @ XE) & (cwcel @ XE @ XV)) => ((cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ XF) => ((ccfv @ (ccima @ XE @ (ccrn @ XF)) @ cchash) = (ccfv @ XF @ cchash)))))))).
