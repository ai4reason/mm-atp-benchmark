...
thf(amptctf_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : ((cwbr @ (XA2 @ Xx3) @ ccom @ ccdom) => (cwbr @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccom @ ccdom))))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(arnct_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ ccom @ ccdom) => (cwbr @ (ccrn @ XA2) @ ccom @ ccdom)))).
thf(cabrexctf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : ((cwbr @ (XA2 @ Xx3) @ ccom @ ccdom) => (cwbr @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) @ ccom @ ccdom))))))).
