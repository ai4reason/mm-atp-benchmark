...
thf(annindf_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ X)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = cc1) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xph @ Xx3 @ Xy1) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3 @ Xy1) <=> (Xta @ Xy1))))) => ((! [Xy1:$i] : (Xps @ Xy1)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccn) => ((Xch @ Xy1) => (Xth @ Xy1)))) => (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ ccn) => (Xta @ Xy1))))))))))))))))).
...
thf(cnn0min_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : ((! [Xn:$i] : (((ccv @ Xn) = ccc0) => ((Xps @ Xn) <=> Xch))) => ((! [Xm:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xm)) => ((Xps @ Xn) <=> (Xth @ Xm))))) => ((! [Xm:$i] : (! [Xn:$i] : (((ccv @ Xn) = (cco @ (ccv @ Xm) @ cc1 @ ccaddc)) => ((Xps @ Xn) <=> (Xta @ Xm))))) => ((Xph => (~ Xch)) => ((Xph => (cwrex @ (^ [Xn:$i] : (Xps @ Xn)) @ (^ [Xn:$i] : ccn))) => (Xph => (cwrex @ (^ [Xm:$i] : ((~ (Xth @ Xm)) & (Xta @ Xm))) @ (^ [Xm:$i] : ccn0)))))))))))))).
