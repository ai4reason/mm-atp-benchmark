...
thf(crpexp12i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0))) => (((cco @ XA2 @ XB2 @ ccgcd) = cc1) => ((cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccgcd) = cc1)))))))).
