...
thf(cpfxfvlsw_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ XW @ XL @ ccpfx) @ cclsw) = (ccfv @ (cco @ XL @ cc1 @ ccmin) @ XW))))))).
