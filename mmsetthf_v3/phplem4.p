...
thf(cphplem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cwbr @ (ccsuc @ XA2) @ (ccsuc @ XB2) @ ccen) => (cwbr @ XA2 @ XB2 @ ccen)))))))).
