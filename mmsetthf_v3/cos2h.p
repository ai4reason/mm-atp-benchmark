...
thf(acosq14ge0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ cccos) @ ccle)))).
...
thf(acos2t_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ cc2 @ XA2 @ ccmul) @ cccos) = (cco @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ cccos) @ cc2 @ ccexp) @ ccmul) @ cc1 @ ccmin))))).
...
thf(ccos2h_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) => ((ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ cccos) = (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccaddc) @ cc2 @ ccdiv) @ ccsqrt))))).
