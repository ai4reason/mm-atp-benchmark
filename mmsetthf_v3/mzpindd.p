...
thf(amzpval_thm,axiom,(! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => ((ccfv @ XV @ ccmzp) = (ccint @ (ccfv @ XV @ ccmzpcl)))))).
...
thf(aconstmap_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XB2 @ XC) => (cwcel @ (ccxp @ XA2 @ (ccsn @ XB2)) @ (cco @ XC @ XA2 @ ccmap))))))))).
