...
thf(aesumpfinvalf_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XA2 @ Xk) @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ (XA2 @ Xk))) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccesum @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccsu @ (XA2 @ Xk) @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))))).
...
thf(cvolfiniune_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xn:$i] : (cwcel @ (XB2 @ Xn) @ (ccdm @ ccvol))) @ (^ [Xn:$i] : XA2)) & (cwdisj @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn)))) => ((ccfv @ (cciun @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccvol) = (ccesum @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccfv @ (XB2 @ Xn) @ ccvol)))))))).
