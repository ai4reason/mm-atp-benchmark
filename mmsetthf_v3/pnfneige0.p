...
thf(aiocinif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) => ((ccin @ (cco @ XA2 @ XC @ ccioc) @ (cco @ XB2 @ XC @ ccioc)) = (ccif @ (cwbr @ XA2 @ XB2 @ cclt) @ (cco @ XB2 @ XC @ ccioc) @ (cco @ XA2 @ XC @ ccioc)))))))).
...
thf(cpnfneige0_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XJ @ Xx3)) & (cwcel @ ccpnf @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioc) @ XA2)) @ (^ [Xx3:$i] : ccr)))))))).
