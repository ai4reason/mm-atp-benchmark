...
thf(adeg1z_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((cwcel @ XR @ ccrg) => ((ccfv @ Xc_0 @ XD) = ccmnf)))))))))).
...
thf(agrpsubid1_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ XB2)) => ((cco @ XX @ Xc_0 @ Xc_mi) = XX))))))))))).
...
thf(adeg1cl_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((cwcel @ XF @ XB2) => (cwcel @ (ccfv @ XF @ XD) @ (ccun @ ccn0 @ (ccsn @ ccmnf))))))))))))).
...
thf(adegltlem1_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ (ccun @ ccn0 @ (ccsn @ ccmnf))) & (cwcel @ XY @ ccz)) => ((cwbr @ XX @ XY @ cclt) <=> (cwbr @ XX @ (cco @ XY @ cc1 @ ccmin) @ ccle)))))).
...
thf(adeg1mulle2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_x = (ccfv @ XY @ ccmulr)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwcel @ XJ @ ccn0)) => ((Xph => (cwcel @ XK @ ccn0)) => ((Xph => (cwbr @ (ccfv @ XF @ XD) @ XJ @ ccle)) => ((Xph => (cwbr @ (ccfv @ XG @ XD) @ XK @ ccle)) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_x) @ XD) @ (cco @ XJ @ XK @ ccaddc) @ ccle)))))))))))))))))))))))).
thf(aleidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwbr @ XA2 @ XA2 @ ccle)))))).
thf(adeg1tmle_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => (((cwcel @ XR @ ccrg) & (cwcel @ XC @ XK) & (cwcel @ XF @ ccn0)) => (cwbr @ (ccfv @ (cco @ XC @ (cco @ XF @ XX @ Xc_ex) @ Xc_x) @ XD) @ XF @ ccle)))))))))))))))))))).
thf(a_3eqtr4rd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XA2)) => ((Xph => (XD = XB2)) => (Xph => (XD = XC))))))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(acoe1tmmul2fv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_xb = (ccfv @ XP @ ccmulr)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((Xph => (cwcel @ XA2 @ XB2)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XC @ XK)) => ((Xph => (cwcel @ XD @ ccn0)) => ((Xph => (cwcel @ XY @ ccn0)) => (Xph => ((ccfv @ (cco @ XD @ XY @ ccaddc) @ (ccfv @ (cco @ XA2 @ (cco @ XC @ (cco @ XD @ XX @ Xc_ex) @ Xc_x) @ Xc_xb) @ ccco1)) = (cco @ (ccfv @ XY @ (ccfv @ XA2 @ ccco1)) @ XC @ Xc_xp))))))))))))))))))))))))))))))))))).
...
thf(agrpsubsub4_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccgrp) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2))) => ((cco @ (cco @ XX @ XY @ Xc_mi) @ XZ @ Xc_mi) = (cco @ XX @ (cco @ XZ @ XY @ Xc_pl) @ Xc_mi)))))))))))))).
...
thf(cply1divex_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((Xc_xb = (ccfv @ XP @ ccmulr)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (XG != Xc_0)) => ((! [Xq:$i] : ((Xc_1 @ Xq) = (ccfv @ XR @ ccur))) => ((! [Xq:$i] : ((XK @ Xq) = (ccfv @ XR @ ccbs))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((! [Xq:$i] : (Xph => (cwcel @ XI @ (XK @ Xq)))) => ((! [Xq:$i] : (Xph => ((cco @ (ccfv @ (ccfv @ XG @ XD) @ (ccfv @ XG @ ccco1)) @ XI @ Xc_x) = (Xc_1 @ Xq)))) => (Xph => (cwrex @ (^ [Xq:$i] : (cwbr @ (ccfv @ (cco @ XF @ (cco @ XG @ (ccv @ Xq) @ Xc_xb) @ Xc_mi) @ XD) @ (ccfv @ XG @ XD) @ cclt)) @ (^ [Xq:$i] : XB2))))))))))))))))))))))))))))))))).
