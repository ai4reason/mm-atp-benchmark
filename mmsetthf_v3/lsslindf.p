...
thf(clsslindf_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XW @ cclss)) => ((XX = (cco @ XW @ XS @ ccress)) => (((cwcel @ XW @ cclmod) & (cwcel @ XS @ XU) & (cwss @ (ccrn @ XF) @ XS)) => ((cwbr @ XF @ XX @ cclindf) <=> (cwbr @ XF @ XW @ cclindf))))))))))).
