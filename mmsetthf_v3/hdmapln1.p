...
thf(chdmapln1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((Xc_x = (ccfv @ XU @ ccvsca)) => ((XR = (ccfv @ XU @ ccsca)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pd = (ccfv @ XR @ ccplusg)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((XS = (ccfv @ XW @ (ccfv @ XK @ cchdma))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XZ @ XV)) => ((Xph => (cwcel @ XA2 @ XB2)) => (Xph => ((ccfv @ (cco @ (cco @ XA2 @ XX @ Xc_x) @ XY @ Xc_pl) @ (ccfv @ XZ @ XS)) = (cco @ (cco @ XA2 @ (ccfv @ XX @ (ccfv @ XZ @ XS)) @ Xc_xp) @ (ccfv @ XY @ (ccfv @ XZ @ XS)) @ Xc_pd)))))))))))))))))))))))))))))))))))).
