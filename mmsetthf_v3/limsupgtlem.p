...
thf(climsupgtlem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((Xph => (cwf @ XZ @ ccr @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ cclsp) @ ccr)) => ((Xph => (cwcel @ XX @ ccrp)) => (Xph => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ XX @ ccmin) @ (ccfv @ XF @ cclsp) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))).
