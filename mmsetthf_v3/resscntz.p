...
thf(cresscntz_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((XZ = (ccfv @ XG @ cccntz)) => ((XY = (ccfv @ XH @ cccntz)) => (((cwcel @ XA2 @ XV) & (cwss @ XS @ XA2)) => ((ccfv @ XS @ XY) = (ccin @ (ccfv @ XS @ XZ) @ XA2)))))))))))))).
