...
thf(apoimirlem32_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) & (cwcel @ (ccv @ Xz) @ XI) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = ccc0))) => (cwbr @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccc0 @ ccle)))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) & (cwcel @ (ccv @ Xz) @ XI) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = cc1))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccle)))) => (Xph => (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xv:$i] : ((cwcel @ (ccv @ Xc) @ (ccv @ Xv)) => (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xz:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ (ccv @ Xr))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xr:$i] : (ccpr @ ccle @ (cccnv @ ccle)))))) @ (^ [Xv:$i] : (cco @ XR @ XI @ ccrest)))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xc:$i] : XI))))))))))))))).
...
thf(apttoponconst_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt)) => (((cwcel @ XA2 @ XV) & (cwcel @ XR @ (ccfv @ XX @ cctopon))) => (cwcel @ XJ @ (ccfv @ (cco @ XX @ XA2 @ ccmap) @ cctopon)))))))))).
...
thf(aelioo5_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) <=> ((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XC @ XB2 @ cclt)))))))).
...
thf(aptpjcn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (XY = (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XF @ ccpt))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ cctop @ XF) & (cwcel @ XI @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (ccfv @ XI @ (ccv @ Xx3)))) @ (cco @ (XJ @ Xx3) @ (ccfv @ XI @ XF) @ cccn))))))))))))).
...
thf(cpoimir_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) & (cwcel @ (ccv @ Xz) @ XI) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = ccc0))) => (cwbr @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccc0 @ ccle)))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) & (cwcel @ (ccv @ Xz) @ XI) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = cc1))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccle)))) => (Xph => (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ XF) = (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ ccc0)))) @ (^ [Xc:$i] : XI))))))))))))))).
