...
thf(adifsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (cwcel @ XA2 @ XB2)) => ((ccdif @ XB2 @ (ccsn @ XA2)) = XB2))))).
...
thf(axpsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((ccxp @ (ccsn @ XA2) @ (ccsn @ XB2)) = (ccsn @ (ccop @ XA2 @ XB2)))))))).
thf(ac0ex_thm,axiom,(cwcel @ ccc0 @ ccvv)).
thf(aunass_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccun @ (ccun @ XA2 @ XB2) @ XC) = (ccun @ XA2 @ (ccun @ XB2 @ XC))))))).
thf(afmptapd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => ((ccun @ XR @ (ccsn @ XA2)) = XS)) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((XC @ Xx3) = XB2))) => (Xph => ((ccun @ (ccmpt @ (^ [Xx3:$i] : XR) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccsn @ (ccop @ XA2 @ XB2))) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))))))).
...
thf(afnsnsplit_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XX @ XA2)) => (XF = (ccun @ (ccres @ XF @ (ccdif @ XA2 @ (ccsn @ XX))) @ (ccsn @ (ccop @ XX @ (ccfv @ XX @ XF)))))))))).
