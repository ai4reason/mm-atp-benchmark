...
thf(cpcprendvds_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn0)))) => ((! [Xn:$i] : ((XS @ Xn) = (ccsup @ (XA2 @ Xn) @ ccr @ cclt))) => (! [Xn:$i] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => (~ (cwbr @ (cco @ XP @ (cco @ (XS @ Xn) @ cc1 @ ccaddc) @ ccexp) @ XN @ ccdvds))))))))))).
