...
thf(aceqsralv_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => ((cwcel @ XA2 @ XB2) => ((cwral @ (^ [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3))) @ (^ [Xx3:$i] : XB2)) <=> Xps)))))))).
...
thf(cacsfn_conj,conjecture,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XX @ XV) & (cwcel @ XK @ XX)) & ((cwss @ XT @ XX) & (cwcel @ XT @ ccfn))) => (cwcel @ (ccrab @ (^ [Xa:$i] : ((cwss @ XT @ (ccv @ Xa)) => (cwcel @ XK @ (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
