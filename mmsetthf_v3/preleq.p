...
thf(cpreleq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => ((((cwcel @ XA2 @ XB2) & (cwcel @ XC @ XD)) & ((ccpr @ XA2 @ XB2) = (ccpr @ XC @ XD))) => ((XA2 = XC) & (XB2 = XD)))))))))))).
