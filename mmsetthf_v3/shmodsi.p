...
thf(cshmodsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => ((cwss @ XA2 @ XC) => (cwss @ (ccin @ (cco @ XA2 @ XB2 @ ccph) @ XC) @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ ccph)))))))))).
