...
thf(adipcn_thm,axiom,(! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XU @ ccdip)) => ((XC = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XU @ ccnv) => (cwcel @ XP @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn))))))))))))).
