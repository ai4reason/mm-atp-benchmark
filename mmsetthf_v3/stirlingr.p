...
thf(astirling_thm,axiom,(! [XS:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (ccfv @ (ccv @ Xn) @ (XS @ Xn)) @ ccdiv))) @ cc1 @ ccli)))).
...
thf(cstirlingr_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : ((XR @ Xn) = (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cclm))) => (! [Xn:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (ccfv @ (ccv @ Xn) @ (XS @ Xn)) @ ccdiv))) @ cc1 @ (XR @ Xn)))))))).
