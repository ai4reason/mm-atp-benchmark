...
thf(advafvsca_thm,axiom,(! [XT:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (! [Xs1:$i] : ((XH @ Xf1 @ Xs1) = (ccfv @ XK @ cclh)))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((! [Xf1:$i] : (! [Xs1:$i] : ((XU @ Xf1 @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccdveca))))) => ((! [Xf1:$i] : (! [Xs1:$i] : ((Xc_x @ Xf1 @ Xs1) = (ccfv @ (XU @ Xf1 @ Xs1) @ ccvsca)))) => (! [Xf1:$i] : (! [Xs1:$i] : (((cwcel @ XK @ (XV @ Xf1 @ Xs1)) & (cwcel @ XW @ (XH @ Xf1 @ Xs1))) => ((Xc_x @ Xf1 @ Xs1) = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xf1:$i] : XE)) @ (^ [Xs1:$i] : (^ [Xf1:$i] : XT)) @ (^ [Xs1:$i] : (^ [Xf1:$i] : (ccfv @ (ccv @ Xf1) @ (ccv @ Xs1))))))))))))))))))))))).
...
thf(cdvavsca_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdveca))) => ((Xc_x = (ccfv @ XU @ ccvsca)) => ((((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) & ((cwcel @ XR @ XE) & (cwcel @ XF @ XT))) => ((cco @ XR @ XF @ Xc_x) = (ccfv @ XF @ XR))))))))))))))))))).
