...
thf(apmss12g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwss @ XA2 @ XC) & (cwss @ XB2 @ XD)) & ((cwcel @ XC @ XV) & (cwcel @ XD @ XW))) => (cwss @ (cco @ XA2 @ XB2 @ ccpm) @ (cco @ XC @ XD @ ccpm)))))))))).
...
thf(apmresg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XF @ (cco @ XA2 @ XC @ ccpm))) => (cwcel @ (ccres @ XF @ XB2) @ (cco @ XA2 @ XB2 @ ccpm))))))))).
...
thf(almbr2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xu:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xu @ Xk) @ ccuz)))) => ((! [Xu:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xu @ Xk) @ ccz)))) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> ((cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) & (cwcel @ XP @ XX) & (cwral @ (^ [Xu:$i] : ((cwcel @ XP @ (ccv @ Xu)) => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (ccv @ Xk) @ (ccdm @ XF)) & (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xu)))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))) @ (^ [Xu:$i] : XJ)))))))))))))))).
thf(clmres_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ ccpm))) => ((Xph => (cwcel @ XM @ ccz)) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ (ccres @ XF @ (ccfv @ XM @ ccuz)) @ XP @ (ccfv @ XJ @ cclm)))))))))))))).
