...
thf(cgrpidd2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (Xph => (XB2 = (ccfv @ (XG @ Xx3) @ ccbs)))) => ((! [Xx3:$i] : (Xph => (Xc_pl = (ccfv @ (XG @ Xx3) @ ccplusg)))) => ((Xph => (cwcel @ Xc_0 @ XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((cco @ Xc_0 @ (ccv @ Xx3) @ Xc_pl) = (ccv @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ ccgrp))) => (! [Xx3:$i] : (Xph => (Xc_0 = (ccfv @ (XG @ Xx3) @ cc0g))))))))))))))).
