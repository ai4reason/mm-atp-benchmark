...
thf(cltxr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & (cwbr @ XA2 @ XB2 @ ccltrr)) | ((XA2 = ccmnf) & (XB2 = ccpnf))) | (((cwcel @ XA2 @ ccr) & (XB2 = ccpnf)) | ((XA2 = ccmnf) & (cwcel @ XB2 @ ccr))))))))).
