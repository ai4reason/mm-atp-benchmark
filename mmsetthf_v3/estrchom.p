...
thf(cestrchom_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ ccestrc)) => ((Xph => (cwcel @ XU @ XV)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XX @ XU)) => ((Xph => (cwcel @ XY @ XU)) => ((XA2 = (ccfv @ XX @ ccbs)) => ((XB2 = (ccfv @ XY @ ccbs)) => (Xph => ((cco @ XX @ XY @ XH) = (cco @ XB2 @ XA2 @ ccmap)))))))))))))))))))).
