...
thf(cswrdccat1_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ (ccword @ XB2)) & (cwcel @ XT @ (ccword @ XB2))) => ((cco @ (cco @ XS @ XT @ ccconcat) @ (ccop @ ccc0 @ (ccfv @ XS @ cchash)) @ ccsubstr) = XS)))))).
