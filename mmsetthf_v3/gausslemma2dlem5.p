...
thf(agausslemma2dlem5a_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => (! [Xx3:$i] : (Xph => ((cco @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XR @ Xx3)))) @ XP @ ccmo) = (cco @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xk) @ cc2 @ ccmul) @ ccmul))) @ XP @ ccmo)))))))))))))).
...
thf(agausslemma2dlem0f_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => (Xph => (cwbr @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccle)))))))))).
