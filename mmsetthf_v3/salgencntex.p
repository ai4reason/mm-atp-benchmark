...
thf(apwsal_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwcel @ (ccpw @ XX) @ ccsalg))))).
...
thf(csalgencntex_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xs1:$i] : ((XA2 @ Xs1) = (cco @ ccc0 @ cc2 @ ccicc))) => ((! [Xs1:$i] : (XS = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) | (cwbr @ (ccdif @ (XA2 @ Xs1) @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xs1)))))) => ((! [Xs1:$i] : ((XB2 @ Xs1) = (cco @ ccc0 @ cc1 @ ccicc))) => ((! [Xx3:$i] : (! [Xs1:$i] : ((XT @ Xx3) = (ccpw @ (XB2 @ Xs1))))) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccin @ XS @ (XT @ Xx3)))) => ((! [Xx3:$i] : (! [Xs1:$i] : ((XZ @ Xx3 @ Xs1) = (ccint @ (ccrab @ (^ [Xs1:$i] : (cwss @ (XC @ Xx3) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : ccsalg)))))) => (! [Xx3:$i] : (! [Xs1:$i] : (~ (cwcel @ (XZ @ Xx3 @ Xs1) @ ccsalg))))))))))))))))).
