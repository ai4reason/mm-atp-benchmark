...
thf(amod0mul_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn)) => (((cco @ XA2 @ XN @ ccmo) = ccc0) => (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ (ccv @ Xx3) @ XN @ ccmul))) @ (^ [Xx3:$i] : ccz))))))).
...
thf(amodn0mul_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn)) => (((cco @ XA2 @ XN @ ccmo) != ccc0) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XA2 = (cco @ (cco @ (ccv @ Xx3) @ XN @ ccmul) @ (ccv @ Xy1) @ ccaddc))) @ (^ [Xy1:$i] : (cco @ cc1 @ XN @ ccfzo)))) @ (^ [Xx3:$i] : ccz))))))).
...
thf(cm1modmmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn)) => ((cco @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmo) @ (cco @ XA2 @ XN @ ccmo) @ ccmin) = (ccif @ ((cco @ XA2 @ XN @ ccmo) = ccc0) @ (cco @ XN @ cc1 @ ccmin) @ (ccneg @ cc1))))))).
