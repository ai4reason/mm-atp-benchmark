...
thf(asubmcmn_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => (((cwcel @ XG @ cccmn) & (cwcel @ XS @ (ccfv @ XG @ ccsubmnd))) => (cwcel @ XH @ cccmn))))))).
...
thf(age0mulcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ ccc0 @ ccpnf @ ccico)))))).
...
thf(crge0srg_conj,conjecture,(cwcel @ (cco @ cccnfld @ (cco @ ccc0 @ ccpnf @ ccico) @ ccress) @ ccsrg)).
