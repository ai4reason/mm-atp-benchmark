...
thf(clefldiveq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XA2 @ ccicc))) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) = (ccfv @ (cco @ XC @ XB2 @ ccdiv) @ ccfl))))))))))).
