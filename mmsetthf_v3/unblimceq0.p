...
thf(cunblimceq0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((Xph => (cwf @ XS @ ccc @ XF)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ (ccv @ Xd) @ cclt) & (cwbr @ (ccv @ Xb) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle))) @ (^ [Xx3:$i] : XS))) @ (^ [Xd:$i] : ccrp))) @ (^ [Xb:$i] : ccrp))) => (Xph => ((cco @ XF @ XA2 @ cclimc) = cc0))))))))))).
