...
thf(axporderlem_b_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XT @ Xx3 @ Xy1 @ Xa @ Xb) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ (XA2 @ Xa @ Xb) @ (XB2 @ Xa @ Xb))) & (cwcel @ (ccv @ Xy1) @ (ccxp @ (XA2 @ Xa @ Xb) @ (XB2 @ Xa @ Xb)))) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ (XR @ Xa @ Xb)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwbr @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ (XS @ Xa @ Xb))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwbr @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (XT @ Xx3 @ Xy1 @ Xa @ Xb)) <=> ((((cwcel @ (ccv @ Xa) @ (XA2 @ Xa @ Xb)) & (cwcel @ (ccv @ Xa) @ (XA2 @ Xa @ Xb))) & ((cwcel @ (ccv @ Xb) @ (XB2 @ Xa @ Xb)) & (cwcel @ (ccv @ Xb) @ (XB2 @ Xa @ Xb)))) & ((cwbr @ (ccv @ Xa) @ (ccv @ Xa) @ (XR @ Xa @ Xb)) | (((ccv @ Xa) = (ccv @ Xa)) & (cwbr @ (ccv @ Xb) @ (ccv @ Xb) @ (XS @ Xa @ Xb))))))))))))))))).
thf(aimbi12i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph <=> Xps) => ((Xch <=> Xth) => ((Xph => Xch) <=> (Xps => Xth))))))))).
thf(axporderlem_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XT @ Xx3 @ Xy1 @ Xa @ Xb @ Xc @ Xd) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ (XA2 @ Xa @ Xb @ Xc @ Xd) @ (XB2 @ Xa @ Xb @ Xc @ Xd))) & (cwcel @ (ccv @ Xy1) @ (ccxp @ (XA2 @ Xa @ Xb @ Xc @ Xd) @ (XB2 @ Xa @ Xb @ Xc @ Xd)))) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ (XR @ Xa @ Xb @ Xc @ Xd)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwbr @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ (XS @ Xa @ Xb @ Xc @ Xd))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cwbr @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (ccop @ (ccv @ Xc) @ (ccv @ Xd)) @ (XT @ Xx3 @ Xy1 @ Xa @ Xb @ Xc @ Xd)) <=> ((((cwcel @ (ccv @ Xa) @ (XA2 @ Xa @ Xb @ Xc @ Xd)) & (cwcel @ (ccv @ Xc) @ (XA2 @ Xa @ Xb @ Xc @ Xd))) & ((cwcel @ (ccv @ Xb) @ (XB2 @ Xa @ Xb @ Xc @ Xd)) & (cwcel @ (ccv @ Xd) @ (XB2 @ Xa @ Xb @ Xc @ Xd)))) & ((cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ (XR @ Xa @ Xb @ Xc @ Xd)) | (((ccv @ Xa) = (ccv @ Xc)) & (cwbr @ (ccv @ Xb) @ (ccv @ Xd) @ (XS @ Xa @ Xb @ Xc @ Xd))))))))))))))))))).
...
thf(cpoxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ XA2 @ XB2)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ XA2 @ XB2))) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ XR) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwbr @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ XS)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwpo @ XA2 @ XR) & (cwpo @ XB2 @ XS)) => (cwpo @ (ccxp @ XA2 @ XB2) @ (XT @ Xx3 @ Xy1)))))))))))).
