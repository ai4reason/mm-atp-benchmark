...
thf(cpridlval_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XG @ Xx3 @ Xy1 @ Xi @ Xa @ Xb) = (ccfv @ XR @ cc1st))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XH @ Xx3 @ Xy1 @ Xa @ Xb) = (ccfv @ XR @ cc2nd)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XX @ Xx3 @ Xy1 @ Xa @ Xb) = (ccrn @ (XG @ Xx3 @ Xy1 @ Xi @ Xa @ Xb)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XR @ ccrngo) => ((ccfv @ XR @ ccpridl) = (ccrab @ (^ [Xi:$i] : (((ccv @ Xi) != (XX @ Xx3 @ Xy1 @ Xa @ Xb)) & (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XH @ Xx3 @ Xy1 @ Xa @ Xb)) @ (ccv @ Xi))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa))) => ((cwss @ (ccv @ Xa) @ (ccv @ Xi)) | (cwss @ (ccv @ Xb) @ (ccv @ Xi))))) @ (^ [Xb:$i] : (ccfv @ XR @ ccidl)))) @ (^ [Xa:$i] : (ccfv @ XR @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ XR @ ccidl))))))))))))))))).
