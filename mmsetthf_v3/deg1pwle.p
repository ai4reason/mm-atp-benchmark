...
thf(cdeg1pwle_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ ccn0)) => (cwbr @ (ccfv @ (cco @ XF @ XX @ Xc_ex) @ XD) @ XF @ ccle))))))))))))))).
