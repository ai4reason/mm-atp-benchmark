...
thf(adf_lkr_ax,axiom,(cclk = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xw) @ cclfn)) @ (^ [Xf1:$i] : (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccfv @ (ccfv @ (ccv @ Xw) @ ccsca) @ cc0g))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(clkrfval_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xf1:$i] : ((XD @ Xf1) = (ccfv @ XW @ ccsca))) => ((! [Xf1:$i] : ((Xc_0 @ Xf1) = (ccfv @ (XD @ Xf1) @ cc0g))) => ((XF = (ccfv @ XW @ cclfn)) => ((! [Xf1:$i] : ((XK @ Xf1) = (ccfv @ XW @ cclk))) => (! [Xf1:$i] : ((cwcel @ XW @ (XX @ Xf1)) => ((XK @ Xf1) = (ccmpt @ (^ [Xf1:$i] : XF) @ (^ [Xf1:$i] : (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (Xc_0 @ Xf1))))))))))))))))))).
