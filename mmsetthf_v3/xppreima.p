...
thf(cxppreima_conj,conjecture,(! [XF:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwfun @ XF) & (cwss @ (ccrn @ XF) @ (ccxp @ ccvv @ ccvv))) => ((ccima @ (cccnv @ XF) @ (ccxp @ XY @ XZ)) = (ccin @ (ccima @ (cccnv @ (cccom @ cc1st @ XF)) @ XY) @ (ccima @ (cccnv @ (cccom @ cc2nd @ XF)) @ XZ)))))))).
