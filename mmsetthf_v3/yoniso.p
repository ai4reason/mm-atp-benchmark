...
thf(ayonffth_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XC @ ccyon)) => ((XO = (ccfv @ XC @ ccoppc)) => ((XS = (ccfv @ XU @ ccsetc)) => ((XQ = (cco @ XO @ XS @ ccfuc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => (Xph => (cwcel @ XY @ (ccin @ (cco @ XC @ XQ @ ccful) @ (cco @ XC @ XQ @ ccfth)))))))))))))))))))).
thf(a_3bitr3g_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps <=> Xch)) => ((Xps <=> Xth) => ((Xch <=> Xta) => (Xph => (Xth <=> Xta))))))))))).
thf(affthres2c_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccfv @ XC @ ccbs)) => ((XE = (cco @ XD @ XS @ ccress)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XA2 @ XS @ XF)) => (Xph => ((cwbr @ XF @ XG @ (ccin @ (cco @ XC @ XD @ ccful) @ (cco @ XC @ XD @ ccfth))) <=> (cwbr @ XF @ XG @ (ccin @ (cco @ XC @ XE @ ccful) @ (cco @ XC @ XE @ ccfth)))))))))))))))))))).
...
thf(ayon11_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (ccfv @ XC @ ccyon)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XZ @ XB2)) => (Xph => ((ccfv @ XZ @ (ccfv @ (ccfv @ XX @ (ccfv @ XY @ cc1st)) @ cc1st)) = (cco @ XZ @ XX @ XH))))))))))))))))).
