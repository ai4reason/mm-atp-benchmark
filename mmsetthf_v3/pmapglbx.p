...
thf(aralcom4_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (! [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (! [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(aceqsalg_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3))) <=> (Xps @ Xx3))))))))))).
...
thf(cpmapglbx_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xy1:$i] : (! [Xi:$i] : ((XG @ Xy1 @ Xi) = (ccfv @ XK @ ccglb)))) => ((! [Xy1:$i] : (! [Xi:$i] : ((XM @ Xy1 @ Xi) = (ccfv @ XK @ ccpmap)))) => (! [Xy1:$i] : (! [Xi:$i] : (((cwcel @ XK @ cchlt) & (cwral @ (^ [Xi:$i] : (cwcel @ (XS @ Xi) @ XB2)) @ (^ [Xi:$i] : XI)) & (XI != cc0)) => ((ccfv @ (ccfv @ (^ [Xy1:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xy1) = (XS @ Xi))) @ (^ [Xi:$i] : XI))) @ (XG @ Xy1 @ Xi)) @ (XM @ Xy1 @ Xi)) = (cciin @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (XS @ Xi) @ (XM @ Xy1 @ Xi)))))))))))))))))).
