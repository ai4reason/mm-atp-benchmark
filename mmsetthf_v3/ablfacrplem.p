...
thf(aodcau_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xg1:$i] : ((XO @ Xg1) = (ccfv @ XG @ ccod))) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn) & (cwcel @ XP @ ccprime)) & (cwbr @ XP @ (ccfv @ XX @ cchash) @ ccdvds)) => (cwrex @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ (XO @ Xg1)) = XP)) @ (^ [Xg1:$i] : XX)))))))))).
...
thf(cablfacrplem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XM @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => ((cco @ XM @ XN @ ccgcd) = cc1)) => ((Xph => ((ccfv @ XB2 @ cchash) = (cco @ XM @ XN @ ccmul))) => (! [Xx3:$i] : (Xph => ((cco @ (ccfv @ (XK @ Xx3) @ cchash) @ XN @ ccgcd) = cc1))))))))))))))))))))).
