...
thf(cltrneq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : (XA2 = (ccfv @ (XK @ Xp) @ ccatm))) => ((! [Xp:$i] : ((XH @ Xp) = (ccfv @ (XK @ Xp) @ cclh))) => ((! [Xp:$i] : ((XT @ Xp) = (ccfv @ (XW @ Xp) @ (ccfv @ (XK @ Xp) @ ccltrn)))) => (! [Xp:$i] : ((((cwcel @ (XK @ Xp) @ cchlt) & (cwcel @ (XW @ Xp) @ (XH @ Xp))) & (cwcel @ XF @ (XT @ Xp)) & (cwcel @ XG @ (XT @ Xp))) => ((cwral @ (^ [Xp:$i] : ((ccfv @ (ccv @ Xp) @ XF) = (ccfv @ (ccv @ Xp) @ XG))) @ (^ [Xp:$i] : XA2)) <=> (XF = XG))))))))))))))).
