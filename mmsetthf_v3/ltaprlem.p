...
thf(altaddpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccpp) @ ccltp))))).
...
thf(cltaprlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnp) => ((cwbr @ XA2 @ XB2 @ ccltp) => (cwbr @ (cco @ XC @ XA2 @ ccpp) @ (cco @ XC @ XB2 @ ccpp) @ ccltp))))))).
