...
thf(amendmulrfval_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (ccfv @ XM @ ccmend)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XB2 = (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccbs)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ (XA2 @ Xx3 @ Xy1) @ ccmulr) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccom @ (ccv @ Xx3) @ (ccv @ Xy1)))))))))))))).
