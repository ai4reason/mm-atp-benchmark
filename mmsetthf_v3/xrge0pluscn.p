...
thf(axrge0iifhmeo_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((XF = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))) => (! [Xx3:$i] : (cwcel @ XF @ (cco @ ccii @ (XJ @ Xx3) @ cchmeo)))))))).
...
thf(axrge0iifcnv_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwf1o @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xx3 @ Xy1)) & ((cccnv @ (XF @ Xx3 @ Xy1)) = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ ccpnf @ ccicc)) @ (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = ccpnf) @ ccc0 @ (ccfv @ (ccneg @ (ccv @ Xy1)) @ cce))))))))))).
thf(cwf1_tp,type,(cwf1 : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(af1of_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ XA2 @ XB2 @ XF) => (cwf @ XA2 @ XB2 @ XF)))))).
thf(axrge0iifhom_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))) => (((cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ XY @ (cco @ ccc0 @ cc1 @ ccicc))) => ((ccfv @ (cco @ XX @ XY @ ccmul) @ XF) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccxad)))))))))).
...
thf(aiistmd_thm,axiom,(! [XI:($i > $o)] : ((XI = (cco @ (ccfv @ cccnfld @ ccmgp) @ (cco @ ccc0 @ cc1 @ ccicc) @ ccress)) => (cwcel @ XI @ cctmd)))).
...
thf(amgpress_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XM = (ccfv @ XR @ ccmgp)) => (((cwcel @ XR @ XV) & (cwcel @ XA2 @ XW)) => ((cco @ XM @ XA2 @ ccress) = (ccfv @ XS @ ccmgp)))))))))))).
thf(adfii4_thm,axiom,(! [XI:($i > $o)] : ((XI = (cco @ cccnfld @ (cco @ ccc0 @ cc1 @ ccicc) @ ccress)) => (ccii = (ccfv @ XI @ cctopn))))).
