...
thf(azprod_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XZ @ Xy1 @ Xk) = (ccfv @ (XM @ Xn) @ ccuz))))) => ((! [Xn:$i] : (Xph => (cwcel @ (XM @ Xn) @ ccz))) => ((! [Xy1:$i] : (! [Xk:$i] : (Xph => (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : (((ccv @ Xy1) != ccc0) & (cwbr @ (ccseq @ ccmul @ (XF @ Xy1 @ Xn) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (XZ @ Xy1 @ Xk)))))) => ((! [Xy1:$i] : (! [Xk:$i] : (Xph => (cwss @ XA2 @ (XZ @ Xy1 @ Xk))))) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (XZ @ Xy1 @ Xk))) => ((ccfv @ (ccv @ Xk) @ (XF @ Xy1 @ Xn)) = (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1)))))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (! [Xy1:$i] : (! [Xn:$i] : (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccfv @ (ccseq @ ccmul @ (XF @ Xy1 @ Xn) @ (XM @ Xn)) @ ccli)))))))))))))))))).
...
thf(cprodss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ ccc))) => ((Xph => (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : (((ccv @ Xy1) != ccc0) & (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : (ccfv @ XM @ ccuz)) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XB2) @ (XC @ Xk) @ cc1))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (ccfv @ XM @ ccuz)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccdif @ XB2 @ XA2))) => ((XC @ Xk) = cc1))) => ((Xph => (cwss @ XB2 @ (ccfv @ XM @ ccuz))) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))).
