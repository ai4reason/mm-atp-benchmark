...
thf(creglogltb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp)) & ((cwcel @ XC @ ccrp) & (cwbr @ cc1 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ cclt))))))).
