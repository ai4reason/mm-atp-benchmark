...
thf(cmrsubccat_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((XR = (ccfv @ XT @ ccmrex)) => (((cwcel @ XF @ (ccrn @ XS)) & (cwcel @ XX @ XR) & (cwcel @ XY @ XR)) => ((ccfv @ (cco @ XX @ XY @ ccconcat) @ XF) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccconcat)))))))))))).
