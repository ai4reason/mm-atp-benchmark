...
thf(cnosepdmlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur) & (cwbr @ XA2 @ XB2 @ ccslt)) => (cwcel @ (ccint @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) != (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccon0))) @ (ccun @ (ccdm @ XA2) @ (ccdm @ XB2))))))).
