...
thf(cfourierdlem52_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XT @ ccfn)) => ((XN = (cco @ (ccfv @ XT @ cchash) @ cc1 @ ccmin)) => ((XS = (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XT @ cclt @ cclt @ (ccv @ Xf1))))) => ((! [Xf1:$i] : (Xph => (cwcel @ (XA2 @ Xf1) @ ccr))) => ((! [Xf1:$i] : (Xph => (cwcel @ (XB2 @ Xf1) @ ccr))) => ((! [Xf1:$i] : (Xph => (cwss @ XT @ (cco @ (XA2 @ Xf1) @ (XB2 @ Xf1) @ ccicc)))) => ((! [Xf1:$i] : (Xph => (cwcel @ (XA2 @ Xf1) @ XT))) => ((! [Xf1:$i] : (Xph => (cwcel @ (XB2 @ Xf1) @ XT))) => (! [Xf1:$i] : (Xph => (((cwf @ (cco @ ccc0 @ XN @ ccfz) @ (cco @ (XA2 @ Xf1) @ (XB2 @ Xf1) @ ccicc) @ XS) & ((ccfv @ ccc0 @ XS) = (XA2 @ Xf1))) & ((ccfv @ XN @ XS) = (XB2 @ Xf1)))))))))))))))))))).
