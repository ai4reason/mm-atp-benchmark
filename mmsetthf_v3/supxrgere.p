...
thf(csupxrgere_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ ccr))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ ccrp)) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))))))).
