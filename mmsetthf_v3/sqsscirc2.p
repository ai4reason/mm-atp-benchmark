...
thf(asqsscirc1_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((((cwcel @ XX @ ccr) & (cwbr @ ccc0 @ XX @ ccle)) & ((cwcel @ XY @ ccr) & (cwbr @ ccc0 @ XY @ ccle))) & (cwcel @ XD @ ccrp)) => (((cwbr @ XX @ (cco @ XD @ cc2 @ ccdiv) @ cclt) & (cwbr @ XY @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (ccfv @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ XD @ cclt))))))).
...
thf(csqsscirc2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & (cwcel @ XD @ ccrp)) => (((cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccre) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt) & (cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccim) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ XD @ cclt))))))).
