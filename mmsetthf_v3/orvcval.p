...
thf(adf_orvc_ax,axiom,(! [XR:($i > $o)] : ((ccorvc @ XR) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xa:$i] : (^ [Xx3:$i] : (cwfun @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : (^ [Xa:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xa:$i] : (ccima @ (cccnv @ (ccv @ Xx3)) @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xa) @ XR))))))))).
...
thf(corvcval_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwfun @ XX))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XX @ (XV @ Xy1)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ (XW @ Xy1)))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cco @ XX @ XA2 @ (ccorvc @ XR)) = (ccima @ (cccnv @ XX) @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XA2 @ XR)))))))))))))))).
