...
thf(ap1modz1_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwbr @ XM @ XA2 @ ccdvds) & (cwbr @ cc1 @ XM @ cclt)) => ((cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XM @ ccmo) = cc1))))).
...
thf(algslem1_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) & (~ (cwbr @ XP @ XA2 @ ccdvds))) => (cwcel @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ XP @ ccmo) @ (ccpr @ ccc0 @ cc2)))))).
