...
thf(aatpsubN_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((cwcel @ XK @ XV) => (cwcel @ XA2 @ XS))))))))).
...
thf(cpclclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ XV) & (cwss @ XX @ XA2)) => (cwcel @ (ccfv @ XX @ XU) @ XS)))))))))))).
