...
thf(adpjeq_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xh:$i] : ((Xph @ Xh) => (cwbr @ XG @ XS @ (ccdm @ ccdprd)))) => ((! [Xh:$i] : ((Xph @ Xh) => ((ccdm @ XS) = XI))) => ((! [Xi:$i] : ((XP @ Xi) = (cco @ XG @ XS @ ccdpj))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh) => (cwcel @ (XA2 @ Xi) @ (cco @ XG @ XS @ ccdprd))))) => ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : ((XW @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS)))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xi))) @ (XW @ Xh @ Xi))))) => (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh) => (((XA2 @ Xi) = (cco @ XG @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xi))) @ ccgsu)) <=> (cwral @ (^ [Xx3:$i] : ((ccfv @ (XA2 @ Xi) @ (ccfv @ (ccv @ Xx3) @ (XP @ Xi))) = (XC @ Xx3 @ Xi))) @ (^ [Xx3:$i] : XI))))))))))))))))))))))).
