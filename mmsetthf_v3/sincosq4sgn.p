...
thf(asincosq3sgn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccpi @ (cco @ cc3 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccioo)) => ((cwbr @ (ccfv @ XA2 @ ccsin) @ ccc0 @ cclt) & (cwbr @ (ccfv @ XA2 @ cccos) @ ccc0 @ cclt))))).
