...
thf(afiln0_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => (XF != cc0))))).
...
thf(asnfbas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwss @ XA2 @ XB2) & (XA2 != cc0) & (cwcel @ XB2 @ XV)) => (cwcel @ (ccsn @ XA2) @ (ccfv @ XB2 @ ccfbas))))))).
thf(afbunfip_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XG @ (ccfv @ XY @ ccfbas))) => ((~ (cwcel @ cc0 @ (ccfv @ (ccun @ XF @ XG) @ ccfi))) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) != cc0)) @ (^ [Xy1:$i] : XG))) @ (^ [Xx3:$i] : XF))))))))).
thf(cwnel_tp,type,(cwnel : (($i > $o) > (($i > $o) > $o)))).
thf(afsubbas_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((cwcel @ (ccfv @ XA2 @ ccfi) @ (ccfv @ XX @ ccfbas)) <=> ((cwss @ XA2 @ (ccpw @ XX)) & (XA2 != cc0) & (~ (cwcel @ cc0 @ (ccfv @ XA2 @ ccfi)))))))))).
...
thf(assfii_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwss @ XA2 @ (ccfv @ XA2 @ ccfi)))))).
...
thf(cufileu_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((cwcel @ XF @ (ccfv @ XX @ ccufil)) <=> (cwreu @ (^ [Xf1:$i] : (cwss @ XF @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil)))))))).
