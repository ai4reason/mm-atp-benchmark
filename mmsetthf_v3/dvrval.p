...
thf(cdvrval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => (((cwcel @ XX @ XB2) & (cwcel @ XY @ XU)) => ((cco @ XX @ XY @ Xc_dv) = (cco @ XX @ (ccfv @ XY @ XI) @ Xc_x))))))))))))))))).
