...
thf(ann0sumltlt_thm,axiom,(! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((cwcel @ (ccv @ Xa) @ ccn0) & (cwcel @ (ccv @ Xb) @ ccn0) & (cwcel @ (ccv @ Xc) @ ccn0)) => ((cwbr @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccaddc) @ (ccv @ Xc) @ cclt) => (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ cclt))))))).
thf(cply1mulgsumlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (! [Xs1:$i] : ((XP @ Xn @ Xs1) = (ccfv @ XR @ ccpl1)))) => ((! [Xn:$i] : (! [Xs1:$i] : (XB2 = (ccfv @ (XP @ Xn @ Xs1) @ ccbs)))) => ((XA2 = (ccfv @ XK @ ccco1)) => ((XC = (ccfv @ XL @ ccco1)) => ((! [Xn:$i] : (! [Xs1:$i] : ((XX @ Xn @ Xs1) = (ccfv @ XR @ ccv1)))) => ((! [Xn:$i] : (! [Xs1:$i] : ((Xc_xp @ Xn @ Xs1) = (ccfv @ (XP @ Xn @ Xs1) @ ccmulr)))) => ((! [Xn:$i] : (! [Xs1:$i] : ((Xc_x @ Xn @ Xs1) = (ccfv @ (XP @ Xn @ Xs1) @ ccvsca)))) => ((! [Xn:$i] : (! [Xs1:$i] : ((Xc_as @ Xn @ Xs1) = (ccfv @ XR @ ccmulr)))) => ((! [Xn:$i] : (! [Xs1:$i] : ((XM @ Xn @ Xs1) = (ccfv @ (XP @ Xn @ Xs1) @ ccmgp)))) => ((! [Xn:$i] : (! [Xs1:$i] : ((Xc_ex @ Xn @ Xs1) = (ccfv @ (XM @ Xn @ Xs1) @ ccmg)))) => (((cwcel @ XR @ ccrg) & (cwcel @ XK @ XB2) & (cwcel @ XL @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xn) @ cclt) => (((ccfv @ (ccv @ Xn) @ XA2) = (ccfv @ XR @ cc0g)) & ((ccfv @ (ccv @ Xn) @ XC) = (ccfv @ XR @ cc0g))))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))))))))))))))).
