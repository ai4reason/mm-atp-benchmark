...
thf(ccvr2N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XP @ XA2)) => ((cwbr @ XX @ (cco @ XX @ XP @ Xc_or) @ Xc_lt) <=> (cwbr @ XX @ (cco @ XX @ XP @ Xc_or) @ XC))))))))))))))))).
