...
thf(csumdmdlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (((cwcel @ XC @ cchil) & (~ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccph)))) => ((ccin @ (cco @ XB2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ ccph) @ XA2) = (ccin @ XB2 @ XA2))))))))).
