...
thf(advdsprmpweq_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn) & (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))))))).
...
thf(cdvdsprmpweqle_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn) & (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xn) @ XN @ ccle) & (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp)))) @ (^ [Xn:$i] : ccn0)))))))).
