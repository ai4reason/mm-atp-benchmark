...
thf(cgeolim2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz))) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ XA2 @ (ccv @ Xk) @ ccexp)))) => (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccli))))))))))).
