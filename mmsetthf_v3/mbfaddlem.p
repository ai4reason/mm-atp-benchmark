...
thf(aismbf3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwf @ (XA2 @ Xx3) @ ccr @ XF))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccdm @ ccvol)))) => (Xph => (cwcel @ XF @ ccmbf)))))))).
...
thf(cmbfaddlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwf @ XA2 @ ccr @ XG)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccmbf))))))))))).
