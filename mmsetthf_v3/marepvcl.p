...
thf(cmarepvcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => (((cwcel @ XR @ ccrg) & ((cwcel @ XM @ XB2) & (cwcel @ XC @ XV) & (cwcel @ XK @ XN))) => (cwcel @ (ccfv @ XK @ (cco @ XM @ XC @ (cco @ XN @ XR @ ccmatrepV))) @ XB2)))))))))))))).
