...
thf(austincl_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU) & (cwcel @ XW @ XU)) => (cwcel @ (ccin @ XV @ XW) @ XU))))))).
...
thf(austinvel_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwcel @ (cccnv @ XV) @ XU)))))).
