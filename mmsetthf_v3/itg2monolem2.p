...
thf(citg2monolem2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccmbf))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ (ccfv @ (ccv @ Xn) @ XF)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (ccofr @ ccle)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xy1:$i] : ccr)))) => ((XS = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ ccitg2)))) @ ccxr @ cclt)) => ((Xph => (cwcel @ XP @ (ccdm @ ccitg1))) => ((Xph => (cwbr @ XP @ XG @ (ccofr @ ccle))) => ((Xph => (~ (cwbr @ (ccfv @ XP @ ccitg1) @ XS @ ccle))) => (Xph => (cwcel @ XS @ ccr))))))))))))))))).
