...
thf(aphtpycn_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (Xph => (cwss @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)) @ (cco @ (cco @ ccii @ ccii @ cctx) @ XJ @ cccn)))))))))).
...
thf(apcovalg_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((Xph & (cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccicc))) => ((ccfv @ XX @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) = (ccif @ (cwbr @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (ccfv @ (cco @ cc2 @ XX @ ccmul) @ XF) @ (ccfv @ (cco @ (cco @ cc2 @ XX @ ccmul) @ cc1 @ ccmin) @ XG)))))))))))).
...
thf(cpcohtpylem_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => ((ccfv @ cc1 @ XF) = (ccfv @ ccc0 @ XG))) => ((Xph => (cwbr @ XF @ XH @ (ccfv @ XJ @ ccphtpc))) => ((Xph => (cwbr @ XG @ XK @ (ccfv @ XJ @ ccphtpc))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XP @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (cco @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ (ccv @ Xy1) @ XM) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmin) @ (ccv @ Xy1) @ XN)))))))) => ((Xph => (cwcel @ XM @ (cco @ XF @ XH @ (ccfv @ XJ @ ccphtpy)))) => ((Xph => (cwcel @ XN @ (cco @ XG @ XK @ (ccfv @ XJ @ ccphtpy)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XP @ Xx3 @ Xy1) @ (cco @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco)) @ (cco @ XH @ XK @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpy)))))))))))))))))))))).
