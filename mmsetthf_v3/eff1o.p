...
thf(aefif1olem1_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccaddc) @ ccioc)) => (((cwcel @ XA2 @ ccr) & ((cwcel @ (ccv @ Xx3) @ XD) & (cwcel @ (ccv @ Xy1) @ XD))) => (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ (cco @ cc2 @ ccpi @ ccmul) @ cclt)))))))).
...
thf(aefif1olem2_thm,axiom,(! [Xz:$i] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccaddc) @ ccioc)) => (((cwcel @ XA2 @ ccr) & (cwcel @ (ccv @ Xz) @ ccr)) => (cwrex @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ ccmin) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ ccz)) @ (^ [Xy1:$i] : XD)))))))).
