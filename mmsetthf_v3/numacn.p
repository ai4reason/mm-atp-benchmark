...
thf(aac5num_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ (ccuni @ XA2) @ (ccdm @ cccrd)) & (~ (cwcel @ cc0 @ XA2))) => (? [Xf1:$i] : ((cwf @ XA2 @ (ccuni @ XA2) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cnumacn_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XX @ (ccdm @ cccrd)) => (cwcel @ XX @ (cwacn @ XA2)))))))).
