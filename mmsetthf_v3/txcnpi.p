...
thf(ctxcnpi_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XJ @ (ccfv @ (XX @ Xv @ Xu) @ cctopon))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XK @ (ccfv @ (XY @ Xv @ Xu) @ cctopon))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XF @ (ccfv @ (ccop @ XA2 @ XB2) @ (cco @ (cco @ XJ @ XK @ cctx) @ (XL @ Xv @ Xu) @ cccnp)))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XU @ (XL @ Xv @ Xu))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XA2 @ (XX @ Xv @ Xu))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XB2 @ (XY @ Xv @ Xu))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ (cco @ XA2 @ XB2 @ XF) @ XU)))) => (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : ((cwcel @ XA2 @ (ccv @ Xu)) & (cwcel @ XB2 @ (ccv @ Xv)) & (cwss @ (ccxp @ (ccv @ Xu) @ (ccv @ Xv)) @ (ccima @ (cccnv @ XF) @ XU)))) @ (^ [Xv:$i] : XK))) @ (^ [Xu:$i] : XJ))))))))))))))))))))))).
