...
thf(cdifmapsn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XC @ XZ)) => (Xph => ((ccdif @ (cco @ XA2 @ (ccsn @ XC) @ ccmap) @ (cco @ XB2 @ (ccsn @ XC) @ ccmap)) = (cco @ (ccdif @ XA2 @ XB2) @ (ccsn @ XC) @ ccmap)))))))))))))).
