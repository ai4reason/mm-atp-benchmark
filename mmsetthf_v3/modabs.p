...
thf(cmodabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp) & (cwcel @ XC @ ccrp)) & (cwbr @ XB2 @ XC @ ccle)) => ((cco @ (cco @ XA2 @ XB2 @ ccmo) @ XC @ ccmo) = (cco @ XA2 @ XB2 @ ccmo))))))).
