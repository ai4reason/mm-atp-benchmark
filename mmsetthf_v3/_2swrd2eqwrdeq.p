...
thf(aswrd2lsw_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ cclt)) => ((cco @ XW @ (ccop @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ (ccfv @ XW @ cchash)) @ ccsubstr) = (ccs2 @ (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW) @ (ccfv @ XW @ cclsw))))))).
