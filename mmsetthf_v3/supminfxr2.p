...
thf(axrssre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (~ (cwcel @ ccpnf @ XA2))) => ((Xph => (~ (cwcel @ ccmnf @ XA2))) => (Xph => (cwss @ XA2 @ ccr)))))))).
...
thf(csupminfxr2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccxr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccsup @ XA2 @ ccxr @ cclt) = (ccxne @ (ccinf @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccxne @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : ccxr)) @ ccxr @ cclt))))))))).
