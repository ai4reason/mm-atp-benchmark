...
thf(clssat_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS) & (cwcel @ XV @ XS)) & (cwpss @ XU @ XV)) => (cwrex @ (^ [Xp:$i] : ((cwss @ (ccv @ Xp) @ XV) & (~ (cwss @ (ccv @ Xp) @ XU)))) @ (^ [Xp:$i] : XA2))))))))))).
