...
thf(aacndom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => ((cwcel @ XX @ (cwacn @ XB2)) => (cwcel @ XX @ (cwacn @ XA2)))))))).
...
thf(adfac8a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XB2 @ Xy1)) => ((? [Xh:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xy1) != cc0) => (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xh)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ XA2)))) => (cwcel @ XA2 @ (ccdm @ cccrd)))))))).
