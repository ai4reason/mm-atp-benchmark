...
thf(cbnj1514_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((XB2 @ Xx3 @ Xf1 @ Xd) = (^ [Xd:$i] : ((cwss @ (ccv @ Xd) @ (XA2 @ Xf1 @ Xd)) & (cwral @ (^ [Xx3:$i] : (cwss @ (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xx3 @ Xf1 @ Xd) @ (ccv @ Xx3)) @ (ccv @ Xd))) @ (^ [Xx3:$i] : (ccv @ Xd))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((XY @ Xx3 @ Xf1) = (ccop @ (ccv @ Xx3) @ (ccres @ (ccv @ Xf1) @ (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xx3 @ Xf1 @ Xd) @ (ccv @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((XC @ Xx3 @ Xf1 @ Xd) = (^ [Xf1:$i] : (cwrex @ (^ [Xd:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xd)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) = (ccfv @ (XY @ Xx3 @ Xf1) @ (XG @ Xx3 @ Xf1)))) @ (^ [Xx3:$i] : (ccv @ Xd))))) @ (^ [Xd:$i] : (XB2 @ Xx3 @ Xf1 @ Xd)))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((cwcel @ (ccv @ Xf1) @ (XC @ Xx3 @ Xf1 @ Xd)) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) = (ccfv @ (XY @ Xx3 @ Xf1) @ (XG @ Xx3 @ Xf1)))) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1)))))))))))))))))).
