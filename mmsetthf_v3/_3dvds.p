...
thf(advdsnegb_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XM @ XN @ ccdvds) <=> (cwbr @ XM @ (ccneg @ XN) @ ccdvds)))))).
thf(anegdvdsb_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XM @ XN @ ccdvds) <=> (cwbr @ (ccneg @ XM) @ XN @ ccdvds)))))).
...
thf(c_3dvds_conj,conjecture,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwf @ (cco @ ccc0 @ XN @ ccfz) @ ccz @ XF)) => ((cwbr @ cc3 @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccv @ Xk) @ ccexp) @ ccmul))) @ ccdvds) <=> (cwbr @ cc3 @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ ccdvds)))))).
