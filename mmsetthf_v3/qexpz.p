...
thf(apcz_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => ((cwcel @ XA2 @ ccz) <=> (cwral @ (^ [Xp:$i] : (cwbr @ ccc0 @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ ccle)) @ (^ [Xp:$i] : ccprime)))))).
thf(a_0zd_thm,axiom,(! [Xph:$o] : (Xph => (cwcel @ ccc0 @ ccz)))).
thf(cqexpz_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccq) & (cwcel @ XN @ ccn) & (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccz)) => (cwcel @ XA2 @ ccz))))).
