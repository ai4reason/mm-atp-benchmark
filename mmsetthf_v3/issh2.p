...
thf(cissh2_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) <=> (((cwss @ XH @ cchil) & (cwcel @ cc0v @ XH)) & ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : XH)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsm) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : ccc))))))).
