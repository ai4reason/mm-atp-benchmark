...
thf(crmulccn_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((Xph => (cwcel @ XC @ ccr)) => (! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccmul))) @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))).
