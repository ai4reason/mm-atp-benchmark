...
thf(ccxpeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn) & (cwcel @ XB2 @ ccc)) => (((cco @ XA2 @ XN @ ccexp) = XB2) <=> (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccdiv) @ cccxp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ (ccv @ Xn) @ ccexp) @ ccmul))) @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))))))).
