...
thf(cvrgpfval_conj,conjecture,(! [Xc_sm:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((Xc_sm = (ccfv @ XI @ ccefg)) => ((! [Xj:$i] : ((XU @ Xj) = (ccfv @ XI @ ccvrgp))) => (! [Xj:$i] : ((cwcel @ XI @ XV) => ((XU @ Xj) = (ccmpt @ (^ [Xj:$i] : XI) @ (^ [Xj:$i] : (ccec @ (ccs1 @ (ccop @ (ccv @ Xj) @ cc0)) @ Xc_sm))))))))))))).
