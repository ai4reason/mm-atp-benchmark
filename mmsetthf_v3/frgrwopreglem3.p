...
thf(cfrgrwopreglem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XA2 = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XD) = XK)) @ (^ [Xx3:$i] : XV))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccdif @ XV @ XA2))) => (! [Xx3:$i] : (((cwcel @ XX @ XA2) & (cwcel @ XY @ (XB2 @ Xx3))) => ((ccfv @ XX @ XD) != (ccfv @ XY @ XD))))))))))))))))).
