...
thf(ar19_29imd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => (Xch @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : ((Xps @ Xx3) & (Xch @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))).
...
thf(cneik0pk1imk0_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xph @ Xt) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xt @ Xs1)))))) => ((! [Xx3:$i] : (! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XN @ Xx3) @ (cco @ (ccpw @ (ccpw @ (XB2 @ Xx3))) @ (XB2 @ Xx3) @ ccmap))))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XN @ Xx3)) != cc0)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (((cwcel @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xx3) @ (XN @ Xx3))) & (cwss @ (ccv @ Xs1) @ (ccv @ Xt))) => (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xx3) @ (XN @ Xx3))))) @ (^ [Xt:$i] : (ccpw @ (XB2 @ Xx3))))) @ (^ [Xs1:$i] : (ccpw @ (XB2 @ Xx3))))) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xt:$i] : ((Xph @ Xt) => (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (XN @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
