...
thf(aswrds2m_thm,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ cc2 @ (ccfv @ XW @ cchash) @ ccfz))) => ((cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) = (ccs2 @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ XW)))))))).
...
thf(aclwwlknonmpt2_thm,axiom,(! [XG:($i > $o)] : ((ccfv @ XG @ ccclwwlknon) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ XG @ ccvtx))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn))))))))).
...
thf(as2elclwwlknon2_thm,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XG @ ccclwwlknon)) => ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XX @ XV) & (cwcel @ XY @ XV) & (cwcel @ (ccpr @ XX @ XY) @ XE)) => (cwcel @ (ccs2 @ XX @ XY) @ (cco @ XX @ cc2 @ XC))))))))))))).
thf(c_2clwwlk2clwwlklem_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & (cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) & ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) = (ccfv @ ccc0 @ XW))) => (cwcel @ (cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) @ (cco @ XX @ cc2 @ (ccfv @ XG @ ccclwwlknon))))))))).
