...
thf(cffvresb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((cwf @ XA2 @ XB2 @ (ccres @ XF @ XA2)) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccdm @ XF)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2))) @ (^ [Xx3:$i] : XA2)))))))).
