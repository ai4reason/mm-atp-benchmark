...
thf(aesum_thm,axiom,(cceu = (ccsu @ ccn0 @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv))))).
...
thf(aefcllem_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccseq @ ccaddc @ (XF @ Xn) @ ccc0) @ (ccdm @ ccli)))))))).
...
thf(aeftlub_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => ((! [Xk:$i] : (! [Xn:$i] : ((XH @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XM @ ccexp) @ (ccfv @ XM @ ccfa) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ XM @ cc1 @ ccaddc) @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul)))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XM @ ccn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XA2 @ ccc))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ ccle))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ (ccsu @ (ccfv @ XM @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccabs) @ (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XM @ ccexp) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ (cco @ (ccfv @ XM @ ccfa) @ XM @ ccmul) @ ccdiv) @ ccmul) @ ccle)))))))))))))))).
...
thf(ceirrlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (XP @ Xn) @ ccz))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XQ @ ccn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cceu = (cco @ (XP @ Xn) @ XQ @ ccdiv)))) => (! [Xn:$i] : (~ (Xph @ Xn)))))))))))).
