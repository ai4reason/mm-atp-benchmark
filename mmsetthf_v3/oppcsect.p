...
thf(aoppcid_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XB2 = (ccfv @ XC @ cccid)) => ((cwcel @ XC @ cccat) => ((ccfv @ XO @ cccid) = XB2)))))))).
...
thf(coppcsect_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XO = (ccfv @ XC @ ccoppc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XS = (ccfv @ XC @ ccsect)) => ((XT = (ccfv @ XO @ ccsect)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XX @ XY @ XT)) <=> (cwbr @ XG @ XF @ (cco @ XX @ XY @ XS)))))))))))))))))))))).
