...
thf(aeldioph2lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn0) & (~ (cwcel @ XS @ ccfn))) & ((cwss @ (cco @ cc1 @ XN @ ccfz) @ XS) & (cwcel @ XA2 @ (ccfv @ XN @ ccuz)))) => (? [Xc:$i] : ((cwf1 @ (cco @ cc1 @ XA2 @ ccfz) @ XS @ (ccv @ Xc)) & ((ccres @ (ccv @ Xc) @ (cco @ cc1 @ XN @ ccfz)) = (ccres @ ccid @ (cco @ cc1 @ XN @ ccfz)))))))))).
...
thf(aeldioph2_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & ((cwcel @ XS @ ccvv) & (cwss @ (cco @ cc1 @ XN @ ccfz) @ XS)) & (cwcel @ XP @ (ccfv @ XS @ ccmzp))) => (cwcel @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ XP) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ XS @ ccmap)))) @ (ccfv @ XN @ ccdioph))))))).
thf(celdioph2b_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [Xu:$i] : (! [Xt:$i] : ((((cwcel @ XN @ ccn0) & (cwcel @ XS @ ccvv)) & ((~ (cwcel @ XS @ ccfn)) & (cwss @ (cco @ cc1 @ XN @ ccfz) @ XS))) => ((cwcel @ (XA2 @ Xu @ Xt) @ (ccfv @ XN @ ccdioph)) <=> (cwrex @ (^ [Xp:$i] : ((XA2 @ Xu @ Xt) = (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ (ccv @ Xp)) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ XS @ ccmap)))))) @ (^ [Xp:$i] : (ccfv @ XS @ ccmzp))))))))))).
