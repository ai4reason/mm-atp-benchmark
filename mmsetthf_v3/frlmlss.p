...
thf(afrlmval_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => (((cwcel @ XR @ XV) & (cwcel @ XI @ XW)) => (XF = (cco @ XR @ (ccxp @ XI @ (ccsn @ (ccfv @ XR @ ccrglmod))) @ ccdsmm)))))))))).
...
thf(cfrlmlss_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((XU = (ccfv @ (cco @ (ccfv @ XR @ ccrglmod) @ XI @ ccpws) @ cclss)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XW)) => (cwcel @ XB2 @ XU)))))))))))).
