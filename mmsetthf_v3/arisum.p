...
thf(abcxmas_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => ((cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XM @ ccaddc) @ XM @ ccbc) = (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ XN @ (ccv @ Xj) @ ccaddc) @ (ccv @ Xj) @ ccbc)))))))).
...
thf(carisum_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xk:$i] : (ccv @ Xk))) = (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ XN @ ccaddc) @ cc2 @ ccdiv))))).
