...
thf(ambfres2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwcel @ (ccres @ XF @ XB2) @ ccmbf)) => ((Xph => (cwcel @ (ccres @ XF @ XC) @ ccmbf)) => ((Xph => ((ccun @ XB2 @ XC) = XA2)) => (Xph => (cwcel @ XF @ ccmbf)))))))))))).
...
thf(cmbfres2cn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ (ccres @ XF @ XB2) @ ccmbf)) => ((Xph => (cwcel @ (ccres @ XF @ XC) @ ccmbf)) => ((Xph => ((ccun @ XB2 @ XC) = XA2)) => (Xph => (cwcel @ XF @ ccmbf)))))))))))).
