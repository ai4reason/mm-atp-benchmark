...
thf(advh4dimat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xs1:$i] : ((XH @ Xs1) = (ccfv @ XK @ cclh))) => ((! [Xs1:$i] : ((XU @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xs1:$i] : (Xc_po = (ccfv @ (XU @ Xs1) @ cclsm))) => ((! [Xs1:$i] : (XA2 = (ccfv @ (XU @ Xs1) @ cclsa))) => ((! [Xs1:$i] : (Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xs1))))) => ((Xph => (cwcel @ XP @ XA2)) => ((Xph => (cwcel @ XQ @ XA2)) => ((Xph => (cwcel @ XR @ XA2)) => (Xph => (cwrex @ (^ [Xs1:$i] : (~ (cwss @ (ccv @ Xs1) @ (cco @ (cco @ XP @ XQ @ Xc_po) @ XR @ Xc_po)))) @ (^ [Xs1:$i] : XA2)))))))))))))))))))))).
...
thf(cdvh4dimlem_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : ((XH @ Xz) = (ccfv @ (XK @ Xz) @ cclh))) => ((! [Xz:$i] : (XU = (ccfv @ (XW @ Xz) @ (ccfv @ (XK @ Xz) @ ccdvh)))) => ((XV = (ccfv @ XU @ ccbs)) => ((XN = (ccfv @ XU @ cclspn)) => ((! [Xz:$i] : (Xph => ((cwcel @ (XK @ Xz) @ cchlt) & (cwcel @ (XW @ Xz) @ (XH @ Xz))))) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XZ @ XV)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((Xph => (XX != Xc_0)) => ((Xph => (XY != Xc_0)) => ((Xph => (XZ != Xc_0)) => (Xph => (cwrex @ (^ [Xz:$i] : (~ (cwcel @ (ccv @ Xz) @ (ccfv @ (cctp @ XX @ XY @ XZ) @ XN)))) @ (^ [Xz:$i] : XV))))))))))))))))))))))))))).
