...
thf(cntrneikb_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XO @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : (cco @ (ccpw @ (ccv @ Xj)) @ (ccv @ Xi) @ ccmap)) @ (^ [Xk:$i] : (ccmpt @ (^ [Xl:$i] : (ccv @ Xj)) @ (^ [Xl:$i] : (ccrab @ (^ [Xm:$i] : (cwcel @ (ccv @ Xl) @ (ccfv @ (ccv @ Xm) @ (ccv @ Xk)))) @ (^ [Xm:$i] : (ccv @ Xi))))))))))))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XF @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) = (cco @ (ccpw @ XB2) @ XB2 @ (XO @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl))))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((Xph @ Xm) => (cwbr @ (XI @ Xt @ Xi @ Xj @ Xs1) @ (XN @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ (XF @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl))))))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : ((Xph @ Xm) => ((cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (((ccin @ (ccv @ Xs1) @ (ccv @ Xt)) = cc0) => ((ccin @ (ccfv @ (ccv @ Xs1) @ (XI @ Xt @ Xi @ Xj @ Xs1)) @ (ccfv @ (ccv @ Xt) @ (XI @ Xt @ Xi @ Xj @ Xs1))) = cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2))) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (((cwcel @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xx3) @ (XN @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl))) & (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xx3) @ (XN @ Xx3 @ Xt @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl)))) => ((ccin @ (ccv @ Xs1) @ (ccv @ Xt)) != cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2)))) @ (^ [Xx3:$i] : XB2))))))))))))))))))).
