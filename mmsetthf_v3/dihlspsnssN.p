...
thf(alspsnat_thm,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => ((((cwcel @ XW @ cclvec) & (cwcel @ XU @ XS) & (cwcel @ XX @ XV)) & (cwss @ XU @ (ccfv @ (ccsn @ XX) @ XN))) => ((XU = (ccfv @ (ccsn @ XX) @ XN)) | (XU = (ccsn @ Xc_0)))))))))))))))).
...
thf(cdihlspsnssN_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((XS = (ccfv @ XU @ cclss)) => ((XN = (ccfv @ XU @ cclspn)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XX @ XV) & (cwss @ XT @ (ccfv @ (ccsn @ XX) @ XN))) => ((cwcel @ XT @ XS) <=> (cwcel @ XT @ (ccrn @ XI))))))))))))))))))))).
