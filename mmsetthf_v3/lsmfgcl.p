...
thf(clsmfgcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XU = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XD = (cco @ XW @ XA2 @ ccress)) => ((XE = (cco @ XW @ XB2 @ ccress)) => ((XF = (cco @ XW @ (cco @ XA2 @ XB2 @ Xc_po) @ ccress)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XB2 @ XU)) => ((Xph => (cwcel @ XD @ cclfig)) => ((Xph => (cwcel @ XE @ cclfig)) => (Xph => (cwcel @ XF @ cclfig)))))))))))))))))))))).
