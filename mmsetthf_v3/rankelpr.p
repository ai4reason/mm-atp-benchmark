...
thf(arankun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((ccfv @ (ccun @ XA2 @ XB2) @ ccrnk) = (ccun @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk)))))))).
...
thf(arankpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((ccfv @ (ccpr @ XA2 @ XB2) @ ccrnk) = (ccsuc @ (ccun @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk))))))))).
thf(crankelpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (((cwcel @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XC @ ccrnk)) & (cwcel @ (ccfv @ XB2 @ ccrnk) @ (ccfv @ XD @ ccrnk))) => (cwcel @ (ccfv @ (ccpr @ XA2 @ XB2) @ ccrnk) @ (ccfv @ (ccpr @ XC @ XD) @ ccrnk)))))))))))).
