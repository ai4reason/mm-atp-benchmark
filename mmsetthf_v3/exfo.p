...
thf(cexfo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((? [Xf1:$i] : (cwfo @ XA2 @ XB2 @ (ccv @ Xf1))) <=> (? [Xf1:$i] : ((cwral @ (^ [Xx3:$i] : (cwreu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XB2)))))))).
