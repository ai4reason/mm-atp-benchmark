...
thf(abcm1n_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) & (cwcel @ XN @ ccn)) => ((cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccbc) @ (cco @ XN @ XK @ ccbc) @ ccdiv) = (cco @ (cco @ XN @ XK @ ccmin) @ XN @ ccdiv)))))).
