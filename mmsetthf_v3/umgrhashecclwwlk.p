...
thf(cumgrhashecclwwlk_conj,conjecture,(! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xt:$i] : (XW = (cco @ XN @ (XG @ Xt) @ ccclwwlkn))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xc_sm @ Xu @ Xt @ Xn) = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : ((cwcel @ (ccv @ Xt) @ XW) & (cwcel @ (ccv @ Xu) @ XW) & (cwrex @ (^ [Xn:$i] : ((ccv @ Xt) = (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (((cwcel @ (XG @ Xt) @ ccumgr) & (cwcel @ XN @ ccprime)) => ((cwcel @ (XU @ Xt) @ (ccqs @ XW @ (Xc_sm @ Xu @ Xt @ Xn))) => ((ccfv @ (XU @ Xt) @ cchash) = XN)))))))))))))).
