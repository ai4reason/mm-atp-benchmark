...
thf(cndmaovdistr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((ccdm @ XF) = (ccxp @ XS @ XS)) => (((ccdm @ XG) = (ccxp @ XS @ XS)) => ((~ ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS) & (cwcel @ XC @ XS))) => ((ccaov @ XA2 @ (ccaov @ XB2 @ XC @ XF) @ XG) = (ccaov @ (ccaov @ XA2 @ XB2 @ XG) @ (ccaov @ XA2 @ XC @ XG) @ XF)))))))))))).
