...
thf(aistotbnd_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (((ccuni @ (ccv @ Xv)) = XX) & (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xb) = (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xb:$i] : (ccv @ Xv))))) @ (^ [Xv:$i] : ccfn))) @ (^ [Xd:$i] : ccrp))))))).
...
thf(asstotbnd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xb:$i] : ((XN @ Xb) = (ccres @ XM @ (ccxp @ XY @ XY)))) => (! [Xb:$i] : (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwss @ XY @ XX)) => ((cwcel @ (XN @ Xb) @ (ccfv @ XY @ cctotbnd)) <=> (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : ((cwss @ XY @ (ccuni @ (ccv @ Xv))) & (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xb) = (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xb:$i] : (ccv @ Xv))))) @ (^ [Xv:$i] : ccfn))) @ (^ [Xd:$i] : ccrp))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ctotbndss_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) & (cwss @ XS @ XX)) => (cwcel @ (ccres @ XM @ (ccxp @ XS @ XS)) @ (ccfv @ XS @ cctotbnd))))))).
