...
thf(ctendoeq1_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ XK @ cclh))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((XE @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => (! [Xf1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xf1))) & ((cwcel @ XU @ (XE @ Xf1)) & (cwcel @ XV @ (XE @ Xf1))) & (cwral @ (^ [Xf1:$i] : ((ccfv @ (ccv @ Xf1) @ XU) = (ccfv @ (ccv @ Xf1) @ XV))) @ (^ [Xf1:$i] : XT))) => (XU = XV)))))))))))))).
