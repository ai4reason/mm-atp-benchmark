...
thf(a_0ghm_thm,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XN @ cc0g)) => ((XB2 = (ccfv @ XM @ ccbs)) => (((cwcel @ XM @ ccgrp) & (cwcel @ XN @ ccgrp)) => (cwcel @ (ccxp @ XB2 @ (ccsn @ Xc_0)) @ (cco @ XM @ XN @ ccghm)))))))))).
...
thf(c_0lmhm_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XN @ cc0g)) => ((XB2 = (ccfv @ XM @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((XT = (ccfv @ XN @ ccsca)) => (((cwcel @ XM @ cclmod) & (cwcel @ XN @ cclmod) & (XS = XT)) => (cwcel @ (ccxp @ XB2 @ (ccsn @ Xc_0)) @ (cco @ XM @ XN @ cclmhm)))))))))))))).
