...
thf(afsnunf_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwf @ XS @ XT @ XF) & ((cwcel @ XX @ XV) & (~ (cwcel @ XX @ XS))) & (cwcel @ XY @ XT)) => (cwf @ (ccun @ XS @ (ccsn @ XX)) @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY)))))))))))).
...
thf(afvunsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XB2 != XD) => ((ccfv @ XD @ (ccun @ XA2 @ (ccsn @ (ccop @ XB2 @ XC)))) = (ccfv @ XD @ XA2)))))))).
...
thf(cnnsum4primesevenALTV_conj,conjecture,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc7 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ (ccdc @ cc1 @ cc2) @ ccuz)) & (cwcel @ XN @ cceven)) => (cwrex @ (^ [Xf1:$i] : (XN = (ccsu @ (cco @ cc1 @ cc4 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc4 @ ccfz) @ ccmap))))))).
