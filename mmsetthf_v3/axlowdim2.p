...
thf(aaxlowdimlem6_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccun @ (ccpr @ (ccop @ cc1 @ ccc0) @ (ccop @ cc2 @ ccc0)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0)))) => ((XB2 = (ccun @ (ccpr @ (ccop @ cc1 @ cc1) @ (ccop @ cc2 @ ccc0)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0)))) => ((XC = (ccun @ (ccpr @ (ccop @ cc1 @ ccc0) @ (ccop @ cc2 @ cc1)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0)))) => ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (~ ((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) | (cwbr @ XB2 @ (ccop @ XC @ XA2) @ ccbtwn) | (cwbr @ XC @ (ccop @ XA2 @ XB2) @ ccbtwn)))))))))))).
...
thf(caxlowdim2_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (~ ((cwbr @ (ccv @ Xx3) @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ ccbtwn) | (cwbr @ (ccv @ Xy1) @ (ccop @ (ccv @ Xz) @ (ccv @ Xx3)) @ ccbtwn) | (cwbr @ (ccv @ Xz) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccbtwn)))) @ (^ [Xz:$i] : (ccfv @ XN @ ccee)))) @ (^ [Xy1:$i] : (ccfv @ XN @ ccee)))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee)))))).
