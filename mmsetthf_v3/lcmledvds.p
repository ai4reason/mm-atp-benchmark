...
thf(clcmledvds_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XK @ ccn) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (~ ((XM = ccc0) | (XN = ccc0)))) => (((cwbr @ XM @ XK @ ccdvds) & (cwbr @ XN @ XK @ ccdvds)) => (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccle))))))).
