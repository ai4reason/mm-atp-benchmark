...
thf(cvoliunnfl_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XS @ Xx3 @ Xf1 @ Xn) = (ccseq @ ccaddc @ (XG @ Xx3 @ Xf1 @ Xn) @ cc1))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xf1 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ ccvol))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : (((cwral @ (^ [Xn:$i] : ((cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ ccvol) @ ccr))) @ (^ [Xn:$i] : ccn)) & (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))))) => ((ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)))) @ ccvol) = (ccsup @ (ccrn @ (XS @ Xx3 @ Xf1 @ Xn)) @ ccxr @ cclt)))))) => (((cwbr @ XA2 @ ccn @ ccdom) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ ccn @ ccdom)) @ (^ [Xx3:$i] : XA2))) => ((ccuni @ XA2) != ccr))))))))).
