...
thf(atgldim0itv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => ((ccfv @ XP @ cchash) = cc1)) => (Xph => (cwcel @ XA2 @ (cco @ XB2 @ XC @ XI)))))))))))))))))))).
...
thf(atgldim0cgr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => ((ccfv @ XP @ cchash) = cc1)) => ((Xph => (cwcel @ XD @ XP)) => (Xph => ((cco @ XA2 @ XB2 @ Xc_mi) = (cco @ XC @ XD @ Xc_mi)))))))))))))))))))))).
...
thf(atgcgrextend_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XE @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => (cwcel @ XE @ (cco @ XD @ XF @ XI))) => ((Xph => ((cco @ XA2 @ XB2 @ Xc_mi) = (cco @ XD @ XE @ Xc_mi))) => ((Xph => ((cco @ XB2 @ XC @ Xc_mi) = (cco @ XE @ XF @ Xc_mi))) => (Xph => ((cco @ XA2 @ XC @ Xc_mi) = (cco @ XD @ XF @ Xc_mi))))))))))))))))))))))))))))).
...
thf(atgbtwndiff_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xc:$i] : (XP = (ccfv @ (XG @ Xc) @ ccbs))) => ((! [Xc:$i] : (Xc_mi = (ccfv @ (XG @ Xc) @ ccds))) => ((! [Xc:$i] : (XI = (ccfv @ (XG @ Xc) @ ccitv))) => ((! [Xc:$i] : (Xph => (cwcel @ (XG @ Xc) @ ccstrkg))) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) => (Xph => (cwrex @ (^ [Xc:$i] : ((cwcel @ XB2 @ (cco @ XA2 @ (ccv @ Xc) @ XI)) & (XB2 != (ccv @ Xc)))) @ (^ [Xc:$i] : XP)))))))))))))))))).
...
thf(atgldimor_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((XP = (ccfv @ XF @ XE)) => ((Xph => (cwcel @ XA2 @ XP)) => (Xph => (((ccfv @ XP @ cchash) = cc1) | (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle))))))))))).
thf(ctgcgrxfr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xe:$i] : (XP = (ccfv @ (XG @ Xe) @ ccbs))) => ((! [Xe:$i] : (Xc_mi = (ccfv @ (XG @ Xe) @ ccds))) => ((! [Xe:$i] : (XI = (ccfv @ (XG @ Xe) @ ccitv))) => ((! [Xe:$i] : (Xc_sm = (ccfv @ (XG @ Xe) @ cccgrg))) => ((! [Xe:$i] : (Xph => (cwcel @ (XG @ Xe) @ ccstrkg))) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => ((cco @ XA2 @ XC @ Xc_mi) = (cco @ XD @ XF @ Xc_mi))) => (Xph => (cwrex @ (^ [Xe:$i] : ((cwcel @ (ccv @ Xe) @ (cco @ XD @ XF @ XI)) & (cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XD @ (ccv @ Xe) @ XF) @ Xc_sm))) @ (^ [Xe:$i] : XP))))))))))))))))))))))))))).
