...
thf(agsumcllem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwf @ XA2 @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ (XZ @ Xk) @ (XU @ Xk)))) => ((! [Xk:$i] : (Xph => (cwss @ (cco @ XF @ (XZ @ Xk) @ ccsupp) @ XW))) => ((Xph & (XW = cc0)) => (XF = (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XZ @ Xk)))))))))))))))))).
...
thf(aressuppss_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XZ @ XW)) => (cwss @ (cco @ (ccres @ XF @ XB2) @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp))))))))).
