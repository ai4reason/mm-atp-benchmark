...
thf(catabsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccat) => ((~ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj))) => ((ccin @ (cco @ XA2 @ XC @ cchj) @ XB2) = (ccin @ XA2 @ XB2)))))))))).
