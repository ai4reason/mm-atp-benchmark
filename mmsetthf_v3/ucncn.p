...
thf(austimasn_thm,axiom,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU) & (cwcel @ XP @ XX)) => (cwss @ (ccima @ XV @ (ccsn @ XP)) @ XX))))))).
...
thf(aelutop_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xv:$i] : ((cwcel @ XU @ (ccfv @ (XX @ Xv) @ ccust)) => ((cwcel @ XA2 @ (ccfv @ XU @ ccutop)) <=> ((cwss @ XA2 @ (XX @ Xv)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xx3))) @ XA2)) @ (^ [Xv:$i] : XU))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(cucncn_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XR @ cctopn)) => ((XK = (ccfv @ XS @ cctopn)) => ((Xph => (cwcel @ XR @ ccusp)) => ((Xph => (cwcel @ XS @ ccusp)) => ((Xph => (cwcel @ XR @ cctps)) => ((Xph => (cwcel @ XS @ cctps)) => ((Xph => (cwcel @ XF @ (cco @ (ccfv @ XR @ ccuss) @ (ccfv @ XS @ ccuss) @ ccucn))) => (Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))))))))).
