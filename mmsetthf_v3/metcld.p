...
thf(ametelcls_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xf1:$i] : (Xph => (cwcel @ XD @ (ccfv @ (XX @ Xf1) @ ccxmt)))) => ((! [Xf1:$i] : (Xph => (cwss @ XS @ (XX @ Xf1)))) => (Xph => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) <=> (? [Xf1:$i] : ((cwf @ ccn @ XS @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XJ @ cclm)))))))))))))))).
...
thf(cmetcld_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) => ((cwcel @ XS @ (ccfv @ XJ @ cccld)) <=> (! [Xx3:$i] : (! [Xf1:$i] : (((cwf @ ccn @ XS @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ (ccfv @ XJ @ cclm))) => (cwcel @ (ccv @ Xx3) @ XS)))))))))))).
