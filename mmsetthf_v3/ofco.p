...
thf(cofco_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => ((Xph => (cwfn @ XG @ XB2)) => ((Xph => (cwf @ XD @ XC @ XH)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XD @ XX)) => (((ccin @ XA2 @ XB2) = XC) => (Xph => ((cccom @ (cco @ XF @ XG @ (ccof @ XR)) @ XH) = (cco @ (cccom @ XF @ XH) @ (cccom @ XG @ XH) @ (ccof @ XR)))))))))))))))))))))))).
