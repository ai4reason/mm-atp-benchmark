...
thf(cmulc1cncfg_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XF @ Xx3) @ (cco @ XA2 @ ccc @ cccncf)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ ccc))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XB2 @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ ccmul))) @ (cco @ XA2 @ ccc @ cccncf))))))))))))).
