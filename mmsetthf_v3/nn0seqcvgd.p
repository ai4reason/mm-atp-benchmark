...
thf(cnn0seqcvgd_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwf @ ccn0 @ ccn0 @ XF)) => ((Xph => (XN = (ccfv @ ccc0 @ XF))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => (((ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) != ccc0) => (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xk) @ XF) @ cclt)))) => (Xph => ((ccfv @ XN @ XF) = ccc0))))))))).
