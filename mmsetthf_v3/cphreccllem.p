...
thf(ccphreccllem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XF @ ccbs)) => ((Xph => (XF = (cco @ cccnfld @ XA2 @ ccress))) => ((Xph => (cwcel @ XF @ ccdr)) => ((Xph & (cwcel @ XX @ XK) & (XX != ccc0)) => (cwcel @ (cco @ cc1 @ XX @ ccdiv) @ XK))))))))))).
