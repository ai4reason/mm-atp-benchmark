...
thf(cnbuhgr_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xn:$i] : ((XE @ Xn) = (ccfv @ XG @ ccedg))) => (((cwcel @ XG @ ccuhgr) & (cwcel @ XN @ XX)) => ((cco @ XG @ XN @ ccnbgr) = (ccrab @ (^ [Xn:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XN @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xn)))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))))))).
