...
thf(afprodp1s_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => (Xph => ((ccprod @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) = (cco @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsb @ (cco @ XN @ cc1 @ ccaddc) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccmul)))))))))).
