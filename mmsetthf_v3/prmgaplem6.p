...
thf(aprmgaplem4_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((XA2 @ Xp) = (ccrab @ (^ [Xp:$i] : ((cwbr @ (XN @ Xx3 @ Xy1) @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (XP @ Xx3 @ Xy1) @ ccle))) @ (^ [Xp:$i] : ccprime)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : (((cwcel @ (XN @ Xx3 @ Xy1) @ ccn) & (cwcel @ (XP @ Xx3 @ Xy1) @ ccprime) & (cwbr @ (XN @ Xx3 @ Xy1) @ (XP @ Xx3 @ Xy1) @ cclt)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : (XA2 @ Xp)))) @ (^ [Xx3:$i] : (XA2 @ Xp)))))))))))).
...
thf(cprmgaplem6_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xp) @ ccfzo))))) @ (^ [Xp:$i] : ccprime))))).
