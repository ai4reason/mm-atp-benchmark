...
thf(catncmp_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ ccal) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) => ((~ (cwbr @ XP @ XQ @ Xc_le)) <=> (XP != XQ))))))))))).
