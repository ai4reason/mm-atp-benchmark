...
thf(crestco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ XV) & (cwcel @ XA2 @ XW) & (cwcel @ XB2 @ XX)) => ((cco @ (cco @ XJ @ XA2 @ ccrest) @ XB2 @ ccrest) = (cco @ XJ @ (ccin @ XA2 @ XB2) @ ccrest)))))))))).
