...
thf(cocvlss_conj,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XL = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ ccphl) & (cwss @ XS @ XV)) => (cwcel @ (ccfv @ XS @ Xc_pe) @ XL))))))))))).
