...
thf(cuspgr2wlkeqi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccuspgr) & ((cwcel @ XA2 @ (ccfv @ XG @ ccwlks)) & (cwcel @ XB2 @ (ccfv @ XG @ ccwlks))) & ((ccfv @ XA2 @ cc2nd) = (ccfv @ XB2 @ cc2nd))) => (XA2 = XB2)))))).
