...
thf(cbj_ceqsalt0_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xth:($i > $o)] : (! [Xx3:$i] : ((((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X))) & (! [Xx3:$i] : ((Xth @ Xx3) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) & (? [Xx3:$i] : (Xth @ Xx3))) => ((! [Xx3:$i] : ((Xth @ Xx3) => (Xph @ Xx3))) <=> (Xps @ Xx3)))))))).
