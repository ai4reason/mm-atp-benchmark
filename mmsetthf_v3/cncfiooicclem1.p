...
thf(aelioo4g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) <=> (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccr)) & ((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XC @ XB2 @ cclt)))))))).
...
thf(ccncfiooicclem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XA2) @ XR @ (ccif @ ((ccv @ Xx3) = XB2) @ XL @ (ccfv @ (ccv @ Xx3) @ XF))))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ XA2 @ XB2 @ cclt))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XR @ (cco @ XF @ XA2 @ cclimc)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XG @ Xx3) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf)))))))))))))))))))).
