...
thf(cisfth_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth)) <=> ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfunc)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwfun @ (cccnv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))).
