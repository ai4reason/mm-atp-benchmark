...
thf(cdivmulass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ ccc)) & ((cwcel @ XD @ ccc) & (XD != ccc0))) => ((cco @ (cco @ XA2 @ (cco @ XB2 @ XD @ ccdiv) @ ccmul) @ XC @ ccmul) = (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XC @ XD @ ccdiv) @ ccmul)))))))).
