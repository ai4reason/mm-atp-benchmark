...
thf(cfrege98_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ XA2) => ((cwcel @ XY @ XB2) => ((cwcel @ XZ @ XC) => ((cwcel @ XR @ XD) => ((cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) => ((cwbr @ XY @ XZ @ (ccfv @ XR @ cctcl)) => (cwbr @ XX @ XZ @ (ccfv @ XR @ cctcl))))))))))))))))).
