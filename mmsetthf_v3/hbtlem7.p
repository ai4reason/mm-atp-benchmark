...
thf(adf_ldgis_ax,axiom,(ccldgis = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cclidl)) @ (^ [Xi:$i] : (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (^ [Xj:$i] : (cwrex @ (^ [Xk:$i] : ((cwbr @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xr) @ ccdg1)) @ (ccv @ Xx3) @ ccle) & ((ccv @ Xj) = (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ ccco1))))) @ (^ [Xk:$i] : (ccv @ Xi)))))))))))).
