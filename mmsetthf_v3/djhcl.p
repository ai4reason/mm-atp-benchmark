...
thf(cdjhcl_conj,conjecture,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_or = (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwss @ XX @ XV) & (cwss @ XY @ XV))) => (cwcel @ (cco @ XX @ XY @ Xc_or) @ (ccrn @ XI)))))))))))))))))).
