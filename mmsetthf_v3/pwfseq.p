...
thf(ainfxpenc2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (? [Xg1:$i] : (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwf1o @ (ccxp @ (ccv @ Xb) @ (ccv @ Xb)) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1))))) @ (^ [Xb:$i] : XA2)))))).
