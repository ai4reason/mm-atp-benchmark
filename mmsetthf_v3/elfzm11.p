...
thf(celfzm11_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwcel @ XK @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) <=> ((cwcel @ XK @ ccz) & (cwbr @ XM @ XK @ ccle) & (cwbr @ XK @ XN @ cclt)))))))).
