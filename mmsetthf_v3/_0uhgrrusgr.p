...
thf(a_0vtxrusgr_thm,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XG @ XW) & ((ccfv @ XG @ ccvtx) = cc0) & ((ccfv @ XG @ cciedg) = cc0)) => (cwral @ (^ [Xk:$i] : (cwbr @ XG @ (ccv @ Xk) @ ccrusgr)) @ (^ [Xk:$i] : ccxnn0)))))).
thf(c_0uhgrrusgr_conj,conjecture,(! [XG:($i > $o)] : (((cwcel @ XG @ ccuhgr) & ((ccfv @ XG @ ccvtx) = cc0)) => (cwral @ (^ [Xk:$i] : (cwbr @ XG @ (ccv @ Xk) @ ccrusgr)) @ (^ [Xk:$i] : ccxnn0))))).
