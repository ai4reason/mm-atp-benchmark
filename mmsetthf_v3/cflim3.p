...
thf(acfval_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ cccf) = (ccint @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ cccrd)) & ((cwss @ (ccv @ Xy1) @ XA2) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : XA2))))))))))).
...
thf(ccflim3_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwlim @ XA2) => ((ccfv @ XA2 @ cccf) = (cciin @ (^ [Xx3:$i] : (ccrab @ (^ [Xx3:$i] : ((ccuni @ (ccv @ Xx3)) = XA2)) @ (^ [Xx3:$i] : (ccpw @ XA2)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cccrd)))))))).
