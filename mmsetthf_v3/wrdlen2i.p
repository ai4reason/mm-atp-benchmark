...
thf(afprg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((((cwcel @ XA2 @ XE) & (cwcel @ XB2 @ XF)) & ((cwcel @ XC @ XG) & (cwcel @ XD @ XH)) & (XA2 != XB2)) => (cwf @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD) @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))))))))))))).
...
thf(aopth1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (((ccop @ XA2 @ XB2) = (ccop @ XC @ XD)) => (XA2 = XC)))))))))).
...
thf(afvpr1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XC @ XW) & (XA2 != XB2)) => ((ccfv @ XA2 @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))) = XC))))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(afvpr2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XD @ XW) & (XA2 != XB2)) => ((ccfv @ XB2 @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))) = XD))))))))).
thf(aanbi12d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xth <=> Xta)) => (Xph => ((Xps & Xth) <=> (Xch & Xta))))))))))).
thf(aeqeq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((XA2 = XC) <=> (XB2 = XC))))))))).
thf(afveq1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = XG) => ((ccfv @ XA2 @ XF) = (ccfv @ XA2 @ XG))))))).
thf(cwrdlen2i_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XT @ XV)) => ((XW = (ccpr @ (ccop @ ccc0 @ XS) @ (ccop @ cc1 @ XT))) => (((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = cc2)) & (((ccfv @ ccc0 @ XW) = XS) & ((ccfv @ cc1 @ XW) = XT)))))))))).
