...
thf(ccpmidpmatlem2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [Xc_ex:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xk:$i] : ((XA2 @ Xk) = (cco @ XN @ XR @ ccmat))) => ((! [Xk:$i] : (XB2 = (ccfv @ (XA2 @ Xk) @ ccbs))) => ((XP = (ccfv @ XR @ ccpl1)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((! [Xk:$i] : ((XX @ Xk) = (ccfv @ XR @ ccv1))) => ((! [Xk:$i] : ((Xc_ex @ Xk) = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg))) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ XY @ ccvsca))) => ((! [Xk:$i] : ((Xc_1 @ Xk) = (ccfv @ XY @ ccur))) => ((! [Xk:$i] : ((XU @ Xk) = (ccfv @ XP @ ccascl))) => ((! [Xk:$i] : ((XC @ Xk) = (cco @ XN @ XR @ ccchpmat))) => ((! [Xk:$i] : (XK = (ccfv @ XM @ (XC @ Xk)))) => ((! [Xk:$i] : (XH = (cco @ XK @ (Xc_1 @ Xk) @ (Xc_x @ Xk)))) => ((! [Xk:$i] : (XO = (ccfv @ (XA2 @ Xk) @ ccur))) => ((! [Xk:$i] : (Xc_as = (ccfv @ (XA2 @ Xk) @ ccvsca))) => ((! [Xk:$i] : ((XT @ Xk) = (cco @ XN @ XR @ ccmat2pmat))) => ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ XK @ ccco1)) @ XO @ Xc_as))))) => (! [Xk:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => (cwcel @ (XG @ Xk) @ (cco @ XB2 @ ccn0 @ ccmap)))))))))))))))))))))))))))))))))))))))).
