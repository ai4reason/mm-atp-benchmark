...
thf(csadcp1_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (((cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) & (cwcel @ (ccv @ Xm) @ (XB2 @ Xn))) | ((cwcel @ cc0 @ (ccv @ Xc)) & (~ ((cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) <=> (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)))))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XN @ Xm @ Xc) @ ccn0))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((cwcel @ cc0 @ (ccfv @ (cco @ (XN @ Xm @ Xc) @ cc1 @ ccaddc) @ (XC @ Xm @ Xn @ Xc))) <=> (((cwcel @ (XN @ Xm @ Xc) @ (XA2 @ Xn)) & (cwcel @ (XN @ Xm @ Xc) @ (XB2 @ Xn))) | ((cwcel @ cc0 @ (ccfv @ (XN @ Xm @ Xc) @ (XC @ Xm @ Xn @ Xc))) & (~ ((cwcel @ (XN @ Xm @ Xc) @ (XA2 @ Xn)) <=> (cwcel @ (XN @ Xm @ Xc) @ (XB2 @ Xn))))))))))))))))))))).
