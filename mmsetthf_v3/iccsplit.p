...
thf(ciccsplit_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((cco @ XA2 @ XB2 @ ccicc) = (ccun @ (cco @ XA2 @ XC @ ccicc) @ (cco @ XC @ XB2 @ ccicc)))))))).
