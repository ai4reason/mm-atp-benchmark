...
thf(ccnntr_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xx3:$i] : (cwss @ (ccima @ (cccnv @ XF) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XK @ ccnt))) @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnt)))) @ (^ [Xx3:$i] : (ccpw @ XY)))))))))))).
