...
thf(cprodpr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XA2) => ((XD @ Xk) = XE))) => ((! [Xk:$i] : (((ccv @ Xk) = XB2) => ((XD @ Xk) = XF))) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XE @ ccc)) => ((Xph => (cwcel @ XF @ ccc)) => ((Xph => (XA2 != XB2)) => (Xph => ((ccprod @ (^ [Xk:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xk:$i] : (XD @ Xk))) = (cco @ XE @ XF @ ccmul))))))))))))))))))).
