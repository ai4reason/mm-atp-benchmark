...
thf(clsmelvalmi_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XX @ XT)) => ((Xph => (cwcel @ XY @ XU)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XT @ XU @ Xc_po)))))))))))))))))).
