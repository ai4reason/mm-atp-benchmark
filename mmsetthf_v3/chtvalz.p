...
thf(auzssico_thm,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => (cwss @ (ccfv @ XM @ ccuz) @ (cco @ XM @ ccpnf @ ccico))))).
...
thf(aicodisj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) => ((ccin @ (cco @ XA2 @ XB2 @ ccico) @ (cco @ XB2 @ XC @ ccico)) = cc0)))))).
