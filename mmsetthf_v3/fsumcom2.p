...
thf(afsumcnv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xx3) = (ccop @ (ccv @ Xj) @ (ccv @ Xk))) => ((XB2 @ Xx3) = (XD @ Xj @ Xk)))))) => ((! [Xy1:$i] : (! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xy1) = (ccop @ (ccv @ Xk) @ (ccv @ Xj))) => ((XC @ Xy1) = (XD @ Xj @ Xk)))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XA2 @ Xj @ Xk) @ ccfn)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwrel @ (XA2 @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xj @ Xk) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xj @ Xk))) => (cwcel @ (XB2 @ Xx3) @ ccc))))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => ((ccsu @ (XA2 @ Xj @ Xk) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccsu @ (cccnv @ (XA2 @ Xj @ Xk)) @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))))))))).
...
thf(cfsumcom2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwcel @ XC @ ccfn)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XA2)) => (cwcel @ (XB2 @ Xj) @ ccfn))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xj))) <=> ((cwcel @ (ccv @ Xk) @ XC) & (cwcel @ (ccv @ Xj) @ (XD @ Xk))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xj)))) => (cwcel @ (XE @ Xj @ Xk) @ ccc)))) => (Xph => ((ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ (XB2 @ Xj) @ (^ [Xk:$i] : (XE @ Xj @ Xk))))) = (ccsu @ XC @ (^ [Xk:$i] : (ccsu @ (XD @ Xk) @ (^ [Xj:$i] : (XE @ Xj @ Xk))))))))))))))))))).
