...
thf(aswrdccatin12lem1_thm,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XL @ ccn0) & (cwcel @ XM @ ccn0) & (cwcel @ XN @ ccz)) => (((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) & (~ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) => (cwcel @ XK @ (cco @ (cco @ XL @ XM @ ccmin) @ (cco @ (cco @ XL @ XM @ ccmin) @ (cco @ XN @ XL @ ccmin) @ ccaddc) @ ccfzo))))))))).
