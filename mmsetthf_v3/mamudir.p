...
thf(amndvcl_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap)) & (cwcel @ XY @ (cco @ XB2 @ XI @ ccmap))) => (cwcel @ (cco @ XX @ XY @ (ccof @ Xc_pl)) @ (cco @ XB2 @ XI @ ccmap)))))))))))).
...
thf(cmamudir_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XF = (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XO @ ccfn)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xph => (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => ((Xph => (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => (Xph => ((cco @ XX @ (cco @ XY @ XZ @ (ccof @ Xc_pl)) @ XF) = (cco @ (cco @ XX @ XY @ XF) @ (cco @ XX @ XZ @ XF) @ (ccof @ Xc_pl)))))))))))))))))))))))))).
