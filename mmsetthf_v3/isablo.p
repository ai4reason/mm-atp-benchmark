...
thf(cisablo_conj,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((cwcel @ XG @ ccablo) <=> ((cwcel @ XG @ ccgr) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))).
