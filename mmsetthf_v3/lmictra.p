...
thf(almimco_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XS @ XT @ cclmim)) & (cwcel @ XG @ (cco @ XR @ XS @ cclmim))) => (cwcel @ (cccom @ XF @ XG) @ (cco @ XR @ XT @ cclmim))))))))).
thf(abrlmici_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XR @ XS @ cclmim)) => (cwbr @ XR @ XS @ cclmic)))))).
thf(clmictra_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwbr @ XR @ XS @ cclmic) & (cwbr @ XS @ XT @ cclmic)) => (cwbr @ XR @ XT @ cclmic)))))).
