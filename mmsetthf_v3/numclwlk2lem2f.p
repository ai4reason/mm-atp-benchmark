...
thf(awwlksubclwwlk_thm,axiom,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) => ((cwcel @ XX @ (cco @ XN @ XG @ ccclwwlkn)) => (cwcel @ (cco @ XX @ (ccop @ ccc0 @ XM) @ ccsubstr) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccwwlksn))))))))).
