...
thf(aisotr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (cwiso @ XB2 @ XC @ XS @ XT @ XG)) => (cwiso @ XA2 @ XC @ XR @ XT @ (cccom @ XG @ XH)))))))))))).
...
thf(aordiso2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwiso @ XA2 @ XB2 @ ccep @ ccep @ XF) & (cword @ XA2) & (cword @ XB2)) => (XA2 = XB2)))))).
...
thf(aweisoeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwiso @ XA2 @ XB2 @ XR @ XS @ XF) & (cwiso @ XA2 @ XB2 @ XR @ XS @ XG))) => (XF = XG))))))))).
