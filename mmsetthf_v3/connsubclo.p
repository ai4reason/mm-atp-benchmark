...
thf(cconnsubclo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn)) => ((Xph => (cwcel @ XB2 @ XJ)) => ((Xph => ((ccin @ XB2 @ XA2) != cc0)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XJ @ cccld))) => (Xph => (cwss @ XA2 @ XB2)))))))))))))).
