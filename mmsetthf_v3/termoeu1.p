...
thf(a_2termoinv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ cctermo))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XC @ cctermo))) => ((Xph & (cwcel @ XG @ (cco @ XB2 @ XA2 @ (ccfv @ XC @ cchom))) & (cwcel @ XF @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cchom)))) => (cwbr @ XF @ XG @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ ccinv)))))))))))))).
