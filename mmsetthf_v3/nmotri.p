...
thf(cnmotri_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((Xc_pl = (ccfv @ XT @ ccplusg)) => (((cwcel @ XT @ ccabl) & (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccnghm))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ XN) @ (cco @ (ccfv @ XF @ XN) @ (ccfv @ XG @ XN) @ ccaddc) @ ccle))))))))))).
