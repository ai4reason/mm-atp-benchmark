...
thf(ceceqoveq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwer @ (ccxp @ XS @ XS) @ (Xc_sm @ Xx3 @ Xy1)))) => (((ccdm @ Xc_pl) = (ccxp @ XS @ XS)) => ((~ (cwcel @ cc0 @ XS)) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS)) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ (Xc_sm @ Xx3 @ Xy1)) <=> ((cco @ XA2 @ XD @ Xc_pl) = (cco @ XB2 @ XC @ Xc_pl)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ XS) & (cwcel @ XC @ XS)) => (((ccec @ (ccop @ XA2 @ XB2) @ (Xc_sm @ Xx3 @ Xy1)) = (ccec @ (ccop @ XC @ XD) @ (Xc_sm @ Xx3 @ Xy1))) <=> ((cco @ XA2 @ XD @ Xc_pl) = (cco @ XB2 @ XC @ Xc_pl))))))))))))))))))).
