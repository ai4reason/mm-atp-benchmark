...
thf(cpsgnfvalfi_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : ((XG @ Xx3 @ Xw @ Xs1) = (ccfv @ XD @ ccsymg))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : ((XB2 @ Xw @ Xs1) = (ccfv @ (XG @ Xx3 @ Xw @ Xs1) @ ccbs))))) => ((! [Xx3:$i] : (! [Xs1:$i] : ((XT @ Xx3 @ Xs1) = (ccrn @ (ccfv @ XD @ ccpmtr))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : ((XN @ Xx3 @ Xw @ Xs1) = (ccfv @ XD @ ccpsgn))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xs1:$i] : ((cwcel @ XD @ ccfn) => ((XN @ Xx3 @ Xw @ Xs1) = (ccmpt @ (^ [Xx3:$i] : (XB2 @ Xw @ Xs1)) @ (^ [Xx3:$i] : (ccio @ (^ [Xs1:$i] : (cwrex @ (^ [Xw:$i] : (((ccv @ Xx3) = (cco @ (XG @ Xx3 @ Xw @ Xs1) @ (ccv @ Xw) @ ccgsu)) & ((ccv @ Xs1) = (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccexp)))) @ (^ [Xw:$i] : (ccword @ (XT @ Xx3 @ Xs1))))))))))))))))))))))).
