...
thf(ccdlemefrs29bpre0_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xz:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xs1:$i] : ((XB2 @ Xs1) = (ccfv @ XK @ ccbs))) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((! [Xs1:$i] : ((Xc_an @ Xs1) = (ccfv @ XK @ ccmee))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xs1:$i] : (((ccv @ Xs1) = XR) => ((Xph @ Xs1) <=> Xps))) => ((! [Xs1:$i] : (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) & (XP != XQ) & ((cwcel @ (ccv @ Xs1) @ XA2) & ((~ (cwbr @ (ccv @ Xs1) @ XW @ Xc_le)) & (Xph @ Xs1)))) => (cwcel @ (XN @ Xs1) @ (XB2 @ Xs1)))) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) & ((XP != XQ) & ((cwcel @ XR @ XA2) & (~ (cwbr @ XR @ XW @ Xc_le)))) & Xps) => ((cwral @ (^ [Xs1:$i] : ((((~ (cwbr @ (ccv @ Xs1) @ XW @ Xc_le)) & (Xph @ Xs1)) & ((cco @ (ccv @ Xs1) @ (cco @ XR @ XW @ (Xc_an @ Xs1)) @ Xc_or) = XR)) => ((ccv @ Xz) = (cco @ (XN @ Xs1) @ (cco @ XR @ XW @ (Xc_an @ Xs1)) @ Xc_or)))) @ (^ [Xs1:$i] : XA2)) <=> ((ccv @ Xz) = (ccsb @ XR @ (^ [Xs1:$i] : (XN @ Xs1)))))))))))))))))))))))))))))).
