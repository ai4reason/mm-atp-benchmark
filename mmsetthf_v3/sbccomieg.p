...
thf(csbccomieg_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : ((! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = XA2) => ((XB2 @ Xa @ Xb) = (XC @ Xb))))) => (! [Xb:$i] : ((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xph @ Xa @ Xb)) @ (XB2 @ Xa @ Xb))) @ XA2) <=> (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xa:$i] : (Xph @ Xa @ Xb)) @ XA2)) @ (XC @ Xb)))))))))).
