...
thf(cdvdsn1add_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (((~ (cwbr @ XK @ XM @ ccdvds)) & (cwbr @ XK @ XN @ ccdvds)) => (~ (cwbr @ XK @ (cco @ XM @ XN @ ccaddc) @ ccdvds)))))))).
