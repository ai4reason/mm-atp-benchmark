...
thf(cdivcan8d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (XA2 != ccc0)) => ((Xph => (XB2 != ccc0)) => (Xph => ((cco @ XB2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccdiv) = (cco @ cc1 @ XA2 @ ccdiv))))))))))).
