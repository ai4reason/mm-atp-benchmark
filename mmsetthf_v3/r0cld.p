...
thf(cr0cld_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ (ccfv @ XJ @ cckq) @ cct1) & (cwcel @ XA2 @ XX)) => (cwcel @ (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xo:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xo)) <=> (cwcel @ XA2 @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ))) @ (^ [Xz:$i] : XX)) @ (ccfv @ XJ @ cccld))))))))).
