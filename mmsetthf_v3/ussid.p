...
thf(aussval_thm,axiom,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XU = (ccfv @ XW @ ccunif)) => ((cco @ XU @ (ccxp @ XB2 @ XB2) @ ccrest) = (ccfv @ XW @ ccuss)))))))).
thf(cussid_conj,conjecture,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XU = (ccfv @ XW @ ccunif)) => (((ccxp @ XB2 @ XB2) = (ccuni @ XU)) => (XU = (ccfv @ XW @ ccuss))))))))).
