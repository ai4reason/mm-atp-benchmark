...
thf(afoov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwfo @ (ccxp @ XA2 @ XB2) @ (XC @ Xx3 @ Xy1) @ XF) <=> ((cwf @ (ccxp @ XA2 @ XB2) @ (XC @ Xx3 @ Xy1) @ XF) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1)))))))))))).
...
thf(aisgrpo_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : ((cwcel @ XG @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xu)) => ((cwcel @ XG @ ccgr) <=> ((cwf @ (ccxp @ XX @ XX) @ XX @ XG) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)) & (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) = (ccv @ Xx3)) & (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) = (ccv @ Xu))) @ (^ [Xy1:$i] : XX)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cisgrpda_conj,conjecture,(! [Xph:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XX @ ccvv))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ (ccxp @ XX @ XX) @ XX @ XG))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (((Xph @ Xn) & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX) & (cwcel @ (ccv @ Xz) @ XX))) => ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XU @ XX))) => ((! [Xx3:$i] : (! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xx3) @ XX)) => ((cco @ XU @ (ccv @ Xx3) @ XG) = (ccv @ Xx3))))) => ((! [Xx3:$i] : (! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xx3) @ XX)) => (cwrex @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ (ccv @ Xx3) @ XG) = XU)) @ (^ [Xn:$i] : XX))))) => (! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XG @ ccgr)))))))))))))).
