...
thf(cellimc3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cwcel @ XC @ (cco @ XF @ XB2 @ cclimc)) <=> ((cwcel @ XC @ ccc) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((((ccv @ Xz) != XB2) & (cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XB2 @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ XC @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : ccrp)))))))))))))).
