...
thf(cknoppndvlem12_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (Xph => (((cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) != cc1) & (cwbr @ cc1 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) @ cc1 @ ccmin) @ cclt)))))))))).
