...
thf(cmulnzcnopr_conj,conjecture,(cwf @ (ccxp @ (ccdif @ ccc @ (ccsn @ ccc0)) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ (ccres @ ccmul @ (ccxp @ (ccdif @ ccc @ (ccsn @ ccc0)) @ (ccdif @ ccc @ (ccsn @ ccc0)))))).
