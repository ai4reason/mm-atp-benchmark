...
thf(aisfbas2_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1 @ Xz)) => ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) <=> ((cwss @ XF @ (ccpw @ XB2)) & ((XF != cc0) & (cwnel @ cc0 @ XF) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccv @ Xz) @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : XF))) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF))))))))))))).
thf(crnelfmlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XY @ XA2) & (cwcel @ XL @ (ccfv @ XX @ ccfil)) & (cwf @ XY @ XX @ XF)) & (cwcel @ (ccrn @ XF) @ XL)) => (cwcel @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3))))) @ (ccfv @ XY @ ccfbas))))))))).
