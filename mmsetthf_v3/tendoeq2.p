...
thf(atendoeq1_thm,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ XK @ cclh))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((XE @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => (! [Xf1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xf1))) & ((cwcel @ XU @ (XE @ Xf1)) & (cwcel @ XV @ (XE @ Xf1))) & (cwral @ (^ [Xf1:$i] : ((ccfv @ (ccv @ Xf1) @ XU) = (ccfv @ (ccv @ Xf1) @ XV))) @ (^ [Xf1:$i] : XT))) => (XU = XV)))))))))))))).
thf(ctendoeq2_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ XK @ ccbs))) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XE) & (cwcel @ XV @ XE)) & (cwral @ (^ [Xf1:$i] : (((ccv @ Xf1) != (ccres @ ccid @ (XB2 @ Xf1))) => ((ccfv @ (ccv @ Xf1) @ XU) = (ccfv @ (ccv @ Xf1) @ XV)))) @ (^ [Xf1:$i] : XT))) => (XU = XV))))))))))))))).
