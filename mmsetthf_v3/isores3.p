...
thf(cisores3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (cwss @ XK @ XA2) & (XX = (ccima @ XH @ XK))) => (cwiso @ XK @ XX @ XR @ XS @ (ccres @ XH @ XK))))))))))).
