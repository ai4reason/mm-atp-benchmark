...
thf(celmapresaunres2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XC @ XA2 @ ccmap)) & (cwcel @ XG @ (cco @ XC @ XB2 @ ccmap)) & ((ccres @ XF @ (ccin @ XA2 @ XB2)) = (ccres @ XG @ (ccin @ XA2 @ XB2)))) => ((ccres @ (ccun @ XF @ XG) @ XB2) = XG)))))))).
