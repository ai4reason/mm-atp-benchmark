...
thf(afvconst_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ (ccsn @ XB2) @ XF) & (cwcel @ XC @ XA2)) => ((ccfv @ XC @ XF) = XB2))))))).
...
thf(aistermo_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : ((! [Xh:$i] : ((XB2 @ Xh) = (ccfv @ XC @ ccbs))) => ((! [Xh:$i] : (! [Xb:$i] : ((XH @ Xh @ Xb) = (ccfv @ XC @ cchom)))) => ((! [Xh:$i] : (! [Xb:$i] : ((Xph @ Xh @ Xb) => (cwcel @ XC @ cccat)))) => ((! [Xh:$i] : (! [Xb:$i] : ((Xph @ Xh @ Xb) => (cwcel @ XI @ (XB2 @ Xh))))) => (! [Xh:$i] : (! [Xb:$i] : ((Xph @ Xh @ Xb) => ((cwcel @ XI @ (ccfv @ XC @ cctermo)) <=> (cwral @ (^ [Xb:$i] : (cweu @ (^ [Xh:$i] : (cwcel @ (ccv @ Xh) @ (cco @ (ccv @ Xb) @ XI @ (XH @ Xh @ Xb)))))) @ (^ [Xb:$i] : (XB2 @ Xh))))))))))))))))).
thf(arngccat_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccrngc)) => ((cwcel @ XU @ XV) => (cwcel @ XC @ cccat))))))).
thf(czrtermorngc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr))) => ((Xph => (cwcel @ XZ @ XU)) => (Xph => (cwcel @ XZ @ (ccfv @ XC @ cctermo))))))))))))).
