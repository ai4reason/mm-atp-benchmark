...
thf(cptcmpg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XF @ ccpt)) => ((XX = (ccuni @ XJ)) => (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ cccmp @ XF) & (cwcel @ XX @ (ccin @ ccufl @ (ccdm @ cccrd)))) => (cwcel @ XJ @ cccmp)))))))))).
