...
thf(afallfaccl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XA2 @ XN @ ccfallfac) @ ccc))))).
...
thf(afallfacp1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) = (cco @ (cco @ XA2 @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccmin) @ ccmul)))))).
...
thf(afallfacp1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) = (cco @ (cco @ XA2 @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccmin) @ ccmul))))))))).
...
thf(abinomfallfaclem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph & (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz))) => (cwcel @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ XK @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccaddc) @ ccfallfac) @ ccmul) @ ccmul) @ ccc))))))))))).
...
thf(cbinomfallfaclem2_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((! [Xk:$i] : ((Xps @ Xk) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccfallfac) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul)))))) => (! [Xk:$i] : ((Xph & (Xps @ Xk)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) = (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xk) @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (ccv @ Xk) @ ccfallfac) @ ccmul) @ ccmul)))))))))))))))).
