...
thf(crelexpaddg_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XN @ ccn0) & ((cwcel @ XM @ ccn0) & (cwcel @ XR @ XV) & (((cco @ XN @ XM @ ccaddc) = cc1) => (cwrel @ XR)))) => ((cccom @ (cco @ XR @ XN @ ccrelexp) @ (cco @ XR @ XM @ ccrelexp)) = (cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp)))))))).
