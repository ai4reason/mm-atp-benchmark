...
thf(alcmcom_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ cclcm) = (cco @ XN @ XM @ cclcm)))))).
...
thf(clcmf2a3a4e12_conj,conjecture,((ccfv @ (cctp @ cc2 @ cc3 @ cc4) @ cclcmf) = (ccdc @ cc1 @ cc2))).
