...
thf(asin0_thm,axiom,((ccfv @ ccc0 @ ccsin) = ccc0)).
...
thf(asinkpi_thm,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ ccpi @ ccmul) @ ccsin) = ccc0)))).
