...
thf(cvmalogdivsum_conj,conjecture,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ cc2 @ ccdiv) @ ccmin))) @ cco1)).
