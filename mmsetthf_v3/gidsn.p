...
thf(agrposnOLD_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2)) @ ccgr)))).
...
thf(cgidsn_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccfv @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2)) @ ccgi) = XA2)))).
