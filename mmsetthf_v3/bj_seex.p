...
thf(cbj_seex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (! [Xx3:$i] : (((cwse @ XA2 @ XR) & (cwcel @ (XB2 @ Xx3) @ XA2)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XB2 @ Xx3) @ XR)) @ (^ [Xx3:$i] : XA2)) @ ccvv)))))))).
