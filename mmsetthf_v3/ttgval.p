...
thf(adf_ttg_ax,axiom,(ccttg = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccsb @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xk:$i] : ((cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccsg)) = (cco @ (ccv @ Xk) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccsg)) @ (ccfv @ (ccv @ Xw) @ ccvsca)))) @ (^ [Xk:$i] : (cco @ ccc0 @ cc1 @ ccicc)))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xw) @ ccbs)))))) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xw) @ (ccop @ (ccfv @ ccnx @ ccitv) @ (ccv @ Xi)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ cclng) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xi))) | (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ (ccv @ Xi))) | (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xi))))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xw) @ ccbs))))))) @ ccsts))))))).
