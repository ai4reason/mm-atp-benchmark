...
thf(adf_domn_ax,axiom,(ccdomn = (ccrab @ (^ [Xr:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xr) @ ccmulr)) = (ccv @ Xz)) => (((ccv @ Xx3) = (ccv @ Xz)) | ((ccv @ Xy1) = (ccv @ Xz))))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xr) @ cc0g))) @ (ccfv @ (ccv @ Xr) @ ccbs))) @ (^ [Xr:$i] : ccnzr)))).
thf(cisdomn_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XR @ ccmulr)))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ ccdomn) <=> ((cwcel @ XR @ ccnzr) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) = Xc_0) => (((ccv @ Xx3) = Xc_0) | ((ccv @ Xy1) = Xc_0)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))).
