...
thf(cpsgnsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccsn @ XA2)) => ((XG = (ccfv @ XD @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XD @ ccpsgn)) => (((cwcel @ XA2 @ XV) & (cwcel @ XX @ XB2)) => ((ccfv @ XX @ XN) = cc1)))))))))))))).
