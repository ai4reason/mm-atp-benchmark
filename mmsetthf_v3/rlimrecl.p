...
thf(arlimcld2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => ((Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC @ ccrli)) => ((Xph => (cwss @ XD @ ccc)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (ccdif @ ccc @ XD))) => (cwcel @ (XR @ Xy1) @ ccrp))) => ((! [Xy1:$i] : (! [Xz:$i] : (((Xph & (cwcel @ (ccv @ Xy1) @ (ccdif @ ccc @ XD))) & (cwcel @ (ccv @ Xz) @ XD)) => (cwbr @ (XR @ Xy1) @ (ccfv @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ ccle)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XD))) => (Xph => (cwcel @ XC @ XD))))))))))))))).
...
thf(crlimrecl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => ((Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC @ ccrli)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => (Xph => (cwcel @ XC @ ccr)))))))))).
