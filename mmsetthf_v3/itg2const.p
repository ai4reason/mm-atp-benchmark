...
thf(citg2const_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico))) => ((ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ XB2 @ ccc0))) @ ccitg2) = (cco @ XB2 @ (ccfv @ XA2 @ ccvol) @ ccmul)))))).
