...
thf(cerclwwlknref_conj,conjecture,(! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((XW @ Xx3 @ Xn) = (cco @ XN @ (XG @ Xx3 @ Xu @ Xt @ Xn) @ ccclwwlkn)))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xc_sm @ Xx3 @ Xu @ Xt @ Xn) = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : ((cwcel @ (ccv @ Xt) @ (XW @ Xx3 @ Xn)) & (cwcel @ (ccv @ Xu) @ (XW @ Xx3 @ Xn)) & (cwrex @ (^ [Xn:$i] : ((ccv @ Xt) = (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))) => (! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((cwcel @ (ccv @ Xx3) @ (XW @ Xx3 @ Xn)) <=> (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ (Xc_sm @ Xx3 @ Xu @ Xt @ Xn)))))))))))))).
