...
thf(ciskgen3_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccuni @ XJ))) => ((cwcel @ XJ @ (ccrn @ cckgen)) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : ((cwral @ (^ [Xk:$i] : ((cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp) => (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xk)) @ (cco @ XJ @ (ccv @ Xk) @ ccrest)))) @ (^ [Xk:$i] : (ccpw @ (XX @ Xx3)))) => (cwcel @ (ccv @ Xx3) @ XJ))) @ (^ [Xx3:$i] : (ccpw @ (XX @ Xx3)))))))))).
