...
thf(atmdlactcn_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ Xc_pl))))) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XJ = (ccfv @ XG @ cctopn)) => (! [Xx3:$i] : (((cwcel @ XG @ cctmd) & (cwcel @ XA2 @ XX)) => (cwcel @ (XF @ Xx3) @ (cco @ XJ @ XJ @ cccn))))))))))))))).
