...
thf(adf_vma_ax,axiom,(ccvma = (ccmpt @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccsb @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ (^ [Xs1:$i] : (ccif @ ((ccfv @ (ccv @ Xs1) @ cchash) = cc1) @ (ccfv @ (ccuni @ (ccv @ Xs1)) @ cclog) @ ccc0))))))).
...
thf(cvmaval_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xp:$i] : ((XS @ Xp) = (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)))) => (! [Xp:$i] : ((cwcel @ XA2 @ ccn) => ((ccfv @ XA2 @ ccvma) = (ccif @ ((ccfv @ (XS @ Xp) @ cchash) = cc1) @ (ccfv @ (ccuni @ (XS @ Xp)) @ cclog) @ ccc0)))))))).
