...
thf(ch1dei_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) <=> ((cwcel @ XA2 @ cchil) & (cwral @ (^ [Xx3:$i] : (((cco @ XB2 @ (ccv @ Xx3) @ ccsp) = ccc0) => ((cco @ XA2 @ (ccv @ Xx3) @ ccsp) = ccc0))) @ (^ [Xx3:$i] : cchil)))))))).
