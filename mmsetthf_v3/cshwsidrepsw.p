...
thf(ccshwsidrepsw_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime)) => (((cwcel @ XL @ ccz) & ((cco @ XL @ (ccfv @ XW @ cchash) @ ccmo) != ccc0) & ((cco @ XW @ XL @ cccsh) = XW)) => (XW = (cco @ (ccfv @ ccc0 @ XW) @ (ccfv @ XW @ cchash) @ ccreps)))))))).
