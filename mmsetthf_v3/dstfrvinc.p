...
thf(cdstfrvinc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((! [Xx3:$i] : (Xph => ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ XX @ (ccv @ Xx3) @ (ccorvc @ ccle)) @ XP)))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => (! [Xx3:$i] : (Xph => (cwbr @ (ccfv @ XA2 @ (XF @ Xx3)) @ (ccfv @ XB2 @ (XF @ Xx3)) @ ccle)))))))))))))))).
