...
thf(a_0elcarsg_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XO @ XV)) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => (Xph => (cwcel @ cc0 @ (ccfv @ XM @ cccarsg))))))))))).
thf(aoms0_thm,axiom,(! [Xph:$o] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XR @ ccoms)) => ((Xph => (cwcel @ XQ @ XV)) => ((Xph => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((Xph => (cwcel @ cc0 @ (ccdm @ XR))) => ((Xph => ((ccfv @ cc0 @ XR) = ccc0)) => (Xph => ((ccfv @ cc0 @ XM) = ccc0))))))))))))).
...
thf(aomsmon_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XR @ ccoms)) => ((Xph => (cwcel @ XQ @ XV)) => ((Xph => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwss @ XB2 @ (ccuni @ XQ))) => (Xph => (cwbr @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccle))))))))))))))).
...
thf(acarsggect_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ XO @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => ((! [Xx3:$i] : ((Xph & (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & (cwss @ (ccv @ Xx3) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XM) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XM))) @ ccle))) => ((Xph => (~ (cwcel @ cc0 @ XA2))) => ((Xph => (cwbr @ XA2 @ ccom @ ccdom)) => ((Xph => (cwss @ XA2 @ (ccfv @ XM @ cccarsg))) => ((Xph => (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (ccv @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccle)))) => (Xph => (cwbr @ (ccesum @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xz) @ XM))) @ (ccfv @ (ccuni @ XA2) @ XM) @ ccle))))))))))))))))).
...
thf(comsmeas_conj,conjecture,(! [Xph:$o] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XR @ ccoms)) => ((XS = (ccfv @ XM @ cccarsg)) => ((Xph => (cwcel @ XQ @ XV)) => ((Xph => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((Xph => (cwcel @ cc0 @ (ccdm @ XR))) => ((Xph => ((ccfv @ cc0 @ XR) = ccc0)) => (Xph => (cwcel @ (ccres @ XM @ XS) @ (ccfv @ XS @ ccmeas)))))))))))))))).
