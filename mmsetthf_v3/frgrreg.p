...
thf(anumclwwlk7lem_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr)) & ((XV != cc0) & (cwcel @ XV @ ccfn))) => (cwcel @ XK @ ccn0))))))).
...
thf(arusgr1vtx_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : ((((ccfv @ (ccfv @ XG @ ccvtx) @ cchash) = cc1) & (cwbr @ XG @ XK @ ccrusgr)) => (XK = ccc0))))).
...
thf(avdgn1frgrv3_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfrgr) & (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt)) => (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) != cc1)) @ (^ [Xv:$i] : XV))))))).
...
thf(afrgrreggt1_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfrgr) & (cwcel @ XV @ ccfn) & (XV != cc0)) => (((cwbr @ XG @ XK @ ccrusgr) & (cwbr @ cc1 @ XK @ cclt)) => (XK = cc2)))))))).
thf(a_2a1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (Xch => Xph))))))).
thf(cfrgrreg_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XV @ ccfn) & (XV != cc0)) => (((cwcel @ XG @ ccfrgr) & (cwbr @ XG @ XK @ ccrusgr)) => ((XK = ccc0) | (XK = cc2))))))))).
