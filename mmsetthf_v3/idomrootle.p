...
thf(adeg1sub_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwbr @ (ccfv @ XG @ XD) @ (ccfv @ XF @ XD) @ cclt)) => (Xph => ((ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) = (ccfv @ XF @ XD)))))))))))))))))))).
...
thf(adeg1sclle_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (ccfv @ XP @ ccascl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XK)) => (cwbr @ (ccfv @ (ccfv @ XF @ XA2) @ XD) @ ccc0 @ ccle))))))))))))).
...
thf(adeg1pw_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => (((cwcel @ XR @ ccnzr) & (cwcel @ XF @ ccn0)) => ((ccfv @ (cco @ XF @ XX @ Xc_ex) @ XD) = XF))))))))))))))).
...
thf(cidomrootle_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xy1:$i] : ((Xc_ex @ Xy1) = (ccfv @ (ccfv @ XR @ ccmgp) @ ccmg))) => (((cwcel @ XR @ ccidom) & (cwcel @ XX @ XB2) & (cwcel @ XN @ ccn)) => (cwbr @ (ccfv @ (ccrab @ (^ [Xy1:$i] : ((cco @ XN @ (ccv @ Xy1) @ (Xc_ex @ Xy1)) = XX)) @ (^ [Xy1:$i] : XB2)) @ cchash) @ XN @ ccle)))))))))).
