...
thf(aoppcinv_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XO = (ccfv @ XC @ ccoppc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XI = (ccfv @ XC @ ccinv)) => ((XJ = (ccfv @ XO @ ccinv)) => (Xph => ((cco @ XX @ XY @ XJ) = (cco @ XY @ XX @ XI))))))))))))))))))).
...
thf(coppciso_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XO = (ccfv @ XC @ ccoppc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XI = (ccfv @ XC @ cciso)) => ((XJ = (ccfv @ XO @ cciso)) => (Xph => ((cco @ XX @ XY @ XJ) = (cco @ XY @ XX @ XI))))))))))))))))))).
