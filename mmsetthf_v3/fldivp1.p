...
thf(cfldivp1_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn)) => ((cco @ (ccfv @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccdiv) @ ccfl) @ (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccfl) @ ccmin) = (ccif @ (cwbr @ XN @ (cco @ XM @ cc1 @ ccaddc) @ ccdvds) @ cc1 @ ccc0)))))).
