...
thf(cprsss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (((cwcel @ XK @ ccpreset) & (cwss @ XA2 @ XB2)) => ((ccin @ Xc_le @ (ccxp @ XA2 @ XA2)) = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XA2 @ XA2))))))))))).
