...
thf(csmfid_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XJ @ Xx3) @ ccsalgen))) => ((Xph => (cwss @ XA2 @ ccr)) => (! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))) @ (ccfv @ (XB2 @ Xx3) @ ccsmblfn)))))))))))).
