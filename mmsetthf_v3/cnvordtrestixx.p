...
thf(aiccval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccicc) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccle) & (cwbr @ (ccv @ Xx3) @ XB2 @ ccle))) @ (^ [Xx3:$i] : ccxr))))))).
...
thf(ccnvordtrestixx_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XA2)))) => ((cco @ (ccfv @ ccle @ ccordt) @ XA2 @ ccrest) = (ccfv @ (ccin @ (cccnv @ ccle) @ (ccxp @ XA2 @ XA2)) @ ccordt)))))).
