...
thf(aabvcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => (((cwcel @ XF @ XA2) & (cwcel @ XX @ XB2)) => (cwcel @ (ccfv @ XX @ XF) @ ccr)))))))))).
...
thf(aabvge0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => (((cwcel @ XF @ XA2) & (cwcel @ XX @ XB2)) => (cwbr @ ccc0 @ (ccfv @ XX @ XF) @ ccle)))))))))).
