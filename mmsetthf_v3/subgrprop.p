...
thf(csubgrprop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XS @ ccvtx)) => ((XA2 = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XS @ cciedg)) => ((XB2 = (ccfv @ XG @ cciedg)) => ((XE = (ccfv @ XS @ ccedg)) => ((cwbr @ XS @ XG @ ccsubgr) => ((cwss @ XV @ XA2) & (XI = (ccres @ XB2 @ (ccdm @ XI))) & (cwss @ XE @ (ccpw @ XV))))))))))))))))).
