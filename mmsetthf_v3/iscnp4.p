...
thf(ciscnp4_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon)) & (cwcel @ XP @ XX)) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ (ccv @ Xy1))) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xy1:$i] : (ccfv @ (ccsn @ (ccfv @ XP @ XF)) @ (ccfv @ XK @ ccnei)))))))))))))).
