...
thf(ckmlem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xw:$i] : ((! [Xx3:$i] : (((cwral @ (^ [Xz:$i] : ((ccv @ Xz) != cc0)) @ (^ [Xz:$i] : (ccv @ Xx3))) & (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (Xph @ Xz @ Xw)) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3)))) => (? [Xy1:$i] : (cwral @ (^ [Xz:$i] : (Xps @ Xy1 @ Xz @ Xw)) @ (^ [Xz:$i] : (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (Xph @ Xz @ Xw)) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3))) => (? [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((ccv @ Xz) != cc0) => (Xps @ Xy1 @ Xz @ Xw))) @ (^ [Xz:$i] : (ccv @ Xx3))))))))))).
