...
thf(afaeval_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XR @ ccvv) & (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((cco @ XR @ XM @ ccfae) = (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (((cwcel @ (ccv @ Xf1) @ (cco @ (ccdm @ XR) @ (ccuni @ (ccdm @ XM)) @ ccmap)) & (cwcel @ (ccv @ Xg1) @ (cco @ (ccdm @ XR) @ (ccuni @ (ccdm @ XM)) @ ccmap))) & (cwbr @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ XR)) @ (^ [Xx3:$i] : (ccuni @ (ccdm @ XM)))) @ XM @ ccae)))))))))).
