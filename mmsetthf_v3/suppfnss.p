...
thf(csuppfnss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : (! [Xx3:$i] : ((((cwfn @ XF @ XA2) & (cwfn @ XG @ (XB2 @ Xx3))) & ((cwss @ XA2 @ (XB2 @ Xx3)) & (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)) & (cwcel @ XZ @ (XW @ Xx3)))) => ((cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ XG) = XZ) => ((ccfv @ (ccv @ Xx3) @ XF) = XZ))) @ (^ [Xx3:$i] : XA2)) => (cwss @ (cco @ XF @ XZ @ ccsupp) @ (cco @ XG @ XZ @ ccsupp))))))))))))).
