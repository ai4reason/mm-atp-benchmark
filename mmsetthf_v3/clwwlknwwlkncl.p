...
thf(cclwwlknwwlkncl_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) => (cwcel @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat) @ (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cclsw) = (ccfv @ ccc0 @ (ccv @ Xw)))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))))))).
