...
thf(aaxlowdimlem9_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => (((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) & (XK != cc3)) => ((ccfv @ XK @ XP) = ccc0))))))).
...
thf(aaxlowdimlem12_thm,axiom,(! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) & (XK != (cco @ XI @ cc1 @ ccaddc))) => ((ccfv @ XK @ XQ) = ccc0)))))))).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(aaxlowdimlem16_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & (cwcel @ XI @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((ccsu @ (cco @ cc3 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ cc2 @ ccexp))) = (ccsu @ (cco @ cc3 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ cc2 @ ccexp)))))))))))).
...
thf(aaxlowdimlem7_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) => (cwcel @ XP @ (ccfv @ XN @ ccee))))))).
...
thf(aaxlowdimlem10_thm,axiom,(! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => (cwcel @ XQ @ (ccfv @ XN @ ccee)))))))).
...
thf(caxlowdimlem17_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => ((XA2 = (ccun @ (ccpr @ (ccop @ cc1 @ XX) @ (ccop @ cc2 @ XY)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0)))) => ((cwcel @ XX @ ccr) => ((cwcel @ XY @ ccr) => (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & (cwcel @ XI @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => (cwbr @ (ccop @ XP @ XA2) @ (ccop @ XQ @ XA2) @ cccgr))))))))))))))).
