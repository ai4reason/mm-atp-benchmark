...
thf(arhmsubclem3_thm,axiom,(! [Xph:$o] : (! [Xx3:$i] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => ((Xph & (cwcel @ (ccv @ Xx3) @ XR)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccfv @ XU @ ccrngc) @ cccid)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XH))))))))))))))).
...
thf(arhmsubclem4_thm,axiom,(! [Xph:$o] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xf1:$i] : (! [Xg1:$i] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => ((((Xph & (cwcel @ (ccv @ Xx3) @ XR)) & ((cwcel @ (ccv @ Xy1) @ XR) & (cwcel @ (ccv @ Xz) @ XR))) & ((cwcel @ (ccv @ Xf1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)) & (cwcel @ (ccv @ Xg1) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XH)))) => (cwcel @ (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ (ccfv @ (ccfv @ XU @ ccrngc) @ ccco))) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XH))))))))))))))))))).
...
thf(arhmsubclem1_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => (Xph => (cwfn @ XH @ (ccxp @ XR @ XR)))))))))))))).
thf(crhmsubc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => (Xph => (cwcel @ XH @ (ccfv @ (ccfv @ XU @ ccrngc) @ ccsubc)))))))))))))).
