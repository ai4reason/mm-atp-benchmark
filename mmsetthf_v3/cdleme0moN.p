...
thf(ccdleme0moN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xr:$i] : ((Xc_le @ Xr) = (ccfv @ (XK @ Xr) @ ccple))) => ((! [Xr:$i] : (Xc_or = (ccfv @ (XK @ Xr) @ ccjn))) => ((! [Xr:$i] : ((Xc_an @ Xr) = (ccfv @ (XK @ Xr) @ ccmee))) => ((! [Xr:$i] : (XA2 = (ccfv @ (XK @ Xr) @ ccatm))) => ((! [Xr:$i] : ((XH @ Xr) = (ccfv @ (XK @ Xr) @ cclh))) => ((! [Xr:$i] : (XU = (cco @ (cco @ XP @ XQ @ Xc_or) @ (XW @ Xr) @ (Xc_an @ Xr)))) => (! [Xr:$i] : ((((cwcel @ (XK @ Xr) @ cchlt) & (cwcel @ (XW @ Xr) @ (XH @ Xr))) & (((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ (XW @ Xr) @ (Xc_le @ Xr)))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ (XW @ Xr) @ (Xc_le @ Xr)))) & ((cwcel @ XR @ XA2) & (~ (cwbr @ XR @ (XW @ Xr) @ (Xc_le @ Xr))))) & ((XP != XQ) & (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ (Xc_le @ Xr)) & (cwmo @ (^ [Xr:$i] : ((cwcel @ (ccv @ Xr) @ XA2) & ((cco @ XP @ (ccv @ Xr) @ Xc_or) = (cco @ XQ @ (ccv @ Xr) @ Xc_or))))))) => ((XR = XP) | (XR = XQ)))))))))))))))))))))).
