...
thf(cleaddsuble_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwbr @ XB2 @ XC @ ccle) <=> (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccmin) @ XA2 @ ccle))))))).
