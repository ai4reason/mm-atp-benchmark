...
thf(cpcoptcl_conj,conjecture,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ XY))) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XY @ XX)) => ((cwcel @ XP @ (cco @ ccii @ XJ @ cccn)) & ((ccfv @ ccc0 @ XP) = XY) & ((ccfv @ cc1 @ XP) = XY))))))))).
