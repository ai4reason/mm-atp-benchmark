...
thf(asadeq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn0)) => ((Xph => (cwss @ XB2 @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((ccin @ (cco @ XA2 @ XB2 @ ccsad) @ (cco @ ccc0 @ XN @ ccfzo)) = (ccin @ (cco @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccin @ XB2 @ (cco @ ccc0 @ XN @ ccfzo)) @ ccsad) @ (cco @ ccc0 @ XN @ ccfzo)))))))))))).
...
thf(csmueqlem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwss @ XA2 @ ccn0)))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwss @ XB2 @ ccn0)))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ XN @ ccn0)))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XP @ Xm @ Xn @ Xp) = (ccseq @ (ccmpt2 @ (^ [Xp:$i] : (^ [Xm:$i] : (ccpw @ ccn0))) @ (^ [Xp:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xp:$i] : (^ [Xm:$i] : (cco @ (ccv @ Xp) @ (ccrab @ (^ [Xn:$i] : ((cwcel @ (ccv @ Xm) @ XA2) & (cwcel @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccmin) @ XB2))) @ (^ [Xn:$i] : ccn0)) @ ccsad)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XQ @ Xm @ Xn @ Xp) = (ccseq @ (ccmpt2 @ (^ [Xp:$i] : (^ [Xm:$i] : (ccpw @ ccn0))) @ (^ [Xp:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xp:$i] : (^ [Xm:$i] : (cco @ (ccv @ Xp) @ (ccrab @ (^ [Xn:$i] : ((cwcel @ (ccv @ Xm) @ XA2) & (cwcel @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccmin) @ (ccin @ XB2 @ (cco @ ccc0 @ XN @ ccfzo))))) @ (^ [Xn:$i] : ccn0)) @ ccsad)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => ((ccin @ (cco @ XA2 @ XB2 @ ccsmu) @ (cco @ ccc0 @ XN @ ccfzo)) = (ccin @ (cco @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccin @ XB2 @ (cco @ ccc0 @ XN @ ccfzo)) @ ccsmu) @ (cco @ ccc0 @ XN @ ccfzo)))))))))))))))))).
