...
thf(cltlecasei_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((Xph & (cwbr @ XA2 @ XB2 @ cclt)) => Xps) => (((Xph & (cwbr @ XB2 @ XA2 @ ccle)) => Xps) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => Xps)))))))))).
