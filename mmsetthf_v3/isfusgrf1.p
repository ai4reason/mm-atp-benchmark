...
thf(cisfusgrf1_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : ((cwcel @ XG @ XW) => ((cwcel @ XG @ ccfusgr) <=> ((cwf1 @ (ccdm @ (XI @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (XI @ Xx3)) & (cwcel @ XV @ ccfn)))))))))))).
