...
thf(citg2seq_conj,conjecture,(! [XF:($i > $o)] : ((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) => (? [Xg1:$i] : ((cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) & (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ XF @ (ccofr @ ccle))) @ (^ [Xn:$i] : ccn)) & ((ccfv @ XF @ ccitg2) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ ccitg1)))) @ ccxr @ cclt))))))).
