...
thf(ccnsrexpcl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ ccn0)) => (Xph => (cwcel @ (cco @ XX @ XY @ ccexp) @ XS)))))))))).
