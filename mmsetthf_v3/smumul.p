...
thf(asmumullem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (ccin @ (ccfv @ XA2 @ ccbits) @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccfv @ XB2 @ ccbits) @ ccsmu) = (ccfv @ (cco @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccmo) @ XB2 @ ccmul) @ ccbits))))))))))).
...
thf(asmueq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn0)) => ((Xph => (cwss @ XB2 @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((ccin @ (cco @ XA2 @ XB2 @ ccsmu) @ (cco @ ccc0 @ XN @ ccfzo)) = (ccin @ (cco @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccin @ XB2 @ (cco @ ccc0 @ XN @ ccfzo)) @ ccsmu) @ (cco @ ccc0 @ XN @ ccfzo)))))))))))).
...
thf(csmumul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XB2 @ ccbits) @ ccsmu) = (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccbits)))))).
