...
thf(ceqsqrt2d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = XB2)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) => (Xph => (XA2 = (ccfv @ XB2 @ ccsqrt))))))))))).
