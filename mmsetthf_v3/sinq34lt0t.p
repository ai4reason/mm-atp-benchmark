...
thf(aiooshf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr))) => ((cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccioo)) <=> (cwcel @ XA2 @ (cco @ (cco @ XC @ XB2 @ ccaddc) @ (cco @ XD @ XB2 @ ccaddc) @ ccioo))))))))).
...
thf(asinmpi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ XA2 @ ccpi @ ccmin) @ ccsin) = (ccneg @ (ccfv @ XA2 @ ccsin)))))).
...
thf(csinq34lt0t_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccpi @ (cco @ cc2 @ ccpi @ ccmul) @ ccioo)) => (cwbr @ (ccfv @ XA2 @ ccsin) @ ccc0 @ cclt)))).
