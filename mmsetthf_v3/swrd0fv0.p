...
thf(cswrd0fv0_conj,conjecture,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XI @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ ccc0 @ (cco @ XW @ (ccop @ ccc0 @ XI) @ ccsubstr)) = (ccfv @ ccc0 @ XW))))))).
