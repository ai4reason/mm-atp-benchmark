...
thf(crmxyadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (((cco @ XA2 @ (cco @ XM @ XN @ ccaddc) @ ccrmx) = (cco @ (cco @ (cco @ XA2 @ XM @ ccrmx) @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmul) @ ccaddc)) & ((cco @ XA2 @ (cco @ XM @ XN @ ccaddc) @ ccrmy) = (cco @ (cco @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ (cco @ XA2 @ XM @ ccrmx) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccaddc)))))))).
