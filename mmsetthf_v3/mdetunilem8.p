...
thf(amdetunilem2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (XA2 = (cco @ XN @ (XR @ Xa @ Xb) @ ccmat)))) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : (XK = (ccfv @ (XR @ Xa @ Xb) @ ccbs)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_0 = (ccfv @ (XR @ Xa @ Xb) @ cc0g)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_1 = (ccfv @ (XR @ Xa @ Xb) @ ccur)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_pl = (ccfv @ (XR @ Xa @ Xb) @ ccplusg)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xa @ Xb) = (ccfv @ (XR @ Xa @ Xb) @ ccmulr)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XR @ Xa @ Xb) @ ccrg)))) => ((Xph => (cwf @ XB2 @ XK @ XD)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((((ccv @ Xy1) != (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xw) @ (ccv @ Xx3)) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xx3)))) @ (^ [Xw:$i] : XN))) => ((ccfv @ (ccv @ Xx3) @ XD) = Xc_0))) @ (^ [Xz:$i] : XN))) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccres @ (ccv @ Xy1) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_pl))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xy1) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccfv @ (ccv @ Xy1) @ XD) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_pl)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN) @ (ccsn @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ (Xc_x @ Xa @ Xb)))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XD) @ (Xc_x @ Xa @ Xb))))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XB2))))) => ((Xps => Xph) => ((Xps => ((cwcel @ XE @ XN) & (cwcel @ XG @ XN) & (XE != XG))) => ((! [Xb:$i] : ((Xps & (cwcel @ (ccv @ Xb) @ XN)) => (cwcel @ (XF @ Xb) @ XK))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xps & (cwcel @ (ccv @ Xa) @ XN) & (cwcel @ (ccv @ Xb) @ XN)) => (cwcel @ (XH @ Xa @ Xb) @ XK)))) => (Xps => ((ccfv @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xa) = XE) @ (XF @ Xb) @ (ccif @ ((ccv @ Xa) = XG) @ (XF @ Xb) @ (XH @ Xa @ Xb)))))) @ XD) = Xc_0)))))))))))))))))))))))))))))))))))).
...
thf(cmdetunilem8_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (XA2 = (cco @ XN @ (XR @ Xa @ Xb) @ ccmat)))) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : (XK = (ccfv @ (XR @ Xa @ Xb) @ ccbs)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_0 = (ccfv @ (XR @ Xa @ Xb) @ cc0g)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_1 = (ccfv @ (XR @ Xa @ Xb) @ ccur)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_pl = (ccfv @ (XR @ Xa @ Xb) @ ccplusg)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xa @ Xb) = (ccfv @ (XR @ Xa @ Xb) @ ccmulr)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XR @ Xa @ Xb) @ ccrg)))) => ((Xph => (cwf @ XB2 @ XK @ XD)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((((ccv @ Xy1) != (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xw) @ (ccv @ Xx3)) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xx3)))) @ (^ [Xw:$i] : XN))) => ((ccfv @ (ccv @ Xx3) @ XD) = Xc_0))) @ (^ [Xz:$i] : XN))) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccres @ (ccv @ Xy1) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_pl))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xy1) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccfv @ (ccv @ Xy1) @ XD) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_pl)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN) @ (ccsn @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ (Xc_x @ Xa @ Xb)))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XD) @ (Xc_x @ Xa @ Xb))))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XB2))))) => ((Xph => ((ccfv @ (ccfv @ XA2 @ ccur) @ XD) = Xc_0)) => ((Xph & (cwf @ XN @ XN @ XE)) => ((ccfv @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccfv @ (ccv @ Xa) @ XE) = (ccv @ Xb)) @ Xc_1 @ Xc_0)))) @ XD) = Xc_0))))))))))))))))))))))))))))).
