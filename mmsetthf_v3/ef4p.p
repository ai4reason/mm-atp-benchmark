...
thf(aefval2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cce) = (ccsu @ ccn0 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn))))))))))).
...
thf(aeft0val_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (cco @ XA2 @ ccc0 @ ccexp) @ (ccfv @ ccc0 @ ccfa) @ ccdiv) = cc1)))).
...
thf(cef4p_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cce) = (cco @ (cco @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccaddc) @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc6 @ ccdiv) @ ccaddc) @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccaddc)))))))).
