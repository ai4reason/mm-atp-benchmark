...
thf(aisercolllem1_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwf @ ccn @ (XZ @ Xk) @ XG))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt))) => (! [Xk:$i] : ((Xph & (cwss @ (XS @ Xk) @ ccn)) => (cwiso @ (XS @ Xk) @ (ccima @ XG @ (XS @ Xk)) @ cclt @ cclt @ (ccres @ XG @ (XS @ Xk))))))))))))))).
...
thf(aisercolllem3_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwf @ ccn @ (XZ @ Xk) @ XG))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccdif @ (XZ @ Xk) @ (ccrn @ XG)))) => ((ccfv @ (ccv @ Xn) @ XF) = ccc0)))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (XZ @ Xk))) => (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => ((ccfv @ (ccv @ Xk) @ XH) = (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ XF)))) => ((Xph & (cwcel @ XN @ (ccfv @ (ccfv @ cc1 @ XG) @ ccuz))) => ((ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) = (ccfv @ (ccfv @ (ccima @ XG @ (ccima @ (cccnv @ XG) @ (cco @ XM @ XN @ ccfz))) @ cchash) @ (ccseq @ ccaddc @ XH @ cc1))))))))))))))))))).
thf(cisercoll_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwf @ ccn @ (XZ @ Xk) @ XG))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccdif @ (XZ @ Xk) @ (ccrn @ XG)))) => ((ccfv @ (ccv @ Xn) @ XF) = ccc0)))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (XZ @ Xk))) => (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => ((ccfv @ (ccv @ Xk) @ XH) = (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ XF)))) => (Xph => ((cwbr @ (ccseq @ ccaddc @ XH @ cc1) @ XA2 @ ccli) <=> (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ XA2 @ ccli)))))))))))))))))).
