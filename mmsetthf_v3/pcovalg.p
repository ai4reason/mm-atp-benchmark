...
thf(cpcovalg_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((Xph & (cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccicc))) => ((ccfv @ XX @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) = (ccif @ (cwbr @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (ccfv @ (cco @ cc2 @ XX @ ccmul) @ XF) @ (ccfv @ (cco @ (cco @ cc2 @ XX @ ccmul) @ cc1 @ ccmin) @ XG)))))))))))).
