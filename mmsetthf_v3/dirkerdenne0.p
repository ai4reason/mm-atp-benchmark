...
thf(cdirkerdenne0_conj,conjecture,(! [XS:($i > $o)] : (((cwcel @ XS @ ccr) & (~ ((cco @ XS @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0))) => ((cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ XS @ cc2 @ ccdiv) @ ccsin) @ ccmul) != ccc0)))).
