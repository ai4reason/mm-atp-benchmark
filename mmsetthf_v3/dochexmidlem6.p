...
thf(adihoml4_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XS = (ccfv @ XU @ cclss)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => ((Xph => ((ccfv @ (ccfv @ XY @ Xc_pe) @ Xc_pe) = XY)) => ((Xph => (cwss @ XX @ XY)) => (Xph => ((ccin @ (ccfv @ (ccin @ (ccfv @ XX @ Xc_pe) @ XY) @ Xc_pe) @ XY) = (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe)))))))))))))))))))))).
