...
thf(cseqshft2_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XK @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => ((ccfv @ (ccv @ Xk) @ XF) = (ccfv @ (cco @ (ccv @ Xk) @ XK @ ccaddc) @ XG)))) => (! [Xk:$i] : (Xph => ((ccfv @ XN @ (ccseq @ (Xc_pl @ Xk) @ XF @ XM)) = (ccfv @ (cco @ XN @ XK @ ccaddc) @ (ccseq @ (Xc_pl @ Xk) @ XG @ (cco @ XM @ XK @ ccaddc))))))))))))))))).
