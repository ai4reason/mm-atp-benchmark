...
thf(celimifd_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (((ccif @ Xps @ XA2 @ XB2) = XA2) => (Xch <=> Xth))) => ((Xph => (((ccif @ Xps @ XA2 @ XB2) = XB2) => (Xch <=> Xta))) => (Xph => (Xch <=> ((Xps & Xth) | ((~ Xps) & Xta)))))))))))))).
