...
thf(csubumgredg2_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xe:$i] : (XV = (ccfv @ (XS @ Xe) @ ccvtx))) => ((! [Xe:$i] : (XI = (ccfv @ (XS @ Xe) @ cciedg))) => (! [Xe:$i] : (((cwbr @ (XS @ Xe) @ (XG @ Xe) @ ccsubgr) & (cwcel @ (XG @ Xe) @ ccumgr) & (cwcel @ XX @ (ccdm @ XI))) => (cwcel @ (ccfv @ XX @ XI) @ (ccrab @ (^ [Xe:$i] : ((ccfv @ (ccv @ Xe) @ cchash) = cc2)) @ (^ [Xe:$i] : (ccpw @ XV)))))))))))))).
