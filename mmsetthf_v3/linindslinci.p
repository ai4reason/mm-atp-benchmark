...
thf(clinindslinci_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ XM @ ccbs))) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XM @ cc0g))) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccfv @ XM @ ccsca))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ (XR @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ (XR @ Xx3) @ cc0g))) => (! [Xx3:$i] : (((cwbr @ XS @ XM @ cclininds) & ((cwcel @ XF @ (cco @ (XE @ Xx3) @ XS @ ccmap)) & (cwbr @ XF @ (Xc_0 @ Xx3) @ ccfsupp) & ((cco @ XF @ XS @ (ccfv @ XM @ cclinc)) = (XZ @ Xx3)))) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (Xc_0 @ Xx3))) @ (^ [Xx3:$i] : XS)))))))))))))))))).
