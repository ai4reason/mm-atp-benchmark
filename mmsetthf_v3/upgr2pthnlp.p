...
thf(a_2pthnloop_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ cclt)) => (cwral @ (^ [Xi:$i] : (cwbr @ cc2 @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XI) @ cchash) @ ccle)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
...
thf(cupgr2pthnlp_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccupgr) & (cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ cclt)) => (cwral @ (^ [Xi:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XI) @ cchash) = cc2)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
