...
thf(csoltmin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ XR) @ XB2 @ XC) @ XR) <=> ((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XA2 @ XC @ XR)))))))))).
