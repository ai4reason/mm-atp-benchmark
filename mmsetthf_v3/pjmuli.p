...
thf(cpjmuli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ cchil)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccsm) @ (ccfv @ XH @ ccpjh)) = (cco @ XA2 @ (ccfv @ XB2 @ (ccfv @ XH @ ccpjh)) @ ccsm)))))))).
