...
thf(cbnj1109_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((? [Xx3:$i] : ((((XA2 @ Xx3) != (XB2 @ Xx3)) & (Xph @ Xx3)) => (Xps @ Xx3))) => ((! [Xx3:$i] : ((((XA2 @ Xx3) = (XB2 @ Xx3)) & (Xph @ Xx3)) => (Xps @ Xx3))) => (? [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3)))))))))).
