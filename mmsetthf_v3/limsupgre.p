...
thf(climsupgre_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => ((XZ = (ccfv @ XM @ ccuz)) => (! [Xk:$i] : (((cwcel @ XM @ ccz) & (cwf @ XZ @ ccr @ XF) & (cwbr @ (ccfv @ XF @ cclsp) @ ccpnf @ cclt)) => (cwf @ ccr @ ccr @ (XG @ Xk))))))))))).
