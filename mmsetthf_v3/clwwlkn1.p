...
thf(cclwwlkn1_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ cc1 @ XG @ ccclwwlkn)) <=> (((ccfv @ XW @ cchash) = cc1) & (cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) & (cwcel @ (ccsn @ (ccfv @ ccc0 @ XW)) @ (ccfv @ XG @ ccedg))))))).
