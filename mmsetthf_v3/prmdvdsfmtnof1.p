...
thf(ainfexd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwor @ XA2 @ XR)) => (Xph => (cwcel @ (ccinf @ XB2 @ XA2 @ XR) @ ccvv)))))))).
...
thf(cprmdvdsfmtnof1_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XF @ Xf1 @ Xp) = (ccmpt @ (^ [Xf1:$i] : (ccrn @ ccfmtno)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xf1) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt)))))) => (! [Xf1:$i] : (! [Xp:$i] : (cwf1 @ (ccrn @ ccfmtno) @ ccprime @ (XF @ Xf1 @ Xp))))))).
