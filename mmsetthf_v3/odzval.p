...
thf(codzval_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) => ((ccfv @ XA2 @ (ccfv @ XN @ ccodz)) = (ccinf @ (ccrab @ (^ [Xn:$i] : (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ cc1 @ ccmin) @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
