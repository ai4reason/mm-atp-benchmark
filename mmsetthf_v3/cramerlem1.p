...
thf(acramerimp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((XE = (ccfv @ XI @ (cco @ (ccfv @ XA2 @ ccur) @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((XH = (ccfv @ XI @ (cco @ XX @ XY @ (cco @ XN @ XR @ ccmatrepV)))) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((((cwcel @ XR @ cccrg) & (cwcel @ XI @ XN)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV)) & (((cco @ XX @ XZ @ Xc_x) = XY) & (cwcel @ (ccfv @ XX @ XD) @ (ccfv @ XR @ ccui)))) => ((ccfv @ XI @ XZ) = (cco @ (ccfv @ XH @ XD) @ (ccfv @ XX @ XD) @ Xc_dv)))))))))))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(afnmptfvd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwfn @ XM @ XA2)) => ((! [Xi:$i] : (! [Xa:$i] : (((ccv @ Xi) = (ccv @ Xa)) => ((XD @ Xi) = (XC @ Xa))))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XA2)) => (cwcel @ (XD @ Xi) @ XU))) => ((! [Xa:$i] : ((Xph & (cwcel @ (ccv @ Xa) @ XA2)) => (cwcel @ (XC @ Xa) @ XV))) => (Xph => ((XM = (ccmpt @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (XC @ Xa)))) <=> (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XM) = (XD @ Xi))) @ (^ [Xi:$i] : XA2)))))))))))))))).
