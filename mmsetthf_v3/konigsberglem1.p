...
thf(avdegp1bi_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (XV = (ccfv @ (XG @ Xx3) @ ccvtx))) => ((cwcel @ XU @ XV) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwcel @ (XI @ Xx3) @ (ccword @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0))))))) => ((! [Xx3:$i] : ((ccfv @ XU @ (ccfv @ (XG @ Xx3) @ ccvtxdg)) = (XP @ Xx3))) => ((! [Xx3:$i] : ((ccfv @ (XF @ Xx3) @ ccvtx) = XV)) => ((cwcel @ XX @ XV) => ((XX != XU) => ((! [Xx3:$i] : ((ccfv @ (XF @ Xx3) @ cciedg) = (cco @ (XI @ Xx3) @ (ccs1 @ (ccpr @ XU @ XX)) @ ccconcat))) => (! [Xx3:$i] : ((ccfv @ XU @ (ccfv @ (XF @ Xx3) @ ccvtxdg)) = (cco @ (XP @ Xx3) @ cc1 @ ccaddc)))))))))))))))))))).
...
thf(ckonigsberglem1_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => ((ccfv @ ccc0 @ (ccfv @ XG @ ccvtxdg)) = cc3)))))))).
