...
thf(ainfpssrlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwss @ XB2 @ XA2)) => ((Xph => (cwf1o @ XB2 @ XA2 @ XF)) => ((Xph => (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((XG = (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => (Xph => (cwf @ ccom @ XA2 @ XG))))))))))))).
...
thf(ainfpssrlem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XB2 @ XA2)) => ((Xph => (cwf1o @ XB2 @ XA2 @ XF)) => ((Xph => (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((XG = (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => ((Xph & (cwcel @ XM @ ccom) & (cwcel @ XN @ XM)) => ((ccfv @ XM @ XG) != (ccfv @ XN @ XG)))))))))))))))).
...
thf(cinfpssrlem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwss @ XB2 @ XA2)) => ((Xph => (cwf1o @ XB2 @ XA2 @ XF)) => ((Xph => (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((XG = (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => (Xph => ((cwcel @ XA2 @ XV) => (cwbr @ ccom @ XA2 @ ccdom))))))))))))))).
