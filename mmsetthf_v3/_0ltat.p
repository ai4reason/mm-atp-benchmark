...
thf(c_0ltat_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XK @ ccp0)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ ccops) & (cwcel @ XP @ XA2)) => (cwbr @ Xc_0 @ XP @ Xc_lt))))))))))).
