...
thf(arspcedeq1vd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((XC @ Xx3) = XD))) => (Xph => (cwrex @ (^ [Xx3:$i] : ((XC @ Xx3) = XD)) @ (^ [Xx3:$i] : XB2))))))))))).
