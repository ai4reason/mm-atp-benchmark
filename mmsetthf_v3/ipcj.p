...
thf(cipcj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_as = (ccfv @ XF @ ccstv)) => (((cwcel @ XW @ ccphl) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_xi) @ Xc_as) = (cco @ XB2 @ XA2 @ Xc_xi))))))))))))))).
