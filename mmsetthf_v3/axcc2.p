...
thf(aaxcc2lem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : ((XK @ Xf1 @ Xg1) = (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccif @ ((ccfv @ (ccv @ Xn) @ (XF @ Xn)) = cc0) @ (ccsn @ cc0) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XA2 @ Xg1) = (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccxp @ (ccsn @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xn) @ (XK @ Xf1 @ Xg1)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XG @ Xf1) = (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xg1)) @ (ccv @ Xf1)) @ cc2nd)))))) => (? [Xg1:$i] : ((cwfn @ (ccv @ Xg1) @ ccom) & (cwral @ (^ [Xn:$i] : (((ccfv @ (ccv @ Xn) @ (XF @ Xn)) != cc0) => (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))))) @ (^ [Xn:$i] : ccom)))))))))))).
...
thf(caxcc2_conj,conjecture,(! [XF:($i > $o)] : (? [Xg1:$i] : ((cwfn @ (ccv @ Xg1) @ ccom) & (cwral @ (^ [Xn:$i] : (((ccfv @ (ccv @ Xn) @ XF) != cc0) => (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xn) @ XF)))) @ (^ [Xn:$i] : ccom)))))).
