...
thf(cdvhvscacl_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_x = (ccfv @ XU @ ccvsca)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XR @ XE) & (cwcel @ XF @ (ccxp @ XT @ XE)))) => (cwcel @ (cco @ XR @ XF @ Xc_x) @ (ccxp @ XT @ XE)))))))))))))))))).
