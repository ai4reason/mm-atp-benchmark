...
thf(aitgvallem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [Xk:$i] : (! [XK:($i > $o)] : ((! [Xx3:$i] : ((cco @ cci @ XK @ ccexp) = (XT @ Xx3))) => (((ccv @ Xk) = XK) => ((ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwbr @ ccc0 @ (ccfv @ (cco @ (XB2 @ Xx3) @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccre) @ ccle)) @ (ccfv @ (cco @ (XB2 @ Xx3) @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccre) @ ccc0))) @ ccitg2) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwbr @ ccc0 @ (ccfv @ (cco @ (XB2 @ Xx3) @ (XT @ Xx3) @ ccdiv) @ ccre) @ ccle)) @ (ccfv @ (cco @ (XB2 @ Xx3) @ (XT @ Xx3) @ ccdiv) @ ccre) @ ccc0))) @ ccitg2)))))))))).
...
thf(ciblcnlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : ((! [Xx3:$i] : ((XR @ Xx3) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ ccc0 @ (ccfv @ (XB2 @ Xx3) @ ccre) @ ccle)) @ (ccfv @ (XB2 @ Xx3) @ ccre) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ ccc0 @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccre)) @ ccle)) @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccre)) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : ((XT @ Xx3) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ ccc0 @ (ccfv @ (XB2 @ Xx3) @ ccim) @ ccle)) @ (ccfv @ (XB2 @ Xx3) @ ccim) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ ccc0 @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccim)) @ ccle)) @ (ccneg @ (ccfv @ (XB2 @ Xx3) @ ccim)) @ ccc0))) @ ccitg2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => (! [Xx3:$i] : (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl) <=> ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmbf) & ((cwcel @ (XR @ Xx3) @ ccr) & (cwcel @ (XS @ Xx3) @ ccr)) & ((cwcel @ (XT @ Xx3) @ ccr) & (cwcel @ (XU @ Xx3) @ ccr))))))))))))))))))).
