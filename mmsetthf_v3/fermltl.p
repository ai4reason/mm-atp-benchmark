...
thf(advdsmodexp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XB2 @ ccn) & (cwbr @ XN @ XA2 @ ccdvds)) => ((cco @ (cco @ XA2 @ XB2 @ ccexp) @ XN @ ccmo) = (cco @ XA2 @ XN @ ccmo))))))).
...
thf(cfermltl_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz)) => ((cco @ (cco @ XA2 @ XP @ ccexp) @ XP @ ccmo) = (cco @ XA2 @ XP @ ccmo)))))).
