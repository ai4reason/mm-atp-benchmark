...
thf(apcgcd1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle)) => ((cco @ XP @ (cco @ XA2 @ XB2 @ ccgcd) @ ccpc) = (cco @ XP @ XA2 @ ccpc))))))).
...
thf(cpcgcd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ XP @ (cco @ XA2 @ XB2 @ ccgcd) @ ccpc) = (ccif @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle) @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc)))))))).
