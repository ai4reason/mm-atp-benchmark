...
thf(aaxtgcgrid_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwcel @ XZ @ XP)) => ((Xph => ((cco @ XX @ XY @ Xc_mi) = (cco @ XZ @ XZ @ Xc_mi))) => (Xph => (XX = XY))))))))))))))))))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(atgcgrsub_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XE @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => (cwcel @ XE @ (cco @ XD @ XF @ XI))) => ((Xph => ((cco @ XA2 @ XC @ Xc_mi) = (cco @ XD @ XF @ Xc_mi))) => ((Xph => ((cco @ XB2 @ XC @ Xc_mi) = (cco @ XE @ XF @ Xc_mi))) => (Xph => ((cco @ XA2 @ XB2 @ Xc_mi) = (cco @ XD @ XE @ Xc_mi))))))))))))))))))))))))))))).
...
thf(atgellng_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XL = (ccfv @ XG @ cclng)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (XX != XY)) => ((Xph => (cwcel @ XZ @ XP)) => (Xph => ((cwcel @ XZ @ (cco @ XX @ XY @ XL)) <=> ((cwcel @ XZ @ (cco @ XX @ XY @ XI)) | (cwcel @ XX @ (cco @ XZ @ XY @ XI)) | (cwcel @ XY @ (cco @ XX @ XZ @ XI)))))))))))))))))))))).
thf(ccolmid_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((XM = (ccfv @ XX @ XS)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ XL)) | (XA2 = XB2))) => ((Xph => ((cco @ XX @ XA2 @ Xc_mi) = (cco @ XX @ XB2 @ Xc_mi))) => (Xph => ((XB2 = (ccfv @ XA2 @ XM)) | (XA2 = XB2))))))))))))))))))))))))))).
