...
thf(acdlemj1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xg1:$i] : (! [Xh:$i] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xp:$i] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XE) & (cwcel @ XV @ XE) & ((ccfv @ XF @ XU) = (ccfv @ XF @ XV))) & ((cwcel @ XF @ XT) & (XF != (ccres @ ccid @ XB2)) & (cwcel @ (ccv @ Xh) @ XT))) & (((ccv @ Xh) != (ccres @ ccid @ XB2)) & (cwcel @ (ccv @ Xg1) @ XT) & ((ccv @ Xg1) != (ccres @ ccid @ XB2))) & (((ccfv @ XF @ XR) != (ccfv @ (ccv @ Xg1) @ XR)) & ((ccfv @ (ccv @ Xg1) @ XR) != (ccfv @ (ccv @ Xh) @ XR)) & ((cwcel @ (ccv @ Xp) @ XA2) & (~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le))))) => ((ccfv @ (ccv @ Xp) @ (ccfv @ (ccv @ Xh) @ XU)) = (ccfv @ (ccv @ Xp) @ (ccfv @ (ccv @ Xh) @ XV))))))))))))))))))))))))))).
