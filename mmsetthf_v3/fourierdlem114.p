...
thf(afourierdlem113_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((! [Xp:$i] : ((Xph @ Xp) => (cwf @ ccr @ ccr @ (XF @ Xp)))) => ((XT = (cco @ cc2 @ ccpi @ ccmul)) => ((! [Xx3:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ (XF @ Xp)) = (ccfv @ (ccv @ Xx3) @ (XF @ Xp)))))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XX @ ccr))) => ((! [Xx3:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XL @ Xx3 @ Xp) @ (cco @ (ccres @ (XF @ Xp) @ (cco @ ccmnf @ XX @ ccioo)) @ XX @ cclimc))))) => ((! [Xx3:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XR @ Xx3 @ Xp) @ (cco @ (ccres @ (XF @ Xp) @ (cco @ XX @ ccpnf @ ccioo)) @ XX @ cclimc))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XP @ Xx3 @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ ccmap)))))))))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XM @ ccn))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XQ @ (ccfv @ XM @ (XP @ Xx3 @ Xi @ Xn @ Xp)))))))) => ((! [Xi:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwcel @ (ccres @ (cco @ ccr @ (XF @ Xp) @ ccdv) @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo) @ ccc @ cccncf))))) => ((! [Xi:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => ((cco @ (ccres @ (cco @ ccr @ (XF @ Xp) @ ccdv) @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (ccv @ Xi) @ XQ) @ cclimc) != cc0)))) => ((! [Xi:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => ((cco @ (ccres @ (cco @ ccr @ (XF @ Xp) @ ccdv) @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ cclimc) != cc0)))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xp:$i] : ((XA2 @ Xx3 @ Xi @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xp:$i] : ((XB2 @ Xx3 @ Xi @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ ccsin) @ ccmul) @ ccaddc)))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XE @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ ccpi @ (ccv @ Xx3) @ ccmin) @ XT @ ccdiv) @ ccfl) @ XT @ ccmul) @ ccaddc))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (ccfv @ XX @ (XE @ Xi @ Xn @ Xp)) @ (ccrn @ XQ)))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => ((cwbr @ (ccseq @ ccaddc @ (XS @ Xx3 @ Xi @ Xn @ Xp) @ cc1) @ (cco @ (cco @ (cco @ (XL @ Xx3 @ Xp) @ (XR @ Xx3 @ Xp) @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xi @ Xp)) @ cc2 @ ccdiv) @ ccmin) @ ccli) & ((cco @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xi @ Xp)) @ cc2 @ ccdiv) @ (ccsu @ ccn @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ XX @ ccmul) @ ccsin) @ ccmul) @ ccaddc))) @ ccaddc) = (cco @ (cco @ (XL @ Xx3 @ Xp) @ (XR @ Xx3 @ Xp) @ ccaddc) @ cc2 @ ccdiv))))))))))))))))))))))))))))))))))))))).
...
thf(aprunioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ ccle)) => ((ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccpr @ XA2 @ XB2)) = (cco @ XA2 @ XB2 @ ccicc)))))).
...
thf(afourierdlem36_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwss @ XA2 @ ccr)) => ((XF = (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ (ccv @ Xf1))))) => ((XN = (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin)) => (Xph => (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ XF))))))))))).
...
thf(afourierdlem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((XT = (cco @ XB2 @ XA2 @ ccmin)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ XT @ ccdiv) @ ccfl) @ XT @ ccmul) @ ccaddc))))) => (! [Xx3:$i] : (Xph => (cwf @ ccr @ (cco @ XA2 @ XB2 @ ccioc) @ (XE @ Xx3))))))))))))))).
...
thf(assdifss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (ccdif @ XA2 @ XC) @ XB2)))))).
...
thf(afourierdlem27_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ XA2 @ XB2 @ ccicc) @ XQ)) => ((Xph => (cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo))) => (Xph => (cwss @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo)))))))))))))).
thf(afourierdlem38_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : ((! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xn @ Xp) => (cwcel @ (XF @ Xn @ Xp) @ (cco @ (ccdm @ (XF @ Xn @ Xp)) @ ccc @ cccncf))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XP @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ ccmap))))))))) => ((! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xn @ Xp) => (cwcel @ XM @ ccn)))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xn @ Xp) => (cwcel @ (XQ @ Xn) @ (ccfv @ XM @ (XP @ Xi @ Xn @ Xp))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XH @ Xi @ Xn @ Xp) = (ccun @ (XA2 @ Xi @ Xn @ Xp) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ (XF @ Xn @ Xp)))))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xn @ Xp) => ((ccrn @ (XQ @ Xn)) = (XH @ Xi @ Xn @ Xp)))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xn @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwcel @ (ccres @ (XF @ Xn @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xn)) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xn)) @ ccioo) @ ccc @ cccncf)))))))))))))))))))).
thf(aeqnetrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 != XC)) => (Xph => (XA2 != XC))))))))).
thf(aoveq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))))).
thf(asimpld_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps & Xch)) => (Xph => Xps)))))).
thf(afourierdlem46_thm,axiom,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > $o))] : ((Xph => (cwcel @ XF @ (cco @ (ccdm @ XF) @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccico) @ (ccdm @ XF)))) => ((cco @ (ccres @ XF @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccv @ Xx3) @ cclimc) != cc0))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ (ccdm @ XF)))) => ((cco @ (ccres @ XF @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccv @ Xx3) @ cclimc) != cc0))) => ((! [Xx3:$i] : (Xph => (cwiso @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz) @ (XH @ Xx3) @ cclt @ cclt @ XQ))) => ((! [Xx3:$i] : (Xph => (cwf @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz) @ (XH @ Xx3) @ XQ))) => ((! [Xx3:$i] : (Xph => (cwcel @ XI @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo)))) => ((Xph => (cwbr @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ cclt)) => ((Xph => (cwss @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccun @ (cctp @ (ccneg @ ccpi) @ ccpi @ (XC @ Xx3)) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ XF))))) => ((! [Xx3:$i] : (Xph => ((ccrn @ XQ) = (XH @ Xx3)))) => (Xph => (((cco @ (ccres @ XF @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ XI @ XQ) @ cclimc) != cc0) & ((cco @ (ccres @ XF @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ cclimc) != cc0)))))))))))))))))))))).
...
thf(cfourierdlem114_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xg1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwf @ ccr @ ccr @ (XF @ Xg1 @ Xp))))) => ((! [Xg1:$i] : ((XT @ Xg1) = (cco @ cc2 @ ccpi @ ccmul))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (XT @ Xg1) @ ccaddc) @ (XF @ Xg1 @ Xp)) = (ccfv @ (ccv @ Xx3) @ (XF @ Xg1 @ Xp))))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XG @ Xg1 @ Xn @ Xp) = (ccres @ (cco @ ccr @ (XF @ Xg1 @ Xp) @ ccdv) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))) @ ccfn))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ (ccdm @ (XG @ Xg1 @ Xn @ Xp)) @ ccc @ cccncf)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccico) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))))) => ((cco @ (ccres @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccv @ Xx3) @ cclimc) != cc0)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))))) => ((cco @ (ccres @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccv @ Xx3) @ cclimc) != cc0)))))) => ((! [Xg1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XX @ Xg1) @ ccr)))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XL @ Xx3 @ Xg1 @ Xp) @ (cco @ (ccres @ (XF @ Xg1 @ Xp) @ (cco @ ccmnf @ (XX @ Xg1) @ ccioo)) @ (XX @ Xg1) @ cclimc)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XR @ Xx3 @ Xg1 @ Xp) @ (cco @ (ccres @ (XF @ Xg1 @ Xp) @ (cco @ (XX @ Xg1) @ ccpnf @ ccioo)) @ (XX @ Xg1) @ cclimc)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xp:$i] : ((XA2 @ Xx3 @ Xg1 @ Xi @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xg1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ cccos) @ ccmul))) @ ccpi @ ccdiv)))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xp:$i] : ((XB2 @ Xx3 @ Xg1 @ Xi @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xg1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ ccmul))) @ ccpi @ ccdiv)))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xg1 @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ ccsin) @ ccmul) @ ccaddc))))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XP @ Xx3 @ Xg1 @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ ccmap))))))))))) => ((! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XE @ Xg1 @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ ccpi @ (ccv @ Xx3) @ ccmin) @ (XT @ Xg1) @ ccdiv) @ ccfl) @ (XT @ Xg1) @ ccmul) @ ccaddc)))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XH @ Xx3 @ Xi @ Xn @ Xp) = (ccun @ (cctp @ (ccneg @ ccpi) @ ccpi @ (ccfv @ (XX @ Xg1) @ (XE @ Xg1 @ Xi @ Xn @ Xp))) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (XM = (cco @ (ccfv @ (XH @ Xx3 @ Xi @ Xn @ Xp) @ cchash) @ cc1 @ ccmin)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (XQ = (ccio @ (^ [Xg1:$i] : (cwiso @ (cco @ ccc0 @ XM @ ccfz) @ (XH @ Xx3 @ Xi @ Xn @ Xp) @ cclt @ cclt @ (ccv @ Xg1))))))))) => (! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => ((cwbr @ (ccseq @ ccaddc @ (XS @ Xx3 @ Xg1 @ Xi @ Xn @ Xp) @ cc1) @ (cco @ (cco @ (cco @ (XL @ Xx3 @ Xg1 @ Xp) @ (XR @ Xx3 @ Xg1 @ Xp) @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ cc2 @ ccdiv) @ ccmin) @ ccli) & ((cco @ (cco @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ cc2 @ ccdiv) @ (ccsu @ ccn @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ cccos) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xn) @ (XB2 @ Xx3 @ Xg1 @ Xi @ Xp)) @ (ccfv @ (cco @ (ccv @ Xn) @ (XX @ Xg1) @ ccmul) @ ccsin) @ ccmul) @ ccaddc))) @ ccaddc) = (cco @ (cco @ (XL @ Xx3 @ Xg1 @ Xp) @ (XR @ Xx3 @ Xg1 @ Xp) @ ccaddc) @ cc2 @ ccdiv)))))))))))))))))))))))))))))))))))))))))))).
