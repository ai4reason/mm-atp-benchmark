...
thf(cltsubsubaddltsub_conj,conjecture,(! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XJ @ ccr) & ((cwcel @ XL @ ccr) & (cwcel @ XM @ ccr) & (cwcel @ XN @ ccr))) => ((cwbr @ XJ @ (cco @ (cco @ XL @ XM @ ccmin) @ XN @ ccmin) @ cclt) <=> (cwbr @ (cco @ XJ @ XM @ ccaddc) @ (cco @ XL @ XN @ ccmin) @ cclt)))))))).
