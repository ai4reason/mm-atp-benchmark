...
thf(cissubm2_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => ((XH = (cco @ XM @ XS @ ccress)) => ((cwcel @ XM @ ccmnd) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) <=> ((cwss @ XS @ XB2) & (cwcel @ Xc_0 @ XS) & (cwcel @ XH @ ccmnd))))))))))))).
