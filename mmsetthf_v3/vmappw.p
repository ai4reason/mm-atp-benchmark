...
thf(avmaval_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xp:$i] : ((XS @ Xp) = (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)))) => (! [Xp:$i] : ((cwcel @ XA2 @ ccn) => ((ccfv @ XA2 @ ccvma) = (ccif @ ((ccfv @ (XS @ Xp) @ cchash) = cc1) @ (ccfv @ (ccuni @ (XS @ Xp)) @ cclog) @ ccc0)))))))).
...
thf(cvmappw_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XK @ ccn)) => ((ccfv @ (cco @ XP @ XK @ ccexp) @ ccvma) = (ccfv @ XP @ cclog)))))).
