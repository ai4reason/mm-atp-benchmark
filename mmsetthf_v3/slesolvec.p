...
thf(cslesolvec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((((XN != cc0) & (cwcel @ XR @ ccrg)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV))) => (((cco @ XX @ XZ @ Xc_x) = XY) => (cwcel @ XZ @ XV))))))))))))))))).
