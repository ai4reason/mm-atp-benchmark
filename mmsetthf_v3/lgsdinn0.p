...
thf(algs0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => ((cco @ XA2 @ ccc0 @ cclgs) = (ccif @ ((cco @ XA2 @ cc2 @ ccexp) = cc1) @ cc1 @ ccc0))))).
...
thf(clgsdinn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ cclgs) = (cco @ (cco @ XA2 @ XM @ cclgs) @ (cco @ XA2 @ XN @ cclgs) @ ccmul))))))).
