...
thf(ampfconst_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XQ = (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XS @ cccrg)) => ((Xph => (cwcel @ XR @ (ccfv @ XS @ ccsubrg))) => ((Xph => (cwcel @ XX @ XR)) => (Xph => (cwcel @ (ccxp @ (cco @ XB2 @ XI @ ccmap) @ (ccsn @ XX)) @ XQ))))))))))))))))).
...
thf(ampfaddcl_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => ((Xc_pl = (ccfv @ XS @ ccplusg)) => (((cwcel @ XF @ XQ) & (cwcel @ XG @ XQ)) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ XQ)))))))))))).
thf(azringplusg_thm,axiom,(ccaddc = (ccfv @ czring @ ccplusg))).
thf(ccmulr_tp,type,(ccmulr : ($i > $o))).
thf(ampfmulcl_thm,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => ((Xc_x = (ccfv @ XS @ ccmulr)) => (((cwcel @ XF @ XQ) & (cwcel @ XG @ XQ)) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_x)) @ XQ)))))))))))).
...
thf(amzpadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XV @ ccmzp)) & (cwcel @ XB2 @ (ccfv @ XV @ ccmzp))) => (cwcel @ (cco @ XA2 @ XB2 @ (ccof @ ccaddc)) @ (ccfv @ XV @ ccmzp))))))).
thf(amzpmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XV @ ccmzp)) & (cwcel @ XB2 @ (ccfv @ XV @ ccmzp))) => (cwcel @ (cco @ XA2 @ XB2 @ (ccof @ ccmul)) @ (ccfv @ XV @ ccmzp))))))).
thf(aadantlr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xth) & Xps) => Xch))))))).
thf(amzpconst_thm,axiom,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XV @ ccvv) & (cwcel @ XC @ ccz)) => (cwcel @ (ccxp @ (cco @ ccz @ XV @ ccmap) @ (ccsn @ XC)) @ (ccfv @ XV @ ccmzp)))))).
