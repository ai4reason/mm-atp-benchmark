...
thf(cpmtrfconj_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => (((cwcel @ XF @ XR) & (cwf1o @ XD @ XD @ XG)) => (cwcel @ (cccom @ (cccom @ XG @ XF) @ (cccnv @ XG)) @ XR)))))))))).
