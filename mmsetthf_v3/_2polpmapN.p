...
thf(c_2polpmapN_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XM = (ccfv @ XK @ ccpmap)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccfv @ (ccfv @ XX @ XM) @ Xc_pe) @ Xc_pe) = (ccfv @ XX @ XM)))))))))))).
