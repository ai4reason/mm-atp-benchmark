...
thf(aprmgaplem3_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((XA2 @ Xp) = (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (XN @ Xx3 @ Xy1) @ cclt)) @ (^ [Xp:$i] : ccprime)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((cwcel @ (XN @ Xx3 @ Xy1) @ (ccfv @ cc3 @ ccuz)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XA2 @ Xp)))) @ (^ [Xx3:$i] : (XA2 @ Xp))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cprmgaplem5_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XN @ cclt) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ XN @ ccfzo))))) @ (^ [Xp:$i] : ccprime))))).
