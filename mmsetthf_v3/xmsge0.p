...
thf(cxmsge0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccfv @ XM @ ccds)) => (((cwcel @ XM @ ccxme) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ XD) @ ccle)))))))))).
