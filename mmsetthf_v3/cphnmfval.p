...
thf(ccphnmfval_conj,conjecture,(! [Xc_xi:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XW @ ccnm))) => (! [Xx3:$i] : ((cwcel @ XW @ cccph) => ((XN @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccsqrt)))))))))))))).
