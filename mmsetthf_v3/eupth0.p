...
thf(ais0wlk_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((XP = (ccsn @ (ccop @ ccc0 @ XN))) & (cwcel @ XN @ XV)) => (cwbr @ cc0 @ XP @ (ccfv @ XG @ ccwlks))))))))).
...
thf(ceupth0_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XA2 @ XV) & (XI = cc0)) => (cwbr @ cc0 @ (ccsn @ (ccop @ ccc0 @ XA2)) @ (ccfv @ XG @ cceupth)))))))))).
