...
thf(acdlemftr2_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ XK @ ccbs))) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwrex @ (^ [Xf1:$i] : (((ccv @ Xf1) != (ccres @ ccid @ (XB2 @ Xf1))) & ((ccfv @ (ccv @ Xf1) @ XR) != XX) & ((ccfv @ (ccv @ Xf1) @ XR) != XY))) @ (^ [Xf1:$i] : XT)))))))))))))))).
