...
thf(cmodaddabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccrp)) => ((cco @ (cco @ (cco @ XA2 @ XC @ ccmo) @ (cco @ XB2 @ XC @ ccmo) @ ccaddc) @ XC @ ccmo) = (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccmo))))))).
