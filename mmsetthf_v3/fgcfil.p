...
thf(aiscfil2_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XF @ (ccfv @ XD @ cccfil)) <=> ((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwbr @ (cco @ (ccv @ Xz) @ (ccv @ Xw) @ XD) @ (ccv @ Xx3) @ cclt)) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1)))) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : ccrp))))))))).
