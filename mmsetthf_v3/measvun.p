...
thf(cmeasvun_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xx3:$i] : (((cwcel @ XM @ (ccfv @ (XS @ Xx3) @ ccmeas)) & (cwcel @ XA2 @ (ccpw @ (XS @ Xx3))) & ((cwbr @ XA2 @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((ccfv @ (ccuni @ XA2) @ XM) = (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XM)))))))))).
