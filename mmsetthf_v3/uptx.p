...
thf(atxcnmpt_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XW = (ccuni @ XU)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG)))))) => (! [Xx3:$i] : (((cwcel @ XF @ (cco @ XU @ XR @ cccn)) & (cwcel @ XG @ (cco @ XU @ XS @ cccn))) => (cwcel @ (XH @ Xx3) @ (cco @ XU @ (cco @ XR @ XS @ cctx) @ cccn)))))))))))))).
...
thf(aupxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xh:$i] : ((XP @ Xh) = (ccres @ cc1st @ (ccxp @ XB2 @ XC)))) => ((! [Xh:$i] : ((XQ @ Xh) = (ccres @ cc2nd @ (ccxp @ XB2 @ XC)))) => (((cwcel @ XA2 @ XD) & (cwf @ XA2 @ XB2 @ XF) & (cwf @ XA2 @ XC @ XG)) => (cweu @ (^ [Xh:$i] : ((cwf @ XA2 @ (ccxp @ XB2 @ XC) @ (ccv @ Xh)) & (XF = (cccom @ (XP @ Xh) @ (ccv @ Xh))) & (XG = (cccom @ (XQ @ Xh) @ (ccv @ Xh)))))))))))))))))).
...
thf(cuptx_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XT = (cco @ XR @ XS @ cctx)) => ((XX = (ccuni @ XR)) => ((XY = (ccuni @ XS)) => ((! [Xh:$i] : ((XZ @ Xh) = (ccxp @ XX @ XY))) => ((! [Xh:$i] : (XP = (ccres @ cc1st @ (XZ @ Xh)))) => ((! [Xh:$i] : (XQ = (ccres @ cc2nd @ (XZ @ Xh)))) => (((cwcel @ XF @ (cco @ XU @ XR @ cccn)) & (cwcel @ XG @ (cco @ XU @ XS @ cccn))) => (cwreu @ (^ [Xh:$i] : ((XF = (cccom @ XP @ (ccv @ Xh))) & (XG = (cccom @ XQ @ (ccv @ Xh))))) @ (^ [Xh:$i] : (cco @ XU @ XT @ cccn)))))))))))))))))))))).
