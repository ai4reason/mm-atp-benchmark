...
thf(cacongsym_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) & ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) | (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds))) => ((cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ ccdvds) | (cwbr @ XA2 @ (cco @ XC @ (ccneg @ XB2) @ ccmin) @ ccdvds))))))).
