...
thf(cioondisj1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ cclt)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr) & (cwbr @ XC @ XD @ cclt))) & ((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XC @ XB2 @ cclt))) => ((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XC @ XD @ ccioo)) != cc0))))))).
