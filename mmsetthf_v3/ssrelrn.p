...
thf(assbr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwbr @ XC @ XD @ XA2) => (cwbr @ XC @ XD @ XB2)))))))).
...
thf(cssrelrn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XY:($i > $o)] : (((cwss @ XR @ (ccxp @ XA2 @ XB2)) & (cwcel @ XY @ (ccrn @ XR))) => (cwrex @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ XY @ XR)) @ (^ [Xa:$i] : XA2)))))))).
