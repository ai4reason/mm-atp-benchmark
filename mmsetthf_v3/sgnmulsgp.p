...
thf(csgnmulsgp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt) <=> (cwbr @ ccc0 @ (cco @ (ccfv @ XA2 @ ccsgn) @ (ccfv @ XB2 @ ccsgn) @ ccmul) @ cclt)))))).
