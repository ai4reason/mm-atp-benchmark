...
thf(cnmf2_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XW @ ccnm)) => ((XX = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccds)) => ((XE = (ccres @ XD @ (ccxp @ XX @ XX))) => (((cwcel @ XW @ ccgrp) & (cwcel @ XE @ (ccfv @ XX @ ccme))) => (cwf @ XX @ ccr @ XN)))))))))))).
