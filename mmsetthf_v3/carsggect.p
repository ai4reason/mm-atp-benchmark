...
thf(apadct_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccdom) & (cwcel @ XZ @ XV) & (~ (cwcel @ XZ @ XA2))) => (? [Xf1:$i] : ((cwf @ ccn @ (ccun @ XA2 @ (ccsn @ XZ)) @ (ccv @ Xf1)) & (cwss @ XA2 @ (ccrn @ (ccv @ Xf1))) & (cwfun @ (ccres @ (cccnv @ (ccv @ Xf1)) @ XA2))))))))).
...
thf(adisjss3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (((cwss @ XA2 @ XB2) & (cwral @ (^ [Xx3:$i] : ((XC @ Xx3) = cc0)) @ (^ [Xx3:$i] : (ccdif @ XB2 @ XA2)))) => ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) <=> (cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
