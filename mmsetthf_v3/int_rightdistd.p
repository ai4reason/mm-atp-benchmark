...
thf(cint_rightdistd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XB2 @ (cco @ XC @ XD @ ccaddc) @ ccmul) = (cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XA2 @ XD @ ccmul) @ ccaddc))))))))))))).
