...
thf(cpcorevcl_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ XF))))) => (! [Xx3:$i] : ((cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) => ((cwcel @ (XG @ Xx3) @ (cco @ ccii @ XJ @ cccn)) & ((ccfv @ ccc0 @ (XG @ Xx3)) = (ccfv @ cc1 @ XF)) & ((ccfv @ cc1 @ (XG @ Xx3)) = (ccfv @ ccc0 @ XF)))))))))).
