...
thf(aeueq1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cweu @ (^ [Xx3:$i] : ((ccv @ Xx3) = XA2)))))).
...
thf(abianfd_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (~ Xps)) => (Xph => (Xps <=> (Xps & Xch)))))))).
...
thf(ceueq3_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((~ (Xph & Xps)) => (cweu @ (^ [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) | ((~ (Xph | Xps)) & ((ccv @ Xx3) = XB2)) | (Xps & ((ccv @ Xx3) = XC))))))))))))))).
