...
thf(cxpcco2nd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (cco @ XC @ XD @ ccxpc)) => ((XB2 = (ccfv @ XT @ ccbs)) => ((XK = (ccfv @ XT @ cchom)) => ((XO = (ccfv @ XT @ ccco)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XK))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ XK))) => ((Xc_x = (ccfv @ XD @ ccco)) => (Xph => ((ccfv @ (cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ XO)) @ cc2nd) = (cco @ (ccfv @ XG @ cc2nd) @ (ccfv @ XF @ cc2nd) @ (cco @ (ccop @ (ccfv @ XX @ cc2nd) @ (ccfv @ XY @ cc2nd)) @ (ccfv @ XZ @ cc2nd) @ Xc_x)))))))))))))))))))))))))))).
