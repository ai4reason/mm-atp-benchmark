...
thf(ccoe1tmmul_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ XP @ ccbs))) => ((Xc_xb = (ccfv @ XP @ ccmulr)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XB2 @ Xx3)))) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XC @ XK)) => ((Xph => (cwcel @ XD @ ccn0)) => (Xph => ((ccfv @ (cco @ (cco @ XC @ (cco @ XD @ XX @ Xc_ex) @ Xc_x) @ XA2 @ Xc_xb) @ ccco1) = (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccif @ (cwbr @ XD @ (ccv @ Xx3) @ ccle) @ (cco @ XC @ (ccfv @ (cco @ (ccv @ Xx3) @ XD @ ccmin) @ (ccfv @ XA2 @ ccco1)) @ Xc_xp) @ Xc_0))))))))))))))))))))))))))))))))))).
