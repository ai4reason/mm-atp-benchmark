...
thf(amopni3_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XA2 @ XJ) & (cwcel @ XP @ XA2)) & (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XR @ cclt) & (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ XA2))) @ (^ [Xx3:$i] : ccrp))))))))))).
...
thf(aelbl3_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XR @ ccxr)) & ((cwcel @ XP @ XX) & (cwcel @ XA2 @ XX))) => ((cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) <=> (cwbr @ (cco @ XA2 @ XP @ XD) @ XR @ cclt))))))))).
...
thf(arolle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))) => (Xph => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) = ccc0)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))).
...
thf(aiccssioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XD @ XB2 @ cclt))) => (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(acmvth_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => (cwcel @ XG @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => ((ccdm @ (cco @ ccr @ XG @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => (Xph => (cwrex @ (^ [Xx3:$i] : ((cco @ (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin) @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XG @ ccdv)) @ ccmul) = (cco @ (cco @ (ccfv @ XB2 @ XG) @ (ccfv @ XA2 @ XG) @ ccmin) @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccmul))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))))).
...
thf(albioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (~ (cwcel @ XA2 @ (cco @ XA2 @ XB2 @ ccioo)))))).
...
thf(arexima_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ XF)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => (((cwfn @ XF @ XA2) & (cwss @ XB2 @ XA2)) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccima @ XF @ XB2))) <=> (cwrex @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : XB2))))))))))).
...
thf(alimccnp2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XR @ Xx3) @ XX))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XS @ Xx3) @ XY))) => ((Xph => (cwss @ XX @ ccc)) => ((Xph => (cwss @ XY @ ccc)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (cco @ (XK @ Xx3) @ (XK @ Xx3) @ cctx) @ (ccxp @ XX @ XY) @ ccrest))) => ((Xph => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XR @ Xx3))) @ XB2 @ cclimc))) => ((Xph => (cwcel @ XD @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XS @ Xx3))) @ XB2 @ cclimc))) => ((! [Xx3:$i] : (Xph => (cwcel @ XH @ (ccfv @ (ccop @ XC @ XD) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccnp))))) => (Xph => (cwcel @ (cco @ XC @ XD @ XH) @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XR @ Xx3) @ (XS @ Xx3) @ XH))) @ XB2 @ cclimc))))))))))))))))))))))))).
...
thf(acnmptlimc_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XX @ Xx3))) @ (cco @ XA2 @ XD @ cccncf)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ XA2))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((XX @ Xx3) = XY))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XY @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XX @ Xx3))) @ XB2 @ cclimc)))))))))))))).
...
thf(adivcn_thm,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XK = (cco @ XJ @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccrest)) => (cwcel @ ccdiv @ (cco @ (cco @ XJ @ XK @ cctx) @ XJ @ cccn))))))).
...
thf(aellimc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((XK = (ccfv @ cccnfld @ cctopn)) => (Xph => ((cwcel @ XC @ (cco @ XF @ XB2 @ cclimc)) <=> ((cwcel @ XC @ ccc) & (cwral @ (^ [Xu:$i] : ((cwcel @ XC @ (ccv @ Xu)) => (cwrex @ (^ [Xw:$i] : ((cwcel @ XB2 @ (ccv @ Xw)) & (cwss @ (ccima @ XF @ (ccin @ (ccv @ Xw) @ (ccdif @ XA2 @ (ccsn @ XB2)))) @ (ccv @ Xu)))) @ (^ [Xw:$i] : XK)))) @ (^ [Xu:$i] : XK)))))))))))))))).
...
thf(clhop1lem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XA2 @ ccr))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XB2 @ Xt) @ ccxr))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwbr @ XA2 @ (XB2 @ Xt) @ cclt))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwf @ (cco @ XA2 @ (XB2 @ Xt) @ ccioo) @ ccr @ XF))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwf @ (cco @ XA2 @ (XB2 @ Xt) @ ccioo) @ ccr @ XG))) => ((! [Xt:$i] : ((Xph @ Xt) => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ (XB2 @ Xt) @ ccioo)))) => ((! [Xt:$i] : ((Xph @ Xt) => ((ccdm @ (cco @ ccr @ XG @ ccdv)) = (cco @ XA2 @ (XB2 @ Xt) @ ccioo)))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ ccc0 @ (cco @ XF @ XA2 @ cclimc)))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ ccc0 @ (cco @ XG @ XA2 @ cclimc)))) => ((! [Xt:$i] : ((Xph @ Xt) => (~ (cwcel @ ccc0 @ (ccrn @ XG))))) => ((! [Xt:$i] : ((Xph @ Xt) => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XG @ ccdv)))))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ (XB2 @ Xt) @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv))) @ XA2 @ cclimc)))) => ((! [Xz:$i] : (! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XE @ Xz) @ ccrp)))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : ((Xph @ Xt) => (cwcel @ (XD @ Xz @ Xr) @ ccr))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : ((Xph @ Xt) => (cwbr @ (XD @ Xz @ Xr) @ (XB2 @ Xt) @ ccle))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : ((Xph @ Xt) => (cwcel @ (XX @ Xt) @ (cco @ XA2 @ (XD @ Xz @ Xr) @ ccioo)))))) => ((! [Xz:$i] : (! [Xt:$i] : (! [Xr:$i] : ((Xph @ Xt) => (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv) @ XC @ ccmin) @ ccabs) @ (XE @ Xz) @ cclt)) @ (^ [Xt:$i] : (cco @ XA2 @ (XD @ Xz @ Xr) @ ccioo))))))) => ((! [Xt:$i] : (! [Xr:$i] : ((XR @ Xt @ Xr) = (cco @ XA2 @ (cco @ (ccv @ Xr) @ cc2 @ ccdiv) @ ccaddc)))) => (! [Xz:$i] : (! [Xt:$i] : ((Xph @ Xt) => (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (XX @ Xt) @ XF) @ (ccfv @ (XX @ Xt) @ XG) @ ccdiv) @ XC @ ccmin) @ ccabs) @ (cco @ cc2 @ (XE @ Xz) @ ccmul) @ cclt))))))))))))))))))))))))))))))))).
