...
thf(ccnmptlimc_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XX @ Xx3))) @ (cco @ XA2 @ XD @ cccncf)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ XA2))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((XX @ Xx3) = XY))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XY @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XX @ Xx3))) @ XB2 @ cclimc)))))))))))))).
