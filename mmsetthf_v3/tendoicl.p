...
thf(atendoi2_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (! [Xs1:$i] : ((XI @ Xf1 @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (XE @ Xf1)) @ (^ [Xs1:$i] : (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (cccnv @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xs1)))))))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (XT = (ccfv @ XW @ (ccfv @ (XK @ Xf1 @ Xs1) @ ccltrn))))) => (! [Xf1:$i] : (! [Xs1:$i] : (((cwcel @ (XS @ Xf1 @ Xs1) @ (XE @ Xf1)) & (cwcel @ (XF @ Xf1 @ Xs1) @ XT)) => ((ccfv @ (XF @ Xf1 @ Xs1) @ (ccfv @ (XS @ Xf1 @ Xs1) @ (XI @ Xf1 @ Xs1))) = (cccnv @ (ccfv @ (XF @ Xf1 @ Xs1) @ (XS @ Xf1 @ Xs1))))))))))))))))).
