...
thf(c_1egrvtxdg0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => ((ccfv @ XG @ ccvtx) = XV)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (XB2 != XC)) => ((Xph => (cwcel @ XD @ XV)) => ((Xph => (XC != XD)) => ((Xph => ((ccfv @ XG @ cciedg) = (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XD))))) => (Xph => ((ccfv @ XC @ (ccfv @ XG @ ccvtxdg)) = ccc0))))))))))))))))))).
