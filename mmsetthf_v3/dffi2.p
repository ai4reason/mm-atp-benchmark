...
thf(cdffi2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((ccfv @ XA2 @ ccfi) = (ccint @ (^ [Xz:$i] : ((cwss @ XA2 @ (ccv @ Xz)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xy1:$i] : (ccv @ Xz)))) @ (^ [Xx3:$i] : (ccv @ Xz)))))))))))).
