...
thf(czndvds0_conj,conjecture,(! [XA2:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XY @ cczrh)) => ((Xc_0 = (ccfv @ XY @ cc0g)) => (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccz)) => (((ccfv @ XA2 @ XL) = Xc_0) <=> (cwbr @ XN @ XA2 @ ccdvds)))))))))))).
