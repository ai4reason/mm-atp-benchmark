...
thf(acbvral2v_b_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xz)) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xx3)) => ((Xch @ Xy1 @ Xz) <=> (Xps @ Xx3 @ Xz)))))) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) <=> (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (^ [Xx3:$i] : XB2))) @ (^ [Xz:$i] : (XA2 @ Xy1))))))))))))).
...
thf(aiscau3_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : ((XZ @ Xm) = (ccfv @ (XM @ Xx3 @ Xk @ Xm) @ ccuz))))) => ((! [Xm:$i] : ((Xph @ Xm) => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xm) => (cwcel @ (XM @ Xx3 @ Xk @ Xm) @ ccz))))) => (! [Xm:$i] : ((Xph @ Xm) => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> ((cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (ccv @ Xk) @ (ccdm @ XF)) & (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XX) & (cwral @ (^ [Xm:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xm) @ XF) @ XD) @ (ccv @ Xx3) @ cclt)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xk) @ ccuz))))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xm)))) @ (^ [Xx3:$i] : ccrp)))))))))))))))).
...
thf(auzfbas_thm,axiom,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XM @ ccz) => (cwcel @ (ccima @ ccuz @ XZ) @ (ccfv @ XZ @ ccfbas))))))).
thf(ccfg_tp,type,(ccfg : ($i > $o))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(afmcfil_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) & (cwf @ XY @ XX @ XF)) => ((cwcel @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ (ccfv @ XD @ cccfil)) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xw) @ XF) @ XD) @ (ccv @ Xx3) @ cclt)) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccrp)))))))))).
thf(ccaucfil_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((XL = (ccfv @ (ccima @ ccuz @ XZ) @ (cco @ XX @ XF @ ccfm))) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XM @ ccz) & (cwf @ XZ @ XX @ XF)) => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> (cwcel @ XL @ (ccfv @ XD @ cccfil))))))))))))).
