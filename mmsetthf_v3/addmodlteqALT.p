...
thf(caddmodlteqALT_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XS @ ccz)) => (((cco @ (cco @ XI @ XS @ ccaddc) @ XN @ ccmo) = (cco @ (cco @ XJ @ XS @ ccaddc) @ XN @ ccmo)) <=> (XI = XJ)))))))).
