...
thf(ccaucvgrlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xj) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : XA2))) @ (^ [Xx3:$i] : ccrp))) => ((Xph => (cwcel @ XR @ ccrp)) => (Xph => (cwrex @ (^ [Xj:$i] : ((cwcel @ (ccfv @ XF @ cclsp) @ ccr) & (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ XF @ cclsp) @ ccmin) @ ccabs) @ (cco @ cc3 @ XR @ ccmul) @ cclt))) @ (^ [Xk:$i] : XA2)))) @ (^ [Xj:$i] : XA2))))))))))))).
