...
thf(cvolicon0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) = (cco @ XB2 @ XA2 @ ccmin)))))))))).
