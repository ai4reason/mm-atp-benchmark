...
thf(acflem_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz @ Xw)) => (? [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ cccrd)) & ((cwss @ (ccv @ Xy1) @ XA2) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : XA2)))))))))))))).
...
thf(ccfval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ cccf) = (ccint @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ cccrd)) & ((cwss @ (ccv @ Xy1) @ XA2) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : XA2))))))))))).
