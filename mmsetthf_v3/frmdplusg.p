...
thf(afrmdval_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XI @ ccfrmd)) => (((cwcel @ XI @ XV) => (XB2 = (ccword @ XI))) => ((Xc_pl = (ccres @ ccconcat @ (ccxp @ XB2 @ XB2))) => ((cwcel @ XI @ XV) => (XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl))))))))))))).
