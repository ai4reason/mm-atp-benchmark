...
thf(aopeliun2xp_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ (ccop @ (XC @ Xy1) @ (ccv @ Xy1)) @ (cciun @ (^ [Xy1:$i] : (XB2 @ Xy1)) @ (^ [Xy1:$i] : (ccxp @ (XA2 @ Xy1) @ (ccsn @ (ccv @ Xy1)))))) <=> ((cwcel @ (ccv @ Xy1) @ (XB2 @ Xy1)) & (cwcel @ (XC @ Xy1) @ (XA2 @ Xy1))))))))).
thf(aancom_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) <=> (Xps & Xph))))).
thf(celiunxp2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwcel @ XC @ (cciun @ (^ [Xy1:$i] : (XB2 @ Xy1)) @ (^ [Xy1:$i] : (ccxp @ (XA2 @ Xy1) @ (ccsn @ (ccv @ Xy1)))))) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((XC = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xy1))))))))))).
