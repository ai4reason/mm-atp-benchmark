...
thf(cnvmdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XM = (ccfv @ XU @ ccnsb)) => ((XS = (ccfv @ XU @ ccns)) => (((cwcel @ XU @ ccnv) & ((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ XM) @ XS) = (cco @ (cco @ XA2 @ XB2 @ XS) @ (cco @ XA2 @ XC @ XS) @ XM)))))))))))))).
