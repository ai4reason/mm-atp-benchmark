...
thf(cxrmaxle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) => ((cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XB2 @ XA2) @ XC @ ccle) <=> ((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XB2 @ XC @ ccle)))))))).
