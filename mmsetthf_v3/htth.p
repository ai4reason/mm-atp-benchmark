...
thf(ahtthlem_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XP @ Xx3 @ Xy1) = (ccfv @ XU @ ccdip)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XL @ Xx3 @ Xy1 @ Xz @ Xw) = (cco @ XU @ XU @ cclno)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XB2 @ Xx3 @ Xy1 @ Xz @ Xw) = (cco @ XU @ XU @ ccblo)))))) => ((XN = (ccfv @ XU @ ccnmcv)) => ((cwcel @ XU @ cchlo) => ((XW = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (Xph => (cwcel @ XT @ (XL @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ (XP @ Xx3 @ Xy1)) = (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ (XP @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xz) = (ccmpt @ (^ [Xz:$i] : XX) @ (^ [Xz:$i] : (ccmpt @ (^ [Xw:$i] : XX) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccfv @ (ccv @ Xz) @ XT) @ (XP @ Xx3 @ Xy1)))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (XK = (ccima @ (XF @ Xx3 @ Xz) @ (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccv @ Xz) @ XN) @ cc1 @ ccle)) @ (^ [Xz:$i] : XX)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (Xph => (cwcel @ XT @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aelimel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ XC) => (cwcel @ (ccif @ (cwcel @ XA2 @ XC) @ XA2 @ XB2) @ XC)))))).
thf(acnchl_thm,axiom,(! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwcel @ XU @ cchlo)))).
...
thf(chtth_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XP @ Xx3 @ Xy1) = (ccfv @ XU @ ccdip)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (cco @ XU @ XU @ cclno)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (cco @ XU @ XU @ ccblo)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XU @ cchlo) & (cwcel @ XT @ (XL @ Xx3 @ Xy1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ (XP @ Xx3 @ Xy1)) = (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ (XP @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) => (cwcel @ XT @ (XB2 @ Xx3 @ Xy1)))))))))))))))).
