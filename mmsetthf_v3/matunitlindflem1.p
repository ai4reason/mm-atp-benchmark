...
thf(aislindf4_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XR = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XY = (ccfv @ XR @ cc0g)) => ((XL = (ccfv @ (cco @ XR @ XI @ ccfrlm) @ ccbs)) => (((cwcel @ XW @ cclmod) & (cwcel @ XI @ XX) & (cwf @ XI @ XB2 @ XF)) => ((cwbr @ XF @ XW @ cclindf) <=> (cwral @ (^ [Xx3:$i] : (((cco @ XW @ (cco @ (ccv @ Xx3) @ XF @ (ccof @ Xc_x)) @ ccgsu) = Xc_0) => ((ccv @ Xx3) = (ccxp @ XI @ (ccsn @ XY))))) @ (^ [Xx3:$i] : XL))))))))))))))))))))).
...
thf(afndmfifsupp_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwfn @ XF @ XD)) => ((Xph => (cwcel @ XD @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwbr @ XF @ XZ @ ccfsupp))))))))))).
...
thf(aabl32_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => (Xph => ((cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl) = (cco @ (cco @ XX @ XZ @ Xc_pl) @ XY @ Xc_pl))))))))))))))))).
