...
thf(ahasheuni_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3)))) => ((ccfv @ (ccuni @ XA2) @ cchash) = (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash)))))))).
...
thf(ccntmeas_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) => (cwcel @ (ccres @ cchash @ XS) @ (ccfv @ XS @ ccmeas))))).
