...
thf(atchnmfval_thm,axiom,(! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XG @ ccnm))) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => (! [Xx3:$i] : ((cwcel @ XW @ ccgrp) => ((XN @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccsqrt)))))))))))))))).
...
thf(crrxnm_conj,conjecture,(! [XB2:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XH @ Xx3 @ Xf1) = (ccfv @ XI @ ccrrx)))) => ((! [Xx3:$i] : (! [Xf1:$i] : (XB2 = (ccfv @ (XH @ Xx3 @ Xf1) @ ccbs)))) => (! [Xx3:$i] : (! [Xf1:$i] : ((cwcel @ XI @ XV) => ((ccmpt @ (^ [Xf1:$i] : XB2) @ (^ [Xf1:$i] : (ccfv @ (cco @ ccrefld @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ cc2 @ ccexp))) @ ccgsu) @ ccsqrt))) = (ccfv @ (XH @ Xx3 @ Xf1) @ ccnm)))))))))))).
