...
thf(aumgr2adedgwlklem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccumgr) & (cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE)) => (((XA2 != XB2) & (XB2 != XC)) & ((cwcel @ XA2 @ (ccfv @ XG @ ccvtx)) & (cwcel @ XB2 @ (ccfv @ XG @ ccvtx)) & (cwcel @ XC @ (ccfv @ XG @ ccvtx)))))))))))).
...
thf(cumgr2wlkon_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccumgr) & (cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE)) => (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ XA2 @ XC @ (ccfv @ XG @ ccwlkson))))))))))))).
