...
thf(cxrsdsreclb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccfv @ ccxrs @ ccds)) => (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (XA2 != XB2)) => ((cwcel @ (cco @ XA2 @ XB2 @ XD) @ ccr) <=> ((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr))))))))).
