...
thf(aelmopn2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ XD @ ccmopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XA2 @ (XJ @ Xx3 @ Xy1)) <=> ((cwss @ XA2 @ XX) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XD @ ccbl)) @ XA2)) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : XA2))))))))))))).
