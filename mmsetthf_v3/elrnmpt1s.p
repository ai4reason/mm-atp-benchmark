...
thf(celrnmpt1s_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XD) => ((XB2 @ Xx3) = XC))) => (! [Xx3:$i] : (((cwcel @ XD @ XA2) & (cwcel @ XC @ (XV @ Xx3))) => (cwcel @ XC @ (ccrn @ (XF @ Xx3)))))))))))))).
