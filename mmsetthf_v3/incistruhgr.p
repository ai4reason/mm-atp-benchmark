...
thf(assrelrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XY:($i > $o)] : (((cwss @ XR @ (ccxp @ XA2 @ XB2)) & (cwcel @ XY @ (ccrn @ XR))) => (cwrex @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ XY @ XR)) @ (^ [Xa:$i] : XA2)))))))).
...
thf(cincistruhgr_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xv:$i] : (XV = (ccfv @ (XG @ Xv) @ ccvtx))) => ((! [Xv:$i] : ((XE @ Xv) = (ccfv @ (XG @ Xv) @ cciedg))) => (! [Xv:$i] : (((cwcel @ (XG @ Xv) @ (XW @ Xv)) & (cwss @ XI @ (ccxp @ XP @ XL)) & ((ccrn @ XI) = XL)) => (((XV = XP) & ((XE @ Xv) = (ccmpt @ (^ [Xe:$i] : XL) @ (^ [Xe:$i] : (ccrab @ (^ [Xv:$i] : (cwbr @ (ccv @ Xv) @ (ccv @ Xe) @ XI)) @ (^ [Xv:$i] : XP)))))) => (cwcel @ (XG @ Xv) @ ccuhgr)))))))))))))).
