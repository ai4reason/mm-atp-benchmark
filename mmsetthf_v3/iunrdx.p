...
thf(ciunrdx_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwfo @ XA2 @ XC @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF))) => ((XD @ Xy1) = (XB2 @ Xx3))))) => (Xph => ((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))))).
