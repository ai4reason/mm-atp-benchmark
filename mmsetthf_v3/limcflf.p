...
thf(alimcflflem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp)))) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((XC = (ccdif @ XA2 @ (ccsn @ XB2))) => ((XL = (cco @ (ccfv @ (ccsn @ XB2) @ (ccfv @ XK @ ccnei)) @ XC @ ccrest)) => (Xph => (cwcel @ XL @ (ccfv @ XC @ ccfil))))))))))))))))).
...
thf(climcflf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp)))) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((XC = (ccdif @ XA2 @ (ccsn @ XB2))) => ((XL = (cco @ (ccfv @ (ccsn @ XB2) @ (ccfv @ XK @ ccnei)) @ XC @ ccrest)) => (Xph => ((cco @ XF @ XB2 @ cclimc) = (ccfv @ (ccres @ XF @ XC) @ (cco @ XK @ XL @ ccflf)))))))))))))))))).
