...
thf(cpeano2uz2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : ccz)))) => (cwcel @ (cco @ XB2 @ cc1 @ ccaddc) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : ccz))))))).
