...
thf(celintfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ ccvv) => (((cwfn @ XF @ XA2) & (cwss @ XB2 @ XA2)) => ((cwcel @ XX @ (ccint @ (ccima @ XF @ XB2))) <=> (cwral @ (^ [Xy1:$i] : (cwcel @ XX @ (ccfv @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XB2)))))))))).
