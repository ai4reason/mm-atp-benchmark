...
thf(apmapglb2xN_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xy1:$i] : (! [Xi:$i] : ((XG @ Xy1 @ Xi) = (ccfv @ XK @ ccglb)))) => ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccfv @ XK @ ccatm))) => ((! [Xy1:$i] : (! [Xi:$i] : ((XM @ Xy1 @ Xi) = (ccfv @ XK @ ccpmap)))) => (! [Xy1:$i] : (! [Xi:$i] : (((cwcel @ XK @ cchlt) & (cwral @ (^ [Xi:$i] : (cwcel @ (XS @ Xi) @ XB2)) @ (^ [Xi:$i] : XI))) => ((ccfv @ (ccfv @ (^ [Xy1:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xy1) = (XS @ Xi))) @ (^ [Xi:$i] : XI))) @ (XG @ Xy1 @ Xi)) @ (XM @ Xy1 @ Xi)) = (ccin @ (XA2 @ Xy1) @ (cciin @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (XS @ Xi) @ (XM @ Xy1 @ Xi))))))))))))))))))))).
...
thf(cpolval2N_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XK @ cclub)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => ((XP = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ cchlt) & (cwss @ XX @ XA2)) => ((ccfv @ XX @ XP) = (ccfv @ (ccfv @ (ccfv @ XX @ XU) @ Xc_pe) @ XM)))))))))))))))).
