...
thf(cxralrple4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (cco @ XB2 @ (cco @ (ccv @ Xx3) @ XN @ ccexp) @ ccaddc) @ ccle)) @ (^ [Xx3:$i] : ccrp)))))))))))).
