...
thf(aopsrcrng_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XO = (ccfv @ XT @ (cco @ XI @ XR @ ccopws))) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwss @ XT @ (ccxp @ XI @ XI))) => (Xph => (cwcel @ XO @ cccrg))))))))))))).
