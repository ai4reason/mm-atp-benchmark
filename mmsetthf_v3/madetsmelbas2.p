...
thf(cmadetsmelbas2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xn:$i] : ((XS @ Xn) = (ccfv @ XN @ ccpsgn))) => ((! [Xn:$i] : ((XY @ Xn) = (ccfv @ XR @ cczrh))) => ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ XN @ XR @ ccmat))) => ((! [Xn:$i] : (XB2 = (ccfv @ (XA2 @ Xn) @ ccbs))) => ((! [Xn:$i] : ((XG @ Xn) = (ccfv @ XR @ ccmgp))) => (! [Xn:$i] : (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2) & (cwcel @ XQ @ XP)) => (cwcel @ (cco @ (ccfv @ XQ @ (cccom @ (XY @ Xn) @ (XS @ Xn))) @ (cco @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ XQ) @ XM))) @ ccgsu) @ (ccfv @ XR @ ccmulr)) @ (ccfv @ XR @ ccbs))))))))))))))))))))).
