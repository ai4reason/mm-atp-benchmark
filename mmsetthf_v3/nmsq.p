...
thf(acphnm_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XN = (ccfv @ XW @ ccnm)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV)) => ((ccfv @ XA2 @ XN) = (ccfv @ (cco @ XA2 @ XA2 @ Xc_xi) @ ccsqrt)))))))))))).
