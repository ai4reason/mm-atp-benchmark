...
thf(crngoiso1o_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((XJ = (ccfv @ XS @ cc1st)) => ((XY = (ccrn @ XJ)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) => (cwf1o @ XX @ XY @ XF)))))))))))))).
