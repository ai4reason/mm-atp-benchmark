...
thf(ccnrefiisp_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XA2 @ ccc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (~ (cwcel @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XB2 @ Xy1) @ ccfn)))) => ((! [Xy1:$i] : (XC = (ccun @ ccr @ (XB2 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cwcel @ (ccv @ Xy1) @ ccc) & ((ccv @ Xy1) != XA2)) => (cwbr @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs) @ ccle))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : ccrp)))))))))))))).
