...
thf(cigenval2_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xj:$i] : ((XG @ Xj) = (ccfv @ XR @ cc1st))) => ((! [Xj:$i] : ((XX @ Xj) = (ccrn @ (XG @ Xj)))) => (! [Xj:$i] : (((cwcel @ XR @ ccrngo) & (cwss @ XS @ (XX @ Xj))) => (((cco @ XR @ XS @ ccigen) = XI) <=> ((cwcel @ XI @ (ccfv @ XR @ ccidl)) & (cwss @ XS @ XI) & (cwral @ (^ [Xj:$i] : ((cwss @ XS @ (ccv @ Xj)) => (cwss @ XI @ (ccv @ Xj)))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))))))))))))).
