...
thf(adf_repr_ax,axiom,(ccrepr = (ccmpt @ (^ [Xs1:$i] : ccn0) @ (^ [Xs1:$i] : (ccmpt2 @ (^ [Xb:$i] : (^ [Xm:$i] : (ccpw @ ccn))) @ (^ [Xb:$i] : (^ [Xm:$i] : ccz)) @ (^ [Xb:$i] : (^ [Xm:$i] : (ccrab @ (^ [Xc:$i] : ((ccsu @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfzo) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xa) @ (ccv @ Xc)))) = (ccv @ Xm))) @ (^ [Xc:$i] : (cco @ (ccv @ Xb) @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfzo) @ ccmap)))))))))).
...
thf(creprval_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xa:$i] : ((Xph @ Xa) => (cwss @ (XA2 @ Xa) @ ccn))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ (XM @ Xa) @ ccz))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XS @ ccn0))) => (! [Xa:$i] : ((Xph @ Xa) => ((cco @ (XA2 @ Xa) @ (XM @ Xa) @ (ccfv @ XS @ ccrepr)) = (ccrab @ (^ [Xc:$i] : ((ccsu @ (cco @ ccc0 @ XS @ ccfzo) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xa) @ (ccv @ Xc)))) = (XM @ Xa))) @ (^ [Xc:$i] : (cco @ (XA2 @ Xa) @ (cco @ ccc0 @ XS @ ccfzo) @ ccmap)))))))))))))).
