...
thf(c_0ofval_conj,conjecture,(! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XZ = (ccfv @ XW @ ccn0v)) => ((XO = (cco @ XU @ XW @ cc0o)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv)) => (XO = (ccxp @ XX @ (ccsn @ XZ))))))))))))).
