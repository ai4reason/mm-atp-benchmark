...
thf(cisnghm_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) <=> (((cwcel @ XS @ ccngp) & (cwcel @ XT @ ccngp)) & ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ (ccfv @ XF @ XN) @ ccr)))))))))).
