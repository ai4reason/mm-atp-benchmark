...
thf(cdfsalgen2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (Xph => (cwcel @ XX @ (XV @ Xy1)))) => (Xph => (((ccfv @ XX @ ccsalgen) = XS) <=> (((cwcel @ XS @ ccsalg) & ((ccuni @ XS) = (ccuni @ XX)) & (cwss @ XX @ XS)) & (cwral @ (^ [Xy1:$i] : ((((ccuni @ (ccv @ Xy1)) = (ccuni @ XX)) & (cwss @ XX @ (ccv @ Xy1))) => (cwss @ XS @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : ccsalg))))))))))).
