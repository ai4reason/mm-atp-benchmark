...
thf(cclimlimsupcex_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((~ (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((XF = cc0) => (((cwcel @ cc0 @ ccc) & (~ (cwcel @ ccmnf @ ccc))) => ((cwf @ XZ @ ccr @ XF) & (cwcel @ XF @ (ccdm @ ccli)) & (~ (cwbr @ XF @ (ccfv @ XF @ cclsp) @ ccli))))))))))).
