...
thf(advdsabseq_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwbr @ XM @ XN @ ccdvds) & (cwbr @ XN @ XM @ ccdvds)) => ((ccfv @ XM @ ccabs) = (ccfv @ XN @ ccabs)))))).
...
thf(cdvdseq_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) & ((cwbr @ XM @ XN @ ccdvds) & (cwbr @ XN @ XM @ ccdvds))) => (XM = XN))))).
