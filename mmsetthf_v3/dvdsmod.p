...
thf(cdvdsmod_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XP @ ccn) & (cwcel @ XN @ ccn) & (cwcel @ XK @ ccz)) & (cwbr @ XP @ XN @ ccdvds)) => ((cwbr @ XP @ (cco @ XK @ XN @ ccmo) @ ccdvds) <=> (cwbr @ XP @ XK @ ccdvds))))))).
