...
thf(axkofvcn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccuni @ XR)) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XF @ Xx3 @ Xf1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xx3:$i] : (cco @ XR @ XS @ cccn))) @ (^ [Xf1:$i] : (^ [Xx3:$i] : XX)) @ (^ [Xf1:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (((cwcel @ XR @ (ccnlly @ cccmp)) & (cwcel @ XS @ cctop)) => (cwcel @ (XF @ Xx3 @ Xf1) @ (cco @ (cco @ (cco @ XS @ XR @ ccxko) @ XR @ cctx) @ XS @ cccn)))))))))))).
...
thf(ccnmptk1p_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : (Xph => (cwcel @ (XJ @ Xy1) @ (ccfv @ XX @ cctopon)))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XK @ Xy1) @ (ccfv @ XY @ cctopon)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XL @ Xy1) @ (ccfv @ (XZ @ Xx3) @ cctopon))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XK @ Xy1) @ (ccnlly @ cccmp)))) => ((! [Xy1:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))))) @ (cco @ (XJ @ Xy1) @ (cco @ (XL @ Xy1) @ (XK @ Xy1) @ ccxko) @ cccn)))) => ((! [Xy1:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ (XJ @ Xy1) @ (XK @ Xy1) @ cccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XB2 @ Xx3)) => ((XA2 @ Xx3 @ Xy1) = (XC @ Xx3))))) => (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cco @ (XJ @ Xy1) @ (XL @ Xy1) @ cccn)))))))))))))))))))))).
