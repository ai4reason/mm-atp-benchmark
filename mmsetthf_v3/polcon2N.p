...
thf(cpolcon2N_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ cchlt) & (cwss @ XY @ XA2) & (cwss @ XX @ (ccfv @ XY @ Xc_pe))) => (cwss @ XY @ (ccfv @ XX @ Xc_pe))))))))))).
