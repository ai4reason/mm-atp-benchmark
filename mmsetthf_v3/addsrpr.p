...
thf(aspc2egv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) & (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))) => (Xps => (? [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1))))))))))))))).
...
thf(aovig_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2) & ((ccv @ Xz) = XC)) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> Xps))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XR) & (cwcel @ (ccv @ Xy1) @ XS)) => (cwmo @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ XR) & (cwcel @ (ccv @ Xy1) @ XS)) & (Xph @ Xx3 @ Xy1 @ Xz)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS) & (cwcel @ XC @ (XD @ Xx3 @ Xy1 @ Xz))) => (Xps => ((cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) = XC))))))))))))))))))).
...
thf(aaddsrmo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer)) & (cwcel @ XB2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer))) => (cwmo @ (^ [Xz:$i] : (? [Xw:$i] : (? [Xv:$i] : (? [Xu:$i] : (? [Xt:$i] : (((XA2 = (ccec @ (ccop @ (ccv @ Xw) @ (ccv @ Xv)) @ ccer)) & (XB2 = (ccec @ (ccop @ (ccv @ Xu) @ (ccv @ Xt)) @ ccer))) & ((ccv @ Xz) = (ccec @ (ccop @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccpp) @ (cco @ (ccv @ Xv) @ (ccv @ Xt) @ ccpp)) @ ccer))))))))))))).
