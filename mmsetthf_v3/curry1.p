...
thf(ccurry1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XC) @ ccvv))))) => (((cwfn @ XF @ (ccxp @ XA2 @ XB2)) & (cwcel @ XC @ XA2)) => (XG = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XC @ (ccv @ Xx3) @ XF)))))))))))).
