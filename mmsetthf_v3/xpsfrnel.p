...
thf(cxpsfrnel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XG @ (ccixp @ (^ [Xk:$i] : cc2o) @ (^ [Xk:$i] : (ccif @ ((ccv @ Xk) = cc0) @ XA2 @ XB2)))) <=> ((cwfn @ XG @ cc2o) & (cwcel @ (ccfv @ cc0 @ XG) @ XA2) & (cwcel @ (ccfv @ cc1o @ XG) @ XB2))))))).
