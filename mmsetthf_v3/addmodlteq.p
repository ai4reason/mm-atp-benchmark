...
thf(apossumd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt) <=> (cwbr @ (ccneg @ XB2) @ XA2 @ cclt))))))))).
...
thf(amulle0b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ ccle) <=> (((cwbr @ XA2 @ ccc0 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle)) | ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XB2 @ ccc0 @ ccle)))))))).
thf(caddmodlteq_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XS @ ccz)) => (((cco @ (cco @ XI @ XS @ ccaddc) @ XN @ ccmo) = (cco @ (cco @ XJ @ XS @ ccaddc) @ XN @ ccmo)) <=> (XI = XJ)))))))).
