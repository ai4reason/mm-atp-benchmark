...
thf(apthdlem2lem_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwcel @ XP @ (ccword @ ccvv))) => ((XR = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) != (ccv @ Xj)) => ((ccfv @ (ccv @ Xi) @ XP) != (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => ((Xph & (cwcel @ (ccfv @ XP @ cchash) @ ccn) & ((XI = ccc0) | (XI = XR))) => (cwnel @ (ccfv @ XI @ XP) @ (ccima @ XP @ (cco @ cc1 @ XR @ ccfzo)))))))))))).
...
thf(afvinim0ffz_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (((cwf @ (cco @ ccc0 @ XK @ ccfz) @ XV @ XF) & (cwcel @ XK @ ccn0)) => (((ccin @ (ccima @ XF @ (ccpr @ ccc0 @ XK)) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) = cc0) <=> ((cwnel @ (ccfv @ ccc0 @ XF) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) & (cwnel @ (ccfv @ XK @ XF) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo)))))))))).
...
thf(cpthdlem2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XP @ (ccword @ ccvv))) => ((XR = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) != (ccv @ Xj)) => ((ccfv @ (ccv @ Xi) @ XP) != (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => (Xph => ((ccin @ (ccima @ XP @ (ccpr @ ccc0 @ XR)) @ (ccima @ XP @ (cco @ cc1 @ XR @ ccfzo))) = cc0))))))))).
