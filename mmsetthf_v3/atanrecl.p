...
thf(aatan0_thm,axiom,((ccfv @ ccc0 @ ccatan) = ccc0)).
...
thf(aatancj_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ ccre) != ccc0)) => ((cwcel @ XA2 @ (ccdm @ ccatan)) & ((ccfv @ (ccfv @ XA2 @ ccatan) @ cccj) = (ccfv @ (ccfv @ XA2 @ cccj) @ ccatan)))))).
thf(acjre_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ cccj) = XA2)))).
thf(catanrecl_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ XA2 @ ccatan) @ ccr)))).
