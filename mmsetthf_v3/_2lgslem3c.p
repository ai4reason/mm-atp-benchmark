...
thf(c_2lgslem3c_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XK @ ccn0) & (XP = (cco @ (cco @ cc8 @ XK @ ccmul) @ cc5 @ ccaddc))) => (XN = (cco @ (cco @ cc2 @ XK @ ccmul) @ cc1 @ ccaddc)))))))).
