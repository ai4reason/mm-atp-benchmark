...
thf(adfac8c_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xf1:$i] : ((cwcel @ XA2 @ (XB2 @ Xz @ Xf1)) => ((? [Xr:$i] : (cwwe @ (ccuni @ XA2) @ (ccv @ Xr))) => (? [Xf1:$i] : (cwral @ (^ [Xz:$i] : (((ccv @ Xz) != cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XA2)))))))))).
...
thf(cvitali_conj,conjecture,(! [Xc_lt:($i > $o)] : ((cwwe @ ccr @ Xc_lt) => (cwpss @ (ccdm @ ccvol) @ (ccpw @ ccr))))).
