...
thf(celmpst_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XT @ ccmdv)) => ((XE = (ccfv @ XT @ ccmex)) => ((XP = (ccfv @ XT @ ccmpst)) => ((cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) <=> (((cwss @ XD @ XV) & ((cccnv @ XD) = XD)) & ((cwss @ XH @ XE) & (cwcel @ XH @ ccfn)) & (cwcel @ XA2 @ XE)))))))))))))).
