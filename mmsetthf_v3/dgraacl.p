...
thf(adgraalem_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((cwcel @ (ccfv @ XA2 @ ccdgraa) @ ccn) & (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xp) @ ccdgr) = (ccfv @ XA2 @ ccdgraa)) & ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))).
