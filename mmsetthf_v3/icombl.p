...
thf(aicoun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & ((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ XB2 @ XC @ ccle))) => ((ccun @ (cco @ XA2 @ XB2 @ ccico) @ (cco @ XB2 @ XC @ ccico)) = (cco @ XA2 @ XC @ ccico))))))).
...
thf(cicombl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccxr)) => (cwcel @ (cco @ XA2 @ XB2 @ ccico) @ (ccdm @ ccvol)))))).
