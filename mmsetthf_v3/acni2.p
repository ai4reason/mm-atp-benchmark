...
thf(aacni_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ (cwacn @ XA2)) & (cwf @ XA2 @ (ccdif @ (ccpw @ XX) @ (ccsn @ cc0)) @ XF)) => (? [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(cacni2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : (((cwcel @ XX @ (cwacn @ XA2)) & (cwral @ (^ [Xx3:$i] : ((cwss @ (XB2 @ Xx3) @ XX) & ((XB2 @ Xx3) != cc0))) @ (^ [Xx3:$i] : XA2))) => (? [Xg1:$i] : ((cwf @ XA2 @ XX @ (ccv @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))).
