...
thf(celovimad_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ XC)) => ((Xph => (cwcel @ XB2 @ XD)) => ((Xph => (cwfun @ XF)) => ((Xph => (cwss @ (ccxp @ XC @ XD) @ (ccdm @ XF))) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ XF) @ (ccima @ XF @ (ccxp @ XC @ XD))))))))))))))).
