...
thf(clautcnvclN_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XI = (ccfv @ XK @ cclaut)) => ((((cwcel @ XK @ XV) & (cwcel @ XF @ XI)) & (cwcel @ XX @ XB2)) => (cwcel @ (ccfv @ XX @ (cccnv @ XF)) @ XB2))))))))))).
