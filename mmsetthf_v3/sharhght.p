...
thf(csharhght_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ cccj) @ (ccv @ Xy1) @ ccmul) @ ccim))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ ccc))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwcel @ XD @ ccc) & ((cco @ (cco @ XA2 @ XD @ ccmin) @ (cco @ XB2 @ XD @ ccmin) @ (XG @ Xx3 @ Xy1)) = ccc0))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cco @ (cco @ (cco @ XC @ XA2 @ ccmin) @ (cco @ XD @ XA2 @ ccmin) @ (XG @ Xx3 @ Xy1)) @ (cco @ XB2 @ XD @ ccmin) @ ccmul) = (cco @ (cco @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XD @ XB2 @ ccmin) @ (XG @ Xx3 @ Xy1)) @ (cco @ XA2 @ XD @ ccmin) @ ccmul))))))))))))))).
