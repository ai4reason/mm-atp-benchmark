...
thf(cfsumsplitsnunOLD_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (((cwcel @ (XA2 @ Xz) @ ccfn) & (cwnel @ (ccv @ Xz) @ (XA2 @ Xz)) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xz @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz)))))) => ((ccsu @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) = (cco @ (ccsu @ (XA2 @ Xz) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) @ (ccsb @ (ccv @ Xz) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) @ ccaddc))))))).
