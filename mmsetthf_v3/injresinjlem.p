...
thf(cinjresinjlem_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((~ (cwcel @ XY @ (cco @ cc1 @ XK @ ccfzo))) => (((ccfv @ ccc0 @ XF) != (ccfv @ XK @ XF)) => (((cwf @ (cco @ ccc0 @ XK @ ccfz) @ XV @ XF) & (cwcel @ XK @ ccn0)) => (((ccin @ (ccima @ XF @ (ccpr @ ccc0 @ XK)) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) = cc0) => (((cwcel @ XX @ (cco @ ccc0 @ XK @ ccfz)) & (cwcel @ XY @ (cco @ ccc0 @ XK @ ccfz))) => (((ccfv @ XX @ XF) = (ccfv @ XY @ XF)) => (XX = XY))))))))))))).
