...
thf(acvrnbtwn4_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ ccpo) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2)) & (cwbr @ XX @ XY @ XC)) => (((cwbr @ XX @ XZ @ Xc_le) & (cwbr @ XZ @ XY @ Xc_le)) <=> ((XX = XZ) | (XZ = XY))))))))))))))).
...
thf(c_2llnmat_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XN) & (cwcel @ XY @ XN)) & ((XX != XY) & ((cco @ XX @ XY @ Xc_an) != Xc_0))) => (cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2)))))))))))))).
