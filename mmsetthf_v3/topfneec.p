...
thf(afneer_thm,axiom,(! [Xc_sm:($i > $o)] : ((Xc_sm = (ccin @ ccfne @ (cccnv @ ccfne))) => (cwer @ ccvv @ Xc_sm)))).
...
thf(afneval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_sm = (ccin @ ccfne @ (cccnv @ ccfne))) => (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ XA2 @ XB2 @ Xc_sm) <=> ((ccfv @ XA2 @ cctg) = (ccfv @ XB2 @ cctg))))))))))).
...
thf(ctopfneec_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XJ:($i > $o)] : ((Xc_sm = (ccin @ ccfne @ (cccnv @ ccfne))) => ((cwcel @ XJ @ cctop) => ((cwcel @ XA2 @ (ccec @ XJ @ Xc_sm)) <=> ((ccfv @ XA2 @ cctg) = XJ)))))))).
