...
thf(cptopn2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ cctop @ XF)) => ((! [Xk:$i] : (Xph => (cwcel @ (XO @ Xk) @ (ccfv @ XY @ XF)))) => (Xph => (cwcel @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ ((ccv @ Xk) = XY) @ (XO @ Xk) @ (ccuni @ (ccfv @ (ccv @ Xk) @ XF))))) @ (ccfv @ XF @ ccpt))))))))))))).
