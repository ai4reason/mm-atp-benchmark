...
thf(awlknwwlksnbij_thm,axiom,(! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XT = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks)))) => ((XW = (cco @ XN @ XG @ ccwwlksn)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd))))) => (! [Xt:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) => (cwf1o @ XT @ XW @ (XF @ Xt))))))))))))).
...
thf(cwlksnwwlknvbij_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XG @ ccusgr) & (cwcel @ XN @ ccn0) & (cwcel @ XX @ (ccfv @ XG @ ccvtx))) => (? [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xp:$i] : (((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN) & ((ccfv @ ccc0 @ (ccfv @ (ccv @ Xp) @ cc2nd)) = XX))) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XX)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))) @ (ccv @ Xf1)))))))).
