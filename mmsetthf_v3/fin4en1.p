...
thf(af1imapss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & ((cwss @ XC @ XA2) & (cwss @ XD @ XA2))) => ((cwpss @ (ccima @ XF @ XC) @ (ccima @ XF @ XD)) <=> (cwpss @ XC @ XD))))))))).
...
thf(afin4i_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwpss @ XX @ XA2) & (cwbr @ XX @ XA2 @ ccen)) => (~ (cwcel @ XA2 @ ccfin4)))))).
...
thf(aisfin4_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xy1)) => ((cwcel @ XA2 @ ccfin4) <=> (~ (? [Xy1:$i] : ((cwpss @ (ccv @ Xy1) @ XA2) & (cwbr @ (ccv @ Xy1) @ XA2 @ ccen)))))))))).
thf(cfin4en1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwcel @ XA2 @ ccfin4) => (cwcel @ XB2 @ ccfin4)))))).
