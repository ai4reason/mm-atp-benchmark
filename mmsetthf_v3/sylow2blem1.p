...
thf(agrplmulf1o_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XX @ (ccv @ Xx3) @ Xc_pl))))) => (! [Xx3:$i] : (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ XB2)) => (cwf1o @ XB2 @ XB2 @ (XF @ Xx3))))))))))))).
...
thf(aeqgen_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_sm = (cco @ XG @ XY @ ccqg)) => (((cwcel @ XY @ (ccfv @ XG @ ccsubg)) & (cwcel @ XA2 @ (ccqs @ XX @ Xc_sm))) => (cwbr @ XY @ XA2 @ ccen)))))))))).
...
thf(csylow2blem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XX @ ccfn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XH @ (ccfv @ XG @ ccsubg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XK @ (ccfv @ XG @ ccsubg))))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_sm = (cco @ XG @ XK @ ccqg)) => ((Xc_x = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XH)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3 @ Xy1) & (cwcel @ XB2 @ XH) & (cwcel @ XC @ XX)) => ((cco @ XB2 @ (ccec @ XC @ Xc_sm) @ Xc_x) = (ccec @ (cco @ XB2 @ XC @ Xc_pl) @ Xc_sm))))))))))))))))))))))).
