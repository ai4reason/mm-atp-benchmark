...
thf(cnumltc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccn) => ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwbr @ XC @ XT @ cclt) => ((cwbr @ XA2 @ XB2 @ cclt) => (cwbr @ (cco @ (cco @ XT @ XA2 @ ccmul) @ XC @ ccaddc) @ (cco @ (cco @ XT @ XB2 @ ccmul) @ XD @ ccaddc) @ cclt)))))))))))))).
