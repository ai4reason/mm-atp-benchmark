...
thf(celimdelov_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ XF))) => ((cwcel @ XZ @ (cco @ XX @ XY @ XF)) => (cwcel @ (ccif @ Xph @ XC @ XZ) @ (cco @ (ccif @ Xph @ XA2 @ XX) @ (ccif @ Xph @ XB2 @ XY) @ XF))))))))))))).
