...
thf(cclmsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & (cwcel @ XA2 @ XK) & (cwcel @ XB2 @ XK)) => ((cco @ XA2 @ XB2 @ ccmin) = (cco @ XA2 @ XB2 @ (ccfv @ XF @ ccsg)))))))))))).
