...
thf(aofcof_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XC @ XW)) => (Xph => ((cco @ XF @ XC @ (ccofc @ XR)) = (cco @ XF @ (ccxp @ XA2 @ (ccsn @ XC)) @ (ccof @ XR)))))))))))))))).
