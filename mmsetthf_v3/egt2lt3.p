...
thf(aege2le3_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => ((cwbr @ cc2 @ cceu @ ccle) & (cwbr @ cceu @ cc3 @ ccle))))))).
...
thf(cegt2lt3_conj,conjecture,((cwbr @ cc2 @ cceu @ cclt) & (cwbr @ cceu @ cc3 @ cclt))).
