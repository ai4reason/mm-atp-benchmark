...
thf(adf_mre_ax,axiom,(ccmre = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xc:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xc)) & (cwral @ (^ [Xs1:$i] : (((ccv @ Xs1) != cc0) => (cwcel @ (ccint @ (ccv @ Xs1)) @ (ccv @ Xc)))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xc)))))) @ (^ [Xc:$i] : (ccpw @ (ccpw @ (ccv @ Xx3))))))))).
...
thf(cismre_conj,conjecture,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccmre)) <=> ((cwss @ XC @ (ccpw @ XX)) & (cwcel @ XX @ XC) & (cwral @ (^ [Xs1:$i] : (((ccv @ Xs1) != cc0) => (cwcel @ (ccint @ (ccv @ Xs1)) @ XC))) @ (^ [Xs1:$i] : (ccpw @ XC)))))))).
