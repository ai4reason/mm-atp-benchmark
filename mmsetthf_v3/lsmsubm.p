...
thf(alsmub1x_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_po = (ccfv @ XG @ cclsm)) => (((cwss @ XT @ XB2) & (cwcel @ XU @ (ccfv @ XG @ ccsubmnd))) => (cwss @ XT @ (cco @ XT @ XU @ Xc_po))))))))))).
...
thf(clsmsubm_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((XZ = (ccfv @ XG @ cccntz)) => (((cwcel @ XT @ (ccfv @ XG @ ccsubmnd)) & (cwcel @ XU @ (ccfv @ XG @ ccsubmnd)) & (cwss @ XT @ (ccfv @ XU @ XZ))) => (cwcel @ (cco @ XT @ XU @ Xc_po) @ (ccfv @ XG @ ccsubmnd))))))))))).
