...
thf(c_2cshw_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XW @ XM @ cccsh) @ XN @ cccsh) = (cco @ XW @ (cco @ XM @ XN @ ccaddc) @ cccsh)))))))).
