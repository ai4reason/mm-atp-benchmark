...
thf(adf_grpo_ax,axiom,(ccgr = (^ [Xg1:$i] : (? [Xt:$i] : ((cwf @ (ccxp @ (ccv @ Xt) @ (ccv @ Xt)) @ (ccv @ Xt) @ (ccv @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xz) @ (ccv @ Xg1)) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xg1)))) @ (^ [Xz:$i] : (ccv @ Xt)))) @ (^ [Xy1:$i] : (ccv @ Xt)))) @ (^ [Xx3:$i] : (ccv @ Xt))) & (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ (ccv @ Xg1)) = (ccv @ Xx3)) & (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xg1)) = (ccv @ Xu))) @ (^ [Xy1:$i] : (ccv @ Xt))))) @ (^ [Xx3:$i] : (ccv @ Xt)))) @ (^ [Xu:$i] : (ccv @ Xt)))))))).
...
thf(cisgrpo_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : ((cwcel @ XG @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xu)) => ((cwcel @ XG @ ccgr) <=> ((cwf @ (ccxp @ XX @ XX) @ XX @ XG) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)) & (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) = (ccv @ Xx3)) & (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) = (ccv @ Xu))) @ (^ [Xy1:$i] : XX)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX)))))))))))))).
