...
thf(cisrrext_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XD = (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XB2 @ XB2))) => ((XZ = (ccfv @ XR @ cczlm)) => ((cwcel @ XR @ ccrrext) <=> (((cwcel @ XR @ ccnrg) & (cwcel @ XR @ ccdr)) & ((cwcel @ XZ @ ccnlm) & ((ccfv @ XR @ ccchr) = ccc0)) & ((cwcel @ XR @ cccusp) & ((ccfv @ XR @ ccuss) = (ccfv @ XD @ ccmetu))))))))))))).
