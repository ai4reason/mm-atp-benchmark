...
thf(ahlatexchb2_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & (XP != XR)) => ((cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le) <=> ((cco @ XP @ XR @ Xc_or) = (cco @ XQ @ XR @ Xc_or))))))))))))))).
...
thf(c_3atlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & ((cwcel @ XS @ XA2) & (cwcel @ XT @ XA2) & (cwcel @ XU @ XA2))) & ((~ (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & ((XP != XU) & (cwbr @ XP @ (cco @ XT @ XU @ Xc_or) @ Xc_le)) & (~ (cwbr @ XQ @ (cco @ XP @ XU @ Xc_or) @ Xc_le))) & (cwbr @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XR @ Xc_or) @ (cco @ (cco @ XS @ XT @ Xc_or) @ XU @ Xc_or) @ Xc_le)) => ((cco @ (cco @ XP @ XQ @ Xc_or) @ XR @ Xc_or) = (cco @ (cco @ XS @ XT @ Xc_or) @ XU @ Xc_or))))))))))))))))).
