...
thf(climsuplt2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xk:$i] : ((Xph @ Xk) => (cwss @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwf @ (XB2 @ Xk) @ ccxr @ XF))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccxr))) => (! [Xk:$i] : ((Xph @ Xk) => ((cwbr @ (ccfv @ XF @ cclsp) @ XA2 @ cclt) <=> (cwrex @ (^ [Xk:$i] : (cwbr @ (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ XA2 @ cclt)) @ (^ [Xk:$i] : ccr))))))))))))).
