...
thf(ccgrtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee))) & ((cwcel @ XD @ (ccfv @ XN @ ccee)) & (cwcel @ XE @ (ccfv @ XN @ ccee)) & (cwcel @ XF @ (ccfv @ XN @ ccee)))) => (((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cccgr) & (cwbr @ (ccop @ XC @ XD) @ (ccop @ XE @ XF) @ cccgr)) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XE @ XF) @ cccgr))))))))))).
