...
thf(afnmap_thm,axiom,(cwfn @ ccmap @ (ccxp @ ccvv @ ccvv))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(afndm_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccdm @ XF) = XA2))))).
thf(celmapex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) => ((cwcel @ XB2 @ ccvv) & (cwcel @ XC @ ccvv))))))).
