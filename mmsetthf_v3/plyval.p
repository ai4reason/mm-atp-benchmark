...
thf(cplyval_conj,conjecture,(! [XS:($i > $o)] : ((cwss @ XS @ ccc) => ((ccfv @ XS @ ccply) = (^ [Xf1:$i] : (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xa:$i] : ((ccv @ Xf1) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))) @ (^ [Xa:$i] : (cco @ (ccun @ XS @ (ccsn @ ccc0)) @ ccn0 @ ccmap)))) @ (^ [Xn:$i] : ccn0))))))).
