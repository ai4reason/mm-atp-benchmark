...
thf(cnoextenddif_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccpr @ cc1o @ cc2o)) => ((cwcel @ XA2 @ ccsur) => ((ccint @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) != (ccfv @ (ccv @ Xx3) @ (ccun @ XA2 @ (ccsn @ (ccop @ (ccdm @ XA2) @ XX)))))) @ (^ [Xx3:$i] : ccon0))) = (ccdm @ XA2))))))).
