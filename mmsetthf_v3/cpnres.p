...
thf(afncpn_thm,axiom,(! [XS:($i > $o)] : ((cwss @ XS @ ccc) => (cwfn @ (ccfv @ XS @ cccpn) @ ccn0)))).
...
thf(advnres_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XF @ (cco @ ccc @ ccc @ ccpm)) & (cwcel @ XN @ ccn0)) & ((ccdm @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn))) = (ccdm @ XF))) => ((ccfv @ XN @ (cco @ XS @ (ccres @ XF @ XS) @ ccdvn)) = (ccres @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn)) @ XS))))))).
...
thf(ccpnres_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XF @ (ccfv @ XN @ (ccfv @ ccc @ cccpn)))) => (cwcel @ (ccres @ XF @ XS) @ (ccfv @ XN @ (ccfv @ XS @ cccpn)))))))).
