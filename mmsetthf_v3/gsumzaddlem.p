...
thf(asuppun_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XG @ XV)) => (Xph => (cwss @ (cco @ XF @ XZ @ ccsupp) @ (cco @ (ccun @ XF @ XG) @ XZ @ ccsupp)))))))))).
...
thf(afsuppun_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => (cwbr @ XG @ XZ @ ccfsupp)) => (Xph => (cwcel @ (cco @ (ccun @ XF @ XG) @ XZ @ ccsupp) @ ccfn))))))))).
