...
thf(cshftmbl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ XA2)) @ (^ [Xx3:$i] : ccr)) @ (ccdm @ ccvol)))))).
