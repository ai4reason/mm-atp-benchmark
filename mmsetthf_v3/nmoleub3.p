...
thf(anmrpcl_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ XX) & (XA2 != Xc_0)) => (cwcel @ (ccfv @ XA2 @ XN) @ ccrp))))))))))).
...
thf(aclmvscl_thm,axiom,(! [XQ:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & (cwcel @ XQ @ XK) & (cwcel @ XX @ XV)) => (cwcel @ (cco @ XQ @ XX @ Xc_x) @ XV)))))))))))))).
