...
thf(cisomenndlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xn:$i] : (Xph => (cwf @ (ccpw @ (XX @ Xn)) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XO))) => ((Xph => ((ccfv @ cc0 @ XO) = ccc0)) => ((! [Xn:$i] : (! [Xa:$i] : (Xph => (cwss @ (XY @ Xa) @ (ccpw @ (XX @ Xn)))))) => ((! [Xn:$i] : (! [Xa:$i] : ((Xph & (cwf @ ccn @ (ccpw @ (XX @ Xn)) @ (ccv @ Xa))) => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xa)))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xa)) @ XO))) @ ccsumge0) @ ccle)))) => ((! [Xa:$i] : (Xph => (cwss @ (XB2 @ Xa) @ ccn))) => ((! [Xa:$i] : (Xph => (cwf1o @ (XB2 @ Xa) @ (XY @ Xa) @ (XF @ Xa)))) => ((! [Xa:$i] : (XA2 = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ (XB2 @ Xa)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xa)) @ cc0))))) => (! [Xa:$i] : (Xph => (cwbr @ (ccfv @ (ccuni @ (XY @ Xa)) @ XO) @ (ccfv @ (ccres @ XO @ (XY @ Xa)) @ ccsumge0) @ ccle)))))))))))))))))).
