...
thf(cneifg_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & (XS != cc0)) => ((cco @ XX @ (ccrab @ (^ [Xx3:$i] : (cwss @ XS @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XJ)) @ ccfg) = (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))).
