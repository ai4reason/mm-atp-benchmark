...
thf(almodlcan_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ cclmod) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV) & (cwcel @ XZ @ XV))) => (((cco @ XZ @ XX @ Xc_pl) = (cco @ XZ @ XY @ Xc_pl)) <=> (XX = XY)))))))))))).
thf(chdmapneg_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((XM = (ccfv @ XU @ ccminusg)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((XI = (ccfv @ XC @ ccminusg)) => ((XS = (ccfv @ XW @ (ccfv @ XK @ cchdma))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XT @ XV)) => (Xph => ((ccfv @ (ccfv @ XT @ XM) @ XS) = (ccfv @ (ccfv @ XT @ XS) @ XI)))))))))))))))))))))))).
