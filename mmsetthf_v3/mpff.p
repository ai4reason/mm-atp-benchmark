...
thf(cmpff_conj,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => ((XB2 = (ccfv @ XS @ ccbs)) => ((cwcel @ XF @ XQ) => (cwf @ (cco @ XB2 @ XI @ ccmap) @ XB2 @ XF))))))))))).
