...
thf(cidsrngd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_as = (ccfv @ XR @ ccstv)) => ((Xph => (cwcel @ XR @ cccrg)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((ccfv @ (ccv @ Xx3) @ Xc_as) = (ccv @ Xx3)))) => (Xph => (cwcel @ XR @ ccsr))))))))))).
