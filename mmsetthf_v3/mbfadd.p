...
thf(ambfaddlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwf @ XA2 @ ccr @ XG)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccmbf))))))))))).
