...
thf(ciunrelexpuztr_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XC = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp)))))) => (! [Xr:$i] : (((cwcel @ XR @ (XV @ Xr)) & (XN = (ccfv @ (XM @ Xr) @ ccuz)) & (cwcel @ (XM @ Xr) @ ccn0)) => (cwss @ (cccom @ (ccfv @ XR @ XC) @ (ccfv @ XR @ XC)) @ (ccfv @ XR @ XC))))))))))).
