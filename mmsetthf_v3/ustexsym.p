...
thf(austssco_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwss @ XV @ (cccom @ XV @ XV))))))).
...
thf(custexsym_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xw:$i] : (((cwcel @ XU @ (ccfv @ (XX @ Xw) @ ccust)) & (cwcel @ XV @ XU)) => (cwrex @ (^ [Xw:$i] : (((cccnv @ (ccv @ Xw)) = (ccv @ Xw)) & (cwss @ (ccv @ Xw) @ XV))) @ (^ [Xw:$i] : XU)))))))).
