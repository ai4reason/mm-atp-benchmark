...
thf(alfladdass_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XR = (ccfv @ XW @ ccsca)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((XF = (ccfv @ XW @ cclfn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XH @ XF)) => ((Xph => (cwcel @ XI @ XF)) => (Xph => ((cco @ (cco @ XG @ XH @ (ccof @ Xc_pl)) @ XI @ (ccof @ Xc_pl)) = (cco @ XG @ (cco @ XH @ XI @ (ccof @ Xc_pl)) @ (ccof @ Xc_pl)))))))))))))))))))).
...
thf(alflnegcl_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XR = (ccfv @ XW @ ccsca)) => ((XI = (ccfv @ XR @ ccminusg)) => ((! [Xx3:$i] : ((XN @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XG) @ XI))))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccfv @ XW @ cclfn))) => ((Xph => (cwcel @ XW @ cclmod)) => ((! [Xx3:$i] : (Xph => (cwcel @ XG @ (XF @ Xx3)))) => (! [Xx3:$i] : (Xph => (cwcel @ (XN @ Xx3) @ (XF @ Xx3)))))))))))))))))))).
