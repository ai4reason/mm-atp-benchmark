...
thf(afsumcnsrcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ XS))) => (Xph => (cwcel @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ XS)))))))))).
...
thf(acnsrexpcl_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ ccn0)) => (Xph => (cwcel @ (cco @ XX @ XY @ ccexp) @ XS)))))))))).
