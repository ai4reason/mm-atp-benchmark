...
thf(crmxycomplete_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XX @ ccn0) & (cwcel @ XY @ ccz)) => (((cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ XY @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1) <=> (cwrex @ (^ [Xn:$i] : ((XX = (cco @ XA2 @ (ccv @ Xn) @ ccrmx)) & (XY = (cco @ XA2 @ (ccv @ Xn) @ ccrmy)))) @ (^ [Xn:$i] : ccz)))))))).
