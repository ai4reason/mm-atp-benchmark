...
thf(crelexpnul_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XR @ XV) & (cwrel @ XR)) & ((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0))) => (((ccin @ (ccdm @ (cco @ XR @ XN @ ccrelexp)) @ (ccrn @ (cco @ XR @ XM @ ccrelexp))) = cc0) <=> ((cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp) = cc0)))))))).
