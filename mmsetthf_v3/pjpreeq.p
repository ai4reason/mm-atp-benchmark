...
thf(cpjpreeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ (cco @ XH @ (ccfv @ XH @ ccort) @ ccph))) => (((ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) = XB2) <=> ((cwcel @ XB2 @ XH) & (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ XB2 @ (ccv @ Xx3) @ ccva))) @ (^ [Xx3:$i] : (ccfv @ XH @ ccort)))))))))).
