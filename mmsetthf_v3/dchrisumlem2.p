...
thf(adchrisumlema_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xn) = (ccfv @ XN @ ccdchr)))) => ((! [Xx3:$i] : (! [Xn:$i] : (XD = (ccfv @ (XG @ Xx3 @ Xn) @ ccbs)))) => ((! [Xx3:$i] : (! [Xn:$i] : (Xc_1 = (ccfv @ (XG @ Xx3 @ Xn) @ cc0g)))) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (XX != Xc_1)) => ((! [Xx3:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xx3)) => ((XA2 @ Xn) = (XB2 @ Xx3))))) => ((Xph => (cwcel @ XM @ ccn)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccrp)) => (cwcel @ (XA2 @ Xn) @ ccr))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ ccrp) & (cwcel @ (ccv @ Xx3) @ ccrp)) & ((cwbr @ XM @ (ccv @ Xn) @ ccle) & (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccle))) => (cwbr @ (XB2 @ Xx3) @ (XA2 @ Xn) @ ccle)))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccc0 @ ccrli)) => ((XF = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (XA2 @ Xn) @ ccmul)))) => (Xph => (((cwcel @ XI @ ccrp) => (cwcel @ (ccsb @ XI @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccr)) & ((cwcel @ XI @ (cco @ XM @ ccpnf @ ccico)) => (cwbr @ ccc0 @ (ccsb @ XI @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccle)))))))))))))))))))))))))))))))).
...
thf(afzosump1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (((ccv @ Xk) = XN) => ((XA2 @ Xk) = XB2))) => (Xph => ((ccsu @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo) @ (^ [Xk:$i] : (XA2 @ Xk))) = (cco @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XB2 @ ccaddc)))))))))))).
...
thf(afsumparts_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (ccv @ Xj)) => (((XA2 @ Xk) = (XB2 @ Xj)) & ((XV @ Xk) = (XW @ Xj)))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (cco @ (ccv @ Xj) @ cc1 @ ccaddc)) => (((XA2 @ Xk) = (XC @ Xj)) & ((XV @ Xk) = (XX @ Xj)))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = XM) => (((XA2 @ Xk) = (XD @ Xj)) & ((XV @ Xk) = (XY @ Xj)))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = XN) => (((XA2 @ Xk) = (XE @ Xj)) & ((XV @ Xk) = (XZ @ Xj)))))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XV @ Xk) @ ccc))) => (! [Xj:$i] : (Xph => ((ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xj:$i] : (cco @ (XB2 @ Xj) @ (cco @ (XX @ Xj) @ (XW @ Xj) @ ccmin) @ ccmul))) = (cco @ (cco @ (cco @ (XE @ Xj) @ (XZ @ Xj) @ ccmul) @ (cco @ (XD @ Xj) @ (XY @ Xj) @ ccmul) @ ccmin) @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xj:$i] : (cco @ (cco @ (XC @ Xj) @ (XB2 @ Xj) @ ccmin) @ (XX @ Xj) @ ccmul))) @ ccmin))))))))))))))))))))))))).
...
thf(atelfsumo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (ccv @ Xj)) => ((XA2 @ Xk) = (XB2 @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (cco @ (ccv @ Xj) @ cc1 @ ccaddc)) => ((XA2 @ Xk) = (XC @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = (XD @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = XN) => ((XA2 @ Xk) = (XE @ Xj))))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => (! [Xj:$i] : (Xph => ((ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xj:$i] : (cco @ (XB2 @ Xj) @ (XC @ Xj) @ ccmin))) = (cco @ (XD @ Xj) @ (XE @ Xj) @ ccmin))))))))))))))))))).
...
thf(cdchrisumlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xu:$i] : ((XZ @ Xu) = (ccfv @ XN @ cczn))) => ((! [Xu:$i] : (XL = (ccfv @ (XZ @ Xu) @ cczrh))) => ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xu @ Xn) = (ccfv @ XN @ ccdchr))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : ((XD @ Xu) = (ccfv @ (XG @ Xx3 @ Xu @ Xn) @ ccbs))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : ((Xc_1 @ Xu) = (ccfv @ (XG @ Xx3 @ Xu @ Xn) @ cc0g))))) => ((! [Xu:$i] : (Xph => (cwcel @ XX @ (XD @ Xu)))) => ((! [Xu:$i] : (Xph => (XX != (Xc_1 @ Xu)))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xx3)) => ((XA2 @ Xu @ Xn) = (XB2 @ Xx3 @ Xu)))))) => ((Xph => (cwcel @ XM @ ccn)) => ((! [Xu:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccrp)) => (cwcel @ (XA2 @ Xu @ Xn) @ ccr)))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ ccrp) & (cwcel @ (ccv @ Xx3) @ ccrp)) & ((cwbr @ XM @ (ccv @ Xn) @ ccle) & (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccle))) => (cwbr @ (XB2 @ Xx3 @ Xu) @ (XA2 @ Xu @ Xn) @ ccle))))) => ((! [Xu:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (XA2 @ Xu @ Xn))) @ ccc0 @ ccrli))) => ((! [Xu:$i] : (XF = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (XA2 @ Xu @ Xn) @ ccmul))))) => ((Xph => (cwcel @ XR @ ccr)) => ((Xph => (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (ccsu @ (cco @ ccc0 @ (ccv @ Xu) @ ccfzo) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX))) @ ccabs) @ XR @ ccle)) @ (^ [Xu:$i] : (cco @ ccc0 @ XN @ ccfzo)))) => ((Xph => (cwcel @ XU @ ccrp)) => ((Xph => (cwbr @ XM @ XU @ ccle)) => ((Xph => (cwbr @ XU @ (cco @ XI @ cc1 @ ccaddc) @ ccle)) => ((Xph => (cwcel @ XI @ ccn)) => ((Xph => (cwcel @ XJ @ (ccfv @ XI @ ccuz))) => (! [Xu:$i] : (Xph => (cwbr @ (ccfv @ (cco @ (ccfv @ XJ @ (ccseq @ ccaddc @ XF @ cc1)) @ (ccfv @ XI @ (ccseq @ ccaddc @ XF @ cc1)) @ ccmin) @ ccabs) @ (cco @ (cco @ cc2 @ XR @ ccmul) @ (ccsb @ XU @ (^ [Xn:$i] : (XA2 @ Xu @ Xn))) @ ccmul) @ ccle))))))))))))))))))))))))))))))))))))))))).
