...
thf(cclwwlkext2edg_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XZ @ XV) & (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) & (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ XN @ XG @ ccclwwlkn))) => ((cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) & (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)))))))))))).
