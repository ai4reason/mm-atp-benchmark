...
thf(adia1dim_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((! [Xg1:$i] : ((XE @ Xg1) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xg1:$i] : (! [Xs1:$i] : ((XI @ Xg1 @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccdia))))) => (! [Xg1:$i] : (! [Xs1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT)) => ((ccfv @ (ccfv @ XF @ XR) @ (XI @ Xg1 @ Xs1)) = (^ [Xg1:$i] : (cwrex @ (^ [Xs1:$i] : ((ccv @ Xg1) = (ccfv @ XF @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (XE @ Xg1)))))))))))))))))))))).
thf(cdia1dim2_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdveca))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((XN = (ccfv @ XU @ cclspn)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT)) => ((ccfv @ (ccfv @ XF @ XR) @ XI) = (ccfv @ (ccsn @ XF) @ XN))))))))))))))))))).
