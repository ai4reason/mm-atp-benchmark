...
thf(awwlksnextbi_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XN @ ccn0) & (cwcel @ XS @ XV)) & ((cwcel @ XT @ (ccword @ XV)) & (XW = (cco @ XT @ (ccs1 @ XS) @ ccconcat)) & (cwcel @ (ccpr @ (ccfv @ XT @ cclsw) @ XS) @ XE))) => ((cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) <=> (cwcel @ XT @ (cco @ XN @ XG @ ccwwlksn)))))))))))))).
...
thf(cwwlksnextwrd_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : ((XE @ Xw) = (ccfv @ XG @ ccedg))) => ((! [Xw:$i] : ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : (((ccfv @ (ccv @ Xw) @ cchash) = (cco @ XN @ cc2 @ ccaddc)) & ((cco @ (ccv @ Xw) @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) = XW) & (cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ (ccfv @ (ccv @ Xw) @ cclsw)) @ (XE @ Xw)))) @ (^ [Xw:$i] : (ccword @ (XV @ Xw)))))) => (! [Xw:$i] : ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : (((cco @ (ccv @ Xw) @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) = XW) & (cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ (ccfv @ (ccv @ Xw) @ cclsw)) @ (XE @ Xw)))) @ (^ [Xw:$i] : (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)))))))))))))))).
