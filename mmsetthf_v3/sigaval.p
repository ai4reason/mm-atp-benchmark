...
thf(csigaval_conj,conjecture,(! [XO:($i > $o)] : ((cwcel @ XO @ ccvv) => ((ccfv @ XO @ ccsiga) = (^ [Xs1:$i] : ((cwss @ (ccv @ Xs1) @ (ccpw @ XO)) & ((cwcel @ XO @ (ccv @ Xs1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XO @ (ccv @ Xx3)) @ (ccv @ Xs1))) @ (^ [Xx3:$i] : (ccv @ Xs1))) & (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xs1))))))))))).
