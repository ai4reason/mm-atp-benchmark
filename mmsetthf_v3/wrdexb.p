...
thf(asnopiswrd_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => (cwcel @ (ccsn @ (ccop @ ccc0 @ XS)) @ (ccword @ XV)))))).
...
thf(cwrdexb_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ ccvv) <=> (cwcel @ (ccword @ XS) @ ccvv)))).
