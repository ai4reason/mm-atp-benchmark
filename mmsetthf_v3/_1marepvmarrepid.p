...
thf(ama1repveval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XE = (ccfv @ XK @ (cco @ Xc_1 @ XC @ (cco @ XN @ XR @ ccmatrepV)))) => (((cwcel @ XR @ ccrg) & ((cwcel @ XM @ XB2) & (cwcel @ XC @ XV) & (cwcel @ XK @ XN)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ XE) = (ccif @ (XJ = XK) @ (ccfv @ XI @ XC) @ (ccif @ (XJ = XI) @ (ccfv @ XR @ ccur) @ Xc_0)))))))))))))))))))))))).
...
thf(c_1marepvmarrepid_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_1 = (ccfv @ (cco @ XN @ XR @ ccmat) @ ccur)) => ((XX = (ccfv @ XI @ (cco @ Xc_1 @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn)) & ((cwcel @ XI @ XN) & (cwcel @ XZ @ XV))) => ((cco @ XI @ XI @ (cco @ XX @ (ccfv @ XI @ XZ) @ (cco @ XN @ XR @ ccmarrep))) = XX))))))))))))).
