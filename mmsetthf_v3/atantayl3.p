...
thf(catantayl3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xn) @ ccexp) @ (cco @ (cco @ XA2 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))))) => (! [Xn:$i] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ ccc0) @ (ccfv @ XA2 @ ccatan) @ ccli))))))).
