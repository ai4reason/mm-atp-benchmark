...
thf(ai1f1lem_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0))))) => (! [Xx3:$i] : ((cwf @ ccr @ (ccpr @ ccc0 @ cc1) @ (XF @ Xx3)) & ((cwcel @ XA2 @ (ccdm @ ccvol)) => ((ccima @ (cccnv @ (XF @ Xx3)) @ (ccsn @ cc1)) = XA2)))))))).
...
thf(citg11_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr)) => ((ccfv @ (XF @ Xx3) @ ccitg1) = (ccfv @ XA2 @ ccvol)))))))).
