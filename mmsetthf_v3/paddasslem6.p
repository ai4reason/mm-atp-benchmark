...
thf(cpaddasslem6_conj,conjecture,(! [Xz:$i] : (! [XA2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xs1:$i] : (! [Xp:$i] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & ((cwcel @ (ccv @ Xp) @ XA2) & (cwcel @ (ccv @ Xs1) @ XA2)) & (cwcel @ (ccv @ Xz) @ XA2)) & (((ccv @ Xs1) != (ccv @ Xz)) & (cwbr @ (ccv @ Xs1) @ (cco @ (ccv @ Xp) @ (ccv @ Xz) @ Xc_or) @ Xc_le))) => (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xs1) @ (ccv @ Xz) @ Xc_or) @ Xc_le))))))))))))).
