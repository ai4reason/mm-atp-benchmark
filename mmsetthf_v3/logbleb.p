...
thf(clogbleb_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XX @ ccrp) & (cwcel @ XY @ ccrp)) => ((cwbr @ XX @ XY @ ccle) <=> (cwbr @ (cco @ XB2 @ XX @ cclogb) @ (cco @ XB2 @ XY @ cclogb) @ ccle))))))).
