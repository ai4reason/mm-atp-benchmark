...
thf(aclwwlknun_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XG @ ccusgr) => ((cco @ XN @ XG @ ccclwwlkn) = (cciun @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ (ccfv @ XG @ ccclwwlknon))))))))))).
...
thf(aclwwlknondisj_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (cwdisj @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ (ccfv @ XG @ ccclwwlknon)))))))).
thf(cnumclwwlk4_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ ccn)) => ((ccfv @ (cco @ XN @ XG @ ccclwwlkn) @ cchash) = (ccsu @ XV @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XN @ (ccfv @ XG @ ccclwwlknon)) @ cchash)))))))))).
