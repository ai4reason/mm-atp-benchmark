...
thf(cmarrepcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2) & (cwcel @ XS @ (ccfv @ XR @ ccbs))) & ((cwcel @ XK @ XN) & (cwcel @ XL @ XN))) => (cwcel @ (cco @ XK @ XL @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ XB2))))))))))))).
