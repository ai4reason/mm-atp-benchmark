...
thf(ahlrelat2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((~ (cwbr @ XX @ XY @ Xc_le)) <=> (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XX @ Xc_le) & (~ (cwbr @ (ccv @ Xp) @ XY @ Xc_le)))) @ (^ [Xp:$i] : XA2)))))))))))))).
