...
thf(acardacda_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd))) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (cco @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd) @ ccoa) @ ccen))))).
...
thf(cficardun2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => (cwss @ (ccfv @ (ccun @ XA2 @ XB2) @ cccrd) @ (cco @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd) @ ccoa)))))).
