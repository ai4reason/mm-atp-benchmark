...
thf(ceucalgf_conj,conjecture,(! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwf @ (ccxp @ ccn0 @ ccn0) @ (ccxp @ ccn0 @ ccn0) @ (XE @ Xx3 @ Xy1))))))).
