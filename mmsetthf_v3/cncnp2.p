...
thf(ccncnp2_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((XX != cc0) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ XF @ (ccfv @ (ccv @ Xx3) @ (cco @ XJ @ XK @ cccnp)))) @ (^ [Xx3:$i] : XX)))))))))))).
