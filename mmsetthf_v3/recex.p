...
thf(arecextlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & ((cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) != ccc0)) => ((cco @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ XB2 @ XB2 @ ccmul) @ ccaddc) != ccc0))))).
...
thf(arecextlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccmin) @ ccmul) = (cco @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ XB2 @ XB2 @ ccmul) @ ccaddc)))))).
...
thf(crecex_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) => (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccmul) = cc1)) @ (^ [Xx3:$i] : ccc))))).
