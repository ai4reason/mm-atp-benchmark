...
thf(cpmss12g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwss @ XA2 @ XC) & (cwss @ XB2 @ XD)) & ((cwcel @ XC @ XV) & (cwcel @ XD @ XW))) => (cwss @ (cco @ XA2 @ XB2 @ ccpm) @ (cco @ XC @ XD @ ccpm)))))))))).
