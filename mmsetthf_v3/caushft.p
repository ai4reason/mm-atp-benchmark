...
thf(aiscau4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xx3 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XZ)) => ((ccfv @ (ccv @ Xj) @ XF) = (XB2 @ Xx3 @ Xj @ Xk)))))) => (Xph => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> ((cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (ccv @ Xk) @ (ccdm @ XF)) & (cwcel @ (XA2 @ Xx3 @ Xj @ Xk) @ XX) & (cwbr @ (cco @ (XA2 @ Xx3 @ Xj @ Xk) @ (XB2 @ Xx3 @ Xj @ Xk) @ XD) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccrp))))))))))))))))))).
...
thf(ccaushft_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (Xph => (cwcel @ (XM @ Xk) @ ccz))) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((! [Xk:$i] : ((XW @ Xk) = (ccfv @ (cco @ (XM @ Xk) @ XN @ ccaddc) @ ccuz))) => ((Xph => (cwcel @ XN @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (ccfv @ (cco @ (ccv @ Xk) @ XN @ ccaddc) @ XG)))) => ((Xph => (cwcel @ XF @ (ccfv @ XD @ ccca))) => ((! [Xk:$i] : (Xph => (cwf @ (XW @ Xk) @ XX @ XG))) => (Xph => (cwcel @ XG @ (ccfv @ XD @ ccca))))))))))))))))))))).
