...
thf(asmores_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwsmo @ XA2) & (cwcel @ XB2 @ (ccdm @ XA2))) => (cwsmo @ (ccres @ XA2 @ XB2)))))).
...
thf(acfcof_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((? [Xf1:$i] : ((cwf @ XB2 @ XA2 @ (ccv @ Xf1)) & (cwsmo @ (ccv @ Xf1)) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XA2)))) => ((ccfv @ XA2 @ cccf) = (ccfv @ XB2 @ cccf))))))).
