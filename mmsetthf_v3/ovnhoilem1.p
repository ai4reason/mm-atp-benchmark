...
thf(aico0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => (((cco @ XA2 @ XB2 @ ccico) = cc0) <=> (cwbr @ XB2 @ XA2 @ ccle)))))).
...
thf(covnhoilem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (! [Xi:$i] : ((Xph @ Xz @ Xi) => (cwcel @ XX @ ccfn)))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xz @ Xi) => (cwf @ XX @ ccr @ (XA2 @ Xk)))))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xz @ Xi) => (cwf @ XX @ ccr @ (XB2 @ Xk)))))) => ((! [Xj:$i] : (! [Xk:$i] : ((XI @ Xj @ Xk) = (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccico)))))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XM @ Xz @ Xi @ Xj @ Xk) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : ((cwss @ (XI @ Xj @ Xk) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) & ((ccv @ Xz) = (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))))))) => ((! [Xz:$i] : (! [Xk:$i] : ((XH @ Xz @ Xk) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccif @ ((ccv @ Xj) = cc1) @ (ccop @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk))) @ (ccop @ ccc0 @ ccc0))))))))) => (! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xz @ Xi) => (cwbr @ (ccfv @ (XI @ Xj @ Xk) @ (ccfv @ XX @ ccovoln)) @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccico) @ ccvol))) @ ccle)))))))))))))))))))).
