...
thf(celsprel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XA2 @ (XV @ Xp @ Xa @ Xb)) | (cwcel @ XB2 @ (XW @ Xp @ Xa @ Xb))) => (cwcel @ (ccpr @ XA2 @ XB2) @ (^ [Xp:$i] : (? [Xa:$i] : (? [Xb:$i] : ((ccv @ Xp) = (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))))))))))))))).
