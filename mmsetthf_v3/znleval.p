...
thf(cznleval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XF = (ccres @ (ccfv @ XY @ cczrh) @ XW)) => ((XW = (ccif @ (XN = ccc0) @ ccz @ (cco @ ccc0 @ XN @ ccfzo))) => ((Xc_le = (ccfv @ XY @ ccple)) => ((XX = (ccfv @ XY @ ccbs)) => ((cwcel @ XN @ ccn0) => ((cwbr @ XA2 @ XB2 @ Xc_le) <=> ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwbr @ (ccfv @ XA2 @ (cccnv @ XF)) @ (ccfv @ XB2 @ (cccnv @ XF)) @ ccle)))))))))))))))))).
