...
thf(cghminv_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XM = (ccfv @ XS @ ccminusg)) => ((XN = (ccfv @ XT @ ccminusg)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccfv @ XX @ XM) @ XF) = (ccfv @ (ccfv @ XX @ XF) @ XN)))))))))))))).
