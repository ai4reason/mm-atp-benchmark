...
thf(czltlesub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ XN @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XB2 @ cc1 @ cclt)) => ((Xph => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccz)) => (Xph => (cwbr @ XN @ (cco @ XA2 @ XB2 @ ccmin) @ ccle))))))))))))).
