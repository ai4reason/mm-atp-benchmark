...
thf(avtxvalOLD_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XG @ XV) => ((ccfv @ XG @ ccvtx) = (ccif @ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)) @ (ccfv @ XG @ cc1st) @ (ccfv @ XG @ ccbs))))))).
...
thf(cfunvtxdm2valOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((((cwcel @ XG @ XV) & (cwfun @ (ccdif @ XG @ (ccsn @ cc0)))) & (XA2 != XB2) & (cwss @ (ccpr @ XA2 @ XB2) @ (ccdm @ XG))) => ((ccfv @ XG @ ccvtx) = (ccfv @ XG @ ccbs)))))))))).
