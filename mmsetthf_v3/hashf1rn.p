...
thf(af1o2ndf1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1 @ XA2 @ XB2 @ XF) => (cwf1o @ XF @ (ccrn @ XF) @ (ccres @ cc2nd @ XF))))))).
...
thf(chashf1rn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf1 @ XA2 @ XB2 @ XF)) => ((ccfv @ XF @ cchash) = (ccfv @ (ccrn @ XF) @ cchash)))))))).
