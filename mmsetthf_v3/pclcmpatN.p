...
thf(cpclcmpatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ ccal) & (cwss @ XX @ XA2) & (cwcel @ XP @ (ccfv @ XX @ XU))) => (cwrex @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xy1) @ XX) & (cwcel @ XP @ (ccfv @ (ccv @ Xy1) @ XU)))) @ (^ [Xy1:$i] : ccfn))))))))))).
