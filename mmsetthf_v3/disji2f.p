...
thf(cdisji2f_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XY:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XY) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (! [Xx3:$i] : (((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ XY @ XA2)) & ((ccv @ Xx3) != XY)) => ((ccin @ (XB2 @ Xx3) @ (XC @ Xx3)) = cc0)))))))))).
