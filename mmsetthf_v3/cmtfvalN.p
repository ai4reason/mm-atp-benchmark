...
thf(adf_cmtN_ax,axiom,(cccmtN = (ccmpt @ (^ [Xp:$i] : ccvv) @ (^ [Xp:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xp) @ ccbs)) & (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xp) @ ccbs)) & ((ccv @ Xx3) = (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xp) @ ccmee)) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xp) @ ccoc)) @ (ccfv @ (ccv @ Xp) @ ccmee)) @ (ccfv @ (ccv @ Xp) @ ccjn))))))))))).
...
thf(ccmtfvalN_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [Xc_pe:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_or @ Xx3 @ Xy1) = (ccfv @ XK @ ccjn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_an @ Xx3 @ Xy1) = (ccfv @ XK @ ccmee)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_pe @ Xx3 @ Xy1) = (ccfv @ XK @ ccoc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xx3 @ Xy1) = (ccfv @ XK @ cccmtN)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XK @ (XA2 @ Xx3 @ Xy1)) => ((XC @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2) & ((ccv @ Xx3) = (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_an @ Xx3 @ Xy1)) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (Xc_pe @ Xx3 @ Xy1)) @ (Xc_an @ Xx3 @ Xy1)) @ (Xc_or @ Xx3 @ Xy1)))))))))))))))))))))))).
