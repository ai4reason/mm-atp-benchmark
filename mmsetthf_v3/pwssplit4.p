...
thf(apwssplit3_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XW @ XU @ ccpws)) => ((XZ = (cco @ XW @ XV @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XX) & (cwss @ XV @ XU)) => (cwcel @ (XF @ Xx3) @ (cco @ XY @ XZ @ cclmhm))))))))))))))))))).
...
thf(almhmkerlss_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((XK = (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((Xc_0 = (ccfv @ XT @ cc0g)) => ((XU = (ccfv @ XS @ cclss)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) => (cwcel @ XK @ XU)))))))))))).
...
thf(areslmhm_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XS @ cclss)) => ((XR = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XX @ XU)) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XR @ XT @ cclmhm)))))))))))).
...
thf(apwslmod_thm,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => (((cwcel @ XR @ cclmod) & (cwcel @ XI @ XV)) => (cwcel @ XY @ cclmod)))))))).
...
thf(aghmf1_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XS @ ccbs)) => ((XY = (ccfv @ XT @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XU = (ccfv @ XT @ cc0g)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) => ((cwf1 @ XX @ XY @ XF) <=> (cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ XF) = XU) => ((ccv @ Xx3) = Xc_0))) @ (^ [Xx3:$i] : XX)))))))))))))))).
...
thf(cpwssplit4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XE = (cco @ XR @ (ccun @ XA2 @ XB2) @ ccpws)) => ((XG = (ccfv @ XE @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xy1:$i] : ((XK @ Xy1) = (ccrab @ (^ [Xy1:$i] : ((ccres @ (ccv @ Xy1) @ XA2) = (ccxp @ XA2 @ (ccsn @ Xc_0)))) @ (^ [Xy1:$i] : XG)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (XK @ Xy1)) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XB2)))))) => ((XC = (cco @ XR @ XA2 @ ccpws)) => ((XD = (cco @ XR @ XB2 @ ccpws)) => ((! [Xy1:$i] : ((XL @ Xy1) = (cco @ XE @ (XK @ Xy1) @ ccress))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XR @ cclmod) & (cwcel @ (ccun @ XA2 @ XB2) @ XV) & ((ccin @ XA2 @ XB2) = cc0)) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ (XL @ Xy1) @ XD @ cclmim)))))))))))))))))))))))))).
