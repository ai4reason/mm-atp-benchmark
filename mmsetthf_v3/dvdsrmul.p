...
thf(cdvdsrmul_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => (cwbr @ XX @ (cco @ XY @ XX @ Xc_x) @ Xc_pa)))))))))))).
