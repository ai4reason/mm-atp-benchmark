...
thf(ch2hcau_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ ccnv) => ((cchil = (ccfv @ XU @ ccba)) => ((XD = (ccfv @ XU @ ccims)) => (cccau = (ccin @ (ccfv @ XD @ ccca) @ (cco @ cchil @ ccn @ ccmap)))))))))).
