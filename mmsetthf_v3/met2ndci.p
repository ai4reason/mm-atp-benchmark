...
thf(cmet2ndci_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & ((cwss @ XA2 @ XX) & (cwbr @ XA2 @ ccom @ ccdom) & ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XX))) => (cwcel @ XJ @ cc2ndc)))))))).
