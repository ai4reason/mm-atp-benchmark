...
thf(aeleclclwwlknlem2_thm,axiom,(! [Xx3:$i] : (! [Xk:$i] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xm:$i] : (! [Xn:$i] : ((XW @ Xm @ Xn) = (cco @ XN @ XG @ ccclwwlkn)))) => (! [Xm:$i] : (! [Xn:$i] : ((((cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ XN @ ccfz)) & (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ cccsh))) & ((cwcel @ XX @ (XW @ Xm @ Xn)) & (cwcel @ (ccv @ Xx3) @ (XW @ Xm @ Xn)))) => ((cwrex @ (^ [Xm:$i] : (XY = (cco @ (ccv @ Xx3) @ (ccv @ Xm) @ cccsh))) @ (^ [Xm:$i] : (cco @ ccc0 @ XN @ ccfz))) <=> (cwrex @ (^ [Xn:$i] : (XY = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))))))).
...
thf(celeclclwwlkn_conj,conjecture,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xu:$i] : (! [Xt:$i] : (XW = (cco @ XN @ (XG @ Xu @ Xt) @ ccclwwlkn)))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xc_sm @ Xu @ Xt @ Xn) = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : ((cwcel @ (ccv @ Xt) @ XW) & (cwcel @ (ccv @ Xu) @ XW) & (cwrex @ (^ [Xn:$i] : ((ccv @ Xt) = (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (((cwcel @ (XB2 @ Xu @ Xt @ Xn) @ (ccqs @ XW @ (Xc_sm @ Xu @ Xt @ Xn))) & (cwcel @ (XX @ Xu @ Xt) @ (XB2 @ Xu @ Xt @ Xn))) => ((cwcel @ (XY @ Xu @ Xt) @ (XB2 @ Xu @ Xt @ Xn)) <=> ((cwcel @ (XY @ Xu @ Xt) @ XW) & (cwrex @ (^ [Xn:$i] : ((XY @ Xu @ Xt) = (cco @ (XX @ Xu @ Xt) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))))))))))).
