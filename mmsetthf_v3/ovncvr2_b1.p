...
thf(covncvr2_b1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xl:$i] : ((Xph @ Xl) => (cwcel @ XX @ ccfn))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : ((Xph @ Xl) => (cwss @ (XA2 @ Xj @ Xk) @ (cco @ ccr @ XX @ ccmap)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xl:$i] : ((Xph @ Xl) => (cwcel @ (XE @ Xj @ Xk @ Xa @ Xl) @ ccrp)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : ((XC @ Xj @ Xk @ Xl) = (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccrab @ (^ [Xl:$i] : (cwss @ (ccv @ Xa) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xl)))))))))) @ (^ [Xl:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : ((XL @ Xj @ Xk @ Xl) = (ccmpt @ (^ [Xh:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xh:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xh))) @ ccvol))))))))) => ((! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((XD @ Xh @ Xj @ Xk @ Xr @ Xa @ Xl) = (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccmpt @ (^ [Xr:$i] : ccrp) @ (^ [Xr:$i] : (ccrab @ (^ [Xh:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (ccv @ Xh)) @ (XL @ Xj @ Xk @ Xl)))) @ ccsumge0) @ (cco @ (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)) @ (ccv @ Xr) @ ccxad) @ ccle)) @ (^ [Xh:$i] : (ccfv @ (ccv @ Xa) @ (XC @ Xj @ Xk @ Xl))))))))))))))) => ((! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((Xph @ Xl) => (cwcel @ (XI @ Xr @ Xa) @ (ccfv @ (XE @ Xj @ Xk @ Xa @ Xl) @ (ccfv @ (XA2 @ Xj @ Xk) @ (XD @ Xh @ Xj @ Xk @ Xr @ Xa @ Xl))))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((XB2 @ Xj @ Xk @ Xr @ Xa @ Xl) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XI @ Xr @ Xa))) @ cc1st))))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((XT @ Xj @ Xk @ Xr @ Xa @ Xl) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XI @ Xr @ Xa))) @ cc2nd))))))))))) => (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((Xph @ Xl) => ((((cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XB2 @ Xj @ Xk @ Xr @ Xa @ Xl)) & (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XT @ Xj @ Xk @ Xr @ Xa @ Xl))) & (cwss @ (XA2 @ Xj @ Xk) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XB2 @ Xj @ Xk @ Xr @ Xa @ Xl))) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XT @ Xj @ Xk @ Xr @ Xa @ Xl))) @ ccico))))))) & (cwbr @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XB2 @ Xj @ Xk @ Xr @ Xa @ Xl))) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XT @ Xj @ Xk @ Xr @ Xa @ Xl))) @ ccico) @ ccvol))))) @ ccsumge0) @ (cco @ (ccfv @ (XA2 @ Xj @ Xk) @ (ccfv @ XX @ ccovoln)) @ (XE @ Xj @ Xk @ Xa @ Xl) @ ccxad) @ ccle)))))))))))))))))))))))))))).
