...
thf(afnpr2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwfn @ XF @ (ccpr @ XA2 @ XB2)) <=> (XF = (ccpr @ (ccop @ XA2 @ (ccfv @ XA2 @ XF)) @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)))))))))))).
...
thf(cfpr2g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwf @ (ccpr @ XA2 @ XB2) @ XC @ XF) <=> ((cwcel @ (ccfv @ XA2 @ XF) @ XC) & (cwcel @ (ccfv @ XB2 @ XF) @ XC) & (XF = (ccpr @ (ccop @ XA2 @ (ccfv @ XA2 @ XF)) @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)))))))))))))).
