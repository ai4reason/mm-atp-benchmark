...
thf(aghmsub_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((Xc_mi = (ccfv @ XS @ ccsg)) => ((XN = (ccfv @ XT @ ccsg)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XU @ XB2) & (cwcel @ XV @ XB2)) => ((ccfv @ (cco @ XU @ XV @ Xc_mi) @ XF) = (cco @ (ccfv @ XU @ XF) @ (ccfv @ XV @ XF) @ XN))))))))))))))).
...
thf(axmsxmet2_thm,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccfv @ XM @ ccds)) => ((cwcel @ XM @ ccxme) => (cwcel @ (ccres @ XD @ (ccxp @ XX @ XX)) @ (ccfv @ XX @ ccxmt))))))))).
