...
thf(aalephordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ XB2) => (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ ccsdm)))))).
...
thf(aalephord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwcel @ XA2 @ XB2) <=> (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ ccsdm)))))).
