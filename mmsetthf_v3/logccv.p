...
thf(clogccv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp) & (cwbr @ XA2 @ XB2 @ cclt)) & (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) => (cwbr @ (cco @ (cco @ XT @ (ccfv @ XA2 @ cclog) @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ XB2 @ cclog) @ ccmul) @ ccaddc) @ (ccfv @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc) @ cclog) @ cclt)))))).
