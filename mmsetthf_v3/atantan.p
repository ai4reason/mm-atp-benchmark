...
thf(acosne0_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => ((ccfv @ XA2 @ cccos) != ccc0)))).
thf(ccexp_tp,type,(ccexp : ($i > $o))).
thf(aatandmtan_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ cccos) != ccc0)) => (cwcel @ (ccfv @ XA2 @ cctan) @ (ccdm @ ccatan))))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aatanval_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) => ((ccfv @ XA2 @ ccatan) = (cco @ (cco @ cci @ cc2 @ ccdiv) @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ ccmin) @ ccmul))))).
...
thf(aatandm2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) <=> ((cwcel @ XA2 @ ccc) & ((cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) != ccc0) & ((cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) != ccc0))))).
...
thf(aefne0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cce) != ccc0)))).
...
thf(atanregt0_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccre) @ cclt)))).
thf(atanneg_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ cccos) != ccc0)) => ((ccfv @ (ccneg @ XA2) @ cctan) = (ccneg @ (ccfv @ XA2 @ cctan)))))).
thf(aatanlogsub_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccatan)) & ((ccfv @ XA2 @ ccre) != ccc0)) => (cwcel @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ (ccrn @ cclog))))).
...
thf(atanhbnd_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cctan) @ cci @ ccdiv) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))))).
...
thf(alttri4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) | (XA2 = XB2) | (cwbr @ XB2 @ XA2 @ cclt)))))).
...
thf(aellogrn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccrn @ cclog)) <=> ((cwcel @ XA2 @ ccc) & (cwbr @ (ccneg @ ccpi) @ (ccfv @ XA2 @ ccim) @ cclt) & (cwbr @ (ccfv @ XA2 @ ccim) @ ccpi @ ccle))))).
...
thf(catantan_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => ((ccfv @ (ccfv @ XA2 @ cctan) @ ccatan) = XA2)))).
