...
thf(aulmdvlem2_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (XZ = (ccfv @ (XM @ Xz) @ ccuz))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xz:$i] : (Xph => (cwcel @ (XM @ Xz) @ ccz))) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XX @ ccmap) @ XF)) => ((! [Xk:$i] : (Xph => (cwf @ XX @ ccc @ (XG @ Xk)))) => ((! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XX)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccfv @ (ccv @ Xz) @ (XG @ Xk)) @ ccli)))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv))) @ (XH @ Xk) @ (ccfv @ XX @ cculm)))) => (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccdm @ (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv)) = XX))))))))))))))))))).
...
thf(aulmdvlem3_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (XZ = (ccfv @ (XM @ Xz) @ ccuz))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xz:$i] : (Xph => (cwcel @ (XM @ Xz) @ ccz))) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XX @ ccmap) @ XF)) => ((! [Xk:$i] : (Xph => (cwf @ XX @ ccc @ (XG @ Xk)))) => ((! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XX)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccfv @ (ccv @ Xz) @ (XG @ Xk)) @ ccli)))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv))) @ (XH @ Xk) @ (ccfv @ XX @ cculm)))) => (! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XX)) => (cwbr @ (ccv @ Xz) @ (ccfv @ (ccv @ Xz) @ (XH @ Xk)) @ (cco @ XS @ (XG @ Xk) @ ccdv))))))))))))))))))))).
