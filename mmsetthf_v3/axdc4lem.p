...
thf(aaxdc3_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((cwcel @ XC @ XA2) & (cwf @ XA2 @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ XF)) => (? [Xg1:$i] : ((cwf @ ccom @ XA2 @ (ccv @ Xg1)) & ((ccfv @ cc0 @ (ccv @ Xg1)) = XC) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ XF))) @ (^ [Xk:$i] : ccom)))))))))).
