...
thf(ameadif_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((Xph => (cwcel @ XA2 @ (ccdm @ XM))) => ((Xph => (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((Xph => (cwcel @ XB2 @ (ccdm @ XM))) => ((Xph => (cwss @ XB2 @ XA2)) => (Xph => ((ccfv @ (ccdif @ XA2 @ XB2) @ XM) = (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccmin))))))))))))).
...
thf(aclimsubc1mpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccc))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (XC @ Xk) @ ccli))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XA2 @ (XB2 @ Xk) @ ccmin))) @ (cco @ XA2 @ (XC @ Xk) @ ccmin) @ ccli)))))))))))))))).
...
thf(aclimresmpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (XZ = (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XN @ XZ))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccfv @ XN @ ccuz)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwbr @ (XG @ Xx3) @ (XB2 @ Xx3) @ ccli) <=> (cwbr @ (XF @ Xx3) @ (XB2 @ Xx3) @ ccli))))))))))))))))).
...
thf(ameadjunre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((XS = (ccdm @ XM)) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((Xph => (cwcel @ (ccfv @ XB2 @ XM) @ ccr)) => (Xph => ((ccfv @ (ccun @ XA2 @ XB2) @ XM) = (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccaddc)))))))))))))))).
...
thf(cmeaiininclem_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((Xph => (cwcel @ XN @ ccz)) => ((XZ = (ccfv @ XN @ ccuz)) => ((Xph => (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => (cwss @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE) @ (ccfv @ (ccv @ Xn) @ XE)))) => ((Xph => (cwcel @ XK @ (ccfv @ XN @ ccuz))) => ((Xph => (cwcel @ (ccfv @ (ccfv @ XK @ XE) @ XM) @ ccr)) => ((! [Xn:$i] : ((XS @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => ((XG = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdif @ (ccfv @ XK @ XE) @ (ccfv @ (ccv @ Xn) @ XE))))) => ((XF = (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XG)))) => (! [Xn:$i] : (Xph => (cwbr @ (XS @ Xn) @ (ccfv @ (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ ccli))))))))))))))))))))))).
