...
thf(clt2addrd_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XA2 @ ccr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XB2 @ ccr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XC @ ccr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))) => (! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((XA2 = (cco @ (ccv @ Xb) @ (ccv @ Xc) @ ccaddc)) & (cwbr @ (ccv @ Xb) @ XB2 @ cclt) & (cwbr @ (ccv @ Xc) @ XC @ cclt))) @ (^ [Xc:$i] : ccr))) @ (^ [Xb:$i] : ccr)))))))))))))).
