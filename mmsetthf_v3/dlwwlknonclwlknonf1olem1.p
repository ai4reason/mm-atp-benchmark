...
thf(cdlwwlknonclwlknonf1olem1_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [Xc:$i] : ((((ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) = XN) & (cwcel @ (ccv @ Xc) @ (ccfv @ XG @ ccclwlks)) & (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) => ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ (cco @ (ccfv @ (ccv @ Xc) @ cc2nd) @ (ccop @ ccc0 @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash)) @ ccsubstr)) = (ccfv @ (cco @ XN @ cc2 @ ccmin) @ (ccfv @ (ccv @ Xc) @ cc2nd)))))))).
