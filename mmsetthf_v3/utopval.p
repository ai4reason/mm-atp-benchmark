...
thf(adf_utop_ax,axiom,(ccutop = (ccmpt @ (^ [Xu:$i] : (ccuni @ (ccrn @ ccust))) @ (^ [Xu:$i] : (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xx3))) @ (ccv @ Xa))) @ (^ [Xv:$i] : (ccv @ Xu)))) @ (^ [Xx3:$i] : (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ (ccdm @ (ccuni @ (ccv @ Xu)))))))))).
...
thf(cutopval_conj,conjecture,(! [XU:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xv:$i] : ((cwcel @ XU @ (ccfv @ (XX @ Xv) @ ccust)) => ((ccfv @ XU @ ccutop) = (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xx3))) @ (ccv @ Xa))) @ (^ [Xv:$i] : XU))) @ (^ [Xx3:$i] : (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ (XX @ Xv)))))))))).
