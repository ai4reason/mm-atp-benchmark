...
thf(cpcqdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XA2 @ ccq) & (XA2 != ccc0)) & ((cwcel @ XB2 @ ccq) & (XB2 != ccc0))) => ((cco @ XP @ (cco @ XA2 @ XB2 @ ccdiv) @ ccpc) = (cco @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccmin))))))).
