...
thf(cmodexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ XC @ ccn0) & (cwcel @ XD @ ccrp)) & ((cco @ XA2 @ XD @ ccmo) = (cco @ XB2 @ XD @ ccmo))) => ((cco @ (cco @ XA2 @ XC @ ccexp) @ XD @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccexp) @ XD @ ccmo)))))))).
