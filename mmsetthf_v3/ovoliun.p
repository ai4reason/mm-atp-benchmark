...
thf(aovoliunlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : ((XT = (ccseq @ ccaddc @ XG @ cc1)) => ((XG = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => ((Xph => (cwcel @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (cco @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ XB2 @ ccaddc) @ ccle)))))))))))))).
