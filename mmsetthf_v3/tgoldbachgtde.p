...
thf(atgoldbachgnn_thm,axiom,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccz))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XN @ XO))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ XN @ ccle))) => (! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XN @ ccn)))))))))).
...
thf(ahgt750lem_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwbr @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ XN @ ccle)) => (cwbr @ (cco @ (cco @ cc7 @ (ccdp2 @ cc3 @ (ccdp2 @ cc4 @ cc8)) @ ccdp) @ (cco @ (ccfv @ XN @ cclog) @ (ccfv @ XN @ ccsqrt) @ ccdiv) @ ccmul) @ (cco @ ccc0 @ (ccdp2 @ ccc0 @ (ccdp2 @ ccc0 @ (ccdp2 @ ccc0 @ (ccdp2 @ cc4 @ (ccdp2 @ cc2 @ (ccdp2 @ cc2 @ (ccdp2 @ cc4 @ cc8))))))) @ ccdp) @ cclt)))).
...
thf(areprss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwss @ XB2 @ XA2)) => (Xph => (cwss @ (cco @ XB2 @ XM @ (ccfv @ XS @ ccrepr)) @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))))))))))))).
