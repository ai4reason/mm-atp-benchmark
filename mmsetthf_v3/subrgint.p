...
thf(asubgint_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (((cwss @ XS @ (ccfv @ XG @ ccsubg)) & (XS != cc0)) => (cwcel @ (ccint @ XS) @ (ccfv @ XG @ ccsubg)))))).
...
thf(csubrgint_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwss @ XS @ (ccfv @ XR @ ccsubrg)) & (XS != cc0)) => (cwcel @ (ccint @ XS) @ (ccfv @ XR @ ccsubrg)))))).
