...
thf(confrALTlem3_conj,conjecture,(! [Xx3:$i] : (! [Xa:$i] : (((cwss @ (ccv @ Xa) @ ccon0) & ((ccv @ Xa) != cc0)) => (((cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) & (~ ((ccin @ (ccv @ Xa) @ (ccv @ Xx3)) = cc0))) => (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccin @ (ccv @ Xa) @ (ccv @ Xx3)) @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : (ccin @ (ccv @ Xa) @ (ccv @ Xx3))))))))).
