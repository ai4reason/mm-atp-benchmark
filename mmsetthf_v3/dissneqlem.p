...
thf(cdissneqlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xu:$i] : ((XC @ Xu) = (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))) => (! [Xu:$i] : (((cwss @ (XC @ Xu) @ (XB2 @ Xu)) & (cwcel @ (XB2 @ Xu) @ (ccfv @ XA2 @ cctopon))) => ((XB2 @ Xu) = (ccpw @ XA2))))))))).
