...
thf(aclimeu_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : ((cwbr @ XF @ (XA2 @ Xx3) @ ccli) => (cweu @ (^ [Xx3:$i] : (cwbr @ XF @ (ccv @ Xx3) @ ccli)))))))).
...
thf(cclimreu_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : ((cwbr @ XF @ (XA2 @ Xx3) @ ccli) => (cwreu @ (^ [Xx3:$i] : (cwbr @ XF @ (ccv @ Xx3) @ ccli)) @ (^ [Xx3:$i] : ccc))))))).
