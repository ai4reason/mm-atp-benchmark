...
thf(advn2bss_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) & (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) => (cwss @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))) @ (ccdm @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)))))))))).
...
thf(advn1_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XS @ ccc) & (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) => ((ccfv @ cc1 @ (cco @ XS @ XF @ ccdvn)) = (cco @ XS @ XF @ ccdv)))))).
...
thf(advbssntr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ XS)) => ((XJ = (cco @ XK @ XS @ ccrest)) => ((XK = (ccfv @ cccnfld @ cctopn)) => (Xph => (cwss @ (ccdm @ (cco @ XS @ XF @ ccdv)) @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)))))))))))))))).
