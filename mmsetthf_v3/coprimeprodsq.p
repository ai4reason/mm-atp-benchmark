...
thf(ccoprimeprodsq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccn0)) & ((cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccgcd) = cc1)) => (((cco @ XC @ cc2 @ ccexp) = (cco @ XA2 @ XB2 @ ccmul)) => (XA2 = (cco @ (cco @ XA2 @ XC @ ccgcd) @ cc2 @ ccexp)))))))).
