...
thf(aprelpw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XC)) <=> (cwcel @ (ccpr @ XA2 @ XB2) @ (ccpw @ XC)))))))))).
...
thf(chashle2prv_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XP @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0))) => ((cwbr @ (ccfv @ XP @ cchash) @ cc2 @ ccle) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (XP = (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
