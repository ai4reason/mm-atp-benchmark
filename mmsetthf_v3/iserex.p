...
thf(ciserex_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => (Xph => ((cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli)) <=> (cwcel @ (ccseq @ ccaddc @ XF @ XN) @ (ccdm @ ccli))))))))))))).
