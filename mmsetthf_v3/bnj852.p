...
thf(abnj153_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xps:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xta:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XR:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ (XA2 @ Xm) @ (XR @ Xm) @ (ccv @ Xx3)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xps @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xm) @ (XR @ Xm) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) = (ccdif @ ccom @ (ccsn @ cc0))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xth @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) <=> (((cw_bnj15 @ (XA2 @ Xm) @ (XR @ Xm)) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xm))) => (cweu @ (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) & (Xph @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) & (Xps @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xta @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) <=> (cwral @ (^ [Xm:$i] : ((cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccep) => (cwsbc @ (^ [Xn:$i] : (Xth @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)) @ (ccv @ Xm)))) @ (^ [Xm:$i] : (XD @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (((ccv @ Xn) = cc1o) => (((cwcel @ (ccv @ Xn) @ (XD @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)) & (Xta @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)) => (Xth @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)))))))))))))))))))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cw_bnj17_tp,type,(cw_bnj17 : ($o > ($o > ($o > ($o > $o)))))).
thf(abnj601_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ (XA2 @ Xx3) @ (XR @ Xx3) @ (ccv @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xps @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xx3) @ (XR @ Xx3) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xy1 @ Xm @ Xn) = (ccdif @ ccom @ (ccsn @ cc0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xch @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) <=> (((cw_bnj15 @ (XA2 @ Xx3) @ (XR @ Xx3)) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cweu @ (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) & (Xph @ Xx3 @ Xy1 @ Xf1 @ Xn) & (Xps @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xn)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xth @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn) <=> (cwral @ (^ [Xm:$i] : ((cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccep) => (cwsbc @ (^ [Xn:$i] : (Xch @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)) @ (ccv @ Xm)))) @ (^ [Xm:$i] : (XD @ Xx3 @ Xy1 @ Xm @ Xn)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (((ccv @ Xn) != cc1o) => (((cwcel @ (ccv @ Xn) @ (XD @ Xx3 @ Xy1 @ Xm @ Xn)) & (Xth @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)) => (Xch @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xn)))))))))))))))))))))).
...
thf(cbnj852_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xf1 @ Xi @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ XA2 @ XR @ (XX @ Xy1 @ Xi)))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xf1 @ Xi @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))) => ((! [Xy1:$i] : ((XD @ Xy1) = (ccdif @ ccom @ (ccsn @ cc0)))) => (! [Xy1:$i] : (! [Xi:$i] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ (XX @ Xy1 @ Xi) @ XA2)) => (cwral @ (^ [Xn:$i] : (cweu @ (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) & (Xph @ Xy1 @ Xf1 @ Xi @ Xn) & (Xps @ Xy1 @ Xf1 @ Xi @ Xn))))) @ (^ [Xn:$i] : (XD @ Xy1)))))))))))))))).
