...
thf(clpss2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX) & (cwss @ XB2 @ XA2)) => (cwss @ (ccfv @ XB2 @ (ccfv @ XJ @ cclp)) @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp)))))))))).
