...
thf(abirthdaylem3_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => ((! [Xf1:$i] : ((XT @ Xf1) = (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => (! [Xf1:$i] : (((cwcel @ XK @ ccn0) & (cwcel @ XN @ ccn)) => (cwbr @ (cco @ (ccfv @ (XT @ Xf1) @ cchash) @ (ccfv @ (XS @ Xf1) @ cchash) @ ccdiv) @ (ccfv @ (ccneg @ (cco @ (cco @ (cco @ (cco @ XK @ cc2 @ ccexp) @ XK @ ccmin) @ cc2 @ ccdiv) @ XN @ ccdiv)) @ cce) @ ccle)))))))))).
...
thf(abirthdaylem1_thm,axiom,(! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => ((! [Xf1:$i] : ((XT @ Xf1) = (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => (! [Xf1:$i] : ((cwss @ (XT @ Xf1) @ (XS @ Xf1)) & (cwcel @ (XS @ Xf1) @ ccfn) & ((cwcel @ XN @ ccn) => ((XS @ Xf1) != cc0))))))))))).
...
thf(areefcl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ XA2 @ cce) @ ccr)))).
thf(ahalfre_thm,axiom,(cwcel @ (cco @ cc1 @ cc2 @ ccdiv) @ ccr)).
thf(cbirthday_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => ((! [Xf1:$i] : ((XT @ Xf1) = (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => ((XK = (ccdc @ cc2 @ cc3)) => ((XN = (ccdc @ (ccdc @ cc3 @ cc6) @ cc5)) => (! [Xf1:$i] : (cwbr @ (cco @ (ccfv @ (XT @ Xf1) @ cchash) @ (ccfv @ (XS @ Xf1) @ cchash) @ ccdiv) @ (cco @ cc1 @ cc2 @ ccdiv) @ cclt))))))))))).
