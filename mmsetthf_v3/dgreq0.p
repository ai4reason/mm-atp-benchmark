...
thf(adgrlb_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XM @ ccn0) & ((ccima @ XA2 @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz)) = (ccsn @ ccc0))) => (cwbr @ XN @ XM @ ccle)))))))))).
