...
thf(cacongrep_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XN @ ccz)) => (cwrex @ (^ [Xa:$i] : ((cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ XN @ ccmin) @ ccdvds) | (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ (ccneg @ XN) @ ccmin) @ ccdvds))) @ (^ [Xa:$i] : (cco @ ccc0 @ XA2 @ ccfz))))))).
