...
thf(aply1nz_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ ccnzr) => (cwcel @ XP @ ccnzr)))))).
...
thf(acoe1mul4_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((Xc_xb = (ccfv @ XY @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xc_0 = (ccfv @ XY @ cc0g)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (XF != Xc_0)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (XG != Xc_0)) => (Xph => ((ccfv @ (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ Xc_xb) @ ccco1)) = (cco @ (ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) @ (ccfv @ (ccfv @ XG @ XD) @ (ccfv @ XG @ ccco1)) @ Xc_x))))))))))))))))))))))))).
...
thf(cmon1psubm_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XM = (ccfv @ XR @ ccmn1)) => ((XU = (ccfv @ XP @ ccmgp)) => ((cwcel @ XR @ ccnzr) => (cwcel @ XM @ (ccfv @ XU @ ccsubmnd))))))))))).
