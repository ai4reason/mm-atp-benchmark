...
thf(cdfiso2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : ((! [Xg1:$i] : ((XB2 @ Xg1) = (ccfv @ XC @ ccbs))) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((XI = (ccfv @ XC @ cciso)) => ((! [Xg1:$i] : (Xph => (cwcel @ XX @ (XB2 @ Xg1)))) => ((! [Xg1:$i] : (Xph => (cwcel @ XY @ (XB2 @ Xg1)))) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((Xc_op = (cco @ (ccop @ XX @ XY) @ XX @ (ccfv @ XC @ ccco))) => ((Xc_as = (cco @ (ccop @ XY @ XX) @ XY @ (ccfv @ XC @ ccco))) => (Xph => ((cwcel @ XF @ (cco @ XX @ XY @ XI)) <=> (cwrex @ (^ [Xg1:$i] : (((cco @ (ccv @ Xg1) @ XF @ Xc_op) = (ccfv @ XX @ Xc_1)) & ((cco @ XF @ (ccv @ Xg1) @ Xc_as) = (ccfv @ XY @ Xc_1)))) @ (^ [Xg1:$i] : (cco @ XY @ XX @ XH))))))))))))))))))))))))))).
