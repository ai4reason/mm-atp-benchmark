...
thf(cperfcls_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cct1) & (cwss @ XS @ XX)) => ((cwcel @ (cco @ XJ @ XS @ ccrest) @ ccperf) <=> (cwcel @ (cco @ XJ @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ ccrest) @ ccperf)))))))).
