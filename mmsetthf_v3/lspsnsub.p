...
thf(clspsnsub_conj,conjecture,(! [Xph:$o] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => (Xph => ((ccfv @ (ccsn @ (cco @ XX @ XY @ Xc_mi)) @ XN) = (ccfv @ (ccsn @ (cco @ XY @ XX @ Xc_mi)) @ XN))))))))))))))))).
