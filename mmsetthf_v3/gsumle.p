...
thf(aofrval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => ((Xph => (cwfn @ XG @ XB2)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => (((ccin @ XA2 @ XB2) = XS) => (((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ XF) = XC)) => (((Xph & (cwcel @ XX @ XB2)) => ((ccfv @ XX @ XG) = XD)) => ((Xph & (cwbr @ XF @ XG @ (ccofr @ XR)) & (cwcel @ XX @ XS)) => (cwbr @ XC @ XD @ XR)))))))))))))))))))))).
...
thf(cgsumle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_le = (ccfv @ XM @ ccple)) => ((Xph => (cwcel @ XM @ ccomnd)) => ((Xph => (cwcel @ XM @ cccmn)) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((Xph => (cwbr @ XF @ XG @ (ccofr @ Xc_le))) => (Xph => (cwbr @ (cco @ XM @ XF @ ccgsu) @ (cco @ XM @ XG @ ccgsu) @ Xc_le)))))))))))))))))).
