...
thf(adf_hfsum_ax,axiom,(cchfs = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccc @ cchil @ ccmap))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccc @ cchil @ ccmap))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ ccaddc)))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(chfsmval_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ ccc @ XS) & (cwf @ cchil @ ccc @ XT)) => ((cco @ XS @ XT @ cchfs) = (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccaddc)))))))).
