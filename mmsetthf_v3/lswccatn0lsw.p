...
thf(clswccatn0lsw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XB2 @ (ccword @ XV)) & (XB2 != cc0)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccconcat) @ cclsw) = (ccfv @ XB2 @ cclsw))))))).
