...
thf(amatunit_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XU = (ccfv @ XA2 @ ccui)) => ((XV = (ccfv @ XR @ ccui)) => (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => ((cwcel @ XM @ XU) <=> (cwcel @ (ccfv @ XM @ XD) @ XV))))))))))))))))).
