...
thf(citgperiod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwcel @ XT @ ccrp)) => ((Xph => (cwf @ ccr @ ccc @ XF)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) = (ccfv @ (ccv @ Xx3) @ XF)))) => ((Xph => (cwcel @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccicc)) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => (Xph => ((ccitg @ (^ [Xx3:$i] : (cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) = (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF)))))))))))))))))).
