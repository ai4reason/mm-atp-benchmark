...
thf(celdmcoa_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xc_x = (ccfv @ XC @ cccoa)) => ((XA2 = (ccfv @ XC @ ccarw)) => ((cwbr @ XG @ XF @ (ccdm @ Xc_x)) <=> ((cwcel @ XF @ XA2) & (cwcel @ XG @ XA2) & ((ccfv @ XF @ cccoda) = (ccfv @ XG @ ccdoma)))))))))))).
