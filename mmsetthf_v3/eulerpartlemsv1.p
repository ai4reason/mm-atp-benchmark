...
thf(ceulerpartlemsv1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xf1:$i] : (! [Xk:$i] : ((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) => ((ccfv @ XA2 @ (XS @ Xf1 @ Xk)) = (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul))))))))))))).
