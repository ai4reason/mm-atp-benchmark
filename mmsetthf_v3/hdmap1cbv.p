...
thf(chdmap1cbv_conj,conjecture,(! [XD:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XL @ Xx3 @ Xy1 @ Xh @ Xi) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccif @ ((ccfv @ (ccv @ Xx3) @ cc2nd) = (Xc_0 @ Xh @ Xi)) @ (XQ @ Xh @ Xi) @ (ccrio @ (^ [Xh:$i] : (((ccfv @ (ccfv @ (ccsn @ (ccfv @ (ccv @ Xx3) @ cc2nd)) @ XN) @ XM) = (ccfv @ (ccsn @ (ccv @ Xh)) @ XJ)) & ((ccfv @ (ccfv @ (ccsn @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ Xc_mi)) @ XN) @ XM) = (ccfv @ (ccsn @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc2nd) @ (ccv @ Xh) @ XR)) @ XJ)))) @ (^ [Xh:$i] : XD)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XL @ Xx3 @ Xy1 @ Xh @ Xi) = (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccif @ ((ccfv @ (ccv @ Xy1) @ cc2nd) = (Xc_0 @ Xh @ Xi)) @ (XQ @ Xh @ Xi) @ (ccrio @ (^ [Xi:$i] : (((ccfv @ (ccfv @ (ccsn @ (ccfv @ (ccv @ Xy1) @ cc2nd)) @ XN) @ XM) = (ccfv @ (ccsn @ (ccv @ Xi)) @ XJ)) & ((ccfv @ (ccfv @ (ccsn @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ cc1st) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ Xc_mi)) @ XN) @ XM) = (ccfv @ (ccsn @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ cc1st) @ cc2nd) @ (ccv @ Xi) @ XR)) @ XJ)))) @ (^ [Xi:$i] : XD))))))))))))))))))))).
