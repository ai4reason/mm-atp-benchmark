...
thf(cordtopn3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => (((cwcel @ XR @ XV) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : ((~ (cwbr @ (ccv @ Xx3) @ XA2 @ XR)) & (~ (cwbr @ XB2 @ (ccv @ Xx3) @ XR)))) @ (^ [Xx3:$i] : XX)) @ (ccfv @ XR @ ccordt)))))))))).
