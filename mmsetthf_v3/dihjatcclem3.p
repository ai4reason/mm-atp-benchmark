...
thf(altrniotacnvval_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((XF @ Xf1) = (ccrio @ (^ [Xf1:$i] : ((ccfv @ XP @ (ccv @ Xf1)) = XQ)) @ (^ [Xf1:$i] : XT)))) => (! [Xf1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) => ((ccfv @ XQ @ (cccnv @ (XF @ Xf1))) = XP)))))))))))))))))).
...
thf(cdihjatcclem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xd:$i] : ((Xc_or @ Xd) = (ccfv @ XK @ ccjn))) => ((! [Xd:$i] : ((Xc_an @ Xd) = (ccfv @ XK @ ccmee))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xd:$i] : ((XU @ Xd) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xd:$i] : ((Xc_po @ Xd) = (ccfv @ (XU @ Xd) @ cclsm))) => ((! [Xd:$i] : ((XI @ Xd) = (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((! [Xd:$i] : ((XV @ Xd) = (cco @ (cco @ XP @ XQ @ (Xc_or @ Xd)) @ XW @ (Xc_an @ Xd)))) => ((! [Xd:$i] : ((Xph @ Xd) => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)))) => ((! [Xd:$i] : ((Xph @ Xd) => ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))))) => ((! [Xd:$i] : ((Xph @ Xd) => ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))))) => ((XC = (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xd:$i] : ((XR @ Xd) = (ccfv @ XW @ (ccfv @ XK @ cctrl)))) => ((! [Xd:$i] : ((XE @ Xd) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xd:$i] : ((XG @ Xd) = (ccrio @ (^ [Xd:$i] : ((ccfv @ XC @ (ccv @ Xd)) = XP)) @ (^ [Xd:$i] : XT)))) => ((! [Xd:$i] : ((XD @ Xd) = (ccrio @ (^ [Xd:$i] : ((ccfv @ XC @ (ccv @ Xd)) = XQ)) @ (^ [Xd:$i] : XT)))) => (! [Xd:$i] : ((Xph @ Xd) => ((ccfv @ (cccom @ (XG @ Xd) @ (cccnv @ (XD @ Xd))) @ (XR @ Xd)) = (XV @ Xd))))))))))))))))))))))))))))))))))))))))))))).
