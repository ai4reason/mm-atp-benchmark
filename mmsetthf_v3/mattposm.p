...
thf(amamutpos_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => ((XG = (cco @ XR @ (ccotp @ XP @ XN @ XM) @ ccmmul)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XP @ ccfn)) => ((Xph => (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XN @ XP) @ ccmap))) => (Xph => ((cctpos @ (cco @ XX @ XY @ XF)) = (cco @ (cctpos @ XY) @ (cctpos @ XX) @ XG))))))))))))))))))))))).
...
thf(cmattposm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((Xc_x = (ccfv @ XA2 @ ccmulr)) => (((cwcel @ XR @ cccrg) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cctpos @ (cco @ XX @ XY @ Xc_x)) = (cco @ (cctpos @ XY) @ (cctpos @ XX) @ Xc_x)))))))))))))).
