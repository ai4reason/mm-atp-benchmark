...
thf(apointsetN_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : ((! [Xa:$i] : (XA2 = (ccfv @ (XK @ Xa) @ ccatm))) => ((! [Xp:$i] : (! [Xa:$i] : ((XP @ Xp @ Xa) = (ccfv @ (XK @ Xa) @ ccpointsN)))) => (! [Xp:$i] : (! [Xa:$i] : ((cwcel @ (XK @ Xa) @ (XB2 @ Xp @ Xa)) => ((XP @ Xp @ Xa) = (^ [Xp:$i] : (cwrex @ (^ [Xa:$i] : ((ccv @ Xp) = (ccsn @ (ccv @ Xa)))) @ (^ [Xa:$i] : XA2)))))))))))))).
