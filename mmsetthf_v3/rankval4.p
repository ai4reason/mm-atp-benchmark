...
thf(ar1ord3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) => (cwss @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
thf(arankss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwss @ XA2 @ XB2) => (cwss @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk))))))).
...
thf(arankval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XB2 @ Xx3)) => ((ccfv @ XA2 @ ccrnk) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccr1))) @ (^ [Xx3:$i] : ccon0))))))))).
...
thf(arankel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XA2 @ XB2) => (cwcel @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk))))))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(aonsucssi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ XB2) <=> (cwss @ (ccsuc @ XA2) @ XB2))))))).
thf(crankval4_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccfv @ XA2 @ ccrnk) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsuc @ (ccfv @ (ccv @ Xx3) @ ccrnk)))))))).
