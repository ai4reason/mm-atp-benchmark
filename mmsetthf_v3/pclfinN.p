...
thf(cpclfinN_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ ccal) & (cwss @ XX @ XA2)) => ((ccfv @ XX @ XU) = (cciun @ (^ [Xy1:$i] : (ccin @ ccfn @ (ccpw @ XX))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XU)))))))))))).
