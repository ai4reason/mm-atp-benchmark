...
thf(aodeq1_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => (((ccfv @ XA2 @ XO) = cc1) <=> (XA2 = Xc_0)))))))))))).
...
thf(aoddvdssubg_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccabl) & (cwcel @ XN @ ccz)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)) @ (ccfv @ XG @ ccsubg)))))))))).
...
thf(abezout_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ XA2 @ XB2 @ ccgcd) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))).
...
thf(advdsmultr1_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XK @ XM @ ccdvds) => (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds))))))).
...
thf(aodmulgid_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) & (cwcel @ XK @ ccz)) => ((cwbr @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ XK @ ccdvds) <=> (cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XK @ XN @ ccmul) @ ccdvds)))))))))))))).
...
thf(cablfacrp_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XM @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => ((cco @ XM @ XN @ ccgcd) = cc1)) => ((Xph => ((ccfv @ XB2 @ cchash) = (cco @ XM @ XN @ ccmul))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((! [Xx3:$i] : ((Xc_po @ Xx3) = (ccfv @ XG @ cclsm))) => (! [Xx3:$i] : (Xph => (((ccin @ (XK @ Xx3) @ (XL @ Xx3)) = (ccsn @ Xc_0)) & ((cco @ (XK @ Xx3) @ (XL @ Xx3) @ (Xc_po @ Xx3)) = XB2)))))))))))))))))))))))))).
