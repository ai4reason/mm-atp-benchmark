...
thf(cproblem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (((cco @ XA2 @ XB2 @ ccaddc) = cc3) => (((cco @ (cco @ cc3 @ XA2 @ ccmul) @ (cco @ cc2 @ XB2 @ ccmul) @ ccaddc) = cc7) => ((XA2 = cc1) & (XB2 = cc2))))))))).
