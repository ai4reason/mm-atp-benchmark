...
thf(akonigsberglem1_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => ((ccfv @ ccc0 @ (ccfv @ XG @ ccvtxdg)) = cc3)))))))).
...
thf(akonigsberglem2_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => ((ccfv @ cc1 @ (ccfv @ XG @ ccvtxdg)) = cc3)))))))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(aleidi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ XA2 @ XA2 @ ccle)))).
thf(a_3re_thm,axiom,(cwcel @ cc3 @ ccr)).
thf(akonigsberglem3_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => ((ccfv @ cc3 @ (ccfv @ XG @ ccvtxdg)) = cc3)))))))).
...
thf(ckonigsberglem4_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3)))) => ((! [Xx3:$i] : (XG = (ccop @ XV @ (XE @ Xx3)))) => (cwss @ (cctp @ ccc0 @ cc1 @ cc3) @ (ccrab @ (^ [Xx3:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)))))))))).
