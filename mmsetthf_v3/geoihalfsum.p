...
thf(ageoisum1_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) = (cco @ XA2 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv))))).
...
thf(cgeoihalfsum_conj,conjecture,((ccsu @ ccn @ (^ [Xk:$i] : (cco @ cc1 @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccdiv))) = cc1)).
