...
thf(arisefacval2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ XN @ ccrisefac) = (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccaddc)))))))).
