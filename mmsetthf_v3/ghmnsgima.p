...
thf(ansgconj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XS @ (ccfv @ XG @ ccnsg)) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XS)) => (cwcel @ (cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ XA2 @ Xc_mi) @ XS))))))))))))).
...
thf(aisnsg3_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cwcel @ XS @ (ccfv @ XG @ ccnsg)) <=> ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ (ccv @ Xx3) @ Xc_mi) @ XS)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XX))))))))))))).
thf(cghmnsgima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XT @ ccbs)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XU @ (ccfv @ XS @ ccnsg)) & ((ccrn @ XF) = XY)) => (cwcel @ (ccima @ XF @ XU) @ (ccfv @ XT @ ccnsg)))))))))).
