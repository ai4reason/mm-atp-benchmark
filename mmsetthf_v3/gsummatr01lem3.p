...
thf(agsummatr01lem1_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xr:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xr) @ ccsymg) @ ccbs))) => ((! [Xr:$i] : ((XR @ Xr) = (ccrab @ (^ [Xr:$i] : ((ccfv @ XK @ (ccv @ Xr)) = XL)) @ (^ [Xr:$i] : XP)))) => (! [Xr:$i] : (((cwcel @ XQ @ (XR @ Xr)) & (cwcel @ (XX @ Xr) @ (XN @ Xr))) => (cwcel @ (ccfv @ (XX @ Xr) @ XQ) @ (XN @ Xr)))))))))))))).
...
thf(agsummatr01lem2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xr:$i] : ((XP @ Xi @ Xj) = (ccfv @ (ccfv @ (XN @ Xr) @ ccsymg) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xr:$i] : ((XR @ Xr) = (ccrab @ (^ [Xr:$i] : ((ccfv @ XK @ (ccv @ Xr)) = XL)) @ (^ [Xr:$i] : (XP @ Xi @ Xj))))))) => (! [Xr:$i] : (((cwcel @ XQ @ (XR @ Xr)) & (cwcel @ (XX @ Xr) @ (XN @ Xr))) => ((cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwcel @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr)) @ (ccfv @ (XG @ Xr) @ ccbs))) @ (^ [Xj:$i] : (XN @ Xr)))) @ (^ [Xi:$i] : (XN @ Xr))) => (cwcel @ (cco @ (XX @ Xr) @ (ccfv @ (XX @ Xr) @ XQ) @ (XA2 @ Xr)) @ (ccfv @ (XG @ Xr) @ ccbs))))))))))))))))).
...
thf(cgsummatr01lem3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XP @ Xi @ Xj @ Xn) = (ccfv @ (ccfv @ (XN @ Xr) @ ccsymg) @ ccbs)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XR @ Xr) = (ccrab @ (^ [Xr:$i] : ((ccfv @ XK @ (ccv @ Xr)) = XL)) @ (^ [Xr:$i] : (XP @ Xi @ Xj @ Xn)))))))) => ((! [Xr:$i] : ((Xc_0 @ Xr) = (ccfv @ (XG @ Xr) @ cc0g))) => ((! [Xr:$i] : ((XS @ Xr) = (ccfv @ (XG @ Xr) @ ccbs))) => (! [Xr:$i] : ((((cwcel @ (XG @ Xr) @ cccmn) & (cwcel @ (XN @ Xr) @ ccfn)) & ((cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwcel @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr)) @ (XS @ Xr))) @ (^ [Xj:$i] : (XN @ Xr)))) @ (^ [Xi:$i] : (XN @ Xr))) & (cwcel @ (XB2 @ Xr) @ (XS @ Xr))) & ((cwcel @ XK @ (XN @ Xr)) & (cwcel @ XL @ (XN @ Xr)) & (cwcel @ XQ @ (XR @ Xr)))) => ((cco @ (XG @ Xr) @ (ccmpt @ (^ [Xn:$i] : (ccun @ (ccdif @ (XN @ Xr) @ (ccsn @ XK)) @ (ccsn @ XK))) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XK) @ (ccif @ ((ccv @ Xj) = XL) @ (Xc_0 @ Xr) @ (XB2 @ Xr)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr))))))))) @ ccgsu) = (cco @ (cco @ (XG @ Xr) @ (ccmpt @ (^ [Xn:$i] : (ccdif @ (XN @ Xr) @ (ccsn @ XK))) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XK) @ (ccif @ ((ccv @ Xj) = XL) @ (Xc_0 @ Xr) @ (XB2 @ Xr)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr))))))))) @ ccgsu) @ (cco @ XK @ (ccfv @ XK @ XQ) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XK) @ (ccif @ ((ccv @ Xj) = XL) @ (Xc_0 @ Xr) @ (XB2 @ Xr)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr))))))) @ (ccfv @ (XG @ Xr) @ ccplusg))))))))))))))))))))).
