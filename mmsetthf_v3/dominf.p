...
thf(adomtriom_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwbr @ ccom @ XA2 @ ccdom) <=> (~ (cwbr @ XA2 @ ccom @ ccsdm)))))).
thf(avex_thm,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(cdominf_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((XA2 != cc0) & (cwss @ XA2 @ (ccuni @ XA2))) => (cwbr @ ccom @ XA2 @ ccdom))))).
