...
thf(angptps_thm,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccngp) => (cwcel @ XG @ cctps)))).
...
thf(acnmpt1ip_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [Xc_xi:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XW @ cctopn)) => ((XC = (ccfv @ cccnfld @ cctopn)) => ((! [Xx3:$i] : ((Xc_xi @ Xx3) = (ccfv @ XW @ ccip))) => ((Xph => (cwcel @ XW @ cccph)) => ((Xph => (cwcel @ XK @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XK @ XJ @ cccn))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XK @ XJ @ cccn))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (Xc_xi @ Xx3)))) @ (cco @ XK @ XC @ cccn)))))))))))))))))))).
...
thf(acnclima_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) & (cwcel @ XA2 @ (ccfv @ XK @ cccld))) => (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ (ccfv @ XJ @ cccld)))))))).
...
thf(cclsocv_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XO = (ccfv @ XW @ ccocv)) => ((XJ = (ccfv @ XW @ cctopn)) => (((cwcel @ XW @ cccph) & (cwss @ XS @ XV)) => ((ccfv @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ XO) = (ccfv @ XS @ XO)))))))))))).
