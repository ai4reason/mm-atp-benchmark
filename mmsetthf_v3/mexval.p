...
thf(adf_mex_ax,axiom,(ccmex = (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccxp @ (ccfv @ (ccv @ Xt) @ ccmtc) @ (ccfv @ (ccv @ Xt) @ ccmrex)))))).
...
thf(cmexval_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ XT @ ccmtc)) => ((XE = (ccfv @ XT @ ccmex)) => ((XR = (ccfv @ XT @ ccmrex)) => (XE = (ccxp @ XK @ XR)))))))))).
