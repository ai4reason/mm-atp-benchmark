...
thf(aralxpxfr2d_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwcel @ (XA2 @ Xy1 @ Xz) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3 @ Xy1 @ Xz)) <=> (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (XA2 @ Xy1 @ Xz))) @ (^ [Xz:$i] : (XD @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : (XC @ Xy1 @ Xz)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1 @ Xz))) => ((Xps @ Xx3) <=> (Xch @ Xy1 @ Xz)))))) => (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1 @ Xz))) <=> (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (Xch @ Xy1 @ Xz)) @ (^ [Xz:$i] : (XD @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : (XC @ Xy1 @ Xz)))))))))))))))))).
