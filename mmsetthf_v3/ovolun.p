...
thf(aovolunlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => ((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr))) => ((Xph => ((cwss @ XB2 @ ccr) & (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr))) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ ccovol) @ (cco @ (cco @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccaddc) @ XC @ ccaddc) @ ccle)))))))))).
