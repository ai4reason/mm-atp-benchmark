...
thf(aatandm3_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) <=> ((cwcel @ XA2 @ ccc) & ((cco @ XA2 @ cc2 @ ccexp) != (ccneg @ cc1)))))).
...
thf(catandmcj_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) => (cwcel @ (ccfv @ XA2 @ cccj) @ (ccdm @ ccatan))))).
