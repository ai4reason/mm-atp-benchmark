...
thf(cocvin_conj,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XL = (ccfv @ XW @ cclss)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XW @ ccphl) & (cwcel @ XS @ XL)) => ((ccin @ XS @ (ccfv @ XS @ Xc_pe)) = (ccsn @ Xc_0)))))))))))).
