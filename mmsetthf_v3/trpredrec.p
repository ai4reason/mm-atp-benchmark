...
thf(ctrpredrec_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XA2) & (cwse @ XA2 @ XR)) => ((cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) => ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) | (cwrex @ (^ [Xz:$i] : (cwbr @ XY @ (ccv @ Xz) @ XR)) @ (^ [Xz:$i] : (cctrpred @ XA2 @ XR @ XX))))))))))).
