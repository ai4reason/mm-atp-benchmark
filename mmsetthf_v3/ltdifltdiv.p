...
thf(cltdifltdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp) & (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ cclt) => (cwbr @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (cco @ XC @ XB2 @ ccdiv) @ cclt))))))).
