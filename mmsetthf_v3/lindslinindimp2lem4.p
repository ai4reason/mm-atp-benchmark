...
thf(clindslinindimp2lem4_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xy1) = (ccfv @ (XM @ Xx3) @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3) = (ccfv @ (XR @ Xy1) @ ccbs)))) => ((! [Xy1:$i] : (Xc_0 = (ccfv @ (XR @ Xy1) @ cc0g))) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ (XM @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XY @ Xx3 @ Xy1 @ Xf1) = (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (XR @ Xy1) @ ccminusg)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XG @ Xx3 @ Xf1) = (ccres @ (ccv @ Xf1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((((cwcel @ XS @ (XV @ Xx3 @ Xf1)) & (cwcel @ (XM @ Xx3) @ cclmod)) & ((cwss @ XS @ (ccfv @ (XM @ Xx3) @ ccbs)) & (cwcel @ (ccv @ Xx3) @ XS)) & ((cwcel @ (ccv @ Xf1) @ (cco @ (XB2 @ Xx3) @ XS @ ccmap)) & (cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) & ((cco @ (ccv @ Xf1) @ XS @ (ccfv @ (XM @ Xx3) @ cclinc)) = (XZ @ Xx3)))) => ((cco @ (XM @ Xx3) @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ XS @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xy1) @ (ccfv @ (XM @ Xx3) @ ccvsca)))) @ ccgsu) = (cco @ (XY @ Xx3 @ Xy1 @ Xf1) @ (ccv @ Xx3) @ (ccfv @ (XM @ Xx3) @ ccvsca))))))))))))))))))))))).
