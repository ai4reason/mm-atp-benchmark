...
thf(aimasdsfn_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwfo @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ XZ)) => ((XE = (ccfv @ XR @ ccds)) => ((XD = (ccfv @ XU @ ccds)) => (Xph => (cwfn @ XD @ (ccxp @ XB2 @ XB2))))))))))))))))))).
...
thf(cimasf1oxmet_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwf1o @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ XZ)) => ((XE = (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XV @ XV))) => ((XD = (ccfv @ XU @ ccds)) => ((Xph => (cwcel @ XE @ (ccfv @ XV @ ccxmt))) => (Xph => (cwcel @ XD @ (ccfv @ XB2 @ ccxmt)))))))))))))))))))).
