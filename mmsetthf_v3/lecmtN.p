...
thf(acmtbr4N_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XC = (ccfv @ XK @ cccmtN)) => (((cwcel @ XK @ ccoml) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ XC) <=> (cwbr @ (cco @ XX @ (cco @ (ccfv @ XX @ Xc_pe) @ XY @ Xc_or) @ Xc_an) @ XY @ Xc_le))))))))))))))))))).
thf(clecmtN_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XC = (ccfv @ XK @ cccmtN)) => (((cwcel @ XK @ ccoml) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ Xc_le) => (cwbr @ XX @ XY @ XC))))))))))))).
