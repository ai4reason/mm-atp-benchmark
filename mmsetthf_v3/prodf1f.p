...
thf(aprodf1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XN @ XZ) => ((ccfv @ XN @ (ccseq @ ccmul @ (ccxp @ XZ @ (ccsn @ cc1)) @ XM)) = cc1))))))).
...
thf(cprodf1f_conj,conjecture,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XM @ ccz) => ((ccseq @ ccmul @ (ccxp @ XZ @ (ccsn @ cc1)) @ XM) = (ccxp @ XZ @ (ccsn @ cc1)))))))).
