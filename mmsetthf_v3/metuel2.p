...
thf(ametuel_thm,axiom,(! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xw:$i] : (! [Xa:$i] : ((((XX @ Xw) != cc0) & (cwcel @ XD @ (ccfv @ (XX @ Xw) @ ccpsmet))) => ((cwcel @ (XV @ Xa) @ (ccfv @ XD @ ccmetu)) <=> ((cwss @ (XV @ Xa) @ (ccxp @ (XX @ Xw) @ (XX @ Xw))) & (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xw) @ (XV @ Xa))) @ (^ [Xw:$i] : (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))))))))))))).
...
thf(cmetuel2_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xd:$i] : ((XU @ Xx3 @ Xy1 @ Xd) = (ccfv @ XD @ ccmetu))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xd:$i] : (((XX != cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => ((cwcel @ XV @ (XU @ Xx3 @ Xy1 @ Xd)) <=> ((cwss @ XV @ (ccxp @ XX @ XX)) & (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (ccv @ Xd) @ cclt) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XV))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) @ (^ [Xd:$i] : ccrp)))))))))))))).
