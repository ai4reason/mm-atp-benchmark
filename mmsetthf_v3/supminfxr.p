...
thf(csupminfxr_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccsup @ XA2 @ ccxr @ cclt) = (ccxne @ (ccinf @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccneg @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : ccr)) @ ccxr @ cclt))))))))).
