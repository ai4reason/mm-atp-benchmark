...
thf(cpltne_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => (((cwcel @ XK @ XA2) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XC)) => ((cwbr @ XX @ XY @ Xc_lt) => (XX != XY)))))))))))).
