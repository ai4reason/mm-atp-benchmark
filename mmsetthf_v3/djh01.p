...
thf(cdjh01_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((Xc_or = (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccrn @ XI))) => (Xph => ((cco @ XX @ (ccsn @ Xc_0) @ Xc_or) = XX))))))))))))))))))).
