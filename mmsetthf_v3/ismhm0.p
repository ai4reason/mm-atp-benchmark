...
thf(cismhm0_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => ((Xc_pl = (ccfv @ XS @ ccplusg)) => ((Xc_pd = (ccfv @ XT @ ccplusg)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XY = (ccfv @ XT @ cc0g)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) <=> (((cwcel @ XS @ ccmnd) & (cwcel @ XT @ ccmnd)) & ((cwcel @ XF @ (cco @ XS @ XT @ ccmgmhm)) & ((ccfv @ Xc_0 @ XF) = XY)))))))))))))))))))).
