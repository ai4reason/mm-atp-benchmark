...
thf(c_2lgslem1a1_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccn) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => (cwral @ (^ [Xi:$i] : ((cco @ (ccv @ Xi) @ cc2 @ ccmul) = (cco @ (cco @ (ccv @ Xi) @ cc2 @ ccmul) @ XP @ ccmo))) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))))).
