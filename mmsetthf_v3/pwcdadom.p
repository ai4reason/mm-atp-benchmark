...
thf(acanthwdom_thm,axiom,(! [XA2:($i > $o)] : (~ (cwbr @ (ccpw @ XA2) @ XA2 @ ccwdom)))).
...
thf(adom0_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc0 @ ccdom) <=> (XA2 = cc0)))).
...
thf(adomen1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XA2 @ XC @ ccdom) <=> (cwbr @ XB2 @ XC @ ccdom))))))).
...
thf(aunxpwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ (ccxp @ XA2 @ XA2) @ (ccun @ XB2 @ XC) @ ccdom) => ((cwbr @ XA2 @ XB2 @ ccwdom) | (cwbr @ XA2 @ XC @ ccdom))))))).
...
thf(cpwcdadom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ (ccpw @ (cco @ XA2 @ XA2 @ cccda)) @ (cco @ XA2 @ XB2 @ cccda) @ ccdom) => (cwbr @ (ccpw @ XA2) @ XB2 @ ccdom))))).
