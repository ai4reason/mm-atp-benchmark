...
thf(cccatrcl1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ (ccword @ XY)) & ((XW = (cco @ XA2 @ XB2 @ ccconcat)) & (cwcel @ XW @ (ccword @ XS)))) => (cwcel @ XA2 @ (ccword @ XS)))))))))).
