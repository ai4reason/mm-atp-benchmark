...
thf(cnmoub3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XL = (ccfv @ XU @ ccnmcv)) => ((XM = (ccfv @ XW @ ccnmcv)) => ((! [Xx3:$i] : ((XN @ Xx3) = (cco @ XU @ XW @ ccnmoo))) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (! [Xx3:$i] : (((cwf @ XX @ XY @ XT) & (cwcel @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ XM) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XL) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : XX))) => (cwbr @ (ccfv @ XT @ (XN @ Xx3)) @ (ccfv @ XA2 @ ccabs) @ ccle)))))))))))))))))))).
