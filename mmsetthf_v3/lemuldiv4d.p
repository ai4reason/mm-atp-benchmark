...
thf(clemuldiv4d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccdiv) @ ccle)) => ((Xph => (cwbr @ ccc0 @ XA2 @ cclt)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => (cwbr @ (cco @ XB2 @ XA2 @ ccmul) @ XC @ ccle)))))))))))).
