...
thf(adf_pprod_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccpprod @ XA2 @ XB2) = (cctxp @ (cccom @ XA2 @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv))) @ (cccom @ XB2 @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv)))))))).
...
thf(atxprel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwrel @ (cctxp @ XA2 @ XB2))))).
...
thf(atxpss3v_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cctxp @ XA2 @ XB2) @ (ccxp @ ccvv @ (ccxp @ ccvv @ ccvv)))))).
...
thf(abrtxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwbr @ XX @ (ccop @ XY @ XZ) @ (cctxp @ XA2 @ XB2)) <=> ((cwbr @ XX @ XY @ XA2) & (cwbr @ XX @ XZ @ XB2)))))))))))).
...
thf(cpprodss4v_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccpprod @ XA2 @ XB2) @ (ccxp @ (ccxp @ ccvv @ ccvv) @ (ccxp @ ccvv @ ccvv)))))).
