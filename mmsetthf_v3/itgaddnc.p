...
thf(aismbfcn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ ccc @ XF) => ((cwcel @ XF @ ccmbf) <=> ((cwcel @ (cccom @ ccre @ XF) @ ccmbf) & (cwcel @ (cccom @ ccim @ XF) @ ccmbf))))))).
...
thf(aitgcnval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => (Xph => ((ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cco @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccre))) @ (cco @ cci @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccim))) @ ccmul) @ ccaddc)))))))))).
