...
thf(cfcof1oinvd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf1o @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XB2 @ XA2 @ XG)) => ((Xph => ((cccom @ XF @ XG) = (ccres @ ccid @ XB2))) => (Xph => ((cccnv @ XF) = XG))))))))))).
