...
thf(clpolconN_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XP = (ccfv @ XW @ cclpoN)) => ((Xph => (cwcel @ XW @ XX)) => ((Xph => (cwcel @ Xc_pe @ XP)) => ((Xph => (cwss @ XX @ XV)) => ((Xph => (cwss @ XY @ XV)) => ((Xph => (cwss @ XX @ XY)) => (Xph => (cwss @ (ccfv @ XY @ Xc_pe) @ (ccfv @ XX @ Xc_pe)))))))))))))))))).
