...
thf(cstoweidlem15_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : ((XQ @ Xt @ Xf1 @ Xh) = (ccrab @ (^ [Xh:$i] : (((ccfv @ (XZ @ Xt @ Xf1) @ (ccv @ Xh)) = ccc0) & (cwral @ (^ [Xt:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ ccle) & (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cc1 @ ccle))) @ (^ [Xt:$i] : XT)))) @ (^ [Xh:$i] : (XA2 @ Xt))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => (cwf @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xh) @ ccfz) @ (XQ @ Xt @ Xf1 @ Xh) @ XG))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : (((Xph @ Xt @ Xh) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt))) => (cwf @ XT @ ccr @ (ccv @ Xf1)))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : ((((Xph @ Xt @ Xh) & (cwcel @ XI @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xh) @ ccfz))) & (cwcel @ (XS @ Xt @ Xf1 @ Xh) @ XT)) => ((cwcel @ (ccfv @ (XS @ Xt @ Xf1 @ Xh) @ (ccfv @ XI @ XG)) @ ccr) & (cwbr @ ccc0 @ (ccfv @ (XS @ Xt @ Xf1 @ Xh) @ (ccfv @ XI @ XG)) @ ccle) & (cwbr @ (ccfv @ (XS @ Xt @ Xf1 @ Xh) @ (ccfv @ XI @ XG)) @ cc1 @ ccle))))))))))))))))))).
