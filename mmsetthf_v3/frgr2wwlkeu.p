...
thf(aumgrwwlks2on_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccumgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE))))))))))))).
thf(cfrgr2wwlkeu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfrgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & (XA2 != XB2)) => (cwreu @ (^ [Xc:$i] : (cwcel @ (ccs3 @ XA2 @ (ccv @ Xc) @ XB2) @ (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)))) @ (^ [Xc:$i] : XV))))))))).
