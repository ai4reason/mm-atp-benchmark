...
thf(cdisji2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XB2 @ Xx3) = XC))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XY) => ((XB2 @ Xx3) = XD))) => (((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) & ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2)) & (XX != XY)) => ((ccin @ XC @ XD) = cc0))))))))))).
