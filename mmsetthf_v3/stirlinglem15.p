...
thf(astirlinglem8_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X)) => (! [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X))) => ((cwnfc @ (^ [Xn:$i] : (XA2 @ Xn))) => ((cwnfc @ (^ [Xn:$i] : (XD @ Xn))) => ((! [Xn:$i] : ((XD @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XA2 @ Xn)))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ ccn @ ccrp @ (XA2 @ Xn)))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp) @ ccdiv))))) => ((! [Xn:$i] : ((XL @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp))))) => ((! [Xn:$i] : ((XM @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp))))) => ((! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ ccrp))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (XC @ Xn) @ ccrp))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (XA2 @ Xn) @ (XC @ Xn) @ ccli))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (XF @ Xn) @ (cco @ (XC @ Xn) @ cc2 @ ccexp) @ ccli)))))))))))))))))))))).
...
thf(astirlinglem1_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ ccmin))))) => ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((! [Xn:$i] : ((XL @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (XH @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccli))))))))))).
...
thf(aaddgt0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ cclt)) => ((Xph => (cwbr @ ccc0 @ XB2 @ cclt)) => (Xph => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt)))))))))).
...
thf(astirlinglem3_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : ((XD @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XA2 @ Xn)))))) => ((! [Xn:$i] : ((XE @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : ((XV @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (ccv @ Xn) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : ((XV @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ ccdiv) @ ccmul)))))))))))))).
thf(aoveq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(ccfz_tp,type,(ccfz : ($i > $o))).
thf(ccseq_tp,type,(ccseq : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(awallispi2_thm,axiom,(! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((XV @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (ccv @ Xn) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (XV @ Xn) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccli))))).
...
thf(aclimmulc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (cco @ XC @ (ccfv @ (ccv @ Xk) @ XF) @ ccmul)))) => (Xph => (cwbr @ XG @ (cco @ XC @ XA2 @ ccmul) @ ccli)))))))))))))))))).
...
thf(cstirlinglem15_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X)) => (! [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X))) => ((! [Xn:$i] : ((XS @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : ((XA2 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : ((XD @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XA2 @ Xn)))))) => ((! [Xn:$i] : ((XE @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : ((XV @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (ccv @ Xn) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn)) @ cc4 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ (XD @ Xn)) @ cc2 @ ccexp) @ ccdiv))))) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XC @ ccrp))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (XA2 @ Xn) @ XC @ ccli))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (ccfv @ (ccv @ Xn) @ (XS @ Xn)) @ ccdiv))) @ cc1 @ ccli))))))))))))))))))))))).
