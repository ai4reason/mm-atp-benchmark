...
thf(adsmmsubg_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((XH = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccgrp @ XR)) => (Xph => (cwcel @ XH @ (ccfv @ XP @ ccsubg))))))))))))))))).
...
thf(aprdslmodd_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XS @ ccrg)) => ((! [Xy1:$i] : (Xph => (cwcel @ XI @ (XV @ Xy1)))) => ((Xph => (cwf @ XI @ cclmod @ XR)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XI)) => ((ccfv @ (ccfv @ (ccv @ Xy1) @ XR) @ ccsca) = XS))) => (Xph => (cwcel @ XY @ cclmod)))))))))))))).
thf(asimprl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xps))))).
thf(asimpld_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps & Xch)) => (Xph => Xps)))))).
thf(ampbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(adsmmelbas_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xa:$i] : ((XP @ Xa) = (cco @ XS @ XR @ ccprds))) => ((! [Xa:$i] : ((XC @ Xa) = (cco @ XS @ XR @ ccdsmm))) => ((! [Xa:$i] : ((XB2 @ Xa) = (ccfv @ (XP @ Xa) @ ccbs))) => ((! [Xa:$i] : ((XH @ Xa) = (ccfv @ (XC @ Xa) @ ccbs))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XI @ (XV @ Xa)))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwfn @ XR @ XI))) => (! [Xa:$i] : ((Xph @ Xa) => ((cwcel @ XX @ (XH @ Xa)) <=> ((cwcel @ XX @ (XB2 @ Xa)) & (cwcel @ (ccrab @ (^ [Xa:$i] : ((ccfv @ (ccv @ Xa) @ XX) != (ccfv @ (ccfv @ (ccv @ Xa) @ XR) @ cc0g))) @ (^ [Xa:$i] : XI)) @ ccfn)))))))))))))))))))))).
...
thf(aislss4_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XS = (ccfv @ XW @ cclss)) => ((cwcel @ XW @ cclmod) => ((cwcel @ XU @ XS) <=> ((cwcel @ XU @ (ccfv @ XW @ ccsubg)) & (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ Xc_x) @ XU)) @ (^ [Xb:$i] : XU))) @ (^ [Xa:$i] : XB2)))))))))))))))))).
thf(cdsmmlss_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XI @ (XW @ Xx3)))) => ((Xph => (cwcel @ XS @ ccrg)) => ((Xph => (cwf @ XI @ cclmod @ XR)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => ((ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccsca) = XS))) => ((XP = (cco @ XS @ XR @ ccprds)) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ XP @ cclss))) => ((XH = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => (! [Xx3:$i] : (Xph => (cwcel @ XH @ (XU @ Xx3)))))))))))))))))))).
