...
thf(adf_prod_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xk:$i] : ((ccprod @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccio @ (^ [Xx3:$i] : ((cwrex @ (^ [Xm:$i] : ((cwss @ (XA2 @ Xk) @ (ccfv @ (ccv @ Xm) @ ccuz)) & (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : (((ccv @ Xy1) != ccc0) & (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xk)) @ (XB2 @ Xk) @ cc1))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xm) @ ccuz))) & (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xk)) @ (XB2 @ Xk) @ cc1))) @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz)) | (cwrex @ (^ [Xm:$i] : (? [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (XA2 @ Xk) @ (ccv @ Xf1)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xm) @ (ccseq @ ccmul @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))) @ cc1)))))) @ (^ [Xm:$i] : ccn)))))))))).
thf(cprodeq2w_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : ((XB2 @ Xk) = (XC @ Xk))) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))))))))).
