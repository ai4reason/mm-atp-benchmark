...
thf(aprdsbas_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((XP = (cco @ XS @ XR @ ccprds)) => ((! [Xx3:$i] : (Xph => (cwcel @ XS @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XR @ (XW @ Xx3)))) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xph => ((ccdm @ XR) = XI)) => (Xph => (XB2 = (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))))))))))))))))))).
thf(atsettps_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccbs)) => ((XJ = (ccfv @ XK @ ccts)) => ((cwcel @ XJ @ (ccfv @ XA2 @ cctopon)) => (cwcel @ XK @ cctps)))))))).
thf(cprdstps_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwf @ XI @ cctps @ XR)) => (Xph => (cwcel @ XY @ cctps)))))))))))))).
