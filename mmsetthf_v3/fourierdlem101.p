...
thf(cfourierdlem101_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XD @ Xi @ Xm @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ ((cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XP @ Xt @ Xi @ Xm @ Xn @ Xs1 @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XG @ Xm @ Xn @ Xp) = (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xi @ Xm @ Xn @ Xs1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xt) @ (XX @ Xm @ Xn @ Xp) @ ccmin) @ (ccfv @ (XN @ Xi @ Xm @ Xp) @ (XD @ Xi @ Xm @ Xn @ Xp))) @ ccmul))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XQ @ Xm @ Xn) @ (ccfv @ (XM @ Xn) @ (XP @ Xt @ Xi @ Xm @ Xn @ Xs1 @ Xp)))))))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XM @ Xn) @ ccn))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XN @ Xi @ Xm @ Xp) @ ccn))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XX @ Xm @ Xn @ Xp) @ ccr))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwf @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccc @ (XF @ Xi @ Xm @ Xn @ Xs1 @ Xp)))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xm @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xn) @ ccfzo))) => (cwcel @ (ccres @ (XF @ Xi @ Xm @ Xn @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm @ Xn)) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm @ Xn)) @ ccioo) @ ccc @ cccncf)))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xm @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xn) @ ccfzo))) => (cwcel @ (XR @ Xi @ Xm @ Xn @ Xs1 @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xn @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm @ Xn)) @ ccioo)) @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm @ Xn)) @ cclimc)))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xm @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xn) @ ccfzo))) => (cwcel @ (XL @ Xi @ Xm @ Xn @ Xs1 @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xn @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm @ Xn)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm @ Xn)) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm @ Xn)) @ cclimc)))))))) => (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => ((ccitg @ (^ [Xt:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xi @ Xm @ Xn @ Xs1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xt) @ (XX @ Xm @ Xn @ Xp) @ ccmin) @ (ccfv @ (XN @ Xi @ Xm @ Xp) @ (XD @ Xi @ Xm @ Xn @ Xp))) @ ccmul))) = (ccitg @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ ccpi) @ (XX @ Xm @ Xn @ Xp) @ ccmin) @ (cco @ ccpi @ (XX @ Xm @ Xn @ Xp) @ ccmin) @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (cco @ (XX @ Xm @ Xn @ Xp) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xi @ Xm @ Xn @ Xs1 @ Xp)) @ (ccfv @ (ccv @ Xs1) @ (ccfv @ (XN @ Xi @ Xm @ Xp) @ (XD @ Xi @ Xm @ Xn @ Xp))) @ ccmul))))))))))))))))))))))))))))))))).
