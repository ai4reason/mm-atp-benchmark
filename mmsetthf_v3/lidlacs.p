...
thf(alssacs_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((cwcel @ XW @ cclmod) => (cwcel @ XS @ (ccfv @ XB2 @ ccacs))))))))).
thf(arlmbas_thm,axiom,(! [XR:($i > $o)] : ((ccfv @ XR @ ccbs) = (ccfv @ (ccfv @ XR @ ccrglmod) @ ccbs)))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(clidlacs_conj,conjecture,(! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XI = (ccfv @ XW @ cclidl)) => ((cwcel @ XW @ ccrg) => (cwcel @ XI @ (ccfv @ XB2 @ ccacs))))))))).
