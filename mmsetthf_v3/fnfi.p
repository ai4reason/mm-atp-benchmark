...
thf(afunressn_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => (cwss @ (ccres @ XF @ (ccsn @ XB2)) @ (ccsn @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)))))))).
...
thf(cfnfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XA2 @ ccfn)) => (cwcel @ XF @ ccfn))))).
