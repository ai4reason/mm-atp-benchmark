...
thf(aalephsucdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwbr @ XA2 @ (ccfv @ XB2 @ ccale) @ ccdom) <=> (cwbr @ XA2 @ (ccfv @ (ccsuc @ XB2) @ ccale) @ ccsdm)))))).
...
thf(asdomel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwbr @ XA2 @ XB2 @ ccsdm) => (cwcel @ XA2 @ XB2)))))).
...
thf(calephsuc2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ (ccsuc @ XA2) @ ccale) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ ccale) @ ccdom)) @ (^ [Xx3:$i] : ccon0)))))).
