...
thf(cfindfvcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ (ccfv @ cc0 @ XF) @ XP)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccom) => (Xph => ((cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ XP) => (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ XF) @ XP))))) => (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ ccom) => (Xph => (cwcel @ (ccfv @ (XA2 @ Xy1) @ XF) @ XP))))))))))).
