...
thf(ccocossss_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwss @ (cccoss @ (cccoss @ XR)) @ XS) <=> (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (cccoss @ XR)) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (cccoss @ XR))) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XS))))))))).
