...
thf(anbfiusgrfi_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ (ccfv @ XG @ ccvtx))) => (cwcel @ (cco @ XG @ XN @ ccnbgr) @ ccfn))))).
...
thf(as3iunsndisj_thm,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XB2 @ XX) => (cwdisj @ (^ [Xa:$i] : XY) @ (^ [Xa:$i] : (cciun @ (^ [Xc:$i] : (ccdif @ XZ @ (ccsn @ (ccv @ Xa)))) @ (^ [Xc:$i] : (ccsn @ (ccs3 @ (ccv @ Xa) @ XB2 @ (ccv @ Xc))))))))))))).
...
thf(as3sndisj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY)) => (cwdisj @ (^ [Xc:$i] : XZ) @ (^ [Xc:$i] : (ccsn @ (ccs3 @ XA2 @ XB2 @ (ccv @ Xc)))))))))))).
...
thf(ahashnbusgrvd_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XU @ XV)) => ((ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) = (ccfv @ XU @ (ccfv @ XG @ ccvtxdg))))))))).
