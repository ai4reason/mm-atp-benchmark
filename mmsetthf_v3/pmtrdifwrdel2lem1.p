...
thf(apmtrdifellem4_thm,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XT = (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccpmtr))) => ((XR = (ccrn @ (ccfv @ XN @ ccpmtr))) => ((XS = (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ XN @ ccpmtr))) => (((cwcel @ XQ @ XT) & (cwcel @ XK @ XN)) => ((ccfv @ XK @ XS) = XK)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cpmtrdifwrdel2lem1_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (XT = (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ (XK @ Xx3))) @ ccpmtr)))) => ((! [Xi:$i] : ((XR @ Xi) = (ccrn @ (ccfv @ XN @ ccpmtr)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XU @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xx3) @ XW) @ ccid)) @ (ccfv @ XN @ ccpmtr))))))) => (! [Xx3:$i] : (((cwcel @ XW @ (ccword @ XT)) & (cwcel @ (XK @ Xx3) @ XN)) => (cwral @ (^ [Xi:$i] : ((ccfv @ (XK @ Xx3) @ (ccfv @ (ccv @ Xi) @ (XU @ Xx3 @ Xi))) = (XK @ Xx3))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))))))))))))))).
