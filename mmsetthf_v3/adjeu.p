...
thf(cadjeu_conj,conjecture,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwcel @ XT @ (ccdm @ ccado)) <=> (cwreu @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccsp) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xu:$i] : (cco @ cchil @ cchil @ ccmap))))))).
