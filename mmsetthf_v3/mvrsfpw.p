...
thf(cmvrsfpw_conj,conjecture,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XE = (ccfv @ XT @ ccmex)) => ((XW = (ccfv @ XT @ ccmvrs)) => ((cwcel @ XX @ XE) => (cwcel @ (ccfv @ XX @ XW) @ (ccin @ (ccpw @ XV) @ ccfn)))))))))))).
