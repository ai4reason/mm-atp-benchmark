...
thf(cclwwlkvbijOLD_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (? [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xw:$i] : (((ccfv @ (ccv @ Xw) @ cclsw) = (ccfv @ ccc0 @ (ccv @ Xw))) & ((ccfv @ ccc0 @ (ccv @ Xw)) = XS))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))) @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XS)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn))) @ (ccv @ Xf1)))))))).
