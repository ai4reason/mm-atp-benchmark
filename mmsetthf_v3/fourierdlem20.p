...
thf(cfourierdlem20_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwcel @ XM @ ccn)))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwcel @ (XA2 @ Xi @ Xk) @ ccr)))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwcel @ (XB2 @ Xi @ Xk) @ ccr)))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwbr @ (XA2 @ Xi @ Xk) @ (XB2 @ Xi @ Xk) @ ccle)))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwf @ (cco @ ccc0 @ XM @ ccfz) @ ccr @ XQ)))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwbr @ (ccfv @ ccc0 @ XQ) @ (XA2 @ Xi @ Xk) @ ccle)))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwbr @ (XB2 @ Xi @ Xk) @ (ccfv @ XM @ XQ) @ ccle)))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwcel @ XJ @ (cco @ ccc0 @ (XN @ Xi @ Xk) @ ccfzo))))) => ((! [Xi:$i] : (! [Xk:$i] : ((XT @ Xi @ Xk) = (ccun @ (ccpr @ (XA2 @ Xi @ Xk) @ (XB2 @ Xi @ Xk)) @ (ccin @ (ccrn @ XQ) @ (cco @ (XA2 @ Xi @ Xk) @ (XB2 @ Xi @ Xk) @ ccioo)))))) => ((! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwiso @ (cco @ ccc0 @ (XN @ Xi @ Xk) @ ccfz) @ (XT @ Xi @ Xk) @ cclt @ cclt @ XS)))) => ((! [Xk:$i] : ((XI @ Xk) = (ccsup @ (ccrab @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XQ) @ (ccfv @ XJ @ XS) @ ccle)) @ (^ [Xk:$i] : (cco @ ccc0 @ XM @ ccfzo))) @ ccr @ cclt))) => (! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xi @ Xk) => (cwrex @ (^ [Xi:$i] : (cwss @ (cco @ (ccfv @ XJ @ XS) @ (ccfv @ (cco @ XJ @ cc1 @ ccaddc) @ XS) @ ccioo) @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)))))))))))))))))))))))))))).
