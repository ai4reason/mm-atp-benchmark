...
thf(cbrfvrcld2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XR @ ccrcl)) <=> (((cwcel @ XA2 @ (ccun @ (ccdm @ XR) @ (ccrn @ XR))) & (cwcel @ XB2 @ (ccun @ (ccdm @ XR) @ (ccrn @ XR))) & (XA2 = XB2)) | (cwbr @ XA2 @ XB2 @ XR)))))))))).
