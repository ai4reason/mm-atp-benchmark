...
thf(cspecval_conj,conjecture,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((ccfv @ XT @ ccspc) = (ccrab @ (^ [Xx3:$i] : (~ (cwf1 @ cchil @ cchil @ (cco @ XT @ (cco @ (ccv @ Xx3) @ (ccres @ ccid @ cchil) @ cchot) @ cchod)))) @ (^ [Xx3:$i] : ccc)))))).
