...
thf(adf_gim_ax,axiom,(ccgim = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : ccgrp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : ccgrp)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccrab @ (^ [Xg1:$i] : (cwf1o @ (ccfv @ (ccv @ Xs1) @ ccbs) @ (ccfv @ (ccv @ Xt) @ ccbs) @ (ccv @ Xg1))) @ (^ [Xg1:$i] : (cco @ (ccv @ Xs1) @ (ccv @ Xt) @ ccghm)))))))).
...
thf(cisgim_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (ccfv @ XS @ ccbs)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccgim)) <=> ((cwcel @ XF @ (cco @ XR @ XS @ ccghm)) & (cwf1o @ XB2 @ XC @ XF))))))))))).
