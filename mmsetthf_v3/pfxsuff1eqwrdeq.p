...
thf(cpfxsuff1eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV)) & (cwbr @ ccc0 @ (ccfv @ XW @ cchash) @ cclt)) => ((XW = XU) <=> (((ccfv @ XW @ cchash) = (ccfv @ XU @ cchash)) & (((cco @ XW @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx) = (cco @ XU @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx)) & ((ccfv @ XW @ cclsw) = (ccfv @ XU @ cclsw)))))))))).
