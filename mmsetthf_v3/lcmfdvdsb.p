...
thf(clcmfdvdsb_conj,conjecture,(! [XK:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XK @ ccz) & (cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn)) => ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ XK @ ccdvds)) @ (^ [Xm:$i] : XZ)) <=> (cwbr @ (ccfv @ XZ @ cclcmf) @ XK @ ccdvds)))))).
