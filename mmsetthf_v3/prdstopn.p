...
thf(aprdstset_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XR @ XW)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xph => ((ccdm @ XR) = XI)) => ((XO = (ccfv @ XP @ ccts)) => (Xph => (XO = (ccfv @ (cccom @ cctopn @ XR) @ ccpt))))))))))))))))))).
...
thf(cprdstopn_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => ((XO = (ccfv @ XY @ cctopn)) => (Xph => (XO = (ccfv @ (cccom @ cctopn @ XR) @ ccpt))))))))))))))))).
