...
thf(ahoidmvval0_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XX:($i > $o)] : (((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xj)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xj)) @ X))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XL @ Xx3 @ Xj @ Xk @ Xa @ Xb) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ XX @ ccfn))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xj) => (cwf @ XX @ ccr @ (XA2 @ Xx3))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xj) => (cwf @ XX @ ccr @ (XB2 @ Xx3))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xj) => (cwrex @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccv @ Xj) @ (XB2 @ Xx3)) @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xx3)) @ ccle)) @ (^ [Xj:$i] : XX))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj) => ((cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (ccfv @ XX @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb))) = ccc0))))))))))))))))))).
