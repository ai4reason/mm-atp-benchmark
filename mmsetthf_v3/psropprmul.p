...
thf(cpsropprmul_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XI @ XR @ ccmps)) => ((XS = (ccfv @ XR @ ccoppr)) => ((XZ = (cco @ XI @ XS @ ccmps)) => ((Xc_x = (ccfv @ XY @ ccmulr)) => ((Xc_xb = (ccfv @ XZ @ ccmulr)) => ((XB2 = (ccfv @ XY @ ccbs)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XB2) & (cwcel @ XG @ XB2)) => ((cco @ XF @ XG @ Xc_xb) = (cco @ XG @ XF @ Xc_x)))))))))))))))))))).
