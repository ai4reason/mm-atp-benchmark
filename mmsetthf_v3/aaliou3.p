...
thf(aaaliou3lem9_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > $o)] : ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ cc2 @ (ccneg @ (ccfv @ (ccv @ Xa) @ ccfa)) @ ccexp))))) => ((! [Xa:$i] : (XL = (ccsu @ ccn @ (^ [Xb:$i] : (ccfv @ (ccv @ Xb) @ (XF @ Xa)))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XH @ Xa @ Xb @ Xc) = (ccmpt @ (^ [Xc:$i] : ccn) @ (^ [Xc:$i] : (ccsu @ (cco @ cc1 @ (ccv @ Xc) @ ccfz) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xb) @ (XF @ Xa)))))))))) => (~ (cwcel @ XL @ ccaa))))))))).
...
thf(caaliou3_conj,conjecture,(cwnel @ (ccsu @ ccn @ (^ [Xk:$i] : (cco @ cc2 @ (ccneg @ (ccfv @ (ccv @ Xk) @ ccfa)) @ ccexp))) @ ccaa)).
