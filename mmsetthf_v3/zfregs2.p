...
thf(azfregs_thm,axiom,(! [XA2:($i > $o)] : ((XA2 != cc0) => (cwrex @ (^ [Xx3:$i] : ((ccin @ (ccv @ Xx3) @ XA2) = cc0)) @ (^ [Xx3:$i] : XA2))))).
...
thf(czfregs2_conj,conjecture,(! [XA2:($i > $o)] : ((XA2 != cc0) => (~ (cwral @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : XA2)))))).
