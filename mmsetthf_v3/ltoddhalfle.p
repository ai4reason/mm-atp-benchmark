...
thf(cltoddhalfle_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds)) & (cwcel @ XM @ ccz)) => ((cwbr @ XM @ (cco @ XN @ cc2 @ ccdiv) @ cclt) <=> (cwbr @ XM @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))))).
