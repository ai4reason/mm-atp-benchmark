...
thf(cdicelval3_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XQ:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xg1:$i] : (! [Xs1:$i] : ((Xc_le @ Xg1 @ Xs1) = (ccfv @ XK @ ccple)))) => ((! [Xg1:$i] : (! [Xs1:$i] : ((XA2 @ Xg1 @ Xs1) = (ccfv @ XK @ ccatm)))) => ((! [Xg1:$i] : (! [Xs1:$i] : ((XH @ Xg1 @ Xs1) = (ccfv @ XK @ cclh)))) => ((! [Xg1:$i] : (! [Xs1:$i] : ((XP @ Xg1 @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccoc))))) => ((! [Xs1:$i] : ((XT @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccltrn)))) => ((! [Xg1:$i] : ((XE @ Xg1) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xg1:$i] : (! [Xs1:$i] : ((XI @ Xg1 @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccdic))))) => ((! [Xg1:$i] : (! [Xs1:$i] : ((XG @ Xg1 @ Xs1) = (ccrio @ (^ [Xg1:$i] : ((ccfv @ (XP @ Xg1 @ Xs1) @ (ccv @ Xg1)) = XQ)) @ (^ [Xg1:$i] : (XT @ Xs1)))))) => (! [Xg1:$i] : (! [Xs1:$i] : ((((cwcel @ XK @ (XV @ Xg1 @ Xs1)) & (cwcel @ XW @ (XH @ Xg1 @ Xs1))) & ((cwcel @ XQ @ (XA2 @ Xg1 @ Xs1)) & (~ (cwbr @ XQ @ XW @ (Xc_le @ Xg1 @ Xs1))))) => ((cwcel @ (XY @ Xg1) @ (ccfv @ XQ @ (XI @ Xg1 @ Xs1))) <=> (cwrex @ (^ [Xs1:$i] : ((XY @ Xg1) = (ccop @ (ccfv @ (XG @ Xg1 @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (XE @ Xg1))))))))))))))))))))))))))))).
