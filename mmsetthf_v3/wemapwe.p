...
thf(aoiexg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((XF = (ccoi @ XA2 @ XR)) => ((cwcel @ XA2 @ XV) => (cwcel @ XF @ ccvv)))))))).
...
thf(aoemapwe_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xw:$i] : ((XS @ Xw) = (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XA2 @ ccon0))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XB2 @ ccon0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) & (cwral @ (^ [Xw:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xw)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xz:$i] : XB2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xw) => ((cwwe @ (XS @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw)) & ((ccdm @ (ccoi @ (XS @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))) = (cco @ XA2 @ XB2 @ ccoe)))))))))))))))))).
...
thf(cwemapwe_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ (XS @ Xx3 @ Xy1 @ Xw)) & (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XR @ Xx3 @ Xy1)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XU @ Xz @ Xw) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XZ @ Xy1 @ Xz @ Xw) @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xz @ Xw) @ XA2 @ ccmap))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwwe @ XA2 @ (XR @ Xx3 @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwwe @ (XB2 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xw))))))) => ((! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => ((XB2 @ Xz @ Xw) != cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XF = (ccoi @ XA2 @ (XR @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XG @ Xz @ Xw) = (ccoi @ (XB2 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xw))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XZ @ Xy1 @ Xz @ Xw) = (ccfv @ cc0 @ (XG @ Xz @ Xw)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwwe @ (XU @ Xz @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))))))))))))))).
