...
thf(aedgnbusgreu_thm,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xn:$i] : ((XN @ Xn) = (cco @ XG @ XM @ ccnbgr))) => ((((cwcel @ XG @ ccusgr) & (cwcel @ XM @ XV)) & ((cwcel @ XC @ XE) & (cwcel @ XM @ XC))) => (cwreu @ (^ [Xn:$i] : (XC = (ccpr @ XM @ (ccv @ Xn)))) @ (^ [Xn:$i] : (XN @ Xn)))))))))))))).
...
thf(cnbusgrf1o0_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XN = (cco @ XG @ XU @ ccnbgr)) => ((XI = (ccrab @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (ccpr @ XU @ (ccv @ Xn)))))) => (! [Xn:$i] : (((cwcel @ XG @ ccusgr) & (cwcel @ XU @ XV)) => (cwf1o @ XN @ XI @ (XF @ Xn))))))))))))))))).
