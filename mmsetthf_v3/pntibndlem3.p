...
thf(achpdifbnd_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xy1) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ ccchp) @ ccmin) @ (cco @ (cco @ cc2 @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccmul) @ (cco @ (ccv @ Xc) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmul) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ ccicc)))) @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)))) @ (^ [Xc:$i] : ccrp))))).
