...
thf(azlmodzxznm_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xi:$i] : ((XZ @ Xi) = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm))) => ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccpr @ (ccop @ ccc0 @ ccc0) @ (ccop @ cc1 @ ccc0)))) => ((! [Xi:$i] : ((Xc_xb @ Xi) = (ccfv @ (XZ @ Xi) @ ccvsca))) => ((! [Xi:$i] : ((Xc_mi @ Xi) = (ccfv @ (XZ @ Xi) @ ccsg))) => ((! [Xi:$i] : ((XA2 @ Xi) = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6)))) => ((! [Xi:$i] : ((XB2 @ Xi) = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4)))) => (cwral @ (^ [Xi:$i] : (((cco @ (ccv @ Xi) @ (XA2 @ Xi) @ (Xc_xb @ Xi)) != (XB2 @ Xi)) & ((cco @ (ccv @ Xi) @ (XB2 @ Xi) @ (Xc_xb @ Xi)) != (XA2 @ Xi)))) @ (^ [Xi:$i] : ccz))))))))))))))).
...
thf(cldepsnlinclem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((cwcel @ XF @ (cco @ (ccfv @ czring @ ccbs) @ (ccsn @ XA2) @ ccmap)) => ((cco @ XF @ (ccsn @ XA2) @ (ccfv @ XZ @ cclinc)) != XB2)))))))))).
