...
thf(aatex_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((cwcel @ XK @ cchlt) => (XA2 != cc0)))))).
...
thf(clplnn0N_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XP = (ccfv @ XK @ cclpl)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XP)) => (XX != Xc_0))))))))).
