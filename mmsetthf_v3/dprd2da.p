...
thf(areldmdprd_thm,axiom,(cwrel @ (ccdm @ ccdprd))).
...
thf(adprd2dlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwrel @ XA2)) => ((Xph => (cwf @ XA2 @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xj:$i] : (Xph => (cwss @ (ccdm @ XA2) @ (XI @ Xj)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (XI @ Xj))) => (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ (ccdm @ ccdprd))))) => ((! [Xj:$i] : (Xph => (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ (ccdm @ ccdprd)))) => ((! [Xj:$i] : ((XK @ Xj) = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc))) => ((Xph & (cwcel @ XX @ XA2)) => (cwss @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccfv @ XX @ cc1st)))) @ (^ [Xj:$i] : (cco @ (ccfv @ XX @ cc1st) @ (ccv @ Xj) @ XS))) @ ccdprd))))))))))))))))).
...
thf(adprdub_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwcel @ XX @ XI)) => (Xph => (cwss @ (ccfv @ XX @ XS) @ (cco @ XG @ XS @ ccdprd)))))))))))).
...
thf(amrccl_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XX)) => (cwcel @ (ccfv @ XU @ XF) @ XC)))))))).
thf(alsmunss_thm,axiom,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => (((cwcel @ XT @ (ccfv @ XG @ ccsubg)) & (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => (cwss @ (ccun @ XT @ XU) @ (cco @ XT @ XU @ Xc_po))))))))).
...
thf(afunimassov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwss @ (ccxp @ XA2 @ XB2) @ (ccdm @ XF))) => ((cwss @ (ccima @ XF @ (ccxp @ XA2 @ XB2)) @ XC) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XC)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(adprdspan_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) => ((cco @ XG @ XS @ ccdprd) = (ccfv @ (ccuni @ (ccrn @ XS)) @ XK)))))))).
...
thf(adprdsn_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((cwbr @ XG @ (ccsn @ (ccop @ XA2 @ XS)) @ (ccdm @ ccdprd)) & ((cco @ XG @ (ccsn @ (ccop @ XA2 @ XS)) @ ccdprd) = XS)))))))).
...
thf(adprd2dlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((Xph => (cwrel @ XA2)) => ((Xph => (cwf @ XA2 @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xj:$i] : (Xph => (cwss @ (ccdm @ XA2) @ (XI @ Xj)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (XI @ Xj))) => (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ (ccdm @ ccdprd))))) => ((! [Xj:$i] : (Xph => (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ (ccdm @ ccdprd)))) => ((! [Xj:$i] : ((XK @ Xj) = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc))) => ((! [Xj:$i] : (Xph => (cwss @ (XC @ Xj) @ (XI @ Xj)))) => (! [Xj:$i] : (Xph => ((ccfv @ (ccuni @ (ccima @ XS @ (ccres @ XA2 @ (XC @ Xj)))) @ (XK @ Xj)) = (cco @ XG @ (ccmpt @ (^ [Xi:$i] : (XC @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ ccdprd))))))))))))))))))).
...
thf(alsmdisj2_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xph => (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => ((ccin @ (cco @ XS @ XT @ Xc_po) @ XU) = (ccsn @ Xc_0))) => ((Xph => ((ccin @ XS @ XT) = (ccsn @ Xc_0))) => (Xph => ((ccin @ XT @ (cco @ XS @ XU @ Xc_po)) = (ccsn @ Xc_0)))))))))))))))))).
...
thf(alsmlub_thm,axiom,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XT @ (ccfv @ XG @ ccsubg)) & (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => (((cwss @ XS @ XU) & (cwss @ XT @ XU)) <=> (cwss @ (cco @ XS @ XT @ Xc_po) @ XU)))))))))).
...
thf(adprddisj_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwcel @ XX @ XI)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (Xph => ((ccin @ (ccfv @ XX @ XS) @ (ccfv @ (ccuni @ (ccima @ XS @ (ccdif @ XI @ (ccsn @ XX)))) @ XK)) = (ccsn @ Xc_0)))))))))))))))).
