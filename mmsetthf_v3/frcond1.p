...
thf(arspc2vd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xth @ Xx3 @ Xy1) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XB2 @ Xx3)) => ((Xch @ Xy1) <=> (Xps @ Xx3))))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ (XC @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xy1) & ((ccv @ Xx3) = XA2)) => ((XD @ Xx3) = (XE @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XB2 @ Xx3) @ (XE @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xth @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XD @ Xx3)))) @ (^ [Xx3:$i] : (XC @ Xy1))) => (Xps @ Xx3)))))))))))))))))))).
...
thf(cfrcond1_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : ((XE @ Xb) = (ccfv @ XG @ ccedg))) => ((cwcel @ XG @ ccfrgr) => (((cwcel @ XA2 @ XV) & (cwcel @ XC @ XV) & (XA2 != XC)) => (cwreu @ (^ [Xb:$i] : (cwss @ (ccpr @ (ccpr @ XA2 @ (ccv @ Xb)) @ (ccpr @ (ccv @ Xb) @ XC)) @ (XE @ Xb))) @ (^ [Xb:$i] : XV)))))))))))).
