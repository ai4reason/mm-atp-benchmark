...
thf(clvolnlelpln_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XP = (ccfv @ XK @ cclpl)) => ((XV = (ccfv @ XK @ cclvol)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XV) & (cwcel @ XY @ XP)) => (~ (cwbr @ XX @ XY @ Xc_le))))))))))))).
