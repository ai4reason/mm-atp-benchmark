...
thf(arngohomadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((XJ = (ccfv @ XS @ cc1st)) => ((((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((ccfv @ (cco @ XA2 @ XB2 @ XG) @ XF) = (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ XJ))))))))))))))).
...
thf(crngogrphom_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XJ = (ccfv @ XS @ cc1st)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) => (cwcel @ XF @ (cco @ XG @ XJ @ ccghomOLD))))))))))).
