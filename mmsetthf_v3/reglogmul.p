...
thf(creglogmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp) & ((cwcel @ XC @ ccrp) & (XC != cc1))) => ((cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) = (cco @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ ccaddc))))))).
