...
thf(cdfac5lem3_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : ((XA2 @ Xu @ Xt @ Xh) = (^ [Xu:$i] : (((ccv @ Xu) != cc0) & (cwrex @ (^ [Xt:$i] : ((ccv @ Xu) = (ccxp @ (ccsn @ (ccv @ Xt)) @ (ccv @ Xt)))) @ (^ [Xt:$i] : (ccv @ Xh))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xh:$i] : ((cwcel @ (ccxp @ (ccsn @ (ccv @ Xw)) @ (ccv @ Xw)) @ (XA2 @ Xu @ Xt @ Xh)) <=> (((ccv @ Xw) != cc0) & (cwcel @ (ccv @ Xw) @ (ccv @ Xh))))))))))).
