...
thf(cfuncres2_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XR @ (ccfv @ XD @ ccsubc)) => (cwss @ (cco @ XC @ (cco @ XD @ XR @ ccresc) @ ccfunc) @ (cco @ XC @ XD @ ccfunc))))))).
