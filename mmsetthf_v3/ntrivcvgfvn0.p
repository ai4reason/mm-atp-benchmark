...
thf(cntrivcvgfvn0_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : (Xph => (cwbr @ (ccseq @ ccmul @ XF @ XM) @ (XX @ Xk) @ ccli))) => ((! [Xk:$i] : (Xph => ((XX @ Xk) != ccc0))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => (Xph => ((ccfv @ XN @ (ccseq @ ccmul @ XF @ XM)) != ccc0)))))))))))))).
