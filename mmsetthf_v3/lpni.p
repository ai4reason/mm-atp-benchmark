...
thf(atncp_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xl:$i] : ((XP @ Xl) = (ccuni @ XG))) => (! [Xl:$i] : ((cwcel @ XG @ ccplig) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xl:$i] : (~ ((cwcel @ (ccv @ Xa) @ (ccv @ Xl)) & (cwcel @ (ccv @ Xb) @ (ccv @ Xl)) & (cwcel @ (ccv @ Xc) @ (ccv @ Xl))))) @ (^ [Xl:$i] : XG))) @ (^ [Xc:$i] : (XP @ Xl)))) @ (^ [Xb:$i] : (XP @ Xl)))) @ (^ [Xa:$i] : (XP @ Xl))))))))).
