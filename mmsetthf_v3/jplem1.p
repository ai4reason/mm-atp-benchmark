...
thf(cjplem1_conj,conjecture,(! [Xu:$i] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ (ccv @ Xu) @ cchil) & ((ccfv @ (ccv @ Xu) @ ccno) = cc1)) => ((cwcel @ (ccv @ Xu) @ XA2) <=> ((cco @ (ccfv @ (ccfv @ (ccv @ Xu) @ (ccfv @ XA2 @ ccpjh)) @ ccno) @ cc2 @ ccexp) = cc1))))))).
