...
thf(ccmodscexp_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((((cwcel @ XW @ ccclm) & (cwcel @ cci @ XK)) & (cwcel @ XN @ ccn)) => (cwcel @ (cco @ cci @ XN @ ccexp) @ XK))))))))).
