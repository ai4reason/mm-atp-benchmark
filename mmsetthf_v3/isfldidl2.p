...
thf(cisfldidl2_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XK @ cc1st)) => ((XH = (ccfv @ XK @ cc2nd)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => ((cwcel @ XK @ ccfld) <=> ((cwcel @ XK @ cccring) & (XX != (ccsn @ XZ)) & ((ccfv @ XK @ ccidl) = (ccpr @ (ccsn @ XZ) @ XX)))))))))))))).
