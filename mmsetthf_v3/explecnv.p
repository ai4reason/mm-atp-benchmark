...
thf(cexplecnv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (Xph => (cwcel @ XF @ (XV @ Xk)))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccabs) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccle))) => (Xph => (cwbr @ XF @ ccc0 @ ccli)))))))))))))))).
