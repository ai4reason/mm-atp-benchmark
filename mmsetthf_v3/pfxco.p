...
thf(cpfxco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) & (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XW @ XN @ ccpfx)) = (cco @ (cccom @ XF @ XW) @ XN @ ccpfx))))))))).
