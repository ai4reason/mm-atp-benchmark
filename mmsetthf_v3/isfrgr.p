...
thf(adf_frgr_ax,axiom,(ccfrgr = (^ [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ ccusgr) & (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xe:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xl:$i] : (cwreu @ (^ [Xx3:$i] : (cwss @ (ccpr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xk)) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xl))) @ (ccv @ Xe))) @ (^ [Xx3:$i] : (ccv @ Xv)))) @ (^ [Xl:$i] : (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : (ccv @ Xv)))) @ (ccfv @ (ccv @ Xg1) @ ccedg))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
...
thf(cisfrgr_conj,conjecture,(! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xl:$i] : ((XE @ Xx3 @ Xk @ Xl) = (ccfv @ XG @ ccedg))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xl:$i] : ((cwcel @ XG @ (XU @ Xx3 @ Xk @ Xl)) => ((cwcel @ XG @ ccfrgr) <=> ((cwcel @ XG @ ccusgr) & (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xl:$i] : (cwreu @ (^ [Xx3:$i] : (cwss @ (ccpr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xk)) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xl))) @ (XE @ Xx3 @ Xk @ Xl))) @ (^ [Xx3:$i] : XV))) @ (^ [Xl:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : XV))))))))))))))).
