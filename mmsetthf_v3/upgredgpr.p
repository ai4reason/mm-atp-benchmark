...
thf(cupgredgpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XG @ ccupgr) & (cwcel @ XC @ XE) & (cwss @ (ccpr @ XA2 @ XB2) @ XC)) & ((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XW) & (XA2 != XB2))) => ((ccpr @ XA2 @ XB2) = XC))))))))))))).
