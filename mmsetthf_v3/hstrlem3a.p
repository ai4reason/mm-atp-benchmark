...
thf(chstrlem3a_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : ((XS @ Xx3 @ Xu) = (ccmpt @ (^ [Xx3:$i] : ccch) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xu) @ (ccfv @ (ccv @ Xx3) @ ccpjh))))))) => (! [Xx3:$i] : (! [Xu:$i] : (((cwcel @ (ccv @ Xu) @ cchil) & ((ccfv @ (ccv @ Xu) @ ccno) = cc1)) => (cwcel @ (XS @ Xx3 @ Xu) @ cchst))))))).
