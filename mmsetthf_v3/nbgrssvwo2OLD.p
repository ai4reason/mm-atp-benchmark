...
thf(cnbgrssvwo2OLD_conj,conjecture,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ XW) & (cwnel @ XM @ (cco @ XG @ XN @ ccnbgr))) => (cwss @ (cco @ XG @ XN @ ccnbgr) @ (ccdif @ XV @ (ccpr @ XM @ XN))))))))))).
