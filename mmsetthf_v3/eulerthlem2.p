...
thf(af1oeq23_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((XA2 = XB2) & (XC = XD)) => ((cwf1o @ XA2 @ XC @ XF) <=> (cwf1o @ XB2 @ XD @ XF))))))))).
