...
thf(afsuppcolem_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn)) => ((Xph => (cwf1 @ XX @ XY @ XG)) => (Xph => (cwcel @ (ccima @ (cccnv @ (cccom @ XF @ XG)) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn))))))))))).
