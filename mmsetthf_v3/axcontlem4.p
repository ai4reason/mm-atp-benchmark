...
thf(caxcontlem4_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((XD @ Xx3 @ Xy1 @ Xp) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((((cwcel @ XN @ ccn) & ((cwss @ (XA2 @ Xy1) @ (ccfv @ XN @ ccee)) & (cwss @ XB2 @ (ccfv @ XN @ ccee)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XZ @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) & (((cwcel @ XZ @ (ccfv @ XN @ ccee)) & (cwcel @ XU @ (XA2 @ Xy1)) & (XB2 != cc0)) & (XZ != XU))) => (cwss @ (XA2 @ Xy1) @ (XD @ Xx3 @ Xy1 @ Xp)))))))))))))).
