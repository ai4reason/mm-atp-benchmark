...
thf(avitalilem1_thm,axiom,(! [Xc_sm:($i > $o)] : ((Xc_sm = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc))) & (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccq)))))) => (cwer @ (cco @ ccc0 @ cc1 @ ccicc) @ Xc_sm)))).
...
thf(aserclim0_thm,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => (cwbr @ (ccseq @ ccaddc @ (ccxp @ (ccfv @ XM @ ccuz) @ (ccsn @ ccc0)) @ XM) @ ccc0 @ ccli)))).
...
thf(cvitalilem5_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xc_sm:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xc_sm = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc))) & (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccq)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XS @ Xx3 @ Xy1 @ Xn @ Xs1) = (ccqs @ (cco @ ccc0 @ cc1 @ ccicc) @ Xc_sm)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xy1 @ Xs1) => (cwfn @ XF @ (XS @ Xx3 @ Xy1 @ Xn @ Xs1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xy1 @ Xs1) => (cwral @ (^ [Xz:$i] : (((ccv @ Xz) != cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (XS @ Xx3 @ Xy1 @ Xn @ Xs1)))))))) => ((! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xy1 @ Xs1) => (cwf1o @ ccn @ (ccin @ ccq @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc)) @ XG)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XT @ Xy1 @ Xz @ Xn @ Xs1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xs1:$i] : (cwcel @ (cco @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xn) @ XG) @ ccmin) @ (ccrn @ XF))) @ (^ [Xs1:$i] : ccr))))))))) => ((! [Xy1:$i] : (! [Xs1:$i] : ((Xph @ Xy1 @ Xs1) => (~ (cwcel @ (ccrn @ XF) @ (ccdif @ (ccpw @ ccr) @ (ccdm @ ccvol))))))) => (! [Xy1:$i] : (! [Xs1:$i] : (~ (Xph @ Xy1 @ Xs1)))))))))))))))))).
