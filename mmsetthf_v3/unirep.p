...
thf(aeu4_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) <=> ((? [Xx3:$i] : (Xph @ Xx3)) & (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3) & (Xps @ Xy1)) => ((ccv @ Xx3) = (ccv @ Xy1))))))))))).
...
thf(cunirep_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (XD @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (XD @ Xz)) => ((XB2 @ Xy1) = (XC @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xch @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((XB2 @ Xy1) = (XF @ Xz))))) => ((! [Xy1:$i] : (cwcel @ (XB2 @ Xy1) @ ccvv)) => (! [Xz:$i] : (((cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((Xph @ Xy1) & (Xch @ Xz)) => ((XB2 @ Xy1) = (XF @ Xz)))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : XA2)) & ((cwcel @ (XD @ Xz) @ XA2) & (Xps @ Xz))) => ((ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XB2 @ Xy1)))) @ (^ [Xy1:$i] : XA2)))) = (XC @ Xz)))))))))))))))))).
