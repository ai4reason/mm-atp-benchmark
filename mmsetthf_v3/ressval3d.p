...
thf(asetsidvald_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwfun @ XS)) => ((Xph => (cwcel @ (ccfv @ ccnx @ XE) @ (ccdm @ XS))) => (Xph => (XS = (cco @ XS @ (ccop @ (ccfv @ ccnx @ XE) @ (ccfv @ XS @ XE)) @ ccsts)))))))))))))).
...
thf(cressval3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XR = (cco @ XS @ XA2 @ ccress)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XE = (ccfv @ ccnx @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwfun @ XS)) => ((Xph => (cwcel @ XE @ (ccdm @ XS))) => ((Xph => (cwcel @ XA2 @ XY)) => ((Xph => (cwss @ XA2 @ XB2)) => (Xph => (XR = (cco @ XS @ (ccop @ XE @ XA2) @ ccsts)))))))))))))))))))).
