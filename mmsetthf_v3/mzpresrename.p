...
thf(cmzpresrename_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ ccvv) & (cwss @ XV @ XW) & (cwcel @ XF @ (ccfv @ XV @ ccmzp))) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (ccres @ (ccv @ Xx3) @ XV) @ XF))) @ (ccfv @ XW @ ccmzp))))))).
