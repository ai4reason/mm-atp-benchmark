...
thf(apgpfi2_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn)) => ((cwbr @ XP @ XG @ ccpgp) <=> ((cwcel @ XP @ ccprime) & ((ccfv @ XX @ cchash) = (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp)))))))))).
...
thf(asubgdprd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => (cwss @ (ccrn @ XS) @ (ccpw @ XA2))) => (Xph => ((cco @ XH @ XS @ ccdprd) = (cco @ XG @ XS @ ccdprd))))))))))))).
thf(asimprbda_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> (Xch & Xth))) => ((Xph & Xps) => Xch))))))).
thf(asubgdmdprd_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XG @ ccsubg)) => ((cwbr @ XH @ XS @ (ccdm @ ccdprd)) <=> ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) & (cwss @ (ccrn @ XS) @ (ccpw @ XA2))))))))))).
