...
thf(cuvtxusgrel_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : ((XE @ Xk) = (ccfv @ XG @ ccedg))) => ((cwcel @ XG @ ccusgr) => ((cwcel @ XN @ (ccfv @ XG @ ccuvtx)) <=> ((cwcel @ XN @ XV) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccpr @ (ccv @ Xk) @ XN) @ (XE @ Xk))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))))))).
