...
thf(cgrpoidinvlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((((cwcel @ XG @ ccgr) & ((cwcel @ XY @ XX) & (cwcel @ XA2 @ XX))) & (((cco @ XY @ XA2 @ XG) = XU) & ((cco @ XA2 @ XA2 @ XG) = XA2))) => ((cco @ XU @ XA2 @ XG) = XU))))))))).
