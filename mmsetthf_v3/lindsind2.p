...
thf(clindsind2_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ cclspn)) => ((XL = (ccfv @ XW @ ccsca)) => ((((cwcel @ XW @ cclmod) & (cwcel @ XL @ ccnzr)) & (cwcel @ XF @ (ccfv @ XW @ cclinds)) & (cwcel @ XE @ XF)) => (~ (cwcel @ XE @ (ccfv @ (ccdif @ XF @ (ccsn @ XE)) @ XK)))))))))))).
