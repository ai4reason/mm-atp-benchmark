...
thf(avolivth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ (cco @ ccc0 @ (ccfv @ XA2 @ ccvol) @ ccicc))) => (cwrex @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & ((ccfv @ (ccv @ Xx3) @ ccvol) = XB2))) @ (^ [Xx3:$i] : (ccdm @ ccvol))))))).
