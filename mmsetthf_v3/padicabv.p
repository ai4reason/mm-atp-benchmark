...
thf(apcqcl_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XN @ ccq) & (XN != ccc0))) => (cwcel @ (cco @ XP @ XN @ ccpc) @ ccz))))).
...
thf(apcadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XA2 @ ccq)) => ((Xph => (cwcel @ XB2 @ ccq)) => ((Xph => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle)) => (Xph => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc) @ ccle))))))))))).
...
thf(cpadicabv_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccc0 @ (cco @ XN @ (cco @ XP @ (ccv @ Xx3) @ ccpc) @ ccexp)))))) => (! [Xx3:$i] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ (cco @ ccc0 @ cc1 @ ccioo))) => (cwcel @ (XF @ Xx3) @ XA2)))))))))))).
