...
thf(cpclssN_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ XV) & (cwss @ XX @ XY) & (cwss @ XY @ XA2)) => (cwss @ (ccfv @ XX @ XU) @ (ccfv @ XY @ XU)))))))))))).
