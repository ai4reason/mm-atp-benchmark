...
thf(am2detleib_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccpr @ cc1 @ cc2)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => ((ccfv @ XM @ XD) = (cco @ (cco @ (cco @ cc1 @ cc1 @ XM) @ (cco @ cc2 @ cc2 @ XM) @ Xc_x) @ (cco @ (cco @ cc2 @ cc1 @ XM) @ (cco @ cc1 @ cc2 @ XM) @ Xc_x) @ Xc_mi)))))))))))))))))).
