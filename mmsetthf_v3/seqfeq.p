...
thf(cseqfeq_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz))) => ((ccfv @ (ccv @ Xk) @ XF) = (ccfv @ (ccv @ Xk) @ XG)))) => (! [Xk:$i] : (Xph => ((ccseq @ (Xc_pl @ Xk) @ XF @ XM) = (ccseq @ (Xc_pl @ Xk) @ XG @ XM)))))))))))).
