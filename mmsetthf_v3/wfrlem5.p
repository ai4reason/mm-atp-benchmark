...
thf(awfrlem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1) = (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1)) => (cwss @ (ccdm @ (ccv @ Xg1)) @ XA2)))))))))))).
...
thf(awfrlem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwwe @ XA2 @ XR) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xh) = (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((cwcel @ (ccv @ Xg1) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xh)) & (cwcel @ (ccv @ Xh) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xh))) => ((cwfn @ (ccres @ (ccv @ Xg1) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh)))) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh)))) & (cwral @ (^ [Xa:$i] : ((ccfv @ (ccv @ Xa) @ (ccres @ (ccv @ Xg1) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh))))) = (ccfv @ (ccres @ (ccres @ (ccv @ Xg1) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh)))) @ (ccpred @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh))) @ XR @ (ccv @ Xa))) @ XF))) @ (^ [Xa:$i] : (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh))))))))))))))))))).
...
thf(awfr3g_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwfn @ XF @ XA2) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) = (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2))) & ((cwfn @ XG @ XA2) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XG) = (ccfv @ (ccres @ XG @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2)))) => (XF = XG)))))))).
...
thf(cwfrlem5_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xu:$i] : (cwwe @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu)))) => ((! [Xv:$i] : (! [Xu:$i] : (cwse @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XB2 @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1 @ Xh) = (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ (XA2 @ Xv @ Xu)) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu) @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccpred @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu) @ (ccv @ Xy1))) @ (XF @ Xv @ Xu)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((cwcel @ (ccv @ Xg1) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1 @ Xh)) & (cwcel @ (ccv @ Xh) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1 @ Xh))) => (((cwbr @ (ccv @ Xx3) @ (ccv @ Xu) @ (ccv @ Xg1)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccv @ Xh))) => ((ccv @ Xu) = (ccv @ Xv))))))))))))))))))).
