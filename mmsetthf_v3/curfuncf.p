...
thf(afucid_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XI = (ccfv @ XQ @ cccid)) => ((Xc_1 = (ccfv @ XD @ cccid)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => (Xph => ((ccfv @ XF @ XI) = (cccom @ Xc_1 @ (ccfv @ XF @ cc1st)))))))))))))))).
...
thf(anatcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XN = (cco @ XC @ XD @ ccnat)) => ((Xph => (cwcel @ XA2 @ (cco @ (ccop @ XF @ XG) @ (ccop @ XK @ XL) @ XN))) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XJ = (ccfv @ XD @ cchom)) => ((Xph => (cwcel @ XX @ XB2)) => (Xph => (cwcel @ (ccfv @ XX @ XA2) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XX @ XK) @ XJ))))))))))))))))))))).
thf(anat1st2nd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XC @ XD @ ccnat)) => ((Xph => (cwcel @ XA2 @ (cco @ XF @ XG @ XN))) => (Xph => (cwcel @ XA2 @ (cco @ (ccop @ (ccfv @ XF @ cc1st) @ (ccfv @ XF @ cc2nd)) @ (ccop @ (ccfv @ XG @ cc1st) @ (ccfv @ XG @ cc2nd)) @ XN))))))))))))).
thf(cc4_tp,type,(cc4 : ($i > $o))).
thf(afuchom_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XN = (cco @ XC @ XD @ ccnat)) => (XN = (ccfv @ XQ @ cchom))))))))).
thf(anatfn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XC @ XD @ ccnat)) => ((Xph => (cwcel @ XA2 @ (cco @ (ccop @ XF @ XG) @ (ccop @ XK @ XL) @ XN))) => ((XB2 = (ccfv @ XC @ ccbs)) => (Xph => (cwfn @ XA2 @ XB2)))))))))))))))).
thf(adffn5_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) <=> (XF = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF)))))))).
thf(ccsb_tp,type,(ccsb : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(acurfval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((XG @ Xx3 @ Xy1 @ Xz @ Xg1) = (cco @ (ccop @ XC @ XD) @ XF @ cccurf)))))) => ((! [Xz:$i] : (! [Xg1:$i] : ((XA2 @ Xz @ Xg1) = (ccfv @ XC @ ccbs)))) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ (cco @ XC @ XD @ ccxpc) @ (XE @ Xx3) @ ccfunc)))) => ((XB2 = (ccfv @ XD @ ccbs)) => ((! [Xy1:$i] : (! [Xz:$i] : ((XJ @ Xy1 @ Xz) = (ccfv @ XD @ cchom)))) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ XC @ cchom))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((XI @ Xx3 @ Xy1 @ Xz @ Xg1) = (ccfv @ XD @ cccid)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : (Xph => ((XG @ Xx3 @ Xy1 @ Xz @ Xg1) = (ccop @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xz @ Xg1)) @ (^ [Xx3:$i] : (ccop @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XF @ cc1st)))) @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XB2)) @ (^ [Xy1:$i] : (^ [Xz:$i] : XB2)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccmpt @ (^ [Xg1:$i] : (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (XJ @ Xy1 @ Xz))) @ (^ [Xg1:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ Xc_1) @ (ccv @ Xg1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ (ccfv @ XF @ cc2nd))))))))))) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xz @ Xg1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xz @ Xg1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt @ (^ [Xg1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XH @ Xx3))) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xz:$i] : XB2) @ (^ [Xz:$i] : (cco @ (ccv @ Xg1) @ (ccfv @ (ccv @ Xz) @ (XI @ Xx3 @ Xy1 @ Xz @ Xg1)) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccfv @ XF @ cc2nd)))))))))))))))))))))))))))))))))))))))).
thf(auncfcl_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = (cco @ (ccs3 @ XC @ XD @ XE) @ XG @ ccuncf)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XE @ cccat)) => ((Xph => (cwcel @ XG @ (cco @ XC @ (cco @ XD @ XE @ ccfuc) @ ccfunc))) => (Xph => (cwcel @ XF @ (cco @ (cco @ XC @ XD @ ccxpc) @ XE @ ccfunc)))))))))))))).
