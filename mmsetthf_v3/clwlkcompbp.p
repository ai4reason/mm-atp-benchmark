...
thf(cclwlkcompbp_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ cc1st)) => ((XP = (ccfv @ XW @ cc2nd)) => ((cwcel @ XW @ (ccfv @ XG @ ccclwlks)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ ccc0 @ XP) = (ccfv @ (ccfv @ XF @ cchash) @ XP))))))))))).
