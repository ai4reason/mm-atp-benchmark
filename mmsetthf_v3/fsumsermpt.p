...
thf(cfsumsermpt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XM @ ccz))) => ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc)))) => ((! [Xk:$i] : (! [Xn:$i] : ((XF @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccsu @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk)))))))) => ((! [Xk:$i] : (! [Xn:$i] : ((XG @ Xk @ Xn) = (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XM)))) => (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xn) => ((XF @ Xk @ Xn) = (XG @ Xk @ Xn))))))))))))))))).
