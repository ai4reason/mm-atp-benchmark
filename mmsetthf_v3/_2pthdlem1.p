...
thf(a_2wlkdlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccs3 @ XA2 @ XB2 @ XC)) => ((XF = (ccs2 @ XJ @ XK)) => ((Xph => ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => (Xph => (((ccfv @ ccc0 @ XP) = XA2) & ((ccfv @ cc1 @ XP) = XB2) & ((ccfv @ cc2 @ XP) = XC)))))))))))))))).
