...
thf(aelsb3_thm,axiom,(! [Xz:$i] : (! [Xx3:$i] : (((^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xz))) @ Xx3) <=> (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)))))).
thf(ccvjust_conj,conjecture,(! [Xx3:$i] : ((ccv @ Xx3) = (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))).
