...
thf(csumpr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XA2) => ((XC @ Xk) = XD))) => ((! [Xk:$i] : (((ccv @ Xk) = XB2) => ((XC @ Xk) = XE))) => ((Xph => ((cwcel @ XD @ ccc) & (cwcel @ XE @ ccc))) => ((Xph => ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW))) => ((Xph => (XA2 != XB2)) => (Xph => ((ccsu @ (ccpr @ XA2 @ XB2) @ (^ [Xk:$i] : (XC @ Xk))) = (cco @ XD @ XE @ ccaddc))))))))))))))))).
