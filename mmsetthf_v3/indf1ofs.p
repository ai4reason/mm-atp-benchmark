...
thf(cindf1ofs_conj,conjecture,(! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xf1:$i] : ((cwcel @ XO @ (XV @ Xf1)) => (cwf1o @ (ccin @ (ccpw @ XO) @ ccfn) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ cc1)) @ ccfn)) @ (^ [Xf1:$i] : (cco @ (ccpr @ ccc0 @ cc1) @ XO @ ccmap))) @ (ccres @ (ccfv @ XO @ ccind) @ ccfn))))))).
