...
thf(aexpm1t_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn)) => ((cco @ XA2 @ XN @ ccexp) = (cco @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XA2 @ ccmul)))))).
...
thf(cjm2_18_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XK @ ccn0) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmin) @ (cco @ XK @ XN @ ccexp) @ ccmin) @ ccdvds)))))).
