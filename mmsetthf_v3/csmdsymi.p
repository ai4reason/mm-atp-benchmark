...
thf(amdslmd4i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => (((cwbr @ XA2 @ XB2 @ ccmd) & ((cwss @ (ccin @ XA2 @ XB2) @ XC) & (cwss @ XC @ XA2)) & ((cwss @ (ccin @ XA2 @ XB2) @ XD) & (cwss @ XD @ XB2))) => (cwbr @ XC @ XD @ ccmd))))))))))).
