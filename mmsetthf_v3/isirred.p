...
thf(adf_irred_ax,axiom,(ccir = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccsb @ (ccdif @ (ccfv @ (ccv @ Xw) @ ccbs) @ (ccfv @ (ccv @ Xw) @ ccui)) @ (^ [Xb:$i] : (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccmulr)) != (ccv @ Xz))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (^ [Xz:$i] : (ccv @ Xb))))))))).
