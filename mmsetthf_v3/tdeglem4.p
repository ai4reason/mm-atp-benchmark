...
thf(afunsssuppss_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (((cwfun @ XG) & (cwss @ XF @ XG) & (cwcel @ XG @ XV)) => (cwss @ (cco @ XF @ XZ @ ccsupp) @ (cco @ XG @ XZ @ ccsupp)))))))).
...
thf(apsrbag0_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => (! [Xf1:$i] : ((cwcel @ XI @ (XV @ Xf1)) => (cwcel @ (ccxp @ XI @ (ccsn @ ccc0)) @ (XD @ Xf1))))))))).
...
thf(ctdeglem4_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xm:$i] : ((XA2 @ Xm) = (ccrab @ (^ [Xm:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xm)) @ ccn) @ ccfn)) @ (^ [Xm:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xh:$i] : (! [Xm:$i] : ((XH @ Xh @ Xm) = (ccmpt @ (^ [Xh:$i] : (XA2 @ Xm)) @ (^ [Xh:$i] : (cco @ cccnfld @ (ccv @ Xh) @ ccgsu)))))) => (! [Xh:$i] : (! [Xm:$i] : (((cwcel @ XI @ (XV @ Xm)) & (cwcel @ XX @ (XA2 @ Xm))) => (((ccfv @ XX @ (XH @ Xh @ Xm)) = ccc0) <=> (XX = (ccxp @ XI @ (ccsn @ ccc0))))))))))))))).
