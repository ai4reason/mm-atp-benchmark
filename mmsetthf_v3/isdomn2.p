...
thf(cisdomn2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ ccdomn) <=> ((cwcel @ XR @ ccnzr) & (cwss @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ XE))))))))))).
