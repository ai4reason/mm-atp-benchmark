...
thf(ambfi1fseqlem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xy1:$i] : ((XJ @ Xy1) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv)))))) => (! [Xy1:$i] : (Xph => (cwf @ (ccxp @ ccn @ ccr) @ (cco @ ccc0 @ ccpnf @ ccico) @ (XJ @ Xy1))))))))))).
