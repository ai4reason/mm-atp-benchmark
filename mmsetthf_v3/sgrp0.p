...
thf(amgm0_thm,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ XV) & ((ccfv @ XM @ ccbs) = cc0)) => (cwcel @ XM @ ccmgm))))).
...
thf(csgrp0_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ XV) & ((ccfv @ XM @ ccbs) = cc0)) => (cwcel @ XM @ ccsgrp))))).
