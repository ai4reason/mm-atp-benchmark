...
thf(afin1a2lem9_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ ccrpss) & (cwss @ XX @ ccfn) & (cwcel @ XA2 @ ccom)) => (cwcel @ (ccrab @ (^ [Xb:$i] : (cwbr @ (ccv @ Xb) @ XA2 @ ccdom)) @ (^ [Xb:$i] : XX)) @ ccfn))))).
...
thf(afin1a2lem10_thm,axiom,(! [XA2:($i > $o)] : (((XA2 != cc0) & (cwcel @ XA2 @ ccfn) & (cwor @ XA2 @ ccrpss)) => (cwcel @ (ccuni @ XA2) @ XA2)))).
