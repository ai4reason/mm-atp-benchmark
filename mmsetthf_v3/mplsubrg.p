...
thf(apsrring_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwcel @ XS @ ccrg))))))))))).
...
thf(apsr1_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (cco @ XI @ XR @ ccmps))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XI @ (XV @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XR @ ccrg))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xf1:$i] : ((Xc_1 @ Xf1) = (ccfv @ XR @ ccur))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XU @ Xx3 @ Xf1) = (ccfv @ (XS @ Xf1) @ ccur)))) => (! [Xx3:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => ((XU @ Xx3 @ Xf1) = (ccmpt @ (^ [Xx3:$i] : (XD @ Xf1)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = (ccxp @ XI @ (ccsn @ ccc0))) @ (Xc_1 @ Xf1) @ Xc_0)))))))))))))))))))))))).
...
thf(amplsubrglem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((! [Xf1:$i] : ((XP @ Xf1) = (cco @ XI @ XR @ ccmpl))) => ((! [Xf1:$i] : ((XU @ Xf1) = (ccfv @ (XP @ Xf1) @ ccbs))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XI @ (XW @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XR @ ccrg))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xf1:$i] : ((XA2 @ Xf1) = (ccima @ (ccof @ ccaddc) @ (ccxp @ (cco @ XX @ Xc_0 @ ccsupp) @ (cco @ XY @ Xc_0 @ ccsupp))))) => ((! [Xf1:$i] : ((Xc_x @ Xf1) = (ccfv @ XR @ ccmulr))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XX @ (XU @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XY @ (XU @ Xf1)))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (cco @ XX @ XY @ (ccfv @ XS @ ccmulr)) @ (XU @ Xf1))))))))))))))))))))))))))))).
...
thf(cmplsubrg_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XP = (cco @ XI @ XR @ ccmpl)) => ((XU = (ccfv @ XP @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwcel @ XU @ (ccfv @ XS @ ccsubrg)))))))))))))))).
