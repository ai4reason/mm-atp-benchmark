...
thf(acpmadugsumlemB_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : (! [Xb:$i] : ((! [Xi:$i] : ((XA2 @ Xi) = (cco @ XN @ XR @ ccmat))) => ((! [Xi:$i] : (XB2 = (ccfv @ (XA2 @ Xi) @ ccbs))) => ((! [Xi:$i] : ((XP @ Xi) = (ccfv @ XR @ ccpl1))) => ((! [Xi:$i] : (XY = (cco @ XN @ (XP @ Xi) @ ccmat))) => ((! [Xi:$i] : ((XT @ Xi) = (cco @ XN @ XR @ ccmat2pmat))) => ((XX = (ccfv @ XR @ ccv1)) => ((! [Xi:$i] : ((Xc_ex @ Xi) = (ccfv @ (ccfv @ (XP @ Xi) @ ccmgp) @ ccmg))) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xc_xp = (ccfv @ XY @ ccmulr)) => ((Xc_1 = (ccfv @ XY @ ccur)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) & ((cwcel @ (ccv @ Xs1) @ ccn0) & (cwcel @ (ccv @ Xb) @ (cco @ XB2 @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) => ((cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ (Xc_ex @ Xi)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (XT @ Xi)) @ Xc_x))) @ ccgsu) @ Xc_xp) = (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XX @ (Xc_ex @ Xi)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (XT @ Xi)) @ Xc_x))) @ ccgsu))))))))))))))))))))))))))))).
thf(acpmadugsumlemC_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : (! [Xb:$i] : ((! [Xi:$i] : ((XA2 @ Xi) = (cco @ XN @ XR @ ccmat))) => ((! [Xi:$i] : (XB2 = (ccfv @ (XA2 @ Xi) @ ccbs))) => ((! [Xi:$i] : ((XP @ Xi) = (ccfv @ XR @ ccpl1))) => ((! [Xi:$i] : (XY = (cco @ XN @ (XP @ Xi) @ ccmat))) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XX = (ccfv @ XR @ ccv1)) => ((! [Xi:$i] : ((Xc_ex @ Xi) = (ccfv @ (ccfv @ (XP @ Xi) @ ccmgp) @ ccmg))) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xc_xp = (ccfv @ XY @ ccmulr)) => ((Xc_1 = (ccfv @ XY @ ccur)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) & ((cwcel @ (ccv @ Xs1) @ ccn0) & (cwcel @ (ccv @ Xb) @ (cco @ XB2 @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) => ((cco @ (ccfv @ XM @ XT) @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ (Xc_ex @ Xi)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ XT) @ Xc_x))) @ ccgsu) @ Xc_xp) = (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ (Xc_ex @ Xi)) @ (cco @ (ccfv @ XM @ XT) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ XT) @ Xc_xp) @ Xc_x))) @ ccgsu))))))))))))))))))))))))))))).
...
thf(acmncom_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ cccmn) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_pl) = (cco @ XY @ XX @ Xc_pl))))))))))).
