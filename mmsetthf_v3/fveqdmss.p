...
thf(anelrnfvne_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwfun @ XF) & (cwcel @ XX @ (ccdm @ XF)) & (cwnel @ XY @ (ccrn @ XF))) => ((ccfv @ XX @ XF) != XY)))))).
...
thf(cfveqdmss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdm @ XB2)) => (((cwfun @ XB2) & (cwnel @ cc0 @ (ccrn @ XB2)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) = (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) => (cwss @ XD @ (ccdm @ XA2)))))))).
