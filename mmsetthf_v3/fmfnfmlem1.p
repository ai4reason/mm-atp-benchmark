...
thf(cfmfnfmlem1_conj,conjecture,(! [Xph:$o] : (! [Xt:$i] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((Xph => (cwcel @ XB2 @ (ccfv @ XY @ ccfbas))) => ((Xph => (cwcel @ XL @ (ccfv @ XX @ ccfil))) => ((Xph => (cwf @ XY @ XX @ XF)) => ((Xph => (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ XL)) => (Xph => ((cwcel @ (ccv @ Xs1) @ (ccfv @ XB2 @ ccfi)) => ((cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xt)) => ((cwss @ (ccv @ Xt) @ XX) => (cwcel @ (ccv @ Xt) @ XL)))))))))))))))))).
