...
thf(almhmpreima_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XS @ cclss)) => ((XY = (ccfv @ XT @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XU @ XY)) => (cwcel @ (ccima @ (cccnv @ XF) @ XU) @ XX))))))))))).
...
thf(almhmima_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XS @ cclss)) => ((XY = (ccfv @ XT @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XU @ XX)) => (cwcel @ (ccima @ XF @ XU) @ XY))))))))))).
