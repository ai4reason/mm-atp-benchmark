...
thf(atfr2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = (ccrecs @ XG)) => ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ XF) = (ccfv @ (ccres @ XF @ XA2) @ XG)))))))).
