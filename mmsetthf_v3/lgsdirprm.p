...
thf(algsdir2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc2 @ cclgs) = (cco @ (cco @ XA2 @ cc2 @ cclgs) @ (cco @ XB2 @ cc2 @ cclgs) @ ccmul)))))).
...
thf(algsle1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => (cwbr @ (ccfv @ (cco @ XA2 @ XN @ cclgs) @ ccabs) @ cc1 @ ccle))))).
thf(ccpc_tp,type,(ccpc : ($i > $o))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(algscl2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XZ @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cc1 @ ccle)) @ (^ [Xx3:$i] : ccz)))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XA2 @ XN @ cclgs) @ (XZ @ Xx3))))))))).
...
thf(clgsdirprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XP @ ccprime)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XP @ cclgs) = (cco @ (cco @ XA2 @ XP @ cclgs) @ (cco @ XB2 @ XP @ cclgs) @ ccmul))))))).
