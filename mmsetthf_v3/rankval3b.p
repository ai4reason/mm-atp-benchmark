...
thf(crankval3b_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => ((ccfv @ XA2 @ ccrnk) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrnk) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccon0))))))).
