...
thf(cixpsnf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ XI) @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : ((cwcel @ XI @ XV) => (cwf1o @ XA2 @ (ccixp @ (^ [Xy1:$i] : (ccsn @ XI)) @ (^ [Xy1:$i] : XA2)) @ (XF @ Xx3)))))))))).
