...
thf(ametidss_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => (cwss @ (ccfv @ XD @ ccmetid) @ (ccxp @ XX @ XX)))))).
...
thf(cmetider_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => (cwer @ XX @ (ccfv @ XD @ ccmetid)))))).
