...
thf(adf_mdv_ax,axiom,(ccmdv = (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccdif @ (ccxp @ (ccfv @ (ccv @ Xt) @ ccmvar) @ (ccfv @ (ccv @ Xt) @ ccmvar)) @ ccid))))).
...
thf(cmdvval_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XD = (ccfv @ XT @ ccmdv)) => (XD = (ccdif @ (ccxp @ XV @ XV) @ ccid)))))))).
