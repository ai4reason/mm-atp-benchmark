...
thf(aghmabl_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XY = (ccfv @ XH @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_pd = (ccfv @ XH @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XF) = (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ Xc_pd))))) => ((Xph => (cwfo @ XX @ XY @ XF)) => ((Xph => (cwcel @ XG @ ccabl)) => (Xph => (cwcel @ XH @ ccabl)))))))))))))))))).
...
thf(aefgh_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cce))))) => (! [Xx3:$i] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XX @ (ccfv @ cccnfld @ ccsubg))) & (cwcel @ (XB2 @ Xx3) @ XX) & (cwcel @ (XC @ Xx3) @ XX)) => ((ccfv @ (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccaddc) @ (XF @ Xx3)) = (cco @ (ccfv @ (XB2 @ Xx3) @ (XF @ Xx3)) @ (ccfv @ (XC @ Xx3) @ (XF @ Xx3)) @ ccmul))))))))))).
...
thf(cefabl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cce)))) => ((XG = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccrn @ XF) @ ccress)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XX @ (ccfv @ cccnfld @ ccsubg))) => (Xph => (cwcel @ XG @ ccabl)))))))))))).
