...
thf(cfbflim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (cco @ XX @ XB2 @ ccfg))) => (! [Xn:$i] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XB2 @ (ccfv @ XX @ ccfbas))) => ((cwcel @ XA2 @ (cco @ XJ @ (XF @ Xn) @ ccflim)) <=> ((cwcel @ XA2 @ XX) & (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xn))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei))))))))))))))).
