...
thf(aexpnnval_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn)) => ((cco @ XA2 @ XN @ ccexp) = (ccfv @ XN @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ XA2)) @ cc1))))))).
...
thf(cexp1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ cc1 @ ccexp) = XA2)))).
