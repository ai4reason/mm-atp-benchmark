...
thf(csymg2bas_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XA2 = (ccpr @ XI @ XJ)) => (((cwcel @ XI @ XV) & (cwcel @ XJ @ XW)) => (XB2 = (ccpr @ (ccpr @ (ccop @ XI @ XI) @ (ccop @ XJ @ XJ)) @ (ccpr @ (ccop @ XI @ XJ) @ (ccop @ XJ @ XI)))))))))))))))).
