...
thf(cpsubspi_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xr:$i] : (! [Xq:$i] : ((Xc_le @ Xr @ Xq) = (ccfv @ XK @ ccple)))) => ((! [Xr:$i] : (! [Xq:$i] : ((Xc_or @ Xr @ Xq) = (ccfv @ XK @ ccjn)))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xr:$i] : (! [Xq:$i] : ((XS @ Xr @ Xq) = (ccfv @ XK @ ccpsubsp)))) => (! [Xr:$i] : (! [Xq:$i] : ((((cwcel @ XK @ (XD @ Xr @ Xq)) & (cwcel @ XX @ (XS @ Xr @ Xq)) & (cwcel @ XP @ XA2)) & (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ XP @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xr @ Xq)) @ (Xc_le @ Xr @ Xq))) @ (^ [Xr:$i] : XX))) @ (^ [Xq:$i] : XX))) => (cwcel @ XP @ XX))))))))))))))))).
