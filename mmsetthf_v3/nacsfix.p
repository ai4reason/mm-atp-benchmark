...
thf(aincssnn0_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))) @ (^ [Xx3:$i] : ccn0)) & (cwcel @ (XA2 @ Xx3) @ ccn0) & (cwcel @ (XB2 @ Xx3) @ (ccfv @ (XA2 @ Xx3) @ ccuz))) => (cwss @ (ccfv @ (XA2 @ Xx3) @ XF) @ (ccfv @ (XB2 @ Xx3) @ XF)))))))).
...
thf(aisnacs3_thm,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccnacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) => (cwcel @ (ccuni @ (ccv @ Xs1)) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ XC)))))))).
...
thf(cnacsfix_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ (XC @ Xx3) @ (ccfv @ (XX @ Xx3) @ ccnacs)) & (cwf @ ccn0 @ (XC @ Xx3) @ XF) & (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))) @ (^ [Xx3:$i] : ccn0))) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ XF) = (ccfv @ (ccv @ Xy1) @ XF))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn0)))))))).
