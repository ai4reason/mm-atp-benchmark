...
thf(ai1f0rn_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ ccc0 @ (ccrn @ XF))))).
...
thf(ci1fres_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XA2 @ (ccdm @ ccvol))) => (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1))))))))).
