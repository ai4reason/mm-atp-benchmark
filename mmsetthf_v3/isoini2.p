...
thf(cisoini2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccin @ XA2 @ (ccima @ (cccnv @ XR) @ (ccsn @ XX)))) => ((XD = (ccin @ XB2 @ (ccima @ (cccnv @ XS) @ (ccsn @ (ccfv @ XX @ XH))))) => (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (cwcel @ XX @ XA2)) => (cwiso @ XC @ XD @ XR @ XS @ (ccres @ XH @ XC)))))))))))))).
