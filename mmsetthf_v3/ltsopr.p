...
thf(altprord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => ((cwbr @ XA2 @ XB2 @ ccltp) <=> (cwpss @ XA2 @ XB2)))))).
...
thf(apsslinpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => ((cwpss @ XA2 @ XB2) | (XA2 = XB2) | (cwpss @ XB2 @ XA2)))))).
...
thf(cltsopr_conj,conjecture,(cwor @ ccnp @ ccltp)).
