...
thf(acrcts_thm,axiom,(! [XG:($i > $o)] : ((ccfv @ XG @ cccrcts) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cctrls)) & ((ccfv @ ccc0 @ (ccv @ Xp)) = (ccfv @ (ccfv @ (ccv @ Xf1) @ cchash) @ (ccv @ Xp)))))))))).
...
thf(ciscrct_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts)) <=> ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) & ((ccfv @ ccc0 @ XP) = (ccfv @ (ccfv @ XF @ cchash) @ XP)))))))).
