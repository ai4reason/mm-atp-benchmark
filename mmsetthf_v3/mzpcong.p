...
thf(cmzpcong_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xk:$i] : (((cwcel @ (XF @ Xk) @ (ccfv @ XV @ ccmzp)) & ((cwcel @ XX @ (cco @ ccz @ XV @ ccmap)) & (cwcel @ XY @ (cco @ ccz @ XV @ ccmap))) & ((cwcel @ XN @ ccz) & (cwral @ (^ [Xk:$i] : (cwbr @ XN @ (cco @ (ccfv @ (ccv @ Xk) @ XX) @ (ccfv @ (ccv @ Xk) @ XY) @ ccmin) @ ccdvds)) @ (^ [Xk:$i] : XV)))) => (cwbr @ XN @ (cco @ (ccfv @ XX @ (XF @ Xk)) @ (ccfv @ XY @ (XF @ Xk)) @ ccmin) @ ccdvds))))))))).
