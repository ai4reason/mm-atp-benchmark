...
thf(ccvrnbtwn2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ ccpo) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2)) & (cwbr @ XX @ XY @ XC)) => (((cwbr @ XX @ XZ @ Xc_lt) & (cwbr @ XZ @ XY @ Xc_le)) <=> (XZ = XY)))))))))))))))).
