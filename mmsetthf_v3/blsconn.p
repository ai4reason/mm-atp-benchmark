...
thf(cblsconn_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XS = (cco @ XP @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((XK = (cco @ XJ @ XS @ ccrest)) => (((cwcel @ XP @ ccc) & (cwcel @ XR @ ccxr)) => (cwcel @ XK @ ccsconn))))))))))).
