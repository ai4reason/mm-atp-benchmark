...
thf(alspprat_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((XV = (ccfv @ XW @ ccbs)) => ((! [Xz:$i] : ((XS @ Xz) = (ccfv @ XW @ cclss))) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclvec)) => ((! [Xz:$i] : (Xph => (cwcel @ XU @ (XS @ Xz)))) => ((! [Xz:$i] : (Xph => (cwcel @ (XX @ Xz) @ XV))) => ((! [Xz:$i] : (Xph => (cwcel @ (XY @ Xz) @ XV))) => ((! [Xz:$i] : (Xph => (cwpss @ XU @ (ccfv @ (ccpr @ (XX @ Xz) @ (XY @ Xz)) @ XN)))) => (Xph => (cwrex @ (^ [Xz:$i] : (XU = (ccfv @ (ccsn @ (ccv @ Xz)) @ XN))) @ (^ [Xz:$i] : XV)))))))))))))))))))).
...
thf(advh3dim2_thm,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : ((XH @ Xz) = (ccfv @ (XK @ Xz) @ cclh))) => ((! [Xz:$i] : (XU = (ccfv @ (XW @ Xz) @ (ccfv @ (XK @ Xz) @ ccdvh)))) => ((XV = (ccfv @ XU @ ccbs)) => ((XN = (ccfv @ XU @ cclspn)) => ((! [Xz:$i] : (Xph => ((cwcel @ (XK @ Xz) @ cchlt) & (cwcel @ (XW @ Xz) @ (XH @ Xz))))) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwrex @ (^ [Xz:$i] : ((~ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XX @ XY) @ XN))) & (~ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XX @ XZ) @ XN))))) @ (^ [Xz:$i] : XV)))))))))))))))))))))).
...
thf(cdvh3dim3N_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : ((XH @ Xz) = (ccfv @ (XK @ Xz) @ cclh))) => ((! [Xz:$i] : (XU = (ccfv @ (XW @ Xz) @ (ccfv @ (XK @ Xz) @ ccdvh)))) => ((XV = (ccfv @ XU @ ccbs)) => ((XN = (ccfv @ XU @ cclspn)) => ((! [Xz:$i] : (Xph => ((cwcel @ (XK @ Xz) @ cchlt) & (cwcel @ (XW @ Xz) @ (XH @ Xz))))) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XZ @ XV)) => ((Xph => (cwcel @ XT @ XV)) => (Xph => (cwrex @ (^ [Xz:$i] : ((~ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XX @ XY) @ XN))) & (~ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccpr @ XZ @ XT) @ XN))))) @ (^ [Xz:$i] : XV)))))))))))))))))))))))).
