...
thf(adff14a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwf1 @ XA2 @ (XB2 @ Xx3 @ Xy1) @ XF) <=> ((cwf @ XA2 @ (XB2 @ Xx3 @ Xy1) @ XF) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) => ((ccfv @ (ccv @ Xx3) @ XF) != (ccfv @ (ccv @ Xy1) @ XF)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(cpthdlem1_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XP @ (ccword @ ccvv))) => ((XR = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) != (ccv @ Xj)) => ((ccfv @ (ccv @ Xi) @ XP) != (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => (Xph => (cwfun @ (cccnv @ (ccres @ XP @ (cco @ cc1 @ XR @ ccfzo)))))))))))).
