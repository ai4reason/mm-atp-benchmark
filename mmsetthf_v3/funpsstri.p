...
thf(cfunpsstri_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (((cwfun @ XH) & ((cwss @ XF @ XH) & (cwss @ XG @ XH)) & ((cwss @ (ccdm @ XF) @ (ccdm @ XG)) | (cwss @ (ccdm @ XG) @ (ccdm @ XF)))) => ((cwpss @ XF @ XG) | (XF = XG) | (cwpss @ XG @ XF))))))).
