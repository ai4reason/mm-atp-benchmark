...
thf(apmatcollpw1lem1_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xn:$i] : ((XP @ Xn) = (ccfv @ XR @ ccpl1))) => ((! [Xn:$i] : ((XC @ Xn) = (cco @ XN @ (XP @ Xn) @ ccmat))) => ((! [Xn:$i] : (XB2 = (ccfv @ (XC @ Xn) @ ccbs))) => ((! [Xn:$i] : (Xc_xp = (ccfv @ (XP @ Xn) @ ccvsca))) => ((! [Xn:$i] : (Xc_ex = (ccfv @ (ccfv @ (XP @ Xn) @ ccmgp) @ ccmg))) => ((XX = (ccfv @ XR @ ccv1)) => (! [Xn:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) & (cwcel @ XI @ XN) & (cwcel @ XJ @ XN)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XI @ XJ @ (cco @ XM @ (ccv @ Xn) @ ccdecpmat)) @ (cco @ (ccv @ Xn) @ XX @ Xc_ex) @ Xc_xp))) @ (ccfv @ (XP @ Xn) @ cc0g) @ ccfsupp))))))))))))))))))))).
