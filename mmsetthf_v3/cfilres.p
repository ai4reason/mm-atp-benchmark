...
thf(afgtr_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwcel @ XA2 @ XF)) => ((cco @ XX @ (cco @ XF @ XA2 @ ccrest) @ ccfg) = XF)))))).
thf(ccfilres_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwcel @ XY @ XF)) => ((cwcel @ XF @ (ccfv @ XD @ cccfil)) <=> (cwcel @ (cco @ XF @ XY @ ccrest) @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ cccfil))))))))).
