...
thf(aneifil_thm,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwss @ XS @ XX) & (XS != cc0)) => (cwcel @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccfv @ XX @ ccfil))))))).
...
thf(autopsnneip_thm,axiom,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xv:$i] : ((XJ @ Xv) = (ccfv @ XU @ ccutop))) => (! [Xv:$i] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XP @ XX)) => ((ccfv @ (ccsn @ XP) @ (ccfv @ (XJ @ Xv) @ ccnei)) = (ccrn @ (ccmpt @ (^ [Xv:$i] : XU) @ (^ [Xv:$i] : (ccima @ (ccv @ Xv) @ (ccsn @ XP)))))))))))))).
...
thf(austexsym_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xw:$i] : (((cwcel @ XU @ (ccfv @ (XX @ Xw) @ ccust)) & (cwcel @ XV @ XU)) => (cwrex @ (^ [Xw:$i] : (((cccnv @ (ccv @ Xw)) = (ccv @ Xw)) & (cwss @ (ccv @ Xw) @ XV))) @ (^ [Xw:$i] : XU)))))))).
...
thf(austneism_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XV @ (ccxp @ XX @ XX)) & (cwcel @ XA2 @ XX)) => (cwss @ (ccxp @ (ccima @ XV @ (ccsn @ XA2)) @ (ccima @ XV @ (ccsn @ XA2))) @ (cccom @ XV @ (cccnv @ XV)))))))).
...
thf(austexhalf_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwrex @ (^ [Xw:$i] : (cwss @ (cccom @ (ccv @ Xw) @ (ccv @ Xw)) @ XV)) @ (^ [Xw:$i] : XU))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(aiscfilu_thm,axiom,(! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xv:$i] : (! [Xa:$i] : ((cwcel @ (XU @ Xa) @ (ccfv @ (XX @ Xv @ Xa) @ ccust)) => ((cwcel @ XF @ (ccfv @ (XU @ Xa) @ cccfilu)) <=> ((cwcel @ XF @ (ccfv @ (XX @ Xv @ Xa) @ ccfbas)) & (cwral @ (^ [Xv:$i] : (cwrex @ (^ [Xa:$i] : (cwss @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ (ccv @ Xv))) @ (^ [Xa:$i] : XF))) @ (^ [Xv:$i] : (XU @ Xa)))))))))))).
thf(cneipcfilu_conj,conjecture,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XU = (ccfv @ XW @ ccuss)) => (((cwcel @ XW @ ccusp) & (cwcel @ XW @ cctps) & (cwcel @ XP @ XX)) => (cwcel @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)) @ (ccfv @ XU @ cccfilu)))))))))))).
