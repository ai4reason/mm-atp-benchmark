...
thf(acospi_thm,axiom,((ccfv @ ccpi @ cccos) = (ccneg @ cc1))).
...
thf(ccoseq00topi_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) => (((ccfv @ XA2 @ cccos) = ccc0) <=> (XA2 = (cco @ ccpi @ cc2 @ ccdiv)))))).
