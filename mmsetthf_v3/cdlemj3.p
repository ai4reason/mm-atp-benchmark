...
thf(acdlemfnid_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ XK @ ccbs))) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((XR @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ cctrl)))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le))) => (cwrex @ (^ [Xf1:$i] : (((ccfv @ (ccv @ Xf1) @ (XR @ Xf1)) = XU) & ((ccv @ Xf1) != (ccres @ ccid @ (XB2 @ Xf1))))) @ (^ [Xf1:$i] : XT))))))))))))))))))).
...
thf(acdlemj2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xg1:$i] : (! [Xh:$i] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XE) & (cwcel @ XV @ XE) & ((ccfv @ XF @ XU) = (ccfv @ XF @ XV))) & ((cwcel @ XF @ XT) & (XF != (ccres @ ccid @ XB2)) & (cwcel @ (ccv @ Xh) @ XT))) & (((ccv @ Xh) != (ccres @ ccid @ XB2)) & (cwcel @ (ccv @ Xg1) @ XT) & ((ccv @ Xg1) != (ccres @ ccid @ XB2))) & (((ccfv @ XF @ XR) != (ccfv @ (ccv @ Xg1) @ XR)) & ((ccfv @ (ccv @ Xg1) @ XR) != (ccfv @ (ccv @ Xh) @ XR)))) => ((ccfv @ (ccv @ Xh) @ XU) = (ccfv @ (ccv @ Xh) @ XV))))))))))))))))))))).
