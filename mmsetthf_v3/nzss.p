...
thf(cnzss_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ XV)) => (Xph => ((cwss @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) <=> (cwbr @ XN @ XM @ ccdvds)))))))))).
