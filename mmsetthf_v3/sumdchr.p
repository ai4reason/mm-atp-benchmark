...
thf(asumdchr2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XN @ cczn))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XZ @ Xx3) @ ccur))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XZ @ Xx3) @ ccbs))) => ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XB2 @ Xx3)))) => (Xph => ((ccsu @ XD @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccv @ Xx3)))) = (ccif @ (XA2 = Xc_1) @ (ccfv @ XD @ cchash) @ ccc0))))))))))))))))))).
...
thf(adchrhash_thm,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((cwcel @ XN @ ccn) => ((ccfv @ XD @ cchash) = (ccfv @ XN @ ccphi))))))))).
