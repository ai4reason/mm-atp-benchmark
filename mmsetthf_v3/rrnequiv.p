...
thf(crrnequiv_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ (cco @ cccnfld @ ccr @ ccress) @ XI @ ccpws)) => ((XD = (ccfv @ XY @ ccds)) => ((XX = (cco @ ccr @ XI @ ccmap)) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph & ((cwcel @ XF @ XX) & (cwcel @ XG @ XX))) => ((cwbr @ (cco @ XF @ XG @ XD) @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ ccle) & (cwbr @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ (cco @ (ccfv @ (ccfv @ XI @ cchash) @ ccsqrt) @ (cco @ XF @ XG @ XD) @ ccmul) @ ccle))))))))))))))).
