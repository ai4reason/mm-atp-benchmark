...
thf(anfimdetndef_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((cwnel @ XN @ ccfn) => (XD = cc0))))))).
...
thf(amatbas0_thm,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : ((~ ((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccvv))) => ((ccfv @ (cco @ XN @ XR @ ccmat) @ ccbs) = cc0))))).
