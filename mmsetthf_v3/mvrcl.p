...
thf(amvrcl2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XV = (cco @ XI @ XR @ ccmvr)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XI)) => (Xph => (cwcel @ (ccfv @ XX @ XV) @ XB2))))))))))))))))).
