...
thf(cccatpfx_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & (cwcel @ XY @ (cco @ ccc0 @ XZ @ ccfz)) & (cwcel @ XZ @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((cco @ (cco @ XS @ XY @ ccpfx) @ (cco @ XS @ (ccop @ XY @ XZ) @ ccsubstr) @ ccconcat) = (cco @ XS @ XZ @ ccpfx)))))))).
