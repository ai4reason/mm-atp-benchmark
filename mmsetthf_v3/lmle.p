...
thf(almff_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XF @ (ccdm @ (ccfv @ XJ @ cclm)))) => (Xph => (cwrex @ (^ [Xj:$i] : (cwf @ (ccfv @ (ccv @ Xj) @ ccuz) @ XX @ (ccres @ XF @ (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))).
