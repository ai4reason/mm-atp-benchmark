...
thf(celcnvrefrels3_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ cccnvrefrels) <=> ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ XR)))) @ (^ [Xx3:$i] : (ccdm @ XR))) & (cwcel @ XR @ ccrels))))).
