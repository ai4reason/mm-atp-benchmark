...
thf(adedth2v_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = (ccif @ Xph @ XA2 @ XC)) => (Xps <=> Xch)) => (((XB2 = (ccif @ Xph @ XB2 @ XD)) => (Xch <=> Xth)) => (Xth => (Xph => Xps))))))))))))).
...
thf(aisowe2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (! [Xx3:$i] : (cwcel @ (ccima @ XH @ (ccv @ Xx3)) @ ccvv))) => ((cwwe @ XB2 @ XS) => (cwwe @ XA2 @ XR))))))))).
...
thf(cltweuz_conj,conjecture,(! [XA2:($i > $o)] : (cwwe @ (ccfv @ XA2 @ ccuz) @ cclt))).
