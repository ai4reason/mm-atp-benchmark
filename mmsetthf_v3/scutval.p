...
thf(cscutval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => ((cco @ XA2 @ XB2 @ ccscut) = (ccrio @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ ccbday) = (ccint @ (ccima @ ccbday @ (ccrab @ (^ [Xy1:$i] : ((cwbr @ XA2 @ (ccsn @ (ccv @ Xy1)) @ ccsslt) & (cwbr @ (ccsn @ (ccv @ Xy1)) @ XB2 @ ccsslt))) @ (^ [Xy1:$i] : ccsur)))))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : ((cwbr @ XA2 @ (ccsn @ (ccv @ Xy1)) @ ccsslt) & (cwbr @ (ccsn @ (ccv @ Xy1)) @ XB2 @ ccsslt))) @ (^ [Xy1:$i] : ccsur))))))))).
