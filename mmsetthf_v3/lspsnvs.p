...
thf(clspsnvs_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_0 = (ccfv @ XF @ cc0g)) => ((XN = (ccfv @ XW @ cclspn)) => (((cwcel @ XW @ cclvec) & ((cwcel @ XR @ XK) & (XR != Xc_0)) & (cwcel @ XX @ XV)) => ((ccfv @ (ccsn @ (cco @ XR @ XX @ Xc_x)) @ XN) = (ccfv @ (ccsn @ XX) @ XN))))))))))))))))))).
