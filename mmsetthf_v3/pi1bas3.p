...
thf(cpi1bas3_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ XJ @ XY @ ccpi1)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XY @ XX)) => ((Xph => (XB2 = (ccfv @ XG @ ccbs))) => ((XR = (ccin @ (ccfv @ XJ @ ccphtpc) @ (ccxp @ (ccuni @ XB2) @ (ccuni @ XB2)))) => (Xph => (XB2 = (ccqs @ (ccuni @ XB2) @ XR)))))))))))))))).
