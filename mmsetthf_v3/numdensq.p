...
thf(cnumdensq_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => (((ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccnumer) = (cco @ (ccfv @ XA2 @ ccnumer) @ cc2 @ ccexp)) & ((ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccdenom) = (cco @ (ccfv @ XA2 @ ccdenom) @ cc2 @ ccexp)))))).
