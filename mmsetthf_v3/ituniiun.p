...
thf(aitunisuc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ (ccsuc @ XB2) @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1))) = (ccuni @ (ccfv @ XB2 @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1)))))))))))).
...
thf(cituniiun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xa)) => ((ccfv @ (ccsuc @ XB2) @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1))) = (cciun @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (ccfv @ XB2 @ (ccfv @ (ccv @ Xa) @ (XU @ Xx3 @ Xy1)))))))))))))))).
