...
thf(acncph_thm,axiom,(! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwcel @ XU @ cccphlo)))).
thf(aishlo_thm,axiom,(! [XU:($i > $o)] : ((cwcel @ XU @ cchlo) <=> ((cwcel @ XU @ cccbn) & (cwcel @ XU @ cccphlo))))).
thf(ccnchl_conj,conjecture,(! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (cwcel @ XU @ cchlo)))).
