...
thf(cdfnbgr2_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xn:$i] : ((XE @ Xn) = (ccfv @ XG @ ccedg))) => ((cwcel @ XN @ XV) => ((cco @ XG @ XN @ ccnbgr) = (ccrab @ (^ [Xn:$i] : (cwrex @ (^ [Xe:$i] : ((cwcel @ XN @ (ccv @ Xe)) & (cwcel @ (ccv @ Xn) @ (ccv @ Xe)))) @ (^ [Xe:$i] : (XE @ Xn)))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))))).
