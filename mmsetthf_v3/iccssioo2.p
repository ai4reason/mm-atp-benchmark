...
thf(ciccssioo2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) & (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccioo))) => (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
