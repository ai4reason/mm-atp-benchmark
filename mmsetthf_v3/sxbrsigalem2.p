...
thf(a_1stpreima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((ccima @ (cccnv @ (ccres @ cc1st @ (ccxp @ XB2 @ XC))) @ XA2) = (ccxp @ XA2 @ XC))))))).
...
thf(adifico_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & ((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ XB2 @ XC @ ccle))) => ((ccdif @ (cco @ XA2 @ XC @ ccico) @ (cco @ XB2 @ XC @ ccico)) = (cco @ XA2 @ XB2 @ ccico))))))).
...
thf(a_2ndpreima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XC) => ((ccima @ (cccnv @ (ccres @ cc2nd @ (ccxp @ XB2 @ XC))) @ XA2) = (ccxp @ XB2 @ XA2))))))).
