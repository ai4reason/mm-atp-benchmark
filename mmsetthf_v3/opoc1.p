...
thf(copoc1_conj,conjecture,(! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XK @ ccp0)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((cwcel @ XK @ ccops) => ((ccfv @ Xc_1 @ Xc_pe) = Xc_0)))))))))).
