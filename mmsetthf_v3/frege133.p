...
thf(cfrege133_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ XU) => ((cwcel @ XY @ XV) => ((cwcel @ XM @ XW) => ((cwcel @ XR @ XS) => ((cwfun @ (cccnv @ (cccnv @ XR))) => ((cwbr @ XX @ XM @ (ccfv @ XR @ cctcl)) => ((cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) => ((~ (cwbr @ XY @ XM @ (ccfv @ XR @ cctcl))) => (cwbr @ XM @ XY @ (ccun @ (ccfv @ XR @ cctcl) @ ccid))))))))))))))))))).
