...
thf(am1dvdsndvds_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz)) => ((cwbr @ XP @ (cco @ XA2 @ cc1 @ ccmin) @ ccdvds) => (~ (cwbr @ XP @ XA2 @ ccdvds))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(amodprminv_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XR = (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) => (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz) & (~ (cwbr @ XP @ XA2 @ ccdvds))) => ((cwcel @ XR @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz)) & ((cco @ (cco @ XA2 @ XR @ ccmul) @ XP @ ccmo) = cc1)))))))).
...
thf(cpowm2modprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz)) => ((cwbr @ XP @ (cco @ XA2 @ cc1 @ ccmin) @ ccdvds) => ((cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo) = cc1)))))).
