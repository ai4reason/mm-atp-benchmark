...
thf(ageoisum_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((ccsu @ ccn0 @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) = (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv))))).
