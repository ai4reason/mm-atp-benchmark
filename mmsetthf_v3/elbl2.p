...
thf(celbl2_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XR @ ccxr)) & ((cwcel @ XP @ XX) & (cwcel @ XA2 @ XX))) => ((cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) <=> (cwbr @ (cco @ XP @ XA2 @ XD) @ XR @ cclt))))))))).
