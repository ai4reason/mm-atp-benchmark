...
thf(cmetcn4_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XC @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XD @ (ccfv @ XY @ ccxmt))) => ((Xph => (cwf @ XX @ XY @ XF)) => (Xph => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> (! [Xf1:$i] : ((cwf @ ccn @ XX @ (ccv @ Xf1)) => (! [Xx3:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ (ccfv @ XJ @ cclm)) => (cwbr @ (cccom @ XF @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ XK @ cclm)))))))))))))))))))))).
