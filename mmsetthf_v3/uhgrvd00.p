...
thf(cuhgrvd00_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((cwcel @ XG @ ccuhgr) => ((cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) = ccc0)) @ (^ [Xv:$i] : XV)) => (XE = cc0))))))))).
