...
thf(cmulpipq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) & (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi))) => ((cco @ XA2 @ XB2 @ ccmpq) = (ccop @ (cco @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc1st) @ ccmi) @ (cco @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XB2 @ cc2nd) @ ccmi))))))).
