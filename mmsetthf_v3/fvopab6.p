...
thf(cfvopab6_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((Xph @ Xx3 @ Xy1) & ((ccv @ Xy1) = (XB2 @ Xx3))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = XC))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XD @ Xx3 @ Xy1)) & (cwcel @ XC @ (XR @ Xx3 @ Xy1)) & Xps) => ((ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) = XC)))))))))))))))).
