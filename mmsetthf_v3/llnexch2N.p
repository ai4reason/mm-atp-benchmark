...
thf(cllnexch2N_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XN) & (cwcel @ XY @ XN) & (cwcel @ XZ @ XN)) & ((cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2) & (XX != XZ))) => ((cwbr @ (cco @ XX @ XY @ Xc_an) @ XZ @ Xc_le) => (cwbr @ (cco @ XX @ XZ @ Xc_an) @ XY @ Xc_le)))))))))))))))))).
