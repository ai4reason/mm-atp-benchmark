...
thf(acoemul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply)) & (cwcel @ XN @ ccn0)) => ((ccfv @ XN @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XB2) @ ccmul)))))))))))))).
...
thf(acoeidp_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((ccfv @ XA2 @ (ccfv @ ccidp @ cccoe)) = (ccif @ (XA2 = cc1) @ cc1 @ ccc0))))).
...
thf(cplymulx0_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdif @ (ccfv @ ccr @ ccply) @ (ccsn @ cc0p))) => ((ccfv @ (cco @ XF @ ccidp @ (ccof @ ccmul)) @ cccoe) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ ccc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccfv @ XF @ cccoe))))))))).
