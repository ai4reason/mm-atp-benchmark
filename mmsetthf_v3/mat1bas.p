...
thf(cmat1bas_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((Xc_1 = (ccfv @ (cco @ XN @ XR @ ccmat) @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn)) => (cwcel @ Xc_1 @ XB2))))))))))).
