...
thf(cissmflem_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((XD = (ccdm @ XF)) => (Xph => ((cwcel @ XF @ (ccfv @ XS @ ccsmblfn)) <=> ((cwss @ XD @ (ccuni @ XS)) & (cwf @ XD @ ccr @ XF) & (cwral @ (^ [Xa:$i] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xa) @ cclt)) @ (^ [Xx3:$i] : XD)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xa:$i] : ccr)))))))))))).
