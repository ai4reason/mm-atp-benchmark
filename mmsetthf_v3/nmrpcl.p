...
thf(cnmrpcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ XX) & (XA2 != Xc_0)) => (cwcel @ (ccfv @ XA2 @ XN) @ ccrp))))))))))).
