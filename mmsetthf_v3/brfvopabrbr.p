...
thf(arbropap_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((Xph @ Xf1 @ Xp) => ((XM @ Xf1 @ Xp) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ XW) & (Xps @ Xf1 @ Xp))))))))) => ((! [Xf1:$i] : (! [Xp:$i] : ((((ccv @ Xf1) = XF) & ((ccv @ Xp) = XP)) => ((Xps @ Xf1 @ Xp) <=> Xch)))) => (! [Xf1:$i] : (! [Xp:$i] : (((Xph @ Xf1 @ Xp) & (cwcel @ XF @ (XX @ Xf1 @ Xp)) & (cwcel @ XP @ (XY @ Xf1 @ Xp))) => ((cwbr @ XF @ XP @ (XM @ Xf1 @ Xp)) <=> ((cwbr @ XF @ XP @ XW) & Xch))))))))))))))))).
