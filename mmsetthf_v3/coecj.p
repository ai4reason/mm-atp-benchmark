...
thf(aplycj_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : ((XG @ Xx3) = (cccom @ (cccom @ cccj @ XF) @ cccj))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ cccj) @ XS))) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => (! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ (ccfv @ XS @ ccply)))))))))))))).
