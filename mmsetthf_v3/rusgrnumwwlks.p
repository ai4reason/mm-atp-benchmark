...
thf(awwlksnredwwlkn0_thm,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XN @ ccn0) & (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn))) => (((ccfv @ ccc0 @ XW) = XP) <=> (cwrex @ (^ [Xy1:$i] : (((cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) = (ccv @ Xy1)) & ((ccfv @ ccc0 @ (ccv @ Xy1)) = XP) & (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ XW @ cclsw)) @ XE))) @ (^ [Xy1:$i] : (cco @ XN @ XG @ ccwwlksn)))))))))))).
...
thf(ahashwwlksnext_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xw:$i] : ((XX @ Xw) = (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn))) => ((! [Xx3:$i] : (! [Xw:$i] : ((XE @ Xx3 @ Xw) = (ccfv @ XG @ ccedg)))) => ((! [Xx3:$i] : (! [Xw:$i] : ((XY @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (XP @ Xx3))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn)))))) => (! [Xw:$i] : ((cwcel @ (ccfv @ XG @ ccvtx) @ ccfn) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (XM @ Xx3 @ Xw)) @ ccsubstr) = (ccv @ Xy1)) & ((ccfv @ ccc0 @ (ccv @ Xy1)) = (XP @ Xx3)) & (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ (ccv @ Xx3) @ cclsw)) @ (XE @ Xx3 @ Xw)))) @ (^ [Xy1:$i] : (XY @ Xw)))) @ (^ [Xx3:$i] : (XX @ Xw))) @ cchash) = (ccsu @ (XY @ Xw) @ (^ [Xy1:$i] : (ccfv @ (ccrab @ (^ [Xx3:$i] : (((cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (XM @ Xx3 @ Xw)) @ ccsubstr) = (ccv @ Xy1)) & ((ccfv @ ccc0 @ (ccv @ Xy1)) = (XP @ Xx3)) & (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ (ccv @ Xx3) @ cclsw)) @ (XE @ Xx3 @ Xw)))) @ (^ [Xx3:$i] : (XX @ Xw))) @ cchash))))))))))))))))).
...
thf(arusgrnumwwlkslem_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XY @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XP)) @ (^ [Xw:$i] : XZ))) => ((ccrab @ (^ [Xw:$i] : ((Xph @ Xw) & (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw))) = (ccrab @ (^ [Xw:$i] : ((Xph @ Xw) & ((ccfv @ ccc0 @ XY) = XP) & (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw)))))))))))).
...
thf(crusgrnumwwlks_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XL @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn))) @ cchash)))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (((cwbr @ XG @ (XK @ Xv @ Xn) @ ccrusgr) & ((cwcel @ XV @ ccfn) & (cwcel @ XP @ XV) & (cwcel @ XN @ ccn0))) => (((cco @ XP @ XN @ (XL @ Xw @ Xv @ Xn)) = (cco @ (XK @ Xv @ Xn) @ XN @ ccexp)) => ((cco @ XP @ (cco @ XN @ cc1 @ ccaddc) @ (XL @ Xw @ Xv @ Xn)) = (cco @ (XK @ Xv @ Xn) @ (cco @ XN @ cc1 @ ccaddc) @ ccexp)))))))))))))))).
