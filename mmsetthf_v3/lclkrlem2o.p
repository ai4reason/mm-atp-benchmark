...
thf(clclkrlem2o_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XU @ ccbs)) => ((Xc_x = (ccfv @ XU @ ccvsca)) => ((XS = (ccfv @ XU @ ccsca)) => ((Xc_xp = (ccfv @ XS @ ccmulr)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XI = (ccfv @ XS @ ccinvr)) => ((Xc_mi = (ccfv @ XU @ ccsg)) => ((XF = (ccfv @ XU @ cclfn)) => ((XD = (ccfv @ XU @ ccld)) => ((Xc_pl = (ccfv @ XD @ ccplusg)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XE @ XF)) => ((Xph => (cwcel @ XG @ XF)) => ((XN = (ccfv @ XU @ cclspn)) => ((XL = (ccfv @ XU @ cclk)) => ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((XB2 = (cco @ XX @ (cco @ (cco @ (ccfv @ XX @ (cco @ XE @ XG @ Xc_pl)) @ (ccfv @ (ccfv @ XY @ (cco @ XE @ XG @ Xc_pl)) @ XI) @ Xc_xp) @ XY @ Xc_x) @ Xc_mi)) => ((Xph => ((ccfv @ XY @ (cco @ XE @ XG @ Xc_pl)) != Xc_0)) => ((Xph => (XB2 != (ccfv @ XU @ cc0g))) => (Xph => ((~ (cwcel @ XX @ (ccfv @ (ccsn @ XB2) @ Xc_pe))) | (~ (cwcel @ XY @ (ccfv @ (ccsn @ XB2) @ Xc_pe)))))))))))))))))))))))))))))))))))))))))))))))))))))).
