...
thf(cfri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XB2 @ (XC @ Xx3 @ Xy1)) & (cwfr @ XA2 @ XR)) & ((cwss @ XB2 @ XA2) & (XB2 != cc0))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
