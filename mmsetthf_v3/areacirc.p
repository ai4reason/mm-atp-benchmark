...
thf(aareacirclem5_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccr) & (cwcel @ (ccv @ Xy1) @ ccr)) & (cwbr @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ XR @ cc2 @ ccexp) @ ccle)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (((cwcel @ XR @ ccr) & (cwbr @ ccc0 @ XR @ ccle) & (cwcel @ (ccv @ Xt) @ ccr)) => ((ccima @ (XS @ Xx3 @ Xy1) @ (ccsn @ (ccv @ Xt))) = (ccif @ (cwbr @ (ccfv @ (ccv @ Xt) @ ccabs) @ XR @ ccle) @ (cco @ (ccneg @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt)) @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccicc) @ cc0)))))))))).
...
thf(aareacirclem3_thm,axiom,(! [XR:($i > $o)] : (((cwcel @ XR @ ccr) & (cwbr @ ccc0 @ XR @ ccle)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ cc2 @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul))) @ ccibl)))).
...
thf(aitgss_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (XB2 @ Xx3) @ (XA2 @ Xx3)))) => ((XC @ Xx3) = ccc0))) => (Xph => ((ccitg @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccitg @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(aareacirclem1_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrp) => ((cco @ ccr @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccioo)) @ (^ [Xt:$i] : (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ ccasin) @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ (ccfv @ (cco @ cc1 @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul) @ ccaddc) @ ccmul))) @ ccdv) = (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccioo)) @ (^ [Xt:$i] : (cco @ cc2 @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul))))))).
thf(aovexd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (Xph => (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))))).
thf(cc2nd_tp,type,(cc2nd : ($i > $o))).
thf(cc1st_tp,type,(cc1st : ($i > $o))).
thf(cccn_tp,type,(cccn : ($i > $o))).
thf(cctx_tp,type,(cctx : ($i > $o))).
thf(aftc2nc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ ccibl)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => (Xph => ((ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)))) = (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin)))))))))))))).
...
thf(aareacirclem2_thm,axiom,(! [XR:($i > $o)] : (((cwcel @ XR @ ccr) & (cwbr @ ccc0 @ XR @ ccle)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
...
thf(aareacirclem4_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrp) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ ccasin) @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ (ccfv @ (cco @ cc1 @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul) @ ccaddc) @ ccmul))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
...
thf(aasinneg_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccneg @ XA2) @ ccasin) = (ccneg @ (ccfv @ XA2 @ ccasin)))))).
...
thf(apidiv2halves_thm,axiom,((cco @ (cco @ ccpi @ cc2 @ ccdiv) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccaddc) = ccpi)).
...
thf(careacirc_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccr) & (cwcel @ (ccv @ Xy1) @ ccr)) & (cwbr @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ XR @ cc2 @ ccexp) @ ccle)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XR @ ccr) & (cwbr @ ccc0 @ XR @ ccle)) => ((ccfv @ (XS @ Xx3 @ Xy1) @ ccarea) = (cco @ ccpi @ (cco @ XR @ cc2 @ ccexp) @ ccmul))))))))).
