...
thf(cgsumncl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (XK = (ccfv @ (XM @ Xk) @ ccbs))) => ((! [Xk:$i] : (Xph => (cwcel @ (XM @ Xk) @ ccmnd))) => ((Xph => (cwcel @ XP @ (ccfv @ XN @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XN @ XP @ ccfz))) => (cwcel @ (XB2 @ Xk) @ XK))) => (! [Xk:$i] : (Xph => (cwcel @ (cco @ (XM @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ XN @ XP @ ccfz)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccgsu) @ XK)))))))))))))).
