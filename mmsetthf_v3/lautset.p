...
thf(adf_laut_ax,axiom,(cclaut = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (^ [Xf1:$i] : ((cwf1o @ (ccfv @ (ccv @ Xk) @ ccbs) @ (ccfv @ (ccv @ Xk) @ ccbs) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xk) @ ccple)) <=> (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xk) @ ccple)))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xk) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccbs))))))))).
...
thf(clautset_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_le @ Xx3 @ Xy1) = (ccfv @ XK @ ccple)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XI @ Xx3 @ Xy1 @ Xf1) = (ccfv @ XK @ cclaut))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((cwcel @ XK @ (XA2 @ Xx3 @ Xy1 @ Xf1)) => ((XI @ Xx3 @ Xy1 @ Xf1) = (^ [Xf1:$i] : ((cwf1o @ XB2 @ XB2 @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_le @ Xx3 @ Xy1)) <=> (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (Xc_le @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))))))))).
