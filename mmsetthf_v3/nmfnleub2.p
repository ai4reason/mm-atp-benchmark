...
thf(cnmfnleub2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ ccc @ XT) & ((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccabs) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccno) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : cchil))) => (cwbr @ (ccfv @ XT @ ccnmf) @ XA2 @ ccle))))).
