...
thf(apmapglbx_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xy1:$i] : (! [Xi:$i] : ((XG @ Xy1 @ Xi) = (ccfv @ XK @ ccglb)))) => ((! [Xy1:$i] : (! [Xi:$i] : ((XM @ Xy1 @ Xi) = (ccfv @ XK @ ccpmap)))) => (! [Xy1:$i] : (! [Xi:$i] : (((cwcel @ XK @ cchlt) & (cwral @ (^ [Xi:$i] : (cwcel @ (XS @ Xi) @ XB2)) @ (^ [Xi:$i] : XI)) & (XI != cc0)) => ((ccfv @ (ccfv @ (^ [Xy1:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xy1) = (XS @ Xi))) @ (^ [Xi:$i] : XI))) @ (XG @ Xy1 @ Xi)) @ (XM @ Xy1 @ Xi)) = (cciin @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (XS @ Xi) @ (XM @ Xy1 @ Xi)))))))))))))))))).
thf(cpmapglb_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ XK @ ccglb))) => ((! [Xx3:$i] : ((XM @ Xx3) = (ccfv @ XK @ ccpmap))) => (! [Xx3:$i] : (((cwcel @ XK @ cchlt) & (cwss @ XS @ XB2) & (XS != cc0)) => ((ccfv @ (ccfv @ XS @ (XG @ Xx3)) @ (XM @ Xx3)) = (cciin @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XM @ Xx3)))))))))))))))).
