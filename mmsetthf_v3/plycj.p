...
thf(aplycjlem_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xz:$i] : (! [Xk:$i] : ((XG @ Xz @ Xk) = (cccom @ (cccom @ cccj @ XF) @ cccj)))) => ((XA2 = (ccfv @ XF @ cccoe)) => (! [Xz:$i] : (! [Xk:$i] : ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((XG @ Xz @ Xk) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (cccom @ cccj @ XA2)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))))))))))).
...
thf(cplycj_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : ((XG @ Xx3) = (cccom @ (cccom @ cccj @ XF) @ cccj))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ cccj) @ XS))) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => (! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ (ccfv @ XS @ ccply)))))))))))))).
