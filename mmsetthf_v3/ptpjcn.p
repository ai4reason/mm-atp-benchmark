...
thf(cptpjcn_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (XY = (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XF @ ccpt))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ cctop @ XF) & (cwcel @ XI @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (ccfv @ XI @ (ccv @ Xx3)))) @ (cco @ (XJ @ Xx3) @ (ccfv @ XI @ XF) @ cccn))))))))))))).
