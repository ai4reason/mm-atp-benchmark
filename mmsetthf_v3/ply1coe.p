...
thf(apsr1baslem_thm,axiom,((cco @ ccn0 @ cc1o @ ccmap) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ cc1o @ ccmap))))).
...
thf(aply1vsca_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XS = (cco @ cc1o @ XR @ ccmpl)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => (Xc_x = (ccfv @ XS @ ccvsca)))))))))).
...
thf(afvcoe1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ ccco1)) => (((cwcel @ XF @ XV) & (cwcel @ XX @ (cco @ ccn0 @ cc1o @ ccmap))) => ((ccfv @ XX @ XF) = (ccfv @ (ccfv @ cc0 @ XX) @ XA2))))))))).
...
thf(amulgpropd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XG @ ccmg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_xp @ Xx3 @ Xy1) = (ccfv @ XH @ ccmg)))) => ((Xph => (XB2 = (ccfv @ XG @ ccbs))) => ((Xph => (XB2 = (ccfv @ XH @ ccbs))) => ((Xph => (cwss @ XB2 @ XK)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XK) & (cwcel @ (ccv @ Xy1) @ XK))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XG @ ccplusg)) @ XK)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XK) & (cwcel @ (ccv @ Xy1) @ XK))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XG @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XH @ ccplusg)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((Xc_x @ Xx3 @ Xy1) = (Xc_xp @ Xx3 @ Xy1)))))))))))))))))))).
...
thf(avr1val_thm,axiom,(! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccv1)) => (XX = (ccfv @ cc0 @ (cco @ cc1o @ XR @ ccmvr))))))).
...
thf(aply1mpl0_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XM = (cco @ cc1o @ XR @ ccmpl)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => (Xc_0 = (ccfv @ XM @ cc0g)))))))))).
...
thf(aply1coefsupp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((XP = (ccfv @ XR @ ccpl1)) => ((! [Xk:$i] : ((XX @ Xk) = (ccfv @ XR @ ccv1))) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((! [Xk:$i] : ((XM @ Xk) = (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : ((Xc_ex @ Xk) = (ccfv @ (XM @ Xk) @ ccmg))) => ((XA2 = (ccfv @ XK @ ccco1)) => (((cwcel @ XR @ ccrg) & (cwcel @ XK @ XB2)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xk) @ (XX @ Xk) @ (Xc_ex @ Xk)) @ Xc_x))) @ (ccfv @ XP @ cc0g) @ ccfsupp))))))))))))))))))).
...
thf(cply1coe_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((! [Xk:$i] : ((XM @ Xk) = (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XM @ Xk) @ ccmg))) => ((XA2 = (ccfv @ XK @ ccco1)) => (((cwcel @ XR @ ccrg) & (cwcel @ XK @ XB2)) => (XK = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_x))) @ ccgsu)))))))))))))))))))).
