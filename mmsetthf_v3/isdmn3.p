...
thf(arngoueqz_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XU = (ccfv @ XH @ ccgi)) => ((XX = (ccrn @ XG)) => ((cwcel @ XR @ ccrngo) => ((cwbr @ XX @ cc1o @ ccen) <=> (XU = XZ))))))))))))))).
...
thf(cisdmn3_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((XG @ Xa @ Xb) = (ccfv @ XR @ cc1st)))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xa:$i] : (! [Xb:$i] : (XX = (ccrn @ (XG @ Xa @ Xb))))) => ((! [Xa:$i] : (! [Xb:$i] : (XZ = (ccfv @ (XG @ Xa @ Xb) @ ccgi)))) => ((! [Xa:$i] : (! [Xb:$i] : ((XU @ Xa @ Xb) = (ccfv @ XH @ ccgi)))) => (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XR @ ccdmn) <=> ((cwcel @ XR @ cccring) & ((XU @ Xa @ Xb) != XZ) & (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (((cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) = XZ) => (((ccv @ Xa) = XZ) | ((ccv @ Xb) = XZ)))) @ (^ [Xb:$i] : XX))) @ (^ [Xa:$i] : XX)))))))))))))))))).
