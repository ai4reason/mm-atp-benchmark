...
thf(a_0totbnd_thm,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = cc0) => ((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XM @ (ccfv @ XX @ ccme))))))).
...
thf(atotbndss_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) & (cwss @ XS @ XX)) => (cwcel @ (ccres @ XM @ (ccxp @ XS @ XS)) @ (ccfv @ XS @ cctotbnd))))))).
