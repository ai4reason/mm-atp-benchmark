...
thf(amapsspw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccmap) @ (ccpw @ (ccxp @ XB2 @ XA2)))))).
...
thf(crankmapu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwss @ (ccfv @ (cco @ XA2 @ XB2 @ ccmap) @ ccrnk) @ (ccsuc @ (ccsuc @ (ccsuc @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)))))))))).
