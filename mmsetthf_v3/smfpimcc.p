...
thf(asmfpimbor1_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((XD = (ccdm @ XF)) => ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XB2 = (ccfv @ XJ @ ccsalgen)) => ((Xph => (cwcel @ XE @ XB2)) => ((XP = (ccima @ (cccnv @ XF) @ XE)) => (Xph => (cwcel @ XP @ (cco @ XS @ XD @ ccrest))))))))))))))))))).
...
thf(asmfpimcclem_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > ($i > $o))] : ((! [Xh:$i] : (! [Xs1:$i] : ((? [X:$i] : ((^ [Xn:$i] : (Xph @ Xh @ Xn @ Xs1)) @ X)) => (! [X:$i] : ((^ [Xn:$i] : (Xph @ Xh @ Xn @ Xs1)) @ X))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwcel @ (XZ @ Xs1) @ (XV @ Xy1 @ Xh @ Xn @ Xs1)))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xh @ Xn @ Xs1) => (cwcel @ XS @ (XW @ Xy1 @ Xh @ Xn @ Xs1))))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : (((Xph @ Xh @ Xn @ Xs1) & (cwcel @ (ccv @ Xy1) @ (ccrn @ (ccmpt @ (^ [Xn:$i] : (XZ @ Xs1)) @ (^ [Xn:$i] : (ccrab @ (^ [Xs1:$i] : ((ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (XA2 @ Xn)) = (ccin @ (ccv @ Xs1) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ (^ [Xs1:$i] : XS))))))) => (cwcel @ (ccfv @ (ccv @ Xy1) @ (XC @ Xh @ Xn)) @ (ccv @ Xy1))))))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XH @ Xy1 @ Xn @ Xs1) = (ccmpt @ (^ [Xn:$i] : (XZ @ Xs1)) @ (^ [Xn:$i] : (ccfv @ (ccrab @ (^ [Xs1:$i] : ((ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (XA2 @ Xn)) = (ccin @ (ccv @ Xs1) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ (^ [Xs1:$i] : XS)) @ (XC @ Xh @ Xn))))))))) => (! [Xh:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xh @ Xn @ Xs1) => (? [Xh:$i] : ((cwf @ (XZ @ Xs1) @ XS @ (ccv @ Xh)) & (cwral @ (^ [Xn:$i] : ((ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (XA2 @ Xn)) = (ccin @ (ccfv @ (ccv @ Xn) @ (ccv @ Xh)) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ (^ [Xn:$i] : (XZ @ Xs1)))))))))))))))))))))))).
...
thf(csmfpimcc_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((cwnfc @ (^ [Xn:$i] : (XF @ Xn))) => ((! [Xh:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xh @ Xn) @ ccuz)))) => ((! [Xh:$i] : (! [Xn:$i] : ((Xph @ Xh @ Xn) => (cwcel @ (XS @ Xn) @ ccsalg)))) => ((! [Xh:$i] : (! [Xn:$i] : ((Xph @ Xh @ Xn) => (cwf @ XZ @ (ccfv @ (XS @ Xn) @ ccsmblfn) @ (XF @ Xn))))) => ((! [Xh:$i] : (! [Xn:$i] : ((XJ @ Xh @ Xn) = (ccfv @ (ccrn @ ccioo) @ cctg)))) => ((! [Xh:$i] : (! [Xn:$i] : ((XB2 @ Xh @ Xn) = (ccfv @ (XJ @ Xh @ Xn) @ ccsalgen)))) => ((! [Xh:$i] : (! [Xn:$i] : ((Xph @ Xh @ Xn) => (cwcel @ XA2 @ (XB2 @ Xh @ Xn))))) => (! [Xh:$i] : (! [Xn:$i] : ((Xph @ Xh @ Xn) => (? [Xh:$i] : ((cwf @ XZ @ (XS @ Xn) @ (ccv @ Xh)) & (cwral @ (^ [Xn:$i] : ((ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ XA2) = (ccin @ (ccfv @ (ccv @ Xn) @ (ccv @ Xh)) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ (^ [Xn:$i] : XZ))))))))))))))))))))))).
