...
thf(asspz_thm,axiom,(! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XU @ ccn0v)) => ((XQ = (ccfv @ XW @ ccn0v)) => ((XH = (ccfv @ XU @ ccss)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ XH)) => (XQ = XZ))))))))))).
...
thf(asspsval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XW @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XR = (ccfv @ XW @ ccns)) => ((XH = (ccfv @ XU @ ccss)) => ((((cwcel @ XU @ ccnv) & (cwcel @ XW @ XH)) & ((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ XY))) => ((cco @ XA2 @ XB2 @ XR) = (cco @ XA2 @ XB2 @ XS)))))))))))))))).
...
thf(chhshsslem2_conj,conjecture,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XW @ (ccfv @ XU @ ccss)) => ((cwss @ XH @ cchil) => (cwcel @ XH @ ccsh))))))))).
