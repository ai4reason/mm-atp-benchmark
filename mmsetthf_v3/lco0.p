...
thf(a_0fsupp_thm,axiom,(! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XZ @ XV) => (cwbr @ cc0 @ XZ @ ccfsupp))))).
...
thf(clco0_conj,conjecture,(! [XM:($i > $o)] : ((cwcel @ XM @ ccmnd) => ((cco @ XM @ cc0 @ cclinco) = (ccsn @ (ccfv @ XM @ cc0g)))))).
