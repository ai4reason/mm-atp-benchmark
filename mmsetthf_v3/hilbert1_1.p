...
thf(chilbert1_1_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ (XN @ Xx3) @ ccn) & ((cwcel @ XP @ (ccfv @ (XN @ Xx3) @ ccee)) & (cwcel @ XQ @ (ccfv @ (XN @ Xx3) @ ccee)) & (XP != XQ))) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwcel @ XQ @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : cclines2)))))))).
