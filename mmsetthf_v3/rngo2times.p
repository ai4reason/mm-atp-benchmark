...
thf(crngo2times_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XA2 @ XB2)) => ((cco @ XA2 @ XA2 @ Xc_pl) = (cco @ (cco @ Xc_1 @ Xc_1 @ Xc_pl) @ XA2 @ Xc_x)))))))))))))).
