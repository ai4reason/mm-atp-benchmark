...
thf(acpmidgsum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((! [Xn:$i] : ((Xc_x @ Xn) = (ccfv @ XY @ ccvsca))) => ((! [Xn:$i] : ((Xc_1 @ Xn) = (ccfv @ XY @ ccur))) => ((! [Xn:$i] : ((XU @ Xn) = (ccfv @ XP @ ccascl))) => ((! [Xn:$i] : ((XC @ Xn) = (cco @ XN @ XR @ ccchpmat))) => ((! [Xn:$i] : (XK = (ccfv @ (XM @ Xn) @ (XC @ Xn)))) => ((! [Xn:$i] : (XH = (cco @ XK @ (Xc_1 @ Xn) @ (Xc_x @ Xn)))) => (! [Xn:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg) & (cwcel @ (XM @ Xn) @ XB2)) => (XH = (cco @ XY @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ XX @ Xc_ex) @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccfv @ XK @ ccco1)) @ (XU @ Xn)) @ (Xc_1 @ Xn) @ (Xc_x @ Xn)) @ (Xc_x @ Xn)))) @ ccgsu)))))))))))))))))))))))))))))))).
