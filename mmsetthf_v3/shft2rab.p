...
thf(cshft2rab_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((XB2 @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XC @ ccmin) @ XA2)) @ (^ [Xx3:$i] : ccr))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (XA2 = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xy1) @ (ccneg @ XC) @ ccmin) @ (XB2 @ Xx3))) @ (^ [Xy1:$i] : ccr))))))))))))).
