...
thf(antrrn_thm,axiom,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XI = (ccfv @ XJ @ ccnt)) => ((cwcel @ XJ @ cctop) => (cwss @ (ccrn @ XI) @ XJ)))))))).
thf(adf_f_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) <=> ((cwfn @ XF @ XA2) & (cwss @ (ccrn @ XF) @ XB2))))))).
thf(cntrf_conj,conjecture,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XI = (ccfv @ XJ @ ccnt)) => ((cwcel @ XJ @ cctop) => (cwf @ (ccpw @ XX) @ XJ @ XI)))))))).
