...
thf(adiag11_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XX @ XA2)) => ((XK = (ccfv @ XX @ (ccfv @ XL @ cc1st))) => ((XB2 = (ccfv @ XD @ ccbs)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((ccfv @ XY @ (ccfv @ XK @ cc1st)) = XX)))))))))))))))))))).
...
thf(adiag1cl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XX @ XA2)) => ((XK = (ccfv @ XX @ (ccfv @ XL @ cc1st))) => (Xph => (cwcel @ XK @ (cco @ XD @ XC @ ccfunc))))))))))))))))).
...
thf(acidfn_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((cwcel @ XC @ cccat) => (cwfn @ Xc_1 @ XB2)))))))).
...
thf(adiag12_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XX @ XA2)) => ((XK = (ccfv @ XX @ (ccfv @ XL @ cc1st))) => ((XB2 = (ccfv @ XD @ ccbs)) => ((Xph => (cwcel @ XY @ XB2)) => ((XJ = (ccfv @ XD @ cchom)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XY @ XZ @ XJ))) => (Xph => ((ccfv @ XF @ (cco @ XY @ XZ @ (ccfv @ XK @ cc2nd))) = (ccfv @ XX @ Xc_1))))))))))))))))))))))))))))).
...
thf(ccurf2ndf_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : ((XQ = (cco @ XD @ XD @ ccfuc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => (Xph => ((cco @ (ccop @ XC @ XD) @ (cco @ XC @ XD @ cc2ndf) @ cccurf) = (ccfv @ (ccfv @ XD @ ccidfu) @ (ccfv @ (cco @ XQ @ XC @ ccdiag) @ cc1st)))))))))))).
