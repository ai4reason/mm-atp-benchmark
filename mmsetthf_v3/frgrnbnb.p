...
thf(a_4cyclusnfrgr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccusgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XC @ XV) & (XA2 != XC)) & ((cwcel @ XB2 @ XV) & (cwcel @ XD @ XV) & (XB2 != XD))) => ((((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE)) & ((cwcel @ (ccpr @ XC @ XD) @ XE) & (cwcel @ (ccpr @ XD @ XA2) @ XE))) => (cwnel @ XG @ ccfrgr))))))))))))).
...
thf(cfrgrnbnb_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => ((XD = (cco @ XG @ XX @ ccnbgr)) => (((cwcel @ XG @ ccfrgr) & ((cwcel @ XU @ XD) & (cwcel @ XW @ XD)) & (XU != XW)) => (((cwcel @ (ccpr @ XU @ XA2) @ XE) & (cwcel @ (ccpr @ XW @ XA2) @ XE)) => (XA2 = XX))))))))))))).
