...
thf(adgrsub2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XT @ ccply))) & (((ccfv @ XG @ ccdgr) = XN) & (cwcel @ XN @ ccn) & ((ccfv @ XN @ (ccfv @ XF @ cccoe)) = (ccfv @ XN @ (ccfv @ XG @ cccoe))))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdgr) @ XN @ cclt))))))))).
thf(adgraa0p_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccaa) & (cwcel @ XP @ (ccfv @ ccq @ ccply)) & (cwbr @ (ccfv @ XP @ ccdgr) @ (ccfv @ XA2 @ ccdgraa) @ cclt)) => (((ccfv @ XA2 @ XP) = ccc0) <=> (XP = cc0p)))))).
...
thf(cmpaaeu_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => (cwreu @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xp) @ ccdgr) = (ccfv @ XA2 @ ccdgraa)) & ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0) & ((ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccv @ Xp) @ cccoe)) = cc1))) @ (^ [Xp:$i] : (ccfv @ ccq @ ccply)))))).
