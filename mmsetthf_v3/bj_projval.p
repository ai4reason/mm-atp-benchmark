...
thf(abj_xpima1sn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwnel @ XX @ XA2) => ((ccima @ (ccxp @ XA2 @ XB2) @ (ccsn @ XX)) = cc0)))))).
...
thf(cbj_projval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cbj_cproj @ XA2 @ (ccxp @ (ccsn @ XB2) @ (cbj_ctag @ XC))) = (ccif @ (XB2 = XA2) @ XC @ cc0)))))))).
