...
thf(clgsneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz) & (XN != ccc0)) => ((cco @ XA2 @ (ccneg @ XN) @ cclgs) = (cco @ (ccif @ (cwbr @ XA2 @ ccc0 @ cclt) @ (ccneg @ cc1) @ cc1) @ (cco @ XA2 @ XN @ cclgs) @ ccmul)))))).
