...
thf(cpythagtrip_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwcel @ XC @ ccn)) => (((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) <=> (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xk:$i] : (((ccpr @ XA2 @ XB2) = (ccpr @ (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul) @ ccmul))) & (XC = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc) @ ccmul)))) @ (^ [Xk:$i] : ccn))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn)))))))).
