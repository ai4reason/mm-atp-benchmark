...
thf(apgpfi1_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn0)) => (((ccfv @ XX @ cchash) = (cco @ XP @ XN @ ccexp)) => (cwbr @ XP @ XG @ ccpgp))))))))).
