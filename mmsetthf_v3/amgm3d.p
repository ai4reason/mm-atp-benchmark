...
thf(agsumws3_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccmnd) & ((cwcel @ XS @ XB2) & ((cwcel @ XT @ XB2) & (cwcel @ XU @ XB2)))) => ((cco @ XG @ (ccs3 @ XS @ XT @ XU) @ ccgsu) = (cco @ XS @ (cco @ XT @ XU @ Xc_pl) @ Xc_pl)))))))))))).
