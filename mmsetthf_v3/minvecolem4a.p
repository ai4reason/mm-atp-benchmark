...
thf(asspims_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XW @ ccba)) => ((XD = (ccfv @ XU @ ccims)) => ((XC = (ccfv @ XW @ ccims)) => ((XH = (ccfv @ XU @ ccss)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ XH)) => (XC = (ccres @ XD @ (ccxp @ XY @ XY))))))))))))))).
