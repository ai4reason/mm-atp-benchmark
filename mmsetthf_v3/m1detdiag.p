...
thf(cm1detdiag_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => (((cwcel @ XR @ cccrg) & ((XN = (ccsn @ XI)) & (cwcel @ XI @ XV)) & (cwcel @ XM @ XB2)) => ((ccfv @ XM @ XD) = (cco @ XI @ XI @ XM))))))))))))))).
