...
thf(ccnblcld_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : ((XD = (cccom @ ccabs @ ccmin)) => ((cwcel @ XR @ ccxr) => ((ccima @ (cccnv @ ccabs) @ (cco @ ccc0 @ XR @ ccicc)) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ ccc0 @ (ccv @ Xx3) @ XD) @ XR @ ccle)) @ (^ [Xx3:$i] : ccc)))))))).
