...
thf(cmrelatglb_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XC @ ccipo)) => ((XG = (ccfv @ XI @ ccglb)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XC) & (XU != cc0)) => ((ccfv @ XU @ XG) = (ccint @ XU))))))))))).
