...
thf(acauss_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwf @ ccn @ XY @ XF)) => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> (cwcel @ XF @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ ccca))))))))).
...
thf(chhsscms_conj,conjecture,(! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((XD = (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccch) => (cwcel @ XD @ (ccfv @ XH @ ccms))))))))).
