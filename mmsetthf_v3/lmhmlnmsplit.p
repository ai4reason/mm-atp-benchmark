...
thf(almhmrnlss_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) => (cwcel @ (ccrn @ XF) @ (ccfv @ XT @ cclss))))))).
...
thf(almhmfgsplit_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XT @ cc0g)) => ((XK = (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((XU = (cco @ XS @ XK @ ccress)) => ((XV = (cco @ XT @ (ccrn @ XF) @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XU @ cclfig) & (cwcel @ XV @ cclfig)) => (cwcel @ XS @ cclfig)))))))))))))).
thf(aislnm_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XS = (ccfv @ XM @ cclss)) => ((cwcel @ XM @ cclnm) <=> ((cwcel @ XM @ cclmod) & (cwral @ (^ [Xi:$i] : (cwcel @ (cco @ XM @ (ccv @ Xi) @ ccress) @ cclfig)) @ (^ [Xi:$i] : XS)))))))).
thf(clmhmlnmsplit_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XT @ cc0g)) => ((XK = (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((XU = (cco @ XS @ XK @ ccress)) => ((XV = (cco @ XT @ (ccrn @ XF) @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XU @ cclnm) & (cwcel @ XV @ cclnm)) => (cwcel @ XS @ cclnm)))))))))))))).
