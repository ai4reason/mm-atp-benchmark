...
thf(ctgldim0eq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((XP = (ccfv @ XF @ XE)) => ((Xph => ((ccfv @ XP @ cchash) = cc1)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => (Xph => (XA2 = XB2))))))))))))).
