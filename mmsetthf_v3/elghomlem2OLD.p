...
thf(aelghomlem1OLD_thm,axiom,(! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xx3 @ Xy1 @ Xf1) = (^ [Xf1:$i] : ((cwf @ (ccrn @ XG) @ (ccrn @ XH) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ XH) = (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccrn @ XG)))) @ (^ [Xx3:$i] : (ccrn @ XG))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr)) => ((cco @ XG @ XH @ ccghomOLD) = (XS @ Xx3 @ Xy1 @ Xf1))))))))))).
...
thf(celghomlem2OLD_conj,conjecture,(! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xx3 @ Xy1 @ Xf1) = (^ [Xf1:$i] : ((cwf @ (ccrn @ XG) @ (ccrn @ XH) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ XH) = (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccrn @ XG)))) @ (^ [Xx3:$i] : (ccrn @ XG))))))))) => (((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr)) => ((cwcel @ XF @ (cco @ XG @ XH @ ccghomOLD)) <=> ((cwf @ (ccrn @ XG) @ (ccrn @ XH) @ XF) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XH) = (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ XF))) @ (^ [Xy1:$i] : (ccrn @ XG)))) @ (^ [Xx3:$i] : (ccrn @ XG)))))))))))).
