...
thf(afuncestrcsetclem8_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccfv @ (XU @ Xx3 @ Xy1) @ ccestrc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccfv @ (XU @ Xx3 @ Xy1) @ ccsetc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XB2 = (ccfv @ (XE @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xy1) = (ccfv @ (XS @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XU @ Xx3 @ Xy1) @ ccwun)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((XG @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ ccid @ (cco @ (ccfv @ (ccv @ Xy1) @ ccbs) @ (ccfv @ (ccv @ Xx3) @ ccbs) @ ccmap))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => (cwf @ (cco @ XX @ XY @ (ccfv @ (XE @ Xx3 @ Xy1) @ cchom)) @ (cco @ (ccfv @ XX @ (XF @ Xx3 @ Xy1)) @ (ccfv @ XY @ (XF @ Xx3 @ Xy1)) @ (ccfv @ (XS @ Xx3 @ Xy1) @ cchom)) @ (cco @ XX @ XY @ (XG @ Xx3 @ Xy1)))))))))))))))))))))))).
