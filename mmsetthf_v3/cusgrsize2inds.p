...
thf(acusgrsizeinds_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : (((cwcel @ XG @ cccusgr) & (cwcel @ XV @ ccfn) & (cwcel @ XN @ XV)) => ((ccfv @ XE @ cchash) = (cco @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ (ccfv @ (XF @ Xe) @ cchash) @ ccaddc))))))))))))).
...
thf(ccusgrsize2inds_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > ($i > $o))] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : ((cwcel @ (XY @ Xe) @ ccn0) => (((cwcel @ XG @ cccusgr) & ((ccfv @ XV @ cchash) = (XY @ Xe)) & (cwcel @ XN @ XV)) => (((ccfv @ (XF @ Xe) @ cchash) = (cco @ (ccfv @ (ccdif @ XV @ (ccsn @ XN)) @ cchash) @ cc2 @ ccbc)) => ((ccfv @ XE @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccbc)))))))))))))))).
