...
thf(cerngmul_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XD = (ccfv @ XW @ (ccfv @ XK @ ccedring))) => ((Xc_x = (ccfv @ XD @ ccmulr)) => ((((cwcel @ XK @ XX) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XE) & (cwcel @ XV @ XE))) => ((cco @ XU @ XV @ Xc_x) = (cccom @ XU @ XV))))))))))))))))))).
