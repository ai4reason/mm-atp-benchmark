...
thf(ameaiuninc3v_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((! [Xn:$i] : (Xph => (cwcel @ (XN @ Xn) @ ccz))) => ((! [Xn:$i] : (XZ = (ccfv @ (XN @ Xn) @ ccuz))) => ((Xph => (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => (cwss @ (ccfv @ (ccv @ Xn) @ XE) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE)))) => ((! [Xn:$i] : ((XS @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => (! [Xn:$i] : (Xph => (cwbr @ (XS @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ cclsxlim)))))))))))))))).
...
thf(cmeaiuninc3_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : (((? [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X)) => (! [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X))) => ((cwnfc @ (^ [Xn:$i] : (XE @ Xn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XM @ ccmea))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (XN @ Xn) @ ccz))) => ((! [Xn:$i] : (XZ = (ccfv @ (XN @ Xn) @ ccuz))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ XZ @ (ccdm @ XM) @ (XE @ Xn)))) => ((! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xn) @ XZ)) => (cwss @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (XE @ Xn))))) => ((! [Xn:$i] : ((XS @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ XM))))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (XS @ Xn) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xn)))) @ XM) @ cclsxlim)))))))))))))))))).
