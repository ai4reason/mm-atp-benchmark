...
thf(cclwlkl1loop_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ (ccfv @ XG @ cciedg)) & (cwbr @ XF @ XP @ (ccfv @ XG @ ccclwlks)) & ((ccfv @ XF @ cchash) = cc1)) => (((ccfv @ ccc0 @ XP) = (ccfv @ cc1 @ XP)) & (cwcel @ (ccsn @ (ccfv @ ccc0 @ XP)) @ (ccfv @ XG @ ccedg)))))))).
