...
thf(aneggcd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (ccneg @ XM) @ XN @ ccgcd) = (cco @ XM @ XN @ ccgcd)))))).
...
thf(cnumdenneg_conj,conjecture,(! [XQ:($i > $o)] : ((cwcel @ XQ @ ccq) => (((ccfv @ (ccneg @ XQ) @ ccnumer) = (ccneg @ (ccfv @ XQ @ ccnumer))) & ((ccfv @ (ccneg @ XQ) @ ccdenom) = (ccfv @ XQ @ ccdenom)))))).
