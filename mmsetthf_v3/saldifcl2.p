...
thf(asaldifcl_thm,axiom,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (((cwcel @ XS @ ccsalg) & (cwcel @ XE @ XS)) => (cwcel @ (ccdif @ (ccuni @ XS) @ XE) @ XS))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asalincl_thm,axiom,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ ccsalg) & (cwcel @ XE @ XS) & (cwcel @ XF @ XS)) => (cwcel @ (ccin @ XE @ XF) @ XS)))))).
thf(csaldifcl2_conj,conjecture,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ ccsalg) & (cwcel @ XE @ XS) & (cwcel @ XF @ XS)) => (cwcel @ (ccdif @ XE @ XF) @ XS)))))).
