...
thf(awrd2ind_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [Xth:($i > ($i > ($i > ($i > $o))))] : (! [Xta:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xrh:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xs1:$i] : ((((ccv @ Xx3) = cc0) & ((ccv @ Xw) = cc0)) => ((Xph @ Xx3 @ Xw) <=> (Xps @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xs1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xs1:$i] : ((((ccv @ Xx3) = (ccv @ Xy1)) & ((ccv @ Xw) = (ccv @ Xu))) => ((Xph @ Xx3 @ Xw) <=> (Xch @ Xy1 @ Xz @ Xu @ Xs1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xs1:$i] : ((((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccs1 @ (ccv @ Xz)) @ ccconcat)) & ((ccv @ Xw) = (cco @ (ccv @ Xu) @ (ccs1 @ (ccv @ Xs1)) @ ccconcat))) => ((Xph @ Xx3 @ Xw) <=> (Xth @ Xy1 @ Xz @ Xu @ Xs1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xs1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1 @ Xz @ Xu @ Xs1)) => ((Xrh @ Xx3 @ Xy1 @ Xz @ Xu @ Xs1) <=> (Xta @ Xy1 @ Xz @ Xw @ Xu @ Xs1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xs1:$i] : (((ccv @ Xw) = (XB2 @ Xu @ Xs1)) => ((Xph @ Xx3 @ Xw) <=> (Xrh @ Xx3 @ Xy1 @ Xz @ Xu @ Xs1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xs1:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xs1))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xs1:$i] : ((((cwcel @ (ccv @ Xy1) @ (ccword @ XX)) & (cwcel @ (ccv @ Xz) @ XX)) & ((cwcel @ (ccv @ Xu) @ (ccword @ XY)) & (cwcel @ (ccv @ Xs1) @ XY)) & ((ccfv @ (ccv @ Xy1) @ cchash) = (ccfv @ (ccv @ Xu) @ cchash))) => ((Xch @ Xy1 @ Xz @ Xu @ Xs1) => (Xth @ Xy1 @ Xz @ Xu @ Xs1))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xs1:$i] : (((cwcel @ (XA2 @ Xy1 @ Xz @ Xu @ Xs1) @ (ccword @ XX)) & (cwcel @ (XB2 @ Xu @ Xs1) @ (ccword @ XY)) & ((ccfv @ (XA2 @ Xy1 @ Xz @ Xu @ Xs1) @ cchash) = (ccfv @ (XB2 @ Xu @ Xs1) @ cchash))) => (Xta @ Xy1 @ Xz @ Xw @ Xu @ Xs1))))))))))))))))))))))))).
