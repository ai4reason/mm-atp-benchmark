...
thf(algsdir2lem1_thm,axiom,((((cco @ cc1 @ cc8 @ ccmo) = cc1) & ((cco @ (ccneg @ cc1) @ cc8 @ ccmo) = cc7)) & (((cco @ cc3 @ cc8 @ ccmo) = cc3) & ((cco @ (ccneg @ cc3) @ cc8 @ ccmo) = cc5)))).
...
thf(clgsdir2lem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc3 @ cc5)) & (cwcel @ (cco @ XB2 @ cc8 @ ccmo) @ (ccpr @ cc3 @ cc5)))) => (cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))))).
