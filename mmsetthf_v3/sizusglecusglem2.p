...
thf(csizusglecusglem2_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XV = (ccfv @ XH @ ccvtx)) => ((XF = (ccfv @ XH @ ccedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XH @ cccusgr) & (cwcel @ XF @ ccfn)) => (cwcel @ XE @ ccfn)))))))))))).
