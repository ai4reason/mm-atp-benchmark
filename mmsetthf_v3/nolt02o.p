...
thf(cnolt02o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur) & (cwcel @ XX @ ccon0)) & (((ccres @ XA2 @ XX) = (ccres @ XB2 @ XX)) & (cwbr @ XA2 @ XB2 @ ccslt)) & ((ccfv @ XX @ XA2) = cc0)) => ((ccfv @ XX @ XB2) = cc2o)))))).
