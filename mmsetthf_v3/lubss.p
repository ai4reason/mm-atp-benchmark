...
thf(clubss_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XU = (ccfv @ XK @ cclub)) => (((cwcel @ XK @ cccla) & (cwss @ XT @ XB2) & (cwss @ XS @ XT)) => (cwbr @ (ccfv @ XS @ XU) @ (ccfv @ XT @ XU) @ Xc_le)))))))))))).
