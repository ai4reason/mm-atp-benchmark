...
thf(cfrlmbas3_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XR @ (ccxp @ XN @ XM) @ ccfrlm)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XV = (ccfv @ XF @ ccbs)) => ((((cwcel @ XR @ XW) & (cwcel @ XX @ XV)) & ((cwcel @ XN @ ccfn) & (cwcel @ XM @ ccfn)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XM))) => (cwcel @ (cco @ XI @ XJ @ XX) @ XB2)))))))))))))))).
