...
thf(cltgseg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (XP = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_mi = (ccfv @ (XG @ Xx3 @ Xy1) @ ccds)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XI @ Xx3 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccitv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_le @ Xx3 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccleg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ ccstrkg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccima @ Xc_mi @ (ccxp @ XP @ XP))))) => ((Xph => (cwfun @ Xc_mi)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XE @ Xx3 @ Xy1))))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XA2 = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP)))))))))))))))))))).
