...
thf(arankr1bg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & (cwcel @ XB2 @ (ccdm @ ccr1))) => ((cwss @ XA2 @ (ccfv @ XB2 @ ccr1)) <=> (cwss @ (ccfv @ XA2 @ ccrnk) @ XB2)))))).
thf(aeqsstr3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XB2 = XA2)) => ((Xph => (cwss @ XB2 @ XC)) => (Xph => (cwss @ XA2 @ XC))))))))).
thf(abiimpi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> Xps) => (Xph => Xps))))).
thf(arankonid_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) <=> ((ccfv @ XA2 @ ccrnk) = XA2)))).
thf(asylc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xps => (Xch => Xth)) => (Xph => Xth))))))))).
thf(aonssr1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) => (cwss @ XA2 @ (ccfv @ XA2 @ ccr1))))).
thf(arankssb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => ((cwss @ XA2 @ XB2) => (cwss @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk))))))).
...
thf(crankr1id_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) <=> ((ccfv @ (ccfv @ XA2 @ ccr1) @ ccrnk) = XA2)))).
