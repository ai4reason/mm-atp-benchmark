...
thf(cwlklenvclwlk_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) & (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ ccle)) => ((cwcel @ (ccop @ XF @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat)) @ (ccfv @ XG @ ccwlks)) => ((ccfv @ XF @ cchash) = (ccfv @ XW @ cchash)))))))).
