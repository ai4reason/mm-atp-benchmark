...
thf(adivcncff_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ XG @ (cco @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ cccncf))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (cco @ XX @ ccc @ cccncf)))))))))).
...
thf(cdvdivcncf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((Xph => (cwcel @ (cco @ XS @ XF @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ (cco @ XS @ XG @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => (Xph => (cwcel @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ ccdv) @ (cco @ XX @ ccc @ cccncf)))))))))))))).
