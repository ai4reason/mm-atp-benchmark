...
thf(crmxynorm_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1))))).
