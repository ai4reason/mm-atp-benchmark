...
thf(cerclwwlk_conj,conjecture,(! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : ((! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : ((Xc_sm @ Xw @ Xu @ Xn) = (ccopab @ (^ [Xu:$i] : (^ [Xw:$i] : ((cwcel @ (ccv @ Xu) @ (ccfv @ XG @ ccclwwlk)) & (cwcel @ (ccv @ Xw) @ (ccfv @ XG @ ccclwwlk)) & (cwrex @ (^ [Xn:$i] : ((ccv @ Xu) = (cco @ (ccv @ Xw) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xw) @ cchash) @ ccfz))))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xn:$i] : (cwer @ (ccfv @ XG @ ccclwwlk) @ (Xc_sm @ Xw @ Xu @ Xn))))))))).
