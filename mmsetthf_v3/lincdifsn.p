...
thf(agsumdifsnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ XG @ ccplusg))) => ((Xph => (cwcel @ XG @ cccmn)) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XW @ Xk)))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ (ccfv @ XG @ cc0g) @ ccfsupp)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XX @ Xk) @ XB2))) => ((Xph => (cwcel @ XM @ XA2)) => ((Xph => (cwcel @ XY @ XB2)) => ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XM)) => ((XX @ Xk) = XY))) => (! [Xk:$i] : (Xph => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) = (cco @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccdif @ XA2 @ (ccsn @ XM))) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ XY @ (Xc_pl @ Xk)))))))))))))))))))))))).
