...
thf(cfseq1m1p1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((XH = (ccsn @ (ccop @ XN @ XB2))) => ((cwcel @ XN @ ccn) => (((cwf @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ XA2 @ XF) & (cwcel @ XB2 @ XA2) & (XG = (ccun @ XF @ XH))) <=> ((cwf @ (cco @ cc1 @ XN @ ccfz) @ XA2 @ XG) & ((ccfv @ XN @ XG) = XB2) & (XF = (ccres @ XG @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))))))))))))).
