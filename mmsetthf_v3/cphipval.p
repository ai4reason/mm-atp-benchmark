...
thf(acphipval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((((cwcel @ XW @ cccph) & (cwcel @ cci @ XK)) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cco @ XA2 @ XB2 @ Xc_xi) = (cco @ (cco @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_mi) @ XN) @ cc2 @ ccexp) @ ccmin) @ (cco @ cci @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ Xc_x) @ Xc_pl) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ Xc_x) @ Xc_mi) @ XN) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ ccaddc) @ cc4 @ ccdiv))))))))))))))))))))))).
...
thf(anmsq_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XN = (ccfv @ XW @ ccnm)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV)) => ((cco @ (ccfv @ XA2 @ XN) @ cc2 @ ccexp) = (cco @ XA2 @ XA2 @ Xc_xi)))))))))))).
thf(arecnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ XA2 @ ccc)))))).
thf(areipcl_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV)) => (cwcel @ (cco @ XA2 @ XA2 @ Xc_xi) @ ccr))))))))).
thf(ccsubrg_tp,type,(ccsubrg : ($i > $o))).
thf(ccress_tp,type,(ccress : ($i > $o))).
thf(cccnfld_tp,type,(cccnfld : ($i > $o))).
thf(acphclm_thm,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cccph) => (cwcel @ XW @ ccclm)))).
thf(aclmneg1_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ ccclm) => (cwcel @ (ccneg @ cc1) @ XK)))))))).
...
thf(aclmvsneg_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XN = (ccfv @ XW @ ccminusg)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xph => (cwcel @ XW @ ccclm)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XR @ XK)) => (Xph => ((ccfv @ (cco @ XR @ XX @ Xc_x) @ XN) = (cco @ (ccneg @ XR) @ XX @ Xc_x))))))))))))))))))))).
...
thf(afsum1_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = XB2))) => (((cwcel @ XM @ ccz) & (cwcel @ XB2 @ ccc)) => ((ccsu @ (cco @ XM @ XM @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) = XB2))))))).
