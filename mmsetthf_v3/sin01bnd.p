...
thf(aresin4p_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccsin) = (cco @ (cco @ XA2 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc6 @ ccdiv) @ ccmin) @ (ccfv @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccim) @ ccaddc)))))))).
...
thf(csin01bnd_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) => ((cwbr @ (cco @ XA2 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ (ccfv @ XA2 @ ccsin) @ cclt) & (cwbr @ (ccfv @ XA2 @ ccsin) @ XA2 @ cclt))))).
