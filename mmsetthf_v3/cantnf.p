...
thf(aoemapso_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xw:$i] : ((XS @ Xw) = (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XA2 @ ccon0))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XB2 @ ccon0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) & (cwral @ (^ [Xw:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xw)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XB2)))) @ (^ [Xz:$i] : XB2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xw) => (cwor @ (XS @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))))).
...
thf(acantnflem4_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xd:$i] : ((XS @ Xw @ Xa @ Xb @ Xd) = (ccdm @ (cco @ XA2 @ (XB2 @ Xa @ Xb @ Xd) @ cccnf))))))) => ((! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xw @ Xa @ Xb @ Xc @ Xd) => (cwcel @ XA2 @ ccon0))))))) => ((! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xw @ Xa @ Xb @ Xc @ Xd) => (cwcel @ (XB2 @ Xa @ Xb @ Xd) @ ccon0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xd:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw @ Xa @ Xb @ Xd) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1))) & (cwral @ (^ [Xw:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xw)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : (XB2 @ Xa @ Xb @ Xd))))) @ (^ [Xz:$i] : (XB2 @ Xa @ Xb @ Xd)))))))))))))) => ((! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xw @ Xa @ Xb @ Xc @ Xd) => (cwcel @ XC @ (cco @ XA2 @ (XB2 @ Xa @ Xb @ Xd) @ ccoe)))))))) => ((! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xw @ Xa @ Xb @ Xc @ Xd) => (cwss @ XC @ (ccrn @ (cco @ XA2 @ (XB2 @ Xa @ Xb @ Xd) @ cccnf))))))))) => ((! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xw @ Xa @ Xb @ Xc @ Xd) => (cwcel @ cc0 @ XC))))))) => ((! [Xc:$i] : ((XX @ Xc) = (ccuni @ (ccint @ (ccrab @ (^ [Xc:$i] : (cwcel @ XC @ (cco @ XA2 @ (ccv @ Xc) @ ccoe))) @ (^ [Xc:$i] : ccon0)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XP @ Xx3 @ Xy1 @ Xz @ Xw @ Xa @ Xb @ Xc @ Xd) = (ccio @ (^ [Xd:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (((ccv @ Xd) = (ccop @ (ccv @ Xa) @ (ccv @ Xb))) & ((cco @ (cco @ (cco @ XA2 @ (XX @ Xc) @ ccoe) @ (ccv @ Xa) @ ccomu) @ (ccv @ Xb) @ ccoa) = XC))) @ (^ [Xb:$i] : (cco @ XA2 @ (XX @ Xc) @ ccoe)))) @ (^ [Xa:$i] : ccon0))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XY @ Xa @ Xb @ Xc @ Xd) = (ccfv @ (XP @ Xx3 @ Xy1 @ Xz @ Xw @ Xa @ Xb @ Xc @ Xd) @ cc1st)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XZ @ Xw @ Xa @ Xb @ Xc @ Xd) = (ccfv @ (XP @ Xx3 @ Xy1 @ Xz @ Xw @ Xa @ Xb @ Xc @ Xd) @ cc2nd)))))))))) => (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xw @ Xa @ Xb @ Xc @ Xd) => (cwcel @ XC @ (ccrn @ (cco @ XA2 @ (XB2 @ Xa @ Xb @ Xd) @ cccnf))))))))))))))))))))))))))))))).
...
thf(afczsupp0_thm,axiom,(! [XB2:($i > $o)] : (! [XZ:($i > $o)] : ((cco @ (ccxp @ XB2 @ (ccsn @ XZ)) @ XZ @ ccsupp) = cc0)))).
...
thf(afczfsuppd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ XZ @ XW)) => (Xph => (cwbr @ (ccxp @ XB2 @ (ccsn @ XZ)) @ XZ @ ccfsupp)))))))))).
...
thf(awe0_thm,axiom,(! [XR:($i > $o)] : (cwwe @ cc0 @ XR))).
...
thf(aeleq12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = XB2) & (XC = XD)) => ((cwcel @ XA2 @ XC) <=> (cwcel @ XB2 @ XD)))))))).
