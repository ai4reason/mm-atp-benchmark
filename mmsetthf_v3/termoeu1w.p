...
thf(atermoeu1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ cctermo))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XC @ cctermo))) => (Xph => (cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cciso)))))))))))))).
...
thf(atermoo_thm,axiom,(! [XC:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XC @ cccat) => ((cwcel @ XO @ (ccfv @ XC @ cctermo)) => (cwcel @ XO @ (ccfv @ XC @ ccbs))))))).
