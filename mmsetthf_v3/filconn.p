...
thf(afilunibas_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((ccuni @ XF) = XX))))).
...
thf(cfilconn_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => (cwcel @ (ccun @ XF @ (ccsn @ cc0)) @ ccconn))))).
