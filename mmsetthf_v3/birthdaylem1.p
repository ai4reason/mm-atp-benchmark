...
thf(amap0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((cco @ XA2 @ XB2 @ ccmap) = cc0) <=> ((XA2 = cc0) & (XB2 != cc0)))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cbirthdaylem1_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => ((! [Xf1:$i] : ((XT @ Xf1) = (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => (! [Xf1:$i] : ((cwss @ (XT @ Xf1) @ (XS @ Xf1)) & (cwcel @ (XS @ Xf1) @ ccfn) & ((cwcel @ XN @ ccn) => ((XS @ Xf1) != cc0))))))))))).
