...
thf(apwsdiaglmhm_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccxp @ XI @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XR @ cclmod) & (cwcel @ XI @ XW)) => (cwcel @ (XF @ Xx3) @ (cco @ XR @ XY @ cclmhm)))))))))))))).
...
thf(apwssnf1o_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ (ccsn @ XI) @ ccpws)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ XI) @ (ccsn @ (ccv @ Xx3))))))) => ((XC = (ccfv @ XY @ ccbs)) => (! [Xx3:$i] : (((cwcel @ XR @ (XV @ Xx3)) & (cwcel @ XI @ XW)) => (cwf1o @ XB2 @ XC @ (XF @ Xx3))))))))))))))))).
