...
thf(amulgaddcomlem_thm,axiom,(! [Xy1:$i] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ (ccv @ Xy1) @ ccz) & (cwcel @ XX @ XB2)) & ((cco @ (cco @ (ccv @ Xy1) @ XX @ Xc_x) @ XX @ Xc_pl) = (cco @ XX @ (cco @ (ccv @ Xy1) @ XX @ Xc_x) @ Xc_pl))) => ((cco @ (cco @ (ccneg @ (ccv @ Xy1)) @ XX @ Xc_x) @ XX @ Xc_pl) = (cco @ XX @ (cco @ (ccneg @ (ccv @ Xy1)) @ XX @ Xc_x) @ Xc_pl))))))))))))).
thf(cmulgaddcom_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XN @ ccz) & (cwcel @ XX @ XB2)) => ((cco @ (cco @ XN @ XX @ Xc_x) @ XX @ Xc_pl) = (cco @ XX @ (cco @ XN @ XX @ Xc_x) @ Xc_pl))))))))))))).
