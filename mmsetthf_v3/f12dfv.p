...
thf(adff14b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwf1 @ XA2 @ (XB2 @ Xx3 @ Xy1) @ XF) <=> ((cwf @ XA2 @ (XB2 @ Xx3 @ Xy1) @ XF) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xx3) @ XF) != (ccfv @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : (ccdif @ XA2 @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(cf12dfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccpr @ XX @ XY)) => ((((cwcel @ XX @ XU) & (cwcel @ XY @ XV)) & (XX != XY)) => ((cwf1 @ XA2 @ XB2 @ XF) <=> ((cwf @ XA2 @ XB2 @ XF) & ((ccfv @ XX @ XF) != (ccfv @ XY @ XF)))))))))))))).
