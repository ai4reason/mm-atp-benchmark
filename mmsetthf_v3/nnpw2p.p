...
thf(cnnpw2p_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xi:$i] : (cwrex @ (^ [Xr:$i] : (XN = (cco @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ (ccv @ Xr) @ ccaddc))) @ (^ [Xr:$i] : (cco @ ccc0 @ (cco @ cc2 @ (ccv @ Xi) @ ccexp) @ ccfzo)))) @ (^ [Xi:$i] : ccn0))))).
