...
thf(atrireciplem_thm,axiom,(! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ cc1) @ cc1 @ ccli))))).
...
thf(ctrirecip_conj,conjecture,((ccsu @ ccn @ (^ [Xk:$i] : (cco @ cc2 @ (cco @ (ccv @ Xk) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))) = cc2)).
