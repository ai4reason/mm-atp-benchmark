...
thf(aghmmulg_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_xp = (ccfv @ XH @ ccmg)) => (((cwcel @ XF @ (cco @ XG @ XH @ ccghm)) & (cwcel @ XN @ ccz) & (cwcel @ XX @ XB2)) => ((ccfv @ (cco @ XN @ XX @ Xc_x) @ XF) = (cco @ XN @ (ccfv @ XX @ XF) @ Xc_xp))))))))))))))).
...
thf(cdchrabs_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XX @ XD)) => ((XZ = (ccfv @ XN @ cczn)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XA2 @ XU)) => (Xph => ((ccfv @ (ccfv @ XA2 @ XX) @ ccabs) = cc1))))))))))))))))).
