...
thf(astirlinglem2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ (XN @ Xn) @ ccn) => (cwcel @ (ccfv @ (XN @ Xn) @ (XA2 @ Xn)) @ ccrp))))))).
