...
thf(ai1fmbf_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ XF @ ccmbf)))).
...
thf(a_0pledm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwfn @ XF @ XA2)) => (Xph => ((cwbr @ cc0p @ XF @ (ccofr @ ccle)) <=> (cwbr @ (ccxp @ XA2 @ (ccsn @ ccc0)) @ XF @ (ccofr @ ccle)))))))))).
...
thf(aitg2itg1_thm,axiom,(! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwbr @ cc0p @ XF @ (ccofr @ ccle))) => ((ccfv @ XF @ ccitg2) = (ccfv @ XF @ ccitg1))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(ccsu_tp,type,(ccsu : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aitg1cl_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (ccfv @ XF @ ccitg1) @ ccr)))).
thf(ai1fposd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccdm @ ccitg1))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (XA2 @ Xx3) @ ccle) @ (XA2 @ Xx3) @ ccc0))) @ (ccdm @ ccitg1))))))).
...
thf(ci1fibl_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ XF @ ccibl)))).
