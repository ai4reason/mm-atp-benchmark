...
thf(amul0ori_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (((cco @ XA2 @ XB2 @ ccmul) = ccc0) <=> ((XA2 = ccc0) | (XB2 = ccc0)))))))).
...
thf(csinhalfpilem_conj,conjecture,(((ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ ccsin) = cc1) & ((ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ cccos) = ccc0))).
