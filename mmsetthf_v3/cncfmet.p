...
thf(ccncfmet_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XA2 @ XA2))) => ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XB2 @ XB2))) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ XD @ ccmopn)) => (((cwss @ XA2 @ ccc) & (cwss @ XB2 @ ccc)) => ((cco @ XA2 @ XB2 @ cccncf) = (cco @ XJ @ XK @ cccn)))))))))))))).
