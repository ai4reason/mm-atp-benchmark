...
thf(acmmbl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) => (cwcel @ (ccdif @ ccr @ XA2) @ (ccdm @ ccvol))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ainmbl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ (ccdm @ ccvol))) => (cwcel @ (ccin @ XA2 @ XB2) @ (ccdm @ ccvol)))))).
thf(cdifmbl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ (ccdm @ ccvol))) => (cwcel @ (ccdif @ XA2 @ XB2) @ (ccdm @ ccvol)))))).
