...
thf(agrpinvhmeo_thm,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ cctgp) => (cwcel @ XI @ (cco @ XJ @ XJ @ cchmeo))))))))).
thf(cwf1o_tp,type,(cwf1o : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(atgplacthmeo_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ Xc_pl))))) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XJ = (ccfv @ XG @ cctopn)) => (! [Xx3:$i] : (((cwcel @ XG @ cctgp) & (cwcel @ XA2 @ XX)) => (cwcel @ (XF @ Xx3) @ (cco @ XJ @ XJ @ cchmeo))))))))))))))).
...
thf(agsumxp_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ XC @ (XW @ Xj @ Xk))))) => ((Xph => (cwf @ (ccxp @ XA2 @ XC) @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ XG @ (ccmpt @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (cco @ XG @ (ccmpt @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (cco @ (ccv @ Xj) @ (ccv @ Xk) @ XF))) @ ccgsu))) @ ccgsu)))))))))))))))))))).
...
thf(aablnncan_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cco @ XX @ (cco @ XX @ XY @ Xc_mi) @ Xc_mi) = XY)))))))))))))).
