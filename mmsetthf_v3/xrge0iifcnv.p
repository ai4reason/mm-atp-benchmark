...
thf(asnunioc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ ccle)) => ((ccun @ (ccsn @ XA2) @ (cco @ XA2 @ XB2 @ ccioc)) = (cco @ XA2 @ XB2 @ ccicc)))))).
...
thf(aiocssioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XD @ XB2 @ cclt))) => (cwss @ (cco @ XC @ XD @ ccioc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(aelioc1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc)) <=> ((cwcel @ XC @ ccxr) & (cwbr @ XA2 @ XC @ cclt) & (cwbr @ XC @ XB2 @ ccle)))))))).
...
thf(aubico_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccxr)) => (~ (cwcel @ XB2 @ (cco @ XA2 @ XB2 @ ccico))))))).
