...
thf(ccdleme31fv2_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccif @ ((XP != XQ) & (~ (cwbr @ (ccv @ Xx3) @ XW @ Xc_le))) @ (XO @ Xx3) @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XX @ XB2) & (~ ((XP != XQ) & (~ (cwbr @ XX @ XW @ Xc_le))))) => ((ccfv @ XX @ (XF @ Xx3)) = XX))))))))))))).
