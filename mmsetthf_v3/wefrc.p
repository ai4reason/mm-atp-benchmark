...
thf(aepfrc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (((cwfr @ XA2 @ ccep) & (cwss @ XB2 @ XA2) & (XB2 != cc0)) => (cwrex @ (^ [Xx3:$i] : ((ccin @ XB2 @ (ccv @ Xx3)) = cc0)) @ (^ [Xx3:$i] : XB2))))))).
...
thf(cwefrc_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : (((cwwe @ (XA2 @ Xx3) @ ccep) & (cwss @ XB2 @ (XA2 @ Xx3)) & (XB2 != cc0)) => (cwrex @ (^ [Xx3:$i] : ((ccin @ XB2 @ (ccv @ Xx3)) = cc0)) @ (^ [Xx3:$i] : XB2))))))).
