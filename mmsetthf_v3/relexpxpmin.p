...
thf(crelexpxpmin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV) & ((ccin @ XA2 @ XB2) != cc0)) & ((XI = (ccif @ (cwbr @ XJ @ XK @ cclt) @ XJ @ XK)) & (cwcel @ XJ @ ccn0) & (cwcel @ XK @ ccn0))) => ((cco @ (cco @ (ccxp @ XA2 @ XB2) @ XJ @ ccrelexp) @ XK @ ccrelexp) = (cco @ (ccxp @ XA2 @ XB2) @ XI @ ccrelexp))))))))))).
