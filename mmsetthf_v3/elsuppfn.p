...
thf(celsuppfn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (((cwfn @ XF @ XX) & (cwcel @ XX @ XV) & (cwcel @ XZ @ XW)) => ((cwcel @ XS @ (cco @ XF @ XZ @ ccsupp)) <=> ((cwcel @ XS @ XX) & ((ccfv @ XS @ XF) != XZ))))))))))).
