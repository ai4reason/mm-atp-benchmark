...
thf(cdford4_conj,conjecture,(! [XN:($i > $o)] : ((cword @ XN) <=> (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((cwcel @ (ccv @ Xa) @ XN) & (cwcel @ (ccv @ Xb) @ (ccv @ Xa))) => ((cwcel @ (ccv @ Xb) @ XN) & ((cwcel @ (ccv @ Xc) @ (ccv @ Xb)) => (cwcel @ (ccv @ Xc) @ (ccv @ Xa))))))))))).
