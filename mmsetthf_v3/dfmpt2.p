...
thf(ampt2mpts_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : ((ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))) = (ccmpt @ (^ [Xz:$i] : (ccxp @ XA2 @ XB2)) @ (^ [Xz:$i] : (ccsb @ (ccfv @ (ccv @ Xz) @ cc1st) @ (^ [Xx3:$i] : (ccsb @ (ccfv @ (ccv @ Xz) @ cc2nd) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))))))))).
thf(adfmpt_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => ((ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (XB2 @ Xx3)))))))))).
...
thf(aiunxpf_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwnfc @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) => ((XC @ Xx3 @ Xy1 @ Xz) = (XD @ Xx3 @ Xy1 @ Xz)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cciun @ (^ [Xx3:$i] : (ccxp @ (XA2 @ Xz) @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1 @ Xz))) = (cciun @ (^ [Xy1:$i] : (XA2 @ Xz)) @ (^ [Xy1:$i] : (cciun @ (^ [Xz:$i] : XB2) @ (^ [Xz:$i] : (XD @ Xx3 @ Xy1 @ Xz)))))))))))))))))).
