...
thf(crestperf_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XK = (cco @ XJ @ XY @ ccrest)) => (((cwcel @ XJ @ cctop) & (cwss @ XY @ XX)) => ((cwcel @ XK @ ccperf) <=> (cwss @ XY @ (ccfv @ XY @ (ccfv @ XJ @ cclp)))))))))))).
