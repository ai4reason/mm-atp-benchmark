...
thf(ciccpartgel_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccv @ Xi) @ XP) @ ccle)) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))).
