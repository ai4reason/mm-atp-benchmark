...
thf(cpythagtriplem10_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwcel @ XC @ ccn)) & ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp))) => (cwbr @ ccc0 @ (cco @ XC @ XB2 @ ccmin) @ cclt)))))).
