...
thf(awfrfun_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (cwfun @ XF))))))))).
...
thf(cwfrlem13_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : (XF = (ccwrecs @ XA2 @ XR @ (XG @ Xz)))) => ((! [Xz:$i] : ((XC @ Xz) = (ccun @ XF @ (ccsn @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ (XG @ Xz))))))) => (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ XF))) => (cwfn @ (XC @ Xz) @ (ccun @ (ccdm @ XF) @ (ccsn @ (ccv @ Xz)))))))))))))))).
