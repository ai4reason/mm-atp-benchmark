...
thf(cmetustbl_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XV @ (ccfv @ XD @ ccmetu)) & (cwcel @ XP @ XX)) => (cwrex @ (^ [Xa:$i] : ((cwcel @ XP @ (ccv @ Xa)) & (cwss @ (ccv @ Xa) @ (ccima @ XV @ (ccsn @ XP))))) @ (^ [Xa:$i] : (ccrn @ (ccfv @ XD @ ccbl)))))))))).
