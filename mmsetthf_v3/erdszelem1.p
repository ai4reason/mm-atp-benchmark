...
thf(cerdszelem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : ((cwiso @ (ccv @ Xy1) @ (ccima @ XF @ (ccv @ Xy1)) @ cclt @ XO @ (ccres @ XF @ (ccv @ Xy1))) & (cwcel @ XA2 @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (cco @ cc1 @ XA2 @ ccfz)))))) => (! [Xy1:$i] : ((cwcel @ XX @ (XS @ Xy1)) <=> ((cwss @ XX @ (cco @ cc1 @ XA2 @ ccfz)) & (cwiso @ XX @ (ccima @ XF @ XX) @ cclt @ XO @ (ccres @ XF @ XX)) & (cwcel @ XA2 @ XX))))))))))).
