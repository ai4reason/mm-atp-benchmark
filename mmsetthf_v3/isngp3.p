...
thf(aisngp2_thm,axiom,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccres @ XD @ (ccxp @ XX @ XX))) => ((cwcel @ XG @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ ccmt) & ((cccom @ XN @ Xc_mi) = XE))))))))))))))).
...
thf(anmf2_thm,axiom,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XW @ ccnm)) => ((XX = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccds)) => ((XE = (ccres @ XD @ (ccxp @ XX @ XX))) => (((cwcel @ XW @ ccgrp) & (cwcel @ XE @ (ccfv @ XX @ ccme))) => (cwf @ XX @ ccr @ XN)))))))))))).
...
thf(cisngp3_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => ((XX = (ccfv @ XG @ ccbs)) => ((cwcel @ XG @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ ccmt) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) = (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))))).
