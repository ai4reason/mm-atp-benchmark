...
thf(acrefeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((cccref @ XA2) = (cccref @ XB2)))))).
thf(adf_pcmp_ax,axiom,(ccpcmp = (^ [Xj:$i] : (cwcel @ (ccv @ Xj) @ (cccref @ (ccfv @ (ccv @ Xj) @ cclocfin)))))).
thf(cispcmp_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccpcmp) <=> (cwcel @ XJ @ (cccref @ (ccfv @ XJ @ cclocfin)))))).
