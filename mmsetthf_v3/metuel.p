...
thf(cmetuel_conj,conjecture,(! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xw:$i] : (! [Xa:$i] : ((((XX @ Xw) != cc0) & (cwcel @ XD @ (ccfv @ (XX @ Xw) @ ccpsmet))) => ((cwcel @ (XV @ Xa) @ (ccfv @ XD @ ccmetu)) <=> ((cwss @ (XV @ Xa) @ (ccxp @ (XX @ Xw) @ (XX @ Xw))) & (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xw) @ (XV @ Xa))) @ (^ [Xw:$i] : (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))))))))))))).
