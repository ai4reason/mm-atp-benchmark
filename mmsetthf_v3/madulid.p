...
thf(amattposm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((Xc_x = (ccfv @ XA2 @ ccmulr)) => (((cwcel @ XR @ cccrg) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cctpos @ (cco @ XX @ XY @ Xc_x)) = (cco @ (cctpos @ XY) @ (cctpos @ XX) @ Xc_x)))))))))))))).
thf(aoveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(amadutpos_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XJ = (cco @ XN @ XR @ ccmadu)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => ((ccfv @ (cctpos @ XM) @ XJ) = (cctpos @ (ccfv @ XM @ XJ)))))))))))))).
...
thf(amattpostpos_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((cwcel @ XM @ XB2) => ((cctpos @ (cctpos @ XM)) = XM)))))))))).
...
thf(amattposvs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XA2 @ ccvsca)) => (((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) => ((cctpos @ (cco @ XX @ XY @ Xc_x)) = (cco @ XX @ (cctpos @ XY) @ Xc_x)))))))))))))))).
...
thf(amattpos1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => ((cctpos @ Xc_1) = Xc_1))))))))).
