...
thf(adfii3_thm,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (ccii = (cco @ XJ @ (cco @ ccc0 @ cc1 @ ccicc) @ ccrest))))).
...
thf(ciimulcn_conj,conjecture,(cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul)))) @ (cco @ (cco @ ccii @ ccii @ cctx) @ ccii @ cccn))).
