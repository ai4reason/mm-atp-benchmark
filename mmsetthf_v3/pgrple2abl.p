...
thf(alt6abl_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwbr @ (ccfv @ XB2 @ cchash) @ cc6 @ cclt)) => (cwcel @ XG @ ccabl)))))).
thf(cpgrple2abl_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => (((cwcel @ XA2 @ XV) & (cwbr @ (ccfv @ XA2 @ cchash) @ cc2 @ ccle)) => (cwcel @ XG @ ccabl))))))).
