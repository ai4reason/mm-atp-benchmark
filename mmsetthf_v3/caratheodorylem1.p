...
thf(aiunxsng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = XC))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cciun @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = XC))))))))).
...
thf(ccaratheodorylem1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((Xph => (cwcel @ XO @ ccome)) => ((! [Xi:$i] : (! [Xn:$i] : ((XS @ Xi @ Xn) = (ccfv @ XO @ cccaragen)))) => ((! [Xi:$i] : ((XZ @ Xi) = (ccfv @ XM @ ccuz))) => ((! [Xi:$i] : (! [Xn:$i] : (Xph => (cwf @ (XZ @ Xi) @ (XS @ Xi @ Xn) @ XE)))) => ((! [Xi:$i] : (Xph => (cwdisj @ (^ [Xn:$i] : (XZ @ Xi)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))))) => ((! [Xi:$i] : (XG = (ccmpt @ (^ [Xn:$i] : (XZ @ Xi)) @ (^ [Xn:$i] : (cciun @ (^ [Xi:$i] : (cco @ XM @ (ccv @ Xn) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XE))))))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (Xph => ((ccfv @ (ccfv @ XN @ XG) @ XO) = (ccfv @ (ccmpt @ (^ [Xn:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XO))) @ ccsumge0))))))))))))))))))).
