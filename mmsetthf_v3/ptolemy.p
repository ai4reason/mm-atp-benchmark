...
thf(acosmpi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ XA2 @ ccpi @ ccmin) @ cccos) = (ccneg @ (ccfv @ XA2 @ cccos)))))).
...
thf(asinmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) = (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cccos) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccmin) @ cc2 @ ccdiv)))))).
...
thf(acosppi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ XA2 @ ccpi @ ccaddc) @ cccos) = (ccneg @ (ccfv @ XA2 @ cccos)))))).
...
thf(cptolemy_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ ccc) & (cwcel @ XD @ ccc)) & ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccaddc) = ccpi)) => ((cco @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) @ (cco @ (ccfv @ XC @ ccsin) @ (ccfv @ XD @ ccsin) @ ccmul) @ ccaddc) = (cco @ (ccfv @ (cco @ XB2 @ XC @ ccaddc) @ ccsin) @ (ccfv @ (cco @ XA2 @ XC @ ccaddc) @ ccsin) @ ccmul)))))))).
