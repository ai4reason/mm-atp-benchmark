...
thf(areslmhm2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => ((XL = (ccfv @ XT @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XU @ cclmhm)) & (cwcel @ XT @ cclmod) & (cwcel @ XX @ XL)) => (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)))))))))))).
thf(creslmhm2b_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => ((XL = (ccfv @ XT @ cclss)) => (((cwcel @ XT @ cclmod) & (cwcel @ XX @ XL) & (cwss @ (ccrn @ XF) @ XX)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) <=> (cwcel @ XF @ (cco @ XS @ XU @ cclmhm))))))))))))).
