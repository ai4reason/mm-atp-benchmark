...
thf(clnopmulsubi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => ((ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ ccmv) @ XT) = (cco @ (cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccsm) @ (ccfv @ XC @ XT) @ ccmv))))))))).
