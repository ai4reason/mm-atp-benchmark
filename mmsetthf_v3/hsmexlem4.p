...
thf(aituni0_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) => ((ccfv @ cc0 @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1))) = XA2))))))))).
thf(amp2an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (((Xph & Xps) => Xch) => Xch))))))).
thf(affun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfun @ XF)))))).
thf(awdomimag_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwfun @ XF) & (cwcel @ XA2 @ XV)) => (cwbr @ (ccima @ XF @ XA2) @ XA2 @ ccwdom)))))).
...
thf(ahsmexlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccoi @ XA2 @ ccep)) => (((cwss @ XA2 @ ccon0) & (cwbr @ XA2 @ XB2 @ ccwdom)) => (cwcel @ (ccdm @ XO) @ (ccfv @ (ccpw @ XB2) @ cchar)))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ahsmexlem7_thm,axiom,(! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((XH @ Xz) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ XX @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ XX) @ cchar)) @ ccom))) => (! [Xz:$i] : ((ccfv @ cc0 @ (XH @ Xz)) = (ccfv @ (ccpw @ XX) @ cchar))))))).
...
thf(aituniiun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xa)) => ((ccfv @ (ccsuc @ XB2) @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1))) = (cciun @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (ccfv @ XB2 @ (ccfv @ (ccv @ Xa) @ (XU @ Xx3 @ Xy1)))))))))))))))).
...
thf(ahsmexlem9_thm,axiom,(! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xa:$i] : ((! [Xz:$i] : ((XH @ Xz) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ XX @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ XX) @ cchar)) @ ccom))) => (! [Xz:$i] : ((cwcel @ (ccv @ Xa) @ ccom) => (cwcel @ (ccfv @ (ccv @ Xa) @ (XH @ Xz)) @ ccon0)))))))).
...
thf(atcss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwss @ XB2 @ XA2) => (cwss @ (ccfv @ XB2 @ cctc) @ (ccfv @ XA2 @ cctc))))))).
thf(amp1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((Xph => Xps) => (Xch => Xps))))))).
thf(atcel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ XA2) => (cwss @ (ccfv @ XB2 @ cctc) @ (ccfv @ XA2 @ cctc))))))).
...
thf(ahsmexlem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xa:$i] : ((XF @ Xa) = (ccoi @ (XB2 @ Xa) @ ccep))) => ((! [Xa:$i] : ((XG @ Xa) = (ccoi @ (cciun @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (XB2 @ Xa))) @ ccep))) => (! [Xa:$i] : ((((cwbr @ XA2 @ (XD @ Xa) @ ccwdom) & (cwcel @ XC @ ccon0)) & (cwral @ (^ [Xa:$i] : ((cwcel @ (XB2 @ Xa) @ (ccpw @ ccon0)) & (cwcel @ (ccdm @ (XF @ Xa)) @ XC))) @ (^ [Xa:$i] : XA2))) => (cwcel @ (ccdm @ (XG @ Xa)) @ (ccfv @ (ccpw @ (ccxp @ (XD @ Xa) @ XC)) @ cchar))))))))))))).
thf(ahsmexlem8_thm,axiom,(! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xa:$i] : ((! [Xz:$i] : ((XH @ Xz) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ XX @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ XX) @ cchar)) @ ccom))) => (! [Xz:$i] : ((cwcel @ (ccv @ Xa) @ ccom) => ((ccfv @ (ccsuc @ (ccv @ Xa)) @ (XH @ Xz)) = (ccfv @ (ccpw @ (ccxp @ XX @ (ccfv @ (ccv @ Xa) @ (XH @ Xz)))) @ cchar))))))))).
thf(chsmexlem4_conj,conjecture,(! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwcel @ (XX @ Xx3 @ Xy1 @ Xc @ Xd) @ ccvv))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XH @ Xx3 @ Xy1 @ Xz @ Xb) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ (XX @ Xx3 @ Xy1 @ Xc @ Xd) @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ (XX @ Xx3 @ Xy1 @ Xc @ Xd)) @ cchar)) @ ccom)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XU @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xa @ Xb) = (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwbr @ (ccv @ Xb) @ (XX @ Xx3 @ Xy1 @ Xc @ Xd) @ ccdom)) @ (^ [Xb:$i] : (ccfv @ (ccsn @ (ccv @ Xa)) @ cctc)))) @ (^ [Xa:$i] : (ccuni @ (ccima @ ccr1 @ ccon0)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XO @ Xx3 @ Xy1 @ Xz @ Xa @ Xb @ Xc @ Xd) = (ccoi @ (ccima @ ccrnk @ (ccfv @ (ccv @ Xc) @ (ccfv @ (ccv @ Xd) @ (XU @ Xx3 @ Xy1 @ Xz @ Xa @ Xb)))) @ ccep))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (((cwcel @ (ccv @ Xc) @ ccom) & (cwcel @ (ccv @ Xd) @ (XS @ Xx3 @ Xy1 @ Xz @ Xa @ Xb))) => (cwcel @ (ccdm @ (XO @ Xx3 @ Xy1 @ Xz @ Xa @ Xb @ Xc @ Xd)) @ (ccfv @ (ccv @ Xc) @ (XH @ Xx3 @ Xy1 @ Xz @ Xb)))))))))))))))))))))).
