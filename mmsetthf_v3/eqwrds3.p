...
thf(ceqwrds3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => ((XW = (ccs3 @ XA2 @ XB2 @ XC)) <=> (((ccfv @ XW @ cchash) = cc3) & (((ccfv @ ccc0 @ XW) = XA2) & ((ccfv @ cc1 @ XW) = XB2) & ((ccfv @ cc2 @ XW) = XC))))))))))).
