...
thf(adf_mvt_ax,axiom,(ccmvt = (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccrn @ (ccfv @ (ccv @ Xt) @ ccmty)))))).
...
thf(cmvtval_conj,conjecture,(! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XT @ ccmvt)) => ((XY = (ccfv @ XT @ ccmty)) => (XV = (ccrn @ XY)))))))).
