...
thf(cfmtnofac2_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XM @ ccn) & (cwbr @ XM @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => (cwrex @ (^ [Xk:$i] : (XM = (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc2 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))))).
