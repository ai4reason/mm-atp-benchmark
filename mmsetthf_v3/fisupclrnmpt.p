...
thf(cfisupclrnmpt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwor @ XA2 @ (XR @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ ccfn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (XB2 != cc0))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwcel @ (XC @ Xx3) @ XA2))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ XA2 @ (XR @ Xx3)) @ XA2)))))))))))))).
