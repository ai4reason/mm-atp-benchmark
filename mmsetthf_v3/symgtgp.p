...
thf(asymgtopn_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XX @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XX @ XV) => ((cco @ (ccfv @ (ccxp @ XX @ (ccsn @ (ccpw @ XX))) @ ccpt) @ XB2 @ ccrest) = (ccfv @ XG @ cctopn)))))))))).
...
thf(agrpplusf_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XF = (ccfv @ XG @ ccplusf)) => ((cwcel @ XG @ ccgrp) => (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ XF)))))))).
