...
thf(ccnpart_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) => (((cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle) & (cwnel @ (cco @ cci @ XA2 @ ccmul) @ ccrp)) <=> (~ ((cwbr @ ccc0 @ (ccfv @ (ccneg @ XA2) @ ccre) @ ccle) & (cwnel @ (cco @ cci @ (ccneg @ XA2) @ ccmul) @ ccrp))))))).
