...
thf(acphnmfval_thm,axiom,(! [Xc_xi:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XW @ ccnm))) => (! [Xx3:$i] : ((cwcel @ XW @ cccph) => ((XN @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccsqrt)))))))))))))).
thf(ccphnmf_conj,conjecture,(! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XN = (ccfv @ XW @ ccnm)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ cccph) => (cwf @ XV @ XK @ XN)))))))))))))).
