...
thf(cosumcllem11N_conj,conjecture,(! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((XC = (ccfv @ XK @ ccpscN)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XC) & (cwcel @ XY @ XC)) & ((cwss @ XX @ (ccfv @ XY @ Xc_pe)) & (XX != cc0))) => ((cco @ XX @ XY @ Xc_pl) = (ccfv @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ Xc_pe) @ Xc_pe))))))))))))).
