...
thf(asbctt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) & ((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)))) => ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3)) <=> (Xph @ Xx3)))))))).
thf(aequsb3_b_thm,axiom,(! [Xx3:$i] : (((^ [Xy1:$i] : ((ccv @ Xy1) = (ccv @ Xx3))) @ Xx3) <=> ((ccv @ Xx3) = (ccv @ Xx3))))).
...
thf(cmptsnunlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : ((! [Xu:$i] : ((XF @ Xu) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3)))))) => ((! [Xx3:$i] : (! [Xu:$i] : ((XR @ Xx3 @ Xu) = (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))) => (! [Xu:$i] : ((cwss @ XB2 @ XA2) => (XB2 = (ccuni @ (ccima @ (XF @ Xu) @ XB2)))))))))))).
