...
thf(chvsubass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => ((cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccmv) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccva) @ ccmv))))))).
