...
thf(cofdivrec_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccc @ XF) & (cwf @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((cco @ XF @ (cco @ (ccxp @ XA2 @ (ccsn @ cc1)) @ XG @ (ccof @ ccdiv)) @ (ccof @ ccmul)) = (cco @ XF @ XG @ (ccof @ ccdiv))))))))).
