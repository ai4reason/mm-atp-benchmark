...
thf(cegrsubgr_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XG @ XW) & (cwcel @ XS @ XU)) & (cwss @ (ccfv @ XS @ ccvtx) @ (ccfv @ XG @ ccvtx)) & ((cwfun @ (ccfv @ XS @ cciedg)) & ((ccfv @ XS @ ccedg) = cc0))) => (cwbr @ XS @ XG @ ccsubgr))))))).
