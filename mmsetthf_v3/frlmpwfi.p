...
thf(amapfien2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ Xc_0 @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ XB2 @ XA2 @ ccmap))))) => ((! [Xx3:$i] : ((XT @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XW @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ XD @ XC @ ccmap))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ XA2 @ XC @ ccen))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ XB2 @ XD @ ccen))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ Xc_0 @ XB2))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XW @ XD))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (XS @ Xx3) @ (XT @ Xx3) @ ccen))))))))))))))))))).
...
thf(aznhash_thm,axiom,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((cwcel @ XN @ ccn) => ((ccfv @ XB2 @ cchash) = XN)))))))).
...
thf(apwfi2en_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ cc0 @ ccfsupp)) @ (^ [Xy1:$i] : (cco @ cc2o @ XA2 @ ccmap))))) => (! [Xy1:$i] : ((cwcel @ XA2 @ XV) => (cwbr @ (XS @ Xy1) @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccen)))))))).
