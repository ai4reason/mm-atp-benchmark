...
thf(citg2leub_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) & (cwcel @ XA2 @ ccxr)) => ((cwbr @ (ccfv @ XF @ ccitg2) @ XA2 @ ccle) <=> (cwral @ (^ [Xg1:$i] : ((cwbr @ (ccv @ Xg1) @ XF @ (ccofr @ ccle)) => (cwbr @ (ccfv @ (ccv @ Xg1) @ ccitg1) @ XA2 @ ccle))) @ (^ [Xg1:$i] : (ccdm @ ccitg1)))))))).
