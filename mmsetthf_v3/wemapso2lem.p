...
thf(cwemapso2lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ XS) & (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XU @ Xx3 @ Xy1 @ Xz @ Xw) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XZ @ Xy1 @ Xz @ Xw) @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xy1 @ Xz @ Xw) @ XA2 @ ccmap)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz @ Xw)) & (cwor @ XA2 @ XR) & (cwor @ (XB2 @ Xy1 @ Xz @ Xw) @ XS)) & (cwcel @ (XZ @ Xy1 @ Xz @ Xw) @ (XW @ Xx3 @ Xy1 @ Xz @ Xw))) => (cwor @ (XU @ Xx3 @ Xy1 @ Xz @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))))))).
