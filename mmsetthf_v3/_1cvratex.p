...
thf(a_1cvrco_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2)) => ((cwbr @ XX @ Xc_1 @ XC) <=> (cwcel @ (ccfv @ XX @ Xc_pe) @ XA2)))))))))))))))).
...
thf(c_1cvratex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwbr @ XX @ Xc_1 @ XC)) => (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XX @ Xc_lt)) @ (^ [Xp:$i] : XA2)))))))))))))))).
