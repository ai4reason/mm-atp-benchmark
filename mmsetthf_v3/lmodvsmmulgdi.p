...
thf(clmodvsmmulgdi_conj,conjecture,(! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_ex = (ccfv @ XW @ ccmg)) => ((XE = (ccfv @ XF @ ccmg)) => (((cwcel @ XW @ cclmod) & ((cwcel @ XC @ XK) & (cwcel @ XN @ ccn0) & (cwcel @ XX @ XV))) => ((cco @ XN @ (cco @ XC @ XX @ Xc_x) @ Xc_ex) = (cco @ (cco @ XN @ XC @ XE) @ XX @ Xc_x)))))))))))))))))))).
