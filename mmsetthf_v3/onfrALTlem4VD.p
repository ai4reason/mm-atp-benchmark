...
thf(confrALTlem4VD_conj,conjecture,(! [Xa:$i] : (! [Xy1:$i] : ((cwsbc @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) & ((ccin @ (ccv @ Xa) @ (ccv @ Xx3)) = cc0))) @ (ccv @ Xy1)) <=> ((cwcel @ (ccv @ Xy1) @ (ccv @ Xa)) & ((ccin @ (ccv @ Xa) @ (ccv @ Xy1)) = cc0)))))).
