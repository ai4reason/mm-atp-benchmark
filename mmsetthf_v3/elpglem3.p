...
thf(celpglem3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xy1:$i] : ((? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ ccpg) & (cwcel @ (XA2 @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccxp @ (ccpw @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))))))) <=> ((cwcel @ (XA2 @ Xy1) @ (ccxp @ ccvv @ ccvv)) & (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ ccpg) & ((cwcel @ (ccfv @ (XA2 @ Xy1) @ cc1st) @ (ccpw @ (ccv @ Xx3))) & (cwcel @ (ccfv @ (XA2 @ Xy1) @ cc2nd) @ (ccpw @ (ccv @ Xx3))))))))))).
