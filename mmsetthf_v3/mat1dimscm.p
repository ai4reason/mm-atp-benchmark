...
thf(amat1dimbas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV) & (cwcel @ XX @ XB2)) => (cwcel @ (ccsn @ (ccop @ XO @ XX)) @ (ccfv @ XA2 @ ccbs)))))))))))))).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(ccfrlm_tp,type,(ccfrlm : ($i > $o))).
thf(amatvsca2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XA2 @ ccvsca)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((XC = (ccxp @ XN @ XN)) => (((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_x) = (cco @ (ccxp @ XC @ (ccsn @ XX)) @ XY @ (ccof @ Xc_xp))))))))))))))))))))).
...
thf(cmat1dimscm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ XX @ (ccsn @ (ccop @ XO @ XY)) @ (ccfv @ XA2 @ ccvsca)) = (ccsn @ (ccop @ XO @ (cco @ XX @ XY @ (ccfv @ XR @ ccmulr)))))))))))))))))).
