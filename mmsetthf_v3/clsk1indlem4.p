...
thf(adf3o2_thm,axiom,(cc3o = (cctp @ cc0 @ cc1o @ cc2o))).
...
thf(cclsk1indlem4_conj,conjecture,(! [XK:($i > ($i > ($i > $o)))] : ((! [Xs1:$i] : (! [Xr:$i] : ((XK @ Xs1 @ Xr) = (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr))))))) => (! [Xr:$i] : (cwral @ (^ [Xs1:$i] : ((ccfv @ (ccfv @ (ccv @ Xs1) @ (XK @ Xs1 @ Xr)) @ (XK @ Xs1 @ Xr)) = (ccfv @ (ccv @ Xs1) @ (XK @ Xs1 @ Xr)))) @ (^ [Xs1:$i] : (ccpw @ cc3o))))))).
