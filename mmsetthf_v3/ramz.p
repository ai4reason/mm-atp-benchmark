...
thf(aramz2_thm,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XM @ ccn) & (cwcel @ XR @ XV) & (cwf @ XR @ ccn0 @ XF)) & ((cwcel @ XC @ XR) & ((ccfv @ XC @ XF) = ccc0))) => ((cco @ XM @ XF @ ccram) = ccc0)))))))).
...
thf(a_0ram_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((((cwcel @ XR @ (XV @ Xy1)) & (XR != cc0) & (cwf @ XR @ ccn0 @ XF)) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccrn @ XF)))) @ (^ [Xx3:$i] : ccz))) => ((cco @ ccc0 @ XF @ ccram) = (ccsup @ (ccrn @ XF) @ ccr @ cclt)))))))).
...
thf(cramz_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XR @ XV) & (XR != cc0)) => ((cco @ XM @ (ccxp @ XR @ (ccsn @ ccc0)) @ ccram) = ccc0)))))).
