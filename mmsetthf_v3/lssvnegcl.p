...
thf(clssvnegcl_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ ccminusg)) => (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS) & (cwcel @ XX @ XU)) => (cwcel @ (ccfv @ XX @ XN) @ XU)))))))))).
