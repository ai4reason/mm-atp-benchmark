...
thf(aslwn0_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn) & (cwcel @ XP @ ccprime)) => ((cco @ XP @ XG @ ccslw) != cc0))))))).
