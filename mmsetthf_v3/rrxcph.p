...
thf(afrlmbasfsupp_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XB2 = (ccfv @ XF @ ccbs)) => (((cwcel @ XI @ XW) & (cwcel @ XX @ XB2)) => (cwbr @ XX @ Xc_0 @ ccfsupp))))))))))))).
...
thf(asylbb1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xph <=> Xch) => (Xps => Xch))))))).
thf(afconstfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> ((cwfn @ XF @ XA2) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = XB2)) @ (^ [Xx3:$i] : XA2)))))))).
thf(afconst2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> (XF = (ccxp @ XA2 @ (ccsn @ XB2))))))))).
...
thf(afrlm0_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XW)) => ((ccxp @ XI @ (ccsn @ Xc_0)) = (ccfv @ XF @ cc0g))))))))))).
...
thf(crrxcph_conj,conjecture,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XH = (ccfv @ XI @ ccrrx)) => ((XB2 = (ccfv @ XH @ ccbs)) => ((cwcel @ XI @ XV) => (cwcel @ XH @ cccph))))))))).
