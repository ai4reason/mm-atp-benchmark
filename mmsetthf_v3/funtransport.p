...
thf(aaxdimuniq_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn) & (cwcel @ XA2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XM @ ccn) & (cwcel @ XA2 @ (ccfv @ XM @ ccee)))) => (XN = XM)))))).
...
thf(cfuntransport_conj,conjecture,(cwfun @ cctransport)).
