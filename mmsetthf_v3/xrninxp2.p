...
thf(cxrninxp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccin @ (ccxrn @ XR @ XS) @ (ccxp @ XA2 @ (ccxp @ XB2 @ XC))) = (ccopab @ (^ [Xu:$i] : (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccxp @ XB2 @ XC)) & ((cwcel @ (ccv @ Xu) @ XA2) & (cwbr @ (ccv @ Xu) @ (ccv @ Xx3) @ (ccxrn @ XR @ XS)))))))))))))).
