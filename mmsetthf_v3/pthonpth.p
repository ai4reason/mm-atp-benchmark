...
thf(atrlontrl_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) => (cwbr @ XF @ XP @ (cco @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP) @ (ccfv @ XG @ cctrlson)))))))).
...
thf(cpthonpth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) => (cwbr @ XF @ XP @ (cco @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP) @ (ccfv @ XG @ ccpthson)))))))).
