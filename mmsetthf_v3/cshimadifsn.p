...
thf(ccshimadifsn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XF @ (ccword @ XS)) & (XN = (ccfv @ XF @ cchash)) & (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo))) => ((ccima @ XF @ (ccdif @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XJ))) = (ccima @ (cco @ XF @ XJ @ cccsh) @ (cco @ cc1 @ XN @ ccfzo))))))))).
