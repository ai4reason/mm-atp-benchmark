...
thf(cdmdbr6ati_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : ((ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccv @ Xx3)) = (ccin @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccat)))))))).
