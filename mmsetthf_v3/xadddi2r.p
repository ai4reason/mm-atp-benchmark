...
thf(cxadddi2r_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ ccle)) & ((cwcel @ XB2 @ ccxr) & (cwbr @ ccc0 @ XB2 @ ccle)) & (cwcel @ XC @ ccxr)) => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxmu) = (cco @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccxad))))))).
