...
thf(abcpascm1_thm,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XK @ ccz)) => ((cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ (cco @ XK @ cc1 @ ccmin) @ ccbc) @ ccaddc) = (cco @ XN @ XK @ ccbc)))))).
