...
thf(celpaddatriN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((((cwcel @ XK @ cclat) & (cwss @ XX @ XA2) & (cwcel @ XQ @ XA2)) & ((cwcel @ XR @ XX) & (cwcel @ XS @ XA2) & (cwbr @ XS @ (cco @ XR @ XQ @ Xc_or) @ Xc_le))) => (cwcel @ XS @ (cco @ XX @ (ccsn @ XQ) @ Xc_pl))))))))))))))))).
