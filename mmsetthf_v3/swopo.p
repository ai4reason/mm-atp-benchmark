...
thf(cswopo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xy1) @ XA2) & (cwcel @ (ccv @ Xz) @ XA2))) => ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR) => (~ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2) & (cwcel @ (ccv @ Xz) @ XA2))) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) | (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR))))))) => (Xph => (cwpo @ XA2 @ XR)))))))).
