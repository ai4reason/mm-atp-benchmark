...
thf(agexdvdsi_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwbr @ XE @ XN @ ccdvds)) => ((cco @ XN @ XA2 @ Xc_x) = Xc_0)))))))))))))).
...
thf(cgex2abl_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => (((cwcel @ XG @ ccgrp) & (cwbr @ XE @ cc2 @ ccdvds)) => (cwcel @ XG @ ccabl)))))))).
