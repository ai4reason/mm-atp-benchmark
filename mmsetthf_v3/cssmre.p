...
thf(acss1_thm,axiom,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ ccphl) => (cwcel @ XV @ XC)))))))).
...
thf(ccssmre_conj,conjecture,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ ccphl) => (cwcel @ XC @ (ccfv @ XV @ ccmre))))))))).
