...
thf(adf_singleton_ax,axiom,(ccsingle = (ccdif @ (ccxp @ ccvv @ ccvv) @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ ccid @ ccvv)))))).
...
thf(cbrsingle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccsingle) <=> (XB2 = (ccsn @ XA2)))))))).
