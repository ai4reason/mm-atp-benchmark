...
thf(adihord2a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((XJ = (ccfv @ XW @ (ccfv @ XK @ ccdic))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) & ((cwcel @ XR @ XA2) & (~ (cwbr @ XR @ XW @ Xc_le)))) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & (((cco @ XQ @ (cco @ XX @ XW @ Xc_an) @ Xc_or) = XX) & ((cco @ XR @ (cco @ XY @ XW @ Xc_an) @ Xc_or) = XY) & (cwss @ (cco @ (ccfv @ XQ @ XJ) @ (ccfv @ (cco @ XX @ XW @ Xc_an) @ XI) @ Xc_po) @ (cco @ (ccfv @ XR @ XJ) @ (ccfv @ (cco @ XY @ XW @ Xc_an) @ XI) @ Xc_po)))) => (cwbr @ XQ @ (cco @ XR @ (cco @ XY @ XW @ Xc_an) @ Xc_or) @ Xc_le))))))))))))))))))))))))))))).
