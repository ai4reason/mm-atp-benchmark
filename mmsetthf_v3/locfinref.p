...
thf(clocfinref_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : ((XX @ Xf1) = (ccuni @ XJ))) => ((Xph => (cwss @ XU @ XJ)) => ((! [Xf1:$i] : (Xph => ((XX @ Xf1) = (ccuni @ XU)))) => ((Xph => (cwss @ XV @ XJ)) => ((Xph => (cwbr @ XV @ XU @ ccref)) => ((Xph => (cwcel @ XV @ (ccfv @ XJ @ cclocfin))) => (Xph => (? [Xf1:$i] : ((cwf @ XU @ XJ @ (ccv @ Xf1)) & (cwbr @ (ccrn @ (ccv @ Xf1)) @ XU @ ccref) & (cwcel @ (ccrn @ (ccv @ Xf1)) @ (ccfv @ XJ @ cclocfin))))))))))))))))).
