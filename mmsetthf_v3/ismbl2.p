...
thf(aismbl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccr) => ((ccfv @ (ccv @ Xx3) @ ccovol) = (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccaddc)))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
...
thf(cismbl2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccr) => (cwbr @ (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccaddc) @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccle))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
