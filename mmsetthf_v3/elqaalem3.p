...
thf(aelqaalem2_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xn) => (cwcel @ XA2 @ ccc))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xn) => (cwcel @ (XF @ Xx3 @ Xy1 @ Xk @ Xn) @ (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xn) => ((ccfv @ XA2 @ (XF @ Xx3 @ Xy1 @ Xk @ Xn)) = ccc0)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ (XF @ Xx3 @ Xy1 @ Xk @ Xn) @ cccoe)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XN = (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccinf @ (ccrab @ (^ [Xn:$i] : (cwcel @ (cco @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xx3 @ Xy1)) @ (ccv @ Xn) @ ccmul) @ ccz)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XR @ Xx3 @ Xy1 @ Xn) = (ccfv @ (ccfv @ (XF @ Xx3 @ Xy1 @ Xk @ Xn) @ ccdgr) @ (ccseq @ ccmul @ XN @ ccc0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XP @ Xx3 @ Xy1 @ Xk @ Xn) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ (ccfv @ XK @ XN) @ ccmo))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xx3 @ Xy1 @ Xn) & (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ (XF @ Xx3 @ Xy1 @ Xk @ Xn) @ ccdgr) @ ccfz))) => ((cco @ (XR @ Xx3 @ Xy1 @ Xn) @ (ccfv @ XK @ XN) @ ccmo) = ccc0)))))))))))))))))))))).
