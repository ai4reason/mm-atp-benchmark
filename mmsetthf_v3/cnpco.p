...
thf(acnpf_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) => (cwf @ XX @ XY @ XF))))))))))).
...
thf(ccnpco_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) & (cwcel @ XG @ (ccfv @ (ccfv @ XP @ XF) @ (cco @ XK @ XL @ cccnp)))) => (cwcel @ (cccom @ XG @ XF) @ (ccfv @ XP @ (cco @ XJ @ XL @ cccnp))))))))))).
