...
thf(areef11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (((ccfv @ XA2 @ cce) = (ccfv @ XB2 @ cce)) <=> (XA2 = XB2)))))).
...
thf(cabsefib_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XA2 @ ccr) <=> ((ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccabs) = cc1))))).
