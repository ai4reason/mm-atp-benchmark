...
thf(avonn0ioo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (XX != cc0)) => ((Xph => (cwf @ XX @ ccr @ XA2)) => ((Xph => (cwf @ XX @ ccr @ XB2)) => ((! [Xk:$i] : ((XI @ Xk) = (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccioo))))) => (! [Xk:$i] : (Xph => ((ccfv @ (XI @ Xk) @ (ccfv @ XX @ ccvoln)) = (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccico) @ ccvol))))))))))))))))).
...
thf(acbvprod_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (ccv @ Xk)) => ((XB2 @ Xj @ Xk) = (XC @ Xj @ Xk))))) => ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XA2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XA2 @ Xj @ Xk)))) => ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XB2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XC @ Xj @ Xk)))) => (! [Xj:$i] : (! [Xk:$i] : ((ccprod @ (^ [Xj:$i] : (XA2 @ Xj @ Xk)) @ (^ [Xj:$i] : (XB2 @ Xj @ Xk))) = (ccprod @ (^ [Xk:$i] : (XA2 @ Xj @ Xk)) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))))))))))))).
thf(anffv_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccfv @ (XA2 @ Xx3) @ (XF @ Xx3))))))))).
thf(cvonn0ioo2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XX @ ccfn))) => ((! [Xk:$i] : ((Xph @ Xk) => (XX != cc0))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XX)) => (cwcel @ (XA2 @ Xk) @ ccr))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XX)) => (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : ((XI @ Xk) = (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccioo))))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ (XI @ Xk) @ (ccfv @ XX @ ccvoln)) = (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccioo) @ ccvol)))))))))))))))))).
