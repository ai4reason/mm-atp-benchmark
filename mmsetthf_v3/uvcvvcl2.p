...
thf(cuvcvvcl2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XU = (cco @ XR @ XI @ ccuvc)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XJ @ XI)) => ((Xph => (cwcel @ XK @ XI)) => (Xph => (cwcel @ (ccfv @ XK @ (ccfv @ XJ @ XU)) @ XB2))))))))))))))))).
