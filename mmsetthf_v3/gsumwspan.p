...
thf(cgsumwspan_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XK = (ccfv @ (ccfv @ XM @ ccsubmnd) @ ccmrc)) => (((cwcel @ XM @ ccmnd) & (cwss @ XG @ XB2)) => ((ccfv @ XG @ XK) = (ccrn @ (ccmpt @ (^ [Xw:$i] : (ccword @ XG)) @ (^ [Xw:$i] : (cco @ XM @ (ccv @ Xw) @ ccgsu))))))))))))).
