...
thf(aclwwlknon1_thm,axiom,(! [XC:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : ((XC @ Xw) = (ccfv @ XG @ ccclwwlknon))) => ((! [Xw:$i] : ((XE @ Xw) = (ccfv @ XG @ ccedg))) => (! [Xw:$i] : ((cwcel @ XX @ XV) => ((cco @ XX @ cc1 @ (XC @ Xw)) = (ccrab @ (^ [Xw:$i] : (((ccv @ Xw) = (ccs1 @ XX)) & (cwcel @ (ccsn @ XX) @ (XE @ Xw)))) @ (^ [Xw:$i] : (ccword @ XV))))))))))))))).
...
thf(cclwwlknon1nloop_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XC = (ccfv @ XG @ ccclwwlknon)) => ((XE = (ccfv @ XG @ ccedg)) => ((cwnel @ (ccsn @ XX) @ XE) => ((cco @ XX @ cc1 @ XC) = cc0))))))))))).
