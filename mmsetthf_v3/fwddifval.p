...
thf(cfwddifval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XX @ XA2)) => ((Xph => (cwcel @ (cco @ XX @ cc1 @ ccaddc) @ XA2)) => (Xph => ((ccfv @ XX @ (ccfv @ XF @ ccfwddif)) = (cco @ (ccfv @ (cco @ XX @ cc1 @ ccaddc) @ XF) @ (ccfv @ XX @ XF) @ ccmin)))))))))))).
