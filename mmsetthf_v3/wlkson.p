...
thf(cwlkson_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((cco @ XA2 @ XB2 @ (ccfv @ XG @ ccwlkson)) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) & ((ccfv @ ccc0 @ (ccv @ Xp)) = XA2) & ((ccfv @ (ccfv @ (ccv @ Xf1) @ cchash) @ (ccv @ Xp)) = XB2))))))))))))).
