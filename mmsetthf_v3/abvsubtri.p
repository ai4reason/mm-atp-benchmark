...
thf(cabvsubtri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => (((cwcel @ XF @ XA2) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => (cwbr @ (ccfv @ (cco @ XX @ XY @ Xc_mi) @ XF) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccaddc) @ ccle))))))))))))).
