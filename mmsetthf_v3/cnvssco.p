...
thf(ccnvssco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ (cccnv @ XA2) @ (cccnv @ (cccom @ XB2 @ XC))) <=> (! [Xx3:$i] : (! [Xy1:$i] : (? [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XC) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XB2))))))))))).
