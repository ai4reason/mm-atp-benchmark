...
thf(adia2dimlem4_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) => ((Xph => (cwcel @ XF @ XT)) => ((Xph => (cwcel @ XG @ XT)) => ((Xph => ((ccfv @ XP @ XG) = XQ)) => ((Xph => (cwcel @ XD @ XT)) => ((Xph => ((ccfv @ XQ @ XD) = (ccfv @ XP @ XF))) => (Xph => ((cccom @ XD @ XG) = XF)))))))))))))))))))))))))).
...
thf(adia1dim2_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdveca))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((XN = (ccfv @ XU @ cclspn)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT)) => ((ccfv @ (ccfv @ XF @ XR) @ XI) = (ccfv @ (ccsn @ XF) @ XN))))))))))))))))))).
