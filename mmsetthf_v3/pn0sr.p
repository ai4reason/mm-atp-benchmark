...
thf(adistrsr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cco @ XA2 @ (cco @ XB2 @ XC @ ccplr) @ ccmr) = (cco @ (cco @ XA2 @ XB2 @ ccmr) @ (cco @ XA2 @ XC @ ccmr) @ ccplr)))))).
thf(aoveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(am1p1sr_thm,axiom,((cco @ ccm1r @ cc1r @ ccplr) = cc0r)).
