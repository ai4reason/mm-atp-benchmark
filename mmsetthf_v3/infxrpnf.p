...
thf(ainfsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XB2 @ XA2)) => ((ccinf @ (ccsn @ XB2) @ XA2 @ XR) = XB2)))))).
...
thf(cinfxrpnf_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccinf @ (ccun @ XA2 @ (ccsn @ ccpnf)) @ ccxr @ cclt) = (ccinf @ XA2 @ ccxr @ cclt))))).
