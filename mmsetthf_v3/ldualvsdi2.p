...
thf(cldualvsdi2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccfv @ XW @ cclfn)) => ((XR = (ccfv @ XW @ ccsca)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((XK = (ccfv @ XR @ ccbs)) => ((XD = (ccfv @ XW @ ccld)) => ((Xc_pb = (ccfv @ XD @ ccplusg)) => ((Xc_x = (ccfv @ XD @ ccvsca)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XX @ XK)) => ((Xph => (cwcel @ XY @ XK)) => ((Xph => (cwcel @ XG @ XF)) => (Xph => ((cco @ (cco @ XX @ XY @ Xc_pl) @ XG @ Xc_x) = (cco @ (cco @ XX @ XG @ Xc_x) @ (cco @ XY @ XG @ Xc_x) @ Xc_pb))))))))))))))))))))))))))).
