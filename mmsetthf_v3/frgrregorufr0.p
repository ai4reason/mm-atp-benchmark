...
thf(afrgrwopreg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XA2 = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XD) = XK)) @ (^ [Xx3:$i] : XV))) => ((XB2 = (ccdif @ XV @ XA2)) => ((cwcel @ XG @ ccfrgr) => ((((ccfv @ XA2 @ cchash) = cc1) | (XA2 = cc0)) | (((ccfv @ XB2 @ cchash) = cc1) | (XB2 = cc0))))))))))))))).
...
thf(cfrgrregorufr0_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : ((XE @ Xw) = (ccfv @ XG @ ccedg))) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((cwcel @ XG @ ccfrgr) => ((cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ XD) = XK)) @ (^ [Xv:$i] : XV)) | (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ XD) != XK)) @ (^ [Xv:$i] : XV)) | (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ (XE @ Xw))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))))).
