...
thf(cprdspjmhm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (XY = (cco @ (XS @ Xx3) @ XR @ ccprds))) => ((XB2 = (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XI @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XS @ Xx3) @ (XX @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwf @ (XI @ Xx3) @ ccmnd @ XR))) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XI @ Xx3)))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccv @ Xx3)))) @ (cco @ XY @ (ccfv @ XA2 @ XR) @ ccmhm))))))))))))))))))).
