...
thf(cltpsrpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnr) => ((cwbr @ (cco @ XC @ (ccec @ (ccop @ XA2 @ cc1p) @ ccer) @ ccplr) @ (cco @ XC @ (ccec @ (ccop @ XB2 @ cc1p) @ ccer) @ ccplr) @ ccltr) <=> (cwbr @ XA2 @ XB2 @ ccltp))))))).
