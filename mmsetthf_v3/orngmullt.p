...
thf(corngmullt_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_lt = (ccfv @ XR @ ccplt)) => ((Xph => (cwcel @ XR @ ccorng)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwbr @ Xc_0 @ XX @ Xc_lt)) => ((Xph => (cwbr @ Xc_0 @ XY @ Xc_lt)) => (Xph => (cwbr @ Xc_0 @ (cco @ XX @ XY @ Xc_x) @ Xc_lt))))))))))))))))))))).
