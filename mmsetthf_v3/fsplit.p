...
thf(adfid2_thm,axiom,(ccid = (ccopab_b @ (^ [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))))).
...
thf(cfsplit_conj,conjecture,((cccnv @ (ccres @ cc1st @ ccid)) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccop @ (ccv @ Xx3) @ (ccv @ Xx3)))))).
