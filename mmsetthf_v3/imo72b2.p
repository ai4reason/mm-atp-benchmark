...
thf(alemuldiv3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwbr @ (cco @ XB2 @ XA2 @ ccmul) @ XC @ ccle)) => ((Xph => (cwbr @ ccc0 @ XA2 @ cclt)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccdiv) @ ccle)))))))))))).
...
thf(afco2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((Xph => (cwf @ XB2 @ XC @ (ccres @ XF @ XB2))) => (Xph => (cwf @ XA2 @ XC @ (cccom @ XF @ XG)))))))))))).
...
thf(awnefimgd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 != cc0)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => (Xph => ((ccima @ XF @ XA2) != cc0))))))))).
...
thf(aextoimad_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ XC @ ccle)) @ (^ [Xy1:$i] : ccr))) => (Xph => (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XC @ ccle)) @ (^ [Xx3:$i] : (ccima @ ccabs @ (ccima @ XF @ ccr))))))))))).
thf(alemuldiv4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccdiv) @ ccle)) => ((Xph => (cwbr @ ccc0 @ XA2 @ cclt)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => (cwbr @ (cco @ XB2 @ XA2 @ ccmul) @ XC @ ccle)))))))))))).
thf(aimo72b2lem2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccabs) @ XC @ ccle)) @ (^ [Xz:$i] : ccr))) => (Xph => (cwbr @ (ccsup @ (ccima @ ccabs @ (ccima @ XF @ ccr)) @ ccr @ cclt) @ XC @ ccle))))))))).
...
thf(arspcdvinvd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((Xps @ Xx3) <=> Xch))) => ((Xph => (cwcel @ XA2 @ XB2)) => ((Xph => (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2))) => (Xph => Xch)))))))))).
...
thf(aimo72b2lem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) != ccc0)) @ (^ [Xx3:$i] : ccr))) => ((Xph => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ cc1 @ ccle)) @ (^ [Xy1:$i] : ccr))) => (Xph => (cwbr @ ccc0 @ (ccsup @ (ccima @ ccabs @ (ccima @ XF @ ccr)) @ ccr @ cclt) @ cclt)))))))).
