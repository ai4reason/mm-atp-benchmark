...
thf(awfrlem8_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (((ccpred @ (ccdif @ XA2 @ (ccdm @ XF)) @ XR @ XX) = cc0) <=> ((ccpred @ XA2 @ XR @ XX) = (ccpred @ (ccdm @ XF) @ XR @ XX)))))))))).
