...
thf(cissald_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : (Xph => (cwcel @ XS @ (XV @ Xy1)))) => ((Xph => (cwcel @ cc0 @ XS)) => ((! [Xy1:$i] : ((XX @ Xy1) = (ccuni @ XS))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XS)) => (cwcel @ (ccdif @ (XX @ Xy1) @ (ccv @ Xy1)) @ XS))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ (ccpw @ XS)) & (cwbr @ (ccv @ Xy1) @ ccom @ ccdom)) => (cwcel @ (ccuni @ (ccv @ Xy1)) @ XS))) => (Xph => (cwcel @ XS @ ccsalg)))))))))))).
