...
thf(aisercolllem2_thm,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwf @ ccn @ (XZ @ Xk) @ XG))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt))) => ((Xph & (cwcel @ XN @ (ccfv @ (ccfv @ cc1 @ XG) @ ccuz))) => ((cco @ cc1 @ (ccfv @ (ccima @ XG @ (ccima @ (cccnv @ XG) @ (cco @ XM @ XN @ ccfz))) @ cchash) @ ccfz) = (ccima @ (cccnv @ XG) @ (cco @ XM @ XN @ ccfz)))))))))))))).
