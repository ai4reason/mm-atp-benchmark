...
thf(asinadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ ccsin) = (cco @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ cccos) @ ccmul) @ (cco @ (ccfv @ XA2 @ cccos) @ (ccfv @ XB2 @ ccsin) @ ccmul) @ ccaddc)))))).
...
thf(atancld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((ccfv @ XA2 @ cccos) != ccc0)) => (Xph => (cwcel @ (ccfv @ XA2 @ cctan) @ ccc))))))).
...
thf(atanaddlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & (((ccfv @ XA2 @ cccos) != ccc0) & ((ccfv @ XB2 @ cccos) != ccc0))) => (((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) != ccc0) <=> ((cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) != cc1)))))).
...
thf(ctanadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & (((ccfv @ XA2 @ cccos) != ccc0) & ((ccfv @ XB2 @ cccos) != ccc0) & ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) != ccc0))) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cctan) = (cco @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccaddc) @ (cco @ cc1 @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) @ ccmin) @ ccdiv)))))).
