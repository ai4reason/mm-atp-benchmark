...
thf(csmatvscl_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XS = (cco @ XN @ XR @ ccscmat)) => ((Xc_as = (ccfv @ XA2 @ ccvsca)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ XC @ XK) & (cwcel @ XX @ XS))) => (cwcel @ (cco @ XC @ XX @ Xc_as) @ XS))))))))))))))).
