...
thf(cel0ldep_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : ((((cwcel @ XM @ cclmod) & (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs) @ cchash) @ cclt)) & (cwcel @ XS @ (ccpw @ (ccfv @ XM @ ccbs))) & (cwcel @ (ccfv @ XM @ cc0g) @ XS)) => (cwbr @ XS @ XM @ cclindeps))))).
