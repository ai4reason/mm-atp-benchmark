...
thf(clmhmlin_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XK = (ccfv @ XS @ ccsca)) => ((XB2 = (ccfv @ XK @ ccbs)) => ((XE = (ccfv @ XS @ ccbs)) => ((Xc_x = (ccfv @ XS @ ccvsca)) => ((Xc_xp = (ccfv @ XT @ ccvsca)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XE)) => ((ccfv @ (cco @ XX @ XY @ Xc_x) @ XF) = (cco @ XX @ (ccfv @ XY @ XF) @ Xc_xp))))))))))))))))))).
