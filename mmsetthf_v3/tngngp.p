...
thf(atngngp2_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XX = (ccfv @ XG @ ccbs)) => ((XD = (ccfv @ XT @ ccds)) => ((cwf @ XX @ ccr @ XN) => ((cwcel @ XT @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XD @ (ccfv @ XX @ ccme)))))))))))))).
...
thf(atng0_thm,axiom,(! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XN @ XV) => (Xc_0 = (ccfv @ XT @ cc0g))))))))))).
...
thf(ctngngp_conj,conjecture,(! [XT:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (XT = (cco @ (XG @ Xx3 @ Xy1) @ XN @ cctng)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_mi = (ccfv @ (XG @ Xx3 @ Xy1) @ ccsg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_0 = (ccfv @ (XG @ Xx3 @ Xy1) @ cc0g)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwf @ XX @ ccr @ XN) => ((cwcel @ XT @ ccngp) <=> ((cwcel @ (XG @ Xx3 @ Xy1) @ ccgrp) & (cwral @ (^ [Xx3:$i] : ((((ccfv @ (ccv @ Xx3) @ XN) = ccc0) <=> ((ccv @ Xx3) = Xc_0)) & (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) @ XN) @ (cco @ (ccfv @ (ccv @ Xx3) @ XN) @ (ccfv @ (ccv @ Xy1) @ XN) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : XX)))) @ (^ [Xx3:$i] : XX)))))))))))))))))).
