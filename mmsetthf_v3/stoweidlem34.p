...
thf(astoweidlem11_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ (XN @ Xj) @ ccn)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ (ccv @ Xt) @ (XT @ Xi @ Xj)))))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ (ccv @ Xj) @ (cco @ cc1 @ (XN @ Xj) @ ccfz))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz))) => (cwf @ (XT @ Xi @ Xj) @ ccr @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz))) => (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ cc1 @ ccle))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xi) @ (cco @ (ccv @ Xj) @ (XN @ Xj) @ ccfz))) => (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ (cco @ (XE @ Xj) @ (XN @ Xj) @ ccdiv) @ cclt))))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ (XE @ Xj) @ ccrp)))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwbr @ (XE @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ cclt)))) => (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwbr @ (ccfv @ (ccv @ Xt) @ (ccmpt @ (^ [Xt:$i] : (XT @ Xi @ Xj)) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ (XN @ Xj) @ ccfz) @ (^ [Xi:$i] : (cco @ (XE @ Xj) @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ ccmul)))))) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ (XE @ Xj) @ ccmul) @ cclt))))))))))))))))))).
...
thf(astoweidlem26_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (cwnfc @ (^ [Xt:$i] : (XF @ Xt @ Xi)))) => ((! [Xt:$i] : ((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xt @ Xj)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xt @ Xj)) @ X)))) => ((! [Xj:$i] : ((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xt @ Xj)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xt @ Xj)) @ X)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XD @ Xt @ Xi @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xj:$i] : (ccrab @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) @ XE @ ccmul) @ ccle)) @ (^ [Xt:$i] : (XT @ Xi))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XB2 @ Xt @ Xi @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xj:$i] : (ccrab @ (^ [Xt:$i] : (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ XE @ ccmul) @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ ccle)) @ (^ [Xt:$i] : (XT @ Xi))))))))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ XN @ ccn)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ (XT @ Xi) @ ccvv))))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ (XS @ Xj) @ (ccdif @ (ccfv @ XL @ (XD @ Xt @ Xi @ Xj)) @ (ccfv @ (cco @ XL @ cc1 @ ccmin) @ (XD @ Xt @ Xi @ Xj)))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwf @ (XT @ Xi) @ ccr @ (XF @ Xt @ Xi)))))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ XE @ ccrp)))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwbr @ XE @ (cco @ cc1 @ cc3 @ ccdiv) @ cclt)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XN @ ccfz))) => (cwf @ (XT @ Xi) @ ccr @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ (ccv @ Xt) @ (XT @ Xi))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ ccle))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xt @ Xi @ Xj)))) => (cwbr @ (cco @ cc1 @ (cco @ XE @ XN @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ cclt))))) => (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwbr @ (cco @ (cco @ XL @ (cco @ cc4 @ cc3 @ ccdiv) @ ccmin) @ XE @ ccmul) @ (ccfv @ (XS @ Xj) @ (ccmpt @ (^ [Xt:$i] : (XT @ Xi)) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ XE @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi @ Xj))) @ ccmul)))))) @ cclt))))))))))))))))))))))))))))))).
...
thf(cstoweidlem34_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : (cwnfc @ (^ [Xt:$i] : (XF @ Xt @ Xi)))) => ((! [Xt:$i] : ((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xt @ Xj)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xt @ Xj)) @ X)))) => ((! [Xj:$i] : ((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xt @ Xj)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xt @ Xj)) @ X)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XD @ Xt @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xj:$i] : (ccrab @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) @ XE @ ccmul) @ ccle)) @ (^ [Xt:$i] : XT)))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XB2 @ Xt @ Xi @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xj:$i] : (ccrab @ (^ [Xt:$i] : (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ XE @ ccmul) @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ ccle)) @ (^ [Xt:$i] : XT)))))))) => ((! [Xt:$i] : (! [Xj:$i] : ((XJ @ Xt @ Xj) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccrab @ (^ [Xj:$i] : (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (XD @ Xt @ Xj)))) @ (^ [Xj:$i] : (cco @ cc1 @ XN @ ccfz)))))))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ XN @ ccn)))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ XT @ ccvv)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwf @ XT @ ccr @ (XF @ Xt @ Xi)))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xt) @ XT)) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ ccle))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xt) @ XT)) => (cwbr @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XE @ ccmul) @ cclt))))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwcel @ XE @ ccrp)))) => ((! [Xt:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwbr @ XE @ (cco @ cc1 @ cc3 @ ccdiv) @ cclt)))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz))) => (cwf @ XT @ ccr @ (ccfv @ (ccv @ Xj) @ (XX @ Xi))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ (ccv @ Xt) @ XT)) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (XX @ Xi))) @ ccle))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ (ccv @ Xt) @ XT)) => (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (XX @ Xi))) @ cc1 @ ccle))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (XD @ Xt @ Xj)))) => (cwbr @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (XX @ Xi))) @ (cco @ XE @ XN @ ccdiv) @ cclt))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xt @ Xj) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (XB2 @ Xt @ Xi @ Xj)))) => (cwbr @ (cco @ cc1 @ (cco @ XE @ XN @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xj) @ (XX @ Xi))) @ cclt))))) => (! [Xt:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xt @ Xj) => (cwral @ (^ [Xt:$i] : (cwrex @ (^ [Xj:$i] : (((cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc4 @ cc3 @ ccdiv) @ ccmin) @ XE @ ccmul) @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ cclt) & (cwbr @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) @ XE @ ccmul) @ ccle)) & ((cwbr @ (ccfv @ (ccv @ Xt) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ XE @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi))) @ ccmul)))))) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ XE @ ccmul) @ cclt) & (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc4 @ cc3 @ ccdiv) @ ccmin) @ XE @ ccmul) @ (ccfv @ (ccv @ Xt) @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ XE @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XX @ Xi))) @ ccmul)))))) @ cclt)))) @ (^ [Xj:$i] : ccr))) @ (^ [Xt:$i] : XT)))))))))))))))))))))))))))))))))).
