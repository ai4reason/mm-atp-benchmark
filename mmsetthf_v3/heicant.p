...
thf(cheicant_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XC @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XD @ (ccfv @ XY @ ccxmt))) => ((Xph => (cwcel @ (ccfv @ XC @ ccmopn) @ cccmp)) => ((Xph => (XX != cc0)) => ((Xph => (XY != cc0)) => (Xph => ((cco @ (ccfv @ XC @ ccmetu) @ (ccfv @ XD @ ccmetu) @ ccucn) = (cco @ (ccfv @ XC @ ccmopn) @ (ccfv @ XD @ ccmopn) @ cccn)))))))))))))).
