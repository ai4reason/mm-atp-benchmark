...
thf(cofaddmndmap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XR = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XV @ XY) & ((cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) & (cwcel @ XB2 @ (cco @ XR @ XV @ ccmap)))) => (cwcel @ (cco @ XA2 @ XB2 @ (ccof @ Xc_pl)) @ (cco @ XR @ XV @ ccmap))))))))))))).
