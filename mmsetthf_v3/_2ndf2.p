...
thf(a_2ndfval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3 @ Xy1) = (cco @ XC @ XD @ ccxpc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XB2 = (ccfv @ (XT @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XH = (ccfv @ (XT @ Xx3 @ Xy1) @ cchom)))) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XQ @ Xx3 @ Xy1) = (cco @ XC @ XD @ cc2ndf)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((XQ @ Xx3 @ Xy1) = (ccop @ (ccres @ cc2nd @ XB2) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ cc2nd @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)))))))))))))))))))))))).
...
thf(c_2ndf2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((XT = (cco @ XC @ XD @ ccxpc)) => ((XB2 = (ccfv @ XT @ ccbs)) => ((XH = (ccfv @ XT @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XQ = (cco @ XC @ XD @ cc2ndf)) => ((Xph => (cwcel @ XR @ XB2)) => ((Xph => (cwcel @ XS @ XB2)) => (Xph => ((cco @ XR @ XS @ (ccfv @ XQ @ cc2nd)) = (ccres @ cc2nd @ (cco @ XR @ XS @ XH)))))))))))))))))))))).
