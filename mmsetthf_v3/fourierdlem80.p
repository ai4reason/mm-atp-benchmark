...
thf(afourierdlem57_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwf @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo) @ ccr @ (cco @ ccr @ (ccres @ XF @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo)) @ ccdv))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((Xph => (~ (cwcel @ ccc0 @ (cco @ XA2 @ XB2 @ ccioo)))) => ((Xph => (cwcel @ XC @ ccr)) => ((! [Xs1:$i] : ((XO @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF) @ XC @ ccmin) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))) => (! [Xs1:$i] : ((Xph => ((cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ (cco @ ccr @ (XO @ Xs1) @ ccdv)) & ((cco @ ccr @ (XO @ Xs1) @ ccdv) = (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ (cco @ ccr @ (ccres @ XF @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo)) @ ccdv)) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccmul) @ (cco @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ cccos) @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF) @ XC @ ccmin) @ ccmul) @ ccmin) @ (cco @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ cc2 @ ccexp) @ ccdiv)))))) & ((cco @ ccr @ (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul))) @ ccdv) = (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ cccos))))))))))))))))))))))).
...
thf(afourierdlem68_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((Xph => (~ (cwcel @ ccc0 @ (cco @ XA2 @ XB2 @ ccicc)))) => ((Xph => (cwf @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo) @ ccr @ (cco @ ccr @ (ccres @ XF @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo)) @ ccdv))) => ((Xph => (cwcel @ XD @ ccr)) => ((! [Xt:$i] : ((Xph & (cwcel @ (ccv @ Xt) @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo))) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xt) @ XF) @ ccabs) @ XD @ ccle))) => ((Xph => (cwcel @ XE @ ccr)) => ((! [Xt:$i] : ((Xph & (cwcel @ (ccv @ Xt) @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo))) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xt) @ (cco @ ccr @ (ccres @ XF @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo)) @ ccdv)) @ ccabs) @ XE @ ccle))) => ((! [Xt:$i] : (Xph => (cwcel @ (XC @ Xt) @ ccr))) => ((! [Xt:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XO @ Xt @ Xs1 @ Xb) = (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF) @ (XC @ Xt) @ ccmin) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))) => (! [Xt:$i] : (! [Xs1:$i] : (! [Xb:$i] : (Xph => (((ccdm @ (cco @ ccr @ (XO @ Xt @ Xs1 @ Xb) @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo)) & (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (cco @ ccr @ (XO @ Xt @ Xs1 @ Xb) @ ccdv)) @ ccabs) @ (ccv @ Xb) @ ccle)) @ (^ [Xs1:$i] : (ccdm @ (cco @ ccr @ (XO @ Xt @ Xs1 @ Xb) @ ccdv))))) @ (^ [Xb:$i] : ccr))))))))))))))))))))))))))))))).
...
thf(cfourierdlem80_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : ((! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwf @ ccr @ ccr @ (XF @ Xj @ Xk)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwcel @ (XX @ Xz @ Xw @ Xj @ Xk) @ ccr))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwcel @ (XA2 @ Xz @ Xw @ Xj @ Xk) @ ccr))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwcel @ (XB2 @ Xz @ Xw @ Xj @ Xk) @ ccr))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwss @ (cco @ (XA2 @ Xz @ Xw @ Xj @ Xk) @ (XB2 @ Xz @ Xw @ Xj @ Xk) @ ccicc) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (~ (cwcel @ ccc0 @ (cco @ (XA2 @ Xz @ Xw @ Xj @ Xk) @ (XB2 @ Xz @ Xw @ Xj @ Xk) @ ccicc))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwcel @ (XC @ Xz @ Xw @ Xj @ Xk) @ ccr))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((XO @ Xt @ Xk @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (cco @ (XA2 @ Xz @ Xw @ Xj @ Xk) @ (XB2 @ Xz @ Xw @ Xj @ Xk) @ ccicc)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ (XX @ Xz @ Xw @ Xj @ Xk) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xj @ Xk)) @ (XC @ Xz @ Xw @ Xj @ Xk) @ ccmin) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb) = (cco @ (cco @ (XX @ Xz @ Xw @ Xj @ Xk) @ (ccfv @ (ccv @ Xj) @ XS) @ ccaddc) @ (cco @ (XX @ Xz @ Xw @ Xj @ Xk) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XS) @ ccaddc) @ ccioo)))))))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xb:$i] : (((Xph @ Xt @ Xk) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ (XN @ Xt) @ ccfzo))) => (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XF @ Xj @ Xk)) @ ccabs) @ (ccv @ Xw) @ ccle)) @ (^ [Xt:$i] : (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb)))) @ (^ [Xw:$i] : ccr))))))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xb:$i] : (((Xph @ Xt @ Xk) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ (XN @ Xt) @ ccfzo))) => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xt) @ (cco @ ccr @ (ccres @ (XF @ Xj @ Xk) @ (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb)) @ ccdv)) @ ccabs) @ (ccv @ Xz) @ ccle)) @ (^ [Xt:$i] : (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb)))) @ (^ [Xz:$i] : ccr))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwf @ (cco @ ccc0 @ (XN @ Xt) @ ccfz) @ (cco @ (XA2 @ Xz @ Xw @ Xj @ Xk) @ (XB2 @ Xz @ Xw @ Xj @ Xk) @ ccicc) @ XS))))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xt @ Xk) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ (XN @ Xt) @ ccfzo))) => (cwbr @ (ccfv @ (ccv @ Xj) @ XS) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XS) @ cclt))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xt @ Xk) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ (XN @ Xt) @ ccfzo))) => (cwss @ (cco @ (ccfv @ (ccv @ Xj) @ XS) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XS) @ ccicc) @ (cco @ (XA2 @ Xz @ Xw @ Xj @ Xk) @ (XB2 @ Xz @ Xw @ Xj @ Xk) @ ccicc)))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : ((((Xph @ Xt @ Xk) & (cwcel @ (ccv @ Xr) @ (cco @ (XA2 @ Xz @ Xw @ Xj @ Xk) @ (XB2 @ Xz @ Xw @ Xj @ Xk) @ ccicc))) & (~ (cwcel @ (ccv @ Xr) @ (ccrn @ XS)))) => (cwrex @ (^ [Xk:$i] : (cwcel @ (ccv @ Xr) @ (cco @ (ccfv @ (ccv @ Xk) @ XS) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XS) @ ccioo))) @ (^ [Xk:$i] : (cco @ ccc0 @ (XN @ Xt) @ ccfzo)))))))))) => ((! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xb:$i] : (((Xph @ Xt @ Xk) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ (XN @ Xt) @ ccfzo))) => (cwf @ (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb) @ ccr @ (cco @ ccr @ (ccres @ (XF @ Xj @ Xk) @ (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb)) @ ccdv))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XY @ Xz @ Xw @ Xt @ Xj @ Xk @ Xr @ Xb) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xj) @ XS) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XS) @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ (XX @ Xz @ Xw @ Xj @ Xk) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xj @ Xk)) @ (XC @ Xz @ Xw @ Xj @ Xk) @ ccmin) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xch @ Xz @ Xw @ Xj @ Xk @ Xr @ Xb) <=> ((((((Xph @ Xt @ Xk) & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ (XN @ Xt) @ ccfzo))) & (cwcel @ (ccv @ Xw) @ ccr)) & (cwcel @ (ccv @ Xz) @ ccr)) & (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XF @ Xj @ Xk)) @ ccabs) @ (ccv @ Xw) @ ccle)) @ (^ [Xt:$i] : (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb)))) & (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xt) @ (cco @ ccr @ (ccres @ (XF @ Xj @ Xk) @ (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb)) @ ccdv)) @ ccabs) @ (ccv @ Xz) @ ccle)) @ (^ [Xt:$i] : (XI @ Xt @ Xj @ Xk @ Xs1 @ Xr @ Xb))))))))))))) => (! [Xt:$i] : (! [Xk:$i] : ((Xph @ Xt @ Xk) => (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (cco @ ccr @ (XO @ Xt @ Xk @ Xs1) @ ccdv)) @ ccabs) @ (ccv @ Xb) @ ccle)) @ (^ [Xs1:$i] : (ccdm @ (cco @ ccr @ (XO @ Xt @ Xk @ Xs1) @ ccdv))))) @ (^ [Xb:$i] : ccr)))))))))))))))))))))))))))))))))))).
