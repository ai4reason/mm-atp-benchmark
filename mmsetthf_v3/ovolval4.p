...
thf(aovolval4lem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => (cwss @ (XA2 @ Xn) @ ccr)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XM @ Xy1 @ Xf1 @ Xn) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xy1) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XG @ Xy1 @ Xf1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ cc1st) @ (ccif @ (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ cc2nd) @ ccle) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ cc2nd) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ cc1st)))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => ((ccfv @ (XA2 @ Xn) @ ccovol) = (ccinf @ (XM @ Xy1 @ Xf1 @ Xn) @ ccxr @ cclt)))))))))))))).
