...
thf(csetsstruct_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XE @ XV) & (cwcel @ XI @ (ccfv @ XM @ ccuz)) & (cwbr @ XG @ (ccop @ XM @ XN) @ ccstr)) => (cwbr @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ (ccop @ XM @ (ccif @ (cwbr @ XI @ XN @ ccle) @ XN @ XI)) @ ccstr))))))))).
