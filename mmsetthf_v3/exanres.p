...
thf(cexanres_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XC @ XW)) => ((? [Xu:$i] : ((cwbr @ (ccv @ Xu) @ XB2 @ (ccres @ (XR @ Xu) @ (XA2 @ Xu))) & (cwbr @ (ccv @ Xu) @ XC @ (ccres @ (XS @ Xu) @ (XA2 @ Xu))))) <=> (cwrex @ (^ [Xu:$i] : ((cwbr @ (ccv @ Xu) @ XB2 @ (XR @ Xu)) & (cwbr @ (ccv @ Xu) @ XC @ (XS @ Xu)))) @ (^ [Xu:$i] : (XA2 @ Xu))))))))))))).
