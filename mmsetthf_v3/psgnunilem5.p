...
thf(asymgsssg_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (XG = (ccfv @ (XD @ Xx3) @ ccsymg))) => ((XB2 = (ccfv @ XG @ ccbs)) => (! [Xx3:$i] : ((cwcel @ (XD @ Xx3) @ (XV @ Xx3)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccdm @ (ccdif @ (ccv @ Xx3) @ ccid)) @ XX)) @ (^ [Xx3:$i] : XB2)) @ (ccfv @ XG @ ccsubg)))))))))))).
...
thf(af1omvdco3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwf1o @ XA2 @ XA2 @ XF) & (cwf1o @ XA2 @ XA2 @ XG) & (~ ((cwcel @ XX @ (ccdm @ (ccdif @ XF @ ccid))) <=> (cwcel @ XX @ (ccdm @ (ccdif @ XG @ ccid)))))) => (cwcel @ XX @ (ccdm @ (ccdif @ (cccom @ XF @ XG) @ ccid))))))))).
...
thf(agsumws1_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XS @ XB2) => ((cco @ XG @ (ccs1 @ XS) @ ccgsu) = XS))))))).
