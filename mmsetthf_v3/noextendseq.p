...
thf(cnoextendseq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccpr @ cc1o @ cc2o)) => (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccon0)) => (cwcel @ (ccun @ XA2 @ (ccxp @ (ccdif @ XB2 @ (ccdm @ XA2)) @ (ccsn @ XX))) @ ccsur))))))).
