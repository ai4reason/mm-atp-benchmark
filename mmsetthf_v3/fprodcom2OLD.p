...
thf(cfprodcom2OLD_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwcel @ XC @ ccfn)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XA2)) => (cwcel @ (XB2 @ Xj) @ ccfn))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xj))) <=> ((cwcel @ (ccv @ Xk) @ XC) & (cwcel @ (ccv @ Xj) @ (XD @ Xk))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xj)))) => (cwcel @ (XE @ Xj @ Xk) @ ccc)))) => (Xph => ((ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (XB2 @ Xj)) @ (^ [Xk:$i] : (XE @ Xj @ Xk))))) = (ccprod @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (ccprod @ (^ [Xj:$i] : (XD @ Xk)) @ (^ [Xj:$i] : (XE @ Xj @ Xk))))))))))))))))))).
