...
thf(cldualsaddN_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_pl = (ccfv @ XF @ ccplusg)) => ((XD = (ccfv @ XW @ ccld)) => ((XR = (ccfv @ XD @ ccsca)) => ((Xc_pb = (ccfv @ XR @ ccplusg)) => ((Xph => (cwcel @ XW @ XV)) => (Xph => (Xc_pb = Xc_pl))))))))))))))))).
