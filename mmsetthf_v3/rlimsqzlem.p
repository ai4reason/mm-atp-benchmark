...
thf(crlimsqzlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccr)) => ((Xph => (cwcel @ XE @ ccc)) => ((Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XD @ ccrli)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ XM @ (ccv @ Xx3) @ ccle))) => (cwbr @ (ccfv @ (cco @ (XC @ Xx3) @ XE @ ccmin) @ ccabs) @ (ccfv @ (cco @ (XB2 @ Xx3) @ XD @ ccmin) @ ccabs) @ ccle))) => (Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ XE @ ccrli)))))))))))))))).
