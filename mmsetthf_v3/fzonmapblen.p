...
thf(cfzonmapblen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XB2 @ (cco @ ccc0 @ XN @ ccfzo)) & (cwbr @ XB2 @ XA2 @ cclt)) => (cwbr @ (cco @ XB2 @ (cco @ XN @ XA2 @ ccmin) @ ccaddc) @ XN @ cclt)))))).
