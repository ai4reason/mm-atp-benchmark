...
thf(c_2pwp1prmfmtno_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XK @ ccn) & (XP = (cco @ (cco @ cc2 @ XK @ ccexp) @ cc1 @ ccaddc)) & (cwcel @ XP @ ccprime)) => (cwrex @ (^ [Xn:$i] : (XP = (ccfv @ (ccv @ Xn) @ ccfmtno))) @ (^ [Xn:$i] : ccn0)))))).
