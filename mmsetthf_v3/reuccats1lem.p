...
thf(accats1swrdeqrex_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV)) & ((ccfv @ XU @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) => ((XW = (cco @ XU @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) => (cwrex @ (^ [Xs1:$i] : (XU = (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat))) @ (^ [Xs1:$i] : XV)))))))).
...
thf(creuccats1lem_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xs1:$i] : ((((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (XU @ Xs1) @ XX) & (cwcel @ (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat) @ XX)) & ((cwral @ (^ [Xs1:$i] : ((cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat) @ XX) => ((XS @ Xx3) = (ccv @ Xs1)))) @ (^ [Xs1:$i] : XV)) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccword @ XV)) & ((ccfv @ (ccv @ Xx3) @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : XX)))) => ((XW = (cco @ (XU @ Xs1) @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) => ((XU @ Xs1) = (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat)))))))))))).
