...
thf(ar1val2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ ccr1) = (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ XA2)))))).
thf(cr1val3_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ ccr1) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccpw @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrnk) @ (ccv @ Xx3)))))))))).
