...
thf(aedgfndxid_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XG @ XV) => ((ccfv @ XG @ ccedgf) = (ccfv @ (ccfv @ ccnx @ ccedgf) @ XG)))))).
...
thf(cstructiedg0val_conj,conjecture,(! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XS @ ccn) => ((cwbr @ (ccfv @ ccnx @ ccbs) @ XS @ cclt) => ((XG = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ XS @ XE))) => (((cwcel @ XV @ XX) & (cwcel @ XE @ XY) & (XS != (ccfv @ ccnx @ ccedgf))) => ((ccfv @ XG @ cciedg) = cc0)))))))))))).
