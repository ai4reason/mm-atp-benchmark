...
thf(crecextlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccmin) @ ccmul) = (cco @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ XB2 @ XB2 @ ccmul) @ ccaddc)))))).
