...
thf(covn0ssdmfun_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cco @ (ccv @ Xa) @ (ccv @ Xb) @ XF) != cc0)) @ (^ [Xb:$i] : XE))) @ (^ [Xa:$i] : XD)) => ((cwss @ (ccxp @ XD @ XE) @ (ccdm @ XF)) & (cwfun @ (ccres @ XF @ (ccxp @ XD @ XE))))))))).
