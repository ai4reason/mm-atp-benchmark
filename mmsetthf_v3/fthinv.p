...
thf(afthsect_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XM @ (cco @ XX @ XY @ XH))) => ((Xph => (cwcel @ XN @ (cco @ XY @ XX @ XH))) => ((XS = (ccfv @ XC @ ccsect)) => ((XT = (ccfv @ XD @ ccsect)) => (Xph => ((cwbr @ XM @ XN @ (cco @ XX @ XY @ XS)) <=> (cwbr @ (ccfv @ XM @ (cco @ XX @ XY @ XG)) @ (ccfv @ XN @ (cco @ XY @ XX @ XG)) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XT))))))))))))))))))))))))))).
