...
thf(ariotaeqdv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => ((XA2 @ Xx3) = (XB2 @ Xx3)))) => (Xph => ((ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(aeloprabg_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > $o)))] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> (Xps @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = XB2) => ((Xps @ Xx3 @ Xy1 @ Xz) <=> (Xch @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = XC) => ((Xch @ Xx3 @ Xy1 @ Xz) <=> Xth))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)) & (cwcel @ XB2 @ (XW @ Xx3 @ Xy1 @ Xz)) & (cwcel @ XC @ (XX @ Xx3 @ Xy1 @ Xz))) => ((cwcel @ (ccop @ (ccop @ XA2 @ XB2) @ XC) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) <=> Xth))))))))))))))))))).
...
thf(cfvtransport_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee))) & (XC != XD))) => ((cco @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cctransport) = (ccrio @ (^ [Xr:$i] : ((cwbr @ XD @ (ccop @ XC @ (ccv @ Xr)) @ ccbtwn) & (cwbr @ (ccop @ XD @ (ccv @ Xr)) @ (ccop @ XA2 @ XB2) @ cccgr))) @ (^ [Xr:$i] : (ccfv @ XN @ ccee))))))))))).
