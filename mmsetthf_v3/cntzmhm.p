...
thf(ccntzmhm_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XG @ cccntz)) => ((XY = (ccfv @ XH @ cccntz)) => (((cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) & (cwcel @ XA2 @ (ccfv @ XS @ XZ))) => (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ (ccima @ XF @ XS) @ XY))))))))))))).
