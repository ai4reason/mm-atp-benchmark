...
thf(cnmopsetn0_conj,conjecture,(! [XT:($i > $o)] : (cwcel @ (ccfv @ (ccfv @ cc0v @ XT) @ ccno) @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccfv @ (ccv @ Xy1) @ ccno) @ cc1 @ ccle) & ((ccv @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ ccno)))) @ (^ [Xy1:$i] : cchil)))))).
