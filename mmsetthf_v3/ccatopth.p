...
thf(cccatopth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ (ccword @ XX))) & ((cwcel @ XC @ (ccword @ XX)) & (cwcel @ XD @ (ccword @ XX))) & ((ccfv @ XA2 @ cchash) = (ccfv @ XC @ cchash))) => (((cco @ XA2 @ XB2 @ ccconcat) = (cco @ XC @ XD @ ccconcat)) <=> ((XA2 = XC) & (XB2 = XD)))))))))).
