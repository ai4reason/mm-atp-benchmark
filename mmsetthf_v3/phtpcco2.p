...
thf(aphtpyco2_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XP @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)))) => (Xph => (cwcel @ (cccom @ XP @ XH) @ (cco @ (cccom @ XP @ XF) @ (cccom @ XP @ XG) @ (ccfv @ XK @ ccphtpy)))))))))))))))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(ane0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ XA2) => (XA2 != cc0))))).
thf(cphtpcco2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwbr @ XF @ XG @ (ccfv @ XJ @ ccphtpc))) => ((Xph => (cwcel @ XP @ (cco @ XJ @ XK @ cccn))) => (Xph => (cwbr @ (cccom @ XP @ XF) @ (cccom @ XP @ XG) @ (ccfv @ XK @ ccphtpc)))))))))))).
