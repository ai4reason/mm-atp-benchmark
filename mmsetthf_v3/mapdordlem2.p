...
thf(amapdordlem1_thm,axiom,(! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((! [Xg1:$i] : ((XT @ Xg1) = (ccrab @ (^ [Xg1:$i] : (cwcel @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xg1) @ XL) @ XO) @ XO) @ XY)) @ (^ [Xg1:$i] : XF)))) => (! [Xg1:$i] : ((cwcel @ XJ @ (XT @ Xg1)) <=> ((cwcel @ XJ @ XF) & (cwcel @ (ccfv @ (ccfv @ (ccfv @ XJ @ XL) @ XO) @ XO) @ XY)))))))))))).
...
thf(adochshpsat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XA2 = (ccfv @ XU @ cclsa)) => ((XY = (ccfv @ XU @ cclsh)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ XY)) => (Xph => (((ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) = XX) <=> (cwcel @ (ccfv @ XX @ Xc_pe) @ XA2)))))))))))))))))))).
