...
thf(afparlem1_thm,axiom,(! [Xx3:$i] : ((ccima @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv))) @ (ccsn @ (ccv @ Xx3))) = (ccxp @ (ccsn @ (ccv @ Xx3)) @ ccvv)))).
...
thf(cfparlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((cccom @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv))) @ (cccom @ XF @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv)))) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccxp @ (ccsn @ (ccv @ Xx3)) @ ccvv) @ (ccxp @ (ccsn @ (ccfv @ (ccv @ Xx3) @ XF)) @ ccvv))))))))).
