...
thf(alsmless1x_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((((cwcel @ XG @ XV) & (cwss @ XT @ XB2) & (cwss @ XU @ XB2)) & (cwss @ XR @ XT)) => (cwss @ (cco @ XR @ XU @ Xc_po) @ (cco @ XT @ XU @ Xc_po))))))))))))).
...
thf(clsmless12_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XU @ (ccfv @ XG @ ccsubg))) & ((cwss @ XR @ XS) & (cwss @ XT @ XU))) => (cwss @ (cco @ XR @ XT @ Xc_po) @ (cco @ XS @ XU @ Xc_po))))))))))).
