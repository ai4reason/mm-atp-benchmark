...
thf(asincos3rdpi_thm,axiom,(((ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ ccsin) = (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)) & ((ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ cccos) = (cco @ cc1 @ cc2 @ ccdiv)))).
...
thf(cpige3_conj,conjecture,(cwbr @ cc3 @ ccpi @ ccle)).
