...
thf(clgsmodeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & ((cwcel @ XN @ ccn) & (~ (cwbr @ cc2 @ XN @ ccdvds)))) => (((cco @ XA2 @ XN @ ccmo) = (cco @ XB2 @ XN @ ccmo)) => ((cco @ XA2 @ XN @ cclgs) = (cco @ XB2 @ XN @ cclgs)))))))).
