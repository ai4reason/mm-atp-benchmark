...
thf(cccatw2s1ass_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV)) => ((cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat) = (cco @ XW @ (cco @ (ccs1 @ XX) @ (ccs1 @ XY) @ ccconcat) @ ccconcat)))))))).
