...
thf(csetsabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XC @ XW)) => ((cco @ (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts) @ (ccop @ XA2 @ XC) @ ccsts) = (cco @ XS @ (ccop @ XA2 @ XC) @ ccsts)))))))))).
