...
thf(ciooiinicc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cciin @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccmin) @ (cco @ XB2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccioo))) = (cco @ XA2 @ XB2 @ ccicc))))))))).
