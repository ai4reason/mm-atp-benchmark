...
thf(advcnvrelem2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = XX)) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XF @ ccdv))))) => ((Xph => (cwf1o @ XX @ XY @ XF)) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => (cwcel @ XR @ ccrp)) => ((Xph => (cwss @ (cco @ (cco @ XC @ XR @ ccmin) @ (cco @ XC @ XR @ ccaddc) @ ccicc) @ XX)) => ((XT = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XM = (cco @ XJ @ XX @ ccrest)) => ((XN = (cco @ XJ @ XY @ ccrest)) => (Xph => ((cwcel @ (ccfv @ XC @ XF) @ (ccfv @ XY @ (ccfv @ XT @ ccnt))) & (cwcel @ (cccnv @ XF) @ (ccfv @ (ccfv @ XC @ XF) @ (cco @ XN @ XM @ cccnp))))))))))))))))))))))))))).
...
thf(cdvcnvre_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = XX)) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XF @ ccdv))))) => ((Xph => (cwf1o @ XX @ XY @ XF)) => (Xph => ((cco @ ccr @ (cccnv @ XF) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cccnv @ XF)) @ (cco @ ccr @ XF @ ccdv)) @ ccdiv)))))))))))))).
