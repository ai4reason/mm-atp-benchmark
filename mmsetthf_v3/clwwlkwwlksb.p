...
thf(cclwwlkwwlksb_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XW @ (ccword @ XV)) & (XW != cc0)) => ((cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) <=> (cwcel @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat) @ (ccfv @ XG @ ccwwlks))))))))).
