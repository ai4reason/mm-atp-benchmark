...
thf(achtfl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccfv @ XA2 @ ccfl) @ cccht) = (ccfv @ XA2 @ cccht))))).
...
thf(achtnprm_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (~ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cccht) = (ccfv @ XA2 @ cccht))))).
