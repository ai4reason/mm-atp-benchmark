...
thf(aincexc_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwss @ XA2 @ ccfn)) => ((ccfv @ (ccuni @ XA2) @ cchash) = (ccsu @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccfv @ (ccv @ Xs1) @ cchash) @ cc1 @ ccmin) @ ccexp) @ (ccfv @ (ccint @ (ccv @ Xs1)) @ cchash) @ ccmul))))))).
...
thf(ainvdisj_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((XC @ Xy1) = (ccv @ Xx3))) @ (^ [Xy1:$i] : (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
...
thf(cincexc2_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwss @ XA2 @ ccfn)) => ((ccfv @ (ccuni @ XA2) @ cchash) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccexp) @ (ccsu @ (ccrab @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ cchash) = (ccv @ Xn))) @ (^ [Xk:$i] : (ccpw @ XA2))) @ (^ [Xs1:$i] : (ccfv @ (ccint @ (ccv @ Xs1)) @ cchash))) @ ccmul))))))).
