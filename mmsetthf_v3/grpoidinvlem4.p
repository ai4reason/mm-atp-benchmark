...
thf(cgrpoidinvlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((((cwcel @ XG @ ccgr) & (cwcel @ XA2 @ XX)) & (cwrex @ (^ [Xy1:$i] : (((cco @ (ccv @ Xy1) @ XA2 @ XG) = XU) & ((cco @ XA2 @ (ccv @ Xy1) @ XG) = XU))) @ (^ [Xy1:$i] : XX))) => ((cco @ XA2 @ XU @ XG) = (cco @ XU @ XA2 @ XG))))))))).
