...
thf(aeuequ1_thm,axiom,(! [Xy1:$i] : (cweu @ (^ [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))))).
...
thf(aexdistrf_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))) => ((? [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ X)))))) => (! [Xy1:$i] : ((? [Xx3:$i] : (? [Xy1:$i] : ((Xph @ Xx3 @ Xy1) & (Xps @ Xx3 @ Xy1)))) => (? [Xx3:$i] : ((Xph @ Xx3 @ Xy1) & (? [Xy1:$i] : (Xps @ Xx3 @ Xy1)))))))))).
