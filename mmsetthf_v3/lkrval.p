...
thf(alkrfval_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xf1:$i] : ((XD @ Xf1) = (ccfv @ XW @ ccsca))) => ((! [Xf1:$i] : ((Xc_0 @ Xf1) = (ccfv @ (XD @ Xf1) @ cc0g))) => ((XF = (ccfv @ XW @ cclfn)) => ((! [Xf1:$i] : ((XK @ Xf1) = (ccfv @ XW @ cclk))) => (! [Xf1:$i] : ((cwcel @ XW @ (XX @ Xf1)) => ((XK @ Xf1) = (ccmpt @ (^ [Xf1:$i] : XF) @ (^ [Xf1:$i] : (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (Xc_0 @ Xf1))))))))))))))))))).
...
thf(clkrval_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => (((cwcel @ XW @ XX) & (cwcel @ XG @ XF)) => ((ccfv @ XG @ XK) = (ccima @ (cccnv @ XG) @ (ccsn @ Xc_0)))))))))))))))).
