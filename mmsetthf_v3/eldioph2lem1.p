...
thf(afzsplit1nn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0) & (cwbr @ XA2 @ XB2 @ ccle)) => ((cco @ cc1 @ XB2 @ ccfz) = (ccun @ (cco @ cc1 @ XA2 @ ccfz) @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XB2 @ ccfz))))))).
...
thf(celdioph2lem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccfn) & (cwss @ (cco @ cc1 @ XN @ ccfz) @ XA2)) => (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ XA2 @ (ccv @ Xe)) & ((ccres @ (ccv @ Xe) @ (cco @ cc1 @ XN @ ccfz)) = (ccres @ ccid @ (cco @ cc1 @ XN @ ccfz))))) @ (^ [Xe:$i] : ccvv))) @ (^ [Xd:$i] : (ccfv @ XN @ ccuz))))))).
