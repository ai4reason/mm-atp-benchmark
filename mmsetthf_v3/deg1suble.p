...
thf(adeg1invg_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XN = (ccfv @ XY @ ccminusg)) => ((Xph => (cwcel @ XF @ XB2)) => (Xph => ((ccfv @ (ccfv @ XF @ XN) @ XD) = (ccfv @ XF @ XD))))))))))))))))).
thf(cdeg1suble_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ (ccif @ (cwbr @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ ccle) @ (ccfv @ XG @ XD) @ (ccfv @ XF @ XD)) @ ccle)))))))))))))))))).
