...
thf(adprdfeq0_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccfv @ XG @ cc0g))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XW @ Xx3 @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS))))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwbr @ XG @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => ((ccdm @ XS) = XI)))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (XF @ Xi) @ (XW @ Xx3 @ Xh @ Xi)))))) => (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (((cco @ XG @ (XF @ Xi) @ ccgsu) = (Xc_0 @ Xi)) <=> ((XF @ Xi) = (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (Xc_0 @ Xi))))))))))))))))))))).
