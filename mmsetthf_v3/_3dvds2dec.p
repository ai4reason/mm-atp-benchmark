...
thf(c_3dvds2dec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwbr @ cc3 @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ ccdvds) <=> (cwbr @ cc3 @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccaddc) @ ccdvds))))))))).
