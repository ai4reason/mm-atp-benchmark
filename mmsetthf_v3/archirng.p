...
thf(ann0min_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : ((! [Xn:$i] : (((ccv @ Xn) = ccc0) => ((Xps @ Xn) <=> Xch))) => ((! [Xm:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xm)) => ((Xps @ Xn) <=> (Xth @ Xm))))) => ((! [Xm:$i] : (! [Xn:$i] : (((ccv @ Xn) = (cco @ (ccv @ Xm) @ cc1 @ ccaddc)) => ((Xps @ Xn) <=> (Xta @ Xm))))) => ((Xph => (~ Xch)) => ((Xph => (cwrex @ (^ [Xn:$i] : (Xps @ Xn)) @ (^ [Xn:$i] : ccn))) => (Xph => (cwrex @ (^ [Xm:$i] : ((~ (Xth @ Xm)) & (Xta @ Xm))) @ (^ [Xm:$i] : ccn0)))))))))))))).
