...
thf(crngosn3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XA2 @ XB2)) => ((XX = (ccsn @ XA2)) <=> (XR = (ccop @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2)) @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2)))))))))))))).
