...
thf(asrhmsubcALTVlem1_thm,axiom,(! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwral @ (^ [Xr:$i] : (cwcel @ (ccv @ Xr) @ ccrg)) @ (^ [Xr:$i] : XS)) => ((! [Xr:$i] : ((XC @ Xr) = (ccin @ (XU @ Xr) @ XS))) => (! [Xr:$i] : (((cwcel @ (XU @ Xr) @ (XV @ Xr)) & (cwcel @ XX @ (XC @ Xr))) => (cwcel @ XX @ (ccfv @ (ccfv @ (XU @ Xr) @ ccringcALTV) @ ccbs)))))))))))).
thf(csrhmsubcALTVlem2_conj,conjecture,(! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xs1:$i] : (cwral @ (^ [Xr:$i] : (cwcel @ (ccv @ Xr) @ ccrg)) @ (^ [Xr:$i] : (XS @ Xs1)))) => ((! [Xs1:$i] : (XC = (ccin @ XU @ (XS @ Xs1)))) => ((! [Xs1:$i] : (! [Xr:$i] : ((XJ @ Xs1 @ Xr) = (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : XC)) @ (^ [Xr:$i] : (^ [Xs1:$i] : XC)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccrh))))))) => (! [Xs1:$i] : (! [Xr:$i] : (((cwcel @ XU @ XV) & ((cwcel @ XX @ XC) & (cwcel @ XY @ XC))) => ((cco @ XX @ XY @ (XJ @ Xs1 @ Xr)) = (cco @ XX @ XY @ (ccfv @ (ccfv @ XU @ ccringcALTV) @ cchom))))))))))))))))).
