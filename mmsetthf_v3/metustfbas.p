...
thf(cmetustfbas_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((XX != cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => (cwcel @ XF @ (ccfv @ (ccxp @ XX @ XX) @ ccfbas)))))))).
