...
thf(adf_lcdual_ax,axiom,(cclcd = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ ccld) @ (ccrab @ (^ [Xf1:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ cclk)) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccoch))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccoch))) = (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ cclk)))) @ (^ [Xf1:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ cclfn))) @ ccress))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(clcdfval_conj,conjecture,(! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ XK @ cclh))) => (! [Xw:$i] : (! [Xf1:$i] : ((cwcel @ XK @ (XX @ Xw @ Xf1)) => ((ccfv @ XK @ cclcd) = (ccmpt @ (^ [Xw:$i] : (XH @ Xf1)) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ ccld) @ (ccrab @ (^ [Xf1:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclk)) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccoch))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccoch))) = (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclk)))) @ (^ [Xf1:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cclfn))) @ ccress)))))))))))).
