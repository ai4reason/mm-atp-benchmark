...
thf(aftc1anclem3_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ (ccdm @ ccitg1))) => (cwcel @ (cccom @ ccabs @ (cco @ XF @ (cco @ (ccxp @ ccr @ (ccsn @ cci)) @ XG @ (ccof @ ccmul)) @ (ccof @ ccaddc))) @ (ccdm @ ccitg1)))))).
