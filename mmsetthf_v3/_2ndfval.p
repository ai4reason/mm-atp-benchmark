...
thf(adf_2ndf_ax,axiom,(cc2ndf = (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : cccat)) @ (^ [Xr:$i] : (^ [Xs1:$i] : cccat)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccsb @ (ccxp @ (ccfv @ (ccv @ Xr) @ ccbs) @ (ccfv @ (ccv @ Xs1) @ ccbs)) @ (^ [Xb:$i] : (ccop @ (ccres @ cc2nd @ (ccv @ Xb)) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ cc2nd @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccxpc) @ cchom)))))))))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aopex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (ccop @ XA2 @ XB2) @ ccvv)))).
thf(c_2ndfval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3 @ Xy1) = (cco @ XC @ XD @ ccxpc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XB2 = (ccfv @ (XT @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XH = (ccfv @ (XT @ Xx3 @ Xy1) @ cchom)))) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XQ @ Xx3 @ Xy1) = (cco @ XC @ XD @ cc2ndf)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((XQ @ Xx3 @ Xy1) = (ccop @ (ccres @ cc2nd @ XB2) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ cc2nd @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)))))))))))))))))))))))).
