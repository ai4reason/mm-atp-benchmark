...
thf(apmtr3ncom_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((XT = (ccfv @ XD @ ccpmtr)) => (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XD @ (XV @ Xf1 @ Xg1)) & (cwbr @ cc3 @ (ccfv @ XD @ cchash) @ ccle)) => (cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : ((cccom @ (ccv @ Xg1) @ (ccv @ Xf1)) != (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))) @ (^ [Xg1:$i] : (ccrn @ XT)))) @ (^ [Xf1:$i] : (ccrn @ XT))))))))))).
...
thf(cpgrpgt2nabl_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => (((cwcel @ XA2 @ XV) & (cwbr @ cc2 @ (ccfv @ XA2 @ cchash) @ cclt)) => (cwnel @ XG @ ccabl))))))).
