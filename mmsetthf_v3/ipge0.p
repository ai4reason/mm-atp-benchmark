...
thf(cipge0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV)) => (cwbr @ ccc0 @ (cco @ XA2 @ XA2 @ Xc_xi) @ ccle))))))))).
