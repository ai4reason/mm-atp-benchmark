...
thf(cbnj1533_conj,conjecture,(! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xz:$i] : ((Xth @ Xz) => (cwral @ (^ [Xz:$i] : (~ (cwcel @ (ccv @ Xz) @ (XD @ Xz)))) @ (^ [Xz:$i] : (XB2 @ Xz))))) => ((! [Xz:$i] : (cwss @ (XB2 @ Xz) @ (XA2 @ Xz))) => ((! [Xz:$i] : ((XD @ Xz) = (ccrab @ (^ [Xz:$i] : ((XC @ Xz) != (XE @ Xz))) @ (^ [Xz:$i] : (XA2 @ Xz))))) => (! [Xz:$i] : ((Xth @ Xz) => (cwral @ (^ [Xz:$i] : ((XC @ Xz) = (XE @ Xz))) @ (^ [Xz:$i] : (XB2 @ Xz))))))))))))))).
