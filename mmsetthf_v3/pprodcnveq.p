...
thf(adfpprod2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccpprod @ XA2 @ XB2) = (ccin @ (cccom @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv))) @ (cccom @ XA2 @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv)))) @ (cccom @ (cccnv @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))) @ (cccom @ XB2 @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))))))))).
...
thf(cpprodcnveq_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccpprod @ XR @ XS) = (cccnv @ (ccpprod @ (cccnv @ XR) @ (cccnv @ XS))))))).
