...
thf(cmpfmulcl_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => ((Xc_x = (ccfv @ XS @ ccmulr)) => (((cwcel @ XF @ XQ) & (cwcel @ XG @ XQ)) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_x)) @ XQ)))))))))))).
