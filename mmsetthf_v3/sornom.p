...
thf(csornom_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ ccom) & (cwral @ (^ [Xa:$i] : ((cwbr @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF) @ XR) | ((ccfv @ (ccv @ Xa) @ XF) = (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF)))) @ (^ [Xa:$i] : ccom)) & (cwpo @ (ccrn @ XF) @ XR)) => (cwor @ (ccrn @ XF) @ XR))))).
