...
thf(cntruni_conj,conjecture,(! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XO @ (ccpw @ XX))) => (cwss @ (cciun @ (^ [Xo:$i] : XO) @ (^ [Xo:$i] : (ccfv @ (ccv @ Xo) @ (ccfv @ XJ @ ccnt)))) @ (ccfv @ (ccuni @ XO) @ (ccfv @ XJ @ ccnt))))))))).
