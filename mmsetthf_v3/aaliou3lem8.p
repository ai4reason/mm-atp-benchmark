...
thf(caaliou3lem8_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (cco @ cc2 @ (cco @ cc2 @ (ccneg @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ ccfa)) @ ccexp) @ ccmul) @ (cco @ XB2 @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ ccfa) @ ccexp) @ XA2 @ ccexp) @ ccdiv) @ ccle)) @ (^ [Xx3:$i] : ccn)))))).
