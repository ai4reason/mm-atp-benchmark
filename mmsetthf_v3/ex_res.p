...
thf(aressnop0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((~ (cwcel @ XA2 @ XC)) => ((ccres @ (ccsn @ (ccop @ XA2 @ XB2)) @ XC) = cc0)))))).
thf(aun0_thm,axiom,(! [XA2:($i > $o)] : ((ccun @ XA2 @ cc0) = XA2))).
thf(cex_res_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((XF = (ccpr @ (ccop @ cc2 @ cc6) @ (ccop @ cc3 @ cc9))) & (XB2 = (ccpr @ cc1 @ cc2))) => ((ccres @ XF @ XB2) = (ccsn @ (ccop @ cc2 @ cc6))))))).
