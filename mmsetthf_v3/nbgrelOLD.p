...
thf(cnbgrelOLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (! [Xe:$i] : ((cwcel @ XG @ (XW @ Xe)) => ((cwcel @ XK @ (cco @ XG @ XN @ ccnbgr)) <=> (((cwcel @ XK @ XV) & (cwcel @ XN @ XV)) & (XK != XN) & (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XN @ XK) @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
