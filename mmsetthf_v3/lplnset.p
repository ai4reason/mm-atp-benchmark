...
thf(clplnset_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xx3 @ Xy1) = (ccfv @ XK @ cccvr)))) => ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XK @ cclln))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XP @ Xx3 @ Xy1) = (ccfv @ XK @ cclpl)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XK @ (XA2 @ Xx3 @ Xy1)) => ((XP @ Xx3 @ Xy1) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (XC @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XN @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xy1)))))))))))))))))).
