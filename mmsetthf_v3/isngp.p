...
thf(adf_ngp_ax,axiom,(ccngp = (ccrab @ (^ [Xg1:$i] : (cwss @ (cccom @ (ccfv @ (ccv @ Xg1) @ ccnm) @ (ccfv @ (ccv @ Xg1) @ ccsg)) @ (ccfv @ (ccv @ Xg1) @ ccds))) @ (^ [Xg1:$i] : (ccin @ ccgrp @ ccmt))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) <=> ((Xph & Xps) & Xch)))))).
thf(cisngp_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => ((cwcel @ XG @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ ccmt) & (cwss @ (cccom @ XN @ Xc_mi) @ XD))))))))))).
