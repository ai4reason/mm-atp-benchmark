...
thf(aresghm_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XX @ (ccfv @ XS @ ccsubg))) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccghm)))))))))).
