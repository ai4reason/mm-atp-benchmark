...
thf(cfprg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((((cwcel @ XA2 @ XE) & (cwcel @ XB2 @ XF)) & ((cwcel @ XC @ XG) & (cwcel @ XD @ XH)) & (XA2 != XB2)) => (cwf @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD) @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))))))))))))).
