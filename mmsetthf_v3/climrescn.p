...
thf(cclimrescn_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ (XM @ Xj) @ ccz))) => ((! [Xj:$i] : (XZ = (ccfv @ (XM @ Xj) @ ccuz))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwfn @ XF @ XZ))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ XF @ (ccdm @ ccli)))) => (! [Xj:$i] : ((Xph @ Xj) => (cwrex @ (^ [Xj:$i] : (cwf @ (ccfv @ (ccv @ Xj) @ ccuz) @ ccc @ (ccres @ XF @ (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))))))))))))).
