...
thf(climinfltlem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xj:$i] : (Xph => (cwcel @ (XM @ Xj) @ ccz))) => ((! [Xj:$i] : (XZ = (ccfv @ (XM @ Xj) @ ccuz))) => ((Xph => (cwf @ XZ @ ccr @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ cclsi) @ ccr)) => ((Xph => (cwcel @ XX @ ccrp)) => (Xph => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ XF @ cclsi) @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ XX @ ccaddc) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))).
