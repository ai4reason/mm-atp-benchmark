...
thf(apaddasslem15_thm,axiom,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (! [Xr:$i] : (! [Xp:$i] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((((cwcel @ XK @ cchlt) & ((cwss @ XX @ XA2) & (cwss @ XY @ XA2) & (cwss @ XZ @ XA2)) & ((XY != cc0) & (XZ != cc0))) & ((cwcel @ (ccv @ Xp) @ XA2) & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xr) @ (cco @ XY @ XZ @ Xc_pl))) & (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ Xc_or) @ Xc_le))) => (cwcel @ (ccv @ Xp) @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl))))))))))))))))))).
thf(cpaddasslem16_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & ((cwss @ XX @ XA2) & (cwss @ XY @ XA2) & (cwss @ XZ @ XA2)) & (((XX != cc0) & ((cco @ XY @ XZ @ Xc_pl) != cc0)) & ((XY != cc0) & (XZ != cc0)))) => (cwss @ (cco @ XX @ (cco @ XY @ XZ @ Xc_pl) @ Xc_pl) @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl)))))))))))))))).
