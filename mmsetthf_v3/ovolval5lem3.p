...
thf(aovolval5lem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xn:$i] : ((XQ @ Xf1 @ Xn) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xz) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => ((XY @ Xf1 @ Xn) = (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (XF @ Xz @ Xf1)) @ ccsumge0)))))) => ((! [Xz:$i] : (! [Xn:$i] : ((XZ @ Xn) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (XG @ Xz)) @ ccsumge0)))) => ((! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xz @ Xf1) => (cwf @ ccn @ (ccxp @ ccr @ ccr) @ (XF @ Xz @ Xf1))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccico @ (XF @ Xz @ Xf1))))))))) => ((! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xz @ Xf1) => (cwcel @ (XW @ Xf1) @ ccrp)))) => ((! [Xz:$i] : (! [Xf1:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc1st) @ (cco @ (XW @ Xf1) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc2nd))))))) => (! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (XY @ Xf1 @ Xn) @ (XW @ Xf1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : (XQ @ Xf1 @ Xn))))))))))))))))))))))).
...
thf(covolval5lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xf1:$i] : ((XM @ Xf1) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccico @ (ccv @ Xf1))))) & ((ccv @ Xy1) = (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr)))) => ((XQ = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xz) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))) => (! [Xf1:$i] : ((ccinf @ XQ @ ccxr @ cclt) = (ccinf @ (XM @ Xf1) @ ccxr @ cclt))))))))).
