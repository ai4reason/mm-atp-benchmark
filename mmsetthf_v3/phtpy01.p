...
thf(cphtpy01_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)))) => (Xph => (((ccfv @ ccc0 @ XF) = (ccfv @ ccc0 @ XG)) & ((ccfv @ cc1 @ XF) = (ccfv @ cc1 @ XG))))))))))))).
