...
thf(cfrege133d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ ccvv)) => ((Xph => (cwbr @ XX @ XA2 @ (ccfv @ XF @ cctcl))) => ((Xph => (cwbr @ XX @ XB2 @ (ccfv @ XF @ cctcl))) => ((Xph => (cwfun @ XF)) => (Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XF @ cctcl)) | (XA2 = XB2) | (cwbr @ XB2 @ XA2 @ (ccfv @ XF @ cctcl)))))))))))))).
