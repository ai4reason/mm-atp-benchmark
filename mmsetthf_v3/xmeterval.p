...
thf(cxmeterval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccima @ (cccnv @ XD) @ ccr)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwbr @ XA2 @ XB2 @ Xc_sm) <=> ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ (cco @ XA2 @ XB2 @ XD) @ ccr))))))))))).
