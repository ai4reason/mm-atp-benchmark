...
thf(copabex3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ ccvv))) => (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (Xph @ Xx3 @ Xy1))))) @ ccvv)))))).
