...
thf(ccardmin2_conj,conjecture,(! [XA2:($i > $o)] : ((cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0)) <=> ((ccfv @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))) @ cccrd) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))))))).
