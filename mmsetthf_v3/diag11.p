...
thf(cdiag11_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XX @ XA2)) => ((XK = (ccfv @ XX @ (ccfv @ XL @ cc1st))) => ((XB2 = (ccfv @ XD @ ccbs)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((ccfv @ XY @ (ccfv @ XK @ cc1st)) = XX)))))))))))))))))))).
