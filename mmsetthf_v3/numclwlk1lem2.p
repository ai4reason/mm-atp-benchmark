...
thf(awlksnfi_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ ccn0)) => (cwcel @ (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ ccfn))))).
