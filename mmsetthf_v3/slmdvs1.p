...
thf(aslmd1cl_thm,axiom,(! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_1 = (ccfv @ XF @ ccur)) => ((cwcel @ XW @ ccslmd) => (cwcel @ Xc_1 @ XK)))))))))).
...
thf(cslmdvs1_conj,conjecture,(! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_1 = (ccfv @ XF @ ccur)) => (((cwcel @ XW @ ccslmd) & (cwcel @ XX @ XV)) => ((cco @ Xc_1 @ XX @ Xc_x) = XX))))))))))))).
