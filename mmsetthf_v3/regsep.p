...
thf(cregsep_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ ccreg) & (cwcel @ XU @ XJ) & (cwcel @ XA2 @ XU)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) & (cwss @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XU))) @ (^ [Xx3:$i] : XJ))))))).
