...
thf(cvolsupnfl_conj,conjecture,(! [XA2:($i > $o)] : ((! [Xf1:$i] : (((cwf @ ccn @ (ccdm @ ccvol) @ (ccv @ Xf1)) & (cwral @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccv @ Xf1)))) @ (^ [Xn:$i] : ccn))) => ((ccfv @ (ccuni @ (ccrn @ (ccv @ Xf1))) @ ccvol) = (ccsup @ (ccima @ ccvol @ (ccrn @ (ccv @ Xf1))) @ ccxr @ cclt)))) => (((cwbr @ XA2 @ ccn @ ccdom) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ ccn @ ccdom)) @ (^ [Xx3:$i] : XA2))) => ((ccuni @ XA2) != ccr))))).
