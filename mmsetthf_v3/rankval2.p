...
thf(arankvalg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((ccfv @ XA2 @ ccrnk) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ ccr1))) @ (^ [Xx3:$i] : ccon0))))))))).
...
thf(crankval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XB2 @ Xx3)) => ((ccfv @ XA2 @ ccrnk) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccr1))) @ (^ [Xx3:$i] : ccon0))))))))).
