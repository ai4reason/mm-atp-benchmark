...
thf(ckbass2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil)) => ((cco @ (ccfv @ XB2 @ (ccfv @ XA2 @ ccbr)) @ (ccfv @ XC @ ccbr) @ cchft) = (cccom @ (ccfv @ XA2 @ ccbr) @ (cco @ XB2 @ XC @ cck)))))))).
