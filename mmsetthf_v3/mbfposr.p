...
thf(aismbf2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwf @ (XA2 @ Xx3) @ ccr @ XF))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccdm @ ccvol)))) => (Xph => (cwcel @ XF @ ccmbf)))))))))).
...
thf(aelioomnf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cwcel @ XB2 @ (cco @ ccmnf @ XA2 @ ccioo)) <=> ((cwcel @ XB2 @ ccr) & (cwbr @ XB2 @ XA2 @ cclt))))))).
...
thf(cmbfposr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle) @ (XB2 @ Xx3) @ ccc0))) @ ccmbf)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (ccneg @ (XB2 @ Xx3)) @ ccle) @ (ccneg @ (XB2 @ Xx3)) @ ccc0))) @ ccmbf)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmbf))))))))).
