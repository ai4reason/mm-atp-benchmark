...
thf(atxbasval_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XR @ XV) & (cwcel @ XS @ XW)) => ((cco @ (ccfv @ XR @ cctg) @ (ccfv @ XS @ cctg) @ cctx) = (cco @ XR @ XS @ cctx)))))))).
...
thf(aimauni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccima @ XA2 @ (ccuni @ XB2)) = (cciun @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccima @ XA2 @ (ccv @ Xx3)))))))).
...
thf(afores_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwss @ XA2 @ (ccdm @ XF))) => (cwfo @ XA2 @ (ccima @ XF @ XA2) @ (ccres @ XF @ XA2)))))).
...
thf(anumdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ XB2 @ XA2 @ ccdom)) => (cwcel @ XB2 @ (ccdm @ cccrd)))))).
...
thf(ambff_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccmbf) => (cwf @ (ccdm @ XF) @ ccc @ XF)))).
...
thf(aismbf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ ccr @ XF) => ((cwcel @ XF @ ccmbf) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ (ccdm @ ccvol))) @ (^ [Xx3:$i] : (ccrn @ ccioo)))))))).
...
thf(cmbfimaopnlem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XG = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))))) => ((XB2 = (ccima @ ccioo @ (ccxp @ ccq @ ccq))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))))) => (! [Xy1:$i] : (((cwcel @ XF @ ccmbf) & (cwcel @ (XA2 @ Xy1) @ XJ)) => (cwcel @ (ccima @ (cccnv @ XF) @ (XA2 @ Xy1)) @ (ccdm @ ccvol))))))))))))))).
