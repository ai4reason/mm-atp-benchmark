...
thf(cnbupgrel_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XG @ ccupgr) & (cwcel @ XK @ XV)) & ((cwcel @ XN @ XV) & (XN != XK))) => ((cwcel @ XN @ (cco @ XG @ XK @ ccnbgr)) <=> (cwcel @ (ccpr @ XN @ XK) @ XE))))))))))).
