...
thf(cdftrpred3g_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XA2) & (cwse @ XA2 @ XR)) => ((cctrpred @ XA2 @ XR @ XX) = (ccun @ (ccpred @ XA2 @ XR @ XX) @ (cciun @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ XX)) @ (^ [Xy1:$i] : (cctrpred @ XA2 @ XR @ (ccv @ Xy1))))))))))).
