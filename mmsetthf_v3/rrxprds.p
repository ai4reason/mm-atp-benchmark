...
thf(crrxprds_conj,conjecture,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XH = (ccfv @ XI @ ccrrx)) => ((XB2 = (ccfv @ XH @ ccbs)) => ((cwcel @ XI @ XV) => (XH = (ccfv @ (cco @ (cco @ ccrefld @ (ccxp @ XI @ (ccsn @ (ccfv @ ccr @ (ccfv @ ccrefld @ ccsra)))) @ ccprds) @ XB2 @ ccress) @ cctch)))))))))).
