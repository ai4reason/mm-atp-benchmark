...
thf(crestutop_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwss @ XA2 @ XX)) => (cwss @ (cco @ (ccfv @ XU @ ccutop) @ XA2 @ ccrest) @ (ccfv @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ ccutop))))))).
