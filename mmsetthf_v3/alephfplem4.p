...
thf(aalephfplem1_thm,axiom,(! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (cwcel @ (ccfv @ cc0 @ XH) @ (ccrn @ ccale))))).
...
thf(acardinfima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XB2 @ Xx3)) => (((cwf @ XA2 @ (ccun @ ccom @ (ccrn @ ccale)) @ XF) & (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccrn @ ccale))) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (ccuni @ (ccima @ XF @ XA2)) @ (ccrn @ ccale))))))))).
thf(calephfplem4_conj,conjecture,(! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (cwcel @ (ccuni @ (ccima @ XH @ ccom)) @ (ccrn @ ccale))))).
