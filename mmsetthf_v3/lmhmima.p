...
thf(clmhmima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XS @ cclss)) => ((XY = (ccfv @ XT @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XU @ XX)) => (cwcel @ (ccima @ XF @ XU) @ XY))))))))))).
