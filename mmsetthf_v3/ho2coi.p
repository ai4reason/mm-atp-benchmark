...
thf(cho2coi_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => ((cwcel @ XA2 @ cchil) => ((ccfv @ XA2 @ (cccom @ (cccom @ XR @ XS) @ XT)) = (ccfv @ (ccfv @ (ccfv @ XA2 @ XT) @ XS) @ XR))))))))))).
