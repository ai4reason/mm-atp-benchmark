...
thf(ccnfcf_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ XF @ (cco @ XK @ (ccv @ Xf1) @ ccfcf)))) @ (^ [Xx3:$i] : (cco @ XJ @ (ccv @ Xf1) @ ccfcls)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))))))).
