...
thf(almres_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ ccpm))) => ((Xph => (cwcel @ XM @ ccz)) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ (ccres @ XF @ (ccfv @ XM @ ccuz)) @ XP @ (ccfv @ XJ @ cclm)))))))))))))).
...
thf(cxlimres_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccxr @ ccc @ ccpm))) => ((Xph => (cwcel @ XM @ ccz)) => (Xph => ((cwbr @ XF @ XA2 @ cclsxlim) <=> (cwbr @ (ccres @ XF @ (ccfv @ XM @ ccuz)) @ XA2 @ cclsxlim)))))))))).
