...
thf(amulcmpblnrlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cco @ XA2 @ XD @ ccpp) = (cco @ XB2 @ XC @ ccpp)) & ((cco @ XF @ XS @ ccpp) = (cco @ XG @ XR @ ccpp))) => ((cco @ (cco @ XD @ XF @ ccmp) @ (cco @ (cco @ (cco @ XA2 @ XF @ ccmp) @ (cco @ XB2 @ XG @ ccmp) @ ccpp) @ (cco @ (cco @ XC @ XS @ ccmp) @ (cco @ XD @ XR @ ccmp) @ ccpp) @ ccpp) @ ccpp) = (cco @ (cco @ XD @ XF @ ccmp) @ (cco @ (cco @ (cco @ XA2 @ XG @ ccmp) @ (cco @ XB2 @ XF @ ccmp) @ ccpp) @ (cco @ (cco @ XC @ XR @ ccmp) @ (cco @ XD @ XS @ ccmp) @ ccpp) @ ccpp) @ ccpp)))))))))))).
...
thf(aaddcanpr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => (((cco @ XA2 @ XB2 @ ccpp) = (cco @ XA2 @ XC @ ccpp)) => (XB2 = XC))))))).
thf(asyl22anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => ((Xph => Xta) => ((((Xps & Xch) & (Xth & Xta)) => Xet) => (Xph => Xet))))))))))))).
thf(asyl2an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xta => Xch) => (((Xps & Xch) => Xth) => ((Xph & Xta) => Xth)))))))))).
thf(aenrbreq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) & ((cwcel @ XC @ ccnp) & (cwcel @ XD @ ccnp))) => ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccer) <=> ((cco @ XA2 @ XD @ ccpp) = (cco @ XB2 @ XC @ ccpp))))))))).
thf(cmulcmpblnr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) & ((cwcel @ XC @ ccnp) & (cwcel @ XD @ ccnp))) & (((cwcel @ XF @ ccnp) & (cwcel @ XG @ ccnp)) & ((cwcel @ XR @ ccnp) & (cwcel @ XS @ ccnp)))) => ((((cco @ XA2 @ XD @ ccpp) = (cco @ XB2 @ XC @ ccpp)) & ((cco @ XF @ XS @ ccpp) = (cco @ XG @ XR @ ccpp))) => (cwbr @ (ccop @ (cco @ (cco @ XA2 @ XF @ ccmp) @ (cco @ XB2 @ XG @ ccmp) @ ccpp) @ (cco @ (cco @ XA2 @ XG @ ccmp) @ (cco @ XB2 @ XF @ ccmp) @ ccpp)) @ (ccop @ (cco @ (cco @ XC @ XR @ ccmp) @ (cco @ XD @ XS @ ccmp) @ ccpp) @ (cco @ (cco @ XC @ XS @ ccmp) @ (cco @ XD @ XR @ ccmp) @ ccpp)) @ ccer)))))))))))).
