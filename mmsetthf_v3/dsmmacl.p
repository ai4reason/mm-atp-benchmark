...
thf(cdsmmacl_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((XH = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccmnd @ XR)) => ((Xph => (cwcel @ XJ @ XH)) => ((Xph => (cwcel @ XK @ XH)) => ((Xc_pl = (ccfv @ XP @ ccplusg)) => (Xph => (cwcel @ (cco @ XJ @ XK @ Xc_pl) @ XH)))))))))))))))))))))).
