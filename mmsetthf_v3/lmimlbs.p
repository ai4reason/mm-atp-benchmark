...
thf(alindsmm2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => (((cwcel @ XG @ (cco @ XS @ XT @ cclmhm)) & (cwf1 @ XB2 @ XC @ XG) & (cwcel @ XF @ (ccfv @ XS @ cclinds))) => (cwcel @ (ccima @ XG @ XF) @ (ccfv @ XT @ cclinds)))))))))))).
...
thf(albsss_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cclbs)) => ((cwcel @ XB2 @ XJ) => (cwss @ XB2 @ XV))))))))).
...
thf(clmimlbs_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cclbs)) => ((XK = (ccfv @ XT @ cclbs)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmim)) & (cwcel @ XB2 @ XJ)) => (cwcel @ (ccima @ XF @ XB2) @ XK))))))))))).
