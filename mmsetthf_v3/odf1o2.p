...
thf(afzocongeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XC @ XD @ ccfzo)) & (cwcel @ XB2 @ (cco @ XC @ XD @ ccfzo))) => ((cwbr @ (cco @ XD @ XC @ ccmin) @ (cco @ XA2 @ XB2 @ ccmin) @ ccdvds) <=> (XA2 = XB2)))))))).
...
thf(aodcong_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz))) => ((cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XM @ XN @ ccmin) @ ccdvds) <=> ((cco @ XM @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))))).
...
thf(aodmod_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((cco @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccmo) @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))).
...
thf(codf1o2_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => (cwf1o @ (cco @ ccc0 @ (ccfv @ XA2 @ XO) @ ccfzo) @ (ccfv @ (ccsn @ XA2) @ XK) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XA2 @ XO) @ ccfzo)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x)))))))))))))))).
