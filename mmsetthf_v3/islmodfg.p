...
thf(adf_lfig_ax,axiom,(cclfig = (ccrab @ (^ [Xw:$i] : (cwcel @ (ccfv @ (ccv @ Xw) @ ccbs) @ (ccima @ (ccfv @ (ccv @ Xw) @ cclspn) @ (ccin @ (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)) @ ccfn)))) @ (^ [Xw:$i] : cclmod)))).
...
thf(alspf_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => ((cwcel @ XW @ cclmod) => (cwf @ (ccpw @ XV) @ XS @ XN)))))))))).
...
thf(cislmodfg_conj,conjecture,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((cwcel @ XW @ cclmod) => ((cwcel @ XW @ cclfig) <=> (cwrex @ (^ [Xb:$i] : ((cwcel @ (ccv @ Xb) @ ccfn) & ((ccfv @ (ccv @ Xb) @ XN) = XB2))) @ (^ [Xb:$i] : (ccpw @ XB2))))))))))).
