...
thf(cghmf1o_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XS @ ccbs)) => ((XY = (ccfv @ XT @ ccbs)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) => ((cwf1o @ XX @ XY @ XF) <=> (cwcel @ (cccnv @ XF) @ (cco @ XT @ XS @ ccghm)))))))))))).
