...
thf(aimasle_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwfo @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ XZ)) => ((XN = (ccfv @ XR @ ccple)) => ((Xc_le = (ccfv @ XU @ ccple)) => (Xph => (Xc_le = (cccom @ (cccom @ XF @ XN) @ (cccnv @ XF)))))))))))))))))))).
