...
thf(clidldomnnring_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccdomn) & ((cwcel @ XU @ XL) & (XU != (ccsn @ Xc_0)) & (XU != XB2))) => (cwnel @ XI @ ccrg))))))))))))).
