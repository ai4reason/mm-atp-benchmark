...
thf(aefiasin_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ cci @ (ccfv @ XA2 @ ccasin) @ ccmul) @ cce) = (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccaddc))))).
...
thf(ccosasin_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccfv @ XA2 @ ccasin) @ cccos) = (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ ccsqrt))))).
