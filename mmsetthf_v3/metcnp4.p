...
thf(cmetcnp4_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XC @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XD @ (ccfv @ XY @ ccxmt))) => ((Xph => (cwcel @ XP @ XX)) => (Xph => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (! [Xf1:$i] : (((cwf @ ccn @ XX @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XJ @ cclm))) => (cwbr @ (cccom @ XF @ (ccv @ Xf1)) @ (ccfv @ XP @ XF) @ (ccfv @ XK @ cclm)))))))))))))))))))))).
