...
thf(adf_dvr_ax,axiom,(ccdvr = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xr) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xr) @ ccui))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xr) @ ccinvr)) @ (ccfv @ (ccv @ Xr) @ ccmulr))))))))).
...
thf(cdvrfval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_dv @ Xx3 @ Xy1) = (ccfv @ XR @ ccdvr)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xc_dv @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XU)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XI) @ Xc_x))))))))))))))))))).
