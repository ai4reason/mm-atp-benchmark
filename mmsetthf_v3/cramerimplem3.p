...
thf(ccramerimplem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xo:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((XE = (ccfv @ XI @ (cco @ (ccfv @ XA2 @ ccur) @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((XH = (ccfv @ XI @ (cco @ XX @ XY @ (cco @ XN @ XR @ ccmatrepV)))) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((Xc_xo = (ccfv @ XR @ ccmulr)) => ((((cwcel @ XR @ cccrg) & (cwcel @ XI @ XN)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV)) & ((cco @ XX @ XZ @ Xc_x) = XY)) => ((cco @ (ccfv @ XX @ XD) @ (ccfv @ XE @ XD) @ Xc_xo) = (ccfv @ XH @ XD)))))))))))))))))))))))))).
