...
thf(aplydivlem2_thm,axiom,(! [Xph:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xq:$i] : (((Xph @ Xq) & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xq:$i] : (((Xph @ Xq) & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS))))) => ((! [Xx3:$i] : (! [Xq:$i] : (((Xph @ Xq) & ((cwcel @ (ccv @ Xx3) @ XS) & ((ccv @ Xx3) != ccc0))) => (cwcel @ (cco @ cc1 @ (ccv @ Xx3) @ ccdiv) @ XS)))) => ((! [Xq:$i] : ((Xph @ Xq) => (cwcel @ (ccneg @ cc1) @ XS))) => ((! [Xq:$i] : ((Xph @ Xq) => (cwcel @ XF @ (ccfv @ XS @ ccply)))) => ((! [Xq:$i] : ((Xph @ Xq) => (cwcel @ XG @ (ccfv @ XS @ ccply)))) => ((! [Xq:$i] : ((Xph @ Xq) => (XG != cc0p))) => ((! [Xq:$i] : ((XR @ Xq) = (cco @ XF @ (cco @ XG @ (ccv @ Xq) @ (ccof @ ccmul)) @ (ccof @ ccmin)))) => (! [Xq:$i] : (((Xph @ Xq) & (cwcel @ (ccv @ Xq) @ (ccfv @ XS @ ccply))) => (cwcel @ (XR @ Xq) @ (ccfv @ XS @ ccply)))))))))))))))))).
...
thf(aplymul0or_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (((cco @ XF @ XG @ (ccof @ ccmul)) = cc0p) <=> ((XF = cc0p) | (XG = cc0p)))))))).
