...
thf(ccshwleneq_conj,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV))) & ((cwcel @ XN @ ccz) & (cwcel @ XM @ ccz)) & ((cco @ XW @ XN @ cccsh) = (cco @ XU @ XM @ cccsh))) => ((ccfv @ XW @ cchash) = (ccfv @ XU @ cchash))))))))).
