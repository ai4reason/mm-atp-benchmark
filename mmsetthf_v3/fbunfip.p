...
thf(afbasfip_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfbas)) => (~ (cwcel @ cc0 @ (ccfv @ XF @ ccfi))))))).
...
thf(cfbunfip_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XG @ (ccfv @ XY @ ccfbas))) => ((~ (cwcel @ cc0 @ (ccfv @ (ccun @ XF @ XG) @ ccfi))) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) != cc0)) @ (^ [Xy1:$i] : XG))) @ (^ [Xx3:$i] : XF))))))))).
