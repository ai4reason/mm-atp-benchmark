...
thf(cf13dfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cctp @ XX @ XY @ XZ)) => ((((cwcel @ XX @ XU) & (cwcel @ XY @ XV) & (cwcel @ XZ @ XW)) & ((XX != XY) & (XX != XZ) & (XY != XZ))) => ((cwf1 @ XA2 @ XB2 @ XF) <=> ((cwf @ XA2 @ XB2 @ XF) & (((ccfv @ XX @ XF) != (ccfv @ XY @ XF)) & ((ccfv @ XX @ XF) != (ccfv @ XZ @ XF)) & ((ccfv @ XY @ XF) != (ccfv @ XZ @ XF))))))))))))))))).
