...
thf(ai1fibl_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ XF @ ccibl)))).
thf(aeqtr4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XB2)) => (Xph => (XA2 = XC))))))))).
thf(aoveq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(aeqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(aitgitg2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (XA2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwbr @ ccc0 @ (XA2 @ Xx3) @ ccle))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccibl)) => (Xph => ((ccitg @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccitg2))))))))).
...
thf(citgitg1_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => ((ccitg @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) = (ccfv @ XF @ ccitg1))))).
