...
thf(cicoshft_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ ccico)) => (cwcel @ (cco @ XX @ XC @ ccaddc) @ (cco @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ ccico))))))))).
