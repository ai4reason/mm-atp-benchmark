...
thf(a_4ipval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ ccnv) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cco @ cc4 @ (cco @ XA2 @ XB2 @ XP) @ ccmul) = (cco @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ XG) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ ccmin) @ (cco @ cci @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ (ccneg @ cci) @ XB2 @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ ccaddc))))))))))))))))).
...
thf(aip0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XA2 @ XX) => ((cwcel @ XB2 @ XX) => ((cwcel @ XC @ XX) => ((XN = (ccfv @ XU @ ccnmcv)) => ((cwcel @ XJ @ ccc) => ((cco @ (cco @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ XG) @ (cco @ XJ @ XC @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ XG) @ (cco @ (ccneg @ XJ) @ XC @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ ccmin) @ (cco @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ XS) @ XG) @ (cco @ XJ @ XC @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ XS) @ XG) @ (cco @ (ccneg @ XJ) @ XC @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ ccmin) @ ccaddc) = (cco @ cc2 @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ XJ @ XC @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ (ccneg @ XJ) @ XC @ XS) @ XG) @ XN) @ cc2 @ ccexp) @ ccmin) @ ccmul))))))))))))))))))))))).
