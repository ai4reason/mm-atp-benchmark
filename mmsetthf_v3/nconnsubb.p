...
thf(cnconnsubb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => (cwcel @ XU @ XJ)) => ((Xph => (cwcel @ XV @ XJ)) => ((Xph => ((ccin @ XU @ XA2) != cc0)) => ((Xph => ((ccin @ XV @ XA2) != cc0)) => ((Xph => ((ccin @ (ccin @ XU @ XV) @ XA2) = cc0)) => ((Xph => (cwss @ XA2 @ (ccun @ XU @ XV))) => (Xph => (~ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn)))))))))))))))))).
