...
thf(aretancld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ cccos) != ccc0)) => (Xph => (cwcel @ (ccfv @ XA2 @ cctan) @ ccr))))))).
...
thf(acosq14gt0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ cccos) @ cclt)))).
...
thf(asinord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)) & (cwcel @ XB2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ cclt)))))).
...
thf(acosord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpi @ ccicc))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XB2 @ cccos) @ (ccfv @ XA2 @ cccos) @ cclt)))))).
