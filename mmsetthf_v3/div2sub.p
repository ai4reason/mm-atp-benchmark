...
thf(cdiv2sub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ ccc) & (cwcel @ XD @ ccc) & (XC != XD))) => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccdiv) = (cco @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ XD @ XC @ ccmin) @ ccdiv)))))))).
