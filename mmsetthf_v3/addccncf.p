...
thf(caddccncf_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccaddc))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ ccc) => (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf)))))))).
