...
thf(ccnpimaex_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) & (cwcel @ XA2 @ XK) & (cwcel @ (ccfv @ XP @ XF) @ XA2)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ XA2))) @ (^ [Xx3:$i] : XJ))))))))).
