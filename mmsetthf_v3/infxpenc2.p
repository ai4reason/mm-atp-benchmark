...
thf(acnfcom3c_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (? [Xg1:$i] : (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2)))))).
...
thf(ainfxpenc2lem3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xg1:$i] : (! [Xn:$i] : ((Xph @ Xg1 @ Xn) => (cwcel @ XA2 @ ccon0)))) => ((! [Xg1:$i] : (! [Xn:$i] : ((Xph @ Xg1 @ Xn) => (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2))))) => ((! [Xn:$i] : (! [Xb:$i] : ((XW @ Xn @ Xb) = (ccfv @ (ccrn @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccon0 @ cc1o)) @ (^ [Xx3:$i] : (cco @ ccom @ (ccv @ Xx3) @ ccoe)))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xn) => (cwf1o @ (cco @ ccom @ cc2o @ ccoe) @ ccom @ (XF @ Xw @ Xn @ Xb))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xn) => ((ccfv @ cc0 @ (XF @ Xw @ Xn @ Xb)) = cc0)))))) => (! [Xg1:$i] : (! [Xn:$i] : ((Xph @ Xg1 @ Xn) => (? [Xg1:$i] : (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwf1o @ (ccxp @ (ccv @ Xb) @ (ccv @ Xb)) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1))))) @ (^ [Xb:$i] : XA2)))))))))))))))).
...
thf(cinfxpenc2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (? [Xg1:$i] : (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwf1o @ (ccxp @ (ccv @ Xb) @ (ccv @ Xb)) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1))))) @ (^ [Xb:$i] : XA2)))))).
