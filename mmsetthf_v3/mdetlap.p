...
thf(amadjusmdet_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XA2 = (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmat)) => ((XD = (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmdat)) => ((XK = (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmadu)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XZ = (ccfv @ XR @ cczrh)) => ((XE = (cco @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ XR @ ccmdat)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XI @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XJ @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XM @ XB2)) => (Xph => ((cco @ XJ @ XI @ (ccfv @ XM @ XK)) = (cco @ (ccfv @ (cco @ (ccneg @ cc1) @ (cco @ XI @ XJ @ ccaddc) @ ccexp) @ XZ) @ (ccfv @ (cco @ XI @ XJ @ (ccfv @ XM @ ccsmat)) @ XE) @ Xc_x))))))))))))))))))))))))))))).
