...
thf(crrnmval_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ ccr @ XI @ ccmap)) => (((cwcel @ XI @ ccfn) & (cwcel @ XF @ XX) & (cwcel @ XG @ XX)) => ((cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) = (ccfv @ (ccsu @ XI @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt))))))))).
