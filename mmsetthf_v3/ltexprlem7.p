...
thf(aprlem934_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XA2 @ ccnp) => (cwrex @ (^ [Xx3:$i] : (~ (cwcel @ (cco @ (ccv @ Xx3) @ XB2 @ ccplq) @ XA2))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cltexprlem7_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((XC @ Xy1) = (^ [Xx3:$i] : (? [Xy1:$i] : ((~ (cwcel @ (ccv @ Xy1) @ XA2)) & (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccplq) @ XB2)))))) => (! [Xy1:$i] : ((((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) & (cwpss @ XA2 @ XB2)) => (cwss @ XB2 @ (cco @ XA2 @ (XC @ Xy1) @ ccpp))))))))).
