...
thf(azerooval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => (Xph => ((ccfv @ XC @ cczeroo) = (ccin @ (ccfv @ XC @ ccinito) @ (ccfv @ XC @ cctermo)))))))))))).
...
thf(aiszeroo_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XI @ XB2)) => (Xph => ((cwcel @ XI @ (ccfv @ XC @ cczeroo)) <=> ((cwcel @ XI @ (ccfv @ XC @ ccinito)) & (cwcel @ XI @ (ccfv @ XC @ cctermo))))))))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(ciszeroi_conj,conjecture,(! [XC:($i > $o)] : (! [XO:($i > $o)] : (((cwcel @ XC @ cccat) & (cwcel @ XO @ (ccfv @ XC @ cczeroo))) => ((cwcel @ XO @ (ccfv @ XC @ ccbs)) & ((cwcel @ XO @ (ccfv @ XC @ ccinito)) & (cwcel @ XO @ (ccfv @ XC @ cctermo)))))))).
