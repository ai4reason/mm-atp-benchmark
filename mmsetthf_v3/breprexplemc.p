...
thf(aprodeq1d_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : ((Xph @ Xk) => (XA2 = XB2))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))).
...
thf(abreprexplemb_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XZ @ ccc)) => ((Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => ((Xph => (cwcel @ XY @ ccn)) => (Xph => (cwcel @ (ccfv @ XY @ (ccfv @ XX @ XL)) @ ccc)))))))))))))))).
...
thf(aeluz1_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => ((cwcel @ XN @ (ccfv @ XM @ ccuz)) <=> ((cwcel @ XN @ ccz) & (cwbr @ XM @ XN @ ccle))))))).
...
thf(areprfi_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XA2 @ ccfn)) => (Xph => (cwcel @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ ccfn))))))))))).
...
thf(areprf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))) => (Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ XA2 @ XC)))))))))))).
...
thf(areprgt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwss @ XA2 @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwbr @ (cco @ XS @ XN @ ccmul) @ XM @ cclt)) => (Xph => ((cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) = cc0))))))))))))).
...
thf(afz2ssnn0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccn0) => (cwss @ (cco @ XM @ XN @ ccfz) @ ccn0))))).
...
thf(areprlt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwbr @ XM @ XS @ cclt)) => (Xph => ((cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) = cc0))))))))))).
...
thf(asublt0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ cclt) <=> (cwbr @ XA2 @ XB2 @ cclt))))))))).
