...
thf(amrcf_thm,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) => (cwf @ (ccpw @ XX) @ XC @ XF))))))).
