...
thf(axkoccn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XR @ (ccfv @ XX @ cctopon)) & (cwcel @ XS @ (ccfv @ XY @ cctopon))) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (ccxp @ XX @ (ccsn @ (ccv @ Xx3))))) @ (cco @ XS @ (cco @ XS @ XR @ ccxko) @ cccn)))))))).
...
thf(cxkofvcn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccuni @ XR)) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XF @ Xx3 @ Xf1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xx3:$i] : (cco @ XR @ XS @ cccn))) @ (^ [Xf1:$i] : (^ [Xx3:$i] : XX)) @ (^ [Xf1:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (((cwcel @ XR @ (ccnlly @ cccmp)) & (cwcel @ XS @ cctop)) => (cwcel @ (XF @ Xx3 @ Xf1) @ (cco @ (cco @ (cco @ XS @ XR @ ccxko) @ XR @ cctx) @ XS @ cccn)))))))))))).
