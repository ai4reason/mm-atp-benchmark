...
thf(cuhgrissubgr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XS @ ccvtx)) => ((XA2 = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XS @ cciedg)) => ((XB2 = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ XW) & (cwfun @ XB2) & (cwcel @ XS @ ccuhgr)) => ((cwbr @ XS @ XG @ ccsubgr) <=> ((cwss @ XV @ XA2) & (cwss @ XI @ XB2)))))))))))))))).
