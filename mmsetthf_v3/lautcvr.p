...
thf(clautcvr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XC = (ccfv @ XK @ cccvr)) => ((XI = (ccfv @ XK @ cclaut)) => (((cwcel @ XK @ XA2) & ((cwcel @ XF @ XI) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cwbr @ XX @ XY @ XC) <=> (cwbr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XC))))))))))))))).
