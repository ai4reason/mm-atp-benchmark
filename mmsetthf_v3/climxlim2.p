...
thf(aclimxlim2lem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccxr @ XF)) => ((Xph => (cwf @ XZ @ ccc @ XF)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => (Xph => (cwbr @ XF @ XA2 @ cclsxlim))))))))))))).
...
thf(cclimxlim2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccxr @ XF)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => (Xph => (cwbr @ XF @ XA2 @ cclsxlim)))))))))))).
