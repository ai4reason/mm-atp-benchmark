...
thf(aitg2addnclem_thm,axiom,(! [XF:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((XL @ Xx3 @ Xy1 @ Xz @ Xg1) = (^ [Xx3:$i] : (cwrex @ (^ [Xg1:$i] : ((cwrex @ (^ [Xy1:$i] : (cwbr @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccif @ ((ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) = ccc0) @ ccc0 @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xy1) @ ccaddc)))) @ XF @ (ccofr @ ccle))) @ (^ [Xy1:$i] : ccrp)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xg1) @ ccitg1)))) @ (^ [Xg1:$i] : (ccdm @ ccitg1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) => ((ccfv @ XF @ ccitg2) = (ccsup @ (XL @ Xx3 @ Xy1 @ Xz @ Xg1) @ ccxr @ cclt))))))))))).
