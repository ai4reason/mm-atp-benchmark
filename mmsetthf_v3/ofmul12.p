...
thf(cofmul12_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccc @ XF)) & ((cwf @ XA2 @ ccc @ XG) & (cwf @ XA2 @ ccc @ XH))) => ((cco @ XF @ (cco @ XG @ XH @ (ccof @ ccmul)) @ (ccof @ ccmul)) = (cco @ XG @ (cco @ XF @ XH @ (ccof @ ccmul)) @ (ccof @ ccmul)))))))))).
