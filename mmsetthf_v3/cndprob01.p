...
thf(aunitdivcld_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ cc1 @ ccicc)) & (XB2 != ccc0)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ ccc0 @ cc1 @ ccicc))))))).
thf(ccndprob01_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((((cwcel @ XP @ ccprb) & (cwcel @ XA2 @ (ccdm @ XP)) & (cwcel @ XB2 @ (ccdm @ XP))) & ((ccfv @ XB2 @ XP) != ccc0)) => (cwcel @ (ccfv @ (ccop @ XA2 @ XB2) @ (ccfv @ XP @ cccprob)) @ (cco @ ccc0 @ cc1 @ ccicc))))))).
