...
thf(ccolineardim1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ XW))) => ((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin) => (cwcel @ XA2 @ (ccfv @ XN @ ccee))))))))))).
