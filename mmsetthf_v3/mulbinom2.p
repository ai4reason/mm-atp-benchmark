...
thf(cmulbinom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ ccc)) => ((cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ XB2 @ ccaddc) @ cc2 @ ccexp) = (cco @ (cco @ (cco @ (cco @ XC @ XA2 @ ccmul) @ cc2 @ ccexp) @ (cco @ (cco @ cc2 @ XC @ ccmul) @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc))))))).
