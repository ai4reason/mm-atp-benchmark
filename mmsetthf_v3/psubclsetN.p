...
thf(cpsubclsetN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_pe:($i > ($i > $o))] : ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xs1:$i] : ((Xc_pe @ Xs1) = (ccfv @ XK @ ccpolN))) => ((! [Xs1:$i] : ((XC @ Xs1) = (ccfv @ XK @ ccpscN))) => (! [Xs1:$i] : ((cwcel @ XK @ (XB2 @ Xs1)) => ((XC @ Xs1) = (^ [Xs1:$i] : ((cwss @ (ccv @ Xs1) @ XA2) & ((ccfv @ (ccfv @ (ccv @ Xs1) @ (Xc_pe @ Xs1)) @ (Xc_pe @ Xs1)) = (ccv @ Xs1)))))))))))))))).
