...
thf(alatmrot_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_an = (ccfv @ XK @ ccmee)) => (((cwcel @ XK @ ccol) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2))) => ((cco @ (cco @ XX @ XY @ Xc_an) @ XZ @ Xc_an) = (cco @ (cco @ XZ @ XX @ Xc_an) @ XY @ Xc_an)))))))))))).
...
thf(aolm02_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => (((cwcel @ XK @ ccol) & (cwcel @ XX @ XB2)) => ((cco @ Xc_0 @ XX @ Xc_an) = Xc_0))))))))))).
thf(acdleme9b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XC = (cco @ (cco @ XP @ XS @ Xc_or) @ XW @ Xc_an)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XP @ XA2) & (cwcel @ XS @ XA2) & (cwcel @ XW @ XH))) => (cwcel @ XC @ XB2))))))))))))))))))).
...
thf(aatmod2i2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XP @ XA2) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & (cwbr @ XY @ XX @ Xc_le)) => ((cco @ (cco @ XX @ XP @ Xc_an) @ XY @ Xc_or) = (cco @ XX @ (cco @ XP @ XY @ Xc_or) @ Xc_an)))))))))))))))))).
...
thf(ccdleme15b_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XU = (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ Xc_an)) => ((XF = (cco @ (cco @ XS @ XU @ Xc_or) @ (cco @ XQ @ (cco @ (cco @ XP @ XS @ Xc_or) @ XW @ Xc_an) @ Xc_or) @ Xc_an)) => ((XG = (cco @ (cco @ XT @ XU @ Xc_or) @ (cco @ XQ @ (cco @ (cco @ XP @ XT @ Xc_or) @ XW @ Xc_an) @ Xc_or) @ Xc_an)) => ((XC = (cco @ (cco @ XP @ XS @ Xc_or) @ XW @ Xc_an)) => ((XX = (cco @ (cco @ XP @ XT @ Xc_or) @ XW @ Xc_an)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) & (((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le))) & ((cwcel @ XT @ XA2) & (~ (cwbr @ XT @ XW @ Xc_le))) & ((XP != XQ) & (XS != XT))) & ((~ (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & (~ (cwbr @ XT @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & (~ (cwbr @ XU @ (cco @ XS @ XT @ Xc_or) @ Xc_le)))) => ((cco @ (cco @ XP @ XC @ Xc_or) @ (cco @ XQ @ XC @ Xc_or) @ Xc_an) = XC))))))))))))))))))))))))))))).
