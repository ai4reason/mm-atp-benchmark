...
thf(cmgpsumz_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ XR @ ccmulr))) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XI @ XN)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XN)) => (cwcel @ (XA2 @ Xk) @ (ccfv @ XR @ ccbs)))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xk:$i] : (((ccv @ Xk) = XI) => ((XA2 @ Xk) = Xc_0))) => (Xph => ((cco @ XM @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccgsu) = Xc_0))))))))))))))))))).
