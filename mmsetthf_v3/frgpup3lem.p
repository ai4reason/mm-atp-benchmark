...
thf(aelxp2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : XB2))))))).
...
thf(avrgpf_thm,axiom,(! [Xc_sm:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccfv @ XI @ ccefg)) => ((XU = (ccfv @ XI @ ccvrgp)) => ((XG = (ccfv @ XI @ ccfrgp)) => ((XX = (ccfv @ XG @ ccbs)) => ((cwcel @ XI @ XV) => (cwf @ XI @ XX @ XU))))))))))))).
...
thf(avrgpval_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((Xc_sm = (ccfv @ XI @ ccefg)) => ((XU = (ccfv @ XI @ ccvrgp)) => (((cwcel @ XI @ XV) & (cwcel @ XA2 @ XI)) => ((ccfv @ XA2 @ XU) = (ccec @ (ccs1 @ (ccop @ XA2 @ cc0)) @ Xc_sm))))))))))).
...
thf(avrgpinv_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xc_sm = (ccfv @ XI @ ccefg)) => ((XU = (ccfv @ XI @ ccvrgp)) => ((XG = (ccfv @ XI @ ccfrgp)) => ((XN = (ccfv @ XG @ ccminusg)) => (((cwcel @ XI @ XV) & (cwcel @ XA2 @ XI)) => ((ccfv @ (ccfv @ XA2 @ XU) @ XN) = (ccec @ (ccs1 @ (ccop @ XA2 @ cc1o)) @ Xc_sm))))))))))))))).
...
thf(afrgpeccl_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XI @ ccfrgp)) => ((Xc_sm = (ccfv @ XI @ ccefg)) => ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XX @ XW) => (cwcel @ (ccec @ XX @ Xc_sm) @ XB2))))))))))))).
...
thf(avrmdfval_thm,axiom,(! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xj:$i] : ((XU @ Xj) = (ccfv @ XI @ ccvrmd))) => (! [Xj:$i] : ((cwcel @ XI @ XV) => ((XU @ Xj) = (ccmpt @ (^ [Xj:$i] : XI) @ (^ [Xj:$i] : (ccs1 @ (ccv @ Xj)))))))))))).
...
thf(afrgpmhm_thm,axiom,(! [Xc_sm:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : ((XM @ Xx3) = (ccfv @ (ccxp @ XI @ cc2o) @ ccfrmd))) => ((! [Xx3:$i] : (XW = (ccfv @ (XM @ Xx3) @ ccbs))) => ((XG = (ccfv @ XI @ ccfrgp)) => ((Xc_sm = (ccfv @ XI @ ccefg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ Xc_sm))))) => (! [Xx3:$i] : ((cwcel @ XI @ XV) => (cwcel @ (XF @ Xx3) @ (cco @ (XM @ Xx3) @ XG @ ccmhm))))))))))))))))).
...
thf(agsumwmhm_thm,axiom,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => (((cwcel @ XH @ (cco @ XM @ XN @ ccmhm)) & (cwcel @ XW @ (ccword @ XB2))) => ((ccfv @ (cco @ XM @ XW @ ccgsu) @ XH) = (cco @ XN @ (cccom @ XH @ XW) @ ccgsu)))))))))).
...
thf(adivsfval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((Xph => (cwer @ XV @ Xc_sm)) => ((Xph => (cwcel @ XV @ ccvv)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ Xc_sm))))) => (! [Xx3:$i] : (Xph => ((ccfv @ XA2 @ (XF @ Xx3)) = (ccec @ XA2 @ Xc_sm))))))))))))).
