...
thf(cisershft_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ (ccseq @ Xc_pl @ XF @ XM) @ XA2 @ ccli) <=> (cwbr @ (ccseq @ Xc_pl @ (cco @ XF @ XN @ ccshi) @ (cco @ XM @ XN @ ccaddc)) @ XA2 @ ccli)))))))))).
