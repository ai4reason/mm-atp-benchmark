...
thf(aresinf1o_thm,axiom,(cwf1o @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc) @ (ccres @ ccsin @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)))).
...
thf(areasinsin_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)) => ((ccfv @ (ccfv @ XA2 @ ccsin) @ ccasin) = XA2)))).
thf(casinrebnd_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc)) => (cwcel @ (ccfv @ XA2 @ ccasin) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc))))).
