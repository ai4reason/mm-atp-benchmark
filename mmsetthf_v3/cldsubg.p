...
thf(aeqgid_thm,axiom,(! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_sm = (cco @ XG @ XY @ ccqg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XY @ (ccfv @ XG @ ccsubg)) => ((ccec @ Xc_0 @ Xc_sm) = XY))))))))))).
...
thf(ccldsubg_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XR = (cco @ XG @ XS @ ccqg)) => ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ cctgp) & (cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ (ccqs @ XX @ XR) @ ccfn)) => ((cwcel @ XS @ (ccfv @ XJ @ cccld)) <=> (cwcel @ XS @ XJ)))))))))))).
