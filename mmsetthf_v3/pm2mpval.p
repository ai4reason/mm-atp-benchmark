...
thf(adf_pm2mp_ax,axiom,(ccpm2mp = (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccfn)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccmpt @ (^ [Xm:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xr) @ ccpl1) @ ccmat) @ ccbs)) @ (^ [Xm:$i] : (ccsb @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ (^ [Xa:$i] : (ccsb @ (ccfv @ (ccv @ Xa) @ ccpl1) @ (^ [Xq:$i] : (cco @ (ccv @ Xq) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xm) @ (ccv @ Xk) @ ccdecpmat) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xa) @ ccv1) @ (ccfv @ (ccfv @ (ccv @ Xq) @ ccmgp) @ ccmg)) @ (ccfv @ (ccv @ Xq) @ ccvsca)))) @ ccgsu)))))))))))).
