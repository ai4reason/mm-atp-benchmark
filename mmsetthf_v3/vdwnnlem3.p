...
thf(avdwnnlem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwcel @ (XR @ Xk @ Xm) @ ccfn)))) => ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwf @ ccn @ (XR @ Xk @ Xm) @ XF)))) => ((! [Xc:$i] : ((XS @ Xc) = (ccrab @ (^ [Xk:$i] : (~ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn)))) @ (^ [Xk:$i] : ccn)))) => (! [Xk:$i] : (! [Xm:$i] : (! [Xc:$i] : (((Xph @ Xk @ Xm) & (cwcel @ (XB2 @ Xc) @ (ccfv @ (XA2 @ Xc) @ ccuz))) => ((cwcel @ (XA2 @ Xc) @ (XS @ Xc)) => (cwcel @ (XB2 @ Xc) @ (XS @ Xc))))))))))))))))).
...
thf(avdwnnlem1_thm,axiom,(! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xm:$i] : (((cwcel @ (XR @ Xm) @ ccfn) & (cwf @ ccn @ (XR @ Xm) @ XF) & (cwcel @ XK @ ccn0)) => (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn))) @ (^ [Xc:$i] : (XR @ Xm))))))))).
...
thf(cvdwnnlem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwcel @ (XR @ Xk @ Xm) @ ccfn)))) => ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwf @ ccn @ (XR @ Xk @ Xm) @ XF)))) => ((! [Xc:$i] : ((XS @ Xc) = (ccrab @ (^ [Xk:$i] : (~ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn)))) @ (^ [Xk:$i] : ccn)))) => ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwral @ (^ [Xc:$i] : ((XS @ Xc) != cc0)) @ (^ [Xc:$i] : (XR @ Xk @ Xm)))))) => (! [Xk:$i] : (! [Xm:$i] : (~ (Xph @ Xk @ Xm))))))))))))).
