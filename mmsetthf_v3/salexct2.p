...
thf(csalexct2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XA2 = (cco @ ccc0 @ cc2 @ ccicc)) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) | (cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ XA2))))) => ((XB2 = (cco @ ccc0 @ cc1 @ ccicc)) => (! [Xx3:$i] : (~ (cwcel @ XB2 @ (XS @ Xx3))))))))))).
