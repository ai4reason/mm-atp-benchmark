...
thf(cusgrfilem_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ XV)) => ((cwcel @ XE @ ccfn) <=> (cwcel @ (XF @ Xe) @ ccfn))))))))))))).
