...
thf(acldcss_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XL = (ccfv @ XW @ cclss)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ cchl) => ((cwcel @ XU @ XC) <=> ((cwcel @ XU @ XL) & (cwcel @ XU @ (ccfv @ XJ @ cccld)))))))))))))))).
