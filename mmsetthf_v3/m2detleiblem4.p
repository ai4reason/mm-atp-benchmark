...
thf(agsumpr12val_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XG @ XV)) => ((Xph => (cwf @ (ccpr @ cc1 @ cc2) @ XB2 @ XF)) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ (ccfv @ cc1 @ XF) @ (ccfv @ cc2 @ XF) @ Xc_pl)))))))))))))).
...
thf(cm2detleiblem4_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccpr @ cc1 @ cc2)) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ XN @ XR @ ccmat))) => ((! [Xn:$i] : (XB2 = (ccfv @ (XA2 @ Xn) @ ccbs))) => ((! [Xn:$i] : ((XG @ Xn) = (ccfv @ XR @ ccmgp))) => ((! [Xn:$i] : ((Xc_x @ Xn) = (ccfv @ (XG @ Xn) @ ccplusg))) => (! [Xn:$i] : (((cwcel @ XR @ ccrg) & (XQ = (ccpr @ (ccop @ cc1 @ cc2) @ (ccop @ cc2 @ cc1))) & (cwcel @ XM @ XB2)) => ((cco @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccv @ Xn) @ XM))) @ ccgsu) = (cco @ (cco @ cc2 @ cc1 @ XM) @ (cco @ cc1 @ cc2 @ XM) @ (Xc_x @ Xn))))))))))))))))))))).
