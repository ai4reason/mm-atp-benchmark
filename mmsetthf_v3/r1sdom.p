...
thf(asdomtr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsdm) & (cwbr @ XB2 @ XC @ ccsdm)) => (cwbr @ XA2 @ XC @ ccsdm)))))).
...
thf(cr1sdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ XA2)) => (cwbr @ (ccfv @ XB2 @ ccr1) @ (ccfv @ XA2 @ ccr1) @ ccsdm))))).
