...
thf(colj01_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => (((cwcel @ XK @ ccol) & (cwcel @ XX @ XB2)) => ((cco @ XX @ Xc_0 @ Xc_or) = XX))))))))))).
