...
thf(cdmdbr3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : ((cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj) = (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
