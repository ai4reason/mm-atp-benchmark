...
thf(ciccdil_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cco @ XA2 @ XR @ ccmul) = XC) => (((cco @ XB2 @ XR @ ccmul) = XD) => ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XX @ ccr) & (cwcel @ XR @ ccrp))) => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) <=> (cwcel @ (cco @ XX @ XR @ ccmul) @ (cco @ XC @ XD @ ccicc))))))))))))).
