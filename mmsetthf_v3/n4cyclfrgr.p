...
thf(afrgrusgrfrcond_thm,axiom,(! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xl:$i] : ((XE @ Xx3 @ Xk @ Xl) = (ccfv @ XG @ ccedg))))) => ((cwcel @ XG @ ccfrgr) <=> ((cwcel @ XG @ ccusgr) & (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xl:$i] : (cwreu @ (^ [Xx3:$i] : (cwss @ (ccpr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xk)) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xl))) @ (XE @ Xx3 @ Xk @ Xl))) @ (^ [Xx3:$i] : XV))) @ (^ [Xl:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : XV)))))))))).
...
thf(areubii_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) <=> (Xps @ Xx3))) => ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwreu @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
...
thf(a_4cycl2vnunb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [Xx3:$i] : ((((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE)) & ((cwcel @ (ccpr @ XC @ (XD @ Xx3)) @ XE) & (cwcel @ (ccpr @ (XD @ Xx3) @ XA2) @ XE)) & ((cwcel @ XB2 @ XV) & (cwcel @ (XD @ Xx3) @ XV) & (XB2 != (XD @ Xx3)))) => (~ (cwreu @ (^ [Xx3:$i] : (cwss @ (ccpr @ (ccpr @ XA2 @ (ccv @ Xx3)) @ (ccpr @ (ccv @ Xx3) @ XC)) @ XE)) @ (^ [Xx3:$i] : XV)))))))))))).
thf(aneqne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (XA2 = XB2)) => (XA2 != XB2))))).
thf(cn4cyclfrgr_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccfrgr) & (cwbr @ XF @ XP @ (ccfv @ XG @ cccycls))) => ((ccfv @ XF @ cchash) != cc4)))))).
