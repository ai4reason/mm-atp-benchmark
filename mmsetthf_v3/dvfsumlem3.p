...
thf(cdvfsumlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (XS = (cco @ (XT @ Xk) @ ccpnf @ ccioo))) => ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XM @ (cco @ XD @ cc1 @ ccaddc) @ ccle)) => ((! [Xk:$i] : (Xph => (cwcel @ (XT @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XA2 @ Xx3 @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XZ @ Xk))) => (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xk:$i] : (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = (ccv @ Xk)) => ((XB2 @ Xx3) = (XC @ Xk))))) => ((Xph => (cwcel @ XU @ ccxr)) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xk) @ XS)) & ((cwbr @ XD @ (ccv @ Xx3) @ ccle) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xk) @ ccle) & (cwbr @ (ccv @ Xk) @ XU @ ccle))) => (cwbr @ (XC @ Xk) @ (XB2 @ Xx3) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XH @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccmin) @ (XB2 @ Xx3) @ ccmul) @ (cco @ (ccsu @ (cco @ XM @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk))) @ (XA2 @ Xx3 @ Xk) @ ccmin) @ ccaddc)))))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => ((Xph => (cwbr @ XD @ XX @ ccle)) => ((Xph => (cwbr @ XX @ XY @ ccle)) => ((Xph => (cwbr @ XY @ XU @ ccle)) => (! [Xx3:$i] : (! [Xk:$i] : (Xph => ((cwbr @ (ccfv @ XY @ (XH @ Xx3 @ Xk)) @ (ccfv @ XX @ (XH @ Xx3 @ Xk)) @ ccle) & (cwbr @ (cco @ (ccfv @ XX @ (XH @ Xx3 @ Xk)) @ (ccsb @ XX @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmin) @ (cco @ (ccfv @ XY @ (XH @ Xx3 @ Xk)) @ (ccsb @ XY @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmin) @ ccle))))))))))))))))))))))))))))))))))))))).
