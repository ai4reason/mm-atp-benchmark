...
thf(ameasunl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => (Xph => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ XM) @ (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccxad) @ ccle))))))))))).
...
thf(caean_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : ((ccuni @ (ccdm @ (XM @ Xx3))) = XO)) => (! [Xx3:$i] : (((cwcel @ (XM @ Xx3) @ (ccuni @ (ccrn @ ccmeas))) & (cwcel @ (ccrab @ (^ [Xx3:$i] : (~ (Xph @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (ccdm @ (XM @ Xx3))) & (cwcel @ (ccrab @ (^ [Xx3:$i] : (~ (Xps @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (ccdm @ (XM @ Xx3)))) => ((cwbr @ (ccrab @ (^ [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) <=> ((cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) & (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae))))))))))).
