...
thf(adcubic1lem_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccc)) => ((Xph => (cwcel @ XQ @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XT @ ccc)) => ((Xph => ((cco @ XT @ cc3 @ ccexp) = (cco @ XG @ XN @ ccmin))) => ((Xph => (cwcel @ XG @ ccc)) => ((Xph => ((cco @ XG @ cc2 @ ccexp) = (cco @ (cco @ XN @ cc2 @ ccexp) @ (cco @ XM @ cc3 @ ccexp) @ ccaddc))) => ((Xph => (XM = (cco @ XP @ cc3 @ ccdiv))) => ((Xph => (XN = (cco @ XQ @ cc2 @ ccdiv))) => ((Xph => (XT != ccc0)) => ((Xph => (cwcel @ XU @ ccc)) => ((Xph => (XU != ccc0)) => ((Xph => (XX = (cco @ XU @ (cco @ XM @ XU @ ccdiv) @ ccmin))) => (Xph => (((cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ XP @ XX @ ccmul) @ XQ @ ccaddc) @ ccaddc) = ccc0) <=> ((cco @ (cco @ (cco @ XU @ cc3 @ ccexp) @ cc2 @ ccexp) @ (cco @ (cco @ XQ @ (cco @ XU @ cc3 @ ccexp) @ ccmul) @ (cco @ XM @ cc3 @ ccexp) @ ccmin) @ ccaddc) = ccc0)))))))))))))))))))))))))).
