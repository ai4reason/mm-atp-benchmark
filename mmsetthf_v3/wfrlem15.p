...
thf(awfrlem10_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xz:$i] : (cwwe @ XA2 @ (XR @ Xz))) => ((! [Xz:$i] : ((XF @ Xz) = (ccwrecs @ XA2 @ (XR @ Xz) @ (XG @ Xz)))) => (! [Xz:$i] : (((cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz)))) & ((ccpred @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz))) @ (XR @ Xz) @ (ccv @ Xz)) = cc0)) => ((ccpred @ XA2 @ (XR @ Xz) @ (ccv @ Xz)) = (ccdm @ (XF @ Xz)))))))))))).
...
thf(awfrlem13_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : (XF = (ccwrecs @ XA2 @ XR @ (XG @ Xz)))) => ((! [Xz:$i] : ((XC @ Xz) = (ccun @ XF @ (ccsn @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ (XG @ Xz))))))) => (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ XF))) => (cwfn @ (XC @ Xz) @ (ccun @ (ccdm @ XF) @ (ccsn @ (ccv @ Xz)))))))))))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => Xch) => (Xph => (Xps & Xch)))))))).
thf(asylancr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(cciun_tp,type,(cciun : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(awfrdmss_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (cwss @ (ccdm @ XF) @ XA2))))))).
...
thf(awfrdmcl_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccwrecs @ XA2 @ XR @ XG)) => ((cwcel @ XX @ (ccdm @ XF)) => (cwss @ (ccpred @ XA2 @ XR @ XX) @ (ccdm @ XF)))))))))).
...
thf(awfrlem14_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : (XF = (ccwrecs @ XA2 @ XR @ (XG @ Xz)))) => ((! [Xz:$i] : ((XC @ Xz) = (ccun @ XF @ (ccsn @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ (XG @ Xz))))))) => (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ XF))) => ((cwcel @ (ccv @ Xy1) @ (ccun @ (ccdm @ XF) @ (ccsn @ (ccv @ Xz)))) => ((ccfv @ (ccv @ Xy1) @ (XC @ Xz)) = (ccfv @ (ccres @ (XC @ Xz) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ (XG @ Xz))))))))))))))))).
...
thf(cwfrlem15_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xz:$i] : (XF = (ccwrecs @ XA2 @ XR @ (XG @ Xz)))) => ((! [Xz:$i] : ((XC @ Xz) = (ccun @ XF @ (ccsn @ (ccop @ (ccv @ Xz) @ (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ (XG @ Xz))))))) => (! [Xz:$i] : (((cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ XF))) & ((ccpred @ (ccdif @ XA2 @ (ccdm @ XF)) @ XR @ (ccv @ Xz)) = cc0)) => (cwcel @ (XC @ Xz) @ (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ (XG @ Xz)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))))))))))).
