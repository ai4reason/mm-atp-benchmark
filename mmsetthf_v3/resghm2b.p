...
thf(cresghm2b_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XX @ (ccfv @ XT @ ccsubg)) & (cwss @ (ccrn @ XF) @ XX)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) <=> (cwcel @ XF @ (cco @ XS @ XU @ ccghm))))))))))).
