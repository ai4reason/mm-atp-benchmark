...
thf(adstfrvel_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ (ccuni @ (ccdm @ XP)))) => ((Xph => (cwbr @ (ccfv @ XB2 @ XX) @ XA2 @ ccle)) => (Xph => (cwcel @ XB2 @ (cco @ XX @ XA2 @ (ccorvc @ ccle))))))))))))))).
...
thf(cdstfrvunirn_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => (Xph => ((ccuni @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XX @ (ccv @ Xn) @ (ccorvc @ ccle)))))) = (ccuni @ (ccdm @ XP)))))))))).
