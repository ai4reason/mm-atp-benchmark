...
thf(cfrlmval_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => (((cwcel @ XR @ XV) & (cwcel @ XI @ XW)) => (XF = (cco @ XR @ (ccxp @ XI @ (ccsn @ (ccfv @ XR @ ccrglmod))) @ ccdsmm)))))))))).
