...
thf(aevend2_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwbr @ cc2 @ XN @ ccdvds) <=> (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccz))))).
...
thf(cnn0ehalf_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwbr @ cc2 @ XN @ ccdvds)) => (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)))).
