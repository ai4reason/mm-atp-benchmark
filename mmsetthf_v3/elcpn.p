...
thf(acpnfval_thm,axiom,(! [XS:($i > $o)] : ((cwss @ XS @ ccc) => ((ccfv @ XS @ cccpn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccfv @ (ccv @ Xn) @ (cco @ XS @ (ccv @ Xf1) @ ccdvn)) @ (cco @ (ccdm @ (ccv @ Xf1)) @ ccc @ cccncf))) @ (^ [Xf1:$i] : (cco @ ccc @ XS @ ccpm))))))))).
...
thf(celcpn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwss @ XS @ ccc) & (cwcel @ XN @ ccn0)) => ((cwcel @ XF @ (ccfv @ XN @ (ccfv @ XS @ cccpn))) <=> ((cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) & (cwcel @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn)) @ (cco @ (ccdm @ XF) @ ccc @ cccncf))))))))).
