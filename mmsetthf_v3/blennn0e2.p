...
thf(aflsubz_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XN @ ccz)) => ((ccfv @ (cco @ XA2 @ XN @ ccmin) @ ccfl) = (cco @ (ccfv @ XA2 @ ccfl) @ XN @ ccmin)))))).
...
thf(ann0enne_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0) <=> (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn))))).
thf(ccabs_tp,type,(ccabs : ($i > $o))).
thf(ablennn_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc))))).
thf(cblennn0e2_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccblen) @ cc1 @ ccaddc))))).
