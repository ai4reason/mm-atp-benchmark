...
thf(cpsgnevpmb_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XD @ ccpsgn)) => ((cwcel @ XD @ ccfn) => ((cwcel @ XF @ (ccfv @ XD @ ccevpm)) <=> ((cwcel @ XF @ XP) & ((ccfv @ XF @ XN) = cc1))))))))))))).
