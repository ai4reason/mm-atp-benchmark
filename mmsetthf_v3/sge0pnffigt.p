...
thf(csge0pnffigt_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ XX @ (XV @ Xx3)))) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => ((ccfv @ XF @ ccsumge0) = ccpnf)) => ((Xph => (cwcel @ XY @ ccr)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwbr @ XY @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ cclt)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
