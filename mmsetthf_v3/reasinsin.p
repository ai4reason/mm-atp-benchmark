...
thf(aasinsin_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => ((ccfv @ (ccfv @ XA2 @ ccsin) @ ccasin) = XA2)))).
...
thf(asinhalfpi_thm,axiom,((ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ ccsin) = cc1)).
thf(creasinsin_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)) => ((ccfv @ (ccfv @ XA2 @ ccsin) @ ccasin) = XA2)))).
