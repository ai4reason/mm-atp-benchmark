...
thf(afrgr3v_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XZ)) & ((XA2 != XB2) & (XA2 != XC) & (XB2 != XC))) => (((XV = (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ XG @ ccusgr)) => ((cwcel @ XG @ ccfrgr) <=> ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE) & (cwcel @ (ccpr @ XC @ XA2) @ XE))))))))))))))))).
...
thf(a_3vfriswmgrlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (XA2 != XB2)) & ((XV = (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ XG @ ccusgr))) => ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) => (cwreu @ (^ [Xw:$i] : (cwcel @ (ccpr @ XA2 @ (ccv @ Xw)) @ XE)) @ (^ [Xw:$i] : (ccpr @ XA2 @ XB2)))))))))))))))).
...
thf(c_3vfriswmgr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xh:$i] : (XV = (ccfv @ (XG @ Xv @ Xh) @ ccvtx)))) => ((! [Xv:$i] : (! [Xh:$i] : (XE = (ccfv @ (XG @ Xv @ Xh) @ ccedg)))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xh:$i] : ((((cwcel @ XA2 @ (XX @ Xv @ Xh)) & (cwcel @ XB2 @ (XY @ Xv @ Xh)) & (cwcel @ XC @ (XZ @ Xw @ Xv @ Xh))) & ((XA2 != XB2) & (XA2 != XC) & (XB2 != XC)) & (XV = (cctp @ XA2 @ XB2 @ XC))) => ((cwcel @ (XG @ Xv @ Xh) @ ccfrgr) => (cwrex @ (^ [Xh:$i] : (cwral @ (^ [Xv:$i] : ((cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xh)) @ XE) & (cwreu @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ XE)) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xh))))))) @ (^ [Xv:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xh)))))) @ (^ [Xh:$i] : XV))))))))))))))))))).
