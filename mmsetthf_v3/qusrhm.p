...
thf(aqusring_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((XU = (cco @ XR @ (cco @ XR @ XS @ ccqg) @ ccqus)) => ((XI = (ccfv @ XR @ cc2idl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XS @ XI)) => (cwcel @ XU @ ccrg))))))))).
...
thf(a_2idlval_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : ((XI = (ccfv @ XR @ cclidl)) => ((XO = (ccfv @ XR @ ccoppr)) => ((XJ = (ccfv @ XO @ cclidl)) => ((XT = (ccfv @ XR @ cc2idl)) => (XT = (ccin @ XI @ XJ)))))))))))).
...
thf(aablnsg_thm,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccabl) => ((ccfv @ XG @ ccnsg) = (ccfv @ XG @ ccsubg))))).
thf(aqusghm_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XH = (cco @ XG @ (cco @ XG @ XY @ ccqg) @ ccqus)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ (cco @ XG @ XY @ ccqg)))))) => (! [Xx3:$i] : ((cwcel @ XY @ (ccfv @ XG @ ccnsg)) => (cwcel @ (XF @ Xx3) @ (cco @ XG @ XH @ ccghm))))))))))))).
thf(cqusrhm_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XR @ (cco @ XR @ XS @ ccqg) @ ccqus)) => ((XI = (ccfv @ XR @ cc2idl)) => ((XX = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ (cco @ XR @ XS @ ccqg)))))) => (! [Xx3:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XS @ XI)) => (cwcel @ (XF @ Xx3) @ (cco @ XR @ XU @ ccrh))))))))))))))).
