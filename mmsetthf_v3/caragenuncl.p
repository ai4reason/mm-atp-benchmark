...
thf(acaragenuncllem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => ((Xph => (cwcel @ XE @ XS)) => ((Xph => (cwcel @ XF @ XS)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XA2 @ XX)) => (Xph => ((cco @ (ccfv @ (ccin @ XA2 @ (ccun @ XE @ XF)) @ XO) @ (ccfv @ (ccdif @ XA2 @ (ccun @ XE @ XF)) @ XO) @ ccxad) = (ccfv @ XA2 @ XO))))))))))))))))).
