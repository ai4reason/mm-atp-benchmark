...
thf(cesumpfinvallem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((cco @ cccnfld @ XF @ ccgsu) = (cco @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ XF @ ccgsu))))))).
