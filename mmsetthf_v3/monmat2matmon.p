...
thf(amonmatcollpw_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XK = (ccfv @ XA2 @ ccbs)) => ((Xc_0 = (ccfv @ XA2 @ cc0g)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XC @ ccvsca)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) & ((cwcel @ XM @ XK) & (cwcel @ XL @ ccn0) & (cwcel @ XI @ ccn0))) => ((cco @ (cco @ (cco @ XL @ XX @ Xc_ex) @ (ccfv @ XM @ XT) @ Xc_x) @ XI @ ccdecpmat) = (ccif @ (XI = XL) @ XM @ Xc_0))))))))))))))))))))))))))).
