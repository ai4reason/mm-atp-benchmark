...
thf(cfsnunf_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwf @ XS @ XT @ XF) & ((cwcel @ XX @ XV) & (~ (cwcel @ XX @ XS))) & (cwcel @ XY @ XT)) => (cwf @ (ccun @ XS @ (ccsn @ XX)) @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY)))))))))))).
