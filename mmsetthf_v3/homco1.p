...
thf(chomco1_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU)) => ((cccom @ (cco @ XA2 @ XT @ cchot) @ XU) = (cco @ XA2 @ (cccom @ XT @ XU) @ cchot))))))).
