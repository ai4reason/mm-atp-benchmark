...
thf(credwlklem_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XF @ (ccword @ XS)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ ccle) & (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP)) => (cwf @ (cco @ ccc0 @ (ccfv @ (ccres @ XF @ (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ cchash) @ ccfz) @ XV @ (ccres @ XP @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))).
