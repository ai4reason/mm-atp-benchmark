...
thf(chl0lt1N_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((cwcel @ XK @ cchlt) => (cwbr @ Xc_0 @ Xc_1 @ Xc_lt)))))))))).
