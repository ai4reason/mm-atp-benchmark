...
thf(crlimuni_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => ((Xph => (cwbr @ XF @ XB2 @ ccrli)) => ((Xph => (cwbr @ XF @ XC @ ccrli)) => (Xph => (XB2 = XC)))))))))))).
