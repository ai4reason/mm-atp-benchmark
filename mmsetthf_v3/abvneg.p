...
thf(cabvneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccminusg)) => (((cwcel @ XF @ XA2) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccfv @ XX @ XN) @ XF) = (ccfv @ XX @ XF))))))))))))).
