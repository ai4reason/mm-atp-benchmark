...
thf(cfusgrregdegfi_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : ((XD @ Xv) = (ccfv @ XG @ ccvtxdg))) => (((cwcel @ XG @ ccfusgr) & (XV != cc0)) => ((cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (XD @ Xv)) = XK)) @ (^ [Xv:$i] : XV)) => (cwcel @ XK @ ccn0)))))))))).
