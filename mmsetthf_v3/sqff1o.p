...
thf(aissqf_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (((ccfv @ XA2 @ ccmu) != ccc0) <=> (cwral @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ cc1 @ ccle)) @ (^ [Xp:$i] : ccprime)))))).
