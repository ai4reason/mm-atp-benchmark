...
thf(adftpos2_thm,axiom,(! [XF:($i > $o)] : ((cwrel @ (ccdm @ XF)) => ((cctpos @ XF) = (cccom @ XF @ (ccmpt @ (^ [Xx3:$i] : (cccnv @ (ccdm @ XF))) @ (^ [Xx3:$i] : (ccuni @ (cccnv @ (ccsn @ (ccv @ Xx3))))))))))).
thf(ctposf12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ XA2) => ((cwf1 @ XA2 @ XB2 @ XF) => (cwf1 @ (cccnv @ XA2) @ XB2 @ (cctpos @ XF)))))))).
