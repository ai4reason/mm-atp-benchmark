...
thf(cpwm1geoser_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (cco @ XA2 @ XN @ ccexp) @ cc1 @ ccmin) = (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) @ ccmul))))))))).
