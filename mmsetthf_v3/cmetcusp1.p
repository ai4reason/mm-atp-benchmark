...
thf(axmsusp_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XF @ ccbs)) => ((XD = (ccres @ (ccfv @ XF @ ccds) @ (ccxp @ XX @ XX))) => ((XU = (ccfv @ XF @ ccuss)) => (((XX != cc0) & (cwcel @ XF @ ccxme) & (XU = (ccfv @ XD @ ccmetu))) => (cwcel @ XF @ ccusp)))))))))).
...
thf(aiscusp2_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xc:$i] : ((XB2 @ Xc) = (ccfv @ XW @ ccbs))) => ((! [Xc:$i] : ((XU @ Xc) = (ccfv @ XW @ ccuss))) => ((! [Xc:$i] : ((XJ @ Xc) = (ccfv @ XW @ cctopn))) => ((cwcel @ XW @ cccusp) <=> ((cwcel @ XW @ ccusp) & (cwral @ (^ [Xc:$i] : ((cwcel @ (ccv @ Xc) @ (ccfv @ (XU @ Xc) @ cccfilu)) => ((cco @ (XJ @ Xc) @ (ccv @ Xc) @ ccflim) != cc0))) @ (^ [Xc:$i] : (ccfv @ (XB2 @ Xc) @ ccfil))))))))))))).
thf(ccmetcusp1_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XF @ ccbs)) => ((XD = (ccres @ (ccfv @ XF @ ccds) @ (ccxp @ XX @ XX))) => ((XU = (ccfv @ XF @ ccuss)) => (((XX != cc0) & (cwcel @ XF @ cccms) & (XU = (ccfv @ XD @ ccmetu))) => (cwcel @ XF @ cccusp)))))))))).
