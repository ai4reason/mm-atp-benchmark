...
thf(aunirnblps_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => ((ccuni @ (ccrn @ (ccfv @ XD @ ccbl))) = XX))))).
...
thf(ametustbl_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XV @ (ccfv @ XD @ ccmetu)) & (cwcel @ XP @ XX)) => (cwrex @ (^ [Xa:$i] : ((cwcel @ XP @ (ccv @ Xa)) & (cwss @ (ccv @ Xa) @ (ccima @ XV @ (ccsn @ XP))))) @ (^ [Xa:$i] : (ccrn @ (ccfv @ XD @ ccbl)))))))))).
...
thf(ablssexps_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XP @ XX)) => ((cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XA2))) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ XD @ ccbl)))) <=> (cwrex @ (^ [Xr:$i] : (cwss @ (cco @ XP @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XA2)) @ (^ [Xr:$i] : ccrp))))))))).
...
thf(ablval2_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccrp)) => ((cco @ XP @ XR @ (ccfv @ XD @ ccbl)) = (ccima @ (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ XR @ ccico)) @ (ccsn @ XP))))))))).
...
thf(cpsmetutop_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (((XX != cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => ((ccfv @ (ccfv @ XD @ ccmetu) @ ccutop) = (ccfv @ (ccrn @ (ccfv @ XD @ ccbl)) @ cctg)))))).
