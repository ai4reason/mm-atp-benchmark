...
thf(a_4sqlem3_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xn) = (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccz) & (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccz)) & ((cwcel @ (XC @ Xx3 @ Xy1 @ Xz @ Xw) @ ccz) & (cwcel @ (XD @ Xx3 @ Xy1 @ Xz @ Xw) @ ccz))) => (cwcel @ (cco @ (cco @ (cco @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ cc2 @ ccexp) @ (cco @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (XC @ Xx3 @ Xy1 @ Xz @ Xw) @ cc2 @ ccexp) @ (cco @ (XD @ Xx3 @ Xy1 @ Xz @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))).
thf(c_4sqlem4a_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xn) = (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccgz) & (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccgz)) => (cwcel @ (cco @ (cco @ (ccfv @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccabs) @ cc2 @ ccexp) @ ccaddc) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
