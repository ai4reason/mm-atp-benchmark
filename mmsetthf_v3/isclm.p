...
thf(cisclm_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ ccclm) <=> ((cwcel @ XW @ cclmod) & (XF = (cco @ cccnfld @ XK @ ccress)) & (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)))))))))).
