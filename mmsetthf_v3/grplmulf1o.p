...
thf(cgrplmulf1o_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XX @ (ccv @ Xx3) @ Xc_pl))))) => (! [Xx3:$i] : (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ XB2)) => (cwf1o @ XB2 @ XB2 @ (XF @ Xx3))))))))))))).
