...
thf(causgrusgri_conj,conjecture,(! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : ((XG @ Xx3 @ Xv @ Xe @ Xf1) = (ccopab @ (^ [Xv:$i] : (^ [Xe:$i] : (cwss @ (ccv @ Xe) @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xv))))))))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : ((XO @ Xx3 @ Xv @ Xe @ Xf1) = (^ [Xf1:$i] : (cwf1 @ (ccdm @ (ccv @ Xf1)) @ (ccrn @ (ccv @ Xf1)) @ (ccv @ Xf1)))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (((cwcel @ XH @ (XW @ Xv @ Xe @ Xf1)) & (cwbr @ (ccfv @ XH @ ccvtx) @ (ccfv @ XH @ ccedg) @ (XG @ Xx3 @ Xv @ Xe @ Xf1)) & (cwcel @ (ccfv @ XH @ cciedg) @ (XO @ Xx3 @ Xv @ Xe @ Xf1))) => (cwcel @ XH @ ccusgr))))))))))))).
