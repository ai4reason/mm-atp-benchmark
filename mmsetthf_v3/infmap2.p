...
thf(ainfxpabs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) & ((XB2 != cc0) & (cwbr @ XB2 @ XA2 @ ccdom))) => (cwbr @ (ccxp @ XA2 @ XB2) @ XA2 @ ccen))))).
...
thf(cinfmap2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ ccom @ XA2 @ ccdom) & (cwbr @ XB2 @ XA2 @ ccdom) & (cwcel @ (cco @ XA2 @ XB2 @ ccmap) @ (ccdm @ cccrd))) => (cwbr @ (cco @ XA2 @ XB2 @ ccmap) @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ XB2 @ ccen))) @ ccen))))).
