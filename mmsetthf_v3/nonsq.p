...
thf(cnonsq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) & ((cwbr @ (cco @ XB2 @ cc2 @ ccexp) @ XA2 @ cclt) & (cwbr @ XA2 @ (cco @ (cco @ XB2 @ cc1 @ ccaddc) @ cc2 @ ccexp) @ cclt))) => (~ (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccq)))))).
