...
thf(cmrsubff_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmrsub)) => ((cwcel @ XT @ XW) => (cwf @ (cco @ XR @ XV @ ccpm) @ (cco @ XR @ XR @ ccmap) @ XS))))))))))).
