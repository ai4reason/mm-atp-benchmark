...
thf(aodzphi_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) => (cwbr @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ (ccfv @ XN @ ccphi) @ ccdvds))))).
...
thf(cfmtnoprmfac1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XP @ ccprime) & (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => (cwrex @ (^ [Xk:$i] : (XP = (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn)))))).
