...
thf(aeulerpartlemn_thm,axiom,(! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xo:$i] : (! [Xr:$i] : ((XP @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xo @ Xr) = (ccrab @ (^ [Xf1:$i] : ((cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn) & ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))) = (XN @ Xy1 @ Xz @ Xr)))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xo:$i] : (! [Xr:$i] : ((XO @ Xz @ Xf1 @ Xg1 @ Xk @ Xo) = (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (~ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (ccima @ (cccnv @ (ccv @ Xg1)) @ ccn)))) @ (^ [Xg1:$i] : (XP @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xo @ Xr)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xo:$i] : (! [Xr:$i] : ((XD @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1 @ Xk @ Xn @ Xo @ Xr) = (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ cc1 @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xg1:$i] : (XP @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xo @ Xr))))))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : ((XJ @ Xz @ Xg1) = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccn))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xr:$i] : ((XF @ Xz @ Xf1 @ Xg1 @ Xr) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XJ @ Xz @ Xg1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ (ccv @ Xx3) @ ccmul))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XH @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1 @ Xk @ Xn) = (ccrab @ (^ [Xr:$i] : (cwcel @ (cco @ (ccv @ Xr) @ cc0 @ ccsupp) @ ccfn)) @ (^ [Xr:$i] : (cco @ (ccin @ (ccpw @ ccn0) @ ccfn) @ (XJ @ Xz @ Xg1) @ ccmap))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XM @ Xz @ Xf1 @ Xg1) = (ccmpt @ (^ [Xr:$i] : (XH @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1 @ Xk @ Xn)) @ (^ [Xr:$i] : (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (XJ @ Xz @ Xg1)) & (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xr))))))))))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : ((XR @ Xz @ Xg1) = (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn))))) => ((! [Xz:$i] : (! [Xg1:$i] : ((XT @ Xz @ Xg1) = (ccrab @ (^ [Xf1:$i] : (cwss @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ (XJ @ Xz @ Xg1))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XG @ Xx3 @ Xy1 @ Xz @ Xg1 @ Xn @ Xr) = (ccmpt @ (^ [Xo:$i] : (ccin @ (XT @ Xz @ Xg1) @ (XR @ Xz @ Xg1))) @ (^ [Xo:$i] : (ccfv @ (ccima @ (XF @ Xz @ Xf1 @ Xg1 @ Xr) @ (ccfv @ (cccom @ ccbits @ (ccres @ (ccv @ Xo) @ (XJ @ Xz @ Xg1))) @ (XM @ Xz @ Xf1 @ Xg1))) @ (ccfv @ ccn @ ccind)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xo:$i] : (! [Xr:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1 @ Xk @ Xn @ Xo @ Xr) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ (XR @ Xz @ Xg1))) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xo:$i] : (! [Xr:$i] : (cwf1o @ (XO @ Xz @ Xf1 @ Xg1 @ Xk @ Xo) @ (XD @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1 @ Xk @ Xn @ Xo @ Xr) @ (ccres @ (XG @ Xx3 @ Xy1 @ Xz @ Xg1 @ Xn @ Xr) @ (XO @ Xz @ Xf1 @ Xg1 @ Xk @ Xo)))))))))))))))))))))))))))))))))))).
...
thf(ceulerpart_conj,conjecture,(! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : ((XP @ Xf1) = (ccrab @ (^ [Xf1:$i] : ((cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn) & ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))) = XN))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap))))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XO @ Xf1 @ Xk) = (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (~ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : (ccima @ (cccnv @ (ccv @ Xg1)) @ ccn)))) @ (^ [Xg1:$i] : (XP @ Xf1)))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XD @ Xf1 @ Xk @ Xn) = (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ cc1 @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xg1:$i] : (XP @ Xf1))))))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((ccfv @ (XO @ Xf1 @ Xk) @ cchash) = (ccfv @ (XD @ Xf1 @ Xk @ Xn) @ cchash))))))))))))).
