...
thf(almcn2_thm,axiom,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (XZ = (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (Xph => (cwcel @ (XM @ Xn) @ ccz))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwf @ XZ @ XX @ XF)) => ((Xph => (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : (Xph => (cwbr @ XF @ (XR @ Xn) @ (ccfv @ XJ @ cclm)))) => ((! [Xn:$i] : (Xph => (cwbr @ XG @ (XS @ Xn) @ (ccfv @ XK @ cclm)))) => ((! [Xn:$i] : (Xph => (cwcel @ XO @ (cco @ (cco @ XJ @ XK @ cctx) @ (XN @ Xn) @ cccn)))) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG) @ XO))))) => (! [Xn:$i] : (Xph => (cwbr @ (XH @ Xn) @ (cco @ (XR @ Xn) @ (XS @ Xn) @ XO) @ (ccfv @ (XN @ Xn) @ cclm))))))))))))))))))))))))))))).
...
thf(chlimadd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : ((Xph => (cwf @ ccn @ cchil @ XF)) => ((Xph => (cwf @ ccn @ cchil @ XG)) => ((! [Xn:$i] : (Xph => (cwbr @ XF @ (XA2 @ Xn) @ cchli))) => ((! [Xn:$i] : (Xph => (cwbr @ XG @ (XB2 @ Xn) @ cchli))) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG) @ ccva))))) => (! [Xn:$i] : (Xph => (cwbr @ (XH @ Xn) @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccva) @ cchli))))))))))))))).
