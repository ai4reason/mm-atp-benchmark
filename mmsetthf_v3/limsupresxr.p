...
thf(climsupresxr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwfun @ XF)) => ((XA2 = (ccima @ (cccnv @ XF) @ ccxr)) => (Xph => ((ccfv @ (ccres @ XF @ XA2) @ cclsp) = (ccfv @ XF @ cclsp))))))))))).
