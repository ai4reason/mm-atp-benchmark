...
thf(cdomneq0_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccdomn) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => (((cco @ XX @ XY @ Xc_x) = Xc_0) <=> ((XX = Xc_0) | (XY = Xc_0)))))))))))))).
