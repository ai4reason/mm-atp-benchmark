...
thf(ardgval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xg1:$i] : ((cwcel @ (XB2 @ Xg1) @ ccon0) => ((ccfv @ (XB2 @ Xg1) @ (ccrdg @ XF @ XA2)) = (ccfv @ (ccres @ (ccrdg @ XF @ XA2) @ (XB2 @ Xg1)) @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccif @ ((ccv @ Xg1) = cc0) @ XA2 @ (ccif @ (cwlim @ (ccdm @ (ccv @ Xg1))) @ (ccuni @ (ccrn @ (ccv @ Xg1))) @ (ccfv @ (ccfv @ (ccuni @ (ccdm @ (ccv @ Xg1))) @ (ccv @ Xg1)) @ XF))))))))))))).
...
thf(crdgprc0_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : ((~ (cwcel @ XI @ ccvv)) => ((ccfv @ cc0 @ (ccrdg @ XF @ XI)) = cc0))))).
