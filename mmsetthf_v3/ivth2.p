...
thf(aivth_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((Xph => ((cwbr @ (ccfv @ XA2 @ XF) @ XU @ cclt) & (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt))) => (Xph => (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ XF) = XU)) @ (^ [Xc:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))))))).
