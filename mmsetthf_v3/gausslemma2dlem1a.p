...
thf(altoddhalfle_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds)) & (cwcel @ XM @ ccz)) => ((cwbr @ XM @ (cco @ XN @ cc2 @ ccdiv) @ cclt) <=> (cwbr @ XM @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))))).
...
thf(ahalfleoddlt_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds)) & (cwcel @ XM @ ccz)) => ((cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ ccle) <=> (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ cclt)))))).
...
thf(annehalf_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwbr @ cc2 @ XN @ ccdvds)) => (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn)))).
