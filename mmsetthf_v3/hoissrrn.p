...
thf(choissrrn_conj,conjecture,(! [Xph:$o] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (Xph => (cwf @ XX @ (ccxp @ ccr @ ccr) @ (XI @ Xk)))) => (Xph => (cwss @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))))) @ (cco @ ccr @ XX @ ccmap)))))))).
