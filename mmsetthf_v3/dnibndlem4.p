...
thf(cdnibndlem4_conj,conjecture,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccr) => (cwbr @ ccc0 @ (cco @ XB2 @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin) @ ccmin) @ ccle)))).
