...
thf(cisreg2_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ ccreg) <=> (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : ((~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xc))) => (cwrex @ (^ [Xo:$i] : (cwrex @ (^ [Xp:$i] : ((cwss @ (ccv @ Xc) @ (ccv @ Xo)) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xp)) & ((ccin @ (ccv @ Xo) @ (ccv @ Xp)) = cc0))) @ (^ [Xp:$i] : XJ))) @ (^ [Xo:$i] : XJ)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld)))))))).
