...
thf(cclsint2_conj,conjecture,(! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XC @ (ccpw @ XX))) => (cwss @ (ccfv @ (ccint @ XC) @ (ccfv @ XJ @ cccl)) @ (cciin @ (^ [Xc:$i] : XC) @ (^ [Xc:$i] : (ccfv @ (ccv @ Xc) @ (ccfv @ XJ @ cccl))))))))))).
