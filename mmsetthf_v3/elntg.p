...
thf(astrfv2d_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XE = (ccslot @ (ccfv @ ccnx @ XE))) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwfun @ (cccnv @ (cccnv @ XS)))) => ((Xph => (cwcel @ (ccop @ (ccfv @ ccnx @ XE) @ XC) @ XS)) => ((Xph => (cwcel @ XC @ XW)) => (Xph => (XC = (ccfv @ XS @ XE))))))))))))))).
...
thf(aeengstr_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwbr @ (ccfv @ XN @ cceeng) @ (ccop @ cc1 @ (ccdc @ cc1 @ cc7)) @ ccstr)))).
...
thf(aeengv_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ cceeng) = (ccun @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccfv @ XN @ ccee)) @ (ccop @ (ccfv @ ccnx @ ccds) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ XN @ ccee))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ XN @ ccee))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xy1)) @ ccmin) @ cc2 @ ccexp)))))))) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccitv) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ XN @ ccee))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ XN @ ccee))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xz:$i] : (ccfv @ XN @ ccee))))))) @ (ccop @ (ccfv @ ccnx @ cclng) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ XN @ ccee))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ (ccfv @ XN @ ccee) @ (ccsn @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccbtwn) | (cwbr @ (ccv @ Xx3) @ (ccop @ (ccv @ Xz) @ (ccv @ Xy1)) @ ccbtwn) | (cwbr @ (ccv @ Xy1) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ ccbtwn))) @ (^ [Xz:$i] : (ccfv @ XN @ ccee))))))))))))).
...
thf(aeengbas_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccee) = (ccfv @ (ccfv @ XN @ cceeng) @ ccbs))))).
...
thf(aebtwntg_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((XP = (ccfv @ (ccfv @ XN @ cceeng) @ ccbs)) => ((XI = (ccfv @ (ccfv @ XN @ cceeng) @ ccitv)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwcel @ XZ @ XP)) => (Xph => ((cwbr @ XZ @ (ccop @ XX @ XY) @ ccbtwn) <=> (cwcel @ XZ @ (cco @ XX @ XY @ XI)))))))))))))))))).
...
thf(celntg_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XP @ Xx3 @ Xy1) = (ccfv @ (ccfv @ XN @ cceeng) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XI @ Xx3 @ Xy1 @ Xz) = (ccfv @ (ccfv @ XN @ cceeng) @ ccitv))))) => ((cwcel @ XN @ ccn) => ((ccfv @ (ccfv @ XN @ cceeng) @ cclng) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XP @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ (XP @ Xx3 @ Xy1) @ (ccsn @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XI @ Xx3 @ Xy1 @ Xz))) | (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ (XI @ Xx3 @ Xy1 @ Xz))) | (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (XI @ Xx3 @ Xy1 @ Xz))))) @ (^ [Xz:$i] : (XP @ Xx3 @ Xy1)))))))))))))).
