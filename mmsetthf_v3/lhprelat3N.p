...
thf(alhpoc2N_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XB2)) => ((cwcel @ XW @ XA2) <=> (cwcel @ (ccfv @ XW @ Xc_pe) @ XH)))))))))))))).
...
thf(aoldmm3N_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => (((cwcel @ XK @ ccol) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((ccfv @ (cco @ XX @ (ccfv @ XY @ Xc_pe) @ Xc_an) @ Xc_pe) = (cco @ (ccfv @ XX @ Xc_pe) @ XY @ Xc_or))))))))))))))).
...
thf(aopltcon3b_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => (((cwcel @ XK @ ccops) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ Xc_lt) <=> (cwbr @ (ccfv @ XY @ Xc_pe) @ (ccfv @ XX @ Xc_pe) @ Xc_lt))))))))))))).
...
thf(clhprelat3N_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [Xc_lt:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xw:$i] : ((XB2 @ Xw) = (ccfv @ XK @ ccbs))) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xw:$i] : ((Xc_lt @ Xw) = (ccfv @ XK @ ccplt))) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XC = (ccfv @ XK @ cccvr)) => ((XH = (ccfv @ XK @ cclh)) => (! [Xw:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ (XB2 @ Xw)) & (cwcel @ XY @ (XB2 @ Xw))) & (cwbr @ XX @ XY @ (Xc_lt @ Xw))) => (cwrex @ (^ [Xw:$i] : ((cwbr @ XX @ (cco @ XY @ (ccv @ Xw) @ Xc_an) @ Xc_le) & (cwbr @ (cco @ XY @ (ccv @ Xw) @ Xc_an) @ XY @ XC))) @ (^ [Xw:$i] : XH)))))))))))))))))))).
