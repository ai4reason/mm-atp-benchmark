...
thf(altmul12a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XA2 @ XB2 @ cclt))) & (((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr)) & ((cwbr @ ccc0 @ XC @ ccle) & (cwbr @ XC @ XD @ cclt)))) => (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ cclt))))))).
...
thf(altmul1a_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) & (cwbr @ XA2 @ XB2 @ cclt)) => (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ cclt)))))).
...
thf(ctgblthelfgottOLD_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccodd) & (cwbr @ cc7 @ XN @ cclt) & (cwbr @ XN @ (cco @ (ccdc @ cc8 @ cc8) @ (cco @ cc10 @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul) @ cclt)) => (cwcel @ XN @ ccgbo)))).
