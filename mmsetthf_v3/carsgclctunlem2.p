...
thf(aesumgect_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwbr @ (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (XB2 @ Xk) @ ccle)))) => (! [Xk:$i] : (Xph => (cwbr @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (XB2 @ Xk) @ ccle)))))))))).
thf(axrge0subcld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((Xph => (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((Xph => (cwbr @ XB2 @ XA2 @ ccle)) => (Xph => (cwcel @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ (cco @ ccc0 @ ccpnf @ ccicc)))))))))).
thf(acarsgmon_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XO @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((! [Xx3:$i] : (Xph => (cwss @ XA2 @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XB2 @ Xx3) @ (ccpw @ XO)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccle)))) => (! [Xx3:$i] : (Xph => (cwbr @ (ccfv @ XA2 @ XM) @ (ccfv @ (XB2 @ Xx3) @ XM) @ ccle))))))))))))))).
...
thf(axrge0neqmnf_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) => (XA2 != ccmnf)))).
...
thf(acarsgclctunlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XO @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => ((! [Xx3:$i] : ((Xph & (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & (cwss @ (ccv @ Xx3) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XM) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XM))) @ ccle))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwss @ XA2 @ (ccfv @ XM @ cccarsg))) => ((Xph => (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (ccv @ Xy1)))) => ((Xph => (cwcel @ XE @ (ccpw @ XO))) => (Xph => ((ccfv @ (ccin @ XE @ (ccuni @ XA2)) @ XM) = (ccesum @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (ccfv @ (ccin @ XE @ (ccv @ Xy1)) @ XM)))))))))))))))))))).
...
thf(adisjss1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwss @ XA2 @ XB2) => ((cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
