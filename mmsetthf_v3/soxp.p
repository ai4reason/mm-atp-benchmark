...
thf(apoxp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ XA2 @ XB2)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ XA2 @ XB2))) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ XR) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwbr @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ XS)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwpo @ XA2 @ XR) & (cwpo @ XB2 @ XS)) => (cwpo @ (ccxp @ XA2 @ XB2) @ (XT @ Xx3 @ Xy1)))))))))))).
