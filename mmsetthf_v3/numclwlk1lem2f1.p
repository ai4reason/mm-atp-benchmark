...
thf(a_2swrd2eqwrdeq_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ cclt)) => ((XW = XU) <=> (((ccfv @ XW @ cchash) = (ccfv @ XU @ cchash)) & (((cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin)) @ ccsubstr) = (cco @ XU @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin)) @ ccsubstr)) & ((ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW) = (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XU)) & ((ccfv @ XW @ cclsw) = (ccfv @ XU @ cclsw)))))))))).
