...
thf(cs2elclwwlknon2_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XG @ ccclwwlknon)) => ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XX @ XV) & (cwcel @ XY @ XV) & (cwcel @ (ccpr @ XX @ XY) @ XE)) => (cwcel @ (ccs2 @ XX @ XY) @ (cco @ XX @ cc2 @ XC))))))))))))).
