...
thf(acoeq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cccom @ XC @ XA2) = (cccom @ XC @ XB2))))))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(amapsncnv_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (XS = (ccsn @ (XX @ Xx3)))) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XX @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ XS @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (XX @ Xx3) @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cccnv @ (XF @ Xx3 @ Xy1)) = (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ XS @ (ccsn @ (ccv @ Xy1))))))))))))))))).
...
thf(amapsnf1o2_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (XS = (ccsn @ (XX @ Xx3)))) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XX @ Xx3) @ ccvv)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ XS @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (XX @ Xx3) @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwf1o @ (cco @ XB2 @ XS @ ccmap) @ XB2 @ (XF @ Xx3)))))))))))).
...
thf(avtocl2ga_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XB2 @ Xx3)) => ((Xps @ Xy1) <=> (Xch @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XC) & (cwcel @ (ccv @ Xy1) @ XD)) => (Xph @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XC) & (cwcel @ (XB2 @ Xx3) @ XD)) => (Xch @ Xx3)))))))))))))).
...
thf(ampff_thm,axiom,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => ((XB2 = (ccfv @ XS @ ccbs)) => ((cwcel @ XF @ XQ) => (cwf @ (cco @ XB2 @ XI @ ccmap) @ XB2 @ XF))))))))))).
...
thf(aply1ascl_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (ccfv @ XP @ ccascl)) => (XA2 = (ccfv @ (cco @ cc1o @ XR @ ccmpl) @ ccascl)))))))).
...
thf(aevl1val_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : ((! [Xy1:$i] : ((XO @ Xy1) = (ccfv @ (XR @ Xy1) @ cce1))) => ((! [Xy1:$i] : ((XQ @ Xy1) = (cco @ cc1o @ (XR @ Xy1) @ ccevl))) => ((! [Xy1:$i] : (XB2 = (ccfv @ (XR @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((XM @ Xy1) = (cco @ cc1o @ (XR @ Xy1) @ ccmpl))) => ((! [Xy1:$i] : ((XK @ Xy1) = (ccfv @ (XM @ Xy1) @ ccbs))) => (! [Xy1:$i] : (((cwcel @ (XR @ Xy1) @ cccrg) & (cwcel @ (XA2 @ Xy1) @ (XK @ Xy1))) => ((ccfv @ (XA2 @ Xy1) @ (XO @ Xy1)) = (cccom @ (ccfv @ (XA2 @ Xy1) @ (XQ @ Xy1)) @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1)))))))))))))))))))))).
thf(asylan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xps & Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(aevl1sca_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XO = (ccfv @ XR @ cce1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XA2 = (ccfv @ XP @ ccascl)) => (((cwcel @ XR @ cccrg) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccfv @ XX @ XA2) @ XO) = (ccxp @ XB2 @ (ccsn @ XX))))))))))))))).
