...
thf(cdisjss3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (((cwss @ XA2 @ XB2) & (cwral @ (^ [Xx3:$i] : ((XC @ Xx3) = cc0)) @ (^ [Xx3:$i] : (ccdif @ XB2 @ XA2)))) => ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) <=> (cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
