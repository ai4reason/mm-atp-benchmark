...
thf(cppisval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ cc2 @ (ccfv @ XM @ ccuz))) => ((ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) = (ccin @ (cco @ XM @ (ccfv @ XA2 @ ccfl) @ ccfz) @ ccprime)))))).
