...
thf(cringcinv_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ ccringc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XN = (ccfv @ XC @ ccinv)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XX @ XY @ XN)) <=> ((cwcel @ XF @ (cco @ XX @ XY @ ccrs)) & (XG = (cccnv @ XF)))))))))))))))))))))).
