...
thf(ccusgrexi_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))) => ((cwcel @ XV @ XW) => (cwcel @ (ccop @ XV @ (ccres @ ccid @ XP)) @ cccusgr))))))).
