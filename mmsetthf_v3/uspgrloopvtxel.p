...
thf(cuspgrloopvtxel_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccsn @ XN))))) => (((cwcel @ XV @ XW) & (cwcel @ XN @ XV)) => (cwcel @ XN @ (ccfv @ XG @ ccvtx)))))))))).
