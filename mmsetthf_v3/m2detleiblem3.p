...
thf(cm2detleiblem3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccpr @ cc1 @ cc2)) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ XN @ XR @ ccmat))) => ((! [Xn:$i] : (XB2 = (ccfv @ (XA2 @ Xn) @ ccbs))) => ((! [Xn:$i] : ((XG @ Xn) = (ccfv @ XR @ ccmgp))) => ((! [Xn:$i] : ((Xc_x @ Xn) = (ccfv @ (XG @ Xn) @ ccplusg))) => (! [Xn:$i] : (((cwcel @ XR @ ccrg) & (XQ = (ccpr @ (ccop @ cc1 @ cc1) @ (ccop @ cc2 @ cc2))) & (cwcel @ XM @ XB2)) => ((cco @ (XG @ Xn) @ (ccmpt @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccv @ Xn) @ XM))) @ ccgsu) = (cco @ (cco @ cc1 @ cc1 @ XM) @ (cco @ cc2 @ cc2 @ XM) @ (Xc_x @ Xn))))))))))))))))))))).
