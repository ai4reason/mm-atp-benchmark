...
thf(awlk0prc_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (((cwnel @ XS @ ccvv) & ((ccfv @ XS @ ccvtx) = (ccfv @ XG @ ccvtx))) => ((ccfv @ XG @ ccwlks) = cc0))))).
