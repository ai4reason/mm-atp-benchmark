...
thf(adivgt1b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ cc1 @ (cco @ XB2 @ XA2 @ ccdiv) @ cclt)))))).
...
thf(cpw2m1lepw2m1_conj,conjecture,(! [XI:($i > $o)] : ((cwcel @ XI @ ccn) => (cwbr @ (cco @ cc2 @ (cco @ XI @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ XI @ ccexp) @ cc1 @ ccmin) @ ccle)))).
