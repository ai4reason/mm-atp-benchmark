...
thf(cupgredgss_conj,conjecture,(! [XG:($i > $o)] : ((cwcel @ XG @ ccupgr) => (cwss @ (ccfv @ XG @ ccedg) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ (ccfv @ XG @ ccvtx)) @ (ccsn @ cc0)))))))).
