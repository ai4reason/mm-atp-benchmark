...
thf(abrcoffn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwfn @ XC @ XY)) => ((Xph => (cwf @ XX @ XY @ XD)) => ((Xph => (cwbr @ XA2 @ XB2 @ (cccom @ XC @ XD))) => (Xph => ((cwbr @ XA2 @ (ccfv @ XA2 @ XD) @ XD) & (cwbr @ (ccfv @ XA2 @ XD) @ XB2 @ XC)))))))))))))).
