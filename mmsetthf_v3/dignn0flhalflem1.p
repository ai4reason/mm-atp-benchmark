...
thf(am1modmmod_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn)) => ((cco @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmo) @ (cco @ XA2 @ XN @ ccmo) @ ccmin) = (ccif @ ((cco @ XA2 @ XN @ ccmo) = ccc0) @ (cco @ XN @ cc1 @ ccmin) @ (ccneg @ cc1))))))).
...
thf(aexpn1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ (ccneg @ cc1) @ ccexp) = (cco @ cc1 @ XA2 @ ccdiv))))).
...
thf(altsubadd2b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr))) => ((cwbr @ (cco @ XD @ XC @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ cclt) <=> (cwbr @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))).
...
thf(adivsub1dir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (XB2 != ccc0)) => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1 @ ccmin) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XB2 @ ccdiv)))))).
thf(afldivmod_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) = (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XB2 @ ccdiv)))))).
thf(cdignn0flhalflem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn) & (cwcel @ XN @ ccn)) => (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ cc1 @ ccmin) @ ccfl) @ (ccfv @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl) @ cclt))))).
