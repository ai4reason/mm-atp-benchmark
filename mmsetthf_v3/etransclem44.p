...
thf(aetransclem9_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (XK != ccc0)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (~ (cwbr @ XK @ XM @ ccdvds))) => ((Xph => (cwbr @ XK @ XN @ ccdvds)) => (Xph => ((cco @ XM @ XN @ ccaddc) != ccc0))))))))))))).
...
thf(aetransclem38_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XF @ Xx3 @ Xj @ Xn @ Xc) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))))) => ((Xph => (cwcel @ XI @ ccn0)) => ((Xph => (cwcel @ XJ @ (cco @ ccc0 @ XM @ ccfz))) => ((Xph => (~ ((XI = (cco @ XP @ cc1 @ ccmin)) & (XJ = ccc0)))) => ((XC = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccrab @ (^ [Xc:$i] : ((ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (ccv @ Xc)))) = (ccv @ Xn))) @ (^ [Xc:$i] : (cco @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (cco @ ccc0 @ XM @ ccfz) @ ccmap)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xc:$i] : (Xph => (cwbr @ XP @ (cco @ (ccfv @ XJ @ (ccfv @ XI @ (cco @ ccr @ (XF @ Xx3 @ Xj @ Xn @ Xc) @ ccdvn))) @ (ccfv @ (cco @ XP @ cc1 @ ccmin) @ ccfa) @ ccdiv) @ ccdvds))))))))))))))))))))).
...
thf(cetransclem44_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : (Xph => (cwf @ ccn0 @ ccz @ (XA2 @ Xx3 @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : (Xph => ((ccfv @ ccc0 @ (XA2 @ Xx3 @ Xj)) != ccc0)))) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XP @ ccprime)) => ((! [Xx3:$i] : (! [Xj:$i] : (Xph => (cwbr @ (ccfv @ (ccfv @ ccc0 @ (XA2 @ Xx3 @ Xj)) @ ccabs) @ XP @ cclt)))) => ((Xph => (cwbr @ (ccfv @ XM @ ccfa) @ XP @ cclt)) => ((! [Xx3:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xj) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XK @ Xx3 @ Xj @ Xk) = (cco @ (ccsu @ (ccxp @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ ccc0 @ (cco @ (cco @ XM @ XP @ ccmul) @ (cco @ XP @ cc1 @ ccmin) @ ccaddc) @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xk) @ cc1st) @ (XA2 @ Xx3 @ Xj)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xk) @ cc2nd) @ (cco @ ccr @ (XF @ Xx3 @ Xj) @ ccdvn))) @ ccmul))) @ (ccfv @ (cco @ XP @ cc1 @ ccmin) @ ccfa) @ ccdiv))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (Xph => ((XK @ Xx3 @ Xj @ Xk) != ccc0)))))))))))))))))))).
