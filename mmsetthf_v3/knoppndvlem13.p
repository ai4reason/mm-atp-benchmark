...
thf(cknoppndvlem13_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (Xph => (XC != ccc0))))))))).
