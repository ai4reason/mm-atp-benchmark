...
thf(cseqp1_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (ccseq @ Xc_pl @ XF @ XM)) = (cco @ (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XF) @ Xc_pl)))))))).
