...
thf(ablrn_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XA2 @ (ccrn @ (ccfv @ XD @ ccbl))) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XA2 = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)))) @ (^ [Xr:$i] : ccxr))) @ (^ [Xx3:$i] : XX)))))))).
...
thf(axbln0_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccxr)) => (((cco @ XP @ XR @ (ccfv @ XD @ ccbl)) != cc0) <=> (cwbr @ ccc0 @ XR @ cclt)))))))).
...
thf(aprdsbas2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => (Xph => (XB2 = (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))))))))))))))))))).
...
thf(amopni2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XA2 @ XJ) & (cwcel @ XP @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ XA2)) @ (^ [Xx3:$i] : ccrp)))))))))).
...
thf(afitop_thm,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ ccfi) = XJ)))).
