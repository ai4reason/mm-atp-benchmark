...
thf(cdisjtp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((((XA2 != XD) & (XB2 != XD) & (XC != XD)) & ((XA2 != XE) & (XB2 != XE) & (XC != XE)) & ((XA2 != XF) & (XB2 != XF) & (XC != XF))) => ((ccin @ (cctp @ XA2 @ XB2 @ XC) @ (cctp @ XD @ XE @ XF)) = cc0))))))))).
