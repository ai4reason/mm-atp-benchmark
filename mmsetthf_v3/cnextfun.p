...
thf(acnextrel_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) & ((cwf @ XA2 @ XB2 @ XF) & (cwss @ XA2 @ XC))) => (cwrel @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext))))))))))))).
