...
thf(amblfinlem1_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) & (XA2 != cc0)) => (? [Xf1:$i] : (cwf1o @ ccn @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xc:$i] : ((cwss @ (ccfv @ (ccv @ Xa) @ ccicc) @ (ccfv @ (ccv @ Xc) @ ccicc)) => ((ccv @ Xa) = (ccv @ Xc)))) @ (^ [Xc:$i] : (ccrab @ (^ [Xb:$i] : (cwss @ (ccfv @ (ccv @ Xb) @ ccicc) @ XA2)) @ (^ [Xb:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv))))))))))) @ (^ [Xa:$i] : (ccrab @ (^ [Xb:$i] : (cwss @ (ccfv @ (ccv @ Xb) @ ccicc) @ XA2)) @ (^ [Xb:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))))))) @ (ccv @ Xf1)))))).
...
thf(adyadmbllem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XG @ Xx3 @ Xy1 @ Xw) = (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cwss @ (ccfv @ (ccv @ Xz) @ ccicc) @ (ccfv @ (ccv @ Xw) @ ccicc)) => ((ccv @ Xz) = (ccv @ Xw)))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XA2 @ (ccrn @ XF))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1) => ((ccuni @ (ccima @ ccicc @ XA2)) = (ccuni @ (ccima @ ccicc @ (XG @ Xx3 @ Xy1 @ Xw)))))))))))))))).
...
thf(aopnmbllem0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((ccuni @ (ccima @ ccicc @ (ccrab @ (^ [Xz:$i] : (cwss @ (ccfv @ (ccv @ Xz) @ ccicc) @ XA2)) @ (^ [Xz:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))))))) = XA2)))).
...
thf(adyadf_thm,axiom,(! [XF:($i > $o)] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (cwf @ (ccxp @ ccz @ ccn0) @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)))).
...
thf(adyaddisj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (((cwcel @ XA2 @ (ccrn @ XF)) & (cwcel @ XB2 @ (ccrn @ XF))) => ((cwss @ (ccfv @ XA2 @ ccicc) @ (ccfv @ XB2 @ ccicc)) | (cwss @ (ccfv @ XB2 @ ccicc) @ (ccfv @ XA2 @ ccicc)) | ((ccin @ (ccfv @ XA2 @ ccioo) @ (ccfv @ XB2 @ ccioo)) = cc0)))))))).
...
thf(af1veqaeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & ((cwcel @ XC @ XA2) & (cwcel @ XD @ XA2))) => (((ccfv @ XC @ XF) = (ccfv @ XD @ XF)) => (XC = XD))))))))).
...
thf(adisjeq2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : ((XB2 @ Xx3) = (XC @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) <=> (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(aiccf_thm,axiom,(cwf @ (ccxp @ ccxr @ ccxr) @ (ccpw @ ccxr) @ ccicc)).
...
thf(aiunxun_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cciun @ (^ [Xx3:$i] : (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccun @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cciun @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
thf(auneq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((ccun @ XA2 @ XC) = (ccun @ XB2 @ XD))))))))))).
thf(aiuneq2i_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) => ((XB2 @ Xx3) = (XC @ Xx3)))) => ((cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(asupmax_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwor @ XA2 @ XR)) => ((Xph => (cwcel @ XC @ XA2)) => ((Xph => (cwcel @ XC @ XB2)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (~ (cwbr @ XC @ (ccv @ Xy1) @ XR)))) => (Xph => ((ccsup @ XB2 @ XA2 @ XR) = XC)))))))))))).
...
thf(aser0_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XN @ XZ) => ((ccfv @ XN @ (ccseq @ ccaddc @ (ccxp @ XZ @ (ccsn @ ccc0)) @ XM)) = ccc0))))))).
...
thf(aad5ant15_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((Xph & Xps) => Xch) => (((((Xph & Xth) & Xta) & Xet) & Xps) => Xch))))))))).
...
thf(aovolsn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccsn @ XA2) @ ccovol) = ccc0)))).
thf(aovolunnul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwss @ XB2 @ ccr) & ((ccfv @ XB2 @ ccovol) = ccc0)) => ((ccfv @ (ccun @ XA2 @ XB2) @ ccovol) = (ccfv @ XA2 @ ccovol)))))).
...
thf(cmblfinlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) & (cwcel @ XM @ ccr) & (cwbr @ XM @ (ccfv @ XA2 @ ccovol) @ cclt)) => (cwrex @ (^ [Xs1:$i] : ((cwss @ (ccv @ Xs1) @ XA2) & (cwbr @ XM @ (ccfv @ (ccv @ Xs1) @ ccovol) @ cclt))) @ (^ [Xs1:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))))).
