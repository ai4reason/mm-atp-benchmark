...
thf(aevl1fval1lem_thm,axiom,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ XV) => (XQ = (cco @ XR @ XB2 @ cces1)))))))))).
...
thf(areldmevls1_thm,axiom,(cwrel @ (ccdm @ cces1))).
thf(cevl1fval1_conj,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XB2 = (ccfv @ XR @ ccbs)) => (XQ = (cco @ XR @ XB2 @ cces1)))))))).
