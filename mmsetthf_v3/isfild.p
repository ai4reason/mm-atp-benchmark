...
thf(cisfild_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3 @ Xz)))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => ((! [Xz:$i] : (Xph => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ XA2))) => ((! [Xz:$i] : (Xph => (~ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ cc0)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xz) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz)) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xz) @ XA2)) => (((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz))) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))) => (Xph => (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
