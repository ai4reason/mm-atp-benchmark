...
thf(albsex_thm,axiom,(! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cclbs)) => ((cwcel @ XW @ cclvec) => (XJ != cc0)))))).
...
thf(almisfree_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cclbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ cclmod) => ((XJ != cc0) <=> (? [Xk:$i] : (cwbr @ XW @ (cco @ XF @ (ccv @ Xk) @ ccfrlm) @ cclmic)))))))))).
