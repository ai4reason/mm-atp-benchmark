...
thf(ceqgabl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xc_sm = (cco @ XG @ XS @ ccqg)) => (((cwcel @ XG @ ccabl) & (cwss @ XS @ XX)) => ((cwbr @ XA2 @ XB2 @ Xc_sm) <=> ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ (cco @ XB2 @ XA2 @ Xc_mi) @ XS))))))))))))))).
