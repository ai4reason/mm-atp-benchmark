...
thf(alcmval_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ cclcm) = (ccif @ ((XM = ccc0) | (XN = ccc0)) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : ((cwbr @ XM @ (ccv @ Xn) @ ccdvds) & (cwbr @ XN @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt))))))).
thf(clcmfpr_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((ccfv @ (ccpr @ XM @ XN) @ cclcmf) = (cco @ XM @ XN @ cclcm)))))).
