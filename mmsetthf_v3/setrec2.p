...
thf(csetrec2_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xa:$i] : (XF @ Xa))) => ((! [Xa:$i] : ((XB2 @ Xa) = (ccsetrecs @ (XF @ Xa)))) => ((! [Xa:$i] : ((Xph @ Xa) => (! [Xa:$i] : ((cwss @ (ccv @ Xa) @ XC) => (cwss @ (ccfv @ (ccv @ Xa) @ (XF @ Xa)) @ XC))))) => (! [Xa:$i] : ((Xph @ Xa) => (cwss @ (XB2 @ Xa) @ XC))))))))))).
