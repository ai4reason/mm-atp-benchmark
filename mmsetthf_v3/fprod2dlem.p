...
thf(acbvprodi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XB2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XC @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (ccv @ Xk)) => ((XB2 @ Xj @ Xk) = (XC @ Xj @ Xk))))) => (! [Xj:$i] : (! [Xk:$i] : ((ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xj @ Xk))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))))))))))).
...
thf(anfcprod_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))) => (cwnfc @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk)))))))))).
thf(anfcsb1v_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwnfc @ (^ [Xx3:$i] : (ccsb @ XA2 @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
thf(aprodeq12dv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((Xph => (XA2 = XB2)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => ((XC @ Xk) = (XD @ Xk)))) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XD @ Xk))))))))))))).
...
thf(aprodsn_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = XB2))) => (((cwcel @ XM @ XV) & (cwcel @ XB2 @ ccc)) => ((ccprod @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) = XB2)))))))).
...
thf(a_2ndconst_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwf1o @ (ccxp @ (ccsn @ XA2) @ XB2) @ XB2 @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XA2) @ XB2)))))))).
...
thf(acbvex_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ X)))) => ((! [Xy1:$i] : ((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)) @ X)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((? [Xx3:$i] : (Xph @ Xx3 @ Xy1)) <=> (? [Xy1:$i] : (Xps @ Xx3 @ Xy1))))))))))).
...
thf(aiunxsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = XC))) => ((cciun @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = XC))))))).
...
thf(cfprod2dlem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xz) = (ccop @ (ccv @ Xj) @ (ccv @ Xk))) => ((XD @ Xx3 @ Xy1 @ Xz) = (XC @ Xx3 @ Xy1 @ Xj @ Xk)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz) @ ccfn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (((Xph @ Xx3 @ Xy1) & (cwcel @ (ccv @ Xj) @ (XA2 @ Xx3 @ Xy1 @ Xz))) => (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xj) @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xx3 @ Xy1) & ((cwcel @ (ccv @ Xj) @ (XA2 @ Xx3 @ Xy1 @ Xz)) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3 @ Xy1 @ Xj)))) => (cwcel @ (XC @ Xx3 @ Xy1 @ Xj @ Xk) @ ccc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xy1))) @ (XA2 @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xps @ Xx3 @ Xy1 @ Xz @ Xj @ Xk) <=> ((ccprod @ (^ [Xj:$i] : (ccv @ Xx3)) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xy1 @ Xj)) @ (^ [Xk:$i] : (XC @ Xx3 @ Xy1 @ Xj @ Xk))))) = (ccprod @ (^ [Xz:$i] : (cciun @ (^ [Xj:$i] : (ccv @ Xx3)) @ (^ [Xj:$i] : (ccxp @ (ccsn @ (ccv @ Xj)) @ (XB2 @ Xx3 @ Xy1 @ Xj))))) @ (^ [Xz:$i] : (XD @ Xx3 @ Xy1 @ Xz)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xx3 @ Xy1) & (Xps @ Xx3 @ Xy1 @ Xz @ Xj @ Xk)) => ((ccprod @ (^ [Xj:$i] : (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xy1)))) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xy1 @ Xj)) @ (^ [Xk:$i] : (XC @ Xx3 @ Xy1 @ Xj @ Xk))))) = (ccprod @ (^ [Xz:$i] : (cciun @ (^ [Xj:$i] : (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xy1)))) @ (^ [Xj:$i] : (ccxp @ (ccsn @ (ccv @ Xj)) @ (XB2 @ Xx3 @ Xy1 @ Xj))))) @ (^ [Xz:$i] : (XD @ Xx3 @ Xy1 @ Xz)))))))))))))))))))))))).
