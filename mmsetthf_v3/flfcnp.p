...
thf(cflfcnp_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwf @ XY @ XX @ XF)) & ((cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) & (cwcel @ XG @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))))) => (cwcel @ (ccfv @ XA2 @ XG) @ (ccfv @ (cccom @ XG @ XF) @ (cco @ XK @ XL @ ccflf))))))))))))).
