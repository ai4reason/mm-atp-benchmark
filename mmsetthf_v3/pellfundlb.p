...
thf(cpellfundlb_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) & (cwbr @ cc1 @ XA2 @ cclt)) => (cwbr @ (ccfv @ XD @ ccpellfund) @ XA2 @ ccle))))).
