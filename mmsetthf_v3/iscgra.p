...
thf(adf_cgra_ax,axiom,(cccgra = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xk:$i] : (((cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xp) @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccmap)) & (cwcel @ (ccv @ Xb) @ (cco @ (ccv @ Xp) @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccmap))) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xa) @ (ccs3 @ (ccv @ Xx3) @ (ccfv @ cc1 @ (ccv @ Xb)) @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xg1) @ cccgrg)) & (cwbr @ (ccv @ Xx3) @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xb)) @ (ccv @ Xk))) & (cwbr @ (ccv @ Xy1) @ (ccfv @ cc2 @ (ccv @ Xb)) @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xb)) @ (ccv @ Xk))))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))))) @ (ccfv @ (ccv @ Xg1) @ cchlg))) @ (ccfv @ (ccv @ Xg1) @ ccbs))))))))).
