...
thf(adirkertrigeq_thm,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XD @ Xk @ Xn @ Xs1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ ((cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XF @ Xk @ Xn @ Xs1) = (ccfv @ (XN @ Xn) @ (XD @ Xk @ Xn @ Xs1)))))) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XH @ Xk @ Xn @ Xs1) = (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ (XN @ Xn) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xs1) @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv))))))) => (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xn) => ((XF @ Xk @ Xn @ Xs1) = (XH @ Xk @ Xn @ Xs1)))))))))))))))).
...
thf(advsinax_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ ccc @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ ccsin))) @ ccdv) = (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ cccos) @ ccmul))))))).
thf(advcnre_thm,axiom,(! [XF:($i > $o)] : (((cwf @ ccc @ ccc @ XF) & (cwss @ ccr @ (ccdm @ (cco @ ccc @ XF @ ccdv)))) => ((cco @ ccr @ (ccres @ XF @ ccr) @ ccdv) = (ccres @ (cco @ ccc @ XF @ ccdv) @ ccr))))).
...
thf(aaddcncf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XX @ ccc @ cccncf))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccaddc))) @ (cco @ XX @ ccc @ cccncf)))))))))).
