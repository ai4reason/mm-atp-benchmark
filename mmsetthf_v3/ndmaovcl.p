...
thf(cndmaovcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((ccdm @ XF) = (ccxp @ XS @ XS)) => ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) => (cwcel @ (ccaov @ XA2 @ XB2 @ XF) @ XS)) => ((cwcel @ (ccaov @ XA2 @ XB2 @ XF) @ ccvv) => (cwcel @ (ccaov @ XA2 @ XB2 @ XF) @ XS))))))))).
