...
thf(cclimbdd_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => (((cwcel @ XM @ ccz) & (cwcel @ XF @ (ccdm @ ccli)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc)) @ (^ [Xk:$i] : XZ))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))).
