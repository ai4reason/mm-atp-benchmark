...
thf(cvtoclegft_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3)) & ((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) & (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3)))) => (Xph @ Xx3))))))).
