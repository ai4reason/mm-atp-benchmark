...
thf(cslmdvsass_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_xp = (ccfv @ XF @ ccmulr)) => (((cwcel @ XW @ ccslmd) & ((cwcel @ XQ @ XK) & (cwcel @ XR @ XK) & (cwcel @ XX @ XV))) => ((cco @ (cco @ XQ @ XR @ Xc_xp) @ XX @ Xc_x) = (cco @ XQ @ (cco @ XR @ XX @ Xc_x) @ Xc_x)))))))))))))))))).
