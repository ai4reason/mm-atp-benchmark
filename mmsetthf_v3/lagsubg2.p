...
thf(clagsubg2_conj,conjecture,(! [Xph:$o] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_sm = (cco @ XG @ XY @ ccqg)) => ((Xph => (cwcel @ XY @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XX @ ccfn)) => (Xph => ((ccfv @ XX @ cchash) = (cco @ (ccfv @ (ccqs @ XX @ Xc_sm) @ cchash) @ (ccfv @ XY @ cchash) @ ccmul))))))))))))).
