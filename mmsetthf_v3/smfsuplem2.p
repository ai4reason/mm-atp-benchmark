...
thf(asmfsuplem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xy1) @ ccz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xy1) @ ccuz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XS @ Xx3 @ Xy1) @ ccsalg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (Xph => (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xy1) @ ccsmblfn) @ (XF @ Xn)))))) => ((XD = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ ccr @ cclt))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ ccr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XZ @ (XS @ Xx3 @ Xy1) @ XH)))) => ((! [Xy1:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => ((ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (cco @ ccmnf @ (XA2 @ Xy1) @ ccioc)) = (ccin @ (ccfv @ (ccv @ Xn) @ XH) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccima @ (cccnv @ (XG @ Xy1)) @ (cco @ ccmnf @ (XA2 @ Xy1) @ ccioc)) @ (cco @ (XS @ Xx3 @ Xy1) @ XD @ ccrest)))))))))))))))))))))))).
