...
thf(adf_vr1_ax,axiom,(ccv1 = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccfv @ cc0 @ (cco @ cc1o @ (ccv @ Xr) @ ccmvr)))))).
...
thf(cvr1val_conj,conjecture,(! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccv1)) => (XX = (ccfv @ cc0 @ (cco @ cc1o @ XR @ ccmvr))))))).
