...
thf(cipolt_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XF @ ccipo)) => ((Xc_lt = (ccfv @ XI @ ccplt)) => (((cwcel @ XF @ XV) & (cwcel @ XX @ XF) & (cwcel @ XY @ XF)) => ((cwbr @ XX @ XY @ Xc_lt) <=> (cwpss @ XX @ XY)))))))))))).
