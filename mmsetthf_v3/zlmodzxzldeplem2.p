...
thf(czlmodzxzldeplem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((XF = (ccpr @ (ccop @ XA2 @ cc2) @ (ccop @ XB2 @ (ccneg @ cc3)))) => (cwbr @ XF @ ccc0 @ ccfsupp)))))))))).
