...
thf(cblval_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccxr)) => ((cco @ XP @ XR @ (ccfv @ XD @ ccbl)) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ XP @ (ccv @ Xx3) @ XD) @ XR @ cclt)) @ (^ [Xx3:$i] : XX))))))))).
