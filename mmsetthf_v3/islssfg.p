...
thf(aislmodfg_thm,axiom,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((cwcel @ XW @ cclmod) => ((cwcel @ XW @ cclfig) <=> (cwrex @ (^ [Xb:$i] : ((cwcel @ (ccv @ Xb) @ ccfn) & ((ccfv @ (ccv @ Xb) @ XN) = XB2))) @ (^ [Xb:$i] : (ccpw @ XB2))))))))))).
thf(cislssfg_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS)) => ((cwcel @ XX @ cclfig) <=> (cwrex @ (^ [Xb:$i] : ((cwcel @ (ccv @ Xb) @ ccfn) & ((ccfv @ (ccv @ Xb) @ XN) = XU))) @ (^ [Xb:$i] : (ccpw @ XU)))))))))))))).
