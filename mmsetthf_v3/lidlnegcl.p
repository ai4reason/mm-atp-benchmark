...
thf(arlmvneg_thm,axiom,(! [XR:($i > $o)] : ((ccfv @ XR @ ccminusg) = (ccfv @ (ccfv @ XR @ ccrglmod) @ ccminusg)))).
...
thf(clidlnegcl_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((XN = (ccfv @ XR @ ccminusg)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU) & (cwcel @ XX @ XI)) => (cwcel @ (ccfv @ XX @ XN) @ XI)))))))))).
