...
thf(cpcdvdstr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwbr @ XA2 @ XB2 @ ccdvds))) => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle)))))).
