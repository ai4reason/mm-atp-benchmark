...
thf(aelico1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) <=> ((cwcel @ XC @ ccxr) & (cwbr @ XA2 @ XC @ ccle) & (cwbr @ XC @ XB2 @ cclt)))))))).
