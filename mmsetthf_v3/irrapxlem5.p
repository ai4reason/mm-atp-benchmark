...
thf(cirrapxlem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) & (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ XB2 @ cclt) & (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccdenom) @ (ccneg @ cc2) @ ccexp) @ cclt))) @ (^ [Xx3:$i] : ccq)))))).
