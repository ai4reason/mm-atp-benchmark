...
thf(aelunitge0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) => (cwbr @ ccc0 @ XA2 @ ccle)))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) => Xch))))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccxdiv_tp,type,(ccxdiv : ($i > $o))).
thf(aprobmeasb_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ (ccfv @ XS @ ccmeas)) & (cwcel @ XA2 @ XS) & (cwcel @ (ccfv @ XA2 @ XM) @ ccrp)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ XM) @ (ccfv @ XA2 @ XM) @ ccdiv))) @ ccprb)))))).
...
thf(ccndprobprob_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprb) & (cwcel @ XB2 @ (ccdm @ XP)) & ((ccfv @ XB2 @ XP) != ccc0)) => (cwcel @ (ccmpt @ (^ [Xa:$i] : (ccdm @ XP)) @ (^ [Xa:$i] : (ccfv @ (ccop @ (ccv @ Xa) @ XB2) @ (ccfv @ XP @ cccprob)))) @ ccprb))))).
