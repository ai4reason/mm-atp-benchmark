...
thf(awlknwwlksnfun_thm,axiom,(! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : ((XT @ Xp) = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))))) => ((! [Xp:$i] : ((XW @ Xp) = (cco @ XN @ XG @ ccwwlksn))) => ((! [Xt:$i] : (! [Xp:$i] : ((XF @ Xt @ Xp) = (ccmpt @ (^ [Xt:$i] : (XT @ Xp)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd)))))) => (! [Xt:$i] : (! [Xp:$i] : (((cwcel @ XG @ ccupgr) & (cwcel @ XN @ ccn0)) => (cwf @ (XT @ Xp) @ (XW @ Xp) @ (XF @ Xt @ Xp)))))))))))))).
