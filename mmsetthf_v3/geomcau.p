...
thf(aexpcnv_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XA2 @ ccc))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccexp))) @ ccc0 @ ccli)))))))).
...
thf(ageolim2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz))) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ XA2 @ (ccv @ Xk) @ ccexp)))) => (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccli))))))))))).
...
thf(amettrifi_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XX))) => (Xph => (cwbr @ (cco @ (ccfv @ XM @ XF) @ (ccfv @ XN @ XF) @ XD) @ (ccsu @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XF) @ XD))) @ ccle)))))))))))).
