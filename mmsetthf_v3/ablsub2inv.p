...
thf(cablsub2inv_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XN = (ccfv @ XG @ ccminusg)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cco @ (ccfv @ XX @ XN) @ (ccfv @ XY @ XN) @ Xc_mi) = (cco @ XY @ XX @ Xc_mi))))))))))))))))).
