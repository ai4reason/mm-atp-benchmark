...
thf(cccats1pfxeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV)) & ((ccfv @ XU @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) => ((XW = (cco @ XU @ (ccfv @ XW @ cchash) @ ccpfx)) => (XU = (cco @ XW @ (ccs1 @ (ccfv @ XU @ cclsw)) @ ccconcat)))))))).
