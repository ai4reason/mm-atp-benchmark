...
thf(cmaxidlval_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XG @ Xi @ Xj) = (ccfv @ XR @ cc1st)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XX @ Xi @ Xj) = (ccrn @ (XG @ Xi @ Xj))))) => (! [Xj:$i] : ((cwcel @ XR @ ccrngo) => ((ccfv @ XR @ ccmaxidl) = (ccrab @ (^ [Xi:$i] : (((ccv @ Xi) != (XX @ Xi @ Xj)) & (cwral @ (^ [Xj:$i] : ((cwss @ (ccv @ Xi) @ (ccv @ Xj)) => (((ccv @ Xj) = (ccv @ Xi)) | ((ccv @ Xj) = (XX @ Xi @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ XR @ ccidl)))))))))))).
