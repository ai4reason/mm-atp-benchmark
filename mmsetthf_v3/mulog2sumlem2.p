...
thf(arlimo1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwbr @ XF @ XA2 @ ccrli) => (cwcel @ XF @ cco1))))).
...
thf(amule1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwbr @ (ccfv @ (ccfv @ XA2 @ ccmu) @ ccabs) @ cc1 @ ccle)))).
...
thf(amulog2sumlem1_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : ((XF @ Xy1 @ Xi @ Xm) = (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccv @ Xi) @ ccdiv))) @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : ((Xph @ Xy1 @ Xi) => (cwbr @ (XF @ Xy1 @ Xi @ Xm) @ (XL @ Xy1 @ Xi @ Xm) @ ccrli))))) => ((! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwcel @ XA2 @ ccrp)))) => ((! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwbr @ cceu @ XA2 @ ccle)))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : ((Xph @ Xy1 @ Xi) => (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xm) @ ccdiv) @ cclog) @ (ccv @ Xm) @ ccdiv))) @ (cco @ (cco @ (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ (cco @ (cco @ ccem @ (ccfv @ XA2 @ cclog) @ ccmul) @ (XL @ Xy1 @ Xi @ Xm) @ ccmin) @ ccaddc) @ ccmin) @ ccabs) @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ cclog) @ XA2 @ ccdiv) @ ccmul) @ ccle)))))))))))))).
...
thf(cmulog2sumlem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XF @ Xy1 @ Xi @ Xm @ Xn) = (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccv @ Xi) @ ccdiv))) @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin)))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xi) => (cwbr @ (XF @ Xy1 @ Xi @ Xm @ Xn) @ (XL @ Xy1 @ Xi @ Xm) @ ccrli)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XT @ Xx3 @ Xy1 @ Xi @ Xm @ Xn) = (cco @ (cco @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ (cco @ (cco @ ccem @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ cclog) @ ccmul) @ (XL @ Xy1 @ Xi @ Xm) @ ccmin) @ ccaddc))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : ((XR @ Xy1 @ Xi @ Xm) = (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ ccem @ (ccfv @ (XL @ Xy1 @ Xi @ Xm) @ ccabs) @ ccaddc) @ ccaddc) @ (ccsu @ (cco @ cc1 @ cc2 @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (cco @ cceu @ (ccv @ Xm) @ ccdiv) @ cclog) @ (ccv @ Xm) @ ccdiv))) @ ccaddc))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : ((Xph @ Xy1 @ Xi) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccmu) @ (ccv @ Xn) @ ccdiv) @ (XT @ Xx3 @ Xy1 @ Xi @ Xm @ Xn) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1))))))))))))))).
