...
thf(aust0_thm,axiom,((ccfv @ cc0 @ ccust) = (ccsn @ (ccsn @ cc0)))).
...
thf(adf_usp_ax,axiom,(ccusp = (^ [Xf1:$i] : ((cwcel @ (ccfv @ (ccv @ Xf1) @ ccuss) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ ccbs) @ ccust)) & ((ccfv @ (ccv @ Xf1) @ cctopn) = (ccfv @ (ccfv @ (ccv @ Xf1) @ ccuss) @ ccutop)))))).
thf(cisusp_conj,conjecture,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XU = (ccfv @ XW @ ccuss)) => ((XJ = (ccfv @ XW @ cctopn)) => ((cwcel @ XW @ ccusp) <=> ((cwcel @ XU @ (ccfv @ XB2 @ ccust)) & (XJ = (ccfv @ XU @ ccutop)))))))))))).
