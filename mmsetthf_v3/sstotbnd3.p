...
thf(asstotbnd2_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccres @ XM @ (ccxp @ XY @ XY))) => (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwss @ XY @ XX)) => ((cwcel @ XN @ (ccfv @ XY @ cctotbnd)) <=> (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ XY @ (cciun @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XX) @ ccfn)))) @ (^ [Xd:$i] : ccrp)))))))))).
