...
thf(aexpfac_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => (cwbr @ (XF @ Xn) @ ccc0 @ ccli))))))).
...
thf(aetransclem47_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XQ @ Xx3 @ Xk) @ (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => ((ccfv @ cceu @ (XQ @ Xx3 @ Xk)) = ccc0)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XA2 @ Xx3) = (ccfv @ (XQ @ Xx3 @ Xk) @ cccoe)))) => ((! [Xx3:$i] : (Xph => ((ccfv @ ccc0 @ (XA2 @ Xx3)) != ccc0))) => ((! [Xx3:$i] : (! [Xk:$i] : (XM = (ccfv @ (XQ @ Xx3 @ Xk) @ ccdgr)))) => ((Xph => (cwcel @ XP @ ccprime)) => ((! [Xx3:$i] : (Xph => (cwbr @ (ccfv @ (ccfv @ ccc0 @ (XA2 @ Xx3)) @ ccabs) @ XP @ cclt))) => ((Xph => (cwbr @ (ccfv @ XM @ ccfa) @ XP @ cclt)) => ((! [Xx3:$i] : (Xph => (cwbr @ (cco @ (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xx3)) @ (cco @ cceu @ (ccv @ Xj) @ cccxp) @ ccmul) @ ccabs) @ (cco @ XM @ (cco @ XM @ (cco @ XM @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))) @ (cco @ (cco @ (cco @ XM @ (cco @ XM @ cc1 @ ccaddc) @ ccexp) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccfv @ (cco @ XP @ cc1 @ ccmin) @ ccfa) @ ccdiv) @ ccmul) @ cc1 @ cclt))) => ((XF = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XL @ Xx3 @ Xj @ Xk) = (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xx3)) @ (cco @ cceu @ (ccv @ Xj) @ cccxp) @ ccmul) @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xj) @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ cceu @ (ccneg @ (ccv @ Xx3)) @ cccxp) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmul))) @ ccmul))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XK @ Xx3 @ Xj) = (cco @ (XL @ Xx3 @ Xj @ Xk) @ (ccfv @ (cco @ XP @ cc1 @ ccmin) @ ccfa) @ ccdiv))))) => (Xph => (cwrex @ (^ [Xk:$i] : (((ccv @ Xk) != ccc0) & (cwbr @ (ccfv @ (ccv @ Xk) @ ccabs) @ cc1 @ cclt))) @ (^ [Xk:$i] : ccz)))))))))))))))))))))))).
...
thf(cetransclem48_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XQ @ Xi @ Xk @ Xn) @ (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (Xph => ((ccfv @ cceu @ (XQ @ Xi @ Xk @ Xn)) = ccc0))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XA2 @ Xi) = (ccfv @ (XQ @ Xi @ Xk @ Xn) @ cccoe))))) => ((! [Xi:$i] : (Xph => ((ccfv @ ccc0 @ (XA2 @ Xi)) != ccc0))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XM @ Xi) = (ccfv @ (XQ @ Xi @ Xk @ Xn) @ ccdgr))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XC @ Xj @ Xk) = (ccsu @ (cco @ ccc0 @ (XM @ Xi) @ ccfz) @ (^ [Xj:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xi)) @ (cco @ cceu @ (ccv @ Xj) @ cccxp) @ ccmul) @ ccabs) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XS @ Xj @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (XC @ Xj @ Xk) @ (cco @ (cco @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv) @ ccmul)))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((XI @ Xj @ Xk) = (ccinf @ (ccrab @ (^ [Xi:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XS @ Xj @ Xk @ Xn)) @ ccabs) @ cc1 @ cclt)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xi) @ ccuz)))) @ (^ [Xi:$i] : ccn0)) @ ccr @ cclt)))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XT @ Xi @ Xn) = (ccsup @ (cctp @ (ccfv @ (ccfv @ ccc0 @ (XA2 @ Xi)) @ ccabs) @ (ccfv @ (XM @ Xi) @ ccfa) @ (XI @ Xj @ Xk)) @ ccxr @ cclt)))))) => (Xph => (cwrex @ (^ [Xk:$i] : (((ccv @ Xk) != ccc0) & (cwbr @ (ccfv @ (ccv @ Xk) @ ccabs) @ cc1 @ cclt))) @ (^ [Xk:$i] : ccz))))))))))))))))))))).
