...
thf(cgagrpid_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) & (cwcel @ XA2 @ XY)) => ((cco @ Xc_0 @ XA2 @ Xc_po) = XA2))))))))).
