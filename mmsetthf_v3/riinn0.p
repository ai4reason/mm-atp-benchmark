...
thf(criinn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : (((cwral @ (^ [Xx3:$i] : (cwss @ (XS @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XX)) & (XX != cc0)) => ((ccin @ XA2 @ (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XS @ Xx3)))) = (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XS @ Xx3))))))))).
