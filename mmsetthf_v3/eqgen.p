...
thf(ceqgen_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_sm = (cco @ XG @ XY @ ccqg)) => (((cwcel @ XY @ (ccfv @ XG @ ccsubg)) & (cwcel @ XA2 @ (ccqs @ XX @ Xc_sm))) => (cwbr @ XY @ XA2 @ ccen)))))))))).
