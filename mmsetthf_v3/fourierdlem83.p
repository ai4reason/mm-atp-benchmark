...
thf(acos0_thm,axiom,((ccfv @ ccc0 @ cccos) = cc1)).
...
thf(acnmbf_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf))) => (cwcel @ XF @ ccmbf))))).
...
thf(abddmulibl_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ ccmbf) & (cwcel @ XG @ ccibl) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccdm @ XF)))) @ (^ [Xx3:$i] : ccr))) => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccibl))))).
...
thf(aiblmulc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XC @ (XB2 @ Xx3) @ ccmul))) @ ccibl))))))))))).
