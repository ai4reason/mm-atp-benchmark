...
thf(csupadd_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XA2 @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (XA2 != cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XB2 @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (XB2 != cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xb:$i] : ((XC @ Xy1 @ Xz @ Xv @ Xb) = (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xb:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xv) @ (ccv @ Xb) @ ccaddc))) @ (^ [Xb:$i] : XB2))) @ (^ [Xv:$i] : XA2)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xy1) => ((cco @ (ccsup @ XA2 @ ccr @ cclt) @ (ccsup @ XB2 @ ccr @ cclt) @ ccaddc) = (ccsup @ (XC @ Xy1 @ Xz @ Xv @ Xb) @ ccr @ cclt)))))))))))))))))))).
