...
thf(cexpgrowthi_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XS @ (ccpr @ ccr @ ccc)))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XK @ ccc))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ XC @ ccc))) => ((! [Xt:$i] : ((XY @ Xt) = (ccmpt @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (cco @ XC @ (ccfv @ (cco @ XK @ (ccv @ Xt) @ ccmul) @ cce) @ ccmul))))) => (! [Xt:$i] : ((Xph @ Xt) => ((cco @ XS @ (XY @ Xt) @ ccdv) = (cco @ (ccxp @ XS @ (ccsn @ XK)) @ (XY @ Xt) @ (ccof @ ccmul))))))))))))))).
