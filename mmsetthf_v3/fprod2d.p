...
thf(aprodeq1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((XA2 = XB2) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk))))))))).
...
thf(aprod0_thm,axiom,(! [XA2:($i > ($i > $o))] : ((ccprod @ (^ [Xk:$i] : cc0) @ (^ [Xk:$i] : (XA2 @ Xk))) = cc1))).
