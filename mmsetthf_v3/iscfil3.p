...
thf(ciscfil3_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XF @ (ccfv @ XD @ cccfil)) <=> ((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XF)) @ (^ [Xx3:$i] : XX))) @ (^ [Xr:$i] : ccrp))))))))).
