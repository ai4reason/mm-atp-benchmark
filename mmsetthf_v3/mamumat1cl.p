...
thf(cmamumat1cl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (XB2 = (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XR @ Xi @ Xj) @ ccrg)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_1 @ Xi @ Xj) = (ccfv @ (XR @ Xi @ Xj) @ ccur)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_0 @ Xi @ Xj) = (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XI @ Xi @ Xj) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = (ccv @ Xj)) @ (Xc_1 @ Xi @ Xj) @ (Xc_0 @ Xi @ Xj)))))))) => ((Xph => (cwcel @ XM @ ccfn)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XI @ Xi @ Xj) @ (cco @ XB2 @ (ccxp @ XM @ XM) @ ccmap))))))))))))))))))).
