...
thf(ccnconst2_conj,conjecture,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon)) & (cwcel @ XB2 @ XY)) => (cwcel @ (ccxp @ XX @ (ccsn @ XB2)) @ (cco @ XJ @ XK @ cccn))))))))).
