...
thf(ccaragencmpl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XE @ XX)) => ((Xph => ((ccfv @ XE @ XO) = ccc0)) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => (cwcel @ XE @ XS))))))))))))).
