...
thf(cflimcfil_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim))) => (cwcel @ XF @ (ccfv @ XD @ cccfil)))))))))).
