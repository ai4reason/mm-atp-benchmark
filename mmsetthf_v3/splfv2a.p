...
thf(csplfv2a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccword @ XA2))) => ((Xph => (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((Xph => (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((Xph => (cwcel @ XR @ (ccword @ XA2))) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ (ccfv @ XR @ cchash) @ ccfzo))) => (Xph => ((ccfv @ (cco @ XF @ XX @ ccaddc) @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice)) = (ccfv @ XX @ XR)))))))))))))))).
