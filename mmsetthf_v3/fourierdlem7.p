...
thf(cfourierdlem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ XB2 @ ccr)) => ((! [Xx3:$i] : (Xph => (cwbr @ (XA2 @ Xx3) @ XB2 @ cclt))) => ((! [Xx3:$i] : (XT = (cco @ XB2 @ (XA2 @ Xx3) @ ccmin))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ XT @ ccdiv) @ ccfl) @ XT @ ccmul) @ ccaddc))))) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XY @ ccr)) => ((Xph => (cwbr @ XX @ XY @ ccle)) => (! [Xx3:$i] : (Xph => (cwbr @ (cco @ (ccfv @ XY @ (XE @ Xx3)) @ XY @ ccmin) @ (cco @ (ccfv @ XX @ (XE @ Xx3)) @ XX @ ccmin) @ ccle))))))))))))))))))).
