...
thf(cpwdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccmin) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (ccsu @ (cco @ ccc0 @ XN @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (cco @ XB2 @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccmin) @ ccexp) @ ccmul))) @ ccmul))))))).
