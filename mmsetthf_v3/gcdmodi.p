...
thf(cgcdmodi_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ ccn0) => ((cwcel @ XR @ ccn0) => ((cwcel @ XN @ ccn) => (((cco @ XK @ XN @ ccmo) = (cco @ XR @ XN @ ccmo)) => (((cco @ XN @ XR @ ccgcd) = XG) => ((cco @ XK @ XN @ ccgcd) = XG))))))))))).
