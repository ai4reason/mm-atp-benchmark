...
thf(cismred_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XC @ (ccpw @ XX))) => ((Xph => (cwcel @ XX @ XC)) => ((! [Xs1:$i] : ((Xph & (cwss @ (ccv @ Xs1) @ XC) & ((ccv @ Xs1) != cc0)) => (cwcel @ (ccint @ (ccv @ Xs1)) @ XC))) => (Xph => (cwcel @ XC @ (ccfv @ XX @ ccmre)))))))))).
