...
thf(aasinlem2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccaddc) @ (cco @ (cco @ cci @ (ccneg @ XA2) @ ccmul) @ (ccfv @ (cco @ cc1 @ (cco @ (ccneg @ XA2) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccaddc) @ ccmul) = cc1)))).
