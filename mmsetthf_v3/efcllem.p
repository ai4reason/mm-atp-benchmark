...
thf(aeftabs_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccn0)) => ((ccfv @ (cco @ (cco @ XA2 @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv) @ ccabs) = (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
thf(cefcllem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccseq @ ccaddc @ (XF @ Xn) @ ccc0) @ (ccdm @ ccli)))))))).
