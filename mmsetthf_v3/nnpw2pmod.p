...
thf(cnnpw2pmod_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (XN = (cco @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ (cco @ XN @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ ccmo) @ ccaddc))))).
