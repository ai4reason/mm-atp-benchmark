...
thf(c_2lgslem2_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => (cwcel @ XN @ ccz)))))).
