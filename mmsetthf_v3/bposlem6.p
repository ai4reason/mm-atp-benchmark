...
thf(abclbnd_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc4 @ ccuz)) => (cwbr @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ cclt)))).
...
thf(aefchtdvds_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ cccht) @ cce) @ (ccfv @ (ccfv @ XB2 @ cccht) @ cce) @ ccdvds))))).
thf(ccicc_tp,type,(ccicc : ($i > $o))).
thf(aefchtcl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ (ccfv @ XA2 @ cccht) @ cce) @ ccn)))).
...
thf(abposlem1_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XP @ ccprime)) => (cwbr @ (cco @ XP @ (cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))))).
...
thf(aprmorcht_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccv @ Xn) @ cc1))))) => (! [Xn:$i] : ((cwcel @ (XA2 @ Xn) @ ccn) => ((ccfv @ (ccfv @ (XA2 @ Xn) @ cccht) @ cce) = (ccfv @ (XA2 @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))).
...
thf(acht3_thm,axiom,((ccfv @ cc3 @ cccht) = (ccfv @ cc6 @ cclog))).
