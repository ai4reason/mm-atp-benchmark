...
thf(arecosf1o_thm,axiom,(cwf1o @ (cco @ ccc0 @ ccpi @ ccicc) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc) @ (ccres @ cccos @ (cco @ ccc0 @ ccpi @ ccicc)))).
...
thf(cresinf1o_conj,conjecture,(cwf1o @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc) @ (ccres @ ccsin @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)))).
