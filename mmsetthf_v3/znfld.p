...
thf(aisnzr2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccnzr) <=> ((cwcel @ XR @ ccrg) & (cwbr @ cc2o @ XB2 @ ccdom))))))).
...
thf(cznfld_conj,conjecture,(! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((cwcel @ XN @ ccprime) => (cwcel @ XY @ ccfield)))))).
