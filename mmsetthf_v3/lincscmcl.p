...
thf(clincscmcl_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((Xc_x = (ccfv @ XM @ ccvsca)) => ((XR = (ccfv @ (ccfv @ XM @ ccsca) @ ccbs)) => ((((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) & (cwcel @ XC @ XR) & (cwcel @ XD @ (cco @ XM @ XV @ cclinco))) => (cwcel @ (cco @ XC @ XD @ Xc_x) @ (cco @ XM @ XV @ cclinco)))))))))))).
