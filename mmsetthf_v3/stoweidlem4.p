...
thf(cstoweidlem4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (ccv @ Xx3))) @ (XA2 @ Xt))))) => (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : XB2)) @ (XA2 @ Xt)))))))))).
