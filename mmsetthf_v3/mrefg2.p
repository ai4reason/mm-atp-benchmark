...
thf(cmrefg2_conj,conjecture,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) => ((cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn))) <=> (cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
