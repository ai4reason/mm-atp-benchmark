...
thf(ccolperp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwbr @ (cco @ XA2 @ XB2 @ XL) @ XD @ (ccfv @ XG @ ccperpg))) => ((Xph => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ XL)) | (XA2 = XB2))) => ((Xph => (XA2 != XC)) => (Xph => (cwbr @ (cco @ XA2 @ XC @ XL) @ XD @ (ccfv @ XG @ ccperpg))))))))))))))))))))))))).
