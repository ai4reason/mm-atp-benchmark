...
thf(adprd2db_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((Xph => (cwrel @ XA2)) => ((Xph => (cwf @ XA2 @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xj:$i] : (Xph => (cwss @ (ccdm @ XA2) @ (XI @ Xj)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (XI @ Xj))) => (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ (ccdm @ ccdprd))))) => ((! [Xj:$i] : (Xph => (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ (ccdm @ ccdprd)))) => ((! [Xj:$i] : ((XK @ Xj) = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc))) => (! [Xj:$i] : (Xph => ((cco @ XG @ XS @ ccdprd) = (cco @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ ccdprd))))))))))))))))).
