...
thf(ahlhilsca_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ ccedring))) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cchg))) => ((XR = (cco @ XE @ (ccop @ (ccfv @ ccnx @ ccstv) @ XG) @ ccsts)) => (Xph => (XR = (ccfv @ XU @ ccsca)))))))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(chlhilslem_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XE = (ccfv @ XW @ (ccfv @ XK @ ccedring))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((XR = (ccfv @ XU @ ccsca)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((XF = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwbr @ XN @ cc4 @ cclt) => ((XC = (ccfv @ XE @ XF)) => (Xph => (XC = (ccfv @ XR @ XF))))))))))))))))))))))).
