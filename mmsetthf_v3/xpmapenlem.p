...
thf(cxpmapenlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : ((XD @ Xx3) = (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ cc1st))))) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (ccfv @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ cc2nd))))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (ccop @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xy1) @ cc1st)) @ (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))) => (cwbr @ (cco @ (ccxp @ XA2 @ XB2) @ XC @ ccmap) @ (ccxp @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap)) @ ccen)))))))))))))).
