...
thf(clincellss_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ cclmod) & (cwcel @ XS @ (ccfv @ XM @ cclss)) & (cwss @ XV @ XS)) => (((cwcel @ XF @ (cco @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs) @ XV @ ccmap)) & (cwbr @ XF @ (ccfv @ (ccfv @ XM @ ccsca) @ cc0g) @ ccfsupp)) => (cwcel @ (cco @ XF @ XV @ (ccfv @ XM @ cclinc)) @ XS)))))))).
