...
thf(adcomex_thm,axiom,(cwcel @ ccom @ ccvv)).
...
thf(caxdc3lem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XS @ Xk @ Xn @ Xs1) = (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : ((cwf @ (ccsuc @ (ccv @ Xn)) @ (XA2 @ Xk) @ (ccv @ Xs1)) & ((ccfv @ cc0 @ (ccv @ Xs1)) = (XC @ Xk @ Xn @ Xs1)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)) @ (XF @ Xk @ Xn @ Xs1)))) @ (^ [Xk:$i] : (ccv @ Xn))))) @ (^ [Xn:$i] : ccom))))))) => (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (cwcel @ (XS @ Xk @ Xn @ Xs1) @ ccvv))))))))))).
