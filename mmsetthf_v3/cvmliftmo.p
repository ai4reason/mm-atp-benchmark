...
thf(acvmliftmoi_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccuni @ XC)) => ((XY = (ccuni @ XK)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XJ @ cccvm))) => ((Xph => (cwcel @ XK @ ccconn)) => ((Xph => (cwcel @ XK @ (ccnlly @ ccconn))) => ((Xph => (cwcel @ XO @ XY)) => ((Xph => (cwcel @ XM @ (cco @ XK @ XC @ cccn))) => ((Xph => (cwcel @ XN @ (cco @ XK @ XC @ cccn))) => ((Xph => ((cccom @ XF @ XM) = (cccom @ XF @ XN))) => ((Xph => ((ccfv @ XO @ XM) = (ccfv @ XO @ XN))) => (Xph => (XM = XN))))))))))))))))))))))).
...
thf(ccvmliftmo_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccuni @ XC))) => ((! [Xf1:$i] : ((XY @ Xf1) = (ccuni @ XK))) => ((! [Xf1:$i] : (Xph => (cwcel @ XF @ (cco @ XC @ (XJ @ Xf1) @ cccvm)))) => ((Xph => (cwcel @ XK @ ccconn)) => ((Xph => (cwcel @ XK @ (ccnlly @ ccconn))) => ((! [Xf1:$i] : (Xph => (cwcel @ XO @ (XY @ Xf1)))) => ((! [Xf1:$i] : (Xph => (cwcel @ XG @ (cco @ XK @ (XJ @ Xf1) @ cccn)))) => ((! [Xf1:$i] : (Xph => (cwcel @ XP @ (XB2 @ Xf1)))) => ((Xph => ((ccfv @ XP @ XF) = (ccfv @ XO @ XG))) => (Xph => (cwrmo @ (^ [Xf1:$i] : (((cccom @ XF @ (ccv @ Xf1)) = XG) & ((ccfv @ XO @ (ccv @ Xf1)) = XP))) @ (^ [Xf1:$i] : (cco @ XK @ XC @ cccn)))))))))))))))))))))))).
