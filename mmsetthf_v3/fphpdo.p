...
thf(cfphpdo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwbr @ (XB2 @ Xx3 @ Xy1) @ XA2 @ ccsdm)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XA2)) => (cwcel @ (XC @ Xz) @ (XB2 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccv @ Xx3)) => ((XC @ Xz) = (XD @ Xx3))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccv @ Xy1)) => ((XC @ Xz) = (XE @ Xy1))))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) & ((XD @ Xx3) = (XE @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))))))))))))).
