...
thf(amdegxrf_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : ((XD = (cco @ XI @ XR @ ccmdg)) => ((XP = (cco @ XI @ XR @ ccmpl)) => ((XB2 = (ccfv @ XP @ ccbs)) => (cwf @ XB2 @ ccxr @ XD)))))))))).
...
thf(cdeg1xrf_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => (cwf @ XB2 @ ccxr @ XD))))))))).
