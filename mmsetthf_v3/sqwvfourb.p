...
thf(acosknegpi_thm,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ (ccneg @ ccpi) @ ccmul) @ cccos) = (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
...
thf(acoskpi2_thm,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ ccpi @ ccmul) @ cccos) = (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
