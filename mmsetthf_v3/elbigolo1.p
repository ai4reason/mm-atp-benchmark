...
thf(asuppdm_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((((cwfun @ XF) & (cwcel @ XF @ XV) & (cwcel @ XZ @ XW)) & (cwnel @ XZ @ (ccrn @ XF))) => ((cco @ XF @ XZ @ ccsupp) = (ccdm @ XF)))))))).
thf(afdm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => ((ccdm @ XF) = XA2)))))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(arefdivmptfv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwf @ XA2 @ ccr @ XF) & (cwf @ XA2 @ ccr @ XG) & (cwcel @ XA2 @ XV)) & (cwcel @ XX @ (cco @ XG @ ccc0 @ ccsupp))) => ((ccfv @ XX @ (cco @ XF @ XG @ ccfdiv)) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XX @ XG) @ ccdiv))))))))).
...
thf(celbigolo1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwf @ XA2 @ ccrp @ XG) & (cwf @ XA2 @ ccrp @ XF)) => ((cwcel @ XF @ (ccfv @ XG @ ccbigo)) <=> (cwcel @ (cco @ XF @ XG @ ccfdiv) @ cclo1))))))).
