...
thf(afoco_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfo @ XB2 @ XC @ XF) & (cwfo @ XA2 @ XB2 @ XG)) => (cwfo @ XA2 @ XC @ (cccom @ XF @ XG))))))))).
thf(afoeq123d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cwfo @ XA2 @ XC @ XF) <=> (cwfo @ XB2 @ XD @ XG)))))))))))))).
...
thf(aisfull2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XJ = (ccfv @ XD @ cchom)) => ((XH = (ccfv @ XC @ cchom)) => ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccful)) <=> ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfunc)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwfo @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XJ) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))))).
thf(adf_br_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwbr @ XA2 @ XB2 @ XR) <=> (cwcel @ (ccop @ XA2 @ XB2) @ XR)))))).
thf(ccofull_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccful))) => ((Xph => (cwcel @ XG @ (cco @ XD @ XE @ ccful))) => (Xph => (cwcel @ (cco @ XG @ XF @ cccofu) @ (cco @ XC @ XE @ ccful)))))))))))).
