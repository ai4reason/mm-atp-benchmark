...
thf(ampt2curryd_thm,axiom,(! [Xph:$o] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ XV)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))) => ((Xph => (XY != cc0)) => (Xph => ((cccur @ XF) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))))))))))))).
...
thf(cmpt2curryvald_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ XV)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))) => ((Xph => (XY != cc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XY @ (XW @ Xx3 @ Xy1))))) => ((Xph => (cwcel @ XA2 @ XX)) => (Xph => ((ccfv @ XA2 @ (cccur @ XF)) = (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccsb @ XA2 @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1))))))))))))))))))))).
