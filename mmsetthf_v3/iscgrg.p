...
thf(adf_cgrg_ax,axiom,(cccgrg = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (((cwcel @ (ccv @ Xa) @ (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ ccr @ ccpm)) & (cwcel @ (ccv @ Xb) @ (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ ccr @ ccpm))) & (((ccdm @ (ccv @ Xa)) = (ccdm @ (ccv @ Xb))) & (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xg1) @ ccds)) = (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (ccfv @ (ccv @ Xj) @ (ccv @ Xb)) @ (ccfv @ (ccv @ Xg1) @ ccds)))) @ (^ [Xj:$i] : (ccdm @ (ccv @ Xa))))) @ (^ [Xi:$i] : (ccdm @ (ccv @ Xa))))))))))))).
