...
thf(ccncfuni_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ (ccuni @ XB2))) => ((! [Xb:$i] : ((Xph & (cwcel @ (ccv @ Xb) @ XB2)) => (cwcel @ (ccin @ XA2 @ (ccv @ Xb)) @ (cco @ (ccfv @ cccnfld @ cctopn) @ XA2 @ ccrest)))) => ((! [Xb:$i] : ((Xph & (cwcel @ (ccv @ Xb) @ XB2)) => (cwcel @ (ccres @ XF @ (ccv @ Xb)) @ (cco @ (ccin @ XA2 @ (ccv @ Xb)) @ ccc @ cccncf)))) => (Xph => (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf))))))))))))).
