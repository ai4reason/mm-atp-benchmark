...
thf(abpoly1_thm,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc1 @ XX @ ccbp) = (cco @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin))))).
...
thf(abpoly2_thm,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc2 @ XX @ ccbp) = (cco @ (cco @ (cco @ XX @ cc2 @ ccexp) @ XX @ ccmin) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccaddc))))).
thf(a_3nn0_thm,axiom,(cwcel @ cc3 @ ccn0)).
thf(a_2ne0_thm,axiom,(cc2 != ccc0)).
thf(a_4d2e2_thm,axiom,((cco @ cc4 @ cc2 @ ccdiv) = cc2)).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(abpoly3_thm,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc3 @ XX @ ccbp) = (cco @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ cc3 @ cc2 @ ccdiv) @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ ccmin) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ XX @ ccmul) @ ccaddc))))).
...
thf(cbpoly4_conj,conjecture,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc4 @ XX @ ccbp) = (cco @ (cco @ (cco @ (cco @ XX @ cc4 @ ccexp) @ (cco @ cc2 @ (cco @ XX @ cc3 @ ccexp) @ ccmul) @ ccmin) @ (cco @ XX @ cc2 @ ccexp) @ ccaddc) @ (cco @ cc1 @ (ccdc @ cc3 @ ccc0) @ ccdiv) @ ccmin))))).
