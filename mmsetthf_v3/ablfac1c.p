...
thf(alagsubg_thm,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XY @ (ccfv @ XG @ ccsubg)) & (cwcel @ XX @ ccfn)) => (cwbr @ (ccfv @ XY @ cchash) @ (ccfv @ XX @ cchash) @ ccdvds))))))).
...
thf(aablfac1a_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xp) = (ccmpt @ (^ [Xp:$i] : XA2) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2))))))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwss @ XA2 @ ccprime)) => (! [Xx3:$i] : (! [Xp:$i] : ((Xph & (cwcel @ XP @ XA2)) => ((ccfv @ (ccfv @ XP @ (XS @ Xx3 @ Xp)) @ cchash) = (cco @ XP @ (cco @ XP @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp))))))))))))))))))).
...
thf(apceq0_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn)) => (((cco @ XP @ XN @ ccpc) = ccc0) <=> (~ (cwbr @ XP @ XN @ ccdvds))))))).
...
thf(cablfac1c_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : ((! [Xw:$i] : (XB2 = (ccfv @ (XG @ Xw) @ ccbs))) => ((! [Xw:$i] : ((XO @ Xw) = (ccfv @ (XG @ Xw) @ ccod))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xw @ Xp) = (ccmpt @ (^ [Xp:$i] : (XA2 @ Xw)) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xw)) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2)))))))) => ((! [Xw:$i] : (Xph => (cwcel @ (XG @ Xw) @ ccabl))) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xw:$i] : (Xph => (cwss @ (XA2 @ Xw) @ ccprime))) => ((! [Xw:$i] : ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccfv @ XB2 @ cchash) @ ccdvds)) @ (^ [Xw:$i] : ccprime)))) => ((! [Xw:$i] : (Xph => (cwss @ (XD @ Xw) @ (XA2 @ Xw)))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : (Xph => ((cco @ (XG @ Xw) @ (XS @ Xx3 @ Xw @ Xp) @ ccdprd) = XB2))))))))))))))))))))).
