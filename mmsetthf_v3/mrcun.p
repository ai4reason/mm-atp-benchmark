...
thf(cmrcun_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XX) & (cwss @ XV @ XX)) => ((ccfv @ (ccun @ XU @ XV) @ XF) = (ccfv @ (ccun @ (ccfv @ XU @ XF) @ (ccfv @ XV @ XF)) @ XF)))))))))).
