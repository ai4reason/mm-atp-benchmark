...
thf(aasinval_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccasin) = (cco @ (ccneg @ cci) @ (ccfv @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccaddc) @ cclog) @ ccmul))))).
...
thf(aasinsinlem_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccre) @ cclt)))).
...
thf(aiooneg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) <=> (cwcel @ (ccneg @ XC) @ (cco @ (ccneg @ XB2) @ (ccneg @ XA2) @ ccioo)))))))).
...
thf(casinsin_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => ((ccfv @ (ccfv @ XA2 @ ccsin) @ ccasin) = XA2)))).
