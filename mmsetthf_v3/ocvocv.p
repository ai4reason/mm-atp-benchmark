...
thf(cocvocv_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => (((cwcel @ XW @ ccphl) & (cwss @ XS @ XV)) => (cwss @ XS @ (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe)))))))))).
