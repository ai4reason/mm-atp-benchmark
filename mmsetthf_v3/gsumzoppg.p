...
thf(acntzspan_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XG @ cccntz)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubmnd) @ ccmrc)) => ((XH = (cco @ XG @ (ccfv @ XS @ XK) @ ccress)) => (((cwcel @ XG @ ccmnd) & (cwss @ XS @ (ccfv @ XS @ XZ))) => (cwcel @ XH @ cccmn))))))))))).
