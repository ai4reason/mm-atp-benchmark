...
thf(cumgredg_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xa:$i] : (! [Xb:$i] : ((XE @ Xa @ Xb) = (ccfv @ XG @ ccedg)))) => (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XG @ ccumgr) & (cwcel @ XC @ (XE @ Xa @ Xb))) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (((ccv @ Xa) != (ccv @ Xb)) & (XC = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))))))))).
