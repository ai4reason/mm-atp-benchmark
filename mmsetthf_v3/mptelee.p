...
thf(aclel2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ XB2) <=> (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (cwcel @ (ccv @ Xx3) @ XB2)))))))).
...
thf(cmptelee_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ (ccmpt @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ (XF @ Xk)))) @ (ccfv @ XN @ ccee)) <=> (cwral @ (^ [Xk:$i] : (cwcel @ (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ (XF @ Xk)) @ ccr)) @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)))))))))).
