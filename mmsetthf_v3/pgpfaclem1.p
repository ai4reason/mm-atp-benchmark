...
thf(asubsubg_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) => ((cwcel @ XA2 @ (ccfv @ XH @ ccsubg)) <=> ((cwcel @ XA2 @ (ccfv @ XG @ ccsubg)) & (cwss @ XA2 @ XS)))))))))).
...
thf(acycsubgcyg2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XB2)) => (cwcel @ (cco @ XG @ (ccfv @ (ccsn @ XA2) @ XK) @ ccress) @ cccyg))))))))).
...
thf(admdprdsplit2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XI = (ccun @ XC @ XD))) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwbr @ XG @ (ccres @ XS @ XC) @ (ccdm @ ccdprd))) => ((Xph => (cwbr @ XG @ (ccres @ XS @ XD) @ (ccdm @ ccdprd))) => ((Xph => (cwss @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (ccfv @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd) @ XZ))) => ((Xph => ((ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) = (ccsn @ Xc_0))) => (Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))))))))))))))))))))).
...
thf(acats1un_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XX)) & (cwcel @ XB2 @ XX)) => ((cco @ XA2 @ (ccs1 @ XB2) @ ccconcat) = (ccun @ XA2 @ (ccsn @ (ccop @ (ccfv @ XA2 @ cchash) @ XB2))))))))).
