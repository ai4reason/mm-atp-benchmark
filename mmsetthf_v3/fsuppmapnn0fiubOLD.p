...
thf(afsuppmapnn0fiublem_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XU = (cciun @ (^ [Xf1:$i] : XM) @ (^ [Xf1:$i] : (cco @ (ccv @ Xf1) @ XZ @ ccsupp)))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccsup @ XU @ ccr @ cclt))) => (! [Xf1:$i] : (((cwss @ XM @ (cco @ XR @ ccn0 @ ccmap)) & (cwcel @ XM @ ccfn) & (cwcel @ XZ @ XV)) => (((cwral @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XZ @ ccfsupp)) @ (^ [Xf1:$i] : XM)) & (XU != cc0)) => (cwcel @ (XS @ Xf1) @ ccn0))))))))))))).
...
thf(cfsuppmapnn0fiubOLD_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XU = (cciun @ (^ [Xf1:$i] : XM) @ (^ [Xf1:$i] : (cco @ (ccv @ Xf1) @ XZ @ ccsupp)))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccsup @ XU @ ccr @ cclt))) => (((cwss @ XM @ (cco @ XR @ ccn0 @ ccmap)) & (cwcel @ XM @ ccfn) & (cwcel @ XZ @ XV)) => (((cwral @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XZ @ ccfsupp)) @ (^ [Xf1:$i] : XM)) & (XU != cc0)) => (cwral @ (^ [Xf1:$i] : (cwss @ (cco @ (ccv @ Xf1) @ XZ @ ccsupp) @ (cco @ ccc0 @ (XS @ Xf1) @ ccfz))) @ (^ [Xf1:$i] : XM))))))))))))).
