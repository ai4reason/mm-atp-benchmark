...
thf(ainitoid_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph & (cwcel @ XO @ (ccfv @ XC @ ccinito))) => ((cco @ XO @ XO @ XH) = (ccsn @ (ccfv @ XO @ (ccfv @ XC @ cccid)))))))))))))).
...
thf(c_2initoinv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XC @ ccinito))) => ((Xph & (cwcel @ XG @ (cco @ XB2 @ XA2 @ (ccfv @ XC @ cchom))) & (cwcel @ XF @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cchom)))) => (cwbr @ XF @ XG @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ ccinv)))))))))))))).
