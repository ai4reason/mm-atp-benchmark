...
thf(cmapsnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xf1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xy1 @ Xf1))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xy1 @ Xf1))))) => (Xph => ((cco @ XA2 @ (ccsn @ XB2) @ ccmap) = (^ [Xf1:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xf1) = (ccsn @ (ccop @ XB2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XA2))))))))))))).
