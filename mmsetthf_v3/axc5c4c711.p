...
thf(aaxc4_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : ((! [Xx3:$i] : (Xph @ Xx3)) => (Xps @ Xx3))) => ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (Xps @ Xx3))))))).
...
thf(caxc5c4c711_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (((! [Xx3:$i] : (! [Xy1:$i] : (~ (! [Xx3:$i] : (! [Xy1:$i] : ((! [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (Xps @ Xx3 @ Xy1))))))) => ((Xph @ Xx3 @ Xy1) => (! [Xy1:$i] : ((! [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (Xps @ Xx3 @ Xy1))))) => ((! [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (! [Xy1:$i] : (Xps @ Xx3 @ Xy1))))))))).
