...
thf(adf_hlg_ax,axiom,(cchlg = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xc:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)) @ (^ [Xc:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (((cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xg1) @ ccbs)) & (cwcel @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ ccbs))) & (((ccv @ Xa) != (ccv @ Xc)) & ((ccv @ Xb) != (ccv @ Xc)) & ((cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xc) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ ccitv))) | (cwcel @ (ccv @ Xb) @ (cco @ (ccv @ Xc) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xg1) @ ccitv))))))))))))))).
...
thf(cishlg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XG @ XV)) => (Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XC @ XK)) <=> ((XA2 != XC) & (XB2 != XC) & ((cwcel @ XA2 @ (cco @ XC @ XB2 @ XI)) | (cwcel @ XB2 @ (cco @ XC @ XA2 @ XI))))))))))))))))))))))).
