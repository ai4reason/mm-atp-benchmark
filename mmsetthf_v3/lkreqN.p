...
thf(alduallvec_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XW:($i > $o)] : ((XD = (ccfv @ XW @ ccld)) => ((Xph => (cwcel @ XW @ cclvec)) => (Xph => (cwcel @ XD @ cclvec)))))))).
...
thf(aldual0_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XR = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XD = (ccfv @ XW @ ccld)) => ((XS = (ccfv @ XD @ ccsca)) => ((XO = (ccfv @ XS @ cc0g)) => ((Xph => (cwcel @ XW @ cclmod)) => (Xph => (XO = Xc_0)))))))))))))))).
...
thf(alkrpssN_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((XD = (ccfv @ XW @ ccld)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XH @ XF)) => (Xph => ((cwpss @ (ccfv @ XG @ XK) @ (ccfv @ XH @ XK)) <=> ((XG != Xc_0) & (XH = Xc_0)))))))))))))))))))).
...
thf(clkreqN_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XS = (ccfv @ XW @ ccsca)) => ((XR = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((XD = (ccfv @ XW @ ccld)) => ((Xc_x = (ccfv @ XD @ ccvsca)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XA2 @ (ccdif @ XR @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XH @ XF)) => ((Xph => (XG = (cco @ XA2 @ XH @ Xc_x))) => (Xph => ((ccfv @ XG @ XK) = (ccfv @ XH @ XK))))))))))))))))))))))))))).
