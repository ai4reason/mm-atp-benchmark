...
thf(adirkerdenne0_thm,axiom,(! [XS:($i > $o)] : (((cwcel @ XS @ ccr) & (~ ((cco @ XS @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0))) => ((cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ XS @ cc2 @ ccdiv) @ ccsin) @ ccmul) != ccc0)))).
...
thf(adirkerval2_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (! [Xs1:$i] : ((XD @ Xn @ Xs1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ ((cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => (! [Xn:$i] : (! [Xs1:$i] : (((cwcel @ (XN @ Xn) @ ccn) & (cwcel @ (XS @ Xn @ Xs1) @ ccr)) => ((ccfv @ (XS @ Xn @ Xs1) @ (ccfv @ (XN @ Xn) @ (XD @ Xn @ Xs1))) = (ccif @ ((cco @ (XS @ Xn @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (XN @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (XS @ Xn @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (XS @ Xn @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))))).
thf(cdirkerper_conj,conjecture,(! [Xx3:$i] : (! [XD:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xn:$i] : ((XD @ Xy1 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ ((cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => ((! [Xy1:$i] : (! [Xn:$i] : ((XT @ Xy1 @ Xn) = (cco @ cc2 @ ccpi @ ccmul)))) => (! [Xy1:$i] : (! [Xn:$i] : (((cwcel @ (XN @ Xn) @ ccn) & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (XT @ Xy1 @ Xn) @ ccaddc) @ (ccfv @ (XN @ Xn) @ (XD @ Xy1 @ Xn))) = (ccfv @ (ccv @ Xx3) @ (ccfv @ (XN @ Xn) @ (XD @ Xy1 @ Xn)))))))))))))).
