...
thf(afprodeq0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XN)) => ((XA2 @ Xk) = ccc0))) => ((Xph & (cwcel @ XK @ (ccfv @ XN @ ccuz))) => ((ccprod @ (^ [Xk:$i] : (cco @ XM @ XK @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) = ccc0))))))))))))).
