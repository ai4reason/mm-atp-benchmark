...
thf(aerdsze_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwf1 @ (cco @ cc1 @ XN @ ccfz) @ ccr @ XF)) => ((Xph => (cwcel @ XR @ ccn)) => ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwbr @ (cco @ (cco @ XR @ cc1 @ ccmin) @ (cco @ XS @ cc1 @ ccmin) @ ccmul) @ XN @ cclt)) => (Xph => (cwrex @ (^ [Xs1:$i] : (((cwbr @ XR @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xs1)))) | ((cwbr @ XS @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ (cco @ cc1 @ XN @ ccfz)))))))))))))))).
