...
thf(atpostpos2_thm,axiom,(! [XF:($i > $o)] : (((cwrel @ XF) & (cwrel @ (ccdm @ XF))) => ((cctpos @ (cctpos @ XF)) = XF)))).
thf(ccmpt2_tp,type,(ccmpt2 : (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > ($i > $o)))))).
thf(aoppchomf_thm,axiom,(! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XH = (ccfv @ XC @ cchomf)) => ((cctpos @ XH) = (ccfv @ XO @ cchomf)))))))).
thf(c_2oppchomf_conj,conjecture,(! [XC:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((ccfv @ XC @ cchomf) = (ccfv @ (ccfv @ XO @ ccoppc) @ cchomf)))))).
