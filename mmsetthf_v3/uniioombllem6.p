...
thf(cuniioombllem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((XA2 = (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (ccfv @ (XE @ Xx3) @ ccovol) @ ccr))) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (Xph => (cwss @ (XE @ Xx3) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG)))))) => ((XT = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (Xph => (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3) @ ccovol) @ XC @ ccaddc) @ ccle))) => (! [Xx3:$i] : (Xph => (cwbr @ (cco @ (ccfv @ (ccin @ (XE @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (XE @ Xx3) @ XA2) @ ccovol) @ ccaddc) @ (cco @ (ccfv @ (XE @ Xx3) @ ccovol) @ (cco @ cc4 @ XC @ ccmul) @ ccaddc) @ ccle)))))))))))))))))))))).
