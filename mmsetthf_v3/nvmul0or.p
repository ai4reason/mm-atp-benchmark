...
thf(cnvmul0or_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XZ = (ccfv @ XU @ ccn0v)) => (((cwcel @ XU @ ccnv) & (cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ XX)) => (((cco @ XA2 @ XB2 @ XS) = XZ) <=> ((XA2 = ccc0) | (XB2 = XZ)))))))))))))).
