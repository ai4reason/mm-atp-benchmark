...
thf(aprmgaplem5_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XN @ cclt) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ XN @ ccfzo))))) @ (^ [Xp:$i] : ccprime))))).
...
thf(aprmgaplem6_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ XN @ cc1 @ ccaddc) @ (ccv @ Xp) @ ccfzo))))) @ (^ [Xp:$i] : ccprime))))).
...
thf(ancoprmlnprm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwbr @ XA2 @ XB2 @ cclt)) => ((cwbr @ cc1 @ (cco @ XA2 @ XB2 @ ccgcd) @ cclt) => (cwnel @ XB2 @ ccprime)))))).
thf(cprmgaplem7_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XN @ ccn))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XF @ (cco @ ccn @ ccn @ ccmap)))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwral @ (^ [Xi:$i] : (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ XF) @ (ccv @ Xi) @ ccaddc) @ (ccv @ Xi) @ ccgcd) @ cclt)) @ (^ [Xi:$i] : (cco @ cc2 @ XN @ ccfz))))) => (! [Xi:$i] : ((Xph @ Xi) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((cwbr @ (ccv @ Xp) @ (cco @ (ccfv @ XN @ XF) @ cc2 @ ccaddc) @ cclt) & (cwbr @ (cco @ (ccfv @ XN @ XF) @ XN @ ccaddc) @ (ccv @ Xq) @ cclt) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))))))))))).
