...
thf(ceigorthi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ ccc) => ((cwcel @ XD @ ccc) => (((((ccfv @ XA2 @ XT) = (cco @ XC @ XA2 @ ccsm)) & ((ccfv @ XB2 @ XT) = (cco @ XD @ XB2 @ ccsm))) & (XC != (ccfv @ XD @ cccj))) => (((cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccsp) = (cco @ (ccfv @ XA2 @ XT) @ XB2 @ ccsp)) <=> ((cco @ XA2 @ XB2 @ ccsp) = ccc0))))))))))))).
