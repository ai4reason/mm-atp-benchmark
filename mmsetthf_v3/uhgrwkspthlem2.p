...
thf(cuhgrwkspthlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & (((ccfv @ XF @ cchash) = cc1) & (XA2 != XB2)) & (((ccfv @ ccc0 @ XP) = XA2) & ((ccfv @ (ccfv @ XF @ cchash) @ XP) = XB2))) => (cwfun @ (cccnv @ XP))))))))).
