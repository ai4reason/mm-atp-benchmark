...
thf(cmdsymlem8_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : ((XC @ Xp) = (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (((XA2 != cc0h) & (XB2 != cc0h)) => ((cwbr @ XB2 @ XA2 @ ccdmd) <=> (cwbr @ XA2 @ XB2 @ ccdmd)))))))))).
