...
thf(cfrgrwopreglem5ALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (! [Xb:$i] : ((XV @ Xa @ Xb) = (ccfv @ XG @ ccvtx)))) => ((! [Xa:$i] : (! [Xb:$i] : ((XD @ Xa @ Xb) = (ccfv @ XG @ ccvtxdg)))) => ((! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (XA2 = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XD @ Xa @ Xb)) = (XK @ Xy1 @ Xa @ Xb))) @ (^ [Xx3:$i] : (XV @ Xa @ Xb))))))) => ((! [Xa:$i] : (! [Xb:$i] : (XB2 = (ccdif @ (XV @ Xa @ Xb) @ XA2)))) => ((! [Xy1:$i] : ((XE @ Xy1) = (ccfv @ XG @ ccedg))) => (((cwcel @ XG @ ccfrgr) & (cwbr @ cc1 @ (ccfv @ XA2 @ cchash) @ cclt) & (cwbr @ cc1 @ (ccfv @ XB2 @ cchash) @ cclt)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xy1:$i] : ((((ccv @ Xa) != (ccv @ Xx3)) & ((ccv @ Xb) != (ccv @ Xy1))) & ((cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ (XE @ Xy1)) & (cwcel @ (ccpr @ (ccv @ Xb) @ (ccv @ Xx3)) @ (XE @ Xy1))) & ((cwcel @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XE @ Xy1)) & (cwcel @ (ccpr @ (ccv @ Xy1) @ (ccv @ Xa)) @ (XE @ Xy1))))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xb:$i] : XB2))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xa:$i] : XA2)))))))))))))))).
