...
thf(cprtlem17_conj,conjecture,(! [Xw:$i] : (! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xz:$i] : ((cwprt @ (XA2 @ Xz)) => (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xz)) & (cwcel @ (ccv @ Xz) @ (ccv @ Xx3))) => ((cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xy1)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (XA2 @ Xz))) => (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)))))))))).
