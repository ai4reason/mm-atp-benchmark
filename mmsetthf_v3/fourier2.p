...
thf(afourierdlem106_thm,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((XT = (cco @ cc2 @ ccpi @ ccmul)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) = (ccfv @ (ccv @ Xx3) @ XF)))) => ((XG = (ccres @ (cco @ ccr @ XF @ ccdv) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))) => ((Xph => (cwcel @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo) @ (ccdm @ XG)) @ ccfn)) => ((Xph => (cwcel @ XG @ (cco @ (ccdm @ XG) @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccico) @ (ccdm @ XG)))) => ((cco @ (ccres @ XG @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccv @ Xx3) @ cclimc) != cc0))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ (ccdm @ XG)))) => ((cco @ (ccres @ XG @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccv @ Xx3) @ cclimc) != cc0))) => ((Xph => (cwcel @ XX @ ccr)) => (Xph => (((cco @ (ccres @ XF @ (cco @ ccmnf @ XX @ ccioo)) @ XX @ cclimc) != cc0) & ((cco @ (ccres @ XF @ (cco @ XX @ ccpnf @ ccioo)) @ XX @ cclimc) != cc0)))))))))))))))))).
