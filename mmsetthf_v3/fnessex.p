...
thf(cfnessex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccfne) & (cwcel @ XS @ XA2) & (cwcel @ XP @ XS)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XS))) @ (^ [Xx3:$i] : XB2)))))))).
