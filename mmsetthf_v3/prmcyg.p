...
thf(aiscygodd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xph => (cwcel @ XG @ ccgrp)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => ((ccfv @ XX @ XO) = (ccfv @ XB2 @ cchash))) => (Xph => (cwcel @ XG @ cccyg))))))))))))).
...
thf(cprmcyg_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ (ccfv @ XB2 @ cchash) @ ccprime)) => (cwcel @ XG @ cccyg)))))).
