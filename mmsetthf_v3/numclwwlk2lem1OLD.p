...
thf(awwlksext2clwwlk_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) & (cwcel @ XZ @ XV)) => (((cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) & (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)) => (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ (cco @ XN @ cc2 @ ccaddc) @ XG @ ccclwwlkn))))))))))))).
...
thf(aclwwlkext2edg_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XZ @ XV) & (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) & (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ XN @ XG @ ccclwwlkn))) => ((cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) & (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)))))))))))).
...
thf(anumclwwlk2lem1lem_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ (ccfv @ XG @ ccvtx)) & (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) & ((ccfv @ XW @ cclsw) != (ccfv @ ccc0 @ XW))) => (((ccfv @ ccc0 @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) = (ccfv @ ccc0 @ XW)) & ((ccfv @ XN @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) != (ccfv @ ccc0 @ XW))))))))).
...
thf(anumclwwlkovhOLD_thm,axiom,(! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XQ @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv)) & ((ccfv @ (ccv @ Xw) @ cclsw) != (ccv @ Xv)))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn)))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XH @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv)) & ((ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) != (ccfv @ ccc0 @ (ccv @ Xw))))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn)))))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (((cwcel @ XX @ (XV @ Xw)) & (cwcel @ XN @ ccn)) => ((cco @ XX @ XN @ (XH @ Xw @ Xv @ Xn)) = (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = XX) & ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ (ccv @ Xw)) != (ccfv @ ccc0 @ (ccv @ Xw))))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn)))))))))))))))))).
thf(aneeq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((XA2 != XC) <=> (XB2 != XD))))))))))).
thf(cnumclwwlk2lem1OLD_conj,conjecture,(! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XQ @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv)) & ((ccfv @ (ccv @ Xw) @ cclsw) != (ccv @ Xv)))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn)))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XH @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv)) & ((ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) != (ccfv @ ccc0 @ (ccv @ Xw))))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn)))))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (((cwcel @ XG @ ccfrgr) & (cwcel @ XX @ (XV @ Xw)) & (cwcel @ XN @ ccn)) => ((cwcel @ (XW @ Xn) @ (cco @ XX @ XN @ (XQ @ Xw @ Xv @ Xn))) => (cwreu @ (^ [Xv:$i] : (cwcel @ (cco @ (XW @ Xn) @ (ccs1 @ (ccv @ Xv)) @ ccconcat) @ (cco @ XX @ (cco @ XN @ cc2 @ ccaddc) @ (XH @ Xw @ Xv @ Xn)))) @ (^ [Xv:$i] : (XV @ Xw))))))))))))))))))).
