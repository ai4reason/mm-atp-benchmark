...
thf(awdomd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XX @ Xy1))) @ (^ [Xy1:$i] : XB2)))) => (Xph => (cwbr @ XA2 @ XB2 @ ccwdom)))))))))).
