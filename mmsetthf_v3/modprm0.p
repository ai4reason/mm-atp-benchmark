...
thf(cmodprm0_conj,conjecture,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ (cco @ cc1 @ XP @ ccfzo)) & (cwcel @ XI @ (cco @ cc1 @ XP @ ccfzo))) => (cwrex @ (^ [Xj:$i] : ((cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XN @ ccmul) @ ccaddc) @ XP @ ccmo) = ccc0)) @ (^ [Xj:$i] : (cco @ ccc0 @ XP @ ccfzo)))))))).
