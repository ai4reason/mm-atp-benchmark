...
thf(acht2_thm,axiom,((ccfv @ cc2 @ cccht) = (ccfv @ cc2 @ cclog))).
...
thf(achtwordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ cccht) @ (ccfv @ XB2 @ cccht) @ ccle))))).
thf(cchtrpcl_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc2 @ XA2 @ ccle)) => (cwcel @ (ccfv @ XA2 @ cccht) @ ccrp)))).
