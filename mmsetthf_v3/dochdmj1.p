...
thf(cdochdmj1_conj,conjecture,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwss @ XX @ XV) & (cwss @ XY @ XV)) => ((ccfv @ (ccun @ XX @ XY) @ Xc_pe) = (ccin @ (ccfv @ XX @ Xc_pe) @ (ccfv @ XY @ Xc_pe))))))))))))))))).
