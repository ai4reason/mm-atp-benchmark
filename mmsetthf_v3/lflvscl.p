...
thf(aislfld_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [Xc_pd:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xp:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xr:$i] : (Xph => ((XV @ Xr) = (ccfv @ XW @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => ((Xc_pl @ Xx3 @ Xy1 @ Xr) = (ccfv @ XW @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => ((XD @ Xx3 @ Xy1 @ Xr) = (ccfv @ XW @ ccsca)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => ((Xc_x @ Xx3 @ Xy1 @ Xr) = (ccfv @ XW @ ccvsca)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => (XK = (ccfv @ (XD @ Xx3 @ Xy1 @ Xr) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => ((Xc_pd @ Xx3 @ Xy1 @ Xr) = (ccfv @ (XD @ Xx3 @ Xy1 @ Xr) @ ccplusg)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => ((Xc_xp @ Xx3 @ Xy1 @ Xr) = (ccfv @ (XD @ Xx3 @ Xy1 @ Xr) @ ccmulr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => ((XF @ Xx3 @ Xy1 @ Xr) = (ccfv @ XW @ cclfn)))))) => ((! [Xr:$i] : (Xph => (cwf @ (XV @ Xr) @ XK @ XG))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : ((Xph & ((cwcel @ (ccv @ Xr) @ XK) & (cwcel @ (ccv @ Xx3) @ (XV @ Xr)) & (cwcel @ (ccv @ Xy1) @ (XV @ Xr)))) => ((ccfv @ (cco @ (cco @ (ccv @ Xr) @ (ccv @ Xx3) @ (Xc_x @ Xx3 @ Xy1 @ Xr)) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xr)) @ XG) = (cco @ (cco @ (ccv @ Xr) @ (ccfv @ (ccv @ Xx3) @ XG) @ (Xc_xp @ Xx3 @ Xy1 @ Xr)) @ (ccfv @ (ccv @ Xy1) @ XG) @ (Xc_pd @ Xx3 @ Xy1 @ Xr))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => (cwcel @ XW @ (XX @ Xx3 @ Xy1 @ Xr)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => (cwcel @ XG @ (XF @ Xx3 @ Xy1 @ Xr)))))))))))))))))))))))))))))).
...
thf(aofc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwfn @ XF @ XA2)) => (((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ XF) = XC)) => ((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ (cco @ XF @ (ccxp @ XA2 @ (ccsn @ XB2)) @ (ccof @ XR))) = (cco @ XC @ XB2 @ XR))))))))))))))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(affn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfn @ XF @ XA2)))))).
thf(aoveq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(aoveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(clflvscl_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XD @ ccbs)) => ((Xc_x = (ccfv @ XD @ ccmulr)) => ((XF = (ccfv @ XW @ cclfn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XR @ XK)) => (Xph => (cwcel @ (cco @ XG @ (ccxp @ XV @ (ccsn @ XR)) @ (ccof @ Xc_x)) @ XF)))))))))))))))))))).
