...
thf(csubgmulgcl_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XN @ ccz) & (cwcel @ XX @ XS)) => (cwcel @ (cco @ XN @ XX @ Xc_x) @ XS))))))))).
