...
thf(aprmlem1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwbr @ cc1 @ XN @ cclt) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) => ((~ (cwbr @ cc3 @ XN @ ccdvds)) => ((cwbr @ XN @ (ccdc @ cc2 @ cc5) @ cclt) => (cwcel @ XN @ ccprime)))))))).
...
thf(c_11prm_conj,conjecture,(cwcel @ (ccdc @ cc1 @ cc1) @ ccprime)).
