...
thf(cfun2d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ XA2 @ XC @ XF)) => ((Xph => (cwf @ XB2 @ XC @ XG)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (Xph => (cwf @ (ccun @ XA2 @ XB2) @ XC @ (ccun @ XF @ XG))))))))))))).
