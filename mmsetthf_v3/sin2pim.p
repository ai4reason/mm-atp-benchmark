...
thf(asinper_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccz)) => ((ccfv @ (cco @ XA2 @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccaddc) @ ccsin) = (ccfv @ XA2 @ ccsin)))))).
...
thf(csin2pim_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ XA2 @ ccmin) @ ccsin) = (ccneg @ (ccfv @ XA2 @ ccsin)))))).
