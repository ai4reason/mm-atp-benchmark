...
thf(ann0o1gt2_thm,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => ((XN = cc1) | (cwbr @ cc2 @ XN @ cclt))))).
...
thf(cnn0o_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0)))).
