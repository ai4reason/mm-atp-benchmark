...
thf(ablin_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX)) & ((cwcel @ XR @ ccxr) & (cwcel @ XS @ ccxr))) => ((ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl))) = (cco @ XP @ (ccif @ (cwbr @ XR @ XS @ ccle) @ XR @ XS) @ (ccfv @ XD @ ccbl)))))))))).
...
thf(cblin2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ (ccin @ XB2 @ XC))) & ((cwcel @ XB2 @ (ccrn @ (ccfv @ XD @ ccbl))) & (cwcel @ XC @ (ccrn @ (ccfv @ XD @ ccbl))))) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (ccin @ XB2 @ XC))) @ (^ [Xx3:$i] : ccrp))))))))).
