...
thf(aaleph11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (((ccfv @ XA2 @ ccale) = (ccfv @ XB2 @ ccale)) <=> (XA2 = XB2)))))).
...
thf(aalephord2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale))))))).
...
thf(calephiso_conj,conjecture,(cwiso @ ccon0 @ (^ [Xx3:$i] : ((cwss @ ccom @ (ccv @ Xx3)) & ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)))) @ ccep @ ccep @ ccale)).
