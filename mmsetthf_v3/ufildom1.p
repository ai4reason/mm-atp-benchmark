...
thf(a_0domg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ cc0 @ XA2 @ ccdom))))).
thf(cufildom1_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccufil)) => (cwbr @ (ccint @ XF) @ cc1o @ ccdom))))).
