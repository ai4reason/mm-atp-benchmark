...
thf(cgexlem2_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ XV) & (cwcel @ XN @ ccn) & (cwral @ (^ [Xx3:$i] : ((cco @ XN @ (ccv @ Xx3) @ Xc_x) = Xc_0)) @ (^ [Xx3:$i] : XX))) => (cwcel @ XE @ (cco @ cc1 @ XN @ ccfz))))))))))))))).
