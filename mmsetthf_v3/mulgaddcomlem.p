...
thf(agrpasscan1_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XN = (ccfv @ XG @ ccminusg)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cco @ XX @ (cco @ (ccfv @ XX @ XN) @ XY @ Xc_pl) @ Xc_pl) = XY)))))))))))).
...
thf(agrpasscan2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XN = (ccfv @ XG @ ccminusg)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cco @ (cco @ XX @ (ccfv @ XY @ XN) @ Xc_pl) @ XY @ Xc_pl) = XX)))))))))))).
thf(cmulgaddcomlem_conj,conjecture,(! [Xy1:$i] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ (ccv @ Xy1) @ ccz) & (cwcel @ XX @ XB2)) & ((cco @ (cco @ (ccv @ Xy1) @ XX @ Xc_x) @ XX @ Xc_pl) = (cco @ XX @ (cco @ (ccv @ Xy1) @ XX @ Xc_x) @ Xc_pl))) => ((cco @ (cco @ (ccneg @ (ccv @ Xy1)) @ XX @ Xc_x) @ XX @ Xc_pl) = (cco @ XX @ (cco @ (ccneg @ (ccv @ Xy1)) @ XX @ Xc_x) @ Xc_pl))))))))))))).
