...
thf(atglowdim1i_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (XP = (ccfv @ (XG @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((Xc_mi @ Xy1) = (ccfv @ (XG @ Xy1) @ ccds))) => ((! [Xy1:$i] : ((XI @ Xy1) = (ccfv @ (XG @ Xy1) @ ccitv))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XG @ Xy1) @ ccstrkg))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XX @ XP))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwrex @ (^ [Xy1:$i] : (XX != (ccv @ Xy1))) @ (^ [Xy1:$i] : XP))))))))))))))))).
