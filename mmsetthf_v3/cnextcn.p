...
thf(acnextfvval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => ((ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) != cc0))) => ((Xph & (cwcel @ XX @ XC)) => ((ccfv @ XX @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext))) = (ccuni @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)))))))))))))))))))))).
...
thf(acnextf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => ((ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) != cc0))) => (Xph => (cwf @ XC @ XB2 @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)))))))))))))))))))).
...
thf(acnnei_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => (((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop) & (cwf @ XX @ XY @ XF)) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ XF @ (ccv @ Xv)) @ (ccv @ Xw))) @ (^ [Xv:$i] : (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xw:$i] : (ccfv @ (ccsn @ (ccfv @ (ccv @ Xp) @ XF)) @ (ccfv @ XK @ ccnei))))) @ (^ [Xp:$i] : XX)))))))))))).
thf(ccnextcn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => ((ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) != cc0))) => ((Xph => (cwcel @ XK @ ccreg)) => (Xph => (cwcel @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)) @ (cco @ XJ @ XK @ cccn)))))))))))))))))))).
