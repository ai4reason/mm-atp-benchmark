...
thf(aackbij2lem1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => (cwss @ (ccpw @ XA2) @ (ccin @ (ccpw @ ccom) @ ccfn))))).
...
thf(aackbij1lem17_thm,axiom,(! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwf1 @ (ccin @ (ccpw @ ccom) @ ccfn) @ ccom @ XF)))).
