...
thf(afucinv_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XN = (cco @ XC @ XD @ ccnat)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XC @ XD @ ccfunc))) => ((XI = (ccfv @ XQ @ ccinv)) => ((XJ = (ccfv @ XD @ ccinv)) => (Xph => ((cwbr @ XU @ XV @ (cco @ XF @ XG @ XI)) <=> ((cwcel @ XU @ (cco @ XF @ XG @ XN)) & (cwcel @ XV @ (cco @ XG @ XF @ XN)) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccfv @ (ccv @ Xx3) @ XV) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ cc1st)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ cc1st)) @ XJ))) @ (^ [Xx3:$i] : XB2))))))))))))))))))))))))).
thf(ainvfuc_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XN = (cco @ XC @ XD @ ccnat)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XC @ XD @ ccfunc))) => ((XI = (ccfv @ XQ @ ccinv)) => ((XJ = (ccfv @ XD @ ccinv)) => ((Xph => (cwcel @ XU @ (cco @ XF @ XG @ XN))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XU) @ (XX @ Xx3) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ cc1st)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ cc1st)) @ XJ)))) => (Xph => (cwbr @ XU @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XX @ Xx3))) @ (cco @ XF @ XG @ XI))))))))))))))))))))))))).
