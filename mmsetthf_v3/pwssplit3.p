...
thf(apwssplit2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XW @ XU @ ccpws)) => ((XZ = (cco @ XW @ XV @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : (((cwcel @ XW @ ccgrp) & (cwcel @ XU @ XX) & (cwss @ XV @ XU)) => (cwcel @ (XF @ Xx3) @ (cco @ XY @ XZ @ ccghm))))))))))))))))))).
...
thf(cpwssplit3_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XW @ XU @ ccpws)) => ((XZ = (cco @ XW @ XV @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XX) & (cwss @ XV @ XU)) => (cwcel @ (XF @ Xx3) @ (cco @ XY @ XZ @ cclmhm))))))))))))))))))).
