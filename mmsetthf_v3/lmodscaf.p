...
thf(clmodscaf_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_xb = (ccfv @ XW @ ccscaf)) => ((cwcel @ XW @ cclmod) => (cwf @ (ccxp @ XK @ XB2) @ XB2 @ Xc_xb)))))))))))).
