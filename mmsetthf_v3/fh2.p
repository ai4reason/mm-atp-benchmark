...
thf(cfh2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch) & (cwcel @ XC @ ccch)) & ((cwbr @ XB2 @ XA2 @ cccm) & (cwbr @ XB2 @ XC @ cccm))) => ((ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) = (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj))))))).
