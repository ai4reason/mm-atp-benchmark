...
thf(chiassdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ cchil)) & ((cwcel @ XC @ cchil) & (cwcel @ XD @ cchil))) => ((cco @ (cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ ccva) @ XD @ ccsp) = (cco @ (cco @ XA2 @ (cco @ XB2 @ XD @ ccsp) @ ccmul) @ (cco @ XC @ XD @ ccsp) @ ccaddc)))))))).
