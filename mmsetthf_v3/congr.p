...
thf(ccongr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XM @ ccn)) => (((cco @ XA2 @ XM @ ccmo) = (cco @ XB2 @ XM @ ccmo)) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ XM @ ccmul) = (cco @ XA2 @ XB2 @ ccmin))) @ (^ [Xn:$i] : ccz)))))))).
