...
thf(aismeannd_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((! [Xe:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XS @ Xe @ Xn) @ ccsalg)))) => ((! [Xe:$i] : (! [Xn:$i] : (Xph => (cwf @ (XS @ Xe @ Xn) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)))) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => ((! [Xe:$i] : (! [Xn:$i] : ((Xph & (cwf @ ccn @ (XS @ Xe @ Xn) @ (ccv @ Xe)) & (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xe))))) => ((ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xe)))) @ XM) = (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xe)) @ XM))) @ ccsumge0))))) => (Xph => (cwcel @ XM @ ccmea)))))))))).
thf(acaragensal_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => (cwcel @ XS @ ccsalg)))))))).
...
thf(aomef_thm,axiom,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => (Xph => (cwf @ (ccpw @ XX) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XO)))))))).
...
thf(acaragenval_thm,axiom,(! [XO:($i > $o)] : ((cwcel @ XO @ ccome) => ((ccfv @ XO @ cccaragen) = (ccrab @ (^ [Xe:$i] : (cwral @ (^ [Xa:$i] : ((cco @ (ccfv @ (ccin @ (ccv @ Xa) @ (ccv @ Xe)) @ XO) @ (ccfv @ (ccdif @ (ccv @ Xa) @ (ccv @ Xe)) @ XO) @ ccxad) = (ccfv @ (ccv @ Xa) @ XO))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ XO)))))) @ (^ [Xe:$i] : (ccpw @ (ccuni @ (ccdm @ XO))))))))).
...
thf(aome0_thm,axiom,(! [Xph:$o] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => (Xph => ((ccfv @ cc0 @ XO) = ccc0)))))).
...
thf(ccaratheodory_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => (cwcel @ (ccres @ XO @ XS) @ ccmea)))))))).
