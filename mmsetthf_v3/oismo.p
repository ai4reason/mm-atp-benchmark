...
thf(aoiiniseg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XF = (ccoi @ XA2 @ XR)) => ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwcel @ XN @ XA2) & (cwcel @ XM @ (ccdm @ XF)))) => ((cwbr @ (ccfv @ XM @ XF) @ XN @ XR) | (cwcel @ XN @ (ccrn @ XF))))))))))).
...
thf(asmogt_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwsmo @ XF) & (cwcel @ XC @ XA2)) => (cwss @ XC @ (ccfv @ XC @ XF))))))).
...
thf(aordtype2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccoi @ XA2 @ XR)) => (((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR) & (cwcel @ XF @ ccvv)) => (cwiso @ (ccdm @ XF) @ XA2 @ ccep @ XR @ XF))))))).
...
thf(coismo_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccoi @ XA2 @ ccep)) => ((cwss @ XA2 @ ccon0) => ((cwsmo @ XF) & ((ccrn @ XF) = XA2))))))).
