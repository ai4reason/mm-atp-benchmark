...
thf(aisumclim3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwcel @ (XF @ Xk) @ (ccdm @ ccli)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XZ)) => ((ccfv @ (ccv @ Xj) @ (XF @ Xk)) = (ccsu @ (cco @ XM @ (ccv @ Xj) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))))))) => (! [Xk:$i] : (Xph => (cwbr @ (XF @ Xk) @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccli)))))))))))))).
...
thf(aesumpmono_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => (Xph => (cwbr @ (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccle)))))))))).
...
thf(aeliccelico_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ ccle)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) <=> ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) | (XC = XB2)))))))).
thf(ar19_30_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) | (Xps @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) | (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
