...
thf(apthsfval_thm,axiom,(! [XG:($i > $o)] : ((ccfv @ XG @ ccpths) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cctrls)) & (cwfun @ (cccnv @ (ccres @ (ccv @ Xp) @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)))) & ((ccin @ (ccima @ (ccv @ Xp) @ (ccpr @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash))) @ (ccima @ (ccv @ Xp) @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo))) = cc0)))))))).
...
thf(cispth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) <=> ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) & (cwfun @ (cccnv @ (ccres @ XP @ (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo)))) & ((ccin @ (ccima @ XP @ (ccpr @ ccc0 @ (ccfv @ XF @ cchash))) @ (ccima @ XP @ (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo))) = cc0))))))).
