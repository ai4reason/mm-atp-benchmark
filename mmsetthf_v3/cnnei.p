...
thf(aiscnp4_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon)) & (cwcel @ XP @ XX)) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ (ccv @ Xy1))) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xy1:$i] : (ccfv @ (ccsn @ (ccfv @ XP @ XF)) @ (ccfv @ XK @ ccnei)))))))))))))).
thf(ccnnei_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => (((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop) & (cwf @ XX @ XY @ XF)) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ XF @ (ccv @ Xv)) @ (ccv @ Xw))) @ (^ [Xv:$i] : (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xw:$i] : (ccfv @ (ccsn @ (ccfv @ (ccv @ Xp) @ XF)) @ (ccfv @ XK @ ccnei))))) @ (^ [Xp:$i] : XX)))))))))))).
