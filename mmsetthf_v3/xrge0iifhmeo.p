...
thf(axrge0iifiso_thm,axiom,(! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog)))))) => (cwiso @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt @ (cccnv @ cclt) @ XF)))).
thf(amp2an_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (((Xph & Xps) => Xch) => Xch))))))).
thf(aiccssxr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ ccxr)))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(agtiso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwss @ XB2 @ ccxr)) => ((cwiso @ XA2 @ XB2 @ cclt @ (cccnv @ cclt) @ XF) <=> (cwiso @ XA2 @ XB2 @ ccle @ (cccnv @ ccle) @ XF))))))).
...
thf(acnvordtrestixx_thm,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XA2)))) => ((cco @ (ccfv @ ccle @ ccordt) @ XA2 @ ccrest) = (ccfv @ (ccin @ (cccnv @ ccle) @ (ccxp @ XA2 @ XA2)) @ ccordt)))))).
...
thf(cxrge0iifhmeo_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((XF = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))) => (! [Xx3:$i] : (cwcel @ XF @ (cco @ ccii @ (XJ @ Xx3) @ cchmeo)))))))).
