...
thf(cfrgrwopregbsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : ((XD @ Xw) = (ccfv @ XG @ ccvtxdg))) => ((! [Xw:$i] : (XA2 = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XD @ Xw)) = (XK @ Xw))) @ (^ [Xx3:$i] : XV)))) => ((XB2 = (ccdif @ XV @ XA2)) => ((! [Xx3:$i] : (! [Xw:$i] : ((XE @ Xx3 @ Xw) = (ccfv @ XG @ ccedg)))) => (! [Xx3:$i] : (((cwcel @ XG @ ccfrgr) & (cwcel @ XX @ XV) & (XB2 = (ccsn @ XX))) => (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ XX @ (ccv @ Xw)) @ (XE @ Xx3 @ Xw))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ XX)))))))))))))))))))).
