...
thf(cpsrvscafval_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xh:$i] : ((XS @ Xx3 @ Xf1 @ Xh) = (cco @ XI @ (XR @ Xh) @ ccmps))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xh:$i] : ((Xc_xb @ Xh) = (ccfv @ (XS @ Xx3 @ Xf1 @ Xh) @ ccvsca))))) => ((! [Xh:$i] : ((XK @ Xh) = (ccfv @ (XR @ Xh) @ ccbs))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xh:$i] : ((XB2 @ Xh) = (ccfv @ (XS @ Xx3 @ Xf1 @ Xh) @ ccbs))))) => ((! [Xh:$i] : ((Xc_x @ Xh) = (ccfv @ (XR @ Xh) @ ccmulr))) => ((! [Xh:$i] : ((XD @ Xh) = (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => (! [Xh:$i] : ((Xc_xb @ Xh) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xf1:$i] : (XK @ Xh))) @ (^ [Xx3:$i] : (^ [Xf1:$i] : (XB2 @ Xh))) @ (^ [Xx3:$i] : (^ [Xf1:$i] : (cco @ (ccxp @ (XD @ Xh) @ (ccsn @ (ccv @ Xx3))) @ (ccv @ Xf1) @ (ccof @ (Xc_x @ Xh))))))))))))))))))))))).
