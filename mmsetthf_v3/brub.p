...
thf(adf_ub_ax,axiom,(! [XR:($i > $o)] : ((ccub @ XR) = (ccdif @ (ccxp @ ccvv @ ccvv) @ (cccom @ (ccdif @ ccvv @ XR) @ (cccnv @ ccep)))))).
...
thf(cbrub_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XS @ ccvv) => ((cwcel @ XA2 @ ccvv) => ((cwbr @ XS @ XA2 @ (ccub @ XR)) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ XR)) @ (^ [Xx3:$i] : XS))))))))).
