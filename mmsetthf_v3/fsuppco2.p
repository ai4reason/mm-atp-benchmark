...
thf(cfsuppco2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XB2 @ XB2 @ XG)) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => ((ccfv @ XZ @ XG) = XZ)) => (Xph => (cwbr @ (cccom @ XG @ XF) @ XZ @ ccfsupp))))))))))))))))))).
