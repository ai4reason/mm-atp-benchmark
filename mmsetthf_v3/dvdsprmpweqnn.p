...
thf(cdvdsprmpweqnn_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn)))))))).
