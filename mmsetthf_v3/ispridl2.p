...
thf(a_2ralor_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xx3) | (Xps @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) | (cwral @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1)))))))))).
...
thf(cispridl2_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((XG @ Xa @ Xb) = (ccfv @ XR @ cc1st)))) => ((! [Xa:$i] : (! [Xb:$i] : ((XH @ Xa @ Xb) = (ccfv @ XR @ cc2nd)))) => ((! [Xa:$i] : (! [Xb:$i] : (XX = (ccrn @ (XG @ Xa @ Xb))))) => (((cwcel @ XR @ ccrngo) & ((cwcel @ XP @ (ccfv @ XR @ ccidl)) & (XP != XX) & (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (XH @ Xa @ Xb)) @ XP) => ((cwcel @ (ccv @ Xa) @ XP) | (cwcel @ (ccv @ Xb) @ XP)))) @ (^ [Xb:$i] : XX))) @ (^ [Xa:$i] : XX)))) => (cwcel @ XP @ (ccfv @ XR @ ccpridl)))))))))))).
