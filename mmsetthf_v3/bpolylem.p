...
thf(awrecseq3_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = XG) => ((ccwrecs @ XA2 @ XR @ XF) = (ccwrecs @ XA2 @ XR @ XG)))))))).
...
thf(awfr1_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (cwfn @ XF @ XA2))))))))).
