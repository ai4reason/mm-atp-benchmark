...
thf(asrngring_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccsr) => (cwcel @ XR @ ccrg)))).
...
thf(atchds_thm,axiom,(! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((cwcel @ XW @ ccgrp) => ((cccom @ XN @ Xc_mi) = (ccfv @ XG @ ccds))))))))))).
...
thf(agrpsubf_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cwcel @ XG @ ccgrp) => (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ Xc_mi)))))))).
