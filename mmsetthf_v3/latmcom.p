...
thf(ameetcom_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((((cwcel @ XK @ ccpo) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & ((cwcel @ (ccop @ XX @ XY) @ (ccdm @ Xc_an)) & (cwcel @ (ccop @ XY @ XX) @ (ccdm @ Xc_an)))) => ((cco @ XX @ XY @ Xc_an) = (cco @ XY @ XX @ Xc_an))))))))))).
thf(clatmcom_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_an = (ccfv @ XK @ ccmee)) => (((cwcel @ XK @ cclat) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_an) = (cco @ XY @ XX @ Xc_an))))))))))).
