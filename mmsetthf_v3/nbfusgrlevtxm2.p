...
thf(anbgrssvwo2_thm,axiom,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwnel @ XM @ (cco @ XG @ XX @ ccnbgr)) => (cwss @ (cco @ XG @ XX @ ccnbgr) @ (ccdif @ XV @ (ccpr @ XM @ XX)))))))))).
...
thf(cnbfusgrlevtxm2_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwcel @ XG @ ccfusgr) & (cwcel @ XU @ XV)) & ((cwcel @ XM @ XV) & (XM != XU) & (cwnel @ XM @ (cco @ XG @ XU @ ccnbgr)))) => (cwbr @ (ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccmin) @ ccle)))))))).
