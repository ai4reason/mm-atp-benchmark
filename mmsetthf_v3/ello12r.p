...
thf(aello12_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr)) => ((cwcel @ XF @ cclo1) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xm) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))).
thf(cello12r_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr)) & ((cwcel @ XC @ ccr) & (cwcel @ XM @ ccr)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ XC @ (ccv @ Xx3) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XM @ ccle))) @ (^ [Xx3:$i] : XA2))) => (cwcel @ XF @ cclo1))))))).
