...
thf(advasinbx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ ccc @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccfv @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccsin) @ ccmul))) @ ccdv) = (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (ccfv @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ cccos) @ ccmul)))))))).
...
thf(acnlimc_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwss @ XA2 @ ccc) => ((cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf)) <=> ((cwf @ XA2 @ ccc @ XF) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ XF @ (ccv @ Xx3) @ cclimc))) @ (^ [Xx3:$i] : XA2)))))))).
