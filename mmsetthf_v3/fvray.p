...
thf(cfvray_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XP @ (ccfv @ XN @ ccee)) & (cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (XP != XA2))) => ((cco @ XP @ XA2 @ ccray) = (ccrab @ (^ [Xx3:$i] : (cwbr @ XP @ (ccop @ XA2 @ (ccv @ Xx3)) @ ccoutsideof)) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee))))))))).
