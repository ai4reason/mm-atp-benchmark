...
thf(aeueq3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((~ (Xph & Xps)) => (cweu @ (^ [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) | ((~ (Xph | Xps)) & ((ccv @ Xx3) = XB2)) | (Xps & ((ccv @ Xx3) = XC))))))))))))))).
...
thf(cmoeq3_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((~ (Xph & Xps)) => (cwmo @ (^ [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) | ((~ (Xph | Xps)) & ((ccv @ Xx3) = XB2)) | (Xps & ((ccv @ Xx3) = XC)))))))))))))).
