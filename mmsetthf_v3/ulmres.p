...
thf(culmres_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((XW = (ccfv @ XN @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => (Xph => ((cwbr @ XF @ XG @ (ccfv @ XS @ cculm)) <=> (cwbr @ (ccres @ XF @ XW) @ XG @ (ccfv @ XS @ cculm))))))))))))))))).
