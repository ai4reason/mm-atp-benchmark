...
thf(arhmsubcALTVlem3_thm,axiom,(! [Xph:$o] : (! [Xx3:$i] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngcALTV)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => ((Xph & (cwcel @ (ccv @ Xx3) @ XR)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccfv @ XU @ ccrngcALTV) @ cccid)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XH))))))))))))))).
...
thf(arhmsubcALTVlem4_thm,axiom,(! [Xph:$o] : (! [Xy1:$i] : (! [Xz:$i] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [Xf1:$i] : (! [Xg1:$i] : (! [XH:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ (XU @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccfv @ (XU @ Xx3) @ ccrngcALTV))) => ((! [Xx3:$i] : (Xph => (XR = (ccin @ ccrg @ (XU @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccres @ ccrh @ (ccxp @ XR @ XR)))) => (! [Xx3:$i] : ((((Xph & (cwcel @ (ccv @ Xx3) @ XR)) & ((cwcel @ (ccv @ Xy1) @ XR) & (cwcel @ (ccv @ Xz) @ XR))) & ((cwcel @ (ccv @ Xf1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XH @ Xx3))) & (cwcel @ (ccv @ Xg1) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (XH @ Xx3))))) => (cwcel @ (cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ (ccfv @ (ccfv @ (XU @ Xx3) @ ccrngcALTV) @ ccco))) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (XH @ Xx3)))))))))))))))))))).
...
thf(arhmsubcALTVlem1_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngcALTV)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => (Xph => (cwfn @ XH @ (ccxp @ XR @ XR)))))))))))))).
thf(crhmsubcALTV_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngcALTV)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => (Xph => (cwcel @ XH @ (ccfv @ (ccfv @ XU @ ccrngcALTV) @ ccsubc)))))))))))))).
