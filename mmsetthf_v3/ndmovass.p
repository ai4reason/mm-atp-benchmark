...
thf(cndmovass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((ccdm @ XF) = (ccxp @ XS @ XS)) => ((~ (cwcel @ cc0 @ XS)) => ((~ ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS) & (cwcel @ XC @ XS))) => ((cco @ (cco @ XA2 @ XB2 @ XF) @ XC @ XF) = (cco @ XA2 @ (cco @ XB2 @ XC @ XF) @ XF))))))))))).
