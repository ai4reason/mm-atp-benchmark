...
thf(cclimeqmpt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ (XW @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XM @ Xx3) @ ccz))) => ((! [Xx3:$i] : (XZ = (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XZ @ XA2))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XZ @ XB2))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XZ)) => (cwcel @ (XC @ Xx3) @ (XU @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xx3) @ ccli) <=> (cwbr @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xx3) @ ccli))))))))))))))))))))))).
