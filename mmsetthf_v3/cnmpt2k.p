...
thf(acnmptcom_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XJ @ Xx3 @ Xy1) @ (ccfv @ XX @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XK @ Xx3 @ Xy1) @ (ccfv @ XY @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XJ @ Xx3 @ Xy1) @ (XK @ Xx3 @ Xy1) @ cctx) @ XL @ cccn))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xx3:$i] : XY)) @ (^ [Xy1:$i] : (^ [Xx3:$i] : XX)) @ (^ [Xy1:$i] : (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XK @ Xx3 @ Xy1) @ (XJ @ Xx3 @ Xy1) @ cctx) @ XL @ cccn)))))))))))))))).
...
thf(acnmptk1_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XJ @ Xz) @ (ccfv @ (XX @ Xz) @ cctopon)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XK @ Xz) @ (ccfv @ (XY @ Xz) @ cctopon)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XL @ Xz) @ (ccfv @ XZ @ cctopon)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XX @ Xz)) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : (XY @ Xz)) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))))) @ (cco @ (XJ @ Xz) @ (cco @ (XL @ Xz) @ (XK @ Xz) @ ccxko) @ cccn)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (ccmpt @ (^ [Xz:$i] : XZ) @ (^ [Xz:$i] : (XB2 @ Xz))) @ (cco @ (XL @ Xz) @ (XM @ Xz) @ cccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (XA2 @ Xx3 @ Xy1)) => ((XB2 @ Xz) = (XC @ Xx3 @ Xy1)))))) => (! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XX @ Xz)) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : (XY @ Xz)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) @ (cco @ (XJ @ Xz) @ (cco @ (XM @ Xz) @ (XK @ Xz) @ ccxko) @ cccn)))))))))))))))))))))).
...
thf(axkoinjcn_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccop @ (ccv @ Xy1) @ (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XR @ (ccfv @ XX @ cctopon)) & (cwcel @ XS @ (ccfv @ XY @ cctopon))) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ XR @ (cco @ (cco @ XS @ XR @ cctx) @ XS @ ccxko) @ cccn)))))))))))).
...
thf(ccnmpt2k_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XJ @ Xx3 @ Xy1) @ (ccfv @ XX @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XK @ Xx3 @ Xy1) @ (ccfv @ XY @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XJ @ Xx3 @ Xy1) @ (XK @ Xx3 @ Xy1) @ cctx) @ XL @ cccn))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))))) @ (cco @ (XJ @ Xx3 @ Xy1) @ (cco @ XL @ (XK @ Xx3 @ Xy1) @ ccxko) @ cccn)))))))))))))))).
