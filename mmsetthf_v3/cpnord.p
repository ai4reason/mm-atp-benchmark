...
thf(ccpnord_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XM @ ccn0) & (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwss @ (ccfv @ XN @ (ccfv @ XS @ cccpn)) @ (ccfv @ XM @ (ccfv @ XS @ cccpn)))))))).
