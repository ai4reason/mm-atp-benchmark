...
thf(cmdsl0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) & ((cwcel @ XC @ ccch) & (cwcel @ XD @ ccch))) => (((((cwss @ XC @ XA2) & (cwss @ XD @ XB2)) & ((ccin @ XA2 @ XB2) = cc0h)) & (cwbr @ XA2 @ XB2 @ ccmd)) => (cwbr @ XC @ XD @ ccmd)))))))).
