...
thf(cltexprlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((XC @ Xy1) = (^ [Xx3:$i] : (? [Xy1:$i] : ((~ (cwcel @ (ccv @ Xy1) @ XA2)) & (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccplq) @ XB2)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ ccnp) => ((cwcel @ (ccv @ Xx3) @ (XC @ Xy1)) => (? [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (XC @ Xy1)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccltq)))))))))))).
