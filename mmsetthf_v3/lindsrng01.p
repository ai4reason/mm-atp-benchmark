...
thf(almodsn0_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ cclmod) => (XB2 != cc0)))))))).
...
thf(a_0ring_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & ((ccfv @ XB2 @ cchash) = cc1)) => (XB2 = (ccsn @ Xc_0))))))))).
...
thf(clindsrng01_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XE = (ccfv @ XR @ ccbs)) => (((cwcel @ XM @ cclmod) & (((ccfv @ XE @ cchash) = ccc0) | ((ccfv @ XE @ cchash) = cc1)) & (cwcel @ XS @ (ccpw @ XB2))) => (cwbr @ XS @ XM @ cclininds))))))))))).
