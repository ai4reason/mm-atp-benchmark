...
thf(adf_rrn_ax,axiom,(ccrrn = (ccmpt @ (^ [Xi:$i] : ccfn) @ (^ [Xi:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccr @ (ccv @ Xi) @ ccmap))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccr @ (ccv @ Xi) @ ccmap))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccsu @ (ccv @ Xi) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xy1)) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt)))))))).
...
thf(crrnval_conj,conjecture,(! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ ccr @ XI @ ccmap)) => ((cwcel @ XI @ ccfn) => ((ccfv @ XI @ ccrrn) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccsu @ XI @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xy1)) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt)))))))))).
