...
thf(cismntoplly_conj,conjecture,(! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XJ @ XV)) => ((cwbr @ XN @ XJ @ ccmntop) <=> ((cwcel @ XJ @ cc2ndc) & (cwcel @ XJ @ ccha) & (cwcel @ XJ @ (cclly @ (ccec @ (ccfv @ (ccfv @ XN @ ccehl) @ cctopn) @ cchmph)))))))))).
