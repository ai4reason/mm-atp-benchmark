...
thf(cbrxrn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwcel @ XC @ XX)) => ((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ (ccxrn @ XR @ XS)) <=> ((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XA2 @ XC @ XS))))))))))))).
