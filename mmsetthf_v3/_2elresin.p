...
thf(c_2elresin_conj,conjecture,(! [Xx3:$i] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xz:$i] : (((cwfn @ (XF @ Xy1 @ Xz) @ (XA2 @ Xy1 @ Xz)) & (cwfn @ (XG @ Xy1 @ Xz) @ (XB2 @ Xy1 @ Xz))) => (((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XF @ Xy1 @ Xz)) & (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ (XG @ Xy1 @ Xz))) <=> ((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccres @ (XF @ Xy1 @ Xz) @ (ccin @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xy1 @ Xz)))) & (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ (ccres @ (XG @ Xy1 @ Xz) @ (ccin @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xy1 @ Xz))))))))))))))).
