...
thf(csubgntr_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => (((cwcel @ XG @ cctgp) & (cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XA2 @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)))) => (cwcel @ XS @ XJ)))))))).
