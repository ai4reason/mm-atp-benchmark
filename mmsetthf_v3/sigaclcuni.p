...
thf(csigaclcuni_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => (! [Xk:$i] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ XS)) @ (^ [Xk:$i] : (XA2 @ Xk))) & (cwbr @ (XA2 @ Xk) @ ccom @ ccdom)) => (cwcel @ (cciun @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XS)))))))).
