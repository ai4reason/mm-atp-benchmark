...
thf(adchreq_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ (XN @ Xk) @ ccdchr))) => ((! [Xk:$i] : (XZ = (ccfv @ (XN @ Xk) @ cczn))) => ((! [Xk:$i] : ((XD @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : (Xph => (cwcel @ XX @ (XD @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ XY @ (XD @ Xk)))) => (Xph => ((XX = XY) <=> (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ XX) = (ccfv @ (ccv @ Xk) @ XY))) @ (^ [Xk:$i] : XU))))))))))))))))))).
