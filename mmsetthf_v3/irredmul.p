...
thf(cirredmul_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XR @ ccir)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI)) => ((cwcel @ XX @ XU) | (cwcel @ XY @ XU))))))))))))))).
