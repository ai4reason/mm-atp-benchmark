...
thf(atrlcocnvat_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XF @ XT) & (cwcel @ XG @ XT)) & ((ccfv @ XF @ XR) != (ccfv @ XG @ XR))) => (cwcel @ (ccfv @ (cccom @ XF @ (cccnv @ XG)) @ XR) @ XA2))))))))))))))).
...
thf(atrljco2_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT) & (cwcel @ XG @ XT)) => ((cco @ (ccfv @ XF @ XR) @ (ccfv @ (cccom @ XF @ XG) @ XR) @ Xc_or) = (cco @ (ccfv @ XG @ XR) @ (ccfv @ (cccom @ XF @ XG) @ XR) @ Xc_or)))))))))))))))).
