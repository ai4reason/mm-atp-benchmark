...
thf(cfrege129d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ ccvv)) => ((Xph => (cwcel @ XA2 @ (ccdm @ XF))) => ((Xph => (XC = (ccfv @ XA2 @ XF))) => ((Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XF @ cctcl)) | (XA2 = XB2) | (cwbr @ XB2 @ XA2 @ (ccfv @ XF @ cctcl)))) => ((Xph => (cwfun @ XF)) => (Xph => ((cwbr @ XB2 @ XC @ (ccfv @ XF @ cctcl)) | (XB2 = XC) | (cwbr @ XC @ XB2 @ (ccfv @ XF @ cctcl))))))))))))))).
