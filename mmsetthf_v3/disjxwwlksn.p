...
thf(cdisjxwwlksn_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XV @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccvtx)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccedg)))) => (! [Xx3:$i] : (cwdisj @ (^ [Xy1:$i] : (cco @ (XN @ Xx3) @ (XG @ Xx3 @ Xy1) @ ccwwlksn)) @ (^ [Xy1:$i] : (ccrab @ (^ [Xx3:$i] : (((cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (XN @ Xx3)) @ ccsubstr) = (ccv @ Xy1)) & ((ccfv @ ccc0 @ (ccv @ Xy1)) = (XP @ Xx3 @ Xy1)) & (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ (ccv @ Xx3) @ cclsw)) @ (XE @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (ccword @ (XV @ Xy1))))))))))))))).
