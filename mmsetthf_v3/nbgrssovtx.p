...
thf(anbgrnself2_thm,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwnel @ XX @ (cco @ XG @ XX @ ccnbgr))))).
...
thf(cnbgrssovtx_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (cwss @ (cco @ XG @ XX @ ccnbgr) @ (ccdif @ XV @ (ccsn @ XX)))))))).
