...
thf(amapcdaen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwcel @ XC @ XX)) => (cwbr @ (cco @ XA2 @ (cco @ XB2 @ XC @ cccda) @ ccmap) @ (ccxp @ (cco @ XA2 @ XB2 @ ccmap) @ (cco @ XA2 @ XC @ ccmap)) @ ccen))))))))).
