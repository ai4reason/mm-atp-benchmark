...
thf(anumdenneg_thm,axiom,(! [XQ:($i > $o)] : ((cwcel @ XQ @ ccq) => (((ccfv @ (ccneg @ XQ) @ ccnumer) = (ccneg @ (ccfv @ XQ @ ccnumer))) & ((ccfv @ (ccneg @ XQ) @ ccdenom) = (ccfv @ XQ @ ccdenom)))))).
thf(a_3eqtr4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XA2)) => ((Xph => (XD = XB2)) => (Xph => (XC = XD))))))))))).
thf(aoveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(ccdvds_tp,type,(ccdvds : ($i > $o))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(agcdneg_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ (ccneg @ XN) @ ccgcd) = (cco @ XM @ XN @ ccgcd)))))).
...
thf(cdivnumden2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ (ccneg @ XB2) @ ccn)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) = (ccneg @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))) & ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) = (ccneg @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)))))))).
