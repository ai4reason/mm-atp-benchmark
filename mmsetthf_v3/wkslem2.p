...
thf(cwkslem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (((XA2 = XB2) & ((cco @ XA2 @ cc1 @ ccaddc) = XC)) => (((((ccfv @ XA2 @ XP) = (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) & ((ccfv @ (ccfv @ XA2 @ XF) @ XI) = (ccsn @ (ccfv @ XA2 @ XP)))) | ((~ ((ccfv @ XA2 @ XP) = (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP))) & (cwss @ (ccpr @ (ccfv @ XA2 @ XP) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ XA2 @ XF) @ XI)))) <=> ((((ccfv @ XB2 @ XP) = (ccfv @ XC @ XP)) & ((ccfv @ (ccfv @ XB2 @ XF) @ XI) = (ccsn @ (ccfv @ XB2 @ XP)))) | ((~ ((ccfv @ XB2 @ XP) = (ccfv @ XC @ XP))) & (cwss @ (ccpr @ (ccfv @ XB2 @ XP) @ (ccfv @ XC @ XP)) @ (ccfv @ (ccfv @ XB2 @ XF) @ XI))))))))))))).
