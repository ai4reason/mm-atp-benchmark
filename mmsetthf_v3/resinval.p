...
thf(aefcj_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccfv @ XA2 @ cccj) @ cce) = (ccfv @ (ccfv @ XA2 @ cce) @ cccj))))).
...
thf(cresinval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccsin) = (ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccim))))).
