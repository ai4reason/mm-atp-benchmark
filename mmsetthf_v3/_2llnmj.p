...
thf(c_2llnmj_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((XP = (ccfv @ XK @ cclpl)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XN) & (cwcel @ XY @ XN)) => ((cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2) <=> (cwcel @ (cco @ XX @ XY @ Xc_or) @ XP))))))))))))))))).
