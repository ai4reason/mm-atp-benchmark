...
thf(cblbnd_conj,conjecture,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XY @ XX) & (cwcel @ XR @ ccr)) => (cwcel @ (ccres @ XM @ (ccxp @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)))) @ (ccfv @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ ccbnd)))))))).
