...
thf(cmsubval_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmsub)) => ((XE = (ccfv @ XT @ ccmex)) => ((XO = (ccfv @ XT @ ccmrsub)) => (((cwf @ XA2 @ XR @ XF) & (cwss @ XA2 @ XV) & (cwcel @ XX @ XE)) => ((ccfv @ XX @ (ccfv @ XF @ XS)) = (ccop @ (ccfv @ XX @ cc1st) @ (ccfv @ (ccfv @ XX @ cc2nd) @ (ccfv @ XF @ XO)))))))))))))))))))).
