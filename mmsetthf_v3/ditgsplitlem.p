...
thf(cditgsplitlem_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XY @ ccr)) => ((Xph => (cwcel @ XA2 @ (cco @ XX @ XY @ ccicc))) => ((Xph => (cwcel @ XB2 @ (cco @ XX @ XY @ ccicc))) => ((Xph => (cwcel @ XC @ (cco @ XX @ XY @ ccicc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XX @ XY @ ccioo))) => (cwcel @ (XD @ Xx3) @ XV))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ XY @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))) @ ccibl)) => (((Xps & Xth) <=> ((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ XB2 @ XC @ ccle))) => (((Xph & Xps) & Xth) => ((ccdit @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3))) = (cco @ (ccdit @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XD @ Xx3))) @ (ccdit @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3))) @ ccaddc)))))))))))))))))))))).
