...
thf(aopabssxpd_thm,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xx3) @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xy1) @ XB2)))) => (Xph => (cwss @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))) @ (ccxp @ XA2 @ XB2)))))))))).
...
thf(cuspgropssxp_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((XP = (ccpw @ (ccfv @ XV @ ccspr))) => ((! [Xv:$i] : (! [Xe:$i] : (! [Xq:$i] : ((XG @ Xv @ Xe @ Xq) = (ccopab @ (^ [Xv:$i] : (^ [Xe:$i] : (((ccv @ Xv) = XV) & (cwrex @ (^ [Xq:$i] : (((ccfv @ (ccv @ Xq) @ ccvtx) = (ccv @ Xv)) & ((ccfv @ (ccv @ Xq) @ ccedg) = (ccv @ Xe)))) @ (^ [Xq:$i] : ccuspgr)))))))))) => (! [Xv:$i] : (! [Xe:$i] : (! [Xq:$i] : ((cwcel @ XV @ (XW @ Xq)) => (cwss @ (XG @ Xv @ Xe @ Xq) @ (ccxp @ (XW @ Xq) @ XP))))))))))))).
