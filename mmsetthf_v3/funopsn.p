...
thf(afuniun_thm,axiom,(! [XF:($i > $o)] : ((cwfun @ XF) => (XF = (cciun @ (^ [Xx3:$i] : (ccdm @ XF)) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XF))))))))).
...
thf(aiunopeqop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XB2 @ Xx3 @ Xz) @ ccvv))) => ((! [Xz:$i] : (cwcel @ (XC @ Xz) @ ccvv)) => ((! [Xz:$i] : (cwcel @ (XD @ Xz) @ ccvv)) => (! [Xz:$i] : ((XA2 != cc0) => (((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (XB2 @ Xx3 @ Xz))))) = (ccop @ (XC @ Xz) @ (XD @ Xz))) => (? [Xz:$i] : (XA2 = (ccsn @ (ccv @ Xz))))))))))))))).
...
thf(cfunopsn_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => (((cwfun @ XF) & (XF = (ccop @ XX @ XY))) => (? [Xa:$i] : ((XX = (ccsn @ (ccv @ Xa))) & (XF = (ccsn @ (ccop @ (ccv @ Xa) @ (ccv @ Xa))))))))))))).
