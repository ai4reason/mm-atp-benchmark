...
thf(cabnexg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : ((cwcel @ (XF @ Xx3) @ (XV @ Xx3 @ Xy1)) & (cwcel @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (^ [Xx3:$i] : XA2)) => ((cwcel @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (XF @ Xx3))) @ (^ [Xx3:$i] : XA2))) @ (XW @ Xx3 @ Xy1)) => (cwcel @ XA2 @ ccvv)))))))))).
