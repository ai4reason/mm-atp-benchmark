...
thf(celbigo_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XF @ (ccfv @ XG @ ccbigo)) <=> ((cwcel @ XF @ (cco @ ccr @ ccr @ ccpm)) & (cwcel @ XG @ (cco @ ccr @ ccr @ ccpm)) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))).
