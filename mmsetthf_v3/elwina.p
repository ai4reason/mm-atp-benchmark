...
thf(adf_wina_ax,axiom,(ccwina = (^ [Xx3:$i] : (((ccv @ Xx3) != cc0) & ((ccfv @ (ccv @ Xx3) @ cccf) = (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccsdm)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))).
thf(celwina_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccwina) <=> ((XA2 != cc0) & ((ccfv @ XA2 @ cccf) = XA2) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
