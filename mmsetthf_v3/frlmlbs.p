...
thf(aislbs_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XV @ Xx3 @ Xy1) = (ccfv @ XW @ ccbs)))) => ((XF = (ccfv @ XW @ ccsca)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XW @ ccvsca)))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XF @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ XW @ cclbs)))) => ((XN = (ccfv @ XW @ cclspn)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ XF @ cc0g))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XW @ (XX @ Xx3 @ Xy1)) => ((cwcel @ XB2 @ (XJ @ Xx3 @ Xy1)) <=> ((cwss @ XB2 @ (XV @ Xx3 @ Xy1)) & ((ccfv @ XB2 @ XN) = (XV @ Xx3 @ Xy1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_x @ Xx3 @ Xy1)) @ (ccfv @ (ccdif @ XB2 @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xy1:$i] : (ccdif @ (XK @ Xx3) @ (ccsn @ (Xc_0 @ Xx3)))))) @ (^ [Xx3:$i] : XB2))))))))))))))))))))))))).
