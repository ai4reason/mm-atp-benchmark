...
thf(abnj1418_b_thm,axiom,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ (ccv @ Xx3) @ (cc_bnj14 @ XA2 @ XR @ (ccv @ Xx3))) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XR)))))).
...
thf(afrirr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cwfr @ XA2 @ XR) & (cwcel @ XB2 @ XA2)) => (~ (cwbr @ XB2 @ XB2 @ XR))))))).
...
thf(abnj1418_thm,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ (ccv @ Xy1) @ (cc_bnj14 @ XA2 @ XR @ (ccv @ Xx3))) => (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))))))).
...
thf(abnj1318_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = XY) => ((cc_bnj18 @ XA2 @ XR @ XX) = (cc_bnj18 @ XA2 @ XR @ XY)))))))).
...
thf(abnj1414_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccun @ (cc_bnj14 @ XA2 @ XR @ XX) @ (cciun @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ XX)) @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => ((cc_bnj18 @ XA2 @ XR @ XX) = (XB2 @ Xy1)))))))))).
thf(abnj1138_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccun @ XB2 @ XC)) => ((cwcel @ XX @ XA2) <=> ((cwcel @ XX @ XB2) | (cwcel @ XX @ XC))))))))).
thf(abnj1204_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xps @ Xx3 @ Xy1) <=> (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))) => (! [Xy1:$i] : (((cw_bnj15 @ XA2 @ XR) & (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3 @ Xy1) => (Xph @ Xx3))) @ (^ [Xx3:$i] : XA2))) => (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(cbnj1417_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : ((Xph <=> (cw_bnj15 @ XA2 @ XR)) => ((! [Xx3:$i] : ((Xps @ Xx3) <=> (~ (cwcel @ (ccv @ Xx3) @ (cc_bnj18 @ XA2 @ XR @ (ccv @ Xx3)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xch @ Xx3 @ Xy1) <=> (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xth @ Xx3 @ Xy1) <=> (Xph & (cwcel @ (ccv @ Xx3) @ XA2) & (Xch @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccun @ (cc_bnj14 @ XA2 @ XR @ (ccv @ Xx3)) @ (cciun @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ (ccv @ Xy1)))))))) => (Xph => (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (cc_bnj18 @ XA2 @ XR @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : XA2)))))))))))))))).
