...
thf(ahoi2toco_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : ((XI @ Xk) = (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccop @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk))))))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))))) = (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccico)))))))))))))).
...
thf(copnvonmbllem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xh:$i] : ((? [X:$i] : ((^ [Xi:$i] : (Xph @ Xh @ Xi)) @ X)) => (! [X:$i] : ((^ [Xi:$i] : (Xph @ Xh @ Xi)) @ X)))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ XX @ (XV @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwf @ XX @ ccq @ (XC @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwf @ XX @ ccq @ (XD @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)) @ ccico))) @ (XB2 @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwss @ (XB2 @ Xh @ Xi) @ (XG @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (XY @ Xi) @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)) @ ccico))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((XK @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))) @ (XG @ Xi))) @ (^ [Xh:$i] : (cco @ (ccxp @ ccq @ ccq) @ XX @ ccmap)))))) => ((! [Xh:$i] : (! [Xi:$i] : ((XH @ Xi) = (ccmpt @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccop @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)))))))) => (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwrex @ (^ [Xh:$i] : (cwcel @ (XY @ Xi) @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))))) @ (^ [Xh:$i] : (XK @ Xh @ Xi)))))))))))))))))))))))))).
