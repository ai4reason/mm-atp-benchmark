...
thf(ccdleme22d_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le))) & ((cwcel @ XT @ XA2) & (~ (cwbr @ XT @ XW @ Xc_le))) & ((cwcel @ XV @ XA2) & (cwbr @ XV @ XW @ Xc_le))) & ((XS != XT) & (cwbr @ XS @ (cco @ XT @ XV @ Xc_or) @ Xc_le))) => (XV = (cco @ (cco @ XS @ XT @ Xc_or) @ XW @ Xc_an))))))))))))))))))).
