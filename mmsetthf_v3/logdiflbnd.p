...
thf(aeflegeo_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => (Xph => (cwbr @ (ccfv @ XA2 @ cce) @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccle)))))))).
...
thf(clogdiflbnd_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (cco @ cc1 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ cclog) @ ccmin) @ ccle)))).
