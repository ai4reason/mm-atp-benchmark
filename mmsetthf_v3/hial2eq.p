...
thf(chial2eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cwral @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccsp) = (cco @ XB2 @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) <=> (XA2 = XB2)))))).
