...
thf(ambfsub_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccmbf)))))))).
thf(ccli_tp,type,(ccli : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccitg1_tp,type,(ccitg1 : ($i > $o))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(ambfmullem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwf @ XA2 @ ccr @ XG)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf))))))))))).
...
thf(ambfres_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ ccmbf) & (cwcel @ XA2 @ (ccdm @ ccvol))) => (cwcel @ (ccres @ XF @ XA2) @ ccmbf))))).
...
thf(cmbfmul_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf)))))))).
