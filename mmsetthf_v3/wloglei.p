...
thf(cwloglei_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xz) = (ccv @ Xx3)) & ((ccv @ Xw) = (ccv @ Xy1))) => ((Xps @ Xz @ Xw) <=> (Xch @ Xx3 @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xz) = (ccv @ Xy1)) & ((ccv @ Xw) = (ccv @ Xx3))) => ((Xps @ Xz @ Xw) <=> (Xth @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((Xph => (cwss @ XS @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) => (Xth @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) => (Xch @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (Xch @ Xx3 @ Xy1))))))))))))))).
