...
thf(ci1f1lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0))))) => (! [Xx3:$i] : ((cwf @ ccr @ (ccpr @ ccc0 @ cc1) @ (XF @ Xx3)) & ((cwcel @ XA2 @ (ccdm @ ccvol)) => ((ccima @ (cccnv @ (XF @ Xx3)) @ (ccsn @ cc1)) = XA2)))))))).
