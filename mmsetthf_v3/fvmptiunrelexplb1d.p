...
thf(cfvmptiunrelexplb1d_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : (! [Xr:$i] : ((XC @ Xn @ Xr) = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp)))))))) => ((! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xn @ Xr) => (cwcel @ XR @ ccvv)))) => ((! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xn @ Xr) => (cwcel @ XN @ ccvv)))) => ((! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xn @ Xr) => (cwcel @ cc1 @ XN)))) => (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xn @ Xr) => (cwss @ XR @ (ccfv @ XR @ (XC @ Xn @ Xr))))))))))))))).
