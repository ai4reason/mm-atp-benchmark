...
thf(csuppval_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (! [Xi:$i] : (((cwcel @ XX @ (XV @ Xi)) & (cwcel @ XZ @ (XW @ Xi))) => ((cco @ XX @ XZ @ ccsupp) = (ccrab @ (^ [Xi:$i] : ((ccima @ XX @ (ccsn @ (ccv @ Xi))) != (ccsn @ XZ))) @ (^ [Xi:$i] : (ccdm @ XX))))))))))).
