...
thf(ci1fmulclem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XA2 @ ccr)) => (((Xph & (XA2 != ccc0)) & (cwcel @ XB2 @ ccr)) => ((ccima @ (cccnv @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul))) @ (ccsn @ XB2)) = (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XB2 @ XA2 @ ccdiv)))))))))))).
