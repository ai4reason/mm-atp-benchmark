...
thf(ccnextfres1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => ((ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) != cc0))) => ((Xph => (cwcel @ XK @ ccreg)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccn))) => (Xph => ((ccres @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)) @ XA2) = XF)))))))))))))))))))).
