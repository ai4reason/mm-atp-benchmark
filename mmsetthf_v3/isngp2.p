...
thf(amsf_thm,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX))) => ((cwcel @ XM @ ccmt) => (cwf @ (ccxp @ XX @ XX) @ ccr @ XD)))))))).
...
thf(cisngp2_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccres @ XD @ (ccxp @ XX @ XX))) => ((cwcel @ XG @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ ccmt) & ((cccom @ XN @ Xc_mi) = XE))))))))))))))).
