...
thf(aoprssov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwfun @ XF) & (cwfn @ XG @ (ccxp @ XC @ XD)) & (cwss @ XG @ XF)) & ((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD))) => ((cco @ XA2 @ XB2 @ XF) = (cco @ XA2 @ XB2 @ XG)))))))))).
...
thf(aeqfnov_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwfn @ XF @ (ccxp @ XA2 @ XB2)) & (cwfn @ XG @ (ccxp @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1)))) => ((XF = XG) <=> (((ccxp @ XA2 @ XB2) = (ccxp @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))))))))).
thf(cssps_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XW @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XR = (ccfv @ XW @ ccns)) => ((XH = (ccfv @ XU @ ccss)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ XH)) => (XR = (ccres @ XS @ (ccxp @ ccc @ XY))))))))))))))).
