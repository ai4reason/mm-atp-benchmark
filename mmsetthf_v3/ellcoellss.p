...
thf(cellcoellss_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ cclmod) & (cwcel @ XS @ (ccfv @ XM @ cclss)) & (cwss @ XV @ XS)) => (cwral @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XS)) @ (^ [Xx3:$i] : (cco @ XM @ XV @ cclinco)))))))).
