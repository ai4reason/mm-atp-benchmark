...
thf(cdvds1lem_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((Xph => ((cwcel @ XJ @ ccz) & (cwcel @ XK @ ccz))) => ((Xph => ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccz)) => (cwcel @ (XZ @ Xx3) @ ccz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccz)) => (((cco @ (ccv @ Xx3) @ XJ @ ccmul) = XK) => ((cco @ (XZ @ Xx3) @ XM @ ccmul) = XN)))) => (Xph => ((cwbr @ XJ @ XK @ ccdvds) => (cwbr @ XM @ XN @ ccdvds)))))))))))))).
