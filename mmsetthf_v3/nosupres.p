...
thf(aeqfunfv_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ XF) & (cwfun @ XG)) => ((XF = XG) <=> (((ccdm @ XF) = (ccdm @ XG)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : (ccdm @ XF))))))))).
thf(cnosupres_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) = (ccif @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccun @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccsn @ (ccop @ (ccdm @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ cc2o))) @ (ccmpt @ (^ [Xg1:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xu))) & (cwral @ (^ [Xv:$i] : ((~ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) => ((ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xy1))) = (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xy1)))))) @ (^ [Xv:$i] : XA2)))) @ (^ [Xu:$i] : XA2)))) @ (^ [Xg1:$i] : (ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xg1) @ (ccdm @ (ccv @ Xu))) & (cwral @ (^ [Xv:$i] : ((~ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) => ((ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xg1))) = (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xg1)))))) @ (^ [Xv:$i] : XA2)) & ((ccfv @ (ccv @ Xg1) @ (ccv @ Xu)) = (ccv @ Xx3)))) @ (^ [Xu:$i] : XA2))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (((~ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) & ((cwss @ XA2 @ ccsur) & (cwcel @ XA2 @ ccvv)) & ((cwcel @ (XU @ Xy1 @ Xg1) @ XA2) & (cwcel @ (XG @ Xx3 @ Xg1) @ (ccdm @ (XU @ Xy1 @ Xg1))) & (cwral @ (^ [Xv:$i] : ((~ (cwbr @ (ccv @ Xv) @ (XU @ Xy1 @ Xg1) @ ccslt)) => ((ccres @ (XU @ Xy1 @ Xg1) @ (ccsuc @ (XG @ Xx3 @ Xg1))) = (ccres @ (ccv @ Xv) @ (ccsuc @ (XG @ Xx3 @ Xg1)))))) @ (^ [Xv:$i] : XA2)))) => ((ccres @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ (ccsuc @ (XG @ Xx3 @ Xg1))) = (ccres @ (XU @ Xy1 @ Xg1) @ (ccsuc @ (XG @ Xx3 @ Xg1)))))))))))))))).
