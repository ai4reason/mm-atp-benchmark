...
thf(alzenom_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwbr @ (ccdif @ ccz @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ ccom @ ccen)))).
...
thf(amapco2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwcel @ XE @ ccvv) => (((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) & (cwf @ XE @ XC @ XD)) => (cwcel @ (cccom @ XA2 @ XD) @ (cco @ XB2 @ XE @ ccmap)))))))))).
...
thf(acoeq0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XC @ XD @ XA2) & (cwf @ XE @ XF @ XB2) & ((ccin @ XC @ XF) = cc0)) => ((cccom @ XA2 @ XB2) = cc0))))))))).
...
thf(aelmapresaun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XC @ XA2 @ ccmap)) & (cwcel @ XG @ (cco @ XC @ XB2 @ ccmap)) & ((ccres @ XF @ (ccin @ XA2 @ XB2)) = (ccres @ XG @ (ccin @ XA2 @ XB2)))) => (cwcel @ (ccun @ XF @ XG) @ (cco @ XC @ (ccun @ XA2 @ XB2) @ ccmap))))))))).
...
thf(cdiophren_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ (ccfv @ XN @ ccdioph)) & (cwcel @ XM @ ccn0) & (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XM @ ccfz) @ XF)) => (cwcel @ (ccrab @ (^ [Xa:$i] : (cwcel @ (cccom @ (ccv @ Xa) @ XF) @ XS)) @ (^ [Xa:$i] : (cco @ ccn0 @ (cco @ cc1 @ XM @ ccfz) @ ccmap))) @ (ccfv @ XM @ ccdioph)))))))).
