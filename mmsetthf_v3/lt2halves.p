...
thf(clt2halves_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => (((cwbr @ XA2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt) & (cwbr @ XB2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt))))))).
