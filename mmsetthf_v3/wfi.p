...
thf(cwfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwss @ XB2 @ XA2) & (cwral @ (^ [Xy1:$i] : ((cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ XB2) => (cwcel @ (ccv @ Xy1) @ XB2))) @ (^ [Xy1:$i] : XA2)))) => (XA2 = XB2)))))).
