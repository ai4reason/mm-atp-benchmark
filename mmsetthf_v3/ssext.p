...
thf(assextss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) <=> (! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) => (cwss @ (ccv @ Xx3) @ XB2))))))).
...
thf(cssext_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) <=> (! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) <=> (cwss @ (ccv @ Xx3) @ XB2))))))).
