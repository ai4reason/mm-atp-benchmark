...
thf(csuppvalbr_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XR @ (XV @ Xx3 @ Xy1)) & (cwcel @ XZ @ (XW @ Xx3 @ Xy1))) => ((cco @ XR @ XZ @ ccsupp) = (^ [Xx3:$i] : ((? [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR)) & (? [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) <=> ((ccv @ Xy1) != XZ)))))))))))))).
