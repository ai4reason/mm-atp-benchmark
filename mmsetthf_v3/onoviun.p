...
thf(aonovuni_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xy1:$i] : ((cwlim @ (ccv @ Xy1)) => ((cco @ XA2 @ (ccv @ Xy1) @ XF) = (cciun @ (^ [Xx3:$i] : (ccv @ Xy1)) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ XF)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccon0) & (cwcel @ (ccv @ Xy1) @ ccon0) & (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) => (cwss @ (cco @ XA2 @ (ccv @ Xx3) @ XF) @ (cco @ XA2 @ (ccv @ Xy1) @ XF))))) => (! [Xy1:$i] : (((cwcel @ XS @ (XT @ Xy1)) & (cwss @ XS @ ccon0) & (XS != cc0)) => ((cco @ XA2 @ (ccuni @ XS) @ XF) = (cciun @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ XF))))))))))))).
