...
thf(cvmcn_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((XC = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XM = (ccfv @ XU @ ccnsb)) => ((cwcel @ XU @ ccnv) => (cwcel @ XM @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))))).
