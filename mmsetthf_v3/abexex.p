...
thf(cabexex_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (ccv @ Xx3) @ XA2)))) => ((! [Xx3:$i] : (cwcel @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ ccvv)) => (cwcel @ (^ [Xy1:$i] : (? [Xx3:$i] : (Xph @ Xx3 @ Xy1))) @ ccvv))))))).
