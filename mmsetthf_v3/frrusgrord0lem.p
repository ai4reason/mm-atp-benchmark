...
thf(cfrrusgrord0lem_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwcel @ XG @ ccfrgr) & (cwcel @ XV @ ccfn) & (XV != cc0)) & (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) = XK)) @ (^ [Xv:$i] : XV))) => ((cwcel @ XK @ ccc) & (cwcel @ (ccfv @ XV @ cchash) @ ccc) & ((ccfv @ XV @ cchash) != ccc0)))))))).
