...
thf(aac6s_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xf1)))))) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) => (? [Xf1:$i] : ((cwf @ (XA2 @ Xy1) @ XB2 @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xf1)) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))))))))))).
thf(aeleq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwcel @ XC @ XA2) <=> (cwcel @ XC @ XB2))))))))).
thf(cacunirnmpt2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3 @ Xf1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XA2)) => ((XB2 @ Xx3 @ Xj) != cc0)))) => ((! [Xx3:$i] : (XC = (ccuni @ (ccrn @ (ccmpt @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xx3 @ Xj))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (((ccv @ Xj) = (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) => ((XB2 @ Xx3 @ Xj) = (XD @ Xx3 @ Xf1)))))) => (Xph => (? [Xf1:$i] : ((cwf @ XC @ XA2 @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XD @ Xx3 @ Xf1))) @ (^ [Xx3:$i] : XC)))))))))))))))).
