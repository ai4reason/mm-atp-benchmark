...
thf(a_0elsiga_thm,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) => (cwcel @ cc0 @ XS)))).
...
thf(avolfiniune_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xn:$i] : (cwcel @ (XB2 @ Xn) @ (ccdm @ ccvol))) @ (^ [Xn:$i] : XA2)) & (cwdisj @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn)))) => ((ccfv @ (cciun @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccvol) = (ccesum @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccfv @ (XB2 @ Xn) @ ccvol)))))))).
...
thf(avoliune_thm,axiom,(! [XA2:($i > ($i > $o))] : (((cwral @ (^ [Xn:$i] : (cwcel @ (XA2 @ Xn) @ (ccdm @ ccvol))) @ (^ [Xn:$i] : ccn)) & (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn)))) => ((ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccvol) = (ccesum @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccvol))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(asyl6eqr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XC = XB2) => (Xph => (XA2 = XC))))))))).
thf(aiunrdx_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwfo @ XA2 @ XC @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF))) => ((XD @ Xy1) = (XB2 @ Xx3))))) => (Xph => ((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))))).
...
thf(cvolmeas_conj,conjecture,(cwcel @ ccvol @ (ccfv @ (ccdm @ ccvol) @ ccmeas))).
