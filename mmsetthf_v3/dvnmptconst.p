...
thf(cdvnmptconst_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XN @ Xx3) @ ccn))) => (! [Xx3:$i] : (Xph => ((ccfv @ (XN @ Xx3) @ (cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : XA2)) @ ccdvn)) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : ccc0))))))))))))))).
