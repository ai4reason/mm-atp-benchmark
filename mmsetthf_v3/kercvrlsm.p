...
thf(aghmeqker_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XT @ cc0g)) => ((XK = (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((Xc_mi = (ccfv @ XS @ ccsg)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XU @ XB2) & (cwcel @ XV @ XB2)) => (((ccfv @ XU @ XF) = (ccfv @ XV @ XF)) <=> (cwcel @ (cco @ XU @ XV @ Xc_mi) @ XK))))))))))))))))).
thf(asimplrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & (Xps & Xch)) & Xth) => Xch)))))).
thf(alsmelvalix_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((((cwcel @ XG @ XV) & (cwss @ XT @ XB2) & (cwss @ XU @ XB2)) & ((cwcel @ XX @ XT) & (cwcel @ XY @ XU))) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XT @ XU @ Xc_po)))))))))))))))).
thf(ckercvrlsm_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((XU = (ccfv @ XS @ cclss)) => ((Xc_po = (ccfv @ XS @ cclsm)) => ((Xc_0 = (ccfv @ XT @ cc0g)) => ((XK = (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XF @ (cco @ XS @ XT @ cclmhm))) => ((Xph => (cwcel @ XD @ XU)) => ((Xph => ((ccima @ XF @ XD) = (ccrn @ XF))) => (Xph => ((cco @ XK @ XD @ Xc_po) = XB2))))))))))))))))))))).
