...
thf(choicvr_conj,conjecture,(! [Xph:$o] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XI @ Xx3 @ Xi @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (ccneg @ (ccv @ Xj)) @ (ccv @ Xj)))))))))) => ((Xph => (cwcel @ XX @ ccfn)) => (! [Xx3:$i] : (Xph => (cwss @ (cco @ ccr @ XX @ ccmap) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (XI @ Xx3 @ Xi @ Xj))))))))))))))))).
