...
thf(cpf1const_conj,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XQ = (ccrn @ (ccfv @ XR @ cce1))) => (((cwcel @ XR @ cccrg) & (cwcel @ XX @ XB2)) => (cwcel @ (ccxp @ XB2 @ (ccsn @ XX)) @ XQ))))))))).
