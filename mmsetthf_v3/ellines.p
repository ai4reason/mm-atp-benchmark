...
thf(cellines_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cclines2) <=> (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (((ccv @ Xp) != (ccv @ Xq)) & (XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccline2)))) @ (^ [Xq:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xn:$i] : ccn))))).
