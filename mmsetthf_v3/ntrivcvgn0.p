...
thf(cntrivcvgn0_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : ((XZ @ Xy1) = (ccfv @ XM @ ccuz))) => ((! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xn) => (cwcel @ XM @ ccz)))) => ((! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xn) => (cwbr @ (ccseq @ ccmul @ XF @ XM) @ (XX @ Xn) @ ccli)))) => ((! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xn) => ((XX @ Xn) != ccc0)))) => (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xn) => (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : (((ccv @ Xy1) != ccc0) & (cwbr @ (ccseq @ ccmul @ XF @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (XZ @ Xy1)))))))))))))))).
