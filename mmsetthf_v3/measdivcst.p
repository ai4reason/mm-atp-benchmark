...
thf(aofcfval3_thm,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XF @ (XV @ Xx3)) & (cwcel @ XC @ (XW @ Xx3))) => ((cco @ XF @ XC @ (ccofc @ XR)) = (ccmpt @ (^ [Xx3:$i] : (ccdm @ XF)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ XC @ XR)))))))))))).
...
thf(aesumdivc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cco @ (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XC @ ccxdiv) = (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XC @ ccxdiv)))))))))))))).
