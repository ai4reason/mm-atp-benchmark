...
thf(ahomacd_thm,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((cwcel @ XF @ (cco @ XX @ XY @ XH)) => ((ccfv @ XF @ cccoda) = XY))))))))).
...
thf(ccoaval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_x = (ccfv @ XC @ cccoa)) => ((XH = (ccfv @ XC @ cchoma)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ XH))) => ((Xc_xb = (ccfv @ XC @ ccco)) => (Xph => ((cco @ XG @ XF @ Xc_x) = (ccotp @ XX @ XZ @ (cco @ (ccfv @ XG @ cc2nd) @ (ccfv @ XF @ cc2nd) @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_xb))))))))))))))))))))).
