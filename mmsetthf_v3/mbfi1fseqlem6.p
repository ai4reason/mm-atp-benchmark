...
thf(ambfi1fseqlem4_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : (Xph => (cwf @ ccn @ (ccdm @ ccitg1) @ (XG @ Xy1 @ Xm)))))))))))))).
thf(aralrimiva_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (Xps @ Xx3))) => (Xph => (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
thf(ambfi1fseqlem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : ((Xph & (cwcel @ XA2 @ ccn)) => ((cwbr @ cc0p @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)) @ (ccofr @ ccle)) & (cwbr @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ (XG @ Xy1 @ Xm)) @ (ccofr @ ccle)))))))))))))))).
