...
thf(astaffval_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_as = (ccfv @ XR @ ccstv)) => ((! [Xx3:$i] : ((Xc_xb @ Xx3) = (ccfv @ XR @ ccstf))) => (! [Xx3:$i] : ((Xc_xb @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ Xc_as))))))))))))).
...
thf(aissrng_thm,axiom,(! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppr)) => ((Xc_as = (ccfv @ XR @ ccstf)) => ((cwcel @ XR @ ccsr) <=> ((cwcel @ Xc_as @ (cco @ XR @ XO @ ccrh)) & (Xc_as = (cccnv @ Xc_as)))))))))).
thf(cissrngd_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : ((Xph => (XK = (ccfv @ XR @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((Xc_pl @ Xx3 @ Xy1) = (ccfv @ XR @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XR @ ccmulr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((Xc_as @ Xx3 @ Xy1) = (ccfv @ XR @ ccstv))))) => ((Xph => (cwcel @ XR @ ccrg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XK)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (Xc_as @ Xx3 @ Xy1)) @ XK)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XK) & (cwcel @ (ccv @ Xy1) @ XK)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1)) @ (Xc_as @ Xx3 @ Xy1)) = (cco @ (ccfv @ (ccv @ Xx3) @ (Xc_as @ Xx3 @ Xy1)) @ (ccfv @ (ccv @ Xy1) @ (Xc_as @ Xx3 @ Xy1)) @ (Xc_pl @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XK) & (cwcel @ (ccv @ Xy1) @ XK)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) @ (Xc_as @ Xx3 @ Xy1)) = (cco @ (ccfv @ (ccv @ Xy1) @ (Xc_as @ Xx3 @ Xy1)) @ (ccfv @ (ccv @ Xx3) @ (Xc_as @ Xx3 @ Xy1)) @ (Xc_x @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XK)) => ((ccfv @ (ccfv @ (ccv @ Xx3) @ (Xc_as @ Xx3 @ Xy1)) @ (Xc_as @ Xx3 @ Xy1)) = (ccv @ Xx3))))) => (Xph => (cwcel @ XR @ ccsr)))))))))))))))))).
