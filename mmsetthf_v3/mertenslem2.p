...
thf(aisumge0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccr))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ ccc0 @ (XA2 @ Xk) @ ccle))) => (Xph => (cwbr @ ccc0 @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccle)))))))))))))).
...
thf(aclimi0_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : (Xph => (cwcel @ (XM @ Xk) @ ccz))) => ((Xph => (cwcel @ XC @ ccrp)) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XB2 @ Xj @ Xk))))) => ((Xph => (cwbr @ XF @ ccc0 @ ccli)) => (Xph => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (XB2 @ Xj @ Xk) @ ccabs) @ XC @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))))))))))))))).
...
thf(aserf0_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => (Xph => (cwbr @ XF @ ccc0 @ ccli))))))))))))).
...
thf(amertenslem1_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XK:($i > ($i > $o))] : ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (((Xph @ Xw @ Xt @ Xn @ Xs1) & (cwcel @ (ccv @ Xj) @ ccn0)) => ((ccfv @ (ccv @ Xj) @ (XF @ Xz @ Xw @ Xt @ Xk @ Xs1)) = (XA2 @ Xz @ Xw @ Xj)))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xs1:$i] : (((Xph @ Xw @ Xt @ Xn @ Xs1) & (cwcel @ (ccv @ Xj) @ ccn0)) => ((ccfv @ (ccv @ Xj) @ (XK @ Xw)) = (ccfv @ (XA2 @ Xz @ Xw @ Xj) @ ccabs))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xs1:$i] : (((Xph @ Xw @ Xt @ Xn @ Xs1) & (cwcel @ (ccv @ Xj) @ ccn0)) => (cwcel @ (XA2 @ Xz @ Xw @ Xj) @ ccc)))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (((Xph @ Xw @ Xt @ Xn @ Xs1) & (cwcel @ (ccv @ Xk) @ ccn0)) => ((ccfv @ (ccv @ Xk) @ (XG @ Xw @ Xt)) = (XB2 @ Xw @ Xk)))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (((Xph @ Xw @ Xt @ Xn @ Xs1) & (cwcel @ (ccv @ Xk) @ ccn0)) => (cwcel @ (XB2 @ Xw @ Xk) @ ccc))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (((Xph @ Xw @ Xt @ Xn @ Xs1) & (cwcel @ (ccv @ Xk) @ ccn0)) => ((ccfv @ (ccv @ Xk) @ (XH @ Xz @ Xw @ Xt @ Xj @ Xn @ Xs1)) = (ccsu @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (^ [Xj:$i] : (cco @ (XA2 @ Xz @ Xw @ Xj) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ ccmin) @ (XG @ Xw @ Xt)) @ ccmul)))))))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xw @ Xt @ Xn @ Xs1) => (cwcel @ (ccseq @ ccaddc @ (XK @ Xw) @ ccc0) @ (ccdm @ ccli))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xw @ Xt @ Xn @ Xs1) => (cwcel @ (ccseq @ ccaddc @ (XG @ Xw @ Xt) @ ccc0) @ (ccdm @ ccli))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xw @ Xt @ Xn @ Xs1) => (cwcel @ (XE @ Xw) @ ccrp)))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XT @ Xs1) = (^ [Xz:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xz) = (ccfv @ (ccsu @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XG @ Xw @ Xt)))) @ ccabs))) @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xs1) @ cc1 @ ccmin) @ ccfz)))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((Xps @ Xw @ Xs1) <=> ((cwcel @ (ccv @ Xs1) @ ccn) & (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccsu @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XG @ Xw @ Xt)))) @ ccabs) @ (cco @ (cco @ (XE @ Xw) @ cc2 @ ccdiv) @ (cco @ (ccsu @ ccn0 @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (XK @ Xw)))) @ cc1 @ ccaddc) @ ccdiv) @ cclt)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xs1) @ ccuz)))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xw @ Xt @ Xn @ Xs1) => ((Xps @ Xw @ Xs1) & ((cwcel @ (ccv @ Xt) @ ccn0) & (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ (XK @ Xw)) @ (cco @ (cco @ (cco @ (XE @ Xw) @ cc2 @ ccdiv) @ (ccv @ Xs1) @ ccdiv) @ (cco @ (ccsup @ (XT @ Xs1) @ ccr @ cclt) @ cc1 @ ccaddc) @ ccdiv) @ cclt)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xt) @ ccuz)))))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xw @ Xt @ Xn @ Xs1) => ((cwbr @ ccc0 @ (ccsup @ (XT @ Xs1) @ ccr @ cclt) @ ccle) & ((cwss @ (XT @ Xs1) @ ccr) & ((XT @ Xs1) != cc0) & (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ ccle)) @ (^ [Xw:$i] : (XT @ Xs1)))) @ (^ [Xz:$i] : ccr))))))))) => (! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xw @ Xt @ Xn @ Xs1) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccsu @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ (^ [Xj:$i] : (cco @ (XA2 @ Xz @ Xw @ Xj) @ (ccsu @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ (ccv @ Xj) @ ccmin) @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (XB2 @ Xw @ Xk))) @ ccmul))) @ ccabs) @ (XE @ Xw) @ cclt)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn0)))))))))))))))))))))))))))))))).
thf(abiimpi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> Xps) => (Xph => Xps))))).
thf(aanbi2i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xch & Xph) <=> (Xch & Xps))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => Xch) => (Xph => (Xps & Xch)))))))).
thf(cmertenslem2_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > $o)] : ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ ccn0)) => ((ccfv @ (ccv @ Xj) @ (XF @ Xz @ Xk @ Xs1)) = (XA2 @ Xz @ Xj))))))) => ((! [Xz:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ ccn0)) => ((ccfv @ (ccv @ Xj) @ XK) = (ccfv @ (XA2 @ Xz @ Xj) @ ccabs))))) => ((! [Xz:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ ccn0)) => (cwcel @ (XA2 @ Xz @ Xj) @ ccc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => ((ccfv @ (ccv @ Xk) @ XG) = (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => ((ccfv @ (ccv @ Xk) @ (XH @ Xz @ Xj @ Xn @ Xs1)) = (ccsu @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (^ [Xj:$i] : (cco @ (XA2 @ Xz @ Xj) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ ccmin) @ XG) @ ccmul)))))))))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XK @ ccc0) @ (ccdm @ ccli))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XG @ ccc0) @ (ccdm @ ccli))) => ((Xph => (cwcel @ XE @ ccrp)) => ((! [Xs1:$i] : ((XT @ Xs1) = (^ [Xz:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xz) = (ccfv @ (ccsu @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XG))) @ ccabs))) @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xs1) @ cc1 @ ccmin) @ ccfz)))))) => ((! [Xs1:$i] : ((Xps @ Xs1) <=> ((cwcel @ (ccv @ Xs1) @ ccn) & (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccsu @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XG))) @ ccabs) @ (cco @ (cco @ XE @ cc2 @ ccdiv) @ (cco @ (ccsu @ ccn0 @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ XK))) @ cc1 @ ccaddc) @ ccdiv) @ cclt)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xs1) @ ccuz)))))) => (! [Xz:$i] : (Xph => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccsu @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ (^ [Xj:$i] : (cco @ (XA2 @ Xz @ Xj) @ (ccsu @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ (ccv @ Xj) @ ccmin) @ cc1 @ ccaddc) @ ccuz) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccmul))) @ ccabs) @ XE @ cclt)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn0)))))))))))))))))))))))))).
