...
thf(crhmsscrnghm_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((Xph => (XS = (ccin @ ccrng @ XU))) => (Xph => (cwbr @ (ccres @ ccrh @ (ccxp @ XR @ XR)) @ (ccres @ ccrngh @ (ccxp @ XS @ XS)) @ ccssc))))))))))).
