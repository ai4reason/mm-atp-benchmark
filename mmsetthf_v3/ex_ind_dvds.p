...
thf(advds2subd_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwbr @ XK @ XM @ ccdvds)) => ((Xph => (cwbr @ XK @ XN @ ccdvds)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => (cwbr @ XK @ (cco @ XM @ XN @ ccmin) @ ccdvds)))))))))))).
...
thf(cex_ind_dvds_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ cc3 @ (cco @ (cco @ cc4 @ XN @ ccexp) @ cc2 @ ccaddc) @ ccdvds)))).
