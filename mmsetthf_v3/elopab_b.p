...
thf(aexlimivv_b_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : ((! [Xx3:$i] : ((Xph @ Xx3) => Xps)) => ((? [Xx3:$i] : (? [Xx3:$i] : (Xph @ Xx3))) => Xps))))).
...
thf(a_2exbidv_b_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : ((! [Xx3:$i] : (Xph => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => (Xph => ((? [Xx3:$i] : (? [Xx3:$i] : (Xps @ Xx3))) <=> (? [Xx3:$i] : (? [Xx3:$i] : (Xch @ Xx3)))))))))).
...
thf(adf_opab_b_ax,axiom,(! [Xph:($i > $o)] : ((ccopab_b @ (^ [Xx3:$i] : (Xph @ Xx3))) = (^ [Xz:$i] : (? [Xx3:$i] : (? [Xx3:$i] : (((ccv @ Xz) = (ccop @ (ccv @ Xx3) @ (ccv @ Xx3))) & (Xph @ Xx3)))))))).
thf(celopab_b_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccopab_b @ (^ [Xx3:$i] : (Xph @ Xx3)))) <=> (? [Xx3:$i] : (? [Xx3:$i] : ((XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xx3))) & (Xph @ Xx3)))))))).
