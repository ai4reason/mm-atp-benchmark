...
thf(cchirredlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccch) => (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => (((((cwcel @ (ccv @ Xp) @ ccat) & (cwss @ (ccv @ Xp) @ XA2)) & ((cwcel @ (ccv @ Xq) @ ccat) & (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) & ((cwcel @ (ccv @ Xr) @ ccat) & (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) => (((ccv @ Xr) = (ccv @ Xp)) | ((ccv @ Xr) = (ccv @ Xq))))))))))).
