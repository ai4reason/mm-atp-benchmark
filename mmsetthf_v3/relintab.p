...
thf(crelintab_conj,conjecture,(! [Xph:($i > $o)] : ((cwrel @ (ccint @ (^ [Xx3:$i] : (Xph @ Xx3)))) => ((ccint @ (^ [Xx3:$i] : (Xph @ Xx3))) = (ccint @ (ccrab @ (^ [Xw:$i] : (? [Xx3:$i] : (((ccv @ Xw) = (cccnv @ (cccnv @ (ccv @ Xx3)))) & (Xph @ Xx3)))) @ (^ [Xw:$i] : (ccpw @ (ccxp @ ccvv @ ccvv))))))))).
