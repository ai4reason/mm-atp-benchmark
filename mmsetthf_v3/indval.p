...
thf(cindval_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XO @ (XV @ Xx3)) & (cwss @ XA2 @ XO)) => ((ccfv @ XA2 @ (ccfv @ XO @ ccind)) = (ccmpt @ (^ [Xx3:$i] : XO) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0)))))))))).
