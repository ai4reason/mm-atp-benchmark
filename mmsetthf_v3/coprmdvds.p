...
thf(ccoprmdvds_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (((cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds) & ((cco @ XK @ XM @ ccgcd) = cc1)) => (cwbr @ XK @ XN @ ccdvds))))))).
