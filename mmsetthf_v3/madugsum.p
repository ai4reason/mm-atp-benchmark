...
thf(amdetr0_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ XR @ ccmdat)))) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XN) & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XX @ Xi @ Xj) @ XK)))) => ((Xph => (cwcel @ XI @ XN)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ Xc_0 @ (XX @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) = Xc_0)))))))))))))))))))).
...
thf(afovrnda_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ (ccxp @ XR @ XS) @ XC @ XF)) => ((Xph & ((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS))) => (cwcel @ (cco @ XA2 @ XB2 @ XF) @ XC))))))))))).
...
thf(amndifsplit_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XA2 @ XB2) & (~ (Xph & Xps))) => ((ccif @ (Xph | Xps) @ XA2 @ Xc_0) = (cco @ (ccif @ Xph @ XA2 @ Xc_0) @ (ccif @ Xps @ XA2 @ Xc_0) @ Xc_pl)))))))))))))).
...
thf(amdetrlin2_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat)))) => ((! [Xi:$i] : (! [Xj:$i] : (XK = (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_pl = (ccfv @ (XR @ Xi @ Xj) @ ccplusg)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XR @ Xi @ Xj) @ cccrg)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XN) & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XX @ Xi @ Xj) @ XK)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XN) & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XY @ Xi @ Xj) @ XK)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XN) & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XZ @ Xi @ Xj) @ XK)))) => ((Xph => (cwcel @ XI @ XN)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (cco @ (XX @ Xi @ Xj) @ (XY @ Xi @ Xj) @ Xc_pl) @ (XZ @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) = (cco @ (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (XX @ Xi @ Xj) @ (XZ @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) @ (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (XY @ Xi @ Xj) @ (XZ @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) @ Xc_pl))))))))))))))))))))))))).
...
thf(cmadugsum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (cco @ XN @ XR @ ccmat)))) => ((! [Xj:$i] : ((XJ @ Xj) = (cco @ XN @ XR @ ccmadu))) => ((! [Xi:$i] : (! [Xj:$i] : (XB2 = (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ XR @ ccmdat)))) => ((! [Xj:$i] : ((Xc_x @ Xj) = (ccfv @ XR @ ccmulr))) => ((XK = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XM @ XB2)) => ((Xph => (cwcel @ XR @ cccrg)) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XN)) => (cwcel @ (XX @ Xi) @ XK))) => ((Xph => (cwcel @ XL @ XN)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((cco @ XR @ (ccmpt @ (^ [Xi:$i] : XN) @ (^ [Xi:$i] : (cco @ (XX @ Xi) @ (cco @ (ccv @ Xi) @ XL @ (ccfv @ XM @ (XJ @ Xj))) @ (Xc_x @ Xj)))) @ ccgsu) = (ccfv @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xi:$i] : XN)) @ (^ [Xj:$i] : (^ [Xi:$i] : XN)) @ (^ [Xj:$i] : (^ [Xi:$i] : (ccif @ ((ccv @ Xj) = XL) @ (XX @ Xi) @ (cco @ (ccv @ Xj) @ (ccv @ Xi) @ XM))))) @ (XD @ Xi @ Xj))))))))))))))))))))))))))))).
