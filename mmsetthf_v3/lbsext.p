...
thf(albsextg_thm,axiom,(! [XC:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XW @ cclbs))) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ XW @ ccbs))) => ((XN = (ccfv @ XW @ cclspn)) => (! [Xx3:$i] : ((((cwcel @ XW @ cclvec) & (cwcel @ (ccpw @ (XV @ Xx3)) @ (ccdm @ cccrd))) & (cwss @ XC @ (XV @ Xx3)) & (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XC @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : XC))) => (cwrex @ (^ [Xs1:$i] : (cwss @ XC @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (XJ @ Xx3)))))))))))))).
thf(clbsext_conj,conjecture,(! [XC:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XW @ cclbs))) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ XW @ ccbs))) => ((XN = (ccfv @ XW @ cclspn)) => (! [Xx3:$i] : (((cwcel @ XW @ cclvec) & (cwss @ XC @ (XV @ Xx3)) & (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XC @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : XC))) => (cwrex @ (^ [Xs1:$i] : (cwss @ XC @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (XJ @ Xx3)))))))))))))).
