...
thf(ciccintsng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & ((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ XB2 @ XC @ ccle))) => ((ccin @ (cco @ XA2 @ XB2 @ ccicc) @ (cco @ XB2 @ XC @ ccicc)) = (ccsn @ XB2))))))).
