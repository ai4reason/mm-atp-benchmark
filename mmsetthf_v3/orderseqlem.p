...
thf(corderseqlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XF @ Xx3 @ Xf1) = (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwf @ (ccv @ Xx3) @ XA2 @ (ccv @ Xf1))) @ (^ [Xx3:$i] : ccon0)))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((cwcel @ XG @ (XF @ Xx3 @ Xf1)) => (cwcel @ (ccfv @ (XX @ Xf1) @ XG) @ (ccun @ XA2 @ (ccsn @ cc0)))))))))))).
