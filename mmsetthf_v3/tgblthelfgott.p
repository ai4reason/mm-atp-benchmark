...
thf(ctgblthelfgott_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccodd) & (cwbr @ cc7 @ XN @ cclt) & (cwbr @ XN @ (cco @ (ccdc @ cc8 @ cc8) @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul) @ cclt)) => (cwcel @ XN @ ccgbo)))).
