...
thf(c_1odd_conj,conjecture,(! [XO:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XO @ Xx3 @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (cco @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => (! [Xx3:$i] : (! [Xz:$i] : (cwcel @ cc1 @ (XO @ Xx3 @ Xz))))))).
