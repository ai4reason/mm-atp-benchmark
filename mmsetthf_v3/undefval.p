...
thf(adf_undef_ax,axiom,(ccund = (ccmpt @ (^ [Xs1:$i] : ccvv) @ (^ [Xs1:$i] : (ccpw @ (ccuni @ (ccv @ Xs1))))))).
thf(cundefval_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => ((ccfv @ XS @ ccund) = (ccpw @ (ccuni @ XS))))))).
