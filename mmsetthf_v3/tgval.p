...
thf(adf_topgen_ax,axiom,(cctg = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwss @ (ccv @ Xy1) @ (ccuni @ (ccin @ (ccv @ Xx3) @ (ccpw @ (ccv @ Xy1)))))))))).
thf(ctgval_conj,conjecture,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((ccfv @ XB2 @ cctg) = (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccuni @ (ccin @ XB2 @ (ccpw @ (ccv @ Xx3))))))))))).
