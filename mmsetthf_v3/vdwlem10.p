...
thf(avdwlem8_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ (XR @ Xx3) @ ccfn))) => ((Xph => (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XW @ ccn)) => ((! [Xx3:$i] : (Xph => (cwf @ (cco @ cc1 @ (cco @ cc2 @ XW @ ccmul) @ ccfz) @ (XR @ Xx3) @ XF))) => ((cwcel @ XC @ ccvv) => ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XD @ ccn)) => ((! [Xx3:$i] : (Xph => (cwss @ (cco @ XA2 @ XD @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ (XG @ Xx3)) @ (ccsn @ XC))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XW @ ccfz)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XW @ ccaddc) @ XF))))) => (Xph => (cwbr @ (ccop @ cc1 @ XK) @ XF @ ccvdwp))))))))))))))))))))).
...
thf(cvdwlem10_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XR @ ccfn))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XK @ (ccfv @ cc2 @ ccuz)))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwbr @ XK @ (ccv @ Xf1) @ ccvdwm)) @ (^ [Xf1:$i] : (cco @ (ccv @ Xs1) @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))) @ (^ [Xs1:$i] : ccfn)))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ (XM @ Xs1) @ ccn))) => (! [Xs1:$i] : ((Xph @ Xs1) => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : ((cwbr @ (ccop @ (XM @ Xs1) @ XK) @ (ccv @ Xf1) @ ccvdwp) | (cwbr @ (cco @ XK @ cc1 @ ccaddc) @ (ccv @ Xf1) @ ccvdwm))) @ (^ [Xf1:$i] : (cco @ XR @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))))))))))))).
