...
thf(axlimclim2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccxr @ XF)) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => ((cwbr @ XF @ XA2 @ cclsxlim) <=> (cwbr @ XF @ XA2 @ ccli))))))))))))).
...
thf(aclimxlim2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccxr @ XF)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => (Xph => (cwbr @ XF @ XA2 @ cclsxlim)))))))))))).
...
thf(cdfxlim2v_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (cwcel @ (XM @ Xx3 @ Xj @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xj @ Xk) @ ccuz))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ XZ @ ccxr @ XF))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwbr @ XF @ (XA2 @ Xx3) @ cclsxlim) <=> ((cwbr @ XF @ (XA2 @ Xx3) @ ccli) | (((XA2 @ Xx3) = ccmnf) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xx3) @ ccle)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr))) | (((XA2 @ Xx3) = ccpnf) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ XF) @ ccle)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))))))).
