...
thf(caxdc2lem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((! [Xy1:$i] : (! [Xg1:$i] : (! [Xk:$i] : ((XR @ Xy1 @ Xg1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xk)) & (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xk))))))))))) => ((! [Xh:$i] : ((XG @ Xh) = (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xh)))))) => (! [Xk:$i] : ((((XA2 @ Xk) != cc0) & (cwf @ (XA2 @ Xk) @ (ccdif @ (ccpw @ (XA2 @ Xk)) @ (ccsn @ cc0)) @ (XF @ Xk))) => (? [Xg1:$i] : ((cwf @ ccom @ (XA2 @ Xk) @ (ccv @ Xg1)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (XF @ Xk)))) @ (^ [Xk:$i] : ccom)))))))))))))).
