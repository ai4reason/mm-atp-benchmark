...
thf(aefgt1p2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccaddc) @ (ccfv @ XA2 @ cce) @ cclt)))).
...
thf(ccxp2limlem_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ cclt)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (cco @ XA2 @ (ccv @ Xn) @ cccxp) @ ccdiv))) @ ccc0 @ ccrli)))).
