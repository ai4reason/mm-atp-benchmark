...
thf(abnj89_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : (cwcel @ (XZ @ Xy1) @ ccvv)) => (! [Xy1:$i] : ((cwsbc @ (^ [Xy1:$i] : (cweu @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) @ (XZ @ Xy1)) <=> (cweu @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (XZ @ Xy1)))))))))).
...
thf(cbnj130_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xbnjwphm:($i > ($i > ($i > $o)))] : (! [Xbnjwpsm:($i > ($i > ($i > $o)))] : (! [Xbnjwthm:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xth @ Xx3 @ Xf1 @ Xn) <=> (((cw_bnj15 @ (XA2 @ Xx3 @ Xf1) @ (XR @ Xx3 @ Xf1)) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xf1))) => (cweu @ (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) & (Xph @ Xx3 @ Xf1 @ Xn) & (Xps @ Xx3 @ Xf1 @ Xn))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xbnjwphm @ Xx3 @ Xf1 @ Xn) <=> (cwsbc @ (^ [Xn:$i] : (Xph @ Xx3 @ Xf1 @ Xn)) @ cc1o))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xbnjwpsm @ Xx3 @ Xf1 @ Xn) <=> (cwsbc @ (^ [Xn:$i] : (Xps @ Xx3 @ Xf1 @ Xn)) @ cc1o))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xbnjwthm @ Xx3 @ Xf1 @ Xn) <=> (cwsbc @ (^ [Xn:$i] : (Xth @ Xx3 @ Xf1 @ Xn)) @ cc1o))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xbnjwthm @ Xx3 @ Xf1 @ Xn) <=> (((cw_bnj15 @ (XA2 @ Xx3 @ Xf1) @ (XR @ Xx3 @ Xf1)) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xf1))) => (cweu @ (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ cc1o) & (Xbnjwphm @ Xx3 @ Xf1 @ Xn) & (Xbnjwpsm @ Xx3 @ Xf1 @ Xn)))))))))))))))))))))).
