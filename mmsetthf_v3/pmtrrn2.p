...
thf(cpmtrrn2_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & (XF = (ccfv @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XT)))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD)))))))))).
