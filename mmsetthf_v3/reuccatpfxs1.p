...
thf(creuccatpfxs1_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccword @ XV)) & ((ccfv @ (ccv @ Xx3) @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : XX))) => ((cwreu @ (^ [Xv:$i] : (cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xv)) @ ccconcat) @ XX)) @ (^ [Xv:$i] : XV)) => (cwreu @ (^ [Xw:$i] : (XW = (cco @ (ccv @ Xw) @ (ccfv @ XW @ cchash) @ ccpfx))) @ (^ [Xw:$i] : XX)))))))).
