...
thf(crlim2lt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwral @ (^ [Xz:$i] : (cwcel @ (XB2 @ Xz) @ ccc)) @ (^ [Xz:$i] : XA2)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwss @ XA2 @ ccr))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XC @ ccc))) => (! [Xz:$i] : ((Xph @ Xz) => ((cwbr @ (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (XB2 @ Xz))) @ XC @ ccrli) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt) => (cwbr @ (ccfv @ (cco @ (XB2 @ Xz) @ XC @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccrp))))))))))))).
