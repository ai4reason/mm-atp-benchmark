...
thf(aovolval4_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwss @ XA2 @ ccr))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XM @ Xy1 @ Xf1) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xy1) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr))))) => (! [Xy1:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XA2 @ ccovol) = (ccinf @ (XM @ Xy1 @ Xf1) @ ccxr @ cclt))))))))))).
...
thf(aovolval5lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xf1:$i] : ((XM @ Xf1) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccico @ (ccv @ Xf1))))) & ((ccv @ Xy1) = (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr)))) => ((XQ = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xz) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))) => (! [Xf1:$i] : ((ccinf @ XQ @ ccxr @ cclt) = (ccinf @ (XM @ Xf1) @ ccxr @ cclt))))))))).
