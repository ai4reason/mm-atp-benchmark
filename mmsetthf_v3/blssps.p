...
thf(ablrnps_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => ((cwcel @ XA2 @ (ccrn @ (ccfv @ XD @ ccbl))) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XA2 = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)))) @ (^ [Xr:$i] : ccxr))) @ (^ [Xx3:$i] : XX)))))))).
...
thf(ablss2ps_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XP @ XX) & (cwcel @ XQ @ XX)) & ((cwcel @ XR @ ccr) & (cwcel @ XS @ ccr) & (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ XR @ ccmin) @ ccle))) => (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))).
...
thf(assblps_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XP @ XX)) & ((cwcel @ XR @ ccxr) & (cwcel @ XS @ ccxr)) & (cwbr @ XR @ XS @ ccle)) => (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl)))))))))).
...
thf(cblssps_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XB2 @ (ccrn @ (ccfv @ XD @ ccbl))) & (cwcel @ XP @ XB2)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ XB2)) @ (^ [Xx3:$i] : ccrp)))))))).
