...
thf(cablfac1eu_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : ((! [Xw:$i] : (XB2 = (ccfv @ (XG @ Xw) @ ccbs))) => ((! [Xw:$i] : ((XO @ Xw) = (ccfv @ (XG @ Xw) @ ccod))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xw @ Xp) = (ccmpt @ (^ [Xp:$i] : (XA2 @ Xw)) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xw)) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2)))))))) => ((! [Xw:$i] : (Xph => (cwcel @ (XG @ Xw) @ ccabl))) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xw:$i] : (Xph => (cwss @ (XA2 @ Xw) @ ccprime))) => ((! [Xw:$i] : ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccfv @ XB2 @ cchash) @ ccdvds)) @ (^ [Xw:$i] : ccprime)))) => ((! [Xw:$i] : (Xph => (cwss @ (XD @ Xw) @ (XA2 @ Xw)))) => ((! [Xw:$i] : (! [Xp:$i] : (Xph => ((cwbr @ (XG @ Xw) @ (XT @ Xw @ Xp) @ (ccdm @ ccdprd)) & ((cco @ (XG @ Xw) @ (XT @ Xw @ Xp) @ ccdprd) = XB2))))) => ((! [Xw:$i] : (! [Xp:$i] : (Xph => ((ccdm @ (XT @ Xw @ Xp)) = (XA2 @ Xw))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xph & (cwcel @ (ccv @ Xq) @ (XA2 @ Xw))) => (cwcel @ (XC @ Xx3 @ Xw @ Xq @ Xp) @ ccn0)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xph & (cwcel @ (ccv @ Xq) @ (XA2 @ Xw))) => ((ccfv @ (ccfv @ (ccv @ Xq) @ (XT @ Xw @ Xp)) @ cchash) = (cco @ (ccv @ Xq) @ (XC @ Xx3 @ Xw @ Xq @ Xp) @ ccexp))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : (Xph => ((XT @ Xw @ Xp) = (XS @ Xx3 @ Xw @ Xp)))))))))))))))))))))))))))).
