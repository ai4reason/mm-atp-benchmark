...
thf(adveeq2_b_thm,axiom,(! [Xx3:$i] : (! [Xz:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))) => (((ccv @ Xz) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xz) = (ccv @ Xx3)))))))).
...
thf(caxc15_b_conj,conjecture,(! [Xph:($i > $o)] : (! [Xx3:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))) => (((ccv @ Xx3) = (ccv @ Xx3)) => ((Xph @ Xx3) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xx3)) => (Xph @ Xx3))))))))).
