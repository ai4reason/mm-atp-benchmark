...
thf(adfsdom2_thm,axiom,(ccsdm = (ccdif @ ccdom @ (cccnv @ ccdom)))).
...
thf(cbrsdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccsdm) <=> ((cwbr @ XA2 @ XB2 @ ccdom) & (~ (cwbr @ XB2 @ XA2 @ ccdom))))))))).
