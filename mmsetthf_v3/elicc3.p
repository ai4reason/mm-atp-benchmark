...
thf(celicc3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) <=> ((cwcel @ XC @ ccxr) & (cwbr @ XA2 @ XB2 @ ccle) & ((XC = XA2) | ((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XC @ XB2 @ cclt)) | (XC = XB2))))))))).
