...
thf(aomeiunle_thm,axiom,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (((? [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X)) => (! [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X))) => ((cwnfc @ (^ [Xn:$i] : (XE @ Xn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XO @ ccome))) => ((XX = (ccuni @ (ccdm @ XO))) => ((! [Xn:$i] : (XZ = (ccfv @ (XN @ Xn) @ ccuz))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ XZ @ (ccpw @ XX) @ (XE @ Xn)))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xn)))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ XO))) @ ccsumge0) @ ccle)))))))))))))))).
...
thf(acaragensspw_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => (cwss @ XS @ (ccpw @ XX))))))))))).
...
thf(ccaratheodorylem2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : ((Xph => (cwcel @ XO @ ccome)) => ((! [Xk:$i] : ((XX @ Xk) = (ccuni @ (ccdm @ XO)))) => ((! [Xk:$i] : (! [Xn:$i] : ((XS @ Xk @ Xn) = (ccfv @ XO @ cccaragen)))) => ((! [Xk:$i] : (! [Xn:$i] : (Xph => (cwf @ ccn @ (XS @ Xk @ Xn) @ XE)))) => ((Xph => (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE)))) => ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cciun @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xk) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))))))) => (Xph => ((ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XO) = (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XO))) @ ccsumge0)))))))))))))))).
