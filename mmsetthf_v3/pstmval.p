...
thf(adf_pstm_ax,axiom,(ccpstm = (ccmpt @ (^ [Xd:$i] : (ccuni @ (ccrn @ ccpsmet))) @ (^ [Xd:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ (ccdm @ (ccdm @ (ccv @ Xd))) @ (ccfv @ (ccv @ Xd) @ ccmetid)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ (ccdm @ (ccdm @ (ccv @ Xd))) @ (ccfv @ (ccv @ Xd) @ ccmetid)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccuni @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa)))))))))))).
...
thf(cpstmval_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccfv @ XD @ ccmetid)) => ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => ((ccfv @ XD @ ccpstm) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccuni @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa))))))))))))))).
