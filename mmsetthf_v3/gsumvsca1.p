...
thf(aslmdvs0_thm,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XW @ ccslmd) & (cwcel @ XX @ XK)) => ((cco @ XX @ Xc_0 @ Xc_x) = Xc_0))))))))))))).
...
thf(aslmdcmn_thm,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ ccslmd) => (cwcel @ XW @ cccmn)))).
...
thf(aslmdvsdi_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccslmd) & ((cwcel @ XR @ XK) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((cco @ XR @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) = (cco @ (cco @ XR @ XX @ Xc_x) @ (cco @ XR @ XY @ Xc_x) @ Xc_pl)))))))))))))))))).
...
thf(cgsumvsca1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XW @ ccbs)) => ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XW @ ccsca))) => ((! [Xk:$i] : ((Xc_0 @ Xk) = (ccfv @ XW @ cc0g))) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ XW @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwss @ (XK @ Xk) @ (ccfv @ (XG @ Xk) @ ccbs)))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwcel @ XW @ ccslmd)) => ((! [Xk:$i] : (Xph => (cwcel @ XP @ (XK @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XQ @ Xk) @ XB2))) => (Xph => ((cco @ XW @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ XP @ (XQ @ Xk) @ Xc_x))) @ ccgsu) = (cco @ XP @ (cco @ XW @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XQ @ Xk))) @ ccgsu) @ Xc_x))))))))))))))))))))))))).
