...
thf(adf_nacs_ax,axiom,(ccnacs = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xc:$i] : (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xg1:$i] : ((ccv @ Xs1) = (ccfv @ (ccv @ Xg1) @ (ccfv @ (ccv @ Xc) @ ccmrc)))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn)))) @ (^ [Xs1:$i] : (ccv @ Xc)))) @ (^ [Xc:$i] : (ccfv @ (ccv @ Xx3) @ ccacs))))))).
...
thf(cisnacs_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccnacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccacs)) & (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xg1:$i] : ((ccv @ Xs1) = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn)))) @ (^ [Xs1:$i] : XC))))))))).
