...
thf(aeqinfd_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwor @ XA2 @ XR))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XC @ XA2))) => ((! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xz) & (cwcel @ (ccv @ Xy1) @ XB2)) => (~ (cwbr @ (ccv @ Xy1) @ XC @ XR))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xz) & ((cwcel @ (ccv @ Xy1) @ XA2) & (cwbr @ XC @ (ccv @ Xy1) @ XR))) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR)) @ (^ [Xz:$i] : XB2))))) => (! [Xz:$i] : ((Xph @ Xz) => ((ccinf @ XB2 @ XA2 @ XR) = XC))))))))))))).
...
thf(cinfmremnf_conj,conjecture,((ccinf @ ccr @ ccxr @ cclt) = ccmnf)).
