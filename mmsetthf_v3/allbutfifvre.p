...
thf(callbutfifvre_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xm:$i] : (Xph @ Xm)) @ X)) => (! [X:$i] : ((^ [Xm:$i] : (Xph @ Xm)) @ X))) => ((! [Xm:$i] : (! [Xn:$i] : ((XZ @ Xn) = (ccfv @ (XM @ Xm @ Xn) @ ccuz)))) => ((! [Xm:$i] : (! [Xn:$i] : (((Xph @ Xm) & (cwcel @ (ccv @ Xm) @ (XZ @ Xn))) => (cwf @ (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn))) @ ccr @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn)))))) => ((! [Xm:$i] : (! [Xn:$i] : ((XD @ Xm @ Xn) = (cciun @ (^ [Xn:$i] : (XZ @ Xn)) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn)))))))))) => ((! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xm) => (cwcel @ XX @ (XD @ Xm @ Xn))))) => (! [Xm:$i] : ((Xph @ Xm) => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (ccfv @ XX @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn))) @ ccr)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)))) @ (^ [Xn:$i] : (XZ @ Xn))))))))))))))))).
