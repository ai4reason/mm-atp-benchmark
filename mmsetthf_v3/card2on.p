...
thf(ahartogs_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccdom)) @ (^ [Xx3:$i] : ccon0)) @ ccon0)))))).
...
thf(ccard2on_conj,conjecture,(! [XA2:($i > $o)] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : ccon0)) @ ccon0))).
