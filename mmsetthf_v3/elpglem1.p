...
thf(celpglem1_conj,conjecture,(! [XA2:($i > $o)] : ((? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ ccpg) & ((cwcel @ (ccfv @ XA2 @ cc1st) @ (ccpw @ (ccv @ Xx3))) & (cwcel @ (ccfv @ XA2 @ cc2nd) @ (ccpw @ (ccv @ Xx3)))))) => ((cwss @ (ccfv @ XA2 @ cc1st) @ ccpg) & (cwss @ (ccfv @ XA2 @ cc2nd) @ ccpg))))).
