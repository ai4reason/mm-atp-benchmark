...
thf(afnelfp_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XX @ XA2)) => ((cwcel @ XX @ (ccdm @ (ccin @ XF @ ccid))) <=> ((ccfv @ XX @ XF) = XX))))))).
