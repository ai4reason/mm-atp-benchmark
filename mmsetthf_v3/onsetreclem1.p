...
thf(consetreclem1_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xa:$i] : ((XF @ Xx3 @ Xa) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccpr @ (ccuni @ (ccv @ Xx3)) @ (ccsuc @ (ccuni @ (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xa:$i] : ((ccfv @ (ccv @ Xa) @ (XF @ Xx3 @ Xa)) = (ccpr @ (ccuni @ (ccv @ Xa)) @ (ccsuc @ (ccuni @ (ccv @ Xa)))))))))).
