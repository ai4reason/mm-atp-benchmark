...
thf(clssatle_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XW @ cclmod))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XT @ XS))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XU @ XS))) => (! [Xp:$i] : ((Xph @ Xp) => ((cwss @ XT @ XU) <=> (cwral @ (^ [Xp:$i] : ((cwss @ (ccv @ Xp) @ XT) => (cwss @ (ccv @ Xp) @ XU))) @ (^ [Xp:$i] : XA2))))))))))))))))).
