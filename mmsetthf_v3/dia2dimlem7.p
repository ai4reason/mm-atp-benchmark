...
thf(adva0g_thm,axiom,(! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdveca))) => ((Xc_0 = (ccfv @ XU @ cc0g)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (Xc_0 = (ccres @ ccid @ XB2)))))))))))))))).
