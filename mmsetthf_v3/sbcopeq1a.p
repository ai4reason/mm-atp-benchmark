...
thf(csbcopeq1a_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((XA2 @ Xx3 @ Xy1) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ cc2nd))) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ cc1st)) <=> (Xph @ Xx3 @ Xy1)))))))).
