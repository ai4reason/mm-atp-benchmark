...
thf(cnlmmul0or_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((XO = (ccfv @ XF @ cc0g)) => (((cwcel @ XW @ ccnlm) & (cwcel @ XA2 @ XK) & (cwcel @ XB2 @ XV)) => (((cco @ XA2 @ XB2 @ Xc_x) = Xc_0) <=> ((XA2 = XO) | (XB2 = Xc_0)))))))))))))))))))).
