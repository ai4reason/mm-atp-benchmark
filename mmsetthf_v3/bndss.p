...
thf(ablssp_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccres @ XM @ (ccxp @ XS @ XS))) => ((((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwss @ XS @ XX)) & ((cwcel @ XY @ XS) & (cwcel @ XR @ ccrp))) => ((cco @ XY @ XR @ (ccfv @ XN @ ccbl)) = (ccin @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ XS))))))))))).
