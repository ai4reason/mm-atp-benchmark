...
thf(ccdlemg4d_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XV = (ccfv @ XG @ XR)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) & (cwcel @ XF @ XT)) & ((cwcel @ XG @ XT) & (~ (cwbr @ XQ @ (cco @ XP @ XV @ Xc_or) @ Xc_le)) & ((ccfv @ (ccfv @ XP @ XG) @ XF) = XP))) => (~ (cwbr @ (ccfv @ XQ @ XG) @ (cco @ (ccfv @ XP @ XG) @ (ccfv @ (ccfv @ XP @ XG) @ XF) @ Xc_or) @ Xc_le)))))))))))))))))))))))).
