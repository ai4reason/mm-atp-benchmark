...
thf(celxp4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) <=> ((XA2 = (ccop @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ (ccuni @ (ccrn @ (ccsn @ XA2))))) & ((cwcel @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ XB2) & (cwcel @ (ccuni @ (ccrn @ (ccsn @ XA2))) @ XC)))))))).
