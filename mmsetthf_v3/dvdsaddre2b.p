...
thf(cdvdsaddre2b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccr) & ((cwcel @ XC @ ccz) & (cwbr @ XA2 @ XC @ ccdvds))) => ((cwbr @ XA2 @ XB2 @ ccdvds) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccaddc) @ ccdvds))))))).
