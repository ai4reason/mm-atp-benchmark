...
thf(cscmatrhmcl_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ (XN @ Xx3) @ XR @ ccmat))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XA2 @ Xx3) @ ccur))) => ((! [Xx3:$i] : (Xc_as = (ccfv @ (XA2 @ Xx3) @ ccvsca))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_1 @ Xc_as))))) => ((! [Xx3:$i] : ((XC @ Xx3) = (cco @ (XN @ Xx3) @ XR @ ccscmat))) => (! [Xx3:$i] : (((cwcel @ (XN @ Xx3) @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XX @ XK)) => (cwcel @ (ccfv @ XX @ (XF @ Xx3)) @ (XC @ Xx3)))))))))))))))))))).
