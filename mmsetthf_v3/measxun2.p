...
thf(adisjdifprg2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwdisj @ (^ [Xx3:$i] : (ccpr @ (ccdif @ XA2 @ XB2) @ (ccin @ XA2 @ XB2))) @ (^ [Xx3:$i] : (ccv @ Xx3))))))))).
...
thf(cmeasxun2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ (ccfv @ XS @ ccmeas)) & ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & (cwss @ XB2 @ XA2)) => ((ccfv @ XA2 @ XM) = (cco @ (ccfv @ XB2 @ XM) @ (ccfv @ (ccdif @ XA2 @ XB2) @ XM) @ ccxad)))))))).
