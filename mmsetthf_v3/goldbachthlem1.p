...
thf(cgoldbachthlem1_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0) & (cwbr @ XM @ XN @ cclt)) => (cwbr @ (ccfv @ XM @ ccfmtno) @ (cco @ (ccfv @ XN @ ccfmtno) @ cc2 @ ccmin) @ ccdvds))))).
