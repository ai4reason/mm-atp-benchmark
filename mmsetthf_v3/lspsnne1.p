...
thf(clspsnne1_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XX @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => ((ccfv @ (ccsn @ XX) @ XN) != (ccfv @ (ccsn @ XY) @ XN))) => (Xph => (~ (cwcel @ XX @ (ccfv @ (ccsn @ XY) @ XN))))))))))))))))))).
