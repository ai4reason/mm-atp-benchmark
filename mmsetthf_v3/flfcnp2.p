...
thf(cflfcnp2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ (XJ @ Xx3) @ (ccfv @ XX @ cctopon)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XK @ Xx3) @ (ccfv @ XY @ cctopon)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XL @ Xx3) @ (ccfv @ XZ @ ccfil)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XZ)) => (cwcel @ (XA2 @ Xx3) @ XX))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XZ)) => (cwcel @ (XB2 @ Xx3) @ XY))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XR @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ (XJ @ Xx3) @ (XL @ Xx3) @ ccflf))))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XS @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ (XK @ Xx3) @ (XL @ Xx3) @ ccflf))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XO @ (ccfv @ (ccop @ (XR @ Xx3) @ (XS @ Xx3)) @ (cco @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cctx) @ (XN @ Xx3) @ cccnp))))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ (XR @ Xx3) @ (XS @ Xx3) @ XO) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XO))) @ (cco @ (XN @ Xx3) @ (XL @ Xx3) @ ccflf))))))))))))))))))))))))))).
