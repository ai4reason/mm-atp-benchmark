...
thf(axblpnfps_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XP @ XX)) => ((cwcel @ XA2 @ (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl))) <=> ((cwcel @ XA2 @ XX) & (cwcel @ (cco @ XP @ XA2 @ XD) @ ccr))))))))).
...
thf(cxblss2ps_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => ((Xph => (cwcel @ XP @ XX)) => ((Xph => (cwcel @ XQ @ XX)) => ((Xph => (cwcel @ XR @ ccxr)) => ((Xph => (cwcel @ XS @ ccxr)) => ((Xph => (cwcel @ (cco @ XP @ XQ @ XD) @ ccr)) => ((Xph => (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ (ccxne @ XR) @ ccxad) @ ccle)) => (Xph => (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))))))))))).
