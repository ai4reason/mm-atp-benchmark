...
thf(adibeldmN_thm,axiom,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => (((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) => ((cwcel @ XX @ (ccdm @ XI)) <=> ((cwcel @ XX @ XB2) & (cwbr @ XX @ XW @ Xc_le))))))))))))))))).
...
thf(adibglbN_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XK @ ccglb)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => (! [Xx3:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwss @ XS @ (ccdm @ (XI @ Xx3))) & (XS != cc0))) => ((ccfv @ (ccfv @ XS @ XG) @ (XI @ Xx3)) = (cciin @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XI @ Xx3))))))))))))))))).
