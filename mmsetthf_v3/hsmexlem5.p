...
thf(aitunifn_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) => (cwfn @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1)) @ ccom))))))))).
thf(afniunfv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) = (ccuni @ (ccrn @ XF))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(aitunitc_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ XA2 @ cctc) = (ccuni @ (ccrn @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1))))))))))).
...
thf(aoiid_thm,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => ((ccoi @ XA2 @ ccep) = (ccres @ ccid @ XA2))))).
...
thf(awdomref_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwbr @ XX @ XX @ ccwdom))))).
...
thf(aiunon_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccon0)) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccon0))))))).
