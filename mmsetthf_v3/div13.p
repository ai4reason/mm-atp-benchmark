...
thf(cdiv13_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((cwcel @ XB2 @ ccc) & (XB2 != ccc0)) & (cwcel @ XC @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ ccmul) = (cco @ (cco @ XC @ XB2 @ ccdiv) @ XA2 @ ccmul))))))).
