...
thf(adf_preset_ax,axiom,(ccpreset = (^ [Xf1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xr)) & (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xr))) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xr))))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xf1) @ ccple))) @ (ccfv @ (ccv @ Xf1) @ ccbs))))).
