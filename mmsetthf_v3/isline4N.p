...
thf(cisline4N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xp:$i] : ((XC @ Xp) = (ccfv @ XK @ cccvr))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : ((XN @ Xp) = (ccfv @ XK @ cclines))) => ((XM = (ccfv @ XK @ ccpmap)) => (! [Xp:$i] : (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2)) => ((cwcel @ (ccfv @ XX @ XM) @ (XN @ Xp)) <=> (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XX @ (XC @ Xp))) @ (^ [Xp:$i] : XA2)))))))))))))))))).
