...
thf(acaragenunidm_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => (cwcel @ XX @ XS)))))))))).
...
thf(admovn_thm,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => (Xph => ((ccdm @ (ccfv @ XX @ ccovoln)) = (ccpw @ (cco @ ccr @ XX @ ccmap)))))))).
...
thf(crrnmbl_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => (Xph => (cwcel @ (cco @ ccr @ XX @ ccmap) @ (ccdm @ (ccfv @ XX @ ccvoln)))))))).
