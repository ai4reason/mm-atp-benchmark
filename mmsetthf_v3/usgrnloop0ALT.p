...
thf(cusgrnloop0ALT_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XG @ cciedg))) => ((cwcel @ XG @ ccusgr) => ((ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XE @ Xx3)) = (ccsn @ XU))) @ (^ [Xx3:$i] : (ccdm @ (XE @ Xx3)))) = cc0))))))).
