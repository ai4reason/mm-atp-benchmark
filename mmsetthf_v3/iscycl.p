...
thf(acycls_thm,axiom,(! [XG:($i > $o)] : ((ccfv @ XG @ cccycls) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccpths)) & ((ccfv @ ccc0 @ (ccv @ Xp)) = (ccfv @ (ccfv @ (ccv @ Xf1) @ cchash) @ (ccv @ Xp)))))))))).
...
thf(arelpths_thm,axiom,(! [XG:($i > $o)] : (cwrel @ (ccfv @ XG @ ccpths)))).
