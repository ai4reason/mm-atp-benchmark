...
thf(angprcan_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XD = (ccfv @ XG @ ccds)) => (((cwcel @ XG @ ccngp) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XC @ Xc_pl) @ (cco @ XB2 @ XC @ Xc_pl) @ XD) = (cco @ XA2 @ XB2 @ XD)))))))))))))).
thf(cngpsubcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => (((cwcel @ XG @ ccngp) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XC @ Xc_mi) @ (cco @ XB2 @ XC @ Xc_mi) @ XD) = (cco @ XA2 @ XB2 @ XD)))))))))))))).
