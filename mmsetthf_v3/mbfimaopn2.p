...
thf(ambfimaopn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (((cwcel @ XF @ ccmbf) & (cwcel @ XA2 @ XJ)) => (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ (ccdm @ ccvol)))))))).
...
thf(cmbfimaopn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XK = (cco @ XJ @ XB2 @ ccrest)) => ((((cwcel @ XF @ ccmbf) & (cwf @ XA2 @ XB2 @ XF) & (cwss @ XB2 @ ccc)) & (cwcel @ XC @ XK)) => (cwcel @ (ccima @ (cccnv @ XF) @ XC) @ (ccdm @ ccvol)))))))))))).
