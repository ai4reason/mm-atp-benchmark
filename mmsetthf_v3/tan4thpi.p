...
thf(asincos4thpi_thm,axiom,(((ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ ccsin) = (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)) & ((ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ cccos) = (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)))).
...
thf(ctan4thpi_conj,conjecture,((ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ cctan) = cc1)).
