...
thf(ccxpmul2z_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) & ((cwcel @ XB2 @ ccc) & (cwcel @ XC @ ccz))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ cccxp) = (cco @ (cco @ XA2 @ XB2 @ cccxp) @ XC @ ccexp))))))).
