...
thf(crabxp_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) => ((Xph @ Xx3) <=> (Xps @ Xy1 @ Xz)))))) => ((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccxp @ XA2 @ XB2))) = (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) & (cwcel @ (ccv @ Xz) @ XB2) & (Xps @ Xy1 @ Xz)))))))))))).
