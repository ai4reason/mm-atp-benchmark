...
thf(aesumcvg2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xl:$i] : ((XJ @ Xm @ Xl) = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn)))) => ((! [Xk:$i] : (! [Xm:$i] : (((Xph @ Xm) & (cwcel @ (ccv @ Xk) @ ccn)) => (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc))))) => ((! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : (((ccv @ Xk) = (ccv @ Xl)) => ((XA2 @ Xk) = (XB2 @ Xm @ Xl)))))) => ((! [Xk:$i] : (! [Xm:$i] : (((ccv @ Xk) = (ccv @ Xm)) => ((XA2 @ Xk) = (XC @ Xm))))) => (! [Xm:$i] : (! [Xl:$i] : ((Xph @ Xm) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))))) @ (ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccfv @ (XJ @ Xm @ Xl) @ cclm))))))))))))))).
...
thf(aiuninc_thm,axiom,(! [Xph:$o] : (! [Xi:$i] : (! [XF:($i > $o)] : ((Xph => (cwfn @ XF @ ccn)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => ((Xph & (cwcel @ (ccv @ Xi) @ ccn)) => ((cciun @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xi) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) = (ccfv @ (ccv @ Xi) @ XF))))))))).
...
thf(cmeascnbl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((XJ = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn)) => ((Xph => (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((Xph => (cwf @ ccn @ XS @ XF)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => (Xph => (cwbr @ (cccom @ XM @ XF) @ (ccfv @ (ccuni @ (ccrn @ XF)) @ XM) @ (ccfv @ XJ @ cclm))))))))))))).
