...
thf(cpjinvari_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((cwf @ cchil @ cchil @ XS) => ((cwcel @ XH @ ccch) => ((XT = (ccfv @ XH @ ccpjh)) => ((cwf @ cchil @ XH @ (cccom @ XS @ XT)) <=> ((cccom @ XS @ XT) = (cccom @ XT @ (cccom @ XS @ XT))))))))))).
