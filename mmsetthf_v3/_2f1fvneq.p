...
thf(c_2f1fvneq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwf1 @ XD @ XR @ XE) & (cwf1 @ XC @ XD @ XF)) & ((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XC)) & (XA2 != XB2)) => ((((ccfv @ (ccfv @ XA2 @ XF) @ XE) = XX) & ((ccfv @ (ccfv @ XB2 @ XF) @ XE) = XY)) => (XX != XY))))))))))))).
