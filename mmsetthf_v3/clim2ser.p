...
thf(aclimsubc1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (cco @ (ccfv @ (ccv @ Xk) @ XF) @ XC @ ccmin)))) => (Xph => (cwbr @ XG @ (cco @ XA2 @ XC @ ccmin) @ ccli)))))))))))))))))).
...
thf(cclim2ser_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((Xph => (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ XA2 @ ccli)) => (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ (cco @ XN @ cc1 @ ccaddc)) @ (cco @ XA2 @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmin) @ ccli))))))))))))).
