...
thf(aor3or_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph | Xps) <=> ((Xph & Xps) | (Xph & (~ Xps)) | ((~ Xph) & Xps)))))).
thf(aandi3or_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph & (Xps | Xch | Xth)) <=> ((Xph & Xps) | (Xph & Xch) | (Xph & Xth)))))))).
...
thf(cuneqsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((ccun @ XA2 @ XB2) = (ccsn @ XC)) <=> (((XA2 = (ccsn @ XC)) & (XB2 = (ccsn @ XC))) | ((XA2 = (ccsn @ XC)) & (XB2 = cc0)) | ((XA2 = cc0) & (XB2 = (ccsn @ XC))))))))).
