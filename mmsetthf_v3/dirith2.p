...
thf(arplogsum_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XN @ ccn)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XA2 @ XU)) => ((XT = (ccima @ (cccnv @ XL) @ (ccsn @ XA2))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ XN @ ccphi) @ (ccsu @ (ccin @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (ccin @ ccprime @ XT)) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ cclog) @ (ccv @ Xp) @ ccdiv))) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1)))))))))))))))).
