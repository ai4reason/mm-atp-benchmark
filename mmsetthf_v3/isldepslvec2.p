...
thf(aislindeps2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XZ = (ccfv @ XM @ cc0g)) => ((XR = (ccfv @ XM @ ccsca)) => ((XE = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XM @ cclmod) & (cwcel @ XS @ (ccpw @ XB2)) & (cwcel @ XR @ ccnzr)) => ((cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) & ((cco @ (ccv @ Xf1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ (ccfv @ XM @ cclinc)) = (ccv @ Xs1)))) @ (^ [Xf1:$i] : (cco @ XE @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ ccmap)))) @ (^ [Xs1:$i] : XS)) => (cwbr @ XS @ XM @ cclindeps)))))))))))))))).
thf(asylbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xch => Xth)) => (Xph => (Xps => Xth))))))))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cclininds_tp,type,(cclininds : ($i > $o))).
thf(aislindeps_thm,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XB2 @ Xx3 @ Xf1) = (ccfv @ XM @ ccbs)))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XZ @ Xx3 @ Xf1) = (ccfv @ XM @ cc0g)))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XR @ Xx3 @ Xf1) = (ccfv @ XM @ ccsca)))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XE @ Xx3) = (ccfv @ (XR @ Xx3 @ Xf1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((Xc_0 @ Xx3 @ Xf1) = (ccfv @ (XR @ Xx3 @ Xf1) @ cc0g)))) => (! [Xx3:$i] : (! [Xf1:$i] : (((cwcel @ XM @ (XW @ Xx3 @ Xf1)) & (cwcel @ XS @ (ccpw @ (XB2 @ Xx3 @ Xf1)))) => ((cwbr @ XS @ XM @ cclindeps) <=> (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ (Xc_0 @ Xx3 @ Xf1) @ ccfsupp) & ((cco @ (ccv @ Xf1) @ XS @ (ccfv @ XM @ cclinc)) = (XZ @ Xx3 @ Xf1)) & (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) != (Xc_0 @ Xx3 @ Xf1))) @ (^ [Xx3:$i] : XS)))) @ (^ [Xf1:$i] : (cco @ (XE @ Xx3) @ XS @ ccmap))))))))))))))))))))).
...
thf(alincreslvec3_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XE = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XZ = (ccfv @ XM @ cc0g)) => ((XN = (ccfv @ XR @ ccminusg)) => ((XI = (ccfv @ XR @ ccinvr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XG = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ XI) @ (ccfv @ (ccv @ Xs1) @ XF) @ Xc_x)))) => ((((cwcel @ XS @ (ccpw @ XB2)) & (cwcel @ XM @ cclvec) & (cwcel @ XX @ XS)) & ((cwcel @ XF @ (cco @ XE @ XS @ ccmap)) & ((ccfv @ XX @ XF) != Xc_0) & (cwbr @ XF @ Xc_0 @ ccfsupp)) & ((cco @ XF @ XS @ (ccfv @ XM @ cclinc)) = XZ)) => ((cco @ XG @ (ccdif @ XS @ (ccsn @ XX)) @ (ccfv @ XM @ cclinc)) = XX))))))))))))))))))))))))))).
