...
thf(a_1marepvmarrepid_thm,axiom,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_1 = (ccfv @ (cco @ XN @ XR @ ccmat) @ ccur)) => ((XX = (ccfv @ XI @ (cco @ Xc_1 @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn)) & ((cwcel @ XI @ XN) & (cwcel @ XZ @ XV))) => ((cco @ XI @ XI @ (cco @ XX @ (ccfv @ XI @ XZ) @ (cco @ XN @ XR @ ccmarrep))) = XX))))))))))))).
...
thf(ccramerimplem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((XE = (ccfv @ XI @ (cco @ (ccfv @ XA2 @ ccur) @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg) & (cwcel @ XI @ XN)) & (cwcel @ XZ @ XV)) => ((ccfv @ XE @ XD) = (ccfv @ XI @ XZ)))))))))))))))))).
