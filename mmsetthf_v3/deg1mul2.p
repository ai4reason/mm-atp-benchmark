...
thf(cdeg1mul2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (XF != Xc_0)) => ((Xph => (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) @ XE)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (XG != Xc_0)) => (Xph => ((ccfv @ (cco @ XF @ XG @ Xc_x) @ XD) = (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ ccaddc)))))))))))))))))))))))))).
