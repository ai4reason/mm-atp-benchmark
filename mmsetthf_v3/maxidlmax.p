...
thf(cmaxidlmax_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((((cwcel @ XR @ ccrngo) & (cwcel @ XM @ (ccfv @ XR @ ccmaxidl))) & ((cwcel @ XI @ (ccfv @ XR @ ccidl)) & (cwss @ XM @ XI))) => ((XI = XM) | (XI = XX))))))))))).
