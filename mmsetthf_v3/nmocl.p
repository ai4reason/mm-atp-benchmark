...
thf(cnmocl_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => (((cwcel @ XS @ ccngp) & (cwcel @ XT @ ccngp) & (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => (cwcel @ (ccfv @ XF @ XN) @ ccxr)))))))).
