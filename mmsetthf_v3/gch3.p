...
thf(aalephgch_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccen) => (cwcel @ (ccfv @ XA2 @ ccale) @ ccgch)))).
...
thf(agch2_thm,axiom,((ccgch = ccvv) <=> (cwss @ (ccrn @ ccale) @ ccgch))).
