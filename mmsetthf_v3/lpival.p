...
thf(adf_lpidl_ax,axiom,(cclpidl = (ccmpt @ (^ [Xw:$i] : ccrg) @ (^ [Xw:$i] : (cciun @ (^ [Xg1:$i] : (ccfv @ (ccv @ Xw) @ ccbs)) @ (^ [Xg1:$i] : (ccsn @ (ccfv @ (ccsn @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xw) @ ccrsp))))))))).
...
thf(clpival_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XR @ cclpidl)) => ((XK = (ccfv @ XR @ ccrsp)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccrg) => (XP = (cciun @ (^ [Xg1:$i] : XB2) @ (^ [Xg1:$i] : (ccsn @ (ccfv @ (ccsn @ (ccv @ Xg1)) @ XK)))))))))))))).
