...
thf(anzin_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => ((ccin @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) = (ccima @ ccdvds @ (ccsn @ (cco @ XM @ XN @ cclcm))))))))))).
...
thf(cnzprmdif_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccprime)) => ((Xph => (cwcel @ XN @ ccprime)) => ((Xph => (XM != XN)) => (Xph => ((ccdif @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ XN))) = (ccdif @ (ccima @ ccdvds @ (ccsn @ XM)) @ (ccima @ ccdvds @ (ccsn @ (cco @ XM @ XN @ ccmul))))))))))))).
