...
thf(c_1arithlem1_conj,conjecture,(! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (! [Xp:$i] : ((XM @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccpc)))))))) => (! [Xn:$i] : (! [Xp:$i] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ (XM @ Xn @ Xp)) = (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ XN @ ccpc))))))))))).
