...
thf(aressply1bas_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : ((XS = (ccfv @ XR @ ccpl1)) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (ccfv @ XH @ ccpl1)) => ((XB2 = (ccfv @ XU @ ccbs)) => ((Xph => (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((XP = (cco @ XS @ XB2 @ ccress)) => (Xph => (XB2 = (ccfv @ XP @ ccbs)))))))))))))))))).
...
thf(aressply1add_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ XR @ ccpl1)) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (ccfv @ XH @ ccpl1)) => ((XB2 = (ccfv @ XU @ ccbs)) => ((Xph => (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((XP = (cco @ XS @ XB2 @ ccress)) => ((Xph & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ XX @ XY @ (ccfv @ XU @ ccplusg)) = (cco @ XX @ XY @ (ccfv @ XP @ ccplusg))))))))))))))))))))).
