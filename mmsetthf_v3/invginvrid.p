...
thf(cinvginvrid_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((XN = (ccfv @ XR @ ccminusg)) => ((XI = (ccfv @ XR @ ccinvr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XU)) => ((cco @ (ccfv @ XY @ XN) @ (cco @ (ccfv @ (ccfv @ XY @ XN) @ XI) @ XX @ Xc_x) @ Xc_x) = XX)))))))))))))))).
