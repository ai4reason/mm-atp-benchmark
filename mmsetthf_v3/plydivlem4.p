...
thf(aplyadd_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((Xph => (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ (ccfv @ XS @ ccply))))))))))).
...
thf(aplydivlem1_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS)))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & ((ccv @ Xx3) != ccc0))) => (cwcel @ (cco @ cc1 @ (ccv @ Xx3) @ ccdiv) @ XS))) => ((Xph => (cwcel @ (ccneg @ cc1) @ XS)) => (Xph => (cwcel @ ccc0 @ XS))))))))).
thf(acoef2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ ccc0 @ XS)) => (cwf @ ccn0 @ XS @ XA2))))))).
...
thf(adgreq0_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((XA2 = (ccfv @ XF @ cccoe)) => ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((XF = cc0p) <=> ((ccfv @ XN @ XA2) = ccc0)))))))))).
thf(acaovcld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XC) & (cwcel @ (ccv @ Xy1) @ XD))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XE)))) => ((Xph => (cwcel @ XA2 @ XC)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XB2 @ Xx3) @ XD))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ XA2 @ (XB2 @ Xx3) @ XF) @ XE)))))))))))))).
...
thf(aplysub_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((Xph => (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS)))) => ((Xph => (cwcel @ (ccneg @ cc1) @ XS)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccfv @ XS @ ccply))))))))))))).
thf(aplymul_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((Xph => (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS)))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (ccfv @ XS @ ccply)))))))))))).
...
thf(adgrsub_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdgr) @ (ccif @ (cwbr @ XM @ XN @ ccle) @ XN @ XM) @ ccle)))))))))).
...
thf(acoe1term_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ XA2 @ (cco @ (ccv @ Xz) @ XN @ ccexp) @ ccmul))))) => (! [Xz:$i] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0) & (cwcel @ (XM @ Xz) @ ccn0)) => ((ccfv @ (XM @ Xz) @ (ccfv @ (XF @ Xz) @ cccoe)) = (ccif @ ((XM @ Xz) = XN) @ XA2 @ ccc0)))))))))).
...
thf(acoe0_thm,axiom,((ccfv @ cc0p @ cccoe) = (ccxp @ ccn0 @ (ccsn @ ccc0)))).
thf(adgrmul_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => ((((cwcel @ XF @ (ccfv @ XS @ ccply)) & (XF != cc0p)) & ((cwcel @ XG @ (ccfv @ XS @ ccply)) & (XG != cc0p))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdgr) = (cco @ XM @ XN @ ccaddc))))))))))).
thf(adgr1term_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ XA2 @ (cco @ (ccv @ Xz) @ XN @ ccexp) @ ccmul))))) => (! [Xz:$i] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & (cwcel @ XN @ ccn0)) => ((ccfv @ (XF @ Xz) @ ccdgr) = XN)))))))).
...
thf(acoesub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ cccoe) = (cco @ XA2 @ XB2 @ (ccof @ ccmin)))))))))))).
...
thf(acoemulhi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ XM @ XN @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) = (cco @ (ccfv @ XM @ XA2) @ (ccfv @ XN @ XB2) @ ccmul))))))))))))))).
...
thf(adgrlt_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((XA2 = (ccfv @ XF @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XM @ ccn0)) => (((XF = cc0p) | (cwbr @ XN @ XM @ cclt)) <=> ((cwbr @ XN @ XM @ ccle) & ((ccfv @ XM @ XA2) = ccc0)))))))))))).
