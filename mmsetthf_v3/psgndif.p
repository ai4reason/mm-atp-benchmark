...
thf(asymgfixelsi_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : ((XQ @ Xq) = (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : XP)))) => ((! [Xq:$i] : ((XS @ Xq) = (ccfv @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : ((XD @ Xq) = (ccdif @ (XN @ Xq) @ (ccsn @ XK)))) => (! [Xq:$i] : (((cwcel @ XK @ (XN @ Xq)) & (cwcel @ (XF @ Xq) @ (XQ @ Xq))) => (cwcel @ (ccres @ (XF @ Xq) @ (XD @ Xq)) @ (XS @ Xq)))))))))))))))).
