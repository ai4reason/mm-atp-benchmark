...
thf(cconstlimc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)))) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XC @ Xx3) @ ccc))) => (! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (cco @ (XF @ Xx3) @ (XC @ Xx3) @ cclimc)))))))))))))).
