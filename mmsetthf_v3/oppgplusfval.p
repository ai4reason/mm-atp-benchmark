...
thf(atpos0_thm,axiom,((cctpos @ cc0) = cc0)).
...
thf(areldmsets_thm,axiom,(cwrel @ (ccdm @ ccsts))).
...
thf(coppgplusfval_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((XO = (ccfv @ XR @ ccoppg)) => ((Xc_pb = (ccfv @ XO @ ccplusg)) => (Xc_pb = (cctpos @ Xc_pl)))))))))).
