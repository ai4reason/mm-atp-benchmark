...
thf(cbastop1_conj,conjecture,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwss @ XB2 @ XJ)) => (((ccfv @ XB2 @ cctg) = XJ) <=> (cwral @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwss @ (ccv @ Xy1) @ XB2) & ((ccv @ Xx3) = (ccuni @ (ccv @ Xy1)))))) @ (^ [Xx3:$i] : XJ))))))).
