...
thf(abrabsb_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwbr @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xy1) @ (XR @ Xx3 @ Xy1)) <=> (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (XB2 @ Xy1))) @ (XA2 @ Xx3 @ Xy1))))))))))).
...
thf(ceqerlem_b_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XA2 @ Xx3 @ Xz) = (XB2 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XR @ Xx3 @ Xy1 @ Xz) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((XA2 @ Xx3 @ Xz) = (XB2 @ Xy1 @ Xz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xz) @ (XR @ Xx3 @ Xy1 @ Xz)) <=> ((ccsb @ (ccv @ Xz) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz))) = (ccsb @ (ccv @ Xz) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz)))))))))))))).
