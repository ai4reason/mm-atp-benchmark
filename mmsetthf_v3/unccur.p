...
thf(cunccur_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwf @ (ccxp @ XA2 @ XB2) @ XC @ XF) & (cwcel @ XB2 @ (ccdif @ XV @ (ccsn @ cc0))) & (cwcel @ XC @ XW)) => ((ccunc @ (cccur @ XF)) = XF))))))))).
