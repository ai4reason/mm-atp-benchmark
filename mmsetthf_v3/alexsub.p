...
thf(aalexsublem_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccufl)) => ((Xph => (XX = (ccuni @ XB2))) => ((Xph => (XJ = (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg))) => ((! [Xx3:$i] : ((Xph & ((cwss @ (ccv @ Xx3) @ XB2) & (XX = (ccuni @ (ccv @ Xx3))))) => (cwrex @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) => ((Xph => (cwcel @ XF @ (ccfv @ XX @ ccufil))) => ((Xph => ((cco @ XJ @ XF @ ccflim) = cc0)) => (~ Xph))))))))))))).
...
thf(calexsub_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccufl)) => ((Xph => (XX = (ccuni @ XB2))) => ((Xph => (XJ = (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg))) => ((! [Xx3:$i] : ((Xph & ((cwss @ (ccv @ Xx3) @ XB2) & (XX = (ccuni @ (ccv @ Xx3))))) => (cwrex @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) => (Xph => (cwcel @ XJ @ cccmp))))))))))).
