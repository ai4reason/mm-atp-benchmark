...
thf(anbusgrf1o_thm,axiom,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xe:$i] : (! [Xf1:$i] : ((XV @ Xe @ Xf1) = (ccfv @ (XG @ Xe) @ ccvtx)))) => ((! [Xe:$i] : (XE = (ccfv @ (XG @ Xe) @ ccedg))) => (! [Xe:$i] : (! [Xf1:$i] : (((cwcel @ (XG @ Xe) @ ccusgr) & (cwcel @ XU @ (XV @ Xe @ Xf1))) => (? [Xf1:$i] : (cwf1o @ (cco @ (XG @ Xe) @ XU @ ccnbgr) @ (ccrab @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ (ccv @ Xf1))))))))))))).
