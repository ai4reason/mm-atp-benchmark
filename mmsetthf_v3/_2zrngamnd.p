...
thf(a_2zrngasgrp_thm,axiom,(! [XR:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XE @ Xx3 @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (XR = (cco @ cccnfld @ (XE @ Xx3 @ Xz) @ ccress)))) => (cwcel @ XR @ ccsgrp)))))).
