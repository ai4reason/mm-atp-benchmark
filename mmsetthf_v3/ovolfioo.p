...
thf(covolfioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) <=> (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xn:$i] : ((cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ (ccv @ Xz) @ cclt) & (cwbr @ (ccv @ Xz) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ cclt))) @ (^ [Xn:$i] : ccn))) @ (^ [Xz:$i] : XA2))))))).
