...
thf(cbfp_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XD @ (ccfv @ XX @ ccms)))) => ((! [Xz:$i] : ((Xph @ Xz) => (XX != cc0))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XK @ Xz) @ ccrp))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (XK @ Xz) @ cc1 @ cclt))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwf @ XX @ XX @ XF))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xz) & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XD) @ (cco @ (XK @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccmul) @ ccle))))) => (! [Xz:$i] : ((Xph @ Xz) => (cwreu @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ XF) = (ccv @ Xz))) @ (^ [Xz:$i] : XX)))))))))))))))).
