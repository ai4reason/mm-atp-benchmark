...
thf(cmapprop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccpr @ (ccop @ XX @ XA2) @ (ccop @ XY @ XB2))) => ((((cwcel @ XX @ XV) & (cwcel @ XA2 @ XR)) & ((cwcel @ XY @ XV) & (cwcel @ XB2 @ XR)) & ((XX != XY) & (cwcel @ XR @ XW))) => (cwcel @ XF @ (cco @ XR @ (ccpr @ XX @ XY) @ ccmap))))))))))))).
