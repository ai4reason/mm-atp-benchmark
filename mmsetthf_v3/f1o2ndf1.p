...
thf(afo2ndf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfo @ XF @ (ccrn @ XF) @ (ccres @ cc2nd @ XF))))))).
thf(af2ndf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwf @ XF @ XB2 @ (ccres @ cc2nd @ XF))))))).
...
thf(cf1o2ndf1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1 @ XA2 @ XB2 @ XF) => (cwf1o @ XF @ (ccrn @ XF) @ (ccres @ cc2nd @ XF))))))).
