...
thf(asseqfres_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XS @ ccvv)) => ((Xph => (cwcel @ XM @ (ccword @ XS))) => ((XW = (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((Xph => (cwf @ XW @ XS @ XF)) => (Xph => ((ccres @ (cco @ XM @ XF @ ccsseq) @ (cco @ ccc0 @ (ccfv @ XM @ cchash) @ ccfzo)) = XM)))))))))))).
...
thf(asseqf_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XS @ ccvv)) => ((Xph => (cwcel @ XM @ (ccword @ XS))) => ((XW = (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((Xph => (cwf @ XW @ XS @ XF)) => (Xph => (cwf @ ccn0 @ XS @ (cco @ XM @ XF @ ccsseq))))))))))))).
...
thf(aiwrdsplit_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ ccvv)) => ((Xph => (cwf @ ccn0 @ XS @ XF)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((ccres @ XF @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)) = (cco @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccs1 @ (ccfv @ XN @ XF)) @ ccconcat))))))))))).
