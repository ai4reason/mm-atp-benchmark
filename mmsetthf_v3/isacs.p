...
thf(adf_acs_ax,axiom,(ccacs = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xc:$i] : (? [Xf1:$i] : ((cwf @ (ccpw @ (ccv @ Xx3)) @ (ccpw @ (ccv @ Xx3)) @ (ccv @ Xf1)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccv @ Xs1) @ (ccv @ Xc)) <=> (cwss @ (ccuni @ (ccima @ (ccv @ Xf1) @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xx3))))))) @ (^ [Xc:$i] : (ccfv @ (ccv @ Xx3) @ ccmre))))))).
...
thf(cisacs_conj,conjecture,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (? [Xf1:$i] : ((cwf @ (ccpw @ XX) @ (ccpw @ XX) @ (ccv @ Xf1)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccv @ Xs1) @ XC) <=> (cwss @ (ccuni @ (ccima @ (ccv @ Xf1) @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ XX)))))))))).
