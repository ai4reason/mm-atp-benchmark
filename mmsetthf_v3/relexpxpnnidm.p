...
thf(crelexpxpnnidm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XN @ ccn) => (((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV) & ((ccin @ XA2 @ XB2) != cc0)) => ((cco @ (ccxp @ XA2 @ XB2) @ XN @ ccrelexp) = (ccxp @ XA2 @ XB2)))))))))).
