...
thf(almimlbs_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cclbs)) => ((XK = (ccfv @ XT @ cclbs)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmim)) & (cwcel @ XB2 @ XJ)) => (cwcel @ (ccima @ XF @ XB2) @ XK))))))))))).
thf(ane0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ XA2) => (XA2 != cc0))))).
thf(clmiclbs_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cclbs)) => ((XK = (ccfv @ XT @ cclbs)) => ((cwbr @ XS @ XT @ cclmic) => ((XJ != cc0) => (XK != cc0)))))))))).
