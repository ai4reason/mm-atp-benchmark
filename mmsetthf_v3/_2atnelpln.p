...
thf(c_2atnelpln_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ cclpl)) => (((cwcel @ XK @ cchlt) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) => (~ (cwcel @ (cco @ XQ @ XR @ Xc_or) @ XP))))))))))))).
