...
thf(callbutfiinf_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xm:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xm @ Xn) @ ccuz)))) => ((! [Xm:$i] : (! [Xn:$i] : ((XA2 @ Xm @ Xn) = (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (XB2 @ Xm)))))))) => ((! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xm @ Xn) => (cwcel @ XX @ (XA2 @ Xm @ Xn))))) => ((! [Xm:$i] : (! [Xn:$i] : ((XN @ Xm @ Xn) = (ccinf @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ XX @ (XB2 @ Xm))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)))) @ (^ [Xn:$i] : XZ)) @ ccr @ cclt)))) => (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xm @ Xn) => ((cwcel @ (XN @ Xm @ Xn) @ XZ) & (cwral @ (^ [Xm:$i] : (cwcel @ XX @ (XB2 @ Xm))) @ (^ [Xm:$i] : (ccfv @ (XN @ Xm @ Xn) @ ccuz))))))))))))))))))).
