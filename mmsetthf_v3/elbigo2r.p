...
thf(celbigo2r_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((((cwf @ XA2 @ ccr @ XG) & (cwss @ XA2 @ ccr)) & ((cwf @ XB2 @ ccr @ XF) & (cwss @ XB2 @ XA2)) & ((cwcel @ XC @ ccr) & (cwcel @ XM @ ccr) & (cwral @ (^ [Xx3:$i] : ((cwbr @ XC @ (ccv @ Xx3) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ XM @ (ccfv @ (ccv @ Xx3) @ XG) @ ccmul) @ ccle))) @ (^ [Xx3:$i] : XB2)))) => (cwcel @ XF @ (ccfv @ XG @ ccbigo)))))))))).
