...
thf(cfzrevral2_conj,conjecture,(! [Xph:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (cwcel @ XK @ ccz)) => ((cwral @ (^ [Xj:$i] : (Xph @ Xj)) @ (^ [Xj:$i] : (cco @ (cco @ XK @ XN @ ccmin) @ (cco @ XK @ XM @ ccmin) @ ccfz))) <=> (cwral @ (^ [Xk:$i] : (cwsbc @ (^ [Xj:$i] : (Xph @ Xj)) @ (cco @ XK @ (ccv @ Xk) @ ccmin))) @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)))))))))).
