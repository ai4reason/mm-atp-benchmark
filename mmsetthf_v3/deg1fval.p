...
thf(adf_deg1_ax,axiom,(ccdg1 = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cco @ cc1o @ (ccv @ Xr) @ ccmdg))))).
...
thf(cdeg1fval_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => (XD = (cco @ cc1o @ XR @ ccmdg)))))).
