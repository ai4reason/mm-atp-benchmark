...
thf(aoddprmdvds_thm,axiom,(! [XK:($i > $o)] : (((cwcel @ XK @ ccn) & (~ (cwrex @ (^ [Xn:$i] : (XK = (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))) => (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XK @ ccdvds)) @ (^ [Xp:$i] : (ccdif @ ccprime @ (ccsn @ cc2))))))).
