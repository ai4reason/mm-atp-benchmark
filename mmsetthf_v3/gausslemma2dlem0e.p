...
thf(cgausslemma2dlem0e_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => (Xph => (cwbr @ (cco @ XM @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt)))))))).
