...
thf(cextwwlkfablem1OLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XG @ ccusgr) & (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) & (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) & ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) = (ccfv @ ccc0 @ XW))) => (cwcel @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ XW) @ (cco @ XG @ (ccfv @ ccc0 @ XW) @ ccnbgr))))))).
