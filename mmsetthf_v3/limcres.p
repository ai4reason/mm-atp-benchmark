...
thf(climcres_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XC @ XA2)) => ((Xph => (cwss @ XA2 @ ccc)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((XJ = (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest)) => ((Xph => (cwcel @ XB2 @ (ccfv @ (ccun @ XC @ (ccsn @ XB2)) @ (ccfv @ XJ @ ccnt)))) => (Xph => ((cco @ (ccres @ XF @ XC) @ XB2 @ cclimc) = (cco @ XF @ XB2 @ cclimc))))))))))))))))).
