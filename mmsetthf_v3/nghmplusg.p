...
thf(cnghmplusg_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xc_pl = (ccfv @ XT @ ccplusg)) => (((cwcel @ XT @ ccabl) & (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccnghm))) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ (cco @ XS @ XT @ ccnghm)))))))))).
