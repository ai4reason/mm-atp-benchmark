...
thf(cfvtp3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwcel @ XF @ ccvv) => (((XA2 != XC) & (XB2 != XC)) => ((ccfv @ XC @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) = XF))))))))))).
