...
thf(aranklim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwlim @ XB2) => ((cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2) <=> (cwcel @ (ccfv @ (ccpw @ XA2) @ ccrnk) @ XB2)))))).
...
thf(crankxplim_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((cwlim @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)) & ((ccxp @ XA2 @ XB2) != cc0)) => ((ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk) = (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)))))))).
