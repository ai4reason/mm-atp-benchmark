...
thf(acanthp1_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ cc1o @ XA2 @ ccsdm) => (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ (ccpw @ XA2) @ ccsdm)))).
thf(cfinngch_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwbr @ cc1o @ XA2 @ ccsdm)) => ((cwbr @ XA2 @ (cco @ XA2 @ cc1o @ cccda) @ ccsdm) & (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ (ccpw @ XA2) @ ccsdm))))).
