...
thf(cghmmulg_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_xp = (ccfv @ XH @ ccmg)) => (((cwcel @ XF @ (cco @ XG @ XH @ ccghm)) & (cwcel @ XN @ ccz) & (cwcel @ XX @ XB2)) => ((ccfv @ (cco @ XN @ XX @ Xc_x) @ XF) = (cco @ XN @ (ccfv @ XX @ XF) @ Xc_xp))))))))))))))).
