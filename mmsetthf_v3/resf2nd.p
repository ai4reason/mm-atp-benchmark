...
thf(cresf2nd_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwcel @ XH @ XW)) => ((Xph => (cwfn @ XH @ (ccxp @ XS @ XS))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => (Xph => ((cco @ XX @ XY @ (ccfv @ (cco @ XF @ XH @ ccresf) @ cc2nd)) = (ccres @ (cco @ XX @ XY @ (ccfv @ XF @ cc2nd)) @ (cco @ XX @ XY @ XH)))))))))))))))))).
