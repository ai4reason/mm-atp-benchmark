...
thf(csgmppw_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccsgm) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XP @ XA2 @ cccxp) @ (ccv @ Xk) @ ccexp))))))))).
