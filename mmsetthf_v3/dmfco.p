...
thf(aopelco2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => ((cwcel @ (ccop @ XA2 @ XB2) @ (cccom @ XC @ XD)) <=> (? [Xx3:$i] : ((cwcel @ (ccop @ XA2 @ (ccv @ Xx3)) @ XD) & (cwcel @ (ccop @ (ccv @ Xx3) @ XB2) @ XC))))))))))))).
...
thf(cdmfco_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ XG) & (cwcel @ XA2 @ (ccdm @ XG))) => ((cwcel @ XA2 @ (ccdm @ (cccom @ XF @ XG))) <=> (cwcel @ (ccfv @ XA2 @ XG) @ (ccdm @ XF)))))))).
