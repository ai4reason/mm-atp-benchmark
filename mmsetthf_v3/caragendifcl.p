...
thf(acarageneld_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : ((Xph => (cwcel @ XO @ ccome)) => ((! [Xa:$i] : ((XX @ Xa) = (ccuni @ (ccdm @ XO)))) => ((! [Xa:$i] : ((XS @ Xa) = (ccfv @ XO @ cccaragen))) => ((! [Xa:$i] : (Xph => (cwcel @ XE @ (ccpw @ (XX @ Xa))))) => ((! [Xa:$i] : ((Xph & (cwcel @ (ccv @ Xa) @ (ccpw @ (XX @ Xa)))) => ((cco @ (ccfv @ (ccin @ (ccv @ Xa) @ XE) @ XO) @ (ccfv @ (ccdif @ (ccv @ Xa) @ XE) @ XO) @ ccxad) = (ccfv @ (ccv @ Xa) @ XO)))) => (! [Xa:$i] : (Xph => (cwcel @ XE @ (XS @ Xa))))))))))))))).
...
thf(acaragenuni_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => ((ccuni @ XS) = (ccuni @ (ccdm @ XO)))))))))).
...
thf(acaragenel_thm,axiom,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XO @ ccome))) => ((! [Xa:$i] : ((XS @ Xa) = (ccfv @ XO @ cccaragen))) => (! [Xa:$i] : ((Xph @ Xa) => ((cwcel @ XE @ (XS @ Xa)) <=> ((cwcel @ XE @ (ccpw @ (ccuni @ (ccdm @ XO)))) & (cwral @ (^ [Xa:$i] : ((cco @ (ccfv @ (ccin @ (ccv @ Xa) @ XE) @ XO) @ (ccfv @ (ccdif @ (ccv @ Xa) @ XE) @ XO) @ ccxad) = (ccfv @ (ccv @ Xa) @ XO))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ XO)))))))))))))))).
thf(ccaragendifcl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => ((Xph => (cwcel @ XE @ XS)) => (Xph => (cwcel @ (ccdif @ (ccuni @ XS) @ XE) @ XS)))))))))).
