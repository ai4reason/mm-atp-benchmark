...
thf(astoweidlem10_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XN @ ccn0) & (cwbr @ XA2 @ cc1 @ ccle)) => (cwbr @ (cco @ cc1 @ (cco @ XN @ XA2 @ ccmul) @ ccmin) @ (cco @ (cco @ cc1 @ XA2 @ ccmin) @ XN @ ccexp) @ ccle))))).
thf(astoweidlem12_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xt:$i] : ((XQ @ Xt) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (cco @ cc1 @ (cco @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ (XN @ Xt) @ ccexp) @ ccmin) @ (cco @ (XK @ Xt) @ (XN @ Xt) @ ccexp) @ ccexp))))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwf @ XT @ ccr @ (XP @ Xt)))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XN @ Xt) @ ccn0))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XK @ Xt) @ ccn0))) => (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xt) @ XT)) => ((ccfv @ (ccv @ Xt) @ (XQ @ Xt)) = (cco @ (cco @ cc1 @ (cco @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ (XN @ Xt) @ ccexp) @ ccmin) @ (cco @ (XK @ Xt) @ (XN @ Xt) @ ccexp) @ ccexp))))))))))))))).
