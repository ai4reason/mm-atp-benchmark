...
thf(alactghmga_thm,axiom,(! [Xc_po:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XH = (ccfv @ XY @ ccsymg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_po @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XF @ (cco @ XG @ XH @ ccghm)) => (cwcel @ (Xc_po @ Xx3 @ Xy1) @ (cco @ XG @ XY @ ccga))))))))))))))).
...
thf(csymgga_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XX @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XF @ Xx3 @ Xf1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xx3:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xx3:$i] : XX)) @ (^ [Xf1:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((cwcel @ XX @ XV) => (cwcel @ (XF @ Xx3 @ Xf1) @ (cco @ XG @ XX @ ccga)))))))))))))).
