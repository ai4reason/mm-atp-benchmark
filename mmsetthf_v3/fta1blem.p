...
thf(acoe1tmfv1_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => (((cwcel @ XR @ ccrg) & (cwcel @ XC @ XK) & (cwcel @ XD @ ccn0)) => ((ccfv @ XD @ (ccfv @ (cco @ XC @ (cco @ XD @ XX @ Xc_ex) @ Xc_x) @ ccco1)) = XC)))))))))))))))))))).
...
thf(adeg1tm_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & ((cwcel @ XC @ XK) & (XC != Xc_0)) & (cwcel @ XF @ ccn0)) => ((ccfv @ (cco @ XC @ (cco @ XF @ XX @ Xc_ex) @ Xc_x) @ XD) = XF)))))))))))))))))))))).
