...
thf(cmclsrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : ((XD = (ccfv @ XT @ ccmdv)) => ((XE = (ccfv @ XT @ ccmex)) => ((XC = (ccfv @ XT @ ccmcls)) => ((cwcel @ XA2 @ (cco @ XK @ XB2 @ XC)) => ((cwcel @ XT @ ccvv) & (cwss @ XK @ XD) & (cwss @ XB2 @ XE)))))))))))))).
