...
thf(cdsmm0cl_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((XH = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccmnd @ XR)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => (Xph => (cwcel @ Xc_0 @ XH)))))))))))))))))).
