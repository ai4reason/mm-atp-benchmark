...
thf(arankvalb_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => ((ccfv @ XA2 @ ccrnk) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ ccr1))) @ (^ [Xx3:$i] : ccon0))))))).
thf(crankidb_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => (cwcel @ XA2 @ (ccfv @ (ccsuc @ (ccfv @ XA2 @ ccrnk)) @ ccr1))))).
