...
thf(arspcedeq2vd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ XB2)) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => (XC = (XD @ Xx3)))) => (Xph => (cwrex @ (^ [Xx3:$i] : (XC = (XD @ Xx3))) @ (^ [Xx3:$i] : XB2))))))))))).
...
thf(ceucrctshift_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (XV = (ccfv @ (XG @ Xx3) @ ccvtx))) => ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (Xph => (cwbr @ XF @ XP @ (ccfv @ (XG @ Xx3) @ cccrcts)))) => ((XN = (ccfv @ XF @ cchash)) => ((Xph => (cwcel @ XS @ (cco @ ccc0 @ XN @ ccfzo))) => ((XH = (cco @ XF @ XS @ cccsh)) => ((! [Xx3:$i] : ((XQ @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP)))))) => ((! [Xx3:$i] : (Xph => (cwbr @ XF @ XP @ (ccfv @ (XG @ Xx3) @ cceupth)))) => (! [Xx3:$i] : (Xph => ((cwbr @ XH @ (XQ @ Xx3) @ (ccfv @ (XG @ Xx3) @ cceupth)) & (cwbr @ XH @ (XQ @ Xx3) @ (ccfv @ (XG @ Xx3) @ cccrcts)))))))))))))))))))))))).
