...
thf(aacndom2_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwbr @ XX @ XY @ ccdom) => ((cwcel @ XY @ (cwacn @ XA2)) => (cwcel @ XX @ (cwacn @ XA2)))))))).
...
thf(afodomacn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ (cwacn @ XB2)) => ((cwfo @ XA2 @ XB2 @ XF) => (cwbr @ XB2 @ XA2 @ ccdom))))))).
