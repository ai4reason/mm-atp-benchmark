...
thf(czfac_conj,conjecture,(! [Xw:$i] : (? [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwcel @ (ccv @ Xz) @ (ccv @ Xw))) => (? [Xw:$i] : (! [Xy1:$i] : ((? [Xw:$i] : (((cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwcel @ (ccv @ Xz) @ (ccv @ Xw))) & ((cwcel @ (ccv @ Xy1) @ (ccv @ Xw)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))))) <=> ((ccv @ Xy1) = (ccv @ Xw))))))))))).
