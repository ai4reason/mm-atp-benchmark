...
thf(cdvhopvadd_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccsca)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XF @ XT) & (cwcel @ XQ @ XE)) & ((cwcel @ XG @ XT) & (cwcel @ XR @ XE))) => ((cco @ (ccop @ XF @ XQ) @ (ccop @ XG @ XR) @ Xc_pl) = (ccop @ (cccom @ XF @ XG) @ (cco @ XQ @ XR @ Xc_pd))))))))))))))))))))))))).
