...
thf(aplycn_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XS @ ccply)) => (cwcel @ XF @ (cco @ ccc @ ccc @ cccncf)))))).
...
thf(csignsply0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xz:$i] : ((XD @ Xz) = (ccfv @ XF @ ccdgr))) => ((! [Xz:$i] : ((XC @ Xz) = (ccfv @ XF @ cccoe))) => ((! [Xz:$i] : (XB2 = (ccfv @ (XD @ Xz) @ (XC @ Xz)))) => ((! [Xz:$i] : ((XA2 @ Xz) = (ccfv @ ccc0 @ (XC @ Xz)))) => ((Xph => (cwcel @ XF @ (ccfv @ ccr @ ccply))) => ((Xph => (XF != cc0p)) => ((! [Xz:$i] : (Xph => (cwbr @ (cco @ (XA2 @ Xz) @ XB2 @ ccmul) @ ccc0 @ cclt))) => (Xph => (cwrex @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ XF) = ccc0)) @ (^ [Xz:$i] : ccrp))))))))))))))))).
