...
thf(cfunvtxval0_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccvv) => (((cwfun @ (ccdif @ XG @ (ccsn @ cc0))) & (XS != (ccfv @ ccnx @ ccbs)) & (cwss @ (ccpr @ (ccfv @ ccnx @ ccbs) @ XS) @ (ccdm @ XG))) => ((ccfv @ XG @ ccvtx) = (ccfv @ XG @ ccbs))))))).
