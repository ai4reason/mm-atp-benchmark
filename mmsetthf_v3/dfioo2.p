...
thf(aiooval2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccioo) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ cclt) & (cwbr @ (ccv @ Xx3) @ XB2 @ cclt))) @ (^ [Xx3:$i] : ccr))))))).
thf(cdfioo2_conj,conjecture,(ccioo = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xw) @ cclt) & (cwbr @ (ccv @ Xw) @ (ccv @ Xy1) @ cclt))) @ (^ [Xw:$i] : ccr))))))).
