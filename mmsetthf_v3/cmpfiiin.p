...
thf(aelrfirn2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [Xy1:$i] : (((cwcel @ XB2 @ XV) & (cwral @ (^ [Xy1:$i] : (cwss @ (XC @ Xy1) @ XB2)) @ (^ [Xy1:$i] : XI))) => ((cwcel @ (XA2 @ Xy1) @ (ccfv @ (ccun @ (ccsn @ XB2) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (XC @ Xy1))))) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : ((XA2 @ Xy1) = (ccin @ XB2 @ (cciin @ (^ [Xy1:$i] : (ccv @ Xv)) @ (^ [Xy1:$i] : (XC @ Xy1)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XI) @ ccfn)))))))))))).
thf(acmpfii_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ cccmp) & (cwss @ XX @ (ccfv @ XJ @ cccld)) & (~ (cwcel @ cc0 @ (ccfv @ XX @ ccfi)))) => ((ccint @ XX) != cc0))))).
thf(ccmpfiiin_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XJ @ cccmp)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XI)) => (cwcel @ (XS @ Xk) @ (ccfv @ XJ @ cccld)))) => ((! [Xl:$i] : ((Xph & ((cwss @ (ccv @ Xl) @ XI) & (cwcel @ (ccv @ Xl) @ ccfn))) => ((ccin @ XX @ (cciin @ (^ [Xk:$i] : (ccv @ Xl)) @ (^ [Xk:$i] : (XS @ Xk)))) != cc0))) => (Xph => ((ccin @ XX @ (cciin @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (XS @ Xk)))) != cc0)))))))))))).
