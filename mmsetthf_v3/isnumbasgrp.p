...
thf(aisnumbasabl_thm,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccdm @ cccrd)) <=> (cwcel @ (ccun @ XS @ (ccfv @ XS @ cchar)) @ (ccima @ ccbs @ ccabl))))).
...
thf(aisnumbasgrplem2_thm,axiom,(! [XS:($i > $o)] : ((cwcel @ (ccun @ XS @ (ccfv @ XS @ cchar)) @ (ccima @ ccbs @ ccgrp)) => (cwcel @ XS @ (ccdm @ cccrd))))).
thf(cisnumbasgrp_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccdm @ cccrd)) <=> (cwcel @ (ccun @ XS @ (ccfv @ XS @ cchar)) @ (ccima @ ccbs @ ccgrp))))).
