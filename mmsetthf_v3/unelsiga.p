...
thf(aisrnsigau_thm,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) => ((cwss @ XS @ (ccpw @ (ccuni @ XS))) & ((cwcel @ (ccuni @ XS) @ XS) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ (ccuni @ XS) @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XS)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ XS))) @ (^ [Xx3:$i] : (ccpw @ XS)))))))).
...
thf(cunelsiga_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) => (cwcel @ (ccun @ XA2 @ XB2) @ XS)))))).
