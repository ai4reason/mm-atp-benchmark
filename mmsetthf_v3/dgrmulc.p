...
thf(cdgrmulc_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ (ccxp @ ccc @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdgr) = (ccfv @ XF @ ccdgr))))))).
