...
thf(amnccoe_thm,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XP @ (ccfv @ XS @ ccmnc)) => ((ccfv @ (ccfv @ XP @ ccdgr) @ (ccfv @ XP @ cccoe)) = cc1))))).
...
thf(cmncn0_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XP @ (ccfv @ XS @ ccmnc)) => (XP != cc0p))))).
