...
thf(aelopg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwcel @ XC @ (ccop @ XA2 @ XB2)) <=> ((XC = (ccsn @ XA2)) | (XC = (ccpr @ XA2 @ XB2))))))))))).
thf(abj_imn3ani_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((~ (Xph & Xps & Xch)) => ((Xph & Xps) => (~ Xch))))))).
