...
thf(agrpsgrp_thm,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccgrp) => (cwcel @ XG @ ccsgrp)))).
...
thf(cdfgrp3_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cwcel @ XG @ ccgrp) <=> ((cwcel @ XG @ ccsgrp) & (XB2 != cc0) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwrex @ (^ [Xl:$i] : ((cco @ (ccv @ Xl) @ (ccv @ Xx3) @ Xc_pl) = (ccv @ Xy1))) @ (^ [Xl:$i] : XB2)) & (cwrex @ (^ [Xr:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xr) @ Xc_pl) = (ccv @ Xy1))) @ (^ [Xr:$i] : XB2)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
