...
thf(covolval2lem_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF))) => (! [Xn:$i] : ((Xph @ Xn) => ((ccrn @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1)) = (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsu @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ XF)) @ ccvol))))))))))))).
