...
thf(clsmmod2_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XT @ (ccfv @ XG @ ccsubg)) & (cwcel @ XU @ (ccfv @ XG @ ccsubg))) & (cwss @ XU @ XS)) => ((ccin @ XS @ (cco @ XT @ XU @ Xc_po)) = (cco @ (ccin @ XS @ XT) @ XU @ Xc_po)))))))))).
