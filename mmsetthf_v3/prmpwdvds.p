...
thf(cprmpwdvds_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XK @ ccz) & (cwcel @ XD @ ccz)) & ((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn)) & ((cwbr @ XD @ (cco @ XK @ (cco @ XP @ XN @ ccexp) @ ccmul) @ ccdvds) & (~ (cwbr @ XD @ (cco @ XK @ (cco @ XP @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ ccdvds)))) => (cwbr @ (cco @ XP @ XN @ ccexp) @ XD @ ccdvds))))))).
