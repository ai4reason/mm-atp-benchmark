...
thf(c_2reuswap2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (cwmo @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (XB2 @ Xy1)) & (Xph @ Xx3 @ Xy1))))) @ (^ [Xx3:$i] : XA2)) => ((cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1)))) @ (^ [Xx3:$i] : XA2)) => (cwreu @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : (XB2 @ Xy1))))))))).
