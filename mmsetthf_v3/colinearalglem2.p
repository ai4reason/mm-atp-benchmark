...
thf(ccolinearalglem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cco @ (cco @ (ccfv @ (ccv @ Xi) @ XB2) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XA2) @ ccmin) @ ccmul) = (cco @ (cco @ (ccfv @ (ccv @ Xj) @ XB2) @ (ccfv @ (ccv @ Xj) @ XA2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul))) @ (^ [Xj:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cco @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xj) @ XA2) @ (ccfv @ (ccv @ Xj) @ XB2) @ ccmin) @ ccmul) = (cco @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XB2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccmin) @ ccmul))) @ (^ [Xj:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))))))))).
