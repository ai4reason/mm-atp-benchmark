...
thf(adgrlem_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((cwf @ ccn0 @ (ccun @ XS @ (ccsn @ ccc0)) @ XA2) & (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xn) @ ccle)) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XA2) @ (ccdif @ ccc @ (ccsn @ ccc0)))))) @ (^ [Xn:$i] : ccz))))))))).
...
thf(adgrval_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((ccfv @ XF @ ccdgr) = (ccsup @ (ccima @ (cccnv @ XA2) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ ccn0 @ cclt)))))))).
...
thf(cdgrub_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XM @ ccn0) & ((ccfv @ XM @ XA2) != ccc0)) => (cwbr @ XM @ XN @ ccle)))))))))).
