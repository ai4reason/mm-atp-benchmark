...
thf(cfin1a2lem13_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwss @ XA2 @ (ccpw @ XB2)) & (cwor @ XA2 @ ccrpss) & (~ (cwcel @ (ccuni @ XA2) @ XA2))) & ((~ (cwcel @ XC @ ccfn)) & (cwcel @ XC @ XA2))) => (~ (cwcel @ (ccdif @ XB2 @ XC) @ ccfin2))))))).
