...
thf(aodf1o2_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => (cwf1o @ (cco @ ccc0 @ (ccfv @ XA2 @ XO) @ ccfzo) @ (ccfv @ (ccsn @ XA2) @ XK) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XA2 @ XO) @ ccfzo)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x)))))))))))))))).
...
thf(acycsubg2cl_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XN @ XA2 @ Xc_x) @ (ccfv @ (ccsn @ XA2) @ XK))))))))))))).
...
thf(aodmulgeq_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => (((ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) = (ccfv @ XA2 @ XO)) <=> ((cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) = cc1))))))))))))).
...
thf(codngen_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XO) = (ccfv @ XA2 @ XO))) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ XA2) @ XK))) @ cchash) = (ccfv @ (ccfv @ XA2 @ XO) @ ccphi)))))))))))).
