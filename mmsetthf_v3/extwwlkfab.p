...
thf(arabeqif_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (XB2 @ Xx3))) => ((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(aclwwlknon_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XX)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn)))))))).
thf(arabrab_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) = (ccrab @ (^ [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(aclwwnrepclwwn_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) & ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) = (ccfv @ ccc0 @ XW))) => (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc2 @ ccmin)) @ ccsubstr) @ (cco @ (cco @ XN @ cc2 @ ccmin) @ XG @ ccclwwlkn))))))).
...
thf(a_2clwwlklem_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) & (cwcel @ XN @ (ccfv @ cc3 @ ccuz))) => ((ccfv @ ccc0 @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc2 @ ccmin)) @ ccsubstr)) = (ccfv @ ccc0 @ XW))))))).
...
thf(aisclwwlknon_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) <=> ((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) & ((ccfv @ ccc0 @ XW) = XX)))))))).
