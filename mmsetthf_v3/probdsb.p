...
thf(aprobdif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprb) & (cwcel @ XA2 @ (ccdm @ XP)) & (cwcel @ XB2 @ (ccdm @ XP))) => ((ccfv @ (ccdif @ XA2 @ XB2) @ XP) = (cco @ (ccfv @ XA2 @ XP) @ (ccfv @ (ccin @ XA2 @ XB2) @ XP) @ ccmin))))))).
