...
thf(cbj_sbeqALT_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (((^ [Xx3:$i] : ((XA2 @ Xx3 @ Xy1) = (XB2 @ Xx3 @ Xy1))) @ Xy1) <=> ((ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) = (ccsb @ (ccv @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))))))))).
