...
thf(afiluni_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XF @ (ccfv @ XX @ ccfil)) & (XF != cc0) & (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : (cwcel @ (ccun @ (ccv @ Xf1) @ (ccv @ Xg1)) @ XF)) @ (^ [Xg1:$i] : XF))) @ (^ [Xf1:$i] : XF))) => (cwcel @ (ccuni @ XF) @ (ccfv @ XX @ ccfil)))))).
...
thf(cfilssufilg_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwcel @ (ccpw @ (ccpw @ XX)) @ (ccdm @ cccrd))) => (cwrex @ (^ [Xf1:$i] : (cwss @ XF @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil))))))).
