...
thf(cistgp_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ cctgp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ cctmd) & (cwcel @ XI @ (cco @ XJ @ XJ @ cccn)))))))))).
