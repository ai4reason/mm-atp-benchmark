...
thf(ahausdiag_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccha) <=> ((cwcel @ XJ @ cctop) & (cwcel @ (ccres @ ccid @ XX) @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccld)))))))).
thf(ctgphaus_conj,conjecture,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XJ = (ccfv @ XG @ cctopn)) => ((cwcel @ XG @ cctgp) => ((cwcel @ XJ @ ccha) <=> (cwcel @ (ccsn @ Xc_0) @ (ccfv @ XJ @ cccld)))))))))).
