...
thf(cblgt0_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccxr)) & (cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)))) => (cwbr @ ccc0 @ XR @ cclt)))))))).
