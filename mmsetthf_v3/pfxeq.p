...
thf(cpfxeq_conj,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV))) & ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) & ((cwbr @ XM @ (ccfv @ XW @ cchash) @ ccle) & (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) => (((cco @ XW @ XM @ ccpfx) = (cco @ XU @ XN @ ccpfx)) <=> ((XM = XN) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) = (ccfv @ (ccv @ Xi) @ XU))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)))))))))))).
