...
thf(aram0_thm,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccn0) => ((cco @ XM @ cc0 @ ccram) = XM)))).
...
thf(a_0ram2_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XR @ ccfn) & (XR != cc0) & (cwf @ XR @ ccn0 @ XF)) => ((cco @ ccc0 @ XF @ ccram) = (ccsup @ (ccrn @ XF) @ ccr @ cclt)))))).
...
thf(c_0ramcl_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XR @ ccfn) & (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ ccc0 @ XF @ ccram) @ ccn0))))).
