...
thf(advdsmulgcd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) => ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccdvds) <=> (cwbr @ XA2 @ (cco @ XB2 @ (cco @ XC @ XA2 @ ccgcd) @ ccmul) @ ccdvds))))))).
...
thf(advdsext_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) => ((XA2 = XB2) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccdvds) <=> (cwbr @ XB2 @ (ccv @ Xx3) @ ccdvds))) @ (^ [Xx3:$i] : ccn0))))))).
thf(codmulg_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) => ((ccfv @ XA2 @ XO) = (cco @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ ccmul))))))))))))).
