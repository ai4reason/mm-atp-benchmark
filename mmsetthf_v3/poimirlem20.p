...
thf(apoimirlem19_thm,axiom,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xf1) = (ccrab @ (^ [Xt:$i] : (XF = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xt) @ cc2nd) @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))) @ (cco @ ccc0 @ XN @ ccfz))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwf @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ XF)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XT @ (XS @ Xf1)))) => ((! [Xf1:$i] : (! [Xn:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz))) => (cwrex @ (^ [Xp:$i] : ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) != ccc0)) @ (^ [Xp:$i] : (ccrn @ XF)))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XT @ cc2nd) = XN))) => (! [Xf1:$i] : ((Xph @ Xf1) => (XF = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (cco @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccfv @ XT @ cc1st) @ cc1st)) @ (ccif @ ((ccv @ Xn) = (ccfv @ XN @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd))) @ cc1 @ ccc0) @ ccmin))) @ (ccun @ (ccxp @ (ccima @ (cccom @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = cc1) @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccmin))))) @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (cccom @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = cc1) @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccmin))))) @ (cco @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))))))))))))))).
...
thf(cpoimirlem20_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xf1) = (ccrab @ (^ [Xt:$i] : (XF = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xt) @ cc2nd) @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))) @ (cco @ ccc0 @ XN @ ccfz))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwf @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ XF)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XT @ (XS @ Xf1)))) => ((! [Xf1:$i] : (! [Xn:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz))) => (cwrex @ (^ [Xp:$i] : ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) != ccc0)) @ (^ [Xp:$i] : (ccrn @ XF)))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XT @ cc2nd) = XN))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwrex @ (^ [Xz:$i] : ((ccv @ Xz) != XT)) @ (^ [Xz:$i] : (XS @ Xf1)))))))))))))))))).
