...
thf(csetsstruct2_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwbr @ XG @ XX @ ccstr) & (cwcel @ XE @ XV) & (cwcel @ XI @ ccn)) & (XY = (ccop @ (ccif @ (cwbr @ XI @ (ccfv @ XX @ cc1st) @ ccle) @ XI @ (ccfv @ XX @ cc1st)) @ (ccif @ (cwbr @ XI @ (ccfv @ XX @ cc2nd) @ ccle) @ (ccfv @ XX @ cc2nd) @ XI)))) => (cwbr @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ XY @ ccstr))))))))).
