...
thf(akmlem4_thm,axiom,(! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) & ((ccv @ Xz) != (ccv @ Xw))) => ((ccin @ (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz))))) @ (ccv @ Xw)) = cc0)))))).
...
thf(ckmlem11_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : ((XA2 @ Xx3 @ Xu @ Xt) = (^ [Xu:$i] : (cwrex @ (^ [Xt:$i] : ((ccv @ Xu) = (ccdif @ (ccv @ Xt) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xt))))))) @ (^ [Xt:$i] : (ccv @ Xx3)))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) => ((ccin @ (ccv @ Xz) @ (ccuni @ (XA2 @ Xx3 @ Xu @ Xt))) = (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz)))))))))))))).
