...
thf(creprpmtf1o_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => ((! [Xc:$i] : ((XO @ Xc) = (ccrab @ (^ [Xc:$i] : (~ (cwcel @ (ccfv @ ccc0 @ (ccv @ Xc)) @ XB2))) @ (^ [Xc:$i] : (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))))) => ((XP = (ccrab @ (^ [Xc:$i] : (~ (cwcel @ (ccfv @ XX @ (ccv @ Xc)) @ XB2))) @ (^ [Xc:$i] : (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))))) => ((XT = (ccif @ (XX = ccc0) @ (ccres @ ccid @ (cco @ ccc0 @ XS @ ccfzo)) @ (ccfv @ (ccpr @ XX @ ccc0) @ (ccfv @ (cco @ ccc0 @ XS @ ccfzo) @ ccpmtr)))) => ((! [Xc:$i] : ((XF @ Xc) = (ccmpt @ (^ [Xc:$i] : XP) @ (^ [Xc:$i] : (cccom @ (ccv @ Xc) @ XT))))) => (! [Xc:$i] : (Xph => (cwf1o @ XP @ (XO @ Xc) @ (XF @ Xc))))))))))))))))))))))).
