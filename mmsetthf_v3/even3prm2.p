...
thf(ceven3prm2_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ cceven) & ((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime) & (cwcel @ XR @ ccprime)) & (XN = (cco @ (cco @ XP @ XQ @ ccaddc) @ XR @ ccaddc))) => ((XP = cc2) | (XQ = cc2) | (XR = cc2)))))))).
