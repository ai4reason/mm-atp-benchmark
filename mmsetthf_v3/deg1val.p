...
thf(cdeg1val_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XA2 = (ccfv @ XF @ ccco1)) => ((cwcel @ XF @ XB2) => ((ccfv @ XF @ XD) = (ccsup @ (cco @ XA2 @ Xc_0 @ ccsupp) @ ccxr @ cclt)))))))))))))))).
