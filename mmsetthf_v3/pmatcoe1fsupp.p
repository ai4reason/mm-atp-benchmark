...
thf(afsuppmapnn0fiub0_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (((cwss @ XM @ (cco @ XR @ ccn0 @ ccmap)) & (cwcel @ XM @ ccfn) & (cwcel @ XZ @ XV)) => ((cwral @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XZ @ ccfsupp)) @ (^ [Xf1:$i] : XM)) => (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xm) @ (ccv @ Xx3) @ cclt) => ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) = XZ))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xf1:$i] : XM))) @ (^ [Xm:$i] : ccn0))))))))).
