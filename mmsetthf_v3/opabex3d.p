...
thf(copabex3d_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ ccvv)))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3 @ Xy1))))) @ ccvv))))))))).
