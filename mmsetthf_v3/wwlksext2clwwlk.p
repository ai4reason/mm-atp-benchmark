...
thf(cwwlksext2clwwlk_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) & (cwcel @ XZ @ XV)) => (((cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) & (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)) => (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ (cco @ XN @ cc2 @ ccaddc) @ XG @ ccclwwlkn))))))))))))).
