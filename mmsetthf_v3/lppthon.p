...
thf(clppthon_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccuhgr) & (cwcel @ XJ @ (ccdm @ XI)) & ((ccfv @ XJ @ XI) = (ccsn @ XA2))) => (cwbr @ (ccs1 @ XJ) @ (ccs2 @ XA2 @ XA2) @ (cco @ XA2 @ XA2 @ (ccfv @ XG @ ccpthson)))))))))).
