...
thf(cltsubadd2b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr))) => ((cwbr @ (cco @ XD @ XC @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ cclt) <=> (cwbr @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))).
