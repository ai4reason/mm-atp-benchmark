...
thf(asetsfun0_thm,axiom,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XG @ XV) & (cwfun @ (ccdif @ XG @ (ccsn @ cc0)))) & ((cwcel @ XI @ XU) & (cwcel @ XE @ XW))) => (cwfun @ (ccdif @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ (ccsn @ cc0))))))))))).
thf(csetsn0fun_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XS @ XX @ ccstr)) => ((Xph => (cwcel @ XI @ XU)) => ((Xph => (cwcel @ XE @ XW)) => (Xph => (cwfun @ (ccdif @ (cco @ XS @ (ccop @ XI @ XE) @ ccsts) @ (ccsn @ cc0))))))))))))))).
