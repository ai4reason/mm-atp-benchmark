...
thf(csotri2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwor @ XS @ XR) => ((cwss @ XR @ (ccxp @ XS @ XS)) => (((cwcel @ XA2 @ XS) & (~ (cwbr @ XB2 @ XA2 @ XR)) & (cwbr @ XB2 @ XC @ XR)) => (cwbr @ XA2 @ XC @ XR)))))))))).
