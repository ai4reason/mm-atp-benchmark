...
thf(aelrn2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwcel @ XA2 @ (ccrn @ XB2)) <=> (? [Xx3:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ XA2) @ XB2))))))))).
thf(cfvrnressn_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((cwcel @ (ccfv @ XX @ XF) @ (ccrn @ (ccres @ XF @ (ccsn @ XX)))) => (cwcel @ (ccfv @ XX @ XF) @ (ccrn @ XF)))))))).
