...
thf(cfmtnofac1_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XM @ ccn) & (cwbr @ XM @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => (cwrex @ (^ [Xk:$i] : (XM = (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))))).
