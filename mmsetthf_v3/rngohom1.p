...
thf(crngohom1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XH = (ccfv @ XR @ cc2nd)) => ((XU = (ccfv @ XH @ ccgi)) => ((XK = (ccfv @ XS @ cc2nd)) => ((XV = (ccfv @ XK @ ccgi)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) => ((ccfv @ XU @ XF) = XV)))))))))))))).
