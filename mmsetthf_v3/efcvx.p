...
thf(areefiso_thm,axiom,(cwiso @ ccr @ ccrp @ cclt @ cclt @ (ccres @ cce @ ccr))).
thf(aioossre_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ ccr)))).
thf(aeqidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (Xph => (XA2 = XA2))))).
thf(aisores3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (cwss @ XK @ XA2) & (XX = (ccima @ XH @ XK))) => (cwiso @ XK @ XX @ XR @ XS @ (ccres @ XH @ XK))))))))))).
...
thf(cefcvx_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XA2 @ XB2 @ cclt)) & (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) => (cwbr @ (ccfv @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc) @ cce) @ (cco @ (cco @ XT @ (ccfv @ XA2 @ cce) @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ XB2 @ cce) @ ccmul) @ ccaddc) @ cclt)))))).
