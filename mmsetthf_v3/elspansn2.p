...
thf(celspansn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil) & (XB2 != cc0v)) => ((cwcel @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn)) <=> (XA2 = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XB2 @ ccsp) @ ccdiv) @ XB2 @ ccsm))))))).
