...
thf(aps_2_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & ((cwcel @ XS @ XA2) & (cwcel @ XT @ XA2))) & (((~ (cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)) & (XS != XT)) & ((cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) & (cwbr @ XT @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))) => (cwrex @ (^ [Xu:$i] : ((cwbr @ (ccv @ Xu) @ (cco @ XP @ XR @ Xc_or) @ Xc_le) & (cwbr @ (ccv @ Xu) @ (cco @ XS @ XT @ Xc_or) @ Xc_le))) @ (^ [Xu:$i] : XA2)))))))))))))))).
