...
thf(cmrcss_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XV) & (cwss @ XV @ XX)) => (cwss @ (ccfv @ XU @ XF) @ (ccfv @ XV @ XF)))))))))).
