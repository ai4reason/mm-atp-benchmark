...
thf(amzpcompact2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xc:$i] : ((cwcel @ (XA2 @ Xc) @ (ccfv @ XB2 @ ccmzp)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwss @ (ccv @ Xa) @ XB2) & ((XA2 @ Xc) = (ccmpt @ (^ [Xc:$i] : (cco @ ccz @ XB2 @ ccmap)) @ (^ [Xc:$i] : (ccfv @ (ccres @ (ccv @ Xc) @ (ccv @ Xa)) @ (ccv @ Xb))))))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xa) @ ccmzp)))) @ (^ [Xa:$i] : ccfn))))))).
...
thf(aeldioph2lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccfn) & (cwss @ (cco @ cc1 @ XN @ ccfz) @ XA2)) => (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ XA2 @ (ccv @ Xe)) & ((ccres @ (ccv @ Xe) @ (cco @ cc1 @ XN @ ccfz)) = (ccres @ ccid @ (cco @ cc1 @ XN @ ccfz))))) @ (^ [Xe:$i] : ccvv))) @ (^ [Xd:$i] : (ccfv @ XN @ ccuz))))))).
...
thf(amapco2g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (((cwcel @ XE @ ccvv) & (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) & (cwf @ XE @ XC @ XD)) => (cwcel @ (cccom @ XA2 @ XD) @ (cco @ XB2 @ XE @ ccmap))))))))).
...
thf(adiophrw_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (((cwcel @ XS @ ccvv) & (cwf1 @ XT @ XS @ XM) & ((ccres @ XM @ XO) = (ccres @ ccid @ XO))) => ((^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (((ccv @ Xa) = (ccres @ (ccv @ Xb) @ XO)) & ((ccfv @ (ccv @ Xb) @ (ccmpt @ (^ [Xd:$i] : (cco @ ccz @ XS @ ccmap)) @ (^ [Xd:$i] : (ccfv @ (cccom @ (ccv @ Xd) @ XM) @ (XP @ Xa))))) = ccc0))) @ (^ [Xb:$i] : (cco @ ccn0 @ XS @ ccmap)))) = (^ [Xa:$i] : (cwrex @ (^ [Xc:$i] : (((ccv @ Xa) = (ccres @ (ccv @ Xc) @ XO)) & ((ccfv @ (ccv @ Xc) @ (XP @ Xa)) = ccc0))) @ (^ [Xc:$i] : (cco @ ccn0 @ XT @ ccmap)))))))))))).
...
thf(amzprename_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ ccvv) & (cwcel @ XF @ (ccfv @ XV @ ccmzp)) & (cwf @ XV @ XW @ XR)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (cccom @ (ccv @ Xx3) @ XR) @ XF))) @ (ccfv @ XW @ ccmzp)))))))).
thf(aeldioph_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ (ccfv @ XN @ ccuz)) & (cwcel @ XP @ (ccfv @ (cco @ cc1 @ XK @ ccfz) @ ccmzp))) => (cwcel @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ XP) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ XK @ ccfz) @ ccmap)))) @ (ccfv @ XN @ ccdioph))))))).
thf(celdioph2_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & ((cwcel @ XS @ ccvv) & (cwss @ (cco @ cc1 @ XN @ ccfz) @ XS)) & (cwcel @ XP @ (ccfv @ XS @ ccmzp))) => (cwcel @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ XP) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ XS @ ccmap)))) @ (ccfv @ XN @ ccdioph))))))).
