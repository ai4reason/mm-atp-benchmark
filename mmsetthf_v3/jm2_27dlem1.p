...
thf(cjm2_27dlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XA2 @ (cco @ cc1 @ XB2 @ ccfz)) => (((ccv @ Xa) = (ccres @ (ccv @ Xb) @ (cco @ cc1 @ XB2 @ ccfz))) => ((ccfv @ XA2 @ (ccv @ Xa)) = (ccfv @ XA2 @ (ccv @ Xb)))))))))).
