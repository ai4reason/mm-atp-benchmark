...
thf(albsind2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XJ = (ccfv @ XW @ cclbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_1 = (ccfv @ XF @ ccur)) => ((Xc_0 = (ccfv @ XF @ cc0g)) => ((((cwcel @ XW @ cclmod) & (Xc_1 != Xc_0)) & (cwcel @ XB2 @ XJ) & (cwcel @ XE @ XB2)) => (~ (cwcel @ XE @ (ccfv @ (ccdif @ XB2 @ (ccsn @ XE)) @ XN)))))))))))))))))).
...
thf(cislbs2_conj,conjecture,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cclbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((cwcel @ XW @ cclvec) => ((cwcel @ XB2 @ XJ) <=> ((cwss @ XB2 @ XV) & ((ccfv @ XB2 @ XN) = XV) & (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XB2 @ (ccsn @ (ccv @ Xx3))) @ XN)))) @ (^ [Xx3:$i] : XB2)))))))))))))).
