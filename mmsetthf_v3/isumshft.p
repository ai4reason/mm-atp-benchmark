...
thf(aisershft_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ (ccseq @ Xc_pl @ XF @ XM) @ XA2 @ ccli) <=> (cwbr @ (ccseq @ Xc_pl @ (cco @ XF @ XN @ ccshi) @ (cco @ XM @ XN @ ccaddc)) @ XA2 @ ccli)))))))))).
...
thf(cisumshft_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : ((XZ @ Xj) = (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (XW = (ccfv @ (cco @ (XM @ Xj @ Xk) @ XK @ ccaddc) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (cco @ XK @ (ccv @ Xk) @ ccaddc)) => ((XA2 @ Xj) = (XB2 @ Xk))))) => ((Xph => (cwcel @ XK @ ccz)) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XW)) => (cwcel @ (XA2 @ Xj) @ ccc))) => (! [Xj:$i] : (Xph => ((ccsu @ XW @ (^ [Xj:$i] : (XA2 @ Xj))) = (ccsu @ (XZ @ Xj) @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))))))))))).
