...
thf(cerclwwlkntr_conj,conjecture,(! [Xc_sm:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((XW @ Xx3 @ Xy1 @ Xz) = (cco @ (XN @ Xy1 @ Xz) @ (XG @ Xx3 @ Xy1 @ Xz @ Xu @ Xt @ Xn) @ ccclwwlkn)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xz @ Xu @ Xt @ Xn) = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : ((cwcel @ (ccv @ Xt) @ (XW @ Xx3 @ Xy1 @ Xz)) & (cwcel @ (ccv @ Xu) @ (XW @ Xx3 @ Xy1 @ Xz)) & (cwrex @ (^ [Xn:$i] : ((ccv @ Xt) = (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ (XN @ Xy1 @ Xz) @ ccfz)))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_sm @ Xx3 @ Xy1 @ Xz @ Xu @ Xt @ Xn)) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_sm @ Xx3 @ Xy1 @ Xz @ Xu @ Xt @ Xn))) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_sm @ Xx3 @ Xy1 @ Xz @ Xu @ Xt @ Xn)))))))))))))))).
