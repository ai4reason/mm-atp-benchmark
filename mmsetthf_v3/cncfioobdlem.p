...
thf(ccncfioobdlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((! [Xx3:$i] : (Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ (XV @ Xx3) @ XF))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XA2) @ (XR @ Xx3) @ (ccif @ ((ccv @ Xx3) = XB2) @ (XL @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XF))))))) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => (! [Xx3:$i] : (Xph => ((ccfv @ XC @ (XG @ Xx3)) = (ccfv @ XC @ XF))))))))))))))))))).
