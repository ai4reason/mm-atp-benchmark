...
thf(celdioph2lem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn0) & (~ (cwcel @ XS @ ccfn))) & ((cwss @ (cco @ cc1 @ XN @ ccfz) @ XS) & (cwcel @ XA2 @ (ccfv @ XN @ ccuz)))) => (? [Xc:$i] : ((cwf1 @ (cco @ cc1 @ XA2 @ ccfz) @ XS @ (ccv @ Xc)) & ((ccres @ (ccv @ Xc) @ (cco @ cc1 @ XN @ ccfz)) = (ccres @ ccid @ (cco @ cc1 @ XN @ ccfz)))))))))).
