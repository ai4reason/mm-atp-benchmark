...
thf(cmodmul12d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((Xph => (cwcel @ XC @ ccz)) => ((Xph => (cwcel @ XD @ ccz)) => ((Xph => (cwcel @ XE @ ccrp)) => ((Xph => ((cco @ XA2 @ XE @ ccmo) = (cco @ XB2 @ XE @ ccmo))) => ((Xph => ((cco @ XC @ XE @ ccmo) = (cco @ XD @ XE @ ccmo))) => (Xph => ((cco @ (cco @ XA2 @ XC @ ccmul) @ XE @ ccmo) = (cco @ (cco @ XB2 @ XD @ ccmul) @ XE @ ccmo))))))))))))))))).
