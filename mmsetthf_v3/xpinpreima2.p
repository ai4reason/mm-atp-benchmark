...
thf(cxpinpreima2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ XE) & (cwss @ XB2 @ XF)) => ((ccxp @ XA2 @ XB2) = (ccin @ (ccima @ (cccnv @ (ccres @ cc1st @ (ccxp @ XE @ XF))) @ XA2) @ (ccima @ (cccnv @ (ccres @ cc2nd @ (ccxp @ XE @ XF))) @ XB2))))))))).
