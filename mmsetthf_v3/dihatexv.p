...
thf(adihlatat_thm,axiom,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XL = (ccfv @ XU @ cclsa)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XQ @ XL)) => (cwcel @ (ccfv @ XQ @ (cccnv @ XI)) @ XA2)))))))))))))))).
...
thf(cdihatexv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ XK @ cclh))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xx3:$i] : (XV = (ccfv @ (XU @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ (XU @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (XN = (ccfv @ (XU @ Xx3) @ cclspn))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((! [Xx3:$i] : (Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xx3))))) => ((Xph => (cwcel @ XQ @ XB2)) => (Xph => ((cwcel @ XQ @ XA2) <=> (cwrex @ (^ [Xx3:$i] : ((ccfv @ XQ @ XI) = (ccfv @ (ccsn @ (ccv @ Xx3)) @ XN))) @ (^ [Xx3:$i] : (ccdif @ XV @ (ccsn @ (Xc_0 @ Xx3)))))))))))))))))))))))))))))).
