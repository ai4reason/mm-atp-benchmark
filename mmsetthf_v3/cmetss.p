...
thf(acfilres_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwcel @ XY @ XF)) => ((cwcel @ XF @ (ccfv @ XD @ cccfil)) <=> (cwcel @ (cco @ XF @ XY @ ccrest) @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ cccfil))))))))).
...
thf(amopick_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xx3:$i] : (((cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) & (? [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3)))) => ((Xph @ Xx3) => (Xps @ Xx3))))))).
...
thf(acfilresi_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XF @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ cccfil))) => (cwcel @ (cco @ XX @ XF @ ccfg) @ (ccfv @ XD @ cccfil)))))))).
