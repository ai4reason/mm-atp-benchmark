...
thf(cnb3gr2nb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XZ)) & (((ccfv @ XG @ ccvtx) = (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ XG @ ccusgr))) => ((((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ XB2 @ XC)) & ((cco @ XG @ XB2 @ ccnbgr) = (ccpr @ XA2 @ XC))) <=> (((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ XB2 @ XC)) & ((cco @ XG @ XB2 @ ccnbgr) = (ccpr @ XA2 @ XC)) & ((cco @ XG @ XC @ ccnbgr) = (ccpr @ XA2 @ XB2))))))))))))).
