...
thf(cdivlimc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccdiv))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XX @ (cco @ (XF @ Xx3) @ XD @ cclimc)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XY @ (cco @ (XG @ Xx3) @ XD @ cclimc)))) => ((Xph => (XY != ccc0)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => ((XC @ Xx3) != ccc0))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ XX @ XY @ ccdiv) @ (cco @ (XH @ Xx3) @ XD @ cclimc)))))))))))))))))))))))).
