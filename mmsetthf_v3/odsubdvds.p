...
thf(asubgod_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((XH = (cco @ XG @ XY @ ccress)) => ((XO = (ccfv @ XG @ ccod)) => ((XP = (ccfv @ XH @ ccod)) => (((cwcel @ XY @ (ccfv @ XG @ ccsubg)) & (cwcel @ XA2 @ XY)) => ((ccfv @ XA2 @ XO) = (ccfv @ XA2 @ XP))))))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(codsubdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XS @ ccfn) & (cwcel @ XA2 @ XS)) => (cwbr @ (ccfv @ XA2 @ XO) @ (ccfv @ XS @ cchash) @ ccdvds)))))))).
