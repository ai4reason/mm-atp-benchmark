...
thf(cdalemccea_conj,conjecture,(! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xc:$i] : (! [Xd:$i] : ((Xps @ Xc @ Xd) <=> (((cwcel @ (ccv @ Xc) @ (XA2 @ Xc @ Xd)) & (cwcel @ (ccv @ Xd) @ (XA2 @ Xc @ Xd))) & (~ (cwbr @ (ccv @ Xc) @ (XY @ Xc @ Xd) @ (Xc_le @ Xc @ Xd))) & (((ccv @ Xd) != (ccv @ Xc)) & (~ (cwbr @ (ccv @ Xd) @ (XY @ Xc @ Xd) @ (Xc_le @ Xc @ Xd))) & (cwbr @ (XC @ Xc @ Xd) @ (cco @ (ccv @ Xc) @ (ccv @ Xd) @ (Xc_or @ Xc @ Xd)) @ (Xc_le @ Xc @ Xd))))))) => (! [Xc:$i] : (! [Xd:$i] : ((Xps @ Xc @ Xd) => (cwcel @ (ccv @ Xc) @ (XA2 @ Xc @ Xd))))))))))))).
