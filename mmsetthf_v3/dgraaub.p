...
thf(aelqaa_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) <=> ((cwcel @ XA2 @ ccc) & (cwrex @ (^ [Xf1:$i] : ((ccfv @ XA2 @ (ccv @ Xf1)) = ccc0)) @ (^ [Xf1:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))).
thf(adgraaval_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ XA2 @ ccdgraa) = (ccinf @ (ccrab @ (^ [Xd:$i] : (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xp) @ ccdgr) = (ccv @ Xd)) & ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p))))) @ (^ [Xd:$i] : ccn)) @ ccr @ cclt))))).
...
thf(adgrnznn_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((((cwcel @ XP @ (ccfv @ XS @ ccply)) & (XP != cc0p)) & ((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ XP) = ccc0))) => (cwcel @ (ccfv @ XP @ ccdgr) @ ccn)))))).
...
thf(cdgraaub_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((((cwcel @ XP @ (ccfv @ ccq @ ccply)) & (XP != cc0p)) & ((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ XP) = ccc0))) => (cwbr @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ XP @ ccdgr) @ ccle))))).
