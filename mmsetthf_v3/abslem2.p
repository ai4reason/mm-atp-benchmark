...
thf(cabslem2_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) => ((cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv) @ cccj) @ XA2 @ ccmul) @ (cco @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv) @ (ccfv @ XA2 @ cccj) @ ccmul) @ ccaddc) = (cco @ cc2 @ (ccfv @ XA2 @ ccabs) @ ccmul))))).
