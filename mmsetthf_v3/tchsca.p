...
thf(atngsca_thm,axiom,(! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XF = (ccfv @ XG @ ccsca)) => ((cwcel @ XN @ XV) => (XF = (ccfv @ XT @ ccsca))))))))))).
...
thf(ctchsca_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XF = (ccfv @ XW @ ccsca)) => (XF = (ccfv @ XG @ ccsca)))))))).
