...
thf(arevval_thm,axiom,(! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xx3:$i] : ((cwcel @ XW @ (XV @ Xx3)) => ((ccfv @ XW @ ccreverse) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccv @ Xx3) @ ccmin) @ XW))))))))).
...
thf(crepswrevw_conj,conjecture,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XS @ XN @ ccreps) @ ccreverse) = (cco @ XS @ XN @ ccreps))))))).
