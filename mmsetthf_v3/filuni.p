...
thf(aisfild_b_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ XA2)) => ((Xph => (~ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ cc0))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xx3)) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwss @ (ccv @ Xy1) @ XA2) & (cwss @ (ccv @ Xx3) @ XA2)) => (((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xy1)) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xx3))) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xx3))))))) => (Xph => (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
...
thf(cfiluni_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XF @ (ccfv @ XX @ ccfil)) & (XF != cc0) & (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : (cwcel @ (ccun @ (ccv @ Xf1) @ (ccv @ Xg1)) @ XF)) @ (^ [Xg1:$i] : XF))) @ (^ [Xf1:$i] : XF))) => (cwcel @ (ccuni @ XF) @ (ccfv @ XX @ ccfil)))))).
