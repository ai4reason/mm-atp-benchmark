...
thf(asringcat_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : ((! [Xs1:$i] : (cwral @ (^ [Xr:$i] : (cwcel @ (ccv @ Xr) @ ccrg)) @ (^ [Xr:$i] : (XS @ Xs1)))) => ((! [Xs1:$i] : (XC = (ccin @ XU @ (XS @ Xs1)))) => ((! [Xs1:$i] : (! [Xr:$i] : ((XJ @ Xs1 @ Xr) = (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : XC)) @ (^ [Xr:$i] : (^ [Xs1:$i] : XC)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccrh))))))) => (! [Xs1:$i] : (! [Xr:$i] : ((cwcel @ XU @ XV) => (cwcel @ (cco @ (ccfv @ XU @ ccringc) @ (XJ @ Xs1 @ Xr) @ ccresc) @ cccat))))))))))))).
