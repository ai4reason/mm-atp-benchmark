...
thf(cleexp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (cwbr @ cc1 @ XA2 @ cclt)) => ((cwbr @ XM @ XN @ ccle) <=> (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle))))))).
