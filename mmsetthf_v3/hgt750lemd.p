...
thf(achtvalz_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccfv @ XN @ cccht) = (ccsu @ (ccin @ (cco @ cc1 @ XN @ ccfz) @ ccprime) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ cclog))))))).
...
thf(aexpm1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) = (cco @ (cco @ XA2 @ XN @ ccexp) @ XA2 @ ccdiv)))))).
...
thf(chgt750lemd_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ XN @ ccle)) => (Xph => (cwbr @ (ccsu @ (ccun @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ ccprime) @ (ccsn @ cc2)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ ccvma))) @ (cco @ (cco @ cc1 @ (ccdp2 @ cc4 @ (ccdp2 @ cc2 @ (ccdp2 @ cc6 @ cc3))) @ ccdp) @ (ccfv @ XN @ ccsqrt) @ ccmul) @ cclt))))))).
