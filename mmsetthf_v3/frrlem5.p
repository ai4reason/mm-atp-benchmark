...
thf(afrss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwfr @ XB2 @ XR) => (cwfr @ XA2 @ XR))))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(asess2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwse @ XB2 @ XR) => (cwse @ XA2 @ XR))))))).
thf(afrrlem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xh) = (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (cco @ (ccv @ Xy1) @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((cwcel @ (ccv @ Xg1) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xh)) & (cwcel @ (ccv @ Xh) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xh))) => ((cwfn @ (ccres @ (ccv @ Xg1) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh)))) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh)))) & (cwral @ (^ [Xa:$i] : ((ccfv @ (ccv @ Xa) @ (ccres @ (ccv @ Xg1) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh))))) = (cco @ (ccv @ Xa) @ (ccres @ (ccres @ (ccv @ Xg1) @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh)))) @ (ccpred @ (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh))) @ XR @ (ccv @ Xa))) @ XG))) @ (^ [Xa:$i] : (ccin @ (ccdm @ (ccv @ Xg1)) @ (ccdm @ (ccv @ Xh)))))))))))))))))).
...
thf(afrrlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1) = (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (cco @ (ccv @ Xy1) @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1)) => (cwfun @ (ccv @ Xg1))))))))))))).
...
thf(cfrrlem5_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xu:$i] : (cwfr @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu)))) => ((! [Xv:$i] : (! [Xu:$i] : (cwse @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu)))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : ((XB2 @ Xy1 @ Xf1) = (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ (XA2 @ Xv @ Xu)) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu) @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (cco @ (ccv @ Xy1) @ (ccres @ (ccv @ Xf1) @ (ccpred @ (XA2 @ Xv @ Xu) @ (XR @ Xv @ Xu) @ (ccv @ Xy1))) @ (XG @ Xv @ Xu)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((cwcel @ (ccv @ Xg1) @ (XB2 @ Xy1 @ Xf1)) & (cwcel @ (ccv @ Xh) @ (XB2 @ Xy1 @ Xf1))) => (((cwbr @ (ccv @ Xx3) @ (ccv @ Xu) @ (ccv @ Xg1)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xv) @ (ccv @ Xh))) => ((ccv @ Xu) = (ccv @ Xv))))))))))))))))))).
