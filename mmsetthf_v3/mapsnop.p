...
thf(cmapsnop_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccsn @ (ccop @ XX @ XY))) => (((cwcel @ XX @ XV) & (cwcel @ XY @ XR) & (cwcel @ XR @ XW)) => (cwcel @ XF @ (cco @ XR @ (ccsn @ XX) @ ccmap))))))))))).
