...
thf(agchacg_thm,axiom,(! [XA2:($i > $o)] : (((cwbr @ ccom @ XA2 @ ccdom) & (cwcel @ XA2 @ ccgch) & (cwcel @ (ccpw @ XA2) @ ccgch)) => (cwcel @ (ccpw @ XA2) @ (ccdm @ cccrd))))).
...
thf(cgchac_conj,conjecture,((ccgch = ccvv) => cwac)).
