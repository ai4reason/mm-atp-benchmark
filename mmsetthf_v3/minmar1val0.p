...
thf(aminmar1fval_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : ((XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) = (cco @ XN @ XR @ ccmat))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : ((XB2 @ Xi @ Xj @ Xk @ Xl) = (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xl) @ ccbs))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : ((XQ @ Xi @ Xj @ Xk @ Xm @ Xl) = (cco @ XN @ XR @ ccminmar1))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : ((Xc_1 @ Xi @ Xj @ Xk @ Xm @ Xl) = (ccfv @ XR @ ccur))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : ((Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xl) = (ccfv @ XR @ cc0g))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xl:$i] : ((XQ @ Xi @ Xj @ Xk @ Xm @ Xl) = (ccmpt @ (^ [Xm:$i] : (XB2 @ Xi @ Xj @ Xk @ Xl)) @ (^ [Xm:$i] : (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = (ccv @ Xk)) @ (ccif @ ((ccv @ Xj) = (ccv @ Xl)) @ (Xc_1 @ Xi @ Xj @ Xk @ Xm @ Xl) @ (Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xl)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)))))))))))))))))))))))))))))).
