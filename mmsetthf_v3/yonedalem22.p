...
thf(ayoncl_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XC @ ccyon)) => ((Xph => (cwcel @ XC @ cccat)) => ((XO = (ccfv @ XC @ ccoppc)) => ((XS = (ccfv @ XU @ ccsetc)) => ((XQ = (cco @ XO @ XS @ ccfuc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => (Xph => (cwcel @ XY @ (cco @ XC @ XQ @ ccfunc))))))))))))))))))).
...
thf(atposex_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwcel @ (cctpos @ XF) @ ccvv)))).
...
thf(aprf2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (cco @ XF @ XG @ ccprf)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XC @ XE @ ccfunc))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XK @ (cco @ XX @ XY @ XH))) => (Xph => ((ccfv @ XK @ (cco @ XX @ XY @ (ccfv @ XP @ cc2nd))) = (ccop @ (ccfv @ XK @ (cco @ XX @ XY @ (ccfv @ XF @ cc2nd))) @ (ccfv @ XK @ (cco @ XX @ XY @ (ccfv @ XG @ cc2nd))))))))))))))))))))))))))).
...
thf(cyonedalem22_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (ccfv @ XC @ ccyon)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((XO = (ccfv @ XC @ ccoppc)) => ((XS = (ccfv @ XU @ ccsetc)) => ((XT = (ccfv @ XV @ ccsetc)) => ((XQ = (cco @ XO @ XS @ ccfuc)) => ((XH = (ccfv @ XQ @ cchof)) => ((XR = (cco @ (cco @ XQ @ XO @ ccxpc) @ XT @ ccfuc)) => ((XE = (cco @ XO @ XS @ ccevlf)) => ((XZ = (cco @ XH @ (cco @ (cco @ (ccop @ (ccfv @ XY @ cc1st) @ (cctpos @ (ccfv @ XY @ cc2nd))) @ (cco @ XQ @ XO @ cc2ndf) @ cccofu) @ (cco @ XQ @ XO @ cc1stf) @ ccprf) @ cccofu)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XV @ XW)) => ((Xph => (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => ((Xph => (cwss @ (ccun @ (ccrn @ (ccfv @ XQ @ cchomf)) @ XU) @ XV)) => ((Xph => (cwcel @ XF @ (cco @ XO @ XS @ ccfunc))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XG @ (cco @ XO @ XS @ ccfunc))) => ((Xph => (cwcel @ XP @ XB2)) => ((Xph => (cwcel @ XA2 @ (cco @ XF @ XG @ (cco @ XO @ XS @ ccnat)))) => ((Xph => (cwcel @ XK @ (cco @ XP @ XX @ (ccfv @ XC @ cchom)))) => (Xph => ((cco @ XA2 @ XK @ (cco @ (ccop @ XF @ XX) @ (ccop @ XG @ XP) @ (ccfv @ XZ @ cc2nd))) = (cco @ (ccfv @ XK @ (cco @ XP @ XX @ (ccfv @ XY @ cc2nd))) @ XA2 @ (cco @ (ccop @ (ccfv @ XX @ (ccfv @ XY @ cc1st)) @ XF) @ (ccop @ (ccfv @ XP @ (ccfv @ XY @ cc1st)) @ XG) @ (ccfv @ XH @ cc2nd))))))))))))))))))))))))))))))))))))))))))))))))).
