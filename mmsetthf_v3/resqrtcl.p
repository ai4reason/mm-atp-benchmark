...
thf(arennim_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwnel @ (cco @ cci @ XA2 @ ccmul) @ ccrp)))).
...
thf(cresqrtcl_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccr)))).
