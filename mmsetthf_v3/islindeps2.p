...
thf(alincext2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xz:$i] : ((XR @ Xz) = (ccfv @ XM @ ccsca))) => ((! [Xz:$i] : (XE = (ccfv @ (XR @ Xz) @ ccbs))) => ((! [Xz:$i] : ((Xc_0 @ Xz) = (ccfv @ (XR @ Xz) @ cc0g))) => ((! [Xz:$i] : ((XZ @ Xz) = (ccfv @ XM @ cc0g))) => ((! [Xz:$i] : ((XN @ Xz) = (ccfv @ (XR @ Xz) @ ccminusg))) => ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : XS) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XX) @ (ccfv @ XY @ (XN @ Xz)) @ (ccfv @ (ccv @ Xz) @ XG)))))) => (! [Xz:$i] : ((((cwcel @ XM @ cclmod) & (cwcel @ XS @ (ccpw @ XB2))) & ((cwcel @ XY @ XE) & (cwcel @ XX @ XS) & (cwcel @ XG @ (cco @ XE @ (ccdif @ XS @ (ccsn @ XX)) @ ccmap))) & (cwbr @ XG @ (Xc_0 @ Xz) @ ccfsupp)) => (cwbr @ (XF @ Xz) @ (Xc_0 @ Xz) @ ccfsupp))))))))))))))))))))))).
...
thf(alincext3_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xz:$i] : ((XR @ Xz) = (ccfv @ XM @ ccsca))) => ((! [Xz:$i] : (XE = (ccfv @ (XR @ Xz) @ ccbs))) => ((! [Xz:$i] : ((Xc_0 @ Xz) = (ccfv @ (XR @ Xz) @ cc0g))) => ((! [Xz:$i] : ((XZ @ Xz) = (ccfv @ XM @ cc0g))) => ((! [Xz:$i] : (XN = (ccfv @ (XR @ Xz) @ ccminusg))) => ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : XS) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XX) @ (ccfv @ XY @ XN) @ (ccfv @ (ccv @ Xz) @ XG)))))) => (! [Xz:$i] : ((((cwcel @ XM @ cclmod) & (cwcel @ XS @ (ccpw @ XB2))) & ((cwcel @ XY @ XE) & (cwcel @ XX @ XS) & (cwcel @ XG @ (cco @ XE @ (ccdif @ XS @ (ccsn @ XX)) @ ccmap))) & ((cwbr @ XG @ (Xc_0 @ Xz) @ ccfsupp) & ((cco @ XY @ XX @ (ccfv @ XM @ ccvsca)) = (cco @ XG @ (ccdif @ XS @ (ccsn @ XX)) @ (ccfv @ XM @ cclinc))))) => ((cco @ (XF @ Xz) @ XS @ (ccfv @ XM @ cclinc)) = (XZ @ Xz)))))))))))))))))))))))).
...
thf(alincext1_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xz:$i] : ((XR @ Xz) = (ccfv @ XM @ ccsca))) => ((! [Xz:$i] : (XE = (ccfv @ (XR @ Xz) @ ccbs))) => ((! [Xz:$i] : ((Xc_0 @ Xz) = (ccfv @ (XR @ Xz) @ cc0g))) => ((! [Xz:$i] : ((XZ @ Xz) = (ccfv @ XM @ cc0g))) => ((! [Xz:$i] : ((XN @ Xz) = (ccfv @ (XR @ Xz) @ ccminusg))) => ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : XS) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XX) @ (ccfv @ XY @ (XN @ Xz)) @ (ccfv @ (ccv @ Xz) @ XG)))))) => (! [Xz:$i] : ((((cwcel @ XM @ cclmod) & (cwcel @ XS @ (ccpw @ XB2))) & ((cwcel @ XY @ XE) & (cwcel @ XX @ XS) & (cwcel @ XG @ (cco @ XE @ (ccdif @ XS @ (ccsn @ XX)) @ ccmap)))) => (cwcel @ (XF @ Xz) @ (cco @ XE @ XS @ ccmap)))))))))))))))))))))))).
...
thf(cislindeps2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XZ = (ccfv @ XM @ cc0g)) => ((XR = (ccfv @ XM @ ccsca)) => ((XE = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XM @ cclmod) & (cwcel @ XS @ (ccpw @ XB2)) & (cwcel @ XR @ ccnzr)) => ((cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) & ((cco @ (ccv @ Xf1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ (ccfv @ XM @ cclinc)) = (ccv @ Xs1)))) @ (^ [Xf1:$i] : (cco @ XE @ (ccdif @ XS @ (ccsn @ (ccv @ Xs1))) @ ccmap)))) @ (^ [Xs1:$i] : XS)) => (cwbr @ XS @ XM @ cclindeps)))))))))))))))).
