...
thf(aaddclprlem1_thm,axiom,(! [Xx3:$i] : (! [XA2:($i > ($i > $o))] : (! [Xh:$i] : (! [Xg1:$i] : ((((cwcel @ (XA2 @ Xg1) @ ccnp) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xg1))) & (cwcel @ (ccv @ Xx3) @ ccnq)) => ((cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ ccplq) @ ccltq) => (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ ccplq) @ ccrq) @ ccmq) @ (ccv @ Xg1) @ ccmq) @ (XA2 @ Xg1))))))))).
