...
thf(agrpoidinvlem3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xz) <=> (cwral @ (^ [Xx3:$i] : ((cco @ XU @ (ccv @ Xx3) @ XG) = (ccv @ Xx3))) @ (^ [Xx3:$i] : XX))))) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xps @ Xx3 @ Xz) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XG) = XU)) @ (^ [Xz:$i] : XX))) @ (^ [Xx3:$i] : XX))))) => (! [Xx3:$i] : (! [Xz:$i] : (((((cwcel @ XG @ ccgr) & (cwcel @ XU @ XX)) & ((Xph @ Xx3 @ Xz) & (Xps @ Xx3 @ Xz))) & (cwcel @ XA2 @ XX)) => (cwrex @ (^ [Xy1:$i] : (((cco @ (ccv @ Xy1) @ XA2 @ XG) = XU) & ((cco @ XA2 @ (ccv @ Xy1) @ XG) = XU))) @ (^ [Xy1:$i] : XX))))))))))))))).
thf(abiid_thm,axiom,(! [Xph:$o] : (Xph <=> Xph))).
thf(agrpoidinvlem4_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((((cwcel @ XG @ ccgr) & (cwcel @ XA2 @ XX)) & (cwrex @ (^ [Xy1:$i] : (((cco @ (ccv @ Xy1) @ XA2 @ XG) = XU) & ((cco @ XA2 @ (ccv @ Xy1) @ XG) = XU))) @ (^ [Xy1:$i] : XX))) => ((cco @ XA2 @ XU @ XG) = (cco @ XU @ XA2 @ XG))))))))).
...
thf(cgrpoidinv_conj,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((cwcel @ XG @ ccgr) => (cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : ((((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xu) @ XG) = (ccv @ Xx3))) & (cwrex @ (^ [Xy1:$i] : (((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) = (ccv @ Xu)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) = (ccv @ Xu)))) @ (^ [Xy1:$i] : XX)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX))))))).
