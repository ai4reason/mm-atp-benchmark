...
thf(awfr2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((XF = (ccwrecs @ XA2 @ XR @ XG)) => ((cwcel @ XX @ XA2) => ((ccfv @ XX @ XF) = (ccfv @ (ccres @ XF @ (ccpred @ XA2 @ XR @ XX)) @ XG)))))))))))).
