...
thf(adirkerre_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (! [Xs1:$i] : ((XD @ Xn @ Xs1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ ((cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => (! [Xn:$i] : (! [Xs1:$i] : (((cwcel @ (XN @ Xn) @ ccn) & (cwcel @ (XS @ Xn @ Xs1) @ ccr)) => (cwcel @ (ccfv @ (XS @ Xn @ Xs1) @ (ccfv @ (XN @ Xn) @ (XD @ Xn @ Xs1))) @ ccr))))))))).
...
thf(adirkerf_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xn:$i] : ((XD @ Xy1 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ ((cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))) => (! [Xy1:$i] : (! [Xn:$i] : ((cwcel @ (XN @ Xn) @ ccn) => (cwf @ ccr @ ccr @ (ccfv @ (XN @ Xn) @ (XD @ Xy1 @ Xn)))))))))).
thf(ccfl_tp,type,(ccfl : ($i > $o))).
thf(cctg_tp,type,(cctg : ($i > $o))).
thf(adirkercncf_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : ((XD @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ ((cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))) => (! [Xn:$i] : ((cwcel @ (XN @ Xn) @ ccn) => (cwcel @ (ccfv @ (XN @ Xn) @ (XD @ Xn)) @ (cco @ ccr @ ccr @ cccncf)))))))).
...
thf(amullimcf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwf @ XA2 @ ccc @ XG)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccmul))))) => ((Xph => (cwcel @ XB2 @ (cco @ XF @ XD @ cclimc))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XC @ Xx3) @ (cco @ XG @ XD @ cclimc)))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ XB2 @ (XC @ Xx3) @ ccmul) @ (cco @ (XH @ Xx3) @ XD @ cclimc)))))))))))))))))).
thf(acncff_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf)) => (cwf @ XA2 @ XB2 @ XF)))))).
thf(affvelrnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwcel @ XC @ XA2)) => (Xph => (cwcel @ (ccfv @ XC @ XF) @ XB2)))))))))).
thf(aifeqda_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((Xph & Xps) => (XA2 = XC)) => (((Xph & (~ Xps)) => (XB2 = XC)) => (Xph => ((ccif @ Xps @ XA2 @ XB2) = XC)))))))))).
...
thf(aellimc_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : ((XJ @ Xz) = (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((! [Xz:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ XC @ (ccfv @ (ccv @ Xz) @ XF)))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwf @ XA2 @ ccc @ XF))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwss @ XA2 @ ccc))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XB2 @ ccc))) => (! [Xz:$i] : ((Xph @ Xz) => ((cwcel @ XC @ (cco @ XF @ XB2 @ cclimc)) <=> (cwcel @ (XG @ Xz) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ XK @ cccnp))))))))))))))))))))).
...
thf(cfourierdlem101_b_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XD @ Xi @ Xm @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ ((cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xm) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XP @ Xt @ Xi @ Xm @ Xs1 @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap))))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XG @ Xm @ Xp) = (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xi @ Xm @ Xs1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xt) @ (XX @ Xm @ Xp) @ ccmin) @ (ccfv @ (XN @ Xi @ Xp) @ (XD @ Xi @ Xm @ Xp))) @ ccmul)))))))) => ((! [Xt:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XQ @ Xm) @ (ccfv @ XM @ (XP @ Xt @ Xi @ Xm @ Xs1 @ Xp))))))))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XM @ ccn))) => ((! [Xi:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XN @ Xi @ Xp) @ ccn)))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XX @ Xm @ Xp) @ ccr)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwf @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccc @ (XF @ Xi @ Xm @ Xs1 @ Xp))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwcel @ (ccres @ (XF @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo) @ ccc @ cccncf))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwcel @ (XR @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ cclimc))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwcel @ (XL @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ cclimc))))))) => (! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xp) => ((ccitg @ (^ [Xt:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xi @ Xm @ Xs1 @ Xp)) @ (ccfv @ (cco @ (ccv @ Xt) @ (XX @ Xm @ Xp) @ ccmin) @ (ccfv @ (XN @ Xi @ Xp) @ (XD @ Xi @ Xm @ Xp))) @ ccmul))) = (ccitg @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ ccpi) @ (XX @ Xm @ Xp) @ ccmin) @ (cco @ ccpi @ (XX @ Xm @ Xp) @ ccmin) @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (cco @ (XX @ Xm @ Xp) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xi @ Xm @ Xs1 @ Xp)) @ (ccfv @ (ccv @ Xs1) @ (ccfv @ (XN @ Xi @ Xp) @ (XD @ Xi @ Xm @ Xp))) @ ccmul)))))))))))))))))))))))))))))))).
