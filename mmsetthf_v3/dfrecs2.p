...
thf(adfrecs3_thm,axiom,(! [XF:($i > $o)] : ((ccrecs @ XF) = (ccuni @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(cdfrecs2_conj,conjecture,(! [XF:($i > $o)] : ((ccrecs @ XF) = (ccuni @ (ccdif @ (ccin @ ccfuns @ (ccima @ (cccnv @ ccdomain) @ ccon0)) @ (ccdm @ (ccdif @ (cccom @ (cccnv @ ccep) @ ccdomain) @ (ccfix @ (cccom @ (cccnv @ ccapply) @ (cccom @ (ccfullfn @ XF) @ ccrestrict)))))))))).
