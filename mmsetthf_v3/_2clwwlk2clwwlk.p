...
thf(aclwwnonrepclwwnon_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & (cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) & ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) = XX)) => (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc2 @ ccmin)) @ ccsubstr) @ (cco @ XX @ (cco @ XN @ cc2 @ ccmin) @ (ccfv @ XG @ ccclwwlknon))))))))).
...
thf(a_2clwwlk2clwwlklem_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & (cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) & ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) = (ccfv @ ccc0 @ XW))) => (cwcel @ (cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) @ (cco @ XX @ cc2 @ (ccfv @ XG @ ccclwwlknon))))))))).
...
thf(aclwwlknonccat_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (cco @ XX @ XM @ (ccfv @ XG @ ccclwwlknon))) & (cwcel @ XB2 @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)))) => (cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (cco @ XX @ (cco @ XM @ XN @ ccaddc) @ (ccfv @ XG @ ccclwwlknon))))))))))).
