...
thf(aelrnust_thm,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (cwcel @ XU @ (ccuni @ (ccrn @ ccust))))))).
...
thf(adf_ucn_ax,axiom,(ccucn = (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccuni @ (ccrn @ ccust)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccuni @ (ccrn @ ccust)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) => (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (ccdm @ (ccuni @ (ccv @ Xu)))))) @ (^ [Xx3:$i] : (ccdm @ (ccuni @ (ccv @ Xu)))))) @ (^ [Xr:$i] : (ccv @ Xu)))) @ (^ [Xs1:$i] : (ccv @ Xv)))) @ (^ [Xf1:$i] : (cco @ (ccdm @ (ccuni @ (ccv @ Xv))) @ (ccdm @ (ccuni @ (ccv @ Xu))) @ ccmap)))))))).
...
thf(austbas2_thm,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (XX = (ccdm @ (ccuni @ XU))))))).
thf(aralbidv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwral @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
thf(arexbidv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
thf(cucnval_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xy1:$i] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ (XV @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccust))) => ((cco @ XU @ (XV @ Xy1) @ ccucn) = (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) => (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) @ (^ [Xr:$i] : XU))) @ (^ [Xs1:$i] : (XV @ Xy1)))) @ (^ [Xf1:$i] : (cco @ (XY @ Xy1) @ XX @ ccmap))))))))))).
