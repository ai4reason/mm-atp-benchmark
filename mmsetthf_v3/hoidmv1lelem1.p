...
thf(asge0ge0mpt_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ ccc0 @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ ccle))))))))))).
...
thf(aiccsupr_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ (XA2 @ Xx3) @ ccr) & (cwcel @ XB2 @ ccr)) & (cwss @ XS @ (cco @ (XA2 @ Xx3) @ XB2 @ ccicc)) & (cwcel @ (XC @ Xx3 @ Xy1) @ XS)) => ((cwss @ XS @ ccr) & (XS != cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : ccr))))))))))).
...
thf(choidmv1lelem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XA2 @ Xx3) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XB2 @ Xj) @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwbr @ (XA2 @ Xx3) @ (XB2 @ Xj) @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ ccn @ ccr @ (XC @ Xx3 @ Xy1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ ccn @ ccr @ (XD @ Xx3 @ Xy1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xy1 @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xy1 @ Xj)) @ ccico) @ ccvol))) @ ccsumge0) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : (XU = (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xz) @ (XA2 @ Xx3) @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xy1 @ Xj)) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xy1 @ Xj)) @ (ccv @ Xz) @ ccle) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xy1 @ Xj)) @ (ccv @ Xz)) @ ccico) @ ccvol))) @ ccsumge0) @ ccle)) @ (^ [Xz:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xj) @ ccicc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccsup @ XU @ ccr @ cclt)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwcel @ (XS @ Xx3 @ Xy1) @ XU) & (cwcel @ (XA2 @ Xx3) @ XU) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : ccr)))))))))))))))))))))).
