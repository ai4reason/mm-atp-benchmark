...
thf(asetsres_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => ((ccres @ (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts) @ (ccdif @ ccvv @ (ccsn @ XA2))) = (ccres @ XS @ (ccdif @ ccvv @ (ccsn @ XA2)))))))))).
...
thf(csetsnid_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XW:($i > $o)] : ((XE = (ccslot @ (ccfv @ ccnx @ XE))) => (((ccfv @ ccnx @ XE) != XD) => ((ccfv @ XW @ XE) = (ccfv @ (cco @ XW @ (ccop @ XD @ XC) @ ccsts) @ XE))))))))).
