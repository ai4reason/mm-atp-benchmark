...
thf(areldmtng_thm,axiom,(cwrel @ (ccdm @ cctng))).
thf(ctngds_conj,conjecture,(! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cwcel @ XN @ XV) => ((cccom @ XN @ Xc_mi) = (ccfv @ XT @ ccds))))))))))).
