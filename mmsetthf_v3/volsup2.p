...
thf(cvolsup2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccr) & (cwbr @ XB2 @ (ccfv @ XA2 @ ccvol) @ cclt)) => (cwrex @ (^ [Xn:$i] : (cwbr @ XB2 @ (ccfv @ (ccin @ XA2 @ (cco @ (ccneg @ (ccv @ Xn)) @ (ccv @ Xn) @ ccicc)) @ ccvol) @ cclt)) @ (^ [Xn:$i] : ccn)))))).
