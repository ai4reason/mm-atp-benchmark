...
thf(amodprm1div_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz)) => (((cco @ XA2 @ XP @ ccmo) = cc1) <=> (cwbr @ XP @ (cco @ XA2 @ cc1 @ ccmin) @ ccdvds)))))).
...
thf(aodzdvds_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) & (cwcel @ XK @ ccn0)) => ((cwbr @ XN @ (cco @ (cco @ XA2 @ XK @ ccexp) @ cc1 @ ccmin) @ ccdvds) <=> (cwbr @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ XK @ ccdvds))))))).
...
thf(aodzcl_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) => (cwcel @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccn))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(advdsprmpweqle_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn) & (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xn) @ XN @ ccle) & (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp)))) @ (^ [Xn:$i] : ccn0)))))))).
...
thf(codz2prm2pw_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) & (((cco @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp) @ XP @ ccmo) != cc1) & ((cco @ (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccexp) @ XP @ ccmo) = cc1))) => ((ccfv @ cc2 @ (ccfv @ XP @ ccodz)) = (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp)))))).
