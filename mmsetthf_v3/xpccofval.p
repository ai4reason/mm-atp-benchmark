...
thf(axpcval_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_xb:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_x:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XY:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XT @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (cco @ XC @ XD @ ccxpc)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XX @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (ccfv @ XC @ ccbs)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XY @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (ccfv @ XD @ ccbs)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XH @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (ccfv @ XC @ cchom)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XJ @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (ccfv @ XD @ cchom)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xc_x @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (ccfv @ XC @ ccco)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xc_xb @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (ccfv @ XD @ ccco)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => (cwcel @ XC @ (XV @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => (cwcel @ XD @ (XW @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => (XB2 = (ccxp @ (XX @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) @ (XY @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => ((XK @ Xv @ Xu) = (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : XB2)) @ (^ [Xu:$i] : (^ [Xv:$i] : XB2)) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (cco @ (ccfv @ (ccv @ Xu) @ cc1st) @ (ccfv @ (ccv @ Xv) @ cc1st) @ (XH @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1)) @ (cco @ (ccfv @ (ccv @ Xu) @ cc2nd) @ (ccfv @ (ccv @ Xv) @ cc2nd) @ (XJ @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1)))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => ((XO @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ XB2 @ XB2))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt2 @ (^ [Xg1:$i] : (^ [Xf1:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccv @ Xy1) @ (XK @ Xv @ Xu)))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccfv @ (ccv @ Xx3) @ (XK @ Xv @ Xu)))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccop @ (cco @ (ccfv @ (ccv @ Xg1) @ cc1st) @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (cco @ (ccop @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc1st)) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ (Xc_x @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1))) @ (cco @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ (ccfv @ (ccv @ Xf1) @ cc2nd) @ (cco @ (ccop @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc2nd) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc2nd)) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ (Xc_xb @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1)))))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => ((XT @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1) = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ cchom) @ (XK @ Xv @ Xu)) @ (ccop @ (ccfv @ ccnx @ ccco) @ (XO @ Xx3 @ Xy1 @ Xv @ Xu @ Xf1 @ Xg1))))))))))))))))))))))))))))))))))))))).
...
thf(cxpccofval_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) = (cco @ XC @ XD @ ccxpc)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (XB2 = (ccfv @ (XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (XK = (ccfv @ (XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ cchom)))))) => ((Xc_x = (ccfv @ XC @ ccco)) => ((Xc_xb = (ccfv @ XD @ ccco)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XO @ Xf1 @ Xg1) = (ccfv @ (XT @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ ccco)))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((XO @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ XB2 @ XB2))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt2 @ (^ [Xg1:$i] : (^ [Xf1:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccv @ Xy1) @ XK))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccfv @ (ccv @ Xx3) @ XK))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccop @ (cco @ (ccfv @ (ccv @ Xg1) @ cc1st) @ (ccfv @ (ccv @ Xf1) @ cc1st) @ (cco @ (ccop @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc1st)) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ Xc_x)) @ (cco @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ (ccfv @ (ccv @ Xf1) @ cc2nd) @ (cco @ (ccop @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ cc2nd) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ cc2nd)) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ Xc_xb))))))))))))))))))))))))))).
