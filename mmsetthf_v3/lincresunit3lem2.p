...
thf(alincresunit3lem1_thm,axiom,(! [Xz:$i] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xs1:$i] : ((XR @ Xs1) = (ccfv @ XM @ ccsca))) => ((! [Xs1:$i] : (XE = (ccfv @ (XR @ Xs1) @ ccbs))) => ((! [Xs1:$i] : (XU = (ccfv @ (XR @ Xs1) @ ccui))) => ((! [Xs1:$i] : ((Xc_0 @ Xs1) = (ccfv @ (XR @ Xs1) @ cc0g))) => ((! [Xs1:$i] : ((XZ @ Xs1) = (ccfv @ XM @ cc0g))) => ((! [Xs1:$i] : (XN = (ccfv @ (XR @ Xs1) @ ccminusg))) => ((! [Xs1:$i] : (XI = (ccfv @ (XR @ Xs1) @ ccinvr))) => ((! [Xs1:$i] : (Xc_x = (ccfv @ (XR @ Xs1) @ ccmulr))) => ((! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ XI) @ (ccfv @ (ccv @ Xs1) @ XF) @ Xc_x))))) => (! [Xs1:$i] : ((((cwcel @ XS @ (ccpw @ XB2)) & (cwcel @ XM @ cclmod) & (cwcel @ XX @ XS)) & ((cwcel @ XF @ (cco @ XE @ XS @ ccmap)) & (cwcel @ (ccfv @ XX @ XF) @ XU) & (cwcel @ (ccv @ Xz) @ (ccdif @ XS @ (ccsn @ XX))))) => ((cco @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ (cco @ (ccfv @ (ccv @ Xz) @ (XG @ Xs1)) @ (ccv @ Xz) @ (ccfv @ XM @ ccvsca)) @ (ccfv @ XM @ ccvsca)) = (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz) @ (ccfv @ XM @ ccvsca))))))))))))))))))))))))))))))).
...
thf(alincresunit1_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xs1:$i] : ((XR @ Xs1) = (ccfv @ XM @ ccsca))) => ((! [Xs1:$i] : (XE = (ccfv @ (XR @ Xs1) @ ccbs))) => ((! [Xs1:$i] : (XU = (ccfv @ (XR @ Xs1) @ ccui))) => ((! [Xs1:$i] : ((Xc_0 @ Xs1) = (ccfv @ (XR @ Xs1) @ cc0g))) => ((! [Xs1:$i] : ((XZ @ Xs1) = (ccfv @ XM @ cc0g))) => ((! [Xs1:$i] : ((XN @ Xs1) = (ccfv @ (XR @ Xs1) @ ccminusg))) => ((! [Xs1:$i] : ((XI @ Xs1) = (ccfv @ (XR @ Xs1) @ ccinvr))) => ((! [Xs1:$i] : ((Xc_x @ Xs1) = (ccfv @ (XR @ Xs1) @ ccmulr))) => ((! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ (XN @ Xs1)) @ (XI @ Xs1)) @ (ccfv @ (ccv @ Xs1) @ XF) @ (Xc_x @ Xs1)))))) => (! [Xs1:$i] : ((((cwcel @ XS @ (ccpw @ XB2)) & (cwcel @ XM @ cclmod) & (cwcel @ XX @ XS)) & ((cwcel @ XF @ (cco @ XE @ XS @ ccmap)) & (cwcel @ (ccfv @ XX @ XF) @ XU))) => (cwcel @ (XG @ Xs1) @ (cco @ XE @ (ccdif @ XS @ (ccsn @ XX)) @ ccmap))))))))))))))))))))))))))))).
...
thf(alincresunit2_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xs1:$i] : ((XR @ Xs1) = (ccfv @ XM @ ccsca))) => ((! [Xs1:$i] : (XE = (ccfv @ (XR @ Xs1) @ ccbs))) => ((! [Xs1:$i] : (XU = (ccfv @ (XR @ Xs1) @ ccui))) => ((! [Xs1:$i] : (Xc_0 = (ccfv @ (XR @ Xs1) @ cc0g))) => ((! [Xs1:$i] : ((XZ @ Xs1) = (ccfv @ XM @ cc0g))) => ((! [Xs1:$i] : (XN = (ccfv @ (XR @ Xs1) @ ccminusg))) => ((! [Xs1:$i] : (XI = (ccfv @ (XR @ Xs1) @ ccinvr))) => ((! [Xs1:$i] : (Xc_x = (ccfv @ (XR @ Xs1) @ ccmulr))) => ((! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ XI) @ (ccfv @ (ccv @ Xs1) @ XF) @ Xc_x))))) => (! [Xs1:$i] : ((((cwcel @ XS @ (ccpw @ XB2)) & (cwcel @ XM @ cclmod) & (cwcel @ XX @ XS)) & ((cwcel @ XF @ (cco @ XE @ XS @ ccmap)) & (cwcel @ (ccfv @ XX @ XF) @ XU) & (cwbr @ XF @ Xc_0 @ ccfsupp))) => (cwbr @ (XG @ Xs1) @ Xc_0 @ ccfsupp)))))))))))))))))))))))))))).
...
thf(clincresunit3lem2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xs1:$i] : ((XR @ Xs1) = (ccfv @ XM @ ccsca))) => ((! [Xs1:$i] : (XE = (ccfv @ (XR @ Xs1) @ ccbs))) => ((! [Xs1:$i] : (XU = (ccfv @ (XR @ Xs1) @ ccui))) => ((! [Xs1:$i] : (Xc_0 = (ccfv @ (XR @ Xs1) @ cc0g))) => ((! [Xs1:$i] : ((XZ @ Xs1) = (ccfv @ XM @ cc0g))) => ((! [Xs1:$i] : (XN = (ccfv @ (XR @ Xs1) @ ccminusg))) => ((! [Xz:$i] : (! [Xs1:$i] : ((XI @ Xz) = (ccfv @ (XR @ Xs1) @ ccinvr)))) => ((! [Xz:$i] : (! [Xs1:$i] : ((Xc_x @ Xz) = (ccfv @ (XR @ Xs1) @ ccmulr)))) => ((! [Xz:$i] : (! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ (XI @ Xz)) @ (ccfv @ (ccv @ Xs1) @ XF) @ (Xc_x @ Xz))))))) => (! [Xs1:$i] : ((((cwcel @ XS @ (ccpw @ XB2)) & (cwcel @ XM @ cclmod) & (cwcel @ XX @ XS)) & ((cwcel @ XF @ (cco @ XE @ XS @ ccmap)) & (cwcel @ (ccfv @ XX @ XF) @ XU) & (cwbr @ XF @ Xc_0 @ ccfsupp))) => ((cco @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ (cco @ XM @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (XG @ Xs1)) @ (ccv @ Xz) @ (ccfv @ XM @ ccvsca)))) @ ccgsu) @ (ccfv @ XM @ ccvsca)) = (cco @ (ccres @ XF @ (ccdif @ XS @ (ccsn @ XX))) @ (ccdif @ XS @ (ccsn @ XX)) @ (ccfv @ XM @ cclinc)))))))))))))))))))))))))))))).
