...
thf(causgrumgri_conj,conjecture,(! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xv:$i] : (! [Xe:$i] : ((XG @ Xx3 @ Xv @ Xe) = (ccopab @ (^ [Xv:$i] : (^ [Xe:$i] : (cwss @ (ccv @ Xe) @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xv)))))))))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xe:$i] : (((cwcel @ XH @ (XW @ Xx3 @ Xv @ Xe)) & (cwbr @ (ccfv @ XH @ ccvtx) @ (ccfv @ XH @ ccedg) @ (XG @ Xx3 @ Xv @ Xe)) & (cwfun @ (ccfv @ XH @ cciedg))) => (cwcel @ XH @ ccumgr)))))))))).
