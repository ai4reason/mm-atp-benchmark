...
thf(apmapjat1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XQ @ XA2)) => ((ccfv @ (cco @ XX @ XQ @ Xc_or) @ XM) = (cco @ (ccfv @ XX @ XM) @ (ccfv @ XQ @ XM) @ Xc_pl))))))))))))))))).
...
thf(apmapat_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2)) => ((ccfv @ XP @ XM) = (ccsn @ XP)))))))))).
...
thf(cpaddatclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XC) & (cwcel @ XQ @ XA2)) => (cwcel @ (cco @ XX @ (ccsn @ XQ) @ Xc_pl) @ XC)))))))))))).
