...
thf(agrpinvssd_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XM @ ccgrp)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XS @ ccgrp)))) => ((XB2 = (ccfv @ XS @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XB2 @ (ccfv @ XM @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XM @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XS @ ccplusg)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwcel @ XX @ XB2) => ((ccfv @ XX @ (ccfv @ XS @ ccminusg)) = (ccfv @ XX @ (ccfv @ XM @ ccminusg)))))))))))))))))).
...
thf(cgrpissubg_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XS = (ccfv @ XH @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XH @ ccgrp)) => (((cwss @ XS @ XB2) & ((ccfv @ XH @ ccplusg) = (ccres @ (ccfv @ XG @ ccplusg) @ (ccxp @ XS @ XS)))) => (cwcel @ XS @ (ccfv @ XG @ ccsubg))))))))))).
