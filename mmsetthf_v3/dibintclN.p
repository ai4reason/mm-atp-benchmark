...
thf(adibf11N_thm,axiom,(! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwf1o @ (ccdm @ XI) @ (ccrn @ XI) @ XI))))))))).
...
thf(adibclN_thm,axiom,(! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XX @ (ccdm @ XI))) => (cwcel @ (ccfv @ XX @ XI) @ (ccrn @ XI))))))))))).
thf(cdibintclN_conj,conjecture,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwss @ XS @ (ccrn @ XI)) & (XS != cc0))) => (cwcel @ (ccint @ XS) @ (ccrn @ XI))))))))))).
