...
thf(awwlksnext_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XT @ (cco @ XN @ XG @ ccwwlksn)) & (cwcel @ XS @ XV) & (cwcel @ (ccpr @ (ccfv @ XT @ cclsw) @ XS) @ XE)) => (cwcel @ (cco @ XT @ (ccs1 @ XS) @ ccconcat) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)))))))))))).
