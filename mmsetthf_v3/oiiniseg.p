...
thf(coiiniseg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XF = (ccoi @ XA2 @ XR)) => ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwcel @ XN @ XA2) & (cwcel @ XM @ (ccdm @ XF)))) => ((cwbr @ (ccfv @ XM @ XF) @ XN @ XR) | (cwcel @ XN @ (ccrn @ XF))))))))))).
