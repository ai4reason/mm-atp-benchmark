...
thf(c_2sqmo_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => (cwrmo @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ ccle) & ((cco @ (cco @ (ccv @ Xa) @ cc2 @ ccexp) @ (cco @ (ccv @ Xb) @ cc2 @ ccexp) @ ccaddc) = XP))) @ (^ [Xb:$i] : ccn0))) @ (^ [Xa:$i] : ccn0))))).
