...
thf(adf_cxp_ax,axiom,(cccxp = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ (ccif @ ((ccv @ Xy1) = ccc0) @ cc1 @ ccc0) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ cce))))))).
...
thf(ccxpval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ XA2 @ XB2 @ cccxp) = (ccif @ (XA2 = ccc0) @ (ccif @ (XB2 = ccc0) @ cc1 @ ccc0) @ (ccfv @ (cco @ XB2 @ (ccfv @ XA2 @ cclog) @ ccmul) @ cce))))))).
