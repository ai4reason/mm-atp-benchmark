...
thf(advdsadd_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XM @ XN @ ccdvds) <=> (cwbr @ XM @ (cco @ XM @ XN @ ccaddc) @ ccdvds)))))).
...
thf(cacongeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ (cco @ ccc0 @ XA2 @ ccfz)) & (cwcel @ XC @ (cco @ ccc0 @ XA2 @ ccfz))) => ((XB2 = XC) <=> ((cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) | (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds)))))))).
