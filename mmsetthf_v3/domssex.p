...
thf(adomss2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (cccnv @ (ccun @ XF @ (ccres @ cc1st @ (ccxp @ (ccdif @ XB2 @ (ccrn @ XF)) @ (ccsn @ (ccpw @ (ccuni @ (ccrn @ XA2))))))))) => (((cwf1 @ XA2 @ XB2 @ XF) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwf1o @ XB2 @ (ccrn @ XG) @ XG) & (cwss @ XA2 @ (ccrn @ XG)) & ((cccom @ XG @ XF) = (ccres @ ccid @ XA2)))))))))))).
...
thf(cdomssex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => (? [Xx3:$i] : ((cwss @ XA2 @ (ccv @ Xx3)) & (cwbr @ XB2 @ (ccv @ Xx3) @ ccen))))))).
