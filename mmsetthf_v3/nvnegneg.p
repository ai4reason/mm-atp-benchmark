...
thf(cnvnegneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => (((cwcel @ XU @ ccnv) & (cwcel @ XA2 @ XX)) => ((cco @ (ccneg @ cc1) @ (cco @ (ccneg @ cc1) @ XA2 @ XS) @ XS) = XA2))))))))).
