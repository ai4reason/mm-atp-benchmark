...
thf(csadeq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn0)) => ((Xph => (cwss @ XB2 @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((ccin @ (cco @ XA2 @ XB2 @ ccsad) @ (cco @ ccc0 @ XN @ ccfzo)) = (ccin @ (cco @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccin @ XB2 @ (cco @ ccc0 @ XN @ ccfzo)) @ ccsad) @ (cco @ ccc0 @ XN @ ccfzo)))))))))))).
