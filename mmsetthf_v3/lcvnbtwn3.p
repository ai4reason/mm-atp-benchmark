...
thf(clcvnbtwn3_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ XX)) => ((Xph => (cwcel @ XR @ XS)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwbr @ XR @ XT @ XC)) => ((Xph => (cwss @ XR @ XU)) => ((Xph => (cwpss @ XU @ XT)) => (Xph => (XU = XR)))))))))))))))))))).
