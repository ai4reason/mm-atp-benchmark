...
thf(cisdrs2_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cwcel @ XK @ ccdrs) <=> ((cwcel @ XK @ ccpreset) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XB2) @ ccfn))))))))))).
