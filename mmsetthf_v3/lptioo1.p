...
thf(aislptre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp))) <=> (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwcel @ XB2 @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo)) => ((ccin @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo) @ (ccdif @ XA2 @ (ccsn @ XB2))) != cc0))) @ (^ [Xb:$i] : ccxr))) @ (^ [Xa:$i] : ccxr)))))))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(aioossre_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ ccr)))).
thf(clptioo1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwcel @ XA2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (ccfv @ XJ @ cclp))))))))))))).
