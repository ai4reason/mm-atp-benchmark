...
thf(areldvds_thm,axiom,(cwrel @ ccdvds)).
...
thf(chashnzfz_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XJ @ ccz)) => ((Xph => (cwcel @ XK @ (ccfv @ (cco @ XJ @ cc1 @ ccmin) @ ccuz))) => (Xph => ((ccfv @ (ccin @ (ccima @ ccdvds @ (ccsn @ XN)) @ (cco @ XJ @ XK @ ccfz)) @ cchash) = (cco @ (ccfv @ (cco @ XK @ XN @ ccdiv) @ ccfl) @ (ccfv @ (cco @ (cco @ XJ @ cc1 @ ccmin) @ XN @ ccdiv) @ ccfl) @ ccmin))))))))))).
