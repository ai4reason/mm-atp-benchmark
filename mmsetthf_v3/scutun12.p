...
thf(assltun1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XC @ ccsslt) & (cwbr @ XB2 @ XC @ ccsslt)) => (cwbr @ (ccun @ XA2 @ XB2) @ XC @ ccsslt)))))).
thf(asimp3d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps & Xch & Xth)) => (Xph => Xth))))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) => Xch))))).
thf(assltun2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsslt) & (cwbr @ XA2 @ XC @ ccsslt)) => (cwbr @ XA2 @ (ccun @ XB2 @ XC) @ ccsslt)))))).
...
thf(asssslt1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsslt) & (cwss @ XC @ XA2)) => (cwbr @ XC @ XB2 @ ccsslt)))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(asssslt2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsslt) & (cwss @ XC @ XB2)) => (cwbr @ XA2 @ XC @ ccsslt)))))).
...
thf(cscutun12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsslt) & (cwbr @ XC @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ ccsslt) & (cwbr @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ XD @ ccsslt)) => ((cco @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ ccscut) = (cco @ XA2 @ XB2 @ ccscut)))))))).
