...
thf(aclwwlknonel_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ XG @ ccvtx))) => ((! [Xi:$i] : ((XE @ Xi) = (ccfv @ XG @ ccedg))) => (! [Xi:$i] : (((XN @ Xi) != ccc0) => ((cwcel @ XW @ (cco @ (XX @ Xi) @ (XN @ Xi) @ (ccfv @ XG @ ccclwwlknon))) <=> (((cwcel @ XW @ (ccword @ (XV @ Xi))) & (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XW)) @ (XE @ Xi))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo))) & (cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW)) @ (XE @ Xi))) & ((ccfv @ XW @ cchash) = (XN @ Xi)) & ((ccfv @ ccc0 @ XW) = (XX @ Xi))))))))))))))).
...
thf(aclwwlknonex2lem1_thm,axiom,(! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & ((ccfv @ XW @ cchash) = (cco @ XN @ cc2 @ ccmin))) => ((cco @ ccc0 @ (cco @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccaddc) @ cc1 @ ccmin) @ ccfzo) = (ccun @ (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo) @ (ccpr @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccfv @ XW @ cchash)))))))).
