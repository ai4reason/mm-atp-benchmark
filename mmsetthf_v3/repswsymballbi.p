...
thf(crepswsymballbi_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xi:$i] : ((cwcel @ XW @ (ccword @ (XV @ Xi))) => ((XW = (cco @ (ccfv @ ccc0 @ XW) @ (ccfv @ XW @ cchash) @ ccreps)) <=> (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) = (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))))))))).
