...
thf(csge0repnf_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (Xph => ((cwcel @ (ccfv @ XF @ ccsumge0) @ ccr) <=> (~ ((ccfv @ XF @ ccsumge0) = ccpnf))))))))))).
