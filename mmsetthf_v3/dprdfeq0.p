...
thf(adprdfsub_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : ((XW @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS)))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwbr @ XG @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => ((ccdm @ XS) = XI)))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (XF @ Xi) @ (XW @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (XH @ Xi) @ (XW @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xc_mi @ Xh @ Xi) = (ccfv @ XG @ ccsg)))) => (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => ((cwcel @ (cco @ (XF @ Xi) @ (XH @ Xi) @ (ccof @ (Xc_mi @ Xh @ Xi))) @ (XW @ Xh @ Xi)) & ((cco @ XG @ (cco @ (XF @ Xi) @ (XH @ Xi) @ (ccof @ (Xc_mi @ Xh @ Xi))) @ ccgsu) = (cco @ (cco @ XG @ (XF @ Xi) @ ccgsu) @ (cco @ XG @ (XH @ Xi) @ ccgsu) @ (Xc_mi @ Xh @ Xi)))))))))))))))))))))))).
