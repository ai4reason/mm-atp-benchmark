...
thf(ce333_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwvd3 @ Xph @ Xps @ Xch @ Xth) => ((cwvd3 @ Xph @ Xps @ Xch @ Xta) => ((cwvd3 @ Xph @ Xps @ Xch @ Xet) => ((Xth => (Xta => (Xet => Xze))) => (cwvd3 @ Xph @ Xps @ Xch @ Xze))))))))))))).
