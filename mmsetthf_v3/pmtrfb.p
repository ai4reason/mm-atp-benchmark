...
thf(cpmtrfb_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) <=> ((cwcel @ XD @ ccvv) & (cwf1o @ XD @ XD @ XF) & (cwbr @ (ccdm @ (ccdif @ XF @ ccid)) @ cc2o @ ccen)))))))))).
