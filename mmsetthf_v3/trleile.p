...
thf(ctrleile_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (((cwcel @ XK @ cctos) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ Xc_le) | (cwbr @ XY @ XX @ Xc_le))))))))))).
