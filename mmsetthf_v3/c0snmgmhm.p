...
thf(cc0snmgmhm_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XT @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => (! [Xx3:$i] : (((cwcel @ XS @ ccmnd) & (cwcel @ XT @ ccmgm) & ((ccfv @ XB2 @ cchash) = cc1)) => (cwcel @ (XH @ Xx3) @ (cco @ XT @ XS @ ccmgmhm))))))))))))).
