...
thf(ccru_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr))) => (((cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) = (cco @ XC @ (cco @ cci @ XD @ ccmul) @ ccaddc)) <=> ((XA2 = XC) & (XB2 = XD))))))))).
