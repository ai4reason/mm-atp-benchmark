...
thf(aprdsvsca_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((XP = (cco @ XS @ XR @ ccprds)) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => (cwcel @ XS @ (XV @ Xx3 @ Xf1 @ Xg1)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => (cwcel @ XR @ (XW @ Xx3 @ Xf1 @ Xg1)))))) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xph => ((ccdm @ XR) = XI)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XS @ ccbs))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xc_x @ Xx3 @ Xf1 @ Xg1) = (ccfv @ XP @ ccvsca))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => ((Xc_x @ Xx3 @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XK @ Xx3))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccvsca)))))))))))))))))))))))))))))).
