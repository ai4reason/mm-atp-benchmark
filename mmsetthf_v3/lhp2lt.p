...
thf(a_3dim2_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > $o)] : ((! [Xs1:$i] : (! [Xr:$i] : (Xc_or = (ccfv @ (XK @ Xs1 @ Xr) @ ccjn)))) => ((! [Xs1:$i] : (! [Xr:$i] : (Xc_le = (ccfv @ (XK @ Xs1 @ Xr) @ ccple)))) => ((! [Xs1:$i] : (! [Xr:$i] : (XA2 = (ccfv @ (XK @ Xs1 @ Xr) @ ccatm)))) => (! [Xs1:$i] : (! [Xr:$i] : (((cwcel @ (XK @ Xs1 @ Xr) @ cchlt) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) => (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : ((~ (cwbr @ (ccv @ Xr) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & (~ (cwbr @ (ccv @ Xs1) @ (cco @ (cco @ XP @ XQ @ Xc_or) @ (ccv @ Xr) @ Xc_or) @ Xc_le)))) @ (^ [Xs1:$i] : XA2))) @ (^ [Xr:$i] : XA2))))))))))))))).
...
thf(ancvr1_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ ccops) & (cwcel @ XX @ XB2)) => (~ (cwbr @ Xc_1 @ XX @ XC)))))))))))).
...
thf(alhp1cvr_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XC = (ccfv @ XK @ cccvr)) => ((XH = (ccfv @ XK @ cclh)) => (((cwcel @ XK @ XA2) & (cwcel @ XW @ XH)) => (cwbr @ XW @ Xc_1 @ XC)))))))))))).
thf(acvrcmp_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ ccpo) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2)) & ((cwbr @ XZ @ XX @ XC) & (cwbr @ XZ @ XY @ XC))) => ((cwbr @ XX @ XY @ Xc_le) <=> (XX = XY)))))))))))))).
