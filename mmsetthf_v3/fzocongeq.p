...
thf(afzo0dvdseq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (cco @ ccc0 @ XA2 @ ccfzo)) => ((cwbr @ XA2 @ XB2 @ ccdvds) <=> (XB2 = ccc0)))))).
...
thf(cfzocongeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XC @ XD @ ccfzo)) & (cwcel @ XB2 @ (cco @ XC @ XD @ ccfzo))) => ((cwbr @ (cco @ XD @ XC @ ccmin) @ (cco @ XA2 @ XB2 @ ccmin) @ ccdvds) <=> (XA2 = XB2)))))))).
