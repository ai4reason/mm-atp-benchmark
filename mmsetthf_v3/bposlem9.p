...
thf(abposlem7_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (ccfv @ cc2 @ ccsqrt) @ (ccfv @ (ccfv @ (ccv @ Xn) @ ccsqrt) @ (XG @ Xx3)) @ ccmul) @ (cco @ (cco @ cc9 @ cc4 @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ (XG @ Xx3)) @ ccmul) @ ccaddc) @ (cco @ (ccfv @ cc2 @ cclog) @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ ccdiv) @ ccaddc)))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ (ccv @ Xx3) @ ccdiv))))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwcel @ XA2 @ ccn)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwcel @ XB2 @ ccn)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwbr @ (cco @ cceu @ cc2 @ ccexp) @ XA2 @ ccle)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwbr @ (cco @ cceu @ cc2 @ ccexp) @ XB2 @ ccle)))) => (! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => ((cwbr @ XA2 @ XB2 @ cclt) => (cwbr @ (ccfv @ XB2 @ (XF @ Xx3 @ Xn)) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xn)) @ cclt))))))))))))))))).
...
thf(abposlem8_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (ccfv @ cc2 @ ccsqrt) @ (ccfv @ (ccfv @ (ccv @ Xn) @ ccsqrt) @ (XG @ Xx3 @ Xn)) @ ccmul) @ (cco @ (cco @ cc9 @ cc4 @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ (XG @ Xx3 @ Xn)) @ ccmul) @ ccaddc) @ (cco @ (ccfv @ cc2 @ cclog) @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ ccdiv) @ ccaddc)))))) => ((! [Xx3:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ (ccv @ Xx3) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xn:$i] : ((cwcel @ (ccfv @ (ccdc @ cc6 @ cc4) @ (XF @ Xx3 @ Xn)) @ ccr) & (cwbr @ (ccfv @ (ccdc @ cc6 @ cc4) @ (XF @ Xx3 @ Xn)) @ (ccfv @ cc2 @ cclog) @ cclt))))))))).
...
thf(aefsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cce) = (cco @ (ccfv @ XA2 @ cce) @ (ccfv @ XB2 @ cce) @ ccdiv)))))).
