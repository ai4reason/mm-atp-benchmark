...
thf(cply1term_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ XA2 @ (cco @ (ccv @ Xz) @ XN @ ccexp) @ ccmul))))) => (! [Xz:$i] : (((cwss @ XS @ ccc) & (cwcel @ XA2 @ XS) & (cwcel @ XN @ ccn0)) => (cwcel @ (XF @ Xz) @ (ccfv @ XS @ ccply)))))))))).
