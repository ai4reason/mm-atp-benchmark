...
thf(afdivmpt_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwf @ XA2 @ ccc @ XF) & (cwf @ XA2 @ ccc @ XG) & (cwcel @ XA2 @ XV)) => ((cco @ XF @ XG @ ccfdiv) = (ccmpt @ (^ [Xx3:$i] : (cco @ XG @ ccc0 @ ccsupp)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccdiv)))))))))).
...
thf(crefdivmptfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwf @ XA2 @ ccr @ XF) & (cwf @ XA2 @ ccr @ XG) & (cwcel @ XA2 @ XV)) & (cwcel @ XX @ (cco @ XG @ ccc0 @ ccsupp))) => ((ccfv @ XX @ (cco @ XF @ XG @ ccfdiv)) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XX @ XG) @ ccdiv))))))))).
