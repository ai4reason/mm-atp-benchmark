...
thf(cendisj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (? [Xx3:$i] : (? [Xy1:$i] : (((cwbr @ (ccv @ Xx3) @ XA2 @ ccen) & (cwbr @ (ccv @ Xy1) @ XB2 @ ccen)) & ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0))))))))).
