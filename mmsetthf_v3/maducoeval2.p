...
thf(amdetero_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat)))) => ((! [Xi:$i] : (! [Xj:$i] : (XK = (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_pl = (ccfv @ (XR @ Xi @ Xj) @ ccplusg)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_x = (ccfv @ (XR @ Xi @ Xj) @ ccmulr)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XR @ Xi @ Xj) @ cccrg)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XX @ Xj) @ XK))) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XY @ Xj) @ XK))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XN) & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XZ @ Xi @ Xj) @ XK)))) => ((Xph => (cwcel @ XW @ XK)) => ((Xph => (cwcel @ XI @ XN)) => ((Xph => (cwcel @ XJ @ XN)) => ((Xph => (XI != XJ)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (cco @ (XX @ Xj) @ (cco @ XW @ (XY @ Xj) @ Xc_x) @ Xc_pl) @ (ccif @ ((ccv @ Xi) = XJ) @ (XY @ Xj) @ (XZ @ Xi @ Xj)))))) @ (XD @ Xi @ Xj)) = (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (XX @ Xj) @ (ccif @ ((ccv @ Xi) = XJ) @ (XY @ Xj) @ (XZ @ Xi @ Xj)))))) @ (XD @ Xi @ Xj))))))))))))))))))))))))))))))))).
...
thf(cmaducoeval2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xl:$i] : ((XA2 @ Xk @ Xl) = (cco @ XN @ XR @ ccmat)))) => ((! [Xk:$i] : (! [Xl:$i] : ((XD @ Xk @ Xl) = (cco @ XN @ XR @ ccmdat)))) => ((! [Xk:$i] : (! [Xl:$i] : ((XJ @ Xk @ Xl) = (cco @ XN @ XR @ ccmadu)))) => ((! [Xk:$i] : (! [Xl:$i] : (XB2 = (ccfv @ (XA2 @ Xk @ Xl) @ ccbs)))) => ((! [Xl:$i] : ((Xc_1 @ Xl) = (ccfv @ XR @ ccur))) => ((! [Xl:$i] : ((Xc_0 @ Xl) = (ccfv @ XR @ cc0g))) => (! [Xk:$i] : (! [Xl:$i] : ((((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) & (cwcel @ XI @ XN) & (cwcel @ XH @ XN)) => ((cco @ XI @ XH @ (ccfv @ XM @ (XJ @ Xk @ Xl))) = (ccfv @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccif @ (((ccv @ Xk) = XH) | ((ccv @ Xl) = XI)) @ (ccif @ (((ccv @ Xl) = XI) & ((ccv @ Xk) = XH)) @ (Xc_1 @ Xl) @ (Xc_0 @ Xl)) @ (cco @ (ccv @ Xk) @ (ccv @ Xl) @ XM))))) @ (XD @ Xk @ Xl)))))))))))))))))))))))).
