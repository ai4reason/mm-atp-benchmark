...
thf(ccoe1mul3_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((Xc_xb = (ccfv @ XY @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XI @ ccn0)) => ((Xph => (cwbr @ (ccfv @ XF @ XD) @ XI @ ccle)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwcel @ XJ @ ccn0)) => ((Xph => (cwbr @ (ccfv @ XG @ XD) @ XJ @ ccle)) => (Xph => ((ccfv @ (cco @ XI @ XJ @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ Xc_xb) @ ccco1)) = (cco @ (ccfv @ XI @ (ccfv @ XF @ ccco1)) @ (ccfv @ XJ @ (ccfv @ XG @ ccco1)) @ Xc_x))))))))))))))))))))))))))).
