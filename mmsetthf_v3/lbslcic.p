...
thf(aindlcim_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => ((Xc_x = (ccfv @ XT @ ccvsca)) => ((XN = (ccfv @ XT @ cclspn)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XT @ (cco @ (ccv @ Xx3) @ XA2 @ (ccof @ Xc_x)) @ ccgsu))))) => ((Xph => (cwcel @ XT @ cclmod)) => ((Xph => (cwcel @ XI @ XX)) => ((Xph => (XR = (ccfv @ XT @ ccsca))) => ((! [Xx3:$i] : (Xph => (cwfo @ XI @ (XJ @ Xx3) @ XA2))) => ((Xph => (cwbr @ XA2 @ XT @ cclindf)) => ((! [Xx3:$i] : (Xph => ((ccfv @ (XJ @ Xx3) @ XN) = XC))) => (! [Xx3:$i] : (Xph => (cwcel @ (XE @ Xx3) @ (cco @ XF @ XT @ cclmim)))))))))))))))))))))))))))))).
...
thf(almimcnv_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ cclmim)) => (cwcel @ (cccnv @ XF) @ (cco @ XT @ XS @ cclmim))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(abrlmici_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XR @ XS @ cclmim)) => (cwbr @ XR @ XS @ cclmic)))))).
thf(clbslcic_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XJ = (ccfv @ XW @ cclbs)) => (((cwcel @ XW @ cclmod) & (cwcel @ XB2 @ XJ) & (cwbr @ XI @ XB2 @ ccen)) => (cwbr @ XW @ (cco @ XF @ XI @ ccfrlm) @ cclmic)))))))))).
