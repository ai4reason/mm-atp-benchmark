...
thf(crelogbdivb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccrp @ (ccsn @ cc1))) & (cwcel @ XA2 @ ccrp)) => ((cco @ XB2 @ (cco @ XA2 @ XB2 @ ccdiv) @ cclogb) = (cco @ (cco @ XB2 @ XA2 @ cclogb) @ cc1 @ ccmin)))))).
