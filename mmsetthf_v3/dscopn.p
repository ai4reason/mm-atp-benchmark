...
thf(adscmet_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ ccc0 @ cc1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (XV @ Xx3 @ Xy1)) => (cwcel @ (XD @ Xx3 @ Xy1) @ (ccfv @ XX @ ccme)))))))))).
thf(ametxmet_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccme)) => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))))).
thf(cctb_tp,type,(cctb : ($i > $o))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(cctg_tp,type,(cctg : ($i > $o))).
thf(aelmopn_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ XD @ ccmopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XA2 @ (XJ @ Xx3 @ Xy1)) <=> ((cwss @ XA2 @ XX) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwss @ (ccv @ Xy1) @ XA2))) @ (^ [Xy1:$i] : (ccrn @ (ccfv @ XD @ ccbl))))) @ (^ [Xx3:$i] : XA2))))))))))))).
...
thf(cdscopn_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ ccc0 @ cc1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (XV @ Xx3 @ Xy1)) => ((ccfv @ (XD @ Xx3 @ Xy1) @ ccmopn) = (ccpw @ XX)))))))))).
