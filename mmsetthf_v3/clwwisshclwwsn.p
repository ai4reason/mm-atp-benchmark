...
thf(afzofzim_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (((XK != XM) & (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfz))) => (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfzo)))))).
...
thf(cclwwisshclwwsn_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (cwcel @ (cco @ XW @ XN @ cccsh) @ (ccfv @ XG @ ccclwwlk))))))).
