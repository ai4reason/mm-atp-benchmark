...
thf(csupfil_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwss @ XB2 @ XA2) & (XB2 != cc0)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ XB2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ ccfil)))))))).
