...
thf(clmfval_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xu:$i] : ((cwcel @ XJ @ (ccfv @ (XX @ Xu) @ cctopon)) => ((ccfv @ XJ @ cclm) = (ccopab @ (^ [Xf1:$i] : (^ [Xx3:$i] : ((cwcel @ (ccv @ Xf1) @ (cco @ (XX @ Xu) @ ccc @ ccpm)) & (cwcel @ (ccv @ Xx3) @ (XX @ Xu)) & (cwral @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) => (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xu) @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz))))) @ (^ [Xu:$i] : XJ)))))))))))).
