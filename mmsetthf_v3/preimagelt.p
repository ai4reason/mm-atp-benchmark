...
thf(cpreimagelt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ ccxr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccdif @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XC @ Xx3) @ (XB2 @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2))) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2))))))))))))).
