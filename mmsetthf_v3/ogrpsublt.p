...
thf(cogrpsublt_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_lt = (ccfv @ XG @ ccplt)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccogrp) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2)) & (cwbr @ XX @ XY @ Xc_lt)) => (cwbr @ (cco @ XX @ XZ @ Xc_mi) @ (cco @ XY @ XZ @ Xc_mi) @ Xc_lt))))))))))))).
