...
thf(cmptcoe1fsupp_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : (XB2 = (ccfv @ (XP @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xc_0 @ Xk) = (ccfv @ XR @ cc0g))) => (! [Xk:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccfv @ XM @ ccco1)))) @ (Xc_0 @ Xk) @ ccfsupp)))))))))))).
