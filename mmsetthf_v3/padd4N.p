...
thf(cpadd4N_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & ((cwss @ XX @ XA2) & (cwss @ XY @ XA2)) & ((cwss @ XZ @ XA2) & (cwss @ XW @ XA2))) => ((cco @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XW @ Xc_pl) @ Xc_pl) = (cco @ (cco @ XX @ XZ @ Xc_pl) @ (cco @ XY @ XW @ Xc_pl) @ Xc_pl))))))))))))).
