...
thf(c_0clwlkv_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XX @ XV) & (XF = cc0) & (cwf @ (ccsn @ ccc0) @ (ccsn @ XX) @ XP)) => (cwbr @ XF @ XP @ (ccfv @ XG @ ccclwlks)))))))))).
