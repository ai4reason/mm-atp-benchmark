...
thf(afrgrncvvdeq_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccfv @ XG @ ccvtxdg)))) => ((cwcel @ XG @ ccfrgr) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwnel @ (ccv @ Xy1) @ (cco @ XG @ (ccv @ Xx3) @ ccnbgr)) => ((ccfv @ (ccv @ Xx3) @ (XD @ Xx3 @ Xy1)) = (ccfv @ (ccv @ Xy1) @ (XD @ Xx3 @ Xy1))))) @ (^ [Xy1:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XV))))))))).
...
thf(cfrgrwopreglem4a_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccfrgr) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV)) & ((ccfv @ XX @ XD) != (ccfv @ XY @ XD))) => (cwcel @ (ccpr @ XX @ XY) @ XE)))))))))))).
