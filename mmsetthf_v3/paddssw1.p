...
thf(cpaddssw1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ XB2) & ((cwss @ XX @ XA2) & (cwss @ XY @ XA2) & (cwss @ XZ @ XA2))) => (((cwss @ XX @ XZ) & (cwss @ XY @ XZ)) => (cwss @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XZ @ Xc_pl)))))))))))))).
