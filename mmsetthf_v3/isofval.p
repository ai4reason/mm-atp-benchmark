...
thf(adf_iso_ax,axiom,(cciso = (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (cccom @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xx3)))) @ (ccfv @ (ccv @ Xc) @ ccinv)))))).
...
thf(cisofval_conj,conjecture,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => ((ccfv @ XC @ cciso) = (cccom @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xx3)))) @ (ccfv @ XC @ ccinv)))))).
