...
thf(abnj517_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xi @ Xn) <=> ((ccfv @ cc0 @ (XF @ Xy1)) = (cc_bnj14 @ XA2 @ (XR @ Xy1 @ Xi @ Xn) @ (XX @ Xy1 @ Xi @ Xn))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xi @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (XN @ Xy1)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (XF @ Xy1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (XF @ Xy1))) @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ (XR @ Xy1 @ Xi @ Xn) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom)))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : (((cwcel @ (XN @ Xy1) @ ccom) & (Xph @ Xy1 @ Xi @ Xn) & (Xps @ Xy1 @ Xi @ Xn)) => (cwral @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccv @ Xn) @ (XF @ Xy1)) @ XA2)) @ (^ [Xn:$i] : (XN @ Xy1))))))))))))))))).
