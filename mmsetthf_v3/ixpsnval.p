...
thf(adfixp_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ XA2) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(cixpsnval_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xx3:$i] : ((cwcel @ XX @ (XV @ Xx3)) => ((ccixp @ (^ [Xx3:$i] : (ccsn @ XX)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ (ccsn @ XX)) & (cwcel @ (ccfv @ XX @ (ccv @ Xf1)) @ (ccsb @ XX @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))))).
