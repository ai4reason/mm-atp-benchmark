...
thf(creprinrn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => (! [Xc:$i] : (Xph => ((cwcel @ (ccv @ Xc) @ (cco @ (ccin @ XA2 @ XB2) @ XM @ (ccfv @ XS @ ccrepr))) <=> ((cwcel @ (ccv @ Xc) @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))) & (cwss @ (ccrn @ (ccv @ Xc)) @ XB2)))))))))))))).
