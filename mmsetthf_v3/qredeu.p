...
thf(cqredeu_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => (cwreu @ (^ [Xx3:$i] : (((cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccgcd) = cc1) & (XA2 = (cco @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ ccdiv)))) @ (^ [Xx3:$i] : (ccxp @ ccz @ ccn)))))).
