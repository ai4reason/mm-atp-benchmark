...
thf(cdpjrid_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((XP = (cco @ XG @ XS @ ccdpj)) => ((Xph => (cwcel @ XX @ XI)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ XS))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XY @ XI)) => ((Xph => (XY != XX)) => (Xph => ((ccfv @ XA2 @ (ccfv @ XY @ XP)) = Xc_0)))))))))))))))))))).
