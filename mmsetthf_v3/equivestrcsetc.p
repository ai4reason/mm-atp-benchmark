...
thf(af1oeq3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwf1o @ XC @ XA2 @ XF) <=> (cwf1o @ XC @ XB2 @ XF)))))))))).
...
thf(cequivestrcsetc_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XE @ Xx3 @ Xy1 @ Xi) = (ccfv @ (XU @ Xx3 @ Xy1 @ Xi @ Xa @ Xb) @ ccestrc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XS @ Xx3 @ Xy1 @ Xi) = (ccfv @ (XU @ Xx3 @ Xy1 @ Xi @ Xa @ Xb) @ ccsetc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : ((XB2 @ Xi) = (ccfv @ (XE @ Xx3 @ Xy1 @ Xi) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xb:$i] : ((XC @ Xy1 @ Xi @ Xb) = (ccfv @ (XS @ Xx3 @ Xy1 @ Xi) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xi) => (cwcel @ (XU @ Xx3 @ Xy1 @ Xi @ Xa @ Xb) @ ccwun))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xi) => ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (XB2 @ Xi)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccbs)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xi) => ((XG @ Xx3 @ Xy1 @ Xi) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xi))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xi))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ ccid @ (cco @ (ccfv @ (ccv @ Xy1) @ ccbs) @ (ccfv @ (ccv @ Xx3) @ ccbs) @ ccmap)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xi) => (cwcel @ (ccfv @ ccnx @ ccbs) @ (XU @ Xx3 @ Xy1 @ Xi @ Xa @ Xb)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xi) => ((cwbr @ (XF @ Xx3 @ Xy1) @ (XG @ Xx3 @ Xy1 @ Xi) @ (cco @ (XE @ Xx3 @ Xy1 @ Xi) @ (XS @ Xx3 @ Xy1 @ Xi) @ ccfth)) & (cwbr @ (XF @ Xx3 @ Xy1) @ (XG @ Xx3 @ Xy1 @ Xi) @ (cco @ (XE @ Xx3 @ Xy1 @ Xi) @ (XS @ Xx3 @ Xy1 @ Xi) @ ccful)) & (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xa:$i] : (? [Xi:$i] : (cwf1o @ (ccv @ Xb) @ (ccfv @ (ccv @ Xa) @ (XF @ Xx3 @ Xy1)) @ (ccv @ Xi)))) @ (^ [Xa:$i] : (XB2 @ Xi)))) @ (^ [Xb:$i] : (XC @ Xy1 @ Xi @ Xb))))))))))))))))))))))))).
