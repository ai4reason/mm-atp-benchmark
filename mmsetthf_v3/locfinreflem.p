...
thf(areff_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwbr @ XA2 @ XB2 @ ccref) <=> ((cwss @ (ccuni @ XB2) @ (ccuni @ XA2)) & (? [Xf1:$i] : ((cwf @ XA2 @ XB2 @ (ccv @ Xf1)) & (cwral @ (^ [Xv:$i] : (cwss @ (ccv @ Xv) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xf1)))) @ (^ [Xv:$i] : XA2))))))))))).
...
thf(areximd2a_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) & (Xps @ Xx3)) => (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) & (Xps @ Xx3)) => (Xch @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))))))).
...
thf(clocfinreflem_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : ((XX @ Xf1) = (ccuni @ XJ))) => ((Xph => (cwss @ XU @ XJ)) => ((! [Xf1:$i] : (Xph => ((XX @ Xf1) = (ccuni @ XU)))) => ((Xph => (cwss @ XV @ XJ)) => ((Xph => (cwbr @ XV @ XU @ ccref)) => ((Xph => (cwcel @ XV @ (ccfv @ XJ @ cclocfin))) => (Xph => (? [Xf1:$i] : (((cwfun @ (ccv @ Xf1)) & (cwss @ (ccdm @ (ccv @ Xf1)) @ XU) & (cwss @ (ccrn @ (ccv @ Xf1)) @ XJ)) & ((cwbr @ (ccrn @ (ccv @ Xf1)) @ XU @ ccref) & (cwcel @ (ccrn @ (ccv @ Xf1)) @ (ccfv @ XJ @ cclocfin)))))))))))))))))).
