...
thf(alimsupub_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xj)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xj)) @ X))) => ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwss @ XA2 @ ccr))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwf @ XA2 @ ccxr @ (XF @ Xj)))) => ((! [Xj:$i] : ((Xph @ Xj) => ((ccfv @ (XF @ Xj) @ cclsp) != ccpnf))) => (! [Xj:$i] : ((Xph @ Xj) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccv @ Xx3) @ ccle))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))))))))).
...
thf(alimsupubuzlem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xx3 @ Xj)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xx3 @ Xj)) @ X)))) => ((cwnfc @ (^ [Xj:$i] : (XX @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwcel @ (XM @ Xx3) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XZ @ Xj) = (ccfv @ (XM @ Xx3) @ ccuz)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwf @ (XZ @ Xj) @ ccr @ (XF @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwcel @ (XY @ Xx3 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwcel @ (XK @ Xx3 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwral @ (^ [Xj:$i] : ((cwbr @ (XK @ Xx3 @ Xj) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (XY @ Xx3 @ Xj) @ ccle))) @ (^ [Xj:$i] : (XZ @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XN @ Xx3) = (ccif @ (cwbr @ (ccfv @ (XK @ Xx3 @ Xj) @ ccceil) @ (XM @ Xx3) @ ccle) @ (XM @ Xx3) @ (ccfv @ (XK @ Xx3 @ Xj) @ ccceil))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XW @ Xx3 @ Xj) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xj:$i] : (cco @ (XM @ Xx3) @ (XN @ Xx3) @ ccfz)) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (XF @ Xj))))) @ ccr @ cclt)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XX @ Xj) = (ccif @ (cwbr @ (XW @ Xx3 @ Xj) @ (XY @ Xx3 @ Xj) @ ccle) @ (XY @ Xx3 @ Xj) @ (XW @ Xx3 @ Xj))))) => (! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (XZ @ Xj)))) @ (^ [Xx3:$i] : ccr)))))))))))))))))))))))))).
...
thf(climsupubuz_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xj:$i] : (XZ = (ccfv @ (XM @ Xj) @ ccuz))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwf @ XZ @ ccr @ (XF @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => ((ccfv @ (XF @ Xj) @ cclsp) != ccpnf)))) => (! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))))).
