...
thf(clnatexN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xq:$i] : ((XB2 @ Xq) = (ccfv @ (XK @ Xq) @ ccbs))) => ((! [Xq:$i] : (Xc_le = (ccfv @ (XK @ Xq) @ ccple))) => ((! [Xq:$i] : (XA2 = (ccfv @ (XK @ Xq) @ ccatm))) => ((! [Xq:$i] : ((XN @ Xq) = (ccfv @ (XK @ Xq) @ cclines))) => ((! [Xq:$i] : ((XM @ Xq) = (ccfv @ (XK @ Xq) @ ccpmap))) => (! [Xq:$i] : (((cwcel @ (XK @ Xq) @ cchlt) & (cwcel @ XX @ (XB2 @ Xq)) & (cwcel @ (ccfv @ XX @ (XM @ Xq)) @ (XN @ Xq))) => (cwrex @ (^ [Xq:$i] : (((ccv @ Xq) != XP) & (cwbr @ (ccv @ Xq) @ XX @ Xc_le))) @ (^ [Xq:$i] : XA2)))))))))))))))))).
