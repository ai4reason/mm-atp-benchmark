...
thf(cgsummptf1o_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XH @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XE @ Xy1)) => ((XC @ Xx3) = (XH @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ cccmn)))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwss @ (XF @ Xx3 @ Xy1) @ (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ (XF @ Xx3 @ Xy1))))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XD)) => (cwcel @ (XE @ Xy1) @ XA2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwreu @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XE @ Xy1))) @ (^ [Xy1:$i] : XD)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cco @ (XG @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccgsu) = (cco @ (XG @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : XD) @ (^ [Xy1:$i] : (XH @ Xx3 @ Xy1))) @ ccgsu)))))))))))))))))))))))))).
