...
thf(arankpwi_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => ((ccfv @ (ccpw @ XA2) @ ccrnk) = (ccsuc @ (ccfv @ XA2 @ ccrnk)))))).
...
thf(cr1pw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) <=> (cwcel @ (ccpw @ XA2) @ (ccfv @ (ccsuc @ XB2) @ ccr1))))))).
