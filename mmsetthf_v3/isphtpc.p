...
thf(cisphtpc_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwbr @ XF @ XG @ (ccfv @ XJ @ ccphtpc)) <=> ((cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) & (cwcel @ XG @ (cco @ ccii @ XJ @ cccn)) & ((cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)) != cc0))))))).
