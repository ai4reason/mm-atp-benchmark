...
thf(cnminvr_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XR @ ccnm)) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccnrg) & (cwcel @ XR @ ccnzr) & (cwcel @ XA2 @ XU)) => ((ccfv @ (ccfv @ XA2 @ XI) @ XN) = (cco @ cc1 @ (ccfv @ XA2 @ XN) @ ccdiv)))))))))))).
