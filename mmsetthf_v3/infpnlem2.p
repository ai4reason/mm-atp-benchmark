...
thf(ainfpnlem1_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XK = (cco @ (ccfv @ XN @ ccfa) @ cc1 @ ccaddc)) => (((cwcel @ XN @ ccn) & (cwcel @ XM @ ccn)) => ((((cwbr @ cc1 @ XM @ cclt) & (cwcel @ (cco @ XK @ XM @ ccdiv) @ ccn)) & (cwral @ (^ [Xj:$i] : (((cwbr @ cc1 @ (ccv @ Xj) @ cclt) & (cwcel @ (cco @ XK @ (ccv @ Xj) @ ccdiv) @ ccn)) => (cwbr @ XM @ (ccv @ Xj) @ ccle))) @ (^ [Xj:$i] : ccn))) => ((cwbr @ XN @ XM @ cclt) & (cwral @ (^ [Xj:$i] : ((cwcel @ (cco @ XM @ (ccv @ Xj) @ ccdiv) @ ccn) => (((ccv @ Xj) = cc1) | ((ccv @ Xj) = XM)))) @ (^ [Xj:$i] : ccn)))))))))).
thf(cinfpnlem2_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (cco @ (ccfv @ XN @ ccfa) @ cc1 @ ccaddc)) => ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xj:$i] : ((cwbr @ XN @ (ccv @ Xj) @ cclt) & (cwral @ (^ [Xk:$i] : ((cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ ccdiv) @ ccn) => (((ccv @ Xk) = cc1) | ((ccv @ Xk) = (ccv @ Xj))))) @ (^ [Xk:$i] : ccn)))) @ (^ [Xj:$i] : ccn))))))).
