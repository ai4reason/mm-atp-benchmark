...
thf(coteqex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((ccop @ (ccop @ XA2 @ XB2) @ XC) = (ccop @ (ccop @ XR @ XS) @ XT)) => (((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv) & (cwcel @ XC @ ccvv)) <=> ((cwcel @ XR @ ccvv) & (cwcel @ XS @ ccvv) & (cwcel @ XT @ ccvv))))))))))).
