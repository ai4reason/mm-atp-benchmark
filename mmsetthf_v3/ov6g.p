...
thf(cov6g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) = (ccop @ XA2 @ XB2)) => ((XR @ Xx3 @ Xy1) = XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XC) & ((ccv @ Xz) = (XR @ Xx3 @ Xy1))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((((cwcel @ XA2 @ (XG @ Xx3 @ Xy1 @ Xz)) & (cwcel @ XB2 @ (XH @ Xx3 @ Xy1 @ Xz)) & (cwcel @ (ccop @ XA2 @ XB2) @ XC)) & (cwcel @ XS @ (XJ @ Xx3 @ Xy1 @ Xz))) => ((cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) = XS))))))))))))))))).
