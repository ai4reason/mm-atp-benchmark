...
thf(cisrngod_conj,conjecture,(! [Xph:$o] : (! [XU:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XG @ ccablo)) => ((Xph => (XX = (ccrn @ XG))) => ((Xph => (cwf @ (ccxp @ XX @ XX) @ XX @ XH)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX) & (cwcel @ (ccv @ Xz) @ XX))) => ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) @ (ccv @ Xz) @ XH) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XH) @ XH)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX) & (cwcel @ (ccv @ Xz) @ XX))) => ((cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XH) = (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XH) @ XG)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX) & (cwcel @ (ccv @ Xz) @ XX))) => ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XH) = (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XH) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XH) @ XG)))))) => ((! [Xz:$i] : (Xph => (cwcel @ (XU @ Xz) @ XX))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XX)) => ((cco @ (XU @ Xz) @ (ccv @ Xy1) @ XH) = (ccv @ Xy1))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XX)) => ((cco @ (ccv @ Xy1) @ (XU @ Xz) @ XH) = (ccv @ Xy1))))) => (Xph => (cwcel @ (ccop @ XG @ XH) @ ccrngo))))))))))))))))).
