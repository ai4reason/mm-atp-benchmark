...
thf(csubrval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xv:$i] : (((cwcel @ XA2 @ (XC @ Xv)) & (cwcel @ XB2 @ (XD @ Xv))) => ((cco @ XA2 @ XB2 @ ccminusr) = (ccmpt @ (^ [Xv:$i] : ccr) @ (^ [Xv:$i] : (cco @ (ccfv @ (ccv @ Xv) @ XA2) @ (ccfv @ (ccv @ Xv) @ XB2) @ ccmin))))))))))).
