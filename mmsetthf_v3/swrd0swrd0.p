...
thf(cswrd0swrd0_conj,conjecture,(! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) & (cwcel @ XL @ (cco @ ccc0 @ XN @ ccfz))) => ((cco @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ (ccop @ ccc0 @ XL) @ ccsubstr) = (cco @ XW @ (ccop @ ccc0 @ XL) @ ccsubstr)))))))).
