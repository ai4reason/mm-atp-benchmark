...
thf(as3wwlks2on_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : ((XV @ Xf1) = (ccfv @ XG @ ccvtx))) => (! [Xf1:$i] : (((cwcel @ XG @ ccupgr) & (cwcel @ XA2 @ (XV @ Xf1)) & (cwcel @ XC @ (XV @ Xf1))) => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> (? [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = cc2))))))))))))).
...
thf(aumgr2wlk_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((! [Xf1:$i] : (! [Xp:$i] : ((XE @ Xf1 @ Xp) = (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : (((cwcel @ XG @ ccumgr) & (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) & (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp))) => (? [Xf1:$i] : (? [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = cc2) & ((XA2 = (ccfv @ ccc0 @ (ccv @ Xp))) & (XB2 = (ccfv @ cc1 @ (ccv @ Xp))) & (XC = (ccfv @ cc2 @ (ccv @ Xp))))))))))))))))).
...
thf(cumgrwwlks2on_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccumgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE))))))))))))).
