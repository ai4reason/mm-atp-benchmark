...
thf(csuplesup2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (cwss @ XB2 @ ccxr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XB2)))) => (Xph => (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle))))))))).
