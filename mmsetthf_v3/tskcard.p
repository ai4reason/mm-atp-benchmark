...
thf(ainawinalem_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwral @ (^ [Xx3:$i] : (cwbr @ (ccpw @ (ccv @ Xx3)) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : XA2)) => (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
thf(amp3an2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => (((Xph & Xps & Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(awinainflem_thm,axiom,(! [XA2:($i > $o)] : (((XA2 != cc0) & (cwcel @ XA2 @ ccon0) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) => (cwss @ ccom @ XA2)))).
thf(acardidm_thm,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ XA2 @ cccrd) @ cccrd) = (ccfv @ XA2 @ cccrd)))).
thf(acardaleph_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ ccom @ XA2) & ((ccfv @ XA2 @ cccrd) = XA2)) => (XA2 = (ccfv @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccale))) @ (^ [Xx3:$i] : ccon0))) @ ccale))))).
...
thf(acfle_thm,axiom,(! [XA2:($i > $o)] : (cwss @ (ccfv @ XA2 @ cccf) @ XA2))).
...
thf(ctskcard_conj,conjecture,(! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (XT != cc0)) => (cwcel @ (ccfv @ XT @ cccrd) @ ccina)))).
