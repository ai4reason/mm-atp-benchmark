...
thf(adf_obs_ax,axiom,(ccobs = (ccmpt @ (^ [Xh:$i] : ccphl) @ (^ [Xh:$i] : (ccrab @ (^ [Xb:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xh) @ ccip)) = (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ (ccfv @ (ccfv @ (ccv @ Xh) @ ccsca) @ ccur) @ (ccfv @ (ccfv @ (ccv @ Xh) @ ccsca) @ cc0g)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb))) & ((ccfv @ (ccv @ Xb) @ (ccfv @ (ccv @ Xh) @ ccocv)) = (ccsn @ (ccfv @ (ccv @ Xh) @ cc0g))))) @ (^ [Xb:$i] : (ccpw @ (ccfv @ (ccv @ Xh) @ ccbs)))))))).
