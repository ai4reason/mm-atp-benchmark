...
thf(aenen1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XA2 @ XC @ ccen) <=> (cwbr @ XB2 @ XC @ ccen))))))).
thf(calephexp2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwbr @ (cco @ cc2o @ (ccfv @ XA2 @ ccale) @ ccmap) @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (ccfv @ XA2 @ ccale)) & (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ ccale) @ ccen))) @ ccen)))).
