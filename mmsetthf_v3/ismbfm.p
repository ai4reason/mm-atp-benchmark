...
thf(cismbfm_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga))))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwcel @ XF @ (cco @ XS @ XT @ ccmbfm)) <=> ((cwcel @ XF @ (cco @ (ccuni @ XT) @ (ccuni @ XS) @ ccmap)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XT))))))))))))).
