...
thf(cftc1anclem4_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ ccibl) & (cwf @ ccr @ ccr @ XG)) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ XG) @ (ccfv @ (ccv @ Xt) @ XF) @ ccmin) @ ccabs))) @ ccitg2) @ ccr))))).
