...
thf(afunop_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwfun @ (ccop @ XX @ XY)) <=> (? [Xa:$i] : ((XX = (ccsn @ (ccv @ Xa))) & ((ccop @ XX @ XY) = (ccsn @ (ccop @ (ccv @ Xa) @ (ccv @ Xa)))))))))))).
...
thf(cfunsndifnop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((XG = (ccsn @ (ccop @ XA2 @ XB2))) => ((XA2 != XB2) => (~ (cwcel @ XG @ (ccxp @ ccvv @ ccvv))))))))))).
