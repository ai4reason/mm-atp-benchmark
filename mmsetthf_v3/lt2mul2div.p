...
thf(clt2mul2div_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt))) & ((cwcel @ XC @ ccr) & ((cwcel @ XD @ ccr) & (cwbr @ ccc0 @ XD @ cclt)))) => ((cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XC @ XD @ ccmul) @ cclt) <=> (cwbr @ (cco @ XA2 @ XD @ ccdiv) @ (cco @ XC @ XB2 @ ccdiv) @ cclt)))))))).
