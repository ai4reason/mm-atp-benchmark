...
thf(cf1oun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwf1o @ XA2 @ XB2 @ XF) & (cwf1o @ XC @ XD @ XG)) & (((ccin @ XA2 @ XC) = cc0) & ((ccin @ XB2 @ XD) = cc0))) => (cwf1o @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ (ccun @ XF @ XG)))))))))).
