...
thf(aelunitcn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) => (cwcel @ XA2 @ ccc)))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) => Xch))))).
thf(ccndprobtot_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprb) & (cwcel @ XA2 @ (ccdm @ XP)) & ((ccfv @ XA2 @ XP) != ccc0)) => ((ccfv @ (ccop @ (ccuni @ (ccdm @ XP)) @ XA2) @ (ccfv @ XP @ cccprob)) = cc1))))).
