...
thf(afnnfpeq0_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => (((ccdm @ (ccdif @ XF @ ccid)) = cc0) <=> (XF = (ccres @ ccid @ XA2))))))).
...
thf(cmdetdiaglem_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XD @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XA2 @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xi @ Xj) = (ccfv @ (XA2 @ Xi @ Xj @ Xk) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XG @ Xi @ Xj) = (ccfv @ (XR @ Xi @ Xj) @ ccmgp)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_0 = (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XH @ Xi @ Xj) = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XZ @ Xi @ Xj @ Xk) = (ccfv @ (XR @ Xi @ Xj) @ cczrh))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XS @ Xi @ Xj @ Xk) = (ccfv @ XN @ ccpsgn))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xc_x @ Xi @ Xj @ Xk) = (ccfv @ (XR @ Xi @ Xj) @ ccmulr))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((((cwcel @ (XR @ Xi @ Xj) @ cccrg) & (cwcel @ XN @ ccfn) & (cwcel @ XM @ (XB2 @ Xi @ Xj))) & (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) != (ccv @ Xj)) => ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) = Xc_0))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)) & ((cwcel @ XP @ (XH @ Xi @ Xj)) & (XP != (ccres @ ccid @ XN)))) => ((cco @ (ccfv @ XP @ (cccom @ (XZ @ Xi @ Xj @ Xk) @ (XS @ Xi @ Xj @ Xk))) @ (cco @ (XG @ Xi @ Xj) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XP) @ (ccv @ Xk) @ XM))) @ ccgsu) @ (Xc_x @ Xi @ Xj @ Xk)) = Xc_0)))))))))))))))))))))))))))).
