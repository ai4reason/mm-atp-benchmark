...
thf(cmulexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ ccexp) = (cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccmul))))))).
