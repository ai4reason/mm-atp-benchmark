...
thf(apstmval_thm,axiom,(! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccfv @ XD @ ccmetid)) => ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => ((ccfv @ XD @ ccpstm) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccuni @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa))))))))))))))).
...
thf(apstmfval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccfv @ XD @ ccmetid)) => (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cco @ (ccec @ XA2 @ Xc_sm) @ (ccec @ XB2 @ Xc_sm) @ (ccfv @ XD @ ccpstm)) = (cco @ XA2 @ XB2 @ XD)))))))))).
...
thf(ametidv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((cwbr @ XA2 @ XB2 @ (ccfv @ XD @ ccmetid)) <=> ((cco @ XA2 @ XB2 @ XD) = ccc0)))))))).
...
thf(ametider_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => (cwer @ XX @ (ccfv @ XD @ ccmetid)))))).
