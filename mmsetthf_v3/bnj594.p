...
thf(abnj253_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) <=> ((Xph & Xps) & Xch & Xth))))))).
...
thf(abnj170_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) <=> ((Xps & Xch) & Xph)))))).
...
thf(abnj258_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) <=> ((Xph & Xps & Xth) & Xch))))))).
...
thf(abnj446_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) <=> ((Xps & Xch & Xth) & Xph))))))).
...
thf(abnj590_thm,axiom,(! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xf1 @ Xi @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xy1 @ Xf1 @ Xi @ Xn) @ (XR @ Xy1 @ Xf1 @ Xi @ Xn) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((((XB2 @ Xy1 @ Xf1 @ Xi @ Xn) = (ccsuc @ (ccv @ Xi))) & (Xps @ Xy1 @ Xf1 @ Xi @ Xn)) => ((cwcel @ (ccv @ Xi) @ ccom) => ((cwcel @ (XB2 @ Xy1 @ Xf1 @ Xi @ Xn) @ (ccv @ Xn)) => ((ccfv @ (XB2 @ Xy1 @ Xf1 @ Xi @ Xn) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xy1 @ Xf1 @ Xi @ Xn) @ (XR @ Xy1 @ Xf1 @ Xi @ Xn) @ (ccv @ Xy1)))))))))))))))))).
...
thf(cbnj594_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xps:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xta:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xbnjwphm:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xbnjwpsm:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xbnjwchm:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ (XA2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (XR @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (ccv @ Xx3)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xps @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (XR @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xch @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn) <=> ((cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) & (Xph @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) & (Xps @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn) = (ccdif @ ccom @ (ccsn @ cc0)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xbnjwphm @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xg1)) = (cc_bnj14 @ (XA2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (XR @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (ccv @ Xx3)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xbnjwpsm @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xg1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xg1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (XR @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xj @ Xn) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xbnjwchm @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn) <=> ((cwfn @ (ccv @ Xg1) @ (ccv @ Xn)) & (Xbnjwphm @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) & (Xbnjwpsm @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xth @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) <=> (((cwcel @ (ccv @ Xn) @ (XD @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn)) & (Xch @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn) & (Xbnjwchm @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn)) => ((ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) = (ccfv @ (ccv @ Xj) @ (ccv @ Xg1))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((cwsbc @ (^ [Xj:$i] : (Xth @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn)) @ (ccv @ Xk)) <=> (((cwcel @ (ccv @ Xn) @ (XD @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn)) & (Xch @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn) & (Xbnjwchm @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xn)) => ((ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) = (ccfv @ (ccv @ Xk) @ (ccv @ Xg1))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xta @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn) <=> (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccep) => (cwsbc @ (^ [Xj:$i] : (Xth @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn)) @ (ccv @ Xk)))) @ (^ [Xk:$i] : (ccv @ Xn)))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (((cwcel @ (ccv @ Xj) @ (ccv @ Xn)) & (Xta @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn)) => (Xth @ Xx3 @ Xy1 @ Xf1 @ Xg1 @ Xi @ Xj @ Xk @ Xn)))))))))))))))))))))))))))))))).
