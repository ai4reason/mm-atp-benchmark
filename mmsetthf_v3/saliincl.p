...
thf(csaliincl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwbr @ XK @ ccom @ ccdom)) => ((Xph => (XK != cc0)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XK)) => (cwcel @ (XE @ Xk) @ XS))) => (Xph => (cwcel @ (cciin @ (^ [Xk:$i] : XK) @ (^ [Xk:$i] : (XE @ Xk))) @ XS))))))))))).
