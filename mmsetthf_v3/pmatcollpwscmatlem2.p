...
thf(a_1pmatscmul_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XE = (ccfv @ XP @ ccbs)) => ((Xc_as = (ccfv @ XC @ ccvsca)) => ((Xc_1 = (ccfv @ XC @ ccur)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XQ @ XE)) => (cwcel @ (cco @ XQ @ Xc_1 @ Xc_as) @ XB2)))))))))))))))))).
...
thf(aply1scltm_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((XA2 = (ccfv @ XP @ ccascl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XK)) => ((ccfv @ XF @ XA2) = (cco @ XF @ (cco @ ccc0 @ XX @ Xc_ex) @ Xc_x)))))))))))))))))))).
...
thf(apmatcollpwscmatlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_as = (ccfv @ XC @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XD = (ccfv @ XA2 @ ccbs)) => ((XU = (ccfv @ XP @ ccascl)) => ((XK = (ccfv @ XR @ ccbs)) => ((XE = (ccfv @ XP @ ccbs)) => ((XS = (ccfv @ XP @ ccascl)) => ((Xc_1 = (ccfv @ XC @ ccur)) => ((XM = (cco @ XQ @ Xc_1 @ Xc_as)) => (((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ XL @ ccn0) & (cwcel @ XQ @ XE))) & ((cwcel @ (ccv @ Xa) @ XN) & (cwcel @ (ccv @ Xb) @ XN))) => ((cco @ (ccfv @ XL @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XM) @ ccco1)) @ (cco @ ccc0 @ (ccfv @ XR @ ccv1) @ (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) @ (ccfv @ XP @ ccvsca)) = (ccif @ ((ccv @ Xa) = (ccv @ Xb)) @ (ccfv @ (ccfv @ XL @ (ccfv @ XQ @ ccco1)) @ XU) @ (ccfv @ XP @ cc0g))))))))))))))))))))))))))))))))))))))))).
...
thf(cpmatcollpwscmatlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_as = (ccfv @ XC @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XD = (ccfv @ XA2 @ ccbs)) => ((XU = (ccfv @ XP @ ccascl)) => ((XK = (ccfv @ XR @ ccbs)) => ((XE = (ccfv @ XP @ ccbs)) => ((XS = (ccfv @ XP @ ccascl)) => ((Xc_1 = (ccfv @ XC @ ccur)) => ((XM = (cco @ XQ @ Xc_1 @ Xc_as)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ XL @ ccn0) & (cwcel @ XQ @ XE))) => ((ccfv @ (cco @ XM @ XL @ ccdecpmat) @ XT) = (cco @ (ccfv @ (ccfv @ XL @ (ccfv @ XQ @ ccco1)) @ XU) @ Xc_1 @ Xc_as)))))))))))))))))))))))))))))))))))))).
