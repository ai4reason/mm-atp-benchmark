...
thf(ahlatle_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ Xc_le) <=> (cwral @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XX @ Xc_le) => (cwbr @ (ccv @ Xp) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2)))))))))))))).
thf(ctrlord_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xf1:$i] : ((XA2 @ Xf1) = (ccfv @ XK @ ccatm))) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XX @ XB2) & (cwbr @ XX @ XW @ Xc_le)) & ((cwcel @ XY @ XB2) & (cwbr @ XY @ XW @ Xc_le))) => ((cwbr @ XX @ XY @ Xc_le) <=> (cwral @ (^ [Xf1:$i] : ((cwbr @ (ccfv @ (ccv @ Xf1) @ XR) @ XX @ Xc_le) => (cwbr @ (ccfv @ (ccv @ Xf1) @ XR) @ XY @ Xc_le))) @ (^ [Xf1:$i] : XT))))))))))))))))))))).
