...
thf(ccarsguni_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XO @ XV)) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => (Xph => ((ccuni @ (ccfv @ XM @ cccarsg)) = XO)))))))))).
