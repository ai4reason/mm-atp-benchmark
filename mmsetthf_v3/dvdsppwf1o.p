...
thf(apcidlem_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn0)) => ((cco @ XP @ (cco @ XP @ XA2 @ ccexp) @ ccpc) = XA2))))).
...
thf(cdvdsppwf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ XA2 @ ccfz)) @ (^ [Xn:$i] : (cco @ XP @ (ccv @ Xn) @ ccexp)))))) => (! [Xx3:$i] : (! [Xn:$i] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn0)) => (cwf1o @ (cco @ ccc0 @ XA2 @ ccfz) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ XP @ XA2 @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (XF @ Xx3 @ Xn)))))))))).
