...
thf(chsmexlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xa:$i] : ((XF @ Xa) = (ccoi @ (XB2 @ Xa) @ ccep))) => ((! [Xa:$i] : ((XG @ Xa) = (ccoi @ (cciun @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (XB2 @ Xa))) @ ccep))) => (! [Xa:$i] : (((cwcel @ XA2 @ (XV @ Xa)) & (cwcel @ XC @ ccon0) & (cwral @ (^ [Xa:$i] : ((cwcel @ (XB2 @ Xa) @ (ccpw @ ccon0)) & (cwcel @ (ccdm @ (XF @ Xa)) @ XC))) @ (^ [Xa:$i] : XA2))) => (cwcel @ (ccdm @ (XG @ Xa)) @ (ccfv @ (ccpw @ (ccxp @ XA2 @ XC)) @ cchar))))))))))))).
