...
thf(alhp2atnle_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & (XU != XV)) & ((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le)) & ((cwcel @ XV @ XA2) & (cwbr @ XV @ XW @ Xc_le))) => (~ (cwbr @ XV @ (cco @ XP @ XU @ Xc_or) @ Xc_le))))))))))))))))).
