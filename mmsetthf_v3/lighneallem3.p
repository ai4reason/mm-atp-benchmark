...
thf(aoddge22np1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) = XN)) @ (^ [Xn:$i] : ccn)))))).
...
thf(apwm1geoser_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (cco @ XA2 @ XN @ ccexp) @ cc1 @ ccmin) = (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) @ ccmul))))))))).
...
thf(clighneallem3_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) & (cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) & ((~ (cwbr @ cc2 @ XN @ ccdvds)) & (cwbr @ cc2 @ XM @ ccdvds)) & ((cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin) = (cco @ XP @ XM @ ccexp))) => (XM = cc1)))))).
