...
thf(copnrebl_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ ccioo) @ XA2)) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : XA2)))))).
