...
thf(adf_sqrt_ax,axiom,(ccsqrt = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : (((cco @ (ccv @ Xy1) @ cc2 @ ccexp) = (ccv @ Xx3)) & (cwbr @ ccc0 @ (ccfv @ (ccv @ Xy1) @ ccre) @ ccle) & (cwnel @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccrp))) @ (^ [Xy1:$i] : ccc)))))).
thf(ariotaex_thm,axiom,(! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwcel @ (ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccvv)))).
thf(csqrtval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccsqrt) = (ccrio @ (^ [Xx3:$i] : (((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2) & (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) & (cwnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp))) @ (^ [Xx3:$i] : ccc)))))).
