...
thf(ampv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => ((cco @ XA2 @ XB2 @ ccmp) = (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmq))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XA2)))))))).
