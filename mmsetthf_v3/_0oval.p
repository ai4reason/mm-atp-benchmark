...
thf(c_0oval_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XZ = (ccfv @ XW @ ccn0v)) => ((XO = (cco @ XU @ XW @ cc0o)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv) & (cwcel @ XA2 @ XX)) => ((ccfv @ XA2 @ XO) = XZ)))))))))))).
