...
thf(acnntri_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccuni @ XK)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) & (cwss @ XS @ XY)) => (cwss @ (ccima @ (cccnv @ XF) @ (ccfv @ XS @ (ccfv @ XK @ ccnt))) @ (ccfv @ (ccima @ (cccnv @ XF) @ XS) @ (ccfv @ XJ @ ccnt))))))))))).
...
thf(chmeontr_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) & (cwss @ XA2 @ XX)) => ((ccfv @ (ccima @ XF @ XA2) @ (ccfv @ XK @ ccnt)) = (ccima @ XF @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)))))))))))).
