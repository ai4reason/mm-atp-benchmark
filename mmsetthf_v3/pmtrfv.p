...
thf(cpmtrfv_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((((cwcel @ XD @ XV) & (cwss @ XP @ XD) & (cwbr @ XP @ cc2o @ ccen)) & (cwcel @ XZ @ XD)) => ((ccfv @ XZ @ (ccfv @ XP @ XT)) = (ccif @ (cwcel @ XZ @ XP) @ (ccuni @ (ccdif @ XP @ (ccsn @ XZ))) @ XZ)))))))))).
