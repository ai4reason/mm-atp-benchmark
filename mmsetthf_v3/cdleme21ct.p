...
thf(acdleme21a_thm,axiom,(! [Xz:$i] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & ((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le))) & ((cwcel @ (ccv @ Xz) @ XA2) & ((cco @ XP @ (ccv @ Xz) @ Xc_or) = (cco @ XS @ (ccv @ Xz) @ Xc_or)))) => (XS != (ccv @ Xz))))))))))))))).
