...
thf(aghomf_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XW = (ccrn @ XH)) => (((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr) & (cwcel @ XF @ (cco @ XG @ XH @ ccghomOLD))) => (cwf @ XX @ XW @ XF)))))))))).
...
thf(cgrpokerinj_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((XW = (ccfv @ XG @ ccgi)) => ((XY = (ccrn @ XH)) => ((XU = (ccfv @ XH @ ccgi)) => (((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr) & (cwcel @ XF @ (cco @ XG @ XH @ ccghomOLD))) => ((cwf1 @ XX @ XY @ XF) <=> ((ccima @ (cccnv @ XF) @ (ccsn @ XU)) = (ccsn @ XW)))))))))))))))).
