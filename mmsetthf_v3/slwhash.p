...
thf(asylow1_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XG @ ccgrp)) => ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ (cco @ XP @ XN @ ccexp) @ (ccfv @ XX @ cchash) @ ccdvds)) => (Xph => (cwrex @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ cchash) = (cco @ XP @ XN @ ccexp))) @ (^ [Xg1:$i] : (ccfv @ XG @ ccsubg)))))))))))))))).
...
thf(aslwprm_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ (cco @ XP @ XG @ ccslw)) => (cwcel @ XP @ ccprime)))))).
...
thf(apgpfi_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn)) => ((cwbr @ XP @ XG @ ccpgp) <=> ((cwcel @ XP @ ccprime) & (cwrex @ (^ [Xn:$i] : ((ccfv @ XX @ cchash) = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))))))))).
