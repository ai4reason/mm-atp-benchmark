...
thf(amulsucdiv2z_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwcel @ (cco @ (cco @ XN @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ cc2 @ ccdiv) @ ccz)))).
thf(csqoddm1div8z_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds))) => (cwcel @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccz)))).
