...
thf(aelimhyp2v_thm,axiom,(! [Xph:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = (ccif @ Xph @ XA2 @ XC)) => (Xph <=> Xch)) => (((XB2 = (ccif @ Xph @ XB2 @ XD)) => (Xch <=> Xth)) => (((XC = (ccif @ Xph @ XA2 @ XC)) => (Xta <=> Xet)) => (((XD = (ccif @ Xph @ XB2 @ XD)) => (Xet <=> Xth)) => (Xta => Xth))))))))))))))).
