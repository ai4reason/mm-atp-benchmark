...
thf(cipolerval_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XI = (ccfv @ XF @ ccipo)) => ((cwcel @ XF @ XV) => ((ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF) & (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)))))) = (ccfv @ XI @ ccple)))))))).
