...
thf(cmat1dim0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => ((ccfv @ XA2 @ cc0g) = (ccsn @ (ccop @ XO @ (ccfv @ XR @ cc0g))))))))))))))).
