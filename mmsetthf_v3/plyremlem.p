...
thf(adgrid_thm,axiom,((ccfv @ ccidp @ ccdgr) = cc1)).
...
thf(cplyremlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => ((cwcel @ XA2 @ ccc) => ((cwcel @ XG @ (ccfv @ ccc @ ccply)) & ((ccfv @ XG @ ccdgr) = cc1) & ((ccima @ (cccnv @ XG) @ (ccsn @ ccc0)) = (ccsn @ XA2)))))))).
