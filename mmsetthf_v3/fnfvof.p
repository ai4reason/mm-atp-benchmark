...
thf(cfnfvof_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) & ((cwcel @ XA2 @ XV) & (cwcel @ XX @ XA2))) => ((ccfv @ XX @ (cco @ XF @ XG @ (ccof @ XR))) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XX @ XG) @ XR)))))))))).
