...
thf(cquartlem1_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XP @ ccc)) => ((Xph => (cwcel @ XQ @ ccc)) => ((Xph => (cwcel @ XR @ ccc)) => ((Xph => (XU = (cco @ (cco @ XP @ cc2 @ ccexp) @ (cco @ (ccdc @ cc1 @ cc2) @ XR @ ccmul) @ ccaddc))) => ((Xph => (XV = (cco @ (cco @ (ccneg @ (cco @ cc2 @ (cco @ XP @ cc3 @ ccexp) @ ccmul)) @ (cco @ (ccdc @ cc2 @ cc7) @ (cco @ XQ @ cc2 @ ccexp) @ ccmul) @ ccmin) @ (cco @ (ccdc @ cc7 @ cc2) @ (cco @ XP @ XR @ ccmul) @ ccmul) @ ccaddc))) => (Xph => ((XU = (cco @ (cco @ (cco @ cc2 @ XP @ ccmul) @ cc2 @ ccexp) @ (cco @ cc3 @ (cco @ (cco @ XP @ cc2 @ ccexp) @ (cco @ cc4 @ XR @ ccmul) @ ccmin) @ ccmul) @ ccmin)) & (XV = (cco @ (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ XP @ ccmul) @ cc3 @ ccexp) @ ccmul) @ (cco @ cc9 @ (cco @ (cco @ cc2 @ XP @ ccmul) @ (cco @ (cco @ XP @ cc2 @ ccexp) @ (cco @ cc4 @ XR @ ccmul) @ ccmin) @ ccmul) @ ccmul) @ ccmin) @ (cco @ (ccdc @ cc2 @ cc7) @ (ccneg @ (cco @ XQ @ cc2 @ ccexp)) @ ccmul) @ ccaddc)))))))))))))))).
