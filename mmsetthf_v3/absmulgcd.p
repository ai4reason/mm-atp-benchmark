...
thf(cabsmulgcd_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccgcd) = (ccfv @ (cco @ XK @ (cco @ XM @ XN @ ccgcd) @ ccmul) @ ccabs))))))).
