...
thf(cuntuni_conj,conjecture,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccuni @ XA2))) <=> (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))).
