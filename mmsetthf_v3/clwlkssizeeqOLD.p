...
thf(cclwlkssizeeqOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ ccprime)) => ((ccfv @ (cco @ XN @ XG @ ccclwwlkn) @ cchash) = (ccfv @ (ccrab @ (^ [Xc:$i] : ((ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) = XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks))) @ cchash)))))).
