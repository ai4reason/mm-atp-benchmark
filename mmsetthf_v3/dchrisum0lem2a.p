...
thf(adchrabs2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((XZ = (ccfv @ XN @ cczn)) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XA2 @ XB2)) => (Xph => (cwbr @ (ccfv @ (ccfv @ XA2 @ XX) @ ccabs) @ cc1 @ ccle))))))))))))))))).
