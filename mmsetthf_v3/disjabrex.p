...
thf(adisjif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XY) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (! [Xx3:$i] : (((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ XY @ XA2)) & ((cwcel @ (XZ @ Xx3) @ (XB2 @ Xx3)) & (cwcel @ (XZ @ Xx3) @ (XC @ Xx3)))) => ((ccv @ Xx3) = XY))))))))))).
...
thf(cdisjabrex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (cwdisj @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))) @ (^ [Xy1:$i] : (ccv @ Xy1))))))).
