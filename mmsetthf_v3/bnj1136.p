...
thf(abnj1148_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => (cwcel @ (cc_bnj14 @ XA2 @ XR @ XX) @ ccvv)))))).
...
thf(abnj1127_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ (cc_bnj18 @ XA2 @ XR @ XX)) => (cwcel @ XY @ XA2))))))).
...
thf(abnj1137_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccun @ (cc_bnj14 @ XA2 @ XR @ XX) @ (cciun @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ XX)) @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => (cw_bnj19 @ XA2 @ (XB2 @ Xy1) @ XR))))))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(abnj931_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = (ccun @ XB2 @ XC)) => (cwss @ XB2 @ XA2)))))).
thf(abnj1124_thm,axiom,(! [Xth:$o] : (! [Xta:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((Xth <=> ((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2))) => ((Xta <=> ((cwcel @ XB2 @ ccvv) & (cw_bnj19 @ XA2 @ XB2 @ XR) & (cwss @ (cc_bnj14 @ XA2 @ XR @ XX) @ XB2))) => ((Xth & Xta) => (cwss @ (cc_bnj18 @ XA2 @ XR @ XX) @ XB2))))))))))).
...
thf(cbnj1136_conj,conjecture,(! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccun @ (cc_bnj14 @ XA2 @ XR @ XX) @ (cciun @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ XX)) @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ (ccv @ Xy1))))))) => ((! [Xy1:$i] : ((Xth @ Xy1) <=> ((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)))) => ((! [Xy1:$i] : ((Xta @ Xy1) <=> ((cwcel @ (XB2 @ Xy1) @ ccvv) & (cw_bnj19 @ XA2 @ (XB2 @ Xy1) @ XR) & (cwss @ (cc_bnj14 @ XA2 @ XR @ XX) @ (XB2 @ Xy1))))) => (! [Xy1:$i] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => ((cc_bnj18 @ XA2 @ XR @ XX) = (XB2 @ Xy1)))))))))))))).
