...
thf(anumclwwlk5lem_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XX @ XV) & (cwcel @ XK @ ccn0)) => ((cwbr @ cc2 @ (cco @ XK @ cc1 @ ccmin) @ ccdvds) => ((cco @ (ccfv @ (cco @ XX @ cc2 @ (ccfv @ XG @ ccclwwlknon)) @ cchash) @ cc2 @ ccmo) = cc1))))))))).
...
thf(amulmoddvds_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cwbr @ XN @ XA2 @ ccdvds) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ ccmo) = ccc0))))))).
...
thf(cnumclwwlk5_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr) & (cwcel @ XV @ ccfn)) & ((cwcel @ XX @ XV) & (cwcel @ XP @ ccprime) & (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) => ((cco @ (ccfv @ (cco @ XX @ XP @ (ccfv @ XG @ ccclwwlknon)) @ cchash) @ XP @ ccmo) = cc1))))))))).
