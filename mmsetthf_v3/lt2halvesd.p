...
thf(clt2halvesd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XA2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt)) => ((Xph => (cwbr @ XB2 @ (cco @ XC @ cc2 @ ccdiv) @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt)))))))))))).
