...
thf(adgrcolem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => ((! [Xf1:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((! [Xf1:$i] : (Xph => (cwcel @ XG @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((XA2 = (ccfv @ XF @ cccoe)) => ((Xph => (cwcel @ XD @ ccn0)) => ((Xph => (XM = (cco @ XD @ cc1 @ ccaddc))) => ((Xph => (cwral @ (^ [Xf1:$i] : ((cwbr @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XD @ ccle) => ((ccfv @ (cccom @ (ccv @ Xf1) @ XG) @ ccdgr) = (cco @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XN @ ccmul)))) @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply)))) => (Xph => ((ccfv @ (cccom @ XF @ XG) @ ccdgr) = (cco @ XM @ XN @ ccmul)))))))))))))))))))).
...
thf(cdgrco_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((Xph => (cwcel @ XG @ (ccfv @ XS @ ccply))) => (Xph => ((ccfv @ (cccom @ XF @ XG) @ ccdgr) = (cco @ XM @ XN @ ccmul)))))))))))))).
