...
thf(cablsubsub23_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccabl) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => (((cco @ XA2 @ XB2 @ Xc_mi) = XC) <=> ((cco @ XA2 @ XC @ Xc_mi) = XB2)))))))))))).
