...
thf(creglogexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XN @ ccz) & ((cwcel @ XC @ ccrp) & (XC != cc1))) => ((cco @ (ccfv @ (cco @ XA2 @ XN @ ccexp) @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) = (cco @ XN @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ ccmul))))))).
