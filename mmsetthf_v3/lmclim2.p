...
thf(clmclim2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwf @ ccn @ XX @ XF)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((XG = (ccmpt @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ XY @ XD)))) => ((Xph => (cwcel @ XY @ XX)) => (Xph => ((cwbr @ XF @ XY @ (ccfv @ XJ @ cclm)) <=> (cwbr @ XG @ ccc0 @ ccli)))))))))))))))).
