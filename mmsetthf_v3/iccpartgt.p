...
thf(ciccpartgt_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xi) @ (ccv @ Xj) @ cclt) => (cwbr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XP) @ cclt))) @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))).
