...
thf(afiinopn_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => (((cwss @ XA2 @ XJ) & (XA2 != cc0) & (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccint @ XA2) @ XJ)))))).
...
thf(ctxtube_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XR)) => ((XY = (ccuni @ XS)) => ((Xph => (cwcel @ XR @ cccmp)) => ((Xph => (cwcel @ XS @ cctop)) => ((Xph => (cwcel @ XU @ (cco @ XR @ XS @ cctx))) => ((Xph => (cwss @ (ccxp @ XX @ (ccsn @ XA2)) @ XU)) => ((Xph => (cwcel @ XA2 @ XY)) => (Xph => (cwrex @ (^ [Xu:$i] : ((cwcel @ XA2 @ (ccv @ Xu)) & (cwss @ (ccxp @ XX @ (ccv @ Xu)) @ XU))) @ (^ [Xu:$i] : XS)))))))))))))))))).
