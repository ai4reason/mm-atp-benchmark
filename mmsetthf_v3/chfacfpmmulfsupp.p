...
thf(achfacfpmmul0_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xp:($i > ($i > ($i > ($i > $o))))] : (! [Xc_ex:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XA2 @ Xn @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XB2 @ Xs1 @ Xb) = (ccfv @ (XA2 @ Xn @ Xs1 @ Xb) @ ccbs))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XP @ Xn @ Xs1 @ Xb) = (ccfv @ (XR @ Xs1 @ Xb) @ ccpl1))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XY @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XP @ Xn @ Xs1 @ Xb) @ ccmat))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_xp @ Xn @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccmulr))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_mi @ Xn @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccsg))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_0 @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ cc0g)))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XT @ Xn @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat2pmat))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XG @ Xn @ Xs1 @ Xb) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ (cco @ (Xc_0 @ Xs1 @ Xb) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (XT @ Xn @ Xs1 @ Xb)) @ (Xc_xp @ Xn @ Xs1 @ Xb)) @ (Xc_mi @ Xn @ Xs1 @ Xb)) @ (ccif @ ((ccv @ Xn) = (cco @ (ccv @ Xs1) @ cc1 @ ccaddc)) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ (XT @ Xn @ Xs1 @ Xb)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ (ccv @ Xn) @ cclt) @ (Xc_0 @ Xs1 @ Xb) @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccv @ Xb)) @ (XT @ Xn @ Xs1 @ Xb)) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xb)) @ (XT @ Xn @ Xs1 @ Xb)) @ (Xc_xp @ Xn @ Xs1 @ Xb)) @ (Xc_mi @ Xn @ Xs1 @ Xb))))))))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_ex @ Xn @ Xs1 @ Xb) = (ccfv @ (ccfv @ (XY @ Xs1 @ Xb) @ ccmgp) @ ccmg))))) => (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((((cwcel @ (XN @ Xs1 @ Xb) @ ccfn) & (cwcel @ (XR @ Xs1 @ Xb) @ cccrg) & (cwcel @ (XM @ Xs1 @ Xb) @ (XB2 @ Xs1 @ Xb))) & ((cwcel @ (ccv @ Xs1) @ ccn) & (cwcel @ (ccv @ Xb) @ (cco @ (XB2 @ Xs1 @ Xb) @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap))) & (cwcel @ (XK @ Xs1 @ Xb) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccaddc) @ ccuz))) => ((cco @ (cco @ (XK @ Xs1 @ Xb) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xn @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (XK @ Xs1 @ Xb) @ (XG @ Xn @ Xs1 @ Xb)) @ (Xc_xp @ Xn @ Xs1 @ Xb)) = (Xc_0 @ Xs1 @ Xb))))))))))))))))))))))))))))))).
