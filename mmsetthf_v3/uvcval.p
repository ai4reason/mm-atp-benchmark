...
thf(cuvcval_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xk:$i] : ((XU @ Xk) = (cco @ XR @ XI @ ccuvc))) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (! [Xk:$i] : (((cwcel @ XR @ (XV @ Xk)) & (cwcel @ XI @ (XW @ Xk)) & (cwcel @ XJ @ XI)) => ((ccfv @ XJ @ (XU @ Xk)) = (ccmpt @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (ccif @ ((ccv @ Xk) = XJ) @ Xc_1 @ Xc_0)))))))))))))))))).
