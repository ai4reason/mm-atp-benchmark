...
thf(altrnco4_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XE @ XT) & (cwcel @ XF @ XT)) => ((cccom @ (cccom @ XD @ XE) @ (cccom @ XF @ XG)) = (cccom @ (cccom @ XD @ XF) @ (cccom @ XE @ XG))))))))))))))).
thf(ctendoco2_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XE) & (cwcel @ XV @ XE)) & ((cwcel @ XF @ XT) & (cwcel @ XG @ XT))) => ((cccom @ (ccfv @ (cccom @ XF @ XG) @ XU) @ (ccfv @ (cccom @ XF @ XG) @ XV)) = (cccom @ (cccom @ (ccfv @ XF @ XU) @ (ccfv @ XF @ XV)) @ (cccom @ (ccfv @ XG @ XU) @ (ccfv @ XG @ XV)))))))))))))))))).
