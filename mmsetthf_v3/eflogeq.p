...
thf(ceflogeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (XB2 != ccc0)) => (((ccfv @ XA2 @ cce) = XB2) <=> (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ (ccfv @ XB2 @ cclog) @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccaddc))) @ (^ [Xn:$i] : ccz))))))).
