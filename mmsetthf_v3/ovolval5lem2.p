...
thf(aovolval5lem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XW:($i > $o)] : ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (XB2 @ Xn) @ ccr))) => ((Xph => (cwcel @ XW @ ccrp)) => ((XC = (ccrab @ (^ [Xn:$i] : (cwbr @ (XA2 @ Xn) @ (XB2 @ Xn) @ cclt)) @ (^ [Xn:$i] : ccn))) => (Xph => (cwbr @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (cco @ (XA2 @ Xn) @ (cco @ XW @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (XB2 @ Xn) @ ccioo) @ ccvol))) @ ccsumge0) @ (cco @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccico) @ ccvol))) @ ccsumge0) @ XW @ ccxad) @ ccle)))))))))))).
...
thf(covolval5lem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xn:$i] : ((XQ @ Xf1 @ Xn) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xz) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => ((XY @ Xf1 @ Xn) = (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (XF @ Xz @ Xf1)) @ ccsumge0)))))) => ((! [Xz:$i] : (! [Xn:$i] : ((XZ @ Xn) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (XG @ Xz)) @ ccsumge0)))) => ((! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xz @ Xf1) => (cwf @ ccn @ (ccxp @ ccr @ ccr) @ (XF @ Xz @ Xf1))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccico @ (XF @ Xz @ Xf1))))))))) => ((! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xz @ Xf1) => (cwcel @ (XW @ Xf1) @ ccrp)))) => ((! [Xz:$i] : (! [Xf1:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc1st) @ (cco @ (XW @ Xf1) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc2nd))))))) => (! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (XY @ Xf1 @ Xn) @ (XW @ Xf1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : (XQ @ Xf1 @ Xn))))))))))))))))))))))).
