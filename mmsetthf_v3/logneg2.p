...
thf(aefipi_thm,axiom,((ccfv @ (cco @ cci @ ccpi @ ccmul) @ cce) = (ccneg @ cc1))).
...
thf(adiv1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ cc1 @ ccdiv) = XA2)))).
...
thf(clogneg2_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccim) @ cclt)) => ((ccfv @ (ccneg @ XA2) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ ccpi @ ccmul) @ ccmin))))).
