...
thf(apgp0_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XP @ ccprime)) => (cwbr @ XP @ (cco @ XG @ (ccsn @ Xc_0) @ ccress) @ ccpgp))))))).
