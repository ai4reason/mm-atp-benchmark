...
thf(ceqfnfv2f_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XG @ Xx3))) => (! [Xx3:$i] : (((cwfn @ (XF @ Xx3) @ XA2) & (cwfn @ (XG @ Xx3) @ XA2)) => (((XF @ Xx3) = (XG @ Xx3)) <=> (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) = (ccfv @ (ccv @ Xx3) @ (XG @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))))))).
