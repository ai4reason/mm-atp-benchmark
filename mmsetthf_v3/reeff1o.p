...
thf(areclt1_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwbr @ XA2 @ cc1 @ cclt) <=> (cwbr @ cc1 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt))))).
...
thf(areeff1olem_thm,axiom,(! [XU:($i > $o)] : (((cwcel @ XU @ ccr) & (cwbr @ cc1 @ XU @ cclt)) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cce) = XU)) @ (^ [Xx3:$i] : ccr))))).
