...
thf(cclwwlknon1loop_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XC = (ccfv @ XG @ ccclwwlknon)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XX @ XV) & (cwcel @ (ccsn @ XX) @ XE)) => ((cco @ XX @ cc1 @ XC) = (ccsn @ (ccs1 @ XX))))))))))))).
