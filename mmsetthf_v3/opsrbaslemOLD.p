...
thf(copsrbaslemOLD_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XO = (ccfv @ XT @ (cco @ XI @ XR @ ccopws))) => ((Xph => (cwss @ XT @ (ccxp @ XI @ XI))) => ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwbr @ XN @ cc10 @ cclt) => (Xph => ((ccfv @ XS @ XE) = (ccfv @ XO @ XE)))))))))))))))))).
