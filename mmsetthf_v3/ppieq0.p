...
thf(appiwordi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ ccppi) @ (ccfv @ XB2 @ ccppi) @ ccle))))).
thf(ccfz_tp,type,(ccfz : ($i > $o))).
thf(appifl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccfv @ XA2 @ ccfl) @ ccppi) = (ccfv @ XA2 @ ccppi))))).
thf(aa1i_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(appi1_thm,axiom,((ccfv @ cc1 @ ccppi) = ccc0)).
...
thf(cppieq0_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (((ccfv @ XA2 @ ccppi) = ccc0) <=> (cwbr @ XA2 @ cc2 @ cclt))))).
