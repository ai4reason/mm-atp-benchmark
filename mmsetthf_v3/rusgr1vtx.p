...
thf(arusgr1vtxlem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xv:$i] : ((((cwral @ (^ [Xv:$i] : ((ccfv @ (XA2 @ Xv) @ cchash) = XK)) @ (^ [Xv:$i] : XV)) & (cwral @ (^ [Xv:$i] : ((XA2 @ Xv) = cc0)) @ (^ [Xv:$i] : XV))) & ((cwcel @ XV @ (XW @ Xv)) & ((ccfv @ XV @ cchash) = cc1))) => (XK = ccc0)))))))).
thf(crusgr1vtx_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : ((((ccfv @ (ccfv @ XG @ ccvtx) @ cchash) = cc1) & (cwbr @ XG @ XK @ ccrusgr)) => (XK = ccc0))))).
