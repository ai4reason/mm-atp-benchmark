...
thf(alcmf_thm,axiom,(! [XK:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XK @ ccn) & ((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn) & (cwnel @ ccc0 @ XZ))) => ((XK = (ccfv @ XZ @ cclcmf)) <=> ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ XK @ ccdvds)) @ (^ [Xm:$i] : XZ)) & (cwral @ (^ [Xk:$i] : ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccdvds)) @ (^ [Xm:$i] : XZ)) => (cwbr @ XK @ (ccv @ Xk) @ ccle))) @ (^ [Xk:$i] : ccn)))))))).
thf(clcmfunsnlem2lem2_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : ((((cwnel @ ccc0 @ (ccv @ Xy1)) & ((ccv @ Xz) != ccc0) & ((ccv @ Xn) != ccc0)) & ((cwcel @ (ccv @ Xn) @ ccz) & (((cwcel @ (ccv @ Xz) @ ccz) & (cwss @ (ccv @ Xy1) @ ccz) & (cwcel @ (ccv @ Xy1) @ ccfn)) & ((cwral @ (^ [Xk:$i] : ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccdvds)) @ (^ [Xm:$i] : (ccv @ Xy1))) => (cwbr @ (ccfv @ (ccv @ Xy1) @ cclcmf) @ (ccv @ Xk) @ ccdvds))) @ (^ [Xk:$i] : ccz)) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xn))) @ cclcmf) = (cco @ (ccfv @ (ccv @ Xy1) @ cclcmf) @ (ccv @ Xn) @ cclcm))) @ (^ [Xn:$i] : ccz)))))) => ((ccfv @ (ccun @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xz))) @ (ccsn @ (ccv @ Xn))) @ cclcmf) = (cco @ (ccfv @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xz))) @ cclcmf) @ (ccv @ Xn) @ cclcm))))))).
