...
thf(ctnglem_conj,conjecture,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XE = (ccslot @ XK)) => ((cwcel @ XK @ ccn) => ((cwbr @ XK @ cc9 @ cclt) => ((cwcel @ XN @ XV) => ((ccfv @ XG @ XE) = (ccfv @ XT @ XE)))))))))))))).
