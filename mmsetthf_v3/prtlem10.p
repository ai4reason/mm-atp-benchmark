...
thf(cprtlem10_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [Xc_sm:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xw:$i] : ((cwer @ (XA2 @ Xz @ Xw) @ (Xc_sm @ Xz @ Xw)) => ((cwcel @ (ccv @ Xz) @ (XA2 @ Xz @ Xw)) => ((cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (Xc_sm @ Xz @ Xw)) <=> (cwrex @ (^ [Xv:$i] : ((cwcel @ (ccv @ Xz) @ (ccec @ (ccv @ Xv) @ (Xc_sm @ Xz @ Xw))) & (cwcel @ (ccv @ Xw) @ (ccec @ (ccv @ Xv) @ (Xc_sm @ Xz @ Xw))))) @ (^ [Xv:$i] : (XA2 @ Xz @ Xw))))))))))).
