...
thf(amrcmndind_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl)) => ((Xps @ Xx3) <=> (Xth @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (Xc_0 @ Xy1 @ Xz)) => ((Xps @ Xx3) <=> (Xta @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (XA2 @ Xy1 @ Xz)) => ((Xps @ Xx3) <=> (Xet @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_0 @ Xy1 @ Xz) = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ cc0g))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xc_pl = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XB2 @ Xx3) = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xy1 @ Xz) @ ccmnd))))) => ((! [Xx3:$i] : (Xph => (cwss @ (XG @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((XB2 @ Xx3) = (ccfv @ (XG @ Xx3) @ (ccfv @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccsubmnd) @ ccmrc))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xph => (Xta @ Xy1 @ Xz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3)) & (cwcel @ (ccv @ Xz) @ (XG @ Xx3))) & (Xch @ Xy1)) => (Xth @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xx3)))))) => (! [Xy1:$i] : (! [Xz:$i] : (Xph => (Xet @ Xy1 @ Xz)))))))))))))))))))))))))))))).
...
thf(apmtrrn2_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & (XF = (ccfv @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XT)))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD)))))))))).
...
thf(amdetunilem6_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (XA2 = (cco @ XN @ (XR @ Xa @ Xb) @ ccmat)))) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : (XK = (ccfv @ (XR @ Xa @ Xb) @ ccbs)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_0 = (ccfv @ (XR @ Xa @ Xb) @ cc0g)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_1 = (ccfv @ (XR @ Xa @ Xb) @ ccur)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_pl = (ccfv @ (XR @ Xa @ Xb) @ ccplusg)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xa @ Xb) = (ccfv @ (XR @ Xa @ Xb) @ ccmulr)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XR @ Xa @ Xb) @ ccrg)))) => ((Xph => (cwf @ XB2 @ XK @ XD)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((((ccv @ Xy1) != (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xw) @ (ccv @ Xx3)) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xx3)))) @ (^ [Xw:$i] : XN))) => ((ccfv @ (ccv @ Xx3) @ XD) = Xc_0))) @ (^ [Xz:$i] : XN))) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccres @ (ccv @ Xy1) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_pl))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xy1) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccfv @ (ccv @ Xy1) @ XD) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_pl)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN) @ (ccsn @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ (Xc_x @ Xa @ Xb)))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XD) @ (Xc_x @ Xa @ Xb))))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XB2))))) => ((Xps => Xph) => ((Xps => ((cwcel @ XE @ XN) & (cwcel @ XF @ XN) & (XE != XF))) => ((! [Xb:$i] : ((Xps & (cwcel @ (ccv @ Xb) @ XN)) => ((cwcel @ (XG @ Xb) @ XK) & (cwcel @ (XH @ Xb) @ XK)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xps & (cwcel @ (ccv @ Xa) @ XN) & (cwcel @ (ccv @ Xb) @ XN)) => (cwcel @ (XI @ Xa @ Xb) @ XK)))) => (! [Xa:$i] : (! [Xb:$i] : (Xps => ((ccfv @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xa) = XE) @ (XG @ Xb) @ (ccif @ ((ccv @ Xa) = XF) @ (XH @ Xb) @ (XI @ Xa @ Xb)))))) @ XD) = (ccfv @ (ccfv @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xa) = XE) @ (XH @ Xb) @ (ccif @ ((ccv @ Xa) = XF) @ (XG @ Xb) @ (XI @ Xa @ Xb)))))) @ XD) @ (ccfv @ (XR @ Xa @ Xb) @ ccminusg))))))))))))))))))))))))))))))))))))))))).
...
thf(apmtrprfv_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => (((cwcel @ XD @ XV) & ((cwcel @ XX @ XD) & (cwcel @ XY @ XD) & (XX != XY))) => ((ccfv @ XX @ (ccfv @ (ccpr @ XX @ XY) @ XT)) = XY))))))))).
...
thf(apmtrmvd_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => (((cwcel @ XD @ XV) & (cwss @ XP @ XD) & (cwbr @ XP @ cc2o @ ccen)) => ((ccdm @ (ccdif @ (ccfv @ XP @ XT) @ ccid)) = XP)))))))).
...
thf(afnelnfp_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XX @ XA2)) => ((cwcel @ XX @ (ccdm @ (ccdif @ XF @ ccid))) <=> ((ccfv @ XX @ XF) != XX))))))).
...
thf(aringmneg1_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XN = (ccfv @ XR @ ccminusg)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cco @ (ccfv @ XX @ XN) @ XY @ Xc_x) = (ccfv @ (cco @ XX @ XY @ Xc_x) @ XN))))))))))))))))).
...
thf(cmdetunilem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (XA2 = (cco @ XN @ (XR @ Xa @ Xb) @ ccmat)))) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : (XK = (ccfv @ (XR @ Xa @ Xb) @ ccbs)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_0 = (ccfv @ (XR @ Xa @ Xb) @ cc0g)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_1 = (ccfv @ (XR @ Xa @ Xb) @ ccur)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_pl = (ccfv @ (XR @ Xa @ Xb) @ ccplusg)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xa @ Xb) = (ccfv @ (XR @ Xa @ Xb) @ ccmulr)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XR @ Xa @ Xb) @ ccrg)))) => ((Xph => (cwf @ XB2 @ XK @ XD)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((((ccv @ Xy1) != (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xw) @ (ccv @ Xx3)) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xx3)))) @ (^ [Xw:$i] : XN))) => ((ccfv @ (ccv @ Xx3) @ XD) = Xc_0))) @ (^ [Xz:$i] : XN))) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccres @ (ccv @ Xy1) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_pl))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xy1) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccfv @ (ccv @ Xy1) @ XD) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_pl)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN) @ (ccsn @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ (Xc_x @ Xa @ Xb)))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XD) @ (Xc_x @ Xa @ Xb))))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XB2))))) => (! [Xa:$i] : (! [Xb:$i] : ((Xph & (cwf1o @ XN @ XN @ XE) & (cwcel @ XF @ XB2)) => ((ccfv @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ (ccfv @ (ccv @ Xa) @ XE) @ (ccv @ Xb) @ XF)))) @ XD) = (cco @ (ccfv @ XE @ (cccom @ (ccfv @ (XR @ Xa @ Xb) @ cczrh) @ (ccfv @ XN @ ccpsgn))) @ (ccfv @ XF @ XD) @ (Xc_x @ Xa @ Xb))))))))))))))))))))))))))))))))).
