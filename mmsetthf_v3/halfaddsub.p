...
thf(chalfaddsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc2 @ ccdiv) @ ccaddc) = XA2) & ((cco @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc2 @ ccdiv) @ ccmin) = XB2)))))).
