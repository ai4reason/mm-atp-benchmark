...
thf(acdlemg10a_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) & ((cwcel @ XF @ XT) & (cwcel @ XG @ XT) & (XP != XQ)) & (((cco @ (ccfv @ (ccfv @ XP @ XG) @ XF) @ (ccfv @ (ccfv @ XQ @ XG) @ XF) @ Xc_or) != (cco @ XP @ XQ @ Xc_or)) & (~ (cwbr @ (ccfv @ XF @ XR) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & (~ (cwbr @ (ccfv @ XG @ XR) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)))) => (cwbr @ (cco @ (cco @ XP @ (ccfv @ (ccfv @ XP @ XG) @ XF) @ Xc_or) @ (cco @ XQ @ (ccfv @ (ccfv @ XQ @ XG) @ XF) @ Xc_or) @ Xc_an) @ (cco @ (ccfv @ XF @ XR) @ (ccfv @ XG @ XR) @ Xc_or) @ Xc_le))))))))))))))))))))))).
