...
thf(awrdexb_thm,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ ccvv) <=> (cwcel @ (ccword @ XS) @ ccvv)))).
...
thf(cefgrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((cwcel @ XA2 @ XW) => ((cwcel @ XI @ ccvv) & (XW = (ccword @ (ccxp @ XI @ cc2o)))))))))).
