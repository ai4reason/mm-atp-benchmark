...
thf(alsmelvalmi_thm,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XX @ XT)) => ((Xph => (cwcel @ XY @ XU)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XT @ XU @ Xc_po)))))))))))))))))).
...
thf(clspprabs_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => (Xph => ((ccfv @ (ccpr @ XX @ (cco @ XX @ XY @ Xc_pl)) @ XN) = (ccfv @ (ccpr @ XX @ XY) @ XN))))))))))))))))).
