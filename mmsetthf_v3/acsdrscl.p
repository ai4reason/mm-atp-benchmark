...
thf(cacsdrscl_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccacs)) & (cwss @ XY @ (ccpw @ XX)) & (cwcel @ (ccfv @ XY @ ccipo) @ ccdrs)) => ((ccfv @ (ccuni @ XY) @ XF) = (ccuni @ (ccima @ XF @ XY)))))))))).
