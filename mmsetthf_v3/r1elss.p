...
thf(atz9_12_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccr1))) @ (^ [Xy1:$i] : ccon0))) @ (^ [Xx3:$i] : XA2)) => (cwrex @ (^ [Xy1:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xy1) @ ccr1))) @ (^ [Xy1:$i] : ccon0)))))).
...
thf(cr1elss_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) <=> (cwss @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))))))).
