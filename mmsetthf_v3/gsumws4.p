...
thf(cgsumws4_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccmnd) & ((cwcel @ XS @ XB2) & ((cwcel @ XT @ XB2) & ((cwcel @ XU @ XB2) & (cwcel @ XV @ XB2))))) => ((cco @ XG @ (ccs4 @ XS @ XT @ XU @ XV) @ ccgsu) = (cco @ XS @ (cco @ XT @ (cco @ XU @ XV @ Xc_pl) @ Xc_pl) @ Xc_pl))))))))))))).
