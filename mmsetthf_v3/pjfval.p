...
thf(adf_pj_ax,axiom,(ccpj = (ccmpt @ (^ [Xh:$i] : ccvv) @ (^ [Xh:$i] : (ccin @ (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xh) @ cclss)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xh) @ ccocv)) @ (ccfv @ (ccv @ Xh) @ ccpj1)))) @ (ccxp @ ccvv @ (cco @ (ccfv @ (ccv @ Xh) @ ccbs) @ (ccfv @ (ccv @ Xh) @ ccbs) @ ccmap))))))).
...
thf(cpjfval_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ cclss)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XP = (ccfv @ XW @ ccpj1)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XW @ ccpj))) => (! [Xx3:$i] : ((XK @ Xx3) = (ccin @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XP))) @ (ccxp @ ccvv @ (cco @ XV @ XV @ ccmap))))))))))))))))).
