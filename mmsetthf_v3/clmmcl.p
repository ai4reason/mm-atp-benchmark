...
thf(cclmmcl_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & (cwcel @ XX @ XK) & (cwcel @ XY @ XK)) => (cwcel @ (cco @ XX @ XY @ ccmul) @ XK)))))))))).
