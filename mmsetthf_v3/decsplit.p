...
thf(cdecsplit_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwcel @ XM @ ccn0) => (((cco @ XM @ cc1 @ ccaddc) = XN) => (((cco @ (cco @ XA2 @ (cco @ (ccdc @ cc1 @ ccc0) @ XM @ ccexp) @ ccmul) @ XB2 @ ccaddc) = XC) => ((cco @ (cco @ XA2 @ (cco @ (ccdc @ cc1 @ ccc0) @ XN @ ccexp) @ ccmul) @ (ccdc @ XB2 @ XD) @ ccaddc) = (ccdc @ XC @ XD))))))))))))))).
