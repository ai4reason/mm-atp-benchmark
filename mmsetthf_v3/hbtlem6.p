...
thf(ahbtlem2_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((XS = (ccfv @ XR @ ccldgis)) => ((XT = (ccfv @ XR @ cclidl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU) & (cwcel @ XX @ ccn0)) => (cwcel @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ XT)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(alnr2i_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((XN = (ccfv @ XR @ ccrsp)) => (((cwcel @ XR @ cclnr) & (cwcel @ XI @ XU)) => (cwrex @ (^ [Xg1:$i] : (XI = (ccfv @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XI) @ ccfn))))))))))).
...
thf(chbtlem6_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : ((XU @ Xk) = (ccfv @ (XP @ Xk) @ cclidl))) => ((XS = (ccfv @ XR @ ccldgis)) => ((! [Xk:$i] : ((XN @ Xk) = (ccfv @ (XP @ Xk) @ ccrsp))) => ((Xph => (cwcel @ XR @ cclnr)) => ((! [Xk:$i] : (Xph => (cwcel @ XI @ (XU @ Xk)))) => ((Xph => (cwcel @ XX @ ccn0)) => (Xph => (cwrex @ (^ [Xk:$i] : (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XX @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XN @ Xk)) @ XS)))) @ (^ [Xk:$i] : (ccin @ (ccpw @ XI) @ ccfn)))))))))))))))))))).
