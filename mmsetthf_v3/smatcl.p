...
thf(csmatcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XC = (ccfv @ (cco @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ XR @ ccmat) @ ccbs)) => ((XS = (cco @ XK @ XL @ (ccfv @ XM @ ccsmat))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XM @ XB2)) => (Xph => (cwcel @ XS @ XC))))))))))))))))))))).
