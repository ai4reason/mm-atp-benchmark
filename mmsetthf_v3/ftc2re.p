...
thf(abddibl_thm,axiom,(! [XF:($i > $o)] : (((cwcel @ XF @ ccmbf) & (cwcel @ (ccfv @ (ccdm @ XF) @ ccvol) @ ccr) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccdm @ XF)))) @ (^ [Xx3:$i] : ccr))) => (cwcel @ XF @ ccibl)))).
...
thf(cftc2re_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xt:$i] : ((XE @ Xt) = (cco @ (XC @ Xt) @ (XD @ Xt) @ ccioo))) => ((! [Xt:$i] : (Xph => (cwcel @ XA2 @ (XE @ Xt)))) => ((! [Xt:$i] : (Xph => (cwcel @ XB2 @ (XE @ Xt)))) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xt:$i] : (Xph => (cwf @ (XE @ Xt) @ ccc @ XF))) => ((! [Xt:$i] : (Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ (XE @ Xt) @ ccc @ cccncf)))) => (Xph => ((ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)))) = (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin))))))))))))))))).
