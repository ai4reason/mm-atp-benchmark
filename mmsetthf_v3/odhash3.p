...
thf(aodhash_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & ((ccfv @ XA2 @ XO) = ccc0)) => ((ccfv @ (ccfv @ (ccsn @ XA2) @ XK) @ cchash) = ccpnf))))))))))).
...
thf(codhash3_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ (ccfv @ (ccsn @ XA2) @ XK) @ ccfn)) => ((ccfv @ XA2 @ XO) = (ccfv @ (ccfv @ (ccsn @ XA2) @ XK) @ cchash)))))))))))).
