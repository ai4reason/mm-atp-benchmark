...
thf(acoe1fzgsumdlem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xm:$i] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xa:$i] : ((XP @ Xx3 @ Xa) = (ccfv @ (XR @ Xx3 @ Xa) @ ccpl1)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((XB2 @ Xa) = (ccfv @ (XP @ Xx3 @ Xa) @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xa) => (cwcel @ (XR @ Xx3 @ Xa) @ ccrg)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xa) => (cwcel @ (XK @ Xa) @ ccn0)))) => (! [Xx3:$i] : (! [Xa:$i] : (((cwcel @ (ccv @ Xm) @ ccfn) & (~ (cwcel @ (ccv @ Xa) @ (ccv @ Xm))) & (Xph @ Xx3 @ Xa)) => (((cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XB2 @ Xa))) @ (^ [Xx3:$i] : (ccv @ Xm))) => ((ccfv @ (XK @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ ccco1)) = (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (ccfv @ (XK @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ ccco1)))) @ ccgsu))) => ((cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XB2 @ Xa))) @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa))))) => ((ccfv @ (XK @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ ccco1)) = (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (ccfv @ (XK @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ ccco1)))) @ ccgsu))))))))))))))))))).
