...
thf(avmaprm_thm,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((ccfv @ XP @ ccvma) = (ccfv @ XP @ cclog))))).
...
thf(aexpnprm_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccq) & (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) => (~ (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccprime)))))).
...
thf(crplogsumlem2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => (cwbr @ (ccsu @ (cco @ cc1 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccc0) @ ccmin) @ (ccv @ Xn) @ ccdiv))) @ cc2 @ ccle)))).
