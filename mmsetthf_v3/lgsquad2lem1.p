...
thf(algsdir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XN @ ccz)) & ((XA2 != ccc0) & (XB2 != ccc0))) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ cclgs) = (cco @ (cco @ XA2 @ XN @ cclgs) @ (cco @ XB2 @ XN @ cclgs) @ ccmul))))))).
thf(algsdi_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((XM != ccc0) & (XN != ccc0))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ cclgs) = (cco @ (cco @ XA2 @ XM @ cclgs) @ (cco @ XA2 @ XN @ cclgs) @ ccmul))))))).
thf(clgsquad2lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (~ (cwbr @ cc2 @ XM @ ccdvds))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((Xph => ((cco @ XM @ XN @ ccgcd) = cc1)) => ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => ((cco @ XA2 @ XB2 @ ccmul) = XM)) => ((Xph => ((cco @ (cco @ XA2 @ XN @ cclgs) @ (cco @ XN @ XA2 @ cclgs) @ ccmul) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp))) => ((Xph => ((cco @ (cco @ XB2 @ XN @ cclgs) @ (cco @ XN @ XB2 @ cclgs) @ ccmul) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XB2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp))) => (Xph => ((cco @ (cco @ XM @ XN @ cclgs) @ (cco @ XN @ XM @ cclgs) @ ccmul) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp))))))))))))))))))).
