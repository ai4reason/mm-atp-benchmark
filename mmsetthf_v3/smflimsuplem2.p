...
thf(alimsupubuzmpt_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xx3 @ Xj)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xx3 @ Xj)) @ X)))) => ((! [Xx3:$i] : (XZ = (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : (! [Xj:$i] : (((Xph @ Xx3 @ Xj) & (cwcel @ (ccv @ Xj) @ XZ)) => (cwcel @ (XB2 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => ((ccfv @ (ccmpt @ (^ [Xj:$i] : XZ) @ (^ [Xj:$i] : (XB2 @ Xj))) @ cclsp) != ccpnf)))) => (! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))))).
