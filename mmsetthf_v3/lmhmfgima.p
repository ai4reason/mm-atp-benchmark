...
thf(aislssfg2_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => ((! [Xb:$i] : ((XB2 @ Xb) = (ccfv @ XW @ ccbs))) => (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS)) => ((cwcel @ XX @ cclfig) <=> (cwrex @ (^ [Xb:$i] : ((ccfv @ (ccv @ Xb) @ XN) = XU)) @ (^ [Xb:$i] : (ccin @ (ccpw @ (XB2 @ Xb)) @ ccfn)))))))))))))))).
...
thf(aislssfgi_thm,axiom,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XW @ cclspn)) => ((XV = (ccfv @ XW @ ccbs)) => ((XX = (cco @ XW @ (ccfv @ XB2 @ XN) @ ccress)) => (((cwcel @ XW @ cclmod) & (cwss @ XB2 @ XV) & (cwcel @ XB2 @ ccfn)) => (cwcel @ XX @ cclfig))))))))))).
thf(aeleq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwcel @ XA2 @ XC) <=> (cwcel @ XB2 @ XC))))))))).
thf(aimaeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccima @ XC @ XA2) = (ccima @ XC @ XB2))))))).
thf(clmhmfgima_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XT @ (ccima @ XF @ XA2) @ ccress)) => ((XX = (cco @ XS @ XA2 @ ccress)) => ((XU = (ccfv @ XS @ cclss)) => ((Xph => (cwcel @ XX @ cclfig)) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XF @ (cco @ XS @ XT @ cclmhm))) => (Xph => (cwcel @ XY @ cclfig))))))))))))))))).
