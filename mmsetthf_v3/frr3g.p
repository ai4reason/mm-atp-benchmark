...
thf(cfrr3g_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((((cwfr @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwfn @ XF @ XA2) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xy1) @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2))) & ((cwfn @ XG @ XA2) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XG) = (cco @ (ccv @ Xy1) @ (ccres @ XG @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2)))) => (XF = XG)))))))).
