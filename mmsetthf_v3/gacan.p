...
thf(cgacan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => (((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XY))) => (((cco @ XA2 @ XB2 @ Xc_po) = XC) <=> ((cco @ (ccfv @ XA2 @ XN) @ XC @ Xc_po) = XB2)))))))))))))).
