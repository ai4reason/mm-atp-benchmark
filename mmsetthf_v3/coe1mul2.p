...
thf(apsr1ring_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XS = (ccfv @ XR @ ccps1)) => ((cwcel @ XR @ ccrg) => (cwcel @ XS @ ccrg)))))).
...
thf(acoe1mul2lem2_thm,axiom,(! [XH:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xd:$i] : ((XH @ Xk @ Xd) = (ccrab @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (ccxp @ cc1o @ (ccsn @ (ccv @ Xk))) @ (ccofr @ ccle))) @ (^ [Xd:$i] : (cco @ ccn0 @ cc1o @ ccmap)))))) => (! [Xk:$i] : (! [Xd:$i] : ((cwcel @ (ccv @ Xk) @ ccn0) => (cwf1o @ (XH @ Xk @ Xd) @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (ccmpt @ (^ [Xc:$i] : (XH @ Xk @ Xd)) @ (^ [Xc:$i] : (ccfv @ cc0 @ (ccv @ Xc))))))))))).
...
thf(acoe1mul2lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XX @ (cco @ ccn0 @ cc1o @ ccmap))) => ((cwbr @ XX @ (ccxp @ cc1o @ (ccsn @ XA2)) @ (ccofr @ ccle)) <=> (cwcel @ (ccfv @ cc0 @ XX) @ (cco @ ccc0 @ XA2 @ ccfz))))))).
...
thf(amapsnconst_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccsn @ XX)) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XX @ ccvv) => ((cwcel @ XF @ (cco @ XB2 @ XS @ ccmap)) => (XF = (ccxp @ XS @ (ccsn @ (ccfv @ XX @ XF))))))))))))).
...
thf(acoe1fv_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccfv @ XF @ ccco1)) => (((cwcel @ XF @ XV) & (cwcel @ XN @ ccn0)) => ((ccfv @ XN @ XA2) = (ccfv @ (ccxp @ cc1o @ (ccsn @ XN)) @ XF))))))))).
thf(ccoe1mul2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : ((XS @ Xx3 @ Xk) = (ccfv @ XR @ ccps1)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xc_xb @ Xx3) = (ccfv @ (XS @ Xx3 @ Xk) @ ccmulr)))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : (! [Xk:$i] : (XB2 = (ccfv @ (XS @ Xx3 @ Xk) @ ccbs)))) => (! [Xx3:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XB2) & (cwcel @ XG @ XB2)) => ((ccfv @ (cco @ XF @ XG @ (Xc_xb @ Xx3)) @ ccco1) = (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xk) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ ccco1)) @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ ccmin) @ (ccfv @ XG @ ccco1)) @ Xc_x))) @ ccgsu)))))))))))))))))).
