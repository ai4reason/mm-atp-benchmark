...
thf(aqndenserrnopn_thm,axiom,(! [Xph:$o] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((! [Xy1:$i] : ((XJ @ Xy1) = (ccfv @ (ccfv @ XI @ ccrrx) @ cctopn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XV @ (XJ @ Xy1)))) => ((Xph => (XV != cc0)) => (Xph => (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ XV)) @ (^ [Xy1:$i] : (cco @ ccq @ XI @ ccmap))))))))))))).
...
thf(cqndenserrn_conj,conjecture,(! [Xph:$o] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((XJ = (ccfv @ (ccfv @ XI @ ccrrx) @ cctopn)) => (Xph => ((ccfv @ (cco @ ccq @ XI @ ccmap) @ (ccfv @ XJ @ cccl)) = (cco @ ccr @ XI @ ccmap))))))))).
