...
thf(adibvalrel_thm,axiom,(! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => (((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) => (cwrel @ (ccfv @ XX @ XI)))))))))))).
...
thf(adiblsmopel_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pb:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xf1:$i] : ((Xc_le @ Xf1) = (ccfv @ XK @ ccple))) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((XO @ Xf1) = (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccres @ ccid @ XB2))))) => ((! [Xf1:$i] : ((XV @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdveca)))) => ((! [Xf1:$i] : ((XU @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xf1:$i] : ((Xc_po @ Xf1) = (ccfv @ (XV @ Xf1) @ cclsm))) => ((! [Xf1:$i] : ((Xc_pb @ Xf1) = (ccfv @ (XU @ Xf1) @ cclsm))) => ((! [Xf1:$i] : ((XJ @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdia)))) => ((! [Xf1:$i] : ((XI @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((cwcel @ (XX @ Xf1) @ XB2) & (cwbr @ (XX @ Xf1) @ XW @ (Xc_le @ Xf1))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((cwcel @ (XY @ Xf1) @ XB2) & (cwbr @ (XY @ Xf1) @ XW @ (Xc_le @ Xf1))))) => (! [Xf1:$i] : ((Xph @ Xf1) => ((cwcel @ (ccop @ (XF @ Xf1) @ (XS @ Xf1)) @ (cco @ (ccfv @ (XX @ Xf1) @ (XI @ Xf1)) @ (ccfv @ (XY @ Xf1) @ (XI @ Xf1)) @ (Xc_pb @ Xf1))) <=> ((cwcel @ (XF @ Xf1) @ (cco @ (ccfv @ (XX @ Xf1) @ (XJ @ Xf1)) @ (ccfv @ (XY @ Xf1) @ (XJ @ Xf1)) @ (Xc_po @ Xf1))) & ((XS @ Xf1) = (XO @ Xf1))))))))))))))))))))))))))))))))))))))).
thf(ajca_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => Xch) => (Xph => (Xps & Xch)))))))).
thf(cdib2dim_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => ((cwcel @ XP @ XA2) & (cwbr @ XP @ XW @ Xc_le))) => ((Xph => ((cwcel @ XQ @ XA2) & (cwbr @ XQ @ XW @ Xc_le))) => (Xph => (cwss @ (ccfv @ (cco @ XP @ XQ @ Xc_or) @ XI) @ (cco @ (ccfv @ XP @ XI) @ (ccfv @ XQ @ XI) @ Xc_po)))))))))))))))))))))))))).
