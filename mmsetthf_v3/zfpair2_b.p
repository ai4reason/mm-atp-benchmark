...
thf(aax_pr_b_thm,axiom,(! [Xx3:$i] : (? [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xw) = (ccv @ Xx3)) | ((ccv @ Xw) = (ccv @ Xx3))) => (cwcel @ (ccv @ Xw) @ (ccv @ Xz))))))).
...
thf(czfpair2_b_conj,conjecture,(! [Xx3:$i] : (cwcel @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xx3)) @ ccvv))).
