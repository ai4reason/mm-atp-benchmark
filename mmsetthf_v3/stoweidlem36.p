...
thf(astoweidlem6_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : ((? [X:$i] : ((^ [Xt:$i] : ((ccv @ Xf1) = (XF @ Xt))) @ X)) => (! [X:$i] : ((^ [Xt:$i] : ((ccv @ Xf1) = (XF @ Xt))) @ X)))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((? [X:$i] : ((^ [Xt:$i] : ((ccv @ Xg1) = (XG @ Xt @ Xf1))) @ X)) => (! [X:$i] : ((^ [Xt:$i] : ((ccv @ Xg1) = (XG @ Xt @ Xf1))) @ X))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XA2 @ Xt)))))) => (! [Xt:$i] : (! [Xf1:$i] : (((Xph @ Xt) & (cwcel @ (XF @ Xt) @ (XA2 @ Xt)) & (cwcel @ (XG @ Xt @ Xf1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xt)) @ (ccfv @ (ccv @ Xt) @ (XG @ Xt @ Xf1)) @ ccmul))) @ (XA2 @ Xt)))))))))))))).
...
thf(astoweidlem4_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (ccv @ Xx3))) @ (XA2 @ Xt))))) => (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : XB2)) @ (XA2 @ Xt)))))))))).
...
thf(cstoweidlem36_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwnfc @ (^ [Xh:$i] : (XQ @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwnfc @ (^ [Xt:$i] : (XH @ Xx3 @ Xt @ Xf1 @ Xg1)))))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwnfc @ (^ [Xt:$i] : (XF @ Xx3 @ Xt @ Xh))))) => ((! [Xx3:$i] : (! [Xh:$i] : (cwnfc @ (^ [Xt:$i] : (XG @ Xx3 @ Xt @ Xh))))) => ((! [Xh:$i] : ((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xt @ Xh)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xt @ Xh)) @ X)))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XK @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh) = (ccfv @ (ccrn @ ccioo) @ cctg))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XQ @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh) = (ccrab @ (^ [Xh:$i] : (((ccfv @ (XZ @ Xx3 @ Xf1 @ Xg1) @ (ccv @ Xh)) = ccc0) & (cwral @ (^ [Xt:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ ccle) & (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cc1 @ ccle))) @ (^ [Xt:$i] : XT)))) @ (^ [Xh:$i] : (XA2 @ Xt))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (XT = (ccuni @ (XJ @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh)))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xh:$i] : ((XG @ Xx3 @ Xt @ Xh) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xt @ Xh)) @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xt @ Xh)) @ ccmul))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xh:$i] : ((XN @ Xf1 @ Xh) = (ccsup @ (ccrn @ (XG @ Xx3 @ Xt @ Xh)) @ ccr @ cclt)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XH @ Xx3 @ Xt @ Xf1 @ Xg1) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XG @ Xx3 @ Xt @ Xh)) @ (XN @ Xf1 @ Xh) @ ccdiv))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => (cwcel @ (XJ @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh) @ cccmp))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => (cwss @ (XA2 @ Xt) @ (cco @ (XJ @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh) @ (XK @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh) @ cccn)))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((Xph @ Xt @ Xh) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XA2 @ Xt))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xh:$i] : (((Xph @ Xt @ Xh) & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xx3))) @ (XA2 @ Xt)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => (cwcel @ (XS @ Xx3 @ Xf1 @ Xg1) @ XT))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => (cwcel @ (XZ @ Xx3 @ Xf1 @ Xg1) @ XT))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => (cwcel @ (XF @ Xx3 @ Xt @ Xh) @ (XA2 @ Xt)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => ((ccfv @ (XS @ Xx3 @ Xf1 @ Xg1) @ (XF @ Xx3 @ Xt @ Xh)) != (ccfv @ (XZ @ Xx3 @ Xf1 @ Xg1) @ (XF @ Xx3 @ Xt @ Xh))))))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => ((ccfv @ (XZ @ Xx3 @ Xf1 @ Xg1) @ (XF @ Xx3 @ Xt @ Xh)) = ccc0))))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xt @ Xh) => (? [Xh:$i] : ((cwcel @ (ccv @ Xh) @ (XQ @ Xx3 @ Xt @ Xf1 @ Xg1 @ Xh)) & (cwbr @ ccc0 @ (ccfv @ (XS @ Xx3 @ Xf1 @ Xg1) @ (ccv @ Xh)) @ cclt)))))))))))))))))))))))))))))))))))))))))).
