...
thf(api1xfrf_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XP = (cco @ XJ @ (ccfv @ ccc0 @ XF) @ ccpi1)) => ((XQ = (cco @ XJ @ (ccfv @ cc1 @ XF) @ ccpi1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((! [Xg1:$i] : ((XG @ Xg1) = (ccrn @ (ccmpt @ (^ [Xg1:$i] : (ccuni @ XB2)) @ (^ [Xg1:$i] : (ccop @ (ccec @ (ccv @ Xg1) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cco @ XI @ (cco @ (ccv @ Xg1) @ XF @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc)))))))) => ((! [Xg1:$i] : (Xph => (cwcel @ XJ @ (ccfv @ (XX @ Xg1) @ cctopon)))) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XI @ (cco @ ccii @ XJ @ cccn))) => ((Xph => ((ccfv @ cc1 @ XF) = (ccfv @ ccc0 @ XI))) => ((Xph => ((ccfv @ cc1 @ XI) = (ccfv @ ccc0 @ XF))) => (! [Xg1:$i] : (Xph => (cwf @ XB2 @ (ccfv @ XQ @ ccbs) @ (XG @ Xg1))))))))))))))))))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(affun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfun @ XF)))))).
thf(cpi1xfrval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XP = (cco @ XJ @ (ccfv @ ccc0 @ XF) @ ccpi1)) => ((XQ = (cco @ XJ @ (ccfv @ cc1 @ XF) @ ccpi1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((! [Xg1:$i] : ((XG @ Xg1) = (ccrn @ (ccmpt @ (^ [Xg1:$i] : (ccuni @ XB2)) @ (^ [Xg1:$i] : (ccop @ (ccec @ (ccv @ Xg1) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cco @ XI @ (cco @ (ccv @ Xg1) @ XF @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc)))))))) => ((! [Xg1:$i] : (Xph => (cwcel @ XJ @ (ccfv @ (XX @ Xg1) @ cctopon)))) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XI @ (cco @ ccii @ XJ @ cccn))) => ((Xph => ((ccfv @ cc1 @ XF) = (ccfv @ ccc0 @ XI))) => ((Xph => ((ccfv @ cc1 @ XI) = (ccfv @ ccc0 @ XF))) => ((Xph => (cwcel @ XA2 @ (ccuni @ XB2))) => (! [Xg1:$i] : (Xph => ((ccfv @ (ccec @ XA2 @ (ccfv @ XJ @ ccphtpc)) @ (XG @ Xg1)) = (ccec @ (cco @ XI @ (cco @ XA2 @ XF @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc)))))))))))))))))))))))))).
