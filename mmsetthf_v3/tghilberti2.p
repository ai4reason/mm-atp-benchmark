...
thf(ctghilberti2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XP @ XB2)) => ((Xph => (cwcel @ XQ @ XB2)) => ((Xph => (XP != XQ)) => (Xph => (cwrmo @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwcel @ XQ @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccrn @ XL))))))))))))))))))).
