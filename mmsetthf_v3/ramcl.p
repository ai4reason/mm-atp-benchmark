...
thf(a_0ramcl_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XR @ ccfn) & (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ ccc0 @ XF @ ccram) @ ccn0))))).
...
thf(aramz_thm,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XR @ XV) & (XR != cc0)) => ((cco @ XM @ (ccxp @ XR @ (ccsn @ ccc0)) @ ccram) = ccc0)))))).
...
thf(aramub1_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwf @ XR @ ccn @ XF)) => ((XG = (ccmpt @ (^ [Xx3:$i] : XR) @ (^ [Xx3:$i] : (cco @ XM @ (ccmpt @ (^ [Xy1:$i] : XR) @ (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = (ccv @ Xx3)) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xy1) @ XF)))) @ ccram)))) => ((Xph => (cwf @ XR @ ccn0 @ XG)) => ((Xph => (cwcel @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccram) @ ccn0)) => (Xph => (cwbr @ (cco @ XM @ XF @ ccram) @ (cco @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccram) @ cc1 @ ccaddc) @ ccle)))))))))))))).
...
thf(cramcl_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XR @ ccfn) & (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccn0)))))).
