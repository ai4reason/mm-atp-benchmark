...
thf(aofexg_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (ccres @ (ccof @ XR) @ XA2) @ ccvv)))))).
...
thf(cpsrplusg_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xc_pb = (ccfv @ XS @ ccplusg)) => (Xc_pb = (ccres @ (ccof @ Xc_pl) @ (ccxp @ XB2 @ XB2)))))))))))))).
