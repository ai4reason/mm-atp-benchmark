...
thf(ccldregopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => (((ccfv @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ XJ @ ccnt)) = XA2) <=> (cwrex @ (^ [Xc:$i] : (XA2 = (ccfv @ (ccv @ Xc) @ (ccfv @ XJ @ ccnt)))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld)))))))))).
