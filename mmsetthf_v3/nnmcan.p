...
thf(cnnmcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom) & (cwcel @ XC @ ccom)) & (cwcel @ cc0 @ XA2)) => (((cco @ XA2 @ XB2 @ ccomu) = (cco @ XA2 @ XC @ ccomu)) <=> (XB2 = XC))))))).
