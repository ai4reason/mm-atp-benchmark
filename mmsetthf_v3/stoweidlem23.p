...
thf(astoweidlem8_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt)))))) => ((cwnfc @ (^ [Xt:$i] : (XF @ Xt))) => ((! [Xf1:$i] : (cwnfc @ (^ [Xt:$i] : (XG @ Xt @ Xf1)))) => (! [Xt:$i] : (! [Xf1:$i] : (((Xph @ Xt) & (cwcel @ (XF @ Xt) @ (XA2 @ Xt)) & (cwcel @ (XG @ Xt @ Xf1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xt)) @ (ccfv @ (ccv @ Xt) @ (XG @ Xt @ Xf1)) @ ccaddc))) @ (XA2 @ Xt)))))))))))))).
...
thf(cstoweidlem23_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XZ:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X))) => ((cwnfc @ (^ [Xt:$i] : (XG @ Xt))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XH @ Xx3 @ Xt @ Xf1 @ Xg1) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XG @ Xt)) @ (ccfv @ (XZ @ Xf1) @ (XG @ Xt)) @ ccmin)))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt))) => (cwf @ XT @ ccr @ (ccv @ Xf1))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xx3))) @ (XA2 @ Xt))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xt) => (cwcel @ (XS @ Xx3 @ Xf1 @ Xg1) @ XT)))))) => ((! [Xt:$i] : (! [Xf1:$i] : ((Xph @ Xt) => (cwcel @ (XZ @ Xf1) @ XT)))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XG @ Xt) @ (XA2 @ Xt)))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xt) => ((ccfv @ (XS @ Xx3 @ Xf1 @ Xg1) @ (XG @ Xt)) != (ccfv @ (XZ @ Xf1) @ (XG @ Xt)))))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xt) => ((cwcel @ (XH @ Xx3 @ Xt @ Xf1 @ Xg1) @ (XA2 @ Xt)) & ((ccfv @ (XS @ Xx3 @ Xf1 @ Xg1) @ (XH @ Xx3 @ Xt @ Xf1 @ Xg1)) != (ccfv @ (XZ @ Xf1) @ (XH @ Xx3 @ Xt @ Xf1 @ Xg1))) & ((ccfv @ (XZ @ Xf1) @ (XH @ Xx3 @ Xt @ Xf1 @ Xg1)) = ccc0))))))))))))))))))))))))).
