...
thf(arrndstprj1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ ccr @ XI @ ccmap)) => ((XM = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => ((((cwcel @ XI @ ccfn) & (cwcel @ XA2 @ XI)) & ((cwcel @ XF @ XX) & (cwcel @ XG @ XX))) => (cwbr @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG) @ XM) @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ ccle))))))))))).
