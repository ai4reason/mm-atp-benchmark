...
thf(citgioocnicc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwf @ (ccdm @ XF) @ ccc @ XF)) => ((Xph => (cwcel @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdm @ XF))) => ((Xph => (cwcel @ XR @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XA2 @ cclimc))) => ((Xph => (cwcel @ XL @ (cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XB2 @ cclimc))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XA2) @ XR @ (ccif @ ((ccv @ Xx3) = XB2) @ XL @ (ccfv @ (ccv @ Xx3) @ XF))))))) => (! [Xx3:$i] : (Xph => ((cwcel @ (XG @ Xx3) @ ccibl) & ((ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XG @ Xx3)))) = (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))))))))))))))))).
