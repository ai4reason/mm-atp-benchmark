...
thf(crtrclreclem4_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : ((! [Xs1:$i] : (Xph => (cwrel @ (XR @ Xs1)))) => ((! [Xs1:$i] : (Xph => (cwcel @ (XR @ Xs1) @ ccvv))) => (Xph => (! [Xs1:$i] : (((cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (XR @ Xs1)) @ (ccrn @ (XR @ Xs1)))) @ (ccv @ Xs1)) & (cwss @ (XR @ Xs1) @ (ccv @ Xs1)) & (cwss @ (cccom @ (ccv @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1))) => (cwss @ (ccfv @ (XR @ Xs1) @ ccrtrcl) @ (ccv @ Xs1)))))))))).
