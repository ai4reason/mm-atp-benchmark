...
thf(clfl1_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XD = (ccfv @ XW @ ccsca)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ XD @ cc0g))) => ((Xc_1 = (ccfv @ XD @ ccur)) => ((XV = (ccfv @ XW @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccfv @ XW @ cclfn))) => (! [Xx3:$i] : (((cwcel @ XW @ cclvec) & (cwcel @ XG @ (XF @ Xx3)) & (XG != (ccxp @ XV @ (ccsn @ (Xc_0 @ Xx3))))) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XG) = Xc_1)) @ (^ [Xx3:$i] : XV))))))))))))))))).
