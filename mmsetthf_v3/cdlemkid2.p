...
thf(acdlemk41_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xg1:$i] : (! [Xb:$i] : ((XY @ Xg1 @ Xb) = (cco @ (cco @ (XP @ Xb) @ (ccfv @ (ccv @ Xg1) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (cco @ (XZ @ Xb) @ (ccfv @ (cccom @ (ccv @ Xg1) @ (cccnv @ (ccv @ Xb))) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (Xc_an @ Xb))))) => (! [Xb:$i] : ((cwcel @ (XG @ Xb) @ (XT @ Xb)) => ((ccsb @ (XG @ Xb) @ (^ [Xg1:$i] : (XY @ Xg1 @ Xb))) = (cco @ (cco @ (XP @ Xb) @ (ccfv @ (XG @ Xb) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (cco @ (XZ @ Xb) @ (ccfv @ (cccom @ (XG @ Xb) @ (cccnv @ (ccv @ Xb))) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (Xc_an @ Xb))))))))))))))).
...
thf(atrlcnv_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT)) => ((ccfv @ (cccnv @ XF) @ XR) = (ccfv @ XF @ XR))))))))))))).
...
thf(acdlemkid1_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xb:$i] : ((XB2 @ Xb) = (ccfv @ (XK @ Xb) @ ccbs))) => ((! [Xb:$i] : ((Xc_le @ Xb) = (ccfv @ (XK @ Xb) @ ccple))) => ((! [Xb:$i] : ((Xc_or @ Xb) = (ccfv @ (XK @ Xb) @ ccjn))) => ((! [Xb:$i] : ((Xc_an @ Xb) = (ccfv @ (XK @ Xb) @ ccmee))) => ((! [Xb:$i] : ((XA2 @ Xb) = (ccfv @ (XK @ Xb) @ ccatm))) => ((! [Xb:$i] : ((XH @ Xb) = (ccfv @ (XK @ Xb) @ cclh))) => ((! [Xb:$i] : ((XT @ Xb) = (ccfv @ (XW @ Xb) @ (ccfv @ (XK @ Xb) @ ccltrn)))) => ((! [Xb:$i] : ((XR @ Xb) = (ccfv @ (XW @ Xb) @ (ccfv @ (XK @ Xb) @ cctrl)))) => ((! [Xb:$i] : ((XZ @ Xb) = (cco @ (cco @ (XP @ Xb) @ (ccfv @ (ccv @ Xb) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (cco @ (ccfv @ (XP @ Xb) @ (XN @ Xb)) @ (ccfv @ (cccom @ (ccv @ Xb) @ (cccnv @ (XF @ Xb))) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (Xc_an @ Xb)))) => (! [Xb:$i] : ((((cwcel @ (XK @ Xb) @ cchlt) & (cwcel @ (XW @ Xb) @ (XH @ Xb))) & ((cwcel @ (XF @ Xb) @ (XT @ Xb)) & (cwcel @ (XN @ Xb) @ (XT @ Xb)) & ((ccfv @ (XF @ Xb) @ (XR @ Xb)) = (ccfv @ (XN @ Xb) @ (XR @ Xb)))) & (((cwcel @ (XP @ Xb) @ (XA2 @ Xb)) & (~ (cwbr @ (XP @ Xb) @ (XW @ Xb) @ (Xc_le @ Xb)))) & ((cwcel @ (ccv @ Xb) @ (XT @ Xb)) & ((ccv @ Xb) != (ccres @ ccid @ (XB2 @ Xb)))))) => ((cco @ (XZ @ Xb) @ (ccfv @ (ccv @ Xb) @ (XR @ Xb)) @ (Xc_or @ Xb)) = (cco @ (XP @ Xb) @ (ccfv @ (ccv @ Xb) @ (XR @ Xb)) @ (Xc_or @ Xb))))))))))))))))))))))))))))).
