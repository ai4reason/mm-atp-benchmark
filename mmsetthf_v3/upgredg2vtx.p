...
thf(cupgredg2vtx_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : ((XE @ Xb) = (ccfv @ XG @ ccedg))) => (! [Xb:$i] : (((cwcel @ XG @ ccupgr) & (cwcel @ XC @ (XE @ Xb)) & (cwcel @ XA2 @ XC)) => (cwrex @ (^ [Xb:$i] : (XC = (ccpr @ XA2 @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV)))))))))))).
