...
thf(a_1259lem2_thm,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => ((cco @ (cco @ cc2 @ (ccdc @ cc3 @ cc4) @ ccexp) @ XN @ ccmo) = (cco @ (ccdc @ (ccdc @ cc8 @ cc7) @ ccc0) @ XN @ ccmo))))).
...
thf(c_1259lem3_conj,conjecture,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => ((cco @ (cco @ cc2 @ (ccdc @ cc7 @ cc6) @ ccexp) @ XN @ ccmo) = (cco @ cc5 @ XN @ ccmo))))).
