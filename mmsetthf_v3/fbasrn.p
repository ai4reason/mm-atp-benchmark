...
thf(cfbasrn_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((XC @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccima @ XF @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XB2 @ (ccfv @ XX @ ccfbas)) & (cwf @ XX @ XY @ XF) & (cwcel @ XY @ XV)) => (cwcel @ (XC @ Xx3) @ (ccfv @ XY @ ccfbas)))))))))))).
