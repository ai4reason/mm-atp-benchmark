...
thf(af1omvdmvd_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwf1o @ XA2 @ XA2 @ XF) & (cwcel @ XX @ (ccdm @ (ccdif @ XF @ ccid)))) => (cwcel @ (ccfv @ XX @ XF) @ (ccdif @ (ccdm @ (ccdif @ XF @ ccid)) @ (ccsn @ XX)))))))).
...
thf(cf1otrspeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwf1o @ XA2 @ XA2 @ XF) & (cwf1o @ XA2 @ XA2 @ XG)) & ((cwbr @ (ccdm @ (ccdif @ XF @ ccid)) @ cc2o @ ccen) & ((ccdm @ (ccdif @ XG @ ccid)) = (ccdm @ (ccdif @ XF @ ccid))))) => (XF = XG)))))).
