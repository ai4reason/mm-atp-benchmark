...
thf(af1ovscpbl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf1o @ XV @ XX @ XF)) => ((Xph & ((cwcel @ XA2 @ XK) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => (((ccfv @ XB2 @ XF) = (ccfv @ XC @ XF)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XF) = (ccfv @ (cco @ XA2 @ XC @ Xc_pl) @ XF))))))))))))))).
...
thf(cxpsvsca_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XT = (cco @ XR @ XS @ ccxps)) => ((XG = (ccfv @ XR @ ccsca)) => ((Xph => (cwcel @ XR @ XV)) => ((Xph => (cwcel @ XS @ XW)) => ((XX = (ccfv @ XR @ ccbs)) => ((XY = (ccfv @ XS @ ccbs)) => ((XK = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccvsca)) => ((Xc_xp = (ccfv @ XS @ ccvsca)) => ((Xc_xb = (ccfv @ XT @ ccvsca)) => ((Xph => (cwcel @ XA2 @ XK)) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XY)) => ((Xph => (cwcel @ (cco @ XA2 @ XB2 @ Xc_x) @ XX)) => ((Xph => (cwcel @ (cco @ XA2 @ XC @ Xc_xp) @ XY)) => (Xph => ((cco @ XA2 @ (ccop @ XB2 @ XC) @ Xc_xb) = (ccop @ (cco @ XA2 @ XB2 @ Xc_x) @ (cco @ XA2 @ XC @ Xc_xp)))))))))))))))))))))))))))))))))))).
