...
thf(cfprb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((XA2 != XB2) => ((cwf @ (ccpr @ XA2 @ XB2) @ XR @ XF) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XF = (ccpr @ (ccop @ XA2 @ (ccv @ Xx3)) @ (ccop @ XB2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XR))) @ (^ [Xx3:$i] : XR))))))))))).
