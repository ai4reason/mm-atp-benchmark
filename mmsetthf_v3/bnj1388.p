...
thf(cbnj1388_conj,conjecture,(! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [Xta:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xbnjwtam:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((XB2 @ Xx3 @ Xy1 @ Xd) = (^ [Xd:$i] : ((cwss @ (ccv @ Xd) @ (XA2 @ Xf1 @ Xd)) & (cwral @ (^ [Xx3:$i] : (cwss @ (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3)) @ (ccv @ Xd))) @ (^ [Xx3:$i] : (ccv @ Xd)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((XY @ Xx3 @ Xy1 @ Xf1 @ Xd) = (ccop @ (ccv @ Xx3) @ (ccres @ (ccv @ Xf1) @ (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((XC @ Xx3 @ Xy1 @ Xf1 @ Xd) = (^ [Xf1:$i] : (cwrex @ (^ [Xd:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xd)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) = (ccfv @ (XY @ Xx3 @ Xy1 @ Xf1 @ Xd) @ (XG @ Xx3 @ Xy1 @ Xf1 @ Xd)))) @ (^ [Xx3:$i] : (ccv @ Xd))))) @ (^ [Xd:$i] : (XB2 @ Xx3 @ Xy1 @ Xd))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((Xta @ Xx3 @ Xf1 @ Xd) <=> ((cwcel @ (ccv @ Xf1) @ (XC @ Xx3 @ Xy1 @ Xf1 @ Xd)) & ((ccdm @ (ccv @ Xf1)) = (ccun @ (ccsn @ (ccv @ Xx3)) @ (cc_bnj18 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3)))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((XD @ Xx3 @ Xf1 @ Xd) = (ccrab @ (^ [Xx3:$i] : (~ (? [Xf1:$i] : (Xta @ Xx3 @ Xf1 @ Xd)))) @ (^ [Xx3:$i] : (XA2 @ Xf1 @ Xd))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((Xps @ Xx3 @ Xf1 @ Xd) <=> ((cw_bnj15 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd)) & ((XD @ Xx3 @ Xf1 @ Xd) != cc0)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((Xch @ Xx3 @ Xy1 @ Xf1 @ Xd) <=> ((Xps @ Xx3 @ Xf1 @ Xd) & (cwcel @ (ccv @ Xx3) @ (XD @ Xx3 @ Xf1 @ Xd)) & (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (XR @ Xf1 @ Xd)))) @ (^ [Xy1:$i] : (XD @ Xx3 @ Xf1 @ Xd))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((Xbnjwtam @ Xx3 @ Xy1 @ Xf1 @ Xd) <=> (cwsbc @ (^ [Xx3:$i] : (Xta @ Xx3 @ Xf1 @ Xd)) @ (ccv @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xd:$i] : ((Xch @ Xx3 @ Xy1 @ Xf1 @ Xd) => (cwral @ (^ [Xy1:$i] : (? [Xf1:$i] : (Xbnjwtam @ Xx3 @ Xy1 @ Xf1 @ Xd))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xf1 @ Xd) @ (XR @ Xf1 @ Xd) @ (ccv @ Xx3))))))))))))))))))))))))))))).
