...
thf(aexidreslem_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => ((XH = (ccres @ XG @ (ccxp @ XY @ XY))) => (((cwcel @ XG @ (ccin @ ccmagm @ ccexid)) & (cwss @ XY @ XX) & (cwcel @ XU @ XY)) => ((cwcel @ XU @ (ccdm @ (ccdm @ XH))) & (cwral @ (^ [Xx3:$i] : (((cco @ XU @ (ccv @ Xx3) @ XH) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ XU @ XH) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdm @ (ccdm @ XH))))))))))))))).
...
thf(aexidres_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => ((XH = (ccres @ XG @ (ccxp @ XY @ XY))) => (((cwcel @ XG @ (ccin @ ccmagm @ ccexid)) & (cwss @ XY @ XX) & (cwcel @ XU @ XY)) => (cwcel @ XH @ ccexid))))))))))).
...
thf(aexidu1_thm,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((cwcel @ XG @ (ccin @ ccmagm @ ccexid)) => (cwreu @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xu) @ XG) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX))))))).
...
thf(cexidresid_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => ((XH = (ccres @ XG @ (ccxp @ XY @ XY))) => ((((cwcel @ XG @ (ccin @ ccmagm @ ccexid)) & (cwss @ XY @ XX) & (cwcel @ XU @ XY)) & (cwcel @ XH @ ccmagm)) => ((ccfv @ XH @ ccgi) = XU))))))))))).
