...
thf(cflffval_conj,conjecture,(! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XL @ (ccfv @ XY @ ccfil))) => ((cco @ XJ @ XL @ ccflf) = (ccmpt @ (^ [Xf1:$i] : (cco @ XX @ XY @ ccmap)) @ (^ [Xf1:$i] : (cco @ XJ @ (ccfv @ XL @ (cco @ XX @ (ccv @ Xf1) @ ccfm)) @ ccflim)))))))))).
