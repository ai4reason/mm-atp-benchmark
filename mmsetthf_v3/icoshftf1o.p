...
thf(aicoshft_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ ccico)) => (cwcel @ (cco @ XX @ XC @ ccaddc) @ (cco @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ ccico))))))))).
...
thf(areueq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ XA2) <=> (cwreu @ (^ [Xx3:$i] : ((ccv @ Xx3) = XB2)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(cicoshftf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccaddc))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => (cwf1o @ (cco @ XA2 @ XB2 @ ccico) @ (cco @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ ccico) @ (XF @ Xx3)))))))))).
