...
thf(cpm2mpf1lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : ((XC @ Xk) = (cco @ XN @ (XP @ Xk) @ ccmat))) => ((! [Xk:$i] : (XB2 = (ccfv @ (XC @ Xk) @ ccbs))) => ((Xc_as = (ccfv @ XQ @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XQ @ ccmgp) @ ccmg)) => ((! [Xk:$i] : ((XX @ Xk) = (ccfv @ XA2 @ ccv1))) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XQ = (ccfv @ XA2 @ ccpl1)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ XU @ XB2) & (cwcel @ XK @ ccn0))) => ((ccfv @ XK @ (ccfv @ (cco @ XQ @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ XU @ (ccv @ Xk) @ ccdecpmat) @ (cco @ (ccv @ Xk) @ (XX @ Xk) @ Xc_ex) @ Xc_as))) @ ccgsu) @ ccco1)) = (cco @ XU @ XK @ ccdecpmat)))))))))))))))))))))))).
