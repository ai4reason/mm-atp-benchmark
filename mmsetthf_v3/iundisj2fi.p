...
thf(ciundisj2fi_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (cwnfc @ (^ [Xn:$i] : (XB2 @ Xk @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xk)) => ((XA2 @ Xn) = (XB2 @ Xk @ Xn))))) => (cwdisj @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfzo)) @ (^ [Xn:$i] : (ccdif @ (XA2 @ Xn) @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfzo)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xn)))))))))))).
