...
thf(cotel3xp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((XT = (ccotp @ XA2 @ XB2 @ XC)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XZ))) => (cwcel @ XT @ (ccxp @ (ccxp @ XX @ XY) @ XZ))))))))))).
