...
thf(abnj422_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) <=> (cw_bnj17 @ Xch @ Xth @ Xph @ Xps))))))).
...
thf(cbnj535_conj,conjecture,(! [Xta:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [Xn:$i] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xbnjwphm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xbnjwpsm:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : ((Xbnjwphm @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ (XA2 @ Xx3 @ Xf1 @ Xm) @ (XR @ Xx3 @ Xf1 @ Xm) @ (ccv @ Xx3))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xbnjwpsm @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xp) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xm)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xx3 @ Xf1 @ Xm) @ (XR @ Xx3 @ Xf1 @ Xm) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XG @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xp) = (ccun @ (ccv @ Xf1) @ (ccsn @ (ccop @ (ccv @ Xm) @ (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xp) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xx3 @ Xf1 @ Xm) @ (XR @ Xx3 @ Xf1 @ Xm) @ (ccv @ Xy1)))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xta @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xp) <=> (cw_bnj17 @ (Xbnjwphm @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm) @ (Xbnjwpsm @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xp) @ (cwcel @ (ccv @ Xm) @ ccom) @ (cwcel @ (ccv @ Xp) @ (ccv @ Xm)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((cw_bnj17 @ (cw_bnj15 @ (XA2 @ Xx3 @ Xf1 @ Xm) @ (XR @ Xx3 @ Xf1 @ Xm)) @ (Xta @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xp) @ ((ccv @ Xn) = (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xm)))) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xm))) => (cwfn @ (XG @ Xx3 @ Xy1 @ Xf1 @ Xi @ Xm @ Xp) @ (ccv @ Xn))))))))))))))))))))).
