...
thf(cbnj1209_conj,conjecture,(! [Xph:($i > $o)] : (! [Xch:$o] : (! [Xth:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xch => (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xth @ Xx3) <=> (Xch & (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)) & (Xph @ Xx3)))) => (Xch => (? [Xx3:$i] : (Xth @ Xx3)))))))))).
