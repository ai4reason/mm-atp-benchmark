...
thf(ausgr2pthspth_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccusgr) & ((ccfv @ XF @ cchash) = cc2)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) <=> (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)))))))).
...
thf(aupgrf1istrl_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccupgr) => ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) <=> ((cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF) & (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP) & (cwral @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) = (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))))).
...
thf(cusgr2pth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccusgr) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & ((ccfv @ XF @ cchash) = cc2)) <=> ((cwf1 @ (cco @ ccc0 @ cc2 @ ccfzo) @ (ccdm @ XI) @ XF) & (cwf1 @ (cco @ ccc0 @ cc2 @ ccfz) @ XV @ XP) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((((ccfv @ ccc0 @ XP) = (ccv @ Xx3)) & ((ccfv @ cc1 @ XP) = (ccv @ Xy1)) & ((ccfv @ cc2 @ XP) = (ccv @ Xz))) & (((ccfv @ (ccfv @ ccc0 @ XF) @ XI) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))) & ((ccfv @ (ccfv @ cc1 @ XF) @ XI) = (ccpr @ (ccv @ Xy1) @ (ccv @ Xz)))))) @ (^ [Xz:$i] : (ccdif @ XV @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XV))))))))))))).
