...
thf(axpindi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccxp @ XA2 @ (ccin @ XB2 @ XC)) = (ccin @ (ccxp @ XA2 @ XB2) @ (ccxp @ XA2 @ XC))))))).
...
thf(axpindir_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccxp @ (ccin @ XA2 @ XB2) @ XC) = (ccin @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC))))))).
thf(acoss1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (cccom @ XA2 @ XC) @ (cccom @ XB2 @ XC))))))).
thf(custund_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwss @ (ccxp @ XA2 @ XA2) @ XV)) => ((Xph => (cwss @ (ccxp @ XB2 @ XB2) @ XV)) => ((Xph => ((ccin @ XA2 @ XB2) != cc0)) => (Xph => (cwss @ (ccxp @ (ccun @ XA2 @ XB2) @ (ccun @ XA2 @ XB2)) @ (cccom @ XV @ XV))))))))))).
