...
thf(cbr1cnvxrn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ (cccnv @ (ccxrn @ XR @ XS))) <=> (? [Xy1:$i] : (? [Xz:$i] : ((XA2 = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) & (cwbr @ XB2 @ (ccv @ Xy1) @ XR) & (cwbr @ XB2 @ (ccv @ Xz) @ XS)))))))))))).
