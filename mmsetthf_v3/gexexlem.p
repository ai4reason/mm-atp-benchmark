...
thf(agexnnod_thm,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((XO = (ccfv @ XG @ ccod)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XE @ ccn) & (cwcel @ XA2 @ XX)) => (cwcel @ (ccfv @ XA2 @ XO) @ ccn))))))))))).
...
thf(aodmulg_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) => ((ccfv @ XA2 @ XO) = (cco @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ ccmul))))))))))))).
thf(agcdeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => (((cco @ XA2 @ XB2 @ ccgcd) = XA2) <=> (cwbr @ XA2 @ XB2 @ ccdvds)))))).
...
thf(aodadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((((cwcel @ XG @ ccabl) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) & ((cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccgcd) = cc1)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XO) = (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccmul))))))))))))).
...
thf(alediv2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt)) & ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XC @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ ccle))))))).
...
thf(apc2dvds_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cwbr @ XA2 @ XB2 @ ccdvds) <=> (cwral @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ (cco @ (ccv @ Xp) @ XB2 @ ccpc) @ ccle)) @ (^ [Xp:$i] : ccprime))))))).
thf(agexdvds2_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((! [Xx3:$i] : ((XO @ Xx3) = (ccfv @ XG @ ccod))) => (((cwcel @ XG @ ccgrp) & (cwcel @ XN @ ccz)) => ((cwbr @ XE @ XN @ ccdvds) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xx3)) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XX))))))))))))).
thf(advdseq_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) & ((cwbr @ XM @ XN @ ccdvds) & (cwbr @ XN @ XM @ ccdvds))) => (XM = XN))))).
thf(cgexexlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((XO = (ccfv @ XG @ ccod)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XE @ ccn)) => ((Xph => (cwcel @ XA2 @ XX)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XX)) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XO) @ (ccfv @ XA2 @ XO) @ ccle))) => (Xph => ((ccfv @ XA2 @ XO) = XE)))))))))))))))).
