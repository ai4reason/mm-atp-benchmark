...
thf(auvtxavalOLD_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((XV = (ccfv @ XG @ ccvtx)) => (! [Xv:$i] : (! [Xn:$i] : ((cwcel @ XG @ (XW @ Xv @ Xn)) => ((ccfv @ XG @ ccuvtx) = (ccrab @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
...
thf(cuvtxa01vtx0OLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ XW) & (XE = cc0)) => (((ccfv @ XG @ ccuvtx) != cc0) <=> ((ccfv @ XV @ cchash) = cc1)))))))))).
