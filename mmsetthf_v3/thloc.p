...
thf(athlval_thm,axiom,(! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ ccthl)) => ((XC = (ccfv @ XW @ cccss)) => ((XI = (ccfv @ XC @ ccipo)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((cwcel @ XW @ XV) => (XK = (cco @ XI @ (ccop @ (ccfv @ ccnx @ ccoc) @ Xc_pe) @ ccsts)))))))))))))).
...
thf(cthloc_conj,conjecture,(! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ ccthl)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => (Xc_pe = (ccfv @ XK @ ccoc)))))))).
