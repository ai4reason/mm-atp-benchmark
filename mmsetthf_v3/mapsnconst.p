...
thf(cmapsnconst_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccsn @ XX)) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XX @ ccvv) => ((cwcel @ XF @ (cco @ XB2 @ XS @ ccmap)) => (XF = (ccxp @ XS @ (ccsn @ (ccfv @ XX @ XF))))))))))))).
