...
thf(aptcmpg_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XF @ ccpt)) => ((XX = (ccuni @ XJ)) => (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ cccmp @ XF) & (cwcel @ XX @ (ccin @ ccufl @ (ccdm @ cccrd)))) => (cwcel @ XJ @ cccmp)))))))))).
...
thf(akelac2lem_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => (cwcel @ (ccfv @ (ccpr @ XS @ (ccsn @ (ccpw @ (ccuni @ XS)))) @ cctg) @ cccmp))))).
...
thf(akelac2_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XS @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => ((XS @ Xx3) != cc0))) => ((Xph => (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (XS @ Xx3) @ (ccsn @ (ccpw @ (ccuni @ (XS @ Xx3))))) @ cctg))) @ ccpt) @ cccmp)) => (Xph => ((ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XS @ Xx3))) != cc0)))))))))).
...
thf(adfac9_thm,axiom,(cwac <=> (! [Xf1:$i] : (((cwfun @ (ccv @ Xf1)) & (cwnel @ cc0 @ (ccrn @ (ccv @ Xf1)))) => ((ccixp @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) != cc0))))).
thf(cdfac21_conj,conjecture,(cwac <=> (! [Xf1:$i] : ((cwf @ (ccdm @ (ccv @ Xf1)) @ cccmp @ (ccv @ Xf1)) => (cwcel @ (ccfv @ (ccv @ Xf1) @ ccpt) @ cccmp))))).
