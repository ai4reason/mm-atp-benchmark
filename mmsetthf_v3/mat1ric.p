...
thf(amat1rngiso_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XO = (ccop @ XE @ XE)) => ((XF = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XO @ (ccv @ Xx3)))))) => (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => (cwcel @ XF @ (cco @ XR @ XA2 @ ccrs))))))))))))))))).
