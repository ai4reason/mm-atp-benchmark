...
thf(adgreq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XF @ Xz @ Xk) @ (ccfv @ (XS @ Xz @ Xk) @ ccply))))) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwf @ ccn0 @ ccc @ XA2)) => ((Xph => ((ccima @ XA2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) = (ccsn @ ccc0))) => ((! [Xz:$i] : (! [Xk:$i] : (Xph => ((XF @ Xz @ Xk) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => ((Xph => ((ccfv @ XN @ XA2) != ccc0)) => (! [Xz:$i] : (! [Xk:$i] : (Xph => ((ccfv @ (XF @ Xz @ Xk) @ ccdgr) = XN)))))))))))))))).
...
thf(ccoe1termlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xn:$i] : ((XF @ Xz @ Xn) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ XA2 @ (cco @ (ccv @ Xz) @ XN @ ccexp) @ ccmul)))))) => (! [Xz:$i] : (! [Xn:$i] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => (((ccfv @ (XF @ Xz @ Xn) @ cccoe) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = XN) @ XA2 @ ccc0)))) & ((XA2 != ccc0) => ((ccfv @ (XF @ Xz @ Xn) @ ccdgr) = XN))))))))))).
