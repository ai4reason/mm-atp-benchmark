...
thf(chvaddsub4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) & ((cwcel @ XC @ cchil) & (cwcel @ XD @ cchil))) => (((cco @ XA2 @ XB2 @ ccva) = (cco @ XC @ XD @ ccva)) <=> ((cco @ XA2 @ XC @ ccmv) = (cco @ XD @ XB2 @ ccmv))))))))).
