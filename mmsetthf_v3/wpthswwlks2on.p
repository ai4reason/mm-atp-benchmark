...
thf(awlklnwwlknupgr_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XG @ ccupgr) => ((? [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = XN))) <=> (cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn)))))))).
...
thf(cwpthswwlks2on_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccusgr) & (XA2 != XB2)) => ((cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwspthsnon)) = (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)))))))).
