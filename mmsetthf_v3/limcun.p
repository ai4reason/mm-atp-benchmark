...
thf(alimciun_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : (cwss @ (XB2 @ Xx3) @ ccc)) @ (^ [Xx3:$i] : XA2)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccc @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ ccc))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cco @ XF @ XC @ cclimc) = (ccin @ ccc @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccres @ XF @ (XB2 @ Xx3)) @ XC @ cclimc))))))))))))))))).
...
thf(climcun_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwss @ XB2 @ ccc)) => ((Xph => (cwf @ (ccun @ XA2 @ XB2) @ ccc @ XF)) => (Xph => ((cco @ XF @ XC @ cclimc) = (ccin @ (cco @ (ccres @ XF @ XA2) @ XC @ cclimc) @ (cco @ (ccres @ XF @ XB2) @ XC @ cclimc))))))))))))).
