...
thf(abnj1029_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => (cw_bnj19 @ XA2 @ (cc_bnj18 @ XA2 @ XR @ XX) @ XR)))))).
...
thf(cbnj1125_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2) & (cwcel @ XY @ (cc_bnj18 @ XA2 @ XR @ XX))) => (cwss @ (cc_bnj18 @ XA2 @ XR @ XY) @ (cc_bnj18 @ XA2 @ XR @ XX)))))))).
