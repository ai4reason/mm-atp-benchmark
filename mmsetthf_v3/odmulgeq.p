...
thf(aodmulg2_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) => (cwbr @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ (ccfv @ XA2 @ XO) @ ccdvds)))))))))))).
...
thf(codmulgeq_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => (((ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) = (ccfv @ XA2 @ XO)) <=> ((cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) = cc1))))))))))))).
