...
thf(celimampt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ (XW @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XD @ XA2))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwcel @ XC @ (ccima @ (XF @ Xx3) @ XD)) <=> (cwrex @ (^ [Xx3:$i] : (XC = (XB2 @ Xx3))) @ (^ [Xx3:$i] : XD)))))))))))))))).
