...
thf(cevls1sca_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (cco @ XS @ XR @ cces1)) => ((XW = (ccfv @ XU @ ccpl1)) => ((XU = (cco @ XS @ XR @ ccress)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XA2 = (ccfv @ XW @ ccascl)) => ((Xph => (cwcel @ XS @ cccrg)) => ((Xph => (cwcel @ XR @ (ccfv @ XS @ ccsubrg))) => ((Xph => (cwcel @ XX @ XR)) => (Xph => ((ccfv @ (ccfv @ XX @ XA2) @ XQ) = (ccxp @ XB2 @ (ccsn @ XX)))))))))))))))))))))).
