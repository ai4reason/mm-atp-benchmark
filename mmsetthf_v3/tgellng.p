...
thf(ctgellng_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XL = (ccfv @ XG @ cclng)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (XX != XY)) => ((Xph => (cwcel @ XZ @ XP)) => (Xph => ((cwcel @ XZ @ (cco @ XX @ XY @ XL)) <=> ((cwcel @ XZ @ (cco @ XX @ XY @ XI)) | (cwcel @ XX @ (cco @ XZ @ XY @ XI)) | (cwcel @ XY @ (cco @ XX @ XZ @ XI)))))))))))))))))))))).
