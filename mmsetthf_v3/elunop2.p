...
thf(celunop2_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ ccuo) <=> ((cwcel @ XT @ cclo) & (cwfo @ cchil @ cchil @ XT) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) = (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)))))).
