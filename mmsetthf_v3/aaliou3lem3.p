...
thf(acvgcmp_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ ccr))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ XN @ ccuz))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ XN @ ccuz))) => (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (ccv @ Xk) @ XF) @ ccle))) => (Xph => (cwcel @ (ccseq @ ccaddc @ XG @ XM) @ (ccdm @ ccli))))))))))))))))).
...
thf(aaaliou3lem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xc:$i] : ((XG @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccfv @ XA2 @ ccuz)) @ (^ [Xc:$i] : (cco @ (cco @ cc2 @ (ccneg @ (ccfv @ XA2 @ ccfa)) @ ccexp) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ (ccv @ Xc) @ XA2 @ ccmin) @ ccexp) @ ccmul))))) => (! [Xc:$i] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz))) => (cwcel @ (ccfv @ XB2 @ (XG @ Xc)) @ ccr)))))))).
thf(asimp1d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps & Xch & Xth)) => (Xph => Xps))))))).
thf(ampbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(aaaliou3lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xc:$i] : ((XG @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccfv @ XA2 @ ccuz)) @ (^ [Xc:$i] : (cco @ (cco @ cc2 @ (ccneg @ (ccfv @ XA2 @ ccfa)) @ ccexp) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ (ccv @ Xc) @ XA2 @ ccmin) @ ccexp) @ ccmul))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ cc2 @ (ccneg @ (ccfv @ (ccv @ Xa) @ ccfa)) @ ccexp))))) => (! [Xa:$i] : (! [Xc:$i] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ (ccfv @ XA2 @ ccuz))) => (cwcel @ (ccfv @ XB2 @ (XF @ Xa)) @ (cco @ ccc0 @ (ccfv @ XB2 @ (XG @ Xc)) @ ccioc)))))))))))).
...
thf(ageolim3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwbr @ (ccfv @ XB2 @ ccabs) @ cc1 @ cclt)) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xk:$i] : ((XF @ Xk) = (ccmpt @ (^ [Xk:$i] : (ccfv @ XA2 @ ccuz)) @ (^ [Xk:$i] : (cco @ XC @ (cco @ XB2 @ (cco @ (ccv @ Xk) @ XA2 @ ccmin) @ ccexp) @ ccmul))))) => (! [Xk:$i] : (Xph => (cwbr @ (ccseq @ ccaddc @ (XF @ Xk) @ XA2) @ (cco @ XC @ (cco @ cc1 @ XB2 @ ccmin) @ ccdiv) @ ccli)))))))))))))).
...
thf(aisumrpcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((XW = (ccfv @ XN @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccrp))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => (Xph => (cwcel @ (ccsu @ XW @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccrp)))))))))))))))).
thf(aeqidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (Xph => (XA2 = XA2))))).
thf(abreqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwbr @ XA2 @ XB2 @ XR)) => ((Xph => (XB2 = XC)) => (Xph => (cwbr @ XA2 @ XC @ XR)))))))))).
thf(aisumle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccr))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccle))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XG @ XM) @ (ccdm @ ccli))) => (Xph => (cwbr @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsu @ XZ @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccle))))))))))))))))))).
...
thf(caaliou3lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xc:$i] : ((XG @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccfv @ XA2 @ ccuz)) @ (^ [Xc:$i] : (cco @ (cco @ cc2 @ (ccneg @ (ccfv @ XA2 @ ccfa)) @ ccexp) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ (ccv @ Xc) @ XA2 @ ccmin) @ ccexp) @ ccmul))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ cc2 @ (ccneg @ (ccfv @ (ccv @ Xa) @ ccfa)) @ ccexp))))) => (! [Xa:$i] : ((cwcel @ XA2 @ ccn) => ((cwcel @ (ccseq @ ccaddc @ (XF @ Xa) @ XA2) @ (ccdm @ ccli)) & (cwcel @ (ccsu @ (ccfv @ XA2 @ ccuz) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xb) @ (XF @ Xa)))) @ ccrp) & (cwbr @ (ccsu @ (ccfv @ XA2 @ ccuz) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xb) @ (XF @ Xa)))) @ (cco @ cc2 @ (cco @ cc2 @ (ccneg @ (ccfv @ XA2 @ ccfa)) @ ccexp) @ ccmul) @ ccle)))))))))).
