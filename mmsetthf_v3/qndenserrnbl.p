...
thf(aqndenserrnbllem_thm,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (XI != cc0)) => ((Xph => (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((! [Xy1:$i] : ((XD @ Xy1) = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (cco @ XX @ XE @ (ccfv @ (XD @ Xy1) @ ccbl)))) @ (^ [Xy1:$i] : (cco @ ccq @ XI @ ccmap))))))))))))))).
thf(aneqne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (XA2 = XB2)) => (XA2 != XB2))))).
thf(cqndenserrnbl_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((XD = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds)) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (cco @ XX @ XE @ (ccfv @ XD @ ccbl)))) @ (^ [Xy1:$i] : (cco @ ccq @ XI @ ccmap)))))))))))))).
