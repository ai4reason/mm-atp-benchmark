...
thf(caxlowdimlem12_conj,conjecture,(! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) & (XK != (cco @ XI @ cc1 @ ccaddc))) => ((ccfv @ XK @ XQ) = ccc0)))))))).
