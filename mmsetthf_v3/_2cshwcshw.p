...
thf(c_2cshwcshw_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XY @ (ccword @ XV)) & ((ccfv @ XY @ cchash) = XN)) => (((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) & (XX = (cco @ XY @ XK @ cccsh)) & (cwrex @ (^ [Xm:$i] : (XZ = (cco @ XY @ (ccv @ Xm) @ cccsh))) @ (^ [Xm:$i] : (cco @ ccc0 @ XN @ ccfz)))) => (cwrex @ (^ [Xn:$i] : (XZ = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))).
