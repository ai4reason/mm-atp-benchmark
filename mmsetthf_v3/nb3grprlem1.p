...
thf(cnb3grprlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((Xph => (cwcel @ XG @ ccusgr)) => ((Xph => (XV = (cctp @ XA2 @ XB2 @ XC))) => ((Xph => ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XZ))) => (Xph => (((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ XB2 @ XC)) <=> ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XA2 @ XC) @ XE)))))))))))))))))))).
