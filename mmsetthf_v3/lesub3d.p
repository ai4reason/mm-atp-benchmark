...
thf(clesub3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwbr @ (cco @ XX @ XC @ ccaddc) @ XA2 @ ccle)) => ((Xph => (cwbr @ XB2 @ XX @ ccle)) => (Xph => (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ ccle)))))))))))))).
