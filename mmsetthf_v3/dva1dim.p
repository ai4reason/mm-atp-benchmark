...
thf(atendoex_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xu:$i] : ((Xc_le @ Xu) = (ccfv @ XK @ ccple))) => ((! [Xu:$i] : ((XH @ Xu) = (ccfv @ XK @ cclh))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => (! [Xu:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xu))) & ((cwcel @ XF @ XT) & (cwcel @ XN @ XT)) & (cwbr @ (ccfv @ XN @ XR) @ (ccfv @ XF @ XR) @ (Xc_le @ Xu))) => (cwrex @ (^ [Xu:$i] : ((ccfv @ XF @ (ccv @ Xu)) = XN)) @ (^ [Xu:$i] : XE))))))))))))))))))).
