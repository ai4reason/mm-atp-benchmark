...
thf(asramulr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra)))) => ((Xph => (cwss @ XS @ (ccfv @ XW @ ccbs))) => (Xph => ((ccfv @ XW @ ccmulr) = (ccfv @ XA2 @ ccmulr)))))))))).
...
thf(acmn12_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ cccmn) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2))) => ((cco @ XX @ (cco @ XY @ XZ @ Xc_pl) @ Xc_pl) = (cco @ XY @ (cco @ XX @ XZ @ Xc_pl) @ Xc_pl)))))))))))).
...
thf(csraassa_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra))) => (((cwcel @ XW @ cccrg) & (cwcel @ XS @ (ccfv @ XW @ ccsubrg))) => (cwcel @ XA2 @ ccasa))))))).
