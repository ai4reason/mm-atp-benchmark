...
thf(amulgassr_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XG @ ccgrp) & ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (cwcel @ XX @ XB2))) => ((cco @ (cco @ XN @ XM @ ccmul) @ XX @ Xc_x) = (cco @ XM @ (cco @ XN @ XX @ Xc_x) @ Xc_x)))))))))))).
...
thf(cmulgmodid_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XG @ ccgrp) & ((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn)) & ((cwcel @ XX @ XB2) & ((cco @ XM @ XX @ Xc_x) = Xc_0))) => ((cco @ (cco @ XN @ XM @ ccmo) @ XX @ Xc_x) = (cco @ XN @ XX @ Xc_x)))))))))))))).
