...
thf(ccurry1f_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XC) @ ccvv))))) => (((cwf @ (ccxp @ XA2 @ XB2) @ XD @ XF) & (cwcel @ XC @ XA2)) => (cwf @ XB2 @ XD @ XG)))))))))).
