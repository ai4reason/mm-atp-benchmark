...
thf(aisomenndlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xn:$i] : (Xph => (cwf @ (ccpw @ (XX @ Xn)) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XO))) => ((Xph => ((ccfv @ cc0 @ XO) = ccc0)) => ((! [Xn:$i] : (! [Xa:$i] : (Xph => (cwss @ (XY @ Xa) @ (ccpw @ (XX @ Xn)))))) => ((! [Xn:$i] : (! [Xa:$i] : ((Xph & (cwf @ ccn @ (ccpw @ (XX @ Xn)) @ (ccv @ Xa))) => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xa)))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xa)) @ XO))) @ ccsumge0) @ ccle)))) => ((! [Xa:$i] : (Xph => (cwss @ (XB2 @ Xa) @ ccn))) => ((! [Xa:$i] : (Xph => (cwf1o @ (XB2 @ Xa) @ (XY @ Xa) @ (XF @ Xa)))) => ((! [Xa:$i] : (XA2 = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ (XB2 @ Xa)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xa)) @ cc0))))) => (! [Xa:$i] : (Xph => (cwbr @ (ccfv @ (ccuni @ (XY @ Xa)) @ XO) @ (ccfv @ (ccres @ XO @ (XY @ Xa)) @ ccsumge0) @ ccle)))))))))))))))))).
...
thf(cisomennd_conj,conjecture,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xa:$i] : (Xph => (cwcel @ (XX @ Xx3 @ Xy1 @ Xn) @ (XV @ Xx3 @ Xy1 @ Xn @ Xa))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (Xph => (cwf @ (ccpw @ (XX @ Xx3 @ Xy1 @ Xn)) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XO))))) => ((Xph => ((ccfv @ cc0 @ XO) = ccc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph & (cwss @ (ccv @ Xx3) @ (XX @ Xx3 @ Xy1 @ Xn)) & (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XO) @ (ccfv @ (ccv @ Xx3) @ XO) @ ccle))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xa:$i] : ((Xph & (cwf @ ccn @ (ccpw @ (XX @ Xx3 @ Xy1 @ Xn)) @ (ccv @ Xa))) => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xa)))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xa)) @ XO))) @ ccsumge0) @ ccle)))))) => (Xph => (cwcel @ XO @ ccome)))))))))))).
