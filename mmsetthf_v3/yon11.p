...
thf(acurf11_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ (ccop @ XC @ XD) @ XF @ cccurf)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XC @ XD @ ccxpc) @ XE @ ccfunc))) => ((XB2 = (ccfv @ XD @ ccbs)) => ((Xph => (cwcel @ XX @ XA2)) => ((XK = (ccfv @ XX @ (ccfv @ XG @ cc1st))) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((ccfv @ XY @ (ccfv @ XK @ cc1st)) = (cco @ XX @ XY @ (ccfv @ XF @ cc1st))))))))))))))))))))))))).
...
thf(cyon11_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (ccfv @ XC @ ccyon)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XZ @ XB2)) => (Xph => ((ccfv @ XZ @ (ccfv @ (ccfv @ XX @ (ccfv @ XY @ cc1st)) @ cc1st)) = (cco @ XZ @ XX @ XH))))))))))))))))).
