...
thf(crelogbmulbexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccrp @ (ccsn @ cc1))) & ((cwcel @ XA2 @ ccrp) & (cwcel @ XC @ ccr))) => ((cco @ XB2 @ (cco @ XA2 @ (cco @ XB2 @ XC @ cccxp) @ ccmul) @ cclogb) = (cco @ (cco @ XB2 @ XA2 @ cclogb) @ XC @ ccaddc))))))).
