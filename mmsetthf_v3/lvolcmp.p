...
thf(clvolcmp_conj,conjecture,(! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XV = (ccfv @ XK @ cclvol)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV)) => ((cwbr @ XX @ XY @ Xc_le) <=> (XX = XY))))))))))).
