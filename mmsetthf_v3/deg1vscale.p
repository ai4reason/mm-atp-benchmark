...
thf(cdeg1vscale_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xph => (cwcel @ XF @ XK)) => ((Xph => (cwcel @ XG @ XB2)) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_x) @ XD) @ (ccfv @ XG @ XD) @ ccle)))))))))))))))))))).
