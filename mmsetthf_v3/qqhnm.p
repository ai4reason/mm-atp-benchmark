...
thf(anmdvr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccnm)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((((cwcel @ XR @ ccnrg) & (cwcel @ XR @ ccnzr)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XU))) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_dv) @ XN) = (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccdiv))))))))))))))).
...
thf(cqqhnm_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XN = (ccfv @ XR @ ccnm)) => ((XZ = (ccfv @ XR @ cczlm)) => ((((cwcel @ XR @ (ccin @ ccnrg @ ccdr)) & (cwcel @ XZ @ ccnlm) & ((ccfv @ XR @ ccchr) = ccc0)) & (cwcel @ XQ @ ccq)) => ((ccfv @ (ccfv @ XQ @ (ccfv @ XR @ ccqqh)) @ XN) = (ccfv @ XQ @ ccabs)))))))))).
