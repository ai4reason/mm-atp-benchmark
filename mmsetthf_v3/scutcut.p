...
thf(cscutcut_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => ((cwcel @ (cco @ XA2 @ XB2 @ ccscut) @ ccsur) & (cwbr @ XA2 @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ ccsslt) & (cwbr @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ XB2 @ ccsslt)))))).
