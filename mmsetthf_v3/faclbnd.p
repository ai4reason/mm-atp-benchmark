...
thf(alemulge11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ cc1 @ XB2 @ ccle))) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle))))).
...
thf(a_0exp0e1_thm,axiom,((cco @ ccc0 @ ccc0 @ ccexp) = cc1)).
...
thf(cfaclbnd_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ (cco @ (cco @ XM @ XM @ ccexp) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
