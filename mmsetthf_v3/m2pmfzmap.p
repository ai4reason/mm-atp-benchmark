...
thf(cm2pmfzmap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : (! [Xb:$i] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XS @ ccn0)) & ((cwcel @ (ccv @ Xb) @ (cco @ XB2 @ (cco @ ccc0 @ XS @ ccfz) @ ccmap)) & (cwcel @ XI @ (cco @ ccc0 @ XS @ ccfz)))) => (cwcel @ (ccfv @ (ccfv @ XI @ (ccv @ Xb)) @ XT) @ (ccfv @ XY @ ccbs))))))))))))))))))).
