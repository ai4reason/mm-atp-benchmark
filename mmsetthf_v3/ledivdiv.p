...
thf(cledivdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt))) & (((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt)) & ((cwcel @ XD @ ccr) & (cwbr @ ccc0 @ XD @ cclt)))) => ((cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccle) <=> (cwbr @ (cco @ XD @ XC @ ccdiv) @ (cco @ XB2 @ XA2 @ ccdiv) @ ccle)))))))).
