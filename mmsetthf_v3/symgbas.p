...
thf(csymgbas_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ XA2 @ ccsymg))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XG @ Xx3) @ ccbs))) => (! [Xx3:$i] : ((XB2 @ Xx3) = (^ [Xx3:$i] : (cwf1o @ XA2 @ XA2 @ (ccv @ Xx3))))))))))).
