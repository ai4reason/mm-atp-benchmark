...
thf(ccoprmdvds1_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (((cwcel @ XF @ ccn) & (cwcel @ XG @ ccn) & ((cco @ XF @ XG @ ccgcd) = cc1)) => (((cwcel @ XI @ ccn) & (cwbr @ XI @ XF @ ccdvds) & (cwbr @ XI @ XG @ ccdvds)) => (XI = cc1))))))).
