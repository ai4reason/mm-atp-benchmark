...
thf(aneibastop1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xo:$i] : (Xph => (cwcel @ XX @ (XV @ Xx3 @ Xw @ Xv @ Xo))))))) => ((Xph => (cwf @ XX @ (ccdif @ (ccpw @ (ccpw @ XX)) @ (ccsn @ cc0)) @ XF)) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xx3) @ XF)) & (cwcel @ (ccv @ Xw) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((ccin @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccpw @ (ccin @ (ccv @ Xv) @ (ccv @ Xw)))) != cc0))))) => ((! [Xw:$i] : (! [Xo:$i] : ((XJ @ Xw @ Xo) = (ccrab @ (^ [Xo:$i] : (cwral @ (^ [Xx3:$i] : ((ccin @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccpw @ (ccv @ Xo))) != cc0)) @ (^ [Xx3:$i] : (ccv @ Xo)))) @ (^ [Xo:$i] : (ccpw @ XX)))))) => (! [Xw:$i] : (! [Xo:$i] : (Xph => (cwcel @ (XJ @ Xw @ Xo) @ (ccfv @ XX @ cctopon))))))))))))))).
...
thf(aneibastop2lem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xo:$i] : (! [Xa:$i] : ((Xph @ Xu @ Xa) => (cwcel @ XX @ (XV @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xf1 @ Xo @ Xa))))))))))))) => ((! [Xu:$i] : (! [Xa:$i] : ((Xph @ Xu @ Xa) => (cwf @ XX @ (ccdif @ (ccpw @ (ccpw @ XX)) @ (ccsn @ cc0)) @ XF)))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (((Xph @ Xu @ Xa) & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xx3) @ XF)) & (cwcel @ (ccv @ Xw) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((ccin @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccpw @ (ccin @ (ccv @ Xv) @ (ccv @ Xw)))) != cc0))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xo:$i] : (! [Xa:$i] : ((XJ @ Xw @ Xt @ Xf1 @ Xo @ Xa) = (ccrab @ (^ [Xo:$i] : (cwral @ (^ [Xx3:$i] : ((ccin @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccpw @ (ccv @ Xo))) != cc0)) @ (^ [Xx3:$i] : (ccv @ Xo)))) @ (^ [Xo:$i] : (ccpw @ XX))))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (((Xph @ Xu @ Xa) & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xx3) @ XF)))) => (cwcel @ (ccv @ Xx3) @ (ccv @ Xv))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (((Xph @ Xu @ Xa) & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xx3) @ XF)))) => (cwrex @ (^ [Xt:$i] : (cwral @ (^ [Xy1:$i] : ((ccin @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccpw @ (ccv @ Xv))) != cc0)) @ (^ [Xy1:$i] : (ccv @ Xt)))) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xx3) @ XF)))))))) => ((! [Xu:$i] : (! [Xa:$i] : ((Xph @ Xu @ Xa) => (cwcel @ (XP @ Xa) @ XX)))) => ((! [Xu:$i] : (! [Xa:$i] : ((Xph @ Xu @ Xa) => (cwss @ (XN @ Xa) @ XX)))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xo:$i] : (! [Xa:$i] : ((Xph @ Xu @ Xa) => (cwcel @ (XU @ Xw @ Xv @ Xu @ Xt @ Xo @ Xa) @ (ccfv @ (XP @ Xa) @ XF))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xo:$i] : (! [Xa:$i] : ((Xph @ Xu @ Xa) => (cwss @ (XU @ Xw @ Xv @ Xu @ Xt @ Xo @ Xa) @ (XN @ Xa))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xo:$i] : (! [Xa:$i] : ((XG @ Xx3 @ Xw @ Xu @ Xo @ Xa) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xz:$i] : (ccv @ Xa)) @ (^ [Xz:$i] : (cciun @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccin @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccpw @ (ccv @ Xz))))))))) @ (ccsn @ (XU @ Xw @ Xv @ Xu @ Xt @ Xo @ Xa))) @ ccom))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xo:$i] : (! [Xa:$i] : ((XS @ Xz @ Xw @ Xa) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((ccin @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccpw @ (ccv @ Xf1))) != cc0)) @ (^ [Xf1:$i] : (ccuni @ (ccrn @ (XG @ Xx3 @ Xw @ Xu @ Xo @ Xa)))))) @ (^ [Xy1:$i] : XX))))))))) => (! [Xw:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xo:$i] : (! [Xa:$i] : ((Xph @ Xu @ Xa) => (cwrex @ (^ [Xu:$i] : ((cwcel @ (XP @ Xa) @ (ccv @ Xu)) & (cwss @ (ccv @ Xu) @ (XN @ Xa)))) @ (^ [Xu:$i] : (XJ @ Xw @ Xt @ Xf1 @ Xo @ Xa))))))))))))))))))))))))))))))))).
...
thf(ardgeq1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = XG) => ((ccrdg @ XF @ XA2) = (ccrdg @ XG @ XA2))))))).
...
thf(cneibastop2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xo:$i] : (Xph => (cwcel @ XX @ (XV @ Xx3 @ Xy1 @ Xw @ Xv @ Xt @ Xo))))))))) => ((Xph => (cwf @ XX @ (ccdif @ (ccpw @ (ccpw @ XX)) @ (ccsn @ cc0)) @ XF)) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xx3) @ XF)) & (cwcel @ (ccv @ Xw) @ (ccfv @ (ccv @ Xx3) @ XF)))) => ((ccin @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccpw @ (ccin @ (ccv @ Xv) @ (ccv @ Xw)))) != cc0))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xo:$i] : ((XJ @ Xw @ Xt @ Xo) = (ccrab @ (^ [Xo:$i] : (cwral @ (^ [Xx3:$i] : ((ccin @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccpw @ (ccv @ Xo))) != cc0)) @ (^ [Xx3:$i] : (ccv @ Xo)))) @ (^ [Xo:$i] : (ccpw @ XX))))))) => ((! [Xx3:$i] : (! [Xv:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xx3) @ XF)))) => (cwcel @ (ccv @ Xx3) @ (ccv @ Xv))))) => ((! [Xx3:$i] : (! [Xv:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xv) @ (ccfv @ (ccv @ Xx3) @ XF)))) => (cwrex @ (^ [Xt:$i] : (cwral @ (^ [Xy1:$i] : ((ccin @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccpw @ (ccv @ Xv))) != cc0)) @ (^ [Xy1:$i] : (ccv @ Xt)))) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xx3) @ XF)))))) => (! [Xw:$i] : (! [Xt:$i] : (! [Xo:$i] : ((Xph & (cwcel @ XP @ XX)) => ((cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ (XJ @ Xw @ Xt @ Xo) @ ccnei))) <=> ((cwss @ XN @ XX) & ((ccin @ (ccfv @ XP @ XF) @ (ccpw @ XN)) != cc0))))))))))))))))))))).
