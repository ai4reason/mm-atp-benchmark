...
thf(csmatlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (cco @ XK @ XL @ (ccfv @ XA2 @ ccsmat))) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => ((Xph => (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XN @ ccfz)) @ ccmap))) => ((Xph => (cwcel @ XI @ ccn)) => ((Xph => (cwcel @ XJ @ ccn)) => ((Xph => ((ccif @ (cwbr @ XI @ XK @ cclt) @ XI @ (cco @ XI @ cc1 @ ccaddc)) = XX)) => ((Xph => ((ccif @ (cwbr @ XJ @ XL @ cclt) @ XJ @ (cco @ XJ @ cc1 @ ccaddc)) = XY)) => (Xph => ((cco @ XI @ XJ @ XS) = (cco @ XX @ XY @ XA2)))))))))))))))))))))))))).
