...
thf(adfac14lem_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XI @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xx3) @ (XI @ Xy1))) => (cwcel @ (XS @ Xx3) @ (XW @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xx3) @ (XI @ Xy1))) => ((XS @ Xx3) != cc0)))) => ((! [Xx3:$i] : ((XP @ Xx3) = (ccpw @ (ccuni @ (XS @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xx3 @ Xy1) = (ccrab @ (^ [Xy1:$i] : ((cwcel @ (XP @ Xx3) @ (ccv @ Xy1)) => ((ccv @ Xy1) = (ccun @ (XS @ Xx3) @ (ccsn @ (XP @ Xx3)))))) @ (^ [Xy1:$i] : (ccpw @ (ccun @ (XS @ Xx3) @ (ccsn @ (XP @ Xx3))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : (XI @ Xy1)) @ (^ [Xx3:$i] : (XR @ Xx3 @ Xy1))) @ ccpt)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => ((ccfv @ (ccixp @ (^ [Xx3:$i] : (XI @ Xy1)) @ (^ [Xx3:$i] : (XS @ Xx3))) @ (ccfv @ (XJ @ Xx3 @ Xy1) @ cccl)) = (ccixp @ (^ [Xx3:$i] : (XI @ Xy1)) @ (^ [Xx3:$i] : (ccfv @ (XS @ Xx3) @ (ccfv @ (XR @ Xx3 @ Xy1) @ cccl)))))))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((ccixp @ (^ [Xx3:$i] : (XI @ Xy1)) @ (^ [Xx3:$i] : (XS @ Xx3))) != cc0))))))))))))))))))).
...
thf(cdfac14_conj,conjecture,(cwac <=> (! [Xf1:$i] : ((cwf @ (ccdm @ (ccv @ Xf1)) @ cctop @ (ccv @ Xf1)) => (cwral @ (^ [Xs1:$i] : ((ccfv @ (ccixp @ (^ [Xk:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)))) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ ccpt) @ cccl)) = (ccixp @ (^ [Xk:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ cccl)))))) @ (^ [Xs1:$i] : (ccixp @ (^ [Xk:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xk:$i] : (ccpw @ (ccuni @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))))))))).
