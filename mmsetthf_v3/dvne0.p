...
thf(advgt0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccrp @ (cco @ ccr @ XF @ ccdv))) => (Xph => (cwiso @ (cco @ XA2 @ XB2 @ ccicc) @ (ccrn @ XF) @ cclt @ cclt @ XF))))))))))).
...
thf(advlt0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ ccmnf @ ccc0 @ ccioo) @ (cco @ ccr @ XF @ ccdv))) => (Xph => (cwiso @ (cco @ XA2 @ XB2 @ ccicc) @ (ccrn @ XF) @ cclt @ (cccnv @ cclt) @ XF))))))))))).
