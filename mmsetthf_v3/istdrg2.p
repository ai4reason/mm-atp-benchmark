...
thf(cistdrg2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ cctdrg) <=> ((cwcel @ XR @ cctrg) & (cwcel @ XR @ ccdr) & (cwcel @ (cco @ XM @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress) @ cctgp))))))))))).
