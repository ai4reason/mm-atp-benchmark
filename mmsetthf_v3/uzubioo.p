...
thf(cuzubioo_conj,conjecture,(! [Xph:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XM @ ccz))) => ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XX @ ccr))) => (! [Xk:$i] : ((Xph @ Xk) => (cwrex @ (^ [Xk:$i] : (cwcel @ (ccv @ Xk) @ XZ)) @ (^ [Xk:$i] : (cco @ XX @ ccpnf @ ccioo))))))))))))).
