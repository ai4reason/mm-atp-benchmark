...
thf(aobsne0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) & (cwcel @ XA2 @ XB2)) => (XA2 != Xc_0)))))))).
...
thf(aocvlsp_thm,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XN = (ccfv @ XW @ cclspn)) => (((cwcel @ XW @ ccphl) & (cwss @ XS @ XV)) => ((ccfv @ (ccfv @ XS @ XN) @ Xc_pe) = (ccfv @ XS @ Xc_pe)))))))))))).
...
thf(cobselocv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => (((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) & (cwss @ XC @ XB2) & (cwcel @ XA2 @ XB2)) => ((cwcel @ XA2 @ (ccfv @ XC @ Xc_pe)) <=> (~ (cwcel @ XA2 @ XC))))))))))).
