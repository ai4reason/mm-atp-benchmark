...
thf(cuhgr3cyclexlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XI = (ccfv @ XG @ cciedg)) => (((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & (XA2 != XB2)) & (((cwcel @ XJ @ (ccdm @ XI)) & ((ccpr @ XB2 @ XC) = (ccfv @ XJ @ XI))) & ((cwcel @ XK @ (ccdm @ XI)) & ((ccpr @ XC @ XA2) = (ccfv @ XK @ XI))))) => (XJ != XK))))))))))))))).
