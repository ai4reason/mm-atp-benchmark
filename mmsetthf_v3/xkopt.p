...
thf(acndis_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cco @ (ccpw @ XA2) @ XJ @ cccn) = (cco @ XX @ XA2 @ ccmap)))))))).
...
thf(aixpconstg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => ((ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) = (cco @ XB2 @ XA2 @ ccmap))))))))).
...
thf(aptuniconst_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt)) => ((XX = (ccuni @ XR)) => (((cwcel @ XA2 @ XV) & (cwcel @ XR @ cctop)) => ((cco @ XX @ XA2 @ ccmap) = (ccuni @ XJ))))))))))).
thf(arestid_thm,axiom,(! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ XV) => ((cco @ XJ @ XX @ ccrest) = XJ))))))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(axkoptsub_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XR)) => ((XJ = (ccfv @ (ccxp @ XX @ (ccsn @ XS)) @ ccpt)) => (((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) => (cwss @ (cco @ XJ @ (cco @ XR @ XS @ cccn) @ ccrest) @ (cco @ XS @ XR @ ccxko)))))))))).
thf(cxkopt_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ cctop) & (cwcel @ XA2 @ XV)) => ((cco @ XR @ (ccpw @ XA2) @ ccxko) = (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt))))))).
