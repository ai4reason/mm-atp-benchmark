...
thf(cpslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XR @ ccps) => ((((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XB2 @ XC @ XR)) => (cwbr @ XA2 @ XC @ XR)) & ((cwcel @ XA2 @ (ccuni @ (ccuni @ XR))) => (cwbr @ XA2 @ XA2 @ XR)) & (((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XB2 @ XA2 @ XR)) => (XA2 = XB2))))))))).
