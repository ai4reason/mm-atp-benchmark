...
thf(alply1binom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_pl = (ccfv @ XP @ ccplusg)) => ((Xc_xp = (ccfv @ XP @ ccmulr)) => ((Xc_x = (ccfv @ XP @ ccmg)) => ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XG @ Xk) @ ccmg))) => ((! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ XP @ ccbs))) => (! [Xk:$i] : (((cwcel @ XR @ cccrg) & (cwcel @ XN @ ccn0) & (cwcel @ XA2 @ (XB2 @ Xk))) => ((cco @ XN @ (cco @ XX @ XA2 @ Xc_pl) @ Xc_ex) = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu)))))))))))))))))))))))).
...
thf(clply1binomsc_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_pl = (ccfv @ XP @ ccplusg)) => ((Xc_xp = (ccfv @ XP @ ccmulr)) => ((Xc_x = (ccfv @ XP @ ccmg)) => ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XG @ Xk) @ ccmg))) => ((XK = (ccfv @ XR @ ccbs)) => ((XS = (ccfv @ XP @ ccascl)) => ((! [Xk:$i] : ((XH @ Xk) = (ccfv @ XR @ ccmgp))) => ((! [Xk:$i] : ((XE @ Xk) = (ccfv @ (XH @ Xk) @ ccmg))) => (((cwcel @ XR @ cccrg) & (cwcel @ XN @ ccn0) & (cwcel @ XA2 @ XK)) => ((cco @ XN @ (cco @ XX @ (ccfv @ XA2 @ XS) @ Xc_pl) @ Xc_ex) = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (ccfv @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ (XE @ Xk)) @ XS) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu))))))))))))))))))))))))))))).
