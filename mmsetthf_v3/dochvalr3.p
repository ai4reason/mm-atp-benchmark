...
thf(cdochvalr3_conj,conjecture,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XN = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccrn @ XI))) => (Xph => ((ccfv @ (ccfv @ XX @ (cccnv @ XI)) @ Xc_pe) = (ccfv @ (ccfv @ XX @ XN) @ (cccnv @ XI))))))))))))))))))).
