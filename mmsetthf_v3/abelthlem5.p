...
thf(acvgcmpce_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccr))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ ccc))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((Xph => (cwcel @ XC @ ccr)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ XN @ ccuz))) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ ccabs) @ (cco @ XC @ (ccfv @ (ccv @ Xk) @ XF) @ ccmul) @ ccle))) => (Xph => (cwcel @ (ccseq @ ccaddc @ XG @ XM) @ (ccdm @ ccli)))))))))))))))))).
...
thf(ageolim_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ XA2 @ (ccv @ Xk) @ ccexp)))) => (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ ccc0) @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ ccli))))))))).
...
thf(cabelthlem5_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwf @ ccn0 @ ccc @ XA2))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XM @ ccr))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ ccc0 @ XM @ ccle))) => ((! [Xz:$i] : ((XS @ Xz) = (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ cc1 @ (ccv @ Xz) @ ccmin) @ ccabs) @ (cco @ XM @ (cco @ cc1 @ (ccfv @ (ccv @ Xz) @ ccabs) @ ccmin) @ ccmul) @ ccle)) @ (^ [Xz:$i] : ccc)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xz @ Xk @ Xn) = (ccmpt @ (^ [Xx3:$i] : (XS @ Xz)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul)))))))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (ccseq @ ccaddc @ XA2 @ ccc0) @ ccc0 @ ccli))) => (! [Xz:$i] : (((Xph @ Xz) & (cwcel @ XX @ (cco @ ccc0 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => (cwcel @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccseq @ ccaddc @ XA2 @ ccc0)) @ (cco @ XX @ (ccv @ Xk) @ ccexp) @ ccmul))) @ ccc0) @ (ccdm @ ccli)))))))))))))))))).
