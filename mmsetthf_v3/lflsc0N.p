...
thf(clflsc0N_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XD @ ccbs)) => ((Xc_x = (ccfv @ XD @ ccmulr)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XX @ XK)) => (Xph => ((cco @ (ccxp @ XV @ (ccsn @ Xc_0)) @ (ccxp @ XV @ (ccsn @ XX)) @ (ccof @ Xc_x)) = (ccxp @ XV @ (ccsn @ Xc_0)))))))))))))))))))).
