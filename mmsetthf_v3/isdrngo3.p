...
thf(cisdrngo3_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XR @ cc1st)))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xx3:$i] : (! [Xy1:$i] : (XZ = (ccfv @ (XG @ Xx3 @ Xy1) @ ccgi)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccrn @ (XG @ Xx3 @ Xy1))))) => ((XU = (ccfv @ XH @ ccgi)) => ((cwcel @ XR @ ccdrng) <=> ((cwcel @ XR @ ccrngo) & ((XU != XZ) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XH) = XU)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccsn @ XZ))))))))))))))))))).
