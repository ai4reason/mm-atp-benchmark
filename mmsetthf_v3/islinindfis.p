...
thf(cislinindfis_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XB2 @ Xx3 @ Xf1) = (ccfv @ XM @ ccbs)))) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XM @ cc0g))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XR @ Xx3 @ Xf1) = (ccfv @ XM @ ccsca)))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XE @ Xx3) = (ccfv @ (XR @ Xx3 @ Xf1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((Xc_0 @ Xx3) = (ccfv @ (XR @ Xx3 @ Xf1) @ cc0g)))) => (! [Xx3:$i] : (! [Xf1:$i] : (((cwcel @ XS @ ccfn) & (cwcel @ XM @ (XW @ Xx3))) => ((cwbr @ XS @ XM @ cclininds) <=> ((cwcel @ XS @ (ccpw @ (XB2 @ Xx3 @ Xf1))) & (cwral @ (^ [Xf1:$i] : (((cco @ (ccv @ Xf1) @ XS @ (ccfv @ XM @ cclinc)) = (XZ @ Xx3)) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) = (Xc_0 @ Xx3))) @ (^ [Xx3:$i] : XS)))) @ (^ [Xf1:$i] : (cco @ (XE @ Xx3) @ XS @ ccmap)))))))))))))))))))))).
