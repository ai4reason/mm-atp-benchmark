...
thf(cpmtr3ncomlem1_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XF = (ccfv @ (ccpr @ XX @ XY) @ XT)) => ((XG = (ccfv @ (ccpr @ XY @ XZ) @ XT)) => (((cwcel @ XD @ XV) & ((cwcel @ XX @ XD) & (cwcel @ XY @ XD) & (cwcel @ XZ @ XD)) & ((XX != XY) & (XX != XZ) & (XY != XZ))) => ((ccfv @ XX @ (cccom @ XG @ XF)) != (ccfv @ XX @ (cccom @ XF @ XG)))))))))))))))).
