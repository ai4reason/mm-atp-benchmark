...
thf(abnj69_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cw_bnj15 @ XA2 @ XR) & (cwss @ XB2 @ XA2) & (XB2 != cc0)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))).
...
thf(cbnj1228_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xw:$i] : ((cwcel @ (ccv @ Xw) @ (XB2 @ Xx3)) => (! [Xx3:$i] : (cwcel @ (ccv @ Xw) @ (XB2 @ Xx3)))))) => (! [Xx3:$i] : (! [Xw:$i] : (((cw_bnj15 @ (XA2 @ Xx3 @ Xw) @ (XR @ Xw)) & (cwss @ (XB2 @ Xx3) @ (XA2 @ Xx3 @ Xw)) & ((XB2 @ Xx3) != cc0)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (XR @ Xw)))) @ (^ [Xy1:$i] : (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
