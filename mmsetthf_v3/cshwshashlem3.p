...
thf(acshwshashlem2_thm,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => ((Xph & (cwrex @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) != (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) => (((cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) & (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) & (cwbr @ XK @ XL @ cclt)) => ((cco @ XW @ XL @ cccsh) != (cco @ XW @ XK @ cccsh))))))))))).
...
thf(ccshwshashlem3_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => ((Xph & (cwrex @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) != (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) => (((cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) & (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) & (XK != XL)) => ((cco @ XW @ XL @ cccsh) != (cco @ XW @ XK @ cccsh))))))))))).
