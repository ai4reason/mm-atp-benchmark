...
thf(afvclss_thm,axiom,(! [XF:($i > $o)] : (cwss @ (^ [Xy1:$i] : (? [Xx3:$i] : ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF)))) @ (ccun @ (ccrn @ XF) @ (ccsn @ cc0))))).
thf(cfvclex_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwcel @ (^ [Xy1:$i] : (? [Xx3:$i] : ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF)))) @ ccvv)))).
