...
thf(aislinei_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xp:$i] : ((Xc_le @ Xp) = (ccfv @ XK @ ccple))) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : ((XN @ Xp) = (ccfv @ XK @ cclines))) => (! [Xp:$i] : ((((cwcel @ XK @ (XD @ Xp)) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & ((XQ != XR) & ((XX @ Xp) = (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (cco @ XQ @ XR @ (Xc_or @ Xp)) @ (Xc_le @ Xp))) @ (^ [Xp:$i] : XA2))))) => (cwcel @ (XX @ Xp) @ (XN @ Xp)))))))))))))))))).
thf(clinepmap_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclines)) => ((XM = (ccfv @ XK @ ccpmap)) => ((((cwcel @ XK @ cclat) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & (XP != XQ)) => (cwcel @ (ccfv @ (cco @ XP @ XQ @ Xc_or) @ XM) @ XN)))))))))))))).
