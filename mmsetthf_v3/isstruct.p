...
thf(aisstruct2_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwbr @ XF @ XX @ ccstr) <=> ((cwcel @ XX @ (ccin @ ccle @ (ccxp @ ccn @ ccn))) & (cwfun @ (ccdif @ XF @ (ccsn @ cc0))) & (cwss @ (ccdm @ XF) @ (ccfv @ XX @ ccfz))))))).
...
thf(cisstruct_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwbr @ XF @ (ccop @ XM @ XN) @ ccstr) <=> (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn) & (cwbr @ XM @ XN @ ccle)) & (cwfun @ (ccdif @ XF @ (ccsn @ cc0))) & (cwss @ (ccdm @ XF) @ (cco @ XM @ XN @ ccfz)))))))).
