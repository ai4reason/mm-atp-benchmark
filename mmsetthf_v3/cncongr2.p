...
thf(adivgcdnnr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccz)) => (cwcel @ (cco @ XA2 @ (cco @ XB2 @ XA2 @ ccgcd) @ ccdiv) @ ccn))))).
...
thf(amulcan2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (XC != ccc0)) => (Xph => (((cco @ XA2 @ XC @ ccmul) = (cco @ XB2 @ XC @ ccmul)) <=> (XA2 = XB2)))))))))))).
...
thf(adivgcdz_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (XB2 != ccc0)) => (cwcel @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccz))))).
...
thf(adivmulasscom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ ccc)) & ((cwcel @ XD @ ccc) & (XD != ccc0))) => ((cco @ (cco @ XA2 @ (cco @ XB2 @ XD @ ccdiv) @ ccmul) @ XC @ ccmul) = (cco @ XB2 @ (cco @ (cco @ XA2 @ XC @ ccmul) @ XD @ ccdiv) @ ccmul)))))))).
...
thf(ccncongr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) & ((cwcel @ XN @ ccn) & (XM = (cco @ XN @ (cco @ XC @ XN @ ccgcd) @ ccdiv)))) => (((cco @ XA2 @ XM @ ccmo) = (cco @ XB2 @ XM @ ccmo)) => ((cco @ (cco @ XA2 @ XC @ ccmul) @ XN @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XN @ ccmo)))))))))).
