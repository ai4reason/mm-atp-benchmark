...
thf(aisprs_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cwcel @ XK @ ccpreset) <=> ((cwcel @ XK @ ccvv) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_le) & (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_le)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
...
thf(coduprs_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : ((XD = (ccfv @ XK @ ccodu)) => ((cwcel @ XK @ ccpreset) => (cwcel @ XD @ ccpreset)))))).
