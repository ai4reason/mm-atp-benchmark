...
thf(aexpge1_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XN @ ccn0) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccle))))).
...
thf(arpdp2cl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => (cwcel @ (ccdp2 @ XA2 @ XB2) @ ccrp)))))).
...
thf(alogdivsqrle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ (ccfv @ cc2 @ cce) @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => (Xph => (cwbr @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XB2 @ ccsqrt) @ ccdiv) @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XA2 @ ccsqrt) @ ccdiv) @ ccle)))))))))).
...
thf(adp2lt10_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => ((cwbr @ XA2 @ (ccdc @ cc1 @ ccc0) @ cclt) => ((cwbr @ XB2 @ (ccdc @ cc1 @ ccc0) @ cclt) => (cwbr @ (ccdp2 @ XA2 @ XB2) @ (ccdc @ cc1 @ ccc0) @ cclt)))))))).
thf(a_3lt10_thm,axiom,(cwbr @ cc3 @ (ccdc @ cc1 @ ccc0) @ cclt)).
thf(cc5_tp,type,(cc5 : ($i > $o))).
thf(a_4lt10_thm,axiom,(cwbr @ cc4 @ (ccdc @ cc1 @ ccc0) @ cclt)).
thf(a_8lt10_thm,axiom,(cwbr @ cc8 @ (ccdc @ cc1 @ ccc0) @ cclt)).
...
thf(a_2exp4_thm,axiom,((cco @ cc2 @ cc4 @ ccexp) = (ccdc @ cc1 @ cc6))).
...
thf(amulne0i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((XA2 != ccc0) => ((XB2 != ccc0) => ((cco @ XA2 @ XB2 @ ccmul) != ccc0)))))))).
...
thf(chgt750lem_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwbr @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ XN @ ccle)) => (cwbr @ (cco @ (cco @ cc7 @ (ccdp2 @ cc3 @ (ccdp2 @ cc4 @ cc8)) @ ccdp) @ (cco @ (ccfv @ XN @ cclog) @ (ccfv @ XN @ ccsqrt) @ ccdiv) @ ccmul) @ (cco @ ccc0 @ (ccdp2 @ ccc0 @ (ccdp2 @ ccc0 @ (ccdp2 @ ccc0 @ (ccdp2 @ cc4 @ (ccdp2 @ cc2 @ (ccdp2 @ cc2 @ (ccdp2 @ cc4 @ cc8))))))) @ ccdp) @ cclt)))).
