...
thf(afrgr3vlem1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XZ)) & ((XA2 != XB2) & (XA2 != XC) & (XB2 != XC)) & ((XV = (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ XG @ ccusgr))) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ (ccv @ Xx3) @ (cctp @ XA2 @ XB2 @ XC)) & (cwss @ (ccpr @ (ccpr @ (ccv @ Xx3) @ XA2) @ (ccpr @ (ccv @ Xx3) @ XB2)) @ XE)) & ((cwcel @ (ccv @ Xy1) @ (cctp @ XA2 @ XB2 @ XC)) & (cwss @ (ccpr @ (ccpr @ (ccv @ Xy1) @ XA2) @ (ccpr @ (ccv @ Xy1) @ XB2)) @ XE))) => ((ccv @ Xx3) = (ccv @ Xy1)))))))))))))))))).
