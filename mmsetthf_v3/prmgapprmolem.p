...
thf(aprmdvdsprmop_thm,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XN @ ccle) & (cwbr @ (ccv @ Xp) @ XI @ ccdvds) & (cwbr @ (ccv @ Xp) @ (cco @ (ccfv @ XN @ ccprmo) @ XI @ ccaddc) @ ccdvds))) @ (^ [Xp:$i] : ccprime)))))).
...
thf(aprmocl_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwcel @ (ccfv @ XN @ ccprmo) @ ccn)))).
