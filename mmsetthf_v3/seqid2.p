...
thf(cseqid2_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => ((cco @ (ccv @ Xx3) @ XZ @ Xc_pl) = (ccv @ Xx3)))) => ((Xph => (cwcel @ XK @ (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XN @ (ccfv @ XK @ ccuz))) => ((Xph => (cwcel @ (ccfv @ XK @ (ccseq @ Xc_pl @ XF @ XM)) @ XS)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz))) => ((ccfv @ (ccv @ Xx3) @ XF) = XZ))) => (Xph => ((ccfv @ XK @ (ccseq @ Xc_pl @ XF @ XM)) = (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)))))))))))))))))).
