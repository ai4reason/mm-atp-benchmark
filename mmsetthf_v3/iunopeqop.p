...
thf(ciunopeqop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XB2 @ Xx3 @ Xz) @ ccvv))) => ((! [Xz:$i] : (cwcel @ (XC @ Xz) @ ccvv)) => ((! [Xz:$i] : (cwcel @ (XD @ Xz) @ ccvv)) => (! [Xz:$i] : ((XA2 != cc0) => (((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (XB2 @ Xx3 @ Xz))))) = (ccop @ (XC @ Xz) @ (XD @ Xz))) => (? [Xz:$i] : (XA2 = (ccsn @ (ccv @ Xz))))))))))))))).
