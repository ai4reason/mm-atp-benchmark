...
thf(catcvat3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ XB2 @ ccat) & (cwcel @ XC @ ccat)) => ((((~ (XB2 = XC)) & (~ (cwss @ XC @ XA2))) & (cwss @ XB2 @ (cco @ XA2 @ XC @ cchj))) => (cwcel @ (ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) @ ccat)))))))).
