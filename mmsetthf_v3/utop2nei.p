...
thf(cutop2nei_conj,conjecture,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XU @ ccutop)) => (((cwcel @ XU @ (ccfv @ XX @ ccust)) & ((cwcel @ XV @ XU) & ((cccnv @ XV) = XV)) & (cwss @ XM @ (ccxp @ XX @ XX))) => (cwcel @ (cccom @ XV @ (cccom @ XM @ XV)) @ (ccfv @ XM @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ ccnei))))))))))).
