...
thf(ccfilss_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XF @ (ccfv @ XD @ cccfil))) & ((cwcel @ XG @ (ccfv @ XX @ ccfil)) & (cwss @ XF @ XG))) => (cwcel @ XG @ (ccfv @ XD @ cccfil)))))))).
