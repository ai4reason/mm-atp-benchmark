...
thf(clidl1el_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) => ((cwcel @ Xc_1 @ XI) <=> (XI = XB2)))))))))))).
