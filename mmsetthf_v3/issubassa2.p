...
thf(cissubassa2_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XL = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ ccasa) & (cwcel @ XS @ (ccfv @ XW @ ccsubrg))) => ((cwcel @ XS @ XL) <=> (cwss @ (ccrn @ XA2) @ XS)))))))))).
