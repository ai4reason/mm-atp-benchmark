...
thf(cnmfnlb_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ ccc @ XT) & (cwcel @ XA2 @ cchil) & (cwbr @ (ccfv @ XA2 @ ccno) @ cc1 @ ccle)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (ccfv @ XT @ ccnmf) @ ccle))))).
