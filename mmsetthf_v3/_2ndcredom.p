...
thf(apwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (ccpw @ XA2) @ (ccpw @ XB2) @ ccdom))))).
...
thf(c_2ndcredom_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cc2ndc) => (cwbr @ XJ @ ccr @ ccdom)))).
