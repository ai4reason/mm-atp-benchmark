...
thf(a_2sbcrex_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [Xa:$i] : (! [Xb:$i] : ((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (Xph @ Xa @ Xb @ Xc)) @ (^ [Xc:$i] : (XC @ Xc)))) @ (XB2 @ Xa @ Xb))) @ (XA2 @ Xa @ Xb)) <=> (cwrex @ (^ [Xc:$i] : (cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xph @ Xa @ Xb @ Xc)) @ (XB2 @ Xa @ Xb))) @ (XA2 @ Xa @ Xb))) @ (^ [Xc:$i] : (XC @ Xc))))))))))).
...
thf(asbc2rex_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xc:$i] : ((cwsbc @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (Xph @ Xa @ Xb @ Xc)) @ (^ [Xc:$i] : (XC @ Xb @ Xc)))) @ (^ [Xb:$i] : (XB2 @ Xb @ Xc)))) @ (XA2 @ Xa)) <=> (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwsbc @ (^ [Xa:$i] : (Xph @ Xa @ Xb @ Xc)) @ (XA2 @ Xa))) @ (^ [Xc:$i] : (XC @ Xb @ Xc)))) @ (^ [Xb:$i] : (XB2 @ Xb @ Xc))))))))))).
...
thf(asbcrot3_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xc:$i] : (Xph @ Xa @ Xb @ Xc)) @ (XC @ Xb @ Xc))) @ (XB2 @ Xb @ Xc))) @ (XA2 @ Xa)) <=> (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xc:$i] : (cwsbc @ (^ [Xa:$i] : (Xph @ Xa @ Xb @ Xc)) @ (XA2 @ Xa))) @ (XC @ Xb @ Xc))) @ (XB2 @ Xb @ Xc))))))))))).
thf(asbccomieg_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : ((! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = XA2) => ((XB2 @ Xa @ Xb) = (XC @ Xb))))) => (! [Xb:$i] : ((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (Xph @ Xa @ Xb)) @ (XB2 @ Xa @ Xb))) @ XA2) <=> (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xa:$i] : (Xph @ Xa @ Xb)) @ XA2)) @ (XC @ Xb)))))))))).
