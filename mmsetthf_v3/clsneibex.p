...
thf(cclsneibex_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XD = (ccfv @ XB2 @ XP)) => ((XH = (cccom @ XF @ XD)) => ((Xph => (cwbr @ XK @ XN @ XH)) => (Xph => (cwcel @ XB2 @ ccvv)))))))))))))).
