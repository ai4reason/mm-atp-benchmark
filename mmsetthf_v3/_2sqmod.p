...
thf(asubeqxfrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => ((cco @ XA2 @ XB2 @ ccmin) = (cco @ XC @ XD @ ccmin))) => (Xph => ((cco @ XA2 @ XC @ ccmin) = (cco @ XB2 @ XD @ ccmin)))))))))))))).
...
thf(aznsqcld_thm,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (XN != ccc0)) => (Xph => (cwcel @ (cco @ XN @ cc2 @ ccexp) @ ccn))))))).
thf(asubne0d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (XA2 != XB2)) => (Xph => ((cco @ XA2 @ XB2 @ ccmin) != ccc0))))))))).
thf(altaddrp2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => (cwbr @ XA2 @ (cco @ XB2 @ XA2 @ ccaddc) @ cclt)))))))).
