...
thf(cicceuelpartlem_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (((cwcel @ XI @ (cco @ ccc0 @ XM @ ccfzo)) & (cwcel @ XJ @ (cco @ ccc0 @ XM @ ccfzo))) => ((cwbr @ XI @ XJ @ cclt) => (cwbr @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP) @ (ccfv @ XJ @ XP) @ ccle)))))))))))).
