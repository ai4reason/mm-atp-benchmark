...
thf(cply1idvr1_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((cwcel @ XR @ ccrg) => ((cco @ ccc0 @ XX @ Xc_ex) = (ccfv @ XP @ ccur))))))))))))).
