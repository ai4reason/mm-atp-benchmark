...
thf(cnnfoctbdj_conj,conjecture,(! [Xph:($i > $o)] : (! [XX:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ XX @ ccom @ ccdom))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (XX != cc0))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwdisj @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccv @ Xy1))))) => (! [Xf1:$i] : ((Xph @ Xf1) => (? [Xf1:$i] : ((cwfo @ ccn @ (ccun @ XX @ (ccsn @ cc0)) @ (ccv @ Xf1)) & (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)))))))))))))).
