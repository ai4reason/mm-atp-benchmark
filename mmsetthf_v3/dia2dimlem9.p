...
thf(adia1dimid_thm,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT)) => (cwcel @ XF @ (ccfv @ (ccfv @ XF @ XR) @ XI))))))))))))))).
...
thf(adia2dimlem8_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XY = (ccfv @ XW @ (ccfv @ XK @ ccdveca))) => ((XS = (ccfv @ XY @ cclss)) => ((Xc_po = (ccfv @ XY @ cclsm)) => ((XN = (ccfv @ XY @ cclspn)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => ((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le))) => ((Xph => ((cwcel @ XV @ XA2) & (cwbr @ XV @ XW @ Xc_le))) => ((Xph => (cwcel @ XF @ XT)) => ((Xph => (cwbr @ (ccfv @ XF @ XR) @ (cco @ XU @ XV @ Xc_or) @ Xc_le)) => ((Xph => (XU != XV)) => ((Xph => ((ccfv @ XF @ XR) != XU)) => ((Xph => ((ccfv @ XF @ XR) != XV)) => (Xph => (cwcel @ XF @ (cco @ (ccfv @ XU @ XI) @ (ccfv @ XV @ XI) @ Xc_po)))))))))))))))))))))))))))))))))))))))))).
