...
thf(aiscygd_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XG @ ccgrp))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XX @ XB2))) => ((! [Xy1:$i] : (! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xy1) @ XB2)) => (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ (ccv @ Xn) @ XX @ Xc_x))) @ (^ [Xn:$i] : ccz))))) => (! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XG @ cccyg)))))))))))))).
...
thf(acycsubgcl_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccz) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x))))) => (! [Xx3:$i] : (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => ((cwcel @ (ccrn @ (XF @ Xx3)) @ (ccfv @ XG @ ccsubg)) & (cwcel @ XA2 @ (ccrn @ (XF @ Xx3))))))))))))))).
