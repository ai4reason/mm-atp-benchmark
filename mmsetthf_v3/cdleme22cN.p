...
thf(acdleme22b_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((((cwcel @ XK @ cchlt) & ((cwcel @ XS @ XA2) & (cwcel @ XT @ XA2) & (XS != XT))) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (XP != XQ)) & ((cwcel @ XV @ XA2) & (((cco @ XT @ XV @ Xc_or) != (cco @ XP @ XQ @ Xc_or)) & (cwbr @ XS @ (cco @ XT @ XV @ Xc_or) @ Xc_le) & (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)))) => (~ (cwbr @ XT @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)))))))))))))))))))).
...
thf(ccdleme22cN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & (cwcel @ XQ @ XA2)) & (((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le))) & (cwcel @ XT @ XA2) & ((cwcel @ XV @ XA2) & (cwbr @ XV @ XW @ Xc_le))) & (((XP != XQ) & (XS != XT)) & ((cwbr @ XS @ (cco @ XT @ XV @ Xc_or) @ Xc_le) & (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & ((cco @ XT @ XV @ Xc_or) != (cco @ XP @ XQ @ Xc_or)))) => (~ (cwbr @ XV @ (cco @ XP @ XQ @ Xc_or) @ Xc_le))))))))))))))))))))).
