...
thf(cvdn0conngrumgrv2_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwcel @ XG @ ccconngr) & (cwcel @ XG @ ccumgr)) & ((cwcel @ XN @ XV) & (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt))) => ((ccfv @ XN @ (ccfv @ XG @ ccvtxdg)) != ccc0))))))).
