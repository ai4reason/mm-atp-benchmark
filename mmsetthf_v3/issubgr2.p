...
thf(cissubgr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XS @ ccvtx)) => ((XA2 = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XS @ cciedg)) => ((XB2 = (ccfv @ XG @ cciedg)) => ((XE = (ccfv @ XS @ ccedg)) => (((cwcel @ XG @ XW) & (cwfun @ XB2) & (cwcel @ XS @ XU)) => ((cwbr @ XS @ XG @ ccsubgr) <=> ((cwss @ XV @ XA2) & (cwss @ XI @ XB2) & (cwss @ XE @ (ccpw @ XV)))))))))))))))))))).
