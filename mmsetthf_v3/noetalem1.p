...
thf(cnoetalem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) = (ccif @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccun @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (ccsn @ (ccop @ (ccdm @ (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) @ cc2o))) @ (ccmpt @ (^ [Xg1:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xy1) @ (ccdm @ (ccv @ Xu))) & (cwral @ (^ [Xv:$i] : ((~ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) => ((ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xy1))) = (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xy1)))))) @ (^ [Xv:$i] : XA2)))) @ (^ [Xu:$i] : XA2)))) @ (^ [Xg1:$i] : (ccio @ (^ [Xx3:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xg1) @ (ccdm @ (ccv @ Xu))) & (cwral @ (^ [Xv:$i] : ((~ (cwbr @ (ccv @ Xv) @ (ccv @ Xu) @ ccslt)) => ((ccres @ (ccv @ Xu) @ (ccsuc @ (ccv @ Xg1))) = (ccres @ (ccv @ Xv) @ (ccsuc @ (ccv @ Xg1)))))) @ (^ [Xv:$i] : XA2)) & ((ccfv @ (ccv @ Xg1) @ (ccv @ Xu)) = (ccv @ Xx3)))) @ (^ [Xu:$i] : XA2))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((XZ @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) = (ccun @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ (ccxp @ (ccdif @ (ccsuc @ (ccuni @ (ccima @ ccbday @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1)))) @ (ccdm @ (XS @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1))) @ (ccsn @ cc1o))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (((cwss @ XA2 @ ccsur) & (cwcel @ XA2 @ ccvv) & (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ ccvv)) => (cwcel @ (XZ @ Xx3 @ Xy1 @ Xv @ Xu @ Xg1) @ ccsur)))))))))))))).
