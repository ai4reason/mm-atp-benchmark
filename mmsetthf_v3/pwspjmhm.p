...
thf(cpwspjmhm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XY @ Xx3) = (cco @ XR @ XI @ ccpws))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XY @ Xx3) @ ccbs))) => (! [Xx3:$i] : (((cwcel @ XR @ ccmnd) & (cwcel @ XI @ XV) & (cwcel @ XA2 @ XI)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccv @ Xx3)))) @ (cco @ (XY @ Xx3) @ XR @ ccmhm))))))))))))).
