...
thf(asqrmo_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwrmo @ (^ [Xx3:$i] : (((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2) & (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) & (cwnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp))) @ (^ [Xx3:$i] : ccc))))).
...
thf(cresqreu_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwreu @ (^ [Xx3:$i] : (((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2) & (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) & (cwnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp))) @ (^ [Xx3:$i] : ccc))))).
