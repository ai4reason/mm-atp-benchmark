...
thf(amulne0bbd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => ((cco @ XA2 @ XB2 @ ccmul) != ccc0)) => (Xph => (XB2 != ccc0))))))))).
...
thf(aefcan_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (ccfv @ XA2 @ cce) @ (ccfv @ (ccneg @ XA2) @ cce) @ ccmul) = cc1)))).
...
thf(atanval2_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ cccos) != ccc0)) => ((ccfv @ XA2 @ cctan) = (cco @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ XA2 @ ccmul) @ cce) @ ccmin) @ (cco @ cci @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ XA2 @ ccmul) @ cce) @ ccaddc) @ ccmul) @ ccdiv))))).
thf(ctanval3_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & ((cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) != ccc0)) => ((ccfv @ XA2 @ cctan) = (cco @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccmin) @ (cco @ cci @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))).
