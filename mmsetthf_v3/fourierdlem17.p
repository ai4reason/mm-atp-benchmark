...
thf(cfourierdlem17_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XB2) @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioc) @ (cco @ XA2 @ XB2 @ ccicc) @ (XL @ Xx3))))))))))))).
