...
thf(clplnnlelln_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XN = (ccfv @ XK @ cclln)) => ((XP = (ccfv @ XK @ cclpl)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XP) & (cwcel @ XY @ XN)) => (~ (cwbr @ XX @ XY @ Xc_le))))))))))))).
