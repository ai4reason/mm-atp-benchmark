...
thf(aisngp3_thm,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => ((XX = (ccfv @ XG @ ccbs)) => ((cwcel @ XG @ ccngp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ ccmt) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) = (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))))).
thf(csubgngp_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ (ccfv @ XG @ ccsubg))) => (cwcel @ XH @ ccngp))))))).
