...
thf(cmhmf1o_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (ccfv @ XS @ ccbs)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccmhm)) => ((cwf1o @ XB2 @ XC @ XF) <=> (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ ccmhm)))))))))))).
