...
thf(abasellem1_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => (((cwcel @ XM @ ccn) & (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => (cwcel @ (cco @ (cco @ XK @ ccpi @ ccmul) @ XN @ ccdiv) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)))))))).
...
thf(atangtx_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => (cwbr @ XA2 @ (ccfv @ XA2 @ cctan) @ cclt)))).
