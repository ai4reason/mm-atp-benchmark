...
thf(avtsprod_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (Xph => ((ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ XX @ (cco @ (ccfv @ (ccv @ Xa) @ XL) @ XN @ ccvts)))) = (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccv @ Xm) @ XX @ ccmul) @ ccmul) @ cce) @ ccmul))))))))))))))))).
...
thf(aefcld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => (cwcel @ (ccfv @ XA2 @ cce) @ ccc)))))).
...
thf(aefmul2picn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XA2 @ ccc @ cccncf))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (XB2 @ Xx3) @ ccmul) @ cce))) @ (cco @ XA2 @ ccc @ cccncf)))))))).
...
thf(aitgexpif_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce))) = (ccif @ (XN = ccc0) @ cc1 @ ccc0))))).
...
thf(annmulge_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn0)) => (cwbr @ XN @ (cco @ XM @ XN @ ccmul) @ ccle))))).
