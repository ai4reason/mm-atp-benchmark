...
thf(acrefi_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : ((XX @ Xz) = (ccuni @ XJ))) => (! [Xz:$i] : (((cwcel @ XJ @ (cccref @ XA2)) & (cwss @ XC @ XJ) & ((XX @ Xz) = (ccuni @ XC))) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ XC @ ccref)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XJ) @ XA2))))))))))).
...
thf(ccrefdf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : ((XX @ Xz) = (ccuni @ XJ))) => ((! [Xz:$i] : ((XB2 @ Xz) = (cccref @ XA2))) => ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XA2) => (Xph @ Xz))) => (! [Xz:$i] : (((cwcel @ XJ @ (XB2 @ Xz)) & (cwss @ XC @ XJ) & ((XX @ Xz) = (ccuni @ XC))) => (cwrex @ (^ [Xz:$i] : ((Xph @ Xz) & (cwbr @ (ccv @ Xz) @ XC @ ccref))) @ (^ [Xz:$i] : (ccpw @ XJ))))))))))))))).
