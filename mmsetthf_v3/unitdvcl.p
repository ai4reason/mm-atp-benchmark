...
thf(cunitdvcl_conj,conjecture,(! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XU) & (cwcel @ XY @ XU)) => (cwcel @ (cco @ XX @ XY @ Xc_dv) @ XU)))))))))).
