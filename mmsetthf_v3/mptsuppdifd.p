...
thf(cmptsuppdifd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XZ @ (XW @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cco @ (XF @ Xx3) @ XZ @ ccsupp) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccdif @ ccvv @ (ccsn @ XZ)))) @ (^ [Xx3:$i] : XA2)))))))))))))))).
