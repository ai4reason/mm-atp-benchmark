...
thf(aral2imi_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => ((Xps @ Xx3) => (Xch @ Xx3)))) => ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwral @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
...
thf(cmrcmndind_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [Xet:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl)) => ((Xps @ Xx3) <=> (Xth @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (Xc_0 @ Xy1 @ Xz)) => ((Xps @ Xx3) <=> (Xta @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (XA2 @ Xy1 @ Xz)) => ((Xps @ Xx3) <=> (Xet @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_0 @ Xy1 @ Xz) = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ cc0g))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xc_pl = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccplusg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XB2 @ Xx3) = (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xy1 @ Xz) @ ccmnd))))) => ((! [Xx3:$i] : (Xph => (cwss @ (XG @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((XB2 @ Xx3) = (ccfv @ (XG @ Xx3) @ (ccfv @ (ccfv @ (XM @ Xx3 @ Xy1 @ Xz) @ ccsubmnd) @ ccmrc))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xph => (Xta @ Xy1 @ Xz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3)) & (cwcel @ (ccv @ Xz) @ (XG @ Xx3))) & (Xch @ Xy1)) => (Xth @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xx3)))))) => (! [Xy1:$i] : (! [Xz:$i] : (Xph => (Xet @ Xy1 @ Xz)))))))))))))))))))))))))))))).
