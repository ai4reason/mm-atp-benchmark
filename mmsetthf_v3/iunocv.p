...
thf(ciunocv_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : ((Xc_pe @ Xx3) = (ccfv @ XW @ ccocv))) => ((XV = (ccfv @ XW @ ccbs)) => (! [Xx3:$i] : ((ccfv @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (Xc_pe @ Xx3)) = (ccin @ XV @ (cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ (Xc_pe @ Xx3))))))))))))))).
