...
thf(aopi2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwcel @ (ccpr @ XA2 @ XB2) @ (ccop @ XA2 @ XB2))))))).
...
thf(cuniopel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ (ccop @ XA2 @ XB2) @ XC) => (cwcel @ (ccuni @ (ccop @ XA2 @ XB2)) @ (ccuni @ XC))))))))).
