...
thf(apmatcoe1fsupp_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : ((XP @ Xx3 @ Xi @ Xj @ Xs1) = (ccfv @ XR @ ccpl1)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : ((XC @ Xx3 @ Xi @ Xj @ Xs1) = (cco @ XN @ (XP @ Xx3 @ Xi @ Xj @ Xs1) @ ccmat)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : (XB2 = (ccfv @ (XC @ Xx3 @ Xi @ Xj @ Xs1) @ ccbs)))))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)) = Xc_0)) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))).
