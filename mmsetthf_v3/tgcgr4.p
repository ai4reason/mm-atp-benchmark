...
thf(aiscgrglt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_sm:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : ((XP @ Xi @ Xj) = (ccfv @ XG @ ccbs)))) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_sm @ Xi @ Xj) = (ccfv @ XG @ cccgrg)))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwss @ (XD @ Xi @ Xj) @ ccr)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwf @ (XD @ Xi @ Xj) @ (XP @ Xi @ Xj) @ XA2)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwf @ (XD @ Xi @ Xj) @ (XP @ Xi @ Xj) @ XB2)))) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((cwbr @ XA2 @ XB2 @ (Xc_sm @ Xi @ Xj)) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xi) @ (ccv @ Xj) @ cclt) => ((cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xj) @ XA2) @ Xc_mi) = (cco @ (ccfv @ (ccv @ Xi) @ XB2) @ (ccfv @ (ccv @ Xj) @ XB2) @ Xc_mi)))) @ (^ [Xj:$i] : (ccdm @ XA2)))) @ (^ [Xi:$i] : (ccdm @ XA2))))))))))))))))))))))).
...
thf(ctgcgr4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xc_sm = (ccfv @ XG @ cccgrg)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XW @ XP)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwcel @ XZ @ XP)) => (Xph => ((cwbr @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccs4 @ XW @ XX @ XY @ XZ) @ Xc_sm) <=> ((cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XW @ XX @ XY) @ Xc_sm) & (((cco @ XA2 @ XD @ Xc_mi) = (cco @ XW @ XZ @ Xc_mi)) & ((cco @ XB2 @ XD @ Xc_mi) = (cco @ XX @ XZ @ Xc_mi)) & ((cco @ XC @ XD @ Xc_mi) = (cco @ XY @ XZ @ Xc_mi)))))))))))))))))))))))))))))))))).
