...
thf(cprtlem15_conj,conjecture,(! [Xv:$i] : (! [Xu:$i] : (! [XA2:($i > ($i > $o))] : (! [Xw:$i] : ((cwprt @ (XA2 @ Xw)) => ((cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((cwcel @ (ccv @ Xu) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))) & ((cwcel @ (ccv @ Xw) @ (ccv @ Xy1)) & (cwcel @ (ccv @ Xv) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (XA2 @ Xw)))) @ (^ [Xx3:$i] : (XA2 @ Xw))) => (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xu) @ (ccv @ Xz)) & (cwcel @ (ccv @ Xv) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (XA2 @ Xw)))))))))).
