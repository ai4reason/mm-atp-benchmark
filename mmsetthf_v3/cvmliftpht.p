...
thf(aphtpc01_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwbr @ XF @ XG @ (ccfv @ XJ @ ccphtpc)) => (((ccfv @ ccc0 @ XF) = (ccfv @ ccc0 @ XG)) & ((ccfv @ cc1 @ XF) = (ccfv @ cc1 @ XG)))))))).
...
thf(acvmliftphtlem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((XB2 = (ccuni @ XC)) => ((! [Xf1:$i] : ((XM @ Xf1) = (ccrio @ (^ [Xf1:$i] : (((cccom @ XF @ (ccv @ Xf1)) = XG) & ((ccfv @ ccc0 @ (ccv @ Xf1)) = XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn))))) => ((! [Xf1:$i] : ((XN @ Xf1) = (ccrio @ (^ [Xf1:$i] : (((cccom @ XF @ (ccv @ Xf1)) = XH) & ((ccfv @ ccc0 @ (ccv @ Xf1)) = XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XF @ (cco @ XC @ XJ @ cccvm)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XP @ XB2))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XP @ XF) = (ccfv @ ccc0 @ XG)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XH @ (cco @ ccii @ XJ @ cccn)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XK @ Xf1) @ (cco @ XG @ XH @ (ccfv @ XJ @ ccphtpy))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XA2 @ (cco @ (cco @ ccii @ ccii @ cctx) @ XC @ cccn)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((cccom @ XF @ XA2) = (XK @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((cco @ ccc0 @ ccc0 @ XA2) = XP))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XA2 @ (cco @ (XM @ Xf1) @ (XN @ Xf1) @ (ccfv @ XC @ ccphtpy)))))))))))))))))))))))))))))).
