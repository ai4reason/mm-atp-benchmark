...
thf(autoptop_thm,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (cwcel @ (ccfv @ XU @ ccutop) @ cctop))))).
...
thf(autoptopon_thm,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (cwcel @ (ccfv @ XU @ ccutop) @ (ccfv @ XX @ cctopon)))))).
...
thf(austrel_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwrel @ XV)))))).
...
thf(autopsnnei_thm,axiom,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XU @ ccutop)) => (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU) & (cwcel @ XP @ XX)) => (cwcel @ (ccima @ XV @ (ccsn @ XP)) @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))))))))).
thf(aneitx_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) & ((cwcel @ XA2 @ (ccfv @ XC @ (ccfv @ XJ @ ccnei))) & (cwcel @ XB2 @ (ccfv @ XD @ (ccfv @ XK @ ccnei))))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (ccfv @ (ccxp @ XC @ XD) @ (ccfv @ (cco @ XJ @ XK @ cctx) @ ccnei))))))))))))))).
...
thf(cutop3cls_conj,conjecture,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XU @ ccutop)) => ((((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwss @ XM @ (ccxp @ XX @ XX))) & ((cwcel @ XV @ XU) & ((cccnv @ XV) = XV))) => (cwss @ (ccfv @ XM @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccl)) @ (cccom @ XV @ (cccom @ XM @ XV))))))))))).
