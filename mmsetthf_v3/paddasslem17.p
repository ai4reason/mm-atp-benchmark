...
thf(cpaddasslem17_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & ((cwss @ XX @ XA2) & (cwss @ XY @ XA2) & (cwss @ XZ @ XA2)) & (~ (((XX != cc0) & ((cco @ XY @ XZ @ Xc_pl) != cc0)) & ((XY != cc0) & (XZ != cc0))))) => (cwss @ (cco @ XX @ (cco @ XY @ XZ @ Xc_pl) @ Xc_pl) @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl)))))))))))).
