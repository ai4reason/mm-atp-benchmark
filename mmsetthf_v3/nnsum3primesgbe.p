...
thf(asumpr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XA2) => ((XC @ Xk) = XD))) => ((! [Xk:$i] : (((ccv @ Xk) = XB2) => ((XC @ Xk) = XE))) => ((Xph => ((cwcel @ XD @ ccc) & (cwcel @ XE @ ccc))) => ((Xph => ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW))) => ((Xph => (XA2 != XB2)) => (Xph => ((ccsu @ (ccpr @ XA2 @ XB2) @ (^ [Xk:$i] : (XC @ Xk))) = (cco @ XD @ XE @ ccaddc))))))))))))))))).
...
thf(cnnsum3primesgbe_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccgbe) => (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xd) @ cc3 @ ccle) & (XN = (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))))).
