...
thf(atposf_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ (ccxp @ XA2 @ XB2) @ XC @ XF) => (cwf @ (ccxp @ XB2 @ XA2) @ XC @ (cctpos @ XF)))))))).
...
thf(cmattposcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((cwcel @ XM @ XB2) => (cwcel @ (cctpos @ XM) @ XB2)))))))))).
