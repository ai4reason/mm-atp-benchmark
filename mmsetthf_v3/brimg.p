...
thf(adf_img_ax,axiom,(ccimg = (cccom @ (ccimage @ (ccres @ (cccom @ cc2nd @ cc1st) @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv)))) @ cccart))).
...
thf(a_19_41vv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : ((? [Xx3:$i] : (? [Xy1:$i] : ((Xph @ Xx3 @ Xy1) & Xps))) <=> ((? [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1))) & Xps))))).
...
thf(cbrimg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ ccimg) <=> (XC = (ccima @ XA2 @ XB2)))))))))).
