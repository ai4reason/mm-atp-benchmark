...
thf(awlknwwlksninj_thm,axiom,(! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : ((XT @ Xp) = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))))) => ((! [Xp:$i] : ((XW @ Xp) = (cco @ XN @ XG @ ccwwlksn))) => ((! [Xt:$i] : (! [Xp:$i] : ((XF @ Xt @ Xp) = (ccmpt @ (^ [Xt:$i] : (XT @ Xp)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd)))))) => (! [Xt:$i] : (! [Xp:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) => (cwf1 @ (XT @ Xp) @ (XW @ Xp) @ (XF @ Xt @ Xp)))))))))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(awlknwwlksnsur_thm,axiom,(! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XT = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks)))) => ((XW = (cco @ XN @ XG @ ccwwlksn)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd))))) => (! [Xt:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) => (cwfo @ XT @ XW @ (XF @ Xt))))))))))))).
