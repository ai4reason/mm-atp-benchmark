...
thf(asummolem2_thm,axiom,(! [Xph:$o] : (! [Xx3:$i] : (! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((XF = (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xf1:$i] : ((XG @ Xf1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => ((Xph & (cwrex @ (^ [Xm:$i] : ((cwss @ XA2 @ (ccfv @ (ccv @ Xm) @ ccuz)) & (cwbr @ (ccseq @ ccaddc @ XF @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz))) => ((cwrex @ (^ [Xm:$i] : (? [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ XA2 @ (ccv @ Xf1)) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xm) @ (ccseq @ ccaddc @ (XG @ Xf1) @ cc1)))))) @ (^ [Xm:$i] : ccn)) => ((ccv @ Xx3) = (ccv @ Xy1))))))))))))))).
...
thf(csummo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((XF = (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xf1:$i] : ((XG @ Xf1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xk))))))) => (Xph => (cwmo @ (^ [Xx3:$i] : ((cwrex @ (^ [Xm:$i] : ((cwss @ XA2 @ (ccfv @ (ccv @ Xm) @ ccuz)) & (cwbr @ (ccseq @ ccaddc @ XF @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz)) | (cwrex @ (^ [Xm:$i] : (? [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ XA2 @ (ccv @ Xf1)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xm) @ (ccseq @ ccaddc @ (XG @ Xf1) @ cc1)))))) @ (^ [Xm:$i] : ccn))))))))))))))).
