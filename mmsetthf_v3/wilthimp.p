...
thf(awilth_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccprime) <=> ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwbr @ XN @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa) @ cc1 @ ccaddc) @ ccdvds))))).
...
thf(cwilthimp_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((cco @ (ccfv @ (cco @ XP @ cc1 @ ccmin) @ ccfa) @ XP @ ccmo) = (cco @ (ccneg @ cc1) @ XP @ ccmo))))).
