...
thf(cfzto1st1_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ cc1 @ XN @ ccfz)) => ((! [Xi:$i] : ((XP @ Xi) = (ccmpt @ (^ [Xi:$i] : XD) @ (^ [Xi:$i] : (ccif @ ((ccv @ Xi) = cc1) @ XI @ (ccif @ (cwbr @ (ccv @ Xi) @ XI @ ccle) @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xi))))))) => (! [Xi:$i] : ((XI = cc1) => ((XP @ Xi) = (ccres @ ccid @ XD))))))))))).
