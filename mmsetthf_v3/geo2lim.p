...
thf(cgeo2lim_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xk:$i] : ((XF @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccdiv))))) => (! [Xk:$i] : ((cwcel @ XA2 @ ccc) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xk) @ cc1) @ XA2 @ ccli))))))).
