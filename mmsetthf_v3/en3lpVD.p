...
thf(azfregs2_thm,axiom,(! [XA2:($i > $o)] : ((XA2 != cc0) => (~ (cwral @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(cen3lpVD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (~ ((cwcel @ XA2 @ XB2) & (cwcel @ XB2 @ XC) & (cwcel @ XC @ XA2))))))).
