...
thf(ccplgr2vpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (XA2 != XB2)) & ((cwcel @ XG @ ccuhgr) & (XV = (ccpr @ XA2 @ XB2)))) => ((cwcel @ XG @ cccplgr) <=> (cwcel @ (ccpr @ XA2 @ XB2) @ XE))))))))))))).
