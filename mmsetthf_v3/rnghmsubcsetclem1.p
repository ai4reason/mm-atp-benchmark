...
thf(aoveqdr_b_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xx3:$i] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => ((Xph & Xps) => ((cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XG)))))))))).
...
thf(crnghmsubcsetclem1_conj,conjecture,(! [Xph:$o] : (! [Xx3:$i] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccestrc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XB2 = (ccin @ ccrng @ XU))) => ((Xph => (XH = (ccres @ ccrngh @ (ccxp @ XB2 @ XB2)))) => ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XC @ cccid)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XH))))))))))))))).
