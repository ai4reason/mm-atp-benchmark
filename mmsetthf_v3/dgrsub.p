...
thf(cdgrsub_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdgr) @ (ccif @ (cwbr @ XM @ XN @ ccle) @ XN @ XM) @ ccle)))))))))).
