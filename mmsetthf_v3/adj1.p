...
thf(cadj1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ (ccdm @ ccado)) & (cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccsp) = (cco @ (ccfv @ XA2 @ (ccfv @ XT @ ccado)) @ XB2 @ ccsp))))))).
