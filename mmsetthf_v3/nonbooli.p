...
thf(cnonbooli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((XF = (ccfv @ (ccsn @ XA2) @ ccspn)) => ((XG = (ccfv @ (ccsn @ XB2) @ ccspn)) => ((XH = (ccfv @ (ccsn @ (cco @ XA2 @ XB2 @ ccva)) @ ccspn)) => ((~ ((cwcel @ XA2 @ XG) | (cwcel @ XB2 @ XF))) => ((ccin @ XH @ (cco @ XF @ XG @ cchj)) != (cco @ (ccin @ XH @ XF) @ (ccin @ XH @ XG) @ cchj)))))))))))))).
