...
thf(ccliminf2mpt_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xj:$i] : ((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xj @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xj @ Xk)) @ X)))) => ((! [Xk:$i] : ((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xj @ Xk)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xj @ Xk)) @ X)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xj @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (ccv @ Xj)) => ((XB2 @ Xk) = (XC @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xj @ Xk) & (cwcel @ (ccv @ Xk) @ XZ) & ((ccv @ Xj) = (cco @ (ccv @ Xk) @ cc1 @ ccaddc))) => (cwbr @ (XC @ Xj) @ (XB2 @ Xk) @ ccle)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccdm @ ccli))))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk)))) @ ccxr @ cclt) @ ccli)))))))))))))))))).
