...
thf(abrwdom_thm,axiom,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xz:$i] : ((cwcel @ XY @ (XV @ Xz)) => ((cwbr @ XX @ XY @ ccwdom) <=> ((XX = cc0) | (? [Xz:$i] : (cwfo @ XY @ XX @ (ccv @ Xz))))))))))).
...
thf(cbrwdomn0_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX != cc0) => ((cwbr @ XX @ XY @ ccwdom) <=> (? [Xz:$i] : (cwfo @ XY @ XX @ (ccv @ Xz)))))))).
