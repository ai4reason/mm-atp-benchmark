...
thf(adomtriomlem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XB2 @ Xy1 @ Xk @ Xn) = (^ [Xy1:$i] : ((cwss @ (ccv @ Xy1) @ (XA2 @ Xk)) & (cwbr @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xn)) @ ccen))))))) => ((! [Xy1:$i] : (! [Xb:$i] : ((XC @ Xy1 @ Xb) = (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccdif @ (ccfv @ (ccv @ Xn) @ (ccv @ Xb)) @ (cciun @ (^ [Xk:$i] : (ccv @ Xn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xb)))))))))) => (! [Xk:$i] : ((~ (cwcel @ (XA2 @ Xk) @ ccfn)) => (cwbr @ ccom @ (XA2 @ Xk) @ ccdom)))))))))).
...
thf(cdomtriom_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwbr @ ccom @ XA2 @ ccdom) <=> (~ (cwbr @ XA2 @ ccom @ ccsdm)))))).
