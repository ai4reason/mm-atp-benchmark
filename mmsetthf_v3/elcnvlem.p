...
thf(aelcnv2_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ (cccnv @ XR)) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & (cwcel @ (ccop @ (ccv @ Xy1) @ (ccv @ Xx3)) @ XR)))))))).
...
thf(celcnvlem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccxp @ ccvv @ ccvv)) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xx3) @ cc1st)))))) => (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ (cccnv @ (XB2 @ Xx3))) <=> ((cwcel @ (XA2 @ Xx3) @ (ccxp @ ccvv @ ccvv)) & (cwcel @ (ccfv @ (XA2 @ Xx3) @ (XF @ Xx3)) @ (XB2 @ Xx3)))))))))).
