...
thf(cf1oiso_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwf1o @ XA2 @ (XB2 @ Xz @ Xw) @ XH) & ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((((ccv @ Xz) = (ccfv @ (ccv @ Xx3) @ XH)) & ((ccv @ Xw) = (ccfv @ (ccv @ Xy1) @ XH))) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))))) => (cwiso @ XA2 @ (XB2 @ Xz @ Xw) @ XR @ (XS @ Xx3 @ Xy1 @ Xz @ Xw) @ XH)))))))))))).
