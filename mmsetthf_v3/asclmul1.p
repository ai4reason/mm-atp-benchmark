...
thf(casclmul1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xp = (ccfv @ XW @ ccmulr)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => (((cwcel @ XW @ ccasa) & (cwcel @ XR @ XK) & (cwcel @ XX @ XV)) => ((cco @ (ccfv @ XR @ XA2) @ XX @ Xc_xp) = (cco @ XR @ XX @ Xc_x))))))))))))))))))).
