...
thf(akonigsberglem5_thm,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3)))) => ((! [Xx3:$i] : (XG = (ccop @ XV @ (XE @ Xx3)))) => (cwbr @ cc2 @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)) @ cchash) @ cclt)))))))).
...
thf(akonigsbergumgr_thm,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => (cwcel @ XG @ ccumgr)))))))).
...
thf(aeulerpath_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccupgr) & ((ccfv @ XG @ cceupth) != cc0)) => (cwcel @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)) @ cchash) @ (ccpr @ ccc0 @ cc2))))))).
...
thf(ckonigsberg_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => ((ccfv @ XG @ cceupth) = cc0)))))))).
