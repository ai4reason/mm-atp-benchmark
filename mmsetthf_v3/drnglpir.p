...
thf(adrngnidl_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XU = (ccfv @ XR @ cclidl)) => ((cwcel @ XR @ ccdr) => (XU = (ccpr @ (ccsn @ Xc_0) @ XB2))))))))))).
...
thf(alpi1_thm,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ cclpidl)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwcel @ XB2 @ XP)))))))).
