...
thf(csgnsval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_lt = (ccfv @ XR @ ccplt)) => ((XS = (ccfv @ XR @ ccsgns)) => (((cwcel @ XR @ XV) & (cwcel @ XX @ XB2)) => ((ccfv @ XX @ XS) = (ccif @ (XX = Xc_0) @ ccc0 @ (ccif @ (cwbr @ Xc_0 @ XX @ Xc_lt) @ cc1 @ (ccneg @ cc1))))))))))))))))).
