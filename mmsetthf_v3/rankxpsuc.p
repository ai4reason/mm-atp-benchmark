...
thf(arankuni_thm,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccuni @ XA2) @ ccrnk) = (ccuni @ (ccfv @ XA2 @ ccrnk))))).
...
thf(arankeq0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((XA2 = cc0) <=> ((ccfv @ XA2 @ ccrnk) = cc0))))).
...
thf(crankxpsuc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((((ccfv @ (ccun @ XA2 @ XB2) @ ccrnk) = (ccsuc @ XC)) & ((ccxp @ XA2 @ XB2) != cc0)) => ((ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk) = (ccsuc @ (ccsuc @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk))))))))))).
