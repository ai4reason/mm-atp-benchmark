...
thf(catmod3i2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XP @ XA2) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & (cwbr @ XX @ XY @ Xc_le)) => ((cco @ XX @ (cco @ XY @ XP @ Xc_an) @ Xc_or) = (cco @ XY @ (cco @ XX @ XP @ Xc_or) @ Xc_an)))))))))))))))))).
