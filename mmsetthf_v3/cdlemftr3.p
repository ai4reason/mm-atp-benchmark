...
thf(alhpexle3_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (((ccv @ Xp) != XX) & ((ccv @ Xp) != XY) & ((ccv @ Xp) != XZ)))) @ (^ [Xp:$i] : XA2))))))))))))))).
...
thf(ccdlemftr3_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ XK @ ccbs))) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwrex @ (^ [Xf1:$i] : (((ccv @ Xf1) != (ccres @ ccid @ (XB2 @ Xf1))) & (((ccfv @ (ccv @ Xf1) @ XR) != XX) & ((ccfv @ (ccv @ Xf1) @ XR) != XY) & ((ccfv @ (ccv @ Xf1) @ XR) != XZ)))) @ (^ [Xf1:$i] : XT))))))))))))))))).
