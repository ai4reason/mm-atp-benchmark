...
thf(amuval2_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccn) & ((ccfv @ XA2 @ ccmu) != ccc0)) => ((ccfv @ XA2 @ ccmu) = (cco @ (ccneg @ cc1) @ (ccfv @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ cchash) @ ccexp))))).
