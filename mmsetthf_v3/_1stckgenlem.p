...
thf(c_1stckgenlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwf @ ccn @ XX @ XF)) => ((Xph => (cwbr @ XF @ XA2 @ (ccfv @ XJ @ cclm))) => (Xph => (cwcel @ (cco @ XJ @ (ccun @ (ccrn @ XF) @ (ccsn @ XA2)) @ ccrest) @ cccmp))))))))))).
