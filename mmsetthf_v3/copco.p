...
thf(ccopco_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => ((Xph => ((ccfv @ cc1 @ XF) = (ccfv @ ccc0 @ XG))) => ((Xph => (cwcel @ XH @ (cco @ XJ @ XK @ cccn))) => (Xph => ((cccom @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) = (cco @ (cccom @ XH @ XF) @ (cccom @ XH @ XG) @ (ccfv @ XK @ ccpco))))))))))))))).
