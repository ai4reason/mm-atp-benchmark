...
thf(cd1mat2pmat_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XB2 = (ccfv @ (cco @ XN @ XR @ ccmat) @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XS = (ccfv @ XP @ ccascl)) => (((cwcel @ XR @ XV) & ((XN = (ccsn @ XA2)) & (cwcel @ XA2 @ XV)) & (cwcel @ XM @ XB2)) => ((ccfv @ XM @ XT) = (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ (ccfv @ (cco @ XA2 @ XA2 @ XM) @ XS))))))))))))))))))).
