...
thf(afsumiun_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((Xph => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3)))) => (cwcel @ (XC @ Xk) @ ccc)))) => (Xph => ((ccsu @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (^ [Xk:$i] : (XC @ Xk))) = (ccsu @ XA2 @ (^ [Xx3:$i] : (ccsu @ (XB2 @ Xx3) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))).
...
thf(aactfunsnrndisj_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xk) @ (XC @ Xx3 @ Xk))) => (cwss @ (XA2 @ Xk) @ (cco @ (XC @ Xx3 @ Xk) @ (XB2 @ Xx3 @ Xk) @ ccmap))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3 @ Xk) @ ccvv)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (cwcel @ XI @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (~ (cwcel @ XI @ (XB2 @ Xx3 @ Xk)))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XF @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xk)) @ (^ [Xx3:$i] : (ccun @ (ccv @ Xx3) @ (ccsn @ (ccop @ XI @ (ccv @ Xk))))))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwdisj @ (^ [Xk:$i] : (XC @ Xx3 @ Xk)) @ (^ [Xk:$i] : (ccrn @ (XF @ Xx3 @ Xk))))))))))))))))))).
...
thf(aactfunsnf1o_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xk:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xk) @ (XC @ Xx3 @ Xk))) => (cwss @ (XA2 @ Xk) @ (cco @ (XC @ Xx3 @ Xk) @ (XB2 @ Xx3 @ Xk) @ ccmap))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3 @ Xk) @ ccvv)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (cwcel @ XI @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (~ (cwcel @ XI @ (XB2 @ Xx3 @ Xk)))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XF @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xk)) @ (^ [Xx3:$i] : (ccun @ (ccv @ Xx3) @ (ccsn @ (ccop @ XI @ (ccv @ Xk))))))))) => (! [Xx3:$i] : (! [Xk:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xk) @ (XC @ Xx3 @ Xk))) => (cwf1o @ (XA2 @ Xk) @ (ccrn @ (XF @ Xx3 @ Xk)) @ (XF @ Xx3 @ Xk)))))))))))))))))).
