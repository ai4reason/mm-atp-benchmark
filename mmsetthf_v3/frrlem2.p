...
thf(cfrrlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1) = (^ [Xf1:$i] : (? [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (cco @ (ccv @ Xy1) @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (XB2 @ Xx3 @ Xy1 @ Xf1 @ Xg1)) => (cwfun @ (ccv @ Xg1))))))))))))).
