...
thf(aqndenserrnbl_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((XD = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds)) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (cco @ XX @ XE @ (ccfv @ XD @ ccbl)))) @ (^ [Xy1:$i] : (cco @ ccq @ XI @ ccmap)))))))))))))).
thf(a_3ad2ant1_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((Xph & Xps & Xth) => Xch))))))).
thf(asseldd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwcel @ XC @ XA2)) => (Xph => (cwcel @ XC @ XB2))))))))).
thf(asyl2anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(asylib_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(ccngp_tp,type,(ccngp : ($i > $o))).
thf(arrxtps_thm,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XI @ XV) => (cwcel @ (ccfv @ XI @ ccrrx) @ cctps))))).
...
thf(cqndenserrnopnlem_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((! [Xy1:$i] : ((XJ @ Xy1) = (ccfv @ (ccfv @ XI @ ccrrx) @ cctopn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XV @ (XJ @ Xy1)))) => ((Xph => (cwcel @ XX @ XV)) => ((XD = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds)) => (Xph => (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ XV)) @ (^ [Xy1:$i] : (cco @ ccq @ XI @ ccmap)))))))))))))))).
