...
thf(csmfres_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((Xph => (cwcel @ XA2 @ XV)) => (Xph => (cwcel @ (ccres @ XF @ XA2) @ (ccfv @ XS @ ccsmblfn)))))))))))).
