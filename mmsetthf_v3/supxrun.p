...
thf(csupxrun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwss @ XB2 @ ccxr) & (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle)) => ((ccsup @ (ccun @ XA2 @ XB2) @ ccxr @ cclt) = (ccsup @ XB2 @ ccxr @ cclt)))))).
