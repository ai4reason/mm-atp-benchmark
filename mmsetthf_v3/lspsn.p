...
thf(alss1d_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((! [Xv:$i] : ((XF @ Xv) = (ccfv @ XW @ ccsca))) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((! [Xv:$i] : (XK = (ccfv @ (XF @ Xv) @ ccbs))) => ((! [Xv:$i] : (! [Xk:$i] : ((XS @ Xv @ Xk) = (ccfv @ XW @ cclss)))) => (! [Xv:$i] : (! [Xk:$i] : (((cwcel @ XW @ cclmod) & (cwcel @ XX @ XV)) => (cwcel @ (^ [Xv:$i] : (cwrex @ (^ [Xk:$i] : ((ccv @ Xv) = (cco @ (ccv @ Xk) @ XX @ Xc_x))) @ (^ [Xk:$i] : XK))) @ (XS @ Xv @ Xk)))))))))))))))))).
...
thf(clspsn_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xv:$i] : ((XF @ Xv) = (ccfv @ XW @ ccsca))) => ((! [Xv:$i] : (XK = (ccfv @ (XF @ Xv) @ ccbs))) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XN = (ccfv @ XW @ cclspn)) => (((cwcel @ XW @ cclmod) & (cwcel @ XX @ XV)) => ((ccfv @ (ccsn @ XX) @ XN) = (^ [Xv:$i] : (cwrex @ (^ [Xk:$i] : ((ccv @ Xv) = (cco @ (ccv @ Xk) @ XX @ Xc_x))) @ (^ [Xk:$i] : XK)))))))))))))))))).
