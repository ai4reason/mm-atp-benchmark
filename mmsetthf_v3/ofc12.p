...
thf(cofc12_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XC @ XX)) => (Xph => ((cco @ (ccxp @ XA2 @ (ccsn @ XB2)) @ (ccxp @ XA2 @ (ccsn @ XC)) @ (ccof @ XR)) = (ccxp @ XA2 @ (ccsn @ (cco @ XB2 @ XC @ XR))))))))))))))))).
