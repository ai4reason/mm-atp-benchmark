...
thf(cjm2_27_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XB2 @ ccn) & (cwcel @ XC @ ccn)) => ((XC = (cco @ XA2 @ XB2 @ ccrmy)) <=> (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : (cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwrex @ (^ [Xh:$i] : (cwrex @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : (((((cco @ (cco @ (ccv @ Xd) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ XC @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1) & ((cco @ (cco @ (ccv @ Xf1) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (ccv @ Xe) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1) & (cwcel @ (ccv @ Xg1) @ (ccfv @ cc2 @ ccuz))) & (((cco @ (cco @ (ccv @ Xi) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ (ccv @ Xg1) @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (ccv @ Xh) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1) & ((ccv @ Xe) = (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ (cco @ cc2 @ (cco @ XC @ cc2 @ ccexp) @ ccmul) @ ccmul)) & (cwbr @ (ccv @ Xf1) @ (cco @ (ccv @ Xg1) @ XA2 @ ccmin) @ ccdvds))) & (((cwbr @ (cco @ cc2 @ XC @ ccmul) @ (cco @ (ccv @ Xg1) @ cc1 @ ccmin) @ ccdvds) & (cwbr @ (ccv @ Xf1) @ (cco @ (ccv @ Xh) @ XC @ ccmin) @ ccdvds)) & ((cwbr @ (cco @ cc2 @ XC @ ccmul) @ (cco @ (ccv @ Xh) @ XB2 @ ccmin) @ ccdvds) & (cwbr @ XB2 @ XC @ ccle))))) @ (^ [Xj:$i] : ccn0))) @ (^ [Xi:$i] : ccn0))) @ (^ [Xh:$i] : ccn0))) @ (^ [Xg1:$i] : ccn0))) @ (^ [Xf1:$i] : ccn0))) @ (^ [Xe:$i] : ccn0))) @ (^ [Xd:$i] : ccn0)))))))).
