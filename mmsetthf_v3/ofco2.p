...
thf(cofco2_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((((cwcel @ XF @ ccvv) & (cwcel @ XG @ ccvv)) & ((cwfun @ XH) & (cwcel @ (cccom @ XF @ XH) @ ccvv) & (cwcel @ (cccom @ XG @ XH) @ ccvv))) => ((cccom @ (cco @ XF @ XG @ (ccof @ XR)) @ XH) = (cco @ (cccom @ XF @ XH) @ (cccom @ XG @ XH) @ (ccof @ XR))))))))).
