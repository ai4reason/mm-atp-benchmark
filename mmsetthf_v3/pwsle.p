...
thf(cpwsle_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XO = (ccfv @ XR @ ccple)) => ((Xc_le = (ccfv @ XY @ ccple)) => (((cwcel @ XR @ XV) & (cwcel @ XI @ XW)) => (Xc_le = (ccin @ (ccofr @ XO) @ (ccxp @ XB2 @ XB2))))))))))))))))).
