...
thf(clogcxp0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0))) & (cwcel @ XB2 @ ccc) & (cwcel @ (cco @ XB2 @ (ccfv @ XA2 @ cclog) @ ccmul) @ (ccrn @ cclog))) => ((ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ cclog) = (cco @ XB2 @ (ccfv @ XA2 @ cclog) @ ccmul)))))).
