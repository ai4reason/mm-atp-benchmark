...
thf(ccnfval_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cco @ XJ @ XK @ cccn) = (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XK))) @ (^ [Xf1:$i] : (cco @ XY @ XX @ ccmap)))))))))).
