...
thf(cstoweidlem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xi:$i] : ((XF @ Xi) = (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ (ccv @ Xi) @ ccexp))))) => ((! [Xi:$i] : ((XG @ Xi) = (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ XB2 @ (ccv @ Xi) @ ccexp))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ cc1 @ XA2 @ cclt)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ XB2 @ cc1 @ cclt)) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xn:$i] : ((cwbr @ (cco @ cc1 @ XE @ ccmin) @ (cco @ cc1 @ (cco @ XB2 @ (ccv @ Xn) @ ccexp) @ ccmin) @ cclt) & (cwbr @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ XE @ cclt))) @ (^ [Xn:$i] : ccn))))))))))))))))).
