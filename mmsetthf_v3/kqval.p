...
thf(adf_kq_ax,axiom,(cckq = (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (cco @ (ccv @ Xj) @ (ccmpt @ (^ [Xx3:$i] : (ccuni @ (ccv @ Xj))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xj))))) @ ccqtop))))).
...
thf(ckqval_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XJ))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((ccfv @ XJ @ cckq) = (cco @ XJ @ (XF @ Xx3 @ Xy1) @ ccqtop)))))))))).
