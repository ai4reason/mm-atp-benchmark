...
thf(amat0dimscm_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (cco @ cc0 @ XR @ ccmat)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ (ccfv @ XR @ ccbs))) => ((cco @ XX @ cc0 @ (ccfv @ XA2 @ ccvsca)) = cc0))))))).
thf(arexbidv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
thf(aoveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(amat0dimid_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = (cco @ cc0 @ XR @ ccmat)) => ((cwcel @ XR @ ccrg) => ((ccfv @ XA2 @ ccur) = cc0)))))).
...
thf(cmat0scmat_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrg) => (cwcel @ cc0 @ (cco @ cc0 @ XR @ ccscmat))))).
