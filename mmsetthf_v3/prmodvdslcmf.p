...
thf(a_0nelfz1_thm,axiom,(! [XN:($i > $o)] : (cwnel @ ccc0 @ (cco @ cc1 @ XN @ ccfz)))).
...
thf(afvprmselgcd1_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xm:$i] : ((XF @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccif @ (cwcel @ (ccv @ Xm) @ ccprime) @ (ccv @ Xm) @ cc1))))) => (! [Xm:$i] : (((cwcel @ XX @ (cco @ cc1 @ XN @ ccfz)) & (cwcel @ XY @ (cco @ cc1 @ XN @ ccfz)) & (XX != XY)) => ((cco @ (ccfv @ XX @ (XF @ Xm)) @ (ccfv @ XY @ (XF @ Xm)) @ ccgcd) = cc1))))))))).
...
thf(cprmodvdslcmf_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ (ccfv @ XN @ ccprmo) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ cclcmf) @ ccdvds)))).
