...
thf(ainfpn_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xj:$i] : ((cwbr @ XN @ (ccv @ Xj) @ cclt) & (cwral @ (^ [Xk:$i] : ((cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ ccdiv) @ ccn) => (((ccv @ Xk) = cc1) | ((ccv @ Xk) = (ccv @ Xj))))) @ (^ [Xk:$i] : ccn)))) @ (^ [Xj:$i] : ccn))))).
