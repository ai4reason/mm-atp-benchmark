...
thf(cmogoldbblem_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime) & (cwcel @ XR @ ccprime)) & (cwcel @ XN @ cceven) & ((cco @ XN @ cc2 @ ccaddc) = (cco @ (cco @ XP @ XQ @ ccaddc) @ XR @ ccaddc))) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (XN = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))))))).
