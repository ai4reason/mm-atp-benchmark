...
thf(caxcontlem8_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xi:$i] : ((XD @ Xi) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XF @ Xx3) = (ccopab @ (^ [Xx3:$i] : (^ [Xt:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xi)) & ((cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))))))))) => (! [Xx3:$i] : (! [Xi:$i] : (((((cwcel @ XN @ ccn) & (cwcel @ XZ @ (ccfv @ XN @ ccee)) & (cwcel @ XU @ (ccfv @ XN @ ccee))) & (XZ != XU)) & ((cwcel @ XP @ (XD @ Xi)) & (cwcel @ XQ @ (XD @ Xi)) & (cwcel @ XR @ (XD @ Xi)))) => (((cwbr @ (ccfv @ XP @ (XF @ Xx3)) @ (ccfv @ XQ @ (XF @ Xx3)) @ ccle) & (cwbr @ (ccfv @ XQ @ (XF @ Xx3)) @ (ccfv @ XR @ (XF @ Xx3)) @ ccle)) => (cwbr @ XQ @ (ccop @ XP @ XR) @ ccbtwn)))))))))))))))).
