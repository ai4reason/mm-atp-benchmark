...
thf(adf_drs_ax,axiom,(ccdrs = (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xr:$i] : (((ccv @ Xb) != cc0) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xr)) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xr)))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb))))) @ (ccfv @ (ccv @ Xf1) @ ccple))) @ (ccfv @ (ccv @ Xf1) @ ccbs))) @ (^ [Xf1:$i] : ccpreset)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) <=> (Xph & (Xps & Xch))))))).
thf(cisdrs_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cwcel @ XK @ ccdrs) <=> ((cwcel @ XK @ ccpreset) & (XB2 != cc0) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_le))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
