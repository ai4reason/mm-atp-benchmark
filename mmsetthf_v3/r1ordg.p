...
thf(ar1limg_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccr1)) & (cwlim @ XA2)) => ((ccfv @ XA2 @ ccr1) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccr1))))))).
thf(cr1ordg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccdm @ ccr1)) => ((cwcel @ XA2 @ XB2) => (cwcel @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
