...
thf(apo0_thm,axiom,(! [XR:($i > $o)] : (cwpo @ cc0 @ XR))).
...
thf(apoeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((cwpo @ XA2 @ XR) <=> (cwpo @ XB2 @ XR))))))).
...
thf(aididg_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ XA2 @ ccid))))).
...
thf(cdfpo2_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwpo @ XA2 @ XR) <=> (((ccin @ XR @ (ccres @ ccid @ XA2)) = cc0) & (cwss @ (cccom @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ (ccin @ XR @ (ccxp @ XA2 @ XA2))) @ XR)))))).
