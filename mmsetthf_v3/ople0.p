...
thf(cople0_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => (((cwcel @ XK @ ccops) & (cwcel @ XX @ XB2)) => ((cwbr @ XX @ Xc_0 @ Xc_le) <=> (XX = Xc_0)))))))))))).
