...
thf(clnon0_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XX = (ccfv @ XU @ ccba)) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XU @ ccn0v))) => ((! [Xx3:$i] : ((XO @ Xx3) = (cco @ XU @ XW @ cc0o))) => ((XL = (cco @ XU @ XW @ cclno)) => (! [Xx3:$i] : ((((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv) & (cwcel @ XT @ XL)) & (XT != (XO @ Xx3))) => (cwrex @ (^ [Xx3:$i] : ((ccv @ Xx3) != (XZ @ Xx3))) @ (^ [Xx3:$i] : XX)))))))))))))))).
