...
thf(cbernneq_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XN @ ccn0) & (cwbr @ (ccneg @ cc1) @ XA2 @ ccle)) => (cwbr @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccmul) @ ccaddc) @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ XN @ ccexp) @ ccle))))).
