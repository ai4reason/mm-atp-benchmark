...
thf(cpjspansn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil) & (XA2 != cc0v)) => ((ccfv @ XB2 @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccpjh)) = (cco @ (cco @ (cco @ XB2 @ XA2 @ ccsp) @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ ccdiv) @ XA2 @ ccsm)))))).
