...
thf(csrabn_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra))) => ((XJ = (ccfv @ XW @ cctopn)) => (((cwcel @ XW @ ccnrg) & (cwcel @ XW @ cccms) & (cwcel @ XS @ (ccfv @ XW @ ccsubrg))) => ((cwcel @ XA2 @ ccbn) <=> ((cwcel @ XS @ (ccfv @ XJ @ cccld)) & (cwcel @ (cco @ XW @ XS @ ccress) @ ccdr))))))))))).
