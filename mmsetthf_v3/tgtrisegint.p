...
thf(atgbtwnexch2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XD @ XI))) => ((Xph => (cwcel @ XC @ (cco @ XB2 @ XD @ XI))) => (Xph => (cwcel @ XC @ (cco @ XA2 @ XD @ XI))))))))))))))))))))))).
thf(asimprr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(ctgtrisegint_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xq:$i] : (XP = (ccfv @ (XG @ Xq) @ ccbs))) => ((! [Xq:$i] : (Xc_mi = (ccfv @ (XG @ Xq) @ ccds))) => ((! [Xq:$i] : (XI = (ccfv @ (XG @ Xq) @ ccitv))) => ((! [Xq:$i] : (Xph => (cwcel @ (XG @ Xq) @ ccstrkg))) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XE @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => (cwcel @ XE @ (cco @ XD @ XC @ XI))) => ((Xph => (cwcel @ XF @ (cco @ XA2 @ XD @ XI))) => (Xph => (cwrex @ (^ [Xq:$i] : ((cwcel @ (ccv @ Xq) @ (cco @ XF @ XC @ XI)) & (cwcel @ (ccv @ Xq) @ (cco @ XB2 @ XE @ XI)))) @ (^ [Xq:$i] : XP)))))))))))))))))))))))))))).
