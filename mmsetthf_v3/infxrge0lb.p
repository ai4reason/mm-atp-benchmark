...
thf(cinfxrge0lb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwss @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((Xph => (cwcel @ XB2 @ XA2)) => (Xph => (cwbr @ (ccinf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ XB2 @ ccle)))))))).
