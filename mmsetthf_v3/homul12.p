...
thf(chomul12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (cwf @ cchil @ cchil @ XT)) => ((cco @ XA2 @ (cco @ XB2 @ XT @ cchot) @ cchot) = (cco @ XB2 @ (cco @ XA2 @ XT @ cchot) @ cchot))))))).
