...
thf(csbc2iedv_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = (XB2 @ Xx3))) => ((Xps @ Xx3 @ Xy1) <=> Xch))))) => (Xph => ((cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (XB2 @ Xx3))) @ XA2) <=> Xch))))))))))).
