...
thf(adf_txp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cctxp @ XA2 @ XB2) = (ccin @ (cccom @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv))) @ XA2) @ (cccom @ (cccnv @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))) @ XB2)))))).
...
thf(cbrtxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwbr @ XX @ (ccop @ XY @ XZ) @ (cctxp @ XA2 @ XB2)) <=> ((cwbr @ XX @ XY @ XA2) & (cwbr @ XX @ XZ @ XB2)))))))))))).
