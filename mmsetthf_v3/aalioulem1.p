...
thf(caalioulem1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((Xph => (cwcel @ XX @ ccz)) => ((Xph => (cwcel @ XY @ ccn)) => (Xph => (cwcel @ (cco @ (ccfv @ (cco @ XX @ XY @ ccdiv) @ XF) @ (cco @ XY @ (ccfv @ XF @ ccdgr) @ ccexp) @ ccmul) @ ccz)))))))))).
