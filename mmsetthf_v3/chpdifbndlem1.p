...
thf(cchpdifbndlem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xz:$i] : (! [Xm:$i] : ((Xph @ Xz @ Xm) => (cwcel @ (XA2 @ Xz @ Xm) @ ccrp)))) => ((! [Xz:$i] : (! [Xm:$i] : ((Xph @ Xz @ Xm) => (cwbr @ cc1 @ (XA2 @ Xz @ Xm) @ ccle)))) => ((! [Xz:$i] : (! [Xm:$i] : ((Xph @ Xz @ Xm) => (cwcel @ (XB2 @ Xm) @ ccrp)))) => ((! [Xz:$i] : (! [Xm:$i] : ((Xph @ Xz @ Xm) => (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xz) @ ccchp) @ (ccfv @ (ccv @ Xz) @ cclog) @ ccmul) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xz) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xz) @ (ccv @ Xm) @ ccdiv) @ ccchp) @ ccmul))) @ ccaddc) @ (ccv @ Xz) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xz) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ (XB2 @ Xm) @ ccle)) @ (^ [Xz:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => ((! [Xz:$i] : (! [Xm:$i] : (XC = (cco @ (cco @ (XB2 @ Xm) @ (cco @ (XA2 @ Xz @ Xm) @ cc1 @ ccaddc) @ ccmul) @ (cco @ (cco @ cc2 @ (XA2 @ Xz @ Xm) @ ccmul) @ (ccfv @ (XA2 @ Xz @ Xm) @ cclog) @ ccmul) @ ccaddc)))) => ((! [Xz:$i] : (! [Xm:$i] : ((Xph @ Xz @ Xm) => (cwcel @ (XX @ Xm) @ (cco @ cc1 @ ccpnf @ ccioo))))) => ((! [Xz:$i] : (! [Xm:$i] : ((Xph @ Xz @ Xm) => (cwcel @ (XY @ Xm) @ (cco @ (XX @ Xm) @ (cco @ (XA2 @ Xz @ Xm) @ (XX @ Xm) @ ccmul) @ ccicc))))) => (! [Xz:$i] : (! [Xm:$i] : ((Xph @ Xz @ Xm) => (cwbr @ (cco @ (ccfv @ (XY @ Xm) @ ccchp) @ (ccfv @ (XX @ Xm) @ ccchp) @ ccmin) @ (cco @ (cco @ cc2 @ (cco @ (XY @ Xm) @ (XX @ Xm) @ ccmin) @ ccmul) @ (cco @ XC @ (cco @ (XX @ Xm) @ (ccfv @ (XX @ Xm) @ cclog) @ ccdiv) @ ccmul) @ ccaddc) @ ccle)))))))))))))))))).
