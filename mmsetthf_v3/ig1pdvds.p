...
thf(advdsr01_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2)) => (cwbr @ XX @ Xc_0 @ Xc_pa))))))))))).
...
thf(alidlsubcl_thm,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) & ((cwcel @ XX @ XI) & (cwcel @ XY @ XI))) => (cwcel @ (cco @ XX @ XY @ Xc_mi) @ XI))))))))))).
...
thf(adeg1n0ima_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwss @ (ccima @ XD @ (ccdif @ XB2 @ (ccsn @ Xc_0))) @ ccn0)))))))))))).
...
thf(cig1pdvds_conj,conjecture,(! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XR @ ccig1p)) => ((XU = (ccfv @ XP @ cclidl)) => ((Xc_pa = (ccfv @ XP @ ccdsr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XI @ XU) & (cwcel @ XX @ XI)) => (cwbr @ (ccfv @ XI @ XG) @ XX @ Xc_pa)))))))))))))).
