...
thf(ccvbr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) <=> ((cwpss @ XA2 @ XB2) & (cwral @ (^ [Xx3:$i] : (((cwpss @ XA2 @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XB2)) => ((ccv @ Xx3) = XB2))) @ (^ [Xx3:$i] : ccch)))))))).
