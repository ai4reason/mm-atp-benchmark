...
thf(cswrdco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & ((cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) & (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr)) = (cco @ (cccom @ XF @ XW) @ (ccop @ XM @ XN) @ ccsubstr)))))))))).
