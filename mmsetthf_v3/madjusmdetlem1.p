...
thf(amaducoevalmin1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((XJ = (cco @ XN @ XR @ ccmadu)) => (((cwcel @ XM @ XB2) & (cwcel @ XI @ XN) & (cwcel @ XH @ XN)) => ((cco @ XI @ XH @ (ccfv @ XM @ XJ)) = (ccfv @ (cco @ XH @ XI @ (ccfv @ XM @ (cco @ XN @ XR @ ccminmar1))) @ XD))))))))))))))))).
...
thf(aminmar1cl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) & ((cwcel @ XK @ XN) & (cwcel @ XL @ XN))) => (cwcel @ (cco @ XK @ XL @ (ccfv @ XM @ (cco @ XN @ XR @ ccminmar1))) @ XB2)))))))))))).
...
thf(aminmar1eval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XQ = (cco @ XN @ XR @ ccminmar1)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XM @ XB2) & ((cwcel @ XK @ XN) & (cwcel @ XL @ XN)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XK @ XL @ (ccfv @ XM @ XQ))) = (ccif @ (XI = XK) @ (ccif @ (XJ = XL) @ Xc_1 @ Xc_0) @ (cco @ XI @ XJ @ XM)))))))))))))))))))))).
...
thf(amarrepval_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XB2 @ Xi @ Xj) = (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XQ @ Xi @ Xj) = (cco @ XN @ XR @ ccmarrep)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_0 @ Xi @ Xj) = (ccfv @ XR @ cc0g)))) => (! [Xi:$i] : (! [Xj:$i] : ((((cwcel @ XM @ (XB2 @ Xi @ Xj)) & (cwcel @ XS @ (ccfv @ XR @ ccbs))) & ((cwcel @ XK @ XN) & (cwcel @ XL @ XN))) => ((cco @ XK @ XL @ (cco @ XM @ XS @ (XQ @ Xi @ Xj))) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XK) @ (ccif @ ((ccv @ Xj) = XL) @ XS @ (Xc_0 @ Xi @ Xj)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM)))))))))))))))))))))))).
...
thf(asubmabas_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (XB2 = (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => (((cwcel @ XM @ XB2) & (cwss @ XD @ XN)) => (cwcel @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XD)) @ (^ [Xi:$i] : (^ [Xj:$i] : XD)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM)))) @ (ccfv @ (cco @ XD @ XR @ ccmat) @ ccbs)))))))))))).
thf(amdetcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => (cwcel @ (ccfv @ XM @ XD) @ XK)))))))))))))).
...
thf(asmadiadetr_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XR @ cccrg) & (cwcel @ XM @ (ccfv @ (cco @ XN @ XR @ ccmat) @ ccbs))) & ((cwcel @ XK @ XN) & (cwcel @ XS @ (ccfv @ XR @ ccbs)))) => ((ccfv @ (cco @ XK @ XK @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ (cco @ XN @ XR @ ccmdat)) = (cco @ XS @ (ccfv @ (cco @ XK @ XK @ (ccfv @ XM @ (cco @ XN @ XR @ ccsubma))) @ (cco @ (ccdif @ XN @ (ccsn @ XK)) @ XR @ ccmdat)) @ (ccfv @ XR @ ccmulr)))))))))).
...
thf(cmadjusmdetlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (XB2 = (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmdat)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XK @ Xi @ Xj) = (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmadu)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_x @ Xi @ Xj) = (ccfv @ XR @ ccmulr)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XZ @ Xi @ Xj) = (ccfv @ XR @ cczrh)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XE @ Xi @ Xj) = (cco @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ XR @ ccmdat)))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XI @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XJ @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XM @ XB2)) => ((XG = (ccfv @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccsymg) @ ccbs)) => ((! [Xi:$i] : (! [Xj:$i] : ((XS @ Xi @ Xj) = (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccpsgn)))) => ((XU = (cco @ XI @ XJ @ (ccfv @ XM @ (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccminmar1)))) => ((XW = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ XN @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ XN @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XQ) @ XU))))) => ((Xph => (cwcel @ XP @ XG)) => ((Xph => (cwcel @ XQ @ XG)) => ((Xph => ((ccfv @ XN @ XP) = XI)) => ((Xph => ((ccfv @ XN @ XQ) = XJ)) => ((Xph => ((cco @ XI @ XJ @ (ccfv @ XU @ ccsmat)) = (cco @ XN @ XN @ (ccfv @ XW @ ccsmat)))) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((cco @ XJ @ XI @ (ccfv @ XM @ (XK @ Xi @ Xj))) = (cco @ (ccfv @ (cco @ (ccfv @ XP @ (XS @ Xi @ Xj)) @ (ccfv @ XQ @ (XS @ Xi @ Xj)) @ ccmul) @ (XZ @ Xi @ Xj)) @ (ccfv @ (cco @ XI @ XJ @ (ccfv @ XM @ ccsmat)) @ (XE @ Xi @ Xj)) @ (Xc_x @ Xi @ Xj))))))))))))))))))))))))))))))))))))))))))))))).
