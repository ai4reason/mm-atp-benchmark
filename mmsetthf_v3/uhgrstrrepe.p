...
thf(cuhgrstrrepe_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ ccnx @ ccedgf)) => ((Xph => (cwbr @ XG @ XX @ ccstr)) => ((Xph => (cwcel @ (ccfv @ ccnx @ ccbs) @ (ccdm @ XG))) => ((Xph => (cwcel @ XE @ XW)) => ((Xph => (cwf @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)) => (Xph => (cwcel @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ ccuhgr)))))))))))))))).
