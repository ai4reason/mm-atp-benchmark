...
thf(acidpropd_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => ((ccfv @ XC @ cchomf) = (ccfv @ XD @ cchomf))) => ((Xph => ((ccfv @ XC @ cccomf) = (ccfv @ XD @ cccomf))) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (cwcel @ XD @ XW)) => (Xph => ((ccfv @ XC @ cccid) = (ccfv @ XD @ cccid))))))))))))).
