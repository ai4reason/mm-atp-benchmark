...
thf(asxbrsigalem0_thm,axiom,((ccuni @ (ccun @ (ccrn @ (ccmpt @ (^ [Xe:$i] : ccr) @ (^ [Xe:$i] : (ccxp @ (cco @ (ccv @ Xe) @ ccpnf @ ccico) @ ccr)))) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : ccr) @ (^ [Xf1:$i] : (ccxp @ ccr @ (cco @ (ccv @ Xf1) @ ccpnf @ ccico))))))) = (ccxp @ ccr @ ccr))).
thf(aunicls_thm,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ cctop) => ((XX = (ccuni @ XJ)) => ((ccuni @ (ccfv @ XJ @ cccld)) = XX)))))).
...
thf(atxcld_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XR @ cccld)) & (cwcel @ XB2 @ (ccfv @ XS @ cccld))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (ccfv @ (cco @ XR @ XS @ cctx) @ cccld)))))))).
...
thf(csxbrsigalem3_conj,conjecture,(! [XJ:($i > ($i > ($i > $o)))] : ((! [Xe:$i] : (! [Xf1:$i] : ((XJ @ Xe @ Xf1) = (ccfv @ (ccrn @ ccioo) @ cctg)))) => (! [Xe:$i] : (! [Xf1:$i] : (cwss @ (ccfv @ (ccun @ (ccrn @ (ccmpt @ (^ [Xe:$i] : ccr) @ (^ [Xe:$i] : (ccxp @ (cco @ (ccv @ Xe) @ ccpnf @ ccico) @ ccr)))) @ (ccrn @ (ccmpt @ (^ [Xf1:$i] : ccr) @ (^ [Xf1:$i] : (ccxp @ ccr @ (cco @ (ccv @ Xf1) @ ccpnf @ ccico)))))) @ ccsigagen) @ (ccfv @ (ccfv @ (cco @ (XJ @ Xe @ Xf1) @ (XJ @ Xe @ Xf1) @ cctx) @ cccld) @ ccsigagen))))))).
