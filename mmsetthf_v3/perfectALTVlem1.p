...
thf(cperfectALTVlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccodd)) => ((Xph => ((cco @ cc1 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccsgm) = (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccmul))) => (Xph => ((cwcel @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ ccn) & (cwcel @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccn) & (cwcel @ (cco @ XB2 @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccdiv) @ ccn))))))))))).
