...
thf(arabxfrd_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xy1) @ XD)) => (cwcel @ (XA2 @ Xy1) @ XD)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XB2 @ Xx3 @ Xy1)) => ((XA2 @ Xy1) = (XC @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3) & (cwcel @ (XB2 @ Xx3 @ Xy1) @ XD)) => ((cwcel @ (XC @ Xx3 @ Xy1) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XD))) <=> (cwcel @ (XB2 @ Xx3 @ Xy1) @ (ccrab @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XD)))))))))))))))))))).
...
thf(criotaxfrd_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnfc @ (^ [Xy1:$i] : (XC @ Xy1))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XA2)) => (cwcel @ (XB2 @ Xy1) @ XA2))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccrio @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XA2)) @ XA2)) => (cwcel @ (XC @ Xy1) @ XA2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XB2 @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xy1:$i] : (((ccv @ Xy1) = (ccrio @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XA2))) => ((XB2 @ Xy1) = (XC @ Xy1)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwreu @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) => (! [Xy1:$i] : ((Xph & (cwreu @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2))) => ((ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) = (XC @ Xy1))))))))))))))))).
