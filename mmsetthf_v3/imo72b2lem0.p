...
thf(aleeq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwbr @ XA2 @ XC @ ccle)) => ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => (cwbr @ XB2 @ XC @ ccle))))))))))).
thf(awwlemuld_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccle)) => ((Xph => (cwbr @ ccc0 @ XC @ cclt)) => (Xph => (cwbr @ XA2 @ XB2 @ ccle)))))))))))).
...
thf(aleeq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwbr @ XA2 @ XC @ ccle)) => ((Xph => (XC = XD)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => (cwbr @ XA2 @ XD @ ccle))))))))))).
...
thf(afvco3d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((Xph => (cwcel @ XC @ XA2)) => (Xph => ((ccfv @ XC @ (cccom @ XF @ XG)) = (ccfv @ (ccfv @ XC @ XG) @ XF)))))))))))).
thf(aeleqtrrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((Xph => (XC = XB2)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(awfximgfd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XC @ XA2)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => (Xph => (cwcel @ (ccfv @ XC @ XF) @ (ccima @ XF @ XA2))))))))))).
thf(aeqcomd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => (XB2 = XA2))))))).
thf(a_2timesd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => ((cco @ cc2 @ XA2 @ ccmul) = (cco @ XA2 @ XA2 @ ccaddc))))))).
thf(aabsmulrposd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccabs) = (cco @ XA2 @ (ccfv @ XB2 @ ccabs) @ ccmul)))))))))).
