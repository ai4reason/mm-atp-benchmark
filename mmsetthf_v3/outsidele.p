...
thf(coutsidele_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XP @ (ccfv @ XN @ ccee)) & (cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee)))) => ((cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof) => ((cwbr @ (ccop @ XP @ XA2) @ (ccop @ XP @ XB2) @ ccsegle) <=> (cwbr @ XA2 @ (ccop @ XP @ XB2) @ ccbtwn))))))))).
