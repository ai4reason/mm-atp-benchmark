...
thf(adominf_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((XA2 != cc0) & (cwss @ XA2 @ (ccuni @ XA2))) => (cwbr @ ccom @ XA2 @ ccdom))))).
...
thf(ainfdif2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) => ((cwbr @ (ccdif @ XA2 @ XB2) @ XB2 @ ccdom) <=> (cwbr @ XA2 @ XB2 @ ccdom)))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) <=> ((Xph & Xps) & Xch)))))).
thf(caxgroth3_conj,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) & (cwrex @ (^ [Xw:$i] : (! [Xv:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xv) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) & (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccdif @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
