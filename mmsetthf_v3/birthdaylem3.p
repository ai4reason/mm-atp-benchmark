...
thf(abirthdaylem2_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XT @ Xf1 @ Xk) = (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1)))))) => (! [Xf1:$i] : (! [Xk:$i] : (((cwcel @ XN @ ccn) & (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz))) => ((cco @ (ccfv @ (XT @ Xf1 @ Xk) @ cchash) @ (ccfv @ (XS @ Xf1 @ Xk) @ cchash) @ ccdiv) = (ccfv @ (ccsu @ (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xk) @ XN @ ccdiv) @ ccmin) @ cclog))) @ cce)))))))))))).
...
thf(aarisum2_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (ccv @ Xk))) = (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ XN @ ccmin) @ cc2 @ ccdiv))))).
...
thf(cbirthdaylem3_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (^ [Xf1:$i] : (cwf @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => ((! [Xf1:$i] : ((XT @ Xf1) = (^ [Xf1:$i] : (cwf1 @ (cco @ cc1 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) => (! [Xf1:$i] : (((cwcel @ XK @ ccn0) & (cwcel @ XN @ ccn)) => (cwbr @ (cco @ (ccfv @ (XT @ Xf1) @ cchash) @ (ccfv @ (XS @ Xf1) @ cchash) @ ccdiv) @ (ccfv @ (ccneg @ (cco @ (cco @ (cco @ (cco @ XK @ cc2 @ ccexp) @ XK @ ccmin) @ cc2 @ ccdiv) @ XN @ ccdiv)) @ cce) @ ccle)))))))))).
