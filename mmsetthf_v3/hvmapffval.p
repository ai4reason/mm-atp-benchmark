...
thf(adf_hvmap_ax,axiom,(cchvm = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccmpt @ (^ [Xx3:$i] : (ccdif @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ ccbs) @ (ccsn @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ cc0g)))) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xv:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ ccbs)) @ (^ [Xv:$i] : (ccrio @ (^ [Xj:$i] : (cwrex @ (^ [Xt:$i] : ((ccv @ Xv) = (cco @ (ccv @ Xt) @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ ccvsca)) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ ccplusg)))) @ (^ [Xt:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccoch)))))) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ ccsca) @ ccbs))))))))))))).
thf(amptex_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(chvmapffval_conj,conjecture,(! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xj:$i] : ((XH @ Xx3 @ Xv @ Xt @ Xj) = (ccfv @ XK @ cclh)))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xj:$i] : ((cwcel @ XK @ (XX @ Xx3 @ Xw @ Xv @ Xt @ Xj)) => ((ccfv @ XK @ cchvm) = (ccmpt @ (^ [Xw:$i] : (XH @ Xx3 @ Xv @ Xt @ Xj)) @ (^ [Xw:$i] : (ccmpt @ (^ [Xx3:$i] : (ccdif @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ ccbs) @ (ccsn @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ cc0g)))) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xv:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ ccbs)) @ (^ [Xv:$i] : (ccrio @ (^ [Xj:$i] : (cwrex @ (^ [Xt:$i] : ((ccv @ Xv) = (cco @ (ccv @ Xt) @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ ccvsca)) @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ ccplusg)))) @ (^ [Xt:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccoch)))))) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ ccsca) @ ccbs))))))))))))))))))))).
