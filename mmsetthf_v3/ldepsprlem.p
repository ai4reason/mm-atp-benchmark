...
thf(cldepsprlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XS = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XZ = (ccfv @ XM @ cc0g)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XN = (ccfv @ XR @ ccminusg)) => (((cwcel @ XM @ cclmod) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XA2 @ XS))) => ((XX = (cco @ XA2 @ XY @ Xc_x)) => ((cco @ (cco @ Xc_1 @ XX @ Xc_x) @ (cco @ (ccfv @ XA2 @ XN) @ XY @ Xc_x) @ (ccfv @ XM @ ccplusg)) = XZ)))))))))))))))))))))))).
