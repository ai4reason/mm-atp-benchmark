...
thf(aprsref_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => (((cwcel @ XK @ ccpreset) & (cwcel @ XX @ XB2)) => (cwbr @ XX @ XX @ Xc_le))))))))).
...
thf(cprsrn_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => ((cwcel @ XK @ ccpreset) => ((ccrn @ Xc_le) = XB2)))))))).
