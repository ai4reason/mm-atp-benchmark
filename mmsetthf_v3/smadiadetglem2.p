...
thf(csmadiadetglem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((cwcel @ XR @ cccrg) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((XE = (cco @ (ccdif @ XN @ (ccsn @ XK)) @ XR @ ccmdat)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XM @ XB2) & (cwcel @ XK @ XN) & (cwcel @ XS @ (ccfv @ XR @ ccbs))) => ((ccres @ (cco @ XK @ XK @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ (ccxp @ (ccsn @ XK) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ XK) @ XN) @ (ccsn @ XS)) @ (ccres @ (cco @ XK @ XK @ (ccfv @ XM @ (cco @ XN @ XR @ ccminmar1))) @ (ccxp @ (ccsn @ XK) @ XN)) @ (ccof @ Xc_x))))))))))))))))))))).
