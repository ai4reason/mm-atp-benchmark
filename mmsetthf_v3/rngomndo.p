...
thf(crngomndo_conj,conjecture,(! [XR:($i > $o)] : (! [XH:($i > $o)] : ((XH = (ccfv @ XR @ cc2nd)) => ((cwcel @ XR @ ccrngo) => (cwcel @ XH @ ccmndo)))))).
