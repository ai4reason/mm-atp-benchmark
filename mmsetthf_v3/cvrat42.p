...
thf(ccvrat42_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((! [Xr:$i] : ((Xc_0 @ Xr) = (ccfv @ XK @ ccp0))) => ((XA2 = (ccfv @ XK @ ccatm)) => (! [Xr:$i] : (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XB2) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2))) => (((XX != (Xc_0 @ Xr)) & (cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le)) => (cwrex @ (^ [Xr:$i] : ((cwbr @ (ccv @ Xr) @ XX @ Xc_le) & (cwbr @ XP @ (cco @ (ccv @ Xr) @ XQ @ Xc_or) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))))))).
