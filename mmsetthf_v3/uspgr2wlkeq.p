...
thf(cuspgr2wlkeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccuspgr) & ((cwcel @ XA2 @ (ccfv @ XG @ ccwlks)) & (cwcel @ XB2 @ (ccfv @ XG @ ccwlks))) & (XN = (ccfv @ (ccfv @ XA2 @ cc1st) @ cchash))) => ((XA2 = XB2) <=> ((XN = (ccfv @ (ccfv @ XB2 @ cc1st) @ cchash)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccfv @ XA2 @ cc2nd)) = (ccfv @ (ccv @ Xy1) @ (ccfv @ XB2 @ cc2nd)))) @ (^ [Xy1:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))).
