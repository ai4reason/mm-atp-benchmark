...
thf(clhpexle1lem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (Xps @ Xp))) @ (^ [Xp:$i] : XA2))) => (((Xph & ((cwcel @ XX @ XA2) & (cwbr @ XX @ XW @ Xc_le))) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (Xps @ Xp) & ((ccv @ Xp) != XX))) @ (^ [Xp:$i] : XA2))) => (Xph => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (Xps @ Xp) & ((ccv @ Xp) != XX))) @ (^ [Xp:$i] : XA2)))))))))))).
