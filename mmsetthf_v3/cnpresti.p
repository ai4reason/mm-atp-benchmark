...
thf(ccnpresti_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwss @ XA2 @ XX) & (cwcel @ XP @ XA2) & (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp)))) => (cwcel @ (ccres @ XF @ XA2) @ (ccfv @ XP @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccnp)))))))))))).
