...
thf(ao1add2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ (XV @ Xx3)))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ cco1)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccaddc))) @ cco1)))))))))))).
...
thf(adchrmusumlema_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : ((XZ @ Xt @ Xa @ Xc) = (ccfv @ (XN @ Xa) @ cczn))))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : (XL = (ccfv @ (XZ @ Xt @ Xa @ Xc) @ cczrh))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XN @ Xa) @ ccn)))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : ((XG @ Xy1 @ Xt @ Xa @ Xc) = (ccfv @ (XN @ Xa) @ ccdchr)))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : ((XD @ Xa) = (ccfv @ (XG @ Xy1 @ Xt @ Xa @ Xc) @ ccbs)))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : ((Xc_1 @ Xa) = (ccfv @ (XG @ Xy1 @ Xt @ Xa @ Xc) @ cc0g)))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ XX @ (XD @ Xa))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (XX != (Xc_1 @ Xa))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccv @ Xa) @ ccdiv))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (? [Xt:$i] : (cwrex @ (^ [Xc:$i] : ((cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (ccv @ Xt) @ ccli) & (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (ccv @ Xt) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xc) @ (ccv @ Xy1) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico))))) @ (^ [Xc:$i] : (cco @ ccc0 @ ccpnf @ ccico)))))))))))))))))))))))))).
...
thf(arlimdm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => (Xph => ((cwcel @ XF @ (ccdm @ ccrli)) <=> (cwbr @ XF @ (ccfv @ XF @ ccrli) @ ccrli))))))))).
...
thf(adchrisum0lem1_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (! [Xd:$i] : ((XZ @ Xa @ Xd) = (ccfv @ (XN @ Xa @ Xd) @ cczn)))) => ((! [Xa:$i] : (! [Xd:$i] : (XL = (ccfv @ (XZ @ Xa @ Xd) @ cczrh)))) => ((! [Xy1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XN @ Xa @ Xd) @ ccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) = (ccfv @ (XN @ Xa @ Xd) @ ccdchr))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XD @ Xa @ Xd) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xc_1 @ Xa @ Xd) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) @ cc0g))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XW @ Xy1 @ Xm @ Xa @ Xd) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ (XD @ Xa @ Xd) @ (ccsn @ (Xc_1 @ Xa @ Xd)))))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ XX @ (XW @ Xy1 @ Xm @ Xa @ Xd))))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccfv @ (ccv @ Xa) @ ccsqrt) @ ccdiv))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XC @ Xa) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (XS @ Xa) @ ccli)))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (XS @ Xa) @ ccmin) @ ccabs) @ (cco @ (XC @ Xa) @ (ccfv @ (ccv @ Xy1) @ ccsqrt) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ ccfl) @ cc1 @ ccaddc) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (ccv @ Xm) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ XX) @ (ccfv @ (ccv @ Xm) @ ccsqrt) @ ccdiv) @ (ccfv @ (ccv @ Xd) @ ccsqrt) @ ccdiv))))))) @ cco1))))))))))))))))))))))))))))).
...
thf(cdchrisum0lem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (! [Xd:$i] : ((XZ @ Xa @ Xd) = (ccfv @ (XN @ Xa @ Xd) @ cczn)))) => ((! [Xa:$i] : (! [Xd:$i] : (XL = (ccfv @ (XZ @ Xa @ Xd) @ cczrh)))) => ((! [Xy1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XN @ Xa @ Xd) @ ccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) = (ccfv @ (XN @ Xa @ Xd) @ ccdchr))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XD @ Xa @ Xd) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xc_1 @ Xa @ Xd) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) @ cc0g))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XW @ Xy1 @ Xm @ Xa @ Xd) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ (XD @ Xa @ Xd) @ (ccsn @ (Xc_1 @ Xa @ Xd)))))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ XX @ (XW @ Xy1 @ Xm @ Xa @ Xd))))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccfv @ (ccv @ Xa) @ ccsqrt) @ ccdiv))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XC @ Xa) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (XS @ Xa) @ ccli)))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (XS @ Xa) @ ccmin) @ ccabs) @ (cco @ (XC @ Xa) @ (ccfv @ (ccv @ Xy1) @ ccsqrt) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (ccv @ Xm) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ XX) @ (ccfv @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccsqrt) @ ccdiv))))))) @ cco1))))))))))))))))))))))))))))).
