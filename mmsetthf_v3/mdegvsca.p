...
thf(cmdegvsca_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XI @ XR @ ccmpl)) => ((XD = (cco @ XI @ XR @ ccmdg)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xph => (cwcel @ XF @ XE)) => ((Xph => (cwcel @ XG @ XB2)) => (Xph => ((ccfv @ (cco @ XF @ XG @ Xc_x) @ XD) = (ccfv @ XG @ XD)))))))))))))))))))))))).
