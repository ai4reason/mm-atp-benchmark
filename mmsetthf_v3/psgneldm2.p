...
thf(asymggen_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XG = (ccfv @ XD @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubmnd) @ ccmrc)) => ((cwcel @ XD @ XV) => ((ccfv @ XT @ XK) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xx3) @ ccid)) @ ccfn)) @ (^ [Xx3:$i] : XB2))))))))))))))).
