...
thf(agrpodivfval_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XN = (ccfv @ XG @ ccgn)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccfv @ XG @ ccgs)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XG @ ccgr) => ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XN) @ XG)))))))))))))))).
...
thf(cnvmfval_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XG = (ccfv @ XU @ ccpv)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccfv @ XU @ ccns)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XM @ Xx3 @ Xy1) = (ccfv @ XU @ ccnsb)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XU @ ccnv) => ((XM @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccneg @ cc1) @ (ccv @ Xy1) @ (XS @ Xx3 @ Xy1)) @ XG)))))))))))))))))).
