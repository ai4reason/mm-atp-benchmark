...
thf(appiprm_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime)) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccppi) = (cco @ (ccfv @ XA2 @ ccppi) @ cc1 @ ccaddc))))).
...
thf(appinprm_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (~ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccppi) = (ccfv @ XA2 @ ccppi))))).
...
thf(cppip1le_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccppi) @ (cco @ (ccfv @ XA2 @ ccppi) @ cc1 @ ccaddc) @ ccle)))).
