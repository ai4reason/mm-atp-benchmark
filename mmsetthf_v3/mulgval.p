...
thf(cmulgval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XI = (ccfv @ XG @ ccminusg)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XS = (ccseq @ Xc_pl @ (ccxp @ ccn @ (ccsn @ XX)) @ cc1)) => (((cwcel @ XN @ ccz) & (cwcel @ XX @ XB2)) => ((cco @ XN @ XX @ Xc_x) = (ccif @ (XN = ccc0) @ Xc_0 @ (ccif @ (cwbr @ ccc0 @ XN @ cclt) @ (ccfv @ XN @ XS) @ (ccfv @ (ccfv @ (ccneg @ XN) @ XS) @ XI))))))))))))))))))))).
