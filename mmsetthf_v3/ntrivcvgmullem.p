...
thf(cntrivcvgmullem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : ((XZ @ Xw) = (ccfv @ (XM @ Xw @ Xk @ Xq) @ ccuz))))) => ((! [Xw:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => (cwcel @ (XN @ Xw @ Xq) @ (XZ @ Xw))))) => ((! [Xw:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => (cwcel @ XP @ (XZ @ Xw))))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => ((XX @ Xw @ Xk @ Xq) != ccc0))))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => ((XY @ Xk @ Xq) != ccc0))))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => (cwbr @ (ccseq @ ccmul @ (XF @ Xq) @ (XN @ Xw @ Xq)) @ (XX @ Xw @ Xk @ Xq) @ ccli))))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => (cwbr @ (ccseq @ ccmul @ (XG @ Xw @ Xq) @ XP) @ (XY @ Xk @ Xq) @ ccli))))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : (((Xph @ Xw @ Xq) & (cwcel @ (ccv @ Xk) @ (XZ @ Xw))) => (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xq)) @ ccc))))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : (((Xph @ Xw @ Xq) & (cwcel @ (ccv @ Xk) @ (XZ @ Xw))) => (cwcel @ (ccfv @ (ccv @ Xk) @ (XG @ Xw @ Xq)) @ ccc))))) => ((! [Xw:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => (cwbr @ (XN @ Xw @ Xq) @ XP @ ccle)))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xq:$i] : (((Xph @ Xw @ Xq) & (cwcel @ (ccv @ Xk) @ (XZ @ Xw))) => ((ccfv @ (ccv @ Xk) @ XH) = (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xq)) @ (ccfv @ (ccv @ Xk) @ (XG @ Xw @ Xq)) @ ccmul)))))) => (! [Xw:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xq) => (cwrex @ (^ [Xq:$i] : (? [Xw:$i] : (((ccv @ Xw) != ccc0) & (cwbr @ (ccseq @ ccmul @ XH @ (ccv @ Xq)) @ (ccv @ Xw) @ ccli)))) @ (^ [Xq:$i] : (XZ @ Xw)))))))))))))))))))))))))))).
