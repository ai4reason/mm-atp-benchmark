...
thf(af1dom3el3dif_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => ((cwcel @ XA2 @ (XX @ Xx3 @ Xy1 @ Xz)) & (cwcel @ XB2 @ (XY @ Xx3 @ Xy1 @ Xz)) & (cwcel @ XC @ (XZ @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => ((XA2 != XB2) & (XA2 != XC) & (XB2 != XC)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => (cwf1 @ (cctp @ XA2 @ XB2 @ XC) @ XR @ XF))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & ((ccv @ Xx3) != (ccv @ Xz)) & ((ccv @ Xy1) != (ccv @ Xz)))) @ (^ [Xz:$i] : XR))) @ (^ [Xy1:$i] : XR))) @ (^ [Xx3:$i] : XR))))))))))))))))))).
thf(anecomd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 != XB2)) => (Xph => (XB2 != XA2))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(chashge3el3dif_conj,conjecture,(! [XD:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XD @ (XV @ Xx3 @ Xy1 @ Xz)) & (cwbr @ cc3 @ (ccfv @ XD @ cchash) @ ccle)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & ((ccv @ Xx3) != (ccv @ Xz)) & ((ccv @ Xy1) != (ccv @ Xz)))) @ (^ [Xz:$i] : XD))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD))))))))).
