...
thf(csegcon2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XQ @ (ccfv @ XN @ ccee)) & (cwcel @ XA2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XB2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee)))) => (cwrex @ (^ [Xx3:$i] : (((cwbr @ XA2 @ (ccop @ XQ @ (ccv @ Xx3)) @ ccbtwn) | (cwbr @ (ccv @ Xx3) @ (ccop @ XQ @ XA2) @ ccbtwn)) & (cwbr @ (ccop @ XQ @ (ccv @ Xx3)) @ (ccop @ XB2 @ XC) @ cccgr))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee)))))))))).
