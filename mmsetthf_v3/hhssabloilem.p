...
thf(aisgrpoi_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwf @ (ccxp @ XX @ XX) @ XX @ XG) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX) & (cwcel @ (ccv @ Xz) @ XX)) => ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG)))))) => ((cwcel @ XU @ XX) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XX) => ((cco @ XU @ (ccv @ Xx3) @ XG) = (ccv @ Xx3)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((cwcel @ (ccv @ Xx3) @ XX) => (cwcel @ (XN @ Xx3 @ Xz) @ XX)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((cwcel @ (ccv @ Xx3) @ XX) => ((cco @ (XN @ Xx3 @ Xz) @ (ccv @ Xx3) @ XG) = XU)))) => (cwcel @ XG @ ccgr))))))))))))).
...
thf(acurry1val_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XC) @ ccvv))))) => (((cwfn @ XF @ (ccxp @ XA2 @ XB2)) & (cwcel @ XC @ XA2)) => ((ccfv @ XD @ XG) = (cco @ XC @ XD @ XF))))))))))).
...
thf(chhssabloilem_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) => ((cwcel @ ccva @ ccgr) & (cwcel @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ ccgr) & (cwss @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ ccva))))).
