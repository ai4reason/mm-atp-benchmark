...
thf(cringccofval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccringc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xc_x = (ccfv @ XC @ ccco)) => (Xph => (Xc_x = (ccfv @ (ccfv @ XU @ ccestrc) @ ccco)))))))))))).
