...
thf(chlrelat5N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xp:$i] : ((Xc_lt @ Xp) = (ccfv @ XK @ ccplt))) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => (! [Xp:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & (cwbr @ XX @ XY @ (Xc_lt @ Xp))) => (cwrex @ (^ [Xp:$i] : ((cwbr @ XX @ (cco @ XX @ (ccv @ Xp) @ (Xc_or @ Xp)) @ (Xc_lt @ Xp)) & (cwbr @ (ccv @ Xp) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2)))))))))))))))))).
