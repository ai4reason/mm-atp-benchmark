...
thf(cabsdiflt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ cclt) <=> ((cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ cclt) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))).
