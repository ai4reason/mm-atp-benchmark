...
thf(crpnnen3lem_conj,conjecture,(! [Xa:$i] : (! [Xb:$i] : ((((cwcel @ (ccv @ Xa) @ ccr) & (cwcel @ (ccv @ Xb) @ ccr)) & (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ cclt)) => ((ccrab @ (^ [Xc:$i] : (cwbr @ (ccv @ Xc) @ (ccv @ Xa) @ cclt)) @ (^ [Xc:$i] : ccq)) != (ccrab @ (^ [Xc:$i] : (cwbr @ (ccv @ Xc) @ (ccv @ Xb) @ cclt)) @ (^ [Xc:$i] : ccq))))))).
