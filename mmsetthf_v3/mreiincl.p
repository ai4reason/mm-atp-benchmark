...
thf(cmreiincl_conj,conjecture,(! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (XI != cc0) & (cwral @ (^ [Xy1:$i] : (cwcel @ (XS @ Xy1) @ XC)) @ (^ [Xy1:$i] : XI))) => (cwcel @ (cciin @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (XS @ Xy1))) @ XC))))))).
