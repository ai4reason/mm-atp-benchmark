...
thf(anmfval_thm,axiom,(! [XD:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XW @ ccnm))) => ((XX = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XD = (ccfv @ XW @ ccds)) => (! [Xx3:$i] : ((XN @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_0 @ XD))))))))))))))).
