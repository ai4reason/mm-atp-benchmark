...
thf(cabelth2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((Xph => (cwf @ ccn0 @ ccc @ XA2)) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli))) => ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XF @ Xx3 @ Xn) @ (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ ccc @ cccncf)))))))))))).
