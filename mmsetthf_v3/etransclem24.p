...
thf(cetransclem24_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xc) => (cwcel @ (XP @ Xn @ Xc) @ ccn)))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XM @ ccn0))) => ((! [Xj:$i] : (! [Xc:$i] : ((Xph @ Xc) => (cwcel @ (XI @ Xj) @ ccn0)))) => ((! [Xj:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xc) => ((XI @ Xj) != (cco @ (XP @ Xn @ Xc) @ cc1 @ ccmin)))))) => ((! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xc) => ((XJ @ Xn @ Xc) = ccc0)))) => ((! [Xj:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xj @ Xn @ Xc) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccrab @ (^ [Xc:$i] : ((ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (ccv @ Xc)))) = (ccv @ Xn))) @ (^ [Xc:$i] : (cco @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (cco @ ccc0 @ XM @ ccfz) @ ccmap))))))))) => ((! [Xj:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xc) => (cwcel @ (XD @ Xn) @ (ccfv @ (XI @ Xj) @ (XC @ Xj @ Xn @ Xc))))))) => (! [Xj:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xc) => (cwbr @ (XP @ Xn @ Xc) @ (cco @ (cco @ (cco @ (ccfv @ (XI @ Xj) @ ccfa) @ (ccprod @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (XD @ Xn)) @ ccfa))) @ ccdiv) @ (cco @ (ccif @ (cwbr @ (cco @ (XP @ Xn @ Xc) @ cc1 @ ccmin) @ (ccfv @ ccc0 @ (XD @ Xn)) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ (XP @ Xn @ Xc) @ cc1 @ ccmin) @ ccfa) @ (ccfv @ (cco @ (cco @ (XP @ Xn @ Xc) @ cc1 @ ccmin) @ (ccfv @ ccc0 @ (XD @ Xn)) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (XJ @ Xn @ Xc) @ (cco @ (cco @ (XP @ Xn @ Xc) @ cc1 @ ccmin) @ (ccfv @ ccc0 @ (XD @ Xn)) @ ccmin) @ ccexp) @ ccmul)) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccif @ (cwbr @ (XP @ Xn @ Xc) @ (ccfv @ (ccv @ Xj) @ (XD @ Xn)) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (XP @ Xn @ Xc) @ ccfa) @ (ccfv @ (cco @ (XP @ Xn @ Xc) @ (ccfv @ (ccv @ Xj) @ (XD @ Xn)) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ (XJ @ Xn @ Xc) @ (ccv @ Xj) @ ccmin) @ (cco @ (XP @ Xn @ Xc) @ (ccfv @ (ccv @ Xj) @ (XD @ Xn)) @ ccmin) @ ccexp) @ ccmul)))) @ ccmul) @ ccmul) @ (ccfv @ (cco @ (XP @ Xn @ Xc) @ cc1 @ ccmin) @ ccfa) @ ccdiv) @ ccdvds)))))))))))))))))))).
