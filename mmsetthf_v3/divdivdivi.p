...
thf(cdivdivdivi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwcel @ XD @ ccc) => ((XB2 != ccc0) => ((XD != ccc0) => ((XC != ccc0) => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccdiv) = (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccdiv)))))))))))))).
