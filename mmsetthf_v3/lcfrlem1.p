...
thf(clcfrlem1_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XU @ ccbs)) => ((XS = (ccfv @ XU @ ccsca)) => ((Xc_xp = (ccfv @ XS @ ccmulr)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XI = (ccfv @ XS @ ccinvr)) => ((XF = (ccfv @ XU @ cclfn)) => ((XD = (ccfv @ XU @ ccld)) => ((Xc_x = (ccfv @ XD @ ccvsca)) => ((Xc_mi = (ccfv @ XD @ ccsg)) => ((Xph => (cwcel @ XU @ cclvec)) => ((Xph => (cwcel @ XE @ XF)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => ((ccfv @ XX @ XG) != Xc_0)) => ((XH = (cco @ XE @ (cco @ (cco @ (ccfv @ (ccfv @ XX @ XG) @ XI) @ (ccfv @ XX @ XE) @ Xc_xp) @ XG @ Xc_x) @ Xc_mi)) => (Xph => ((ccfv @ XX @ XH) = Xc_0))))))))))))))))))))))))))))))))).
