...
thf(aply1bascl2_thm,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((cwcel @ XF @ XB2) => (cwcel @ XF @ (ccfv @ (cco @ cc1o @ XR @ ccmpl) @ ccbs)))))))))).
...
thf(cply1ass23l_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_xp = (ccfv @ XP @ ccmulr)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => (((cwcel @ XR @ ccrg) & ((cwcel @ XA2 @ XK) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ (cco @ XA2 @ XX @ Xc_x) @ XY @ Xc_xp) = (cco @ XA2 @ (cco @ XX @ XY @ Xc_xp) @ Xc_x)))))))))))))))))).
