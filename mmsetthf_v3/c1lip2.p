...
thf(ac1lip1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ ccc @ ccr @ ccpm))) => ((Xph => (cwcel @ (ccres @ (cco @ ccr @ XF @ ccdv) @ (cco @ XA2 @ XB2 @ ccicc)) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => (cwcel @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccicc)) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => (Xph => (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xk:$i] : ccr))))))))))))).
...
thf(aelcpn_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwss @ XS @ ccc) & (cwcel @ XN @ ccn0)) => ((cwcel @ XF @ (ccfv @ XN @ (ccfv @ XS @ cccpn))) <=> ((cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) & (cwcel @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn)) @ (cco @ (ccdm @ XF) @ ccc @ cccncf))))))))).
...
thf(apmfun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XA2 @ XB2 @ ccpm)) => (cwfun @ XF)))))).
...
thf(acpnord_thm,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XM @ ccn0) & (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwss @ (ccfv @ XN @ (ccfv @ XS @ cccpn)) @ (ccfv @ XM @ (ccfv @ XS @ cccpn)))))))).
thf(cc1lip2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (ccfv @ cc1 @ (ccfv @ ccr @ cccpn)))) => ((Xph => (cwss @ (ccrn @ XF) @ ccr)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdm @ XF))) => (Xph => (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xk:$i] : ccr))))))))))))).
