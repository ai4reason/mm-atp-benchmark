...
thf(amendlmod_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XA2 = (ccfv @ XM @ ccmend)) => ((XS = (ccfv @ XM @ ccsca)) => (((cwcel @ XM @ cclmod) & (cwcel @ XS @ cccrg)) => (cwcel @ XA2 @ cclmod)))))))).
...
thf(cmendassa_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XA2 = (ccfv @ XM @ ccmend)) => ((XS = (ccfv @ XM @ ccsca)) => (((cwcel @ XM @ cclmod) & (cwcel @ XS @ cccrg)) => (cwcel @ XA2 @ ccasa)))))))).
