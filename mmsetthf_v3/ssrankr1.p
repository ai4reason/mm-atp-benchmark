...
thf(arankr1clem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & (cwcel @ XB2 @ (ccdm @ ccr1))) => ((~ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1))) <=> (cwss @ XB2 @ (ccfv @ XA2 @ ccrnk))))))).
thf(cssrankr1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccon0) => ((cwss @ XB2 @ (ccfv @ XA2 @ ccrnk)) <=> (~ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1))))))))).
