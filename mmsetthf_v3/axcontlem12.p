...
thf(aaxcontlem11_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : (! [Xy1:$i] : ((((cwcel @ XN @ ccn) & ((cwss @ (XA2 @ Xy1) @ (ccfv @ XN @ ccee)) & (cwss @ XB2 @ (ccfv @ XN @ ccee)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XZ @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) & (((cwcel @ XZ @ (ccfv @ XN @ ccee)) & (cwcel @ XU @ (XA2 @ Xy1)) & (XB2 != cc0)) & (XZ != XU))) => (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xb) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) @ (^ [Xb:$i] : (ccfv @ XN @ ccee))))))))))).
...
thf(caxcontlem12_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : (! [Xy1:$i] : ((((cwcel @ XN @ ccn) & ((cwss @ (XA2 @ Xy1) @ (ccfv @ XN @ ccee)) & (cwss @ XB2 @ (ccfv @ XN @ ccee)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XZ @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) & (cwcel @ XZ @ (ccfv @ XN @ ccee))) => (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xb) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) @ (^ [Xb:$i] : (ccfv @ XN @ ccee)))))))))).
