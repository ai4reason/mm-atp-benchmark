...
thf(aigamval_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccigam) = (ccif @ (cwcel @ XA2 @ (ccdif @ ccz @ ccn)) @ ccc0 @ (cco @ cc1 @ (ccfv @ XA2 @ ccgam) @ ccdiv)))))).
thf(aiffalse_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ Xph) => ((ccif @ Xph @ XA2 @ XB2) = XB2)))))).
thf(cigamgam_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) => ((ccfv @ XA2 @ ccigam) = (cco @ cc1 @ (ccfv @ XA2 @ ccgam) @ ccdiv))))).
