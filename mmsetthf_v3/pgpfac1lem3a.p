...
thf(amulgdi_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccabl) & ((cwcel @ XM @ ccz) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ XM @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) = (cco @ (cco @ XM @ XX @ Xc_x) @ (cco @ XM @ XY @ Xc_x) @ Xc_pl)))))))))))))).
...
thf(agexid_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XA2 @ XX) => ((cco @ XE @ XA2 @ Xc_x) = Xc_0))))))))))))).
...
thf(cpgpfac1lem3a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((XS = (ccfv @ (ccsn @ XA2) @ XK)) => ((! [Xw:$i] : ((XB2 @ Xw) = (ccfv @ XG @ ccbs))) => ((! [Xw:$i] : ((XO @ Xw) = (ccfv @ XG @ ccod))) => ((! [Xw:$i] : ((XE @ Xw) = (ccfv @ XG @ ccgex))) => ((! [Xw:$i] : ((Xc_0 @ Xw) = (ccfv @ XG @ cc0g))) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xph => (cwbr @ XP @ XG @ ccpgp)) => ((Xph => (cwcel @ XG @ ccabl)) => ((! [Xw:$i] : (Xph => (cwcel @ (XB2 @ Xw) @ ccfn))) => ((! [Xw:$i] : (Xph => ((ccfv @ XA2 @ (XO @ Xw)) = (XE @ Xw)))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XW @ (ccfv @ XG @ ccsubg))) => ((! [Xw:$i] : (Xph => ((ccin @ XS @ XW) = (ccsn @ (Xc_0 @ Xw))))) => ((Xph => (cwss @ (cco @ XS @ XW @ Xc_po) @ XU)) => ((Xph => (cwral @ (^ [Xw:$i] : (((cwpss @ (ccv @ Xw) @ XU) & (cwcel @ XA2 @ (ccv @ Xw))) => (~ (cwpss @ (cco @ XS @ XW @ Xc_po) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccfv @ XG @ ccsubg)))) => ((Xph => (cwcel @ XC @ (ccdif @ XU @ (cco @ XS @ XW @ Xc_po)))) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((! [Xw:$i] : (Xph => (cwcel @ (XM @ Xw) @ ccz))) => ((! [Xw:$i] : (Xph => (cwcel @ (cco @ (cco @ XP @ XC @ Xc_x) @ (cco @ (XM @ Xw) @ XA2 @ Xc_x) @ (ccfv @ XG @ ccplusg)) @ XW))) => (! [Xw:$i] : (Xph => ((cwbr @ XP @ (XE @ Xw) @ ccdvds) & (cwbr @ XP @ (XM @ Xw) @ ccdvds)))))))))))))))))))))))))))))))))))))))))).
