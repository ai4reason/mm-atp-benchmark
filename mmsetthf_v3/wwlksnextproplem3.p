...
thf(awwlksm1edg_thm,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccfv @ XG @ ccwwlks)) & (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) => (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ (ccfv @ XG @ ccwwlks)))))).
