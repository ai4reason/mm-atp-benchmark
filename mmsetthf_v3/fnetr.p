...
thf(aisfne4b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ ccfne) <=> ((XX = XY) & (cwss @ (ccfv @ XA2 @ cctg) @ (ccfv @ XB2 @ cctg))))))))))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(aadantl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(cfnetr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccfne) & (cwbr @ XB2 @ XC @ ccfne)) => (cwbr @ XA2 @ XC @ ccfne)))))).
