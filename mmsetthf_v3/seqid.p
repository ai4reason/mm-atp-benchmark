...
thf(aseqfeq2_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ XK @ (ccfv @ (XM @ Xk) @ ccuz)))) => ((! [Xk:$i] : (Xph => ((ccfv @ XK @ (ccseq @ (Xc_pl @ Xk) @ XF @ (XM @ Xk))) = (ccfv @ XK @ XG)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ (cco @ XK @ cc1 @ ccaddc) @ ccuz))) => ((ccfv @ (ccv @ Xk) @ XF) = (ccfv @ (ccv @ Xk) @ XG)))) => (! [Xk:$i] : (Xph => ((ccres @ (ccseq @ (Xc_pl @ Xk) @ XF @ (XM @ Xk)) @ (ccfv @ XK @ ccuz)) = (ccseq @ (Xc_pl @ Xk) @ XG @ XK)))))))))))))).
