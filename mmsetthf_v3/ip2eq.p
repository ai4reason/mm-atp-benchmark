...
thf(cip2eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ ccphl) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((XA2 = XB2) <=> (cwral @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XA2 @ Xc_xi) = (cco @ (ccv @ Xx3) @ XB2 @ Xc_xi))) @ (^ [Xx3:$i] : XV)))))))))))).
