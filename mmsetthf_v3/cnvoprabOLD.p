...
thf(ccnvoprabOLD_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : ((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)) @ X)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xa:$i] : ((? [X:$i] : ((^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)) @ X)) => (! [X:$i] : ((^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)) @ X)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (((ccv @ Xa) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((Xps @ Xx3 @ Xy1 @ Xz @ Xa) <=> (Xph @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : ((Xps @ Xx3 @ Xy1 @ Xz @ Xa) => (cwcel @ (ccv @ Xa) @ (ccxp @ ccvv @ ccvv))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cccnv @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) = (ccopab @ (^ [Xz:$i] : (^ [Xa:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)))))))))))))).
