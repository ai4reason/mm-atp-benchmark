...
thf(aopnbnd_thm,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ XJ) <=> ((ccin @ XA2 @ (ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ cccl)))) = cc0)))))))).
