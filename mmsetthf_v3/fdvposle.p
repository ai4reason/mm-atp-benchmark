...
thf(aftc2re_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xt:$i] : ((XE @ Xt) = (cco @ (XC @ Xt) @ (XD @ Xt) @ ccioo))) => ((! [Xt:$i] : (Xph => (cwcel @ XA2 @ (XE @ Xt)))) => ((! [Xt:$i] : (Xph => (cwcel @ XB2 @ (XE @ Xt)))) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xt:$i] : (Xph => (cwf @ (XE @ Xt) @ ccc @ XF))) => ((! [Xt:$i] : (Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ (XE @ Xt) @ ccc @ cccncf)))) => (Xph => ((ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (cco @ ccr @ XF @ ccdv)))) = (cco @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccmin))))))))))))))))).
...
thf(cfdvposle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (XE = (cco @ (XC @ Xx3) @ (XD @ Xx3) @ ccioo))) => ((Xph => (cwcel @ XA2 @ XE)) => ((Xph => (cwcel @ XB2 @ XE)) => ((Xph => (cwf @ XE @ ccr @ XF)) => ((Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ XE @ ccr @ cccncf))) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccle))) => (Xph => (cwbr @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccle))))))))))))))))).
