...
thf(coutsideofrflx_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XP @ (ccfv @ XN @ ccee)) & (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((XA2 != XP) => (cwbr @ XP @ (ccop @ XA2 @ XA2) @ ccoutsideof))))))).
