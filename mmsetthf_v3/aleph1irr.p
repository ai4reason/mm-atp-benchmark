...
thf(aaleph1re_thm,axiom,(cwbr @ (ccfv @ cc1o @ ccale) @ ccr @ ccdom)).
...
thf(aresdomq_thm,axiom,(cwbr @ ccq @ ccr @ ccsdm)).
...
thf(caleph1irr_conj,conjecture,(cwbr @ (ccfv @ cc1o @ ccale) @ (ccdif @ ccr @ ccq) @ ccdom)).
