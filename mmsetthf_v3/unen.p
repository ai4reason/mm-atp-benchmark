...
thf(cunen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XC @ XD @ ccen)) & (((ccin @ XA2 @ XC) = cc0) & ((ccin @ XB2 @ XD) = cc0))) => (cwbr @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ ccen))))))).
