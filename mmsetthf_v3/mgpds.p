...
thf(amgplem_thm,axiom,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((XN != cc2) => ((ccfv @ XR @ XE) = (ccfv @ XM @ XE))))))))))).
...
thf(cmgpds_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((XB2 = (ccfv @ XR @ ccds)) => (XB2 = (ccfv @ XM @ ccds)))))))).
