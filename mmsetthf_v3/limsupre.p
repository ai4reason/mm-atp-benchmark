...
thf(climsupre_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xb:$i] : (Xph => (cwss @ (XB2 @ Xb) @ ccr))) => ((! [Xb:$i] : (Xph => ((ccsup @ (XB2 @ Xb) @ ccxr @ cclt) = ccpnf))) => ((! [Xb:$i] : (Xph => (cwf @ (XB2 @ Xb) @ ccr @ XF))) => ((Xph => (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xj) @ XF) @ ccabs) @ (ccv @ Xb) @ ccle))) @ (^ [Xj:$i] : (XB2 @ Xb)))) @ (^ [Xk:$i] : ccr))) @ (^ [Xb:$i] : ccr))) => (Xph => (cwcel @ (ccfv @ XF @ cclsp) @ ccr)))))))))).
