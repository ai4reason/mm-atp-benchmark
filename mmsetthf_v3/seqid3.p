...
thf(cseqid3_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => ((cco @ XZ @ XZ @ Xc_pl) = XZ)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) => ((ccfv @ (ccv @ Xx3) @ XF) = XZ))) => (Xph => ((ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) = XZ)))))))))))).
