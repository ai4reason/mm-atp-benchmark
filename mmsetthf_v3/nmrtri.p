...
thf(amsrtri_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccfv @ XM @ ccds)) => (((cwcel @ XM @ ccmt) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ XC @ XD) @ (cco @ XB2 @ XC @ XD) @ ccmin) @ ccabs) @ (cco @ XA2 @ XB2 @ XD) @ ccle))))))))))).
...
thf(cnmrtri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwbr @ (ccfv @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_mi) @ XN) @ ccle)))))))))))).
