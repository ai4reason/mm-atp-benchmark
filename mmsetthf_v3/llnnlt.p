...
thf(cllnnlt_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XN = (ccfv @ XK @ cclln)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XN) & (cwcel @ XY @ XN)) => (~ (cwbr @ XX @ XY @ Xc_lt))))))))))).
