...
thf(cwtgoldbnnsum4prm_conj,conjecture,((cwral @ (^ [Xm:$i] : ((cwbr @ cc5 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) => (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xd) @ cc4 @ ccle) & ((ccv @ Xn) = (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xn:$i] : (ccfv @ cc2 @ ccuz))))).
