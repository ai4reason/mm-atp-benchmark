...
thf(admin_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccdm @ (ccin @ XA2 @ XB2)) @ (ccin @ (ccdm @ XA2) @ (ccdm @ XB2)))))).
...
thf(ahauseqlcld_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (Xph => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XJ @ cccld)))))))))))).
...
thf(chauseqcn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((Xph => ((ccres @ XF @ XA2) = (ccres @ XG @ XA2))) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XX)) => (Xph => (XF = XG))))))))))))))))).
