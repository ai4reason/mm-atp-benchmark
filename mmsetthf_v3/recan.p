...
thf(crecan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cwral @ (^ [Xx3:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmul) @ ccre) = (ccfv @ (cco @ (ccv @ Xx3) @ XB2 @ ccmul) @ ccre))) @ (^ [Xx3:$i] : ccc)) <=> (XA2 = XB2)))))).
