...
thf(almhmsca_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XK = (ccfv @ XS @ ccsca)) => ((XL = (ccfv @ XT @ ccsca)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) => (XL = XK)))))))))).
...
thf(almhmlmod1_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) => (cwcel @ XS @ cclmod)))))).
...
thf(almhmlin_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XK = (ccfv @ XS @ ccsca)) => ((XB2 = (ccfv @ XK @ ccbs)) => ((XE = (ccfv @ XS @ ccbs)) => ((Xc_x = (ccfv @ XS @ ccvsca)) => ((Xc_xp = (ccfv @ XT @ ccvsca)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XE)) => ((ccfv @ (cco @ XX @ XY @ Xc_x) @ XF) = (cco @ XX @ (ccfv @ XY @ XF) @ Xc_xp))))))))))))))))))).
...
thf(aisghm_thm,axiom,(! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XS @ ccbs)) => ((XY = (ccfv @ XT @ ccbs)) => ((Xc_pl = (ccfv @ XS @ ccplusg)) => ((Xc_pd = (ccfv @ XT @ ccplusg)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) <=> (((cwcel @ XS @ ccgrp) & (cwcel @ XT @ ccgrp)) & ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ Xc_pl) @ XF) = (cco @ (ccfv @ (ccv @ Xu) @ XF) @ (ccfv @ (ccv @ Xv) @ XF) @ Xc_pd))) @ (^ [Xv:$i] : XX))) @ (^ [Xu:$i] : XX))))))))))))))))).
...
thf(aralimdvva_thm,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1)))) => ((Xps @ Xx3 @ Xy1) => (Xch @ Xx3 @ Xy1))))) => (Xph => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))).
...
thf(aislmhm3_thm,axiom,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ XS @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccfv @ XT @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XK @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XS @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XS @ ccvsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_xp @ Xx3 @ Xy1) = (ccfv @ XT @ ccvsca)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XS @ cclmod) & (cwcel @ XT @ cclmod)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) <=> ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & ((XL @ Xx3 @ Xy1) = (XK @ Xx3 @ Xy1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) @ XF) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XF) @ (Xc_xp @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : (XE @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xy1)))))))))))))))))))))))).
thf(cislmhm2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => ((XK = (ccfv @ XS @ ccsca)) => ((XL = (ccfv @ XT @ ccsca)) => ((XE = (ccfv @ XK @ ccbs)) => ((Xc_pl = (ccfv @ XS @ ccplusg)) => ((Xc_pd = (ccfv @ XT @ ccplusg)) => ((! [Xy1:$i] : ((Xc_x @ Xy1) = (ccfv @ XS @ ccvsca))) => ((! [Xy1:$i] : ((Xc_xp @ Xy1) = (ccfv @ XT @ ccvsca))) => (((cwcel @ XS @ cclmod) & (cwcel @ XT @ cclmod)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) <=> ((cwf @ XB2 @ XC @ XF) & (XL = XK) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xy1)) @ (ccv @ Xz) @ Xc_pl) @ XF) = (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XF) @ (Xc_xp @ Xy1)) @ (ccfv @ (ccv @ Xz) @ XF) @ Xc_pd))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XE))))))))))))))))))))))))))).
