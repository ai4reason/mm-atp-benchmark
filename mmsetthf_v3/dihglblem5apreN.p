...
thf(alatmle1_thm,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_an = (ccfv @ XK @ ccmee)) => (((cwcel @ XK @ cclat) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => (cwbr @ (cco @ XX @ XY @ Xc_an) @ XX @ Xc_le)))))))))))).
...
thf(adihopelvalc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xg1:$i] : ((XB2 @ Xg1) = (ccfv @ XK @ ccbs))) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xg1:$i] : ((Xc_or @ Xg1) = (ccfv @ XK @ ccjn))) => ((! [Xg1:$i] : ((Xc_an @ Xg1) = (ccfv @ XK @ ccmee))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XP = (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xg1:$i] : ((XR @ Xg1) = (ccfv @ XW @ (ccfv @ XK @ cctrl)))) => ((! [Xg1:$i] : ((XE @ Xg1) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xg1:$i] : ((XI @ Xg1) = (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((! [Xg1:$i] : ((XG @ Xg1) = (ccrio @ (^ [Xg1:$i] : ((ccfv @ XP @ (ccv @ Xg1)) = XQ)) @ (^ [Xg1:$i] : XT)))) => ((! [Xg1:$i] : (cwcel @ (XF @ Xg1) @ ccvv)) => ((! [Xg1:$i] : (cwcel @ (XS @ Xg1) @ ccvv)) => (! [Xg1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ (XX @ Xg1) @ (XB2 @ Xg1)) & (~ (cwbr @ (XX @ Xg1) @ XW @ Xc_le))) & (((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) & ((cco @ XQ @ (cco @ (XX @ Xg1) @ XW @ (Xc_an @ Xg1)) @ (Xc_or @ Xg1)) = (XX @ Xg1)))) => ((cwcel @ (ccop @ (XF @ Xg1) @ (XS @ Xg1)) @ (ccfv @ (XX @ Xg1) @ (XI @ Xg1))) <=> (((cwcel @ (XF @ Xg1) @ XT) & (cwcel @ (XS @ Xg1) @ (XE @ Xg1))) & (cwbr @ (ccfv @ (cccom @ (XF @ Xg1) @ (cccnv @ (ccfv @ (XG @ Xg1) @ (XS @ Xg1)))) @ (XR @ Xg1)) @ (XX @ Xg1) @ Xc_le)))))))))))))))))))))))))))))))))))))).
...
thf(cdihglblem5apreN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xh:$i] : ((Xc_an @ Xh) = (ccfv @ XK @ ccmee))) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xh:$i] : ((XI @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xh:$i] : (! [Xq:$i] : ((Xc_or @ Xh @ Xq) = (ccfv @ XK @ ccjn)))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xq:$i] : ((XP @ Xq) = (ccfv @ XW @ (ccfv @ XK @ ccoc)))) => ((! [Xq:$i] : ((XT @ Xq) = (ccfv @ XW @ (ccfv @ XK @ ccltrn)))) => ((! [Xh:$i] : (! [Xq:$i] : ((XR @ Xh @ Xq) = (ccfv @ XW @ (ccfv @ XK @ cctrl))))) => ((! [Xh:$i] : (! [Xq:$i] : ((XE @ Xh @ Xq) = (ccfv @ XW @ (ccfv @ XK @ cctendo))))) => ((! [Xh:$i] : (! [Xq:$i] : ((XG @ Xh @ Xq) = (ccrio @ (^ [Xh:$i] : ((ccfv @ (XP @ Xq) @ (ccv @ Xh)) = (ccv @ Xq))) @ (^ [Xh:$i] : (XT @ Xq)))))) => ((! [Xh:$i] : (! [Xq:$i] : ((Xc_0 @ Xh @ Xq) = (ccmpt @ (^ [Xh:$i] : (XT @ Xq)) @ (^ [Xh:$i] : (ccres @ ccid @ XB2)))))) => (! [Xh:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ (XX @ Xh) @ XB2) & (~ (cwbr @ (XX @ Xh) @ XW @ Xc_le)))) => ((ccfv @ (cco @ (XX @ Xh) @ XW @ (Xc_an @ Xh)) @ (XI @ Xh)) = (ccin @ (ccfv @ (XX @ Xh) @ (XI @ Xh)) @ (ccfv @ XW @ (XI @ Xh)))))))))))))))))))))))))))))))))))).
