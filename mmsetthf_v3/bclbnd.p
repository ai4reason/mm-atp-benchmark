...
thf(abcp1ctr_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (cco @ XN @ cc1 @ ccaddc) @ ccbc) = (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ (cco @ cc2 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ (cco @ XN @ cc1 @ ccaddc) @ ccdiv) @ ccmul) @ ccmul))))).
