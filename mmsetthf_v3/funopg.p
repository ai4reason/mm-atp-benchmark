...
thf(arelop_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwrel @ (ccop @ XA2 @ XB2)) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((XA2 = (ccsn @ (ccv @ Xx3))) & (XB2 = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))))))))).
...
thf(cfunopg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwfun @ (ccop @ XA2 @ XB2))) => (XA2 = XB2))))))).
