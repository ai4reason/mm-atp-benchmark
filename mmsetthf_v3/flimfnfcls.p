...
thf(asupfil_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwss @ XB2 @ XA2) & (XB2 != cc0)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ XB2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ ccfil)))))))).
...
thf(cflimfnfcls_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) <=> (cwral @ (^ [Xg1:$i] : ((cwss @ XF @ (ccv @ Xg1)) => (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccfcls)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil))))))))))).
