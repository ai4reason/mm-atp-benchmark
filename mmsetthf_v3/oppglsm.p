...
thf(atposfo2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ XA2) => ((cwfo @ XA2 @ XB2 @ XF) => (cwfo @ (cccnv @ XA2) @ XB2 @ (cctpos @ XF)))))))).
...
thf(coppglsm_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((cco @ XT @ XU @ (ccfv @ XO @ cclsm)) = (cco @ XU @ XT @ Xc_po)))))))))).
