...
thf(clbsind_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cclbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_0 = (ccfv @ XF @ cc0g)) => ((((cwcel @ XB2 @ XJ) & (cwcel @ XE @ XB2)) & ((cwcel @ XA2 @ XK) & (XA2 != Xc_0))) => (~ (cwcel @ (cco @ XA2 @ XE @ Xc_x) @ (ccfv @ (ccdif @ XB2 @ (ccsn @ XE)) @ XN))))))))))))))))))))))).
