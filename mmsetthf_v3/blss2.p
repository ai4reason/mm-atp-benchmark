...
thf(axblss2_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XP @ XX)) => ((Xph => (cwcel @ XQ @ XX)) => ((Xph => (cwcel @ XR @ ccxr)) => ((Xph => (cwcel @ XS @ ccxr)) => ((Xph => (cwcel @ (cco @ XP @ XQ @ XD) @ ccr)) => ((Xph => (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ (ccxne @ XR) @ ccxad) @ ccle)) => (Xph => (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))))))))))).
...
thf(cblss2_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XQ @ XX)) & ((cwcel @ XR @ ccr) & (cwcel @ XS @ ccr) & (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ XR @ ccmin) @ ccle))) => (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))).
