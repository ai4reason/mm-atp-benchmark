...
thf(advh3dimatN_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xs1:$i] : ((XH @ Xs1) = (ccfv @ XK @ cclh))) => ((! [Xs1:$i] : ((XU @ Xs1) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xs1:$i] : (Xc_po = (ccfv @ (XU @ Xs1) @ cclsm))) => ((! [Xs1:$i] : (XA2 = (ccfv @ (XU @ Xs1) @ cclsa))) => ((! [Xs1:$i] : (Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xs1))))) => ((Xph => (cwcel @ XP @ XA2)) => ((Xph => (cwcel @ XQ @ XA2)) => (Xph => (cwrex @ (^ [Xs1:$i] : (~ (cwss @ (ccv @ Xs1) @ (cco @ XP @ XQ @ Xc_po)))) @ (^ [Xs1:$i] : XA2)))))))))))))))))))).
...
thf(cdvh2dimatN_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xs1:$i] : ((XH @ Xs1) = (ccfv @ XK @ cclh))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XA2 = (ccfv @ XU @ cclsa)) => ((! [Xs1:$i] : (Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xs1))))) => ((Xph => (cwcel @ XP @ XA2)) => (Xph => (cwrex @ (^ [Xs1:$i] : ((ccv @ Xs1) != XP)) @ (^ [Xs1:$i] : XA2)))))))))))))))).
