...
thf(ann0prpwlem_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xk) @ XA2 @ cclt) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xn:$i] : (~ ((cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xk) @ ccdvds) <=> (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ XA2 @ ccdvds)))) @ (^ [Xn:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))) @ (^ [Xk:$i] : ccn))))).
