...
thf(cmrsubcn_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XV = (ccfv @ XT @ ccmvar)) => ((XC = (ccfv @ XT @ ccmcn)) => (((cwcel @ XF @ (ccrn @ XS)) & (cwcel @ XX @ (ccdif @ XC @ XV))) => ((ccfv @ (ccs1 @ XX) @ XF) = (ccs1 @ XX))))))))))))))).
