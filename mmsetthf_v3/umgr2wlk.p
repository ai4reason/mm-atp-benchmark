...
thf(aumgr2adedgwlk_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => ((XI = (ccfv @ XG @ cciedg)) => ((XF = (ccs2 @ XJ @ XK)) => ((XP = (ccs3 @ XA2 @ XB2 @ XC)) => ((Xph => (cwcel @ XG @ ccumgr)) => ((Xph => ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE))) => ((Xph => ((ccfv @ XJ @ XI) = (ccpr @ XA2 @ XB2))) => ((Xph => ((ccfv @ XK @ XI) = (ccpr @ XB2 @ XC))) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ XF @ cchash) = cc2) & ((XA2 = (ccfv @ ccc0 @ XP)) & (XB2 = (ccfv @ cc1 @ XP)) & (XC = (ccfv @ cc2 @ XP))))))))))))))))))))))))).
...
thf(cumgr2wlk_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((! [Xf1:$i] : (! [Xp:$i] : ((XE @ Xf1 @ Xp) = (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : (((cwcel @ XG @ ccumgr) & (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) & (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp))) => (? [Xf1:$i] : (? [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = cc2) & ((XA2 = (ccfv @ ccc0 @ (ccv @ Xp))) & (XB2 = (ccfv @ cc1 @ (ccv @ Xp))) & (XC = (ccfv @ cc2 @ (ccv @ Xp))))))))))))))))).
