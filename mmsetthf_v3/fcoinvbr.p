...
thf(cfcoinvbr_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_sm = (cccom @ (cccnv @ XF) @ XF)) => (((cwfn @ XF @ XA2) & (cwcel @ XX @ XA2) & (cwcel @ XY @ XA2)) => ((cwbr @ XX @ XY @ Xc_sm) <=> ((ccfv @ XX @ XF) = (ccfv @ XY @ XF))))))))))).
