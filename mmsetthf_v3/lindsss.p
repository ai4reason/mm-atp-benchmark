...
thf(alindfres_thm,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwbr @ XF @ XW @ cclindf)) => (cwbr @ (ccres @ XF @ XX) @ XW @ cclindf)))))).
...
thf(clindsss_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwcel @ XF @ (ccfv @ XW @ cclinds)) & (cwss @ XG @ XF)) => (cwcel @ XG @ (ccfv @ XW @ cclinds))))))).
