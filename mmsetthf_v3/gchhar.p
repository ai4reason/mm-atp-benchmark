...
thf(apwcdaen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwbr @ (ccpw @ (cco @ XA2 @ XB2 @ cccda)) @ (ccxp @ (ccpw @ XA2) @ (ccpw @ XB2)) @ ccen))))))).
...
thf(aharwdom_thm,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwbr @ (ccfv @ XX @ cchar) @ (ccpw @ (ccxp @ XX @ XX)) @ ccwdom))))).
thf(awdompwdom_thm,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwbr @ XX @ XY @ ccwdom) => (cwbr @ (ccpw @ XX) @ (ccpw @ XY) @ ccdom))))).
...
thf(agchxpidm_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) => (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
thf(apwen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => (cwbr @ (ccpw @ XA2) @ (ccpw @ XB2) @ ccen))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acdaen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XC @ XD @ ccen)) => (cwbr @ (cco @ XA2 @ XC @ cccda) @ (cco @ XB2 @ XD @ cccda) @ ccen))))))).
thf(agchcdaidm_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) => (cwbr @ (cco @ XA2 @ XA2 @ cccda) @ XA2 @ ccen)))).
...
thf(acdacomen_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (cco @ XB2 @ XA2 @ cccda) @ ccen)))).
thf(asylanbrc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xth <=> (Xps & Xch)) => (Xph => Xth))))))))).
thf(amtoi_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((~ Xch) => ((Xph => (Xps => Xch)) => (Xph => (~ Xps)))))))).
thf(aharndom_thm,axiom,(! [XX:($i > $o)] : (~ (cwbr @ (ccfv @ XX @ cchar) @ XX @ ccdom)))).
thf(asyl5ibrcom_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xth) => ((Xch => (Xps <=> Xth)) => (Xph => (Xch => Xps))))))))).
thf(adomen2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XC @ XA2 @ ccdom) <=> (cwbr @ XC @ XB2 @ ccdom))))))).
...
thf(agchen2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) & ((cwbr @ XA2 @ XB2 @ ccsdm) & (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom))) => (cwbr @ XB2 @ (ccpw @ XA2) @ ccen))))).
thf(aendom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => (cwbr @ XA2 @ XB2 @ ccdom))))).
thf(apwcdadom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ (ccpw @ (cco @ XA2 @ XA2 @ cccda)) @ (cco @ XA2 @ XB2 @ cccda) @ ccdom) => (cwbr @ (ccpw @ XA2) @ XB2 @ ccdom))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asbth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccdom) & (cwbr @ XB2 @ XA2 @ ccdom)) => (cwbr @ XA2 @ XB2 @ ccen))))).
thf(cgchhar_conj,conjecture,(! [XA2:($i > $o)] : (((cwbr @ ccom @ XA2 @ ccdom) & (cwcel @ XA2 @ ccgch) & (cwcel @ (ccpw @ XA2) @ ccgch)) => (cwbr @ (ccfv @ XA2 @ cchar) @ (ccpw @ XA2) @ ccen)))).
