...
thf(anlmnrg_thm,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ ccnlm) => (cwcel @ XF @ ccnrg)))))).
...
thf(clssnlm_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XS = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ ccnlm) & (cwcel @ XU @ XS)) => (cwcel @ XX @ ccnlm))))))))).
