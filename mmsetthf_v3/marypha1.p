...
thf(cmarypha1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xf1:$i] : (! [Xd:$i] : (Xph => (cwcel @ (XB2 @ Xf1 @ Xd) @ ccfn)))) => ((! [Xf1:$i] : (! [Xd:$i] : (Xph => (cwss @ XC @ (ccxp @ XA2 @ (XB2 @ Xf1 @ Xd)))))) => ((! [Xd:$i] : ((Xph & (cwss @ (ccv @ Xd) @ XA2)) => (cwbr @ (ccv @ Xd) @ (ccima @ XC @ (ccv @ Xd)) @ ccdom))) => (! [Xd:$i] : (Xph => (cwrex @ (^ [Xf1:$i] : (cwf1 @ XA2 @ (XB2 @ Xf1 @ Xd) @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccpw @ XC)))))))))))))).
