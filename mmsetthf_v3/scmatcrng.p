...
thf(admatmul_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ XR @ cc0g)))) => ((XD = (cco @ XN @ XR @ ccdmat)) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ XX @ XD) & (cwcel @ XY @ XD))) => ((cco @ XX @ XY @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccmulr)) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XN)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XN)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XX) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XY) @ (ccfv @ XR @ ccmulr)) @ (Xc_0 @ Xx3 @ Xy1)))))))))))))))))))))).
...
thf(cscmatcrng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XE = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XS = (cco @ XN @ XR @ ccscmat)) => ((XC = (cco @ XA2 @ XS @ ccress)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) => (cwcel @ XC @ cccrg))))))))))))))))).
