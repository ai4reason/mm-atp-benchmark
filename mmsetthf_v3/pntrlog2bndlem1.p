...
thf(aselberg34r_thm,axiom,(! [XR:($i > ($i > $o))] : ((! [Xa:$i] : ((XR @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xa)) @ (cco @ (ccsu @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccdiv) @ ccvma) @ ccmul))) @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul) @ ccmin) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cco1))))).
