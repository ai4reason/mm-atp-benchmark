...
thf(cfmtnoprmfac2lem1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) & (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => ((cco @ (cco @ cc2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) = cc1))))).
