...
thf(apjfval2_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XP = (ccfv @ XW @ ccpj1)) => ((XK = (ccfv @ XW @ ccpj)) => (XK = (ccmpt @ (^ [Xx3:$i] : (ccdm @ XK)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XP)))))))))))).
