...
thf(cdfsmo2_conj,conjecture,(! [XF:($i > $o)] : ((cwsmo @ XF) <=> ((cwf @ (ccdm @ XF) @ ccon0 @ XF) & (cword @ (ccdm @ XF)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdm @ XF))))))).
