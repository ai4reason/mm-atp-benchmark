...
thf(cgrpodivval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XN = (ccfv @ XG @ ccgn)) => ((XD = (ccfv @ XG @ ccgs)) => (((cwcel @ XG @ ccgr) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cco @ XA2 @ XB2 @ XD) = (cco @ XA2 @ (ccfv @ XB2 @ XN) @ XG))))))))))))).
