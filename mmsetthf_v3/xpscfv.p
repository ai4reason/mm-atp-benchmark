...
thf(cxpscfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW) & (cwcel @ XC @ cc2o)) => ((ccfv @ XC @ (cccnv @ (cco @ (ccsn @ XA2) @ (ccsn @ XB2) @ cccda))) = (ccif @ (XC = cc0) @ XA2 @ XB2))))))))).
