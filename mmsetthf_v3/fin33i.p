...
thf(aisf32lem11_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xb:$i] : (((cwcel @ XG @ (XV @ Xb)) & ((cwf @ ccom @ (ccpw @ XG) @ XF) & (cwral @ (^ [Xb:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xb)) @ XF) @ (ccfv @ (ccv @ Xb) @ XF))) @ (^ [Xb:$i] : ccom)) & (~ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF))))) => (cwbr @ ccom @ XG @ ccwdom))))))).
thf(cfin33i_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccfin3) & (cwf @ ccom @ (ccpw @ XA2) @ XF) & (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))))).
