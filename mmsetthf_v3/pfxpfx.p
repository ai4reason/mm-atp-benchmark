...
thf(cpfxpfx_conj,conjecture,(! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) & (cwcel @ XL @ (cco @ ccc0 @ XN @ ccfz))) => ((cco @ (cco @ XW @ XN @ ccpfx) @ XL @ ccpfx) = (cco @ XW @ XL @ ccpfx)))))))).
