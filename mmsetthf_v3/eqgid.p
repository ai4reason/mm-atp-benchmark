...
thf(areleqg_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : ((XR = (cco @ XG @ XS @ ccqg)) => (cwrel @ XR)))))).
...
thf(ceqgid_conj,conjecture,(! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_sm = (cco @ XG @ XY @ ccqg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XY @ (ccfv @ XG @ ccsubg)) => ((ccec @ Xc_0 @ Xc_sm) = XY))))))))))).
