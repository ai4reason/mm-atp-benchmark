...
thf(com1addcl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XO = (cco @ XJ @ XY @ ccomi)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XY @ XX)) => ((Xph => (XB2 = (ccfv @ XO @ ccbs))) => ((Xph => (cwcel @ XH @ XB2)) => ((Xph => (cwcel @ XK @ XB2)) => (Xph => (cwcel @ (cco @ XH @ XK @ (ccfv @ XJ @ ccpco)) @ XB2))))))))))))))))).
