...
thf(ccnvcnvintabd_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xw) => (? [Xx3:$i] : (Xps @ Xx3))))) => (! [Xx3:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xw) => ((cccnv @ (cccnv @ (ccint @ (^ [Xx3:$i] : (Xps @ Xx3))))) = (ccint @ (ccrab @ (^ [Xw:$i] : (? [Xx3:$i] : (((ccv @ Xw) = (cccnv @ (cccnv @ (ccv @ Xx3)))) & (Xps @ Xx3)))) @ (^ [Xw:$i] : (ccpw @ (ccxp @ ccvv @ ccvv))))))))))))).
