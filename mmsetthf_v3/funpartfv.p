...
thf(adf_funpart_ax,axiom,(! [XF:($i > $o)] : ((ccfunpart @ XF) = (ccres @ XF @ (ccdm @ (ccin @ (cccom @ (ccimage @ XF) @ ccsingle) @ (ccxp @ ccvv @ ccsingles))))))).
...
thf(cfunpartfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ (ccfunpart @ XF)) = (ccfv @ XA2 @ XF))))).
