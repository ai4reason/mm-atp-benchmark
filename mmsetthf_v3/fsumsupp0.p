...
thf(cfsumsupp0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => (Xph => ((ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) = (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))))))))))).
