...
thf(ceqfnov_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwfn @ XF @ (ccxp @ XA2 @ XB2)) & (cwfn @ XG @ (ccxp @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1)))) => ((XF = XG) <=> (((ccxp @ XA2 @ XB2) = (ccxp @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))))))))).
