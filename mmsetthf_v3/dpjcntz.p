...
thf(cdpjcntz_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwcel @ XX @ XI)) => ((XZ = (ccfv @ XG @ cccntz)) => (Xph => (cwss @ (ccfv @ XX @ XS) @ (ccfv @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ XZ)))))))))))))).
