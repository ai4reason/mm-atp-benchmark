...
thf(asyl5breq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwbr @ XA2 @ XB2 @ XR) => ((Xph => (XB2 = XC)) => (Xph => (cwbr @ XA2 @ XC @ XR)))))))))).
...
thf(cunierri_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XF @ ccuo) => ((cwcel @ XG @ ccuo) => ((cwcel @ XS @ ccuo) => ((cwcel @ XT @ ccuo) => (cwbr @ (ccfv @ (cco @ (cccom @ XF @ XG) @ (cccom @ XS @ XT) @ cchod) @ ccnop) @ (cco @ (ccfv @ (cco @ XF @ XS @ cchod) @ ccnop) @ (ccfv @ (cco @ XG @ XT @ cchod) @ ccnop) @ ccaddc) @ ccle)))))))))).
