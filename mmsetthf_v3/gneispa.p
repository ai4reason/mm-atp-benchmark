...
thf(cgneispa_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xp:$i] : ((XX @ Xp) = (ccuni @ XJ))) => ((cwcel @ XJ @ cctop) => (cwral @ (^ [Xp:$i] : (((ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei)) != cc0) & (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xp) @ (ccv @ Xn))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei)))))) @ (^ [Xp:$i] : (XX @ Xp)))))))).
