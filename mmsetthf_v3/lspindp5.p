...
thf(clspindp5_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XZ @ (ccfv @ (ccpr @ XX @ XU) @ XN))) => ((Xph => (~ (cwcel @ XZ @ (ccfv @ (ccpr @ XX @ XY) @ XN)))) => (Xph => (~ (cwcel @ XU @ (ccfv @ (ccpr @ XX @ XY) @ XN))))))))))))))))))))).
