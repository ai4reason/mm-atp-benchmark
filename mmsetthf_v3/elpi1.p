...
thf(celpi1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ XJ @ XY @ ccpi1)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XY @ XX)) => (Xph => ((cwcel @ XF @ XB2) <=> (cwrex @ (^ [Xf1:$i] : ((((ccfv @ ccc0 @ (ccv @ Xf1)) = XY) & ((ccfv @ cc1 @ (ccv @ Xf1)) = XY)) & (XF = (ccec @ (ccv @ Xf1) @ (ccfv @ XJ @ ccphtpc))))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))))))))))))).
