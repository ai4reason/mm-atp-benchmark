...
thf(aramcl2_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XR @ XV) & (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ XM @ XF @ ccram) @ (ccun @ ccn0 @ (ccsn @ ccpnf))))))))).
thf(aelun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccun @ XB2 @ XC)) <=> ((cwcel @ XA2 @ XB2) | (cwcel @ XA2 @ XC))))))).
thf(cramubcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XR @ XV) & (cwf @ XR @ ccn0 @ XF)) & ((cwcel @ XA2 @ ccn0) & (cwbr @ (cco @ XM @ XF @ ccram) @ XA2 @ ccle))) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccn0)))))))).
