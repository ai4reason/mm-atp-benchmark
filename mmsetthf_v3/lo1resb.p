...
thf(alo1res_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ cclo1) => (cwcel @ (ccres @ XF @ XA2) @ cclo1))))).
...
thf(aello12r_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr)) & ((cwcel @ XC @ ccr) & (cwcel @ XM @ ccr)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ XC @ (ccv @ Xx3) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XM @ ccle))) @ (^ [Xx3:$i] : XA2))) => (cwcel @ XF @ cclo1))))))).
thf(clo1resb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwcel @ XF @ cclo1) <=> (cwcel @ (ccres @ XF @ (cco @ XB2 @ ccpnf @ ccico)) @ cclo1))))))))))).
