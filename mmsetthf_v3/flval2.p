...
thf(cflval2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccfl) = (ccrio @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XA2 @ ccle) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ XA2 @ ccle) => (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle))) @ (^ [Xy1:$i] : ccz)))) @ (^ [Xx3:$i] : ccz)))))).
