...
thf(aitg1cl_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (ccfv @ XF @ ccitg1) @ ccr)))).
...
thf(ai1f0_thm,axiom,(cwcel @ (ccxp @ ccr @ (ccsn @ ccc0)) @ (ccdm @ ccitg1))).
...
thf(aitg10_thm,axiom,((ccfv @ (ccxp @ ccr @ (ccsn @ ccc0)) @ ccitg1) = ccc0)).
...
thf(aitg10a_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ ccovol) = ccc0)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) => ((ccfv @ (ccv @ Xx3) @ XF) = ccc0))) => (Xph => ((ccfv @ XF @ ccitg1) = ccc0)))))))))).
...
thf(aifeq2da_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((Xph & (~ Xps)) => (XA2 = XB2)) => (Xph => ((ccif @ Xps @ XC @ XA2) = (ccif @ Xps @ XC @ XB2)))))))))).
...
thf(ai1fmulc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ (ccdm @ ccitg1))))))))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ai1f1_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr)) => (cwcel @ (XF @ Xx3) @ (ccdm @ ccitg1)))))))).
thf(ai1fsub_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ (ccdm @ ccitg1))) => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccdm @ ccitg1)))))).
thf(ccico_tp,type,(ccico : ($i > $o))).
thf(ai1fpos_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1)))))))).
...
thf(amulgt0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt))) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))))).
...
thf(aitg1mulc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => ((ccfv @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccitg1) = (cco @ XA2 @ (ccfv @ XF @ ccitg1) @ ccmul))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(a_3eqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => ((Xph => (XC = XD)) => (Xph => (XA2 = XD))))))))))).
thf(aitg11_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ cc1 @ ccc0))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr)) => ((ccfv @ (XF @ Xx3) @ ccitg1) = (ccfv @ XA2 @ ccvol)))))))).
...
thf(aitg1sub_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ (ccdm @ ccitg1))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccitg1) = (cco @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccmin)))))).
...
thf(aitg1le_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ (ccdm @ ccitg1)) & (cwbr @ XF @ XG @ (ccofr @ ccle))) => (cwbr @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccle))))).
...
thf(citg2addnclem_conj,conjecture,(! [XF:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((XL @ Xx3 @ Xy1 @ Xz @ Xg1) = (^ [Xx3:$i] : (cwrex @ (^ [Xg1:$i] : ((cwrex @ (^ [Xy1:$i] : (cwbr @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccif @ ((ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) = ccc0) @ ccc0 @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xy1) @ ccaddc)))) @ XF @ (ccofr @ ccle))) @ (^ [Xy1:$i] : ccrp)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xg1) @ ccitg1)))) @ (^ [Xg1:$i] : (ccdm @ ccitg1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) => ((ccfv @ XF @ ccitg2) = (ccsup @ (XL @ Xx3 @ Xy1 @ Xz @ Xg1) @ ccxr @ cclt))))))))))).
