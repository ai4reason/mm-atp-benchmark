...
thf(cbrtrclfv2_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XU) & (cwcel @ XY @ XV) & (cwcel @ XR @ XW)) => ((cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) <=> (cwcel @ XY @ (ccint @ (^ [Xf1:$i] : (cwss @ (ccima @ XR @ (ccun @ (ccsn @ XX) @ (ccv @ Xf1))) @ (ccv @ Xf1)))))))))))))).
