...
thf(acbvralsv_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xy1:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ Xy1)) @ (^ [Xy1:$i] : XA2)))))).
...
thf(crspsbc_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ XB2) => ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2)) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3))))))))).
