...
thf(acphipcj_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_xi) @ cccj) = (cco @ XB2 @ XA2 @ Xc_xi))))))))))).
thf(ccphipipcj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((cco @ (cco @ XA2 @ XB2 @ Xc_xi) @ (cco @ XB2 @ XA2 @ Xc_xi) @ ccmul) = (cco @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_xi) @ ccabs) @ cc2 @ ccexp))))))))))).
