...
thf(cisprm2lem_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccn) & (XP != cc1)) => ((cwbr @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XP @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ cc2o @ ccen) <=> ((ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XP @ ccdvds)) @ (^ [Xn:$i] : ccn)) = (ccpr @ cc1 @ XP)))))).
