...
thf(csuppvalfn_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (((cwfn @ XF @ XX) & (cwcel @ XX @ XV) & (cwcel @ XZ @ XW)) => ((cco @ XF @ XZ @ ccsupp) = (ccrab @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XF) != XZ)) @ (^ [Xi:$i] : XX)))))))))).
