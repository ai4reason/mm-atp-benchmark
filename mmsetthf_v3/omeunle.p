...
thf(comeunle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => (cwss @ XB2 @ XX)) => (Xph => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ XO) @ (cco @ (ccfv @ XA2 @ XO) @ (ccfv @ XB2 @ XO) @ ccxad) @ ccle)))))))))))).
