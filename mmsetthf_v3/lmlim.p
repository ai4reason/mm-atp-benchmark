...
thf(almclimf_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XZ = (ccfv @ XM @ ccuz)) => (((cwcel @ XM @ ccz) & (cwf @ XZ @ ccc @ XF)) => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ XF @ XP @ ccli))))))))))).
thf(clmlim_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XY @ cctopon)) => ((Xph => (cwf @ ccn @ XX @ XF)) => ((Xph => (cwcel @ XP @ XX)) => (((cco @ XJ @ XX @ ccrest) = (cco @ (ccfv @ cccnfld @ cctopn) @ XX @ ccrest)) => ((cwss @ XX @ ccc) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ XF @ XP @ ccli))))))))))))))).
