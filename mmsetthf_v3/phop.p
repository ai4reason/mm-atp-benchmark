...
thf(aphrel_thm,axiom,(cwrel @ cccphlo)).
...
thf(cphop_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((cwcel @ XU @ cccphlo) => (XU = (ccop @ (ccop @ XG @ XS) @ XN))))))))))).
