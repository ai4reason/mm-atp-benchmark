...
thf(cstoweidlem20_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XF @ Xt @ Xf1 @ Xg1 @ Xi) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccsu @ (cco @ cc1 @ (XM @ Xf1 @ Xg1) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XG))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xt) => (cwcel @ (XM @ Xf1 @ Xg1) @ ccn))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt) => (cwf @ (cco @ cc1 @ (XM @ Xf1 @ Xg1) @ ccfz) @ (XA2 @ Xt @ Xi) @ XG)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt @ Xi)) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt @ Xi))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt @ Xi))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt @ Xi))) => (cwf @ XT @ ccr @ (ccv @ Xf1)))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt) => (cwcel @ (XF @ Xt @ Xf1 @ Xg1 @ Xi) @ (XA2 @ Xt @ Xi)))))))))))))))))))).
