...
thf(aborelmbl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((XS = (ccdm @ (ccfv @ XX @ ccvoln))) => ((XB2 = (ccfv @ (ccfv @ (ccfv @ XX @ ccrrx) @ cctopn) @ ccsalgen)) => (Xph => (cwss @ XB2 @ XS)))))))))).
