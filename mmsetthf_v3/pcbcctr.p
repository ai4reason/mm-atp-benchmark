...
thf(apcbc_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XP @ ccprime)) => ((cco @ XP @ (cco @ XN @ XK @ ccbc) @ ccpc) = (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ XN @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ (cco @ (ccfv @ (cco @ (cco @ XN @ XK @ ccmin) @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ (ccfv @ (cco @ XK @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ ccaddc) @ ccmin))))))))).
...
thf(cpcbcctr_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XP @ ccprime)) => ((cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) = (ccsu @ (cco @ cc1 @ (cco @ cc2 @ XN @ ccmul) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ (cco @ cc2 @ (ccfv @ (cco @ XN @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl) @ ccmul) @ ccmin)))))))).
