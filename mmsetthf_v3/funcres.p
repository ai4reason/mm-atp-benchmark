...
thf(aresfval_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XH @ (XW @ Xx3)))) => (Xph => ((cco @ XF @ XH @ ccresf) = (ccop @ (ccres @ (ccfv @ XF @ cc1st) @ (ccdm @ (ccdm @ XH))) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ XH)) @ (^ [Xx3:$i] : (ccres @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ cc2nd)) @ (ccfv @ (ccv @ Xx3) @ XH))))))))))))))).
...
thf(aresf2nd_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwcel @ XH @ XW)) => ((Xph => (cwfn @ XH @ (ccxp @ XS @ XS))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => (Xph => ((cco @ XX @ XY @ (ccfv @ (cco @ XF @ XH @ ccresf) @ cc2nd)) = (ccres @ (cco @ XX @ XY @ (ccfv @ XF @ cc2nd)) @ (cco @ XX @ XY @ XH)))))))))))))))))).
...
thf(cfuncres_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XH @ (ccfv @ XC @ ccsubc))) => (Xph => (cwcel @ (cco @ XF @ XH @ ccresf) @ (cco @ (cco @ XC @ XH @ ccresc) @ XD @ ccfunc))))))))))).
