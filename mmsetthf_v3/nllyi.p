...
thf(cnllyi_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ (ccnlly @ XA2)) & (cwcel @ XU @ XJ) & (cwcel @ XP @ XU)) => (cwrex @ (^ [Xu:$i] : ((cwss @ (ccv @ Xu) @ XU) & (cwcel @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ XA2))) @ (^ [Xu:$i] : (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)))))))))).
