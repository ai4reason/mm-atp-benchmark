...
thf(abinomcxplemrat_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xk:$i] : (Xph => (cwcel @ (XA2 @ Xk) @ ccrp))) => ((! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (XB2 @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xk) @ ccabs) @ cclt))) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ XC @ (ccv @ Xk) @ ccmin) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccdiv) @ ccabs))) @ cc1 @ ccli))))))))))).
