...
thf(coprres_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XY) & (cwcel @ (ccv @ Xy1) @ XY)) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwss @ XY @ (XX @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ (ccxp @ XY @ XY) @ (XR @ Xx3 @ Xy1) @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ (ccxp @ (XX @ Xx3 @ Xy1) @ (XX @ Xx3 @ Xy1)) @ (XS @ Xx3 @ Xy1) @ XG)))) => (Xph => (XF = (ccres @ XG @ (ccxp @ XY @ XY)))))))))))))))).
