...
thf(citg2l_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xg1:$i] : ((XL @ Xx3 @ Xg1) = (^ [Xx3:$i] : (cwrex @ (^ [Xg1:$i] : ((cwbr @ (ccv @ Xg1) @ XF @ (ccofr @ ccle)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xg1) @ ccitg1)))) @ (^ [Xg1:$i] : (ccdm @ ccitg1))))))) => (! [Xx3:$i] : (! [Xg1:$i] : ((cwcel @ XA2 @ (XL @ Xx3 @ Xg1)) <=> (cwrex @ (^ [Xg1:$i] : ((cwbr @ (ccv @ Xg1) @ XF @ (ccofr @ ccle)) & (XA2 = (ccfv @ (ccv @ Xg1) @ ccitg1)))) @ (^ [Xg1:$i] : (ccdm @ ccitg1))))))))))).
