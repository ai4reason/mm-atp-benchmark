...
thf(adf_cusp_ax,axiom,(cccusp = (ccrab @ (^ [Xw:$i] : (cwral @ (^ [Xc:$i] : ((cwcel @ (ccv @ Xc) @ (ccfv @ (ccfv @ (ccv @ Xw) @ ccuss) @ cccfilu)) => ((cco @ (ccfv @ (ccv @ Xw) @ cctopn) @ (ccv @ Xc) @ ccflim) != cc0))) @ (^ [Xc:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ ccbs) @ ccfil)))) @ (^ [Xw:$i] : ccusp)))).
thf(ciscusp_conj,conjecture,(! [XW:($i > $o)] : ((cwcel @ XW @ cccusp) <=> ((cwcel @ XW @ ccusp) & (cwral @ (^ [Xc:$i] : ((cwcel @ (ccv @ Xc) @ (ccfv @ (ccfv @ XW @ ccuss) @ cccfilu)) => ((cco @ (ccfv @ XW @ cctopn) @ (ccv @ Xc) @ ccflim) != cc0))) @ (^ [Xc:$i] : (ccfv @ (ccfv @ XW @ ccbs) @ ccfil))))))).
