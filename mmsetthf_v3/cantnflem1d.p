...
thf(afsuppmptif_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (Xph => (cwf @ XA2 @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ XZ @ (XW @ Xk)))) => ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XD @ Xk)) @ (ccfv @ (ccv @ Xk) @ XF) @ XZ))) @ XZ @ ccfsupp))))))))))))))).
