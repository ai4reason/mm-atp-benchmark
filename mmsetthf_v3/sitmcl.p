...
thf(age0xmulcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (cwcel @ (cco @ XA2 @ XB2 @ ccxmu) @ (cco @ ccc0 @ ccpnf @ ccicc)))))).
thf(csitmcl_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XW @ ccmnd)) => ((Xph => (cwcel @ XW @ ccxme)) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((Xph => (cwcel @ XF @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => ((Xph => (cwcel @ XG @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => (Xph => (cwcel @ (cco @ XF @ XG @ (cco @ XW @ XM @ ccsitm)) @ (cco @ ccc0 @ ccpnf @ ccicc)))))))))))))).
