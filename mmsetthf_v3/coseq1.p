...
thf(acos2tsin_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ cc2 @ XA2 @ ccmul) @ cccos) = (cco @ cc1 @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccsin) @ cc2 @ ccexp) @ ccmul) @ ccmin))))).
...
thf(amul0or_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((cco @ XA2 @ XB2 @ ccmul) = ccc0) <=> ((XA2 = ccc0) | (XB2 = ccc0))))))).
...
thf(ccoseq1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (((ccfv @ XA2 @ cccos) = cc1) <=> (cwcel @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ ccz))))).
