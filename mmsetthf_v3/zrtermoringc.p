...
thf(czrtermoringc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccringc)) => ((Xph => (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr))) => ((Xph => (cwcel @ XZ @ XU)) => (Xph => (cwcel @ XZ @ (ccfv @ XC @ cctermo))))))))))))).
