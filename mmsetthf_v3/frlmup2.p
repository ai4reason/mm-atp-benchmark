...
thf(cfrlmup2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => ((Xc_x = (ccfv @ XT @ ccvsca)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XT @ (cco @ (ccv @ Xx3) @ XA2 @ (ccof @ Xc_x)) @ ccgsu))))) => ((Xph => (cwcel @ XT @ cclmod)) => ((Xph => (cwcel @ XI @ XX)) => ((Xph => (XR = (ccfv @ XT @ ccsca))) => ((Xph => (cwf @ XI @ XC @ XA2)) => ((Xph => (cwcel @ XY @ XI)) => ((XU = (cco @ XR @ XI @ ccuvc)) => (! [Xx3:$i] : (Xph => ((ccfv @ (ccfv @ XY @ XU) @ (XE @ Xx3)) = (ccfv @ XY @ XA2))))))))))))))))))))))))))))).
