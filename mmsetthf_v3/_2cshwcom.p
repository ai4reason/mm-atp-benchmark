...
thf(c_2cshwcom_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz) & (cwcel @ XM @ ccz)) => ((cco @ (cco @ XW @ XN @ cccsh) @ XM @ cccsh) = (cco @ (cco @ XW @ XM @ cccsh) @ XN @ cccsh)))))))).
