...
thf(cbnj986_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [Xta:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xch @ Xf1 @ Xm @ Xn @ Xp) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xn) @ (XD @ Xf1 @ Xm @ Xn @ Xp)) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xf1 @ Xm @ Xn @ Xp) @ (Xps @ Xf1 @ Xm @ Xn @ Xp))))))) => ((! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XD @ Xf1 @ Xm @ Xn @ Xp) = (ccdif @ ccom @ (ccsn @ cc0))))))) => ((! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xta @ Xf1 @ Xm @ Xn @ Xp) <=> ((cwcel @ (ccv @ Xm) @ ccom) & ((ccv @ Xn) = (ccsuc @ (ccv @ Xm))) & ((ccv @ Xp) = (ccsuc @ (ccv @ Xn))))))))) => (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xch @ Xf1 @ Xm @ Xn @ Xp) => (? [Xm:$i] : (? [Xp:$i] : (Xta @ Xf1 @ Xm @ Xn @ Xp))))))))))))))))).
