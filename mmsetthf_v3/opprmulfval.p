...
thf(aopprval_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XO = (ccfv @ XR @ ccoppr)) => (XO = (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (cctpos @ Xc_x)) @ ccsts)))))))))).
