...
thf(ar10_thm,axiom,((ccfv @ cc0 @ ccr1) = cc0)).
...
thf(ar1sssuc_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwss @ (ccfv @ XA2 @ ccr1) @ (ccfv @ (ccsuc @ XA2) @ ccr1))))).
...
thf(ar1tr_thm,axiom,(! [XA2:($i > $o)] : (cwtr @ (ccfv @ XA2 @ ccr1)))).
...
thf(cackbij2lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((XG = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : (ccpw @ (ccdm @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccfv @ (ccima @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)))))) => ((cwcel @ XA2 @ ccom) => (cwss @ (ccfv @ XA2 @ (ccrdg @ XG @ cc0)) @ (ccfv @ (ccsuc @ XA2) @ (ccrdg @ XG @ cc0)))))))))).
