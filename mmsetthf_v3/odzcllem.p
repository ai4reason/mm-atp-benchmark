...
thf(codzcllem_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) => ((cwcel @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccn) & (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccexp) @ cc1 @ ccmin) @ ccdvds)))))).
