...
thf(afseqdom_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xn:$i] : ((cwcel @ XA2 @ (XV @ Xn)) => (cwbr @ (ccxp @ ccom @ XA2) @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccmap))) @ ccdom)))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asbth_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccdom) & (cwbr @ XB2 @ XA2 @ ccdom)) => (cwbr @ XA2 @ XB2 @ ccen))))).
thf(cfseqen_conj,conjecture,(! [XA2:($i > $o)] : (((cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen) & (XA2 != cc0)) => (cwbr @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccmap))) @ (ccxp @ ccom @ XA2) @ ccen)))).
