...
thf(arrnmbl_thm,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => (Xph => (cwcel @ (cco @ ccr @ XX @ ccmap) @ (ccdm @ (ccfv @ XX @ ccvoln)))))))).
...
thf(ahoimbllem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (XX != cc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xl:$i] : ((XS @ Xx3 @ Xy1 @ Xl) = (ccdm @ (ccfv @ XX @ ccvoln)))))) => ((Xph => (cwf @ XX @ ccr @ XA2)) => ((Xph => (cwf @ XX @ ccr @ XB2)) => ((XH = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccv @ Xx3))) @ (^ [Xl:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccixp @ (^ [Xi:$i] : (ccv @ Xx3)) @ (^ [Xi:$i] : (ccif @ ((ccv @ Xi) = (ccv @ Xl)) @ (cco @ ccmnf @ (ccv @ Xy1) @ ccioo) @ ccr))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xl:$i] : (Xph => (cwcel @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccico))) @ (XS @ Xx3 @ Xy1 @ Xl))))))))))))))))))).
...
thf(choimbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((XS = (ccdm @ (ccfv @ XX @ ccvoln))) => ((Xph => (cwf @ XX @ ccr @ XA2)) => ((Xph => (cwf @ XX @ ccr @ XB2)) => (Xph => (cwcel @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccico))) @ XS)))))))))))).
