...
thf(crge0scvg_conj,conjecture,(! [XF:($i > $o)] : (((cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccico) @ XF) & (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli))) => (cwcel @ (ccsup @ (ccrn @ (ccseq @ ccaddc @ XF @ cc1)) @ ccr @ cclt) @ ccr)))).
