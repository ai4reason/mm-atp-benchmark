...
thf(clvolnlelln_conj,conjecture,(! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XN = (ccfv @ XK @ cclln)) => ((XV = (ccfv @ XK @ cclvol)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XV) & (cwcel @ XY @ XN)) => (~ (cwbr @ XX @ XY @ Xc_le))))))))))))).
