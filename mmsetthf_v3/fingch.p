...
thf(adf_gch_ax,axiom,(ccgch = (ccun @ ccfn @ (^ [Xx3:$i] : (! [Xy1:$i] : (~ ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm) & (cwbr @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xx3)) @ ccsdm)))))))).
thf(cfingch_conj,conjecture,(cwss @ ccfn @ ccgch)).
