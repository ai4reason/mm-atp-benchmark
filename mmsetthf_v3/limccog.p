...
thf(climccog_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwss @ (ccrn @ XF) @ (ccdif @ (ccdm @ XG) @ (ccsn @ XB2)))) => ((Xph => (cwcel @ XB2 @ (cco @ XF @ XA2 @ cclimc))) => ((Xph => (cwcel @ XC @ (cco @ XG @ XB2 @ cclimc))) => (Xph => (cwcel @ XC @ (cco @ (cccom @ XG @ XF) @ XA2 @ cclimc))))))))))))).
