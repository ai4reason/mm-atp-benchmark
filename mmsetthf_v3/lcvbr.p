...
thf(clcvbr_conj,conjecture,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XS = (ccfv @ XW @ cclss)) => ((! [Xs1:$i] : ((XC @ Xs1) = (ccfv @ XW @ cclcv))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XW @ (XX @ Xs1)))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XT @ XS))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XU @ XS))) => (! [Xs1:$i] : ((Xph @ Xs1) => ((cwbr @ XT @ XU @ (XC @ Xs1)) <=> ((cwpss @ XT @ XU) & (~ (cwrex @ (^ [Xs1:$i] : ((cwpss @ XT @ (ccv @ Xs1)) & (cwpss @ (ccv @ Xs1) @ XU))) @ (^ [Xs1:$i] : XS)))))))))))))))))))).
