...
thf(cfourierdlem40_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((Xph => (cwcel @ XB2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (~ (cwcel @ ccc0 @ (cco @ XA2 @ XB2 @ ccioo)))) => ((Xph => (cwcel @ (ccres @ XF @ (cco @ (cco @ XA2 @ XX @ ccaddc) @ (cco @ XB2 @ XX @ ccaddc) @ ccioo)) @ (cco @ (cco @ (cco @ XA2 @ XX @ ccaddc) @ (cco @ XB2 @ XX @ ccaddc) @ ccioo) @ ccc @ cccncf))) => ((Xph => (cwcel @ XY @ ccr)) => ((Xph => (cwcel @ XW @ ccr)) => ((! [Xs1:$i] : ((XH @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ ((ccv @ Xs1) = ccc0) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF) @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xs1) @ cclt) @ XY @ XW) @ ccmin) @ (ccv @ Xs1) @ ccdiv)))))) => (! [Xs1:$i] : (Xph => (cwcel @ (ccres @ (XH @ Xs1) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf)))))))))))))))))))))).
