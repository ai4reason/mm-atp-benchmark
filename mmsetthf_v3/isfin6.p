...
thf(adf_fin6_ax,axiom,(ccfin6 = (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ cc2o @ ccsdm) | (cwbr @ (ccv @ Xx3) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)) @ ccsdm))))).
...
thf(cisfin6_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin6) <=> ((cwbr @ XA2 @ cc2o @ ccsdm) | (cwbr @ XA2 @ (ccxp @ XA2 @ XA2) @ ccsdm))))).
