...
thf(cextoimad_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ XC @ ccle)) @ (^ [Xy1:$i] : ccr))) => (Xph => (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XC @ ccle)) @ (^ [Xx3:$i] : (ccima @ ccabs @ (ccima @ XF @ ccr))))))))))).
