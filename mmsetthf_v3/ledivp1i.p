...
thf(cledivp1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => (((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ XC @ ccle) & (cwbr @ XA2 @ (cco @ XB2 @ (cco @ XC @ cc1 @ ccaddc) @ ccdiv) @ ccle)) => (cwbr @ (cco @ XA2 @ XC @ ccmul) @ XB2 @ ccle))))))))).
