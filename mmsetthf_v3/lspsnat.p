...
thf(clspsnat_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => ((((cwcel @ XW @ cclvec) & (cwcel @ XU @ XS) & (cwcel @ XX @ XV)) & (cwss @ XU @ (ccfv @ (ccsn @ XX) @ XN))) => ((XU = (ccfv @ (ccsn @ XX) @ XN)) | (XU = (ccsn @ Xc_0)))))))))))))))).
