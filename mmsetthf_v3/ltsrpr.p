...
thf(abrecop2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_le:($i > $o)] : ((cwcel @ Xc_sm @ ccvv) => (((ccdm @ Xc_sm) = (ccxp @ XG @ XG)) => ((XH = (ccqs @ (ccxp @ XG @ XG) @ Xc_sm)) => ((cwss @ XR @ (ccxp @ XH @ XH)) => ((cwss @ Xc_le @ (ccxp @ XG @ XG)) => ((~ (cwcel @ cc0 @ XG)) => (((ccdm @ Xc_pl) = (ccxp @ XG @ XG)) => (((((cwcel @ XA2 @ XG) & (cwcel @ XB2 @ XG)) & ((cwcel @ XC @ XG) & (cwcel @ XD @ XG))) => ((cwbr @ (ccec @ (ccop @ XA2 @ XB2) @ Xc_sm) @ (ccec @ (ccop @ XC @ XD) @ Xc_sm) @ XR) <=> (cwbr @ (cco @ XA2 @ XD @ Xc_pl) @ (cco @ XB2 @ XC @ Xc_pl) @ Xc_le))) => ((cwbr @ (ccec @ (ccop @ XA2 @ XB2) @ Xc_sm) @ (ccec @ (ccop @ XC @ XD) @ Xc_sm) @ XR) <=> (cwbr @ (cco @ XA2 @ XD @ Xc_pl) @ (cco @ XB2 @ XC @ Xc_pl) @ Xc_le))))))))))))))))))))).
...
thf(acaovord3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XS) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) <=> (cwbr @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XF) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XF) @ XR)))))) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XF)))) => ((cwcel @ XD @ ccvv) => ((((cwcel @ XB2 @ XS) & (cwcel @ XC @ XS)) & ((cco @ XA2 @ XB2 @ XF) = (cco @ XC @ XD @ XF))) => ((cwbr @ XA2 @ XC @ XR) <=> (cwbr @ XD @ XB2 @ XR))))))))))))))))).
