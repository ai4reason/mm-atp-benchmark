...
thf(a_3gencl_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XD @ Xx3) @ (XS @ Xx3)) <=> (cwrex @ (^ [Xx3:$i] : ((XA2 @ Xx3 @ Xy1 @ Xz) = (XD @ Xx3))) @ (^ [Xx3:$i] : (XR @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XF @ Xx3 @ Xy1) @ (XS @ Xx3)) <=> (cwrex @ (^ [Xy1:$i] : ((XB2 @ Xx3 @ Xy1 @ Xz) = (XF @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XR @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XG @ Xx3 @ Xy1 @ Xz) @ (XS @ Xx3)) <=> (cwrex @ (^ [Xz:$i] : ((XC @ Xx3 @ Xy1 @ Xz) = (XG @ Xx3 @ Xy1 @ Xz))) @ (^ [Xz:$i] : (XR @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((XA2 @ Xx3 @ Xy1 @ Xz) = (XD @ Xx3)) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((XB2 @ Xx3 @ Xy1 @ Xz) = (XF @ Xx3 @ Xy1)) => ((Xps @ Xy1 @ Xz) <=> (Xch @ Xx3 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((XC @ Xx3 @ Xy1 @ Xz) = (XG @ Xx3 @ Xy1 @ Xz)) => ((Xch @ Xx3 @ Xz) <=> (Xth @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ (XR @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XR @ Xz)) & (cwcel @ (ccv @ Xz) @ (XR @ Xz))) => (Xph @ Xx3 @ Xy1 @ Xz))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (XD @ Xx3) @ (XS @ Xx3)) & (cwcel @ (XF @ Xx3 @ Xy1) @ (XS @ Xx3)) & (cwcel @ (XG @ Xx3 @ Xy1 @ Xz) @ (XS @ Xx3))) => (Xth @ Xx3 @ Xy1))))))))))))))))))))))))).
...
thf(cax_pre_ltadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ XB2 @ ccltrr) => (cwbr @ (cco @ XC @ XA2 @ ccaddc) @ (cco @ XC @ XB2 @ ccaddc) @ ccltrr))))))).
