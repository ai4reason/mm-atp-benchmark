...
thf(ccantnfvalf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xk:$i] : ((XF @ Xz @ Xk) = (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xz:$i] : XB2)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (XC @ Xz @ Xk) @ (XD @ Xz @ Xk) @ ccoa)))) @ cc0)))) => (! [Xz:$i] : (! [Xk:$i] : (cwf @ ccom @ ccon0 @ (XF @ Xz @ Xk))))))))))).
