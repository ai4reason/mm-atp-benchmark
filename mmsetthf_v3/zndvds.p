...
thf(aeqgabl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xc_sm = (cco @ XG @ XS @ ccqg)) => (((cwcel @ XG @ ccabl) & (cwss @ XS @ XX)) => ((cwbr @ XA2 @ XB2 @ Xc_sm) <=> ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ (cco @ XB2 @ XA2 @ Xc_mi) @ XS))))))))))))))).
...
thf(arspsn_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XK = (ccfv @ XR @ ccrsp)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XG @ XB2)) => ((ccfv @ (ccsn @ XG) @ XK) = (^ [Xx3:$i] : (cwbr @ XG @ (ccv @ Xx3) @ Xc_pa))))))))))))).
...
thf(czndvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XY @ cczrh)) => (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (((ccfv @ XA2 @ XL) = (ccfv @ XB2 @ XL)) <=> (cwbr @ XN @ (cco @ XA2 @ XB2 @ ccmin) @ ccdvds))))))))))).
