...
thf(adirith2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XN @ ccn)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XA2 @ XU)) => ((XT = (ccima @ (cccnv @ XL) @ (ccsn @ XA2))) => (Xph => (cwbr @ (ccin @ ccprime @ XT) @ ccn @ ccen)))))))))))))))).
...
thf(cdirith_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1)) => (cwbr @ (ccrab @ (^ [Xp:$i] : (cwbr @ XN @ (cco @ (ccv @ Xp) @ XA2 @ ccmin) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccn @ ccen))))).
