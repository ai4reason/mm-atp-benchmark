...
thf(aring1eq0_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((Xc_1 = Xc_0) => (XX = XY))))))))))))).
...
thf(axmseq0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccfv @ XM @ ccds)) => (((cwcel @ XM @ ccxme) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (((cco @ XA2 @ XB2 @ XD) = ccc0) <=> (XA2 = XB2))))))))))).
...
thf(anrginvrcnlem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XX @ Xx3 @ Xy1) = (ccfv @ XR @ ccbs)))) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XN @ Xx3 @ Xy1) = (ccfv @ XR @ ccnm)))) => ((! [Xy1:$i] : ((XD @ Xy1) = (ccfv @ XR @ ccds))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XR @ ccnrg))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XR @ ccnzr))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xy1) @ XU)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3) => (cwcel @ (XB2 @ Xy1) @ ccrp)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XT = (cco @ (ccif @ (cwbr @ cc1 @ (cco @ (ccfv @ (XA2 @ Xy1) @ (XN @ Xx3 @ Xy1)) @ (XB2 @ Xy1) @ ccmul) @ ccle) @ cc1 @ (cco @ (ccfv @ (XA2 @ Xy1) @ (XN @ Xx3 @ Xy1)) @ (XB2 @ Xy1) @ ccmul)) @ (cco @ (ccfv @ (XA2 @ Xy1) @ (XN @ Xx3 @ Xy1)) @ cc2 @ ccdiv) @ ccmul)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (cco @ (XA2 @ Xy1) @ (ccv @ Xy1) @ (XD @ Xy1)) @ (ccv @ Xx3) @ cclt) => (cwbr @ (cco @ (ccfv @ (XA2 @ Xy1) @ XI) @ (ccfv @ (ccv @ Xy1) @ XI) @ (XD @ Xy1)) @ (XB2 @ Xy1) @ cclt))) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : ccrp))))))))))))))))))))))))).
...
thf(amstopn_thm,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XK @ cctopn)) => ((XX = (ccfv @ XK @ ccbs)) => ((XD = (ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XX @ XX))) => ((cwcel @ XK @ ccmt) => (XJ = (ccfv @ XD @ ccmopn))))))))))).
...
thf(cnrginvrcn_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((XJ = (ccfv @ XR @ cctopn)) => ((cwcel @ XR @ ccnrg) => (cwcel @ XI @ (cco @ (cco @ XJ @ XU @ ccrest) @ (cco @ XJ @ XU @ ccrest) @ cccn))))))))))))).
