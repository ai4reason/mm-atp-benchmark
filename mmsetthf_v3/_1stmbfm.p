...
thf(aunielsiga_thm,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) => (cwcel @ (ccuni @ XS) @ XS)))).
...
thf(apwssb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ (ccpw @ XB2)) <=> (cwral @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XB2)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(aissgon_thm,axiom,(! [XS:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XS @ (ccfv @ XO @ ccsiga)) <=> ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (XO = (ccuni @ XS))))))).
...
thf(c_1stmbfm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((Xph => (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((Xph => (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => (Xph => (cwcel @ (ccres @ cc1st @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT))) @ (cco @ (cco @ XS @ XT @ ccsx) @ XS @ ccmbfm))))))))).
