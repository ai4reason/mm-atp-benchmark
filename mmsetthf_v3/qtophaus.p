...
thf(cqtophaus_conj,conjecture,(! [Xph:$o] : (! [Xc_sm:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xc_sm = (cccom @ (cccnv @ XF) @ XF)) => ((XH = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))))) => ((Xph => (cwcel @ XJ @ ccha)) => ((Xph => (cwfo @ XX @ XY @ XF)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XJ)) => (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ (cco @ XJ @ XF @ ccqtop)))) => ((Xph => (cwcel @ Xc_sm @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccld))) => (Xph => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ ccha))))))))))))))))).
