...
thf(aslerec_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwbr @ XA2 @ XB2 @ ccsslt) & (cwbr @ XC @ XD @ ccsslt)) & ((XX = (cco @ XA2 @ XB2 @ ccscut)) & (XY = (cco @ XC @ XD @ ccscut)))) => ((cwbr @ XX @ XY @ ccsle) <=> ((cwral @ (^ [Xd:$i] : (cwbr @ XX @ (ccv @ Xd) @ ccslt)) @ (^ [Xd:$i] : XD)) & (cwral @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ XY @ ccslt)) @ (^ [Xa:$i] : XA2)))))))))))).
...
thf(csltrec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwbr @ XA2 @ XB2 @ ccsslt) & (cwbr @ XC @ XD @ ccsslt)) & ((XX = (cco @ XA2 @ XB2 @ ccscut)) & (XY = (cco @ XC @ XD @ ccscut)))) => ((cwbr @ XX @ XY @ ccslt) <=> ((cwrex @ (^ [Xc:$i] : (cwbr @ XX @ (ccv @ Xc) @ ccsle)) @ (^ [Xc:$i] : XC)) | (cwrex @ (^ [Xb:$i] : (cwbr @ (ccv @ Xb) @ XY @ ccsle)) @ (^ [Xb:$i] : XB2)))))))))))).
