...
thf(cbtwnoutside_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XP @ (ccfv @ XN @ ccee)))) => ((((XA2 != XP) & (XB2 != XP) & (XC != XP)) & (cwbr @ XP @ (ccop @ XA2 @ XC) @ ccbtwn)) => ((cwbr @ XP @ (ccop @ XB2 @ XC) @ ccbtwn) <=> (cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof)))))))))).
