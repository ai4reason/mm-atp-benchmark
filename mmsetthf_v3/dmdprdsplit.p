...
thf(cdmdprdsplit_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XI = (ccun @ XC @ XD))) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (Xph => ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) <=> (((cwbr @ XG @ (ccres @ XS @ XC) @ (ccdm @ ccdprd)) & (cwbr @ XG @ (ccres @ XS @ XD) @ (ccdm @ ccdprd))) & (cwss @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (ccfv @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd) @ XZ)) & ((ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) = (ccsn @ Xc_0))))))))))))))))))).
