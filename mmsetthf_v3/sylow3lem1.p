...
thf(afislw_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn) & (cwcel @ XP @ ccprime)) => ((cwcel @ XH @ (cco @ XP @ XG @ ccslw)) <=> ((cwcel @ XH @ (ccfv @ XG @ ccsubg)) & ((ccfv @ XH @ cchash) = (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp))))))))))).
...
thf(aabrexco_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xw:$i] : (cwcel @ (XB2 @ Xx3 @ Xw) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xy1) = (XB2 @ Xx3 @ Xw)) => ((XC @ Xx3 @ Xy1 @ Xz) = (XD @ Xx3 @ Xz @ Xw))))))) => (! [Xz:$i] : ((^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XC @ Xx3 @ Xy1 @ Xz))) @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xz) = (XB2 @ Xx3 @ Xw))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xw))))))) = (^ [Xx3:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xx3) = (XD @ Xx3 @ Xz @ Xw))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xw))))))))))))).
