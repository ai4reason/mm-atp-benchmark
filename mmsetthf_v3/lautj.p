...
thf(clautj_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XI = (ccfv @ XK @ cclaut)) => (((cwcel @ XK @ cclat) & ((cwcel @ XF @ XI) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((ccfv @ (cco @ XX @ XY @ Xc_or) @ XF) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ Xc_or)))))))))))))).
