...
thf(celdioph4i_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ ccvv) => ((~ (cwcel @ XW @ ccfn)) => (((ccin @ XW @ ccn) = cc0) => (((cwcel @ XN @ ccn0) & (cwcel @ XP @ (ccfv @ (ccun @ XW @ (cco @ cc1 @ XN @ ccfz)) @ ccmzp))) => (cwcel @ (ccrab @ (^ [Xt:$i] : (cwrex @ (^ [Xw:$i] : ((ccfv @ (ccun @ (ccv @ Xt) @ (ccv @ Xw)) @ XP) = ccc0)) @ (^ [Xw:$i] : (cco @ ccn0 @ XW @ ccmap)))) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))))))).
