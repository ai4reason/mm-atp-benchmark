...
thf(cupgrpredgv_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccupgr) & ((cwcel @ XM @ XU) & (cwcel @ XN @ XW)) & (cwcel @ (ccpr @ XM @ XN) @ XE)) => ((cwcel @ XM @ XV) & (cwcel @ XN @ XV))))))))))))).
