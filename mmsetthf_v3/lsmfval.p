...
thf(adf_lsm_ax,axiom,(cclsm = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt2 @ (^ [Xt:$i] : (^ [Xu:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))) @ (^ [Xt:$i] : (^ [Xu:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))) @ (^ [Xt:$i] : (^ [Xu:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xt))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xu))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccplusg))))))))))))).
