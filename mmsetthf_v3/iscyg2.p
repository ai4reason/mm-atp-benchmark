...
thf(ciscyg2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((! [Xx3:$i] : (! [Xn:$i] : ((XE @ Xx3 @ Xn) = (ccrab @ (^ [Xx3:$i] : ((ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_x)))) = XB2)) @ (^ [Xx3:$i] : XB2))))) => (! [Xx3:$i] : (! [Xn:$i] : ((cwcel @ XG @ cccyg) <=> ((cwcel @ XG @ ccgrp) & ((XE @ Xx3 @ Xn) != cc0))))))))))))).
