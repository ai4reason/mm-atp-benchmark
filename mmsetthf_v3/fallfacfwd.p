...
thf(afallfacval_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ XN @ ccfallfac) = (ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccmin)))))))).
...
thf(afallfacval2_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ XN @ ccfallfac) = (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccmin)))))))).
...
thf(cfallfacfwd_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn)) => ((cco @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccfallfac) @ ccmin) = (cco @ XN @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccfallfac) @ ccmul)))))).
