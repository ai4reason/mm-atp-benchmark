...
thf(abrcofffn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwfn @ XC @ XZ)) => ((Xph => (cwf @ XY @ XZ @ XD)) => ((Xph => (cwf @ XX @ XY @ XE)) => ((Xph => (cwbr @ XA2 @ XB2 @ (cccom @ XC @ (cccom @ XD @ XE)))) => (Xph => ((cwbr @ XA2 @ (ccfv @ XA2 @ XE) @ XE) & (cwbr @ (ccfv @ XA2 @ XE) @ (ccfv @ (ccfv @ XA2 @ XE) @ XD) @ XD) & (cwbr @ (ccfv @ (ccfv @ XA2 @ XE) @ XD) @ XB2 @ XC))))))))))))))))).
...
thf(cbrco3f1o_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf1o @ XY @ XZ @ XC)) => ((Xph => (cwf1o @ XX @ XY @ XD)) => ((Xph => (cwf1o @ XW @ XX @ XE)) => ((Xph => (cwbr @ XA2 @ XB2 @ (cccom @ XC @ (cccom @ XD @ XE)))) => (Xph => ((cwbr @ (ccfv @ XB2 @ (cccnv @ XC)) @ XB2 @ XC) & (cwbr @ (ccfv @ (ccfv @ XB2 @ (cccnv @ XC)) @ (cccnv @ XD)) @ (ccfv @ XB2 @ (cccnv @ XC)) @ XD) & (cwbr @ XA2 @ (ccfv @ (ccfv @ XB2 @ (cccnv @ XC)) @ (cccnv @ XD)) @ XE)))))))))))))))))).
