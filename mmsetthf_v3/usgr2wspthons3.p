...
thf(awpthswwlks2on_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccusgr) & (XA2 != XB2)) => ((cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwspthsnon)) = (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)))))))).
...
thf(cusgr2wspthons3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccusgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))) <=> ((XA2 != XC) & (cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE))))))))))))).
