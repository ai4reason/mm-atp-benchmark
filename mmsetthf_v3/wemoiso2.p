...
thf(aweisoeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwwe @ XB2 @ XS) & (cwse @ XB2 @ XS)) & ((cwiso @ XA2 @ XB2 @ XR @ XS @ XF) & (cwiso @ XA2 @ XB2 @ XR @ XS @ XG))) => (XF = XG))))))))).
...
thf(cwemoiso2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwwe @ XB2 @ XS) => (cwmo @ (^ [Xf1:$i] : (cwiso @ XA2 @ XB2 @ XR @ XS @ (ccv @ Xf1)))))))))).
