...
thf(csubglsm_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((XA2 = (ccfv @ XH @ cclsm)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwss @ XT @ XS) & (cwss @ XU @ XS)) => ((cco @ XT @ XU @ Xc_po) = (cco @ XT @ XU @ XA2)))))))))))))).
