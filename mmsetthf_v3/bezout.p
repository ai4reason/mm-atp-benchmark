...
thf(agcd0val_thm,axiom,((cco @ ccc0 @ ccc0 @ ccgcd) = ccc0)).
...
thf(cbezout_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ XA2 @ XB2 @ ccgcd) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))).
