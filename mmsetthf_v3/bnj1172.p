...
thf(cbnj1172_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xw:$i] : ((XC @ Xz @ Xw) = (ccin @ (cc_bnj18 @ (XA2 @ Xz @ Xw) @ (XR @ Xz @ Xw) @ (XX @ Xz @ Xw)) @ (XB2 @ Xz @ Xw))))) => ((? [Xz:$i] : (! [Xw:$i] : (((Xph @ Xz @ Xw) & (Xps @ Xz @ Xw)) => (((Xph @ Xz @ Xw) & (Xps @ Xz @ Xw) & (cwcel @ (ccv @ Xz) @ (XC @ Xz @ Xw))) & ((Xth @ Xz @ Xw) => ((cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)) => (~ (cwcel @ (ccv @ Xw) @ (XB2 @ Xz @ Xw))))))))) => ((! [Xz:$i] : (! [Xw:$i] : (((Xph @ Xz @ Xw) & (Xps @ Xz @ Xw) & (cwcel @ (ccv @ Xz) @ (XC @ Xz @ Xw))) => ((Xth @ Xz @ Xw) <=> (cwcel @ (ccv @ Xw) @ (XA2 @ Xz @ Xw)))))) => (? [Xz:$i] : (! [Xw:$i] : (((Xph @ Xz @ Xw) & (Xps @ Xz @ Xw)) => ((cwcel @ (ccv @ Xz) @ (XB2 @ Xz @ Xw)) & ((cwcel @ (ccv @ Xw) @ (XA2 @ Xz @ Xw)) => ((cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)) => (~ (cwcel @ (ccv @ Xw) @ (XB2 @ Xz @ Xw))))))))))))))))))))).
