...
thf(ampfsubrg_thm,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ (cco @ XI @ XS @ cces)))) => (((cwcel @ XI @ XV) & (cwcel @ XS @ cccrg) & (cwcel @ XR @ (ccfv @ XS @ ccsubrg))) => (cwcel @ XQ @ (ccfv @ (cco @ XS @ (cco @ (ccfv @ XS @ ccbs) @ XI @ ccmap) @ ccpws) @ ccsubrg)))))))))).
