...
thf(ccshwidx0mod_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (XW != cc0) & (cwcel @ XN @ ccz)) => ((ccfv @ ccc0 @ (cco @ XW @ XN @ cccsh)) = (ccfv @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmo) @ XW))))))).
