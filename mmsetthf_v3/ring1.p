...
thf(agrppropstr_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (((ccfv @ XK @ ccbs) = XB2) => (((ccfv @ XK @ ccplusg) = Xc_pl) => ((XL = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl))) => ((cwcel @ XK @ ccgrp) <=> (cwcel @ XL @ ccgrp)))))))))).
