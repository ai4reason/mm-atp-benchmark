...
thf(cbinom2sub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc2 @ ccexp) = (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ cc2 @ (cco @ XA2 @ XB2 @ ccmul) @ ccmul) @ ccmin) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc)))))).
