...
thf(cusgr1eop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XV @ XW) & (cwcel @ XA2 @ XX)) & ((cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => ((XB2 != XC) => (cwcel @ (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XC)))) @ ccusgr)))))))))).
