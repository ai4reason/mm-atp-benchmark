...
thf(aiundifdifd_thm,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : ((cwss @ XA2 @ (ccpw @ XO)) => ((XA2 != cc0) => ((ccint @ XA2) = (ccdif @ XO @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccdif @ XO @ (ccv @ Xx3))))))))))).
thf(csigaclci_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwcel @ XA2 @ (ccpw @ XS))) & ((cwbr @ XA2 @ ccom @ ccdom) & (XA2 != cc0))) => (cwcel @ (ccint @ XA2) @ XS))))).
