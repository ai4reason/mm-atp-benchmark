...
thf(aalgr0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((XR = (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ XZ @ (ccsn @ XA2)) @ XM)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XA2 @ XS)) => (Xph => ((ccfv @ XM @ XR) = XA2)))))))))))))).
...
thf(alt2subd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XA2 @ XC @ cclt)) => ((Xph => (cwbr @ XB2 @ XD @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XD @ ccmin) @ (cco @ XC @ XB2 @ ccmin) @ cclt)))))))))))))).
...
thf(covolicc2lem4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ ccr))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XB2 @ ccr))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwbr @ XA2 @ XB2 @ ccle))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((XS @ Xu @ Xt @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XF @ Xu)) @ cc1))))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ (XF @ Xu)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XU @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ (XF @ Xu)))) @ ccfn)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ XU)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwf @ XU @ ccn @ (XG @ Xu)))) => ((! [Xu:$i] : (! [Xt:$i] : (((Xph @ Xu) & (cwcel @ (ccv @ Xt) @ XU)) => ((ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (cccom @ ccioo @ (XF @ Xu))) = (ccv @ Xt))))) => ((! [Xu:$i] : ((XT @ Xu) = (ccrab @ (^ [Xu:$i] : ((ccin @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccicc)) != cc0)) @ (^ [Xu:$i] : XU)))) => ((! [Xu:$i] : (! [Xn:$i] : ((Xph @ Xu) => (cwf @ (XT @ Xu) @ (XT @ Xu) @ (XH @ Xu @ Xn))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (((Xph @ Xu) & (cwcel @ (ccv @ Xt) @ (XT @ Xu))) => (cwcel @ (ccif @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2 @ ccle) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2) @ (ccfv @ (ccv @ Xt) @ (XH @ Xu @ Xn))))))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ (XC @ Xu)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ (XC @ Xu) @ (XT @ Xu)))) => ((! [Xu:$i] : (! [Xn:$i] : (XK = (ccseq @ (cccom @ (XH @ Xu @ Xn) @ cc1st) @ (ccxp @ ccn @ (ccsn @ (XC @ Xu))) @ cc1)))) => ((! [Xu:$i] : (! [Xt:$i] : ((XW @ Xu @ Xt) = (ccrab @ (^ [Xn:$i] : (cwcel @ XB2 @ (ccfv @ (ccv @ Xn) @ XK))) @ (^ [Xn:$i] : ccn))))) => ((! [Xu:$i] : (! [Xt:$i] : ((XM @ Xu) = (ccinf @ (XW @ Xu @ Xt) @ ccr @ cclt)))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xph @ Xu) => (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccsup @ (ccrn @ (XS @ Xu @ Xt @ Xn)) @ ccxr @ cclt) @ ccle)))))))))))))))))))))))))))))))))))).
