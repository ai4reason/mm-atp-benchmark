...
thf(c_1stf2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((XT = (cco @ XC @ XD @ ccxpc)) => ((XB2 = (ccfv @ XT @ ccbs)) => ((XH = (ccfv @ XT @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XP = (cco @ XC @ XD @ cc1stf)) => ((Xph => (cwcel @ XR @ XB2)) => ((Xph => (cwcel @ XS @ XB2)) => (Xph => ((cco @ XR @ XS @ (ccfv @ XP @ cc2nd)) = (ccres @ cc1st @ (cco @ XR @ XS @ XH)))))))))))))))))))))).
