...
thf(ciseraltlem1_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((Xph => (cwbr @ XG @ ccc0 @ ccli)) => ((Xph & (cwcel @ XN @ XZ)) => (cwbr @ ccc0 @ (ccfv @ XN @ XG) @ ccle))))))))))))).
