...
thf(areceu_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc) & (XB2 != ccc0)) => (cwreu @ (^ [Xx3:$i] : ((cco @ XB2 @ (ccv @ Xx3) @ ccmul) = XA2)) @ (^ [Xx3:$i] : ccc)))))).
...
thf(crexdiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (XB2 != ccc0)) => ((cco @ XA2 @ XB2 @ ccxdiv) = (cco @ XA2 @ XB2 @ ccdiv)))))).
