...
thf(cig1pval3_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XR @ ccig1p)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XU = (ccfv @ XP @ cclidl)) => ((XD = (ccfv @ XR @ ccdg1)) => ((XM = (ccfv @ XR @ ccmn1)) => (((cwcel @ XR @ ccdr) & (cwcel @ XI @ XU) & (XI != (ccsn @ Xc_0))) => ((cwcel @ (ccfv @ XI @ XG) @ XI) & (cwcel @ (ccfv @ XI @ XG) @ XM) & ((ccfv @ (ccfv @ XI @ XG) @ XD) = (ccinf @ (ccima @ XD @ (ccdif @ XI @ (ccsn @ Xc_0))) @ ccr @ cclt))))))))))))))))))).
