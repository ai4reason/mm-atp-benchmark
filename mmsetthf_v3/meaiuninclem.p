...
thf(ameaxrcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((XS = (ccdm @ XM)) => ((Xph => (cwcel @ XA2 @ XS)) => (Xph => (cwcel @ (ccfv @ XA2 @ XM) @ ccxr)))))))))).
thf(aadantr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(affvelrnda_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph & (cwcel @ XC @ XA2)) => (cwcel @ (ccfv @ XC @ XF) @ XB2))))))))).
thf(ameage0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((Xph => (cwcel @ XA2 @ (ccdm @ XM))) => (Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ XM) @ ccle)))))))).
...
thf(asge0reuzb_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xx3 @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xx3 @ Xk)) @ X)))) => ((! [Xk:$i] : ((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xk)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xk)) @ X)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xk) => (cwcel @ XM @ ccz)))) => ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xx3:$i] : (! [Xk:$i] : (((Xph @ Xx3 @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xk) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccsu @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccv @ Xx3) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xx3:$i] : ccr))))) => (! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xk) => ((ccfv @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccsu @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk)))))) @ ccr @ cclt)))))))))))))))).
...
thf(acbvdisjv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XB2 @ Xx3) = (XC @ Xy1))))) => ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) <=> (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (XC @ Xy1))))))))).
...
thf(cmeaiuninclem_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((Xph => (cwcel @ XN @ ccz)) => ((XZ = (ccfv @ XN @ ccuz)) => ((Xph => (cwf @ XZ @ (ccdm @ XM) @ XE)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => (cwss @ (ccfv @ (ccv @ Xn) @ XE) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XE)))) => ((Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xx3:$i] : ccr))) => ((! [Xi:$i] : ((XS @ Xi) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XE) @ XM))))) => ((XF = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdif @ (ccfv @ (ccv @ Xn) @ XE) @ (cciun @ (^ [Xi:$i] : (cco @ XN @ (ccv @ Xn) @ ccfzo)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XE))))))) => (! [Xi:$i] : (Xph => (cwbr @ (XS @ Xi) @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ XM) @ ccli))))))))))))))))))).
