...
thf(codinv_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((XI = (ccfv @ XG @ ccminusg)) => ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => ((ccfv @ (ccfv @ XA2 @ XI) @ XO) = (ccfv @ XA2 @ XO)))))))))))).
