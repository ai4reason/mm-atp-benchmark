...
thf(atailini_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XD)) => (((cwcel @ XD @ ccdir) & (cwcel @ XA2 @ XX)) => (cwcel @ XA2 @ (ccfv @ XA2 @ (ccfv @ XD @ cctail))))))))).
...
thf(ctailfb_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XD)) => (((cwcel @ XD @ ccdir) & (XX != cc0)) => (cwcel @ (ccrn @ (ccfv @ XD @ cctail)) @ (ccfv @ XX @ ccfbas))))))).
