...
thf(atxcmp_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ cccmp) & (cwcel @ XS @ cccmp)) => (cwcel @ (cco @ XR @ XS @ cctx) @ cccmp))))).
thf(ctxcmpb_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XR)) => ((XY = (ccuni @ XS)) => ((((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) & ((XX != cc0) & (XY != cc0))) => ((cwcel @ (cco @ XR @ XS @ cctx) @ cccmp) <=> ((cwcel @ XR @ cccmp) & (cwcel @ XS @ cccmp))))))))))).
