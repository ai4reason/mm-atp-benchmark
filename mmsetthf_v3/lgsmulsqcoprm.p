...
thf(clgsmulsqcoprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (XA2 != ccc0)) & ((cwcel @ XB2 @ ccz) & (XB2 != ccc0)) & ((cwcel @ XN @ ccz) & ((cco @ XA2 @ XN @ ccgcd) = cc1))) => ((cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XB2 @ ccmul) @ XN @ cclgs) = (cco @ XB2 @ XN @ cclgs))))))).
