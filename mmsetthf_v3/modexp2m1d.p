...
thf(cmodexp2m1d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XE @ ccrp)) => ((Xph => (cwbr @ cc1 @ XE @ cclt)) => ((Xph => ((cco @ XA2 @ XE @ ccmo) = (cco @ (ccneg @ cc1) @ XE @ ccmo))) => (Xph => ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ XE @ ccmo) = cc1)))))))))).
