...
thf(cmaprnin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cco @ (ccin @ XB2 @ XC) @ XA2 @ ccmap) = (ccrab @ (^ [Xf1:$i] : (cwss @ (ccrn @ (ccv @ Xf1)) @ XC)) @ (^ [Xf1:$i] : (cco @ XB2 @ XA2 @ ccmap)))))))))).
