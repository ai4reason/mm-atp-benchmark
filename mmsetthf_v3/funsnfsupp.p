...
thf(afsuppunbi_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwfun @ (ccun @ XF @ XG))) => (Xph => ((cwbr @ (ccun @ XF @ XG) @ XZ @ ccfsupp) <=> ((cwbr @ XF @ XZ @ ccfsupp) & (cwbr @ XG @ XZ @ ccfsupp)))))))))).
...
thf(asnopfsupp_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XY @ XW) & (cwcel @ XZ @ XU)) => (cwbr @ (ccsn @ (ccop @ XX @ XY)) @ XZ @ ccfsupp))))))))).
...
thf(cfunsnfsupp_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XX @ XV) & (cwcel @ XY @ XW)) & ((cwfun @ XF) & (cwnel @ XX @ (ccdm @ XF)))) => ((cwbr @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))) @ XZ @ ccfsupp) <=> (cwbr @ XF @ XZ @ ccfsupp)))))))))).
