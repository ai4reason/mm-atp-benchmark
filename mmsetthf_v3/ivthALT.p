...
thf(civthALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XU @ ccr)) & (cwbr @ XA2 @ XB2 @ cclt) & ((cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD) & (cwss @ XD @ ccc) & ((cwcel @ XF @ (cco @ XD @ ccc @ cccncf)) & (cwss @ (ccima @ XF @ (cco @ XA2 @ XB2 @ ccicc)) @ ccr) & (cwcel @ XU @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccioo))))) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = XU)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)))))))))).
