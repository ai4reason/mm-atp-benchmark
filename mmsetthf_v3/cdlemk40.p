...
thf(ccdlemk40_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xg1:$i] : ((XX @ Xz @ Xg1) = (ccrio @ (^ [Xz:$i] : (Xph @ Xz @ Xg1)) @ (^ [Xz:$i] : (XT @ Xz)))))) => ((! [Xz:$i] : (! [Xg1:$i] : ((XU @ Xz @ Xg1) = (ccmpt @ (^ [Xg1:$i] : (XT @ Xz)) @ (^ [Xg1:$i] : (ccif @ ((XF @ Xz) = (XN @ Xz)) @ (ccv @ Xg1) @ (XX @ Xz @ Xg1))))))) => (! [Xz:$i] : (! [Xg1:$i] : ((cwcel @ (XG @ Xz @ Xg1) @ (XT @ Xz)) => ((ccfv @ (XG @ Xz @ Xg1) @ (XU @ Xz @ Xg1)) = (ccif @ ((XF @ Xz) = (XN @ Xz)) @ (XG @ Xz @ Xg1) @ (ccsb @ (XG @ Xz @ Xg1) @ (^ [Xg1:$i] : (XX @ Xz @ Xg1)))))))))))))))))).
