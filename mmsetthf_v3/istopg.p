...
thf(adf_top_ax,axiom,(cctop = (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (cwcel @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xx3)))) & (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwcel @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xx3))) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))).
...
thf(cistopg_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [Xy1:$i] : ((cwcel @ XJ @ (XA2 @ Xy1)) => ((cwcel @ XJ @ cctop) <=> ((! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XJ) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ XJ))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))))).
