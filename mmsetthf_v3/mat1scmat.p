...
thf(amat1dimid_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => ((ccfv @ XA2 @ ccur) = (ccsn @ (ccop @ XO @ (ccfv @ XR @ ccur))))))))))))))).
...
thf(amat1dimscm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ XX @ (ccsn @ (ccop @ XO @ XY)) @ (ccfv @ XA2 @ ccvsca)) = (ccsn @ (ccop @ XO @ (cco @ XX @ XY @ (ccfv @ XR @ ccmulr)))))))))))))))))).
...
thf(cmat1scmat_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => (((cwcel @ XN @ XV) & ((ccfv @ XN @ cchash) = cc1) & (cwcel @ XR @ ccrg)) => ((cwcel @ XM @ XB2) => (cwcel @ XM @ (cco @ XN @ XR @ ccscmat))))))))))))).
