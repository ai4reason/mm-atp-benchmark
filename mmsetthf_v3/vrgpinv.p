...
thf(afrgpinv_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [Xc_sm:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((! [Xy1:$i] : (! [Xz:$i] : ((XG @ Xy1 @ Xz) = (ccfv @ XI @ ccfrgp)))) => ((Xc_sm = (ccfv @ XI @ ccefg)) => ((! [Xy1:$i] : (! [Xz:$i] : ((XN @ Xy1 @ Xz) = (ccfv @ (XG @ Xy1 @ Xz) @ ccminusg)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XM @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XA2 @ Xy1 @ Xz) @ XW) => ((ccfv @ (ccec @ (XA2 @ Xy1 @ Xz) @ Xc_sm) @ (XN @ Xy1 @ Xz)) = (ccec @ (cccom @ (XM @ Xy1 @ Xz) @ (ccfv @ (XA2 @ Xy1 @ Xz) @ ccreverse)) @ Xc_sm)))))))))))))))))).
...
thf(cvrgpinv_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xc_sm = (ccfv @ XI @ ccefg)) => ((XU = (ccfv @ XI @ ccvrgp)) => ((XG = (ccfv @ XI @ ccfrgp)) => ((XN = (ccfv @ XG @ ccminusg)) => (((cwcel @ XI @ XV) & (cwcel @ XA2 @ XI)) => ((ccfv @ (ccfv @ XA2 @ XU) @ XN) = (ccec @ (ccs1 @ (ccop @ XA2 @ cc1o)) @ Xc_sm))))))))))))))).
