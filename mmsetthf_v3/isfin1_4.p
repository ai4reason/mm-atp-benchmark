...
thf(aisfin1_3_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfn) <=> (cwfr @ (ccpw @ XA2) @ (cccnv @ ccrpss))))))).
...
thf(aisofr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) => ((cwfr @ XA2 @ XR) <=> (cwfr @ XB2 @ XS))))))))).
