...
thf(csubmmulg_conj,conjecture,(! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_xb = (ccfv @ XG @ ccmg)) => ((XH = (cco @ XG @ XS @ ccress)) => ((Xc_x = (ccfv @ XH @ ccmg)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) & (cwcel @ XN @ ccn0) & (cwcel @ XX @ XS)) => ((cco @ XN @ XX @ Xc_xb) = (cco @ XN @ XX @ Xc_x)))))))))))))).
