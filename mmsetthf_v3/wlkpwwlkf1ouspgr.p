...
thf(awlkiswwlks_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XG @ ccuspgr) => ((? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks))) <=> (cwcel @ XP @ (ccfv @ XG @ ccwwlks))))))).
...
thf(cwlkpwwlkf1ouspgr_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xw:$i] : ((XF @ Xw) = (ccmpt @ (^ [Xw:$i] : (ccfv @ XG @ ccwlks)) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xw) @ cc2nd))))) => (! [Xw:$i] : ((cwcel @ XG @ ccuspgr) => (cwf1o @ (ccfv @ XG @ ccwlks) @ (ccfv @ XG @ ccwwlks) @ (XF @ Xw)))))))).
