...
thf(allnmod1i2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & (cwbr @ XX @ XY @ Xc_le)) => ((cco @ XX @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XY @ Xc_an) @ Xc_or) = (cco @ (cco @ XX @ (cco @ XP @ XQ @ Xc_or) @ Xc_or) @ XY @ Xc_an))))))))))))))))))).
thf(aoveq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))))).
thf(cllnmod2i2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & (cwbr @ XY @ XX @ Xc_le)) => ((cco @ (cco @ XX @ (cco @ XP @ XQ @ Xc_or) @ Xc_an) @ XY @ Xc_or) = (cco @ XX @ (cco @ (cco @ XP @ XQ @ Xc_or) @ XY @ Xc_or) @ Xc_an))))))))))))))))))).
