...
thf(adfid4_thm,axiom,(ccid = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccv @ Xx3))))).
...
thf(cdfid6_conj,conjecture,(ccid = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : (ccsn @ cc1)) @ (^ [Xn:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccrelexp))))))).
