...
thf(cnnsum4primeseven_conj,conjecture,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc5 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ cc9 @ ccuz)) & (cwcel @ XN @ cceven)) => (cwrex @ (^ [Xf1:$i] : (XN = (ccsu @ (cco @ cc1 @ cc4 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc4 @ ccfz) @ ccmap))))))).
