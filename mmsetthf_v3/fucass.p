...
thf(afuccoval_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XN = (cco @ XC @ XD @ ccnat)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((Xc_x = (ccfv @ XD @ ccco)) => ((Xc_xb = (ccfv @ XQ @ ccco)) => ((Xph => (cwcel @ XR @ (cco @ XF @ XG @ XN))) => ((Xph => (cwcel @ XS @ (cco @ XG @ XH @ XN))) => ((Xph => (cwcel @ XX @ XA2)) => (Xph => ((ccfv @ XX @ (cco @ XS @ XR @ (cco @ (ccop @ XF @ XG) @ XH @ Xc_xb))) = (cco @ (ccfv @ XX @ XS) @ (ccfv @ XX @ XR) @ (cco @ (ccop @ (ccfv @ XX @ (ccfv @ XF @ cc1st)) @ (ccfv @ XX @ (ccfv @ XG @ cc1st))) @ (ccfv @ XX @ (ccfv @ XH @ cc1st)) @ Xc_x))))))))))))))))))))))))))).
