...
thf(cvoliooico_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccvol) = (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol))))))))).
