...
thf(age0div_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt)) => ((cwbr @ ccc0 @ XA2 @ ccle) <=> (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccle)))))).
...
thf(cdignnld_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn) & (cwcel @ XK @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc) @ ccuz))) => ((cco @ XK @ XN @ (ccfv @ XB2 @ ccdig)) = ccc0)))))).
