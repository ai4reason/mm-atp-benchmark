...
thf(aevlsval_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XQ @ Xx3 @ Xf1 @ Xg1) = (ccfv @ (XR @ Xg1) @ (cco @ XI @ XS @ cces)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XW @ Xx3 @ Xg1) = (cco @ XI @ (XU @ Xx3 @ Xf1 @ Xg1) @ ccmpl))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XV @ Xx3 @ Xf1 @ Xg1) = (cco @ XI @ (XU @ Xx3 @ Xf1 @ Xg1) @ ccmvr))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XU @ Xx3 @ Xf1 @ Xg1) = (cco @ XS @ (XR @ Xg1) @ ccress))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XT @ Xx3 @ Xg1) = (cco @ XS @ (cco @ (XB2 @ Xx3 @ Xf1 @ Xg1) @ XI @ ccmap) @ ccpws))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XB2 @ Xx3 @ Xf1 @ Xg1) = (ccfv @ XS @ ccbs))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XA2 @ Xx3 @ Xf1 @ Xg1) = (ccfv @ (XW @ Xx3 @ Xg1) @ ccascl))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XX @ Xx3 @ Xf1 @ Xg1) = (ccmpt @ (^ [Xx3:$i] : (XR @ Xg1)) @ (^ [Xx3:$i] : (ccxp @ (cco @ (XB2 @ Xx3 @ Xf1 @ Xg1) @ XI @ ccmap) @ (ccsn @ (ccv @ Xx3))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XY @ Xx3 @ Xf1 @ Xg1) = (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xg1:$i] : (cco @ (XB2 @ Xx3 @ Xf1 @ Xg1) @ XI @ ccmap)) @ (^ [Xg1:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)))))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XI @ (XZ @ Xx3 @ Xf1 @ Xg1)) & (cwcel @ XS @ cccrg) & (cwcel @ (XR @ Xg1) @ (ccfv @ XS @ ccsubrg))) => ((XQ @ Xx3 @ Xf1 @ Xg1) = (ccrio @ (^ [Xf1:$i] : (((cccom @ (ccv @ Xf1) @ (XA2 @ Xx3 @ Xf1 @ Xg1)) = (XX @ Xx3 @ Xf1 @ Xg1)) & ((cccom @ (ccv @ Xf1) @ (XV @ Xx3 @ Xf1 @ Xg1)) = (XY @ Xx3 @ Xf1 @ Xg1)))) @ (^ [Xf1:$i] : (cco @ (XW @ Xx3 @ Xg1) @ (XT @ Xx3 @ Xg1) @ ccrh))))))))))))))))))))))))))))))).
...
thf(apwscrng_thm,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => (((cwcel @ XR @ cccrg) & (cwcel @ XI @ XV)) => (cwcel @ XY @ cccrg)))))))).
...
thf(ariotacl2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwcel @ (ccrio @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
