...
thf(acfslb2n_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((cwlim @ XA2) & (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ cccf) @ ccsdm))) @ (^ [Xx3:$i] : XB2))) => ((cwbr @ XB2 @ (ccfv @ XA2 @ cccf) @ ccsdm) => ((ccuni @ XB2) != XA2))))))).
...
thf(ctskuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwtr @ XT) & (cwcel @ XA2 @ XT)) => (cwcel @ (ccuni @ XA2) @ XT))))).
