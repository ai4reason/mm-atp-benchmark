...
thf(cclimreeq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XR = (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cclm)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccr @ XF)) => (Xph => ((cwbr @ XF @ XA2 @ XR) <=> (cwbr @ XF @ XA2 @ ccli)))))))))))))).
