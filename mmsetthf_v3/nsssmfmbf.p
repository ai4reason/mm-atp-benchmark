...
thf(ansssmfmbflem_thm,axiom,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccdm @ ccvol))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwss @ (XX @ Xf1) @ ccr))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (~ (cwcel @ (XX @ Xf1) @ (XS @ Xx3)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (XX @ Xf1)) @ (^ [Xx3:$i] : ccc0))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (? [Xf1:$i] : ((cwcel @ (ccv @ Xf1) @ (ccfv @ (XS @ Xx3) @ ccsmblfn)) & (~ (cwcel @ (ccv @ Xf1) @ ccmbf)))))))))))))))).
