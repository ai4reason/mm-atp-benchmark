...
thf(acaov411_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ (ccv @ Xz) @ XF) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XF) @ XF))))) => ((cwcel @ XD @ ccvv) => ((cco @ (cco @ XA2 @ XB2 @ XF) @ (cco @ XC @ XD @ XF) @ XF) = (cco @ (cco @ XC @ XB2 @ XF) @ (cco @ XA2 @ XD @ XF) @ XF)))))))))))))).
...
thf(cltanq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnq) => ((cwbr @ XA2 @ XB2 @ ccltq) <=> (cwbr @ (cco @ XC @ XA2 @ ccplq) @ (cco @ XC @ XB2 @ ccplq) @ ccltq))))))).
