...
thf(ciuninc_conj,conjecture,(! [Xph:$o] : (! [Xi:$i] : (! [XF:($i > $o)] : ((Xph => (cwfn @ XF @ ccn)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => ((Xph & (cwcel @ (ccv @ Xi) @ ccn)) => ((cciun @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xi) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) = (ccfv @ (ccv @ Xi) @ XF))))))))).
