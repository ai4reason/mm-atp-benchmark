...
thf(alspextmo_thm,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XK = (ccfv @ XS @ cclspn)) => (((cwss @ XX @ XB2) & ((ccfv @ XX @ XK) = XB2)) => (cwrmo @ (^ [Xg1:$i] : ((ccres @ (ccv @ Xg1) @ XX) = XF)) @ (^ [Xg1:$i] : (cco @ XS @ XT @ cclmhm))))))))))))).
