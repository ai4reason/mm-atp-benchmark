...
thf(acatccat_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ cccatc)) => ((cwcel @ XU @ XV) => (cwcel @ XC @ cccat))))))).
...
thf(aisinv_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XN = (ccfv @ XC @ ccinv)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XS = (ccfv @ XC @ ccsect)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XX @ XY @ XN)) <=> ((cwbr @ XF @ XG @ (cco @ XX @ XY @ XS)) & (cwbr @ XG @ XF @ (cco @ XY @ XX @ XS))))))))))))))))))))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(aissect_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xc_x = (ccfv @ XC @ ccco)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((XS = (ccfv @ XC @ ccsect)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XX @ XY @ XS)) <=> ((cwcel @ XF @ (cco @ XX @ XY @ XH)) & (cwcel @ XG @ (cco @ XY @ XX @ XH)) & ((cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XX @ Xc_x)) = (ccfv @ XX @ Xc_1))))))))))))))))))))))))).
thf(acatchom_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ cccatc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XU @ XV)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cco @ XX @ XY @ XH) = (cco @ XX @ XY @ ccfunc)))))))))))))))))).
...
thf(acatcco_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XC = (ccfv @ XU @ cccatc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XU @ XV)) => ((Xc_x = (ccfv @ XC @ ccco)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ ccfunc))) => (Xph => ((cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_x)) = (cco @ XG @ XF @ cccofu)))))))))))))))))))))))).
thf(acatcid_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccfv @ XU @ cccatc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((XI = (ccfv @ XX @ ccidfu)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XB2)) => (Xph => ((ccfv @ XX @ Xc_1) = XI))))))))))))))))).
...
thf(aidfu1_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XC @ ccidfu)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => (Xph => ((ccfv @ XX @ (ccfv @ XI @ cc1st)) = XX)))))))))))).
...
thf(acatcbas_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ cccatc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XU @ XV)) => (Xph => (XB2 = (ccin @ XU @ cccat)))))))))))).
thf(ainss2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccin @ XA2 @ XB2) @ XB2)))).
thf(aoveqd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XD @ XA2) = (cco @ XC @ XD @ XB2)))))))))).
thf(acofu2nd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XD @ XE @ ccfunc))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cco @ XX @ XY @ (ccfv @ (cco @ XG @ XF @ cccofu) @ cc2nd)) = (cccom @ (cco @ (ccfv @ XX @ (ccfv @ XF @ cc1st)) @ (ccfv @ XY @ (ccfv @ XF @ cc1st)) @ (ccfv @ XG @ cc2nd)) @ (cco @ XX @ XY @ (ccfv @ XF @ cc2nd)))))))))))))))))))).
...
thf(aisffth2_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((XJ = (ccfv @ XD @ cchom)) => ((cwbr @ XF @ XG @ (ccin @ (cco @ XC @ XD @ ccful) @ (cco @ XC @ XD @ ccfth))) <=> ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfunc)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwf1o @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XJ) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))))).
thf(adf_br_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwbr @ XA2 @ XB2 @ XR) <=> (cwcel @ (ccop @ XA2 @ XB2) @ XR)))))).
thf(acofu1st_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XD @ XE @ ccfunc))) => (Xph => ((ccfv @ (cco @ XG @ XF @ cccofu) @ cc1st) = (cccom @ (ccfv @ XG @ cc1st) @ (ccfv @ XF @ cc1st))))))))))))))).
...
thf(afullfunc_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwss @ (cco @ XC @ XD @ ccful) @ (cco @ XC @ XD @ ccfunc))))).
thf(acatcisolem_thm,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (XC = (ccfv @ (XU @ Xx3 @ Xy1) @ cccatc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ XC @ ccbs)))) => ((XR = (ccfv @ XX @ ccbs)) => ((XS = (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XU @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XX @ (XB2 @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XY @ (XB2 @ Xx3 @ Xy1))))) => ((XI = (ccfv @ XC @ ccinv)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XH @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccnv @ (cco @ (ccfv @ (ccv @ Xx3) @ (cccnv @ XF)) @ (ccfv @ (ccv @ Xy1) @ (cccnv @ XF)) @ XG)))))))) => ((Xph => (cwbr @ XF @ XG @ (ccin @ (cco @ XX @ XY @ ccful) @ (cco @ XX @ XY @ ccfth)))) => ((Xph => (cwf1o @ XR @ XS @ XF)) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwbr @ (ccop @ XF @ XG) @ (ccop @ (cccnv @ XF) @ (XH @ Xx3 @ Xy1)) @ (cco @ XX @ XY @ XI)))))))))))))))))))))))))))))).
thf(asylibr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch <=> Xps) => (Xph => Xch))))))).
thf(aeqeltrrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XA2 @ XC)) => (Xph => (cwcel @ XB2 @ XC))))))))).
thf(ccatciso_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XU @ cccatc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XR = (ccfv @ XX @ ccbs)) => ((XS = (ccfv @ XY @ ccbs)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XI = (ccfv @ XC @ cciso)) => (Xph => ((cwcel @ XF @ (cco @ XX @ XY @ XI)) <=> ((cwcel @ XF @ (ccin @ (cco @ XX @ XY @ ccful) @ (cco @ XX @ XY @ ccfth))) & (cwf1o @ XR @ XS @ (ccfv @ XF @ cc1st))))))))))))))))))))))))).
