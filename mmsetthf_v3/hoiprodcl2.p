...
thf(choiprodcl2_conj,conjecture,(! [Xph:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XX @ ccfn))) => ((! [Xi:$i] : (! [Xk:$i] : ((XL @ Xi @ Xk) = (ccmpt @ (^ [Xi:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xi:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xi))) @ ccvol)))))))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwf @ XX @ (ccxp @ ccr @ ccr) @ XI))) => (! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (ccfv @ XI @ (XL @ Xi @ Xk)) @ (cco @ ccc0 @ ccpnf @ ccico)))))))))))))).
