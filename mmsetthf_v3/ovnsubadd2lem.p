...
thf(aiunxdif3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XE @ Xx3))) => ((cwral @ (^ [Xx3:$i] : ((XB2 @ Xx3) = cc0)) @ (^ [Xx3:$i] : (XE @ Xx3))) => ((cciun @ (^ [Xx3:$i] : (ccdif @ XA2 @ (XE @ Xx3))) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(aiunxprg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XC @ Xx3) = XD))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((XC @ Xx3) = XE))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => ((cciun @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccun @ XD @ XE)))))))))))))).
