...
thf(caxlowdimlem11_conj,conjecture,(! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => ((ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) = cc1)))))).
