...
thf(a_2zrngamgm_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XE @ Xx3 @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XR @ Xx3 @ Xz) = (cco @ cccnfld @ (XE @ Xx3 @ Xz) @ ccress)))) => (! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XR @ Xx3 @ Xz) @ ccmgm)))))))).
...
thf(c_2zrngasgrp_conj,conjecture,(! [XR:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XE @ Xx3 @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (XR = (cco @ cccnfld @ (XE @ Xx3 @ Xz) @ ccress)))) => (cwcel @ XR @ ccsgrp)))))).
