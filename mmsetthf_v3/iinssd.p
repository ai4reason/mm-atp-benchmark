...
thf(ciinssd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XX @ XA2))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XB2 @ Xx3) = XD))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XD @ XC))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC))))))))))))).
