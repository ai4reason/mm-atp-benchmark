...
thf(cpf1addcl_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ cce1))) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => (((cwcel @ XF @ XQ) & (cwcel @ XG @ XQ)) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ XQ)))))))))).
