...
thf(cznle_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ czring @ ccrsp)) => ((XU = (cco @ czring @ (cco @ czring @ (ccfv @ (ccsn @ XN) @ XS) @ ccqg) @ ccqus)) => ((XY = (ccfv @ XN @ cczn)) => ((XF = (ccres @ (ccfv @ XU @ cczrh) @ XW)) => ((XW = (ccif @ (XN = ccc0) @ ccz @ (cco @ ccc0 @ XN @ ccfzo))) => ((Xc_le = (ccfv @ XY @ ccple)) => ((cwcel @ XN @ ccn0) => (Xc_le = (cccom @ (cccom @ XF @ ccle) @ (cccnv @ XF)))))))))))))))))).
