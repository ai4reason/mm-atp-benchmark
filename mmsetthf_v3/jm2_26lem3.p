...
thf(advdsleabs_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (XN != ccc0)) => ((cwbr @ XM @ XN @ ccdvds) => (cwbr @ XM @ (ccfv @ XN @ ccabs) @ ccle)))))).
