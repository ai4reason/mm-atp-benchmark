...
thf(cxrge0addgt0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) & (cwbr @ ccc0 @ XA2 @ cclt)) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccxad) @ cclt))))).
