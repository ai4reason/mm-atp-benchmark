...
thf(cupgrex_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccupgr) & (cwfn @ XE @ XA2) & (cwcel @ XF @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccfv @ XF @ XE) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV))))))))))).
