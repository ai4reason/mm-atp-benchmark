...
thf(ccmpcov_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xs1:$i] : ((XX @ Xs1) = (ccuni @ XJ))) => (! [Xs1:$i] : (((cwcel @ XJ @ cccmp) & (cwss @ XS @ XJ) & ((XX @ Xs1) = (ccuni @ XS))) => (cwrex @ (^ [Xs1:$i] : ((XX @ Xs1) = (ccuni @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccin @ (ccpw @ XS) @ ccfn)))))))))).
