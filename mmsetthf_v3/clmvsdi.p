...
thf(cclmvsdi_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ ccclm) & ((cwcel @ XA2 @ XK) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((cco @ XA2 @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) = (cco @ (cco @ XA2 @ XX @ Xc_x) @ (cco @ XA2 @ XY @ Xc_x) @ Xc_pl)))))))))))))))))).
