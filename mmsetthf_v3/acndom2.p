...
thf(aacni2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : (((cwcel @ XX @ (cwacn @ XA2)) & (cwral @ (^ [Xx3:$i] : ((cwss @ (XB2 @ Xx3) @ XX) & ((XB2 @ Xx3) != cc0))) @ (^ [Xx3:$i] : XA2))) => (? [Xg1:$i] : ((cwf @ XA2 @ XX @ (ccv @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))).
thf(aad3antlr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((((Xch & Xph) & Xth) & Xta) => Xps)))))))).
thf(aacnrcl_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (cwacn @ XA2)) => (cwcel @ XA2 @ ccvv))))).
...
thf(aacnlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XA2 @ (XV @ Xx3 @ Xf1 @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3 @ Xf1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : XA2))) => (? [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : XA2))))))))))).
...
thf(aisacn_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XX @ (XV @ Xx3 @ Xf1 @ Xg1)) & (cwcel @ XA2 @ (XW @ Xx3 @ Xf1 @ Xg1))) => ((cwcel @ XX @ (cwacn @ XA2)) <=> (cwral @ (^ [Xf1:$i] : (? [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : XA2)))) @ (^ [Xf1:$i] : (cco @ (ccdif @ (ccpw @ XX) @ (ccsn @ cc0)) @ XA2 @ ccmap))))))))))))).
thf(cacndom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwbr @ XX @ XY @ ccdom) => ((cwcel @ XY @ (cwacn @ XA2)) => (cwcel @ XX @ (cwacn @ XA2)))))))).
