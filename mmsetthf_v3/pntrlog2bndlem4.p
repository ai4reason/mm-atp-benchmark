...
thf(apntsval2_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ (XS @ Xi @ Xa)) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul) @ (ccsu @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccdiv) @ ccvma) @ ccmul))) @ ccaddc))))))))))).
...
thf(apntsf_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwf @ ccr @ ccr @ (XS @ Xi @ Xa))))))).
...
thf(apntrlog2bndlem1_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : ((XR @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => (! [Xi:$i] : (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xn) @ (XS @ Xi @ Xa)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XS @ Xi @ Xa)) @ ccmin) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cclo1)))))))).
...
thf(ao1lo1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1)))))))).
...
thf(aselbergs_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XS @ Xi @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmin))) @ cco1)))))).
...
thf(ao1lo12_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ XM @ (XB2 @ Xx3) @ ccle))) => (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1) <=> (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1))))))))))).
...
thf(aselbergsb_thm,axiom,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XS @ Xi @ Xa)) @ (ccv @ Xx3) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ (ccv @ Xc) @ ccle)) @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccico)))) @ (^ [Xc:$i] : ccrp))))))).
...
thf(apntrlog2bndlem3_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : ((XR @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xa) => (cwcel @ XA2 @ ccrp))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xa) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ (XS @ Xi @ Xa)) @ (ccv @ Xy1) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xy1) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ XA2 @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico))))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xa) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xn) @ (XS @ Xi @ Xa)) @ (cco @ cc2 @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul) @ ccmul) @ ccmin) @ ccmul))) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccdiv))) @ cco1)))))))))))))).
