...
thf(ccdj3lem3b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccph)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ ccva))) @ (^ [Xz:$i] : XA2))) @ (^ [Xw:$i] : XB2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwrex @ (^ [Xv:$i] : ((cwbr @ ccc0 @ (ccv @ Xv) @ cclt) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ ccno) @ (ccfv @ (ccv @ Xy1) @ ccno) @ ccaddc) @ (cco @ (ccv @ Xv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva) @ ccno) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))) @ (^ [Xv:$i] : ccr)) => (cwrex @ (^ [Xv:$i] : ((cwbr @ ccc0 @ (ccv @ Xv) @ cclt) & (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xu) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw)) @ ccno) @ (cco @ (ccv @ Xv) @ (ccfv @ (ccv @ Xu) @ ccno) @ ccmul) @ ccle)) @ (^ [Xu:$i] : (cco @ XA2 @ XB2 @ ccph))))) @ (^ [Xv:$i] : ccr)))))))))))))).
