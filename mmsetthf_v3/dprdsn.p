...
thf(cdprdsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((cwbr @ XG @ (ccsn @ (ccop @ XA2 @ XS)) @ (ccdm @ ccdprd)) & ((cco @ XG @ (ccsn @ (ccop @ XA2 @ XS)) @ ccdprd) = XS)))))))).
