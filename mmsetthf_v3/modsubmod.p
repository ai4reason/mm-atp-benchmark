...
thf(cmodsubmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XM @ ccrp)) => ((cco @ (cco @ (cco @ XA2 @ XM @ ccmo) @ XB2 @ ccmin) @ XM @ ccmo) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XM @ ccmo))))))).
