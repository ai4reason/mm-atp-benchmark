...
thf(areprinrn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => (! [Xc:$i] : (Xph => ((cwcel @ (ccv @ Xc) @ (cco @ (ccin @ XA2 @ XB2) @ XM @ (ccfv @ XS @ ccrepr))) <=> ((cwcel @ (ccv @ Xc) @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))) & (cwss @ (ccrn @ (ccv @ Xc)) @ XB2)))))))))))))).
...
thf(chashreprin_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwss @ XB2 @ ccn)) => (Xph => ((ccfv @ (cco @ (ccin @ XA2 @ XB2) @ XM @ (ccfv @ XS @ ccrepr)) @ cchash) = (ccsu @ (cco @ XB2 @ XM @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ XA2 @ (ccfv @ ccn @ ccind)))))))))))))))))))).
