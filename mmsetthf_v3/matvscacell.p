...
thf(cmatvscacell_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XA2 @ ccvsca)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccrg) & ((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XX @ XY @ Xc_x)) = (cco @ XX @ (cco @ XI @ XJ @ XY) @ Xc_xp)))))))))))))))))))).
