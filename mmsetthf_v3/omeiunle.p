...
thf(aomeunile_thm,axiom,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XY @ (ccpw @ XX))) => ((Xph => (cwbr @ XY @ ccom @ ccdom)) => (Xph => (cwbr @ (ccfv @ (ccuni @ XY) @ XO) @ (ccfv @ (ccres @ XO @ XY) @ ccsumge0) @ ccle))))))))))).
...
thf(comeiunle_conj,conjecture,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (((? [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X)) => (! [X:$i] : ((^ [Xn:$i] : (Xph @ Xn)) @ X))) => ((cwnfc @ (^ [Xn:$i] : (XE @ Xn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XO @ ccome))) => ((XX = (ccuni @ (ccdm @ XO))) => ((! [Xn:$i] : (XZ = (ccfv @ (XN @ Xn) @ ccuz))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ XZ @ (ccpw @ XX) @ (XE @ Xn)))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xn)))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XE @ Xn)) @ XO))) @ ccsumge0) @ ccle)))))))))))))))).
