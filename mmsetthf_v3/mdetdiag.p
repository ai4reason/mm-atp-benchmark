...
thf(amadetsumid_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xr:$i] : ((XA2 @ Xr) = (cco @ XN @ XR @ ccmat))) => ((! [Xr:$i] : (XB2 = (ccfv @ (XA2 @ Xr) @ ccbs))) => ((! [Xr:$i] : ((XU @ Xr) = (ccfv @ XR @ ccmgp))) => ((! [Xr:$i] : ((XY @ Xr) = (ccfv @ XR @ cczrh))) => ((! [Xr:$i] : ((XS @ Xr) = (ccfv @ XN @ ccpsgn))) => ((! [Xr:$i] : ((Xc_x @ Xr) = (ccfv @ XR @ ccmulr))) => (! [Xr:$i] : (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2) & (XP = (ccres @ ccid @ XN))) => ((cco @ (ccfv @ XP @ (cccom @ (XY @ Xr) @ (XS @ Xr))) @ (cco @ (XU @ Xr) @ (ccmpt @ (^ [Xr:$i] : XN) @ (^ [Xr:$i] : (cco @ (ccfv @ (ccv @ Xr) @ XP) @ (ccv @ Xr) @ XM))) @ ccgsu) @ (Xc_x @ Xr)) = (cco @ (XU @ Xr) @ (ccmpt @ (^ [Xr:$i] : XN) @ (^ [Xr:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xr) @ XM))) @ ccgsu))))))))))))))))))))).
...
thf(amdetdiaglem_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XD @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XA2 @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xi @ Xj) = (ccfv @ (XA2 @ Xi @ Xj @ Xk) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XG @ Xi @ Xj) = (ccfv @ (XR @ Xi @ Xj) @ ccmgp)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_0 = (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XH @ Xi @ Xj) = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XZ @ Xi @ Xj @ Xk) = (ccfv @ (XR @ Xi @ Xj) @ cczrh))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XS @ Xi @ Xj @ Xk) = (ccfv @ XN @ ccpsgn))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xc_x @ Xi @ Xj @ Xk) = (ccfv @ (XR @ Xi @ Xj) @ ccmulr))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((((cwcel @ (XR @ Xi @ Xj) @ cccrg) & (cwcel @ XN @ ccfn) & (cwcel @ XM @ (XB2 @ Xi @ Xj))) & (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) != (ccv @ Xj)) => ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) = Xc_0))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)) & ((cwcel @ XP @ (XH @ Xi @ Xj)) & (XP != (ccres @ ccid @ XN)))) => ((cco @ (ccfv @ XP @ (cccom @ (XZ @ Xi @ Xj @ Xk) @ (XS @ Xi @ Xj @ Xk))) @ (cco @ (XG @ Xi @ Xj) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XP) @ (ccv @ Xk) @ XM))) @ ccgsu) @ (Xc_x @ Xi @ Xj @ Xk)) = Xc_0)))))))))))))))))))))))))))).
thf(aiffalse_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ Xph) => ((ccif @ Xph @ XA2 @ XB2) = XB2)))))).
thf(ccsb_tp,type,(ccsb : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(agsummptif1n0_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ ccmnd)) => ((! [Xn:$i] : (Xph => (cwcel @ XI @ (XW @ Xn)))) => ((Xph => (cwcel @ XX @ XI)) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : XI) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = XX) @ XA2 @ Xc_0))))) => ((Xph => (cwcel @ XA2 @ (ccfv @ XG @ ccbs))) => (! [Xn:$i] : (Xph => ((cco @ XG @ (XF @ Xn) @ ccgsu) = XA2)))))))))))))))))).
...
thf(cmdetdiag_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XD @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XA2 @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xi @ Xj) = (ccfv @ (XA2 @ Xi @ Xj @ Xk) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XG @ Xi @ Xj) = (ccfv @ (XR @ Xi @ Xj) @ ccmgp)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_0 = (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (((cwcel @ (XR @ Xi @ Xj) @ cccrg) & (cwcel @ XN @ ccfn) & (cwcel @ XM @ (XB2 @ Xi @ Xj))) => ((cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) != (ccv @ Xj)) => ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) = Xc_0))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)) => ((ccfv @ XM @ (XD @ Xi @ Xj @ Xk)) = (cco @ (XG @ Xi @ Xj) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ (ccv @ Xk) @ XM))) @ ccgsu))))))))))))))))))))).
