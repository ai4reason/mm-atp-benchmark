...
thf(abitsres_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn0)) => ((ccin @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XN @ ccuz)) = (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl) @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ ccbits)))))).
...
thf(cbitsuz_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn0)) => ((cwbr @ (cco @ cc2 @ XN @ ccexp) @ XA2 @ ccdvds) <=> (cwss @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XN @ ccuz))))))).
