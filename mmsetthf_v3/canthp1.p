...
thf(acda1dif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (cco @ XA2 @ cc1o @ cccda)) => (cwbr @ (ccdif @ (cco @ XA2 @ cc1o @ cccda) @ (ccsn @ XB2)) @ XA2 @ ccen))))).
