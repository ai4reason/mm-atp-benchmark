...
thf(csupxrgelem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ ccxr))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ ccrp)) => (cwrex @ (^ [Xy1:$i] : (cwbr @ XB2 @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccxad) @ cclt)) @ (^ [Xy1:$i] : XA2)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))))))).
