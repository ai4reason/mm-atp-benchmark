...
thf(cdchr2sum_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : (XG = (ccfv @ (XN @ Xa) @ ccdchr))) => ((! [Xa:$i] : (XZ = (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : ((XD @ Xa) = (ccfv @ XG @ ccbs))) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((! [Xa:$i] : (Xph => (cwcel @ XX @ (XD @ Xa)))) => ((! [Xa:$i] : (Xph => (cwcel @ XY @ (XD @ Xa)))) => (! [Xa:$i] : (Xph => ((ccsu @ XB2 @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ XX) @ (ccfv @ (ccfv @ (ccv @ Xa) @ XY) @ cccj) @ ccmul))) = (ccif @ (XX = XY) @ (ccfv @ (XN @ Xa) @ ccphi) @ ccc0))))))))))))))))))).
