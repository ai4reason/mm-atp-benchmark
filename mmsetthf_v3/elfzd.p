...
thf(celfzd_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwbr @ XM @ XK @ ccle)) => ((Xph => (cwbr @ XK @ XN @ ccle)) => (Xph => (cwcel @ XK @ (cco @ XM @ XN @ ccfz))))))))))))).
