...
thf(aiocval_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccioc) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ cclt) & (cwbr @ (ccv @ Xx3) @ XB2 @ ccle))) @ (^ [Xx3:$i] : ccxr))))))).
...
thf(corvclteel_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ (cco @ XX @ XA2 @ (ccorvc @ ccle)) @ (ccdm @ XP))))))))))).
