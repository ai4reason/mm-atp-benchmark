...
thf(adrex2_b_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) => ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))) => ((? [Xx3:$i] : (Xph @ Xx3)) <=> (? [Xx3:$i] : (Xps @ Xx3)))))))).
thf(adrex1_b_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) => ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))) => ((? [Xx3:$i] : (Xph @ Xx3)) <=> (? [Xx3:$i] : (Xps @ Xx3)))))))).
...
thf(anfnae_b_thm,axiom,((? [X:$i] : ((^ [Xx3:$i] : (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))))) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))))) @ X)))).
...
thf(cdfid3_b_conj,conjecture,(ccid = (ccopab_b @ (^ [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))))).
