...
thf(csigagenss2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((((ccuni @ XA2) = (ccuni @ XB2)) & (cwss @ XA2 @ (ccfv @ XB2 @ ccsigagen)) & (cwcel @ XB2 @ XV)) => (cwss @ (ccfv @ XA2 @ ccsigagen) @ (ccfv @ XB2 @ ccsigagen))))))).
