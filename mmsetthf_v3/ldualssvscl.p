...
thf(cldualssvscl_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XR = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XR @ ccbs)) => ((XD = (ccfv @ XW @ ccld)) => ((Xc_x = (ccfv @ XD @ ccvsca)) => ((XS = (ccfv @ XD @ cclss)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XX @ XK)) => ((Xph => (cwcel @ XY @ XU)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XU)))))))))))))))))))))).
