...
thf(ahlpasch_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (XA2 != XB2)) => ((Xph => (cwbr @ XC @ XD @ (ccfv @ XB2 @ XK))) => ((Xph => (cwcel @ XA2 @ (cco @ XX @ XC @ XI))) => (Xph => (cwrex @ (^ [Xe:$i] : ((cwbr @ XA2 @ (ccv @ Xe) @ (ccfv @ XB2 @ XK)) & (cwcel @ (ccv @ Xe) @ (cco @ XX @ XD @ XI)))) @ (^ [Xe:$i] : XP)))))))))))))))))))))))))).
...
thf(cinaghl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XX @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccinag))) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwbr @ XD @ XA2 @ (ccfv @ XB2 @ XK))) => ((Xph => (cwbr @ XF @ XC @ (ccfv @ XB2 @ XK))) => ((Xph => (cwbr @ XY @ XX @ (ccfv @ XB2 @ XK))) => (Xph => (cwbr @ XY @ (ccs3 @ XD @ XB2 @ XF) @ (ccfv @ XG @ ccinag))))))))))))))))))))))))))))))).
