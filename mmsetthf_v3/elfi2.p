...
thf(celfi2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (ccint @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdif @ (ccin @ (ccpw @ XB2) @ ccfn) @ (ccsn @ cc0)))))))))).
