...
thf(adomnrrg_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccdomn) & (cwcel @ XX @ XB2) & (XX != Xc_0)) => (cwcel @ XX @ XE))))))))))).
thf(cdeg1ldgdomn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((XA2 = (ccfv @ XF @ ccco1)) => (((cwcel @ XR @ ccdomn) & (cwcel @ XF @ XB2) & (XF != Xc_0)) => (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ XA2) @ XE))))))))))))))))).
