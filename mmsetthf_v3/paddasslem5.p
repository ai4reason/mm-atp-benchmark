...
thf(cpaddasslem5_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [XA2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xs1:$i] : (! [Xr:$i] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ (ccv @ Xr) @ XA2) & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2) & (cwcel @ (ccv @ Xz) @ XA2))) & ((~ (cwbr @ (ccv @ Xr) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_or) @ Xc_le)) & (cwbr @ (ccv @ Xr) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_or) @ Xc_le) & (cwbr @ (ccv @ Xs1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_or) @ Xc_le))) => ((ccv @ Xs1) != (ccv @ Xz)))))))))))))))).
