...
thf(abndatandm_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwcel @ XA2 @ (ccdm @ ccatan))))).
...
thf(catantayl_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ (cco @ (cco @ (ccneg @ cci) @ (ccv @ Xn) @ ccexp) @ (cco @ cci @ (ccv @ Xn) @ ccexp) @ ccmin) @ ccmul) @ cc2 @ ccdiv) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccv @ Xn) @ ccdiv) @ ccmul))))) => (! [Xn:$i] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ cc1) @ (ccfv @ XA2 @ ccatan) @ ccli))))))).
