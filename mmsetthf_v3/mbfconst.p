...
thf(ambfconstlem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XC @ ccr)) => (cwcel @ (ccima @ (cccnv @ (ccxp @ XA2 @ (ccsn @ XC))) @ XB2) @ (ccdm @ ccvol))))))).
...
thf(cmbfconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccc)) => (cwcel @ (ccxp @ XA2 @ (ccsn @ XB2)) @ ccmbf))))).
