...
thf(abezoutlem2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XM @ Xx3 @ Xy1 @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccn)))))) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (XG = (ccinf @ (XM @ Xx3 @ Xy1 @ Xz) @ ccr @ cclt))))) => ((Xph => (~ ((XA2 = ccc0) & (XB2 = ccc0)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ XG @ (XM @ Xx3 @ Xy1 @ Xz))))))))))))))))).
...
thf(abezoutlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XM @ Xx3 @ Xy1 @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccn)))))) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((XA2 != ccc0) => (cwcel @ (ccfv @ XA2 @ ccabs) @ (XM @ Xx3 @ Xy1 @ Xz))))))))))))))).
thf(ccmin_tp,type,(ccmin : ($i > $o))).
thf(ccfl_tp,type,(ccfl : ($i > $o))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(ccrp_tp,type,(ccrp : ($i > $o))).
thf(ccmo_tp,type,(ccmo : ($i > $o))).
thf(abezoutlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xz:$i] : ((XM @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccn)))) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((! [Xz:$i] : (XG = (ccinf @ (XM @ Xz) @ ccr @ cclt))) => ((Xph => (~ ((XA2 = ccc0) & (XB2 = ccc0)))) => (! [Xz:$i] : (Xph => ((cwcel @ XC @ (XM @ Xz)) => (cwbr @ XG @ XC @ ccdvds)))))))))))))))).
...
thf(cbezoutlem4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xz:$i] : ((XM @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccn)))) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((! [Xz:$i] : (XG = (ccinf @ (XM @ Xz) @ ccr @ cclt))) => ((Xph => (~ ((XA2 = ccc0) & (XB2 = ccc0)))) => (! [Xz:$i] : (Xph => (cwcel @ (cco @ XA2 @ XB2 @ ccgcd) @ (XM @ Xz))))))))))))))).
