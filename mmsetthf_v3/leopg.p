...
thf(cleopg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ XA2) & (cwcel @ XU @ XB2)) => ((cwbr @ XT @ XU @ ccleo) <=> ((cwcel @ (cco @ XU @ XT @ cchod) @ ccho) & (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (cco @ (ccfv @ (ccv @ Xx3) @ (cco @ XU @ XT @ cchod)) @ (ccv @ Xx3) @ ccsp) @ ccle)) @ (^ [Xx3:$i] : cchil)))))))))).
