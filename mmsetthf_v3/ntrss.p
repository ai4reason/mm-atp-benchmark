...
thf(cntrss_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX) & (cwss @ XT @ XS)) => (cwss @ (ccfv @ XT @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)))))))))).
