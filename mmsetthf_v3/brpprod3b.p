...
thf(approdcnveq_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccpprod @ XR @ XS) = (cccnv @ (ccpprod @ (cccnv @ XR) @ (cccnv @ XS))))))).
...
thf(cbrpprod3b_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwbr @ XX @ (ccop @ XY @ XZ) @ (ccpprod @ XR @ XS)) <=> (? [Xz:$i] : (? [Xw:$i] : ((XX = (ccop @ (ccv @ Xz) @ (ccv @ Xw))) & (cwbr @ (ccv @ Xz) @ XY @ XR) & (cwbr @ (ccv @ Xw) @ XZ @ XS)))))))))))))).
