...
thf(abpos1lem_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((! [Xp:$i] : ((cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)) => (Xph @ Xp))) => ((! [Xp:$i] : ((cwcel @ XN @ (ccfv @ XP @ ccuz)) => (Xph @ Xp))) => ((cwcel @ XP @ ccprime) => ((! [Xp:$i] : (cwcel @ (XA2 @ Xp) @ ccn0)) => ((! [Xp:$i] : ((cco @ (XA2 @ Xp) @ cc2 @ ccmul) = (XB2 @ Xp))) => ((! [Xp:$i] : (cwbr @ (XA2 @ Xp) @ XP @ cclt)) => ((! [Xp:$i] : ((cwbr @ XP @ (XB2 @ Xp) @ cclt) | (XP = (XB2 @ Xp)))) => (! [Xp:$i] : ((cwcel @ XN @ (ccfv @ (XA2 @ Xp) @ ccuz)) => (Xph @ Xp)))))))))))))))).
...
thf(cbpos1_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwbr @ XN @ (ccdc @ cc6 @ cc4) @ ccle)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime))))).
