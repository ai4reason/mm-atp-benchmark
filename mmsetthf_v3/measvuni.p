...
thf(asigaclcuni_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => (! [Xk:$i] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ XS)) @ (^ [Xk:$i] : (XA2 @ Xk))) & (cwbr @ (XA2 @ Xk) @ ccom @ ccdom)) => (cwcel @ (cciun @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XS)))))))).
...
thf(cmeasvuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ (ccfv @ XS @ ccmeas)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XS)) @ (^ [Xx3:$i] : XA2)) & ((cwbr @ XA2 @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XM) = (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ XM)))))))))).
