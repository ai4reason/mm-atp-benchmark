...
thf(csrgen1zr_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xc_as = (ccfv @ XR @ ccmulr)) => ((XZ = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccsrg) & (cwfn @ Xc_pl @ (ccxp @ XB2 @ XB2)) & (cwfn @ Xc_as @ (ccxp @ XB2 @ XB2))) => ((cwbr @ XB2 @ cc1o @ ccen) <=> ((Xc_pl = (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))) & (Xc_as = (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ)))))))))))))))).
