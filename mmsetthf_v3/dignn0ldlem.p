...
thf(cdignn0ldlem_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn) & (cwcel @ XK @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc) @ ccuz))) => (cwbr @ XN @ (cco @ XB2 @ XK @ ccexp) @ cclt)))))).
