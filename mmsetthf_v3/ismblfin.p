...
thf(amblfinlem4_thm,axiom,(! [XA2:($i > $o)] : ((((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) & (cwcel @ XA2 @ (ccdm @ ccvol))) => ((ccfv @ XA2 @ ccovol) = (ccsup @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : ((cwss @ (ccv @ Xb) @ XA2) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld)))) @ ccr @ cclt))))).
...
thf(aopnmbl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwcel @ XA2 @ (ccdm @ ccvol))))).
...
thf(amblfinlem2_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) & (cwcel @ XM @ ccr) & (cwbr @ XM @ (ccfv @ XA2 @ ccovol) @ cclt)) => (cwrex @ (^ [Xs1:$i] : ((cwss @ (ccv @ Xs1) @ XA2) & (cwbr @ XM @ (ccfv @ (ccv @ Xs1) @ ccovol) @ cclt))) @ (^ [Xs1:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))))).
...
thf(amblfinlem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) & ((cwss @ XB2 @ ccr) & (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr)) & (((ccfv @ XA2 @ ccovol) = (ccsup @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : ((cwss @ (ccv @ Xb) @ XA2) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld)))) @ ccr @ cclt)) & ((ccfv @ XB2 @ ccovol) = (ccsup @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : ((cwss @ (ccv @ Xb) @ XB2) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld)))) @ ccr @ cclt)))) => ((ccsup @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : ((cwss @ (ccv @ Xb) @ (ccdif @ XA2 @ XB2)) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld)))) @ ccr @ cclt) = (ccfv @ (ccdif @ XA2 @ XB2) @ ccovol)))))).
...
thf(aismbl2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccr) => (cwbr @ (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccaddc) @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccle))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
thf(cismblfin_conj,conjecture,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) => ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((ccfv @ XA2 @ ccovol) = (ccsup @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : ((cwss @ (ccv @ Xb) @ XA2) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld)))) @ ccr @ cclt)))))).
