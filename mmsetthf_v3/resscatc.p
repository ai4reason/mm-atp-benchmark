...
thf(ahomfeq_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((XH = (ccfv @ XC @ cchom)) => ((XJ = (ccfv @ XD @ cchom)) => ((Xph => (XB2 = (ccfv @ XC @ ccbs))) => ((Xph => (XB2 = (ccfv @ XD @ ccbs))) => (Xph => (((ccfv @ XC @ cchomf) = (ccfv @ XD @ cchomf)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XJ))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))))).
...
thf(cresscatc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XC = (ccfv @ XU @ cccatc)) => ((XD = (ccfv @ XV @ cccatc)) => ((Xph => (cwcel @ XU @ XW)) => ((Xph => (cwss @ XV @ XU)) => (Xph => (((ccfv @ (cco @ XC @ XV @ ccress) @ cchomf) = (ccfv @ XD @ cchomf)) & ((ccfv @ (cco @ XC @ XV @ ccress) @ cccomf) = (ccfv @ XD @ cccomf))))))))))))))).
