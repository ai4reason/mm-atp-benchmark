...
thf(cupixp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xb:$i] : ((XX @ Xb) = (ccixp @ (^ [Xb:$i] : XA2) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xb) @ XC))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xb:$i] : ((XP @ Xx3 @ Xw @ Xb) = (ccmpt @ (^ [Xw:$i] : XA2) @ (^ [Xw:$i] : (ccmpt @ (^ [Xx3:$i] : (XX @ Xb)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ (ccv @ Xx3)))))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xb:$i] : (((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS) & (cwral @ (^ [Xa:$i] : (cwf @ XB2 @ (ccfv @ (ccv @ Xa) @ XC) @ (ccfv @ (ccv @ Xa) @ XF))) @ (^ [Xa:$i] : XA2))) => (cweu @ (^ [Xh:$i] : ((cwf @ XB2 @ (XX @ Xb) @ (ccv @ Xh)) & (cwral @ (^ [Xa:$i] : ((ccfv @ (ccv @ Xa) @ XF) = (cccom @ (ccfv @ (ccv @ Xa) @ (XP @ Xx3 @ Xw @ Xb)) @ (ccv @ Xh)))) @ (^ [Xa:$i] : XA2)))))))))))))))))))).
