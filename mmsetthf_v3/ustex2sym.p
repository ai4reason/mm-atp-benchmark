...
thf(custex2sym_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwrex @ (^ [Xw:$i] : (((cccnv @ (ccv @ Xw)) = (ccv @ Xw)) & (cwss @ (cccom @ (ccv @ Xw) @ (ccv @ Xw)) @ XV))) @ (^ [Xw:$i] : XU))))))).
