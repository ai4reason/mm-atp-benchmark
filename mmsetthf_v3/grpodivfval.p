...
thf(adf_gdiv_ax,axiom,(ccgs = (ccmpt @ (^ [Xg1:$i] : ccgr) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccv @ Xg1)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccv @ Xg1)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xg1) @ ccgn)) @ (ccv @ Xg1))))))))).
thf(cgrpodivfval_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XN = (ccfv @ XG @ ccgn)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccfv @ XG @ ccgs)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XG @ ccgr) => ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XN) @ XG)))))))))))))))).
