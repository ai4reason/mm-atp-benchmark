...
thf(arankuni2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccfv @ (ccuni @ XA2) @ ccrnk) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccrnk))))))).
...
thf(arankr1id_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) <=> ((ccfv @ (ccfv @ XA2 @ ccr1) @ ccrnk) = XA2)))).
...
thf(arankpw_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccfv @ (ccpw @ XA2) @ ccrnk) = (ccsuc @ (ccfv @ XA2 @ ccrnk)))))).
...
thf(crankuni_conj,conjecture,(! [XA2:($i > $o)] : ((ccfv @ (ccuni @ XA2) @ ccrnk) = (ccuni @ (ccfv @ XA2 @ ccrnk))))).
