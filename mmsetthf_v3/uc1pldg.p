...
thf(cuc1pldg_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XU = (ccfv @ XR @ ccui)) => ((XC = (ccfv @ XR @ ccuc1p)) => ((cwcel @ XF @ XC) => (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) @ XU))))))))))).
