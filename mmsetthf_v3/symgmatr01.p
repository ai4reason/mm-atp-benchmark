...
thf(asymgmatr01lem_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => (! [Xq:$i] : (((cwcel @ XK @ (XN @ Xq)) & (cwcel @ XL @ (XN @ Xq))) => ((cwcel @ XQ @ (ccdif @ XP @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XL)) @ (^ [Xq:$i] : XP)))) => (cwrex @ (^ [Xk:$i] : ((ccif @ ((ccv @ Xk) = XK) @ (ccif @ ((ccfv @ (ccv @ Xk) @ XQ) = XL) @ (XA2 @ Xq) @ (XB2 @ Xq)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ XQ) @ (XM @ Xq))) = (XB2 @ Xq))) @ (^ [Xk:$i] : (XN @ Xq)))))))))))))))).
...
thf(csymgmatr01_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_1:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xq:$i] : ((Xc_0 @ Xq) = (ccfv @ (XR @ Xi @ Xj @ Xk @ Xq) @ cc0g)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xq:$i] : ((Xc_1 @ Xq) = (ccfv @ (XR @ Xi @ Xj @ Xk @ Xq) @ ccur)))))) => (! [Xq:$i] : (((cwcel @ XK @ (XN @ Xq)) & (cwcel @ XL @ (XN @ Xq))) => ((cwcel @ XQ @ (ccdif @ XP @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XL)) @ (^ [Xq:$i] : XP)))) => (cwrex @ (^ [Xk:$i] : ((cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ XQ) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xq))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xq))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XK) @ (ccif @ ((ccv @ Xj) = XL) @ (Xc_1 @ Xq) @ (Xc_0 @ Xq)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XM @ Xq))))))) = (Xc_0 @ Xq))) @ (^ [Xk:$i] : (XN @ Xq))))))))))))))))))).
