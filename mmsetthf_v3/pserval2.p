...
thf(apserval_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xn:$i] : ((cwcel @ (XX @ Xx3 @ Xn) @ ccc) => ((ccfv @ (XX @ Xx3 @ Xn) @ (XG @ Xx3 @ Xn)) = (ccmpt @ (^ [Xm:$i] : ccn0) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ XA2) @ (cco @ (XX @ Xx3 @ Xn) @ (ccv @ Xm) @ ccexp) @ ccmul)))))))))))).
