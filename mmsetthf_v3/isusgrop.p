...
thf(cisusgrop_conj,conjecture,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XV @ XW) & (cwcel @ XE @ XX)) => ((cwcel @ (ccop @ XV @ XE) @ ccusgr) <=> (cwf1 @ (ccdm @ XE) @ (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccv @ Xp) @ cchash) = cc2)) @ (^ [Xp:$i] : (ccpw @ XV))) @ XE)))))))).
