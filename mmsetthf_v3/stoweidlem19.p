...
thf(cstoweidlem19_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xt:$i] : (XF @ Xx3 @ Xt)))) => (((? [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X)) => (! [X:$i] : ((^ [Xt:$i] : (Xph @ Xt)) @ X))) => ((! [Xt:$i] : (! [Xf1:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ XA2)) => (cwf @ XT @ ccr @ (ccv @ Xf1))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ XA2) & (cwcel @ (ccv @ Xg1) @ XA2)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ XA2))))) => ((! [Xx3:$i] : (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xx3))) @ XA2)))) => ((! [Xx3:$i] : (! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XF @ Xx3 @ Xt) @ XA2)))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xt) => (cwcel @ (XN @ Xx3 @ Xf1 @ Xg1) @ ccn0)))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xt) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xt)) @ (XN @ Xx3 @ Xf1 @ Xg1) @ ccexp))) @ XA2))))))))))))))))))).
