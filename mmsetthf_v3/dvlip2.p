...
thf(advlipcn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwss @ (XX @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwf @ (XX @ Xx3) @ ccc @ XF))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XR @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (XB2 = (cco @ (XA2 @ Xx3) @ (XR @ Xx3) @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => ((Xph => (cwss @ XB2 @ (ccdm @ (cco @ ccc @ XF @ ccdv)))) => ((Xph => (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccc @ XF @ ccdv)) @ ccabs) @ XM @ ccle))) => (! [Xx3:$i] : ((Xph & ((cwcel @ (XY @ Xx3) @ XB2) & (cwcel @ (XZ @ Xx3) @ XB2))) => (cwbr @ (ccfv @ (cco @ (ccfv @ (XY @ Xx3) @ XF) @ (ccfv @ (XZ @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ XM @ (ccfv @ (cco @ (XY @ Xx3) @ (XZ @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle))))))))))))))))))))).
