...
thf(acaufpm_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XF @ (ccfv @ XD @ ccca))) => (cwcel @ XF @ (cco @ XX @ ccc @ ccpm))))))).
...
thf(ccauss_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwf @ ccn @ XY @ XF)) => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> (cwcel @ XF @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ ccca))))))))).
