...
thf(comndmul2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_le = (ccfv @ XM @ ccple)) => ((Xc_x = (ccfv @ XM @ ccmg)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => (((cwcel @ XM @ ccomnd) & ((cwcel @ XX @ XB2) & (cwcel @ XN @ ccn0)) & (cwbr @ Xc_0 @ XX @ Xc_le)) => (cwbr @ Xc_0 @ (cco @ XN @ XX @ Xc_x) @ Xc_le)))))))))))))).
