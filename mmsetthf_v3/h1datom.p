...
thf(ch1datom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ cchil)) => ((cwss @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) => ((XA2 = (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) | (XA2 = cc0h))))))).
