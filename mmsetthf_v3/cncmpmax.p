...
thf(ccncmpmax_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XT = (ccuni @ XJ)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwcel @ XJ @ cccmp)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (XT != cc0)) => (Xph => ((cwcel @ (ccsup @ (ccrn @ XF) @ ccr @ cclt) @ (ccrn @ XF)) & (cwcel @ (ccsup @ (ccrn @ XF) @ ccr @ cclt) @ ccr) & (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ XF) @ (ccsup @ (ccrn @ XF) @ ccr @ cclt) @ ccle)) @ (^ [Xt:$i] : XT))))))))))))))).
