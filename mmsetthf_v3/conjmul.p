...
thf(amuleqadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((cco @ XA2 @ XB2 @ ccmul) = (cco @ XA2 @ XB2 @ ccaddc)) <=> ((cco @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ XB2 @ cc1 @ ccmin) @ ccmul) = cc1)))))).
thf(cconjmul_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((((cwcel @ XP @ ccc) & (XP != ccc0)) & ((cwcel @ XQ @ ccc) & (XQ != ccc0))) => (((cco @ (cco @ cc1 @ XP @ ccdiv) @ (cco @ cc1 @ XQ @ ccdiv) @ ccaddc) = cc1) <=> ((cco @ (cco @ XP @ cc1 @ ccmin) @ (cco @ XQ @ cc1 @ ccmin) @ ccmul) = cc1)))))).
