...
thf(amp2pm2mplem5_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_as:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > $o)] : ((! [Xp:$i] : ((XA2 @ Xp) = (cco @ XN @ XR @ ccmat))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((XQ @ Xi @ Xj @ Xk @ Xp) = (ccfv @ (XA2 @ Xp) @ ccpl1)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (XL = (ccfv @ (XQ @ Xi @ Xj @ Xk @ Xp) @ ccbs)))))) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XE = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XY = (ccfv @ XR @ ccv1)) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((XI @ Xi @ Xj @ Xk @ Xp) = (ccmpt @ (^ [Xp:$i] : XL) @ (^ [Xp:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xp) @ ccco1))) @ (cco @ (ccv @ Xk) @ XY @ XE) @ Xc_x))) @ ccgsu))))))))))) => ((XP = (ccfv @ XR @ ccpl1)) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((Xc_as @ Xi @ Xj @ Xp) = (ccfv @ (XQ @ Xi @ Xj @ Xk @ Xp) @ ccvsca)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((Xc_ex @ Xi @ Xj @ Xk @ Xp) = (ccfv @ (ccfv @ (XQ @ Xi @ Xj @ Xk @ Xp) @ ccmgp) @ ccmg)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((XX @ Xi @ Xj @ Xk @ Xp) = (ccfv @ (XA2 @ Xp) @ ccv1)))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XO @ XL)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ XO @ (XI @ Xi @ Xj @ Xk @ Xp)) @ (ccv @ Xk) @ ccdecpmat) @ (cco @ (ccv @ Xk) @ (XX @ Xi @ Xj @ Xk @ Xp) @ (Xc_ex @ Xi @ Xj @ Xk @ Xp)) @ (Xc_as @ Xi @ Xj @ Xp)))) @ (ccfv @ (XQ @ Xi @ Xj @ Xk @ Xp) @ cc0g) @ ccfsupp)))))))))))))))))))))))))))))))).
...
thf(amp2pm2mplem4_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((! [Xp:$i] : ((XA2 @ Xp) = (cco @ XN @ XR @ ccmat))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((XQ @ Xi @ Xj @ Xk @ Xp) = (ccfv @ (XA2 @ Xp) @ ccpl1)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : (XL = (ccfv @ (XQ @ Xi @ Xj @ Xk @ Xp) @ ccbs)))))) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XE = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XY = (ccfv @ XR @ ccv1)) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((XI @ Xi @ Xj @ Xk @ Xp) = (ccmpt @ (^ [Xp:$i] : XL) @ (^ [Xp:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xp) @ ccco1))) @ (cco @ (ccv @ Xk) @ XY @ XE) @ Xc_x))) @ ccgsu))))))))))) => ((XP = (ccfv @ XR @ ccpl1)) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xp:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XO @ XL)) & (cwcel @ (XK @ Xp) @ ccn0)) => ((cco @ (ccfv @ XO @ (XI @ Xi @ Xj @ Xk @ Xp)) @ (XK @ Xp) @ ccdecpmat) = (ccfv @ (XK @ Xp) @ (ccfv @ XO @ ccco1))))))))))))))))))))))))))))).
...
thf(aeqcoe1ply1eq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ (XR @ Xk) @ ccpl1))) => ((! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ (XP @ Xk) @ ccbs))) => ((! [Xk:$i] : (XA2 = (ccfv @ (XK @ Xk) @ ccco1))) => ((! [Xk:$i] : (XC = (ccfv @ (XL @ Xk) @ ccco1))) => (! [Xk:$i] : (((cwcel @ (XR @ Xk) @ ccrg) & (cwcel @ (XK @ Xk) @ (XB2 @ Xk)) & (cwcel @ (XL @ Xk) @ (XB2 @ Xk))) => ((cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ XA2) = (ccfv @ (ccv @ Xk) @ XC))) @ (^ [Xk:$i] : ccn0)) => ((XK @ Xk) = (XL @ Xk))))))))))))))))).
