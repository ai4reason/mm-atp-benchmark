...
thf(anbedgusgr_thm,axiom,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : ((XV @ Xe) = (ccfv @ (XG @ Xe) @ ccvtx))) => ((! [Xe:$i] : (XE = (ccfv @ (XG @ Xe) @ ccedg))) => (! [Xe:$i] : (((cwcel @ (XG @ Xe) @ ccusgr) & (cwcel @ XU @ (XV @ Xe))) => ((ccfv @ (cco @ (XG @ Xe) @ XU @ ccnbgr) @ cchash) = (ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) <=> ((Xph & Xps) & Xch)))))).
thf(crusgrpropedg_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xe:$i] : ((XV @ Xv @ Xe) = (ccfv @ XG @ ccvtx)))) => (! [Xe:$i] : ((cwbr @ XG @ (XK @ Xe) @ ccrusgr) => ((cwcel @ XG @ ccusgr) & (cwcel @ (XK @ Xe) @ ccxnn0) & (cwral @ (^ [Xv:$i] : ((ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ (ccv @ Xv) @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccfv @ XG @ ccedg))) @ cchash) = (XK @ Xe))) @ (^ [Xv:$i] : (XV @ Xv @ Xe))))))))))).
