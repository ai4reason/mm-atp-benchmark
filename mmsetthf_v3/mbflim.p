...
thf(ambflimlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xn) @ ccz)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xx3 @ Xn))) @ (XC @ Xx3 @ Xn) @ ccli)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xn))) @ ccmbf))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ XZ) & (cwcel @ (ccv @ Xx3) @ XA2))) => (cwcel @ (XB2 @ Xx3 @ Xn) @ ccr)))) => (! [Xn:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xn))) @ ccmbf))))))))))))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aclimre_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccre)))) => (Xph => (cwbr @ XG @ (ccfv @ XA2 @ ccre) @ ccli)))))))))))))))).
...
thf(aclimim_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccim)))) => (Xph => (cwbr @ XG @ (ccfv @ XA2 @ ccim) @ ccli)))))))))))))))).
...
thf(cmbflim_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xn) @ ccz)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xx3 @ Xn))) @ (XC @ Xx3 @ Xn) @ ccli)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xn))) @ ccmbf))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ XZ) & (cwcel @ (ccv @ Xx3) @ XA2))) => (cwcel @ (XB2 @ Xx3 @ Xn) @ (XV @ Xx3 @ Xn))))) => (! [Xn:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xn))) @ ccmbf)))))))))))))))).
