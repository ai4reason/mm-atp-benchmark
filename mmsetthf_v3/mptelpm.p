...
thf(cmptelpm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XC))) => ((! [Xx3:$i] : (Xph => (cwss @ XA2 @ (XD @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XC @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XD @ Xx3) @ (XW @ Xx3)))) => (! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XC @ (XD @ Xx3) @ ccpm)))))))))))))))).
