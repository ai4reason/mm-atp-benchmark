...
thf(cprmdvdsfmtnof1lem2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (((cwcel @ XF @ (ccrn @ ccfmtno)) & (cwcel @ XG @ (ccrn @ ccfmtno))) => (((cwcel @ XI @ ccprime) & (cwbr @ XI @ XF @ ccdvds) & (cwbr @ XI @ XG @ ccdvds)) => (XF = XG))))))).
