...
thf(aimasncls_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) & ((cwss @ XR @ (ccxp @ XX @ XY)) & (cwcel @ XA2 @ XX))) => (cwss @ (ccfv @ (ccima @ XR @ (ccsn @ XA2)) @ (ccfv @ XK @ cccl)) @ (ccima @ (ccfv @ XR @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cccl)) @ (ccsn @ XA2))))))))))))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(cc2nd_tp,type,(cc2nd : ($i > $o))).
thf(cc1st_tp,type,(cc1st : ($i > $o))).
thf(autop3cls_thm,axiom,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XU @ ccutop)) => ((((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwss @ XM @ (ccxp @ XX @ XX))) & ((cwcel @ XV @ XU) & ((cccnv @ XV) = XV))) => (cwss @ (ccfv @ XM @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccl)) @ (cccom @ XV @ (cccom @ XM @ XV))))))))))).
...
thf(austex3sym_thm,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwrex @ (^ [Xw:$i] : (((cccnv @ (ccv @ Xw)) = (ccv @ Xw)) & (cwss @ (cccom @ (ccv @ Xw) @ (cccom @ (ccv @ Xw) @ (ccv @ Xw))) @ XV))) @ (^ [Xw:$i] : XU))))))).
