...
thf(coutsideofeu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XR @ (ccfv @ XN @ ccee))) & ((cwcel @ XB2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee)))) => (((XR != XA2) & (XB2 != XC)) => (cwreu @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccop @ (ccv @ Xx3) @ XR) @ ccoutsideof) & (cwbr @ (ccop @ XA2 @ (ccv @ Xx3)) @ (ccop @ XB2 @ XC) @ cccgr))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee))))))))))).
