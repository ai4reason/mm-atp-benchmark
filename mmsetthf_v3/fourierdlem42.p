...
thf(alptre2pt_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cclp)) != cc0)) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ XE @ cclt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))))))))).
...
thf(cfourierdlem42_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XB2 @ Xj @ Xk @ Xa @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XC @ Xj @ Xk @ Xa @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwbr @ (XB2 @ Xj @ Xk @ Xa @ Xb) @ (XC @ Xj @ Xk @ Xa @ Xb) @ cclt)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (XT = (cco @ (XC @ Xj @ Xk @ Xa @ Xb) @ (XB2 @ Xj @ Xk @ Xa @ Xb) @ ccmin)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwss @ XA2 @ (cco @ (XB2 @ Xj @ Xk @ Xa @ Xb) @ (XC @ Xj @ Xk @ Xa @ Xb) @ ccicc))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ XA2 @ ccfn)))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XB2 @ Xj @ Xk @ Xa @ Xb) @ XA2)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XC @ Xj @ Xk @ Xa @ Xb) @ XA2)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XD @ Xj @ Xk @ Xa @ Xb) = (cccom @ ccabs @ ccmin)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XI @ Xj @ Xk @ Xa @ Xb) = (ccdif @ (ccxp @ XA2 @ XA2) @ ccid)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XR @ Xj @ Xk @ Xa @ Xb) = (ccrn @ (ccres @ (XD @ Xj @ Xk @ Xa @ Xb) @ (XI @ Xj @ Xk @ Xa @ Xb)))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XE @ Xx3) = (ccinf @ (XR @ Xj @ Xk @ Xa @ Xb) @ ccr @ cclt))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XX @ Xj @ Xk @ Xa @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XY @ Xj @ Xk @ Xa @ Xb) @ ccr)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XJ @ Xx3 @ Xj @ Xk) = (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XK @ Xj @ Xk) = (cco @ (XJ @ Xx3 @ Xj @ Xk) @ (cco @ (XX @ Xj @ Xk @ Xa @ Xb) @ (XY @ Xj @ Xk @ Xa @ Xb) @ ccicc) @ ccrest))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XH @ Xj @ Xk) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ XT @ ccmul) @ ccaddc) @ XA2)) @ (^ [Xk:$i] : ccz))) @ (^ [Xx3:$i] : (cco @ (XX @ Xj @ Xk @ Xa @ Xb) @ (XY @ Xj @ Xk @ Xa @ Xb) @ ccicc)))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xps @ Xx3 @ Xa @ Xb) <=> (((Xph @ Xj @ Xk) & ((cwcel @ (ccv @ Xa) @ ccr) & (cwcel @ (ccv @ Xb) @ ccr) & (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ cclt))) & (cwrex @ (^ [Xj:$i] : (cwrex @ (^ [Xk:$i] : ((cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xj) @ XT @ ccmul) @ ccaddc) @ XA2) & (cwcel @ (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xk) @ XT @ ccmul) @ ccaddc) @ XA2))) @ (^ [Xk:$i] : ccz))) @ (^ [Xj:$i] : ccz))))))))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XH @ Xj @ Xk) @ ccfn)))))))))))))))))))))))))))))))))))))).
