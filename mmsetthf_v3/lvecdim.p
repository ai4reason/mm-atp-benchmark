...
thf(albsacsbs_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((XX = (ccfv @ XW @ ccbs)) => ((XI = (ccfv @ XA2 @ ccmri)) => ((XJ = (ccfv @ XW @ cclbs)) => ((cwcel @ XW @ cclvec) => ((cwcel @ XS @ XJ) <=> ((cwcel @ XS @ XI) & ((ccfv @ XS @ XN) = XX))))))))))))))))).
thf(asimp3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) => Xch))))).
thf(aeqtr4d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XB2)) => (Xph => (XA2 = XC))))))))).
thf(clvecdim_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cclbs)) => (((cwcel @ XW @ cclvec) & (cwcel @ XS @ XJ) & (cwcel @ XT @ XJ)) => (cwbr @ XS @ XT @ ccen)))))))).
