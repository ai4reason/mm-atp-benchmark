...
thf(awemapwe_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ (XS @ Xx3 @ Xy1 @ Xw)) & (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XR @ Xx3 @ Xy1)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XU @ Xz @ Xw) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XZ @ Xy1 @ Xz @ Xw) @ ccfsupp)) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xz @ Xw) @ XA2 @ ccmap))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwwe @ XA2 @ (XR @ Xx3 @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwwe @ (XB2 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xw))))))) => ((! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => ((XB2 @ Xz @ Xw) != cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XF = (ccoi @ XA2 @ (XR @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XG @ Xz @ Xw) = (ccoi @ (XB2 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xw))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XZ @ Xy1 @ Xz @ Xw) = (ccfv @ cc0 @ (XG @ Xz @ Xw)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwwe @ (XU @ Xz @ Xw) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))))))))))))))))).
...
thf(altbval_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) = (cco @ (XT @ Xh) @ XI @ ccltb))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((XD @ Xz @ Xw @ Xh) = (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xw) => (cwcel @ XI @ (XV @ Xx3 @ Xy1 @ Xz @ Xw @ Xh)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xw) => (cwcel @ (XT @ Xh) @ (XW @ Xx3 @ Xy1 @ Xz @ Xw @ Xh)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xw) => ((XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XD @ Xz @ Xw @ Xh)) & (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ cclt) & (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XT @ Xh)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XI)))) @ (^ [Xz:$i] : XI))))))))))))))))))))))))).
...
thf(cltbwe_conj,conjecture,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xh:$i] : ((XC @ Xh) = (cco @ (XT @ Xh) @ XI @ ccltb))) => ((! [Xh:$i] : ((XD @ Xh) = (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xh:$i] : (Xph => (cwcel @ XI @ (XV @ Xh)))) => ((! [Xh:$i] : (Xph => (cwcel @ (XT @ Xh) @ (XW @ Xh)))) => ((! [Xh:$i] : (Xph => (cwwe @ XI @ (XT @ Xh)))) => (! [Xh:$i] : (Xph => (cwwe @ (XD @ Xh) @ (XC @ Xh))))))))))))))))).
