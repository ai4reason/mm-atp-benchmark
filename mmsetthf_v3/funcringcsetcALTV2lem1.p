...
thf(cfuncringcsetcALTV2lem1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XR @ Xx3) = (ccfv @ (XU @ Xx3) @ ccringc))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ (XU @ Xx3) @ ccsetc))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XR @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccfv @ (XS @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XU @ Xx3) @ ccwun))) => ((! [Xx3:$i] : (Xph => ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccbs)))))) => (! [Xx3:$i] : ((Xph & (cwcel @ XX @ XB2)) => ((ccfv @ XX @ (XF @ Xx3)) = (ccfv @ XX @ ccbs))))))))))))))))))).
