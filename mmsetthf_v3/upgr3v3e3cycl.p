...
thf(acyclprop_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ cccycls)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & ((ccfv @ ccc0 @ XP) = (ccfv @ (ccfv @ XF @ cchash) @ XP)))))))).
...
thf(apthdadjvtx_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ cclt) & (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) => ((ccfv @ XI @ XP) != (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP)))))))).
