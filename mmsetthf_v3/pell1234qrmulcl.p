...
thf(cpell1234qrmulcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr)) & (cwcel @ XB2 @ (ccfv @ XD @ ccpell1234qr))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ (ccfv @ XD @ ccpell1234qr))))))).
