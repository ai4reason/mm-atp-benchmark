...
thf(abpolydif_thm,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XX @ ccc)) => ((cco @ (cco @ XN @ (cco @ XX @ cc1 @ ccaddc) @ ccbp) @ (cco @ XN @ XX @ ccbp) @ ccmin) = (cco @ XN @ (cco @ XX @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul)))))).
...
thf(abpolycl_thm,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XX @ ccc)) => (cwcel @ (cco @ XN @ XX @ ccbp) @ ccc))))).
thf(cfsumkthpow_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XK @ ccn0) & (cwcel @ XM @ ccn0)) => ((ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ XK @ ccexp))) = (cco @ (cco @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ XM @ cc1 @ ccaddc) @ ccbp) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ ccc0 @ ccbp) @ ccmin) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv)))))).
