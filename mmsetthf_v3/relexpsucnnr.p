...
thf(aseqeq123d_thm,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (XM = XN)) => ((Xph => (Xc_pl = XQ)) => ((Xph => (XF = XG)) => (Xph => ((ccseq @ Xc_pl @ XF @ XM) = (ccseq @ XQ @ XG @ XN)))))))))))))).
...
thf(crelexpsucnnr_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ XV) & (cwcel @ XN @ ccn)) => ((cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) = (cccom @ (cco @ XR @ XN @ ccrelexp) @ XR))))))).
