...
thf(adeg1suble_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ (ccif @ (cwbr @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ ccle) @ (ccfv @ XG @ XD) @ (ccfv @ XF @ XD)) @ ccle)))))))))))))))))).
...
thf(cply1divmo_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xb:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xq:$i] : ((XP @ Xq) = (ccfv @ (XR @ Xq) @ ccpl1))) => ((! [Xq:$i] : (XD = (ccfv @ (XR @ Xq) @ ccdg1))) => ((! [Xq:$i] : (XB2 = (ccfv @ (XP @ Xq) @ ccbs))) => ((! [Xq:$i] : (Xc_mi = (ccfv @ (XP @ Xq) @ ccsg))) => ((! [Xq:$i] : ((Xc_0 @ Xq) = (ccfv @ (XP @ Xq) @ cc0g))) => ((! [Xq:$i] : (Xc_xb = (ccfv @ (XP @ Xq) @ ccmulr))) => ((! [Xq:$i] : (Xph => (cwcel @ (XR @ Xq) @ ccrg))) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => ((! [Xq:$i] : (Xph => (XG != (Xc_0 @ Xq)))) => ((! [Xq:$i] : (Xph => (cwcel @ (ccfv @ (ccfv @ XG @ XD) @ (ccfv @ XG @ ccco1)) @ (XE @ Xq)))) => ((! [Xq:$i] : ((XE @ Xq) = (ccfv @ (XR @ Xq) @ ccrlreg))) => (Xph => (cwrmo @ (^ [Xq:$i] : (cwbr @ (ccfv @ (cco @ XF @ (cco @ XG @ (ccv @ Xq) @ Xc_xb) @ Xc_mi) @ XD) @ (ccfv @ XG @ XD) @ cclt)) @ (^ [Xq:$i] : XB2))))))))))))))))))))))))))).
