...
thf(a_1gcd_thm,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => ((cco @ cc1 @ XM @ ccgcd) = cc1)))).
...
thf(arpmulgcd_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XK @ ccn) & (cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) & ((cco @ XK @ XM @ ccgcd) = cc1)) => ((cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) = (cco @ XK @ XN @ ccgcd))))))).
...
thf(ccoprmprod_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xn:$i] : ((((cwcel @ XM @ ccfn) & (cwss @ XM @ ccn) & (cwcel @ XN @ ccn)) & (cwf @ ccn @ ccn @ (XF @ Xn)) & (cwral @ (^ [Xm:$i] : ((cco @ (ccfv @ (ccv @ Xm) @ (XF @ Xn)) @ XN @ ccgcd) = cc1)) @ (^ [Xm:$i] : XM))) => ((cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : ((cco @ (ccfv @ (ccv @ Xm) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)) @ ccgcd) = cc1)) @ (^ [Xn:$i] : (ccdif @ XM @ (ccsn @ (ccv @ Xm)))))) @ (^ [Xm:$i] : XM)) => ((cco @ (ccprod @ (^ [Xm:$i] : XM) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xm) @ (XF @ Xn)))) @ XN @ ccgcd) = cc1)))))))).
