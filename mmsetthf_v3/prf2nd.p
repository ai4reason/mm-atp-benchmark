...
thf(cprf2nd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XP = (cco @ XF @ XG @ ccprf)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XC @ XE @ ccfunc))) => (Xph => ((cco @ (cco @ XD @ XE @ cc2ndf) @ XP @ cccofu) = XG))))))))))))).
