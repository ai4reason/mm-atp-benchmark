...
thf(aftalem4_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XF @ (ccfv @ (XS @ Xn) @ ccply)))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XN @ ccn))) => ((! [Xn:$i] : ((Xph @ Xn) => ((ccfv @ ccc0 @ XF) != ccc0))) => ((XK = (ccinf @ (ccrab @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ XA2) != ccc0)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)) => ((! [Xn:$i] : ((XT @ Xn) = (cco @ (ccneg @ (cco @ (ccfv @ ccc0 @ XF) @ (ccfv @ XK @ XA2) @ ccdiv)) @ (cco @ cc1 @ XK @ ccdiv) @ cccxp))) => ((! [Xk:$i] : (! [Xn:$i] : ((XU @ Xk @ Xn) = (cco @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (cco @ (ccsu @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (XT @ Xn) @ (ccv @ Xk) @ ccexp) @ ccmul) @ ccabs))) @ cc1 @ ccaddc) @ ccdiv)))) => ((! [Xk:$i] : (! [Xn:$i] : (XX = (ccif @ (cwbr @ cc1 @ (XU @ Xk @ Xn) @ ccle) @ cc1 @ (XU @ Xk @ Xn))))) => (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xn) => (((cwcel @ XK @ ccn) & ((ccfv @ XK @ XA2) != ccc0)) & ((cwcel @ (XT @ Xn) @ ccc) & (cwcel @ (XU @ Xk @ Xn) @ ccrp) & (cwcel @ XX @ ccrp))))))))))))))))))))))))).
...
thf(acoefv0_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((ccfv @ ccc0 @ XF) = (ccfv @ ccc0 @ XA2)))))))).
...
thf(afsumm1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (((ccv @ Xk) = XN) => ((XA2 @ Xk) = XB2))) => (Xph => ((ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) = (cco @ (ccsu @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XB2 @ ccaddc)))))))))))).
...
thf(cftalem5_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XF @ (ccfv @ (XS @ Xx3 @ Xn) @ ccply))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XN @ ccn))) => ((! [Xn:$i] : ((Xph @ Xn) => ((ccfv @ ccc0 @ XF) != ccc0))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccinf @ (ccrab @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ XA2) != ccc0)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt))) => ((! [Xx3:$i] : (! [Xn:$i] : ((XT @ Xn) = (cco @ (ccneg @ (cco @ (ccfv @ ccc0 @ XF) @ (ccfv @ (XK @ Xx3) @ XA2) @ ccdiv)) @ (cco @ cc1 @ (XK @ Xx3) @ ccdiv) @ cccxp)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XU @ Xk @ Xn) = (cco @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (cco @ (ccsu @ (cco @ (cco @ (XK @ Xx3) @ cc1 @ ccaddc) @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (XT @ Xn) @ (ccv @ Xk) @ ccexp) @ ccmul) @ ccabs))) @ cc1 @ ccaddc) @ ccdiv))))) => ((! [Xk:$i] : (! [Xn:$i] : (XX = (ccif @ (cwbr @ cc1 @ (XU @ Xk @ Xn) @ ccle) @ cc1 @ (XU @ Xk @ Xn))))) => (! [Xn:$i] : ((Xph @ Xn) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ cclt)) @ (^ [Xx3:$i] : ccc))))))))))))))))))))))).
