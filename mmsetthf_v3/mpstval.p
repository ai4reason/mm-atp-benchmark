...
thf(adf_mpst_ax,axiom,(ccmpst = (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (ccrab @ (^ [Xd:$i] : ((cccnv @ (ccv @ Xd)) = (ccv @ Xd))) @ (^ [Xd:$i] : (ccpw @ (ccfv @ (ccv @ Xt) @ ccmdv)))) @ (ccin @ (ccpw @ (ccfv @ (ccv @ Xt) @ ccmex)) @ ccfn)) @ (ccfv @ (ccv @ Xt) @ ccmex)))))).
...
thf(cmpstval_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XT @ ccmdv)) => ((! [Xd:$i] : ((XE @ Xd) = (ccfv @ XT @ ccmex))) => ((! [Xd:$i] : ((XP @ Xd) = (ccfv @ XT @ ccmpst))) => (! [Xd:$i] : ((XP @ Xd) = (ccxp @ (ccxp @ (ccrab @ (^ [Xd:$i] : ((cccnv @ (ccv @ Xd)) = (ccv @ Xd))) @ (^ [Xd:$i] : (ccpw @ XV))) @ (ccin @ (ccpw @ (XE @ Xd)) @ ccfn)) @ (XE @ Xd)))))))))))).
