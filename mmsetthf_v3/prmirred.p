...
thf(airredn0_thm,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XI = (ccfv @ XR @ ccir)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XI)) => (XX != Xc_0))))))))).
...
thf(cprmirred_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ czring @ ccir)) => ((cwcel @ XA2 @ XI) <=> ((cwcel @ XA2 @ ccz) & (cwcel @ (ccfv @ XA2 @ ccabs) @ ccprime))))))).
