...
thf(aminvecolem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XU @ ccba))) => ((XM = (ccfv @ XU @ ccnsb)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XY = (ccfv @ XW @ ccba)) => ((Xph => (cwcel @ XU @ cccphlo)) => ((Xph => (cwcel @ XW @ (ccin @ (ccfv @ XU @ ccss) @ cccbn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XX @ Xy1)))) => ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : ((XR @ Xy1) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN)))))) => ((! [Xy1:$i] : (XS = (ccinf @ (XR @ Xy1) @ ccr @ cclt))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ XM) @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN) @ ccle)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XY))))))))))))))))))))))))))).
...
thf(aminvecolem6_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XU @ ccba))) => ((XM = (ccfv @ XU @ ccnsb)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XY = (ccfv @ XW @ ccba)) => ((Xph => (cwcel @ XU @ cccphlo)) => ((Xph => (cwcel @ XW @ (ccin @ (ccfv @ XU @ ccss) @ cccbn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XX @ Xy1)))) => ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : ((XR @ Xy1) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN)))))) => ((! [Xy1:$i] : (XS = (ccinf @ (XR @ Xy1) @ ccr @ cclt))) => (! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XY)) => ((cwbr @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ XD) @ cc2 @ ccexp) @ (cco @ (cco @ XS @ cc2 @ ccexp) @ ccc0 @ ccaddc) @ ccle) <=> (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ XM) @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN) @ ccle)) @ (^ [Xy1:$i] : XY))))))))))))))))))))))))))))).
...
thf(cminvecolem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XU @ ccba))) => ((XM = (ccfv @ XU @ ccnsb)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XY = (ccfv @ XW @ ccba)) => ((Xph => (cwcel @ XU @ cccphlo)) => ((Xph => (cwcel @ XW @ (ccin @ (ccfv @ XU @ ccss) @ cccbn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XX @ Xy1)))) => ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : ((XR @ Xy1) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN)))))) => ((! [Xy1:$i] : (XS = (ccinf @ (XR @ Xy1) @ ccr @ cclt))) => (Xph => (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ XM) @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN) @ ccle)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XY))))))))))))))))))))))))))).
