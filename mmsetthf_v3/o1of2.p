...
thf(ao1f_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ cco1) => (cwf @ (ccdm @ XF) @ ccc @ XF)))).
thf(ao1bdd_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ cco1) & (cwf @ XA2 @ ccc @ XF)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xm) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))).
...
thf(ao1dm_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ cco1) => (cwss @ (ccdm @ XF) @ ccr)))).
