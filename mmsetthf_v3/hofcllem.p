...
thf(ahof2val_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xh:$i] : ((XM @ Xh) = (ccfv @ XC @ cchof))) => ((Xph => (cwcel @ XC @ cccat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XW @ XB2)) => ((Xc_x = (ccfv @ XC @ ccco)) => ((Xph => (cwcel @ XF @ (cco @ XZ @ XX @ XH))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XW @ XH))) => (! [Xh:$i] : (Xph => ((cco @ XF @ XG @ (cco @ (ccop @ XX @ XY) @ (ccop @ XZ @ XW) @ (ccfv @ (XM @ Xh) @ cc2nd))) = (ccmpt @ (^ [Xh:$i] : (cco @ XX @ XY @ XH)) @ (^ [Xh:$i] : (cco @ (cco @ XG @ (ccv @ Xh) @ (cco @ (ccop @ XX @ XY) @ XW @ Xc_x)) @ XF @ (cco @ (ccop @ XZ @ XX) @ XW @ Xc_x))))))))))))))))))))))))))))))).
...
thf(chofcllem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XM = (ccfv @ XC @ cchof)) => ((XO = (ccfv @ XC @ ccoppc)) => ((XD = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XW @ XB2)) => ((Xph => (cwcel @ XS @ XB2)) => ((Xph => (cwcel @ XT @ XB2)) => ((Xph => (cwcel @ XK @ (cco @ XZ @ XX @ XH))) => ((Xph => (cwcel @ XL @ (cco @ XY @ XW @ XH))) => ((Xph => (cwcel @ XP @ (cco @ XS @ XZ @ XH))) => ((Xph => (cwcel @ XQ @ (cco @ XW @ XT @ XH))) => (Xph => ((cco @ (cco @ XK @ XP @ (cco @ (ccop @ XS @ XZ) @ XX @ (ccfv @ XC @ ccco))) @ (cco @ XQ @ XL @ (cco @ (ccop @ XY @ XW) @ XT @ (ccfv @ XC @ ccco))) @ (cco @ (ccop @ XX @ XY) @ (ccop @ XS @ XT) @ (ccfv @ XM @ cc2nd))) = (cco @ (cco @ XP @ XQ @ (cco @ (ccop @ XZ @ XW) @ (ccop @ XS @ XT) @ (ccfv @ XM @ cc2nd))) @ (cco @ XK @ XL @ (cco @ (ccop @ XX @ XY) @ (ccop @ XZ @ XW) @ (ccfv @ XM @ cc2nd))) @ (cco @ (ccop @ (cco @ XX @ XY @ XH) @ (cco @ XZ @ XW @ XH)) @ (cco @ XS @ XT @ XH) @ (ccfv @ XD @ ccco))))))))))))))))))))))))))))))))))))))))))).
