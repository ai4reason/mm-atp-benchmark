...
thf(ccusgrexilem2_conj,conjecture,(! [Xv:$i] : (! [XP:($i > $o)] : (! [Xn:$i] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))) => ((((cwcel @ XV @ XW) & (cwcel @ (ccv @ Xv) @ XV)) & (cwcel @ (ccv @ Xn) @ (ccdif @ XV @ (ccsn @ (ccv @ Xv))))) => (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xv) @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccrn @ (ccres @ ccid @ XP)))))))))))).
