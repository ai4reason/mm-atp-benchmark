...
thf(cfrege77_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xa:$i] : (cwcel @ XX @ (XU @ Xa))) => ((! [Xa:$i] : (cwcel @ (XY @ Xa) @ (XV @ Xa))) => ((! [Xa:$i] : (cwcel @ XR @ (XW @ Xa))) => ((! [Xa:$i] : (cwcel @ XA2 @ (XB2 @ Xa))) => (! [Xa:$i] : ((cwbr @ XX @ (XY @ Xa) @ (ccfv @ XR @ cctcl)) => ((cwhe @ XA2 @ XR) => ((! [Xa:$i] : ((cwbr @ XX @ (ccv @ Xa) @ XR) => (cwcel @ (ccv @ Xa) @ XA2))) => (cwcel @ (XY @ Xa) @ XA2)))))))))))))))))).
