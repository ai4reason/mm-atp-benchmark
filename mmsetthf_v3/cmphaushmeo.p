...
thf(ccmphaushmeo_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => (((cwcel @ XJ @ cccmp) & (cwcel @ XK @ ccha) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) <=> (cwf1o @ XX @ XY @ XF))))))))))).
