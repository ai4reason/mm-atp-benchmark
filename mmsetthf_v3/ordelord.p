...
thf(awetrep_thm,axiom,(! [Xx3:$i] : (! [XA2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xz:$i] : (((cwwe @ (XA2 @ Xy1 @ Xz) @ ccep) & ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XA2 @ Xy1 @ Xz)) & (cwcel @ (ccv @ Xz) @ (XA2 @ Xy1 @ Xz)))) => (((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xz))) => (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))))))).
...
thf(cordelord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cwcel @ XB2 @ XA2)) => (cword @ XB2))))).
