...
thf(aelrfi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwss @ XC @ (ccpw @ XB2))) => ((cwcel @ XA2 @ (ccfv @ (ccun @ (ccsn @ XB2) @ XC) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : (XA2 = (ccin @ XB2 @ (ccint @ (ccv @ Xv))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XC) @ ccfn)))))))))).
...
thf(aimaiinfv_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (((cwfn @ XF @ (XA2 @ Xx3)) & (cwss @ XB2 @ (XA2 @ Xx3))) => ((cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) = (ccint @ (ccima @ XF @ XB2))))))))).
