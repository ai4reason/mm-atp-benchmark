...
thf(aobs2ocv_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XV = (ccfv @ XW @ ccbs)) => ((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) => ((ccfv @ (ccfv @ XB2 @ Xc_pe) @ Xc_pe) = XV))))))))).
...
thf(aobselocv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => (((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) & (cwss @ XC @ XB2) & (cwcel @ XA2 @ XB2)) => ((cwcel @ XA2 @ (ccfv @ XC @ Xc_pe)) <=> (~ (cwcel @ XA2 @ XC))))))))))).
...
thf(aislbs3_thm,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cclbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((cwcel @ XW @ cclvec) => ((cwcel @ XB2 @ XJ) <=> ((cwss @ XB2 @ XV) & ((ccfv @ XB2 @ XN) = XV) & (! [Xs1:$i] : ((cwpss @ (ccv @ Xs1) @ XB2) => (cwpss @ (ccfv @ (ccv @ Xs1) @ XN) @ XV))))))))))))))).
thf(a_3anan32_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) <=> ((Xph & Xch) & Xps)))))).
thf(cobslbs_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cclbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) => ((cwcel @ XB2 @ XJ) <=> (cwcel @ (ccfv @ XB2 @ XN) @ XC)))))))))))).
