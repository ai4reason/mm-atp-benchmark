...
thf(cconncompss_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccuni @ (ccrab @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) & (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccconn))) @ (^ [Xx3:$i] : (ccpw @ XX)))))) => (! [Xx3:$i] : (((cwss @ (XT @ Xx3) @ XX) & (cwcel @ XA2 @ (XT @ Xx3)) & (cwcel @ (cco @ XJ @ (XT @ Xx3) @ ccrest) @ ccconn)) => (cwss @ (XT @ Xx3) @ (XS @ Xx3))))))))))).
