...
thf(apczndvds_thm,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XN @ ccz) & (XN != ccc0))) => (~ (cwbr @ (cco @ XP @ (cco @ (cco @ XP @ XN @ ccpc) @ cc1 @ ccaddc) @ ccexp) @ XN @ ccdvds)))))).
...
thf(cpcdvdsb_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccz) & (cwcel @ XA2 @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccpc) @ ccle) <=> (cwbr @ (cco @ XP @ XA2 @ ccexp) @ XN @ ccdvds))))))).
