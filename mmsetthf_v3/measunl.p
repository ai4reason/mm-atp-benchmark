...
thf(cmeasunl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => (Xph => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ XM) @ (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccxad) @ ccle))))))))))).
