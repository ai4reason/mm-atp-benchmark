...
thf(csubrec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) & ((cwcel @ XB2 @ ccc) & (XB2 != ccc0))) => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ (cco @ cc1 @ XB2 @ ccdiv) @ ccmin) = (cco @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccmul) @ ccdiv)))))).
