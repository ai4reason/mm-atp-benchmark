...
thf(aclimf2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XF @ Xk) @ (XV @ Xx3 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ ccz)) => ((ccfv @ (ccv @ Xk) @ (XF @ Xk)) = (XB2 @ Xx3 @ Xj @ Xk)))))) => (! [Xk:$i] : ((Xph @ Xk) => ((cwbr @ (XF @ Xk) @ XA2 @ ccli) <=> ((cwcel @ XA2 @ ccc) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (XB2 @ Xx3 @ Xj @ Xk) @ ccc) & (cwbr @ (ccfv @ (cco @ (XB2 @ Xx3 @ Xj @ Xk) @ XA2 @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz))) @ (^ [Xx3:$i] : ccrp)))))))))))))))).
...
thf(cclim2f2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XZ @ Xx3) = (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XF @ Xk) @ (XV @ Xx3 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ (XZ @ Xx3))) => ((ccfv @ (ccv @ Xk) @ (XF @ Xk)) = (XB2 @ Xx3 @ Xj @ Xk)))))) => (! [Xk:$i] : ((Xph @ Xk) => ((cwbr @ (XF @ Xk) @ XA2 @ ccli) <=> ((cwcel @ XA2 @ ccc) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (XB2 @ Xx3 @ Xj @ Xk) @ ccc) & (cwbr @ (ccfv @ (cco @ (XB2 @ Xx3 @ Xj @ Xk) @ XA2 @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xx3)))) @ (^ [Xx3:$i] : ccrp)))))))))))))))))))).
