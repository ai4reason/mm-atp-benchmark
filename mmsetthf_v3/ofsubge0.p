...
thf(cofsubge0_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccr @ XF) & (cwf @ XA2 @ ccr @ XG)) => ((cwbr @ (ccxp @ XA2 @ (ccsn @ ccc0)) @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccofr @ ccle)) <=> (cwbr @ XG @ XF @ (ccofr @ ccle))))))))).
