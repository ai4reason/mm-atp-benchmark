...
thf(aomelesplit_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XA2 @ XX)) => (Xph => (cwbr @ (ccfv @ XA2 @ XO) @ (cco @ (ccfv @ (ccin @ XA2 @ XE) @ XO) @ (ccfv @ (ccdif @ XA2 @ XE) @ XO) @ ccxad) @ ccle))))))))))).
thf(ccaragenel2d_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : ((Xph => (cwcel @ XO @ ccome)) => ((! [Xa:$i] : ((XX @ Xa) = (ccuni @ (ccdm @ XO)))) => ((! [Xa:$i] : ((XS @ Xa) = (ccfv @ XO @ cccaragen))) => ((! [Xa:$i] : (Xph => (cwcel @ XE @ (ccpw @ (XX @ Xa))))) => ((! [Xa:$i] : ((Xph & (cwcel @ (ccv @ Xa) @ (ccpw @ (XX @ Xa)))) => (cwbr @ (cco @ (ccfv @ (ccin @ (ccv @ Xa) @ XE) @ XO) @ (ccfv @ (ccdif @ (ccv @ Xa) @ XE) @ XO) @ ccxad) @ (ccfv @ (ccv @ Xa) @ XO) @ ccle))) => (! [Xa:$i] : (Xph => (cwcel @ XE @ (XS @ Xa))))))))))))))).
