...
thf(ctx2cn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XR @ (ccfv @ XX @ cctopon)) & (cwcel @ XS @ (ccfv @ XY @ cctopon))) => (cwcel @ (ccres @ cc2nd @ (ccxp @ XX @ XY)) @ (cco @ (cco @ XR @ XS @ cctx) @ XS @ cccn)))))))).
