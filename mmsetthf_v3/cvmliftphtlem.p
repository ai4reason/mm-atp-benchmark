...
thf(acvmlift_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XB2 = (ccuni @ XC)) => ((((cwcel @ XF @ (cco @ XC @ XJ @ cccvm)) & (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) & ((cwcel @ XP @ XB2) & ((ccfv @ XP @ XF) = (ccfv @ ccc0 @ XG)))) => (cwreu @ (^ [Xf1:$i] : (((cccom @ XF @ (ccv @ Xf1)) = XG) & ((ccfv @ ccc0 @ (ccv @ Xf1)) = XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn)))))))))))).
