...
thf(adecpmatmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((! [Xk:$i] : ((XC @ Xk) = (cco @ XN @ XP @ ccmat))) => ((! [Xk:$i] : (XB2 = (ccfv @ (XC @ Xk) @ ccbs))) => ((XA2 = (cco @ XN @ XR @ ccmat)) => (! [Xk:$i] : (((cwcel @ XR @ ccrg) & ((cwcel @ XU @ XB2) & (cwcel @ XW @ XB2)) & (cwcel @ XK @ ccn0)) => ((cco @ (cco @ XU @ XW @ (ccfv @ (XC @ Xk) @ ccmulr)) @ XK @ ccdecpmat) = (cco @ XA2 @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XK @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XU @ (ccv @ Xk) @ ccdecpmat) @ (cco @ XW @ (cco @ XK @ (ccv @ Xk) @ ccmin) @ ccdecpmat) @ (ccfv @ XA2 @ ccmulr)))) @ ccgsu)))))))))))))))))).
...
thf(adecpmatfsupp_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : ((XC @ Xk) = (cco @ (XN @ Xk) @ (XP @ Xk) @ ccmat))) => ((! [Xk:$i] : (XB2 = (ccfv @ (XC @ Xk) @ ccbs))) => ((! [Xk:$i] : ((XA2 @ Xk) = (cco @ (XN @ Xk) @ XR @ ccmat))) => ((! [Xk:$i] : ((Xc_0 @ Xk) = (ccfv @ (XA2 @ Xk) @ cc0g))) => (! [Xk:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XM @ (ccv @ Xk) @ ccdecpmat))) @ (Xc_0 @ Xk) @ ccfsupp))))))))))))))))).
