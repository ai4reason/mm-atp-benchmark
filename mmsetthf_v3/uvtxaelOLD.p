...
thf(cuvtxaelOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((XV = (ccfv @ XG @ ccvtx)) => (! [Xn:$i] : ((cwcel @ XG @ (XW @ Xn)) => ((cwcel @ XN @ (ccfv @ XG @ ccuvtx)) <=> ((cwcel @ XN @ XV) & (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ XN @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))))))).
