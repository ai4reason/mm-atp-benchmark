...
thf(awwlksnwwlksnonOLD_thm,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XN @ ccn0) & (cwcel @ XG @ XU)) => ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwlksnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))))).
