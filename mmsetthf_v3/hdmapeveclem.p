...
thf(ahdmaplem1_thm,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XZ @ XV)) => ((Xph => (~ (cwcel @ XZ @ (ccun @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN))))) => ((Xph => (cwcel @ XX @ XV)) => (Xph => ((ccfv @ (ccsn @ XZ) @ XN) != (ccfv @ (ccsn @ XX) @ XN))))))))))))))))).
...
thf(ahdmaplem3_thm,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XZ @ XV)) => ((Xph => (~ (cwcel @ XZ @ (ccun @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN))))) => ((Xph => (cwcel @ XY @ XV)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => (Xph => (cwcel @ XZ @ (ccdif @ XV @ (ccsn @ Xc_0)))))))))))))))))))).
