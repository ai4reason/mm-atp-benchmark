...
thf(cfzneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) => ((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfz)) <=> (cwcel @ (ccneg @ XA2) @ (cco @ (ccneg @ XC) @ (ccneg @ XB2) @ ccfz)))))))).
