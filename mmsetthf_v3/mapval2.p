...
thf(cmapval2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xf1:$i] : (cwcel @ (XA2 @ Xf1) @ ccvv)) => ((cwcel @ XB2 @ ccvv) => (! [Xf1:$i] : ((cco @ (XA2 @ Xf1) @ XB2 @ ccmap) = (ccin @ (ccpw @ (ccxp @ XB2 @ (XA2 @ Xf1))) @ (^ [Xf1:$i] : (cwfn @ (ccv @ Xf1) @ XB2)))))))))).
