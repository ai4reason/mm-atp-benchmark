...
thf(achtdif_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cco @ (ccfv @ XN @ cccht) @ (ccfv @ XM @ cccht) @ ccmin) = (ccsu @ (ccin @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog)))))))).
...
thf(cefchtdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ cccht) @ cce) @ (ccfv @ (ccfv @ XB2 @ cccht) @ cce) @ ccdvds))))).
