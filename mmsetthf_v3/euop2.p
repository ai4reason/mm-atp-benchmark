...
thf(aeuxfr2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (cwmo @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))))) => ((cweu @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) & (Xph @ Xy1))))) <=> (cweu @ (^ [Xy1:$i] : (Xph @ Xy1))))))))).
