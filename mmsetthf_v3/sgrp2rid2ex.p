...
thf(csgrp2rid2ex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [Xc_op:($i > $o)] : ((XS = (ccpr @ XA2 @ XB2)) => ((! [Xy1:$i] : (! [Xz:$i] : ((ccfv @ (XM @ Xy1 @ Xz) @ ccbs) = XS))) => ((! [Xy1:$i] : (! [Xz:$i] : ((ccfv @ (XM @ Xy1 @ Xz) @ ccplusg) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = XA2) @ XA2 @ XB2))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xc_op = (ccfv @ (XM @ Xy1 @ Xz) @ ccplusg)))) => (((ccfv @ XS @ cchash) = cc2) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xz)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_op) = (ccv @ Xy1)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_op) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS))) @ (^ [Xz:$i] : XS))) @ (^ [Xx3:$i] : XS))))))))))))).
