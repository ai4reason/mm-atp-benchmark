...
thf(abnj23_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XB2 @ Xx3) = (ccrab @ (^ [Xx3:$i] : (~ (Xph @ Xx3 @ Xz @ Xw))) @ (^ [Xx3:$i] : (XA2 @ Xw))))))) => (! [Xx3:$i] : (! [Xz:$i] : ((cwral @ (^ [Xz:$i] : (~ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ (XR @ Xx3)))) @ (^ [Xz:$i] : (XB2 @ Xx3))) => (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xw) @ (ccv @ Xy1) @ (XR @ Xx3)) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xz @ Xw)) @ (ccv @ Xw)))) @ (^ [Xw:$i] : (XA2 @ Xw))))))))))))).
...
thf(cbnj110_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xps @ Xx3 @ Xy1) <=> (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))) => (! [Xy1:$i] : (((cwfr @ XA2 @ XR) & (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3 @ Xy1) => (Xph @ Xx3))) @ (^ [Xx3:$i] : XA2))) => (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2))))))))))).
